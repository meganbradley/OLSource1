 ...
 **Does Stretch Database work with \<SQL Server feature name\>?**
 -   For a list of [!INCLUDE[ssNoVersion](../Token/ssNoVersion_md.md)] features that make a table ineligible for Stretch, see [Surface area limitations and blocking issues for Stretch Database](assetId:///2b1fbec1-7859-44fc-8417-724fc57a59c0).
 ...
 **Can I target another local SQL Server instance for Stretch Database?**
 No. Stretch Database does not support another local [!INCLUDE[ssNoVersion](../Token/ssNoVersion_md.md)] instance as the remote endpoint.
