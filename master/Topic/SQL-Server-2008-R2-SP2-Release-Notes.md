...
## 2.0 Before You Install
 For information about how to install [!INCLUDE[ssKilimanjaro](../Token/ssKilimanjaro_md.md)] updates, see [SQL Server 2008 R2 Servicing Documentation](http://msdn.microsoft.com/library/dd638062\(SQL.105\).aspx).
