...
# SQL Server 2014 Release Notes
  This Release Notes document describes known issues that you should read about before you install or troubleshoot [!INCLUDE[ssSQL14](../Token/ssSQL14_md.md)].
 ...
 **Workaround:** There is no workaround for downgrade. We recommend that you back\-up the database before upgrading to SQL Server 2014 RTM.
 ...
 ![](../Image/UpArrow16x16.gif) [Top](#top)
...
-   Danish \(da\-DK\)
 ...
 In [!INCLUDE[ssSQL11](../Token/ssSQL11_md.md)], this content was available in a CHM file that shipped with the product and was available in these languages. The CHM files no longer ship with the product and the Report Builder content is only available on MSDN. MSDN does not support these languages. Report Builder was also removed from TechNet and is no longer available in those supported languages.
...
-   Portuguese \(Portugal\) \(pt\-PT\)
 ...
 In [!INCLUDE[ssSQL11](../Token/ssSQL11_md.md)], this content was available on TechNet and was available in these languages. This content was removed from TechNet and is no longer available in these supported languages.
 ...
 **Issue:** The [!INCLUDE[ssRSnoversion](../Token/ssRSnoversion_md.md)] Native mode Windows service ‘SQL Server Reporting Services’ \(ReportingServicesService.exe\) fails to start if there are [!INCLUDE[ssSQL14](../Token/ssSQL14_md.md)] [!INCLUDE[ssRSnoversion](../Token/ssRSnoversion_md.md)] SharePoint components installed on the same server.

 **Workaround:** Uninstall [!INCLUDE[ssSQL14](../Token/ssSQL14_md.md)] [!INCLUDE[ssRSnoversion](../Token/ssRSnoversion_md.md)] SharePoint components and restart Microsoft SQL Server 2012 Reporting Services Windows service.

 **More Information:**

 [!INCLUDE[ssSQL11](../Token/ssSQL11_md.md)] [!INCLUDE[ssRSnoversion](../Token/ssRSnoversion_md.md)] Native Mode cannot run side\-by\-side with either of the following:

-   [!INCLUDE[ssSQL14](../Token/ssSQL14_md.md)] [!INCLUDE[ssRSnoversion](../Token/ssRSnoversion_md.md)] Add\-in for SharePoint Products

-   [!INCLUDE[ssSQL14](../Token/ssSQL14_md.md)] [!INCLUDE[ssRSnoversion](../Token/ssRSnoversion_md.md)] SharePoint Shared Service

 The side\-by\-side installation prevents the [!INCLUDE[ssSQL11](../Token/ssSQL11_md.md)] [!INCLUDE[ssRSnoversion](../Token/ssRSnoversion_md.md)] Native Mode Windows Service from starting. Error messages similar to the following will be seen in the Windows Event log:
 ...
 **Issue:** Report rendering in a multi\-node farm fails if instances of the [!INCLUDE[ssRSnoversion](../Token/ssRSnoversion_md.md)] SharePoint Shared Service are upgraded before all instances of the [!INCLUDE[ssRSnoversion](../Token/ssRSnoversion_md.md)] Add\-in for SharePoint Products.

 **Workaround:** In a multi\-node SharePoint farm:

1.  First upgrade all instances of the [!INCLUDE[ssRSnoversion](../Token/ssRSnoversion_md.md)] Add\-in for SharePoint Products.

2.  Then upgrade all instances of the [!INCLUDE[ssRSnoversion](../Token/ssRSnoversion_md.md)] SharePoint Shared Service.
...
1.  Download the MSOLAP.5 provider from the [!INCLUDE[ssSQL11SP1](../Token/ssSQL11SP1_md.md)] Feature Pack. Install the provider on the application servers running Excel Services. For more information, see the section “Microsoft Analysis Services OLE DB Provider for Microsoft SQL Server 2012 SP1” [Microsoft SQL Server 2012 SP1 Feature Pack](http://www.microsoft.com/download/details.aspx?id=35580).
...
-   [!INCLUDE[ssSQL14](../Token/ssSQL14_md.md)] includes MSOLAP.6. [!INCLUDE[ssSQL11](../Token/ssSQL11_md.md)] and [!INCLUDE[ssSQL14](../Token/ssSQL14_md.md)][!INCLUDE[ssGemini](../Token/ssGemini_md.md)] workbooks use MSOLAP.5. If MSOLAP.5 is not installed on the computer running Excel Services, Excel Services cannot load the data models.

### 6.2 MSOLAP.5 must be downloaded, installed and registered for a SharePoint 2013 new farm configured with SQL Server 2014
 **Issue:**

-   For a SharePoint 2013 farm configured with a [!INCLUDE[ssSQL14](../Token/ssSQL14_md.md)] deployment, Excel workbooks referencing the MSOLAP.5 provider cannot connect to tabula data models because the provider referenced in the connection string is not installed.
...
-   [!INCLUDE[ssSQL14](../Token/ssSQL14_md.md)] includes MSOLAP.6. but SQL Server 2014 PowerPivot workbooks use MSOLAP.5. If MSOLAP.5 is not installed on the computer running Excel Services, Excel Services cannot load the data models.
