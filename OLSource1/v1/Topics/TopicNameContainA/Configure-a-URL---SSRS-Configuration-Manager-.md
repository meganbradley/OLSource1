...
-   For an overview of URL construction and usage in [!INCLUDE[ssRSnoversion](../../Token\Other/ssRSnoversion_md.md)], see [Configure Report Server URLs  &#40;SSRS Configuration Manager&#41;](../Topic/Configure%20Report%20Server%20URLs%20%20\(SSRS%20Configuration%20Manager\).md).  
...
## URLs for Multiple Report Server Instances on the Same Computer  
 If you are reserving URLs for multiple instances of [!INCLUDE[ssRSnoversion](../../Token\Other/ssRSnoversion_md.md)], you should follow naming conventions so that you can avoid naming conflicts. For more information, see [URL Reservations for Multi-Instance Report Server Deployments  &#40;SSRS Configuration Manager&#41;](../Topic/URL%20Reservations%20for%20Multi-Instance%20Report%20Server%20Deployments%20%20\(SSRS%20Configuration%20Manager\).md).  
