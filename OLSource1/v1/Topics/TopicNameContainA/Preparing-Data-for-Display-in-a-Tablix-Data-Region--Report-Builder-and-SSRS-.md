...
```  
 ...
 To sort a table data region according to this sort order, set the sort expression on the detail group to `=Fields!ColorSortOrder.Value`. For more information, see [Sort Data in a Data Region &#40;Report Builder and SSRS&#41;](../Topic/Sort%20Data%20in%20a%20Data%20Region%20\(Report%20Builder%20and%20SSRS\).md).  
