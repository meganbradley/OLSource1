...
-   On a linear gauge, you can specify the width of the start and end margins relative to the endpoints on a linear gauge.  
 ...
 To quickly get started with formatting scales, see [Set a Minimum or Maximum on a Gauge &#40;Report Builder and SSRS&#41;](../Topic/Set%20a%20Minimum%20or%20Maximum%20on%20a%20Gauge%20\(Report%20Builder%20and%20SSRS\).md).  
...
## See Also  
 [Formatting Ranges on a Gauge &#40;Report Builder and SSRS&#41;](../Topic/Formatting%20Ranges%20on%20a%20Gauge%20\(Report%20Builder%20and%20SSRS\).md)   
