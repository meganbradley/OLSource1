...
2.  In the **Dimensions** pane, the dimension set should be set to **All database dimensions**.  
     ...
     Optionally, you can set **Read Definition** and **Process** permissions on individual dimension objects, as long as those permissions are not already set at the database level. See [Grant process permissions &#40;Analysis Services&#41;](../Topic/Grant%20process%20permissions%20\(Analysis%20Services\).md) and [Grant read definition permissions on object metadata &#40;Analysis Services&#41;](../Topic/Grant%20read%20definition%20permissions%20on%20object%20metadata%20\(Analysis%20Services\).md) for details.  
