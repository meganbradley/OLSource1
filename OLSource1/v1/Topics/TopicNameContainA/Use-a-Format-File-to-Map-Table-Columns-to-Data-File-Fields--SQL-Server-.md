...
> [!NOTE]  
>  Either a non\-XML format file or an XML format file can be used to bulk import a data file into the table by using a **bcp** command, BULK INSERT statement, or INSERT ... SELECT \* FROM OPENROWSET\(BULK...\) statement. For more information, see [Use a Format File to Bulk Import Data &#40;SQL Server&#41;](../Topic/Use%20a%20Format%20File%20to%20Bulk%20Import%20Data%20\(SQL%20Server\).md).  
...
> [!NOTE]  
>  For more information about the layout of non\-XML format files, see [Non-XML Format Files &#40;SQL Server&#41;](../Topic/Non-XML%20Format%20Files%20\(SQL%20Server\).md).  
