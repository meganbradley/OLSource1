...
####  <a name="Permissions"></a> Permissions  
 Requires CREATE TYPE permission in the current database and ALTER permission on *schema\_name*. If *schema\_name* is not specified, the default name resolution rules for determining the schema for the current user apply.  
