...
1.  Create a report and define a dataset. For more information, see [Report Datasets &#40;SSRS&#41;](../Topic/Report%20Datasets%20\(SSRS\).md).  
...
10. On the **Run** tab, click **Design** to continue working on the report.  
 ...
 On charts with axes, such as bar and column charts, the category axis may not display all the category labels. For more information about how to change the axis labels, see [Specify an Axis Interval &#40;Report Builder and SSRS&#41;](../Topic/Specify%20an%20Axis%20Interval%20\(Report%20Builder%20and%20SSRS\).md).  
