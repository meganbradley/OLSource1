...
13. To configure the error output, click the **Error Output** page and set the error handling options. For more information, see [Lookup Transformation Editor &#40;Error Output Page&#41;](../Topic/Lookup%20Transformation%20Editor%20\(Error%20Output%20Page\).md).  
