...
7.  In the **Properties** window, update the read\/write variable properties. Some properties are read\/read only for user\-defined variables.  
     ...
     For more information about the properties, see [Integration Services &#40;SSIS&#41; Variables](../Topic/Integration%20Services%20\(SSIS\)%20Variables.md).  
