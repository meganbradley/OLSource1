...
##  <a name="bkmk_userpermissions"></a> User permissions on the database  
 ...
 Roles, and sometimes role membership, are defined when a model is authored in [!INCLUDE[ssBIDevStudioFull](../../Token\Other/ssBIDevStudioFull_md.md)], or for deployed models, by using [!INCLUDE[ssManStudioFull](../../Token\Other/ssManStudioFull_md.md)]. For more information about creating roles by using Role Manager in [!INCLUDE[ssBIDevStudio](../../Token\Other/ssBIDevStudio_md.md)], see [Create and Manage Roles &#40;SSAS Tabular&#41;](../Topic/Create%20and%20Manage%20Roles%20\(SSAS%20Tabular\).md). For more information about creating and managing roles for a deployed model, see [Tabular Model Roles &#40;SSAS Tabular&#41;](../Topic/Tabular%20Model%20Roles%20\(SSAS%20Tabular\).md).  
