...
3.  Click **New Snapshot**. A new snapshot is created in the **When Run** column.  
    ...
    > [!NOTE]  
    >  In order to do this, the report history must be configured by the administrator to **Allow history to be created manually**. For more information, see [Limit Report History &#40;Report Manager&#41;](../Topic/Limit%20Report%20History%20\(Report%20Manager\).md).  
