...
6.  In the line, `SELECT`*\<select list, expr list, \*\>*, type the names of columns in the mining model content schema rowset.  
     ...
     To view a list of columns that you can return in mining model content queries, see [Mining Model Content &#40;Analysis Services - Data Mining&#41;](../Topic/Mining%20Model%20Content%20\(Analysis%20Services%20-%20Data%20Mining\).md).  
