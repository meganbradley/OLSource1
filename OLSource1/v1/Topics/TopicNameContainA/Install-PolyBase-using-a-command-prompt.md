...
-   An external data source, either Windows Azure blob storage, or a supported Hadoop version \(see [PolyBase Connectivity Configuration &#40;Transact-SQL&#41;](../Topic/PolyBase%20Connectivity%20Configuration%20\(Transact-SQL\).md)\).  
