...
###  <a name="trx"></a> Reading the Transaction Context  
 To obtain the current transaction context, use the [!INCLUDE[tsql](../../Topics/TopicNameContainA/includes/tsql_md.md)] [GET_FILESTREAM_TRANSACTION_CONTEXT()](assetId:///459e6b79-4420-41e6-85bf-89d90f43b4f1) function. The following example shows how to begin a transaction and read the current transaction context.  
