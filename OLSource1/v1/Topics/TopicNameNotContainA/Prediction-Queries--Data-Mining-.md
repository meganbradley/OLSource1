...
-   When you create prediction queries using DMX in the Query pane of [!INCLUDE[ssManStudioFull](../../Token\Other/ssManStudioFull_md.md)], you can use the query output options to save the results to a file, or to the Query Results pane as text or in a grid. For more information, see [Query and Text Editors &#40;SQL Server Management Studio&#41;](../Topic/Query%20and%20Text%20Editors%20\(SQL%20Server%20Management%20Studio\).md).  
