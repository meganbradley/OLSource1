...
## Permission requirements  
 You must be an Analysis Services database or server administrator \(a member of the server role\) to run the command. See [Grant database permissions &#40;Analysis Services&#41;](../Topic/Grant%20database%20permissions%20\(Analysis%20Services\).md) or [Grant server admin rights to an  Analysis Services instance](../../Topics\TopicNameNotContainA/Grant-server-admin-rights-to-an--Analysis-Services-instance.md) for instructions.  
...
## See Also  
 [Process Database, Table, or Partition &#40;Analysis Services&#41;](../Topic/Process%20Database,%20Table,%20or%20Partition%20\(Analysis%20Services\).md)   
