...
1.  Call [catalog.deploy_project (SSISDB Database)](assetId:///2e3439b4-7226-4b61-a993-7a1d161eac7e) to deploy the [!INCLUDE[ssISnoversion](../../Topics/TopicNameContainA/includes/ssISnoversion_md.md)] project that contains the package to the [!INCLUDE[ssISnoversion](../../Topics/TopicNameContainA/includes/ssISnoversion_md.md)] server.  
