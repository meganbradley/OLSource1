...
|Topic|Description|  
|-----------|-----------------|  
|[Understanding DAX in Tabular Models &#40;SSAS Tabular&#41;](../Topic/Understanding%20DAX%20in%20Tabular%20Models%20\(SSAS%20Tabular\).md)|Describes the Data Analysis Expressions \(DAX\) formula language used to create calculations for calculated columns, measures, and row filters in tabular models.|  
