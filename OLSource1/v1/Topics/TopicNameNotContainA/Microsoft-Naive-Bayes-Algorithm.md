...
-   **Input columns** In a Naive Bayes model, all columns must be either discrete, or the values must have been binned. For information about how to discretize \(bin\) columns, see [Discretization Methods &#40;Data Mining&#41;](../Topic/Discretization%20Methods%20\(Data%20Mining\).md).  
...
## Viewing the Model  
 ...
 If you want to know more detail, you can browse the model in the [Microsoft Generic Content Tree Viewer &#40;Data Mining&#41;](../Topic/Microsoft%20Generic%20Content%20Tree%20Viewer%20\(Data%20Mining\).md). For more information about the type of information stored in the model, see [Mining Model Content for Naive Bayes Models &#40;Analysis Services - Data Mining&#41;](../Topic/Mining%20Model%20Content%20for%20Naive%20Bayes%20Models%20\(Analysis%20Services%20-%20Data%20Mining\).md).  
