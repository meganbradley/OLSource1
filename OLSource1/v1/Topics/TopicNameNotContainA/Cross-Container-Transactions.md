...
##  <a name="isolation"></a> Isolation of Individual Operations  
 Each [!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/includes/ssNoVersion_md.md)] transaction has an isolation level. The default isolation level is Read Committed. To use a different isolation level, you can set the isolation level using [SET TRANSACTION ISOLATION LEVEL (Transact-SQL)](assetId:///016fb05e-a702-484b-bd2a-a6eabd0d76fd).  
...
### Isolation Semantics for Individual Operations  
 ...
 The general semantics of the transaction isolation levels in [!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/includes/ssNoVersion_md.md)], along with the implications on locking, is explained in [SET TRANSACTION ISOLATION LEVEL (Transact-SQL)](assetId:///016fb05e-a702-484b-bd2a-a6eabd0d76fd).  
