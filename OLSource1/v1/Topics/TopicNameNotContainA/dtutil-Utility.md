...
> [!NOTE]  
>  Many of the operations that are performed by dtutil can also be performed visually in [!INCLUDE[ssManStudioFull](../../Token\Other/ssManStudioFull_md.md)] when you are connected to an instance of [!INCLUDE[ssISnoversion](../../Token\Other/ssISnoversion_md.md)]. For more information, see [Package Management &#40;SSIS Service&#41;](../Topic/Package%20Management%20\(SSIS%20Service\).md).  
