...
|Topic|Description|  
|-----------|-----------------|  
|[Add Columns to a Table &#40;SSAS Tabular&#41;](../Topic/Add%20Columns%20to%20a%20Table%20\(SSAS%20Tabular\).md)|Describes how to add a source column to a table definition.|  
|[Delete a Column &#40;SSAS Tabular&#41;](../Topic/Delete%20a%20Column%20\(SSAS%20Tabular\).md)|Describes how to delete a model table column by using the model designer or by using the Table Properties dialog box.|  
|[Change table, column, or row filter mappings &#40;SSAS Tabular&#41;](../Topic/Change%20table,%20column,%20or%20row%20filter%20mappings%20\(SSAS%20Tabular\).md)|Describes how to change table, column, or row filter mappings by using the table preview or SQL query editor in the Edit Table Properties dialog box.|  
|[Specify Mark as Date Table for use with Time Intelligence &#40;SSAS Tabular&#41;](../Topic/Specify%20Mark%20as%20Date%20Table%20for%20use%20with%20Time%20Intelligence%20\(SSAS%20Tabular\).md)|Describes how to use the Mark as Date Table dialog box to specify a date table and unique identifier column. Specifying a date table and unique identifier is necessary when using time intelligence functions in DAX formulas.|  
|[Add a Table &#40;SSAS Tabular&#41;](../Topic/Add%20a%20Table%20\(SSAS%20Tabular\).md)|Describes how to add a table from a data source by using an existing data source connection.|  
|[Delete a Table &#40;SSAS Tabular&#41;](../Topic/Delete%20a%20Table%20\(SSAS%20Tabular\).md)|Describes how to delete tables in your model workspace database that you no longer need.|  
|[Rename a Table or Column &#40;SSAS Tabular&#41;](../Topic/Rename%20a%20Table%20or%20Column%20\(SSAS%20Tabular\).md)|Describes how to rename a table or column to make it more identifiable in your model.|  
|[Set the Data Type of a Column &#40;SSAS Tabular&#41;](../Topic/Set%20the%20Data%20Type%20of%20a%20Column%20\(SSAS%20Tabular\).md)|Describes how to change the data type of a column. The data type defines how data in the column is stored and presented.|  
|[Hide or Freeze Columns &#40;SSAS Tabular&#41;](../Topic/Hide%20or%20Freeze%20Columns%20\(SSAS%20Tabular\).md)|Describes how to hide columns that you don’t want to display and how to keep an area of a model visible while you scroll to another area of the model by freezing \(locking\) specific columns in one area.|  
