...
1.  Open a new project. The version of the project that you choose determines the version of the RDL schema. In [!INCLUDE[ssCurrent](../../Token\Other/ssCurrent_md.md)], more than one schema version is supported. For more information, see [Deployment and Version Support in SQL Server Data Tools &#40;SSRS&#41;](../Topic/Deployment%20and%20Version%20Support%20in%20SQL%20Server%20Data%20Tools%20\(SSRS\).md).  
