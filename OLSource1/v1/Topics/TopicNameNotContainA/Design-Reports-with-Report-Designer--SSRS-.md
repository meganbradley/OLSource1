...
##  <a name="bkmk_SharedDataSources"></a> Shared Data Sources  
 ...
 In Report Designer, you work in both the Report Data pane and in Solution Explorer to define the data sources used in a report. For more information, see [Report Data Pane](../Topic/Reporting%20Services%20in%20SQL%20Server%20Data%20Tools%20\(SSDT\).md#bkmk_ReportDataPane). You cannot use [!INCLUDE[ssBIDevStudio](../../Token\Other/ssBIDevStudio_md.md)] to open data sources that are published to  a report server or SharePoint site, but not included in the [!INCLUDE[ssBIDevStudio](../../Token\Other/ssBIDevStudio_md.md)] solution. For that feature, use [Report Builder authoring environment &#40;SSRS&#41;](../Topic/Report%20Builder%20authoring%20environment%20\(SSRS\).md).  
  
 [!INCLUDE[ssBIDevStudio](../../Token\Other/ssBIDevStudio_md.md)] is a client tool. You can test your reporting solution locally on your computer, deploy it to a test environment for testing the server solution, and then deploy it to a production environment. After deployment, verify that the data source processing extensions and data source credentials are configured for the report server environment. You can use Configuration Manager to help manage the properties for different deployments. For more information, see [Reporting Services in SQL Server Data Tools &#40;SSDT&#41;](../Topic/Reporting%20Services%20in%20SQL%20Server%20Data%20Tools%20\(SSDT\).md).  
...
##  <a name="bkmk_SharedDatasets"></a> Shared Datasets  
 ...
 In Report Designer, you work in both the Report Data pane and in Solution Explorer to define shared datasets used in a report. For more information, see [Report Data Pane](../Topic/Reporting%20Services%20in%20SQL%20Server%20Data%20Tools%20\(SSDT\).md#bkmk_ReportDataPane). You cannot use [!INCLUDE[ssBIDevStudio](../../Token\Other/ssBIDevStudio_md.md)] to open published datasets directly from a report server or SharePoint site. For that feature, use [Report Builder authoring environment &#40;SSRS&#41;](../Topic/Report%20Builder%20authoring%20environment%20\(SSRS\).md) in Shared Dataset mode.  
  
 [!INCLUDE[ssBIDevStudio](../../Token\Other/ssBIDevStudio_md.md)] is a client tool. You can use query designers to help create and test your query results locally in Preview. After deployment, you can manage shared datasets independently from the shared data sources and reports that they depend on. For more information, see [Report Embedded Datasets and Shared Datasets &#40;Report Builder and SSRS&#41;](../Topic/Report%20Embedded%20Datasets%20and%20Shared%20Datasets%20\(Report%20Builder%20and%20SSRS\).md), [Query Design Tools &#40;SSRS&#41;](../Topic/Query%20Design%20Tools%20\(SSRS\).md), and [Manage Shared Datasets](../../Topics\TopicNameNotContainA/Manage-Shared-Datasets.md).  
...
-   **Work directly in RDL.** When you write a report in Report Designer, the report is saved in XML format as a Report Definition Language \(RDL\) file. You can edit this file in Report Designer, a text editor, or any tool in which you can edit XML.  
     ...
     For more information, see [Report Definition Language &#40;SSRS&#41;](../Topic/Report%20Definition%20Language%20\(SSRS\).md).  
  
 ![Arrow icon used with Back to Top link](../../Images\Image\ImageNotContaina/UpArrow16x16.gif "UpArrow16x16") [Back to Top](#bkmk_Top)  
  
##  <a name="bkmk_ReportParts"></a> Report Parts  
 In Report Designer, after you create tables, charts, and other report items in a project, you can publish them as *report parts* to a report server or SharePoint site integrated with a report server so that you and others can reuse them in other reports. For more information, see [Report Parts in Report Designer &#40;SSRS&#41;](../Topic/Report%20Parts%20in%20Report%20Designer%20\(SSRS\).md).  
  
 Report parts can be deployed independently from other items in a project by using **TargetReportPartFolder** and other properties. For more information, see [Set Deployment Properties &#40;Reporting Services&#41;](../Topic/Set%20Deployment%20Properties%20\(Reporting%20Services\).md).  
  
 ![Arrow icon used with Back to Top link](../../Images\Image\ImageNotContaina/UpArrow16x16.gif "UpArrow16x16") [Back to Top](#bkmk_Top)  
  
##  <a name="bkmk_Resources"></a> Resources  
 You can add files to your project that are related to your report but not processed by the report server. For example, you can add images for pictures or ESRI shapefiles for spatial data. For more information, see [Resources](../Topic/Report%20Server%20Content%20Management%20\(SSRS%20Native%20Mode\).md#bkmk_Resources).  
...
##  <a name="bkmk_Preview"></a> Preview  
 Use **Preview** to verify the report data and layout design. When you preview a report, the report processor validates the report definition schema and expression syntax and lists issues in the [Output](../Topic/Reporting%20Services%20in%20SQL%20Server%20Data%20Tools%20\(SSDT\).md#bkmk_Output) window.  
...
## See Also  
 [Reporting Services in SQL Server Data Tools &#40;SSDT&#41;](../Topic/Reporting%20Services%20in%20SQL%20Server%20Data%20Tools%20\(SSDT\).md)   
 [Query Design Tools &#40;SSRS&#41;](../Topic/Query%20Design%20Tools%20\(SSRS\).md)   
 [Deployment and Version Support in SQL Server Data Tools &#40;SSRS&#41;](../Topic/Deployment%20and%20Version%20Support%20in%20SQL%20Server%20Data%20Tools%20\(SSRS\).md)  
