...
```  
 ...
 Line 3 backs up the Contoso\_Retail sample database on the remote Analysis Services server to an Analysis Services backup file named test.abf, also on the remote server. The file is saved to the default backup folder of the default instance.  
