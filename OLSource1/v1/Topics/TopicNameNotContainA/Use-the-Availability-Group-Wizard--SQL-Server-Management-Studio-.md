...
> [!NOTE]  
>  As an alternative to using the New Availability Group Wizard, you can use [!INCLUDE[tsql](../../Token\Other/tsql_md.md)] or [!INCLUDE[ssNoVersion](../../Token\Other/ssNoVersion_md.md)] PowerShell cmdlets. For more information, see [Create an Availability Group &#40;Transact-SQL&#41;](../Topic/Create%20an%20Availability%20Group%20\(Transact-SQL\).md) or [Create an Availability Group &#40;SQL Server PowerShell&#41;](../Topic/Create%20an%20Availability%20Group%20\(SQL%20Server%20PowerShell\).md).  
