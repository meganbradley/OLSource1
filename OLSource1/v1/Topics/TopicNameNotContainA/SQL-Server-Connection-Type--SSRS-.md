...
##  <a name="Remarks"></a> Remarks  
 You can also retrieve data from a [!INCLUDE[ssNoVersion](../../Token\Other/ssNoVersion_md.md)] database by using an OLE DB or ODBC data source type. For more information, see [OLE DB Connection Type &#40;SSRS&#41;](../Topic/OLE%20DB%20Connection%20Type%20\(SSRS\).md) or [ODBC Connection Type &#40;SSRS&#41;](../Topic/ODBC%20Connection%20Type%20\(SSRS\).md).  
