...
## Locking Table Hints  
 Locking hints ([Table Hints](assetId:///8bf1316f-c0ef-49d0-90a7-3946bc8e7a89)) such as HOLDLOCK and XLOCK can be used with disk-based tables to have [!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/includes/ssNoVersion_md.md)] take more locks than are required for the specified isolation level.  
