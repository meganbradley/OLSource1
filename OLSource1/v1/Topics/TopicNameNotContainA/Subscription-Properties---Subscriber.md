...
-   **Default location**: the default location, which is defined when configuring a Distributor. For more information, see [Specify the Default Snapshot Location &#40;SQL Server Management Studio&#41;](../Topic/Specify%20the%20Default%20Snapshot%20Location%20\(SQL%20Server%20Management%20Studio\).md).  
