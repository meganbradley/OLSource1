...
3.  Right\-click the database, point to **Tasks**, point to **Restore**, and then click **Page**, which opens the **Restore Page** dialog box.  
     ...
     **Restore**  
     This section performs the same function as that of **Restore to** on the [Restore Database \(General Page\)](../Topic/Restore%20Database%20\(General%20Page\).md).  
...
5.  The pages grid is used to identify the pages to be restored. Initially, this grid is populated from the [suspect\_pages](../Topic/suspect_pages%20\(Transact-SQL\).md) system table. To add or remove pages from the grid, click **Add** or **Remove**. For more information, see [Manage the suspect_pages Table &#40;SQL Server&#41;](../Topic/Manage%20the%20suspect_pages%20Table%20\(SQL%20Server\).md).  
...
1.  Obtain the page IDs of the damaged pages to be restored. A checksum or torn write error returns page ID, providing the information required for specifying the pages. To look up page ID of a damaged page, use any of the following sources.  
    ...
    |-----------------------|-----------|  
    |**msdb..suspect\_pages**|[Manage the suspect_pages Table &#40;SQL Server&#41;](../Topic/Manage%20the%20suspect_pages%20Table%20\(SQL%20Server\).md)|  
    |Error log|[View the SQL Server Error Log &#40;SQL Server Management Studio&#41;](../Topic/View%20the%20SQL%20Server%20Error%20Log%20\(SQL%20Server%20Management%20Studio\).md)|  
