...
8.  To verify that remote connections are enabled, open SQL Server Management Studio or Excel on a different computer and connect to [!INCLUDE[ssASnoversion](../../Token\Other/ssASnoversion_md.md)] by specifying the network name of the server in **Server name**.  
    ...
    > [!NOTE]  
    >  Other users will not have access to this server until you grant permissions. For more information, see [Authorizing access to objects and operations &#40;Analysis Services&#41;](../Topic/Authorizing%20access%20to%20objects%20and%20operations%20\(Analysis%20Services\).md).  
...
## See Also  
 [SQL Server Browser Service &#40;Database Engine and SSAS&#41;](../Topic/SQL%20Server%20Browser%20Service%20\(Database%20Engine%20and%20SSAS\).md)   
