...
> [!NOTE]  
>  In previous releases, there were multiple trace log files, one for each application. The following files are obsolete and are no longer created in [!INCLUDE[ssKatmai](../../Topics/TopicNameContainA/includes/ssKatmai_md.md)] and later versions: ReportServerWebApp_*<timestamp\>*.log, ReportServer_*<timestamp\>*.log, and ReportServerService_main_*<timestamp\>*.log.  
...
##  <a name="bkmk_view_log"></a> Where are the Report Server log files?  
 ...
 ![view a video about Power Query and SSRS logs](../../Topics/TopicNameNotContainA/media/generic_video_thumbnail.png "generic_video_thumbnail")  
