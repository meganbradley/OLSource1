...
1.  In the registry, navigate to the following node: **HKEY\_LOCAL\_MACHINE\\SOFTWARE\\Microsoft\\Microsoft SQL Server\\\<InstanceRoot\>\\MSSearch\\CLSID**.  
...
3.  In the registry, navigate to the following node: **HKEY\_LOCAL\_MACHINE\\SOFTWARE\\Microsoft\\Microsoft SQL Server\\\<InstanceRoot\>\\MSSearch\\Language\\enu**.  
...
3.  In the registry, navigate to the following node: **HKEY\_LOCAL\_MACHINE\\SOFTWARE\\Microsoft\\Microsoft SQL Server\\\<InstanceRoot\>\\MSSearch\\Language\\eng**.  
