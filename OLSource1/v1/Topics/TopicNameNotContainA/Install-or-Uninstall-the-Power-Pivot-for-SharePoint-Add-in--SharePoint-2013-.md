...
-   For more information on [!INCLUDE[ssGeminiShort](../../Topics/TopicNameNotContainA/includes/ssGeminiShort_md.md)] requirements and pre-requisites, go to [Hardware and Software Requirements for Analysis Services Server in SharePoint Mode (SharePoint 2013)](assetId:///fb86ca0a-518c-4c61-ae78-7680c57fae1f).  
