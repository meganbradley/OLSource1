...
> [!NOTE]  
>  The first task for the control flow is to calculate the endpoints of the change interval. For more information about this task, see [Specify an Interval of Change Data](../../Topics\TopicNameNotContainA/Specify-an-Interval-of-Change-Data.md). For a description of the overall process of designing the control flow, see [Change Data Capture &#40;SSIS&#41;](../Topic/Change%20Data%20Capture%20\(SSIS\).md).  
