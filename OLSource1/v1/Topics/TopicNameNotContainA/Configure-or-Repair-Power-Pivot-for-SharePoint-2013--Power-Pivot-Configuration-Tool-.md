...
||Maximum File Size \(in MB\)|Default, if needed|Default setting is 2047. SharePoint document libraries also have a maximum size and the [!INCLUDE[ssGemini](../../Token\Other/ssGemini_md.md)] setting should not exceed the document library setting. For more information, see [Configure Maximum File Upload Size &#40;Power Pivot for SharePoint&#41;](../Topic/Configure%20Maximum%20File%20Upload%20Size%20\(Power%20Pivot%20for%20SharePoint\).md).|  
...
## Verify the Configuration  
 See the “Verify [!INCLUDE[ssGemini](../../Token\Other/ssGemini_md.md)] Configuration“ section of [Configure Power Pivot and Deploy Solutions &#40;SharePoint 2013&#41;](../Topic/Configure%20Power%20Pivot%20and%20Deploy%20Solutions%20\(SharePoint%202013\).md).  
