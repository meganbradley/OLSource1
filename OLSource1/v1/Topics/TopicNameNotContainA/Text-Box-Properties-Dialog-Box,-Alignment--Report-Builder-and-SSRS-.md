...
## Options  
 **Horizontal**  
 Specify where the value is positioned horizontally within a selected cell or data region. By default, **Default** is selected. The value for Default is **General**. For more information about how general text alignment is calculated, see [Formatting Text and Placeholders &#40;Report Builder and SSRS&#41;](../Topic/Formatting%20Text%20and%20Placeholders%20\(Report%20Builder%20and%20SSRS\).md). Click the **Expression** \(*fx*\) button to edit the expression.  
