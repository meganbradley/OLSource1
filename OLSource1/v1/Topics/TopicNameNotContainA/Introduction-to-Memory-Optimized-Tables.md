...
## Performance and Scalability  
 ...
 [!INCLUDE[tsql](../../Topics/TopicNameContainA/includes/tsql_md.md)] Execution  
...
## Scenarios  
 For a brief discussion of typical scenarios where [!INCLUDE[hek_1](../../Topics/TopicNameContainA/includes/hek_1_md.md)] can improve performance, see [In-Memory OLTP](https://msdn.microsoft.com/en-us/library/dn133186.aspx).  
