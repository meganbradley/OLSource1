...
# Recovery of Related  Databases That Contain Marked Transaction
 ...
 For information about the requirements for restoring to a specific recovery point, see [Restore a SQL Server Database to a Point in Time &#40;Full Recovery Model&#41;](../Topic/Restore%20a%20SQL%20Server%20Database%20to%20a%20Point%20in%20Time%20\(Full%20Recovery%20Model\).md).  
...
1.  Create [tail\-log backups](../Topic/Tail-Log%20Backups%20\(SQL%20Server\).md) of the undamaged databases, if possible.  
