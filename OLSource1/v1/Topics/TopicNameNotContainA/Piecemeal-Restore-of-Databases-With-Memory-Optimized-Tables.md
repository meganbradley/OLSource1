...
-   Piecemeal restore.  
    ...
    -   Using page repair, you can fix page corruption by specifically restoring the page. For more information, see [Restore Pages &#40;SQL Server&#41;](../Topic/Restore%20Pages%20\(SQL%20Server\).md).  
