 ...
 **Back up the tail of the log, and leave the database in the restoring state**  
 ...
 Selecting this option is equivalent to specifying WITH NO_TRUNCATE, NORECOVERY in a [BACKUP](assetId:///89a4658a-62f1-4289-8982-f072229720a1) statement ([!INCLUDE[tsql](../../Topics/TopicNameContainA/includes/tsql_md.md)]). For more information, see [Tail-Log Backups (SQL Server)](../../Topics/TopicNameNotContainA/Tail-Log-Backups--SQL-Server-.md).  
