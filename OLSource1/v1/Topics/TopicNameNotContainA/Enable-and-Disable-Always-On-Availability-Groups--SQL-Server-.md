...
-   The only supported Always On [!INCLUDE[tsql](../../Topics/TopicNameContainA/includes/tsql_md.md)] statement is [DROP AVAILABILITY GROUP](assetId:///c1600289-c990-454a-b279-dba0ebd5d63e). CREATE AVAILABILITY GROUP, ALTER AVAILABILITY GROUP, and the SET HADR options of ALTER DATABASE are not supported.  
