...
1.  Add one or more articles through one of the following methods:  
    ...
    -   [Add Articles to and Drop Articles from a Publication &#40;SQL Server Management Studio&#41;](../Topic/Add%20Articles%20to%20and%20Drop%20Articles%20from%20a%20Publication%20\(SQL%20Server%20Management%20Studio\).md)  
...
1.  Dropping an article from a publication involves dropping the article and creating a new snapshot for the publication. Dropping an article invalidates the current snapshot; therefore a new snapshot must be created.  
    ...
    -   To drop an article from a publication, see [Add Articles to and Drop Articles from a Publication &#40;SQL Server Management Studio&#41;](../Topic/Add%20Articles%20to%20and%20Drop%20Articles%20from%20a%20Publication%20\(SQL%20Server%20Management%20Studio\).md) or [Delete an Article](../../Topics\TopicNameNotContainA/Delete-an-Article.md).  
