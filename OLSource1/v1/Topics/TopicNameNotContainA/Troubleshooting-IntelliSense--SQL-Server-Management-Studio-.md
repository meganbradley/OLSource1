...
-   The automatic options are turned off.  
     ...
     Even when automatic statement completion is disabled, you can use an IntelliSense feature. For more information, see [Configure IntelliSense &#40;SQL Server Management Studio&#41;](../Topic/Configure%20IntelliSense%20\(SQL%20Server%20Management%20Studio\).md).  
