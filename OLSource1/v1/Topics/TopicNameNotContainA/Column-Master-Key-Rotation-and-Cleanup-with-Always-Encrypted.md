...
### Using [!INCLUDE[tsql](../../Topics/TopicNameContainA/includes/tsql_md.md)]  
 See [CREATE COLUMN MASTER KEY (Transact-SQL)](assetId:///f8926b95-e146-4e3f-b56b-add0c0d0a30e) for how to provision a new column master key programmatically or from command line, and for how to define it in the database by using [!INCLUDE[tsql](../../Topics/TopicNameContainA/includes/tsql_md.md)].  
