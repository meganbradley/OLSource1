...
|Topic|Description|  
|-----------|-----------------|  
|[Create and Manage Perspectives &#40;SSAS Tabular&#41;](../Topic/Create%20and%20Manage%20Perspectives%20\(SSAS%20Tabular\).md)|Describes how to create and manage perspectives using the Perspectives dialog box in the model designer.|  
