 ...
 **Example: Setting max server memory**  
 ...
 This example uses the [sp_configure](assetId:///d18b251d-b37a-4f5f-b50c-502d689594c8) and [RECONFIGURE](assetId:///2e6e4eeb-b70b-4f45-a253-28ac4e595d75)[!INCLUDE[tsql](../../Topics/TopicNameContainA/includes/tsql_md.md)] statements to set **max server memory** to the value calculated for *M* in the preceding example, `7052`:  
