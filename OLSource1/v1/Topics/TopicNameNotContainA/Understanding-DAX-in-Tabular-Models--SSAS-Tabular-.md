...
### Measures  
 ...
 For more information, see [Measures &#40;SSAS Tabular&#41;](../Topic/Measures%20\(SSAS%20Tabular\).md).  
...
### Row Filters  
 ...
 For more information, see [Roles &#40;SSAS Tabular&#41;](../Topic/Roles%20\(SSAS%20Tabular\).md).  
...
|N\/A|Blank|A blank is a data type in DAX that represents and replaces SQL nulls. You can create a blank by using the BLANK function, and test for blanks by using the logical function, ISBLANK.|  
 ...
 For detailed information about data types in tabular models and explicit and implicit conversions of data types in DAX, see [Data Types Supported &#40;SSAS Tabular&#41;](../Topic/Data%20Types%20Supported%20\(SSAS%20Tabular\).md).  
...
-   The values calculated by measures are dynamically evaluated whenever a user adds the measure to a pivot table or open a report; as the user modifies the context, values returned by the measure change. The results of the measure always reflect the latest in the in\-memory cache.  
 ...
 For more information, see [Process Data &#40;SSAS Tabular&#41;](../Topic/Process%20Data%20\(SSAS%20Tabular\).md).  
