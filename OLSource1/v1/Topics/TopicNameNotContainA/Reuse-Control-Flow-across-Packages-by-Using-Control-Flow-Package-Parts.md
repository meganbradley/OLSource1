...
## Create a new control flow package part  
 ...
 ![Create a new control flow template](../../Topics/TopicNameNotContainA/media/Control-flow-templates-create-new.png "Control)  
 ...
 ![Control flow templates in toolbox](../../Topics/TopicNameNotContainA/media/Control-flow-templates-in-toolbox.png "Control)  
...
## Design a control flow package part  
 ...
 ![Step 1 of control flow template design](../../Topics/TopicNameNotContainA/media/Control-flow-template-design-step-1.png "Control)  
  
 ![Step 2 of control flow template design](../../Topics/TopicNameNotContainA/media/Control-flow-template-design-step-2.png "Control)  
...
### Drag and drop a control flow package part  
 ...
 ![Add a control flow template to a package](../../Topics/TopicNameNotContainA/media/Control-flow-templates-add-to-package.png "Control)  
  
 ![Package with multiple control flow templates](../../Topics/TopicNameNotContainA/media/Control-flow-templates-in-package.png "Control)  
...
-   If the package does not use parts, the designer deletes any previously created .dtsx.designer file for the package (that is, any .dtsx.designer file that has the same name as the package).  
 ...
 ![Solution Explorer with control flow templates](../../Topics/TopicNameNotContainA/media/Control-flow-templates-in-Solution-Explorer.png "Control)  
...
### Add a copy of an existing control flow package part or a reference to an existing part  
 ...
 ![Add a new control flow templates from the menu](../../Topics/TopicNameNotContainA/media/Control-flow-templates-add-from-menu.png "Control)  
  
 ![Add Copy of Existing Templates dialog box](../../Topics/TopicNameNotContainA/media/Control-flow-templates-Add-Copy-dialog.png "Control)  
...
### Properties tab  
 ...
 ![Properties tab of the Template Configuration dialog box](../../Topics/TopicNameNotContainA/media/Template-Configuration-Properties-tab.png "Template)  
...
### Connection Managers tab  
 ...
 ![Connection Managers tab of the Template Configuration dialog box](../../Topics/TopicNameNotContainA/media/Template-Configuration-Connection-Managers-tab.png "Template)  
...
-   Finally all the content, which no longer includes part information, is saved back to the “.dtsx” package file. This is the file that the SSIS runtime runs.  
 ...
 ![Control flow templates files and flow](../../Topics/TopicNameNotContainA/media/Control-flow-templates-intro.png "Control)