...
-   A graph of links between Web pages  
 ...
 Use [hierarchyid](assetId:///69b756e0-a1df-45b3-8a24-6ded8658aefe) as a data type to create tables with a hierarchical structure, or to describe the hierarchical structure of data that is stored in another location. Use the [hierarchyid functions](assetId:///01a050f5-7580-4d5f-807c-7f11423cbb06) in [!INCLUDE[tsql](../../Topics/TopicNameContainA/includes/tsql_md.md)] to query and manage hierarchical data.  
