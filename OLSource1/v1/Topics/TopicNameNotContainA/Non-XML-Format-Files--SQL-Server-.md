...
-   You can create a format file for a particular data type such as character data or native data.  
     ...
     You can create a non\-XML format file that contains interactively specified attributes for each data field. For more information, see [Specify Data Formats for Compatibility when Using bcp &#40;SQL Server&#41;](../Topic/Specify%20Data%20Formats%20for%20Compatibility%20when%20Using%20bcp%20\(SQL%20Server\).md).  
  
> [!NOTE]  
>  XML format files offer several advantages over non\-XML format files. For more information, see [XML Format Files &#40;SQL Server&#41;](../Topic/XML%20Format%20Files%20\(SQL%20Server\).md).  
