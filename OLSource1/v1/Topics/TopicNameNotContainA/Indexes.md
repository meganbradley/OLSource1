...
|XML|A shredded, and persisted, representation of the XML binary large objects \(BLOBs\) in the **xml** data type column.|[XML Indexes &#40;SQL Server&#41;](../Topic/XML%20Indexes%20\(SQL%20Server\).md)|  
