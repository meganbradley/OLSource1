...
4.  The required actions are performed based on the specified command. If you just chose to install [!INCLUDE[ssDQSServer](../../Topics/TopicNameContainA/includes/ssDQSServer_md.md)] without any command-line parameters, rest of the steps are same as described in steps 2-6 in the previous section, [Run DQSInstaller.exe from Start menu or Windows Explorer](../Topic/Run%20DQSInstaller.exe%20to%20Complete%20Data%20Quality%20Server%20Installation.md#WindowsExplorer).  
