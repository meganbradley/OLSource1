...
-   For multidimensional, see [Processing Options and Settings &#40;Analysis Services&#41;](../Topic/Processing%20Options%20and%20Settings%20\(Analysis%20Services\).md).  
  
-   For tabular, see [Process Database, Table, or Partition &#40;Analysis Services&#41;](../Topic/Process%20Database,%20Table,%20or%20Partition%20\(Analysis%20Services\).md).  
...
### \-RefreshType \<Microsoft.AnalysisServices.RefreshType\>  
 Specifies the process type for a Tabular database at compatibility level 1200.  Valid values are  Full, ClearValues, Calculate, DataOnly,  Automatic, Add, and  Defragment. See [Process Database, Table, or Partition &#40;Analysis Services&#41;](../Topic/Process%20Database,%20Table,%20or%20Partition%20\(Analysis%20Services\).md) for descriptions and guidance.  
