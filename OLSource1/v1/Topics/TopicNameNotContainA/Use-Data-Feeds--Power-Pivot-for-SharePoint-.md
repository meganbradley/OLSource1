...
##  <a name="rsreport"></a> Create a Data Feed from a Reporting Services Report  
 ...
 For instructions on how to export a data feed from a report, see [Generate Data Feeds from a Report &#40;Report Builder and SSRS&#41;](../Topic/Generate%20Data%20Feeds%20from%20a%20Report%20\(Report%20Builder%20and%20SSRS\).md) in the [Report Builder help file](http://go.microsoft.com/fwlink/?LinkId=154494).  
  
> [!NOTE]  
>  To set up a recurring data refresh schedule that re\-imports report data into a [!INCLUDE[ssGemini](../../Token\Other/ssGemini_md.md)] workbook that is published to a SharePoint library, the report server must be configured for SharePoint integration. For more information about using [!INCLUDE[ssGemini](../../Token\Other/ssGemini_md.md)] for SharePoint and Reporting Services together, see [Configuration and Administration of a Report Server &#40;Reporting Services SharePoint Mode&#41;](../Topic/Configuration%20and%20Administration%20of%20a%20Report%20Server%20\(Reporting%20Services%20SharePoint%20Mode\).md).  
...
1.  Open a data feed library that was created by your site administrator. For more information, see [Create or Customize a Data Feed Library &#40;Power Pivot for SharePoint&#41;](../Topic/Create%20or%20Customize%20a%20Data%20Feed%20Library%20\(Power%20Pivot%20for%20SharePoint\).md).  
