...
-   [View or Change Server Properties &#40;SQL Server&#41;](../Topic/View%20or%20Change%20Server%20Properties%20\(SQL%20Server\).md)  
 ...
 **FILESTREAM Share Name**  
 Displays the read\-only name of the FILESTREAM share that was selected during setup. For more information, see [FILESTREAM &#40;SQL Server&#41;](../Topic/FILESTREAM%20\(SQL%20Server\).md).  
