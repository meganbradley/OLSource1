...
## Implementation of the Microsoft Naive Bayes Algorithm  
 ...
 For a description of how probabilities in all models are adjusted to account for potential missing values, see [Missing Values &#40;Analysis Services - Data Mining&#41;](../Topic/Missing%20Values%20\(Analysis%20Services%20-%20Data%20Mining\).md).  
  
### Feature Selection  
 The [!INCLUDE[msCoName](../../Token\Other/msCoName_md.md)] Naive Bayes algorithm performs automatic feature selection to limit the number of values that are considered when building the model. For more information, see [Feature Selection &#40;Data Mining&#41;](../Topic/Feature%20Selection%20\(Data%20Mining\).md).  
