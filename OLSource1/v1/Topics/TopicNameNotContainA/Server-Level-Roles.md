...
```  
 ...
 For more information about permissions, see [Permissions &#40;Database Engine&#41;](../Topic/Permissions%20\(Database%20Engine\).md) and [sys.fn_builtin_permissions &#40;Transact-SQL&#41;](../Topic/sys.fn_builtin_permissions%20\(Transact-SQL\).md).  
