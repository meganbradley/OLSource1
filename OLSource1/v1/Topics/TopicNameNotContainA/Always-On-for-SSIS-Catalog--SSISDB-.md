...
1.  [Prerequisites](../Topic/Always%20On%20for%20SSIS%20Catalog%20\(SSISDB\).md#prereq)  
  
2.  [Configure SSIS support for Always On](../Topic/Always%20On%20for%20SSIS%20Catalog%20\(SSISDB\).md#Firsttime)  
  
3.  [Upgrading SSISDB in an availability group](../Topic/Always%20On%20for%20SSIS%20Catalog%20\(SSISDB\).md#Upgrade)  
...
-   [Step 1: Create Integration Services Catalog](../Topic/Always%20On%20for%20SSIS%20Catalog%20\(SSISDB\).md#Step1)  
  
-   [Step 2: Add SSISDB to an Always On Availability Group](../Topic/Always%20On%20for%20SSIS%20Catalog%20\(SSISDB\).md#Step2)  
  
-   [Step 3: Enable SSIS support for Always On](../Topic/Always%20On%20for%20SSIS%20Catalog%20\(SSISDB\).md#Step3)  
...
1.  Remove the SSISDB database from the availability group. For more info, see [Remove a Secondary Database from an Availability Group &#40;SQL Server&#41;](../Topic/Remove%20a%20Secondary%20Database%20from%20an%20Availability%20Group%20\(SQL%20Server\).md) and [Remove a Primary Database from an Availability Group &#40;SQL Server&#41;](../Topic/Remove%20a%20Primary%20Database%20from%20an%20Availability%20Group%20\(SQL%20Server\).md).  
...
4.  Follow the instructions in [Step 2: Add SSISDB to an Always On Availability Group](../Topic/Always%20On%20for%20SSIS%20Catalog%20\(SSISDB\).md#Step2) to add the SSISDB back to an availability group.  
  
5.  Follow the instructions in [Step 3: Enable SSIS support for Always On](../Topic/Always%20On%20for%20SSIS%20Catalog%20\(SSISDB\).md#Step3).  
