...
### Query Identifies Missing Statistics  
 ...
 Missing statistics are indicated as warnings \(table name in red text\) when the execution plan of a query is graphically displayed using [!INCLUDE[ssManStudioFull](../../Token\Other/ssManStudioFull_md.md)]. Additionally, monitoring the **Missing Column Statistics** event class by using [!INCLUDE[ssSqlProfiler](../../Token\Other/ssSqlProfiler_md.md)] indicates when statistics are missing. For more information, see [Errors and Warnings Event Category &#40;Database Engine&#41;](../Topic/Errors%20and%20Warnings%20Event%20Category%20\(Database%20Engine\).md).  
