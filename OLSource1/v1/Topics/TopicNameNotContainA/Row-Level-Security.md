...
---
# Row-Level Security
![Row level security graphic](../../Topics/TopicNameNotContainA/media/Row-level-security-graphic.png "Row)  
 ...
 Implement RLS by using the [CREATE SECURITY POLICY](assetId:///d6ab70ee-0fa2-469c-96f6-a3c16d673bc8)[!INCLUDE[tsql](../../Topics/TopicNameContainA/includes/tsql_md.md)] statement, and predicates created as [inline table valued functions](../../Topics/TopicNameNotContainA/Create-User-defined-Functions--Database-Engine-.md).  
