...
# Row-Level Security
 ...
 Implement RLS by using the [CREATE SECURITY POLICY](../Topic/CREATE%20SECURITY%20POLICY%20\(Transact-SQL\).md)[!INCLUDE[tsql](../../Token\Other/tsql_md.md)] statement, and predicates created as [inline table valued functions](../Topic/Create%20User-defined%20Functions%20\(Database%20Engine\).md).  
