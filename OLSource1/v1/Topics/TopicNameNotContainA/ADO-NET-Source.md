...
-   If the data is a large UDT, the system converts the data to DT_IMAGE.  
 ...
 For information about mapping [!INCLUDE[ssISnoversion](../../Topics/TopicNameContainA/includes/ssISnoversion_md.md)] data types to managed data types, see [Mapping Data Types in the Data Flow](assetId:///941260d0-4ec3-4bf0-ab48-2b26733e6b24).  
