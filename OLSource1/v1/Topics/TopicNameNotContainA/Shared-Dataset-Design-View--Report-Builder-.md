...
# Shared Dataset Design View (Report Builder)
 ...
 For more information about working with data in a report, see [Report Datasets &#40;SSRS&#41;](../Topic/Report%20Datasets%20\(SSRS\).md).  
...
> [!NOTE]  
>  A shared dataset must be based on a shared data source. If the data source you need isn't available, you need to create one on the report server. For more information, see [Create, Modify, and Delete Shared Data Sources &#40;SSRS&#41;](../Topic/Create,%20Modify,%20and%20Delete%20Shared%20Data%20Sources%20\(SSRS\).md) .  
...
-   Parameters. You can add a parameter or edit parameter options. For example, you can specify a default value for each parameter so that you can create a cache refresh plan for this shared dataset on the report server.  
 ...
 For more information about cache refresh plans, see [Cache Shared Datasets &#40;SSRS&#41;](../Topic/Cache%20Shared%20Datasets%20\(SSRS\).md).  
...
### Query Designer  
 ...
 For more information, see the topic that corresponds to the data source type in [Add Data from External Data Sources &#40;SSRS&#41;](../Topic/Add%20Data%20from%20External%20Data%20Sources%20\(SSRS\).md).  
