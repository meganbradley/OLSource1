...
1.  Verify that [!INCLUDE[ssSB](../../Topics/TopicNameContainA/includes/ssSB_md.md)] is enabled for the msdb database by running the following query.  
    ...
    ```  
     ...
     For more information about enabling [!INCLUDE[ssSB](../../Topics/TopicNameContainA/includes/ssSB_md.md)], see [ALTER DATABASE (Transact-SQL)](assetId:///15f8affd-8f39-4021-b092-0379fc6983da).  
