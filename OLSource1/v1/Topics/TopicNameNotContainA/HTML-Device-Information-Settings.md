...
|**LinkTarget**|The target for hyperlinks in the report. You can target a window or frame by providing the name of the window, like **LinkTarget**\=*window\_name*, or you can target a new window using **LinkTarget**\=\_blank. Other valid target names include \_self, \_parent, and \_top.|  
