...
---
# Drop XML Indexes
The [DROP INDEX](assetId:///2b1464c8-934c-405f-8ef7-2949346b5372)[!INCLUDE[tsql](../../Topics/TopicNameContainA/includes/tsql_md.md)] statement can be used to drop existing primary or secondary XML and non-XML indexes. However, no options of DROP INDEX apply to XML indexes. If you drop the primary XML index, any secondary indexes that are present are also deleted.  
