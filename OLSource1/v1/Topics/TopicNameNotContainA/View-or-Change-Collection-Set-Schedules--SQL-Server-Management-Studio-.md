 ...
 **Server**  
 Displays the name of the server that hosts the management data warehouse. For more information, see [Configure the Management Data Warehouse &#40;SQL Server Management Studio&#41;](../Topic/Configure%20the%20Management%20Data%20Warehouse%20\(SQL%20Server%20Management%20Studio\).md).  
  
 **Management data warehouse**  
 Displays the name of the management data warehouse. For more information, see [Configure the Management Data Warehouse &#40;SQL Server Management Studio&#41;](../Topic/Configure%20the%20Management%20Data%20Warehouse%20\(SQL%20Server%20Management%20Studio\).md).  
