...
## Logins  
 ...
 If a user is orphaned, create the login on the new primary\/principal server instance and run [sp\_change\_users\_login](../Topic/sp_change_users_login%20\(Transact-SQL\).md). For more information, see [Troubleshoot Orphaned Users &#40;SQL Server&#41;](../Topic/Troubleshoot%20Orphaned%20Users%20\(SQL%20Server\).md).  
