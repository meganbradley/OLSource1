...
#### Grid Density  
 ...
 The [CREATE SPATIAL INDEX](assetId:///ee6b9116-a7ff-463a-a9f0-b360804d8678)[!INCLUDE[tsql](../../Topics/TopicNameContainA/includes/tsql_md.md)] statement supports a GRIDS clause that enables you to specify different grid densities at different levels. The grid density for a given level is specified by using one of the following keywords.  
...
#### Cells-Per-Object Rule  
 ...
 By default, the cells-per-object limit is 16 cells per object, which provides a satisfactory trade-off between space and precision for most spatial indexes. However, the [CREATE SPATIAL INDEX](assetId:///ee6b9116-a7ff-463a-a9f0-b360804d8678)[!INCLUDE[tsql](../../Topics/TopicNameContainA/includes/tsql_md.md)] statement supports a CELLS_PER_OBJECT**=***n* clause that enables you to specify a cells-per-object limit between 1 and 8192, inclusive.  
...
> [!NOTE]  
>  You can explicitly specify this tessellation scheme by using the USING (GEOMETRY_AUTO_GRID/GEOMETRY_GRID) clause of the [CREATE SPATIAL INDEX](assetId:///ee6b9116-a7ff-463a-a9f0-b360804d8678)[!INCLUDE[tsql](../../Topics/TopicNameContainA/includes/tsql_md.md)] statement.  
...
> [!NOTE]  
>  These coordinates are specified by the BOUNDING_BOX clause of the [CREATE SPATIAL INDEX](assetId:///ee6b9116-a7ff-463a-a9f0-b360804d8678)[!INCLUDE[tsql](../../Topics/TopicNameContainA/includes/tsql_md.md)] statement.  
...
> [!NOTE]  
>  You can explicitly specify this tessellation scheme by using the USING (GEOGRAPHY_AUTO_GRID/GEOGRAPHY_GRID) clause of the [CREATE SPATIAL INDEX](assetId:///ee6b9116-a7ff-463a-a9f0-b360804d8678)[!INCLUDE[tsql](../../Topics/TopicNameContainA/includes/tsql_md.md)] statement.  
