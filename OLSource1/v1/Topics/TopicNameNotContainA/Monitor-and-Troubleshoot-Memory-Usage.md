...
```  
 ...
 For more information see [sys.dm\_db\_xtp\_table\_memory\_stats](../Topic/sys.dm_db_xtp_table_memory_stats%20\(Transact-SQL\).md).  
...
```  
 ...
 For more information see [sys.dm\_os\_memory\_clerks \(Transact\-SQL\)](../Topic/sys.dm_os_memory_clerks%20\(Transact-SQL\).md).  
