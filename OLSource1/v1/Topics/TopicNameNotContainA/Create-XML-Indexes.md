...
## Creating a Primary XML Index  
 To create a primary XML index, use the [CREATE PRIMARY XML INDEX](assetId:///d2297805-412b-47b5-aeeb-53388349a5b9)[!INCLUDE[tsql](../../Topics/TopicNameContainA/includes/tsql_md.md)] DDL statement. Not all options available for non-XML indexes are supported on XML indexes.  
...
## Creating a Secondary XML Index  
 Use the [CREATE XML INDEX](assetId:///d2297805-412b-47b5-aeeb-53388349a5b9)[!INCLUDE[tsql](../../Topics/TopicNameContainA/includes/tsql_md.md)] DDL statement to create secondary XML indexes and specify the type of the secondary XML index that you want.  
