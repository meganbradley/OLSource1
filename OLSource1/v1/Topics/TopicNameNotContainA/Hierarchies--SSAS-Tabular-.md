...
##  <a name="bkmk_define"></a> Defining Hierarchies  
 ...
 After you have created hierarchies, you can test their efficacy by using the Analyze in Excel feature. For more information, see [Analyze in Excel &#40;SSAS Tabular&#41;](../Topic/Analyze%20in%20Excel%20\(SSAS%20Tabular\).md).  
  
##  <a name="bkmk_related_tasks"></a> Related Tasks  
  
|Task|Description|  
|----------|-----------------|  
|[Create and Manage Hierarchies &#40;SSAS Tabular&#41;](../Topic/Create%20and%20Manage%20Hierarchies%20\(SSAS%20Tabular\).md)|Describes how to create and manage hierarchies by using the model designer in Diagram View.|  
