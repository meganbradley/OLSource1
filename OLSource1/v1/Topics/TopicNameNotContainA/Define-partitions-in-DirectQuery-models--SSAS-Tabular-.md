...
# Define partitions in DirectQuery models (SSAS Tabular)
  This section explains how partitions are used in DirectQuery models. For more general information about partitions in tabular models, see [Partitions &#40;SSAS Tabular&#41;](../Topic/Partitions%20\(SSAS%20Tabular\).md).  
