...
>  If you want to remove the filter from an existing mining model, or change the filter conditions, you must reprocess the mining model.  
 ...
 For more information about the kinds of filters you can apply, and how filter expressions are evaluated, see [Model Filter Syntax and Examples &#40;Analysis Services - Data Mining&#41;](../Topic/Model%20Filter%20Syntax%20and%20Examples%20\(Analysis%20Services%20-%20Data%20Mining\).md).  
