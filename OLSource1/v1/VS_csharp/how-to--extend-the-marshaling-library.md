...
This topic explains how to extend the marshaling library to provide more conversions between data types. Users can extend the marshaling library for any data conversions not currently supported by the library.  
 ...
 You can extend the marshaling library in one of two ways - with or without a [marshal_context Class](../VS_csharp/marshal_context-class.md). Review the [Overview of Marshaling in C++](../VS_csharp/overview-of-marshaling-in-c--.md) topic to determine whether a new conversion requires a context.  
...
## See Also  
 [Overview of Marshaling in C++](../VS_csharp/overview-of-marshaling-in-c--.md)