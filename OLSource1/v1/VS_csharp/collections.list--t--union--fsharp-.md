...
|Member|Description|  
|------------|-----------------|  
|[Head](../VS_csharp/list.head--t--property--fsharp-.md)|Gets the first element of the list.|  
|[IsEmpty](../VS_csharp/list.isempty--t--property--fsharp-.md)|Gets a value indicating if the list contains no entries.|  
|[Item](../VS_csharp/list.item--t--property--fsharp-.md)|Gets the element of the list at the given position.|  
|[Length](../VS_csharp/list.length--t--property--fsharp-.md)|Gets the number of items contained in the list.|  
|[Tail](../VS_csharp/list.tail--t--property--fsharp-.md)|Gets the tail of the list, which is a list containing all the elements of the list, excluding the first element.|  
  
## Static Members  
  
|Member|Description|  
|------------|-----------------|  
|[Cons](../VS_csharp/list.cons--t--method--fsharp-.md)|Returns a list with the first argument as its first element and the second argument as its subsequent elements.|  
|[Empty](../VS_csharp/empty--t--property--fsharp-.md)|Returns an empty list of a particular type.|  
