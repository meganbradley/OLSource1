...
cannot locate dependent type library 'type_lib'  
 ...
 [no_registry](../VS_csharp/no_registry.md) and [auto_search](../VS_csharp/auto_search.md) were passed to `#import` but the compiler was not able to find a referenced type library.  
