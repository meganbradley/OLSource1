...
> [!TIP]
>  You can right-click on the Resource View window to launch a shortcut menu of commands. You can also double-click on the title bar to dock or undock the window. Right-clicking on the title bar will give you additional commands that allow you to control the behavior of the window. For more information, see [Windows Management](../VS_csharp/customizing-window-layouts-in-visual-studio.md).  
