...
-   HWND ([CWnd](../VS_csharp/cwnd-class.md) and `CWnd`-derived classes)  
  
-   HDC ([CDC](../VS_csharp/cdc-class.md) and `CDC`-derived classes)  
  
-   HMENU ([CMenu](../VS_csharp/cmenu-class.md))  
  
-   HPEN ([CGdiObject](../VS_csharp/cgdiobject-class.md))  
...
-   HIMAGELIST ([CImageList](../VS_csharp/cimagelist-class.md))  
  
-   SOCKET ([CSocket](../VS_csharp/csocket-class.md))  
