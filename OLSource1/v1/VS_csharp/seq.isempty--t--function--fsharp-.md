...
## Remarks  
 The first element of the `source` sequence, if there is one, is evaluated on each call. To avoid this, you can create a cached sequence by using [Seq.cache](../VS_csharp/seq.cache--t--function--fsharp-.md).  
...
## Example  
 ...
 [!code[FsSequences#42](../VS_csharp/codesnippet/FSharp/seq.isempty--t--function--fsharp-_1.fs)]  
