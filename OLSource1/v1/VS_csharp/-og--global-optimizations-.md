...
## Remarks  
 **/Og** is deprecated. These optimizations are now generally enabled by default. For more information on optimizations, see [/O1, /O2](../VS_csharp/-o1---o2--minimize-size--maximize-speed-.md) or [/Ox](../VS_csharp/-ox--full-optimization-.md).  
...
-   Loop optimization  
    ...
    ```  
     ...
     Loop optimization is much more effective when the compiler can assume no aliasing, which you set with [__restrict](../VS_csharp/__restrict.md), [noalias](../VS_csharp/noalias.md), or [restrict](../VS_csharp/restrict.md).  
 ...
 **/Og** also enables the Named Return Value optimization, which eliminates the copy constructor and destructor of a stack based return value. See [/O1, /O2 (Minimize Size, Maximize Speed)](../VS_csharp/-o1---o2--minimize-size--maximize-speed-.md) for more information.  
  
 For related information, see [Generate Intrinsic Functions (/Oi)](../VS_csharp/-oi--generate-intrinsic-functions-.md) and [Full Optimization (/Ox)](../VS_csharp/-ox--full-optimization-.md).  
