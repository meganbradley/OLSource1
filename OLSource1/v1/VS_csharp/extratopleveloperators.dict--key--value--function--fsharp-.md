...
#### Parameters  
 `keyValuePairs`  
 Type: [seq](../VS_csharp/collections.seq--t--type-abbreviation--fsharp-.md)`<'Key * 'Value>`  
  
## Return Value  
 An object that implements <xref:System.Collections.Generic.IDictionary`2*> that represents the given collection.  
...
## Example  
 ...
 [!code[FsCoreLib2#1](../VS_csharp/codesnippet/FSharp/extratopleveloperators.dict--key--value--function--fsharp-_1.fs)]  
