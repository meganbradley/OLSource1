 ...
 *Functional programming* is a programming approach that directly supports pure functional transformation.  
 ...
 For more information about functional programming, see [Functional Programming vs. Imperative Programming (Visual Basic)](../VS_csharp/functional-programming-vs.-imperative-programming--visual-basic-.md).  
  
#### Domain-Specific FP Languages  
 Although general functional programming languages have not been widely adopted, specific domain-specific functional programming languages have had better success. For example, Cascading Style Sheets (CSS) are used to determine the look and feel of many Web pages, and Extensible Stylesheet Language Transformations (XSLT) style sheets are used extensively in XML data manipulation. For more information about XSLT, see [XSLT Transformations](assetId:///202f8820-224c-494f-b61e-cd127eac6e03).  
...
## Terminology  
 ...
 For more information, see [Standard Query Operators Overview (Visual Basic)](../VS_csharp/standard-query-operators-overview--visual-basic-.md).  
 ...
 For more information about, see [Lambda Expressions &#91;Visual Basic&#93;](../VS_csharp/lambda-expressions--visual-basic-.md).  
 ...
 For more information, see [Local Type Inference &#91;Visual Basic&#93;](../VS_csharp/local-type-inference--visual-basic-.md).  
 ...
 For more information, see [Basic Query Operations (Visual Basic)](../VS_csharp/basic-query-operations--visual-basic-.md) and [Deferred Execution and Lazy Evaluation in LINQ to XML (Visual Basic)](../VS_csharp/deferred-execution-and-lazy-evaluation-in-linq-to-xml--visual-basic-.md).  
...
## See Also  
 ...
 [Functional Programming vs. Imperative Programming (Visual Basic)](../VS_csharp/functional-programming-vs.-imperative-programming--visual-basic-.md)