 ...
 *Result* = `CallByName`(*Object*, *ProcedureName*, *CallType*, *Arguments*())  
 ...
 You can use `CallByName` with classes in your current solution, but it is most often used to access COM objects or objects from [!INCLUDE[dnprdnshort](../VS_csharp/includes/dnprdnshort_md.md)] assemblies.  
 ...
 [!code[VbVbalrOOP#53](../VS_csharp/codesnippet/VisualBasic/calling-a-property-or-method-using-a-string-name--visual-basic-_1.vb)]  
 ...
 [!code[VbVbalrOOP#54](../VS_csharp/codesnippet/VisualBasic/calling-a-property-or-method-using-a-string-name--visual-basic-_2.vb)]  
...
## See Also  
 ...
 [Determining Object Type](../VS_csharp/determining-object-type--visual-basic-.md)