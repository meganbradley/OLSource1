...
3.  Highlight the extension and choose **Download**.  
 ...
 For more information about creating and using coded UI tests, see [Creating Coded UI Tests](../VS_csharp/use-ui-automation-to-test-your-code.md#VerifyingCodeUsingCUITCreate).  
...
##  <a name="generate"></a> *I don't see the option to change BrowserWindow.CurrentBrowser in the coded UI test.*  
 You might be using a version of [!INCLUDE[vs2011_first](../VS_csharp/includes/vs2011_first_md.md)] that does not support coded UI tests using various web browsers. To use such coded UI tests, you must use Visual Studio Enterprise.  
  
 *What else should I know?*  
 **Notes**  
  
-   ![Prerequsite](../VS_csharp/media/prereq.png "Prereq") Apple Safari web browser is not supported.  
  
-   ![Prerequsite](../VS_csharp/media/prereq.png "Prereq") The action of starting the web browser must be part of the coded UI test.  
...
-   ![Prerequsite](../VS_csharp/media/prereq.png "Prereq") Automating browser specific based UI actions such as maximize, minimize and restore is not supported.  
  
 **Tips**  
  
-   ![Tip](../VS_csharp/media/tip.png "Tip") You can configure the output to include screenshots in the coded UI logs. To do so, you need to set some configuration settings in the QTAgent32.exe.config file. By default, this file is installed in the following location:  
    ...
    -   `<add name="EqtTraceLevel" value="4" />`  
     ...
     For more information, see [Analyzing Coded UI Tests Using Coded UI Test Logs](../VS_csharp/analyzing-coded-ui-tests-using-coded-ui-test-logs.md).  
...
## See Also  
 ...
 [Analyzing Coded UI Tests Using Coded UI Test Logs](../VS_csharp/analyzing-coded-ui-tests-using-coded-ui-test-logs.md)