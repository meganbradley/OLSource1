...
1.  Install the [AUTOCLIK](../VS_csharp/visual-c---samples.md) sample application onto your development machine.  
...
5.  Run AUTODRIV.EXE on the local machine and verify that running it starts AUTOCLIK.EXE. To find out more about AUTODRIV.EXE, see [AUTOCLIK](../VS_csharp/visual-c---samples.md).  
