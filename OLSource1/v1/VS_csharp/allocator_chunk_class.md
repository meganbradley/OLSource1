...
Defines a             [block allocator](../VS_csharp/-allocators-.md) that allocates and deallocates memory blocks of a single size.  
...
|||  
|-|-|  
|[cache_chunklist](../VS_csharp/cache_chunklist-class.md#cache_chunklist__cache_chunklist)|Constructs an object of type                                         `cache_chunklist`.|  
  
### Member Functions  
  
|||  
|-|-|  
|[allocate](../VS_csharp/cache_chunklist-class.md#cache_chunklist__allocate)|Allocates a block of memory.|  
|[deallocate](../VS_csharp/cache_chunklist-class.md#cache_chunklist__deallocate)|Frees a specified number of objects from storage beginning at a specified position.|  
