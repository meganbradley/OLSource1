...
|Name|Description|  
|----------|-----------------|  
|[CMFCMenuButton::m_bOSMenu](#cmfcmenubutton__m_bosmenu)|Specifies whether to display the default system pop-up menu or to use [CContextMenuManager::TrackPopupMenu](../VS_csharp/ccontextmenumanager-class.md#ccontextmenumanager__trackpopupmenu).|  
...
## Remarks  
 The `CMFCMenuButton` class is derived from the [CMFCButton Class](../VS_csharp/cmfcbutton-class.md) which is, in turn, derived from the [CButton Class](../VS_csharp/cbutton-class.md). Therefore, you can use `CMFCMenuButton` in your code the same way you would use `CButton`.  
...
## Example  
 The following example demonstrates how to set the handle of the menu attached to the button, resize the button according to its text and image size, and set the pop-up menu that is displayed by the framework. This code snippet is part of the [New Controls sample](../VS_csharp/visual-c---samples.md).  
  
 [!code[NVC_MFC_NewControls#38](../VS_csharp/codesnippet/CPP/cmfcmenubutton-class_1.h)]  
[!code[NVC_MFC_NewControls#39](../VS_csharp/codesnippet/CPP/cmfcmenubutton-class_2.cpp)]  
...
##  <a name="cmfcmenubutton__cmfcmenubutton"></a>  CMFCMenuButton::CMFCMenuButton  
 Constructs a new [CMFCMenuButton](../VS_csharp/cmfcmenubutton-class.md) object.  
...
### Remarks  
 If `m_bOSMenu` is `TRUE`, the framework calls the inherited `TrackPopupMenu` method for this object. Otherwise, the framework calls [CContextMenuManager::TrackPopupMenu](../VS_csharp/ccontextmenumanager-class.md#ccontextmenumanager__trackpopupmenu).  
...
### Return Value  
 A [CSize](../VS_csharp/csize-class.md) object that specifies the new size for the button.  
...
## See Also  
 ...
 [CMFCButton Class](../VS_csharp/cmfcbutton-class.md)