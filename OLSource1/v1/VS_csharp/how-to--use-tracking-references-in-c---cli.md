...
This article shows how to use a tracking reference (%) in [!INCLUDE[cppcli](../VS_csharp/includes/cppcli_md.md)] to pass common language runtime (CLR) types by reference.  
 ...
 **zip == 20100** The next sample shows that taking the address of a tracking reference returns an [interior_ptr](../VS_csharp/interior_ptr--c---cli-.md), and shows how to modify and access data through a tracking reference.  
