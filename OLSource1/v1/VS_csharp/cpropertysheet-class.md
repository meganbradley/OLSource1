...
## Remarks  
 A property sheet consists of a `CPropertySheet` object and one or more [CPropertyPage](../VS_csharp/cpropertypage-class.md) objects. The framework displays a property sheet as a window with a set of tab indices and an area that contains the currently selected page. The user navigates to a specific page by using the appropriate tab.  
  
 `CPropertySheet` provides support for the expanded                 [PROPSHEETHEADER](http://msdn.microsoft.com/library/windows/desktop/bb774546) structure introduced in [!INCLUDE[Win98](../VS_csharp/includes/win98_md.md)] and Windows NT 2000. The structure contains additional flags and members that support using a "watermark" background bitmap.  
...
### Remarks  
 ...
 `AddPage` adds the [CPropertyPage](../VS_csharp/cpropertypage-class.md#cpropertypage__cpropertypage) object to the `CPropertySheet` object's list of pages but does not actually create the window for the page. The framework postpones creation of the window for the page until the user selects that page.  
  
 When you add a property page using `AddPage`, the `CPropertySheet` is the parent of the `CPropertyPage`. To gain access to the property sheet from the property page, call [CWnd::GetParent](../VS_csharp/cwnd-class.md#cwnd__getparent).  
...
### Example  
 [!code[NVC_MFCDocView#129](../VS_csharp/codesnippet/CPP/cpropertysheet-class_1.cpp)]  
...
### Example  
 ...
 [!code[NVC_MFCDocView#130](../VS_csharp/codesnippet/CPP/cpropertysheet-class_2.cpp)]  
...
### Example  
 [!code[NVC_MFCDocView#131](../VS_csharp/codesnippet/CPP/cpropertysheet-class_3.cpp)]  
...
### Parameters  
 ...
 `dwStyle`  
 Window styles for property sheet. For a complete list of available styles, see [Window Styles](../VS_csharp/window-styles.md).  
  
 `dwExStyle`  
 Extended window styles for property sheet. For a complete list of available styles, see [Extended Window Styles](../VS_csharp/extended-window-styles.md)  
...
### Remarks  
 ...
 The **Create** member function returns immediately after creating the property sheet. To destroy the property sheet, call [CWnd::DestroyWindow](../VS_csharp/cwnd-class.md#cwnd__destroywindow).  
...
### Example  
 [!code[NVC_MFCDocView#132](../VS_csharp/codesnippet/CPP/cpropertysheet-class_4.cpp)]  
  
 [!code[NVC_MFCDocView#133](../VS_csharp/codesnippet/CPP/cpropertysheet-class_5.cpp)]  
...
### Remarks  
 The return value corresponds to the ID of the control that closed the property sheet. After this function returns, the windows corresponding to the property sheet and all the pages will have been destroyed. The objects themselves will still exist. Typically, you will retrieve data from the [CPropertyPage](../VS_csharp/cpropertypage-class.md) objects after `DoModal` returns `IDOK`.  
...
### Remarks  
 ...
 You must call `EnableStackedTabs` when you create a modal or a modeless property sheet. To incorporate this style in a `CPropertySheet`-derived class, write a message handler for `WM_CREATE`. In the overridden version of [CWnd::OnCreate](../VS_csharp/cwnd-class.md#cwnd__oncreate), call **EnableStackedTabs( FALSE )** before calling the base class implementation.  
  
### Example  
 [!code[NVC_MFCDocView#134](../VS_csharp/codesnippet/CPP/cpropertysheet-class_6.cpp)]  
...
### Example  
 [!code[NVC_MFCDocView#135](../VS_csharp/codesnippet/CPP/cpropertysheet-class_7.cpp)]  
...
### Example  
  See the example for [CPropertyPage::OnWizardFinish](../VS_csharp/cpropertypage-class.md#cpropertypage__onwizardfinish).  
...
##  <a name="cpropertysheet__gettabcontrol"></a>  CPropertySheet::GetTabControl  
 Retrieves a pointer to a tab control to do something specific to the tab control (that is, to use any of the APIs in [CTabCtrl](../VS_csharp/ctabctrl-class.md)).  
...
### Example  
 [!code[NVC_MFCDocView#136](../VS_csharp/codesnippet/CPP/cpropertysheet-class_8.cpp)]  
...
### Remarks  
 ...
 For more information on this structure, including a listing of its members, see **PROPSHEETHEADER** in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
  
### Example  
 [!code[NVC_MFCDocView#143](../VS_csharp/codesnippet/CPP/cpropertysheet-class_9.cpp)]  
...
### Parameters  
 `lpRect`  
 Points to a                                 [RECT](http://msdn.microsoft.com/library/windows/desktop/dd162897) structure or [CRect](../VS_csharp/crect-class.md) object that contains the dialog-box coordinates to be converted.  
...
### Remarks  
 ...
 A call to `PressButton` will not send the                         [PSN_APPLY](http://msdn.microsoft.com/library/windows/desktop/bb774552) notification from a property page to the framework. To send this notification, call [CPropertyPage::OnOK](../VS_csharp/cpropertypage-class.md#cpropertypage__onok).  
  
### Example  
 [!code[NVC_MFCDocView#137](../VS_csharp/codesnippet/CPP/cpropertysheet-class_10.cpp)]  
...
### Remarks  
 The [CPropertyPage](../VS_csharp/cpropertypage-class.md) object itself is not destroyed until the owner of the `CPropertySheet` window is closed.  
...
### Example  
 [!code[NVC_MFCDocView#138](../VS_csharp/codesnippet/CPP/cpropertysheet-class_11.cpp)]  
...
### Example  
 [!code[NVC_MFCDocView#139](../VS_csharp/codesnippet/CPP/cpropertysheet-class_12.cpp)]  
...
### Remarks  
 Call `SetWizardButtons` only after the dialog is open; you can't call `SetWizardButtons` before you call [DoModal](#cpropertysheet__domodal). Typically, you should call `SetWizardButtons` from [CPropertyPage::OnSetActive](../VS_csharp/cpropertypage-class.md#cpropertypage__onsetactive).  
...
### Example  
 ...
 [!code[NVC_MFCDocView#140](../VS_csharp/codesnippet/CPP/cpropertysheet-class_13.cpp)]  
  
 [!code[NVC_MFCDocView#141](../VS_csharp/codesnippet/CPP/cpropertysheet-class_14.cpp)]  
...
### Example  
 [!code[NVC_MFCDocView#142](../VS_csharp/codesnippet/CPP/cpropertysheet-class_15.cpp)]  
  
## See Also  
 [MFC Sample CMNCTRL1](../VS_csharp/visual-c---samples.md)   
 [MFC Sample CMNCTRL2](../VS_csharp/visual-c---samples.md)   
 [MFC Sample PROPDLG](../VS_csharp/visual-c---samples.md)   
 [MFC Sample SNAPVW](../VS_csharp/visual-c---samples.md)   
