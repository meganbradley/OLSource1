...
## shared_ptr  
 Multiple threads can simultaneously read and write different [shared_ptr](../VS_csharp/shared_ptr-class.md) objects, even when the objects are copies that share ownership.  
