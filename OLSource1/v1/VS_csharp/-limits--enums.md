...
### Example  
  See [numeric_limits::has_denorm](../VS_csharp/numeric_limits-class.md#numeric_limits__has_denorm) for an example in which the values of this enumeration may be accessed.  
...
### Example  
  See [numeric_limits::round_style](../VS_csharp/numeric_limits-class.md#numeric_limits__round_style) for an example in which the values of this enumeration may be accessed.  
