...
|Name|Description|  
|----------|-----------------|  
|[CSmoothStopTransition::Create](#csmoothstoptransition__create)|Calls the transition library to create encapsulated transition COM object. (Overrides [CBaseTransition::Create](../VS_csharp/cbasetransition-class.md#cbasetransition__create).)|  
...
## Inheritance Hierarchy  
 ...
 [CSmoothStopTransition](../VS_csharp/csmoothstoptransition-class.md)  
