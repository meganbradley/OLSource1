...
-   [Consistency Rules for Per-File Use of Precompiled Headers](../VS_csharp/consistency-rules-for-per-file-use-of-precompiled-headers.md)  
  
-   [Consistency Rules for /Yc and /Yu](../VS_csharp/consistency-rules-for--yc-and--yu.md)  
