...
## Frame Windows in SDI and MDI Applications  
 For an SDI application, there is one frame window derived from class [CFrameWnd](../VS_csharp/cframewnd-class.md). This window is both the main frame window and the document frame window. For an MDI application, the main frame window is derived from class [CMDIFrameWnd](../VS_csharp/cmdiframewnd-class.md), and the document frame windows, which are MDI child windows, are derived from class [CMDIChildWnd](../VS_csharp/cmdichildwnd-class.md).  
...
-   [Frame-window classes created by the Application Wizard](../VS_csharp/frame-window-classes-created-by-the-application-wizard.md)  
