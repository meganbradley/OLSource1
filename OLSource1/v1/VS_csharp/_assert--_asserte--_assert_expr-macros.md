...
## Remarks  
 ...
 Unless you specify otherwise with the [_CrtSetReportMode](../VS_csharp/_crtsetreportmode.md) and [_CrtSetReportFile](../VS_csharp/_crtsetreportfile.md) functions, messages appear in a pop-up dialog box equivalent to setting:  
...
## See Also  
 ...
 [assert](../VS_csharp/assert-macro--_assert--_wassert.md)   
 [_RPT, _RPTF, _RPTW, _RPTFW Macros](../VS_csharp/_rpt--_rptf--_rptw--_rptfw-macros.md)