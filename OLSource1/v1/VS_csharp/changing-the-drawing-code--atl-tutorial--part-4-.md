...
1.  Add the line `#include <math.h>` to the top of PolyCtl.h. The top of the file should look like this:  
     ...
     [!code[NVC_ATL_Windowing#47](../VS_csharp/codesnippet/CPP/changing-the-drawing-code--atl-tutorial--part-4-_1.cpp)]  
...
2.  Once the polygon points are calculated, they will be stored in an array of type `POINT`, so add the array after the definition of `m_nSides` in PolyCtl.h:  
     ...
     [!code[NVC_ATL_Windowing#48](../VS_csharp/codesnippet/CPP/changing-the-drawing-code--atl-tutorial--part-4-_2.h)]  
...
1.  Replace the existing `OnDraw` method in PolyCtl.h with the following code:  
     ...
     [!code[NVC_ATL_Windowing#49](../VS_csharp/codesnippet/CPP/changing-the-drawing-code--atl-tutorial--part-4-_3.cpp)]  
...
1.  Add the declaration of `CalcPoints` to the `IPolyCtl` public section of the `CPolyCtl` class in PolyCtl.h:  
     ...
     [!code[NVC_ATL_Windowing#50](../VS_csharp/codesnippet/CPP/changing-the-drawing-code--atl-tutorial--part-4-_4.h)]  
  
     The last part of the public section of the `CPolyCtl` class will look like this:  
  
     [!code[NVC_ATL_Windowing#51](../VS_csharp/codesnippet/CPP/changing-the-drawing-code--atl-tutorial--part-4-_5.h)]  
  
2.  Add this implementation of the `CalcPoints` function to the end of PolyCtl.cpp:  
  
     [!code[NVC_ATL_Windowing#52](../VS_csharp/codesnippet/CPP/changing-the-drawing-code--atl-tutorial--part-4-_6.cpp)]  
...
1.  Use green as the default color by adding this line to the `CPolyCtl` constructor in PolyCtl.h:  
     ...
     [!code[NVC_ATL_Windowing#53](../VS_csharp/codesnippet/CPP/changing-the-drawing-code--atl-tutorial--part-4-_7.h)]  
  
 The constructor now looks like this:  
  
 [!code[NVC_ATL_Windowing#54](../VS_csharp/codesnippet/CPP/changing-the-drawing-code--atl-tutorial--part-4-_8.h)]  
...
1.  Build and start the ActiveX Control Test Container. For more information, see [TSTCON Sample: ActiveX Control Test Container](../VS_csharp/visual-c---samples.md).  
...
1.  Update PolyCtl.cpp by adding the call to `FireViewChange` to the `put_Sides` method. When you have finished, the `put_Sides` method should look like this:  
     ...
     [!code[NVC_ATL_Windowing#55](../VS_csharp/codesnippet/CPP/changing-the-drawing-code--atl-tutorial--part-4-_9.cpp)]  
 ...
 [Back to Step 3](../VS_csharp/adding-a-property-to-the-control--atl-tutorial--part-3-.md) &#124; [On to Step 5](../VS_csharp/adding-an-event--atl-tutorial--part-5-.md)  
  
## See Also  
 [Tutorial](../VS_csharp/active-template-library--atl--tutorial.md)   
 [Testing Properties and Events with Test Container](../VS_csharp/testing-properties-and-events-with-test-container.md)