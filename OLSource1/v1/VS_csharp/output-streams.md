...
## In This Section  
 [Constructing Output Stream Objects](../VS_csharp/constructing-output-stream-objects.md)  
  
 [Using Insertion Operators and Controlling Format](../VS_csharp/using-insertion-operators-and-controlling-format.md)  
  
 [Output File Stream Member Functions](../VS_csharp/output-file-stream-member-functions.md)  
  
 [The Effects of Buffering](../VS_csharp/effects-of-buffering.md)  
  
 [Binary Output Files](../VS_csharp/binary-output-files.md)  
  
 [Overloading the << Operator for Your Own Classes](../VS_csharp/overloading-the----operator-for-your-own-classes.md)  
  
 [Writing Your Own Manipulators Without Arguments](../VS_csharp/writing-your-own-manipulators-without-arguments.md)  
