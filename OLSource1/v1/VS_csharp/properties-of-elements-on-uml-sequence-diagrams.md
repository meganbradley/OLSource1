...
> [!NOTE]
>  This topic is about the properties of elements in UML sequence diagrams. For more information about how to read UML sequence diagrams, see [UML Sequence Diagrams: Overview](../VS_csharp/uml-sequence-diagrams--reference.md). For more information about how to draw UML sequence diagrams, see [UML Sequence Diagrams: Guidelines](../VS_csharp/uml-sequence-diagrams--guidelines.md).  
...
## See Also  
 [UML Sequence Diagrams: Overview](../VS_csharp/uml-sequence-diagrams--reference.md)   
 [UML Sequence Diagrams: Guidelines](../VS_csharp/uml-sequence-diagrams--guidelines.md)   
 [Alternative Flows: Combined Fragments in UML Sequence Diagrams](../VS_csharp/describe-control-flow-with-fragments-on-uml-sequence-diagrams.md)