...
> [!NOTE]
>  For information about the UML modeling API, see [API for UML Extensibility](../VS_csharp/api-reference-for-uml-modeling-extensibility.md). For information about text transformation, see [Customizing Text Transformation](../VS_csharp/customizing-t4-text-transformation.md).  
...
|<xref:Microsoft.VisualStudio.Modeling.Integration.Shell*?displayProperty=fullName>|Modelbus adapter framework for [!INCLUDE[vsprvs](../VS_csharp/includes/vsprvs_md.md)].|  
...
|<xref:Microsoft.VisualStudio.Modeling.Shell*?displayProperty=fullName>|The interface between DSLs and [!INCLUDE[vsprvs](../VS_csharp/includes/vsprvs_md.md)].|  
...
## See Also  
 [API for UML Extensibility](../VS_csharp/api-reference-for-uml-modeling-extensibility.md)   
 [Customizing Text Transformation](../VS_csharp/customizing-t4-text-transformation.md)