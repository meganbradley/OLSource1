...
-   Make sure that the file type is valid. For example, make sure that an OMF object is 32-bit and not 16-bit. For more information, see [.Obj Files as Linker Input](../VS_csharp/.obj-files-as-linker-input.md) and [Microsoft PE and COFF Specification](http://go.microsoft.com/fwlink/p/?LinkId=93292).  
  
-   Make sure that the file is not corrupt. Rebuild it, if necessary.  
  
## See Also  
 [.Obj Files as Linker Input](../VS_csharp/.obj-files-as-linker-input.md)   
