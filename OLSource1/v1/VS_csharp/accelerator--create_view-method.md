...
Creates and returns an `accelerator_view` object on this accelerator, using the specified queuing mode. When the queuing mode is not specified, the new `accelerator_view` uses the [queuing_mode::immediate](../VS_csharp/queuing_mode-enumeration.md) queuing mode.  
...
## See Also  
 ...
 [accelerator_view](../VS_csharp/accelerator_view-class.md)