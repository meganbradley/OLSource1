...
## Nested Loops  
 ...
 [!code[VbVbalrStatements#122](../VS_csharp/codesnippet/VisualBasic/for-each...next-statement--visual-basic-_2.vb)]  
  
 When you nest loops, each loop must have a unique `element` variable.  
  
 You can also nest different kinds of control structures within each other. For more information, see [Nested Control Structures](../VS_csharp/nested-control-structures--visual-basic-.md).  
  
## Exit For and Continue For  
 The [Exit For](../VS_csharp/exit-statement--visual-basic-.md) statement causes execution to exit the `For`…`Next` loop and transfers control to the statement that follows the `Next` statement.  
  
 The `Continue For` statement transfers control immediately to the next iteration of the loop. For more information, see [Continue Statement (Visual Basic)](../VS_csharp/continue-statement--visual-basic-.md).  
  
 The following example shows how to use the `Continue For` and `Exit For` statements.  
  
 [!code[VbVbalrStatements#123](../VS_csharp/codesnippet/VisualBasic/for-each...next-statement--visual-basic-_3.vb)]  
...
-   There an endless loop, which is a loop that could run a large or even infinite number of times. If you detect such a condition, you can use `Exit For` to escape the loop. For more information, see [Do...Loop Statement (Visual Basic)](../VS_csharp/do...loop-statement--visual-basic-.md).  
...
## Iterators  
 ...
 [!code[VbVbalrStatements#127](../VS_csharp/codesnippet/VisualBasic/for-each...next-statement--visual-basic-_4.vb)]  
  
 For more information, see [Iterators (C# and Visual Basic)](../VS_csharp/iterators--csharp-and-visual-basic-.md), [Yield Statement (Visual Basic)](../VS_csharp/yield-statement--visual-basic-.md), and [Iterator (Visual Basic)](../VS_csharp/iterator--visual-basic-.md).  
...
### Narrowing Conversions  
 ...
 [!code[VbVbalrStatements#89](../VS_csharp/codesnippet/VisualBasic/for-each...next-statement--visual-basic-_5.vb)]  
...
## Example  
 ...
 [!code[VbVbalrStatements#124](../VS_csharp/codesnippet/VisualBasic/for-each...next-statement--visual-basic-_6.vb)]  
...
## Example  
 ...
 [!code[VbVbalrStatements#125](../VS_csharp/codesnippet/VisualBasic/for-each...next-statement--visual-basic-_7.vb)]  
  
## See Also  
 [Collections (C# and Visual Basic)](../VS_csharp/collections--csharp-and-visual-basic-.md)   
 ...
 [While...End While Statement](../VS_csharp/while...end-while-statement--visual-basic-.md)   
 ...
 [Object Initializers: Named and Anonymous Types (Visual Basic)](../VS_csharp/object-initializers--named-and-anonymous-types--visual-basic-.md)   
