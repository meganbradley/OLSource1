...
Sorts the elements of an array by mutating the array in place, using the given projection for the keys. Elements are compared using [Operators.compare](../VS_csharp/operators.compare--t--function--fsharp-.md).  
...
## Example  
 ...
 [!code[FsArrays#41](../VS_csharp/codesnippet/FSharp/array.sortinplaceby--t--key--function--fsharp-_1.fs)]  
