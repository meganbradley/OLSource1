...
-   [Writing a Termination Handler](../VS_csharp/writing-a-termination-handler.md)  
  
-   [Using Structured Exception Handling with C++](../VS_csharp/using-structured-exception-handling-with-c--.md)  
 ...
 **Throwing C++ exception**  
**Destroying TestClass!**  
**Executing SEH __except block** For more information, see [/EH (Exception Handling Model)](../VS_csharp/-eh--exception-handling-model-.md).  
  
## END Microsoft Specific  
  
## See Also  
 [Exception Handling](../VS_csharp/exception-handling-in-visual-c--.md)   
 [Keywords](../VS_csharp/keywords--c---.md)   
 [<exception\> Header](../VS_csharp/-exception-.md)   
 [Errors and Exception Handling (Modern C++)](../VS_csharp/errors-and-exception-handling--modern-c---.md)   
