...
'function' : member function will be invoked on a copy of the initonly data member 'member'  
 ...
 A member function was called on an [initonly](../VS_csharp/initonly--c---cli-.md) data member.  C4395 warns that the **initonly** data member cannot be modified by the function.  
