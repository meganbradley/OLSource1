...
#### Parameters  
 ...
 lSccExCaps  
 [in] A flag specifying an extended capability for which to test (see the Extended Capability Code table in [Capability Flags](../VS_csharp/capability-flags.md) for the possible flags).  
