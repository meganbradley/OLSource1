...
> [!NOTE]
>  The location of unit tests for native code and the test project structure can be different than the structure that is described in this topic. For more information, see [Unit Testing Existing C++ Applications with Test Explorer](../VS_csharp/unit-testing-existing-c---applications-with-test-explorer.md).  
...
5.  If the code that you want to test is in another location, see [Managing Project References](../VS_csharp/managing-references-in-a-project.md) for information about adding references.  
 ...
 **Running unit tests**  
 ...
 [Running Unit Tests with Unit Test Explorer](../VS_csharp/run-unit-tests-with-test-explorer.md)