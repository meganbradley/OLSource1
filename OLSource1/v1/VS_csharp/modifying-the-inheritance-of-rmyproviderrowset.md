...
```  
 ...
 When this is done, you can [dynamically determine columns returned to the consumer](../VS_csharp/dynamically-determining-columns-returned-to-the-consumer.md).  
