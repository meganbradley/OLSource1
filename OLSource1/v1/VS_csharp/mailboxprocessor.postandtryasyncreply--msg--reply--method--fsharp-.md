...
Like [MailboxProcessor.AsyncPostAndReply](../VS_csharp/mailboxprocessor.postandasyncreply--msg--reply--method--fsharp-.md), but returns `None` if no reply within the timeout period.  
...
#### Parameters  
 `buildMessage`  
 Type: [AsyncReplyChannel](../VS_csharp/control.asyncreplychannel--reply--class--fsharp-.md)`<'Reply> ->   'Msg`  
  
 The function to incorporate the [AsyncReplyChannel](../VS_csharp/control.asyncreplychannel--reply--class--fsharp-.md) into the message to be sent.  
...
## Return Value  
 An asynchronous computation ([Async](../VS_csharp/control.async-class--fsharp-.md) object) that will return the reply or `None` if the timeout expires.  
...
## Example  
 ...
 [!code[FsMailboxProcessor#19](../VS_csharp/codesnippet/FSharp/mailboxprocessor.postandtryasyncreply--msg--reply--method--fsharp-_1.fs)]  
