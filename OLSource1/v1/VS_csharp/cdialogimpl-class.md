 ...
 *TBase*  
 The base class of your new class. The default base class is [CWindow](../VS_csharp/cwindow-class.md).  
...
>  Your class must define an **IDD** member that specifies the dialog template resource ID. For example, the ATL Project Wizard automatically adds the following line to your class:  
 ...
 [!code[NVC_ATL_Windowing#41](../VS_csharp/codesnippet/CPP/cdialogimpl-class_1.h)]  
...
|Using dialog boxes in ATL|[ATL Window Classes](../VS_csharp/atl-window-classes.md)|  
|ATL Project Wizard|[Creating an ATL Project](../VS_csharp/creating-an-atl-project.md)|  
|Dialog boxes|[Dialog Boxes](http://msdn.microsoft.com/library/windows/desktop/ms632588) and subsequent topics in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)]|  
...
### Remarks  
 This dialog box is automatically attached to the `CDialogImpl` object. To create a modal dialog box, call [DoModal](../Topic/CDialogImpl::DoModal.md). The second override above is used only with [CComControl](../VS_csharp/ccomcontrol-class.md).  
