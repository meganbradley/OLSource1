...
---
# Edit and Continue (Visual Basic)
Edit and Continue is a feature for [!INCLUDE[vbprvb](../VS_csharp/includes/vbprvb_md.md)] debugging that enables you to change your code while it is executing in Break mode. After code edits have been applied, you can resume code execution with the new edits in place and see the effect.  
...
## In This Section  
 ...
 [Unsupported Edits in Visual Basic Edit and Continue](../VS_csharp/unsupported-edits-in-visual-basic-edit-and-continue.md)  
 Describes what types of edits cannot be performed in [!INCLUDE[vb_current_short](../VS_csharp/includes/vb_current_short_md.md)] Edit and Continue.  
