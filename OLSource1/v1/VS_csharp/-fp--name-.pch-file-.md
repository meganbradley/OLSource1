...
## Remarks  
 Use this option with [/Yc (Create Precompiled Header File)](../VS_csharp/-yc--create-precompiled-header-file-.md) or [/Yu (Use Precompiled Header File)](../VS_csharp/-yu--use-precompiled-header-file-.md) to provide a path name for a precompiled header instead of using the default path name. You can also use **/Fp** with **/Yc** to specify the use of a precompiled header file that differs from the **/Yc**`filename` argument and from the base name of the source file.  
