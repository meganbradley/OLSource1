...
|Member|Description|  
|------------|-----------------|  
|[new](../VS_csharp/core.printfformat--printer--state--residue--result--constructor--fsharp-.md)|Construct a format string|  
  
## Instance Members  
  
|Member|Description|  
|------------|-----------------|  
|[Value](../VS_csharp/printfformat.value--printer--state--residue--result--property--fsharp-.md)|The raw text of the format string.|  
