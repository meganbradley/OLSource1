...
This article explains how to implement connection points (formerly known as OLE connection points) using the MFC classes `CCmdTarget` and `CConnectionPoint`.  
 ...
 ![Implemented connection point](../VS_csharp/media/vc37lh1.gif "vc37LH1")  
An Implemented Connection Point  
  
 MFC implements this model in the [CConnectionPoint](../VS_csharp/cconnectionpoint-class.md) and [CCmdTarget](../VS_csharp/ccmdtarget-class.md) classes. Classes derived from **CConnectionPoint** implement the **IConnectionPoint** interface, used to expose connection points to other objects. Classes derived from `CCmdTarget` implement the **IConnectionPointContainer** interface, which can enumerate all of an object's available connection points or find a specific connection point.  
 ...
 [!code[NVC_MFCConnectionPoints#1](../VS_csharp/codesnippet/CPP/connection-points_1.h)]  
 ...
 [!code[NVC_MFCConnectionPoints#2](../VS_csharp/codesnippet/CPP/connection-points_2.cpp)]  
 ...
 [!code[NVC_MFCConnectionPoints#3](../VS_csharp/codesnippet/CPP/connection-points_3.cpp)]  
 ...
 ![Connection point implemented by using MFC](../VS_csharp/media/vc37lh2.gif "vc37LH2")  
A Connection Point Implemented with MFC  
 ...
 [!code[NVC_MFCConnectionPoints#4](../VS_csharp/codesnippet/CPP/connection-points_4.cpp)]  
