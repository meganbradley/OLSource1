...
#### Parameters  
 `pEvent`  
 [in] An [IDebugEvent2](../VS_csharp/idebugevent2.md) object that represents the previously sent synchronous event from which the debugger should now continue.  
...
## Example  
 The following example shows how to implement this method for a simple `CEngine` object that implements the [IDebugEngine2](../VS_csharp/idebugengine2.md) interface.  
