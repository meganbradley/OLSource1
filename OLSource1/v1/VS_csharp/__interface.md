...
## Remarks  
 A C++ [class](../VS_csharp/class--c---.md) or [struct](../VS_csharp/struct--c---.md) could be implemented with these rules, but `__interface` enforces them.  
...
```  
 ...
 For information on managed interfaces, see [interface class](../VS_csharp/interface-class---c---component-extensions-.md).  
...
```  
 ...
 `__interface` implies the [novtable](../VS_csharp/novtable.md) `__declspec` modifier.  
