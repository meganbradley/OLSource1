...
|Method|Description|  
|------------|-----------------|  
|[LaunchSuspended](../VS_csharp/idebugenginelaunch2--launchsuspended.md)|Launches a process by means of the DE.|  
|[ResumeProcess](../VS_csharp/idebugenginelaunch2--resumeprocess.md)|Resumes process execution.|  
|[CanTerminateProcess](../VS_csharp/idebugenginelaunch2--canterminateprocess.md)|Determines if a process can be terminated.|  
|[TerminateProcess](../VS_csharp/idebugenginelaunch2--terminateprocess.md)|Terminates a process.|  
