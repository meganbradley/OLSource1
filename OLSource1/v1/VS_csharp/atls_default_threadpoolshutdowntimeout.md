...
---
# ATLS_DEFAULT_THREADPOOLSHUTDOWNTIMEOUT
This macro defines the default time in milliseconds that [CThreadPool](../VS_csharp/cthreadpool-class.md) will wait for a thread to shut down.  
...
## Remarks  
 ...
 To set the timeout at run time or for a particular object, call [CThreadPool::SetTimeout](../Topic/CThreadPool::SetTimeout.md).  
