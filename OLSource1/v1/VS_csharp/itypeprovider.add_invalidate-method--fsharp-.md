...
apitype: "Assembly"
f1_keywords: 
  - "Microsoft.FSharp.Core.CompilerServices.ITypeProvider.add_Invalidate"
dev_langs: 
  - "FSharp"
helpviewer_keywords: 
  - "ITypeProvider.add_Invalidate method [F#]"
  - "add_Invalidate method [F#]"
...
---
# ITypeProvider.add_Invalidate Method (F#)
Add an event handler to the [Invalidate](../VS_csharp/itypeprovider.invalidate-event--fsharp-.md) event.  
