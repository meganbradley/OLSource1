...
-   In the timeline graph, click the name or id of the resource.  
     ...
     The [Resource Details View](../VS_csharp/resource-details-view---contention-data.md) appears for the selected resource.  
  
#### To view the thread contention data in the Processes window  
  
-   In the timeline graph, click **Total**.  
  
     The [Process View - Profiler Contention Data](../VS_csharp/process-view---contention-data.md) appears with the thread selected.