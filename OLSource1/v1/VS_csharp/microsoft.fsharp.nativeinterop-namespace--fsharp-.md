...
|Module|Description|  
|------------|-----------------|  
|module [NativePtr](../VS_csharp/nativeinterop.nativeptr-module--fsharp-.md)|Contains operations on native pointers. Use of these operators may result in the generation of unverifiable code.|  
