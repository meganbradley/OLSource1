...
## Remarks  
 The class describes an object that stores a reference to an object of class [valarray](../VS_csharp/valarray-class.md)**<Type\>**, along with an object of class [slice](../VS_csharp/slice-class.md), which describes the sequence of elements to select from the **valarray<Type\>** object.  
