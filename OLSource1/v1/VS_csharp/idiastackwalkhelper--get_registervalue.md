...
#### Parameters  
 `index`  
 [in] A value from the [CV_HREG_e Enumeration](../VS_csharp/cv_hreg_e.md) enumeration specifying which register to get the value from.  
...
## See Also  
 ...
 [CV_HREG_e Enumeration](../VS_csharp/cv_hreg_e.md)