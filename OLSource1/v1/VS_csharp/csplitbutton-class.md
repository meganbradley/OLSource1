...
## Remarks  
 ...
 ![Dialog with a splitbutton and pager control.](../VS_csharp/media/splitbutton_pager.png "SplitButton_Pager")  
...
|---------------|-----------------|  
|[in] `dwStyle`|A bitwise combination (OR) of styles to be applied to the control. For more information, see [Button Styles](../VS_csharp/button-styles.md).|  
...
|[in] `pMenu`|A pointer to a [CMenu](../VS_csharp/cmenu-class.md) object that specifies a submenu. The `CSplitButton` object deletes the `CMenu` object and its associated `HMENU` when the `CSplitButton` object goes out of scope.|  
...
### Remarks  
 ...
 To implement a custom action that the containing control supports, use a [CButton](../VS_csharp/cbutton-class.md) object with a style of `BS_SPLITBUTTON` instead of a `CSplitButton` object. Then implement a handler for the `BCN_DROPDOWN` notification in the `CButton` object. For more information, see [Button Styles](../VS_csharp/button-styles.md).  
...
|[in] `nMenuId`|The resource ID of the menu bar.|  
|[in] `nSubMenuId`|The resource ID of a submenu.|  
|[in] `pMenu`|Pointer to a [CMenu](../VS_csharp/cmenu-class.md) object that specifies a submenu. The `CSplitButton` object deletes the `CMenu` object and its associated `HMENU` when the `CSplitButton` object goes out of scope.|  
...
### Example  
 ...
 [!code[NVC_MFC_CSplitButton_s2#1](../VS_csharp/codesnippet/CPP/csplitbutton-class_1.cpp)]  
  
## See Also  
 [CSplitButton Class](../VS_csharp/csplitbutton-class.md)   
 [Hierarchy Chart](../VS_csharp/hierarchy-chart.md)   
 [CButton Class](../VS_csharp/cbutton-class.md)