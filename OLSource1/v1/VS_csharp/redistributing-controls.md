...
Visual C++ .NET supplies ActiveX controls that you can use in applications. You can then redistribute the controls along with the applications. In the **Insert ActiveX Control** dialog box, highlighting a control will display its .ocx or .dll file.  
 ...
 [MFC ActiveX Controls: Distributing ActiveX Controls](../VS_csharp/mfc-activex-controls--distributing-activex-controls.md) explains how to install and register redistributable ActiveX controls.  
 ...
 [Redistributing Database Support Files](../VS_csharp/redistributing-database-support-files.md) discusses how to redistribute support files for the database technologies found in the Microsoft Data Access SDK.  
...
## See Also  
 ...
 [MFC ActiveX Controls: Distributing ActiveX Controls](../VS_csharp/mfc-activex-controls--distributing-activex-controls.md)