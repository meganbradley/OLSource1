 ...
 **Context-sensitive help (HTML)**  
 ...
 See [HTML Help: Context-Sensitive Help for Your Programs](../VS_csharp/html-help--context-sensitive-help-for-your-programs.md) and [Help Files (HTML Help)](../VS_csharp/help-files--html-help-.md) for more information.  
  
 **Printing and print preview**  
 Generates the code to handle the print, print setup and print preview commands by calling member functions in the [CView Class](../VS_csharp/cview-class.md) from the MFC library. The wizard also adds commands for these functions to the application's menu. Printing support is available only for applications that specify **Document/view architecture support** in the [Application Type, MFC Application Wizard](../VS_csharp/application-type--mfc-application-wizard.md) page of the wizard. By default, document/view applications have printing support.  
 ...
 **ActiveX controls**  
 Supports ActiveX controls (default). If you do not select this option and later want to insert ActiveX controls into your project, you must add a call to [AfxEnableControlContainer](../VS_csharp/afxenablecontrolcontainer.md) in your application's [CWinApp::InitInstance](../Topic/CWinApp::InitInstance.md) member function.  
 ...
 **Active Accessibility**  
 Adds support for [IAccessible](http://msdn.microsoft.com/library/windows/desktop/dd318466) to [CWnd](../VS_csharp/cwnd-class.md)-derived classes, which you can use to customize the user interface for better interaction with accessibility clients.  
 ...
 **Common Control Manifest**  
 ...
 An application manifest can also specify other DLLs and versions that your application needs. For more information about application manifests, see [Isolated Applications and Side-by-Side Assemblies](http://msdn.microsoft.com/library/dd408052) in the [!INCLUDE[winsdkshort](../VS_csharp/includes/winsdkshort_md.md)].  
