...
|Name|Description|  
|----------|-----------------|  
|[IDispEventImpl::_tihclass](../VS_csharp/idispeventimpl-class.md)|The class used to manage the type information. By default, `CComTypeInfoHolder`.|  
  
### Public Constructors  
  
|Name|Description|  
|----------|-----------------|  
|[IDispEventImpl::IDispEventImpl](../VS_csharp/idispeventimpl--idispeventimpl.md)|The constructor.|  
  
### Public Methods  
  
|Name|Description|  
|----------|-----------------|  
|[IDispEventImpl::GetFuncInfoFromId](../VS_csharp/idispeventimpl--getfuncinfofromid.md)|Locates the function index for the specified dispatch identifier.|  
|[IDispEventImpl::GetIDsOfNames](../VS_csharp/idispeventimpl--getidsofnames.md)|Maps a single member and an optional set of argument names to a corresponding set of integer DISPIDs.|  
|[IDispEventImpl::GetTypeInfo](../VS_csharp/idispeventimpl--gettypeinfo.md)|Retrieves the type information for an object.|  
|[IDispEventImpl::GetTypeInfoCount](../VS_csharp/idispeventimpl--gettypeinfocount.md)|Retrieves the number of type information interfaces.|  
|[IDispEventImpl::GetUserDefinedType](../VS_csharp/idispeventimpl--getuserdefinedtype.md)|Retrieves the basic type of a user-defined type.|  
...
## Remarks  
 ...
 `IDispEventImpl` works in conjunction with the [event sink map](../VS_csharp/begin_sink_map.md) in your class to route events to the appropriate handler function. To use this class:  
  
 Add a [SINK_ENTRY](../VS_csharp/sink_entry.md) or [SINK_ENTRY_EX](../VS_csharp/sink_entry_ex.md) macro to the event sink map for each event on each object that you want to handle. When using `IDispEventImpl` as a base class of a composite control, you can call [AtlAdviseSinkMap](../VS_csharp/atladvisesinkmap.md) to establish and break the connection with the event sources for all entries in the event sink map. In other cases, or for greater control, call [DispEventAdvise](../VS_csharp/idispeventsimpleimpl--dispeventadvise.md) to establish the connection between the source object and the base class. Call [DispEventUnadvise](../VS_csharp/idispeventsimpleimpl--dispeventunadvise.md) to break the connection.  
 ...
 `IDispEventImpl` provides the same functionality as [IDispEventSimpleImpl](../VS_csharp/idispeventsimpleimpl-class.md), except it gets type information about the interface from a type library rather than having it supplied as a pointer to an [_ATL_FUNC_INFO](../VS_csharp/_atl_func_info-structure.md) structure. Use `IDispEventSimpleImpl` when you do not have a type library describing the event interface or want to avoid the overhead associated with using the type library.  
...
## Inheritance Hierarchy  
 ...
 [IDispEventSimpleImpl](../VS_csharp/idispeventsimpleimpl-class.md)  
