...
## Arguments  
 ...
 /analyze:WX-  
 Specifying **/analyze:WX-** means that code analysis warnings are not treated as errors when you compile by using **/WX**. For more information, see [/w, /Wn, /WX, /Wall, /wln, /wdn, /wen, /won (Warning Level)](../VS_csharp/-w---w0---w1---w2---w3---w4---w1---w2---w3---w4---wall---wd---we---wo---wv---wx--warning-level-.md).  
 ...
 The `number` parameter that is used with this option specifies the size, in bytes, of the stack frame for which warning [C6262](../VS_csharp/c6262.md) is generated. If this parameter is not specified, the stack frame size is 16KB by default.  
...
## Remarks  
 For more information, see [Code Analysis for C/C++ Overview](../VS_csharp/code-analysis-for-c-c---overview.md) and [C/C++ Code Analysis Warnings](../VS_csharp/code-analysis-for-c-c---warnings.md).  
