...
|`name`|Required. Name of the array variable. See [Declared Element Names](../VS_csharp/declared-element-names--visual-basic-.md).|  
...
## Example  
 ...
 [!code[VbVbalrStatements#52](../VS_csharp/codesnippet/VisualBasic/redim-statement--visual-basic-_1.vb)]  
 ...
 For additional examples, see [Arrays in Visual Basic](../VS_csharp/arrays-in-visual-basic.md).  
  
## See Also  
 <xref:System.IndexOutOfRangeException*>   
 [Const Statement](../VS_csharp/const-statement--visual-basic-.md)   
 [Dim Statement](../VS_csharp/dim-statement--visual-basic-.md)   
 [Erase Statement](../VS_csharp/erase-statement--visual-basic-.md)   
 [Nothing (Visual Basic)](../VS_csharp/nothing--visual-basic-.md)   
