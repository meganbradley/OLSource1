...
## Remarks  
 ...
 [!code[NVC_ATL_COM#42](../VS_csharp/codesnippet/CPP/ccomobjectstack-class_1.cpp)]  
...
### Remarks  
 Calls                         `FinalConstruct` and then sets                         [m_hResFinalConstruct](../Topic/CComObjectStack::m_hResFinalConstruct.md) to the                         `HRESULT` returned by                         `FinalConstruct`. If you have not derived your base class from                         [CComObjectRoot](../VS_csharp/ccomobjectroot-class.md), you must supply your own                         `FinalConstruct` method. The destructor calls                         `FinalRelease`.  
...
## See Also  
 ...
 [CComObjectGlobal Class](../VS_csharp/ccomobjectglobal-class.md)   
