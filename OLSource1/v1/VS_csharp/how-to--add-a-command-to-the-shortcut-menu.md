...
> [!NOTE]
>  You can also modify the behavior of some existing commands such as Cut, Paste, Select All, and Print by overriding methods in CommandSet.cs. For more information, see [How to: Modify an Existing Command](../VS_csharp/how-to--modify-a-standard-menu-command-in-a-domain-specific-language.md).  
...
4.  You only want to define one command.  
 ...
 Otherwise, consider using the MEF method to define commands. For more information, see [Extend your DSL using MEF](../VS_csharp/extend-your-dsl-by-using-mef.md).  
...
##  <a name="VSCT"></a> Declare the Command in Commands.Vsct  
 ...
 For more information about .vsct files, see [Visual Studio Command Table (.Vsct) Files](../VS_csharp/visual-studio-command-table--.vsct--files.md).  
...
3.  Add a visibility constraint for the command so that it is loaded only in the context of your domain-specific language. For more information, see [VisibilityConstraints Element](../VS_csharp/visibilityconstraints-element.md).  
...
### Define what the command does  
 ...
 If you make changes to model elements, you must do so inside a transaction. For more information, see [How to Create and Update model elements](../VS_csharp/how-to--modify-a-standard-menu-command-in-a-domain-specific-language.md).  
...
```  
 ...
 For more information about how to navigate from object to object in the model, and about how to create objects and links, see [How to Navigate and Update a Model](../VS_csharp/how-to--modify-a-standard-menu-command-in-a-domain-specific-language.md).  
...
-   The command will appear only in debugging instances of Visual Studio, until you install the DSL package. For more information, see [Deploying a DSL](../VS_csharp/deploying-domain-specific-language-solutions.md).  
...
## See Also  
 ...
 [How to Navigate and Update a Model](../VS_csharp/how-to--modify-a-standard-menu-command-in-a-domain-specific-language.md)   
 [Deployment](../VS_csharp/deploying-domain-specific-language-solutions.md)   
