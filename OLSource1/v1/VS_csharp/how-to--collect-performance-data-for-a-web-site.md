...
You can use the **Performance Wizard** to collect performance data for an [!INCLUDE[vstecasp](../VS_csharp/includes/vstecasp_md.md)] Web application. You can profile a Web application that is open in [!INCLUDE[vsprvs](../VS_csharp/includes/vsprvs_md.md)], or you can profile an [!INCLUDE[vstecasp](../VS_csharp/includes/vstecasp_md.md)] Web site that is located on your local computer and not open in the [!INCLUDE[vsprvs](../VS_csharp/includes/vsprvs_md.md)] IDE.  
...
-   Some users my deny access to profiling to all other users.  
 ...
 For more information, see [Profiling and Vista Security](../VS_csharp/profiling-and-windows-vista-security.md) and the ADMIN options in [VSPerfCmd](../VS_csharp/vsperfcmd.md).  
  
### To profile a Web site project  
  
1.  Open the [!INCLUDE[vstecasp](../VS_csharp/includes/vstecasp_md.md)] Web project in [!INCLUDE[vsPreShort](../VS_csharp/includes/vspreshort_md.md)] or [!INCLUDE[vsUltShort](../VS_csharp/includes/vsultshort_md.md)].  
  
2.  On the **Analyze** menu, click **Launch Performance Wizard**.  
  
3.  On the first page of the wizard, select a profiling method, and then click **Next**. For more information about profiling methods, see [Understanding Profiling Methods](../VS_csharp/understanding-performance-collection-methods.md). Note that the concurrency visualizer profiling method is not available for web applications.  
...
8.  A performance session is created for the [!INCLUDE[vstecasp](../VS_csharp/includes/vstecasp_md.md)] application, and the Web site is started in the browser. Exercise the functionality that you want to profile, and then close the browser.  
  
     The profiler generates the data file and displays the Summary view of the data in the [!INCLUDE[vsprvs](../VS_csharp/includes/vsprvs_md.md)] main window.  
  
### To profile a Web site without opening a project in Visual Studio  
  
1.  Open [!INCLUDE[vsPreShort](../VS_csharp/includes/vspreshort_md.md)] or [!INCLUDE[vsUltShort](../VS_csharp/includes/vsultshort_md.md)].  
  
2.  On the **Analyze** menu, click **Launch Performance Wizard**.  
  
3.  On the first page of the wizard, select a profiling method, and then click **Next**. For more information, see [Understanding Profiling Methods](../VS_csharp/understanding-performance-collection-methods.md).  
...
## See Also  
 [Overviews (Profiling Tools)](../VS_csharp/overviews--performance-tools-.md)   
 [Configuring Performance Sessions](../VS_csharp/configuring-performance-sessions.md)   
 [Understanding Instrumented Data Values](../VS_csharp/understanding-instrumentation-data-values.md)   
