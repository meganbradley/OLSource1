...
## Remarks  
 You can also use [pointers_to_members](../VS_csharp/pointers_to_members.md) or [Inheritance Keywords](../VS_csharp/inheritance-keywords.md) in your code to specify a pointer representation.  
