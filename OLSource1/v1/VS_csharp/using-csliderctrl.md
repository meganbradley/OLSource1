...
-   [Using Slider Controls](../VS_csharp/using-slider-controls.md)  
  
-   [Slider Control Styles](../VS_csharp/slider-control-styles.md)  
  
-   [Slider Control Member Functions](../VS_csharp/slider-control-member-functions.md)  
  
-   [Slider Notification Messages](../VS_csharp/slider-notification-messages.md)  
