...
## UIElement List  
 **Print a Message**  
 Prints a message, using DebuggerDisplay syntax. For more information, see [Using DebuggerDisplay Attribute](../VS_csharp/using-the-debuggerdisplay-attribute.md).  
