...
## Array Initialization  
 ...
 C# 3.0 introduces implicitly typed arrays. For more information, see [Implicitly Typed Arrays (C# Programming Guide)](../VS_csharp/implicitly-typed-arrays--csharp-programming-guide-.md).  
