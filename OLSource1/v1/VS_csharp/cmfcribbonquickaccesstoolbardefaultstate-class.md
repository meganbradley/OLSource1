...
---
# CMFCRibbonQuickAccessToolBarDefaultState Class
A helper class that manages default state for the Quick Access Toolbar that is positioned on the ribbon bar ( [CMFCRibbonBar Class](../VS_csharp/cmfcribbonbar-class.md)).  
...
## Remarks  
 After you create the Quick Access Toolbar in your application, we recommend that you set its default state by calling [CMFCRibbonBar::SetQuickAccessDefaultState](../VS_csharp/cmfcribbonbar-class.md#cmfcribbonbar__setquickaccessdefaultstate). This default state is restored when a user clicks the **Reset** button on the **Customize** page of your application's **Options** dialog box.  
  
## Inheritance Hierarchy  
 [CMFCRibbonQuickAccessToolBarDefaultState](../VS_csharp/cmfcribbonquickaccesstoolbardefaultstate-class.md)  
...
## Example  
 ...
 [!code[NVC_MFC_RibbonApp#21](../VS_csharp/codesnippet/CPP/cmfcribbonquickaccesstoolbardefaultstate-class_1.cpp)]  
...
### Remarks  
 By default, the list of commands that the new instance of [CMFRibbonQuickAccessToolBarDefaultState](../VS_csharp/cmfcribbonquickaccesstoolbardefaultstate-class.md) contains is empty.  
...
## See Also  
 ...
 [CMFCRibbonBar::SetQuickAccessDefaultState](../VS_csharp/cmfcribbonbar-class.md#cmfcribbonbar__setquickaccessdefaultstate)