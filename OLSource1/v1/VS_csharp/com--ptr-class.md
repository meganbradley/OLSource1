...
---
# com::ptr Class
A wrapper for a COM object that can be used as a member of a CLR class.  The wrapper also automates lifetime management of the COM object, releasing all owned references on the object when its destructor is called. Analogous to [CComPtr](../VS_csharp/ccomptr-class.md).  
...
## Remarks  
 ...
 A `com::ptr` cannot be used directly as a function parameter; use a [tracking reference (%)](../VS_csharp/tracking-reference-operator--c---component-extensions-.md) or a [handle (^)](../VS_csharp/handle-to-object-operator--^----c---component-extensions-.md) instead.  
...
## See Also  
 ...
 [ptr Members](../VS_csharp/ptr-members.md)