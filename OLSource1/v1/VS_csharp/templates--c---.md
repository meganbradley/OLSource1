...
```  
 ...
 The rules for how the compiler performs type deduction in function templates are based on the rules for ordinary functions. For more information, see [Overload Resolution in Function Templates](../VS_csharp/overload-resolution-of-function-template-calls.md).  
...
```  
 ...
 For more information, see [Template Specialization](../VS_csharp/template-specialization--c---.md).