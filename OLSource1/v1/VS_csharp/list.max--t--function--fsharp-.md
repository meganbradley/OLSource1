...
Return the greatest of all elements of the list, compared via [Operators.max](../VS_csharp/operators.max--t--function--fsharp-.md).  
...
## Example  
 ...
 [!code[FsLists#55](../VS_csharp/codesnippet/FSharp/list.max--t--function--fsharp-_1.fs)]  
