...
## Remarks  
 The **ordered** directive must be within the dynamic extent of a [for](../VS_csharp/for--openmp-.md) or **parallel for** construct with an **ordered** clause.  
  
 The **ordered** directive supports no OpenMP clauses.  
  
 For more information, see [2.6.6 ordered Construct](../VS_csharp/2.6.6-ordered-construct.md).  
