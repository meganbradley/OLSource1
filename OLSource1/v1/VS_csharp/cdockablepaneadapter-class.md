...
## Remarks  
 Usually, the framework instantiates objects of this class when you use the [CMFCBaseTabCtrl::AddTab](../VS_csharp/cmfcbasetabctrl-class.md#cmfcbasetabctrl__addtab) or [CMFCBaseTabCtrl::InsertTab](../VS_csharp/cmfcbasetabctrl-class.md#cmfcbasetabctrl__inserttab) methods.  
  
 If you want to customize the `CDockablePaneAdapter` behavior, just derive a new class from it and set the runtime class information to a tabbed window by using [CMFCBaseTabCtrl::SetDockingBarWrapperRTC](../VS_csharp/cmfcbasetabctrl-class.md#cmfcbasetabctrl__setdockingbarwrapperrtc).  
...
## Inheritance Hierarchy  
 ...
 [CDockablePaneAdapter](../VS_csharp/cdockablepaneadapter-class.md)  
