...
## Example  
 ...
 This example uses the following XML document: [Sample XML File: Numerical Data in a Namespace](../VS_csharp/sample-xml-file--numerical-data-in-a-namespace3.md).  
