...
1.  Follow the instructions in [How to: Change the Text of a Menu Command](../VS_csharp/changing-the-text-of-a-menu-command.md) to create a menu item named `New Text`.  
