...
|Method|Description|  
|------------|-----------------|  
|[IDebugProcessSecurity::GetUserName](../VS_csharp/idebugprocesssecurity--getusername.md)|Gets the user name from the port supplier.|  
|[IDebugProcessSecurity::QueryCanSafelyAttach](../VS_csharp/idebugprocesssecurity--querycansafelyattach.md)|Warns a user that attaching to the debugging process is unsafe.|  
