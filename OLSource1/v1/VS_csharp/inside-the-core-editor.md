...
The [!INCLUDE[vsprvs](../VS_csharp/includes/vsprvs_md.md)] core editor is a set of several components that let you modify and query textual information. If you have customized the core editor by using the legacy API, you may continue to use these customizations, which will be routed through editor adapters. It is recommended, however, that you adapt your customizations to the new editor API.  
...
## In This Section  
 [Instantiating the Core Editor](../VS_csharp/instantiating-the-core-editor-by-using-the-legacy-api.md)  
 ...
 [Text Buffer for the Visual Studio Editor](../VS_csharp/accessing-the-text-buffer-by-using-the-legacy-api.md)  
 ...
 [Text Buffer Events](../VS_csharp/text-buffer-events-in-the-legacy-api.md)  
 Provides a list of the interfaces that are used for notification of text buffer events.  
  
 [How to: Advise Text Buffer Events](../VS_csharp/how-to--register-for-text-buffer-events-with-the-legacy-api.md)  
 Describes how to advise text buffer events.  
  
 [Text Manager in Visual Studio](../VS_csharp/using-the-text-manager-to-monitor-global-settings.md)  
 ...
 [Code Windows](../VS_csharp/customizing-code-windows-by-using-the-legacy-api.md)  
 ...
 [Forcing View Settings](../VS_csharp/changing-view-settings-by-using-the-legacy-api.md)  
 Provides step-by-step instructions about how to force view settings and how to remove forced settings.  
  
 [Language Service and the Core Editor](../VS_csharp/language-services-and-the-core-editor.md)  
 Describes the instantiation of a language service to control code decorations.  
  
## Related Sections  
 [Walkthrough: Invoking the Core Editor](../VS_csharp/walkthrough--creating-a-core-editor-and-registering-an-editor-file-type.md)  
 Provides step-by-step instructions about how to start the core editor from managed code.  
  
 [Drop-Down Bar](../VS_csharp/drop-down-bar.md)  
 ...
 [How to: Create Custom Text Markers](../VS_csharp/how-to--create-custom-text-markers.md)  
