...
```  
 ...
 For more information, see [Lock Statement and Thread Synchronization (C# Programmers Reference)](../VS_csharp/thread-synchronization--csharp-and-visual-basic-.md).  
  
## Remarks  
 The `lock` keyword ensures that one thread does not enter a critical section of code while another thread is in the critical section. If another thread tries to enter a locked code, it will wait, block, until the object is released.  
  
 The section [Threading (Visual C#)](../VS_csharp/threading--csharp-and-visual-basic-.md) discusses threading.  
...
-   `lock("myLock")` is a problem because any other code in the process using the same string, will share the same lock.  
 ...
 You can't use the [await](../VS_csharp/await--csharp-reference-.md) keyword in the body of a `lock` statement.  
  
## Example  
 The following sample shows a simple use of threads without locking in C#.  
  
 [!code[csrefKeywordsFixedLock#5](../VS_csharp/codesnippet/CSharp/lock-statement--csharp-reference-_1.cs)]  
...
## Example  
 ...
 [!code[csrefKeywordsFixedLock#6](../VS_csharp/codesnippet/CSharp/lock-statement--csharp-reference-_2.cs)]  
...
## See Also  
 ...
 [Threading (Visual C#)](../VS_csharp/threading--csharp-and-visual-basic-.md)   
 ...
 [Lock Statement and Thread Synchronization (C# Programmers Reference)](../VS_csharp/thread-synchronization--csharp-and-visual-basic-.md)