...
## Remarks  
 ...
 [!code[NVC_ATL_Windowing#41](../VS_csharp/codesnippet/CPP/caxdialogimpl-class_1.h)]  
 ...
 For more information on `CAxDialogImpl`, see [ATL Control Containment FAQ](../VS_csharp/atl-control-containment-faq.md).  
...
### Remarks  
 ...
 The second override is provided only so dialog boxes can be used with [CComControl](../VS_csharp/ccomcontrol-class.md).  
...
## See Also  
 [CDialogImpl Class](../VS_csharp/cdialogimpl-class.md)   
