...
Here's how to create a C++ project in Visual Studio, add code, and then build and run the project. The project in this walkthrough is a program that tracks how many players are playing different card games.  
 ...
 In [!INCLUDE[vsprvs](../VS_csharp/includes/vsprvs_md.md)], work is organized in projects and solutions. A solution can contain more than one project—for example, a DLL and an executable that references that DLL. For more information, see [Introduction to Solutions, Projects, and Items](../VS_csharp/solutions-and-projects-in-visual-studio.md).  
...
## Creating a Project  
 To create a project, first choose a project-type template. For each project type, [!INCLUDE[vsprvs](../VS_csharp/includes/vsprvs_md.md)] sets compiler settings and—depending on the type—generates starter code that you can modify later.  
...
4.  Enter a name for the project in the **Name** box. For this example, enter **Game**.  
     ...
     When you create a project, [!INCLUDE[vsprvs](../VS_csharp/includes/vsprvs_md.md)] puts the project in a solution. By default, the solution has the same name as the project. You can change the name in the **Solution name** box, but for this example, keep the default name.  
...
## Organizing Projects and Files in a Solution  
 ...
 This part of the walkthrough shows how add a class to the project. When you add the class, [!INCLUDE[vsprvs](../VS_csharp/includes/vsprvs_md.md)] adds the corresponding .h and .cpp files. Next, you add a new source code file for the main program that tests the class.  
...
4.  The Cardgame.h file is opened in the editor. Make these changes:  
    ...
    -   Add two private data members after the opening brace of the class definition.  
         ...
         [!code[NVC_Walkthrough_Working_With_Projects#100](../VS_csharp/codesnippet/CPP/walkthrough--working-with-projects-and-solutions--c---_1.h)]  
    ...
    -   Modify the default constructor that Visual Studio generated. After the `public:` access specifier, find the line that looks like this:  
         ...
         [!code[NVC_Walkthrough_Working_With_Projects#101](../VS_csharp/codesnippet/CPP/walkthrough--working-with-projects-and-solutions--c---_2.h)]  
    ...
    -   After the default destructor, add an inline declaration for a static int member function named **GetParticipants** that takes no parameters and returns the **totalParticipants** value.  
         ...
         [!code[NVC_Walkthrough_Working_With_Projects#102](../VS_csharp/codesnippet/CPP/walkthrough--working-with-projects-and-solutions--c---_3.h)]  
  
5.  The Cardgame.h file should resemble this after you change it:  
  
     [!code[NVC_Walkthrough_Working_With_Projects#103](../VS_csharp/codesnippet/CPP/walkthrough--working-with-projects-and-solutions--c---_4.h)]  
  
     The line `#pragma once` tells the compiler to include the file only one time. For more information, see [once](../VS_csharp/once.md).  
  
     For information about other C++ keywords in this header file, see [class](../VS_csharp/class--c---.md), [int](../VS_csharp/fundamental-types---c---.md), [static](../Topic/Static%20\(C++\).md), and [public](../VS_csharp/public--c---.md).  
...
7.  Delete everything in the file and replace it with this code:  
     ...
     [!code[NVC_Walkthrough_Working_With_Projects#111](../VS_csharp/codesnippet/CPP/walkthrough--working-with-projects-and-solutions--c---_5.cpp)]  
    ...
    >  You can use auto-completion when you are entering code. For example, if you were entering this code, you could enter **pl** or **tot** and then press Ctrl+Spacebar so that auto-completion finishes entering `players` or `totalParticipants` for you.  
     ...
     For information about `#include`, see [The #include Directive](../VS_csharp/sharpinclude-directive--c-c---.md).  
...
3.  In the TestGames.cpp editing window, enter the following code.  
     ...
     [!code[NVC_Walkthrough_Working_With_Projects#120](../VS_csharp/codesnippet/CPP/walkthrough--working-with-projects-and-solutions--c---_6.cpp)]  
...
## Next Steps  
 **Previous:** [Introducing the Visual Studio IDE (C++)](../VS_csharp/using-the-visual-studio-ide-for-c---desktop-development.md). **Next:**[Building a Project (C++)](../VS_csharp/walkthrough--building-a-project--c---.md).  
