...
-   [Registering Controls](#_core_registering_controls)  
    ...
    > [!NOTE]
    >  For additional information on redistributing ActiveX controls, see [Redistributing Controls](../VS_csharp/redistributing-controls.md).  
...
##  <a name="_core_registering_controls"></a> Registering Controls  
 ...
 [!code[NVC_MFC_AxCont#16](../VS_csharp/codesnippet/CPP/mfc-activex-controls--distributing-activex-controls_1.cpp)]  
