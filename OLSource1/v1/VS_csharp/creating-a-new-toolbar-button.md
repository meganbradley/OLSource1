...
1.  In [Resource view](../VS_csharp/resource-view-window.md) expand the resource folder (for example, Project1.rc).  
...
3.  Assign an ID to the blank button at the right end of the toolbar. You can do so by editing the **ID** property in the [Properties Window](../VS_csharp/properties-window.md). For example, you may want to give a toolbar button the same ID as a menu option. In this case, use the drop-down list box to select the **ID** of the menu option.  
...
1.  In [Resource View](../VS_csharp/resource-view-window.md), open the toolbar by double-clicking it.  
...
## See Also  
 [Toolbar Button Properties](../VS_csharp/toolbar-button-properties.md)   
 [Creating, Moving, and Editing Toolbar Buttons](../VS_csharp/creating--moving--and-editing-toolbar-buttons.md)   
