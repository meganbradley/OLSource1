...
#### Parameters  
 ...
 For more information about data link files (.udl files), see [Data Link API Overview](https://msdn.microsoft.com/en-us/library/ms718102.aspx) in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
