...
```  
 ...
 A *literal* is a constant primary expression. Its type depends on the form of its specification. See [Literals](../VS_csharp/numeric--boolean-and-pointer-literals---c---.md) for complete information about specifying literals.  
