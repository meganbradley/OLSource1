...
2.  On the [Image Editor toolbar](../VS_csharp/toolbar--image-editor-for-icons-.md), click the arrow to the right of the [Magnify tool](../VS_csharp/toolbar--image-editor-for-icons-.md) and select the magnification-factor from the submenu: **1X**, **2X**, **6X**, or **8X**.  
...
## See Also  
 ...
 [Window Panes](../VS_csharp/window-panes--image-editor-for-icons-.md)