...
The Microsoft run-time library contains definitions for [global variables](../VS_csharp/global-variables.md), [control flags](../VS_csharp/control-flags.md), and [standard types](../VS_csharp/standard-types.md) used by library routines. Access these variables, flags, and types by declaring them in your program or by including the appropriate header files.  
