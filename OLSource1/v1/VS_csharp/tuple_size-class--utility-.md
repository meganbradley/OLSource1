...
## Remarks  
 The template is a specialization of the template class [tuple_size](../VS_csharp/tuple_size-class--tuple-.md). It has a member `value` that is an integral constant expression whose value is 2.  
...
## See Also  
 ...
 [tuple_element](../VS_csharp/tuple_element-class--utility-.md)