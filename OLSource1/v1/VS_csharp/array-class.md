...
|[array::get_accelerator_view Method](#array__get_accelerator_view_method)|Returns the                                         [accelerator_view](../VS_csharp/accelerator_view-class.md) object that represents the location where the array is allocated. This property can be accessed only on the CPU.|  
|[array::get_associated_accelerator_view Method](#array__get_associated_accelerator_view_method)|Gets the second                                         [accelerator_view](../VS_csharp/accelerator_view-class.md) object that is passed as a parameter when a staging constructor is called to instantiate the                                          [array](../VS_csharp/array-class.md) object.|  
...
|[array::get_extent Method](#array__get_extent_method)|Returns the                                         [extent](../VS_csharp/extent-class--c---amp-.md) object of the array.|  
...
|[array::section Method](#array__section_method)|Returns a subsection of the                                         [array](../VS_csharp/array-class.md) object that is at the specified origin and, optionally, that has the specified extent.|  
|[array::view_as Method](#array__view_as_method)|Returns an                                         [array_view](../VS_csharp/array_view-class.md) object that is constructed from the                                         `array` object.|  
  
### Public Operators  
  
|Name|Description|  
|----------|-----------------|  
|[array::operator std::vector<_Value_type> Operator](#array__operator_std__vector_lt__value_type_gt__operator)|Uses                                         `copy(*this, vector)` to implicitly convert the array to a                                         [std::vector](../VS_csharp/vector-class.md) object.|  
...
|Name|Description|  
|----------|-----------------|  
|[array::accelerator_view Data Member](#array__accelerator_view_data_member)|Gets the                                         [accelerator_view](../VS_csharp/accelerator_view-class.md) object that represents the location where the array is allocated. This property can be accessed only on the CPU.|  
|[array::associated_accelerator_view Data Member](#array__associated_accelerator_view_data_member)|Gets the second                                         [accelerator_view](../VS_csharp/accelerator_view-class.md) object that is passed as a parameter when a staging constructor is called to instantiate the                                         [array](../VS_csharp/array-class.md) object.|  
...
##  <a name="array__accelerator_view_data_member"></a>  array::accelerator_view Data Member  
 Gets the                 [accelerator_view](../VS_csharp/accelerator_view-class.md) object that represents the location where the array is allocated. This property can be accessed only on the CPU.  
...
##  <a name="array__associated_accelerator_view_data_member"></a>  array::associated_accelerator_view Data Member  
 Gets the second                 [accelerator_view](../VS_csharp/accelerator_view-class.md) object that is passed as a parameter when a staging constructor is called to instantiate the                  [array](../VS_csharp/array-class.md) object.  
...
##  <a name="array__copy_to_method"></a>  array::copy_to Method  
 Copies the contents of the                 [array](../VS_csharp/array-class.md) to another                 `array`.  
...
### Parameters  
 `_Dest`  
 The                                 [array_view](../VS_csharp/array_view-class.md) object to copy to.  
...
##  <a name="array__data_method"></a>  array::data Method  
 Returns a pointer to the raw data of the                 [array](../VS_csharp/array-class.md).  
...
##  <a name="array__extent_data_member"></a>  array::extent Data Member  
 Gets the                 [extent](../VS_csharp/extent-class--c---amp-.md) object that defines the shape of the                 [array](../VS_csharp/array-class.md).  
...
##  <a name="array__get_accelerator_view_method"></a>  array::get_accelerator_view Method  
 Returns the                 [accelerator_view](../VS_csharp/accelerator_view-class.md) object that represents the location where the                 [array](../VS_csharp/array-class.md) object is allocated. This property can be accessed only on the CPU.  
...
### Return Value  
 The                         `accelerator_view` object that represents the location where the                         [array](../VS_csharp/array-class.md) object is allocated.  
...
### Return Value  
 The second                         [accelerator_view](../VS_csharp/accelerator_view-class.md) object passed to the staging constructor.  
...
##  <a name="array__operator_std__vector_lt__value_type_gt__operator"></a>  array::operator std::vector&lt;_Value_type&gt; Operator  
 Uses                 `copy(*this, vector)` to implicitly convert the array to a                 [std::vector](../VS_csharp/vector-class.md) object.  
...
##  <a name="array__operator_eq_operator"></a>  array::operator= Operator  
 Copies the contents of the specified                 [array](../VS_csharp/array-class.md) object.  
...
##  <a name="array__rank_constant"></a>  array::rank Constant  
 Stores the rank of the                 [array](../VS_csharp/array-class.md).  
...
##  <a name="array__section_method"></a>  array::section Method  
 Returns a subsection of the                 [array](../VS_csharp/array-class.md) object that is at the specified origin and, optionally, that has the specified extent.  
