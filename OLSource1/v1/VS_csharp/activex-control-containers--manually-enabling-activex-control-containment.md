...
-   Modify your main dialog's `InitInstance` function (found in CONTAINER.CPP) by the MFC Application Wizard making a call to [AfxEnableControlContainer](../VS_csharp/afxenablecontrolcontainer.md), as in the following example:  
  
     [!code[NVC_MFCOleContainer#34](../VS_csharp/codesnippet/CPP/activex-control-containers--manually-enabling-activex-control-containment_1.cpp)]  
    [!code[NVC_MFCOleContainer#35](../VS_csharp/codesnippet/CPP/activex-control-containers--manually-enabling-activex-control-containment_2.cpp)]  
  
-   Add the following to your project's STDAFX.H header file:  
  
     [!code[NVC_MFCOleContainer#36](../VS_csharp/codesnippet/CPP/activex-control-containers--manually-enabling-activex-control-containment_3.h)]  
