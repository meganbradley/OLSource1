...
invalid or corrupt file: file contains invalid .pdata contributions  
 ...
 To fix this issue, try compiling without [/GL (Whole Program Optimization)](../VS_csharp/linker-tools-error-lnk1223.md) enabled. Empty function bodies can also cause this error in some cases.