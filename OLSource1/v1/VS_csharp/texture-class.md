...
|Name|Description|  
|----------|-----------------|  
|[texture::texture Constructor](#texture__texture_constructor)|Initializes a new instance of the                                         [texture](../VS_csharp/texture-class.md) class.|  
|[texture::~texture Destructor](#texture___dtortexture_destructor)|Destroys the                                         [texture](../VS_csharp/texture-class.md) object.|  
  
### Public Methods  
  
|Name|Description|  
|----------|-----------------|  
|[texture::copy_to Method](#texture__copy_to_method)|Copies the                                         [texture](../VS_csharp/texture-class.md) object to the destination, by doing a deep copy.|  
...
|[Texture::get_associated_accelerator_view Data Member](#texture__get_associated_accelerator_view_method)|Returns the                                         [accelerator_view](../VS_csharp/accelerator_view-class.md) that is the preferred target for this texture to be copied to.|  
...
|[texture::operator= Operator](#texture__operator_eq_operator)|Copies the specified                                         [texture](../VS_csharp/texture-class.md) object to this one.|  
  
### Public Constants  
  
|Name|Description|  
|----------|-----------------|  
|[texture::rank Constant](#texture__rank_constant)|Gets the rank of the                                         [texture](../VS_csharp/texture-class.md) object.|  
  
### Public Data Members  
  
|Name|Description|  
|----------|-----------------|  
|[Texture::associated_accelerator_view Data Member](#texture__associated_accelerator_view_data_member)|Gets the                                         [accelerator_view](../VS_csharp/accelerator_view-class.md) that is the preferred target for this texture to be copied to.|  
...
##  <a name="texture___dtortexture_destructor"></a>  texture::~texture Destructor  
 Destroys the                 [texture](../VS_csharp/texture-class.md) object.  
...
##  <a name="texture__associated_accelerator_view_data_member"></a>  texture::associated_accelerator_view Data Member  
 Gets the                 [accelerator_view](../VS_csharp/accelerator_view-class.md) that is the preferred target for this texture to be copied to.  
...
##  <a name="texture__copy_to_method"></a>  texture::copy_to Method  
 Copies the                 [texture](../VS_csharp/texture-class.md) object to the destination, by doing a deep copy.  
...
### Return Value  
 The                         [accelerator_view](../VS_csharp/accelerator_view-class.md) that is the preferred target for this texture to be copied to.  
...
##  <a name="texture__rank_constant"></a>  texture::rank Constant  
 Gets the rank of the                 [texture](../VS_csharp/texture-class.md) object.  
...
##  <a name="texture__texture_constructor"></a>  texture::texture Constructor  
 Initializes a new instance of the                 [texture](../VS_csharp/texture-class.md) class.  
...
### Parameters  
 `_Acc_view`  
 The                                 [accelerator_view](../VS_csharp/accelerator_view-class.md) that specifies the location of the texture.  
