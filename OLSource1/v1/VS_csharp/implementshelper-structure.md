...
#### Parameters  
 `RuntimeClassFlagsT`  
 A field of flags that specifies one or more [RuntimeClassType](../VS_csharp/runtimeclasstype-enumeration.md) enumerators.  
...
## Remarks  
 Helps implement the [Implements](../VS_csharp/implements-structure.md) structure.  
