...
You can use the [!INCLUDE[vsprvs](../VS_csharp/includes/vsprvs_md.md)] Profiling Tools instrumentation method to collect detailed timing data, .NET memory allocation data, and .NET object lifetime data from dynamically compiled [!INCLUDE[vstecasp](../VS_csharp/includes/vstecasp_md.md)] Web applications.  
  
 This topic describes how to modify the web.config configuration file to enable the instrumentation and profiling of [!INCLUDE[vstecasp](../VS_csharp/includes/vstecasp_md.md)] Web applications.  
  
> [!NOTE]
>  You are not required to modify the web.config file when you use the sampling profiling method, or when you want to instrument a pre-compiled [!INCLUDE[vstecasp](../VS_csharp/includes/vstecasp_md.md)] module.  
  
 The root of a web.config file is the **configuration** element. To instrument and profile a dynamically compiled [!INCLUDE[vstecasp](../VS_csharp/includes/vstecasp_md.md)] Web application, you must add or modify the following elements:  
...
8.  Add the following attribute names and values to the **codeBase** element:  
    ...
    |**href**|`PathToASPNetHelperDll`|  
     ...
     `PathToASPNetHelperDll` is the file URL of the Microsoft.VisualStudio.Enterprise.ASPNetHelper.dll. If [!INCLUDE[vsprvs](../VS_csharp/includes/vsprvs_md.md)] is installed in the default location, the **href** value should be `C:/Program%20Files/Microsoft%20Visual%20Studio%202010.0/Common7/IDE/PrivateAssemblies/Microsoft.VisualStudio.Enterprise.ASPNetHelper.DLL`  
...
5.  Add the following attribute names and values to this **add** element:  
    ...
    |**value**|`PerformanceToolsFolder`|  
     ...
     `PerformanceToolsFolder` is the path of the profiler executable files. If [!INCLUDE[vsprvs](../VS_csharp/includes/vsprvs_md.md)] is installed in the default location, the value will be **C:\Program Files\Microsoft Visual Studio 10.0\Team Tools\Performance Tools**  
...
## Example  
 The following is a complete web.config file that enables the instrumentation and profiling of dynamically compiled [!INCLUDE[vstecasp](../VS_csharp/includes/vstecasp_md.md)] Web applications. This example assumes that there were no other settings in the file before modification.  
...
## See Also  
 [How to: Instrument a Dynamically Compiled ASP.NET Web Application and Collect Detailed Timing Data with the Profiler by Using the Command Line](../VS_csharp/how-to--instrument-a-dynamically-compiled-asp.net-web-application-and-collect-detailed-timing-data-with-the-profiler-by-using-the-command-line.md)   
 [How to: Instrument a Dynamically Compiled ASP.NET Web Application and Collect Memory Data by Using the Profiler Command Line](../VS_csharp/how-to--instrument-a-dynamically-compiled-asp.net-web-application-and-collect-memory-data-by-using-the-profiler-command-line.md)