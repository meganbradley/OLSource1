...
-   By adding your custom Start Page files to an empty VSIX Project. For more information, see [VSIX Project Template](../VS_csharp/vsix-project-template.md).  
  
-   By manually creating a .vsix file. For more information, see [How to: Manually Package an Extension (VSIX Deployment)](../Topic/How%20to:%20Manually%20Package%20an%20Extension%20\(VSIX%20Deployment\).md).  
...
3.  In the **Customize Start Page** list on the **Startup** options page, select the new Start Page. For more information, see [Custom Start Pages](../VS_csharp/customizing-the-start-page-for-visual-studio.md).  
  
## See Also  
 [Customizing the Start Page](../VS_csharp/customizing-the-start-page-for-visual-studio.md)   
