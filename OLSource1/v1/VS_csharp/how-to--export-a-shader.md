...
1.  In [!INCLUDE[vsprvs](../VS_csharp/includes/vsprvs_md.md)], open a **Visual Shader Graph (.dgsl)** file.  
  
     If you don't have a **Visual Shader Graph (.dgsl)** file to open, create one as described in [How to: Create a Basic Color Shader](../VS_csharp/how-to--create-a-basic-color-shader.md).  
