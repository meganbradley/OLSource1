...
## Remarks  
 ...
 Both member functions return an iterator that designates the first element remaining beyond any elements removed, or [end](../VS_csharp/vector--end--stl-clr-.md)`()` if no such element exists.  
