...
### Remarks  
 The `generic_categor`y object is an implementation of [error_category](../VS_csharp/error_category-class.md).  
...
### Remarks  
 The `system_categor`y object is an implementation of [error_category](../VS_csharp/error_category-class.md).  
