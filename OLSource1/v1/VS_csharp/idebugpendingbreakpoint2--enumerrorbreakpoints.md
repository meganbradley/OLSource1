...
#### Parameters  
 `bpErrorType`  
 [in] A combination of values from the [BP_ERROR_TYPE](../VS_csharp/bp_error_type.md) enumeration that selects the type of errors to enumerate.  
  
 `ppEnum`  
 [out] Returns an [IEnumDebugErrorBreakpoints2](../VS_csharp/ienumdebugerrorbreakpoints2.md) object that contains a list of [IDebugErrorBreakpoint2](../VS_csharp/idebugerrorbreakpoint2.md) objects.  
