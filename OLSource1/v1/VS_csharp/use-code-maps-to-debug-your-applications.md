...
Code maps can help you avoid getting lost in large code bases, unfamiliar code, or legacy code. For example, when you’re debugging, you might have to look at code across many files and projects. Use code maps to navigate around pieces of code and understand the relationships between them. That way, you don't have to keep track of this code in your head, or draw a separate diagram. So, when your work is interrupted, code maps help refresh your memory about the code you're working on.  
 ...
 ![Code map &#45; Map relationships in code](../VS_csharp/media/codemapstoryboardpaint.png "CodeMapStoryboardPaint")  
...
## Understand the problem  
 ...
 ![Code map &#45; Repro bug](../VS_csharp/media/codemapstoryboardpaint0.png "CodeMapStoryboardPaint0")  
  
 So you start investigating by searching for the `Undo` method. You find it in the `PaintCanvas` class.  
  
 ![Code map &#45; Find code](../VS_csharp/media/codemapstoryboardpaint1.png "CodeMapStoryboardPaint1")  
...
## Start mapping the code  
 ...
 ![Code map &#45; Show method and related fields](../VS_csharp/media/codemapstoryboardpaint3.png "CodeMapStoryboardPaint3")  
...
>  The green highlighting shows the last items that were added to the map. The green arrow shows your cursor’s position in the code. Arrows between items represent different relationships. You can get more info about items on the map by moving the mouse over them and examining their tooltips.  
 ...
 ![Code map &#45; Show tooltips](../VS_csharp/media/codemapstoryboardpaint4.png "CodeMapStoryboardPaint4")  
...
## Navigate and examine code from the map  
 ...
 ![Code map &#45; Examine field definition](../VS_csharp/media/codemapstoryboardpaint5.png "CodeMapStoryboardPaint5")  
  
 ![Code map &#45; Examine field definition](../VS_csharp/media/codemapstoryboardpaint5a.png "CodeMapStoryboardPaint5A")  
...
## Understand relationships between pieces of code  
 ...
 ![Code map &#45; Find all references](../VS_csharp/media/codemapstoryboardpaint6.png "CodeMapStoryboardPaint6")  
  
 ![Open a code map from the code editor](../VS_csharp/media/codemapstoryboardpaint6a.PNG "CodeMapStoryboardPaint6A")  
...
>  If you add items from a project that's shared across multiple apps, like Windows Phone or Windows Store, then those items always appear with the currently active app project on the map. So, if you change the context to another app project, then the context on the map also changes for any newly added items from the shared project. Operations that you perform with an item on the map apply only to those items that share the same context.  
 ...
 ![Code map &#45; Change layout](../VS_csharp/media/codemapstoryboardpaint7a.png "CodeMapStoryboardPaint7A")  
...
>  By default, **Incremental Layout** is turned on. This rearranges the map as little as possible when you add new items. To rearrange the entire map every time you add new items, turn off **Incremental Layout**.  
 ...
 ![Code map &#45; Change layout](../VS_csharp/media/codemapstoryboardpaint7.png "CodeMapStoryboardPaint7")  
 ...
 ![Code map &#45; Examine method definition](../VS_csharp/media/codemapstoryboardpaint8.png "CodeMapStoryboardPaint8")  
 ...
 ![Code map &#45; Examine method definition](../VS_csharp/media/codemapstoryboardpaint9.png "CodeMapStoryboardPaint9")  
 ...
 ![Code map &#45; Examine method definition](../VS_csharp/media/codemapstoryboardpaint10.png "CodeMapStoryboardPaint10")  
...
## Find the problem by examining the map  
 ...
 ![Code map &#45; Find missing method call](../VS_csharp/media/codemapstoryboardpaint11.png "CodeMapStoryboardPaint11")  
...
## Share your discovery and next steps  
 ...
 ![Code map &#45; Comment and flag items for followup](../VS_csharp/media/codemapstoryboardpaint12.png "CodeMapStoryboardPaint12")  
  
 For example, you can add comments to the map and flag items using colors.  
  
 ![Code map &#45; Commented and flagged items](../VS_csharp/media/codemapstoryboardpaint12a.png "CodeMapStoryboardPaint12A")  
 ...
 ![Code map &#45; Share, export, mail](../VS_csharp/media/codemapstoryboardpaint13.png "CodeMapStoryboardPaint13")  
  
## Fix the problem and show what you did  
 To fix this bug, you add the call for `Repaint` to `undo`.  
  
 ![Code map &#45; Add missing method call](../VS_csharp/media/codemapstoryboardpaint14.png "CodeMapStoryboardPaint14")  
 ...
 ![Code map &#45; Confirm code fix](../VS_csharp/media/codemapstoryboardpaint15.png "CodeMapStoryboardPaint15")  
  
 You can update the map to show the fix you made.  
  
 ![Code map &#45; Update map with missing method call](../VS_csharp/media/codemapstoryboardpaint16.png "CodeMapStoryboardPaint16")  
  
 Your map now shows a link between **undo** and **Repaint**.  
  
 ![Code map &#45; Updated map with method call](../VS_csharp/media/codemapstoryboardpaint17.png "CodeMapStoryboardPaint17")  
...
## See Also  
 ...
 [Visualize Code](../VS_csharp/visualize-code.md)