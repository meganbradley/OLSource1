...
## Members  
 ...
 DSS_FUNCTION  
 Specifies that the function contained by the code context should be disassembled. Specifies that the disassembly stream represents a function, when returned by the [GetScope](../VS_csharp/idebugdisassemblystream2--getscope.md) method.  
...
## Remarks  
 Passed as an argument to the [GetDisassemblyStream](../VS_csharp/idebugprogram2--getdisassemblystream.md) method and returned by the [GetScope](../VS_csharp/idebugdisassemblystream2--getscope.md) method.  
...
## See Also  
 ...
 [GetScope](../VS_csharp/idebugdisassemblystream2--getscope.md)