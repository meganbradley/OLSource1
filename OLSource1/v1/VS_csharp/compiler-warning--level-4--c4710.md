...
'function' : function not inlined  
 ...
 In some cases, the compiler will not inline a particular function for mechanical reasons. See [C4714](../VS_csharp/compiler-warning--level-4--c4714.md) for a list of reasons the compiler may not inline a function.  
