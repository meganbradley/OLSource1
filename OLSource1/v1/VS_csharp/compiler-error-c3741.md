...
'class': must be a coclass when the 'layout_dependent' parameter of event_receiver = true  
 ...
 When `layout_dependent=true`for an [event_receiver](../VS_csharp/event_receiver.md) class, then the class must also have the [coclass](../VS_csharp/coclass.md) attribute.  
