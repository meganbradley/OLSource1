...
## Example  
 The following code example defines packages for the [!INCLUDE[dnprdnshort](../VS_csharp/includes/dnprdnshort_md.md)] redistributable package and its dependencies, such as the Windows Installer.  
...
## See Also  
 [<Product\> Element (ClickOnce Bootstrapper)](../VS_csharp/-product--element--bootstrapper-.md)   
 [<Package\> Element (ClickOnce Bootstrapper)](../VS_csharp/-package--element--bootstrapper-.md)   
