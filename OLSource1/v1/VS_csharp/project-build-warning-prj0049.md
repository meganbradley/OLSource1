...
Referenced target '<Reference\>' requires .NET Framework <MinFrameworkVersion\> and will fail to run on this project's target framework  
 ...
 Applications created by using [!INCLUDE[vs_orcas_long](../VS_csharp/includes/vs_orcas_long_md.md)] can specify which version of the [!INCLUDE[dnprdnshort](../VS_csharp/includes/dnprdnshort_md.md)] they should target. If you add a reference to an assembly or project that depends on a version of the [!INCLUDE[dnprdnshort](../VS_csharp/includes/dnprdnshort_md.md)] that is later than the targeted version, you will get this warning at compile time.  
...
## See Also  
 [Project Build Errors and Warnings (PRJxxxx)](../VS_csharp/project-build-errors-and-warnings--prjxxxx-.md)