...
## Remarks  
 To obtain the attribute bytes associated with the custom attribute, call the [IDebugCustomAttributeQuery2::GetCustomAttributeByName](../VS_csharp/idebugcustomattributequery2--getcustomattributebyname.md) method.  
