...
#### Parameters  
 ...
 rgelt  
 [out] An array that is to be filled with the [IDiaSectionContrib](../VS_csharp/idiasectioncontrib.md) objects that represent the desired section contributions.  
