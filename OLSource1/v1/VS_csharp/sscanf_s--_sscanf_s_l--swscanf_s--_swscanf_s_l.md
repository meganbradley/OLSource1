...
Reads formatted data from a string. These versions of [sscanf, _sscanf_l, swscanf, _swscanf_l](../VS_csharp/sscanf--_sscanf_l--swscanf--_swscanf_l.md) have security enhancements, as described in [Security Enhancements in the CRT](../VS_csharp/security-features-in-the-crt.md).  
...
#### Parameters  
 ...
 `format`  
 Format-control string. For more information, see [Format Specification Fields: scanf and wscanf Functions](../VS_csharp/format-specification-fields--scanf-and-wscanf-functions.md).  
...
## Return Value  
 ...
 If `buffer` or `format` is a `NULL` pointer, the invalid parameter handler is invoked, as described in [Parameter Validation](../VS_csharp/parameter-validation.md). If execution is allowed to continue, these functions return -1 and set `errno` to `EINVAL`  
...
## Remarks  
 ...
 For more information, see [scanf_s, wscanf_s](../VS_csharp/scanf_s--_scanf_s_l--wscanf_s--_wscanf_s_l.md) and [scanf Type Field Characters](../VS_csharp/scanf-type-field-characters.md).  
...
## See Also  
 ...
 [_snprintf, _snwprintf](../VS_csharp/snprintf--_snprintf--_snprintf_l--_snwprintf--_snwprintf_l.md)