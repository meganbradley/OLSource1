...
When you want to extend project systems, you can use commands and command groups provided by the [!INCLUDE[vsprvs](../VS_csharp/includes/vsprvs_md.md)] IDE.  
...
## See Also  
 ...
 [Creating Reusable Groups of Buttons](../VS_csharp/creating-reusable-groups-of-buttons.md)