...
## Remarks  
 This class is used by [CComHeapPtr](../VS_csharp/ccomheapptr-class.md) to provide the COM memory allocation routines. The counterpart class, [CCRTAllocator](../VS_csharp/ccrtallocator-class.md), provides the same methods using CRT routines.  
