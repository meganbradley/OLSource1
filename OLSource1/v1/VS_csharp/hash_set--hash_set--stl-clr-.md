...
## Remarks  
 ...
 initializes the controlled sequence with the sequence `[``right``.`[begin](../VS_csharp/hash_set--begin--stl-clr-.md)`(),` `right``.`[end](../VS_csharp/hash_set--end--stl-clr-.md)`())`, with the default ordering predicate, and with the default hash function. You use it to specify an initial controlled sequence that is a copy of the sequence controlled by the hash_set object `right`, with the default ordering predicate and hash function.  
...
## See Also  
 ...
 [generic_container](../VS_csharp/hash_set--generic_container--stl-clr-.md)   
 [operator=](../VS_csharp/hash_set--operator=--stl-clr-.md)