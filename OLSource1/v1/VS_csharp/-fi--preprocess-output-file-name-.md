...
Specifies the name of the output file to which the [/P (Preprocess to a File)](../VS_csharp/-p--preprocess-to-a-file-.md) compiler option writes preprocessed output.  
...
## Example  
 The following command line preprocesses PROGRAM.cpp, preserves comments, adds [#line](../VS_csharp/sharpline-directive--c-c---.md) directives, and writes the result to the MYPROCESS.i file.  
...
## See Also  
 ...
 [/P (Preprocess to a File)](../VS_csharp/-p--preprocess-to-a-file-.md)   
