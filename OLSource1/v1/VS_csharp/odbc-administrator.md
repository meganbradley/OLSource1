...
---
# ODBC Administrator
ODBC Administrator registers and configures the [data sources](../VS_csharp/data-source--odbc-.md) available to you either locally or across a network. The wizards use information supplied by ODBC Administrator to create code in your applications that connects your users to data sources.  
