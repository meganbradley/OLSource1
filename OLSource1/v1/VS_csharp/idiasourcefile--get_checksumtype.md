...
|2|`CALG_SHA1`|checksum generated with the SHA1 hashing algorithm.|  
 ...
 The `CryptoAPI` labels are from the `ALG_ID` enumeration. For more information on hashing algorithms, consult the `CryptoAPI` section of the Microsoft [!INCLUDE[winsdkshort](../VS_csharp/includes/winsdkshort_md.md)].  
  
 To obtain the actual checksum bytes for the source file, call the [IDiaSourceFile::get_checksum](../VS_csharp/idiasourcefile--get_checksum.md) method.  
  
## See Also  
 [IDiaSourceFile](../VS_csharp/idiasourcefile.md)   
 [IDiaSourceFile::get_checksum](../VS_csharp/idiasourcefile--get_checksum.md)