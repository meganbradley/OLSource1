...
Creates an array where the entries are initially the default value [Unchecked.defaultof<'T>](../VS_csharp/unchecked.defaultof--t--type-function--fsharp-.md).  
...
## Example  
 ...
 [!code[FsArrays#4](../VS_csharp/codesnippet/FSharp/array.zerocreate--t--function--fsharp-_1.fs)]  
