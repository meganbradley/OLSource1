...
You can type pre- or post-build events for the [Build Events Pane](../VS_csharp/build-events-page--project-designer--csharp-.md) directly in the edit box, or you can select pre- and post-build macros from a list of available macros.  
...
## See Also  
 [Specifying Custom Build Events](../VS_csharp/specifying-custom-build-events-in-visual-studio.md)   
 [Build Events Pane, Project Designer (C#)](../VS_csharp/build-events-page--project-designer--csharp-.md)   
