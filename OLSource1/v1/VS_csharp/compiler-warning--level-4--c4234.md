...
nonstandard extension used: 'keyword' keyword reserved for future use  
 ...
 This warning is automatically promoted to an error. If you wish to modify this behavior, use [#pragma warning](../VS_csharp/warning.md). For example, to make C4234 into a level 4 warning issue,  
