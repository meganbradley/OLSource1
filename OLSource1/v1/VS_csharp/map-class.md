...
#### Parameters  
 ...
 In C++14 you can enable heterogeneous lookup by specifying the std::less<> predicate that has no type parameters. For more information, see [Heterogeneous Lookup in Associative Containers](../VS_csharp/stl-containers.md#sequence_containers)  
...
>   
>  In C++14 you can enable heterogeneous lookup by specifying the `std::less<>` or `std::greater<>` predicate that has no type parameters. For more information, see [Heterogeneous Lookup in Associative Containers](../VS_csharp/stl-containers.md#sequence_containers)  
...
### Remarks  
 If the argument key value is not found, then the function throws an object of class [out_of_range Class](../VS_csharp/out_of_range-class.md).  
...
### Return Value  
 A const reverse bidirectional iterator addressing the first element in a reversed [map](../VS_csharp/map-class.md) or addressing what had been the last element in the unreversed `map`.  
...
### Return Value  
 A const reverse bidirectional iterator that addresses the location succeeding the last element in a reversed [map](../VS_csharp/map-class.md) (the location that had preceded the first element in the unreversed `map`).  
...
### Return Value  
 A [pair](../VS_csharp/pair-structure.md) whose `bool` component is true if an insertion was made, and false if the map already contained an element of equivalent value in the ordering. The iterator component of the return-value pair points to the newly inserted element if the `bool` component is true, or to the existing element if the `bool` component is false.  
...
|`InputIterator`|Template function argument that meets the requirements of an [input iterator](../VS_csharp/input_iterator_tag-struct.md) that points to elements of a type that can be used to construct [value_type](#map__value_type) objects.|  
|`IList`|The [initializer_list](../VS_csharp/-initializer_list-.md) from which to copy the elements.|  
  
### Return Value  
 The single-element member functions, (1) and (2), return a [pair](../VS_csharp/pair-structure.md) whose `bool` component is true if an insertion was made, and false if the map already contained an element whose key had an equivalent value in the ordering. The iterator component of the return-value pair points to the newly inserted element if the `bool` component is true, or to the existing element if the `bool` component is false.  
...
### Remarks  
 ...
 The initializer list member function (6) uses an [initializer_list](../VS_csharp/-initializer_list-.md) to copy elements into the map.  
...
### Remarks  
 ...
 For more information on `Traits` see the [map Class](../VS_csharp/map-class.md) topic.  
...
### Remarks  
 ...
 For more information on `Key`, see the Remarks section of the [map Class](../VS_csharp/map-class.md) topic.  
...
### Remarks  
 ...
 For more information on `Type` see the [map Class](../VS_csharp/map-class.md) topic.  
...
|-|-|  
|Parameter|Description|  
|`_Right`|The [map](../VS_csharp/map-class.md) being copied into the `map`.|  
