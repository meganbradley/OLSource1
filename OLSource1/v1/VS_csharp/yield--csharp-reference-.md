...
-   Anonymous methods. For more information, see [Anonymous Methods](../VS_csharp/anonymous-methods--csharp-programming-guide-.md).  
  
-   Methods that contain unsafe blocks. For more information, see [unsafe](../VS_csharp/unsafe--csharp-reference-.md).  
