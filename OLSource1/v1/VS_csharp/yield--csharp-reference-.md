...
-   The declaration can't have any [ref](../VS_csharp/ref--csharp-reference-.md) or [out](../VS_csharp/out--csharp-reference-.md) parameters.  
...
-   Anonymous methods. For more information, see [Anonymous Methods (C# Programming Guide)](../VS_csharp/anonymous-methods--csharp-programming-guide-.md).  
  
-   Methods that contain unsafe blocks. For more information, see [unsafe (C# Reference)](../VS_csharp/unsafe--csharp-reference-.md).  
...
## Example  
 ...
 [!code[csrefKeywordsContextual#5](../VS_csharp/codesnippet/CSharp/yield--csharp-reference-_1.cs)]  
...
## Example  
 ...
 [!code[csrefKeywordsContextual#21](../VS_csharp/codesnippet/CSharp/yield--csharp-reference-_2.cs)]  
