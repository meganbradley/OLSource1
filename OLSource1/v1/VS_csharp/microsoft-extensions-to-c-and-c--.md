...
## Keywords  
 Several keywords are added. In the list in [Keywords](../VS_csharp/keywords--c---.md), the keywords that have two leading underscores are Visual C++ extensions.  
...
```  
 ...
 To avoid errors when an out-of-class definition is provided in a header file and the header file is included in multiple source files, use [selectany](../VS_csharp/selectany.md). For example:  
