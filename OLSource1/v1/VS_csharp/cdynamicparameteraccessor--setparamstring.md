...
## Remarks  
 ...
 Use `SetParamString` to set string parameter data in the buffer. Use [SetParam](../VS_csharp/cdynamicparameteraccessor--setparam.md) to set nonstring parameter data in the buffer.  
