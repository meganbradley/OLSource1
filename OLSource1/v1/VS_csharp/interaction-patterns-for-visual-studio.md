...
-   [Menus and Commands for Visual Studio](../VS_csharp/menus-and-commands-for-visual-studio.md)  
  
-   [Application Patterns for Visual Studio](../VS_csharp/application-patterns-for-visual-studio.md)  
  
    -   [Window interactions](../VS_csharp/application-patterns-for-visual-studio.md#BKMK_WindowInteractions)  
  
    -   [Tool windows](../VS_csharp/application-patterns-for-visual-studio.md#BKMK_ToolWindows)  
  
    -   [Document editor conventions](../VS_csharp/application-patterns-for-visual-studio.md#BKMK_DocumentEditorConventions)  
  
    -   [Dialogs](../VS_csharp/application-patterns-for-visual-studio.md#BKMK_Dialogs)  
  
    -   [Projects](../VS_csharp/application-patterns-for-visual-studio.md#BKMK_Projects)  
...
-   [Common Control Patterns for Visual Studio](../VS_csharp/common-control-patterns-for-visual-studio.md)  
  
    -   [Common controls](../VS_csharp/common-control-patterns-for-visual-studio.md#BKMK_CommonControls)  
...
-   [Composite Patterns for Visual Studio](../VS_csharp/composite-patterns-for-visual-studio.md)  
