...
```  
 ...
 Note that the Microsoft C compiler maps **long double** to type **double**. See [Storage of Basic Types](../VS_csharp/storage-of-basic-types.md) for information about type **double**, **float**, and **long**.  
