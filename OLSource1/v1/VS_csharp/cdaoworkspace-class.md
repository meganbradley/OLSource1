...
-   Explicitly open the default workspace.  
     ...
     Usually your use of the default workspace is implicit — when you open new [CDaoDatabase](../VS_csharp/cdaodatabase-class.md) or [CDaoRecordset](../VS_csharp/cdaorecordset-class.md) objects. But you might need to access it explicitly — for example, to access database engine properties or the Workspaces collection. See "Implicit Use of the Default Workspace" below.  
...
## Other Operations  
 ...
 For information about calling DAO directly and about DAO security, see [Technical Note 54](../VS_csharp/tn054--calling-dao-directly-while-using-mfc-dao-classes.md).  
...
-   Or call the object's [Create](#cdaoworkspace__create) member function to create a new DAO workspace object. This explicitly starts a new workspace session, which you can refer to via the `CDaoWorkspace` object. After calling **Create**, you can call [Append](#cdaoworkspace__append) if you want to add the workspace to the database engine's Workspaces collection.  
 ...
 See the class overview for [CDaoWorkspace](../VS_csharp/cdaoworkspace-class.md) for information about when you need to explicitly create a `CDaoWorkspace` object. Usually, you use workspaces created implicitly when you open a [CDaoDatabase](../VS_csharp/cdaodatabase-class.md) object without specifying a workspace or when you open a [CDaoRecordset](../VS_csharp/cdaorecordset-class.md) object without specifying a database object. MFC DAO objects created in this way use DAO's default workspace, which is created once and reused.  
...
> [!CAUTION]
>  Closing a workspace object closes any open databases in the workspace. This results in any recordsets open in the databases being closed as well, and any pending edits or updates are rolled back. For related information, see the [CDaoDatabase::Close](../VS_csharp/cdaodatabase-class.md#cdaodatabase__close), [CDaoRecordset::Close](../VS_csharp/cdaorecordset-class.md#cdaorecordset__close), [CDaoTableDef::Close](../VS_csharp/cdaotabledef-class.md#cdaotabledef__close), and [CDaoQueryDef::Close](../VS_csharp/cdaoquerydef-class.md#cdaoquerydef__close) member functions.  
...
### Parameters  
 ...
 `dbinfo`  
 A reference to a [CDaoDatabaseInfo](../VS_csharp/cdaodatabaseinfo-structure.md) object that returns the information requested.  
...
### Return Value  
 A [CString](../VS_csharp/cstringt-class.md) containing the registry location.  
...
### Return Value  
 A [CString](../VS_csharp/cstringt-class.md) containing the user-defined name of the DAO workspace object.  
...
### Return Value  
 A [CString](../VS_csharp/cstringt-class.md) that represents the owner of the workspace object.  
...
### Remarks  
 ...
 For information about calling DAO directly, see [Technical Note 54](../VS_csharp/tn054--calling-dao-directly-while-using-mfc-dao-classes.md). For related information, see the topic "UserName Property" in DAO Help.  
...
### Return Value  
 A [CString](../VS_csharp/cstringt-class.md) that indicates the version of the database engine associated with the object.  
...
### Parameters  
 ...
 `wkspcinfo`  
 A reference to a [CDaoWorkspaceInfo](../VS_csharp/cdaoworkspaceinfo-structure.md) object that returns the information requested.  
...
### Remarks  
 ...
 For information about accessing DAO objects directly, see [Technical Note 54](../VS_csharp/tn054--calling-dao-directly-while-using-mfc-dao-classes.md).  
...
### Remarks  
 ...
 This member function attempts to repair a database that was marked as possibly corrupt by an incomplete write operation. This can occur if an application using the Microsoft Jet database engine is closed unexpectedly because of a power outage or computer hardware problem. If you complete the operation and call the [Close](../VS_csharp/cdaodatabase-class.md#cdaodatabase__close) member function or you quit the application in a usual way, the database will not be marked as possibly corrupt.  
