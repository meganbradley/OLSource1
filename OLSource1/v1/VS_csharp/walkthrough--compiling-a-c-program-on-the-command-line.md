...
Visual C++ includes a C compiler that you can use to create everything from basic console programs to full Windows Desktop applications, mobile apps, and more.  
 ...
 This walkthrough shows how to create a basic, "Hello, World"-style C program by using a text editor, and then compile it on the command line. If you'd rather work in C++ on the command line, see [Walkthrough: Compiling a Native C++ Program on the Command Line](../VS_csharp/walkthrough--compiling-a-native-c---program-on-the-command-line.md). If you'd like to try the Visual Studio IDE instead of using the command line, see [Walkthrough: Working with Projects and Solutions](../VS_csharp/walkthrough--working-with-projects-and-solutions--c---.md) or [Using the Visual Studio IDE for C++ Desktop Development](../VS_csharp/using-the-visual-studio-ide-for-c---desktop-development.md).  
...
## Next Steps  
 ...
 The compiler outputs a program called file1.exe. To change the name to program1.exe, add an [/out](../VS_csharp/-out--output-file-name-.md) linker option:  
...
## See Also  
 [Walkthrough: Creating a Win32 Console Program (C++)](../VS_csharp/walkthrough--creating-a-standard-c---program--c---.md)   
