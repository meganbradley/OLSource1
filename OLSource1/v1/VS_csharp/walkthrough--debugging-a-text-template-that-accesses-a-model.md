...
> [!NOTE]
>  For more information about text templates in general, see [Code Generation and Text Templates](../VS_csharp/code-generation-and-t4-text-templates.md). For more information about debugging text templates, see [Walkthrough: Debugging a Text Template](assetId:///5c3fd3b7-c110-4e86-a22f-d5756be6b94f).  
