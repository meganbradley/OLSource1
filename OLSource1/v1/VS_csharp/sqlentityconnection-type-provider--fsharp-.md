...
## Remarks  
 For a walkthrough that shows how to use this type provider, see [Walkthrough: Accessing Typed Data from the Entity Data Model (F#)](../VS_csharp/walkthrough--accessing-a-sql-database-by-using-type-providers-and-entities--fsharp-.md).  
...
## See Also  
 ...
 [How To: Access Typed Data From the Entity Data Model](../VS_csharp/walkthrough--accessing-a-sql-database-by-using-type-providers-and-entities--fsharp-.md)   
