...
## Remarks  
 `CStringT` inherits from                 [CSimpleStringT Class](../VS_csharp/csimplestringt-class.md). Advanced features, such as character manipulation, ordering, and searching, are implemented by                 `CStringT`.  
...
-   Custom memory management for string buffers. For more information, see                         [Memory Management and CStringT](../VS_csharp/memory-management-with-cstringt.md).  
  
## CStringT Predefined Types  
 Because                 `CStringT` uses a template argument to define the character type (either                 [wchar_t](../VS_csharp/standard-types.md) or                 [char](../VS_csharp/standard-types.md)) supported, method parameter types can be complicated at times. To simplify this issue, a set of predefined types is defined and used throughout the                 `CStringT` class. The following table lists the various types:  
...
## Inheritance Hierarchy  
 [CSimpleStringT](../VS_csharp/csimplestringt-class.md)  
...
### Remarks  
 In MFC programs, a                         [CMemoryException](../VS_csharp/cmemoryexception-class.md) is thrown if insufficient memory exists. In ATL programs, a                         [CAtlException](../VS_csharp/catlexception-class.md) is thrown. This function is normally used to return strings for Automation.  
  
 Commonly, if this string is passed to a COM function as an [in] parameter, then this requires the caller to free the string. This can be done by using                         [SysFreeString](assetId:///8f230ee3-5f6e-4cb9-a910-9c90b754dcd3), as described in the                         [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)]. For more information, see                         [Strings: Allocating and Releasing Memory for a BSTR](../VS_csharp/allocating-and-releasing-memory-for-a-bstr.md).  
  
 For more information about OLE allocation functions in Windows, see                         [SysAllocString](assetId:///9e0437a2-9b4a-4576-88b0-5cb9d08ca29b) in the                         [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
  
### Example  
 The following example demonstrates the use of                                 `CStringT::AllocSysString`.  
  
 [!code[NVC_ATLMFC_Utilities#105](../VS_csharp/codesnippet/CPP/cstringt-class_1.cpp)]  
...
### Example  
 [!code[NVC_ATLMFC_Utilities#106](../VS_csharp/codesnippet/CPP/cstringt-class_2.cpp)]  
...
### Example  
 [!code[NVC_ATLMFC_Utilities#107](../VS_csharp/codesnippet/CPP/cstringt-class_3.cpp)]  
...
### Remarks  
 The generic-text function                         `_tcscoll`, which is defined in TCHAR.H, maps to either                         `strcoll`,                         `wcscoll`, or                         `_mbscoll`, depending on the character set that is defined at compile time. Each function performs a case-sensitive comparison of the strings according to the code page currently in use. For more information, see                         [strcoll, wcscoll, _mbscoll](../VS_csharp/strcoll--wcscoll--_mbscoll--_strcoll_l--_wcscoll_l--_mbscoll_l.md).  
...
### Remarks  
 The generic-text function                         `_tcscoll`, which is defined in TCHAR.H, maps to either                         `stricoll`,                         `wcsicoll`, or                         `_mbsicoll`, depending on the character set that is defined at compile time. Each function performs a case-insensitive comparison of the strings, according to the code page currently in use. For more information, see                         [strcoll, wcscoll, _mbscoll](../VS_csharp/strcoll--wcscoll--_mbscoll--_strcoll_l--_wcscoll_l--_mbscoll_l.md).  
  
### Example  
 [!code[NVC_ATLMFC_Utilities#109](../VS_csharp/codesnippet/CPP/cstringt-class_4.cpp)]  
...
### Remarks  
 The generic-text function                         `_tcscmp`, which is defined in TCHAR.H, maps to either                         `strcmp`,                         `wcscmp`, or                         `_mbscmp`, depending on the character set that is defined at compile time. Each function performs a case-sensitive comparison of the strings and is not affected by locale. For more information, see                         [strcmp, wcscmp, _mbscmp](../VS_csharp/strcmp--wcscmp--_mbscmp.md).  
...
### Example  
 ...
 [!code[NVC_ATLMFC_Utilities#110](../VS_csharp/codesnippet/CPP/cstringt-class_5.cpp)]  
...
### Parameters  
 ...
 `pStringMgr`  
 A pointer to the memory manager for the                                 `CStringT` object. For more information on                                 `IAtlStringMgr` and memory management for                                 `CStringT`, see                                 [Memory Management and CStringT](../VS_csharp/memory-management-with-cstringt.md).  
...
### Example  
 [!code[NVC_ATLMFC_Utilities#112](../VS_csharp/codesnippet/CPP/cstringt-class_7.cpp)]  
...
### Example  
 [!code[NVC_ATLMFC_Utilities#113](../VS_csharp/codesnippet/CPP/cstringt-class_8.cpp)]  
...
### Example  
 [!code[NVC_ATLMFC_Utilities#114](../VS_csharp/codesnippet/CPP/cstringt-class_9.cpp)]  
...
### Example  
 [!code[NVC_ATLMFC_Utilities#115](../VS_csharp/codesnippet/CPP/cstringt-class_10.cpp)]  
  
##  <a name="cstringt__format"></a>  CStringT::Format  
 Writes formatted data to a                 `CStringT` in the same way that                 [sprintf_s](../VS_csharp/sprintf_s--_sprintf_s_l--swprintf_s--_swprintf_s_l.md) formats data into a C-style character array.  
...
### Remarks  
 ...
 [!code[NVC_ATLMFC_Utilities#116](../VS_csharp/codesnippet/CPP/cstringt-class_11.cpp)]  
  
 For more information, see                         [Format Specification Fields: printf and wprintf Functions](../VS_csharp/format-specification-syntax--printf-and-wprintf-functions.md).  
  
### Example  
 [!code[NVC_ATLMFC_Utilities#117](../VS_csharp/codesnippet/CPP/cstringt-class_12.cpp)]  
...
>  `FormatMessage` attempts to allocate system memory for the newly formatted string. If this attempt fails, a memory exception is automatically thrown.  
 ...
 Each insert must have a corresponding parameter following the                         `pszFormat` or                         `nFormatID` parameter. Within the message text, several escape sequences are supported for dynamically formatting the message. For more information, see the Windows                         [FormatMessage](http://msdn.microsoft.com/library/windows/desktop/ms679351) function in the                         [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
  
### Example  
 [!code[NVC_ATLMFC_Utilities#118](../VS_csharp/codesnippet/CPP/cstringt-class_13.cpp)]  
...
>  `FormatMessageV` calls                             [FormatMessage](#cstringt__formatmessage), which attempts to allocate system memory for the newly formatted string. If this attempt fails, a memory exception is automatically thrown.  
 ...
 For more information, see the Windows                         [FormatMessage](http://msdn.microsoft.com/library/windows/desktop/ms679351) function in the                         [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Example  
 [!code[NVC_ATLMFC_Utilities#119](../VS_csharp/codesnippet/CPP/cstringt-class_14.cpp)]  
  
 [!code[NVC_ATLMFC_Utilities#120](../VS_csharp/codesnippet/CPP/cstringt-class_15.cpp)]  
...
### Example  
 [!code[NVC_ATLMFC_Utilities#121](../VS_csharp/codesnippet/CPP/cstringt-class_16.cpp)]  
...
### Example  
 [!code[NVC_ATLMFC_Utilities#122](../VS_csharp/codesnippet/CPP/cstringt-class_17.cpp)]  
...
### Example  
 [!code[NVC_ATLMFC_Utilities#123](../VS_csharp/codesnippet/CPP/cstringt-class_18.cpp)]  
...
### Example  
 [!code[NVC_ATLMFC_Utilities#124](../VS_csharp/codesnippet/CPP/cstringt-class_19.cpp)]  
...
### Example  
 [!code[NVC_ATLMFC_Utilities#125](../VS_csharp/codesnippet/CPP/cstringt-class_20.cpp)]  
...
### Example  
 [!code[NVC_ATLMFC_Utilities#126](../VS_csharp/codesnippet/CPP/cstringt-class_21.cpp)]  
...
### Example  
 [!code[NVC_ATLMFC_Utilities#127](../VS_csharp/codesnippet/CPP/cstringt-class_22.cpp)]  
...
### Example  
 [!code[NVC_ATLMFC_Utilities#128](../VS_csharp/codesnippet/CPP/cstringt-class_23.cpp)]  
...
### Example  
 [!code[NVC_ATLMFC_Utilities#140](../VS_csharp/codesnippet/CPP/cstringt-class_24.cpp)]  
...
### Example  
 [!code[NVC_ATLMFC_Utilities#141](../VS_csharp/codesnippet/CPP/cstringt-class_25.cpp)]  
...
### Example  
 [!code[NVC_ATLMFC_Utilities#142](../VS_csharp/codesnippet/CPP/cstringt-class_26.cpp)]  
...
### Example  
 [!code[NVC_ATLMFC_Utilities#143](../VS_csharp/codesnippet/CPP/cstringt-class_27.cpp)]  
...
### Example  
 [!code[NVC_ATLMFC_Utilities#144](../VS_csharp/codesnippet/CPP/cstringt-class_28.cpp)]  
...
### Example  
 [!code[NVC_ATLMFC_Utilities#145](../VS_csharp/codesnippet/CPP/cstringt-class_29.cpp)]  
...
### Example  
 [!code[NVC_ATLMFC_Utilities#146](../VS_csharp/codesnippet/CPP/cstringt-class_30.cpp)]  
...
### Example  
 [!code[NVC_ATLMFC_Utilities#147](../VS_csharp/codesnippet/CPP/cstringt-class_31.cpp)]  
...
### Example  
 [!code[NVC_ATLMFC_Utilities#129](../VS_csharp/codesnippet/CPP/cstringt-class_32.cpp)]  
...
### Example  
 [!code[NVC_ATLMFC_Utilities#200](../VS_csharp/codesnippet/CPP/cstringt-class_33.cpp)]  
...
### Example  
 [!code[NVC_ATLMFC_Utilities#130](../VS_csharp/codesnippet/CPP/cstringt-class_34.cpp)]  
...
### Example  
 [!code[NVC_ATLMFC_Utilities#131](../VS_csharp/codesnippet/CPP/cstringt-class_35.cpp)]  
...
### Example  
 [!code[NVC_ATLMFC_Utilities#132](../VS_csharp/codesnippet/CPP/cstringt-class_36.cpp)]  
...
### Example  
 [!code[NVC_ATLMFC_Utilities#133](../VS_csharp/codesnippet/CPP/cstringt-class_37.cpp)]  
...
### Example  
 [!code[NVC_ATLMFC_Utilities#134](../VS_csharp/codesnippet/CPP/cstringt-class_38.cpp)]  
...
### Remarks  
 ...
 Unlike the CRT tokenize functions like                         [strtok_s](../VS_csharp/strtok_s--_strtok_s_l--wcstok_s--_wcstok_s_l--_mbstok_s--_mbstok_s_l.md),                         `Tokenize` does not modify the target string.  
  
### Example  
 [!code[NVC_ATLMFC_Utilities#135](../VS_csharp/codesnippet/CPP/cstringt-class_39.cpp)]  
...
### Example  
 [!code[NVC_ATLMFC_Utilities#136](../VS_csharp/codesnippet/CPP/cstringt-class_40.cpp)]  
...
### Example  
 [!code[NVC_ATLMFC_Utilities#137](../VS_csharp/codesnippet/CPP/cstringt-class_41.cpp)]  
...
### Example  
 [!code[NVC_ATLMFC_Utilities#138](../VS_csharp/codesnippet/CPP/cstringt-class_42.cpp)]  
