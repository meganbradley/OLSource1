...
## Windows Runtime  
 [!INCLUDE[cppwrt_short](../VS_csharp/includes/cppwrt_short_md.md)] supports a shorthand syntax for boxing value types and unboxing reference types. A value type is boxed when it is assigned to a variable of type `Object`. An `Object` variable is unboxed when it is assigned to a value type variable and the unboxed type is specified in parentheses; that is, when the object variable is cast to a value type.  
...
-   [How to: Explicitly Request Boxing](../VS_csharp/how-to--explicitly-request-boxing.md)  
  
-   [How to: Use gcnew to Create Value Types and Use Implicit Boxing](../VS_csharp/how-to--use-gcnew-to-create-value-types-and-use-implicit-boxing.md)  
  
-   [How to: Unboxing](../VS_csharp/how-to--unbox.md)  
  
-   [Standard Conversions and Implicit Boxing](../VS_csharp/standard-conversions-and-implicit-boxing.md)  
