...
##  <a name="_atl_using_.25.module.25"></a> Using %MODULE%  
 The [ATL Control Wizard](../VS_csharp/atl-control-wizard.md) automatically generates a script that uses `%MODULE%`. ATL uses this replaceable parameter for the actual location of your server's DLL or EXE.  
...
```  
 ...
 Then, before calling one of the script processing methods listed in [Invoking Scripts](../VS_csharp/invoking-scripts.md), add a replacement to the map:  
  
 [!code[NVC_ATL_Utilities#113](../VS_csharp/codesnippet/CPP/using-replaceable-parameters--the-registrar-s-preprocessor-_1.cpp)]  
