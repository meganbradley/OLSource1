...
#### Parameters  
 ...
 [!code[NVC_OLEDB_Consumer#9](../VS_csharp/codesnippet/CPP/cdynamicparameteraccessor--getparamstring_1.cpp)]  
...
## Remarks  
 ...
 Use `GetParamString` to retrieve string parameter data from the buffer. Use [GetParam](../VS_csharp/cdynamicparameteraccessor--getparam.md) to retrieve nonstring parameter data from the buffer.  
