...
### Remarks  
 ...
 [!code[NVC_ATL_Windowing#42](../VS_csharp/codesnippet/CPP/caxwindow-class_1.cpp)]  
...
### Example  
 See [Hosting ActiveX Controls Using ATL AXHost](../VS_csharp/hosting-activex-controls-using-atl-axhost.md) for a sample that uses `CreateControl`.  
...
### Example  
 See [Hosting ActiveX Controls Using ATL AXHost](../VS_csharp/hosting-activex-controls-using-atl-axhost.md) for a sample that uses `CreateControlEx`.  
...
##  <a name="caxwindow__setexternaluihandler"></a>  CAxWindow::SetExternalUIHandler  
 Sets the external [IDocHostUIHandlerDispatch](../VS_csharp/idochostuihandlerdispatch-interface.md) interface for the `CAxWindow` object.  
...
## See Also  
 [ATLCON Sample](../VS_csharp/visual-c---samples.md)   
