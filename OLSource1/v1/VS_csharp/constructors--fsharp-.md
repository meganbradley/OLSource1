...
## Construction of Class Objects  
 ...
 The primary constructor contains `let` and `do` bindings that appear at the start of the class definition. A `let` binding declares private fields and methods of the class; a `do` binding executes code. For more information about `let` bindings in class constructors, see [Let Bindings in Classes](../VS_csharp/let-bindings-in-classes--fsharp-.md). For more information about `do` bindings in constructors, see [Do Bindings in Classes](../VS_csharp/do-bindings-in-classes--fsharp-.md).  
 ...
 [!code[FsLangRef2#3501](../VS_csharp/codesnippet/FSharp/constructors--fsharp-_1.fs)]  
...
## Construction of Structures  
 ...
 [!code[FsLangRef2#3502](../VS_csharp/codesnippet/FSharp/constructors--fsharp-_2.fs)]  
  
 For more information, see [Fields: the val Keyword](../VS_csharp/explicit-fields--the-val-keyword--fsharp-.md).  
...
## Executing Side Effects in Constructors  
 ...
 [!code[FsLangRef2#3503](../VS_csharp/codesnippet/FSharp/constructors--fsharp-_3.fs)]  
...
## Self Identifiers in Constructors  
 ...
 [!code[FsLangRef2#3504](../VS_csharp/codesnippet/FSharp/constructors--fsharp-_4.fs)]  
 ...
 [!code[FsLangRef2#3505](../VS_csharp/codesnippet/FSharp/constructors--fsharp-_5.fs)]  
...
## Assigning Values to Properties at Initialization  
 ...
 [!code[FsLangRef2#3506](../VS_csharp/codesnippet/FSharp/constructors--fsharp-_6.fs)]  
 ...
 [!code[FsLangRef2#3507](../VS_csharp/codesnippet/FSharp/constructors--fsharp-_7.fs)]  
  
## Static Constructors or Type Constructors  
 In addition to specifying code for creating objects, static `let` and `do` bindings can be authored in class types that execute before the type is first used to perform initialization at the type level. For more information, see [Let Bindings in Classes](../VS_csharp/let-bindings-in-classes--fsharp-.md) and [Do Bindings in Classes](../VS_csharp/do-bindings-in-classes--fsharp-.md).  
