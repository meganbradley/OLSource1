...
|Element|Description|  
|-------------|-----------------|  
|[Group Element](../VS_csharp/group-element.md)|Represents a single command group.|  
|[Groups Element](../VS_csharp/groups-element.md)|Contains entries that define the command groups of a VSPackage.|  
