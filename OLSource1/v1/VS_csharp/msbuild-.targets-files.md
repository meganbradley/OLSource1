...
> [!NOTE]
>  For information about how to create your own targets, see [MSBuild Targets](../VS_csharp/msbuild-targets.md). For information about how to use the `Import` element to insert a project file into another project file, see [Import Element (MSBuild)](../VS_csharp/import-element--msbuild-.md) and [How to: Use the Same Target in Multiple Project Files](../VS_csharp/how-to--use-the-same-target-in-multiple-project-files.md).  
  
## Common .Targets Files  
  
|.Targets file|Description|  
|-------------------|-----------------|  
|Microsoft.Common.targets|Defines the steps in the standard build process for [!INCLUDE[vbprvb](../VS_csharp/includes/vbprvb_md.md)] and [!INCLUDE[csprcs](../VS_csharp/includes/csprcs_md.md)] projects.<br /><br /> Imported by the Microsoft.CSharp.targets and Microsoft.VisualBasic.targets files, which include the following statement: `<Import Project="Microsoft.Common.targets" />`|  
...
## See Also  
 [Import Element (MSBuild)](../VS_csharp/import-element--msbuild-.md)   
