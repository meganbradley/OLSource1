...
Output error processing functions, discussed in [Error Processing Functions](../VS_csharp/output-file-stream-member-functions.md), apply to input streams. Testing for errors during extraction is important. Consider this statement:  
