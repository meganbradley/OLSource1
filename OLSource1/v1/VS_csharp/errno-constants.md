...
## Remarks  
 The **errno** values are constants assigned to [errno](../VS_csharp/errno--_doserrno--_sys_errlist--and-_sys_nerr.md) in the event of various error conditions.  
 ...
 The **errno** values in a 32-bit Windows operating system are a subset of the values for **errno** in XENIX systems. Thus, the **errno** value is not necessarily the same as the actual error code returned by a system call from the Windows operating systems. To access the actual operating system error code, use the [_doserrno](../VS_csharp/errno--_doserrno--_sys_errlist--and-_sys_nerr.md) variable, which contains this value.  
 ...
 **STRUNCATE**  
 A string copy or concatenation resulted in a truncated string. See [_TRUNCATE](../VS_csharp/_truncate.md).  
