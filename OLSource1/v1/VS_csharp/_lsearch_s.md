...
---
# _lsearch_s
Performs a linear search for a value. A version of [_lsearch](../VS_csharp/_lsearch.md) with security enhancements as described in [Security Enhancements in the CRT](../VS_csharp/security-features-in-the-crt.md).  
...
## See Also  
 ...
 [_lfind_s](../VS_csharp/_lfind_s.md)   
