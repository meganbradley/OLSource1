...
Converts a time value to a structure. These are versions of [_gmtime32, _gmtime64](../VS_csharp/gmtime--_gmtime32--_gmtime64.md) with security enhancements as described in [Security Enhancements in the CRT](../VS_csharp/security-features-in-the-crt.md).  
...
## Return Value  
 Zero if successful. The return value is an error code if there is a failure. Error codes are defined in Errno.h; for a listing of these errors, see [errno](../VS_csharp/errno-constants.md).  
...
## See Also  
 ...
 [mktime, _mktime32, _mktime64](../VS_csharp/mktime--_mktime32--_mktime64.md)   
