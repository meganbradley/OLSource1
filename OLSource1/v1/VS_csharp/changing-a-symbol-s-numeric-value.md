...
For symbols associated with a single resource, you can use the [Properties Window](../VS_csharp/properties-window.md) to change the symbol value. You can use the [Resource Symbols dialog box](../VS_csharp/resource-symbols-dialog-box.md) to change the value of symbols not currently assigned to a resource. For more information, see [Changing Unassigned Symbols](../VS_csharp/changing-unassigned-symbols.md).  
