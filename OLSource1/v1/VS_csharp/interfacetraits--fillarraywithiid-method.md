...
## Remarks  
 ...
 For more information about `Base`, see the Public Typedefs section in [InterfaceTraits Structure](../VS_csharp/interfacetraits-structure.md).  
...
## See Also  
 [InterfaceTraits Structure](../VS_csharp/interfacetraits-structure.md)   
