...
### Example  
  See [set_terminate](../VS_csharp/-exception--functions.md#set_terminate) for an example of the use of `terminate_handler`.  
...
### Example  
  See [set_unexpected](../VS_csharp/-exception--functions.md#set_unexpected) for an example of the use of `unexpected_handler`.  
