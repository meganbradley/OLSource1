...
## Members  
 `bpType`  
 A value from the [BP_TYPE](../VS_csharp/bp_type.md) enumeration that specifies how to interpret the `bpResLocation` union or `unionmemberX` members.  
  
 `bpResLocation.bpresCode`  
 [C++ only] Contains the [BP_RESOLUTION_CODE](../VS_csharp/bp_resolution_code.md) structure if `bpType` = `BPT_CODE`.  
  
 `bpResLocation.bpresData`  
 [C++ only] Contains the [BP_RESOLUTION_DATA](../VS_csharp/bp_resolution_data.md) structure if `bpType` = `BPT_DATA`.  
...
## Remarks  
 This structure is a member of the [BP_ERROR_RESOLUTION_INFO](../VS_csharp/bp_error_resolution_info.md) and [BP_RESOLUTION_INFO](../VS_csharp/bp_resolution_info.md) structures.  
...
|----------------------|--------------------|--------------------|--------------------|--------------------|  
|`BPT_CODE`|[IDebugCodeContext2](../VS_csharp/idebugcodecontext2.md)|-|-|-|  
