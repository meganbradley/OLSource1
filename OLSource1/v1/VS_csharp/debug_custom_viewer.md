...
## Remarks  
 A list of this structure is returned by a call to the [IDebugProperty3::GetCustomViewerList](../VS_csharp/idebugproperty3--getcustomviewerlist.md) method (and, by extension, the [IEEVisualizerService::GetCustomViewerList](../VS_csharp/ieevisualizerservice--getcustomviewerlist.md) method).  
