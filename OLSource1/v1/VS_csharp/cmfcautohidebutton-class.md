...
---
# CMFCAutoHideButton Class
A button that displays or hides a [CDockablePane Class](../VS_csharp/cdockablepane-class.md) that is configured to hide.  
...
|[CMFCAutoHideButton::GetAutoHideWindow](#cmfcautohidebutton__getautohidewindow)|Returns the [CDockablePane](../VS_csharp/cdockablepane-class.md) object associated with the auto-hide button.|  
...
|[CMFCAutoHideButton::ShowAttachedWindow](#cmfcautohidebutton__showattachedwindow)|Shows or hides the associated [CDockablePane Class](../VS_csharp/cdockablepane-class.md).|  
...
## Remarks  
 On creation, the `CMFCAutoHideButton` object is attached to a [CDockablePane Class](../VS_csharp/cdockablepane-class.md). The `CDockablePane` object is hidden or displayed as the user interacts with the `CMFCAutoHideButton` object.  
...
## Example  
 ...
 [!code[NVC_MFC_RibbonApp#32](../VS_csharp/codesnippet/CPP/cmfcautohidebutton-class_1.cpp)]  
  
## Inheritance Hierarchy  
 [CObject](../VS_csharp/cobject-class.md)  
  
 [CMFCAutoHideButton](../VS_csharp/cmfcautohidebutton-class.md)  
...
### Parameters  
 ...
 [in] `pAutoHideWnd`  
 A pointer to a [CDockablePane](../VS_csharp/cdockablepane-class.md) object. This auto-hide button hides and shows that `CDockablePane`.  
...
### Remarks  
 When you create a [CMFCAutoHideButton](../VS_csharp/cmfcautohidebutton-class.md) object, you must associate the auto-hide button with a specific `CDockablePane`. The user can use the auto-hide button to hide and show the associated `CDockablePane`.  
...
##  <a name="cmfcautohidebutton__getautohidewindow"></a>  CMFCAutoHideButton::GetAutoHideWindow  
 Returns the [CDockablePane](../VS_csharp/cdockablepane-class.md) object associated with the auto-hide button.  
...
### Return Value  
 A [CSize](../VS_csharp/csize-class.md) object that contains the size of the text for the auto-hide button.  
...
### Remarks  
 An auto-hide button is active when the associated [CDockablePane Class](../VS_csharp/cdockablepane-class.md) window is shown.  
...
### Remarks  
 The framework sets the orientation of a [CMFCAutoHideButton](../VS_csharp/cmfcautohidebutton-class.md) object when you create it.  You can control the orientation by using the `dwAlignment` parameter in the [CMFCAutoHideButton::Create](#cmfcautohidebutton__create) method.  
...
### Remarks  
 If you want to customize the appearance of auto-hide buttons in your application, create a new class derived from the [CMFCAutoHideButton Class](../VS_csharp/cmfcautohidebutton-class.md). In your derived class, override this method.  
...
### Remarks  
 If you want to customize the border of each auto-hide button in your application, create a new class derived from the [CMFCAutoHideButton Class](../VS_csharp/cmfcautohidebutton-class.md). In your derived class, override this method.  
...
### Remarks  
 If you want to customize the background for auto-hide buttons in your application, create a new class derived from the [CMFCAutoHideButton Class](../VS_csharp/cmfcautohidebutton-class.md). In your derived class, override this method.  
  
##  <a name="cmfcautohidebutton__showattachedwindow"></a>  CMFCAutoHideButton::ShowAttachedWindow  
 Shows or hides the associated [CDockablePane Class](../VS_csharp/cdockablepane-class.md).  
...
## See Also  
 ...
 [CMFCAutoHideBar Class](../VS_csharp/cmfcautohidebar-class.md)   
 [CAutoHideDockSite Class](../VS_csharp/cautohidedocksite-class.md)