...
The *handle declarator* (`^`, pronounced "hat"), modifies the type [specifier](../VS_csharp/overview-of-declarators.md) to mean that the declared object should be automatically deleted when the system determines that the object is no longer accessible.  
...
## [!INCLUDE[wrt](../VS_csharp/includes/wrt_md.md)]  
 ...
 For information on how to instantiate an object, see [ref new](../VS_csharp/ref-new--gcnew---c---component-extensions-.md).  
...
## See Also  
 ...
 [% (Tracking Reference)](../VS_csharp/tracking-reference-operator--c---component-extensions-.md)