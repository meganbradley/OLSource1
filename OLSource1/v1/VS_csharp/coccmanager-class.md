...
### Remarks  
 For more information on creating custom sites, see [COleControlContainer::AttachControlSite](../VS_csharp/colecontrolcontainer-class.md#colecontrolcontainer__attachcontrolsite).  
...
### Remarks  
 Override this function to create a custom control site, using your [COleControlSite](../VS_csharp/colecontrolsite-class.md)-derived class.  
...
> [!NOTE]
>  The control must have the **OLEMISC_ACTSLIKEBUTTON** status bit set. For more information on **OLEMISC** flags, see the                             [OLEMISC](http://msdn.microsoft.com/library/windows/desktop/ms678497) topic in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
## See Also  
 ...
 [COleControlSite](../VS_csharp/colecontrolsite-class.md)   
