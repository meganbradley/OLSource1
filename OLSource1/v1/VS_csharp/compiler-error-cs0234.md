...
-   An assembly that contains the definition of a type was not referenced in the compilation; use [/reference (Import Metadata)](../VS_csharp/-reference--csharp-compiler-options-.md) to specify the assembly  
  
-   You passed a variable name to the [typeof](../VS_csharp/typeof--csharp-reference-.md) operator.  
  
-   You tried to reference an assembly that is not part of your target .NET Framework profile. For more information, see [Troubleshooting .NET Framework Targeting Errors](../VS_csharp/troubleshooting-.net-framework-targeting-errors.md).  
