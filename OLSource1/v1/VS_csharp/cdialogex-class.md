...
## Remarks  
 ...
 A `CDialogEx` object can be a parent of a [CMFCPopupMenu](../VS_csharp/cmfcpopupmenu-class.md) object. The [CMFCPopupMenu](../VS_csharp/cmfcpopupmenu-class.md) object calls the `CDialogEx::SetActiveMenu` method when the [CMFCPopupMenu](../VS_csharp/cmfcpopupmenu-class.md) object opens. Afterward, the `CDialogEx` object handles any menu event until the [CMFCPopupMenu](../VS_csharp/cmfcpopupmenu-class.md) object is closed.  
...
## See Also  
 ...
 [CMFCContextMenuManager](../VS_csharp/ccontextmenumanager-class.md)