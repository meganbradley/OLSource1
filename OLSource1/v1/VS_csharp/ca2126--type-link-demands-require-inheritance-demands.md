...
## Example  
 ...
 [!code[FxCop.Security.TypesWithLinkDemands#1](../VS_csharp/codesnippet/CPP/ca2126--type-link-demands-require-inheritance-demands_1.cpp)]
[!code[FxCop.Security.TypesWithLinkDemands#1](../VS_csharp/codesnippet/VisualBasic/ca2126--type-link-demands-require-inheritance-demands_1.vb)]
[!code[FxCop.Security.TypesWithLinkDemands#1](../VS_csharp/codesnippet/CSharp/ca2126--type-link-demands-require-inheritance-demands_1.cs)]  
  
## Related Rules  
 [Review declarative security on value types](../VS_csharp/ca2108--review-declarative-security-on-value-types.md)  
  
 [Secured types should not expose fields](../VS_csharp/ca2112--secured-types-should-not-expose-fields.md)  
  
 [Do not indirectly expose methods with link demands](../VS_csharp/ca2122--do-not-indirectly-expose-methods-with-link-demands.md)  
  
 [Override link demands should be identical to base](../VS_csharp/ca2123--override-link-demands-should-be-identical-to-base.md)  
