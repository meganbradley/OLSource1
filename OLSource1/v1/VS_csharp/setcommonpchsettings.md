...
-   **pchUseUsingSpecific** Uses the [/Yu (Use Precompiled Header File)](../VS_csharp/-yu--use-precompiled-header-file-.md) compiler setting.  
  
-   **pchCreateUsingSpecific** Uses the [/Yc (Create Precompiled Header File)](../VS_csharp/-yc--create-precompiled-header-file-.md) compiler setting.  
...
## See Also  
 ...
 [SetNoPchSettings](../VS_csharp/setnopchsettings.md)   
