...
## Remarks  
 Contains a value that identifies a registered [!INCLUDE[wrt](../VS_csharp/includes/wrt_md.md)] or COM class object, and is later used to unregister the object.  
...
## See Also  
 [FactoryCache Structure](../VS_csharp/factorycache-structure.md)   
