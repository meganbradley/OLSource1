...
-   **ON_EN_VSCROLL** The user clicks an edit control's vertical scroll bar. The parent window is notified before the screen is updated.  
 ...
 To modify certain styles in an edit control (such as **ES_READONLY**) you must send specific messages to the control instead of using [ModifyStyle](../VS_csharp/cwnd-class.md#cwnd__modifystyle). See                 [Edit Control Styles](http://msdn.microsoft.com/library/windows/desktop/bb775464) in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Example  
 [!code[NVC_MFC_CEdit#1](../VS_csharp/codesnippet/CPP/cedit-class_1.cpp)]  
...
### Example  
 [!code[NVC_MFC_CEdit#3](../VS_csharp/codesnippet/CPP/cedit-class_2.cpp)]  
...
### Example  
 [!code[NVC_MFC_CEdit#4](../VS_csharp/codesnippet/CPP/cedit-class_3.cpp)]  
...
### Example  
 [!code[NVC_MFC_CEdit#5](../VS_csharp/codesnippet/CPP/cedit-class_4.cpp)]  
...
### Parameters  
 `dwStyle`  
 Specifies the edit control's style. Apply any combination of [edit styles](../VS_csharp/edit-styles.md) to the control.  
...
### Remarks  
 ...
 Apply the following [window styles](../VS_csharp/window-styles.md) to an edit control.  
...
### Example  
 [!code[NVC_MFC_CEdit#2](../VS_csharp/codesnippet/CPP/cedit-class_5.cpp)]  
...
### Example  
 [!code[NVC_MFC_CEdit#6](../VS_csharp/codesnippet/CPP/cedit-class_6.cpp)]  
...
### Remarks  
 ...
 The undo flag is automatically cleared whenever the [SetWindowText](../VS_csharp/cwnd-class.md#cwnd__setwindowtext) or [SetHandle](#cedit__sethandle)`CWnd` member functions are called.  
...
### Example  
 [!code[NVC_MFC_CEdit#7](../VS_csharp/codesnippet/CPP/cedit-class_7.cpp)]  
...
### Remarks  
 ...
 For more information, see                         [EM_FMTLINES](http://msdn.microsoft.com/library/windows/desktop/bb761570) in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
  
### Example  
 [!code[NVC_MFC_CEdit#8](../VS_csharp/codesnippet/CPP/cedit-class_8.cpp)]  
...
### Return Value  
 ...
 For the second overload, a [CString](../VS_csharp/using-cstring.md) that contains the cue text if the method is successful; otherwise, the empty string ("").  
  
### Remarks  
 This method sends the                         [EM_GETCUEBANNER](http://msdn.microsoft.com/library/windows/desktop/bb761572) message, which is described in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)]. For more information, see the                         [Edit_GetCueBannerText](http://msdn.microsoft.com/library/windows/desktop/bb761695) macro.  
...
### Example  
 [!code[NVC_MFC_CEdit#9](../VS_csharp/codesnippet/CPP/cedit-class_9.cpp)]  
...
>  **GetHandle** will not work with Windows 95/98. If you call **GetHandle** in Windows 95/98, it will return **NULL**. **GetHandle** will work as documented under Windows NT, versions 3.51 and later.  
 ...
 For more information, see                         [EM_GETHANDLE](http://msdn.microsoft.com/library/windows/desktop/bb761576) in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
  
### Example  
 [!code[NVC_MFC_CEdit#10](../VS_csharp/codesnippet/CPP/cedit-class_10.cpp)]  
...
### Remarks  
 This method sends the                         [EM_GETHILITE](http://msdn.microsoft.com/library/windows/desktop/bb761578) message, which is described in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
>  This member function is available beginning with Windows 95 and Windows NT 4.0.  
 ...
 For more information, see                         [EM_GETLIMITTEXT](http://msdn.microsoft.com/library/windows/desktop/bb761582) in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
  
### Example  
 [!code[NVC_MFC_CEdit#11](../VS_csharp/codesnippet/CPP/cedit-class_11.cpp)]  
...
### Example  
 [!code[NVC_MFC_CEdit#12](../VS_csharp/codesnippet/CPP/cedit-class_12.cpp)]  
...
>  This member function is available beginning with Windows 95 and Windows NT 4.0.  
 ...
 For more information, see                         [EM_GETMARGINS](http://msdn.microsoft.com/library/windows/desktop/bb761590) in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
  
### Example  
  See the example for [CEditView::GetEditCtrl](../VS_csharp/ceditview-class.md#ceditview__geteditctrl).  
...
### Example  
 [!code[NVC_MFC_CEdit#13](../VS_csharp/codesnippet/CPP/cedit-class_13.cpp)]  
...
### Remarks  
 ...
 This method sends the                         [EM_GETPASSWORDCHAR](http://msdn.microsoft.com/library/windows/desktop/bb761594) message, which is described in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
  
### Example  
 [!code[NVC_MFC_CEdit#14](../VS_csharp/codesnippet/CPP/cedit-class_14.cpp)]  
...
### Remarks  
 For more information, see                         [EM_GETSEL](http://msdn.microsoft.com/library/windows/desktop/bb761598) in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
  
### Example  
 [!code[NVC_MFC_CEdit#15](../VS_csharp/codesnippet/CPP/cedit-class_15.cpp)]  
...
### Remarks  
 This function sends the                         [EM_HIDEBALLOONTIP](http://msdn.microsoft.com/library/windows/desktop/bb761604) message, which is described in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
>  In Win32 (Windows NT and Windows 95/98), [SetLimitText](#cedit__setlimittext) replaces this function.  
 ...
 For more information, see                         [EM_LIMITTEXT](http://msdn.microsoft.com/library/windows/desktop/bb761607) in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
  
### Example  
 [!code[NVC_MFC_CEdit#17](../VS_csharp/codesnippet/CPP/cedit-class_16.cpp)]  
...
### Remarks  
 ...
 For more information, see                         [EM_LINEFROMCHAR](http://msdn.microsoft.com/library/windows/desktop/bb761609) in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
  
### Example  
 [!code[NVC_MFC_CEdit#18](../VS_csharp/codesnippet/CPP/cedit-class_17.cpp)]  
...
### Example  
 [!code[NVC_MFC_CEdit#19](../VS_csharp/codesnippet/CPP/cedit-class_18.cpp)]  
...
### Remarks  
 This method is supported by the                         [EM_LINELENGTH](http://msdn.microsoft.com/library/windows/desktop/bb761613) message, which is described in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Example  
 [!code[NVC_MFC_CEdit#20](../VS_csharp/codesnippet/CPP/cedit-class_19.cpp)]  
...
### Remarks  
 Replaces only a portion of the text in an edit control. If you want to replace all of the text, use the [CWnd::SetWindowText](../VS_csharp/cwnd-class.md#cwnd__setwindowtext) member function.  
...
### Remarks  
 This method sends the                         [EM_SETCUEBANNER](http://msdn.microsoft.com/library/windows/desktop/bb761639) message, which is described in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)]. For more information, see the                         [Edit_SetCueBannerTextFocused](http://msdn.microsoft.com/library/windows/desktop/bb761703) macro.  
  
### Example  
 The following example demonstrates the [CEdit::SetCueBanner](#cedit__setcuebanner) method.  
  
 [!code[NVC_MFC_CEdit_s1#2](../VS_csharp/codesnippet/CPP/cedit-class_20.cpp)]  
...
>  **GetHandle** will not work with Windows 95/98. If you call **GetHandle** in Windows 95/98, it will return **NULL**. **GetHandle** will work as documented under Windows NT, versions 3.51 and later.  
 ...
 For more information, see                         [EM_SETHANDLE](http://msdn.microsoft.com/library/windows/desktop/bb761641),                         [LocalAlloc](http://msdn.microsoft.com/library/windows/desktop/aa366723), and                         [LocalFree](http://msdn.microsoft.com/library/windows/desktop/aa366730) in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
  
### Example  
 [!code[NVC_MFC_CEdit#22](../VS_csharp/codesnippet/CPP/cedit-class_21.cpp)]  
...
### Remarks  
 This method sends the                         [EM_SETHILITE](http://msdn.microsoft.com/library/windows/desktop/bb761643) message, which is described in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Remarks  
 ...
 For more information, see                         [EM_SETLIMITTEXT](http://msdn.microsoft.com/library/windows/desktop/bb761647) in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
>  This member function is available beginning with Windows 95 and Windows NT 4.0.  
 ...
 For more information, see                         [EM_SETMARGINS](http://msdn.microsoft.com/library/windows/desktop/bb761649) in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Remarks  
 ...
 If the edit control is created with the [ES_PASSWORD](../VS_csharp/edit-styles.md) style, the default password character is set to an asterisk ( **\***). This style is removed if `SetPasswordChar` is called with                         *ch* set to 0.  
  
 For more information, see                         [EM_SETPASSWORDCHAR](http://msdn.microsoft.com/library/windows/desktop/bb761653) in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
  
### Example  
 [!code[NVC_MFC_CEdit#16](../VS_csharp/codesnippet/CPP/cedit-class_22.cpp)]  
...
### Remarks  
 The current setting can be found by testing the [ES_READONLY](../VS_csharp/edit-styles.md) flag in the return value of [CWnd::GetStyle](../VS_csharp/cwnd-class.md#cwnd__getstyle).  
...
### Example  
 [!code[NVC_MFC_CEdit#23](../VS_csharp/codesnippet/CPP/cedit-class_23.cpp)]  
...
### Example  
 [!code[NVC_MFC_CEdit#24](../VS_csharp/codesnippet/CPP/cedit-class_24.cpp)]  
...
### Remarks  
 ...
 For more information, see                         [EM_SETRECTNP](http://msdn.microsoft.com/library/windows/desktop/bb761659) in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Remarks  
 For more information, see                         [EM_SETSEL](http://msdn.microsoft.com/library/windows/desktop/bb761661) in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Remarks  
 ...
 `SetTabStops` does not automatically redraw the edit window. If you change the tab stops for text already in the edit control, call [CWnd::InvalidateRect](../VS_csharp/cwnd-class.md#cwnd__invalidaterect) to redraw the edit window.  
  
 For more information, see                         [EM_SETTABSTOPS](http://msdn.microsoft.com/library/windows/desktop/bb761663) and                         [GetDialogBaseUnits](http://msdn.microsoft.com/library/windows/desktop/ms645475) in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
  
### Example  
  See the example for [CEditView::SetTabStops](../VS_csharp/ceditview-class.md#ceditview__settabstops).  
...
### Remarks  
 This function sends the                         [EM_SHOWBALLOONTIP](http://msdn.microsoft.com/library/windows/desktop/bb761668) message, which is described in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)]. For more information, see the                         [Edit_ShowBalloonTip](http://msdn.microsoft.com/library/windows/desktop/bb761707) macro.  
...
### Example  
 ...
 [!code[NVC_MFC_CEdit_s1#1](../VS_csharp/codesnippet/CPP/cedit-class_25.h)]  
...
### Example  
 ...
 [!code[NVC_MFC_CEdit_s1#3](../VS_csharp/codesnippet/CPP/cedit-class_26.cpp)]  
...
### Example  
 [!code[NVC_MFC_CEdit#25](../VS_csharp/codesnippet/CPP/cedit-class_27.cpp)]  
  
## See Also  
 [MFC Sample CALCDRIV](../VS_csharp/visual-c---samples.md)   
 [MFC Sample CMNCTRL2](../VS_csharp/visual-c---samples.md)   
