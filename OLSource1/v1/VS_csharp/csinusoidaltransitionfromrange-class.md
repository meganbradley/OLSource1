...
|Name|Description|  
|----------|-----------------|  
|[CSinusoidalTransitionFromRange::Create](#csinusoidaltransitionfromrange__create)|Calls the transition library to create encapsulated transition COM object. (Overrides [CBaseTransition::Create](../VS_csharp/cbasetransition-class.md#cbasetransition__create).)|  
...
## Inheritance Hierarchy  
 ...
 [CSinusoidalTransitionFromRange](../VS_csharp/csinusoidaltransitionfromrange-class.md)  
