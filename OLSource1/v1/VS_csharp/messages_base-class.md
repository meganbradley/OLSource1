...
## Remarks  
 The type catalog is a synonym for type `int` that describes the possible return values from messages:: [do_open](../VS_csharp/messages-class.md#messages__do_open).  
