...
## Remarks  
 ...
 File translation mode specifies either `binary` or `text` translation for [_open](../VS_csharp/_open--_wopen.md) and [_pipe](../VS_csharp/_pipe.md) I/O operations. For more information, see [_fmode](../VS_csharp/_fmode.md).  
