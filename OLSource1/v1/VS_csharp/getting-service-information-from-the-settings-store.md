...
1.  Create a VSIX project named FindServicesExtension and then add a custom command named FindServicesCommand. For more information about how to create a custom command, see [Creating an Extension with a Menu Command](../VS_csharp/creating-an-extension-with-a-menu-command.md)  
