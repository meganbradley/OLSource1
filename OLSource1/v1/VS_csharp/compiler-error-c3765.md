...
'event': cannot define an event in a class/struct 'type' marked as an event_receiver  
 ...
 If a class is marked with the [event_receiver](../VS_csharp/event_receiver.md) attribute, the class cannot contain an [__event](../VS_csharp/__event.md) declaration.  
