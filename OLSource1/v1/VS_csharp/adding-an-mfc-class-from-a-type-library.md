...
Use this wizard to create an MFC class from an interface in an available type library. You can add an MFC class to an [MFC application](../VS_csharp/creating-an-mfc-application.md), an [MFC DLL](../VS_csharp/creating-an-mfc-dll-project.md), or an [MFC ActiveX control](../VS_csharp/creating-an-mfc-activex-control.md).  
...
3.  In the [Add Class](../VS_csharp/add-class-dialog-box.md) dialog box, in the Templates pane, click **MFC Class from Typelib**, and then click **Open** to display the [Add Class from Typelib Wizard](../VS_csharp/add-class-from-typelib-wizard.md).  
 ...
 The wizard creates an MFC class, derived from [COleDispatchDriver](../VS_csharp/coledispatchdriver-class.md), for each interface you add from the selected type library. `COleDispatchDriver` implements the client side of OLE automation.  
  
## See Also  
 [Automation Clients](../VS_csharp/automation-clients.md)   
 [Automation Clients: Using Type Libraries](../VS_csharp/automation-clients--using-type-libraries.md)