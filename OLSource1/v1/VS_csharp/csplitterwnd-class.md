...
## Remarks  
 A pane is usually an application-specific object derived from [CView](../VS_csharp/cview-class.md), but it can be any [CWnd](../VS_csharp/cwnd-class.md) object that has the appropriate child window ID.  
  
 A `CSplitterWnd` object is usually embedded in a parent [CFrameWnd](../VS_csharp/cframewnd-class.md) or [CMDIChildWnd](../VS_csharp/cmdichildwnd-class.md) object. Create a `CSplitterWnd` object using the following steps:  
  
1.  Embed a `CSplitterWnd` member variable in the parent frame.  
  
2.  Override the parent frame's [CFrameWnd::OnCreateClient](../VS_csharp/cframewnd-class.md#cframewnd__oncreateclient) member function.  
...
-   [Technical Note 29](../VS_csharp/tn029--splitter-windows.md)  
...
-   MFC sample [Scribble](../VS_csharp/visual-c---samples.md)  
  
-   MFC sample [VIEWEX](../VS_csharp/visual-c---samples.md).  
...
### Remarks  
 This member function is a high level command that is used by the [CView](../VS_csharp/cview-class.md) class to delegate to the `CSplitterWnd` implementation.  
 ...
 *nMaxCols*  
 ...
 `pContext`  
 A pointer to a [CCreateContext](../VS_csharp/ccreatecontext-structure.md) structure. In most cases, this can be the `pContext` passed to the parent frame window.  
...
### Remarks  
 You can embed a `CSplitterWnd` in a parent [CFrameWnd](../VS_csharp/cframewnd-class.md) or [CMDIChildWnd](../VS_csharp/cmdichildwnd-class.md) object by taking the following steps:  
...
3.  Call the **Create** member function from within the overridden `OnCreateClient`.  
 ...
 For more on dynamic splitter windows, see "Splitter Windows" in the article [Multiple Document Types, Views, and Frame Windows](../VS_csharp/multiple-document-types--views--and-frame-windows.md), [Technical Note 29](../VS_csharp/tn029--splitter-windows.md), and the [CSplitterWnd](../VS_csharp/csplitterwnd-class.md) class overview.  
  
### Example  
 [!code[NVC_MFCWindowing#125](../VS_csharp/codesnippet/CPP/csplitterwnd-class_1.cpp)]  
...
### Remarks  
 A `CSplitterWnd` is usually embedded in a parent `CFrameWnd` or [CMDIChildWnd](../VS_csharp/cmdichildwnd-class.md) object by taking the following steps:  
  
1.  Embed a `CSplitterWnd` member variable in the parent frame.  
  
2.  Override the parent frame's `OnCreateClient` member function.  
  
3.  Call the `CreateStatic` member function from within the overridden [CFrameWnd::OnCreateClient](../VS_csharp/cframewnd-class.md#cframewnd__oncreateclient).  
 ...
 See "Splitter Windows" in the article [Multiple Document Types, Views, and Frame Windows](../VS_csharp/multiple-document-types--views--and-frame-windows.md), [Technical Note 29](../VS_csharp/tn029--splitter-windows.md), and the [CSplitterWnd](../VS_csharp/csplitterwnd-class.md) class overview for more on static splitter windows.  
...
### Parameters  
 ...
 `pViewClass`  
 Specifies the [CRuntimeClass](../VS_csharp/cruntimeclass-structure.md) of the new view.  
  
 *sizeInit*  
 Specifies the initial size of the new view.  
  
 `pContext`  
 A pointer to a creation context used to create the view (usually the `pContext` passed into the parent frame's overridden [CFrameWnd::OnCreateClient](../VS_csharp/cframewnd-class.md#cframewnd__oncreateclient) member function in which the splitter window is being created).  
...
### Example  
 [!code[NVC_MFCWindowing#4](../VS_csharp/codesnippet/CPP/csplitterwnd-class_2.cpp)]  
...
### Remarks  
 If the active view is being deleted, the next view will become active. The default implementation assumes the view will auto delete in [PostNcDestroy](../VS_csharp/cwnd-class.md#cwnd__postncdestroy).  
...
### Return Value  
 Returns the pane at the specified row and column. The returned pane is usually a [CView](../VS_csharp/cview-class.md)-derived class.  
...
### Example  
 [!code[NVC_MFCWindowing#5](../VS_csharp/codesnippet/CPP/csplitterwnd-class_3.cpp)]  
...
### Parameters  
 `pWnd`  
 A pointer to a [CWnd](../VS_csharp/cwnd-class.md) object to be tested.  
...
### Parameters  
 `pDC`  
 A pointer to the device context in which to draw. If `pDC` is **NULL**, then [CWnd::RedrawWindow](../VS_csharp/cwnd-class.md#cwnd__redrawwindow) is called by the framework and no split window is drawn.  
...
-   **splitBorder** The split window borders.  
 ...
 `rect`  
 A reference to a [CRect](../VS_csharp/crect-class.md) object specifying the size and shape of the split windows.  
...
### Example  
 [!code[NVC_MFCWindowing#6](../VS_csharp/codesnippet/CPP/csplitterwnd-class_4.cpp)]  
