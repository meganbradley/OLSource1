...
> [!NOTE]
>  For C++ programs, C++ exception handling should be used instead of structured exception handling. For more information, see [Exception Handling](../VS_csharp/exception-handling-in-visual-c--.md) in the *C++ Language Reference*.  
...
## Example  
 Following is an example of an exception handler and a termination handler. See [The try-finally Statement](../VS_csharp/try-finally-statement--c-.md) for more information about termination handlers.  
...
## See Also  
 [try-except Statement](../VS_csharp/try-except-statement.md)