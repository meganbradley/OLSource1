...
---
# POPDIRLISTFUNC
This is a callback function given to the [SccPopulateDirList](../VS_csharp/sccpopulatedirlist-function.md) function to update a collection of directories and (optionally) file names to find out which are under source control.  
...
## Parameters  
 pvCallerData  
 [in] User value given to [SccPopulateDirList](../VS_csharp/sccpopulatedirlist-function.md).  
...
## See Also  
 ...
 [SccPopulateDirList](../VS_csharp/sccpopulatedirlist-function.md)   
