...
-   By a compound key.  
 ...
 In addition, the last two queries project their results into a new anonymous type that contains only the student's first and last name. For more information, see the [group clause (C# Reference)](../VS_csharp/group-clause--csharp-reference-.md).  
...
## See Also  
 ...
 [How To: Group a Group (LINQ)](../VS_csharp/how-to--create-a-nested-group--csharp-programming-guide-.md)   
 [Grouping Data](../VS_csharp/grouping-data.md)