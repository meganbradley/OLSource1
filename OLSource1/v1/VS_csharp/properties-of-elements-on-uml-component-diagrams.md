...
> [!NOTE]
>  This topic is about the properties of elements in UML Component Diagrams. For more information about how to read UML Component Diagrams, see [UML Component Diagrams: Introduction](../VS_csharp/uml-component-diagrams--reference.md). For more information about how to draw UML Component Diagrams, see [UML Component Diagrams: Guidelines](../VS_csharp/uml-component-diagrams--guidelines.md).  
...
## See Also  
 [UML Component Diagrams: Overview](../VS_csharp/uml-use-case-diagrams--reference.md)   
 [UML Component Diagrams: Guidelines](../VS_csharp/uml-use-case-diagrams--guidelines.md)