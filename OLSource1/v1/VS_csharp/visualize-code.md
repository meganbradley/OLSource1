...
|||  
|-|-|  
|**Understand code and its relationships:**<br /><br /> Map relationships between specific pieces of code.<br /><br /> See an overview of the relationships in your code for the entire solution.<br /><br /> **Note**: In this release of Visual Studio, the term *code map* is used in place of *dependency graph*.|-   [Map dependencies across your solutions](../VS_csharp/map-dependencies-across-your-solutions.md)<br />-   [Use code maps to debug your applications](../VS_csharp/use-code-maps-to-debug-your-applications.md)<br />-   [Find potential problems in code using code maps](../VS_csharp/find-potential-problems-using-code-map-analyzers.md)<br />-   [Map methods on the call stack while debugging](../VS_csharp/map-methods-on-the-call-stack-while-debugging-in-visual-studio.md)|  
|**Understand class structures:**<br /><br /> Visualize the structure of classes in a project by creating class diagrams from code.|[How to: Add Class Diagrams to Projects](../VS_csharp/how-to--add-class-diagrams-to-projects--class-designer-.md)|  
|**Describe the high-level system design and validate code against this design:**<br /><br /> Describe the high-level system design and its intended dependencies by creating layer diagrams. Validate code against this design to make sure dependencies in code remain consistent with the design.|-   [How to: Create Layer Diagrams from Code](../VS_csharp/create-layer-diagrams-from-your-code.md)<br />-   [Layer Diagrams: Reference](../VS_csharp/layer-diagrams--reference.md)<br />-   [Layer Diagrams: Guidelines](../VS_csharp/layer-diagrams--guidelines.md)<br />-   [How to: Validate Code Against Layer Diagrams](../VS_csharp/validate-code-with-layer-diagrams.md)|  
|**Communicate the user requirements and architecture:**<br /><br /> Model the user requirements and architecture of your software system by drawing the following UML diagrams: activity, component, class, sequence, and use case.|-   [Developing Models for Software Design](../VS_csharp/create-models-for-your-app.md)<br />-   [Modeling User Requirements](../VS_csharp/model-user-requirements.md)<br />-   [Modeling the Architecture of a Software System](../VS_csharp/model-your-app-s-architecture.md)|  
...
## See Also  
 [Scenario: Updating a System by Using Visualization and Modeling](../VS_csharp/scenario--change-your-design-using-visualization-and-modeling.md)   
