...
## Remarks  
 This class provides a constructor and derives methods from [CAtlList](../VS_csharp/catllist-class.md) and [CAutoPtrElementTraits](../VS_csharp/cautoptrelementtraits-class.md) to aid the creation of a list object storing smart pointers. The class [CAutoPtrArray](../VS_csharp/cautoptrarray-class.md) provides a similar function for an array object.  
