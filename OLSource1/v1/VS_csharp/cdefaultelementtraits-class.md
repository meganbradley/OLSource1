...
## Remarks  
 This class provides default static functions and methods for moving, copying, comparing, and hashing elements stored in a collection class object. This class derives its functions and methods from [CElementTraitsBase](../VS_csharp/celementtraitsbase-class.md), [CDefaultHashTraits](../VS_csharp/cdefaulthashtraits-class.md), and [CDefaultCompareTraits](../VS_csharp/cdefaultcomparetraits-class.md), and is utilized by [CElementTraits](../VS_csharp/celementtraits-class.md), [CPrimitiveElementTraits](../VS_csharp/cprimitiveelementtraits-class.md), and [CHeapPtrElementTraits](../VS_csharp/cheapptrelementtraits-class.md).  
