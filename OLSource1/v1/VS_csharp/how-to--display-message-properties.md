...
To find out more about a message listed in [Messages View](../VS_csharp/messages-view.md), use the [Message Properties Dialog Box](../VS_csharp/message-properties-dialog-box.md).  
