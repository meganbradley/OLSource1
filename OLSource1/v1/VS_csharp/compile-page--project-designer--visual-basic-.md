 ...
 **Configuration**  
 Specifies which configuration settings to display or modify. The settings are **Debug** (default), **Release**, or **All Configurations**. For more information, see [Debug and Release Project Configurations](assetId:///0440b300-0614-4511-901a-105b771b236e) and [How to: Create and Edit Configurations](../VS_csharp/how-to--create-and-edit-configurations.md).  
 ...
 **Option explicit**  
 ...
 This setting corresponds to the [/optionexplicit](../VS_csharp/-optionexplicit.md) compiler option.  
  
 If a source code file contains an [Option Explicit Statement (Visual Basic)](../VS_csharp/option-explicit-statement--visual-basic-.md), the `On` or `Off` value in the statement overrides the **Option Explicit** setting on the **Compile page**.  
...
-   Implicit typing that results in an `Object` type  
 ...
 Implicit narrowing conversion errors occur when there is an implicit data type conversion that is a narrowing conversion. For more information, see [Option Strict Statement](../VS_csharp/option-strict-statement.md), [Implicit and Explicit Conversions (Visual Basic)](../VS_csharp/implicit-and-explicit-conversions--visual-basic-.md), and [Widening and Narrowing Conversions (Visual Basic)](../VS_csharp/widening-and-narrowing-conversions--visual-basic-.md).  
  
 An object is late bound when it is assigned to a property or method of a variable that is declared to be of type `Object`. For more information, see [Option Strict Statement](../VS_csharp/option-strict-statement.md) and [Early and Late Binding (Visual Basic)](../VS_csharp/early-and-late-binding--visual-basic-.md).  
  
 Implicit object type errors occur when an appropriate type cannot be inferred for a declared variable, so a type of `Object` is inferred. This primarily occurs when you use a `Dim` statement to declare a variable without using an `As` clause, and `Option Infer` is off. For more information, see [Option Strict Statement](../VS_csharp/option-strict-statement.md), [Option Infer Statement](../VS_csharp/option-infer-statement.md), and the [Visual Basic Language Specification](../VS_csharp/visual-basic-language-specification.md).  
  
 The **Option Strict** setting corresponds to the [/optionstrict](../VS_csharp/-optionstrict.md) compiler option.  
  
 If a source code file contains an [Option Strict Statement](../VS_csharp/option-strict-statement.md), the `On` or `Off` value in the statement overrides the **Option Strict** setting on the **Compile page**.  
 ...
 **Option compare**  
 ...
 This setting corresponds to the [/optioncompare](../VS_csharp/-optioncompare.md) compiler option.  
  
 If a source code file contains an [Option Compare Statement](../VS_csharp/option-compare-statement.md), the `Binary` or `Text` value in the statement overrides the **Option Compare** setting on the **Compile page**.  
 ...
 **Option infer**  
 ...
 This setting corresponds to the [/optioninfer](../VS_csharp/-optioninfer.md) compiler option.  
  
 If a source code file contains an [Option Infer Statement](../VS_csharp/option-infer-statement.md), the `On` or `Off` value in the statement overrides the **Option Infer** setting on the **Compile page**.  
 ...
 **Target CPU**  
 ...
 For more information, see [/platform (Visual Basic)](../VS_csharp/-platform--visual-basic-.md).  
 ...
 **Disable all warnings**  
 ...
 This setting corresponds to the [/nowarn](../VS_csharp/-nowarn.md) compiler option.  
 ...
 **Generate XML documentation file**  
 ...
 This setting corresponds to the [/doc](../VS_csharp/-doc.md) compiler option.  
 ...
 **Build Events**  
 Click this button to access the **Build Events** dialog box. Use this dialog box to specify pre-build and post-build configuration instructions for the project. This dialog box applies to Visual Basic projects only. For more information, see [Build Events Dialog Box (Visual Basic)](../VS_csharp/build-events-dialog-box--visual-basic-.md).  
  
 **Advanced Compile Options**  
 Click this button to access the **AdvancedCompiler Settings** dialog box. Use the **AdvancedCompiler Settings** dialog box to specify a project's advanced build configuration properties. This dialog box applies to Visual Basic projects only. For more information, see [Advanced Compiler Settings Dialog Box (Visual Basic)](../VS_csharp/advanced-compiler-settings-dialog-box--visual-basic-.md).  
...
## See Also  
 ...
 [How to: Specify Build Events](../VS_csharp/how-to--specify-build-events--visual-basic-.md)   
