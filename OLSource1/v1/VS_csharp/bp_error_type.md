...
## Remarks  
 These values may be combined with a bitwise `OR` and used for the `dwType` member of the [BP_ERROR_RESOLUTION_INFO](../VS_csharp/bp_error_resolution_info.md) structure. Passed as a parameter to the [EnumErrorBreakpoints](../VS_csharp/idebugpendingbreakpoint2--enumerrorbreakpoints.md) method.  
