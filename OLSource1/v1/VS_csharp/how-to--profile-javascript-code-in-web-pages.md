...
[!INCLUDE[vsprvs](../VS_csharp/includes/vsprvs_md.md)] Profiling Tools can collect performance data for JavaScript code that executes in an [!INCLUDE[vstecasp](../VS_csharp/includes/vstecasp_md.md)] Web application, an arbitrary Web page, or JavaScript application by using the instrumentation profiling method.  
...
>   
>  -   [How to profile JavaScript code in Windows Metro style apps on a local machine](../Topic/JavaScript%20Function%20Timing.md) [How to profile JavaScript code in Windows Metro style apps on a remote device](../Topic/JavaScript%20Function%20Timing%20on%20a%20Remote%20Device.md)  
...
> -  
 ...
 When you specify JavaScript profiling, both the JavaScript code that executes in the browser and the [!INCLUDE[vstecasp](../VS_csharp/includes/vstecasp_md.md)] code that executes on the server are profiled.  
  
-   For an [!INCLUDE[vstecasp](../VS_csharp/includes/vstecasp_md.md)] Web application, both the JavaScript code that executes in the browser and the [!INCLUDE[vstecasp](../VS_csharp/includes/vstecasp_md.md)] code that executes on the server are profiled.  
...
1.  In [!INCLUDE[vsPreLong](../VS_csharp/includes/vsprelong_md.md)], open the [!INCLUDE[vstecasp](../VS_csharp/includes/vstecasp_md.md)] Web project.  
...
1.  Open [!INCLUDE[vsPreShort](../VS_csharp/includes/vspreshort_md.md)].  
