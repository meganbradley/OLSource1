...
## Return Value  
 The formal return type is `Var option`. The option indicates whether the input results in a match. In a pattern matching expression, the input is represented as a [Var](../VS_csharp/quotations.var-class--fsharp-.md) object that represents a local value or variable.  
