...
## Example  
 [!code[csProgGuideObjects#90](../VS_csharp/codesnippet/CSharp/how-to--test-for-reference-equality--identity---csharp-programming-guide-_1.cs)]  
...
## See Also  
 [Reference Equality vs Value Equality](../VS_csharp/equality-comparisons--csharp-programming-guide-.md)