 ...
 **F1 Support**  
 ...
 ![F1 flow](../VS_csharp/media/f1flow.png "F1flow")  
...
|< meta name="Description" content="[topic description]" />|Provides a short summary of the content in this topic. If this tag is used in a topic, it must be used just once. This property is accessed directly by the query library; it is not stored in the index file.|  
 meta name="Microsoft.Help.TocParent" content="[parent_Id]"/>|Specifies the parent topic of this topic in the table of contents. This tag is required, and must be used just once in a topic. The value is the Microsoft.Help.Id of the parent. A topic can have just one location in the table of contents. “-1” is considered the topic ID for the TOC root. In [!INCLUDE[vs_dev12](../VS_csharp/includes/vs_dev12_md.md)], that page is Help Viewer home page. This is the same reason we specifically add TocParent=-1 to some topics to ensure that they show up at the top level.The Help Viewer home page is a system page and so non-replaceable. If a VSP tries to add a page with an ID of -1, it may get added to the content set, but Help Viewer will always use the system page – Help Viewer Home|  
...
|FeedbackLink||  
|LogoTitle|[!INCLUDE[vs_dev12](../VS_csharp/includes/vs_dev12_md.md)]|  
...
1.  [!INCLUDE[vs_dev12](../VS_csharp/includes/vs_dev12_md.md)]  
  
2.  [Visual Studio 2013 Isolated Shell Redist](http://www.microsoft.com/visualstudio/11/downloads#vs-shell)  
  
 **Overview**  
  
 The [!INCLUDE[vs_dev12](../VS_csharp/includes/vs_dev12_md.md)] Shell is a version of the [!INCLUDE[vs_dev12](../VS_csharp/includes/vs_dev12_md.md)] IDE on which you can base an application. Such applications contain the Isolated Shell together with extensions that you create. Use Isolated Shell project templates, which are included in the [!INCLUDE[vs_dev12](../VS_csharp/includes/vs_dev12_md.md)] SDK, to build extensions.  
  
 The basic steps for creating an Isolated Shell-based application and its Help:  
  
1.  Obtain the [!INCLUDE[vs_dev12](../VS_csharp/includes/vs_dev12_md.md)] ISO Shell redistributable (a Microsoft download).  
...
-   HKLM\SOFTWARE\Wow6432Node\Microsoft\Help\v2.1\Catalogs\VisualStudio12\en-US  
     ...
     Key: CatalogName String value: [!INCLUDE[vs_dev12](../VS_csharp/includes/vs_dev12_md.md)] Documentation  
...
5.  Create a content store:  
     ...
     For [!INCLUDE[vs_dev12](../VS_csharp/includes/vs_dev12_md.md)] Integrated Shell, create folder C:\ProgramData\Microsoft\HelpLibrary2\Catalogs\VisualStudio12  
...
7.  Add the following registry keys:  
     ...
     [!INCLUDE[vs_dev12](../VS_csharp/includes/vs_dev12_md.md)] Integrated Shell:  
  
     C:ProgramDataMicrosoftHelpLibrary2CatalogsVisualStudio12en-US  
  
     Key: CatalogName String value: [!INCLUDE[vs_dev12](../VS_csharp/includes/vs_dev12_md.md)] Documentation. For ISO Shell, this is the name of your catalog.  
