...
## Remarks  
 ...
 For more information on event maps and the `BEGIN_EVENT_MAP` macro, see the article [ActiveX Controls: Events](../VS_csharp/mfc-activex-controls--events.md).  
...
## See Also  
 ...
 [DECLARE_EVENT_MAP](../VS_csharp/declare_event_map.md)   
