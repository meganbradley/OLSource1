...
## Remarks  
 Use this method when your scheduler wants to oversubscribe a particular hardware thread for a limited amount of time. Once you are done with the virtual processor root, you should return it to the resource manager by calling the [Remove](../VS_csharp/iexecutionresource--remove-method.md) method on the `IVirtualProcessorRoot` interface.  
