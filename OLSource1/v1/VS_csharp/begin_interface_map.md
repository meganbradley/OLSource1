...
## Remarks  
 ...
 For more information on interface maps, see [Technical Note 38](../VS_csharp/tn038--mfc-ole-iunknown-implementation.md).  
...
## See Also  
 ...
 [END_INTERFACE_MAP](../VS_csharp/end_interface_map.md)   
 [INTERFACE_PART](../VS_csharp/interface_part.md)