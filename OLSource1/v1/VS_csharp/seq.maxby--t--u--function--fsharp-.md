...
Returns the greatest of all elements of the sequence, compared by using [Operators.max](../VS_csharp/operators.max--t--function--fsharp-.md) on the function result.  
