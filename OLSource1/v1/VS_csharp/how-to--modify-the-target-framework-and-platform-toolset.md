...
4.  In the right pane, select **Platform Toolset** and then select the toolset you want from the drop-down list. For example, if you have installed the [!INCLUDE[vs_dev10_long](../VS_csharp/includes/vs_dev10_long_md.md)] toolset, select **Visual Studio 2010 (v100)** to use it for your project.  
  
5.  Choose the **OK** button.  
  
## See Also  
 [MSBuild](../VS_csharp/msbuild--visual-c---.md)