...
-   The extension is .ext.  
 ...
 For more information and code examples, see [File System Navigation](../VS_csharp/file-system-navigation.md).  
  
## Classes  
  
|Name|Description|  
|----------|-----------------|  
|[directory_entry Class](../VS_csharp/directory_entry-class.md)|Describes an object that is returned by a `directory_iterator` or a `recursive_directory_iterator` and contains a path.|  
|[directory_iterator Class](../VS_csharp/directory_iterator-class.md)|Describes an input iterator that sequences through the file names in a file-system directory.|  
|[filesystem_error Class](../VS_csharp/filesystem_error-class.md)|A base class for exceptions that are thrown to report a low-level system overflow.|  
|[path Class](../VS_csharp/path-class--c---standard-template-library-.md)|Defines a class that stores an object of template type `String` that is suitable for use as a file name.|  
|[recursive_directory_iterator Class](../VS_csharp/recursive_directory_iterator-class.md)|Describes an input iterator that sequences through the file names in a file-system directory. The iterator can also descend into subdirectories.|  
|[file_status Class](../VS_csharp/file_status-class.md)|Wraps a `file_type`.|  
  
## Structs  
  
|Name|Description|  
|----------|-----------------|  
|[space_info Structure](../VS_csharp/space_info-structure.md)|Holds information about a volume.|  
  
## Functions  
 [<filesystem\> functions](../VS_csharp/-filesystem--functions.md)  
  
## Operators  
 [<filesystem\> operators](../VS_csharp/-filesystem--operators.md)  
  
## Enumerations  
  
|Name|Description|  
|----------|-----------------|  
|[copy_options Enumeration](../VS_csharp/copy_option-enumeration--filesystem-.md)|An enumeration that is used with [copy_file](assetId:///4af7a9b0-8861-45ed-b84e-0307f0669d60) and determines behavior if a destination file already exists.|  
|[directory_options Enumeration](../VS_csharp/directory_options-enumeration.md)|An enumeration that specifies options for directory iterators.|  
|[file_type Enumeration](../VS_csharp/file_type-enumeration.md)|An enumeration for file types.|  
|[perms Enumeration](../VS_csharp/perms-enumeration.md)|A bitmask type used to convey permissions and options to permissions|  
