...
>  Before using an array, use [SetSize](#carray__setsize) to establish its size and allocate memory for it. If you do not use `SetSize`, adding elements to your array causes it to be frequently reallocated and copied. Frequent reallocation and copying are inefficient and can fragment memory.  
 ...
 If you need a dump of individual elements in an array, you must set the depth of the [CDumpContext](../VS_csharp/cdumpcontext-class.md) object to 1 or larger.  
  
 Certain member functions of this class call global helper functions that must be customized for most uses of the `CArray` class. See the topic [Collection Class Helpers](../VS_csharp/collection-class-helpers.md) in the MFC Macros and Globals section.  
  
 Array class derivation is like list derivation.  
  
 For more information about how to use `CArray`, see the article [Collections](../VS_csharp/collections.md).  
...
### Example  
 [!code[NVC_MFCCollections#22](../VS_csharp/codesnippet/CPP/carray-class_1.cpp)]  
...
### Example  
 [!code[NVC_MFCCollections#23](../VS_csharp/codesnippet/CPP/carray-class_2.cpp)]  
...
### Example  
 [!code[NVC_MFCCollections#24](../VS_csharp/codesnippet/CPP/carray-class_3.cpp)]  
...
### Example  
 [!code[NVC_MFCCollections#25](../VS_csharp/codesnippet/CPP/carray-class_4.cpp)]  
...
### Example  
 [!code[NVC_MFCCollections#26](../VS_csharp/codesnippet/CPP/carray-class_5.cpp)]  
...
### Example  
 [!code[NVC_MFCCollections#27](../VS_csharp/codesnippet/CPP/carray-class_6.cpp)]  
...
### Example  
 [!code[NVC_MFCCollections#28](../VS_csharp/codesnippet/CPP/carray-class_7.cpp)]  
...
### Example  
 [!code[NVC_MFCCollections#29](../VS_csharp/codesnippet/CPP/carray-class_8.cpp)]  
...
### Example  
 [!code[NVC_MFCCollections#30](../VS_csharp/codesnippet/CPP/carray-class_9.cpp)]  
...
### Example  
 [!code[NVC_MFCCollections#34](../VS_csharp/codesnippet/CPP/carray-class_10.cpp)]  
...
### Remarks  
 ...
 The [CArray](../VS_csharp/carray-class.md) implementation uses this method to copy the old data to a new buffer when the array should grow or shrink (when [SetSize](#carray__setsize) or [FreeExtra](#carray__freeextra) are called). The default implementation just copies the data.  
...
### Example  
 [!code[NVC_MFCCollections#31](../VS_csharp/codesnippet/CPP/carray-class_11.cpp)]  
...
### Example  
 [!code[NVC_MFCCollections#32](../VS_csharp/codesnippet/CPP/carray-class_12.cpp)]  
...
### Example  
 [!code[NVC_MFCCollections#33](../VS_csharp/codesnippet/CPP/carray-class_13.cpp)]  
