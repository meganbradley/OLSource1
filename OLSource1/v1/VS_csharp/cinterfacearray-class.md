...
## Remarks  
 This class provides a constructor and derived methods for creating an array of COM interface pointers. Use [CInterfaceList](../VS_csharp/cinterfacelist-class.md) when a list is required.  
