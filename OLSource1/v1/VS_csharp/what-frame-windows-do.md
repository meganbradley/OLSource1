...
-   [Control bars (how they fit into the frame window)](../VS_csharp/control-bars.md)  
  
-   [Managing menus, control bars, and accelerators (how they fit into the frame window)](../VS_csharp/managing-menus--control-bars--and-accelerators.md)  
  
-   [Command Routing (from the frame window to its view and other command targets)](../VS_csharp/command-routing.md)  
