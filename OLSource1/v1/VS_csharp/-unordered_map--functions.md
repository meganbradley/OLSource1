...
### Remarks  
 The template function executes `left.`[swap](../VS_csharp/unordered_map-class.md#unordered_map__swap)`(right)`.  
...
### Remarks  
 The template function executes `left.`[swap](../VS_csharp/unordered_multimap-class.md#unordered_multimap__swap)`(right)`.  
