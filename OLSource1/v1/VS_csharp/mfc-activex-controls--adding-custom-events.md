...
##  <a name="_core_classwizard_changes_for_custom_events"></a> Add Event Wizard Changes for Custom Events  
 ...
 [!code[NVC_MFC_AxUI#7](../VS_csharp/codesnippet/CPP/mfc-activex-controls--adding-custom-events_1.h)]  
 ...
 [!code[NVC_MFC_AxUI#8](../VS_csharp/codesnippet/CPP/mfc-activex-controls--adding-custom-events_2.cpp)]  
 ...
 [!code[NVC_MFC_AxUI#9](../VS_csharp/codesnippet/CPP/mfc-activex-controls--adding-custom-events_3.idl)]  
...
6.  Double-click the new handler function in Class View to jump to the message handler code in the implementation (.CPP) file of your ActiveX control.  
 ...
 The following code sample calls the **InCircle** function every time the left mouse button is clicked within the control window. This sample can be found in the `WM_LBUTTONDOWN` handler function, `OnLButtonDown`, in the [Circ sample](../VS_csharp/visual-c---samples.md) abstract.  
  
 [!code[NVC_MFC_AxUI#10](../VS_csharp/codesnippet/CPP/mfc-activex-controls--adding-custom-events_4.cpp)]  
...
>  When the Add Event Wizard creates message handlers for mouse button actions, a call to the same message handler of the base class is automatically added. Do not remove this call. If your control uses any of the stock mouse messages, the message handlers in the base class must be called to ensure that mouse capture is handled properly.  
 ...
 [!code[NVC_MFC_AxUI#11](../VS_csharp/codesnippet/CPP/mfc-activex-controls--adding-custom-events_5.cpp)]  
  
 You will also need to add the following declaration of the `InCircle` function to your control's header (.H) file:  
  
 [!code[NVC_MFC_AxUI#12](../VS_csharp/codesnippet/CPP/mfc-activex-controls--adding-custom-events_6.h)]  
