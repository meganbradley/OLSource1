...
**Microsoft Specific**  
 ...
 Generates the [!INCLUDE[vcprx64](../VS_csharp/includes/vcprx64_md.md)] extended version of the Convert Scalar Single Precision Floating Point Number to 64-bit Integer (`cvtss2si`) instruction.  
...
|---------------|------------------|  
|`_mm_cvtss_si64x`|[!INCLUDE[vcprx64](../VS_csharp/includes/vcprx64_md.md)]|  
