...
Use this dialog box to find and select the node for a specific window in [Windows View](../VS_csharp/windows-view.md). To display this dialog box, move the focus to the Windows view window. Then choose **Find Window** from the **Search** menu.  
