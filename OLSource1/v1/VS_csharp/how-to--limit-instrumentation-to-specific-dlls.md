...
1.  Open [!INCLUDE[vsPreLong](../VS_csharp/includes/vsprelong_md.md)].  
...
## See Also  
 ...
 [How to: Limit Instrumentation to Specific Functions](../VS_csharp/how-to--limit-instrumentation-to-specific-functions.md)