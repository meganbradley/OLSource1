...
2.  In Solution Explorer, double-click the file app.ico. The [Image Editor](../VS_csharp/image-editor-for-icons.md) will open.  
  
3.  From the **Image** menu, select **Tools** and then select **Text Tool**. The [Text Tool Dialog Box](../VS_csharp/text-tool-dialog-box--image-editor-for-icons-.md) will appear.  
...
6.  In the Text Tool Dialog Box, click the **Font** button. The [Text Tool Font Dialog Box](../VS_csharp/text-tool-font-dialog-box--image-editor-for-icons-.md) will appear.  
