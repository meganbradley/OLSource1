...
## Exceptions  
 The method throws an [overflow_error](../VS_csharp/overflow_error-class.md) if any bit in the bit sequence has a bit value that cannot be represented as a value of type `unsigned long long`.  
