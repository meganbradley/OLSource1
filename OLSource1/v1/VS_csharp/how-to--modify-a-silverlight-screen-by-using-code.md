...
[!INCLUDE[smb_current_long](../VS_csharp/includes/smb_current_long_md.md)] enables you to accomplish many screen-related design tasks by using designers and tool windows.  However, there are certain tasks that you might want to accomplish by using code.  This topic shows you how to accomplish a set of common screen-related design tasks by using the screen object model. For more information about where you can write code in your application, see any of the following topics:  
...
##  <a name="ReadingData"></a> Making Controls Hidden, Read-Only, or Disabled  
 ...
 [!code[LS_Screens#4](../VS_csharp/codesnippet/CSharp/how-to--modify-a-silverlight-screen-by-using-code_1.cs)]
[!code[LS_Screens#4](../VS_csharp/codesnippet/VisualBasic/how-to--modify-a-silverlight-screen-by-using-code_1.vb)]  
 ...
 [!code[LS_Screens#5](../VS_csharp/codesnippet/CSharp/how-to--modify-a-silverlight-screen-by-using-code_2.cs)]
[!code[LS_Screens#5](../VS_csharp/codesnippet/VisualBasic/how-to--modify-a-silverlight-screen-by-using-code_2.vb)]  
