...
#### Parameters  
 ...
 `category`  
 An identifier that contains the return value of [wctrans](../VS_csharp/wctrans.md).  
  
## Return Value  
 The character `c`, after `towctrans` used the transform rule in `category`.  
  
## Remarks  
 The value of `category` must have been returned by an earlier successful call to [wctrans](../VS_csharp/wctrans.md).  
