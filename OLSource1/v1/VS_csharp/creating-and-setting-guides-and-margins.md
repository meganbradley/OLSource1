...
1.  Within the ruler, click once to create a guide. (One click creates a new guide; double-clicking launches the [Guide Settings Dialog Box](../VS_csharp/guide-settings-dialog-box.md) in which you can specify guide settings.)  
