...
>  The Visual Studio shell integrated mode can be installed together with all editions of Visual Studio except the Express editions.  
 ...
 For more information, see [The Visual Studio Integrated Shell](../VS_csharp/visual-studio-shell--integrated-.md).  
...
## Isolated Mode  
 ...
 For more information, see [Visual Studio Shell (Isolated Mode)](../VS_csharp/visual-studio-isolated-shell.md).  
  
## Distributing your Integrated or Isolated Shell Application  
 In order to distribute your integrated or isolated shell application, you need to include your application, a special integrated or isolated shell redistributable, and an installation program. For more information about distribution and installation, see [Distributing Integrated and Isolated Shell Applications](../VS_csharp/distributing-isolated-shell-applications.md).  
...
## See Also  
 [Package Deployment](../VS_csharp/shipping-visual-studio-extensions.md)