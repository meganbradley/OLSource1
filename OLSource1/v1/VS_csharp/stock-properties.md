...
---
# Stock Properties
If you are adding a property to an MFC dispinterface using the [Add Property Wizard](../VS_csharp/idl-attributes--add-property-wizard.md), you can choose a stock property from the **Property name** list in the [Names](../VS_csharp/names--add-property-wizard.md) page of the wizard. These properties are as follows:  
