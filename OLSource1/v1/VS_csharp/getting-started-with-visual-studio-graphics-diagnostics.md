...
> [!TIP]
>  The optional Graphics Tools feature of Windows 10 provides lightweight capture and playback functionality—such as the command-line capture program **dxcap.exe**—that can be used in support, testing, and diagnostic scenarios on machines where developer tools aren't installed. For more information, see the [Command-Line Capture Tool](../VS_csharp/command-line-capture-tool.md) topic.  
...
### 4 – Examine captured frames in the Graphics Analyzer  
 ...
 To learn more about how to use the Graphics Analyzer tools together, see the [Graphics Diagnostics Examples](../VS_csharp/graphics-diagnostics-examples.md).  
