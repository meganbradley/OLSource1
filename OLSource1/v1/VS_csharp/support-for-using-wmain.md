...
> [!NOTE]
>  MFC Unicode applications use **wWinMain** as the entry point. In this case, `CWinApp::m_lpCmdLine` is a Unicode string. Be sure to set **wWinMainCRTStartup** with the [/ENTRY](../VS_csharp/-entry--entry-point-symbol-.md) linker option.  
...
## See Also  
 ...
 [Unicode Programming Summary](../VS_csharp/unicode-programming-summary.md)   
