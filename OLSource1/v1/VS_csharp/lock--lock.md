...
## Remarks  
 ...
 The fourth form of the constructor does not acquire a lock on `_object`. `lock_later` is a member of the [lock_when Enum](../VS_csharp/lock_when-enum.md). Use [acquire](../VS_csharp/lock--acquire.md) or [try_acquire](../VS_csharp/lock--try_acquire.md) to acquire the lock in this case.  
...
## See Also  
 [lock Members](../VS_csharp/lock-members.md)   
 [lock::~lock](../VS_csharp/lock--~lock.md)   
 [lock::acquire](../VS_csharp/lock--acquire.md)   
 [lock::try_acquire](../VS_csharp/lock--try_acquire.md)