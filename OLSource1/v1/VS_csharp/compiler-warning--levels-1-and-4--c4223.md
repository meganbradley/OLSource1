...
nonstandard extension used : non-lvalue array converted to pointer  
 ...
 In standard C, you cannot convert a non-lvalue array to a pointer. With the default Microsoft extensions ([/Ze](../VS_csharp/-za---ze--disable-language-extensions-.md)), you can.