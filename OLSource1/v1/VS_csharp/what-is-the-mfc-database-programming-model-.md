...
Although MFC implements DAO and ODBC quite differently underneath, they have similar interfaces that it relatively easy to port your applications from one to the other, particularly from ODBC to DAO. For information about porting from ODBC to DAO, see [Technical Note 55](../VS_csharp/tn055--migrating-mfc-odbc-database-class-applications-to-mfc-dao-classes.md). The DAO and ODBC interfaces in MFC are also very similar to that in Visual Basic.  
...
-   Online documentation that includes overviews, articles about programming topics, and class reference materials  
 ...
 For information about these components, see [ODBC and MFC](../VS_csharp/odbc-and-mfc.md).  
  
 For more information, see:  
  
-   [Choosing between DAO and ODBC](../VS_csharp/should-i-use-dao-or-odbc-.md).  
  
-   [Availability of database definition language (DDL) and database manipulation language (DML)](../VS_csharp/are-ddl-and-dml-supported-.md) in DAO and ODBC.  
  
-   [Installing MFC database support](../VS_csharp/installing-mfc-database-support.md).  
  
-   The [ODBC](../VS_csharp/odbc-and-mfc.md) classes in MFC.  
  
-   [MFC data access programming documentation](../VS_csharp/mfc-database-documentation.md).  
  
-   [How MFC implements ODBC](../VS_csharp/odbc-and-mfc.md).  
