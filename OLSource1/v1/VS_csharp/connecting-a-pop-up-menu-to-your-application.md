...
1.  Add a message handler for [WM_CONTEXTMENU](_win32_WM_CONTEXTMENU) (for example). For more information, see [Mapping Messages to Functions](../VS_csharp/mapping-messages-to-functions.md).  
...
2.  Add the following code to the message handler:  
    ...
    > [!NOTE]
    >  The [CPoint](../VS_csharp/cpoint-class.md) **passed by the message handler is in screen coordinates.**  
...
## See Also  
 [Creating Pop-up Menus](../VS_csharp/creating-pop-up-menus.md)   
