...
## Members  
 ...
 Initialize/use the `bpResLocation` (breakpoint resolution location) field of the [BP_RESOLUTION_INFO](../VS_csharp/bp_resolution_info.md) structure.  
...
## Remarks  
 Passed to the [GetResolutionInfo](../VS_csharp/idebugbreakpointresolution2--getresolutioninfo.md) method to indicate which fields of the [BP_RESOLUTION_INFO](../VS_csharp/bp_resolution_info.md) structure are to be initialized.  
