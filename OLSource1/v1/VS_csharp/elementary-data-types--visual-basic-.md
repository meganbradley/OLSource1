...
[!INCLUDE[vbprvb](../VS_csharp/includes/vbprvb_md.md)] supplies a set of predefined data types, which you can use for many of your programming elements. This section describes these types and how to use them.  
...
## Related Sections  
 ...
 Provides an overview of the elementary data types supplied by [!INCLUDE[vbprvb](../VS_csharp/includes/vbprvb_md.md)].