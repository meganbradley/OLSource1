...
1.  Open the MFC application you created in [How to: Create the User Control and Host MDI View](../VS_csharp/how-to--create-the-user-control-and-host-mdi-view.md).  
