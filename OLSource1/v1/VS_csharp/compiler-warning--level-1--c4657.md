...
expression involves a data type that is new since the last build  
 ...
 This warning will always be followed by [Fatal Error C1092](../VS_csharp/fatal-error-c1092.md). For further information, see the [Supported Code Changes](../VS_csharp/supported-code-changes--c---.md).  
