...
This section provides information about creating XML trees in [!INCLUDE[vbprvb](../VS_csharp/includes/vbprvb_md.md)].  
  
 For information about using the results of LINQ queries as the content for an XML tree, see [Functional Construction (LINQ to XML) (Visual Basic)](../VS_csharp/functional-construction--linq-to-xml---visual-basic-.md).  
  
 For more information on XML literals in [!INCLUDE[vbprvb](../VS_csharp/includes/vbprvb_md.md)], see [Overview of LINQ to XML in Visual Basic](../VS_csharp/overview-of-linq-to-xml-in-visual-basic.md).  
