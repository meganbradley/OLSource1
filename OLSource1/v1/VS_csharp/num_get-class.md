...
### Parameters  
 ...
 `_Iosbase`  
 The [ios_base](../VS_csharp/ios_base-class.md) whose flags are used by the conversion.  
  
 `_State`  
 The state to which failbit (see [ios_base::iostate](../VS_csharp/ios_base-class.md#ios_base__iostate)) is added upon failure.  
...
### Remarks  
 ...
 If `iosbase.`[flags](../VS_csharp/ios_base-class.md#ios_base__flags)`() & ios_base::basefield == ios_base::`[oct](../VS_csharp/-ios--functions.md#oct), the conversion specification is `lo`.  
  
 If `iosbase.flags() & ios_base::basefield == ios_base::`[hex](../VS_csharp/-ios--functions.md#hex), the conversion specification is `lx`.  
  
 If `iosbase.flags() & ios_base::basefield == 0`, the conversion specification is `li`.  
  
 Otherwise, the conversion specification is `ld`.  
  
 The format of an integer input field is further determined by the [locale facet](../VS_csharp/locale-class.md#facet_class)`fac` returned by the call [use_facet](../VS_csharp/-locale--functions.md#use_facet) `<`[numpunct](../VS_csharp/numpunct-class.md)`<Elem>(iosbase.` [getloc](../VS_csharp/ios_base-class.md#ios_base__getloc)`())`. Specifically:  
  
 `fac.` [grouping](../VS_csharp/numpunct-class.md#numpunct__grouping) `()` determines how digits are grouped to the left of any decimal point  
  
 `fac.` [thousands_sep](../VS_csharp/numpunct-class.md#numpunct__thousands_sep) `()` determines the sequence that separates groups of digits to the left of any decimal point.  
 ...
 behaves the same as the first, except that it endeavors to match a complete, nonempty floating-point input field. `fac.`[decimal_point](../VS_csharp/numpunct-class.md#numpunct__decimal_point)`()` determines the sequence that separates the integer digits from the fraction digits. The equivalent scan conversion specifier is `lf`.  
 ...
 A Boolean input field takes one of two forms. If `iosbase.flags() & ios_base::`[boolalpha](../VS_csharp/-ios--functions.md#boolalpha) is false, it is the same as an integer input field, except that the converted value must be either 0 (for false) or 1 (for true). Otherwise, the sequence must match either `fac.`[falsename](../VS_csharp/numpunct-class.md#numpunct__falsename)`()` (for false), or `fac.`[truename](../VS_csharp/numpunct-class.md#numpunct__truename)`()` (for true).  
...
```  
 ...
 behaves the same as the first, except that it tries to match a complete, nonempty floating-point input field. **fac**. [decimal_point](../VS_csharp/numpunct-class.md#numpunct__decimal_point) determines the sequence that separates the integer digits from the fraction digits. The equivalent scan conversion specifier is **lf**.  
