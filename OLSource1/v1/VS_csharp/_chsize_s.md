...
---
# _chsize_s
Changes the size of a file. This is a version of [_chsize](../VS_csharp/_chsize.md) with security enhancements as described in [Security Enhancements in the CRT](../VS_csharp/security-features-in-the-crt.md).  
...
## Remarks  
 ...
 This function validates its parameters. If `fd` is not a valid file descriptor or size is less than zero, the invalid parameter handler is invoked, as described in [Parameter Validation](../VS_csharp/parameter-validation.md).  
