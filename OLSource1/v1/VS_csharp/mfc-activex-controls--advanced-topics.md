...
##  <a name="_core_using_database_classes_in_activex_controls"></a> Using Database Classes in ActiveX Controls  
 ...
 For a general overview of the MFC database classes, see [MFC Database Classes (DAO and ODBC)](../VS_csharp/mfc-database-classes--odbc-and-dao-.md). The article introduces both the MFC ODBC classes and the MFC DAO classes and directs you to more details on either.  
  
> [!NOTE]
>  As of Visual C++ .NET, the Visual C++ environment and wizards no longer support DAO (although the DAO classes are included and you can still use them). Microsoft recommends that you use [OLE DB Templates](../VS_csharp/ole-db-programming.md) or [ODBC and MFC](../VS_csharp/odbc-and-mfc.md) for new projects. You should only use DAO in maintaining existing applications.  
...
##  <a name="_core_implementing_a_parameterized_property"></a> Implementing a Parameterized Property  
 ...
 [!code[NVC_MFC_AxVb#1](../VS_csharp/codesnippet/VisualBasic/mfc-activex-controls--advanced-topics_1.vb)]  
...
### Changes Made by the Add Property Wizard  
 ...
 [!code[NVC_MFC_AxUI#35](../VS_csharp/codesnippet/CPP/mfc-activex-controls--advanced-topics_2.h)]  
 ...
 [!code[NVC_MFC_AxUI#36](../VS_csharp/codesnippet/CPP/mfc-activex-controls--advanced-topics_3.cpp)]  
...
|**CTL_E_REPLACEMENTSTOOLONG**|Replacements too long|  
 ...
 [!code[NVC_MFC_AxUI#37](../VS_csharp/codesnippet/CPP/mfc-activex-controls--advanced-topics_4.cpp)]  
...
##  <a name="_core_handling_special_keys_in_your_control"></a> Handling Special Keys in the Control  
 ...
 [!code[NVC_MFC_AxUI#38](../VS_csharp/codesnippet/CPP/mfc-activex-controls--advanced-topics_5.cpp)]  
...
-   Declare a local variable and subclass as the dialog item. Insert code that resembles the following (`CMyCtrl` is the wrapper class, `IDC_MYCTRL1` is the control's ID):  
     ...
     [!code[NVC_MFC_AxCont#19](../VS_csharp/codesnippet/CPP/mfc-activex-controls--advanced-topics_6.cpp)]  
