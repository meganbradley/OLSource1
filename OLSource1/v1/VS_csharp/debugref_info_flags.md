...
## Remarks  
 These flags are passed to the [IDebugReference2::EnumChildren](../VS_csharp/idebugreference2--enumchildren.md) and [IDebugReference2::GetReferenceInfo](../VS_csharp/idebugreference2--getreferenceinfo.md) methods to indicate which fields of the [DEBUG_REFERENCE_INFO](../VS_csharp/debug_reference_info.md) structure are to be initialized.  
