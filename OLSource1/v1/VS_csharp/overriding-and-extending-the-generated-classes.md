...
### Rules  
 ...
 Rules are defined on a per-class basis, so that you do not have to have code that registers the rule for each object. For more information, see [How to create custom rules](../VS_csharp/rules-propagate-changes-within-the-model.md).  
...
### .NET Events  
 ...
 Some events are generated on ShapeFields, which are used to draw decorators on a shape. For an example, see [How to Intercept a Click on a Decorator](../VS_csharp/how-to--intercept-a-click-on-a-shape-or-decorator.md).  
