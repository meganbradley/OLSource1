...
## In This Section  
 [Menu Commands](../VS_csharp/menu-commands.md)  
 Describes the commands available on each Spy++ menu.  
  
 [Font Dialog Box](../VS_csharp/font-dialog-box--microsoft-spy---help-.md)  
 Used to configure the character font used in a Spy++ Views window.  
  
 [Search Tools for Spy++ Views](../VS_csharp/search-tools-for-spy---views.md)  
 ...
 [Process Properties Dialog Box](../VS_csharp/process-properties-dialog-box.md)  
 Used to display the properties of a process selected in Processes view.  
  
 [Thread Properties Dialog Box](../VS_csharp/thread-properties-dialog-box.md)  
 Used to display the properties of a thread selected in Threads view.  
  
 [Other Dialog Boxes](../VS_csharp/other-dialog-boxes.md)  
