...
The increased complexity of modern software applications also increases the difficulty of making the code reliable and maintainable. In recent years, many software measures, known as code metrics, have been developed that can help developers understand where their code needs rework or increased testing.  
 ...
 Developers can use [!INCLUDE[vsprvsts](../VS_csharp/includes/vsprvsts_md.md)] to generate code metrics data that measure the complexity and maintainability of their managed code. Code metrics data can be generated for an entire solution or a single project.  
  
 This section describes how to generate and use code metrics in [!INCLUDE[vsprvs](../VS_csharp/includes/vsprvs_md.md)].  
  
## In This Section  
 [Code Metrics Overview](../VS_csharp/code-metrics-values.md)  
  
 [How to: Calculate Code Metrics Result Data](../VS_csharp/how-to--generate-code-metrics-data.md)  
  
 [Working in the Code Metrics Results Window](../VS_csharp/working-with-code-metrics-data.md)  
...
## See Also  
 [Troubleshooting Code Metrics Issues](../VS_csharp/troubleshooting-code-metrics-issues.md)   
