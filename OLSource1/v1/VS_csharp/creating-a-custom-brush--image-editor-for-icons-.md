...
1.  [Select the part of the image](../VS_csharp/selecting-an-area-of-an-image--image-editor-for-icons-.md) that you want to use for a brush.  
...
3.  From the **Image** menu, choose **Use Selection as Brush**.  
     ...
     **Note** Clicking the **Use a Selection as Brush** without first selecting a portion of the image will use the whole image as a brush. The result of using a custom brush will also depend on whether you've selected an [Opaque or Transparent background](../VS_csharp/choosing-a-transparent-or-opaque-background--image-editor-for-icons-.md).  
...
1.  [Select an opaque or transparent background](../VS_csharp/choosing-a-transparent-or-opaque-background--image-editor-for-icons-.md).  
  
2.  [Set the background color](../VS_csharp/selecting-foreground-or-background-colors--image-editor-for-icons-.md) to the color in which you want to draw.  
