...
-   What you must do to implement them.  
 ...
 The [CDocument](../VS_csharp/cdocument-class.md) (or [COleDocument](../VS_csharp/coledocument-class.md)) class supports objects used to store or control your program's data and provides the basic functionality for programmer-defined document classes. A document represents the unit of data that the user typically opens with the Open command on the File menu and saves with the Save command on the File menu.  
  
 The [CView](../VS_csharp/cview-class.md) (or one of its many derived classes) provides the basic functionality for programmer-defined view classes. A view is attached to a document and acts as an intermediary between the document and the user: the view renders an image of the document on the screen and interprets user input as operations upon the document. The view also renders the image for both printing and print preview.  
  
 [CFrameWnd](../VS_csharp/cframewnd-class.md) (or one of its variations) supports objects that provides the frame around one or more views of a document.  
  
 [CDocTemplate](../VS_csharp/cdoctemplate-class.md) (or [CSingleDocTemplate](../VS_csharp/csingledoctemplate-class.md) or [CMultiDocTemplate](../VS_csharp/cmultidoctemplate-class.md)) supports an object that coordinates one or more existing documents of a given type and manages creating the correct document, view, and frame window objects for that type.  
  
 The following figure shows the relationship between a document and its view.  
  
 ![View is the part of the document that's displayed](../VS_csharp/media/vc379n1.gif "vc379N1")  
Document and View  
...
-   [A portrait of the document/view architecture](../VS_csharp/a-portrait-of-the-document-view-architecture.md)  
  
-   [Advantages of the document/view architecture](../VS_csharp/advantages-of-the-document-view-architecture.md)  
  
-   [Document and view classes created by the Application Wizard](../VS_csharp/document-and-view-classes-created-by-the-mfc-application-wizard.md)  
  
-   [Alternatives to the document/view architecture](../VS_csharp/alternatives-to-the-document-view-architecture.md)  
  
-   [Adding Multiple Views to a Single Document](../VS_csharp/adding-multiple-views-to-a-single-document.md)  
  
-   [Using Documents](../VS_csharp/using-documents.md)  
  
-   [Using Views](../VS_csharp/using-views.md)  
  
-   [Multiple Document Types, Views, and Frame Windows](../VS_csharp/multiple-document-types--views--and-frame-windows.md)  
  
-   [Initializing and cleaning up documents and views](../VS_csharp/initializing-and-cleaning-up-documents-and-views.md)  
  
-   [Initialize your own additions to document & view classes](../VS_csharp/creating-new-documents--windows--and-views.md)  
  
-   [Using database classes with documents and views](../VS_csharp/mfc--using-database-classes-with-documents-and-views.md)  
  
-   [Using database classes without documents and views](../VS_csharp/mfc--using-database-classes-without-documents-and-views.md)  
  
-   [Samples](../VS_csharp/visual-c---samples.md)  
