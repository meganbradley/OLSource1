...
A method used to support the F# query syntax. Indicates that the query should be passed as a quotation to the [Run](../VS_csharp/querybuilder.run--t--method--fsharp-.md) method.  
