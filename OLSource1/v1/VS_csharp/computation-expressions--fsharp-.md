...
## Built-in Workflows  
 Sequence expressions are an example of a computation expression, as are asynchronous workflows and query expressions. For more information, see [Sequences](../VS_csharp/sequences--fsharp-.md), [Asynchronous Workflows](../VS_csharp/asynchronous-workflows--fsharp-.md), and [Query Expressions](../VS_csharp/query-expressions--fsharp-.md).  
