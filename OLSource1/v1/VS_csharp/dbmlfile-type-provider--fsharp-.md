...
## Remarks  
 ...
 For a walkthrough on how to use the `DbmlFile` type provider, see [Walkthrough: Generating F# Types from a DBML File (F#)](../VS_csharp/walkthrough--generating-fsharp-types-from-a-dbml-file--fsharp-.md).  
