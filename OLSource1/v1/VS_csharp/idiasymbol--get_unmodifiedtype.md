...
Retrieves the original type for this symbol. Use when the [SymTagEnum](../VS_csharp/symtagenum.md) is set to a type.  
...
#### Parameters  
 `pRetVal`  
 [out] Returns an [IDiaSymbol](../VS_csharp/idiasymbol.md) object that represents the original type of this symbol.  
