...
##  <a name="vclrftheclosefunctionforinputstreamsanchor15"></a> The close Function for Input Streams  
 The **close** member function closes the disk file associated with an input file stream and frees the operating system file handle. The [ifstream](../VS_csharp/basic_ifstream-class.md) destructor closes the file for you, but you can use the **close** function if you need to open another file for the same stream object.  
