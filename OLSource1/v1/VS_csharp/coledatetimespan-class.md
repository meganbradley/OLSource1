...
## Remarks  
 ...
 `COleDateTimeSpan` is used with its companion class                 [COleDateTime](../VS_csharp/coledatetime-class.md).                 `COleDateTime` encapsulates the                 **DATE** data type of OLE automation.                 `COleDateTime` represents absolute time values. All                 `COleDateTime` calculations involve                 `COleDateTimeSpan` values. The relation between these classes is analogous to the one between                 [CTime](../VS_csharp/ctime-class.md) and                 [CTimeSpan](../VS_csharp/ctimespan-class.md).  
  
 For more information on the                 `COleDateTime` and                 `COleDateTimeSpan` classes, see the article                 [Date and Time: Automation Support](../VS_csharp/date-and-time--automation-support.md).  
...
### Example  
 [!code[NVC_ATLMFC_Utilities#25](../VS_csharp/codesnippet/CPP/coledatetimespan-class_1.cpp)]  
  
 [!code[NVC_ATLMFC_Utilities#26](../VS_csharp/codesnippet/CPP/coledatetimespan-class_2.cpp)]  
...
-   **COleDateTimeSpan(** `lDays`**,** `nHours`**,** `nMins`**,** `nSecs` **)** Constructs a                                 `COleDateTimeSpan` object initialized to the specified numerical values.  
 ...
 For more information about the bounds for                         `COleDateTimeSpan` values, see the article                         [Date and Time: Automation Support](../VS_csharp/date-and-time--automation-support.md).  
  
### Example  
 [!code[NVC_ATLMFC_Utilities#14](../VS_csharp/codesnippet/CPP/coledatetimespan-class_3.cpp)]  
...
### Example  
 [!code[NVC_ATLMFC_Utilities#15](../VS_csharp/codesnippet/CPP/coledatetimespan-class_4.cpp)]  
...
### Example  
 [!code[NVC_ATLMFC_Utilities#16](../VS_csharp/codesnippet/CPP/coledatetimespan-class_5.cpp)]  
...
### Example  
 [!code[NVC_ATLMFC_Utilities#17](../VS_csharp/codesnippet/CPP/coledatetimespan-class_6.cpp)]  
...
### Example  
 [!code[NVC_ATLMFC_Utilities#18](../VS_csharp/codesnippet/CPP/coledatetimespan-class_7.cpp)]  
...
### Example  
 [!code[NVC_ATLMFC_Utilities#19](../VS_csharp/codesnippet/CPP/coledatetimespan-class_8.cpp)]  
...
-   If the status of this object was explicitly set to invalid using                                 `SetStatus`.  
 ...
 For more information about the operations that may set the status to invalid, see                         [COleDateTimeSpan::operator +, -](../VS_csharp/coledatetime-class.md#coledatetime__operator__add_-) and                         [COleDateTimeSpan::operator +=, -=](../VS_csharp/coledatetime-class.md#coledatetime__operator__add_eq_-_eq).  
...
### Example  
 [!code[NVC_ATLMFC_Utilities#20](../VS_csharp/codesnippet/CPP/coledatetimespan-class_9.cpp)]  
...
### Example  
 [!code[NVC_ATLMFC_Utilities#23](../VS_csharp/codesnippet/CPP/coledatetimespan-class_10.cpp)]  
...
### Example  
 [!code[NVC_ATLMFC_Utilities#24](../VS_csharp/codesnippet/CPP/coledatetimespan-class_11.cpp)]  
...
### Example  
 [!code[NVC_ATLMFC_Utilities#21](../VS_csharp/codesnippet/CPP/coledatetimespan-class_12.cpp)]  
...
### Example  
 [!code[NVC_ATLMFC_Utilities#22](../VS_csharp/codesnippet/CPP/coledatetimespan-class_13.cpp)]  
