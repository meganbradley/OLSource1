...
3.  In the [Properties Window](../VS_csharp/properties-window.md), add any of the standard escape sequences listed below to the text in the **Caption** box, and press **ENTER**.  
