...
> [!NOTE]
>  This class is one of MFC's Open Database Connectivity (ODBC) classes. If you are instead using the newer Data Access Objects (DAO) classes, use [CDaoException](../VS_csharp/cdaoexception-class.md) instead. All DAO class names have "CDao" as a prefix. For more information, see the article [Overview: Database Programming](../VS_csharp/data-access-programming--mfc-atl-.md).  
 ...
 For more information about exception handling in general, or about `CDBException` objects, see the articles [Exception Handling (MFC)](../VS_csharp/exception-handling-in-mfc.md) and [Exceptions: Database Exceptions](../VS_csharp/exceptions--database-exceptions.md).  
...
-   **AFX_SQL_ERROR_DATA_TRUNCATED** You requested more data than you have provided storage for. For information on increasing the provided data storage for `CString` or `CByteArray` data types, see the `nMaxLength` argument for [RFX_Text](../VS_csharp/rfx_text.md) and [RFX_Binary](../VS_csharp/rfx_binary.md) under "Macros and Globals."  
...
## See Also  
 ...
 [CFieldExchange](../VS_csharp/cfieldexchange-class.md)   
 [AfxThrowDBException](../VS_csharp/afxthrowdbexception.md)   
 [CRecordset::Update](../VS_csharp/crecordset-class.md#crecordset__update)   
 [CRecordset::Delete](../VS_csharp/crecordset-class.md#crecordset__delete)   
 [CException](../VS_csharp/cexception-class.md)