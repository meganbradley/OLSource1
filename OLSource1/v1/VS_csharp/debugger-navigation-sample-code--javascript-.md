...
The code in this topic is the sample file for the [Quick Start: Debugger navigation (JavaScript)](../VS_csharp/control-execution-of-a-store-app-in-a-visual-studio-debug-session-for-windows-store-apps--javascript-.md) topic.  
