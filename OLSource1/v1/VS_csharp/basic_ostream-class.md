...
---
# basic_ostream Class
This template class describes an object that controls insertion of elements and encoded objects into a stream buffer with elements of type **Elem**, also known as [char_type](../VS_csharp/basic_ios-class.md#basic_ios__char_type), whose character traits are determined by the class **Tr**, also known as [traits_type](../VS_csharp/basic_ios-class.md#basic_ios__traits_type).  
...
```  
 ...
 Both groups of functions call [setstate](../VS_csharp/basic_ios-class.md#basic_ios__setstate)**(badbit)** if they encounter a failure while inserting elements.  
  
 An object of class basic_istream< **Elem**, **Tr**> stores only a virtual public base object of class [basic_ios](../VS_csharp/basic_ios-class.md)**<Elem**,  **Tr>**.  
  
## Example  
 See the example for [basic_ofstream Class](../VS_csharp/basic_ofstream-class.md) to learn more about output streams.  
...
### Remarks  
 The first constructor initializes the base class by calling [init](../VS_csharp/basic_ios-class.md#basic_ios__init)(`_Strbuf`). The second constructor initializes the base class by calling [move](../VS_csharp/basic_ios-class.md#basic_ios__move)`(``_Right``)`.  
  
### Example  
  See the example for [basic_ofstream::basic_ofstream](../VS_csharp/basic_ofstream-class.md#basic_ofstream__basic_ofstream) to learn more about output streams.  
...
### Remarks  
 If [rdbuf](../VS_csharp/basic_ios-class.md#basic_ios__rdbuf) is not a null pointer, the function calls **rdbuf->**[pubsync](../VS_csharp/basic_streambuf-class.md#basic_streambuf__pubsync). If that returns -1, the function calls [setstate](../VS_csharp/basic_ios-class.md#basic_ios__setstate)(**badbit**). It returns **\*this**.  
...
### Remarks  
 The `<ostream>` header also defines several global insertion operators. For more information, see [operator<< (<ostream\>)](../VS_csharp/-ostream--operators.md#operator_lt__lt_).  
  
 The first member function ensures that an expression of the form **ostr << endl** calls [endl](../VS_csharp/-ostream--functions.md#endl)**(ostr)**, and then returns **\*this**. The second and third functions ensure that other manipulators, such as [hex](../VS_csharp/-ios--functions.md#hex), behave similarly. The remaining functions are all formatted output functions.  
...
```  
 ...
 converts _`Val` to a Boolean field and inserts it by calling [use_facet](../VS_csharp/basic_filebuf-class.md#basic_filebuf__open)**<num_put<Elem, OutIt>**`(`[getloc](../VS_csharp/ios_base-class.md#ios_base__getloc)). [put](#basic_ostream__put)(**OutIt**([rdbuf](../VS_csharp/basic_ios-class.md#basic_ios__rdbuf)), **\*this**, `getloc`, **val**). Here, **OutIt** is defined as [ostreambuf_iterator](../VS_csharp/ostreambuf_iterator-class.md)**<Elem, Tr>**. The function returns **\*this**.  
...
### Remarks  
 The nested class describes an object whose declaration structures the formatted output functions and the unformatted output functions. If **ostr.**[good](../VS_csharp/basic_ios-class.md#basic_ios__good) is **true** and **ostr.**[tie](../VS_csharp/basic_ios-class.md#basic_ios__tie) is not a null pointer, the constructor calls **ostr.tie->**[flush](#basic_ostream__flush). The constructor then stores the value returned by **ostr.good** in **status**. A later call to **operator bool** delivers this stored value.  
  
 If `uncaught_exception` returns **false** and [flags](../VS_csharp/ios_base-class.md#ios_base__flags) **&** [unitbuf](../VS_csharp/-ios--functions.md#unitbuf) is nonzero, the destructor calls [flush](#basic_ostream__flush).  
...
### Remarks  
 The member function calls [swap](../VS_csharp/basic_ios-class.md#basic_ios__swap)`(``_Right``)` to exchange the contents of this object for the contents of `_Right`.  
...
### Remarks  
 The [unformatted output function](../VS_csharp/basic_ostream-class.md) inserts the sequence of `_Count` elements beginning at `_Str`.  
  
### Example  
  See [streamsize](../VS_csharp/-ios--typedefs.md#streamsize) for an example using `write`.  
