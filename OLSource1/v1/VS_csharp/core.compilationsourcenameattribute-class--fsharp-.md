...
This attribute is inserted automatically by the F# compiler to tag methods which are given the [CompiledName](../VS_csharp/core.compilednameattribute-class--fsharp-.md) attribute. It is not intended for use from user code.  
...
|Member|Description|  
|------------|-----------------|  
|[new](../VS_csharp/core.compilationsourcenameattribute-constructor--fsharp-.md)|Creates an instance of the attribute.|  
  
## Instance Members  
  
|Member|Description|  
|------------|-----------------|  
|[SourceName](../VS_csharp/compilationsourcenameattribute.sourcename-property--fsharp-.md)|Indicates the name of the entity in F# source code.|  
