...
## Remarks  
 ...
 If your scheduler had any deactivated virtual processor roots, you must activate them using [IVirtualProcessorRoot::Activate](../VS_csharp/ivirtualprocessorroot--activate-method.md), and have the thread proxies executing on them leave the `Dispatch` method of the execution contexts they are dispatching before you invoke `Shutdown` on a scheduler proxy.  
...
## See Also  
 ...
 [ISchedulerProxy::RequestInitialVirtualProcessors Method](../VS_csharp/ischedulerproxy--requestinitialvirtualprocessors-method.md)   
 [ISchedulerProxy::SubscribeCurrentThread Method](../VS_csharp/ischedulerproxy--subscribecurrentthread-method.md)   
 [IExecutionResource::Remove Method](../VS_csharp/iexecutionresource--remove-method.md)