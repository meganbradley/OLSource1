...
> [!NOTE]
>  Do not confuse this kind of custom join operation with the use of multiple `from` clauses to access inner collections. For more information, see [join clause](../VS_csharp/join-clause--csharp-reference-.md).  
...
## See Also  
 ...
 [join clause](../VS_csharp/join-clause--csharp-reference-.md)   
