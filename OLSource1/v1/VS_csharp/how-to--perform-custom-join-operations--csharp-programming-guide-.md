...
> [!NOTE]
>  Do not confuse this kind of custom join operation with the use of multiple `from` clauses to access inner collections. For more information, see [join clause (C# Reference)](../VS_csharp/join-clause--csharp-reference-.md).  
...
## Example  
 ...
 [!code[csProgGuideLINQ#64](../VS_csharp/codesnippet/CSharp/how-to--perform-custom-join-operations--csharp-programming-guide-_1.cs)]  
...
## Example  
 ...
 [!code[csProgGuideLINQ#13](../VS_csharp/codesnippet/CSharp/how-to--perform-custom-join-operations--csharp-programming-guide-_2.cs)]  
  
## Compiling the Code  
  
-   Create a [!INCLUDE[vs_current_short](../VS_csharp/includes/vs_current_short_md.md)] console application project that targets [!INCLUDE[dnprdnshort](../VS_csharp/includes/dnprdnshort_md.md)] 3.5 or later. By default, the project has a reference to System.Core.dll and a `using` directive for the System.Linq namespace.  
  
-   Replace the `Program` class with the code in the previous example.  
  
-   Follow the instructions in [How To: Join Content from Dissimilar Files (LINQ)](../VS_csharp/how-to--join-content-from-dissimilar-files--linq-.md) to set up the data files, scores.csv and names.csv.  
