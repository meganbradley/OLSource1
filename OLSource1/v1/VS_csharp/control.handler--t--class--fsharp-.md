...
A delegate type associated with the F# event type [IEvent](../VS_csharp/control.ievent--t--type-abbreviation--fsharp-.md).  
...
|Member|Description|  
|------------|-----------------|  
|[Invoke](../VS_csharp/handler.invoke--t--method--fsharp-.md)|Calls the function or functions associated with the event handler.|  
