...
The following illustration represents the MFC classes derived from `CObject`:  
 ...
 ![Classes Derived From CObject](../VS_csharp/media/mfc_heirarchy_chart1of3.png "MFC_Heirarchy_Chart1of3")  
  
 The following illustration represents the MFC classes derived from `CWnd` and `CCmdTarget`:  
  
 ![Classes Derived From CCmdTarget or CWnd](../VS_csharp/media/mfc_heirarchy_chart2of3.png "MFC_Heirarchy_Chart2of3")  
  
 The following illustration represents the MFC classes not derived from `CObject`:  
  
 ![Classes Not Derived From CObject](../VS_csharp/media/mfc_heirarchy_chart3of3.png "MFC_Heirarchy_Chart3of3")  
...
## See Also  
 [Hierarchy Chart Categories](../VS_csharp/hierarchy-chart-categories.md)   
 [Class Library Overview](../VS_csharp/class-library-overview.md)