...
|Value|Description|  
|-----------|-----------------|  
|[FromFunction](../VS_csharp/comparisonidentity.fromfunction--t--function--fsharp-.md)  `: ('T -> 'T -> int) -> IComparer<'T>`|Compare using the given comparer function.|  
|[Structural](../VS_csharp/comparisonidentity.structural--t--type-function--fsharp-.md)  `: IComparer<'T>`|Structural comparison. Compare using [Operators.compare](../VS_csharp/operators.compare--t--function--fsharp-.md).|  
