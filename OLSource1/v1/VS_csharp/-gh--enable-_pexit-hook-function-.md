...
```  
 ...
 `_pexit` is similar to `_penter`; see [/Gh (Enable _penter Hook Function)](../VS_csharp/-gh--enable-_penter-hook-function-.md) for an example of how to write a `_pexit` function.  
