...
This article explains how to delete all objects in a collection (without deleting the collection object itself).  
 ...
 To delete all the objects in a collection of `CObject`s (or of objects derived from `CObject`), you use one of the iteration techniques described in the article [Accessing All Members of a Collection](../VS_csharp/accessing-all-members-of-a-collection.md) to delete each object in turn.  
...
3.  Call the `RemoveAll` function to remove all elements from the list after the objects associated with those elements have been deleted.  
 ...
 [!code[NVC_MFCCollections#17](../VS_csharp/codesnippet/CPP/deleting-all-objects-in-a-cobject-collection_1.cpp)]  
...
3.  Call the `RemoveAll` function to remove all elements from the array after they have been deleted.  
     ...
     [!code[NVC_MFCCollections#18](../VS_csharp/codesnippet/CPP/deleting-all-objects-in-a-cobject-collection_2.cpp)]  
...
3.  Call the `RemoveAll` function to remove all elements from the map after they have been deleted.  
     ...
     [!code[NVC_MFCCollections#19](../VS_csharp/codesnippet/CPP/deleting-all-objects-in-a-cobject-collection_3.cpp)]  
