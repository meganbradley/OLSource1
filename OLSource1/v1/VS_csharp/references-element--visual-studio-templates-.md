...
|Element|Description|  
|-------------|-----------------|  
|[Reference](../VS_csharp/reference-element--visual-studio-templates-.md)|Required element.<br /><br /> Specifies the assembly reference to add when the item is added to a project. There must be one or more `Reference` elements in a `References` element.|  
