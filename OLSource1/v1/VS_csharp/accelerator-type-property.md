...
-   If the **Type** property is **ASCII**, the [Modifier](../VS_csharp/accelerator-modifier-property.md) may only be None or Alt, or it can have an accelerator which uses the CTRL key (specified by preceding the key with a ^).  
