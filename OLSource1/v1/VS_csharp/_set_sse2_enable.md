...
-   [atan](../VS_csharp/atan--atanf--atanl--atan2--atan2f--atan2l.md)  
  
-   [ceil](../VS_csharp/ceil--ceilf--ceill.md)  
  
-   [exp](../VS_csharp/exp--expf.md)  
  
-   [floor](../VS_csharp/floor--floorf--floorl.md)  
  
-   [log](../VS_csharp/log--logf--log10--log10f.md)  
  
-   [log10](../VS_csharp/log--logf--log10--log10f.md)  
  
-   [modf](../VS_csharp/modf--modff--modfl.md)  
  
-   [pow](../VS_csharp/pow--powf--powl.md)  
