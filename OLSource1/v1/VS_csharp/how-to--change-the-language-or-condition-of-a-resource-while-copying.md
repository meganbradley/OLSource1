...
1.  In the .rc file or in the [Resource View](../VS_csharp/resource-view-window.md) window, right-click the resource you want to copy.  
...
## See Also  
 [How to: Copy Resources](../VS_csharp/how-to--copy-resources.md)   
