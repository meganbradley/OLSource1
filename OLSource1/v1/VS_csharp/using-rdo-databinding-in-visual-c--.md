...
1.  Configure an [ODBC data source](../VS_csharp/odbc-connections.md), if you have not already done so.  
  
2.  Create an MFC Dialog application or MFC Formview application using the MFC Application Wizard.  
  
3.  Add the Microsoft RemoteData control (RDO RemoteData control) to the dialog box; see [Inserting the Control into a Visual C++ Application](../VS_csharp/inserting-the-control-into-a-visual-c---application.md).  
...
## See Also  
 ...
 [Databinding with ActiveX Controls in Visual C++](../VS_csharp/databinding-with-activex-controls-in-visual-c--.md)