 ...
 *type-parameter-constraints-clauses*  
 This specifies restrictions on the types that may be used as type arguments, and takes the form specified in [Constraints](../VS_csharp/constraints-on-generic-type-parameters--c---cli-.md).  
 ...
 **Remarks**  
 ...
 In [!INCLUDE[vcprvc](../VS_csharp/includes/vcprvc_md.md)], class or struct constructors may not be declared with generic type parameters.  
