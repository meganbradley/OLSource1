...
1.  Define the array as shown by the following code. The array is automatically deleted and its memory reclaimed when the array variable exits its scope.  
     ...
     [!code[NVC_MFC_Utilities#1](../VS_csharp/codesnippet/CPP/memory-management--examples_1.cpp)]  
...
1.  Use the **new** operator with the array syntax shown in this example:  
     ...
     [!code[NVC_MFC_Utilities#2](../VS_csharp/codesnippet/CPP/memory-management--examples_2.cpp)]  
  
#### To deallocate the arrays from the heap  
  
1.  Use the **delete** operator as follows:  
  
     [!code[NVC_MFC_Utilities#3](../VS_csharp/codesnippet/CPP/memory-management--examples_3.cpp)]  
...
1.  Define the structure variable as follows:  
     ...
     [!code[NVC_MFC_Utilities#4](../VS_csharp/codesnippet/CPP/memory-management--examples_4.cpp)]  
...
1.  Use **new** to allocate data structures on the heap and **delete** to deallocate them, as shown by the following examples:  
     ...
     [!code[NVC_MFC_Utilities#5](../VS_csharp/codesnippet/CPP/memory-management--examples_5.cpp)]  
...
1.  Declare the object as follows:  
     ...
     [!code[NVC_MFC_Utilities#6](../VS_csharp/codesnippet/CPP/memory-management--examples_6.cpp)]  
...
1.  Use the **new** operator, which returns a pointer to the object, to allocate objects on the heap. Use the **delete** operator to delete them.  
     ...
     [!code[NVC_MFC_Utilities#7](../VS_csharp/codesnippet/CPP/memory-management--examples_7.cpp)]  
  
     If the argument for the `CPerson` constructor is a pointer to `char`, the statement for frame allocation is:  
  
     [!code[NVC_MFC_Utilities#8](../VS_csharp/codesnippet/CPP/memory-management--examples_8.cpp)]  
  
     The statement for heap allocation is:  
  
     [!code[NVC_MFC_Utilities#9](../VS_csharp/codesnippet/CPP/memory-management--examples_9.cpp)]  
  
## See Also  
 [Memory Management: Heap Allocation](../VS_csharp/memory-management--heap-allocation.md)