...
>  Application Wizard-generated container code uses this class.  
 ...
 For more information, see the                 [OLEUIBUSY](http://msdn.microsoft.com/library/windows/desktop/ms682493) structure in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
  
 For more information on OLE-specific dialog boxes, see the article [Dialog Boxes in OLE](../VS_csharp/dialog-boxes-in-ole.md).  
