...
## Remarks  
 This method is case-insensitive. If a case-sensitive search is needed (for example, in a language such as C++ where names are case-sensitive), use [IDebugEnumField::GetValueFromString](../VS_csharp/idebugenumfield--getvaluefromstring.md).  
  
## See Also  
 [IDebugEnumField](../VS_csharp/idebugenumfield.md)   
 [IDebugEnumField::GetValueFromString](../VS_csharp/idebugenumfield--getvaluefromstring.md)