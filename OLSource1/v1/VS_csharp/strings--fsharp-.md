...
```  
 ...
 [!code[FsLangRef1#1001](../VS_csharp/codesnippet/FSharp/strings--fsharp-_1.fs)]  
  
 You can access individual characters in a string by using array-like syntax, as follows.  
  
 [!code[FsLangRef1#1002](../VS_csharp/codesnippet/FSharp/strings--fsharp-_2.fs)]  
  
 The output is `b`.  
  
 Or you can extract substrings by using array slice syntax, as shown in the following code.  
  
 [!code[FsLangRef1#1003](../VS_csharp/codesnippet/FSharp/strings--fsharp-_3.fs)]  
...
```  
 ...
 [!code[FsLangRef1#1004](../VS_csharp/codesnippet/FSharp/strings--fsharp-_4.fs)]  
...
## String Operators  
 ...
 [!code[FsLangRef1#1006](../VS_csharp/codesnippet/FSharp/strings--fsharp-_5.fs)]  
...
## String Class  
 ...
 [!code[FsLangRef1#1005](../VS_csharp/codesnippet/FSharp/strings--fsharp-_6.fs)]  
  
## String Module  
 Additional functionality for string handling is included in the `String` module in the `FSharp.Core` namespace. For more information, see [Core.String Module](../VS_csharp/core.string-module--fsharp-.md).  
