...
-   [IDebugPointerObject](../VS_csharp/idebugpointerobject.md)  
  
-   [IDebugManagedObject](../VS_csharp/idebugmanagedobject.md)  
  
-   [IEnumDebugObjects](../VS_csharp/ienumdebugobjects.md)  
  
-   [IDebugBinder](../VS_csharp/idebugbinder.md)  
  
 The EE implements [IDebugProperty2](../VS_csharp/idebugproperty2.md). `IDebugProperty2` provides the mechanism for describing the result of an expression evaluation, such as a local variable, a primitive, or an object, to Visual Studio, which then displays the appropriate information in the **Locals**, **Watch**, or **Immediate** window.  
...
## In This Section  
 [Expression Evaluator Implementation Strategy](../VS_csharp/expression-evaluator-implementation-strategy.md)  
