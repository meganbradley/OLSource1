...
-   [Use the OLE Clipboard mechanism](../VS_csharp/clipboard--using-the-ole-clipboard-mechanism.md)  
  
-   [Use the Windows Clipboard mechanism](../VS_csharp/clipboard--using-the-windows-clipboard.md)  
