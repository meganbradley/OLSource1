...
Wraps a smart pointer around a resource that ensures the resource is destroyed automatically when control leaves a block.  
 ...
 The more capable             `unique_ptr` class supersedes             `auto_ptr`. For more information, see             [unique_ptr Class](../VS_csharp/unique_ptr-class.md).  
  
 For more information about             `throw()` and exception handling, see             [Exception Specifications](../VS_csharp/exception-specifications--throw---c---.md).  
...
## See Also  
 ...
 [unique_ptr](../VS_csharp/unique_ptr-class.md)