...
>  For details on further differences between `CComEnumImpl` and `IEnumOnSTLImpl`, see [CComEnumImpl::Init](../Topic/CComEnumImpl::Init.md).  
 ...
 Typically, you will *not* need to create your own enumerator class by deriving from this interface implementation. If you want to use an ATL-supplied enumerator based on an array, it is more common to create an instance of [CComEnum](../VS_csharp/ccomenum-class.md).  
 ...
 For more information, see [ATL Collections and Enumerators](../VS_csharp/atl-collections-and-enumerators.md).  
...
## See Also  
 ...
 [CComEnum Class](../VS_csharp/ccomenum-class.md)   
