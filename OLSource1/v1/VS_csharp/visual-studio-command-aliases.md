...
|------------------|-----------|-------------------|  
|[Print Command](../VS_csharp/print-command.md)|?|Debug.Print|  
|[Quick Watch Command](../VS_csharp/quick-watch-command.md)|??|Debug.Quickwatch|  
|Add New Project|AddProj|File.AddNewProject|  
|[Alias Command](../VS_csharp/alias-command.md)|Alias|Tools.Alias|  
...
|[List Memory Command](../VS_csharp/list-memory-command.md)|d|Debug.ListMemory|  
|[List Memory Command](../VS_csharp/list-memory-command.md) as ANSI|da|Debug.ListMemory /Ansi|  
|[List Memory Command](../VS_csharp/list-memory-command.md) One Byte format|db|Debug.ListMemory /Format:OneByte|  
|[List Memory Command](../VS_csharp/list-memory-command.md) as ANSI with Four Byte format|dc|Debug.ListMemory /Format:FourBytes /Ansi|  
|[List Memory Command](../VS_csharp/list-memory-command.md) Four Byte format|dd|Debug.ListMemory /Format:FourBytes|  
...
|[List Memory Command](../VS_csharp/list-memory-command.md) Float format|df|Debug.ListMemory/Format:Float|  
|Disassembly window|disasm|Debug.Disassembly|  
|[List Memory Command](../VS_csharp/list-memory-command.md) Eight Byte format|dq|Debug.ListMemory /Format:EightBytes|  
|[List Memory Command](../VS_csharp/list-memory-command.md) as Unicode|du|Debug.ListMemory /Unicode|  
|[Evaluate Statement Command](../VS_csharp/evaluate-statement-command.md)|eval|Debug.EvaluateStatement|  
|Exit|Exit|File.Exit|  
|Format Selection|format|Edit.FormatSelection|  
|Full Screen|FullScreen|View.FullScreen|  
|[Start Command](../VS_csharp/start-command.md)|g|Debug.Start|  
|[Go To Command](../VS_csharp/go-to-command.md)|GotoLn|Edit.GoTo|  
...
|[List Call Stack Command](../VS_csharp/list-call-stack-command.md)|kb|Debug.ListCallStack|  
...
|[Log Command Window Output Command](../VS_csharp/log-command-window-output-command.md)|Log|Tools.LogCommandWindowOutput|  
...
|[Set Radix Command](../VS_csharp/set-radix-command.md)|n|Debug.SetRadix|  
|[ShowWebBrowser Command](../VS_csharp/showwebbrowser-command.md)|nav navigate|View.ShowWebBrowser|  
|Next Bookmark|NextBook|Edit.NextBookmark|  
|[New File Command](../VS_csharp/new-file-command.md)|nf|File.NewFile|  
|New Project|np NewProj|File.NewProject|  
|[Open File Command](../VS_csharp/open-file-command.md)|of Open|File.OpenFile|  
|[Open Project Command](../VS_csharp/open-project-command.md)|op|File.OpenProject|  
...
|[Shell Command](../VS_csharp/shell-command.md)|shell|Tools.Shell|  
...
|[List Disassembly Command](../VS_csharp/list-disassembly-command.md)|u|Debug.ListDisassembly|  
...
|[List Threads Command](../VS_csharp/list-threads-command.md)|~ ~*k ~\*kb|Debug.ListThreads Debug.ListTheads /AllThreads|  
