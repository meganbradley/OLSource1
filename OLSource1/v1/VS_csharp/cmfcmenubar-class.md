...
|[CMFCMenuBar::AllowChangeTextLabels](#cmfcmenubar__allowchangetextlabels)|Specifies whether text labels can be shown under images on the toolbar buttons. (Overrides [CMFCToolBar::AllowChangeTextLabels](../VS_csharp/cmfctoolbar-class.md#cmfctoolbar__allowchangetextlabels).)|  
|[CMFCMenuBar::AllowShowOnPaneMenu](#cmfcmenubar__allowshowonpanemenu)|(Overrides `CPane::AllowShowOnPaneMenu`.)|  
|[CMFCMenuBar::CalcFixedLayout](#cmfcmenubar__calcfixedlayout)|Calculates the horizontal size of the toolbar. (Overrides [CMFCToolBar::CalcFixedLayout](../VS_csharp/cmfctoolbar-class.md#cmfctoolbar__calcfixedlayout).)|  
|[CMFCMenuBar::CalcLayout](#cmfcmenubar__calclayout)|(Overrides `CMFCToolBar::CalcLayout`.)|  
|[CMFCMenuBar::CalcMaxButtonHeight](#cmfcmenubar__calcmaxbuttonheight)|Calculates the maximum height of buttons in the toolbar. (Overrides [CMFCToolBar::CalcMaxButtonHeight](../VS_csharp/cmfctoolbar-class.md#cmfctoolbar__calcmaxbuttonheight).)|  
|[CMFCMenuBar::CanBeClosed](#cmfcmenubar__canbeclosed)|Specifies whether a user can close the toolbar. (Overrides [CMFCToolBar::CanBeClosed](../VS_csharp/cmfctoolbar-class.md#cmfctoolbar__canbeclosed).)|  
|[CMFCMenuBar::CanBeRestored](#cmfcmenubar__canberestored)|Determines whether the system can restore a toolbar to its original state after customization. (Overrides [CMFCToolBar::CanBeRestored](../VS_csharp/cmfctoolbar-class.md#cmfctoolbar__canberestored).)|  
...
|[CMFCMenuBar::GetAvailableExpandSize](#cmfcmenubar__getavailableexpandsize)|(Overrides [CPane::GetAvailableExpandSize](../VS_csharp/cpane-class.md#cpane__getavailableexpandsize).)|  
|[CMFCMenuBar::GetColumnWidth](#cmfcmenubar__getcolumnwidth)|Returns the width of the toolbar buttons. (Overrides [CMFCToolBar::GetColumnWidth](../VS_csharp/cmfctoolbar-class.md#cmfctoolbar__getcolumnwidth).)|  
...
|[CMFCMenuBar::GetRowHeight](#cmfcmenubar__getrowheight)|Returns the height of toolbar buttons. (Overrides [CMFCToolBar::GetRowHeight](../VS_csharp/cmfctoolbar-class.md#cmfctoolbar__getrowheight).)|  
...
|[CMFCMenuBar::IsButtonExtraSizeAvailable](#cmfcmenubar__isbuttonextrasizeavailable)|Determines whether the toolbar can display buttons that have extended borders. (Overrides [CMFCToolBar::IsButtonExtraSizeAvailable](../VS_csharp/cmfctoolbar-class.md#cmfctoolbar__isbuttonextrasizeavailable).)|  
...
|[CMFCMenuBar::OnChangeHot](#cmfcmenubar__onchangehot)|Called by the framework when a user selects a button on the toolbar. (Overrides [CMFCToolBar::OnChangeHot](../VS_csharp/cmfctoolbar-class.md#cmfctoolbar__onchangehot).)|  
...
## Remarks  
 ...
 To use a `CMFCMenuBar` object, embed it in the main window frame object. When processing the `WM_CREATE` message, call `CMFCMenuBar::Create` or `CMFCMenuBar::CreateEx`. Regardless of which create function you use, pass in a pointer to the main frame window. Then enable docking by calling [CFrameWndEx::EnableDocking](../VS_csharp/cframewndex-class.md#cframewndex__enabledocking). Dock this menu by calling [CFrameWndEx::DockPane](../VS_csharp/cframewndex-class.md#cframewndex__dockpane).  
  
## Example  
 The following example demonstrates how to use various methods in the `CMFCMenuBar` class. The example shows how to set the style of the pane, enable the customize button, enable a Help box, enable shadows for pop-up menus, and update the menu bar. This code snippet is part of the [IE Demo sample](../VS_csharp/visual-c---samples.md).  
  
 [!code[NVC_MFC_IEDemo#1](../VS_csharp/codesnippet/CPP/cmfcmenubar-class_1.h)]  
[!code[NVC_MFC_IEDemo#3](../VS_csharp/codesnippet/CPP/cmfcmenubar-class_2.cpp)]  
...
##  <a name="cmfcmenubar__create"></a>  CMFCMenuBar::Create  
 Creates a menu control and attaches it to a [CMFCMenuBar](../VS_csharp/cmfcmenubar-class.md) object.  
...
### Remarks  
 ...
 For more information about toolbar styles, see [CBasePane::SetPaneStyle](../VS_csharp/cbasepane-class.md#cbasepane__setpanestyle).  
  
##  <a name="cmfcmenubar__createex"></a>  CMFCMenuBar::CreateEx  
 Creates a [CMFCMenuBar](../VS_csharp/cmfcmenubar-class.md) object with specified extended styles.  
...
### Example  
 The following example demonstrates how to use the `CreateEx` method of the `CMFCMenuBar` class. This code snippet is part of the [IE Demo sample](../VS_csharp/visual-c---samples.md).  
  
 [!code[NVC_MFC_IEDemo#1](../VS_csharp/codesnippet/CPP/cmfcmenubar-class_1.h)]  
[!code[NVC_MFC_IEDemo#2](../VS_csharp/codesnippet/CPP/cmfcmenubar-class_3.cpp)]  
  
##  <a name="cmfcmenubar__createfrommenu"></a>  CMFCMenuBar::CreateFromMenu  
 Initializes a [CMFCMenuBar](../VS_csharp/cmfcmenubar-class.md) object. This method models the `CMFCMenuBar` object after a `HMENU` parameter.  
...
### Remarks  
 The framework loads the default menu for the [CMFCMenuBar](../VS_csharp/cmfcmenubar-class.md) object from the resource file.  
...
##  <a name="cmfcmenubar__gethmenu"></a>  CMFCMenuBar::GetHMenu  
 Retrieves the handle to the menu attached to the [CMFCMenuBar](../VS_csharp/cmfcmenubar-class.md) object.  
...
### Return Value  
 A pointer to a [CFont](../VS_csharp/cfont-class.md) parameter that contains the current menu bar font.  
...
##  <a name="cmfcmenubar__getmenuitem"></a>  CMFCMenuBar::GetMenuItem  
 Retrieves a [CMFCToolBarButton](../VS_csharp/cmfctoolbarbutton-class.md) object on a menu bar based on the item index.  
...
### Return Value  
 Nonzero if the [CMFCMenuBar](../VS_csharp/cmfcmenubar-class.md) object shows recently used menu commands; otherwise 0.  
...
### Return Value  
 Nonzero if the [CMFCMenuBar](../VS_csharp/cmfcmenubar-class.md) displays all commands; otherwise 0.  
  
### Remarks  
 A `CMFCMenuBar` object can be configured to either show all commands or show only a subset of commands. For more information about this feature, see [CMFCMenuBar Class](../VS_csharp/cmfcmenubar-class.md).  
...
##  <a name="cmfcmenubar__isshowallcommandsdelay"></a>  CMFCMenuBar::IsShowAllCommandsDelay  
 Indicates whether the [CMFCMenuBar](../VS_csharp/cmfcmenubar-class.md) object displays all the commands after a short delay.  
...
### Parameters  
 [in] `hMenu`  
 The handle for the menu attached to the [CMFCMenuBar](../VS_csharp/cmfcmenubar-class.md) object.  
...
### Parameters  
 [in] `pButton`  
 A pointer to the [CMFCToolBarButton](../VS_csharp/cmfctoolbarbutton-class.md) object that the user wants to customize.  
...
##  <a name="cmfcmenubar__savestate"></a>  CMFCMenuBar::SaveState  
 Saves the state of the [CMFCMenuBar](../VS_csharp/cmfcmenubar-class.md) object to the Windows registry.  
...
### Remarks  
 Usually, your application does not call `SaveState`. The framework calls this method when the workspace is serialized. For more information, see [CWinAppEx::SaveState](../VS_csharp/cwinappex-class.md#cwinappex__savestate).  
...
##  <a name="cmfcmenubar__setdefaultmenuresid"></a>  CMFCMenuBar::SetDefaultMenuResId  
 Sets the default menu for a [CMFCMenuBar](../VS_csharp/cmfcmenubar-class.md) object based on the resource ID.  
...
### Parameters  
 [in] `pMenuButtonRTC`  
 The [CRuntimeClass](../VS_csharp/cruntimeclass-structure.md) information for a class derived from the [CMFCMenuButton Class](../VS_csharp/cmfcmenubutton-class.md).  
...
### Remarks  
 Two fonts are used for all [CMFCMenuBar](../VS_csharp/cmfcmenubar-class.md) objects. These separate fonts are used for horizontal and vertical menu bars.  
...
### Remarks  
 If a menu does not display all the menu commands, it hides the commands that are rarely used. For more information about displaying menu commands, see [CMFCMenuBar Class](../VS_csharp/cmfcmenubar-class.md).  
  
## See Also  
 [Hierarchy Chart](../VS_csharp/hierarchy-chart.md)   
 [Classes](../VS_csharp/mfc-classes.md)   
 [CMFCToolBar Class](../VS_csharp/cmfctoolbar-class.md)