...
## Remarks  
 ...
 The `CNetAddressCtrl` class is derived from the [CEdit](../VS_csharp/cedit-class.md) class. Consequently, the network address control provides access to all Windows edit control messages.  
 ...
 ![Dialog with a network address control and infotip.](../VS_csharp/media/cnetaddctrl.png "CNetAddCtrl")  
...
## Example  
 ...
 [!code[NVC_MFC_CNetAddressCtrl_s1#1](../VS_csharp/codesnippet/CPP/cnetaddressctrl-class_1.cpp)]  
...
## Example  
 ...
 [!code[NVC_MFC_CNetAddressCtrl_s1#2](../VS_csharp/codesnippet/CPP/cnetaddressctrl-class_2.h)]  
 ...
 **Header:** afxcmn.h  
 ...
 This class is supported in [!INCLUDE[windowsver](../VS_csharp/includes/windowsver_md.md)] and later.  
  
 Additional requirements for this class are described in [Build Requirements for Vista Common Controls](../VS_csharp/build-requirements-for-windows-vista-common-controls.md).  
...
|---------------|-----------------|  
|[in] `dwStyle`|A bitwise combination of styles to be applied to the control. For more information, see [Edit Styles](../VS_csharp/edit-styles.md).|  
...
|[in] `pParentWnd`|A non-null pointer to a [CWnd](../VS_csharp/cwnd-class.md) object that is the parent window of the control.|  
...
|[in] `dwStyle`|A bitwise combination (OR) of styles to be applied to the control. For more information, see [Edit Styles](../VS_csharp/edit-styles.md).|  
|[in] `rect`|A reference to a                                         [RECT](http://msdn.microsoft.com/library/windows/desktop/dd162897) structure that contains the position and size of the control.|  
|[in] `pParentWnd`|A non-null pointer to a [CWnd](../VS_csharp/cwnd-class.md) object that is the parent window of the control.|  
|[in] `nID`|The ID of the control.|  
...
### Remarks  
 ...
 This message invokes the                         [NetAddr_DisplayErrorTip](http://msdn.microsoft.com/library/windows/desktop/bb774314) macro, which is described in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)]. That macro sends the `NCM_DISPLAYERRORTIP` message.  
...
### Remarks  
 ...
 This method invokes the                         [NetAddr_GetAddress](http://msdn.microsoft.com/library/windows/desktop/bb774316) macro, which is described in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)]. That macro sends the `NCM_GETADDRESS` message.  
...
### Remarks  
 This message invokes the                         [NetAddr_GetAllowType](http://msdn.microsoft.com/library/windows/desktop/bb774318) macro, which is described in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)]. That macro sends the `NCM_GETALLOWTYPE` message.  
...
### Remarks  
 ...
 This message invokes the                         [NetAddr_SetAllowType](http://msdn.microsoft.com/library/windows/desktop/bb774320) macro, which is described in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)]. That macro sends the `NCM_SETALLOWTYPE` message.  
  
## See Also  
 [CNetAddressCtrl Class](../VS_csharp/cnetaddressctrl-class.md)   
 [Hierarchy Chart](../VS_csharp/hierarchy-chart.md)   
 [CEdit Class](../VS_csharp/cedit-class.md)