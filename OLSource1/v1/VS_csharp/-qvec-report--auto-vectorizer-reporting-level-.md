...
Enables the reporting feature of the compiler [Auto-Vectorizer](../VS_csharp/auto-parallelization-and-auto-vectorization.md) and specifies the level of informational messages for output during compilation.  
 ...
 **/Qvec-report:2**  
 ...
 For information about reason codes and messages, see [Vectorizer/Parallelizer Messages](../VS_csharp/vectorizer-and-parallelizer-messages.md).  
