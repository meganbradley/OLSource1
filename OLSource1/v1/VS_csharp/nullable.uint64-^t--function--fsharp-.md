...
Converts the argument to unsigned 64-bit integer ([uint64](../VS_csharp/core.uint64-type-abbreviation--fsharp-.md)). This is a direct conversion for all primitive numeric types. The operation requires an appropriate static conversion method on the input type.  
...
## See Also  
 ...
 [Operators.uint64<^T> Function (F#)](../VS_csharp/operators.uint64-^t--function--fsharp-.md)