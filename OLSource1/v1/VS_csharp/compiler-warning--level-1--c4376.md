...
access specifier 'old_specifier:' is no longer supported: please use 'new_specifier:' instead  
 ...
 For more information on specifying type and member accessibility in metadata, see [Type Visibility](../VS_csharp/how-to--define-and-consume-classes-and-structs--c---cli-.md#BKMK_Type_visibility) and [Member Visibility](../VS_csharp/how-to--define-and-consume-classes-and-structs--c---cli-.md#BKMK_Member_visibility) in [How to: Define and Consume Classes and Structs](../VS_csharp/how-to--define-and-consume-classes-and-structs--c---cli-.md).  
