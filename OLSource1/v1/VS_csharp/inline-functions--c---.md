...
-   Functions that are referred to through a pointer elsewhere in the translation unit.  
 ...
 The [/Ob](../VS_csharp/-ob--inline-function-expansion-.md) compiler optimization option helps to determine whether inline function expansion actually occurs.  
  
 [/LTCG](../VS_csharp/-ltcg--link-time-code-generation-.md) performs cross-module inlining regardless of whether it was requested in source code.  
...
-   The function is recursive and not accompanied by **#pragma inline_recursion(on)**. With the pragma, recursive functions are inlined to a default depth of 16 calls. To reduce the inlining depth, use [inline_depth](../VS_csharp/inline_depth.md) pragma.  
...
-   The function is also marked with the [naked](../VS_csharp/naked--c---.md) [__declspec](../VS_csharp/__declspec.md) modifier.  
  
 If the compiler cannot inline a function declared with `__forceinline`, it generates a level 1 warning.  
  
 Recursive functions can be substituted inline to a depth specified by the [inline_depth](../VS_csharp/inline_depth.md) pragma, up to a maximum of 16 calls. After that depth, recursive function calls are treated as calls to an instance of the function.  The depth to which recursive functions are examined by the inline heuristic cannot exceed 16. The [inline_recursion](../VS_csharp/inline_recursion.md) pragma controls the inline expansion of a function currently under expansion. See the [Inline-Function Expansion](../VS_csharp/-ob--inline-function-expansion-.md) (/Ob) compiler option for related information.  
  
### END Microsoft Specific  
 For more information on using the **inline** specifier, see:  
  
-   [Inline Class Member Functions](../VS_csharp/inline-functions--c---.md)  
...
-   [Defining Inline C++ Functions with dllexport and dllimport](../VS_csharp/defining-inline-c---functions-with-dllexport-and-dllimport.md)  
...
**Sample Output: `A`**   
## See Also  
 [noinline](../VS_csharp/noinline.md)   
 [auto_inline](../VS_csharp/auto_inline.md)