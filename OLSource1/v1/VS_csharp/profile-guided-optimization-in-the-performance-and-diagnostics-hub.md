...
2.  In the **Configuration Manager** dialog box, choose the **Active Solution Configuration** drop-down button and select **Release**. Choose the **Close** button.  
 ...
 ![PGO in the Performance and Diagnostics Hub](../VS_csharp/media/pgofig0hub.png "PGOFig0Hub")  
  
 In **Available Tools**, select the **Profile Guided Optimization** check box. Choose the **Start** button to start the PGO plug-in.  
  
 ![PGO introduction page](../VS_csharp/media/pgofig1start.png "PGOFig1Start")  
 ...
 ![PGO instrumentation page](../VS_csharp/media/pgofig2instrument.png "PGOFig2Instrument")  
 ...
 ![PGO instrumented build page](../VS_csharp/media/pgofig3build.PNG "PGOFig3Build")  
 ...
 ![PGO training page](../VS_csharp/media/pgofig4training.PNG "PGOFig4Training")  
 ...
 ![PGO analysis page](../VS_csharp/media/pgofig5analyze.png "PGOFig5Analyze")  
 ...
 ![PGO data file in Solution Explorer](../VS_csharp/media/pgofig6data.png "PGOFig6Data")  
 ...
 ![PGO output diagnostics](../VS_csharp/media/pgofig7diagnostics.png "PGOFig7Diagnostics")  
