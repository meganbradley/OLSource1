...
> [!NOTE]
>  This method is obsolete: do not use ([!INCLUDE[vsprvs](../VS_csharp/includes/vsprvs_md.md)] always returns `E_NOTIMPL` if this method is called). It is retained for historical reasons.  
...
## Remarks  
 [!INCLUDE[vsprvs](../VS_csharp/includes/vsprvs_md.md)] always returns `E_NOTIMPL` if this method is called.  
