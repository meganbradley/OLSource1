...
#### Parameters  
 ...
 `initializer`  
 Type: [int](../VS_csharp/core.int-type-abbreviation--fsharp-.md) `->` [string](../VS_csharp/core.string-type-abbreviation--fsharp-.md)  
...
## Example  
 ...
 [!code[FsStrings#5](../VS_csharp/codesnippet/FSharp/string.init-function--fsharp-_1.fs)]  
