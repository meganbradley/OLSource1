...
#### Parameters  
 *rString*  
 -   Reference to a [CString](../VS_csharp/using-cstring.md) object that will receive an individual substring.  
...
## Example  
 [!code[NVC_MFC_Utilities#48](../VS_csharp/codesnippet/CPP/afxextractsubstring_1.cpp)]  
