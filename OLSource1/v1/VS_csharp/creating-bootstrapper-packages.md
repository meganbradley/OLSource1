...
## Creating Custom Packages  
 You can generate the manifests by using the XML Editor in Visual Studio. For more information, see [How to: Create a Product Manifest](../VS_csharp/how-to--create-a-package-manifest.md) and [How to: Create a Package Manifest](../VS_csharp/how-to--create-a-product-manifest.md). To see an example of creating a bootstrapper package, see [Walkthrough: Creating a Custom Bootstrapper to Show a Privacy Prompt](../VS_csharp/walkthrough--creating-a-custom-bootstrapper-to-show-a-privacy-prompt.md).  
...
-   The package manifest, package.xml, which contains language-specific metadata; it typically contains localized error messages. A component must have at least one package manifest for each localized version of that component.  
 ...
 Finally, copy the redistributable files into the bootstrapper folder location. For more information, see [How to: Create a Localized Bootstrapper Package](../VS_csharp/how-to--create-a-localized-bootstrapper-package.md).  
...
## See Also  
 ...
 [Prerequisites Dialog Box](../VS_csharp/prerequisites-dialog-box.md)   
