...
## Handling Exceptions  
 Typically, code snippet Try…Catch blocks catch and rethrow all exceptions. That may not be the right choice for your project. For each exception, there are several ways to respond. For examples, see [How to: Handle an Exception Using try/catch](../VS_csharp/how-to--handle-an-exception-using-try-catch--csharp-programming-guide-.md) and [Try...Catch...Finally Statement (Visual Basic)](../VS_csharp/try...catch...finally-statement--visual-basic-.md).  
...
-   Passing data to scripting technologies  
 ...
 For more information, see [Securing Applications](../VS_csharp/securing-applications.md).  
...
## See Also  
 [Visual Basic IntelliSense Code Snippets](../VS_csharp/visual-basic-intellisense-code-snippets.md)   
 [Securing Applications](../VS_csharp/securing-applications.md)   
