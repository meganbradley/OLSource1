...
---
# CDocablePane_copy
Similar to a Windows             [RECT](../VS_csharp/rect-structure.md) structure.  
...
>  This class is derived from the                     **tagRECT** structure. (The name                     **tagRECT** is a less-commonly-used name for the                     `RECT` structure.) This means that the data members (                    **left**,                     **top**,                     **right**, and                     **bottom**) of the                     `RECT` structure are accessible data members of                     `CRect`.  
 ...
 When using overloaded                 `CRect` operators, the first operand must be a                 `CRect`; the second can be either a                 [RECT](../VS_csharp/rect-structure.md) structure or a                 `CRect` object.  
  
> [!NOTE]
>  For more information on shared utility classes (like                     `CRect`), see                     [Shared Classes](../VS_csharp/atl-mfc-shared-classes.md).  
...
##  <a name="crect__bottomright"></a>  CRect::BottomRight  
 The coordinates are returned as a reference to a                 [CPoint](../VS_csharp/cpoint-class.md) object that is contained in                 `CRect`.  
...
### Example  
 [!code[NVC_ATLMFC_Utilities#35](../VS_csharp/codesnippet/CPP/cdocablepane_copy_1.cpp)]  
...
### Example  
 [!code[NVC_ATLMFC_Utilities#36](../VS_csharp/codesnippet/CPP/cdocablepane_copy_2.cpp)]  
...
### Parameters  
 `lpSrcRect`  
 Points to the                                 [RECT](../VS_csharp/rect-structure.md) structure or                                 `CRect` object that is to be copied.  
  
### Example  
 [!code[NVC_ATLMFC_Utilities#37](../VS_csharp/codesnippet/CPP/cdocablepane_copy_3.cpp)]  
 ...
 *srcRect*  
 Refers to the                                 [RECT](../VS_csharp/rect-structure.md) structure with the coordinates for                                 `CRect`.  
...
### Example  
 [!code[NVC_ATLMFC_Utilities#38](../VS_csharp/codesnippet/CPP/cdocablepane_copy_4.cpp)]  
 ...
 *y*  
 ...
 `size`  
 A                                 [SIZE](http://msdn.microsoft.com/library/windows/desktop/dd145106) or                                 [CSize](../VS_csharp/csize-class.md) that specifies the number of units to deflate                                 `CRect`. The                                 `cx` value specifies the number of units to deflate the left and right sides and the                                 `cy` value specifies the number of units to deflate the top and bottom.  
  
 `lpRect`  
 Points to a                                 [RECT](../VS_csharp/rect-structure.md) structure or                                 `CRect` that specifies the number of units to deflate each side.  
...
### Example  
 [!code[NVC_ATLMFC_Utilities#39](../VS_csharp/codesnippet/CPP/cdocablepane_copy_5.cpp)]  
...
### Parameters  
 `lpRect`  
 Points to a                                 [RECT](../VS_csharp/rect-structure.md) structure or                                 `CRect` object that contains the upper-left and lower-right corner coordinates of a rectangle.  
...
### Example  
 [!code[NVC_ATLMFC_Utilities#40](../VS_csharp/codesnippet/CPP/cdocablepane_copy_6.cpp)]  
...
### Example  
 [!code[NVC_ATLMFC_Utilities#41](../VS_csharp/codesnippet/CPP/cdocablepane_copy_7.cpp)]  
 ...
 *y*  
 ...
 `size`  
 A                                 [SIZE](http://msdn.microsoft.com/library/windows/desktop/dd145106) or                                 [CSize](../VS_csharp/csize-class.md) that specifies the number of units to inflate                                 `CRect`. The                                 `cx` value specifies the number of units to inflate the left and right sides and the                                 `cy` value specifies the number of units to inflate the top and bottom.  
  
 `lpRect`  
 Points to a                                 [RECT](../VS_csharp/rect-structure.md) structure or                                 `CRect` that specifies the number of units to inflate each side.  
...
### Example  
 [!code[NVC_ATLMFC_Utilities#42](../VS_csharp/codesnippet/CPP/cdocablepane_copy_8.cpp)]  
...
### Parameters  
 `lpRect1`  
 Points to a                                 [RECT](../VS_csharp/rect-structure.md) structure or                                 `CRect` object that contains a source rectangle.  
...
### Example  
 [!code[NVC_ATLMFC_Utilities#43](../VS_csharp/codesnippet/CPP/cdocablepane_copy_9.cpp)]  
...
### Example  
 [!code[NVC_ATLMFC_Utilities#44](../VS_csharp/codesnippet/CPP/cdocablepane_copy_10.cpp)]  
...
### Example  
 [!code[NVC_ATLMFC_Utilities#45](../VS_csharp/codesnippet/CPP/cdocablepane_copy_11.cpp)]  
...
### Example  
 [!code[NVC_ATLMFC_Utilities#46](../VS_csharp/codesnippet/CPP/cdocablepane_copy_12.cpp)]  
...
### Example  
 [!code[NVC_ATLMFC_Utilities#47](../VS_csharp/codesnippet/CPP/cdocablepane_copy_13.cpp)]  
...
### Example  
 [!code[NVC_ATLMFC_Utilities#48](../VS_csharp/codesnippet/CPP/cdocablepane_copy_14.cpp)]  
...
### Example  
 [!code[NVC_ATLMFC_Utilities#49](../VS_csharp/codesnippet/CPP/cdocablepane_copy_15.cpp)]  
 ...
 *y*  
 ...
 `point`  
 Contains a                                 [POINT](../VS_csharp/point-structure.md) structure or                                 [CPoint](../VS_csharp/cpoint-class.md) object specifying both dimensions by which to move.  
  
 `size`  
 Contains a                                 [SIZE](http://msdn.microsoft.com/library/windows/desktop/dd145106) structure or                                 [CSize](../VS_csharp/csize-class.md) object specifying both dimensions by which to move.  
...
### Example  
 [!code[NVC_ATLMFC_Utilities#50](../VS_csharp/codesnippet/CPP/cdocablepane_copy_16.cpp)]  
  
##  <a name="crect__operator_lpcrect"></a>  CRect::operator LPCRECT  
 Converts a                 `CRect` to an                 [LPCRECT](../VS_csharp/data-types--mfc-.md).  
...
### Example  
 [!code[NVC_ATLMFC_Utilities#58](../VS_csharp/codesnippet/CPP/cdocablepane_copy_17.cpp)]  
  
##  <a name="crect__operator_lprect"></a>  CRect::operator LPRECT  
 Converts a                 `CRect` to an                 [LPRECT](../VS_csharp/data-types--mfc-.md).  
...
### Parameters  
 *srcRect*  
 Refers to a source rectangle. Can be a                                 [RECT](../VS_csharp/rect-structure.md) or                                 `CRect`.  
  
### Example  
 [!code[NVC_ATLMFC_Utilities#59](../VS_csharp/codesnippet/CPP/cdocablepane_copy_18.cpp)]  
...
### Example  
 [!code[NVC_ATLMFC_Utilities#60](../VS_csharp/codesnippet/CPP/cdocablepane_copy_19.cpp)]  
...
### Example  
 [!code[NVC_ATLMFC_Utilities#61](../VS_csharp/codesnippet/CPP/cdocablepane_copy_20.cpp)]  
...
### Parameters  
 `point`  
 A                                 [POINT](../VS_csharp/point-structure.md) structure or                                 [CPoint](../VS_csharp/cpoint-class.md) object that specifies the number of units to move the rectangle.  
  
 `size`  
 A                                 [SIZE](http://msdn.microsoft.com/library/windows/desktop/dd145106) structure or                                 [CSize](../VS_csharp/csize-class.md) object that specifies the number of units to move the rectangle.  
  
 `lpRect`  
 Points to a                                 [RECT](../VS_csharp/rect-structure.md) structure or                                 `CRect` object that contains the number of units to inflate each side of                                 `CRect`.  
...
### Example  
 [!code[NVC_ATLMFC_Utilities#62](../VS_csharp/codesnippet/CPP/cdocablepane_copy_21.cpp)]  
...
### Parameters  
 ...
 `lpRect`  
 Points to a                                 [RECT](../VS_csharp/rect-structure.md) structure or                                 `CRect` object that contains the number of units to deflate each side of                                 `CRect`.  
...
### Example  
 [!code[NVC_ATLMFC_Utilities#63](../VS_csharp/codesnippet/CPP/cdocablepane_copy_22.cpp)]  
...
### Parameters  
 `rect`  
 Contains a                                 [RECT](../VS_csharp/rect-structure.md) or                                 `CRect`.  
...
### Parameters  
 `rect`  
 Contains a                                 `CRect` or                                 [RECT](../VS_csharp/rect-structure.md).  
...
### Example  
 [!code[NVC_ATLMFC_Utilities#64](../VS_csharp/codesnippet/CPP/cdocablepane_copy_23.cpp)]  
...
### Parameters  
 `point`  
 A                                 [POINT](../VS_csharp/point-structure.md) structure or                                 [CPoint](../VS_csharp/cpoint-class.md) object that specifies the number of units to move the return value.  
  
 `size`  
 A                                 [SIZE](http://msdn.microsoft.com/library/windows/desktop/dd145106) structure or                                 [CSize](../VS_csharp/csize-class.md) object that specifies the number of units to move the return value.  
  
 `lpRect`  
 Points to a                                 [RECT](../VS_csharp/rect-structure.md) structure or                                 `CRect` object that contains the number of units to inflate each side of the return value.  
...
### Example  
 [!code[NVC_ATLMFC_Utilities#65](../VS_csharp/codesnippet/CPP/cdocablepane_copy_24.cpp)]  
...
### Parameters  
 `point`  
 A                                 [POINT](../VS_csharp/point-structure.md) structure or                                 `CPoint` object that specifies the number of units to move the return value.  
 ...
 `lpRect`  
 Points to a                                 [RECT](../VS_csharp/rect-structure.md) structure or                                 `CRect` object that contains the number of units to deflate each side of the return value.  
...
### Example  
 [!code[NVC_ATLMFC_Utilities#66](../VS_csharp/codesnippet/CPP/cdocablepane_copy_25.cpp)]  
...
### Example  
 [!code[NVC_ATLMFC_Utilities#67](../VS_csharp/codesnippet/CPP/cdocablepane_copy_26.cpp)]  
...
### Example  
 [!code[NVC_ATLMFC_Utilities#68](../VS_csharp/codesnippet/CPP/cdocablepane_copy_27.cpp)]  
...
### Parameters  
 `point`  
 Contains a                                 [POINT](../VS_csharp/point-structure.md) structure or                                 [CPoint](../VS_csharp/cpoint-class.md) object.  
...
### Example  
 [!code[NVC_ATLMFC_Utilities#51](../VS_csharp/codesnippet/CPP/cdocablepane_copy_28.cpp)]  
...
### Example  
 [!code[NVC_ATLMFC_Utilities#52](../VS_csharp/codesnippet/CPP/cdocablepane_copy_29.cpp)]  
...
### Example  
 [!code[NVC_ATLMFC_Utilities#53](../VS_csharp/codesnippet/CPP/cdocablepane_copy_30.cpp)]  
...
### Return Value  
 A                         [CSize](../VS_csharp/csize-class.md) object that contains the size of                         `CRect`.  
...
### Example  
 [!code[NVC_ATLMFC_Utilities#54](../VS_csharp/codesnippet/CPP/cdocablepane_copy_31.cpp)]  
...
### Parameters  
 `lpRectSrc1`  
 Points to the                                 [RECT](../VS_csharp/rect-structure.md) structure or                                 `CRect` object from which a rectangle is to be subtracted.  
...
### Example  
 [!code[NVC_ATLMFC_Utilities#55](../VS_csharp/codesnippet/CPP/cdocablepane_copy_32.cpp)]  
...
### Parameters  
 `lpRect1`  
 Points to a                                 [RECT](../VS_csharp/rect-structure.md) or                                 `CRect` that contains a source rectangle.  
...
### Example  
 [!code[NVC_ATLMFC_Utilities#56](../VS_csharp/codesnippet/CPP/cdocablepane_copy_33.cpp)]  
...
### Example  
 [!code[NVC_ATLMFC_Utilities#57](../VS_csharp/codesnippet/CPP/cdocablepane_copy_34.cpp)]  
  
## See Also  
 [Hierarchy Chart](../VS_csharp/hierarchy-chart.md)   
 [CPoint](../VS_csharp/cpoint-class.md)   
 [CSize](../VS_csharp/csize-class.md)   
 [RECT](../VS_csharp/rect-structure.md)