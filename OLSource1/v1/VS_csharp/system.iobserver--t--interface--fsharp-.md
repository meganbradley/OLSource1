...
|Member|Description|  
|------------|-----------------|  
|[OnCompleted](../VS_csharp/iobserver.oncompleted--t--method--fsharp-.md)|Notify an observer that no more results will be produced|  
|[OnError](../VS_csharp/iobserver.onerror--t--method--fsharp-.md)|Notify an observer of an error|  
|[OnNext](../VS_csharp/iobserver.onnext--t--method--fsharp-.md)|Notify an observer of a new result|  
