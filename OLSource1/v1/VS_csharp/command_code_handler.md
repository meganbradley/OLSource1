...
---
# COMMAND_CODE_HANDLER
Similar to [COMMAND_HANDLER](../VS_csharp/command_handler.md), but maps a [WM_COMMAND](http://msdn.microsoft.com/library/windows/desktop/ms647591) message based only on the notification code.  
