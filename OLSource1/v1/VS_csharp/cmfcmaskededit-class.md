...
|`CMFCMaskedEdit::GetThisClass`|Used by the framework to obtain a pointer to the [CRuntimeClass](../VS_csharp/cruntimeclass-structure.md) object that is associated with this class type.|  
...
## Example  
 The following example demonstrates how to set up a mask (for example a phone number) by using the `EnableMask` method to create the mask for the masked edit control, the `SetValidChars` method to specify a string of valid characters that the user can enter, and `SetWindowText` method to display a prompt in the masked edit control. This example is part of the [New Controls sample](../VS_csharp/visual-c---samples.md).  
  
 [!code[NVC_MFC_NewControls#11](../VS_csharp/codesnippet/CPP/cmfcmaskededit-class_1.h)]  
[!code[NVC_MFC_NewControls#12](../VS_csharp/codesnippet/CPP/cmfcmaskededit-class_2.cpp)]  
...
## Inheritance Hierarchy  
 ...
 [CMFCMaskedEdit](../VS_csharp/cmfcmaskededit-class.md)  
...
### Remarks  
 ...
 This method redefines [CWnd::GetWindowText](../VS_csharp/cwnd-class.md#cwnd__getwindowtext).  
...
### Remarks  
 ...
 This method redefines [CWnd::SetWindowText](../VS_csharp/cwnd-class.md#cwnd__setwindowtext).  
