...
## Remarks  
 ...
 If the extents of the source and destination objects do not match, a [runtime_exception](../VS_csharp/runtime_exception-class.md) is thrown.  
  
 You can copy to [array](../VS_csharp/array-class.md) and [array_view](../VS_csharp/array_view-class.md) objects from the following sources:  
