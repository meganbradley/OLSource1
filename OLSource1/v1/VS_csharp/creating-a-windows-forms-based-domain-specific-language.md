...
You can use Windows Forms to display the state of a domain-specific language (DSL) model, instead of using a DSL diagram. This topic walks you through binding a Windows Form to a DSL, using the [!INCLUDE[vsprvs](../VS_csharp/includes/vsprvs_md.md)] Visualization and Modeling SDK.  
  
 ![DSL&#45;Wpf&#45;2](../VS_csharp/media/dsl-wpf-2.png "DSL-Wpf-2")  
...
2.  Experiment with the initial example that the template provides:  
 ...
 In the main instance of [!INCLUDE[vsprvs](../VS_csharp/includes/vsprvs_md.md)], notice the following points about the DSL solution:  
...
## Updating the DSL Definition  
 ...
 ![DSL&#45;Wpf&#45;1](../VS_csharp/media/dsl-wpf-1.png "DSL-Wpf-1")  
...
2.  Choose **Object**, **Next**.  
     ...
     ![DslWpf&#45;3](../VS_csharp/media/dslwpf-3.png "DslWpf-3")  
...
-   It ensures that, when the user selects a row, the Properties window displays the properties of the corresponding model element, instead of the data grid row.  
 ...
 ![DslWpf4](../VS_csharp/media/dslwpf4.png "DslWpf4")  
...
```  
 ...
 Therefore we recommend that you use <xref:Microsoft.VisualStudio.Modeling.ElementOperations*> to create new elements. For more information, see [Customizing Element Creation and Pasting](../VS_csharp/customizing-element-creation-and-movement.md).  
