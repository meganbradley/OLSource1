...
A [delegate](../VS_csharp/delegate--csharp-reference-.md) is a type that safely encapsulates a method, similar to a function pointer in C and C++. Unlike C function pointers, delegates are object-oriented, type safe, and secure. The type of a delegate is defined by the name of the delegate. The following example declares a delegate named `Del` that can encapsulate a method that takes a [string](../VS_csharp/string--csharp-reference-.md) as an argument and returns [void](../VS_csharp/void--csharp-reference-.md):  
 ...
 [!code[csProgGuideDelegates#24](../VS_csharp/codesnippet/CSharp/using-delegates--csharp-programming-guide-_4.cs)]  
  
 You can then pass the delegate created above to that method:  
  
 [!code[csProgGuideDelegates#25](../VS_csharp/codesnippet/CSharp/using-delegates--csharp-programming-guide-_5.cs)]  
 ...
 [!code[csProgGuideDelegates#26](../VS_csharp/codesnippet/CSharp/using-delegates--csharp-programming-guide-_6.cs)]  
 ...
 [!code[csProgGuideDelegates#27](../VS_csharp/codesnippet/CSharp/using-delegates--csharp-programming-guide-_7.cs)]  
 ...
 [!code[csProgGuideDelegates#28](../VS_csharp/codesnippet/CSharp/using-delegates--csharp-programming-guide-_8.cs)]  
 ...
 [!code[csProgGuideDelegates#29](../VS_csharp/codesnippet/CSharp/using-delegates--csharp-programming-guide-_9.cs)]  
 ...
 [!code[csProgGuideDelegates#30](../VS_csharp/codesnippet/CSharp/using-delegates--csharp-programming-guide-_10.cs)]  
  
## See Also  
 [C# Programming Guide](../VS_csharp/csharp-programming-guide.md)   
 [Delegates (C# Programming Guide)](../VS_csharp/delegates--csharp-programming-guide-.md)   
 [Covariance and Contravariance in Delegates (C# Programming Guide)](../VS_csharp/using-variance-in-delegates--csharp-and-visual-basic-.md)   
 [Variance in Generic Delegates](../VS_csharp/variance-in-delegates--csharp-and-visual-basic-.md)   
 [Using Covariance and Contravariance for Func and Action Generic Delegates](../VS_csharp/using-variance-for-func-and-action-generic-delegates--csharp-and-visual-basic-.md)   
