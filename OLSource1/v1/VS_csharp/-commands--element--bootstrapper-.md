...
---
# &lt;Commands&gt; Element (Bootstrapper)
The `Commands` element implements tests described by the elements underneath the `InstallChecks` element, and declares which package the [!INCLUDE[ndptecclick](../VS_csharp/includes/ndptecclick_md.md)] bootstrapper should install if the test fails.  
...
|Attribute|Description|  
|---------------|-----------------|  
|`Property`|Required. The name of the property to test. The property must previously have been defined by a child of the `InstallChecks` element. For more information, see [<InstallChecks\> Element (ClickOnce BootStrapper)](../VS_csharp/-installchecks--element--bootstrapper-.md).|  
...
## See Also  
 ...
 [<InstallChecks\> Element (ClickOnce BootStrapper)](../VS_csharp/-installchecks--element--bootstrapper-.md)