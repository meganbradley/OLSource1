...
'function' : no suitable method found to override  
 ...
 A method was marked as an override, but the compiler found no method to override. For more information, see [override (C# Programmer's Reference)](../VS_csharp/override--csharp-reference-.md), and [Knowing When to Use Override and New Keywords (C# Programmer's Reference)](../VS_csharp/knowing-when-to-use-override-and-new-keywords--csharp-programming-guide-.md).  
