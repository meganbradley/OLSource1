...
##  <a name="ChildRuleSetChangesInPreviousVersions"></a> Changes in a Visual Studio 2010 Rule Set Are Not Reflected in Previous Visual Studio Versions  
 When you create a rule set in [!INCLUDE[vs_dev10_long](../VS_csharp/includes/vs_dev10_long_md.md)] that contains a child rule set, a change to the child rule set might not be applied in code analysis runs on computers that use an earlier version of Visual Studio. To resolve this issue, you must force a rewrite of the parent rule set, that is the rule set that contains the child rule set.  
  
1.  Open the parent rule set in [!INCLUDE[vs_dev10_long](../VS_csharp/includes/vs_dev10_long_md.md)].  
...
## See Also  
 [Analyzing Application Quality by Using Code Analysis Tools](../VS_csharp/analyzing-application-quality-by-using-code-analysis-tools.md)   
 [Analyzing Managed Code Quality By Using Code Analysis](../VS_csharp/analyzing-managed-code-quality-by-using-code-analysis.md)   
 [Using Rule Sets to Specify Managed Code Analysis Rules](../VS_csharp/using-rule-sets-to-group-code-analysis-rules.md)