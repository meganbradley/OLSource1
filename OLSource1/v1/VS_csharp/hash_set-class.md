 ...
 **allocator_type** is a synonym for the template parameter `Allocator`.  
 ...
 For more information on `Allocator`, see the Remarks section of the [hash_set Class](../VS_csharp/hash_set-class.md) topic.  
...
### Return Value  
 A const bidirectional iterator addressing the first element in the [hash_set](../VS_csharp/hash_set-class.md) or the location succeeding an empty `hash_set`.  
...
### Return Value  
 A const bidirectional iterator that addresses the location succeeding the last element in a [hash_set](../VS_csharp/hash_set-class.md). If the `hash_set` is empty, then `hash_set::cend == hash_set::begin`.  
...
### Return Value  
 A const reverse bidirectional iterator addressing the first element in a reversed [hash_set](../VS_csharp/hash_set-class.md) or addressing what had been the last element in the unreversed `hash_set`.  
...
### Return Value  
 A const reverse bidirectional iterator that addresses the location succeeding the last element in a reversed [hash_set](../VS_csharp/hash_set-class.md) (the location that had preceded the first element in the unreversed `hash_set`).  
...
|`_Val`|The value of an element to be inserted into the [hash_set](../VS_csharp/hash_set-class.md) unless the `hash_set` already contains that element or, more generally, an element whose key is equivalently ordered.|  
...
### Return Value  
 A pair of iterators where the first is the [lower_bound](../VS_csharp/set-class.md#set__lower_bound) of the key and the second is the [upper_bound](../VS_csharp/set-class.md#set__upper_bound) of the key.  
...
### Remarks  
 ...
 All constructors store a function object of type `Traits` that is used to establish an order among the keys of the `hash_set` and that can later be returned by calling [hash_set::key_comp](#hash_set__key_comp). For more information on `Traits` see the [hash_set Class](../VS_csharp/hash_set-class.md) topic.  
...
### Return Value  
 ...
 For more information on `Traits` see the [hash_set Class](../VS_csharp/hash_set-class.md) topic.  
 ...
 **key_type** is a synonym for the template parameter `Key`.  
 ...
 For more information on `Key`, see the Remarks section of the [hash_set Class](../VS_csharp/hash_set-class.md) topic.  
...
|-|-|  
|Parameter|Description|  
|`_Right`|The [hash_set](../VS_csharp/hash_set-class.md) being copied into the `hash_set`.|  
...
### Return Value  
 ...
 For more information on `Compare`, see the Remarks section of the [hash_set Class](../VS_csharp/hash_set-class.md) topic.  
