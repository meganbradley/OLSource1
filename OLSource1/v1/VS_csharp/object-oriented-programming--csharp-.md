...
-   To declare an event in a class, use the [event (C# Reference)](../VS_csharp/event--csharp-reference-.md) keyword.  
...
|------------------|----------------|  
|[public](../VS_csharp/public--csharp-reference-.md)|The type or member can be accessed by any other code in the same assembly or another assembly that references it.|  
|[private](../VS_csharp/private--csharp-reference-.md)|The type or member can only be accessed by code in the same class.|  
|[protected](../VS_csharp/protected--csharp-reference-.md)|The type or member can only be accessed by code in the same class or in a derived class.|  
|[internal](../VS_csharp/internal--csharp-reference-.md)|The type or member can be accessed by any code in the same assembly, but not from another assembly.|  
...
```  
 ...
 For more information, see: [static (C# Reference)](../VS_csharp/static--csharp-reference-.md).  
...
|C# Modifier|Definition|  
|------------------|----------------|  
|[virtual (C# Reference)](../VS_csharp/virtual--csharp-reference-.md)|Allows a class member to be overridden in a derived class.|  
|[override (C# Reference)](../VS_csharp/override--csharp-reference-.md)|Overrides a virtual (overridable) member defined in the base class.|  
|[abstract (C# Reference)](../VS_csharp/abstract--csharp-reference-.md)|Requires that a class member to be overridden in the derived class.|  
|[new Modifier (C# Reference)](../VS_csharp/new-modifier--csharp-reference-.md)|Hides a member inherited from a base class|  
