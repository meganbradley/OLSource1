...
-   [get](../VS_csharp/get--csharp-reference-.md)  
  
-   [set](../VS_csharp/set--csharp-reference-.md)  
...
-   To declare an event in a class, use the [event](../VS_csharp/event--csharp-reference-.md) keyword.  
...
-   [new Operator](../VS_csharp/new-operator--csharp-reference-.md)  
...
```  
 ...
 For more information, see: [static](../VS_csharp/static--csharp-reference-.md).  
...
```  
 ...
 For more information, see: [Anonymous Types](../VS_csharp/anonymous-types--csharp-programming-guide-.md).  
...
|C# Modifier|Definition|  
|------------------|----------------|  
|[virtual](../VS_csharp/virtual--csharp-reference-.md)|Allows a class member to be overridden in a derived class.|  
|[override](../VS_csharp/override--csharp-reference-.md)|Overrides a virtual (overridable) member defined in the base class.|  
|[abstract](../VS_csharp/abstract--csharp-reference-.md)|Requires that a class member to be overridden in the derived class.|  
|[new Modifier](../VS_csharp/new-modifier--csharp-reference-.md)|Hides a member inherited from a base class|  
