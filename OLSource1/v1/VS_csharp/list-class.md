...
## Remarks  
 ...
 Include the STL standard header <list\> to define the [container](../VS_csharp/stl-containers.md) template class list and several supporting templates.  
...
### Remarks  
 ...
 When compiling with _SECURE_SCL 1, a runtime error will occur if you attempt to access an element in an empty list.  See [Checked Iterators](../VS_csharp/checked-iterators.md) for more information.  
...
### Return Value  
 A const reverse bidirectional iterator addressing the first element in a reversed [list](../VS_csharp/list-class.md) (or addressing what had been the last element in the unreversed `list`).  
...
### Return Value  
 A const reverse bidirectional iterator that addresses the location succeeding the last element in a reversed [list](../VS_csharp/list-class.md) (the location that had preceded the first element in the unreversed `list`).  
...
### Remarks  
 ...
 Note that although `difference_type` is available for all iterators that satisfy the requirements of an input iterator, which includes the class of bidirectional iterators supported by reversible containers like set, subtraction between iterators is only supported by random-access iterators provided by a random-access container, such as [vector Class](../VS_csharp/vector-class.md).  
...
|`_Where`|The position in the target [list](../VS_csharp/list-class.md) where the first element is inserted.|  
...
|-|-|  
|Parameter|Description|  
|`_Val`|The element added to the end of the [list](../VS_csharp/list-class.md).|  
...
|-|-|  
|Parameter|Description|  
|`_Val`|The element added to the beginning of the [list](../VS_csharp/list-class.md).|  
...
|-|-|  
|Parameter|Description|  
|`_Right`|The [list](../VS_csharp/list-class.md) being copied into the `list`.|  
...
### Remarks  
 ...
 If the ranged splice inserts `N` elements, and `&Source != this`, an object of class [iterator](../VS_csharp/forward_list-class.md#forward_list__iterator) is incremented `N` times.  
