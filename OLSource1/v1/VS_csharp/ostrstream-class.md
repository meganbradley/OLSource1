...
---
# ostrstream Class
Describes an object that controls insertion of elements and encoded objects into a stream buffer of class [strstreambuf](../VS_csharp/strstreambuf-class.md).  
...
> [!NOTE]
>  This class is deprecated. Consider using [ostringstream](../VS_csharp/-sstream--typedefs.md#ostringstream) or [wostringstream](../VS_csharp/-sstream--typedefs.md#wostringstream) instead.  
...
|[str](#ostrstream__str)|Calls [freeze](../VS_csharp/strstreambuf-class.md#strstreambuf__freeze), and then returns a pointer to the beginning of the controlled sequence.|  
...
### Remarks  
 The member function calls [rdbuf](#ostrstream__rdbuf) -> [freeze](../VS_csharp/strstreambuf-class.md#strstreambuf__freeze)(_                        *Freezeit*).  
  
### Example  
  See [strstream::freeze](../VS_csharp/strstreambuf-class.md#strstreambuf__freeze) for an example that uses **freeze**.  
...
### Remarks  
 Both constructors initialize the base class by calling [ostream](../VS_csharp/-ostream--typedefs.md#ostream)( **sb**), where **sb** is the stored object of class [strstreambuf](../VS_csharp/strstreambuf-class.md). The first constructor also initializes **sb** by calling `strstreambuf`. The second constructor initializes the base class one of two ways:  
...
### Remarks  
 The member function returns [rdbuf](#ostrstream__rdbuf) -> [pcount](../VS_csharp/strstreambuf-class.md#strstreambuf__pcount).  
  
### Example  
  See [strstream::pcount](../VS_csharp/strstreambuf-class.md#strstreambuf__pcount) for a sample that uses `pcount`.  
...
### Remarks  
 The member function returns [rdbuf](#ostrstream__rdbuf) -> [str](../VS_csharp/strstreambuf-class.md#strstreambuf__str).  
  
### Example  
  See [strstream::str](../VS_csharp/strstreambuf-class.md#strstreambuf__str) for a sample that uses **str**.  
  
## See Also  
 [ostream](../VS_csharp/-ostream--typedefs.md#ostream)   
