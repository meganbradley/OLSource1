...
A variable of the [Object Data Type](../VS_csharp/object-data-type.md) can refer to data of any type. The value you store in an `Object` variable is kept elsewhere in memory, while the variable itself holds a pointer to the data.  
  
## Object Classifier Functions  
 [!INCLUDE[vbprvb](../VS_csharp/includes/vbprvb_md.md)] supplies functions that return information about what an `Object` variable refers to, as shown in the following table.  
...
|<xref:Microsoft.VisualBasic.Information.IsDate*>|A [Date Data Type (Visual Basic)](../VS_csharp/date-data-type--visual-basic-.md) value, or a string that can be interpreted as a date and time value|  
...
|<xref:Microsoft.VisualBasic.Information.IsNothing*>|[Nothing (Visual Basic)](../VS_csharp/nothing--visual-basic-.md), that is, no object is currently assigned to the variable|  
...
## TypeOf Operator  
 You can also use the [TypeOf Operator (Visual Basic)](../VS_csharp/typeof-operator--visual-basic-.md) to determine whether an object variable currently refers to a specific data type. The `TypeOf`...`Is` expression evaluates to `True` if the run-time type of the operand is derived from or implements the specified type.  
...
## See Also  
 ...
 [Object Variable Assignment](../VS_csharp/object-variable-assignment--visual-basic-.md)   
 [How to: Refer to the Current Instance of an Object](../VS_csharp/how-to--refer-to-the-current-instance-of-an-object--visual-basic-.md)   
