...
## Remarks  
 The [/clr](../VS_csharp/-clr--common-language-runtime-compilation-.md) compiler option provides module-level control for compiling functions either as managed or unmanaged.  
...
-   Add the pragma after `#include` statements. Do not use these pragmas before `#include` statements.  
 ...
 For more information, see [Initialization of Mixed Assemblies](../VS_csharp/initialization-of-mixed-assemblies.md).  
