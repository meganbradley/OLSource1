...
## Remarks  
 The `<example>` tag lets you specify an example of how to use a method or other library member. This commonly involves using the [<code\> (Visual Basic)](../VS_csharp/-code---visual-basic-.md) tag.  
...
## Example  
 ...
 [!code[VbVbcnXmlDocComments#2](../VS_csharp/codesnippet/VisualBasic/-example---visual-basic-_1.vb)]  
