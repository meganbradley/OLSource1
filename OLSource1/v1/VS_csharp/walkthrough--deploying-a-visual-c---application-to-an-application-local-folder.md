...
1.  Create and build an MFC application by following the steps in [Walkthrough: Deploying a Visual C++ Application by using a Setup Project](../VS_csharp/walkthrough--deploying-a-visual-c---application-by-using-a-setup-project.md).  
