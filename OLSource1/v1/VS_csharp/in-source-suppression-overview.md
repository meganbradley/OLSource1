...
> [!NOTE]
>  You do not have to hand code these attributes yourself. For more information, see [How to: Suppress Warnings Using the Menu Item](../VS_csharp/how-to--suppress-warnings-by-using-the-menu-item.md). The menu item is not available for C++ code.  
...
-   **Rule Category** - The category in which the rule is defined. For more information about code analysis rule categories, see [Code Analysis for Managed Code Warnings](../VS_csharp/code-analysis-for-managed-code-warnings.md).  
...
## Suppressing Multiple Violations within a method body  
 ...
 [!code[InSourceSuppression#1](../VS_csharp/codesnippet/CPP/in-source-suppression-overview_1.cpp)]
[!code[InSourceSuppression#1](../VS_csharp/codesnippet/VisualBasic/in-source-suppression-overview_1.vb)]
[!code[InSourceSuppression#1](../VS_csharp/codesnippet/CSharp/in-source-suppression-overview_1.cs)]  
...
## Generated Code  
 ...
 You can choose whether to suppress Code Analysis warnings and errors for generated code. For information about how to suppress such warnings and errors, see [How to: Suppress Code Analysis Warnings for Generated Code](../VS_csharp/how-to--suppress-code-analysis-warnings-for-generated-code.md).  
