...
>  When registering standard verbs, do not set the default value for the Open key. The default value contains the display string on the menu. The operating system supplies this string for standard verbs.  
 ...
 Project files should be registered to start a new instance of [!INCLUDE[vsprvs](../VS_csharp/includes/vsprvs_md.md)] when a user opens the file. The following example illustrates a standard verb registration for a [!INCLUDE[csprcs](../VS_csharp/includes/csprcs_md.md)] project.  
...
```  
 ...
 To open a file in an existing instance of [!INCLUDE[vsprvs](../VS_csharp/includes/vsprvs_md.md)], register a DDEEXEC key. The following example illustrates a standard verb registration for a [!INCLUDE[csprcs](../VS_csharp/includes/csprcs_md.md)] .cs file.  
...
## See Also  
 ...
 [Managing Side-by-Side Projects](../VS_csharp/managing-side-by-side-file-associations.md)