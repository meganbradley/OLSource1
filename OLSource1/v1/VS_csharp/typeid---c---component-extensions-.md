...
> [!WARNING]
>  This topic refers to the C++ Component Extensions version of typeid. For the ISO C++ version of this keyword, see [typeid Operator](../VS_csharp/typeid-operator.md).  
...
### Remarks  
 In [!INCLUDE[cppwrt_short](../VS_csharp/includes/cppwrt_short_md.md)],  typeid returns a [Platform::Type](assetId:///d6b03f1e-b240-49b9-a08e-53a460030475) that is constructed from runtime type information.  
 ...
 **Remarks**  
 ...
 `typeid` can take a native type name or common language runtime alias for the native type name; see [.NET Framework Equivalents to C++ Native Types](../VS_csharp/.net-framework-equivalents-to-c---native-types--c---cli-.md) for more information.  
  
 `typeid` also works with native types, although it will still return a System::Type.  To get a type_info structure, use [typeid Operator](../VS_csharp/typeid-operator.md).  
