...
## In this Section  
 [Adding a Toolbar](../VS_csharp/adding-a-toolbar.md)  
 ...
 [Adding a Command to the Solution Explorer Toolbar](../VS_csharp/adding-a-command-to-the-solution-explorer-toolbar.md)  
 Explains how to add a command to the toolbar on the Solution Explorer.  
  
 [Adding a Menu Controller to a Toolbar](../VS_csharp/adding-a-menu-controller-to-a-toolbar.md)  
 Explains how to add a menu controller to a toolbar.  
  
 [Dynamically Adding Menu Items](../VS_csharp/dynamically-adding-menu-items.md)  
