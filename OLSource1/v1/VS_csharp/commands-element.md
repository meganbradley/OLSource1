...
|[Groups Element](../VS_csharp/groups-element.md)|Contains entries that define the command groups in a VSPackage.|  
...
|[Combos Element](../VS_csharp/combos-element.md)|Groups Combo elements.|  
  
### Parent Elements  
  
|Element|Description|  
|-------------|-----------------|  
|[CommandTable Element](../VS_csharp/commandtable-element.md)|Defines all the elements that represent the commands that a VSPackage provides to the IDE. Possible elements are menu items, menus, toolbars, and combo boxes.|  
  
## Example  
 The following example shows how to use a [Commands Element](../VS_csharp/commands-element.md).  
