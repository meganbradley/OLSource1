...
-   Convenient: Standard Posix and similar format strings.  
 ...
 Although Boost.Format is built on C++ [iostreams](../VS_csharp/iostream-programming.md), which are safe and extensible, they aren't performance-optimized. When you require performance optimization, consider C [printf](../VS_csharp/printf--_printf_l--wprintf--_wprintf_l.md) and [sprintf](../VS_csharp/sprintf--_sprintf_l--swprintf--_swprintf_l--__swprintf_l.md), which are fast and easy to use. However, they are not extensible or safe from vulnerabilities. (Safe versions exist, but they incur a slight performance penalty. For more information, see [printf_s](../VS_csharp/printf_s--_printf_s_l--wprintf_s--_wprintf_s_l.md) and [sprintf_s](../VS_csharp/sprintf_s--_sprintf_s_l--swprintf_s--_swprintf_s_l.md)).  
...
## See Also  
 ...
 [iostream](../VS_csharp/-iostream-.md)   
 [limits](../VS_csharp/-limits-.md)   
