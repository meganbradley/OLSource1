...
-   **User-defined conversions**: User-defined conversions are performed by special methods that you can define to enable explicit and implicit conversions between custom types that do not have a base class–derived class relationship. For more information, see [Conversion Operators (C# Programming Guide)](../VS_csharp/conversion-operators--csharp-programming-guide-.md).  
  
-   **Conversions with helper classes**: To convert between non-compatible types, such as integers and <xref:System.DateTime*?displayProperty=fullName> objects, or hexadecimal strings and byte arrays, you can use the <xref:System.BitConverter*?displayProperty=fullName> class, the <xref:System.Convert*?displayProperty=fullName> class, and the `Parse` methods of the built-in numeric types, such as <xref:System.Int32.Parse*?displayProperty=fullName>. For more information, see [How to: Convert a Byte Array to an int (C# Programming Guide)](../VS_csharp/how-to--convert-a-byte-array-to-an-int--csharp-programming-guide-.md), [How to: Convert a string to an int (C# Programming Guide)](../VS_csharp/how-to--convert-a-string-to-a-number--csharp-programming-guide-.md), and [How to: Convert Between Hex Strings and Numeric Types (C# Programming Guide)](../VS_csharp/how-to--convert-between-hexadecimal-strings-and-numeric-types--csharp-programming-guide-.md).  
...
## Implicit Conversions  
 ...
 For a complete list of all implicit numeric conversions, see [Implicit Numeric Conversions Table (C# Reference)](../VS_csharp/implicit-numeric-conversions-table--csharp-reference-.md).  
...
## Explicit Conversions  
 ...
 For a list of the explicit numeric conversions that are allowed, see [Explicit Numeric Conversions Table (C# Reference)](../VS_csharp/explicit-numeric-conversions-table--csharp-reference-.md).  
...
```  
 ...
 A cast operation between reference types does not change the run-time type of the underlying object; it only changes the type of the value that is being used as a reference to that object. For more information, see [Polymorphism (C# Programming Guide)](../VS_csharp/polymorphism--csharp-programming-guide-.md).  
...
## See Also  
 ...
 [How to: Convert a string to an int (C# Programming Guide)](../VS_csharp/how-to--convert-a-string-to-a-number--csharp-programming-guide-.md)