...
## Example  
 See the typedefs and member functions of the template class [char_traits Class](../VS_csharp/char_traits-struct.md)< **CharType**> for examples involving elements of type `char`.  
