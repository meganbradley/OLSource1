...
Returns an [extent](../VS_csharp/extent-class--c---amp-.md) object that has the values of the [tiled_index](../VS_csharp/tiled_index-class.md) template arguments `_Dim0`, `_Dim1`, and `_Dim2`.  
