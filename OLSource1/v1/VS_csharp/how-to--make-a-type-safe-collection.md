...
1.  Declare a variable of the collection class type. For example:  
     ...
     [!code[NVC_MFCCollections#7](../VS_csharp/codesnippet/CPP/how-to--make-a-type-safe-collection_1.cpp)]  
  
2.  Call the member functions of the collection object. For example:  
  
     [!code[NVC_MFCCollections#8](../VS_csharp/codesnippet/CPP/how-to--make-a-type-safe-collection_2.cpp)]  
  
3.  If necessary, implement the [helper functions](../VS_csharp/collection-class-helpers.md) and [SerializeElements](../VS_csharp/serializeelements.md). For information on implementing these functions, see [Implementing Helper Functions](#_core_implementing_helper_functions).  
...
##  <a name="_core_implementing_helper_functions"></a> Implementing Helper Functions  
 The template-based collection classes `CArray`, `CList`, and `CMap` use five global helper functions that you can customize as needed for your derived collection class. For information on these helper functions, see [Collection Class Helpers](../VS_csharp/collection-class-helpers.md) in the *MFC Reference*. Implementation of the serialization function is necessary for most uses of the template-based collection classes.  
...
###  <a name="_core_serializing_elements"></a> Serializing Elements  
 ...
 [!code[NVC_MFCCollections#9](../VS_csharp/codesnippet/CPP/how-to--make-a-type-safe-collection_3.cpp)]  
...
1.  Use one of the nontemplate classes, such as `CWordArray`, directly.  
     ...
     [!code[NVC_MFCCollections#10](../VS_csharp/codesnippet/CPP/how-to--make-a-type-safe-collection_4.cpp)]  
...
1.  Derive your own collection class from one of the predefined nontemplate classes.  
     ...
     [!code[NVC_MFCCollections#11](../VS_csharp/codesnippet/CPP/how-to--make-a-type-safe-collection_5.h)]  
