...
'member': a sealed or final function must be virtual  
 ...
 The [sealed](../VS_csharp/sealed---c---component-extensions-.md) and [final](../VS_csharp/final-specifier.md) keywords are only allowed on a class, struct, or member function marked `virtual`.  
