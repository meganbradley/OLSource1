...
|[My.Forms Object](../VS_csharp/my.forms-object.md)|Provides properties for accessing an instance of each Windows Form declared in the current project.|  
...
|[My.Request Object](../VS_csharp/my.request-object.md)|Gets the <xref:System.Web.HttpRequest*> object for the requested page. The `My.Request` object contains information about the current HTTP request.<br /><br /> The `My.Request` object is available only for [!INCLUDE[vstecasp](../VS_csharp/includes/vstecasp_md.md)] applications.|  
|[My.Resources Object](../VS_csharp/my.resources-object.md)|Provides properties and classes for accessing an application's resources.|  
|[My.Response Object](../VS_csharp/my.response-object.md)|Gets the <xref:System.Web.HttpResponse*> object that is associated with the <xref:System.Web.UI.Page*>. This object allows you to send HTTP response data to a client and contains information about that response.<br /><br /> The `My.Response` object is available only for [!INCLUDE[vstecasp](../VS_csharp/includes/vstecasp_md.md)] applications.|  
|[My.Settings Object](../VS_csharp/my.settings-object.md)|Provides properties and methods for accessing an application's settings.|  
|`My.User` (<xref:Microsoft.VisualBasic.ApplicationServices.User*>)|Provides access to information about the current user.|  
|[My.WebServices Object](../VS_csharp/my.webservices-object.md)|Provides properties for creating and accessing a single instance of each Web service that is referenced by the current project.|  
