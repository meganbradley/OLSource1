...
## Remarks  
 ...
 `modf` has an implementation that uses Streaming SIMD Extensions 2 (SSE2). See [_set_SSE2_enable](../VS_csharp/_set_sse2_enable.md) for information and restrictions on using the SSE2 implementation.  
