...
|Topic|Description|  
|-----------|-----------------|  
|[How to: Serialize Using XmlSerializer (Visual Basic)](../VS_csharp/how-to--serialize-using-xmlserializer--visual-basic-.md)|Demonstrates how to serialize using <xref:System.Xml.Serialization.XmlSerializer*>.|  
|[How to: Serialize Using DataContractSerializer (Visual Basic)](../VS_csharp/how-to--serialize-using-datacontractserializer--visual-basic-.md)|Demonstrates how to serialize using <xref:System.Runtime.Serialization.DataContractSerializer*>.|  
