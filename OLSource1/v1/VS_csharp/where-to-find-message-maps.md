...
When you create a new skeleton application with the Application Wizard, the Application Wizard writes a message map for each command-target class it creates for you. This includes your derived application, document, view, and frame-window classes. Some of these message maps already have the entries supplied by the Application Wizard for certain messages and predefined commands, and some are just placeholders for handlers that you will add.  
 ...
 [!code[NVC_MFCMessageHandling#1](../VS_csharp/codesnippet/CPP/where-to-find-message-maps_1.cpp)]  
  
 The message map consists of a collection of macros. Two macros, [BEGIN_MESSAGE_MAP](../VS_csharp/begin_message_map.md) and [END_MESSAGE_MAP](../VS_csharp/end_message_map.md), bracket the message map. Other macros, such as `ON_COMMAND`, fill in the message map's contents.  
...
## See Also  
 [How the Framework Searches Message Maps](../VS_csharp/how-the-framework-searches-message-maps.md)