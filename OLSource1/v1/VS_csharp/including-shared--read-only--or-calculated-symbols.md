...
The first time the development environment reads a resource file created by another application, it marks all included header files as read-only. Subsequently, you can use the [Resource Includes dialog box](../VS_csharp/resource-includes-dialog-box.md) to add additional read-only symbol header files.  
...
1.  In [Resource View](../VS_csharp/resource-view-window.md), right-click your .rc file and choose [Resource Includes](../VS_csharp/resource-includes-dialog-box.md) from the shortcut menu.  
...
## See Also  
 ...
 [Symbol Value Restrictions](../VS_csharp/symbol-value-restrictions.md)   
