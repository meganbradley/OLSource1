...
## Remarks  
 ...
 The [Ignore All Default Libraries](../VS_csharp/-nodefaultlib--ignore-libraries-.md) (/NODEFAULTLIB) option overrides /DEFAULTLIB:*library*. The [Ignore Libraries](../VS_csharp/-nodefaultlib--ignore-libraries-.md) (/NODEFAULTLIB:*library*) option overrides /DEFAULTLIB:*library* when the same *library* name is specified in both.  
