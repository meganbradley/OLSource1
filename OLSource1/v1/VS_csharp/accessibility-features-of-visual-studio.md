...
-   [How to: Set IDE Accessibility Options](../VS_csharp/how-to--set-ide-accessibility-options.md)  
  
-   [How to: Use the Keyboard Exclusively](../VS_csharp/how-to--use-the-keyboard-exclusively.md)  
  
-   [Pre-defined Keyboard Shortcuts](../VS_csharp/default-keyboard-shortcuts-in-visual-studio.md)  
  
-   [Accessibility Tips and Tricks](../VS_csharp/accessibility-tips-and-tricks.md)  
  
-   [How to: Change the Fonts and Colors Used in the IDE](../VS_csharp/how-to--change-fonts-and-colors-in-visual-studio.md)  
  
## See Also  
 [Accessibility Products and Services from Microsoft](../VS_csharp/accessibility-products-and-services-from-microsoft.md)