...
## Threads View  
 ...
 ![Threads view in Parallel Stacks window](../VS_csharp/media/parallel_stacksthread.png "Parallel_StacksThread")  
...
|-|-|  
|Icon|Description|  
|![Parallel Stacks Yellow Arrow](../VS_csharp/media/icon_parallelyellowarrow.gif "Icon_ParallelYellowArrow")|Indicates that the method context contains the active stack frame of the current thread.|  
|![Parallel Stacks Threads Icon](../VS_csharp/media/icon_parallelthreads.gif "Icon_ParallelThreads")|Indicates that the method context contains the active stack frame of a non-current thread.|  
|![Parallel Stacks Green Arrow](../VS_csharp/media/icon_parallelgreenarrow.gif "Icon_ParallelGreenArrow")|Indicates that the method context contains the current stack frame. That method name is bold in all nodes in which it appears.|  
  
## Toolbar Controls  
 The following illustration and table describe the controls that are available in the Parallel Stacks toolbar.  
  
 ![Toolbar in Parallel Stacks window](../VS_csharp/media/parallel_stackstoolbar.png "Parallel_StacksToolbar")  
...
### Context Menu Items  
 ...
 ![Shortcut menu in Parallel Stacks window](../VS_csharp/media/parallel_contmenu.png "Parallel_ContMenu")  
...
-   When multiple tasks are on one thread, the call stacks of those tasks are split out into separate nodes.  
 ...
 ![Tasks view in Parallel Stacks window](../VS_csharp/media/parallel_tasksview.png "Parallel_TasksView")  
 ...
 ![Tooltips in Parallel Stacks window](../VS_csharp/media/parallel_stack_tooltips.png "Parallel_Stack_Tooltips")  
...
## Method View  
 ...
 ![Method view in Parallel Stacks window](../VS_csharp/media/parallel_methodview.png "Parallel_MethodView")  
...
## See Also  
 ...
 [Task Class](../VS_csharp/task-class---internal-members.md)