...
## Remarks  
 `_set_output_format` is used to configure the output of formatted I/O functions such as [printf_s](../VS_csharp/printf_s--_printf_s_l--wprintf_s--_wprintf_s_l.md). At present, the only formatting convention that can be changed by this function is the number of digits displayed in exponents in the output of floating point numbers.  
...
## See Also  
 ...
 [_get_output_format](../VS_csharp/_get_output_format.md)