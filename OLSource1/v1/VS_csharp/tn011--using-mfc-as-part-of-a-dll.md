...
## WinMain -> DllMain  
 The MFC library defines the standard Win32 `DllMain` entry point that initializes your [CWinApp](../VS_csharp/cwinapp-class.md) derived object as in a typical MFC application. Place all DLL-specific initialization in the [InitInstance](../Topic/CWinApp::InitInstance.md) method as in a typical MFC application.  
 ...
 The `DllMain` function that MFC provides will call the [ExitInstance](../Topic/CWinApp::ExitInstance.md) method of your class that is derived from `CWinApp` before the DLL is unloaded.  
