...
Calling managed 'entrypoint': Managed code may not be run under loader lock, including the DLL entrypoint and calls reached from the DLL entrypoint  
 ...
 For more information, see [Mixed Mode Initialization](../VS_csharp/initialization-of-mixed-assemblies.md) and [Linker Tools Error LNK1306](../VS_csharp/linker-tools-error-lnk1306.md).  
