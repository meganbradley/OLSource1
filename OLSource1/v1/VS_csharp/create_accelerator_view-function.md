...
---
# create_accelerator_view Function
Creates an [accelerator_view](../VS_csharp/accelerator_view-class.md) object from a pointer to a Direct3D device interface.  
...
## See Also  
 [Concurrency::direct3d Namespace](../VS_csharp/concurrency--direct3d-namespace.md)