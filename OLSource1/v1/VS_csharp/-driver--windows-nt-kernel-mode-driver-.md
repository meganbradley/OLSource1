...
-   /FIXED:NO is in effect ([/FIXED (Fixed Base Address)](../VS_csharp/-fixed--fixed-base-address-.md)).  
  
-   The extension of the output file will be .sys. Use **/OUT** to change the default filename and extension ([/OUT (Output File Name)](../VS_csharp/-out--output-file-name-.md)).  
