...
#### Parameters  
 ...
 [!code[NVC_OLEDB_Consumer#8](../VS_csharp/codesnippet/CPP/cdynamicparameteraccessor--setparam_1.cpp)]  
...
## Return Value  
 ...
 Use `SetParam` to set nonstring parameter data in the buffer. Use [SetParamString](../VS_csharp/cdynamicparameteraccessor--setparamstring.md) to set string parameter data in the buffer.  
