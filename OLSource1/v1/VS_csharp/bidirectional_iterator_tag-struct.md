...
## Example  
 See [random_access_iterator_tag](../VS_csharp/random_access_iterator_tag-struct.md) for an example of how to use `bidirectional_iterator_tag`.  
...
## See Also  
 [forward_iterator_tag Class](../VS_csharp/forward_iterator_tag-struct.md)   
