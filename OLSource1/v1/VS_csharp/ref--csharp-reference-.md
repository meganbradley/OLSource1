...
>  Do not confuse the concept of passing by reference with the concept of reference types. The two concepts are not the same. A method parameter can be modified by `ref` regardless of whether it is a value type or a reference type. There is no boxing of a value type when it is passed by reference.  
 ...
 [!code[csrefKeywordsMethodParams#6](../VS_csharp/codesnippet/CSharp/ref--csharp-reference-_1.cs)]  
  
 An argument that is passed to a `ref` parameter must be initialized before it is passed. This differs from `out` parameters, whose arguments do not have to be explicitly initialized before they are passed. For more information, see [out](../VS_csharp/out--csharp-reference-.md).  
 ...
 [!code[csrefKeywordsMethodParams#2](../VS_csharp/codesnippet/CSharp/ref--csharp-reference-_2.cs)]  
 ...
 [!code[csrefKeywordsMethodParams#7](../VS_csharp/codesnippet/CSharp/ref--csharp-reference-_3.cs)]  
 ...
 For information about how to pass arrays, see [Passing Arrays Using ref and out](../VS_csharp/passing-arrays-using-ref-and-out--csharp-programming-guide-.md).  
...
## See Also  
 ...
 [Passing Parameters (C# Programmer's Reference)](../VS_csharp/passing-parameters--csharp-programming-guide-.md)   
