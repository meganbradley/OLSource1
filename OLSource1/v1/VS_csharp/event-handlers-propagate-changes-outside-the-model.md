...
## Using Events to Make Undoable Adjustments in the Store  
 Store events are not normally used for propagating changes inside the store, because the event handler executes after the transaction is committed. Instead, you would use a store rule. For more information, see [Store Rules](../VS_csharp/rules-propagate-changes-within-the-model.md).  
...
## See Also  
 [Responding to Changes](../VS_csharp/responding-to-and-propagating-changes.md)   
