...
## Remarks  
 ...
 You can use the linker option [/OPT (Optimizations)](../VS_csharp/-opt--optimizations-.md) to exclude unreferenced packaged functions from the .exe file.  
  
 You can use the linker option [/ORDER (Put Functions in Order)](../VS_csharp/-order--put-functions-in-order-.md) to include packaged functions in a specified order in the .exe file.  
...
> [!NOTE]
>  The [/ZI](../VS_csharp/-z7---zi---zi--debug-information-format-.md) option, used for Edit and Continue, automatically sets the **/Gy** option.  
