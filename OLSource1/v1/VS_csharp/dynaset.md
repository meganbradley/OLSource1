...
> [!NOTE]
>  This topic applies to the MFC ODBC classes, including [CRecordset](../VS_csharp/crecordset-class.md). For information about dynasets in the DAO classes, see [CDaoRecordset](../VS_csharp/cdaorecordset-class.md). With DAO, you can open dynaset-type recordsets.  
