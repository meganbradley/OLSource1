...
-   The results of floating-point arithmetic operators in constant expressions, which always round to the nearest value.  
 ...
 To use these functions, you must turn off floating-point optimizations that could prevent access by using the `#pragma fenv_access(on)` directive prior to the call. For more information, see [fenv_access](../VS_csharp/fenv_access.md).  
...
## See Also  
 ...
 [nearbyint](../VS_csharp/nearbyint--nearbyintf--nearbyintl.md)   
 [rint](../VS_csharp/rint--rintf--rintl.md)   
 [lrint, llrint](../VS_csharp/lrint--lrintf--lrintl--llrint--llrintf--llrintl.md)