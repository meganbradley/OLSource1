...
#### Parameters  
 `action`  
 Type: `'T1 -> 'T2 ->` [unit](../VS_csharp/core.unit-type-abbreviation--fsharp-.md)  
...
## Example  
 The following code example shows the differences between [Array.iter](../VS_csharp/array.iter--t--function--fsharp-.md), `Array.iter2`, [Array.iteri](../VS_csharp/array.iteri--t--function--fsharp-.md), and [Array.iteri2](../VS_csharp/array.iteri2--t1--t2--function--fsharp-.md).  
  
 [!code[FsArrays#49](../VS_csharp/codesnippet/FSharp/array.iter2--t1--t2--function--fsharp-_1.fs)]  
