...
## Remarks  
 It is often safer to utilize the [scoped_lock](../VS_csharp/reader_writer_lock--scoped_lock-class.md) construct to acquire and release a `reader_writer_lock` object as a writer in an exception safe way.  
