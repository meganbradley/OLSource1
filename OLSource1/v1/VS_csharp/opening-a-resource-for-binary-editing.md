...
1.  In [Resource View](../VS_csharp/resource-view-window.md), select the specific resource file you want to edit.  
...
2.  Right-click the resource and click **Open Binary Data** from the shortcut menu.  
    ...
    > [!NOTE]
    >  If you use the [Resource View](../VS_csharp/resource-view-window.md) window to open a resource with a format that Visual Studio does not recognize (such as RCDATA or a custom resource), the resource is automatically opened in the Binary editor.  
...
## See Also  
 [Binary Editor](../VS_csharp/binary-editor.md)