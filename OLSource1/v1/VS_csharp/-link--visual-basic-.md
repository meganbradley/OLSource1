...
-   A field, property, event, or method that has a return type or parameter type from Assembly B is invoked.  
 ...
 Use [/libpath](../VS_csharp/-libpath.md) to specify the directory in which one or more of your assembly references is located.  
  
 Like the [/reference](../VS_csharp/-reference--visual-basic-.md) compiler option, the `/link` compiler option uses the Vbc.rsp response file, which references frequently used [!INCLUDE[dnprdnshort](../VS_csharp/includes/dnprdnshort_md.md)] assemblies. Use the [/noconfig](../VS_csharp/-noconfig.md) compiler option if you do not want the compiler to use the Vbc.rsp file.  
...
### Generic Interfaces  
 ...
 [!code[VbLinkCompiler#1](../VS_csharp/codesnippet/VisualBasic/-link--visual-basic-_1.vb)]  
...
### Types That Have Generic Parameters  
 ...
 [!code[VbLinkCompiler#2](../VS_csharp/codesnippet/VisualBasic/-link--visual-basic-_2.vb)]  
[!code[VbLinkCompiler#3](../VS_csharp/codesnippet/VisualBasic/-link--visual-basic-_3.vb)]  
[!code[VbLinkCompiler#4](../VS_csharp/codesnippet/VisualBasic/-link--visual-basic-_4.vb)]  
 ...
 [!code[VbLinkCompiler#5](../VS_csharp/codesnippet/VisualBasic/-link--visual-basic-_5.vb)]  
...
## See Also  
 ...
 [/reference](../VS_csharp/-reference--visual-basic-.md)   
 [/noconfig](../VS_csharp/-noconfig.md)   
 [/libpath](../VS_csharp/-libpath.md)   
