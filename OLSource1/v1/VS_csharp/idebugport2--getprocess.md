...
#### Parameters  
 `ProcessId`  
 [in] An [AD_PROCESS_ID](../VS_csharp/ad_process_id.md) structure that specifies the process identifier.  
  
 `ppProcess`  
 [out] Returns an [IDebugProcess2](../VS_csharp/idebugprocess2.md) object representing the process.  
