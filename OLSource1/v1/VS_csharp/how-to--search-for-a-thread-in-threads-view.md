...
1.  Arrange your windows so that Spy++ and an active [Threads View](../VS_csharp/threads-view.md) window are visible.  
  
2.  From the **Search** menu, choose **Find Thread**.  
  
     The [Thread Search Dialog Box](../VS_csharp/thread-search-dialog-box.md) opens.  
