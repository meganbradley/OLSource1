...
3.  In the [Add Class](../VS_csharp/add-class-dialog-box.md) dialog box, in the templates pane, click **ATL Control**, and then click **Add** to display the [ATL Control Wizard](../VS_csharp/atl-control-wizard.md).  
