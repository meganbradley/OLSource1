...
#### Parameters  
 `beginAction`  
 Type: <xref:System.AsyncCallback*> `*` [obj](../VS_csharp/core.obj-type-abbreviation--fsharp-.md) `->` <xref:System.IAsyncResult*>  
...
## Example  
 ...
 [!code[FsAsyncAPIs#200](../VS_csharp/codesnippet/FSharp/async.frombeginend--t--method--fsharp-_1.fs)]  
...
## Example  
 ...
 [!code[FsAsyncAPIs#20](../VS_csharp/codesnippet/FSharp/async.frombeginend--t--method--fsharp-_2.fs)]  
