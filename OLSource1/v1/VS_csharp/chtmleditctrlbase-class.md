 ...
 **CHtmlEditCtrlBase** is not intended to stand on its own. It is designed to be a base class for derived classes that expose the HTML editing functionality of the WebBrowser (see [CHtmlEditCtrl](../VS_csharp/chtmleditctrl-class.md) and [CHtmlEditView](../VS_csharp/chtmleditview-class.md)).  
