...
The hot spot of a [cursor](../VS_csharp/icons-and-cursors--image-resources-for-display-devices--image-editor-for-icons-.md) is the point to which Windows refers in tracking the cursor's position. By default, the hot spot is set to the upper-left corner of the cursor (coordinates 0,0). The Hotspot property in the [Properties window](../VS_csharp/properties-window.md) shows the hot spot coordinates.  
  
### To set a cursor's hot spot  
  
1.  On the [Image Editor toolbar](../VS_csharp/toolbar--image-editor-for-icons-.md), click the **Set Hotspot** tool.  
