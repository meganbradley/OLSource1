...
-   Is represented by an [IDebugCoreServer2](../VS_csharp/idebugcoreserver2.md) interface, which is only implemented by Visual Studio (one instance of a server for each instance of Visual Studio running).  
