...
## Remarks  
 The `__dllonexit` function is analogous to the [_onexit](../VS_csharp/_onexit--_onexit_m.md) function except that the global variables used by that function are not visible to this routine. Instead of global variables, this function uses the `pbegin` and `pend` parameters.  
