...
'file': typelibrary contains a union; ignoring the 'embedded_idl' qualifier  
 ...
 The embedded_idl attribute of [#import](../VS_csharp/sharpimport-directive--c---.md) could not be applied to the type library because a union is present in the type library. To resolve this warning, don't use embedded_idl.  
