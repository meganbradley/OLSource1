...
## Return Value  
 An asychronous computation ([Async](../VS_csharp/control.async-class--fsharp-.md) object) that will wait for the reply from the agent.  
...
## Example  
 ...
 [!code[FsMailboxProcessor#14](../VS_csharp/codesnippet/FSharp/mailboxprocessor.postandasyncreply--msg--reply--method--fsharp-_1.fs)]  
