...
#### Parameters  
 `pFX`  
 A pointer to a [CFieldExchange](../VS_csharp/cfieldexchange-class.md) object. This object contains information to define the context for each call of the function. For more information, see the article [Record Field Exchange: How RFX Works](../VS_csharp/record-field-exchange--how-rfx-works.md).  
...
>  Bulk record field exchange only transfers data from the data source to the recordset object. To make your recordset updateable, you must use the ODBC API function **SQLSetPos**.  
 ...
 For more information, see the articles [Recordset: Fetching Records in Bulk (ODBC)](../VS_csharp/recordset--fetching-records-in-bulk--odbc-.md) and [Record Field Exchange (RFX)](../VS_csharp/record-field-exchange--rfx-.md).  
  
## Example  
 You must manually write calls in your `DoBulkFieldExchange` override. This example shows a call to `RFX_Text_Bulk`, as well as a call to `RFX_Long_Bulk`, for data transfer. These calls are preceded by a call to [CFieldExchange::SetFieldType](../Topic/CFieldExchange::SetFieldType.md). Note that for parameters, you must call the RFX functions instead of the Bulk RFX functions.  
  
 [!code[NVC_MFCDatabase#42](../VS_csharp/codesnippet/CPP/rfx_text_bulk_1.cpp)]  
...
## See Also  
 ...
 [RFX_Binary_Bulk](../VS_csharp/rfx_binary_bulk.md)   
 [RFX_Bool_Bulk](../VS_csharp/rfx_bool_bulk.md)   
 [RFX_Byte_Bulk](../VS_csharp/rfx_byte_bulk.md)   
 [RFX_Date_Bulk](../VS_csharp/rfx_date_bulk.md)   
 [RFX_Double_Bulk](../VS_csharp/rfx_double_bulk.md)   
 [RFX_Int_Bulk](../VS_csharp/rfx_int_bulk.md)   
 [RFX_Long_Bulk](../VS_csharp/rfx_long_bulk.md)   
 [RFX_Single_Bulk](../VS_csharp/rfx_single_bulk.md)   
