...
The **Properties** window in the [!INCLUDE[vsprvs](../VS_csharp/includes/vsprvs_md.md)] integrated development environment (IDE) can display project and configuration properties. You can provide a property page for your own project type so that the user can set properties for your application.  
  
 By selecting a project node in **Solution Explorer** and then clicking **Properties** on the **Project** menu, you can open a dialog box that includes project and configuration properties. In [!INCLUDE[csprcs](../VS_csharp/includes/csprcs_md.md)] and [!INCLUDE[vbprvb](../VS_csharp/includes/vbprvb_md.md)], and project types derived from these languages, this dialog box appears as a tabbed page in the [options dialog box](../VS_csharp/general--environment--options-dialog-box.md). For more information, see [Not in Build: Walkthrough: Exposing Project and Configuration Properties (C#)](assetId:///d850d63b-25e2-4505-9f3d-eb038d7c1d0e).  
...
## ProvideObjectAttribute and Registry Path  
 ...
 [!code[VSSDKSupportProjectConfigurationProperties#1](../VS_csharp/codesnippet/CSharp/support-for-project-and-configuration-properties_1.cs)]
[!code[VSSDKSupportProjectConfigurationProperties#1](../VS_csharp/codesnippet/VisualBasic/support-for-project-and-configuration-properties_1.vb)]  
  
 The VSPackage to which the attribute is attached is unimportant. When a VSPackage is registered with [!INCLUDE[vsprvs](../VS_csharp/includes/vsprvs_md.md)], the class id (CLSID) of any object that can be created is registered so that a call to <xref:Microsoft.VisualStudio.Shell.Interop.ILocalRegistry.CreateInstance*> can create it.  
...
>  Equivalent attributes, SRCategory, LocDisplayName, and SRDescription, use string resources for localization and are defined in [MPF for Projects - Visual Studio 2013](http://mpfproj12.codeplex.com/).  
 ...
 [!code[VSSDKSupportProjectConfigurationProperties#2](../VS_csharp/codesnippet/VisualBasic/support-for-project-and-configuration-properties_2.vb)]
[!code[VSSDKSupportProjectConfigurationProperties#2](../VS_csharp/codesnippet/CSharp/support-for-project-and-configuration-properties_2.cs)]  
...
## See Also  
 ...
 [How to: Add and Remove Property Pages](../VS_csharp/adding-and-removing-property-pages.md)   
 [VSPackage State](../Topic/VSPackage%20State.md)   
 [Projects and Solutions](../VS_csharp/projects.md)   
 [NIB: Visual Studio Templates](assetId:///141fccaa-d68f-4155-822b-27f35dd94041)   
 [Template Directory Description Files (.vsdir)](../VS_csharp/template-directory-description--.vsdir--files.md)