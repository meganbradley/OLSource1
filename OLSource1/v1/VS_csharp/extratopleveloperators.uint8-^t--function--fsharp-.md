...
Converts the argument to byte. This is a direct conversion for all primitive numeric types. For strings, the input is converted using <xref:System.Byte.Parse*> on strings and otherwise requires a `ToByte` method on the input type.  
...
## Return Value  
 The converted value of type [byte](../VS_csharp/core.byte-type-abbreviation--fsharp-.md).  
