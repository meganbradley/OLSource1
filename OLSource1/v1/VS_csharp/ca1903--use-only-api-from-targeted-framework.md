...
|.NET Framework 4|N/A|  
 ...
 To change a project's target framework, see [Targeting a Specific .NET Framework](../VS_csharp/targeting-a-specific-.net-framework-version.md).  
...
## Example  
 ...
 [!code[FxCop.Portability.UseOnlyApiFromTargetedFramework#1](../VS_csharp/codesnippet/CSharp/ca1903--use-only-api-from-targeted-framework_1.cs)]  
...
## Example  
 ...
 [!code[FxCop.Portability.UseOnlyApiFromTargetedFramework2#1](../VS_csharp/codesnippet/CSharp/ca1903--use-only-api-from-targeted-framework_2.cs)]  
  
## See Also  
 [Portability Warnings](../VS_csharp/portability-warnings.md)   
