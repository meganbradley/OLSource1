...
-   Incorrect LIB environment variable. For information on how to update the LIB environment variable, see [VC++ Directories Property Page](../VS_csharp/vc---directories-property-page.md) . Make sure any directories with libraries you need are listed here.  
...
-   Use [/OPT:NOREF](../VS_csharp/-opt--optimizations-.md); doing transitive comdat elimination reads all the object files multiple times.