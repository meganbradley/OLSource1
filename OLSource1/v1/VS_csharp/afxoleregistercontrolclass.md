 ...
 *dwMiscStatus*  
 Contains one or more of the following status flags (for a description of the flags, see **OLEMISC** enumeration in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)]):  
...
## Remarks  
 This allows the control to be used by containers that are OLE-control aware. `AfxOleRegisterControlClass` updates the registry with the control's name and location on the system and also sets the threading model that the control supports in the registry. For more information, see [Technical Note 64](../VS_csharp/tn064--apartment-model-threading-in-activex-controls.md), "Apartment-Model Threading in OLE Controls," and [About Processes and Threads](http://msdn.microsoft.com/library/windows/desktop/ms681917) in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
  
## Example  
 [!code[NVC_MFCAxCtl#11](../VS_csharp/codesnippet/CPP/afxoleregistercontrolclass_1.cpp)]  
 ...
 [!code[NVC_MFCAxCtl#12](../VS_csharp/codesnippet/CPP/afxoleregistercontrolclass_2.cpp)]  
...
## See Also  
 ...
 [AfxOleRegisterPropertyPageClass](../VS_csharp/afxoleregisterpropertypageclass.md)   
 [AfxOleRegisterTypeLib](../VS_csharp/afxoleregistertypelib.md)   
 [AfxOleUnregisterClass](../VS_csharp/afxoleunregisterclass.md)   
 [AfxOleUnregisterTypeLib](../VS_csharp/afxoleunregistertypelib.md)