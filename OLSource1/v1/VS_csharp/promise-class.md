...
|Name|Description|  
|----------|-----------------|  
|[promise::get_future Method](#promise__get_future_method)|Returns a [future](../VS_csharp/future-class.md) associated with this promise.|  
...
##  <a name="promise__get_future_method"></a>  promise::get_future Method  
 Returns a [future](../VS_csharp/future-class.md) object that has the same *associated asynchronous state* as this promise.  
...
### Remarks  
 If the promise object is empty, this method throws a [future_error](../VS_csharp/future_error-class.md) that has an [error_code](../VS_csharp/error_code-class.md) of `no_state`.  
...
### Parameters  
 `Al`  
 A memory allocator. See [<allocators\>](../VS_csharp/-allocators-.md) for more information.  
...
### Parameters  
 `Exc`  
 An [exception_ptr](../VS_csharp/transporting-exceptions-between-threads.md) that's stored by this method as the exception result.  
  
### Remarks  
 If the `promise` object has no associated asynchronous state, this method throws a [future_error](../VS_csharp/future_error-class.md) that has an error code of `no_state`.  
