...
An object reference is required for the nonstatic field, method, or property 'member'  
 ...
 In order to use a non-static field, method, or property, you must first create an object instance. For more information about static methods, see [Static Classes and Static Class Members (C# Programming Guide)](../VS_csharp/static-classes-and-static-class-members--csharp-programming-guide-.md). For more information about creating instances of classes, see [Instance Constructors (C# Programmer's Reference)](../VS_csharp/instance-constructors--csharp-programming-guide-.md).  
