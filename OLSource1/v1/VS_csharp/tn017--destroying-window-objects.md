...
-   Default control bars (classes derived from `CControlBar`, see [Technical Note 31](../VS_csharp/tn031--control-bars.md) for enabling auto-delete for control bar objects).  
