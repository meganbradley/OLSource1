...
-   [How to: Enable a 64-Bit Visual C++ Toolset at the Command Line](../VS_csharp/how-to--enable-a-64-bit-visual-c---toolset-on-the-command-line.md)  
  
-   [How to: Use the 64-Bit C++ Command-line Tools](../VS_csharp/how-to--enable-a-64-bit-visual-c---toolset-on-the-command-line.md)  
  
-   [How to: Configure Projects to Target 64-Bit Platforms](../VS_csharp/how-to--configure-visual-c---projects-to-target-64-bit-platforms.md)