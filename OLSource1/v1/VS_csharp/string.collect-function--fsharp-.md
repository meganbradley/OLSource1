...
#### Parameters  
 `mapping`  
 Type: [char](../VS_csharp/core.char-type-abbreviation--fsharp-.md) `->` [string](../VS_csharp/core.string-type-abbreviation--fsharp-.md)  
...
## Example  
 ...
 [!code[FsStrings#1](../VS_csharp/codesnippet/FSharp/string.collect-function--fsharp-_1.fs)]  
