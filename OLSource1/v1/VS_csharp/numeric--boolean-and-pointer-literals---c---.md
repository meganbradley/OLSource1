...
A literal is a program element that directly represents a value. This article covers literals of type integer, floating-point, boolean and pointer. For information about string and character literals, see [String and Character Literals  (C++)](../VS_csharp/string-and-character-literals---c---.md). You can also define your own literals based on any of these categories; for more information see [User-Defined Literals  (C++)](../VS_csharp/user-defined-literals---c---.md)  
...
## Pointer literal (C++11)  
 C++ introduces the [nullptr](../VS_csharp/nullptr.md) literal to specify a zero-initialized pointer. In portable code, `nullptr` should be used instead of integral-type zero or macros such as NULL.  
...
## See Also  
 ...
 [C++ String Literals](../VS_csharp/string-and-character-literals---c---.md)   
 [C++ User-Defined Literals](../VS_csharp/user-defined-literals---c---.md)