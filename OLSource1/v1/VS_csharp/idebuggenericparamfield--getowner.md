...
#### Parameters  
 `ppOwner`  
 [out] Returns the [IDebugField](../VS_csharp/idebugfield.md) object that owns this generic parameter.  
  
## Return Value  
 If successful, returns `S_OK`; otherwise, returns an error code.  
  
## Example  
 The following example shows how to implement this method for a **CDebugGenericParamFieldType** object that exposes the [IDebugGenericParamField](../VS_csharp/idebuggenericparamfield.md) interface.  
...
## See Also  
 [IDebugGenericParamField](../VS_csharp/idebuggenericparamfield.md)