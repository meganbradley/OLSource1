...
## Remarks  
 ...
 When you use the `Skip` clause in a query, you may also need to ensure that the results are returned in an order that will enable the `Skip` clause to bypass the intended results. For more information about ordering query results, see [Order By Clause (Visual Basic)](../VS_csharp/order-by-clause--visual-basic-.md).  
...
## Example  
 ...
 [!code[VbSimpleQuerySamples#1](../VS_csharp/codesnippet/VisualBasic/skip-clause--visual-basic-_1.vb)]  
...
## See Also  
 ...
 [SkipWhile Clause (Visual Basic)](../VS_csharp/skip-while-clause--visual-basic-.md)   
