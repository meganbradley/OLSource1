...
#### Parameters  
 `pdwScope`  
 [out] Returns a value from the [DISASSEMBLY_STREAM_SCOPE](../VS_csharp/disassembly_stream_scope.md) enumeration that describes the scope of this disassembly stream.  
