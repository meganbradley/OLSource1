...
#### Parameters  
 `compare`  
 [in] A value from the [CONTEXT_COMPARE](../VS_csharp/context_compare.md) enumeration that determines the type of comparison.  
  
 `rgpMemoryContextSet`  
 [in] An array of references to the [IDebugMemoryContext2](../VS_csharp/idebugmemorycontext2.md) objects to compare against.  
