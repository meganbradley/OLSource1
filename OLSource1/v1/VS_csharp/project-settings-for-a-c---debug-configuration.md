...
|**SQL Debugging** (all but MPI Cluster Debugger)|Enables debugging of SQL procedures from your [!INCLUDE[vcprvc](../VS_csharp/includes/vcprvc_md.md)] application. Default setting is No.|  
...
|Setting|Description|  
|-------------|-----------------|  
|**Generate Debug Info** ([/DEBUG](../VS_csharp/-debug--generate-debug-info-.md))|Tells the linker to include debug information, which will have the format specified by /Z7, /Zd, Zi, or /ZI.|  
|**Generate Program Database File** ([/PDB:name](../VS_csharp/-pdb--use-program-database-.md))|Specify the name of a PDB file in this box. You must select ZI or /Zi for Debug Information Format.|  
|**Strip Private Symbols** ([/PDBSTRIPPED:filename](../VS_csharp/-pdbstripped--strip-private-symbols-.md))|Specify the name of a PDB file in this box if you do not want to include private symbols in the PDB file. This option creates a second program database (PDB) file when you build your program image with any of the compiler or linker options that generate a PDB file, such as /DEBUG, /Z7, /Zd. Or /Zi. This second PDB file omits symbols that you would not want to ship to your customers. For more information, see [/PDBSTRIPPED (Strip Private Symbols)](../VS_csharp/-pdbstripped--strip-private-symbols-.md).|  
|**Generate Map File** ([/MAP](../VS_csharp/-map--generate-mapfile-.md))|Tells the linker to generate a map file during linking. Default setting is No. For more information, see [/MAP (Generate Mapfile)](../VS_csharp/-map--generate-mapfile-.md).|  
|**Map File Name** ([/MAP:](../VS_csharp/-map--generate-mapfile-.md)*name*)|If you choose Generate Map File, you can specify the map file in this box. For more information, see [/MAP (Generate Mapfile)](../VS_csharp/-map--generate-mapfile-.md).|  
|**Map Exports** ([/MAPINFO:EXPORTS](../VS_csharp/-mapinfo--include-information-in-mapfile-.md))|Includes exported functions in the map file. Default setting is No. For more information, see [/MAPINFO (Include Information in Mapfile)](../VS_csharp/-mapinfo--include-information-in-mapfile-.md).|  
|**Debuggable Assembly** ([/ASSEMBLYDEBUG](../VS_csharp/-mapinfo--include-information-in-mapfile-.md))|Specifies settings for the Linker /ASSEMBLYDEBUG option. Possible values are as follows:<br /><br /> -   **No debuggable attribute emitted**.<br />-   **Runtime tracking and disable optimizations (/ASSEMBLYDEBUG)**. This is the default setting,<br />-   **No runtime tracking and enable optimizations(/ASSEMBLYDEBUG:DISABLE)**.<br />-   **<inherit from parent or project defaults\>**.<br />-   For more information, see [/ASSEMBLYDEBUG (Add DebuggableAttribute)](../VS_csharp/-assemblydebug--add-debuggableattribute-.md).|  
...
## See Also  
 ...
 [Debugger Settings and Preparation](../VS_csharp/debugger-settings-and-preparation.md)   
 [Creating and Managing Visual C++ Projects](../VS_csharp/creating-and-managing-visual-c---projects.md)   
 [/ASSEMBLYDEBUG (Add DebuggableAttribute)](../VS_csharp/-assemblydebug--add-debuggableattribute-.md)   
 [Macros for Build Commands and Properties](../VS_csharp/common-macros-for-build-commands-and-properties.md)