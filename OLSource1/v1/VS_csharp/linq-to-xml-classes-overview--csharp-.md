...
### XAttribute Class  
 \<xref:System.Xml.Linq.XAttribute> represents an XML attribute. For detailed information and examples, see [XAttribute Class Overview (C#)](../VS_csharp/xattribute-class-overview--csharp-.md).  
...
### XDocument Class  
 \<xref:System.Xml.Linq.XDocument> represents an XML document. For detailed information and examples, see [XDocument Class Overview (C#)](../VS_csharp/xdocument-class-overview--csharp-.md).  
  
### XDocumentType Class  
 \<xref:System.Xml.Linq.XDocumentType> represents an XML Document Type Definition (DTD).  
  
### XElement Class  
 \<xref:System.Xml.Linq.XElement> represents an XML element. For detailed information and examples, see [XElement Class Overview (C#)](../VS_csharp/xelement-class-overview--csharp-.md).  
  
### XName Class  
 \<xref:System.Xml.Linq.XName> represents names of elements (\<xref:System.Xml.Linq.XElement>) and attributes (\<xref:System.Xml.Linq.XAttribute>). For detailed information and examples, see [XDocument Class Overview (C#)](../VS_csharp/xdocument-class-overview--csharp-.md).  
