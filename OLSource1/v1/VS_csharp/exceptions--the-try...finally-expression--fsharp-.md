...
## Remarks  
 ...
 [!code[FsLangRef2#5701](../VS_csharp/codesnippet/FSharp/exceptions--the-try...finally-expression--fsharp-_1.fs)]  
...
```  
 ...
 [!code[FsLangRef2#5702](../VS_csharp/codesnippet/FSharp/exceptions--the-try...finally-expression--fsharp-_2.fs)]  
  
 In the context of computation expressions, including sequence expressions and asynchronous workflows, `try...finally` expressions can have a custom implementation. For more information, see [Computation Expressions (F#)](../VS_csharp/computation-expressions--fsharp-.md).  
  
## See Also  
 [Exception Handling](../VS_csharp/exception-handling--fsharp-.md)   
