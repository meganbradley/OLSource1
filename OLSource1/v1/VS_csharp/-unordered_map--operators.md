...
##  <a name="operator_neq"></a>  operator!=  
 Tests whether the [unordered_map](../VS_csharp/unordered_map-class.md) object on the left side of the operator is not equal to the unordered_map object on the right side.  
...
##  <a name="operator_eq_eq"></a>  operator==  
 Tests whether the [unordered_map](../VS_csharp/unordered_map-class.md) object on the left side of the operator is equal to the unordered_map object on the right side.  
...
##  <a name="operator_neq_multimap"></a>  operator!=  
 Tests whether the [unordered_multimap](../VS_csharp/unordered_multimap-class.md) object on the left side of the operator is not equal to the unordered_multimap object on the right side.  
...
##  <a name="operator_eq_eq_multimap"></a>  operator==  
 Tests whether the [unordered_multimap](../VS_csharp/unordered_multimap-class.md) object on the left side of the operator is equal to the unordered_multimap object on the right side.  
