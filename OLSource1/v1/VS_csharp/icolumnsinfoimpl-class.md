...
|||  
|-|-|  
|[GetColumnInfo](../VS_csharp/icolumnsinfoimpl--getcolumninfo.md)|Returns the column metadata needed by most consumers.|  
|[MapColumnIDs](../VS_csharp/icolumnsinfoimpl--mapcolumnids.md)|Returns an array of ordinals of the columns in a rowset that are identified by the specified column IDs.|  
