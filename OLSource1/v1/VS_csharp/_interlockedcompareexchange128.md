...
|---------------|------------------|  
|`_InterlockedCompareExchange128`|[!INCLUDE[vcprx64](../VS_csharp/includes/vcprx64_md.md)]|  
...
## See Also  
 ...
 [_InterlockedCompareExchange Intrinsic Functions](../VS_csharp/_interlockedcompareexchange-intrinsic-functions.md)   
