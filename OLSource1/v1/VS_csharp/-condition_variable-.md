...
---
# &lt;condition_variable&gt;
Defines the classes [condition_variable](../VS_csharp/condition_variable-class.md) and [condition_variable_any](../VS_csharp/condition_variable_any-class.md) that are used to create objects that wait for a condition to become true.  
...
## See Also  
 ...
 [condition_variable Class](../VS_csharp/condition_variable-class.md)   
 [condition_variable_any Class](../VS_csharp/condition_variable_any-class.md)   
 [cv_status Enumeration](../VS_csharp/-condition_variable--enums.md#cv_status_enumeration)