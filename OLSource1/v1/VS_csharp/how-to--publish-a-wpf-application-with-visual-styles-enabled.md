...
2.  Build and publish your solution. For more information about how to publish the solution, see [How to: Publish a ClickOnce Application using the Publish Wizard](../VS_csharp/how-to--publish-a-clickonce-application-using-the-publish-wizard.md).  
