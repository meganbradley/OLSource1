...
|[CTime::GetAsDBTIMESTAMP](#ctime__getasdbtimestamp)|Converts the time information stored in the                                         `CTime` object to a Win32-compatible                                         <xref:System.Data.OleDb.OleDbType.DBTimeStamp*> structure.|  
...
## Remarks  
 ...
 `CTime` values are based on coordinated universal time (UTC), which is equivalent to Coordinated Universal time (Greenwich Mean Time, GMT). See                 [Time Management](../VS_csharp/time-management.md) for information about how the time zone is determined.  
  
 When you create a                 `CTime` object, set the                 `nDST` parameter to 0 to indicate that standard time is in effect, or to a value larger than 0 to indicate that daylight saving time is in effect, or to a value less than zero to have the C run-time library code compute whether standard time or daylight saving time is in effect.                 `tm_isdst` is a required field. If not set, its value is undefined and the return value from                 [mktime](../VS_csharp/mktime--_mktime32--_mktime64.md) is unpredictable. If                 `timeptr` points to a tm structure returned by a previous call to                 [asctime_s](../VS_csharp/asctime_s--_wasctime_s.md),                 [_gmtime_s](../VS_csharp/gmtime_s--_gmtime32_s--_gmtime64_s.md), or                 [localtime_s](../VS_csharp/localtime_s--_localtime32_s--_localtime64_s.md), the                 `tm_isdst` field contains the correct value.  
  
 A companion class,                 [CTimeSpan](../VS_csharp/ctimespan-class.md), represents a time interval.  
...
>  The upper date limit is 12/31/3000. The lower limit is 1/1/1970 12:00:00 AM GMT.  
 ...
 For more information about using                 `CTime`, see the articles                 [Date and Time](../VS_csharp/date-and-time.md), and                 [Time Management](../VS_csharp/time-management.md) in the Run-Time Library Reference.  
...
### Example  
 [!code[NVC_ATLMFC_Utilities#161](../VS_csharp/codesnippet/CPP/ctime-class_1.cpp)]  
...
-   `nDST` set to a value less than 0   The default. Automatically computes whether standard time or daylight savings time is in effect.  
 ...
 `st`  
 A                                 [SYSTEMTIME](../VS_csharp/systemtime-structure.md) structure to be converted to a date/time value and copied into the new                                 `CTime` object.  
  
 `ft`  
 A                                 [FILETIME](../VS_csharp/filetime-structure.md) structure to be converted to a date/time value and copied into the new                                 `CTime` object.  
...
-   `CTime`(                                 **const FILETIME&** )                                **;** Constructs a                                 `CTime` object from a                                 `FILETIME` structure. You most likely will not use                                 `CTime` `FILETIME` initialization directly. If you use a                                 `CFile` object to manipulate a file,                                 `CFile::GetStatus` retrieves the file time stamp for you through a                                 `CTime` object initialized with a                                 `FILETIME` structure. This constructor assumes a time based on UTC and automatically converts the value to local time before storing the result.  
 ...
 For more information, see the                         [SYSTEMTIME](http://msdn.microsoft.com/library/windows/desktop/ms724950) and                         [FILETIME](http://msdn.microsoft.com/library/windows/desktop/ms724284) structure in the                         [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)]. Also see the                         [MS-DOS Date and Time](http://msdn.microsoft.com/library/windows/desktop/ms724503) entry in the                         [!INCLUDE[winsdkshort](../VS_csharp/includes/winsdkshort_md.md)].  
  
### Example  
 [!code[NVC_ATLMFC_Utilities#148](../VS_csharp/codesnippet/CPP/ctime-class_2.cpp)]  
...
### Example  
 [!code[NVC_ATLMFC_Utilities#149](../VS_csharp/codesnippet/CPP/ctime-class_3.cpp)]  
...
### Parameters  
 `pszFormat`  
 Specifies a formatting string similar to the                                 `printf` formatting string. See the run-time function                                 [strftime](../VS_csharp/strftime--wcsftime--_strftime_l--_wcsftime_l.md) for details.  
...
### Example  
 [!code[NVC_ATLMFC_Utilities#150](../VS_csharp/codesnippet/CPP/ctime-class_4.cpp)]  
...
### Example  
 [!code[NVC_ATLMFC_Utilities#151](../VS_csharp/codesnippet/CPP/ctime-class_5.cpp)]  
...
### Example  
 [!code[NVC_ATLMFC_Utilities#152](../VS_csharp/codesnippet/CPP/ctime-class_6.cpp)]  
...
### Example  
 [!code[NVC_ATLMFC_Utilities#153](../VS_csharp/codesnippet/CPP/ctime-class_7.cpp)]  
...
### Example  
 [!code[NVC_ATLMFC_Utilities#154](../VS_csharp/codesnippet/CPP/ctime-class_8.cpp)]  
...
### Return Value  
 A pointer to a filled-in                         **struct tm** as defined in the include file TIME.H. See                         [gmtime, _gmtime32, _gmtime64](../VS_csharp/gmtime--_gmtime32--_gmtime64.md) for the structure layout.  
...
### Example  
 [!code[NVC_ATLMFC_Utilities#155](../VS_csharp/codesnippet/CPP/ctime-class_9.cpp)]  
...
### Example  
 [!code[NVC_ATLMFC_Utilities#156](../VS_csharp/codesnippet/CPP/ctime-class_10.cpp)]  
...
### Example  
 [!code[NVC_ATLMFC_Utilities#157](../VS_csharp/codesnippet/CPP/ctime-class_11.cpp)]  
...
### Example  
 [!code[NVC_ATLMFC_Utilities#158](../VS_csharp/codesnippet/CPP/ctime-class_12.cpp)]  
...
### Example  
 [!code[NVC_ATLMFC_Utilities#159](../VS_csharp/codesnippet/CPP/ctime-class_13.cpp)]  
...
### Example  
 [!code[NVC_ATLMFC_Utilities#160](../VS_csharp/codesnippet/CPP/ctime-class_14.cpp)]  
...
## See Also  
 ...
 [_ftime_s, _ftime32_s, _ftime64_s](../VS_csharp/_ftime_s--_ftime32_s--_ftime64_s.md)   
 [_gmtime_s, _gmtime32_s, _gmtime64_s](../VS_csharp/gmtime_s--_gmtime32_s--_gmtime64_s.md)   
 [localtime_s, _localtime32_s, _localtime64_s](../VS_csharp/localtime_s--_localtime32_s--_localtime64_s.md)   
 [strftime](../VS_csharp/strftime--wcsftime--_strftime_l--_wcsftime_l.md)   
 [time](../VS_csharp/time--_time32--_time64.md)   
