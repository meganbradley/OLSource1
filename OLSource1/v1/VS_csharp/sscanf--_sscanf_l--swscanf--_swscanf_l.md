...
Read formatted data from a string. More secure versions of these functions are available; see [sscanf_s, _sscanf_s_l, swscanf_s , _swscanf_s_l](../VS_csharp/sscanf_s--_sscanf_s_l--swscanf_s--_swscanf_s_l.md).  
...
#### Parameters  
 ...
 `format`  
 Format-control string. For more information, see [Format Specifications](../VS_csharp/format-specification-fields--scanf-and-wscanf-functions.md).  
