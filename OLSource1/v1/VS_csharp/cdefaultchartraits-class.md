...
## Remarks  
 This class provides functions that are utilized by the class [CStringElementTraitsI](../VS_csharp/cstringelementtraitsi-class.md).  
...
### Example  
 [!code[NVC_ATL_Utilities#132](../VS_csharp/codesnippet/CPP/cdefaultchartraits-class_1.cpp)]  
