...
## Modeling  
 Reference link: **[Analyze and model your architecture](../VS_csharp/analyze-and-model-your-architecture.md)**  
  
 Design features are independent of coding language, or work with .NET languages like C#. See [Modeling Diagram Tools](../VS_csharp/scenario--change-your-design-using-visualization-and-modeling.md#ModelingDiagramsTools) for what aspects are related to code.  
...
|[Code analysis/Improve code quality (references, suggested changes, etc.)](../VS_csharp/improve-code-quality.md)|Yes||  
|[CodeLens](../VS_csharp/find-code-changes-and-other-history-with-codelens.md)|Yes|Except across platform-specific boundaries where the implementation isn’t resolved until run time.|  
|[Code maps](../VS_csharp/use-code-maps-to-debug-your-applications.md)|Yes||  
...
|Code coverage|n/a||  
|[Unit tests](../VS_csharp/unit-test-your-code.md)|Yes|For Windows and Android targets, the built-in MSTest tools can be used. To run unit tests on Windows, Android, and iOS, Xamarin recommends NUnit. See [Configuring TFS for Xamarin](http://developer.xamarin.com/guides/cross-platform/ci/configuring_tfs/) (Xamarin website).|  
|[Automated (Coded) UI tests](../VS_csharp/use-ui-automation-to-test-your-code.md)|Windows only|Visual Studio's UI test recorder is Windows only. For all platforms, see [Xamarin Test Recorder](https://www.xamarin.com/test-cloud/recorder).|  
  
## Improve code quality  
 Reference link: **[Improve code quality](../VS_csharp/improve-code-quality.md)**  
  
|Feature|Supported with Xamarin|Additional Comments|  
|-------------|----------------------------|-------------------------|  
|[Code quality analysis](../VS_csharp/analyzing-managed-code-quality-by-using-code-analysis.md)|Yes||  
|[Code clone detection](../VS_csharp/finding-duplicate-code-by-using-code-clone-detection.md)|Yes||  
|[Code metrics](../VS_csharp/measuring-complexity-and-maintainability-of-managed-code.md)|Yes||  
|[Performance profiling](../VS_csharp/performance-explorer.md)|No|Use the [Xamarin Profiler](http://developer.xamarin.com/guides/cross-platform/deployment,_testing,_and_metrics/) through Xamarin Studio instead. Note that the Xamarin Profiler is currently in preview and does not yet work for Windows targets.|  
|[.NET Framework memory analysis](../Topic/Analyze%20.NET%20Framework%20memory%20issues.md)|No|Visual Studio tools do not have hooks into the Mono framework for profiling.|  
