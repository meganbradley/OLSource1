...
## Example  
 See [iterator_traits](../VS_csharp/iterator_traits-struct.md) or [random_access_iterator_tag](../VS_csharp/random_access_iterator_tag-struct.md) for an example of how to use the **iterator_tag**s.  
...
## See Also  
 [input_iterator_tag Class](../VS_csharp/input_iterator_tag-struct.md)   
