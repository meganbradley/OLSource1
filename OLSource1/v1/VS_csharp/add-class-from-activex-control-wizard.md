 ...
 **Available ActiveX controls**  
 Specifies the ActiveX controls currently registered in the system. Select an ActiveX control from this list to display its interfaces in the **Interfaces** list. See [MFC ActiveX Controls: Distributing ActiveX Controls](../VS_csharp/mfc-activex-controls--distributing-activex-controls.md) for more information about registering ActiveX controls.  
...
## See Also  
 [Adding a Class from an ActiveX Control](../VS_csharp/adding-a-class-from-an-activex-control--visual-c---.md)   
