...
|Method|Description|  
|------------|-----------------|  
|[PublishProgramNode](../VS_csharp/idebugprogrampublisher2--publishprogramnode.md)|Makes a program node available to DEs and the session debug manager (SDM).|  
|[UnpublishProgramNode](../VS_csharp/idebugprogrampublisher2--unpublishprogramnode.md)|Removes a program node so that it is no longer available.|  
|[PublishProgram](../VS_csharp/idebugprogrampublisher2--publishprogram.md)|Makes a program available to DEs and the SDM.|  
|[UnpublishProgram](../VS_csharp/idebugprogrampublisher2--unpublishprogram.md)|Removes a program so it is no longer available.|  
|[SetDebuggerPresent](../VS_csharp/idebugprogrampublisher2--setdebuggerpresent.md)|Sets a flag indicating that a debugger is present.|  
  
## Remarks  
 This interface makes programs and program nodes available (that is, "publishes" them) for use by DEs and the session debug manager (SDM). To access published programs and program nodes, use the [IDebugProgramProvider2](../VS_csharp/idebugprogramprovider2.md) interface. This is the only way Visual Studio can recognize that a program is being debugged.  
...
## See Also  
 ...
 [IDebugProgramProvider2](../VS_csharp/idebugprogramprovider2.md)