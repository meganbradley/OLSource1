...
option is no longer supported; ignored  
 ...
 For example, LNK4224 can occur if a /comment directive appears in .obj. The /comment directive would have been added via the [comment (C/C++)](../VS_csharp/comment--c-c---.md) pragma, using the deprecated exestr option. Use dumpbin [/ALL](../VS_csharp/-all.md) to view the linker directives in an .obj file.  
