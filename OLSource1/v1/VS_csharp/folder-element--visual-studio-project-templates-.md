...
|[ProjectItem](../VS_csharp/projectitem-element--visual-studio-item-templates-.md)|Specifies a file to add to the project.|  
  
### Parent Elements  
  
|Element|Description|  
|-------------|-----------------|  
|[Project](../VS_csharp/project-element--visual-studio-templates-.md)|Optional child element of [TemplateContent](../VS_csharp/templatecontent-element--visual-studio-templates-.md).|  
...
## Example  
 The following example illustrates the metadata for a project template for a [!INCLUDE[csprcs](../VS_csharp/includes/csprcs_md.md)] Windows application.  
