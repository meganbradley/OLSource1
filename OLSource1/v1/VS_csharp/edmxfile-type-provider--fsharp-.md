...
## Remarks  
 ...
 For a walkthrough that shows how to use the EdmxFile type provider, see [Walkthrough: Generating F# Types from an EDMX Schema File (F#)](../VS_csharp/walkthrough--generating-fsharp-types-from-an-edmx-schema-file--fsharp-.md).  
