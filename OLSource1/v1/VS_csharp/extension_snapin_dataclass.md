...
## Remarks  
 This class should also be entered into a snap-in extension data class map. Start your snap-in extension data class map with the [BEGIN_EXTENSION_SNAPIN_NODEINFO_MAP](../VS_csharp/begin_extension_snapin_nodeinfo_map.md) macro, add entries for each of your snap-in extension data types with the [EXTENSION_SNAPIN_NODEINFO_ENTRY](../VS_csharp/extension_snapin_nodeinfo_entry.md) macro, and complete the map with the [END_EXTENSION_SNAPIN_NODEINFO_MAP](../VS_csharp/end_extension_snapin_nodeinfo_map.md) macro.  
  
## Example  
 [!code[NVC_ATL_Windowing#105](../VS_csharp/codesnippet/CPP/extension_snapin_dataclass_1.h)]  
