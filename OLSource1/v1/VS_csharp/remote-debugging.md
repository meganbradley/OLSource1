...
2.  When you start the remote tools for the first time (or before you have configured it), the **Remote Debugging Configuration** dalog box appears.  
     ...
     ![RemoteDebuggerConfWizardPage](../VS_csharp/media/remotedebuggerconfwizardpage.png "RemoteDebuggerConfWizardPage")  
...
6.  When configuration is complete, the Remote Debugger window appears.  
     ...
     ![RemoteDebuggerWindow](../VS_csharp/media/remotedebuggerwindow.png "RemoteDebuggerWindow")  
...
-   To change the Authentication mode or the port number, or to specify a timeout value for the remote tools: choose Tools / Options.  
     ...
     For a listing of the port numbers used by default, see [Remote Debugger Port Assignments](../VS_csharp/remote-debugger-port-assignments.md).  
...
4.  Set the **Debugger to launch** to **Remote Windows Debugger**.  
     ...
     ![RemoteDebuggingCPlus](../VS_csharp/media/remotedebuggingcplus.png "RemoteDebuggingCPlus")  
...
7.  For the **Debug** configuration, select the **Deploy** check box.  
     ...
     ![RemoteDebugCplusDeploy](../VS_csharp/media/remotedebugcplusdeploy.png "RemoteDebugCplusDeploy")  
...
4.  On the **Properties** page, choose the **Debug** tab.  
     ...
     ![RemoteDebuggerCSharp](../VS_csharp/media/remotedebuggercsharp.png "RemoteDebuggerCSharp")  
...
## Remote debug an ASP.NET application  
 ...
 For remote computers running Windows 7 or Windows Server 2008 that have IIS 7.5 installed, please see [Remote Debugging ASP.NET on a Remote IIS 7.5 Computer](../VS_csharp/remote-debugging-asp.net-on-a-remote-iis-7.5-computer.md).  
...
## See Also  
 ...
 [Configure the Windows Firewall for Remote Debugging](../VS_csharp/configure-the-windows-firewall-for-remote-debugging.md)   
 [Remote Debugger Port Assignments](../VS_csharp/remote-debugger-port-assignments.md)   
 [Remote Debugging ASP.NET on a Remote IIS 7.5 Computer](../VS_csharp/remote-debugging-asp.net-on-a-remote-iis-7.5-computer.md)   
 [Remote Debugging Errors and Troubleshooting](../VS_csharp/remote-debugging-errors-and-troubleshooting.md)