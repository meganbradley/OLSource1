...
##  <a name="operator_neq"></a>  operator!=  
 Tests whether the [unordered_set](../VS_csharp/unordered_set-class.md) object on the left side of the operator is not equal to the unordered_set object on the right side.  
...
##  <a name="operator_eq_eq"></a>  operator==  
 Tests whether the [unordered_set](../VS_csharp/unordered_set-class.md) object on the left side of the operator is equal to the unordered_set object on the right side.  
...
##  <a name="operator_neq_unordered_multiset"></a>  operator!=  
 Tests whether the [unordered_multiset](../VS_csharp/unordered_multiset-class.md) object on the left side of the operator is not equal to the unordered_multiset object on the right side.  
...
##  <a name="operator_eq_eq_unordered_multiset"></a>  operator==  
 Tests whether the [unordered_multiset](../VS_csharp/unordered_multiset-class.md) object on the left side of the operator is equal to the unordered_multiset object on the right side.  
