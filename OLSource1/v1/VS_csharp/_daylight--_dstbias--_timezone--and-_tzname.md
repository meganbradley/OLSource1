...
|---------------------|---------------------------|  
|`_daylight`|[_get_daylight](../VS_csharp/_get_daylight.md)|  
|`_dstbias`|[_get_dstbias](../VS_csharp/_get_dstbias.md)|  
|`_timezone`|[_get_timezone](../VS_csharp/_get_timezone.md)|  
|`_tzname`|[_get_tzname](../VS_csharp/_get_tzname.md)|  
...
## Remarks  
 On a call to `_ftime`, `localtime`, or `_tzset`, the values of `_daylight`, `_dstbias`, `_timezone`, and `_tzname` are determined from the value of the `TZ` environment variable. If you do not explicitly set the value of `TZ`, `_tzname[0]` and `_tzname[1]` contain the default settings of "PST" and "PDT" respectively.  The time-manipulation functions ([_tzset](../VS_csharp/_tzset.md), [_ftime](../VS_csharp/_ftime--_ftime32--_ftime64.md), and [localtime](../VS_csharp/localtime--_localtime32--_localtime64.md)) attempt to set the values of `_daylight`, `_dstbias` and `_timezone` by querying the operating system for the default value of each variable. The time-zone global variable values are shown in the following table.  
