...
#### Parameters  
 ...
 `entry`  
 Pointer to a [CreatorMap](../VS_csharp/creatormap-structure.md) that contains initialization and registration information about parameter `riid`.  
...
## See Also  
 [Details Namespace](../VS_csharp/microsoft--wrl--wrappers--details-namespace.md)