...
|[CMFCPopupMenu::GetMenuBar](#cmfcpopupmenu__getmenubar)|Returns the [CMFCPopupMenuBar](../VS_csharp/cmfcpopupmenubar-class.md) embedded inside the pop-up menu.|  
...
|[CMFCPopupMenu::IsQuickCustomize](#cmfcpopupmenu__isquickcustomize)|Determines whether the associated [CMFCToolBarMenuButton Class](../VS_csharp/cmfctoolbarmenubutton-class.md) is in QuickCustomize mode.|  
...
|[CMFCPopupMenu::RecalcLayout](#cmfcpopupmenu__recalclayout)|Called by the framework when the standard control bars are toggled on or off or when the frame window is resized. (Overrides [CFrameWnd::RecalcLayout](../VS_csharp/cframewnd-class.md#cframewnd__recalclayout).)|  
...
##  <a name="cmfcpopupmenu__cmfcpopupmenu"></a>  CMFCPopupMenu::CMFCPopupMenu  
 Constructs a [CMFCPopupMenu](../VS_csharp/cmfcpopupmenu-class.md) object.  
...
##  <a name="cmfcpopupmenu__create"></a>  CMFCPopupMenu::Create  
 Creates a pop-up menu and attaches it to a [CMFCPopupMenu](../VS_csharp/cmfcpopupmenu-class.md) object.  
...
### Example  
 The following example demonstrates how to use the `Create` method of the `CMFCPopuMenu` class. This code snippet is part of the [Custom Pages sample](../VS_csharp/visual-c---samples.md).  
  
 [!code[NVC_MFC_CustomPages#1](../VS_csharp/codesnippet/CPP/cmfcpopupmenu-class_2.cpp)]  
...
### Remarks  
 To display the logo, implement the method [CFrameWndEx::OnDrawMenuLogo](../VS_csharp/cframewndex-class.md#cframewndex__ondrawmenulogo) in the main frame window.  
...
### Parameters  
 [in] `bNoSystem`  
 A Boolean parameter that indicates whether this method checks the global value. FALSE if you want this method to return the animation style for this instance of the [CMFCPopupMenu Class](../VS_csharp/cmfcpopupmenu-class.md).  
...
##  <a name="cmfcpopupmenu__getmenubar"></a>  CMFCPopupMenu::GetMenuBar  
 Returns the [CMFCPopupMenuBar](../VS_csharp/cmfcpopupmenubar-class.md) embedded inside the pop-up menu.  
...
### Remarks  
 Menu items are represented by the [CMFCToolBarMenuButton Class](../VS_csharp/cmfctoolbarmenubutton-class.md). When you call this method, it returns a pointer to the appropriate `CMFCToolBarMenuButton`.  
...
### Remarks  
 A [CMFCPopupMenu](../VS_csharp/cmfcpopupmenu-class.md) can be associated with a button on the menu. In this scenario, the pop-up menu appears when a user selects the parent toolbar button.  
...
### Return Value  
 A pointer to the parent [CMFCPopupMenu](../VS_csharp/cmfcpopupmenu-class.md) object; `NULL` if there is no parent pop-up menu.  
...
### Remarks  
 If the [CMFCPopupMenu](../VS_csharp/cmfcpopupmenu-class.md) is a shortcut menu, then it has no parent toolbar.  
...
### Remarks  
 The menu commands on a pop-up menu are represented by the [CMFCToolBarMenuButton Class](../VS_csharp/cmfctoolbarmenubutton-class.md), or a class derived from `CMFCToolBarMenuButton`.  
...
### Remarks  
 This method specifies only whether a pop-up menu can hide rarely used commands, not if that configuration is enabled. A pop-up menu can hide rarely used commands if it has a parent button and the parent window is derived from the [CMFCMenuBar Class](../VS_csharp/cmfcmenubar-class.md). Use [CMFCMenuBar::SetRecentlyUsedMenus](../VS_csharp/cmfcmenubar-class.md#cmfcmenubar__setrecentlyusedmenus) to enable this feature and [CMFCMenuBar::IsRecentlyUsedMenus](../VS_csharp/cmfcmenubar-class.md#cmfcmenubar__isrecentlyusedmenus) to determine if this feature is currently enabled. You must call both of these methods for the parent window.  
...
### Remarks  
 Use the **QuickCustomizePane** to enable the user to directly customize the pop-up menu. The **QuickCustomizePane** is a [CMFCPopupMenu](../VS_csharp/cmfcpopupmenu-class.md) that appears when the user clicks on a toolbar button to edit it directly.  
  
 Your application should call this method during [CMDIFrameWndEx::OnShowCustomizePane](../VS_csharp/cmdiframewndex-class.md#cmdiframewndex__onshowcustomizepane).  
...
##  <a name="cmfcpopupmenu__isquickcustomize"></a>  CMFCPopupMenu::IsQuickCustomize  
 Determines whether the associated [CMFCToolBarMenuButton Class](../VS_csharp/cmfctoolbarmenubutton-class.md) is in QuickCustomize mode.  
...
### Remarks  
 This method automatically arranges any separators that are affected by the removal of an item. For more information about how the framework rearranges separators, see [CMFCToolBar::RemoveButton](../VS_csharp/cmfctoolbar-class.md#cmfctoolbar__removebutton).  
...
## See Also  
 ...
 [CMFCPopupMenuBar Class](../VS_csharp/cmfcpopupmenubar-class.md)