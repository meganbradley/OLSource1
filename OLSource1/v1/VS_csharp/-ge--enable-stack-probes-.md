...
## Remarks  
 This mechanism is useful if you rewrite the functionality of the stack probe. It is recommended that you use [/Gh (Enable _penter Hook Function)](../VS_csharp/-gh--enable-_penter-hook-function-.md) instead of rewriting the stack probe.  
  
 [/Gs (Control Stack Checking Calls)](../VS_csharp/-gs--control-stack-checking-calls-.md) has the same effect.  
