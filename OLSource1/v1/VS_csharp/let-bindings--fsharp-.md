...
## Remarks  
 ...
 [!code[FsLangRef1#1101](../VS_csharp/codesnippet/FSharp/let-bindings--fsharp-_1.fs)]  
 ...
 [!code[FsLangRef1#1102](../VS_csharp/codesnippet/FSharp/let-bindings--fsharp-_2.fs)]  
  
 Instead of just a name, a pattern that contains names can be specified, for example, a tuple, as shown in the following code.  
  
 [!code[FsLangRef1#1103](../VS_csharp/codesnippet/FSharp/let-bindings--fsharp-_3.fs)]  
 ...
 [!code[FsLangRef1#1104](../VS_csharp/codesnippet/FSharp/let-bindings--fsharp-_4.fs)]  
 ...
 [!code[FsLangRef1#1105](../VS_csharp/codesnippet/FSharp/let-bindings--fsharp-_5.fs)]  
...
## Function Bindings  
 ...
 [!code[FsLangRef1#1106](../VS_csharp/codesnippet/FSharp/let-bindings--fsharp-_6.fs)]  
  
 In general, parameters are patterns, such as a tuple pattern:  
  
 [!code[FsLangRef1#1107](../VS_csharp/codesnippet/FSharp/let-bindings--fsharp-_7.fs)]  
 ...
 [!code[FsLangRef1#1109](../VS_csharp/codesnippet/FSharp/let-bindings--fsharp-_8.fs)]  
  
 For more information, see [Functions (F#)](../VS_csharp/functions--fsharp-.md).  
...
## Type Annotations  
 ...
 [!code[FsLangRef1#1108](../VS_csharp/codesnippet/FSharp/let-bindings--fsharp-_9.fs)]  
 ...
 For more information, see [Automatic Generalization](../VS_csharp/automatic-generalization--fsharp-.md) and [Type Inference](../VS_csharp/type-inference--fsharp-.md).  
...
## let Bindings in Classes  
 ...
 [!code[FsLangRef1#1110](../VS_csharp/codesnippet/FSharp/let-bindings--fsharp-_10.fs)]  
  
 The scopes of `field1` and `field2` are limited to the type in which they are declared. For more information, see [Let Bindings in Classes](../VS_csharp/let-bindings-in-classes--fsharp-.md) and [Classes (F#)](../VS_csharp/classes--fsharp-.md).  
  
## Type Parameters in let Bindings  
 A `let` binding at the module level, in a type, or in a computation expression can have explicit type parameters. A let binding in an expression, such as within a function definition, cannot have type parameters. For more information, see [Generics](../VS_csharp/generics--fsharp-.md).  
  
## Attributes on let Bindings  
 Attributes can be applied to top-level `let` bindings in a module, as shown in the following code.  
  
 [!code[FsLangRef1#1111](../VS_csharp/codesnippet/FSharp/let-bindings--fsharp-_11.fs)]  
...
```  
 ...
 Some modules have the attribute [RequireQualifiedAccess](../VS_csharp/core.requirequalifiedaccessattribute-class--fsharp-.md), which means that the functions that they expose must be qualified with the name of the module. For example, the F# List module has this attribute.  
  
 For more information on modules and access control, see [Modules (F#)](../VS_csharp/modules--fsharp-.md) and [Access Control (F#)](../VS_csharp/access-control--fsharp-.md).  
