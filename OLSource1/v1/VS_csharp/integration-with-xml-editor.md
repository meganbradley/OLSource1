...
-   In the Graph View and the XML Schema Explorer, double-click a node, or right-click a node and select **View Code**. In the Content Model View, right-click a node and select **View Code**.  
 ...
 ![XSDDesignerWithXMLEditor](../VS_csharp/media/xsddesignerwithxmleditor.gif "XSDDesignerWithXMLEditor")  
 ...
 ![XSDDesignerWithXMLEditorAndCMV](../VS_csharp/media/xsddesignerwithxmleditorandcmv.gif "XSDDesignerWithXMLEditorAndCMV")  
