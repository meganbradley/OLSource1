...
## Remarks  
 ...
 The `reinterpret_cast` operator cannot cast away the **const**, `volatile`, or **__unaligned** attributes. See [const_cast Operator](../VS_csharp/const_cast-operator.md) for information on removing these attributes.  
