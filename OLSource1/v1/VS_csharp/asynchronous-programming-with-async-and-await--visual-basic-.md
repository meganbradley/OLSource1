...
##  <a name="BKMK_HowtoWriteanAsyncMethod"></a> Async Methods Are Easier to Write  
 The [Async](../VS_csharp/async--visual-basic-.md) and [Await](../VS_csharp/async--visual-basic-.md) keywords in Visual Basic are the heart of async programming. By using those two keywords, you can use resources in the .NET Framework or the Windows Runtime to create an asynchronous method almost as easily as you create a synchronous method. Asynchronous methods that you define by using `Async` and `Await` are referred to as async methods.  
...
-   The return type is one of the following types:  
    ...
    -   [Sub](../VS_csharp/sub-procedures--visual-basic-.md) if you're writing an async event handler.  
...
##  <a name="BKMK_WhatHappensUnderstandinganAsyncMethod"></a> What Happens in an Async Method  
 ...
 ![Trace an async program](../VS_csharp/media/navigationtrace.png "NavigationTrace")  
...
8.  When `AccessTheWebAsync` has the string result, the method can calculate the length of the string. Then the work of `AccessTheWebAsync` is also complete, and the waiting event handler can resume. In the full example at the end of the topic, you can confirm that the event handler retrieves and prints the value of the length result.  
 ...
 For more information about control flow, see [Control Flow in Async Programs (Visual Basic)](../VS_csharp/control-flow-in-async-programs--visual-basic-.md).  
...
-   [Async (Visual Basic)](../VS_csharp/async--visual-basic-.md)  
  
-   [Await Operator (Visual Basic)](../VS_csharp/await-operator--visual-basic-.md)  
...
##  <a name="BKMK_ReturnTypesandParameters"></a> Return Types and Parameters  
 ...
 You specify <xref:System.Threading.Tasks.Task`1*> as the return type if the method contains a [Return](../VS_csharp/return-statement--visual-basic-.md) statement that specifies an operand of type `TResult`.  
...
```  
 ...
 An async method can't declare [ByRef](../VS_csharp/byref--visual-basic-.md) parameters, but the method can call methods that have such parameters.  
  
 For more information and examples, see [Async Return Types (Visual Basic)](../VS_csharp/async-return-types--visual-basic-.md). For more information about how to catch exceptions in async methods, see [Try...Catch...Finally Statement (Visual Basic)](../VS_csharp/try...catch...finally-statement--visual-basic-.md).  
...
|-----------|-----------------|------------|  
|[Walkthrough: Accessing the Web by Using Async and Await (Visual Basic)](../VS_csharp/walkthrough--accessing-the-web-by-using-async-and-await--visual-basic-.md)|Shows how to convert a synchronous WPF solution to an asynchronous WPF solution. The application downloads a series of websites.|[Async Sample: Accessing the Web Walkthrough](http://go.microsoft.com/fwlink/p/?LinkID=255191&clcid=0x409)|  
|[How to: Extend the Async Walkthrough by Using Task.WhenAll (Visual Basic)](../VS_csharp/how-to--extend-the-async-walkthrough-by-using-task.whenall--visual-basic-.md)|Adds <xref:System.Threading.Tasks.Task.WhenAll*?displayProperty=fullName> to the previous walkthrough. The use of `WhenAll` starts all the downloads at the same time.||  
|[How to: Make Multiple Web Requests in Parallel by Using Async and Await (Visual Basic)](../VS_csharp/how-to--make-multiple-web-requests-in-parallel-by-using-async-and-await--visual-basic-.md)|Demonstrates how to start several tasks at the same time.|[Async Sample: Make Multiple Web Requests in Parallel](http://go.microsoft.com/fwlink/p/?LinkID=254906&clcid=0x409)|  
|[Async Return Types (Visual Basic)](../VS_csharp/async-return-types--visual-basic-.md)|Illustrates the types that async methods can return and explains when each type is appropriate.||  
|[Control Flow in Async Programs (Visual Basic)](../VS_csharp/control-flow-in-async-programs--visual-basic-.md)|Traces in detail the flow of control through a succession of await expressions in an asynchronous program.|[Async Sample: Control Flow in Async Programs](http://go.microsoft.com/fwlink/p/?LinkID=255285&clcid=0x409)|  
|[Fine-Tuning Your Async Application (Visual Basic)](../VS_csharp/fine-tuning-your-async-application--visual-basic-.md)|Shows how to add the following functionality to your async solution:<br /><br /> -   [Cancel an Async Task or a List of Tasks (Visual Basic)](../VS_csharp/cancel-an-async-task-or-a-list-of-tasks--visual-basic-.md)<br />-   [Cancel Async Tasks after a Period of Time (Visual Basic)](../VS_csharp/cancel-async-tasks-after-a-period-of-time--visual-basic-.md)<br />-   [Cancel Remaining Async Tasks after One Is Complete (Visual Basic)](../VS_csharp/cancel-remaining-async-tasks-after-one-is-complete--visual-basic-.md)<br />-   [Start Multiple Async Tasks and Process Them As They Complete (Visual Basic)](../VS_csharp/start-multiple-async-tasks-and-process-them-as-they-complete--visual-basic-.md)|[Async Sample: Fine Tuning Your Application](http://go.microsoft.com/fwlink/p/?LinkID=255046&clcid=0x409)|  
|[Handling Reentrancy in Async Apps (Visual Basic)](../VS_csharp/handling-reentrancy-in-async-apps--visual-basic-.md)|Shows how to handle cases in which an active asynchronous operation is restarted while it’s running.||  
|[WhenAny: Bridging between the .NET Framework and the Windows Runtime (Visual Basic)](../Topic/WhenAny:%20Bridging%20between%20the%20.NET%20Framework%20and%20the%20Windows%20Runtime%20\(Visual%20Basic\).md)|Shows how to bridge between Task types in the .NET Framework and IAsyncOperations in the [!INCLUDE[wrt](../VS_csharp/includes/wrt_md.md)] so that you can use <xref:System.Threading.Tasks.Task.WhenAny*> with a [!INCLUDE[wrt](../VS_csharp/includes/wrt_md.md)] method.|[Async Sample: Bridging between .NET and Windows Runtime (AsTask and WhenAny)](http://go.microsoft.com/fwlink/p/?LinkID=260638)|  
|[Async Cancellation: Bridging between the .NET Framework and the Windows Runtime (Visual Basic)](../Topic/Async%20Cancellation:%20Bridging%20between%20the%20.NET%20Framework%20and%20the%20Windows%20Runtime%20\(Visual%20Basic\).md)|Shows how to bridge between Task types in the .NET Framework and IAsyncOperations in the [!INCLUDE[wrt](../VS_csharp/includes/wrt_md.md)] so that you can use <xref:System.Threading.CancellationTokenSource*> with a [!INCLUDE[wrt](../VS_csharp/includes/wrt_md.md)] method.|[Async Sample: Bridging between .NET and Windows Runtime (AsTask & Cancellation)](http://go.microsoft.com/fwlink/p/?LinkId=263004)|  
|[Using Async for File Access (Visual Basic)](../VS_csharp/using-async-for-file-access--visual-basic-.md)|Lists and demonstrates the benefits of using async and await to access files.||  
||||  
