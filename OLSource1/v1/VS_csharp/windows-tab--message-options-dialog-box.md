...
Use the **Windows** tab to set the scope of the messages listed in [Messages View](../VS_csharp/messages-view.md). To display the [Message Options Dialog Box](../VS_csharp/message-options-dialog-box.md), choose **Log Messages** from the **Spy** menu.  
