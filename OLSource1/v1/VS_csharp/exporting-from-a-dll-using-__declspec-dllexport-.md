 ...
 **__declspec(dllexport)** stores function names in the DLL's export table. If you want to optimize the table's size, see [Exporting Functions from a DLL by Ordinal Rather Than by Name](../VS_csharp/exporting-functions-from-a-dll-by-ordinal-rather-than-by-name.md).  
...
-   [The __declspec keyword](../VS_csharp/__declspec.md)  
