...
|[CWnd::GetNextDlgTabItem](#cwnd__getnextdlgtabitem)|Retrieves the first control with the [WS_TABSTOP](../VS_csharp/window-styles.md) style that follows (or precedes) the specified control.|  
...
|[CWnd::OnCharToItem](#cwnd__onchartoitem)|Called by a child list box with the [LBS_WANTKEYBOARDINPUT](../VS_csharp/list-box-styles.md) style in response to a [WM_CHAR](#cwnd__onchar) message.|  
...
## Remarks  
 ...
 Within the Microsoft Foundation Class Library, further classes are derived from `CWnd` to provide specific window types. Many of these classes, including [CFrameWnd](../VS_csharp/cframewnd-class.md), [CMDIFrameWnd](../VS_csharp/cmdiframewnd-class.md), [CMDIChildWnd](../VS_csharp/cmdichildwnd-class.md), [CView](../VS_csharp/cview-class.md), and [CDialog](../VS_csharp/cdialog-class.md), are designed for further derivation. The control classes derived from `CWnd`, such as [CButton](../VS_csharp/cbutton-class.md), can be used directly or can be used for further derivation of classes.  
  
 For more information on using `CWnd`, see [Frame Windows](../VS_csharp/frame-windows.md) and [Window Objects](../VS_csharp/window-objects.md).  
...
### Return Value  
 Returns S_OK on success, a COM error code on failure. See                         **Return Values** in                         [IAccessible::accDoDefaultAction](http://msdn.microsoft.com/library/windows/desktop/dd318470) in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
  
### Remarks  
 This function is part of MFC's                         [Active Accessibility](http://msdn.microsoft.com/library/windows/desktop/dd373592) support.  
  
 Override this function in your `CWnd`-derived class to perform your object's default action. For more information, see                         [IAccessible::accDoDefaultAction](http://msdn.microsoft.com/library/windows/desktop/dd318470) in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Parameters  
 ...
 `pvarChild`  
 Receives information identifying the object at the point specified by `xLeft` and `yTop`. See                                 *pvarID* in                                 [IAccessible::accHitTest](http://msdn.microsoft.com/library/windows/desktop/dd318471) in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
  
### Return Value  
 Returns S_OK on success, a COM error code on failure. See                         **Return Values** in **IAccessible::accHitTest** in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Remarks  
 ...
 For more information, see                         [IAccessible::accHitTest](http://msdn.microsoft.com/library/windows/desktop/dd318471) in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Return Value  
 Returns S_OK on success, a COM error code on failure. See                         **Return Values** in **IAccessible::accLocation** in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
  
### Remarks  
 Override this function in your `CWnd`-derived class if you have nonwindowed user interface elements (other than windowless ActiveX controls, which MFC handles).  
  
 For more information, see **IAccessible::accLocation** in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Parameters  
 `navDir`  
 Specifies the direction to navigate. See `navDir` in                                 [IAccessible::accNavigate](http://msdn.microsoft.com/library/windows/desktop/dd318473) in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
  
 `varStart`  
 Specifies the starting object. See `varStart` in **IAccessible::accNavigate** in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
  
 *pvarEndUpAt*  
 Receives information about the destination user interface object. See                                 *pvarEnd* in **IAccessible::accNavigate** in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
  
### Return Value  
 Returns S_OK on success, a COM error code on failure. See                         **Return Values** in  **IAccessible::accNavigate** in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Remarks  
 ...
 For more information, see                         [IAccessible::accNavigate](http://msdn.microsoft.com/library/windows/desktop/dd318473) in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Parameters  
 `flagsSelect`  
 Specifies how to change the current selection or focus. See `flagsSelect` in                                 [IAccessible::accSelect](http://msdn.microsoft.com/library/windows/desktop/dd318474) in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Return Value  
 Returns S_OK on success, a COM error code on failure. See                         **Return Values** in **IAccessible::accSelect** in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Remarks  
 ...
 For more information, see                         [IAccessible::accSelect](http://msdn.microsoft.com/library/windows/desktop/dd318474) in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Remarks  
 This member function emulates the functionality of the function                         [AnimateWindow](http://msdn.microsoft.com/library/windows/desktop/ms632669), as described in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Remarks  
 ...
 To arrange iconic MDI child windows in an MDI client window, call [CMDIFrameWnd::MDIIconArrange](../VS_csharp/cmdiframewnd-class.md#cmdiframewnd__mdiiconarrange).  
  
### Example  
 [!code[NVC_MFCWindowing#66](../VS_csharp/codesnippet/CPP/cwnd-class_1.cpp)]  
...
### Example  
 ...
 [!code[NVC_MFCWindowing#67](../VS_csharp/codesnippet/CPP/cwnd-class_2.h)]  
  
 [!code[NVC_MFCWindowing#68](../VS_csharp/codesnippet/CPP/cwnd-class_3.cpp)]  
  
 [!code[NVC_MFCWindowing#69](../VS_csharp/codesnippet/CPP/cwnd-class_4.cpp)]  
...
### Parameters  
 `lpPaint`  
 Points to the [PAINTSTRUCT](../VS_csharp/paintstruct-structure.md) structure that is to receive painting information.  
...
### Remarks  
 The paint structure contains a [RECT](../VS_csharp/rect-structure.md) data structure that has the smallest rectangle that completely encloses the update region and a flag that specifies whether the background has been erased.  
...
### Example  
 [!code[NVC_MFCWindowing#70](../VS_csharp/codesnippet/CPP/cwnd-class_5.cpp)]  
...
### Example  
 ...
 [!code[NVC_MFC_AxDataBinding#1](../VS_csharp/codesnippet/CPP/cwnd-class_6.cpp)]  
[!code[NVC_MFC_AxDataBinding#2](../VS_csharp/codesnippet/CPP/cwnd-class_7.cpp)]  
[!code[NVC_MFC_AxDataBinding#3](../VS_csharp/codesnippet/CPP/cwnd-class_8.cpp)]  
...
### Example  
 ...
 [!code[NVC_MFC_AxDataBinding#1](../VS_csharp/codesnippet/CPP/cwnd-class_6.cpp)]  
[!code[NVC_MFC_AxDataBinding#4](../VS_csharp/codesnippet/CPP/cwnd-class_9.cpp)]  
[!code[NVC_MFC_AxDataBinding#3](../VS_csharp/codesnippet/CPP/cwnd-class_8.cpp)]  
...
### Example  
 [!code[NVC_MFCWindowing#71](../VS_csharp/codesnippet/CPP/cwnd-class_10.cpp)]  
...
### Example  
 [!code[NVC_MFCWindowing#72](../VS_csharp/codesnippet/CPP/cwnd-class_11.cpp)]  
...
### Example  
 [!code[NVC_MFCWindowing#73](../VS_csharp/codesnippet/CPP/cwnd-class_12.cpp)]  
...
### Example  
 [!code[NVC_MFCWindowing#75](../VS_csharp/codesnippet/CPP/cwnd-class_14.cpp)]  
...
### Example  
 [!code[NVC_MFCWindowing#76](../VS_csharp/codesnippet/CPP/cwnd-class_15.cpp)]  
...
### Example  
 [!code[NVC_MFCWindowing#77](../VS_csharp/codesnippet/CPP/cwnd-class_16.cpp)]  
...
### Parameters  
 `lpPoint`  
 Points to a [POINT](../VS_csharp/point-structure.md) structure or `CPoint` object that contains the client coordinates to be converted.  
  
 `lpRect`  
 Points to a [RECT](../VS_csharp/rect-structure.md) structure or `CRect` object that contains the client coordinates to be converted.  
...
### Example  
 [!code[NVC_MFCWindowing#78](../VS_csharp/codesnippet/CPP/cwnd-class_17.cpp)]  
...
### Remarks  
 This member function emulates the functionality of the function                         [CloseWindow](http://msdn.microsoft.com/library/windows/desktop/ms632678), as described in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
##  <a name="cwnd__create"></a>  CWnd::Create  
 Creates the specified child window and attaches it to the [CWnd](../VS_csharp/cwnd-class.md) object.  
...
### Parameters  
 ...
 [in] `dwStyle`  
 Bitwise combination (OR) of [window styles](../VS_csharp/window-styles.md). The `WS_POPUP` option is not a valid style.  
 ...
 [in] `pContext`  
 Pointer to a [CCreateContext](../VS_csharp/ccreatecontext-structure.md) structure that is used to customize the document-view architecture for the application.  
...
>  This change fixes a crash in managed/native interop scenarios. A `TRACE` statement in `CWnd::Create` alerts the developer of the problem.  
 ...
 Use the [AfxRegisterWndClass](../VS_csharp/afxregisterwndclass.md) function to register window classes. User defined window classes are available in the module where they are registered.  
  
 The [CWnd::OnCreate](#cwnd__oncreate) method is called before the `Create` method returns, and before the window becomes visible.  
  
### Example  
 [!code[NVC_MFCWindowing#79](../VS_csharp/codesnippet/CPP/cwnd-class_18.cpp)]  
...
### Remarks  
 The bitmap must have previously been created by the [CBitmap::CreateBitmap](../VS_csharp/cbitmap-class.md#cbitmap__createbitmap) member function, the                         [CreateDIBitmap](http://msdn.microsoft.com/library/windows/desktop/dd183491) Windows function, or the [CBitmap::LoadBitmap](../VS_csharp/cbitmap-class.md#cbitmap__loadbitmap) member function.  
...
### Example  
 [!code[NVC_MFCWindowing#80](../VS_csharp/codesnippet/CPP/cwnd-class_19.cpp)]  
 ...
 *pszWindowName*  
 ...
 `rect`  
 Specifies the control's size and position. It can be either a [CRect](../VS_csharp/crect-class.md) object or a [RECT](../VS_csharp/rect-structure.md) structure.  
  
 `ppt`  
 Points to a [POINT](../VS_csharp/point-structure.md) structure or `CPoint` object that contains the upper left corner of the control.  
 ...
 `pPersist`  
 A pointer to a [CFile](../VS_csharp/cfile-class.md) containing the persistent state for the control. The default value is **NULL**, indicating that the control initializes itself without restoring its state from any persistent storage. If not **NULL**, it should be a pointer to a `CFile`-derived object which contains the control's persistent data, in the form of either a stream or a storage. This data could have been saved in a previous activation of the client. The `CFile` can contain other data, but must have its read-write pointer set to the first byte of persistent data at the time of the call to `CreateControl`.  
...
### Example  
 [!code[NVC_MFCWindowing#81](../VS_csharp/codesnippet/CPP/cwnd-class_20.h)]  
...
### Parameters  
 `dwExStyle`  
 Bitwise combination (OR) of [extended window styles](../VS_csharp/extended-window-styles.md); otherwise `NULL` for the default extended window style.  
 ...
 `dwStyle`  
 Bitwise combination (OR) of [window styles](../VS_csharp/window-styles.md); otherwise `NULL` for the default window style.  
...
### Example  
 [!code[NVC_MFCWindowing#82](../VS_csharp/codesnippet/CPP/cwnd-class_21.cpp)]  
...
### Example  
 [!code[NVC_MFCWindowing#83](../VS_csharp/codesnippet/CPP/cwnd-class_22.cpp)]  
...
### Example  
 [!code[NVC_MFCWindowing#84](../VS_csharp/codesnippet/CPP/cwnd-class_23.cpp)]  
...
### Example  
 [!code[NVC_MFCWindowing#85](../VS_csharp/codesnippet/CPP/cwnd-class_24.cpp)]  
...
### Example  
 [!code[NVC_MFCWindowing#86](../VS_csharp/codesnippet/CPP/cwnd-class_25.cpp)]  
...
### Remarks  
 ...
 The `DestroyWindow` member function also destroys modeless dialog boxes created by [CDialog::Create](../VS_csharp/cdialog-class.md#cdialog__create).  
  
 If the `CWnd` being destroyed is a child window and does not have the [WS_EX_NOPARENTNOTIFY](../VS_csharp/extended-window-styles.md) style set, then the                         [WM_PARENTNOTIFY](https://msdn.microsoft.com/en-us/library/ms632638.aspx) message is sent to the parent.  
  
### Example  
 [!code[NVC_MFCWindowing#87](../VS_csharp/codesnippet/CPP/cwnd-class_26.cpp)]  
...
### Example  
 [!code[NVC_MFCWindowing#88](../VS_csharp/codesnippet/CPP/cwnd-class_27.cpp)]  
...
### Example  
 [!code[NVC_MFCWindowing#89](../VS_csharp/codesnippet/CPP/cwnd-class_28.cpp)]  
...
### Remarks  
 ...
 [!code[NVC_MFCWindowing#90](../VS_csharp/codesnippet/CPP/cwnd-class_29.cpp)]  
  
 The `DoDataExchange` overridden member function must precede the macro statements in your source file.  
  
 For more information on dialog data exchange and validation, see [Displaying and Manipulating Data in a Form](../VS_csharp/displaying-and-manipulating-data-in-a-form.md) and [Dialog Data Exchange and Validation](../VS_csharp/dialog-data-exchange-and-validation.md). For a description of the DDX_ and DDV_ macros generated by the Add Variable wizard, see [Technical Note 26](../VS_csharp/tn026--ddx-and-ddv-routines.md).  
  
##  <a name="cwnd__dragacceptfiles"></a>  CWnd::DragAcceptFiles  
 Call this member function from within a window, using a `CWnd` pointer, in your application's [CWinApp::InitInstance](../VS_csharp/cwinapp-class.md#cwinapp__initinstance) function to indicate that the window accepts dropped files from the Windows File Manager or File Explorer.  
...
### Remarks  
 This member function emulates the functionality of the function                         [DragDetect](http://msdn.microsoft.com/library/windows/desktop/ms646256), as described in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Remarks  
 This member function emulates the functionality of the function                         [DrawAnimatedRects](http://msdn.microsoft.com/library/windows/desktop/dd162475), as described in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Remarks  
 This member function emulates the functionality of the function                         [DrawCaption](http://msdn.microsoft.com/library/windows/desktop/dd162476), as described in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Example  
 [!code[NVC_MFCWindowing#91](../VS_csharp/codesnippet/CPP/cwnd-class_30.cpp)]  
  
 [!code[NVC_MFCWindowing#92](../VS_csharp/codesnippet/CPP/cwnd-class_31.cpp)]  
...
### Example  
 [!code[NVC_MFCWindowing#93](../VS_csharp/codesnippet/CPP/cwnd-class_32.cpp)]  
...
### Parameters  
 `lpPaint`  
 Points to a [PAINTSTRUCT](../VS_csharp/paintstruct-structure.md) structure that contains the painting information retrieved by the [BeginPaint](#cwnd__beginpaint) member function.  
...
### Remarks  
 `ExecuteDlgInit` will use resources bound to the executing module, or resources from other sources. To accomplish this, `ExecuteDlgInit` finds a resource handle by calling `AfxFindResourceHandle`. If your MFC application does not use the shared DLL (MFCx0[U][D].DLL), **AfxFindResourceHandle** calls [AfxGetResourceHandle](../VS_csharp/afxgetresourcehandle.md), which returns the current resource handle for the executable. If your MFC application that uses MFCx0[U][D].DLL, `AfxFindResourceHandle` traverses the **CDynLinkLibrary** object list of shared and extension DLLs looking for the correct resource handle.  
...
### Remarks  
 ...
 However, in certain applications, for example some ActiveX controls, these methods might not be invoked by the framework, and you will need to call FilterToolTipMessage yourself. For more information, see [Methods of Creating Tool Tips](../VS_csharp/methods-of-creating-tool-tips.md).  
...
### Example  
 [!code[NVC_MFCWindowing#94](../VS_csharp/codesnippet/CPP/cwnd-class_33.cpp)]  
...
### Remarks  
 This member function emulates the functionality of the function                         [FindWindowEx](http://msdn.microsoft.com/library/windows/desktop/ms633500), as described in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Example  
 [!code[NVC_MFCWindowing#95](../VS_csharp/codesnippet/CPP/cwnd-class_34.cpp)]  
...
### Remarks  
 This method emulates the functionality of the function                         [FlashWindowEx](http://msdn.microsoft.com/library/windows/desktop/ms679347), as described in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Return Value  
 Returns S_OK on success, a COM error code on failure. See                         **Return Values** in                         [IAccessible::get_accChild](http://msdn.microsoft.com/library/windows/desktop/dd318475) in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Remarks  
 ...
 For more information, see                        [IAccessible::get_accChild](http://msdn.microsoft.com/library/windows/desktop/dd318475) in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Return Value  
 Returns S_OK on success, a COM error code on failure. See                         **Return Values** in                         [IAccessible::get_accChildCount](http://msdn.microsoft.com/library/windows/desktop/dd318476) in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Remarks  
 ...
 For more information, see                         [IAccessible::get_accChildCount](http://msdn.microsoft.com/library/windows/desktop/dd318476) in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Return Value  
 Returns S_OK on success, a COM error code on failure. See                         **Return Values** in                         [IAccessible::get_accDefaultAction](http://msdn.microsoft.com/library/windows/desktop/dd318477) in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Remarks  
 ...
 For more information, see                         [IAccessible::get_accDefaultAction](http://msdn.microsoft.com/library/windows/desktop/dd318477) in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Return Value  
 Returns S_OK on success, a COM error code on failure. See                         **Return Values** in                         [IAccessible::get_accDescription](http://msdn.microsoft.com/library/windows/desktop/dd318478) in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Remarks  
 ...
 For more information, see                         [IAccessible::get_accDescription](http://msdn.microsoft.com/library/windows/desktop/dd318478) in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Parameters  
 `pvarChild`  
 Receives information about the object that has the focus. See                                 *pvarID* in                                [IAccessible::get_accFocus](http://msdn.microsoft.com/library/windows/desktop/dd318479) in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
  
### Return Value  
 Returns S_OK on success, a COM error code on failure. See                         **Return Values** in **IAccessible::get_accFocus** in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Remarks  
 ...
 For more information, see                         [IAccessible::get_accFocus](http://msdn.microsoft.com/library/windows/desktop/dd318479) in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Return Value  
 Returns S_OK on success, a COM error code on failure. See                         **Return Values** in                         [IAccessible::get_accHelp](http://msdn.microsoft.com/library/windows/desktop/dd318480) in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Remarks  
 ...
 For more information, see                         [IAccessible::get_accHelp](http://msdn.microsoft.com/library/windows/desktop/dd318480) in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Parameters  
 ...
 `pidTopic`  
 Identifies the Help file topic associated with the specified object. See `pidTopic` in                                 [IAccessible::get_accHelpTopic](http://msdn.microsoft.com/library/windows/desktop/dd318481) in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
  
### Return Value  
 Returns S_OK on success, a COM error code on failure. See                         **Return Values** in **IAccessible::get_accHelpTopic** in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Remarks  
 ...
 For more information, see                        [IAccessible::get_accHelpTopic](http://msdn.microsoft.com/library/windows/desktop/dd318481) in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Return Value  
 Returns S_OK on success, a COM error code on failure. See                         **Return Values** in                         [IAccessible::get_accKeyboardShortcut](http://msdn.microsoft.com/library/windows/desktop/dd318482) in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Remarks  
 ...
 For more information, see                         [IAccessible::get_accKeyboardShortcut](http://msdn.microsoft.com/library/windows/desktop/dd318482) in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Return Value  
 Returns S_OK on success, a COM error code on failure. See                         **Return Values** in                         [IAccessible::get_accName](http://msdn.microsoft.com/library/windows/desktop/dd318483) in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Remarks  
 ...
 For more information, see                         [IAccessible::get_accName](http://msdn.microsoft.com/library/windows/desktop/dd318483) in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Return Value  
 Returns S_OK on success, a COM error code on failure. See                         **Return Values** in                         [IAccessible::get_accParent](http://msdn.microsoft.com/library/windows/desktop/dd318484) in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Remarks  
 ...
 For more information, see                         [IAccessible::get_accParent](http://msdn.microsoft.com/library/windows/desktop/dd318484) in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Parameters  
 ...
 `pvarRole`  
 Receives the role information. See `pvarRole` in                                 [IAccessible::get_accRole](http://msdn.microsoft.com/library/windows/desktop/dd318485) in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
  
### Return Value  
 Returns S_OK on success, a COM error code on failure. See                         **Return Values** in **IAccessible::get_accRole** in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Remarks  
 ...
 For more information, see                         [IAccessible::get_accRole](http://msdn.microsoft.com/library/windows/desktop/dd318485) in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Parameters  
 `pvarChildren`  
 Receives information about which children are selected. See `pvarChildren` in                                 [IAccessible::get_accSelection](http://msdn.microsoft.com/library/windows/desktop/dd318486) in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
  
### Return Value  
 Returns S_OK on success, a COM error code on failure. See                         **Return Values** in **IAccessible::get_accSelection** in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Remarks  
 ...
 For more information, see                         [IAccessible::get_accSelection](http://msdn.microsoft.com/library/windows/desktop/dd318486) in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Parameters  
 ...
 `pvarState`  
 Receives information about the object's state. See `pvarState` in                                 [IAccessible::get_accState](http://msdn.microsoft.com/library/windows/desktop/dd318487) in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
  
### Return Value  
 Returns S_OK on success, a COM error code on failure. See                         **Return Values** in **IAccessible::get_accState** in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Remarks  
 ...
 For more information, see                         [IAccessible::get_accState](http://msdn.microsoft.com/library/windows/desktop/dd318487) in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Return Value  
 Returns S_OK on success, a COM error code on failure. See                         **Return Values** in                         [IAccessible::get_accValue](http://msdn.microsoft.com/library/windows/desktop/dd318488) in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Remarks  
 ...
 For more information, see                         [IAccessible::get_accValue](http://msdn.microsoft.com/library/windows/desktop/dd318488) in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Remarks  
 This member function emulates the functionality of the function                         [GetAncestor](http://msdn.microsoft.com/library/windows/desktop/ms633502), as described in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Return Value  
 [CPoint](../VS_csharp/cpoint-class.md) object containing the coordinates of the caret's position.  
...
### Parameters  
 `lpRect`  
 Points to a [RECT](../VS_csharp/rect-structure.md) structure or a `CRect` object to receive the client coordinates. The **left** and **top** members will be 0. The **right** and **bottom** members will contain the width and height of the window.  
...
### Example  
 [!code[NVC_MFCWindowing#96](../VS_csharp/codesnippet/CPP/cwnd-class_35.cpp)]  
...
### Return Value  
 Returns a pointer to the [MSG](../VS_csharp/msg-structure.md) structure that contains the message the window is currently processing. Should only be called when in an **On***Message* handler.  
  
### Example  
  See the example for [CMDIFrameWnd::MDICascade](../VS_csharp/cmdiframewnd-class.md#cmdiframewnd__mdicascade).  
...
### Remarks  
 ...
 For more information about these characteristics, see the description of the **WNDCLASS** structure in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Parameters  
 ...
 `bOnlyPerm`  
 Specifies whether the window to be returned can be temporary. If **TRUE**, only a permanent window can be returned; if **FALSE,** the function can return a temporary window. For more information on temporary windows see [Technical Note 3](../VS_csharp/tn003--mapping-of-windows-handles-to-objects.md).  
...
### Example  
 [!code[NVC_MFCWindowing#97](../VS_csharp/codesnippet/CPP/cwnd-class_36.cpp)]  
...
### Parameters  
 ...
 `rString`  
 A reference to a [CString](../VS_csharp/cstringt-class.md).  
...
### Example  
 [!code[NVC_MFC_AxDataBinding#1](../VS_csharp/codesnippet/CPP/cwnd-class_6.cpp)]  
[!code[NVC_MFC_AxDataBinding#5](../VS_csharp/codesnippet/CPP/cwnd-class_37.cpp)]  
[!code[NVC_MFC_AxDataBinding#3](../VS_csharp/codesnippet/CPP/cwnd-class_8.cpp)]  
...
### Return Value  
 The window's extended style. For more information about the extended window styles used in MFC, see [Extended Window Styles](../VS_csharp/extended-window-styles.md).  
...
### Return Value  
 Pointer to a [CFont](../VS_csharp/cfont-class.md) object that is attached to the current font for the window.  
...
### Remarks  
 This member function emulates the functionality of the function                         [GetLayeredWindowAttributes](http://msdn.microsoft.com/library/windows/desktop/ms633508), as described in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Example  
 [!code[NVC_MFCWindowing#98](../VS_csharp/codesnippet/CPP/cwnd-class_38.cpp)]  
...
### Remarks  
 This member function emulates the functionality of the function                         [GetMenuBarInfo](http://msdn.microsoft.com/library/windows/desktop/ms647833), as described in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Remarks  
 A group of controls begins with a control that was created with the [WS_GROUP](../VS_csharp/window-styles.md) style and ends with the last control that was not created with the **WS_GROUP** style.  
...
|----------------------------|-----------------------------|  
|Windowed ActiveX control|Contains an HWND and associates a [COleControlSite](../VS_csharp/colecontrolsite-class.md) object with it. The `m_hWnd` member of `COleControlSiteOrWnd` is set to the HWND of the control, and the **m_pSite** member points to the control's `COleControlSite`.|  
...
##  <a name="cwnd__getnextdlgtabitem"></a>  CWnd::GetNextDlgTabItem  
 Retrieves a pointer to the first control that was created with the [WS_TABSTOP](../VS_csharp/window-styles.md) style and that precedes or follows the specified control.  
...
### Return Value  
 See the Return Values section in                         [GetParent](http://msdn.microsoft.com/library/windows/desktop/ms633510) in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Remarks  
 The member function searches up the parent chain until a [CFrameWnd](../VS_csharp/cframewnd-class.md) (or derived class) object is found.  
...
### Parameters  
 ...
 `vtProp`  
 Specifies the type of the property to be retrieved. For possible values, see the Remarks section for [COleDispatchDriver::InvokeHelper](../VS_csharp/coledispatchdriver-class.md#coledispatchdriver__invokehelper).  
...
>  This function should be called only on a `CWnd` object that represents an ActiveX control.  
 ...
 For more information about using this member function with ActiveX Control Containers, see the article [ActiveX Control Containers: Programming ActiveX Controls in an ActiveX Control Container](../VS_csharp/activex-control-containers--programming-activex-controls-in-an-activex-control-container.md).  
...
### Remarks  
 The safe owner is the first non-child parent window of `pParent`. If `pParent` is **NULL**, the thread's main window (retrieved via [AfxGetMainWnd](../VS_csharp/afxgetmainwnd.md)) is used to find an owner.  
...
### Remarks  
 This member function emulates the functionality of the function                         [GetScrollBarInfo](http://msdn.microsoft.com/library/windows/desktop/bb787581), as described in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
-   **SB_VERT** Retrieves the parameters for the window's standard vertical scroll bar.  
 ...
 `lpScrollInfo`  
 A pointer to a                                 [SCROLLINFO](http://msdn.microsoft.com/library/windows/desktop/bb787537) structure. See the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)] for more information about this structure.  
...
### Return Value  
 The window's style. For more information about the window styles used in MFC, see [Window Styles](../VS_csharp/window-styles.md).  
...
### Remarks  
 ...
 The pointer returned by the `GetSystemMenu` member function can be used with the [CMenu::AppendMenu](../VS_csharp/cmenu-class.md#cmenu__appendmenu), [CMenu::InsertMenu](../VS_csharp/cmenu-class.md#cmenu__insertmenu), or [CMenu::ModifyMenu](../VS_csharp/cmenu-class.md#cmenu__modifymenu) functions to change the Control menu.  
...
### Example  
 [!code[NVC_MFCWindowing#99](../VS_csharp/codesnippet/CPP/cwnd-class_39.cpp)]  
...
### Remarks  
 This member function emulates the functionality of the function                         [GetTitleBarInfo](http://msdn.microsoft.com/library/windows/desktop/ms633513), as described in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Remarks  
 If `CWnd` has no attached window, or its top-level parent is not a [CFrameWnd](../VS_csharp/cframewnd-class.md)-derived object, this function returns **NULL**.  
...
### Parameters  
 `lpRect`  
 Points to a `CRect` object or [RECT](../VS_csharp/rect-structure.md) structure that is to receive the client coordinates of the update that encloses the update region.  
...
### Remarks  
 This member function emulates the functionality of the function                         [GetWindowInfo](http://msdn.microsoft.com/library/windows/desktop/ms633516), as described in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Remarks  
 The **flags** member of the [WINDOWPLACEMENT](../VS_csharp/windowplacement-structure.md) structure retrieved by this function is always 0. If `CWnd` is maximized, the **showCmd** member of `WINDOWPLACEMENT` is **SW_SHOWMAXIMIZED**. If the window is minimized, it is **SW_SHOWMINIMIZED.** It is **SW_SHOWNORMAL** otherwise.  
...
### Parameters  
 `lpRect`  
 Points to a `CRect` object or a [RECT](../VS_csharp/rect-structure.md) structure that will receive the screen coordinates of the upper-left and lower-right corners.  
...
### Parameters  
 ...
 `rString`  
 A [CString](../VS_csharp/cstringt-class.md) object that is to receive the copied string of the window's title.  
...
### Remarks  
 The **MF_HILITE** and **MF_UNHILITE** flags can be used only with this member function; they cannot be used with the [CMenu::ModifyMenu](../VS_csharp/cmenu-class.md#cmenu__modifymenu) member function.  
...
### Parameters  
 ...
 `nCmd`  
 Specifies the type of help requested. For a list of possible values and how they affect the `dwData` parameter, see the `uCommand` parameter described in the [HTMLHelp API Reference](vsconovhtmlhelpapioverview) in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
  
### Remarks  
 See [CWinApp::HtmlHelp](../VS_csharp/cwinapp-class.md#cwinapp__htmlhelp) for more information.  
...
### Parameters  
 `lpRect`  
 Points to a `CRect` object or a [RECT](../VS_csharp/rect-structure.md) structure that contains the rectangle (in client coordinates) to be added to the update region. If `lpRect` is **NULL**, the entire client area is added to the region.  
...
### Parameters  
 `pRgn`  
 A pointer to a [CRgn](../VS_csharp/crgn-class.md) object that identifies the region to be added to the update region. The region is assumed to have client coordinates. If this parameter is **NULL**, the entire client area is added to the update region.  
...
### Parameters  
 ...
 `vtRet`  
 Specifies the type of the return value. For possible values, see the Remarks section for [COleDispatchDriver::InvokeHelper](../VS_csharp/coledispatchdriver-class.md#coledispatchdriver__invokehelper).  
...
### Remarks  
 ...
 This function converts the parameters to **VARIANTARG** values, then invokes the **IDispatch::Invoke** method on the ActiveX control. If the call to **IDispatch::Invoke** fails, this function will throw an exception. If the `SCODE` (status code) returned by **IDispatch::Invoke** is `DISP_E_EXCEPTION`, this function throws a [COleException](../VS_csharp/coleexception-class.md) object, otherwise it throws a [COleDispatchException](../VS_csharp/coledispatchexception-class.md).  
...
### Parameters  
 `lpMsg`  
 Points to an [MSG](../VS_csharp/msg-structure.md) structure that contains the message to be checked.  
...
### Return Value  
 ...
 [!code[NVC_MFCWindowing#100](../VS_csharp/codesnippet/CPP/cwnd-class_40.cpp)]  
...
### Example  
 [!code[NVC_MFCWindowing#101](../VS_csharp/codesnippet/CPP/cwnd-class_41.cpp)]  
...
### Example  
 [!code[NVC_MFCWindowing#102](../VS_csharp/codesnippet/CPP/cwnd-class_42.cpp)]  
...
### Return Value  
 Nonzero if `CWnd` is visible (has the [WS_VISIBLE](../VS_csharp/window-styles.md) style bit set, and parent window is visible). Because the return value reflects the state of the **WS_VISIBLE** style bit, the return value may be nonzero even though `CWnd` is totally obscured by other windows.  
...
### Example  
 [!code[NVC_MFCWindowing#103](../VS_csharp/codesnippet/CPP/cwnd-class_43.cpp)]  
...
### Remarks  
 ...
 The `LockWindowUpdate` member function does not make the given window invisible and does not clear the [WS_VISIBLE](../VS_csharp/window-styles.md) style bit.  
 ...
 *pwndTo*  
 ...
 `lpPoint`  
 A pointer to an array of [POINT](../VS_csharp/point-structure.md) structures that contain the set of points to be converted.  
  
 `nCount`  
 Specifies the number of **POINT** structures in the array pointed to by `lpPoint`.  
  
##  <a name="cwnd__messagebox"></a>  CWnd::MessageBox  
 Creates and displays a window that contains an application-supplied message and caption, plus a combination of the predefined icons and pushbuttons described in the [Message-Box Styles](../VS_csharp/message-box-styles.md) list.  
...
### Return Value  
 This method utilizes the                         [MessageBox](http://msdn.microsoft.com/library/windows/desktop/ms645505) function as defined in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)]. This method returns the result of calling this function.  
  
### Remarks  
 Use the global function [AfxMessageBox](../VS_csharp/afxmessagebox.md) instead of this member function to implement a message box in your application.  
  
 The following shows the various system icons that can be used in a message box:  
  
|||  
|-|-|  
|![Stop &#40;x&#41; icon](../VS_csharp/media/vc364f1.gif "vc364F1")|**MB_ICONHAND**, **MB_ICONSTOP**, and **MB_ICONERROR**|  
|![Help &#40;?&#41; icon](../VS_csharp/media/vc364f2.gif "vc364F2")|**MB_ICONQUESTION**|  
|![Important &#40;&#33;&#41; icon](../VS_csharp/media/vc364f3.gif "vc364F3")|**MB_ICONEXCLAMATION** and **MB_ICONWARNING**|  
|![Information &#40;i&#41; icon](../VS_csharp/media/vc364f4.gif "vc364F4")|**MB_ICONASTERISK** and **MB_ICONINFORMATION**|  
  
### Example  
 [!code[NVC_MFCWindowing#104](../VS_csharp/codesnippet/CPP/cwnd-class_44.cpp)]  
...
### Remarks  
 Styles to be added or removed can be combined by using the bitwise OR (&#124;) operator. See the topics                         [Window Styles](http://msdn.microsoft.com/library/windows/desktop/ms632600) and                         [CreateWindow](http://msdn.microsoft.com/library/windows/desktop/ms632679) in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)] for information about the available window styles.  
...
### Example  
 [!code[NVC_MFCWindowing#105](../VS_csharp/codesnippet/CPP/cwnd-class_45.cpp)]  
...
### Remarks  
 Styles to be added or removed can be combined by using the bitwise OR (&#124;) operator. See the topics [Extended Window Styles](../VS_csharp/extended-window-styles.md) in this book and                         [CreateWindowEx](http://msdn.microsoft.com/library/windows/desktop/ms632680) in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)] for information about the available extended styles  
...
### Example  
 [!code[NVC_MFCWindowing#106](../VS_csharp/codesnippet/CPP/cwnd-class_46.cpp)]  
 ...
 *y*  
 ...
 `lpRect`  
 The [CRect](../VS_csharp/crect-class.md) object or [RECT](../VS_csharp/rect-structure.md) structure that specifies the new size and position.  
...
### Remarks  
 This member function emulates the functionality of the function                         [NotifyWinEvent](http://msdn.microsoft.com/library/windows/desktop/dd373603), as described in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
|---------------|-----------------|  
|[in] `pWnd`|Pointer to a [CWnd](../VS_csharp/cwnd-class.md) object that represents the window where the user clicked the comman button or pressed the command key. This window can be a child window of the window receiving the message.|  
...
### Remarks  
 This method receives the                         [WM_APPCOMMAND](http://msdn.microsoft.com/library/windows/desktop/ms646275) notification, which is described in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Remarks  
 ...
 See the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)] for information on the `ReleaseCapture` Windows function.  
...
### Remarks  
 This member function emulates the functionality of the                         [WM_CHANGEUISTATE](http://msdn.microsoft.com/library/windows/desktop/ms646342) message, as described in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
##  <a name="cwnd__onchartoitem"></a>  CWnd::OnCharToItem  
 Called when a list box with the [LBS_WANTKEYBOARDINPUT](../VS_csharp/list-box-styles.md) style sends its owner a                 [WM_CHARTOITEM](http://msdn.microsoft.com/library/windows/desktop/bb761358) message in response to a [WM_CHAR](#cwnd__onchar) message.  
...
### Remarks  
 This method receives the                         [WM_DWMNCRENDERINGCHANGED](http://msdn.microsoft.com/library/windows/desktop/dd388198) notification message, which is described in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Parameters  
 ...
 `lpCompareItemStruct`  
 Contains a long pointer to a [COMPAREITEMSTRUCT](../VS_csharp/compareitemstruct-structure.md) data structure that contains the identifiers and application-supplied data for two items in the combo or list box.  
...
### Remarks  
 If a combo or list box is created with the [CBS_SORT](../VS_csharp/combo-box-styles.md) or [LBS_SORT](../VS_csharp/list-box-styles.md) style, Windows sends the combo-box or list-box owner a `WM_COMPAREITEM` message whenever the application adds a new item.  
...
### Remarks  
 This method receives the                         [WM_DWMCOMPOSITIONCHANGED](http://msdn.microsoft.com/library/windows/desktop/dd388199) notification, which is described in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Remarks  
 You can process this message by displaying a context menu using the [TrackPopupMenu](../VS_csharp/cmenu-class.md#cmenu__trackpopupmenu).  
...
### Parameters  
 `pWnd`  
 A pointer to a [CWnd](../VS_csharp/cwnd-class.md) object that is sending the data.  
...
### Parameters  
 `lpCreateStruct`  
 Points to a [CREATESTRUCT](../VS_csharp/createstruct-structure.md) structure that contains information about the `CWnd` object being created.  
...
### Remarks  
 ...
 To change the background color of a single-line edit control, set the brush handle in both the **CTLCOLOR_EDIT** and **CTLCOLOR_MSGBOX** message codes, and call the [CDC::SetBkColor](../VS_csharp/cdc-class.md#cdc__setbkcolor) function in response to the **CTLCOLOR_EDIT** code.  
...
### Example  
 [!code[NVC_MFCWindowing#107](../VS_csharp/codesnippet/CPP/cwnd-class_47.cpp)]  
...
##  <a name="cwnd__ondeleteitem"></a>  CWnd::OnDeleteItem  
 The framework calls this member function to inform the owner of an owner-draw list box or combo box that the list box or combo box is destroyed or that items have been removed by [CComboBox::DeleteString](../VS_csharp/ccombobox-class.md#ccombobox__deletestring), [CListBox::DeleteString](../VS_csharp/clistbox-class.md#clistbox__deletestring), [CComboBox::ResetContent](../VS_csharp/ccombobox-class.md#ccombobox__resetcontent), or [CListBox::ResetContent](../VS_csharp/clistbox-class.md#clistbox__resetcontent).  
...
### Parameters  
 ...
 `lpDeleteItemStruct`  
 Specifies a long pointer to a [DELETEITEMSTRUCT](../VS_csharp/deleteitemstruct-structure.md) data structure that contains information about the deleted list box item.  
...
### Remarks  
 The **itemAction** member of the [DRAWITEMSTRUCT](../VS_csharp/drawitemstruct-structure.md) structure defines the drawing operation that is to be performed. The data in this member allows the owner of the control to determine what drawing action is required.  
 ...
 If the **hwndItem** member belongs to a [CButton](../VS_csharp/cbutton-class.md), [CMenu](../VS_csharp/cmenu-class.md), [CListBox](../VS_csharp/clistbox-class.md), or [CComboBox](../VS_csharp/ccombobox-class.md) object, then the `DrawItem` virtual function of the appropriate class is called. Override the `DrawItem` member function of the appropriate control's class to draw the item.  
...
### Remarks  
 `OnEnable` is called before the [EnableWindow](#cwnd__enablewindow) member function returns, but after the window enabled state ( [WS_DISABLED](../VS_csharp/window-styles.md) style bit) has changed.  
...
### Remarks  
 This method receives the                         [WM_ENTERSIZEMOVE](http://msdn.microsoft.com/library/windows/desktop/ms632622) notification, which is described in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Remarks  
 This method receives the                         [WM_EXITSIZEMOVE](http://msdn.microsoft.com/library/windows/desktop/ms632623) notification, which is described in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Parameters  
 *lpMMI*  
 Points to a `MINMAXINFO` structure that contains information about a window's maximized size and position and its minimum and maximum tracking size. For more about this structure, see the [MINMAXINFO](../VS_csharp/minmaxinfo-structure.md) structure.  
...
### Remarks  
 See [CWinApp::OnHelp](../VS_csharp/cwinapp-class.md#cwinapp__onhelp) for more information.  
...
### Remarks  
 See [CWinApp::OnHelpFinder](../VS_csharp/cwinapp-class.md#cwinapp__onhelpfinder) for more information.  
...
### Remarks  
 See [CWinApp::OnHelpIndex](../VS_csharp/cwinapp-class.md#cwinapp__onhelpindex) for more information.  
...
### Remarks  
 See [CWinApp::OnHelpUsing](../VS_csharp/cwinapp-class.md#cwinapp__onhelpusing) for more information.  
...
### Remarks  
 This method receives the                         [WM_HOTKEY](http://msdn.microsoft.com/library/windows/desktop/ms646279) notification, which is described in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)]. This message is placed at the top of the message queue associated with the thread that registered the hot key. Use the                         [RegisterHotKey](http://msdn.microsoft.com/library/windows/desktop/ms646309) function to register a system-wide hot key.  
...
### Example  
 [!code[NVC_MFCWindowing#108](../VS_csharp/codesnippet/CPP/cwnd-class_48.cpp)]  
...
### Remarks  
 This method receives the                         [WM_INPUT_DEVICE_CHANGE](http://msdn.microsoft.com/library/windows/desktop/ms645591) notification, which is described in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)]. The is a generic input device message.  
...
### Remarks  
 This method receives the                         [WM_INPUTLANGCHANGE](http://msdn.microsoft.com/library/windows/desktop/ms632629) notification message, which is described in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Remarks  
 This method receives the                         [WM_INPUTLANGCHANGEREQUEST](http://msdn.microsoft.com/library/windows/desktop/ms632630) notification message, which is described in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)]. This message is posted when the user chooses a new input language with either a hotkey that is specified in the keyboard control panel application, or from the indicator on the system taskbar.  
...
### Parameters  
 ...
 `lpMeasureItemStruct`  
 Points to a [MEASUREITEMSTRUCT](../VS_csharp/measureitemstruct-structure.md) data structure that contains the dimensions of the owner-draw control.  
...
### Remarks  
 ...
 If a list box or combo box is created with the [LBS_OWNERDRAWVARIABLE](../VS_csharp/list-box-styles.md) or [CBS_OWNERDRAWVARIABLE](../VS_csharp/combo-box-styles.md) style, the framework calls this function for the owner for each item in the control; otherwise this function is called once.  
...
|[in] `pMenu`|Pointer to the [CMenu](../VS_csharp/cmenu-class.md) object that contains the menu item.|  
...
### Remarks  
 This method receives the                         [WM_MENUDRAG](http://msdn.microsoft.com/library/windows/desktop/ms647606) notification, which is described in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Remarks  
 This method receives the                         [WM_MENUGETOBJECT](http://msdn.microsoft.com/library/windows/desktop/ms647607) notification, which is described in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Remarks  
 This method receives the                         [WM_MENURBUTTONUP](http://msdn.microsoft.com/library/windows/desktop/ms647610) notification, which is described in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)]. The                         [WM_MENURBUTTONUP](http://msdn.microsoft.com/library/windows/desktop/ms647610) message enables an application to provide a context-sensitive menu for the menu item specified in the message.  
...
### Example  
 [!code[NVC_MFCAxCtl#9](../VS_csharp/codesnippet/CPP/cwnd-class_49.cpp)]  
...
|[in] `point`|A [CPoint](../VS_csharp/cpoint-class.md) object that specifies the                                         *x* and                                         *y* coordinates of the cursor relative to the upper-left corner of the client area.|  
  
### Remarks  
 This method receives the                         [WM_MOUSEHOVER](http://msdn.microsoft.com/library/windows/desktop/ms645613) notification, which is described in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
|[in] `pt`|A [CPoint](../VS_csharp/cpoint-class.md) object that specifies the                                         *x* and                                         *y* coordinates of the cursor relative to the upper-left corner of the client area.|  
  
### Remarks  
 This method receives the                         [WM_MOUSEHWHEEL](http://msdn.microsoft.com/library/windows/desktop/ms645614) notification message, which is described in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)]. This message is sent to the window that has the focus when the mouse's horizontal scroll wheel is tilted or rotated.  
...
### Remarks  
 This method receives the                         [WM_MOUSELEAVE](http://msdn.microsoft.com/library/windows/desktop/ms645615) notification, which is described in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Parameters  
 ...
 `lpRect`  
 Address of the [CRect](../VS_csharp/crect-class.md) or [RECT](../VS_csharp/rect-structure.md) structure that will contain the item's coordinates.  
...
### Parameters  
 ...
 `lpncsp`  
 Points to a [NCCALCSIZE_PARAMS](../VS_csharp/nccalcsize_params-structure.md) data structure that contains information an application can use to calculate the new size and position of the `CWnd` rectangle (including client area, borders, caption, scroll bars, and so on).  
...
### Parameters  
 `lpCreateStruct`  
 Points to the [CREATESTRUCT](../VS_csharp/createstruct-structure.md) data structure for `CWnd`.  
...
|[in] `point`|A [CPoint](../VS_csharp/cpoint-class.md) object that specifies the                                         *x* and                                         *y* coordinates of the cursor relative to the upper-left corner of the screen.|  
  
### Remarks  
 This method receives the                         [WM_NCMOUSEHOVER](http://msdn.microsoft.com/library/windows/desktop/ms645625) notification, which is described in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Remarks  
 This method receives the                         [WM_NCMOUSELEAVE](http://msdn.microsoft.com/library/windows/desktop/ms645626) notification, which is described in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Remarks  
 This method receives the                         [WM_DWMNCRENDERINGCHANGED](http://msdn.microsoft.com/library/windows/desktop/dd388200) notification, which is described in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Remarks  
 This method receives the                         [WM_XBUTTONDBLCLK](http://msdn.microsoft.com/library/windows/desktop/ms646244) notification, which is described in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)]. This message is posted to the window that contains the cursor. If a window has captured the mouse, this message is not posted.  
...
### Remarks  
 This method receives the                         [WM_NCXBUTTONDOWN](http://msdn.microsoft.com/library/windows/desktop/ms645632) notification, which is described in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)]. This message is posted to the window that contains the cursor. If a window has captured the mouse, this message is not posted.  
...
### Remarks  
 This method receives the                         [WM_NCXBUTTONUP](http://msdn.microsoft.com/library/windows/desktop/ms646240) notification, which is described in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)]. This message is posted to the window that contains the cursor. If a window has captured the mouse, this message is not posted.  
...
### Remarks  
 This method receives the                         [WM_UNINITMENUPOPUP](http://msdn.microsoft.com/library/windows/desktop/ms647614) notification, which is described in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)]. In response to this message, your application can set the `hmenuNext` member of the                         [MDINEXTMENU](http://msdn.microsoft.com/library/windows/desktop/ms647561) structure to specify the menu to switch to, and the `hwndNext` member to specify the window to receive menu notification messages.  
...
### Remarks  
 ...
 For more information on the WM_NOTIFY message, see Technical Note 61 (TN061), [ON_NOTIFY and WM_NOTIFY messages](../VS_csharp/tn061--on_notify-and-wm_notify-messages.md). You may also be interested the related topics described in [Control Topics](../VS_csharp/controls--mfc-.md), and TN062, [Message Reflection for Windows Controls](../VS_csharp/tn062--message-reflection-for-windows-controls.md).  
...
|Parameter|Description|  
|---------------|-----------------|  
|[in] `pWnd`|A pointer to a [CWnd](../VS_csharp/cwnd-class.md) object that represents the window sending the                                         [WM_NOTIFY](http://msdn.microsoft.com/library/windows/desktop/bb775583) message.<br /><br /> This parameter is the pointer to a control if the `nCommand` parameter is `NF_QUERY`, or the pointer to the parent window of a control if `nCommand` is `NF_REQUERY`.|  
...
### Remarks  
 This method receives the                         [WM_NOTIFYFORMAT](http://msdn.microsoft.com/library/windows/desktop/bb775584) notification, which is described in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].                         **WM_NOTIFY** messages are sent from a common control to its parent window, and from the parent window to the common control.  
...
### Remarks  
 ...
 For information on rendering an image in document/view applications, see [CView::OnDraw](../VS_csharp/cview-class.md#cview__ondraw).  
  
 For more information about using **WM_Paint**, see the following topics in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)]:  
 ...
 *hPaintStruct*  
 Identifies a [PAINTSTRUCT](../VS_csharp/paintstruct-structure.md) data structure that defines what part of the client area to paint.  
...
### Remarks  
 This method receives the                         [WM_POWERBROADCAST](http://msdn.microsoft.com/library/windows/desktop/aa373247) message, which is described in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Remarks  
 This member function emulates the functionality of the                         [WM_QUERYUISTATE](http://msdn.microsoft.com/library/windows/desktop/ms646355) message, as described in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Remarks  
 This method receives the                         [WM_INPUT](http://msdn.microsoft.com/library/windows/desktop/ms646275) notification, which is described in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Remarks  
 This method receives the                         [WM_WTSSESSION_CHANGE](http://msdn.microsoft.com/library/aa383828) notification, which is described in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Parameters  
 `uFlags`  
 When the system sends the message as a result of a **SystemParametersInfo** call, this parameter is a flag that indicates the system parameter that was changed. For a list of values, see                                 [SystemParametersInfo](http://msdn.microsoft.com/library/windows/desktop/ms724947) in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)]. When an application sends the message, this parameter must be 0.  
...
### Example  
 [!code[NVC_MFCWindowing#109](../VS_csharp/codesnippet/CPP/cwnd-class_50.cpp)]  
 ...
 *hRect*  
 Identifies a global memory object. The memory object contains a [RECT](../VS_csharp/rect-structure.md) data structure that specifies the area for the Clipboard owner to paint.  
...
### Remarks  
 ...
 Within `OnSizeClipboard`, an application must use the                         [GlobalLock](http://msdn.microsoft.com/library/windows/desktop/aa366584) Windows function to lock the memory that contains the [RECT](../VS_csharp/rect-structure.md) data structure. Have the application unlock that memory with the                         [GlobalUnlock](http://msdn.microsoft.com/library/windows/desktop/aa366595) Windows function before it yields or returns control.  
...
### Example  
 [!code[NVC_MFCWindowing#110](../VS_csharp/codesnippet/CPP/cwnd-class_51.cpp)]  
...
### Remarks  
 This function is called only when an application has initiated a training card with Windows Help. An application initiates a training card by specifying the **HELP_TCARD** command in a call to the [WinHelp](../VS_csharp/cwinapp-class.md#cwinapp__winhelp) function.  
...
### Remarks  
 ...
 See                         [TOOLINFO](http://msdn.microsoft.com/library/windows/desktop/bb760256), in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)], for more information about the structure.  
...
### Remarks  
 This method receives the                         [WM_UNICHAR](http://msdn.microsoft.com/library/windows/desktop/ms646288) notification, which is described in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)]. The                         [WM_UNICHAR](http://msdn.microsoft.com/library/windows/desktop/ms646288) message is designed to send or post Unicode characters to ANSI windows. It is equivalent to the                         [WM_CHAR](http://msdn.microsoft.com/library/windows/desktop/ms646276) message, but uses Unicode Transformation Format-32 encoding (UTF-32), whereas the                         [WM_CHAR](http://msdn.microsoft.com/library/windows/desktop/ms646276) message uses UTF-16.  
...
|Parameter|Description|  
|---------------|-----------------|  
|[in] `pMenu`|Pointer to the [CMenu](../VS_csharp/cmenu-class.md) object that represents the menu or submenu.|  
|[in] `nFlags`|The menu that was destroyed. Currently, it can only be the window menu, `MF_SYSMENU`.|  
  
### Remarks  
 This method receives the                         [WM_UNINITMENUPOPUP](http://msdn.microsoft.com/library/windows/desktop/ms647614) notification, which is described in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Remarks  
 This member function emulates the functionality of the                         [WM_UPDATEUISTATE](http://msdn.microsoft.com/library/windows/desktop/ms646361) message, as described in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Remarks  
 This method receives the                         [WM_USERCHANGED](http://msdn.microsoft.com/library/windows/desktop/ms632651) notification message, which is described in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)]. When the user logs on or off, the operating system updates user-specific settings. The system sends this message immediately after updating the settings.  
  
> [!NOTE]
>  This member function is called by the framework to allow your application to handle a Windows message. The parameters passed to your function reflect the parameters received by the framework when the message was received. If you call the base-class implementation of this function, that implementation will use the parameters originally passed with the message and not the parameters you supply to the function.  
  
##  <a name="cwnd__onvkeytoitem"></a>  CWnd::OnVKeyToItem  
 If the `CWnd` object owns a list box with the [LBS_WANTKEYBOARDINPUT](../VS_csharp/list-box-styles.md) style, the list box will send the `WM_VKEYTOITEM` message in response to a `WM_KEYDOWN` message.  
...
### Remarks  
 This member function is called by the framework only for list boxes that have the [LBS_HASSTRINGS](../VS_csharp/list-box-styles.md) style.  
...
### Remarks  
 This method receives the                         [WM_DWMWINDOWMAXIMIZEDCHANGE](http://msdn.microsoft.com/library/windows/desktop/dd388201) notification message, which is described in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Parameters  
 `lpwndpos`  
 Points to a [WINDOWPOS](../VS_csharp/windowpos-structure.md) data structure that contains information about the window's new size and position.  
...
### Remarks  
 An application can prevent changes to the window by setting or clearing the appropriate bits in the **flags** member of the [WINDOWPOS](../VS_csharp/windowpos-structure.md) structure.  
  
 For a window with the [WS_OVERLAPPED](../VS_csharp/window-styles.md) or [WS_THICKFRAME](../VS_csharp/window-styles.md) style, the default implementation sends a                         [WM_GETMINMAXINFO](http://msdn.microsoft.com/library/windows/desktop/ms632626) message to the window. This is done to validate the new size and position of the window and to enforce the **CS_BYTEALIGNCLIENT** and **CS_BYTEALIGN** client styles. An application can override this functionality by not calling its base class.  
...
### Remarks  
 ...
 For more information about message reflection, see [Handling Reflected Messages](../VS_csharp/handling-reflected-messages.md).  
...
### Remarks  
 This method receives the                         [WM_XBUTTONDBLCLK](http://msdn.microsoft.com/library/windows/desktop/ms646244) notification, which is described in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)]. If the mouse is not captured, the message is posted to the window beneath the cursor. Otherwise, the message is posted to the window that has captured the mouse.  
...
### Remarks  
 This method receives the                         [WM_XBUTTONDOWN](http://msdn.microsoft.com/library/windows/desktop/ms646245) notification, which is described in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)]. If the mouse is not captured, the message is posted to the window beneath the cursor. Otherwise, the message is posted to the window that has captured the mouse.  
...
### Remarks  
 This method receives the                         [WM_XBUTTONUP](http://msdn.microsoft.com/library/windows/desktop/ms646246) notification, which is described in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)]. If the mouse is not captured, the message is posted to the window beneath the cursor. Otherwise, the message is posted to the window that has captured the mouse.  
...
### Example  
 [!code[NVC_MFCWindowing#111](../VS_csharp/codesnippet/CPP/cwnd-class_52.cpp)]  
...
### Example  
  See the example for [AfxGetMainWnd](../VS_csharp/afxgetmainwnd.md).  
...
### Parameters  
 *cs*  
 A [CREATESTRUCT](../VS_csharp/createstruct-structure.md) structure.  
...
### Example  
 [!code[NVC_MFCWindowing#112](../VS_csharp/codesnippet/CPP/cwnd-class_53.cpp)]  
...
##  <a name="cwnd__pretranslatemessage"></a>  CWnd::PreTranslateMessage  
 Used by class [CWinApp](../VS_csharp/cwinapp-class.md) to translate window messages before they are dispatched to the                 [TranslateMessage](http://msdn.microsoft.com/library/windows/desktop/ms644955) and                 [DispatchMessage](http://msdn.microsoft.com/library/windows/desktop/ms644934) Windows functions.  
...
### Parameters  
 `pMsg`  
 Points to a [MSG](../VS_csharp/msg-structure.md) structure that contains the message to process.  
...
### Remarks  
 This member function emulates the functionality of the function                         [PrintWindow](http://msdn.microsoft.com/library/windows/desktop/dd162869), as described in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Parameters  
 `lpRectUpdate`  
 Points to a [RECT](../VS_csharp/rect-structure.md) structure containing the coordinates of the update rectangle. This parameter is ignored if                                 *prgnUpdate* contains a valid region handle.  
...
### Remarks  
 ...
 Reflected messages are sent directly to [CWnd::OnWndMsg](#cwnd__onwndmsg) or [CCmdTarget::OnCmdMsg](../VS_csharp/ccmdtarget-class.md#ccmdtarget__oncmdmsg).  
...
-   **CWnd::reposExtra** Adds the values of `lpRectParam` to the client area of `nIDLast` and also performs the layout                                        *.*  
 ...
 `lpRectParam`  
 Points to a [RECT](../VS_csharp/rect-structure.md) structure; the usage of which depends on the value of `nFlag`.  
  
 *lpRectClient*  
 Points to a [RECT](../VS_csharp/rect-structure.md) structure containing the available client area. If **NULL**, the window's client area will be used.  
...
### Parameters  
 `lpPoint`  
 Points to a [CPoint](../VS_csharp/cpoint-class.md) object or [POINT](../VS_csharp/point-structure.md) structure that contains the screen coordinates to be converted.  
  
 `lpRect`  
 Points to a [CRect](../VS_csharp/crect-class.md) object or [RECT](../VS_csharp/rect-structure.md) structure that contains the screen coordinates to be converted.  
...
### Example  
  See the example for [CListCtrl::GetItemRect](../VS_csharp/clistctrl-class.md#clistctrl__getitemrect).  
...
### Parameters  
 ...
 `lpRect`  
 Points to a [CRect](../VS_csharp/crect-class.md) object or [RECT](../VS_csharp/rect-structure.md) structure that specifies the portion of the client area to be scrolled. If `lpRect` is **NULL**, the entire client area is scrolled. The caret is repositioned if the cursor rectangle intersects the scroll rectangle.  
 ...
 *dy*  
 ...
 `lpRectScroll`  
 Points to a [RECT](../VS_csharp/rect-structure.md) structure that specifies the portion of the client area to be scrolled. If this parameter is **NULL**, the entire client area is scrolled.  
...
### Example  
 [!code[NVC_MFCWindowing#113](../VS_csharp/codesnippet/CPP/cwnd-class_54.cpp)]  
...
### Parameters  
 ...
 `bOnlyPerm`  
 Specifies whether the message will be received by temporary windows. If **TRUE**, temporary windows can receive the message; if **FALSE**, only permanent windows receive the message. For more information on temporary windows see [Technical Note 3](../VS_csharp/tn003--mapping-of-windows-handles-to-objects.md).  
...
### Example  
 [!code[NVC_MFCWindowing#114](../VS_csharp/codesnippet/CPP/cwnd-class_55.cpp)]  
...
### Example  
 [!code[NVC_MFCWindowing#115](../VS_csharp/codesnippet/CPP/cwnd-class_56.cpp)]  
...
### Parameters  
 ...
 `lpszString`  
 Points to a [CString](../VS_csharp/cstringt-class.md) object or null-terminated string that contains the text to be copied to the control.  
  
### Remarks  
 `SetDlgItemText` sends a                         [WM_SETTEXT](http://msdn.microsoft.com/library/windows/desktop/ms632644) message to the given control.  
  
### Example  
 [!code[NVC_MFCWindowing#116](../VS_csharp/codesnippet/CPP/cwnd-class_57.cpp)]  
...
### Remarks  
 This member function emulates the functionality of the function                         [SetLayeredWindowAttributes](http://msdn.microsoft.com/library/windows/desktop/ms633540), as described in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Remarks  
 ...
 `SetMenu` will not destroy a previous menu. An application should call the [CMenu::DestroyMenu](../VS_csharp/cmenu-class.md#cmenu__destroymenu) member function to accomplish this task.  
  
### Example  
  See the example for [CMenu::LoadMenu](../VS_csharp/cmenu-class.md#cmenu__loadmenu).  
...
### Parameters  
 ...
 `vtProp`  
 Specifies the type of the property to be set. For possible values, see the Remarks section for [COleDispatchDriver::InvokeHelper](../VS_csharp/coledispatchdriver-class.md#coledispatchdriver__invokehelper).  
...
>  This function should be called only on a `CWnd` object that represents an OLE control.  
 ...
 For more information about using this member function with OLE Control Containers, see the article [ActiveX Control Containers: Programming ActiveX Controls in an ActiveX Control Container](../VS_csharp/activex-control-containers--programming-activex-controls-in-an-activex-control-container.md).  
...
### Example  
 [!code[NVC_MFCWindowing#117](../VS_csharp/codesnippet/CPP/cwnd-class_58.cpp)]  
...
### Example  
 ...
 [!code[NVC_MFCWindowing#118](../VS_csharp/codesnippet/CPP/cwnd-class_59.cpp)]  
...
### Example  
 [!code[NVC_MFCWindowing#119](../VS_csharp/codesnippet/CPP/cwnd-class_60.cpp)]  
...
### Parameters  
 `lpwndpl`  
 Points to a [WINDOWPLACEMENT](../VS_csharp/windowplacement-structure.md) structure that specifies the new show state and positions.  
...
### Example  
 [!code[NVC_MFCWindowing#120](../VS_csharp/codesnippet/CPP/cwnd-class_61.cpp)]  
...
### Parameters  
 `lpszString`  
 Points to a [CString](../VS_csharp/cstringt-class.md) object or null-terminated string to be used as the new title or control text.  
...
### Example  
 [!code[NVC_MFCWindowing#121](../VS_csharp/codesnippet/CPP/cwnd-class_62.cpp)]  
...
### Remarks  
 `ShowWindow` must be called only once per application for the main window with [CWinApp::m_nCmdShow](../VS_csharp/cwinapp-class.md#cwinapp__m_ncmdshow). Subsequent calls to `ShowWindow` must use one of the values listed above instead of the one specified by `CWinApp::m_nCmdShow`.  
...
### Example  
 [!code[NVC_MFCWindowing#122](../VS_csharp/codesnippet/CPP/cwnd-class_63.cpp)]  
...
### Example  
 [!code[NVC_MFCWindowing#123](../VS_csharp/codesnippet/CPP/cwnd-class_64.cpp)]  
...
### Remarks  
 The framework automatically calls `UpdateData` with `bSaveAndValidate` set to **FALSE** when a modal dialog box is created in the default implementation of [CDialog::OnInitDialog](../VS_csharp/cdialog-class.md#cdialog__oninitdialog). The call occurs before the dialog box is visible. The default implementation of [CDialog::OnOK](../VS_csharp/cdialog-class.md#cdialog__onok) calls this member function with `bSaveAndValidate` set to **TRUE** to retrieve the data, and if successful, will close the dialog box. (If the Cancel button is clicked in the dialog box, the dialog box is closed without the data being retrieved.)  
  
##  <a name="cwnd__updatedialogcontrols"></a>  CWnd::UpdateDialogControls  
 Call this member function to update the state of dialog buttons and other controls in a dialog box or window that uses the [ON_UPDATE_COMMAND_UI](../VS_csharp/on_update_command_ui.md) callback mechanism.  
...
### Remarks  
 This member function emulates the functionality of the function                         [UpdateLayeredWindow](http://msdn.microsoft.com/library/windows/desktop/ms633556), as described in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Example  
 [!code[NVC_MFCWindowing#124](../VS_csharp/codesnippet/CPP/cwnd-class_65.cpp)]  
...
### Parameters  
 `lpRect`  
 Points to a [CRect](../VS_csharp/crect-class.md) object or [RECT](../VS_csharp/rect-structure.md) structure that contains client coordinates of the rectangle to be removed from the update region. If `lpRect` is **NULL**, the entire window is validated.  
...
### Parameters  
 `pRgn`  
 A pointer to a [CRgn](../VS_csharp/crgn-class.md) object that identifies a region that defines the area to be removed from the update region. If this parameter is **NULL**, the entire client area is removed.  
...
### Parameters  
 `point`  
 Specifies a [CPoint](../VS_csharp/cpoint-class.md) object or [POINT](../VS_csharp/point-structure.md) data structure that defines the point to be checked.  
...
### Parameters  
 ...
 `nCmd`  
 Specifies the type of help requested. For a list of possible values and how they affect the `dwData` parameter, see the                                 [WinHelp](http://msdn.microsoft.com/library/windows/desktop/bb762267) Windows function in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
  
### Remarks  
 See [CWinApp::WinHelp](../VS_csharp/cwinapp-class.md#cwinapp__winhelp) for more information.  
