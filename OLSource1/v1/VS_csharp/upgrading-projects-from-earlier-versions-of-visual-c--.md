...
4.  Build the solution. If the build fails, modify the settings and rebuild.  
 ...
 For information about how to update the targeted Windows versions, see [How to: Modify WINVER and _WIN32_WINNT](../VS_csharp/modifying-winver-and-_win32_winnt.md).  
  
## See Also  
 [Build System Changes](../VS_csharp/build-system-changes.md)   
