...
1.  Add the `CheckTheAnswer()` method.  
     ...
     [!code[VbExpressTutorial3Step4#8](../VS_csharp/codesnippet/VisualBasic/step-4--add-the-checktheanswer---method_1.vb)]
[!code[VbExpressTutorial3Step4#8](../VS_csharp/codesnippet/CSharp/step-4--add-the-checktheanswer---method_1.cs)]  
...
2.  Add the following code to the `if else` statement.  
     ...
     [!code[VbExpressTutorial3Step4#10](../VS_csharp/codesnippet/VisualBasic/step-4--add-the-checktheanswer---method_2.vb)]
[!code[VbExpressTutorial3Step4#10](../VS_csharp/codesnippet/CSharp/step-4--add-the-checktheanswer---method_2.cs)]  
...
-   To go to the next tutorial step, see [Step 5: Add Click and Enter Event Handlers for the NumericUpDown Control](../VS_csharp/step-5--add-enter-event-handlers-for-the-numericupdown-controls.md).  
  
-   To return to the previous tutorial step, see [Step 3: Add a Countdown Timer](../VS_csharp/step-3--add-a-countdown-timer.md).