...
## Remarks  
 Use this class to lock and unlock objects in a safer way than with the [CComCriticalSection Class](../VS_csharp/ccomcriticalsection-class.md) or [CComAutoCriticalSection Class](../VS_csharp/ccomautocriticalsection-class.md).  
