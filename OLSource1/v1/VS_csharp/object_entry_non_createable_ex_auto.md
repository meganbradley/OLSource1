...
## Remarks  
 ...
 `OBJECT_ENTRY_NON_CREATEABLE_EX_AUTO` allows you to specify that an object should be registered and initialized (see [OBJECT_ENTRY_AUTO](../VS_csharp/object_entry_auto.md) for more information), but it should not be creatable via `CoCreateInstance`.  
...
## See Also  
 ...
 [OBJECT_ENTRY_AUTO](../VS_csharp/object_entry_auto.md)