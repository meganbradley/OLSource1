...
## Remarks  
 ...
 For more information on the template class                 `complex`, see                 [complex Class](../VS_csharp/complex-class.md). For a list of members of the template class                 `complex`, see .  
...
## See Also  
 [complex Class](../VS_csharp/complex-class.md)   
