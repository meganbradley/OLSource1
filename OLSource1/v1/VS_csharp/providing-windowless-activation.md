...
Window creation code (that is, everything that happens when you call **CreateWindow**) is costly to execute. A control that maintains an on-screen window has to manage messages for the window. Windowless controls are therefore faster than controls with windows.  
 ...
 [!code[NVC_MFC_AxOpt#5](../VS_csharp/codesnippet/CPP/providing-windowless-activation_1.cpp)]  
[!code[NVC_MFC_AxOpt#6](../VS_csharp/codesnippet/CPP/providing-windowless-activation_2.cpp)]  
[!code[NVC_MFC_AxOpt#7](../VS_csharp/codesnippet/CPP/providing-windowless-activation_3.cpp)]  
  
 The code to include this flag is automatically generated if you select the **Windowless activation** option on the [Control Settings](../VS_csharp/control-settings--mfc-activex-control-wizard.md) page of the MFC ActiveX Control Wizard.  
...
-   [GetClientRect](../Topic/COleControl::GetClientRect.md)  
 ...
 [!code[NVC_MFC_AxOpt#8](../VS_csharp/codesnippet/CPP/providing-windowless-activation_4.cpp)]  
