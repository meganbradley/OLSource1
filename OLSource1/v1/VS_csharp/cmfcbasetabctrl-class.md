...
|[CMFCBaseTabCtrl::Serialize](#cmfcbasetabctrl__serialize)|Reads or writes this object from or to an archive. (Overrides [CObject::Serialize](../VS_csharp/cobject-class.md#cobject__serialize).)|  
...
|[CMFCBaseTabCtrl::SetDockingBarWrapperRTC](#cmfcbasetabctrl__setdockingbarwrapperrtc)|Sets the wrapper class that is used for any objects that are not derived from the [CDockablePane Class](../VS_csharp/cdockablepane-class.md).|  
...
## Remarks  
 The `CMFCBaseTabCtrl` class is an abstract class. Therefore, it cannot be instantiated. To create a tabbed window, you must derive a class from `CMFCBaseTabCtrl`. The MFC library contains some derived class examples, two of which are [CMFCTabCtrl Class](../VS_csharp/cmfctabctrl-class.md) and [CMFCOutlookBarTabCtrl Class](../VS_csharp/cmfcoutlookbartabctrl-class.md).  
  
 Starting with [!INCLUDE[vs_dev14](../VS_csharp/includes/vs_dev14_md.md)], this class supports Microsoft Active Accessibility.  
  
## Customization Tips  
 The following tips pertain to the [CMFCBaseTabCtrl Class](../VS_csharp/cmfcbasetabctrl-class.md) and any classes that inherit from it:  
...
## Inheritance Hierarchy  
 ...
 [CMFCBaseTabCtrl](../VS_csharp/cmfcbasetabctrl-class.md)  
...
##  <a name="cmfcbasetabctrl__createwrapper"></a>  CMFCBaseTabCtrl::CreateWrapper  
 Creates a wrapper for a frame window that is derived from the [CWnd Class](../VS_csharp/cwnd-class.md) but is not derived from the [CDockablePane Class](../VS_csharp/cdockablepane-class.md).  
...
### Remarks  
 A tabbed window can dock any object derived from `CWnd`. However, in order for a [CMFCBaseTabCtrl Class](../VS_csharp/cmfcbasetabctrl-class.md) object to be dockable, each object on the `CMFCBaseTabCtrl` must be detachable. Therefore, `CMFCBaseTabCtrl` automatically wraps any objects that are not derived from `CDockablePane`.  
  
 By default, the `CMFCBaseTabCtrl` creates instances of the [CDockablePaneAdapter Class](../VS_csharp/cdockablepaneadapter-class.md). To change the wrapper's default class, call [CMFCBaseTabCtrl::SetDockingBarWrapperRTC](#cmfcbasetabctrl__setdockingbarwrapperrtc).  
...
### Parameters  
 [in] `dockMethod`  
 An enumerated data type provided by the [CBasePane Class](../VS_csharp/cbasepane-class.md). This data type specifies the method that was used to detach the tab.  
...
### Remarks  
 ...
 In the [CMFCBaseTabCtrl Class](../VS_csharp/cmfcbasetabctrl-class.md), this method is a pure virtual function and has no implementation. If you derive a class from `CMFCBaseTabCtrl`, you must implement this function.  
...
### Remarks  
 ...
 By default, this method is not supported by the [CMFCBaseTabCtrl Class](../VS_csharp/cmfcbasetabctrl-class.md). You should implement this function in a custom class derived from `CMFCBaseTabCtrl` if that custom tab control supports tab scrolling. This method is supported by the [CMFCTabCtrl Class](../VS_csharp/cmfctabctrl-class.md).  
...
### Parameters  
 [in] `pt`  
 A point that is defined by using client-area coordinates of the [CMFCBaseTabCtrl](../VS_csharp/cmfcbasetabctrl-class.md) object.  
  
### Return Value  
 A pointer to a [CWnd](../VS_csharp/cwnd-class.md) object if successful; otherwise `NULL`.  
...
### Return Value  
 A reference to an array of                         [COLORREF](http://msdn.microsoft.com/library/windows/desktop/dd183449) values that the [CMFCBaseTabCtrl](../VS_csharp/cmfcbasetabctrl-class.md) object uses for automatic tab coloring.  
...
### Remarks  
 ...
 In the [CMFCBaseTabCtrl Class](../VS_csharp/cmfcbasetabctrl-class.md), this method is a pure virtual function and has no implementation. If you derive a class from `CMFCBaseTabCtrl`, you have to implement this function.  
...
### Remarks  
 The [CMFCBaseTabCtrl](../VS_csharp/cmfcbasetabctrl-class.md) object stores the icons in the internal [CImageList](../VS_csharp/cimagelist-class.md) object.  
...
### Return Value  
 A pointer to the [CWnd](../VS_csharp/cwnd-class.md) object that resides on the tab that `iTab` specifies. `NULL` if `iTab` is invalid.  
...
### Return Value  
 A pointer to the [CWnd](../VS_csharp/cwnd-class.md) object that resides on the specified tab; `NULL` if `iTab` is invalid.  
...
### Remarks  
 Use [CMFCTabCtrl::SetFlatFrame](../VS_csharp/cmfctabctrl-class.md#cmfctabctrl__setflatframe) to change the style for the frame of the tab control.  
  
 Tab controls that use the Outlook style cannot be rendered with flat frames. This includes the [CMFCOutlookBarTabCtrl Class](../VS_csharp/cmfcoutlookbartabctrl-class.md) and any classes derived from that class.  
...
### Remarks  
 Call the method [CMDIFrameWndEx::EnableMDITabs](../VS_csharp/cmdiframewndex-class.md#cmdiframewndex__enablemditabs) to enable the Microsoft OneNote style. You can also enable this style when you instantiate the [CMFCTabCtrl Class](../VS_csharp/cmfctabctrl-class.md): simply pass the style STYLE_3D_ONENOTE to the method [CMFCTabCtrl::Create](../VS_csharp/cmfctabctrl-class.md#cmfctabctrl__create).  
  
 By default, the Microsoft OneNote style is not supported in a custom class derived from the [CMFCBaseTabCtrl Class](../VS_csharp/cmfcbasetabctrl-class.md). However, it is supported in the `CMFCTabCtrl` class.  
...
### Remarks  
 In the [CMFCBaseTabCtrl Class](../VS_csharp/cmfcbasetabctrl-class.md), this method is a pure virtual function. If you derive a class from `CMFCBaseTabCtrl`, you have to implement this function.  
...
### Remarks  
 If [CMFCBaseTabCtrl::m_bAutoDestroyWindow](#cmfcbasetabctrl__m_bautodestroywindow) is `TRUE`, the framework deletes all the [CWnd](../VS_csharp/cwnd-class.md) objects attached to the removed tabs.  
...
### Remarks  
 If [CMFCBaseTabCtrl::m_bAutoDestroyWindow](#cmfcbasetabctrl__m_bautodestroywindow) is `TRUE`, `RemoveTab` destroys the [CWnd](../VS_csharp/cwnd-class.md) object associated with the specified tab.  
...
##  <a name="cmfcbasetabctrl__resetimagelist"></a>  CMFCBaseTabCtrl::ResetImageList  
 Resets the image list for an instance of the [CMFCBaseTabCtrl Class](../VS_csharp/cmfcbasetabctrl-class.md).  
...
##  <a name="cmfcbasetabctrl__setdockingbarwrapperrtc"></a>  CMFCBaseTabCtrl::SetDockingBarWrapperRTC  
 Sets the wrapper class that is used for any objects that are not derived from the [CDockablePane Class](../VS_csharp/cdockablepane-class.md).  
...
### Parameters  
 ...
 [in] `uiIcon`  
 The icon ID for the new icon. This ID references the internal [CImageList](../VS_csharp/cimagelist-class.md) object.  
...
## See Also  
 ...
 [CMFCTabCtrl Class](../VS_csharp/cmfctabctrl-class.md)   
 [CMFCOutlookBarTabCtrl Class](../VS_csharp/cmfcoutlookbartabctrl-class.md)