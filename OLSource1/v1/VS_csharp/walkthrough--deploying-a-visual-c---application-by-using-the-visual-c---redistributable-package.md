...
1.  Create and build an MFC application by following the first three steps in [Walkthrough: Deploying a Visual C++ Application By Using a Setup Project](../VS_csharp/walkthrough--deploying-a-visual-c---application-by-using-the-visual-c---redistributable-package.md).  
