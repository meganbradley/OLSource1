...
|Name|Description|  
|----------|-----------------|  
|[DeferrableEventArgs::GetDeferral Method](../VS_csharp/deferrableeventargs--getdeferral-method.md)|Gets a reference to the [Deferral](http://go.microsoft.com/fwlink/?LinkId=526520) object which represents a deferred event.|  
|[DeferrableEventArgs::InvokeAllFinished Method](../VS_csharp/deferrableeventargs--invokeallfinished-method.md)|Called to indicate that all processing to handle a deferred event is complete.|  
