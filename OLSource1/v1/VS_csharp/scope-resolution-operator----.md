...
---
# Scope Resolution Operator: ::
The scope resolution operator `::` is used to identify and disambiguate identifiers used in different scopes. For more information about scope, see [Scope](../VS_csharp/scope--visual-c---.md).  
...
## With Scoped Enumerations  
 The scoped resolution operator is also used with the values of a scoped enumeration [Enumeration Declarations](../VS_csharp/enumerations--c---.md), as in the following example:  
...
## See Also  
 ...
 [Namespaces](../VS_csharp/namespaces--c---.md)   
