...
---
# vsscanf, vswscanf
Reads formatted data from a string. More secure versions of these functions are available; see [vsscanf_s, vswscanf_s](../VS_csharp/vsscanf_s--vswscanf_s.md).  
...
## See Also  
 ...
 [vsscanf_s, vswscanf_s](../VS_csharp/vsscanf_s--vswscanf_s.md)