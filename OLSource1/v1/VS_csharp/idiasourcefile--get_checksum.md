...
## Remarks  
 To determine the type of checksum algorithm that was used to generate the checksum bytes, call the [IDiaSourceFile::get_checksumType](../VS_csharp/idiasourcefile--get_checksumtype.md) method.  
...
## See Also  
 ...
 [IDiaSourceFile::get_checksumType](../VS_csharp/idiasourcefile--get_checksumtype.md)