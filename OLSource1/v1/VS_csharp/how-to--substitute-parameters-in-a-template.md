...
You may replace template parameters such as class names and namespaces when a file based on a template is created. For a complete list of template parameters, see [Parameter Substitution](../VS_csharp/template-parameters.md).  
...
## See Also  
 ...
 [ProjectItem Element (Visual Studio Template Content)](../VS_csharp/projectitem-element--visual-studio-item-templates-.md)