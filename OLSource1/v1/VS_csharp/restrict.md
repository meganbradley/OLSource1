...
## Remarks  
 ...
 For similar semantics on variables, see [__restrict](../VS_csharp/__restrict.md).  
  
## Example  
 See [noalias](../VS_csharp/noalias.md) for an example using `restrict`.  
  
 For information about the restrict keyword that is part of C++ AMP, see [Restriction Clause (C++ AMP)](../VS_csharp/restrict--c---amp-.md).  
