...
### Remarks  
 The object is used as a function argument to match the parameter type [std::nothrow_t](../VS_csharp/nothrow_t-structure.md).  
...
### Remarks  
 The function stores `_Pnew` in a static [new handler](../VS_csharp/-new--typedefs.md#new_handler) pointer that it maintains, then returns the value previously stored in the pointer. The new handler is used by [operator new](../VS_csharp/-new--operators.md#operator_new)( **size_t**).  
