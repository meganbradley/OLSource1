...
## Remarks  
 This method is part of [The SafeInt Library](../VS_csharp/safeint-library.md) and is designed for a single casting operation without creating an instance of the [SafeInt Class](../VS_csharp/safeint-class.md).  
