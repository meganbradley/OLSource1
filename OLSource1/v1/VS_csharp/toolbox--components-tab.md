...
---
# Toolbox, Components Tab
Displays components you can add to [!INCLUDE[vbprvb](../VS_csharp/includes/vbprvb_md.md)] and [!INCLUDE[csprcs](../VS_csharp/includes/csprcs_md.md)] designers. In addition to the [!INCLUDE[dnprdnshort](../VS_csharp/includes/dnprdnshort_md.md)] components that are included with [!INCLUDE[vsprvs](../VS_csharp/includes/vsprvs_md.md)], such as the <xref:System.Messaging.MessageQueue*> and <xref:System.Diagnostics.EventLog*> components, you can add your own or third-party components to this tab. For more information, see [How to: Manipulate Toolbox Tabs](assetId:///21285050-cadd-455a-b1f5-a2289a89c4db).  
