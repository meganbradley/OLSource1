...
-   [To create the SimpleMath class library](../VS_csharp/walkthrough--creating-an-sdk-using-csharp-or-visual-basic.md#createClassLibrary)  
  
-   [To create the SimpleMathVSIX extension project](../VS_csharp/walkthrough--creating-an-sdk-using-csharp-or-visual-basic.md#createVSIX)  
  
-   [To create a sample app that uses the class library](../VS_csharp/walkthrough--creating-an-sdk-using-csharp-or-visual-basic.md#createSample)  
...
5.  Rename **Class1.cs** to **Arithmetic.cs** and update it to match the following code:  
     ...
     [!code[CreatingAnSDKUsingWinRT#3](../VS_csharp/codesnippet/CSharp/walkthrough--creating-an-sdk-using-csharp-or-visual-basic_1.cs)]
[!code[CreatingAnSDKUsingWinRT#3](../VS_csharp/codesnippet/VisualBasic/walkthrough--creating-an-sdk-using-csharp-or-visual-basic_1.vb)]  
...
8.  In the **Configuration** column, verify that **SimpleMath** row is set to **Release**, and then choose the **Close** button to accept the change.  
    ...
    > [!IMPORTANT]
    >  The SDK for the SimpleMath component includes only one configuration. This configuration must be the release build, or apps that use the component won't pass certification for the[!INCLUDE[win8_appstore_long](../VS_csharp/includes/win8_appstore_long_md.md)].  
...
12. Replace the contents of the file with the following XML:  
     ...
     [!code[CreatingAnSDKUsingWinRT#1](../VS_csharp/codesnippet/XML/walkthrough--creating-an-sdk-using-csharp-or-visual-basic_3.xml)]
[!code[CreatingAnSDKUsingWinRT#1](../VS_csharp/codesnippet/XML/walkthrough--creating-an-sdk-using-csharp-or-visual-basic_3.xml)]  
...
10. In **Solution Explorer**, open MainPage.xaml, and replace its contents with the following XAML:  
     ...
     [!code[CreatingAnSDKUsingWinRTDemoApp#1](../VS_csharp/codesnippet/Xaml/walkthrough--creating-an-sdk-using-csharp-or-visual-basic_4.xaml)]
[!code[CreatingAnSDKUsingWinRTDemoApp#1](../VS_csharp/codesnippet/Xaml/walkthrough--creating-an-sdk-using-csharp-or-visual-basic_4.xaml)]  
  
11. Update MainPage.xaml.cs to match the following code:  
  
     [!code[CreatingAnSDKUsingWinRTDemoApp#2](../VS_csharp/codesnippet/CSharp/walkthrough--creating-an-sdk-using-csharp-or-visual-basic_5.cs)]
[!code[CreatingAnSDKUsingWinRTDemoApp#2](../VS_csharp/codesnippet/VisualBasic/walkthrough--creating-an-sdk-using-csharp-or-visual-basic_5.vb)]  
