...
## Remarks  
 ...
 For more information about iterator functions and `Get` accessors, see [Iterators (C# and Visual Basic)](../VS_csharp/iterators--csharp-and-visual-basic-.md).  
...
-   It must include an [Iterator](../VS_csharp/iterator--visual-basic-.md) modifier.  
...
-   It cannot have any `ByRef` parameters.  
 ...
 An iterator function can be an anonymous function. For more information, see [Iterators (C# and Visual Basic)](../VS_csharp/iterators--csharp-and-visual-basic-.md).  
  
## Exception Handling  
 A `Yield` statement can be inside a `Try` block of a [Try...Catch...Finally Statement (Visual Basic)](../VS_csharp/try...catch...finally-statement--visual-basic-.md). A `Try` block that has a `Yield` statement can have `Catch` blocks, and can have a `Finally` block.  
...
## Example  
 ...
 [!code[VbVbalrStatements#98](../VS_csharp/codesnippet/VisualBasic/yield-statement--visual-basic-_1.vb)]  
...
## Example  
 ...
 [!code[VbVbalrStatements#99](../VS_csharp/codesnippet/VisualBasic/yield-statement--visual-basic-_2.vb)]  
  
 For additional examples, see [Iterators (C# and Visual Basic)](../VS_csharp/iterators--csharp-and-visual-basic-.md).  
  
## Requirements  
 [!INCLUDE[vs_dev11_long](../VS_csharp/includes/vs_dev11_long_md.md)]  
