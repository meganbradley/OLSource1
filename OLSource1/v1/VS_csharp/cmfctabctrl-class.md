...
|[CMFCTabCtrl::EnableInPlaceEdit](#cmfctabctrl__enableinplaceedit)|Enables or disables editable tab labels. (Overrides [CMFCBaseTabCtrl::EnableInPlaceEdit](../VS_csharp/cmfcbasetabctrl-class.md#cmfcbasetabctrl__enableinplaceedit).)|  
...
|[CMFCTabCtrl::GetTabArea](#cmfctabctrl__gettabarea)|Retrieves the bounding rectangle of the tab label area at the top or bottom of the tab control. (Overrides [CMFCBaseTabCtrl::GetTabArea](../VS_csharp/cmfcbasetabctrl-class.md#cmfcbasetabctrl__gettabarea).)|  
|`CMFCTabCtrl::GetTabFromPoint`|Retrieves the tab that contains a specified point. (Overrides [CMFCBaseTabCtrl::GetTabFromPoint](../VS_csharp/cmfcbasetabctrl-class.md#cmfcbasetabctrl__gettabfrompoint).)|  
...
|[CMFCTabCtrl::GetTabsRect](#cmfctabctrl__gettabsrect)|Retrieves a rectangle that bounds the tab area of the current tab control. (Overrides [CMFCBaseTabCtrl::GetTabsRect](../VS_csharp/cmfcbasetabctrl-class.md#cmfcbasetabctrl__gettabsrect).)|  
|`CMFCTabCtrl::GetThisClass`|Used by the framework to obtain a pointer to the [CRuntimeClass](../VS_csharp/cruntimeclass-structure.md) object that is associated with this class type.|  
...
|[CMFCTabCtrl::HideSingleTab](#cmfctabctrl__hidesingletab)|Enables or disables drawing a tab when there is a single tabbed window. (Overrides [CMFCBaseTabCtrl::HideSingleTab](../VS_csharp/cmfcbasetabctrl-class.md#cmfcbasetabctrl__hidesingletab).)|  
...
|`CMFCTabCtrl::IsPtInTabArea`|Determines if a point is inside the tab area. (Overrides [CMFCBaseTabCtrl::IsPtInTabArea](../VS_csharp/cmfcbasetabctrl-class.md#cmfcbasetabctrl__isptintabarea).)|  
...
|`CMFCTabCtrl::MoveTab`|Moves a tab to another tab position. (Overrides [CMFCBaseTabCtrl::MoveTab](../VS_csharp/cmfcbasetabctrl-class.md#cmfcbasetabctrl__movetab).)|  
...
|[CMFCTabCtrl::OnDragOver](#cmfctabctrl__ondragover)|Called by the framework during a drag operation when the mouse is moved over the drop target window. (Overrides [CMFCBaseTabCtrl::OnDragOver](../VS_csharp/cmfcbasetabctrl-class.md#cmfcbasetabctrl__ondragover).)|  
...
|`CMFCTabCtrl::PreTranslateMessage`|Translates window messages before they are dispatched to the                                         [TranslateMessage](http://msdn.microsoft.com/library/windows/desktop/ms644955) and                                         [DispatchMessage](http://msdn.microsoft.com/library/windows/desktop/ms644934) Windows functions. (Overrides [CMFCBaseTabCtrl::PreTranslateMessage](../VS_csharp/cmfcbasetabctrl-class.md#cmfcbasetabctrl__pretranslatemessage).)|  
|`CMFCTabCtrl::RecalcLayout`|Recalculates the internal layout of the tab control. (Overrides [CMFCBaseTabCtrl::RecalcLayout](../VS_csharp/cmfcbasetabctrl-class.md#cmfcbasetabctrl__recalclayout).)|  
...
|[CMFCTabCtrl::SetActiveTab](#cmfctabctrl__setactivetab)|Activates a tab. (Overrides [CMFCBaseTabCtrl::SetActiveTab](../VS_csharp/cmfcbasetabctrl-class.md#cmfcbasetabctrl__setactivetab).)|  
...
|[CMFCTabCtrl::SetImageList](#cmfctabctrl__setimagelist)|Specifies an image list. (Overrides [CMFCBaseTabCtrl::SetImageList](../VS_csharp/cmfcbasetabctrl-class.md#cmfcbasetabctrl__setimagelist).)|  
...
|`CMFCTabCtrl::SwapTabs`|Swaps a pair of tabs. (Overrides [CMFCBaseTabCtrl::SwapTabs](../VS_csharp/cmfcbasetabctrl-class.md#cmfcbasetabctrl__swaptabs).)|  
...
-   Detachable tabbed windows.  
 ...
 The `CMFCTabCtrl` class can be used with a dialog box, but is intended for applications that use docking control bars like [!INCLUDE[ofprexcel](../VS_csharp/includes/ofprexcel_md.md)] and [!INCLUDE[vsprvs](../VS_csharp/includes/vsprvs_md.md)]. For more information, see [CMFCDockingControlBar](../VS_csharp/cdockablepane-class.md).  
  
 Follow these steps to add a resizable, docking tab control in your application:  
  
1.  Create an instance of [CMFCTabbedControlBar](../VS_csharp/ctabbedpane-class.md).  
  
2.  Call [CMFCTabbedControlBar::Create](../VS_csharp/cdockablepane-class.md#cdockablepane__create).  
  
3.  Use [AddTab](../VS_csharp/cbasetabbedpane-class.md#cbasetabbedpane__addtab) or [InsertTab](../VS_csharp/cmfcbasetabctrl-class.md#cmfcbasetabctrl__inserttab) to add new tabs.  
  
4.  Call [EnableDocking](../VS_csharp/cbasepane-class.md#cbasepane__enabledocking) so that the current docking tab control can dock at the main frame window.  
  
5.  Call [DockControlBar](../VS_csharp/cframewndex-class.md#cframewndex__dockpane) to dock the tabbed window at the main frame.  
  
 For an example of how to create a tabbed window as a docking control bar, see [CMFCTabbedControlBar](../VS_csharp/ctabbedpane-class.md). To use `CMFCTabCtrl` as a non-docking control, create a `CMFCTabCtrl` object and then call [CMFCTabCtrl::Create](#cmfctabctrl__create).  
...
## Inheritance Hierarchy  
 ...
 [CMFCTabCtrl](../VS_csharp/cmfctabctrl-class.md)  
  
## Example  
 The following example demonstrates how to use various methods in the `CMFCTabCtrl` class to configure a `CMFCTabCtrl` object. The example explains how to add a tab, show the Close button on the active tab, enable editable tab labels, and display a pop-up menu of tabbed window labels. This example is part of the [State Collection sample](../VS_csharp/visual-c---samples.md).  
  
 [!code[NVC_MFC_StateCollection#1](../VS_csharp/codesnippet/CPP/cmfctabctrl-class_1.h)]  
[!code[NVC_MFC_StateCollection#3](../VS_csharp/codesnippet/CPP/cmfctabctrl-class_2.cpp)]  
...
### Example  
 The following example demonstrates how to use the `Create` method in the `CMFCTabCtrl` class. This example is part of the [State Collection sample](../VS_csharp/visual-c---samples.md).  
  
 [!code[NVC_MFC_StateCollection#1](../VS_csharp/codesnippet/CPP/cmfctabctrl-class_1.h)]  
[!code[NVC_MFC_StateCollection#2](../VS_csharp/codesnippet/CPP/cmfctabctrl-class_3.cpp)]  
...
### Parameters  
 [in] `pDataObject`  
 Pointer to a [COleDataObject](../VS_csharp/coledataobject-class.md) object that is being dragged over the drop target.  
...
### Remarks  
 Override this method with your custom implementation. For more information, see the [CView::OnDragOver](../VS_csharp/cview-class.md#cview__ondragover) method.  
...
### Remarks  
 ...
 Use the [CMFCBaseTabCtrl::AddTab](../VS_csharp/cmfcbasetabctrl-class.md#cmfcbasetabctrl__addtab) method that is inherited by the tab control to specify the index of the image to display.  
...
### Remarks  
 Use this method to limit the width of each tab in a tabbed window. This method is useful if tabs have very long labels. The [CMFCTabCtrl](../VS_csharp/cmfctabctrl-class.md) class constructor initializes the maximum tab width to 0, which actually means that the width is not limited.  
...
## See Also  
 ...
 [CMFCDockingControlBar](../VS_csharp/cdockablepane-class.md)   
 [CMFCDockingControlBar](../VS_csharp/cdockablepane-class.md)   
 [CMFCBaseTabWnd](../VS_csharp/cmfcbasetabctrl-class.md)