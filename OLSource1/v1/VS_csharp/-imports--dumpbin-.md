...
```  
 ...
 This option displays the list of DLLs (both statically linked and [delay loaded](../VS_csharp/linker-support-for-delay-loaded-dlls.md)) that are imported to an executable file or DLL and all the individual imports from each of these DLLs.  
...
## Remarks  
 The output displayed by this option is similar to the [/EXPORTS](../VS_csharp/-exports.md) output.  
