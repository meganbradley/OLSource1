...
---
# IMPLEMENT_OLECREATE
Either this macro or [IMPLEMENT_OLECREATE_FLAGS](../VS_csharp/implement_olecreate_flags.md) must appear in the implementation file for any class that uses `DECLARE_OLECREATE`.  
