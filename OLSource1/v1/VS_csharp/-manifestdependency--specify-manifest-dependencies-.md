...
## Remarks  
 ...
 See [/MANIFEST](../VS_csharp/-manifest--create-side-by-side-assembly-manifest-.md) for information on how to create a manifest file.  
...
-   Via the [comment](../VS_csharp/comment--c-c---.md) pragma.  
