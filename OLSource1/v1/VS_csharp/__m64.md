...
## Remarks  
 ...
 The `__m64` data type is not supported on [!INCLUDE[vcprx64](../VS_csharp/includes/vcprx64_md.md)] processors. Applications that use __m64 as part of MMX intrinsics must be rewritten to use equivalent SSE and SSE2 intrinsics.  
