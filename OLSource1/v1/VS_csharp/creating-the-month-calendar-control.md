...
3.  Use the [Add Member Variable Wizard](../VS_csharp/adding-a-member-variable---visual-c---.md) to add a member variable of type [CMonthCalCtrl](../VS_csharp/cmonthcalctrl-class.md) with the Control property. You can use this member to call `CMonthCalCtrl` member functions.  
  
4.  Use the Properties window to map handler functions in the dialog class for any month calendar control notification messages you need to handle (see [Mapping Messages to Functions](../VS_csharp/mapping-messages-to-functions.md)).  
...
## See Also  
 [Using CMonthCalCtrl](../VS_csharp/using-cmonthcalctrl.md)   
