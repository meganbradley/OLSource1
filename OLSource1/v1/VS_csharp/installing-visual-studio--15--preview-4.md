...
3.  We’ll ask you to acknowledge the Microsoft [License Terms](https://www.visualstudio.com/support/legal/mt591984) and the Microsoft [Privacy Statement](https://www.visualstudio.com/dn948229). Click **Install** to continue.  
     ...
     ![Installing Visual Studio '15' Preview 4 &#45; License Terms and Privacy Statement](../VS_csharp/media/01-installingdev15prev4_licensetermsandprivacystatement.png.PNG "01-InstallingDev15Prev4_LicenseTermsAndPrivacyStatement.PNG")  
...
4.  You’ll see several status screens that show the progress of the installation. After the installer is finished installing, it’s time to pick the feature sets—or workloads—that you want. To get started, click **Install**.  
     ...
     ![Installing Visual Studio '15' Preview 4 &#45; Install Button](../VS_csharp/media/02-installingdev15prev4_installbutton.PNG "02-InstallingDev15Prev4_InstallButton")  
...
1.  Find the workload you want in the **Installing Visual Studio** screen.  
     ...
     ![Installing Visual Studio '15' Preview 4 &#45; Choose Workloads](../VS_csharp/media/03-installingdev15prev4_chooseworkloads.png "03-InstallingDev15Prev4_ChooseWorkloads")  
     ...
     ![Installing Visual Studio '15' Preview 4 &#45; Select Web development workload](../VS_csharp/media/04-installingdev15prev4_selectwebdevworkload.png "04-InstallingDev15Prev4_SelectWebDevWorkload")  
     ...
     ![Installing Visual Studio '15' Preview 4 &#45; Optional components for the Web development workload](../VS_csharp/media/05-installingdev15prev4_selectwebdevworkload-options.PNG "05-InstallingDev15Prev4_SelectWebDevWorkload-Options")  
...
3.  Next, status screens will appear that show the progress of your Visual Studio installation. After everything’s installed, you can click either **Modify** to change your workloads, or click **Launch** to start Visual Studio.  
     ...
     ![Installing Visual Studio '15' Preview 4 &#45; Launch or Modify screen](../VS_csharp/media/06-installingdev15prev4_launchormodify.png "06-InstallingDev15Prev4_LaunchOrModify")  
     ...
     ![Installing Visual Studio '15' Preview 4 &#45; Choose viewing options](../VS_csharp/media/07-installingdev15prev4_chooseviewingoptions.PNG "07-InstallingDev15Prev4_ChooseViewingOptions")  
  
4.  After you make your selections, click **Start Visual Studio**, and you’re ready to go!  
  
## See Also  
 [Modifying Visual Studio '15' Preview 4](../VS_csharp/modifying-visual-studio--15--preview-4.md)