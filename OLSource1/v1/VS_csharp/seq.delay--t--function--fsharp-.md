...
#### Parameters  
 `generator`  
 Type: [unit](../VS_csharp/core.unit-type-abbreviation--fsharp-.md) `->` [seq](../VS_csharp/collections.seq--t--type-abbreviation--fsharp-.md)`<'T>`  
...
## Example  
 ...
 [!code[FsSequences#30](../VS_csharp/codesnippet/FSharp/seq.delay--t--function--fsharp-_1.fs)]  
...
## Example  
 ...
 [!code[FsSequences#31](../VS_csharp/codesnippet/FSharp/seq.delay--t--function--fsharp-_2.fs)]  
