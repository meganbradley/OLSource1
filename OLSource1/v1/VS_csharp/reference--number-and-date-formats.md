...
You can modify the display format for numbers and dates in [!INCLUDE[smb_current_long](../VS_csharp/includes/smb_current_long_md.md)] by setting the `Format Pattern` property. The following sections show the notation and rules for that property in addition to examples of format strings that are commonly used.  
...
1.  [Numeric Formats](../VS_csharp/reference--number-and-date-formats.md#NUMERIC)  
  
2.  [Standard Numeric Format Strings](../VS_csharp/reference--number-and-date-formats.md#STANDARD)  
  
3.  [Custom Numeric Format Strings](../VS_csharp/reference--number-and-date-formats.md#CUSTOM)  
  
4.  [Date and Time Formats](../VS_csharp/reference--number-and-date-formats.md#DATET)  
  
5.  [Standard Date and Time Format Strings](../VS_csharp/reference--number-and-date-formats.md#SDATE)  
  
6.  [Custom Date and Time Format Strings](../VS_csharp/reference--number-and-date-formats.md#CDATE)  
  
7.  [Formatting Guids](../VS_csharp/reference--number-and-date-formats.md#GUID)  
...
## See Also  
 [How to: Format Numbers and Dates](../VS_csharp/how-to--format-numbers-and-dates-in-a-lightswitch-application.md)   
