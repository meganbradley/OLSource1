...
This topic applies to the MFC ODBC classes.  
 ...
 A [CRecordset](../VS_csharp/crecordset-class.md) object represents a set of records selected from a data source. The records can be from:  
...
> [!NOTE]
>  For information about deriving recordset classes with the wizards, see [Adding an MFC ODBC Consumer](../VS_csharp/adding-an-mfc-odbc-consumer.md) and [Database Support, MFC Application Wizard](../VS_csharp/database-support--mfc-application-wizard.md).  
...
-   If the data source is not read-only, you can specify that your recordset be [updatable](../VS_csharp/recordset--adding--updating--and-deleting-records--odbc-.md), [appendable](../VS_csharp/recordset--adding--updating--and-deleting-records--odbc-.md), or read-only. If the recordset is updateable, you can choose either pessimistic or optimistic [locking](../VS_csharp/recordset--locking-records--odbc-.md) methods, provided the driver supplies the appropriate locking support. If the data source is read-only, the recordset will be read-only.  
  
-   You can call member functions to [scroll](../VS_csharp/recordset--scrolling--odbc-.md) through the selected records.  
  
-   You can [filter](../VS_csharp/recordset--filtering-records--odbc-.md) the records to constrain which records are selected from those available.  
  
-   You can [sort](../VS_csharp/recordset--sorting-records--odbc-.md) the records in ascending or descending order, based on one or more columns.  
  
-   You can [parameterize](../VS_csharp/recordset--parameterizing-a-recordset--odbc-.md) the recordset to qualify the recordset selection at run time.  
  
##  <a name="_core_snapshots_and_dynasets"></a> Snapshots and Dynasets  
 There are two principal types of recordsets: [snapshots](../VS_csharp/snapshot.md) and [dynasets](../VS_csharp/dynaset.md). Both are supported by class `CRecordset`. Each shares the common characteristics of all recordsets, but each also extends the common functionality in its own specialized way. Snapshots provide a static view of the data and are useful for reports and other situations in which you want a view of the data as it existed at a particular time. Dynasets are useful when you want updates made by other users to be visible in the recordset without having to requery or refresh the recordset. Snapshots and dynasets can be updateable or read-only. To reflect records added or deleted by other users, call [CRecordset::Requery](../Topic/CRecordset::Requery.md).  
...
-   [Recordset: Architecture (ODBC)](../VS_csharp/recordset--architecture--odbc-.md)  
  
-   [Recordset: Declaring a Class for a Table (ODBC)](../VS_csharp/recordset--declaring-a-class-for-a-table--odbc-.md)  
  
-   [Recordset: Creating and Closing Recordsets (ODBC)](../VS_csharp/recordset--creating-and-closing-recordsets--odbc-.md)  
  
-   [Recordset: Scrolling (ODBC)](../VS_csharp/recordset--scrolling--odbc-.md)  
  
-   [Recordset: Bookmarks and Absolute Positions (ODBC)](../VS_csharp/recordset--bookmarks-and-absolute-positions--odbc-.md)  
  
-   [Recordset: Filtering Records (ODBC)](../VS_csharp/recordset--filtering-records--odbc-.md)  
  
-   [Recordset: Sorting Records (ODBC)](../VS_csharp/recordset--sorting-records--odbc-.md)  
  
-   [Recordset: Parameterizing a Recordset (ODBC)](../VS_csharp/recordset--parameterizing-a-recordset--odbc-.md)  
  
### Topics about the mechanics of modifying recordsets  
  
-   [Recordset: Adding, Updating, and Deleting Records (ODBC)](../VS_csharp/recordset--adding--updating--and-deleting-records--odbc-.md)  
  
-   [Recordset: Locking Records (ODBC)](../VS_csharp/recordset--locking-records--odbc-.md)  
  
-   [Recordset: Requerying a Recordset (ODBC)](../VS_csharp/recordset--requerying-a-recordset--odbc-.md)  
  
### Topics about somewhat more advanced techniques  
  
-   [Recordset: Performing a Join (ODBC)](../VS_csharp/recordset--performing-a-join--odbc-.md)  
  
-   [Recordset: Declaring a Class for a Predefined Query (ODBC)](../VS_csharp/recordset--declaring-a-class-for-a-predefined-query--odbc-.md)  
  
-   [Recordset: Dynamically Binding Data Columns (ODBC)](../VS_csharp/recordset--dynamically-binding-data-columns--odbc-.md)  
  
-   [Recordset: Fetching Records in Bulk (ODBC)](../VS_csharp/recordset--fetching-records-in-bulk--odbc-.md)  
  
-   [Recordset: Working with Large Data Items (ODBC)](../VS_csharp/recordset--working-with-large-data-items--odbc-.md)  
  
-   [Recordset: Obtaining SUMs and Other Aggregate Results (ODBC)](../VS_csharp/recordset--obtaining-sums-and-other-aggregate-results--odbc-.md)  
  
### Topics about how recordsets work  
  
-   [Recordset: How Recordsets Select Records (ODBC)](../VS_csharp/recordset--how-recordsets-select-records--odbc-.md)  
