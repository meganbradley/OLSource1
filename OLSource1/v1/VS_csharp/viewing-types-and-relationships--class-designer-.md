...
## In This Section  
 [How to: View Existing Types](../VS_csharp/how-to--view-existing-types--class-designer-.md)  
  
 Describes how Class Designer can be used to visualize pre-existing code.  
  
 [How to: View Inheritance Between Types](../VS_csharp/how-to--view-inheritance-between-types--class-designer-.md)  
