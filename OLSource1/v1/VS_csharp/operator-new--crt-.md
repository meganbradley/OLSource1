...
## Remarks  
 This form of `operator new` is known as scalar new, in contrast to the vector new form ([operator new&#91;&#93;](../VS_csharp/operator-new-crt-.md)).  
 ...
 [operator delete](../VS_csharp/operator-delete--crt-.md) frees memory allocated with `operator new`.  
  
 You can configure whether operator new returns null or throws an exception on failure. See [The new and delete Operators](../VS_csharp/new-and-delete-operators.md) for more information.  
