...
## Rule Description  
 ...
 To be certain that your code contains only verifiable MSIL, run [Peverify.exe (PEVerify Tool)](assetId:///f4f46f9e-8d08-4e66-a94b-0c69c9b0bbfa) on your assembly. Run PEVerify with the **/transparent** option which limits the output to only unverifiable transparent methods which would cause an error. If the /transparent option is not used, PEVerify also verifies critical methods that are allowed to contain unverifiable code.  
...
## Example  
 ...
 [!code[FxCop.Security.CA2137.TransparentMethodsMustBeVerifiable#1](../VS_csharp/codesnippet/CSharp/ca2137--transparent-methods-must-contain-only-verifiable-il_1.cs)]