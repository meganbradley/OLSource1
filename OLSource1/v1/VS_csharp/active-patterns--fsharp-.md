...
## Remarks  
 ...
 [!code[FsLangRef2#5001](../VS_csharp/codesnippet/FSharp/active-patterns--fsharp-_1.fs)]  
  
 You can use the active pattern in a pattern matching expression, as in the following example.  
  
 [!code[FsLangRef2#5002](../VS_csharp/codesnippet/FSharp/active-patterns--fsharp-_2.fs)]  
...
```  
 ...
 [!code[FsLangRef2#5003](../VS_csharp/codesnippet/FSharp/active-patterns--fsharp-_3.fs)]  
...
## Partial Active Patterns  
 ...
 [!code[FsLangRef2#5004](../VS_csharp/codesnippet/FSharp/active-patterns--fsharp-_4.fs)]  
...
```  
 ...
 [!code[FsLangRef2#5005](../VS_csharp/codesnippet/FSharp/active-patterns--fsharp-_5.fs)]  
...
## Parameterized Active Patterns  
 ...
 [!code[FsLangRef2#5006](../VS_csharp/codesnippet/FSharp/active-patterns--fsharp-_6.fs)]  
...
## See Also  
 ...
 [Pattern Matching](../VS_csharp/match-expressions--fsharp-.md)