...
This topic enumerates the GUID and ID values of the menus and groups on the Visual Studio menu bar. These values are defined in .vsct files that are installed as part of the Visual Studio SDK. For more information, see [IDE-Defined Menus, Groups, and Commands](../VS_csharp/ide-defined-commands--menus--and-groups.md).  
  
 For more information about how to work with integrated development environment (IDE) objects that are defined in .vsct files, see [Common Menu Tasks](../VS_csharp/extending-menus-and-commands.md).  
