...
## Remarks  
 Use the `<seealso>` tag to specify the text that you want to appear in a See Also section. Use [<see\> (Visual Basic)](../VS_csharp/-see---visual-basic-.md) to specify a link from within text.  
...
## Example  
 ...
 [!code[VbVbcnXmlDocComments#6](../VS_csharp/codesnippet/VisualBasic/-seealso---visual-basic-_1.vb)]  
