...
You can use the Finder Tool in the **Find Window** dialog box to display window properties or messages. The Finder Tool can also locate disabled child windows, and discern which window to highlight if disabled child windows overlap.  
 ...
 ![Spy&#43;&#43; Find Window Dialog Box](../VS_csharp/media/icon_spy--_find.png "Icon_Spy++_Find")  
...
2.  From the **Spy** menu, choose **Find Window**.  
     ...
     The [Find Window Dialog Box](../VS_csharp/find-window-dialog-box.md) opens.  
...
5.  Press **OK**.  
     ...
     If you selected **Properties**, the [Window Properties Dialog Box](../VS_csharp/window-properties-dialog-box.md) opens. If you selected **Messages**, a [Messages View](../VS_csharp/messages-view.md) window opens.  
