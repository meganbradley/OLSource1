...
You can view resources in an .rc file without having a project open. The .rc file will open in a document window as opposed to opening in the [Resource View](../VS_csharp/resource-view-window.md) window (as it does when the file is open inside a project).  
...
2.  In the **Open File** dialog box, navigate to the resource script file you want to view, highlight the file, and click **Open**.  
 ...
 To open and view the resource file in text format, see [Editing a Resource Script (.rc) File](../VS_csharp/how-to--open-a-resource-script-file-in-text-format.md).  
