...
dev_langs: 
  - "FSharp"
helpviewer_keywords: 
  - "RequiresExplicitTypeArgumentsAttribute class [F#]"
  - "RequiresExplicitTypeArguments attribute [F#]"
...
|Member|Description|  
|------------|-----------------|  
|[new](../VS_csharp/core.requiresexplicittypeargumentsattribute-constructor--fsharp-.md)|Creates an instance of the attribute|  
