...
## Remarks  
 This class provides the basis for other smart pointers which use COM memory management routines, such as [CComQIPtr](../VS_csharp/ccomqiptr-class.md) and [CComPtr](../VS_csharp/ccomptr-class.md). The derived classes add their own constructors and operators, but rely on the methods provided by `CComPtrBase`.  
...
### Remarks  
 See [AtlAdvise](../VS_csharp/atladvise.md) for more information.  
...
### Remarks  
 This method calls [AtlSetChildSite](../VS_csharp/atlsetchildsite.md).  
