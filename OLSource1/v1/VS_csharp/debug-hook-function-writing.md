...
## In This Section  
 [Client Block Hook Functions](../VS_csharp/client-block-hook-functions.md)  
 ...
 [Allocation Hook Functions](../VS_csharp/allocation-hook-functions.md)  
 Defines an allocation hook function, explores its different uses, points out restrictions, and provides a prototype.  
  
 [Allocation Hooks and CRT Memory Allocations](../VS_csharp/allocation-hooks-and-c-run-time-memory-allocations.md)  
 ...
 [Report Hook Functions](../VS_csharp/report-hook-functions.md)  
