...
The `switch` statement is a control statement that selects a *switch section* to execute from a list of candidates.  
 ...
 [!code[csrefKeywordsSelection#7](../VS_csharp/codesnippet/CSharp/switch--csharp-reference-_1.cs)]  
...
## Example  
 ...
 [!code[csrefKeywordsSelection#9](../VS_csharp/codesnippet/CSharp/switch--csharp-reference-_2.cs)]  
  
## Example  
 In the final example, the string variable, `str`, and string case labels control the flow of execution.  
  
 [!code[csrefKeywordsSelection#8](../VS_csharp/codesnippet/CSharp/switch--csharp-reference-_3.cs)]  
