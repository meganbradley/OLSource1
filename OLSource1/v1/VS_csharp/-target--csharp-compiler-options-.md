...
The **/target** compiler option can be specified in one of four forms:  
 ...
 [/target:appcontainerexe](../VS_csharp/-target-appcontainerexe--csharp-compiler-options-.md)  
 To create an .exe file for [!INCLUDE[win8_appname_long](../VS_csharp/includes/win8_appname_long_md.md)] apps.  
  
 [/target:exe](../VS_csharp/-target-exe--csharp-compiler-options-.md)  
 To create an .exe file.  
  
 [/target:library](../VS_csharp/-target-library--csharp-compiler-options-.md)  
 To create a code library.  
  
 [/target:module](../VS_csharp/-target-module--csharp-compiler-options-.md)  
 To create a module.  
  
 [/target:winexe](../VS_csharp/-target-winexe--csharp-compiler-options-.md)  
 To create a Windows program.  
  
 [/target:winmdobj](../VS_csharp/-target-winmdobj--csharp-compiler-options-.md)  
 To create an intermediate .winmdobj file.  
  
 Unless you specify **/target:module**, **/target** causes a .NET Framework assembly manifest to be placed in an output file. For more information, see [Assemblies in the Common Language Runtime](assetId:///2cfebe19-7436-49f1-bd99-3c4019f0b676) and [Common Attributes](../VS_csharp/common-attributes--csharp-and-visual-basic-.md).  
