...
|`Sync`|The synchronization policy for the allocator, which is [sync_none](../VS_csharp/sync_none-class.md), [sync_per_container](../VS_csharp/sync_per_container-class.md), [sync_per_thread](../VS_csharp/sync_per_thread-class.md), or [sync_shared](../VS_csharp/sync_shared-class.md).|  
...
### Remarks  
 The first constructor constructs an [allocator_base](../VS_csharp/allocator_base-class.md) instance. The second constructor constructs an `allocator_base` instance such that for any `allocator_base<Type, _Sync>` instance `a`, `allocator_base<Type, Sync>(allocator_base<Other, Sync>(a)) == a`.  
