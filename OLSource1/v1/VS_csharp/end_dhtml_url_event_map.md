...
#### Parameters  
 `className`  
 The name of the class containing the event map. This class should derive directly or indirectly from [CMultiPageDHtmlDialog](../VS_csharp/cmultipagedhtmldialog-class.md). This should match `className` in the corresponding [BEGIN_DHTML_URL_EVENT_MAP](../VS_csharp/begin_dhtml_url_event_map.md) macro.  
