...
|Name|Description|  
|----------|-----------------|  
|[_U_RECT::_U_RECT](../VS_csharp/_u_rect--_u_rect.md)|The constructor.|  
  
### Public Data Members  
  
|Name|Description|  
|----------|-----------------|  
|[_U_RECT::m_lpRect](../VS_csharp/_u_rect--m_lprect.md)|Pointer to a `RECT`.|  
  
## Remarks  
 The class defines two constructor overloads: one accepts a **RECT&** argument and the other accepts an `LPRECT` argument. The first constructor stores the address of the reference argument in the class's single data member, [m_lpRect](../VS_csharp/_u_rect--m_lprect.md). The argument to the pointer constructor is stored directly without conversion.  
