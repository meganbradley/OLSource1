...
## Remarks  
 You can derive a class from [CPaneFrameWnd](../VS_csharp/cpaneframewnd-class.md) and use the protected method, `AddButton`, to add caption buttons to a mini frame window.  
...
## Example  
 ...
 [!code[NVC_MFC_RibbonApp#43](../VS_csharp/codesnippet/CPP/cmfccaptionbutton-class_1.cpp)]  
  
## Inheritance Hierarchy  
 [CObject](../VS_csharp/cobject-class.md)  
  
 [CMFCCaptionButton](../VS_csharp/cmfccaptionbutton-class.md)  
...
## See Also  
 ...
 [CMFCDockablePane](../VS_csharp/cdockablepane-class.md)