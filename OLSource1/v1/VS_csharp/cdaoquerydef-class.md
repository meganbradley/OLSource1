...
1.  In all cases, first construct a `CDaoQueryDef` object, supplying a pointer to the [CDaoDatabase](../VS_csharp/cdaodatabase-class.md) object to which the query belongs.  
 ...
 **Append** saves the querydef in the database by appending the object to the database's QueryDefs collection. You can use the querydef as a temporary object without appending it, but if you want it to persist, you must call **Append**.  
 ...
 If you attempt to append a temporary querydef object, MFC throws an exception of type [CDaoException](../VS_csharp/cdaoexception-class.md).  
...
### Parameters  
 `pDatabase`  
 A pointer to an open [CDaoDatabase](../VS_csharp/cdaodatabase-class.md) object.  
...
### Remarks  
 Closing the querydef releases the underlying DAO object but does not destroy the saved DAO querydef object or the C++ `CDaoQueryDef` object. This is not the same as [CDaoDatabase::DeleteQueryDef](../VS_csharp/cdaodatabase-class.md#cdaodatabase__deletequerydef), which deletes the querydef from the database's QueryDefs collection in DAO (if not a temporary querydef).  
 ...
 **Execute** does not return a recordset. Using **Execute** on a query that selects records causes MFC to throw an exception of type [CDaoException](../VS_csharp/cdaoexception-class.md).  
...
### Return Value  
 A [CString](../VS_csharp/cstringt-class.md) containing the connection string for the querydef.  
...
### Return Value  
 A [COleDateTime](../VS_csharp/coledatetime-class.md) object containing the date and time the querydef was created.  
...
### Return Value  
 A [COleDateTime](../VS_csharp/coledatetime-class.md) object containing the date and time the querydef was last updated.  
...
-   `AFX_DAO_ALL_INFO` Primary and secondary information plus: Default Value, Validation Text, Validation Rule  
 ...
 `lpszName`  
 A string containing the name of the desired field, for lookup by name. You can use a [CString](../VS_csharp/cstringt-class.md).  
  
### Remarks  
 For a description of the information returned in `fieldinfo`, see the [CDaoFieldInfo](../VS_csharp/cdaofieldinfo-structure.md) structure. This structure has members that correspond to the descriptive information under `dwInfoOptions` above. If you request one level of information, you get any prior levels of information as well.  
...
### Parameters  
 ...
 `paraminfo`  
 A reference to a [CDaoParameterInfo](../VS_csharp/cdaoparameterinfo-structure.md) object that returns the information requested.  
...
-   `AFX_DAO_PRIMARY_INFO` (Default) Name, Type  
 ...
 `lpszName`  
 A string containing the name of the desired parameter, for lookup by name. You can use a [CString](../VS_csharp/cstringt-class.md).  
  
### Remarks  
 For a description of the information returned in `paraminfo`, see the [CDaoParameterInfo](../VS_csharp/cdaoparameterinfo-structure.md) structure. This structure has members that correspond to the descriptive information under `dwInfoOptions` above.  
...
### Remarks  
 A querydef must be in an open state before you use it to call [Execute](#cdaoquerydef__execute) or to create a [CDaoRecordset](../VS_csharp/cdaorecordset-class.md) object. To put a querydef into an open state call either [Create](#cdaoquerydef__create) (for a new querydef) or [Open](#cdaoquerydef__open) (for an existing querydef).  
  
##  <a name="cdaoquerydef__m_pdatabase"></a>  CDaoQueryDef::m_pDatabase  
 Contains a pointer to the [CDaoDatabase](../VS_csharp/cdaodatabase-class.md) object associated with the querydef object.  
...
### Parameters  
 `lpszName`  
 A string that contains the name of the saved querydef to open. You can use a [CString](../VS_csharp/cstringt-class.md).  
  
### Remarks  
 Once the querydef is open, you can call its [Execute](#cdaoquerydef__execute) member function or use the querydef to create a [CDaoRecordset](../VS_csharp/cdaorecordset-class.md) object.  
...
### Parameters  
 `lpszConnect`  
 A string that contains a connection string for the associated [CDaoDatabase](../VS_csharp/cdaodatabase-class.md) object.  
...
### Parameters  
 `lpszName`  
 A string that contains the new name for a nontemporary query in the associated [CDaoDatabase](../VS_csharp/cdaodatabase-class.md) object.  
...
### Remarks  
 ...
 Specify the value to set as a `COleVariant` object. For information about setting the desired value and type in your `COleVariant` object, see class [COleVariant](../VS_csharp/colevariant-class.md).  
