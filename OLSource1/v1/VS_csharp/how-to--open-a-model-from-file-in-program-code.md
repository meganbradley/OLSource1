...
You can open DSL models in any application.  
 ...
 From a [!INCLUDE[vsprvs](../VS_csharp/includes/vsprvs_md.md)] extension, you can use ModelBus for this purpose. ModelBus provides standard mechanism for referencing a model or elements in a model, and for finding the model if it has moved. For more information, see [Integrating DSLs using ModelBus](../VS_csharp/integrating-models-by-using-visual-studio-modelbus.md).  
...
1.  Open the [!INCLUDE[vsprvs](../VS_csharp/includes/vsprvs_md.md)] project for the application in which you want to read a DSL model.  
...
## References  
 You have to add these references to your [!INCLUDE[vsprvs](../VS_csharp/includes/vsprvs_md.md)] application project:  
