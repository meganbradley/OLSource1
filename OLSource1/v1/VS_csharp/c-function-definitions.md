 ...
 **{**  `declaration`-*list* opt*statement-list* opt**}**  
 ...
 The sections [Function Attributes](../VS_csharp/function-attributes.md), [Storage Class](../VS_csharp/storage-class.md), [Return Type](../VS_csharp/return-type.md), [Parameters](../VS_csharp/parameters.md), and [Function Body](../VS_csharp/function-body.md) describe the components of the function definition in detail.  
