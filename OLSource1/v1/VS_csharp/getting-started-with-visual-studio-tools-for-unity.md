...
#### 2 - Configure Unity Editor to use Visual Studio Tools for Unity  
 ...
 ![Import the VSTU package into your Unity project.](../VS_csharp/media/vstu_configure_unity_import_vstu.png "vstu_configure_unity_import_vstu")  
...
#### 3 - Launch Visual Studio from Unity Editor  
 ...
 ![Open your unity project in Visual Studio.](../VS_csharp/media/vstu_configure_open_in_visual_studio.png "vstu_configure_open_in_visual_studio")  
  
## Next steps  
 To learn how to work with and debug your Unity project in Visual Studio, see [Using Visual Studio Tools for Unity](../VS_csharp/getting-started-with-visual-studio-tools-for-unity.md).  
