...
Windows Presentation Foundation (WPF) lets you create desktop client applications for Windows with visually stunning user experiences.  
 ...
 ![Contoso Healthcare UI sample](../VS_csharp/media/wpfintrofigure24.png "WPFIntroFigure24")  
...
```  
 ...
 ![A window that contains a button](../VS_csharp/media/wpfintrofigure10.png "WPFIntroFigure10")  
...
```  
 ...
 ![A MessageBox](../VS_csharp/media/wpfintrofigure25.png "WPFIntroFigure25")  
...
##  <a name="Controls"></a> Controls  
 ...
 For more information, see [Controls](assetId:///3f255a8a-35a8-4712-9065-472ff7d75599).  
...
-   <xref:System.Windows.Controls.WrapPanel*>: Child controls are positioned in left-to-right order and wrapped to the next line when there are more controls on the current line than space allows.  
 ...
 [!code[IntroToWPFSnippets#LayoutMARKUP](../VS_csharp/codesnippet/Xaml/introduction-to-wpf_1.xaml)]  
...
>  A property that is implemented by a parent control for use by child controls is a WPF construct called an [attached property](https://msdn.microsoft.com/en-us/library/ms749011\(v=vs.100\).aspx).  
 ...
 ![DockPanel page](../VS_csharp/media/wpfintrofigure11.png "WPFIntroFigure11")  
...
2.  Ensuring that changes made to data by using controls are copied back to the managed objects.  
 ...
 ![Basic data binding diagram](../VS_csharp/media/databindingmostbasic.png "DataBindingMostBasic")  
 ...
 [!code[SimpleDataBindingSnippets#PersonClassCODE](../VS_csharp/codesnippet/VisualBasic/introduction-to-wpf_2.vb)]
[!code[SimpleDataBindingSnippets#PersonClassCODE](../VS_csharp/codesnippet/CSharp/introduction-to-wpf_2.cs)]  
  
 The following markup binds the <xref:System.Windows.Controls.TextBox*> to an instance of a custom `Person` object.  
  
 [!code[SimpleDataBindingSnippets#DataBindingMARKUP1](../VS_csharp/codesnippet/Xaml/introduction-to-wpf_3.xaml)]  
[!code[SimpleDataBindingSnippets#DataBindingMARKUP2](../VS_csharp/codesnippet/Xaml/introduction-to-wpf_4.xaml)]  
[!code[SimpleDataBindingSnippets#DataBindingMARKUP3](../VS_csharp/codesnippet/Xaml/introduction-to-wpf_5.xaml)]  
  
 [!code[SimpleDataBindingSnippets#DataBindingCODEBEHIND](../VS_csharp/codesnippet/VisualBasic/introduction-to-wpf_6.vb)]
[!code[SimpleDataBindingSnippets#DataBindingCODEBEHIND](../VS_csharp/codesnippet/CSharp/introduction-to-wpf_6.cs)]  
...
### 2-D Shapes  
 ...
 ![Ellipses and rectangles](../VS_csharp/media/wpfintrofigure4.PNG "WPFIntroFigure4")  
 ...
 [!code[IntroToWPFSnippets#HandleEllipseMouseUpEventMARKUP](../VS_csharp/codesnippet/Xaml/introduction-to-wpf_7.xaml)]  
  
 [!code[IntroToWPFSnippets#HandleEllipseMouseUpEventCODEBEHIND](../VS_csharp/codesnippet/VisualBasic/introduction-to-wpf_8.vb)]
[!code[IntroToWPFSnippets#HandleEllipseMouseUpEventCODEBEHIND](../VS_csharp/codesnippet/CSharp/introduction-to-wpf_8.cs)]  
  
 The following figure shows what is produced by the preceding code.  
  
 ![A window with the text "you clicked the ellipse&#33;"](../VS_csharp/media/wpfintrofigure12.png "WPFIntroFigure12")  
...
### 2-D Geometries  
 ...
 ![Various uses of a Path](../VS_csharp/media/wpfintrofigure5.PNG "WPFIntroFigure5")  
...
### 2-D Effects  
 ...
 ![Illustration of different brushes](../VS_csharp/media/wpfintrofigure6.PNG "WPFIntroFigure6")  
...
### 3-D Rendering  
 ...
 ![Visual3D sample screen shot](../VS_csharp/media/wpfintrofigure13.png "WPFIntroFigure13")  
...
##  <a name="Animation"></a> Animation  
 ...
 ![Images of an animated cube](../VS_csharp/media/wpfintrofigure7.png "WPFIntroFigure7")  
...
### Images  
 ...
 ![Thumbnail images and a full&#45;size image](../VS_csharp/media/wpfintrofigure8.PNG "WPFIntroFigure8")  
...
### Video and Audio  
 ...
 [!code[IntroToWPFSnippets#MediaElementMARKUP](../VS_csharp/codesnippet/Xaml/introduction-to-wpf_9.xaml)]  
  
 The window in the following figure shows the <xref:System.Windows.Controls.MediaElement*> control in action.  
  
 ![A MediaElement control with audio and video](../VS_csharp/media/wpfintrofigure1.png "WPFIntroFigure1")  
...
-   International font support and fallback mechanisms.  
 ...
 ![Text with various text decorations](../VS_csharp/media/wpfintrofigure23.png "WPFIntroFigure23")  
...
### Content Model  
 ...
 [!code[IntroToWPFSnippets#TextBoxContentMARKUP1](../VS_csharp/codesnippet/Xaml/introduction-to-wpf_10.xaml)]  
[!code[IntroToWPFSnippets#TextBoxContentMARKUP2](../VS_csharp/codesnippet/Xaml/introduction-to-wpf_11.xaml)]  
[!code[IntroToWPFSnippets#TextBoxContentMARKUP3](../VS_csharp/codesnippet/Xaml/introduction-to-wpf_12.xaml)]  
  
 The following figure shows the result.  
  
 ![A TextBox control that contains text](../VS_csharp/media/wpfintrofigure21.png "WPFIntroFigure21")  
 ...
 [!code[IntroToWPFSnippets#ButtonContentMARKUP1](../VS_csharp/codesnippet/Xaml/introduction-to-wpf_13.xaml)]  
[!code[IntroToWPFSnippets#ButtonContentMARKUP2](../VS_csharp/codesnippet/Xaml/introduction-to-wpf_14.xaml)]  
[!code[IntroToWPFSnippets#ButtonContentMARKUP3](../VS_csharp/codesnippet/Xaml/introduction-to-wpf_15.xaml)]  
  
 The following figure shows the content of this button.  
  
 ![A button that contains multiple types of content](../VS_csharp/media/wpfintrofigure22.png "WPFIntroFigure22")  
...
### Control Templates  
 ...
 [!code[IntroToWPFSnippets#ButtonControlTemplateWindowMARKUP](../VS_csharp/codesnippet/Xaml/introduction-to-wpf_16.xaml)]  
  
 [!code[IntroToWPFSnippets#ButtonControlTemplateWindowCODEBEHIND](../VS_csharp/codesnippet/CSharp/introduction-to-wpf_17.cs)]
[!code[IntroToWPFSnippets#ButtonControlTemplateWindowCODEBEHIND](../VS_csharp/codesnippet/VisualBasic/introduction-to-wpf_17.vb)]  
 ...
 ![An elliptical button and a second window](../VS_csharp/media/wpfintrofigure2.png "WPFIntroFigure2")  
...
### Data Templates  
 ...
 ![A list box with the default appearance](../VS_csharp/media/wpfintrofigure18.png "WPFIntroFigure18")  
 ...
 [!code[IntroToWPFSnippets#DataTemplateMARKUP1](../VS_csharp/codesnippet/Xaml/introduction-to-wpf_18.xaml)]  
[!code[IntroToWPFSnippets#DataTemplateMARKUP2](../VS_csharp/codesnippet/Xaml/introduction-to-wpf_19.xaml)]  
[!code[IntroToWPFSnippets#DataTemplateMARKUP3](../VS_csharp/codesnippet/Xaml/introduction-to-wpf_20.xaml)]  
[!code[IntroToWPFSnippets#DataTemplateMARKUP4](../VS_csharp/codesnippet/Xaml/introduction-to-wpf_21.xaml)]  
  
 The following figure shows the effect of this code.  
  
 ![Llist box that uses a data template](../VS_csharp/media/wpfintrofigure19.png "WPFIntroFigure19")  
...
### Styles  
 ...
 [!code[IntroToWPFSnippets#StyleMARKUP1](../VS_csharp/codesnippet/Xaml/introduction-to-wpf_22.xaml)]  
[!code[IntroToWPFSnippets#StyleMARKUP2](../VS_csharp/codesnippet/Xaml/introduction-to-wpf_23.xaml)]  
[!code[IntroToWPFSnippets#StyleMARKUP3](../VS_csharp/codesnippet/Xaml/introduction-to-wpf_24.xaml)]  
[!code[IntroToWPFSnippets#StyleMARKUP4](../VS_csharp/codesnippet/Xaml/introduction-to-wpf_25.xaml)]  
 ...
 ![Two orange buttons](../VS_csharp/media/wpfintrofigure20.png "WPFIntroFigure20")  
...
### Resources  
 ...
 [!code[IntroToWPFSnippets#ResourceWindowMARKUP1](../VS_csharp/codesnippet/Xaml/introduction-to-wpf_26.xaml)]  
[!code[IntroToWPFSnippets#ResourceWindowMARKUP2](../VS_csharp/codesnippet/Xaml/introduction-to-wpf_27.xaml)]  
[!code[IntroToWPFSnippets#ResourceWindowMARKUP3](../VS_csharp/codesnippet/Xaml/introduction-to-wpf_28.xaml)]  
...
3.  An <xref:System.Windows.Application*> (using the <xref:System.Windows.Application.Resources*?displayProperty=fullName> property).  
 ...
 [!code[IntroToWPFSnippets#ResourceDictionaryMARKUP1](../VS_csharp/codesnippet/Xaml/introduction-to-wpf_29.xaml)]  
[!code[IntroToWPFSnippets#ResourceDictionaryMARKUP2](../VS_csharp/codesnippet/Xaml/introduction-to-wpf_30.xaml)]  
 ...
 [!code[IntroToWPFSnippets#ApplicationScopedResourceDictionaryMARKUP1](../VS_csharp/codesnippet/Xaml/introduction-to-wpf_31.xaml)]  
[!code[IntroToWPFSnippets#ApplicationScopedResourceDictionaryMARKUP2](../VS_csharp/codesnippet/Xaml/introduction-to-wpf_32.xaml)]  
...
-   **Framework Element Model**. A custom control derives from <xref:System.Windows.FrameworkElement*> when its appearance is defined by custom rendering logic (not templates).  
 ...
 [!code[IntroToWPFSnippets#UserControlMARKUP](../VS_csharp/codesnippet/Xaml/introduction-to-wpf_33.xaml)]  
  
 [!code[IntroToWPFSnippets#UserControlCODEBEHIND1](../VS_csharp/codesnippet/CSharp/introduction-to-wpf_34.cs)]
[!code[IntroToWPFSnippets#UserControlCODEBEHIND1](../VS_csharp/codesnippet/VisualBasic/introduction-to-wpf_34.vb)]  
[!code[IntroToWPFSnippets#UserControlCODEBEHIND2](../VS_csharp/codesnippet/CSharp/introduction-to-wpf_35.cs)]
[!code[IntroToWPFSnippets#UserControlCODEBEHIND2](../VS_csharp/codesnippet/VisualBasic/introduction-to-wpf_35.vb)]  
[!CODE [IntroToWPFSnippets#UserControlCODEBEHIND3](../CodeSnippet/VS_Snippets_Wpf/IntroToWPFSnippets#usercontrolcodebehind3)]  
 ...
 [!code[IntroToWPFSnippets#UserControlWindowMARKUP1](../VS_csharp/codesnippet/Xaml/introduction-to-wpf_37.xaml)]  
[!code[IntroToWPFSnippets#UserControlWindowMARKUP2](../VS_csharp/codesnippet/Xaml/introduction-to-wpf_38.xaml)]  
[!code[IntroToWPFSnippets#UserControlWindowMARKUP3](../VS_csharp/codesnippet/Xaml/introduction-to-wpf_39.xaml)]  
  
 The following figure shows the `NumericUpDown` control hosted in a <xref:System.Windows.Window*>.  
  
 ![A custom UserControl](../VS_csharp/media/wpfintrofigure3.png "WPFIntroFigure3")  
...
## See Also  
 [Getting Started with WPF](../VS_csharp/getting-started-with-wpf.md)   
 [Create Modern Desktop Applications with Windows Presentation Foundation](../VS_csharp/create-modern-desktop-applications-with-windows-presentation-foundation.md)   
