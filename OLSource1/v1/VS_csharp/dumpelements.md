...
## Remarks  
 ...
 For information on diagnostics and on the `Dump` function, see [Debugging MFC Applications](../VS_csharp/mfc-debugging-techniques.md).  
...
## See Also  
 ...
 [CDumpContext::SetDepth](../Topic/CDumpContext::SetDepth.md)   
