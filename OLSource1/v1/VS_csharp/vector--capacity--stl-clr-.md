...
## Remarks  
 The member function returns the storage currently allocated to hold the controlled sequence, a value at least as large as [size](../VS_csharp/vector--size--stl-clr-.md)`()`. You use it to determine how much the container can grow before it must reallocate storage for the controlled sequence.  
...
## See Also  
 ...
 [reserve](../VS_csharp/vector--reserve--stl-clr-.md)