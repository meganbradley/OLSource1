...
## Remarks  
 ...
 The first template is the form that you should use in your code. The second template (not shown here, but declared in the header file) is an internal, helper specialization that supports C++ language features such as the [auto](../VS_csharp/auto--c---.md) type deduction keyword.  
...
## See Also  
 [WeakRef Class](../VS_csharp/weakref-class.md)