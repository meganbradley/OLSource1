...
-   [Reset item properties to their default values](#reset).  
 ...
 For more information about how to accomplish design tasks by using the screen designer, see [How to: Customize a Screen by Using the Screen Designer](../VS_csharp/how-to--design-a-silverlight-screen-by-using-the-screen-designer.md).  
...
2.  Click the **Add Group** button. ![Adds a group.](../VS_csharp/media/ls_group_button.gif "LS_Group_Button")  
  
3.  In the **Screen Content Tree** of the **Customization Mode** screen, select the item (for example, a field or command).  
  
4.  Next to the screen, click the **Move Up** (![Moves the item to a higher position in the list.](../VS_csharp/media/ls_addbutton_button.png "LS_AddButton_Button")) and **Move Down** (![Moves an item to a position lower in the list.](../VS_csharp/media/ls_movedown_button.png "LS_MoveDown_Button")) buttons to move an item into the group.  
...
2.  Next to the **Screen Content Tree**, click the **Delete** (![Deletes the selected item.](../VS_csharp/media/ls_delete_button.png "LS_Delete_Button")) button.  
...
2.  Next to the screen, click the **Move Up** (![Moves the item to a higher position in the list.](../VS_csharp/media/ls_addbutton_button.png "LS_AddButton_Button")) and **Move Down** (![Moves an item to a position lower in the list.](../VS_csharp/media/ls_movedown_button.png "LS_MoveDown_Button")) buttons to position an item in the list of items.  
...
2.  Next to the **Screen Content Tree**, click the **Reset Items** button. ![Resets item properties to their default values.](../VS_csharp/media/ls_resetfields_button.png "LS_ResetFields_Button")  
