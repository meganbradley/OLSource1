...
3.  Optional but recommended: Overload the [==](../VS_csharp/==-operator--csharp-reference-.md) and [!=](../VS_csharp/!=-operator--csharp-reference-.md) operators.  
...
5.  Optional: To support definitions for "greater than" or "less than," implement the <xref:System.IComparable`1> interface for your type, and also overload the [<=](../VS_csharp/-=-operator--csharp-reference-.md) and [>=](../VS_csharp/-=-operator--csharp-reference-.md) operators.  
...
## Example  
 ...
 [!code[csProgGuideStatements#19](../VS_csharp/codesnippet/CSharp/how-to--define-value-equality-for-a-type--csharp-programming-guide-_1.cs)]  
...
## Example  
 ...
 [!code[csProgGuideStatements#20](../VS_csharp/codesnippet/CSharp/how-to--define-value-equality-for-a-type--csharp-programming-guide-_2.cs)]  
 ...
 The [==](../VS_csharp/==-operator--csharp-reference-.md) and [!=](../VS_csharp/!=-operator--csharp-reference-.md) operators cannot operate on a struct unless the struct explicitly overloads them.  
  
## See Also  
 [Equality Comparisons](../VS_csharp/equality-comparisons--csharp-programming-guide-.md)   
