...
As you read the code examples, you often encounter the comment symbol (`'`). This symbol tells the [!INCLUDE[vbprvb](../VS_csharp/includes/vbprvb_md.md)] compiler to ignore the text following it, or the *comment*. Comments are brief explanatory notes added to code for the benefit of those reading it.  
 ...
 [!code[VbVbcnConventions#16](../VS_csharp/codesnippet/VisualBasic/comments-in-code--visual-basic-_1.vb)]  
  
 If your comment requires more than one line, use the comment symbol on each line, as the following example illustrates.  
  
 [!code[VbVbcnConventions#17](../VS_csharp/codesnippet/VisualBasic/comments-in-code--visual-basic-_2.vb)]  
  
## Commenting Guidelines  
 The following table provides general guidelines for what types of comments can precede a section of code. These are suggestions; [!INCLUDE[vbprvb](../VS_csharp/includes/vbprvb_md.md)] does not enforce rules for adding comments. Write what works best, both for you and for anyone else who reads your code.  
...
-   Comments cannot follow a line-continuation sequence on the same line.  
 ...
 You can add or remove comment symbols for a block of code by selecting one or more lines of code and choosing the **Comment** (![VisualBasicWinAppCodeEditorCommentButton](../VS_csharp/media/vacommentbutton.gif "vaCommentButton")) and **Uncomment** (![VisualStudioWinAppProjectUncommentButton](../VS_csharp/media/vauncommentbutton.gif "vaUncommentButton")) buttons on the **Edit** toolbar.  
...
## See Also  
 ...
 [](../VS_csharp/how-to--create-xml-documentation-in-visual-basic.md "How to: Create XML Documentation in Visual Basic")   
 [](../VS_csharp/recommended-xml-tags-for-documentation-comments--visual-basic-.md "Recommended XML Tags for Documentation Comments (Visual Basic)")   
 [Program Structure and Code Conventions](../VS_csharp/program-structure-and-code-conventions--visual-basic-.md)   
 [REM Statement (Visual Basic)](../VS_csharp/rem-statement--visual-basic-.md)