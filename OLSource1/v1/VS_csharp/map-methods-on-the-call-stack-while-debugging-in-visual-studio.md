...
Create a code map to visually trace the call stack while you’re debugging. You can make notes on the map to track what the code is doing so you can focus on finding bugs.  
 ...
 ![Debugging with call stacks on code maps](../VS_csharp/media/debuggermap_overview.png "DebuggerMap_Overview")  
...
-   Code that you can debug, such as Visual C# .NET, Visual Basic .NET, C++, JavaScript, or X++  
 ...
 For details of the commands and actions you can use when working with code maps, see [Browse and rearrange code maps](../VS_csharp/browse-and-rearrange-code-maps.md).  
...
2.  After your app enters break mode or you step into a function, choose **Code Map**. (Keyboard: **Ctrl** + **Shift** + **`**)  
     ...
     ![Choose Code Map to start mapping call stack](../VS_csharp/media/debuggermap_choosecodemap.png "DebuggerMap_ChooseCodeMap")  
  
     The current call stack appears in orange on a new code map:  
  
     ![See call stack on code map](../VS_csharp/media/debuggermap_seeundocallstack.png "DebuggerMap_SeeUndoCallStack")  
...
##  <a name="MakeNotes"></a> Make notes about the code  
 ...
 ![Add comment to call stack on code map](../VS_csharp/media/debuggermap_addcomment.png "DebuggerMap_AddComment")  
...
##  <a name="UpdateMap"></a> Update the map with the next call stack  
 ...
 ![Update code map with next call stack](../VS_csharp/media/debuggermap_addclearcallstack.png "DebuggerMap_AddClearCallStack")  
...
##  <a name="AddRelatedCode"></a> Add related code to the map  
 ...
 ![Go to code definition for a method on code map](../VS_csharp/media/debuggermap_gotocodedefinition.png "DebuggerMap_GoToCodeDefinition")  
  
 Add the items that you want to track on the map.  
  
 ![Show fields in a method on call stack code map](../VS_csharp/media/debuggermap_showfields.png "DebuggerMap_ShowFields")  
...
>  By default, adding items to the map also adds the parent group nodes such as the class, namespace, and assembly. While this is useful, you can keep the map simple by turning off this feature using the **Include Parents** button on the map toolbar, or by pressing **CTRL** when you add items.  
 ...
 ![Fields related to a method on call stack code map](../VS_csharp/media/debuggermap_showedfields.png "DebuggerMap_ShowedFields")  
 ...
 ![See methods that use a field: call stack code map](../VS_csharp/media/debuggermap_findallreferences.png "DebuggerMap_FindAllReferences")  
  
 ![Methods that use a field on call stack code map](../VS_csharp/media/debuggermap_foundallreferences.png "DebuggerMap_FoundAllReferences")  
...
##  <a name="FindBugs"></a> Find bugs using the map  
 ...
 ![Add another call stack to code map](../VS_csharp/media/debuggermap_addpaintobjectcallstack.png "DebuggerMap_AddPaintObjectCallStack")  
 ...
 ![Add new method call to call stack on code map](../VS_csharp/media/debuggermap_addnewcallforrepaint.png "DebuggerMap_AddNewCallForRepaint")  
...
-   **Not all calls appear on the map. Why?**  
     ...
     ![Display external code using the Call Stack window](../VS_csharp/media/debuggermap_callstackmenu.png "DebuggerMap_CallStackMenu")  
  
     or turn off **Enable Just My Code** in the Visual Studio debugging options:  
  
     ![Show external code using Options dialog](../VS_csharp/media/debuggermap_debugoptions.png "DebuggerMap_DebugOptions")  
...
-   **Can I share the map with others?**  
     ...
     ![Share call stack code map with others](../VS_csharp/media/debuggermap_sharewithothers.png "DebuggerMap_ShareWithOthers")  
  
-   **How do I stop the map from adding new call stacks automatically?**  
  
     Choose ![Button &#45; Show call stack on code map automatically](../VS_csharp/media/debuggermap_automaticupdateicon.gif "DebuggerMap_AutomaticUpdateIcon") on the map toolbar. To manually add the current call stack to the map, press **Ctrl** + **Shift** + **`**.  
...
-   **What do the item icons and arrows mean?**  
     ...
     ![What do icons on the call stack code map mean?](../VS_csharp/media/debuggermap_showlegend.png "DebuggerMap_ShowLegend")  
