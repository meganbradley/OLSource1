...
## Remarks  
 ...
 You can set `/langversion` directly only by using the command line. For more information, see [Targeting a Specific .NET Framework](../VS_csharp/targeting-a-specific-.net-framework-version.md).  
