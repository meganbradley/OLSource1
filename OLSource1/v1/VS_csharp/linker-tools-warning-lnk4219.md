...
fixup name fixup overflow. Target 'target symbol name' is out of range, inserting thunk  
 ...
 You may want to reorder the image (using the [/ORDER](../VS_csharp/-order--put-functions-in-order-.md) option, for example) to avoid the extra level of indirection.