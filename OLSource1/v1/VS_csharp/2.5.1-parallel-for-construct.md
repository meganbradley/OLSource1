...
-   **parallel** directive, see [Section 2.3](../VS_csharp/2.3-parallel-construct.md) on page 8.  
  
-   **for** directive, see [Section 2.4.1](../VS_csharp/2.4.1-for-construct.md) on page 11.  
  
-   Data attribute clauses, see [2.7.2 Data-Sharing Attribute Clauses](../VS_csharp/2.7.2-data-sharing-attribute-clauses.md) on page 25.