...
3.  Call <xref:Microsoft.VisualStudio.TextManager.Interop.IVsLinkedUndoTransactionManager.CloseLinkedUndo*> to roll back all of the linked undo units as one.  
    ...
    > [!NOTE]
    >  To implement linked undo management in an editor, add undo management. For more information on implementing linked undo management, see [How to: Implement Undo Management](../VS_csharp/how-to--implement-undo-management.md).  
