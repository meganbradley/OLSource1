...
#### Parameters  
 `Flags`  
 [in] A combination of flags from the [PROVIDER_FLAGS](../VS_csharp/provider_flags.md) enumeration. The following flags are typical for this call:  
...
|`PFLAG_GET_PROGRAM_NODES`|Caller is asking for a list of program nodes to be returned.|  
 ...
 `processId`  
 [in] An [AD_PROCESS_ID](../VS_csharp/ad_process_id.md) structure holding the ID of the process that contains the program in question.  
 ...
 `pProcess`  
 [out] A [PROVIDER_PROCESS_DATA](../VS_csharp/provider_process_data.md) structure that is filled in with the requested information.  
  
## Return Value  
 If successful, returns `S_OK`; otherwise, returns an error code.  
  
## Remarks  
 This method is normally called by a process to obtain a list of programs running in that process. The returned information is a list of [IDebugProgramNode2](../VS_csharp/idebugprogramnode2.md) objects.  
  
## See Also  
 [IDebugProgramProvider2](../VS_csharp/idebugprogramprovider2.md)   
 [IDebugDefaultPort2](../VS_csharp/idebugdefaultport2.md)   
