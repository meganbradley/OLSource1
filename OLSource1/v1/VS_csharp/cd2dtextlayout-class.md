...
|Name|Description|  
|----------|-----------------|  
|[CD2DTextLayout::Create](#cd2dtextlayout__create)|Creates a CD2DTextLayout. (Overrides [CD2DResource::Create](../VS_csharp/cd2dresource-class.md#cd2dresource__create).)|  
|[CD2DTextLayout::Destroy](#cd2dtextlayout__destroy)|Destroys a CD2DTextLayout object. (Overrides [CD2DResource::Destroy](../VS_csharp/cd2dresource-class.md#cd2dresource__destroy).)|  
...
|[CD2DTextLayout::IsValid](#cd2dtextlayout__isvalid)|Checks resource validity (Overrides [CD2DResource::IsValid](../VS_csharp/cd2dresource-class.md#cd2dresource__isvalid).)|  
|[CD2DTextLayout::ReCreate](#cd2dtextlayout__recreate)|Re-creates a CD2DTextLayout. (Overrides [CD2DResource::ReCreate](../VS_csharp/cd2dresource-class.md#cd2dresource__recreate).)|  
...
## Inheritance Hierarchy  
 ...
 [CD2DTextLayout](../VS_csharp/cd2dtextlayout-class.md)  
