...
-   When you test for overloaded functions, you cannot test for a specific form of the overload.  
 ...
 The complement to the `__if_exists` statement is the [__if_not_exists](../VS_csharp/__if_not_exists-statement.md) statement.  
...
## See Also  
 ...
 [The __if_not_exists Statement](../VS_csharp/__if_not_exists-statement.md)