...
## Remarks  
 The member function returns a pair of iterators `cliext::pair<iterator, iterator>(` [lower_bound](../VS_csharp/hash_map--lower_bound--stl-clr-.md)`(``key``),` [upper_bound](../VS_csharp/hash_map--upper_bound--stl-clr-.md)`(``key``))`. You use it to determine the range of elements currently in the controlled sequence that match a specified key.  
...
## See Also  
 ...
 [upper_bound](../VS_csharp/hash_map--upper_bound--stl-clr-.md)