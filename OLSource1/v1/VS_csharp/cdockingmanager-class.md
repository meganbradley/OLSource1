...
|[CDockingManager::Serialize](#cdockingmanager__serialize)|Writes the docking manager to an archive. (Overrides [CObject::Serialize](../VS_csharp/cobject-class.md#cobject__serialize).)|  
...
## Remarks  
 ...
 The docking manager object holds a list of all panes that are in the docking layout, and also a list of all [CPaneFrameWnd](../VS_csharp/cpaneframewnd-class.md) windows that belong to the main frame window.  
  
 The `CDockingManager` class implements some services that you can use to find a pane or a `CPaneFrameWnd` window. You usually do not call these services directly because they are wrapped in the main frame window object. For more information, see [CPaneFrameWnd Class](../VS_csharp/cpaneframewnd-class.md).  
  
## Customization Tips  
 The following tips apply to `CDockingManager` objects:  
  
-   [CDockingManager Class](../VS_csharp/cdockingmanager-class.md) supports these docking modes:  
...
### Return Value  
 The [CBasePane](../VS_csharp/cbasepane-class.md) object that has the specified control ID, or `NULL` if the specified pane cannot be found.  
...
### Return Value  
 A bitwise combination of `CBRS_ALIGN_` flags, or 0 if autohide panes are not enabled. For more information, see [CFrameWnd::EnableDocking](../VS_csharp/cframewnd-class.md#cframewnd__enabledocking).  
  
### Remarks  
 The method returns the enabled alignment for autohide control bars. To enable autohide bars, call [CFrameWndEx::EnableAutoHidePanes](../VS_csharp/cframewndex-class.md#cframewndex__enableautohidepanes).  
...
### Remarks  
 If there are any tabbed panes in the docking manager, the method returns pointers to [CBaseTabbedPane Class](../VS_csharp/cbasetabbedpane-class.md) objects and you must enumerate the tabs explicitly.  
...
### Return Value  
 The class that contains the smart docking parameters for the current docking manager. For more information, see [CSmartDockingInfo Class](../VS_csharp/csmartdockinginfo-class.md).  
...
### Remarks  
 By default, each docking pane uses this docking mode. For more information about the values that this field can be set to, see [CBasePane::GetDockingMode](../VS_csharp/cbasepane-class.md#cbasepane__getdockingmode).  
...
### Return Value  
 The [CBasePane](../VS_csharp/cbasepane-class.md)-derived object that contains the given point, or `NULL` if no pane was found.  
...
### Remarks  
 ...
 To use the default look for smart docking markers, pass an uninitialized instance of [CSmartDockingInfo Class](../VS_csharp/csmartdockinginfo-class.md) to `params`.  
...
## See Also  
 ...
 [CFrameWndEx](../VS_csharp/cframewndex-class.md)   
 [CDockablePane Class](../VS_csharp/cdockablepane-class.md)   
 [CPaneFrameWnd Class](../VS_csharp/cpaneframewnd-class.md)