...
1.  Click the item once to select it, then again to begin editing it. Make the changes directly in the Version Information table or in the [Properties window](../VS_csharp/properties-window.md). The changes you make will be reflected in both places.  
