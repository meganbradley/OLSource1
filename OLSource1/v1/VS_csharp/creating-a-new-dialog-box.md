...
1.  In [Resource View](../VS_csharp/resource-view-window.md), right-click your .rc file, then choose **Add Resource** from the shortcut menu.  
...
2.  In the **Add Resource** dialog box, select **Dialog** in the **Resource Type** list, then click **New**.  
     ...
     You can also [open existing dialog boxes in the Dialog Box editor for editing](../VS_csharp/viewing-and-editing-resources-in-a-resource-editor.md).  
