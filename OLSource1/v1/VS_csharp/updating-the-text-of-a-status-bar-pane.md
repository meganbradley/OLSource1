...
3.  Add the pane to the **indicators** array.  
     ...
     [!code[NVC_MFCDocView#10](../VS_csharp/codesnippet/CPP/updating-the-text-of-a-status-bar-pane_1.cpp)]  
...
1.  Add a command update handler for the command.  
     ...
     [!code[NVC_MFCDocView#11](../VS_csharp/codesnippet/CPP/updating-the-text-of-a-status-bar-pane_2.h)]  
  
2.  In the appropriate .CPP file, add the handler's definition, as shown here for `ID_INDICATOR_PAGE` (in MAINFRM.CPP):  
  
     [!code[NVC_MFCDocView#12](../VS_csharp/codesnippet/CPP/updating-the-text-of-a-status-bar-pane_3.cpp)]  
...
3.  In the appropriate message map, add the `ON_UPDATE_COMMAND_UI` macro, as shown here for `ID_INDICATOR_PAGE` (in MAINFRM.CPP):  
     ...
     [!code[NVC_MFCDocView#13](../VS_csharp/codesnippet/CPP/updating-the-text-of-a-status-bar-pane_4.cpp)]  
...
-   [Updating user-interface objects (how to update toolbar buttons and menu items as program conditions change)](../VS_csharp/how-to--update-user-interface-objects.md)  
  
## See Also  
 [Status Bar Implementation in MFC](../VS_csharp/status-bar-implementation-in-mfc.md)   
 [CStatusBar Class](../VS_csharp/cstatusbar-class.md)