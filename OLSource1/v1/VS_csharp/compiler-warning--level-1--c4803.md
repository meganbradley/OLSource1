...
'method' : the raise method has a different storage class from that of the event, 'event'  
 ...
 See [warning](../VS_csharp/warning.md) pragma for information on how to turn a warning off.  
  
## Example  
 C4803 can be generated using **/clr**. See [event](../VS_csharp/event---c---component-extensions-.md) for more information on using events..  
