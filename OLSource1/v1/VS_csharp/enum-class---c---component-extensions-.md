 ...
 *underlying-type*  
 ...
 (Optional. [!INCLUDE[wrt](../VS_csharp/includes/wrt_md.md)] only) The underlying type of the enumeration, which can be `bool`, `char`, `char16`, `int16`, `uint16`, `int`, `uint32`, `int64`, or `uint64`.  
...
```  
 ...
 For more information about native enums, see [C++ Enumeration Declarations](../VS_csharp/enumerations--c---.md).  
  
 For more information on CLR enums, see:  
  
-   [Underlying Type of an Enum](../VS_csharp/how-to--define-and-consume-enums-in-c---cli.md)  
