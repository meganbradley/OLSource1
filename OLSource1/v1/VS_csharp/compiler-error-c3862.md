...
'function': cannot compile an unmanaged function with /clr:pure or /clr:safe  
 ...
 For more information, see [/clr (Common Language Runtime Compilation)](../VS_csharp/-clr--common-language-runtime-compilation-.md) and [managed, unmanaged](../VS_csharp/managed--unmanaged.md).  
