...
## Remarks  
 ...
 For more information on Exception Handling, see the [CException Class](../VS_csharp/cexception-class.md) topic and [Exception Handling (MFC)](../VS_csharp/exception-handling-in-mfc.md).  
...
## See Also  
 ...
 [CSimpleException Class](../VS_csharp/csimpleexception-class.md)