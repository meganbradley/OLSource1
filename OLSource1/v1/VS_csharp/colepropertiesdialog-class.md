...
## Remarks  
 ...
 For more information on OLE dialog boxes, see the article [Dialog Boxes in OLE](../VS_csharp/dialog-boxes-in-ole.md).  
...
### Remarks  
 ...
 For more information on the **OLEUIGNRLPROPS** structure, see the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Remarks  
 ...
 For more information on the **OLEUILINKPROPS** structure, see the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Remarks  
 ...
 For more information, see the **OLEUIOBJECTPROPS** and                         [OLEUILINKPROPS](http://msdn.microsoft.com/library/windows/desktop/ms680735) structures in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Remarks  
 ...
 For more information on the **PROPSHEETHEADER** structure, see the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Remarks  
 ...
 For more information on the **OLEUIVIEWPROPS** structure, see the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
## See Also  
 [MFC Sample CIRC](../VS_csharp/visual-c---samples.md)   
