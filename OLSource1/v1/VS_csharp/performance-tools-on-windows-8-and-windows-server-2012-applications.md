...
-   Instrumentation options, such as collecting performance and windows counter data, or specifying additional command-line options.  
 ...
 [Running Windows Metro style apps on the local machine](../VS_csharp/run-windows-store-apps-on-the-local-machine.md)  
  
 [Running Windows Metro style apps on a remote machine](../VS_csharp/run-windows-store-apps-on-a-remote-machine.md)  
  
 [Analyzing the performance of Windows Metro style apps](../Topic/Analyze%20the%20performance%20of%20Windows%20Store%20apps%20using%20Visual%20Studio%20diagnostic%20tools.md)  
  
-   [How to profile JavaScript code in Windows Metro style apps on a local machine](../Topic/JavaScript%20Function%20Timing.md)  
  
-   [How to profile JavaScript code in Windows Metro style apps on a remote device](../Topic/JavaScript%20Function%20Timing%20on%20a%20Remote%20Device.md)  
  
-   [Analyzing JavaScript performance data in Metro Style apps](../Topic/Analyze%20JavaScript%20Function%20Timing%20data.md)  
...
|---------------|-----------------|  
|[VSPerf.exe](../VS_csharp/vsperf.md)|Collects profiling data from Windows Store apps and collects sample profiling data from Windows 8 desktop applications and Windows Server 2012 applications..|  
|[VSPerfCmd](../VS_csharp/vsperfcmd.md)|Collects instrumentation, concurrency, and tier interaction profiling data from apps that are running on theWindows 8 desktop or Windows Server 2012. Collects all types of profiling data from previous versions of Windows.|  
...
-   Collecting data from Windows 8 and Windows Server 2012 web apps by using sampling mode with [VSPerfASPNetCmd](../VS_csharp/vsperfaspnetcmd.md).  
 ...
 **Visual Studio editions**  
 ...
 Tier interaction profiling data can be collected using [!INCLUDE[vsUltLong](../VS_csharp/includes/vsultlong_md.md)], [!INCLUDE[vsPreLong](../VS_csharp/includes/vsprelong_md.md)], or [!INCLUDE[vs_pro_current_short](../VS_csharp/includes/vs_pro_current_short_md.md)]. However, tier interaction profiling data can be viewed only in [!INCLUDE[vsUltLong](../VS_csharp/includes/vsultlong_md.md)] and [!INCLUDE[vsPreLong](../VS_csharp/includes/vsprelong_md.md)].  
 ...
 **Performance Wizard and Performance Explorer**  
 ...
 You must add the tier interaction data collection option to a profiling run from the Performance Explorer. You must also add the project, executable, or website to the Target node of Performance Explorer. See [Collecting tier interaction data by using the Visual Studio IDE](../VS_csharp/collecting-tier-interaction-data.md).  
 ...
 **Collecting TIP data on a remote machine**  
 ...
 You can use [VSPerfCmd](../VS_csharp/vsperfcmd.md) or [VSPerfASPNetCmd](../VS_csharp/vsperfaspnetcmd.md) to collect the profiling data.  
  
 **TIP reports**  
  
 Tier interaction data can only be viewed in the [!INCLUDE[vsUltLong](../VS_csharp/includes/vsultlong_md.md)] or [!INCLUDE[vsPreLong](../VS_csharp/includes/vsprelong_md.md)] IDE. File based tier interaction reports through [VSPerfReport](../VS_csharp/vsperfreport.md) are not available.  
  
## See Also  
 [Analyzing Application Performance by Using Profiling Tools](../VS_csharp/performance-explorer.md)   
 [Configuring Performance Sessions for Profiling Tools](../VS_csharp/configuring-performance-sessions.md)   
 [Using the Profiling Tools From the Command-Line](../VS_csharp/using-the-profiling-tools-from-the-command-line.md)