...
This walkthrough builds on the [Adding a Toolbar to a Tool Window](../VS_csharp/adding-a-toolbar-to-a-tool-window.md) walkthrough and shows how to add a menu controller to the tool window toolbar. The steps shown here also can be applied to the toolbar that is created in the [Adding a Toolbar](../VS_csharp/adding-a-toolbar.md) walkthrough.  
...
1.  Follow the procedures described in [Adding a Toolbar to a Tool Window](../VS_csharp/adding-a-toolbar-to-a-tool-window.md) to create a tool window that has a toolbar.  
...
## See Also  
 [Adding a Toolbar to a Tool Window](../VS_csharp/adding-a-toolbar-to-a-tool-window.md)   
 [Adding a Toolbar to the IDE](../VS_csharp/adding-a-toolbar.md)