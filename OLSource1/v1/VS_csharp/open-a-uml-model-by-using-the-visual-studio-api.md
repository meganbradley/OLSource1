...
-   Visual Studio Model Bus allows you to access models and elements within them, and provides a standard method of making links between one model and another. For more information, see [How to Access UML Diagrams and Models using Model Bus](../VS_csharp/integrate-uml-models-with-other-models-and-tools.md).  
  
-   You can open a model in read-only mode. For more information, see [How to Open a UML Model in Program Code](../VS_csharp/read-a-uml-model-in-program-code.md).  
