...
##  <a name="BKMK_Find_the_source_and_symbol___pdb__files"></a> Find the source and symbol (.pdb) files  
 To navigate the source code of a process, the debugger needs access to the source files and symbol files of the process. See [Find Symbol (.pdb),Source, and Binary Files](../VS_csharp/specify-symbol--.pdb--and-source-files-in-the-visual-studio-debugger.md).  
  
 If you can’t access the files for a process, you can navigate by using the Disassemby window. See [How to: Use the Disassembly Window](../VS_csharp/how-to--use-the-disassembly-window.md)  
...
###  <a name="BKMK_Start_debugging_multiple_processes_in_a_Visual_Studio_solution"></a> Start debugging multiple processes in a Visual Studio solution  
 ...
 ![Changing the startup type for a project](../VS_csharp/media/dbg_execution_startmultipleprojects.png "DBG_Execution_StartMultipleProjects")  
...
####  <a name="BKMK_Start_a_specific_project_in_a_solution"></a> Start a specific project in a solution  
 ...
 ![Back to top](../VS_csharp/media/pcs_backtotop.png "PCS_BackToTop") [Start multiple processes in a VS solution, attach to a process, automatically start a process in the debugger](../VS_csharp/debug-multiple-processes.md#BKMK_Start_multiple_processes_in_a_VS_solution__attach_to_a_process__automatically_start_a_process_in_the_debugger)  
...
###  <a name="BKMK_Attach_to_a_process"></a> Attach to a process  
 ...
 See [Attaching to Running Processes](../VS_csharp/attach-to-running-processes-with-the-visual-studio-debugger.md) for more information.  
 ...
 **Attach to a process that is running on your local machine**  
 ...
 ![Attach to Process dialog box](../VS_csharp/media/dbg_attachtoprocessdlg.png "DBG_AttachToProcessDlg")  
...
7.  On the Edit String dialog box, type `vsjitdebugger.exe` in the **Value data** box.  
     ...
     ![Edit String dialog box](../VS_csharp/media/dbg_execution_automaticstart_editstringdlg.png "DBG_Execution_AutomaticStart_EditStringDlg")  
  
 ![Automatic debugger start entry in regedit.exe](../VS_csharp/media/dbg_execution_automaticstart_result.png "DBG_Execution_AutomaticStart_Result")  
...
-   On the Debug Location toolbar, choose **Process** to view the **Process** list box. Select the process that you want to designate as current process.  
     ...
     ![Switch between processes](../VS_csharp/media/dbg_execution_switchbetweenmodules.png "DBG_Execution_SwitchBetweenModules")  
...
-   Open the **Processes** window (shortcut **Ctrl+Alt+Z**), find the process that you want to set as the current process, and double-click it.  
     ...
     ![Processes window](../VS_csharp/media/dbg_processeswindow.png "DBG_ProcessesWindow")  
 ...
 ![Back to top](../VS_csharp/media/pcs_backtotop.png "PCS_BackToTop") [Switch processes, break and continue execution, step through source](../VS_csharp/debug-multiple-processes.md#BKMK_Switch_processes__break_and_continue_execution__step_through_source)  
...
|**Processes** window context menu:<br /><br /> -   **Detach when debugging stops**|Toggles the behavior of **Debug**, **Stop Debugging** for the selected process:<br /><br /> -   Checked: The debugger detaches from the process.<br />-   Cleared: The process is terminated.|  
 ...
 ![Back to top](../VS_csharp/media/pcs_backtotop.png "PCS_BackToTop") [Stop debugging, terminate or detach from processes](../VS_csharp/debug-multiple-processes.md#BKMK_Stop_debugging__terminate_or_detach_from_processes)  
  
 ![Back to top](../VS_csharp/media/pcs_backtotop.png "PCS_BackToTop") [Contents](#BKMK_Contents)  
  
## See Also  
 [Find Symbol (.pdb),Source, and Binary Files](../VS_csharp/specify-symbol--.pdb--and-source-files-in-the-visual-studio-debugger.md)   
 [Attach to Running Processes](../VS_csharp/attach-to-running-processes-with-the-visual-studio-debugger.md)   
 [Start, Break, Navigate, and Stop the Visual Studio Debugger](../VS_csharp/navigating-through-code-with-the-debugger.md)   
 [Just-In-Time Debugging](../VS_csharp/just-in-time-debugging-in-visual-studio.md)   
 [Debug Multithreaded Applications in Visual Studio](../VS_csharp/debug-multithreaded-applications-in-visual-studio.md)