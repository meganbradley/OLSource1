...
Returns the greatest of all elements of the array, compared by using [Operators.max](../VS_csharp/operators.max--t--function--fsharp-.md) on the function result.  
...
## Example  
 ...
 [!code[FsArrays#56](../VS_csharp/codesnippet/FSharp/array.maxby--t--u--function--fsharp-_1.fs)]  
