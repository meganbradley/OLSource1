...
#### Parameters  
 ...
 `token`  
 When this operation completes, a handle that represents the event. Use this token as the parameter to the [Remove()](../VS_csharp/eventsource--remove-method.md) method to discard the event handler.  
...
## See Also  
 [EventSource Class](../VS_csharp/eventsource-class.md)