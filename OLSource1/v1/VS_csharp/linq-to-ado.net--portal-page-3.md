...
[!INCLUDE[linq_adonet](../Token/linq_adonet_md.md)] enables you to query over any enumerable object in [!INCLUDE[vstecado](../VS_csharp/includes/vstecado_md.md)] by using the [!INCLUDE[vbteclinqext](../VS_csharp/includes/vbteclinqext_md.md)] programming model.  
...
>  The [!INCLUDE[linq_adonet](../Token/linq_adonet_md.md)] documentation is located in the ADO.NET section of the .NET Framework SDK: [LINQ and ADO.NET](../Topic/LINQ%20and%20ADO.NET.md).  
 ...
 There are three separate ADO.NET [!INCLUDE[vbteclinqext](../VS_csharp/includes/vbteclinqext_md.md)] technologies: [!INCLUDE[linq_dataset](../VS_csharp/includes/linq_dataset_md.md)], [!INCLUDE[vbtecdlinq](../VS_csharp/includes/vbtecdlinq_md.md)], and [!INCLUDE[linq_entities](../Token/linq_entities_md.md)]. [!INCLUDE[linq_dataset](../VS_csharp/includes/linq_dataset_md.md)] provides richer, optimized querying over the \<xref:System.Data.DataSet>, [!INCLUDE[vbtecdlinq](../VS_csharp/includes/vbtecdlinq_md.md)] enables you to directly query [!INCLUDE[ssNoVersion](../VS_csharp/includes/ssnoversion_md.md)] database schemas, and [!INCLUDE[linq_entities](../Token/linq_entities_md.md)] allows you to query an [!INCLUDE[adonet_edm](../VS_csharp/includes/adonet_edm_md.md)].  
