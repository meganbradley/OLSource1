...
-   **Tabbed document** tool windows can be docked within the document well. This is useful for large tool windows, such as the Object Browser, that need more real estate than docking to the edges of the frame allows.  
 ...
 ![Tool window states in Visual Studio](../VS_csharp/media/0702-01_toolwindowstates.png "0702-01_ToolWindowStates")  
...
#### Single-instance and multi-instance  
 ...
 ![Tool window enabling commands in Visual Studio](../VS_csharp/media/0702-02_toolwindowenablingcommand.png "0702-02_ToolWindowEnablingCommand")  
 ...
 **Tool window enabling ‘New Window’ command when an instance of the window is active**  
 ...
 ![Window management commands in Visual Studio](../VS_csharp/media/0702-03_windowmanagementcontrols.png "0702-03_WindowManagementControls")  
...
-   The dialog is an important part of an experience that plays a strategic role in promoting or differentiating a product version.  
 ...
 When creating a themed dialog, use the appropriate environment colors and follow the correct layout and interaction patterns. (See [Layout for Visual Studio](../VS_csharp/layout-for-visual-studio.md))  
...
####  <a name="BKMK_SimpleDialogs"></a> Simple dialogs  
 ...
 ![Simple dialog in Visual Studio](../VS_csharp/media/0704-01_createstrongnamekey.png "0704-01_CreateStrongNameKey")  
...
####  <a name="BKMK_LayeredDialogs"></a> Layered dialogs  
 ...
 ![Layered dialog in Visual Studio](../VS_csharp/media/0704-02_toolsoptions.png "0704-02_ToolsOptions")  
...
### Common conventions  
 ...
 For layout-specific guidelines, see [Layout for Visual Studio](../VS_csharp/layout-for-visual-studio.md).  
...
-   Help buttons in the title bar have been deprecated. Do not add them to new dialogs. When they do exist, they should launch a Help topic that is conceptually relevant to the task.  
 ...
 ![Title bar specifications for Visual Studio](../VS_csharp/media/0704-03_titlebarspecs.png "0704-03_TitleBarSpecs")  
...
#### Control buttons  
 ...
 ![Control button configurations in Visual Studio](../VS_csharp/media/0704-04_controlbuttonconfig.png "0704-04_ControlButtonConfig")  
...
##### Hallways or dashboards  
 ...
 ![Hallway concept in Outlook](../VS_csharp/media/0704-08_hallway.png "0704-08_Hallway")  
...
|-------------------|-------------|-----------------|  
|![Mouse "no drop" icon](../VS_csharp/media/0706-01_mousenodrop.png "0706-01_MouseNoDrop")|No drop|Item cannot be dropped to the specified location.|  
|![Mouse "copy" icon](../VS_csharp/media/0706-02_mousecopy.png "0706-02_MouseCopy")|Copy|Item will be copied to the target location.|  
|![Mouse "move" icon](../VS_csharp/media/0706-03_mousemove.png "0706-03_MouseMove")|Move|Item will be moved to the target location.|  
|![Mouse "add reference" icon](../VS_csharp/media/0706-04_mouseaddref.png "0706-04_MouseAddRef")|Add reference|A reference to the selected item will be added to the target location.|  
