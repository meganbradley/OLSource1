...
-   [The Task List window](../VS_csharp/using-the-task-list.md#taskListWindow)  
  
-   [User Tasks--deprecated](../VS_csharp/using-the-task-list.md#userTasks)  
  
-   [Tokens and comments](../VS_csharp/using-the-task-list.md#tokensComments)  
  
-   [Custom tokens](../VS_csharp/using-the-task-list.md#customTokens)  
  
-   [C++ TODO comments](../VS_csharp/using-the-task-list.md#cppComments)  
  
-   [Shortcuts](../VS_csharp/using-the-task-list.md#shortcuts)  
...
-   On the **View** menu, choose **Task List** (Keyboard: Ctrl+\\,T).  
     ...
     ![Task List window](../VS_csharp/media/vs2015_task_list.png "vs2015_task_list")  
...
2.  Open the **Environment** folder and then choose **Task List**.  
     ...
     The [Task List, Environment, Options Dialog Box](../VS_csharp/task-list--environment--options-dialog-box.md) is displayed.  
  
     ![Visual Studio Task List](../VS_csharp/media/vs2015_task_list_options.png "vs2015_task_list_options")  
...
##  <a name="shortcuts"></a> Shortcuts  
 ...
 ![Visual Studio Task List Shortcut Icon](../VS_csharp/media/vs2015_task_list_bookmark.png "vs2015_task_list_bookmark")  
...
## See Also  
 [Task List, Environment, Options Dialog Box](../VS_csharp/task-list--environment--options-dialog-box.md)