...
## The Phong lighting model  
 ...
 For more information about the Lambert lighting model, see [How To: Create a Lambert Shader](../VS_csharp/how-to--create-a-basic-lambert-shader.md).  
  
 Before you begin, make sure that the **Properties** window and the **Toolbox** are displayed.  
  
#### To create a Phong shader  
  
1.  Create a Lambert shader, as described in [How To: Create a Lambert Shader](../VS_csharp/how-to--create-a-basic-lambert-shader.md).  
...
> [!NOTE]
>  To better demonstrate the effect of the shader in this illustration, an orange color has been specified by using the **MaterialDiffuse** parameter of the shader, and a metallic-looking finish has been specified by using the **MaterialSpecular** and **MaterialSpecularPower** parameters. For information about material parameters, see the Previewing Shaders section in [Shader Designer](../VS_csharp/shader-designer.md).  
  
 ![Shader graph and a preview of its effect](../VS_csharp/media/digit-lighting-graph.png "Digit-Lighting-Graph")  
  
 Certain shapes might provide better previews for some shaders. For more information about how to preview shaders in the Shader Designer, see the Previewing Shaders section in [Shader Designer](../VS_csharp/shader-designer.md)  
...
>  The **MaterialSpecularPower** property determines how intense the specular highlights are. High specular powers simulate duller, more-localized highlights. Very low specular powers simulate intense, sweeping highlights that can oversaturate and conceal the color of the whole surface.  
 ...
 ![Phong lighting applied to a model](../VS_csharp/media/digit-lighting-model.png "Digit-Lighting-Model")  
...
## See Also  
 ...
 [How To: Create a Lambert Shader](../VS_csharp/how-to--create-a-basic-lambert-shader.md)   
