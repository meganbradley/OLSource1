...
-   A [get](../VS_csharp/get--csharp-reference-.md) property accessor is used to return the property value, and a [set](../VS_csharp/set--csharp-reference-.md) accessor is used to assign a new value. These accessors can have different access levels. For more information, see [Restricting Accessor Accessibility](../VS_csharp/restricting-accessor-accessibility--csharp-programming-guide-.md).  
...
-   For simple properties that require no custom accessor code, consider the option of using auto-implemented properties. For more information, see [Auto-Implemented Properties](../VS_csharp/auto-implemented-properties--csharp-programming-guide-.md).  
