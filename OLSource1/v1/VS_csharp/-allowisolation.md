 ...
 **/ALLOWISOLATION:NO** indicates that executables are loaded as if there were no manifest, and causes [EDITBIN](../VS_csharp/editbin-reference.md) to set the `IMAGE_DLLCHARACTERISTICS_NO_ISOLATION` bit in the optional header's `DllCharacteristics` field.  
...
## See Also  
 ...
 [/ALLOWISOLATION (Manifest Lookup)](../VS_csharp/-allowisolation--manifest-lookup-.md)   
