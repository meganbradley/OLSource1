...
## Code Sample  
 Your project must reference the following [!INCLUDE[TLA2#tla_net](../VS_csharp/includes/tla2sharptla_net_md.md)] assemblies:  
...
```  
 ...
 For more information about `ElementGroupPrototype` and the `Store` in which the UML modeling tools are implemented, see [Domain-Specific Languages](../VS_csharp/modeling-sdk-for-visual-studio---domain-specific-languages.md).  
  
## See Also  
 [Programming with the UML API](../VS_csharp/programming-with-the-uml-api.md)   
 [How to: Define a Gesture Handler on a UML Diagram](../VS_csharp/define-a-menu-command-on-a-modeling-diagram.md)