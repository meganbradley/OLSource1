...
3.  In the **Breakpoint Condition** dialog box, click on the **Condition** check box. See [Specify a breakpoint condition using a code expression](../VS_csharp/using-breakpoints.md#BKMK_Specify_a_breakpoint_condition_using_a_code_expression).  
...
7.  Use the Call Stack window to find the calling function and navigate to its source code. For more information, see [How to: Use the Call Stack Window](../VS_csharp/how-to--use-the-call-stack-window.md).  
