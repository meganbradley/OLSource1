...
-   [!INCLUDE[win8_appname_long](../VS_csharp/includes/win8_appname_long_md.md)] apps. To build [!INCLUDE[win8_appname_long](../VS_csharp/includes/win8_appname_long_md.md)] apps, you must install Visual Studio on the build computer.  
...
-   [Installing software on the computers](../VS_csharp/walkthrough--creating-a-multiple-computer-build-environment.md#InstallingSoftware)  
  
-   [Copying files from the host computer to the build computer](../VS_csharp/walkthrough--creating-a-multiple-computer-build-environment.md#CopyingFiles)  
  
-   [Creating registry settings](../VS_csharp/walkthrough--creating-a-multiple-computer-build-environment.md#CreatingRegistry)  
  
-   [Setting environment variables on the build computer](../VS_csharp/walkthrough--creating-a-multiple-computer-build-environment.md#SettingEnvVariables)  
  
-   [Installing MSBuild assemblies to the GAC on the build computer](../VS_csharp/walkthrough--creating-a-multiple-computer-build-environment.md#InstallingMSBuildToGAC)  
  
-   [Building projects](../VS_csharp/walkthrough--creating-a-multiple-computer-build-environment.md#BuildingProjects)  
  
-   [Creating the build environment so that it can be checked into source control](../VS_csharp/walkthrough--creating-a-multiple-computer-build-environment.md#CreatingForSourceControl)  
...
5.  Copy only the following files from the \Debug_NonRedist\x86\ or \Debug_NonRedist\x64\ folder to the build computer, as described in [Preparing a Test Machine to Run a Debug Executable](../VS_csharp/preparing-a-test-machine-to-run-a-debug-executable.md). No other files may be copied.  
...
-   Open a Command Prompt window on the build computer and run %Program Files%\Microsoft Visual Studio 11.0\VC\vcvarsall.bat. You can use a command-line argument to specify the toolset you want to use—x86, native x64, or x64 cross-compiler. If you don't specify a command-line argument, the x86 toolset is used.  
    ...
    |amd64|x64 Native|x64|x64|  
     ...
     If vcvarsall.bat runs successfully—that is, no error message is displayed—you can skip the next step and continue at the [Installing MSBuild assemblies to the GAC on the build computer](../VS_csharp/walkthrough--creating-a-multiple-computer-build-environment.md#InstallingMSBuildToGAC) section of this document.  
...
##  <a name="BuildingProjects"></a> Building projects  
 You can use Team Foundation Build to build [!INCLUDE[vs_dev11_long](../VS_csharp/includes/vs_dev11_long_md.md)] projects and solutions, or you can build them on the command line. When you use Team Foundation Build to build projects, it invokes the MSBuild executable that corresponds to the system architecture.  On the command line, you can use either 32-bit MSBuild or 64-bit MSBuild, and you can choose the architecture of MSBuild by setting the PATH environment variable or by directly invoking the architecture-specific MSBuild executable.  
 ...
 **msbuild** *solution.sln*  
 ...
 For more information about how to use MSBuild on the command line, see [MSBuild Command Line Reference](../VS_csharp/msbuild-command-line-reference.md).  
  
> [!NOTE]
>  To build [!INCLUDE[vs_dev11_long](../VS_csharp/includes/vs_dev11_long_md.md)] projects, you must use the "v110" Platform Toolset. If you don't want to edit the [!INCLUDE[vs_dev11_long](../VS_csharp/includes/vs_dev11_long_md.md)] project files, you can set the Platform Toolset by using this command-line argument:  
>   
...
## See Also  
 [Preparing a Test Machine to Run a Debug Executable](../VS_csharp/preparing-a-test-machine-to-run-a-debug-executable.md)   
