...
1.  Arrange your windows so that Spy++, the [Windows View](../VS_csharp/windows-view.md) window, and the target window are visible.  
  
2.  From the **Search** menu, choose **Find Window**.  
  
     The [Window Search Dialog Box](../VS_csharp/window-search-dialog-box.md) opens.  
...
5.  Click **OK**.  
     ...
     If a matching window is found, it is highlighted in the [Windows View](../VS_csharp/windows-view.md) window.