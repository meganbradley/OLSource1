...
'type' : invalid operand for __uuidof  
 ...
 The [__uuidof](../VS_csharp/__uuidof-operator.md) operator takes a user-defined type with a GUID attached or an object of such a user-defined type.  Possible causes:  
