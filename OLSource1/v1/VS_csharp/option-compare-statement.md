...
## Remarks  
 ...
 In Microsoft Windows, sort order is determined by the code page. For more information, see [Code Pages](../VS_csharp/code-pages.md).  
...
## When an Option Compare Statement Is Not Present  
 If the source code does not contain an `Option Compare` statement, the **Option Compare** setting on the [Compile Page, Project Designer (Visual Basic)](../VS_csharp/compile-page--project-designer--visual-basic-.md) is used. If you use the command-line compiler, the setting specified by the [/optioncompare](../VS_csharp/-optioncompare.md) compiler option is used.  
...
-   Include the [/optioncompare](../VS_csharp/-optioncompare.md) compiler option in the **vbc** command.  
...
## Example  
 ...
 [!code[VbVbalrStatements#45](../VS_csharp/codesnippet/VisualBasic/option-compare-statement_1.vb)]  
...
## Example  
 ...
 [!code[VbVbalrStatements#46](../VS_csharp/codesnippet/VisualBasic/option-compare-statement_2.vb)]  
...
## See Also  
 ...
 [Like Operator (Visual Basic)](../VS_csharp/like-operator--visual-basic-.md)   
 [String Functions (Visual Basic)](../VS_csharp/string-functions--visual-basic-.md)   
 [Option Explicit Statement (Visual Basic)](../VS_csharp/option-explicit-statement--visual-basic-.md)   
