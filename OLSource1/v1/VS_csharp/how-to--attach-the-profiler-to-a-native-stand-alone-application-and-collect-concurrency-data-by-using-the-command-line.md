...
This topic describes how to use [!INCLUDE[vsprvs](../VS_csharp/includes/vsprvs_md.md)] Profiling Tools command-line tools to attach the profiler to a running native (C/C++) stand-alone application and collect thread contention data.  
...
1.  At a command prompt, type the following command:  
     ...
     [VSPerfCmd](../VS_csharp/vsperfcmd.md) **/start:concurrency**  
...
2.  Attach the profiler to the target application by typing the following command:  
     ...
     **VSPerfCmd**  [/attach](../VS_csharp/attach.md) **:**{`PID`&#124;`ProcName`}  
