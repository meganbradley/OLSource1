...
This topic describes how to use [!INCLUDE[vsPreShort](../VS_csharp/includes/vspreshort_md.md)] Profiling Tools command-line tools to instrument a [!INCLUDE[dnprdnshort](../VS_csharp/includes/dnprdnshort_md.md)] service and collect detailed timing data.  
...
4.  Initialize the [!INCLUDE[dnprdnshort](../VS_csharp/includes/dnprdnshort_md.md)] profiling environment variables. Type:  
...
## Ending the Profiling Session  
 To end a profiling session, stop the service that is running the instrumented component, and then call the **VSPerfCmd** [/shutdown](../VS_csharp/shutdown.md) option to turn the profiler off and close the profiling data file. The **VSPerfClrEnv /globaloff** command clears the profiling environment variables.  
