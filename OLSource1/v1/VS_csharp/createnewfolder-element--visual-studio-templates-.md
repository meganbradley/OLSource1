...
## Remarks  
 ...
 The value specified in the `CreateNewFolder` element is only honored by [!INCLUDE[vsprvs](../VS_csharp/includes/vsprvs_md.md)] if the underlying project system supports it.  
