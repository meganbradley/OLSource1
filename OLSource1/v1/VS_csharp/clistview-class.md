...
---
# CListView Class
Simplifies use of the list control and of [CListCtrl](../VS_csharp/clistctrl-class.md), the class that encapsulates list-control functionality, with MFC's document-view architecture.  
...
### Example  
 [!code[NVC_MFCListView#7](../VS_csharp/codesnippet/CPP/clistview-class_1.cpp)]  
