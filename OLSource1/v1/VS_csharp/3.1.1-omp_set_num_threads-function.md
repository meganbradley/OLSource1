...
-   `omp_get_dynamic` function, see [Section 3.1.8](../VS_csharp/3.1.8-omp_get_dynamic-function.md) on page 40.  
  
-   `OMP_NUM_THREADS` environment variable, see [Section 4.2](../VS_csharp/4.2-omp_num_threads.md) on page 48, and Section 2.3 on page 8.  
  
-   `num_threads` clause, see [Section 2.3](../VS_csharp/2.3-parallel-construct.md) on page 8