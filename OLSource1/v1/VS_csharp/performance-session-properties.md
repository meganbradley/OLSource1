...
## General  
 ...
 [How to: Choose Collection Methods](../VS_csharp/how-to--choose-collection-methods.md)  
  
 [Collecting .NET Memory Allocation and Lifetime Data](../VS_csharp/collecting-.net-memory-allocation-and-lifetime-data.md)  
  
 [How to: Set Profiling Data File Options](../VS_csharp/how-to--set-performance-data-file-name-options.md)  
  
## Launch  
 These settings enable you to select from a list of binaries and specify the start order of the binaries.  
  
 For more information, see [How to: Specify the Binary to Start](../VS_csharp/how-to--specify-the-binary-to-start.md)  
...
-   Additional sample events can be specified based on available performance counters  
 ...
 For more information, see [How to: Choose Sampling Events](../VS_csharp/how-to--choose-sampling-events.md)  
...
## Tier Interactions  
 For more information, see [How to: Collect Interaction Data for Multi-Tiered Applications](../VS_csharp/collecting-tier-interaction-data.md)  
  
## Instrumentation  
 These settings enable you to collect performance data for JScript code in [!INCLUDE[vstecasp](../VS_csharp/includes/vstecasp_md.md)] Web pages and specify any **Pre-instrument** and **Post-instrument** events that you want to occur before or after the instrumentation process.  
  
 For more information, see:  
  
 [How to: Profile JavaScript (ECMA) Code in Web Pages](../VS_csharp/how-to--profile-javascript-code-in-web-pages.md)  
  
 [How to: Specify Pre- and Post-Instrument Commands](../VS_csharp/how-to--specify-pre--and-post-instrument-commands.md)  
...
## CPU Counters  
 ...
 For more information, see [How to: Collect CPU Counter Data](../VS_csharp/how-to--collect-cpu-counter-data.md)  
...
## Windows Events  
 ...
 [How to: Collect Event Trace (ETW) Data](../VS_csharp/how-to--collect-event-tracing-for-windows--etw--data.md)  
...
## Windows Counters  
 ...
 For more information, see [How to: Collect Windows Counter Data](../VS_csharp/how-to--collect-windows-counter-data.md).  
  
## Advanced  
 These settings enable you to add options to the instrumentation process by specifying one or more options of the [VSInstr](../VS_csharp/vsinstr.md) command line profiling tool. You can also specify the version of the Common Runtime to profile when the application is using more than one version.  
  
 For more information, see:  
  
 [How to: Specify the .NET Framework Runtime to Profile in Side by Side Scenarios](../VS_csharp/how-to--specify-the-.net-framework-runtime.md)  
  
 [How to: Specify Additional Instrumentation Options](../VS_csharp/how-to--specify-additional-instrumentation-options.md)  
