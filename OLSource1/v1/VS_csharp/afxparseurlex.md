...
---
# AfxParseURLEx
This global function is the extended version of [AfxParseURL](../VS_csharp/afxparseurl.md) and is used in [CInternetSession::OpenURL](../Topic/CInternetSession::OpenURL.md).  
