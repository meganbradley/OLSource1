...
### Return Value  
 A const reverse bidirectional iterator addressing the first element in a reversed [multimap](../VS_csharp/multimap-class.md) or addressing what had been the last element in the unreversed `multimap`.  
...
### Return Value  
 A const reverse bidirectional iterator that addresses the location succeeding the last element in a reversed [multimap](../VS_csharp/multimap-class.md) (the location that had preceded the first element in the unreversed `multimap`).  
...
|`Where`|The place to start searching for the correct point of insertion. (If that point immediately precedes `Where`, insertion can occur in amortized constant time instead of logarithmic time.)|  
|`ValTy`|Template parameter that specifies the argument type that the map can use to construct an element of [value_type](../VS_csharp/map-class.md#map__value_type), and perfect-forwards `Val` as an argument.|  
...
### Remarks  
 ...
 The [value_type](../VS_csharp/map-class.md#map__value_type) of a container is a typedef that belongs to the container, and for map, `multimap<K, V>::value_type` is `pair<const K, V>`. The value of an element is an ordered pair in which the first component is equal to the key value and the second component is equal to the data value of the element.  
 ...
 **key_compare** is a synonym for the template parameter `Traits`.  
 ...
 For more information on `Traits` see the [multimap Class](../VS_csharp/multimap-class.md) topic.  
 ...
 **key_type** is a synonym for the template parameter `Key`.  
 ...
 For more information on `Key`, see the Remarks section of the [multimap Class](../VS_csharp/multimap-class.md) topic.  
...
### Remarks  
 ...
 For more information on `Type` see the [multimap Class](../VS_csharp/multimap-class.md) topic.  
...
|-|-|  
|Parameter|Description|  
|`_Right`|The [multimap](../VS_csharp/multimap-class.md) being copied into the `multimap`.|  
...
### Remarks  
 `rend` is used with a reversed multimap just as [end](../VS_csharp/map-class.md#map__end) is used with a multimap.  
