...
5.  On the menu bar, choose **Debug**, **Start Debugging** (or press F5) to run the application.  
     ...
     ![ExpenseIt sample screen shot](../VS_csharp/media/gettingstartedfigure1.png "GettingStartedFigure1")  
...
3.  Build and run the application. The following illustration shows the run time appearance of the controls that are created by the XAML in this procedure.  
     ...
     ![ExpenseIt sample screen shot](../VS_csharp/media/gettingstartedfigure2.png "GettingStartedFigure2")  
...
1.  Choose the following image and save it as `watermark.png`.  
     ...
     ![Watermark image for walkthrough](../VS_csharp/media/wpf_watermark.png "WPF_watermark")  
...
6.  If you build and run the application at this point, it should look like the following illustration:  
     ...
     ![ExpenseIt sample screen shot](../VS_csharp/media/gettingstartedfigure3.png "GettingStartedFigure3")  
...
4.  Choose the **View** button.  
     ...
     ![ExpenseIt sample screen shot](../VS_csharp/media/gettingstartedfigure4.png "GettingStartedFigure4")  
...
6.  Choose a person and then choose the **View** button.  
     ...
     ![ExpenseIt sample screen shots](../VS_csharp/media/gettingstartedfigure5.png "GettingStartedFigure5")  
...
## See Also  
 [Walkthrough: Create a WPF Desktop Application connected to an Azure Mobile Services](../VS_csharp/walkthrough--create-a-wpf-desktop-application-connected-to-an-azure-mobile-service.md)   
