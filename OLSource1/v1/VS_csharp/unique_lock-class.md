...
### Remarks  
 If the stored `mutex` pointer is `null`, this method throws a [system_error](../VS_csharp/system_error-class.md) that has an error code of `operation_not_permitted`.  
...
### Remarks  
 If the stored `mutex` pointer is `null`, the method throws a [system_error](../VS_csharp/system_error-class.md) that has an error code of `operation_not_permitted`.  
...
### Parameters  
 `Rel_time`  
 A [chrono::duration](../VS_csharp/duration-class.md) object that specifies the maximum amount of time that the method attempts to obtain ownership of the `mutex`.  
...
### Remarks  
 If the calling thread doesn't own the associated `mutex`, this method throws a [system_error](../VS_csharp/system_error-class.md) that has an error code of `operation_not_permitted`.  
