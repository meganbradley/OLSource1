 ...
 *section-name*  
 ...
 For a list of names you should not use when creating a section, see [/SECTION](../VS_csharp/-section--specify-section-attributes-.md).  
  
 *func-name*  
 Specifies a function to be called in place of `atexit` when the program exits. This helper function also calls [atexit](../VS_csharp/atexit.md) with a pointer to the destructor for the global object. If you specify a function identifier in the pragma of the form,  
