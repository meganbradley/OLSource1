...
These symbols are defined in the ATL header files, but they support standard Windows application functions and actions. These symbols are mainly used with dialog boxes. When you are working with dialogs and controls in the [Dialog editor](../VS_csharp/dialog-editor.md), these symbols will appear in the Properties window associated with common controls. For instance, if your dialog box has a Cancel button, that command will be associated with the symbol IDCANCEL in the [Properties Window](../VS_csharp/properties-window.md).  
