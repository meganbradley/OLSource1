...
## Remarks  
 If you specify an accessor that is not an autoaccessor in [BEGIN_ACCESSOR](../VS_csharp/begin_accessor.md), use this method to explicitly get the data by passing the accessor number.  
