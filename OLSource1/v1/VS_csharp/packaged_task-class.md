...
|Name|Description|  
|----------|-----------------|  
|[packaged_task::get_future Method](#packaged_task__get_future_method)|Returns a [future](../VS_csharp/future-class.md) object that has the same associated asynchronous state.|  
...
### Remarks  
 If the `packaged_task` object does not have an associated asynchronous state, this method throws a [future_error](../VS_csharp/future_error-class.md) that has an error code of `no_state`.  
...
### Remarks  
 If the `packaged_task` object doesn't have an associated asynchronous state, this method throws a [future_error](../VS_csharp/future_error-class.md) that has an error code of `no_state`.  
...
### Parameters  
 ...
 `alloc`  
 A memory allocator. For more information, see [<allocators\>](../VS_csharp/-allocators-.md).  
