...
The type of optional values. When used from other .NET Framework languages the empty option is the `null` value. This type is a type abbreviation for [Option](../VS_csharp/core.option--t--union--fsharp-.md).  
...
## See Also  
 ...
 [Option](../VS_csharp/core.option--t--union--fsharp-.md)