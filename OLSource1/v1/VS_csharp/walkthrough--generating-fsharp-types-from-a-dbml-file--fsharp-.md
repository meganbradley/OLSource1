...
##  <a name="BKMK_CreateADBMLFile"></a> Creating a .dbml file  
 If you do not have a database to test on, create one by following the instructions at the bottom of [How To: Access a SQL Database by Using Type Providers (F#)](../VS_csharp/walkthrough--accessing-a-sql-database-by-using-type-providers--fsharp-.md). If you follow these instructions, you will create a database called MyDatabase that contains a few simple tables and stored procedures on your SQL Server.  
...
## Next Steps  
 You can proceed to use other query expressions, or get a database connection from the data context and perform normal ADO.NET data operations. For additional steps, see the sections after "Query the Data" in [How To: Access a SQL Database by Using Type Providers (F#)](../VS_csharp/walkthrough--accessing-a-sql-database-by-using-type-providers--fsharp-.md).  
  
## See Also  
 [DbmlFile Type Provider (F#)](../VS_csharp/dbmlfile-type-provider--fsharp-.md)   
 [Type Providers](../VS_csharp/type-providers.md)   
 [How To: Access a SQL Database by Using Type Providers (F#)](../VS_csharp/walkthrough--accessing-a-sql-database-by-using-type-providers--fsharp-.md)   
