...
Converts a time value to a structure. More secure versions of these functions are available; see [_gmtime32_s, _gmtime64_s](../VS_csharp/gmtime_s--_gmtime32_s--_gmtime64_s.md).  
...
## Return Value  
 A pointer to a structure of type [tm](../VS_csharp/standard-types.md). The fields of the returned structure hold the evaluated value of the `timer` argument in UTC rather than in local time. Each of the structure fields is of type `int`, as follows:  
