...
## Remarks  
 ...
 For more information on the `DECLARE_DYNCREATE` macro, see [CObject Class Topics](../VS_csharp/using-cobject.md).  
  
> [!NOTE]
>  The `DECLARE_DYNCREATE` macro includes all the functionality of `DECLARE_DYNAMIC`.  
  
## Example  
 See the example for [IMPLEMENT_DYNCREATE](../VS_csharp/implement_dyncreate.md).  
