...
|Name|Description|  
|----------|-----------------|  
|[Win32ThreadTraits::CreateThread](../VS_csharp/win32threadtraits--createthread.md)|(Static) Call this function to create a thread that should not use CRT functions.|  
...
-   [CThreadPool](../VS_csharp/cthreadpool-class.md)  
  
-   [CWorkerThread](../VS_csharp/cworkerthread-class.md)  
  
 If the thread will be using CRT functions, use [CRTThreadTraits](../VS_csharp/crtthreadtraits-class.md) instead.  
