...
## Core Editors and Document Data Objects  
 ...
 For more information, see [Determining Which Editor Opens a File in a Project](../VS_csharp/determining-which-editor-opens-a-file-in-a-project.md).  
...
## See Also  
 ...
 [Providing a Language Service Context by Using the Legacy API](../VS_csharp/providing-a-language-service-context-by-using-the-legacy-api.md)   
 [IntelliSense Hosting](../VS_csharp/intellisense-hosting.md)   
 [Contained Languages](../VS_csharp/contained-languages.md)   
