...
1.  Create a new C# Windows Universal app project named **CpuUseDemo** using the **BlankApp** template.  
     ...
     ![Create the CpuUseDemoProject](../VS_csharp/media/cpu_use_newproject.png "CPU_USE_NewProject")  
...
##  <a name="BKMK_Collect_CPU_usage_data"></a> Collect CPU usage data  
 ![Run a release build of the app in the simulator](../VS_csharp/media/cpu_use_wt_setsimulatorandretail.png "CPU_USE_WT_SetSimulatorAndRetail")  
...
3.  In the Performance and Diagnostic hub, choose **CPU Usage** and then choose **Start**.  
     ...
     ![Start the CpuUsage diagnostic session](../VS_csharp/media/cpu_use_wt_perfdiaghub.png "CPU_USE_WT_PerfDiagHub")  
...
5.  After the second output line appears, choose **Stop Collection** in the Performance and Diagnostic hub.  
 ...
 ![Stop CpuUsage data collection](../VS_csharp/media/cpu_use_wt_stopcollection.png "CPU_USE_WT_StopCollection")  
  
 The CPU Usage tool analyzes the data and displays the report.  
  
 ![CpuUsage report](../VS_csharp/media/cpu_use_wt_report.png "CPU_USE_WT_Report")  
...
###  <a name="BKMK_CPU_utilization_timeline_graph"></a> CPU utilization timeline graph  
 ![CpuUtilization &#40;%&#41; timeline graph](../VS_csharp/media/cpu_use_wt_timelinegraph.png "CPU_USE_WT_TimelineGraph")  
...
####  <a name="BKMK_Select_timeline_segments_to_view_details"></a> Select timeline segments to view details  
 ...
 ![GetMaxNumberButton&#95;Click selected](../VS_csharp/media/cpu_use_wt_getmaxnumberreport.png "CPU_USE_WT_GetMaxNumberReport")  
 ...
 ![GetMaxNumberAsyncButton&#95;Click report selection](../VS_csharp/media/cpu_use_wt_getmaxnumberasync_selected.png "CPU_USE_WT_GetMaxNumberAsync_Selected")  
...
####  <a name="BKMK_Call_tree_structure"></a> Call tree structure  
 ![GetMaxNumberButton&#95;Click call tree](../VS_csharp/media/cpu_use_wt_getmaxnumbercalltree_annotated.png "CPU_USE_WT_GetMaxNumberCallTree_annotated")  
  
|||  
|-|-|  
|![Step 1](../VS_csharp/media/procguid_1.png "ProcGuid_1")|The top-level node in CPU Usage call trees is a pseudo-node|  
|![Step 2](../VS_csharp/media/procguid_2.png "ProcGuid_2")|In most apps, when the **Show External Code** option is disabled, the second-level node is an **[External Code]** node that contains the system and framework code that starts and stops the app, draws the UI, controls thread scheduling, and provides other low-level services to the app.|  
|![Step 3](../VS_csharp/media/procguid_3.png "ProcGuid_3")|The children of the second-level node are the user-code methods and asynchronous routines that are called or created by the second-level system and framework code.|  
|![Step 4](../VS_csharp/media/procguid_4.png "ProcGuid_4")|Child nodes of a method contain data only for the calls of the parent method. When **Show External Code** is disabled, app methods can also contain an **[External Code]** node.|  
...
####  <a name="BKMK_External_Code"></a> External Code  
 ...
 ![Choose Filter View, then Show External Code](../VS_csharp/media/cpu_use_wt_filterview.png "CPU_USE_WT_FilterView")  
 ...
 ![Nested external code in the call tree](../VS_csharp/media/cpu_use_wt_showexternalcodetoowide.png "CPU_USE_WT_ShowExternalCodeTooWide")  
 ...
 ![Search for nested external code](../VS_csharp/media/cpu_use_wt_showexternalcodetoowide_found.png "CPU_USE_WT_ShowExternalCodeTooWide_Found")  
  
###  <a name="BKMK_Call_tree_data_columns"></a> Call tree data columns  
  
|||  
|-|-|  
|**Total CPU (%)**|![Total % data equation](../VS_csharp/media/cpu_use_wt_totalpercentequation.png "CPU_USE_WT_TotalPercentEquation")<br /><br /> The percentage of the app's CPU activity in the selected time range that was used by calls to the function and the functions called by the function. Note that this is different from the **CPU Utilization** timeline graph, which compares the total activity of the app in a time range to the total available CPU capacity.|  
|**Self CPU (%)**|![Self % equation](../VS_csharp/media/cpu_use_wt_selflpercentequation.png "CPU_USE_WT_SelflPercentEquation")<br /><br /> The percentage of the app's CPU activity in the selected time range that was used by the calls to the function, excluding the activity of functions called by the function.|  
...
###  <a name="BKMK_Asynchronous_functions_in_the_CPU_Usage_call_tree"></a> Asynchronous functions in the CPU Usage call tree  
 ...
 ![Expanded GetMaxNumberAsyncButton&#95;Click call tree](../VS_csharp/media/cpu_use_wt_getmaxnumberasync_expandedcalltree.png "CPU_USE_WT_GetMaxNumberAsync_ExpandedCallTree")  
