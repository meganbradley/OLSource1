...
This topic describes the debugger windows and dialog boxes. It only discusses the user interface pieces that have XSLT-specific debugging behavior.  
 ...
 For more information, see the [Debugging User Interface Reference](../VS_csharp/debugging-user-interface-reference.md).  
...
|`self::node()`|The value of the context node.|  
 ...
 For more information, see [How to: Use the Locals Window](../Topic/How%20to:%20Change%20the%20Debugger%20Context.md).  
...
-   User-defined functions are not allowed.  
 ...
 For more information, see [How to: Evaluate an XPath Expression](../VS_csharp/how-to--evaluate-an-xpath-expression.md).  
...
## Disassembly Window  
 ...
 For more information, [How to: Use the Disassembly Window](../VS_csharp/how-to--use-the-disassembly-window.md).  
  
## See Also  
 [Debugging XSLT](../VS_csharp/debugging-xslt.md)   
 [Debugger Roadmap](../VS_csharp/debugger-basics.md)   
 [Variable Windows and the QuickWatch Dialog Box](../Topic/Variable%20Windows.md)