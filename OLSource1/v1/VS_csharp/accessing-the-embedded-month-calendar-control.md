...
>  The embedded month calendar control is used only when the date and time picker control does not have the **DTS_UPDOWN** style set.  
 ...
 [!code[NVC_MFCControlLadenDialog#5](../VS_csharp/codesnippet/CPP/accessing-the-embedded-month-calendar-control_1.cpp)]  
 ...
 [!code[NVC_MFCControlLadenDialog#6](../VS_csharp/codesnippet/CPP/accessing-the-embedded-month-calendar-control_2.cpp)]  
