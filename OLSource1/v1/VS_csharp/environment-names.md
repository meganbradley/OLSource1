...
---
# Environment Names
**ANSI 4.10.4.4** The set of environment names and the method for altering the environment list used by the [getenv](../VS_csharp/getenv--_wgetenv.md) function  
  
 The set of environment names is unlimited.  
  
 To change environment variables from within a C program, call the [_putenv](../VS_csharp/_putenv--_wputenv.md) function. To change environment variables from the command line in Windows, use the SET command (for example, SET LIB = D:\ LIBS).  
...
## See Also  
 ...
 [_putenv](../VS_csharp/_putenv--_wputenv.md)   
 [getenv](../VS_csharp/getenv--_wgetenv.md)