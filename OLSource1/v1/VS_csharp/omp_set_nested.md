...
## Remarks  
 OMP nested parallelism can be turned on with `omp_set_nested`, or by setting the [OMP_NESTED](../VS_csharp/omp_nested.md) environment variable.  
 ...
 Use [omp_get_nested](../VS_csharp/omp_get_nested.md) to display the current setting of `omp_set_nested`.  
  
 For more information, see [3.1.9 omp_set_nested Function](../VS_csharp/3.1.9-omp_set_nested-function.md).  
