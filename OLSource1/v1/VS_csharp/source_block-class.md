...
|[source_block::unlink_targets Method](#source_block__unlink_targets_method)|Unlinks all target blocks from this                                         `source_block` object. (Overrides                                         [ISource::unlink_targets](../VS_csharp/isource-class.md#isource__unlink_targets_method).)|  
...
### Remarks  
 The method throws an                         [invalid_argument](../VS_csharp/invalid_argument-class.md) exception if the parameter                         `_PTarget` is                         `NULL`.  
...
### Remarks  
 ...
 The method throws a                         [bad_target](../VS_csharp/bad_target-class.md) exception if the parameter                         `_PTarget` does not represent the target that called                         `reserve`.  
