...
Write formatted output using a pointer to a list of arguments. These are versions of [vsprintf, _vsprintf_l, vswprintf, _vswprintf_l](../VS_csharp/vsprintf--_vsprintf_l--vswprintf--_vswprintf_l--__vswprintf_l.md) with security enhancements as described in [Security Enhancements in the CRT](../VS_csharp/security-features-in-the-crt.md).  
...
## Remarks  
 ...
 These functions differ from the non-secure versions only in that the secure versions support positional parameters. For more information, see [printf Positional Parameters](../VS_csharp/printf_p-positional-parameters.md).  
