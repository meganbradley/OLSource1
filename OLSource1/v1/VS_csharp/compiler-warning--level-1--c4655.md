 ...
 ***symbol* ' : variable type is new since the last build, or is defined differently elsewhere**  
 ...
 This warning is followed by a [Fatal Error C1092](../VS_csharp/fatal-error-c1092.md). For further information, see the [Supported Code Changes](../VS_csharp/supported-code-changes--c---.md).  
