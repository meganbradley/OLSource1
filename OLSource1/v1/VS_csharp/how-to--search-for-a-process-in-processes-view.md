...
1.  Arrange your windows so that Spy++ and an active [Processes View](../VS_csharp/processes-view.md) window are visible.  
  
2.  From the **Search** menu, choose **Find Process**  
  
     The [Process Search Dialog Box](../VS_csharp/process-search-dialog-box.md) opens.  
