...
## Remarks  
 ...
 For more information on `CFont`, see [Graphic Objects](../VS_csharp/graphic-objects.md).  
...
### Example  
 [!code[NVC_MFCDocView#70](../VS_csharp/codesnippet/CPP/cfont-class_1.cpp)]  
...
### Parameters  
 ...
 `nWeight`  
 Specifies the font weight (in inked pixels per 1000). See the `lfWeight` member in the `LOGFONT` structure in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)] for more information. The described values are approximate; the actual appearance depends on the typeface. Some fonts have only `FW_NORMAL`, `FW_REGULAR`, and `FW_BOLD` weights. If `FW_DONTCARE` is specified, a default weight is used.  
 ...
 `nCharSet`  
 Specifies the font's character setSee the `lfCharSet` member in the `LOGFONT` structure in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)] for a list of values.  
 ...
 `nOutPrecision`  
 Specifies the desired output precision. The output precision defines how closely the output must match the requested font's height, width, character orientation, escapement, and pitch. See the `lfOutPrecision` member in the `LOGFONT` structure in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)] for a list of values and more information.  
  
 `nClipPrecision`  
 Specifies the desired clipping precision. The clipping precision defines how to clip characters that are partially outside the clipping region. See the `lfClipPrecision` member in the `LOGFONT` structure in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)] for a list of values.  
 ...
 `nQuality`  
 Specifies the font's output quality, which defines how carefully the GDI must attempt to match the logical-font attributes to those of an actual physical font. See the `lfQuality` member in the `LOGFONT` structure in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)] for a list of values.  
  
 `nPitchAndFamily`  
 Specifies the pitch and family of the font. See the `lfPitchAndFamily` member in the `LOGFONT` structure in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)] for a list of values and more information.  
...
### Example  
 [!code[NVC_MFCDocView#71](../VS_csharp/codesnippet/CPP/cfont-class_2.cpp)]  
...
### Remarks  
 ...
 This font has the characteristics specified in the                         [LOGFONT](http://msdn.microsoft.com/library/windows/desktop/dd145037) structure. When the font is selected by using the [CDC::SelectObject](../VS_csharp/cdc-class.md#cdc__selectobject) member function, the GDI font mapper attempts to match the logical font with an existing physical font. If the font mapper fails to find an exact match for the logical font, it provides an alternative font whose characteristics match as many of the requested characteristics as possible.  
...
### Example  
 [!code[NVC_MFCDocView#72](../VS_csharp/codesnippet/CPP/cfont-class_3.cpp)]  
...
### Parameters  
 ...
 `pDC`  
 Pointer to the [CDC](../VS_csharp/cdc-class.md) object to be used to convert the height in `nPointSize` to logical units. If **NULL**, a screen device context is used for the conversion.  
...
### Example  
 [!code[NVC_MFCDocView#73](../VS_csharp/codesnippet/CPP/cfont-class_4.cpp)]  
...
### Parameters  
 ...
 `pDC`  
 Pointer to the [CDC](../VS_csharp/cdc-class.md) object to be used to convert the height in **lfHeight** to logical units. If **NULL**, a screen device context is used for the conversion.  
...
### Example  
 [!code[NVC_MFCDocView#74](../VS_csharp/codesnippet/CPP/cfont-class_5.cpp)]  
...
### Example  
 [!code[NVC_MFCDocView#75](../VS_csharp/codesnippet/CPP/cfont-class_6.cpp)]  
...
### Example  
 [!code[NVC_MFCDocView#76](../VS_csharp/codesnippet/CPP/cfont-class_7.cpp)]  
...
### Remarks  
 ...
 For more information about using graphic objects, see                         [Graphic Objects](http://msdn.microsoft.com/library/windows/desktop/dd144962) in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
  
### Example  
 [!code[NVC_MFCDocView#77](../VS_csharp/codesnippet/CPP/cfont-class_8.cpp)]  
