...
---
# do Bindings (F#)
A `do` binding is used to execute code without defining a function or value. Also, do bindings can be used in classes, see [do Bindings in Classes (F#)](../VS_csharp/do-bindings-in-classes--fsharp-.md).  
...
## Remarks  
 ...
 [!code[FsLangRef1#201](../VS_csharp/codesnippet/FSharp/do-bindings--fsharp-_1.fs)]  
