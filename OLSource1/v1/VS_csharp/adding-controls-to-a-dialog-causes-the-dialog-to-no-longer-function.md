...
2.  In [Resource View](../VS_csharp/resource-view-window.md), double click on the .rc file.  
...
## The fix for RichEdit controls  
 You must call **LoadLibrary** for rich edit controls. For more information, see [Using the RichEdit 1.0 Control with MFC](../VS_csharp/using-the-richedit-1.0-control-with-mfc.md), [About Rich Edit Controls](http://msdn.microsoft.com/library/windows/desktop/bb787873) in the [!INCLUDE[winsdkshort](../VS_csharp/includes/winsdkshort_md.md)], and [Overview of the Rich Edit Control](../VS_csharp/overview-of-the-rich-edit-control.md).  
