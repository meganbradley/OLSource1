...
## Return Value  
 ...
 Use `GetParam` to retrieve nonstring parameter data from the buffer. Use [GetParamString](../VS_csharp/cdynamicparameteraccessor--getparamstring.md) to retrieve string parameter data from the buffer.  
