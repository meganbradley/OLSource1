...
You can specify which DLLs to delay load with the [/delayload](../VS_csharp/-delayload--delay-load-import-.md):`dllname` linker option. If you do not plan to use your own version of a helper function, you must also link your program with delayimp.lib (for desktop applications) or dloadhelper.lib (for store apps).  
