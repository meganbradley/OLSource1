...
-   To describe a business process or a flow of work between users and your system. For more information, see [Modeling User Requirements](../VS_csharp/model-user-requirements.md).  
  
-   To describe the steps performed in a use case. For more information, see [Use Case Diagrams: Guidelines](../VS_csharp/uml-use-case-diagrams--guidelines.md).  
  
-   To describe a method, function or operation in software. For more information, see [Modeling the Architecture of a Software System](../VS_csharp/model-your-app-s-architecture.md).  
 ...
 For reference information about the elements on activity diagrams, see [UML Activity Diagrams: Introduction](../VS_csharp/uml-activity-diagrams--reference.md).  
...
##  <a name="SimpleControlFlow"></a> Describing Control Flow  
 ...
 ![A simple activity diagram](../VS_csharp/media/uml_actguidectrl.png "UML_ActGuideCtrl")  
...
-   Use an **Output Pin** and an **Input Pin**. This method lets you separately describe the outputs from one action and the inputs to another. Pins are like parameters in a program. Pins represent ports where objects can enter and leave an action.  
    ...
    > [!NOTE]
    >  For an overview of the elements used in this section, see the Data Flows section of the topic see [Overview of Activity Diagrams](../VS_csharp/uml-activity-diagrams--reference.md).  
...
### Describing Data Flow with Object Nodes  
 ...
 ![Object nodes can show data passed between actions](../VS_csharp/media/uml_actguidedata.png "UML_ActGuideData")  
 ...
 You can set the **Type** of the object node in the Properties window. The type can be a primitive type such as Integer, or a class, interface, or enumeration that you have defined in a class diagram. For example, you could create a class Shipment Address, with attributes of Street Address, City, and so on, together with an association to another class that is named Customer. For more information, see [UML Class Diagrams](../VS_csharp/uml-class-diagrams--guidelines.md).  
...
#### Buffering data in object nodes  
 ...
 ![Buffering data in object nodes](../VS_csharp/media/uml_actguidebuffer.png "UML_ActGuideBuffer")  
...
### Describing Data Flow with Input and Output Pins  
 ...
 ![Input and output pins are action parameters](../VS_csharp/media/uml_actguidepins.png "UML_ActGuidePins")  
...
###  <a name="Subactivities"></a> Describing Sub-activities with Call Behavior Actions  
 ...
 ![A separate activity diagram shows detailed actions](../VS_csharp/media/uml_actguidedetail.png "UML_ActGuideDetail")  
...
-   In the sub-activity diagram, draw connectors that show the flow of objects into or out of each activity parameter node.  
 ...
 ![Pins on Call Behavior map to activity parameters](../VS_csharp/media/uml_actguidesub.png "UML_ActGuideSub")  
...
##  <a name="Concurrent"></a> Concurrent Flows  
 ...
 ![The fork and join nodes show concurrent flows](../VS_csharp/media/uml_actguideconcurrent.png "UML_ActGuideConcurrent")  
...
### Describing Multiple Data Flows  
 ...
 ![Parallel object flows](../VS_csharp/media/uml_actguidemulti.png "UML_ActGuideMulti")  
...
### Streams  
 ...
 ![A data flow](../VS_csharp/media/uml_actguidestream.png "UML_ActGuideStream")  
...
-   A selection describes how only some of the objects entering a flow are transmitted to the receiving action.  
 ...
 ![Object transformation defined in another diagram](../VS_csharp/media/uml_actguidetransform.png "UML_ActGuideTransform")  
...
## See Also  
 ...
 [Sequence Diagrams: Overview](../VS_csharp/uml-sequence-diagrams--reference.md)   
 ...
 [Activity Diagrams: Overview](../VS_csharp/uml-component-diagrams--reference.md)   
