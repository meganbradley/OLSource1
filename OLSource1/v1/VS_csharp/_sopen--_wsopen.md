...
---
# _sopen, _wsopen
Opens a file for sharing. More-secure versions of these functions are available—see [_sopen_s, _wsopen_s](../VS_csharp/_sopen_s--_wsopen_s.md).  
...
>  The `_O_TRUNC` flag destroys the contents of the specified file.  
 ...
 `_sopen` applies the current file-permission mask to `pmode` before the permissions are set. (See [_umask](../VS_csharp/_umask.md).)  
