...
### Parameters  
 ...
 `_Fmt`  
 The format of the output. See [strftime, wcsftime, _strftime_l, _wcsftime_l](../VS_csharp/strftime--wcsftime--_strftime_l--_wcsftime_l.md) for valid values.  
  
 `_Mod`  
 A modifier for the format. See [strftime, wcsftime, _strftime_l, _wcsftime_l](../VS_csharp/strftime--wcsftime--_strftime_l--_wcsftime_l.md) for valid values.  
...
### Parameters  
 ...
 `_First`  
 The beginning of the formatting string for the output. See [strftime, wcsftime, _strftime_l, _wcsftime_l](../VS_csharp/strftime--wcsftime--_strftime_l--_wcsftime_l.md) for valid values.  
  
 `_Last`  
 The end of the formatting string for the output. See [strftime, wcsftime, _strftime_l, _wcsftime_l](../VS_csharp/strftime--wcsftime--_strftime_l--_wcsftime_l.md) for valid values.  
