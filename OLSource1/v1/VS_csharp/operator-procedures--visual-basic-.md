...
An operator procedure is a series of [!INCLUDE[vbprvb](../VS_csharp/includes/vbprvb_md.md)] statements that define the behavior of a standard operator (such as `*`, `<>`, or `And`) on a class or structure you have defined. This is also called *operator overloading*.  
...
## When to Define Operator Procedures  
 ...
 [!INCLUDE[vbprvb](../VS_csharp/includes/vbprvb_md.md)] defines operators only on its fundamental data types. You can define the behavior of an operator when one or both of the operands are of the type of your class or structure.  
  
 For more information, see [Operator Statement](../VS_csharp/operator-statement.md).  
...
## Declaration Syntax  
 ...
 You use the `Widening` or `Narrowing` keyword only on a type conversion operator. The operator symbol is always [CType Function](../VS_csharp/ctype-function--visual-basic-.md) for a type conversion operator.  
 ...
 You declare each operand the same way you declare parameters for [Sub Procedures](../VS_csharp/sub-procedures--visual-basic-.md).  
...
### Data Type  
 ...
 For more details, see [Operator Statement](../VS_csharp/operator-statement.md).  
...
### Illustration of Declaration and Call  
 ...
 [!code[VbVbcnProcedures#23](../VS_csharp/codesnippet/VisualBasic/operator-procedures--visual-basic-_1.vb)]  
  
 The following example shows a typical call to the `+` operator defined on `veryLong`.  
  
 [!code[VbVbcnProcedures#24](../VS_csharp/codesnippet/VisualBasic/operator-procedures--visual-basic-_2.vb)]  
...
## See Also  
 ...
 [How to: Consume a Class that Defines Operators](../VS_csharp/how-to--use-a-class-that-defines-operators--visual-basic-.md)