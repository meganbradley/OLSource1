...
## Remarks  
 The tabledef is an object of class [CDaoTableDef](../VS_csharp/cdaotabledef-class.md). The references to Primary, Secondary, and All above indicate how the information is returned by the [GetTableDefInfo](../Topic/CDaoDatabase::GetTableDefInfo.md) member function in class `CDaoDatabase`.  
...
## See Also  
 ...
 [CDaoTableDef Class](../VS_csharp/cdaotabledef-class.md)   
