...
---
# shared_future Class
Describes an *asynchronous return object*. In contrast with a [future](../VS_csharp/future-class.md) object, an *asynchronous provider* can be associated with any number of `shared_future` objects.  
...
### Parameters  
 `Right`  
 A [future](../VS_csharp/future-class.md) or `shared_future` object.  
...
### Parameters  
 `Rel_time`  
 A [chrono::duration](../VS_csharp/duration-class.md) object that specifies a maximum time interval that the thread blocks.  
  
### Return Value  
 A [future_status](../VS_csharp/-future--enums.md#future_status_enumeration) that indicates the reason for returning.  
...
### Parameters  
 `Abs_time`  
 A [chrono::time_point](../VS_csharp/time_point-class.md) object that specifies a time after which the thread can unblock.  
