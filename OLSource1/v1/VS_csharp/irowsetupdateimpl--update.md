...
## Remarks  
 Changes are transmitted by calling [IRowsetChangeImpl::FlushData](../VS_csharp/irowsetchangeimpl--flushdata.md). The consumer must call [CRowset::Update](../VS_csharp/crowset--update.md) for the changes to take effect. Set *prgRowstatus* to an appropriate value as described in [Row States](https://msdn.microsoft.com/en-us/library/ms722752.aspx) in the *OLE DB Programmer's Reference*.  
