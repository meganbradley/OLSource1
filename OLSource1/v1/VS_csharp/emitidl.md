...
-   If **restricted**, allows IDL attributes to be in the file without a [module](../VS_csharp/module--c---.md) attribute. The compiler will not generate an .idl file.  
...
-   If `boolean` is **false**, docobj.idl will not be imported into the generated .idl file. You will need to explicitly import .idl files with [import](../VS_csharp/import.md).  
