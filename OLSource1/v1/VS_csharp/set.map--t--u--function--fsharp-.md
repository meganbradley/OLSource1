...
## Remarks  
 This function is named [Map](../VS_csharp/collections.map--key--value--class--fsharp-.md) in compiled assemblies. If you are accessing the function from a language other than F#, or through reflection, use this name.  
