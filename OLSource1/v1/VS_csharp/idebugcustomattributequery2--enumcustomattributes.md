...
#### Parameters  
 `ppEnum`  
 [out] Returns an [IEnumDebugCustomAttributes](../VS_csharp/ienumdebugcustomattributes.md) object representing the list of custom attributes; otherwise, returns a null value if there are no custom attributes.  
