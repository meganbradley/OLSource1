...
## Remarks  
 ...
 When used in a project that does not also use ATL, specifying the `uuid` attribute is the same as specifying the [uuid](../VS_csharp/uuid--c---.md) __declspec modifier. To retrieve the `uuid` of a class, you can use [__uuidof](../VS_csharp/__uuidof-operator.md)  
  
## Example  
 See the [bindable](../VS_csharp/bindable.md) example for a sample use of `uuid`.  
