...
### Remarks  
 The type is a synonym for template class [basic_ios](../VS_csharp/basic_ios-class.md), specialized for elements of type `char` with default character traits.  
...
### Remarks  
 The type is a synonym for [fpos](../VS_csharp/fpos-class.md)< `mbstate_t`>.  
...
### Remarks  
 The type is a synonym for template class [basic_ios](../VS_csharp/basic_ios-class.md), specialized for elements of type `wchar_t` with default character traits.  
