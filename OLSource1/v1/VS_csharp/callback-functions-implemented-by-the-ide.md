...
## In This Section  
 ...
 [POPLISTFUNC](../VS_csharp/poplistfunc.md)  
 Describes the callback function that is used by [SccPopulateList Function](../VS_csharp/sccpopulatelist-function.md) when the IDE does not have complete access to information that is available only to the source control plug-in, such as a complete list of files under version control.  
  
 [QUERYCHANGESFUNC](../VS_csharp/querychangesfunc.md)  
 Describes the callback function that is used by the [SccQueryChanges Function](../VS_csharp/sccquerychanges-function.md) operation.  
  
 [POPDIRLISTFUNC](../VS_csharp/popdirlistfunc.md)  
 Describes the callback function that is used by the [SccPopulateDirList Function](../VS_csharp/sccpopulatedirlist-function.md) operation.  
  
 [OPTNAMECHANGEPFN](../VS_csharp/optnamechangepfn.md)  
 Describes the callback function set by a call to the [SccSetOption Function](../VS_csharp/sccsetoption-function.md) that enables the source control plug-in to communicate name changes back to the IDE.  
...
## Related Sections  
 ...
 [SccPopulateDirList Function](../VS_csharp/sccpopulatedirlist-function.md)  
 ...
 [SccQueryChanges Function](../VS_csharp/sccquerychanges-function.md)  
 ...
 [SccSetOption Function](../VS_csharp/sccsetoption-function.md)  
