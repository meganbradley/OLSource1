...
## Remarks  
 ...
 This function validates its parameters. If `fd` is a bad file descriptor, the invalid parameter handler is invoked, as described in [Parameter Validation](../VS_csharp/parameter-validation.md). If execution is allowed to continue, the functions returns -1 and `errno` is set to `EBADF`.  
...
## Example  
 See the example for [_open](../VS_csharp/_open--_wopen.md).  
...
## See Also  
 ...
 [_unlink, _wunlink](../VS_csharp/_unlink--_wunlink.md)