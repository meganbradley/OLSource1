...
-   [The method under test](../VS_csharp/how-to--create-a-data-driven-unit-test.md#BKMK_The_method_under_test)  
  
-   [Creating a data source](../VS_csharp/how-to--create-a-data-driven-unit-test.md#BKMK_Creating_a_data_source)  
  
-   [Adding a TestContext to the test class](../VS_csharp/how-to--create-a-data-driven-unit-test.md#BKMK_Adding_a_TestContext_to_the_test_class)  
  
-   [Writing the test method](../VS_csharp/how-to--create-a-data-driven-unit-test.md#BKMK_Writing_the_test_method)  
  
    -   [Specifying the DataSourceAttribute](../VS_csharp/how-to--create-a-data-driven-unit-test.md#BKMK_Specifying_the_DataSourceAttribute)  
  
    -   [Using TestContext.DataRow to access the data](../VS_csharp/how-to--create-a-data-driven-unit-test.md#BKMK_Using_TestContext_DataRow_to_access_the_data)  
  
-   [Running the test and viewing results](../VS_csharp/how-to--create-a-data-driven-unit-test.md#BKMK_Running_the_test_and_viewing_results)  
...
## See Also  
 ...
 [Running Unit Tests with Test Explorer](../VS_csharp/run-unit-tests-with-test-explorer.md)   
