...
This walkthrough will step you through creating, running, and customizing a series of unit tests using the Microsoft unit test framework for managed code and the Visual Studio Test Explorer. You start with a C# project that is under development, create tests that exercise its code, run the tests, and examine the results. Then you can change your project code and re-run the tests.  
 ...
 [Prepare the walkthrough](../VS_csharp/walkthrough--creating-and-running-unit-tests-for-managed-code.md#BKMK_Prepare_the_walkthrough)  
  
 [Create a unit test project](../VS_csharp/walkthrough--creating-and-running-unit-tests-for-managed-code.md#BKMK_Create_a_unit_test_project)  
  
 [Create the test class](../VS_csharp/walkthrough--creating-and-running-unit-tests-for-managed-code.md#BKMK_Create_the_test_class)  
  
-   [Test class requirements](../VS_csharp/walkthrough--creating-and-running-unit-tests-for-managed-code.md#BKMK_Test_class_requirements)  
  
 [Create the first test method](../VS_csharp/walkthrough--creating-and-running-unit-tests-for-managed-code.md#BKMK_Create_the_first_test_method)  
  
-   [Test method requirements](../VS_csharp/walkthrough--creating-and-running-unit-tests-for-managed-code.md#BKMK_Test_method_requirements)  
  
 [Build and run the test](../VS_csharp/walkthrough--creating-and-running-unit-tests-for-managed-code.md#BKMK_Build_and_run_the_test)  
  
 [Fix your code and rerun your tests](../VS_csharp/walkthrough--creating-and-running-unit-tests-for-managed-code.md#BKMK_Fix_your_code_and_rerun_your_tests)  
  
 [Use unit tests to improve your code](../VS_csharp/walkthrough--creating-and-running-unit-tests-for-managed-code.md#BKMK_Use_unit_tests_to_improve_your_code)  
  
> [!NOTE]
>  This walkthrough uses the Microsoft unit test framework for managed code. Test Explorer also can run tests from third party unit test frameworks that have adapters for Test Explorer. For more information, see [How to: Install Third-Party Unit Test Frameworks](../VS_csharp/install-third-party-unit-test-frameworks.md)  
...
-   The Bank project. See [Unit Test Sample](../VS_csharp/sample-project-for-creating-unit-tests.md).  
...
6.  Copy the source code from the [Unit Test Sample](../VS_csharp/sample-project-for-creating-unit-tests.md).  
  
7.  Replace the original contents of Class1.cs with the code from the [Unit Test Sample](../VS_csharp/sample-project-for-creating-unit-tests.md).  
 ...
 **Prerequisite**: Follow the steps in the procedure, [Prepare the walkthrough](../VS_csharp/walkthrough--creating-and-running-unit-tests-for-managed-code.md#BKMK_Prepare_the_walkthrough).  
