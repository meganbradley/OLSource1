...
|[CMFCVisualManager::OnDrawBrowseButton](#cmfcvisualmanager__ondrawbrowsebutton)|Called by the framework when it draws a browse button that belongs to an edit control ( [CMFCEditBrowseCtrl Class](../VS_csharp/cmfceditbrowsectrl-class.md)).|  
...
|[CMFCVisualManager::OnDrawEditBorder](#cmfcvisualmanager__ondraweditborder)|Called by the framework when it draws a border around a [CMFCToolBarEditBoxButton](../VS_csharp/cmfctoolbareditboxbutton-class.md) object.|  
...
|[CMFCVisualManager::OnDrawPaneBorder](#cmfcvisualmanager__ondrawpaneborder)|Called by the framework when it draws the border of a [CPane Class](../VS_csharp/cpane-class.md).|  
...
|[CMFCVisualManager::OnDrawRibbonProgressBar](#cmfcvisualmanager__ondrawribbonprogressbar)|Called by the framework when it draws a [CMFCRibbonProgressBar](../VS_csharp/cmfcribbonprogressbar-class.md) object.|  
...
|[CMFCVisualManager::OnDrawRibbonSliderChannel](#cmfcvisualmanager__ondrawribbonsliderchannel)|Called by the framework when it draws the channel of a [CMFCRibbonSlider](../VS_csharp/cmfcribbonslider-class.md) object.|  
...
|[CMFCVisualManager::OnDrawTab](#cmfcvisualmanager__ondrawtab)|Called by the framework when it draws a [CMFCTabCtrl](../VS_csharp/cmfctabctrl-class.md) object.|  
...
|[CMFCVisualManager::OnFillTasksGroupInterior](#cmfcvisualmanager__onfilltasksgroupinterior)|Called by the framework when it fills the interior of a [CMFCTasksPaneTaskGroup](../VS_csharp/cmfctaskspanetaskgroup-class.md) object on the [CMFCTasksPane](../VS_csharp/cmfctaskspane-class.md).|  
...
## Remarks  
 ...
 To change the appearance of your application you must use other classes that provide methods for drawing all of the visual elements of your application. Some examples of these classes are [CMFCVisualManagerOfficeXP Class](../VS_csharp/cmfcvisualmanagerofficexp-class.md), [CMFCVisualManagerOffice2003 Class](../VS_csharp/cmfcvisualmanageroffice2003-class.md), and [CMFCVisualManagerOffice2007 Class](../VS_csharp/cmfcvisualmanageroffice2007-class.md). When you want to change the appearance of your application, pass one of these visual managers into the method `SetDefaultManager`. For an example that demonstrates how your application can mimic the appearance of Microsoft Office 2003, see [CMFCVisualManagerOffice2003 Class](../VS_csharp/cmfcvisualmanageroffice2003-class.md).  
...
## Example  
 The following example demonstrates how to retrieve the default values of a `CMFCVisualManager` object. This code snippet is part of the [Tasks Pane sample](../VS_csharp/visual-c---samples.md).  
  
 [!code[NVC_MFC_TasksPane#1](../VS_csharp/codesnippet/CPP/cmfcvisualmanager-class_1.h)]  
...
### Return Value  
 A [CSize](../VS_csharp/csize-class.md) object that contains the extra size of the border for toolbar buttons.  
...
##  <a name="cmfcvisualmanager__getinstance"></a>  CMFCVisualManager::GetInstance  
 Returns a pointer to the current [CMFCVisualManager Class](../VS_csharp/cmfcvisualmanager-class.md) object for the application.  
...
### Return Value  
 A [CSize](../VS_csharp/csize-class.md) parameter that indicate the size of the system buttons.  
...
### Remarks  
 The text color of a [CMFCToolBarButton Class](../VS_csharp/cmfctoolbarbutton-class.md) object depends on the state of the button. The possible states of a toolbar button are `ButtonsIsRegular`, `ButtonsIsPressed`, or `ButtonsIsHighlighted`.  
...
### Remarks  
 This method is called by [CMFCToolBarImages::Draw](../VS_csharp/cmfctoolbarimages-class.md#cmfctoolbarimages__draw) when it draws an image on the toolbar that is unavailable.  
...
### Remarks  
 The [CMFCPopupMenu Class](../VS_csharp/cmfcpopupmenu-class.md) calls this method when it has to draw the menu and shadow. By default, this method returns `FALSE`. If you want to use pop-up menus similar to the pop-up menus in Office XP, override this method in a custom visual manager and return `TRUE`.  
...
### Parameters  
 ...
 [in] `rectBorderSize`  
 A [CRect](../VS_csharp/crect-class.md) parameter that contains the sizes of the borders.  
...
### Remarks  
 The default implementation of this method displays the standard gripper. To customize the appearance of the gripper, override this method in a custom class derived from the [CMFCVisualManager Class](../VS_csharp/cmfcvisualmanager-class.md).  
...
### Remarks  
 Override this function in a derived class if you want to customize the appearance of browse buttons in instances of the [CMFCEditBrowseCtrl Class](../VS_csharp/cmfceditbrowsectrl-class.md). The possible values for the state of the button are `ButtonsIsRegular`, `ButtonsIsPressed`, and `ButtonsIsHighlighted`.  
...
##  <a name="cmfcvisualmanager__ondrawcaptionbarborder"></a>  CMFCVisualManager::OnDrawCaptionBarBorder  
 The framework calls this method when it draws the border of a [CMFCCaptionBar Class](../VS_csharp/cmfccaptionbar-class.md) object.  
...
##  <a name="cmfcvisualmanager__ondrawcaptionbutton"></a>  CMFCVisualManager::OnDrawCaptionButton  
 The framework calls this method when it draws a [CMFCCaptionButton](../VS_csharp/cmfccaptionbutton-class.md) object.  
...
##  <a name="cmfcvisualmanager__ondrawcomboborder"></a>  CMFCVisualManager::OnDrawComboBorder  
 The framework calls this method when it draws the border around an instance of the [CMFCToolBarComboBoxButton Class](../VS_csharp/cmfctoolbarcomboboxbutton-class.md).  
...
##  <a name="cmfcvisualmanager__ondraweditborder"></a>  CMFCVisualManager::OnDrawEditBorder  
 The framework calls this method when it draws the border around an instance of the [CMFCToolBarEditBoxButton Class](../VS_csharp/cmfctoolbareditboxbutton-class.md).  
...
### Parameters  
 [in] `pCtrl`  
 A pointer to a header control. The visual manager draws the sort arrow of this [CMFCHeaderCtrl Class](../VS_csharp/cmfcheaderctrl-class.md) object.  
...
### Remarks  
 ...
 The default implementation for this method calls [CDC::DrawFrameControl](../VS_csharp/cdc-class.md#cdc__drawframecontrol) with the `DFC_CAPTION` type. Override this method in your derived visual manager class to customize the appearance of system buttons.  
...
##  <a name="cmfcvisualmanager__ondrawpaneborder"></a>  CMFCVisualManager::OnDrawPaneBorder  
 The framework calls this method when it draws the border of a [CPane Class](../VS_csharp/cpane-class.md) object.  
...
##  <a name="cmfcvisualmanager__ondrawpanecaption"></a>  CMFCVisualManager::OnDrawPaneCaption  
 The framework calls this method when it draws a caption for an instance of the [CDockablePane Class](../VS_csharp/cdockablepane-class.md).  
...
### Parameters  
 ...
 [in] `pButton`  
 A pointer to a [CMFCRibbonButton](../VS_csharp/cmfcribbonbutton-class.md) object. The framework draws the border for this ribbon button.  
...
##  <a name="cmfcvisualmanager__ondrawribboncategory"></a>  CMFCVisualManager::OnDrawRibbonCategory  
 The framework calls this method when it draws a [CMFCRibbonCategory](../VS_csharp/cmfcribboncategory-class.md) object.  
...
### Remarks  
 A ribbon category is a logical grouping of menu commands. For more information about ribbon categories, see [CMFCRibbonCategory Class](../VS_csharp/cmfcribboncategory-class.md).  
...
### Parameters  
 ...
 [in] `pContextCaption`  
 A pointer to a caption bar. The visual manager draws this [CMFCRibbonContextCaption Class](../VS_csharp/cmfcribboncontextcaption-class.md) object.  
...
### Remarks  
 Override this method in a derived class to customize the appearance of the caption bar for a ribbon category. For more information about the caption bar, see [CMFCRibbonContextCaption Class](../VS_csharp/cmfcribboncontextcaption-class.md).  
...
### Remarks  
 Override this method in a derived visual manager to customize the appearance of a ribbon category tab. For more information about ribbon categories, see [CMFCRibbonCategory Class](../VS_csharp/cmfcribboncategory-class.md).  
...
### Parameters  
 ...
 [in] `pLabel`  
 A pointer to a [CMFCRibbonLabel](../VS_csharp/cmfcribbonlabel-class.md) object. The framework draws this ribbon label.  
...
##  <a name="cmfcvisualmanager__ondrawribbonmainpanelbuttonborder"></a>  CMFCVisualManager::OnDrawRibbonMainPanelButtonBorder  
 The framework calls this method when it draws the border of a [CMFCRibbonButton](../VS_csharp/cmfcribbonbutton-class.md) that is positioned on the **Main** panel.  
...
##  <a name="cmfcvisualmanager__ondrawribbonmainpanelframe"></a>  CMFCVisualManager::OnDrawRibbonMainPanelFrame  
 The framework calls this method when it draws the frame around the [CMFCRibbonMainPanel](../VS_csharp/cmfcribbonmainpanel-class.md).  
...
##  <a name="cmfcvisualmanager__ondrawribbonpanel"></a>  CMFCVisualManager::OnDrawRibbonPanel  
 The framework calls this method when it draws a [CMFCRibbonPanel](../VS_csharp/cmfcribbonpanel-class.md) object.  
...
##  <a name="cmfcvisualmanager__ondrawribbonpanelcaption"></a>  CMFCVisualManager::OnDrawRibbonPanelCaption  
 The framework calls this method when it draws the caption of a [CMFCRibbonPanel Class](../VS_csharp/cmfcribbonpanel-class.md).  
...
##  <a name="cmfcvisualmanager__ondrawribbonprogressbar"></a>  CMFCVisualManager::OnDrawRibbonProgressBar  
 The framework calls this method when it draws a [CMFCRibbonProgressBar Class](../VS_csharp/cmfcribbonprogressbar-class.md).  
...
##  <a name="cmfcvisualmanager__ondrawribbonsliderchannel"></a>  CMFCVisualManager::OnDrawRibbonSliderChannel  
 The framework calls this method when it draws the channel of a [CMFCRibbonSlider Class](../VS_csharp/cmfcribbonslider-class.md).  
...
### Parameters  
 ...
 `pWndRibbonBar`  
 A pointer to a [CMFCRibbonBar](../VS_csharp/cmfcribbonbar-class.md) object. The framework draws the frame for this ribbon bar.  
...
##  <a name="cmfcvisualmanager__ondrawspinbuttons"></a>  CMFCVisualManager::OnDrawSpinButtons  
 The framework calls this method when it draws an instance of the [CMFCSpinButtonCtrl Class](../VS_csharp/cmfcspinbuttonctrl-class.md).  
...
##  <a name="cmfcvisualmanager__ondrawtabcontent"></a>  CMFCVisualManager::OnDrawTabContent  
 The framework calls this method when it draws the contents located on the interior of an instance of the [CMFCBaseTabCtrl Class](../VS_csharp/cmfcbasetabctrl-class.md).  
...
### Parameters  
 ...
 [in] `pButton`  
 A pointer to a [CMFCButton](../VS_csharp/cmfcbutton-class.md) object. The framework draws the border for this `CMFCButton` instance.  
...
##  <a name="cmfcvisualmanager__ondrawtask"></a>  CMFCVisualManager::OnDrawTask  
 The framework calls this method when it draws a [CMFCTasksPane](../VS_csharp/cmfctaskspane-class.md) object.  
...
##  <a name="cmfcvisualmanager__ondrawtasksgroupareaborder"></a>  CMFCVisualManager::OnDrawTasksGroupAreaBorder  
 The framework calls this method when it draws a border around a group on a [CMFCTasksPane Class](../VS_csharp/cmfctaskspane-class.md).  
...
### Remarks  
 The task groups appear on the [CMFCTasksPane](../VS_csharp/cmfctaskspane-class.md) object.  
...
##  <a name="cmfcvisualmanager__ondrawtearoffcaption"></a>  CMFCVisualManager::OnDrawTearOffCaption  
 The framework calls this method when it draws the caption for a [CMFCPopupMenu Class](../VS_csharp/cmfcpopupmenu-class.md).  
...
### Remarks  
 This function is called by the framework when a [CMFCBaseTabCtrl Class](../VS_csharp/cmfcbasetabctrl-class.md) object processes a `WM_PAINT` message and erases the tab area.  
...
##  <a name="cmfcvisualmanager__onerasetabsframe"></a>  CMFCVisualManager::OnEraseTabsFrame  
 The framework calls this method when it erases a frame on a [CMFCBaseTabCtrl](../VS_csharp/cmfcbasetabctrl-class.md).  
...
### Example  
 The following example demonstrates how to use the `OnFillBarBackground` in the `CMFCVisualManager` class. This code snippet is part of the [Outlook Demo sample](../VS_csharp/visual-c---samples.md).  
  
 [!code[NVC_MFC_OutlookDemo#4](../VS_csharp/codesnippet/CPP/cmfcvisualmanager-class_2.cpp)]  
...
### Parameters  
 ...
 [in] `pButton`  
 A pointer to a [CMFCToolBarButton](../VS_csharp/cmfctoolbarbutton-class.md). The framework fills the background for this button.  
...
### Parameters  
 ...
 [in] `pButton`  
 A pointer to a [CMFCRibbonButton](../VS_csharp/cmfcribbonbutton-class.md) object. The framework fills the interior of this ribbon button.  
...
### Parameters  
 ...
 [in] `pButton`  
 A pointer to a [CMFCRibbonButton Class](../VS_csharp/cmfcribbonbutton-class.md) object. The framework fills this ribbon button.  
...
### Parameters  
 ...
 [in] `pPanel`  
 A pointer to an instance of the [CMFCRibbonMainPanel Class](../VS_csharp/cmfcribbonmainpanel-class.md). The framework fills the menu frame for this ribbon panel.  
...
### Parameters  
 ...
 [in] `pButton`  
 A pointer to a [CMFCToolBarMenuButton](../VS_csharp/cmfctoolbarmenubutton-class.md) object to display. The default implementation does not use this parameter.  
...
### Remarks  
 Use the [CMFCVisualManager Class](../VS_csharp/cmfcvisualmanager-class.md) and any derived visual managers to customize the appearance of your application. After you set the default visual manager, this method redraws your application by using the new visual manager. For more information about how to use visual managers, see [The Visualization Manager](../VS_csharp/visualization-manager.md).  
...
##  <a name="cmfcvisualmanager__setshadowhighlightedimage"></a>  CMFCVisualManager::SetShadowHighlightedImage  
 Sets a flag that indicates whether the [CMFCVisualManager](../VS_csharp/cmfcvisualmanager-class.md) displays shadows for highlighted images.  
...
## See Also  
 ...
 [The Visualization Manager](../VS_csharp/visualization-manager.md)