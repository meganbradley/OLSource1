...
## Remarks  
 The template class describes an object that designates a sequence of characters that matched a capture group in a call to [regex_match](../VS_csharp/-regex--functions.md#regex_match_function) or to [regex_search](../VS_csharp/-regex--functions.md#regex_search_function). Objects of type [match_results](../VS_csharp/match_results-class.md) hold an array of these objects, one for each capture group in the regular expression that was used in the search.  
...
## See Also  
 ...
 [sub_match](../VS_csharp/sub_match-class.md)   
