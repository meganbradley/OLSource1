...
## Remarks  
 Patterns are used in many language constructs, such as the `match` expression. They are used when you are processing arguments for functions in `let` bindings, lambda expressions, and in the exception handlers associated with the `try...with` expression. For more information, see [Match Expression](../VS_csharp/match-expressions--fsharp-.md), [Let Bindings](../VS_csharp/let-bindings--fsharp-.md), [Lambda Expressions: The fun keyword](../VS_csharp/lambda-expressions--the-fun-keyword--fsharp-.md), and [Exception Handling: The try...with Expression](../VS_csharp/exceptions--the-try...with-expression--fsharp-.md).  
...
## Constant Patterns  
 ...
 [!code[FsLangRef2#4801](../VS_csharp/codesnippet/FSharp/pattern-matching--fsharp-_1.fs)]  
 ...
 [!code[FsLangRef2#4802](../VS_csharp/codesnippet/FSharp/pattern-matching--fsharp-_2.fs)]  
...
## Identifier Patterns  
 ...
 [!code[FsLangRef2#4803](../VS_csharp/codesnippet/FSharp/pattern-matching--fsharp-_3.fs)]  
 ...
 [!code[FsLangRef2#4804](../VS_csharp/codesnippet/FSharp/pattern-matching--fsharp-_4.fs)]  
...
```  
 ...
 Active patterns enable you to define more complex custom pattern matching. For more information about active patterns, see [Active Patterns (F#)](../VS_csharp/active-patterns--fsharp-.md).  
  
 The case in which the identifier is an exception is used in pattern matching in the context of exception handlers. For information about pattern matching in exception handling, see [Exception Handling: The try...with Expression](../VS_csharp/exceptions--the-try...with-expression--fsharp-.md).  
...
## Variable Patterns  
 ...
 [!code[FsLangRef2#4805](../VS_csharp/codesnippet/FSharp/pattern-matching--fsharp-_5.fs)]  
...
## as Pattern  
 ...
 [!code[FsLangRef2#4806](../VS_csharp/codesnippet/FSharp/pattern-matching--fsharp-_6.fs)]  
...
## OR Pattern  
 ...
 [!code[FsLangRef2#4807](../VS_csharp/codesnippet/FSharp/pattern-matching--fsharp-_7.fs)]  
...
## AND Pattern  
 ...
 [!code[FsLangRef2#4808](../VS_csharp/codesnippet/FSharp/pattern-matching--fsharp-_8.fs)]  
...
## Cons Pattern  
 ...
 [!code[FsLangRef2#4809](../VS_csharp/codesnippet/FSharp/pattern-matching--fsharp-_9.fs)]  
...
## List Pattern  
 ...
 [!code[FsLangRef2#4810](../VS_csharp/codesnippet/FSharp/pattern-matching--fsharp-_10.fs)]  
  
## Array Pattern  
 The array pattern resembles the list pattern and can be used to decompose arrays of a specific length.  
  
 [!code[FsLangRef2#4811](../VS_csharp/codesnippet/FSharp/pattern-matching--fsharp-_11.fs)]  
...
## Parenthesized Pattern  
 ...
 [!code[FsLangRef2#4812](../VS_csharp/codesnippet/FSharp/pattern-matching--fsharp-_12.fs)]  
...
##  <a name="tuple"></a> Tuple Pattern  
 ...
 [!code[FsLangRef2#4813](../VS_csharp/codesnippet/FSharp/pattern-matching--fsharp-_13.fs)]  
...
## Record Pattern  
 ...
 [!code[FsLangRef2#4814](../VS_csharp/codesnippet/FSharp/pattern-matching--fsharp-_14.fs)]  
...
## Patterns That Have Type Annotations  
 ...
 [!code[FsLangRef2#4815](../VS_csharp/codesnippet/FSharp/pattern-matching--fsharp-_15.fs)]  
...
## Type Test Pattern  
 ...
 [!code[FsLangRef2#4816](../VS_csharp/codesnippet/FSharp/pattern-matching--fsharp-_16.fs)]  
  
## Null Pattern  
 The null pattern matches the null value that can appear when you are working with types that allow a null value. Null patterns are frequently used when interoperating with [!INCLUDE[dnprdnshort](../VS_csharp/includes/dnprdnshort_md.md)] code. For example, the return value of a .NET API might be the input to a `match` expression. You can control program flow based on whether the return value is null, and also on other characteristics of the returned value. You can use the null pattern to prevent null values from propagating to the rest of your program.  
  
 The following example uses the null pattern and the variable pattern.  
  
 [!code[FsLangRef2#4817](../VS_csharp/codesnippet/FSharp/pattern-matching--fsharp-_17.fs)]  
  
## See Also  
 [Match Expression](../VS_csharp/match-expressions--fsharp-.md)   
 [F# Language Reference](../VS_csharp/fsharp-language-reference.md)   
 [Active Patterns](../VS_csharp/active-patterns--fsharp-.md)