...
## Remarks  
 The querydef is an object of class [CDaoQueryDef](../VS_csharp/cdaoquerydef-class.md). The references to Primary, Secondary, and All above indicate how the information is returned by the [GetQueryDefInfo](../Topic/CDaoDatabase::GetQueryDefInfo.md) member function in class `CDaoDatabase`.  
