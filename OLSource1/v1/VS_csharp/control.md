...
## Remarks  
 The **control** attribute implies the [coclass](../VS_csharp/coclass.md) attribute. The **control** C++ attribute has the same functionality as the [control](http://msdn.microsoft.com/library/windows/desktop/aa366764) MIDL attribute.  
