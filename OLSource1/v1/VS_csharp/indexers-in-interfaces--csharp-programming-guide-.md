...
Indexers can be declared on an [interface](../VS_csharp/interface--csharp-reference-.md). Accessors of interface indexers differ from the accessors of [class](../VS_csharp/class--csharp-reference-.md) indexers in the following ways:  
