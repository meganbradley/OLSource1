...
-   [Inserting the Control into a Visual C++ Application](../VS_csharp/inserting-the-control-into-a-visual-c---application.md)  
  
-   [Wrapper Classes](../VS_csharp/wrapper-classes.md)  
  
-   [Creating a Database Connection](../VS_csharp/creating-database-connections.md)  
  
-   [Setting Control Properties at Design Time](../VS_csharp/setting-control-properties-at-design-time.md)  
  
-   [Setting Event Handlers on ActiveX Controls](../VS_csharp/setting-event-handlers-on-activex-controls.md)  
  
-   [Modifying a Control's Run-Time Behavior](../VS_csharp/modifying-a-control-s-run-time-behavior.md)  
  
-   [Redistributing Controls](../VS_csharp/redistributing-controls.md)  
