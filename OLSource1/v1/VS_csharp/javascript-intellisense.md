...
-   [JavaScript Validation](#Validation)  
 ...
 For more information about the IntelliSense functionality of [!INCLUDE[vs_current_short](../VS_csharp/includes/vs_current_short_md.md)], see [Using IntelliSense](../VS_csharp/using-intellisense.md).  
...
-   The [!INCLUDE[atlaslib_current_ext](../VS_csharp/includes/atlaslib_current_ext_md.md)], if you are working in an AJAX-enabled ASP.NET Web application.  
...
-   Objects described using standard JavaScript comment tags (//). For more information, see [Extending JavaScript IntelliSense](../VS_csharp/extending-javascript-intellisense.md).  
  
-   Objects supported using the [extensibility](#Extensibility) mechanism. For more information, see [Extending JavaScript IntelliSense](../VS_csharp/extending-javascript-intellisense.md).  
  
-   [ASP.NET AJAX objects](#ASPNet)  
  
 When IntelliSense is unable to determine the type of an object, it provides options for statement completion using identifiers in the active document. For more information, see [Statement Completion using Identifiers](../VS_csharp/statement-completion-for-identifiers.md).  
...
###  <a name="IntrinsicObjects"></a> Intrinsic Objects  
 JavaScript IntelliSense provides programming references for intrinsic objects such as `Array`, `String`, `Math`, `Date`, and `Number`. For more information about intrinsic objects, see [Intrinsic Objects](assetId:///6520c634-a7d1-4a05-8c1b-2e79f449d2e4).  
  
###  <a name="UserDefined"></a> User-defined Variables, Functions, and Objects  
 When you change a JavaScript file, [!INCLUDE[vs_current_short](../VS_csharp/includes/vs_current_short_md.md)] scans opened and referenced documents to determine all available code resources. This includes the variables, functions, and objects that you have created. These resources are then available to JavaScript IntelliSense.  
...
####  <a name="ReferenceDirectives"></a> Reference Directives  
 A `reference` directive enables [!INCLUDE[vs_current_short](../VS_csharp/includes/vs_current_short_md.md)] to establish a relationship between the script you are currently editing and other scripts. The `reference` directive lets you include a script file in the scripting context of the current script file. This enables IntelliSense to reference externally defined functions, types, and fields as you code.  
...
-   Implicit (Windows), for [!INCLUDE[win8_appname_long](../VS_csharp/includes/win8_appname_long_md.md)] apps using JavaScript. Files included in this group are in scope for every .js file opened in the Code Editor for the project of the specified type.  
...
>  Except for Web projects, this feature works only for JavaScript files that are opened outside the context of a project. For Web projects, remote files referenced in your project are downloaded by default.  
 ...
 For instructions about using this feature, see [Options, Text Editor, JavaScript, IntelliSense](../VS_csharp/options--text-editor--javascript--intellisense.md).  
...
## See Also  
 ...
 [How to: Create JavaScript XML Documentation Comments](../VS_csharp/create-xml-documentation-comments-for-javascript-intellisense.md)   
 [Extending JavaScript IntelliSense](../VS_csharp/extending-javascript-intellisense.md)   
 [Statement Completion using Identifiers](../VS_csharp/statement-completion-for-identifiers.md)   
 [XML Documentation Comments](../VS_csharp/xml-documentation-comments--javascript-.md)   
