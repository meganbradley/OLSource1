...
#### 4. Build Support  
 The integrated shell provides build support. You can find information about builds in the [MSBuild Reference](../VS_csharp/msbuild-reference.md).  
...
## See Also  
 [Visual Studio Integration](../Topic/Extending%20Visual%20Studio%20Overview_deleted.md)