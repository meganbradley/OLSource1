...
|Element|Description|  
|-------------|-----------------|  
|[Menus Element](../VS_csharp/menus-element.md)|Defines all the menus and toolbars that a VSPackage implements.|  
|[Menu Element](../VS_csharp/menu-element.md)|Represents a single menu or toolbar.|  
  
### Parent Elements  
  
|Element|Description|  
|-------------|-----------------|  
|[Commands](../VS_csharp/commands-element.md)|Represents the collection of commands in the VSPackage.|  
