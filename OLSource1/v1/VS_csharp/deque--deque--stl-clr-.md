...
## Remarks  
 ...
 initializes the controlled sequence with the sequence `[``right``.`[begin](../VS_csharp/deque--begin--stl-clr-.md)`(),` `right``.`[end](../VS_csharp/deque--end--stl-clr-.md)`())`. You use it to specify an initial controlled sequence that is a copy of the sequence controlled by the deque object `right`.  
  
 The constructor:  
  
 `deque(deque<Value>^ right);`  
  
 initializes the controlled sequence with the sequence `[``right``->`[begin](../VS_csharp/deque--begin--stl-clr-.md)`(),` `right``->`[end](../VS_csharp/deque--end--stl-clr-.md)`())`. You use it to specify an initial controlled sequence that is a copy of the sequence controlled by the deque object whose handle is `right`.  
...
## See Also  
 ...
 [assign](../VS_csharp/deque--assign--stl-clr-.md)   
 [generic_container](../VS_csharp/deque--generic_container--stl-clr-.md)   
 [operator=](../VS_csharp/operator=--deque---stl-clr-.md)