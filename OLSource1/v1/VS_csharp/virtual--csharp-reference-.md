...
```  
 ...
 The implementation of a virtual member can be changed by an [overriding member](../VS_csharp/override--csharp-reference-.md) in a derived class. For more information about how to use the `virtual` keyword, see [Versioning with the Override and New Keywords](../VS_csharp/versioning-with-the-override-and-new-keywords--csharp-programming-guide-.md) and [Knowing When to Use Override and New Keywords](../VS_csharp/knowing-when-to-use-override-and-new-keywords--csharp-programming-guide-.md).  
