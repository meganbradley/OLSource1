...
> [!NOTE]
>  The **/verbosity** (**/v**) switch in a command line can also affect build performance. Your build performance might decrease if the verbosity of your build log information is set to detailed or diagnostic, which are used for troubleshooting. For more information, see [Overview of Logging in MSBuild](../VS_csharp/obtaining-build-logs-with-msbuild.md) and [MSBuild Command-Line Reference](../VS_csharp/msbuild-command-line-reference.md).  
...
## /maxcpucount Switch  
 ...
 For more information about this switch, which was introduced in MSBuild 3.5, see [MSBuild Command-Line Reference](../VS_csharp/msbuild-command-line-reference.md).  
...
## See Also  
 [Taking Advantage of Multiple Processors for Building Projects](../VS_csharp/using-multiple-processors-to-build-projects.md)   
 [Writing Multi-Proc Aware Loggers](../VS_csharp/writing-multi-processor-aware-loggers.md)   
