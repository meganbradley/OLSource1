...
## Resources  
 ...
 For [!INCLUDE[win81](../VS_csharp/includes/win81_md.md)], DirectX is included in the Windows SDK. You don't have to download anything extra. For more information, see [Where is the DirectX SDK?](http://msdn.microsoft.com/library/windows/desktop/ee663275.aspx).  
 ...
 [Win32 Windows Applications](../VS_csharp/windows-desktop-applications--c---.md) contains articles that describe how to create a basic Windows desktop app.  
  
 [Developing Games](http://msdn.microsoft.com/library/windows/apps/hh452744.aspx) discusses [!INCLUDE[win8_appname_long](../VS_csharp/includes/win8_appname_long_md.md)] game development, but many of the concepts also apply to desktop games.