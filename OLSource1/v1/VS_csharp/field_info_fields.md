...
## Members  
 FIF_FULLNAME  
 Initialize/use the `bstrFullName` field in the [FIELD_INFO](../VS_csharp/field_info.md) structure.  
...
## Remarks  
 These values are also passed as an argument to the [GetInfo](../VS_csharp/idebugfield--getinfo.md) method to specify which fields of the [FIELD_INFO](../VS_csharp/field_info.md) structure are to be initialized.  
...
## See Also  
 ...
 [GetInfo](../VS_csharp/idebugfield--getinfo.md)