...
dev_langs: 
  - "FSharp"
helpviewer_keywords: 
  - "GeneralizableValue attribute [F#]"
  - "GeneralizableValueAttribute class [F#]"
...
|Member|Description|  
|------------|-----------------|  
|[new](../VS_csharp/core.generalizablevalueattribute-constructor--fsharp-.md)|Creates an instance of the attribute.|  
