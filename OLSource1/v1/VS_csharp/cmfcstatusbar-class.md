...
|Name|Description|  
|----------|-----------------|  
|[CMFCStatusBar::CalcFixedLayout](#cmfcstatusbar__calcfixedlayout)|(Overrides [CBasePane::CalcFixedLayout](../VS_csharp/cbasepane-class.md#cbasepane__calcfixedlayout).)|  
|[CMFCStatusBar::CommandToIndex](#cmfcstatusbar__commandtoindex)||  
|[CMFCStatusBar::Create](#cmfcstatusbar__create)|Creates a control bar and attaches it to the [CPane](../VS_csharp/cpane-class.md) object. (Overrides [CPane::Create](../VS_csharp/cpane-class.md#cpane__create).)|  
|[CMFCStatusBar::CreateEx](#cmfcstatusbar__createex)|Creates a control bar and attaches it to the [CPane](../VS_csharp/cpane-class.md) object. (Overrides [CPane::CreateEx](../VS_csharp/cpane-class.md#cpane__createex).)|  
|[CMFCStatusBar::DoesAllowDynInsertBefore](#cmfcstatusbar__doesallowdyninsertbefore)|Determines whether another pane can be dynamically inserted between this pane and the parent frame. (Overrides [CBasePane::DoesAllowDynInsertBefore](../VS_csharp/cbasepane-class.md#cbasepane__doesallowdyninsertbefore).)|  
...
|[CMFCStatusBar::GetPaneStyle](#cmfcstatusbar__getpanestyle)|Returns the pane style. (Overrides [CBasePane::GetPaneStyle](../VS_csharp/cbasepane-class.md#cbasepane__getpanestyle).)|  
...
|[CMFCStatusBar::PreCreateWindow](#cmfcstatusbar__precreatewindow)|Called by the framework before the creation of the Windows window attached to this `CWnd` object. (Overrides [CWnd::PreCreateWindow](../VS_csharp/cwnd-class.md#cwnd__precreatewindow).)|  
...
|[CMFCStatusBar::SetPaneStyle](#cmfcstatusbar__setpanestyle)|Sets the style of the pane. (Overrides [CBasePane::SetPaneStyle](../VS_csharp/cbasepane-class.md#cbasepane__setpanestyle).)|  
...
## Remarks  
 The following diagram shows a figure of the status bar from [Status Bar Demo sample](../VS_csharp/visual-c---samples.md) application.  
  
 ![Example of CMFCStatusBar](../VS_csharp/media/cmfcstatusbar.png "CMFCStatusBar")  
  
## Example  
 The following example demonstrates the local variables that the application uses to call various methods in the `CMFCStatusBar` class. These variables are declared in StatusBarDemoView.h. The main frame is declared in MainFrm.h, the document is declared in StatusBarDemoDoc.h, and the view is declared in StatusBarDemoView.h. This code snippet is part of the [Status Bar Demo sample](../VS_csharp/visual-c---samples.md).  
  
 [!code[NVC_MFC_StatusBarDemo#9](../VS_csharp/codesnippet/CPP/cmfcstatusbar-class_1.h)]  
  
## Example  
 The following example demonstrates how to get a reference to `CMFCStatusBar` object by introducing the `GetStatusBar` method in MainFrm.h and then calling this method from the `GetStatusBar` method in StatusBarDemoView.h. This code snippet is part of the [Status Bar Demo sample](../VS_csharp/visual-c---samples.md).  
  
 [!code[NVC_MFC_StatusBarDemo#7](../VS_csharp/codesnippet/CPP/cmfcstatusbar-class_2.h)]  
[!code[NVC_MFC_StatusBarDemo#8](../VS_csharp/codesnippet/CPP/cmfcstatusbar-class_3.h)]  
  
## Example  
 The following example demonstrates how to call various methods in the `CMFCStatusBar` class in StatusBarDemoView.cpp. The constants are declared in MainFrm.h. The example shows how to set the icon, set the tooltip text of the status bar pane, display a progress bar on the specified pane, assign an animation to the specified pane, set the text and the width of the status bar pane, and set the current progress indicator of the progress bar for the status bar pane. This code snippet is part of the [Status Bar Demo sample](../VS_csharp/visual-c---samples.md).  
  
 [!code[NVC_MFC_StatusBarDemo#6](../VS_csharp/codesnippet/CPP/cmfcstatusbar-class_4.h)]  
[!code[NVC_MFC_StatusBarDemo#1](../VS_csharp/codesnippet/CPP/cmfcstatusbar-class_5.cpp)]  
[!code[NVC_MFC_StatusBarDemo#2](../VS_csharp/codesnippet/CPP/cmfcstatusbar-class_6.cpp)]  
[!code[NVC_MFC_StatusBarDemo#3](../VS_csharp/codesnippet/CPP/cmfcstatusbar-class_7.cpp)]  
[!code[NVC_MFC_StatusBarDemo#4](../VS_csharp/codesnippet/CPP/cmfcstatusbar-class_8.cpp)]  
[!code[NVC_MFC_StatusBarDemo#5](../VS_csharp/codesnippet/CPP/cmfcstatusbar-class_9.cpp)]  
...
## Inheritance Hierarchy  
 ...
 [CMFCStatusBar](../VS_csharp/cmfcstatusbar-class.md)  
