...
-   **MF_CHECKED** and **MF_UNCHECKED**  
 ...
 Whenever a menu that resides in a window is changed (whether or not the window is displayed), the application should call [CWnd::DrawMenuBar](../VS_csharp/cwnd-class.md#cwnd__drawmenubar).  
...
### Remarks  
 ...
 If the menu you want to manipulate is already associated with a window, you can use the [CWnd::GetMenu](../VS_csharp/cwnd-class.md#cwnd__getmenu) function to get a handle to the menu.  
  
### Example  
 [!code[NVC_MFCWindowing#21](../VS_csharp/codesnippet/CPP/cmenu-class_1.cpp)]  
...
### Example  
  See the example for [ON_COMMAND_RANGE](../VS_csharp/on_command_range.md).  
...
### Example  
 [!code[NVC_MFCWindowing#22](../VS_csharp/codesnippet/CPP/cmenu-class_2.cpp)]  
...
### Remarks  
 ...
 Whenever a menu that resides in a window is changed (whether or not the window is displayed), the application must call [CWnd::DrawMenuBar](../VS_csharp/cwnd-class.md#cwnd__drawmenubar).  
  
### Example  
  See the example for [CWnd::GetMenu](../VS_csharp/cwnd-class.md#cwnd__getmenu).  
...
### Example  
 [!code[NVC_MFCWindowing#23](../VS_csharp/codesnippet/CPP/cmenu-class_3.cpp)]  
...
### Example  
 The following code is from the MFC [CTRLTEST](../VS_csharp/visual-c---samples.md) sample:  
  
 [!code[NVC_MFCWindowing#24](../VS_csharp/codesnippet/CPP/cmenu-class_4.cpp)]  
...
### Example  
 [!code[NVC_MFCWindowing#25](../VS_csharp/codesnippet/CPP/cmenu-class_5.cpp)]  
...
### Remarks  
 This member function implements the behavior of the Win32 function                         [GetMenuDefaultItem](http://msdn.microsoft.com/library/windows/desktop/ms647976), as described in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Parameters  
 ...
 `lpMenuItemInfo`  
 A pointer to a                                 [MENUITEMINFO](http://msdn.microsoft.com/library/windows/desktop/ms647578), as described in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)], that contains information about the menu.  
...
### Return Value  
 If the function succeeds, the return value is nonzero. If the function fails, the return value is zero. To get extended error information, use the Win32 function                         [GetLastError](http://msdn.microsoft.com/library/windows/desktop/ms679360), as described in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
  
### Remarks  
 This member function implements the behavior of the of the Win32 function                         [GetMenuItemInfo](http://msdn.microsoft.com/library/windows/desktop/ms647980), as described in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)]. Note that in the MFC implementation of `GetMenuItemInfo`, you do not use a handle to a menu.  
  
### Example  
 [!code[NVC_MFCWindowing#26](../VS_csharp/codesnippet/CPP/cmenu-class_6.cpp)]  
...
### Example  
 [!code[NVC_MFCWindowing#27](../VS_csharp/codesnippet/CPP/cmenu-class_7.cpp)]  
...
### Example  
 [!code[NVC_MFCWindowing#28](../VS_csharp/codesnippet/CPP/cmenu-class_8.cpp)]  
...
### Parameters  
 `uItem`  
 See description of `uItem` in                                 [InsertMenuItem](http://msdn.microsoft.com/library/windows/desktop/ms647988) in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
  
 `lpMenuItemInfo`  
 See description of `lpmii` in **InsertMenuItem** in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
  
 `fByPos`  
 See description of `fByPosition` in **InsertMenuItem** in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
  
### Remarks  
 This function wraps                         [InsertMenuItem](http://msdn.microsoft.com/library/windows/desktop/ms647988), described in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Example  
 [!code[NVC_MFCWindowing#29](../VS_csharp/codesnippet/CPP/cmenu-class_9.cpp)]  
...
### Example  
 [!code[NVC_MFCWindowing#30](../VS_csharp/codesnippet/CPP/cmenu-class_10.cpp)]  
...
### Example  
 ...
 [!code[NVC_MFCWindowing#31](../VS_csharp/codesnippet/CPP/cmenu-class_11.cpp)]  
...
### Remarks  
 This member function implements the behavior of the Win32 function                         [SetMenuDefaultItem](http://msdn.microsoft.com/library/windows/desktop/ms647996), as described in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Example  
 [!code[NVC_MFCWindowing#32](../VS_csharp/codesnippet/CPP/cmenu-class_12.cpp)]  
  
 [!code[NVC_MFCWindowing#33](../VS_csharp/codesnippet/CPP/cmenu-class_13.cpp)]  
...
### Parameters  
 `uItem`  
 See description of `uItem` in                                 [SetMenuItemInfo](http://msdn.microsoft.com/library/windows/desktop/ms648001) in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
  
 `lpMenuItemInfo`  
 See description of `lpmii` in **SetMenuItemInfo** in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
  
 `fByPos`  
 See description of `fByPosition` in **SetMenuItemInfo** in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
  
### Remarks  
 This function wraps                         [SetMenuItemInfo](http://msdn.microsoft.com/library/windows/desktop/ms648001), described in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Return Value  
 This method returns the result of calling                         [TrackPopupMenu](http://msdn.microsoft.com/library/windows/desktop/ms648002) in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
  
### Remarks  
 A floating pop-up menu can appear anywhere on the screen.  
  
### Example  
 [!code[NVC_MFCWindowing#34](../VS_csharp/codesnippet/CPP/cmenu-class_14.cpp)]  
...
## See Also  
 ...
 [MFC Sample DYNAMENU](../VS_csharp/visual-c---samples.md)   
