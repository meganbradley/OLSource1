...
## Example  
 The following code example illustrates an `assembly` element in a deployment manifest for an application deployed using [!INCLUDE[ndptecclick](../VS_csharp/includes/ndptecclick_md.md)]. This code example is part of a larger example provided for the [ClickOnce Deployment Manifest](../VS_csharp/clickonce-deployment-manifest.md) topic.  
...
## See Also  
 ...
 [<assembly\> Element (ClickOnce Application)](../VS_csharp/-assembly--element--clickonce-application-.md)