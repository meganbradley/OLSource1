...
The syntax for declaring an explicit override of an interface member within a class has changed from Managed Extensions for C++ to [!INCLUDE[cpp_current_long](../VS_csharp/includes/cpp_current_long_md.md)].  
...
## See Also  
 ...
 [Explicit Overrides](../VS_csharp/explicit-overrides---c---component-extensions-.md)