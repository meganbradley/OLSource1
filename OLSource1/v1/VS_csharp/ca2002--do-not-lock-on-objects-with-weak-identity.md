...
## Example  
 ...
 [!code[FxCop.Reliability.LockWeakObjects#1](../VS_csharp/codesnippet/VisualBasic/ca2002--do-not-lock-on-objects-with-weak-identity_1.vb)]
[!code[FxCop.Reliability.LockWeakObjects#1](../VS_csharp/codesnippet/CSharp/ca2002--do-not-lock-on-objects-with-weak-identity_1.cs)]  
  
## See Also  
 <xref:System.Threading.Monitor*>   
 <xref:System.AppDomain*>   
 [C# Lock Statement](../VS_csharp/lock-statement--csharp-reference-.md)   
 [Visual Basic SyncLock Statement](../VS_csharp/synclock-statement.md)