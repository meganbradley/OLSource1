...
>  In C# the [#define](../VS_csharp/sharpdefine--csharp-reference-.md) preprocessor directive cannot be used to define constants in the way that is typically used in C and C++.  
 ...
 To define constant values of integral types (`int`, `byte`, and so on) use an enumerated type. For more information, see [enum](../VS_csharp/enum--csharp-reference-.md).  
