...
#### Parameters  
 ...
 `BindingVector`  
 Storage unit for column information. The default is [CAtlMap](../VS_csharp/catlmap-class.md) where the key element is an **HACCESSOR** value and the value element is a pointer to a `BindType` structure.  
...
|||  
|-|-|  
|[IAccessorImpl](../VS_csharp/iaccessorimpl-class.md)|The constructor.|  
  
### Interface Methods  
  
|||  
|-|-|  
|[AddRefAccessor](../VS_csharp/iaccessorimpl--addrefaccessor.md)|Adds a reference count to an existing accessor.|  
|[CreateAccessor](../VS_csharp/iaccessorimpl--createaccessor.md)|Creates an accessor from a set of bindings.|  
|[GetBindings](../VS_csharp/iaccessorimpl--getbindings.md)|Returns the bindings in an accessor.|  
|[ReleaseAccessor](../VS_csharp/iaccessorimpl--releaseaccessor.md)|Releases an accessor.|  
