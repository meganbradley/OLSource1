...
To add a class in a Visual C++ project, in **Solution Explorer**, right-click the project, click **Add**, and then click **Class**. This opens the [Add Class Dialog Box](../VS_csharp/add-class-dialog-box.md) dialog box.  
...
-   For more information about how to create MFC classes, see [MFC Class](../VS_csharp/adding-an-mfc-class.md).  
  
-   For more information about how to create ATL classes, see [ATL Simple Object](../VS_csharp/adding-an-atl-simple-object.md).  
  
> [!NOTE]
>  The template **Add ATL Support to MFC** does not create a class, but instead configures the project to use ATL. For more information, see [Adding ATL Support to Your MFC project](../VS_csharp/adding-atl-support-to-your-mfc-project.md).  
  
 To make a C++ class that does not use MFC, ATL, or CLR, use the **C++ Class** template in the **C++** group of installed templates. For more information, see [Adding a Generic C++ Class](../VS_csharp/adding-a-generic-c---class.md).  
  
 Two kinds of form-based C++ classes are available. The first one, [CFormView Class](../VS_csharp/cformview-class.md) creates an MFC class. The second one creates a CLR Windows Forms class.  
  
## See Also  
 [Creating a Forms-Based MFC Application](../VS_csharp/creating-a-forms-based-mfc-application.md)   
 [Add Class Dialog Box](../VS_csharp/add-class-dialog-box.md)   
