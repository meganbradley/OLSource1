...
ms.topic: "article"
f1_keywords: 
  - "amp/Concurrency::extent::operator(mod)="
dev_langs: 
  - "C++"
helpviewer_keywords: 
  - "operator%="
...
Calculates the modulus (remainder) of each element in the [extent](../VS_csharp/extent-class--c---amp-.md) when that element is divided by a number.  
