 ...
 **Precondition:** `0.0 ≤ p ≤ 1.0`  
 ...
 For more information and a code example, see [bernoulli_distribution Class](../VS_csharp/binomial_distribution-class.md).  
...
### Parameters  
 See parent topic [bernoulli_distribution Class](../VS_csharp/bernoulli_distribution-class.md).  
