...
-   All [symbols](../VS_csharp/symbols--resource-identifiers.md) must be unique within the scope of the application. This prevents conflicting symbol definitions in the header files.  
...
## See Also  
 [Changing a Symbol or Symbol Name (ID)](../VS_csharp/changing-a-symbol-or-symbol-name--id-.md)   
