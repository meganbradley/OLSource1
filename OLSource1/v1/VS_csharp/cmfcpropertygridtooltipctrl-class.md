...
---
# CMFCPropertyGridToolTipCtrl Class
Implements a tooltip control that the [CMFCPropertyGridCtrl Class](../VS_csharp/cmfcpropertygridctrl-class.md) uses to display tooltips.  
...
## Remarks  
 Tooltips are displayed when the pointer rests on a property name. The [CMFCPropertyGridToolTipCtrl](../VS_csharp/cmfcpropertygridtooltipctrl-class.md) class displays a tooltip so that it is easily readable by the user. Usually, the position of a tooltip is determined by the position of the pointer. By using this class, the tooltip appears over the property name and resembles the natural property extension, so that the property name is fully visible.  
  
 MFC automatically creates this control and uses it in the [CMFCPropertyGridCtrl Class](../VS_csharp/cmfcpropertygridctrl-class.md).  
...
## Example  
 ...
 [!code[NVC_MFC_RibbonApp#23](../VS_csharp/codesnippet/CPP/cmfcpropertygridtooltipctrl-class_1.cpp)]  
...
## Inheritance Hierarchy  
 ...
 [CMFCPropertyGridToolTipCtrl](../VS_csharp/cmfcpropertygridtooltipctrl-class.md)  
