...
## Remarks  
 ...
 For more information on using `CProgressCtrl`, see [Controls](../VS_csharp/controls--mfc-.md) and [Using CProgressCtrl](../VS_csharp/using-cprogressctrl.md).  
...
### Example  
 [!code[NVC_MFC_CProgressCtrl#1](../VS_csharp/codesnippet/CPP/cprogressctrl-class_1.cpp)]  
...
### Parameters  
 `dwStyle`  
 Specifies the progress bar control's style. Apply any combination of window stylesdescribed in                                 [CreateWindow](http://msdn.microsoft.com/library/windows/desktop/ms632679) in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)], in addition to the following progress bar control styles, to the control:  
...
### Example  
 [!code[NVC_MFC_CProgressCtrl#2](../VS_csharp/codesnippet/CPP/cprogressctrl-class_2.cpp)]  
...
### Parameters  
 ...
 `dwStyle`  
 Specifies the progress bar control's style. Apply any combination of window styles described in                                 [CreateWindow](http://msdn.microsoft.com/library/windows/desktop/ms632679) in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Remarks  
 This method sends the                         [PBM_GETBARCOLOR](http://msdn.microsoft.com/library/windows/desktop/bb760826) message, which is described in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Remarks  
 This method sends the                         [PBM_GETBKCOLOR](http://msdn.microsoft.com/library/windows/desktop/bb760828) message, which is described in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Example  
 [!code[NVC_MFC_CProgressCtrl#3](../VS_csharp/codesnippet/CPP/cprogressctrl-class_3.cpp)]  
...
### Example  
 [!code[NVC_MFC_CProgressCtrl#4](../VS_csharp/codesnippet/CPP/cprogressctrl-class_4.cpp)]  
...
### Remarks  
 This method sends the                         [PBM_GETSTATE](http://msdn.microsoft.com/library/windows/desktop/bb760834) message, which is described in the                        [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Example  
 ...
 [!code[NVC_MFC_CProgressCtrl_s1#9](../VS_csharp/codesnippet/CPP/cprogressctrl-class_5.h)]  
  
### Example  
 The following code example retrieves the state of the current progress bar control.  
  
 [!code[NVC_MFC_CProgressCtrl_s1#5](../VS_csharp/codesnippet/CPP/cprogressctrl-class_6.cpp)]  
...
### Remarks  
 ...
 This method sends the                         [PBM_GETSTEP](http://msdn.microsoft.com/library/windows/desktop/bb760836) message, which is described in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Example  
 ...
 [!code[NVC_MFC_CProgressCtrl_s1#3](../VS_csharp/codesnippet/CPP/cprogressctrl-class_7.cpp)]  
...
### Example  
 [!code[NVC_MFC_CProgressCtrl#5](../VS_csharp/codesnippet/CPP/cprogressctrl-class_8.cpp)]  
...
### Remarks  
 The `SetBarColor` method sets the progress bar color only if a [!INCLUDE[windowsver](../VS_csharp/includes/windowsver_md.md)][theme](https://msdn.microsoft.com/en-us/library/windows/desktop/hh270423.aspx) is not in effect.  
  
 This method sends the                         [PBM_SETBARCOLOR](http://msdn.microsoft.com/library/windows/desktop/bb760838) message, which is described in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Example  
 ...
 [!code[NVC_MFC_CProgressCtrl_s1#1](../VS_csharp/codesnippet/CPP/cprogressctrl-class_9.cpp)]  
...
### Example  
 [!code[NVC_MFC_CProgressCtrl#6](../VS_csharp/codesnippet/CPP/cprogressctrl-class_10.cpp)]  
...
### Remarks  
 ...
 This method sends the                         [PBM_SETMARQUEE](http://msdn.microsoft.com/library/windows/desktop/bb760842) message, which is described in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Example  
 ...
 [!code[NVC_MFC_CProgressCtrl_s1#2](../VS_csharp/codesnippet/CPP/cprogressctrl-class_11.cpp)]  
...
### Example  
 [!code[NVC_MFC_CProgressCtrl#7](../VS_csharp/codesnippet/CPP/cprogressctrl-class_12.cpp)]  
...
### Example  
 [!code[NVC_MFC_CProgressCtrl#8](../VS_csharp/codesnippet/CPP/cprogressctrl-class_13.cpp)]  
...
### Remarks  
 This method sends the                         [PBM_SETSTATE](http://msdn.microsoft.com/library/windows/desktop/bb760850) message, which is described in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Example  
 ...
 [!code[NVC_MFC_CProgressCtrl_s1#4](../VS_csharp/codesnippet/CPP/cprogressctrl-class_14.cpp)]  
...
### Example  
 [!code[NVC_MFC_CProgressCtrl#9](../VS_csharp/codesnippet/CPP/cprogressctrl-class_15.cpp)]  
...
### Example  
 [!code[NVC_MFC_CProgressCtrl#10](../VS_csharp/codesnippet/CPP/cprogressctrl-class_16.cpp)]  
