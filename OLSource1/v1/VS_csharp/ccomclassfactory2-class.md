...
## Remarks  
 ...
 ATL objects normally acquire a class factory by deriving from [CComCoClass](../VS_csharp/ccomcoclass-class.md). This class includes the macro [DECLARE_CLASSFACTORY](../VS_csharp/declare_classfactory.md), which declares [CComClassFactory](../VS_csharp/ccomclassfactory-class.md) as the default class factory. To use `CComClassFactory2`, specify the [DECLARE_CLASSFACTORY2](../VS_csharp/declare_classfactory2.md) macro in your object's class definition. For example:  
  
 [!code[NVC_ATL_COM#2](../VS_csharp/codesnippet/CPP/ccomclassfactory2-class_1.h)]  
 ...
 **CMyLicense**, the template parameter to `CComClassFactory2`, must implement the static functions `VerifyLicenseKey`, `GetLicenseKey`, and `IsLicenseValid`. The following is an example of a simple license class:  
 ...
 [!code[NVC_ATL_COM#3](../VS_csharp/codesnippet/CPP/ccomclassfactory2-class_2.h)]  
