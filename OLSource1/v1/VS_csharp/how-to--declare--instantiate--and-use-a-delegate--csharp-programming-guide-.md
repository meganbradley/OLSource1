...
In C# 1.0 and later, delegates can be declared as shown in the following example.  
 ...
 [!code[csProgGuideDelegates#13](../VS_csharp/codesnippet/CSharp/how-to--declare--instantiate--and-use-a-delegate--csharp-programming-guide-_1.cs)]  
  
 [!code[csProgGuideDelegates#14](../VS_csharp/codesnippet/CSharp/how-to--declare--instantiate--and-use-a-delegate--csharp-programming-guide-_2.cs)]  
  
 C# 2.0 provides a simpler way to write the previous declaration, as shown in the following example.  
  
 [!code[csProgGuideDelegates#32](../VS_csharp/codesnippet/CSharp/how-to--declare--instantiate--and-use-a-delegate--csharp-programming-guide-_3.cs)]  
  
 In C# 2.0 and later, it is also possible to use an anonymous method to declare and initialize a [delegate](../VS_csharp/delegate--csharp-reference-.md), as shown in the following example.  
  
 [!code[csProgGuideDelegates#15](../VS_csharp/codesnippet/CSharp/how-to--declare--instantiate--and-use-a-delegate--csharp-programming-guide-_4.cs)]  
 ...
 [!code[csProgGuideDelegates#31](../VS_csharp/codesnippet/CSharp/how-to--declare--instantiate--and-use-a-delegate--csharp-programming-guide-_5.cs)]  
  
 For more information, see [Lambda Expressions (C# Programming Guide)](../VS_csharp/lambda-expressions--csharp-programming-guide-.md).  
...
## Example  
 [!code[csProgGuideDelegates#12](../VS_csharp/codesnippet/CSharp/how-to--declare--instantiate--and-use-a-delegate--csharp-programming-guide-_6.cs)]  
...
-   Declaring a delegate.  
     ...
     [!code[csProgGuideDelegates#16](../VS_csharp/codesnippet/CSharp/how-to--declare--instantiate--and-use-a-delegate--csharp-programming-guide-_7.cs)]  
...
-   Instantiating a delegate.  
     ...
     [!code[csProgGuideDelegates#17](../VS_csharp/codesnippet/CSharp/how-to--declare--instantiate--and-use-a-delegate--csharp-programming-guide-_8.cs)]  
  
     This creates a new delegate object associated with the [static](../VS_csharp/static--csharp-reference-.md) method `Test.PrintTitle`. Similarly, the non-static method `AddBookToTotal` on the object `totaller` is passed as in the following example:  
  
     [!code[csProgGuideDelegates#18](../VS_csharp/codesnippet/CSharp/how-to--declare--instantiate--and-use-a-delegate--csharp-programming-guide-_9.cs)]  
...
-   Calling a delegate.  
     ...
     [!code[csProgGuideDelegates#19](../VS_csharp/codesnippet/CSharp/how-to--declare--instantiate--and-use-a-delegate--csharp-programming-guide-_10.cs)]  
