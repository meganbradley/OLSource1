...
Returns the greatest of all elements of the list, compared by using [Operators.max](../VS_csharp/operators.max--t--function--fsharp-.md) on the function result.  
...
## Example  
 ...
 [!code[FsLists#56](../VS_csharp/codesnippet/FSharp/list.maxby--t--u--function--fsharp-_1.fs)]  
