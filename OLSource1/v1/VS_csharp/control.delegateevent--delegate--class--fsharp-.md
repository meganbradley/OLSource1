...
|Member|Description|  
|------------|-----------------|  
|[new](../VS_csharp/control.delegateevent--delegate--constructor--fsharp-.md)|Creates an event object suitable for implementing an arbitrary type of delegate.|  
  
## Instance Members  
  
|Member|Description|  
|------------|-----------------|  
|[Publish](../VS_csharp/delegateevent.publish--delegate--property--fsharp-.md)|Publishes the event as a first class event value.|  
|[Trigger](../VS_csharp/delegateevent.trigger--delegate--method--fsharp-.md)|Triggers the event using the given parameters.|  
