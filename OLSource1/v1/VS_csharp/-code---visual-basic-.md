...
## Remarks  
 Use the `<code>` tag to indicate multiple lines as code. Use [<c\> (Visual Basic)](../VS_csharp/-c---visual-basic-.md) to indicate that text within a description should be marked as code.  
...
## Example  
 ...
 [!code[VbVbcnXmlDocComments#2](../VS_csharp/codesnippet/VisualBasic/-code---visual-basic-_1.vb)]  
