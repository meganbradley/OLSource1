...
|[traits_type](../VS_csharp/istream_iterator-class.md#istream_iterator__traits_type)|A type that provides for the character traits type of the `istream_iterator`.|  
...
## See Also  
 [iterator Class](../VS_csharp/iterator-struct.md)   
