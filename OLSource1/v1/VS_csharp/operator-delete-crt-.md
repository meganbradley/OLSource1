...
## Remarks  
 This form of **operator delete** is known as vector delete, in contrast to the scalar delete form ([operator delete](../VS_csharp/operator-delete--crt-.md)).  
  
 **operator** `delete[]` frees memory allocated by [operator new&#91;&#93;](../VS_csharp/operator-new-crt-.md).  
...
## Example  
 See [operator new&#91;&#93;](../VS_csharp/operator-new-crt-.md) for examples of using operator **delete**.  
