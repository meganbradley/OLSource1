...
##  <a name="_core_writing_the_message.2d.map_entry"></a> Writing the Message-Map Entry  
 ...
 [!code[NVC_MFCMessageHandling#6](../VS_csharp/codesnippet/CPP/handlers-for-message-map-ranges_1.cpp)]  
  
 The message-map entry consists of the following items:  
  
-   The message-map range macro:  
  
    -   [ON_COMMAND_RANGE](../VS_csharp/on_command_range.md)  
  
    -   [ON_UPDATE_COMMAND_UI_RANGE](../VS_csharp/on_update_command_ui_range.md)  
  
    -   [ON_CONTROL_RANGE](../VS_csharp/on_control_range.md)  
...
##  <a name="_core_declaring_the_handler_function"></a> Declaring the Handler Function  
 ...
 [!code[NVC_MFCMessageHandling#7](../VS_csharp/codesnippet/CPP/handlers-for-message-map-ranges_2.h)]  
...
##  <a name="_core_example_for_a_range_of_command_ids"></a> Example for a Range of Command IDs  
 When might you use ranges? One example is in handling commands like the Zoom command in the MFC sample [HIERSVR](../VS_csharp/visual-c---samples.md). This command zooms the view, scaling it between 25% and 300% of its normal size. HIERSVR's view class uses a range to handle the Zoom commands with a message-map entry resembling this:  
  
 [!code[NVC_MFCMessageHandling#8](../VS_csharp/codesnippet/CPP/handlers-for-message-map-ranges_3.cpp)]  
...
-   The name of the handler function for the commands.  
 ...
 [!code[NVC_MFCMessageHandling#9](../VS_csharp/codesnippet/CPP/handlers-for-message-map-ranges_4.h)]  
...
##  <a name="_core_example_for_a_range_of_control_ids"></a> Example for a Range of Control IDs  
 ...
 [!code[NVC_MFCMessageHandling#10](../VS_csharp/codesnippet/CPP/handlers-for-message-map-ranges_5.cpp)]  
...
-   The name of the message handler function.  
 ...
 [!code[NVC_MFCMessageHandling#11](../VS_csharp/codesnippet/CPP/handlers-for-message-map-ranges_6.cpp)]  
...
## See Also  
 [Declaring Message Handler Functions](../VS_csharp/declaring-message-handler-functions.md)