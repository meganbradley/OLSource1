...
## In This Section  
 ...
 [Command Handling](../VS_csharp/command-handling.md)  
 Details command handling in editors.  
  
 [Context Menus](../VS_csharp/context-menus.md)  
 Describes editor context menus.  
  
 [How to: Update the Status Bar](../VS_csharp/how-to--update-the-status-bar.md)  
