...
### Remarks  
 ...
 The framework uses this class to display the picture area in an image editor dialog box. For more information about the image editor dialog box, see [CMFCImageEditorDialog Class](../VS_csharp/cmfcimageeditordialog-class.md).  
...
## Example  
 ...
 [!code[NVC_MFC_RibbonApp#37](../VS_csharp/codesnippet/CPP/cmfcimagepaintarea-class_1.cpp)]  
...
## Inheritance Hierarchy  
 ...
 [CMFCImagePaintArea](../VS_csharp/cmfcimagepaintarea-class.md)  
...
### Remarks  
 ...
 The drawing color is used by the image editor dialog box for all drawing modes except for `IMAGE_EDIT_MODE_COLOR`. For more information about drawing modes, see [CMFCImagePaintArea::IMAGE_EDIT_MODE Enumeration](../VS_csharp/cmfcimagepaintarea--image_edit_mode-enumeration.md).  
