...
```  
 ...
 The <xref:System.Linq.Enumerable.Where*> method is an extension method. For more information, see [Extension Methods](../VS_csharp/extension-methods--csharp-programming-guide-.md). Because <xref:System.Linq.Enumerable.Where*> is an extension method, the query above is compiled as though it were written as follows:  
...
## See Also  
 [Performance (LINQ to XML) (Visual Basic)](../VS_csharp/performance--linq-to-xml---visual-basic-.md)