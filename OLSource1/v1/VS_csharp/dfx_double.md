...
helpviewer_keywords: 
  ...
  - "Double float data, exchanging with data source"
...
---
# DFX_Double
Transfers **double float** data between the field data members of a [CDaoRecordset](../VS_csharp/cdaorecordset-class.md) object and the columns of a record on the data source.  
