...
## Remarks  
 ...
 For more information on `CBrush`, see [Graphic Objects](../VS_csharp/graphic-objects.md).  
...
### Remarks  
 ...
 The constructor with a `CBitmap` parameter constructs a patterned brush. The parameter identifies a bitmap. The bitmap is assumed to have been created by using [CBitmap::CreateBitmap](../VS_csharp/cbitmap-class.md#cbitmap__createbitmap), [CBitmap::CreateBitmapIndirect](../VS_csharp/cbitmap-class.md#cbitmap__createbitmapindirect), [CBitmap::LoadBitmap](../VS_csharp/cbitmap-class.md#cbitmap__loadbitmap), or [CBitmap::CreateCompatibleBitmap](../VS_csharp/cbitmap-class.md#cbitmap__createcompatiblebitmap). The minimum size for a bitmap to be used in a fill pattern is 8 pixels by 8 pixels.  
  
### Example  
 [!code[NVC_MFCDocView#21](../VS_csharp/codesnippet/CPP/cbrush-class_1.cpp)]  
...
### Example  
 [!code[NVC_MFCDocView#22](../VS_csharp/codesnippet/CPP/cbrush-class_2.cpp)]  
 ...
 *nUsage*  
 Specifies whether the **bmiColors[]** fields of the [BITMAPINFO](../VS_csharp/bitmapinfo-structure.md) data structure (a part of the "packed DIB") contain explicit RGB values or indices into the currently realized logical palette. The parameter must be one of the following values:  
...
-   In the second version, it is not necessary to call **GlobalAlloc** to allocate memory for the packed DIB.  
 ...
 For information about using the following Windows functions, see the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)]:  
...
### Example  
 [!code[NVC_MFCDocView#23](../VS_csharp/codesnippet/CPP/cbrush-class_3.cpp)]  
...
-   `HS_VERTICAL` Vertical hatch  
 ...
 `crColor`  
 Specifies the foreground color of the brush as an RGB color (the color of the hatches). See                                 [COLORREF](http://msdn.microsoft.com/library/windows/desktop/dd183449) in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)] for more information.  
...
### Example  
 [!code[NVC_MFCDocView#24](../VS_csharp/codesnippet/CPP/cbrush-class_4.cpp)]  
...
### Remarks  
 The brush can subsequently be selected for any device context that supports raster operations. The bitmap identified by `pBitmap` is typically initialized by using the [CBitmap::CreateBitmap](../VS_csharp/cbitmap-class.md#cbitmap__createbitmap), [CBitmap::CreateBitmapIndirect](../VS_csharp/cbitmap-class.md#cbitmap__createbitmapindirect), [CBitmap::LoadBitmap](../VS_csharp/cbitmap-class.md#cbitmap__loadbitmap), or [CBitmap::CreateCompatibleBitmap](../VS_csharp/cbitmap-class.md#cbitmap__createcompatiblebitmap) function.  
 ...
 For information about using                         [CreatePatternBrush](http://msdn.microsoft.com/library/windows/desktop/dd183508), a Windows function, see the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
  
### Example  
 [!code[NVC_MFCDocView#25](../VS_csharp/codesnippet/CPP/cbrush-class_5.cpp)]  
...
### Parameters  
 `nIndex`  
 Specifies a color index. This value corresponds to the color used to paint one of the 21 window elements. See                                 [GetSysColor](http://msdn.microsoft.com/library/windows/desktop/ms724371) in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)] for a list of values.  
...
### Example  
 [!code[NVC_MFCDocView#26](../VS_csharp/codesnippet/CPP/cbrush-class_6.cpp)]  
...
### Example  
 [!code[NVC_MFCDocView#27](../VS_csharp/codesnippet/CPP/cbrush-class_7.cpp)]  
...
### Example  
 [!code[NVC_MFCDocView#28](../VS_csharp/codesnippet/CPP/cbrush-class_8.cpp)]  
  
## See Also  
 [MFC Sample PROPDLG](../VS_csharp/visual-c---samples.md)   
 [Base Class](../VS_csharp/cgdiobject-class.md)   
 [Hierarchy Chart](../VS_csharp/hierarchy-chart.md)   
 [CBitmap](../VS_csharp/cbitmap-class.md)   
