...
apitype: "Assembly"
f1_keywords: 
  - "Microsoft.FSharp.Linq.QueryBuilder.Run``1"
dev_langs: 
  - "FSharp"
helpviewer_keywords: 
  - "Run method [F#]"
ms.assetid: 33bbcef1-2a4a-45cb-9105-01aa0082cfc9
...
#### Parameters  
 `source`  
 Type: [Expr](../VS_csharp/quotations.expr--t--class--fsharp-.md)<[QuerySource](../VS_csharp/linq.querysource--t--q--class--fsharp-.md)<'T,                        <xref:System.Linq.IQueryable*>>>  
