...
## Microsoft Specific  
 ...
 For more information on the MBCS environment, see [Single-byte and Multibyte Character Sets](../VS_csharp/single-byte-and-multibyte-character-sets.md) in the *Run-Time Library Reference.*  
