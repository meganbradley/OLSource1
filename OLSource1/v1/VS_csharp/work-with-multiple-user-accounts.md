...
### Access your Azure account in Server Explorer  
 ...
 ![Server Explorer showing Azure Tools node expanded](../VS_csharp/media/vs2015_serverexplorer.png "VS2015_ServerExplorer")  
 ...
 ![Manage Azure Subscriptions dialog](../VS_csharp/media/vs2015_manage_subs.png "vs2015_manage_subs")  
...
###  <a name="access_azure"></a> Access Azure Active Directory in a Web project  
 ...
 ![Change authentication dialog for ASP.NET](../VS_csharp/media/vs2015_change_authentication.png "VS2015_change_authentication")  
...
## Add a second user account to Visual Studio  
 ...
 ![Visual Studio account picker](../VS_csharp/media/vs2015_acct_picker.png "VS2015_acct_picker")  
