...
'type': a parameter cannot have a type that contains 'auto'  
 ...
 A method or template parameter cannot be declared with the `auto` keyword if the default [/Zc:auto](../VS_csharp/-zc-auto--deduce-variable-type-.md) compiler option is in effect.  
