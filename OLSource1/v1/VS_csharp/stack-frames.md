...
-   Is represented by an [IDebugStackFrame2](../VS_csharp/idebugstackframe2.md) interface, typically created by a debug engine (DE) or virtual machine as a consequence of executing a thread.  
