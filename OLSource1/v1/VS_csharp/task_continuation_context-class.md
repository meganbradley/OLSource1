...
|Name|Description|  
|----------|-----------------|  
|[task_continuation_context::get_current_winrt_context](../VS_csharp/task_continuation_context--get_current_winrt_context-method.md)|Returns a task continuation context object that represents the current winrt thread context.|  
...
|[task_continuation_context::use_synchronous_execution](../VS_csharp/task_continuation_context--use_synchronous_execution-method.md)|Returns a task continuation context object that represents the synchronous execution context.|  
