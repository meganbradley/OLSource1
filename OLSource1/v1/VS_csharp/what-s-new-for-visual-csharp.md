 ...
 **Function Members with Expression Bodies**  
 You can declare members with expression-bodies of code in the same lightweight syntax you use with lambda expressions.  See [methods](../VS_csharp/methods--csharp-programming-guide-.md), [properties](../VS_csharp/properties--csharp-programming-guide-.md), [indexers](../VS_csharp/indexers--csharp-programming-guide-.md), and [operators](../VS_csharp/overloadable-operators--csharp-programming-guide-.md).  
