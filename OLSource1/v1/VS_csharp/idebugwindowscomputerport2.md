...
|Method|Description|  
|------------|-----------------|  
|[IDebugWindowsComputerPort2::GetComputerInfo](../VS_csharp/idebugwindowscomputerport2--getcomputerinfo.md)|Retrieves information about the computer on which the debugger in running.|  
