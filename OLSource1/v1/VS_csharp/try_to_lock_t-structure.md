...
Represents a `struct` that defines a [try_to_lock](../VS_csharp/-mutex--functions.md#try_to_lock_variable) object. Used to select one of the overloaded constructors of [unique_lock](../VS_csharp/unique_lock-class.md).  
