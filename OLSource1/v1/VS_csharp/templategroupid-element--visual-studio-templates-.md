...
---
# TemplateGroupID Element (Visual Studio Templates)
Specifies what kind of project an item templates will show up in. This element is significant when [ShowByDefault (Visual Studio Templates)](../VS_csharp/showbydefault--visual-studio-templates-.md) is set to `false`. When [ShowByDefault (Visual Studio Templates)](../VS_csharp/showbydefault--visual-studio-templates-.md) is set to `true`, then an item template is available in all project types.  
