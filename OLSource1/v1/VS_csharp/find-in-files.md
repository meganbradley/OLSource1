...
## Find options  
 ...
 If this check box is selected, you can use special notations to define patterns of text to match in the **Find what** or **Replace with** text boxes. For a list of these notations, see [Using Regular Expressions in Visual Studio](../VS_csharp/using-regular-expressions-in-visual-studio.md).  
...
## See Also  
 [Findng and Replacing Text](../VS_csharp/finding-and-replacing-text.md)   
 [Replace in Files Tab, Find and Replace Window](../VS_csharp/replace-in-files.md)   
