...
**Microsoft Specific**  
 ...
 The most complete and up-to-date information on this topic can be found in [dllexport, dllimport](../VS_csharp/dllexport--dllimport.md).  
...
```  
 ...
 For specific information about the syntax for extended storage-class modifiers, see [Extended Storage-Class Attributes](../VS_csharp/c-extended-storage-class-attributes.md).  
