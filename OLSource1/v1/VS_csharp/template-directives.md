...
---
# Template Directives
You can use the following template directives in a wizard [template file](../VS_csharp/template-files.md) and the [Templates.inf file](../VS_csharp/templates.inf-file.md) to customize the wizard.  
