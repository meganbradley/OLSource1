...
This example shows how to use the [concurrency::parallel_for_each](../VS_csharp/parallel_for_each-function.md) algorithm to compute the count of prime numbers in a [std::array](../VS_csharp/array-class--stl-.md) object in parallel.  
...
## Example  
 ...
 [!code[concrt-parallel-count-primes#1](../VS_csharp/codesnippet/CPP/how-to--write-a-parallel_for_each-loop_1.cpp)]  
