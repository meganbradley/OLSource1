...
## Remarks  
 `CHeapPtr` is derived from                 [CHeapPtrBase](../VS_csharp/cheapptrbase-class.md) and by default uses the CRT routines (in                 [CCRTAllocator](../VS_csharp/ccrtallocator-class.md)) to allocate and free memory. The class                 [CHeapPtrList](../VS_csharp/cheapptrlist-class.md) may be used to construct a list of heap pointers. See also                 [CComHeapPtr](../VS_csharp/ccomheapptr-class.md), which uses COM memory allocation routines.  
...
### Example  
 [!code[NVC_ATL_Utilities#77](../VS_csharp/codesnippet/CPP/cheapptr-class_1.cpp)]  
...
### Example  
 [!code[NVC_ATL_Utilities#78](../VS_csharp/codesnippet/CPP/cheapptr-class_2.cpp)]  
...
### Example  
 [!code[NVC_ATL_Utilities#80](../VS_csharp/codesnippet/CPP/cheapptr-class_3.cpp)]  
...
### Example  
 [!code[NVC_ATL_Utilities#79](../VS_csharp/codesnippet/CPP/cheapptr-class_4.cpp)]  
  
## See Also  
 [CHeapPtrBase Class](../VS_csharp/cheapptrbase-class.md)   
 [CCRTAllocator Class](../VS_csharp/ccrtallocator-class.md)   
