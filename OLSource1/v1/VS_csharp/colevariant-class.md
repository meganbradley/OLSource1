...
>  This class is derived from the **VARIANT** structure. This means you can pass a `COleVariant` in a parameter that calls for a **VARIANT** and that the data members of the **VARIANT** structure are accessible data members of `COleVariant`.  
 ...
 The two related MFC classes [COleCurrency](../VS_csharp/colecurrency-class.md) and [COleDateTime](../VS_csharp/coledatetime-class.md) encapsulate the variant data types **CURRENCY** ( `VT_CY`) and **DATE** ( `VT_DATE`). The `COleVariant` class is used extensively in the DAO classes; see these classes for typical usage of this class, for example [CDaoQueryDef](../VS_csharp/cdaoquerydef-class.md) and [CDaoRecordset](../VS_csharp/cdaorecordset-class.md).  
  
 For more information, see the [VARIANT](assetId:///e305240e-9e11-4006-98cc-26f4932d2118), [CURRENCY](assetId:///5e81273c-7289-45c7-93c0-32c1553f708e), [DISPPARAMS](assetId:///a16e5a21-766e-4287-b039-13429aa78f8b), and [IDispatch::Invoke](assetId:///964ade8e-9d8a-4d32-bd47-aa678912a54d) entries in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
  
 For more information on the `COleVariant` class and its use in OLE automation, see "Passing Parameters in OLE Automation" in the article [Automation](../VS_csharp/automation.md).  
...
### Remarks  
 ...
 For more information, see the [VARIANT](assetId:///e305240e-9e11-4006-98cc-26f4932d2118) and [VARTYPE](assetId:///317b911b-1805-402d-a9cb-159546bc88b4) entries in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
 ...
 *varSrc*  
 ...
 `strSrc`  
 A [CString](../VS_csharp/cstringt-class.md) object to be copied into the new `COleVariant` object.  
 ...
 `curSrc`  
 A [COleCurrency](../VS_csharp/colecurrency-class.md) object to be copied into the new `COleVariant` object.  
  
 `fltSrc`, `dblSrc`  
 A numerical value to be copied into the new `COleVariant` object.  
  
 `timeSrc`  
 A [COleDateTime](../VS_csharp/coledatetime-class.md) object to be copied into the new `COleVariant` object.  
  
 `arrSrc`  
 A [CByteArray](../VS_csharp/cbytearray-class.md) object to be copied into the new `COleVariant` object.  
  
 `lbSrc`  
 A [CLongBinary](../VS_csharp/clongbinary-class.md) object to be copied into the new `COleVariant` object.  
...
### Remarks  
 For more information, see the [VARIANT](assetId:///e305240e-9e11-4006-98cc-26f4932d2118), [VARTYPE](assetId:///317b911b-1805-402d-a9cb-159546bc88b4), and [VariantChangeType](assetId:///48a51e32-95d7-4eeb-8106-f5043ffa2fd1) entries in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Remarks  
 ...
 For more information, see the `VARIANT`, `VARTYPE`, and `VariantClear` entries in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
>  After calling **Detach**, it is the caller's responsibility to call **VariantClear** on the resulting **VARIANT** structure.  
 ...
 For more information, see the [VARIANT](assetId:///e305240e-9e11-4006-98cc-26f4932d2118), [VARTYPE](assetId:///317b911b-1805-402d-a9cb-159546bc88b4), and [VariantClear](assetId:///28741d81-8404-4f85-95d3-5c209ec13835) entries in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Parameters  
 `bytes`  
 A reference to an existing [CByteArray](../VS_csharp/cbytearray-class.md) object.  
...
-   **operator =(** `strSrc` **)** Copies a [CString](../VS_csharp/cstringt-class.md) object into this object and sets the **VARTYPE** to `VT_BSTR`.  
...
-   **operator =(** `curSrc` **)** Copies a [COleCurrency](../VS_csharp/colecurrency-class.md) object into this object and sets the **VARTYPE** to `VT_CY`.  
...
-   **operator =(** `dateSrc` **)** Copies a [COleDateTime](../VS_csharp/coledatetime-class.md) object into this object and sets the **VARTYPE** to `VT_DATE`.  
  
-   **operator =(** `arrSrc` **)** Copies a [CByteArray](../VS_csharp/cbytearray-class.md) object into this `COleVariant` object.  
  
-   **operator =(** `lbSrc` **)** Copies a [CLongBinary](../VS_csharp/clongbinary-class.md) object into this `COleVariant` object.  
