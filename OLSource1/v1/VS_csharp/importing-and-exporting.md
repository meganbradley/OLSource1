...
## Using a .def file  
 ...
 You can use .def files to [import into an application](../VS_csharp/importing-using-def-files.md) or to [export from a DLL](../VS_csharp/exporting-from-a-dll-using-def-files.md).  
...
-   [Import into an Application](../VS_csharp/importing-into-an-application-using-__declspec-dllimport-.md)  
