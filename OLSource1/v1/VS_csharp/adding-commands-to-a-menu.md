...
1.  [Create a menu](../VS_csharp/creating-a-menu.md).  
...
4.  In the Properties window, select the menu command properties that apply. For details, see [Menu Command Properties](../VS_csharp/menu-command-properties.md).  
