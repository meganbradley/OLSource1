 ...
 **END Microsoft Specific**  
 ...
 Functions that require variable lists are declared by using the ellipsis (...) in the argument list. Use the types and macros that are described in the STDARG.H include file to access arguments that are passed by a variable list. For more information about these macros, see [va_arg, va_copy, va_end, va_start](../VS_csharp/va_arg--va_copy--va_end--va_start.md). in the documentation for the C Run-Time Library.  
