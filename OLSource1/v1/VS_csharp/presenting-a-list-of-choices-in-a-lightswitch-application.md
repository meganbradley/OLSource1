...
6.  In the **Choice List** dialog box, enter the following values, and then choose the **OK** button.  
     ...
     ![The choice list](../VS_csharp/media/ls_tour12.PNG "LS_Tour12")  
...
## Next Steps  
 ...
 Next Lesson: [Adding Validation](../VS_csharp/validating-data-in-a-lightswitch-application.md)  
  
## See Also  
 [How to: Create a List of Values for a Field in a LightSwitch Application](../VS_csharp/how-to--create-a-list-of-values-for-a-field-in-a-lightswitch-application.md)   
