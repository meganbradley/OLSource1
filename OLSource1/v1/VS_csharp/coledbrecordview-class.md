...
> [!NOTE]
>  If you are working with the Data Access Objects (DAO) classes rather than the OLE DB Consumer Template classes, use class [CDaoRecordView](../VS_csharp/cdaorecordview-class.md) instead. For more information, see the article [Overview: Database Programming](../VS_csharp/data-access-programming--mfc-atl-.md).  
 ...
 For more information about rowset classes, see the [Using OLE DB Consumer Templates](../VS_csharp/ole-db-consumer-templates--c---.md) article.  
...
### Example  
 [!code[NVC_MFCDatabase#38](../VS_csharp/codesnippet/CPP/coledbrecordview-class_1.cpp)]  
