...
You can use the Visual C++ compiler options [/Qpar-report](../VS_csharp/-qpar-report--auto-parallelizer-reporting-level-.md) and [/Qvec-report](../VS_csharp/-qvec-report--auto-vectorizer-reporting-level-.md) to set the [Auto-Parallelizer and Auto-Vectorizer](../VS_csharp/auto-parallelization-and-auto-vectorization.md) to output reason codes and informational messages about its activity. This article explains the reason codes and the messages.  
...
## See Also  
 [Auto-Parallelizer and Auto-Vectorizer](../VS_csharp/auto-parallelization-and-auto-vectorization.md)   
