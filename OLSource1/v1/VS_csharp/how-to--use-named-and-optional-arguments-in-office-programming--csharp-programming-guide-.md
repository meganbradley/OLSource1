...
Named arguments and optional arguments, introduced in [!INCLUDE[csharp_dev10_long](../VS_csharp/includes/csharp_dev10_long_md.md)], enhance convenience, flexibility, and readability in C# programming. In addition, these features greatly facilitate access to COM interfaces such as the Microsoft Office automation APIs.  
...
2.  Add the following `using` directives to the top of the code file.  
     ...
     [!code[csProgGuideNamedAndOptional#4](../VS_csharp/codesnippet/CSharp/how-to--use-named-and-optional-arguments-in-office-programming--csharp-programming-guide-_1.cs)]  
...
1.  In the `Program` class in Program.cs, add the following method to create a Word application and a Word document. The [Add](http://go.microsoft.com/fwlink/?LinkId=145381) method has four optional parameters. This example uses their default values. Therefore, no arguments are necessary in the calling statement.  
     ...
     [!code[csProgGuideNamedAndOptional#6](../VS_csharp/codesnippet/CSharp/how-to--use-named-and-optional-arguments-in-office-programming--csharp-programming-guide-_2.cs)]  
...
2.  Add the following code at the end of the method to define where to display text in the document, and what text to display.  
     ...
     [!code[csProgGuideNamedAndOptional#7](../VS_csharp/codesnippet/CSharp/how-to--use-named-and-optional-arguments-in-office-programming--csharp-programming-guide-_3.cs)]  
  
### To run the application  
  
1.  Add the following statement to Main.  
  
     [!code[csProgGuideNamedAndOptional#8](../VS_csharp/codesnippet/CSharp/how-to--use-named-and-optional-arguments-in-office-programming--csharp-programming-guide-_4.cs)]  
...
1.  Use the `ConvertToTable` method to enclose the text in a table. The method has sixteen optional parameters. IntelliSense encloses optional parameters in brackets, as shown in the following illustration.  
     ...
     ![List of parameters for ConvertToTable method.](../VS_csharp/media/convert_tableparameters.png "Convert_TableParameters")  
ConvertToTable parameters  
     ...
     [!code[csProgGuideNamedAndOptional#9](../VS_csharp/codesnippet/CSharp/how-to--use-named-and-optional-arguments-in-office-programming--csharp-programming-guide-_5.cs)]  
     ...
     [!code[csProgGuideNamedAndOptional#14](../VS_csharp/codesnippet/CSharp/how-to--use-named-and-optional-arguments-in-office-programming--csharp-programming-guide-_6.cs)]  
...
1.  To change the table so that it has one column and three rows, replace the last line in `DisplayInWord` with the following statement and then type CTRL+F5.  
     ...
     [!code[csProgGuideNamedAndOptional#10](../VS_csharp/codesnippet/CSharp/how-to--use-named-and-optional-arguments-in-office-programming--csharp-programming-guide-_7.cs)]  
...
2.  To specify a predefined format for the table, replace the last line in `DisplayInWord` with the following statement and then type CTRL+F5. The format can be any of the [WdTableFormat](http://go.microsoft.com/fwlink/?LinkId=145382) constants.  
     ...
     [!code[csProgGuideNamedAndOptional#11](../VS_csharp/codesnippet/CSharp/how-to--use-named-and-optional-arguments-in-office-programming--csharp-programming-guide-_8.cs)]  
  
## Example  
 The following code includes the full example.  
  
 [!code[csProgGuideNamedAndOptional#12](../VS_csharp/codesnippet/CSharp/how-to--use-named-and-optional-arguments-in-office-programming--csharp-programming-guide-_9.cs)]  
