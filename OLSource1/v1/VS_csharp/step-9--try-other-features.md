...
-   To return to the previous tutorial step, see [Step 8: Add a Method to Verify Whether the Player Won](../VS_csharp/step-8--add-a-method-to-verify-whether-the-player-won.md).