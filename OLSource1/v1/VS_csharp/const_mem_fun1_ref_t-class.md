...
## Example  
 The constructor of `const_mem_fun1_ref_t` is not usually used directly; the helper function `mem_fun_ref` is used to adapt member functions. See [mem_fun_ref](../VS_csharp/-functional--functions.md#mem_fun_ref_function) for examples of how to use member function adaptors.  
