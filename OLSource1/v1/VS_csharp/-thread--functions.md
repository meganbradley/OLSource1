...
### Return Value  
 An object of type [thread::id](../VS_csharp/thread-class.md#thread__id_class) that uniquely identifies the current thread of execution.  
...
### Parameters  
 `Rel_time`  
 A [duration](../VS_csharp/duration-class.md) object that specifies a time interval.  
