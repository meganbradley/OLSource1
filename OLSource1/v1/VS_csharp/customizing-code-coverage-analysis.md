...
By default, the Visual Studio Code Coverage tool analyzes all solution assemblies (.exe/.dll) that are loaded during unit tests. We recommend that you retain this default, because it works well most of the time. For more information, see [Using Code Coverage](../VS_csharp/using-code-coverage-to-determine-how-much-code-is-being-tested.md).  
...
5.  To turn the custom settings off and on, deselect or select the file in the **Test**, **Test Settings** menu.  
 ...
 ![Test settings menu with custom settings file](../VS_csharp/media/codecoverage-settingsfile.png "CodeCoverage-settingsFile")  
  
 Other aspects of unit tests can be configured in the same .runsettings file. For more information, see [Configuring unit tests with .runsettings](../VS_csharp/unit-test-your-code.md).  
...
### Regular expressions  
 Include and exclude nodes use regular expressions. For more information, see [Regular Expressions](../VS_csharp/using-regular-expressions-in-visual-studio.md). Regular expressions are not the same as wildcards. In particular:  
...
### To customize run settings in a build definition  
 ...
 ![Specifying runsettings in a build definition](../VS_csharp/media/codecoverage-buildrunsettings.png "CodeCoverage-buildRunsettings")  
...
##  <a name="sample"></a> Sample .runsettings file  
 ...
 (For other uses of the .runsettings file, see [Customizing unit tests](../VS_csharp/configure-unit-tests-by-using-a-.runsettings-file.md).)  
...
## See Also  
 [Using Code Coverage](../VS_csharp/using-code-coverage-to-determine-how-much-code-is-being-tested.md)   
 [Configuring unit tests with .runsettings](../VS_csharp/unit-test-your-code.md)