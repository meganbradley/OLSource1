...
-   From the **Run this rule set** list, use one of the following methods:  
    ...
    -   For more information about how to create and implement a custom check-in policy rule set, see [Implementing Custom Code Analysis Check-in Policies for Managed Code](../VS_csharp/implementing-custom-code-analysis-check-in-policies-for-managed-code.md).  
