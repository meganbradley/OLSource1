...
> [!NOTE]
>  This method is deprecated. Use the [IDebugProcess3::Execute](../VS_csharp/idebugprocess3--execute.md) method instead.  
...
## Remarks  
 When the user starts execution from a stopped state in some other program's thread, this method is called on this program. This method is also called when the user selects the **Start** command from the **Debug** menu in the IDE. The implementation of this method may be as simple as calling the [IDebugThread2::Resume](../VS_csharp/idebugthread2--resume.md) method on the current thread in the program.  
