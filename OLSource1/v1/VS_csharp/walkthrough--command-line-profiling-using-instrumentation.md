...
This walkthrough takes you through profiling a [!INCLUDE[dnprdnshort](../VS_csharp/includes/dnprdnshort_md.md)] stand-alone application to collect detailed timing and call count data by using the instrumentation method of the Profiling Tools. In this walkthrough, you will accomplish the following tasks:  
  
-   Use the [VSInstr](../VS_csharp/vsinstr.md) command line tool to generate instrumented binaries.  
  
-   Use the [VSPerfCLREnv](../VS_csharp/vsperfclrenv.md) tool to set the environment variables to collect .NET profiling data.  
  
-   Use the [VSPerfCmd](../VS_csharp/vsperfcmd.md) tool to collect profiling data.  
  
-   Use the [VSPerfReport](../VS_csharp/vsperfreport.md) tool to generate file-based reports of the profiling data.  
  
## Prerequisites  
  
-   [!INCLUDE[vsprvsts](../VS_csharp/includes/vsprvsts_md.md)]  
  
-   Intermediate understanding of C#  
  
-   Intermediate understanding of working with command-line tools  
  
-   A copy of the [PeopleTrax Sample](../VS_csharp/peopletrax-sample--profiling-tools-.md)  
  
-   To work with the information provided by profiling, it is best to have debugging symbol information available. For more information, see [How to: Reference Windows Symbol Information](../VS_csharp/how-to--reference-windows-symbol-information.md).  
...
14. Use the VSPerfReport tool to generate or comma-separated value (.csv) report files. Type:  
    ...
    ```  
     ...
     You can analyze the generated reports in a spreadsheet program, or you can use the [!INCLUDE[vsprvs](../VS_csharp/includes/vsprvs_md.md)] IDE to analyze the profiling data in the Report.vsp file. For more information, see [Analyzing Profiling Tools Data](../VS_csharp/analyzing-performance-tools-data.md).  
...
## See Also  
 ...
 [VSPerfCmd.exe Reference](../VS_csharp/vsperfcmd.md)   
