...
## Return Value  
 ...
 In order for `toupper` to give the expected results, [__isascii](../VS_csharp/isascii--__isascii--iswascii.md) and [islower](../VS_csharp/islower--iswlower--_islower_l--_iswlower_l.md) must both return nonzero.  
...
## Remarks  
 ...
 In order for `toupper` to give the expected results, [__isascii](../VS_csharp/isascii--__isascii--iswascii.md) and [isupper](../VS_csharp/isupper--_isupper_l--iswupper--_iswupper_l.md) must both return nonzero.  
  
 [Data Conversion Routines](../VS_csharp/data-conversion.md)  
