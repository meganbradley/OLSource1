...
-   If the module is a safe .netmodule, pass the module directly to the linker.  
 ...
 For more information, see [/ASSEMBLYMODULE (Add a MSIL Module to the Assembly)](../VS_csharp/-assemblymodule--add-a-msil-module-to-the-assembly-.md) and [.netmodule Files as Linker Input](../VS_csharp/.netmodule-files-as-linker-input.md).