...
Like [List.mapi](../VS_csharp/list.mapi--t--u--function--fsharp-.md), but mapping corresponding elements from two lists of equal length.  
...
#### Parameters  
 `mapping`  
 Type: [int](../VS_csharp/core.int-type-abbreviation--fsharp-.md) `-> 'T1 -> 'T2 -> 'U`  
...
## Example  
 ...
 [!code[FsLists#37](../VS_csharp/codesnippet/FSharp/list.mapi2--t1--t2--u--function--fsharp-_1.fs)]  
