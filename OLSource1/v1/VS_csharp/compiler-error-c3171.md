...
'module': cannot specify different module attributes in a project  
 ...
 [module](../VS_csharp/module--c---.md) attributes with different parameter lists were found in two of the files in a compilation. Only one unique `module` attribute can be specified per compilation.  
