...
## Remarks  
 From managed code, an event can only be raised from within the class where it is defined. See [event](../VS_csharp/event---c---component-extensions-.md) for more information.  
