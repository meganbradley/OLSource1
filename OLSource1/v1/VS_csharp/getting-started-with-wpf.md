...
|||  
|-|-|  
|I want to jump right in…|[Walkthrough: My First WPF Desktop Application](../VS_csharp/walkthrough--my-first-wpf-desktop-application.md)<br /><br /> [Walkthrough: Create a WPF Desktop Application connected to an Azure Mobile Services](../VS_csharp/walkthrough--create-a-wpf-desktop-application-connected-to-an-azure-mobile-service.md)|  
|How do I design the application UI?|[Designing XAML in Visual Studio](../VS_csharp/designing-xaml-in-visual-studio.md)|  
...
|Tell me more about WPF…|[Introduction to WPF](../VS_csharp/introduction-to-wpf.md)<br /><br /> [XAML Overview (WPF)](https://msdn.microsoft.com/en-us/library/ms752059\(v=vs.100\).aspx)<br /><br /> [Controls](https://msdn.microsoft.com/en-us/library/bb613551\(v=vs.100\).aspx)<br /><br /> [Data Binding Overview](https://msdn.microsoft.com/en-us/library/ms752347\(v=vs.100\).aspx)<br /><br /> [WPF Data Binding with LINQ to XML](../VS_csharp/wpf-data-binding-with-linq-to-xml.md)|  
