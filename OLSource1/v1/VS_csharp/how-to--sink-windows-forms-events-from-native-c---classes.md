...
-   Attach an `OnClick` event handler to the control using [MAKE_DELEGATE](../VS_csharp/make_delegate.md).  
  
-   Create a delegate map using [BEGIN_DELEGATE_MAP](../VS_csharp/begin_delegate_map.md), [END_DELEGATE_MAP](../VS_csharp/end_delegate_map.md), and [EVENT_DELEGATE_ENTRY](../VS_csharp/event_delegate_entry.md).  
  
 This sample continues the work you did in [How To: Do DDX/DDV Data Binding with Windows Forms](../VS_csharp/how-to--do-ddx-ddv-data-binding-with-windows-forms.md).  
...
## See Also  
 ...
 [EVENT_DELEGATE_ENTRY](../VS_csharp/event_delegate_entry.md)