...
## Notes for Callers  
 This interface is passed into [IDebugPortSupplier2::AddPort](../VS_csharp/idebugportsupplier2--addport.md) to create a debug port. A call to [IDebugPort2::GetPortRequest](../VS_csharp/idebugport2--getportrequest.md) returns this interface, representing the request used to create the port in the first place.  
...
|Method|Description|  
|------------|-----------------|  
|[GetPortName](../VS_csharp/idebugportrequest2--getportname.md)|Gets the name of the port to create.|  
...
## See Also  
 ...
 [GetPortRequest](../VS_csharp/idebugport2--getportrequest.md)