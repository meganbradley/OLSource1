...
### Remarks  
 The first method blocks until the `condition_variable_any` object is signaled by a call to [notify_one](../VS_csharp/condition_variable-class.md#condition_variable__notify_one_method) or [notify_all](../VS_csharp/condition_variable-class.md#condition_variable__notify_all_method). It can also wake up spuriously.  
...
### Remarks  
 The first method blocks until the `condition_variable_any` object is signaled by a call to [notify_one](../VS_csharp/condition_variable-class.md#condition_variable__notify_one_method) or [notify_all](../VS_csharp/condition_variable-class.md#condition_variable__notify_all_method), or until the time interval `Rel_time` has elapsed. It can also wake up spuriously.  
...
### Parameters  
 ...
 `Abs_time`  
 A [chrono::time_point](../VS_csharp/time_point-class.md) object.  
...
### Remarks  
 The first method blocks until the `condition_variable` object is signaled by a call to [notify_one](../VS_csharp/condition_variable-class.md#condition_variable__notify_one_method) or [notify_all](../VS_csharp/condition_variable-class.md#condition_variable__notify_all_method), or until `Abs_time`. It can also wake up spuriously.  
...
## See Also  
 ...
 [<condition_variable>](../VS_csharp/-condition_variable-.md)