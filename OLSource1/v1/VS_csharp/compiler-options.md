...
>  You can start this tool only from the [!INCLUDE[vsprvs](../VS_csharp/includes/vsprvs_md.md)] command prompt. You cannot start it from a system command prompt or from File Explorer.  
 ...
 To compile without linking, use [/c](../VS_csharp/-c--compile-without-linking-.md).  
  
## Finding an Option  
 To find a particular compiler option, see one of the following lists:  
  
-   [Compiler Options Listed Alphabetically](../VS_csharp/compiler-options-listed-alphabetically.md)  
...
-   [Compiler Command-Line Syntax](../VS_csharp/compiler-command-line-syntax.md)  
  
-   [CL Command Files](../VS_csharp/cl-command-files.md)  
  
-   [CL Environment Variables](../VS_csharp/cl-environment-variables.md)  
  
## Related Build Tools  
 Use [NMAKE](../VS_csharp/nmake-reference.md) to build your output file.  
  
 Use [BSCMAKE](../VS_csharp/bscmake-reference.md) to support class browsing.  
  
 [Linker options](../VS_csharp/linker-options.md) also affect how your program is built.  
