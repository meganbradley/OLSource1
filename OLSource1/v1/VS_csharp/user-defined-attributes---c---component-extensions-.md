...
### Remarks  
 The information and syntax presented in this topic is meant to supersede the information presented in [attribute](../VS_csharp/attribute.md).  
...
-   [Attribute Targets](../VS_csharp/attribute-targets--c---component-extensions-.md)  
  
-   [Attribute Parameter Types](../VS_csharp/attribute-parameter-types---c---component-extensions-.md)  
  
 For information on signing assemblies in Visual C++, see [Strong Name Assemblies (Assembly Signing)](../VS_csharp/strong-name-assemblies--assembly-signing---c---cli-.md).  
 ...
 **Service Access = Read** **Example**  
 ...
 See [typeid<>](../VS_csharp/typeid---c---component-extensions-.md) for information on how to return a value of System::Type from a custom attribute block.  
