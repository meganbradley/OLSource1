...
## Microsoft Specific  
 Programs containing inline assembly code can be debugged with a source-level debugger if you compile with the [/Zi](../VS_csharp/-z7---zi---zi--debug-information-format-.md) option.  
 ...
 If you create a mixed source and assembly listing with the [/FAs](../VS_csharp/-fa---fa--listing-file-.md) compiler option, the listing contains both the source and assembly forms of each assembly-language line. Macros are not expanded in listings, but they are expanded during compilation.  
