...
This topic describes how to control the white space behavior of [!INCLUDE[sqltecxlinq](../VS_csharp/includes/sqltecxlinq_md.md)].  
 ...
 Another common scenario is to read and modify XML that has already been intentionally indented. You might not want to change this indentation in any way. To do this in [!INCLUDE[sqltecxlinq](../VS_csharp/includes/sqltecxlinq_md.md)], you preserve white space when you load or parse the XML and disable formatting when you serialize the XML.  
  
 This topic describes the white space behavior of methods that populate XML trees. For information about controlling white space when you serialize XML trees, see [Preserving White Space While Serializing](../VS_csharp/preserving-white-space-while-serializing2.md).  
...
## See Also  
 [Parsing XML (Visual Basic)](../VS_csharp/parsing-xml--visual-basic-.md)