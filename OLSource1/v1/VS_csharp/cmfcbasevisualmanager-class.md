...
|[CMFCBaseVisualManager::DrawStatusBarProgress](#cmfcbasevisualmanager__drawstatusbarprogress)|Draws a progress bar on a status bar control ( [CMFCStatusBar Class](../VS_csharp/cmfcstatusbar-class.md)) using the current Windows theme.|  
...
##  <a name="cmfcbasevisualmanager__drawstatusbarprogress"></a>  CMFCBaseVisualManager::DrawStatusBarProgress  
 Draws progress bar on status bar control ( [CMFCStatusBar Class](../VS_csharp/cmfcstatusbar-class.md)) using the current Windows theme.  
