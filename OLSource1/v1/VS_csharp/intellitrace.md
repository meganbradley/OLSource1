...
|||  
|-|-|  
|**Debug my application with IntelliTrace:**<br /><br /> -   Show me past events.<br />-   Show me call information with past events.<br />-   Save my IntelliTrace session.<br />-   Control the data that IntelliTrace collects.|-   [Walkthrough: Using IntelliTrace](../VS_csharp/walkthrough--using-intellitrace.md)<br />     [Record Execution History to Debug Your Application with IntelliTrace in Visual Studio](../VS_csharp/intellitrace-features.md)<br />-   [Configure IntelliTrace](assetId:///7657ecab-e07e-4b1b-872d-f05d966be37e)<br />-   [Historical Debugging](../VS_csharp/historical-debugging.md)|  
...
|**Collect IntelliTrace data from deployed applications**|-   [Collect IntelliTrace Data in Production](../VS_csharp/using-the-intellitrace-stand-alone-collector.md)|  
|**Start debugging from an IntelliTrace log file (.iTrace file).**|-   [Start Debugging from IntelliTrace Recordings](../VS_csharp/using-saved-intellitrace-data.md)|  
...
|**Not supported**|-   C++, other languages, and script<br />-   Windows Services, Silverlight, Xbox, or [!INCLUDE[winmobile](../VS_csharp/includes/winmobile_md.md)] apps|  
...
-   A bug or crash happens in a deployed application.  
     ...
     This is useful when you want to diagnose problems with apps in deployment. See [Monitor apps in deployment](../VS_csharp/using-the-intellitrace-stand-alone-collector.md).  
...
-   **SharePoint 2010 and SharePoint 2013 application events**  
    ...
    -   [Monitor apps in deployment](../VS_csharp/using-the-intellitrace-stand-alone-collector.md)  
  
    -   [Start Debugging from IntelliTrace Recordings](../VS_csharp/using-saved-intellitrace-data.md)  
...
## In this section  
 [Record Execution History to Debug Your Application with IntelliTrace in Visual Studio](../VS_csharp/intellitrace-features.md)  
 ...
 [Diagnose problems in deployment](../VS_csharp/diagnose-problems-after-deployment.md)  
  
 [Start Debugging from IntelliTrace Recording Files](../VS_csharp/using-saved-intellitrace-data.md)  
