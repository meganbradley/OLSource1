...
## Remarks  
 ...
 [!code[FsLangRef2#5801](../VS_csharp/codesnippet/FSharp/exceptions--the-raise-function--fsharp-_1.fs)]  
  
 The `raise` function can also be used to raise .NET exceptions, as shown in the following example.  
  
 [!code[FsLangRef2#5802](../VS_csharp/codesnippet/FSharp/exceptions--the-raise-function--fsharp-_2.fs)]  
...
## See Also  
 ...
 [Exceptions: The invalidArg Function (F#)](../VS_csharp/exceptions--the-invalidarg-function--fsharp-.md)