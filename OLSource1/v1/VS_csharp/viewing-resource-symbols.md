...
1.  In [Resource View](../VS_csharp/resource-view-window.md), right-click your .rc file.  
...
2.  Select **Resource Symbols** from the shortcut menu to view a resource symbol table in the [Resource Symbols dialog box](../VS_csharp/resource-symbols-dialog-box.md).  
