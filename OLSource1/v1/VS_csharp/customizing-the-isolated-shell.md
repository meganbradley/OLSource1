...
##### The default home page  
 You can customize the home page by changing the value of the "DefaultHomePage" row in the *SolutionName*.Application.pkgdef file. For more details, see [Walkthrough: Creating a Basic Isolated Shell Application](../VS_csharp/walkthrough--creating-a-basic-isolated-shell-application.md)  
...
```  
 ...
 For more information on customizing start pages, see [Custom Start Pages](../VS_csharp/customizing-the-start-page-for-visual-studio.md).  
...
```  
 ...
 removes the Miscellaneous Files project from the set of project templates displayed in the **New Project** dialog. For more details, see [Walkthrough: Creating a Basic Isolated Shell Application](../VS_csharp/walkthrough--creating-a-basic-isolated-shell-application.md).  
...
##### The Help/About window  
 In the isolated shell template there is a separate project you can use to customize the Help/About box for your application. For more details, see [Walkthrough: Creating a Basic Isolated Shell Application](../VS_csharp/walkthrough--creating-a-basic-isolated-shell-application.md).