...
-   To create an alias for a namespace or a type. This is called a *using alias directive*.  
 ...
 The `using` keyword is also used to create *using statements*, which help ensure that <xref:System.IDisposable*> objects such as files and fonts are handled correctly. See [using Statement](../VS_csharp/using-statement--csharp-reference-.md) for more information.  
...
## Remarks  
 ...
 For examples on referencing methods in other assemblies, see [Creating and Using C# DLLs](../VS_csharp/how-to--create-and-use-assemblies-using-the-command-line--csharp-and-visual-basic-.md).  
...
### Code  
 [!code[csrefKeywordsNamespace#8](../VS_csharp/codesnippet/CSharp/using-directive--csharp-reference-_1.cs)]  
...
### Code  
 [!code[csrefKeywordsNamespace#9](../VS_csharp/codesnippet/CSharp/using-directive--csharp-reference-_2.cs)]  
