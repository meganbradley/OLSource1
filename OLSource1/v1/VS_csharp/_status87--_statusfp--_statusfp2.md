...
## Remarks  
 ...
 These functions are not useful for [/clr](../VS_csharp/-clr--common-language-runtime-compilation-.md) or `/clr:pure` compilation because the common language runtime (CLR) only supports the default floating-point precision.  
