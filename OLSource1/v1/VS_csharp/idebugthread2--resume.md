...
## Remarks  
 ...
 For each call to this method, there must be a previous call to the [IDebugThread2::Suspend](../VS_csharp/idebugthread2--suspend.md) method. The suspend count determines how many times the `IDebugThread2::Suspend` method has been called so far.  
  
## See Also  
 [IDebugThread2](../VS_csharp/idebugthread2.md)   
 [IDebugThread2::Suspend](../VS_csharp/idebugthread2--suspend.md)