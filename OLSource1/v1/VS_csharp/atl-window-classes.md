...
## In This Section  
 [Introduction to ATL Window Classes](../VS_csharp/introduction-to-atl-window-classes.md)  
 Briefly describes each ATL window class and provides links to the reference material on them.  
  
 [Using a Window](../VS_csharp/using-a-window.md)  
 ...
 [Implementing a Dialog Box](../VS_csharp/implementing-a-dialog-box.md)  
 Discusses the two methods for adding a dialog box class and shows a code sample.  
  
 [Using Contained Windows](../VS_csharp/using-contained-windows.md)  
...
## Related Sections  
 ...
 [Windows Support Classes](../VS_csharp/windows-support-classes.md)  
