...
## Remarks  
 The values in this enumeration are returned by a call to the [IDiaSymbol::get_callingConvention](../VS_csharp/idiasymbol--get_callingconvention.md) method.  
...
## See Also  
 ...
 [IDiaSymbol::get_callingConvention](../VS_csharp/idiasymbol--get_callingconvention.md)