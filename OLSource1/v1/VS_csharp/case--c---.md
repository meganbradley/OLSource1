...
---
# case (C++)
Used with the [switch_type](../VS_csharp/switch_type.md) attribute in a **union**.  
...
## Remarks  
 The **case** C++ attribute has the same functionality as the **case** MIDL attribute. This attribute is only used with the [switch_type](../VS_csharp/switch_type.md) attribute.  
