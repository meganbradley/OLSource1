...
|MFCx0UD.DLL|MFC DLL, Unicode Debug version|  
 ...
 If you are statically linking your DLL to MFC, you must link it with one of the static MFC libraries. These versions are named according to the convention [N&#124;U]AFXCW[D].LIB. For more information, see the table "Static-Link Library Naming Conventions" in [Library Naming Conventions](../VS_csharp/library-naming-conventions.md) (MFC).  
...
-   [The naming convention for libraries](../VS_csharp/library-naming-conventions.md)  
