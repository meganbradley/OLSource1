...
2.  From the **Debug** menu, click **Continue**, **Step**, or **Set Next Statement** or evaluate a function in a debugger window.  
     ...
     The new code is compiled and the debugging continues with the new code. Some changes are not supported by Edit and Continue. For more information, see [Supported Code Changes (C#)](../VS_csharp/supported-code-changes--csharp-.md).  
...
## See Also  
 ...
 [Supported Code Changes (C#)](../VS_csharp/supported-code-changes--csharp-.md)   
 [Edit and Continue Errors and Warnings (C#)](../Topic/Edit%20and%20Continue%20Errors%20and%20Warnings%20\(C%23\).md)