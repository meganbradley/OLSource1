...
## Remarks  
 ...
 If you do not want the project system to generate the default name for the project or item, then set the [ProvideDefaultName](../VS_csharp/providedefaultname-element--visual-studio-templates-.md) element to `False`.  
