...
1.  Use the property name in an expression the same way you would use a variable name. You can use a property anywhere you can use a variable or a constant.  
     ...
     [!code[VbVbalrDateProperties#4](../VS_csharp/codesnippet/VisualBasic/how-to--call-a-property-procedure--visual-basic-_1.vb)]  
...
1.  Use the property name on the left side of an assignment statement.  
     ...
     [!code[VbVbcnProcedures#11](../VS_csharp/codesnippet/VisualBasic/how-to--call-a-property-procedure--visual-basic-_2.vb)]  
