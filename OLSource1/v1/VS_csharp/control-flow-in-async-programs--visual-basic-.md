...
>  The `Async` and `Await` keywords were introduced in Visual Studio 2012.  
 ...
 In general, you mark methods that contain asynchronous code with the [Async (Visual Basic)](../VS_csharp/async--visual-basic-.md) modifier. In a method that's marked with an async modifier, you can use an [Await (Visual Basic)](../VS_csharp/await-operator--visual-basic-.md) operator to specify where the method pauses to wait for a called asynchronous process to complete. For more information, see [Asynchronous Programming with Async and Await (Visual Basic)](../VS_csharp/asynchronous-programming-with-async-and-await--visual-basic-.md).  
...
### Steps ONE and TWO  
 ...
 ![Steps ONE and TWO](../VS_csharp/media/asynctrace-onetwo.png "AsyncTrace-ONETWO")  
  
 The return type of both `AccessTheWebAsync` and `client.GetStringAsync` is <xref:System.Threading.Tasks.Task`1*>. For `AccessTheWebAsync`, TResult is an integer. For `GetStringAsync`, TResult is a string. For more information about async method return types, see [Async Return Types (Visual Basic)](../VS_csharp/async-return-types--visual-basic-.md).  
...
```  
 ...
 ![Step THREE](../VS_csharp/media/asynctrace-three.png "AsyncTrace-Three")  
...
```  
 ...
 ![Step FOUR](../VS_csharp/media/asynctrace-four.png "AsyncTrace-FOUR")  
...
```  
 ...
 ![Step FIVE](../VS_csharp/media/asynctrace-five.png "AsyncTrace-FIVE")  
...
```  
 ...
 ![Step SIX](../VS_csharp/media/asynctrace-six.png "AsyncTrace-SIX")  
