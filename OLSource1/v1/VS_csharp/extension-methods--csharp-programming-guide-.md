...
```  
 ...
 For more information, see [How to: Implement and Call a Custom  Extension Method](../VS_csharp/how-to--implement-and-call-a-custom-extension-method--csharp-programming-guide-.md).  
...
## General Guidelines  
 In general, we recommend that you implement extension methods sparingly and only when you have to. Whenever possible, client code that must extend an existing type should do so by creating a new type derived from the existing type. For more information, see [Inheritance](../VS_csharp/inheritance--csharp-programming-guide-.md).  
