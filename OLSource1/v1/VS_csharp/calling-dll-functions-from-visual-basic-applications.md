...
```  
 ...
 To get the decorated name, use [/MAP](../VS_csharp/-map--generate-mapfile-.md). Use of **__declspec(dllexport)** does the following:  
...
```  
 ...
 For DLLs to be called by programs written in Visual Basic, the alias technique shown in this topic is needed in the .def file. If the alias is done in the Visual Basic program, use of aliasing in the .def file is not necessary. It can be done in the Visual Basic program by adding an alias clause to the [Declare](../VS_csharp/declare-statement.md) statement.  
  
## What do you want to know more about?  
  
-   [Exporting from a DLL](../VS_csharp/exporting-from-a-dll.md)  
  
-   [Exporting from a DLL using .DEF files](../VS_csharp/exporting-from-a-dll-using-def-files.md)  
  
-   [Exporting from a DLL using __declspec(dllexport)](../VS_csharp/exporting-from-a-dll-using-__declspec-dllexport-.md)  
  
-   [Exporting C++ functions for use in C-language executables](../VS_csharp/exporting-c---functions-for-use-in-c-language-executables.md)  
  
-   [Determining which exporting method to use](../VS_csharp/determining-which-exporting-method-to-use.md)  
