...
-   Creating a solution configuration that doesn’t  include the project.  
 ...
 For more information, see [Build Configurations](../VS_csharp/understanding-build-configurations.md).  
...
## See Also  
 ...
 [How to: Build Multiple Configurations Simultaneously](../VS_csharp/how-to--build-multiple-configurations-simultaneously.md)