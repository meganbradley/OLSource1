...
#### Parameters  
 *hInstLib*  
 A handle of the loaded library module. [AfxLoadLibrary](../VS_csharp/afxloadlibrary.md) returns this handle.  
...
## Example  
 See the example for [AfxLoadLibrary](../VS_csharp/afxloadlibrary.md).  
