...
3.  On the shortcut menu, click **Insert ActiveX Control**.  
     ...
     The [Insert ActiveX Control dialog box](../VS_csharp/insert-activex-control-dialog-box.md) appears, showing all the ActiveX controls on your system. At the bottom of the dialog box, the path to the ActiveX Control file appears.  
  
### To add an ActiveX control to a dialog box  
  
1.  In the [Insert ActiveX Control dialog box](../VS_csharp/insert-activex-control-dialog-box.md), select the control you want to add to your dialog box and click **OK**.  
    ...
    > [!NOTE]
    >  You can add ActiveX controls to the [Toolbox window](../VS_csharp/toolbox.md). For more information, see [Managing Items and Tabs in the Toolbox](assetId:///21285050-cadd-455a-b1f5-a2289a89c4db).  
