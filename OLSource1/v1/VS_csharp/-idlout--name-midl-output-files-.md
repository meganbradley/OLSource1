 ...
 *filename* is the parameter that you pass to /IDLOUT. If [/TLBOUT](../VS_csharp/-tlbout--name-.tlb-file-.md) is specified, the .tlb file will get its name from /TLBOUT *filename*.  
