...
Using the managed package framework (MPF) language classes to implement a language service in [!INCLUDE[csprcs](../VS_csharp/includes/csprcs_md.md)] is straightforward. You need a VSPackage to host the language service, the language service itself, and a parser for your language.  
...
3.  Select [!INCLUDE[csprcs](../VS_csharp/includes/csprcs_md.md)] as the language and the option to generate a new key file. Click **Next**.  
...
9. Implement the abstract methods as described in [Implementing a Language Service (Managed Package Framework)](../VS_csharp/implementing-a-legacy-language-service2.md).  
