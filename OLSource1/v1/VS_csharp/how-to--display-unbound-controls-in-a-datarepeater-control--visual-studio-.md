...
3.  Add at least one data-bound control to the <xref:Microsoft.VisualBasic.PowerPacks.DataRepeater*> control. For more information, see [How to: Display Bound Data in a DataRepeater Control (Visual Basic)](../VS_csharp/how-to--display-bound-data-in-a-datarepeater-control--visual-studio-.md).  
