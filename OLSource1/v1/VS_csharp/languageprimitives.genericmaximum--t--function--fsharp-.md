...
Take the maximum of two values structurally according to the order given by [GenericComparison](../VS_csharp/languageprimitives.genericcomparison--t--function--fsharp-.md).  
