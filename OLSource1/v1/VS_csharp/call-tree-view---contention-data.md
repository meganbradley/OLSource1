...
|**Level**|The level of the function in the call tree. Only in VSReport command-line reports. For more information, see in [VSReport](../VS_csharp/vsperfreport.md).|  
...
## See Also  
 ...
 [Call Tree View - Profiler .NET Memory Instrumentation Data](../VS_csharp/call-tree-view---.net-memory-instrumentation-data.md)   
