...
dev_langs: 
  - "FSharp"
helpviewer_keywords: 
  - "CompiledNameAttribute class [F#]"
  - "CompiledName attribute [F#]"
...
|Member|Description|  
|------------|-----------------|  
|[new](../VS_csharp/core.compilednameattribute-constructor--fsharp-.md)|Creates an instance of the attribute.|  
  
## Instance Members  
  
|Member|Description|  
|------------|-----------------|  
|[CompiledName](../VS_csharp/compilednameattribute.compiledname-property--fsharp-.md)|The name of the value as it appears in compiled code.|  
