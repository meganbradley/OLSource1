...
1.  Copy the scores.csv data from the topic [How to: Join Content from Dissimilar Files (LINQ) (Visual Basic)](../VS_csharp/how-to--join-content-from-dissimilar-files--linq---visual-basic-.md) and save it to your solution folder.  
