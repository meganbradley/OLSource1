...
-   [tiled_extent Class](../VS_csharp/tiled_extent-class.md) and [tiled_index Class](../VS_csharp/tiled_index-class.md). You use a `tiled_extent` object instead of an `extent` object in the `parallel_for_each` call. You use a `tiled_index` object instead of an `index` object in the `parallel_for_each` call.  
...
## Example of Global, Tile, and Local Indices  
 ...
 ![8&#45;by&#45;9 matrix divided into 2&#45;by&#45;3 tiles](../VS_csharp/media/usingtilesmatrix.PNG "UsingTilesMatrix")  
...
-   [tile_barrier::wait Method](../VS_csharp/tile_barrier--wait-method.md): Creates a fence around both global and `tile_static` memory.  
  
-   [tile_barrier::wait_with_all_memory_fence Method](../VS_csharp/tile_barrier--wait_with_all_memory_fence-method.md): Creates a fence around both global and `tile_static` memory.  
  
-   [tile_barrier::wait_with_global_memory_fence Method](../VS_csharp/tile_barrier--wait_with_global_memory_fence-method.md): Creates a fence around only global memory.  
  
-   [tile_barrier::wait_with_tile_static_memory_fence Method](../VS_csharp/tile_barrier--wait_with_tile_static_memory_fence-method.md): Creates a fence around only `tile_static` memory.  
