...
The **Registers** window is available only if address-level debugging is enabled in the **Options** dialog box, **Debugging** node.  
 ...
 For more information on displaying the **Registers** window, see [Using the Registers Window](../VS_csharp/how-to--use-the-registers-window.md).  
...
## See Also  
 [How to: Use the Registers Window](../VS_csharp/how-to--use-the-registers-window.md)   
