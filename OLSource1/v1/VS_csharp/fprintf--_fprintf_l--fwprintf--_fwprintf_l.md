...
Print formatted data to a stream. More secure versions of these functions are available; see [fprintf_s, _fprintf_s_l, fwprintf_s, _fwprintf_s_l](../VS_csharp/fprintf_s--_fprintf_s_l--fwprintf_s--_fwprintf_s_l.md).  
