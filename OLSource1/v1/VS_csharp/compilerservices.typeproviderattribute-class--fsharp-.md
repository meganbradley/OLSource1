...
Place on a class that implements the [ITypeProvider](../VS_csharp/compilerservices.itypeprovider-interface--fsharp-.md) interface to extend the compiler.  
...
|Member|Description|  
|------------|-----------------|  
|[new](../VS_csharp/compilerservices.typeproviderattribute-constructor--fsharp-.md)|Creates an instance of the attribute.|  
