...
This example demonstrates how to use [concurrency::parallel_for](../VS_csharp/parallel_for-function.md) to compute the product of two matrices.  
  
## Example  
 The following example shows the `matrix_multiply` function, which computes the product of two square matrices.  
  
 [!code[concrt-parallel-matrix-multiply#1](../VS_csharp/codesnippet/CPP/how-to--write-a-parallel_for-loop_1.cpp)]  
...
## Example  
 ...
 [!code[concrt-parallel-matrix-multiply#2](../VS_csharp/codesnippet/CPP/how-to--write-a-parallel_for-loop_2.cpp)]  
...
## Example  
 ...
 [!code[concrt-parallel-matrix-multiply#3](../VS_csharp/codesnippet/CPP/how-to--write-a-parallel_for-loop_3.cpp)]  
