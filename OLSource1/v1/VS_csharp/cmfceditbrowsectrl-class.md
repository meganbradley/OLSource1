...
## Inheritance Hierarchy  
 ...
 [CMFCEditBrowseCtrl](../VS_csharp/cmfceditbrowsectrl-class.md)  
  
## Example  
 The following example demonstrates how to use two methods in the `CMFCEditBrowseCtrl` class: `EnableFolderBrowseButton` and `EnableFileBrowseButton`. This example is part of the [New Controls sample](../VS_csharp/visual-c---samples.md).  
  
 [!code[NVC_MFC_NewControls#6](../VS_csharp/codesnippet/CPP/cmfceditbrowsectrl-class_1.h)]  
[!code[NVC_MFC_NewControls#7](../VS_csharp/codesnippet/CPP/cmfceditbrowsectrl-class_2.cpp)]  
