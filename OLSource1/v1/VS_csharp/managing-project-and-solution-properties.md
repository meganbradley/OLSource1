...
Projects have properties that govern many aspects of compilation, debugging, testing and deploying. Some properties are common among all project types, and some are unique to specific languages or platforms. You access project properties by right-clicking the project node in Solution Explorer and choosing Properties, or by typing properties into the **QuickLaunch** search box in the menu bar.  
 ...
 ![Project context menu](../VS_csharp/media/vs2015_proj_prop_menu.gif "vs2015_proj_prop_menu")  
  
 .NET projects also have a properties node in the project tree itself.  
  
 ![Properties node in Solution Explorer tree](../VS_csharp/media/vs2015_props_se.png "VS2015_Props_SE")  
  
> [!TIP]
>  Solutions have a few properties, and so do project items; these properties are accessed in the [Properties Window](../VS_csharp/properties-window.md), not **Project Designer**.  
...
### C# and Visual Basic projects  
 ...
 ![Visual Studio Project Designer](../VS_csharp/media/vs2015_proppage_build.png "VS2015_PropPage_Build")  
  
 For information about each of the property pages in Project Designer, see [Project Properties Reference](../VS_csharp/project-properties-reference.md).  
...
### C++ and JavaScript projects  
 ...
 ![Visual C&#43;&#43; project properties](../VS_csharp/media/vs2015_projprops_cpp.png "VS2015_ProjProps_cpp")  
  
 For information about C++ project properties, see [Working with Project Properties](../VS_csharp/working-with-project-properties.md). For more information about JavaScript properties, see [Property Pages, JavaScript](../VS_csharp/property-pages--javascript.md).  
...
## See Also  
 [Solutions and Projects in Visual Studio](../VS_csharp/solutions-and-projects-in-visual-studio.md)