...
## In This Section  
 [Implementing and Registering a Port Supplier](../VS_csharp/implementing-and-registering-a-port-supplier.md)  
 Discusses how the SDM interacts with the port supplier and its ports.  
  
 [Required Port Supplier Interfaces](../VS_csharp/required-port-supplier-interfaces.md)  
