...
Before calling a stored procedure, you must first define it, using the [DEFINE_COMMAND](../VS_csharp/define_command.md) macro. When you define the command, denote parameters with a question mark (?) as the parameter marker:  
...
```  
 ...
 Also note that you can define a stored procedure using the database attribute [db_command](../VS_csharp/db_command.md) as follows:  
...
## See Also  
 [Using Stored Procedures](../VS_csharp/using-stored-procedures.md)