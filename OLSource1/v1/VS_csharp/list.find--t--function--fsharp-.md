...
Returns the first element for which the given function returns `true`. Raises <xref:System.Collections.Generic.KeyNotFoundException*> if no such element exists.  
...
## Example  
 ...
 [!code[FsLists#8](../VS_csharp/codesnippet/FSharp/list.find--t--function--fsharp-_1.fs)]  
