...
```  
 ...
 For more information about transactions, see [How to: Navigate and Update a Model](../VS_csharp/navigating-and-updating-a-model-in-program-code.md).  
  
## See Also  
 [How to Navigate and Update a Model](../VS_csharp/navigating-and-updating-a-model-in-program-code.md)   
 [Properties of Domain Properties](../VS_csharp/properties-of-domain-properties.md)   
