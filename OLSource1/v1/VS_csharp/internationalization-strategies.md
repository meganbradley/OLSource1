...
-   The source code for your application is written for complete portability — by recompiling with the symbol **_UNICODE** or the symbol **_MBCS** defined, you can produce versions that use either. For more information, see [Generic-Text Mappings in Tchar.h](../VS_csharp/generic-text-mappings-in-tchar.h.md).  
...
## See Also  
 ...
 [Locales and Code Pages](../VS_csharp/locales-and-code-pages.md)