...
```  
 ...
 Without the suffix m, the number is treated as a [double](../VS_csharp/double--csharp-reference-.md) and generates a compiler error.  
...
```  
 ...
 For more information about implicit numeric conversions, see [Implicit Numeric Conversions Table](../VS_csharp/implicit-numeric-conversions-table--csharp-reference-.md).  
  
 For more information about explicit numeric conversions, see [Explicit Numeric Conversions Table (Visual C#)](../VS_csharp/explicit-numeric-conversions-table--csharp-reference-.md).  
...
## Example  
 The following example causes a compiler error by trying to add [double](../VS_csharp/double--csharp-reference-.md) and `decimal` variables.  
...
```  
 ...
 In this example, a `decimal` and an [int](../VS_csharp/int--csharp-reference-.md) are mixed in the same expression. The result evaluates to the `decimal` type.  
  
 [!code[csrefKeywordsTypes#6](../VS_csharp/codesnippet/CSharp/decimal--csharp-reference-_1.cs)]  
...
## Example  
 ...
 [!code[csrefKeywordsTypes#7](../VS_csharp/codesnippet/CSharp/decimal--csharp-reference-_2.cs)]  
