...
#### Parameters  
 `pAddress`  
 [in] The address as represented by an [IDebugAddress](../VS_csharp/idebugaddress.md) interface.  
  
 `ppContainerField`  
 [out] Returns a container field represented by an [IDebugContainerField](../VS_csharp/idebugcontainerfield.md) interface.  
