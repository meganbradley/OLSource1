...
> [!NOTE]
>  See the **Rectangle Selection** and **Irregular Selection** tools pictured in [Image Editor toolbar](../VS_csharp/toolbar--image-editor-for-icons-.md) or view the Tool tips associated with each button on the **Image Editor** toolbar.  
  
 You can also create a custom brush from a selection. For more information, see [Creating a Custom Brush](../VS_csharp/creating-a-custom-brush--image-editor-for-icons-.md).  
