...
2.  Call [IDiaDataSource::loadDataFromPdb Method](../VS_csharp/idiadatasource--loaddatafrompdb.md) or [IDiaDataSource::loadDataForExe Method](../VS_csharp/idiadatasource--loaddataforexe.md) to load the debugging information.  
...
3.  Call [IDiaDataSource::openSession](../VS_csharp/idiadatasource--opensession.md) to open an [IDiaSession](../VS_csharp/idiasession.md) to gain access to the debugging information.  
