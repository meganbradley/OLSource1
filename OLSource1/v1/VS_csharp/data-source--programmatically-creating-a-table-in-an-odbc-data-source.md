...
This topic explains how to create a table for your data source, using the `ExecuteSQL` member function of class `CDatabase`, passing the function a string that contains a **CREATE TABLE** SQL statement.  
 ...
 For general information about ODBC data sources in MFC, see [Data Source (ODBC)](../VS_csharp/data-source--odbc-.md). The topic [Data Source: Programmatically Configuring an ODBC Data Source](../VS_csharp/data-source--programmatically-configuring-an-odbc-data-source.md) describes creating data sources.  
