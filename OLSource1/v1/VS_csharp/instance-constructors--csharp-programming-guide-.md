...
Instance constructors are used to create and initialize any instance member variables when you use the [new](../VS_csharp/new--csharp-reference-.md) expression to create an object of a [class](../VS_csharp/class--csharp-reference-.md). To initialize a [static](../VS_csharp/static--csharp-reference-.md) class, or static variables in a non-static class, you must define a static constructor. For more information, see [Static Constructors (C# Programming Guide)](../VS_csharp/static-constructors--csharp-programming-guide-.md).  
