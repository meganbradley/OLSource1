...
Sorts the given list using keys given by the given projection. Keys are compared using [Operators.compare](../VS_csharp/operators.compare--t--function--fsharp-.md).  
...
## Example  
 ...
 [!code[FsLists#6](../VS_csharp/codesnippet/FSharp/list.sortby--t--key--function--fsharp-_1.fs)]  
