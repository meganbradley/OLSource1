...
3.  If you are moving the items to another menu resource or resource script file, [open it in another window](../VS_csharp/customizing-window-layouts-in-visual-studio.md).  
