...
---
# max_variable_size Class
Describes a [max class](../VS_csharp/-allocators-.md) object that limits a [freelist](../VS_csharp/freelist-class.md) object to a maximum length that is roughly proportional to the number of allocated memory blocks.  
