...
> [!NOTE]
>  This example represents recommended practice only when you cannot use a generic collection class. For an example of how to implement a type-safe generic collection class that supports <xref:System.Collections.Generic.IEnumerable`1*>, see [Iterators (C# and Visual Basic)](../VS_csharp/iterators--csharp-and-visual-basic-.md).  
...
## See Also  
 ...
 [Collection Classes (C#)](../VS_csharp/collections--csharp-and-visual-basic-.md)