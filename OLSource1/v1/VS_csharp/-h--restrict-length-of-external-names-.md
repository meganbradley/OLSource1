...
## Remarks  
 ...
 If a program contains external names longer than `number`, the extra characters are ignored. If you compile a program without **/H** and if an identifier contains more than 2,047 characters, the compiler will generate [Fatal Error C1064](../VS_csharp/fatal-error-c1064.md).  
...
```  
 ...
 Use of **/H** is incompatible with [/GL (Whole Program Optimization)](../VS_csharp/-gl--whole-program-optimization-.md).  
