...
> [!NOTE]
>  You can also use the **Advanced** page of the **Performance Session** property pages to set other options that are available to the Profiling Tools [VSInstr](../VS_csharp/vsinstr.md) command line instrumentation tool.  
...
3.  In the **Additional instrumentation options** text box, use the following syntax to type the name of the functions that you want to instrument:  
    ...
    > [!NOTE]
    >  To list the functions in a binary, open a command prompt window in the Profiling Tools installation directory (typically, the \Team Tools\Performance Tools directory under the [!INCLUDE[vsprvsts](../VS_csharp/includes/vsprvsts_md.md)] installation directory) and then type **vsinstr /DumpFuncs**  
...
## See Also  
 ...
 [How to: Limit Instrumentation to Specific DLLs](../VS_csharp/how-to--limit-instrumentation-to-specific-dlls.md)   
