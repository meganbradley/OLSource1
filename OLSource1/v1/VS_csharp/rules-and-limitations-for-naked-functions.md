...
-   The `naked` keyword is ignored when compiling with [/clr](../VS_csharp/-clr--common-language-runtime-compilation-.md).  
  
-   For [__fastcall](../VS_csharp/__fastcall.md) naked functions, whenever there is a reference in C/C++ code to one of the register arguments, the prolog code should store the values of that register into the stack location for that variable. For example:  
