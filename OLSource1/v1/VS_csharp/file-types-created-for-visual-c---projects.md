...
-   [Project and Solution Files](../VS_csharp/project-and-solution-files.md)  
  
-   [Files Created for CLR Projects](../VS_csharp/files-created-for-clr-projects.md)  
  
-   [ATL Program or Control Source and Header Files](../VS_csharp/atl-program-or-control-source-and-header-files.md)  
  
-   [MFC Program or Control Source and Header Files](../VS_csharp/mfc-program-or-control-source-and-header-files.md)  
  
-   [Precompiled Header Files](../VS_csharp/precompiled-header-files.md)  
  
-   [Resource Files](../VS_csharp/resource-files--c---.md)  
  
-   [Help Files (WinHelp)](../VS_csharp/help-files--winhelp-.md)  
  
-   [Hint Files](../VS_csharp/hint-files.md)  
  
 When you [create a Visual C++ project](../VS_csharp/creating-desktop-projects-by-using-application-wizards.md), you might be creating a new solution, or you might be adding a project to a solution. Non-trivial applications are commonly developed with multiple projects in a solution.  
...
|.idb|Compiling|The state file, containing dependency information between source files and class definitions, which can be used by the compiler during minimal rebuild and incremental compilation. Use the [/Fd](../VS_csharp/-fd--program-database-file-name-.md) compiler option to specify the name of the .idb file. See [/Gm (Enable Minimal Rebuild)](../VS_csharp/-gm--enable-minimal-rebuild-.md) for more information.|  
|.idl|Compiling|An interface definition language file. See [Interface Definition (IDL) File](http://msdn.microsoft.com/library/windows/desktop/aa378712) in the [!INCLUDE[winsdkshort](../VS_csharp/includes/winsdkshort_md.md)] for more information.|  
|.ilk|Linking|Incremental link file. See [/INCREMENTAL](../VS_csharp/-incremental--link-incrementally-.md) for more information.|  
|.map|Linking|A text file containing linker information. Use the [/Fm](../VS_csharp/-fm--name-mapfile-.md) compiler option to name the map file. See [/MAP](../VS_csharp/-map--generate-mapfile-.md) for more information.|  
|.mfcribbon-ms|Resource|A resource file that contains the XML code that defines the buttons, controls, and attributes in the ribbon. For more information, see [Ribbon Designer (MFC)](../VS_csharp/ribbon-designer--mfc-.md).|  
|.obj, .o||Object files, compiled but not linked.|  
|.pch|Debug|Precompiled header file.|  
|.rc, .rc2|Resource|[Resource script files](../VS_csharp/working-with-resource-files.md) to generate resources.|  
|.sbr|Compiling|Source browser intermediate file. The input file for [BSCMAKE](../VS_csharp/bscmake-options.md).|  
...
|.vcxproj|Project|The Visual C++ project file. See [Project Files and Makefiles](../VS_csharp/project-and-solution-files.md) for more information.|  
...
|.vup|Project|The utility project file.|  
 ...
 For information on other files associated with Visual Studio, see [File Types and File Extensions in Visual Studio .NET](../VS_csharp/project-and-solution-file-types.md).  
