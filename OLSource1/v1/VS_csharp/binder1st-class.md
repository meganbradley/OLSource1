...
## Remarks  
 ...
 If `_Func` is an object of type **Operation** and `c` is a constant , then [bind1st](../VS_csharp/-functional--functions.md#bind1st_function) ( `_Func`, `c` ) is equivalent to the `binder1st` class constructor `binder1st`< **Operation**> ( `_Func`, `c` ) and more convenient.  
