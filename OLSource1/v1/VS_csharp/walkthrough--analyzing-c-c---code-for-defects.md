...
-   [!INCLUDE[vsPreLong](../VS_csharp/includes/vsprelong_md.md)] or [!INCLUDE[vsUltLong](../VS_csharp/includes/vsultlong_md.md)].  
  
-   A copy of the [Demo Sample](../VS_csharp/demo-sample.md).  
  
-   Basic understanding of C/C++.  
  
### To run code defect analysis on native code  
  
1.  Open the Demo solution in [!INCLUDE[vsprvs](../VS_csharp/includes/vsprvs_md.md)].  
...
1.  On the **View** menu, click **Error List**.  
     ...
     Depending on the developer profile that you chose in [!INCLUDE[vsprvs](../VS_csharp/includes/vsprvs_md.md)], you might have to point to **Other Windows** on the **View** menu, and then click **Error List**.  
...
## See Also  
 [Walkthrough: Analyzing Managed Code for Code Defects](../VS_csharp/walkthrough--analyzing-managed-code-for-code-defects.md)