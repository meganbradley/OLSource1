...
-   Compatibility with collection classes  
 ...
 The first-level macros, [DECLARE_DYNAMIC](../VS_csharp/declare_dynamic.md) and [IMPLEMENT_DYNAMIC](../VS_csharp/implement_dynamic.md), permit run-time access to the class name and its position in the hierarchy. This, in turn, allows meaningful diagnostic dumping.  
  
 The second-level macros, [DECLARE_SERIAL](../VS_csharp/declare_serial.md) and [IMPLEMENT_SERIAL](../VS_csharp/implement_serial.md), include all the functionality of the first-level macros, and they enable an object to be "serialized" to and from an "archive."  
  
 For information about deriving Microsoft Foundation classes and C++ classes in general and using `CObject`, see [Using CObject](../VS_csharp/using-cobject.md) and [Serialization](../VS_csharp/serialization-in-mfc.md).  
...
### Example  
 See [CObList::CObList](../VS_csharp/coblist-class.md#coblist__coblist) for a listing of the `CAge` class used in all `CObject` examples.  
  
 [!code[NVC_MFCCObjectSample#7](../VS_csharp/codesnippet/CPP/cobject-class_1.cpp)]  
  
 For another example, see [AfxDoForAllObjects](../VS_csharp/afxdoforallobjects.md).  
...
### Remarks  
 ...
 If your class is serializable (it incorporates the `IMPLEMENT_SERIAL` macro), then you must have a default constructor (a constructor with no arguments) in your class declaration. If you do not need a default constructor, declare a private or protected "empty" constructor. For more information, see [Using CObject](../VS_csharp/using-cobject.md).  
...
### Example  
 See [CObList::CObList](../VS_csharp/coblist-class.md#coblist__coblist) for a listing of the `CAge` class used in the `CObject` examples.  
  
 [!code[NVC_MFCCObjectSample#8](../VS_csharp/codesnippet/CPP/cobject-class_2.cpp)]  
  
##  <a name="cobject__dump"></a>  CObject::Dump  
 Dumps the contents of your object to a [CDumpContext](../VS_csharp/cdumpcontext-class.md) object.  
...
>  Your `Dump` function should not print a newline character at the end of its output.  
 ...
 The [CDumpContext insertion (<<) operator](../VS_csharp/cdumpcontext-class.md#cdumpcontext__operator__lt__lt_) calls `Dump` when a `CObject` pointer is inserted.  
...
### Example  
 ...
 [!code[NVC_MFCCObjectSample#9](../VS_csharp/codesnippet/CPP/cobject-class_3.cpp)]  
...
### Return Value  
 A pointer to the [CRuntimeClass](../VS_csharp/cruntimeclass-structure.md) structure corresponding to this object's class; never **NULL**.  
...
-   **UINT m_wSchema** The schema number ( – 1 for nonserializable classes). See the [IMPLEMENT_SERIAL](../VS_csharp/implement_serial.md) macro for a description of schema number.  
...
-   **CRuntimeClass\* m_pBaseClass** If your application is statically linked to MFC, a pointer to the `CRuntimeClass` structure of the base class.  
 ...
 This function requires use of the [IMPLEMENT_DYNAMIC](../VS_csharp/implement_dynamic.md), [IMPLEMENT_DYNCREATE](../VS_csharp/implement_dyncreate.md), or [IMPLEMENT_SERIAL](../VS_csharp/implement_serial.md) macro in the class implementation. You will get incorrect results otherwise.  
  
### Example  
 See [CObList::CObList](../VS_csharp/coblist-class.md#coblist__coblist) for a listing of the `CAge` class used in all `CObject` examples.  
  
 [!code[NVC_MFCCObjectSample#10](../VS_csharp/codesnippet/CPP/cobject-class_4.cpp)]  
...
### Parameters  
 `pClass`  
 A pointer to a [CRuntimeClass](../VS_csharp/cruntimeclass-structure.md) structure associated with your `CObject`-derived class.  
  
### Return Value  
 Nonzero if the object corresponds to the class; otherwise 0.  
  
### Remarks  
 This function tests `pClass` to see if (1) it is an object of the specified class or (2) it is an object of a class derived from the specified class. This function works only for classes declared with the [DECLARE_DYNAMIC](../VS_csharp/declare_dynamic.md), [DECLARE_DYNCREATE](../VS_csharp/declare_dyncreate.md), or [DECLARE_SERIAL](../VS_csharp/declare_serial.md) macro.  
...
### Example  
 ...
 [!code[NVC_MFCCObjectSample#11](../VS_csharp/codesnippet/CPP/cobject-class_5.cpp)]  
...
### Remarks  
 For a class to be serializable, its declaration must contain the [DECLARE_SERIAL](../VS_csharp/declare_serial.md) macro, and the implementation must contain the [IMPLEMENT_SERIAL](../VS_csharp/implement_serial.md) macro.  
...
### Example  
 ...
 [!code[NVC_MFCCObjectSample#12](../VS_csharp/codesnippet/CPP/cobject-class_6.cpp)]  
...
### Remarks  
 ...
 [!code[NVC_MFCCObjectSample#14](../VS_csharp/codesnippet/CPP/cobject-class_7.cpp)]  
...
### Example  
 ...
 [!code[NVC_MFCCObjectSample#15](../VS_csharp/codesnippet/CPP/cobject-class_8.cpp)]  
...
### Example  
 ...
 [!code[NVC_MFCCObjectSample#16](../VS_csharp/codesnippet/CPP/cobject-class_9.h)]  
...
### Remarks  
 ...
 You must also use the [DECLARE_SERIAL](../VS_csharp/declare_serial.md) macro in your class declaration, and you must use the [IMPLEMENT_SERIAL](../VS_csharp/implement_serial.md) macro in the implementation.  
  
 Use [CArchive::IsLoading](../VS_csharp/carchive-class.md#carchive__isloading) or [CArchive::IsStoring](../VS_csharp/carchive-class.md#carchive__isstoring) to determine whether the archive is loading or storing.  
  
 `Serialize` is called by [CArchive::ReadObject](../VS_csharp/carchive-class.md#carchive__readobject) and [CArchive::WriteObject](../VS_csharp/carchive-class.md#carchive__writeobject). These functions are associated with the `CArchive` insertion operator ( **<<**) and extraction operator ( **>>**).  
  
 For serialization examples, see the article [Serialization: Serializing an Object](../VS_csharp/serialization--serializing-an-object.md).  
  
### Example  
 See [CObList::CObList](../VS_csharp/coblist-class.md#coblist__coblist) for a listing of the `CAge` class used in all `CObject` examples.  
  
 [!code[NVC_MFCCObjectSample#13](../VS_csharp/codesnippet/CPP/cobject-class_10.cpp)]  
