...
## Virtual base classes  
 ...
 ![Graph of simulated lunch line](../VS_csharp/media/vc38xp1.gif "vc38XP1")  
Simulated Lunch-Line Graph  
 ...
 ![Simulated lunch&#45;line object](../VS_csharp/media/vc38xp2.gif "vc38XP2")  
...
```  
 ...
 ![Simulated lunch&#45;line object, virtual base classes](../VS_csharp/media/vc38xp3.gif "vc38XP3")  
Simulated Lunch-Line Object with Virtual Base Classes  
 ...
 ![Virtual and nonvirtual components of a class](../VS_csharp/media/vc38xp4.gif "vc38XP4")  
Virtual and Nonvirtual Components of the Same Class  
 ...
 ![Virtual & nonvirtual inheritance in object layout](../VS_csharp/media/vc38xp5.gif "vc38XP5")  
...
3.  If access to the name violates member-access permission, an error message is generated. (For more information, see [Member-Access Control](../VS_csharp/member-access-control--c---.md).)  
...
-   The effect of explicitly converting the pointer obtained using the address-of operator to the base-class type `A`. Note that coercing the address of the object to type `A*` does not always provide the compiler with enough information as to which subobject of type `A` to select; in this case, two subobjects exist.  
 ...
 ![Ambiguous conversion of pointers to base classes](../VS_csharp/media/vc38xt1.gif "vc38XT1")  
...
### Ambiguities and virtual base classes  
 ...
 ![Virtual derivation and nonvirtual derivation](../VS_csharp/media/vc38xr1.gif "vc38XR1")  
...
## See Also  
 [Inheritance](../VS_csharp/inheritance---c---.md)