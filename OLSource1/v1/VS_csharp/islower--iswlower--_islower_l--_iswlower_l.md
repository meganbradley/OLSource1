...
|---------------------|------------------------------------|--------------------|-----------------------|  
|`_istlower`|`islower`|[_ismbclower](../VS_csharp/_ismbclower--_ismbclower_l--_ismbcupper--_ismbcupper_l.md)|`iswlower`|  
|`_istlower_l`|`_islower _l`|[_ismbclower_l](../VS_csharp/_ismbclower--_ismbclower_l--_ismbcupper--_ismbcupper_l.md)|`_liswlower_l`|  
