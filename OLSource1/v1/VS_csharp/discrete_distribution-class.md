...
## Remarks  
 This sampling distribution has uniform-width intervals with uniform probability in each interval. For information about other sampling distributions, see [piecewise_linear_distribution](../VS_csharp/piecewise_linear_distribution-class.md) and [piecewise_constant_distribution](../VS_csharp/piecewise_constant_distribution-class.md).  
...
### Parameters  
 ...
 `weightlist`  
 The [initializer_list](../VS_csharp/initializers.md) from which to construct the distribution.  
...
### Parameters  
 See parent topic [discrete_distribution Class](../VS_csharp/discrete_distribution-class.md).  
