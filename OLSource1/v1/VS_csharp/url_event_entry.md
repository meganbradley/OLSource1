 ...
 *mapName*  
 Specifies the page whose URL is *url*. This matches *mapName* in the [BEGIN_EMBED_DHTML_EVENT_MAP](../VS_csharp/begin_embed_dhtml_event_map.md) macro that maps events from this page.  
