...
## Remarks  
 ...
 The data that is collected from instrumented runs is used to create an optimized image. For more information, see [Profile Guided Optimization](../VS_csharp/profile-guided-optimizations.md). The short form of this option is /LTCG:PGI.  
  
 :PGOPTIMIZE (optional)  
 This option is deprecated. Instead, use **/LTCG** and  **/USEPROFILE** to build an optimized image. For more information, see [Profile Guided Optimization](../VS_csharp/profile-guided-optimizations.md). The short form of this option is /LTCG:PGO.  
  
 :PGUPDATE (optional)  
 This option is deprecated. Instead, use **/LTCG** and  **/USEPROFILE** to build an optimized image. For more information, see [Profile Guided Optimization](../VS_csharp/profile-guided-optimizations.md). The short form of this option is /LTCG:PGU.  
  
 The /LTCG option tells the linker to call the compiler and perform whole-program optimization. You can also do profile guided optimization. For more information, see [Profile Guided Optimization](../VS_csharp/profile-guided-optimizations.md).  
...
-   [/BASE](../VS_csharp/-base--base-address-.md)  
  
-   [/FIXED](../VS_csharp/-fixed--fixed-base-address-.md)  
  
-   /LTCG  
  
-   [/MAP](../VS_csharp/-map--generate-mapfile-.md)  
  
-   [/MAPINFO](../VS_csharp/-mapinfo--include-information-in-mapfile-.md)  
  
-   [/NOLOGO](../VS_csharp/-nologo--suppress-startup-banner---linker-.md)  
  
-   [/OUT](../VS_csharp/-out--output-file-name-.md)  
  
-   [/PGD](../VS_csharp/-pgd--specify-database-for-profile-guided-optimizations-.md)  
  
-   [/PDB](../VS_csharp/-pdb--use-program-database-.md)  
  
-   [/PDBSTRIPPED](../VS_csharp/-pdbstripped--strip-private-symbols-.md)  
  
-   [/STUB](../VS_csharp/-stub--ms-dos-stub-file-name-.md)  
  
-   [/VERBOSE](../VS_csharp/-verbose--print-progress-messages-.md)  
 ...
 **/LTCG** is not valid for use with [/INCREMENTAL](../VS_csharp/-incremental--link-incrementally-.md).  
  
 When **/LTCG** is used to link modules compiled by using [/Og](../VS_csharp/-og--global-optimizations-.md), [/O1](../VS_csharp/-o1---o2--minimize-size--maximize-speed-.md), [/O2](../VS_csharp/-o1---o2--minimize-size--maximize-speed-.md), or [/Ox](../VS_csharp/-ox--full-optimization-.md), the following optimizations are performed:  
...
## /LTCG and MSIL Modules  
 Modules that are compiled by using [/GL](../VS_csharp/-gl--whole-program-optimization-.md) and [/clr](../VS_csharp/-clr--common-language-runtime-compilation-.md) can be used as input to the linker when **/LTCG** is specified.  
...
1.  Open the project **Property Pages** dialog box. See [Working with Project Properties](../VS_csharp/working-with-project-properties.md).  
