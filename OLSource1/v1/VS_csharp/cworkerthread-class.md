...
#### Parameters  
 `ThreadTraits`  
 The class providing the thread creation function, such as [CRTThreadTraits](../VS_csharp/crtthreadtraits-class.md) or [Win32ThreadTraits](../VS_csharp/win32threadtraits-class.md).  
...
3.  Call [CWorkerThread::AddHandle](../Topic/CWorkerThread::AddHandle.md) with the handle of a kernel object and a pointer to an implementation of [IWorkerThreadClient](../VS_csharp/iworkerthreadclient-interface.md).  
  
     – or –  
  
     Call [CWorkerThread::AddTimer](../Topic/CWorkerThread::AddTimer.md) with a pointer to an implementation of [IWorkerThreadClient](../VS_csharp/iworkerthreadclient-interface.md).  
  
4.  Implement [IWorkerThreadClient::Execute](../VS_csharp/iworkerthreadclient--execute.md) to take some action when the handle or timer is signaled.  
...
### Parameters  
 ...
 `pClient`  
 The pointer to the [IWorkerThreadClient](../VS_csharp/iworkerthreadclient-interface.md) interface on the object to be called when the handle is signaled.  
  
 `dwParam`  
 The parameter to be passed to [IWorkerThreadClient::Execute](../VS_csharp/iworkerthreadclient--execute.md) when the handle is signaled.  
  
### Return Value  
 Returns S_OK on success, or an error HRESULT on failure.  
  
### Remarks  
 [IWorkerThreadClient::Execute](../VS_csharp/iworkerthreadclient--execute.md) will be called through `pClient` when the handle, `hObject`, is signaled.  
...
### Remarks  
 [IWorkerThreadClient::Execute](../VS_csharp/iworkerthreadclient--execute.md) will be called through `pClient` when the timer is signaled.  
...
## See Also  
 [DefaultThreadTraits](../VS_csharp/defaultthreadtraits.md)   
