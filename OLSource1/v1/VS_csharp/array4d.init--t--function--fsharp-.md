...
#### Parameters  
 ...
 `initializer`  
 Type: [int](../VS_csharp/core.int-type-abbreviation--fsharp-.md) `->` [int](../VS_csharp/core.int-type-abbreviation--fsharp-.md) `->` [int](../VS_csharp/core.int-type-abbreviation--fsharp-.md) `->` [int](../VS_csharp/core.int-type-abbreviation--fsharp-.md) `-> 'T`  
...
## See Also  
 [Collections.Array4D Module (F#)](../VS_csharp/collections.array4d-module--fsharp-.md)   
