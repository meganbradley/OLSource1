...
## See Also  
 [Run Windows Store apps on a remote machine from Visual Studio](../VS_csharp/run-windows-store-apps-on-a-remote-machine.md)   
 [How to: Change the Graphics Diagnostics Playback Machine](../VS_csharp/how-to--change-the-graphics-diagnostics-playback-machine.md)