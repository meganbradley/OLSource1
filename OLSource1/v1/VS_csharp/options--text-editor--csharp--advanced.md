...
-   Invalid [Edit and Continue](../VS_csharp/edit-and-continue.md) edits are purple.  
...
## XML Documentation Comments  
 ...
 When selected, inserts the <summary\> start and end tags automatically for XML documentation comments after you type the /// comment introduction. For more information about XML documentation, see [Documenting Your Code with XML](../VS_csharp/xml-documentation-comments--csharp-programming-guide-.md).  
...
## Organize Usings  
 ...
 When selected, `System` using directives appear before other using directives. For more information, see [Sort Usings](../Topic/Sort%20Usings.md).  
