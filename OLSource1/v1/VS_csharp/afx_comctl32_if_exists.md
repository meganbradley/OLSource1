...
## Remarks  
 Use this macro to determine whether the Common Controls library the function specified by `proc` (instead of calling [GetProcAddress](../VS_csharp/getprocaddress.md)).  
...
## See Also  
 ...
 [AFX_COMCTL32_IF_EXISTS2](../VS_csharp/afx_comctl32_if_exists2.md)