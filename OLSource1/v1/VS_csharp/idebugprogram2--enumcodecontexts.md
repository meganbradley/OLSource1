...
#### Parameters  
 `pDocPos`  
 [in] An [IDebugDocumentPosition2](../VS_csharp/idebugdocumentposition2.md) object representing an abstract position in a source file known to the IDE.  
  
 `ppEnum`  
 [out] Returns an [IEnumDebugCodeContexts2](../VS_csharp/ienumdebugcodecontexts2.md) object that contains a list of the code contexts.  
