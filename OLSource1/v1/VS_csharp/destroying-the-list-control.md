...
If you embed your [CListCtrl](../VS_csharp/clistctrl-class.md) object as a data member of a view or dialog class, it is destroyed when its owner is destroyed. If you use a [CListView](../VS_csharp/clistview-class.md), the framework destroys the control when it destroys the view.  
