...
dev_langs: 
  - "FSharp"
helpviewer_keywords: 
  - "DefaultTimeout property [F#]"
  - "MailboxProcessor.DefaultTimeout property [F#]"
...
## Remarks  
 The [MailboxProcessor](../VS_csharp/control.mailboxprocessor--msg--class--fsharp-.md) raises a timeout exception if a message is not received in this amount of time. If this property is not set, no timeout is used.  
