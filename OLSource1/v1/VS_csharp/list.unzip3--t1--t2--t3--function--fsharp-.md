...
#### Parameters  
 `list`  
 Type: `('T1 * 'T2 * 'T3)`[list](../VS_csharp/collections.list--t--union--fsharp-.md)  
...
## Example  
 ...
 [!code[FsLists#39](../VS_csharp/codesnippet/FSharp/list.unzip3--t1--t2--t3--function--fsharp-_1.fs)]  
