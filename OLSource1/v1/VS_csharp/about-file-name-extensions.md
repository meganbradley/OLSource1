...
When you register a file extension of a VSPackage, you associate it with a version of [!INCLUDE[vsprvs](../VS_csharp/includes/vsprvs_md.md)]. This is important if more than one version of [!INCLUDE[vsprvs](../VS_csharp/includes/vsprvs_md.md)] is installed on a computer.  
...
## See Also  
 [Registering File Name Extensions for Side-By-Side Deployments](../VS_csharp/registering-file-name-extensions-for-side-by-side-deployments.md)   
