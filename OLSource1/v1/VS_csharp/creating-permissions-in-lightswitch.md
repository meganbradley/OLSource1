...
5.  In the **Description** column, enter `Allows access to the Products screen`, and then choose the **Enter** key.  
     ...
     ![Defining a permission](../VS_csharp/media/ls_tour33.PNG "LS_Tour33")  
...
## Next Steps  
 ...
 Next lesson: [Restricting Access to Screens](../VS_csharp/restricting-access-to-a-lightswitch-screen.md)  
