...
This outline shows you examples of some of the changes in the language from Managed Extensions for C++ to [!INCLUDE[cpp_current_long](../VS_csharp/includes/cpp_current_long_md.md)]. Follow the link that accompanies each item for more information.  
...
## No Double Underscore Keywords  
 ...
 See [Language Keywords](../VS_csharp/language-keywords--c---cli-.md) for more information.  
...
```  
 ...
 See [The Managed Types](../VS_csharp/managed-types--c---cl-.md) for more information.  
...
```  
 ...
 See [Declaration of a CLR Reference Class Object](../VS_csharp/declaration-of-a-clr-reference-class-object.md) for more information.  
...
## Array Declaration  
 ...
 See [Declaration of a CLR Array](../VS_csharp/declaration-of-a-clr-array.md) for more information.  
...
```  
 ...
 See [Property Declaration](../VS_csharp/property-declaration.md) for more information.  
...
```  
 ...
 See [Property Index Declaration](../VS_csharp/property-index-declaration.md) for more information.  
...
```  
 ...
 See [Overloaded Operators](../VS_csharp/overloaded-operators.md) for more information.  
...
```  
 ...
 See [Changes to Conversion Operators](../VS_csharp/changes-to-conversion-operators.md) for more information.  
...
```  
 ...
 See [Explicit Override of an Interface Member](../VS_csharp/explicit-override-of-an-interface-member.md) for more information.  
...
```  
 ...
 See [Private Virtual Functions](../VS_csharp/private-virtual-functions.md) for more information.  
...
-   The overload resolution between the built-in arithmetic types and the Object class hierarchy has reversed between Managed Extensions and [!INCLUDE[cpp_current_long](../VS_csharp/includes/cpp_current_long_md.md)]. As a side-effect, CLR enums are no longer implicitly converted to arithmetic types.  
...
-   In the new syntax, a CLR enum maintains its own scope, which is not the case in Managed Extensions. Previously, enumerators were visible within the containing scope of the enum; now, enumerators are encapsulated within the scope of the enum.  
 ...
 See [CLR Enum Type](../VS_csharp/clr-enum-type.md) for more information.  
...
```  
 ...
 See [A Tracking Handle to a Boxed Value](../VS_csharp/a-tracking-handle-to-a-boxed-value.md) for more information.  
...
```  
 ...
 See [Value Type Semantics](../VS_csharp/value-type-semantics.md) for more information.  
...
```  
 ...
 See [typeof Goes to T::typeid](../VS_csharp/typeof-goes-to-t--typeid.md) for more information.  
