...
function declarations differ, variable parameters specified only in one of them  
 ...
 One declaration of the function contains a variable parameter list. Another declaration does not. ANSI C ([/Za](../VS_csharp/-za---ze--disable-language-extensions-.md)) only.  
