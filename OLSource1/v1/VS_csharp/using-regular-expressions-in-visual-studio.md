...
[!INCLUDE[vsprvs](../VS_csharp/includes/vsprvs_md.md)] uses .NET Framework regular expressions to find and replace text. For more information about .NET regular expressions, see [.NET Framework Regular Expressions](assetId:///521b3f6d-f869-42e1-93e5-158c54a6895d).  
...
## See Also  
 [Searching and Replacing](../VS_csharp/finding-and-replacing-text.md)