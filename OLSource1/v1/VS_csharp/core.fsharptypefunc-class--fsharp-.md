...
|Member|Description|  
|------------|-----------------|  
|[new](../VS_csharp/core.fsharptypefunc-constructor--fsharp-.md)|Construct an instance of an F# first class type function value|  
  
## Instance Members  
  
|Member|Description|  
|------------|-----------------|  
|[Specialize](../VS_csharp/fsharptypefunc.specialize--t--method--fsharp-.md)|Specialize the type function at a given type|  
