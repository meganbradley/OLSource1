...
### Parameters  
 `rSid`  
 A [CSid](../VS_csharp/csid-class.md) object.  
...
### Parameters  
 `rSid`  
 The [CSid](../VS_csharp/csid-class.md) object for which the security identifier (SID) and attributes should be removed.  
...
### Return Value  
 Returns the number of [CSid](../VS_csharp/csid-class.md) objects and their associated attributes contained in the `CTokenGroups` object.  
...
### Parameters  
 `pSids`  
 Pointer to an array of [CSid](../VS_csharp/csid-class.md) objects.  
