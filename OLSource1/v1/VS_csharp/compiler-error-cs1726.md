...
Friend assembly reference 'reference' is invalid. Strong-name signed assemblies must specify a public key in their InternalsVisibleTo declarations.  
 ...
 For more information, see [Friend Assemblies (C# Programming Guide)](../VS_csharp/friend-assemblies--csharp-and-visual-basic-.md).  
...
## See Also  
 [How to: Create Signed Friend Assemblies (C# and Visual Basic)](../VS_csharp/how-to--create-signed-friend-assemblies--csharp-and-visual-basic-.md)