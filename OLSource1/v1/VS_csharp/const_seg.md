...
---
# const_seg
Specifies the segment where [const](../VS_csharp/const--c---.md) variables are stored in the .obj file.  
...
## Remarks  
 ...
 OBJ files can be viewed with the [dumpbin](../VS_csharp/dumpbin-command-line.md) application. The default segment in the .obj file for `const` variables is .rdata. Some `const` variables, such as scalars, are automatically inlined into the code stream. Inlined code will not appear in .rdata.  
...
## Comments  
 ...
 You can also specify sections for initialized data ([data_seg](../VS_csharp/data_seg.md)), uninitialized data ([bss_seg](../VS_csharp/bss_seg.md)), and functions ([code_seg](../VS_csharp/code_seg.md)).  
