...
## In This Section  
 [Windows Presentation Foundation .Targets Files](../VS_csharp/wpf-.targets-files.md)  
 Describes WPF .Targets files.  
  
 [Windows Presentation Foundation MSBuild Task Reference](../VS_csharp/wpf-msbuild-task-reference.md)  
