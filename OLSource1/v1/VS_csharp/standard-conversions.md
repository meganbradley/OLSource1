...
-   Pointer-to-member conversions  
    ...
    > [!NOTE]
    >  User-defined types can specify their own conversions. Conversion of user-defined types is covered in [Constructors](../VS_csharp/constructors--c---.md) and [Conversions](../VS_csharp/user-defined-type-conversions--c---.md).  
...
-   An argument to an overloaded function or operand of an overloaded operator that depends on the signedness of the type of that operand for argument matching. (See [Overloaded Operators](../VS_csharp/operator-overloading.md) for more about defining overloaded operators.)  
...
### Pointer to classes  
 ...
 The first case is when the specified base class is accessible and the conversion is unambiguous. (See [Multiple Base Classes](../VS_csharp/multiple-base-classes.md) for more information about ambiguous base-class references.)  
 ...
 ![Inheritance graph showing base&#45;class accessibility](../VS_csharp/media/vc38xa1.gif "vc38XA1")  
...
||Public|Yes|  
 ...
 The following code defines two classes, `A` and `B`, where `B` is derived from `A`. (For more information on inheritance, see [Derived Classes](../VS_csharp/inheritance---c---.md).) It then defines `bObject`, an object of type `B`, and two pointers (`pA` and `pB`) that point to the object.  
...
### null pointer conversions  
 ...
 In C++11 the [nullptr](../VS_csharp/nullptr.md) type should be preferred to the C-style null pointer.  
...
-   The conversion is unambiguous. (See [Multiple Base Classes](../VS_csharp/multiple-base-classes.md) for more information about ambiguous base-class references.)  
