...
## Remarks  
 The member function returns `(float)`[size](../VS_csharp/hash_multimap--size--stl-clr-.md)`() /` [bucket_count](../VS_csharp/hash_multimap--bucket_count--stl-clr-.md)`()`. You use it to determine the average bucket size.  
