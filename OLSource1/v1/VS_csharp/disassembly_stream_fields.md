...
## Members  
 ...
 DSF_FLAGS  
 Initialize/use the `dwFlags` ([DISASSEMBLY_FLAGS](../VS_csharp/disassembly_flags.md)) field.  
...
## Remarks  
 Passed as a parameter to the [Read](../VS_csharp/idebugdisassemblystream2--read.md) method to indicate which fields of the [DisassemblyData](../VS_csharp/disassemblydata.md) structure are to be initialized.  
