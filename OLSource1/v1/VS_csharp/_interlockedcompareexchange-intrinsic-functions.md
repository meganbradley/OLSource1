...
|---------------|------------------|------------|  
|`_InterlockedCompareExchange`, `_InterlockedCompareExchange8`, `_InterlockedCompareExchange16`, `_InterlockedCompareExchange64`|x86, ARM, [!INCLUDE[vcprx64](../VS_csharp/includes/vcprx64_md.md)]|<intrin.h>|  
...
|`_InterlockedCompareExchange_np`, `_InterlockedCompareExchange16_np`, `_InterlockedCompareExchange64_np`|[!INCLUDE[vcprx64](../VS_csharp/includes/vcprx64_md.md)]|<intrin.h>|  
|`_InterlockedCompareExchange_HLEAcquire`, `_InterlockedCompareExchange_HLERelease`, `_InterlockedCompareExchange64_HLEAcquire`, `_InterlockedCompareExchange64_HLERelease`|x86, [!INCLUDE[vcprx64](../VS_csharp/includes/vcprx64_md.md)]|<immintrin.h>|  
...
## Remarks  
 ...
 `_InterlockedCompareExchange` provides compiler intrinsic support for the Win32 [!INCLUDE[winsdkshort](../VS_csharp/includes/winsdkshort_md.md)] [InterlockedCompareExchange](http://msdn.microsoft.com/library/ms683560.aspx) function.  
...
## Example  
 In the following example, `_InterlockedCompareExchange` is used for simple low-level thread synchronization. The approach has its limitations as a basis for multithreaded programming; it is presented to illustrate the typical use of the interlocked intrinsics. For best results, use the Windows API. For further information about multithreaded programming, see [Writing a Multithreaded Win32 Program](../VS_csharp/writing-a-multithreaded-win32-program.md).  
...
## See Also  
 [_InterlockedCompareExchange128](../VS_csharp/_interlockedcompareexchange128.md)   
 [_InterlockedCompareExchangePointer Intrinsic Functions](../VS_csharp/_interlockedcompareexchangepointer-intrinsic-functions.md)   
