...
In [New Project Generation : Under the Hood](../VS_csharp/new-project-generation--under-the-hood--part-one.md) we saw how the **New Project** dialog Box is populated. Let's assume you've selected a **Visual C# Windows Application**, filled out the **Name** and **Location** text boxes, and clicked OK.  
  
## Generating the Solution Files  
 Choosing an application template directs [!INCLUDE[vsprvs](../VS_csharp/includes/vsprvs_md.md)] to unzip and open the corresponding .vstemplate file, and to launch a template to interpret the XML commands in this file. These commands create projects and project items in the new or existing solution.  
...
```  
 ...
 For a complete list of template parameters, see [Template Parameters](../VS_csharp/template-parameters.md).  
...
```  
 ...
 We looked at the <TemplateData\> section in the [first part of this article](../VS_csharp/new-project-generation--under-the-hood--part-one.md). The tags in this section are used to control the appearance of the **New Project** dialog box.  
...
```  
 ...
 ![SimpleSolution](../VS_csharp/media/simplesolution.png "SimpleSolution")  
...
## See Also  
 [New Project Generation: Under the Hood](../VS_csharp/new-project-generation--under-the-hood--part-one.md)   
