...
|||  
|-|-|  
|[flip](../VS_csharp/vector-bool---reference--flip.md)|Inverts the Boolean value of a vector element.|  
|[operator bool](../VS_csharp/vector-bool---reference--operator-bool.md)|Provides an implicit conversion from `vector<bool>::reference` to `bool`.|  
|[operator=](../VS_csharp/vector-bool---reference--operator=.md)|Assigns a Boolean value to a bit, or the value held by a referenced element to a bit.|  
