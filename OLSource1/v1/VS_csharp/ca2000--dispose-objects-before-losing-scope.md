...
## How to Fix Violations  
 ...
 Note that you can use the `using` statement (`Using` in [!INCLUDE[vbprvb](../VS_csharp/includes/vbprvb_md.md)]) to wrap objects that implement `IDisposable`. Objects that are wrapped in this manner will automatically be disposed at the close of the `using` block.  
...
## Related Rules  
 [Disposable fields should be disposed](../VS_csharp/ca2213--disposable-fields-should-be-disposed.md)  
  
 [CA2202: Do not dispose objects multiple times](../VS_csharp/ca2202--do-not-dispose-objects-multiple-times.md)  
