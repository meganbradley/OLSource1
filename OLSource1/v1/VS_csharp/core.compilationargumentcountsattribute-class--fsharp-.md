...
|Member|Description|  
|------------|-----------------|  
|[new](../VS_csharp/core.compilationargumentcountsattribute-constructor--fsharp-.md)|Creates an instance of the attribute.|  
  
## Instance Members  
  
|Member|Description|  
|------------|-----------------|  
|[Counts](../VS_csharp/compilationargumentcountsattribute.counts-property--fsharp-.md)|Indicates the number of arguments in each argument group|  
