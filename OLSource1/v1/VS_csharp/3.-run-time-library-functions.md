...
-   Execution environment functions (see [Section 3.1](../VS_csharp/3.1-execution-environment-functions.md) on page 35).  
  
-   Lock functions (see [Section 3.2](../VS_csharp/3.2-lock-functions.md) on page 41).