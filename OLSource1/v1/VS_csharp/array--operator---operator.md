...
## Remarks  
 The overloads that have `I0`, `I1`, or `I2` parameters enable you to retrieve references to values in the [array](../VS_csharp/array-class.md) without having to create an [index](../VS_csharp/index-class.md) object.  
