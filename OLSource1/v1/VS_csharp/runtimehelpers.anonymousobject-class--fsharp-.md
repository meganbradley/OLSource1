...
apitype: "Assembly"
f1_keywords: 
  - "Microsoft.FSharp.Linq.RuntimeHelpers.AnonymousObject"
dev_langs: 
  - "FSharp"
helpviewer_keywords: 
  - "AnonymousObject class [F#]"
...
|Member|Description|  
|------------|-----------------|  
|[new](../VS_csharp/runtimehelpers.anonymousobject-constructor--fsharp-.md)|Creates a new instance of the type.|  
  
## Instance Members  
  
|Member|Description|  
|------------|-----------------|  
|[Item1 to Item8](../VS_csharp/anonymousobject.item1-to-item8-properties--fsharp-.md)|Provides access to the aggregated objects.|  
