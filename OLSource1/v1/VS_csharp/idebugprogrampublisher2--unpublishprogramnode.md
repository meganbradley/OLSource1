...
#### Parameters  
 `pProgramNode`  
 [in] An [IDebugProgramNode2](../VS_csharp/idebugprogramnode2.md) object representing the program node being removed.  
...
## Remarks  
 ...
 To make a program node available, call the [IDebugProgramPublisher2::PublishProgramNode](../VS_csharp/idebugprogrampublisher2--publishprogramnode.md) method.  
