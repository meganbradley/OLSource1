...
-   [Deferred Execution Example (Visual Basic)](../VS_csharp/deferred-execution-example--visual-basic-.md)  
  
## See Also  
 [Tutorial: Chaining Queries Together (Visual Basic)](../VS_csharp/tutorial--deferred-execution--visual-basic-.md)   
 [Concepts and Terminology (Functional Transformation) (Visual Basic)](../VS_csharp/concepts-and-terminology--functional-transformation---visual-basic-.md)   
