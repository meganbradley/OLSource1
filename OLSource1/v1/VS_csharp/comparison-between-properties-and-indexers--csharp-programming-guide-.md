...
|Supports shortened syntax with [Auto-Implemented Properties (C# Programming Guide)](../VS_csharp/auto-implemented-properties--csharp-programming-guide-.md).|Does not support shortened syntax.|  
