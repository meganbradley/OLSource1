...
1.  In the **Call Stack** window, open the shortcut menu. Choose **Show Call Stack on Code Map**. (Keyboard: **CTRL** + **SHIFT** + **`**)  
     ...
     See [Visualize and Debug Code Execution with Call Stacks](../VS_csharp/map-methods-on-the-call-stack-while-debugging-in-visual-studio.md).  
...
-   See [Run to a specified location or function](../VS_csharp/navigating-through-code-with-the-debugger.md#BKMK_Run_to_a_specified_location_or_function).  
  
### To set a breakpoint on the exit point of a function call  
  
-   See [Set a breakpoint at a source line, assembly instruction, or call stack function](../VS_csharp/using-breakpoints.md#BKMK_Set_a_breakpoint_at_a_source_line__assembly_instruction__or_call_stack_function_).  
...
## See Also  
 [Mixed Code and Missing Information in the Call Stack Window](../VS_csharp/mixed-code-and-missing-information-in-the-call-stack-window.md)   
