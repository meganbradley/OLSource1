...
---
# CAtlFileMapping Class
This class represents a memory-mapped file, adding a cast operator to the methods of [CAtlFileMappingBase](../VS_csharp/catlfilemappingbase-class.md).  
...
## Remarks  
 This class adds a single cast operator to allow implicit conversion of `CAtlFileMapping` objects to `T`**\***. Other members are supplied by the base class, [CAtlFileMappingBase](../VS_csharp/catlfilemappingbase-class.md).  
  
## Inheritance Hierarchy  
 [CAtlFileMappingBase](../VS_csharp/catlfilemappingbase-class.md)  
...
## See Also  
 [CAtlFileMappingBase Class](../VS_csharp/catlfilemappingbase-class.md)   
