...
### Parameters  
 ...
 `dwStyle`  
 Specifies the static control's window style. Apply any combination of [static control styles](../VS_csharp/static-styles.md) to the control.  
...
### Remarks  
 ...
 Apply the following [window styles](../VS_csharp/window-styles.md) to a static control:  
...
-   **WS_DISABLED** Rarely  
 ...
 If you're going to display a bitmap, cursor, icon, or metafile in the static control, you'll need to apply one of the following [static styles](../VS_csharp/static-styles.md):  
...
### Example  
 [!code[NVC_MFC_CStatic#1](../VS_csharp/codesnippet/CPP/cstatic-class_1.cpp)]  
...
### Example  
 [!code[NVC_MFC_CStatic#2](../VS_csharp/codesnippet/CPP/cstatic-class_2.cpp)]  
...
### Parameters  
 `lpDrawItemStruct`  
 A pointer to a [DRAWITEMSTRUCT](../VS_csharp/drawitemstruct-structure.md) structure. The structure contains information about the item to be drawn and the type of drawing required.  
...
### Example  
 [!code[NVC_MFC_CStatic#3](../VS_csharp/codesnippet/CPP/cstatic-class_3.cpp)]  
...
### Example  
 [!code[NVC_MFC_CStatic#4](../VS_csharp/codesnippet/CPP/cstatic-class_4.cpp)]  
...
### Example  
 [!code[NVC_MFC_CStatic#5](../VS_csharp/codesnippet/CPP/cstatic-class_5.cpp)]  
...
### Example  
 [!code[NVC_MFC_CStatic#6](../VS_csharp/codesnippet/CPP/cstatic-class_6.cpp)]  
...
-   MFC provides the class `CBitmap`, which you can use when you have to do more with a bitmap image than just call the Win32 function `LoadBitmap`. `CBitmap`, which contains one kind of GDI object, is often used in cooperation with `CStatic`, which is a `CWnd` class that is used for displaying a graphic object as a static control.  
 ...
 `CImage` is an ATL/MFC class that lets you more easily work with device independent bitmaps (DIB). For more information, see [CImage Class](../VS_csharp/cimage-class.md).  
