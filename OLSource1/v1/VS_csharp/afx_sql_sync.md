...
#### Parameters  
 `SQLFunc`  
 An ODBC API function. For more information about these functions, see the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
## Remarks  
 ...
 [!code[NVC_MFCDatabase#40](../VS_csharp/codesnippet/CPP/afx_sql_sync_1.cpp)]  
  
 you can simply make the assignment  
  
 [!code[NVC_MFCDatabase#41](../VS_csharp/codesnippet/CPP/afx_sql_sync_2.cpp)]  
