...
## Remarks  
 This class, derived from [CSecurityDesc](../VS_csharp/csecuritydesc-class.md), provides methods for creating and managing the security descriptor of a private object.  
...
## Inheritance Hierarchy  
 [CSecurityDesc](../VS_csharp/csecuritydesc-class.md)  
...
### Parameters  
 `pParent`  
 Pointer to a [CSecurityDesc](../VS_csharp/csecuritydesc-class.md) object referencing the parent container of the object. If there is no parent container, this parameter is NULL.  
...
### Parameters  
 `pParent`  
 Pointer to a [CSecurityDesc](../VS_csharp/csecuritydesc-class.md) object referencing the parent directory in which a new object is being created. Set to NULL if there is no parent directory.  
 ...
 `Token`  
 Reference to the [CAccessToken](../VS_csharp/caccesstoken-class.md) object for the client process on whose behalf the object is being created.  
...
### Parameters  
 ...
 `pResult`  
 Pointer to a [CSecurityDesc](../VS_csharp/csecuritydesc-class.md) object that receives a copy of the requested information from the specified security descriptor.  
 ...
 *Modification*  
 Pointer to a [CSecurityDesc](../VS_csharp/csecuritydesc-class.md) object. The parts of this security descriptor indicated by the `si` parameter are applied to the object's security descriptor.  
