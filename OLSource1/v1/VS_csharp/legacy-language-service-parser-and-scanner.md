...
### Summary  
 ...
 For more information, see [Brace Matching (Managed Package Framework)](../VS_csharp/brace-matching-in-a-legacy-language-service.md).  
...
## Parsing for Colorization  
 ...
 For more information, see [Syntax Highlighting (Managed Package Framework)](../VS_csharp/syntax-colorizing-in-a-legacy-language-service.md).  
...
## See Also  
 ...
 [Language Service Overview (Managed Package Framework)](../VS_csharp/legacy-language-service-overview.md)   
