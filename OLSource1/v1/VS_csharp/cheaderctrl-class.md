...
-   Image list support. Header items can contain images stored in a `CImageList` object or text.  
 ...
 For more information about using `CHeaderCtrl`, see [Controls](../VS_csharp/controls--mfc-.md) and [Using CHeaderCtrl](../VS_csharp/using-cheaderctrl.md).  
...
### Example  
 [!code[NVC_MFC_CHeaderCtrl#1](../VS_csharp/codesnippet/CPP/cheaderctrl-class_1.cpp)]  
...
### Remarks  
 This method implements the behavior of the Win32 message                         [HDM_CLEARFILTER](http://msdn.microsoft.com/library/windows/desktop/bb775306) with a column value of –1, as described in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
  
### Example  
 [!code[NVC_MFC_CHeaderCtrl#2](../VS_csharp/codesnippet/CPP/cheaderctrl-class_2.cpp)]  
...
### Remarks  
 This method implements the behavior of the Win32 message                         [HDM_CLEARFILTER](http://msdn.microsoft.com/library/windows/desktop/bb775306), as described in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
  
### Example  
 [!code[NVC_MFC_CHeaderCtrl#3](../VS_csharp/codesnippet/CPP/cheaderctrl-class_3.cpp)]  
...
### Parameters  
 `dwStyle`  
 Specifies the header control's style. For a description of header control styles, see                                 [Header Control Styles](http://msdn.microsoft.com/library/windows/desktop/bb775241) in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
  
 `rect`  
 Specifies the header control's size and position. It can be either a [CRect](../VS_csharp/crect-class.md) object or a                                 [RECT](http://msdn.microsoft.com/library/windows/desktop/dd162897) structure.  
...
-   `CCS_TOP` Causes the control to position itself at the top of the parent window's client area and sets the width to be the same as the parent window's width.  
 ...
 You can also apply the following window styles to a header control (see [Window Styles](../VS_csharp/window-styles.md) for more information):  
...
### Example  
 [!code[NVC_MFC_CHeaderCtrl#4](../VS_csharp/codesnippet/CPP/cheaderctrl-class_4.cpp)]  
...
### Parameters  
 ...
 `dwStyle`  
 The header control's style. For a description of header control styles, see                                 [Header Control Styles](http://msdn.microsoft.com/library/windows/desktop/bb775241) in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)]. See [Create](#cheaderctrl__create) for a list of additional styles.  
...
### Return Value  
 A pointer to a [CImageList](../VS_csharp/cimagelist-class.md) object if successful; otherwise **NULL**. The returned list contains only one image.  
  
### Remarks  
 This member function implements the behavior of the Win32 message                         [HDM_CREATEDRAGIMAGE](http://msdn.microsoft.com/library/windows/desktop/bb775308), as described in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)]. It is provided to support header item drag and drop.  
...
### Example  
 [!code[NVC_MFC_CHeaderCtrl#5](../VS_csharp/codesnippet/CPP/cheaderctrl-class_5.cpp)]  
...
### Example  
 [!code[NVC_MFC_CHeaderCtrl#6](../VS_csharp/codesnippet/CPP/cheaderctrl-class_6.cpp)]  
...
### Remarks  
 This method implements the behavior of the Win32 message                         [HDM_EDITFILTER](http://msdn.microsoft.com/library/windows/desktop/bb775312), as described in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
  
### Example  
 [!code[NVC_MFC_CHeaderCtrl#7](../VS_csharp/codesnippet/CPP/cheaderctrl-class_7.cpp)]  
...
### Remarks  
 This member function implements the behavior of the Win32 message                         [HDM_GETBITMAPMARGIN](http://msdn.microsoft.com/library/windows/desktop/bb775314), as described in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
  
### Example  
 [!code[NVC_MFC_CHeaderCtrl#8](../VS_csharp/codesnippet/CPP/cheaderctrl-class_8.cpp)]  
...
### Remarks  
 This method sends the                         [HDM_GETFOCUSEDITEM](http://msdn.microsoft.com/library/windows/desktop/bb775330) message, which is described in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Example  
 ...
 [!code[NVC_MFC_CHeaderCtrl_s4#6](../VS_csharp/codesnippet/CPP/cheaderctrl-class_9.h)]  
...
### Example  
 ...
 [!code[NVC_MFC_CHeaderCtrl_s4#4](../VS_csharp/codesnippet/CPP/cheaderctrl-class_10.cpp)]  
...
### Remarks  
 This member function implements the behavior of the Win32 message                         [HDM_GETIMAGELIST](http://msdn.microsoft.com/library/windows/desktop/bb775332), as described in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)]. The `CImageList` object to which the returned pointer points is a temporary object and is deleted in the next idle-time processing.  
  
### Example  
 [!code[NVC_MFC_CHeaderCtrl#9](../VS_csharp/codesnippet/CPP/cheaderctrl-class_11.cpp)]  
...
### Example  
 [!code[NVC_MFC_CHeaderCtrl#10](../VS_csharp/codesnippet/CPP/cheaderctrl-class_12.cpp)]  
...
### Remarks  
 This method sends the                         [HDM_GETITEMDROPDOWNRECT](http://msdn.microsoft.com/library/windows/desktop/bb775339) message, which is described in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Example  
 ...
 [!code[NVC_MFC_CHeaderCtrl_s4#2](../VS_csharp/codesnippet/CPP/cheaderctrl-class_13.cpp)]  
...
### Remarks  
 This method implements the behavior of the Win32 message                         [HDM_GETITEMRECT](http://msdn.microsoft.com/library/windows/desktop/bb775341), as described in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Remarks  
 This member function implements the behavior of the Win32 message                         [HDM_GETORDERARRAY](http://msdn.microsoft.com/library/windows/desktop/bb775343), as described in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)]. It is provided to support header item ordering.  
  
### Example  
 [!code[NVC_MFC_CHeaderCtrl#11](../VS_csharp/codesnippet/CPP/cheaderctrl-class_14.cpp)]  
...
### Remarks  
 ...
 This method sends the                         [HDM_GETOVERFLOWRECT](http://msdn.microsoft.com/library/windows/desktop/bb775345) message, which is described in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Example  
 ...
 [!code[NVC_MFC_CHeaderCtrl_s4#3](../VS_csharp/codesnippet/CPP/cheaderctrl-class_15.cpp)]  
...
### Remarks  
 This method sends the                         [HDM_HITTEST](http://msdn.microsoft.com/library/windows/desktop/bb775349) message, which is described in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Example  
 ...
 [!code[NVC_MFC_CHeaderCtrl_s4#1](../VS_csharp/codesnippet/CPP/cheaderctrl-class_16.cpp)]  
...
### Example  
 [!code[NVC_MFC_CHeaderCtrl#12](../VS_csharp/codesnippet/CPP/cheaderctrl-class_17.cpp)]  
...
### Example  
 [!code[NVC_MFC_CHeaderCtrl#13](../VS_csharp/codesnippet/CPP/cheaderctrl-class_18.cpp)]  
...
### Remarks  
 This member function implements the behavior of the Win32 macro                         [HDM_ORDERTOINDEX](http://msdn.microsoft.com/library/windows/desktop/bb775355), as described in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)]. It is provided to support header item ordering.  
...
### Remarks  
 This member function implements the behavior of the Win32 message                         [HDM_SETBITMAPMARGIN](http://msdn.microsoft.com/library/windows/desktop/bb775357), as described in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
  
### Example  
 [!code[NVC_MFC_CHeaderCtrl#14](../VS_csharp/codesnippet/CPP/cheaderctrl-class_19.cpp)]  
...
### Remarks  
 This member function implements the behavior of the Win32 message                         [HDM_SETFILTERCHANGETIMEOUT](http://msdn.microsoft.com/library/windows/desktop/bb775359), as described in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
  
### Example  
 [!code[NVC_MFC_CHeaderCtrl#15](../VS_csharp/codesnippet/CPP/cheaderctrl-class_20.cpp)]  
...
### Remarks  
 This method sends the                         [HDM_SETFOCUSEDITEM](http://msdn.microsoft.com/library/windows/desktop/bb775361) message, which is described in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Remarks  
 This member function implements the behavior of the Win32 message                         [HDM_SETHOTDIVIDER](http://msdn.microsoft.com/library/windows/desktop/bb775363), as described in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)]. It is provided to support header item drag and drop.  
  
### Example  
 [!code[NVC_MFC_CHeaderCtrl#16](../VS_csharp/codesnippet/CPP/cheaderctrl-class_21.cpp)]  
...
### Return Value  
 A pointer to the [CImageList](../VS_csharp/cimagelist-class.md) object previously assigned to the header control.  
  
### Remarks  
 This member function implements the behavior of the Win32 message                         [HDM_SETIMAGELIST](http://msdn.microsoft.com/library/windows/desktop/bb775365), as described in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)]. The `CImageList` object to which the returned pointer points is a temporary object and is deleted in the next idle-time processing.  
...
### Remarks  
 This member function implements the behavior of the Win32 macro                         [HDM_SETORDERARRAY](http://msdn.microsoft.com/library/windows/desktop/bb775369), as described in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)]. It is provided to support header item ordering.  
