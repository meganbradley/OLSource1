...
Reads formatted data from the standard input stream. These versions of [scanf, _scanf_l, wscanf, _wscanf_l](../VS_csharp/scanf--_scanf_l--wscanf--_wscanf_l.md) have security enhancements, as described in [Security Enhancements in the CRT](../VS_csharp/security-features-in-the-crt.md).  
...
```  
 ...
 For more information, see [scanf Width Specification](../VS_csharp/scanf-width-specification.md).  
