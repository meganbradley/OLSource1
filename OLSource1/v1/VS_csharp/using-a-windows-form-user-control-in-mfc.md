...
> [!NOTE]
>  When you build your application using a private (modified) copy of the MFC Windows Forms interfaces DLL (mfcmifc80.dll), it will fail to install in the GAC unless you replace the Microsoft key with your own vendor key. For more information on assembly signing, see [Programming with Assemblies](assetId:///25918b15-701d-42c7-95fc-c290d08648d6) and [Strong Name Assemblies (Assembly Signing)](../VS_csharp/strong-name-assemblies--assembly-signing---c---cli-.md).  
 ...
 If your MFC application uses Windows Forms, you need to redistribute mfcmifc90.dll with your application. For more information, see [Redistributing the MFC Library](../VS_csharp/redistributing-the-mfc-library.md).  
  
## In This Section  
 [Hosting a Windows Forms Control in an MFC Dialog Box](../VS_csharp/hosting-a-windows-form-user-control-in-an-mfc-dialog-box.md)  
...
## Reference  
 [CWinFormsControl Class](../VS_csharp/cwinformscontrol-class.md)  
 ...
 [CommandUIHandler Delegate](../VS_csharp/commanduihandler-delegate.md)  
  
 [DDX_ManagedControl](../VS_csharp/ddx_managedcontrol.md)  
  
 [UICheckState Enumeration](../VS_csharp/uicheckstate-enumeration.md)  
...
## See Also  
 ...
 [Form Topics](../VS_csharp/form-views--mfc-.md)