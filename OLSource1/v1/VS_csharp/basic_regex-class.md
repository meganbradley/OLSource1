...
## Remarks  
 The template class describes an object that holds a regular expression. Objects of this template class can be passed to the template functions [regex_match](../VS_csharp/-regex--functions.md#regex_match_function), [regex_search](../VS_csharp/-regex--functions.md#regex_search_function), and [regex_replace](../VS_csharp/-regex--functions.md#regex_replace_function), along with suitable text string arguments, to search for text that matches the regular expression. There are two specializations of this template class, with the type definitions [regex](../VS_csharp/-regex--typedefs.md#regex_typedef) for elements of type `char`, and [wregex](../VS_csharp/-regex--typedefs.md#wregex_typedef) for elements of type `wchar_t`.  
  
 The template argument `RXtraits` describes various important properties of the syntax of the regular expressions that the template class supports. A class that specifies these regular expression traits must have the same external interface as an object of template class [regex_traits](../VS_csharp/regex_traits-class.md).  
...
### Remarks  
 ...
 An empty `basic_regex` object does not match any character sequence when passed to [regex_match](../VS_csharp/-regex--functions.md#regex_match_function), [regex_search](../VS_csharp/-regex--functions.md#regex_search_function), or [regex_replace](../VS_csharp/-regex--functions.md#regex_replace_function).  
...
### Remarks  
 The type is a synonym for [regex_constants::syntax_option_type](../VS_csharp/regex_constants-class.md#regex_constants__syntax_option_type).  
...
### Remarks  
 The member function returns `traits.`[getloc](../VS_csharp/regex_traits-class.md#regex_traits__getloc)`()`.  
...
### Remarks  
 The member function empties `*this` and returns `traits.`[imbue](../VS_csharp/regex_traits-class.md#regex_traits__imbue)`(loc)`.  
...
### Remarks  
 The type is a synonym for [regex_traits::locale_type](../VS_csharp/regex_traits-class.md#regex_traits__locale_type).  
...
## See Also  
 ...
 [regex_match](../VS_csharp/-regex--functions.md#regex_match_function)   
 [regex_search](../VS_csharp/-regex--functions.md#regex_search_function)   
 [regex_replace](../VS_csharp/-regex--functions.md#regex_replace_function)   
 [regex](../VS_csharp/-regex--typedefs.md#regex_typedef)   
 [wregex](../VS_csharp/-regex--typedefs.md#wregex_typedef)   
 [regex_traits](../VS_csharp/regex_traits-class.md)