...
---
# String Literal
The handling of string literals has changed from Managed Extensions for C++ to [!INCLUDE[cpp_current_long](../VS_csharp/includes/cpp_current_long_md.md)].  
...
## See Also  
 ...
 [Strings (C++)](../VS_csharp/string---c---component-extensions-.md)