...
|Topic|Description|  
|-----------|-----------------|  
|[How to: Serialize Using XmlSerializer (C#)](../VS_csharp/how-to--serialize-using-xmlserializer--csharp-.md)|Demonstrates how to serialize using <xref:System.Xml.Serialization.XmlSerializer*>.|  
|[How to: Serialize Using DataContractSerializer (C#)](../VS_csharp/how-to--serialize-using-datacontractserializer--csharp-.md)|Demonstrates how to serialize using <xref:System.Runtime.Serialization.DataContractSerializer*>.|  
