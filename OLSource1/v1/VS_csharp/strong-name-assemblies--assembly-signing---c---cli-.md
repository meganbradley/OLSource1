...
-   <xref:System.Reflection.AssemblyKeyNameAttribute*>  
 ...
 If you use the signing attributes when building in the development environment, you can successfully sign the assembly by explicitly calling sn.exe ([Strong Name Tool (Sn.exe)](assetId:///c1d2b532-1b8e-4c7a-8ac5-53b801135ec6)) in a post-build event. For more information, see [Specifying Build Events](../VS_csharp/specifying-build-events.md). Build times may be less if you use attributes and a post-build event, compared to using a linker options.  
  
 The following linker options support assembly signing:  
  
-   [/DELAYSIGN (Partially Sign an Assembly)](../VS_csharp/-delaysign--partially-sign-an-assembly-.md)  
  
-   [/KEYFILE (Specify Key or Key Pair to Sign an Assembly)](../VS_csharp/-keyfile--specify-key-or-key-pair-to-sign-an-assembly-.md)  
  
-   [/KEYCONTAINER (Specify a Key Container to Sign an Assembly)](../VS_csharp/-keycontainer--specify-a-key-container-to-sign-an-assembly-.md)  
