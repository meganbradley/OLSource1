...
## Remarks  
 ...
 Other MFC classes designed for Internet and local file searched include [CFtpFileFind](../VS_csharp/cftpfilefind-class.md) and [CFileFind](../VS_csharp/cfilefind-class.md). Together with `CGopherFileFind`, these classes provide a seamless mechanism for the user to find specific files, regardless of the server protocol, file type, or location (either a local machine or a remote server.) Note that there is no MFC class for searching on HTTP servers because HTTP does not support the direct file manipulation required by searches.  
  
> [!NOTE]
>  `CGopherFileFind` does not support the following member functions of its base class [CFileFind](../VS_csharp/cfilefind-class.md):  
  
-   [GetRoot](../VS_csharp/cfilefind-class.md#cfilefind__getroot)  
  
-   [GetFileName](../VS_csharp/cfilefind-class.md#cfilefind__getfilename)  
  
-   [GetFilePath](../VS_csharp/cfilefind-class.md#cfilefind__getfilepath)  
  
-   [GetFileTitle](../VS_csharp/cfilefind-class.md#cfilefind__getfiletitle)  
  
-   [GetFileURL](../VS_csharp/cfilefind-class.md#cfilefind__getfileurl)  
  
 In addition, when used with `CGopherFileFind`, the `CFileFind` member function [IsDots](../VS_csharp/cfilefind-class.md#cfilefind__isdots) is always **FALSE**.  
  
 For more information about how to use `CGopherFileFind` and the other WinInet classes, see the article [Internet Programming with WinInet](../VS_csharp/win32-internet-extensions--wininet-.md).  
...
### Remarks  
 The default value for `dwContext` is sent by MFC to the `CGopherFileFind` object from the [CInternetSession](../VS_csharp/cinternetsession-class.md) object that created the `CGopherFileFind` object. When you construct a `CGopherFileFind` object, you can override the default to set the context identifier to a value of your choosing. The context identifier is returned to [CInternetSession::OnStatusCallback](../VS_csharp/cinternetsession-class.md#cinternetsession__onstatuscallback) to provide status on the object with which it is identified. See the article [Internet First Steps: WinInet](../VS_csharp/wininet-basics.md) for more information about the context identifier.  
...
### Parameters  
 ...
 `refTime`  
 A reference to a [CTime](../VS_csharp/ctime-class.md) object.  
...
### Example  
  See the example for [CFile::GetLength](../VS_csharp/cfile-class.md#cfile__getlength) (the base class implementation).  
  
##  <a name="cgopherfilefind__getlocator"></a>  CGopherFileFind::GetLocator  
 Call this member function to get the [CGopherLocator](../VS_csharp/cgopherlocator-class.md) object that [FindFile](#cgopherfilefind__findfile) uses to find the gopher file.  
...
## See Also  
 [Base Class](../VS_csharp/cfilefind-class.md)   
