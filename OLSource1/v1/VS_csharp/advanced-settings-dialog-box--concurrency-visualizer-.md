...
### Disable Rundown Events  
 The CLR generates events from two providers: runtime and rundown.  If you want to collect CLR runtime events, but want to avoid collecting rundown events, select the **Disable Rundown Events** check box.  This reduces the size of the trace file that's generated by collection, but some stacks might not resolve. For more information, see [CLR ETW Providers](assetId:///0beafad4-b2c8-47f4-b342-83411d57a51f)  
...
## See Also  
 [Just My Code (Threads View)](../VS_csharp/just-my-code--threads-view-.md)   
