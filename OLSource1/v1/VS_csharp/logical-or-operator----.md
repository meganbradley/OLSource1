...
## Operator Keyword for &#124;&#124;  
 The **or** operator is the text equivalent of `||`. There are two ways to access the **or** operator in your programs: include the header file `iso646.h`, or compile with the [/Za](../VS_csharp/-za---ze--disable-language-extensions-.md) (Disable language extensions) compiler option.  
