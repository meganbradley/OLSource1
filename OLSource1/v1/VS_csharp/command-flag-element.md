...
|FilterKeys|See the Filtering Keys topic under [Combo](../VS_csharp/combo-element.md).<br /><br /> Valid for: `Combo`|  
...
|Element|Description|  
|-------------|-----------------|  
|[Buttons](../VS_csharp/buttons-element.md)|Provides a group for [Button](../VS_csharp/button-element.md) elements.|  
