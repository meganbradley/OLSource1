...
## Remarks  
 The `break` statement is used with the conditional [switch](../VS_csharp/switch-statement--c---.md) statement and with the [do](../VS_csharp/do-while-statement--c---.md), [for](../VS_csharp/for-statement--c---.md), and [while](../VS_csharp/while-statement--c---.md) loop statements.  
...
## See Also  
 ...
 [continue Statement](../VS_csharp/continue-statement--c---.md)