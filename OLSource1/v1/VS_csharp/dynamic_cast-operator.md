...
## Remarks  
 ...
 See [static_cast](../VS_csharp/static_cast-operator.md) for an explanation of the difference between static and dynamic casting conversions, and when it is appropriate to use each.  
...
```  
 ...
 ![Class hierarchy that shows multiple inheritance](../VS_csharp/media/vc39011.gif "vc39011")  
...
```  
 ...
 ![Class hierarchy that shows virtual base classes](../VS_csharp/media/vc39012.gif "vc39012")  
Class Hierarchy Showing Virtual Base Classes  
 ...
 ![Class hierarchy that shows duplicate base classes](../VS_csharp/media/vc39013.gif "vc39013")  
...
```  
 ...
 The value of a failed cast to pointer type is the null pointer. A failed cast to reference type throws a [bad_cast Exception](../VS_csharp/bad_cast-exception.md).   If `expression` does not point to or reference a valid object, a `__non_rtti_object` exception is thrown.  
  
 See [typeid](../VS_csharp/typeid-operator.md) for an explanation of the `__non_rtti_object` exception.  
