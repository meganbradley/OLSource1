...
## Remarks  
 ...
 The /TSAWARE option is enabled by default for Windows 2000 and later, for Windows and console applications. See [/SUBSYSTEM](../VS_csharp/-subsystem--specify-subsystem-.md) and [/VERSION](../VS_csharp/-version--version-information-.md) for information.  
  
 /TSAWARE is not valid for drivers, VxDs, or DLLs.  
  
 If an application was linked with /TSAWARE, DUMPBIN [/HEADERS](../VS_csharp/-headers.md) will display information to that effect.  
