...
This article shows how to use lambda expressions in your programs. For an overview of lambda expressions, see [Lambda Expressions in C++](../VS_csharp/lambda-expressions-in-c--.md). For more information about the structure of a lambda expression, see [Lambda Expression Syntax](../VS_csharp/lambda-expression-syntax.md).  
  
##  <a name="declaringLambdaExpressions"></a> Declaring Lambda Expressions  
  
### Example 1  
 Because a lambda expression is typed, you can assign it to an `auto` variable or to a [function](../VS_csharp/function-class.md) object, as shown here:  
...
**7**   
### Remarks  
 For more information, see [auto Keyword (Type Deduction)](../VS_csharp/auto--c---.md), [function Class](../VS_csharp/function-class.md), and [Function Call (C++)](../VS_csharp/function-call--c---.md).  
...
### Remarks  
 For more information about the `find_if` function, see [find_if](../Topic/find_if.md). For more information about the STL functions that perform common algorithms, see [<algorithm\>](../VS_csharp/-algorithm-.md).  
...
**-56**   
### Remarks  
 For more information about C++ templates, see [Templates](../VS_csharp/templates--c---.md).  
...
### Remarks  
 For more information about exception handling, see [Exception Handling in Visual C++](../VS_csharp/exception-handling-in-visual-c--.md).  
 ...
 **Hello!**   
### Remarks  
 You can also use lambda expressions with the STL/CLR library. For more information, see [STL/CLR Library Reference](../VS_csharp/stl-clr-library-reference.md).  
...
## See Also  
 ...
 [auto Keyword (Type Deduction)](../VS_csharp/auto--c---.md)   
 [function Class](../VS_csharp/function-class.md)   
 ...
 [Exception Handling in Visual C++](../VS_csharp/exception-handling-in-visual-c--.md)   
