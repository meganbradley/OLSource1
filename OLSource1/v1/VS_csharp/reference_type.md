...
## Remarks  
 Used as the `dwRefType` member of the [DEBUG_REFERENCE_INFO](../VS_csharp/debug_reference_info.md) structure.  
  
 Passed as a parameter to the [IDebugReference2::SetReferenceType](../VS_csharp/idebugreference2--setreferencetype.md) method.  
...
## See Also  
 ...
 [IDebugReference2::SetReferenceType](../VS_csharp/idebugreference2--setreferencetype.md)