...
>  A return type of a method is not part of the signature of the method for the purposes of method overloading. However, it is part of the signature of the method when determining the compatibility between a delegate and the method that it points to.  
 ...
 [!code[csProgGuideObjects#40](../VS_csharp/codesnippet/CSharp/methods--csharp-programming-guide-_1.cs)]  
...
## Method Access  
 ...
 [!code[csProgGuideObjects#41](../VS_csharp/codesnippet/CSharp/methods--csharp-programming-guide-_2.cs)]  
...
## Method Parameters vs. Arguments  
 ...
 [!code[csProgGuideObjects#74](../VS_csharp/codesnippet/CSharp/methods--csharp-programming-guide-_3.cs)]  
  
## Passing by Reference vs. Passing by Value  
 By default, when a value type is passed to a method, a copy is passed instead of the object itself. Therefore, changes to the argument have no effect on the original copy in the calling method. You can pass a value-type by reference by using the ref keyword. For more information, see [Passing Value-Type Parameters (C# Programmer's Reference)](../VS_csharp/passing-value-type-parameters--csharp-programming-guide-.md). For a list of built-in value types, see [Value Types Table (C# Programmer's Reference)](../VS_csharp/value-types-table--csharp-reference-.md).  
 ...
 [!code[csProgGuideObjects#42](../VS_csharp/codesnippet/CSharp/methods--csharp-programming-guide-_4.cs)]  
 ...
 [!code[csProgGuideObjects#75](../VS_csharp/codesnippet/CSharp/methods--csharp-programming-guide-_5.cs)]  
 ...
 For more information about how to pass reference types by reference and by value, see [Passing Reference-Type Parameters (C# Programmer's Reference)](../VS_csharp/passing-reference-type-parameters--csharp-programming-guide-.md) and [Reference Types  (C# Programmer's Reference)](../VS_csharp/reference-types--csharp-reference-.md).  
...
## Return Values  
 ...
 [!code[csProgGuideObjects#44](../VS_csharp/codesnippet/CSharp/methods--csharp-programming-guide-_6.cs)]  
 ...
 [!code[csProgGuideObjects#45](../VS_csharp/codesnippet/CSharp/methods--csharp-programming-guide-_7.cs)]  
  
 [!code[csProgGuideObjects#46](../VS_csharp/codesnippet/CSharp/methods--csharp-programming-guide-_8.cs)]  
...
```  
 ...
 For more information, see [return](../VS_csharp/return--csharp-reference-.md).  
  
## Async Methods  
 By using the async feature, you can invoke asynchronous methods without using explicit callbacks or manually splitting your code across multiple methods or lambda expressions. The async feature was introduced [!INCLUDE[vs_dev11_long](../VS_csharp/includes/vs_dev11_long_md.md)].  
  
 If you mark a method with the [async](../VS_csharp/async--csharp-reference-.md) modifier, you can use the [await](../VS_csharp/await--csharp-reference-.md) operator in the method. When control reaches an await expression in the async method, control returns to the caller, and progress in the method is suspended until the awaited task completes. When the task is complete, execution can resume in the method.  
...
>  An async method returns to the caller when either it encounters the first awaited object that’s not yet complete or it gets to the end of the async method, whichever occurs first.  
 ...
 [!code[csAsyncMethod#2](../VS_csharp/codesnippet/CSharp/methods--csharp-programming-guide-_9.cs)]  
  
 An async method can't declare any [ref](../VS_csharp/ref--csharp-reference-.md) or [out](../VS_csharp/out--csharp-reference-.md) parameters, but it can call methods that have such parameters.  
  
 For more information about async methods, see [Asynchronous Programming with Async and Await (C# and Visual Basic)](../VS_csharp/asynchronous-programming-with-async-and-await--csharp-and-visual-basic-.md), [Control Flow in Async Programs (C# and Visual Basic)](../VS_csharp/control-flow-in-async-programs--csharp-and-visual-basic-.md), and [Async Return Types (C# and Visual Basic)](../VS_csharp/async-return-types--csharp-and-visual-basic-.md).  
...
## Iterators  
 An iterator performs a custom iteration over a collection, such as a list or an array. An iterator uses the [yield return](../VS_csharp/yield--csharp-reference-.md) statement to return each element one at a time. When a [yield return](../VS_csharp/yield--csharp-reference-.md) statement is reached, the current location in code is remembered. Execution is restarted from that location when the iterator is called the next time.  
  
 You call an iterator from client code by using a [foreach](../VS_csharp/foreach--in--csharp-reference-.md) statement.  
...
## See Also  
 ...
 [params](../VS_csharp/params--csharp-reference-.md)   
 [return](../VS_csharp/return--csharp-reference-.md)   
 [out (C# Programmer's Reference)](../VS_csharp/out--csharp-reference-.md)   
 [ref (C# Programmer's Reference)](../VS_csharp/ref--csharp-reference-.md)   
