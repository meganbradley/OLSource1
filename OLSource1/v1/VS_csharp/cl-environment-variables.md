...
-   LIBPATH, which specifies directories to search for metadata files referenced with [#using](../VS_csharp/sharpusing-directive--c---.md). See `#using` for more information on LIBPATH.  
...
```  
 ...
 For details on the arguments to the CL and _CL\_ environment variables, see [Compiler Command-Line Syntax](../VS_csharp/compiler-command-line-syntax.md).  
 ...
 For related information, see [Set Environment Variables](../VS_csharp/setting-the-path-and-environment-variables-for-command-line-builds.md).  
