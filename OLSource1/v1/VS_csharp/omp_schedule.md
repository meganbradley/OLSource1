...
---
# OMP_SCHEDULE
Modifies the behavior of the [schedule](../VS_csharp/schedule.md) clause when `schedule(runtime)` is specified in a `for` or `parallel for` directive.  
...
## Remarks  
 ...
 For more information, see [4.1 OMP_SCHEDULE](../VS_csharp/4.1-omp_schedule.md).  
