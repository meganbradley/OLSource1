...
-   Cannot contain [Instance Constructors](../VS_csharp/instance-constructors--csharp-programming-guide-.md).  
 ...
 Static classes are sealed and therefore cannot be inherited. They cannot inherit from any class except <xref:System.Object*>. Static classes cannot contain an instance constructor; however, they can contain a static constructor. Non-static classes should also define a static constructor if the class contains static members that require non-trivial initialization. For more information, see [Static Constructors](../VS_csharp/static-constructors--csharp-programming-guide-.md).  
...
## Example  
 ...
 [!code[csProgGuideObjects#31](../VS_csharp/codesnippet/CSharp/static-classes-and-static-class-members--csharp-programming-guide-_1.cs)]  
...
## Static Members  
 ...
 [!code[csProgGuideObjects#29](../VS_csharp/codesnippet/CSharp/static-classes-and-static-class-members--csharp-programming-guide-_2.cs)]  
 ...
 [!code[csProgGuideObjects#30](../VS_csharp/codesnippet/CSharp/static-classes-and-static-class-members--csharp-programming-guide-_3.cs)]  
