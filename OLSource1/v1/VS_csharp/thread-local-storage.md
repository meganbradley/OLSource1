...
-   The use of **__declspec(thread)** may interfere with [delay loading](../VS_csharp/linker-support-for-delay-loaded-dlls.md) of DLL imports**.**  
...
-   The use of **__declspec(thread)** may interfere with [delay loading](../VS_csharp/linker-support-for-delay-loaded-dlls.md) of DLL imports**.**  
 ...
 For more information about using the thread attribute, see [Multithreading Topics](../VS_csharp/multithreading-support-for-older-code--visual-c---.md).  
