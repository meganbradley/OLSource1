...
## Remarks  
 The Microsoft Foundation Class Library provides several classes derived from `CSyncObject`. These are [CEvent](../VS_csharp/cevent-class.md), [CMutex](../VS_csharp/cmutex-class.md), [CCriticalSection](../VS_csharp/ccriticalsection-class.md), and [CSemaphore](../VS_csharp/csemaphore-class.md).  
  
 For information on how to use the synchronization objects, see the article [Multithreading: How to Use the Synchronization Classes](../VS_csharp/multithreading--how-to-use-the-synchronization-classes.md).  
