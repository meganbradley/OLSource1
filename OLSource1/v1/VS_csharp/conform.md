...
**C++ Specific**  
 ...
 Specifies the run-time behavior of the [/Zc:forScope](../VS_csharp/-zc-forscope--force-conformance-in-for-loop-scope-.md) compiler option.  
 ...
 **on, off**(optional)  
 Setting *name* to **on** enables the [/Zc:forScope](../VS_csharp/-zc-forscope--force-conformance-in-for-loop-scope-.md) compiler option. The default is **off**.  
