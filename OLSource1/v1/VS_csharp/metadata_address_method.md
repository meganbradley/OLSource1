...
## Remarks  
 This structure is part of the union in the [DEBUG_ADDRESS_UNION](../VS_csharp/debug_address_union.md) structure when the `dwKind` field of the `DEBUG_ADDRESS_UNION` structure is set to `ADDRESS_KIND_METHOD` (a value from the [ADDRESS_KIND](../VS_csharp/address_kind.md) enumeration).  
