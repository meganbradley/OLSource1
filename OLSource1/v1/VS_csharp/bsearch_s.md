...
---
# bsearch_s
Performs a binary search of a sorted array. This is version of [bsearch](../VS_csharp/bsearch.md) with security enhancements as described in [Security Enhancements in the CRT](../VS_csharp/security-features-in-the-crt.md).  
...
## Return Value  
 ...
 If invalid parameters are passed to the function, the invalid parameter handler is invoked as described in [Parameter Validation](../VS_csharp/parameter-validation.md). If execution is allowed to continue, `errno`is set to `EINVAL` and the function returns `NULL`. For more information, see [errno, _doserrno, _sys_errlist, and _sys_nerr](../VS_csharp/errno--_doserrno--_sys_errlist--and-_sys_nerr.md).  
...
## Example  
 This program sorts a string array with [qsort_s](../VS_csharp/qsort_s.md), and then uses bsearch_s to find the word "cat".  
...
## See Also  
 [Searching and Sorting](../VS_csharp/searching-and-sorting.md)   
 [_lfind](../VS_csharp/_lfind.md)   
 [_lsearch](../VS_csharp/_lsearch.md)   
 [qsort](../VS_csharp/qsort.md)