...
1.  After the user enters the new value, Visual Studio calls [IDebugProperty2::SetValueAsString](../VS_csharp/idebugproperty2--setvalueasstring.md) on the [IDebugProperty2](../VS_csharp/idebugproperty2.md) object associated with the local.  
  
2.  `IDebugProperty2::SetValueAsString` performs the following tasks:  
  
    1.  Evaluates the string to produce a value.  
  
    2.  Binds the associated [IDebugField](../VS_csharp/idebugfield.md) object to obtain an [IDebugObject](../VS_csharp/idebugobject.md) object.  
  
    3.  Converts the value to a series of bytes.  
  
    4.  Calls [IDebugObject::SetValue](../VS_csharp/idebugobject--setvalue.md) to put the value's bytes into memory so the program being debugged can access them.  
  
3.  Visual Studio refreshes the **Locals** display (see [Displaying Locals](../VS_csharp/displaying-locals.md) for details).  
...
## In This Section  
 [Sample Implementation of Changing Values](../VS_csharp/sample-implementation-of-changing-values.md)  
