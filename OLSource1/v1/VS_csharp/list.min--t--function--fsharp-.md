...
Returns the lowest of all elements of the list, compared by using [Operators.min](../VS_csharp/operators.min--t--function--fsharp-.md).  
...
## Example  
 ...
 [!code[FsLists#57](../VS_csharp/codesnippet/FSharp/list.min--t--function--fsharp-_1.fs)]  
