...
```  
 ...
 tells the compiler that the function does not throw any exceptions. It is the equivalent to using [__declspec(nothrow)](../VS_csharp/nothrow--c---.md). Its use is considered optional.  
  
 **(C++11)** In the ISO C++11 Standard, [noexcept](../VS_csharp/noexcept--c---.md) operator was introduced and is supported in Visual Studio 2015 and later. Whenever possible, use `noexcept` to specify whether a function might throw exceptions.  
...
-   Which [/EH](../VS_csharp/-eh--exception-handling-model-.md) compiler option you use.  
