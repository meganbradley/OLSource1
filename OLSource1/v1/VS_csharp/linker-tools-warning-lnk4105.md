...
no argument specified with option 'option'; ignoring option  
 ...
 This warning occurs only when the [/LIBPATH](../VS_csharp/-libpath--additional-libpath-.md) option is set. If no directory is specified with this option, then the linker ignores the option and generates this warning message.  
