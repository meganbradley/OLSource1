...
---
# ToolBar Control Styles
[CMFCToolBarButton](../VS_csharp/cmfctoolbarbutton-class.md) has a set of style flags that determine the appearance and behavior of the button. You can set a combination of these flags by calling [CMFCToolBarButton::SetStyles](../Topic/CMFCToolBarButton::SetStyle.md). This topic lists the style flag values and their meanings.  
...
## Remarks  
 ...
 The visual manager determines the appearance of buttons in each state. See [The Visualization Manager](../VS_csharp/visualization-manager.md) for more information.  
