...
## Remarks  
 ...
 For more information on using `CFile`, see the articles [Files in MFC](../VS_csharp/files-in-mfc.md) and [File Handling](../VS_csharp/file-handling.md) in the                 *Run-Time Library Reference*.  
...
### Example  
 [!code[NVC_MFCFiles#5](../VS_csharp/codesnippet/CPP/cfile-class_1.cpp)]  
...
|Value|Description|  
|-----------|-----------------|  
|`CFile::modeCreate`|Creates a new file if no file exists.; If the file already exists, [CFileException](../VS_csharp/cfileexception-class.md) is raised.|  
...
|`CFile::modeNoInherit`|Prevents any child processes from using the file handle.|  
 ...
 The constructor with two parameters initializes members and tries to open the specified file. If this constructor successfully opens the specified file, the file is attached to the `CFile` object; otherwise, this constructor throws a pointer to a `CInvalidArgException` object. For more information about how to handle exceptions, see [Exceptions](../VS_csharp/exception-handling-in-mfc.md).  
...
### Example  
 ...
 [!code[NVC_MFCFiles#4](../VS_csharp/codesnippet/CPP/cfile-class_2.cpp)]  
...
### Remarks  
 The use of `Flush` does not guarantee flushing of `CArchive` buffers. If you are using an archive, call [CArchive::Flush](../VS_csharp/carchive-class.md#carchive__flush) first.  
...
### Example  
 ...
 [!code[NVC_MFCFiles#6](../VS_csharp/codesnippet/CPP/cfile-class_3.cpp)]  
...
### Example  
 [!code[NVC_MFCFiles#7](../VS_csharp/codesnippet/CPP/cfile-class_4.cpp)]  
...
### Example  
 [!code[NVC_MFCFiles#8](../VS_csharp/codesnippet/CPP/cfile-class_5.cpp)]  
...
### Example  
 [!code[NVC_MFCFiles#10](../VS_csharp/codesnippet/CPP/cfile-class_6.cpp)]  
...
### Remarks  
 ...
 [!code[NVC_MFCFiles#22](../VS_csharp/codesnippet/CPP/cfile-class_7.cpp)]  
...
### Example  
 [!code[NVC_MFCFiles#12](../VS_csharp/codesnippet/CPP/cfile-class_8.cpp)]  
...
### Example  
 [!code[NVC_MFCFiles#13](../VS_csharp/codesnippet/CPP/cfile-class_9.cpp)]  
  
 [!code[NVC_MFCFiles#14](../VS_csharp/codesnippet/CPP/cfile-class_10.cpp)]  
...
### Example  
 [!code[NVC_MFCFiles#15](../VS_csharp/codesnippet/CPP/cfile-class_11.cpp)]  
...
### Example  
 [!code[NVC_MFCFiles#17](../VS_csharp/codesnippet/CPP/cfile-class_12.cpp)]  
...
### Example  
 [!code[NVC_MFCFiles#18](../VS_csharp/codesnippet/CPP/cfile-class_13.cpp)]  
...
### Example  
 [!code[NVC_MFCFiles#9](../VS_csharp/codesnippet/CPP/cfile-class_14.cpp)]  
...
### Example  
 [!code[NVC_MFCFiles#19](../VS_csharp/codesnippet/CPP/cfile-class_15.cpp)]  
...
##  <a name="cfile__setfilepath"></a>  CFile::SetFilePath  
 Call this function to specify the path of the file; for example, if the path of a file is not available when a [CFile](../VS_csharp/cfile-class.md) object is constructed, call `SetFilePath` to provide it.  
...
### Example  
 [!code[NVC_MFCFiles#20](../VS_csharp/codesnippet/CPP/cfile-class_16.cpp)]  
...
### Example  
 [!code[NVC_MFCFiles#11](../VS_csharp/codesnippet/CPP/cfile-class_17.cpp)]  
...
### Example  
 [!code[NVC_MFCFiles#21](../VS_csharp/codesnippet/CPP/cfile-class_18.cpp)]  
...
### Example  
 [!code[NVC_MFCFiles#16](../VS_csharp/codesnippet/CPP/cfile-class_19.cpp)]  
  
 In addition, see the examples for [CFile::CFile](#cfile__cfile) and [CFile::Open](#cfile__open).  
  
## See Also  
 [MFC Sample DRAWCLI](../VS_csharp/visual-c---samples.md)   
