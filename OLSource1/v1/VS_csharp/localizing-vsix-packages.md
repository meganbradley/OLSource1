...
You can localize a VSIX package by creating an Extension.vsixlangpack file for each target language and then putting them in the correct folder. When a localized package is installed, the localized name of the extension is displayed together with a localized description. If you supply a localized license file, or a URL that points to localized information, they are also displayed.  
 ...
 If the content your VSIX package includes a VSPackage that adds menu commands or other UI, see [How to: Localize Menu Commands](../VS_csharp/localizing-menu-commands.md) for information about localizing the new UI elements.  
...
> [!NOTE]
>  The VSIX-supported project templates in the [!INCLUDE[vsipsdk](../VS_csharp/includes/vsipsdk_md.md)] generate a VSIX manifest and name it source.extension.vsixmanifest. When Visual Studio builds the project, it copies the content of that file into Extension.VsixManifest in the VSIX package.  
  
## The Extension.vsixlangpack File  
 The Extension.vsixlangpack file follows the [VSIX Language Pack Schema](../VS_csharp/vsx-language-pack-schema-reference.md). This schema has a [VSIXLanguagePack](../VS_csharp/vsixlanguagepack-element--vsix-language-pack-schema-.md) root element, and these four child elements: [LocalizedName](../VS_csharp/localizedname-element--vsix-language-pack-schema-.md), [LocalizedDescription](../VS_csharp/localizeddescription-element--vsix-language-pack-schema-.md), [MoreInfoURL](../VS_csharp/moreinfourl-element--vsix-language-pack-schema-.md), and [License](../VS_csharp/license-element--vsix-language-pack-schema-.md). These child elements correspond to the `Name`, `Description`, `MoreInfoURL`, and `License` child elements of the `Identifier` element of the Extension.vsixmanifest file.  
...
## See Also  
 [VSIXLanguagePack Element (VSIX Language Pack Schema)](../VS_csharp/vsixlanguagepack-element--vsix-language-pack-schema-.md)   
 [Anatomy of a VSIX Container](../VS_csharp/anatomy-of-a-vsix-package.md)   
 [Walkthrough: Publishing a Visual Studio Extension](../VS_csharp/vsix-project-template.md)