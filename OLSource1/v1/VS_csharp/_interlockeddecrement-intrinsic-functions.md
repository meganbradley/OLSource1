...
**Microsoft Specific**  
 ...
 Provides compiler intrinsic support for the Win32 [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)] [InterlockedDecrement](http://msdn.microsoft.com/library/ms683580.aspx) function.  
...
|---------------|------------------|  
|`_InterlockedDecrement`, `_InterlockedDecrement16`, `_InterlockedDecrement64`|x86, ARM, [!INCLUDE[vcprx64](../VS_csharp/includes/vcprx64_md.md)]|  
