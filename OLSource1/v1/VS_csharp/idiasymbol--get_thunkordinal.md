...
#### Parameters  
 `pRetVal`  
 [out] Returns a value from the [THUNK_ORDINAL](../VS_csharp/thunk_ordinal.md) enumeration that specifies the thunk type of a function.  
...
## Remarks  
 This property is valid only if the symbol as a [SymTagEnum](../VS_csharp/symtagenum.md) value of `SymTagThunk`.  
