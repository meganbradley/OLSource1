...
## Remarks  
 ...
 The members in a namespace specified with `/imports` are available to all source-code files in the compilation. Use the [Imports Statement (.NET Namespace and Type)](../VS_csharp/imports-statement--.net-namespace-and-type-.md) to use a namespace in a single source-code file.  
...
## Example  
 ...
 [!code[VbVbalrCompiler#21](../VS_csharp/codesnippet/VisualBasic/-imports--visual-basic-_1.vb)]  
