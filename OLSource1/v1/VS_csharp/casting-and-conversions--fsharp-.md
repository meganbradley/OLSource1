...
## Arithmetic Types  
 ...
 [!code[FsLangRef2#4401](../VS_csharp/codesnippet/FSharp/casting-and-conversions--fsharp-_1.fs)]  
...
## Enumerated Types  
 ...
 [!code[FsLangRef2#4402](../VS_csharp/codesnippet/FSharp/casting-and-conversions--fsharp-_2.fs)]  
...
```  
 ...
 For more information, see [Enumerations (F#)](../VS_csharp/enumerations--fsharp-.md).  
...
### Upcasting  
 In many object-oriented languages, upcasting is implicit; in F#, the rules are slightly different. Upcasting is applied automatically when you pass arguments to methods on an object type. However, for let-bound functions in a module, upcasting is not automatic, unless the parameter type is declared as a flexible type. For more information, see [Flexible Types (F#)](../VS_csharp/flexible-types--fsharp-.md).  
...
### Downcasting  
 ...
 [!code[FsLangRef2#4403](../VS_csharp/codesnippet/FSharp/casting-and-conversions--fsharp-_3.fs)]  
 ...
 For more information about type tests, see [Pattern Matching (F#)](../VS_csharp/match-expressions--fsharp-.md).  
