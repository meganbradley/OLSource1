...
## Remarks  
 ...
 To change whether the application redirects registry access, use [AfxSetPerUserRegistration](../VS_csharp/afxsetperuserregistration.md).  
...
## See Also  
 ...
 [AfxSetPerUserRegistration](../VS_csharp/afxsetperuserregistration.md)   
