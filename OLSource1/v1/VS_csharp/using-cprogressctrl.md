...
You can use the progress control to indicate the progress of a lengthy operation. It is a rectangle that is gradually filled with the system highlight color as the operation progresses.  
 ...
 The progress control is represented in MFC by class [CProgressCtrl](../VS_csharp/cprogressctrl-class.md).  
...
-   [Styles for the Progress Control](../VS_csharp/styles-for-the-progress-control.md)  
  
-   [Settings for the Progress Control](../VS_csharp/settings-for-the-progress-control.md)  
  
-   [Manipulating the Progress Control](../VS_csharp/manipulating-the-progress-control.md)  
