...
##  <a name="vcreferrortrappingviaerrorobjects"></a> Error Trapping Through Error Objects  
 Both ADO and RDO have error objects. When generating [wrapper classes](../VS_csharp/wrapper-classes.md), the RDO RemoteData control generates wrappers for error objects, but the ADO data control does not.  
