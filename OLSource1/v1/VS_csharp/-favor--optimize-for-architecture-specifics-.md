...
>  Intel64 architecture was previously known as Extended Memory 64 Technology, and the corresponding compiler option was **/favor:EM64T**.  
 ...
 For information about how to program for the [!INCLUDE[vcprx64](../VS_csharp/includes/vcprx64_md.md)] architecture, see [x64 Software Conventions](../VS_csharp/x64-software-conventions.md).  
