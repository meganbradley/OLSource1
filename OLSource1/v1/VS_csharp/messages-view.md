...
Each window has an associated message stream. A Messages view window displays this message stream. The window handle, message code, and message are shown. You can create a Messages view for a thread or process as well. This allows you to view messages sent to all windows owned by a specific process or thread, which is particularly useful for capturing window initialization messages.  
 ...
 A typical Messages view window appears below. Note that the first column contains the window handle, and the second column contains a message code (explained in [Message Codes](../VS_csharp/message-codes.md)). Decoded message parameters and return values are on the right.  
  
 ![Spy&#43;&#43; Messages View](../VS_csharp/media/spy--_messagesview.png "Spy++_MessagesView")  
Spy++ Messages View  
...
1.  Move the focus to a [Windows View](../VS_csharp/windows-view.md), [Processes View](../VS_csharp/processes-view.md), or [Threads View](../VS_csharp/threads-view.md) window.  
  
2.  Find the node for the item whose messages you want to examine, and select it.  
  
3.  From the **Spy** menu, choose **Log Messages**.  
  
     The [Message Options Dialog Box](../VS_csharp/message-options-dialog-box.md) opens.  
...
## In This Section  
 [Controlling Messages View](../VS_csharp/how-to--control-messages-view.md)  
 ...
 [Searching for a Message in Messages View](../VS_csharp/how-to--search-for-a-message-in-messages-view.md)  
 Explains how to find a specific message in Messages view.  
  
 [Starting and Stopping the Message Log Display](../VS_csharp/how-to--start-and-stop-the-message-log-display.md)  
 Explains how to start and stop message logging.  
  
 [Message Codes](../VS_csharp/message-codes.md)  
 Defines the codes for messages listed in Messages view.  
  
 [Displaying Message Properties](../VS_csharp/how-to--display-message-properties.md)  
...
## Related Sections  
 ...
 [Message Options Dialog Box](../VS_csharp/message-options-dialog-box.md)  
 Used to select which messages are listed in the active Messages view.  
  
 [Message Search Dialog Box](../VS_csharp/message-search-dialog-box.md)  
 Used to find the node for a specific message in Messages view.  
  
 [Message Properties Dialog Box](../VS_csharp/message-properties-dialog-box.md)  
