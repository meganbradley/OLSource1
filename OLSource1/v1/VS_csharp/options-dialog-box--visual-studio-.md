...
## How options are applied  
 Clicking OK in the **Options** dialog box saves all settings on all pages. Clicking Cancel on any page cancels all change requests, including any just made on other **Options** pages. Some changes to option settings, such as those made on [Fonts and Colors, Environment, Options Dialog Box](../VS_csharp/fonts-and-colors--environment--options-dialog-box.md), will only take effect after you close and reopen Visual Studio.  
