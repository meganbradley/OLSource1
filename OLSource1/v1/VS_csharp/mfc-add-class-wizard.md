 ...
 **Base class**  
 Specifies the name of the base class for the new class. By default, the base class is [CWnd](../VS_csharp/cwnd-class.md). The base class you select determines whether other boxes on this page are active.  
...
-   Classes such as [CButton](../VS_csharp/cbutton-class.md), [CWnd](../VS_csharp/cwnd-class.md), or [CDocument](../VS_csharp/cdocument-class.md), which do not require a dialog ID or resource ID. These classes do not use a dialog or resource ID. If you select one of these classes for your base class, the **Dialog ID** box and the **DHTML resource ID** box are dimmed.  
  
-   Classes such as [CDialog](../VS_csharp/cdialog-class.md), [CFormView](../VS_csharp/cformview-class.md), or [CPropertyPage](../VS_csharp/cpropertypage-class.md), which require a dialog ID.  
  
-   The class [CDHtmlDialog](../VS_csharp/cdhtmldialog-class.md), which requires a dialog ID, a DHTML resource ID, and an HTML file name.  
  
 For classes requiring a dialog ID, you might find it more efficient to use the [Resource editor](../VS_csharp/resource-editors.md) to create the dialog resource, assign its ID in the [Properties window](../VS_csharp/properties-window.md), and then create a class associated with that resource ID. See [Creating a New Dialog Box](../VS_csharp/creating-a-new-dialog-box.md) for more information on creating a standard Windows dialog box.  
 ...
 **Active accessibility**  
 Enables MFC's support for Active Accessibility by calling [EnableActiveAccessibility](../Topic/CWnd::EnableActiveAccessibility.md) in the constructor. This option is available for classes derived from [CWnd](../VS_csharp/cwnd-class.md).  
 ...
 **Automation**  
 Sets the class level of support for [Automation](../VS_csharp/automation.md). Automation at the class level is available for all classes that support Automation. It is also available for projects created with support for Automation. That is, either an MFC project that [supports ATL](../VS_csharp/mfc-support-in-atl-projects.md), or an MFC project for which you selected the **Automation** check box in the [Advanced Features](../VS_csharp/advanced-features--mfc-application-wizard.md) page of the MFC Application Wizard.  
 ...
 **Generate DocTemplate resources**  
 Indicates that the documents created by the application have document template resources. To activate this check box, the project must support the MFC document/view architecture, and the base class of this class must be [CFormView](../VS_csharp/cformview-class.md).  
  
 See [Document Templates and the Document/View Creation Process](../VS_csharp/document-templates-and-the-document-view-creation-process.md) for more information.  
