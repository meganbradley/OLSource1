...
## Microsoft Specific  
 ...
 When compiling with [/clr:pure](../VS_csharp/-clr--common-language-runtime-compilation-.md), all functions and function pointers are `__clrcall` unless specified otherwise.  
 ...
 On ARM and [!INCLUDE[vcprx64](../VS_csharp/includes/vcprx64_md.md)] machines, `__thiscall` is accepted and ignored by the compiler.  
