...
The C run-time library provides extensive debugging support. To use one of the CRT debug libraries, you must link with [/DEBUG](../VS_csharp/-debug--generate-debug-info-.md) and compile with **/MDd**, **/MTd**, or **/LDd**.  
...
## Remarks  
 ...
 For more information on the various run-time libraries you can use, see [C Run-Time Libraries](../VS_csharp/crt-library-features.md).  
