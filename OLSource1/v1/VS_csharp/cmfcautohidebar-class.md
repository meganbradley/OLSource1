...
|[CMFCAutoHideBar::CalcFixedLayout](#cmfcautohidebar__calcfixedlayout)|(Overrides [CBasePane::CalcFixedLayout](../VS_csharp/cbasepane-class.md#cbasepane__calcfixedlayout).)|  
|[CMFCAutoHideBar::Create](#cmfcautohidebar__create)|Creates a control bar and attaches it to the [CPane](../VS_csharp/cpane-class.md) object. (Overrides [CPane::Create](../VS_csharp/cpane-class.md#cpane__create).)|  
...
|[CMFCAutoHideBar::OnShowControlBarMenu](#cmfcautohidebar__onshowcontrolbarmenu)|Called by the framework when a special pane menu is about to be displayed. (Overrides [CPane::OnShowControlBarMenu](../VS_csharp/cpane-class.md#cpane__onshowcontrolbarmenu).)|  
|[CMFCAutoHideBar::RemoveAutoHideWindow](#cmfcautohidebar__removeautohidewindow)||  
|[CMFCAutoHideBar::SetActiveInGroup](#cmfcautohidebar__setactiveingroup)|(Overrides [CPane::SetActiveInGroup](../VS_csharp/cpane-class.md#cpane__setactiveingroup).)|  
...
|[CMFCAutoHideBar::StretchPane](#cmfcautohidebar__stretchpane)|Stretches a pane vertically or horizontally. (Overrides [CBasePane::StretchPane](../VS_csharp/cbasepane-class.md#cbasepane__stretchpane).)|  
...
|Name|Description|  
|----------|-----------------|  
|[CMFCAutoHideBar::m_nShowAHWndDelay](#cmfcautohidebar__m_nshowahwnddelay)|The time delay between the moment when the user places the mouse cursor over a [CMFCAutoHideButton Class](../VS_csharp/cmfcautohidebutton-class.md) and the moment when the framework shows the associated window.|  
  
## Remarks  
 When the user switches a dock pane to auto-hide mode, the framework automatically creates a `CMFCAutoHideBar` object. It also creates the necessary [CAutoHideDockSite](../VS_csharp/cautohidedocksite-class.md) and [CMFCAutoHideButton](../VS_csharp/cmfcautohidebutton-class.md) objects. Each `CAutoHideDockSite` object is associated with an individual `CMFCAutoHideButton`.  
...
## Example  
 ...
 [!code[NVC_MFC_RibbonApp#26](../VS_csharp/codesnippet/CPP/cmfcautohidebar-class_1.cpp)]  
...
## Inheritance Hierarchy  
 ...
 [CMFCAutoHideBar](../VS_csharp/cmfcautohidebar-class.md)  
...
##  <a name="cmfcautohidebar__m_nshowahwnddelay"></a>  CMFCAutoHideBar::m_nShowAHWndDelay  
 The time delay between the moment when the user places the mouse cursor over a [CMFCAutoHideButton Class](../VS_csharp/cmfcautohidebutton-class.md) and the moment when the framework shows the associated window.  
...
### Remarks  
 See [CPane::SetActiveInGroup](../VS_csharp/cpane-class.md#cpane__setactiveingroup).  
...
## See Also  
 ...
 [CMFCAutoHideButton Class](../VS_csharp/cmfcautohidebutton-class.md)