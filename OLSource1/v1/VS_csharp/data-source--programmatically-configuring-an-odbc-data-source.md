...
```  
 ...
 For more information about creating tables, see [Data Source: Programmatically Creating a Table in an ODBC Data Source](../VS_csharp/data-source--programmatically-creating-a-table-in-an-odbc-data-source.md).  
