...
|MFC ActiveX control dispinterface|Provide your own or select either of the stock methods [DoClick](../Topic/COleControl::DoClick.md) and [Refresh](../Topic/COleControl::Refresh.md). See [MFC ActiveX Controls: Adding Stock Methods](../VS_csharp/mfc-activex-controls--adding-stock-methods.md) for more information.|  
...
## See Also  
 ...
 [IDL Attributes, Add Method Wizard](../VS_csharp/idl-attributes--add-method-wizard.md)