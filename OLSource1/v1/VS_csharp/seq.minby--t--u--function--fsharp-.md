...
Returns the lowest of all elements of the sequence, compared by using [Operators.min](../VS_csharp/operators.min--t--function--fsharp-.md) on the function result.  
