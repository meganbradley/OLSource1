...
## Suppressing Warnings for Visual Basic  
 You can hide specific compiler warnings for Visual Basic by editing the .vbproj file for the project. You can also use the [Compile Page, Project Designer](../VS_csharp/compile-page--project-designer--visual-basic-.md) to suppress warnings by category. For more information, see [Configuring Warnings in Visual Basic](../VS_csharp/configuring-warnings-in-visual-basic.md).  
...
8.  On the menu bar, choose **Build**, **Rebuild Solution**.  
 ...
 For more information, see [/nowarn](../VS_csharp/-nowarn.md).  
  
## See Also  
 [Walkthrough: Building an Application](../VS_csharp/walkthrough--building-an-application.md)   
 [How to: View, Save, and Configure Build Log Files](../VS_csharp/how-to--view--save--and-configure-build-log-files.md)   
 [Building Applications in Visual Studio](../VS_csharp/compiling-and-building-in-visual-studio.md)