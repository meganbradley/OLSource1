...
Specifies whether the [!INCLUDE[vsprvs](../VS_csharp/includes/vsprvs_md.md)] project system will generate a default name for the template in the **Add New Item** or **New Project** dialog box.  
...
## Remarks  
 ...
 Use the [DefaultName](../VS_csharp/defaultname-element--visual-studio-templates-.md) element to specify the default name of the project or item in the **Add New Item** and **New Project** dialog boxes.  
