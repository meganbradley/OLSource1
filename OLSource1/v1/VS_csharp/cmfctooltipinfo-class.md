...
|[CMFCToolTipInfo::m_bVislManagerTheme](#cmfctooltipinfo__m_bvislmanagertheme)|A Boolean variable that indicates whether the appearance of the tooltip should be controlled by a visual manager (see [CMFCVisualManager](../VS_csharp/cmfcvisualmanager-class.md)).|  
...
## Remarks  
 Use [CMFCToolTipCtrl](../VS_csharp/cmfctooltipctrl-class.md), `CMFCToolTipInfo`, and [CTooltipManager](../VS_csharp/ctooltipmanager-class.md) together to implement customized tooltips in your application. For an example of how to use these tooltip classes, see the [CMFCToolTipCtrl](../VS_csharp/cmfctooltipctrl-class.md) topic.  
  
## Example  
 The following example demonstrates how to set the values of the various member variables in the `CMFCToolTipInfo` class.  
  
 [!code[NVC_MFC_RibbonApp#42](../VS_csharp/codesnippet/CPP/cmfctooltipinfo-class_1.cpp)]  
  
## Inheritance Hierarchy  
 [CMFCToolTipInfo](../VS_csharp/cmfctooltipinfo-class.md)  
...
### Remarks  
 Set this member to `TRUE` to display the description, or `FALSE` to hide the description. You can specify the description on a tooltip by calling [CMFCToolTipCtrl::SetDescription](../VS_csharp/cmfctooltipctrl-class.md#cmfctooltipctrl__setdescription)  
...
### Remarks  
 If `m_bVislManagerTheme` is `TRUE`, every tooltip requests a new [CMFCToolTipInfo](../VS_csharp/cmfctooltipinfo-class.md) from the visual manager of the application before they appear on the screen, and uses the values in that object to determine their appearance. The other members of your [CMFCToolTipInfo](../VS_csharp/cmfctooltipinfo-class.md) are ignored.  
...
## See Also  
 ...
 [CTooltipManager](../VS_csharp/ctooltipmanager-class.md)   
 [CMFCToolTipCtrl](../VS_csharp/cmfctooltipctrl-class.md)