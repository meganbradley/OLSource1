...
---
# CNoMultipleResults Class
Used as a template argument (*TMultiple*) to [CCommand](../VS_csharp/ccommand-class.md) to create an optimized command that handles a single result set.  
...
## Remarks  
 If you want a command to handle multiple result sets, use [CMultipleResults](../VS_csharp/cmultipleresults-class.md) instead.  
