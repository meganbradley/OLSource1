...
## Remarks  
 These flags are passed as a parameter to the [IDebugModule3::GetSymbolInfo](../VS_csharp/idebugmodule3--getsymbolinfo.md) method to determine the amount of information returned.  
