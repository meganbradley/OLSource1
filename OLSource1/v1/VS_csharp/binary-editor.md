...
-   [Open a resource for binary editing](../VS_csharp/opening-a-resource-for-binary-editing.md)  
  
-   [Edit binary data](../VS_csharp/editing-binary-data.md)  
  
-   [Find binary data](../VS_csharp/finding-binary-data.md)  
  
-   [Create a new custom or data resource](../VS_csharp/creating-a-new-custom-or-data-resource.md)  
  
## Managed Resources  
 You can use the [Image editor](../VS_csharp/image-editor-for-icons.md) and the Binary editor to work with resource files in managed projects. Any managed resources you want to edit must be linked resources. The Visual Studio resource editors do not support editing embedded resources.  
