...
Operator 'operator' cannot be applied to operands of type 'type' and 'type'  
 ...
 If you encounter this error with a class type, it is because the class does not overload the operator. For more information, see [Overloadable Operators](../VS_csharp/overloadable-operators--csharp-programming-guide-.md).  
