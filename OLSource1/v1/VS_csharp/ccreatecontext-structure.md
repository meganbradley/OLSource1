...
-   For member functions involved in view creation, you must provide enough information to create the view. For example, for the first view in a splitter window, you must supply the view class information and the current document.  
 ...
 For more information on `CCreateContext`, see the MFC sample [VIEWEX](../VS_csharp/visual-c---samples.md).  
...
## See Also  
 ...
 [CFrameWnd::Create](../VS_csharp/cframewnd-class.md#cframewnd__create)   
 [CFrameWnd::LoadFrame](../VS_csharp/cframewnd-class.md#cframewnd__loadframe)   
 [CFrameWnd::OnCreateClient](../VS_csharp/cframewnd-class.md#cframewnd__oncreateclient)   
 [CSplitterWnd::Create](../VS_csharp/csplitterwnd-class.md#csplitterwnd__create)   
 [CSplitterWnd::CreateView](../VS_csharp/csplitterwnd-class.md#csplitterwnd__createview)   
 [CWnd::Create](../VS_csharp/cwnd-class.md#cwnd__create)