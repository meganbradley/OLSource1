...
## Remarks  
 ...
 You should not create a `CContextMenuManager` object manually. The framework of your application creates the `CContextMenuManager` object. However, you should call [CWinAppEx::InitContextMenuManager](../VS_csharp/cwinappex-class.md#cwinappex__initcontextmenumanager) when your application is initialized. After initializing the context manager, use the method [CWinAppEx::GetContextMenuManager](../VS_csharp/cwinappex-class.md#cwinappex__getcontextmenumanager) to obtain a pointer to the context manager for your application.  
...
## Example  
 The following example demonstrates how to add a menu to a `CContextMenuManager` object, and how not to close the active pop-up menu when the `CContextMenuManager` object displays a new pop-up menu. This code snippet is part of the [Custom Pages sample](../VS_csharp/visual-c---samples.md).  
  
 [!code[NVC_MFC_CustomPages#4](../VS_csharp/codesnippet/CPP/ccontextmenumanager-class_1.cpp)]  
  
## Inheritance Hierarchy  
 [CObject](../VS_csharp/cobject-class.md)  
  
 [CContextMenuManager](../VS_csharp/ccontextmenumanager-class.md)  
  
## Requirements  
 **Header:** afxcontextmenumanager.h  
  
##  <a name="ccontextmenumanager__addmenu"></a>  CContextMenuManager::AddMenu  
 Adds a new shortcut menu to the [CContextMenuManager](../VS_csharp/ccontextmenumanager-class.md).  
...
##  <a name="ccontextmenumanager__ccontextmenumanager"></a>  CContextMenuManager::CContextMenuManager  
 Constructs a [CContextMenuManager](../VS_csharp/ccontextmenumanager-class.md) object.  
...
### Remarks  
 In most cases, you should not create a `CContextMenuManager` manually. The framework of your application creates the `CContextMenuManager` object. You should call [CWinAppEx::InitContextMenuManager](../VS_csharp/cwinappex-class.md#cwinappex__initcontextmenumanager) during the initialization of your application. To get a pointer to the context manager, call [CWinAppEx::GetContextMenuManager](../VS_csharp/cwinappex-class.md#cwinappex__getcontextmenumanager).  
...
##  <a name="ccontextmenumanager__getmenunames"></a>  CContextMenuManager::GetMenuNames  
 Returns the list of menu names added to the [CContextMenuManager](../VS_csharp/ccontextmenumanager-class.md).  
...
### Parameters  
 [out] `listOfNames`  
 A reference to a [CStringList](../VS_csharp/cstringlist-class.md) parameter. This method writes the list of menu names to this parameter.  
  
##  <a name="ccontextmenumanager__loadstate"></a>  CContextMenuManager::LoadState  
 Loads information associated with the [CContextMenuManager Class](../VS_csharp/ccontextmenumanager-class.md) from the Windows registry.  
...
### Remarks  
 The `lpszProfileName` parameter is not the absolute path for a registry entry. It is a relative path that is added to the end of the default registry key for your application. To get or set the default registry key, use the methods [CWinAppEx::GetRegistryBase](../VS_csharp/cwinappex-class.md#cwinappex__getregistrybase) and [CWinAppEx::SetRegistryBase](../VS_csharp/cwinappex-class.md#cwinappex__setregistrybase) respectively.  
...
##  <a name="ccontextmenumanager__resetstate"></a>  CContextMenuManager::ResetState  
 Clears all items from the shortcut menus associated with the [CContextMenuManager Class](../VS_csharp/ccontextmenumanager-class.md).  
...
##  <a name="ccontextmenumanager__savestate"></a>  CContextMenuManager::SaveState  
 Saves information associated with the [CContextMenuManager Class](../VS_csharp/ccontextmenumanager-class.md) to the Windows registry.  
...
##  <a name="ccontextmenumanager__setdontcloseactivemenu"></a>  CContextMenuManager::SetDontCloseActiveMenu  
 Controls whether the [CContextMenuManager](../VS_csharp/ccontextmenumanager-class.md) closes the active pop-up menu when it displays a new pop-up menu.  
...
### Return Value  
 The first method overload returns nonzero if the method shows the menu successfully; otherwise 0. The second method overload returns a pointer to [CMFCPopupMenu](../VS_csharp/cmfcpopupmenu-class.md) if the shortcut menu displays correctly; otherwise `NULL`.  
...
### Remarks  
 ...
 If the parameter `bAutoDestroy` is `FALSE`, you must manually call the inherited `DestroyMenu` method to release memory resources. The default implementation of `ShowPopupMenu` does not use the parameter `bAutoDestroy`. It is provided for future use or for custom classes derived from the [CContextMenuManager Class](../VS_csharp/ccontextmenumanager-class.md).  
...
## See Also  
 ...
 [CWinAppEx::InitContextMenuManager](../VS_csharp/cwinappex-class.md#cwinappex__initcontextmenumanager)