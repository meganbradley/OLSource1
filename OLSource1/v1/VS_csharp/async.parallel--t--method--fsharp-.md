...
#### Parameters  
 `computations`  
 Type: [seq](../VS_csharp/collections.seq--t--type-abbreviation--fsharp-.md)`<`[Async](../VS_csharp/control.async--t--type--fsharp-.md)`<'T>>`  
...
## Example  
 ...
 [!code[FsAsyncAPIs#32](../VS_csharp/codesnippet/FSharp/async.parallel--t--method--fsharp-_1.fs)]  
