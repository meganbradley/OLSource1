...
>  If you declare any member after `DECLARE_MESSAGE_MAP`, you must specify a new access type (**public**, `private`, or `protected`) for them.  
 ...
 For more information on message maps and the `DECLARE_MESSAGE_MAP` macro, see [Message Handling and Mapping Topics](../VS_csharp/message-handling-and-mapping.md).  
  
## Example  
 [!code[NVC_MFCWindowing#136](../VS_csharp/codesnippet/CPP/declare_message_map_1.h)]  
