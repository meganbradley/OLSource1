...
## Remarks  
 Start your snap-in extension data class map with the [BEGIN_EXTENSION_SNAPIN_NODEINFO_MAP](../VS_csharp/begin_extension_snapin_nodeinfo_map.md) macro, add entries for each of your snap-in extension data types with the `EXTENSION_SNAPIN_NODEINFO_ENTRY` macro, and complete the map with the [END_EXTENSION_SNAPIN_NODEINFO_MAP](../VS_csharp/end_extension_snapin_nodeinfo_map.md) macro.  
  
## Example  
 See the example for [BEGIN_EXTENSION_SNAPIN_NODEINFO_MAP](../VS_csharp/begin_extension_snapin_nodeinfo_map.md).  
...
## See Also  
 ...
 [BEGIN_EXTENSION_SNAPIN_NODEINFO_MAP](../VS_csharp/begin_extension_snapin_nodeinfo_map.md)   
