...
## Remarks  
 ...
 If `type` is not one of the values listed in the table, this function invokes the invalid parameter handler, as described in [Parameter Validation](../VS_csharp/parameter-validation.md). If execution is allowed to continue, this function sets `errno` to `EINVAL` and returns -1.  
...
## See Also  
 ...
 [Multithreading and Locales](../VS_csharp/multithreading-and-locales.md)