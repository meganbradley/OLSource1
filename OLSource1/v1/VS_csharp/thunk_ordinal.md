...
## Remarks  
 The values in this enumeration are returned from a call to the [IDiaSymbol::get_thunkOrdinal](../VS_csharp/idiasymbol--get_thunkordinal.md) method.  
...
## See Also  
 ...
 [IDiaSymbol::get_thunkOrdinal](../VS_csharp/idiasymbol--get_thunkordinal.md)