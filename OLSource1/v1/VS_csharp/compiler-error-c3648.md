...
this explicit override syntax requires /clr:oldSyntax  
 ...
 For more information, see [Explicit Overrides](../VS_csharp/explicit-overrides---c---component-extensions-.md). For more information on the older syntax, see [Explicit Overrides](../VS_csharp/explicit-overrides--c---.md).  
