...
|[CMFCToolBarButton::Serialize](#cmfctoolbarbutton__serialize)|Reads this object from an archive or writes it to an archive. (Overrides [CObject::Serialize](../VS_csharp/cobject-class.md#cobject__serialize).)|  
...
## Remarks  
 ...
 Typically, toolbar buttons can be customized: the user can drag buttons from one toolbar to another, and copy, paste, delete, and edit text labels and images. To prevent the user from customizing the toolbar, you can lock the toolbar in one of two ways. Either set the `bLocked` flag to `TRUE` when you call [CMFCToolBar::LoadToolBar](../VS_csharp/cmfctoolbar-class.md#cmfctoolbar__loadtoolbar), or add the command ID of an individual button to the global list of protected commands by using the [CMFCToolBarButton::SetProtectedCommands](#cmfctoolbarbutton__setprotectedcommands) method.  
  
 `CMFCToolBarButton` objects display images from the global collections of toolbar images in the application. These collections are maintained by the parent toolbar, [CMFCToolBar](../VS_csharp/cmfctoolbar-class.md). For more information, see [CMFCToolBarImages](../VS_csharp/cmfctoolbarimages-class.md).  
 ...
 The `CMFCToolBarButton` class is the base class for other toolbar button classes, such as [CMFCToolbarMenuButton](../VS_csharp/cmfctoolbarmenubutton-class.md), [CMFCToolbarEditBoxButton](../VS_csharp/cmfctoolbareditboxbutton-class.md), and [CMFCToolbarComboBoxButton](../VS_csharp/cmfctoolbarcomboboxbutton-class.md).  
  
## Example  
 The following example demonstrates how to configure a `CMFCToolBarButton` object by using various methods in the `CMFCToolBarButton` class. The example illustrates how to enable the mouse and keyboard input, set the image index of the button, set the bounding rectangle of the button, and make the button visible. This code snippet is part of the [Tab Control sample](../VS_csharp/visual-c---samples.md).  
  
 [!code[NVC_MFC_TabControl#1](../VS_csharp/codesnippet/CPP/cmfctoolbarbutton-class_1.cpp)]  
[!code[NVC_MFC_TabControl#2](../VS_csharp/codesnippet/CPP/cmfctoolbarbutton-class_2.cpp)]  
...
### Remarks  
 ...
 The default implementation returns `TRUE`. Override this method if your button cannot be stored as part of a drag-and-drop operation. For more information about drag-and-drop operations, see [Drag and Drop (OLE)](../VS_csharp/drag-and-drop--ole-.md).  
...
### Remarks  
 ...
 For more information about customization mode, see [CMFCToolBar::SetCustomizeMode](../VS_csharp/cmfctoolbar-class.md#cmfctoolbar__setcustomizemode).  
...
### Remarks  
 This method calls the `EnableWindow` function to enable or disable input. For more information, see                         [EnableWindow](http://msdn.microsoft.com/library/windows/desktop/ms646291) in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Remarks  
 ...
 The default implementation of this method returns `TRUE`. Override this method if you want to take additional actions when the framework converts an object that is derived from [CMFCToolbarButton](../VS_csharp/cmfctoolbarbutton-class.md) to a menu button.  
...
### Remarks  
 ...
 For more information about clipboards in MFC, see [Clipboard](../VS_csharp/clipboard.md).  
...
### Remarks  
 The framework calls this method to determine whether the user can customize the toolbar button by using drag-and-drop or edit operations. Set the locked attribute on the parent toolbar by using the [CMFCToolBar::LoadToolBar,](../VS_csharp/cmfctoolbar-class.md#cmfctoolbar__loadtoolbar) method. The framework passes the value of this attribute to the constructor of each toolbar button ( [CMFCToolbarButton](../VS_csharp/cmfctoolbarbutton-class.md)) that it inserts into the parent toolbar.  
...
### Remarks  
 You can show or hide the toolbar button by using the [SetVisible](#cmfctoolbarbutton__setvisible) method. Call the [CPane::AdjustSizeImmediate](../VS_csharp/cpane-class.md#cpane__adjustsizeimmediate) method on the parent toolbar after you call [SetVisible](#cmfctoolbarbutton__setvisible) to recalculate the layout of a parent toolbar.  
...
### Remarks  
 See [ToolBar Control Styles](../VS_csharp/toolbar-control-styles.md) for the list of available toolbar button styles.  
...
### Remarks  
 ...
 The framework calls this method when the toolbar framework is in customization mode and the toolbar button is unlocked. For more information about customization mode, see [CMFCToolBar::SetCustomizeMode](../VS_csharp/cmfctoolbar-class.md#cmfctoolbar__setcustomizemode). For more information about locking toolbar buttons, see [CMFCToolBarButton::IsLocked](#cmfctoolbarbutton__islocked).  
...
-   [CMDIFrameWndEx::OnMenuButtonToolHitTest](../VS_csharp/cmdiframewndex-class.md#cmdiframewndex__onmenubuttontoolhittest)  
  
-   [CFrameWndEx::OnMenuButtonToolHitTest](../VS_csharp/cframewndex-class.md#cframewndex__onmenubuttontoolhittest)  
  
-   [COleIPFrameWndEx::OnMenuButtonToolHitTest](../VS_csharp/coleipframewndex-class.md#coleipframewndex__onmenubuttontoolhittest)  
...
### Remarks  
 The framework calls this method to prepare the toolbar button to store its state in the provided `COleDataSource` object. This method stores its state by serializing itself to a shared file and then passing that file to the [COleDataSource::CacheGlobalData](../VS_csharp/coledatasource-class.md#coledatasource__cacheglobaldata) method. For more information about toolbar button serialization, see [CMFCToolBarButton::Serialize](#cmfctoolbarbutton__serialize).  
 ...
 For more information about OLE drag-and-drop operations, see [Drag and Drop (OLE)](../VS_csharp/drag-and-drop--ole-.md).  
...
### Remarks  
 This method retrieves the default image from its parent toolbar by using the [CMFCToolBar::GetDefaultImage](../VS_csharp/cmfctoolbar-class.md#cmfctoolbar__getdefaultimage) method. If the button has no associated default image, this method sets the text label of the button according to its string resource by using the [CStringT::LoadString](../Topic/CStringT::LoadString.md) method. For more information about string resources, see [Working with Resource Files](../VS_csharp/working-with-resource-files.md).  
...
### Remarks  
 ...
 For serialization examples, see [Serialization: Serializing an Object](../VS_csharp/serialization--serializing-an-object.md).  
...
### Remarks  
 Use this function to hide or show a particular toolbar button. Call the [CPane::AdjustSizeImmediate](../VS_csharp/cpane-class.md#cpane__adjustsizeimmediate) method after you call this method.  
...
## See Also  
 ...
 [CMFCToolBarImages](../VS_csharp/cmfctoolbarimages-class.md)   
