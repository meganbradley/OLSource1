...
## Microsoft Specific  
 If your program does not take command-line arguments, you can save a small amount of space by suppressing use of the library routine that performs command-line processing. This routine is called **_setargv** and is described in [Wildcard Expansion](../VS_csharp/wildcard-expansion.md). To suppress its use, define a routine that does nothing in the file containing the **main** function, and name it **_setargv**. The call to **_setargv** is then satisfied by your definition of **_setargv**, and the library version is not loaded.  
