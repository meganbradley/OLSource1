...
>  Because of the improved lookup behavior implemented in Visual Studio .NET, code such as `bstr = L"String2" + bstr;`, which may have compiled in previous releases, should instead be implemented as `bstr = CStringW(L"String2") + bstr`.  
 ...
 For a list of cautions when using `CComBSTR`, see [Programming with CComBSTR](../VS_csharp/programming-with-ccombstr--atl-.md).  
...
### Example  
 [!code[NVC_ATL_Utilities#32](../VS_csharp/codesnippet/CPP/ccombstr-class_1.cpp)]  
...
### Example  
 [!code[NVC_ATL_Utilities#33](../VS_csharp/codesnippet/CPP/ccombstr-class_2.cpp)]  
...
### Example  
 [!code[NVC_ATL_Utilities#34](../VS_csharp/codesnippet/CPP/ccombstr-class_3.cpp)]  
...
### Example  
 [!code[NVC_ATL_Utilities#35](../VS_csharp/codesnippet/CPP/ccombstr-class_4.cpp)]  
...
### Example  
 [!code[NVC_ATL_Utilities#36](../VS_csharp/codesnippet/CPP/ccombstr-class_5.cpp)]  
...
### Example  
 [!code[NVC_ATL_Utilities#37](../VS_csharp/codesnippet/CPP/ccombstr-class_6.cpp)]  
...
### Example  
 [!code[NVC_ATL_Utilities#38](../VS_csharp/codesnippet/CPP/ccombstr-class_7.cpp)]  
...
### Example  
 [!code[NVC_ATL_Utilities#39](../VS_csharp/codesnippet/CPP/ccombstr-class_8.cpp)]  
...
### Example  
 [!code[NVC_ATL_Utilities#40](../VS_csharp/codesnippet/CPP/ccombstr-class_9.cpp)]  
...
### Example  
 [!code[NVC_ATL_Utilities#41](../VS_csharp/codesnippet/CPP/ccombstr-class_10.cpp)]  
...
### Example  
 [!code[NVC_ATL_Utilities#42](../VS_csharp/codesnippet/CPP/ccombstr-class_11.cpp)]  
...
### Parameters  
 See [LoadString](http://msdn.microsoft.com/library/windows/desktop/ms647486) in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
  
### Return Value  
 Returns **true** if the string is successfully loaded; otherwise, returns **false**.  
  
### Remarks  
 The first function loads the resource from the module identified by you via the `hInst` parameter. The second function loads the resource from the resource module associated with the [CComModule](../VS_csharp/ccommodule-class.md)-derived object used in this project.  
  
### Example  
 [!code[NVC_ATL_Utilities#43](../VS_csharp/codesnippet/CPP/ccombstr-class_12.cpp)]  
...
### Example  
 [!code[NVC_ATL_Utilities#49](../VS_csharp/codesnippet/CPP/ccombstr-class_13.cpp)]  
...
### Example  
 [!code[NVC_ATL_Utilities#46](../VS_csharp/codesnippet/CPP/ccombstr-class_14.cpp)]  
  
 [!code[NVC_ATL_Utilities#47](../VS_csharp/codesnippet/CPP/ccombstr-class_15.cpp)]  
...
### Example  
 [!code[NVC_ATL_Utilities#48](../VS_csharp/codesnippet/CPP/ccombstr-class_16.cpp)]  
...
### Example  
 [!code[NVC_ATL_Utilities#44](../VS_csharp/codesnippet/CPP/ccombstr-class_17.cpp)]  
...
### Example  
 [!code[NVC_ATL_Utilities#45](../VS_csharp/codesnippet/CPP/ccombstr-class_18.cpp)]  
  
## See Also  
 [Class Overview](../VS_csharp/atl-class-overview.md)   
 [ATL and MFC String Conversion Macros](../VS_csharp/atl-and-mfc-string-conversion-macros.md)