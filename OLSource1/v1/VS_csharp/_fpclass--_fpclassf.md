...
## Remarks  
 The `_fpclass` and `_fpclassf` functions are Microsoft specific. They are similar to [fpclassify](../VS_csharp/fpclassify.md), but return more detailed information about the argument. The `_fpclassf` function is only available when compiled for the x64 platform.  
...
|`_fpclass`|<float.h>|  
 ...
 For more compatibility and conformance information, see [Compatibility](../VS_csharp/compatibility.md).  
