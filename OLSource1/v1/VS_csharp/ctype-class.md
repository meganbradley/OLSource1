...
-   [ctype](../VS_csharp/ctype-char--class.md)< `char`>, an explicit specialization whose differences are described separately.  
...
-   \> 0: These values are not defined.  
 ...
 The constructor initializes its `locale::facet` base object with **locale::**[facet](../VS_csharp/locale-class.md#facet_class)( `_Refs`).  
...
### Remarks  
 The mask values classifying the attributes of the characters are provided by the class [ctype_base](../VS_csharp/ctype_base-class.md), from which ctype derives. The first member function can accept expressions for its first parameter referred to as bitmasks and formed from the combination of mask values by the logical bitwise operators (&#124; , & , ^ , ~).  
...
### Remarks  
 The mask values classifying the attributes of the characters are provided by the class [ctype_base Class](../VS_csharp/ctype_base-class.md), from which ctype derives. The first member function can accept expressions for its first parameter referred to as bitmasks and formed from the combination of mask values by the logical bitwise operators (&#124; , & , ^ , ~).  
