...
2.  In Select features, expand **Cross Platform Mobile Development** and check **Visual C++ Mobile Development**.  
     ...
     ![Select Visual C&#43;&#43; Mobile Development](../VS_csharp/media/cppmdd_install_vcmdd.png "CPPMDD_Install_VCMDD")  
...
2.  In the **Options** dialog box, expand **Cross Platform**, **C++**, and select **Android**.  
     ...
     ![Android tool path options](../VS_csharp/media/cppmdd_options_android.PNG "CPPMDD_Options_Android")  
...
## See Also  
 [Install and Configure Tools to Build using iOS](../VS_csharp/install-and-configure-tools-to-build-using-ios.md)   
