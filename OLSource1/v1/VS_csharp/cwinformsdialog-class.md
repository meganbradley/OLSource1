...
## Remarks  
 `CWinFormsDialog` is a wrapper for an MFC dialog class ( [CDialog](../VS_csharp/cdialog-class.md)) that hosts a Windows Forms ( <xref:System.Windows.Forms.UserControl*>) user control. This allows the display of .NET Framework controls on a modal or modeless MFC dialog box.  
  
 For more information on using Windows Forms, see [Using Windows Forms in MFC](../VS_csharp/using-a-windows-form-user-control-in-mfc.md) and [Hosting a Windows Form User Control as an MFC Dialog Box](../VS_csharp/hosting-a-windows-form-user-control-as-an-mfc-dialog-box.md).  
...
### Parameters  
 `nIDTemplate`  
 Contains the ID of a dialog box template resource. Use the dialog editor to create the dialog template and store it in the application's resource script file. For more information on dialog templates, see [CDialog Class](../VS_csharp/cdialog-class.md).  
...
### Remarks  
 When the MFC dialog box is created (using the [Create](../VS_csharp/cdialog-class.md#cdialog__create), [CreateIndirect](../VS_csharp/cdialog-class.md#cdialog__createindirect), or [DoModal](../VS_csharp/cdialog-class.md#cdialog__domodal) method inherited from [CDialog](../VS_csharp/cdialog-class.md)), a `WM_INITDIALOG` message is sent and this method is called. It creates an instance of a <xref:System.Windows.Forms.UserControl*> control on the dialog box and adjusts the size of the dialog box to accommodate for the size of the user control. Then it hosts the new control in the MFC dialog box.  
  
 Override this member function if you need to perform special processing when the dialog box is initialized. For more information on using this method, see [CDialog::OnInitDialog](../VS_csharp/cdialog-class.md#cdialog__oninitdialog).  
...
### Remarks  
 ...
 For information on using Windows Forms, see [Using a Windows Form User Control in MFC](../VS_csharp/using-a-windows-form-user-control-in-mfc.md).  
...
## See Also  
 ...
 [CDialog Class](../VS_csharp/cdialog-class.md)