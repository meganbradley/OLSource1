...
|-|-|  
|Name|Description|  
|[CMFCRibbonSeparator::AddToListBox](#cmfcribbonseparator__addtolistbox)|Adds a separator to the **Commands** list in the **Customize** dialog box. (Overrides [CMFCRibbonBaseElement::AddToListBox](../VS_csharp/cmfcribbonbaseelement-class.md#cmfcribbonbaseelement__addtolistbox).)|  
|`CMFCRibbonSeparator::CreateObject`|Used by the framework to create a dynamic instance of this class type.|  
|`CMFCRibbonSeparator::GetThisClass`|Used by the framework to obtain a pointer to the [CRuntimeClass](../VS_csharp/cruntimeclass-structure.md) object that is associated with this class type.|  
...
```  
 ...
 Call [CMFCRibbonPanel::AddSeparator](../VS_csharp/cmfcribbonpanel-class.md#cmfcribbonpanel__addseparator) to add separators to ribbon panels. The separators are allocated and added internally by the `AddSeparator` method.  
...
## Inheritance Hierarchy  
 ...
 [CMFCRibbonSeparator](../VS_csharp/cmfcribbonseparator-class.md)  
...
### Example  
 ...
 [!code[NVC_MFC_RibbonApp#19](../VS_csharp/codesnippet/CPP/cmfcribbonseparator-class_1.cpp)]  
