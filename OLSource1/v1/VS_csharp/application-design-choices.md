...
-   [Client Data Download Services](#_core_client_data_download_services)  
 ...
 If you are ready to start writing your program now, see [Writing MFC Applications](../VS_csharp/writing-mfc-applications.md).  
...
|-----------------------|----------------------------|-------------------------|  
|[Internet Downloading Using Asynchronous Monikers](../VS_csharp/asynchronous-monikers-on-the-internet.md)|For asynchronous transfer using COM, ActiveX controls, and any Internet protocol.|[CAsyncMonikerFile](../VS_csharp/casyncmonikerfile-class.md), [CDataPathProperty](../VS_csharp/cdatapathproperty-class.md)|  
|[WinInet](../VS_csharp/win32-internet-extensions--wininet-.md)|For Internet protocols for HTTP, FTP, and gopher. Data can be transferred synchronously or asynchronously and is stored in a system-wide cache.|[CInternetSession](../VS_csharp/cinternetsession-class.md), [CFtpFileFind](../VS_csharp/cftpfilefind-class.md), [CGopherFileFind](../VS_csharp/cgopherfilefind-class.md), and many more.|  
|[WinSock](../VS_csharp/windows-sockets-in-mfc.md)|For maximum efficiency and control. Requires understanding of sockets and TCP/IP protocols.|[CSocket](../VS_csharp/csocket-class.md), [CAsyncSocket](../VS_csharp/casyncsocket-class.md)|  
