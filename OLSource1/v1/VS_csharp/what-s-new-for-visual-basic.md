...
## Current Version  
 ...
 [Multi-line String Literals](../VS_csharp/string-basics-in-visual-basic.md)  
 ...
 [TypeOf <expr\> IsNot <type\>](../VS_csharp/typeof-operator--visual-basic-.md)  
 For more readability of your code, you can now use `TypeOf` with `IsNot`.  
  
 [#Disable Warning <ID\> and #Enable Warning <ID\>](../VS_csharp/directives--visual-basic-.md)  
 ...
 [Partial Module and Interface Definitions](../VS_csharp/partial--visual-basic-.md)  
 In addition to classes and structs, you can declare partial modules and interfaces.  
  
 [#Region Directives inside Method Bodies](../VS_csharp/sharpregion-directive.md)  
 You can put #Region…#End Region delimiters anywhere in a file, inside functions, and even spanning across function bodies.  
  
 [Overrides Definitions are Implicitly Overloads](../VS_csharp/overrides--visual-basic-.md)  
