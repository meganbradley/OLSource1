...
## Remarks  
 ...
 [!code[FsLangRef1#2301](../VS_csharp/codesnippet/FSharp/type-abbreviations--fsharp-_1.fs)]  
  
 Type abbreviations can include generic parameters, as in the following code.  
  
 [!code[FsLangRef1#2302](../VS_csharp/codesnippet/FSharp/type-abbreviations--fsharp-_2.fs)]  
 ...
 Type abbreviations can also be used on units of measure. For more information, see [Units of Measure](../VS_csharp/units-of-measure--fsharp-.md).  
