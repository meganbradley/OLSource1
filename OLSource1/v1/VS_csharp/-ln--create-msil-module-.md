...
## Remarks  
 ...
 When **/LN** is used, one of the [/clr](../VS_csharp/-clr--common-language-runtime-compilation-.md) options must also be used.  
  
 A managed program that does not have an assembly metadata in the manifest is called a module. If you compile with [/c (Compile Without Linking)](../VS_csharp/-c--compile-without-linking-.md) and **/LN**, specify [/NOASSEMBLY (Create a MSIL Module)](../VS_csharp/-noassembly--create-a-msil-module-.md) in the linker phase to create the output file.  
 ...
 In [!INCLUDE[vcprvc](../VS_csharp/includes/vcprvc_md.md)] releases before Visual C++ 2005, a module was created with **/clr:noAssembly**.  
...
-   Specify [/NOASSEMBLY (Create a MSIL Module)](../VS_csharp/-noassembly--create-a-msil-module-.md) in the linker phase to create the output file.  
