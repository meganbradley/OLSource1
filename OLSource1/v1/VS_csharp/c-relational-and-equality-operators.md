...
|`!=`|First operand not equal to second operand|  
 ...
 The first four operators in the list above have a higher precedence than the equality operators (`==` and `!=`). See the precedence information in the table [Precedence and Associativity of C Operators](../VS_csharp/precedence-and-order-of-evaluation.md).  
...
## See Also  
 [Relational Operators: <, >, <=, and >=](../VS_csharp/relational-operators---------=--and--=.md)   
 [Equality Operators: == and !=](../VS_csharp/equality-operators--==-and-!=.md)