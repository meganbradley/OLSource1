...
Use **typename** for qualified names in template definitions to tell the compiler that the given qualified name identifies a type. For more information, see [typename](../VS_csharp/typename.md).  
...
### Template Disambiguation  
 [!INCLUDE[cpp_dev11_long](../VS_csharp/includes/cpp_dev11_long_md.md)] enforces the C++98/03/11 standard rules for disambiguation with the "template" keyword. In the following example, [!INCLUDE[cpp_dev10_long](../VS_csharp/includes/cpp_dev10_long_md.md)] would accept both the nonconforming lines and the conforming lines.  [!INCLUDE[cpp_dev11_long](../VS_csharp/includes/cpp_dev11_long_md.md)] accepts only the conforming lines.  
...
## See Also  
 [Name Resolution](../VS_csharp/templates-and-name-resolution.md)