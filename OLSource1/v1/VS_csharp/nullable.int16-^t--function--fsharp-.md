...
Converts the argument to signed 16-bit integer ([int16](../VS_csharp/core.int16-type-abbreviation--fsharp-.md)). This is a direct conversion for all primitive numeric types. The operation requires an appropriate static conversion method on the input type.  
...
## See Also  
 ...
 [Operators.int16<^T> Function (F#)](../VS_csharp/operators.int16-^t--function--fsharp-.md)