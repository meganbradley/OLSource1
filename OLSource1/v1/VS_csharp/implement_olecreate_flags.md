...
---
# IMPLEMENT_OLECREATE_FLAGS
Either this macro or [IMPLEMENT_OLECREATE](../VS_csharp/implement_olecreate.md) must appear in the implementation file for any class that uses `DECLARE_OLECREATE`.  
...
## See Also  
 ...
 [DECLARE_OLECREATE](../VS_csharp/declare_olecreate.md)   
