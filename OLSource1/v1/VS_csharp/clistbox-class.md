...
## Remarks  
 ...
 If you want to handle Windows notification messages sent by a list box to its parent (usually a class derived from [CDialog](../VS_csharp/cdialog-class.md)), add a message-map entry and message-handler member function to the parent class for each message.  
...
-   **ON_LBN_DBLCLK** The user double-clicks a string in a list box. Only a list box that has the [LBS_NOTIFY](../VS_csharp/list-box-styles.md) style will send this notification message.  
...
### Remarks  
 If the list box was not created with the [LBS_SORT](../VS_csharp/list-box-styles.md) style, the string is added to the end of the list. Otherwise, the string is inserted into the list, and the list is sorted. If the list box was created with the **LBS_SORT** style but not the [LBS_HASSTRINGS](../VS_csharp/list-box-styles.md) style, the framework sorts the list by one or more calls to the `CompareItem` member function.  
  
 Use [InsertString](#clistbox__insertstring) to insert a string into a specific location within the list box.  
  
### Example  
 [!code[NVC_MFC_CListBox#3](../VS_csharp/codesnippet/CPP/clistbox-class_1.cpp)]  
...
-   Does not have the [LBS_HASSTRINGS](../VS_csharp/list-box-styles.md) style set.  
...
### Example  
 [!code[NVC_MFC_CListBox#4](../VS_csharp/codesnippet/CPP/clistbox-class_2.cpp)]  
...
### Example  
 [!code[NVC_MFC_CListBox#1](../VS_csharp/codesnippet/CPP/clistbox-class_3.cpp)]  
...
### Return Value  
 Indicates the relative position of the two items described in the [COMPAREITEMSTRUCT](../VS_csharp/compareitemstruct-structure.md) structure. It may be any of the following values:  
...
|1|Item 1 sorts after item 2.|  
 ...
 See [CWnd::OnCompareItem](../VS_csharp/cwnd-class.md#cwnd__oncompareitem) for a description of the `COMPAREITEMSTRUCT` structure.  
...
### Example  
 [!code[NVC_MFC_CListBox#5](../VS_csharp/codesnippet/CPP/clistbox-class_4.cpp)]  
...
### Parameters  
 `dwStyle`  
 Specifies the style of the list box. Apply any combination of [list-box styles](../VS_csharp/list-box-styles.md) to the box.  
...
### Remarks  
 ...
 When **Create** executes, Windows sends the [WM_NCCREATE](../VS_csharp/cwnd-class.md#cwnd__onnccreate), [WM_CREATE](../VS_csharp/cwnd-class.md#cwnd__oncreate), [WM_NCCALCSIZE](../VS_csharp/cwnd-class.md#cwnd__onnccalcsize), and [WM_GETMINMAXINFO](../VS_csharp/cwnd-class.md#cwnd__ongetminmaxinfo) messages to the list-box control.  
 ...
 Apply the following [window styles](../VS_csharp/window-styles.md) to a list-box control.  
...
### Example  
 [!code[NVC_MFC_CListBox#2](../VS_csharp/codesnippet/CPP/clistbox-class_5.cpp)]  
...
### Parameters  
 `lpDeleteItemStruct`  
 A long pointer to a Windows [DELETEITEMSTRUCT](../VS_csharp/deleteitemstruct-structure.md) structure that contains information about the deleted item.  
...
### Remarks  
 ...
 See [CWnd::OnDeleteItem](../VS_csharp/cwnd-class.md#cwnd__ondeleteitem) for a description of the `DELETEITEMSTRUCT` structure.  
  
### Example  
 [!code[NVC_MFC_CListBox#6](../VS_csharp/codesnippet/CPP/clistbox-class_6.cpp)]  
...
### Example  
 [!code[NVC_MFC_CListBox#7](../VS_csharp/codesnippet/CPP/clistbox-class_7.cpp)]  
...
### Parameters  
 `attr`  
 Can be any combination of the `enum` values described in **CFile::GetStatu**[s](../VS_csharp/cfile-class.md#cfile__getstatus), or any combination of the following values:  
...
### Example  
 [!code[NVC_MFC_CListBox#8](../VS_csharp/codesnippet/CPP/clistbox-class_8.cpp)]  
...
### Parameters  
 `lpDrawItemStruct`  
 A long pointer to a [DRAWITEMSTRUCT](../VS_csharp/drawitemstruct-structure.md) structure that contains information about the type of drawing required.  
...
### Remarks  
 ...
 See [CWnd::OnDrawItem](../VS_csharp/cwnd-class.md#cwnd__ondrawitem) for a description of the `DRAWITEMSTRUCT` structure.  
  
### Example  
 [!code[NVC_MFC_CListBox#9](../VS_csharp/codesnippet/CPP/clistbox-class_9.cpp)]  
...
### Example  
 [!code[NVC_MFC_CListBox#10](../VS_csharp/codesnippet/CPP/clistbox-class_10.cpp)]  
...
### Remarks  
 If the list box was created with an owner-draw style but without the [LBS_HASSTRINGS](../VS_csharp/list-box-styles.md) style, the `FindStringExact` member function attempts to match the doubleword value against the value of `lpszFind`.  
  
### Example  
 [!code[NVC_MFC_CListBox#11](../VS_csharp/codesnippet/CPP/clistbox-class_11.cpp)]  
...
### Example  
 [!code[NVC_MFC_CListBox#12](../VS_csharp/codesnippet/CPP/clistbox-class_12.cpp)]  
...
### Example  
 [!code[NVC_MFC_CListBox#13](../VS_csharp/codesnippet/CPP/clistbox-class_13.cpp)]  
...
### Example  
 [!code[NVC_MFC_CListBox#14](../VS_csharp/codesnippet/CPP/clistbox-class_14.cpp)]  
...
### Example  
 [!code[NVC_MFC_CListBox#15](../VS_csharp/codesnippet/CPP/clistbox-class_15.cpp)]  
...
### Example  
 [!code[NVC_MFC_CListBox#16](../VS_csharp/codesnippet/CPP/clistbox-class_16.cpp)]  
...
### Return Value  
 The height, in pixels, of the items in the list box. If the list box has the [LBS_OWNERDRAWVARIABLE](../VS_csharp/list-box-styles.md) style, the return value is the height of the item specified by `nIndex`. If an error occurs, the return value is **LB_ERR**.  
  
### Example  
 [!code[NVC_MFC_CListBox#17](../VS_csharp/codesnippet/CPP/clistbox-class_17.cpp)]  
...
### Parameters  
 ...
 `lpRect`  
 Specifies a long pointer to a [RECT](../VS_csharp/rect-structure.md) structure that receives the list-box client coordinates of the item.  
  
### Return Value  
 **LB_ERR** if an error occurs.  
  
### Example  
 [!code[NVC_MFC_CListBox#18](../VS_csharp/codesnippet/CPP/clistbox-class_18.cpp)]  
...
### Remarks  
 This member function emulates the functionality of the                         [LB_GETLISTBOXINFO](http://msdn.microsoft.com/library/windows/desktop/bb775208) message, as described in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Example  
 [!code[NVC_MFC_CListBox#19](../VS_csharp/codesnippet/CPP/clistbox-class_19.cpp)]  
...
### Example  
 [!code[NVC_MFC_CListBox#20](../VS_csharp/codesnippet/CPP/clistbox-class_20.cpp)]  
...
### Example  
 [!code[NVC_MFC_CListBox#21](../VS_csharp/codesnippet/CPP/clistbox-class_21.cpp)]  
...
### Example  
 [!code[NVC_MFC_CListBox#22](../VS_csharp/codesnippet/CPP/clistbox-class_22.cpp)]  
...
### Example  
 [!code[NVC_MFC_CListBox#23](../VS_csharp/codesnippet/CPP/clistbox-class_23.cpp)]  
...
### Remarks  
 Unlike the [AddString](#clistbox__addstring) member function, `InsertString` does not cause a list with the [LBS_SORT](../VS_csharp/list-box-styles.md) style to be sorted.  
  
### Example  
 [!code[NVC_MFC_CListBox#24](../VS_csharp/codesnippet/CPP/clistbox-class_24.cpp)]  
...
### Remarks  
 By default, this member function does nothing. Override this member function and fill in the `MEASUREITEMSTRUCT` structure to inform Windows of the list-box dimensions. If the list box is created with the [LBS_OWNERDRAWVARIABLE](../VS_csharp/list-box-styles.md) style, the framework calls this member function for each item in the list box. Otherwise, this member is called only once.  
  
 For further information about using the [LBS_OWNERDRAWFIXED](../VS_csharp/list-box-styles.md) style in an owner-draw list box created with the `SubclassDlgItem` member function of `CWnd`, see the discussion in [Technical Note 14](../VS_csharp/tn014--custom-controls.md).  
  
 See [CWnd::OnMeasureItem](../VS_csharp/cwnd-class.md#cwnd__onmeasureitem) for a description of the `MEASUREITEMSTRUCT` structure **.**  
  
### Example  
 [!code[NVC_MFC_CListBox#25](../VS_csharp/codesnippet/CPP/clistbox-class_25.cpp)]  
...
### Example  
 [!code[NVC_MFC_CListBox#26](../VS_csharp/codesnippet/CPP/clistbox-class_26.cpp)]  
...
### Remarks  
 ...
 This member function cannot be used with a list box that has the [LBS_MULTIPLESEL](../VS_csharp/list-box-styles.md) style.  
...
### Example  
 [!code[NVC_MFC_CListBox#27](../VS_csharp/codesnippet/CPP/clistbox-class_27.cpp)]  
...
### Example  
 [!code[NVC_MFC_CListBox#28](../VS_csharp/codesnippet/CPP/clistbox-class_28.cpp)]  
...
### Example  
 [!code[NVC_MFC_CListBox#29](../VS_csharp/codesnippet/CPP/clistbox-class_29.cpp)]  
...
### Example  
 [!code[NVC_MFC_CListBox#30](../VS_csharp/codesnippet/CPP/clistbox-class_30.cpp)]  
  
##  <a name="clistbox__setcolumnwidth"></a>  CListBox::SetColumnWidth  
 Sets the width in pixels of all columns in a multicolumn list box (created with the [LBS_MULTICOLUMN](../VS_csharp/list-box-styles.md) style).  
...
### Example  
 [!code[NVC_MFC_CListBox#31](../VS_csharp/codesnippet/CPP/clistbox-class_31.cpp)]  
...
### Example  
 [!code[NVC_MFC_CListBox#32](../VS_csharp/codesnippet/CPP/clistbox-class_32.cpp)]  
...
### Remarks  
 ...
 To respond to a call to `SetHorizontalExtent`, the list box must have been defined with the [WS_HSCROLL](../VS_csharp/window-styles.md) style.  
...
### Example  
 [!code[NVC_MFC_CListBox#33](../VS_csharp/codesnippet/CPP/clistbox-class_33.cpp)]  
...
### Example  
 [!code[NVC_MFC_CListBox#34](../VS_csharp/codesnippet/CPP/clistbox-class_34.cpp)]  
...
### Example  
 [!code[NVC_MFC_CListBox#35](../VS_csharp/codesnippet/CPP/clistbox-class_35.cpp)]  
...
### Remarks  
 If the list box has the [LBS_OWNERDRAWVARIABLE](../VS_csharp/list-box-styles.md) style, this function sets the height of the item specified by `nIndex`. Otherwise, this function sets the height of all items in the list box.  
  
### Example  
 [!code[NVC_MFC_CListBox#36](../VS_csharp/codesnippet/CPP/clistbox-class_36.cpp)]  
...
### Example  
 [!code[NVC_MFC_CListBox#37](../VS_csharp/codesnippet/CPP/clistbox-class_37.cpp)]  
...
### Example  
 [!code[NVC_MFC_CListBox#38](../VS_csharp/codesnippet/CPP/clistbox-class_38.cpp)]  
...
### Remarks  
 ...
 To respond to a call to the `SetTabStops` member function, the list box must have been created with the [LBS_USETABSTOPS](../VS_csharp/list-box-styles.md) style.  
  
### Example  
 [!code[NVC_MFC_CListBox#39](../VS_csharp/codesnippet/CPP/clistbox-class_39.cpp)]  
...
### Example  
 [!code[NVC_MFC_CListBox#40](../VS_csharp/codesnippet/CPP/clistbox-class_40.cpp)]  
...
-   Has the [LBS_WANTKEYBOARDINPUT](../VS_csharp/list-box-styles.md) style set.  
...
### Example  
 [!code[NVC_MFC_CListBox#41](../VS_csharp/codesnippet/CPP/clistbox-class_41.cpp)]  
  
## See Also  
 [MFC Sample CTRLTEST](../VS_csharp/visual-c---samples.md)   
