...
during code generation, compiler introduced reference to symbol 'symbol' defined in module 'module' compiled with /GL  
 ...
 To resolve LNK1237, do not compile the symbol with **/GL** or use [/INCLUDE (Force Symbol References)](../VS_csharp/-include--force-symbol-references-.md) to force a reference to the symbol.  
