...
You can use Edit and Continue in Visual C++ projects. See [Supported Code Changes and Limitations (C++)](../VS_csharp/supported-code-changes--c---.md) for information about the limitations of Edit and Continue.  
 ...
 The [/Zo (Enhance Optimized Debugging)](../VS_csharp/-zo--enhance-optimized-debugging-.md) compiler option that was introduced in Visual Studio 2013 Update 3 adds additional information to .pdb (symbol) files for binaries compiled without the [/Od (Disable (Debug))](http://msdn.microsoft.com/library/aafb762y.aspx) option.  
  
 **/Zo** disables Edit and Continue. See [How to: Debug Optimized Code](../VS_csharp/how-to--debug-optimized-code.md).  
...
## See Also  
 [Supported Code Changes and Limitations (C++)](../VS_csharp/supported-code-changes--c---.md)