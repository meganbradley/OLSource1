...
|Name|Description|  
|----------|-----------------|  
|[CMFCPopupMenuBar::AdjustSizeImmediate](#cmfcpopupmenubar__adjustsizeimmediate)|Immediately recalculates the layout of a pane. (Overrides [CPane::AdjustSizeImmediate](../VS_csharp/cpane-class.md#cpane__adjustsizeimmediate).)|  
...
|[CMFCPopupMenuBar::SetButtonStyle](#cmfcpopupmenubar__setbuttonstyle)|Sets the style of the toolbar button at the given index. (Overrides [CMFCToolBar::SetButtonStyle](../VS_csharp/cmfctoolbar-class.md#cmfctoolbar__setbuttonstyle).)|  
...
## Remarks  
 The `CMFCPopupMenuBar` is created at the same time as a [CMFCPopupMenu Class](../VS_csharp/cmfcpopupmenu-class.md) and embedded inside it. The `CMFCPopupMenuBar` covers the entire client area of the `CMFCPopupMenu` object. It supports keyboard and mouse input. It also communicates that input to the `CMFCPopupMenu` and to the top-level frame window.  
  
## Example  
 The following example demonstrates how to initialize a `CMFCPopupMenuBar` object from a `CMFCPopupMenu` object. This code snippet is part of the [Draw Client sample](../VS_csharp/visual-c---samples.md).  
  
 [!code[NVC_MFC_DrawClient#7](../VS_csharp/codesnippet/CPP/cmfcpopupmenubar-class_1.cpp)]  
...
##  <a name="cmfcpopupmenubar__adjustsizeimmediate"></a>  CMFCPopupMenuBar::AdjustSizeImmediate  
 Immediately recalculates the layout of the popup menu bar pane. (Overrides [CPane::AdjustSizeImmediate](../VS_csharp/cpane-class.md#cpane__adjustsizeimmediate).  
...
##  <a name="cmfcpopupmenubar__setbuttonstyle"></a>  CMFCPopupMenuBar::SetButtonStyle  
 Sets the style of the toolbar button at the given index. (Overrides [CMFCToolBar::SetButtonStyle](../VS_csharp/cmfctoolbar-class.md#cmfctoolbar__setbuttonstyle).)  
...
## See Also  
 ...
 [CMFCColorBar Class](../VS_csharp/cmfccolorbar-class.md)   
 [CMFCPopupMenu Class](../VS_csharp/cmfcpopupmenu-class.md)