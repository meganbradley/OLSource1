...
### Remarks  
 See [Using Insertion Operators and Controlling Format](../VS_csharp/using-insertion-operators-and-controlling-format.md).  
...
### Return Value  
 The manipulator returns an object that, when extracted from or inserted into the stream **str**, calls **str**. [setf](../VS_csharp/ios_base-class.md#ios_base__setf)( `ios_base::`[fmtflags](../VS_csharp/ios_base-class.md#ios_base__fmtflags), _                        *Mask*), and then returns **str**.  
  
### Example  
  See [setw](../VS_csharp/-iomanip--functions.md#setw) for an example of using `resetiosflags`.  
...
### Return Value  
 The manipulator returns an object that, when extracted from or inserted into the stream **str**, calls **str**. `setf`( **mask**, [ios_base::basefield](../VS_csharp/ios_base-class.md#ios_base__fmtflags)), and then returns **str**. Here, **mask** is determined as follows:  
  
-   If _                                *Base* is 8, then **mask** is `ios_base::`[oct](../VS_csharp/-ios--functions.md#oct).  
  
-   If _                                *Base* is 10, then mask is `ios_base::`[dec](../VS_csharp/-ios--functions.md#dec).  
  
-   If _                                *Base* is 16, then **mask** is `ios_base::`[hex](../VS_csharp/-ios--functions.md#hex).  
  
-   If _                                *Base* is any other value, then mask is `ios_base::`[fmtflags](../VS_csharp/ios_base-class.md#ios_base__fmtflags)(0).  
  
### Example  
  See [setw](../VS_csharp/-iomanip--functions.md#setw) for an example of using `setbase`.  
...
### Return Value  
 The template manipulator returns an object that, when extracted from or inserted into the stream **str**, calls **str**. [fill](../VS_csharp/basic_ios-class.md#basic_ios__fill)( `_Ch`), and then returns **str**. The type **Elem** must be the same as the element type for the stream **str**.  
  
### Example  
  See [setw](../VS_csharp/-iomanip--functions.md#setw) for an example of using `setfill`.  
...
### Return Value  
 The manipulator returns an object that, when extracted from or inserted into the stream **str**, calls **str**. [setf](../VS_csharp/ios_base-class.md#ios_base__setf)(_                        *Mask*), and then returns **str**.  
  
### Example  
  See [setw](../VS_csharp/-iomanip--functions.md#setw) for an example of using `setiosflags`.  
...
### Return Value  
 The manipulator returns an object that, when extracted from or inserted into the stream **str**, calls **str**. [precision](../VS_csharp/ios_base-class.md#ios_base__precision)( `_Prec`), and then returns **str**.  
  
### Example  
  See [setw](../VS_csharp/-iomanip--functions.md#setw) for an example of using `setprecision`.  
...
### Return Value  
 The manipulator returns an object that, when extracted from or inserted into the stream **str**, calls **str**. [width](../VS_csharp/ios_base-class.md#ios_base__width)(_                        *Wide*), then returns **str**.  
