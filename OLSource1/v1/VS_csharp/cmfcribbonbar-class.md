...
|[CMFCRibbonBar::CreateEx](#cmfcribbonbar__createex)|Creates a control bar and attaches it to the [CPane](../VS_csharp/cpane-class.md) object. (Overrides [CPane::CreateEx](../VS_csharp/cpane-class.md#cpane__createex).)|  
...
|[CMFCRibbonBar::GetCaptionHeight](#cmfcribbonbar__getcaptionheight)|Returns the caption height. (Overrides [CBasePane::GetCaptionHeight](../VS_csharp/cbasepane-class.md#cbasepane__getcaptionheight).)|  
...
|[CMFCRibbonBar::OnSetAccData](#cmfcribbonbar__onsetaccdata)|(Overrides [CBasePane::OnSetAccData](../VS_csharp/cbasepane-class.md#cbasepane__onsetaccdata).)|  
...
|[CMFCRibbonBar::RecalcLayout](#cmfcribbonbar__recalclayout)|(Overrides [CPane::RecalcLayout](../VS_csharp/cpane-class.md#cpane__recalclayout).)|  
...
## Remarks  
 ...
 You can use the `CMFCRibbonStatusBar` class to implement a status bar similar to the one used in Office 2007. A ribbon category contains (and displays) a group of [ribbon panels](../VS_csharp/cmfcribbonpanel-class.md). Each ribbon panel contains one or more ribbon elements, which are derived from [CMFCRibbonBaseElement](../VS_csharp/cmfcribbonbaseelement-class.md).  
  
 For information about how to add a ribbon bar to your existing MFC application, see [Walkthrough: Updating the MFC Scribble Application](../VS_csharp/walkthrough--updating-the-mfc-scribble-application--part-1-.md).  
...
### Parameters  
 ...
 [in] `pRTI`  
 Pointer to a [CMFCRibbonCategory](../VS_csharp/cmfcribboncategory-class.md) run-time class to dynamically create a ribbon category at run-time.  
...
### Example  
 ...
 [!code[NVC_MFC_RibbonApp#5](../VS_csharp/codesnippet/CPP/cmfcribbonbar-class_1.cpp)]  
...
### Example  
 ...
 [!code[NVC_MFC_RibbonApp#4](../VS_csharp/codesnippet/CPP/cmfcribbonbar-class_2.cpp)]  
...
##  <a name="cmfcribbonbar__cmfcribbonbar"></a>  CMFCRibbonBar::CMFCRibbonBar  
 Constructs and initializes a [CMFCRibbonBar](../VS_csharp/cmfcribbonbar-class.md) object.  
...
### Example  
 ...
 [!code[NVC_MFC_RibbonApp#1](../VS_csharp/codesnippet/CPP/cmfcribbonbar-class_3.cpp)]  
...
### Example  
 ...
 [!code[NVC_MFC_RibbonApp#3](../VS_csharp/codesnippet/CPP/cmfcribbonbar-class_4.cpp)]  
...
### Example  
 ...
 [!code[NVC_MFC_RibbonApp#8](../VS_csharp/codesnippet/CPP/cmfcribbonbar-class_5.cpp)]  
...
### Example  
 ...
 [!code[NVC_MFC_RibbonApp#9](../VS_csharp/codesnippet/CPP/cmfcribbonbar-class_6.cpp)]  
...
## See Also  
 ...
 [CPane](../VS_csharp/cpane-class.md)   
 [CMFCRibbonCategory](../VS_csharp/cmfcribboncategory-class.md)   
 [CMFCRibbonPanel](../VS_csharp/cmfcribbonpanel-class.md)   
 [CMFCRibbonBaseElement](../VS_csharp/cmfcribbonbaseelement-class.md)   
 [Walkthrough: Updating the MFC Scribble Application](../VS_csharp/walkthrough--updating-the-mfc-scribble-application--part-1-.md)