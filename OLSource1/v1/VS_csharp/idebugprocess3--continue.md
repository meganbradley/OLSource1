...
> [!NOTE]
>  This method should be used instead of [IDebugProgram2::Continue](../VS_csharp/idebugprogram2--continue.md).  
...
#### Parameters  
 `pThread`  
 [in] An [IDebugThread2](../VS_csharp/idebugthread2.md) object representing the thread to be continued.  
