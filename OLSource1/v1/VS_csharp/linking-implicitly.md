...
-   A header file (.h file) containing the declarations of the exported functions and/or C++ classes.  The classes, functions, and data should all have `__declspec(dllimport)`, for more information, see [dllexport, dllimport](../VS_csharp/dllexport--dllimport.md).  
  
-   An import library ([.LIB files](../VS_csharp/.lib-files-as-linker-input.md)) to link with. (The linker creates the import library when the DLL is built.)  
...
-   [Link explicitly](../VS_csharp/linking-explicitly.md)  
  
-   [Determine which linking method to use](../VS_csharp/determining-which-linking-method-to-use.md)  
  
## What do you want to know more about?  
  
-   [Working with Import Libraries and Export Files](../VS_csharp/working-with-import-libraries-and-export-files.md)  
  
-   [The search path used by Windows to locate a DLL](../VS_csharp/search-path-used-by-windows-to-locate-a-dll.md)  
