...
'conversion' conversion from 'type1' to 'type2', possible loss of data  
 ...
 An integer type is converted to a smaller integer type. This is a level-4 warning if *type1* is `int` and *type2* is smaller than `int`. Otherwise, it is a level 3 (assigned a value of type [__int64](../VS_csharp/__int8--__int16--__int32--__int64.md) to a variable of type `unsigned int`). A possible loss of data may have occurred.  
 ...
 C4244 can also fire at level 2; see [Compiler Warning (level 2) C4244](../VS_csharp/compiler-warning--level-2--c4244.md) for more information.  
...
```  
 ...
 For more information, see [Usual Arithmetic Conversions](../VS_csharp/usual-arithmetic-conversions.md).  
