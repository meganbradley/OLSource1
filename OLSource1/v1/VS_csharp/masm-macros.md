...
---
# MASM Macros
In order to simplify the use of the [Raw Pseudo Operations](../VS_csharp/raw-pseudo-operations.md), there are a set of macros, defined in ksamd64.inc, which can be used to create typical procedure prologues and epilogues.  
