...
The `explicit` keyword declares a user-defined type conversion operator that must be invoked with a cast. For example, this operator converts from a class called Fahrenheit to a class called Celsius:  
 ...
 [!code[csrefKeywordsConversion#2](../VS_csharp/codesnippet/CSharp/explicit--csharp-reference-_1.cs)]  
  
 This conversion operator can be invoked like this:  
  
 [!code[csrefKeywordsConversion#3](../VS_csharp/codesnippet/CSharp/explicit--csharp-reference-_2.cs)]  
 ...
 For more information, see [Using Conversion Operators (C#)](../VS_csharp/using-conversion-operators--csharp-programming-guide-.md).  
...
## Example  
 ...
 [!code[csrefKeywordsConversion#1](../VS_csharp/codesnippet/CSharp/explicit--csharp-reference-_3.cs)]  
...
## Example  
 ...
 [!code[csrefKeywordsConversion#4](../VS_csharp/codesnippet/CSharp/explicit--csharp-reference-_4.cs)]  
