...
To draw with a selection from the 256-color palette, you need to select the colors from the Colors palette in the [Colors window](../VS_csharp/colors-window--image-editor-for-icons-.md).  
