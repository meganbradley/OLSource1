...
Defines by its presence whether a default instance of the [VsgDbg](../VS_csharp/vsgdbg-class.md) class—which provides the programmatic capture interface—is supplied.  
