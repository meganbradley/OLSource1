...
## Give the Value a Name  
 If a function is a first-class value, you must be able to name it, just as you can name integers, strings, and other built-in types. This is referred to in functional programming literature as binding an identifier to a value. F# uses [let expressions](../VS_csharp/let-bindings--fsharp-.md) to bind names to values: `let <identifier> = <value>`. The following code shows two examples.  
  
 [!code[FsConTour#20](../VS_csharp/codesnippet/FSharp/functions-as-first-class-values--fsharp-_1.fs)]  
  
 You can name a function just as easily. The following example defines a function named `squareIt` by binding the identifier `squareIt` to the [lambda expression](../VS_csharp/lambda-expressions--the-fun-keyword--fsharp-.md)`fun n -> n * n`. Function `squareIt` has one parameter, `n`, and it returns the square of that parameter.  
  
 [!code[FsConTour#21](../VS_csharp/codesnippet/FSharp/functions-as-first-class-values--fsharp-_2.fs)]  
  
 F# provides the following more concise syntax to achieve the same result with less typing.  
  
 [!code[FsConTour#22](../VS_csharp/codesnippet/FSharp/functions-as-first-class-values--fsharp-_3.fs)]  
...
## Store the Value in a Data Structure  
 ...
 [!code[FsConTour#23](../VS_csharp/codesnippet/FSharp/functions-as-first-class-values--fsharp-_4.fs)]  
 ...
 [!code[FsConTour#24](../VS_csharp/codesnippet/FSharp/functions-as-first-class-values--fsharp-_5.fs)]  
 ...
 [!code[FsConTour#25](../VS_csharp/codesnippet/FSharp/functions-as-first-class-values--fsharp-_6.fs)]  
...
## Pass the Value as an Argument  
 ...
 [!code[FsConTour#26](../VS_csharp/codesnippet/FSharp/functions-as-first-class-values--fsharp-_7.fs)]  
 ...
 [!code[FsConTour#27](../VS_csharp/codesnippet/FSharp/functions-as-first-class-values--fsharp-_8.fs)]  
 ...
 F# provides map methods for most collection types, including [lists](../VS_csharp/collections.list-module--fsharp-.md), [arrays](../VS_csharp/collections.array-module--fsharp-.md), and [sets](../VS_csharp/collections.set-module--fsharp-.md). The following examples use lists. The syntax is `List.map <the function> <the list>`.  
  
 [!code[FsConTour#28](../VS_csharp/codesnippet/FSharp/functions-as-first-class-values--fsharp-_9.fs)]  
  
 For more information, see [Lists](../VS_csharp/lists--fsharp-.md).  
...
## Return the Value from a Function Call  
 ...
 [!code[FsConTour#34](../VS_csharp/codesnippet/FSharp/functions-as-first-class-values--fsharp-_15.fs)]  
...
>  For an even shorter version, see the following section, "Curried Functions."  
 ...
 [!code[FsConTour#35](../VS_csharp/codesnippet/FSharp/functions-as-first-class-values--fsharp-_16.fs)]  
...
>  F# provides two operators, `<<` and `>>`, that compose functions. For example, `let squareAndDouble2 = doubleIt << squareIt` is equivalent to `let squareAndDouble = compose doubleIt squareIt` in the previous example.  
 ...
 [!code[FsConTour#36](../VS_csharp/codesnippet/FSharp/functions-as-first-class-values--fsharp-_17.fs)]  
 ...
 [!code[FsConTour#37](../VS_csharp/codesnippet/FSharp/functions-as-first-class-values--fsharp-_18.fs)]  
...
## Curried Functions  
 ...
 [!code[FsConTour#38](../VS_csharp/codesnippet/FSharp/functions-as-first-class-values--fsharp-_19.fs)]  
 ...
 [!code[FsConTour#39](../VS_csharp/codesnippet/FSharp/functions-as-first-class-values--fsharp-_20.fs)]  
 ...
 [!code[FsConTour#40](../VS_csharp/codesnippet/FSharp/functions-as-first-class-values--fsharp-_21.fs)]  
  
 To verify that the function still works as it did before, try the original test cases again.  
  
 [!code[FsConTour#41](../VS_csharp/codesnippet/FSharp/functions-as-first-class-values--fsharp-_22.fs)]  
  
> [!NOTE]
>  You can restrict currying by enclosing parameters in tuples. For more information, see "Parameter Patterns" in [Parameters and Arguments](../VS_csharp/parameters-and-arguments--fsharp-.md).  
 ...
 [!code[FsConTour#42](../VS_csharp/codesnippet/FSharp/functions-as-first-class-values--fsharp-_23.fs)]  
  
 For more information about currying, see "Partial Application of Arguments" in [Functions](../VS_csharp/functions--fsharp-.md).  
...
## Identifier and Function Definition Are Interchangeable  
 ...
 [!code[FsConTour#43](../VS_csharp/codesnippet/FSharp/functions-as-first-class-values--fsharp-_24.fs)]  
  
 To take it one step further, substitute the value that `applyIt` is bound to for `applyIt`.  
  
 [!code[FsConTour#44](../VS_csharp/codesnippet/FSharp/functions-as-first-class-values--fsharp-_25.fs)]  
...
-   You can store a function in a data structure.  
     ...
     [!code[FsConTour#45](../VS_csharp/codesnippet/FSharp/functions-as-first-class-values--fsharp-_26.fs)]  
  
-   You can pass a function as an argument.  
  
     [!code[FsConTour#46](../VS_csharp/codesnippet/FSharp/functions-as-first-class-values--fsharp-_27.fs)]  
  
-   You can return a function as the value of a function call.  
  
     [!code[FsConTour#32](../VS_csharp/codesnippet/FSharp/functions-as-first-class-values--fsharp-_13.fs)]  
  
 For more information about F#, see [F# Language Reference](../VS_csharp/fsharp-language-reference.md).  
...
### Code  
 [!code[FsConTour#47](../VS_csharp/codesnippet/FSharp/functions-as-first-class-values--fsharp-_28.fs)]  
  
## See Also  
 [Lists](../VS_csharp/lists--fsharp-.md)   
 [Tuples](../VS_csharp/tuples--fsharp-.md)   
 [Functions](../VS_csharp/functions--fsharp-.md)   
 [let Bindings](../VS_csharp/let-bindings--fsharp-.md)   
 [lambda Expressions](../VS_csharp/lambda-expressions--the-fun-keyword--fsharp-.md)