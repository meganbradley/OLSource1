...
## Remarks  
 `db_source` creates a [CDataSource](../VS_csharp/cdatasource-class.md) and a [CSession](../VS_csharp/csession-class.md) object, which together represent a connection with an OLE DB consumer data source.  
