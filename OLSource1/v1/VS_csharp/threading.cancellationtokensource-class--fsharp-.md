...
|Member|Description|  
|------------|-----------------|  
|[new](../VS_csharp/threading.cancellationtokensource-constructor--fsharp-.md)|Creates a new cancellation capability.|  
  
## Instance Members  
  
|Member|Description|  
|------------|-----------------|  
|[Cancel](../VS_csharp/cancellationtokensource.cancel-method--fsharp-.md)|Cancels the operation.|  
|[Dispose](../VS_csharp/cancellationtokensource.dispose-method--fsharp-.md)|Discards resources associated with this capability.|  
|[Token](../VS_csharp/cancellationtokensource.token-property--fsharp-.md)|Fetches the token representing the capability to detect cancellation of an operation.|  
  
## Static Members  
  
|Member|Description|  
|------------|-----------------|  
|[CreateLinkedTokenSource](../VS_csharp/cancellationtokensource.createlinkedtokensource-method--fsharp-.md)|Creates a cancellation capability linking two tokens.|  
