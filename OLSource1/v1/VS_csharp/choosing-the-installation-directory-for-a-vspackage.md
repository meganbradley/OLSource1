...
## Managed VSPackages  
 ...
 For more information, see [How to: Register aVSPackage (C#)](../VS_csharp/registering-and-unregistering-vspackages.md).  
...
## Satellite DLLs  
 ...
 [Loading a VSPackage](../VS_csharp/managing-vspackages.md) indicates that registry entries control where [!INCLUDE[vsprvs](../VS_csharp/includes/vsprvs_md.md)] actually looks for a VSPackage's satellite DLL. However, [!INCLUDE[vsprvs](../VS_csharp/includes/vsprvs_md.md)] tries to load a satellite DLL in a subdirectory named for an LCID value, in the following order:  
...
5.  U.S. English (.\1033 or .\0x409).  
 ...
 If your VSPackage DLL includes resources and the SatelliteDll\DllName registry entry points to it, [!INCLUDE[vsprvs](../VS_csharp/includes/vsprvs_md.md)] attempts to load them in the above order.  
  
## See Also  
 [Side-By-Side Implementation Strategies](../VS_csharp/choosing-between-shared-and-versioned-vspackages.md)   
 [Loading a VSPackage](../VS_csharp/managing-vspackages.md)   
