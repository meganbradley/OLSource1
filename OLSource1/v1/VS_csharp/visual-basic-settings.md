...
|[Class View](../VS_csharp/viewing-the-structure-of-code.md)|No|Hides **Hidden Types and Members**|  
|[Command Window](../VS_csharp/command-window.md)|No||  
|**Dynamic Help** window|No|Does not appear when you press F1.|  
|[Immediate Window](../VS_csharp/immediate-window.md)|Yes, when debugging starts.||  
|[Object Browser](../VS_csharp/viewing-the-structure-of-code.md)|No|Displays, by default:<br /><br /> -   Namespaces<br />-   Public members<br />-   Inherited members|  
|[Output Window](../VS_csharp/output-window.md)|Yes, when build starts.||  
|[Properties Window](../VS_csharp/properties-window.md)|Yes||  
...
|[Start Page](../VS_csharp/customizing-the-start-page-for-visual-studio.md)|Yes|Appears the first time you start the IDE. You can customize it.|  
...
|[Toolbox](../VS_csharp/toolbox.md)|Yes|Displays controls and components in alphabetical order.|  
...
|[Options Dialog Box](../VS_csharp/options-dialog-box--visual-studio-.md)|Visual Basic enables simplified **Options** pages. Click the **Show All Settings** check box to see the full list of options.|  
...
|[Visual Basic IntelliSense Code Snippets](../VS_csharp/visual-basic-intellisense-code-snippets.md)|Includes a library of code snippets that are ready to be inserted in your application.|  
|[Visual Basic-Specific IntelliSense](../VS_csharp/visual-basic-specific-intellisense.md)|-   Provides all of the IntelliSense features with some productivity enhancements for Visual Basic developers.|  
