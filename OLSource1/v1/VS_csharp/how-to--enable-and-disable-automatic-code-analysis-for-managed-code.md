...
You can configure Code Analysis to run before each build of a managed code project. You can set different Code Analysis properties for each [!INCLUDE[vs_current_short](../VS_csharp/includes/vs_current_short_md.md)] configuration.  
