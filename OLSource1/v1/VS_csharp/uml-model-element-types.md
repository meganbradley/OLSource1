...
You can read and manipulate a UML model through a programming interface. This topic summarizes the hierarchy of element types. The hierarchy is the same as that defined in the UML specification.  
 ...
 The details of each type are provided in [API reference for Modeling Extensibility](../VS_csharp/api-reference-for-uml-modeling-extensibility.md).  
...
## See Also  
 ...
 [How to: Use Validation Constraints with UML Models](../VS_csharp/define-validation-constraints-for-uml-models.md)   
