...
## Requirements  
 Its behavior is determined by the named locale `_Locname`. Each constructor initializes its base object with [time_get](../VS_csharp/time_get-class.md#time_get__time_get)<CharType, InputIterator>( `_Refs`).  
