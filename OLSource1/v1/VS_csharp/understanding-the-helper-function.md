...
-   [Changes in the DLL Delayed Loading Helper Function Since Visual C++ 6.0](../VS_csharp/changes-in-the-dll-delayed-loading-helper-function-since-visual-c---6.0.md)  
  
-   [Calling Conventions, Parameters, and Return Type](../VS_csharp/calling-conventions--parameters--and-return-type.md)  
  
-   [Structure and Constant Definitions](../VS_csharp/structure-and-constant-definitions.md)  
  
-   [Calculating Necessary Values](../VS_csharp/calculating-necessary-values.md)  
  
-   [Unloading a Delay-Loaded DLL](../VS_csharp/explicitly-unloading-a-delay-loaded-dll.md)  
