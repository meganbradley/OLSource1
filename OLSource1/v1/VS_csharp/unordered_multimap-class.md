...
### Remarks  
 ...
 For a code example, see [multimap::emplace](../VS_csharp/multimap-class.md#multimap__emplace).  
...
|`ValTy`|Template parameter that specifies the argument type that the unordered_multimap can use to construct an element of [value_type](../VS_csharp/map-class.md#map__value_type), and perfect-forwards `Val` as an argument.|  
...
### Remarks  
 ...
 The initializer list member function (6) uses an [initializer_list](../VS_csharp/-initializer_list-.md) to copy elements into the unordered_multimap.  
 ...
 For a code example, see [multimap::insert](../VS_csharp/multiset-class.md#multiset__insert).  
