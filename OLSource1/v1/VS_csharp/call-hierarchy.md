...
## Using Call Hierarchy  
 ...
 ![Call Hierarchy with one node open](../VS_csharp/media/onenode.png "OneNode")  
...
-   If you expand the **Calls From** node, all members that are called by the selected member are displayed.  
 ...
 ![Call Hierarchy Multiple Nodes Open](../VS_csharp/media/multiplenodes.png "MultipleNodes")  
Call Hierarchy window  
...
-   The **Code Definition Window**, if open, displays the code for the selected member. This window is available in C# and C++. For more information about this window, see [Viewing the Structure of Code](../VS_csharp/viewing-the-structure-of-code.md).  
