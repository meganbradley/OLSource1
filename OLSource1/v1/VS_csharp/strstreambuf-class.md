...
> [!NOTE]
>  This class is deprecated. Consider using [stringbuf](../VS_csharp/-sstream--typedefs.md#stringbuf) or [wstringbuf](../VS_csharp/-sstream--typedefs.md#wstringbuf) instead.  
...
### Remarks  
 Specifically, if [pptr](../VS_csharp/basic_streambuf-class.md#basic_streambuf__pptr) is a null pointer, the function returns zero. Otherwise, it returns `pptr` – [pbase](../VS_csharp/basic_streambuf-class.md#basic_streambuf__pbase).  
...
## See Also  
 [streambuf](../VS_csharp/-streambuf--typedefs.md#streambuf)   
