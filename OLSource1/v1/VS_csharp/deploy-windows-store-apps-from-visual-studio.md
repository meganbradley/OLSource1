...
2.  On the debugger Visual Studio toolbar, choose the deployment target from the drop-down list next to the **Start Debugging** button.  
     ...
     ![Run on Local Machine](../VS_csharp/media/vsrun_f5_local.png "VSRUN_F5_Local")  
 ...
 **Specifying the remote device in a JavaScript or Visual C++ project page**  
 ...
 ![C&#43;&#43; project properties for remote debugging](../VS_csharp/media/vsrun_cpp_projprop_remote.png "VSRUN_CPP_ProjProp_Remote")  
 ...
 **Specifying the remote device in a Visual C# and Visual Basic project page**  
 ...
 ![Managed project properties for remote debugging](../VS_csharp/media/vsrun_managed_projprop_remote.png "VSRUN_Managed_ProjProp_Remote")  
 ...
 **Allow Network Loopback**  
 For security reasons, a [!INCLUDE[win8_appname_long](../VS_csharp/includes/win8_appname_long_md.md)] app that is installed in the standard manner is not allowed to make network calls to the device it is installed on. By default, Visual Studio deployment creates an exemption from this rule for the deployed app. This exemption allows you to test communication procedures on a single machine. Before you submit your app to the [!INCLUDE[win8_appstore_long](../VS_csharp/includes/win8_appstore_long_md.md)], you should test your app without the exemption.  
...
## See Also  
 [Running Windows Store apps from Visual Studio](../VS_csharp/run-store-apps-from-visual-studio.md)