...
-   The <xref:Microsoft.VisualStudio.Shell.Interop.IPersistXMLFragment*> is used to persist non-build related data in free-form XML. The methods provided by <xref:Microsoft.VisualStudio.Shell.Interop.IPersistXMLFragment*> are called by [!INCLUDE[vsprvs](../VS_csharp/includes/vsprvs_md.md)] whenever [!INCLUDE[vsprvs](../VS_csharp/includes/vsprvs_md.md)] needs to persist non-build related data in the project file.  
  
 For more information on how to persist build and non-build related data, see [Persisting Data in the MSBuild Project File](../VS_csharp/persisting-data-in-the-msbuild-project-file.md).  
...
> [!NOTE]
>  All code examples provided in this topic are parts of a larger example, [Visual Studio Extensibility Samples](../Topic/VSSDK%20Samples.md).  
  
## See Also  
 [Persisting Data in the MSBuild Project File](../VS_csharp/persisting-data-in-the-msbuild-project-file.md)