...
```  
 ...
 Because increment and decrement operators have side effects, using expressions with increment or decrement operators in a [preprocessor macro](../VS_csharp/macros--c-c---.md) can have undesirable results. Consider this example:  
...
## See Also  
 ...
 [Prefix Increment and Decrement Operators](../VS_csharp/prefix-increment-and-decrement-operators.md)