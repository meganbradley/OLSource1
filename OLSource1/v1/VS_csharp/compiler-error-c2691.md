...
```  
 ...
 C2691 can also occur if you attempt to define a jagged array using Managed Extensions for C++.  Jagged arrays are supported in the current syntax, see [array](../VS_csharp/arrays--c---component-extensions-.md) for more information.  
