...
|||  
|-|-|  
|[OnFieldChange](../VS_csharp/irowsetnotifyimpl--onfieldchange.md)|Notifies the consumer of any change to the value of a column.|  
|[OnRowChange](../VS_csharp/irowsetnotifyimpl--onrowchange.md)|Notifies the consumer of the first change to a row or of any change that affects the entire row.|  
|[OnRowsetChange](../VS_csharp/irowsetnotifyimpl--onrowsetchange.md)|Notifies the consumer of any change affecting the entire rowset.|  
  
## Remarks  
 See [Receiving Notifications](../VS_csharp/receiving-notifications.md) about implementing the connection point interface on the consumer.  
...
## See Also  
 ...
 [IRowsetNotifyCP Class](../VS_csharp/irowsetnotifycp-class.md)