...
#### Parameters  
 `pBPRequest`  
 [in] An [IDebugBreakpointRequest2](../VS_csharp/idebugbreakpointrequest2.md) object that describes the pending breakpoint to create.  
  
 `ppPendingBP`  
 [out] Returns an [IDebugPendingBreakpoint2](../VS_csharp/idebugpendingbreakpoint2.md) object that represents the pending breakpoint.  
...
## Remarks  
 A pending breakpoint is essentially a collection of all the information needed to bind a breakpoint to code. The pending breakpoint returned from this method is not bound to code until the [Bind](../VS_csharp/idebugpendingbreakpoint2--bind.md) method is called.  
...
## See Also  
 ...
 [Bind](../VS_csharp/idebugpendingbreakpoint2--bind.md)   
