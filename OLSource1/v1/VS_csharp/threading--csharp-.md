...
-   Threads share the application's resources. For more information, see [Using Threads and Threading](assetId:///9b5ec2cd-121b-4d49-b075-222cf26f2344).  
 ...
 You can use some or all these classes to synchronize the activities of multiple threads, but some support for threading is supported by the C# language. For example, the [Lock Statement](../VS_csharp/lock-statement--csharp-reference-.md) provides synchronization features through implicit use of <xref:System.Threading.Monitor*>.  
...
|Title|Description|  
|-----------|-----------------|  
|[Multithreaded Applications (C#)](../VS_csharp/multithreaded-applications--csharp-.md)|Describes how to create and use threads.|  
|[Parameters and Return Values for Multithreaded Procedures (C#)](../VS_csharp/parameters-and-return-values-for-multithreaded-procedures--csharp-.md)|Describes how to pass and return parameters with multithreaded applications.|  
|[Walkthrough: Multithreading with the BackgroundWorker Component (C#)](../VS_csharp/walkthrough--multithreading-with-the-backgroundworker-component--csharp-.md)|Shows how to create a simple multithreaded application.|  
|[Thread Synchronization (C#)](../VS_csharp/thread-synchronization--csharp-.md)|Describes how to control the interactions of threads.|  
|[Thread Timers (C#)](../VS_csharp/thread-timers--csharp-.md)|Describes how to run procedures on separate threads at fixed intervals.|  
|[Thread Pooling (C#)](../VS_csharp/thread-pooling--csharp-.md)|Describes how to use a pool of worker threads that are managed by the system.|  
|[How to: Use a Thread Pool (C#)](../VS_csharp/how-to--use-a-thread-pool--csharp-.md)|Demonstrates synchronized use of multiple threads in the thread pool.|  
