...
## Remarks  
 The `reserve` argument specifies the total initial heap allocation in virtual memory. By default, the heap size is 1 MB. [EDITBIN](../VS_csharp/editbin-reference.md) rounds up the specified value to the nearest multiple of 4 bytes.  
