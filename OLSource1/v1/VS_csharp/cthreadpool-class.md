...
#### Parameters  
 *Worker*  
 The class conforming to the [worker archetype](../VS_csharp/worker-archetype.md) providing the code used to process work items queued on the thread pool.  
...
## Remarks  
 ...
 An example of a *Worker* class is [CNonStatelessWorker Class](../VS_csharp/cnonstatelessworker-class.md).  
  
## Inheritance Hierarchy  
 `IUnknown`  
  
 [IThreadPoolConfig](../VS_csharp/ithreadpoolconfig-interface.md)  
...
### Remarks  
 Initializes the timeout value to [ATLS_DEFAULT_THREADPOOLSHUTDOWNTIMEOUT](../VS_csharp/atls_default_threadpoolshutdowntimeout.md).  
...
### Parameters  
 ...
 If `nNumThreads` is zero, [ATLS_DEFAULT_THREADSPERPROC](../VS_csharp/atls_default_threadsperproc.md) will be multiplied by the number of processors in the machine to get the total number of threads.  
...
### Remarks  
 Objects of this class can be successfully queried for the **IUnknown** and [IThreadPoolConfig](../VS_csharp/ithreadpoolconfig-interface.md) interfaces.  
...
### Remarks  
 The timeout is initialized to [ATLS_DEFAULT_THREADPOOLSHUTDOWNTIMEOUT](../VS_csharp/atls_default_threadpoolshutdowntimeout.md) in the constructor.  
