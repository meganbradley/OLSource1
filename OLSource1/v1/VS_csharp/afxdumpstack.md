...
-   **AFX_STACK_DUMP_TARGET_TRACE** Sends output by means of the [TRACE](../VS_csharp/trace.md) macro. The **TRACE** macro generates output in debug builds only; it generates no output in release builds. Also, **TRACE** can be redirected to other targets besides the debugger.  
...
## See Also  
 ...
 [afxDump](../VS_csharp/afxdump--cdumpcontext-in-mfc-.md)