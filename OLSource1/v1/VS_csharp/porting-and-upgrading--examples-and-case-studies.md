...
-   [MFC Scribble](../VS_csharp/porting-guide--mfc-scribble.md) is a sample  that uses the basics of MFC.  
  
-   [COM Spy](../VS_csharp/porting-guide--mfc-scribble.md) is an application that displays information about COM+ components on a machine.  
  
-   [Spy++](../VS_csharp/porting-guide--spy--.md) is an application that inspects and provides information about UI elements in running applications.  
