...
```  
 ...
 Once you have installed your hook function using [_CrtSetDumpClient](../VS_csharp/_crtsetdumpclient.md), it will be called every time a `_CLIENT_BLOCK` block is dumped. You can then use [_CrtReportBlockType](../VS_csharp/_crtreportblocktype.md) to get information on the type or subtype of dumped blocks.  
