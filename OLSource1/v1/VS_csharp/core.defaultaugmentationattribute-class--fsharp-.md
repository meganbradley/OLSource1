...
|Member|Description|  
|------------|-----------------|  
|[new](../VS_csharp/core.defaultaugmentationattribute-constructor--fsharp-.md)|Creates an instance of the attribute|  
  
## Instance Members  
  
|Member|Description|  
|------------|-----------------|  
|[Value](../VS_csharp/defaultaugmentationattribute.value-property--fsharp-.md)|The value of the attribute, indicating whether the type has a default augmentation or not|  
