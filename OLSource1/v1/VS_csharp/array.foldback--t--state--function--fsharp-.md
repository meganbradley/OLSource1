...
## Example  
 The following code example shows the difference between [Array.fold](../VS_csharp/array.fold--t--state--function--fsharp-.md) and `Array.foldBack`.  
  
 [!code[FsArrays#46](../VS_csharp/codesnippet/FSharp/array.foldback--t--state--function--fsharp-_1.fs)]  
