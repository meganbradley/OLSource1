...
#### Parameters  
 `PortNames`  
 [in] A [BSTR_ARRAY](../VS_csharp/bstr_array.md) structure that contains a list of port names to find and return among the persisted ports. Only those persisted ports with these names will be returned.  
  
 `ppEnum`  
 [out] An object that implements the [IEnumDebugPorts2](../VS_csharp/ienumdebugports2.md) interface.  
