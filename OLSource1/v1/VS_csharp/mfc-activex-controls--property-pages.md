...
-   The container can display its own modeless dialog box that shows the property pages of the selected control.  
 ...
 ![Properties dialog box for Circ3](../VS_csharp/media/vc373i1.gif "vc373I1")  
...
##  <a name="_core_customizing_the_dodataexchange_function"></a> Customizing the DoDataExchange Function  
 ...
 [!code[NVC_MFC_AxUI#31](../VS_csharp/codesnippet/CPP/mfc-activex-controls--property-pages_1.cpp)]  
 ...
 [Property Pages](../VS_csharp/property-pages--mfc-.md) are available for other dialog control types, such as check boxes, radio buttons, and list boxes. The table below lists the entire set of property page **DDP_** functions and their purposes:  
...
## See Also  
 ...
 [COlePropertyPage Class](../VS_csharp/colepropertypage-class.md)