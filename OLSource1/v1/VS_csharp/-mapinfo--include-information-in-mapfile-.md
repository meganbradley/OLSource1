...
## Remarks  
 The /MAPINFO option tells the linker to include the specified information in a mapfile, which is created if you specify the [/MAP](../VS_csharp/-map--generate-mapfile-.md) option.  EXPORTS tells the linker to include exported functions.  
