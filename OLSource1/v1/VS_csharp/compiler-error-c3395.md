...
'function' : __declspec(dllexport) cannot be applied to a function with the \__clrcall calling convention  
 ...
 `__declspec(dllexport)` and [__clrcall](../VS_csharp/__clrcall.md) are not compatible.  For more information, see [dllexport, dllimport](../VS_csharp/dllexport--dllimport.md).  
