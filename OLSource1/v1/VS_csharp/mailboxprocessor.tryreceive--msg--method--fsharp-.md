...
## Return Value  
 An asynchronous computation ([Async](../VS_csharp/control.async-class--fsharp-.md) object) that returns the received message or `None` if the timeout is exceeded.  
  
## Remarks  
 This method is for use within the body of the agent. Returns `None` if a timeout is given and the timeout is exceeded. This method is for use within the body of the agent. For each agent, at most one concurrent reader may be active, so no more than one concurrent call to [Receive](../VS_csharp/mailboxprocessor.receive--msg--method--fsharp-.md), `TryReceive`, [Scan](../VS_csharp/mailboxprocessor.scan--msg--t--method--fsharp-.md) or [TryScan](../VS_csharp/mailboxprocessor.tryscan--msg--t--method--fsharp-.md) may be active.  
...
## Example  
 ...
 [!code[FsMailboxProcessor#18](../VS_csharp/codesnippet/FSharp/mailboxprocessor.tryreceive--msg--method--fsharp-_1.fs)]  
