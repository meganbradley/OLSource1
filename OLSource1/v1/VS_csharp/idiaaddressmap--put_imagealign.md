...
## Remarks  
 ...
 The current image alignment can be retrieved with a call to the [IDiaAddressMap::get_imageAlign](../VS_csharp/idiaaddressmap--get_imagealign.md) method.  
...
## See Also  
 ...
 [IDiaAddressMap::get_imageAlign](../VS_csharp/idiaaddressmap--get_imagealign.md)