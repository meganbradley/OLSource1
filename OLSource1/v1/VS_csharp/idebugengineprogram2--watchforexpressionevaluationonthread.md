...
#### Parameters  
 `pOriginatingProgram`  
 [in] An [IDebugProgram2](../VS_csharp/idebugprogram2.md) object representing the program that is evaluating an expression.  
 ...
 `pExprCallback`  
 [in] An [IDebugEventCallback2](../VS_csharp/idebugeventcallback2.md) object to be used to send debug events that occur during expression evaluation.  
