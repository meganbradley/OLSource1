...
##  <a name="_core_classwizard_changes_for_stock_properties"></a> Add Property Wizard Changes for Stock Properties  
 ...
 [!code[NVC_MFC_AxUI#22](../VS_csharp/codesnippet/CPP/mfc-activex-controls--adding-stock-properties_1.cpp)]  
  
 The following line is added to your control's interface description (.IDL) file:  
  
 [!code[NVC_MFC_AxUI#23](../VS_csharp/codesnippet/CPP/mfc-activex-controls--adding-stock-properties_2.idl)]  
...
|**Font**|**DISP_STOCKPROP_FONT( )**|See the article [MFC ActiveX Controls: Using Fonts](../VS_csharp/mfc-activex-controls--using-fonts.md) for usage.|  
...
##  <a name="_core_color_properties"></a> Color Properties  
 ...
 [!code[NVC_MFC_AxUI#24](../VS_csharp/codesnippet/CPP/mfc-activex-controls--adding-stock-properties_3.cpp)]  
