...
2.  Open the shortcut menu for the project node, and choose **Retarget SDK Version**.  
     ...
     ![Retarget SDK Version](../VS_csharp/media/retargetingwindowssdk1.PNG "RetargetingWindowsSDK1")  
  
     The **Review Solution Actions** dialog appears.  
  
     ![Review Solution Actions](../VS_csharp/media/retargetingwindowssdk2.PNG "RetargetingWindowsSDK2")  
...
4.  Open the project properties, and in the **Configuration Properties, General** section, notice the values of **Windows Target Platform Version**. Changing the value here has the same effect as following this procedure. See [General Property Page (Project)](../VS_csharp/general-property-page--project-.md).  
  
     ![Target Platform Version](../VS_csharp/media/retargetingwindowssdk3.PNG "RetargetingWindowsSDK3")  
     ...
     ![Include Directories dialog box](../VS_csharp/media/retargetingwindowssdk4.PNG "RetargetingWindowsSDK4")  
  
     Choose the **Macros >>** button, and scroll down the list of macros to the Windows SDK macros to see all the new values.  
  
     ![Windows SDK Macros](../VS_csharp/media/retargetingwindowssdk5.PNG "RetargetingWindowsSDK5")  
...
## See Also  
 [Windows Desktop Applications (Visual C++)](../VS_csharp/how-to--use-the-windows-10-sdk-in-a-windows-desktop-application.md)