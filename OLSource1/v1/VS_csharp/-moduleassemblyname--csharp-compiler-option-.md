...
-   The existing assembly has granted friend assembly access to the assembly into which the .netmodule will be built.  
 ...
 For more information on building a .netmodule, see [/target:module (Create Module to Add to Assembly) (C# Compiler Options)](../VS_csharp/-target-module--csharp-compiler-options-.md).  
  
 For more information on friend assemblies, see [Friend Assemblies (C# Programmer's Reference)](../VS_csharp/friend-assemblies--csharp-and-visual-basic-.md).  
