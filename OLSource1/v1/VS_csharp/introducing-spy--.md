...
-   Display a graphical tree of relationships among system objects. These include [processes](../VS_csharp/processes-view.md), [threads](../VS_csharp/threads-view.md), and [windows](../VS_csharp/windows-view.md).  
  
-   Search for specified [windows](../VS_csharp/how-to--search-for-a-window-in-windows-view.md), [threads](../VS_csharp/how-to--search-for-a-thread-in-threads-view.md), [processes](../VS_csharp/how-to--search-for-a-process-in-processes-view.md), or [messages](../VS_csharp/how-to--search-for-a-message-in-messages-view.md).  
  
-   View the properties of selected [windows](../VS_csharp/how-to--display-window-properties.md), [threads](../VS_csharp/how-to--display-thread-properties.md), [processes](../VS_csharp/how-to--display-process-properties.md), or [messages](../VS_csharp/how-to--display-message-properties.md).  
  
-   Select a window, thread, process, or message directly in the view.  
  
-   Use the [Finder Tool](../VS_csharp/how-to--use-the-finder-tool.md) to select a window by mouse pointer positioning.  
