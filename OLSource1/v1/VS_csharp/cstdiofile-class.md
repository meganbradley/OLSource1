...
---
# CStdioFile Class
Represents a C run-time stream file as opened by the run-time function [fopen](../VS_csharp/fopen--_wfopen.md).  
...
|Name|Description|  
|----------|-----------------|  
|[CStdioFile::Open](#cstdiofile__open)|Overloaded. Open is designed for use with the default `CStdioFile` constructor (Overrides [CFile::Open](../VS_csharp/cfile-class.md#cfile__open)).|  
...
## Remarks  
 ...
 The [CFile](../VS_csharp/cfile-class.md) functions [Duplicate](../VS_csharp/cfile-class.md#cfile__duplicate), [LockRange](../VS_csharp/cfile-class.md#cfile__lockrange), and [UnlockRange](../VS_csharp/cfile-class.md#cfile__unlockrange) are not supported for `CStdioFile`.  
  
 If you call these functions on a `CStdioFile`, you will get a [CNotSupportedException](../VS_csharp/cnotsupportedexception-class.md).  
  
 For more information on using `CStdioFile`, see the articles [Files in MFC](../VS_csharp/files-in-mfc.md) and [File Handling](../VS_csharp/file-handling.md) in the                 *Run-Time Library Reference*.  
...
### Parameters  
 `pOpenStream`  
 Specifies the file pointer returned by a call to the C run-time function [fopen](../VS_csharp/fopen--_wfopen.md).  
 ...
 One file access mode option is required; other modes are optional. See [CFile::CFile](../VS_csharp/cfile-class.md#cfile__cfile) for a list of mode options and other flags. In MFC version 3.0 and later, share flags are allowed.  
...
### Example  
 [!code[NVC_MFCFiles#37](../VS_csharp/codesnippet/CPP/cstdiofile-class_1.cpp)]  
...
### Remarks  
 ...
 [CFile::Read](../VS_csharp/cfile-class.md#cfile__read) is also available for text-mode input, but it does not terminate on a carriage return–linefeed pair.  
  
> [!NOTE]
>  The `CString` version of this function removes the `'\n'` if present; the `LPTSTR` version does not.  
  
### Example  
 [!code[NVC_MFCFiles#38](../VS_csharp/codesnippet/CPP/cstdiofile-class_2.cpp)]  
...
### Remarks  
 ...
 This implementation of `Seek` is based on the Run-Time Library (CRT) function `fseek`. There are several limits on the usage of `Seek` on streams opened in text mode. For more information, see [fseek](../VS_csharp/fseek--_fseeki64.md).  
...
### Example  
 ...
 [!code[NVC_MFCFiles#39](../VS_csharp/codesnippet/CPP/cstdiofile-class_3.cpp)]  
...
### Remarks  
 ...
 If you want to write data that is not null-terminated to a file, use `CStdioFile::Write` or [CFile::Write](../VS_csharp/cfile-class.md#cfile__write).  
...
### Example  
 [!code[NVC_MFCFiles#40](../VS_csharp/codesnippet/CPP/cstdiofile-class_4.cpp)]  
  
## See Also  
 [Base Class](../VS_csharp/cfile-class.md)   
 [Hierarchy Chart](../VS_csharp/hierarchy-chart.md)   
 [CFile](../VS_csharp/cfile-class.md)   
 [CFile::Duplicate](../VS_csharp/cfile-class.md#cfile__duplicate)   
 [CFile::LockRange](../VS_csharp/cfile-class.md#cfile__lockrange)   
 [CFile::UnlockRange](../VS_csharp/cfile-class.md#cfile__unlockrange)   
