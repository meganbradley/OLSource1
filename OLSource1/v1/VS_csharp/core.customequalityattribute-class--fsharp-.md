...
dev_langs: 
  - "FSharp"
helpviewer_keywords: 
  - "CustomEqualityAttribute class [F#]"
  - "CustomEquality attribute [F#]"
...
|Member|Description|  
|------------|-----------------|  
|[new](../VS_csharp/core.customequalityattribute-constructor--fsharp-.md)|Creates an instance of the attribute.|  
