...
## Remarks  
 These values are passed as an argument to the [GetHostName](../VS_csharp/idebugprogramnode2--gethostname.md) method to retrieve a host name in different formats.  
