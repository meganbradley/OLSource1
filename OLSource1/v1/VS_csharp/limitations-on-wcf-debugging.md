...
-   The service must be part of the [!INCLUDE[vsprvs](../VS_csharp/includes/vsprvs_md.md)] solution you are debugging.  
...
## Self-Hosting  
 A *self-hosted service* is a WCF service that does not run inside IIS, the WCF Service Host, or the [!INCLUDE[vstecasp](../VS_csharp/includes/vstecasp_md.md)] Development Server. For information about how to debug a self-hosted service, see [How to: Debug a Self-Hosted Service](../VS_csharp/how-to--debug-a-self-hosted-wcf-service.md).  
  
## Self-Hosting  
 To enable debugging of [!INCLUDE[vstecasp](../VS_csharp/includes/vstecasp_md.md)] 3.0 or 3.5 applications, [!INCLUDE[vstecasp](../VS_csharp/includes/vstecasp_md.md)] 3.0 or 3.5 must be installed before [!INCLUDE[vs_dev10_long](../VS_csharp/includes/vs_dev10_long_md.md)] is installed. If [!INCLUDE[vs_dev10_long](../VS_csharp/includes/vs_dev10_long_md.md)] is installed before [!INCLUDE[vstecasp](../VS_csharp/includes/vstecasp_md.md)] 3.0 or 3.5, an error occurs when you try to debug a [!INCLUDE[vstecasp](../VS_csharp/includes/vstecasp_md.md)] 3.0 or 3.5 application. The error message is, "Unable to Automatically Step Into the Server." To fix this problem, use the Windows **Control Panel**, **Programs and Features** to repair your [!INCLUDE[vs_dev10_long](../VS_csharp/includes/vs_dev10_long_md.md)] installation.  
