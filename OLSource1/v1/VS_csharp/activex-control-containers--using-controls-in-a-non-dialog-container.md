...
1.  Insert CIRC.H in CMYVIEW.H, just before the `CMyView` class definition:  
     ...
     [!code[NVC_MFC_AxCont#12](../VS_csharp/codesnippet/CPP/activex-control-containers--using-controls-in-a-non-dialog-container_1.h)]  
  
2.  Add a member variable (of type `CCirc`) to the protected section of the `CMyView` class definition located in CMYVIEW.H:  
  
     [!code[NVC_MFC_AxCont#13](../VS_csharp/codesnippet/CPP/activex-control-containers--using-controls-in-a-non-dialog-container_2.h)]  
    [!code[NVC_MFC_AxCont#14](../VS_csharp/codesnippet/CPP/activex-control-containers--using-controls-in-a-non-dialog-container_3.h)]  
...
4.  In the handler function, `CMyView::OnCreate`, make a call to the control's `Create` function using the **this** pointer as the parent window:  
     ...
     [!code[NVC_MFC_AxCont#15](../VS_csharp/codesnippet/CPP/activex-control-containers--using-controls-in-a-non-dialog-container_4.cpp)]  
