...
#### Parameters  
 `event1`  
 Type: [IEvent](../VS_csharp/control.ievent--delegate--args--interface--fsharp-.md)`<'Del1,'T>`  
  
 The first input event.  
  
 `event2`  
 Type: [IEvent](../VS_csharp/control.ievent--delegate--args--interface--fsharp-.md)`<'Del2,'T>`  
...
## Example  
 ...
 [!code[FsEvents#5](../VS_csharp/codesnippet/FSharp/event.merge--del1--t--del2--function--fsharp-_1.fs)]  
