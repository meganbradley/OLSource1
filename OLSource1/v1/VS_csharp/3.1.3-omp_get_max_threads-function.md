...
-   **omp_get_num_threads** function, see [Section 3.1.2](../VS_csharp/3.1.2-omp_get_num_threads-function.md) on page 37.  
  
-   **omp_set_num_threads** function, see [Section 3.1.1](../VS_csharp/3.1.1-omp_set_num_threads-function.md) on page 36.  
