...
You can use the Model Editor in [!INCLUDE[vsprvs](../VS_csharp/includes/vsprvs_md.md)] to create 3-D models. You can use the models in your DirectX-based game or app.  
...
|Title|Description|  
|-----------|-----------------|  
|[The Model Editor](../VS_csharp/model-editor.md)|Describes how to use the Model Editor to work with 3-D models.|  
|[Model Editor Examples](../VS_csharp/model-editor-examples.md)|Provides links to topics that demonstrate how to use the Model Editor to perform common 3-D modeling tasks.|