...
## Remarks  
 ...
 `CPrintInfo` contains information about both the print job as a whole, such as the range of pages to be printed, and the current status of the print job, such as the page currently being printed. Some information is stored in an associated [CPrintDialog](../VS_csharp/cprintdialog-class.md) object; this object contains the values entered by the user in the Print dialog box.  
 ...
 `CPrintInfo` is used by the member functions of `CView` listed under "See Also." For more information about the printing architecture provided by the Microsoft Foundation Class Library, see [Frame Windows](../VS_csharp/frame-windows.md) and [Document/View Architecture](../VS_csharp/document-view-architecture.md) and the articles [Printing](../VS_csharp/printing.md) and [Printing: Multipage Documents](../VS_csharp/multipage-documents.md).  
...
### Remarks  
 ...
 You normally don't change this member, but if you do change it, change it before you call [CView::DoPreparePrinting](../VS_csharp/cview-class.md#cview__doprepareprinting) in your override of [CView::OnPreparePrinting](../VS_csharp/cview-class.md#cview__onprepareprinting).  
...
### Example  
  See the example for [CView::OnPreparePrinting](../VS_csharp/cview-class.md#cview__onprepareprinting).  
...
## See Also  
 ...
 [CView::OnBeginPrinting](../VS_csharp/cview-class.md#cview__onbeginprinting)   
 [CView::OnEndPrinting](../VS_csharp/cview-class.md#cview__onendprinting)   
 [CView::OnEndPrintPreview](../VS_csharp/cview-class.md#cview__onendprintpreview)   
 [CView::OnPrepareDC](../VS_csharp/cview-class.md#cview__onpreparedc)   
 [CView::OnPreparePrinting](../VS_csharp/cview-class.md#cview__onprepareprinting)   
