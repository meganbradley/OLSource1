...
2.  Choose the **Enter** event, enter `answer_Enter`, and then choose the Enter key.  
     ...
     ![Properties dialog box](../VS_csharp/media/express_answerenter.png "Express_AnswerEnter")  
...
3.  In the method for the **answer_Enter** event handler, add the following code.  
     ...
     [!code[VbExpressTutorial3Step5_6#11](../VS_csharp/codesnippet/VisualBasic/step-5--add-enter-event-handlers-for-the-numericupdown-controls_1.vb)]
[!code[VbExpressTutorial3Step5_6#11](../VS_csharp/codesnippet/CSharp/step-5--add-enter-event-handlers-for-the-numericupdown-controls_1.cs)]  
...
-   To go to the next tutorial step, see [Step 6: Add a Subtraction Problem](../VS_csharp/step-6--add-a-subtraction-problem.md).  
  
-   To return to the previous tutorial step, see [Step 4: Add the CheckTheAnswer() Method](../VS_csharp/step-4--add-the-checktheanswer---method.md).