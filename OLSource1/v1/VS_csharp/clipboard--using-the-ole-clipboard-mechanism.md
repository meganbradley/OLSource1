...
OLE uses standard formats and some OLE-specific formats for transferring data through the Clipboard.  
 ...
 [!code[NVC_MFCListView#3](../VS_csharp/codesnippet/CPP/clipboard--using-the-ole-clipboard-mechanism_1.cpp)]  
...
-   [Using the Windows Clipboard](../VS_csharp/clipboard--using-the-windows-clipboard.md)  
