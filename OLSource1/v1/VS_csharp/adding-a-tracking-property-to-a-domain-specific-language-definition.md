...
|[!INCLUDE[dsl](../VS_csharp/includes/dsl_md.md)]|[http://go.microsoft.com/fwlink/?LinkID=185581](http://go.microsoft.com/fwlink/?LinkID=185581)|  
...
2.  The system regenerates the code for the solution, and saves DslDefinition.dsl. For information about the XML format of definition files, see [The DslDefinition.dsl File](../VS_csharp/the-dsldefinition.dsl-file.md).  
...
## Testing the Language  
 The next step is to build and run the DSL designer in a new instance of [!INCLUDE[vs_current_short](../VS_csharp/includes/vs_current_short_md.md)] so that you can verify that the tracking property is working correctly.  
...
2.  On the **Debug** menu, click **Start Debugging**.  
     ...
     The experimental build of [!INCLUDE[vs_current_short](../VS_csharp/includes/vs_current_short_md.md)] opens the **Debugging** solution, which contains an empty test file.  
...
## Next Steps  
 If you plan to use more than one tracking property, or implement tracking properties in more than one DSL, you can create a text template to generate the common code for supporting each tracking property. For more information about text templates, see [Generating Artifacts By Using Text Templates](../VS_csharp/code-generation-and-t4-text-templates.md).  
  
## See Also  
 <xref:Microsoft.VisualStudio.Modeling.Design.TrackingPropertyDescriptor*>   
 <xref:Microsoft.VisualStudio.Modeling.Design.ElementTypeDescriptor*>   
 [Defining Domain Models](../VS_csharp/how-to-define-a-domain-specific-language.md)   
 [Walkthrough: Creating a Domain-Specific Language Solution](../VS_csharp/how-to--create-a-domain-specific-language-solution.md)   
 [Walkthrough: Customizing the Domain-Specific Language Definition](../Topic/Walkthrough:%20Customizing%20the%20Domain-Specific%20Language%20Definition.md)