...
### Project References  
 Add the following [!INCLUDE[TLA2#tla_net](../VS_csharp/includes/tla2sharptla_net_md.md)] assemblies to your project references:  
...
### Import the Work Item Namespace  
 In your [!INCLUDE[vsprvs](../VS_csharp/includes/vsprvs_md.md)] project **References**, add references to the following assemblies:  
...
1.  Press **F5**, or on the **Debug** menu, choose **Start Debugging**.  
     ...
     **Troubleshooting**: If a new [!INCLUDE[vsprvs](../VS_csharp/includes/vsprvs_md.md)] does not start, ensure that the VSIX project is set as the Startup project of the solution.  
...
-   `RepositoryGuid` can be obtained from your TFS connection:  
 ...
 For more information about References, see [How to Attach Reference Strings to Model Elements](../VS_csharp/attach-reference-strings-to-uml-model-elements.md).  
...
## See Also  
 ...
 [How to Attach Reference Strings to Model Elements](../VS_csharp/attach-reference-strings-to-uml-model-elements.md)   
