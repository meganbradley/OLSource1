...
## Remarks  
 ...
 When you create an ActiveX control, the wizard inserts this macro after the property map macro [BEGIN_PROP_MAP](../VS_csharp/begin_prop_map.md) and before the property map macro [END_PROP_MAP](../VS_csharp/end_prop_map.md).  
  
## Example  
 In the following example, the extent of the object (`m_sizeExtent`) is being persisted.  
  
 [!code[NVC_ATL_Windowing#131](../VS_csharp/codesnippet/CPP/prop_data_entry_1.h)]  
  
 [!code[NVC_ATL_Windowing#132](../VS_csharp/codesnippet/CPP/prop_data_entry_2.h)]  
