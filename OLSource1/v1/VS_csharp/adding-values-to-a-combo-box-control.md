...
2.  In the [Properties Window](../VS_csharp/properties-window.md), scroll down to the **Data** property.  
...
4.  Click **Enter** when you are finished adding values.  
 ...
 For information on enlarging the drop-down portion of a combo box, see [Setting the Size of the Combo Box and Its Drop-Down List](../VS_csharp/setting-the-size-of-the-combo-box-and-its-drop-down-list.md).  
...
1.  After entering values in the **Data** property, click the **Test** button on the [Dialog Editor Toolbar](../VS_csharp/showing-or-hiding-the-dialog-editor-toolbar.md).  
