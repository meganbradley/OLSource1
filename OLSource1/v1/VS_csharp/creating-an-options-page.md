...
This walkthrough creates a simple Tools/Options page that uses a property grid to examine and set properties.  
 ...
 To save these properties to and restore them from a settings file, follow these steps, and then see [Walkthrough: Creating a Settings Category (C#)](../VS_csharp/creating-a-settings-category.md).  
...
## See Also  
 [Support for Tools/Options Pages](../VS_csharp/options-and-options-pages.md)