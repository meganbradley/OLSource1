...
Like [List.foldBack](../VS_csharp/list.foldback--t--state--function--fsharp-.md), but returns both the intermediate and final results.  
...
## Example  
 The following code example shows how to use `List.scanBack`, and also contrasts its behavior with [List.scan](../VS_csharp/list.scan--t--state--function--fsharp-.md).  
  
 [!code[FsLists#61](../VS_csharp/codesnippet/FSharp/list.scanback--t--state--function--fsharp-_1.fs)]  
