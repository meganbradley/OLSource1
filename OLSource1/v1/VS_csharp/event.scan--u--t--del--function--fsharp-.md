...
## Remarks  
 An item of internal state records the current value of the state parameter. The internal state is not locked during the execution of the accumulation function, so care should be taken that the input [IEvent](../VS_csharp/control.ievent--delegate--args--interface--fsharp-.md) is not triggered by multiple threads simultaneously.  
...
## Example  
 ...
 [!code[FsEvents#8](../VS_csharp/codesnippet/FSharp/event.scan--u--t--del--function--fsharp-_1.fs)]  
