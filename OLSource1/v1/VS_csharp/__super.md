...
## Remarks  
 ...
 `__super` cannot be used with a using declaration. See [using Declaration](../VS_csharp/using-declaration.md) for more information.  
  
 With the introduction of [attributes](../VS_csharp/c---attributes-reference.md) that inject code, your code might contain one or more base classes whose names you may not know but that contain methods that you wish to call.  
