...
## Remarks  
 These constants are used to indicate file type in the **st_mode** field of the [_stat structure](../VS_csharp/standard-types.md).  
...
## See Also  
 ...
 [Standard Types](../VS_csharp/standard-types.md)   
