...
-   At entry to **single**  
 ...
 Note that because the **flush** directive does not have a C language statement as part of its syntax, there are some restrictions on its placement within a program. See [Appendix C](../VS_csharp/c.-openmp-c-and-c---grammar.md) for the formal grammar. The example below illustrates these restrictions.  
