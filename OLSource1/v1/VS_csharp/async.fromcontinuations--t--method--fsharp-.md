...
#### Parameters  
 `callback`  
 Type: `('T ->` [unit](../VS_csharp/core.unit-type-abbreviation--fsharp-.md)`) * (`[exn](../VS_csharp/core.exn-type-abbreviation--fsharp-.md) `->` [unit](../VS_csharp/core.unit-type-abbreviation--fsharp-.md)`) * (`<xref:System.OperationCanceledException*> `->` [unit](../VS_csharp/core.unit-type-abbreviation--fsharp-.md)`) ->` [unit](../VS_csharp/core.unit-type-abbreviation--fsharp-.md)  
...
## Example  
 ...
 [!code[FsAsyncAPIs#23](../VS_csharp/codesnippet/FSharp/async.fromcontinuations--t--method--fsharp-_1.fs)]  
