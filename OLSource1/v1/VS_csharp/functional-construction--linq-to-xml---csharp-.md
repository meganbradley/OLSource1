...
```  
 ...
 These features also enable you to write code that uses the results of [!INCLUDE[vbteclinq](../VS_csharp/includes/vbteclinq_md.md)] queries when you create an XML tree, as follows:  
