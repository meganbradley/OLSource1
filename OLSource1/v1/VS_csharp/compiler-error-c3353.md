...
'delegate' : a delegate can only be created from a global function or a member function of a managed or WinRT type  
 ...
 Delegates, declared with the [__delegate](../Topic/__delegate.md) or [delegate](../VS_csharp/delegate---c---component-extensions-.md) keyword, can only be declared at global scope.  
