...
/OUT:filename directive in .EXP differs from output filename 'filename'; ignoring directive  
 ...
 The `filename` specified in the [NAME](../VS_csharp/name--c-c---.md) or [LIBRARY](../VS_csharp/library.md) statement when the .exp file was created differs from the output `filename` that was either assumed by default or specified with the [/OUT](../VS_csharp/-out--output-file-name-.md) option.  
