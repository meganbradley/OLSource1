...
## Remarks  
 For an overview of reference cells, see [Reference Cells (F#)](../VS_csharp/reference-cells--fsharp-.md).  
...
|Member|Description|  
|------------|-----------------|  
|[Value](../VS_csharp/ref.value--t--property--fsharp-.md)|The current value of the reference cell|  
