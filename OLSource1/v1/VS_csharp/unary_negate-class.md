...
## Remarks  
 ...
 The constructor of `unary_negate` is rarely used directly. The helper function [not1](../VS_csharp/-functional--functions.md#not1_function) provides an easier way to declare and use the **unary_negator** adaptor predicate.  
