...
>  `CWnd::GetCurrentMessage` should only be called within a message handler.  
 ...
 [!code[NVC_MFCControlLadenDialog#4](../VS_csharp/codesnippet/CPP/receiving-notification-from-common-controls_1.cpp)]  
