...
## Flags  
 `value` *,* `setting` **[push]**  
 Specifies floating-point behavior. `value` can be **precise** or **except**. For more information, see [/fp (Specify Floating-Point Behavior)](../VS_csharp/-fp--specify-floating-point-behavior-.md). `setting` can either be **on** or **off**.  
