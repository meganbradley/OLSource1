...
Reference required to assembly '<assemblyname\>' containing the base class '<classname\>'. Add one to your project.  
 ...
 The class is defined in a dynamic-link library (DLL) or assembly that is not directly referenced in your project. The [!INCLUDE[vbprvb](../VS_csharp/includes/vbprvb_md.md)] compiler requires a reference to avoid ambiguity in case the class is defined in more than one DLL or assembly.  
