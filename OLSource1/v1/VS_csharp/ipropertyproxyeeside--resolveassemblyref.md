...
#### Parameters  
 ...
 `assemBytes`  
 [out] Returns an [IEEDataStorage](../VS_csharp/ieedatastorage.md) object containing the assembly bytes associated with the reference.  
 ...
 `alr`  
 [out] Returns a value from the [ASSEMBLYLOCRESOLUTION](../VS_csharp/assemblylocresolution.md) enumeration indicating the location of this reference's assembly.  
