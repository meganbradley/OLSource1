...
-   `std::string` and `std::wstring` types (see [<string\>](../VS_csharp/-string-.md)) instead of raw `char[]` arrays.  
  
-   [Standard template library](../VS_csharp/c---standard-library-header-files.md) (STL) containers like `vector`, `list`, and `map` instead of raw arrays or custom containers. See [<vector\>](../VS_csharp/-vector-.md), [<list\>](../VS_csharp/-list-.md), and [<map\>](../VS_csharp/-map-.md).  
  
-   [STL algorithms](../VS_csharp/-algorithm-.md) instead of manually coded ones.  
  
-   Exceptions, to report and handle error conditions.  
  
-   Lock-free inter-thread communication using STL `std::atomic<>` (see [<atomic\>](../VS_csharp/-atomic-.md)) instead of other inter-thread communication mechanisms.  
  
-   Inline [lambda functions](../VS_csharp/lambda-expressions-in-c--.md) instead of small functions implemented separately.  
  
-   Range-based for loops to write more robust loops that work with arrays, STL containers, and [!INCLUDE[wrt](../VS_csharp/includes/wrt_md.md)] collections in the form `for ( for-range-declaration : expression )`. This is part of the Core Language support. For more information, see [Range-based for Statement (C++)](../VS_csharp/range-based-for-statement--c---.md).  
...
-   [C++11 Features](../VS_csharp/support-for-c--11-14-17-features--modern-c---.md)  
  
-   [C++ Type System](../VS_csharp/c---type-system--modern-c---.md)  
  
-   [Uniform Initialization and Delegating Constructors](../VS_csharp/uniform-initialization-and-delegating-constructors.md)  
  
-   [Object Lifetime and Resource Management](../VS_csharp/object-lifetime-and-resource-management--modern-c---.md)  
  
-   [Objects Own Resources (RAII)](../VS_csharp/objects-own-resources--raii-.md)  
  
-   [Smart Pointers](../VS_csharp/smart-pointers--modern-c---.md)  
  
-   [Pimpl For Compile Time Encapsulation](../VS_csharp/pimpl-for-compile-time-encapsulation--modern-c---.md)  
  
-   [Containers](../VS_csharp/containers--modern-c---.md)  
  
-   [Algorithms](../VS_csharp/algorithms--modern-c---.md)  
  
-   [String and I/O Formatting](../VS_csharp/string-and-i-o-formatting--modern-c---.md)  
  
-   [Errors and Exception Handling](../VS_csharp/errors-and-exception-handling--modern-c---.md)  
  
-   [Portability At ABI Boundaries](../VS_csharp/portability-at-abi-boundaries--modern-c---.md)  
...
## See Also  
 ...
 [Lambda Expressions (C++)](../VS_csharp/lambda-expressions-in-c--.md)   
