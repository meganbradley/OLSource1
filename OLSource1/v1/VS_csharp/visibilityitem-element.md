...
|Element|Description|  
|-------------|-----------------|  
|[VisibilityConstraints](../VS_csharp/visibilityconstraints-element.md)|The `VisibilityConstraints` element determines the static visibility of groups of commands and toolbars.|  
...
## See Also  
 ...
 [VisibilityConstraints](../VS_csharp/visibilityconstraints-element.md)   
