...
4.  Choose **Stop** to close the app.  
 ...
 ![The Network window](../VS_csharp/media/network_fullwindow.png "NETWORK_FullWindow")  
...
## Analyzing data  
 ...
 ![Network tool details pane](../VS_csharp/media/network_detailsviewpane.png "NETWORK_DetailsViewPane")  
...
## See Also  
 [Run Visual Studio diagnostic tools without debugging](../Topic/Run%20profiling%20tools%20without%20debugging.md)   
