...
---
# CPaintDC Class
A device-context class derived from [CDC](../VS_csharp/cdc-class.md).  
...
|Name|Description|  
|----------|-----------------|  
|[CPaintDC::CPaintDC](#cpaintdc__cpaintdc)|Constructs a `CPaintDC` connected to the specified [CWnd](../VS_csharp/cwnd-class.md).|  
  
### Public Data Members  
  
|Name|Description|  
|----------|-----------------|  
|[CPaintDC::m_ps](#cpaintdc__m_ps)|Contains the [PAINTSTRUCT](../VS_csharp/paintstruct-structure.md) used to paint the client area.|  
...
## Remarks  
 It performs a [CWnd::BeginPaint](../VS_csharp/cwnd-class.md#cwnd__beginpaint) at construction time and [CWnd::EndPaint](../VS_csharp/cwnd-class.md#cwnd__endpaint) at destruction time.  
 ...
 For more information on using `CPaintDC`, see [Device Contexts](../VS_csharp/device-contexts.md).  
...
##  <a name="cpaintdc__cpaintdc"></a>  CPaintDC::CPaintDC  
 Constructs a `CPaintDC` object, prepares the application window for painting, and stores the [PAINTSTRUCT](../VS_csharp/paintstruct-structure.md) structure in the [m_ps](#cpaintdc__m_ps) member variable.  
...
### Example  
 [!code[NVC_MFCDocView#97](../VS_csharp/codesnippet/CPP/cpaintdc-class_1.cpp)]  
...
### Example  
 [!code[NVC_MFCDocView#98](../VS_csharp/codesnippet/CPP/cpaintdc-class_2.cpp)]  
  
##  <a name="cpaintdc__m_ps"></a>  CPaintDC::m_ps  
 `m_ps` is a public member variable of type [PAINTSTRUCT](../VS_csharp/paintstruct-structure.md).  
...
### Remarks  
 It is the `PAINTSTRUCT` that is passed to and filled out by [CWnd::BeginPaint](../VS_csharp/cwnd-class.md#cwnd__beginpaint).  
...
## See Also  
 ...
 [Base Class](../VS_csharp/cdc-class.md)   
