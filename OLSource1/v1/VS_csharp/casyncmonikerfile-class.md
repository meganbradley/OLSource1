...
## Remarks  
 Derived from [CMonikerFile](../VS_csharp/cmonikerfile-class.md), which in turn is derived from [COleStreamFile](../VS_csharp/colestreamfile-class.md), `CAsyncMonikerFile` uses the                 [IMoniker](http://msdn.microsoft.com/library/windows/desktop/ms679705) interface to access any data stream asynchronously, including loading files asynchronously from a URL. The files can be datapath properties of ActiveX controls.  
  
 Asynchronous monikers are used primarily in Internet-enabled applications and ActiveX controls to provide a responsive user-interface during file transfers. A prime example of this is the use of [CDataPathProperty](../VS_csharp/cdatapathproperty-class.md) to provide asynchronous properties for ActiveX controls. The `CDataPathProperty` object will repeatedly get a callback to indicate availability of new data during a lengthy property exchange process.  
...
-   [Internet First Steps: Asynchronous Monikers](../VS_csharp/asynchronous-monikers-on-the-internet.md)  
  
-   [Internet First Steps: ActiveX Controls](../VS_csharp/activex-controls-on-the-internet.md)  
...
### Remarks  
 ...
 For a description of the `IBindHost` interface, see the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Return Value  
 Retrieves the settings for **IBindStatusCallBack**. For a description of the `IBindStatusCallback` interface, see the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Remarks  
 ...
 For a description of the `IBinding` interface, see the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Example  
 [!code[NVC_MFCWinInet#5](../VS_csharp/codesnippet/CPP/casyncmonikerfile-class_1.cpp)]  
...
### Remarks  
 ...
 [!code[NVC_MFCWinInet#6](../VS_csharp/codesnippet/CPP/casyncmonikerfile-class_2.cpp)]  
  
 – or –  
  
 [!code[NVC_MFCWinInet#7](../VS_csharp/codesnippet/CPP/casyncmonikerfile-class_3.cpp)]  
  
## See Also  
 [Base Class](../VS_csharp/cmonikerfile-class.md)   
