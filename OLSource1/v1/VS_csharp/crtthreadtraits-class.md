...
-   [CWorkerThread](../VS_csharp/cworkerthread-class.md)  
 ...
 If the thread will not be using CRT functions, use [Win32ThreadTraits](../VS_csharp/win32threadtraits-class.md) instead.  
...
### Remarks  
 ...
 This function calls [_beginthreadex](../VS_csharp/_beginthread--_beginthreadex.md) to create the thread.  
