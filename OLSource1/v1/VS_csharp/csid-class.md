...
## Remarks  
 ...
 Applications should not modify the `SID` structure directly, but instead use the methods provided in this wrapper class. See also [AtlGetOwnerSid](../VS_csharp/atlgetownersid.md), [AtlSetGroupSid](../VS_csharp/atlsetgroupsid.md), [AtlGetGroupSid](../VS_csharp/atlgetgroupsid.md), and [AtlSetOwnerSid](../VS_csharp/atlsetownersid.md).  
...
### Remarks  
 ...
 If initialization fails, the constructor will throw a [CAtlException Class](../VS_csharp/catlexception-class.md).  
...
##  <a name="csid__csidarray"></a>  CSid::CSidArray  
 An array of [CSid](../VS_csharp/csid-class.md) objects.  
...
### Remarks  
 See [EqualPrefixSid](http://msdn.microsoft.com/library/windows/desktop/aa446621) in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)] for more details.  
...
## See Also  
 [Security Sample](../VS_csharp/visual-c---samples.md)   
