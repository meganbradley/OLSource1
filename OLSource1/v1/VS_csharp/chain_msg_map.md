...
## Remarks  
 `CHAIN_MSG_MAP` directs messages to a base class's default message map (declared with [BEGIN_MSG_MAP](../VS_csharp/begin_msg_map.md)). To direct messages to a base class's alternate message map (declared with [ALT_MSG_MAP](../VS_csharp/alt_msg_map.md)), use [CHAIN_MSG_MAP_ALT](../VS_csharp/chain_msg_map_alt.md).  
...
## Example  
 [!code[NVC_ATL_Windowing#107](../VS_csharp/codesnippet/CPP/chain_msg_map_1.h)]  
