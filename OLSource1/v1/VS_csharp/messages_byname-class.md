...
## Remarks  
 Its behavior is determined by the named locale `_Locname`. Each constructor initializes its base object with [messages](../VS_csharp/messages-class.md#messages__messages)<CharType\>( `_Refs`).  
