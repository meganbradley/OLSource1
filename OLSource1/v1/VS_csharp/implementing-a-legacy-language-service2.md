...
### Example  
 This example shows one possible implementation of the <xref:Microsoft.VisualStudio.Package.LanguageService.Name*> property. Note that the name here is hard-coded: the actual name should be obtained from a resource file so it can be used in registering a language service (see [Registering a Language Service (Managed Package Framework)](../VS_csharp/registering-a-legacy-language-service1.md)).  
