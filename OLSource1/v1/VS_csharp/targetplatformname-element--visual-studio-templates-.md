...
Specifies the platform that the project template targets. This element is used to specify that a project template is used to create [!INCLUDE[win8_appname_long](../VS_csharp/includes/win8_appname_long_md.md)] apps.  
...
|Element|Description|  
|-------------|-----------------|  
|[RequiredPlatformVersion](../VS_csharp/requiredplatformversion-element--visual-studio-templates-.md)|Specifies the version of the operation system that the project template targets.|  
