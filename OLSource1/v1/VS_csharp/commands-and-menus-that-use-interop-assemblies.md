...
-   Inform the [!INCLUDE[vsprvs](../VS_csharp/includes/vsprvs_md.md)] integrated development environment (IDE) about the commands it supports and whether they are currently enabled.  
...
## In This Section  
 [Determining Command Status with Interop Assemblies](../VS_csharp/determining-command-status-by-using-interop-assemblies.md)  
 Describes how a VSPackage notifies the IDE about which commands it supports and whether they are currently enabled.  
  
 [Command Contracts in Interop Assemblies](../VS_csharp/command-contracts-in-interop-assemblies.md)  
 ...
 [Registering Interop Assemblies Command Handlers](../VS_csharp/registering-interop-assembly-command-handlers.md)  
 Describes the registry entries required to notify the IDE that a VSPackage provides a command handler.  
  
## Related Sections  
 [Command Context](../VS_csharp/command-availability.md)  
 ...
 Provides details about how to create a UI that uses [!INCLUDE[vsprvs](../VS_csharp/includes/vsprvs_md.md)] command support.  
