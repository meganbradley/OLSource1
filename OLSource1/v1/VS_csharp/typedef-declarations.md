 ...
 *identifier*  
 ...
 Typedef names share the name space with ordinary identifiers (see [Name Spaces](../VS_csharp/name-spaces.md) for more information). Therefore, a program can have a typedef name and a local-scope identifier by the same name. For example:  
