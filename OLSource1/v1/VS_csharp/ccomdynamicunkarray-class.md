...
## Remarks  
 **CComDynamicUnkArray** holds a dynamically allocated array of **IUnknown** pointers, each an interface on a connection point. **CComDynamicUnkArray** can be used as a parameter to the [IConnectionPointImpl](../VS_csharp/iconnectionpointimpl-class.md) template class.  
...
## See Also  
 [CComUnkArray Class](../VS_csharp/ccomunkarray-class.md)   
