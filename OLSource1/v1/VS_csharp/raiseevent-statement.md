...
## Remarks  
 ...
 [!code[VbVbalrEvents#37](../VS_csharp/codesnippet/VisualBasic/raiseevent-statement_1.vb)]  
...
> [!NOTE]
>  You can change the default behavior of events by defining a custom event. For custom events, the `RaiseEvent` statement invokes the event's `RaiseEvent` accessor. For more information on custom events, see [Event Statement](../VS_csharp/event-statement.md).  
...
## Example  
 ...
 [!code[VbVbalrEvents#14](../VS_csharp/codesnippet/VisualBasic/raiseevent-statement_2.vb)]  
...
## Example  
 ...
 [!code[VbVbalrEvents#15](../VS_csharp/codesnippet/VisualBasic/raiseevent-statement_3.vb)]  
...
> [!NOTE]
>  The `My.Application.DoEvents` method does not process events in exactly the same way as the form does. To allow the form to handle the events directly, you can use multithreading. For more information, see [Threading (C# and Visual Basic)](../VS_csharp/threading--csharp-and-visual-basic-.md).  
