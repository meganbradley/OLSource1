...
MFC provides two classes that encapsulate tree controls: [CTreeCtrl](../VS_csharp/ctreectrl-class.md) and [CTreeView](../VS_csharp/ctreeview-class.md). Each class is useful in different situations.  
