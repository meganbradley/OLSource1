...
-   [Data members](../VS_csharp/static-members--c---.md) including built-in types and other user defined types.  
  
-   Operators  
  
-   [Nested Class Declarations](../VS_csharp/nested-class-declarations.md) and.)  
  
-   [Unions](../VS_csharp/unions.md)  
  
-   [Enumerations](../VS_csharp/enumerations--c---.md).  
  
-   [Bit fields](../VS_csharp/c---bit-fields.md).  
  
-   [Friends](../VS_csharp/friend--c---.md).  
  
-   [Aliases and typedefs](../VS_csharp/aliases-and-typedefs--c---.md).  
...
```  
 ...
 There is only one shared copy of static data members for all objects of a given class type. Static data members must be defined and can be initialized at file scope. (For more information about static data members, see [Static Data Members](../VS_csharp/static-members--c---.md).) The following example shows how to perform these initializations:  
