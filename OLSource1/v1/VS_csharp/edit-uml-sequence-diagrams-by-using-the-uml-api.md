...
An interaction is a sequence of messages between a set of lifelines. An interaction is displayed on a UML sequence diagram.  
 ...
 For a more general introduction to writing commands and gesture handlers for UML diagrams, see [How to: Add Commands and Gestures to a Modeling Diagram](../VS_csharp/define-a-menu-command-on-a-modeling-diagram.md).  
...
```  
 ...
 For more information, see [How to Add Commands and Gestures to a Modeling Diagram](../VS_csharp/define-a-menu-command-on-a-modeling-diagram.md).  
