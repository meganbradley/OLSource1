...
|Member|Description|  
|------------|-----------------|  
|[new](../VS_csharp/core.compilationrepresentationattribute-constructor--fsharp-.md)|Creates an instance of the attribute|  
  
## Instance Members  
  
|Member|Description|  
|------------|-----------------|  
|[Flags](../VS_csharp/compilationrepresentationattribute.flags-property--fsharp-.md)|Indicates one or more adjustments to the compiled representation of an F# type or member|  
