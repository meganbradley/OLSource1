...
#### Parameters  
 ...
 `dwAttribFilter`  
 [in] A combination of flags from the [DBG_ATTRIB_FLAGS](../VS_csharp/dbg_attrib_flags.md) enumeration that specifies what type of objects to enumerate, for example `DBG_ATTRIB_METHOD` for all methods that might be children of this property. Used in combination with the `guidFilter` and `pszNameFilter` parameters.  
 ...
 `ppEnum`  
 [out] Returns an [IEnumDebugPropertyInfo2](../VS_csharp/ienumdebugpropertyinfo2.md) object containing a list of the child properties.  
