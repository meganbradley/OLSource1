...
This class extends the <xref:Microsoft.VisualStudio.TestTools.UITest.Extension.UITechnologyManager*> class and is responsible for providing core services for the [!INCLUDE[ofprexcel](../VS_csharp/includes/ofprexcel_md.md)] extension. Although the base class has many methods, only a subset of them is used in this sample.  
