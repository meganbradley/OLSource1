...
#### Parameters  
 `pProgram`  
 [in] An [IDebugProgram2](../VS_csharp/idebugprogram2.md) object that represents the program that has been atypically terminated.  
  
## Return Value  
 If successful, returns `S_OK`; otherwise, returns an error code.  
  
## Remarks  
 After this method is called, the DE subsequently sends an [IDebugProgramDestroyEvent2](../VS_csharp/idebugprogramdestroyevent2.md) event back to the session debug manager (SDM).  
