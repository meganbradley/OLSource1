...
## Remarks  
 These values are used as a parameter to the [Attach](../VS_csharp/idebugengine2--attach.md) and [IDebugProgramEx2::Attach](../VS_csharp/idebugprogramex2--attach.md) methods.  
