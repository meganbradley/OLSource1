...
-   `attributelist`  
     ...
     Optional. See [Attribute List](../VS_csharp/attribute-list--visual-basic-.md).  
...
-   `accessmodifier`  
    ...
    -   `Protected Friend`  
     ...
     See [Access Levels in Visual Basic](../VS_csharp/access-levels-in-visual-basic.md).  
  
-   `Shared`  
  
     Optional. See [Shared](../VS_csharp/shared--visual-basic-.md).  
  
-   `Shadows`  
  
     Optional. See [Shadows](../VS_csharp/shadows--visual-basic-.md).  
  
-   `Static`  
  
     Optional. See [Static](../VS_csharp/static--visual-basic-.md).  
  
-   `ReadOnly`  
  
     Optional. See [ReadOnly](../VS_csharp/readonly--visual-basic-.md).  
  
-   `WithEvents`  
  
     Optional. Specifies that these are object variables that refer to instances of a class that can raise events. See [WithEvents](../VS_csharp/withevents--visual-basic-.md).  
...
-   `variablelist`  
    ...
    |-|-|  
    |Part|Description|  
    |`variablename`|Required. Name of the variable. See [Declared Element Names](../VS_csharp/declared-element-names--visual-basic-.md).|  
...
```  
 ...
 You can declare a variable in a procedure, block, class, structure, or module. You cannot declare a variable in a source file, namespace, or interface. For more information, see [Declaration Contexts and Default Access Levels (Visual Basic)](../VS_csharp/declaration-contexts-and-default-access-levels--visual-basic-.md).  
 ...
 The following access modifiers are used to declare variables outside a procedure: `Public`, `Protected`, `Friend`, `Protected Friend`, and `Private`. For more information, see [Access Levels in Visual Basic](../VS_csharp/access-levels-in-visual-basic.md).  
...
```  
 ...
 If `Option Explicit` is on (the default), the compiler requires a declaration for every variable you use. For more information, see [Option Explicit Statement (Visual Basic)](../VS_csharp/option-explicit-statement--visual-basic-.md).  
...
```  
 ...
 Type inference applies at the procedure level. It does not apply outside a procedure in a class, structure, module, or interface. For more information about type inference, see [Option Infer Statement](../VS_csharp/option-infer-statement.md) and [Local Type Inference (Visual Basic)](../VS_csharp/local-type-inference--visual-basic-.md).  
  
 For information about what happens when a data type or initializer is not specified, see [Default Data Types and Values](../VS_csharp/dim-statement--visual-basic-.md#default) later in this topic.  
...
```  
 ...
 For more information about object initializers, see [How to: Declare an Object by Using an Object Initializer (Visual Basic)](../VS_csharp/how-to--declare-an-object-by-using-an-object-initializer--visual-basic-.md), [Object Initializers: Named and Anonymous Types](../VS_csharp/object-initializers--named-and-anonymous-types--visual-basic-.md), and [Anonymous Types](../VS_csharp/anonymous-types--visual-basic-.md).  
...
## Arrays  
 You can declare a variable to hold an *array*, which can hold multiple values. To specify that a variable holds an array, follow its `variablename` immediately with parentheses. For more information about arrays, see [Arrays in Visual Basic](../VS_csharp/arrays-in-visual-basic.md).  
...
```  
 ...
 For more information about array literals, see [Arrays in Visual Basic](../VS_csharp/arrays-in-visual-basic.md).  
...
|No|No|`Dim qty`|If [Option Strict](../VS_csharp/option-strict-statement.md) is off (the default), the variable is set to `Nothing`.<br /><br /> If `Option Strict` is on, a compile-time error occurs.|  
|No|Yes|`Dim qty = 5`|If [Option Infer](../VS_csharp/option-infer-statement.md) is on (the default), the variable takes the data type of the initializer. See [Local Type Inference (Visual Basic)](../VS_csharp/local-type-inference--visual-basic-.md).<br /><br /> If `Option Infer` is off and `Option Strict` is off, the variable takes the data type of `Object`.<br /><br /> If `Option Infer` is off and `Option Strict` is on, a compile-time error occurs.|  
...
|Yes|Yes|`Dim qty  As Integer = 5`|If the data type of the initializer is not convertible to the specified data type, a compile-time error occurs.|  
 ...
 If you specify a data type but do not specify an initializer, [!INCLUDE[vbprvb](../VS_csharp/includes/vbprvb_md.md)] initializes the variable to the default value for its data type. The following table shows the default initialization values.  
...
## Releasing Managed Resources  
 ...
 The `Using` statement automates the process of acquiring a resource, executing a set of statements, and then disposing of the resource. However, the resource must implement the <xref:System.IDisposable*> interface. For more information, see [Using Statement (Visual Basic)](../VS_csharp/using-statement--visual-basic-.md).  
  
## Example  
 The following example declares variables by using the `Dim` statement with various options.  
  
 [!code[VbVbalrStatements#141](../VS_csharp/codesnippet/VisualBasic/dim-statement--visual-basic-_1.vb)]  
...
## Example  
 ...
 [!code[VbVbalrStatements#142](../VS_csharp/codesnippet/VisualBasic/dim-statement--visual-basic-_2.vb)]  
...
## Example  
 ...
 [!code[VbVbalrStatements#144](../VS_csharp/codesnippet/VisualBasic/dim-statement--visual-basic-_3.vb)]  
  
 [!code[VbVbalrStatements#145](../VS_csharp/codesnippet/VisualBasic/dim-statement--visual-basic-_4.vb)]  
...
## See Also  
 ...
 [Arrays in Visual Basic](../VS_csharp/arrays-in-visual-basic.md)   
 ...
 [Object Initializers: Named and Anonymous Types](../VS_csharp/object-initializers--named-and-anonymous-types--visual-basic-.md)   
 [How to: Declare an Object by Using an Object Initializer](../VS_csharp/how-to--declare-an-object-by-using-an-object-initializer--visual-basic-.md)   
