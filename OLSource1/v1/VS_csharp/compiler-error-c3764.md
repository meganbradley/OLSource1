...
'override_function': cannot override base class method 'base_class_function'  
 ...
 The compiler detected an ill-formed override. For example, the base class function was not `virtual`. For more information, see [override](../VS_csharp/override---c---component-extensions-.md).  
