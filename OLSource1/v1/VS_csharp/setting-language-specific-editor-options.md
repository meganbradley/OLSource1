...
[!INCLUDE[vsprvs](../VS_csharp/includes/vsprvs_md.md)] offers a variety of Text Editor options that apply to specific programming languages.  
  
## In This Section  
 [Visual Basic-Specific, Basic, Text Editor, Options Dialog Box](../VS_csharp/options--text-editor--basic--visual-basic-.md)  
 Describes settings for end constructs, code reformatting, outlining, and error correction suggestions, among others, for [!INCLUDE[vbprvb](../VS_csharp/includes/vbprvb_md.md)] code.  
  
 [Formatting, C/C++, Text Editor, Options Dialog Box](../VS_csharp/options--text-editor--c-c----formatting.md)  
 Describes outlining, indenting, Quick Info, and other settings for C and C++ code.  
  
 [Advanced, C/C++, Text Editor, Options Dialog Box](../VS_csharp/options--text-editor--c-c----advanced.md)  
 Describes settings for IntelliSense and database files when using C and C++.  
  
 [Formatting, C#/J#, Text Editor, Options Dialog Box](../VS_csharp/options--text-editor--csharp--formatting.md)  
 Describes settings for indenting, new line formatting, and wrapping text, among others, for C# and J#.  
  
 [Advanced, C#/J#, Text Editor, Options Dialog Box](../VS_csharp/options--text-editor--csharp--advanced.md)  
 Describes outlining, error identification, and XML documentation comment settings for C# and J#.  
  
 [IntelliSense, C#/J#, Text Editor, Options Dialog Box](../VS_csharp/options--text-editor--csharp--intellisense.md)  
 ...
 [Formatting, XAML, Text Editor, Options Dialog Box](../VS_csharp/options--text-editor--xaml--formatting.md)  
