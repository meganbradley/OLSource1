...
-   **OMP_NUM_THREADS** environment variable, see [Section 4.2](../VS_csharp/4.2-omp_num_threads.md) on page 48.  
  
-   **num_threads** clause, see [Section 2.3](../VS_csharp/2.3-parallel-construct.md) on page 8.  
  
-   **parallel** construct, see [Section 2.3](../VS_csharp/2.3-parallel-construct.md) on page 8.