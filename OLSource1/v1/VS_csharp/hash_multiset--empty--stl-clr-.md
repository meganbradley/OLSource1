...
## Remarks  
 The member function returns true for an empty controlled sequence. It is equivalent to [size](../VS_csharp/hash_multiset--size--stl-clr-.md)`() == 0`. You use it to test whether the hash_multiset is empty.  
...
## See Also  
 ...
 [size](../VS_csharp/hash_multiset--size--stl-clr-.md)