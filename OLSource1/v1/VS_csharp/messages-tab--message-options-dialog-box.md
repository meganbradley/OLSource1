...
Use the **Messages** tab to select which message types to list in [Messages View](../VS_csharp/messages-view.md), and to specify message search criteria. To display the [Message Options Dialog Box](../VS_csharp/message-options-dialog-box.md), choose **Log Messages** from the **Spy** menu.  
