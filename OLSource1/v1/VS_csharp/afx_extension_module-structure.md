...
-   Call [AfxInitExtensionModule](../VS_csharp/afxinitextensionmodule.md) and check the return value.  
  
-   Create a **CDynLinkLibrary** object if the DLL will be exporting [CRuntimeClass](../VS_csharp/cruntimeclass-structure.md) objects or has its own custom resources.  
 ...
 [!code[NVC_MFC_DLL#2](../VS_csharp/codesnippet/CPP/afx_extension_module-structure_1.cpp)]  
 ...
 [!code[NVC_MFC_DLL#5](../VS_csharp/codesnippet/CPP/afx_extension_module-structure_2.cpp)]  
