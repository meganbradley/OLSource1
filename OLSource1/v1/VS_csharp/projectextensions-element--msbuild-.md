...
---
# ProjectExtensions Element (MSBuild)
Allows [!INCLUDE[vstecmsbuild](../VS_csharp/includes/vstecmsbuild_md.md)] project files to contain non-[!INCLUDE[vstecmsbuild](../VS_csharp/includes/vstecmsbuild_md.md)] information. Anything inside of a `ProjectExtensions` element will be ignored by [!INCLUDE[vstecmsbuild](../VS_csharp/includes/vstecmsbuild_md.md)].  
...
## Remarks  
 Only one `ProjectExtensions` element may be used in an [!INCLUDE[vstecmsbuild](../VS_csharp/includes/vstecmsbuild_md.md)] project.  
