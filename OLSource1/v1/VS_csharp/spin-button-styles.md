...
---
# Spin Button Styles
Many of the settings for a spin button ([CSpinButtonCtrl](../VS_csharp/cspinbuttonctrl-class.md)) are controlled by styles. You can set the following styles using the **Properties** window in the dialog editor.  
...
## See Also  
 [Using CSpinButtonCtrl](../VS_csharp/using-cspinbuttonctrl.md)   
