...
#### Parameters  
 `splitter`  
 Type: `'T ->` [Choice](../VS_csharp/core.choice--t1--t2--union--fsharp-.md)`<'U1,'U2>`  
  
 The function that takes an observation and transforms it into one of the two output [Choice](../VS_csharp/core.choice--t1--t2--union--fsharp-.md) types.  
