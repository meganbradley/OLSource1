...
> [!WARNING]
>  This topic does not apply to Windows Store apps. See [How to start a debugging session (Visual C++, Visual C#, and Visual Basic)](../VS_csharp/start-a-debugging-session-for-a-store-app-in-visual-studio--vb--csharp--c---and-xaml-.md) in the Windows Dev Center.  
 ...
 **Enable the Visual Studio hosting process**  
 Select this check box to enable the Visual Studio hosting process. This check box is selected by default. For more information, see [Hosting Process (vshost.exe)](../VS_csharp/hosting-process--vshost.exe-.md).  
  
 To debug in a security zone, you must enable this option and **Debug this application with the selected permission set** in the [Advanced Security Settings Dialog Box](../VS_csharp/advanced-security-settings-dialog-box.md).  
  
## See Also  
 [Debugging in Visual Studio](../VS_csharp/debugging-in-visual-studio.md)   
 [Project Settings for  C# Debug Configurations](../VS_csharp/project-settings-for--csharp-debug-configurations.md)   
