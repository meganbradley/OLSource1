...
An `if` statement identifies which statement to run based on the value of a `Boolean` expression. In the following example, the `Boolean` variable `result` is set to `true` and then checked in the `if` statement. The output is `The condition is true`.  
 ...
 [!code[csrefKeywordsSelection#1](../VS_csharp/codesnippet/CSharp/if-else--csharp-reference-_1.cs)]  
...
```  
 ...
 [!code[csrefKeywordsSelection#2](../VS_csharp/codesnippet/CSharp/if-else--csharp-reference-_2.cs)]  
 ...
 [!code[csrefKeywordsSelection#3](../VS_csharp/codesnippet/CSharp/if-else--csharp-reference-_3.cs)]  
...
## Example  
 ...
 [!code[csrefKeywordsSelection#4](../VS_csharp/codesnippet/CSharp/if-else--csharp-reference-_4.cs)]  
...
## Example  
 ...
 [!code[csrefKeywordsSelection#5](../VS_csharp/codesnippet/CSharp/if-else--csharp-reference-_5.cs)]  
...
## Example  
 ...
 [!code[csrefKeywordsSelection#6](../VS_csharp/codesnippet/CSharp/if-else--csharp-reference-_6.cs)]  
  
 Just as a statement in the else block or the then block can be any valid statement, you can use any valid Boolean expression for the condition. You can use logical operators such as [&&](../VS_csharp/---operator--csharp-reference-.md), [&](../VS_csharp/--operator--csharp-reference-.md), [&#124;&#124;](../VS_csharp/---operator--csharp-reference-.md), [&#124;](../VS_csharp/--operator--csharp-reference-.md) and [!](../VS_csharp/!-operator--csharp-reference-.md) to make compound conditions. The following code shows examples.  
...
## See Also  
 ...
 [if-else Statement (C++)](../VS_csharp/if-else-statement--c---.md)   
