...
---
# ATL_WORKER_THREAD_WAIT
This macro defines the default value in milliseconds that [CWorkerThread::Shutdown](../Topic/CWorkerThread::Shutdown.md) will wait for the worker thread to shut down.  
