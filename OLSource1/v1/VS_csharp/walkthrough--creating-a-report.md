...
[!INCLUDE[smb_current_short](../VS_csharp/includes/smb_current_short_md.md)] doesn’t have built-in reporting capabilities, but you can create and print reports from a [!INCLUDE[smb_current_short](../VS_csharp/includes/smb_current_short_md.md)] application by integrating Word. You can automate reporting by using Visual Studio and APIs for Word, but the Office Integration Pack [!INCLUDE[smb_current_short](../VS_csharp/includes/smb_current_short_md.md)] extension simplifies the task.  
  
 By using the Office Integration Pack, you can more easily automate [!INCLUDE[Word_14_short](../VS_csharp/includes/word_14_short_md.md)], [!INCLUDE[Excel_14_short](../VS_csharp/includes/excel_14_short_md.md)], and [!INCLUDE[Outlook_14_short](../VS_csharp/includes/outlook_14_short_md.md)] in a variety of ways. For example, you can import and export data, create documents and reports, and work with email and appointments. You can download the Office Integration Pack extension for free from CodePlex.  
...
1.  Open [!INCLUDE[Word_14_short](../VS_csharp/includes/word_14_short_md.md)].  
...
1.  On the [!INCLUDE[vsprvs](../VS_csharp/includes/vsprvs_md.md)] menu bar, choose **File**, **Open**, **Project/Solution**.  
