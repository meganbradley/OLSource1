...
```  
 ...
 C2975 will also occur when you use __LINE\_\_ as a compile-time constant with [/ZI](../VS_csharp/-z7---zi---zi--debug-information-format-.md). One solution would be to compile with [/Zi](../VS_csharp/-z7---zi---zi--debug-information-format-.md) instead of **/ZI**.  
