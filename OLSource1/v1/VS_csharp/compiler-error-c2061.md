...
syntax error : identifier 'identifier'  
 ...
 This error could also be caused when the compiler detects an expression as a class template argument; use [typename](../VS_csharp/typename.md) to tell the compiler it is a type.  
...
```  
 ...
 C2061 can occur if you pass an instance name to [typeid](../VS_csharp/typeid---c---component-extensions-.md):  
