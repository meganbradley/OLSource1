...
-   Use the Assembly Linker tool (Al.exe) provided by the [!INCLUDE[dnprdnshort](../VS_csharp/includes/dnprdnshort_md.md)] SDK.  
  
-   For the [!INCLUDE[dnprdnshort](../VS_csharp/includes/dnprdnshort_md.md)] v1.0 or v1.1, use either the <xref:System.Reflection.AssemblyKeyFileAttribute*?displayProperty=fullName> or <xref:System.Reflection.AssemblyKeyNameAttribute*?displayProperty=fullName> attribute.  
  
-   For the [!INCLUDE[dnprdnlong](../VS_csharp/includes/dnprdnlong_md.md)], use either the `/keyfile` or `/keycontainer` compiler option [(/KEYFILE](../VS_csharp/-keyfile--specify-key-or-key-pair-to-sign-an-assembly-.md) or [/KEYCONTAINER](../VS_csharp/-keycontainer--specify-a-key-container-to-sign-an-assembly-.md) linker option in C++).  
  
 **To sign your assembly with a strong name in Visual Studio**  
  
1.  In [!INCLUDE[vsprvs](../VS_csharp/includes/vsprvs_md.md)], open your solution.  
...
-   Use the strong name tool (Sn.exe) that is provided by the [!INCLUDE[dnprdnshort](../VS_csharp/includes/dnprdnshort_md.md)] SDK. For more information, see [Strong Name Tool (Sn.exe)](assetId:///c1d2b532-1b8e-4c7a-8ac5-53b801135ec6).  
