...
## Remarks  
 ...
 initializes the controlled sequence with the sequence `[``right``.`[begin](../VS_csharp/map--begin--stl-clr-.md)`(),` `right``.`[end](../VS_csharp/map--end--stl-clr-.md)`())`, with the default ordering predicate. You use it to specify an initial controlled sequence that is a copy of the sequence controlled by the map object `right`, with the default ordering predicate.  
...
## See Also  
 ...
 [generic_container](../VS_csharp/map--generic_container--stl-clr-.md)   
 [operator=](../VS_csharp/map--operator=--stl-clr-.md)