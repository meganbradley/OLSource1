...
the type 'type' (return type of GetEnumerator) must have a suitable public MoveNext member function and public Current property  
 ...
 See [How to: Iterate Over a User-Defined Collection with for each](../VS_csharp/how-to--iterate-over-a-user-defined-collection-with-for-each.md) for more information.  
