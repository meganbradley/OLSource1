...
## Members  
 ...
 MIF_NAME  
 Initialize/use the `m_bstrName` field in the [MODULE_INFO](../VS_csharp/module_info.md) structure.  
...
## Remarks  
 These values are passed as an argument to the [GetInfo](../VS_csharp/idebugmodule2--getinfo.md) method to indicate which fields of the [MODULE_INFO](../VS_csharp/module_info.md) structure are to be initialized.  
...
## See Also  
 ...
 [GetInfo](../VS_csharp/idebugmodule2--getinfo.md)