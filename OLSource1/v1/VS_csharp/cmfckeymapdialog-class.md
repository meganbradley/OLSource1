...
## Inheritance Hierarchy  
 ...
 [CMFCKeyMapDialog](../VS_csharp/cmfckeymapdialog-class.md)  
...
### Example  
 The following example demonstrates how to construct an object of the `CMFCKeyMapDialog` class. This example is part of the [Visual Studio Demo sample](../VS_csharp/visual-c---samples.md).  
  
 [!code[NVC_MFC_VisualStudioDemo#21](../VS_csharp/codesnippet/CPP/cmfckeymapdialog-class_1.cpp)]  
...
### Return Value  
 A signed integer, such as `IDOK` or `IDCANCEL`, that is passed to the [CDialog::EndDialog](../VS_csharp/cdialog-class.md#cdialog__enddialog) method. The method, in turn, closes the dialog box. For more information, see [CDialog::DoModal](../VS_csharp/cdialog-class.md#cdialog__domodal).  
...
### Return Value  
 If successful, the height of the printed text. For more information, see the Return Value section of [CDC::DrawText](../VS_csharp/cdc-class.md#cdc__drawtext).  
...
## See Also  
 ...
 [CMFCKeyboardManager](../VS_csharp/ckeyboardmanager-class.md)