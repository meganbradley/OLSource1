...
|Val SortPriority|REG_DWORD|100 ([!INCLUDE[vcprx64](../VS_csharp/includes/vcprx64_md.md)])|Determines the sort order in the tree node of files displayed in the **Add New Item** dialog box.|  
  
> [!NOTE]
>  The GUIDS for the Visual C# and Visual Basic project types are as follows:[!INCLUDE[csprcs](../VS_csharp/includes/csprcs_md.md)]: {FAE04EC0-301F-11D3-BF4B-00C04F79EFBC}[!INCLUDE[vbprvb](../VS_csharp/includes/vbprvb_md.md)]: {F184B08F-C81C-45F6-A57F-5ABD9991F28F}  
 ...
 However, you do not have to have everything in one .vsdir file. You can have one .vsdir file for every item in the directory. For more information, see [Wizard (.Vsz) File](../VS_csharp/wizard--.vsz--file.md) and [Template Directory Description (.Vsdir) Files](../VS_csharp/template-directory-description--.vsdir--files.md).  
...
## See Also  
 ...
 [CATIDs for Objects That Are Typically Used to Extend Projects](../VS_csharp/catids-for-objects-that-are-typically-used-to-extend-projects.md)   
 [Adding Project and Project Item Templates](../VS_csharp/adding-project-and-project-item-templates.md)   
 [Template Directory Description (.Vsdir) Files](../VS_csharp/template-directory-description--.vsdir--files.md)   
 [Wizard (.Vsz) File](../VS_csharp/wizard--.vsz--file.md)