...
## Remarks  
 ...
 For more information, see [Generics (C# Programmer's Reference)](../VS_csharp/generics--csharp-programming-guide-.md).  
...
## See Also  
 ...
 [Recommended Tags for Documentation Comments (C# Programmer's Reference)](../VS_csharp/recommended-tags-for-documentation-comments--csharp-programming-guide-.md)