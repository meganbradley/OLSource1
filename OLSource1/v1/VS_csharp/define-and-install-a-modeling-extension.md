...
-   A [!INCLUDE[vsprvs](../VS_csharp/includes/vsprvs_md.md)] Integration Extension (VSIX) project. This generates a file that acts as an installer for the components of your extension.  
...
|--------------------|-----------|----------------------------------------------|  
|Menu Command|[How to: Define Menu Commands on a UML Diagram](../VS_csharp/define-a-menu-command-on-a-modeling-diagram.md)|`[ClassDesignerExtension]`<br /><br /> `// or other diagram types`<br /><br /> `[Export(typeof(ICommandExtension))]`<br /><br /> `public class MyCommand : ICommandExtension`<br /><br /> `{...`|  
|Drag-and-drop or double-click|[How to Define a Gesture Handler on a UML Diagram](../VS_csharp/define-a-gesture-handler-on-a-modeling-diagram.md)|`[ClassDesignerExtension]`<br /><br /> `// or other diagram types`<br /><br /> `[Export(typeof(IGestureExtension))]`<br /><br /> `public class MyGesture : IGestureExtension`<br /><br /> `{...`|  
|Validation Constraint|[How to: Define Validation Constraints on UML Models](../VS_csharp/define-validation-constraints-for-uml-models.md)|`[Export(typeof(     System.Action<ValidationContext, object>))]`<br /><br /> `[ValidationMethod(ValidationCategories.Save`<br /><br /> `&#124; ValidationCategories.Menu)]`<br /><br /> `public void ValidateSomething`<br /><br /> `(ValidationContext context, IClassifier elementToValidate)`<br /><br /> `{...}`|  
|Work Item link event handler|[How to: Link Work Items and Other References to Model Elements](../VS_csharp/define-a-work-item-link-handler.md)|`[Export(typeof(ILinkedWorkItemExtension))]`<br /><br /> `public class MyWorkItemEventHandler : ILinkedWorkItemExtension`<br /><br /> `{...`|  
|UML Profile|[How to: Define a Profile to Extend UML](../VS_csharp/define-a-profile-to-extend-uml.md)|(To be defined)|  
|Toolbox Item|[How to: Define a Custom Modeling Toolbox Item](../VS_csharp/define-a-custom-modeling-toolbox-item.md)|(To be defined)|  
  
## Running an Extension During its Development  
  
#### To run an extension during its development  
  
1.  In the [!INCLUDE[vs_current_short](../VS_csharp/includes/vs_current_short_md.md)] **Debug** menu, choose **Start Debugging**.  
  
     The project builds, and a new instance of [!INCLUDE[vs_current_short](../VS_csharp/includes/vs_current_short_md.md)] starts in Experimental mode.  
...
## See Also  
 [How to: Define a Profile to Extend UML](../VS_csharp/define-a-profile-to-extend-uml.md)   
 [How to: Define a Custom Modeling Toolbox Item](../VS_csharp/define-a-custom-modeling-toolbox-item.md)   
 [How to: Define Validation Constraints on UML Models](../VS_csharp/define-validation-constraints-for-uml-models.md)   
 [How to: Add Commands and Gestures to a Modeling Diagram](../VS_csharp/define-a-menu-command-on-a-modeling-diagram.md)