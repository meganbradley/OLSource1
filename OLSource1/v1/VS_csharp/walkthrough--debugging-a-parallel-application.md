...
2.  In the **Installed Templates** pane, select either Visual C#, Visual Basic, or Visual C++. For the managed languages, ensure that [!INCLUDE[net_v40_short](../VS_csharp/includes/net_v40_short_md.md)] is displayed in the framework box.  
...
5.  Paste the following code for your chosen language into the empty code file.  
 ...
 [!code[Debugger#1](../VS_csharp/codesnippet/CSharp/walkthrough--debugging-a-parallel-application_1.cs)]
[!code[Debugger#1](../VS_csharp/codesnippet/CPP/walkthrough--debugging-a-parallel-application_1.cpp)]
[!code[Debugger#1](../VS_csharp/codesnippet/VisualBasic/walkthrough--debugging-a-parallel-application_1.vb)]  
...
1.  On the **Debug** menu, point to **Windows** and then click **Parallel Stacks**. Make sure that **Threads** is selected in the box at the upper-left corner.  
     ...
     ![Threads view in Parallel Stacks window](../VS_csharp/media/pdb_walkthrough_1.png "PDB_Walkthrough_1")  
     ...
     ![Tooltip that shows thread IDs and names](../VS_csharp/media/pdb_walkthrough_1a.png "PDB_Walkthrough_1A")  
  
     The yellow arrow indicates the active stack frame of the current thread. To get more information, hover over it  
  
     ![Tooltip on active stack frame](../VS_csharp/media/pdb_walkthrough_1b.png "PDB_Walkthrough_1B")  
     ...
     ![Highlighted main thread in Parallel Stacks window](../VS_csharp/media/pdb_walkthrough_1c.png "PDB_Walkthrough_1C")  
...
1.  To resume execution until the second breakpoint is hit, on the **Debug** menu, click **Continue**. The following illustration shows the thread tree at the second breakpoint.  
     ...
     ![Parallel Stacks window that shows many branches](../VS_csharp/media/pdb_walkthrough_2.png "PDB_Walkthrough_2")  
     ...
     ![Parallel Stacks Path of Execution](../VS_csharp/media/pdb_walkthrough_2b.png "PDB_Walkthrough_2B")  
     ...
     ![Stacks menu with 2 options on C while J is current](../VS_csharp/media/pdb_walkthrough_3.png "PDB_Walkthrough_3")  
     ...
     ![Empty Parallel Stacks window and tooltip](../VS_csharp/media/pdb_walkthrough_3a.png "PDB_Walkthrough_3A")  
...
1.  To resume execution until the third breakpoint is hit, on the **Debug** menu, click **Continue**.  
     ...
     ![Execution path in Parallel Stacks window](../VS_csharp/media/pdb_walkthrough_3b.png "PDB_Walkthrough_3B")  
     ...
     ![Method view in Parallel Stacks window](../VS_csharp/media/pdw_walkthrough_4.png "PDW_Walkthrough_4")  
    ...
    -   **Show External Code** displays all the frames even if they are not in user code. Try it to see the diagram expand to accommodate the additional frames (which may be dimmed because you do not have symbols for them).  
     ...
     ![Autoscrolling in the Parallel Stacks window](../VS_csharp/media/pdb_walkthrough_4a.png "PDB_Walkthrough_4A")  
...
1.  To resume execution until the fourth breakpoint is hit, on the **Debug** menu, click **Continue**.  
     ...
     ![Bird's&#45;eye view in Parallel Stacks window](../VS_csharp/media/pdb_walkthrough_5.png "PDB_Walkthrough_5")  
     ...
     ![Zoomed stacks in Parallel Stacks window](../VS_csharp/media/pdb_walkthrough_5a.png "PDB_Walkthrough_5A")  
...
5.  On the **Debug** menu, point to **Windows** and then click **Parallel Tasks**. The following illustration shows the **Parallel Tasks** window.  
     ...
     ![Four running tasks in Parallel Tasks window](../VS_csharp/media/pdw_walkthrough_6.png "PDW_Walkthrough_6")  
...
1.  To resume execution until the second breakpoint is hit, on the **Debug** menu, click **Continue**.  
     ...
     ![Two waiting tasks in Parallel Tasks window](../VS_csharp/media/pdb_walkthrough_7.png "PDB_Walkthrough_7")  
  
     Task 4, in turn, is waiting on a monitor owned by the thread assigned to task 2.  
  
     ![Waiting task and tooltip in Tasks window](../VS_csharp/media/pdb_walkthrough_7a.png "PDB_Walkthrough_7A")  
     ...
     ![Threads view in Parallel Stacks window](../VS_csharp/media/pdb_walkthrough_8.png "PDB_Walkthrough_8")  
     ...
     ![Shortcut view menu in Parallel Tasks window](../VS_csharp/media/pdb_walkthrough_8a.png "PDB_Walkthrough_8A")  
...
1.  To resume execution until the third breakpoint is hit, on the **Debug** menu, click **Continue**.  
     ...
     ![Parent&#45;child view in Parallel Tasks window](../VS_csharp/media/pdb_walkthrough_9.png "PDB_Walkthrough_9")  
     ...
     ![Task view in Parallel Stacks window](../VS_csharp/media/pdb_walkthrough_9a.png "PDB_Walkthrough_9A")  
     ...
     ![Highlighted thread in threads view](../VS_csharp/media/pdb_walkthrough_9b.png "PDB_Walkthrough_9B")  
...
1.  To resume execution until the third breakpoint is hit, on the **Debug** menu, click **Continue**. Click the **ID** column header to sort by ID. You should see the following illustration.  
     ...
     ![Four task states in Parallel Stacks window](../VS_csharp/media/pdb_walkthrough_10.png "PDB_Walkthrough_10")  
     ...
     ![Header tooltip in Parallel Stacks window](../VS_csharp/media/pdb_walkthrough_11.png "PDB_Walkthrough_11")  
     ...
     ![Grouped tasks in Parallel Tasks window](../VS_csharp/media/pdb_walkthrough_12.png "PDB_Walkthrough_12")  
     ...
     ![Grouped stacks in Parallel Stacks window](../VS_csharp/media/pdb_walkthrough_12a.png "PDB_Walkthrough_12A")  
     ...
     ![Shortcut menu in Parallel Tasks window](../VS_csharp/media/pdb_walkthrough_12b.png "PDB_Walkthrough_12B")  
...
## See Also  
 [Debugging Multithreaded Applications](../VS_csharp/walkthrough--debugging-a-parallel-application.md)   
