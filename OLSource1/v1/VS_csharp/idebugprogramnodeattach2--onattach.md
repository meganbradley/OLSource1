...
---
# IDebugProgramNodeAttach2::OnAttach
Attaches to the associated program or defers the attach process to the [IDebugEngine2::Attach](../VS_csharp/idebugengine2--attach.md) method.  
...
## Return Value  
 If successful, returns `S_OK`. Returns `S_FALSE` if the [IDebugEngine2::Attach](../VS_csharp/idebugengine2--attach.md) method should not be called. Otherwise, returns an error code.  
