...
-   To clarify the glossary of terms used for communication between the application and its users, and in descriptions of the users' needs. See [Clarifying User Requirements](../VS_csharp/model-user-requirements.md).  
...
### Relationship to Other Diagrams  
 ...
 See [UML Activity Diagrams: Guidelines](../VS_csharp/uml-activity-diagrams--guidelines.md).  
 ...
 See [UML Sequence Diagrams: Guidelines](../VS_csharp/uml-sequence-diagrams--guidelines.md).  
  
 Component diagram  
  
 Component interfaces, listing their operations.  
  
 See [UML Component Diagrams: Guidelines](../VS_csharp/uml-component-diagrams--guidelines.md).  
  
 Use case diagram  
  
 Types mentioned in descriptions of the goals and steps of a use case.  
  
 See [UML Use Case Diagrams: Guidelines](../VS_csharp/uml-use-case-diagrams--guidelines.md).  
  
##  <a name="BasicSteps"></a> Basic Steps for Drawing Class Diagrams  
 For reference information about the elements on UML class diagrams, see [UML Class Diagrams: Overview](../VS_csharp/uml-class-diagrams--reference.md).  
...
##  <a name="UsingTypes"></a> Using Classes, Interfaces, and Enumerations  
 ...
 ![A class, an enumeration, and an interface](../VS_csharp/media/uml_classguidetypes.png "UML_ClassGuideTypes")  
...
### Getting Types from Other Diagrams  
 ...
 See [Component Diagram: Guidelines](../VS_csharp/uml-component-diagrams--guidelines.md).  
 ...
 To create a class from a lifeline, open the shortcut menu for the lifeline, and then choose **Create Class** or **Create Interface**. See [UML Sequence Diagram: Guidelines](../VS_csharp/uml-sequence-diagrams--guidelines.md).  
...
-   **Is Navigable**. If true for only one role, an arrow appears in the navigable direction. You can use this to indicate navigability of links and database relations in the software.  
 ...
 For the full details of these and other properties, see [Properties of Associations in UML Class Diagrams](../VS_csharp/properties-of-associations-on-uml-class-diagrams.md).  
...
### Attributes and Associations  
 ...
 ![Equivalent association and attributes](../VS_csharp/media/uml_classguideattrib.png "UML_ClassGuideAttrib")  
...
### Realization  
 ...
 ![Realization shown with conector and lollipop](../VS_csharp/media/uml_classguiderealize.png "UML_ClassGuideRealize")  
...
##  <a name="Templates"></a> Template Types  
 ...
 ![Template class with two parameters](../VS_csharp/media/uml_classguidetemplate1.png "UML_ClassGuideTemplate1")  
...
9. Add attributes and operations to the template type as you would do for other classes.  
 ...
 ![A  class bound from the Dictionary template](../VS_csharp/media/uml_classguidetemplate2.png "UML_ClassGuideTemplate2")  
...
##  <a name="Packages"></a> Packages  
 ...
 See [Defining Namespaces with Packages](../VS_csharp/define-packages-and-namespaces.md).  
...
-   Open the shortcut menu for the diagram or an element, choose **Generate Code**, and then set the necessary properties.  
     ...
     For more information about how to set these properties and customize the provided templates, see [How to: Generate Code from UML Class Diagrams](../VS_csharp/generate-code-from-uml-class-diagrams.md).  
