...
-   No palette changes are allowed in the video stream.  
 ...
 For more information on using `CAnimateCtrl`, see [Controls](../VS_csharp/controls--mfc-.md) and [Using CAnimateCtrl](../VS_csharp/using-canimatectrl.md).  
...
### Example  
 [!code[NVC_MFCControlLadenDialog#56](../VS_csharp/codesnippet/CPP/canimatectrl-class_1.cpp)]  
...
### Parameters  
 `dwStyle`  
 Specifies the animation control's style. Apply any combination of the windows styles described in the Remarks section below and the animation control styles described in                                 [Animation Control Styles](http://msdn.microsoft.com/library/windows/desktop/bb761886) in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
  
 `rect`  
 Specifies the animation control's position and size. It can be either a [CRect](../VS_csharp/crect-class.md) object or a [RECT](../VS_csharp/rect-structure.md) structure.  
...
### Remarks  
 ...
 Apply the following [window styles](../VS_csharp/window-styles.md) to an animation control.  
...
-   **WS_DISABLED** Rarely  
 ...
 In addition to the window styles listed above, you may want to apply one or more of the animation control styles to an animation control. See the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)] for more information on                         [animation control styles](http://msdn.microsoft.com/library/windows/desktop/bb761886).  
...
### Parameters  
 ...
 `dwStyle`  
 Specifies the animation control's style. Apply any combination of the window and animation control styles described in                                 [Animation Control Styles](http://msdn.microsoft.com/library/windows/desktop/bb761886) in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Remarks  
 This method sends the                         [ACM_ISPLAYING](http://msdn.microsoft.com/library/windows/desktop/bb761895) message, which is described in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
