...
This walkthrough builds on the demonstration in [Walkthrough:Adding a Menu to the Visual Studio Menu Bar (C#)](../VS_csharp/adding-a-menu-to-the-visual-studio-menu-bar.md) by showing how to add a submenu to the **TestMenu** menu.  
...
1.  Follow the steps in [Walkthrough: Adding a Menu to the Visual Studio Menu Bar (C#)](../VS_csharp/adding-a-menu-to-the-visual-studio-menu-bar.md) to create the project and menu item. The steps in this walkthrough assume that the name of the VSIX project is `TopLevelMenu`.  
...
3.  Add the newly created submenu to the `<Menus>` section.  
    ...
    ```  
     ...
     The GUID/ID pair of the parent specifies the menu group that was generated in [Walkthrough:Adding a Menu to the Visual Studio Menu Bar (C#)](../VS_csharp/adding-a-menu-to-the-visual-studio-menu-bar.md), and is a child of the top-level menu.  
...
## See Also  
 [Creating a Top Level Menu](../VS_csharp/adding-a-menu-to-the-visual-studio-menu-bar.md)   
