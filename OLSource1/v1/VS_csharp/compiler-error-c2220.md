...
warning treated as error - no object file generated  
 ...
 [/WX](../VS_csharp/-w---w0---w1---w2---w3---w4---w1---w2---w3---w4---wall---wd---we---wo---wv---wx--warning-level-.md) tells the compiler to treat all warnings as errors. Because an error occurred, no object or executable file was generated.  
...
-   Use a [warning](../VS_csharp/warning.md) pragma to disable or suppress a specific warning.  
