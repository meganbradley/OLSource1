...
### Remarks  
 The type describes a specialization of template class [basic_string](../VS_csharp/basic_string-class.md) whose objects can store copies of the punctuation sequences.  
