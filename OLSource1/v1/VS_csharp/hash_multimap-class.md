...
# hash_multimap Class
> [!NOTE]
>  This API is obsolete. The alternative is [unordered_multimap Class](../VS_csharp/unordered_multimap-class.md).  
...
-   A template class, because the functionality it provides is generic and so independent of the specific type of data contained as elements or keys. The data types to be used for elements and keys are, instead, specified as parameters in the class template along with the comparison function and allocator.  
 ...
 The hash_multimap orders the sequence it controls by calling a stored hash `Traits` object of type [value_compare](../VS_csharp/value_compare-class.md). This stored object may be accessed by calling the member function [key_comp](../VS_csharp/hash_map-class.md#hash_map__key_comp). Such a function object must behave the same as an object of class [hash_compare](../VS_csharp/hash_compare-class.md)`<Key,  less<Key> >`. Specifically, for all values `Key` of type `Key`, the call `Traits (Key)` yields a distribution of values of type `size_t`.  
...
### Remarks  
 ...
 For more information on `Allocator`, see the Remarks section of the [hash_multimap Class](../VS_csharp/hash_multimap-class.md) topic.  
...
### Return Value  
 A const bidirectional iterator addressing the first element in the [hash_multimap](../VS_csharp/hash_multimap-class.md) or the location succeeding an empty `hash_multimap`.  
...
### Return Value  
 A const bidirectional iterator that addresses the location succeeding the last element in a [hash_multimap](../VS_csharp/hash_multimap-class.md). If the `hash_multimap` is empty, then `hash_multimap::cend == hash_multimap::begin`.  
...
### Return Value  
 A const reverse bidirectional iterator addressing the first element in a reversed [hash_multimap](../VS_csharp/hash_multimap-class.md) or addressing what had been the last element in the unreversed `hash_multimap`.  
...
### Return Value  
 A const reverse bidirectional iterator that addresses the location succeeding the last element in a reversed [hash_multimap](../VS_csharp/hash_multimap-class.md) (the location that had preceded the first element in the unreversed `hash_multimap`).  
...
|`_Val`|The value used to move construct an element to be inserted into the [hash_multimap](../VS_csharp/hash_multimap-class.md).|  
...
|-|-|  
|Parameter|Description|  
|`_Val`|The value used to move construct an element to be inserted into the [hash_multimap](../VS_csharp/hash_multimap-class.md) unless the `hash_multimap` already contains that element (or, more generally, an element whose key is equivalently ordered).|  
 ...
 **key_compare** is a synonym for the template parameter `Traits`.  
 ...
 For more information on `Traits` see the [hash_multimap Class](../VS_csharp/hash_multimap-class.md) topic.  
...
### Remarks  
 ...
 For more information on `Key`, see the Remarks section of the [hash_multimap Class](../VS_csharp/hash_multimap-class.md) topic.  
...
### Remarks  
 ...
 For more information on `Type` see the [hash_multimap Class](../VS_csharp/hash_multimap-class.md) topic.  
...
|-|-|  
|Parameter|Description|  
|`_Right`|The [hash_multimap](../VS_csharp/hash_multimap-class.md) being copied into the `hash_multimap`.|  
