...
Sorts the elements of an array, using the given projection for the keys and returning a new array. Elements are compared using [Operators.compare](../VS_csharp/operators.compare--t--function--fsharp-.md).  
...
## Remarks  
 This is not a stable sort, that is, the original order of equal elements is not necessarily preserved. For a stable sort, consider using [Seq.sort](../VS_csharp/seq.sort--t--function--fsharp-.md).  
...
## Example  
 ...
 [!code[FsArrays#38](../VS_csharp/codesnippet/FSharp/array.sortby--t--key--function--fsharp-_1.fs)]  
