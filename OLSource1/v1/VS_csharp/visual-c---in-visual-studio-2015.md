...
The [!INCLUDE[vcprvc](../VS_csharp/includes/vcprvc_md.md)] programming language and development tools help you develop native Universal Windows apps, native desktop and server applications, cross-platform libraries that run on Android and iOS as well as Windows, and managed apps that run on the .NET Framework.  
...
## General Information about Visual C++  
 [What's New for Visual C++ in Visual Studio](../VS_csharp/what-s-new-for-visual-c---in-visual-studio-2015.md)  
 Find out what’s new in Visual C++.  
  
 [Breaking Changes](../VS_csharp/breaking-changes-in-visual-c---2015.md)  
 ...
 [How to Report a Problem with the Visual C++ Toolset](../VS_csharp/how-to-report-a-problem-with-the-visual-c---toolset.md)  
 ...
 Guidance for porting code and upgrading projects to Visual C++ in [!INCLUDE[vs_dev14](../VS_csharp/includes/vs_dev14_md.md)], including porting C++ code to Windows 10 and the Universal Windows Platform.  
  
 [Support For C++11 Features (Modern C++)](../VS_csharp/support-for-c--11-14-17-features--modern-c---.md)  
 Learn about support for C++11 and C++14 features in Visual C++.  
  
 [Visual C++ Team Blog](http://blogs.msdn.com/b/vcblog/)  
 Learn more about new features and the latest information from the developers of [!INCLUDE[vcprvc](../VS_csharp/includes/vcprvc_md.md)].  
  
 [Visual Studio Downloads](http://go.microsoft.com/fwlink/?LinkId=235233)  
 Download Visual C++.  
  
 [Visual C++ Editions](../VS_csharp/visual-c---tools-and-templates-in-visual-studio-editions.md)  
 Find out about different Visual Studio editions.  
  
 [Supported Platforms (Visual C++)](../VS_csharp/supported-platforms--visual-c---.md)  
 Find out which platforms are supported.  
  
 [Visual C++ Samples](../VS_csharp/visual-c---samples.md)  
...
## Writing Applications in C++  
 [Windows Store Apps](../VS_csharp/universal-windows-apps--c---.md)  
 ...
 [Win32 Desktop Applications](../VS_csharp/desktop-applications--visual-c---.md)  
 ...
 [Parallel Programming in Visual C++](../VS_csharp/parallel-programming-in-visual-c--.md)  
 ...
 [Security Best Practices for C++](../VS_csharp/security-best-practices-for-c--.md)  
 Learn how to protect applications from malicious code and unauthorized use.  
  
 [Cloud and Web Programming](../VS_csharp/cloud-and-web-programming-in-visual-c--.md)  
...
## C++ Development Tools  
 To find out about how to create projects, work with source code files, link to libraries, compile, debug, profile, deploy, and more, see [Visual C++ Development Tools](../VS_csharp/ide-and-tools-for-visual-c---development.md).  
  
## C++ Language Reference  
 For information about the C++ language, see [C++ Language Reference](../VS_csharp/c---language-reference.md).  
  
 For information about the C++ preprocessor, see [C/C++ Preprocessor Reference](../VS_csharp/c-c---preprocessor-reference.md).  
...
## C++ Libraries in Visual Studio  
 ...
 [C Runtime Library (CRT)](../VS_csharp/c-run-time-library-reference.md)  
 ...
 [Active Template Library (ATL)](../VS_csharp/atl-com-desktop-components.md)  
 Support for  COM components and apps.  
  
 [Microsoft Foundation Class (MFC) libraries](../VS_csharp/mfc-desktop-applications.md)  
 ...
 [!INCLUDE[win8_appname_long](../VS_csharp/includes/win8_appname_long_md.md)] apps and components.  
 ...
 See also the documentation for [STL/CLR](../VS_csharp/stl-clr-library-reference.md) and the [C++ Support Library](../VS_csharp/c---support-library.md).  
