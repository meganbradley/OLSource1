...
If you use Visual Studio to write a [!INCLUDE[cppwrl](../VS_csharp/includes/cppwrl_md.md)] ([!INCLUDE[cppwrl_short](../VS_csharp/includes/cppwrl_short_md.md)]) project, you can greatly simplify your task by downloading the WRL Class Library project template.  
...
## Download the WRL Project Template  
 Visual Studio doesn't provide a template for [!INCLUDE[cppwrl_short](../VS_csharp/includes/cppwrl_short_md.md)] projects. Here’s how to download a project template that creates a basic class library for [!INCLUDE[win8_appname_long](../VS_csharp/includes/win8_appname_long_md.md)] apps with [!INCLUDE[cppwrl_short](../VS_csharp/includes/cppwrl_short_md.md)].  
...
## Examples that use the project template  
 Read [Walkthrough: Creating a Basic Windows Runtime Component (WRL)](../VS_csharp/walkthrough--creating-a-basic-windows-runtime-component-using-wrl.md) for an example that uses this template to create a [!INCLUDE[wrt](../VS_csharp/includes/wrt_md.md)] component.  
...
-   an .idl file that declares the MIDL attributes for a basic interface its class implementation. Here’s an example.  
     ...
     [!code[wrl-project-template#1](../VS_csharp/codesnippet/CPP/wrl-class-library-project-template_1.idl)]  
  
-   a .cpp file that defines the class implementation. Here’s an example.  
  
     [!code[wrl-project-template#2](../VS_csharp/codesnippet/CPP/wrl-class-library-project-template_2.cpp)]  
  
     The [RuntimeClass](../VS_csharp/runtimeclass-class.md) base class helps manage the global reference of all objects in the module and declares the methods of the [IUnknown](assetId:///33f1d79a-33fc-4ce5-a372-e08bda378332) and [IInspectable](assetId:///0657e51f-d4c0-46c6-927d-b01e54b6846c) interfaces. The [InspectableClass](../VS_csharp/inspectableclass-macro.md) macro implements `IUnknown` and `IInspectable`. The [ActivatableClass](../VS_csharp/activatableclass-macros.md) macro creates a class factory that creates instances of the class.  
