...
## Members  
 ...
 PFLAG_REMOTE_PORT  
 Caller wants a list of programs on a different machine than [!INCLUDE[vsprvs](../VS_csharp/includes/vsprvs_md.md)].  
  
 PFLAG_DEBUGGEE  
 The process is currently being debugged by this instance of [!INCLUDE[vsprvs](../VS_csharp/includes/vsprvs_md.md)].  
  
 PFLAG_ATTACH_TODEBUGGEE  
 [!INCLUDE[vsprvs](../VS_csharp/includes/vsprvs_md.md)] is attached to the program being debugged but did not launch it.  
  
 PFLAG_REASON_WATCH  
 [!INCLUDE[vsprvs](../VS_csharp/includes/vsprvs_md.md)] is watching for events.  
  
 PFLAG_GET_PROGRAM_NODES  
 Caller wants the `ProgramNodes` field of the [PROVIDER_PROCESS_DATA](../VS_csharp/provider_process_data.md) structure.  
