...
```  
 ...
 The [no_injected_text](../VS_csharp/no_injected_text.md) attribute is embedded in an .mrg file, which allows for the compilation of the .mrg file without text being reinjected.  
