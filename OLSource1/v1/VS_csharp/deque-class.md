...
|[const_reverse_iterator](#deque__const_reverse_iterator)|A type that provides a random-access iterator that can access and read elements in the `deque` as `const`. The deque is viewed in reverse. For more information, see [reverse_iterator Class](../VS_csharp/reverse_iterator-class.md)|  
...
### Remarks  
 ...
 When compiling with _SECURE_SCL 1, a runtime error will occur if you attempt to access an element in an empty deque.  See [Checked Iterators](../VS_csharp/checked-iterators.md) for more information.  
...
### Return Value  
 A const reverse random-access iterator addressing the first element in a reversed [deque](../VS_csharp/deque-class.md) or addressing what had been the last element in the unreversed `deque`.  
...
### Return Value  
 A const reverse random-access iterator that addresses the location succeeding the last element in a reversed [deque](../VS_csharp/deque-class.md) (the location that had preceded the first element in the unreversed deque).  
  
### Remarks  
 `crend` is used with a reversed `deque` just as [cend](../VS_csharp/array-class--stl-.md#array__cend) is used with a `deque`.  
...
|-|-|  
|Parameter|Description|  
|`_Where`|The position in the [deque](../VS_csharp/deque-class.md) where the first element is inserted.|  
...
|-|-|  
|Parameter|Description|  
|`_Val`|The element added to the end of the [deque](../VS_csharp/deque-class.md).|  
...
|-|-|  
|Parameter|Description|  
|`_Val`|The element added to the beginning of the [deque](../VS_csharp/deque-class.md).|  
...
### Remarks  
 For more information on **erase**, see [deque::erase and deque::clear](../Topic/deque::erase%20and%20deque::clear.md).  
...
### Remarks  
 ...
 When compiling with _SECURE_SCL 1, a runtime error will occur if you attempt to access an element outside the bounds of the deque.  See [Checked Iterators](../VS_csharp/checked-iterators.md) for more information.  
...
##  <a name="deque__pointer"></a>  deque::pointer  
 Provides a pointer to an element in a [deque](../VS_csharp/deque-class.md).  
...
### Example  
  See the example for [rbegin](../VS_csharp/vector-class.md#vector__rbegin).  
...
### Remarks  
 There is no portable way to determine if `shrink_to_fit` reduces the storage used by a [deque](../VS_csharp/deque-class.md).  
