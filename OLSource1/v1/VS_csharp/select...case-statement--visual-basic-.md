...
> [!NOTE]
>  The `Is` keyword used in the `Case` and `Case Else` statements is not the same as the [Is Operator](../VS_csharp/is-operator--visual-basic-.md), which is used for object reference comparison.  
...
## Example  
 ...
 [!code[VbVbalrStatements#54](../VS_csharp/codesnippet/VisualBasic/select...case-statement--visual-basic-_1.vb)]  
