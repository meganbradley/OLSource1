...
-   [Create new toolbars and buttons](../VS_csharp/creating-new-toolbars.md)  
  
-   [Convert bitmaps to toolbar resources](../VS_csharp/converting-bitmaps-to-toolbars.md)  
  
-   [Create, move, and edit toolbar buttons](../VS_csharp/creating--moving--and-editing-toolbar-buttons.md)  
  
-   [Create Tool Tips](../VS_csharp/creating-a-tool-tip-for-a-toolbar-button.md)  
