 ...
 **Precondition:** `0 ≤ t` and `0.0 ≤ p ≤ 1.0`  
 ...
 For more information and a code example, see [binomial_distribution Class](../VS_csharp/binomial_distribution-class.md).  
...
### Parameters  
 See parent topic [binomial_distribution Class](../VS_csharp/binomial_distribution-class.md).  
