...
```  
  ...
  For another sample showing how to use copy, see [accumulate, copy, and vector::push_back Sample](../Topic/accumulate,%20copy,%20and%20vector::push_back.md).  
...
### Remarks  
 ...
 This algorithm is generalized to count elements that satisfy any predicate with the template function [count_if](../VS_csharp/-algorithm--functions.md#count_if).  
...
### Remarks  
 This template function is a generalization of the algorithm [count](../VS_csharp/-algorithm--functions.md#count), replacing the predicate "equals a specific value" with any predicate.  
...
### Remarks  
 The first iterator of the pair returned by the algorithm is [lower_bound](../VS_csharp/-algorithm--functions.md#lower_bound), and the second iterator is [upper_bound](../VS_csharp/-algorithm--functions.md#upper_bound).  
...
### Remarks  
 ...
 For a code example using `find()`, see [find_if()](../VS_csharp/-algorithm--functions.md#find_if).  
...
### Remarks  
 This template function is a generalization of the algorithm [find](../VS_csharp/-algorithm--functions.md#find), replacing the predicate "equals a specific value" with any predicate. For the logical opposite (find the first element that does not satisfy the predicate), see [find_if_not](../VS_csharp/-algorithm--functions.md#find_if_not).  
...
### Remarks  
 This template function is a generalization of the algorithm [find](../VS_csharp/-algorithm--functions.md#find), replacing the predicate "equals a specific value" with any predicate. For the logical opposite (find the first element that does satisfy the predicate), see [find_if](../VS_csharp/-algorithm--functions.md#find_if).  
  
 For a code example readily adaptable to `find_if_not()`, see [find_if()](../VS_csharp/-algorithm--functions.md#find_if).  
...
### Remarks  
 The first template function returns [is_heap_until](../VS_csharp/-algorithm--functions.md#is_heap_until)`(``_First``,` `_Last``) ==` `_Last`.  
...
-   Elements may be added or removed in logarithmic time.  
 ...
 Heaps are an ideal way to implement priority queues and they are used in the implementation of the Standard Template Library container adaptor [priority_queue Class](../VS_csharp/priority_queue-class.md).  
...
### Remarks  
 ...
 The [list](../VS_csharp/list-class.md) class provides a member function [merge](../VS_csharp/list-class.md#list__merge) to merge the elements of two lists.  
...
### Remarks  
 The `min` algorithm is unusual in having objects passed as parameters. Most Standard Template Library algorithms operate on a range of elements whose position is specified by iterators passed as parameters. If you need a function that uses a range of elements, use [min_element](../VS_csharp/-algorithm--functions.md#min_element).  
...
### Return Value  
 ...
 `(` [min_element](../VS_csharp/-algorithm--functions.md#min_element)( `_First`, `_Last`), [max_element](../VS_csharp/-algorithm--functions.md#max_element)( `_First`, `_Last`)).  
...
##  <a name="random_shuffle"></a>  random_shuffle  
 The std::random_shuffle() function is deprecated, replaced by [std::shuffle()](../VS_csharp/-algorithm--functions.md#std__shuffle). For a code example and more information, see [<random\>](../VS_csharp/-random-.md) and the Stackoverflow posting                 [Why are std::random_shuffle methods being deprecated in C++14?](http://go.microsoft.com/fwlink/?LinkId=397954).  
...
### Remarks  
 ...
 The [list](../VS_csharp/list-class.md) class has a more efficient member function version of **remove**, which also relinks pointers.  
...
### Remarks  
 ...
 For information on how these functions behave, see [Checked Iterators](../VS_csharp/checked-iterators.md).  
...
### Remarks  
 For more information, and a code sample that uses `shuffle()`, see [<random\>](../VS_csharp/-random-.md).  
...
### Parameters  
 ...
 `comp`  
 User-defined predicate function object that defines the comparison criterion to be satisfied by successive elements in the ordering. This binary predicate takes two arguments and returns `true` if the two arguments are in order and `false` otherwise. This comparator function must impose a strict weak ordering on pairs of elements from the sequence. For more information, see [Algorithms](../VS_csharp/algorithms.md).  
...
### Remarks  
 ...
 List provides a more efficient member function [unique](../VS_csharp/list-class.md#list__unique), which may perform better.  
