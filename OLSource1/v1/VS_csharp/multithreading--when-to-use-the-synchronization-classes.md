...
The multithreaded classes provided with MFC fall into two categories: synchronization objects ([CSyncObject](../VS_csharp/csyncobject-class.md), [CSemaphore](../VS_csharp/csemaphore-class.md), [CMutex](../VS_csharp/cmutex-class.md), [CCriticalSection](../VS_csharp/ccriticalsection-class.md), and [CEvent](../VS_csharp/cevent-class.md)) and synchronization access objects ([CMultiLock](../VS_csharp/cmultilock-class.md) and [CSingleLock](../VS_csharp/csinglelock-class.md)).  
...
## Example 2: Using Synchronization Access Classes  
 ...
 For information about how the synchronization classes are used, see [Multithreading: How to Use the Synchronization Classes](../VS_csharp/multithreading--how-to-use-the-synchronization-classes.md). For information about synchronization, see [Synchronization](http://msdn.microsoft.com/library/windows/desktop/ms686353) in the [!INCLUDE[winsdkshort](../VS_csharp/includes/winsdkshort_md.md)]. For information about multithreading support in MFC, see [Multithreading with C++ and MFC](../VS_csharp/multithreading-with-c---and-mfc.md).  
