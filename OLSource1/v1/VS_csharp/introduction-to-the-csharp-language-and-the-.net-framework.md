...
-   For detailed information about specific aspects of the C# language, see the [C# Reference](../VS_csharp/csharp-reference.md).  
  
-   For more information about [!INCLUDE[vbteclinq](../VS_csharp/includes/vbteclinq_md.md)], see [LINQ (Language-Integrated Query)](../Topic/LINQ%20\(Language-Integrated%20Query\).md).  
