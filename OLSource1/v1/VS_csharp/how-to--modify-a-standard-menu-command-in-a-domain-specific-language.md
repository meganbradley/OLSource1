...
> [!NOTE]
>  If you want to create your own menu commands, see [How to Add a Command](../VS_csharp/how-to--add-a-command-to-the-shortcut-menu.md).  
...
```  
 ...
 If your code makes changes to the Store, such as creating, deleting or updating elements or links, you must do so inside a transaction. For more information, see [How to Create and Update model elements](../VS_csharp/how-to--modify-a-standard-menu-command-in-a-domain-specific-language.md).  
...
-   `shape.ModelElement as MyLanguageElement` - the model element represented by a shape.  
 ...
 For more information about how to navigate from element to element and about how to create objects and links, see [How to Navigate and Update the Model](../VS_csharp/navigating-and-updating-a-model-in-program-code.md).  
  
## See Also  
 <xref:System.ComponentModel.Design.MenuCommand*>   
 [Programming Domain-Specific Languages](../VS_csharp/writing-code-to-customise-a-domain-specific-language.md)   
 [Walkthrough: Adding a Command to the Shortcut Menu](../VS_csharp/how-to--add-a-command-to-the-shortcut-menu.md)   
 [Walkthrough: Getting Information from a Selected Link](../Topic/Walkthrough:%20Getting%20Information%20from%20a%20Selected%20Link.md)   
 [How VSPackages Add User Interface Elements to the IDE](../VS_csharp/how-vspackages-add-user-interface-elements.md)   
