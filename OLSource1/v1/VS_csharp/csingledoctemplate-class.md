...
-   A frame window class, which contains the view. For an SDI document template, you can derive this class from `CFrameWnd`; if you do not need to customize the behavior of the main frame window, you can use `CFrameWnd` directly without deriving your own class.  
 ...
 For more information on using `CSingleDocTemplate`, see [Document Templates and the Document/View Creation Process](../VS_csharp/document-templates-and-the-document-view-creation-process.md).  
...
### Parameters  
 ...
 The string resource consists of up to seven substrings separated by the '\n' character (the '\n' character is needed as a placeholder if a substring is not included; however, trailing '\n' characters are not necessary); these substrings describe the document type. For information about the substrings, see [CDocTemplate::GetDocString](../VS_csharp/cdoctemplate-class.md#cdoctemplate__getdocstring). This string resource is found in the application's resource file. For example:  
 ...
 For more information about these resource types, see the [String Editor](../VS_csharp/string-editor.md).  
...
### Example  
 [!code[NVC_MFCDocViewSDI#13](../VS_csharp/codesnippet/CPP/csingledoctemplate-class_1.cpp)]  
  
 [!code[NVC_MFCDocViewSDI#14](../VS_csharp/codesnippet/CPP/csingledoctemplate-class_2.cpp)]  
