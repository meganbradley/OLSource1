...
## Remarks  
 Returned from a call to the [GetKind](../VS_csharp/idebugfield--getkind.md) method.  
  
 Depending on the kind of field, [QueryInterface](../VS_csharp/queryinterface.md) can be called on the [IDebugField](../VS_csharp/idebugfield.md) interface for a more specific form of interface. For example, if [GetKind](../VS_csharp/idebugfield--getkind.md) returns `FIELD_TYPE_METHOD`, you can then call `QueryInterface` on I`DebugField` to obtain the [IDebugMethodField](../VS_csharp/idebugmethodfield.md) interface.  
...
## See Also  
 ...
 [GetKind](../VS_csharp/idebugfield--getkind.md)   
