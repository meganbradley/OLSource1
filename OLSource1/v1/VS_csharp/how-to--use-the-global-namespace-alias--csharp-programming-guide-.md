...
The ability to access a member in the global [namespace](../VS_csharp/namespace--csharp-reference-.md) is useful when the member might be hidden by another entity of the same name.  
 ...
 [!code[csProgGuide#1](../VS_csharp/codesnippet/CSharp/how-to--use-the-global-namespace-alias--csharp-programming-guide-_1.cs)]  
  
 [!code[csProgGuideNamespaces#1](../VS_csharp/codesnippet/CSharp/how-to--use-the-global-namespace-alias--csharp-programming-guide-_2.cs)]  
  
 Using `System.Console` still results in an error because the `System` namespace is hidden by the class `TestApp.System`:  
  
 [!code[csProgGuideNamespaces#2](../VS_csharp/codesnippet/CSharp/how-to--use-the-global-namespace-alias--csharp-programming-guide-_3.cs)]  
  
 However, you can work around this error by using `global::System.Console`, like this:  
  
 [!code[csProgGuideNamespaces#3](../VS_csharp/codesnippet/CSharp/how-to--use-the-global-namespace-alias--csharp-programming-guide-_4.cs)]  
 ...
 [!code[csProgGuideNamespaces#4](../VS_csharp/codesnippet/CSharp/how-to--use-the-global-namespace-alias--csharp-programming-guide-_5.cs)]  
...
## Example  
 ...
 [!code[csProgGuideNamespaces#5](../VS_csharp/codesnippet/CSharp/how-to--use-the-global-namespace-alias--csharp-programming-guide-_6.cs)]  
...
## See Also  
 ...
 [:: Operator](../VS_csharp/---operator--csharp-reference-.md)   
 [extern](../VS_csharp/extern--csharp-reference-.md)