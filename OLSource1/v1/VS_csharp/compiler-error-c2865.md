...
'function' : illegal comparison for handle_or_pointer  
 ...
 You can compare references to [Classes and Structs (Managed)](../VS_csharp/classes-and-structs---c---component-extensions-.md) or [__gc](../Topic/__gc.md) types only for equality to see if they refer to the same object (==) or to different objects (!=).  
