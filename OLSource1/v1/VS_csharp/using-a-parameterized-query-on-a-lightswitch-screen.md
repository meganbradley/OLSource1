...
9. In the **Screen Designer**, choose the **Rows Layout &#124; Related Products** node. In the **Add** list, choose **Products By Category**.  
     ...
     ![The modified Current Product List screen](../VS_csharp/media/ls_tour30.PNG "LS_Tour30")  
...
## Next Steps  
 ...
 Next lesson: [Creating Menus and Commands](../VS_csharp/creating-commands-and-working-with-menus-in-lightswitch.md)  
