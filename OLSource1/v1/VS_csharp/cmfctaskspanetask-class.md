...
---
# CMFCTasksPaneTask Class
The `CMFCTasksPaneTask` class is a helper class that represents tasks for the task pane control ( [CMFCTasksPane](../VS_csharp/cmfctaskspane-class.md)). The task object represents an item in the task group ( [CMFCTasksPaneTaskGroup](../VS_csharp/cmfctaskspanetaskgroup-class.md)). Each task can have a command that the framework executes when a user clicks on the task and an icon that appears to the left of the task name.  
...
## Inheritance Hierarchy  
 ...
 [CMFCTasksPaneTask](../VS_csharp/cmfctaskspanetask-class.md)  
...
### Parameters  
 `pGroup`  
 Specifies the [CMFCTasksPaneTaskGroup](../VS_csharp/cmfctaskspanetaskgroup-class.md) to which the task belongs.  
...
### Remarks  
 To add a task window, call [CMFCTasksPane::AddWindow](../VS_csharp/cmfctaskspane-class.md#cmfctaskspane__addwindow).  
...
### Remarks  
 The image list is set by [CMFCTasksPane::SetIconsList](../VS_csharp/cmfctaskspane-class.md#cmfctaskspane__seticonslist).  
...
##  <a name="cmfctaskspanetask__m_pgroup"></a>  CMFCTasksPaneTask::m_pGroup  
 Pointer to the [CMFCTasksPaneTaskGroup](../VS_csharp/cmfctaskspanetaskgroup-class.md) to which this task belongs.  
...
### Remarks  
 Every task must have a parent group. You add groups to a task pane by calling [CMFCTasksPane::AddGroup](../VS_csharp/cmfctaskspane-class.md#cmfctaskspane__addgroup).  
