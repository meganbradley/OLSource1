...
---
# MSBuild Conditions
[!INCLUDE[vstecmsbuild](../VS_csharp/includes/vstecmsbuild_md.md)] supports a specific set of conditions that can be applied wherever a `Condition` attribute is allowed. The following table explains those conditions.  
...
## See Also  
 ...
 [Walkthrough: Creating an MSBuild Project File from Scratch](../VS_csharp/walkthrough--creating-an-msbuild-project-file-from-scratch.md)