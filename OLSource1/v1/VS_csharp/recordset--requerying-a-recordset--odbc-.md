...
1.  Call the [Requery](../Topic/CRecordset::Requery.md) member function of the object.  
 ...
 For an example, see [Record Views: Filling a List Box from a Second Recordset](../VS_csharp/filling-a-list-box-from-a-second-recordset---mfc-data-access-.md).  
  
> [!TIP]
>  To optimize **Requery** performance, avoid changing the recordset's [filter](../VS_csharp/recordset--filtering-records--odbc-.md) or [sort](../VS_csharp/recordset--sorting-records--odbc-.md). Change only the parameter value before calling **Requery**.  
