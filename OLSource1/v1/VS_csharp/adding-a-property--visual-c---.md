...
You can use the [Add Property Wizard](../VS_csharp/names--add-property-wizard.md) to add a method to an interface in your project.  
...
3.  In the [Add Property Wizard](../VS_csharp/names--add-property-wizard.md), provide the information to create the property.  
  
4.  Specify any interface definition language (IDL) settings for the property in the [IDL Attributes](../VS_csharp/idl-attributes--add-property-wizard.md) page of the wizard.  
