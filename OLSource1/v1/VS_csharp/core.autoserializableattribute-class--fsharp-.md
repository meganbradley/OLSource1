...
|Member|Description|  
|------------|-----------------|  
|[new](../VS_csharp/core.autoserializableattribute-constructor--fsharp-.md)|Creates an instance of the attribute.|  
  
## Instance Members  
  
|Member|Description|  
|------------|-----------------|  
|[Value](../VS_csharp/autoserializableattribute.value-property--fsharp-.md)|The value of the attribute, indicating whether the type is automatically marked serializable or not.|  
