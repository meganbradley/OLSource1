...
|Name|Description|  
|----------|-----------------|  
|[IDispatchImpl::IDispatchImpl](../VS_csharp/idispatchimpl--idispatchimpl.md)|The constructor. Calls `AddRef` on the protected member variable that manages the type information for the dual interface. The destructor calls `Release`.|  
  
### Public Methods  
  
|Name|Description|  
|----------|-----------------|  
|[IDispatchImpl::GetIDsOfNames](../VS_csharp/idispatchimpl--getidsofnames.md)|Maps a set of names to a corresponding set of dispatch identifiers.|  
|[IDispatchImpl::GetTypeInfo](../VS_csharp/idispatchimpl--gettypeinfo.md)|Retrieves the type information for the dual interface.|  
|[IDispatchImpl::GetTypeInfoCount](../VS_csharp/idispatchimpl--gettypeinfocount.md)|Determines whether there is type information available for the dual interface.|  
|[IDispatchImpl::Invoke](../VS_csharp/idispatchimpl--invoke.md)|Provides access to the methods and properties exposed by the dual interface.|  
...
## Remarks  
 ...
 [!code[NVC_ATL_COM#47](../VS_csharp/codesnippet/CPP/idispatchimpl-class_1.h)]  
...
### Remarks  
 See `IDispatch::GetTypeInfoCount` in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Remarks  
 See [IDispatch::Invoke](assetId:///964ade8e-9d8a-4d32-bd47-aa678912a54d) in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
