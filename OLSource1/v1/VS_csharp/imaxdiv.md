...
## Return Value  
 `imaxdiv` called with arguments of type [intmax_t](../VS_csharp/standard-types.md) returns a structure of type [imaxdiv_t](../VS_csharp/standard-types.md) that comprises the quotient and the remainder.  
