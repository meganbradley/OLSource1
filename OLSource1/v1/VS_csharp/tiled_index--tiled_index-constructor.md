...
Initializes a new instance of the [tiled_index](../VS_csharp/tiled_index-class.md) class.  
...
#### Parameters  
 `_Global`  
 The global [index](../VS_csharp/index-class.md) of the constructed `tiled_index`.  
  
 `_Local`  
 The local [index](../VS_csharp/index-class.md) of the constructed `tiled_index`  
  
 `_Tile`  
 The tile [index](../VS_csharp/index-class.md) of the constructed `tiled_index`  
  
 `_Tile_origin`  
 The tile origin [index](../VS_csharp/index-class.md) of the constructed `tiled_index`  
  
 `_Barrier`  
 The [tile_barrier](../VS_csharp/tile_barrier-class.md) object of the constructed `tiled_index`.  
