...
```  
 ...
 You can define arrays of pointers to various types of objects by using complex declarators, as described in [Interpreting More Complex Declarators](../VS_csharp/interpreting-more-complex-declarators.md).  
...
```  
 ...
 To refer to an individual element of an array, use a subscript expression, as described in [Postfix Operators](../VS_csharp/postfix-operators.md).  
