...
|String|Unicode string|none|`"text\n"`<br /><br /> or<br /><br /> `@"c:\filename"`<br /><br /> or<br /><br /> `"""<book title="Paradise Lost">"""`<br /><br /> or<br /><br /> `"string1" + "string2"`<br /><br /> See also [Strings (F#)](../VS_csharp/strings--fsharp-.md).|  
...
## Named Literals  
 Values that are intended to be constants can be marked with the [Literal](../VS_csharp/core.literalattribute-class--fsharp-.md) attribute. This attribute has the effect of causing a value to be compiled as a constant.  
...
## See Also  
 [F# Language Reference](../VS_csharp/literals--fsharp-.md)   
 [Literal Attribute](../VS_csharp/core.literalattribute-class--fsharp-.md)