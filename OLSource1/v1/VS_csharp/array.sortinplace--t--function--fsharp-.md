...
Sorts the elements of an array by mutating the array in-place, using the given comparison function. Elements are compared using [Operators.compare](../VS_csharp/operators.compare--t--function--fsharp-.md).  
...
## Example  
 ...
 [!code[FsArrays#40](../VS_csharp/codesnippet/FSharp/array.sortinplace--t--function--fsharp-_1.fs)]  
