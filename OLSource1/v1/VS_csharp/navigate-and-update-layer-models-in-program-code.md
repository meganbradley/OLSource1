...
## Transactions  
 ...
 For more information, see [How to Link Model Updates using Transactions](../VS_csharp/link-uml-model-updates-by-using-transactions.md).  
...
## Containment  
 ![ILayer and ILayerModel can both contain ILayers.](../VS_csharp/media/layerapi_containment.png "LayerApi_Containment")  
...
## Dependency Links  
 ...
 ![An ILayerDependencyLink connects two ILayers.](../VS_csharp/media/layerapi_dependency.png "LayerApi_Dependency")  
...
## Comments  
 ...
 ![Comments can be attached to any layer element.](../VS_csharp/media/layerapi_comments.png "LayerApi_Comments")  
...
## Layer Elements  
 ...
 ![Layer diagram contents are ILayerElements.](../VS_csharp/media/layerapi_layerelements.png "LayerApi_LayerElements")  
...
## Artifact References  
 ...
 Each row in Layer Explorer displays an artifact reference. For more information, see [How to Create Layer Diagrams from Artifacts](../VS_csharp/create-layer-diagrams-from-your-code.md).  
...
```  
 ...
 ![Each ILayerElement is presented by an IShape.](../VS_csharp/media/layerapi_shapes.png "LayerApi_Shapes")  
  
 <xref:Microsoft.VisualStudio.ArchitectureTools.Extensibility.Presentation.IShape*> and <xref:Microsoft.VisualStudio.ArchitectureTools.Extensibility.Presentation.IDiagram*> are also used to display UML models. For more information, see [How to Display a Model on Diagrams](../VS_csharp/display-a-uml-model-on-diagrams.md).  
