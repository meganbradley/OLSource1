...
## Referencing Environment Variables  
 All environment variables are available to the [!INCLUDE[vstecmsbuildengine](../VS_csharp/includes/vstecmsbuildengine_md.md)] ([!INCLUDE[vstecmsbuild](../VS_csharp/includes/vstecmsbuild_md.md)]) project file as properties.  
