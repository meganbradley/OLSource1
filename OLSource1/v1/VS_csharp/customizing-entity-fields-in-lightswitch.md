...
## Next Steps  
 In the next lesson, you’ll learn how to present a list of predetermined values to the user. Next lesson: [Presenting a List of Choices](../VS_csharp/presenting-a-list-of-choices-in-a-lightswitch-application.md)  
  
## See Also  
 [Working with Data in LightSwitch](../VS_csharp/working-with-data-in-lightswitch.md)   
 [How to: Define Data Fields](../VS_csharp/how-to--define-data-fields-in-a-lightswitch-database.md)   
 [How to: Validate Data](../VS_csharp/how-to--validate-data-in-a-lightswitch-application.md)   
