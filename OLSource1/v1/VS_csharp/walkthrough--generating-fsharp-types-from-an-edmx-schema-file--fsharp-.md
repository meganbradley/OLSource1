...
## Next Steps  
 Explore other queries by looking at the available query operators as listed in [Query Expressions (F#)](../VS_csharp/query-expressions--fsharp-.md).  
  
## See Also  
 [Type Providers](../VS_csharp/type-providers.md)   
 [EdmxFile Type Provider (F#)](../VS_csharp/edmxfile-type-provider--fsharp-.md)   
 [How To: Access Typed Data from the Entity Data Model (F#)](../VS_csharp/walkthrough--accessing-a-sql-database-by-using-type-providers-and-entities--fsharp-.md)   
