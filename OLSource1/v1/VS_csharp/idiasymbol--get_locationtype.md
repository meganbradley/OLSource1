...
#### Parameters  
 `pRetVal`  
 [out] Returns a value from the [LocationType](../VS_csharp/locationtype.md) enumeration that specifies the location type of a data symbol, such as `static` or `local`.  
