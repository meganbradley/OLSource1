...
The following rules constrain how overloaded operators are implemented. However, they do not apply to the [new](../VS_csharp/new-operator--c---.md) and [delete](../VS_csharp/delete-operator--c---.md) operators, which are covered separately.  
