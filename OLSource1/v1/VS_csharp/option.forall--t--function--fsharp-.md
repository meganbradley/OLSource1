...
Evaluates the equivalent of [List.forall](../VS_csharp/list.forall--t--function--fsharp-.md) for an option type.  
...
## Example  
 ...
 [!code[FsOptions#6](../VS_csharp/codesnippet/FSharp/option.forall--t--function--fsharp-_1.fs)]  
