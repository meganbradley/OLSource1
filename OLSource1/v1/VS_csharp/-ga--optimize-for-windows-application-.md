...
## Remarks  
 **/GA** speeds access to data declared with [__declspec(thread)](../VS_csharp/__declspec.md) in a Windows-based program. When this option is set, the [__tls_index](http://msdn.microsoft.com/library/windows/desktop/ms686749) macro is assumed to be 0.  
