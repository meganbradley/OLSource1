...
---
# COM_INTERFACE_ENTRY_AUTOAGGREGATE
Same as [COM_INTERFACE_ENTRY_AGGREGATE](../VS_csharp/com_interface_entry_aggregate.md), except if `punk` is **NULL**, it automatically creates the aggregate described by the `clsid`.  
...
## Example  
 [!code[NVC_ATL_Windowing#114](../VS_csharp/codesnippet/CPP/com_interface_entry_autoaggregate_1.h)]  
