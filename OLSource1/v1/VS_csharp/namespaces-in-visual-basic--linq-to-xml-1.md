...
The topics in this section describe how to work with namespaces in [!INCLUDE[vbprvb](../VS_csharp/includes/vbprvb_md.md)].  
...
|[Working with Global Namespaces (Visual Basic) (LINQ to XML)](../VS_csharp/working-with-global-namespaces--visual-basic---linq-to-xml-2.md)|Explains the semantics of global namespaces in Visual Basic, and and reasons for using them.|  
