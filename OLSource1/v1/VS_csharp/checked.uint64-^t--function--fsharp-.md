...
apitype: "Assembly"
f1_keywords: 
  - "Microsoft.FSharp.Core.Operators.Checked.ToUInt64``1"
dev_langs: 
  - "FSharp"
helpviewer_keywords: 
  - "uint64 function [F#]"
  - "ToUInt64 function [F#]"
  - "Checked.ToUInt64 function [F#]"
  - "Checked.uint64 function [F#]"
...
Converts the argument to `uint64`. This is a direct, checked conversion for all primitive numeric types. For strings, the input is converted using <xref:System.UInt64.Parse*> with InvariantCulture settings. Otherwise the operation requires an appropriate static conversion method on the input type.  
