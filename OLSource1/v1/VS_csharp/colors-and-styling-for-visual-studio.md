...
### Visual Studio themes  
 ...
 Users can also use Control Panel to switch their entire systems into one of several High Contrast themes. If a user selects a High Contrast theme, then the Visual Studio color theme selector no longer affects colors in Visual Studio, although any theme changes are saved for when the user exits High Contrast mode. For more information about High Contrast mode, see [Choosing High Contrast colors](../VS_csharp/colors-and-styling-for-visual-studio.md#BKMK_ChoosingHighContrastColors).  
...
### User-customizable colors  
 See: [Exposing colors for end users](../VS_csharp/colors-and-styling-for-visual-studio.md#BKMK_ExposingColorsForEndUsers)  
 ...
 ![Tools &#62; Options dialog in Visual Studio](../VS_csharp/media/0301-a_toolsoptionsdialog.png "0301-a_ToolsOptionsDialog")  
  
 **Tools>Options dialog**  
  
### Web UI colors  
 It is becoming common to author UI components using HTML so that they can be used both in Visual Studio Online and within Visual Studio. UI written in HTML must still use the VSColor service when running inside the Visual Studio environment. For information about Daytona and how to use it, see [Daytona and web UI](../VS_csharp/colors-and-styling-for-visual-studio.md#BKMK_DaytonaAndWebUI).  
...
### How the service works  
 ...
 ![Environment color service architecture](../VS_csharp/media/0302-a_environmentcolorservicearchitecture.png "0302-a_EnvironmentColorServiceArchitecture")  
...
### System color set  
 ...
 ![Properties window](../VS_csharp/media/030303-a_propertieswindow.png "030303-a_PropertiesWindow")  
...
#### Choosing text colors in an editor  
 ...
 ![High Contrast editor comparison](../VS_csharp/media/030303-b_hceditorcomparison.png "030303-b_HCEditorComparison")  
  
 **High Contrast editor comparison**  
  
 Examples of the editor surface in the Blue theme:  
  
 ![Editor in Blue theme](../VS_csharp/media/030303-c_editorblue.png "030303-c_EditorBlue")  
  
 **Editor in Blue theme**  
  
 ![Editor in High Contrast theme](../VS_csharp/media/030303-d_editorhc1.png "030303-d_EditorHC1")  
...
|Package|REG_SZ|GUID|The GUID of the VSPackage service that supports the category|  
 ...
 ![IVsFontAndColorGroup](../VS_csharp/media/0304-a_fontandcolorgroup.png "0304-a_FontAndColorGroup")  
 ...
 **Color theme:**  
 ...
 ![Color theme changes](../VS_csharp/media/0305-a_colortheme.png "0305-a_ColorTheme")  
  
 **Environment theme:**  
  
 ![Environment theme changes](../VS_csharp/media/0305-b_environmenttheme.png "0305-b_EnvironmentTheme")  
  
 **Operating system theme** (only when changing to and from High Contrast):  
  
 ![OS theme changes](../VS_csharp/media/0305-c_ostheme.png "0305-c_OSTheme")