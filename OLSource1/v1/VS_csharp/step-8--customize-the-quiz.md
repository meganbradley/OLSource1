...
-   To go to the next tutorial, see [Tutorial 4: Create a Matching Game](../VS_csharp/tutorial-3--create-a-matching-game.md).  
  
-   To return to the previous tutorial step, see [Step 7: Add Multiplication and Division Problems](../VS_csharp/step-7--add-multiplication-and-division-problems.md).