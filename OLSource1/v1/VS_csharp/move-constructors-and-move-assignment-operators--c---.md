...
```  
 ...
 Before [!INCLUDE[cpp_dev10_long](../VS_csharp/includes/cpp_dev10_long_md.md)], this example produces the following output:  
...
## See Also  
 [Rvalue Reference Operator: &&](../VS_csharp/rvalue-reference-declarator----.md)   
