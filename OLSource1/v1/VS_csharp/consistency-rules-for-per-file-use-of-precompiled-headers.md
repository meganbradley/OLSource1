...
The [/Yu](../VS_csharp/-yu--use-precompiled-header-file-.md) compiler option lets you specify which precompiled header (PCH) file to use.  
...
## See Also  
 ...
 [/Yu (Use Precompiled Header File)](../VS_csharp/-yu--use-precompiled-header-file-.md)   
