...
-   If you select a consumer **Type** of Command, the wizard uses the `db_source` and **db_command** attributes, and uses **db_column** to create the column map, for example:  
 ...
 See [Basic Mechanics of Attributes](../VS_csharp/basic-mechanics-of-attributes.md) for more information.  
...
## See Also  
 [Adding an ATL OLE DB Consumer](../VS_csharp/adding-an-atl-ole-db-consumer.md)   
