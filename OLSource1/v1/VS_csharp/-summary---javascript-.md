...
## Remarks  
 The elements used to annotate functions, which include [<summary\>](../VS_csharp/-summary---javascript-.md), [<param\>](../VS_csharp/-param---javascript-.md), and [<returns\>](../VS_csharp/-returns---javascript-.md), must be placed in the function body before any statements.  
