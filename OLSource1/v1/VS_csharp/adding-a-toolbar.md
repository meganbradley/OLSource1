...
This walkthrough shows how to add a toolbar to the Visual Studio IDE.  
 ...
 For more information about menus, see [Menu and Toolbar Commands](../VS_csharp/commands--menus--and-toolbars.md).  
...
## Creating an Extension with a Toolbar  
 Create a VSIX project named `IDEToolbar`. Add a menu command item template named **ToolbarTestCommand**. For information about how to do this, see [Creating an Extension with a Menu Command](../VS_csharp/creating-an-extension-with-a-menu-command.md).  
...
3.  In the [Groups](../VS_csharp/groups-element.md) section, after the existing group entry, define a [Group](../VS_csharp/group-element.md) element to contain the commands for the toolbar.  
