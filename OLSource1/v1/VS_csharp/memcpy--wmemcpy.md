...
---
# memcpy, wmemcpy
Copies bytes between buffers. More secure versions of these functions are available; see [memcpy_s, wmemcpy_s](../VS_csharp/memcpy_s--wmemcpy_s.md).  
...
## Example  
 See [memmove](../VS_csharp/memmove--wmemmove.md) for a sample of how to use `memcpy`.  
