...
The walkthrough uses a C# application to demonstrate how to use the [!INCLUDE[vsprvs](../VS_csharp/includes/vsprvs_md.md)] Profiling Tools APIs. You will use the profiler APIs to limit the amount of data that is collected during instrumentation profiling.  
 ...
 However, a greater level of detail means that more data is collected. You might find that instrumentation profiling creates large data files. Also, instrumentation is more likely to impact the performance of the application. For more information, see [Understanding Instrumented Data Values](../VS_csharp/understanding-instrumentation-data-values.md) and [Understanding Sampling Data Values](../VS_csharp/understanding-sampling-data-values.md)  
...
1.  Open the [!INCLUDE[vsprvs](../VS_csharp/includes/vsprvs_md.md)] IDE. On to the **Analyze** menu, point to **Profiler**, and then select **New Performance Session.**  
...
## See Also  
 ...
 [Visual Studio Profiler API Reference (Native)](../VS_csharp/visual-studio-profiler-api-reference--native-.md)   
 [Getting Started with Profiling Tools](../VS_csharp/getting-started-with-performance-tools.md)   
 [Command-Line Profiling Tools](../VS_csharp/using-the-profiling-tools-from-the-command-line.md)