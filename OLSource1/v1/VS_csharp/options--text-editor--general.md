...
This dialog box lets you change global settings for the [!INCLUDE[vsprvs](../VS_csharp/includes/vsprvs_md.md)] Code and Text Editor. To display this dialog box, click **Options** on the **Tools** menu, expand the **Text Editor** folder, and then click **General**.  
...
|-------------------------|--------------------------|  
|![HTMLpageSelectionMarginOn screenshot](../VS_csharp/media/vxselmaron.gif "vxSelmaron")|![HTMLpageSelectionMarginOff screenshot](../VS_csharp/media/vxselmaroff.gif "vxSelmaroff")|  
...
## See Also  
 [General, All Languages, Text Editor, Options Dialog Box](../VS_csharp/options--text-editor--all-languages.md)   
 [Tabs, All Languages, Text Editor, Options Dialog Box](../VS_csharp/options--text-editor--all-languages--tabs.md)   
 [File Extension, Text Editor, Options Dialog Box](../VS_csharp/options--text-editor--file-extension.md)   
 [How to: Work with Keyboard Shortcuts](../VS_csharp/identifying-and-customizing-keyboard-shortcuts-in-visual-studio.md)   
