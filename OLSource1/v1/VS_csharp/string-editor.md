...
-   [Search for one or more strings](../VS_csharp/finding-a-string.md).  
  
-   Quickly [insert new entries](../VS_csharp/adding-or-deleting-a-string.md) into the string table.  
  
-   [Move a string from one resource file to another](../VS_csharp/moving-a-string-from-one-resource-file-to-another.md)  
  
-   [Use in-place editing for the ID, Value, and Caption properties](../VS_csharp/changing-the-properties-of-a-string.md) and view changes immediately.  
  
-   [Change the caption property of multiple strings](../VS_csharp/changing-the-caption-property-of-multiple-strings.md)  
  
-   [Add formatting or special characters to a string](../VS_csharp/adding-formatting-or-special-characters-to-a-string.md)  
