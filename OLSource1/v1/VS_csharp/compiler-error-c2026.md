...
```  
 ...
 You may want to store exceptionally large string literals (32K or more) in a custom resource or an external file. See [Creating a New Custom or Data Resource](../VS_csharp/creating-a-new-custom-or-data-resource.md) for more information.