...
## See Also  
 [Deploying ClickOnce Applications from Multiple Network Locations](../VS_csharp/deploying-clickonce-applications-for-testing-and-production-servers-without-resigning.md)   
 ...
 [Walkthrough: Deploying a ClickOnce Application with Multiple Deployment and Branding Support Manually](../VS_csharp/walkthrough--manually-deploying-a-clickonce-application-that-does-not-require-re-signing-and-that-preserves-branding-information.md)