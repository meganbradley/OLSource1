...
## Example  
 The following example builds on the example in [How to: Stream XML Fragments with Access to Header Information (Visual Basic)](../VS_csharp/how-to--stream-xml-fragments-with-access-to-header-information--visual-basic-.md).  
...
## Example  
 The following example also builds on the example in [How to: Stream XML Fragments with Access to Header Information (Visual Basic)](../VS_csharp/how-to--stream-xml-fragments-with-access-to-header-information--visual-basic-.md).  
...
## See Also  
 [Advanced LINQ to XML Programming (Visual Basic)](../VS_csharp/advanced-linq-to-xml-programming--visual-basic-.md)