...
## Remarks  
 When `DDX_Check` is called, *value* is set to the current state of the check box control. For a list of the possible state values, see [BM_GETCHECK](http://msdn.microsoft.com/library/windows/desktop/bb775986) in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)]*.*  
...
## See Also  
 ...
 [DDP_Check](../VS_csharp/ddp_check.md)