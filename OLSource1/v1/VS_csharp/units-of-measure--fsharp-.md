...
```  
 ...
 [!code[FsLangRef2#6901](../VS_csharp/codesnippet/FSharp/units-of-measure--fsharp-_1.fs)]  
 ...
 [!code[FsLangRef2#6902](../VS_csharp/codesnippet/FSharp/units-of-measure--fsharp-_2.fs)]  
...
## Using Generic Units  
 ...
 [!code[FsLangRef2#6903](../VS_csharp/codesnippet/FSharp/units-of-measure--fsharp-_3.fs)]  
...
## Creating Aggregate Types with Generic Units  
 ...
 [!code[FsLangRef2#6904](../VS_csharp/codesnippet/FSharp/units-of-measure--fsharp-_4.fs)]  
...
## Conversions  
 ...
 [!code[FsLangRef2#6905](../VS_csharp/codesnippet/FSharp/units-of-measure--fsharp-_5.fs)]  
  
 To convert a unitless value to a value that has units, you can multiply by a 1 or 1.0 value that is annotated with the appropriate units. However, for writing interoperability layers, there are also some explicit functions that you can use to convert unitless values to values with units. These are in the [Microsoft.FSharp.Core.LanguagePrimitives](../VS_csharp/core.languageprimitives-module--fsharp-.md) module. For example, to convert from a unitless `float` to a `float<cm>`, use [FloatWithMeasure](../VS_csharp/languageprimitives.floatwithmeasure--measure--function.md), as shown in the following code.  
  
 [!code[FsLangRef2#6906](../VS_csharp/codesnippet/FSharp/units-of-measure--fsharp-_6.fs)]  
