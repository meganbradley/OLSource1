...
When no Windows messages are being processed, the framework calls the [CWinApp](../VS_csharp/cwinapp-class.md) member function [OnIdle](../Topic/CWinApp::OnIdle.md) (described in the MFC Library Reference).  
 ...
 ![Message loop process](../VS_csharp/media/vc387c1.gif "vc387C1")  
The Message Loop  
  
 For more information about what you can do in the idle loop, see [Idle Loop Processing](../VS_csharp/idle-loop-processing.md).  
