...
## See Also  
 [Accessing the Text Buffer by Using the Legacy API](../VS_csharp/accessing-the-text-buffer-by-using-the-legacy-api.md)   
 [How to: Register for Text Buffer Events with the Legacy API](../VS_csharp/how-to--register-for-text-buffer-events-with-the-legacy-api.md)