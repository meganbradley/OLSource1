...
---
# PX_DataPath
Call this function within your control's `DoPropExchange` member function to serialize or initialize a data path property of type [CDataPathProperty](../VS_csharp/cdatapathproperty-class.md).  
...
## See Also  
 ...
 [CDataPathProperty Class](../VS_csharp/cdatapathproperty-class.md)