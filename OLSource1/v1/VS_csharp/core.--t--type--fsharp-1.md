...
## Remarks  
 Use the values in the [Array4D module](../VS_csharp/collections.array4d-module--fsharp-.md) to manipulate values of this type, or the notation `arr.[x1,x2,x3,x4]` to get and set array values.  
