...
## Remarks  
 Two predefined objects implement `error_category`: [generic_category](../VS_csharp/-system_error--functions.md#generic_category) and [system_category](../VS_csharp/-system_error--functions.md#system_category).  
...
|[operator<](#error_category__operator_lt_)|Tests if the [error_category](../VS_csharp/error_category-class.md) object is less than the `error_category` object passed in for comparison.|  
...
|---------------|-----------------|  
|`_Errval`|The error code value to store in the [error_condition](../VS_csharp/error_condition-class.md).|  
...
|`_Cond`|The [error_condition](../VS_csharp/error_condition-class.md) object to compare.|  
|`_Code`|The [error_code](../VS_csharp/error_code-class.md) object to compare.|  
...
##  <a name="error_category__operator_lt_"></a>  error_category::operator&lt;  
 Tests if the [error_category](../VS_csharp/error_category-class.md) object is less than the `error_category` object passed in for comparison.  
