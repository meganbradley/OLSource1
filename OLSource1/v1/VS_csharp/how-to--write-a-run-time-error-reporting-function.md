...
## Example  
 Use `_RTC_SetErrorFuncW` to install your custom function in place of `_CrtDbgReportW`. For more information, see [_RTC_SetErrorFuncW](../VS_csharp/_rtc_seterrorfuncw.md). The `_RTC_SetErrorFuncW` return value is the previous reporting function, which you can save and restore if necessary.  
...
## See Also  
 [Native Run-Time Check Customization](../VS_csharp/native-run-time-checks-customization.md)