...
```  
 ...
 Functions can be called recursively. For more information about function declarations, see [Function Specifiers](../Topic/Function%20Specifiers.md) and [Member Functions](../Topic/Member%20Functions%20\(C++\).md). Related material is in [Program and Linkage](../VS_csharp/program-and-linkage---c---.md).  
