...
-   Supply persistence and CodeDOM support by implementing the <xref:System.ComponentModel.Design.Serialization.IDesignerSerializationService*> and the <xref:System.ComponentModel.Design.IComponentChangeService*> classes.  
 ...
 For more information on writing designers using [!INCLUDE[dnprdnshort](../VS_csharp/includes/dnprdnshort_md.md)], see [Extending Design-Time Support](assetId:///d6ac8a6a-42fd-4bc8-bf33-b212811297e2).  
  
 The [!INCLUDE[vsipsdk](../VS_csharp/includes/vsipsdk_md.md)] provides a default undo infrastructure by:  
...
## Obtaining Undo Support Automatically  
 Any designer created in [!INCLUDE[vsprvs](../VS_csharp/includes/vsprvs_md.md)] has automatic and full undo support if, the designer:  
...
## When to Use Explicit Designer Undo Support  
 ...
 An example of this might be creating a product with a web-based graphical design interface rather than a [!INCLUDE[dnprdnshort](../VS_csharp/includes/dnprdnshort_md.md)] based graphical interface.  
  
 In such cases, one would need to register this view adapter with [!INCLUDE[vsprvs](../VS_csharp/includes/vsprvs_md.md)] using <xref:Microsoft.VisualStudio.Shell.Design.ProvideViewAdapterAttribute*>, and provide explicit undo management.  
  
 Designers need to provide CodeDOM and persistence support if they do not use the [!INCLUDE[vsprvs](../VS_csharp/includes/vsprvs_md.md)] code generation model provided in the <xref:System.CodeDom*> name space.  
...
## Undo Support Features of the Designer  
 ...
 The <xref:Microsoft.VisualStudio.Shell.Design.OleUndoEngine*> class derives from the [!INCLUDE[dnprdnshort](../VS_csharp/includes/dnprdnshort_md.md)] <xref:System.ComponentModel.Design.UndoEngine*> class using an implementation of the <xref:Microsoft.VisualStudio.OLE.Interop.IOleUndoManager*> class to manage undo operations.  
...
-   <xref:System.ComponentModel.Design.Serialization.CodeDomComponentSerializationService*> as an implementations of the <xref:System.ComponentModel.Design.Serialization.IDesignerSerializationService*>  
 ...
 A <xref:System.ComponentModel.Design.IComponentChangeService*> provided by the [!INCLUDE[vsprvs](../VS_csharp/includes/vsprvs_md.md)]``design host.  
...
-   This <xref:System.IServiceProvider*> class must provide the following services:  
    ...
    -   <xref:System.ComponentModel.Design.Serialization.IDesignerSerializationService*>  
         ...
         Designers using [!INCLUDE[vsprvs](../VS_csharp/includes/vsprvs_md.md)] CodeDOM serialization may choose to use <xref:System.ComponentModel.Design.Serialization.CodeDomComponentSerializationService*> provided with the [!INCLUDE[vsipsdk](../VS_csharp/includes/vsipsdk_md.md)] as its implementation of the <xref:System.ComponentModel.Design.Serialization.IDesignerSerializationService*>.  
    ...
    -   <xref:System.ComponentModel.Design.IComponentChangeService*>  
         ...
         Designers using the default <xref:System.ComponentModel.Design.DesignSurface*> provided by the [!INCLUDE[vsprvs](../VS_csharp/includes/vsprvs_md.md)] design host are guaranteed to have a default implementation of the <xref:System.ComponentModel.Design.IComponentChangeService*> class.  
