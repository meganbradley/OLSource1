...
The following XML file is used in various examples in the [!INCLUDE[sqltecxlinq](../VS_csharp/includes/sqltecxlinq_md.md)] documentation. This file contains customers and orders.  
 ...
 For an example of writing LINQ queries that take advantage of this relationship using the `Join` clause, see [How to: Join Two Collections (LINQ to XML) (C#)](../VS_csharp/how-to--join-two-collections--linq-to-xml---csharp-.md).  
...
## See Also  
 [Sample XML Documents (LINQ to XML)](../VS_csharp/sample-xml-documents--linq-to-xml-2.md)