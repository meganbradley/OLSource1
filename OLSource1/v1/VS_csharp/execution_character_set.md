...
## Remarks  
 This compiler directive is obsolete in Visual Studio 2015 Update 2. We recommend that you use the **/execution-charset:utf-8** or **/utf-8** compiler options together with using the `u8` prefix on narrow character and string literals that contain extended characters. For more information about the `u8` prefix, see [String and Character Literals](../VS_csharp/string-and-character-literals---c---.md). For more information about the compiler options, see [/execution-charset](../VS_csharp/-execution-charset--set-execution-character-set-.md) and [/utf-8](../VS_csharp/-utf-8--set-source-and-executable-character-sets-to-utf-8-.md).  
