...
## Example  
 ...
 [!code[FxCop.Design.NoRefOrOut#1](../VS_csharp/codesnippet/CSharp/ca1021--avoid-out-parameters_1.cs)]  
...
## Example  
 ...
 [!code[FxCop.Design.TestNoRefOrOut#1](../VS_csharp/codesnippet/CSharp/ca1021--avoid-out-parameters_2.cs)]  
...
## Example  
 ...
 [!code[FxCop.Design.RefByRefNo#1](../VS_csharp/codesnippet/CSharp/ca1021--avoid-out-parameters_3.cs)]  
  
## Example  
 The following application calls each method in the library to demonstrate the behavior.  
  
 [!code[FxCop.Design.TestRefByRefNo#1](../VS_csharp/codesnippet/CSharp/ca1021--avoid-out-parameters_4.cs)]  
...
### Code  
 [!code[FxCop.Design.TryPattern#1](../VS_csharp/codesnippet/CSharp/ca1021--avoid-out-parameters_5.cs)]  
  
## Related Rules  
 [Do not pass types by reference](../VS_csharp/ca1045--do-not-pass-types-by-reference.md)