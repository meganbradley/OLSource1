...
## Checked Out Flag  
 This flag can be set for either the [SccAdd Function](../VS_csharp/sccadd-function.md) or [SccCheckin Function](../VS_csharp/scccheckin-function.md).  
...
## Add Flags  
 These flags are used by the [SccAdd Function](../VS_csharp/sccadd-function.md).  
...
## PopulateList Flag  
 This flag is used by the [SccPopulateList Function](../VS_csharp/sccpopulatelist-function.md) in the `fOptions` parameter.  
...
## PopulateDirList Flags  
 These flags are used by the [SccPopulateDirList Function](../VS_csharp/sccpopulatedirlist-function.md) in the `fOptions` parameter.  
...
## OpenProject Flags  
 These flags are used by the [SccOpenProject Function](../VS_csharp/sccopenproject-function.md) in the `dwFlags` parameter.  
...
## Get Flags  
 These flags are used by the [SccGet Function](../VS_csharp/sccget-function.md) and the [SccCheckout Function](../VS_csharp/scccheckout-function.md).  
...
## nOption Values  
 These flags are used by the [SccSetOption Function](../VS_csharp/sccsetoption-function.md) in the `nOption` parameter.  
...
## dwVal Bitflags  
 These flags are used by the [SccSetOption Function](../VS_csharp/sccsetoption-function.md) in the `dwVal` parameter.  
