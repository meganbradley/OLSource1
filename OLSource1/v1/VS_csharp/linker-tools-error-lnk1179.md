...
invalid or corrupt file: duplicate COMDAT 'filename'  
 ...
 This error can be caused by using [/H](../VS_csharp/-h--restrict-length-of-external-names-.md), which limits the length of external names, and [/Gy](../VS_csharp/-gy--enable-function-level-linking-.md), which packages functions in COMDATs.  
