...
---
# CRecentDockSiteInfo Class
The `CRecentDockSiteInfo` class is a helper class that stores recent state information for the [CPane Class](../VS_csharp/cpane-class.md).  
...
## Remarks  
 ...
 A `CRecentDockSiteInfo` object is created every time that a pane is created. Each `CPane` object has a member variable, [CPane::m_recentDockInfo](../VS_csharp/cpane-class.md#cpane__m_recentdockinfo), to store this information.  
  
## Inheritance Hierarchy  
 [CObject](../VS_csharp/cobject-class.md)  
  
 [CRecentDockSiteInfo](../VS_csharp/crecentdocksiteinfo-class.md)  
