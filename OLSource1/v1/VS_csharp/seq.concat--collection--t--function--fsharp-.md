...
#### Parameters  
 `sources`  
 Type: [seq](../VS_csharp/collections.seq--t--type-abbreviation--fsharp-.md)`<'Collection>`  
...
## Example  
 ...
 [!code[FsSequences#29](../VS_csharp/codesnippet/FSharp/seq.concat--collection--t--function--fsharp-_1.fs)]  
