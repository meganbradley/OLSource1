...
|Name|Description|  
|----------|-----------------|  
|[diagnostic Namespace](../VS_csharp/diagnostic-namespace.md)|The `diagnostics` namespace provides functionality for emitting Concurrency Visualizer markers.|  
  
## Requirements  
 **Header:** cvmarkersobj.h  
  
## See Also  
 [Reference (Concurrency Runtime)](../VS_csharp/c-library-reference.md)