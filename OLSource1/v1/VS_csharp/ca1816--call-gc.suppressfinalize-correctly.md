...
## Example  
 ...
 [!code[FxCop.Usage.CallGCSuppressFinalizeCorrectly#1](../VS_csharp/codesnippet/VisualBasic/ca1816--call-gc.suppressfinalize-correctly_1.vb)]
[!code[FxCop.Usage.CallGCSuppressFinalizeCorrectly#1](../VS_csharp/codesnippet/CSharp/ca1816--call-gc.suppressfinalize-correctly_1.cs)]  
  
## Example  
 The following example shows a method that correctly calls <xref:System.GC.SuppressFinalize*?displayProperty=fullName>.  
  
 [!code[FxCop.Usage.CallGCSuppressFinalizeCorrectly2#1](../VS_csharp/codesnippet/VisualBasic/ca1816--call-gc.suppressfinalize-correctly_2.vb)]
[!code[FxCop.Usage.CallGCSuppressFinalizeCorrectly2#1](../VS_csharp/codesnippet/CSharp/ca1816--call-gc.suppressfinalize-correctly_2.cs)]  
  
## Related Rules  
 [Dispose methods should call base class dispose](../VS_csharp/ca2215--dispose-methods-should-call-base-class-dispose.md)  
  
 [Disposable types should declare finalizer](../VS_csharp/ca2216--disposable-types-should-declare-finalizer.md)  
