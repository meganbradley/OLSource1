...
## Remarks  
 Its behavior is determined by the [named](../VS_csharp/locale-class.md#locale__name) locale `_Locname`. Each constructor initializes its base object with [time_put](../VS_csharp/time_put-class.md#time_put__time_put)<CharType, OutputIterator>( `_Refs`).  
