...
## ToolsVersion Attribute  
 Specify the Toolset in the `ToolsVersion` attribute on the [Project](../VS_csharp/project-element--msbuild-.md) element in the project file. The following example specifies that the project should be built by using the MSBuild 12.0 Toolset.  
...
## How the ToolsVersion Attribute Works  
 When you create a project in Visual Studio, or upgrade an existing project, an attribute named `ToolsVersion` is automatically included in the project file and its value corresponds to the version of MSBuild that is included in the Visual Studio edition. For more information, see [Targeting a Specific .NET Framework](../VS_csharp/targeting-a-specific-.net-framework-version.md).  
...
```  
 ...
 You can modify the value of `MSBuildToolsPath` by defining a custom Toolset. For more information, see [Standard and Custom Toolset Configurations](../VS_csharp/standard-and-custom-toolset-configurations.md)  
...
## See Also  
 [Standard and Custom Toolset Configurations](../VS_csharp/standard-and-custom-toolset-configurations.md)   
