...
## Remarks  
 ...
 For more information on event sink maps, see the article [ActiveX Control Containers](../VS_csharp/activex-control-containers.md).  
...
## See Also  
 ...
 [BEGIN_EVENTSINK_MAP](../VS_csharp/begin_eventsink_map.md)   
