...
## Rule Description  
 ...
 The compiler ignores the values of default parameters for Managed Extension for C++ when it accesses managed code. The Visual Basic compiler supports methods that have default parameters that use the [Optional](../VS_csharp/optional--visual-basic-.md) keyword.  
...
## Example  
 ...
 [!code[FxCop.Design.DefaultParameters#1](../VS_csharp/codesnippet/VisualBasic/ca1026--default-parameters-should-not-be-used_1.vb)]  
  
## Related Rules  
 [Replace repetitive arguments with params array](../VS_csharp/ca1025--replace-repetitive-arguments-with-params-array.md)  
