...
## Example  
 ...
 [!code[FxCop.Design.RefTypesNoEqualityOp#1](../VS_csharp/codesnippet/CSharp/ca1046--do-not-overload-operator-equals-on-reference-types_1.cs)]  
  
## Example  
 The following application compares some references.  
  
 [!code[FxCop.Design.TestRefTypesNoEqualityOp#1](../VS_csharp/codesnippet/CSharp/ca1046--do-not-overload-operator-equals-on-reference-types_2.cs)]  
...
**c and a are == ? Yes**   
## Related Rules  
 [Override operator equals on overriding add and subtract](../VS_csharp/ca1013--overload-operator-equals-on-overloading-add-and-subtract.md)  
