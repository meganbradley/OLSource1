...
#### Parameters  
 `pCodeContext`  
 [in] An [IDebugCodeContext2](../VS_csharp/idebugcodecontext2.md) object to be converted to an identifier.  
...
## Remarks  
 ...
 To retrieve the code context of a code location identifier, call the [IDebugDisassemblyStream2::GetCodeContext](../VS_csharp/idebugdisassemblystream2--getcodecontext.md) method.  
  
## See Also  
 [IDebugDocumentContext2](../VS_csharp/idebugdocumentcontext2.md)   
 [IDebugCodeContext2](../VS_csharp/idebugcodecontext2.md)   
 [IDebugDisassemblyStream2::GetCodeContext](../VS_csharp/idebugdisassemblystream2--getcodecontext.md)