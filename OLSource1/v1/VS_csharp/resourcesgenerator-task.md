...
The <xref:Microsoft.Build.Tasks.Windows.ResourcesGenerator*> task embeds one or more resources (.jpg, .ico, .bmp, [!INCLUDE[TLA2#tla_xaml](../VS_csharp/includes/tla2sharptla_xaml_md.md)] in binary format, and other extension types) into a .resources file.  
