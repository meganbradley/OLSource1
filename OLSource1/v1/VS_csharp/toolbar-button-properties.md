...
|**Prompt**|Defines the message displayed in the status bar. Adding \n and a name adds a ToolTip to that toolbar button. For more information, see [Creating a ToolTip](../VS_csharp/creating-a-tool-tip-for-a-toolbar-button.md).|  
...
## See Also  
 [Changing the Properties of a Toolbar Button](../VS_csharp/changing-the-properties-of-a-toolbar-button.md)   
