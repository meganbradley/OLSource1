...
'function' : a private virtual method of a ref class or value class should be marked 'sealed'  
 ...
 Since a private virtual member function of a managed class or struct cannot be accessed or overridden, it should be marked [sealed](../VS_csharp/sealed---c---component-extensions-.md).  
