...
Forces writes to the program database (PDB) file—created by [/Zi](../VS_csharp/-z7---zi---zi--debug-information-format-.md) or [/ZI](../VS_csharp/-z7---zi---zi--debug-information-format-.md)—to be serialized through MSPDBSRV.EXE.  
...
## Remarks  
 ...
 The [/MP](../VS_csharp/-mp--build-with-multiple-processes-.md) option enables **/FS** by default.  
