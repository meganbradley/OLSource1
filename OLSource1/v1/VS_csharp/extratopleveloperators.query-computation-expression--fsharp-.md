...
ms.assetid: 5404e826-594a-4d82-af4d-167194ed1d42
...
Provides the F# language support for query expressions. For more information, see [Query Expressions (F#)](../VS_csharp/query-expressions--fsharp-.md).  
