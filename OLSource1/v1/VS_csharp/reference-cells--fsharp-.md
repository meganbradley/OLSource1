...
## Remarks  
 ...
 [!code[FsLangRef1#2201](../VS_csharp/codesnippet/FSharp/reference-cells--fsharp-_1.fs)]  
...
|`contents` (record field)|Gets or sets the underlying value.|`'a`|`let ref x = { contents = x }`|  
 ...
 [!code[FsLangRef1#2203](../VS_csharp/codesnippet/FSharp/reference-cells--fsharp-_2.fs)]  
...
```  
 ...
 The field `contents` is provided for compatibility with other versions of ML and will produce a warning during compilation. To disable the warning, use the `--mlcompatibility` compiler option. For more information, see [Compiler Options](../VS_csharp/compiler-options--fsharp-.md).  
...
## Example  
 ...
 [!code[FsLangRef1#2204](../VS_csharp/codesnippet/FSharp/reference-cells--fsharp-_3.fs)]  
  
 For more information about how to pass by reference, see [Passing Arguments (F#)](../VS_csharp/parameters-and-arguments--fsharp-.md).  
...
## Reference Cells vs. Mutable Variables  
 ...
 [!code[FsLangRef1#2205](../VS_csharp/codesnippet/FSharp/reference-cells--fsharp-_4.fs)]  
 ...
 [!code[FsLangRef1#2207](../VS_csharp/codesnippet/FSharp/reference-cells--fsharp-_5.fs)]  
  
## See Also  
 [F# Language Reference](../VS_csharp/fsharp-language-reference.md)   
 [Passing Arguments](../VS_csharp/parameters-and-arguments--fsharp-.md)   
