...
> [!NOTE]
>  This topic is about fragments in sequence diagrams. For more information about how to read UML sequence diagrams, see [UML Sequence Diagrams: Overview](../VS_csharp/uml-sequence-diagrams--reference.md). For more information about how to draw UML sequence diagrams, see [UML Sequence Diagrams: Guidelines](../VS_csharp/uml-sequence-diagrams--guidelines.md).  
  
 ![Combined Fragment with two Interaction Operands](../VS_csharp/media/uml_seqfragments.png "UML_SeqFragments")  
