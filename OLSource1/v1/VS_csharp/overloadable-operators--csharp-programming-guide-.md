...
```  
 ...
 For more information, see [How To: Use Operator Overloading to Create a Complex Number Class (C#)](../VS_csharp/how-to--use-operator-overloading-to-create-a-complex-number-class--csharp-programming-guide-.md).  
