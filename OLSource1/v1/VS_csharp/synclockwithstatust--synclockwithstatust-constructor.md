...
#### Parameters  
 ...
 `status`  
 The value of the [status_](../VS_csharp/synclockwithstatust--status_-data-member.md) data member of the `other` parameter or the `sync` parameter.  
...
## See Also  
 ...
 [SyncLockWithStatusT::GetStatus Method](../VS_csharp/synclockwithstatust--getstatus-method.md)