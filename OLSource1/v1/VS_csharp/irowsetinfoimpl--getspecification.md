...
## Remarks  
 Use this method with [IGetDataSourceImpl](../VS_csharp/igetdatasourceimpl-class.md) to retrieve properties from the data source object.  
...
## See Also  
 ...
 [IRowsetInfoImpl::GetProperties](../VS_csharp/irowsetinfoimpl--getproperties.md)