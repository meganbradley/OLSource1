...
## Remarks  
 ...
 Note that there is a behavior change in the [As](../VS_csharp/weakref--as-method.md), [AsIID](../VS_csharp/weakref--asiid-method.md) and [CopyTo](../VS_csharp/weakref--copyto-method.md) methods in the Windows 10 SDK. Previously, after calling any of these methods, you could check the WeakRef for `nullptr` to determine if a strong reference was successfully obtained, as in the following code:  
...
|Name|Description|  
|----------|-----------------|  
|[WeakRef::WeakRef Constructor](../VS_csharp/weakref--weakref-constructor.md)|Initializes a new instance of the WeakRef class.|  
|[WeakRef::~WeakRef Destructor](../VS_csharp/weakref--~weakref-destructor.md)|Deinitializes the current instance of the WeakRef class.|  
  
### Public Methods  
  
|Name|Description|  
|----------|-----------------|  
|[WeakRef::As Method](../VS_csharp/weakref--as-method.md)|Sets the specified ComPtr pointer parameter to represent the specified interface.|  
|[WeakRef::AsIID Method](../VS_csharp/weakref--asiid-method.md)|Sets the specified ComPtr pointer parameter to represent the specified interface ID.|  
|[WeakRef::CopyTo Method](../VS_csharp/weakref--copyto-method.md)|Assigns a pointer to an interface, if available, to the specified pointer variable.|  
  
### Public Operators  
  
|Name|Description|  
|----------|-----------------|  
|[WeakRef::operator& Operator](../VS_csharp/weakref--operator--operator.md)|Returns a ComPtrRef object that represents the current WeakRef object.|  
