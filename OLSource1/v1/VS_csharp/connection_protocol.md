...
## Remarks  
 These values are returned from the [IDebugCoreServer3::GetConnectionProtocol](../VS_csharp/idebugcoreserver3--getconnectionprotocol.md) method.  
...
## See Also  
 ...
 [IDebugCoreServer3::GetConnectionProtocol](../VS_csharp/idebugcoreserver3--getconnectionprotocol.md)