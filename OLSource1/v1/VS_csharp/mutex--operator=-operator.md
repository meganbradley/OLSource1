...
## Remarks  
 For more information, see the **Move Semantics** section of [Rvalue Reference Declarator: &&](../VS_csharp/rvalue-reference-declarator----.md).  
...
## See Also  
 [Mutex Class](../VS_csharp/mutex-class.md)