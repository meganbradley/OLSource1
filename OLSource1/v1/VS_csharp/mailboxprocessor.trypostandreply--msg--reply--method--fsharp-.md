...
Like [MailboxProcessor.PostAndReply](../VS_csharp/mailboxprocessor.postandreply--msg--reply--method--fsharp-.md), but returns `None` if there is no reply within the timeout period.  
...
## Example  
 ...
 [!code[FsMailboxProcessor#16](../VS_csharp/codesnippet/FSharp/mailboxprocessor.trypostandreply--msg--reply--method--fsharp-_1.fs)]  
