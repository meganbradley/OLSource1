...
## Remarks  
 Passed as a parameter to the [GetLocationType](../VS_csharp/idebugbreakpointrequest2--getlocationtype.md) method.  
 ...
 `BPT_CODE` and `BPT_DATA` are members of the [BP_TYPE](../VS_csharp/bp_type.md) enumeration.  
...
## See Also  
 ...
 [GetLocationType](../VS_csharp/idebugbreakpointrequest2--getlocationtype.md)   
