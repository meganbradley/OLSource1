...
##  <a name="req"></a> Requirements  
 Before you can create an Android Native Activity app, you must make sure you've met all system requirements, and installed the Visual C++ Mobile Development option in Visual Studio 2015. For more information, see [Install Visual C++ for Cross-Platform Mobile Development](../VS_csharp/install-visual-c---for-cross-platform-mobile-development.md). Make sure that the required third-party tools and SDKs are included in the installation, and that the Microsoft Visual Studio Emulator for Android is installed.  
...
3.  Give the app a name like `MyAndroidApp`, and then choose **OK**.  
     ...
     ![Create a Native Activity project](../VS_csharp/media/cppmdd_newproject.PNG "CppMDD_NewProject")  
  
     Visual Studio creates the new solution and opens Solution Explorer.  
  
     ![Native Activity project in Solution Explorer](../VS_csharp/media/cppmdd_rc_na_solutionexp.PNG "CPPMDD_RC_NA_SolutionExp")  
...
1.  If it is not already selected, choose **x86** from the **Solution Platforms** dropdown list.  
     ...
     ![Solution Platforms dropdown x86 selection](../VS_csharp/media/cppmdd_rc_na_solution_x86.png "CPPMDD_RC_NA_Solution_x86")  
...
4.  Press F5 to start debugging, or Shift+F5 to start without debugging.  
     ...
     ![The emulator running your app](../VS_csharp/media/cppmdd_emulator_running_app.PNG "CppMDD_Emulator_Running_App")  
