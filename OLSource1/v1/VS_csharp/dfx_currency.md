...
---
# DFX_Currency
Transfers currency data between the field data members of a [CDaoRecordset](../VS_csharp/cdaorecordset-class.md) object and the columns of a record on the data source.  
 ...
 *value*  
 The value stored in the indicated data member — the value to be transferred. For a transfer from recordset to data source, this value is taken from the specified data member, of type [COleCurrency](../VS_csharp/colecurrency-class.md). For a transfer from data source to recordset, the value is stored in the specified data member.  
...
## Remarks  
 Data is mapped between type **DAO_CURRENCY** in DAO and type [COleCurrency](../VS_csharp/colecurrency-class.md) in the recordset.  
