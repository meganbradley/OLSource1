...
|`select(element)`|Selects the specified HTML `element` in the [DOM Explorer](../VS_csharp/quickstart--debug-html-and-css.md).|console.select(element);|  
...
|`select(element)`|Selects the specified element in [DOM Explorer](../VS_csharp/quickstart--debug-html-and-css.md).|`select(document.getElementById("element"));`<br /><br /> `select($("element"));`<br /><br /> `select($1);`|  
...
## See Also  
 [QuickStart: Debug JavaScript using the console](../VS_csharp/quickstart--debug-javascript-using-the-console.md)   
 [Quick Start: Debug HTML and CSS](../VS_csharp/quickstart--debug-html-and-css.md)