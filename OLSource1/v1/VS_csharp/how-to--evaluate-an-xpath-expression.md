...
> [!NOTE]
>  The following procedure uses the belowAvg.xsl and books.xml files from the [Walkthrough: Debug an XSLT Style Sheet](../VS_csharp/walkthrough--debug-an-xslt-style-sheet.md) topic.  
