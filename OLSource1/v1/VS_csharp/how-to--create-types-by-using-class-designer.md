...
To design new types for Visual C# .NET and Visual Basic .NET projects, create them on a class diagram. To see existing types, see [How to: View Existing Types](../VS_csharp/how-to--view-existing-types--class-designer-.md).  
...
4.  Now add other items to define the type:  
    ...
    |Module|Methods, properties, fields, events, constructors (method), and constants that define the module|  
     ...
     See [Creating Members](../VS_csharp/creating-and-configuring-type-members--class-designer-.md#CreateMembers).  
