...
## Remarks  
 ...
 When defining a coclass, you can also specify the [uuid](../VS_csharp/uuid--c---attributes-.md), [version](../VS_csharp/version--c---.md), [threading](../VS_csharp/threading--c---.md), [vi_progid](../VS_csharp/vi_progid.md), and [progid](../VS_csharp/progid.md) attributes. If any one of them is not specified, it will be generated.  
...
-   [CComCoClass Class](../VS_csharp/ccomcoclass-class.md) provides the default class factory and aggregation model for the object.  
  
-   [CComObjectRootEx Class](../VS_csharp/ccomobjectrootex-class.md) has a template based on the threading model class specified by the [threading](../VS_csharp/threading--c---.md) attribute. If the **threading** attribute is not specified, the default threading model is apartment.  
  
-   [IProvideClassInfo2Impl](../VS_csharp/iprovideclassinfo2impl-class.md) is added if the [noncreatable](../VS_csharp/noncreatable.md) attribute is not specified for the target object.  
  
 Finally, any dual interface that is not defined using embedded IDL is replaced with the corresponding [IDispatchImpl](../VS_csharp/idispatchimpl-class.md) class. If the dual interface is defined in embedded IDL, the particular interface in the base list is not modified.  
...
-   **GetProgID**, which is related to registration, returns the string specified with the [progid](../VS_csharp/progid.md) attribute.  
  
-   **GetVersionIndependentProgID** has the same functionality as **GetProgID**, but it returns the string specified with [vi_progid](../VS_csharp/vi_progid.md).  
  
 The following changes, which are related to the COM map, are made to the target class:  
  
-   A COM map is added with entries for all interfaces the target class derives from and all entries specified by the [COM Interface Entry Points](../VS_csharp/com-interface-entry-points.md) attribute or those required by the [aggregates](../VS_csharp/aggregates.md) attribute.  
  
-   An [OBJECT_ENTRY_AUTO](../VS_csharp/object_entry_auto.md) macro is inserted into the COM map. This macro is similar to [OBJECT_ENTRY](assetId:///abd10ee2-54f0-4f94-9ec2-ddf8f4c8c8cd) in terms of functionality but does not need to be part of the COM map of the target class.  
...
## See Also  
 ...
 [appobject](../VS_csharp/appobject.md)