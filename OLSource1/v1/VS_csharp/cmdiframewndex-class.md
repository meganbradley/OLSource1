...
---
# CMDIFrameWndEx Class
Extends the functionality of [CMDIFrameWnd](../VS_csharp/cframewnd-class.md), a Windows Multiple Document Interface (MDI) frame window.  
...
|[CMDIFrameWndEx::EnableWindowsDialog](#cmdiframewndex__enablewindowsdialog)|Inserts a menu item whose command ID calls a [CMFCWindowsManagerDialog](../VS_csharp/cmfcwindowsmanagerdialog-class.md) dialog box.|  
...
|[CMDIFrameWndEx::GetTearOffBars](#cmdiframewndex__gettearoffbars)|Returns a list of [CPane](../VS_csharp/cpane-class.md)-derived objects that are in a tear-off state.|  
|`CMDIFrameWndEx::GetThisClass`|Called by the framework to obtain a pointer to the [CRuntimeClass](../VS_csharp/cruntimeclass-structure.md) object that is associated with this class type.|  
...
|[CMDIFrameWndEx::OnDrawMenuLogo](#cmdiframewndex__ondrawmenulogo)|Called by the framework when a [CMFCPopupMenu](../VS_csharp/cmfcpopupmenu-class.md)processes a `WM_PAINT` message.|  
...
|[CMDIFrameWndEx::OnMenuButtonToolHitTest](#cmdiframewndex__onmenubuttontoolhittest)|Called by the framework when a [CMFCToolBarButton](../VS_csharp/cmfctoolbarbutton-class.md)object processes a `WM_NCHITTEST` message.|  
|[CMDIFrameWndEx::OnMoveMiniFrame](#cmdiframewndex__onmoveminiframe)|Called by the framework to move a mini-frame window.|  
|[CMDIFrameWndEx::OnSetPreviewMode](#cmdiframewndex__onsetpreviewmode)|Sets the application's main frame window print-preview mode. (Overrides [CFrameWnd::OnSetPreviewMode](../VS_csharp/cframewnd-class.md#cframewnd__onsetpreviewmode).)|  
...
|`CMDIFrameWndEx::PreTranslateMessage`|Used by class [CWinApp](../VS_csharp/cwinapp-class.md) to translate window messages before they are dispatched to the                                         [TranslateMessage](http://msdn.microsoft.com/library/windows/desktop/ms644955) and                                         [DispatchMessage](http://msdn.microsoft.com/library/windows/desktop/ms644934) Windows functions.  (Overrides `CMDIFrameWnd::PreTranslateMessage`.)|  
|[CMDIFrameWndEx::RecalcLayout](#cmdiframewndex__recalclayout)|Called by the framework to recalculate the layout of the frame window. (Overrides [CFrameWnd::RecalcLayout](../VS_csharp/cframewnd-class.md#cframewnd__recalclayout).)|  
...
|[CMDIFrameWndEx::ShowWindowsDialog](#cmdiframewndex__showwindowsdialog)|Creates a [CMFCWindowsManagerDialog](../VS_csharp/cmfcwindowsmanagerdialog-class.md) box and opens it.|  
...
|[CMDIFrameWndEx::WinHelp](#cmdiframewndex__winhelp)|Called by the framework to initiate the WinHelp application or context help. (Overrides [CWnd::WinHelp](../VS_csharp/cwnd-class.md#cwnd__winhelp).)|  
...
## Example  
 The following example derives a class from `CMDIFrameWndEx`. This code snippet comes from the [DrawClient Sample: MFC Ribbon-Based OLE Object Drawing Application](../VS_csharp/visual-c---samples.md).  
  
 [!code[NVC_MFC_DrawClient#1](../VS_csharp/codesnippet/CPP/cmdiframewndex-class_1.h)]  
...
## Inheritance Hierarchy  
 ...
 [CMDIFrameWndEx](../VS_csharp/cmdiframewndex-class.md)  
...
### Remarks  
 Each pane must be registered with the [docking manager](../VS_csharp/cdockingmanager-class.md) before it can take a part in the docking layout. Use this method to notify the docking manager that you want to dock a specific pane. Once that pane is registered, the docking manager aligns it based on its alignment setting and position in the list of panes maintained by the docking manager.  
...
### Remarks  
 This method converts a docking pane to a tabbed document. When you call this method, the framework creates a [CMDIChildWndEx](../VS_csharp/cmdichildwndex-class.md) object, removes the docking pane from the docking manager, and adds the docking pane to the new MDI child window. The MDI child window resizes the docking pane to cover the entire client area  
...
### Example  
 The following example shows how `CreateDocumentWindow` is used in the [VisualStudioDemo Sample: MFC Visual Studio Application](../VS_csharp/visual-c---samples.md).  
 ...
 [!code[NVC_MFC_VisualStudioDemo#13](../VS_csharp/codesnippet/CPP/cmdiframewndex-class_2.cpp)]  
...
### Remarks  
 This method docks the specified the pane to one of the sides of the frame window that was specified when [CBasePane::EnableDocking](../VS_csharp/cbasepane-class.md#cbasepane__enabledocking) and [CMDIFrameWndEx::EnableDocking](#cmdiframewndex__enabledocking) were called.  
  
### Example  
 The following example demonstrates the use of the `DockPane` method. This code snippet comes from the [VisualStudioDemo Sample: MFC Visual Studio Application](../VS_csharp/visual-c---samples.md).  
  
 [!code[NVC_MFC_VisualStudioDemo#4](../VS_csharp/codesnippet/CPP/cmdiframewndex-class_3.cpp)]  
...
### Example  
 The following example shows how the `DockPaneLeftOf` method is used in the [VisualStudioDemo Sample: MFC Visual Studio Application](../VS_csharp/visual-c---samples.md).  
  
 [!code[NVC_MFC_VisualStudioDemo#5](../VS_csharp/codesnippet/CPP/cmdiframewndex-class_4.cpp)]  
...
### Example  
 The following example shows how the `EnableAutoHidePanes` method is used in the [VisualStudioDemo Sample: MFC Visual Studio Application](../VS_csharp/visual-c---samples.md).  
  
 [!code[NVC_MFC_VisualStudioDemo#6](../VS_csharp/codesnippet/CPP/cmdiframewndex-class_5.cpp)]  
...
### Example  
 The following example shows how the `EnableDocking` method is used in the [VisualStudioDemo Sample: MFC Visual Studio Application](../VS_csharp/visual-c---samples.md).  
  
 [!code[NVC_MFC_VisualStudioDemo#7](../VS_csharp/codesnippet/CPP/cmdiframewndex-class_6.cpp)]  
...
-   Your application can save the current layout of tabbed windows and the list of currently opened documents.  
 ...
 For more information about how to use MDI tabbed groups, see [MDI Tabbed Groups](../VS_csharp/mdi-tabbed-groups.md).  
  
### Example  
 The following example shows how `EnableMDITabbedGroups` is used in the [VisualStudioDemo Sample: MFC Visual Studio Application](../VS_csharp/visual-c---samples.md).  
  
 [!code[NVC_MFC_VisualStudioDemo#8](../VS_csharp/codesnippet/CPP/cmdiframewndex-class_7.cpp)]  
...
### Example  
 The following example shows how `EnableMDITabs` is used in the [MDITabsDemo Sample: MFC Tabbed MDI Application](../VS_csharp/visual-c---samples.md).  
  
 [!code[NVC_MFC_MDITabsDemo#3](../VS_csharp/codesnippet/CPP/cmdiframewndex-class_8.cpp)]  
...
### Example  
 The following example shows how `EnablePaneMenu` is used in the [VisualStudioDemo Sample: MFC Visual Studio Application](../VS_csharp/visual-c---samples.md).  
  
 [!code[NVC_MFC_VisualStudioDemo#9](../VS_csharp/codesnippet/CPP/cmdiframewndex-class_9.cpp)]  
  
##  <a name="cmdiframewndex__enablewindowsdialog"></a>  CMDIFrameWndEx::EnableWindowsDialog  
 Inserts a menu item whose command ID calls a [CMFCWindowsManagerDialog](../VS_csharp/cmfcwindowsmanagerdialog-class.md) dialog box.  
...
### Remarks  
 Use this method to insert a menu item whose command calls a MDI child window management dialog box ( [CBCGPWindowsManagerDlg](../VS_csharp/cmfcwindowsmanagerdialog-class.md)). The new item is inserted into the menu specified by `uiMenuId`. Call `EnableWindowsDialog` when you process the `WM_CREATE` message.  
  
### Example  
 The following example shows how `EnableWindowsDialog` is used in the [VisualStudioDemo Sample: MFC Visual Studio Application](../VS_csharp/visual-c---samples.md).  
  
 [!code[NVC_MFC_VisualStudioDemo#10](../VS_csharp/codesnippet/CPP/cmdiframewndex-class_10.cpp)]  
...
### Remarks  
 Use this function to obtain a pointer to the [CBCGPPopupMenu](../VS_csharp/cmfcpopupmenu-class.md) object that is currently displayed.  
...
### Remarks  
 This method returns the resource ID that was specified when the MDI frame window was loaded by [CFrameWnd::LoadFrame](../VS_csharp/cframewnd-class.md#cframewnd__loadframe).  
...
### Return Value  
 A reference to a [CObList Class](../VS_csharp/coblist-class.md) object that contains a list of tabbed windows. Do not store or modify the list.  
...
### Return Value  
 Pointer to the [CMFCRibbonBar Class](../VS_csharp/cmfcribbonbar-class.md) for the frame.  
...
### Return Value  
 A reference to a [CObList Class](../VS_csharp/coblist-class.md) object that contains a collection of pointers to `CPane`-derived objects that are in a tear-off state.  
...
### Parameters  
 ...
 [in] `pContext`  
 A pointer to a [CCreateContext Structure](../VS_csharp/ccreatecontext-structure.md). This parameter can be `NULL`.  
...
-   Override `GetDocumentName` in the `CMDIChildWndEx`- derived class if your application displays documents that are not stored as files. The returned string will be saved in the registry as the document identifier. The base implementation of [CMDIChildWndEx::GetDocumentName](../VS_csharp/cmdichildwndex-class.md#cmdichildwndex__getdocumentname) returns a value obtained from [CDocument::GetPathName](../VS_csharp/cdocument-class.md#cdocument__getpathname).  
...
### Example  
 The following example shows how `LoadMDIState` is used in the [VisualStudioDemo Sample: MFC Visual Studio Application](../VS_csharp/visual-c---samples.md).  
  
 [!code[NVC_MFC_VisualStudioDemo#11](../VS_csharp/codesnippet/CPP/cmdiframewndex-class_11.cpp)]  
...
### Example  
 The following example shows how `MDITabNewGroup` is used in the [VisualStudioDemo Sample: MFC Visual Studio Application](../VS_csharp/visual-c---samples.md).  
  
 [!code[NVC_MFC_VisualStudioDemo#12](../VS_csharp/codesnippet/CPP/cmdiframewndex-class_12.cpp)]  
...
### Example  
 The following example shows how `m_bCanCovertControlBarToMDIChild` is used in the [VisualStudioDemo Sample: MFC Visual Studio Application](../VS_csharp/visual-c---samples.md).  
...
-   `borderSet` = 3  
 ...
 [in, out] `lpRectBorder`  
 Pointer to a [RECT Structure](../VS_csharp/rect-structure.md) or a [CRect Class](../VS_csharp/crect-class.md) object that specifies the coordinates of the border.  
...
### Remarks  
 Override this method if you want to process notifications from [CMFCPopupMenu Class](../VS_csharp/cmfcpopupmenu-class.md) objects that belong to the MDI frame window when those objects process `WM_DESTROY` messages.  
...
### Parameters  
 ...
 [in] `nCode`  
 Identifies the command notification code. See [CCmdTarget::OnCmdMsg](../VS_csharp/ccmdtarget-class.md#ccmdtarget__oncmdmsg) for more information about values for `nCode`.  
  
 [in] `pExtra`  
 Used according to the value of `nCode`. See [CCmdTarget::OnCmdMsg](../VS_csharp/ccmdtarget-class.md#ccmdtarget__oncmdmsg) for more information about `pExtra`.  
...
##  <a name="cmdiframewndex__ondrawmenulogo"></a>  CMDIFrameWndEx::OnDrawMenuLogo  
 Called by the framework when a [CMFCPopupMenu](../VS_csharp/cmfcpopupmenu-class.md)processes a `WM_PAINT` message.  
...
##  <a name="cmdiframewndex__onmenubuttontoolhittest"></a>  CMDIFrameWndEx::OnMenuButtonToolHitTest  
 Called by the framework when a [CMFCToolBarButton](../VS_csharp/cmfctoolbarbutton-class.md)object processes a `WM_NCHITTEST` message.  
...
### Remarks  
 This method overrides [CFrameWnd::OnSetPreviewMode](../VS_csharp/cframewnd-class.md#cframewnd__onsetpreviewmode).  
...
### Return Value  
 Override this method in a [CBCGPMDIFrameWnd](../VS_csharp/cmdiframewndex-class.md)-derived class.  
...
### Example  
 The following example shows how `OnShowMDITabContextMenu` is used in the [VisualStudioDemo Sample: MFC Visual Studio Application](../VS_csharp/visual-c---samples.md).  
  
 [!code[NVC_MFC_VisualStudioDemo#14](../VS_csharp/codesnippet/CPP/cmdiframewndex-class_13.cpp)]  
...
### Remarks  
 ...
 If [CDockingManager::m_bHideDockingBarsInContainerMode](../VS_csharp/cdockingmanager-class.md#cdockingmanager__m_bhidedockingbarsincontainermode) is `TRUE` (the default), all docking panes will be hidden.  
...
### Remarks  
 The call is redirected to the [docking manager](../VS_csharp/cdockingmanager-class.md). See [CDockingManager::ControlBarFromPoint](../VS_csharp/cdockingmanager-class.md#cdockingmanager__panefrompoint) for more information.  
...
### Remarks  
 This method overrides [CFrameWnd::RecalcLayout](../VS_csharp/cframewnd-class.md#cframewnd__recalclayout).  
...
### Example  
 The following example shows how `SaveMDIState` is used in the [VisualStudioDemo Sample: MFC Visual Studio Application](../VS_csharp/visual-c---samples.md).  
  
 [!code[NVC_MFC_VisualStudioDemo#15](../VS_csharp/codesnippet/CPP/cmdiframewndex-class_14.cpp)]  
...
### Parameters  
 [in] `menu`  
 A reference to a [CMenu Class](../VS_csharp/cmenu-class.md) object to be modified.  
...
### Example  
 The following example shows how `ShowPane` is used in the [VisualStudioDemo Sample: MFC Visual Studio Application](../VS_csharp/visual-c---samples.md).  
  
 [!code[NVC_MFC_VisualStudioDemo#16](../VS_csharp/codesnippet/CPP/cmdiframewndex-class_15.cpp)]  
  
##  <a name="cmdiframewndex__showwindowsdialog"></a>  CMDIFrameWndEx::ShowWindowsDialog  
 Creates a [CMFCWindowsManagerDialog](../VS_csharp/cmfcwindowsmanagerdialog-class.md) box and opens it.  
...
### Example  
 The following example shows how `ShowWindowsDialog` is used in the [VisualStudioDemo Sample: MFC Visual Studio Application](../VS_csharp/visual-c---samples.md).  
  
 [!code[NVC_MFC_VisualStudioDemo#18](../VS_csharp/codesnippet/CPP/cmdiframewndex-class_16.cpp)]  
...
### Example  
 The following example shows how `TabbedDocumentToControlBar` is used in the [VisualStudioDemo Sample: MFC Visual Studio Application](../VS_csharp/visual-c---samples.md).  
  
 [!code[NVC_MFC_VisualStudioDemo#19](../VS_csharp/codesnippet/CPP/cmdiframewndex-class_17.cpp)]  
...
### Remarks  
 This method overrides [CWnd::WinHelp](../VS_csharp/cwnd-class.md#cwnd__winhelp).  
  
## See Also  
 [Hierarchy Chart](../VS_csharp/hierarchy-chart.md)   
 [Classes](../VS_csharp/mfc-classes.md)   
 [CMDIFrameWnd](../VS_csharp/cframewnd-class.md)   
