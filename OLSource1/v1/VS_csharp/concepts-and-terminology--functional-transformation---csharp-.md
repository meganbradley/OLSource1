 ...
 *Functional programming* is a programming approach that directly supports pure functional transformation.  
 ...
 For more information about functional programming, see [Functional Programming vs. Imperative Programming (C#)](../VS_csharp/functional-programming-vs.-imperative-programming--csharp-.md).  
...
## Terminology  
 ...
 For more information, see [Standard Query Operators Overview (C#)](../VS_csharp/standard-query-operators-overview--csharp-.md).  
 ...
 For more information about, see [Lambda Expressions &#91;C#&#93;](../VS_csharp/lambda-expressions--csharp-programming-guide-.md).  
 ...
 For more information, see [Anonymous Types &#91;C#&#93;](../VS_csharp/anonymous-types--csharp-programming-guide-.md).  
 ...
 For more information, see [Implicitly Typed Local Variables &#91;C#&#93;](../VS_csharp/implicitly-typed-local-variables--csharp-programming-guide-.md).  
 ...
 For more information, see [Introduction to LINQ Queries (C#)](../VS_csharp/introduction-to-linq-queries--csharp-.md) and [Deferred Execution and Lazy Evaluation in LINQ to XML (C#)](../VS_csharp/deferred-execution-and-lazy-evaluation-in-linq-to-xml--csharp-.md).  
