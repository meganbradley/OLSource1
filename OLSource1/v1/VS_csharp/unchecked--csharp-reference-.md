...
The `unchecked` keyword is used to suppress overflow-checking for integral-type arithmetic operations and conversions.  
 ...
 Expressions that contain non-constant terms are unchecked by default at compile time and run time. See [checked](../VS_csharp/checked--csharp-reference-.md) for information about enabling a checked environment.  
