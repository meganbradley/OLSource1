...
The `unchecked` keyword is used to suppress overflow-checking for integral-type arithmetic operations and conversions.  
 ...
 [!code[csrefKeywordsChecked#5](../VS_csharp/codesnippet/CSharp/unchecked--csharp-reference-_1.cs)]  
 ...
 Expressions that contain non-constant terms are unchecked by default at compile time and run time. See [checked (C# Reference)](../VS_csharp/checked--csharp-reference-.md) for information about enabling a checked environment.  
...
## Example  
 ...
 [!code[csrefKeywordsChecked#2](../VS_csharp/codesnippet/CSharp/unchecked--csharp-reference-_2.cs)]  
...
## See Also  
 ...
 [checked](../VS_csharp/checked--csharp-reference-.md)