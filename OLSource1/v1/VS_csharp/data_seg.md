...
## Remarks  
 ...
 OBJ files can be viewed with the [dumpbin](../VS_csharp/dumpbin-command-line.md) application. The default segment in the .obj file for initialized variables is .data. Variables that are uninitialized are considered to be initialized to zero and are stored in .bss.  
...
```  
 ...
 You can also specify sections for const variables ([const_seg](../VS_csharp/const_seg.md)), uninitialized data ([bss_seg](../VS_csharp/bss_seg.md)), and functions ([code_seg](../VS_csharp/code_seg.md)).  
