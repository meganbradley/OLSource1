...
-   [Implicit linking](../VS_csharp/linking-implicitly.md)  
  
-   [Explicit linking](../VS_csharp/linking-explicitly.md)  
...
-   [Determining which linking method to use](../VS_csharp/determining-which-linking-method-to-use.md)  
