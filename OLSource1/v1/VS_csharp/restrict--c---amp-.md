...
> [!NOTE]
>  For information about the `restrict` keyword that is part of the `__declspec` storage-class attributes, see [restrict](../VS_csharp/restrict.md).  
...
-   The following are not allowed:  
    ...
    -   Variables declared with the [volatile](../VS_csharp/volatile--c---.md) keyword.  
    ...
    -   Static variables. Use [tile_static](../VS_csharp/tile_static-keyword.md) instead.  
