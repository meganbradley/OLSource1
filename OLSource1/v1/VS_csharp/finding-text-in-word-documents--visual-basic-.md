...
```  
 ...
 Note that this example performs approximately as well as if it were written as a single query. Because each query is implemented in a lazy, deferred fashion, each query does not yield its results until the query is iterated. For more information about execution and lazy evaluation, see [Deferred Execution and Lazy Evaluation in LINQ to XML (Visual Basic)](../VS_csharp/deferred-execution-and-lazy-evaluation-in-linq-to-xml--visual-basic-.md).  
  
## Next Steps  
 The next section provides more information about WordprocessingML documents:  
  
-   [Details of Office Open XML WordprocessingML Documents (Visual Basic)](../VS_csharp/details-of-office-open-xml-wordprocessingml-documents--visual-basic-.md)  
...
## See Also  
 ...
 [Refactoring Using a Pure Function (Visual Basic)](../VS_csharp/refactoring-using-a-pure-function--visual-basic-.md)   
