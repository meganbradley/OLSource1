...
```  
 ...
 Another use of the @ symbol is to use referenced ([/reference](../VS_csharp/-reference--csharp-compiler-options-.md)) identifiers that are C# keywords.  
  
 For more information about strings in C#, see [Strings Overview (C# Programming Guide)](../VS_csharp/strings--csharp-programming-guide-.md).  
  
## Example  
 [!code[csrefKeywordsTypes#17](../VS_csharp/codesnippet/CSharp/string--csharp-reference-_1.cs)]  
