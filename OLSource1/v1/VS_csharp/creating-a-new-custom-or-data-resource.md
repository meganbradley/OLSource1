...
1.  [Create a .rc file](../VS_csharp/how-to--create-a-resource-script-file.md) that contains the custom or data resource.  
...
4.  Click **OK** to record your changes.  
 ...
 Another way to create a custom resource is to import an external file as the custom resource. For more information, see [Importing and Exporting Resources](../VS_csharp/how-to--import-and-export-resources.md).  
