 ...
 *pDBID*  
 ...
 `bstr`  
 [in] A [CComBSTR](../VS_csharp/ccombstr-class.md) reference to place a copy of the **DBID** string.  
...
## Remarks  
 This method is called by the `CRowsetImpl` implementations of [ValidateCommandID](../VS_csharp/crowsetimpl--validatecommandid.md) and [GetCommandFromID](../VS_csharp/crowsetimpl--getcommandfromid.md).  
