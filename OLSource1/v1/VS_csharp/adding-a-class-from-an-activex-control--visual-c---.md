...
Use this wizard to create an MFC class from an interface in an available ActiveX control. You can add an MFC class to an [MFC application](../VS_csharp/creating-an-mfc-application.md), an [MFC DLL](../VS_csharp/creating-an-mfc-dll-project.md), or an [MFC ActiveX control](../VS_csharp/creating-an-mfc-activex-control.md).  
...
3.  In the [Add Class](../VS_csharp/add-class-dialog-box.md) dialog box, in the Templates pane, click **MFC Class from ActiveX Control**, and then click **Open** to display the [Add Class from ActiveX Control Wizard](../VS_csharp/add-class-from-activex-control-wizard.md).  
 ...
 You can add classes from ActiveX controls registered in your system, or you can add classes from ActiveX controls located in type library files (.tlb, .olb, .dll, .ocx, or .exe) without first registering them in your system. See [Registering OLE Controls](../VS_csharp/registering-ole-controls.md) for more information on registering ActiveX controls.  
  
 The wizard creates an MFC class, derived from [CWnd](../VS_csharp/cwnd-class.md) or from [COleDispatchDriver](../VS_csharp/coledispatchdriver-class.md), for each interface you add from the selected ActiveX control.  
