...
#### Parameters  
 `ppParams`  
 [in] An array of [IDebugObject](../VS_csharp/idebugobject.md) objects that represents the input parameters. Each of these parameters was created by using one of the Create methods in this interface.  
