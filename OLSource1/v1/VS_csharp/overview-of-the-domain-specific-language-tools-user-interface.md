...
When you first open a Domain-Specific Language Tools (DSL Tools) solution in [!INCLUDE[vsprvs](../VS_csharp/includes/vsprvs_md.md)], the user interface will resemble the following picture.  
...
## See Also  
 ...
 [Creating Domain-Specific Language Solutions in Visual Studio](../VS_csharp/customizing-and-extending-a-domain-specific-language.md)