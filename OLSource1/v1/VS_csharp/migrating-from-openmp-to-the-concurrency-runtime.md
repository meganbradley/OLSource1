...
The Concurrency Runtime enables a variety of programming models. These models may overlap or complement the models of other libraries. The documents in this section compare [OpenMP](../VS_csharp/openmp-in-visual-c--.md) to the Concurrency Runtime and provide examples about how to migrate existing OpenMP code to use the Concurrency Runtime.  
...
|You require enhanced debugging support.|Visual Studio provides the **Parallel Stacks** and **Parallel Tasks** windows so that you can more easily debug multithreaded applications.<br /><br /> For more information about debugging support for the Concurrency Runtime, see [Using the Parallel Tasks Window](../VS_csharp/using-the-tasks-window.md), [Using the Parallel Stacks Window](../VS_csharp/using-the-parallel-stacks-window.md), and [Walkthrough: Debugging a Parallel Application](../VS_csharp/walkthrough--debugging-a-parallel-application.md).|  
...
## Related Topics  
 [How to: Convert an OpenMP parallel for loop to Use the Concurrency Runtime](../VS_csharp/how-to--convert-an-openmp-parallel-for-loop-to-use-the-concurrency-runtime.md)  
 Given a basic loop that uses the OpenMP [parallel](../VS_csharp/parallel.md) and [for](../VS_csharp/for--openmp-.md) directives, demonstrates how to convert it to use the Concurrency Runtime [concurrency::parallel_for](../VS_csharp/parallel_for-function.md) algorithm.  
  
 [How to: Convert an OpenMP Loop that Uses Cancellation to Use the Concurrency Runtime](../VS_csharp/how-to--convert-an-openmp-loop-that-uses-cancellation-to-use-the-concurrency-runtime.md)  
 Given an OpenMP [parallel](../VS_csharp/parallel.md)[for](../VS_csharp/for--openmp-.md) loop that does not require all iterations to run, demonstrates how to convert it to use the Concurrency Runtime cancellation mechanism.  
  
 [How to: Convert an OpenMP Loop that Uses Exception Handling to Use the Concurrency Runtime](../VS_csharp/how-to--convert-an-openmp-loop-that-uses-exception-handling-to-use-the-concurrency-runtime.md)  
 Given an OpenMP [parallel](../VS_csharp/parallel.md)[for](../VS_csharp/for--openmp-.md) loop that performs exception handling, demonstrates how to convert it to use the Concurrency Runtime exception handling mechanism.  
  
 [How to: Convert an OpenMP Loop that Uses a Reduction Variable to Use the Concurrency Runtime](../VS_csharp/how-to--convert-an-openmp-loop-that-uses-a-reduction-variable-to-use-the-concurrency-runtime.md)  
 Given an OpenMP [parallel](../VS_csharp/parallel.md)[for](../VS_csharp/for--openmp-.md) loop that uses the [reduction](../VS_csharp/reduction.md) clause, demonstrates how to convert it to use the Concurrency Runtime.  
  
## See Also  
 [Concurrency Runtime](../VS_csharp/concurrency-runtime.md)   
 [OpenMP in Visual C++](../VS_csharp/openmp-in-visual-c--.md)   
