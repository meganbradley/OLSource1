...
## Example  
 C2660 can also occur if you attempt to directly call the Dispose method of a managed type. For more information, see [Destructors and Finalizers](../VS_csharp/how-to--define-and-consume-classes-and-structs--c---cli-.md#BKMK_Destructors_and_finalizers). The following sample generates C2660.  
