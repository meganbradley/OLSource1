...
|Member|Description|  
|------------|-----------------|  
|[Equals](../VS_csharp/cancellationtoken.equals-method--fsharp-.md)|Equality comparison against another token.|  
|[IsCancellationRequested](../VS_csharp/cancellationtoken.iscancellationrequested-property--fsharp-.md)|Flags whether an operation should be cancelled.|  
|[Register](../VS_csharp/cancellationtoken.register-method--fsharp-.md)|Registers an action to perform with the CancellationToken.|  
  
## Static Members  
  
|Member|Description|  
|------------|-----------------|  
|[( <> )](../VS_csharp/cancellationtoken.-------method--fsharp-.md)|Inequality operator for tokens.|  
|[( = )](../VS_csharp/cancellationtoken.--=---method--fsharp-.md)|Equality operator for tokens.|  
