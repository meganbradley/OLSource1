...
#### Parameters  
 ...
 `strings`  
 Type: [seq](../VS_csharp/collections.seq--t--type-abbreviation--fsharp-.md)`<`[string](../VS_csharp/core.string-type-abbreviation--fsharp-.md)`>`  
...
## Example  
 ...
 [!code[FsStrings#2](../VS_csharp/codesnippet/FSharp/string.concat-function--fsharp-_1.fs)]  
