...
3.  Choose the **Events** button on the tool bar in the **Properties** window to view the **Events** page in the **Properties** window. Scroll down to the **Click** event, and enter **label_Click** in the box, as shown in the following picture.  
     ...
     ![Properties window showing Click event](../VS_csharp/media/express_labelclick.png "Express_labelClick")  
...
5.  Fill in the rest of the code, as follows:  
     ...
     [!code[VbExpressTutorial4Step2_3_4#4](../VS_csharp/codesnippet/CSharp/step-4--add-a-click-event-handler-to-each-label_1.cs)]
[!code[VbExpressTutorial4Step2_3_4#4](../VS_csharp/codesnippet/VisualBasic/step-4--add-a-click-event-handler-to-each-label_1.vb)]  
...
-   To go to the next tutorial step, see [Step 5: Add Label References](../VS_csharp/step-5--add-label-references.md).  
  
-   To return to the previous tutorial step, see [Step 3: Assign a Random Icon to Each Label](../VS_csharp/step-3--assign-a-random-icon-to-each-label.md).