...
#### Parameters  
 `ppRetVal`  
 [out] Returns an [IDiaEnumSymbols](../VS_csharp/idiaenumsymbols.md) object that contains a list of all compilands that have line numbers referencing this file.  
