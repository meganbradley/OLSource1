...
The CommandPlacement element enables buttons, groups, and menus to be included in more than one group or menu. By using the CommandPlacement element, you do not have to completely redefine these items in order to modify the look of a user interface.  
 ...
 For more information, see [How to: Create Reusable Groups of Buttons](../VS_csharp/creating-reusable-groups-of-buttons.md).  
...
|---------------|-----------------|  
|guid|Required. The guid of the command set, as defined in the [Symbols Element](../VS_csharp/symbols-element.md).|  
...
|Element|Description|  
|-------------|-----------------|  
|[CommandPlacements](../VS_csharp/commandplacements-element.md)|Specifies groups of CommandPlacements and CommandPlacement elements.|  
