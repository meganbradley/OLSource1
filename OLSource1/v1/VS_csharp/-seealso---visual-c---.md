...
---
# &lt;seealso&gt; (Visual C++)
The <seealso\> tag lets you specify the text that you might want to appear in a See Also section. Use [<see\>](../VS_csharp/-see---visual-c---.md) to specify a link from within text.  
...
## Remarks  
 ...
 See [<summary\> (C++)](../VS_csharp/-summary---visual-c---.md) for an example of using <seealso\>.  
