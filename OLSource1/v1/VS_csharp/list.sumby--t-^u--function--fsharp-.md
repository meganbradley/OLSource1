...
## Example  
 The following code example illustrates the use of [List.sum](../VS_csharp/list.sum-^t--function--fsharp-.md), `List.sumBy`, and [List.average](../VS_csharp/list.average-^t--function--fsharp-.md).  
  
 [!code[FsLists#11](../VS_csharp/codesnippet/FSharp/list.sumby--t-^u--function--fsharp-_1.fs)]  
