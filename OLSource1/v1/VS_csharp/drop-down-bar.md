...
## Drop-Down Bar Interfaces  
 In [!INCLUDE[vcprvc](../VS_csharp/includes/vcprvc_md.md)], for example, the drop-down bar contains lists for [!INCLUDE[vcprvc](../VS_csharp/includes/vcprvc_md.md)] Items and [!INCLUDE[vcprvc](../VS_csharp/includes/vcprvc_md.md)] Items Member Functions, as shown in the following picture.  
  
 ![Drop&#45;down Bars](../VS_csharp/media/vsdropdown_bar.gif "vsDropdown_bar")  
Drop-down bar  
...
## See Also  
 [Customizing Code Windows by Using the Legacy API](../VS_csharp/customizing-code-windows-by-using-the-legacy-api.md)   
