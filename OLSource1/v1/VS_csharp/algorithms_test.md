...
##  <a name="random_shuffle"></a>  random_shuffle  
 The std::random_shuffle() function is deprecated, replaced by                 [std::shuffle()](#std__shuffle). For a code example and more information, see                 [<random\>](../VS_csharp/-random-.md) and the Stackoverflow posting                 [Why are std::random_shuffle methods being deprecated in C++14?](http://go.microsoft.com/fwlink/?LinkId=397954).  
