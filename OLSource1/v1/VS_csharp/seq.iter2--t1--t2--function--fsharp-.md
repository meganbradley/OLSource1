...
#### Parameters  
 ...
 `source1`  
 Type: [seq](../VS_csharp/collections.seq--t--type-abbreviation--fsharp-.md)`<'T1>`  
  
 The first input sequence.  
  
 `source2`  
 Type: [seq](../VS_csharp/collections.seq--t--type-abbreviation--fsharp-.md)`<'T2>`  
...
## Example  
 ...
 [!code[FsSequences#43](../VS_csharp/codesnippet/FSharp/seq.iter2--t1--t2--function--fsharp-_1.fs)]  
