...
Checked iterators ensure that the bounds of your container are not overwritten.  
 ...
 Checked iterators apply to release builds and debug builds. For more information about how to use iterators when you compile in debug mode, see [Debug Iterator Support](../VS_csharp/debug-iterator-support.md).  
  
## Remarks  
 For information about how to disable warnings that are generated by checked iterators, see [_SCL_SECURE_NO_WARNINGS](../VS_csharp/_scl_secure_no_warnings.md).  
...
> [!IMPORTANT]
>  Use `_ITERATOR_DEBUG_LEVEL` to control [_SECURE_SCL](../VS_csharp/_secure_scl.md). For more information, see [_ITERATOR_DEBUG_LEVEL](../VS_csharp/_iterator_debug_level.md).  
...
|||||  
|-|-|-|-|  
|[basic_string::operator&#91;&#93;](../Topic/basic_string::operator.md)|[bitset::operator&#91;&#93;](../VS_csharp/bitset--operator.md)|[deque::back](../Topic/deque::back.md)|[deque::front](../Topic/deque::front.md)|  
...
-   If an output iterator is an unchecked iterator you will get unchecked behavior on calls to the standard function (for example, `std::copy`).  
 ...
 A checked iterator refers to an iterator that will call `invalid_parameter_handler` if you attempt to move past the boundaries of the container. For more information about `invalid_parameter_handler`, see [Parameter Validation](../VS_csharp/parameter-validation.md).  
  
 [checked_array_iterator Class](../VS_csharp/checked_array_iterator-class.md) and [unchecked_array_iterator Class](../VS_csharp/unchecked_array_iterator-class.md) are the iterator adaptors that support checked iterators.  
