...
## The New Project Dialog Box  
 ...
 ![New Project dialog box](../VS_csharp/media/newproject.gif "NewProject")  
...
##### DeveloperActivity  
 ...
 indicates that Visual C# will be a root node if Visual Studio is set for [!INCLUDE[vcprvc](../VS_csharp/includes/vcprvc_md.md)] development. Otherwise, it will be a child node of **Other Languages**.  
...
#### Project Type Child Nodes and .vstdir Files  
 ...
 ![Project Types](../VS_csharp/media/projecttypes.png "ProjectTypes")  
  
 The corresponding ProjectTemplates folder looks like this:  
  
 ![Project Templates](../VS_csharp/media/projecttemplates.png "ProjectTemplates")  
  
 When the **New Project** dialog box opens, [!INCLUDE[vsprvs](../VS_csharp/includes/vsprvs_md.md)] traverses the ProjectTemplates folder and recreates its structure in the **Project types** tree with some changes:  
...
##### Finding the Root Node for a Project Type  
 When Visual Studio traverses the ProjectTemplates folders, it opens all .zip files and extracts any .vstemplate files. A .vstemplate file uses XML to describe an application template. For more information, see [New Project Generation: Under the Hood, Part Two](../VS_csharp/new-project-generation--under-the-hood--part-two.md).  
...
1.  Open the **New Project** dialog box and expand the **Visual C#** project node.  
 ...
 ![MyProjectNode](../VS_csharp/media/myprojectnode.png "MyProjectNode")  
  
 **MyProjectNode** appears as a child node of Visual C# just under the Windows node.  
  
## See Also  
 [New Project Generation: Under the Hood, Part Two](../VS_csharp/new-project-generation--under-the-hood--part-two.md)