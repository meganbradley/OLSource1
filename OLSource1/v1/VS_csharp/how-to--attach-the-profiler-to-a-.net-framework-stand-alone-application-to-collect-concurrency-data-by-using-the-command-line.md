...
This topic describes how to use [!INCLUDE[vsprvs](../VS_csharp/includes/vsprvs_md.md)] Profiling Tools command-line tools to attach the Profiler to a running .NET Framework stand-alone (client) application and collect process and thread concurrency data.  
...
4.  Attach the profiler to the target application. Type:  
    ...
    -   [/lineoff](../VS_csharp/lineoff.md) disables the collection of line number data.  
