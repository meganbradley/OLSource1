...
An [interface](../VS_csharp/interface--csharp-reference-.md) can declare an [event](../VS_csharp/event--csharp-reference-.md). The following example shows how to implement interface events in a class. Basically the rules are the same as when you implement any interface method or property.  
...
## Example  
 ...
 [!code[csProgGuideEvents#10](../VS_csharp/codesnippet/CSharp/how-to--implement-interface-events--csharp-programming-guide-_1.cs)]  
