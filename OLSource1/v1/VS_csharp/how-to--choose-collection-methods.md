...
The [!INCLUDE[vsprvs](../VS_csharp/includes/vsprvs_md.md)] Profiling Tools support three methods of collecting performance data: sampling, instrumentation, and concurrency. You can also use either the sampling or instrumentation method to collect .NET memory allocation and lifetime data.  
...
|**.NET Memory Allocation**|Collects [!INCLUDE[dnprdnshort](../VS_csharp/includes/dnprdnshort_md.md)] memory allocation data by using the sampling profiling method.|  
...
4.  Click the collection method that you prefer.  
    ...
    -   For information about the other options that are available when you are collecting sampling data, see [Collecting Performance Statistics by Using Sampling](../VS_csharp/collecting-performance-statistics-by-using-sampling.md)  
  
    -   For information about the other options that are available when you are collecting sampling data, see [Collecting Detailed Timing Data by Using Instrumentation](../VS_csharp/collecting-detailed-timing-data-by-using-instrumentation.md).  
...
5.  Click **Collect .NET object allocation information** to collect the size and number of [!INCLUDE[dnprdnshort](../VS_csharp/includes/dnprdnshort_md.md)] object allocations.  
...
6.  (Optional) Click **Also collect .NET object lifetime information** to collect data about the garbage collection generations in which the object memory was reclaimed.  
     ...
     For information about the other options that are available when you are collecting .NET memory data, see [Collecting .NET Memory Allocation and Lifetime Data](../VS_csharp/collecting-.net-memory-allocation-and-lifetime-data.md).  
...
## See Also  
 ...
 [Performance Session Properties](../VS_csharp/performance-session-properties.md)