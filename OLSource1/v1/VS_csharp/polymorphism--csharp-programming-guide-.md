...
-   define new non-virtual implementation of those members that hide the base class implementations  
 ...
 A derived class can override a base class member only if the base class member is declared as [virtual](../VS_csharp/virtual--csharp-reference-.md) or [abstract](../VS_csharp/abstract--csharp-reference-.md). The derived member must use the [override](../VS_csharp/override--csharp-reference-.md) keyword to explicitly indicate that the method is intended to participate in virtual invocation. The following code provides an example:  
  
 [!code[csProgGuideInheritance#20](../VS_csharp/codesnippet/CSharp/polymorphism--csharp-programming-guide-_2.cs)]  
 ...
 [!code[csProgGuideInheritance#21](../VS_csharp/codesnippet/CSharp/polymorphism--csharp-programming-guide-_3.cs)]  
  
 Virtual methods and properties enable derived classes to extend a base class without needing to use the base class implementation of a method. For more information, see [Versioning with the Override and New Keywords (C# Programming Guide)](../VS_csharp/versioning-with-the-override-and-new-keywords--csharp-programming-guide-.md). An interface provides another way to define a method or set of methods whose implementation is left to derived classes. For more information, see [Interfaces (C# Programming Guide)](../VS_csharp/interfaces--csharp-programming-guide-.md).  
  
### Hiding Base Class Members with New Members  
 If you want your derived member to have the same name as a member in a base class, but you do not want it to participate in virtual invocation, you can use the [new](../VS_csharp/new--csharp-reference-.md) keyword. The `new` keyword is put before the return type of a class member that is being replaced. The following code provides an example:  
  
 [!code[csProgGuideInheritance#18](../VS_csharp/codesnippet/CSharp/polymorphism--csharp-programming-guide-_4.cs)]  
 ...
 [!code[csProgGuideInheritance#19](../VS_csharp/codesnippet/CSharp/polymorphism--csharp-programming-guide-_5.cs)]  
...
### Preventing Derived Classes from Overriding Virtual Members  
 ...
 [!code[csProgGuideInheritance#22](../VS_csharp/codesnippet/CSharp/polymorphism--csharp-programming-guide-_6.cs)]  
  
 A derived class can stop virtual inheritance by declaring an override as [sealed](../VS_csharp/sealed--csharp-reference-.md). This requires putting the `sealed` keyword before the `override` keyword in the class member declaration. The following code provides an example:  
  
 [!code[csProgGuideInheritance#24](../VS_csharp/codesnippet/CSharp/polymorphism--csharp-programming-guide-_7.cs)]  
 ...
 [!code[csProgGuideInheritance#25](../VS_csharp/codesnippet/CSharp/polymorphism--csharp-programming-guide-_8.cs)]  
...
### Accessing Base Class Virtual Members from Derived Classes  
 ...
 [!code[csProgGuideInheritance#26](../VS_csharp/codesnippet/CSharp/polymorphism--csharp-programming-guide-_9.cs)]  
  
 For more information, see [base](../VS_csharp/base--csharp-reference-.md).  
...
-   [Versioning with the Override and New Keywords (C#)](../VS_csharp/versioning-with-the-override-and-new-keywords--csharp-programming-guide-.md)  
  
-   [Knowing When to Use Override and New Keywords](../VS_csharp/knowing-when-to-use-override-and-new-keywords--csharp-programming-guide-.md)  
  
-   [Overriding OnPaint and ToString (C#)](../VS_csharp/how-to--override-the-tostring-method--csharp-programming-guide-.md)  
