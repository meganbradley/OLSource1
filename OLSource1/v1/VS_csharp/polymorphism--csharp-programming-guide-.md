...
-   define new non-virtual implementation of those members that hide the base class implementations  
 ...
 Virtual methods and properties enable derived classes to extend a base class without needing to use the base class implementation of a method. For more information, see [Versioning with the Override and New Keywords](../VS_csharp/versioning-with-the-override-and-new-keywords--csharp-programming-guide-.md). An interface provides another way to define a method or set of methods whose implementation is left to derived classes. For more information, see [Interfaces](../VS_csharp/interfaces--csharp-programming-guide-.md).  
...
-   [Versioning with the Override and New Keywords](../VS_csharp/versioning-with-the-override-and-new-keywords--csharp-programming-guide-.md)  
...
-   [How to: Override the ToString Method](../VS_csharp/how-to--override-the-tostring-method--csharp-programming-guide-.md)  
