...
The Visual Studio Extension Color Editor tool can create and edit custom colors for Visual Studio. The tool can also generate theme resource keys so that the colors can be used in code. This tool is useful for making colors for a Visual Studio extension that supports theming. This tool can open .pkgdef and .xml files. Visual Studio themes (.vstheme files) can be used with the Visual Studio Extension Color Editor by changing the file extension to .xml. Additionally, .vstheme files can be imported into a current .xml file.  
 ...
 ![VSIX Color Editor Hero](../VS_csharp/media/vsix-color-editor-hero.png "VSIX Color Editor Hero")  
 ...
 **Step 3: Use the color editor to create new color tokens.**  
 ...
 ![VSIX Color Editor New Color](../VS_csharp/media/vsix-color-editor-new-color.png "VSIX Color Editor New Color")  
 ...
 ![VSIX Color Editor New Category](../VS_csharp/media/vsix-color-editor-new-category.png "VSIX Color Editor New Category")  
 ...
 ![VSIX Color Editor New Color Filled](../VS_csharp/media/vsix-color-editor-new-color-filled.png "VSIX Color Editor New Color Filled")  
 ...
 ![VSIX Color Editor Color Values](../VS_csharp/media/vsix-color-editor-color-values.png "VSIX Color Editor Color Values")  
 ...
 ![VSIX Color Editor Edit Color](../VS_csharp/media/vsix-color-editor-edit-color.png "VSIX Color Editor Edit Color")  
  
 ![VSIX Color Editor Background](../VS_csharp/media/vsix-color-editor-background.png "VSIX Color Editor Background")  
 ...
 **Step 4: Use the colors in a Visual Studio extension.**  
 ...
 ![VSIX Color Editor pkgdef](../VS_csharp/media/vsix-color-editor-pkgdef.png "VSIX Color Editor pkgdef")  
 ...
 ![VSIX Color Editor Resource Code Viewer](../VS_csharp/media/vsix-color-editor-resource-code-viewer.png "VSIX Color Editor Resource Code Viewer")  
 ...
 **Step 5: Test the changes in Visual Studio.**  
 ...
 ![VSIX Color Editor Apply](../VS_csharp/media/vsix-color-editor-apply.png "VSIX Color Editor Apply")  
