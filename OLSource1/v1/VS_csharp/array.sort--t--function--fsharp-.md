...
Sorts the elements of an array, returning a new array. Elements are compared using [Operators.compare](../VS_csharp/operators.compare--t--function--fsharp-.md).  
...
## Remarks  
 This is not a stable sort. Therefore, the original order of equal elements might not be preserved. For a stable sort, consider using [Seq.sort](../VS_csharp/seq.sort--t--function--fsharp-.md).  
...
## Example  
 ...
 [!code[FsArrays#37](../VS_csharp/codesnippet/FSharp/array.sort--t--function--fsharp-_1.fs)]  
