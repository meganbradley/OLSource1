...
---
# ICommandTextImpl::GetCommandText
Returns the text command set by the last call to [SetCommandText](../VS_csharp/icommandtextimpl--setcommandtext.md).  
...
## See Also  
 [ICommandTextImpl Class](../VS_csharp/icommandtextimpl-class.md)