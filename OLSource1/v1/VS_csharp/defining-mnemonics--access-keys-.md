...
2.  In the [Properties Window](../VS_csharp/properties-window.md), in the **Caption** property, type a new name for the control, typing an ampersand (**&**) in front of the letter you want as the access key for that control. For example, `&Radio1`.  
...
1.  Make a caption for the control by using a **Static Text** control in the [Toolbox](../VS_csharp/toolbox.md).  
