...
[!INCLUDE[vsprvs](../VS_csharp/includes/vsprvs_md.md)] provides many default shortcut key combinations to make it easy to navigate and code within the integrated development environment (IDE). For a full listing of shortcut keys used in Visual Studio, see [Pre-defined Keyboard Shortcuts](../VS_csharp/default-keyboard-shortcuts-in-visual-studio.md). For information on keyboard shortcuts available for other Microsoft products, see [http://www.microsoft.com/enable/products/keyboard.aspx](http://go.microsoft.com/fwlink/?LinkID=40400).  
...
## See Also  
 [How To: Work with Shortcut Key Combinations](../VS_csharp/identifying-and-customizing-keyboard-shortcuts-in-visual-studio.md)   
 [Accessibility Tips and Tricks](../VS_csharp/accessibility-tips-and-tricks.md)   
 [Shortcut Keys](../VS_csharp/default-keyboard-shortcuts-in-visual-studio.md)