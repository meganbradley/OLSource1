...
-   Registering control object factories with the OLE system registry.  
 ...
 For more information about object creation, see the articles [Data Objects and Data Sources (OLE)](../VS_csharp/data-objects-and-data-sources--ole-.md) and [Data Objects and Data Sources: Creation and Destruction](../VS_csharp/data-objects-and-data-sources--creation-and-destruction.md). For more about registration, see the article [Registration](../VS_csharp/registration.md).  
...
-   **afxRegFreeThreading** Sets the threading model in the registry to ThreadingModel=Free.  
     ...
     You can combine the two flags `afxRegApartmentThreading` and `afxRegFreeThreading` to set ThreadingModel=Both. See                                         [InprocServer32](http://msdn.microsoft.com/library/windows/desktop/ms682390) in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)] for more information on threading model registration.  
...
### Remarks  
 ...
 For more information, see                         [CLSID Key](http://msdn.microsoft.com/library/windows/desktop/ms691424) in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Remarks  
 Override this function to create the object from something other than the [CRuntimeClass](../VS_csharp/cruntimeclass-structure.md) passed to the constructor.  
...
### Remarks  
 This function is usually called by [CWinApp::InitInstance](../VS_csharp/cwinapp-class.md#cwinapp__initinstance) when the application is launched.  
...
### Remarks  
 The framework calls this function automatically before the application terminates. If necessary, call it from an override of [CWinApp::ExitInstance](../VS_csharp/cwinapp-class.md#cwinapp__exitinstance).  
...
-   **UpdateRegistry(**  `lpszProgID`  **)** Registers this object factory with the OLE system registry. This function is usually called by [CWinApp::InitInstance](../VS_csharp/cwinapp-class.md#cwinapp__initinstance) when the application is launched.  
