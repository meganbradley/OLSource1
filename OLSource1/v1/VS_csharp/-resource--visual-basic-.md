...
## Remarks  
 ...
 If `filename` is a [!INCLUDE[dnprdnshort](../VS_csharp/includes/dnprdnshort_md.md)] resource file created, for example, by the [Resource File Generator (Resgen.exe)](assetId:///8ef159de-b660-4bec-9213-c3fbc4d1c6f4) or in the development environment, it can be accessed with members in the <xref:System.Resources*> namespace (see <xref:System.Resources.ResourceManager*> for more information). To access all other resources at run time, use one of the following methods: <xref:System.Reflection.Assembly.GetManifestResourceInfo*>, <xref:System.Reflection.Assembly.GetManifestResourceNames*>, or <xref:System.Reflection.Assembly.GetManifestResourceStream*>.  
  
 The short form of `/resource` is `/res`.  
  
 For information about how to set `/resource` in the Visual Studio IDE, see [Managing Application Resources](../VS_csharp/managing-application-resources--.net-.md).  
...
## See Also  
 ...
 [/win32resource](../VS_csharp/-win32resource.md)   
 [/linkresource (Visual Basic)](../VS_csharp/-linkresource--visual-basic-.md)   
