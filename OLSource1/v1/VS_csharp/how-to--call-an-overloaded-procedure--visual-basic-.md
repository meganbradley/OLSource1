...
3.  You do not have to determine which version of the procedure to call. [!INCLUDE[vbprvb](../VS_csharp/includes/vbprvb_md.md)] passes control to the version matching your argument list.  
  
     The following example calls the `post` procedure declared in [How to: Define Multiple Versions of a Procedure](../VS_csharp/how-to--define-multiple-versions-of-a-procedure--visual-basic-.md). It obtains the customer identification, determines whether it is a `String` or an `Integer`, and then in either case calls the same procedure.  
  
     [!code[VbVbcnProcedures#56](../VS_csharp/codesnippet/VisualBasic/how-to--call-an-overloaded-procedure--visual-basic-_1.vb)]  
  
     [!code[VbVbcnProcedures#57](../VS_csharp/codesnippet/VisualBasic/how-to--call-an-overloaded-procedure--visual-basic-_2.vb)]  
