...
'function': function call missing argument list; use 'call' to create a pointer to member  
 ...
 This warning is always issued as an error. Use the [warning](../VS_csharp/warning.md) pragma to disable this warning. For more information about C4867 and MFC/ATL, see [_ATL_ENABLE_PTM_WARNING](../VS_csharp/_atl_enable_ptm_warning.md).  
