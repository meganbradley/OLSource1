...
[Pop-up menus](../VS_csharp/menus--mfc-.md) display frequently used commands. They can be context sensitive to the location of the pointer. Using pop-up menus in your application requires building the menu itself and then connecting it to application code.  
...
1.  [Create a menu](../VS_csharp/creating-a-menu.md) with an empty title (don't provide a **Caption**).  
  
2.  [Add a menu command to the new menu](../VS_csharp/adding-commands-to-a-menu.md). Move to the first menu command below the blank menu title (the temporary caption says Type Here). Type a **Caption** and any other information.  
...
3.  Save the menu resource.  
    ...
    > [!TIP]
    >  For more information on viewing the pop-up menu, see [Viewing a Menu as a Pop-Up Menu](../VS_csharp/viewing-a-menu-as-a-pop-up-menu.md).  
...
## See Also  
 [Connecting a Pop-up Menu to Your Application](../VS_csharp/connecting-a-pop-up-menu-to-your-application.md)   
