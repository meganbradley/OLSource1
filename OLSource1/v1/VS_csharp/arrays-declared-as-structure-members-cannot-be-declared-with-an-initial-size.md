...
2.  If you require a certain size of array, you can redimension a dynamic array with a [ReDim Statement (Visual Basic)](../VS_csharp/redim-statement--visual-basic-.md) when your code is running. The following example illustrates this.  
