...
> [!NOTE]
>  This topic describes the elements that you can use in Component diagrams. For more detailed in information about how to draw Component diagrams see [Component Diagrams: Guidelines for Drawing](../VS_csharp/uml-component-diagrams--guidelines.md). For more information about how to draw modeling diagrams in general, see [How to: Draw Modeling Diagrams](../VS_csharp/edit-uml-models-and-diagrams.md).  
  
## Reading Component Diagrams  
 The following table describes the elements that you can use on a component diagram, together with their main properties. For a full list of the properties of the elements, see [Properties of Elements in Component Diagrams](../VS_csharp/properties-of-elements-on-uml-component-diagrams.md).  
  
 ![Elements used on component diagrams](../VS_csharp/media/uml_compovreading.png "UML_CompOvReading")  
...
## See Also  
 ...
 [Component Diagrams: Guidelines for Drawing](../VS_csharp/uml-component-diagrams--guidelines.md)   
 [Ensuring your Application Supports User Requirements](../VS_csharp/validate-your-system-during-development.md)   
 ...
 [Activity Diagrams: Overview](../VS_csharp/uml-activity-diagrams--reference.md)   
