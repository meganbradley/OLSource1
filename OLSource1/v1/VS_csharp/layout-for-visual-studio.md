...
The majority of Visual Studio dialogs are [utility dialogs](../VS_csharp/layout-for-visual-studio.md#BKMK_UtilityDialogLayout), which are the unthemed dialogs that follow standard [Windows Desktop dialog layout principles](https://msdn.microsoft.com/en-us/library/windows/desktop/dn742499\(v=vs.85\).aspx). As Visual Studio moves to refresh its UI, some of the more prominent dialogs have a new design that establishes them as product-defining experiences. These [signature dialogs](../VS_csharp/layout-for-visual-studio.md#BKMK_ThemedDialogLayout) have a themed appearance.  
...
-   Use the environment font for all dialog text. When writing a visual spec, specify the environment font instead of selecting a particular font and size. See [The environment font](../VS_csharp/fonts-and-formatting-for-visual-studio.md#BKMK_TheEnvironmentFont).  
...
### Utility dialog layout examples  
 ...
 ![Dialog spacing for labels above controls](../VS_csharp/media/0801-a_utilityspacingabove.png "0801-a_UtilitySpacingAbove")  
  
 **Figure 08.01-a: Spacing guidelines for utility dialogs with labels above controls**  
  
 ![Dialog spacing for labels to the left of controls](../VS_csharp/media/0801-b_utilityspacingleft.png "0801-b_UtilitySpacingLeft")  
...
-   If there are horizontal buttons that operate within the dialog, the alternate command button configuration is a vertical stack at the upper right. See [Interior command buttons](../VS_csharp/layout-for-visual-studio.md#BKMK_InteriorCommandButtons) below.  
...
-   Command buttons should be 6 pixels apart.  
 ...
 ![Basic button alignment](../VS_csharp/media/0801-c_buttonalign.png "0801-c_ButtonAlign")  
...
-   Labels are sentence case and are followed by a colon. See [Text style](../VS_csharp/fonts-and-formatting-for-visual-studio.md#BKMK_TextStyle).  
...
#### Distance between controls  
 ...
 ![Recommended distance between controls](../VS_csharp/media/0801-d_controldistance.png "0801-d_ControlDistance")  
...
#### Control indentation  
 ...
 ![Nested control alignment](../VS_csharp/media/0801-e_controlalign.png "0801-e_ControlAlign")  
...
-   Interior button size should target the standard button size of 75x23 pixels, matching the size of **OK**/**Cancel** buttons when possible. If a button label makes the button exceed the standard button size, the other buttons in that set should align with that wider size.  
 ...
 ![Horizontal OK and Cancel buttons](../VS_csharp/media/0801-f_horizokcan.png "0801-f_HorizOKCan")  
  
 **Figure 08.01-f: Vertical Interior buttons with horizontal OK/Cancel**  
  
 ![Vertical OK and Cancel buttons](../VS_csharp/media/0801-g_vertokcan.png "0801-g_VertOKCan")  
...
3.  The dialog title no longer sits in a title bar, but provides visual interest and emphasis in a larger point size. (See the font size section in [Text style](../VS_csharp/fonts-and-formatting-for-visual-studio.md#BKMK_TextStyle).)  
...
### Themed dialog layout examples  
 ![Themed dialog layout](../VS_csharp/media/0801-h_themeddialog.png "0801-h_ThemedDialog")  
  
 **Figure 08.01-h: Themed dialog**  
  
 ![Themed dialog dimensions](../VS_csharp/media/0801-i_themeddialogdimensions.png "0801-i_ThemedDialogDimensions")  
  
 **Figure 08.01-i: Themed dialog – Dimensions**  
  
 ![Themed dialog fonts](../VS_csharp/media/0801-j_themeddialogfonts.png "0801-j_ThemedDialogFonts")  
  
 **Figure 08.01-j: Themed dialog – Fonts**  
  
 ![Themed dialog colors](../VS_csharp/media/0801-k_themeddialogcolors.png "0801-k_ThemedDialogColors")  
  
 **Figure 08.01-k: Themed dialog – Colors**  
  
## See Also  
 [Application Patterns for Visual Studio](../VS_csharp/application-patterns-for-visual-studio.md)   
