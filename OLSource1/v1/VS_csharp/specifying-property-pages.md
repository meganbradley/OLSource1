...
1.  Derive your class from [ISpecifyPropertyPagesImpl](../VS_csharp/ispecifypropertypagesimpl-class.md).  
  
2.  Add an entry for **ISpecifyPropertyPages** to your class's COM map.  
  
3.  Add a [PROP_PAGE](../VS_csharp/prop_page.md) entry to the property map for each page associated with your control.  
  
> [!NOTE]
>  When generating a standard control using the [ATL Control Wizard](../VS_csharp/atl-control-wizard.md), you will only have to add the `PROP_PAGE` entries to the property map. The wizard generates the necessary code for the other steps.  
...
## Example  
 ...
 [!code[NVC_ATL_Windowing#72](../VS_csharp/codesnippet/CPP/specifying-property-pages_1.h)]  
