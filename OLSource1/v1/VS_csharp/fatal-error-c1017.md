...
```  
 ...
 To see exactly how the compiler handles preprocessor directives, use [/P](../VS_csharp/-p--preprocess-to-a-file-.md), [/E](../VS_csharp/-e--preprocess-to-stdout-.md), or [/EP](../VS_csharp/-ep--preprocess-to-stdout-without-sharpline-directives-.md).