...
-   Use the `TypeOf` operator in combination with the [Is Operator (Visual Basic)](../VS_csharp/is-operator--visual-basic-.md) to test the object with a `TypeOf`...`Is` expression.  
