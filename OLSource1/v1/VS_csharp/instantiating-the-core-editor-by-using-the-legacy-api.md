...
-   Either create your own shortcut keys, or use the system default by setting the <xref:Microsoft.VisualStudio.Shell.Interop.IVsWindowFrame*> objects display properties. To do this, call the <xref:Microsoft.VisualStudio.Shell.Interop.IVsWindowFrame.SetGuidProperty*> method with the <xref:Microsoft.VisualStudio.Shell.Interop.__VSFPROPID.VSFPROPID_InheritKeyBindings*> property.  
     ...
     To obtain and use non-standard shortcut keys, generate them using the .vsct file. For more information, see [XML-Based Command Table Configuration (.vsct) Files](../VS_csharp/visual-studio-command-table--.vsct--files.md).  
...
## How to Use an Editor factory to Obtain the Core Editor  
 ...
 For general information, see [Invoking the Core Editor](../VS_csharp/walkthrough--creating-a-core-editor-and-registering-an-editor-file-type.md).  
  
## See Also  
 [Inside the Core Editor](../VS_csharp/inside-the-core-editor.md)   
 [Opening and Saving Project Items](../VS_csharp/opening-and-saving-project-items.md)   
 [Invoking the Core Editor](../VS_csharp/walkthrough--creating-a-core-editor-and-registering-an-editor-file-type.md)