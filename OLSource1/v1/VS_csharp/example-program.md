...
```  
 ...
 The lifetime and visibility of identifiers are discussed in [Lifetime, Scope, Visibility, and Linkage](../VS_csharp/lifetime--scope--visibility--and-linkage.md). For more information on functions, see [Functions](../VS_csharp/functions--c-.md).  
