...
-   [How ODBC Works with the Database Classes](../VS_csharp/odbc-and-the-database-classes.md)  
  
-   [How ODBC Drivers Work with Dynasets](../VS_csharp/odbc-driver-requirements-for-dynasets.md)  
  
-   [What ODBC Components You Need to Redistribute with Your Applications](../VS_csharp/redistributing-odbc-components-to-your-customers.md)  
  
 You will also want to read the related topic [ODBC: The ODBC Cursor Library](../VS_csharp/odbc--the-odbc-cursor-library.md).  
...
> [!NOTE]
>  The MFC ODBC classes support Unicode and multithreading. For more information about the multithreading support, see [ODBC Classes and Threads](../VS_csharp/odbc-classes-and-threads.md)  
...
-   ODBC API  
     ...
     A library of function calls, a set of error codes, and a standard [SQL](../VS_csharp/sql.md) syntax for accessing data on DBMSs.  
...
-   ODBC database drivers  
     ...
     One or more DLLs that process ODBC function calls for specific DBMSs. For a list of supplied drivers, see [ODBC Driver List](../VS_csharp/odbc-driver-list.md).  
  
-   [ODBC Cursor Library](../VS_csharp/odbc--the-odbc-cursor-library.md)  
...
-   [ODBC Administrator](../VS_csharp/odbc-administrator.md)  
 ...
 For a list of ODBC drivers included in this version of Visual C++ and for information about obtaining additional drivers, see [ODBC Driver List](../VS_csharp/odbc-driver-list.md).  
