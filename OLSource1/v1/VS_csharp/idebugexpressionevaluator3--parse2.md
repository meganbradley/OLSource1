...
#### Parameters  
 ...
 `dwFlags`  
 [in] A collection of [PARSEFLAGS](../VS_csharp/parseflags.md) constants that determine how the expression is to be parsed.  
 ...
 `ppParsedExpression`  
 [out] Returns the parsed expression in an [IDebugParsedExpression](../VS_csharp/idebugparsedexpression.md) object.  
...
## Example  
 The following example shows how to implement this method for a **CEE** object that exposes the [IDebugExpressionEvaluator3](../VS_csharp/idebugexpressionevaluator3.md) interface.  
...
## See Also  
 [IDebugExpressionEvaluator3](../VS_csharp/idebugexpressionevaluator3.md)