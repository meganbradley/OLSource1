...
---
# Debugging Native Code
The section covers some common debugging problems and techniques for native applications. The techniques covered in this section are high-level techniques. For the mechanics of using the Visual Studio debugger, see [Debugger Roadmap](../VS_csharp/debugger-basics.md).  
...
## In This Section  
 ...
 [DebugBreak and __debugbreak](../VS_csharp/debugbreak-and-__debugbreak.md)  
 ...
 [C/C++ Assertions](../VS_csharp/c-c---assertions.md)  
 Discusses assertion statements, how they work, the benefits of using them (catching logic errors, checking results of an operation, and testing error conditions), their interaction with `_DEBUG`, and the types of assertions supported in [!INCLUDE[vsprvs](../VS_csharp/includes/vsprvs_md.md)].  
  
 [How to: Debug Inline Assembly Code](../VS_csharp/how-to--debug-inline-assembly-code.md)  
...
## Related Sections  
 [Visual C++ Project Types](../VS_csharp/debugging-preparation--visual-c---project-types.md)  
