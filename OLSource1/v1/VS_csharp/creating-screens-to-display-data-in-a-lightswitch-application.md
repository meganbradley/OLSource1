...
4.  In the **Screen Data** list, choose **NorthwindEntitiesData.Orders**, and then choose the **OK** button.  
     ...
     ![The BrowseOrders screen](../VS_csharp/media/ls_tour17.PNG "LS_Tour17")  
...
5.  Clear the **Use as Default Details Screen** check box, and then choose the **OK** button.  
     ...
     ![The ViewOrder screen.](../VS_csharp/media/ls_tour18.PNG "LS_Tour18")  
...
3.  In the `Properties` window, choose the **Item Tap: viewSelected** link.  
     ...
     ![The Edit ItemTap Action dialog box.](../VS_csharp/media/ls_tour19.PNG "LS_Tour19")  
  
4.  In the **Navigate To: (DefaultScreen)** list, choose **View Order**, and then choose the **OK** button.  
  
     ![Navigate to the ViewOrder screen.](../VS_csharp/media/ls_tour20.PNG "LS_Tour20")  
...
1.  Run the application. On the **ContactLists** screen, choose the downward arrow next to the screen title, and then choose **Browse Orders**.  
     ...
     ![The screen menu.](../VS_csharp/media/ls_tour21.PNG "LS_Tour21")  
...
## Next Steps  
 ...
 Next lesson: [Customizing Screen Appearance](../VS_csharp/customizing-screen-appearance-in-a-lightswitch-application.md)  
  
## See Also  
 [Creating Screens](../VS_csharp/creating-screens-in-lightswitch.md)   
 [Choosing a Screen Type for an HTML Client of a LightSwitch App](../VS_csharp/choosing-a-screen-type-for-an-html-client-of-a-lightswitch-app.md)   
