...
## How to Fix Violations  
 ...
 For information about how to add tier interaction data to profiling data from the Visual Studio IDE, see [How to: Collect Interaction Data for Multi-Tiered Applications](../VS_csharp/collecting-tier-interaction-data.md). For information about how to add tier interaction data from the command line, see [How to: Add Tier Interaction Data to Profiling Data From the Command Line](../VS_csharp/adding-tier-interaction-data-from-the-command-line.md).