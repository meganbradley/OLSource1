...
1.  Arrange your windows so that Spy++ and an active [Messages View](../VS_csharp/messages-view.md) window are visible.  
  
2.  From the **Search** menu, choose **Find Message**.  
  
     The [Message Search Dialog Box](../VS_csharp/message-search-dialog-box.md) opens.  
...
6.  Click **OK**.  
 ...
 If a matching message is found, it is highlighted in the Messages view window. See [Messages View](../VS_csharp/messages-view.md).