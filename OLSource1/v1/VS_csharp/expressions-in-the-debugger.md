...
## C++ Expressions  
 For information about using context operators with expressions in C++, see [Context Operator (C++)](../VS_csharp/context-operator--c---.md).  
...
## See Also  
 [Format Specifiers in C++](../VS_csharp/format-specifiers-in-c--.md)   
 [Context Operator (C++)](../VS_csharp/context-operator--c---.md)   
 [Format Specifiers in C#](../VS_csharp/format-specifiers-in-csharp.md)   
 [Pseudovariables](../VS_csharp/pseudovariables.md)