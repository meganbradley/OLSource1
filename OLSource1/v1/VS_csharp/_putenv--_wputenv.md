...
---
# _putenv, _wputenv
Creates, modifies, or removes environment variables. More secure versions of these functions are available; see [putenv_s, _wputenv_s](../VS_csharp/_putenv_s--_wputenv_s.md).  
...
## Example  
 For a sample of how to use `_putenv`, see [getenv, _wgetenv](../VS_csharp/getenv--_wgetenv.md).  
