...
|---------------|------------------|  
|`__shiftright128`|[!INCLUDE[vcprx64](../VS_csharp/includes/vcprx64_md.md)]|  
...
## Example  
 For an example, see [__shiftleft128](../VS_csharp/__shiftleft128.md).  
  
## END Microsoft Specific  
  
## See Also  
 [__shiftleft128](../VS_csharp/__shiftleft128.md)   
