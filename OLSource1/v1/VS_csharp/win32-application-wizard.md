...
-   The project includes support for neither MFC nor ATL.  
 ...
 To change these defaults, click the [Application Settings](../VS_csharp/application-settings--win-32-project-wizard.md) tab in the left column of the wizard and make the desired changes.  
  
 Once you have created a Windows desktop application, you can add generic C++ classes using the [Generic](../VS_csharp/generic-c---class-wizard.md) Code Wizard. You can add other items, such as HTML files, header files, resources, or text files.  
...
## See Also  
 [Creating an Empty Windows Desktop Application](../VS_csharp/creating-an-empty-windows-desktop-application.md)   
