 ...
 **/FC** is also needed if you want to see the full path of a file name when using the __FILE\_\_ macro.  See [Predefined Macros](../VS_csharp/predefined-macros.md) for more information on \__FILE\_\_.  
  
 The **/FC** option is implied by **/ZI**. For more information about **/ZI**, see [/Z7, /Zi, /ZI (Debug Information Format)](../VS_csharp/-z7---zi---zi--debug-information-format-.md).  
