...
## Remarks  
 An MFC application will typically create a local instance of this class in the [InitInstance](../VS_csharp/cwinapp-class.md#cwinapp__initinstance) function of its application object. This object is then passed to [CWinApp::ParseCommandLine](../VS_csharp/cwinapp-class.md#cwinapp__parsecommandline), which repeatedly calls [ParseParam](#ccommandlineinfo__parseparam) to fill the `CCommandLineInfo` object. The `CCommandLineInfo` object is then passed to [CWinApp::ProcessShellCommand](../VS_csharp/cwinapp-class.md#cwinapp__processshellcommand) to handle the command-line arguments and flags.  
...
### Example  
 [!code[NVC_MFCDocView#54](../VS_csharp/codesnippet/CPP/ccommandlineinfo-class_1.cpp)]  
...
### Example  
 [!code[NVC_MFCDocView#55](../VS_csharp/codesnippet/CPP/ccommandlineinfo-class_2.cpp)]  
...
## See Also  
 ...
 [CWinApp::ParseCommandLine](../VS_csharp/cwinapp-class.md#cwinapp__parsecommandline)   
 [CWinApp::ProcessShellCommand](../VS_csharp/cwinapp-class.md#cwinapp__processshellcommand)