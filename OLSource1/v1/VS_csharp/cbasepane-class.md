...
|Name|Description|  
|----------|-----------------|  
|`CBasePane::accHitTest`|Called by the framework to retrieve the child element or child object at a given point on the screen. (Overrides [CWnd::accHitTest](../VS_csharp/cwnd-class.md#cwnd__acchittest).)|  
|`CBasePane::accLocation`|Called by the framework to retrieve the current screen location for the specified object. (Overrides [CWnd::accLocation](../VS_csharp/cwnd-class.md#cwnd__acclocation).)|  
|[CBasePane::AccNotifyObjectFocusEvent](#cbasepane__accnotifyobjectfocusevent)|`CBasePane` does not use this method.|  
|`CBasePane::accSelect`|Called by the framework to modify the selection or move the keyboard focus of the specified object. (Overrides [CWnd::accSelect](../VS_csharp/cwnd-class.md#cwnd__accselect).)|  
...
|`CBasePane::get_accChild`|Called by the framework to retrieve the address of an `IDispatch` interface for the specified child. (Overrides [CWnd::get_accChild](../VS_csharp/cwnd-class.md#cwnd__get_accchild).)|  
|`CBasePane::get_accChildCount`|Called by the framework to retrieve the number of children that belong to this object. (Overrides [CWnd::get_accChildCount](../VS_csharp/cwnd-class.md#cwnd__get_accchildcount).)|  
|`CBasePane::get_accDefaultAction`|Called by the framework to retrieve a string that describes the default action for the object. (Overrides [CWnd::get_accDefaultAction](../VS_csharp/cwnd-class.md#cwnd__get_accdefaultaction).)|  
|`CBasePane::get_accDescription`|Called by framework to retrieve a string that describes the visual appearance of the specified object. (Overrides [CWnd::get_accDescription](../VS_csharp/cwnd-class.md#cwnd__get_accdescription).)|  
|`CBasePane::get_accFocus`|Called by the framework to retrieve the object that has the keyboard focus. (Overrides [CWnd::get_accFocus](../VS_csharp/cwnd-class.md#cwnd__get_accfocus).)|  
|`CBasePane::get_accHelp`|Called by the framework to retrieve a  Help property string for the object. (Overrides [CWnd::get_accHelp](../VS_csharp/cwnd-class.md#cwnd__get_acchelp).)|  
|[CBasePane::get_accHelpTopic](#cbasepane__get_acchelptopic)|Called by the framework to retrieve the full path of the WinHelp file that is associated with the specified object and the identifier of the appropriate topic in that file. (Overrides [CWnd::get_accHelpTopic](../VS_csharp/cwnd-class.md#cwnd__get_acchelptopic).)|  
|`CBasePane::get_accKeyboardShortcut`|Called by the framework to retrieve the specified shortcut key for the object. (Overrides [CWnd::get_accKeyboardShortcut](../VS_csharp/cwnd-class.md#cwnd__get_acckeyboardshortcut).)|  
|`CBasePane::get_accName`|Called by the framework to retrieve the name of the specified object. (Overrides [CWnd::get_accName](../VS_csharp/cwnd-class.md#cwnd__get_accname).)|  
|`CBasePane::get_accParent`|Called by the framework to retrieve the `IDispatch` interface for the parent of the object. (Overrides [CWnd::get_accParent](../VS_csharp/cwnd-class.md#cwnd__get_accparent).)|  
|`CBasePane::get_accRole`|Called by the framework to retrieve information that describes the role of the specified object. (Overrides [CWnd::get_accRole](../VS_csharp/cwnd-class.md#cwnd__get_accrole).)|  
|[CBasePane::get_accSelection](#cbasepane__get_accselection)|Called by the framework to retrieve the selected children of this object. (Overrides [CWnd::get_accSelection](../VS_csharp/cwnd-class.md#cwnd__get_accselection).)|  
|`CBasePane::get_accState`|Called by the framework to retrieve the current state of the specified object. (Overrides [CWnd::get_accState](../VS_csharp/cwnd-class.md#cwnd__get_accstate).)|  
|`CBasePane::get_accValue`|Called by the framework to retrieve the value of the specified object. (Overrides [CWnd::get_accValue](../VS_csharp/cwnd-class.md#cwnd__get_accvalue).)|  
...
|[CBasePane::GetPaneRow](#cbasepane__getpanerow)|Returns a pointer to the [CDockingPanesRow](../VS_csharp/cdockingpanesrow-class.md)object where the pane is docked.|  
...
|`CBasePane::Serialize`|Reads or writes this object from or to an archive. (Overrides [CObject::Serialize](../VS_csharp/cobject-class.md#cobject__serialize).)|  
...
## Remarks  
 If you want to create a pane class that supports the extended docking features available in MFC, you must derive it from `CBasePane` or from [CPane](../VS_csharp/cpane-class.md).  
  
## Customization Tips  
 The following customization tips pertain to the [CBasePane Class](../VS_csharp/cbasepane-class.md) and any classes that inherit from it:  
...
-   If you want to create a non-floating resizable pane, create it without the `AFX_CBRS_FLOAT` style and call [CFrameWnd::DockControlBar](../VS_csharp/cframewnd-class.md#cframewnd__dockcontrolbar).  
...
-   If you want to float or undock a pane that is in auto-hide mode, you must call [CDockablePane::SetAutoHideMode](../VS_csharp/cdockablepane-class.md#cdockablepane__setautohidemode) with `FALSE` as the first argument before you call [CBasePane::FloatPane](#cbasepane__floatpane) or [CBasePane::UnDockPane](#cbasepane__undockpane).  
  
## Example  
 The following example demonstrates how to use various methods in the `CBasePane` class. The example demonstrates how to retrieve a pane from the `CFrameWndEx` class and how to set the docking mode, the pane alignment, and the pane style. The code is from the [Word Pad sample](../VS_csharp/visual-c---samples.md).  
  
 [!code[NVC_MFC_WordPad#2](../VS_csharp/codesnippet/CPP/cbasepane-class_1.cpp)]  
...
### Remarks  
 ...
 For more information, see [CBCGPDockManager](../VS_csharp/cdockingmanager-class.md) and [CMDIFrameWndEx::AddControlBar](../VS_csharp/cmdiframewndex-class.md#cmdiframewndex__addpane).  
...
### Remarks  
 ...
 For more information, see [CDockingManager::AdjustDockingLayout](../VS_csharp/cdockingmanager-class.md#cdockingmanager__adjustdockinglayout)  
...
### Remarks  
 See the remarks section in [CControlBar::CalcFixedLayout](../VS_csharp/ccontrolbar-class.md#ccontrolbar__calcfixedlayout)  
...
### Remarks  
 Only objects of certain `CBasePane`-derived types, such as the [CDockablePane Class](../VS_csharp/cdockablepane-class.md), can be converted to tabbed documents.  
...
### Parameters  
 [in] `dwStyleEx`  
 The extended styles (see [CWnd::CreateEx](../VS_csharp/cwnd-class.md#cwnd__createex) for more information).  
 ...
 [in] `dwStyle`  
 The window style (see [CWnd::CreateEx](../VS_csharp/cwnd-class.md#cwnd__createex)).  
...
|`AFX_CBRS_REGULAR_TABS`|When one pane docks to another pane that has this style, a regular tabbed window is created. (For more information, see [CBCGTabbedControlBar](../VS_csharp/ctabbedpane-class.md).)|  
|`AFX_CBRS_OUTLOOK_TABS`|When one pane docks to another pane that has this style, an Outlook-style tabbed window is created. (For more information, see [CBCGPOutlookBar](../VS_csharp/cmfcoutlookbar-class.md).)|  
...
### Remarks  
 Call this function to dock a pane to another pane or a dock bar ( [BCGPDockBar](../VS_csharp/cdocksite-class.md)) that is specified by `pDockBar`, or to a main frame if `pDockBar` is `NULL`.  
  
 `dockMethod` specifies how the pane is docked. See [CPane::DockPane](../VS_csharp/cpane-class.md#cpane__dockpane) for a list of possible values.  
...
### Remarks  
 This method fails if a pane divider ( [CPaneDivider Class](../VS_csharp/cpanedivider-class.md)) cannot be created. Otherwise, it always returns `TRUE`.  
...
### Remarks  
 ...
 We recommend that you override this method and return `FALSE` for non-floating panes derived from [CBCGPDockingControlBar](../VS_csharp/cdockablepane-class.md).  
...
### Remarks  
 The default implementation calls the current visual manager to fill the background ( [CMFCVisualManager::OnFillBarBackground](../VS_csharp/cmfcvisualmanager-class.md#cmfcvisualmanager__onfillbarbackground)).  
...
##  <a name="cbasepane__getdocksiteframewnd"></a>  CBasePane::GetDockSiteFrameWnd  
 Returns a pointer to the [CDockingPanesRow](../VS_csharp/cdockingpanesrow-class.md)object where the pane is docked.  
...
### Remarks  
 The default implementation calls [CWnd::GetIcon](../VS_csharp/cwnd-class.md#cwnd__geticon).  
...
### Remarks  
 Call this method to access the row where a pane is docked. For example, to arrange the panes in a particular row, call `GetPaneRow` and then call [CDockingPanesRow::ArrangePanes](../VS_csharp/cdockingpanesrow-class.md#cdockingpanesrow__arrangepanes).  
...
### Remarks  
 Call this function to retrieve a pointer to the parent mini-frame window. This method iterates through all parents and checks for an object derived from [CPaneFrameWnd Class](../VS_csharp/cpaneframewnd-class.md).  
...
### Remarks  
 Use this function to retrieve a pointer to the parent tabbed window. Sometimes it is not enough to call `GetParent`, because a pane may be inside a docking wrapper ( [CBCGPDockingCBWrapper](../VS_csharp/cdockablepaneadapter-class.md)) or inside a pane adapter ( [CDockablePaneAdapter](../VS_csharp/cdockablepaneadapter-class.md)). By using `GetParentTabWnd` you will be able to retrieve a valid pointer in those cases (assuming that the parent is a tabbed window).  
...
### Remarks  
 Panes of [CDockablePane Class](../VS_csharp/cdockablepane-class.md) can be resized.  
  
 The status bar ( [CBCGPStatusBar](../VS_csharp/cmfcstatusbar-class.md)) and the dock bar ( [CBCGPDockBar](../VS_csharp/cdocksite-class.md)) cannot be resized.  
...
### Remarks  
 This method retrieves a pointer to the immediate parent and determines if the parent's runtime class is [CBCGPBaseTabWnd](../VS_csharp/cmfcbasetabctrl-class.md).  
...
### Return Value  
 A pointer to the default [CFont Class](../VS_csharp/cfont-class.md) object.  
...
### Remarks  
 ...
 Initially, the docking mode is defined globally by [CDockingManager::m_dockModeGlobal](../VS_csharp/cdockingmanager-class.md#cdockingmanager__m_dockmodeglobal). You can set the docking mode for each pane individually using the `SetDockingMode` method.  
...
### Parameters  
 [in] `pWndInsertAfter`  
 Identifies the `CWnd` object that comes before this `CWnd` object in the Z-order. For more information, see [CWnd::SetWindowPos](../VS_csharp/cwnd-class.md#cwnd__setwindowpos).  
 ...
 [in] `nFlags`  
 Specifies size and position options. For more information, see [CWnd::SetWindowPos](../VS_csharp/cwnd-class.md#cwnd__setwindowpos).  
...
### Remarks  
 If `pWndInsertAfter` is `NULL`, this method calls [CWnd::SetWindowPos](../VS_csharp/cwnd-class.md#cwnd__setwindowpos). If `pWndInsertAfter` is non- `NULL`, this method calls `DeferWindowPos`.  
...
## See Also  
 ...
 [CPane](../VS_csharp/cbasepane-class.md)   
 [CWnd](../VS_csharp/cwnd-class.md)