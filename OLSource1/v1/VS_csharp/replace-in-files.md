...
## Find options  
 ...
 When this check box is selected, you can use special notations to define patterns of text in the **Find what** or **Replace with** text boxes. For a list of these notations, see [Using Regular Expressions in Visual Studio](../VS_csharp/using-regular-expressions-in-visual-studio.md).  
...
## See Also  
 ...
 [Find in Files Tab, Find and Replace Window](../VS_csharp/find-in-files.md)   
