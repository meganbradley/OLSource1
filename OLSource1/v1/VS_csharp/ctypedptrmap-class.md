...
## Remarks  
 ...
 For more information on using `CTypedPtrMap`, see the articles [Collections](../VS_csharp/collections.md) and [Template-Based Classes](../VS_csharp/template-based-classes.md).  
...
### Remarks  
 For more detailed remarks, see [CMapStringToOb::RemoveKey](../VS_csharp/cmapstringtoob-class.md#cmapstringtoob__removekey).  
...
### Remarks  
 For more detailed remarks, see [CMapStringToOb::SetAt](../VS_csharp/cmapstringtoob-class.md#cmapstringtoob__setat).  
