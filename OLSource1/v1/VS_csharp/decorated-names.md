...
-   #### To use a listing to view decorated names  
    ...
    1.  Generate a listing by compiling the source file that contains the data, object, or function definition or prototype with the [Listing File Type](../VS_csharp/-fa---fa--listing-file-.md) compiler option set to Assembly with Source Code (**/FAs**).  
...
## See Also  
 ...
 [Using extern to Specify Linkage](../VS_csharp/using-extern-to-specify-linkage.md)