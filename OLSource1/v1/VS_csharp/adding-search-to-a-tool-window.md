...
1.  Create a VSIX project named `TestToolWindowSearch` with a tool window named **TestSearch**. If you need help doing this, see [Creating an Extension with a Tool Window](../VS_csharp/creating-an-extension-with-a-tool-window.md).  
...
4.  Remove the `button1_Click()` method.  
    ...
    ```  
     ...
     [!code[ToolWindowSearch#1](../VS_csharp/codesnippet/CSharp/adding-search-to-a-tool-window_1.cs)]
[!code[ToolWindowSearch#1](../VS_csharp/codesnippet/VisualBasic/adding-search-to-a-tool-window_1.vb)]  
