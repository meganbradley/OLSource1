...
## Remarks  
 Visual Basic always performs exponentiation in the [Double Data Type (Visual Basic)](../VS_csharp/double-data-type--visual-basic-.md).  
...
## Example  
 ...
 [!code[VbVbalrOperators#20](../VS_csharp/codesnippet/VisualBasic/^-operator--visual-basic-_1.vb)]  
