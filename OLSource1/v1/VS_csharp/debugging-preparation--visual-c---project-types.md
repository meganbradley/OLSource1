...
This section describes how to debug the basic project types created by the [!INCLUDE[vcprvc](../VS_csharp/includes/vcprvc_md.md)] project templates.  
...
##  <a name="BKMK_Recommended_Property_Settings"></a> Recommended property settings  
 Certain properties should be set the same way for all unmanaged debugging scenarios. The following tables display recommended property settings. Settings not listed here may vary among the different unmanaged project types. For more information, see [Project Settings for a C++ Debug Configuration](../VS_csharp/project-settings-for-a-c---debug-configuration.md)  
...
|**Generate debugging information**|You should always set this option to **Yes (/DEBUG)** to create debugging symbols and files needed for debugging. When the application goes into production, you can set it to off.|  
 ...
 [In this topic](../VS_csharp/debugging-preparation--visual-c---project-types.md#BKMK_In_this_topic)  
  
##  <a name="BKMK_Win32_Projects"></a> Win32 projects  
 Win32 applications are traditional Windows programs written in C or C++. Debugging this type of application in [!INCLUDE[vsprvs](../VS_csharp/includes/vsprvs_md.md)] is straightforward.  
 ...
 The following procedure explains how to debug a Win32 project from within [!INCLUDE[vsprvs](../VS_csharp/includes/vsprvs_md.md)]. Another way to debug a Win32 application is to start the application outside of [!INCLUDE[vsprvs](../VS_csharp/includes/vsprvs_md.md)] and attach to it. For more information, see [Attaching to Running Processes](../VS_csharp/attach-to-running-processes-with-the-visual-studio-debugger.md).  
...
3.  Debug using the techniques discussed in [Debugger Roadmap](../VS_csharp/debugger-basics.md).  
...
6.  Open the **Linker** node, and select **Debugging**. In the first **Generate** row, select **Yes (/DEBUG)** from the drop-down list. Always set this when you are debugging.  
 ...
 For more information, see[Project Settings for a C++ Debug Configuration](../VS_csharp/project-settings-for-a-c---debug-configuration.md).  
  
 [In this topic](../VS_csharp/debugging-preparation--visual-c---project-types.md#BKMK_In_this_topic)  
  
##  <a name="BKMK_Windows_Forms_Applications___NET_"></a> Windows Forms applications (.NET)  
 The **Windows Forms Application (.NET)** template creates a [!INCLUDE[vcprvc](../VS_csharp/includes/vcprvc_md.md)] Windows Forms application. For more information, see [How to: Create a Windows Application Project](assetId:///b2f93fed-c635-4705-8d0e-cf079a264efa).  
  
 Debugging this type of application in [!INCLUDE[vsprvs](../VS_csharp/includes/vsprvs_md.md)] is similar to that in managed Windows Forms applications.  
 ...
 Another way to debug a Windows Forms application is to start the application outside of [!INCLUDE[vsprvs](../VS_csharp/includes/vsprvs_md.md)] and attach to it. For more information, see [Attaching to a Running Program or Multiple Programs](../VS_csharp/attach-to-running-processes-with-the-visual-studio-debugger.md).  
...
## See Also  
 ...
 [Attaching to a Running Program or Multiple Programs](../VS_csharp/attach-to-running-processes-with-the-visual-studio-debugger.md)   
 [Debug and Release Configurations](../VS_csharp/how-to--set-debug-and-release-configurations.md)   
