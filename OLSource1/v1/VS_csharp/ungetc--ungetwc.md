...
## Remarks  
 ...
 These functions are thread-safe and lock sensitive data during execution. For a non-locking version, see [_ungetc_nolock, _ungetwc_nolock](../VS_csharp/_ungetc_nolock--_ungetwc_nolock.md).  
