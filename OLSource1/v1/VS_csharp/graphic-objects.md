...
|-----------|-------------------------|  
|[CPen](../VS_csharp/cpen-class.md)|`HPEN`|  
|[CBrush](../VS_csharp/cbrush-class.md)|`HBRUSH`|  
|[CFont](../VS_csharp/cfont-class.md)|**HFONT**|  
|[CBitmap](../VS_csharp/cbitmap-class.md)|`HBITMAP`|  
|[CPalette](../VS_csharp/cpalette-class.md)|`HPALETTE`|  
|[CRgn](../VS_csharp/crgn-class.md)|**HRGN**|  
  
> [!NOTE]
>  The class [CImage](../VS_csharp/cimage-class.md) provides enhanced bitmap support.  
 ...
 [!code[NVC_MFCDocViewSDI#5](../VS_csharp/codesnippet/CPP/graphic-objects_1.cpp)]  
  
#### To create a graphic object in a device context  
  
1.  Define a graphic object on the stack frame. Initialize the object with the type-specific create function, such as `CreatePen`. Alternatively, initialize the object in the constructor. See the discussion of [one-stage and two-stage creation](../VS_csharp/one-stage-and-two-stage-construction-of-objects.md), which provides example code.  
  
2.  [Select the object into the current device context](../VS_csharp/selecting-a-graphic-object-into-a-device-context.md), saving the old graphic object that was selected before.  
...
-   [Example of constructing a pen in one and two stages](../VS_csharp/one-stage-and-two-stage-construction-of-objects.md)  
  
-   [Selecting a Graphic Object into a Device Context](../VS_csharp/selecting-a-graphic-object-into-a-device-context.md)  
  
-   [Device contexts](../VS_csharp/device-contexts.md)  
  
-   [CImage limitations with earlier operating systems](../VS_csharp/cimage-limitations-with-earlier-operating-systems.md)  
