...
## In This Section  
 [Migrating a Legacy Language Service](../VS_csharp/migrating-a-legacy-language-service.md)  
 Explains how to update a language service from Visual Studio 2008 to the latest version.  
  
 [Language Services Essentials](../VS_csharp/legacy-language-service-essentials.md)  
 ...
 [Managed-Code Language Services with the MPF](../VS_csharp/implementing-a-legacy-language-service1.md)  
...
## Related Sections  
 [Visual Studio Editors](../VS_csharp/editor-and-language-service-extensions.md)  
