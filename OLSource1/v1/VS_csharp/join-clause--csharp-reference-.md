...
## Inner Join  
 ...
 For more information, see [How to: Perform Inner Joins](../VS_csharp/how-to--perform-inner-joins--csharp-programming-guide-.md).  
...
## Group Join  
 ...
 For more information, see [How to: Perform Grouped Joins](../VS_csharp/how-to--perform-grouped-joins--csharp-programming-guide-.md).  
...
## Left Outer Join  
 ...
 For more information, see [How to: Perform Left Outer Joins](../VS_csharp/how-to--perform-left-outer-joins--csharp-programming-guide-.md).  
...
## Joins on object collections vs. relational tables  
 ...
 For more information about querying across related tables in the context of [!INCLUDE[vbtecdlinq](../VS_csharp/includes/vbtecdlinq_md.md)], see [How to: Map Database Relationships](../Topic/How%20to:%20Map%20Database%20Relationships.md).  
  
## Composite Keys  
 You can test for equality of multiple values by using a composite key. For more information, see [How to: Join by Using Composite Keys](../VS_csharp/how-to--join-by-using-composite-keys--csharp-programming-guide-.md). Composite keys can be also used in a `group` clause.  
...
## See Also  
 ...
 [How to: Perform Grouped Joins](../VS_csharp/how-to--perform-grouped-joins--csharp-programming-guide-.md)   
 [How to: Order the Results of a Join Clause](../VS_csharp/how-to--order-the-results-of-a-join-clause--csharp-programming-guide-.md)   
 [How to: Join by Using Composite Keys](../VS_csharp/how-to--join-by-using-composite-keys--csharp-programming-guide-.md)   
