...
#### Parameters  
 `ppMemoryBytes`  
 [out] Returns an [IDebugMemoryBytes2](../VS_csharp/idebugmemorybytes2.md) object that can be used to retrieve the memory that contains the value of the property.  
