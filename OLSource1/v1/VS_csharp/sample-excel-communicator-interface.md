...
## IExcelUICommunication Interface  
 This interface defines the communication points between the `CodedUIExtension`, which runs in the Coded UI Test process, and the `ExcelCodedUIAddIn`, which runs in the [!INCLUDE[ofprexcel](../VS_csharp/includes/ofprexcel_md.md)] process.  
...
## See Also  
 ...
 [Sample Excel Add-In for Coded UI Testing](../VS_csharp/sample-excel-add-in-for-coded-ui-testing.md)   
 [Sample Coded UI Test Extension for Excel](../VS_csharp/sample-coded-ui-test-extension-for-excel.md)