...
The following instructions and examples show you how to catch and delete exceptions. For more information on the **try**, **catch**, and `throw` keywords, see [C++ Exception Handling](../VS_csharp/c---exception-handling.md).  
...
-   The **catch** block throws a new exception.  
     ...
     [!code[NVC_MFCExceptions#3](../VS_csharp/codesnippet/CPP/exceptions--catching-and-deleting-exceptions_1.cpp)]  
...
1.  Use the **try** keyword to set up a **try** block. Execute any program statements that might throw an exception within a **try** block.  
     ...
     [!code[NVC_MFCExceptions#4](../VS_csharp/codesnippet/CPP/exceptions--catching-and-deleting-exceptions_2.cpp)]  
     ...
     [!code[NVC_MFCExceptions#5](../VS_csharp/codesnippet/CPP/exceptions--catching-and-deleting-exceptions_3.cpp)]  
  
 For more information, see [Exceptions: Converting from MFC Exception Macros](../VS_csharp/exceptions--converting-from-mfc-exception-macros.md).  
