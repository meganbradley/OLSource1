...
-   For a summary of the model types, see [Model Element Types](../VS_csharp/uml-model-element-types.md).  
  
-   For full details of the API, see [API Reference for Modeling Extensibility](../VS_csharp/api-reference-for-uml-modeling-extensibility.md).  
...
### Relationships  
 ...
 For more information about traversing relationships, see [How to: Navigate Relationships with the UML API](../VS_csharp/navigate-relationships-with-the-uml-api.md).  
...
### The Ownership Tree  
 ...
 Every model element is created with an Owner. For more information, see [How to Create Elements and Relationships](../VS_csharp/create-elements-and-relationships-in-uml-models.md).  
  
 ![Class diagram: Model, Diagram, Shape, and Element](../VS_csharp/media/uml_mm1.png "UML_MM1")  
...
## Shapes and Diagrams  
 ...
 For more information about shapes, see [How to: Display a Model on Diagrams](../VS_csharp/display-a-uml-model-on-diagrams.md).  
  
## Access to the Model in Extensions  
 In [!INCLUDE[vsprvs](../VS_csharp/includes/vsprvs_md.md)] extensions defined as MEF Components, you can declare properties that import information from the context in which the extension runs.  
  
|Attribute type|What this provides access to|More information|  
|--------------------|----------------------------------|----------------------|  
|Microsoft.VisualStudio.ArchitectureTools.Extensibility.Presentation<br /><br /> .IDiagramContext<br /><br /> (in Microsoft.VisualStudio.ArchitectureTools.Extensibility.dll)|The current focus diagram.|[How to: Define a Command on a Modeling Diagram](../VS_csharp/define-a-menu-command-on-a-modeling-diagram.md)|  
|Microsoft.VisualStudio.Modeling.ExtensionEnablement<br /><br /> .ILinkedUndoContext<br /><br /> (in Microsoft.VisualStudio.Modeling.Sdk.[version].dll)|Allows you to group changes into transactions.|[How to: Link Model Updates using Transactions](../VS_csharp/link-uml-model-updates-by-using-transactions.md)|  
|Microsoft.VisualStudio.Shell .SVsServiceProvider<br /><br /> (in Microsoft.VisualStudio.Shell.Immutable.[version].dll)|The host [!INCLUDE[vsprvs](../VS_csharp/includes/vsprvs_md.md)]. From there you can access files, projects and other aspects.|[How to: Open a UML model](../VS_csharp/open-a-uml-model-by-using-the-visual-studio-api.md)|  
...
-   Use [!INCLUDE[vsprvs](../VS_csharp/includes/vsprvs_md.md)] model bus to create links between elements in different models. For more information, see [How to Open a UML Model using Model Bus](../VS_csharp/integrate-uml-models-with-other-models-and-tools.md).  
  
-   Load a modeling project and diagrams in read-only mode without making it visible in the [!INCLUDE[vsprvs](../VS_csharp/includes/vsprvs_md.md)] user interface. For more information, see [How to Read a UML Model in Program Code](../VS_csharp/read-a-uml-model-in-program-code.md).  
  
-   Open a modeling project and its diagrams in [!INCLUDE[vsprvs](../VS_csharp/includes/vsprvs_md.md)], and then access the contents. For more information, see [How to Open a UML Model by using the Visual Studio API](../VS_csharp/open-a-uml-model-by-using-the-visual-studio-api.md).  
