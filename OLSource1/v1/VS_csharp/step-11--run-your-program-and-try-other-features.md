...
2.  Before you open a picture, choose the **Set the background color** button. The **Color** dialog box opens.  
     ...
     ![Color dialog box](../VS_csharp/media/express_colordialog.png "Express_ColorDialog")  
Color dialog box  
...
-   To learn more about programming in Visual Studio, see [Programming Concepts](../VS_csharp/programming-concepts.md).  
  
-   To learn more about Visual Basic, see [Developing Applications with Visual Basic](../VS_csharp/developing-applications-with-visual-basic.md).  
  
-   To learn more about Visual C#, see [Introduction to the C# Language and the .NET Framework](../VS_csharp/introduction-to-the-csharp-language-and-the-.net-framework.md).  
  
-   To go to the next tutorial, see [Tutorial 2: Create a Math Quiz](../VS_csharp/tutorial-2--create-a-timed-math-quiz.md).  
  
-   To return to the previous tutorial step, see [Step 10: Create Additional Buttons and a Check Box](../VS_csharp/step-10--write-code-for-additional-buttons-and-a-check-box.md).