...
## Remarks  
 ...
 For more information about the `BITMAPINFO` structure and appropriate values for members of the `BITMAPINFOHEADER` and `RGBQUAD` structures, see the following topics in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)] documentation.  
