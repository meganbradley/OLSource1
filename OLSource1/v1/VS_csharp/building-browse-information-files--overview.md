...
To create browse information for symbol browsing, the compiler creates an .sbr file for each source file in your project, then BSCMAKE.EXE concatenates the .sbr files into one .bsc file.  
 ...
 Use [/FR](../VS_csharp/-fr---fr--create-.sbr-file-.md) or [/Fr](../VS_csharp/-fr---fr--create-.sbr-file-.md) to tell the compiler to create .sbr files. To create .bsc files, you can call [BSCMAKE](../VS_csharp/bscmake-command-line.md) from the command line. Using BSCMAKE from the command line gives you more precise control over the manipulation of browse information files. See [BSCMAKE Reference](../VS_csharp/bscmake-reference.md) for more information.  
...
>  You can turn on .sbr file generation but leave .bsc file generation turned off. This provides fast builds but also enables you to create a fresh .bsc file quickly by turning on .bsc file generation and building the project.  
 ...
 See [General Property Page (Project)](../VS_csharp/general-property-page--project-.md) for information on how to build a browser file in the development environment.  
  
### To create a smaller .bsc file  
  
1.  Use [BSCMAKE command-line options](../VS_csharp/bscmake-options.md) to exclude information from the browse information file.  
