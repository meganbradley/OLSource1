...
-   [Use a .def file so I can export by ordinal](../VS_csharp/exporting-from-a-dll-using-def-files.md)  
  
-   [Use __declspec(dllexport)](../VS_csharp/exporting-from-a-dll-using-__declspec-dllexport-.md)  
