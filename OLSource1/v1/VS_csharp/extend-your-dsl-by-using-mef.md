...
9. Review and update the other fields of **source.extension.vsixmanifest**. Click **Select Editions** and verify that the correct [!INCLUDE[vsprvs](../VS_csharp/includes/vsprvs_md.md)] editions are set.  
...
11. To test the extension, press **F5**. In the experimental instance of [!INCLUDE[vsprvs](../VS_csharp/includes/vsprvs_md.md)], create or open an example file of the DSL.  
...
### Gesture Handlers  
 A gesture handler can deal with objects dragged onto the diagram from anywhere, inside or outside [!INCLUDE[vsprvs](../VS_csharp/includes/vsprvs_md.md)]. The following example lets the user drag files from Windows Explorer onto the diagram. It creates elements that contain the file names.  
  
 You can write handlers to deal with drags from other DSL models and UML models. For more information, see [How to Add a Drag-and-Drop Handler](../VS_csharp/how-to--add-a-drag-and-drop-handler.md).  
...
### Validation constraints  
 ...
 For more information, see [Validation in a Domain-Specific Language](../VS_csharp/validation-in-a-domain-specific-language.md).  
...
## See Also  
 ...
 [Validation in a Domain-Specific Language](../VS_csharp/validation-in-a-domain-specific-language.md)