...
## Remarks  
 ...
 ATL objects normally acquire a class factory by deriving from [CComCoClass](../VS_csharp/ccomcoclass-class.md). This class includes the macro [DECLARE_CLASSFACTORY](../VS_csharp/declare_classfactory.md), which declares `CComClassFactory` as the default class factory. To override this default, specify one of the `DECLARE_CLASSFACTORY`*XXX* macros in your class definition. For example, the [DECLARE_CLASSFACTORY_EX](../VS_csharp/declare_classfactory_ex.md) macro uses the specified class for the class factory:  
  
 [!code[NVC_ATL_COM#8](../VS_csharp/codesnippet/CPP/ccomclassfactory-class_1.h)]  
...
-   [DECLARE_CLASSFACTORY2](../VS_csharp/declare_classfactory2.md) Uses [CComClassFactory2](../VS_csharp/ccomclassfactory2-class.md), which controls creation through a license.  
  
-   [DECLARE_CLASSFACTORY_AUTO_THREAD](../VS_csharp/declare_classfactory_auto_thread.md) Uses [CComClassFactoryAutoThread](../VS_csharp/ccomclassfactoryautothread-class.md), which creates objects in multiple apartments.  
  
-   [DECLARE_CLASSFACTORY_SINGLETON](../VS_csharp/declare_classfactory_singleton.md) Uses [CComClassFactorySingleton](../VS_csharp/ccomclassfactorysingleton-class.md), which constructs a single [CComObjectGlobal](../VS_csharp/ccomobjectglobal-class.md) object.  
...
### Remarks  
 **_Module** refers to the global instance of [CComModule](../VS_csharp/ccommodule-class.md) or a class derived from it.  
