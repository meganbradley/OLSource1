...
## Members  
 dwFields  
 A combination of flags from he [CONTEXT_INFO_FIELDS](../VS_csharp/context_info_fields.md) enumeration that specifies which fields are filled out**.**  
 ...
 posFunctionOffset  
 A [TEXT_POSITION](../VS_csharp/text_position.md) structure that identifies the line and column offset of the function associated with the code context.  
...
## Remarks  
 This structure is returned from a call to the [GetInfo](../VS_csharp/idebugmemorycontext2--getinfo.md) method.  
...
## See Also  
 ...
 [GetInfo](../VS_csharp/idebugmemorycontext2--getinfo.md)   
