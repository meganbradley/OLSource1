...
To see an existing type and its members, add its shape to a class diagram.  
 ...
 To design new types on class diagrams, see [How to: Create Types on Class Diagrams](../VS_csharp/how-to--create-types-by-using-class-designer.md).  
  
### To see types in a project on a class diagram  
  
1.  From a project in Solution Explorer, open an existing class diagram (.cd) file. Or if no class diagram exists, add a new class diagram to the project. See [How to Add Class Diagrams to Projects](../VS_csharp/how-to--add-class-diagrams-to-projects--class-designer-.md).  
...
## See Also  
 ...
 [How to: Customize Class Diagrams (Class Designer)](../VS_csharp/how-to--customize-class-diagrams--class-designer-.md)   
