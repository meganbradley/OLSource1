...
|Element|Description|  
|-------------|-----------------|  
|[Project](../VS_csharp/project-element--visual-studio-templates-.md)|Specifies the files or directories to add to the project.|  
...
2.  Open the project file (.vbproj for a [!INCLUDE[vbprvb](../VS_csharp/includes/vbprvb_md.md)] project) in a text editor or [!INCLUDE[vsprvs](../VS_csharp/includes/vsprvs_md.md)].  
...
4.  Replace the line of code with the following XML:  
    ...
    ```  
     ...
     When a project is created from this template, the file name will be based on the name the user entered in the **New Project** dialog box, with all unsafe characters and spaces removed. For more information, see [Template Parameters](../VS_csharp/template-parameters.md).  
...
## See Also  
 ...
 [ProjectItem Element (Visual Studio Templates)](../VS_csharp/projectitem-element--visual-studio-item-templates-.md)