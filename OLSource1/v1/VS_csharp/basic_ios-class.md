...
---
# basic_ios Class
The template class describes the storage and member functions common to both input streams (of template class [basic_istream](../VS_csharp/basic_istream-class.md)) and output streams (of template class [basic_ostream](../VS_csharp/basic_ostream-class.md)) that depend on the template parameters. (The class [ios_base](../VS_csharp/ios_base-class.md) describes what is common and not dependent on template parameters.) An object of class **basic_ios<class Elem, class Traits>** helps control a stream with elements of type **Elem**, whose character traits are determined by the class **Traits**.  
...
-   A tie pointer to an object of type [basic_istream](../VS_csharp/basic_istream-class.md)**<Elem, Traits>**.  
  
-   A stream buffer pointer to an object of type [basic_streambuf](../VS_csharp/basic_streambuf-class.md)**<Elem, Traits >**.  
  
-   [Formatting information](../VS_csharp/ios_base-class.md).  
  
-   [Stream state information](../VS_csharp/ios_base-class.md) in a base object of type [ios_base](../VS_csharp/ios_base-class.md).  
...
### Return Value  
 ...
 For more information on `badbit`, see [ios_base::iostate](../VS_csharp/ios_base-class.md#ios_base__iostate).  
...
### Remarks  
 ...
 If `state`**&**[exceptions](#basic_ios__exceptions) is nonzero, it then throws an object of class [failure](../VS_csharp/ios_base-class.md#ios_base__failure).  
  
### Example  
  See [rdstate](#basic_ios__rdstate) and [getline](../VS_csharp/-string--functions.md#getline_template_function) for examples using **clear**.  
...
### Remarks  
 The member function returns `true` if [rdstate](#basic_ios__rdstate) `& eofbit` is nonzero. For more information on `eofbit`, see [ios_base::iostate](../VS_csharp/ios_base-class.md#ios_base__iostate).  
...
### Return Value  
 ...
 For more information on `failbit`, see [ios_base::iostate](../VS_csharp/ios_base-class.md#ios_base__iostate).  
...
### Return Value  
 ...
 For more information on `goodbit`, see [ios_base::iostate](../VS_csharp/ios_base-class.md#ios_base__iostate).  
...
### Remarks  
 ...
 `rdbuf`->                        [pubimbue](../VS_csharp/basic_streambuf-class.md#basic_streambuf__pubimbue)(_ *Loc*)  
  
 In any case, it returns [ios_base::imbue](../VS_csharp/ios_base-class.md#ios_base__imbue)(_ *Loc*).  
...
-   [rdstate](#basic_ios__rdstate) returns [goodbit](../VS_csharp/ios_base-class.md#ios_base__iostate) if `_Sb` is nonzero; otherwise, it returns [badbit](../VS_csharp/ios_base-class.md#ios_base__iostate).  
  
-   [exceptions](#basic_ios__exceptions) returns **goodbit**.  
  
-   [flags](../VS_csharp/ios_base-class.md#ios_base__flags) returns [skipws](../VS_csharp/ios_base-class.md#ios_base__fmtflags) &#124;                                 [dec](../VS_csharp/ios_base-class.md#ios_base__fmtflags).  
  
-   [width](../VS_csharp/ios_base-class.md#ios_base__width) returns 0.  
  
-   [precision](../VS_csharp/ios_base-class.md#ios_base__precision) returns 6.  
  
-   [fill](#basic_ios__fill) returns the space character.  
  
-   [getloc](../VS_csharp/ios_base-class.md#ios_base__getloc) returns `locale::classic`.  
  
-   [iword](../VS_csharp/ios_base-class.md#ios_base__iword) returns zero, and [pword](../VS_csharp/ios_base-class.md#ios_base__pword) returns a null pointer for all argument values.  
...
### Remarks  
 The member function returns [use_facet](../VS_csharp/basic_filebuf-class.md#basic_filebuf__open)**<**Â **ctype**<                        **E**> >(                         [getloc](../VS_csharp/ios_base-class.md#ios_base__getloc)( ) ).                         `narrow`(                        `_Char`,                         `_Default`).  
...
### Remarks  
 The member function returns [use_facet](../VS_csharp/basic_filebuf-class.md#basic_filebuf__open)<                         **ctype**<                        **E**> >(                         [getloc](../VS_csharp/ios_base-class.md#ios_base__getloc)).                         `widen`(                        `_Char`).  
