...
'cast' : explicit cast from 'cast_from' to 'cast_to' is not verifiable  
 ...
 Some casts are safe (for example, a `static_cast` that triggers user-defined conversions and a `const_cast`). A [safe_cast](../VS_csharp/safe_cast--c---component-extensions-.md) is guaranteed to produce verifiable code.  
