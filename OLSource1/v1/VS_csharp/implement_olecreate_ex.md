 ...
 *l, w1, w2, b1, b2, b3, b4, b5, b6, b7, b8*  
 Components of the class's **CLSID**. For more information on these parameters, see the Remarks for [IMPLEMENT_OLECREATE](../VS_csharp/implement_olecreate.md).  
...
## See Also  
 ...
 [BEGIN_OLEFACTORY](../VS_csharp/begin_olefactory.md)   
 [END_OLEFACTORY](../VS_csharp/end_olefactory.md)   
 [IMPLEMENT_OLECREATE](../VS_csharp/implement_olecreate.md)