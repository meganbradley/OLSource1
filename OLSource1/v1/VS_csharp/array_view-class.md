...
|[Array_view::get_source_accelerator_view Method](#array_view__get_source_accelerator_view_method)|Returns the                                         [accelerator_view](../VS_csharp/accelerator_view-class.md) where the data source of the                                         `array_view` is located.|  
...
|[array_view::synchronize_async Method](#array_view__synchronize_async_method)|Asynchronously synchronizes any modifications made to the                                         [array_view](../VS_csharp/array_view-class.md) object back to its source data.|  
|[array_view::synchronize_to Method](#array_view__synchronize_to_method)|Synchronizes any modifications made to the                                         `array_view` object to the specified                                         [accelerator_view](../VS_csharp/accelerator_view-class.md).|  
|[Array_view::synchronize_to_async Method](#array_view__synchronize_to_async_method)|Asynchronously synchronizes any modifications made to the                                         `array_view` object to the specified                                         [accelerator_view](../VS_csharp/accelerator_view-class.md).|  
...
|[array_view::source_accelerator_view Data Member](#array_view__source_accelerator_view_data_member)|Gets the                                         [accelerator_view](../VS_csharp/accelerator_view-class.md) where the data source of the                                         `array_view` is located|  
...
## Remarks  
 The                 `array_view` class represents a view into the data that is contained in an                 [array](../VS_csharp/array-class.md) object or a subsection of an                 `array` object.  
...
##  <a name="array_view___dtorarray_view_destructor"></a>  array_view::~array_view Destructor  
 Destroys the                 [array_view](../VS_csharp/array_view-class.md) object.  
...
##  <a name="array_view__get_extent_method"></a>  array_view::get_extent Method  
 Returns the                 [extent](../VS_csharp/extent-class--c---amp-.md) object of the                 [array_view](../VS_csharp/array_view-class.md) object.  
...
##  <a name="array_view__operator_eq_operator"></a>  array_view::operator= Operator  
 Copies the contents of the specified                 [array_view](../VS_csharp/array_view-class.md) object to this one.  
...
##  <a name="array_view__rank_constant"></a>  array_view::rank Constant  
 Stores the rank of the                 [array_view](../VS_csharp/array_view-class.md) object.  
...
##  <a name="array_view__refresh_method"></a>  array_view::refresh Method  
 Notifies the                 [array_view](../VS_csharp/array_view-class.md) object that its bound memory has been modified outside the                 `array_view` interface. A call to this method renders all cached information stale.  
...
### Parameters  
 `_Access_type`  
 The intended                                 [access_type](concurrency_namespace__c++_amp__Enumerations) on the target                                 [accelerator_view](../VS_csharp/accelerator_view-class.md). This parameter has a default value of                                 `access_type_read`.  
  
##  <a name="array_view__synchronize_async_method"></a>  array_view::synchronize_async Method  
 Asynchronously synchronizes any modifications made to the                 [array_view](../VS_csharp/array_view-class.md) object back to its source data.  
