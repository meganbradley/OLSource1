...
## Remarks  
 If __WRL_STRICT\_\_ is defined, an assert error is emitted if the base class specified in the class template parameter isn't derived from [RuntimeClass](../VS_csharp/runtimeclass-class.md), or isn't configured with the ClassicCom or WinRtClassicComMix [RuntimeClassType](../VS_csharp/runtimeclasstype-enumeration.md) enumeration value.  
...
## See Also  
 [SimpleClassFactory Class](../VS_csharp/simpleclassfactory-class.md)