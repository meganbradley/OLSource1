...
A useful shortcut for [Set.contains](../VS_csharp/set.contains--t--function--fsharp-.md). See the [Set module](../VS_csharp/collections.set-module--fsharp-.md) for further operations on sets.  
