...
#### Parameters  
 `sets`  
 Type: [seq](../VS_csharp/collections.seq--t--type-abbreviation--fsharp-.md)`<`[Set](../VS_csharp/collections.set--t--class--fsharp-.md)`<'T>>`  
...
## Example  
 ...
 [!code[FsSets#5](../VS_csharp/codesnippet/FSharp/set.intersectmany--t--function--fsharp-_1.fs)]  
