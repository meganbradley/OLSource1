...
1.  Open the string tables in both .rc files. (For more information, see [Viewing Resources in a Resource Script File Outside of a Project](../VS_csharp/how-to--open-a-resource-script-file-outside-of-a-project--standalone-.md).)  
