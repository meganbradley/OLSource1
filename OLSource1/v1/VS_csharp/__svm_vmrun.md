...
## Remarks  
 The `__svm_vmrun` function uses a minimal amount of information in the VMCB to begin executing the virtual machine guest code. Use the [__svm_vmsave](../VS_csharp/__svm_vmsave.md) or [__svm_vmload](../VS_csharp/__svm_vmload.md) function if you require more information to handle a complex interrupt or to switch to another guest.  
...
|---------------|------------------|  
|`__svm_vmrun`|x86, [!INCLUDE[vcprx64](../VS_csharp/includes/vcprx64_md.md)]|  
...
## See Also  
 ...
 [__svm_vmsave](../VS_csharp/__svm_vmsave.md)   
 [__svm_vmload](../VS_csharp/__svm_vmload.md)