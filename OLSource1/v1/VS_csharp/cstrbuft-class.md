...
## Remarks  
 This class is used as a wrapper class for replacing calls to                 [GetBuffer](../VS_csharp/csimplestringt-class.md#csimplestringt__getbuffer) and                 [ReleaseBuffer](../VS_csharp/csimplestringt-class.md#csimplestringt__releasebuffer), or                 [GetBufferSetLength](../VS_csharp/csimplestringt-class.md#csimplestringt__getbuffersetlength) and                 `ReleaseBuffer`.  
...
-   **AUTO_LENGTH** String length is automatically determined when                                         [CSimpleStringT::Release](../VS_csharp/csimplestringt-class.md#csimplestringt__releasebuffer) is called. The string must be null-terminated. Default value.  
  
-   **SET_LENGTH** String length is set when                                         [CSimpleStringT::GetBuffer](../VS_csharp/csimplestringt-class.md#csimplestringt__getbuffer) is called.  
  
### Remarks  
 Creates a string buffer for the associated string object. During construction,                         [CSimpleStringT::GetBuffer](../VS_csharp/csimplestringt-class.md#csimplestringt__getbuffer) or                         [CSimpleStringT::GetBufferSetLength](../VS_csharp/csimplestringt-class.md#csimplestringt__getbuffersetlength) is called.  
...
### Remarks  
 ...
 Determines if                         [CSimpleStringT::GetBuffer](../VS_csharp/csimplestringt-class.md#csimplestringt__getbuffer) and                         [CSimpleStringT::GetBufferSetLength](../VS_csharp/csimplestringt-class.md#csimplestringt__getbuffersetlength) are called when the string buffer object is constructed.  
