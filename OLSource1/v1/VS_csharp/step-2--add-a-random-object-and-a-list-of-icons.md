...
2.  In the existing code, add the following code.  
     ...
     [!code[VbExpressTutorial4Step2_3_4#1](../VS_csharp/codesnippet/CSharp/step-2--add-a-random-object-and-a-list-of-icons_1.cs)]
[!code[VbExpressTutorial4Step2_3_4#1](../VS_csharp/codesnippet/VisualBasic/step-2--add-a-random-object-and-a-list-of-icons_1.vb)]  
...
3.  When adding the `List` object, notice the **IntelliSense** window that opens. The following is a Visual C# example, but similar text appears when you add a list in Visual Basic.  
     ...
     ![Properties window showing Click event](../VS_csharp/media/express_listintellisense.png "Express_ListIntellisense")  
IntelliSense window  
...
-   To go to the next tutorial step, see [Step 3: Assign a Random Icon to Each Label](../VS_csharp/step-3--assign-a-random-icon-to-each-label.md).  
  
-   To return to the previous tutorial step, see [Step 1: Create a Project and Add a Table to Your Form](../VS_csharp/step-1--create-a-project-and-add-a-table-to-your-form.md).