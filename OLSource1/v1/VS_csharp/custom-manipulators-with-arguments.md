...
## In This Section  
 [Output Stream Manipulators with One Argument](../VS_csharp/output-stream-manipulators-with-one-argument--int-or-long-.md) (`int` or `long`)  
  
 [Other One-Argument Output Stream Manipulators](../VS_csharp/other-one-argument-output-stream-manipulators.md)  
