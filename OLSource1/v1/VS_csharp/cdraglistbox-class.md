...
## Remarks  
 ...
 The list box control associated with the `CDragListBox` class must not have the **LBS_SORT** or the **LBS_MULTIPLESELECT** style. For a description of list box styles, see [List-Box Styles](../VS_csharp/list-box-styles.md).  
 ...
 For more information on assigning controls to member variables, see [Shortcut for Defining Member Variables for Dialog Controls](../VS_csharp/defining-member-variables-for-dialog-controls.md).  
...
### Parameters  
 `pt`  
 A [CPoint](../VS_csharp/cpoint-class.md) object that contains the coordinates of the item being dragged.  
...
### Parameters  
 `pt`  
 A [CPoint](../VS_csharp/cpoint-class.md) object that contains the x and y screen coordinates of the cursor.  
 ...
 *nSrcIndex*  
 ...
 `pt`  
 A [CPoint](../VS_csharp/cpoint-class.md) object that contains the coordinates of the drop site.  
...
### Parameters  
 `pt`  
 A [CPoint](../VS_csharp/cpoint-class.md) object containing the coordinates of a point within the list box.  
