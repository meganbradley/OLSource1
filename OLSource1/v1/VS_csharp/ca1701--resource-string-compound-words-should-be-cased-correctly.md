...
## When to Suppress Warnings  
 ...
 You can also add compound words to a custom dictionary for the spelling checker. Words in the custom dictionary do not cause violations. For more information, see [How to: Customize the Code Analysis Dictionary](../VS_csharp/how-to--customize-the-code-analysis-dictionary.md).  
  
## Related Rules  
 [Compound words should be cased correctly](../VS_csharp/ca1702--compound-words-should-be-cased-correctly.md)  
