...
-   You can't use the [Await](../VS_csharp/await-operator--visual-basic-.md) operator in a `SyncLock` block.  
...
### Code  
 [!code[VbVbalrThreading#1](../VS_csharp/codesnippet/VisualBasic/synclock-statement_1.vb)]  
...
### Code  
 [!code[VbVbalrThreading#21](../VS_csharp/codesnippet/VisualBasic/synclock-statement_2.vb)]  
...
## See Also  
 ...
 [Thread Synchronization (C# and Visual Basic)](../VS_csharp/thread-synchronization--csharp-and-visual-basic-.md)   
 [Threading (C# and Visual Basic)](../VS_csharp/threading--csharp-and-visual-basic-.md)