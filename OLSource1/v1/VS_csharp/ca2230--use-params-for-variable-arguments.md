...
## How to Fix Violations  
 To fix a violation of this rule in C#, use the [params](../VS_csharp/params--csharp-reference-.md) keyword instead of `__arglist`.  
...
## Example  
 ...
 [!code[FxCop.Usage.UseParams#1](../VS_csharp/codesnippet/CSharp/ca2230--use-params-for-variable-arguments_1.cs)]  
