...
## Remarks  
 This enumeration is for internal use only by [!INCLUDE[vsprvs](../VS_csharp/includes/vsprvs_md.md)]. The [IDebugProcess3::GetENCAvailableState](../VS_csharp/idebugprocess3--getencavailablestate.md) and [IDebugProcess3::DisableENC](../VS_csharp/idebugprocess3--disableenc.md) methods as implemented by a custom port supplier should always return `E_NOTIMPL`.  
...
## See Also  
 ...
 [IDebugProcess3::DisableENC](../VS_csharp/idebugprocess3--disableenc.md)   
 [IDebugProcess3::GetENCAvailableState](../VS_csharp/idebugprocess3--getencavailablestate.md)