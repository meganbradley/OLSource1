...
### Remarks  
 By default, `AddRef` calls **_Module::Lock**, where **_Module** is the global instance of [CComModule](../VS_csharp/ccommodule-class.md) or a class derived from it.  
...
### Remarks  
 If you have not derived your base class from [CComObjectRoot](../VS_csharp/ccomobjectroot-class.md), you must supply your own `FinalConstruct` method. The destructor calls `FinalRelease`.  
...
### Remarks  
 By default,                         **Release** calls **_Module::Unlock**, where **_Module** is the global instance of [CComModule](../VS_csharp/ccommodule-class.md) or a class derived from it.  
  
## See Also  
 [CComObjectStack Class](../VS_csharp/ccomobjectstack-class.md)   
