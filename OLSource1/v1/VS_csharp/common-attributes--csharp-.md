...
|<xref:System.Runtime.CompilerServices.CallerMemberNameAttribute*>|Method name or property name of the caller. For more information, see [Caller Information (C#)](../VS_csharp/caller-information--csharp-.md).|`String`|  
  
 For more information about the Caller Info attributes, see [Caller Information (C#)](../VS_csharp/caller-information--csharp-.md).  
