...
>  The **Show Derived Classes** command is not supported for C++ code. You can display derived classes by going to Class View, expanding the type node, expanding the **Derived Types** subfolder, and then dragging those types onto the class diagram.  
 ...
 For more information about multiple-class inheritance, see [(NOTINBUILD) Multiple Inheritance](assetId:///3b74185e-2beb-4e29-8684-441e51d2a2ca) and [Multiple Base Classes](../VS_csharp/multiple-base-classes.md).  
...
```  
 ...
 For more information about anonymous classes, see [Anonymous Class Types](../VS_csharp/anonymous-class-types.md).  
...
## See Also  
 [Working with Visual C++ Code in Class Designer](../VS_csharp/working-with-visual-c---code--class-designer-.md)   
