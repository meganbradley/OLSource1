...
The string conversion macros discussed here are valid for both ATL and MFC. For more information on MFC string conversion, see [TN059: Using MFC MBCS/Unicode Conversion Macros](../VS_csharp/tn059--using-mfc-mbcs-unicode-conversion-macros.md) and [MFC Macros and Globals](../VS_csharp/mfc-macros-and-globals.md).  
...
> [!NOTE]
>  The recommended way of converting to and from BSTR strings is to use the [CComBSTR](../VS_csharp/ccombstr-class.md) class. To convert to a BSTR, pass the existing string to the constructor of `CComBSTR`. To convert from a BSTR, use `COLE2`[`C`]`DestinationType`[`EX`], such as `COLE2T`.  
...
### Code  
 [!code[NVC_ATL_Utilities#98](../VS_csharp/codesnippet/CPP/atl-and-mfc-string-conversion-macros_1.cpp)]  
  
### A Warning Regarding Temporary Class Instances  
 It should be stressed that the following is not good code:  
  
 [!code[NVC_ATL_Utilities#99](../VS_csharp/codesnippet/CPP/atl-and-mfc-string-conversion-macros_2.cpp)]  
  
 Using ATL 3.0 macros, it was acceptable to use:  
  
 [!code[NVC_ATL_Utilities#100](../VS_csharp/codesnippet/CPP/atl-and-mfc-string-conversion-macros_3.cpp)]  
 ...
 [!code[NVC_ATL_Utilities#101](../VS_csharp/codesnippet/CPP/atl-and-mfc-string-conversion-macros_4.cpp)]  
  
 is equivalent to this:  
  
 [!code[NVC_ATL_Utilities#102](../VS_csharp/codesnippet/CPP/atl-and-mfc-string-conversion-macros_5.cpp)]  
 ...
 [!code[NVC_ATL_Utilities#103](../VS_csharp/codesnippet/CPP/atl-and-mfc-string-conversion-macros_6.cpp)]  
...
### Advanced Usage  
 ...
 [!code[NVC_ATL_Utilities#104](../VS_csharp/codesnippet/CPP/atl-and-mfc-string-conversion-macros_7.cpp)]  
  
 Here is an example of specifying the code page as the second parameter to the constructor for the class.  
  
 [!code[NVC_ATL_Utilities#105](../VS_csharp/codesnippet/CPP/atl-and-mfc-string-conversion-macros_8.cpp)]  
...
|`A2W`|`OLE2W`|`T2W`|`W2T`|  
 ...
 [!code[NVC_ATL_Utilities#106](../VS_csharp/codesnippet/CPP/atl-and-mfc-string-conversion-macros_9.cpp)]  
...
|`_UNICODE` and `OLE2ANSI`|`W`|`A`|  
 ...
 [!code[NVC_ATL_Utilities#107](../VS_csharp/codesnippet/CPP/atl-and-mfc-string-conversion-macros_10.cpp)]  
...
## See Also  
 ...
 [DEVMODE and TEXTMETRIC String Conversion Macros](../VS_csharp/devmode-and-textmetric-string-conversion-macros.md)