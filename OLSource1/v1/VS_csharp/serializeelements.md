...
---
# SerializeElements
[CArray](../VS_csharp/carray-class.md), [CList](../VS_csharp/clist-class.md), and [CMap](../VS_csharp/cmap-class.md) call this function to serialize elements.  
...
## Example  
 See the example in the article [Collections: How to Make a Type-Safe Collection](../VS_csharp/how-to--make-a-type-safe-collection.md).  
