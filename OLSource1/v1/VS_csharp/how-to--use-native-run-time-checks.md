...
In Visual C++, you can use native [runtime checks](../VS_csharp/runtime_checks.md) to catch common run-time errors such as:  
...
-   [Customizing Run-Time Checks with the C Run-Time Library](../VS_csharp/native-run-time-checks-customization.md)  
