...
## Members  
 CIF_MODULEURL  
 Initialize/use the `bstrModuleUrl` field of the [CONTEXT_INFO](../VS_csharp/context_info.md) structure.  
...
## Remarks  
 These values are passed a parameter to the [GetInfo](../VS_csharp/idebugmemorycontext2--getinfo.md) method to indicate which fields of the [CONTEXT_INFO](../VS_csharp/context_info.md) structure are to be initialized.  
