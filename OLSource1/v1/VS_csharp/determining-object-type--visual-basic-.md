...
## TypeName and TypeOf…Is  
 ...
 [!code[VbVbalrOOP#92](../VS_csharp/codesnippet/VisualBasic/determining-object-type--visual-basic-_1.vb)]  
 ...
 [!code[VbVbalrOOP#93](../VS_csharp/codesnippet/VisualBasic/determining-object-type--visual-basic-_2.vb)]  
  
 A word of caution is due here. The `TypeOf...Is` operator returns `True` if an object is of a specific type, or is derived from a specific type. Almost everything you do with [!INCLUDE[vbprvb](../VS_csharp/includes/vbprvb_md.md)] involves objects, which include some elements not normally thought of as objects, such as strings and integers. These objects are derived from and inherit methods from <xref:System.Object*>. When passed an `Integer` and evaluated with `Object`, the `TypeOf...Is` operator returns `True`. The following example reports that the parameter `InParam` is both an `Object` and an `Integer`:  
  
 [!code[VbVbalrOOP#94](../VS_csharp/codesnippet/VisualBasic/determining-object-type--visual-basic-_3.vb)]  
...
3.  Add the following code to your form:  
     ...
     [!code[VbVbalrOOP#95](../VS_csharp/codesnippet/VisualBasic/determining-object-type--visual-basic-_4.vb)]  
  
## See Also  
 <xref:Microsoft.VisualBasic.Information.TypeName*>   
 [Calling a Property or Method Using a String Name](../VS_csharp/calling-a-property-or-method-using-a-string-name--visual-basic-.md)   
 [Object Data Type](../VS_csharp/object-data-type.md)   
 [If...Then...Else Statement](../VS_csharp/if...then...else-statement--visual-basic-.md)   
 [String Data Type](../VS_csharp/string-data-type--visual-basic-.md)   
