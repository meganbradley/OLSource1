...
operator 'operator' cannot be applied to an instance of a ref class  
 ...
 A CLR type requires CLR operators, not native (or standard) operators.  For more information, see [% (Tracking Reference)](../VS_csharp/tracking-reference-operator--c---component-extensions-.md).  
