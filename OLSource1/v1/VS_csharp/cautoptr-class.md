...
## Remarks  
 ...
 [CHeapPtr](../VS_csharp/cheapptr-class.md) and variants work in the same way as `CAutoPtr`, except that they allocate and free memory using different heap functions instead of the C++                 **new** and **delete** operators. [CAutoVectorPtr](../VS_csharp/cautovectorptr-class.md) is similar to `CAutoPtr`, the only difference being that it uses **vector new[]** and **vector delete[]** to allocate and free memory.  
  
 See also [CAutoPtrArray](../VS_csharp/cautoptrarray-class.md) and [CAutoPtrList](../VS_csharp/cautoptrlist-class.md) when arrays or lists of smart pointers are required.  
  
## Requirements  
 **Header:** atlbase.h  
  
## Example  
 [!code[NVC_ATL_Utilities#74](../VS_csharp/codesnippet/CPP/cautoptr-class_1.cpp)]  
...
### Example  
 See the example in the [CAutoPtr Overview](../VS_csharp/cautoptr-class.md).  
