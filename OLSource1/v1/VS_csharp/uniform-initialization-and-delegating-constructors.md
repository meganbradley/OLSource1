...
## initializer_list Constructors  
 The [initializer_list](../VS_csharp/initializer_list-class.md) represents a list of objects of a specified type that can be used in a constructor, and in other contexts. You can construct an initializer_list by using brace initialization:  
...
> [!IMPORTANT]
>  To use this class, you must include the [<initializer_list>](../VS_csharp/-initializer_list-.md) header.  
