...
The following simple example shows the standard way to declare events in a base class so that they can also be raised from derived classes. This pattern is used extensively in Windows Forms classes in the [!INCLUDE[dnprdnshort](../VS_csharp/includes/dnprdnshort_md.md)] class library.  
...
## Example  
 [!code[csProgGuideEvents#1](../VS_csharp/codesnippet/CSharp/how-to--raise-base-class-events-in-derived-classes--csharp-programming-guide-_1.cs)]  
