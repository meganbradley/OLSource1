...
## Remarks  
 ...
 For more information on using `CHotKeyCtrl`, see [Controls](../VS_csharp/controls--mfc-.md) and [Using CHotKeyCtrl](../VS_csharp/using-chotkeyctrl.md).  
...
### Parameters  
 `dwStyle`  
 Specifies the hot key control's style. Apply any combination of control styles. See                                 [Common Control Styles](http://msdn.microsoft.com/library/windows/desktop/bb775498) in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)] for more information.  
  
 `rect`  
 Specifies the hot key control's size and position. It can be either a [CRect](../VS_csharp/crect-class.md) object or a [RECT](../VS_csharp/rect-structure.md) structure.  
  
 `pParentWnd`  
 Specifies the hot key control's parent window, usually a [CDialog](../VS_csharp/cdialog-class.md). It must not be **NULL**.  
...
### Parameters  
 ...
 `dwStyle`  
 Specifies the hot key control's style. Apply any combination of control styles. For more information, see                                 [Common Control Styles](http://msdn.microsoft.com/library/windows/desktop/bb775498) in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Example  
  [!code[NVC_MFCControlLadenDialog#69](../VS_csharp/codesnippet/CPP/chotkeyctrl-class_1.cpp)]  
