...
3.  While pressing the CTRL key, double-click the control.  
     ...
     The [Add Member Variable](../VS_csharp/add-member-variable-wizard.md) dialog box appears.  
