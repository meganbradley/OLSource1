...
-   The referenced assembly has granted friend assembly access to the assembly into which the module will be built.  
 ...
 For more information about creating a module, see [/target (Visual Basic)](../VS_csharp/-target--visual-basic-.md). For more information about friend assemblies, see [Friend Assemblies (C# and Visual Basic)](../VS_csharp/friend-assemblies--csharp-and-visual-basic-.md).  
...
## See Also  
 ...
 [Friend Assemblies (C# and Visual Basic)](../VS_csharp/friend-assemblies--csharp-and-visual-basic-.md)