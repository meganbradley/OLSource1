...
## Remarks  
 ...
 initializes the controlled sequence with the sequence `[``right``.`[begin](../VS_csharp/vector--begin--stl-clr-.md)`(),` `right``.`[end](../VS_csharp/vector--end--stl-clr-.md)`())`. You use it to specify an initial controlled sequence that is a copy of the sequence controlled by the vector object `right`.  
  
 The constructor:  
  
 `vector(vector<Value>^ right);`  
  
 initializes the controlled sequence with the sequence `[``right``->`[begin](../VS_csharp/vector--begin--stl-clr-.md)`(),` `right``->`[end](../VS_csharp/vector--end--stl-clr-.md)`())`. You use it to specify an initial controlled sequence that is a copy of the sequence controlled by the vector object whose handle is `right`.  
...
## See Also  
 ...
 [assign](../VS_csharp/vector--assign--stl-clr-.md)   
 [generic_container](../VS_csharp/vector--generic_container--stl-clr-.md)   
 [operator=](../VS_csharp/vector--operator=--stl-clr-.md)