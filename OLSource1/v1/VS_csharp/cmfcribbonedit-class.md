...
## Example  
 The following example demonstrates how to construct a `CMFCRibbonEdit` object, show spin buttons next to the edit control, and set the text of the edit control. This code snippet is part of the [MS Office 2007 Demo sample](../VS_csharp/visual-c---samples.md).  
  
 [!code[NVC_MFC_MSOffice2007Demo#7](../VS_csharp/codesnippet/CPP/cmfcribbonedit-class_1.cpp)]  
  
## Requirements  
 **Header:** afxRibbonEdit.h  
  
##  <a name="cmfcribbonedit__canbestretched"></a>  CMFCRibbonEdit::CanBeStretched  
 Indicates whether the height of the [CMFCRibbonEdit](../VS_csharp/cmfcribbonedit-class.md) control can increase vertically to the height of a ribbon row.  
...
##  <a name="cmfcribbonedit__cmfcribbonedit"></a>  CMFCRibbonEdit::CMFCRibbonEdit  
 Constructs a [CMFCRibbonEdit](../VS_csharp/cmfcribbonedit-class.md) object.  
...
### Parameters  
 [in] `nID`  
 Command ID for the [CMFCRibbonEdit](../VS_csharp/cmfcribbonedit-class.md) control.  
  
 [in] `nWidth`  
 The width, in pixels, of the text box for the [CMFCRibbonEdit](../VS_csharp/cmfcribbonedit-class.md) control.  
  
 [in] `lpszLabel`  
 The label for the [CMFCRibbonEdit](../VS_csharp/cmfcribbonedit-class.md) control.  
  
 [in] `nImage`  
 Index of the small image to use for the [CMFCRibbonEdit](../VS_csharp/cmfcribbonedit-class.md) control. The collection of small images is maintained by the parent ribbon category.  
  
### Remarks  
 The [CMFCRibbonEdit](../VS_csharp/cmfcribbonedit-class.md) control does not use a large image.  
  
##  <a name="cmfcribbonedit__copyfrom"></a>  CMFCRibbonEdit::CopyFrom  
 Copies the state of the specified [CMFCRibbonEdit](../VS_csharp/cmfcribbonedit-class.md) object to the current [CMFCRibbonEdit](../VS_csharp/cmfcribbonedit-class.md) object.  
...
### Parameters  
 [in] `src`  
 The source [CMFCRibbonEdit](../VS_csharp/cmfcribbonedit-class.md) object.  
  
### Remarks  
 The `src` parameter must be of type [CMFCRibbonEdit](../VS_csharp/cmfcribbonedit-class.md).  
  
##  <a name="cmfcribbonedit__createedit"></a>  CMFCRibbonEdit::CreateEdit  
 Creates a new text box for the [CMFCRibbonEdit](../VS_csharp/cmfcribbonedit-class.md) object.  
...
### Parameters  
 [in] `pWndParent`  
 A pointer to the parent window of the [CMFCRibbonEdit](../VS_csharp/cmfcribbonedit-class.md) object.  
...
### Remarks  
 ...
 You can apply the following [Window Styles](../VS_csharp/window-styles.md) to a text box:  
...
##  <a name="cmfcribbonedit__destroyctrl"></a>  CMFCRibbonEdit::DestroyCtrl  
 Destroys the [CMFCRibbonEdit](../VS_csharp/cmfcribbonedit-class.md) object.  
...
##  <a name="cmfcribbonedit__getcompactsize"></a>  CMFCRibbonEdit::GetCompactSize  
 Retrieves the compact size of the [CMFCRibbonEdit](../VS_csharp/cmfcribbonedit-class.md) object.  
...
### Parameters  
 [in] `pDC`  
 Pointer to a device context for the [CMFCRibbonEdit](../VS_csharp/cmfcribbonedit-class.md) object.  
  
### Return Value  
 The compact size of the [CMFCRibbonEdit](../VS_csharp/cmfcribbonedit-class.md) object.  
...
##  <a name="cmfcribbonedit__getintermediatesize"></a>  CMFCRibbonEdit::GetIntermediateSize  
 Retrieves the intermediate size of the [CMFCRibbonEdit](../VS_csharp/cmfcribbonedit-class.md) object.  
...
### Return Value  
 The intermediate size of the [CMFCRibbonEdit](../VS_csharp/cmfcribbonedit-class.md) object.  
...
##  <a name="cmfcribbonedit__getwidth"></a>  CMFCRibbonEdit::GetWidth  
 Retrieves the width, in pixels, of the [CMFCRibbonEdit](../VS_csharp/cmfcribbonedit-class.md) control.  
...
### Parameters  
 [in] `bInFloatyMode`  
 `TRUE` if the [CMFCRibbonEdit](../VS_csharp/cmfcribbonedit-class.md) control is in floating mode; otherwise, `FALSE`.  
  
### Return Value  
 The width, in pixels, of the [CMFCRibbonEdit](../VS_csharp/cmfcribbonedit-class.md) control.  
  
### Remarks  
  
##  <a name="cmfcribbonedit__hascompactmode"></a>  CMFCRibbonEdit::HasCompactMode  
 Indicates whether the display size for the [CMFCRibbonEdit](../VS_csharp/cmfcribbonedit-class.md) control can be compact.  
...
##  <a name="cmfcribbonedit__hasfocus"></a>  CMFCRibbonEdit::HasFocus  
 Indicates whether the [CMFCRibbonEdit](../VS_csharp/cmfcribbonedit-class.md) control has the focus.  
...
### Return Value  
 `TRUE` if the [CMFCRibbonEdit](../VS_csharp/cmfcribbonedit-class.md) control has the focus; otherwise `FALSE`.  
  
### Remarks  
  
##  <a name="cmfcribbonedit__haslargemode"></a>  CMFCRibbonEdit::HasLargeMode  
 Indicates whether the display size for the [CMFCRibbonEdit](../VS_csharp/cmfcribbonedit-class.md) control can be large.  
...
##  <a name="cmfcribbonedit__ishighlighted"></a>  CMFCRibbonEdit::IsHighlighted  
 Indicates whether the [CMFCRibbonEdit](../VS_csharp/cmfcribbonedit-class.md) control is highlighted.  
...
### Return Value  
 `TRUE` if the [CMFCRibbonEdit](../VS_csharp/cmfcribbonedit-class.md) control is highlighted; otherwise `FALSE`.  
  
### Remarks  
  
##  <a name="cmfcribbonedit__onafterchangerect"></a>  CMFCRibbonEdit::OnAfterChangeRect  
 Called by the framework when the dimensions of the display rectangle for the [CMFCRibbonEdit](../VS_csharp/cmfcribbonedit-class.md) control change.  
...
### Parameters  
 [in] `pDC`  
 Pointer to a device context for the [CMFCRibbonEdit](../VS_csharp/cmfcribbonedit-class.md) control.  
  
### Remarks  
  
##  <a name="cmfcribbonedit__ondraw"></a>  CMFCRibbonEdit::OnDraw  
 Called by the framework to draw the [CMFCRibbonEdit](../VS_csharp/cmfcribbonedit-class.md) control.  
...
##  <a name="cmfcribbonedit__ondrawlabelandimage"></a>  CMFCRibbonEdit::OnDrawLabelAndImage  
 Called by the framework to draw the label and image for the [CMFCRibbonEdit](../VS_csharp/cmfcribbonedit-class.md) control.  
...
##  <a name="cmfcribbonedit__ondrawonlist"></a>  CMFCRibbonEdit::OnDrawOnList  
 Called by the framework to draw the [CMFCRibbonEdit](../VS_csharp/cmfcribbonedit-class.md) control in a commands list box.  
...
### Parameters  
 ...
 [in] `strText`  
 The display text [](../VS_csharp/cmfcribbonedit-class.md "CMFCRibbonEdit Class").  
  
 [in] `nTextOffset`  
 Distance, in pixels, from the left side of the list box to the display text.  
  
 [in] `rect`  
 The display rectangle for the [CMFCRibbonEdit](../VS_csharp/cmfcribbonedit-class.md) control.  
...
##  <a name="cmfcribbonedit__onenable"></a>  CMFCRibbonEdit::OnEnable  
 Called by the framework to enable or disable the [CMFCRibbonEdit](../VS_csharp/cmfcribbonedit-class.md) control.  
...
##  <a name="cmfcribbonedit__onhighlight"></a>  CMFCRibbonEdit::OnHighlight  
 Called by the framework when the pointer enters or leaves the bounds of the [CMFCRibbonEdit](../VS_csharp/cmfcribbonedit-class.md) control.  
...
### Parameters  
 [in] `bHighlight`  
 `TRUE` if the pointer is in the bounds of the [CMFCRibbonEdit](../VS_csharp/cmfcribbonedit-class.md) control; otherwise, `FALSE`.  
  
### Remarks  
  
##  <a name="cmfcribbonedit__onkey"></a>  CMFCRibbonEdit::OnKey  
 Called by the framework when the user presses a keytip and the [CMFCRibbonEdit](../VS_csharp/cmfcribbonedit-class.md) control has the focus.  
...
##  <a name="cmfcribbonedit__onlbuttondown"></a>  CMFCRibbonEdit::OnLButtonDown  
 Called by the framework to update the [CMFCRibbonEdit](../VS_csharp/cmfcribbonedit-class.md) control when the user presses the left mouse button on the control.  
...
##  <a name="cmfcribbonedit__onrtlchanged"></a>  CMFCRibbonEdit::OnRTLChanged  
 Called by the framework to update the [CMFCRibbonEdit](../VS_csharp/cmfcribbonedit-class.md) control when the layout changes direction.  
...
##  <a name="cmfcribbonedit__onshow"></a>  CMFCRibbonEdit::OnShow  
 Called by the framework to show or hide the [CMFCRibbonEdit](../VS_csharp/cmfcribbonedit-class.md) control.  
...
##  <a name="cmfcribbonedit__redraw"></a>  CMFCRibbonEdit::Redraw  
 Updates the display of the [CMFCRibbonEdit](../VS_csharp/cmfcribbonedit-class.md) control.  
...
### Remarks  
 This method redraws the display rectangle for the [CMFCRibbonEdit](../VS_csharp/cmfcribbonedit-class.md) object by indirectly calling                         [CWnd::RedrawWindow](http://msdn.microsoft.com/library/windows/desktop/dd162911) with the `RDW_INVALIDATE`, `RDW_ERASE`, and `RDW_UPDATENOW` flags set.  
  
##  <a name="cmfcribbonedit__setaccdata"></a>  CMFCRibbonEdit::SetACCData  
 Sets the accessibility data for the [CMFCRibbonEdit](../VS_csharp/cmfcribbonedit-class.md) object.  
...
### Parameters  
 `pParent`  
 Pointer to the parent window for the [CMFCRibbonEdit](../VS_csharp/cmfcribbonedit-class.md) object.  
  
 `data`  
 The accessibility data for the [CMFCRibbonEdit](../VS_csharp/cmfcribbonedit-class.md) object.  
...
##  <a name="cmfcribbonedit__setwidth"></a>  CMFCRibbonEdit::SetWidth  
 Sets the width of the text box for the [CMFCRibbonEdit](../VS_csharp/cmfcribbonedit-class.md) control.  
...
### Remarks  
 The [CMFCRibbonEdit](../VS_csharp/cmfcribbonedit-class.md) control has two widths depending on its display mode: floating mode and regular mode.  
  
## See Also  
 [Hierarchy Chart](../VS_csharp/hierarchy-chart.md)   
 [Classes](../VS_csharp/mfc-classes.md)   
 [CMFCRibbonButton Class](../VS_csharp/cmfcribbonbutton-class.md)   
 [CMFCRibbonBar](../VS_csharp/cmfcribbonbar-class.md)