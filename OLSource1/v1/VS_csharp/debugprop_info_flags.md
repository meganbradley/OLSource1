...
## Members  
 ...
 DEBUGPROP_INFO_PROP,  
 Initialize/use the `pProperty` field that contains an [IDebugProperty2](../VS_csharp/idebugproperty2.md) interface.  
...
## Remarks  
 These values are passed to the [IDebugProperty2::GetPropertyInfo](../VS_csharp/idebugproperty2--getpropertyinfo.md), [IDebugProperty2::EnumChildren](../VS_csharp/idebugproperty2--enumchildren.md), and [IDebugStackFrame2::EnumProperties](../VS_csharp/idebugstackframe2--enumproperties.md) methods to indicate which fields are to be initialized the [DEBUG_PROPERTY_INFO](../VS_csharp/debug_property_info.md) structure.  
