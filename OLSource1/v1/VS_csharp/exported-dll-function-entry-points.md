...
For exported functions of a DLL, use the [AFX_MANAGE_STATE](../VS_csharp/afx_manage_state.md) macro to maintain the proper global state when switching from the DLL module to the calling application's DLL.  
 ...
 [!code[NVC_MFCConnectionPoints#6](../VS_csharp/codesnippet/CPP/exported-dll-function-entry-points_1.cpp)]  
