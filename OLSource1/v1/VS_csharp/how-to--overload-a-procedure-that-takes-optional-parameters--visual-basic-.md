...
If a procedure has one or more [Optional (Visual Basic)](../VS_csharp/optional--visual-basic-.md) parameters, you cannot define an overloaded version matching any of its implicit overloads. For more information, see "Implicit Overloads for Optional Parameters" in [Considerations in Overloading Procedures](../VS_csharp/considerations-in-overloading-procedures--visual-basic-.md).  
...
2.  Precede the `Sub` or `Function` keyword with the [Overloads](../VS_csharp/overloads--visual-basic-.md) keyword.  
...
6.  Write the procedure code that should execute when the calling code does not supply the optional argument. Terminate the procedure with the `End Sub` or `End Function` statement as appropriate.  
     ...
     [!code[VbVbcnProcedures#59](../VS_csharp/codesnippet/VisualBasic/how-to--overload-a-procedure-that-takes-optional-parameters--visual-basic-_1.vb)]  
  
     [!code[VbVbcnProcedures#60](../VS_csharp/codesnippet/VisualBasic/how-to--overload-a-procedure-that-takes-optional-parameters--visual-basic-_2.vb)]  
  
     [!code[VbVbcnProcedures#61](../VS_csharp/codesnippet/VisualBasic/how-to--overload-a-procedure-that-takes-optional-parameters--visual-basic-_3.vb)]  
...
3.  In each declaration, precede the `Sub` or `Function` keyword with the [Overloads](../VS_csharp/overloads--visual-basic-.md) keyword.  
