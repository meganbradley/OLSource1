...
## How to Investigate a Warning  
 Review the [Profiling Tools .NET Memory Data Views](../VS_csharp/.net-memory-data-views.md) reports to understand the application’s pattern of memory allocation. Use the [Object Lifetime View](../VS_csharp/object-lifetime-view.md) to determine which of the program’s data objects are surviving into generation 2 and then being reclaimed from there. Use the [.NET Memory Allocations View](../VS_csharp/.net-memory-allocations-view.md) to determine the execution path that resulted in these allocations.  
