...
-   How a [template library](../VS_csharp/using-a-template-library.md) differs from a standard C++ library.  
  
-   What you [can and cannot do with ATL](../VS_csharp/scope-of-atl.md).  
  
-   [Recommendations for choosing between ATL and MFC](../VS_csharp/recommendations-for-choosing-between-atl-and-mfc.md).  
