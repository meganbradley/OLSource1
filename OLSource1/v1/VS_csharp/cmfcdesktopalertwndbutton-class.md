...
### Remarks  
 ...
 Add `CMFCDesktopAlertWndButton` objects to a `CMFCDesktopAlertDialog` object as you would add any button. For more information about `CMFCDesktopAlertDialog`, see [CMFCDesktopAlertDialog Class](../VS_csharp/cmfcdesktopalertdialog-class.md).  
  
## Example  
 The following example demonstrates how to use the `SetImage` method in the `CMFCDesktopAlertWndButton` class. This code snippet is part of the [Desktop Alert Demo sample](../VS_csharp/visual-c---samples.md).  
  
 [!code[NVC_MFC_DesktopAlertDemo#4](../VS_csharp/codesnippet/CPP/cmfcdesktopalertwndbutton-class_1.h)]  
[!code[NVC_MFC_DesktopAlertDemo#5](../VS_csharp/codesnippet/CPP/cmfcdesktopalertwndbutton-class_2.cpp)]  
...
## Inheritance Hierarchy  
 ...
 [CMFCDesktopAlertWndButton](../VS_csharp/cmfcdesktopalertwndbutton-class.md)  
