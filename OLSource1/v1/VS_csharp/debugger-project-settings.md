...
## In This Section  
 ...
 [Project Settings for a C# Debug Configuration](../VS_csharp/project-settings-for--csharp-debug-configurations.md)  
 Lists properties available in the **Property Pages** dialog box for C# projects.  
  
 [Property Pages Settings for Web Projects](../VS_csharp/property-pages-settings-for-web-projects.md)  
 ...
 Lists properties available in the **Property Pages** dialog box for [!INCLUDE[vbprvb](../VS_csharp/includes/vbprvb_md.md)] projects.  
...
## Related Sections  
 ...
 Describes the debugger-related property settings, and the preparation needed in order to debug your program with the [!INCLUDE[vsprvs](../VS_csharp/includes/vsprvs_md.md)] debugger.  
