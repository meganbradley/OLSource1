...
Registers COM or [!INCLUDE[wrt](../VS_csharp/includes/wrt_md.md)] objects so other applications can connect to them.  
...
#### Parameters  
 `module`  
 An array of COM or [!INCLUDE[wrt](../VS_csharp/includes/wrt_md.md)] objects.  
