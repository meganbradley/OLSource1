...
---
# bool (C++)
This keyword is a built-in type. A variable of this type can have values [true](../VS_csharp/true--c---.md) and [false](../VS_csharp/false--c---.md). Conditional expressions have the type `bool` and so have values of type `bool`. For example, `i!=0` now has **true** or **false** depending on the value of `i`.  
