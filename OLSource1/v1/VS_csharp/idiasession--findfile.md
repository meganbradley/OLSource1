...
#### Parameters  
 `pCompiland`  
 [in] An [IDiaSymbol](../VS_csharp/idiasymbol.md) object representing the compiland to be used as a context for the search. Set this parameter to `NULL` to find source files in all compilands.  
 ...
 `ppResult`  
 [out] Returns an [IDiaEnumSourceFiles](../VS_csharp/idiaenumsourcefiles.md) object that contains a list of the source files retrieved.  
