...
-   When you test for overloaded functions, you cannot test for a specific form of the overload.  
 ...
 The complement to the `__if_not_exists` statement is the [__if_exists](../VS_csharp/__if_exists-statement.md) statement.  
  
## Example  
 For an example about how to use `__if_not_exists`, see [The __if_exists Statement](../VS_csharp/__if_exists-statement.md).  
  
## See Also  
 [Selection Statements](../VS_csharp/selection-statements--c---.md)   
 [Keywords](../VS_csharp/keywords--c---.md)   
 [The __if_exists Statement](../VS_csharp/__if_exists-statement.md)