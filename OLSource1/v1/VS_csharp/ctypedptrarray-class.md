...
## Remarks  
 ...
 For more information on using `CTypedPtrArray`, see the articles [Collections](../VS_csharp/collections.md) and [Template-Based Classes](../VS_csharp/template-based-classes.md).  
...
### Remarks  
 For more detailed remarks, see [CObArray::Add](../VS_csharp/cobarray-class.md#cobarray__add).  
...
### Parameters  
 `BASE_CLASS`  
 Base class of the typed pointer array class; must be an array class ( [CObArray](../VS_csharp/cobarray-class.md) or [CPtrArray](../VS_csharp/cptrarray-class.md)).  
...
### Remarks  
 For more detailed remarks, see [CObArray::Append](../VS_csharp/cobarray-class.md#cobarray__append).  
...
### Remarks  
 For more detailed remarks, see [CObArray::Copy](../VS_csharp/cobarray-class.md#cobarray__copy).  
...
### Remarks  
 For more detailed remarks, see [CObArray::ElementAt](../VS_csharp/cobarray-class.md#cobarray__elementat).  
...
### Remarks  
 For more detailed remarks, see [CObArray::GetAt](../VS_csharp/cobarray-class.md#cobarray__getat)  
...
### Parameters  
 `nIndex`  
 An integer index that may be greater than the value returned by [CObArray::GetUpperBound](../VS_csharp/cobarray-class.md#cobarray__getupperbound).  
...
### Remarks  
 For more detailed remarks, see [CObArray::InsertAt](../VS_csharp/cobarray-class.md#cobarray__insertat).  
...
### Parameters  
 `nIndex`  
 An integer index that is greater than or equal to 0 and less than or equal to the value returned by [CObArray::GetUpperBound](../VS_csharp/cobarray-class.md#cobarray__getupperbound).  
...
### Remarks  
 For more detailed remarks, see [CObArray::SetAt](../VS_csharp/cobarray-class.md#cobarray__setat).  
...
### Remarks  
 For more detailed remarks, see [CObArray::SetAtGrow](../VS_csharp/cobarray-class.md#cobarray__setatgrow).  
