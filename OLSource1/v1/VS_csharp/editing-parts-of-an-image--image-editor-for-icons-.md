...
3.  To anchor the selection in the image at its new location, click outside the selection border.  
 ...
 For more information on drawing with a selection, see [Creating a Custom Brush](../VS_csharp/creating-a-custom-brush--image-editor-for-icons-.md).  
