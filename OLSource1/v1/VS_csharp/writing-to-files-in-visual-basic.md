...
## In This Section  
 [How to: Write Text to Files in Visual Basic](../VS_csharp/how-to--write-text-to-files-in-visual-basic.md)  
 Demonstrates how to write to text files.  
  
 [How to: Append to Text Files (Visual Basic)](../VS_csharp/how-to--append-to-text-files-in-visual-basic.md)  
 Demonstrates how to append text to a text file.  
  
 [How to: Write to Binary Files in Visual Basic](../VS_csharp/how-to--write-to-binary-files-in-visual-basic.md)  
 Demonstrates how to write to a binary file.  
  
 [How to: Write Text to Files in MyDocuments (Visual Basic)](../VS_csharp/how-to--write-text-to-files-in-the-my-documents-directory-in-visual-basic.md)  
 Demonstrates how to create and write to a new text file in the **My Documents** directory.  
  
 [How to: Write Text to Files with a StreamWriter (Visual Basic)](../VS_csharp/how-to--write-text-to-files-with-a-streamwriter-in-visual-basic.md)  
...
## Related Sections  
 ...
 [Creating, Deleting, and Moving Files and Directories in Visual Basic](../VS_csharp/creating--deleting--and-moving-files-and-directories-in-visual-basic.md)  
