...
|Element|Description|  
|-------------|-----------------|  
|[IDSymbol Element](../VS_csharp/idsymbol-element.md)|Contains the ID of the GUID:ID pair that represents a menu, group, or command.|  
  
### Parent Elements  
  
|Element|Description|  
|-------------|-----------------|  
|[Symbols Element](../VS_csharp/symbols-element.md)|Groups `GuidSymbol` elements in a .vsct file.|  
