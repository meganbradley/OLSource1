...
## Remarks  
 ...
 The following table compares the three combo-box [styles](../VS_csharp/combo-box-styles.md).  
...
-   **ON_CBN_CLOSEUP** (Windows 3.1 and later.) The list box of a combo box has closed. This notification message is not sent for a combo box that has the [CBS_SIMPLE](../VS_csharp/combo-box-styles.md) style.  
  
-   **ON_CBN_DBLCLK** The user double-clicks a string in the list box of a combo box. This notification message is only sent for a combo box with the **CBS_SIMPLE** style. For a combo box with the [CBS_DROPDOWN](../VS_csharp/combo-box-styles.md) or [CBS_DROPDOWNLIST](../VS_csharp/combo-box-styles.md) style, a double-click cannot occur because a single click hides the list box.  
...
### Remarks  
 If the list box was not created with the [CBS_SORT](../VS_csharp/combo-box-styles.md) style, the string is added to the end of the list. Otherwise, the string is inserted into the list, and the list is sorted.  
  
> [!NOTE]
>  This function is not supported by the Windows **ComboBoxEx** control. For more information on this control, see                             [ComboBoxEx Controls](http://msdn.microsoft.com/library/windows/desktop/bb775738) in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
  
 To insert a string into a specific location within the list, use the [InsertString](#ccombobox__insertstring) member function.  
  
### Example  
 [!code[NVC_MFC_CComboBox#3](../VS_csharp/codesnippet/CPP/ccombobox-class_1.cpp)]  
...
### Example  
 [!code[NVC_MFC_CComboBox#1](../VS_csharp/codesnippet/CPP/ccombobox-class_2.cpp)]  
...
### Example  
 [!code[NVC_MFC_CComboBox#4](../VS_csharp/codesnippet/CPP/ccombobox-class_3.cpp)]  
...
### Parameters  
 `lpCompareItemStruct`  
 A long pointer to a [COMPAREITEMSTRUCT](../VS_csharp/compareitemstruct-structure.md) structure.  
...
|1|Item 1 sorts after item 2.|  
 ...
 See [CWnd::OnCompareItem](../VS_csharp/cwnd-class.md#cwnd__oncompareitem) for a description of `COMPAREITEMSTRUCT`.  
...
### Example  
 [!code[NVC_MFC_CComboBox#5](../VS_csharp/codesnippet/CPP/ccombobox-class_4.cpp)]  
...
### Example  
 [!code[NVC_MFC_CComboBox#6](../VS_csharp/codesnippet/CPP/ccombobox-class_5.cpp)]  
...
### Parameters  
 `dwStyle`  
 Specifies the style of the combo box. Apply any combination of [combo-box styles](../VS_csharp/combo-box-styles.md) to the box.  
  
 `rect`  
 Points to the position and size of the combo box. Can be a [RECT](../VS_csharp/rect-structure.md) structure or a `CRect` object.  
...
### Remarks  
 ...
 When **Create** executes, Windows sends the [WM_NCCREATE](../VS_csharp/cwnd-class.md#cwnd__onnccreate), [WM_CREATE](../VS_csharp/cwnd-class.md#cwnd__oncreate), [WM_NCCALCSIZE](../VS_csharp/cwnd-class.md#cwnd__onnccalcsize), and [WM_GETMINMAXINFO](../VS_csharp/cwnd-class.md#cwnd__ongetminmaxinfo) messages to the combo box.  
  
 These messages are handled by default by the [OnNcCreate](../VS_csharp/cwnd-class.md#cwnd__onnccreate), [OnCreate](../VS_csharp/cwnd-class.md#cwnd__oncreate), [OnNcCalcSize](../VS_csharp/cwnd-class.md#cwnd__onnccalcsize), and [OnGetMinMaxInfo](../VS_csharp/cwnd-class.md#cwnd__ongetminmaxinfo) member functions in the `CWnd` base class. To extend the default message handling, derive a class from `CComboBox`, add a message map to the new class, and override the preceding message-handler member functions. Override `OnCreate`, for example, to perform needed initialization for a new class.  
  
 Apply the following [window styles](../VS_csharp/window-styles.md) to a combo-box control. :  
...
### Example  
 [!code[NVC_MFC_CComboBox#2](../VS_csharp/codesnippet/CPP/ccombobox-class_6.cpp)]  
...
### Example  
 [!code[NVC_MFC_CComboBox#7](../VS_csharp/codesnippet/CPP/ccombobox-class_7.cpp)]  
...
### Parameters  
 `lpDeleteItemStruct`  
 A long pointer to a Windows [DELETEITEMSTRUCT](../VS_csharp/deleteitemstruct-structure.md) structure that contains information about the deleted item. See [CWnd::OnDeleteItem](../VS_csharp/cwnd-class.md#cwnd__ondeleteitem) for a description of this structure.  
  
### Remarks  
 The default implementation of this function does nothing. Override this function to redraw the combo box as needed.  
  
### Example  
 [!code[NVC_MFC_CComboBox#8](../VS_csharp/codesnippet/CPP/ccombobox-class_8.cpp)]  
...
### Example  
 [!code[NVC_MFC_CComboBox#9](../VS_csharp/codesnippet/CPP/ccombobox-class_9.cpp)]  
...
### Parameters  
 `attr`  
 Can be any combination of the `enum` values described in [CFile::GetStatus](../VS_csharp/cfile-class.md#cfile__getstatus) or any combination of the following values:  
...
### Example  
 [!code[NVC_MFC_CComboBox#10](../VS_csharp/codesnippet/CPP/ccombobox-class_10.cpp)]  
...
### Parameters  
 `lpDrawItemStruct`  
 A pointer to a [DRAWITEMSTRUCT](../VS_csharp/drawitemstruct-structure.md) structure that contains information about the type of drawing required.  
  
### Remarks  
 The **itemAction** member of the `DRAWITEMSTRUCT` structure defines the drawing action that is to be performed. See [CWnd::OnDrawItem](../VS_csharp/cwnd-class.md#cwnd__ondrawitem) for a description of this structure.  
...
### Example  
 [!code[NVC_MFC_CComboBox#11](../VS_csharp/codesnippet/CPP/ccombobox-class_11.cpp)]  
...
### Example  
 [!code[NVC_MFC_CComboBox#12](../VS_csharp/codesnippet/CPP/ccombobox-class_12.cpp)]  
...
### Remarks  
 If the combo box was created with an owner-draw style but without the [CBS_HASSTRINGS](../VS_csharp/combo-box-styles.md) style, `FindStringExact` attempts to match the doubleword value against the value of `lpszFind`.  
  
### Example  
 [!code[NVC_MFC_CComboBox#13](../VS_csharp/codesnippet/CPP/ccombobox-class_13.cpp)]  
...
### Remarks  
 This member function emulates the functionality of the                         [CB_GETCOMBOBOXINFO](http://msdn.microsoft.com/library/windows/desktop/bb775839) message, as described in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Example  
 [!code[NVC_MFC_CComboBox#14](../VS_csharp/codesnippet/CPP/ccombobox-class_14.cpp)]  
...
### Return Value  
 In the first overload, a [CString](../VS_csharp/using-cstring.md) object that contains the cue banner text if it exists; otherwise, a `CString` object that has zero length.  
...
### Remarks  
 ...
 This method sends the                         [CB_GETCUEBANNER](http://msdn.microsoft.com/library/windows/desktop/bb775843) message, which is described in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Example  
 [!code[NVC_MFC_CComboBox#15](../VS_csharp/codesnippet/CPP/ccombobox-class_15.cpp)]  
...
### Parameters  
 *lprect*  
 Points to the [RECT](../VS_csharp/rect-structure.md) structure that is to receive the coordinates.  
  
### Example  
 [!code[NVC_MFC_CComboBox#16](../VS_csharp/codesnippet/CPP/ccombobox-class_16.cpp)]  
...
### Example  
 [!code[NVC_MFC_CComboBox#17](../VS_csharp/codesnippet/CPP/ccombobox-class_17.cpp)]  
...
### Remarks  
 This function only applies to combo boxes with the [CBS_DROPDOWN](../VS_csharp/combo-box-styles.md) or [CBS_DROPDOWNLIST](../VS_csharp/combo-box-styles.md) style.  
...
### Example  
 [!code[NVC_MFC_CComboBox#18](../VS_csharp/codesnippet/CPP/ccombobox-class_18.cpp)]  
...
-   Clicking the static control displays the list box only for combo boxes with the [CBS_DROPDOWNLIST](../VS_csharp/combo-box-styles.md) style.  
...
### Example  
 [!code[NVC_MFC_CComboBox#19](../VS_csharp/codesnippet/CPP/ccombobox-class_19.cpp)]  
...
### Example  
 [!code[NVC_MFC_CComboBox#20](../VS_csharp/codesnippet/CPP/ccombobox-class_20.cpp)]  
...
### Example  
 [!code[NVC_MFC_CComboBox#21](../VS_csharp/codesnippet/CPP/ccombobox-class_21.cpp)]  
...
### Example  
 [!code[NVC_MFC_CComboBox#22](../VS_csharp/codesnippet/CPP/ccombobox-class_22.cpp)]  
...
### Parameters  
 `nIndex`  
 Specifies the component of the combo box whose height is to be retrieved. If the `nIndex` parameter is –1, the height of the edit-control (or static-text) portion of the combo box is retrieved. If the combo box has the [CBS_OWNERDRAWVARIABLE](../VS_csharp/combo-box-styles.md) style, `nIndex` specifies the zero-based index of the list item whose height is to be retrieved. Otherwise, `nIndex` should be set to 0.  
  
### Return Value  
 The height, in pixels, of the specified item in a combo box. The return value is **CB_ERR** if an error occurs.  
  
### Example  
 [!code[NVC_MFC_CComboBox#23](../VS_csharp/codesnippet/CPP/ccombobox-class_23.cpp)]  
...
### Example  
 [!code[NVC_MFC_CComboBox#24](../VS_csharp/codesnippet/CPP/ccombobox-class_24.cpp)]  
...
### Remarks  
 This method sends the                         [CB_GETMINVISIBLE](http://msdn.microsoft.com/library/windows/desktop/bb775915) message, which is described in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Example  
 [!code[NVC_MFC_CComboBox#25](../VS_csharp/codesnippet/CPP/ccombobox-class_25.cpp)]  
...
### Example  
 [!code[NVC_MFC_CComboBox#26](../VS_csharp/codesnippet/CPP/ccombobox-class_26.cpp)]  
...
### Remarks  
 Unlike the [AddString](#ccombobox__addstring) member function, the `InsertString` member function does not cause a list with the [CBS_SORT](../VS_csharp/combo-box-styles.md) style to be sorted.  
  
> [!NOTE]
>  This function is not supported by the Windows **ComboBoxEx** control. For more information on this control, see                             [ComboBoxEx Controls](http://msdn.microsoft.com/library/windows/desktop/bb775738) in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
  
### Example  
 [!code[NVC_MFC_CComboBox#27](../VS_csharp/codesnippet/CPP/ccombobox-class_27.cpp)]  
...
### Return Value  
 Nonzero if successful. If called for a combo box with the style [CBS_DROPDOWNLIST](../VS_csharp/combo-box-styles.md) or for a combo box without an edit control, the return value is **CB_ERR**.  
  
### Remarks  
 If the combo box does not have the style [CBS_AUTOHSCROLL](../VS_csharp/combo-box-styles.md), setting the text limit to be larger than the size of the edit control will have no effect.  
...
### Example  
 [!code[NVC_MFC_CComboBox#28](../VS_csharp/codesnippet/CPP/ccombobox-class_28.cpp)]  
...
### Parameters  
 `lpMeasureItemStruct`  
 A long pointer to a [MEASUREITEMSTRUCT](../VS_csharp/measureitemstruct-structure.md) structure.  
  
### Remarks  
 By default, this member function does nothing. Override this member function and fill in the `MEASUREITEMSTRUCT` structure to inform Windows of the dimensions of the list box in the combo box. If the combo box is created with the [CBS_OWNERDRAWVARIABLE](../VS_csharp/combo-box-styles.md) style, the framework calls this member function for each item in the list box. Otherwise, this member is called only once.  
  
 Using the **CBS_OWNERDRAWFIXED** style in an owner-draw combo box created with the [SubclassDlgItem](../VS_csharp/cwnd-class.md#cwnd__subclassdlgitem) member function of `CWnd` involves further programming considerations. See the discussion in [Technical Note 14](../VS_csharp/tn014--custom-controls.md).  
  
 See [CWnd::OnMeasureItem](../VS_csharp/cwnd-class.md#cwnd__onmeasureitem) for a description of the `MEASUREITEMSTRUCT` structure.  
  
### Example  
 [!code[NVC_MFC_CComboBox#29](../VS_csharp/codesnippet/CPP/ccombobox-class_29.cpp)]  
...
### Example  
 [!code[NVC_MFC_CComboBox#30](../VS_csharp/codesnippet/CPP/ccombobox-class_30.cpp)]  
...
### Example  
 [!code[NVC_MFC_CComboBox#31](../VS_csharp/codesnippet/CPP/ccombobox-class_31.cpp)]  
...
### Example  
 [!code[NVC_MFC_CComboBox#32](../VS_csharp/codesnippet/CPP/ccombobox-class_32.cpp)]  
...
### Remarks  
 ...
 This method sends the                         [CB_SETCUEBANNER](http://msdn.microsoft.com/library/windows/desktop/bb775897) message, which is described in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Example  
 ...
 [!code[NVC_MFC_CComboBox_s1#1](../VS_csharp/codesnippet/CPP/ccombobox-class_33.h)]  
  
### Example  
 The following code example sets the cue banner for the combo box control.  
  
 [!code[NVC_MFC_CComboBox_s1#2](../VS_csharp/codesnippet/CPP/ccombobox-class_34.cpp)]  
...
### Example  
 [!code[NVC_MFC_CComboBox#33](../VS_csharp/codesnippet/CPP/ccombobox-class_35.cpp)]  
...
### Example  
 [!code[NVC_MFC_CComboBox#34](../VS_csharp/codesnippet/CPP/ccombobox-class_36.cpp)]  
...
### Return Value  
 Nonzero if the member function is successful; otherwise 0. It is **CB_ERR** if `CComboBox` has the [CBS_DROPDOWNLIST](../VS_csharp/combo-box-styles.md) style or does not have a list box.  
...
##  <a name="ccombobox__setextendedui"></a>  CComboBox::SetExtendedUI  
 Call the `SetExtendedUI` member function to select either the default user interface or the extended user interface for a combo box that has the [CBS_DROPDOWN](../VS_csharp/combo-box-styles.md) or [CBS_DROPDOWNLIST](../VS_csharp/combo-box-styles.md) style.  
...
### Remarks  
 If the width of the list box is smaller than this value, the horizontal scroll bar will horizontally scroll items in the list box. If the width of the list box is equal to or greater than this value, the horizontal scroll bar is hidden or, if the combo box has the [CBS_DISABLENOSCROLL](../VS_csharp/combo-box-styles.md) style, disabled.  
  
### Example  
 [!code[NVC_MFC_CComboBox#35](../VS_csharp/codesnippet/CPP/ccombobox-class_37.cpp)]  
...
### Example  
 [!code[NVC_MFC_CComboBox#36](../VS_csharp/codesnippet/CPP/ccombobox-class_38.cpp)]  
...
### Example  
 [!code[NVC_MFC_CComboBox#37](../VS_csharp/codesnippet/CPP/ccombobox-class_39.cpp)]  
...
### Parameters  
 ...
 If the combo box has the [CBS_OWNERDRAWVARIABLE](../VS_csharp/combo-box-styles.md) style, `nIndex` specifies the zero-based index of the list item whose height is to be set; otherwise, `nIndex` must be 0 and the height of all list items will be set.  
...
### Example  
 [!code[NVC_MFC_CComboBox#38](../VS_csharp/codesnippet/CPP/ccombobox-class_40.cpp)]  
...
### Example  
 [!code[NVC_MFC_CComboBox#39](../VS_csharp/codesnippet/CPP/ccombobox-class_41.cpp)]  
...
### Remarks  
 This method sends the                         [CB_SETMINVISIBLE](http://msdn.microsoft.com/library/windows/desktop/bb775915) message, which is described in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Example  
 [!code[NVC_MFC_CComboBox#40](../VS_csharp/codesnippet/CPP/ccombobox-class_42.cpp)]  
  
##  <a name="ccombobox__showdropdown"></a>  CComboBox::ShowDropDown  
 Shows or hides the list box of a combo box that has the [CBS_DROPDOWN](../VS_csharp/combo-box-styles.md) or [CBS_DROPDOWNLIST](../VS_csharp/combo-box-styles.md) style.  
...
### Remarks  
 ...
 This member function has no effect on a combo box created with the [CBS_SIMPLE](../VS_csharp/combo-box-styles.md) style.  
