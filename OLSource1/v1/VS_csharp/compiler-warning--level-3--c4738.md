...
storing 32-bit float result in memory, possible loss of performance  
 ...
 To resolve this warning and avoid rounding, compile with [/fp:fast](../VS_csharp/-fp--specify-floating-point-behavior-.md) or use `double`s instead of `float`s.  
 ...
 This warning is off by default. For more information, see [Compiler Warnings That Are Off by Default](../VS_csharp/compiler-warnings-that-are-off-by-default.md).  
