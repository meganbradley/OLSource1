...
To install the [!INCLUDE[vsipsdk](../VS_csharp/includes/vsipsdk_md.md)] on your computer, you must be running in a context with administrative credentials. The basic unit of security and deployment of a [!INCLUDE[vsprvs](../VS_csharp/includes/vsprvs_md.md)] application is the [VSPackage](../VS_csharp/vspackages.md). A VSPackage must be registered by using [!INCLUDE[vsprvs](../VS_csharp/includes/vsprvs_md.md)], which also requires administrative credentials.  
