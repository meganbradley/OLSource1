...
|[CMFCToolBar::AdjustLayout](#cmfctoolbar__adjustlayout)|Recalculates the size and position of a toolbar. (Overrides [CBasePane::AdjustLayout](../VS_csharp/cbasepane-class.md#cbasepane__adjustlayout)).|  
...
|[CMFCToolBar::ButtonToIndex](#cmfctoolbar__buttontoindex)|Returns the index of a specified [CMFCToolBarButton](../VS_csharp/cmfctoolbarbutton-class.md) object in this toolbar.|  
|[CMFCToolBar::CalcFixedLayout](#cmfctoolbar__calcfixedlayout)|Calculates the horizontal size of the toolbar. (Overrides [CBasePane::CalcFixedLayout](../VS_csharp/cbasepane-class.md#cbasepane__calcfixedlayout).)|  
|[CMFCToolBar::CalcSize](#cmfctoolbar__calcsize)|Called by the framework as part of the layout calculation process. (Overrides [CPane::CalcSize](../VS_csharp/cpane-class.md#cpane__calcsize).)|  
...
|[CMFCToolBar::CanBeClosed](#cmfctoolbar__canbeclosed)|Specifies whether a user can close the toolbar. (Overrides [CBasePane::CanBeClosed](../VS_csharp/cbasepane-class.md#cbasepane__canbeclosed).)|  
...
|[CMFCToolBar::CanFocus](#cmfctoolbar__canfocus)|Specifies whether the pane can receive focus. (Overrides [CBasePane::CanFocus](../VS_csharp/cbasepane-class.md#cbasepane__canfocus).)|  
|[CMFCToolBar::CanHandleSiblings](#cmfctoolbar__canhandlesiblings)|Determines whether the toolbar and its sibling are positioned on the same pane.|  
...
|[CMFCToolBar::EnableDocking](#cmfctoolbar__enabledocking)|Enables docking of the pane to the main frame. (Overrides [CBasePane::EnableDocking](../VS_csharp/cbasepane-class.md#cbasepane__enabledocking).)|  
...
|[CMFCToolBar::LoadState](#cmfctoolbar__loadstate)|Loads the toolbar state information from the Windows registry. (Overrides [CPane::LoadState](../VS_csharp/cpane-class.md#cpane__loadstate).)|  
...
|[CMFCToolBar::OnFillBackground](#cmfctoolbar__onfillbackground)|Called by the framework from [CBasePane::DoPaint](../VS_csharp/cbasepane-class.md#cbasepane__dopaint) to fill the toolbar background.|  
|[CMFCToolBar::OnReset](#cmfctoolbar__onreset)|Restores the toolbar to its original state.|  
|[CMFCToolBar::OnSetAccData](#cmfctoolbar__onsetaccdata)|(Overrides [CBasePane::OnSetAccData](../VS_csharp/cbasepane-class.md#cbasepane__onsetaccdata).)|  
...
|[CMFCToolBar::SaveState](#cmfctoolbar__savestate)|Saves the state information for the toolbar in the Windows registry. (Overrides [CPane::SaveState](../VS_csharp/cpane-class.md#cpane__savestate).)|  
...
|[CMFCToolBar::StretchPane](#cmfctoolbar__stretchpane)|Stretches the toolbar vertically or horizontally. (Overrides [CBasePane::StretchPane](../VS_csharp/cbasepane-class.md#cbasepane__stretchpane).)|  
...
3.  Call [CBasePane::EnableDocking](../VS_csharp/cbasepane-class.md#cbasepane__enabledocking) to specify the docking style.  
  
 To insert a special button, such as a combo box or drop-down toolbar, reserve a dummy button in the parent resource, and replace the dummy button at runtime by using [CMFCToolBar::ReplaceButton](#cmfctoolbar__replacebutton). For more information, see [How to Put Controls on Toolbars](../VS_csharp/walkthrough--putting-controls-on-toolbars.md).  
  
 `CMFCToolBar` is the base class for the MFC Library classes [CMFCMenuBar](../VS_csharp/cmfcmenubar-class.md), [CMFCPopupMenuBar](../VS_csharp/cmfcpopupmenubar-class.md), and [CMFCDropDownToolBar](../VS_csharp/cmfcdropdowntoolbar-class.md).  
  
## Example  
 The following example demonstrates how to use various methods in the `CMFCToolBar` class. The example shows how to set the text of the window label of the tool bar, set the borders, set the style of the pane, and enable the **Add or Remove Buttons** button that appears on the end of the toolbar. This code snippet is part of the [IE Demo sample](../VS_csharp/visual-c---samples.md).  
  
 [!code[NVC_MFC_IEDemo#6](../VS_csharp/codesnippet/CPP/cmfctoolbar-class_1.h)]  
[!code[NVC_MFC_IEDemo#8](../VS_csharp/codesnippet/CPP/cmfctoolbar-class_2.cpp)]  
...
### Remarks  
 ...
 This method increments the command counter by using the [CMFCCmdUsageCount::AddCmd](../VS_csharp/cmfccmdusagecount-class.md#cmfccmdusagecount__addcmd) method.  
...
### Remarks  
 ...
 Override this method to provide your own dynamic layout in classes that you derive from [CMFCToolar](../VS_csharp/cmfctoolbar-class.md).  
...
### Remarks  
 ...
 Override this method in an object derived from [CMFCToolBar](../VS_csharp/cmfctoolbar-class.md) and return `FALSE` when you do not want the user to decide whether text labels are displayed on toolbar buttons under the images.  
...
### Remarks  
 This method is called by the framework to determine whether the list on the toolbar customization page should include a particular object derived from [CMFCToolBar](../VS_csharp/cmfctoolbar-class.md).  
...
### Remarks  
 Use [EnableTextLabels](#cmfctoolbar__enabletextlabels) to specify whether the text is displayed. The default value is `FALSE`. Call [CMFCToolBar::AllowChangeTextLabels](#cmfctoolbar__allowchangetextlabels) to specify whether the user can change this setting in the customization dialog box.  
...
### Remarks  
 ...
 For more information about the `nGrayImagePercentage` parameter, see [CMFCToolBarImages::GrayImages](../VS_csharp/cmfctoolbarimages-class.md#cmfctoolbarimages__grayimages).  
  
##  <a name="cmfctoolbar__buttontoindex"></a>  CMFCToolBar::ButtonToIndex  
 Returns the index of a specified [CMFCToolBarButton](../VS_csharp/cmfctoolbarbutton-class.md) object in this toolbar.  
...
### Remarks  
 ...
 Override this method in a class derived from [CMFCToolBar](../VS_csharp/cmfctoolbar-class.md) to provide your own height calculation.  
...
### Remarks  
 ...
 The default implementation returns `TRUE`. Override this method in a class derived from [CMFCToolBar](../VS_csharp/cmfctoolbar-class.md) to make toolbar objects that cannot be closed by the user.  
...
### Remarks  
 This method overrides the base class implementation, [CBasePane::CanFocus](../VS_csharp/cbasepane-class.md#cbasepane__canfocus), because toolbar objects cannot receive focus.  
...
### Remarks  
 A [CMFCToolBar](../VS_csharp/cmfctoolbar-class.md) object maintains an internal list of the buttons on the toolbar. Call this function to retrieve the index of a button in the list given the command ID of the button.  
...
### Parameters  
 ...
 [in] `dwStyle`  
 The toolbar style. See                                 [Toolbar Control and Button Styles](http://msdn.microsoft.com/library/windows/desktop/bb760439) in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)] for the list of styles.  
...
### Remarks  
 This method creates a control bar and attaches it to the toolbar. It creates the control bar with the `TBSTYLE_FLAT` style. Call [CreateEx](#cmfctoolbar__createex) if you want a different control bar style.  
...
### Remarks  
 ...
 Call this method instead of [Create](#cmfctoolbar__create) when you want to provide specific styles. For example, set `dwCtrlStyle` to `TBSTYLE_FLAT | TBSTYLE_TRANSPARENT` to create a toolbar that resembles the toolbars that are used by Internet Explorer 4.  
  
### Example  
 The following example demonstrates how to use the `CreateEx` method of the `CMFCToolBar` class. This code snippet is part of the [IE Demo sample](../VS_csharp/visual-c---samples.md).  
  
 [!code[NVC_MFC_IEDemo#6](../VS_csharp/codesnippet/CPP/cmfctoolbar-class_1.h)]  
[!code[NVC_MFC_IEDemo#7](../VS_csharp/codesnippet/CPP/cmfctoolbar-class_3.cpp)]  
...
### Remarks  
 ...
 Override this method to customize the appearance of an object derived from [CMFCToolBar](../VS_csharp/cmfctoolbar-class.md).  
...
### Remarks  
 [DoPaint](#cmfctoolbar__dopaint) calls this method for each [CMFCToolbarButton](#cmfctoolbar__drawseparator) object that has the `TBBS_SEPARATOR` style, instead of calling [CMFCToolBar::DrawButton](#cmfctoolbar__drawbutton) for those buttons.  
  
 Override this method in a class derived from [CMFCToolBar](../VS_csharp/cmfctoolbar-class.md) to customize the appearance of separators on the toolbar. The default implementation calls [CMFCVisualManager::OnDrawSeparator](../VS_csharp/cmfcvisualmanager-class.md#cmfcvisualmanager__ondrawseparator) to draw a separator whose appearance is determined by the current visual manager.  
...
### Remarks  
 This method extends the base class implementation, [CBasePane::EnableDocking](../VS_csharp/cbasepane-class.md#cbasepane__enabledocking), by setting the `CBasePane::m_dwControlBarStyle` data member to `AFX_CBRS_FLOAT`. This method then passes `dwAlignment` to the base class implementation.  
  
##  <a name="cmfctoolbar__enablelargeicons"></a>  CMFCToolBar::EnableLargeIcons  
 Enables or disables large icons on toolbar buttons.  
  
```  
void EnableLargeIcons(  
   BOOL bEnable   
);  
```  
...
### Remarks  
 ...
 For more information about command reflection, see [TN062: Message Reflection for Windows Controls](../VS_csharp/tn062--message-reflection-for-windows-controls.md).  
...
### Return Value  
 A constant reference to a [CObList](../VS_csharp/coblist-class.md) object, which contains a collection of [CMFCToolbarButton](../VS_csharp/cmfctoolbarbutton-class.md) objects.  
...
### Return Value  
 A const reference to a [CObList](../VS_csharp/coblist-class.md) object that contains a collection of [CMFCToolbar](../VS_csharp/cmfctoolbar-class.md) objects.  
...
### Return Value  
 A const reference to a [CList](../VS_csharp/clist-class.md) object that contains a collection of basic commands.  
...
##  <a name="cmfctoolbar__getbutton"></a>  CMFCToolBar::GetButton  
 Returns a pointer to the [CMFCToolBarButton](../VS_csharp/cmfctoolbarbutton-class.md) object at a specified index.  
...
### Return Value  
 A [CSize](../VS_csharp/csize-class.md) object that specifies the dimensions of each button on the toolbar.  
...
### Return Value  
 A value that specifies the style of the toolbar button. . See [ToolBar Control Styles](../VS_csharp/toolbar-control-styles.md) for a list of possible styles.  
...
### Parameters  
 ...
 [out] `listButtons`  
 A reference to a [CObList](../VS_csharp/coblist-class.md) object that receives the list of toolbar buttons.  
...
### Remarks  
 Load the disabled toolbar button images by using the [LoadBitmapEx](../VS_csharp/cmfctoolbareditboxbutton-class.md) and [LoadBitmap](#cmfctoolbar__loadbitmap) methods.  
...
### Remarks  
 Load the disabled images by using the [LoadBitmapEx](../VS_csharp/cmfctoolbareditboxbutton-class.md) method.  
...
### Return Value  
 A handle to window that is not derived from [CMFCBaseToolBar](../VS_csharp/cmfcbasetoolbar-class.md), which previously had the input focus; or `NULL` if there is no such window.  
  
### Remarks  
 When a [CMFCToolBar](../VS_csharp/cmfctoolbar-class.md) control receives the input focus, it stores a handle to the window that lost the focus so that it can restore it later.  
...
### Return Value  
 A pointer to the [CMFCToolBarImages](../VS_csharp/cmfctoolbarimages-class.md) object that contains the collection of default images for all toolbars in the application.  
...
### Return Value  
 A [CSize](../VS_csharp/csize-class.md) object that represents the current size of toolbar button images.  
...
### Example  
 The following example demonstrates how to use the `GetItemRect` method of the `CMFCToolBar` class. This code snippet is part of the [IE Demo sample](../VS_csharp/visual-c---samples.md).  
  
 [!code[NVC_MFC_IEDemo#6](../VS_csharp/codesnippet/CPP/cmfctoolbar-class_1.h)]  
[!code[NVC_MFC_IEDemo#9](../VS_csharp/codesnippet/CPP/cmfctoolbar-class_4.cpp)]  
...
### Remarks  
 The framework calls this method when it updates the client area that is associated with a toolbar button. It calls the [CWnd::InvalidateRect](../VS_csharp/cwnd-class.md#cwnd__invalidaterect) method with the client rectangle of the `CMFCToolBarButton` object that exists at the provided index.  
...
### Remarks  
 This static method determines whether the command specified by `uiCmd` belongs to the global list of basic commands. You can change the list of basic commands by calling [AddBasicCommand](#cmfctoolbar__addbasiccommand) or [SetBasicCommands](#cmfctoolbar__setbasiccommands).  
...
### Remarks  
 The toolbar object returns `TRUE` if it can display buttons that have extended borders. A toolbar button calls this method when it handles the [CMFCToolBarButton::OnChangeParentWnd](../VS_csharp/cmfctoolbarbutton-class.md#cmfctoolbarbutton__onchangeparentwnd) notification and will set its internal extra border size flag accordingly. This internal flag may be retrieved later by calling [CMFCToolBarButton::IsExtraSize](../VS_csharp/cmfctoolbarbutton-class.md#cmfctoolbarbutton__isextrasize).  
  
 Override this method in a class derived from [CMFCToolBar](../VS_csharp/cmfctoolbar-class.md) and return `TRUE` if your bar can display the toolbar buttons with the extra border size and return `FALSE` otherwise. The default implementation returns `TRUE`.  
...
### Remarks  
 ...
 The framework changes the mode when the user invokes the customization dialog box ( [CMFCToolBarsCustomizeDialog](../VS_csharp/cmfctoolbarscustomizedialog-class.md)).  
...
### Remarks  
 This method obtains a pointer to a [MSG Structure](../VS_csharp/msg-structure.md) by calling `CWnd::GetCurrentMessage`. It then compares the `HWND` of the button with the `MSG::lParam` and `MSG::hwnd` members to determine whether the button was the source of the command.  
...
### Remarks  
 ...
 The [CWinAppEx::LoadState](../VS_csharp/cwinappex-class.md#cwinappex__loadstate) method calls this method as a part of the initialization process of the application.  
...
### Remarks  
 The framework calls this method as a part of the initialization process of the application. For more information, see [CWinAppEx::LoadState](../VS_csharp/cwinappex-class.md#cwinappex__loadstate).  
...
### Example  
 The following example demonstrates how to use the `LoadToolBar` method in the `CMFCToolBar` class. This code snippet is part of the [IE Demo sample](../VS_csharp/visual-c---samples.md).  
...
##  <a name="cmfctoolbar__onfillbackground"></a>  CMFCToolBar::OnFillBackground  
 Called by the framework from [CBasePane::DoPaint](../VS_csharp/cbasepane-class.md#cbasepane__dopaint) to fill the toolbar background.  
...
### Remarks  
 ...
 The default implementation does nothing. Override `OnReset` in a class derived from [CMFCToolBar](../VS_csharp/cmfctoolbar-class.md) when the toolbar has dummy buttons that must be replaced when the toolbar returns to its original state.  
...
### Remarks  
 ...
 Override `OnUserToolTip` to customize tool tips of toolbar buttons. The default implementation calls [CFrameWndEx::GetToolbarButtonToolTipText](#cmfctoolbar__onusertooltip) to obtain the tooltip text.  
...
### Remarks  
 This method posts a `WM_COMMAND` message to the window that owns the toolbar by calling [CWnd::PostMessage](../VS_csharp/cwnd-class.md#cwnd__postmessage) and passing the command ID of the specified button as the `wParam` parameter.  
  
 Use the [ON_COMMAND](../VS_csharp/on_command.md) macro to map the `WM_COMMAND` message to a member function.  
...
### Parameters  
 ...
 [in] `uiID`  
 The resource ID of the toolbar. If this parameter is -1, this method uses the [CWnd::GetDlgCtrlID](../VS_csharp/cwnd-class.md#cwnd__getdlgctrlid) method to retrieve the resource ID.  
...
### Example  
 The following example demonstrates how to use the `ReplaceButton` method in the `CMFCToolBar` class. This code snippet is part of the [IE Demo sample](../VS_csharp/visual-c---samples.md).  
  
 [!code[NVC_MFC_IEDemo#6](../VS_csharp/codesnippet/CPP/cmfctoolbar-class_1.h)]  
[!code[NVC_MFC_IEDemo#10](../VS_csharp/codesnippet/CPP/cmfctoolbar-class_5.cpp)]  
...
### Remarks  
 The framework calls this method when it saves the application state to the registry. For more information, see [CWinAppEx::SaveState](../VS_csharp/cwinappex-class.md#cwinappex__savestate).  
...
### Parameters  
 ...
 [in] `nStyle`  
 The style of the button. See [ToolBar Control Styles](../VS_csharp/toolbar-control-styles.md) for the list of available toolbar button styles.  
...
### Remarks  
 ...
 This method adds the **Customize** button to the toolbar and sends the `AFX_WM_RESETTOOLBAR` message to the parent window of the toolbar. For more information about the **Customize** button, see [EnableCustomizeButton](#cmfctoolbar__enablecustomizebutton).  
...
### Remarks  
 ...
 This class uses the `CMFCCmdUsageCount` class to track the usage count of commands. For more information about this class, see [CMFCCmdUsageCount Class](../VS_csharp/cmfccmdusagecount-class.md).  
...
### Remarks  
 ...
 For more information about the **Customize** dialog box, see [CMFCToolBarsCustomizeDialog Class](../VS_csharp/cmfctoolbarscustomizedialog-class.md).  
...
## See Also  
 ...
 [CMFCMenuBar](../VS_csharp/cmfcmenubar-class.md)   
 [CMFCPopupMenuBar](../VS_csharp/cmfcpopupmenubar-class.md)   
