...
## Remarks  
 The first constructor is the default constructor, which implictly creates an empty object. The second constructor specifies [__nullptr](../VS_csharp/nullptr---c---component-extensions-.md), which explicitly creates an empty object.  
