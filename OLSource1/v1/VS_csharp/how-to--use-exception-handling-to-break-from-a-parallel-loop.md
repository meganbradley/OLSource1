...
## Example  
 ...
 [!code[concrt-task-tree-search#2](../VS_csharp/codesnippet/CPP/how-to--use-exception-handling-to-break-from-a-parallel-loop_1.cpp)]  
  
## Example  
 The following example shows the `for_all` method. It uses the [concurrency::parallel_for_each](../VS_csharp/parallel_for_each-function.md) algorithm to perform a work function on each node of the tree in parallel.  
  
 [!code[concrt-task-tree-search#1](../VS_csharp/codesnippet/CPP/how-to--use-exception-handling-to-break-from-a-parallel-loop_2.cpp)]  
...
## Example  
 ...
 [!code[concrt-task-tree-search#3](../VS_csharp/codesnippet/CPP/how-to--use-exception-handling-to-break-from-a-parallel-loop_3.cpp)]  
...
## Example  
 ...
 [!code[concrt-task-tree-search#4](../VS_csharp/codesnippet/CPP/how-to--use-exception-handling-to-break-from-a-parallel-loop_4.cpp)]  
  
 This example uses the [concurrency::parallel_invoke](../VS_csharp/parallel_invoke-function.md) algorithm to search for values in parallel. For more information about this algorithm, see [Parallel Algorithms](../VS_csharp/parallel-algorithms.md).  
  
## Example  
 The following complete example uses exception handling to search for values in a basic tree structure.  
  
 [!code[concrt-task-tree-search#5](../VS_csharp/codesnippet/CPP/how-to--use-exception-handling-to-break-from-a-parallel-loop_5.cpp)]  
