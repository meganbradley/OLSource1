...
1.  Supply the missing body or accessor or else use the [abstract](../VS_csharp/abstract--csharp-reference-.md), [extern](../VS_csharp/extern--csharp-reference-.md), or [partial](../VS_csharp/partial--type---csharp-reference-.md) modifiers on it and/or its enclosing type.  
