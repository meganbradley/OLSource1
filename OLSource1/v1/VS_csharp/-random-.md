...
-   For most purposes, URNGs produce raw bits that must be shaped by distributions. (A notable exception to this is [std::shuffle()](../VS_csharp/-algorithm--functions.md#std__shuffle) because it uses a URNG directly.)  
  
-   A single instantiation of a URNG or distribution cannot safely be called concurrently because running a URNG or distribution is a modifying operation. For more information, see [Thread Safety in the C++ Standard Library](../VS_csharp/thread-safety-in-the-c---standard-library.md).  
...
|||  
|-|-|  
|[random_device](../VS_csharp/random_device-class.md)|Generates a non-deterministic, cryptographically secure random sequence by using an external device. Usually used to seed an engine. Low performance, very high quality. For more information, see [Remarks](#comments).|  
...
|||  
|-|-|  
|[linear_congruential_engine](../VS_csharp/linear_congruential_engine-class.md)|Generates a random sequence by using the linear congruential algorithm. Most simplistic and lowest quality.|  
|[mersenne_twister_engine](../VS_csharp/mersenne_twister_engine-class.md)|Generates a random sequence by using the Mersenne twister algorithm. Most complex, and is highest quality except for the random_device class. Very fast performance.|  
|[subtract_with_carry_engine](../VS_csharp/subtract_with_carry_engine-class.md)|Generates a random sequence by using the subtract-with-carry algorithm. An improvement on `linear_congruential_engine`, but much lower quality and performance than `mersenne_twister_engine`.|  
...
|||  
|-|-|  
|[discard_block_engine](../VS_csharp/discard_block_engine-class.md)|Generates a random sequence by discarding values returned by its base engine.|  
|[independent_bits_engine](../VS_csharp/independent_bits_engine-class.md)|Generates a random sequence with a specified number of bits by repacking bits from the values returned by its base engine.|  
|[shuffle_order_engine](../VS_csharp/shuffle_order_engine-class.md)|Generates a random sequence by reordering the values returned from its base engine.|  
...
|||  
|-|-|  
|[uniform_int_distribution](../VS_csharp/uniform_int_distribution-class.md)|Produces a uniform integer value distribution across a range in the closed interval [a, b] (inclusive- inclusive).|  
|[uniform_real_distribution](../VS_csharp/uniform_real_distribution-class.md)|Produces a uniform real (floating-point) value distribution across a range in the interval [a, b) (inclusive-exclusive).|  
|[generate_canonical](../VS_csharp/-random--functions.md#generate_canonical)|Produces an even distribution of real (floating point) values of a given precision across [0, 1) (inclusive-exclusive).|  
...
|||  
|-|-|  
|[bernoulli_distribution](../VS_csharp/bernoulli_distribution-class.md)|Produces a Bernoulli distribution of `bool` values.|  
|[binomial_distribution](../VS_csharp/binomial_distribution-class.md)|Produces a binomial distribution of integer values.|  
|[geometric_distribution](../VS_csharp/geometric_distribution-class.md)|Produces a geometric distribution of integer values.|  
|[negative_binomial_distribution](../VS_csharp/negative_binomial_distribution-class.md)|Produces a negative binomial distribution of integer values.|  
...
|||  
|-|-|  
|[cauchy_distribution](../VS_csharp/cauchy_distribution-class.md)|Produces a Cauchy distribution of real (floating point) values.|  
|[chi_squared_distribution](../VS_csharp/chi_squared_distribution-class.md)|Produces a chi-squared distribution of real (floating point) values.|  
|[fisher_f_distribution](../VS_csharp/fisher_f_distribution-class.md)|Produces an F-distribution (also known as Snedecor's F distribution or the Fisher–Snedecor distribution) of real (floating point) values.|  
|[lognormal_distribution](../VS_csharp/lognormal_distribution-class.md)|Produces a log-normal distribution of real (floating point) values.|  
|[normal_distribution](../VS_csharp/normal_distribution-class.md)|Produces a normal (Gaussian) distribution of real (floating point) values.|  
|[student_t_distribution](../VS_csharp/student_t_distribution-class.md)|Produces a Student's *t*-distribution of real (floating point) values.|  
...
|||  
|-|-|  
|[exponential_distribution](../VS_csharp/exponential_distribution-class.md)|Produces an exponential distribution of real (floating point) values.|  
|[extreme_value_distribution](../VS_csharp/extreme_value_distribution-class.md)|Produces an extreme value distribution of real (floating point) values.|  
|[gamma_distribution](../VS_csharp/gamma_distribution-class.md)|Produces a gamma distribution of real (floating point) values.|  
|[poisson_distribution](../VS_csharp/poisson_distribution-class.md)|Produces a Poisson distribution of integer values.|  
|[weibull_distribution](../VS_csharp/weibull_distribution-class.md)|Produces a Weibull distribution of real (floating point) values.|  
...
|||  
|-|-|  
|[discrete_distribution](../VS_csharp/discrete_distribution-class.md)|Produces a discrete integer distribution.|  
|[piecewise_constant_distribution](../VS_csharp/piecewise_constant_distribution-class.md)|Produces a piecewise constant distribution of real (floating point) values.|  
|[piecewise_linear_distribution](../VS_csharp/piecewise_linear_distribution-class.md)|Produces a piecewise linear distribution of real (floating point) values.|  
...
|||  
|-|-|  
|[seed_seq](../VS_csharp/seed_seq-class.md)|Generates a non-biased scrambled seed sequence. Used to avoid replication of random variate streams. Useful when many URNGs are instantiated from engines.|  
...
-   `template <class Seq> void seed(Seq& q)` seeds the generator by using a [seed_seq](../VS_csharp/seed_seq-class.md)`Seq`.  
...
## See Also  
 [C++ Standard Library Header Files](../VS_csharp/c---standard-library-header-files.md)