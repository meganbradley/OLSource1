...
## Remarks  
 The returned load address is always zero unless specifically set using the [IDiaSession::put_loadAddress](../VS_csharp/idiasession--put_loadaddress.md) method.  
