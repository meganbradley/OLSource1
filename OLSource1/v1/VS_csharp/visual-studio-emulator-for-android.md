...
-   It is not joined to a Windows domain.  
 ...
 For more info on network requirements, see [System requirements for the Visual Studio Emulator for Android](../VS_csharp/system-requirements-for-the-visual-studio-emulator-for-android.md)  
  
 For info on troubleshooting networking issues, see [Troubleshooting the emulator](../VS_csharp/troubleshooting-the-visual-studio-emulator-for-android.md).  
...
##  <a name="Configuring"></a> Configure the Visual Studio Emulator for Android  
 ...
 ![The Visual Studio Emulator for Android Manager](../VS_csharp/media/android_emu_manager.png "Android_Emu_Manager")  
...
## See Also  
 [System Requirements](../VS_csharp/system-requirements-for-the-visual-studio-emulator-for-android.md)   
 [Troubleshooting](../VS_csharp/troubleshooting-the-visual-studio-emulator-for-android.md)