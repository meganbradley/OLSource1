...
-   [Using the Classes to Write Windows Applications](../VS_csharp/using-the-classes-to-write-applications-for-windows.md)  
...
3.  Define your application settings using the [MFC Application Wizard](../VS_csharp/mfc-application-wizard.md).  
