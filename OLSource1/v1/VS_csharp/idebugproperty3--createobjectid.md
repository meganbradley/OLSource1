...
## Remarks  
 ...
 Any unique ID created with `CreateObjectID` is destroyed when the [IDebugProperty3::DestroyObjectID](../VS_csharp/idebugproperty3--destroyobjectid.md) method is called; this also signals the end of the need for uniquely identifying this property.  
...
## See Also  
 ...
 [IDebugProperty3::DestroyObjectID](../VS_csharp/idebugproperty3--destroyobjectid.md)