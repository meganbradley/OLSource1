...
|`Max`|The max class representing the maximum size of the free list. This can be [max_fixed_size](../VS_csharp/max_fixed_size-class.md), [max_none](../VS_csharp/max_none-class.md), [max_unbounded](../VS_csharp/max_unbounded-class.md), or [max_variable_size](../VS_csharp/max_variable_size-class.md).|  
