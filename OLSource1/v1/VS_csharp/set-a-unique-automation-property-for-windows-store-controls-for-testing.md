 ...
 **To give a unique name to existing controls**  
 ...
 ![Choose Name Interactive Elements from Tools menu](../VS_csharp/media/cuit_windowsstoreproperty_blend_1.png "CUIT_WindowsStoreProperty_Blend_1")  
 ...
 **To automatically give a unique name to controls that you create**  
 ...
 ![Set project to name interactive elements](../VS_csharp/media/cuit_windowsstoreproeprty_blend_2.png "CUIT_WindowsStoreProeprty_Blend_2")  
...
## See Also  
 [Testing Windows Store Applications with Coded UI Tests](../VS_csharp/test-windows-store-8.1-apps-with-coded-ui-tests.md)