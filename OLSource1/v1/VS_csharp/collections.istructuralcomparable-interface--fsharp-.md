...
|Member|Description|  
|------------|-----------------|  
|[CompareTo](../VS_csharp/istructuralcomparable.compareto-method--fsharp-.md)|Determines whether the current object precedes, occurs in the same position as, or follows another object in the sort order.|  
