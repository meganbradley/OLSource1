...
The result of the unary 'operator' operator may be unaligned  
 ...
 To resolve C4366, either change the alignment of the structure or declare the pointer with the [__unaligned](../VS_csharp/__unaligned.md) keyword.  
  
 For more information, see __unaligned and [pack](../VS_csharp/pack.md).  
