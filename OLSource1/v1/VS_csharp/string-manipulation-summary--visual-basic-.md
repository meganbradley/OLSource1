...
[!INCLUDE[vbprvb](../VS_csharp/includes/vbprvb_md.md)] language keywords and run-time library members are organized by purpose and use.  
...
|Set string comparison rules.|[Option Compare](../VS_csharp/option-compare-statement.md)|  
