...
|Member|Description|  
|------------|-----------------|  
|[new](../VS_csharp/core.experimentalattribute-constructor--fsharp-.md)|Creates an instance of the attribute|  
  
## Instance Members  
  
|Member|Description|  
|------------|-----------------|  
|[Message](../VS_csharp/experimentalattribute.message-property--fsharp-.md)|Indicates the warning message to be emitted when F# source code uses this construct.|  
