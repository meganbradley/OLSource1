...
apitype: "Assembly"
f1_keywords: 
  - "Microsoft.FSharp.Collections.MapModule.OfSeq``2"
dev_langs: 
  - "FSharp"
helpviewer_keywords: 
  - "FromSequence function [F#]"
  - "Map.ofSeq function [F#]"
  - "Map.FromSequence function [F#]"
  - "ofSeq function [F#]"
...
#### Parameters  
 `elements`  
 Type: [seq](../VS_csharp/collections.seq--t--type-abbreviation--fsharp-.md)`<'Key * 'T>`  
