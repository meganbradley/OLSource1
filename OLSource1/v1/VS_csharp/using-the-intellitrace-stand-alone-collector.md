...
-   Visual Studio Enterprise (but not Professional or Community editions) on a development computer or other computer to open .iTrace files  
    ...
    > [!NOTE]
    >  Make sure to save your symbol (.pdb) files. To debug with IntelliTrace and step through code, you must have the matching source files and symbol files. See [Set up your release to diagnose problems after deployment](../VS_csharp/diagnose-problems-after-deployment.md).  
...
1.  On your app’s server, make sure that PowerShell is enabled. On most versions of Windows Server, you can add this feature in the **Server Manager** administrative tool.  
     ...
     ![Adding PowerShell by using Server Manager](../VS_csharp/media/intellitrace_servermanager_addpowershell.png "INTELLITRACE_ServerManager_AddPowerShell")  
...
> [!NOTE]
>  To debug with IntelliTrace and step through code, you must have the matching source files and symbol files. See [Set up your release to diagnose problems after deployment](../VS_csharp/diagnose-problems-after-deployment.md).  
...
2.  Double-click the .iTrace file outside Visual Studio, or open the file from inside Visual Studio.  
     ...
     Visual Studio shows the **IntelliTrace Summary** page. In most sections, you can review events or other items, choose an item, and start debugging with IntelliTrace at the point where and when an event happened. See [Debug Your App with IntelliTrace Log Files](../VS_csharp/using-saved-intellitrace-data.md).  
  
    > [!NOTE]
    >  To debug with IntelliTrace and step through code, you must have the matching source files and symbol files on your development machine. See [Set up your release to diagnose problems after deployment](../VS_csharp/diagnose-problems-after-deployment.md).  
...
-   *Is there any data that IntelliTrace doesn't collect?*  
     ...
     ![Relationship between Employee and Address](../VS_csharp/media/employeeaddressrelationship.png "EmployeeAddressRelationship")  
...
-   From an IntelliTrace debugging session in Visual Studio Enterprise, see [Record Execution History to Debug Your App with IntelliTrace in Visual Studio](../VS_csharp/intellitrace-features.md).  
...
## Where can I get more information?  
 [Debug Your App with IntelliTrace Log Files](../VS_csharp/using-saved-intellitrace-data.md)  
