...
-   Optional additional brackets enclosing constant expressions.  
 ...
 3. An optional initializer.  See [Initializers](../VS_csharp/initializers.md).  
...
```  
 ...
 ![Conceptual layout of a multi&#45;dimensional array](../VS_csharp/media/vc38rc1.gif "vc38RC1")  
Conceptual Layout of Multidimensional Array  
  
 In declarations of multidimensioned arrays that have an initializer list (as described in [Initializers](../VS_csharp/initializers.md)), the constant expression that specifies the bounds for the first dimension can be omitted. For example:  
...
-   [Using Arrays](../VS_csharp/using-arrays--c---.md)  
  
-   [Arrays in Expressions](../VS_csharp/arrays-in-expressions.md)  
  
-   [Interpretation of Subscript Operator](../VS_csharp/interpretation-of-subscript-operator.md)  
  
-   [Indirection on Array Types](../VS_csharp/indirection-on-array-types.md)  
  
-   [Ordering of C++ Arrays](../VS_csharp/ordering-of-c---arrays.md)  
