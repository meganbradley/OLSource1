 ...
 **Custom**  
 Opens the [Custom Image dialog box](../VS_csharp/custom-image-dialog-box--image-editor-for-icons-.md) in which you can create a new image with a custom size and number of colors.  
