...
Convert a `tm` time structure to a character string. These functions are versions of [asctime, _wasctime](../VS_csharp/asctime--_wasctime.md) with security enhancements as described in [Security Enhancements in the CRT](../VS_csharp/security-features-in-the-crt.md).  
...
## Return Value  
 Zero if successful. If there is a failure, the invalid parameter handler is invoked, as described in [Parameter Validation](../VS_csharp/parameter-validation.md). If execution is allowed to continue, the return value is an error code. Error codes are defined in ERRNO.H. For more information, see [errno Constants](../VS_csharp/errno-constants.md). The actual error codes returned for each error condition are shown in the following table.  
...
|`tm_year`|Year (current year minus 1900)|  
 ...
 The converted character string is also adjusted according to the local time zone settings. See the [time, _time32, _time64](../VS_csharp/time--_time32--_time64.md), [_ftime, _ftime32, _ftime64](../VS_csharp/_ftime--_ftime32--_ftime64.md), and [localtime_s, _localtime32_s, _localtime64_s](../VS_csharp/localtime_s--_localtime32_s--_localtime64_s.md) functions for information about configuring the local time and the [_tzset](../VS_csharp/_tzset.md) function for information about defining the time zone environment and global variables.  
...
## See Also  
 ...
 [ctime_s, _ctime32_s, _ctime64_s, _wctime_s, _wctime32_s, _wctime64_s](../VS_csharp/ctime_s--_ctime32_s--_ctime64_s--_wctime_s--_wctime32_s--_wctime64_s.md)   
