...
|[timer::release_message Method](#timer__release_message_method)|Releases a previous message reservation. (Overrides                                         [source_block::release_message](../VS_csharp/source_block-class.md#source_block__release_message_method).)|  
|[timer::reserve_message Method](#timer__reserve_message_method)|Reserves a message previously offered by this                                         `timer` messaging block. (Overrides                                         [source_block::reserve_message](../VS_csharp/source_block-class.md#source_block__reserve_message_method).)|  
|[timer::resume_propagation Method](#timer__resume_propagation_method)|Resumes propagation after a reservation has been released. (Overrides                                         [source_block::resume_propagation](../VS_csharp/source_block-class.md#source_block__resume_propagation_method).)|  
