...
-   [Stream I/O](../VS_csharp/stream-i-o.md) functions treat data as a stream of individual characters.  
  
-   [Low-level I/O](../VS_csharp/low-level-i-o.md) functions invoke the operating system directly for lower-level operation than that provided by stream I/O.  
  
-   [Console and port I/O](../VS_csharp/console-and-port-i-o.md) functions read or write directly to a console (keyboard and screen) or an I/O port (such as a printer port).  
