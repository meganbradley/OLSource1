...
-   Save files locally, and then publish to a server or use another approach to saving project items when the item represents a data connection to a remote object.  
 ...
 For more information about persistence, see [Project Persistence](../VS_csharp/project-persistence.md) and [Opening and Saving Project Items](../VS_csharp/opening-and-saving-project-items.md).  
