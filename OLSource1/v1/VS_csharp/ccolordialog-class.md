...
>  On some installations the `CColorDialog` object will not display with a gray background if you have used the framework to make other `CDialog` objects gray.  
 ...
 For more information on using `CColorDialog`, see [Common Dialog Classes](../VS_csharp/common-dialog-classes.md)  
 ...
 *clrInit*  
 ...
 `dwFlags`  
 A set of flags that customize the function and appearance of the dialog box. For more information, see the                                 [CHOOSECOLOR](http://msdn.microsoft.com/library/windows/desktop/ms646830) structure in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
  
 `pParentWnd`  
 A pointer to the dialog box's parent or owner window.  
  
### Example  
 [!code[NVC_MFCDocView#49](../VS_csharp/codesnippet/CPP/ccolordialog-class_1.cpp)]  
...
### Example  
 [!code[NVC_MFCDocView#50](../VS_csharp/codesnippet/CPP/ccolordialog-class_2.cpp)]  
...
### Example  
 [!code[NVC_MFCDocView#51](../VS_csharp/codesnippet/CPP/ccolordialog-class_3.cpp)]  
...
### Example  
 [!code[NVC_MFCDocView#53](../VS_csharp/codesnippet/CPP/ccolordialog-class_4.cpp)]  
...
### Example  
 [!code[NVC_MFCDocView#52](../VS_csharp/codesnippet/CPP/ccolordialog-class_5.cpp)]  
