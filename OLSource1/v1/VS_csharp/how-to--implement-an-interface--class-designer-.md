...
> [!TIP]
>  You can create interfaces the same way you create other types. If the interface exists but does not appear on the class diagram, then first display it. For more information, see [How to: Create Types on Class Diagrams](../VS_csharp/how-to--create-types-by-using-class-designer.md) and [How to: View Existing Types](../VS_csharp/how-to--view-existing-types--class-designer-.md).  
...
2.  Draw an inheritance line from the class and the interface.  
 ...
 For more information, see [How to: Define Inheritance Between Types](../VS_csharp/how-to--create-inheritance-between-types--class-designer-.md).  
...
## See Also  
 ...
 [How to: Visualize a Type on the Design Surface](../VS_csharp/how-to--view-existing-types--class-designer-.md)   
 [How to: Define an Inheritance Relationship](../VS_csharp/how-to--create-inheritance-between-types--class-designer-.md)   
 [Refactoring Classes and Types](../VS_csharp/refactoring-classes-and-types--class-designer-.md)