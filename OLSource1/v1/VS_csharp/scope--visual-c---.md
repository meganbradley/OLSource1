...
---
# Scope (Visual C++)
C++ names can be used only in certain regions of a program. This area is called the "scope" of the name. Scope determines the "lifetime" of a name that does not denote an object of static extent. Scope also determines the visibility of a name, when class constructors and destructors are called, and when variables local to the scope are initialized. (For more information, see [Constructors](../VS_csharp/constructors--c---.md) and [Destructors](../VS_csharp/destructors--c---.md).) There are five kinds of scope:  
...
## Hiding Names  
 ...
 ![Block&#45;scope name hiding](../VS_csharp/media/vc38sf1.png "vc38SF1")  
...
>  The reuse of identifier names as shown in this example is considered poor programming style.  
 ...
 For more information about pointers, see [Derived Types](assetId:///aa14183c-02fe-4d81-95fe-beddb0c01c7c). For information about declaration and initialization of class objects, see [Classes, Structures, and Unions](../VS_csharp/classes-and-structs--c---.md). For information about using the **new** and **delete** free-store operators, see [Special Member Functions](../Topic/Special%20Member%20Functions%20\(C++\).md).  
...
## See Also  
 [Basic Concepts](../VS_csharp/basic-concepts---c---.md)