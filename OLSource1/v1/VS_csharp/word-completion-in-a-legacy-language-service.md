...
## Implementing Complete Word in the ParseSource Method  
 ...
 Also look at the example of a <xref:Microsoft.VisualStudio.Package.Declarations*> class implementation in [Supporting IntelliSense Member Completion (Managed Package Framework)](../VS_csharp/member-completion-in-a-legacy-language-service.md).