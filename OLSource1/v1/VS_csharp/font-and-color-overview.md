...
This topic discusses text font and color settings in the [!INCLUDE[vsprvs](../VS_csharp/includes/vsprvs_md.md)] integrated development environment (IDE). It also introduces the concepts of Categories and Display Items, and it describes how VSPackages and the core editor use text attributes.  
  
## The Fonts and Colors Property Page  
 You can manage attributes of displayed text in the [!INCLUDE[vsprvs](../VS_csharp/includes/vsprvs_md.md)] integrated development environment (IDE) through the **Fonts and Colors** property page. To find the **Fonts and Colors** property page, on the **Tools** menu, click **Options**. Expand **Environment**, and then click **Fonts and Colors**.  
...
## VSPackage Control of Fonts and Colors  
 The [!INCLUDE[vsipsdk](../VS_csharp/includes/vsipsdk_md.md)] allows VSPackages to:  
...
-   Persist changes in default settings.  
 ...
 There are two ways to interact with font and color selections within the [!INCLUDE[vsipsdk](../VS_csharp/includes/vsipsdk_md.md)].  
  
-   One way is referred to as *Syntax Coloring*. It is used by a VSPackage that customizes the existing [!INCLUDE[vsprvs](../VS_csharp/includes/vsprvs_md.md)] editor to implement a language service and create a source editor.  
...
-   The ability to both use built-in display items from the **Text EditorCategory** and to extend them.  
     ...
     For more information, see [How to: Use Built-In Colorable Items](../VS_csharp/how-to--use-built-in-colorable-items.md) and [Custom Colorable Items](../VS_csharp/custom-colorable-items.md).  
  
-   Automatic persistence of the current state of both built-in and custom display items with the **Text Editor** category.  
  
 For more information on syntax coloring see [Providing A Syntax Coloring Service](../VS_csharp/syntax-coloring-in-a-legacy-language-service.md).  
  
## See Also  
 [Custom Editors](../VS_csharp/legacy-interfaces-in-the-editor.md)   
 [Providing A Syntax Coloring Service](../VS_csharp/syntax-coloring-in-a-legacy-language-service.md)