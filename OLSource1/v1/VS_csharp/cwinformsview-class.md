...
> [!NOTE]
>  CWinFormsView does not support the MFC splitter window ( [CSplitterWnd Class](../VS_csharp/csplitterwnd-class.md)). Currently only the Windows Forms Splitter control ( <xref:System.Windows.Forms.Splitter*>) is supported.  
...
### Example  
 ...
 [!code[NVC_MFC_Managed#1](../VS_csharp/codesnippet/CPP/cwinformsview-class_1.h)]  
  
 [!code[NVC_MFC_Managed#2](../VS_csharp/codesnippet/CPP/cwinformsview-class_2.cpp)]  
...
### Remarks  
 For an example of how to use Windows Forms, see [Using a Windows Form User Control in MFC](../VS_csharp/using-a-windows-form-user-control-in-mfc.md).  
