...
|----------------------|---------------|-----------------|  
|binmode.obj|pbinmode.obj|Sets the default file-translation mode to binary. See [_fmode](../VS_csharp/_fmode.md).|  
|chkstk.obj|n/a|Provides stack-checking and alloca support when not using the CRT.|  
|commode.obj|pcommode.obj|Sets the global commit flag to "commit". See [fopen, _wfopen](../VS_csharp/fopen--_wfopen.md) and [fopen_s, _wfopen_s](../VS_csharp/fopen_s--_wfopen_s.md).|  
|fp10.obj|n/a|Changes the default precision control to 64 bits. See [Floating-Point Support](../VS_csharp/floating-point-support.md).|  
...
|newmode.obj|pnewmode.obj|Causes [malloc](../VS_csharp/malloc.md) to call the new handler on failure. See [_set_new_mode](../VS_csharp/_set_new_mode.md), [_set_new_handler](../VS_csharp/_set_new_handler.md), [calloc](../VS_csharp/calloc.md), and [realloc](../VS_csharp/realloc.md).|  
...
|nothrownew.obj|pnothrownew.obj|Enables the non-throwing version of new in the CRT. See [The new and delete Operators](../VS_csharp/new-and-delete-operators.md).|  
|setargv.obj|psetargv.obj|Enables command-line argument wildcard expansion. See [Expanding Wildcard Arguments](../VS_csharp/expanding-wildcard-arguments.md).|  
...
|wsetargv.obj|pwsetargv.obj|Enables command-line argument wildcard expansion. See [Expanding Wildcard Arguments](../VS_csharp/expanding-wildcard-arguments.md).|  
