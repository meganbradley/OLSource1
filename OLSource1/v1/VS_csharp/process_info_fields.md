...
## Members  
 PIF_FILE_NAME  
 Initialize/use the `bstrFileName` field of the [PROCESS_INFO](../VS_csharp/process_info.md) structure.  
...
## Remarks  
 Passed to the [GetInfo](../VS_csharp/idebugprocess2--getinfo.md) method to indicate which fields of the [PROCESS_INFO](../VS_csharp/process_info.md) structure are to be initialized.  
