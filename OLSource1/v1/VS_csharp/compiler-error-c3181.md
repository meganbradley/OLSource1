...
'type' : invalid operand for operator  
 ...
 An invalid parameter was passed to the [__typeof](../Topic/__typeof.md) or [typeid](../VS_csharp/typeid---c---component-extensions-.md) operator. The parameter must be a managed type.  
