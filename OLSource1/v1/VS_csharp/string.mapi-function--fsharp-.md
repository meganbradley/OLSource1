...
#### Parameters  
 `mapping`  
 Type: [int](../VS_csharp/core.int-type-abbreviation--fsharp-.md) `->` [char](../VS_csharp/core.char-type-abbreviation--fsharp-.md) `->` [char](../VS_csharp/core.char-type-abbreviation--fsharp-.md)  
...
## Example  
 ...
 [!code[FsStrings#10](../VS_csharp/codesnippet/FSharp/string.mapi-function--fsharp-_1.fs)]  
