...
Visual Studio*Graphics Diagnostics* is a set of tools for recording and then analyzing rendering and performance problems in Direct3D apps. Graphics Diagnostics can be used on apps that are running locally on your Windows PC, in a Windows device emulator, or on a remote PC or device.  
 ...
 Continue to [Overview of Visual Studio Graphics Diagnostics](../VS_csharp/overview-of-visual-studio-graphics-diagnostics.md) to learn more about what Visual Studio Graphics Diagnostics offers.  
  
## In This Section  
 [Overview of Visual Studio Graphics Diagnostics](../VS_csharp/overview-of-visual-studio-graphics-diagnostics.md)  
 Introduces the Graphics Diagnostics workflow and tools.  
  
 [Getting Started with Visual Studio Graphics diagnostics](../VS_csharp/getting-started-with-visual-studio-graphics-diagnostics.md)  
 ...
 [GPU Usage](../VS_csharp/gpu-usage.md)  
 ...
 [Graphics Log Document](../VS_csharp/graphics-log-document.md)  
 ...
 [Graphics Frame Analysis](../VS_csharp/graphics-frame-analysis.md)  
 After you select a frame, you use Graphics Frame Analysis to examine and tune your rendering performance.  
  
 [Graphics Event List](../VS_csharp/graphics-event-list.md)  
 ...
 [Graphics State](../VS_csharp/graphics-state.md)  
 The State window helps you understand the graphics state that is active at the time of the current event.  
  
 [Graphics Pipeline Stages](../VS_csharp/graphics-pipeline-stages.md)  
 ...
 [Graphics Event Call Stack](../VS_csharp/graphics-event-call-stack.md)  
 ...
 [Graphics Pixel History](../VS_csharp/graphics-pixel-history.md)  
 ...
 [Graphics Object Table](../VS_csharp/graphics-object-table.md)  
 ...
 [Graphics Diagnostics Examples](../VS_csharp/graphics-diagnostics-examples.md)  
...
|Title|Description|  
|-----------|-----------------|  
|[Debugging in Visual Studio](../VS_csharp/debugging-in-visual-studio.md)|Introduces the debugging functionality in [!INCLUDE[vsprvs](../VS_csharp/includes/vsprvs_md.md)].|  
