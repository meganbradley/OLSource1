...
#### Parameters  
 `format`  
 Type: [StringFormat](../VS_csharp/printf.stringformat--t--type-abbreviation--fsharp-.md)`<'T>`  
...
## Example  
 ...
 [!code[FsCoreLib2#10](../VS_csharp/codesnippet/FSharp/extratopleveloperators.sprintf--t--function--fsharp-_1.fs)]  
