...
-   Windows can automatically scale content up to 250% on new devices that exceed 280 ppi (as of Windows 8.1 S14).  
 ...
 ![DPI Issues Fuzzy](../VS_csharp/media/dpi-issues-fuzzy.png "DPI Issues Fuzzy")  
...
```  
 ...
 ![DPI Issues Scaling](../VS_csharp/media/dpi-issues-scaling.png "DPI Issues Scaling")  
...
## Special case: prescaling WPF images for large DPI levels  
 ...
 ![DPI Issues Double Scaling Example](../VS_csharp/media/dpi-issues-double-scaling-example.png "DPI Issues Double Scaling Example")  
