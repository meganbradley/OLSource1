...
-   [omp_init_nest_lock](../VS_csharp/omp_init_nest_lock.md)  
  
-   [omp_destroy_nest_lock](../VS_csharp/omp_destroy_nest_lock.md)  
  
-   [omp_set_nest_lock](../VS_csharp/omp_set_nest_lock.md)  
  
-   [omp_unset_nest_lock](../VS_csharp/omp_unset_nest_lock.md)  
  
-   [omp_test_nest_lock](../VS_csharp/omp_test_nest_lock.md)  
  
 For more information, see [3.2 Lock Functions](../VS_csharp/3.2-lock-functions.md).  
  
## Example  
 See [omp_init_nest_lock](../VS_csharp/omp_init_nest_lock.md) for an example of using **omp_nest_lock_t**.  
