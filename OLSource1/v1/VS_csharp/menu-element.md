...
|CommandFlag|Required. See [CommandFlag Element](../VS_csharp/command-flag-element.md). The valid CommandFlag values for a Menu are as follows:<br /><br /> -   **AlwaysCreate**<br />-   **DefaultDocked**<br />-   **DefaultInvisible** - This flag does not affect the display of toolbars.<br />-   **DontCache**<br />-   **DynamicVisibility** - This flag does not affect the display of toolbars.<br />-   **IconAndText**<br />-   **NoCustomize**<br />-   **NotInTBList**<br />-   **NoToolbarClose**<br />-   **TextChanges**<br />-   **TextIsAnchorCommand**|  
|Strings|Required. See [Strings Element](../VS_csharp/strings-element.md). The child `ButtonText` element must be defined.|  
...
|Element|Description|  
|-------------|-----------------|  
|[Menus Element](../VS_csharp/menus-element.md)|Defines all the menus that a VSPackage implements.|  
