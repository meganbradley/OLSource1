...
---
# AfxWinInit
This function is called by the MFC-supplied `WinMain` function, as part of the [CWinApp](../VS_csharp/cwinapp-class.md) initialization of a GUI-based application, to initialize MFC.  
...
## Example  
 [!code[NVC_MFC_AfxWinInit#1](../VS_csharp/codesnippet/CPP/afxwininit_1.cpp)]  
