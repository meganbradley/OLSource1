...
This article describes the process for accessing the exposed [methods](../VS_csharp/mfc-activex-controls--methods.md) and [properties](../VS_csharp/mfc-activex-controls--properties.md) of embedded ActiveX controls. Basically, you will follow these steps:  
  
1.  [Insert an ActiveX control into the ActiveX container project](../VS_csharp/activex-control-containers--inserting-a-control-into-a-control-container-application.md) using Gallery.  
  
2.  [Define a member variable](../VS_csharp/activex-control-containers--connecting-an-activex-control-to-a-member-variable.md) (or other form of access) of the same type as the ActiveX control wrapper class.  
...
## Modifications to the Project  
 ...
 [!code[NVC_MFC_AxCont#1](../VS_csharp/codesnippet/CPP/activex-control-containers--programming-activex-controls-in-an-activex-control-container_1.h)]  
...
##  <a name="_core_the_wrapper_class_header_28h29_file"></a> The Wrapper Class Header (.H) File  
 ...
 [!code[NVC_MFC_AxCont#2](../VS_csharp/codesnippet/CPP/activex-control-containers--programming-activex-controls-in-an-activex-control-container_2.h)]  
[!code[NVC_MFC_AxCont#3](../VS_csharp/codesnippet/CPP/activex-control-containers--programming-activex-controls-in-an-activex-control-container_3.h)]  
...
##  <a name="_core_member_variable_modifications_to_the_project"></a> Member Variable Modifications to the Project  
 Once the ActiveX control has been added to the project and embedded in a dialog box container, it can be accessed by other parts of the project. The easiest way to access the control is to [create a member variable](../VS_csharp/activex-control-containers--connecting-an-activex-control-to-a-member-variable.md) of the dialog class, `CContainerDlg` (step 2), that is of the same type as the wrapper class added to the project by Visual C++. You can then use the member variable to access the embedded control at any time.  
 ...
 [!code[NVC_MFC_AxCont#4](../VS_csharp/codesnippet/CPP/activex-control-containers--programming-activex-controls-in-an-activex-control-container_4.h)]  
[!code[NVC_MFC_AxCont#5](../VS_csharp/codesnippet/CPP/activex-control-containers--programming-activex-controls-in-an-activex-control-container_5.h)]  
  
 In addition, a call to **DDX_Control** is automatically added to the `CContainerDlg`'s implementation of `DoDataExchange`:  
  
 [!code[NVC_MFC_AxCont#6](../VS_csharp/codesnippet/CPP/activex-control-containers--programming-activex-controls-in-an-activex-control-container_6.cpp)]  
...
##  <a name="_core_programming_the_activex_control"></a> Programming the ActiveX Control  
 ...
 [!code[NVC_MFC_AxCont#7](../VS_csharp/codesnippet/CPP/activex-control-containers--programming-activex-controls-in-an-activex-control-container_7.cpp)]  
