...
## Remarks  
 The `VSTextBuffer` is usually found by a `QueryInterface` call on `IVsTextBuffer`. For more information, see [Text Buffer](../VS_csharp/accessing-the-text-buffer-by-using-the-legacy-api.md).  
