 ...
 *delegate*  
 The [delegate](../VS_csharp/delegate---c---component-extensions-.md), whose signature the event handler must match.  
 ...
 *event block*  
 ...
 `event` is a context-sensitive keyword; see [Context-Sensitive Keywords](../VS_csharp/context-sensitive-keywords---c---component-extensions-.md) for more information.  
...
4.  Use the event:  
 ...
 For more information on [!INCLUDE[cppcli](../VS_csharp/includes/cppcli_md.md)] events, see  
  
-   [Events in an Interface](../VS_csharp/how-to--use-events-in-c---cli.md)  
