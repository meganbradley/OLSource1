...
A managed package framework (MPF) language service can support one or more [!INCLUDE[vsprvs](../VS_csharp/includes/vsprvs_md.md)] features, such as syntax highlighting, IntelliSense, and breakpoint validation. Each feature can be implemented independent of the others but all require a parser and a scanner except for syntax highlighting, which requires only a scanner.  
...
## In This Section  
 ...
 [Supporting the Navigation Bar](../VS_csharp/support-for-the-navigation-bar-in-a-legacy-language-service.md)  
