...
```  
 ...
 For more information, see [File System Navigation](../VS_csharp/file-system-navigation.md).  
...
## See Also  
 [path Class (C++ Standard Template Library)](../VS_csharp/path-class--c---standard-template-library-.md)   
