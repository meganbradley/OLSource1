...
1.  Follow the instructions in the topic [Creating a Project with a Visual C++ Application Wizard](../VS_csharp/creating-desktop-projects-by-using-application-wizards.md).  
  
2.  Select the **ATL Project** icon in the Templates pane to open the ATL Project Wizard.  
  
3.  Define your application settings using the [Application Settings](../VS_csharp/application-settings--atl-project-wizard.md) page of the `ATL Project Wizard`.  
