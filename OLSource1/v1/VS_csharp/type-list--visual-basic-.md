...
|-|-|  
|Term|Definition|  
|`genericmodifier`|Optional. Can be used only in generic interfaces and delegates. You can declare a type covariant by using the [Out](../VS_csharp/out--generic-modifier---visual-basic-.md) keyword or contravariant by using the [In](../VS_csharp/in--generic-modifier---visual-basic-.md) keyword. See [Covariance and Contravariance (C# and Visual Basic)](../VS_csharp/covariance-and-contravariance--csharp-and-visual-basic-.md).|  
...
|`constraintlist`|Optional. List of requirements that constrain the data type that can be supplied for `typename`. If you have multiple constraints, enclose them in curly braces (`{ }`) and separate them with commas. You must introduce the constraint list with the [As](../VS_csharp/as-clause--visual-basic-.md) keyword. You use `As` only once, at the beginning of the list.|  
...
## Remarks  
 ...
 For more information on when to define a generic type, see [Generic Types in Visual Basic](../VS_csharp/generic-types-in-visual-basic--visual-basic-.md). For more information on type parameter names, see [Declared Element Names](../VS_csharp/declared-element-names--visual-basic-.md).  
  
## Rules  
  
-   **Parentheses.** If you supply a type parameter list, you must enclose it in parentheses, and you must introduce the list with the [Of](../VS_csharp/of-clause--visual-basic-.md) keyword. You use `Of` only once, at the beginning of the list.  
...
-   **Absence of Constraints.** If you do not specify any constraints on a type parameter, your code is limited to the operations and members supported by the [Object Data Type](../VS_csharp/object-data-type.md) for that type parameter.  
...
## Example  
 ...
 [!code[VbVbalrStatements#3](../VS_csharp/codesnippet/VisualBasic/type-list--visual-basic-_1.vb)]  
...
## Example  
 ...
 [!code[VbVbalrStatements#4](../VS_csharp/codesnippet/VisualBasic/type-list--visual-basic-_2.vb)]  
  
## Example  
 The following example shows the equivalent skeleton definition generated by the preceding example.  
  
 [!code[VbVbalrStatements#5](../VS_csharp/codesnippet/VisualBasic/type-list--visual-basic-_3.vb)]  
