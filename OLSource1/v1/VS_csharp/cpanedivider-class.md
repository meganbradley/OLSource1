...
|[CPaneDivider::CalcFixedLayout](#cpanedivider__calcfixedlayout)|(Overrides [CBasePane::CalcFixedLayout](../VS_csharp/cbasepane-class.md#cbasepane__calcfixedlayout).)|  
|[CPaneDivider::CheckVisibility](#cpanedivider__checkvisibility)||  
|[CPaneDivider::CreateEx](#cpanedivider__createex)|(Overrides [CBasePane::CreateEx](../VS_csharp/cbasepane-class.md#cbasepane__createex).)|  
|[CPaneDivider::DoesAllowDynInsertBefore](#cpanedivider__doesallowdyninsertbefore)|(Overrides [CBasePane::DoesAllowDynInsertBefore](../VS_csharp/cbasepane-class.md#cbasepane__doesallowdyninsertbefore).)|  
...
|[CPaneDivider::IsAutoHideMode](#cpanedivider__isautohidemode)|(Overrides [CBasePane::IsAutoHideMode](../VS_csharp/cbasepane-class.md#cbasepane__isautohidemode).)|  
|[CPaneDivider::IsDefault](#cpanedivider__isdefault)||  
|[CPaneDivider::IsHorizontal](#cpanedivider__ishorizontal)|(Overrides [CBasePane::IsHorizontal](../VS_csharp/cbasepane-class.md#cbasepane__ishorizontal).)|  
...
|Name|Description|  
|----------|-----------------|  
|[CPaneDivider::GetPanes](#cpanedivider__getpanes)|Returns the list of panes that reside in the [CPaneContainer](../VS_csharp/cpanecontainer-class.md). This method should be called only for default pane dividers.|  
|[CPaneDivider::GetPaneDividers](#cpanedivider__getpanedividers)|Returns the list of pane dividers that reside in the [CPaneContainer](../VS_csharp/cpanecontainer-class.md). This method should be called only for default pane dividers.|  
...
-   a default pane divider is created when a group of panes is docked to a side of the main frame window. The default pane divider holds a pointer to the [CPaneContainerManager](../VS_csharp/cpanecontainermanager-class.md) and redirects most operations on the group of panes (such as resizing a pane, or docking another pane or container) to the container manager. Each docking pane maintains a pointer to its default pane divider.  
  
-   A regular pane divider just divides two panes in a container. For more information, see [CPaneContainer](../VS_csharp/cpanecontainer-class.md).  
  
## Example  
 The following example demonstrates how to get a `CPaneDivider` object from a `CWorkspaceBar` object. This code snippet is part of the [MDI Tabs Demo sample](../VS_csharp/visual-c---samples.md).  
  
 [!code[NVC_MFC_MDITabsDemo#5](../VS_csharp/codesnippet/CPP/cpanedivider-class_1.cpp)]  
  
## Inheritance Hierarchy  
 [CObject](../VS_csharp/cobject-class.md) [CCmdTarget](../VS_csharp/ccmdtarget-class.md) [CWnd](../VS_csharp/cwnd-class.md)  
  
 [CBasePane](../VS_csharp/cbasepane-class.md) [CPaneDivider](../VS_csharp/cpanedivider-class.md)  
...
##  <a name="cpanedivider__getpanedividers"></a>  CPaneDivider::GetPaneDividers  
 Returns the list of pane dividers that reside in the [CPaneContainer](../VS_csharp/cpanecontainer-class.md). This method should be called only for default pane dividers.  
...
##  <a name="cpanedivider__getpanes"></a>  CPaneDivider::GetPanes  
 Returns the list of panes that reside in the [CPaneContainer](../VS_csharp/cpanecontainer-class.md). This method should be called only to retrieve default pane dividers.  
...
## See Also  
 ...
 [CPaneContainerManager](../VS_csharp/cpanecontainermanager-class.md)   
 [CPaneContainer](../VS_csharp/cpanecontainer-class.md)   
 [CDockingManager Class](../VS_csharp/cdockingmanager-class.md)   
