...
cannot write to file 'filename' [: reason]  
 ...
 If the problem is caused by more than 4092 .sbr files, you must reduce the number of input files. From within Visual Studio, this can be accomplished by [/FR](../VS_csharp/-fr---fr--create-.sbr-file-.md) your entire project, then recheck on a file by file basis.  
