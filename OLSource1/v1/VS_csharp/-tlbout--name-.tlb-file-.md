...
## Remarks  
 ...
 The MIDL compiler is called by the Visual C++ linker when linking projects that have the [module](../VS_csharp/module--c---.md) attribute.  
  
 If /TLBOUT is not specified, the .tlb file will get its name from [/IDLOUT](../VS_csharp/-idlout--name-midl-output-files-.md) *filename*. If /IDLOUT is not specified, the .tlb file will be called vc70.tlb.  
...
## See Also  
 ...
 [/IGNOREIDL (Don't Process Attributes into MIDL)](../VS_csharp/-ignoreidl--don-t-process-attributes-into-midl-.md)   
