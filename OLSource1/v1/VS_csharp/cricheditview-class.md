...
---
# CRichEditView Class
With [CRichEditDoc](../VS_csharp/cricheditdoc-class.md) and [CRichEditCntrItem](../VS_csharp/cricheditcntritem-class.md), provides the functionality of the rich edit control within the context of MFC's document view architecture.  
...
|[CRichEditView::GetDocument](#cricheditview__getdocument)|Retrieves a pointer to the related [CRichEditDoc](../VS_csharp/cricheditdoc-class.md).|  
...
## Remarks  
 ...
 For an example of using a rich edit view in an MFC application, see the [WORDPAD](../VS_csharp/visual-c---samples.md) sample application.  
...
### Parameters  
 `dataobj`  
 The [COleDataObject](../VS_csharp/coledataobject-class.md) containing the data to paste.  
...
### Example  
 [!code[NVC_MFCDocView#151](../VS_csharp/codesnippet/CPP/cricheditview-class_1.cpp)]  
...
### Remarks  
 For more information, see the                         [EM_GETCHARFORMAT](http://msdn.microsoft.com/library/windows/desktop/bb788026) message and the                         [CHARFORMAT2](http://msdn.microsoft.com/library/windows/desktop/bb787883) structure in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
  
### Example  
 [!code[NVC_MFCDocView#152](../VS_csharp/codesnippet/CPP/cricheditview-class_2.cpp)]  
...
### Return Value  
 An `HRESULT` value reporting the success of the operation. For more information on `HRESULT`, see                         [Structure of COM Error Codes](http://msdn.microsoft.com/library/windows/desktop/ms690088) in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Remarks  
 ...
 For more information, see                         [IRichEditOle::GetClipboardData](http://msdn.microsoft.com/library/windows/desktop/bb774341),                         [IRichEditOleCallback::GetClipboardData](http://msdn.microsoft.com/library/windows/desktop/bb774315), and                         [CHARRANGE](http://msdn.microsoft.com/library/windows/desktop/bb787885) in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)] and see                         [IDataObject](http://msdn.microsoft.com/library/windows/desktop/ms688421) in the [!INCLUDE[winsdkshort](../VS_csharp/includes/winsdkshort_md.md)].  
...
-   `SEL_MULTIOBJECT` Indicates that the current selection contains more than one OLE object.  
 ...
 For more information, see                         [IRichEditOleCallback::GetContextMenu](http://msdn.microsoft.com/library/windows/desktop/bb774317) and                         [CHARRANGE](http://msdn.microsoft.com/library/windows/desktop/bb787885) in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Return Value  
 Pointer to a [CRichEditDoc](../VS_csharp/cricheditdoc-class.md) object associated with your `CRichEditView` object.  
...
### Return Value  
 A pointer to the single, in-place active [CRichEditCntrItem](../VS_csharp/cricheditcntritem-class.md) object in this rich edit view; **NULL** if there is no OLE item currently in the in-place active state.  
...
### Example  
 [!code[NVC_MFCDocView#153](../VS_csharp/codesnippet/CPP/cricheditview-class_3.cpp)]  
...
### Remarks  
 For more information, see                         [EM_GETPARAFORMAT](http://msdn.microsoft.com/library/windows/desktop/bb774182) message and                         [PARAFORMAT2](http://msdn.microsoft.com/library/windows/desktop/bb787942) structure in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Example  
 [!code[NVC_MFCDocView#154](../VS_csharp/codesnippet/CPP/cricheditview-class_4.cpp)]  
...
##  <a name="cricheditview__getricheditctrl"></a>  CRichEditView::GetRichEditCtrl  
 Call this function to retrieve the [CRichEditCtrl](../VS_csharp/cricheditctrl-class.md) object associated with the `CRichEditView` object.  
...
### Return Value  
 Pointer to a [CRichEditCntrItem](../VS_csharp/cricheditcntritem-class.md) object selected in the `CRichEditView` object; **NULL** if no item is selected in this view.  
...
### Remarks  
 `GetTextLengthEx` provides additional ways of determining the length of the text. It supports the Rich Edit 2.0 functionality. For more information, see                         [About Rich Edit Controls](http://msdn.microsoft.com/library/windows/desktop/bb787873) in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
  
##  <a name="cricheditview__insertfileasobject"></a>  CRichEditView::InsertFileAsObject  
 Call this function to insert the specified file (as a [CRichEditCntrItem](../VS_csharp/cricheditcntritem-class.md) object) into a rich edit view.  
...
##  <a name="cricheditview__insertitem"></a>  CRichEditView::InsertItem  
 Call this function to insert a [CRichEditCntrItem](../VS_csharp/cricheditcntritem-class.md) object into a rich edit view.  
...
### Remarks  
 For more information on `HRESULT`, see                         [Structure of COM Error Codes](http://msdn.microsoft.com/library/windows/desktop/ms690088) in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Remarks  
 ...
 For more information on the `dwMask` and `dwEffect` parameters and their potential values, see the corresponding data members of                         [CHARFORMAT](http://msdn.microsoft.com/library/windows/desktop/bb787881) in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
  
### Example  
 [!code[NVC_MFCDocView#155](../VS_csharp/codesnippet/CPP/cricheditview-class_5.cpp)]  
...
### Remarks  
 Typically, you would do this by creating a [COleStreamFile](../VS_csharp/colestreamfile-class.md) around the `IStorage`. The `COleStreamFile` can be attached to an archive and [CObject::Serialize](../VS_csharp/cobject-class.md#cobject__serialize) called to load the data.  
  
 This is an advanced overridable.  
  
 For more information, see                         [IStorage](http://msdn.microsoft.com/library/windows/desktop/aa380015) in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Example  
 [!code[NVC_MFCDocView#156](../VS_csharp/codesnippet/CPP/cricheditview-class_6.cpp)]  
...
### Parameters  
 `dcPrinter`  
 A [CDC](../VS_csharp/cdc-class.md) object for the new printer.  
...
### Remarks  
 ...
 For more information, see                         [MessageBeep](http://msdn.microsoft.com/library/windows/desktop/ms680356) in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
  
### Example  
 [!code[NVC_MFCDocView#157](../VS_csharp/codesnippet/CPP/cricheditview-class_7.cpp)]  
...
### Parameters  
 `pCmdUI`  
 Pointer to a [CCmdUI](../VS_csharp/ccmdui-class.md) object.  
...
### Example  
 [!code[NVC_MFCDocView#158](../VS_csharp/codesnippet/CPP/cricheditview-class_8.cpp)]  
...
### Example  
 [!code[NVC_MFCDocView#159](../VS_csharp/codesnippet/CPP/cricheditview-class_9.cpp)]  
 ...
 *rectLayout*  
 [RECT](../VS_csharp/rect-structure.md) or [CRect](../VS_csharp/crect-class.md) which defines the output area.  
...
### Remarks  
 Typically, this call is followed by a call to [CRichEditCtrl::DisplayBand](../VS_csharp/cricheditctrl-class.md#cricheditctrl__displayband) which generates the output.  
...
### Remarks  
 The layout of each page is controlled by [GetPageRect](#cricheditview__getpagerect) and [GetPrintRect](#cricheditview__getprintrect). Typically, this call is followed by a call to [CRichEditCtrl::DisplayBand](../VS_csharp/cricheditctrl-class.md#cricheditctrl__displayband) which generates the output.  
...
### Remarks  
 ...
 For more information on `HRESULT` and `IDataObject`, see                         [Structure of COM Error Codes](http://msdn.microsoft.com/library/windows/desktop/ms690088) and                         [IDataObject](http://msdn.microsoft.com/library/windows/desktop/ms688421), respectively, in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
  
### Example  
 [!code[NVC_MFCDocView#160](../VS_csharp/codesnippet/CPP/cricheditview-class_10.cpp)]  
...
### Remarks  
 ...
 For more information, see                         [EM_SETCHARFORMAT](http://msdn.microsoft.com/library/windows/desktop/bb774230) message and                         [CHARFORMAT2](http://msdn.microsoft.com/library/windows/desktop/bb787883) structure in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Example  
 [!code[NVC_MFCDocView#161](../VS_csharp/codesnippet/CPP/cricheditview-class_11.cpp)]  
...
### Remarks  
 ...
 For more information, see                         [EM_SETPARAFORMAT](http://msdn.microsoft.com/library/windows/desktop/bb774276) message and                         [PARAFORMAT2](http://msdn.microsoft.com/library/windows/desktop/bb787942) structure in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
  
### Example  
 [!code[NVC_MFCDocView#162](../VS_csharp/codesnippet/CPP/cricheditview-class_12.cpp)]  
  
##  <a name="cricheditview__textnotfound"></a>  CRichEditView::TextNotFound  
 Call this function to reset the internal search state of the [CRichEditView](../VS_csharp/cricheditview-class.md) control after a failed call to [FindText](#cricheditview__findtext).  
...
### Example  
 [!code[NVC_MFCDocView#163](../VS_csharp/codesnippet/CPP/cricheditview-class_13.cpp)]  
