...
1.  In the [Dialog editor](../VS_csharp/dialog-editor.md), select a control.  
  
2.  While pressing the **CTRL** key, double-click the dialog box control.  
  
     The [Add Member Variable wizard](../VS_csharp/add-member-variable-wizard.md) appears.  
  
3.  Type the appropriate information in the **Add Member Variable** wizard. For more information, see [Dialog Data Exchange](../VS_csharp/dialog-data-exchange.md).  
...
## See Also  
 ...
 [MFC Class Wizard](../VS_csharp/mfc-class-wizard.md)   
