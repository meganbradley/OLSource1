...
|[CRgn::CreateEllipticRgnIndirect](#crgn__createellipticrgnindirect)|Initializes a `CRgn` object with an elliptical region defined by a [RECT](../VS_csharp/rect-structure.md) structure.|  
...
|[CRgn::CreateRectRgnIndirect](#crgn__createrectrgnindirect)|Initializes a `CRgn` object with a rectangular region defined by a [RECT](../VS_csharp/rect-structure.md) structure.|  
...
## Remarks  
 ...
 For more information on using `CRgn`, see [Graphic Objects](../VS_csharp/graphic-objects.md).  
...
### Example  
 [!code[NVC_MFCDocView#144](../VS_csharp/codesnippet/CPP/crgn-class_1.cpp)]  
...
### Example  
 [!code[NVC_MFCDocView#145](../VS_csharp/codesnippet/CPP/crgn-class_2.cpp)]  
...
### Parameters  
 *lpXForm*  
 Points to an [XFORM](../VS_csharp/xform-structure.md) data structure that defines the transformation to be performed on the region. If this pointer is **NULL**, the identity transformation is used.  
  
 `nCount`  
 Specifies the number of bytes pointed to by `pRgnData`.  
  
 `pRgnData`  
 Points to a [RGNDATA](../VS_csharp/rgndata-structure.md) data structure that contains the region data.  
...
### Example  
 [!code[NVC_MFCDocView#146](../VS_csharp/codesnippet/CPP/crgn-class_3.cpp)]  
...
### Remarks  
 ...
 When an application has finished using a region created with the `CreatePolyPolygonRgn` function, it should select the region out of the device context and use the [CGDIObject::DeleteObject](../VS_csharp/cgdiobject-class.md#cgdiobject__deleteobject) member function to remove it.  
...
### Remarks  
 ...
 When it has finished using a region created by `CreateRectRgn`, an application should use the [CGDIObject::DeleteObject](../VS_csharp/cgdiobject-class.md#cgdiobject__deleteobject) member function to remove the region.  
  
### Example  
 [!code[NVC_MFCDocView#147](../VS_csharp/codesnippet/CPP/crgn-class_4.cpp)]  
...
### Remarks  
 ...
 When it has finished using a region created by `CreateRectRgnIndirect`, an application should use the [CGDIObject::DeleteObject](../VS_csharp/cgdiobject-class.md#cgdiobject__deleteobject) member function to remove the region.  
  
### Example  
 [!code[NVC_MFCDocView#148](../VS_csharp/codesnippet/CPP/crgn-class_5.cpp)]  
...
### Remarks  
 ...
 When an application has finished using a region created with the `CreateRoundRectRgn` function, it should select the region out of the device context and use the [CGDIObject::DeleteObject](../VS_csharp/cgdiobject-class.md#cgdiobject__deleteobject) member function to remove it.  
  
### Example  
 [!code[NVC_MFCDocView#149](../VS_csharp/codesnippet/CPP/crgn-class_6.cpp)]  
...
### Example  
 [!code[NVC_MFCDocView#150](../VS_csharp/codesnippet/CPP/crgn-class_7.cpp)]  
...
### Parameters  
 `lpRgnData`  
 Points to a [RGNDATA](../VS_csharp/rgndata-structure.md) data structure that receives the information. If this parameter is **NULL**, the return value contains the number of bytes needed for the region data.  
