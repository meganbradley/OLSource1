...
## Remarks  
 **/GS** is on by default. If you expect your application to have no security exposure, use **/GS-**. For more information about **/GS**, see [Compiler Security Checks In Depth](http://go.microsoft.com/fwlink/?linkid=7260). For more information about suppressing buffer overrun detection, see [safebuffers](../VS_csharp/safebuffers.md).  
...
-   A buffer allocated by using the [_alloca](../VS_csharp/_alloca.md) function.  
...
-   Optimizations ([/O options](../VS_csharp/-o-options--optimize-code-.md)) are not enabled.  
  
-   Functions that have a variable argument list (...).  
  
-   Functions that are marked with [naked](../VS_csharp/naked--c---.md).  
