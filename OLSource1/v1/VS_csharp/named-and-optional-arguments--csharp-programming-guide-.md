...
## Example  
 ...
 [!code[csProgGuideNamedAndOptional#1](../VS_csharp/codesnippet/CSharp/named-and-optional-arguments--csharp-programming-guide-_1.cs)]  
...
-   an expression of the form `new ValType()`, where `ValType` is a value type, such as an [enum](../VS_csharp/enum--csharp-reference-.md) or a [struct](../VS_csharp/structs--csharp-programming-guide-.md);  
  
-   an expression of the form [default(ValType)](../VS_csharp/default-keyword-in-generic-code--csharp-programming-guide-.md),  where `ValType` is a value type.  
 ...
 [!code[csProgGuideNamedAndOptional#15](../VS_csharp/codesnippet/CSharp/named-and-optional-arguments--csharp-programming-guide-_2.cs)]  
 ...
 ![IntelliSense Quick Info for method ExampleMethod.](../VS_csharp/media/optional_parameters.png "Optional_Parameters")  
...
## Example  
 ...
 [!code[csProgGuideNamedAndOptional#2](../VS_csharp/codesnippet/CSharp/named-and-optional-arguments--csharp-programming-guide-_3.cs)]  
...
## COM Interfaces  
 ...
 ![IntelliSense Quick Info for the AutoFormat method.](../VS_csharp/media/autoformat_parameters.png "AutoFormat_Parameters")  
AutoFormat parameters  
 ...
 [!code[csProgGuideNamedAndOptional#3](../VS_csharp/codesnippet/CSharp/named-and-optional-arguments--csharp-programming-guide-_4.cs)]  
 ...
 [!code[csProgGuideNamedAndOptional#13](../VS_csharp/codesnippet/CSharp/named-and-optional-arguments--csharp-programming-guide-_5.cs)]  
  
 For more information and examples, see [How to: Use Named and Optional Arguments in Office Programming (C# Programming Guide)](../VS_csharp/how-to--use-named-and-optional-arguments-in-office-programming--csharp-programming-guide-.md) and [How to: Acces Office Objects by Using C# 4.0](../VS_csharp/how-to--access-office-interop-objects-by-using-visual-csharp-features--csharp-programming-guide-.md).  
...
## See Also  
 ...
 [Dynamic Types](../VS_csharp/using-type-dynamic--csharp-programming-guide-.md)   
