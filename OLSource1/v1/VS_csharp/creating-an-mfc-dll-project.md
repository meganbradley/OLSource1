...
1.  Define your application settings using the [application settings](../VS_csharp/application-settings--mfc-dll-wizard.md) page of the [MFC DLL Wizard](../VS_csharp/mfc-dll-wizard.md).  
