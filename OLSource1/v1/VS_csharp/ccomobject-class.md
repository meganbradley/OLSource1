...
## Remarks  
 ...
 For more information about using `CComObject`, see the article [Fundamentals of ATL COM Objects](../VS_csharp/fundamentals-of-atl-com-objects.md).  
...
### Example  
 [!code[NVC_ATL_COM#38](../VS_csharp/codesnippet/CPP/ccomobject-class_1.h)]  
  
 [!code[NVC_ATL_COM#39](../VS_csharp/codesnippet/CPP/ccomobject-class_2.cpp)]  
