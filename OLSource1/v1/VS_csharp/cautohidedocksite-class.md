...
---
# CAutoHideDockSite Class
The `CAutoHideDockSite` extends the [CDockSite Class](../VS_csharp/cdocksite-class.md) to implement auto-hide dock panes.  
...
|[CAutoHideDockSite::CanAcceptPane](#cautohidedocksite__canacceptpane)|Determines whether a base pane object is derived from the [CMFCAutoHideBar Class](../VS_csharp/cmfcautohidebar-class.md).|  
...
|[CAutoHideDockSite::UnSetAutoHideMode](#cautohidedocksite__unsetautohidemode)|Calls [CMFCAutoHideBar::UnSetAutoHideMode](../VS_csharp/cmfcautohidebar-class.md#cmfcautohidebar__unsetautohidemode) for objects on the `CAutoHideDockSite`.|  
...
## Remarks  
 When you call [CFrameWndEx::EnableAutoHidePanes](../VS_csharp/cframewndex-class.md#cframewndex__enableautohidepanes), the framework automatically creates a `CAutoHideDockSite` object. In most cases, you should not have to instantiate or use this class directly.  
  
 The docking bar is the gap between the left side of the dock pane and the left side of the [CMFCAutoHideButton Class](../VS_csharp/cmfcautohidebutton-class.md).  
...
## Inheritance Hierarchy  
 ...
 [CDockSite](../VS_csharp/cdocksite-class.md)  
...
## Example  
 ...
 [!code[NVC_MFC_RibbonApp#29](../VS_csharp/codesnippet/CPP/cautohidedocksite-class_1.cpp)]  
  
## Requirements  
 **Header:** afxautohidedocksite.h  
  
##  <a name="cautohidedocksite__canacceptpane"></a>  CAutoHideDockSite::CanAcceptPane  
 Determines whether a base pane is a [CMFCAutoHideBar](../VS_csharp/cmfcautohidebar-class.md) object or derived from `CMFCAutoHideBar`.  
...
### Remarks  
 If a base pane object is derived from `CMFCAutoHideBar`, it can contain a [CAutoHideDockSite](../VS_csharp/cautohidedocksite-class.md).  
  
##  <a name="cautohidedocksite__dockpane"></a>  CAutoHideDockSite::DockPane  
 Docks a pane to this [CAutoHideDockSite](../VS_csharp/cautohidedocksite-class.md) object.  
...
##  <a name="cautohidedocksite__m_nextraspace"></a>  CAutoHideDockSite::m_nExtraSpace  
 The size of the space between the edges of the [CAutoHideDockSite Class](../VS_csharp/cautohidedocksite-class.md) and the [CMFCAutoHideBar Class](../VS_csharp/cmfcautohidebar-class.md) objects.  
...
### Remarks  
 [CMFCAutoHideBar](../VS_csharp/cmfcautohidebar-class.md) objects are positioned statically on the [CAutoHideDockSite](../VS_csharp/cautohidedocksite-class.md) object. This means that the user cannot manually change the location of `CMFCAutoHideBar` objects. The `SetOffsetLeft` method controls the spacing between the left side of the left-most `CMFCAutoHideBar` and the left side of the `CAutoHideDockSite`.  
...
### Remarks  
 [CMFCAutoHideBar](../VS_csharp/cmfcautohidebar-class.md) objects are positioned statically on the [CAutoHideDockSite](../VS_csharp/cautohidedocksite-class.md) object. This means that the user cannot manually change the location of the `CMFCAutoHideBar` objects. The `SetOffsetRight` method controls the spacing between the right side of the right-most `CMFCAutoHideBar` and the right side of the `CAutoHideDockSite`.  
  
##  <a name="cautohidedocksite__repositionpanes"></a>  CAutoHideDockSite::RepositionPanes  
 Redraws the panes on the [CAutoHideDockSite](../VS_csharp/cautohidedocksite-class.md).  
...
##  <a name="cautohidedocksite__unsetautohidemode"></a>  CAutoHideDockSite::UnSetAutoHideMode  
 Calls [CMFCAutoHideBar::UnSetAutoHideMode](../VS_csharp/cmfcautohidebar-class.md#cmfcautohidebar__unsetautohidemode) for objects on the dock site.  
...
|-|-|  
|Parameter|Description|  
|[in] `pAutoHideToolbar`|A pointer to a [CMFCAutoHideBar](../VS_csharp/cmfcautohidebar-class.md) object pane located on the [CAutoHideDockSite](../VS_csharp/cautohidedocksite-class.md).|  
