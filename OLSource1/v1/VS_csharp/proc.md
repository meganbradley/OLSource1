...
---
# PROC
Marks start and end of a procedure block called *label*. The statements in the block can be called with the **CALL** instruction or [INVOKE](../VS_csharp/invoke.md) directive.  
...
## Remarks  
 ...
 When the **FRAME** attribute is used, it must be followed by an [.ENDPROLOG](../VS_csharp/.endprolog.md) directive.  
  
 See [MASM for x64 (ml64.exe)](../VS_csharp/masm-for-x64--ml64.exe-.md) for more information on using ml64.exe.  
