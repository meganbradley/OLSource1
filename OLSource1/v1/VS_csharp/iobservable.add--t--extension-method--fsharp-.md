...
## See Also  
 <xref:System*>   
 [Control.CommonExtensions Module (F#)](../VS_csharp/control.commonextensions-module--fsharp-.md)   
 [IObservable.Subscribe<'T> Extension Method (F#)](../VS_csharp/iobservable.subscribe--t--extension-method--fsharp-.md)   
 [System.IObservable<'T> Interface](../VS_csharp/system.iobservable--t--interface--fsharp-.md)