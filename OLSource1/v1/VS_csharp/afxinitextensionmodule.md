...
#### Parameters  
 `state`  
 A reference to the [AFX_EXTENSION_MODULE Structure](../VS_csharp/afx_extension_module-structure.md) structure that will contain the state of the extension DLL module after the initialization. The state includes a copy of the runtime class objects that have been initialized by the extension DLL as part of normal static object construction executed before `DllMain` is entered.  
...
## Remarks  
 ...
 [!code[NVC_MFC_DLL#2](../VS_csharp/codesnippet/CPP/afxinitextensionmodule_1.cpp)]  
...
-   Create a **CDynLinkLibrary** object if the DLL will be exporting [CRuntimeClass Structure](../VS_csharp/cruntimeclass-structure.md) objects or has its own custom resources.  
...
## See Also  
 ...
 [AfxTermExtensionModule](../VS_csharp/afxtermextensionmodule.md)