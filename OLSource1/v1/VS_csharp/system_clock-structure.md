...
## Remarks  
 A *clock type* is used to obtain the current time as UTC. The type embodies an instantiation of [duration](../VS_csharp/duration-class.md) and the class template [time_point](../VS_csharp/time_point-class.md), and defines a static member function `now()` that returns the time.  
...
##  <a name="system_clock__from_time_t_method"></a>  system_clock::from_time_t Method  
 Static method that returns a [time_point](../VS_csharp/time_point-class.md) that most closely approximates the time that is represented by `Tm`.  
...
### Parameters  
 `Tm`  
 A [time_t](../VS_csharp/standard-types.md) object.  
...
### Return Value  
 A [time_point](../VS_csharp/time_point-class.md) object that represents the current time.  
  
##  <a name="system_clock__to_time_t_method"></a>  system_clock::to_time_t Method  
 Static method that returns a [time_t](../VS_csharp/standard-types.md) that most closely approximates the time that is represented by `Time`.  
...
### Parameters  
 `Time`  
 A [time_point](../VS_csharp/time_point-class.md) object.  
  
## See Also  
 [Header Files](../VS_csharp/c---standard-library-header-files.md)   
 [<chrono\>](../VS_csharp/-chrono-.md)   
 [steady_clock Class](../VS_csharp/steady_clock-struct.md)