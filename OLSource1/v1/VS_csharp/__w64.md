...
---
# __w64
(Microsoft Specific) This keyword is obsolete. In versions of Visual Studio earlier than Visual Studio 2013, this lets you mark variables, so that when you compile with [/Wp64](../VS_csharp/-wp64--detect-64-bit-portability-issues-.md) the compiler will report any warnings that would be reported if you were compiling with a 64-bit compiler.  
...
-   [Porting 32-Bit Code to 64-Bit Code](../VS_csharp/common-visual-c---64-bit-migration-issues.md)  
