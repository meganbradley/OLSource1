...
Injected text suppressed by attribute 'no_injected_text'  
 ...
 The [no_injected_text](../VS_csharp/no_injected_text.md) attribute appeared in source code, which means the compiler will prevent attributes from injecting code.  
