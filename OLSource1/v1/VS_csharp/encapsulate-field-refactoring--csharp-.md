...
2.  In the [Code Editor](../Topic/Writing%20Code%20in%20the%20Code%20and%20Text%20Editor.md), place the cursor in the declaration, on the name of the field that you want to encapsulate. In the example below, place the cursor on the word `width`:  
...
## Remarks  
 ...
 The code that is generated by this refactoring operation is modeled by the encapsulate field code snippets feature. Code Snippets are modifiable. For more information, see [Code Snippets](../Topic/Code%20Snippets.md).  
