...
## Comparison Method  
 The behavior of the `Like` operator depends on the [Option Compare Statement](../VS_csharp/option-compare-statement.md). The default string comparison method for each source file is `Option Compare Binary`.  
...
## Example  
 ...
 [!code[VbVbalrOperators#30](../VS_csharp/codesnippet/VisualBasic/like-operator--visual-basic-_1.vb)]  
...
## See Also  
 ...
 [How to: Match a String against a Pattern](../VS_csharp/how-to--match-a-string-against-a-pattern--visual-basic-.md)