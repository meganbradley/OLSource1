...
## How to Investigate a Warning  
 For an example of implementing the Equals and equality operators, see the code analysis rule [CA1815: Override equals and operator equals on value types](../VS_csharp/ca1815--override-equals-and-operator-equals-on-value-types.md)