...
One way to determine whether an image was built for the common language runtime is to use **dumpbin**[/CLRHEADER](../VS_csharp/-clrheader.md).  
  
 You can also programmatically check whether an image was built for the common language runtime. For more information, see [How to: Detect /clr Compilation](../VS_csharp/how-to--detect--clr-compilation.md).  
