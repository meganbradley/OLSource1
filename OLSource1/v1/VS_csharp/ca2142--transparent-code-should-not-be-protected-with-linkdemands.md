...
## Cause  
 A transparent method requires a <xref:System.Security.Permissions.SecurityAction.LinkDemand*> or other security demand.  
...
## Example  
 In the following example, the rule fires on the method because the method is transparent and is marked with a LinkDemand <xref:System.Security.PermissionSet*> that contains an <xref:System.Security.Permissions.SecurityAction.LinkDemand*>.  
  
 [!code[FxCop.Security.CA2142.TransparentMethodsShouldNotBeProtectedWithLinkDemands#1](../VS_csharp/codesnippet/CSharp/ca2142--transparent-code-should-not-be-protected-with-linkdemands_1.cs)]  
