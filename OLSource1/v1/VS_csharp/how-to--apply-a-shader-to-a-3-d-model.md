...
1.  Begin with a 3-D scene that contains one or more models. If you don't have a suitable 3-D scene, create one as described in [How to: Create a Basic 3-D Model](../VS_csharp/how-to--create-a-basic-3-d-model.md). You also have to have a DGSL shader that you can apply to the model. If you don't have a suitable shader, create one as described in [How to: Create a Basic Color Shader](../VS_csharp/how-to--create-a-basic-color-shader.md) and make sure that you have saved it to a file before you continue.  
...
2.  In **Select** mode, select the model that you want to apply the shader to, and then in the **Properties** window, in the **Filename** property of the **Effect** property group, specify the DGSL shader that you want to apply to the model.  
 ...
 ![3&#45;D scene that shows the basic color effect](../VS_csharp/media/digit-3d-model-effect.png "Digit-3D-Model-Effect")  
...
## See Also  
 [How to: Create a Basic 3D Model](../VS_csharp/how-to--create-a-basic-3-d-model.md)   
 [How to: Create a Basic Color Shader](../VS_csharp/how-to--create-a-basic-color-shader.md)   
