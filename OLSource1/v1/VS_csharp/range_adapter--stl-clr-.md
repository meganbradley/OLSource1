...
|---------------------|-----------------|  
|[range_adapter](../VS_csharp/range_adapter--range_adapter--stl-clr-.md)|Constructs an adapter object.|  
  
|Operator|Description|  
|--------------|-----------------|  
|[operator=](../VS_csharp/range_adapter--operator=--stl-clr-.md)|Replaces the stored iterator pair.|  
...
## See Also  
 [collection_adapter](../VS_csharp/collection_adapter--stl-clr-.md)   
