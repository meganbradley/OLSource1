...
## Remarks  
 The most common use of the **no_injected_text** C++ attribute is by the [/Fx](../VS_csharp/-fx--merge-injected-code-.md) compiler option, which inserts the **no_injected_text** attribute into the .mrg file.  
