...
2.  If the error continues, save your work and restart [!INCLUDE[vsprvs](../VS_csharp/includes/vsprvs_md.md)].  
  
3.  If the error continues, restart the computer.  
  
4.  If the error recurs, reinstall [!INCLUDE[vbprvb](../VS_csharp/includes/vbprvb_md.md)].  
...
## See Also  
 [Getting Assistance](../VS_csharp/talk-to-us.md)