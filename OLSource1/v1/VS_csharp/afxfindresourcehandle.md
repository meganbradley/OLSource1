 ...
 *lpszType*  
 A pointer to the type of resource. For a list of resource types, see [FindResource](http://msdn.microsoft.com/library/windows/desktop/ms648042) in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
## See Also  
 ...
 [AfxGetResourceHandle](../VS_csharp/afxgetresourcehandle.md)