...
## Remarks  
 This macro is to be used in the definition of [CDHtmlDialog](../VS_csharp/cdhtmldialog-class.md)-derived classes.  
  
 Use [BEGIN_DHTML_EVENT_MAP](../VS_csharp/begin_dhtml_event_map.md) or [BEGIN_DHTML_EVENT_MAP_INLINE](../VS_csharp/begin_dhtml_event_map_inline.md) to implement the map.  
