...
## Remarks  
 ...
 For information on implementing schema rowset support, see [Supporting Schema Rowsets](../VS_csharp/supporting-schema-rowsets.md).  
  
 For an example of an provider that supports schema rowsets, see the [UpdatePV](../VS_csharp/visual-c---samples.md) sample.  
...
## See Also  
 ...
 [UpdatePV](../VS_csharp/visual-c---samples.md)