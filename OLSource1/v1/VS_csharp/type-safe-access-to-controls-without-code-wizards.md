...
The first approach to creating type-safe access to controls uses an inline member function to cast the return type of class `CWnd`'s `GetDlgItem` member function to the appropriate C++ control type, as in this example:  
 ...
 [!code[NVC_MFCControlLadenDialog#50](../VS_csharp/codesnippet/CPP/type-safe-access-to-controls-without-code-wizards_1.cpp)]  
  
 You can then use this member function to access the control in a type-safe manner with code similar to the following:  
  
 [!code[NVC_MFCControlLadenDialog#51](../VS_csharp/codesnippet/CPP/type-safe-access-to-controls-without-code-wizards_2.cpp)]  
  
## See Also  
 [Type-Safe Access to Controls in a Dialog Box](../VS_csharp/type-safe-access-to-controls-in-a-dialog-box.md)   
 [Type-Safe Access to Controls With Code Wizards](../VS_csharp/type-safe-access-to-controls-with-code-wizards.md)