...
## Remarks  
 This method is used when the debug engine is running in the [!INCLUDE[vsprvs](../VS_csharp/includes/vsprvs_md.md)] process space and the program being debugged is running in its own process space.  
  
## See Also  
 [IDebugProviderProgramNode2](../VS_csharp/idebugproviderprogramnode2.md)