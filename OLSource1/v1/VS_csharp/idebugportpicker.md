...
|Method|Description|  
|------------|-----------------|  
|[IDebugPortPicker::DisplayPortPicker](../VS_csharp/idebugportpicker--displayportpicker.md)|Displays the specified dialog box that allows the user to select a port.|  
|[IDebugPortPicker::SetSite](../VS_csharp/idebugportpicker--setsite.md)|Sets the service provider.|  
