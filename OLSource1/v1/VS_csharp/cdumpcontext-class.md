...
## Remarks  
 ...
 You can use [afxDump](../VS_csharp/afxdump--cdumpcontext-in-mfc-.md), a predeclared `CDumpContext` object, for most of your dumping. The `afxDump` object is available only in the Debug version of the Microsoft Foundation Class Library.  
  
 Several of the memory [diagnostic services](../VS_csharp/diagnostic-services.md) use `afxDump` for their output.  
 ...
 If you use the [IMPLEMENT_DYNAMIC](../VS_csharp/implement_dynamic.md) or [IMPLEMENT_SERIAL](../VS_csharp/implement_serial.md) macro in the implementation of your class, then `CObject::Dump` will print the name of your `CObject`-derived class. Otherwise, it will print `CObject`.  
 ...
 For more information on `CDumpContext`, see [Debugging MFC Applications](../VS_csharp/mfc-debugging-techniques.md).  
...
### Example  
 [!code[NVC_MFC_Utilities#12](../VS_csharp/codesnippet/CPP/cdumpcontext-class_1.cpp)]  
...
### Example  
  [!code[NVC_MFC_Utilities#13](../VS_csharp/codesnippet/CPP/cdumpcontext-class_2.cpp)]  
...
### Example  
 [!code[NVC_MFC_Utilities#14](../VS_csharp/codesnippet/CPP/cdumpcontext-class_3.cpp)]  
...
### Example  
  [!code[NVC_MFC_Utilities#15](../VS_csharp/codesnippet/CPP/cdumpcontext-class_4.cpp)]  
...
### Example  
 [!code[NVC_MFC_Utilities#17](../VS_csharp/codesnippet/CPP/cdumpcontext-class_5.cpp)]  
...
### Example  
 [!code[NVC_MFC_Utilities#16](../VS_csharp/codesnippet/CPP/cdumpcontext-class_6.cpp)]  
