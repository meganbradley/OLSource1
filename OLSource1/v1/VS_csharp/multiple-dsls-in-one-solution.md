...
You can package several DSLs as part of a single solution so that they are installed together.  
 ...
 You can use several techniques to integrate multiple DSLs. For more information, see [Integrating Models by using Visual Studio ModelBus](../VS_csharp/integrating-models-by-using-visual-studio-modelbus.md) and [How to Write a Drag-and-Drop Handler](../VS_csharp/how-to--add-a-drag-and-drop-handler.md) and [Customizing Copy-Paste Behavior](../VS_csharp/customizing-copy-behavior.md).  
...
## See Also  
 ...
 [Customizing Copy-Paste Behavior](../VS_csharp/customizing-copy-behavior.md)