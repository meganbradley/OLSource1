...
The XML Document Generator Tool property page exposes the functionality of xdcmake.exe. xdcmake.exe merges .xdc files into an .xml file when your source code contains documentation comments and [/doc (Process Documentation Comments) (C/C++)](../VS_csharp/-doc--process-documentation-comments---c-c---.md) is specified,. See [Recommended Tags for Documentation Comments (C++)](../VS_csharp/recommended-tags-for-documentation-comments--visual-c---.md) for information on adding documentation comments to source code.  
  
> [!NOTE]
>  xdcmake.exe options in the development environment (property pages) differ from the options when xdcmake.exe is used at the command line. For information on using xdcmake.exe at the command line, see [XDCMake Reference](../VS_csharp/xdcmake-reference.md).  
 ...
 **Output Document File**  
 The name and directory location of the .xml output file. See [Macros for Build Commands and Properties](../VS_csharp/common-macros-for-build-commands-and-properties.md) for information on using macros to specify directory locations.  
