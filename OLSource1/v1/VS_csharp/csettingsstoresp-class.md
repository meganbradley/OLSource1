...
---
# CSettingsStoreSP Class
The `CSettingsStoreSP` class is a helper class that you can use to create instances of the [CSettingsStore Class](../VS_csharp/csettingsstore-class.md).  
...
2.  Use [DECLARE_DYNCREATE](../VS_csharp/declare_dyncreate.md) and [IMPLEMENT_DYNCREATE](../VS_csharp/implement_dyncreate.md) macros with your custom `CSettingsStore` class to enable dynamic creation.  
...
4.  In your application, call `CSettingsStoreSP::SetRuntimeClass` and pass in a pointer to the [CRuntimeClass Structure](../VS_csharp/cruntimeclass-structure.md) obtained from your class.  
...
##  <a name="csettingsstoresp__create"></a>  CSettingsStoreSP::Create  
 Creates a new instance of an object that is derived from the [CSettingsStore Class](../VS_csharp/csettingsstore-class.md).  
...
### Example  
 ...
 [!code[NVC_MFC_RibbonApp#33](../VS_csharp/codesnippet/CPP/csettingsstoresp-class_1.cpp)]  
  
##  <a name="csettingsstoresp__csettingsstoresp"></a>  CSettingsStoreSP::CSettingsStoreSP  
 Constructs a [CSettingsStoreSP Class](../VS_csharp/csettingsstoresp-class.md) object.  
...
### Parameters  
 [in] `pRTI`  
 A pointer to the runtime class information for a class derived from the [CSettingsStore Class](../VS_csharp/csettingsstore-class.md).  
  
### Return Value  
 `TRUE` if successful; `FALSE` if the class identified by `pRTI` is not derived from `CSettingsStore`.  
  
### Remarks  
 You can use the [CSettingsStoreSP Class](../VS_csharp/csettingsstoresp-class.md) to derive classes from `CSettingsStore`. Use the method `SetRuntimeClass` if you want to create objects of a custom class that is derived from `CSettingsStore`.  
  
## See Also  
 [MFC Classes](../VS_csharp/mfc-classes.md)   
 [Hierarchy Chart](../VS_csharp/hierarchy-chart.md)   
 [CSettingsStore Class](../VS_csharp/csettingsstore-class.md)