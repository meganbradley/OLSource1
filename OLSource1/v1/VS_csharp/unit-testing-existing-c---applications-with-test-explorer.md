...
## Deciding how to test your code  
 Open the existing C++ project, and inspect it to decide how you want to add the unit tests. You might want to use some modeling tools, which help you see dependencies in the code, and help you understand how the parts interact. For more information, see [Visualizing Existing Code](../VS_csharp/visualize-code.md).  
...
2.  In Test Explorer, choose **Run All**.  
 ...
 For more information, see [Test Driven Development with Test Explorer](../VS_csharp/quick-start--test-driven-development-with-test-explorer.md).