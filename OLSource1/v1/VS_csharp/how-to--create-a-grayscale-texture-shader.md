...
1.  Create a basic texture shader, as described in [How to: Create a Basic Texture Shader](../VS_csharp/how-to--create-a-basic-texture-shader.md).  
...
>  In this illustration, a plane is used as the preview shape, and a texture has been specified to better demonstrate the effect of the shader.  
 ...
 ![Shader graph and a preview of its effect](../VS_csharp/media/digit-grayscale-effect.png "Digit-Grayscale-Effect")  
  
 Certain shapes might provide better previews for some shaders. For more information about previewing shaders in the Shader Designer, see [The Shader Designer](../VS_csharp/shader-designer.md)  
...
## See Also  
 ...
 [The Image Editor](../VS_csharp/image-editor.md)   
