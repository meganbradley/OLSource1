...
-   The [dynamic_cast](../VS_csharp/dynamic_cast-operator.md) operator.  
  
     Used for conversion of polymorphic types.  
  
-   The [typeid](../VS_csharp/typeid-operator.md) operator.  
  
     Used for identifying the exact type of an object.  
  
-   The [type_info](../VS_csharp/type_info-class.md) class.  
