...
## In This Section  
 [OLE DB Consumer Templates](../VS_csharp/ole-db-consumer-templates-reference.md)  
 Provides links to the OLE DB Consumer Template classes listed by usage.  
  
 [OLE DB Provider Templates](../VS_csharp/ole-db-provider-templates-reference.md)  
...
## Related Sections  
 ...
 Provides links to the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)] documentation on OLE DB.  
  
 [OLE DB Templates Samples](../VS_csharp/visual-c---samples.md)  
 ...
 [Creating a Simple Read-Only Provider](../VS_csharp/creating-a-simple-read-only-provider.md)  
 ...
 [Active Template Library (ATL) Reference](../VS_csharp/atl-com-desktop-components.md)  
 ...
 [Debugging](../VS_csharp/debugging-in-visual-studio.md)  
