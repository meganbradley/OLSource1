...
-   [Member Lists](../VS_csharp/constructors--c---.md#member_lists)  
  
-   [Explicit Constructors](../VS_csharp/constructors--c---.md#explicit_constructors)  
  
-   [Default Constructors](../VS_csharp/constructors--c---.md#default_constructors)  
  
-   [Copy and Move Constructors](../VS_csharp/constructors--c---.md#copy_and_move_constructors)  
  
-   [Explicitly Defaulted and Deleted Constructors](../VS_csharp/constructors--c---.md#explicitly_defaulted_and_deleted_constructors)  
  
-   [Constructors in Derived Classes](../VS_csharp/constructors--c---.md#constructors_in_derived_classes)  
  
-   [Constructors for Classes That Have Multiple Inheritance](../VS_csharp/constructors--c---.md#constructors_for_classes_that_have_multiple_inheritance)  
  
-   [Virtual Functions in Constructors](../VS_csharp/constructors--c---.md#virtual_functions_in_constructors)  
  
-   [Constructors and Composite Classes](../VS_csharp/constructors--c---.md#constructors_in_composite_classes)  
  
-   [Delegating Constructors](../VS_csharp/constructors--c---.md#delegating_constructors)  
  
-   [Inheriting constructors (C++11)](../VS_csharp/constructors--c---.md#inheriting_constructors)  
  
-   [Rules for Declaring Constructors](../VS_csharp/constructors--c---.md#rules_for_declaring_constructors)  
  
-   Default and Copy Constructors  
  
-   [Explicitly invoking constructors](../VS_csharp/constructors--c---.md#explicitly_invoking_constructors)  
...
```  
 ...
 When the constructor is explicit, this line causes a compiler error: `ShippingOrder so(42, 10.8);`.  For more information, see [User-Defined Type Conversions (C++)](../VS_csharp/user-defined-type-conversions--c---.md).  
...
```  
 ...
 For more information, see [Uniform Initialization and Delegating Constructors](../VS_csharp/uniform-initialization-and-delegating-constructors.md).  
...
```  
 ...
 Objects that are created by calling constructors explicitly, as in the preceding two examples, are unnamed and have a lifetime of the expression in which they are created. This is discussed in greater detail in [Temporary Objects](../VS_csharp/temporary-objects.md).  
