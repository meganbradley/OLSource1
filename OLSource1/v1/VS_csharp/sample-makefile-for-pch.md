...
```  
 ...
 For more information on makefiles, see [NMAKE Reference](../VS_csharp/nmake-reference.md). Also see [Compiler Options](../VS_csharp/compiler-options.md) and the [Linker Options](../VS_csharp/linker-options.md).  
