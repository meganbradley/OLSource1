...
|[CDockablePane::CanAutoHide](#cdockablepane__canautohide)|Determines whether the pane supports auto-hide mode. (Overrides [CBasePane::CanAutoHide](../VS_csharp/cbasepane-class.md#cbasepane__canautohide).)|  
...
|`CDockablePane::DockToFrameWindow`|Used internally. To dock a pane, use [CPane::DockPane](../VS_csharp/cpane-class.md#cpane__dockpane) or [CDockablePane::DockToWindow](#cdockablepane__docktowindow).|  
...
|[CDockablePane::OnAfterChangeParent](#cdockablepane__onafterchangeparent)|Called by the framework when the parent of a pane has changed. (Overrides [CPane::OnAfterChangeParent](../VS_csharp/cpane-class.md#cpane__onafterchangeparent).)|  
...
|[CDockablePane::OnBeforeChangeParent](#cdockablepane__onbeforechangeparent)|Called by the framework when the parent of the pane is about to change. (Overrides [CPane::OnBeforeChangeParent](../VS_csharp/cpane-class.md#cpane__onbeforechangeparent).)|  
|[CDockablePane::OnBeforeFloat](#cdockablepane__onbeforefloat)|Called by the framework when a pane is about to float. (Overrides [CPane::OnBeforeFloat](../VS_csharp/cpane-class.md#cpane__onbeforefloat).)|  
...
|[CDockablePane::ToggleAutoHide](#cdockablepane__toggleautohide)|Toggles auto-hide mode. (Overrides [CPane::ToggleAutoHide](../VS_csharp/cpane-class.md#cpane__toggleautohide) .)|  
...
-   The kind of tabbed pane that is created by [CDockablePane::AttachToTabWnd](#cdockablepane__attachtotabwnd) is determined by the `CDockablePane` object in the `pTabControlBarAttachTo` parameter. You can call [CDockablePane::SetTabbedPaneRTC](#cdockablepane__settabbedpanertc) to set the kind of tabbed pane that the `CDockablePane` will create. The default type is determined by the `dwTabbedStyle` of [CDockablePane::Create](#cdockablepane__create) when you first create the `CDockablePane`. If `dwTabbedStyle` is AFX_CBRS_OUTLOOK_TABS the default type is [CMFCOutlookBar](../VS_csharp/cmfcoutlookbar-class.md); if `dwTabbedStyle` is AFX_CBRS_REGULAR_TABS the default type is [CTabbedPane](../VS_csharp/ctabbedpane-class.md).  
...
1.  The framework checks whether the target pane `pTabControlBarAttachTo` is a regular docking pane or if it is derived from [CBaseTabbedPane](../VS_csharp/cbasetabbedpane-class.md).  
...
3.  If the target pane is a regular docking pane, the framework creates a tabbed pane.  
    ...
    -   The framework calls `pTabControlBarAttachTo->CreateTabbedPane`. The style of the new tabbed pane depends on the `m_pTabbedControlBarRTC` member. By default, this member is set to the runtime class of [CTabbedPane](../VS_csharp/ctabbedpane-class.md). If you pass the `AFX_CBRS_OUTLOOK_TABS` style as the `dwTabbedStyle` parameter to the [CDockablePane::Create](#cdockablepane__create) method, the runtime class object is set to the runtime class of [CMFCOutlookBar](../VS_csharp/cmfcoutlookbar-class.md). You can change this member at any time to change the style of the new pane.  
...
### Remarks  
 By default, this method always returns `TRUE`. Override this method in a derived class to enable or disable docking without calling [CBasePane::EnableDocking](../VS_csharp/cbasepane-class.md#cbasepane__enabledocking).  
  
##  <a name="cdockablepane__cdockablepane"></a>  CDockablePane::CDockablePane  
 Constructs and initializes a [CDockablePane](../VS_csharp/cdockablepane-class.md) object.  
...
-   [CPane::CopyState](../VS_csharp/cpane-class.md#cpane__copystate)  
...
##  <a name="cdockablepane__create"></a>  CDockablePane::Create  
 Creates the Windows control and attaches it to the [CDockablePane](../VS_csharp/cdockablepane-class.md) object.  
...
### Remarks  
 ...
 If the `dwTabbedStyle` parameter has the `AFX_CBRS_OUTLOOK_TABS` flag specified, the pane creates Outlook-style tabbed panes when another pane is attached to this pane using the [CDockablePane::AttachToTabWnd](#cdockablepane__attachtotabwnd) method. By default, dockable panes create regular tabbed panes of type [CTabbedPane](../VS_csharp/ctabbedpane-class.md).  
...
### Remarks  
 Dockable panes store recent docking information in a [CRecentDockSiteInfo](../VS_csharp/crecentdocksiteinfo-class.md) object.  
...
### Return Value  
 A valid [CPaneDivider](../VS_csharp/cpanedivider-class.md) object if the dockable pane is docked to the main frame window, or `NULL` if the dockable pane is not docked or if it is floating.  
  
### Remarks  
 For more information about pane dividers, see [CPaneDivider Class](../VS_csharp/cpanedivider-class.md).  
...
### Return Value  
 A [CSize](../VS_csharp/csize-class.md) object that contains the width and height, in pixels, of a rectangle centered on a drag point. The drag operation does not begin until the mouse pointer moves outside this rectangle.  
  
##  <a name="cdockablepane__getlastpercentinpanecontainer"></a>  CDockablePane::GetLastPercentInPaneContainer  
 Retrieves the percentage of space that a pane occupies in its container ( [CPaneContainer Class](../VS_csharp/cpanecontainer-class.md)).  
...
### Remarks  
 This method is used only in classes that are derived from `CDockablePane` and have tabs. For more information, see [CTabbedPane::GetTabArea](../VS_csharp/ctabbedpane-class.md#ctabbedpane__gettabarea) and [CMFCOutlookBar::GetTabArea](../VS_csharp/cmfcoutlookbar-class.md#cmfcoutlookbar__gettabarea).  
...
### Remarks  
 By default, dockable panes are resizable. To prevent resizing, override this method in a derived class and return `FALSE`. Note that a `FALSE` value leads to a failed `ASSERT` in [CPane::DockPane](../VS_csharp/cpane-class.md#cpane__dockpane). Use [CDockingManager::AddPane](../VS_csharp/cdockingmanager-class.md#cdockingmanager__addpane) instead to dock a pane within a parent frame.  
...
### Remarks  
 For more information, see [CTabbedPane::IsTabLocationBottom](../VS_csharp/ctabbedpane-class.md#ctabbedpane__istablocationbottom).  
...
### Remarks  
 ...
 If the dockable pane is not in autohide mode, the visibility state is determined by the [CBasePane::IsVisible](../VS_csharp/cbasepane-class.md#cbasepane__isvisible) method.  
...
### Parameters  
 ...
 [in] `dockMethod`  
 Specifies the docking method. See [CPane::DockPane](../VS_csharp/cpane-class.md#cpane__dockpane) for a list of possible values.  
...
### Remarks  
 ...
 Call this method to switch a dockable pane to autohide mode programmatically. The pane must be docked to the main frame window ( [CDockablePane::GetDefaultPaneDivider](#cdockablepane__getdefaultpanedivider) must return a valid pointer to the [CPaneDivider](../VS_csharp/cpanedivider-class.md)).  
...
-   [CBaseTabbedPane Class](../VS_csharp/cbasetabbedpane-class.md)  
  
-   [CTabbedPane Class](../VS_csharp/ctabbedpane-class.md)  
  
-   [CMFCOutlookBar Class](../VS_csharp/cmfcoutlookbar-class.md).  
...
### Remarks  
 Call this method instead of the [CWnd::ShowWindow](../VS_csharp/cwnd-class.md#cwnd__showwindow) when showing or hiding dockable panes.  
...
### Remarks  
 ...
 You must undock a pane before you perform any external operation that is not performed by the [CDockingManager](../VS_csharp/cdockingmanager-class.md). For example, you must undock a pane to move it programmatically from one location to another.  
