...
-   `WhenAll` returns a task that completes when all tasks in a collection are complete.  
     ...
     For more information and an example that uses `WhenAll`, see [How to: Extend the async Walkthrough by Using Task.WhenAll (C#)](../VS_csharp/how-to--extend-the-async-walkthrough-by-using-task.whenall--csharp-.md).  
