...
## Remarks  
 Similar to [PROVIDER_COLUMN_ENTRY_LENGTH](../VS_csharp/provider_column_entry_length.md) but also allows you to specify the column's data type as well as size.  
