...
A [CStatusBar](../VS_csharp/cstatusbar-class.md) object is a control bar with a row of text output panes. The output panes are commonly used as message lines and as status indicators. Examples include the menu help-message lines that briefly explain the selected menu command and the indicators that show the status of the SCROLL LOCK, NUM LOCK, and other keys.  
  
 As of MFC version 4.0, status bars are implemented using class [CStatusBarCtrl](../VS_csharp/cstatusbarctrl-class.md), which encapsulates a status bar common control. For backward compatibility, MFC retains the older status bar implementation in class **COldStatusBar**. The documentation for earlier versions of MFC describes **COldStatusBar** under `CStatusBar`.  
 ...
 ![Status bar](../VS_csharp/media/vc37dy1.gif "vc37DY1")  
A Status Bar  
...
-   [Updating the text of a status bar pane](../VS_csharp/updating-the-text-of-a-status-bar-pane.md)  
  
-   MFC classes [CStatusBar](../VS_csharp/cstatusbar-class.md) and [CStatusBarCtrl](../VS_csharp/cstatusbarctrl-class.md)  
  
-   [Control bars](../VS_csharp/control-bars.md)  
  
-   [Dialog bars](../VS_csharp/dialog-bars.md)  
  
-   [Toolbars (MFC Toolbar Implementation)](../VS_csharp/mfc-toolbar-implementation.md)  
  
## See Also  
 [Status Bars](../VS_csharp/status-bars.md)