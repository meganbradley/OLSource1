...
The extension uses classes that are derived from <xref:Microsoft.VisualStudio.TestTools.UITest.Extension.UITechnologyElement*> and represent the Worksheet control and Cell control in [!INCLUDE[ofprexcel](../VS_csharp/includes/ofprexcel_md.md)].  
