...
## Remarks  
 ...
 In order to use the synchronization classes [CSemaphore](../VS_csharp/csemaphore-class.md), [CMutex](../VS_csharp/cmutex-class.md), [CCriticalSection](../VS_csharp/ccriticalsection-class.md), and [CEvent](../VS_csharp/cevent-class.md), you must create either a `CSingleLock` or [CMultiLock](../VS_csharp/cmultilock-class.md) object to wait on and release the synchronization object. Use `CSingleLock` when you only need to wait on one object at a time. Use **CMultiLock** when there are multiple objects that you could use at a particular time.  
 ...
 `CSingleLock` objects require the presence of an object derived from [CSyncObject](../VS_csharp/csyncobject-class.md). This is usually a data member of the controlled resource's class. For more information on how to use `CSingleLock` objects, see the article [Multithreading: How to Use the Synchronization Classes](../VS_csharp/multithreading--how-to-use-the-synchronization-classes.md).  
...
### Example  
 [!code[NVC_MFC_Utilities#19](../VS_csharp/codesnippet/CPP/csinglelock-class_1.h)]  
...
### Example  
 [!code[NVC_MFC_Utilities#20](../VS_csharp/codesnippet/CPP/csinglelock-class_2.h)]  
...
### Example  
 [!code[NVC_MFC_Utilities#21](../VS_csharp/codesnippet/CPP/csinglelock-class_3.h)]  
