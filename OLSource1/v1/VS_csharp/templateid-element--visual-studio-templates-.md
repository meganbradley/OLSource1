...
---
# TemplateID Element (Visual Studio Templates)
Specifies an identifier for an item template that is categorized into a group of item templates by the [TemplateGroupID](../VS_csharp/templategroupid-element--visual-studio-templates-.md) element.  
...
## Remarks  
 ...
 If a .vstemplate file omits the `TemplateID` element, then the [Name](../VS_csharp/name-element--visual-studio-templates-.md) element is used as the identifier for the template.  
