...
## Remarks  
 ...
 You can construct an MDI frame window by calling the [Create](../VS_csharp/cframewnd-class.md#cframewnd__create) or [LoadFrame](../VS_csharp/cframewnd-class.md#cframewnd__loadframe) member function of `CFrameWnd`.  
  
 Before you call **Create** or `LoadFrame`, you must construct the frame window object on the heap using the C++ **new** operator. Before calling **Create** you can also register a window class with the [AfxRegisterWndClass](../VS_csharp/afxregisterwndclass.md) global function to set the icon and class styles for the frame.  
 ...
 The `CMDIFrameWnd` class inherits much of its default implementation from `CFrameWnd`. For a detailed list of these features, refer to the [CFrameWnd](../VS_csharp/cframewnd-class.md) class description. The `CMDIFrameWnd` class has the following additional features:  
...
-   An MDI frame window also has an implementation of **ID_WINDOW_NEW**, which creates a new frame and view on the current document. An application can override these default command implementations to customize MDI window handling.  
 ...
 For more information on `CMDIFrameWnd`, see [Frame Windows](../VS_csharp/frame-windows.md).  
...
### Example  
 [!code[NVC_MFCWindowing#13](../VS_csharp/codesnippet/CPP/cmdiframewnd-class_1.cpp)]  
...
### Parameters  
 `lpCreateStruct`  
 A long pointer to a [CREATESTRUCT](../VS_csharp/createstruct-structure.md) structure.  
...
### Example  
 [!code[NVC_MFCWindowing#14](../VS_csharp/codesnippet/CPP/cmdiframewnd-class_2.cpp)]  
...
### Example  
 [!code[NVC_MFCWindowing#15](../VS_csharp/codesnippet/CPP/cmdiframewnd-class_3.cpp)]  
...
### Example  
 [!code[NVC_MFCWindowing#16](../VS_csharp/codesnippet/CPP/cmdiframewnd-class_4.cpp)]  
...
### Remarks  
 This member function sends the [WM_MDIACTIVATE](../VS_csharp/cwnd-class.md#cwnd__onmdiactivate) message to both the child window being activated and the child window being deactivated.  
...
> [!NOTE]
>  An MDI child window is activated independently of the MDI frame window. When the frame becomes active, the child window that was last activated is sent a [WM_NCACTIVATE](../VS_csharp/cwnd-class.md#cwnd__onncactivate) message to draw an active window frame and caption bar, but it does not receive another `WM_MDIACTIVATE` message.  
...
### Example  
 [!code[NVC_MFCWindowing#17](../VS_csharp/codesnippet/CPP/cmdiframewnd-class_5.cpp)]  
...
### Example  
 See the example for [CMDIChildWnd::MDIMaximize](../VS_csharp/cmdichildwnd-class.md#cmdichildwnd__mdimaximize).  
...
### Example  
 [!code[NVC_MFCWindowing#18](../VS_csharp/codesnippet/CPP/cmdiframewnd-class_6.cpp)]  
...
### Example  
 See the example for [CMDIChildWnd::MDIRestore](../VS_csharp/cmdichildwnd-class.md#cmdichildwnd__mdirestore).  
...
### Remarks  
 After calling `MDISetMenu`, an application must call the [DrawMenuBar](../VS_csharp/cwnd-class.md#cwnd__drawmenubar) member function of `CWnd` to update the menu bar.  
...
### Example  
 [!code[NVC_MFCWindowing#19](../VS_csharp/codesnippet/CPP/cmdiframewnd-class_7.cpp)]  
  
 [!code[NVC_MFCWindowing#20](../VS_csharp/codesnippet/CPP/cmdiframewnd-class_8.cpp)]  
...
## See Also  
 ...
 [Base Class](../VS_csharp/cframewnd-class.md)   
