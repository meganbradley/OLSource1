...
|Name|Description|  
|----------|-----------------|  
|[CInstantaneousTransition::Create](#cinstantaneoustransition__create)|Calls the transition library to create encapsulated transition COM object. (Overrides [CBaseTransition::Create](../VS_csharp/cbasetransition-class.md#cbasetransition__create).)|  
...
## Inheritance Hierarchy  
 ...
 [CInstantaneousTransition](../VS_csharp/cinstantaneoustransition-class.md)  
