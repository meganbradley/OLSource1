...
## Debugging an Application That Has Restricted Permissions  
 ...
 For more information, see [How to: Debug a ClickOnce Application with Restricted Permissions](../VS_csharp/how-to--debug-a-clickonce-application-with-restricted-permissions.md).  
...
## See Also  
 ...
 [Security Page, Project Designer](../VS_csharp/security-page--project-designer.md)