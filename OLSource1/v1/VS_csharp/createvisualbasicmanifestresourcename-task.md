...
## Parameters  
 The following table describes the parameters of the [CreateVisualBasicManifestResourceName Task](../VS_csharp/createvisualbasicmanifestresourcename-task.md).  
...
|`ResourceFiles`|Required `String` parameter.<br /><br /> The name of the resource file from which to create the [!INCLUDE[vbprvb](../VS_csharp/includes/vbprvb_md.md)] manifest name.|  
