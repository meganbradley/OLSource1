...
-   Create a [CDC](../VS_csharp/cdc-class.md) object for the printer.  
...
-   [Multipage documents](../VS_csharp/multipage-documents.md)  
...
-   [Print preview](../VS_csharp/print-preview-architecture.md)  
