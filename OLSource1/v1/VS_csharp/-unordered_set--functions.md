...
### Remarks  
 The template function executes `left.`[swap](../VS_csharp/unordered_set-class.md#unordered_set__swap)`(right)`.  
...
### Remarks  
 The template function executes `left.`[swap](../VS_csharp/unordered_multiset-class.md#unordered_multiset__swap)`(right)`.  
