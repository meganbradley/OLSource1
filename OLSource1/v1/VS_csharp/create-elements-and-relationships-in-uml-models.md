...
```  
 ...
 Some types have more complex creation methods, particularly in Sequence Diagrams. See [How to Edit Interactions using the API](../VS_csharp/edit-uml-sequence-diagrams-by-using-the-uml-api.md).  
...
## See Also  
 ...
 [How to: Display a Model on Diagrams](../VS_csharp/display-a-uml-model-on-diagrams.md)