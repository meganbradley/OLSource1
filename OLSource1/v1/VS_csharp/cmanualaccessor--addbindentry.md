...
## Remarks  
 To use this function, you must first call [CreateAccessor](../VS_csharp/cmanualaccessor--createaccessor.md). You cannot add more entries than the number of columns specified in `CreateAccessor`.  
