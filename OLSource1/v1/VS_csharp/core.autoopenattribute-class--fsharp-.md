...
|Member|Description|  
|------------|-----------------|  
|[new](../VS_csharp/core.autoopenattribute-constructor--fsharp-.md)|Creates an attribute used to mark a namespace or module path to be automatically opened when an assembly is referenced|  
  
## Instance Members  
  
|Member|Description|  
|------------|-----------------|  
|[Path](../VS_csharp/autoopenattribute.path-property--fsharp-.md)|Indicates the namespace or module to be automatically opened when an assembly is referenced or an enclosing module opened.|  
