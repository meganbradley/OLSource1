...
---
# CControlBar Class
The base class for the control-bar classes [CStatusBar](../VS_csharp/cstatusbar-class.md), [CToolBar](../VS_csharp/ctoolbar-class.md), [CDialogBar](../VS_csharp/cdialogbar-class.md), [CReBar](../VS_csharp/crebar-class.md), and [COleResizeBar](../VS_csharp/coleresizebar-class.md).  
...
|Name|Description|  
|----------|-----------------|  
|[CControlBar::CalcDynamicLayout](#ccontrolbar__calcdynamiclayout)|Returns the size of a dynamic control bar as a [CSize](../VS_csharp/csize-class.md) object.|  
|[CControlBar::CalcFixedLayout](#ccontrolbar__calcfixedlayout)|Returns the size of the control bar as a [CSize](../VS_csharp/csize-class.md) object.|  
...
-   [Technical Note 31: Control Bars](../VS_csharp/tn031--control-bars.md).  
...
### Return Value  
 The control bar size, in pixels, of a [CSize](../VS_csharp/csize-class.md) object.  
  
### Remarks  
 Override this member function to provide your own dynamic layout in classes you derive from `CControlBar`. MFC classes derived from `CControlBar`, such as [CToolbar](../VS_csharp/ctoolbar-class.md), override this member function and provide their own implementation.  
...
### Return Value  
 A `CRect` object that contains the current width (in pixels) of each side of the control bar object. For example, the value of the `left` member, of [CRect](../VS_csharp/crect-class.md) object, is the width of the left hand border.  
...
### Return Value  
 The number of non- `HWND` items on the `CControlBar` object. This function returns 0 for a [CDialogBar](../VS_csharp/cdialogbar-class.md) object.  
  
### Remarks  
 The type of the item depends on the derived object: panes for [CStatusBar](../VS_csharp/cstatusbar-class.md) objects, and buttons and separators for [CToolBar](../VS_csharp/ctoolbar-class.md) objects.  
...
### Return Value  
 ...
 If the control bar is not docked to a frame window (that is, if the control bar is floating), this function will return a pointer to its parent [CMiniFrameWnd](../VS_csharp/cminiframewnd-class.md).  
  
### Remarks  
 For more information about dockable control bars, see [CControlBar::EnableDocking](#ccontrolbar__enabledocking) and [CFrameWnd::DockControlBar](../VS_csharp/cframewnd-class.md#cframewnd__dockcontrolbar).  
...
### Remarks  
 To change the state of a control bar from docked to floating, call [CFrameWnd::FloatControlBar](../VS_csharp/cframewnd-class.md#cframewnd__floatcontrolbar).  
...
### Remarks  
 To update an individual button or pane, use the `ON_UPDATE_COMMAND_UI` macro in your message map to set an update handler appropriately. See [ON_UPDATE_COMMAND_UI](../VS_csharp/on_update_command_ui.md) for more information about using this macro.  
 ...
 *cyBottom*  
 ...
 `lpRect`  
 A pointer to a [CRect](../VS_csharp/crect-class.md) object that contains the current width (in pixels)of each border of the control bar object.  
...
### Example  
 ...
 [!code[NVC_MFCControlLadenDialog#61](../VS_csharp/codesnippet/CPP/ccontrolbar-class_1.cpp)]  
