...
Declares an interface.  For information on native interfaces, see [__interface](../VS_csharp/__interface.md).  
...
-   [Interface Static Constructor](../VS_csharp/how-to--define-an-interface-static-constructor--c---cli-.md)  
  
-   [Generic Interfaces (C++)](../VS_csharp/generic-interfaces--visual-c---.md)  
  
 For information on other CLR types, see [Classes and Structs](../VS_csharp/classes-and-structs---c---component-extensions-.md).  
  
 You can detect at compile time if a type is an interface with `__is_interface_class(``type``)`. For more information, see [Intrinsic Support for Type Traits](../VS_csharp/compiler-support-for-type-traits--c---component-extensions-.md).  
