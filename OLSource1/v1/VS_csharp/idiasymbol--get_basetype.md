...
#### Parameters  
 `pRetVal`  
 [out] Returns a value from the [BasicType Enumeration](../VS_csharp/basictype.md) enumeration specifying the base type of the symbol.  
...
## See Also  
 ...
 [BasicType](../VS_csharp/basictype.md)   
