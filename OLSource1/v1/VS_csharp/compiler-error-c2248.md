...
```  
 ...
 Another conformance issue that exposes C2248 is the use of template friends and specialization. For more information, see [Linker Tools Error LNK2019](../VS_csharp/linker-tools-error-lnk2019.md).  
