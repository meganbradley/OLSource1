...
> [!NOTE]
>  The process for setting permissions differs for Silverlight clients – see [How to: Enable Authentication in an Silverlight Client App](../VS_csharp/how-to--enable-authentication-in-a-silverlight-client-app.md). LightSwitch apps that have been enabled for SharePoint use SharePoint authentication for access control.  
...
-   [Authentication](../VS_csharp/how-to--enable-authentication-in-an-html-client-app.md#auth)  
  
-   [Permissions](../VS_csharp/how-to--enable-authentication-in-an-html-client-app.md#perm)  
  
-   [Securing the Server](../VS_csharp/how-to--enable-authentication-in-an-html-client-app.md#server)  
  
-   [Securing the Client](../VS_csharp/how-to--enable-authentication-in-an-html-client-app.md#client)  
  
-   [Administration](../VS_csharp/how-to--enable-authentication-in-an-html-client-app.md#admin)  
...
## See Also  
 ...
 [How to: Enable Authentication in an Silverlight Client App](../VS_csharp/how-to--enable-authentication-in-a-silverlight-client-app.md)   
