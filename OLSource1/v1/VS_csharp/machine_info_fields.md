...
## Remarks  
 These values are passed to the [IDebugCoreServer2::GetMachineInfo](../VS_csharp/idebugcoreserver2--getmachineinfo.md) method to indicate which members of the [MACHINE_INFO](../VS_csharp/machine_info.md) structure are to be initialized.  
...
## See Also  
 ...
 [IDebugCoreServer2::GetMachineInfo](../VS_csharp/idebugcoreserver2--getmachineinfo.md)