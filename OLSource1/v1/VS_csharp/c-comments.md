...
```  
 ...
 While you can use comments to render certain lines of code inactive for test purposes, the preprocessor directives `#if` and `#endif` and conditional compilation are a useful alternative for this task. For more information, see [Preprocessor Directives](../VS_csharp/preprocessor-directives.md) in the *Preprocessor Reference*.  
...
## See Also  
 [C Tokens](../VS_csharp/c-tokens.md)