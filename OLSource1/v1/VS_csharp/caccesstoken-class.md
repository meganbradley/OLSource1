...
## Remarks  
 ...
 For an introduction to the access control model in Windows, see [Access Control](http://msdn.microsoft.com/library/windows/desktop/aa374860) in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Parameters  
 `rSid`  
 Reference to a [CSid Class](../VS_csharp/csid-class.md) object.  
...
### Parameters  
 `pDacl`  
 Pointer to the [CDacl Class](../VS_csharp/cdacl-class.md) object which will receive the **CAccessToken** object's default DACL.  
...
### Parameters  
 *pGroups*  
 Pointer to the [CTokenGroups Class](../VS_csharp/ctokengroups-class.md) object which will receive the group information.  
...
### Parameters  
 `pSid`  
 Pointer to a [CSid Class](../VS_csharp/csid-class.md) object.  
...
### Parameters  
 `pPrivileges`  
 Pointer to a [CTokenPrivileges Class](../VS_csharp/ctokenprivileges-class.md) object which will receive the privileges.  
...
### Remarks  
 ...
 The [CAutoRevertImpersonation class](../VS_csharp/cautorevertimpersonation-class.md) can be used to automatically revert impersonated access tokens.  
...
### Remarks  
 The [CAutoRevertImpersonation Class](../VS_csharp/cautorevertimpersonation-class.md) can be used to automatically revert impersonated access tokens created by setting the `bImpersonate` flag to *true*.  
...
### Remarks  
 The reversion of impersonation tokens can be performed automatically with the [CAutoRevertImpersonation Class](../VS_csharp/cautorevertimpersonation-class.md).  
...
### Parameters  
 `rDacl`  
 The new default [CDacl Class](../VS_csharp/cdacl-class.md) information.  
...
### Parameters  
 `rSid`  
 The [CSid Class](../VS_csharp/csid-class.md) object containing the owner information.  
...
### Parameters  
 `rSid`  
 The [CSid Class](../VS_csharp/csid-class.md) object containing the primary group information.  
...
## See Also  
 [ATLSecurity Sample](../VS_csharp/visual-c---samples.md)   
