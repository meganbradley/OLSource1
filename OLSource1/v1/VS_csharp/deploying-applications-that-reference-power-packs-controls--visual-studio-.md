...
## Installing the Power Packs Controls as a Prerequisite  
 ...
 When [!INCLUDE[vsprvs](../VS_csharp/includes/vsprvs_md.md)] is installed on your development computer, a Power Packs bootstrapper package is added to the [!INCLUDE[vsprvs](../VS_csharp/includes/vsprvs_md.md)] bootstrapper directory. This package is then available when you follow the procedures for adding prerequisites for either [!INCLUDE[ndptecclick](../VS_csharp/includes/ndptecclick_md.md)] or Windows Installer deployment.  
...
## See Also  
 ...
 [Visual Basic Power Packs Controls](../VS_csharp/visual-basic-power-packs-controls.md)