...
1.  In [Resource View](../VS_csharp/resource-view-window.md), right-click the resource you want to edit and choose **Properties** from the shortcut menu.  
...
2.  In the [Properties window](../VS_csharp/properties-window.md), change the properties of your resource.  
