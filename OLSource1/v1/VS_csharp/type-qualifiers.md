...
```  
 ...
 Type qualifiers are relevant only when accessing identifiers as l-values in expressions. See [L-Value and R-Value Expressions](../VS_csharp/l-value-and-r-value-expressions.md) for information about l-values and expressions.  
