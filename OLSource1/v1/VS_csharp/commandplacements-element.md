...
|[CommandPlacement](../VS_csharp/commandplacement-element.md)|Enables buttons, groups, and menus to be included in more than one group or menu.|  
...
## See Also  
 [CommandPlacement Element](../VS_csharp/commandplacement-element.md)   
