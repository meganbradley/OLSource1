 ...
 **Visual Studio Enterprise** can help you find code clones so that you can refactor them.  
 ...
 ![Code clone analysis result with strong matches](../VS_csharp/media/codeclone1.png "CodeClone1")  
...
-   Code generated from T4 templates.  
     ...
     For more information about T4, see [Code Generation by using T4](../VS_csharp/code-generation-and-t4-text-templates.md).  
