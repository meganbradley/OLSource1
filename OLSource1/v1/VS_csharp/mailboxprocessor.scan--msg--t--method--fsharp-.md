...
## Remarks  
 This method is for use within the body of the agent. For each agent, at most one concurrent reader may be active, so no more than one concurrent call to [Receive](../VS_csharp/mailboxprocessor.receive--msg--method--fsharp-.md), [TryReceive](../VS_csharp/mailboxprocessor.tryreceive--msg--method--fsharp-.md), `Scan` or [TryScan](../VS_csharp/mailboxprocessor.tryscan--msg--t--method--fsharp-.md) may be active. The body of the `scanner` function is locked during its execution, but the lock is released before the execution of the asynchronous workflow.  
...
## Example  
 ...
 [!code[FsMailboxProcessor#21](../VS_csharp/codesnippet/FSharp/mailboxprocessor.scan--msg--t--method--fsharp-_1.fs)]  
