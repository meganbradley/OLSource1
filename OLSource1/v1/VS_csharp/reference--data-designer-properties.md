...
|**Summary Property**|When the entity or table appears in a group that uses the **Summary** control type, this property specifies which field of the entity or table appears in each row of the group. For more information about the **Summary** control type, see [Reference: Screen Designer Properties](../VS_csharp/reference--screen-designer-properties.md).|  
