...
This topic contains and describes the XAML source file for the [WPF Data Binding Using LINQ to XML Example](../VS_csharp/wpf-data-binding-using-linq-to-xml-example.md), L2DBForm.xaml.  
...
## Overall UI Structure  
 ...
 The client area is contained within a <xref:System.Windows.Controls.StackPanel*> that is given a light blue background. This panel contains four <xref:System.Windows.Controls.DockPanel*> UI sections separated by <xref:System.Windows.Controls.Separator*> bars. The purpose of these sections is described in the **Remarks** in the [previous topic](../VS_csharp/walkthrough--linqtoxmldatabinding-example.md).  
...
### Comments  
 For the C# source code for the event handlers associated with the WPF UI elements, see [L2DBForm.xaml.cs Source Code](../VS_csharp/l2dbform.xaml.cs-source-code.md).  
  
## See Also  
 [Walkthrough: LinqToXmlDataBinding Example](../VS_csharp/walkthrough--linqtoxmldatabinding-example.md)   
 [L2DBForm.xaml.cs Source Code](../VS_csharp/l2dbform.xaml.cs-source-code.md)