...
apitype: "Assembly"
f1_keywords: 
  - "System.Net.WebExtensions.AsyncDownloadString"
dev_langs: 
  - "FSharp"
helpviewer_keywords: 
  - "AsyncDownloadString extension method [F#]"
  - "WebExtensions.AsyncDownloadString extension method [F#]"
...
#### Parameters  
 `address`  
 Type: <xref:System.Uri*>  
  
 The URI to retrieve.  
  
## Return Value  
 An asynchronous computation ([Async](../VS_csharp/control.async-class--fsharp-.md) object) that will wait for the return of the URI.  
