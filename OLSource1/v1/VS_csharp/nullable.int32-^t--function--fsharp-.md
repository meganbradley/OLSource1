...
Converts the argument to signed 32-bit integer ([int32](../VS_csharp/core.int32-type-abbreviation--fsharp-.md)). This is a direct conversion for all primitive numeric types. The operation requires an appropriate static conversion method on the input type.  
...
## See Also  
 ...
 [Operators.int32<^T> Function (F#)](../VS_csharp/operators.int32-^t--function--fsharp-.md)