...
## Remarks  
 ...
 For more information about lambda expressions, see [Lambda Expressions: The fun keyword](../VS_csharp/lambda-expressions--the-fun-keyword--fsharp-.md).  
 ...
 The following code illustrates some of the ways in which the `match` expression is used. For a reference and examples of all the possible patterns that can be used, see [Patterns](../VS_csharp/pattern-matching--fsharp-.md).  
  
 [!code[FsLangRef2#4601](../VS_csharp/codesnippet/FSharp/match-expressions--fsharp-_1.fs)]  
...
## Guards on Patterns  
 ...
 [!code[FsLangRef2#4602](../VS_csharp/codesnippet/FSharp/match-expressions--fsharp-_2.fs)]  
 ...
 [!code[FsLangRef2#4603](../VS_csharp/codesnippet/FSharp/match-expressions--fsharp-_3.fs)]  
