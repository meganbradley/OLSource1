...
> [!NOTE]
>  By default, project code analysis is not run as a build step. To enable code analysis as a build step, see [How to: Configure a Rule Set for a Managed Code Project](../VS_csharp/how-to--configure-code-analysis-for-a-managed-code-project.md).  
  
### To specify a rule set for multiple projects in a managed code  solution  
  
1.  In [!INCLUDE[vsPreLong](../VS_csharp/includes/vsprelong_md.md)]. [!INCLUDE[vsUltLong](../VS_csharp/includes/vsultlong_md.md)], or [!INCLUDE[vsPro](../VS_csharp/includes/vspro_md.md)] open the solution.  
