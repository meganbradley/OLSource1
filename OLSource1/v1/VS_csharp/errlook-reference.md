...
## In This Section  
 [Value Edit Control](../VS_csharp/value-edit-control.md)  
 Describes the Value Edit control in ERRLOOK.  
  
 [Error Message Edit Control](../VS_csharp/error-message-edit-control.md)  
 Describes the Error Message Edit control in ERRLOOK.  
  
 [Modules Button](../VS_csharp/modules-button.md)  
 Describes the Modules button in ERRLOOK.  
  
 [Look Up Button](../VS_csharp/look-up-button.md)  
