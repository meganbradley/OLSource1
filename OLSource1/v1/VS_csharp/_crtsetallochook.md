...
```  
 ...
 For more information about how `_CrtSetAllocHook` can be used with other memory management functions or how to write your own client-defined hook functions, see [Debug Hook Function Writing](../VS_csharp/debug-hook-function-writing.md).  
...
## See Also  
 ...
 [_CrtGetAllocHook](../VS_csharp/_crtgetallochook.md)