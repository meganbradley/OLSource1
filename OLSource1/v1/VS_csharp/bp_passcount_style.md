...
## Remarks  
 Used for the `stylePassCount` member of the [BP_PASSCOUNT](../VS_csharp/bp_passcount.md) structure that is in turn a member of the [BP_REQUEST_INFO](../VS_csharp/bp_request_info.md) and [BP_REQUEST_INFO2](../VS_csharp/bp_request_info2.md) structures.  
