...
## Accessing Physical Views  
 ...
 To enable your editor to access all of the available physical views, you must create a unique physical view string for each type of document view object that your editor factory can create. For example, the [!INCLUDE[vbprvb](../VS_csharp/includes/vbprvb_md.md)] editor factory can create document view objects for a code window and a forms designer window.  
...
## See Also  
 [Support for Multiple Views of Documents](../VS_csharp/supporting-multiple-document-views.md)   
 [How to: Attach Views to Document Data Objects](../VS_csharp/how-to--attach-views-to-document-data.md)   
 [Creating Custom Editors and Designers](../VS_csharp/creating-custom-editors-and-designers.md)