...
## Remarks  
 ...
 ![Example of RebarMenu](../VS_csharp/media/vc4sc61.gif "vc4SC61")  
 ...
 **CReBar** uses the [CReBarCtrl](../VS_csharp/crebarctrl-class.md) class to provide its implementation. You can access the rebar control through [GetReBarCtrl](#crebar__getrebarctrl) to take advantage of the control's customization options. For more information about rebar controls, see `CReBarCtrl`. For more information about using rebar controls, see [Using CReBarCtrl](../VS_csharp/using-crebarctrl.md).  
...
### Example  
 [!code[NVC_MFC_CReBarCtrl#1](../VS_csharp/codesnippet/CPP/crebar-class_1.cpp)]  
...
### Parameters  
 ...
 `dwCtrlStyle`  
 The rebar control style. By default, **RBS_BANDBORDERS**, which displays narrow lines to separate adjacent bands within the rebar control. See                                 [Rebar Control Styles](http://msdn.microsoft.com/library/windows/desktop/bb774377) in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)] for a list of styles.  
...
### Return Value  
 A reference to a [CReBarCtrl](../VS_csharp/crebarctrl-class.md) object.  
...
### Remarks  
 ...
 For more information about using `CReBarCtrl` to customize your rebar, see [Using CReBarCtrl](../VS_csharp/using-crebarctrl.md).  
  
### Example  
 [!code[NVC_MFC_CReBarCtrl#2](../VS_csharp/codesnippet/CPP/crebar-class_2.cpp)]  
