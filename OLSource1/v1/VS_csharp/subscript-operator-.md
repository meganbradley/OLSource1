...
## Remarks  
 ...
 For information about managed arrays, see [array](../VS_csharp/arrays--c---component-extensions-.md).  
...
```  
 ...
 The subscript operator is commutative. Therefore, the expressions *array*[*index*] and *array*[*array*] are guaranteed to be equivalent as long as the subscript operator is not overloaded (see [Overloaded Operators](../VS_csharp/operator-overloading.md)). The first form is the most common coding practice, but either works.  
  
## See Also  
 [Postfix Expressions](../VS_csharp/postfix-expressions.md)   
 ...
 [Arrays](../VS_csharp/arrays--c---.md)   
 [One-Dimensional Arrays](../VS_csharp/one-dimensional-arrays.md)   
 [Multidimensional Arrays](../VS_csharp/multidimensional-arrays--c-.md)