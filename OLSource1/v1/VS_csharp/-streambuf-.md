...
---
# &lt;streambuf&gt;
Include the iostreams standard header <streambuf\> to define the template class [basic_streambuf](../VS_csharp/basic_streambuf-class.md), which is basic to the operation of the iostreams classes. This header is typically included for you by another of the iostreams headers; you rarely need to include it directly.  
...
|||  
|-|-|  
|[streambuf](../VS_csharp/-streambuf--typedefs.md#streambuf)|A specialization of `basic_streambuf` that uses `char` as the template parameters.|  
|[wstreambuf](../VS_csharp/-streambuf--typedefs.md#wstreambuf)|A specialization of `basic_streambuf` that uses `wchar_t` as the template parameters.|  
