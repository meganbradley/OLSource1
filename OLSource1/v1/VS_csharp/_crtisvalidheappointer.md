...
```  
 ...
 For more information about how `_CrtIsValidHeapPointer` can be used with other debug functions and macros, see [Macros for Reporting](../VS_csharp/macros-for-reporting.md). For information about how memory blocks are allocated, initialized, and managed in the debug version of the base heap, see [CRT Debug Heap Details](../VS_csharp/crt-debug-heap-details.md).  
