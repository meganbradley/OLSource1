...
The following procedure demonstrates how to add events that follow the standard [!INCLUDE[dnprdnshort](../VS_csharp/includes/dnprdnshort_md.md)] pattern to your classes and structs. All events in the [!INCLUDE[dnprdnshort](../VS_csharp/includes/dnprdnshort_md.md)] class library are based on the <xref:System.EventHandler*> delegate, which is defined as follows:  
...
> [!NOTE]
>  The [!INCLUDE[dnprdnlong](../VS_csharp/includes/dnprdnlong_md.md)] introduces a generic version of this delegate, <xref:System.EventHandler`1*>. The following examples show how to use both versions.  
  
 Although events in classes that you define can be based on any valid delegate type, even delegates that return a value, it is generally recommended that you base your events on the [!INCLUDE[dnprdnshort](../VS_csharp/includes/dnprdnshort_md.md)] pattern by using <xref:System.EventHandler*>, as shown in the following example.  
...
## Example  
 ...
 [!code[csProgGuideEvents#2](../VS_csharp/codesnippet/CSharp/how-to--publish-events-that-conform-to-.net-framework-guidelines--csharp-programming-guide-_1.cs)]  
  
## See Also  
 <xref:System.Delegate*>   
 [C# Programming Guide](../VS_csharp/csharp-programming-guide.md)   
 [Events (C# Programmer's Reference)](../VS_csharp/events--csharp-programming-guide-.md)   
 [Delegates (C# Programmer's Reference)](../VS_csharp/delegates--csharp-programming-guide-.md)