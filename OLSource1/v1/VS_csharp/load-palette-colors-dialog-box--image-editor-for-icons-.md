...
Use this dialog box to load special color palettes to use in your project. For more information, see [Saving and Loading Different Color Palettes](../VS_csharp/saving-and-loading-different-color-palettes--image-editor-for-icons-.md).  
