...
## Managing projects in Solution Explorer  
 ...
 ![Solution Explorer](../VS_csharp/media/vs2015_solution_explorer.png "vs2015_solution_explorer")  
  
## In This Section  
  
-   [Creating Solutions and Projects](../VS_csharp/creating-solutions-and-projects.md)  
  
-   [Adding and Removing Project Items](../VS_csharp/adding-and-removing-project-items.md)  
  
-   [Managing Project and Solution Properties](../VS_csharp/managing-project-and-solution-properties.md)  
  
-   [Managing Project References](../VS_csharp/managing-references-in-a-project.md)  
  
-   [Application Properties](../VS_csharp/application-properties.md)  
  
-   [Managing Assembly and Manifest Signing](../VS_csharp/managing-assembly-and-manifest-signing.md)  
  
-   [How to: Specify an Application Icon (Visual Basic, C#)](../VS_csharp/how-to--specify-an-application-icon--visual-basic--csharp-.md)  
  
-   [Targeting a Specific .NET Framework Version or Profile](../VS_csharp/targeting-a-specific-.net-framework-version.md)  
  
-   [Creating Custom Project and ItemTemplates in Visual Studio](../VS_csharp/creating-project-and-item-templates.md)  
