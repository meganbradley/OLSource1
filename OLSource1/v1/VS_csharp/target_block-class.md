...
|[target_block::unlink_sources Method](#target_block__unlink_sources_method)|Unlinks all source blocks from this                                         `target_block` object. (Overrides                                         [ITarget::unlink_sources](../VS_csharp/itarget-class.md#itarget__unlink_sources_method).)|  
