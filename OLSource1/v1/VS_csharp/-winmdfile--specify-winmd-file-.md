...
Specifies the file name for the Windows Runtime Metadata (.winmd) output file that is generated by the [/WINMD](../VS_csharp/-winmd--generate-windows-metadata-.md) linker option.  
...
## See Also  
 [/WINMD](../VS_csharp/-winmd--generate-windows-metadata-.md)   
