...
## In This Section  
 ...
 [Stop Statements in Visual Basic](../VS_csharp/stop-statements-in-visual-basic.md)  
 ...
 [Debugging the OnStart Method](../VS_csharp/how-to--debug-the-onstart-method.md)  
 ...
 [Mixed-Mode Debugging](../VS_csharp/debugging-mixed-mode-applications.md)  
 ...
 Describes an error message that occurs if you try to debug managed code on a [!INCLUDE[win7](../VS_csharp/includes/win7_md.md)], [!INCLUDE[wiprlhext](../VS_csharp/includes/wiprlhext_md.md)], [!INCLUDE[winxp](../VS_csharp/includes/winxp_md.md)], [!INCLUDE[win2kfamily](../VS_csharp/includes/win2kfamily_md.md)], or Windows NT system that has been started in debug mode.  
  
 [JIT Optimization and Debugging](../VS_csharp/jit-optimization-and-debugging.md)  
 Describes the effects of JIT optimization on debugging.  
  
 [Debugging LINQ and DLINQ](../VS_csharp/debugging-linq.md)  
...
## Related Sections  
 ...
 [Debugging Script and Web Applications](../VS_csharp/debugging-web-applications-and-script.md)  
 Describes common debugging problems and techniques you may encounter when debugging script and Web applications.  
  
 [What's New in the Visual Studio 2005 Debugger](../VS_csharp/what’s-new-for-the-debugger-in-visual-studio-2015.md)  
 Description of new debugging features added in this release of [!INCLUDE[vsprvs](../VS_csharp/includes/vsprvs_md.md)].  
  
 [Debugging Home Page](../VS_csharp/debugging-in-visual-studio.md)  
