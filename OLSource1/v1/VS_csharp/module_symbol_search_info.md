...
#### Parameters  
 `dwValidFields`  
 A combination of flags from the [SYMBOL_SEARCH_INFO_FIELDS](../VS_csharp/symbol_search_info_fields.md) enumeration specifying the kind of search information described in this structure.  
  
 `bstrVerboseSearchInfo`  
 Search path and results concatenated into a single string.  
  
## Remarks  
 This structure is returned from a call to the [IDebugModule3::GetSymbolInfo](../VS_csharp/idebugmodule3--getsymbolinfo.md) method.  
...
## See Also  
 ...
 [IDebugModule3::GetSymbolInfo](../VS_csharp/idebugmodule3--getsymbolinfo.md)