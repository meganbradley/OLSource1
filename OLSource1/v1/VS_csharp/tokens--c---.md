...
-   Comments  
 ...
 The parser recognizes keywords, identifiers, literals, operators, and punctuators. For information on specific token types, see [Keywords](../VS_csharp/keywords--c---.md), [Identifiers](../VS_csharp/identifiers--c---.md), [Numeric, Boolean and Pointer Literals](../VS_csharp/numeric--boolean-and-pointer-literals---c---.md), [String and Character Literals](../VS_csharp/string-and-character-literals---c---.md), [User-Defined Literals](../VS_csharp/user-defined-literals---c---.md), [C++ Built-in Operators, Precedence and Associativity](../VS_csharp/c---built-in-operators--precedence-and-associativity.md), and [Punctuators](../VS_csharp/punctuators--c---.md). White space is ignored, except as required to separate tokens.  
