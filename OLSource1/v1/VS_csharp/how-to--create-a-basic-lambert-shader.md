...
>  To better demonstrate the effect of the shader in this illustration, an orange color has been specified by using the **MaterialDiffuse** parameter of the shader. A game or app can use this parameter to supply a unique color value for each object. For information about material parameters, see the Previewing Shaders section in [Shader Designer](../VS_csharp/shader-designer.md).  
 ...
 ![The shader graph and a preview of its effect.](../VS_csharp/media/digit-lambert-effect-graph.png "Digit-Lambert-Effect-Graph")  
 ...
 ![Lambert lighting applied to a model.](../VS_csharp/media/digit-lambert-effect-result.png "Digit-Lambert-Effect-Result")  
...
## See Also  
 ...
 [How to: Create a Phong Shader](../VS_csharp/how-to--create-a-basic-phong-shader.md)   
