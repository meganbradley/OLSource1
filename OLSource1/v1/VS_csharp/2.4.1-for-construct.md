...
-   **private**, **firstprivate**, **lastprivate**, and **reduction** clauses, see [Section 2.7.2](../VS_csharp/2.7.2-data-sharing-attribute-clauses.md) on page 25.  
  
-   **OMP_SCHEDULE** environment variable, see [Section 4.1](../VS_csharp/4.1-omp_schedule.md) on page 48.  
  
-   **ordered** construct, see [Section 2.6.6](../VS_csharp/2.6.6-ordered-construct.md) on page 22.  
  
-   [Appendix D](../VS_csharp/d.-using-the-schedule-clause.md), page 93, gives more information on using the schedule clause.