...
'interface' : a 'attribute' interface must inherit from IDispatch, or from an interface that inherits from IDispatch  
 ...
 An interface with the [dual](../VS_csharp/dual.md) or [dispinterface](../VS_csharp/dispinterface.md) attributes does not have `IDispatch` as a direct or indirect base interface.  
