...
The **/lib** option specifies the location of assemblies referenced by means of the [/reference (C# Compiler Options)](../VS_csharp/-reference--csharp-compiler-options-.md) option.  
