...
-   Hiding the base class property by adding the [new](../VS_csharp/new--csharp-reference-.md) keyword to a property in a derived class.  
  
-   Making the base class property [virtual](../VS_csharp/virtual--csharp-reference-.md).  
  
 For more information, see [Using Properties (C# Programming Guide)](../VS_csharp/using-properties--csharp-programming-guide-.md).  
