...
This article explains how to pass [CString](../VS_csharp/cstringt-class.md) objects to functions and how to return `CString` objects from functions.  
...
##  <a name="_core_strings_as_function_outputs"></a> Strings as Function Outputs  
 ...
 [!code[NVC_ATLMFC_Utilities#197](../VS_csharp/codesnippet/CPP/cstring-argument-passing_1.cpp)]  
  
 [!code[NVC_ATLMFC_Utilities#198](../VS_csharp/codesnippet/CPP/cstring-argument-passing_2.cpp)]  
