...
## Remarks  
 ...
 Use the class methods provided to create, add, remove, and delete ACEs from the `CDacl` object. See also [AtlGetDacl](../VS_csharp/atlgetdacl.md) and [AtlSetDacl](../VS_csharp/atlsetdacl.md).  
