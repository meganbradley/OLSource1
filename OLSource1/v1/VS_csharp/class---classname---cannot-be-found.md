...
2.  If the error recurs, save your work and restart [!INCLUDE[vsprvs](../VS_csharp/includes/vsprvs_md.md)].  
  
3.  If the error persists, reinstall [!INCLUDE[vbprvb](../VS_csharp/includes/vbprvb_md.md)].  
