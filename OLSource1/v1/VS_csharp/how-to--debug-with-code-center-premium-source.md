...
With the [!INCLUDE[vs_dev11_long](../VS_csharp/includes/vs_dev11_long_md.md)] debugger, you can debug secure shared source from Microsoft MSDN Code Center Premium.  
...
10. In the **Cache symbols from symbol servers in this directory** box, enter a location such as `C:\symbols` where Code Center Premium can cache the symbols. Caching symbols can significantly improve performance during debugging.  
     ...
     If you experience difficulty debugging source code with [!INCLUDE[vsprvs](../VS_csharp/includes/vsprvs_md.md)] after you complete this procedure, check your cache location for previously cached and outdated symbol files. Remove the outdated symbol files.  
  
11. Click **OK**.  
  
12. Restart [!INCLUDE[vsprvs](../VS_csharp/includes/vsprvs_md.md)] to ensure that settings are persisted.  
