...
To determine what proportion of your project's code is actually being tested by coded tests such as unit tests, you can use the code coverage feature of Visual Studio. To guard effectively against bugs, your tests should exercise or 'cover' a large proportion of your code.  
 ...
 ![Code coverage results with coloring](../VS_csharp/media/codecoverage1.png "CodeCoverage1")  
...
2.  To see which lines have been run, choose ![Show Code Coverage Coloring Icon](../VS_csharp/media/codecoverage-showcoloringicon.png "CodeCoverage-ShowColoringIcon")**Show Code Coverage Coloring**.  
...
>   
>  If you don’t get the results you expect, see [Troubleshooting](../VS_csharp/troubleshooting-code-coverage.md). . Don’t forget to run code coverage again after updating your code. Coverage results and code coloring are not automatically updated after you modify your code or when you run tests.  
...
## Merging results from different runs  
 ...
 Use ![Icon for Merge button in Code Coverage window](../VS_csharp/media/codecoverage-mergeicon.png "CodeCoverage-MergeIcon")**Merge Code Coverage Results** to do this. You can choose any combination of recent runs or imported results. If you want to combine exported results, you must import them first.  
...
2.  On the **Process** page, expand **Automated Tests**, **Test Source**, **Run Settings**. Set **Type of Run Settings File** to **Code Coverage Enabled**.  
 ...
 ![Setting the build definition for code coverage](../VS_csharp/media/codecoverage-plaincc.png "CodeCoverage-plainCC")  
...
## Troubleshooting  
 If you do not see code coverage results, see  [Troubleshooting Code Coverage](../VS_csharp/troubleshooting-code-coverage.md).  
...
## See Also  
 [Customizing Code Coverage](../VS_csharp/customizing-code-coverage-analysis.md)   
 [Troubleshooting Code Coverage](../VS_csharp/troubleshooting-code-coverage.md)   
