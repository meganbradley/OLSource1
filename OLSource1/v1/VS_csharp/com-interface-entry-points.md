...
For member functions of a COM interface, use the [METHOD_PROLOGUE](../VS_csharp/method_prologue.md) macro to maintain the proper global state when calling methods of an exported interface.  
 ...
 [!code[NVC_MFCConnectionPoints#5](../VS_csharp/codesnippet/CPP/com-interface-entry-points_1.cpp)]  
  
 For additional information, see [Technical Note 38](../VS_csharp/tn038--mfc-ole-iunknown-implementation.md) on MFC/OLE **IUnknown** implementation.  
