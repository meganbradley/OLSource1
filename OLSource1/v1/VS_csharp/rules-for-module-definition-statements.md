...
-   If a string argument matches a [reserved word](../VS_csharp/reserved-words.md), it must be enclosed in double quotation marks (").  
  
## See Also  
 [Module-Definition (.Def) Files](../VS_csharp/module-definition--.def--files.md)   
