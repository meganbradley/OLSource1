...
|Method|Description|  
|------------|-----------------|  
|[Event](../VS_csharp/idebugportevents2--event.md)|Sends events that describe the creation and destruction of processes and programs on the port.|  
