...
---
# _chsize
Changes the size of a file. A more secure version is available; see [_chsize_s](../VS_csharp/_chsize_s.md).  
...
## Remarks  
 ...
 This function validates its parameters. If `size` is less than zero or `fd` is a bad file descriptor, the invalid parameter handler is invoked, as described in [Parameter Validation](../VS_csharp/parameter-validation.md).  
