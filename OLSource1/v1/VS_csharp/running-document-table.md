...
## Other Uses of the Running Document Table  
 ...
 The IDE also uses the RDT to resurface (bring to the front) an open document, if a user requests that document. For more information, see [Displaying Files By Using the Open File Command](../VS_csharp/displaying-files-by-using-the-open-file-command.md). To determine whether a file is open in the RDT, do one the following.  
...
## See Also  
 [RDT_ReadLock Usage](../VS_csharp/rdt_readlock-usage.md)   
