...
#### Parameters  
 `pRetVal`  
 [out] Returns an [IDiaSymbol](../VS_csharp/idiasymbol.md) object that represents the lexical parent of the symbol.  
...
## Remarks  
 ...
 The possible symbols that can appear as lexical parents are documented in [Lexical Hierarchy of Symbol Types](../VS_csharp/lexical-hierarchy-of-symbol-types.md).  
