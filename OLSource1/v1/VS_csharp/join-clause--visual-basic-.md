...
## Example  
 ...
 [!code[VbSimpleQuerySamples#13](../VS_csharp/codesnippet/VisualBasic/join-clause--visual-basic-_1.vb)]  
  
## Example  
 The following code example joins two collections by using the `Join` clause.  
  
 [!code[VbSimpleQuerySamples#12](../VS_csharp/codesnippet/VisualBasic/join-clause--visual-basic-_2.vb)]  
...
## Example  
 ...
 [!code[VbSimpleQuerySamples#17](../VS_csharp/codesnippet/VisualBasic/join-clause--visual-basic-_3.vb)]  
