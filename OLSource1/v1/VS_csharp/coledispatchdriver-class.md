...
### Example  
 [!code[NVC_MFCOleContainer#3](../VS_csharp/codesnippet/CPP/coledispatchdriver-class_1.cpp)]  
...
### Example  
 [!code[NVC_MFCOleContainer#4](../VS_csharp/codesnippet/CPP/coledispatchdriver-class_2.cpp)]  
...
### Remarks  
 ...
 For more information about the `LPDISPATCH` type, see [Implementing the IDispatch Interface](assetId:///0e171f7f-0022-4e9b-ac8e-98192828e945) in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
  
### Example  
 [!code[NVC_MFCOleContainer#5](../VS_csharp/codesnippet/CPP/coledispatchdriver-class_3.cpp)]  
...
### Example  
 [!code[NVC_MFCOleContainer#6](../VS_csharp/codesnippet/CPP/coledispatchdriver-class_4.cpp)]  
...
### Parameters  
 ...
 `wFlags`  
 Flags describing the context of the call to **IDispatch::Invoke**. . For a list of possible values, see the `wFlags` parameter in                                  [IDispatch::Invoke](http://msdn.microsoft.com/library/windows/desktop/ms221479\(v=vs.85\).aspx) in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
|**VT_UNKNOWN**|`LPUNKNOWN`|  
 ...
 The `pbParamInfo` argument is a space-separated list of **VTS_** constants. One or more of these values, separated by spaces (not commas), specifies the function's parameter list. Possible values are listed with the [EVENT_CUSTOM](../VS_csharp/event_custom.md) macro.  
  
 This function converts the parameters to **VARIANTARG** values, then invokes the                         [IDispatch::Invoke](http://msdn.microsoft.com/library/windows/desktop/ms221479\(v=vs.85\).aspx) method. If the call to `Invoke` fails, this function will throw an exception. If the `SCODE` (status code) returned by **IDispatch::Invoke** is `DISP_E_EXCEPTION`, this function throws a [COleException](../VS_csharp/coleexception-class.md) object; otherwise it throws a [COleDispatchException](../VS_csharp/coledispatchexception-class.md).  
...
### Remarks  
 ...
 For more information on releasing COM objects, see                         [Implementing Reference Counting](http://msdn.microsoft.com/library/windows/desktop/ms693431) and                         [IUnknown::Release](http://msdn.microsoft.com/library/windows/desktop/ms682317) in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
  
### Example  
 [!code[NVC_MFCOleContainer#9](../VS_csharp/codesnippet/CPP/coledispatchdriver-class_5.cpp)]  
...
### Remarks  
 ...
 For more information, see [IDispatch](assetId:///0e171f7f-0022-4e9b-ac8e-98192828e945) in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Example  
 [!code[NVC_MFCOleContainer#8](../VS_csharp/codesnippet/CPP/coledispatchdriver-class_6.cpp)]  
...
### Example  
 [!code[NVC_MFCOleContainer#7](../VS_csharp/codesnippet/CPP/coledispatchdriver-class_7.cpp)]  
