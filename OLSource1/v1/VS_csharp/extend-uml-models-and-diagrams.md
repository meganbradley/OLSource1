...
This topic summarizes the different ways in which you can extend the UML modeling tools included with Visual Studio. To see which versions of Visual Studio support each model type and tool, see [Version support for architecture and modeling tools](../VS_csharp/what-s-new-for-design-in-visual-studio.md#VersionSupport).  
 ...
 For more information, see this video: ![link to video](../VS_csharp/media/playvideo.gif "PlayVideo")[MSDN How Do I Series: UML Tools and Extensibility](http://go.microsoft.com/fwlink/?LinkId=214467).  
...
## Profiles  
 ...
 For more information, see [Defining a Profile to Extend UML](../VS_csharp/define-a-profile-to-extend-uml.md).  
...
## Custom Toolbox Items  
 ...
 For more information, see [How to: Define a Custom Modeling Toolbox Item](../VS_csharp/define-a-custom-modeling-toolbox-item.md).  
...
## Validation  
 ...
 For more information, see [How to: Define Validation Constraints on UML Models](../VS_csharp/define-validation-constraints-for-uml-models.md).  
  
## Menu Commands  
 You can define commands that users can invoke by right-clicking elements on a UML diagram. The commands can update the model and diagrams or perform other operations in [!INCLUDE[vs_current_short](../VS_csharp/includes/vs_current_short_md.md)].  
 ...
 See [How to: Define a Menu Command on a Modeling Diagram](../VS_csharp/define-a-menu-command-on-a-modeling-diagram.md).  
...
## Gestures  
 ...
 For more information, see [How to: Define a Gesture on a Modeling Diagram](../VS_csharp/define-a-gesture-handler-on-a-modeling-diagram.md).  
...
## Responding to Changes  
 ...
 For more information, see [Responding to Changes in the Model](../Topic/How%20to:%20Respond%20to%20Changes%20in%20a%20UML%20Model.md).  
  
## Model Bus  
 Model Bus allows you to access a diagram or model from another diagram or from another [!INCLUDE[vs_current_short](../VS_csharp/includes/vs_current_short_md.md)] Extension. Among other things, this allows you to spread information across more than one model, so that several people can work on the combined model at the same time.  
 ...
 For more information, see [How to: Access UML Diagrams and Models using Model Bus](../VS_csharp/integrate-uml-models-with-other-models-and-tools.md).  
...
## Generation  
 ...
 For more information, see [How to: Generate Code from a UML Model](../VS_csharp/generate-files-from-a-uml-model.md).  
...
## Team Foundation Server Integration  
 ...
 For more information, see [How to: Link Work Items to Model Elements in Program Code](../VS_csharp/define-a-work-item-link-handler.md).  
...
## Tools that Update Models  
 ...
 For more information, see [How to: Load and Update a UML Model](../VS_csharp/read-a-uml-model-in-program-code.md).  
  
## Domain-Specific Languages  
 Where you frequently use a particular type of model, it can be useful to create a domain-specific language. This can be made to fit your business needs more closely than a UML model, but requires more effort to build it and maintain it. For more information, see [Domain Specific Languages](../VS_csharp/modeling-sdk-for-visual-studio---domain-specific-languages.md).  
  
## External Resources  
  
|**Category**|**Links**|  
|------------------|---------------|  
|**Videos**|![link to video](../VS_csharp/media/playvideo.gif "PlayVideo") [MSDN How Do I Series: UML Tools and Extensibility](http://go.microsoft.com/fwlink/?LinkId=214467)<br /><br /> ![link to video](../VS_csharp/media/playvideo.gif "PlayVideo") [Channel 9: UML with Visual Studio](http://go.microsoft.com/fwlink/?LinkId=199957)|  
