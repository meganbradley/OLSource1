...
Like [Array.foldBack](../VS_csharp/array.foldback--t--state--function--fsharp-.md), but returns both the intermediate and final results.  
...
## Example  
 The following code contrasts the behavior of [Array.scan](../VS_csharp/array.scan--t--state--function--fsharp-.md) and `Array.scanBack`.  
  
 [!code[FsArrays#36](../VS_csharp/codesnippet/FSharp/array.scanback--t--state--function--fsharp-_1.fs)]  
