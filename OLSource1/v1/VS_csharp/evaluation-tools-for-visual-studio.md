...
-   Verify that all UI elements use the environment font service. (See [Fonts and Formatting for Visual Studio](../VS_csharp/fonts-and-formatting-for-visual-studio.md))  
