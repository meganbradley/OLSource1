...
Returns the lowest of all elements of the array, compared by using [Operators.min](../VS_csharp/operators.min--t--function--fsharp-.md).  
...
## Example  
 ...
 [!code[FsArrays#57](../VS_csharp/codesnippet/FSharp/array.min--t--function--fsharp-_1.fs)]  
