...
In the IDE, all information that is needed to build a project is exposed as              *properties*. This information includes the application name, extension (such as DLL, LIB, EXE), compiler options, linker options, debugger settings, custom build steps, and many other things. You use              *property pages* (             **Project &#124; Properties**) to view and modify these properties.  
 ...
 ![Visual C&#43;&#43; Project Defaults](../VS_csharp/media/visual-c---project-defaults.png "Visual C++ Project Defaults")  
 ...
 ![Visual C&#43;&#43; Property Pages showing active configuration](../VS_csharp/media/visual-c---property-pages-showing-active-configuration.png "Visual C++ Property Pages showing active configuration")  
 ...
 ![Visual C&#43;&#43; Property Pages showing release config](../VS_csharp/media/visual-c---property-pages-showing-release-config.png "Visual C++ Property Pages showing release config")  
...
## Build configurations  
 ...
 ![Property Manager](../VS_csharp/media/property-manager.png "Property Manager")  
 ...
 *Target platform* refers to the kind of device and/or operating system that the executable will run on. You can build a project for more than one platform. The available target platforms for C++ projects depend on the kind of project; they include but are not limited to Win32, x64, ARM, Android, and iOS.     The                   **x86** target platform that you might see in                  **Configuration Manager** is identical to                  **Win32** in native C++ projects. Win32 means 32-bit Windows and                  **x64** means 64-bit Windows.  For more information about these two platforms, see                  [Running 32-bit applications](https://msdn.microsoft.com/library/windows/desktop/aa384249\(v=vs.85\).aspx).  
 ...
 The                  **Any CPU** target platform value that you might see in                  **Configuration Manager** has no effect on native C++ projects; it is relevant for C++/CLI and other .NET project types. For more information, see                  [/CLRIMAGETYPE (Specify Type of CLR Image)](../VS_csharp/-clrimagetype--specify-type-of-clr-image-.md).  
  
## Property pages  
 As stated earlier, the Visual C++ project system is based on                  [MSBuild](../VS_csharp/msbuild.md) and the values are stored in the XML project file, default .props and .targets files that (for Visual Studio 2015) are located in                     **<drive\>\Program Files (x86)\MSBuild\Microsoft.Cpp\v4.0\V140** and in custom .props files that you might add. We highly recommend that you use NOT edit those files manually, and instead use the property pages in the IDE  to modify all properties, especially those that participate in inheritance, unless you have a very good understanding of MSBuild.  
 ...
 ![Project property pages](../VS_csharp/media/project_property_pages_vc.png "Project_Property_Pages_VC")  
  
> [!WARNING]
>  The                      **Common Properties** configurations in earlier versions of Visual Studio have been removed. To add a reference to a project, you now use the                      **Add Reference** dialog in the same way as for managed languages. See                      [Managing Project References](../VS_csharp/managing-references-in-a-project.md).  
...
-   [General Property Page (File)](../VS_csharp/general-property-page--file-.md)  
  
-   [Command Line Property Pages](../VS_csharp/command-line-property-pages.md)  
  
-   [Debugging Property Page](../VS_csharp/project-settings-for-a-c---debug-configuration.md)  
  
-   [NMake Property Page](../VS_csharp/nmake-property-page.md)  
  
-   [Linker Property Pages](../VS_csharp/linker-property-pages.md)  
  
-   [Resources Property Pages](../VS_csharp/resources-property-pages.md)  
  
-   [MIDL Property Pages](../VS_csharp/midl-property-pages.md)  
  
-   [Web References Property Page](../VS_csharp/web-references-property-page.md)  
  
-   [XML Data Generator Tool Property Page](../VS_csharp/xml-data-generator-tool-property-page.md)  
...
## Property Editor  
 ...
 ![Property&#95;Editor&#95;Dropdown](../VS_csharp/media/property_editor_dropdown.png "Property_Editor_Dropdown")  
 ...
 ![Property editor, Visual C&#43;&#43;](../VS_csharp/media/propertyeditorvc.png "PropertyEditorVC")  
...
>  Although .user files are still installed by Visual Studio and participate in property inheritance, they are empty by default. The best practice is to delete the reference to them in                      **Property Manager** to ensure that your projects operate independently of any per-user, per-computer settings This is important to ensure correct behavior in a SCC (source code control) environment.  
 ...
 ![Property Manager shortcut menu](../VS_csharp/media/sharingnew.png "SharingNew")  
