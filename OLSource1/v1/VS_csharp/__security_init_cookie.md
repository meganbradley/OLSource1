...
|`__security_init_cookie`|<process.h>|  
 ...
 `__security_init_cookie` is a Microsoft extension to the standard C Runtime Library. For compatibility information, see [Compatibility](../VS_csharp/compatibility.md).  
