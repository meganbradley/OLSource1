...
---
# QUERYCHANGESFUNC
This is a callback function used by the [SccQueryChanges](../VS_csharp/sccquerychanges-function.md) operation to enumerate a collection of file names and determine each file's status.  
...
## Parameters  
 pvCallerData  
 [in] The `pvCallerData` parameter passed by the caller (the IDE) to [SccQueryChanges](../VS_csharp/sccquerychanges-function.md). The source control plug-in should make no assumptions about the contents of this value.  
...
## See Also  
 ...
 [SccQueryChanges](../VS_csharp/sccquerychanges-function.md)   
