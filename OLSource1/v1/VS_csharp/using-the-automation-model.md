...
```  
 ...
 The following code lists the names of all of the properties in the [!INCLUDE[vsprvs](../VS_csharp/includes/vsprvs_md.md)] environment **General** option on the **Tools** menu:  
