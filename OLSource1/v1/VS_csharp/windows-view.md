...
When you first open Spy++, Windows view displays a tree of all windows and controls in the system. The window handle and class name are shown. The current desktop window is at the top of the tree. All other windows are children of the desktop, and are listed according to the standard window hierarchy. Sibling windows appear in expansible lists indented below their parents.  
 ...
 ![Spy&#43;&#43; Windows View](../VS_csharp/media/spy--_windowsview.png "Spy++_WindowsView")  
Spy++ Windows View  
 ...
 When Windows view has the focus, you can use the Finder tool in the [Window Search Dialog Box](../VS_csharp/window-search-dialog-box.md) to display information from any window open on your system.  
  
## In This Section  
 [How to: Use the Finder Tool](../VS_csharp/how-to--use-the-finder-tool.md)  
 Shows how this tool scans windows for properties or messages.  
  
 [How to: Search for a Window in Windows View](../VS_csharp/how-to--search-for-a-window-in-windows-view.md)  
 Explains how to find a specific window in Windows view.  
  
 [How to: Display Window Properties](../VS_csharp/how-to--display-window-properties.md) m  
...
## Related Sections  
 ...
 [Find Window Dialog Box](../VS_csharp/find-window-dialog-box.md)  
 ...
 [Window Properties Dialog Box](../VS_csharp/window-properties-dialog-box.md)  
