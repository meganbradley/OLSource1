...
dev_langs: 
  - "FSharp"
helpviewer_keywords: 
  - "AsyncReplyChannel class [F#]"
  - "FSharpAsyncReplyChannel class [F#]"
...
|Member|Description|  
|------------|-----------------|  
|[Reply](../VS_csharp/asyncreplychannel.reply--reply--method--fsharp-.md)|Sends a reply to a PostAndReply message.|  
