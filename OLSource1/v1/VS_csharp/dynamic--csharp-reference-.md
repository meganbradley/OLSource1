...
## Example  
 ...
 For more information and examples, see [Using Type dynamic](../VS_csharp/using-type-dynamic--csharp-programming-guide-.md).  
...
## See Also  
 ...
 [How to: Safely Cast by Using as and is Operators](../VS_csharp/how-to--safely-cast-by-using-as-and-is-operators--csharp-programming-guide-.md)   
 [Walkthrough: Creating and Using Dynamic Objects](../VS_csharp/walkthrough--creating-and-using-dynamic-objects--csharp-and-visual-basic-.md)