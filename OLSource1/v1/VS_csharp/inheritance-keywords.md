...
-   At the command line using the [/vmg](../VS_csharp/-vmb---vmg--representation-method-.md) switch  
  
-   Using the [pointers_to_members](../VS_csharp/pointers_to_members.md) pragma  
