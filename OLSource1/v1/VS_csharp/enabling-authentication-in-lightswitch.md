...
3.  In the **Select the type of authentication to use:** list, choose the **Use Windows authentication** option button.  
     ...
     ![Enabling Windows authentication](../VS_csharp/media/ls_tour32.PNG "LS_Tour32")  
