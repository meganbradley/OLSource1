...
## In This Section  
 [How to: Create a Custom Rule Set](../VS_csharp/how-to--create-a-custom-rule-set.md)  
 Describes how to create a custom rule set by modifying one or more standard rule sets.  
  
 [Working in the Code Analysis Rule Set Editor](../VS_csharp/working-in-the-code-analysis-rule-set-editor.md)  
 Describes how to use the rule set editor to group, sort, filter, and modify code analysis rules in a custom rule set.  
  
## See Also  
 [Rule Set Reference](../VS_csharp/code-analysis-rule-set-reference.md)   
 ...
 [Analyzing C/C++ Code Quality by Using Code Analysis](../VS_csharp/analyzing-c-c---code-quality-by-using-code-analysis.md)