...
```  
 ...
 C2819 can also occur when using [Stack Semantics for Reference Types](../VS_csharp/c---stack-semantics-for-reference-types.md). The following sample generates C2819:  
