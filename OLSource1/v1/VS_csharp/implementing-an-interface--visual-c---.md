...
To implement an interface, you must have created a project as an ATL COM application or as an MFC application that contains ATL support. You can use the [ATL Project Wizard](../VS_csharp/atl-project-wizard.md) to create an ATL application, or [add an ATL object to your MFC application](../VS_csharp/adding-atl-support-to-your-mfc-project.md) to implement ATL support for an MFC application.  
 ...
 Once you create the project, to implement an interface, you must first add an ATL object. See [Adding Objects and Controls to an ATL Project](../VS_csharp/adding-objects-and-controls-to-an-atl-project.md) for a list of wizards that add objects to your ATL project.  
  
> [!NOTE]
>  The wizard does not support ATL dialogs, XML Web services using ATL, performance objects, or performance counters.  
  
 If you [add an ATL control](../VS_csharp/adding-an-atl-control.md), you can specify whether to implement default interfaces, listed on the [Interfaces](../VS_csharp/interfaces--atl-control-wizard.md) page of that wizard and defined in atlcom.h.  
 ...
 If you are adding a new interface, you must add it manually to the project's .idl file. See [Adding a New Interface in an ATL Project](../VS_csharp/adding-a-new-interface-in-an-atl-project.md) for more information.  
  
### To implement an interface  
  
1.  In Class View, right-click the class name for your ATL object.  
  
2.  Click **Add** from the shortcut menu, and then click **Implement Interface** to display the [Implement Interface Wizard](../VS_csharp/implement-interface-wizard.md).  
...
## See Also  
 [Creating a COM Interface](../VS_csharp/creating-a-com-interface--visual-c---.md)   
 [Editing a COM Interface](../VS_csharp/editing-a-com-interface.md)