...
## Rule Description  
 To display a message box correctly for cultures that use a right-to-left reading order, the <xref:System.Windows.Forms.MessageBoxOptions.RightAlign*> and <xref:System.Windows.Forms.MessageBoxOptions.RtlReading*> members of the <xref:System.Windows.Forms.MessageBoxOptions*> enumeration must be passed to the <xref:System.Windows.Forms.MessageBox.Show*> method. Examine the <xref:System.Windows.Forms.Control.RightToLeft*?displayProperty=fullName> property of the containing control to determine whether to use a right-to-left reading order.  
...
## Example  
 ...
 [!code[FxCop.Globalization.SpecifyMBOptions#1](../VS_csharp/codesnippet/VisualBasic/ca1300--specify-messageboxoptions_1.vb)]
[!code[FxCop.Globalization.SpecifyMBOptions#1](../VS_csharp/codesnippet/CSharp/ca1300--specify-messageboxoptions_1.cs)]  
