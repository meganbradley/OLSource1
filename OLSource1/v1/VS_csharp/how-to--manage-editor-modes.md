...
## See Also  
 [Customizing the Editor's Features and Options](../VS_csharp/customizing-the-editor.md)   
 [How to: Arrange and Dock Windows](../Topic/How%20to:%20Arrange%20and%20Dock%20Windows.md)   
 [Fonts and Colors, Environment, Options Dialog Box](../VS_csharp/fonts-and-colors--environment--options-dialog-box.md)