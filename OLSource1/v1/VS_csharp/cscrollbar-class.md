...
## Remarks  
 ...
 For related information about using `CScrollBar`, see [Controls](../VS_csharp/controls--mfc-.md).  
...
### Parameters  
 `dwStyle`  
 Specifies the scroll bar's style. Apply any combination of [scroll-bar styles](../VS_csharp/scroll-bar-styles.md) to the scroll bar.  
...
### Remarks  
 ...
 Apply the following [window styles](../VS_csharp/window-styles.md) to a scroll bar:  
...
### Example  
 [!code[NVC_MFC_CScrollBar#1](../VS_csharp/codesnippet/CPP/cscrollbar-class_1.cpp)]  
...
### Example  
 [!code[NVC_MFC_CScrollBar#2](../VS_csharp/codesnippet/CPP/cscrollbar-class_2.h)]  
...
### Remarks  
 This member function emulates the functionality of the                         [SBM_SCROLLBARINFO](http://msdn.microsoft.com/library/windows/desktop/bb787545) message, as described in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Remarks  
 ...
 The MFC Windows message handlers that indicate scroll bar position, [CWnd::OnHScroll](../VS_csharp/cwnd-class.md#cwnd__onhscroll) and [CWnd::OnVScroll](../VS_csharp/cwnd-class.md#cwnd__onvscroll), provide only 16 bits of position data. `GetScrollInfo` and `SetScrollInfo` provide 32 bits of scroll bar position data. Thus, an application can call `GetScrollInfo` while processing either `CWnd::OnHScroll` or `CWnd::OnVScroll` to obtain 32-bit scroll bar position data.  
  
### Example  
  See the example for [CWnd::OnHScroll](../VS_csharp/cwnd-class.md#cwnd__onhscroll).  
...
### Remarks  
 ...
 The `SCROLLINFO` structure contains information about a scroll bar, including the minimum and maximum scrolling positions, the page size, and the position of the scroll box (the thumb). See the                         [SCROLLINFO](http://msdn.microsoft.com/library/windows/desktop/bb787537) structure topic in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)] for more information about changing the structure defaults.  
  
### Example  
 [!code[NVC_MFC_CScrollBar#3](../VS_csharp/codesnippet/CPP/cscrollbar-class_3.cpp)]  
...
### Example  
 [!code[NVC_MFC_CScrollBar#4](../VS_csharp/codesnippet/CPP/cscrollbar-class_4.cpp)]  
