...
|**/norestart**|Prevents the installation application from restarting the computer during or after installation. See the Return Codes section of the [Visual Studio Administrator Guide](../VS_csharp/visual-studio-administrator-guide.md) for the return codes to look for.|  
...
|**/u**<br /><br /> **/Uninstall**|Uninstalls [!INCLUDE[vsprvs](../VS_csharp/includes/vsprvs_md.md)].|  
...
## See Also  
 [Visual Studio Administrator Guide](../VS_csharp/visual-studio-administrator-guide.md)