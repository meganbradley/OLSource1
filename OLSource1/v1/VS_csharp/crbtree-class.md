...
|Name|Description|  
|----------|-----------------|  
|[CRBTree::CPair Class](../VS_csharp/crbtree--cpair-class.md)|A class containing the key and value elements.|  
...
## Remarks  
 ...
 This template class is designed to be used by [CRBMap](../VS_csharp/crbmap-class.md) and [CRBMultiMap](../VS_csharp/crbmultimap-class.md). The bulk of the methods that make up these derived classes are provided by `CRBTree`.  
...
### Return Value  
 The first two forms return a pointer to a [CPair](../VS_csharp/crbtree--cpair-class.md). The third form obtains a key and a value for the given position.  
...
### Return Value  
 Returns a pointer to the next [CPair](../VS_csharp/crbtree--cpair-class.md) value in the tree.  
...
### Return Value  
 Returns a pointer to the previous [CPair](../VS_csharp/crbtree--cpair-class.md) value stored in the tree.  
