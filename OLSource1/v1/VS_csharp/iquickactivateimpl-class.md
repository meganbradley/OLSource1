...
|Name|Description|  
|----------|-----------------|  
|[IQuickActivateImpl::GetContentExtent](../VS_csharp/iquickactivateimpl--getcontentextent.md)|Retrieves the current display size for a running control.|  
|[IQuickActivateImpl::QuickActivate](../VS_csharp/iquickactivateimpl--quickactivate.md)|Performs quick initialization of controls being loaded.|  
|[IQuickActivateImpl::SetContentExtent](../VS_csharp/iquickactivateimpl--setcontentextent.md)|Informs the control of how much display space the container has assigned to it.|  
...
### Remarks  
 ...
 See [IQuickActivate::QuickActivate](http://msdn.microsoft.com/library/windows/desktop/ms682421) in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Remarks  
 ...
 See [IQuickActivate::SetContentExtent](http://msdn.microsoft.com/library/windows/desktop/ms678806) in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
