...
## Remarks  
 `PROP_PAGE` is similar to [PROP_ENTRY_TYPE](../VS_csharp/prop_entry_type.md), but does not require a property description or DISPID.  
  
> [!NOTE]
>  If you have already entered a CLSID with `PROP_ENTRY_TYPE` or [PROP_ENTRY_TYPE_EX](../VS_csharp/prop_entry_type_ex.md), you do not need to make an additional entry with `PROP_PAGE`.  
...
## Example  
 [!code[NVC_ATL_Windowing#134](../VS_csharp/codesnippet/CPP/prop_page_1.h)]  
