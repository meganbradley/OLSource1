...
## Remarks  
 ...
 For more information about differences in exception handling in managed and unmanaged applications, see [Differences in Exception Handling Behavior Under Managed Extensions for C++](../VS_csharp/differences-in-exception-handling-behavior-under--clr.md).  
...
```  
 ...
 When throwing or catching unmanaged exceptions, we recommend that you use the [/EHsc](../VS_csharp/-eh--exception-handling-model-.md) compiler option instead of **/EHs** or **/EHa**.  
  
## See Also  
 [Exception Handling under /clr](../VS_csharp/exception-handling---c---component-extensions-.md)   
