...
3.  In the message handler that processes the `AFX_WM_RESETTOOLBAR` message, replace the original button with the new combo box button by using [CMFCToolBar::ReplaceButton](../VS_csharp/cmfctoolbar-class.md#cmfctoolbar__replacebutton).  
...
4.  Synchronize the font that is selected in the combo box with the font in the document by using the [SetFont](#cmfctoolbarfontcombobox__setfont) method.  
 ...
 To synchronize the document's font with the font selected in the combo box, use the [GetFontDesc](#cmfctoolbarfontcombobox__getfontdesc) method to retrieve the attributes of the selected font, and use those attributes to create a [CFont](../VS_csharp/cfont-class.md) object.  
...
##  <a name="cmfctoolbarfontcombobox__cmfctoolbarfontcombobox"></a>  CMFCToolBarFontComboBox::CMFCToolBarFontComboBox  
 Constructs a [CMFCToolBarFontComboBox](../VS_csharp/cmfctoolbarfontcombobox-class.md) object.  
...
### Parameters  
 ...
 [in] `iImage`  
 The zero-based index of a toolbar image. The image is located in the [CMFCToolBarImages](../VS_csharp/cmfctoolbarimages-class.md) object that [CMFCToolBar](../VS_csharp/cmfctoolbar-class.md) class maintains.  
 ...
 [in] `dwStyle`  
 The style of the combo box. (see [Combo-Box Styles](../VS_csharp/combo-box-styles.md))  
 ...
 Pointer to a [CObList](../VS_csharp/coblist-class.md) object that stores the available fonts.  
...
### Example  
 The following example demonstrates how to construct a `CMFCToolBarFontComboBox` object. This code snippet is part of the [Word Pad sample](../VS_csharp/visual-c---samples.md).  
  
 [!code[NVC_MFC_WordPad#7](../VS_csharp/codesnippet/CPP/cmfctoolbarfontcombobox-class_1.cpp)]  
