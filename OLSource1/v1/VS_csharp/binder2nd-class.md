...
## Remarks  
 ...
 If `_Func` is an object of type **Operation** and c is a constant, then [bind2nd](../VS_csharp/-functional--functions.md#bind2nd_function) ( `_Func`, `c` ) is equivalent to the `binder2nd` class constructor `binder2nd`< **Operation**> ( `_Func`, `c` ) and more convenient.  
