...
![Applies to Windows and Windows Phone](../VS_csharp/media/windows_and_phone_content.png "windows_and_phone_content")  
 ...
 The code in this topic is the sample file for [QuickStart: Debug HTML, CSS, and JavaScript](../VS_csharp/quickstart--debug-html-and-css.md). The errors present by design in the QuickStart are fixed in this version of the code.  
