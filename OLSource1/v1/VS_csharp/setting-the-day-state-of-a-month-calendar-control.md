...
1.  Using the Properties window, add a notification handler for the **MCN_GETDAYSTATE** message to the `m_monthcal` object (see [Mapping Messages to Functions](../VS_csharp/mapping-messages-to-functions.md)).  
  
2.  In the body of the handler, add the following code:  
  
     [!code[NVC_MFCControlLadenDialog#26](../VS_csharp/codesnippet/CPP/setting-the-day-state-of-a-month-calendar-control_1.cpp)]  
