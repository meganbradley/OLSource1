...
-   [Set Accelerator Properties](../VS_csharp/setting-accelerator-properties.md)  
  
-   [Associate an Accelerator Key with a Menu Item](../VS_csharp/associating-an-accelerator-key-with-a-menu-item.md)  
  
-   [Edit Accelerator Tables](../VS_csharp/editing-accelerator-tables.md)  
  
-   [Use Predefined Accelerator Keys](../VS_csharp/predefined-accelerator-keys.md)  
