...
|Name|Description|  
|----------|-----------------|  
|[CMFCVisualManagerOffice2003::DrawComboBorderWinXP](#cmfcvisualmanageroffice2003__drawcomboborderwinxp)|Draws the combo box border using the current Windows XP theme. (Overrides [CMFCVisualManager::DrawComboBorderWinXP](../VS_csharp/cmfcvisualmanager-class.md#cmfcvisualmanager__drawcomboborderwinxp).)|  
|[CMFCVisualManagerOffice2003::DrawComboDropButtonWinXP](#cmfcvisualmanageroffice2003__drawcombodropbuttonwinxp)|Draws a combo box drop-down button using the current Windows XP theme. (Overrides [CMFCVisualManager::DrawComboDropButtonWinXP](../VS_csharp/cmfcvisualmanager-class.md#cmfcvisualmanager__drawcombodropbuttonwinxp).)|  
...
|[CMFCVisualManagerOffice2003::DrawPushButtonWinXP](#cmfcvisualmanageroffice2003__drawpushbuttonwinxp)|Draws a push button using the current Windows XP theme. (Overrides [CMFCVisualManager::DrawPushButtonWinXP](../VS_csharp/cmfcvisualmanager-class.md#cmfcvisualmanager__drawpushbuttonwinxp).)|  
...
|[CMFCVisualManagerOffice2003::GetShowAllMenuItemsHeight](#cmfcvisualmanageroffice2003__getshowallmenuitemsheight)|Returns the height of all menu items. (Overrides [CMFCVisualManager::GetShowAllMenuItemsHeight](../VS_csharp/cmfcvisualmanager-class.md#cmfcvisualmanager__getshowallmenuitemsheight).)|  
...
|[CMFCVisualManagerOffice2003::GetToolTipInfo](#cmfcvisualmanageroffice2003__gettooltipinfo)|Called by the framework to get tooltip information. (Overrides [CMFCVisualManager::GetToolTipInfo](../VS_csharp/cmfcvisualmanager-class.md#cmfcvisualmanager__gettooltipinfo).)|  
...
|[CMFCVisualManagerOffice2003::IsToolbarRoundShape](#cmfcvisualmanageroffice2003__istoolbarroundshape)|Indicates whether a specified toolbar has a round shape. (Overrides [CMFCVisualManager::IsToolbarRoundShape](../VS_csharp/cmfcvisualmanager-class.md#cmfcvisualmanager__istoolbarroundshape).)|  
...
|[CMFCVisualManagerOffice2003::IsWindowsThemingSupported](#cmfcvisualmanageroffice2003__iswindowsthemingsupported)|Indicates whether Windows theming is supported. (Overrides [CMFCVisualManager::IsWindowsThemingSupported](../VS_csharp/cmfcvisualmanager-class.md#cmfcvisualmanager__iswindowsthemingsupported).)|  
...
|[CMFCVisualManagerOffice2003::OnDrawCaptionBarBorder](#cmfcvisualmanageroffice2003__ondrawcaptionbarborder)|The framework calls this method when it draws the border of a [CMFCCaptionBar](../VS_csharp/cmfccaptionbar-class.md) object. (Overrides [CMFCVisualManager::OnDrawCaptionBarBorder](../VS_csharp/cmfcvisualmanager-class.md#cmfcvisualmanager__ondrawcaptionbarborder).)|  
|[CMFCVisualManagerOffice2003::OnDrawCheckBoxEx](#cmfcvisualmanageroffice2003__ondrawcheckboxex)|The framework calls this method when it draws a checkbox. (Overrides [CMFCVisualManager::OnDrawCheckBoxEx](../VS_csharp/cmfcvisualmanager-class.md#cmfcvisualmanager__ondrawcheckboxex).)|  
|[CMFCVisualManagerOffice2003::OnDrawComboBorder](#cmfcvisualmanageroffice2003__ondrawcomboborder)|The framework calls this method when it draws the border around a [CMFCToolBarComboBoxButton](../VS_csharp/cmfctoolbarcomboboxbutton-class.md) object. (Overrides `CMFCVisualManagerOfficeXP::OnDrawComboBorder`.)|  
|[CMFCVisualManagerOffice2003::OnDrawComboDropButton](#cmfcvisualmanageroffice2003__ondrawcombodropbutton)|The framework calls this method when it draws the drop button of a [CMFCToolBarComboBoxButton](../VS_csharp/cmfctoolbarcomboboxbutton-class.md). (Overrides `CMFCVisualManagerOfficeXP::OnDrawComboDropButton`.)|  
|[CMFCVisualManagerOffice2003::OnDrawControlBorder](#cmfcvisualmanageroffice2003__ondrawcontrolborder)|The framework calls this method when it draws the border of a control. (Overrides [CMFCVisualManager::OnDrawControlBorder](../VS_csharp/cmfcvisualmanager-class.md#cmfcvisualmanager__ondrawcontrolborder).)|  
|[CMFCVisualManagerOffice2003::OnDrawExpandingBox](#cmfcvisualmanageroffice2003__ondrawexpandingbox)|The framework calls this method when it draws an expanding box. (Overrides [CMFCVisualManager::OnDrawExpandingBox](../VS_csharp/cmfcvisualmanager-class.md#cmfcvisualmanager__ondrawexpandingbox).)|  
|[CMFCVisualManagerOffice2003::OnDrawHeaderCtrlBorder](#cmfcvisualmanageroffice2003__ondrawheaderctrlborder)|The framework calls this method when it draws the border around an instance of the [CMFCHeaderCtrl Class](../VS_csharp/cmfcheaderctrl-class.md). (Overrides [CMFCVisualManager::OnDrawHeaderCtrlBorder](../VS_csharp/cmfcvisualmanager-class.md#cmfcvisualmanager__ondrawheaderctrlborder).)|  
|[CMFCVisualManagerOffice2003::OnDrawMenuBorder](#cmfcvisualmanageroffice2003__ondrawmenuborder)|The framework calls this method when it draws the border of a [CMFCPopupMenu](../VS_csharp/cmfcpopupmenu-class.md). (Overrides `CMFCVisualManagerOfficeXP::OnDrawMenuBorder`.)|  
|[CMFCVisualManagerOffice2003::OnDrawOutlookBarSplitter](#cmfcvisualmanageroffice2003__ondrawoutlookbarsplitter)|The framework calls this method when it draws the splitter for an Outlook bar. (Overrides [CMFCVisualManager::OnDrawOutlookBarSplitter](../VS_csharp/cmfcvisualmanager-class.md#cmfcvisualmanager__ondrawoutlookbarsplitter).)|  
|[CMFCVisualManagerOffice2003::OnDrawOutlookPageButtonBorder](#cmfcvisualmanageroffice2003__ondrawoutlookpagebuttonborder)|Called by the framework when it draws the border of an Outlook page button. (Overrides [CMFCVisualManager::OnDrawOutlookPageButtonBorder](../VS_csharp/cmfcvisualmanager-class.md#cmfcvisualmanager__ondrawoutlookpagebuttonborder).)|  
|[CMFCVisualManagerOffice2003::OnDrawPaneBorder](#cmfcvisualmanageroffice2003__ondrawpaneborder)|The framework calls this method when it draws the border of a [CPane](../VS_csharp/cpane-class.md) object. (Overrides `CMFCVisualManagerOfficeXP::OnDrawPaneBorder`.)|  
|[CMFCVisualManagerOffice2003::OnDrawPaneCaption](#cmfcvisualmanageroffice2003__ondrawpanecaption)|The framework calls this method when it draws a caption for a [CDockablePane](../VS_csharp/cdockablepane-class.md) object. (Overrides `CMFCVisualManagerOfficeXP::OnDrawPaneCaption`.)|  
...
|[CMFCVisualManagerOffice2003::OnDrawRibbonSliderChannel](#cmfcvisualmanageroffice2003__ondrawribbonsliderchannel)|The framework calls this method when it draws the channel of a [CMFCRibbonSlider](../VS_csharp/cmfcribbonslider-class.md). (Overrides [CMFCVisualManager::OnDrawRibbonSliderChannel](../VS_csharp/cmfcvisualmanager-class.md#cmfcvisualmanager__ondrawribbonsliderchannel).)|  
|[CMFCVisualManagerOffice2003::OnDrawRibbonSliderThumb](#cmfcvisualmanageroffice2003__ondrawribbonsliderthumb)|The framework calls this method when it draws the thumb of a [CMFCRibbonSlider](../VS_csharp/cmfcribbonslider-class.md) object. (Overrides [CMFCVisualManager::OnDrawRibbonSliderThumb](../VS_csharp/cmfcvisualmanager-class.md#cmfcvisualmanager__ondrawribbonsliderthumb).)|  
|[CMFCVisualManagerOffice2003::OnDrawRibbonSliderZoomButton](#cmfcvisualmanageroffice2003__ondrawribbonsliderzoombutton)|The framework calls this method when it draws the zoom buttons for a [CMFCRibbonSlider](../VS_csharp/cmfcribbonslider-class.md) object. (Overrides [CMFCVisualManager::OnDrawRibbonSliderZoomButton](../VS_csharp/cmfcvisualmanager-class.md#cmfcvisualmanager__ondrawribbonsliderzoombutton).)|  
...
|[CMFCVisualManagerOffice2003::OnDrawShowAllMenuItems](#cmfcvisualmanageroffice2003__ondrawshowallmenuitems)|The framework calls this method when it draws all the items in a menu. (Overrides [CMFCVisualManager::OnDrawShowAllMenuItems](../VS_csharp/cmfcvisualmanager-class.md#cmfcvisualmanager__ondrawshowallmenuitems).)|  
|[CMFCVisualManagerOffice2003::OnDrawStatusBarPaneBorder](#cmfcvisualmanageroffice2003__ondrawstatusbarpaneborder)|The framework calls this method when it draws the border for a [CMFCStatusBar](../VS_csharp/cmfcstatusbar-class.md) object. (Overrides `CMFCVisualManagerOfficeXP::OnDrawStatusBarPaneBorder`.)|  
|[CMFCVisualManagerOffice2003::OnDrawStatusBarProgress](#cmfcvisualmanageroffice2003__ondrawstatusbarprogress)|The framework calls this method when it draws the progress indicator on the [CMFCStatusBar](../VS_csharp/cmfcstatusbar-class.md) object. (Overrides [CMFCVisualManager::OnDrawStatusBarProgress](../VS_csharp/cmfcvisualmanager-class.md#cmfcvisualmanager__ondrawstatusbarprogress).)|  
|[CMFCVisualManagerOffice2003::OnDrawStatusBarSizeBox](#cmfcvisualmanageroffice2003__ondrawstatusbarsizebox)|The framework calls this method when it draws the size box for a [CMFCStatusBar](../VS_csharp/cmfcstatusbar-class.md). (Overrides [CMFCVisualManager::OnDrawStatusBarSizeBox](../VS_csharp/cmfcvisualmanager-class.md#cmfcvisualmanager__ondrawstatusbarsizebox).)|  
|[CMFCVisualManagerOffice2003::OnDrawTab](#cmfcvisualmanageroffice2003__ondrawtab)|The framework calls this method when it draws the tabs for a [CMFCBaseTabCtrl](../VS_csharp/cmfcbasetabctrl-class.md) object. (Overrides `CMFCVisualManagerOfficeXP::OnDrawTab`.)|  
...
|[CMFCVisualManagerOffice2003::OnDrawTask](#cmfcvisualmanageroffice2003__ondrawtask)|The framework calls this method when it draws a [CMFCTasksPaneTask](../VS_csharp/cmfctaskspanetask-class.md) object. (Overrides `CMFCVisualManagerOfficeXP::OnDrawTask`.)|  
|[CMFCVisualManagerOffice2003::OnDrawTasksGroupAreaBorder](#cmfcvisualmanageroffice2003__ondrawtasksgroupareaborder)|The framework calls this method when it draws a border around a group on a [CMFCTasksPane](../VS_csharp/cmfctaskspane-class.md) object. (Overrides `CMFCVisualManagerOfficeXP::OnDrawTasksGroupAreaBorder`.)|  
|[CMFCVisualManagerOffice2003::OnDrawTasksGroupCaption](#cmfcvisualmanageroffice2003__ondrawtasksgroupcaption)|The framework calls this method when it draws the caption for a [CMFCTasksPaneTaskGroup](../VS_csharp/cmfctaskspanetaskgroup-class.md) object. (Overrides `CMFCVisualManagerOfficeXP::OnDrawTasksGroupCaption`.)|  
|[CMFCVisualManagerOffice2003::OnDrawTearOffCaption](#cmfcvisualmanageroffice2003__ondrawtearoffcaption)|The framework calls this method when it draws the caption for a [CMFCPopupMenu](../VS_csharp/cmfcpopupmenu-class.md) object. (Overrides `CMFCVisualManagerOfficeXP::OnDrawTearOffCaption`.)|  
...
|[CMFCVisualManagerOffice2003::OnEraseTabsFrame](#cmfcvisualmanageroffice2003__onerasetabsframe)|The framework calls this method when it erases a frame on a [CMFCBaseTabCtrl](../VS_csharp/cmfcbasetabctrl-class.md). (Overrides [CMFCVisualManager::OnEraseTabsFrame](../VS_csharp/cmfcvisualmanager-class.md#cmfcvisualmanager__onerasetabsframe).)|  
|[CMFCVisualManagerOffice2003::OnFillAutoHideButtonBackground](#cmfcvisualmanageroffice2003__onfillautohidebuttonbackground)|The framework calls this method when it fills the background of an auto-hide button. (Overrides [CMFCVisualManager::OnFillAutoHideButtonBackground](../VS_csharp/cmfcvisualmanager-class.md#cmfcvisualmanager__onfillautohidebuttonbackground).)|  
|[CMFCVisualManagerOffice2003::OnFillBarBackground](#cmfcvisualmanageroffice2003__onfillbarbackground)|The framework calls this method when it fills the background of a [CBasePane](../VS_csharp/cbasepane-class.md) object. (Overrides `CMFCVisualManagerOfficeXP::OnFillBarBackground`.)|  
...
## Example  
 The following example demonstrates how to set the office 2003 visual manager. This code snippet is part of the [Desktop Alert Demo sample](../VS_csharp/visual-c---samples.md).  
  
 [!code[NVC_MFC_DesktopAlertDemo#6](../VS_csharp/codesnippet/CPP/cmfcvisualmanageroffice2003-class_1.cpp)]  
  
## Inheritance Hierarchy  
 [CObject](../VS_csharp/cobject-class.md)  
  
 [CMFCBaseVisualManager](../VS_csharp/cmfcbasevisualmanager-class.md)  
  
 [CMFCVisualManager](../VS_csharp/cmfcvisualmanager-class.md)  
  
 [CMFCVisualManagerOfficeXP](../VS_csharp/cmfcvisualmanagerofficexp-class.md)  
  
 [CMFCVisualManagerOffice2003](../VS_csharp/cmfcvisualmanageroffice2003-class.md)  
...
### Parameters  
 ...
 [in] `pButton`  
 A pointer to the [CMFCButton Class](../VS_csharp/cmfcbutton-class.md) object to draw.  
...
### Parameters  
 [out] `params`  
 A reference to a [CMFCToolTipInfo](../VS_csharp/cmfctooltipinfo-class.md) object where this method returns tooltip information.  
...
### Remarks  
 The default implementation of this method displays the standard gripper. To customize the appearance of the gripper, override this method in a custom class derived from the [CMFCVisualManagerOffice2003](../VS_csharp/cmfcvisualmanageroffice2003-class.md) Class.  
...
##  <a name="cmfcvisualmanageroffice2003__ondrawcaptionbarborder"></a>  CMFCVisualManagerOffice2003::OnDrawCaptionBarBorder  
 The framework calls this method when it draws the border of a [CMFCCaptionBar](../VS_csharp/cmfccaptionbar-class.md) object.  
...
### Parameters  
 ...
 [in] `pBar`  
 A pointer to a [CMFCCaptionBar](../VS_csharp/cmfccaptionbar-class.md) object. The framework draws this caption bar.  
...
##  <a name="cmfcvisualmanageroffice2003__ondrawcomboborder"></a>  CMFCVisualManagerOffice2003::OnDrawComboBorder  
 The framework calls this method when it draws the border around an instance of a [CMFCToolBarComboBoxButton](../VS_csharp/cmfctoolbarcomboboxbutton-class.md).  
...
##  <a name="cmfcvisualmanageroffice2003__ondrawcombodropbutton"></a>  CMFCVisualManagerOffice2003::OnDrawComboDropButton  
 The framework calls this method when it draws the drop button of a [CMFCToolBarComboBoxButton](../VS_csharp/cmfctoolbarcomboboxbutton-class.md).  
...
### Parameters  
 [in] `pWndCtrl`  
 Pointer to a [CWnd](../VS_csharp/cwnd-class.md) object representing the control for which to draw the border.  
...
##  <a name="cmfcvisualmanageroffice2003__ondrawheaderctrlborder"></a>  CMFCVisualManagerOffice2003::OnDrawHeaderCtrlBorder  
 The framework calls this method when it draws the border around an instance of the [CMFCHeaderCtrl Class](../VS_csharp/cmfcheaderctrl-class.md).  
...
### Parameters  
 [in] `pCtrl`  
 A pointer to a [CMFCHeaderCtrl](../VS_csharp/cmfcheaderctrl-class.md) object. The framework draws the border of this header control.  
...
##  <a name="cmfcvisualmanageroffice2003__ondrawmenuborder"></a>  CMFCVisualManagerOffice2003::OnDrawMenuBorder  
 The framework calls this method when it draws the border of a [CMFCPopupMenu](../VS_csharp/cmfcpopupmenu-class.md).  
...
### Parameters  
 [in] `pDC`  
 A pointer to the device context for a [CMFCPopupMenu](../VS_csharp/cmfcpopupmenu-class.md) object.  
  
 [in] `pMenu`  
 A pointer to a [CMFCPopupMenu](../VS_csharp/cmfcpopupmenu-class.md) object. The framework draws a border around this popup menu.  
...
##  <a name="cmfcvisualmanageroffice2003__ondrawpaneborder"></a>  CMFCVisualManagerOffice2003::OnDrawPaneBorder  
 The framework calls this method when it draws the border of a [CPane](../VS_csharp/cpane-class.md) object.  
...
##  <a name="cmfcvisualmanageroffice2003__ondrawpanecaption"></a>  CMFCVisualManagerOffice2003::OnDrawPaneCaption  
 The framework calls this method when it draws a caption for a [CDockablePane](../VS_csharp/cdockablepane-class.md) object.  
...
### Parameters  
 ...
 [in] `pBar`  
 A pointer to a [CDockablePane](../VS_csharp/cdockablepane-class.md) object. The framework draws the caption for this pane.  
...
### Parameters  
 ...
 [in] `pButton`  
 Pointer to the button (a [CMFCDesktopAlertWndButton](../VS_csharp/cmfcdesktopalertwndbutton-class.md) object).  
...
### Parameters  
 ...
 [in] `pContextCaption`  
 A pointer to a caption bar. The visual manager draws this [CMFCRibbonContextCaption](../VS_csharp/cmfcribboncontextcaption-class.md).  
...
##  <a name="cmfcvisualmanageroffice2003__ondrawribbonprogressbar"></a>  CMFCVisualManagerOffice2003::OnDrawRibbonProgressBar  
 The framework calls this method when it draws a [CMFCRibbonProgressBar](../VS_csharp/cmfcribbonprogressbar-class.md)object.  
...
### Parameters  
 ...
 [in] `pProgress`  
 A pointer to a [CMFCRibbonProgressBar](../VS_csharp/cmfcribbonprogressbar-class.md) object. The framework draws this progress bar.  
...
### Parameters  
 ...
 [in] `pSeparator`  
 A pointer to a [CMFCRibbonSeparator](../VS_csharp/cmfcribbonseparator-class.md) object. The framework draws this ribbon separator.  
...
##  <a name="cmfcvisualmanageroffice2003__ondrawribbonsliderchannel"></a>  CMFCVisualManagerOffice2003::OnDrawRibbonSliderChannel  
 The framework calls this method when it draws the channel of a [CMFCRibbonSlider](../VS_csharp/cmfcribbonslider-class.md).  
...
### Parameters  
 ...
 [in] `pSlider`  
 A pointer to a [CMFCRibbonSlider](../VS_csharp/cmfcribbonslider-class.md) object. The framework draws the channel for this ribbon slider.  
...
##  <a name="cmfcvisualmanageroffice2003__ondrawribbonsliderthumb"></a>  CMFCVisualManagerOffice2003::OnDrawRibbonSliderThumb  
 The framework calls this method when it draws the thumb of a [CMFCRibbonSlider](../VS_csharp/cmfcribbonslider-class.md) object  
...
### Parameters  
 ...
 [in] `pSlider`  
 A pointer to a [CMFCRibbonSlider](../VS_csharp/cmfcribbonslider-class.md). The framework draws the thumb for this ribbon slider.  
...
##  <a name="cmfcvisualmanageroffice2003__ondrawribbonsliderzoombutton"></a>  CMFCVisualManagerOffice2003::OnDrawRibbonSliderZoomButton  
 The framework calls this method when it draws the zoom buttons for a [CMFCRibbonSlider](../VS_csharp/cmfcribbonslider-class.md) object.  
...
### Parameters  
 ...
 [in] `pSlider`  
 A pointer to a [CMFCRibbonSlider](../VS_csharp/cmfcribbonslider-class.md) object. The framework draws this ribbon slider.  
...
### Parameters  
 ...
 [in] `pPane`  
 A pointer to a status bar pane. The framework draws this [CMFCRibbonStatusBarPane](../VS_csharp/cmfcribbonstatusbarpane-class.md) object.  
...
##  <a name="cmfcvisualmanageroffice2003__ondrawstatusbarpaneborder"></a>  CMFCVisualManagerOffice2003::OnDrawStatusBarPaneBorder  
 The framework calls this method when it draws the border for a [CMFCStatusBar](../VS_csharp/cmfcstatusbar-class.md) object.  
...
### Parameters  
 ...
 [in] `pBar`  
 A pointer to a [CMFCStatusBar](../VS_csharp/cmfcstatusbar-class.md) object. The framework draws this status bar object.  
...
##  <a name="cmfcvisualmanageroffice2003__ondrawstatusbarprogress"></a>  CMFCVisualManagerOffice2003::OnDrawStatusBarProgress  
 The framework calls this method when it draws the progress indicator on the [CMFCStatusBar](../VS_csharp/cmfcstatusbar-class.md) object  
...
### Parameters  
 ...
 [in] `pStatusBar`  
 The [CMFCStatusBar](../VS_csharp/cmfcstatusbar-class.md) object that contains the progress bar.  
...
##  <a name="cmfcvisualmanageroffice2003__ondrawstatusbarsizebox"></a>  CMFCVisualManagerOffice2003::OnDrawStatusBarSizeBox  
 The framework calls this method when it draws the size box for a [CMFCStatusBar](../VS_csharp/cmfcstatusbar-class.md).  
...
##  <a name="cmfcvisualmanageroffice2003__ondrawtab"></a>  CMFCVisualManagerOffice2003::OnDrawTab  
 The framework calls this method when it draws the tabs for a [CMFCBaseTabCtrl](../VS_csharp/cmfcbasetabctrl-class.md) object.  
...
### Parameters  
 ...
 [in] `pTabWnd`  
 A pointer to a [CMFCBaseTabCtrl](../VS_csharp/cmfcbasetabctrl-class.md) object. The framework draws this tab control.  
...
### Parameters  
 ...
 [in] `pButton`  
 A pointer to the [CMFCButton](../VS_csharp/cmfcbutton-class.md) for which the framework draws the border.  
  
 [in] `uiState`  
 The state of the button (see [CButton::GetState](../VS_csharp/cbutton-class.md#cbutton__getstate)).  
...
##  <a name="cmfcvisualmanageroffice2003__ondrawtask"></a>  CMFCVisualManagerOffice2003::OnDrawTask  
 The framework calls this method when it draws a [CMFCTasksPaneTask](../VS_csharp/cmfctaskspanetask-class.md) object.  
...
### Parameters  
 ...
 [in] `pTask`  
 A pointer to a [CMFCTasksPaneTask](../VS_csharp/cmfctaskspanetask-class.md) object. The framework draws this task.  
...
##  <a name="cmfcvisualmanageroffice2003__ondrawtasksgroupareaborder"></a>  CMFCVisualManagerOffice2003::OnDrawTasksGroupAreaBorder  
 The framework calls this method when it draws a border around a group on a [CMFCTasksPane](../VS_csharp/cmfctaskspane-class.md) object.  
...
##  <a name="cmfcvisualmanageroffice2003__ondrawtasksgroupcaption"></a>  CMFCVisualManagerOffice2003::OnDrawTasksGroupCaption  
 The framework calls this method when it draws the caption for a [CMFCTasksPaneTaskGroup](../VS_csharp/cmfctaskspanetaskgroup-class.md) object.  
...
### Parameters  
 ...
 [in] `pGroup`  
 A pointer to a [CMFCTasksPaneTaskGroup](../VS_csharp/cmfctaskspanetaskgroup-class.md) object. The framework draws the caption for this group.  
...
##  <a name="cmfcvisualmanageroffice2003__ondrawtearoffcaption"></a>  CMFCVisualManagerOffice2003::OnDrawTearOffCaption  
 The framework calls this method when it draws the caption for a [CMFCPopupMenu](../VS_csharp/cmfcpopupmenu-class.md) object.  
...
### Remarks  
 This function is called by the framework when a [CMFCPopupMenu](../VS_csharp/cmfcpopupmenu-class.md) object processes a `WM_PAINT` message and must draw a tear-off caption.  
...
### Remarks  
 This function is called by the framework when a [CMFCBaseTabCtrl](../VS_csharp/cmfcbasetabctrl-class.md) object processes a `WM_PAINT` message and erases the tab area.  
...
### Remarks  
 The framework erases the text and icon for a button when a [CMFCBaseTabCtrl](../VS_csharp/cmfcbasetabctrl-class.md) object processes the `WM_ERASEBKGND` message  
...
##  <a name="cmfcvisualmanageroffice2003__onerasetabsframe"></a>  CMFCVisualManagerOffice2003::OnEraseTabsFrame  
 The framework calls this method when it erases a frame on a [CMFCBaseTabCtrl](../VS_csharp/cmfcbasetabctrl-class.md) object.  
...
### Parameters  
 ...
 [in] `pTabWnd`  
 A pointer to a tab window. The framework erases a frame for this [CMFCBaseTabCtrl](../VS_csharp/cmfcbasetabctrl-class.md).  
...
### Parameters  
 ...
 [in] `pButton`  
 A pointer to a [CMFCAutoHideButton](../VS_csharp/cmfcautohidebutton-class.md) object. The framework fills the background for this auto-hide button.  
...
##  <a name="cmfcvisualmanageroffice2003__onfillbarbackground"></a>  CMFCVisualManagerOffice2003::OnFillBarBackground  
 The framework calls this method when it fills the background of a [CBasePane](../VS_csharp/cbasepane-class.md) object.  
...
### Parameters  
 ...
 [in] `pBar`  
 A pointer to a [CBasePane](../VS_csharp/cbasepane-class.md) object. The framework fills the background of this pane.  
...
### Remarks  
 For more information about the customization list, see [CMFCToolBarButton::OnDrawOnCustomizeList](../VS_csharp/cmfctoolbarbutton-class.md#cmfctoolbarbutton__ondrawoncustomizelist). The default implementation for this method fills the background based on the color scheme of the currently selected skin.  
...
### Parameters  
 [in] `pCtrl`  
 A pointer to a [CMFCHeaderCtrl](../VS_csharp/cmfcheaderctrl-class.md) object. The framework fills the background for this header control.  
...
### Parameters  
 ...
 [in] `pButton`  
 Pointer to the [CMFCToolBarButton](../VS_csharp/cmfctoolbarbutton-class.md) object for which to fill the highlighted area.  
...
##  <a name="cmfcvisualmanageroffice2003__onfilltasksgroupinterior"></a>  CMFCVisualManagerOffice2003::OnFillTasksGroupInterior  
 The framework calls this method when it fills the interior of a [CMFCTasksPaneTaskGroup](../VS_csharp/cmfctaskspanetaskgroup-class.md) object.  
...
##  <a name="cmfcvisualmanageroffice2003__onfilltaskspanebackground"></a>  CMFCVisualManagerOffice2003::OnFillTasksPaneBackground  
 The framework calls this method when it fills the background of a [CMFCTasksPane](../VS_csharp/cmfctaskspane-class.md) control.  
...
### Remarks  
 Override this method in a derived visual manager to customize the appearance of a [CMFCTasksPane](../VS_csharp/cmfctaskspane-class.md) object.  
...
### Remarks  
 If a `CMFCVisualManagerOffice2003` object uses a global theme, it draws the GUI elements by using the [CMFCVisualManagerWindows Class](../VS_csharp/cmfcvisualmanagerwindows-class.md).  
  
 If a `CMFCVisualManagerOffice2003` object does not use a global theme, it draws the GUI elements by using the [CMFCVisualManagerOfficeXP Class](../VS_csharp/cmfcvisualmanagerofficexp-class.md).  
  
## See Also  
 [Hierarchy Chart](../VS_csharp/hierarchy-chart.md)   
 [Classes](../VS_csharp/mfc-classes.md)   
 [CMFCVisualManager Class](../VS_csharp/cmfcvisualmanager-class.md)   
 [CMFCVisualManagerOfficeXP Class](../VS_csharp/cmfcvisualmanagerofficexp-class.md)   
 [CMFCVisualManagerWindows Class](../VS_csharp/cmfcvisualmanagerwindows-class.md)   
 [CMFCVisualManager::SetDefaultManager](../VS_csharp/cmfcvisualmanager-class.md#cmfcvisualmanager__setdefaultmanager)