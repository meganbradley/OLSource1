...
## Remarks  
 ...
 For more information on using `CTypedPtrList`, see the articles [Collections](../VS_csharp/collections.md) and [Template-Based Classes](../VS_csharp/template-based-classes.md).  
...
## Example  
 ...
 [!code[NVC_MFCCollections#110](../VS_csharp/codesnippet/CPP/ctypedptrlist-class_1.cpp)]  
  
 [!code[NVC_MFCCollections#111](../VS_csharp/codesnippet/CPP/ctypedptrlist-class_2.cpp)]  
 ...
 *TYPE*  
 ...
 `BASE_CLASS`  
 Base class of the typed pointer list class; must be a pointer list class ( [CObList](../VS_csharp/coblist-class.md) or [CPtrList](../VS_csharp/cptrlist-class.md)).  
  
 `pNewList`  
 A pointer to another [CTypedPtrList](../VS_csharp/ctypedptrlist-class.md) object. The elements in `pNewList` will be added to this list.  
...
### Remarks  
 You must ensure that the list is not empty before calling `GetHead`. If the list is empty, then the Debug version of the Microsoft Foundation Class Library asserts. Use [IsEmpty](../VS_csharp/coblist-class.md#coblist__isempty) to verify that the list contains elements.  
...
### Remarks  
 You can use `GetNext` in a forward iteration loop if you establish the initial position with a call to `GetHeadPosition` or [CPtrList::Find](../VS_csharp/coblist-class.md#coblist__find).  
  
 You must ensure that your **POSITION** value represents a valid position in the list. If it is invalid, then the Debug version of the Microsoft Foundation Class Library asserts.  
  
 If the retrieved element is the last in the list, then the new value of `rPosition` is set to **NULL**.  
  
 It is possible to remove an element during an iteration. See the example for [CObList::RemoveAt](../VS_csharp/coblist-class.md#coblist__removeat).  
...
### Remarks  
 You must ensure that the list is not empty before calling `RemoveHead`. If the list is empty, then the Debug version of the Microsoft Foundation Class Library asserts. Use [IsEmpty](../VS_csharp/coblist-class.md#coblist__isempty) to verify that the list contains elements.  
...
### Remarks  
 You must ensure that the list is not empty before calling `RemoveTail`. If the list is empty, then the Debug version of the Microsoft Foundation Class Library asserts. Use [IsEmpty](../VS_csharp/coblist-class.md#coblist__isempty) to verify that the list contains elements.  
...
### Remarks  
 ...
 For more detailed remarks, see [CObList::SetAt](../VS_csharp/coblist-class.md#coblist__setat).  
