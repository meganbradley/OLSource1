...
---
# wcsrtombs_s
Convert a wide character string to its multibyte character string representation. A version of [wcsrtombs](../VS_csharp/wcsrtombs.md) with security enhancements as described in [Security Enhancements in the CRT](../VS_csharp/security-features-in-the-crt.md).  
...
#### Parameters  
 ...
 [in] `count`  
 The maximum number of bytes to be stored in the `mbstr` buffer, or [_TRUNCATE](../VS_csharp/_truncate.md).  
...
-   The number of bytes stored in the `mbstr` buffer equals `count`.  
 ...
 If `count` is the special value [_TRUNCATE](../VS_csharp/_truncate.md), then `wcsrtombs_s` converts as much of the string as will fit into the destination buffer, while still leaving room for a null terminator.  
...
## See Also  
 ...
 [wcrtomb](../VS_csharp/wcrtomb.md)   
 [wcrtomb_s](../VS_csharp/wcrtomb_s.md)   
 [wctomb](../VS_csharp/wctomb--_wctomb_l.md)   
 [wcstombs, _wcstombs_l](../VS_csharp/wcstombs--_wcstombs_l.md)   
 [mbsinit](../VS_csharp/mbsinit.md)