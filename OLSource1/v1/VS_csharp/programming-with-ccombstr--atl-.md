...
The ATL class [CComBSTR](../VS_csharp/ccombstr-class.md) provides a wrapper around the `BSTR` data type. While `CComBSTR` is a useful tool, there are several situations that require caution.  
...
##  <a name="programmingwithccombstr_conversionissues"></a> Conversion Issues  
 Although several `CComBSTR` methods will automatically convert an ANSI string argument into Unicode, the methods will always return Unicode format strings. To convert the output string back to ANSI, use an ATL conversion class. For more information on the ATL conversion classes, see [ATL and MFC String Conversion Macros](../VS_csharp/atl-and-mfc-string-conversion-macros.md).  
  
### Example  
 [!code[NVC_ATL_Utilities#114](../VS_csharp/codesnippet/CPP/programming-with-ccombstr--atl-_1.cpp)]  
...
### Example  
 [!code[NVC_ATL_Utilities#115](../VS_csharp/codesnippet/CPP/programming-with-ccombstr--atl-_2.cpp)]  
...
### Example  
 [!code[NVC_ATL_Utilities#116](../VS_csharp/codesnippet/CPP/programming-with-ccombstr--atl-_3.cpp)]  
...
### Example  
 [!code[NVC_ATL_Utilities#117](../VS_csharp/codesnippet/CPP/programming-with-ccombstr--atl-_4.cpp)]  
...
### Example  
 [!code[NVC_ATL_Utilities#118](../VS_csharp/codesnippet/CPP/programming-with-ccombstr--atl-_5.cpp)]  
...
##  <a name="programmingwithccombstr_memoryleaks"></a> Memory Leak Issues  
 ...
 [!code[NVC_ATL_Utilities#119](../VS_csharp/codesnippet/CPP/programming-with-ccombstr--atl-_6.cpp)]  
...
## See Also  
 ...
 [String Conversion Macros](../VS_csharp/string-conversion-macros.md)