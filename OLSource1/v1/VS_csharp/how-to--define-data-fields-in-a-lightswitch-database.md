...
-   [Modifying a Field](#Modifying).  
 ...
 ![link to video](../VS_csharp/media/playvideo.gif "PlayVideo") For a related video demonstration, see [How Do I: Format Data on a Screen in a LightSwitch Application?](http://go.microsoft.com/fwlink/?LinkID=205126).  
...
##  <a name="Adding"></a> Adding a Data Field  
 ...
 See [How to: Add a Computed Field](../VS_csharp/how-to--add-a-computed-field-in-a-lightswitch-database.md).  
...
2.  In the **Properties** window, set property values.  
     ...
     See [Reference: Data Designer Properties](../VS_csharp/reference--data-designer-properties.md).  
