...
These examples show how to debug rendering problems in DirectX-based apps by using [!INCLUDE[vsprvs](../VS_csharp/includes/vsprvs_md.md)] Graphics Diagnostics.  
...
-   [Walkthrough: Capturing Graphics Information](../VS_csharp/walkthrough--capturing-graphics-information.md)  
  
-   [Walkthrough: Capturing Graphics Information Programmatically](../VS_csharp/walkthrough--capturing-graphics-information-programmatically.md)  
  
## Use Graphics Diagnostics with an ARM-based device  
 You can use Graphics Diagnostics to debug your Direct3D app on an ARM-based device by using remote debugging. For more information see [How to: Use Graphics Diagnostics with an ARM Device](../VS_csharp/how-to--use-graphics-diagnostics-with-an-arm-device.md).  
  
## Playing back graphics information  
 After you capture graphics information from a running app, you can play back the captured events to diagnose rendering problems. To play back, you can use your development machine, or you can use a remote machine or device that you are connected to. For more information, see [How to: Change the Graphics Diagnostics Playback Machine](../VS_csharp/how-to--change-the-graphics-diagnostics-playback-machine.md).  
...
-   [Walkthrough: Missing Objects Due to Device State](../VS_csharp/walkthrough--missing-objects-due-to-device-state.md)  
  
-   [Walkthrough: Missing Objects Due to Vertex Shading](../VS_csharp/walkthrough--missing-objects-due-to-vertex-shading.md)  
  
-   [Walkthrough: Missing objects Due to Misconfigured Pipeline](../VS_csharp/walkthrough--missing-objects-due-to-misconfigured-pipeline.md)  
...
-   [Walkthrough: Debugging Rendering Errors Due to Shading](../VS_csharp/walkthrough--debugging-rendering-errors-due-to-shading.md)  
...
## Debugging compute shaders  
 ...
 For a scenario that demonstrates how to debug a simulation problem that's caused by a bug in a compute shader, see [Walkthrough: Using Graphics Diagnostics to Debug a Compute Shader](../VS_csharp/walkthrough--using-graphics-diagnostics-to-debug-a-compute-shader.md).