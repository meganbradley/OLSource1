...
By default, [!INCLUDE[vsprvs](../VS_csharp/includes/vsprvs_md.md)] builds each project in a solution in its own folder inside the solution. You can change the build output paths of your projects to force all outputs to be placed in the same folder.  
...
## See Also  
 ...
 [How to: Change the Build Output Directory](../VS_csharp/how-to--change-the-build-output-directory.md)