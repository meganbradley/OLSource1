...
The type or namespace name 'type/namespace' could not be found (are you missing a using directive or an assembly reference?)  
 ...
 A type or namespace that is used in the program was not found. You might have forgotten to reference ([/reference](../VS_csharp/-reference--csharp-compiler-options-.md)) the assembly that contains the type, or you might not have added the required [using directive](../VS_csharp/using-directive--csharp-reference-.md).  Or, there might be an issue with the assembly you are trying to reference.  
