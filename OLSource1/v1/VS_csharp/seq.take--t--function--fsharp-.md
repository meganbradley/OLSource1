...
## Remarks  
 [Seq.truncate](../VS_csharp/seq.truncate--t--function--fsharp-.md) returns as many items as the sequence contains instead of throwing an exception.  
...
## Example  
 ...
 [!code[FsSequences#16](../VS_csharp/codesnippet/FSharp/seq.take--t--function--fsharp-_1.fs)]  
