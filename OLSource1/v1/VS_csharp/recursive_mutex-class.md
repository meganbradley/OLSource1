...
Represents a *mutex type*. In contrast to [mutex](../VS_csharp/mutex-class--stl-.md), the behavior of calls to locking methods for objects that are already locked is well-defined.  
