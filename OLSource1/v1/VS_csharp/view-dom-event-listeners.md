...
9. Choose the **Events** tab in the pane on the right side of DOM Explorer.  
     ...
     ![Events Tab of the DOM Explorer](../VS_csharp/media/js_dom_events.png "JS_DOM_Events")  
...
11. To quickly identify event listeners for parent elements in the DOM hierarchy, choose a parent element in the hierarchy list at the bottom of the DOM Explorer.  
     ...
     ![Selecting parent elements in the DOM hierarchy](../VS_csharp/media/js_dom_breadcrumbs.png "JS_DOM_Breadcrumbs")  
...
-   Use the JavaScript memory analyzer to [analyze memory usage](../VS_csharp/javascript-memory.md) in your app. Event listeners that must be explicitly removed might appear as a memory leak.  
  
## See Also  
 [QuickStart: Debug HTML, CSS, and JavaScript](../VS_csharp/quickstart--debug-html-and-css.md)   
 [Debug CSS Rules](../VS_csharp/debug-css-styles-using-dom-explorer.md)   
 [Debug layout](../VS_csharp/debug-layout-using-dom-explorer.md)