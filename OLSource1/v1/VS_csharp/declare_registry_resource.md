...
## Remarks  
 When you create an object or control using the ATL Project Wizard, the wizard will automatically implement script-based registry support and add the [DECLARE_REGISTRY_RESOURCEID](../VS_csharp/declare_registry_resourceid.md) macro, which is similar to `DECLARE_REGISTRY_RESOURCE`, to your files.  
 ...
 [!code[NVC_ATL_COM#56](../VS_csharp/codesnippet/CPP/declare_registry_resource_1.h)]  
...
## See Also  
 ...
 [_ATL_STATIC_REGISTRY](../VS_csharp/_atl_static_registry.md)