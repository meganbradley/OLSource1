...
## Remarks  
 ...
 ![Task group, expanded](../VS_csharp/media/nexttaskgrpexpand.png "NextTaskGrpExpand")  
  
 The following illustration shows a collapsed task group:  
  
 ![Collapsed task group](../VS_csharp/media/nexttaskgrpcollapse.png "NextTaskGrpCollapse")  
  
 The following illustration shows a task group without a caption:  
  
 ![Task group without a caption](../VS_csharp/media/nexttaskgrpnocapt.png "NextTaskGrpNoCapt")  
 ...
 ![Special task group](../VS_csharp/media/nexttaskgrpspecial.png "NextTaskGrpSpecial")  
  
## Inheritance Hierarchy  
 [CObject](../VS_csharp/cobject-class.md)  
  
 [CMFCTasksPaneTaskGroup](../VS_csharp/cmfctaskspanetaskgroup-class.md)  
...
### Remarks  
 Only one group can be aligned to the bottom of the task pane control. This task group must be added last. For more information, see [CMFCTasksPane::AddGroup](../VS_csharp/cmfctaskspane-class.md#cmfctaskspane__addgroup).  
...
### Remarks  
 You can enable or disable the ability to collapse groups on the task pane by calling [CMFCTasksPane::EnableGroupCollapse](../VS_csharp/cmfctaskspane-class.md#cmfctaskspane__enablegroupcollapse).  
...
### Remarks  
 To fill this list, call [CMFCTasksPane::AddTask](../VS_csharp/cmfctaskspane-class.md#cmfctaskspane__addtask).  
...
## See Also  
 ...
 [CMFCTasksPane Class](../VS_csharp/cmfctaskspane-class.md)   
