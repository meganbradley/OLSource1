...
### Command Line  
 Using the [VSPerfCmd](../VS_csharp/vsperfcmd.md) command line tool, you can list the CPU counters that are available on a computer from the command line.  
...
## See Also  
 ...
 [How to: Collect CPU Counter Data](../VS_csharp/how-to--collect-cpu-counter-data.md)   
