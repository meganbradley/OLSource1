...
2.  Open the work item, choose **Links**. Under **Model Link**, open the shortcut menu for the linked model element. Choose **Open Linked Item**.  
     ...
     ![Open linked model element from a work item](../VS_csharp/media/workitem_openlinkedmodelelement.png "WorkItem_OpenLinkedModelElement")  
...
|The work item doesn't have the linked model elements that you expect.|A work item shows a linked layer element only if the link was created from the work item. If your team does not use [!INCLUDE[esprscc](../VS_csharp/includes/esprscc_md.md)], the local path of the diagrams will be used to create the links. If the modeling project and its diagrams are in [!INCLUDE[esprscc](../VS_csharp/includes/esprscc_md.md)], all team members who can access the project can view linked elements in work items.|Try refreshing the work item.|  
...
## See Also  
 ...
 [Overview of Modeling Diagrams](../VS_csharp/create-models-for-your-app.md)