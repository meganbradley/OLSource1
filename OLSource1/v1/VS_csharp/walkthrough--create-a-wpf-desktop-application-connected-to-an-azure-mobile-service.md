...
5.  In the lower pane of the designer, select the `<Grid>` and `</Grid>` tags and replace them with the following XAML code:  
    ...
    ```  
     ...
     ![The QuickStartTask user control](../VS_csharp/media/wpfquickstart1.PNG "WPFQuickStart1")  
...
5.  Select the `<Grid>` and `</Grid>` tags and replace them with the following XAML code:  
    ...
    ```  
     ...
     ![The MainWindow in the designer](../VS_csharp/media/wpfquickstart2.PNG "WPFQuickStart2")  
...
3.  Enter `Do something else`, and then choose the **Save** button again.  
     ...
     ![The Todo items are added to the list.](../VS_csharp/media/wpfquickstart3.PNG "WPFQuickStart3")  
...
## Next Steps  
 ...
 You can make the user interface more appealing by adding color, shapes, graphics, and even animations. See [Designing XAML in Visual Studio](../VS_csharp/designing-xaml-in-visual-studio.md).  
...
## See Also  
 [Walkthrough: My First WPF Desktop Application](../VS_csharp/walkthrough--my-first-wpf-desktop-application.md)   
