...
-   A pointer to a [CFieldExchange](../VS_csharp/cfieldexchange-class.md) object. You simply pass along the `pFX` pointer passed to `DoFieldExchange`.  
...
-   (Optional) In the `RFX_Text` function, you sometimes use a fifth parameter to specify the data type of a column.  
 ...
 For more information, see the RFX functions under [Macros and Globals](../VS_csharp/macros--global-functions--and-global-variables.md) in the *Class Library Reference*. For an example of when you might make special use of the parameters, see [Recordset: Obtaining SUMs and Other Aggregate Results (ODBC)](../VS_csharp/recordset--obtaining-sums-and-other-aggregate-results--odbc-.md).  
...
|`RFX_Date`|`CTime`|  
 ...
 For more information, see the RFX function documentation under [Macros and Globals](../VS_csharp/macros--global-functions--and-global-variables.md) in the *Class Library Reference*. For information about how C++ data types map to SQL data types, see the table ANSI SQL Data Types Mapped to C++ Data Types in [SQL: SQL and C++ Data Types (ODBC)](../VS_csharp/sql--sql-and-c---data-types--odbc-.md).  
...
## See Also  
 ...
 [CFieldExchange Class](../VS_csharp/cfieldexchange-class.md)