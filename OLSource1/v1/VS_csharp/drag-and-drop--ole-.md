...
The drag-and-drop feature of OLE is primarily a shortcut for copying and pasting data. When you use the Clipboard to copy or paste data, a number of steps are required. You select the data, click **Cut** or **Copy** from the **Edit** menu, move to the destination file, window or application, place the cursor in the desired location, and click **Paste** from the **Edit** menu.  
 ...
 If you only want to use the drag-and-drop capabilities of OLE, see [Drag and Drop: Customizing](../VS_csharp/drag-and-drop--customizing.md). You can use the techniques explained in that article to make non-OLE applications drop sources. The article [Drag and Drop: Implementing a Drop Target](../VS_csharp/drag-and-drop--implementing-a-drop-target.md) describes how to implement drop-target support for both OLE and non-OLE applications. It will also be helpful to examine the MFC OLE samples [OCLIENT](../VS_csharp/visual-c---samples.md) and [HIERSVR](../VS_csharp/visual-c---samples.md).  
  
 If you have not read the [Data Objects and Data Sources (OLE)](../VS_csharp/data-objects-and-data-sources--ole-.md) family of articles, you may want to do so now. These articles explain the fundamentals of data transfer, and how to implement it in your applications.  
  
 For more information about drag and drop, see:  
  
-   [Drag and Drop: Implementing a Drop Source](../VS_csharp/drag-and-drop--implementing-a-drop-source.md)  
  
-   [Drag and Drop: Implementing a Drop Target](../VS_csharp/drag-and-drop--implementing-a-drop-target.md)  
  
-   [Drag and Drop: Customizing](../VS_csharp/drag-and-drop--customizing.md)  
