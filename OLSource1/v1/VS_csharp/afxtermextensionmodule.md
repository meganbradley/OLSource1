...
#### Parameters  
 `state`  
 A reference to the [AFX_EXTENSION_MODULE](../VS_csharp/afx_extension_module-structure.md) structure that contains the state of extension DLL module.  
...
## Remarks  
 ...
 [!code[NVC_MFC_DLL#4](../VS_csharp/codesnippet/CPP/afxtermextensionmodule_1.cpp)]  
 ...
 MFC extension DLLs need to call [AfxInitExtensionModule](../VS_csharp/afxinitextensionmodule.md) in their `DllMain`. If the DLL will be exporting [CRuntimeClass](../VS_csharp/cruntimeclass-structure.md) objects or has its own custom resources, you also need to create a **CDynLinkLibrary** object in `DllMain`.  
...
## See Also  
 ...
 [AfxInitExtensionModule](../VS_csharp/afxinitextensionmodule.md)