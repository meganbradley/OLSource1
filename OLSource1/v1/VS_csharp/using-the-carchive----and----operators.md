...
1.  The following example shows how to store an object in a file via an archive:  
     ...
     [!code[NVC_MFCSerialization#7](../VS_csharp/codesnippet/CPP/using-the-carchive----and----operators_1.cpp)]  
...
1.  The following example shows how to load an object from a value previously stored in a file:  
     ...
     [!code[NVC_MFCSerialization#8](../VS_csharp/codesnippet/CPP/using-the-carchive----and----operators_2.cpp)]  
 ...
 [!code[NVC_MFCSerialization#9](../VS_csharp/codesnippet/CPP/using-the-carchive----and----operators_3.cpp)]  
 ...
 [!code[NVC_MFCSerialization#10](../VS_csharp/codesnippet/CPP/using-the-carchive----and----operators_4.cpp)]  
...
> [!NOTE]
>  Storing and loading `CObject`s via an archive requires extra consideration. For more information, see [Storing and Loading CObjects via an Archive](../VS_csharp/storing-and-loading-cobjects-via-an-archive.md).  
 ...
 [!code[NVC_MFCSerialization#11](../VS_csharp/codesnippet/CPP/using-the-carchive----and----operators_5.cpp)]  
