...
Use this dialog box to find and select the node for a specific message in [Messages View](../VS_csharp/messages-view.md). To display this dialog box, move the focus to a Messages view window. Then choose **Find Message** from the **Search** menu.  
...
## Related Sections  
 ...
 [Messages View](../VS_csharp/messages-view.md)  
