...
3.  Select the **Enable full solution analysis** check box to enable full solution analysis, or clear the box to disable it. Choose the **OK** button when you're done.  
     ...
     ![Enable full solution analysis check box.](../VS_csharp/media/fsa_toolsoptions.png "FSA_ToolsOptions")  
...
## Results of enabling and disabling full solution analysis  
 ...
 ![Full solution analysis enabled.](../VS_csharp/media/fsa_enabled.png "FSA_Enabled")  
 ...
 ![Full solution analysis disabled.](../VS_csharp/media/fsa_disabled.png "FSA_Disabled")  
...
## Automatically disabling full solution analysis  
 ...
 ![Alert text suspending full solution analysis](../VS_csharp/media/fsa_alert.png "FSA_Alert")  
