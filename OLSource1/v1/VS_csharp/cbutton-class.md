...
## Remarks  
 ...
 Typical buttons are the check box, radio button, and pushbutton. A `CButton` object can become any of these, according to the [button style](../VS_csharp/button-styles.md) specified at its initialization by the [Create](#cbutton__create) member function.  
  
 In addition, the [CBitmapButton](../VS_csharp/cbitmapbutton-class.md) class derived from `CButton` supports creation of button controls labeled with bitmap images instead of text. A `CBitmapButton` can have separate bitmaps for a button's up, down, focused, and disabled states.  
 ...
 If you want to handle Windows notification messages sent by a button control to its parent (usually a class derived from [CDialog](../VS_csharp/cdialog-class.md)), add a message-map entry and message-handler member function to the parent class for each message.  
...
### Example  
 [!code[NVC_MFC_CButton#1](../VS_csharp/codesnippet/CPP/cbutton-class_1.cpp)]  
...
### Parameters  
 ...
 `dwStyle`  
 Specifies the button control's style. Apply any combination of [button styles](../VS_csharp/button-styles.md) to the button.  
...
### Remarks  
 ...
 Apply the following [window styles](../VS_csharp/window-styles.md) to a button control:  
...
### Example  
 [!code[NVC_MFC_CButton#2](../VS_csharp/codesnippet/CPP/cbutton-class_2.cpp)]  
...
### Parameters  
 `lpDrawItemStruct`  
 A long pointer to a [DRAWITEMSTRUCT](../VS_csharp/drawitemstruct-structure.md) structure. The structure contains information about the item to be drawn and the type of drawing required.  
...
### Remarks  
 ...
 Also see the [BS_](../VS_csharp/button-styles.md) style values.  
  
### Example  
 [!code[NVC_MFC_CButton#3](../VS_csharp/codesnippet/CPP/cbutton-class_3.cpp)]  
...
### Example  
 [!code[NVC_MFC_CButton#4](../VS_csharp/codesnippet/CPP/cbutton-class_4.cpp)]  
...
### Return Value  
 Returns the button styles for this `CButton` object. This function returns only the [BS_](../VS_csharp/button-styles.md) style values, not any of the other window styles.  
  
### Example  
 [!code[NVC_MFC_CButton#5](../VS_csharp/codesnippet/CPP/cbutton-class_5.cpp)]  
...
### Example  
 [!code[NVC_MFC_CButton#6](../VS_csharp/codesnippet/CPP/cbutton-class_6.cpp)]  
...
### Example  
 [!code[NVC_MFC_CButton#7](../VS_csharp/codesnippet/CPP/cbutton-class_7.cpp)]  
...
### Example  
 [!code[NVC_MFC_CButton#8](../VS_csharp/codesnippet/CPP/cbutton-class_8.cpp)]  
...
### Remarks  
 This member function emulates the functionality of the **BCM_GETIDEALSIZE** message, as described in the                         [Buttons](http://msdn.microsoft.com/library/windows/desktop/bb775943) section of the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Remarks  
 This member function emulates the functionality of the **BCM_GETIMAGELIST** message, as described in the                         [Buttons](http://msdn.microsoft.com/library/windows/desktop/bb775943) section of the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Return Value  
 In the first overload, a [CString](../VS_csharp/using-cstring.md) object that contains the note text associated with the current command link control.  
...
### Remarks  
 ...
 This method sends the                         [BCM_GETNOTE](http://msdn.microsoft.com/library/windows/desktop/bb775965) message, which is described in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Remarks  
 ...
 This method sends the                         [BCM_GETNOTELENGTH](http://msdn.microsoft.com/library/windows/desktop/bb775967) message, which is described in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Remarks  
 ...
 This method initializes the `mask` member of a                         [BUTTON_SPLITINFO](http://msdn.microsoft.com/library/windows/desktop/bb775955) structure with the `BCSIF_GLYPH` flag, and then sends that structure in the                         [BCM_GETSPLITINFO](http://msdn.microsoft.com/library/windows/desktop/bb775969) message that is described in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)]. When the message function returns, this method retrieves the glyph from the `himlGlyph` member of the structure.  
  
##  <a name="cbutton__getsplitimagelist"></a>  CButton::GetSplitImageList  
 Retrieves the [image list](../VS_csharp/cimagelist-class.md) for the current split button control.  
...
### Return Value  
 A pointer to a [CImageList](../VS_csharp/cimagelist-class.md) object.  
  
### Remarks  
 Use this method only with controls whose button style is `BS_SPLITBUTTON` or `BS_DEFSPLITBUTTON`.  
  
 This method initializes the `mask` member of a                         [BUTTON_SPLITINFO](http://msdn.microsoft.com/library/windows/desktop/bb775955) structure with the `BCSIF_IMAGE` flag, and then sends that structure in the                         [BCM_GETSPLITINFO](http://msdn.microsoft.com/library/windows/desktop/bb775969) message that is described in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)]. When the message function returns, this method retrieves the image list from the `himlGlyph` member of the structure.  
...
### Remarks  
 ...
 This method sends the                         [BCM_GETSPLITINFO](http://msdn.microsoft.com/library/windows/desktop/bb775969) message, which is described in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Remarks  
 ...
 This method initializes the `mask` member of a                         [BUTTON_SPLITINFO](http://msdn.microsoft.com/library/windows/desktop/bb775955) structure with the `BCSIF_SIZE` flag, and then sends that structure in the                         [BCM_GETSPLITINFO](http://msdn.microsoft.com/library/windows/desktop/bb775969) message that is described in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)]. When the message function returns, this method retrieves the bounding rectangle from the `size` member of the structure.  
...
### Remarks  
 ...
 This method initializes the `mask` member of a                         [BUTTON_SPLITINFO](http://msdn.microsoft.com/library/windows/desktop/bb775955) structure with the `BCSIF_STYLE` flag, and then sends that structure in the                         [BCM_GETSPLITINFO](http://msdn.microsoft.com/library/windows/desktop/bb775969) message that is described in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)]. When the message function returns, this method retrieves the split button styles from the `uSplitStyle` member of the structure.  
...
### Example  
 [!code[NVC_MFC_CButton#9](../VS_csharp/codesnippet/CPP/cbutton-class_9.cpp)]  
...
### Remarks  
 This member function emulates the functionality of the **BCM_GETTEXTMARGIN** message, as described in the                         [Buttons](http://msdn.microsoft.com/library/windows/desktop/bb775943) section of the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
-   **BS_VCENTER**  
 ...
 Unlike [CBitmapButton](../VS_csharp/cbitmapbutton-class.md), which uses four bitmaps per button, `SetBitmap` uses only one bitmap per the button. When the button is pressed, the bitmap appears to shift down and to the right.  
...
### Parameters  
 `nStyle`  
 Specifies the [button style](../VS_csharp/button-styles.md).  
...
-   **BS_VCENTER**  
 ...
 Unlike [CBitmapButton](../VS_csharp/cbitmapbutton-class.md), which uses four bitmaps per button, `SetCursor` uses only one cursor per the button. When the button is pressed, the cursor appears to shift down and to the right.  
...
### Remarks  
 ...
 This method sends the                         [BCM_SETDROPDOWNSTATE](http://msdn.microsoft.com/library/windows/desktop/bb775973) message, which is described in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Example  
 ...
 [!code[NVC_MFC_CButton_s1#1](../VS_csharp/codesnippet/CPP/cbutton-class_10.h)]  
  
### Example  
 The following code example sets the state of the split button control to indicate that the drop-down arrow is pushed.  
  
 [!code[NVC_MFC_CButton_s1#6](../VS_csharp/codesnippet/CPP/cbutton-class_11.cpp)]  
...
### Remarks  
 ...
 This method sends the                         [BCM_SETSHIELD](http://msdn.microsoft.com/library/windows/desktop/bb775979) message, which is described in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
-   **BS_VCENTER**  
 ...
 Unlike [CBitmapButton](../VS_csharp/cbitmapbutton-class.md), which uses four bitmaps per button, `SetIcon` uses only one icon per the button. When the button is pressed, the icon appears to shift down and to the right.  
...
### Remarks  
 This member function emulates the functionality of the **BCM_SETIMAGELIST** message, as described in the                         [Buttons](http://msdn.microsoft.com/library/windows/desktop/bb775943) section of the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Remarks  
 ...
 This method sends the                         [BCM_SETNOTE](http://msdn.microsoft.com/library/windows/desktop/bb775977) message, which is described in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Example  
 ...
 [!code[NVC_MFC_CButton_s1#7](../VS_csharp/codesnippet/CPP/cbutton-class_12.cpp)]  
...
|Parameter|Description|  
|---------------|-----------------|  
|[in] `pSplitImageList`|Pointer to a [CImageList](../VS_csharp/cimagelist-class.md) object to assign to the current split button control.|  
...
### Remarks  
 ...
 This method sends the                         [BCM_SETSPLITINFO](http://msdn.microsoft.com/library/windows/desktop/bb775981) message, which is described in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Example  
 ...
 [!code[NVC_MFC_CButton_s1#4](../VS_csharp/codesnippet/CPP/cbutton-class_13.cpp)]  
...
### Example  
 ...
 [!code[NVC_MFC_CButton_s1#5](../VS_csharp/codesnippet/CPP/cbutton-class_14.cpp)]  
...
### Example  
 ...
 [!code[NVC_MFC_CButton_s1#3](../VS_csharp/codesnippet/CPP/cbutton-class_15.cpp)]  
...
### Remarks  
 This member function emulates the functionality of the **BCM_SETTEXTMARGIN** message, as described in the                         [Buttons](http://msdn.microsoft.com/library/windows/desktop/bb775943) section of the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
