...
Used when [/vmb, /vmg (Representation Method)](../VS_csharp/-vmb---vmg--representation-method-.md) is selected as the [representation method](../VS_csharp/-vmb---vmg--representation-method-.md). These options indicate the inheritance model of the not-yet-encountered class definition.  
...
## See Also  
 [/vmb, /vmg (Representation Method)](../VS_csharp/-vmb---vmg--representation-method-.md)   
