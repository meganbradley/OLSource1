...
## Remarks  
 The template class describes various regular expression traits for type `Elem`. The template class [basic_regex](../VS_csharp/basic_regex-class.md) uses this information to manipulate elements of type `Elem`.  
...
## See Also  
 ...
 [regex_traits<char\>](../VS_csharp/regex_traits-char--class.md)   
 [regex_traits<wchar_t>](../VS_csharp/regex_traits-wchar_t--class.md)