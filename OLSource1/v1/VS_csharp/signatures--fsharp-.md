...
## Remarks  
 ...
 For more information about the default accessibility, see [Access Control (F#)](../VS_csharp/access-control--fsharp-.md).  
...
-   The pattern of parameters (also known as the *arity*) of signatures and implementations must be consistent.  
 ...
 [!code[FsSignatures#9004](../VS_csharp/codesnippet/FSharp/signatures--fsharp-_1.fs)]  
  
 The following code shows the implementation file.  
  
 [!code[FsSignatures#9001](../VS_csharp/codesnippet/FSharp/signatures--fsharp-_2.fs)]  
  
## See Also  
 [F# Language Reference](../VS_csharp/fsharp-language-reference.md)   
 [Access Control (F#)](../VS_csharp/access-control--fsharp-.md)   
