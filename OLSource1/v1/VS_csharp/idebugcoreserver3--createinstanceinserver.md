...
#### Parameters  
 ...
 `wLangId`  
 [in] Locale of the debug engine. This can be 0 if the [IDebugEngine2::SetLocale](../VS_csharp/idebugengine2--setlocale.md) method should not be called.  
...
## See Also  
 ...
 [IDebugEngine2::SetLocale](../VS_csharp/idebugengine2--setlocale.md)