...
>  In the [!INCLUDE[vbteclinq](../VS_csharp/includes/vbteclinq_md.md)] documentation, variables that store a query have the word "query" as part of their names. Variables that store an actual result do not have "query" in their names.  
 ...
 For more information about the different ways to express queries, see [Query Syntax and Method Syntax in LINQ](../VS_csharp/query-syntax-and-method-syntax-in-linq--csharp-.md).  
...
#### Explicit and Implicit Typing of Query Variables  
 ...
 For more information, see [Implicitly Typed Local Variables](../VS_csharp/implicitly-typed-local-variables--csharp-programming-guide-.md) and [Type Relationships in LINQ Query Operations](../VS_csharp/type-relationships-in-linq-query-operations--csharp-.md).  
...
### Starting a Query Expression  
 ...
 For more information, see [from clause](../VS_csharp/from-clause--csharp-reference-.md).  
...
#### group Clause  
 ...
 For more information about grouping, see [group clause](../VS_csharp/group-clause--csharp-reference-.md).  
...
#### select Clause  
 ...
 For more information about all the ways that a `select` clause can be used to transform source data, see [select clause](../VS_csharp/select-clause--csharp-reference-.md).  
...
#### Continuations with "into"  
 ...
 For more information, see [into](../VS_csharp/into--csharp-reference-.md).  
...
#### orderby Clause  
 ...
 The `ascending` keyword is optional; it is the default sort order if no order is specified. For more information, see [orderby clause](../VS_csharp/orderby-clause--csharp-reference-.md).  
...
#### join Clause  
 ...
 You can also perform a group join by storing the results of the `join` operation into a temporary variable by using the [into](../VS_csharp/into--csharp-reference-.md) keyword. For more information, see [join clause](../VS_csharp/join-clause--csharp-reference-.md).  
...
#### let Clause  
 ...
 For more information, see [let clause](../VS_csharp/let-clause--csharp-reference-.md).  
...
### Subqueries in a Query Expression  
 ...
 For more information, see [How to: Perform a Subquery on a Grouping Operation](../VS_csharp/how-to--perform-a-subquery-on-a-grouping-operation--csharp-programming-guide-.md).  
