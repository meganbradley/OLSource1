...
In [!INCLUDE[vsprvs](../VS_csharp/includes/vsprvs_md.md)] Visualization and Modeling SDK, you can set the background image for a generated designer by using custom code.  
...
## See Also  
 ...
 [Customizing Text and Image Fields](../VS_csharp/customizing-text-and-image-fields.md)   
