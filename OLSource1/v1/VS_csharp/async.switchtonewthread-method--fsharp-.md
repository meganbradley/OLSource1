...
## Example  
 The following code example shows how to use `Async.SwitchToNewThread` and [Async.SwitchToThreadPool](../VS_csharp/async.switchtothreadpool-method--fsharp-.md) to wrap a synchronous method call as an asynchronous method.  
  
 [!code[FsAsyncAPIs#28](../VS_csharp/codesnippet/FSharp/async.switchtonewthread-method--fsharp-_1.fs)]  
