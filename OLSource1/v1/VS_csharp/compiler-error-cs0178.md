...
-   A comma enclosed in brackets  
 ...
 For more information, see [Arrays (C# Programmer's Reference)](../VS_csharp/arrays--csharp-programming-guide-.md) and the C# specification ([C# Language Specification](../VS_csharp/csharp-language-specification.md)) section on array initializers.  
