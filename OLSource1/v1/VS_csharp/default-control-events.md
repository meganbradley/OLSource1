...
## See Also  
 ...
 [Message Types Associated with User-Interface Objects](../VS_csharp/message-types-associated-with-user-interface-objects.md)   
 [Editing a Message Handler](../VS_csharp/editing-a-message-handler.md)   
 [Defining a Message Handler for a Reflected Message](../VS_csharp/defining-a-message-handler-for-a-reflected-message.md)   
 [Declaring a Variable Based on Your New Control Class](../VS_csharp/declaring-a-variable-based-on-your-new-control-class.md)   
