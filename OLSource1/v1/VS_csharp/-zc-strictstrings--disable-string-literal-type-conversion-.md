...
> [!NOTE]
>  The Standard C++ Library in [!INCLUDE[cpp_dev12_long](../VS_csharp/includes/cpp_dev12_long_md.md)] does not support the **/Zc:strictStrings** compiler option in debug builds. If you see several [C2665](../VS_csharp/compiler-error-c2665.md) errors in your build output, this may be the cause.  
