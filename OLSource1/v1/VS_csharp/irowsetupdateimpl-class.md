...
|||  
|-|-|  
|[SetData](../VS_csharp/irowsetupdateimpl--setdata.md)|Sets data values in one or more columns.|  
  
### Interface Methods (Used with IRowsetUpdate)  
  
|||  
|-|-|  
|[GetOriginalData](../VS_csharp/irowsetupdateimpl--getoriginaldata.md)|Gets the data most recently transmitted to or obtained from the data source, ignoring pending changes.|  
|[GetPendingRows](../VS_csharp/irowsetupdateimpl--getpendingrows.md)|Returns a list of rows with pending changes.|  
|[GetRowStatus](../VS_csharp/irowsetupdateimpl--getrowstatus.md)|Returns the status of specified rows.|  
|[Undo](../VS_csharp/irowsetupdateimpl--undo.md)|Undoes any changes to the row since the last fetch or update.|  
|[Update](../VS_csharp/irowsetupdateimpl--update.md)|Transmits any changes made to the row since the last fetch or update.|  
  
### Implementation Methods (Callback)  
  
|||  
|-|-|  
|[IsUpdateAllowed](../VS_csharp/irowsetupdateimpl--isupdateallowed.md)|Used to check for security, integrity, and so on before allowing updates.|  
  
### Data Members  
  
|||  
|-|-|  
|[m_mapCachedData](../VS_csharp/irowsetupdateimpl--m_mapcacheddata.md)|Contains the original data for the deferred operation.|  
