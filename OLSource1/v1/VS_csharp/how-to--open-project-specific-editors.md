...
1.  Call the <xref:Microsoft.VisualStudio.Shell.Interop.IVsRunningDocumentTable.FindAndLockDocument*> method (RDT_EditLock) to determine whether the file (document data object) is already open.  
    ...
    > [!NOTE]
    >  For more information about document data and document view objects, see [Document Data and Document View in Custom Editors](../VS_csharp/document-data-and-document-view-in-custom-editors.md).  
