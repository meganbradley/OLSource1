...
'override_function' : matches base ref class method 'base_class_function ', but is not marked 'new' or 'override'; 'new' (and 'virtual') is assumed  
 ...
 See [override](../VS_csharp/override---c---component-extensions-.md) and [new (new slot in vtable)](../VS_csharp/new--new-slot-in-vtable----c---component-extensions-.md) for more information.  
  
 C4485 is always issued as an error. Use the [warning](../VS_csharp/warning.md) pragma to suppress C4485.  
