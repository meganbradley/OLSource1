...
-   [Setting wrap positions for a fixed-style toolbar](#_core_setting_wrap_positions_for_a_fixed.2d.style_toolbar)  
 ...
 See the MFC General sample [DOCKTOOL](../VS_csharp/visual-c---samples.md) for examples.  
...
##  <a name="_core_setting_wrap_positions_for_a_fixed.2d.style_toolbar"></a> Setting Wrap Positions for a Fixed-Style Toolbar  
 ...
 [!code[NVC_MFCDocViewSDI#10](../VS_csharp/codesnippet/CPP/docking-and-floating-toolbars_1.cpp)]  
  
 The MFC General sample [DOCKTOOL](../VS_csharp/visual-c---samples.md) shows how to use member functions of classes [CControlBar](../VS_csharp/ccontrolbar-class.md) and [CToolBar](../VS_csharp/ctoolbar-class.md) to manage dynamic layout of a toolbar. See the file EDITBAR.CPP in DOCKTOOL.  
