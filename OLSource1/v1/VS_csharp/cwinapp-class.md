...
|[CWinApp::DoMessageBox](#cwinapp__domessagebox)|Implements [AfxMessageBox](../VS_csharp/afxmessagebox.md) for the application.|  
...
|[CWinApp::RunAutomated](#cwinapp__runautomated)|Tests the application's command line for the                                         **/Automation** option. Obsolete. Instead, use the value in [CCommandLineInfo::m_bRunAutomated](../VS_csharp/ccommandlineinfo-class.md#ccommandlineinfo__m_brunautomated) after calling [ParseCommandLine](#cwinapp__parsecommandline).|  
|[CWinApp::RunEmbedded](#cwinapp__runembedded)|Tests the application's command line for the                                         **/Embedding** option. Obsolete. Instead, use the value in [CCommandLineInfo::m_bRunEmbedded](../VS_csharp/ccommandlineinfo-class.md#ccommandlineinfo__m_brunembedded) after calling [ParseCommandLine](#cwinapp__parsecommandline).|  
...
-   [AfxGetApp](../VS_csharp/afxgetapp.md) Obtains a pointer to the `CWinApp` object.  
  
-   [AfxGetInstanceHandle](../VS_csharp/afxgetinstancehandle.md) Obtains a handle to the current application instance.  
  
-   [AfxGetResourceHandle](../VS_csharp/afxgetresourcehandle.md) Obtains a handle to the application's resources.  
  
-   [AfxGetAppName](../VS_csharp/afxgetappname.md) Obtains a pointer to a string containing the application's name. Alternately, if you have a pointer to the `CWinApp` object, use `m_pszExeName` to get the application's name.  
  
 See [CWinApp: The Application Class](../VS_csharp/cwinapp--the-application-class.md) for more on the `CWinApp` class, including an overview of the following:  
...
### Example  
 [!code[NVC_MFCWindowing#35](../VS_csharp/codesnippet/CPP/cwinapp-class_1.cpp)]  
...
### Example  
 [!code[NVC_MFCWindowing#36](../VS_csharp/codesnippet/CPP/cwinapp-class_2.cpp)]  
...
### Remarks  
 ...
 To customize the behavior, override this function in a derived [CWinApp Class](../VS_csharp/cwinapp-class.md) or pass your own application recovery method as a parameter to [CWinApp::RegisterWithRestartManager](#cwinapp__registerwithrestartmanager).  
...
### Remarks  
 ...
 If the function is successful, when you have finished printing, you must destroy the device context. You can let the destructor of the [CDC](../VS_csharp/cdc-class.md) object do it, or you can do it explicitly by calling [CDC::DeleteDC](../VS_csharp/cdc-class.md#cdc__deletedc).  
...
##  <a name="cwinapp__domessagebox"></a>  CWinApp::DoMessageBox  
 The framework calls this member function to implement a message box for the global function [AfxMessageBox](../VS_csharp/afxmessagebox.md).  
 ...
 *lpszPrompt*  
 ...
 `nType`  
 The message box [style](../VS_csharp/message-box-styles.md).  
...
##  <a name="cwinapp__dowaitcursor"></a>  CWinApp::DoWaitCursor  
 This member function is called by the framework to implement [CWaitCursor](../VS_csharp/cwaitcursor-class.md), [CCmdTarget::BeginWaitCursor](../VS_csharp/ccmdtarget-class.md#ccmdtarget__beginwaitcursor), [CCmdTarget::EndWaitCursor](../VS_csharp/ccmdtarget-class.md#ccmdtarget__endwaitcursor), and [CCmdTarget::RestoreWaitCursor](../VS_csharp/ccmdtarget-class.md#ccmdtarget__restorewaitcursor).  
...
### Example  
 [!code[NVC_MFCWindowing#37](../VS_csharp/codesnippet/CPP/cwinapp-class_3.cpp)]  
  
##  <a name="cwinapp__enabled2dsupport"></a>  CWinApp::EnableD2DSupport  
 [!INCLUDE[dev10_sp1required](../VS_csharp/includes/dev10_sp1required_md.md)]  
...
### Example  
 [!code[NVC_MFCWindowing#38](../VS_csharp/codesnippet/CPP/cwinapp-class_4.cpp)]  
...
### Example  
 [!code[NVC_MFCWindowing#39](../VS_csharp/codesnippet/CPP/cwinapp-class_5.cpp)]  
...
### Remarks  
 Each application that uses the restart manager must have one instance of the [CDataRecoveryHandler Class](../VS_csharp/cdatarecoveryhandler-class.md). This class is responsible for monitoring open documents and autosaving files. The behavior of the `CDataRecoveryHandler` depends on the configuration of the restart manager. For more information, see [CDataRecoveryHandler Class](../VS_csharp/cdatarecoveryhandler-class.md).  
  
 This method returns `NULL` on operating systems earlier than [!INCLUDE[wiprlhext](../VS_csharp/includes/wiprlhext_md.md)]. The restart manager is not supported on operating systems earlier than [!INCLUDE[wiprlhext](../VS_csharp/includes/wiprlhext_md.md)].  
...
### Remarks  
 Use the **POSITION** value returned in a call to [GetNextDocTemplate](#cwinapp__getnextdoctemplate) to get the first [CDocTemplate](../VS_csharp/cdoctemplate-class.md) object.  
...
### Return Value  
 A pointer to a [CDocTemplate](../VS_csharp/cdoctemplate-class.md) object.  
...
### Example  
 [!code[NVC_MFCWindowing#40](../VS_csharp/codesnippet/CPP/cwinapp-class_6.cpp)]  
...
### Example  
 [!code[NVC_MFCWindowing#41](../VS_csharp/codesnippet/CPP/cwinapp-class_7.cpp)]  
...
### Example  
 [!code[NVC_MFCWindowing#42](../VS_csharp/codesnippet/CPP/cwinapp-class_8.cpp)]  
...
### Example  
 [!code[NVC_MFCWindowing#43](../VS_csharp/codesnippet/CPP/cwinapp-class_9.cpp)]  
...
### Parameters  
 ...
 `nCmd`  
 Specifies the type of help requested. For a list of possible values and how they affect the `dwData` parameter, see the `uCommand` parameter described in [About the HTMLHelp API Function](vsconhowcallingthehtmlhelpapi) in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Remarks  
 ...
 Override `InitInstance` to initialize each new instance of your application running under Windows. Typically, you override `InitInstance` to construct your main window object and set the `CWinThread::m_pMainWnd` data member to point to that window. For more information on overriding this member function, see [CWinApp: The Application Class](../VS_csharp/cwinapp--the-application-class.md).  
...
### Example  
 [!code[NVC_MFCListView#9](../VS_csharp/codesnippet/CPP/cwinapp-class_10.cpp)]  
...
### Parameters  
 ...
 `nIDResource`  
 ID of the cursor resource. For a list of resources, see                                 [LoadCursor](http://msdn.microsoft.com/library/windows/desktop/ms648391) in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Example  
 [!code[NVC_MFCWindowing#44](../VS_csharp/codesnippet/CPP/cwinapp-class_11.cpp)]  
...
### Example  
 [!code[NVC_MFCWindowing#45](../VS_csharp/codesnippet/CPP/cwinapp-class_12.h)]  
  
 [!code[NVC_MFCWindowing#46](../VS_csharp/codesnippet/CPP/cwinapp-class_13.cpp)]  
...
### Example  
 [!code[NVC_MFCWindowing#47](../VS_csharp/codesnippet/CPP/cwinapp-class_14.cpp)]  
...
|-   `AFX_RESTART_MANAGER_REOPEN_PREVIOUS_FILES`|The restart manager opens previously open documents after restarting the application from an unexpected exit. The [CDataRecoveryHandler Class](../VS_csharp/cdatarecoveryhandler-class.md) handles storing the list of open documents and restoring them.|  
...
### Remarks  
 The `m_hInstance` data member is a handle to the current instance of the application running under Windows. This is returned by the global function [AfxGetInstanceHandle](../VS_csharp/afxgetinstancehandle.md). `m_hInstance` is a public variable of type `HINSTANCE`.  
  
### Example  
 [!code[NVC_MFCWindowing#55](../VS_csharp/codesnippet/CPP/cwinapp-class_15.cpp)]  
...
### Example  
 [!code[NVC_MFCWindowing#52](../VS_csharp/codesnippet/CPP/cwinapp-class_16.cpp)]  
...
### Remarks  
 You should pass `m_nCmdShow` as an argument when you call [CWnd::ShowWindow](../VS_csharp/cwnd-class.md#cwnd__showwindow) for your application's main window. `m_nCmdShow` is a public variable of type `int`.  
  
### Example  
 [!code[NVC_MFCWindowing#56](../VS_csharp/codesnippet/CPP/cwinapp-class_17.cpp)]  
...
### Remarks  
 The data recovery handler of an application monitors open documents and autosaves them. The framework uses the data recovery handler to restore autosaved files when an application restarts after it exits unexpectedly. For more information, see [CDataRecoveryHandler Class](../VS_csharp/cdatarecoveryhandler-class.md).  
...
### Remarks  
 ...
 Returned by the global function [AfxGetAppName](../VS_csharp/afxgetappname.md). `m_pszAppName` is a public variable of type **const char\***.  
...
>  If you assign a value to `m_pszAppName`, it must be dynamically allocated on the heap. The `CWinApp` destructor calls **free**( ) with this pointer. You many want to use the `_tcsdup`( ) run-time library function to do the allocating. Also, free the memory associated with the current pointer before assigning a new value. For example:  
 ...
 [!code[NVC_MFCWindowing#57](../VS_csharp/codesnippet/CPP/cwinapp-class_18.cpp)]  
  
### Example  
 [!code[NVC_MFCWindowing#65](../VS_csharp/codesnippet/CPP/cwinapp-class_19.cpp)]  
...
>  If you assign a value to `m_pszExeName`, it must be dynamically allocated on the heap. The `CWinApp` destructor calls **free**( ) with this pointer. You many want to use the `_tcsdup`( ) run-time library function to do the allocating. Also, free the memory associated with the current pointer before assigning a new value. For example:  
 ...
 [!code[NVC_MFCWindowing#58](../VS_csharp/codesnippet/CPP/cwinapp-class_20.cpp)]  
...
>  If you assign a value to `m_pszHelpFilePath`, it must be dynamically allocated on the heap. The `CWinApp` destructor calls **free**( ) with this pointer. You many want to use the `_tcsdup`( ) run-time library function to do the allocating. Also, free the memory associated with the current pointer before assigning a new value. For example:  
 ...
 [!code[NVC_MFCWindowing#59](../VS_csharp/codesnippet/CPP/cwinapp-class_21.cpp)]  
...
>  If you assign a value to `m_pszProfileName`, it must be dynamically allocated on the heap. The `CWinApp` destructor calls **free**( ) with this pointer. You many want to use the `_tcsdup`( ) run-time library function to do the allocating. Also, free the memory associated with the current pointer before assigning a new value. For example:  
 ...
 [!code[NVC_MFCWindowing#60](../VS_csharp/codesnippet/CPP/cwinapp-class_22.cpp)]  
...
-   The value is stored to a registry key. The name for the application profile setting is appended to the following registry key: HKEY_CURRENT_USER/Software/LocalAppWizard-Generated/.  
 ...
 [!code[NVC_MFCWindowing#61](../VS_csharp/codesnippet/CPP/cwinapp-class_23.cpp)]  
...
### Example  
 [!code[NVC_MFCWindowing#48](../VS_csharp/codesnippet/CPP/cwinapp-class_24.cpp)]  
...
### Remarks  
 ...
 See [Technical Note 22](../VS_csharp/tn022--standard-commands-implementation.md) for information on default behavior and guidance on how to override this member function.  
  
### Example  
 [!code[NVC_MFCWindowing#49](../VS_csharp/codesnippet/CPP/cwinapp-class_25.cpp)]  
  
 [!code[NVC_MFCWindowing#50](../VS_csharp/codesnippet/CPP/cwinapp-class_26.cpp)]  
...
### Remarks  
 ...
 For information on default behavior and guidance on how to override this member function, see [Technical Note 22](../VS_csharp/tn022--standard-commands-implementation.md).  
...
>  The default implementation of `OnIdle` updates command user-interface objects such as menu items and toolbar buttons, and it performs internal data structure cleanup. Therefore, if you override `OnIdle`, you must call `CWinApp::OnIdle` with the `lCount` in your overridden version. First call all base-class idle processing (that is, until the base class `OnIdle` returns 0). If you need to perform work before the base-class processing completes, review the base-class implementation to select the proper `lCount` during which to do your work.  
 ...
 If you do not want `OnIdle` to be called whenever a message is retrieved from the message queue, you can override the [CWinThreadIsIdleMessage](../VS_csharp/cwinthread-class.md#cwinthread__isidlemessage). If an application has set a very short timer, or if the system is sending the **WM_SYSTIMER** message, then `OnIdle` will be called repeatedly, and degrade performance.  
...
### Example  
 ...
 [!code[NVC_MFCWindowing#51](../VS_csharp/codesnippet/CPP/cwinapp-class_27.cpp)]  
  
##  <a name="cwinapp__opendocumentfile"></a>  CWinApp::OpenDocumentFile  
 The framework calls this method to open the named [CDocument](../VS_csharp/cdocument-class.md) file for the application.  
...
##  <a name="cwinapp__parsecommandline"></a>  CWinApp::ParseCommandLine  
 Call this member function to parse the command line and send the parameters, one at a time, to [CCommandLineInfo::ParseParam](../VS_csharp/ccommandlineinfo-class.md#ccommandlineinfo__parseparam).  
...
### Parameters  
 `rCmdInfo`  
 A reference to a [CCommandLineInfo](../VS_csharp/ccommandlineinfo-class.md) object.  
...
4.  `ProcessShellCommand` handles the command-line arguments and flags.  
 ...
 For a description of the command-line flags, see [CCommandLineInfo::m_nShellCommand](../VS_csharp/ccommandlineinfo-class.md#ccommandlineinfo__m_nshellcommand).  
...
### Parameters  
 `pMsg`  
 A pointer to a [MSG](../VS_csharp/msg-structure.md) structure that contains the message to process.  
...
### Parameters  
 ...
 `lpMsg`  
 A pointer to a Windows [MSG](../VS_csharp/msg-structure.md) structure.  
...
2.  `ParseCommandLine` then calls [CCommandLineInfo::ParseParam](../VS_csharp/ccommandlineinfo-class.md#ccommandlineinfo__parseparam) repeatedly, once for each parameter.  
  
3.  `ParseParam` fills the `CCommandLineInfo` object, which is then passed to `ProcessShellCommand`.  
  
4.  `ProcessShellCommand` handles the command-line arguments and flags.  
  
 The data members of the `CCommandLineInfo` object, identified by [CCommandLineInfo::m_nShellCommand](../VS_csharp/ccommandlineinfo-class.md#ccommandlineinfo__m_nshellcommand), are of the following enumerated type, which is defined within the `CCommandLineInfo` class.  
 ...
 *e*  
 ...
 `pMsg`  
 A [MSG](../VS_csharp/msg-structure.md) structure that contains information about the windows message that caused the framework to throw an exception.  
...
### Remarks  
 When the restart manager restarts an application, the framework calls this method. This method retrieves the data recovery handler and restores the autosaved files. This method calls [CDataRecoveryHandler::RestoreAutosavedDocuments](../VS_csharp/cdatarecoveryhandler-class.md#cdatarecoveryhandler__restoreautosaveddocuments) to determine whether the user wants to restore the autosaved files.  
  
 This method returns `FALSE` if the [CDataRecoveryHandler](../VS_csharp/cdatarecoveryhandler-class.md) determines that there were no open documents. If there were no open documents, the application starts ordinarily.  
...
### Remarks  
 If present, the option is removed from the command line. For more information on OLE Automation, see the article [Automation Servers](../VS_csharp/automation-servers.md).  
...
### Remarks  
 If present, the option is removed from the command line. For more information on embedding, see the article [Servers: Implementing a Server](../VS_csharp/servers--implementing-a-server.md).  
...
### Remarks  
 The default implementation of this member function calls the [CDocument::SaveModified](../VS_csharp/cdocument-class.md#cdocument__savemodified) member function in turn for all modified documents within the application.  
...
### Parameters  
 `hDevNames`  
 A handle to a [DEVNAMES](../VS_csharp/devnames-structure.md) structure that identifies the driver, device, and output port names of a specific printer.  
...
### Example  
 [!code[NVC_MFCWindowing#53](../VS_csharp/codesnippet/CPP/cwinapp-class_28.cpp)]  
...
### Example  
 ...
 [!code[NVC_MFCWindowing#54](../VS_csharp/codesnippet/CPP/cwinapp-class_29.cpp)]  
...
## See Also  
 [Base Class](../VS_csharp/cwinthread-class.md)   
 [Hierarchy Chart](../VS_csharp/hierarchy-chart.md)   
 [How to: Add Restart Manager Support](../VS_csharp/how-to--add-restart-manager-support.md)