 ...
 *lppos*  
 Points to a [WINDOWPOS](../VS_csharp/windowpos-structure.md) structure that contains the size and position values specified in the operation that caused the window to be moved or resized.  
