...
|----------------|-----------------|  
|where T: struct|The type argument must be a value type. Any value type except \<xref:System.Nullable> can be specified. See [Using Nullable Types](../VS_csharp/using-nullable-types--csharp-programming-guide-.md) for more information.|  
