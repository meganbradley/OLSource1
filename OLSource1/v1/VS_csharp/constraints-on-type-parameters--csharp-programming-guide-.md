...
|----------------|-----------------|  
|where T: struct|The type argument must be a value type. Any value type except <xref:System.Nullable*> can be specified. See [Using Nullable Types (C# Programmer's Reference)](../VS_csharp/using-nullable-types--csharp-programming-guide-.md) for more information.|  
...
## Why Use Constraints  
 ...
 [!code[csProgGuideGenerics#12](../VS_csharp/codesnippet/CSharp/constraints-on-type-parameters--csharp-programming-guide-_2.cs)]  
 ...
 [!code[csProgGuideGenerics#13](../VS_csharp/codesnippet/CSharp/constraints-on-type-parameters--csharp-programming-guide-_3.cs)]  
...
## Constraining Multiple Parameters  
 ...
 [!code[csProgGuideGenerics#64](../VS_csharp/codesnippet/CSharp/constraints-on-type-parameters--csharp-programming-guide-_4.cs)]  
...
-   You can compare to [null](../VS_csharp/null--csharp-reference-.md). If an unbounded parameter is compared to `null`, the comparison will always return false if the type argument is a value type.  
...
## Type Parameters as Constraints  
 ...
 [!code[csProgGuideGenerics#14](../VS_csharp/codesnippet/CSharp/constraints-on-type-parameters--csharp-programming-guide-_5.cs)]  
 ...
 [!code[csProgGuideGenerics#15](../VS_csharp/codesnippet/CSharp/constraints-on-type-parameters--csharp-programming-guide-_6.cs)]  
...
## See Also  
 ...
 [Generics Overview(C#)](../VS_csharp/introduction-to-generics--csharp-programming-guide-.md)   
 [Generic Classes (C# Programming Guide)](../VS_csharp/generic-classes--csharp-programming-guide-.md)   
 [new Constraint (C# Programming Guide)](../VS_csharp/new-constraint--csharp-reference-.md)