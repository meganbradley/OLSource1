...
## Return Value  
 ...
 The difference between `_scprintf_p` and `_scprintf` is that `_scprintf_p` supports positional parameters, which allows specifying the order in which the arguments are used in the format string. For more information, see [printf Positional Parameters](../VS_csharp/printf_p-positional-parameters.md).  
...
## See Also  
 ...
 [_scprintf, _scprintf_l, _scwprintf, _scwprintf_l](../VS_csharp/_scprintf--_scprintf_l--_scwprintf--_scwprintf_l.md)   
 [_printf_p, _printf_p_l, _wprintf_p, _wprintf_p_l](../VS_csharp/_printf_p--_printf_p_l--_wprintf_p--_wprintf_p_l.md)