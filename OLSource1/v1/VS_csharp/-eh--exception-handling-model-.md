...
```  
 ...
 For information about exception handling restrictions under **/clr**, see [_set_se_translator](../VS_csharp/_set_se_translator.md).  
...
## See Also  
 ...
 [Exception Specifications (throw)](../VS_csharp/exception-specifications--throw---c---.md)   
 [Structured Exception Handling (C++)](../VS_csharp/structured-exception-handling--c-c---.md)