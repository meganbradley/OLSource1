...
-   Parameter Info of IntelliSense. For more information, see [Using IntelliSense](../VS_csharp/using-intellisense.md).  
  
-   Object Browser. For more information, see [Viewing the Structure of Code](../VS_csharp/viewing-the-structure-of-code.md).  
...
## Example  
 ...
 [!code[VbVbcnXmlDocComments#6](../VS_csharp/codesnippet/VisualBasic/-param---visual-basic-_1.vb)]  
