 ...
 *dwRop*  
 ...
 For a complete list of raster-operation codes, see                         [About Raster Operation Codes](http://msdn.microsoft.com/library/windows/desktop/dd162892) in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Parameters  
 ...
 `str`  
 A pointer to a [CString](../VS_csharp/cstringt-class.md) object to process.  
...
### Remarks  
 This member function emulates the functionality of the function                         [GetCharacterPlacement](http://msdn.microsoft.com/library/windows/desktop/dd144860\(v=vs.85\).aspx), as described in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Parameters  
 ...
 `lpabc`  
 Points to an array of [ABC](../VS_csharp/abc-structure.md) structures that receive the character widths when the function returns. This array must contain at least as many **ABC** structures as there are characters in the range specified by the `nFirstChar` and `nLastChar` parameters.  
  
 *lpABCF*  
 Points to an application-supplied buffer with an array of [ABCFLOAT](../VS_csharp/abcfloat-structure.md) structures to receive the character widths when the function returns. The widths returned by this function are in the IEEE floating-point format.  
...
### Remarks  
 This member function emulates the functionality of the function                         [GetCharABCWidthsI](http://msdn.microsoft.com/library/windows/desktop/dd144859), as described in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Remarks  
 This member function emulates the functionality of the function                         [GetCharWidthI](http://msdn.microsoft.com/library/windows/desktop/dd144864), as described in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Parameters  
 `lpRect`  
 Points to the [RECT](../VS_csharp/rect-structure.md) structure or [CRect](../VS_csharp/crect-class.md) object that is to receive the rectangle dimensions.  
...
### Parameters  
 `lpColorAdjust`  
 Points to a [COLORADJUSTMENT](../VS_csharp/coloradjustment-structure.md) data structure to receive the color adjustment values.  
...
### Remarks  
 This member function emulates the functionality of the function                         [GetDCBrushColor](http://msdn.microsoft.com/library/windows/desktop/dd144872), as described in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Remarks  
 This member function utilizes the Win32 function                         [GetDCPenColor](http://msdn.microsoft.com/library/windows/desktop/dd144875), as described in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Parameters  
 `nIndex`  
 Specifies the type of information to return. See                                 [GetDeviceCaps](http://msdn.microsoft.com/library/windows/desktop/dd144877) in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)] for a list of values.  
  
### Return Value  
 The value of the requested capability if the function is successful.  
  
### Example  
  See the example for [CPrintDialog::GetDefaults](../VS_csharp/cprintdialog-class.md#cprintdialog__getdefaults).  
...
### Remarks  
 This member function emulates the functionality of the function                         [GetFontLanguageInfo](http://msdn.microsoft.com/library/windows/desktop/dd144886), as described in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Remarks  
 ...
 ![Detail of a dithered pen stroke](../VS_csharp/media/vc318s1.gif "vc318S1")  
...
### Parameters  
 `lpszString`  
 Points to a character string to be measured. You can also pass a [CString](../VS_csharp/cstringt-class.md) object for this parameter.  
...
### Return Value  
 The dimensions of the string (in logical units) in a [CSize](../VS_csharp/csize-class.md) object.  
...
### Parameters  
 `lpszString`  
 Points to a string of characters. You can also pass a [CString](../VS_csharp/cstringt-class.md) object for this parameter.  
...
### Return Value  
 The dimensions of the string (in logical units) returned in a [CSize](../VS_csharp/csize-class.md) object.  
...
### Parameters  
 `lpPoints`  
 Points to an array of [POINT](../VS_csharp/point-structure.md) data structures or `CPoint` objects where the line endpoints and curve control points are placed.  
...
-   **PT_CLOSEFIGURE** Specifies that the figure is automatically closed after the corresponding line or curve is drawn. The figure is closed by drawing a line from the line or curve endpoint to the point corresponding to the last **PT_MOVETO**.  
 ...
 `nCount`  
 Specifies the total number of [POINT](../VS_csharp/point-structure.md) data structures that may be placed in the `lpPoints` array. This value must be the same as the number of bytes that may be placed in the `lpTypes` array.  
...
### Remarks  
 ...
 The **GetPixel** member function has two forms. The first takes two coordinate values; the second takes either a [POINT](../VS_csharp/point-structure.md) structure or a [CPoint](../VS_csharp/cpoint-class.md) object.  
...
### Parameters  
 `lpszString`  
 Points to a character string. You can also pass a [CString](../VS_csharp/cstringt-class.md) object for this parameter.  
...
### Remarks  
 This member function emulates the functionality of the function                         [GetTextExtentExPointI](http://msdn.microsoft.com/library/windows/desktop/dd144936), as described in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Remarks  
 This member function emulates the functionality of the function                         [GetTextExtentPointI](http://msdn.microsoft.com/library/windows/desktop/dd144939), as described in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
 ...
 *lpszFacename*  
 ...
 `rString`  
 A reference to a [CString](../VS_csharp/cstringt-class.md) object.  
 ...
 *nMeshElements*  
 ...
 `dwMode`  
 Specifies gradient fill mode. For a list of possible values, see                                 [GradientFill](http://msdn.microsoft.com/library/windows/desktop/dd144957) in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
  
### Return Value  
 **TRUE** if successful; otherwise **FALSE**.  
  
### Remarks  
 For more information, see `GradientFill` in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Parameters  
 ...
 `lpfnOutput`  
 Specifies the procedure-instance address of the application-supplied callback function that will draw the string. For more information, see the description of the Windows **OutputFunc** [callback function](../VS_csharp/callback-function-for-cdc--graystring.md). If this parameter is **NULL**, the system uses the Windows `TextOut` function to draw the string, and `lpData` is assumed to be a long pointer to the character string to be output.  
...
### Example  
 [!code[NVC_MFCDocView#36](../VS_csharp/codesnippet/CPP/cdc-class_8.cpp)]  
...
### Parameters  
 `lpPoints`  
 Points to an array of points. Each point in the array is a [POINT](../VS_csharp/point-structure.md) structure or a [CPoint](../VS_csharp/cpoint-class.md) object.  
  
 `nCount`  
 The number of points in the array.  
  
 `lpRect`  
 Points to a [RECT](../VS_csharp/rect-structure.md) structure or a [CRect](../VS_csharp/crect-class.md) object. This parameter is used for the common case of mapping a rectangle from logical to device units.  
  
 `lpSize`  
 Points to a                                 [SIZE](http://msdn.microsoft.com/library/windows/desktop/dd145106) structure or a [CSize](../VS_csharp/csize-class.md) object.  
...
### Remarks  
 By default, this device context is equal to `m_hDC`. In general, `CDC` GDI calls that request information from the device context are directed to `m_hAttribDC`. See the [CDC](../VS_csharp/cdc-class.md) class description for more on the use of these two device contexts.  
 ...
 *x3*  
 ...
 `ptStart`  
 Specifies the starting point of the arc. This point does not have to lie exactly on the arc. You can pass either a [POINT](../VS_csharp/point-structure.md) structure or a [CPoint](../VS_csharp/cpoint-class.md) object for this parameter.  
...
### Example  
 [!code[NVC_MFCDocView#37](../VS_csharp/codesnippet/CPP/cdc-class_9.cpp)]  
...
### Parameters  
 `lpPoints`  
 Points to an array of [POINT](../VS_csharp/point-structure.md) data structures that contain the endpoints and control points of the spline(s).  
...
### Parameters  
 `lpPoints`  
 Points to an array of [POINT](../VS_csharp/point-structure.md) data structures that contains the endpoints and control points.  
...
### Parameters  
 `lpPoints`  
 Points to an array of [POINT](../VS_csharp/point-structure.md) data structures that contains the endpoints for each line segment and the endpoints and control points for each Bzier spline.  
...
### Example  
 [!code[NVC_MFCDocView#38](../VS_csharp/codesnippet/CPP/cdc-class_10.cpp)]  
...
### Remarks  
 ...
 For more information, see                         [PolyLine](http://msdn.microsoft.com/library/windows/desktop/dd162815) in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Parameters  
 `lpPoints`  
 Points to an array of [POINT](../VS_csharp/point-structure.md) data structures that contains the vertices of the line.  
...
### Example  
 [!code[NVC_MFCDocView#39](../VS_csharp/codesnippet/CPP/cdc-class_11.cpp)]  
...
### Example  
 [!code[NVC_MFCDocView#40](../VS_csharp/codesnippet/CPP/cdc-class_12.cpp)]  
...
### Parameters  
 *pPen*  
 A pointer to a [CPen](../VS_csharp/cpen-class.md) object to be selected.  
  
 `pBrush`  
 A pointer to a [CBrush](../VS_csharp/cbrush-class.md) object to be selected.  
  
 `pFont`  
 A pointer to a [CFont](../VS_csharp/cfont-class.md) object to be selected.  
  
 `pBitmap`  
 A pointer to a [CBitmap](../VS_csharp/cbitmap-class.md) object to be selected.  
  
 `pRgn`  
 A pointer to a [CRgn](../VS_csharp/crgn-class.md) object to be selected.  
  
 `pObject`  
 A pointer to a [CGdiObject](../VS_csharp/cgdiobject-class.md) object to be selected.  
...
### Parameters  
 `pPalette`  
 Identifies the logical palette to be selected. This palette must already have been created with the `CPalette` member function [CreatePalette](../VS_csharp/cpalette-class.md#cpalette__createpalette).  
...
##  <a name="cdc__selectstockobject"></a>  CDC::SelectStockObject  
 Selects a [CGdiObject](../VS_csharp/cgdiobject-class.md) object that corresponds to one of the predefined stock pens, brushes, or fonts.  
...
### Return Value  
 A pointer to the `CGdiObject` object that was replaced if the function is successful. The actual object pointed to is a [CPen](../VS_csharp/cpen-class.md), [CBrush](../VS_csharp/cbrush-class.md), or [CFont](../VS_csharp/cfont-class.md) object. If the call is unsuccessful, the return value is **NULL**.  
...
### Parameters  
 `lpfn`  
 A pointer to the abort function to install as the abort procedure. For more about the callback function, see [Callback Function for CDC::SetAbortProc](../VS_csharp/callback-function-for-cdc--setabortproc.md).  
...
### Example  
  See the example for [CWnd::OnCtlColor](../VS_csharp/cwnd-class.md#cwnd__onctlcolor).  
...
### Parameters  
 `lpColorAdjust`  
 Points to a [COLORADJUSTMENT](../VS_csharp/coloradjustment-structure.md) data structure containing the color adjustment values.  
...
### Remarks  
 This method emulates the functionality of the function                         [SetDCBrushColor](http://msdn.microsoft.com/library/windows/desktop/dd162969), as described in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Remarks  
 This member function utilizes the Win32 function                         [SetDCPenColor](http://msdn.microsoft.com/library/windows/desktop/dd162970), as described in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Remarks  
 Normally, you would not call **SetLayout** for a window. Rather, you control the right-to-left layout in a window by setting the [extended window styles](../VS_csharp/extended-window-styles.md) such as **WS_EX_RTLREADING**. A device context, such as a printer or a metafile, does not inherit this layout. The only way to set the device context for a right-to-left layout is by calling **SetLayout**.  
...
### Example  
  See the example for [CView::OnPrepareDC](../VS_csharp/cview-class.md#cview__onpreparedc).  
 ...
 *y*  
 ...
 `crColor`  
 A **COLORREF** RGB value that specifies the color used to paint the point. See                                 [COLORREF](http://msdn.microsoft.com/library/windows/desktop/dd183449) in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)] for a description of this value.  
 ...
 *y*  
 ...
 `point`  
 Specifies the logical x- and y-coordinates of the point to be set. You can pass either a [POINT](../VS_csharp/point-structure.md) data structure or a [CPoint](../VS_csharp/cpoint-class.md) object for this parameter.  
...
### Return Value  
 ...
 It can be any of the values given in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Return Value  
 The previous extents of the viewport as a [CSize](../VS_csharp/csize-class.md) object. When an error occurs, the x- and y-coordinates of the returned `CSize` object are both set to 0.  
...
### Example  
 ...
 [!code[NVC_MFCDocView#41](../VS_csharp/codesnippet/CPP/cdc-class_13.cpp)]  
 ...
 *y*  
 ...
 `lpszString`  
 Points to the character string to draw. You can pass either a pointer to an array of characters or a [CString](../VS_csharp/cstringt-class.md) object for this parameter.  
...
### Remarks  
 ...
 For more information, see                         [TransparentBlt](http://msdn.microsoft.com/library/windows/desktop/dd145141) in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Remarks  
 ...
 For more information about using color palettes, see                         [UpdateColors](http://msdn.microsoft.com/library/windows/desktop/dd145166) in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
## See Also  
 ...
 [CPaintDC](../VS_csharp/cpaintdc-class.md)   
 [CWindowDC](../VS_csharp/cwindowdc-class.md)   
 [CClientDC](../VS_csharp/cclientdc-class.md)   
 [CMetaFileDC](../VS_csharp/cmetafiledc-class.md)