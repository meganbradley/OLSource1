...
dev_langs: 
  - "FSharp"
helpviewer_keywords: 
  - "AbstractClass attribute [F#]"
  - "AbstractClassAttribute class [F#]"
...
|Member|Description|  
|------------|-----------------|  
|[new](../VS_csharp/core.abstractclassattribute-constructor--fsharp-.md)|Creates an instance of the attribute|  
