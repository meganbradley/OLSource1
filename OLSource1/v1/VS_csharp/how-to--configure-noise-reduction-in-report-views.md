...
2.  To enable trimming, follow these steps:  
    ...
    1.  Select **Enable Trimming**. This is the default setting.  
        ...
        > [!NOTE]
        >  If noise reduction is enabled, an information bar will display in the report. For more information, see [Call Tree View](../VS_csharp/call-tree-view.md) and [Allocation View](../VS_csharp/.net-memory-allocations-view.md).  
...
## See Also  
 ...
 [How to: Exclude or Include Short Functions from Instrumentation](../VS_csharp/how-to--exclude-or-include-short-functions-from-instrumentation.md)   
