...
## Remarks  
 This class provides methods for creating and managing ATL controls. [CComControl Class](../VS_csharp/ccomcontrol-class.md) derives from `CComControlBase`. When you create a Standard Control or DHTML control using the ATL Control Wizard, the wizard will automatically derive your class from `CComControlBase`.  
  
 For more information about creating a control, see the [ATL Tutorial](../VS_csharp/active-template-library--atl--tutorial.md). For more information about the ATL Project Wizard, see the article [Creating an ATL Project](../VS_csharp/creating-an-atl-project.md).  
...
### Example  
 [!code[NVC_ATL_COM#15](../VS_csharp/codesnippet/CPP/ccomcontrolbase-class_1.cpp)]  
...
### Example  
 [!code[NVC_ATL_COM#19](../VS_csharp/codesnippet/CPP/ccomcontrolbase-class_2.cpp)]  
  
 [!code[NVC_ATL_COM#20](../VS_csharp/codesnippet/CPP/ccomcontrolbase-class_3.h)]  
...
### Example  
 [!code[NVC_ATL_COM#21](../VS_csharp/codesnippet/CPP/ccomcontrolbase-class_4.cpp)]  
...
### Example  
 [!code[NVC_ATL_COM#22](../VS_csharp/codesnippet/CPP/ccomcontrolbase-class_5.h)]  
...
### Parameters  
 `di`  
 The structure that will hold the zoom factor's numerator and denominator. For more information, see [ATL_DRAWINFO](../VS_csharp/atl_drawinfo-structure.md).  
...
### Parameters  
 `iVerb`  
 Value indicating the action to be performed by [IOleObjectImpl::DoVerb](../VS_csharp/ioleobjectimpl--doverb.md).  
...
>  To use this data member within your control class, you must declare it as a data member in your control class. Your control class will not inherit this data member from the base class because it is declared within a union in the base class.  
 ...
 If you add the **Auto Size** option on the [Stock Properties](../VS_csharp/stock-properties--atl-control-wizard.md) tab of the ATL Control Wizard, the wizard automatically creates this data member in your control class, creates put and get methods for the property, and supports [IPropertyNotifySink](http://msdn.microsoft.com/library/windows/desktop/ms692638) to automatically notify the container when the property changes.  
...
>  To use this data member within your control class, you must declare it as a data member in your control class. Your control class will not inherit this data member from the base class because it is declared within a union in the base class.  
 ...
 This flag is checked by [IOleObjectImpl::SetExtent](../VS_csharp/ioleobjectimpl--setextent.md) and, if **TRUE**, `SetExtent` notifies the container of view changes. if this flag is set, the **OLEMISC_RECOMPOSEONRESIZE** bit in the [OLEMISC](http://msdn.microsoft.com/library/windows/desktop/ms678497) enumeration should also be set.  
...
>  To use this data member within your control class, you must declare it as a data member in your control class. Your control class will not inherit this data member from the base class because it is declared within a union in the base class.  
 ...
 You can convert the size to pixels with the global function [AtlHiMetricToPixel](../VS_csharp/atlhimetrictopixel.md).  
...
### Parameters  
 `di`  
 A reference to the [ATL_DRAWINFO](../VS_csharp/atl_drawinfo-structure.md) structure that contains drawing information such as the draw aspect, the control bounds, and whether the drawing is optimized or not.  
