...
## Remarks  
 [IDebugProcess3::GetHostingProcessLanguage](../VS_csharp/idebugprocess3--gethostingprocesslanguage.md) can be used to retrieve the current language setting.  
  
## See Also  
 [IDebugProcess3](../VS_csharp/idebugprocess3.md)   
 [IDebugProcess3::GetHostingProcessLanguage](../VS_csharp/idebugprocess3--gethostingprocesslanguage.md)