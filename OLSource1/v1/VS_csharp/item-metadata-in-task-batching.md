...
[!INCLUDE[vstecmsbuild](../VS_csharp/includes/vstecmsbuild_md.md)] has the ability to divide item lists into different categories, or batches, based on item metadata, and run a task one time with each batch. It can be confusing to understand exactly what items are being passed with which batch. This topic covers the following common scenarios that involve batching.  
...
-   Filtering item lists  
 ...
 For more information on batching with [!INCLUDE[vstecmsbuild](../VS_csharp/includes/vstecmsbuild_md.md)], see [MSBuild Batching](../VS_csharp/msbuild-batching.md).  
...
```  
 ...
 The [Message](../VS_csharp/message-task.md) task displays the following information:  
