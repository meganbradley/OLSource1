...
#### Parameters  
 ...
 `ppPortProcess`  
 [out] Returns an [IDebugPendingBreakpoint2](../VS_csharp/idebugpendingbreakpoint2.md) object that represents the launched process.  
  
## Return Value  
 If successful, returns `S_OK`; otherwise, returns an error code.  
  
## Remarks  
 This method should launch the process so that it is suspended and not running any code. The [ResumeProcess](../VS_csharp/idebugportex2--resumeprocess.md) method is called to resume the process.  
  
 A program can also be launched from a debug engine. For details, see [Launching a Program](../VS_csharp/launching-a-program.md).  
  
## See Also  
 [IDebugPortEx2](../VS_csharp/idebugportex2.md)   
 [IDebugPendingBreakpoint2](../VS_csharp/idebugpendingbreakpoint2.md)   
 [ResumeProcess](../VS_csharp/idebugportex2--resumeprocess.md)   
