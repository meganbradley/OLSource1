...
To design, edit, and refactor classes and other types, add a class diagram to your Visual C# .NET, Visual Basic .NET, or C++ project. To visualize different parts of the code in a project, add multiple class diagrams to the project.  
 ...
 You can't create class diagrams from projects that share code across multiple apps. To create UML class diagrams, see [Create UML Modeling Projects and Diagrams](../VS_csharp/create-uml-modeling-projects-and-diagrams.md).  
...
## See Also  
 [How to: Create Types on Class Diagrams](../VS_csharp/how-to--create-types-by-using-class-designer.md)   
 ...
 [Viewing Existing Types and Relationships on Class Diagrams](../VS_csharp/viewing-types-and-relationships--class-designer-.md)   
