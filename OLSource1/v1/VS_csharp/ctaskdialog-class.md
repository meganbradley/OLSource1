...
## Remarks  
 The `CTaskDialog` class replaces the standard Windows message box and has additional functionality such as new controls to gather information from the user. This class is in the MFC library in [!INCLUDE[vs_dev10_long](../VS_csharp/includes/vs_dev10_long_md.md)]. The `CTaskDialog` is available starting with [!INCLUDE[wiprlhext](../VS_csharp/includes/wiprlhext_md.md)]. Earlier versions of Windows cannot display the `CTaskDialog` object. Use `CTaskDialog::IsSupported` to determine at runtime whether the current user can display the task dialog box. The standard Windows message box is still supported in [!INCLUDE[vs_dev10_long](../VS_csharp/includes/vs_dev10_long_md.md)].  
 ...
 ![Example of CTaskDialog](../VS_csharp/media/ctaskdialogsample.png "CTaskDialogSample")  
CTaskDialog Sample  
  
## Requirements  
 **Minimum required operating system:** [!INCLUDE[wiprlhext](../VS_csharp/includes/wiprlhext_md.md)]  
...
### Example  
 [!code[NVC_MFC_CTaskDialog#2](../VS_csharp/codesnippet/CPP/ctaskdialog-class_1.cpp)]  
...
### Remarks  
 The radio buttons for the [CTaskDialog Class](../VS_csharp/ctaskdialog-class.md) enable you to gather information from the user. Use the function [CTaskDialog::GetSelectedRadioButtonID](#ctaskdialog__getselectedradiobuttonid) to determine which radio button is selected.  
...
### Example  
 [!code[NVC_MFC_CTaskDialog#3](../VS_csharp/codesnippet/CPP/ctaskdialog-class_2.cpp)]  
...
##  <a name="ctaskdialog__ctaskdialog"></a>  CTaskDialog::CTaskDialog  
 Creates an instance of the [CTaskDialog Class](../VS_csharp/ctaskdialog-class.md).  
...
### Example  
 [!code[NVC_MFC_CTaskDialog#7](../VS_csharp/codesnippet/CPP/ctaskdialog-class_3.cpp)]  
...
### Remarks  
 Displays this instance of the [CTaskDialog](../VS_csharp/ctaskdialog-class.md). The application then waits for the user to close the dialog box.  
...
### Remarks  
 The common buttons are the default buttons that you provide to [CTaskDialog::CTaskDialog](#ctaskdialog__ctaskdialog). The [CTaskDialog Class](../VS_csharp/ctaskdialog-class.md) displays the buttons along the bottom of the dialog box.  
...
##  <a name="ctaskdialog__getcommonbuttonflag"></a>  CTaskDialog::GetCommonButtonFlag  
 Converts a standard Windows button to the common button type associated with the [CTaskDialog Class](../VS_csharp/ctaskdialog-class.md).  
...
##  <a name="ctaskdialog__getcommonbuttonid"></a>  CTaskDialog::GetCommonButtonId  
 Converts one of the common button types associated with the [CTaskDialog Class](../VS_csharp/ctaskdialog-class.md) to a standard Windows button.  
...
### Remarks  
 For more information about the options available to the [CTaskDialog Class](../VS_csharp/ctaskdialog-class.md), see [CTaskDialog::SetOptions](#ctaskdialog__setoptions).  
...
### Example  
 [!code[NVC_MFC_CTaskDialog#5](../VS_csharp/codesnippet/CPP/ctaskdialog-class_4.cpp)]  
...
### Remarks  
 You can use this method to determine the availability of both command button controls and the common buttons of the [CTaskDialog Class](../VS_csharp/ctaskdialog-class.md).  
...
### Example  
 [!code[NVC_MFC_CTaskDialog#1](../VS_csharp/codesnippet/CPP/ctaskdialog-class_5.cpp)]  
...
### Remarks  
 Use this method to change whether a command button control is enabled or requires elevation after it has been added to the [CTaskDialog Class](../VS_csharp/ctaskdialog-class.md).  
...
### Remarks  
 ...
 If you use this method to disable or elevate a common button that is not available for this `CTaskDialog`, this method throws an exception by using the [ENSURE (MFC)](../VS_csharp/ensure--mfc-.md) macro.  
...
### Example  
 [!code[NVC_MFC_CTaskDialog#6](../VS_csharp/codesnippet/CPP/ctaskdialog-class_6.cpp)]  
...
### Remarks  
 You cannot call this method after the display window for this instance of the [CTaskDialog Class](../VS_csharp/ctaskdialog-class.md) is created. If you do, this method throws an exception.  
 ...
 If either `nDisabledButtonMask` or `nElevationButtonMask` contain a button that is not in `nButtonMask`, this method throws an exception by using the [ENSURE (MFC)](../VS_csharp/ensure--mfc-.md) macro.  
...
### Remarks  
 The content of the [CTaskDialog Class](../VS_csharp/ctaskdialog-class.md) is the text that is displayed to the user in the main section of the dialog box.  
...
### Remarks  
 The expansion area of the [CTaskDialog Class](../VS_csharp/ctaskdialog-class.md) enables you to provide additional information to the user. The expansion area is in the main part of the `CTaskDialog`, located immediately underneath the title and content string.  
...
### Remarks  
 The footer icon is displayed on the bottom of the [CTaskDialog Class](../VS_csharp/ctaskdialog-class.md). It can have associated footer text. You can change the footer text with [CTaskDialog::SetFooterText](#ctaskdialog__setfootertext).  
  
 This method throws an exception with the [ENSURE (MFC)](../VS_csharp/ensure--mfc-.md) macro if the `CTaskDialog` is displayed or the input parameter is `NULL`.  
...
### Remarks  
 The main instruction of the [CTaskDialog Class](../VS_csharp/ctaskdialog-class.md) is text displayed to the user in a large bold font. It is located in the dialog box underneath the title bar.  
...
### Remarks  
 The marquee bar appears underneath the main text of the [CTaskDialog Class](../VS_csharp/ctaskdialog-class.md).  
  
 Use `nMarqueeSpeed` to set the speed of the marquee bar; larger values indicate a slower speed. A value of 0 for `nMarqueeSpeed` makes the marquee bar move at the default speed for [!INCLUDE[wiprlhext](../VS_csharp/includes/wiprlhext_md.md)].  
  
 This method throws an exception with the [ENSURE (MFC)](../VS_csharp/ensure--mfc-.md) macro if `nMarqueeSpeed` is less than 0.  
  
### Example  
 [!code[NVC_MFC_CTaskDialog#4](../VS_csharp/codesnippet/CPP/ctaskdialog-class_7.cpp)]  
...
### Remarks  
 This method throws an exception with the [ENSURE (MFC)](../VS_csharp/ensure--mfc-.md) macro if `nProgressPos` is not in the progress bar range. You can change the progress bar range with [CTaskDialog::SetProgressBarRange](#ctaskdialog__setprogressbarrange).  
...
### Remarks  
 ...
 This method throws an exception with the [ENSURE (MFC)](../VS_csharp/ensure--mfc-.md) macro if `nRangeMin` is not less than `nRangeMax`. This method also throws an exception if the `CTaskDialog` is already displayed and has a marquee progress bar.  
...
### Remarks  
 This method throws an exception with the [ENSURE (MFC)](../VS_csharp/ensure--mfc-.md) macro if the `CTaskDialog` is already displayed and has a marquee progress bar.  
...
### Remarks  
 This method throws an exception with the [ENSURE (MFC)](../VS_csharp/ensure--mfc-.md) macro if `nRadioButtonID` is not a valid ID for a radio button.  
...
### Remarks  
 This method throws an exception with the [ENSURE (MFC)](../VS_csharp/ensure--mfc-.md) macro if this instance of the [CTaskDialog Class](../VS_csharp/ctaskdialog-class.md) is already displayed.  
...
## See Also  
 ...
 [Walkthrough: Adding a CTaskDialog to an Application](../VS_csharp/walkthrough--adding-a-ctaskdialog-to-an-application.md)