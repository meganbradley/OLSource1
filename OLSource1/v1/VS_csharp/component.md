...
> [!NOTE]
>  To turn on the collecting of browse information with this pragma, [browse information must first be enabled](../VS_csharp/building-browse-information-files--overview.md).  
...
```  
 ...
 For more information, see the [Enable Minimal Rebuild](../VS_csharp/-gm--enable-minimal-rebuild-.md) (/Gm) compiler option.  
