...
#### Parameters  
 ...
 `initializer`  
 Type: [int](../VS_csharp/core.int-type-abbreviation--fsharp-.md) `->` [int](../VS_csharp/core.int-type-abbreviation--fsharp-.md) `->` [int](../VS_csharp/core.int-type-abbreviation--fsharp-.md) `-> 'T`  
