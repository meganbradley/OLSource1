...
## Remarks  
 ...
 You can construct a `CMFCColorDialog` object on the stack and then call `DoModal`, passing the initial color as a parameter to the `CMFCColorDialog` constructor. The color selection dialog box then creates several [CMFCColorPickerCtrl](../VS_csharp/cmfccolorpickerctrl-class.md) objects to handle each color palette.  
...
## See Also  
 ...
 [CMFCColorPickerCtrl](../VS_csharp/cmfccolorpickerctrl-class.md)