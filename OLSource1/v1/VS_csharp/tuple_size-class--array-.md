...
## Remarks  
 This template is a specialization of the template class [tuple_size](../VS_csharp/tuple_size-class--tuple-.md). It has a member `value` that is an integral constant expression whose value is `N`, which is the size of the array.  
...
## See Also  
 ...
 [tuple_size](../VS_csharp/tuple_size-class--tuple-.md)