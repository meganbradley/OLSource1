...
## Return Value  
 The first two member functions return an iterator that designates the first element remaining beyond any elements removed, or [concurrent_unordered_set::end Method](../VS_csharp/concurrent_unordered_set--end-method.md)() if no such element exists. The third member function returns the number of elements it removes.  
...
## Remarks  
 ...
 The third member function removes the elements in the range delimited by [concurrent_unordered_set::equal_range Method](../VS_csharp/concurrent_unordered_set--equal_range-method.md)(_Keyval).  
