...
##  <a name="vcconattributeprogrammmingfaqanchor2"></a> When do I have to specify the parameter name for an attribute?  
 In most cases, if the attribute has a single parameter, that parameter is named. This name is not required when inserting the attribute in your code. For example, the following usage of the [aggregatable](../VS_csharp/aggregatable.md) attribute:  
...
||||  
|-|-|-|  
|[call_as](../VS_csharp/call_as.md)|[case](../VS_csharp/case--c---.md)|[cpp_quote](../VS_csharp/cpp_quote.md)|  
|[default](../VS_csharp/default--c---.md)|[defaultvalue](../VS_csharp/defaultvalue.md)|[defaultvtable](../VS_csharp/defaultvtable.md)|  
|[emitidl](../VS_csharp/emitidl.md)|[entry](../VS_csharp/entry.md)|[first_is](../VS_csharp/first_is.md)|  
|[helpcontext](../VS_csharp/helpcontext.md)|[helpfile](../VS_csharp/helpfile.md)|[helpstring](../VS_csharp/helpstring.md)|  
|[helpstringcontext](../VS_csharp/helpstringcontext.md)|[helpstringdll](../VS_csharp/helpstringdll.md)|[id](../VS_csharp/id.md)|  
|[iid_is](../VS_csharp/iid_is.md)|[import](../VS_csharp/import.md)|[importlib](../VS_csharp/importlib.md)|  
|[include](../VS_csharp/include--c---.md)|[includelib](../VS_csharp/includelib--c---.md)|[last_is](../VS_csharp/last_is.md)|  
|[length_is](../VS_csharp/length_is.md)|[max_is](../VS_csharp/max_is.md)|[no_injected_text](../VS_csharp/no_injected_text.md)|  
|[pointer_default](../VS_csharp/pointer_default.md)|[pragma](../VS_csharp/pragma.md)|[restricted](../VS_csharp/restricted.md)|  
|[size_is](../VS_csharp/size_is.md)|[source](../VS_csharp/source--c---.md)|[switch_is](../VS_csharp/switch_is.md)|  
|[switch_type](../VS_csharp/switch_type.md)|[transmit_as](../VS_csharp/transmit_as.md)|[wire_marshal](../VS_csharp/wire_marshal.md)|  
...
##  <a name="vcconattributeprogrammmingfaqhowcaniforwarddeclareanattributedinterface"></a> How can I forward declare an attributed interface?  
 If you are going to make a forward declaration of an attributed interface, you must apply the same attributes to the forward declaration that you apply to the actual interface declaration. You must also apply the [export](../VS_csharp/export.md) attribute to your forward declaration.  
