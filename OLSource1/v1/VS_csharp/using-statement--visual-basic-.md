...
|`arglist`|Optional. List of arguments you are passing to the constructor to create an instance of `resourcetype`. See [Parameter List](../VS_csharp/parameter-list--visual-basic-.md).|  
...
## Example  
 ...
 [!code[VbVbalrStatements#50](../VS_csharp/codesnippet/VisualBasic/using-statement--visual-basic-_1.vb)]  
  
## See Also  
 <xref:System.IDisposable*>   
 [Try...Catch...Finally Statement (Visual Basic)](../VS_csharp/try...catch...finally-statement--visual-basic-.md)   
 [How to: Dispose of a System Resource](../VS_csharp/how-to--dispose-of-a-system-resource--visual-basic-.md)