...
-   Using the **/STACK** linker option. For more information, see [/STACK](../VS_csharp/-stack.md).  
  
-   Using EDITBIN on the .exe file. For more information, see [EDITBIN Reference](../VS_csharp/editbin-reference.md).  
