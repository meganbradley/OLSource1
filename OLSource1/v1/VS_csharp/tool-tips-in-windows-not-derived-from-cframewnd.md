...
This article family covers enabling tool tips for controls contained in a window that is not derived from [CFrameWnd](../VS_csharp/cframewnd-class.md). The article [Toolbars Tool Tips](../VS_csharp/toolbar-tool-tips.md) provides information about tool tips for controls in a `CFrameWnd`.  
  
 Topics covered in this article family include:  
  
-   [Enabling Tool Tips](../VS_csharp/enabling-tool-tips.md)  
  
-   [Handling TTN_NEEDTEXT Notification for Tool Tips](../VS_csharp/handling-ttn_needtext-notification-for-tool-tips.md)  
  
-   [The TOOLTIPTEXT Structure](../VS_csharp/tooltiptext-structure.md)  
...
## See Also  
 [Tool Tips](../VS_csharp/tool-tips.md)