...
### Remarks  
 The type is a synonym for template class [basic_ostream](../VS_csharp/basic_ostream-class.md), specialized for elements of type `char` with default character traits.  
...
### Remarks  
 The type is a synonym for template class [basic_ostream](../VS_csharp/basic_ostream-class.md), specialized for elements of type `wchar_t` with default character traits.  
