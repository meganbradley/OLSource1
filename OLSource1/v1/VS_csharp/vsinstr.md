...
|**NoWarn** `[:[Message Number[;Message Number]]]`|Suppress all or specific warnings.<br /><br /> `Message Number` - the warning number. If `Message Number` is omitted, all warnings are suppressed.<br /><br /> For more information, see [VSInstr Warnings](../VS_csharp/vsinstr-warnings.md).|  
...
## See Also  
 ...
 [VSInstr Warnings](../VS_csharp/vsinstr-warnings.md)   
