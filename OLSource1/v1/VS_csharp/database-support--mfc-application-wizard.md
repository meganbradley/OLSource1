...
-   If you select **ODBC** under **Client type**, then the application's view class derives from [CRecordView](../VS_csharp/crecordview-class.md). This class is associated with a [CRecordset](../VS_csharp/crecordset-class.md)-derived class, which the MFC Application Wizard also creates for you. This option gives you a form-based application in which the record view is used to view and update records through its recordset.  
  
-   If you select **OLE DB** under **Client type**, then the view class derives from [COleDBRecordView](../VS_csharp/coledbrecordview-class.md), and it is associated with a [CTable](../VS_csharp/ctable-class.md) or [CCommand](../VS_csharp/ccommand-class.md)-derived class.  
