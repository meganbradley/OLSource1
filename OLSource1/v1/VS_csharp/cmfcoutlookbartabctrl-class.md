...
|[CMFCOutlookBarTabCtrl::EnableInPlaceEdit](#cmfcoutlookbartabctrl__enableinplaceedit)|Specifies whether a user can modify the text labels on the tab buttons of the Outlook bar. (Overrides [CMFCBaseTabCtrl::EnableInPlaceEdit](../VS_csharp/cmfcbasetabctrl-class.md#cmfcbasetabctrl__enableinplaceedit).)|  
...
|`CMFCOutlookBarTabCtrl::FindTargetWnd`|Identifies the pane that contains a specified point. (Overrides [CMFCBaseTabCtrl::FindTargetWnd](../VS_csharp/cmfcbasetabctrl-class.md#cmfcbasetabctrl__findtargetwnd).)|  
...
|`CMFCOutlookBarTabCtrl::GetTabArea`|Retrieves the size and position of the tab area of the tab control. (Overrides [CMFCBaseTabCtrl::GetTabArea](../VS_csharp/cmfcbasetabctrl-class.md#cmfcbasetabctrl__gettabarea).)|  
|`CMFCOutlookBarTabCtrl::GetThisClass`|Used by the framework to obtain a pointer to the [CRuntimeClass](../VS_csharp/cruntimeclass-structure.md) object that is associated with this class type.|  
...
|`CMFCOutlookBarTabCtrl::IsPtInTabArea`|Determines if a point is inside the tab area. (Overrides [CMFCBaseTabCtrl::IsPtInTabArea](../VS_csharp/cmfcbasetabctrl-class.md#cmfcbasetabctrl__isptintabarea).)|  
|`CMFCOutlookBarTabCtrl::IsTabDetachable`|Determines whether a tab is detachable. (Overrides [CMFCBaseTabCtrl::IsTabDetachable](../VS_csharp/cmfcbasetabctrl-class.md#cmfcbasetabctrl__istabdetachable).)|  
...
|`CMFCOutlookBarTabCtrl::RecalcLayout`|Recalculates the internal layout of the tab control. (Overrides [CMFCBaseTabCtrl::RecalcLayout](../VS_csharp/cmfcbasetabctrl-class.md#cmfcbasetabctrl__recalclayout).)|  
|[CMFCOutlookBarTabCtrl::SetActiveTab](#cmfcoutlookbartabctrl__setactivetab)|Sets the active tab. (Overrides [CMFCBaseTabCtrl::SetActiveTab](../VS_csharp/cmfcbasetabctrl-class.md#cmfcbasetabctrl__setactivetab).)|  
...
|[CMFCOutlookBarTabCtrl::SetToolbarImageList](#cmfcoutlookbartabctrl__settoolbarimagelist)|Sets the bitmap that contains the icons that are displayed on the bottom of the Outlook bar in Outlook 2003 mode (see [CMFCOutlookBar](../VS_csharp/cmfcoutlookbar-class.md)).|  
|[CMFCOutlookBarTabCtrl::SetVisiblePageButtons](#cmfcoutlookbartabctrl__setvisiblepagebuttons)||  
  
## Remarks  
 To create an Outlook bar that has docking support, use a `CMFCOutlookBar` object to host the Outlook bar tab control. For more information, see [CMFCOutlookBar](../VS_csharp/cmfcoutlookbar-class.md).  
  
## Example  
 The following example demonstrates how to initialize a `CMFCOutlookBarTabCtrl` object and use various methods in the `CMFCOutlookBarTabCtrl` class. The example shows how to enable the in-place editing of the text label on the tab page buttons of the Outlook bar, enable the animation, enable scroll handles that enable the user to scroll through buttons on the Outlook bar pane, set the border size of the Outlook tab control, and set the alignment of the text labels on the tab buttons of the Outlook bar. This code snippet is part of the [Outlook Demo sample](../VS_csharp/visual-c---samples.md).  
  
 [!code[NVC_MFC_OutlookDemo#1](../VS_csharp/codesnippet/CPP/cmfcoutlookbartabctrl-class_1.cpp)]  
[!code[NVC_MFC_OutlookDemo#2](../VS_csharp/codesnippet/CPP/cmfcoutlookbartabctrl-class_2.cpp)]  
...
### Remarks  
 ...
 This function internally calls on [CMFCBaseTabCtrl::AddTab](../VS_csharp/cmfcbasetabctrl-class.md#cmfcbasetabctrl__addtab).  
...
### Example  
 The following example demonstrates how to use the `AddControl` method in the `CMFCOutlookBarTabCtrl` class. This code snippet is part of the [Outlook Demo sample](../VS_csharp/visual-c---samples.md).  
  
 [!code[NVC_MFC_OutlookDemo#3](../VS_csharp/codesnippet/CPP/cmfcoutlookbartabctrl-class_3.cpp)]  
...
### Remarks  
 Usually, outlook bar tab controls are created when [CMFCOutlookBar](../VS_csharp/cmfcoutlookbar-class.md) controls the `WM_CREATE` message of the process.  
...
### Remarks  
 This value is set by [CMFCOutlookBar::SetMode2003](../VS_csharp/cmfcoutlookbar-class.md#cmfcoutlookbar__setmode2003).  
...
### Remarks  
 ...
 This method should not be called if not in Microsoft Office 2003 mode. For more information, see [CMFCOutlookBar](../VS_csharp/cmfcoutlookbar-class.md).  
