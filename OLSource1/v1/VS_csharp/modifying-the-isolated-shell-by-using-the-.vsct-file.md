...
```  
 ...
 For a more detailed example these customizations, see [Walkthrough: A Simple Isolated Shell Custom tool](../VS_csharp/walkthrough--creating-a-basic-isolated-shell-application.md).  
...
|VsDbgCmdUsed.vsct|Command table for the debugger.|  
 ...
 For more information, see [Designing XML Command Table (.Vsct) Files](../VS_csharp/designing-xml-command-table--.vsct--files.md) and the [VSCT XML Schema Reference](../VS_csharp/vsct-xml-schema-reference.md).  
  
## See Also  
 [Visual Studio Shell (Isolated Mode)](../VS_csharp/visual-studio-isolated-shell.md)