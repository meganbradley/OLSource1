...
This dialog box lets you define [!INCLUDE[vcprvc](../VS_csharp/includes/vcprvc_md.md)] project settings related to build logging and supporting file types.  
...
## Build Timing  
 **Yes**  
 Turns on build timing. If selected, the time it takes for the build to complete is posted to the Output window. For more information, see [Output Window](../VS_csharp/output-window.md).  
 ...
 **Yes**  
 Lists environment variables in the build log file. This option specifies to echo all environment variables, during builds of [!INCLUDE[vcprvc](../VS_csharp/includes/vcprvc_md.md)] projects, into the build log file.  
