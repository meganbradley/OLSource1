...
## Remarks  
 Always use the [BEGIN_MSG_MAP](../VS_csharp/begin_msg_map.md) macro to mark the beginning of a message map. Use [ALT_MSG_MAP](../VS_csharp/alt_msg_map.md) to declare subsequent alternate message maps.  
...
## Example  
 ...
 [!code[NVC_ATL_Windowing#98](../VS_csharp/codesnippet/CPP/end_msg_map_1.h)]  
  
 The next example shows two alternate message maps. The default message map is empty.  
  
 [!code[NVC_ATL_Windowing#99](../VS_csharp/codesnippet/CPP/end_msg_map_2.h)]  
