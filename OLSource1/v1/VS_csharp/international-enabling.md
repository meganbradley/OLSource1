...
-   You still must handle certain kinds of internationalization tasks in your code:  
    ...
    -   Make literal strings and characters portable under either environment, using the **_T** macro. For more information, see [Generic-Text Mappings in Tchar.h](../VS_csharp/generic-text-mappings-in-tchar.h.md).  
  
    -   Take precautions when parsing strings under MBCS. These precautions are not needed under Unicode. For more information, see [MBCS Programming Tips](../VS_csharp/mbcs-programming-tips.md).  
    ...
    -   Do not hard-code strings in your application. Instead, make them STRINGTABLE resources by adding them to the application's .rc file. Your application can then be localized without requiring source code changes or recompilation. For more information about STRINGTABLE resources, see [String Editor](../VS_csharp/string-editor.md).  
...
## See Also  
 ...
 [Internationalization Strategies](../VS_csharp/internationalization-strategies.md)