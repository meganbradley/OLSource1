...
#### Parameters  
 `pReason`  
 [out] A value from the [EncUnavailableReason](../VS_csharp/encunavailablereason.md) enumeration.  
...
## Remarks  
 This state can be affected by [IDebugProcess3::DisableENC](../VS_csharp/idebugprocess3--disableenc.md).  
