...
## Remarks  
 If your compilation includes more than one type with a [Main](../VS_csharp/main---and-command-line-arguments--csharp-programming-guide-.md) method, you can specify which type contains the **Main** method that you want to use as the entry point into the program.  
