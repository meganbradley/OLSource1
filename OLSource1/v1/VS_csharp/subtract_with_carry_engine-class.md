...
## Remarks  
 The `substract_with_carry_engine` template class is an improvement over the [linear_congruential_engine](../VS_csharp/linear_congruential_engine-class.md). Neither for these engines is as fast or with as high quality results as the [mersenne_twister_engine](../VS_csharp/mersenne_twister_engine-class.md).  
