...
> [!NOTE]
>  This method is deprecated. Use the [IDebugProcess3::Continue](../VS_csharp/idebugprocess3--continue.md) method instead.  
...
#### Parameters  
 `pThread`  
 [in] An [IDebugThread2](../VS_csharp/idebugthread2.md) object that represents the thread.  
