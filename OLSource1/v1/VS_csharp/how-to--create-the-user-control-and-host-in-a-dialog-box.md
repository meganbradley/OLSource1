...
The steps in this article assume that you are creating a dialog-based ([CDialog Class](../VS_csharp/cdialog-class.md)) Microsoft Foundation Classes (MFC) project, but you can also add support for a Windows Forms control to an existing MFC dialog box.  
...
## See Also  
 [Hosting a Windows Forms User Control in an MFC Dialog Box](../VS_csharp/hosting-a-windows-form-user-control-in-an-mfc-dialog-box.md)