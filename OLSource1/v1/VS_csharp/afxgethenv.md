...
## Return Value  
 The handle to the ODBC environment currently in use by MFC. Can be `SQL_HENV_NULL` if there are no [CDatabase](../VS_csharp/cdatabase-class.md) objects and no [CRecordset](../VS_csharp/crecordset-class.md) objects in use.  
