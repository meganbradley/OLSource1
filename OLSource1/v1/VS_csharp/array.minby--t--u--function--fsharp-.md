...
Returns the lowest of all elements of the array, compared by using [Operators.min](../VS_csharp/operators.min--t--function--fsharp-.md) on the function result.  
...
## Example  
 ...
 [!code[FsArrays#58](../VS_csharp/codesnippet/FSharp/array.minby--t--u--function--fsharp-_1.fs)]  
