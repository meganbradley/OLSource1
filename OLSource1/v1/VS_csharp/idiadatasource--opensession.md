...
#### Parameters  
 ppSession  
 [out] Returns an [IDiaSession](../VS_csharp/idiasession.md) object representing the open session.  
...
|Value|Description|  
|-----------|-----------------|  
|E_UNEXPECTED|The [IDiaDataSource](../VS_csharp/idiadatasource.md) object has not previously been initialized with a source of symbols.|  
|E_INVALIDARG|Invalid `ppSession` parameter.|  
|E_OUTOFMEMORY|Insufficient memory to open the session.|  
  
## Remarks  
 This method opens an [IDiaSession](../VS_csharp/idiasession.md) object for a data source.  
