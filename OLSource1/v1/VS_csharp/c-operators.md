...
|**,**|Sequential-evaluation operator|  
 ...
 The base operator (**:>**), supported by previous versions of the Microsoft 16-bit C compiler, is described in [C Language Syntax Summary](../VS_csharp/c-language-syntax-summary.md).  
