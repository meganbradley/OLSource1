...
## Using LIB Options  
 ...
 For more information about /ERRORREPORT, see [/errorReport (Report Internal Compiler Errors)](../VS_csharp/-errorreport--report-internal-compiler-errors-.md).  
  
 /LTCG  
 Causes the library to be built using link-time code generation.  For more information, see [/LTCG](../VS_csharp/-ltcg--link-time-code-generation-.md).  
 ...
 /WX[:NO]  
 Treat warnings as errors. See [/WX (Treat Linker Warnings as Errors)](../VS_csharp/-wx--treat-linker-warnings-as-errors-.md) for more information.  
