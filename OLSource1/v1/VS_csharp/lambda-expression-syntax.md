...
## Example 2: Using a Function Object  
 ...
 For more information about the `operator()`, see [Function Call (C++)](../VS_csharp/function-call--c---.md). For more information about the `for_each` function, see [for_each](../Topic/for_each.md).  
...
## See Also  
 ...
 [Compiler Warning (level 1) C4297](../VS_csharp/compiler-warning--level-1--c4297.md)   
