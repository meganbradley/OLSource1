...
-   [Using the Mouse in Class Designer](../VS_csharp/keyboard-and-mouse-shortcuts-in-the-class-diagram-and-class-details-window--class-designer-.md#MouseClassDesigner)  
  
-   [Using the Mouse in the Class Details Window](../VS_csharp/keyboard-and-mouse-shortcuts-in-the-class-diagram-and-class-details-window--class-designer-.md#MouseClassDetails)  
  
-   [Using the Keyboard in Class Designer](../VS_csharp/keyboard-and-mouse-shortcuts-in-the-class-diagram-and-class-details-window--class-designer-.md#KeyboardClassDesigner)  
  
-   [Using the Keyboard in the Class Details Window](../VS_csharp/keyboard-and-mouse-shortcuts-in-the-class-diagram-and-class-details-window--class-designer-.md#KeyboardClassDetails)  
