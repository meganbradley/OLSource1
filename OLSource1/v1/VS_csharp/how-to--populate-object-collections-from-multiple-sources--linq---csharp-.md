...
-   Copy the names.csv and scores.csv files into your project folder, as described in [How to: Join Content from Dissimilar Files (LINQ) (C#)](../VS_csharp/how-to--join-content-from-dissimilar-files--linq---csharp-.md).  
...
```  
 ...
 In the [select](../VS_csharp/select-clause--csharp-reference-.md) clause, an object initializer is used to instantiate each new `Student` object by using the data from the two sources.  
