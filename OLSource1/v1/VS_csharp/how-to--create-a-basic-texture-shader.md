...
>  In this illustration, a plane is used as the preview shape, and a texture has been specified to better demonstrate the effect of the shader.  
 ...
 ![Shader graph and a preview of its effect](../VS_csharp/media/digit-texture-effect.png "Digit-Texture-Effect")  
  
 Certain shapes might provide better previews for some shaders. For more information about how to preview shaders in the Shader Designer, see [The Shader Designer](../VS_csharp/shader-designer.md)  
  
## See Also  
 [How to: Apply a Shader to a 3D Model](../VS_csharp/how-to--apply-a-shader-to-a-3-d-model.md)   
 [Working with Images and Textures](../VS_csharp/image-editor.md)   
