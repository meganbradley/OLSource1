...
|Name|Description|  
|----------|-----------------|  
|[IServiceProviderImpl::QueryService](../VS_csharp/iserviceproviderimpl--queryservice.md)|Creates or accesses the specified service and returns an interface pointer to the specified interface for the service.|  
 ...
 **IServiceProviderImpl** specifies one method: [QueryService](../VS_csharp/iserviceproviderimpl--queryservice.md), which creates or accesses the specified service and returns an interface pointer to the specified interface for the service.  
  
 `IServiceProviderImpl` uses a service map, starting with [BEGIN_SERVICE_MAP](../VS_csharp/begin_service_map.md) and ending with [END_SERVICE_MAP](../VS_csharp/end_service_map.md).  
  
 The service map contains two entries: [SERVICE_ENTRY](../VS_csharp/service_entry.md), which indicates a specified service id (SID) supported by the object, and [SERVICE_ENTRY_CHAIN](../VS_csharp/service_entry_chain.md), which calls `QueryService` to chain to another object.  
