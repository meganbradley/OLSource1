...
## Remarks  
 The `GoTo` statement can branch only to lines in the procedure in which it appears. The line must have a line label that `GoTo` can refer to. For more information, see [How to: Label Statements](../VS_csharp/how-to--label-statements--visual-basic-.md).  
  
> [!NOTE]
>  `GoTo` statements can make code difficult to read and maintain. Whenever possible, use a control structure instead. For more information, see [Control Flow in Visual Basic](../VS_csharp/control-flow-in-visual-basic.md).  
...
|`Finally` block|Never allowed|Never allowed|  
 ...
 ![Graphic diagram of branching in Try constructions](../VS_csharp/media/trybranching.gif "TryBranching")  
...
## Example  
 ...
 [!code[VbVbalrStatements#31](../VS_csharp/codesnippet/VisualBasic/goto-statement_1.vb)]  
...
## See Also  
 ...
 [While...End While Statement (Visual Basic)](../VS_csharp/while...end-while-statement--visual-basic-.md)   
