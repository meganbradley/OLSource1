...
> [!NOTE]
>  This article discusses the use of `this` with class instances. For more information about its use in extension methods, see [Extension Methods](../VS_csharp/extension-methods--csharp-programming-guide-.md).  
