...
## Creating a basic texture  
 ...
 !["Bullseye" target with transparency shown in green](../VS_csharp/media/digit-bullseye-texture-in-editor.png "Digit-Bullseye-Texture-In-Editor")  
...
11. Using the **Ellipse** tool, draw a circle from pixel coordinate `(3, 3)` to pixel coordinate `(508, 508)`. To draw the circle more easily, you can press and hold the Shift key while you draw.  
    ...
    > [!NOTE]
    >  The pixel coordinates of the current pointer location are displayed on the [!INCLUDE[vsprvs](../VS_csharp/includes/vsprvs_md.md)] status bar.  
...
17. Draw another circle from pixel coordinate `(192, 192)` to pixel coordinate `(320, 320)`.  
 ...
 ![The complete "bullseye" target texture](../VS_csharp/media/gfx_image_demo_bullseye.png "gfx_image_demo_bullseye")  
  
 As a next step, you can generate MIP levels for this texture. For information, see [How to: Generate and Modify MIP Levels](../VS_csharp/how-to--create-and-modify-mip-levels.md).  
