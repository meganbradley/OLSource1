...
-   Trapping errors. Most controls have an error event from which you can write an error handler (see [Error Trapping](../VS_csharp/error-trapping.md)).  
  
 For more information, see [Mapping Messages to Functions](../VS_csharp/mapping-messages-to-functions.md).  
