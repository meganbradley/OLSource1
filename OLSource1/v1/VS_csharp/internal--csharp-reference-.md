...
The `internal` keyword is an [access modifier](../VS_csharp/access-modifiers--csharp-reference-.md) for types and type members. Internal types or members are accessible only within files in the same assembly, as in this example:  
...
```  
 ...
 For a comparison of `internal` with the other access modifiers, see [Accessibility Levels](../VS_csharp/accessibility-levels--csharp-reference-.md) and [Access Modifiers (C# Programming Guide)](../VS_csharp/access-modifiers--csharp-programming-guide-.md).  
  
 For more information about assemblies, see [Assemblies and the Global Assembly Cache (C#)](../VS_csharp/assemblies-and-the-global-assembly-cache--csharp-and-visual-basic-.md).  
