...
```  
 ...
 For a comparison of `internal` with the other access modifiers, see [Accessibility Levels](../VS_csharp/accessibility-levels--csharp-reference-.md) and [Access Modifiers](../VS_csharp/access-modifiers--csharp-programming-guide-.md).  
