...
```  
 ...
 For more information about compiler options that help you suppress warnings, see [/FI](../VS_csharp/-fi--name-forced-include-file-.md) and [/w](../VS_csharp/-w---w0---w1---w2---w3---w4---w1---w2---w3---w4---wall---wd---we---wo---wv---wx--warning-level-.md).  
