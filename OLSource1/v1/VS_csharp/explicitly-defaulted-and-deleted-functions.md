...
> [!NOTE]
>  [!INCLUDE[vsprvs](../VS_csharp/includes/vsprvs_md.md)] does not support defaulted move constructors or move-assignment operators as the C++11 standard mandates. For more information, see the Defaulted and Deleted functions section of [C++11 Features](../VS_csharp/support-for-c--11-14-17-features--modern-c---.md).  
