...
-   [Adding Controls to a Dialog Causes the Dialog to No Longer Function](../VS_csharp/adding-controls-to-a-dialog-causes-the-dialog-to-no-longer-function.md)  
  
-   [Using the RichEdit 1.0 Control with MFC](../VS_csharp/using-the-richedit-1.0-control-with-mfc.md)  
