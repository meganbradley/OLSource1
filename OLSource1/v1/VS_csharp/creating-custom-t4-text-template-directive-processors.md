...
The *text template transformation process* takes a *text template* file as the input and produces a text file as the output. The *text template transformation engine* controls the process, and the engine interacts with a text template transformation host and one or more text template *directive processors* to complete the process. For more information, see [The Text Template Transformation Process](../VS_csharp/the-text-template-transformation-process.md).  
 ...
 Before you call a custom directive processor from a text template in [!INCLUDE[vsprvs](../VS_csharp/includes/vsprvs_md.md)], you must register it.  
  
 For more information about how to add the registry key, see [Deploying a Custom Directive Processor](../VS_csharp/deploying-a-custom-directive-processor.md).  
...
-   For more information, see [Walkthrough: Creating a Directive Processor](../VS_csharp/walkthrough--creating-a-custom-directive-processor.md).  
  
## In This Section  
 [Setting the Registry Key for the Custom Directive Processor](../VS_csharp/deploying-a-custom-directive-processor.md)  
 Explains how to register a custom directive processor.  
  
 [Walkthrough: Creating a Directive Processor](../VS_csharp/walkthrough--creating-a-custom-directive-processor.md)  
