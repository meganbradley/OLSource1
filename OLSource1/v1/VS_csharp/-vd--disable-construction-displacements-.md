...
## Arguments  
 ...
 `2`  
 Allows you to use [dynamic_cast Operator](../VS_csharp/dynamic_cast-operator.md) on an object being constructed. For example, a dynamic_cast from a virtual base class to a derived class.  
...
## Remarks  
 ...
 These options affect entire source files. Use [vtordisp](../VS_csharp/vtordisp.md) to suppress and then re-enable vtordisp fields on a class-by-class basis.  
