...
5.  To test the DSL, press F5 or CTRL+F5, and in the experimental instance of [!INCLUDE[vsprvs](../VS_csharp/includes/vsprvs_md.md)], open a sample model file. The new tool should appear on the toolbox. Drag it onto the diagram to verify that it creates a new element.  
  
     If the tool does not appear, stop the experimental [!INCLUDE[vsprvs](../VS_csharp/includes/vsprvs_md.md)]. In the Windows **Start** menu, run **Reset the Microsoft Visual Studio 2010 Experimental Instance**. On the [!INCLUDE[vsprvs](../VS_csharp/includes/vsprvs_md.md)]**Build** menu, click **Rebuild Solution**. Then test the DSL again.  
...
-   Define Element Merge Directives on other classes, enabling them to accept new instances of this class, and enabling them to create additional links when the new element is created. For example, you could allow the user to drop a Comment onto another element, and thereby create a reference link between the two.  
     ...
     For more information, see [Customizing Element Creation](../VS_csharp/customizing-element-creation-and-movement.md).  
...
##  <a name="connections"></a> Customizing Connection Tools  
 ...
 When you create a reference relationship between domain classes, a connection builder is automatically created. You can use this connection builder when you map a connection tool. For more information about how to create connection tools, see [Configuring the Toolbox](../VS_csharp/customizing-tools-and-the-toolbox.md).  
...
> [!NOTE]
>  To add custom code, create a partial class definition in a code file separate from the code files in the GeneratedCode folders. To avoid losing your work, you should not edit the generated code files. For more information, see [Overriding and Extending the Generated Classes](../VS_csharp/overriding-and-extending-the-generated-classes.md).  
 ...
 **Connection Coming in to an OutPort from a Nested Component**  
 ...
 ![Connection Builder](../VS_csharp/media/connectionbuilder_3.png "ConnectionBuilder_3")  
 ...
 **Link Connect Directive in DSL Explorer**  
 ...
 ![Connection builder image](../VS_csharp/media/connectionbuilder_4a.png "ConnectionBuilder_4a")  
  
 **Link Connect Directive in DSL Details Window**  
  
 ![](../VS_csharp/media/connectionbuilder_4b.png "ConnectionBuilder_4b")  
...
## See Also  
 [Customizing Element Creation and Movement](../VS_csharp/customizing-element-creation-and-movement.md)   
 [Customizing Copy Behavior](../VS_csharp/customizing-copy-behavior.md)   
