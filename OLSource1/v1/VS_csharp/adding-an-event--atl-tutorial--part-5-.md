...
12. Repeat the steps above to define a `ClickOut` method with the same `LONG` parameters `x` and `y`, the same **Parameter attributes** and the same `void` return type.  
 ...
 [!code[NVC_ATL_Windowing#56](../VS_csharp/codesnippet/CPP/adding-an-event--atl-tutorial--part-5-_1.idl)]  
...
1.  Change the code which comprises the `OnLButtonDown` method in PolyCtl.cpp (deleting any code placed by the wizard) so that it looks like this:  
     ...
     [!code[NVC_ATL_Windowing#57](../VS_csharp/codesnippet/CPP/adding-an-event--atl-tutorial--part-5-_2.cpp)]  
...
## Building and Testing the Control  
 ...
 [Back to Step 4](../VS_csharp/changing-the-drawing-code--atl-tutorial--part-4-.md) &#124; [On to Step 6](../VS_csharp/adding-a-property-page--atl-tutorial--part-6-.md)  
