...
-   **DTN_DROPDOWN** Notifies the parent that the embedded month calendar control is about to be displayed. This notification is only sent when the **DTS_UPDOWN** style has not been set. For more information on this notification, see [Accessing the Embedded Month Calendar Control](../VS_csharp/accessing-the-embedded-month-calendar-control.md).  
