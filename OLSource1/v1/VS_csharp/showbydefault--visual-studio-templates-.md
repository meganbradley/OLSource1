...
If `false`, specifies that the template will only be displayed under the specified [TemplateGroupID](../VS_csharp/templategroupid-element--visual-studio-templates-.md).  
...
## See Also  
 ...
 [TemplateGroupID Element (Visual Studio Templates)](../VS_csharp/templategroupid-element--visual-studio-templates-.md)