...
## Keyboard Shortcuts  
 Almost every menu command in Visual Studio has a keyboard shortcut. You can also create your own custom shortcuts. For more information, see [Identifying and Customizing Keyboard Shortcuts in Visual Studio](../VS_csharp/identifying-and-customizing-keyboard-shortcuts-in-visual-studio.md).  
...
-   To activate open documents in the reverse order, press CTRL + SHIFT + MINUS SIGN.  
 ...
 ![Visual Studio IDE Navigator](../VS_csharp/media/vs2015_ide_navigator.png "VS2015_IDE_Navigator")  
...
> [!NOTE]
>  If the settings combination you are using does not already have a shortcut key combination assigned to this command, you can assign your own custom command using the **Keyboard** page of the **Options** dialog box. For more information, see [How To: Work with Shortcut Key Combinations](../VS_csharp/identifying-and-customizing-keyboard-shortcuts-in-visual-studio.md).  
...
## See Also  
 [Customizing window layouts](../VS_csharp/customizing-window-layouts-in-visual-studio.md)   
 [Default Keyboard Shortcuts in Visual Studio](../VS_csharp/default-keyboard-shortcuts-in-visual-studio.md)