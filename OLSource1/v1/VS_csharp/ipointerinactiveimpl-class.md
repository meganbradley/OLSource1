...
|Name|Description|  
|----------|-----------------|  
|[IPointerInactiveImpl::GetActivationPolicy](../VS_csharp/ipointerinactiveimpl--getactivationpolicy.md)|Retrieves the current activation policy for the object. The ATL implementation returns **E_NOTIMPL**.|  
|[IPointerInactiveImpl::OnInactiveMouseMove](../VS_csharp/ipointerinactiveimpl--oninactivemousemove.md)|Notifies the object that the mouse pointer has moved over it, indicating the object can fire mouse events. The ATL implementation returns **E_NOTIMPL**.|  
|[IPointerInactiveImpl::OnInactiveSetCursor](../VS_csharp/ipointerinactiveimpl--oninactivesetcursor.md)|Sets the mouse pointer for the inactive object. The ATL implementation returns **E_NOTIMPL**.|  
...
### Remarks  
 See [IPointerInactive::GetActivationPolicy](http://msdn.microsoft.com/library/windows/desktop/ms692470) in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Remarks  
 See [IPointerInactive::OnInactiveMouseMove](http://msdn.microsoft.com/library/windows/desktop/ms693374) in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Remarks  
 See [IPointerInactive::OnInactiveSetCursor](http://msdn.microsoft.com/library/windows/desktop/ms694336) in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
