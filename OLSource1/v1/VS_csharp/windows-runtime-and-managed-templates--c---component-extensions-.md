...
## All Runtimes  
 You can create templates from value or reference types.  For more information about creating value or reference types, see [Classes and Structs (Managed)](../VS_csharp/classes-and-structs---c---component-extensions-.md).  
  
 For more information about standard C++ class templates, see [Class Templates](../VS_csharp/class-templates.md).  
