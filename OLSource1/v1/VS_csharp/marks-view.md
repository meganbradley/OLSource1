...
The Marks view displays sampling and ETW events that were inserted into the application.  
 ...
 Windows counters data from automatically generated marks is also presented in this view. For more information, see [How to: Collect Windows Counter Data](../VS_csharp/how-to--collect-windows-counter-data.md).  
...
## See Also  
 [Profiling Tools Report Overview](../VS_csharp/performance-report-overview.md)   
 ...
 [How to: Collect Windows Counter Data](../VS_csharp/how-to--collect-windows-counter-data.md)   
