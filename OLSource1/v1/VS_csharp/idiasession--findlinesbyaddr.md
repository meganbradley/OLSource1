...
#### Parameters  
 ...
 `ppResult`  
 [out] Returns an [IDiaEnumLineNumbers](../VS_csharp/idiaenumlinenumbers.md) object that contains a list of all the line numbers that cover the specified address range.  
