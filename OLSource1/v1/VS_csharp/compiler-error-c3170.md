...
cannot have different module identifiers in a project  
 ...
 [module](../VS_csharp/module--c---.md) attributes with different names were found in two of the files in a compilation. Only one unique `module` attribute can be specified per compilation.  
