...
|||  
|-|-|  
|[AfxExtractSubString](../VS_csharp/afxextractsubstring.md)|Extracts substrings separated by a single character from a given source string.|  
|[AfxFormatString1](../VS_csharp/afxformatstring1.md)|Substitutes a given string for the format characters "%1" in a string contained in the string table.|  
|[AfxFormatString2](../VS_csharp/afxformatstring2.md)|Substitutes two strings for the format characters "%1" and "%2" in a string contained in the string table.|  
|[AfxMessageBox](../VS_csharp/afxmessagebox.md)|Displays a message box.|  
