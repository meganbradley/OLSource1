...
## Example  
 The following code example illustrates the use of `List.append` to join two lists together. Use [List.concat](../VS_csharp/list.concat--t--function--fsharp-.md) to join more than two lists.  
  
 [!code[FsLists#26](../VS_csharp/codesnippet/FSharp/list.append--t--function--fsharp-_1.fs)]  
