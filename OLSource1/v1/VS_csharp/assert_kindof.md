...
## Remarks  
 ...
 [!code[NVC_MFCDocView#194](../VS_csharp/codesnippet/CPP/assert_kindof_1.cpp)]  
  
 Using the `ASSERT_KINDOF` macro is exactly the same as coding:  
  
 [!code[NVC_MFCDocView#195](../VS_csharp/codesnippet/CPP/assert_kindof_2.cpp)]  
  
 This function works only for classes declared with the [DECLARE_DYNAMIC](../VS_csharp/declare_dynamic.md) or [DECLARE_SERIAL](../VS_csharp/declare_serial.md) macro.  
