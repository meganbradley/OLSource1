...
### Remarks  
 The type describes a specialization of template class [basic_string](../VS_csharp/basic_string-class.md) whose objects can store copies of the message sequences.  
  
## See Also  
 [<locale\>](../VS_csharp/-locale-.md)   
 [messages_base Class](../VS_csharp/messages_base-class.md)   
