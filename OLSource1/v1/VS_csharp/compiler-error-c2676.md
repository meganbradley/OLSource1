...
## Example  
 ...
 The `this` pointer is of type handle in a reference type. For more information, see [Semantics of the this Pointer in Value and Reference Types](../VS_csharp/how-to--define-and-consume-classes-and-structs--c---cli-.md#BKMK_Semantics_of_the_this_pointer).  
