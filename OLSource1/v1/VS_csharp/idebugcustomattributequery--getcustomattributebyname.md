...
## Example  
 The following example shows how to implement this method for a **CDebugClassFieldSymbol** object that exposes the [IDebugCustomAttributeQuery](../VS_csharp/idebugcustomattributequery.md) interface.  
...
## See Also  
 [IDebugCustomAttributeQuery](../VS_csharp/idebugcustomattributequery.md)