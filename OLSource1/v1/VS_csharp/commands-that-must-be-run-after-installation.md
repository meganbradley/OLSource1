...
> [!NOTE]
>  The information in this topic applies to finding DevEnv with Visual Studio 2008 and earlier. For information about how to discover DevEnv with later versions of Visual Studio, see [Detecting System Requirements](../VS_csharp/detecting-system-requirements.md).  
  
## Finding devenv.exe  
 You can locate each version's devenv.exe from registry values that [!INCLUDE[vsprvs](../VS_csharp/includes/vsprvs_md.md)] installers write, using the RegLocator Table and AppSearch Table to store the registry values as properties. For more information, see [Detecting System Requirements](../VS_csharp/detecting-system-requirements.md).  
...
## See Also  
 [Installing VSPackages By Using Windows Installer](../VS_csharp/installing-vspackages-with-windows-installer.md)