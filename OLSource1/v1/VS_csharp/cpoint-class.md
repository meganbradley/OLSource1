...
## Remarks  
 It also includes member functions to manipulate                 `CPoint` and                 [POINT](../VS_csharp/point-structure.md) structures.  
  
 A                 `CPoint` object can be used wherever a                 `POINT` structure is used. The operators of this class that interact with a "size" accept either                 [CSize](../VS_csharp/csize-class.md) objects or                 [SIZE](http://msdn.microsoft.com/library/windows/desktop/dd145106) structures, since the two are interchangeable.  
...
> [!NOTE]
>  For more information on shared utility classes (like                     `CPoint`), see                     [Shared Classes](../VS_csharp/atl-mfc-shared-classes.md).  
...
### Parameters  
 ...
 `initPt`  
 [POINT](../VS_csharp/point-structure.md) structure or                                 `CPoint` that specifies the values used to initialize                                 `CPoint`.  
  
 `initSize`  
 [SIZE](http://msdn.microsoft.com/library/windows/desktop/dd145106) structure or                                 [CSize](../VS_csharp/csize-class.md) that specifies the values used to initialize                                 `CPoint`.  
 ...
 *yOffset*  
 ...
 `point`  
 Specifies the amount (                                [POINT](../VS_csharp/point-structure.md) or                                 `CPoint`) to offset the                                 `CPoint`.  
  
 `size`  
 Specifies the amount (                                [SIZE](http://msdn.microsoft.com/library/windows/desktop/dd145106) or                                 [CSize](../VS_csharp/csize-class.md)) to offset the                                 `CPoint`.  
  
### Example  
 [!code[NVC_ATLMFC_Utilities#28](../VS_csharp/codesnippet/CPP/cpoint-class_1.cpp)]  
...
### Parameters  
 `point`  
 Contains a                                 [POINT](../VS_csharp/point-structure.md) structure or                                 `CPoint` object.  
  
### Return Value  
 Nonzero if the points are equal; otherwise 0.  
  
### Example  
 [!code[NVC_ATLMFC_Utilities#29](../VS_csharp/codesnippet/CPP/cpoint-class_2.cpp)]  
...
### Example  
 [!code[NVC_ATLMFC_Utilities#30](../VS_csharp/codesnippet/CPP/cpoint-class_3.cpp)]  
...
### Parameters  
 `size`  
 Contains a                                 [SIZE](http://msdn.microsoft.com/library/windows/desktop/dd145106) structure or                                 [CSize](../VS_csharp/csize-class.md) object.  
...
### Example  
 [!code[NVC_ATLMFC_Utilities#31](../VS_csharp/codesnippet/CPP/cpoint-class_4.cpp)]  
...
### Example  
 [!code[NVC_ATLMFC_Utilities#32](../VS_csharp/codesnippet/CPP/cpoint-class_5.cpp)]  
...
### Parameters  
 ...
 `lpRect`  
 Contains a pointer to a                                 [RECT](../VS_csharp/rect-structure.md) structure or                                 [CRect](../VS_csharp/crect-class.md) object.  
...
### Example  
 [!code[NVC_ATLMFC_Utilities#33](../VS_csharp/codesnippet/CPP/cpoint-class_6.cpp)]  
...
### Parameters  
 `point`  
 A                                 [POINT](../VS_csharp/point-structure.md) structure or                                 [CPoint](../VS_csharp/cpoint-class.md) object.  
  
 `size`  
 A                                 [SIZE](http://msdn.microsoft.com/library/windows/desktop/dd145106) structure or                                 [CSize](../VS_csharp/csize-class.md) object.  
  
 `lpRect`  
 A pointer to a                                 [RECT](../VS_csharp/rect-structure.md) structure or a                                 [CRect](../VS_csharp/crect-class.md) object.  
...
### Example  
 [!code[NVC_ATLMFC_Utilities#34](../VS_csharp/codesnippet/CPP/cpoint-class_7.cpp)]  
  
## See Also  
 [MFC Sample MDI](../VS_csharp/visual-c---samples.md)   
 [Hierarchy Chart](../VS_csharp/hierarchy-chart.md)   
 [POINT Structure](../VS_csharp/point-structure.md)   
