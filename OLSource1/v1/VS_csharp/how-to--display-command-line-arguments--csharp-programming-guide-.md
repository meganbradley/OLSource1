...
> [!NOTE]
>  When you are running an application in Visual Studio, you can specify command-line arguments in the [Debug Page, Project Designer](../VS_csharp/debug-page--project-designer.md).  
...
## Example  
 ...
 [!code[csProgGuideMain#9](../VS_csharp/codesnippet/CSharp/how-to--display-command-line-arguments--csharp-programming-guide-_1.cs)]  
