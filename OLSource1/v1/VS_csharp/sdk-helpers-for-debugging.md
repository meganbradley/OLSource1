...
## Requirements  
 These files are located in the [!INCLUDE[vs_dev10_ext](../VS_csharp/includes/vs_dev10_ext_md.md)] SDK installation directory (by default, *[drive]*\Program Files\Microsoft Visual Studio 2010 SDK\\).  
...
## See Also  
 [API Reference (Visual Studio Debugging SDK)](../VS_csharp/api-reference--visual-studio-debugging-.md)