...
'function' candidate function(s) not accessible  
 ...
 C3767 may also be caused by a breaking change: native types are now private by default in a **/clr** compilation; see [Type Visibility](../VS_csharp/how-to--define-and-consume-classes-and-structs--c---cli-.md#BKMK_Type_visibility) for more information.  
