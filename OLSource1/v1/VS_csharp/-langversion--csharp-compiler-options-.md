...
|3|The compiler accepts only syntax that is included in the version 3.0 [C# Language Specification](../VS_csharp/csharp-language-specification.md).|  
