...
## Remarks  
 `CComClassFactoryAutoThread` is similar to [CComClassFactory](../VS_csharp/ccomclassfactory-class.md), but allows objects to be created in multiple apartments. To take advantage of this support, derive your EXE module from [CComAutoThreadModule](../VS_csharp/ccomautothreadmodule-class.md).  
  
 ATL objects normally acquire a class factory by deriving from [CComCoClass](../VS_csharp/ccomcoclass-class.md). This class includes the macro [DECLARE_CLASSFACTORY](../VS_csharp/declare_classfactory.md), which declares [CComClassFactory](../VS_csharp/ccomclassfactory-class.md) as the default class factory. To use `CComClassFactoryAutoThread`, specify the [DECLARE_CLASSFACTORY_AUTO_THREAD](../VS_csharp/declare_classfactory_auto_thread.md) macro in your object's class definition. For example:  
  
 [!code[NVC_ATL_COM#9](../VS_csharp/codesnippet/CPP/ccomclassfactoryautothread-class_1.h)]  
...
### Remarks  
 If your module derives from [CComAutoThreadModule](../VS_csharp/ccomautothreadmodule-class.md), `CreateInstance` first selects a thread to create the object in the associated apartment.  
...
### Remarks  
 When using `CComClassFactoryAutoThread`,                         **_Module** typically refers to the global instance of [CComAutoThreadModule](../VS_csharp/ccomautothreadmodule-class.md).  
...
## See Also  
 ...
 [CComClassFactorySingleton Class](../VS_csharp/ccomclassfactorysingleton-class.md)   
