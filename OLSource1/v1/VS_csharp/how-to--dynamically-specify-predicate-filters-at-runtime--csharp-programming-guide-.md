...
2.  Copy the `StudentClass` class from [How to: Query a Collection of Objects](../VS_csharp/how-to--query-a-collection-of-objects--csharp-programming-guide-.md) and paste it into namespace `PredicateFilters` underneath class `Program`. `StudentClass` provides a list of `Student` objects.  
