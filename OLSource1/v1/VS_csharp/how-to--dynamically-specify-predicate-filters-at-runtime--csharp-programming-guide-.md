...
2.  Copy the `StudentClass` class from [How to: Query a Collections of Objects](../VS_csharp/how-to--query-a-collection-of-objects--csharp-programming-guide-.md) and paste it into namespace `PredicateFilters` underneath class `Program`. `StudentClass` provides a list of `Student` objects.  
  
3.  Comment out the `Main` method in `StudentClass`.  
  
4.  Replace class `Program` with the following code.  
  
     [!code[csProgGuideLINQ#26](../VS_csharp/codesnippet/CSharp/how-to--dynamically-specify-predicate-filters-at-runtime--csharp-programming-guide-_1.cs)]  
...
2.  Copy the following method and paste it into class `DynamicPredicates`.  
     ...
     [!code[csProgGuideLINQ#27](../VS_csharp/codesnippet/CSharp/how-to--dynamically-specify-predicate-filters-at-runtime--csharp-programming-guide-_2.cs)]  
