...
---
# _mktemp, _wmktemp
Creates a unique file name. More secure versions of these functions are available; see [_mktemp_s, _wmktemp_s](../VS_csharp/_mktemp_s--_wmktemp_s.md).  
