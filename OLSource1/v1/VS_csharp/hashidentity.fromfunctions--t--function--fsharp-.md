...
#### Parameters  
 `hasher`  
 Type: `'T ->`[int](../VS_csharp/core.int-type-abbreviation--fsharp-.md)  
  
 A function to generate a hash code from a value.  
  
 `equality`  
 Type: `'T -> 'T ->`[bool](../VS_csharp/core.bool-type-abbreviation--fsharp-.md)  
  
 A function to test equality of two values.  
  
## Return Value  
 An object that implements <xref:System.Collections.IEqualityComparer*> using the supplied functions.  
