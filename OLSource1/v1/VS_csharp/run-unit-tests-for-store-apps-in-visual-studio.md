...
>   
>  For more information, see [Verifying Code by Using Unit Tests](../VS_csharp/unit-test-your-code.md) in the MSDN Library.  
...
|||  
|-|-|  
|![Test Explorer group button](../VS_csharp/media/ute_groupby_btn.png "UTE_GroupBy_btn")|To group your tests by the time it takes to execute them, open the **Group By** list and choose **Duration**. Choose **Test Outcome** to switch to the original grouping.|  
