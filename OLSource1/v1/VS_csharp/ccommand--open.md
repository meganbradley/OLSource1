...
#### Parameters  
 ...
 `wszCommand`  
 [in] The command to execute, passed as a Unicode string. Can be **NULL** when using `CAccessor`, in which case the command will be retrieved from the value passed to the [DEFINE_COMMAND](../VS_csharp/define_command.md) macro. See [ICommand::Execute](https://msdn.microsoft.com/en-us/library/ms718095.aspx) in the *OLE DB Programmer's Reference* for details.  
...
## Remarks  
 ...
 Use the fourth form of **Open** when you have already created a command and you want to perform a single [Prepare](../VS_csharp/ccommand--prepare.md) and multiple executions.  
