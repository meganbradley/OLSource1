...
-   **DTS_TIMEFORMAT** Displays the time in long format, producing output like "5:31:42 PM".  
 ...
 [!code[NVC_MFCControlLadenDialog#7](../VS_csharp/codesnippet/CPP/using-custom-format-strings-in-a-date-and-time-picker-control_1.cpp)]  
  
 In addition to custom format strings, date and time picker controls also support [callback fields](../VS_csharp/using-callback-fields-in-a-date-and-time-picker-control.md).  
