...
1.  In all cases, first construct a `CDaoTableDef` object, supplying a pointer to a [CDaoDatabase](../VS_csharp/cdaodatabase-class.md) object to which the table belongs.  
...
2.  Then do the following, depending on what you want:  
 ...
 To use a tabledef object to create a `CDaoRecordset` object, you typically create or open a tabledef as described above, then construct a recordset object, passing a pointer to your tabledef object when you call [CDaoRecordset::Open](../VS_csharp/cdaorecordset-class.md#cdaorecordset__open). The tabledef you pass must be in an open state. For more information, see class [CDaoRecordset](../VS_csharp/cdaorecordset-class.md).  
  
 When you finish using a tabledef object, call its [Close](../VS_csharp/cdaorecordset-class.md#cdaorecordset__close) member function; then destroy the tabledef object.  
...
### Parameters  
 `pDatabase`  
 A pointer to a [CDaoDatabase](../VS_csharp/cdaodatabase-class.md) object.  
...
### Remarks  
 Once you have named the tabledef, you can then call [Append](#cdaotabledef__append) to save the tabledef in the database's TableDefs collection. After calling **Append**, the tabledef is in an open state, and you can use it to create a [CDaoRecordset](../VS_csharp/cdaorecordset-class.md) object.  
...
|**dbLongBinary**|0|Long Binary (OLE Object), [CLongBinary](../VS_csharp/clongbinary-class.md) or [CByteArray](../VS_csharp/cbytearray-class.md)|  
...
##  <a name="cdaotabledef__m_pdatabase"></a>  CDaoTableDef::m_pDatabase  
 Contains a pointer to the [CDaoDatabase](../VS_csharp/cdaodatabase-class.md) object for this table.  
...
### Remarks  
 ...
 To force the modified connect information to take effect, all open [CDaoRecordset](../VS_csharp/cdaorecordset-class.md) objects based on this tabledef must be closed.  
...
### Remarks  
 ...
 [!code[NVC_MFCDatabase#34](../VS_csharp/codesnippet/CPP/cdaotabledef-class_1.cpp)]  
