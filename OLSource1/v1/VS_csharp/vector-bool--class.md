...
---
# vector&lt;bool&gt; Class
The `vector<bool>` class is a partial specialization of [vector](../VS_csharp/vector-class.md) for elements of type `bool`. It has an allocator for the underlying type that's used by the specialization, which provides space optimization by storing one `bool` value per bit.  
...
## Remarks  
 This class template specialization behaves like [vector](../VS_csharp/vector-class.md), except for the differences explained in this article.  
...
|`at`|Functions the same as the unspecialized [vector::at](../VS_csharp/vector-class.md#vector__at) function, except that it uses the proxy class [vector<bool\>::reference](#vector_lt_bool_gt___reference_class). Also see [operator&#91;&#93;](#vector_lt_bool_gt___operator_at).|  
|`front`|Functions the same as the unspecialized [vector::front](../VS_csharp/vector-class.md#vector__front) function, except that it uses the proxy class [vector<bool\>::reference](#vector_lt_bool_gt___reference_class). Also see [operator&#91;&#93;](#vector_lt_bool_gt___operator_at).|  
|`back`|Functions the same as the unspecialized [vector::back](../VS_csharp/vector-class.md#vector__back) function, except that it uses the proxy class [vector<bool\>::reference](#vector_lt_bool_gt___reference_class). Also see [operator&#91;&#93;](#vector_lt_bool_gt___operator_at).|  
...
### Remarks  
 If you compile with `_ITERATOR_DEBUG_LEVEL` set, a run-time error occurs if you attempt to access an element outside the bounds of the vector.  For more information, see [Checked Iterators](../VS_csharp/checked-iterators.md).  
...
##  <a name="vector_lt_bool_gt___reference_class"></a>  vector<bool\>::reference Class  
 The `vector<bool>::reference` class is a proxy class provided by the [vector<bool\> Class](../VS_csharp/vector-bool--class.md) to simulate `bool&`.  
...
### Remarks  
 This overload supports the special proxy requirements of `vector<bool>`. [vector::swap](../VS_csharp/vector-class.md#vector__swap) has the same functionality as the single-argument overload of `vector<bool>::swap()`.  
