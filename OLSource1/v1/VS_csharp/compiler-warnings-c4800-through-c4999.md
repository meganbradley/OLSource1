...
|Warning|Message|  
|-------------|-------------|  
|[Compiler Warning (level 3) C4800](../VS_csharp/compiler-warning--level-3--c4800.md)|'type': forcing value to bool 'true' or 'false' (performance warning)|  
|[Compiler Warning (level 1) C4801](../VS_csharp/compiler-warning-c4801.md)|Return by reference is not verifiable: %s|  
|[Compiler Warning (level 1) C4803](../VS_csharp/compiler-warning--level-1--c4803.md)|'method': the raise method has a different storage class from that of the event, 'event'|  
|[Compiler Warning (level 1) C4804](../VS_csharp/compiler-warning--level-1--c4804.md)|'operation': unsafe use of type 'bool' in operation|  
|[Compiler warning (level 1) C4805](../VS_csharp/compiler-warning--level-1--c4805.md)|'operation': unsafe mix of type 'type' and type 'type' in operation|  
...
|[Compiler Warning (level 4) C4815](../VS_csharp/compiler-warning--level-4--c4815.md)|'var': zero-sized array in stack object will have no elements (unless the object is an aggregate that has been aggregate initialized)|  
...
|[Compiler Warning (level 1) C4819](../VS_csharp/compiler-warning--level-1--c4819.md)|The file contains a character that cannot be represented in the current code page (number). Save the file in Unicode format to prevent data loss|  
|[Compiler Warning (level 4) C4820](../VS_csharp/compiler-warning--level-4--c4820.md)|'bytes' bytes padding added after construct 'member_name'|  
|[Compiler Warning (level 1) C4821](../VS_csharp/compiler-warning--level-1--c4821.md)|Unable to determine Unicode encoding type, please save the file with signature (BOM)|  
|Compiler warning (level 1) C4822|'member function': local class member function does not have a body|  
|[Compiler Warning (level 3) C4823](../VS_csharp/compiler-warning--level-3--c4823.md)|'function': uses pinning pointers but unwind semantics are not enabled. Consider using /EHa|  
|Compiler warning (level 4) C4825||  
|[Compiler Warning (level 2) C4826](../VS_csharp/compiler-warning--level-2--c4826.md)|Conversion from 'type1' to 'type_2' is sign-extended. This may cause unexpected runtime behavior.|  
|Compiler warning (level 3) C4827|A public 'ToString' method with 0 parameters should be marked as virtual and override|  
|[Compiler Warning (level 1) C4829](../VS_csharp/compiler-warning--level-1--c4829.md)|Possibly incorrect parameters to function main. Consider 'int main(Platform::Array\<Platform::String^>^ argv)'|  
|[Compiler Warning (level 1) C4835](../VS_csharp/compiler-warning--level-1--c4835.md)|'variable': the initializer for exported data will not be run until managed code is first executed in the host assembly|  
|Compiler warning (level 4) C4837|trigraph detected: 'trigraph' replaced by 'character'|  
|[Compiler warning (level 1) C4838](../VS_csharp/compiler-warning--level-1--c4838.md)|conversion from 'type_1' to 'type_2' requires a narrowing conversion|  
|[Compiler Warning (level 1) C4867](../VS_csharp/compiler-warning-c4867.md)|'function': function call missing argument list; use 'call' to create a pointer to member|  
|[Compiler warning C4868](../VS_csharp/compiler-warning-c4868.md)|'file(line_number)' compiler may not enforce left-to-right evaluation order in braced initialization list|  
...
|[Compiler Warning (level 1) C4905](../VS_csharp/compiler-warning--level-1--c4905.md)|wide string literal cast to 'LPSTR'|  
|[Compiler Warning (level 1) C4906](../VS_csharp/compiler-warning--level-1--c4906.md)|string literal cast to 'LPWSTR'|  
...
|[Compiler Warning (level 1) C4917](../VS_csharp/compiler-warning--level-1--c4917.md)|'declarator': a GUID can only be associated with a class, interface or namespace|  
...
|[Compiler Warning (level 1) C4927](../VS_csharp/compiler-warning--level-1--c4927.md)|illegal conversion; more than one user-defined conversion has been implicitly applied|  
|[Compiler Warning (level 1) C4928](../VS_csharp/compiler-warning--level-1--c4928.md)|illegal copy-initialization; more than one user-defined conversion has been implicitly applied|  
|[Compiler Warning (level 1) C4929](../VS_csharp/compiler-warning--level-1--c4929.md)|'file': typelibrary contains a union; ignoring the 'embedded_idl' qualifier|  
|[Compiler Warning (level 1) C4930](../VS_csharp/compiler-warning--level-1--c4930.md)|'prototype': prototyped function not called (was a variable definition intended?)|  
|[Compiler Warning (level 4) C4931](../VS_csharp/compiler-warning--level-4--c4931.md)|we are assuming the type library was built for number-bit pointers|  
...
|[Compiler Warning (level 1) C4945](../VS_csharp/compiler-warning--level-1--c4945.md)|'symbol': cannot import symbol from 'assembly1': as 'symbol' has already been imported from another assembly 'assembly2'|  
|[Compiler Warning (level 1) C4946](../VS_csharp/compiler-warning--level-1--c4946.md)|reinterpret_cast used between related classes: 'class1' and 'class2'|  
|Compiler warning (level 1) C4947|'type_or_member': marked as obsolete|  
|[Compiler Warning (level 2) C4948](../VS_csharp/compiler-warning--level-2--c4948.md)|return type of 'accessor' does not match the last parameter type of the corresponding setter|  
|[Compiler Warning (level 1 and level 4) C4949](../VS_csharp/compiler-warning--level-1-and-level-4--c4949.md)|pragmas 'managed' and 'unmanaged' are meaningful only when compiled with '/clr[:option]'|  
...
|[Compiler Warning (level 1) C4964](../VS_csharp/compiler-warning--level-1--c4964.md)|No optimization options were specified; profile info will not be collected|  
|[Compiler Warning (level 1) C4965](../VS_csharp/compiler-warning--level-1--c4965.md)|implicit box of integer 0; use nullptr or explicit cast|  
...
|[Compiler Warning C4986](../VS_csharp/compiler-warning-c4986.md)|'%$pS': exception specification does not match previous declaration|  
...
|[Compiler Warning (level 3) C4995](../VS_csharp/compiler-warning--level-3--c4995.md)|'function': name was marked as #pragma deprecated|  
|[Compiler Warning (level 3) C4996](../VS_csharp/compiler-warning--level-3--c4996.md)|'%$pS': %$*|  
