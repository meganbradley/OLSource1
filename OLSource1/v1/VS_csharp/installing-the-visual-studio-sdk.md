...
3.  You should see a tree view of custom features. Open **Common Tools**. You should see **Visual Studio Extensibility Tools** .  
     ...
     ![VSSDKInstall](../VS_csharp/media/vssdkinstall.png "VSSDKInstall")  
...
## Installing the Visual Studio SDK from a Solution  
 ...
 ![SolutionExplorerInstall](../VS_csharp/media/solutionexplorerinstall.png "SolutionExplorerInstall")  
  
## Installing the Visual Studio SDK from the Command Line  
 You can install the VSSDK from the command line by using the **/InstallSelectableItems** switch with the Visual Studio installer. For details about using command-line parameters with the installer, see [Installing Visual Studio](../VS_csharp/installing-visual-studio-2015.md).  
