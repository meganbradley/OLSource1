...
#### Parameters  
 *nClassStyle*  
 Specifies the Windows class style or combination of styles, created by using the bitwise-OR (**&#124;**) operator, for the window class. For a list of class styles, see the [WNDCLASS](http://msdn.microsoft.com/library/windows/desktop/ms633576) structure in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)]. If **NULL**, the defaults will be set as follows:  
...
## See Also  
 ...
 [CWnd::PreCreateWindow](../Topic/CWnd::PreCreateWindow.md)   
