...
## Remarks  
 Its behavior is determined by the named locale `_Locname`. Each constructor initializes its base object with [moneypunct](../VS_csharp/moneypunct-class.md#moneypunct__moneypunct)<CharType, Intl>( `_Refs`).  
