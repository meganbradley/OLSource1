...
>  When you use MFC **CDocument** objects, the framework does much of the serialization work for you. In particular, the framework creates and uses the `CFile` object. You only have to write code in your override of the `Serialize` member function of class **CDocument**.  
 ...
 For more information about alternatives to MFC file handling, see [File Handling](../VS_csharp/file-handling.md) in the *Run-Time Library Reference*.  
  
 For information about derived `CFile` classes, see the [MFC hierarchy chart](../VS_csharp/hierarchy-chart.md).  
  
## What do you want to do?  
 *Use CFile*  
  
-   [Open a file with CFile](../VS_csharp/opening-files.md)  
  
-   [Read and write a file with CFile](../VS_csharp/reading-and-writing-files.md)  
  
-   [Close a file with CFile](../VS_csharp/closing-files.md)  
  
-   [Access file status with CFile](../VS_csharp/accessing-file-status.md)  
  
 *Use MFC Serialization (Object Persistence)*  
  
-   [Create a serializable class](../VS_csharp/serialization--making-a-serializable-class.md)  
  
-   [Serialize an object via a CArchive object](../VS_csharp/serialization--serializing-an-object.md)  
  
-   [Create a CArchive object](../VS_csharp/two-ways-to-create-a-carchive-object.md)  
  
-   [Use CArchive << and >> operators](../VS_csharp/using-the-carchive----and----operators.md)  
  
-   [Store and load CObjects and CObject-derived objects via an archive](../VS_csharp/storing-and-loading-cobjects-via-an-archive.md)  
