...
## Remarks  
 ...
 These functions lock the calling thread and are therefore thread-safe. For non-locking versions, see [_getch_nolock, _getwch_nolock](../VS_csharp/_getch_nolock--_getwch_nolock.md).  
...
## See Also  
 ...
 [_getche, _getwche](../VS_csharp/_getche--_getwche.md)   
 [_cgets, _cgetws](../VS_csharp/_cgets--_cgetws.md)   
