 ...
 **i64**  
 ...
 Integer constants are positive unless they are preceded by a minus sign (**–**). The minus sign is interpreted as the unary arithmetic negation operator. (See [Unary Arithmetic Operators](../VS_csharp/unary-arithmetic-operators.md) for information about this operator.)  
