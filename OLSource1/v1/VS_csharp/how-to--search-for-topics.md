...
## See Also  
 [Full-Text Search Tips](../VS_csharp/full-text-search-tips.md)   
 [Logical Operators in Search Expressions](../VS_csharp/logical-operators-in-search-expressions.md)   
 [Advanced Search Operators in Search Expressions](../VS_csharp/advanced-search-operators-in-search-expressions.md)   
 [How to: Customize Search Results](../VS_csharp/how-to--customize-search-results.md)