...
## Language Features  
 ...
 [Optimization Pragmas and Keywords](../VS_csharp/optimization-pragmas-and-keywords.md)  
 A list of keywords and pragmas that you can use in your code to improve performance.  
  
 [Compiler Options Listed by Category](../VS_csharp/compiler-options-listed-by-category.md)  
 A list of **/O** compiler options that specifically affect execution speed or code size.  
  
 [Rvalue Reference Declarator: &&](../VS_csharp/rvalue-reference-declarator----.md)  
...
### The optimize Pragma  
 If an optimized section of code causes errors or a slowdown, you can use the [optimize](../VS_csharp/optimize.md) pragma to turn off optimization for that section.  
...
## Programming Practices  
 ...
 [Tips for Improving Time-Critical Code](../VS_csharp/tips-for-improving-time-critical-code.md)  
 ...
 [Optimization Best Practices](../VS_csharp/optimization-best-practices.md)  
...
-   [How to: Debug Optimized Code](../VS_csharp/how-to--debug-optimized-code.md)  
  
-   [Why Floating-Point Numbers May Lose Precision](../VS_csharp/why-floating-point-numbers-may-lose-precision.md)  
  
 The following assortment of topics provide information about how to optimize building, loading, and executing your code.  
  
-   [Improving Compiler Throughput](../VS_csharp/improving-compiler-throughput.md)  
  
-   [Using Function Name Without () Produces No Code](../VS_csharp/using-function-name-without----produces-no-code.md)  
...
-   [What optimization techniques should I use to improve the client application's performance when loading?](../VS_csharp/what-optimization-techniques-should-i-use-to-improve-the-client-application-s-performance-when-loading-.md)  
  
-   [!INCLUDE[crabout](../VS_csharp/includes/crabout_md.md)] how to reduce the time to load DLL methods, see "Optimizing DLL Load Time Performance" in the "Under the Hood" column in the "MSDN Magazine" on the [MSDN Library](http://go.microsoft.com/fwlink/?linkid=556) Web site.  
  
-   [!INCLUDE[crabout](../VS_csharp/includes/crabout_md.md)] how to minimize paging in applications, see "Improving Runtime Performance with the Smooth Working Set Tool" and "Improving Runtime Performance with the Smooth Working Set Tool—Part 2" in the "Bugslayer" column in the "MSDN Magazine" on the [MSDN Library](http://go.microsoft.com/fwlink/?linkid=556) Web site.  
