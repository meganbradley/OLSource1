...
## Remarks  
 ...
 For related information, and for an example of calling `AfxDaoInit`, see [Technical Note 54](../VS_csharp/tn054--calling-dao-directly-while-using-mfc-dao-classes.md).  
...
## See Also  
 ...
 [AfxDaoTerm](../VS_csharp/afxdaoterm.md)