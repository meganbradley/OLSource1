...
'type': you cannot cast to a type that contains 'auto'  
 ...
 You cannot cast a variable to the indicated type because the type contains the `auto` keyword and the default [/Zc:auto](../VS_csharp/-zc-auto--deduce-variable-type-.md) compiler option is in effect.  
