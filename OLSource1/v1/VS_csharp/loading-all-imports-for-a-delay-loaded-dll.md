...
The **__HrLoadAllImportsForDll** function, which is defined in delayhlp.cpp, tells the linker to load all imports from a DLL that was specified with the [/delayload](../VS_csharp/-delayload--delay-load-import-.md) linker option.  
 ...
 Calling **__HrLoadAllImportsForDll** does not change the behavior of hooks and error handling; see [Error Handling and Notification](../VS_csharp/error-handling-and-notification.md) for more information.  
