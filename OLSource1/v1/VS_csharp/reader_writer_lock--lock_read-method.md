...
## Remarks  
 It is often safer to utilize the [scoped_lock_read](../VS_csharp/reader_writer_lock--scoped_lock_read-class.md) construct to acquire and release a `reader_writer_lock` object as a reader in an exception safe way.  
