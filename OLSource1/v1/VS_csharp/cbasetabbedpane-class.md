...
---
# CBaseTabbedPane Class
Extends the functionality of the [CDockablePane Class](../VS_csharp/cdockablepane-class.md) to support the creation of tabbed windows.  
...
|[CBaseTabbedPane::CanFloat](#cbasetabbedpane__canfloat)|Determines whether the pane can float. (Overrides [CBasePane::CanFloat](../VS_csharp/cbasepane-class.md#cbasepane__canfloat).)|  
...
|[CBaseTabbedPane::ConvertToTabbedDocument](#cbasetabbedpane__converttotabbeddocument)|(Overrides [CDockablePane::ConvertToTabbedDocument](../VS_csharp/cdockablepane-class.md#cdockablepane__converttotabbeddocument).)|  
...
|[CBaseTabbedPane::GetMinSize](#cbasetabbedpane__getminsize)|Retrieves the minimum allowed size for the pane. (Overrides [CPane::GetMinSize](../VS_csharp/cpane-class.md#cpane__getminsize).)|  
|[CBaseTabbedPane::GetPaneIcon](#cbasetabbedpane__getpaneicon)|Returns a handle to the pane icon. (Overrides [CBasePane::GetPaneIcon](../VS_csharp/cbasepane-class.md#cbasepane__getpaneicon).)|  
...
|[CBaseTabbedPane::RecalcLayout](#cbasetabbedpane__recalclayout)|Recalculates layout information for the pane. (Overrides [CPane::RecalcLayout](../VS_csharp/cpane-class.md#cpane__recalclayout).)|  
...
|[CBaseTabbedPane::SetAutoHideMode](#cbasetabbedpane__setautohidemode)|Toggles the docking pane between displayed and auto-hide mode. (Overrides [CDockablePane::SetAutoHideMode](../VS_csharp/cdockablepane-class.md#cdockablepane__setautohidemode).)|  
...
## Remarks  
 ...
 Currently, the library includes two derived tabbed pane classes: [CTabbedPane Class](../VS_csharp/ctabbedpane-class.md) and [CMFCOutlookBar](../VS_csharp/cmfcoutlookbar-class.md).  
  
 A `CBaseTabbedPane` object wraps a pointer to a [CMFCBaseTabCtrl](../VS_csharp/cmfcbasetabctrl-class.md) object. [CMFCBaseTabCtrl](../VS_csharp/cmfcbasetabctrl-class.md) then becomes a child window of the tabbed pane.  
  
 For more information about how to create tabbed panes, see [CDockablePane Class](../VS_csharp/cdockablepane-class.md), [CTabbedPane Class](../VS_csharp/ctabbedpane-class.md), and [CMFCOutlookBar](../VS_csharp/cmfcoutlookbar-class.md).  
...
### Remarks  
 The framework floats the detached pane if possible. For more information, see [CBasePane::CanFloat](../VS_csharp/cbasepane-class.md#cbasepane__canfloat).  
...
### Parameters  
 ...
 [in] `bGetWrappedBar`  
 `TRUE` to return the underlying (wrapped) window of the pane instead of the pane itself; otherwise `FALSE`. This only applies to panes derived from [CDockablePaneAdapter](../VS_csharp/cdockablepaneadapter-class.md).  
...
### Remarks  
 If consistent handling of minimum pane sizes is active ( [CPane::m_bHandleMinSize](../VS_csharp/cpane-class.md#cpane__m_bhandleminsize)), `size` is filled with the minimum allowed size for the active tab. Otherwise, `size` is filled with the return value of [CPane::GetMinSize](../VS_csharp/cpane-class.md#cpane__getminsize).  
...
### Parameters  
 ...
 [in] `dwAlignment`  
 Specifies the alignment of the auto-hide pane that is to be created. For a list of possible values, see [CPane::MoveByAlignment](../VS_csharp/cpane-class.md#cpane__movebyalignment).  
...
### Remarks  
 ...
 Auto-hide mode is set for each detachable pane in the tabbed pane. Panes that are non-detachable are ignored. For more information, see [CMFCBaseTabCtrl::EnableTabDetach](../VS_csharp/cmfcbasetabctrl-class.md#cmfcbasetabctrl__enabletabdetach).  
  
 Call this method to switch a tabbed pane to auto-hide mode programmatically. The pane must be docked to the main frame window ( [CDockablePane::GetDefaultPaneDivider](../VS_csharp/cdockablepane-class.md#cdockablepane__getdefaultpanedivider) must return a valid pointer to the [CPaneDivider](../VS_csharp/cpanedivider-class.md)).  
  
## See Also  
 [Hierarchy Chart](../VS_csharp/hierarchy-chart.md)   
 [Classes](../VS_csharp/mfc-classes.md)   
 [CDockablePane Class](../VS_csharp/cdockablepane-class.md)