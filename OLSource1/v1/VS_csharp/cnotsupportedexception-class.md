...
## Remarks  
 ...
 For more information on using `CNotSupportedException`, see the article [Exception Handling (MFC)](../VS_csharp/exception-handling-in-mfc.md).  
...
### Remarks  
 Do not use this constructor directly, but rather call the global function [AfxThrowNotSupportedException](../VS_csharp/afxthrownotsupportedexception.md). For more information about exception processing, see the article [Exceptions](../VS_csharp/exception-handling-in-mfc.md).  
