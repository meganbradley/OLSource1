...
|Name|Description|  
|----------|-----------------|  
|[ArgTraitsHelper::args Constant](../VS_csharp/argtraitshelper--args-constant.md)|Helps [ArgTraits::args](../VS_csharp/argtraits--args-constant.md) keep count of the number of parameters on the Invoke method of a delegate interface.|  
