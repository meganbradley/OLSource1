 ...
 **Note** The `Installation URL` property can also be set using the **PublishWizard**. For more information, see [How to: Publish a ClickOnce Application](../VS_csharp/how-to--publish-a-clickonce-application-using-the-publish-wizard.md).  
...
## See Also  
 [How to: Specify a Publishing Location](../VS_csharp/how-to--specify-where-visual-studio-copies-the-files.md)   
