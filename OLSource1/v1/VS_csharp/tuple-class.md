...
### Remarks  
 ...
 The remaining member operators are analogs to earlier ones, but with [rvalue references](../VS_csharp/rvalue-reference-declarator----.md).  
...
### Remarks  
 ...
 The remaining constructors are analogs to earlier ones, but with [rvalue references](../VS_csharp/rvalue-reference-declarator----.md).  
...
## See Also  
 ...
 [make_tuple](../VS_csharp/-tuple--functions.md#make_tuple_function)