...
## Remarks  
 ...
 At some point in the future, you must call the [CurrentScheduler::Detach](../VS_csharp/currentscheduler--detach-method.md) method in order to allow the scheduler to shut down.  
...
## See Also  
 ...
 [CurrentScheduler::Detach Method](../VS_csharp/currentscheduler--detach-method.md)