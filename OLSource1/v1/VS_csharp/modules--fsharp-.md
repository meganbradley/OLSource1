...
## Remarks  
 ...
 [!code[FsModules#6601](../VS_csharp/codesnippet/FSharp/modules--fsharp-_1.fs)]  
  
 This file would be compiled as if it were written in this manner:  
  
 [!code[FsModules#6602](../VS_csharp/codesnippet/FSharp/modules--fsharp-_2.fs)]  
 ...
 [!code[FsModules#6603](../VS_csharp/codesnippet/FSharp/modules--fsharp-_3.fs)]  
 ...
 The `accessibility-modifier` can be one of the following: `public`, `private`, `internal`. For more information, see [Access Control (F#)](../VS_csharp/access-control--fsharp-.md). The default is public.  
...
## Referencing Code in Modules  
 ...
 You can open the module or one or more of the namespaces to simplify the code. For more information about opening namespaces and modules, see [Import Declarations: the open Keyword (F#)](../VS_csharp/import-declarations--the-open-keyword--fsharp-.md).  
  
 The following code example shows a top-level module that contains all the code up to the end of the file.  
  
 [!code[FsModules#6604](../VS_csharp/codesnippet/FSharp/modules--fsharp-_4.fs)]  
 ...
 [!code[FsModules#6605](../VS_csharp/codesnippet/FSharp/modules--fsharp-_5.fs)]  
...
## Nested Modules  
 ...
 [!code[FsModules#6607](../VS_csharp/codesnippet/FSharp/modules--fsharp-_6.fs)]  
  
 But module `Z` is a sibling to module `Y` in the following code.  
  
 [!code[FsModules#6608](../VS_csharp/codesnippet/FSharp/modules--fsharp-_7.fs)]  
 ...
 [!code[FsModules#6609](../VS_csharp/codesnippet/FSharp/modules--fsharp-_8.fs)]  
 ...
 [!code[FsModules#6610](../VS_csharp/codesnippet/FSharp/modules--fsharp-_9.fs)]  
  
 To eliminate the warning, indent the inner module.  
  
 [!code[FsModules#6611](../VS_csharp/codesnippet/FSharp/modules--fsharp-_10.fs)]  
 ...
 [!code[FsModules#6612](../VS_csharp/codesnippet/FSharp/modules--fsharp-_11.fs)]  
  
## See Also  
 [F# Language Reference](../VS_csharp/fsharp-language-reference.md)   
 [Namespaces](../VS_csharp/namespaces--fsharp-.md)