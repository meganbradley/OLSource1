...
|Element|Description|  
|-------------|-----------------|  
|[CustomParameters](../VS_csharp/customparameters-element--visual-studio-templates-.md)|Groups the custom parameters that are to be passed to the template wizard when the wizard makes parameter replacements.|  
...
## See Also  
 [CustomParameters Element (Visual Studio Project Templates)](../VS_csharp/customparameters-element--visual-studio-templates-.md)   
