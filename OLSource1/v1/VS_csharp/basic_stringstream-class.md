...
---
# basic_stringstream Class
Describes an object that controls insertion and extraction of elements and encoded objects using a stream buffer of class [basic_stringbuf](../VS_csharp/basic_stringbuf-class.md)< **Elem**, **Tr**, `Alloc`>.  
...
## Remarks  
 The template class describes an object that controls insertion and extraction of elements and encoded objects using a stream buffer of class [basic_stringbuf](../VS_csharp/basic_stringbuf-class.md)< **Elem**, **Tr**, `Alloc`>, with elements of type **Elem**, whose character traits are determined by the class **Tr**, and whose elements are allocated by an allocator of class `Alloc`. The object stores an object of class basic_stringbuf< **Elem**, **Tr**, `Alloc`>.  
...
|||  
|-|-|  
|[rdbuf](#basic_stringstream__rdbuf)|Returns the address of the stored stream buffer of type `pointer` to [basic_stringbuf](../VS_csharp/basic_stringbuf-class.md)< `Elem`, `Tr`, `Alloc`>.|  
...
### Remarks  
 The first constructor initializes the base class by calling [basic_iostream](../VS_csharp/basic_iostream-class.md)( **sb**), where **sb** is the stored object of class [basic_stringbuf](../VS_csharp/basic_stringbuf-class.md)< **Elem**, **Tr**, `Alloc`>. It also initializes **sb** by calling basic_stringbuf< **Elem**, **Tr**, `Alloc`>( `_Mode`).  
...
##  <a name="basic_stringstream__rdbuf"></a>  basic_stringstream::rdbuf  
 Returns the address of the stored stream buffer of type **pointer** to [basic_stringbuf](../VS_csharp/basic_stringbuf-class.md)< **Elem**, **Tr**, `Alloc`>.  
...
### Remarks  
 The first member function returns [rdbuf](#basic_stringstream__rdbuf) -> [str](../VS_csharp/basic_stringbuf-class.md#basic_stringbuf__str). The second member function calls `rdbuf` -> **str**( `_Newstr`).  
  
### Example  
  See [basic_stringbuf::str](../VS_csharp/basic_stringbuf-class.md#basic_stringbuf__str) for an example that uses **str**.  
