...
## Remarks  
 If `syncContext` is null then the asynchronous computation is equivalent to [Async.SwitchToThreadPool](../VS_csharp/async.switchtothreadpool-method--fsharp-.md).  
...
## Example  
 ...
 [!code[FsAsyncAPIs#25](../VS_csharp/codesnippet/FSharp/async.switchtocontext-method--fsharp-_1.fs)]  
