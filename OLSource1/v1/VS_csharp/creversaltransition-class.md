...
|Name|Description|  
|----------|-----------------|  
|[CReversalTransition::Create](#creversaltransition__create)|Calls the transition library to create encapsulated transition COM object. (Overrides [CBaseTransition::Create](../VS_csharp/cbasetransition-class.md#cbasetransition__create).)|  
...
## Inheritance Hierarchy  
 ...
 [CReversalTransition](../VS_csharp/creversaltransition-class.md)  
