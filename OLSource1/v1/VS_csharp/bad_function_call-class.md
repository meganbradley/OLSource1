...
## Remarks  
 The class describes an exception thrown to indicate that a call to `operator()` on a [function](../VS_csharp/function-class.md) object failed because the object was empty.  
