...
## Example  
 The following code example illustrates the use of `List.sum`, [List.sumBy](../VS_csharp/list.sumby--t-^u--function--fsharp-.md), and [List.average](../VS_csharp/list.average-^t--function--fsharp-.md).  
  
 [!code[FsLists#11](../VS_csharp/codesnippet/FSharp/list.sum-^t--function--fsharp-_1.fs)]  
