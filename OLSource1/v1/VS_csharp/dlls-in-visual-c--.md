...
## In This Section  
 [Walkthrough: Creating and Using a Dynamic Link Library (C++)](../VS_csharp/walkthrough--creating-and-using-a-dynamic-link-library--c---.md)  
 Describes how to create and use a DLL using Visual Studio.  
  
 [Differences Between Applications and DLLs](../VS_csharp/differences-between-applications-and-dlls.md)  
 Describes the fundamental differences between applications and DLLs.  
  
 [Advantages of Using DLLs](../VS_csharp/advantages-of-using-dlls.md)  
 ...
 [DLL Frequently Asked Questions](../VS_csharp/dll-frequently-asked-questions.md)  
 Provides answers to frequently asked questions about DLLs.  
  
 [Linking an Executable to a DLL](../VS_csharp/linking-an-executable-to-a-dll.md)  
 Describes explicit and implicit linking to a DLL.  
  
 [Initializing a DLL](../VS_csharp/initializing-a-dll.md)  
 ...
 [LoadLibrary and AfxLoadLibrary](../VS_csharp/loadlibrary-and-afxloadlibrary.md)  
 ...
 [Search Path Used by Windows to Locate a DLL](../VS_csharp/search-path-used-by-windows-to-locate-a-dll.md)  
 Describes the search path that the Windows operating system uses to locate a DLL on the system.  
  
 [Module States of a Regular DLL Dynamically Linked to MFC](../VS_csharp/module-states-of-a-regular-dll-dynamically-linked-to-mfc.md)  
 Describes the module states of a regular DLL dynamically linked to MFC.  
  
 [Extension DLLs](../VS_csharp/extension-dlls--overview.md)  
 ...
 [Creating a Resource-Only DLL](../VS_csharp/creating-a-resource-only-dll.md)  
 Discusses a resource-only DLL, which contains nothing but resources, such as icons, bitmaps, strings, and dialog boxes.  
  
 [Localized Resources in MFC Applications: Satellite DLLs](../VS_csharp/localized-resources-in-mfc-applications--satellite-dlls.md)  
 ...
 [Active Technology and DLLs](../VS_csharp/active-technology-and-dlls.md)  
 Allows object servers to be implemented inside a DLL.  
  
 [Automation in a DLL](../VS_csharp/automation-in-a-dll.md)  
 Describes what the Automation option in the MFC DLL Wizard supplies.  
  
 [Naming Conventions for MFC DLLs](../VS_csharp/naming-conventions-for-mfc-dlls.md)  
 Discusses how the DLLs and libraries included in MFC follow a structured naming convention.  
  
 [Calling DLL functions from Visual Basic Applications](../VS_csharp/calling-dll-functions-from-visual-basic-applications.md)  
...
## Related Sections  
 ...
 [DLL Version of MFC](../VS_csharp/tn033--dll-version-of-mfc.md)  
