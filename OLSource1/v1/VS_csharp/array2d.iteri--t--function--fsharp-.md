...
#### Parameters  
 `action`  
 Type: [int](../VS_csharp/core.int-type-abbreviation--fsharp-.md) `->` [int](../VS_csharp/core.int-type-abbreviation--fsharp-.md) `-> 'T ->` [unit](../VS_csharp/core.unit-type-abbreviation--fsharp-.md)  
