...
-   on a [!INCLUDE[win7](../VS_csharp/includes/win7_md.md)] or [!INCLUDE[wiprlhext](../VS_csharp/includes/wiprlhext_md.md)]system that has been started in debug mode.  
...
-   Disable kernel debugging and debug in [!INCLUDE[vsprvs](../VS_csharp/includes/vsprvs_md.md)].  
  
     —or—  
  
-   Debug using the Kernel Debugger instead of [!INCLUDE[vsprvs](../VS_csharp/includes/vsprvs_md.md)].  
