...
### Remarks  
 The manipulator calls `_Ostr`**.**[put](../VS_csharp/basic_ostream-class.md#basic_ostream__put)( `_Ostr`**.** [widen](../VS_csharp/basic_ios-class.md#basic_ios__widen)( **'\n'**)), and then calls `_Ostr`**.**[flush](../VS_csharp/basic_ostream-class.md#basic_ostream__flush). It returns `_Ostr`.  
...
### Remarks  
 The manipulator calls `_Ostr`**.**[put](../VS_csharp/basic_ostream-class.md#basic_ostream__put)( `_Elem`( **'\0'**)). It returns `_Ostr.`  
...
### Remarks  
 The manipulator calls `_Ostr`**.**[flush](../VS_csharp/basic_ostream-class.md#basic_ostream__flush). It returns `_Ostr`.  
