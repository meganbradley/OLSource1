...
1.  Open a version information resource by double-clicking it in [Resource View](../VS_csharp/resource-view-window.md).  
...
2.  Right-click within the version information table and choose **New Version Info Block** from the shortcut menu.  
     ...
     This command adds an additional information block to the current version information resource and opens its corresponding properties in the [Properties window](../VS_csharp/properties-window.md).  
...
## See Also  
 [Version Information Editor](../VS_csharp/version-information-editor.md)   
