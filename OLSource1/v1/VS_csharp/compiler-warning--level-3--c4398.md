...
'variable' : per-process global object might not work correctly with multiple appdomains; consider using __declspec(appdomain)  
 ...
 A virtual function with [__clrcall](../VS_csharp/__clrcall.md) calling convention in a native type causes the creation of a per application domain vtable. Such a variable may not correct correctly when used in multiple application domains.  
 ...
 For more information, see [appdomain](../VS_csharp/appdomain.md) and [Application Domains and Visual C++](../VS_csharp/application-domains-and-visual-c--.md).  
