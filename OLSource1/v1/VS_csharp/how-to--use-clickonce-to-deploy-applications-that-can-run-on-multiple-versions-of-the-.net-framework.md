...
3.  Update the version number of the `<assemblyIdentity>` element for Microsoft.Windows.CommonLanguageRuntime to the version number for the .NET Framework that is the lowest common denominator. For example, if the application targets .NET Framework 3.5 and [!INCLUDE[net_v40_short](../VS_csharp/includes/net_v40_short_md.md)], use the 2.0.50727.0 version number and the XML should look like the following:  
...
-   Update and re-sign the application and deployment manifests. For more information, see [How to: Re-sign Application and Deployment Manifests](../VS_csharp/how-to--re-sign-application-and-deployment-manifests.md).  
  
## See Also  
 [Publishing ClickOnce Applications](../VS_csharp/publishing-clickonce-applications.md)   
 [<compatibleFrameworks\> Element](../VS_csharp/-compatibleframeworks--element--clickonce-deployment-.md)   
 [<dependency\> Element](../VS_csharp/-dependency--element--clickonce-application-.md)   
