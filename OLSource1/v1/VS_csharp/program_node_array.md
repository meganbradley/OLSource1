...
## Members  
 ...
 Members  
 An array of [IDebugProgramNode2](../VS_csharp/idebugprogramnode2.md) objects describing the programs requested.  
  
## Remarks  
 This structure is part of the [PROVIDER_PROCESS_DATA](../VS_csharp/provider_process_data.md) structure which in turn is filled in by a call to the [IDebugProgramProvider2::GetProviderProcessData](../VS_csharp/idebugprogramprovider2--getproviderprocessdata.md) method.  
