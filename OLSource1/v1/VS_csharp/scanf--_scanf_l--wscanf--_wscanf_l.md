...
Reads formatted data from the standard input stream. More secure versions of these function are available; see [scanf_s, _scanf_s_l, wscanf_s, _wscanf_s_l](../VS_csharp/scanf_s--_scanf_s_l--wscanf_s--_wscanf_s_l.md).  
...
> [!IMPORTANT]
>  When reading a string with `scanf`, always specify a width for the `%s` format (for example, `"%32s"` instead of `"%s"`); otherwise, improperly formatted input can easily cause a buffer overrun. Alternately, consider using [scanf_s, wscanf_s](../VS_csharp/scanf_s--_scanf_s_l--wscanf_s--_wscanf_s_l.md) or [fgets](../VS_csharp/fgets--fgetws.md).  
...
|`_tscanf_l`|`_scanf_l`|`_scanf_l`|`_wscanf_l`|  
 ...
 For more information, see [Format Specification Fields — scanf functions and wscanf Functions](../VS_csharp/format-specification-fields--scanf-and-wscanf-functions.md).  
