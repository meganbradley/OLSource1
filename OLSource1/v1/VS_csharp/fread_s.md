...
---
# fread_s
Reads data from a stream. This version of [fread](../VS_csharp/fread.md) has security enhancements, as described in [Security Enhancements in the CRT](../VS_csharp/security-features-in-the-crt.md).  
