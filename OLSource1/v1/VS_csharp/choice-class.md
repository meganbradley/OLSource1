...
|[choice::unlink_targets Method](#choice__unlink_targets_method)|Unlinks all targets from this                                         `choice` messaging block. (Overrides                                         [ISource::unlink_targets](../VS_csharp/isource-class.md#isource__unlink_targets_method).)|  
