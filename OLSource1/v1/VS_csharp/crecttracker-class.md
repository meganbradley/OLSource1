...
## Remarks  
 ...
 For more information on using `CRectTracker`, see the article [Trackers](../VS_csharp/trackers.md).  
...
### Remarks  
 ...
 ![Resize handle numbers](../VS_csharp/media/vc35dp1.gif "vc35DP1")  
...
## See Also  
 [MFC Sample TRACKER](../VS_csharp/visual-c---samples.md)   
 [MFC Sample DRAWCLI](../VS_csharp/visual-c---samples.md)   
 [Hierarchy Chart](../VS_csharp/hierarchy-chart.md)   
 [COleResizeBar](../VS_csharp/coleresizebar-class.md)   
