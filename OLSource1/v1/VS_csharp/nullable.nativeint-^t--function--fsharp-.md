...
Converts the argument to signed native integer ([nativeint](../VS_csharp/core.nativeint-type-abbreviation--fsharp-.md)). This is a direct conversion for all primitive numeric types. Otherwise, the operation requires an appropriate static conversion method on the input type.  
...
## See Also  
 ...
 [Operators.nativeint<^T> Function (F#)](../VS_csharp/operators.nativeint-^t--function--fsharp-.md)