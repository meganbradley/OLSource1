 ...
 *interface2*(optional)  
 The default source interface. You must also specify this interface with the [source](../VS_csharp/source--c---.md) attribute.  
  
 If no default source interface is specified, the first source interface is used as the default.  
  
## Remarks  
 The **default** C++ attribute has the same functionality as the [default](http://msdn.microsoft.com/library/windows/desktop/aa366787) MIDL attribute. The **default** attribute is also used with the [case](../VS_csharp/case--c---.md) attribute.  
...
```  
 ...
 The [source](../VS_csharp/source--c---.md) attribute also has an example of how to use **default**.  
