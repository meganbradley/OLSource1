...
|||  
|-|-|  
|[AddProperty](../VS_csharp/cdbpropset--addproperty.md)|Adds a property to the property set.|  
|[CDBPropSet](../VS_csharp/cdbpropset--cdbpropset.md)|Constructor.|  
|[SetGUID](../VS_csharp/cdbpropset--setguid.md)|Sets the **guidPropertySet** field of the **DBPROPSET** structure.|  
  
### Operators  
  
|||  
|-|-|  
|[operator =](../VS_csharp/cdbpropset--operator-=.md)|Assigns the contents of one property set to another.|  
