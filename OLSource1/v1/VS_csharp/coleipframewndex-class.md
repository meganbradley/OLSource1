...
---
# COleIPFrameWndEx Class
The `COleIPFrameWndEx` class implements an OLE container that supports MFC. You must derive the in-place frame window class for your application from the `COleIPFrameWndEx` class, instead of deriving it from the [COleIPFrameWnd](../VS_csharp/coleipframewnd-class.md)class.  
...
|[COleIPFrameWndEx::OnDrawMenuLogo](#coleipframewndex__ondrawmenulogo)|Called by the framework when a [CMFCPopupMenu](../VS_csharp/cmfcpopupmenu-class.md)object processes a WM_PAINT message.|  
|[COleIPFrameWndEx::OnMenuButtonToolHitTest](#coleipframewndex__onmenubuttontoolhittest)|Called by the framework when a [CMFCToolBarButton](../VS_csharp/cmfctoolbarbutton-class.md)object processes WM_NCHITTEST message.|  
|[COleIPFrameWndEx::OnMoveMiniFrame](#coleipframewndex__onmoveminiframe)||  
|[COleIPFrameWndEx::OnSetPreviewMode](#coleipframewndex__onsetpreviewmode)|Call this member function to set the application's main frame window into and out of print-preview mode. (Overrides [CFrameWnd::OnSetPreviewMode](../VS_csharp/cframewnd-class.md#cframewnd__onsetpreviewmode).)|  
...
## Example  
 The following example demonstrates how to subclass an instance of the `COleIPFrameWndEx` class and over ride its methods. The example shows how to over ride the `OnDestory` method, the `RepositionFrame` method, the `RecalcLayout` method, and the `CalcWindowRect` method. This code snippet is part of the [Word Pad sample](../VS_csharp/visual-c---samples.md).  
  
 [!code[NVC_MFC_WordPad#1](../VS_csharp/codesnippet/CPP/coleipframewndex-class_1.cpp)]  
...
## Inheritance Hierarchy  
 ...
 [COleIPFrameWndEx](../VS_csharp/coleipframewndex-class.md)  
...
### Remarks  
 Use this method to obtain a pointer to the [CMFCPopupMenu](../VS_csharp/cmfcpopupmenu-class.md) object that is currently displayed.  
...
### Return Value  
 A reference to a `CObList` object that contains a collection of pointers to the [CBasePane](../VS_csharp/cbasepane-class.md)-derived objects.  
  
### Remarks  
 The `COleIPFrameWndEx` object maintains the collection of tear-off menus as a list of [CBasePane](../VS_csharp/cbasepane-class.md)-derived objects. Use this method to retrieve a reference to this list.  
...
##  <a name="coleipframewndex__ondrawmenulogo"></a>  COleIPFrameWndEx::OnDrawMenuLogo  
 Called by the framework when a [CMFCPopupMenu](../VS_csharp/cmfcpopupmenu-class.md)object processes a `WM_PAINT` message.  
...
### Parameters  
 [in]  `menu`  
 A reference to a [CMenu](../VS_csharp/cmenu-class.md) object to be modified.  
