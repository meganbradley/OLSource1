...
1.  Create the recordset object ([CRecordset](../VS_csharp/crecordset-class.md) for ODBC, [CDaoRecordset](../VS_csharp/cdaorecordset-class.md) for DAO).  
  
2.  Obtain a pointer to the [CComboBox](../VS_csharp/ccombobox-class.md) object for the combo box control.  
