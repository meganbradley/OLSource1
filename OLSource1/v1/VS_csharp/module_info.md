...
## Members  
 dwValidFields  
 A combination of flags from the [MODULE_INFO_FIELDS](../VS_csharp/module_info_fields.md) enumeration that specifies which fields are filled out.  
 ...
 m_dwModuleFlags  
 A combination of flags from the [MODULE_FLAGS](../VS_csharp/module_flags.md) enumeration that describes the module.  
  
## Remarks  
 This structure is passed to the [IDebugModule2::GetInfo](../VS_csharp/idebugmodule2--getinfo.md) method where it is filled in.  
...
## See Also  
 ...
 [IDebugModule2::GetInfo](../VS_csharp/idebugmodule2--getinfo.md)