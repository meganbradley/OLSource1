...
By using the procedures in this topic, you can build, rebuild, or clean all or some of the projects or project items in a solution. For a step-by-step tutorial, see [Walkthrough: Building an Application](../VS_csharp/walkthrough--building-an-application.md).  
...
1.  Choose a [!INCLUDE[vcprvc](../VS_csharp/includes/vcprvc_md.md)] project, and then, on the menu bar, choose **Build**, **Project Only**, and one of the following commands:  
    ...
    -   **Link Only** *ProjectName*  
     ...
     These commands apply only to the [!INCLUDE[vcprvc](../VS_csharp/includes/vcprvc_md.md)] project that you chose, without building, rebuilding, cleaning, or linking any project dependencies or solution files. Depending on your version of [!INCLUDE[vsprvs](../VS_csharp/includes/vsprvs_md.md)], the **Project Only** submenu might contain more commands.  
...
## See Also  
 [How to: Create a Build Log File in Visual Studio](../VS_csharp/how-to--view--save--and-configure-build-log-files.md)   
