...
## Remarks  
 Casts the current [ptr_](../VS_csharp/comptrrefbase--ptr_-data-member.md) data member to a pointer-to-a-pointer-to the IInspectable interface.  
...
## See Also  
 [ComPtrRefBase Class](../VS_csharp/comptrrefbase-class.md)   
