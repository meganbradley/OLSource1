...
> [!NOTE]
>  For a list of decimal language values, see [Wizard Support for Other Languages](../VS_csharp/wizard-support-for-other-languages.md).  
  
 The language ID is specified as a custom parameter in the .[vsz file](assetId:///3af817d8-8179-416f-bf54-0b70a007ca77) in the paths where the [HTML files](../VS_csharp/html-files.md) and the [Template files](../VS_csharp/template-files.md) reside.  
...
## See Also  
 ...
 [Custom Parameters in the Wizard .Vsz File](../VS_csharp/custom-parameters-in-the-wizard-.vsz-file.md)