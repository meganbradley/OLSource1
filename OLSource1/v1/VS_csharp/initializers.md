...
-   Arrays, [POD](../VS_csharp/is_pod-class.md) classes, structs, and unions have their members initialized to a zero value.  
...
```  
 ...
 For more information about initialization of global static objects, see [Additional Startup Considerations](../VS_csharp/additional-startup-considerations.md).  
...
-   class, struct, and union members are initialized by copy initialization during aggregate initialization. See [Aggregate initialization](../VS_csharp/initializers.md#INIT_AggInit) for examples.  
...
-   Declaration of a variable explicitly specified as `extern`. For example:  
 ...
 ![Decision graph for initialization of ref types](../VS_csharp/media/vc38s71.gif "vc38S71")  
