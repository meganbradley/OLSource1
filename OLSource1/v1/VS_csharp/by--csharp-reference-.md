...
---
# by (C# Reference)
The `by` contextual keyword is used in the `group` clause in a query expression to specify how the returned items should be grouped. For more information, see [group clause (C# Reference)](../VS_csharp/group-clause--csharp-reference-.md).  
...
## Example  
 ...
 [!code[csrefKeywordsContextual#10](../VS_csharp/codesnippet/CSharp/by--csharp-reference-_1.cs)]  
