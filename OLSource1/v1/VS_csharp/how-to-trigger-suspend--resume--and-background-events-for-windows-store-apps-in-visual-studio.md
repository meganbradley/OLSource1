...
3.  On the **Debug Location** toolbar, choose the event that you want to fire:  
     ...
     ![Suspend, resume, terminate, and background tasks](../VS_csharp/media/dbg_suspendresumebackground.png "DBG_SuspendResumeBackground")  
...
3.  Do one of the following:  
    ...
    -   For Visual C# and Visual Basic projects, choose **Do not launch, but debug my code when it starts**  
         ...
         ![C&#35;&#47;VB debug launch application property](../VS_csharp/media/dbg_csvb_dontlaunchapp.png "DBG_CsVb_DontLaunchApp")  
  
    -   For JavaScript and Visual C++ projects, choose **No** from the **Launch application** list.  
  
         ![C&#43;&#43;&#47;VB Launch application debug property](../VS_csharp/media/dbg_cppjs_dontlaunchapp.png "DBG_CppJs_DontLaunchApp")  
...
4.  Press **F5** to put the app in debug mode. Note the **Process** list on the **Debug Location** toolbar displays the app package name to indicate that you are in debug mode.  
     ...
     ![Background task Process list](../VS_csharp/media/dbg_backgroundtask_processlist.png "DBG_BackgroundTask_ProcessList")  
...
## See Also  
 [Debugging and testing Windows Metro style apps](../VS_csharp/testing-store-apps-with-visual-studio.md)   
