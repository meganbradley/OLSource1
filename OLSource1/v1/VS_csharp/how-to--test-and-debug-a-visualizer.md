...
Once you have written a visualizer, you need to debug and test it.  
 ...
 One way to test a visualizer is by installing it in Visual Studio and calling it from a debugger window. (See [How to: Install a Visualizer](../VS_csharp/how-to--install-a-visualizer.md).) If you do that, you will need to use a second instance of Visual Studio to attach and debug the visualizer, which is running in the first instance of the debugger.  
...
2.  Add the following statement to call `TestShowVisualizer`. If you created your visualizer in a class library, you need to create an executable to call the class library and place this statement in your executable:  
    ...
    ```  
     ...
     For a more complete example, see [Walkthrough: Writing a Visualizer](../VS_csharp/walkthrough--writing-a-visualizer-in-csharp.md).  
