...
## Remarks  
 ...
 By default, the linker sets this option for 64-bit executable images. To set this option, the [/DYNAMICBASE](../VS_csharp/-dynamicbase.md) option must also be set.  
  
## See Also  
 [EDITBIN Options](../VS_csharp/editbin-options.md)   
 [/DYNAMICBASE](../VS_csharp/-dynamicbase.md)   
