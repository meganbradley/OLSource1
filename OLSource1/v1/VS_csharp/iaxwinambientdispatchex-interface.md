...
|||  
|-|-|  
|[SetAmbientDispatch](../VS_csharp/iaxwinambientdispatchex--setambientdispatch.md)|This method is called to supplement the default ambient property interface with a user-defined interface.|  
...
## Remarks  
 ...
 This interface is exposed by ATL's ActiveX control hosting objects. Derived from [IAxWinAmbientDispatch](../VS_csharp/iaxwinambientdispatch-interface.md), `IAxWinAmbientDispatchEx` adds a method that allows you to supplement the ambient property interface provided by ATL with one of your own.  
