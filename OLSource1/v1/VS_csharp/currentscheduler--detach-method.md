...
## Remarks  
 ...
 Calling this method from a context that is internal to and managed by a scheduler, or a context that was attached using a method other than the [Scheduler::Attach](../VS_csharp/scheduler--attach-method.md) or [CurrentScheduler::Create](../VS_csharp/currentscheduler--create-method.md) methods, will result in an [improper_scheduler_detach](../VS_csharp/improper_scheduler_detach-class.md) exception being thrown.  
