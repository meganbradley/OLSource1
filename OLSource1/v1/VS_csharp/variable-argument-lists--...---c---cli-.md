...
> [!NOTE]
>  This topic pertains to C++/CLI. For information about using the `...` in ISO Standard C++, see [Ellipses and Variadics](../VS_csharp/ellipses-and-variadic-templates.md) and [Ellipses and Default Arguments](../Topic/Ellipses%20and%20Default%20Arguments.md).  
...
## See Also  
 [Arrays](../VS_csharp/arrays--c---component-extensions-.md)