...
---
# &lt;see&gt; (Visual C++)
The <see\> tag lets you specify a link from within text. Use [<seealso\>](../VS_csharp/-seealso---visual-c---.md) to indicate text that you might want to appear in a See Also section.  
...
## Remarks  
 ...
 See [<summary\>](../VS_csharp/-summary---visual-c---.md) for an example of using <see\>.  
  
 The Visual C++ compiler will attempt to resolve cref references in one pass through the documentation comments.  Therefore, if using the C++ lookup rules, a symbol is not found by the compiler the reference will be marked as unresolved. See [<seealso\> (C++)](../VS_csharp/-seealso---visual-c---.md) for more information.  
