...
---
# CMDITabInfo Class
The `CMDITabInfo` class is used to pass parameters to [CMDIFrameWndEx::EnableMDITabbedGroups](../VS_csharp/cmdiframewndex-class.md#cmdiframewndex__enablemditabbedgroups) method. Set members of this class to control the behavior of MDI tabbed groups.  
...
## Example  
 ...
 [!code[NVC_MFC_MDITab#1](../VS_csharp/codesnippet/CPP/cmditabinfo-class_1.cpp)]  
  
## Inheritance Hierarchy  
 [CMDITabInfo](../VS_csharp/cmditabinfo-class.md)  
...
### Remarks  
 [CMFCVisualManager::GetMDITabsBordersSize](../VS_csharp/cmfcvisualmanager-class.md#cmfcvisualmanager__getmditabsborderssize) returns the default value.  
...
### Parameters  
 [in] `ar`  
 A [CArchive Class](../VS_csharp/carchive-class.md) object to serialize.  
  
## See Also  
 [CMDIFrameWndEx](../VS_csharp/cmdiframewndex-class.md)   
 [MDI Tabbed Groups](../VS_csharp/mdi-tabbed-groups.md)   
