...
-   [Creating the SimpleMathVSIX extension SDK project](../VS_csharp/walkthrough--creating-an-sdk-using-javascript.md#createSimpleMathVSIX)  
  
-   [Creating a sample app that uses the SDK](../VS_csharp/walkthrough--creating-an-sdk-using-javascript.md#createSampleApp)  
