...
---
# CDaoRelationInfo Structure
The `CDaoRelationInfo` structure contains information about a relation defined between fields of two tables in a [CDaoDatabase](../VS_csharp/cdaodatabase-class.md) object.  
...
-   **dbRelationDeleteCascade** Deletions will cascade.  
 ...
 `m_pFieldInfos`  
 A pointer to an array of [CDaoRelationFieldInfo](../VS_csharp/cdaorelationfieldinfo-structure.md) structures. The array contains one object for each field in the relation. The `m_nFields` data member gives a count of the array elements.  
...
## See Also  
 [CDaoRelationFieldInfo Structure](../VS_csharp/cdaorelationfieldinfo-structure.md)