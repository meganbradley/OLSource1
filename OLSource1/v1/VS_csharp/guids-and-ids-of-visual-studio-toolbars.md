...
## See Also  
 [Walkthrough: Adding a Menu Controller to a Toolbar](../VS_csharp/adding-a-menu-controller-to-a-toolbar.md)   
 [Walkthrough: Adding a Toolbar to a Tool Window (C#)](../VS_csharp/adding-a-toolbar-to-a-tool-window.md)   
