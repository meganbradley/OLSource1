...
#### Parameters  
 ...
 iCommand  
 [in] The command for which advanced options are requested (see [Command Code Enumerator](../VS_csharp/command-code-enumerator.md) for possible values).  
...
## Remarks  
 ...
 Finally, when the user clicks **OK** in the IDE's **Get** dialog box, the IDE calls the [SccGet Function](../VS_csharp/sccget-function.md), passing the structure returned in `ppvOptions` that contains the advanced options.  
