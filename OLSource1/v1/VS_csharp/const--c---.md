...
```  
 ...
 In C++, you can use the **const** keyword instead of the [#define](../VS_csharp/sharpdefine-directive--c-c---.md) preprocessor directive to define constant values. Values defined with **const** are subject to type checking, and can be used in place of constant expressions. In C++, you can specify the size of an array with a **const** variable as follows:  
...
-   [Type Qualifiers (C Language Reference)](../VS_csharp/type-qualifiers.md)  
  
-   [volatile](../VS_csharp/volatile--c---.md)  
  
-   [#define](../VS_csharp/sharpdefine-directive--c-c---.md).  
