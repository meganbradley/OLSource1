...
```  
 ...
 The next section, [C Function Definitions](../VS_csharp/c-function-definitions.md), shows the syntax for function definitions, including the old-style syntax. The nonterminal for the list of parameters in the old-style syntax is *identifier-list*.  
  
## See Also  
 [Overview of Functions](../VS_csharp/overview-of-functions.md)