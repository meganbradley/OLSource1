...
---
# CMFCToolBarComboBoxButton Class
A toolbar button that contains a combo box control ( [CComboBox](../VS_csharp/ccombobox-class.md)).  
...
## Remarks  
 ...
 For more information, see [How to Put Controls on Toolbars](../VS_csharp/walkthrough--putting-controls-on-toolbars.md). For an example of a combo box toolbar button, see the example project VisualStudioDemo.  
  
## Example  
 The following example demonstrates how to use various methods in the `CMFCToolBarComboBoxButton` class. The example shows how to enable the edit and combo boxes, set the vertical position of combo box buttons in the application, set the height of the list box when it is dropped down, set the flat style appearance of combo box buttons in the application, and set the text in the edit box of the combo box button. This code snippet is part of the [Visual Studio Demo sample](../VS_csharp/visual-c---samples.md).  
  
 [!code[NVC_MFC_VisualStudioDemo#36](../VS_csharp/codesnippet/CPP/cmfctoolbarcomboboxbutton-class_1.cpp)]  
[!code[NVC_MFC_VisualStudioDemo#37](../VS_csharp/codesnippet/CPP/cmfctoolbarcomboboxbutton-class_2.cpp)]  
...
##  <a name="cmfctoolbarcomboboxbutton__cmfctoolbarcomboboxbutton"></a>  CMFCToolBarComboBoxButton::CMFCToolBarComboBoxButton  
 Constructs a [CMFCToolBarComboBoxButton](../VS_csharp/cmfctoolbarcomboboxbutton-class.md) object.  
...
### Remarks  
 ...
 For a list of toolbar button styles see [ToolBar Control Styles](../VS_csharp/toolbar-control-styles.md)  
...
### Remarks  
 The framework calls this method when it creates a new edit box for a combo box button. Override this method to change how [CMFCToolBarComboBoxEdit](../VS_csharp/cmfctoolbarcomboboxedit-class.md) is created.  
...
### Return Value  
 A pointer to the [CComboBox](../VS_csharp/ccombobox-class.md) object if the method was successful; otherwise `NULL`.  
