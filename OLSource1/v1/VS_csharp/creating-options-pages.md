...
In the [!INCLUDE[vsprvs](../VS_csharp/includes/vsprvs_md.md)] managed package framework, classes derived from <xref:Microsoft.VisualStudio.Shell.DialogPage*> extend the [!INCLUDE[vsprvs](../VS_csharp/includes/vsprvs_md.md)] IDE by adding **Options** pages under the **Tools** menu.  
...
### Code  
 [!code[UI_UserSettings_ToolsOptionPages#11](../VS_csharp/codesnippet/CSharp/creating-options-pages_1.cs)]
[!code[UI_UserSettings_ToolsOptionPages#11](../VS_csharp/codesnippet/VisualBasic/creating-options-pages_1.vb)]  
...
### Code  
 [!code[UI_UserSettings_ToolsOptionPages#07](../VS_csharp/codesnippet/CSharp/creating-options-pages_2.cs)]
[!code[UI_UserSettings_ToolsOptionPages#07](../VS_csharp/codesnippet/VisualBasic/creating-options-pages_2.vb)]  
...
### Code  
 [!code[UI_UserSettings_ToolsOptionPages#08](../VS_csharp/codesnippet/CSharp/creating-options-pages_3.cs)]
[!code[UI_UserSettings_ToolsOptionPages#08](../VS_csharp/codesnippet/VisualBasic/creating-options-pages_3.vb)]  
  
## See Also  
 [User Configuration and Settings](../VS_csharp/extending-user-settings-and-options.md)   
 [Automation Support for Tools Options Pages](../VS_csharp/automation-support-for-options-pages.md)