...
---
# for each, in
Iterates through an array or collection. This non-standard keyword is available in both C++/CLI and native C++ projects. However, its use is not recommended. Consider using a standard [Range-based for Statement (C++)](../VS_csharp/range-based-for-statement--c---.md) instead.  
 ...
 **Parameters**  
 ...
 `identifier`  
 The iteration variable that represents the collection element.  When `identifier` is a [Tracking Reference Operator (C++ Component Extensions)](../VS_csharp/tracking-reference-operator--c---component-extensions-.md), you can modify the element.  
 ...
 **Remarks**  
 ...
 `for each` and `in` are [context-sensitive keywords](../VS_csharp/context-sensitive-keywords---c---component-extensions-.md).  
  
 For more information:  
  
-   [How to: Iterate Over STL Collection with for each](../VS_csharp/iterating-over-stl-collection-by-using-for-each.md)  
  
-   [How to: Iterate Over Arrays with for each](../VS_csharp/how-to--iterate-over-arrays-with-for-each.md)  
  
-   [How to: Iterate Over a Generic Collection with for each](../VS_csharp/how-to--iterate-over-a-generic-collection-with-for-each.md)  
  
-   [How to: Iterate Over a User-Defined Collection with for each](../VS_csharp/how-to--iterate-over-a-user-defined-collection-with-for-each.md)  
