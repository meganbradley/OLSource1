...
compiler option /GL is incompatible with the installed version of common language runtime  
 ...
 For more information, see [/clr (Common Language Runtime Compilation)](../VS_csharp/-clr--common-language-runtime-compilation-.md) and [/GL (Whole Program Optimization)](../VS_csharp/-gl--whole-program-optimization-.md).