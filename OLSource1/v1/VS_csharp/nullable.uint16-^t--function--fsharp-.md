...
Converts the argument to unsigned 16-bit integer ([uint16](../VS_csharp/core.uint16-type-abbreviation--fsharp-.md)). This is a direct conversion for all primitive numeric types. The operation requires an appropriate static conversion method on the input type.  
...
## See Also  
 ...
 [Operators.uint16<^T> Function (F#)](../VS_csharp/operators.uint16-^t--function--fsharp-.md)