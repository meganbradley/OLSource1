...
## See Also  
 ...
 [How to: Distribute Code Snippets](../VS_csharp/how-to--distribute-code-snippets.md)   
 [Best Practices for Using Code Snippets](../VS_csharp/best-practices-for-using-code-snippets.md)   
 [Troubleshooting Snippets](../VS_csharp/troubleshooting-snippets.md)   
 [Visual C# Code Snippets](../VS_csharp/visual-csharp-code-snippets.md)   
 [Visual C++ Code Snippets](../VS_csharp/visual-c---code-snippets.md)   
