...
Converts the argument to [char](../VS_csharp/core.char-type-abbreviation--fsharp-.md). Numeric inputs are converted according to the UTF-16 encoding for characters. The operation requires an appropriate static conversion method on the input type.  
...
## See Also  
 ...
 [Operators.char<^T> Function (F#)](../VS_csharp/operators.char-^t--function--fsharp-.md)