...
---
# DDX_FieldCBStringExact
The `DDX_FieldCBStringExact` function manages the transfer of [CString](../VS_csharp/cstringt-class.md) data between the edit control of a combo box control in a record view and a `CString` field data member of a recordset associated with the record view.  
...
## Example  
 See [DDX_FieldText](../VS_csharp/ddx_fieldtext.md) for a general DDX_Field example. Calls to `DDX_FieldCBStringExact` would be similar.  
