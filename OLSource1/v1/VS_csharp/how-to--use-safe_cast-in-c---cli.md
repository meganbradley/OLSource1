...
This article shows how to use safe_cast in [!INCLUDE[cppcli](../VS_csharp/includes/cppcli_md.md)] applications. For information about safe_cast in [!INCLUDE[cppwrt_short](../VS_csharp/includes/cppwrt_short_md.md)], see [safe_cast](../VS_csharp/safe_cast--c---component-extensions-.md).  
