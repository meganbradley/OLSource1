...
|Member|Description|  
|------------|-----------------|  
|[InnerExceptions](../VS_csharp/aggregateexception.innerexceptions-property--fsharp-.md)|Gets a read-only collection of the `Exception` instances that caused the current exception.|  
