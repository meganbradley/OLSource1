...
Represents a statically-analyzed format associated with writing to a <xref:System.IO.TextWriter*>. The first type parameter indicates the arguments of the format operation and the last the overall return type. This type is a type abbreviation for [Format<'Printer,TextWriter,unit,'Result>](../VS_csharp/core.format--printer--state--residue--result--type-abbreviation--fsharp-.md).  
