...
1.  Add the following comment to your code.  
     ...
     [!code[VbExpressTutorial1Step9_10#1](../VS_csharp/codesnippet/VisualBasic/step-9--review--comment--and-test-your-code_1.vb)]
[!code[VbExpressTutorial1Step9_10#1](../VS_csharp/codesnippet/CSharp/step-9--review--comment--and-test-your-code_1.cs)]  
...
2.  Before you run your program, save your program by choosing the **Save All** toolbar button, which appears as follows.  
     ...
     ![Save All toolbar button](../VS_csharp/media/express_iconsaveall.png "Express_IconSaveAll")  
Save All button  
     ...
     ![Picture Viewer](../VS_csharp/media/express_pictureviewerdonerun.png "Express_PictureViewerDoneRun")  
Picture Viewer  
...
-   To go to the next tutorial step, see [Step 10: Create Additional Buttons and a Check Box](../VS_csharp/step-10--write-code-for-additional-buttons-and-a-check-box.md).  
  
-   To return to the previous tutorial step, see [Step 8: Write Code for the Show a Picture Button Event Handler](../VS_csharp/step-8--write-code-for-the-show-a-picture-button-event-handler.md).