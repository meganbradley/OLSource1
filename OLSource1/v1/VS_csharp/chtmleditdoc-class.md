...
---
# CHtmlEditDoc Class
With [CHtmlEditView](../VS_csharp/chtmleditview-class.md), provides the functionality of the WebBrowser editing platform within the context of the MFC document-view architecture.  
...
##  <a name="chtmleditdoc__getview"></a>  CHtmlEditDoc::GetView  
 Retrieves the [CHtmlEditView](../VS_csharp/chtmleditview-class.md) object attached to this document.  
