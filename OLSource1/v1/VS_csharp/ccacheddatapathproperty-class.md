...
### Remarks  
 The `COleControl` object pointed to by `pControl` is used by [Open](../VS_csharp/cdatapathproperty-class.md#cdatapathproperty__open) and retrieved by derived classes. If `pControl` is **NULL**, the control used with **Open** should be set with [SetControl](../VS_csharp/cdatapathproperty-class.md#cdatapathproperty__setcontrol). If `lpszPath` is **NULL**, you can pass in the path through **Open** or set it with [SetPath](../VS_csharp/cdatapathproperty-class.md#cdatapathproperty__setpath).  
...
## See Also  
 [Base Class](../VS_csharp/cdatapathproperty-class.md)   
