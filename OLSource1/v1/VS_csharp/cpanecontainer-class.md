...
|[CPaneContainer::Serialize](#cpanecontainer__serialize)|Reads or writes this object from or to an archive. (Overrides [CObject::Serialize](../VS_csharp/cobject-class.md#cobject__serialize).)|  
...
## Example  
 The following example demonstrates how to construct an instance of the `CPaneContainer` class. This code snippet is part of the [Set Pane Size sample](../VS_csharp/visual-c---samples.md).  
  
 [!code[NVC_MFC_SetPaneSize#2](../VS_csharp/codesnippet/CPP/cpanecontainer-class_1.h)]  
[!code[NVC_MFC_SetPaneSize#1](../VS_csharp/codesnippet/CPP/cpanecontainer-class_2.cpp)]  
