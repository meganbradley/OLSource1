...
-   [Initialize extension DLLs](../VS_csharp/initializing-extension-dlls.md)  
...
-   [Thread local storage wrappers (MFC Technical Note 58)](../VS_csharp/tn058--mfc-module-state-implementation.md)  
