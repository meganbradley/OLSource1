...
## Remarks  
 As with standard dialog boxes, you derive a class from `CPropertyPage` for each page in your property sheet. To use `CPropertyPage`-derived objects, first create a [CPropertySheet](../VS_csharp/cpropertysheet-class.md) object, and then create an object for each page that goes in the property sheet. Call [CPropertySheet::AddPage](../VS_csharp/cpropertysheet-class.md#cpropertysheet__addpage) for each page in the sheet, and then display the property sheet by calling [CPropertySheet::DoModal](../VS_csharp/cpropertysheet-class.md#cpropertysheet__domodal) for a modal property sheet, or [CPropertySheet::Create](../VS_csharp/cpropertysheet-class.md#cpropertysheet__create) for a modeless property sheet.  
 ...
 For more information on establishing a property sheet as a wizard, see [CPropertySheet::SetWizardMode](../VS_csharp/cpropertysheet-class.md#cpropertysheet__setwizardmode). For more information on using `CPropertyPage` objects, see the article [Property Sheets and Property Pages](../VS_csharp/property-sheets-and-property-pages-in-mfc.md).  
...
-   The page has been added to a property sheet using [CPropertySheet::AddPage](../VS_csharp/cpropertysheet-class.md#cpropertysheet__addpage).  
  
-   The property sheet's [DoModal](../VS_csharp/cpropertysheet-class.md#cpropertysheet__domodal) or [Create](../VS_csharp/cpropertysheet-class.md#cpropertysheet__create) function has been called.  
...
### Example  
 [!code[NVC_MFCDocView#112](../VS_csharp/codesnippet/CPP/cpropertypage-class_1.cpp)]  
...
-   The user has selected (tabbed to) this page.  
 ...
 If you have multiple parameters (for example, if you are using an array), use [CPropertySheet::Construct](../VS_csharp/cpropertysheet-class.md#cpropertysheet__construct) instead of `CPropertyPage`.  
  
### Example  
 [!code[NVC_MFCDocView#113](../VS_csharp/codesnippet/CPP/cpropertypage-class_2.cpp)]  
...
### Remarks  
 ...
 For more information on this structure, including a listing of its members, see **PROPSHEETPAGE** in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
  
### Example  
 [!code[NVC_MFCDocView#128](../VS_csharp/codesnippet/CPP/cpropertypage-class_3.cpp)]  
...
### Remarks  
 ...
 For more information about notification messages sent when the user presses the Apply Now or OK button in a property sheet, see                         [PSN_APPLY](http://msdn.microsoft.com/library/windows/desktop/bb774552) in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Example  
 [!code[NVC_MFCDocView#114](../VS_csharp/codesnippet/CPP/cpropertypage-class_4.cpp)]  
...
### Example  
 [!code[NVC_MFCDocView#115](../VS_csharp/codesnippet/CPP/cpropertypage-class_5.cpp)]  
...
### Remarks  
 When the user chooses either the OK or the Apply Now button, the framework receives the                         [PSN_APPLY](http://msdn.microsoft.com/library/windows/desktop/bb774552) notification from the property page. The call to `OnOK` won't be made if you call [CPropertySheet::PressButton](../VS_csharp/cpropertysheet-class.md#cpropertysheet__pressbutton) because the property page does not send the notification in that case.  
...
### Example  
 [!code[NVC_MFCDocView#116](../VS_csharp/codesnippet/CPP/cpropertypage-class_6.cpp)]  
...
### Example  
 [!code[NVC_MFCDocView#117](../VS_csharp/codesnippet/CPP/cpropertypage-class_7.cpp)]  
...
### Example  
  See the example for [CPropertySheet::SetFinishText](../VS_csharp/cpropertysheet-class.md#cpropertysheet__setfinishtext).  
...
### Remarks  
 ...
 For more information on how to make a wizard-type property sheet, see [CPropertySheet::SetWizardMode](../VS_csharp/cpropertysheet-class.md#cpropertysheet__setwizardmode).  
  
### Example  
 [!code[NVC_MFCDocView#118](../VS_csharp/codesnippet/CPP/cpropertypage-class_8.cpp)]  
...
### Remarks  
 ...
 For more information about notification messages sent when the user presses the Finish button in a wizard property sheet, see                         [PSN_WIZFINISH](http://msdn.microsoft.com/library/windows/desktop/bb774571) in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
  
 For more information on how to make a wizard-type property sheet, see [CPropertySheet::SetWizardMode](../VS_csharp/cpropertysheet-class.md#cpropertysheet__setwizardmode).  
  
### Example  
 [!code[NVC_MFCDocView#119](../VS_csharp/codesnippet/CPP/cpropertypage-class_9.cpp)]  
  
 [!code[NVC_MFCDocView#120](../VS_csharp/codesnippet/CPP/cpropertypage-class_10.cpp)]  
  
 [!code[NVC_MFCDocView#121](../VS_csharp/codesnippet/CPP/cpropertypage-class_11.cpp)]  
  
 [!code[NVC_MFCDocView#122](../VS_csharp/codesnippet/CPP/cpropertypage-class_12.cpp)]  
...
### Example  
 [!code[NVC_MFCDocView#123](../VS_csharp/codesnippet/CPP/cpropertypage-class_13.cpp)]  
...
### Example  
 [!code[NVC_MFCDocView#124](../VS_csharp/codesnippet/CPP/cpropertypage-class_14.cpp)]  
  
 [!code[NVC_MFCDocView#125](../VS_csharp/codesnippet/CPP/cpropertypage-class_15.cpp)]  
  
 [!code[NVC_MFCDocView#126](../VS_csharp/codesnippet/CPP/cpropertypage-class_16.cpp)]  
...
### Example  
 [!code[NVC_MFCDocView#127](../VS_csharp/codesnippet/CPP/cpropertypage-class_17.cpp)]  
...
## See Also  
 ...
 [CDialog](../VS_csharp/cdialog-class.md)   
 [CPropertySheet::SetWizardMode](../VS_csharp/cpropertysheet-class.md#cpropertysheet__setwizardmode)