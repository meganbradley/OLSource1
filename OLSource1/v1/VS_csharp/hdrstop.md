...
## Remarks  
 The *filename* is the name of the precompiled header file to use or create (depending on whether [/Yu](../VS_csharp/-yu--use-precompiled-header-file-.md) or [/Yc](../VS_csharp/-yc--create-precompiled-header-file-.md) is specified). If *filename* does not contain a path specification, the precompiled header file is assumed to be in the same directory as the source file.  
