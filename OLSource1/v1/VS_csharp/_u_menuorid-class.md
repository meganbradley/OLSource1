...
|Name|Description|  
|----------|-----------------|  
|[_U_MENUorID::_U_MENUorID](../VS_csharp/_u_menuorid--_u_menuorid.md)|The constructor.|  
  
### Public Data Members  
  
|Name|Description|  
|----------|-----------------|  
|[_U_MENUorID::m_hMenu](../VS_csharp/_u_menuorid--m_hmenu.md)|A handle to a menu.|  
