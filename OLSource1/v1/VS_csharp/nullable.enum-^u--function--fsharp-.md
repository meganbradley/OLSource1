...
#### Parameters  
 `value`  
 Type: <xref:System.Nullable`1*><[int32](../VS_csharp/core.int32-type-abbreviation--fsharp-.md)>  
...
## See Also  
 ...
 [Operators.enum<^U> Function (F#)](../VS_csharp/operators.enum-^u--function--fsharp-.md)   
 [Enumerations (F#)](../VS_csharp/enumerations--fsharp-.md)