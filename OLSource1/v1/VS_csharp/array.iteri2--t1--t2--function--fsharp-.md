...
#### Parameters  
 `action`  
 Type: [int](../VS_csharp/core.int-type-abbreviation--fsharp-.md) `-> 'T1 -> 'T2 ->` [unit](../VS_csharp/core.unit-type-abbreviation--fsharp-.md)  
...
## Example  
 The following code examples shows the differences between [Array.iter](../VS_csharp/array.iter--t--function--fsharp-.md), [Array.iter2](../VS_csharp/array.iter2--t1--t2--function--fsharp-.md), [Array.iteri](../VS_csharp/array.iteri--t--function--fsharp-.md), and `Array.iteri2`.  
  
 [!code[FsArrays#49](../VS_csharp/codesnippet/FSharp/array.iteri2--t1--t2--function--fsharp-_1.fs)]  
