...
|**WS_TABSTOP**|Specifies that the control can receive focus when the user presses the TAB key to move to it.|  
 ...
 ![Standard progress bar style](../VS_csharp/media/vc4ruw1.gif "vc4RUW1")  
  
 With `PBS_SMOOTH` and `PBS_VERTICAL` styles:  
  
 ![Progress bar style, smooth and vertical](../VS_csharp/media/vc4ruw2.gif "vc4RUW2")  
  
 For more information, see [Window Styles](../VS_csharp/frame-window-styles--mfc-.md) in the *MFC Reference*.  
