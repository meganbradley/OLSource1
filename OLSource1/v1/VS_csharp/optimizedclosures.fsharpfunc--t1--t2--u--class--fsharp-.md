...
|Member|Description|  
|------------|-----------------|  
|[new](../VS_csharp/optimizedclosures.fsharpfunc--t1--t2--u--constructor--fsharp-.md)|Construct an optimized function value that can accept two curried arguments without intervening execution.|  
  
## Instance Members  
  
|Member|Description|  
|------------|-----------------|  
|[Invoke](../VS_csharp/fsharpfunc.invoke--t1--t2--u--method--fsharp-.md)|Invoke the optimized function value with two curried arguments|  
  
## Static Members  
  
|Member|Description|  
|------------|-----------------|  
|[Adapt](../VS_csharp/fsharpfunc.adapt--t1--t2--u--method--fsharp-.md)|Adapt an F# first class function value to be an optimized function value that can accept two curried arguments without intervening execution.|  
