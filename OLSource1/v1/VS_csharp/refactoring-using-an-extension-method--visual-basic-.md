...
This example builds on the previous example, [Retrieving the Text of the Paragraphs (Visual Basic)](../VS_csharp/retrieving-the-text-of-the-paragraphs--visual-basic-.md), by refactoring the concatenation of strings using a pure function that is implemented as an extension method.  
...
## See Also  
 ...
 [Refactoring Into Pure Functions (Visual Basic)](../VS_csharp/refactoring-into-pure-functions--visual-basic-.md)