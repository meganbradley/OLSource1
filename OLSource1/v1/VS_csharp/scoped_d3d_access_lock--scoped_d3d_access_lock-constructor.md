...
## Construction  
 [1] Constructor  
 Acquires a D3D access lock on the given [accelerator_view](../VS_csharp/accelerator_view-class.md) object. Construction blocks until the lock is acquired.  
  
 [2] Constructor  
 Adopt a D3D access lock from the given [accelerator_view](../VS_csharp/accelerator_view-class.md) object.  
...
## See Also  
 [scoped_d3d_access_lock Class](../VS_csharp/scoped_d3d_access_lock-class.md)