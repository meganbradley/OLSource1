...
In Visual C++ .NET, you can set accelerator properties in the [Properties window](../VS_csharp/properties-window.md) at any time. You can also use the Accelerator editor to modify the accelerator properties in the accelerator table. Changes made using the Properties window or the Accelerator editor have the same result: edits are immediately reflected in the accelerator table.  
  
 There are three properties for each [accelerator ID](../VS_csharp/id-property.md):  
  
-   The [Modifier property](../VS_csharp/accelerator-modifier-property.md) sets control key combinations for the accelerator.  
...
-   The [Key property](../VS_csharp/accelerator-key-property.md) sets the actual key to use as the accelerator.  
  
-   The [Type property](../VS_csharp/accelerator-type-property.md) determines whether the key is interpreted as virtual (VIRTKEY) or ASCII/ANSI.  
...
## See Also  
 [Predefined Accelerator Keys](../VS_csharp/predefined-accelerator-keys.md)   
