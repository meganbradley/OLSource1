...
|`OLE_CHANGED_STATE`|Describes the state being entered (`emptyState`, **loadedState**, `openState`, `activeState`, or `activeUIState`).|  
 ...
 For more information about the states a client item can assume, see [Containers: Client-Item States](../VS_csharp/containers--client-item-states.md).  
...
## See Also  
 ...
 [Containers: Client-Item States](../VS_csharp/containers--client-item-states.md)   
