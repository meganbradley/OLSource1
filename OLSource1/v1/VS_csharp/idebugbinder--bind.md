...
#### Parameters  
 `pContainer`  
 [in] The [IDebugObject](../VS_csharp/idebugobject.md) that contains the child referenced by `pField`.  
  
 `pField`  
 [in] The [IDebugField](../VS_csharp/idebugfield.md) that represents the symbol.  
