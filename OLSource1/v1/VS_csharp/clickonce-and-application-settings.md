...
## Application Settings Files  
 ...
 In a ClickOnce application, the size of the configuration files used by application settings is constrained by the size of the ClickOnce cache. For more information, see [Architecture of the ClickOnce Cache](../VS_csharp/clickonce-cache-overview.md).  
...
## See Also  
 ...
 [Architecture of the ClickOnce Cache](../VS_csharp/clickonce-cache-overview.md)   
