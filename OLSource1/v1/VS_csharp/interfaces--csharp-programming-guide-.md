...
An interface contains definitions for a group of related functionalities that a [class](../VS_csharp/class--csharp-reference-.md) or a [struct](../VS_csharp/struct--csharp-reference-.md) can implement.  
  
 By using interfaces, you can, for example, include behavior from multiple sources in a class. That capability is important in C# because the language doesn't support multiple inheritance of classes. In addition, you must use an interface if you want to simulate inheritance for structs, because they can't actually inherit from another struct or class.  
  
 You define an interface by using the [interface](../VS_csharp/interface--csharp-reference-.md) keyword, as the following example shows.  
  
 [!code[csProgGuideInheritance#47](../VS_csharp/codesnippet/CSharp/interfaces--csharp-programming-guide-_1.cs)]  
 ...
 For more information about abstract classes, see [Abstract and Sealed Classes and Class Members](../VS_csharp/abstract-and-sealed-classes-and-class-members--csharp-programming-guide-.md).  
  
 Interfaces can contain methods, properties, events, indexers, or any combination of those four member types. For links to examples, see [Related Sections](../VS_csharp/interfaces--csharp-programming-guide-.md#BKMK_RelatedSections). An interface can't contain constants, fields, operators, instance constructors, destructors, or types. Interface members are automatically public, and they can't include any access modifiers. Members also can't be [static](../VS_csharp/static--csharp-reference-.md).  
 ...
 [!code[csProgGuideInheritance#48](../VS_csharp/codesnippet/CSharp/interfaces--csharp-programming-guide-_2.cs)]  
  
 Properties and indexers of a class can define extra accessors for a property or indexer that's defined in an interface. For example, an interface might declare a property that has a [get](../VS_csharp/get--csharp-reference-.md) accessor. The class that implements the interface can declare the same property with both a `get` and [set](../VS_csharp/set--csharp-reference-.md) accessor. However, if the property or indexer uses explicit implementation, the accessors must match. For more information about explicit implementation, see [Explicit Interface Implementation](../VS_csharp/explicit-interface-implementation--csharp-programming-guide-.md) and [Interface Properties (C# Programming Guide)](../VS_csharp/interface-properties--csharp-programming-guide-.md).  
 ...
 A base class can also implement interface members by using virtual members. In that case, a derived class can change the interface behavior by overriding the virtual members. For more information about virtual members, see [Polymorphism](../VS_csharp/polymorphism--csharp-programming-guide-.md).  
...
## In This Section  
 [Explicit Interface Implementation (Visual C#)](../VS_csharp/explicit-interface-implementation--csharp-programming-guide-.md)  
 ...
 [How to: Explicitly Implement Interface Members with Inheritance (C#)](../VS_csharp/how-to--explicitly-implement-members-of-two-interfaces--csharp-programming-guide-.md)  
...
-   [Interface Indexers](../VS_csharp/indexers-in-interfaces--csharp-programming-guide-.md)  
  
-   [How to: Declare an Event in an Interface and Implement it in a Class (C#)](../VS_csharp/how-to--implement-interface-events--csharp-programming-guide-.md)  
