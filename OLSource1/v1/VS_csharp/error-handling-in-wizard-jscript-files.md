...
When you create a wizard, your project includes the Default.js and Common.js files. Use these files to customize your project. See [The JScript File](../VS_csharp/jscript-file.md) for more information.  
...
3.  If the parameter **PREPROCESS_FUNCTION** is in [the .vsz file](../VS_csharp/.vsz-file--project-control-.md), the wizard calls [CanAddATLClass](../VS_csharp/jscript-functions-for-c---wizards.md). Use [SetErrorInfo](../VS_csharp/seterrorinfo.md) in case of failure and return **false**:  
