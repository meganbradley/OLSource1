...
Creates a path name from components. These are versions of [_makepath, _wmakepath](../VS_csharp/_makepath--_wmakepath.md) with security enhancements as described in [Security Enhancements in the CRT](../VS_csharp/security-features-in-the-crt.md).  
...
|`_tmakepath_s`|`_makepath_s`|`_makepath_s`|`_wmakepath_s`|  
 ...
 If path is `NULL`, the invalid parameter handler is invoked, as described in [Parameter Validation](../VS_csharp/parameter-validation.md). In addition, `errno` is set to `EINVAL`. `NULL` values are allowed for all other parameters.  
