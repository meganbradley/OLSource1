...
'method' should be declared 'static' and have exactly one parameter  
 ...
 When using the new syntax (**/clr**), see [User-Defined Operators](../VS_csharp/user-defined-operators--c---cli-.md) and [User-Defined Conversions](../VS_csharp/user-defined-conversions--c---cli-.md) for information on defining operators.  
