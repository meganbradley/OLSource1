...
---
# BLOB_NAME_LENGTH_STATUS
Used with `BEGIN_COLUMN_MAP` and `END_COLUMN_MAP` to bind a binary large object ([BLOB](https://msdn.microsoft.com/en-us/library/ms711511.aspx)). Similar to [BLOB_NAME](../VS_csharp/blob_name.md), except that this macro also gets the length and status of the BLOB data column.  
...
## See Also  
 ...
 [BLOB_NAME](../VS_csharp/blob_name.md)   
