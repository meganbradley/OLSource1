...
> [!TIP]
>  For additional procedures on implementing multiple views for a single document, see [CDocument::AddView](../Topic/CDocument::AddView.md) and the [COLLECT](../VS_csharp/visual-c---samples.md) MFC sample.  
...
##  <a name="vcconmodifyexistingapplicationa1"></a> Modify the Existing Application Class  
 ...
 [!code[NVC_MFCDocViewSDI#1](../VS_csharp/codesnippet/CPP/adding-multiple-views-to-a-single-document_1.h)]  
...
##  <a name="vcconattachnewviewa3"></a> Create and Attach the New View  
 ...
 [!code[NVC_MFCDocViewSDI#3](../VS_csharp/codesnippet/CPP/adding-multiple-views-to-a-single-document_3.cpp)]  
...
##  <a name="vcconswitchingfunctiona4"></a> Implement the Switching Function  
 ...
 [!code[NVC_MFCDocViewSDI#4](../VS_csharp/codesnippet/CPP/adding-multiple-views-to-a-single-document_4.cpp)]  
...
##  <a name="vcconswitchingtheviewa5"></a> Add Support for Switching the View  
 ...
 For more information on adding new menu items and command handler functions, see [Handlers for Commands and Control Notifications](../VS_csharp/handlers-for-commands-and-control-notifications.md).  
