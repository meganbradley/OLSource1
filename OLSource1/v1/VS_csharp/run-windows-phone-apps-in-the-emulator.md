...
2.  On the **Standard** toolbar, select one of the emulator options.  
     ...
     ![List of Windows Phone Emulator images](../VS_csharp/media/wp_emulator_list.png "WP_Emulator_list")  
...
3.  The right image displays the emulator screen after tapping the **Volume Up** button to increase the volume.  
 ...
 ![Buttons on the Windows Phone emulator](../VS_csharp/media/wp_emulator_buttons.png "WP_Emulator_buttons")  
...
-   Click **Delete** to delete a snapshot that you no longer need.  
 ...
 ![Checkpoints tab of the Windows Phone Emulator](../VS_csharp/media/wp_emulator_checkpoints.png "WP_Emulator_checkpoints")  
...
##  <a name="BKMK_tasks_shot"></a> Capture screenshots in the emulator  
 ...
 ![Screenshots from the Windows Phone Emulator](../VS_csharp/media/wp_emulator_screenshots.png "WP_Emulator_screenshots")  
