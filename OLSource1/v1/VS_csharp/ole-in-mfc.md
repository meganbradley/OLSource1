...
-   To manage the state data of MFC modules, including exported DLL function entry points, OLE/COM interface entry points, and window procedure entry points.  
 ...
 You can also use [Automation](../VS_csharp/automation.md) or [Remote Automation](../VS_csharp/remote-automation.md) to operate another program from your program.  
...
## In This Section  
 ...
 [Data Objects and Data Sources](../VS_csharp/data-objects-and-data-sources--ole-.md)  
 ...
 [OLE Menus and Resources](../VS_csharp/menus-and-resources--ole-.md)  
 ...
 [Trackers](../VS_csharp/trackers.md)  
...
## Related Sections  
 ...
 [Container/Server COM Components](../VS_csharp/containers--advanced-features.md)  
