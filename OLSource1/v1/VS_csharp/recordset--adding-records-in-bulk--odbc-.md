...
This topic applies to the MFC ODBC classes.  
 ...
 The MFC [CRecordset](../VS_csharp/crecordset-class.md) class has a new optimization that improves efficiency when you are adding new records in bulk to a table.  
