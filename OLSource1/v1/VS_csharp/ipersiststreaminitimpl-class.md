...
|Name|Description|  
|----------|-----------------|  
|[IPersistStreamInitImpl::GetClassID](../VS_csharp/ipersiststreaminitimpl--getclassid.md)|Retrieves the object's CLSID.|  
|[IPersistStreamInitImpl::GetSizeMax](../VS_csharp/ipersiststreaminitimpl--getsizemax.md)|Retrieves the size of the stream needed to save the object's data. The ATL implementation returns **E_NOTIMPL**.|  
|[IPersistStreamInitImpl::InitNew](../VS_csharp/ipersiststreaminitimpl--initnew.md)|Initializes a newly created object.|  
|[IPersistStreamInitImpl::IsDirty](../VS_csharp/ipersiststreaminitimpl--isdirty.md)|Checks whether the object's data has changed since it was last saved.|  
|[IPersistStreamInitImpl::Load](../VS_csharp/ipersiststreaminitimpl--load.md)|Loads the object's properties from the specified stream.|  
|[IPersistStreamInitImpl::Save](../VS_csharp/ipersiststreaminitimpl--save.md)|Saves the object's properties to the specified stream.|  
...
### Remarks  
 See [IPersistStreamInit::GetSizeMax](http://msdn.microsoft.com/library/windows/desktop/ms687287) in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Remarks  
 See [IPersistStreamInit::InitNew](http://msdn.microsoft.com/library/windows/desktop/ms690234) in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Remarks  
 See [IPersistStreamInit::IsDirty](http://msdn.microsoft.com/library/windows/desktop/ms680092) in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Remarks  
 ...
 See [IPersistStreamInit::Load](http://msdn.microsoft.com/library/windows/desktop/ms680730) in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Remarks  
 ...
 See [IPersistStreamInit::Save](http://msdn.microsoft.com/library/windows/desktop/ms694439) in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
