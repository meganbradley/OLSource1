...
### Parameters  
 ...
 `nCodePage`  
 The code page used to perform the conversion. See the code page parameter discussion for the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)] function [MultiByteToWideChar](http://msdn.microsoft.com/library/windows/desktop/dd319072) for more details.  
...
## See Also  
 ...
 [CA2CAEX Class](../VS_csharp/ca2caex-class.md)   
