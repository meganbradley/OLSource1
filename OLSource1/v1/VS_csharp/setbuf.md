...
---
# setbuf
Controls stream buffering. This function is deprecated; use [setvbuf](../VS_csharp/setvbuf.md) instead.  
...
## Remarks  
 ...
 `setbuf` has been replaced by [setvbuf](../VS_csharp/setvbuf.md), which is the preferred routine for new code. `setbuf` is retained for compatibility with existing code.  
