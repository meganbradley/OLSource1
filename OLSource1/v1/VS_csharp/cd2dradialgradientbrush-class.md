...
|[CD2DRadialGradientBrush::Create](#cd2dradialgradientbrush__create)|Creates a CD2DRadialGradientBrush. (Overrides [CD2DResource::Create](../VS_csharp/cd2dresource-class.md#cd2dresource__create).)|  
|[CD2DRadialGradientBrush::Destroy](#cd2dradialgradientbrush__destroy)|Destroys a CD2DRadialGradientBrush object. (Overrides [CD2DGradientBrush::Destroy](../VS_csharp/cd2dgradientbrush-class.md#cd2dgradientbrush__destroy).)|  
...
## Inheritance Hierarchy  
 ...
 [CD2DRadialGradientBrush](../VS_csharp/cd2dradialgradientbrush-class.md)  
