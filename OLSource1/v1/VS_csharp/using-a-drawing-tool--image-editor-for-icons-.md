...
The Image editor's freehand drawing and erasing tools all work in the same way: you select the tool and, if necessary, [select foreground and background colors](../VS_csharp/selecting-foreground-or-background-colors--image-editor-for-icons-.md) and size and shape options. You then move the pointer to the image and click or drag to draw and erase.  
...
1.  Click a button on the **Image Editor** toolbar.  
    ...
    -   The **Airbrush** tool randomly distributes color pixels around the center of the brush.  
        ...
        > [!TIP]
        >  Tool tips appear when you hover your cursor over the buttons on the [Image Editor toolbar](../VS_csharp/toolbar--image-editor-for-icons-.md). These tips will help you identify the specific buttons mentioned here.  
  
2.  If necessary, select colors and a brush:  
  
    -   In the [Colors palette](../VS_csharp/colors-window--image-editor-for-icons-.md), click the left mouse button to select a foreground color or the right mouse button to select a background color.  
  
    -   In the [Options Selector](../VS_csharp/toolbar--image-editor-for-icons-.md), click a shape representing the brush you want to use.  
...
## See Also  
 ...
 [Working with Color](../VS_csharp/working-with-color--image-editor-for-icons-.md)