...
```  
 ...
 To specify that functions cannot be overridden and that classes cannot be inherited, use the [final](../VS_csharp/final-specifier.md) keyword.  
  
## See Also  
 [final Specifier](../VS_csharp/final-specifier.md)   
