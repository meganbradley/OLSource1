...
### Code  
 [!code[FxCop.Design.EnumIntegralType#1](../VS_csharp/codesnippet/VisualBasic/ca1028--enum-storage-should-be-int32_1.vb)]
[!code[FxCop.Design.EnumIntegralType#1](../VS_csharp/codesnippet/CSharp/ca1028--enum-storage-should-be-int32_1.cs)]  
...
### Code  
 [!code[FxCop.Design.EnumIntegralTypeFixed#1](../VS_csharp/codesnippet/CSharp/ca1028--enum-storage-should-be-int32_2.cs)]
[!code[FxCop.Design.EnumIntegralTypeFixed#1](../VS_csharp/codesnippet/VisualBasic/ca1028--enum-storage-should-be-int32_2.vb)]  
  
## Related Rules  
 [Enums should have zero value](../VS_csharp/ca1008--enums-should-have-zero-value.md)  
  
 [Mark enums with FlagsAttribute](../VS_csharp/ca1027--mark-enums-with-flagsattribute.md)  
  
 [Do not mark enums with FlagsAttribute](../VS_csharp/ca2217--do-not-mark-enums-with-flagsattribute.md)  
  
 [Do not name enum values 'Reserved'](../VS_csharp/ca1700--do-not-name-enum-values--reserved-.md)  
  
 [Do not prefix enum values with type name](../VS_csharp/ca1712--do-not-prefix-enum-values-with-type-name.md)  
