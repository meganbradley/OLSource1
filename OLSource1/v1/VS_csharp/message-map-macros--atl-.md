...
|[CHAIN_MSG_MAP_DYNAMIC](../VS_csharp/chain_msg_map_dynamic.md)|Chains to the message map in another class at run time.|  
|[CHAIN_MSG_MAP_MEMBER](../VS_csharp/chain_msg_map_member.md)|Chains to the default message map in a data member of the class.|  
|[COMMAND_CODE_HANDLER](../VS_csharp/command_code_handler.md)|Maps a **WM_COMMAND** message to a handler function, based on the notification code.|  
...
|[COMMAND_RANGE_CODE_HANDLER](../VS_csharp/command_range_code_handler.md)|Maps a **WM_COMMAND** message to a handler function, based on the notification code and a contiguous range of control identifiers.|  
|[COMMAND_RANGE_HANDLER](../VS_csharp/command_range_handler.md)|Maps a **WM_COMMAND** message to a handler function, based on a contiguous range of control identifiers.|  
|[DECLARE_EMPTY_MSG_MAP](../VS_csharp/declare_empty_msg_map.md)|Implements an empty message map.|  
|[DEFAULT_REFLECTION_HANDLER](../VS_csharp/default_reflection_handler.md)|Provides a default handler for reflected messages that are not handled otherwise.|  
...
|[NOTIFY_RANGE_CODE_HANDLER](../VS_csharp/notify_range_code_handler.md)|Maps a **WM_NOTIFY** message to a handler function, based on the notification code and a contiguous range of control identifiers.|  
|[NOTIFY_RANGE_HANDLER](../VS_csharp/notify_range_handler.md)|Maps a **WM_NOTIFY** message to a handler function, based on a contiguous range of control identifiers.|  
|[REFLECT_NOTIFICATIONS](../VS_csharp/reflect_notifications.md)|Reflects notification messages back to the window that sent them.|  
