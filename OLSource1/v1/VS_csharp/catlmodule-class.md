...
## Remarks  
 This class is used by [CAtlDllModuleT Class](../VS_csharp/catldllmodulet-class.md), [CAtlExeModuleT Class](../VS_csharp/catlexemodulet-class.md), and [CAtlServiceModuleT Class](../VS_csharp/catlservicemodulet-class.md) to provide support for DLL applications, EXE applications, and Windows services, respectively.  
  
 For more information on modules in ATL, see [ATL Module Classes](../VS_csharp/atl-module-classes.md).  
  
 This class replaces the obsolete [CComModule Class](../VS_csharp/ccommodule-class.md) used in earlier versions of ATL.  
...
### Remarks  
 ...
 See the topic [Using Replaceable Parameters (The Registrar's Preprocessor)](../VS_csharp/using-replaceable-parameters--the-registrar-s-preprocessor-.md) for more details.  
