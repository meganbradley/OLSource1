...
**Microsoft Specific**  
 ...
 Throws a [_com_error](../VS_csharp/_com_error-class.md) in response to a failure.  
...
## Remarks  
 ...
 You can also use [_set_com_error_handler](../VS_csharp/_set_com_error_handler.md) to replace the default error-handling function.  
 ...
 **Lib:** If the “wchar_t is Native Type” compiler option is on, use comsuppw.lib or comsuppwd.lib. If “wchar_t is Native Type” is off, use comsupp.lib. For more information, see [/Zc:wchar_t (wchar_t Is Native Type)](../VS_csharp/-zc-wchar_t--wchar_t-is-native-type-.md).  
  
## See Also  
 [Compiler COM Global Functions](../VS_csharp/compiler-com-global-functions.md)   
 [_set_com_error_handler](../VS_csharp/_set_com_error_handler.md)