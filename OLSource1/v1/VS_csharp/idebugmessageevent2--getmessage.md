...
#### Parameters  
 `pMessageType`  
 [out] Returns a value from the [MESSAGETYPE](../VS_csharp/messagetype.md) enumeration that describes the type of the message.  
  
 `pbstrMessage`  
 [out] Returns the message.  
  
 `pdwType`  
 [out] Returns the type of the message, using the conventions of the Win32 `MessageBox` function. See the [AfxMessageBox](../VS_csharp/afxmessagebox.md) function for details.  
