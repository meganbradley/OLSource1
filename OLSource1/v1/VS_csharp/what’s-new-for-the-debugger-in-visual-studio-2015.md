...
## Visual Studio 2015 Update 1 Changes  
 C++ Edit and Continue supports more features. For more information, see [Edit and Continue (VIsual C++](../VS_csharp/edit-and-continue--visual-c---.md).  
  
 For debugging Visual C++ access violations, a new exception dialog specifies the pointer that caused the exception. For more information, please see [How Can I Debug an Access Violation?](../VS_csharp/how-can-i-debug-an-access-violation-.md) and [Improvement to Debugging C++ Access Violations in Visual Studio 2015 Update 1](http://blogs.msdn.com/b/visualstudioalm/archive/2015/10/29/improvement-to-debugging-c-access-violations-in-visual-studio-2015-update-1.aspx)  
...
1.  [Using Breakpoints](../VS_csharp/using-breakpoints.md)  
...
1.  [Exception Handling](../VS_csharp/managing-exceptions-with-the-debugger.md)  
