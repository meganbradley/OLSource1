...
-   [Build an app for Android, iOS, and Windows (.NET Framework)](#NET)  
    ...
    -   [Target Android, iOS, and Windows from a single code base](../VS_csharp/cross-platform-mobile-development-in-visual-studio.md#AndroidHTML)  
  
    -   [Target Windows 10 devices](../VS_csharp/cross-platform-mobile-development-in-visual-studio.md#WindowsHTML)  
...
##  <a name="NET"></a> Build an app for Android, iOS, and Windows (.NET Framework)  
 ![Devices](../VS_csharp/media/homedevices.png "HomeDevices")  
...
|[Get started with Xamarin in Visual Studio](../VS_csharp/visual-studio-and-xamarin.md) (MSDN Library)|  
|[Learn about Visual Studio Application Lifecycle Management (ALM) with Xamarin Apps](../VS_csharp/application-lifecycle-management--alm--with-xamarin-apps.md) (MSDN Library)|  
...
####  <a name="ShareHTML"></a> Share code between Android, iOS, and Windows apps  
 ...
 ![Share code between Windows, iOs, and Android UI's](../VS_csharp/media/sharecode.png "ShareCode")  
...
###  <a name="WindowsHTML"></a> Target Windows 10 devices  
 ![Windows Devices](../VS_csharp/media/windowsdevices.png "WindowsDevices")  
...
|[Develop apps for the Universal Windows Platform (UWP)](../VS_csharp/develop-apps-for-the-universal-windows-platform--uwp-.md)|  
|[Migrate apps to the Universal Windows Platform (UWP)](../Topic/Migrate%20apps%20to%20the%20Universal%20Windows%20Platform%20\(UWP\).md)|  
...
##  <a name="HTML"></a> Build an app for Android, iOS, and Windows (HTML/JavaScript)  
 ...
 ![Multi&#45;Device Hybrid Apps](../VS_csharp/media/multidevicehybridapps.png "MultiDeviceHybridApps")  
...
##  <a name="CPP"></a> Build an app for Android and Windows (C++)  
 ![Use C&#43;&#43; to build for Android, iOS, and Windows](../VS_csharp/media/cross_plat_cpp_intro_image.png "Cross_Plat_CPP_Intro_Image")  
 ...
 ![Native activity project template](../VS_csharp/media/cross-plat_cpp_native.png "Cross-Plat_CPP_Native")  
 ...
 ![Static and dynamic shared libraries](../VS_csharp/media/cross_plat_cpp_libraries.png "Cross_Plat_CPP_Libraries")  
...
##  <a name="Unity"></a> Build a cross-platform game for Android, iOS, and Windows by using Visual Studio tools for Unity  
 ...
 ![VSTU development environment](../VS_csharp/media/vstu_overview.png "VSTU_Overview")  
...
|[Read more about Visual Studio Tools for Unity](../VS_csharp/visual-studio-tools-for-unity.md) (MSDN Library)|  
|[Start using Visual Studio Tools for Unity](../VS_csharp/getting-started-with-visual-studio-tools-for-unity.md) (MSDN Library)|  
...
## See Also  
 ...
 [Application Insights](../Topic/Application%20Insights%20for%20Visual%20Studio%20Online.md)