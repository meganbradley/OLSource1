...
|Classes|Description|  
|-------------|-----------------|  
|[shared_mutex Class](../VS_csharp/-shared_mutex-.md#class_shared_mutex)|A shared mutex type that can be locked exclusively by one agent or shared non-exclusively by multiple agents.|  
|[shared_timed_mutex Class](../VS_csharp/-shared_mutex-.md#class_shared_timed_mutex)|A shared timed mutex type that can be locked exclusively by one agent or shared non-exclusively by multiple agents.|  
|[shared_lock Class](../VS_csharp/-shared_mutex-.md#class_shared_lock)|A template class that wraps a shared mutex to support timed lock operations and non-exclusive sharing by multiple agents.|  
  
|Functions|Description|  
|---------------|-----------------|  
|[swap Function](../VS_csharp/-shared_mutex-.md#function_swap)|Swaps the content of the shared mutex objects referenced by the function parameters.|  
