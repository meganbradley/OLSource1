...
## Prerequisites  
 Before you read this walkthrough, we highly recommended that you build and run the LinqToXmlDataBinding program as described in [How to: Build and Run the LinqToXmlDataBinding Example](../VS_csharp/how-to--build-and-run-the-linqtoxmldatabinding-example.md).  
...
|Topic|Description|  
|-----------|-----------------|  
|[L2DBForm.xaml Source Code](../VS_csharp/l2dbform.xaml-source-code.md)|Contains the contents and description of the XAML code in file L2DBForm.xaml.|  
|[L2DBForm.xaml.cs Source Code](../VS_csharp/l2dbform.xaml.cs-source-code.md)|Contains the contents and description of the C# source code in the file L2DBForm.xaml.cs.|  
  
## See Also  
 [WPF Data Binding using LINQ to XML Example](../VS_csharp/wpf-data-binding-using-linq-to-xml-example.md)   
 [How to: Build and Run the LinqToXmlDataBinding Example](../VS_csharp/how-to--build-and-run-the-linqtoxmldatabinding-example.md)