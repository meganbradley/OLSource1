...
> [!WARNING]
>  This switch is supported only for Visual Studio partner development, and is not available in Express editions. You must run devenv as an administrator in order to use the [/setup (devenv.exe)](../VS_csharp/-setup--devenv.exe-.md) and [/InstallVSTemplates (devenv.exe)](../VS_csharp/-installvstemplates--devenv.exe-.md) switches. For more information, see [User Permissions and Visual Studio](../VS_csharp/user-permissions-and-visual-studio.md).  
