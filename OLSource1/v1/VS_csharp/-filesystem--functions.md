...
These free functions in the [<filesystem\> (v3)](../VS_csharp/-filesystem-.md) header perform modifying and query operations on paths, files, symlinks, directories and volumes. For more information and code examples, see [File System Navigation](../VS_csharp/file-system-navigation.md).  
