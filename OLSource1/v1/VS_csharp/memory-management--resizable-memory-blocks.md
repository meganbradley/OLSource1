...
The **new** and **delete** operators, described in the article [Memory Management: Examples](../VS_csharp/memory-management--examples.md), are good for allocating and deallocating fixed-size memory blocks and objects. Occasionally, your application may need resizable memory blocks. You must use the standard C run-time library functions [malloc](../VS_csharp/malloc.md), [realloc](../VS_csharp/realloc.md), and [free](../VS_csharp/free.md) to manage resizable memory blocks on the heap.  
