...
The OLE DB consumer attributes inject code, based on the [OLE DB Consumer Templates](../VS_csharp/ole-db-consumer-templates-reference.md), to create a working OLE DB consumer that performs tasks such as opening tables, executing commands, and accessing data.  
