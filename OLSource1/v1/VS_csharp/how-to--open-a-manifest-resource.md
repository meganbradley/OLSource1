...
If you open a manifest resource from [Resource View](../VS_csharp/resource-view-window.md), the resource will open in binary format. To view the contents of a manifest resource in a more viewable format, you must open the resource from Solution Explorer.  
...
## See Also  
 [Manifest Resources](../VS_csharp/manifest-resources.md)   
