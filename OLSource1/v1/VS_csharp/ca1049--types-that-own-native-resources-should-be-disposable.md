...
## Example  
 ...
 [!code[FxCop.Design.UnmanagedResources#1](../VS_csharp/codesnippet/CSharp/ca1049--types-that-own-native-resources-should-be-disposable_1.cs)]
[!code[FxCop.Design.UnmanagedResources#1](../VS_csharp/codesnippet/VisualBasic/ca1049--types-that-own-native-resources-should-be-disposable_1.vb)]  
  
## Related Rules  
 [Call GC.KeepAlive when using native resources](../VS_csharp/ca2115--call-gc.keepalive-when-using-native-resources.md)  
  
 [Dispose methods should call SuppressFinalize](../VS_csharp/ca1816--call-gc.suppressfinalize-correctly.md)  
  
 [Disposable types should declare finalizer](../VS_csharp/ca2216--disposable-types-should-declare-finalizer.md)  
  
 [Types that own disposable fields should be disposable](../VS_csharp/ca1001--types-that-own-disposable-fields-should-be-disposable.md)  
