...
---
# strstream Class
Describes an object that controls insertion and extraction of elements and encoded objects using a stream buffer of class [strstreambuf](../VS_csharp/strstreambuf-class.md).  
...
> [!NOTE]
>  This class is deprecated. Consider using [stringstream](../VS_csharp/-sstream--typedefs.md#stringstream) or [wstringstream](../VS_csharp/-sstream--typedefs.md#wstringstream) instead.  
...
|[str](#strstream__str)|Calls [freeze](../VS_csharp/strstreambuf-class.md#strstreambuf__freeze), and then returns a pointer to the beginning of the controlled sequence.|  
...
### Remarks  
 The member function calls [rdbuf](#strstream__rdbuf) -> [freeze](../VS_csharp/strstreambuf-class.md#strstreambuf__freeze)(_                        *Freezeit*).  
  
### Example  
  See [strstreambuf::freeze](../VS_csharp/strstreambuf-class.md#strstreambuf__freeze) for an example that uses **freeze**.  
...
### Remarks  
 The member function returns [rdbuf](#strstream__rdbuf) -> [pcount](../VS_csharp/strstreambuf-class.md#strstreambuf__pcount).  
  
### Example  
  See [strstreambuf::pcount](../VS_csharp/strstreambuf-class.md#strstreambuf__pcount) for a sample of using pcount.  
...
### Remarks  
 The member function returns [rdbuf](#strstream__rdbuf) -> [str](../VS_csharp/strstreambuf-class.md#strstreambuf__str).  
  
### Example  
  See [strstreambuf::str](../VS_csharp/strstreambuf-class.md#strstreambuf__str) for a sample that uses **str**.  
...
### Parameters  
 ...
 `_Mode`  
 The input and output mode of the buffer. See [ios_base::openmode](../VS_csharp/ios_base-class.md#ios_base__openmode) for more information.  
  
 `_Ptr`  
 The buffer.  
  
### Remarks  
 Both constructors initialize the base class by calling [streambuf](../VS_csharp/-streambuf--typedefs.md#streambuf)( **sb**), where **sb** is the stored object of class [strstreambuf](../VS_csharp/strstreambuf-class.md). The first constructor also initializes **sb** by calling [strstreambuf](../VS_csharp/strstreambuf-class.md#strstreambuf__strstreambuf). The second constructor initializes the base class one of two ways:  
...
## See Also  
 [iostream](../VS_csharp/-istream--typedefs.md#iostream)   
