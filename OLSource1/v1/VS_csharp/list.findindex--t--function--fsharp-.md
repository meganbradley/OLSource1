...
## Example  
 The following code shows how to use `List.findIndex` and compares its behavior to that of [List.find](../VS_csharp/list.find--t--function--fsharp-.md).  
  
 [!code[FsLists#45](../VS_csharp/codesnippet/FSharp/list.findindex--t--function--fsharp-_1.fs)]  
