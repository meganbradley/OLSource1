...
##  <a name="_core_multiple_document_types"></a> Multiple Document Types  
 ...
 To create extra document classes, see [Adding a Class](../VS_csharp/adding-a-class--visual-c---.md). Choose [CDocument](../VS_csharp/cdocument-class.md) as the Class Type to derive from and supply the requested document information. Then implement the new class's data.  
  
 To let the framework know about your extra document class, you must add a second call to [AddDocTemplate](../Topic/CWinApp::AddDocTemplate.md) in your application class's [InitInstance](../Topic/CWinApp::InitInstance.md) override. For more information, see [Document Templates](../VS_csharp/document-templates-and-the-document-view-creation-process.md).  
...
-   View objects of different classes in a single frame window.  
 ...
 ![Multiple&#45;view user interfaces](../VS_csharp/media/vc37a71.gif "vc37A71")  
Multiple-View User Interfaces  
  
 The framework provides these models by implementing the New Window command and by providing class [CSplitterWnd](../VS_csharp/csplitterwnd-class.md), as discussed in [Splitter Windows](#_core_splitter_windows). You can implement other models using these as your starting point. For sample programs that illustrate different configurations of views, frame windows, and splitters, see [MFC Samples](../VS_csharp/visual-c---samples.md).  
  
 For more information about `UpdateAllViews`, see class [CView](../VS_csharp/cview-class.md) in the *MFC Reference* and the [Scribble sample](../VS_csharp/visual-c---samples.md).  
...
##  <a name="_core_splitter_windows"></a> Splitter Windows  
 ...
 For more information, see class [CSplitterWnd](../VS_csharp/csplitterwnd-class.md) in the *MFC Reference* and [MFC Samples](../VS_csharp/visual-c---samples.md).  
