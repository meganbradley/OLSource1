...
1.  Add two integer variables for the subtraction problem to your form, between the integer variables for the addition problem and the timer. The code should look like the following.  
     ...
     [!code[VbExpressTutorial3Step5_6#12](../VS_csharp/codesnippet/VisualBasic/step-6--add-a-subtraction-problem_1.vb)]
[!code[VbExpressTutorial3Step5_6#12](../VS_csharp/codesnippet/CSharp/step-6--add-a-subtraction-problem_1.cs)]  
...
2.  Add the following code after the "Fill in the subtraction problem" comment.  
     ...
     [!code[VbExpressTutorial3Step5_6#13](../VS_csharp/codesnippet/VisualBasic/step-6--add-a-subtraction-problem_2.vb)]
[!code[VbExpressTutorial3Step5_6#13](../VS_csharp/codesnippet/CSharp/step-6--add-a-subtraction-problem_2.cs)]  
     ...
     [!code[VbExpressTutorial3Step5_6#21](../VS_csharp/codesnippet/VisualBasic/step-6--add-a-subtraction-problem_3.vb)]
[!code[VbExpressTutorial3Step5_6#21](../VS_csharp/codesnippet/CSharp/step-6--add-a-subtraction-problem_3.cs)]  
     ...
     ![Intellisense window tooltip](../VS_csharp/media/express_overloads.png "Express_Overloads")  
Intellisense window tooltip  
     ...
     ![Overload for Next&#40;&#41; method in IntelliSense](../VS_csharp/media/express_nextoverload.png "Express_NextOverload")  
...
3.  Modify the `CheckTheAnswer()` method to check for the correct subtraction answer.  
     ...
     [!code[VbExpressTutorial3Step5_6#14](../VS_csharp/codesnippet/VisualBasic/step-6--add-a-subtraction-problem_4.vb)]
[!code[VbExpressTutorial3Step5_6#14](../VS_csharp/codesnippet/CSharp/step-6--add-a-subtraction-problem_4.cs)]  
...
4.  Replace the last part of the timer's Tick event handler with the following code so that it fills in the correct answer when time runs out.  
     ...
     [!code[VbExpressTutorial3Step5_6#22](../VS_csharp/codesnippet/VisualBasic/step-6--add-a-subtraction-problem_5.vb)]
[!code[VbExpressTutorial3Step5_6#22](../VS_csharp/codesnippet/CSharp/step-6--add-a-subtraction-problem_5.cs)]  
  
5.  Save and run your code.  
  
     Your program includes a subtraction problem, as the following illustration shows.  
  
     ![Math quiz with subtraction problem](../VS_csharp/media/express_addsubtract.png "Express_AddSubtract")  
Math quiz with subtraction problem  
  
### To continue or review  
  
-   To go to the next tutorial step, see [Step 7: Add Multiplication and Division Problems](../VS_csharp/step-7--add-multiplication-and-division-problems.md).  
  
-   To return to the previous tutorial step, see [Step 5: Add Click and Enter Event Handlers for the NumericUpDown Control](../VS_csharp/step-5--add-enter-event-handlers-for-the-numericupdown-controls.md).