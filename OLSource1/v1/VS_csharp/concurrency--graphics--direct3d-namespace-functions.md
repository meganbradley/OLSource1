...
##  <a name="get_texture_function"></a>  get_texture Function  
 Gets the Direct3D texture interface underlying the specified                 [texture](../VS_csharp/texture-class.md) object.  
...
##  <a name="make_texture_function"></a>  make_texture Function  
 Creates a                 [texture](../VS_csharp/texture-class.md) object by using the specified parameters.  
...
## See Also  
 [Concurrency::graphics::direct3d Namespace](../VS_csharp/concurrency--graphics--direct3d-namespace.md)