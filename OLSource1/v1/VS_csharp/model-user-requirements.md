...
|Additional documents or work items|Constraints and rules not specific to a particular use case|[Showing business rules](#BusinessRules)|  
 ...
 Notice that most of the diagram types can be used for other purposes. For an overview of diagram types, see [Overview of Modeling Diagrams](../VS_csharp/create-models-for-your-app.md). For basic information about drawing diagrams, see [How to: Create and Edit a UML Model](../VS_csharp/edit-uml-models-and-diagrams.md).  
...
##  <a name="UseCases"></a> Describing how your system is used  
 ...
 ![Use cases for Customer and Restaurant](../VS_csharp/media/uml_reqmuc1.png "UML_ReqmUC1")  
 ...
 ![System participates in payment but not delivery.](../VS_csharp/media/uml_reqmuc2.png "UML_ReqmUC2")  
 ...
 A use case diagram only provides a summary of the use cases. To provide more detailed descriptions, you can link the use cases on the diagram to separate documents, and to other diagrams. To learn how to do this, see [How to: Link Use Cases to Documents and Diagrams](../VS_csharp/link-a-use-case-to-documents-and-diagrams.md).  
...
|To learn about|Read|  
|--------------------|----------|  
|More detailed information about how to create use cases|[UML Use Case Diagrams: Guidelines](../VS_csharp/uml-use-case-diagrams--guidelines.md)|  
|Elements on a use case diagram|[UML Use Case Diagrams: Introduction](../VS_csharp/uml-use-case-diagrams--reference.md)|  
|How to develop code from use cases|[Modeling the Architecture of a Software System](../VS_csharp/model-your-app-s-architecture.md)|  
...
-   Descriptions of system or acceptance tests.  
 ...
 ![Classes Menu, Order, Menu Item, Order Item.](../VS_csharp/media/uml_reqmcd1.png "UML_ReqMCD1")  
...
|To learn about|Read|  
|--------------------|----------|  
|More detailed information about finding requirements classes|[UML Class Diagrams: Guidelines](../VS_csharp/uml-class-diagrams--guidelines.md)|  
|Elements on a conceptual class diagram|[UML Class Diagrams: Introduction](../VS_csharp/uml-class-diagrams--reference.md)|  
|How to develop code from conceptual classes|[Modeling the Architecture of a Software System](../VS_csharp/model-your-app-s-architecture.md)|  
  
 In a conceptual class diagram, it is typically not useful to place arrows on the associations to represent navigability. This is because the diagram does not represent an implementation. The associations represent relationships between real-world objects. The following [!INCLUDE[vsprvs](../VS_csharp/includes/vsprvs_md.md)] Extension make non-directional arrows the default: [Sample: UML Domain Modeling features](http://go.microsoft.com/fwlink/?LinkId=213849).  
...
##  <a name="BusinessRules"></a> Showing Business Rules  
 ...
 ![Rule in Comment attached to Order class.](../VS_csharp/media/uml_reqmcd2.png "UML_ReqmCD2")  
...
|To learn about|Read|  
|--------------------|----------|  
|More detailed information about finding and recording static business rules|[UML Class Diagrams: Guidelines](../VS_csharp/uml-class-diagrams--guidelines.md)|  
|Elements on a conceptual class diagram|[UML Class Diagrams: Introduction](../VS_csharp/uml-class-diagrams--reference.md)|  
|How to develop code that adheres to business rules|[Modeling the Architecture of a Software System](../VS_csharp/model-your-app-s-architecture.md)|  
...
|Attaching additional documents to use cases|[How to: Link a Use Case to Documents and Diagrams](../VS_csharp/link-a-use-case-to-documents-and-diagrams.md)|  
|How to develop code that adheres to quality of service requirements|[Modeling the Architecture of a Software System](../VS_csharp/model-your-app-s-architecture.md)|  
...
##  <a name="Workflow"></a> Showing work flow between users and your system  
 ...
 ![Activity with three actions and a loop.](../VS_csharp/media/uc_reqmwfact.png "UC_ReqmWFAct")  
 ...
 ![Use cases for previous actions](../VS_csharp/media/uml_reqmwfuc.png "UML_ReqmWFUC")  
...
|To learn about|Read|  
|--------------------|----------|  
|More information about how to define business work flows|[UML Activity Diagrams: Guidelines](../VS_csharp/uml-activity-diagrams--guidelines.md)|  
|Elements on an activity diagram|[UML Activity Diagrams: Introduction](../VS_csharp/uml-activity-diagrams--reference.md)|  
|How to develop code from activity diagrams|[Modeling the Architecture of a Software System](../VS_csharp/model-your-app-s-architecture.md)|  
...
##  <a name="Sequences"></a> Showing interactions between users and your system  
 ...
 ![Sequence diagram with System and actors.](../VS_csharp/media/uml_reqmseq.png "UML_ReqmSeq")  
...
|To learn about|Read|  
|--------------------|----------|  
|More information about how to define interactions|[UML Sequence Diagrams; Guidelines](../VS_csharp/uml-sequence-diagrams--guidelines.md)|  
|Elements on an sequence diagram|[UML Sequence Diagrams: Introduction](../VS_csharp/uml-sequence-diagrams--reference.md)|  
|How to develop code from sequence diagrams|[Modeling the Architecture of a Software System](../VS_csharp/model-your-app-s-architecture.md)|  
...
## See Also  
 ...
 [Using Requirements Models within the Development Process](../VS_csharp/use-models-in-your-development-process.md)   
