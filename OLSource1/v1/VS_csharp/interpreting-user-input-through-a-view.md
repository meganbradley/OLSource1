...
-   Windows [messages](../VS_csharp/messages.md) generated by mouse and keyboard actions.  
  
-   [Commands](../VS_csharp/user-interface-objects-and-command-ids.md) from menus, toolbar buttons, and accelerator keys.  
