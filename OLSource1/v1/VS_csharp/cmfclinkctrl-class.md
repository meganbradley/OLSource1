...
## Example  
 The following example demonstrates how to set the size of a `CMFCLinkCtrl` object, and how to set a url and a tooltip in a `CMFCLinkCtrl` object. This example is part of the [New Controls sample](../VS_csharp/visual-c---samples.md).  
  
 [!code[NVC_MFC_NewControls#9](../VS_csharp/codesnippet/CPP/cmfclinkctrl-class_1.h)]  
[!code[NVC_MFC_NewControls#10](../VS_csharp/codesnippet/CPP/cmfclinkctrl-class_2.cpp)]  
...
## Inheritance Hierarchy  
 ...
 [CMFCLinkCtrl](../VS_csharp/cmfclinkctrl-class.md)  
...
### Return Value  
 A [CSize](../VS_csharp/csize-class.md) object that contains the new size of the link control.  
...
## See Also  
 ...
 [CLinkCtrl Class](../VS_csharp/clinkctrl-class.md)   
 [CMFCButton](../VS_csharp/cmfcbutton-class.md)