...
1.  Create a command handler in a C# project as described in [How to Define a Menu Command on a Modeling Diagram](../VS_csharp/define-a-menu-command-on-a-modeling-diagram.md).  
...
5.  Build and run the project.  
     ...
     A new instance of [!INCLUDE[vsprvs](../VS_csharp/includes/vsprvs_md.md)] will start in experimental mode.  
  
6.  Create or open a UML class diagram in the experimental instance of [!INCLUDE[vsprvs](../VS_csharp/includes/vsprvs_md.md)].  
...
## See Also  
 ...
 [How to Define a Gesture Handler on a Modeling Diagram](../VS_csharp/define-a-gesture-handler-on-a-modeling-diagram.md)