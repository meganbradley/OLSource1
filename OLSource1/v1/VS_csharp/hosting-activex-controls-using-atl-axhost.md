...
The sample in this topic shows how to create AXHost and how to host an ActiveX control using various ATL functions. It also shows how to access the control and sink events (using [IDispEventImpl](../VS_csharp/idispeventimpl-class.md)) from the control that is hosted. The sample hosts the Calendar control in a main window or in a child window.  
...
|8|Main window|Multiple steps|AtlAxCreateControl|  
 ...
 [!code[NVC_ATL_AxHost#1](../VS_csharp/codesnippet/CPP/hosting-activex-controls-using-atl-axhost_1.cpp)]  
  
## See Also  
 [Control Containment FAQ](../VS_csharp/atl-control-containment-faq.md)   
 [AtlAxCreateControl](../VS_csharp/atlaxcreatecontrol.md)   
 [AtlAxCreateControlEx](../VS_csharp/atlaxcreatecontrolex.md)   
 [AtlAxCreateControlLic](../VS_csharp/atlaxcreatecontrollic.md)   
 [AtlAxCreateControlLicEx](../VS_csharp/atlaxcreatecontrollicex.md)   
 [CAxWindow2T Class](../VS_csharp/caxwindow2t-class.md)   
 [IAxWinHostWindowLic Interface](../VS_csharp/iaxwinhostwindowlic-interface.md)