...
|||  
|-|-|  
|[AtlHresultFromLastError](../VS_csharp/atlhresultfromlasterror.md)|Returns a                             `GetLastError` error code in the form of an HRESULT.|  
|[AtlHresultFromWin32](../VS_csharp/atlhresultfromwin32.md)|Converts a Win32 error code into an HRESULT.|  
|[AtlReportError](../VS_csharp/atlreporterror.md)|Sets up                             **IErrorInfo** to provide error details to a client.|  
|[AtlThrow](../VS_csharp/atlthrow.md)|Throws a                             `CAtlException`.|  
...
### Parameters  
 ...
 `hInst`  
 [in] The handle to the resource. By default, this parameter is                                 **__AtlBaseModuleModule::GetResourceInstance**, where                                 **__AtlBaseModuleModule** is the global instance of                                 [CAtlBaseModule](../VS_csharp/catlbasemodule-class.md) or a class derived from it.  
...
### Example  
 [!code[NVC_ATL_COM#52](../VS_csharp/codesnippet/CPP/debugging-and-error-reporting-global-functions_1.cpp)]  
...
### Remarks  
 ...
 If                         **_ATL_NO_EXCEPTIONS** is not defined in an MFC project, this function throws a                         [CMemoryException](../VS_csharp/cmemoryexception-class.md) or a                         [COleException](../VS_csharp/coleexception-class.md) based on the value of the HRESULT.  
  
 If                         **_ATL_NO_EXCEPTIONS** is not defined in an ATL project, the function throws a                         [CAtlException](../VS_csharp/catlexception-class.md).  
...
### Example  
 [!code[NVC_ATL_Windowing#95](../VS_csharp/codesnippet/CPP/debugging-and-error-reporting-global-functions_2.h)]  
...
### Remarks  
 ...
 If                         **_ATL_NO_EXCEPTIONS** is not defined in an MFC project, this function throws a                         [CMemoryException](../VS_csharp/cmemoryexception-class.md) or a                         [COleException](../VS_csharp/coleexception-class.md) based on the value returned by                         `GetLastError`.  
