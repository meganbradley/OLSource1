...
Async methods have three possible return types: <xref:System.Threading.Tasks.Task`1*>, <xref:System.Threading.Tasks.Task*>, and void. In Visual Basic, the void return type is written as a [Sub](../VS_csharp/sub-procedures--visual-basic-.md) procedure. For more information about async methods, see [Asynchronous Programming with Async and Await (Visual Basic)](../VS_csharp/asynchronous-programming-with-async-and-await--visual-basic-.md).  
...
##  <a name="BKMK_TaskTReturnType"></a> Task(T) Return Type  
 The <xref:System.Threading.Tasks.Task`1*> return type is used for an async method that contains a [Return](../VS_csharp/return-statement--visual-basic-.md) statement in which the operand has type `TResult`.  
...
##  <a name="BKMK_VoidReturnType"></a> Void Return Type  
 ...
 For more information about how to catch exceptions in async methods, see [Try...Catch...Finally Statement (Visual Basic)](../VS_csharp/try...catch...finally-statement--visual-basic-.md).  
...
## See Also  
 ...
 [Control Flow in Async Programs (Visual Basic)](../VS_csharp/control-flow-in-async-programs--visual-basic-.md)   
