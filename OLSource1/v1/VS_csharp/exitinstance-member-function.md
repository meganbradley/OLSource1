...
The [ExitInstance](../Topic/CWinApp::ExitInstance.md) member function of class [CWinApp](../VS_csharp/cwinapp-class.md) is called each time a copy of your application terminates, usually as a result of the user quitting the application.  
