...
---
# Code Snippet Picker
The [!INCLUDE[vsprvs](../VS_csharp/includes/vsprvs_md.md)] Code Editor provides a **Code Snippet Picker** that allows you, in a few mouse clicks, to insert ready-made blocks of code into the active document.  
  
 The procedure to display the **Code Snippet Picker** varies according to the language you are using.  
  
-   [!INCLUDE[vbprvb](../VS_csharp/includes/vbprvb_md.md)] - Right-click at the desired location in the Code Editor to display the Shortcut menu, and select **Insert Snippet**.  
  
-   [!INCLUDE[csprcs](../VS_csharp/includes/csprcs_md.md)] - Right-click at the desired location in the Code Editor to display the Shortcut menu, and click **Insert Snippet** or **Surround With**.  
  
-   [!INCLUDE[vcprvc](../VS_csharp/includes/vcprvc_md.md)] - The **Code Snippet Picker** is not available.  
  
-   Visual F# - The **Code Snippet Picker** is not available.  
  
-   [!INCLUDE[jsprjscript](../VS_csharp/includes/jsprjscript_md.md)] -- Right-click at the desired location in the Code Editor to display the Shortcut menu, and click **Insert Snippet** or **Surround With**.  
...
## See Also  
 [Best Practices for Using Code Snippets](../VS_csharp/best-practices-for-using-code-snippets.md)   
 [Introduction to IntelliSense Code Snippets](../VS_csharp/visual-basic-intellisense-code-snippets.md)   
 [Marking and Commenting Code](../VS_csharp/setting-bookmarks-in-code.md)   
