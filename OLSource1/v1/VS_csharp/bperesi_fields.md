...
## Members  
 ...
 Initialize/use the `bpResLocation` (breakpoint resolution location) field of the [BP_ERROR_RESOLUTION_INFO](../VS_csharp/bp_error_resolution_info.md) structure.  
...
## Remarks  
 Passed as a parameter to the [GetResolutionInfo](../VS_csharp/idebugerrorbreakpointresolution2--getresolutioninfo.md) method to indicate which fields of the [BP_ERROR_RESOLUTION_INFO](../VS_csharp/bp_error_resolution_info.md) structure are to be initialized.  
