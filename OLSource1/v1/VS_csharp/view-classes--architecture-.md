...
## Form and Record Views  
 ...
 [COLEDBRecordView](../VS_csharp/coledbrecordview-class.md)  
...
## Control Views  
 ...
 A view that contains a Windows list control (see [CListCtrl](../VS_csharp/clistctrl-class.md)). A list control displays icons and strings in a manner similar to the right pane of File Explorer.  
  
 [CTreeView](../VS_csharp/ctreeview-class.md)  
 A view that contains a Windows tree control (see [CTreeCtrl](../VS_csharp/ctreectrl-class.md)). A tree control displays icons and strings arranged in a hierarchy in a manner similar to the left pane of File Explorer.  
