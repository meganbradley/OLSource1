...
## Remarks  
 ...
 For more information on `CWinThread`, see the articles [Multithreading with C++ and MFC](../VS_csharp/multithreading-with-c---and-mfc.md), [Multithreading: Creating User-Interface Threads](../VS_csharp/multithreading--creating-user-interface-threads.md), [Multithreading: Creating Worker Threads](../VS_csharp/multithreading--creating-worker-threads.md), and [Multithreading: How to Use the Synchronization Classes](../VS_csharp/multithreading--how-to-use-the-synchronization-classes.md).  
...
### Remarks  
 To begin the thread's execution, call the [CreateThread](#cwinthread__createthread) member function. You will usually create threads by calling [AfxBeginThread](../VS_csharp/afxbeginthread.md), which will call this constructor and `CreateThread`.  
...
### Return Value  
 This function returns a pointer to one of two types of windows. If your thread is part of an OLE server and has an object that is in-place active inside an active container, this function returns the [CWinApp::m_pActiveWnd](../VS_csharp/cwinapp-class.md#cwinapp__m_pactivewnd) data member of the `CWinThread` object.  
...
-   **THREAD_PRIORITY_IDLE**  
 ...
 For more information on these priorities, see                         [SetThreadPriority](http://msdn.microsoft.com/library/windows/desktop/ms686277) in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Remarks  
 ...
 This member function is used only in user-interface threads. Perform initialization of worker threads in the controlling function passed to [AfxBeginThread](../VS_csharp/afxbeginthread.md).  
...
### Remarks  
 ...
 [!code[NVC_MFCDocView#189](../VS_csharp/codesnippet/CPP/cwinthread-class_1.cpp)]  
...
### Example  
  See the example for [AfxGetThread](../VS_csharp/afxgetthread.md).  
...
### Parameters  
 `pMsg`  
 Points to a [MSG](../VS_csharp/msg-structure.md) structure containing the message to process.  
 ...
 *e*  
 ...
 `pMsg`  
 Points to a [MSG](../VS_csharp/msg-structure.md) structure containing information about the windows message that caused the framework to throw an exception.  
