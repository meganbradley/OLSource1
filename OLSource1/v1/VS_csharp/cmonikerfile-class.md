...
## Remarks  
 ...
 For more information on streams and monikers, see [COleStreamFile](../VS_csharp/colestreamfile-class.md) in the                 *MFC Reference* and                 [IStream](http://msdn.microsoft.com/library/windows/desktop/aa380034) and                 [IMoniker](http://msdn.microsoft.com/library/windows/desktop/ms679705) in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Remarks  
 ...
 [!code[NVC_MFCWinInet#6](../VS_csharp/codesnippet/CPP/cmonikerfile-class_1.cpp)]  
  
 – or –  
  
 [!code[NVC_MFCWinInet#7](../VS_csharp/codesnippet/CPP/cmonikerfile-class_2.cpp)]  
  
## See Also  
 [Base Class](../VS_csharp/colestreamfile-class.md)   
