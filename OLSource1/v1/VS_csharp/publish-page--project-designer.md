 ...
 **Prerequisites**  
 Opens the [Prerequisites Dialog Box](../VS_csharp/prerequisites-dialog-box.md), which is used to specify prerequisite components, such as the .NET Framework, to be installed together with the application.  
...
## See Also  
 ...
 [How to: Publish a ClickOnce Application using the Publish Wizard](../VS_csharp/how-to--publish-a-clickonce-application-using-the-publish-wizard.md)   
 [How to: Specify Where Visual Studio Copies the Files](../VS_csharp/how-to--specify-where-visual-studio-copies-the-files.md)   
 [How to: Specify the Location Where End Users Will Install From](../VS_csharp/how-to--specify-the-location-where-end-users-will-install-from.md)   
 [How to: Specify a Link for Technical Support](../VS_csharp/how-to--specify-a-link-for-technical-support.md)   
 [How to: Specify the ClickOnce Offline or Online Install Mode](../VS_csharp/how-to--specify-the-clickonce-offline-or-online-install-mode.md)   
 [How to: Enable AutoStart for CD Installations](../VS_csharp/how-to--enable-autostart-for-cd-installations.md)   
 [How to: Set the ClickOnce Publish Version](../VS_csharp/how-to--set-the-clickonce-publish-version.md)   
 ...
 [How to: Specify Which Files Are Published by ClickOnce](../VS_csharp/how-to--specify-which-files-are-published-by-clickonce.md)   
 ...
 [How to: Manage Updates for a ClickOnce Application](../VS_csharp/how-to--manage-updates-for-a-clickonce-application.md)   
 [How to: Change the Publish Language for a ClickOnce Application](../VS_csharp/how-to--change-the-publish-language-for-a-clickonce-application.md)   
 [How to: Specify a Start Menu Name for a ClickOnce Application](../VS_csharp/how-to--specify-a-start-menu-name-for-a-clickonce-application.md)   
 [How to: Specify a Publish Page for a ClickOnce Application](../VS_csharp/how-to--specify-a-publish-page-for-a-clickonce-application.md)   
