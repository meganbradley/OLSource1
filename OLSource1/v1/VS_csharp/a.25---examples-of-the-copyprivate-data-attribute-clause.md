...
**Example 1:** The `copyprivate` clause ([Section 2.7.2.8](../VS_csharp/2.7.2.8-copyprivate.md) on page 32) can be used to broadcast values acquired by a single thread directly to all instances of the private variables in the other threads.  
