...
---
# rts_alloc Class
The rts_alloc template class describes a [filter](../VS_csharp/-allocators-.md) that holds an array of cache instances and determines which instance to use for allocation and deallocation at runtime instead of at compile time.  
...
|---------------|-----------------|  
|`Cache`|The type of cache instances contained in the array. This can be [cache_chunklist](../VS_csharp/cache_chunklist-class.md), [cache_freelist](../VS_csharp/cache_freelist-class.md), or [cache_suballoc](../VS_csharp/cache_suballoc-class.md).|  
...
## See Also  
 [ALLOCATOR_DECL](../VS_csharp/-allocators--functions.md#allocator_decl)   
