...
---
# File Status Code Enumerator
The `SccStatus` enumerator contains named constant values that specify the state of a file in the source control system. This enumeration is used by the [SccQueryInfo Function](../VS_csharp/sccqueryinfo-function.md) and the `POPLISTFUNC` callback function (see [POPLISTFUNC](../VS_csharp/poplistfunc.md) for details).  
...
## See Also  
 ...
 [SccQueryInfo Function](../VS_csharp/sccqueryinfo-function.md)   
