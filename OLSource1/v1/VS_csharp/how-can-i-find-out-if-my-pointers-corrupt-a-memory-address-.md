...
1.  Set a data breakpoint at 0x00408000. See [Set a data change breakpoint (native C++ only)](../VS_csharp/using-breakpoints.md#BKMK_Set_a_data_change_breakpoint__native_C___only_).  
  
2.  When you hit the breakpoint, use the **Memory** window to view memory contents starting at 0x00408000. For more information, see [Memory Windows](../VS_csharp/memory-windows.md).  
