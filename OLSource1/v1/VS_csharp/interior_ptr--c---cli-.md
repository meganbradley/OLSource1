...
### Remarks  
 ...
 For information on how to declare an interior pointer that points into an object that cannot be moved on the garbage-collected heap, see [pin_ptr](../VS_csharp/pin_ptr--c---cli-.md).  
  
 `interior_ptr` is in the cli namespace.  See [cli Namespace](../VS_csharp/platform--default--and-cli-namespaces---c---component-extensions-.md) for more information.  
  
 For more information on interior pointers, see  
  
-   [How to: Declare and Use Interior Pointers and Managed Arrays (C++/CLI)](../VS_csharp/how-to--declare-and-use-interior-pointers-and-managed-arrays--c---cli-.md)  
  
-   [How to: Declare Value Types with the interior_ptr Keyword (C++/CLI)](../VS_csharp/how-to--declare-value-types-with-the-interior_ptr-keyword--c---cli-.md)  
  
-   [How to: Overload Functions with Interior Pointers and Native Pointers (C++/CLI)](../VS_csharp/how-to--overload-functions-with-interior-pointers-and-native-pointers--c---cli-.md)  
  
-   [How to: Declare Interior Pointers with the const Keyword (C++/CLI)](../VS_csharp/how-to--declare-interior-pointers-with-the-const-keyword--c---cli-.md)  
