...
Make sure that your software system meets users' needs by using the visualization and modeling tools in Visual Studio. Use tools such as Unified Modeling Language (UML) diagrams, code maps, layer diagrams, and class diagrams to:  
 ...
 To see which versions of Visual Studio support each tool, see [Version support for architecture and modeling tools](../VS_csharp/what-s-new-for-design-in-visual-studio.md#VersionSupport).  
...
-   [Exploring Existing Code](../VS_csharp/visualize-code.md)  
  
-   [Developing Models for Software Design](../VS_csharp/create-models-for-your-app.md)  
...
-   [How to: Create UML Modeling Projects and Diagrams](../VS_csharp/create-uml-modeling-projects-and-diagrams.md)  
  
-   [How to: Create Layer Diagrams from Artifacts](../VS_csharp/create-layer-diagrams-from-your-code.md)  
  
-   [Map dependencies across your code](../VS_csharp/map-dependencies-across-your-solutions.md)  
  
-   [How to: Add Class Diagrams to Projects (Class Designer)](../VS_csharp/how-to--add-class-diagrams-to-projects--class-designer-.md)  
  
-   [Domain-Specific Languages](../VS_csharp/modeling-sdk-for-visual-studio---domain-specific-languages.md)  
  
 To show alternate views of the architecture, you can reuse certain elements from the same model on multiple or different diagrams. For example, you can drag a component to another component diagram or to a sequence diagram so that it can function as an actor. See [How to: Edit a UML Model and Diagrams](../VS_csharp/edit-uml-models-and-diagrams.md).  
...
-   [How to: Validate Code Against Layer Diagrams](../VS_csharp/validate-code-with-layer-diagrams.md)  
    ...
    > [!NOTE]
    >  Some versions of Visual Studio support layer validation and read-only versions of code maps and UML diagrams for visualization and modeling. To see which versions of Visual Studio support this feature, see [Version support for architecture and modeling tools](../VS_csharp/what-s-new-for-design-in-visual-studio.md#VersionSupport).  
...
|**Diagram**|**Describes**|  
|-----------------|-------------------|  
|*Use case diagram (UML)*<br /><br /> See:<br /><br /> -   [UML Use Case Diagrams: Reference](../VS_csharp/uml-use-case-diagrams--reference.md)<br />-   [UML Use Case Diagrams: Guidelines](../VS_csharp/uml-use-case-diagrams--guidelines.md)|-   The activities that the Dinner Now system supports<br />-   The people and external systems that perform the activities<br />-   The major components of the system that support each activity<br />-   The parts of the business process that are outside the scope of the current system, for example, food delivery|  
|*Activity diagram (UML)*<br /><br /> See:<br /><br /> -   [UML Activity Diagrams: Reference](../VS_csharp/uml-activity-diagrams--reference.md)<br />-   [UML Activity Diagrams: Guidelines](../VS_csharp/uml-activity-diagrams--guidelines.md)|The flow of steps that occur when a customer creates an order|  
|*Class diagram (UML)*<br /><br /> See:<br /><br /> -   [UML Class Diagrams: Reference](../VS_csharp/uml-class-diagrams--reference.md)<br />-   [UML Class Diagrams: Guidelines](../VS_csharp/uml-class-diagrams--guidelines.md)|The business entities and terms that used in discussion and the relationships between those entities. For example, Order and Menu Item are part of the vocabulary in this scenario.|  
 ...
 ![UML Use Case Diagram](../VS_csharp/media/uml_usecase.png "UML_UseCase")  
 ...
 **UML Use Case Diagram**  
 ...
 ![UML Activity Diagram](../VS_csharp/media/uml_dinnernowprocess.png "UML_DinnerNowProcess")  
  
 **UML Activity Diagram**  
  
 The following class diagram describes the entities that participate in the order process:  
  
 ![UML Class Diagram](../VS_csharp/media/uml_dinnerorders.png "UML_DinnerOrders")  
...
|**Diagram**|**Describes**|  
|-----------------|-------------------|  
|*Use case diagram (UML)*<br /><br /> See:<br /><br /> -   [UML Use Case Diagrams: Reference](../VS_csharp/uml-use-case-diagrams--reference.md)<br />-   [UML Use Case Diagrams: Guidelines](../VS_csharp/uml-use-case-diagrams--guidelines.md)|A new use case for "Write a restaurant review"|  
|*Activity diagram (UML)*<br /><br /> See:<br /><br /> -   [UML Activity Diagrams: Reference](../VS_csharp/uml-activity-diagrams--reference.md)<br />-   [UML Activity Diagrams: Guidelines](../VS_csharp/uml-activity-diagrams--guidelines.md)|The steps that occur when a customer wants to write a restaurant review|  
|*Class diagram (UML)*<br /><br /> See:<br /><br /> -   [UML Class Diagrams: Reference](../VS_csharp/uml-class-diagrams--reference.md)<br />-   [UML Class Diagrams: Guidelines](../VS_csharp/uml-class-diagrams--guidelines.md)|The data that is required to store a review|  
 ...
 ![UML Use Case Diagram](../VS_csharp/media/uml_writerev.png "UML_WriteRev")  
  
 **UML use case diagram**  
  
 The following activity diagram includes new elements in orange to describe the flow of steps in the new use case:  
  
 ![UML Activity Diagram](../VS_csharp/media/uml_writereview.png "UML_WriteReview")  
 ...
 **UML activity diagram**  
 ...
 ![UML Class Diagram](../VS_csharp/media/uml_dinnerreviews.png "UML_DinnerReviews")  
...
-   [How to: Validate a UML Model](../VS_csharp/validate-your-uml-model.md)  
...
|------------------------|---------------|  
|*Code map*<br /><br /> See:<br /><br /> -   [Map dependencies across your solutions](../VS_csharp/map-dependencies-across-your-solutions.md)<br />-   [Browse and rearrange code maps](../VS_csharp/browse-and-rearrange-code-maps.md)<br />-   [Customize code maps by editing the DGML files](../VS_csharp/customize-code-maps-by-editing-the-dgml-files.md)|Dependencies and other relationships in code.<br /><br /> For example, Dinner Now might start by reviewing assembly code maps for an overview of the assemblies and their dependencies. They can drill into the maps to explore the namespaces and classes in those assemblies.<br /><br /> Dinner Now can also create maps to explore particular areas and other kinds of relationships in the code. They use Solution Explorer to find and select the areas and relationships that interest them.|  
|*Code-based class diagram*<br /><br /> See [How to: Add Class Diagrams to Projects (Class Designer)](../VS_csharp/how-to--add-class-diagrams-to-projects--class-designer-.md).|Existing classes in code|  
 ...
 ![Namespace Dependency Graph](../VS_csharp/media/namespace_reviewsystem.png "Namespace_ReviewSystem")  
  
 **Namespace code map**  
  
 The developer expands the selected namespaces to see their classes, methods, and relationships:  
  
 ![Expanded namespace dependency graph](../VS_csharp/media/dep_reviewsystem.png "Dep_ReviewSystem")  
  
 **Expanded namespace code map with visible cross-group links**  
  
 The developer examines the code to find the affected classes and methods. To see the effects of each change as you make them, regenerate code maps after each change. See [Exploring Existing Code](../VS_csharp/visualize-code.md).  
...
|**Diagrams**|**Describes**|  
|------------------|-------------------|  
|*Activity diagram (UML)*<br /><br /> See:<br /><br /> -   [UML Activity Diagrams: Reference](../VS_csharp/uml-activity-diagrams--reference.md)<br />-   [UML Activity Diagrams: Guidelines](../VS_csharp/uml-activity-diagrams--guidelines.md)|The flow of steps that occur when the system notices that a customer places an order from a restaurant again, prompting the customer to write a review.|  
|*Class diagram (UML)*<br /><br /> See:<br /><br /> -   [UML Class Diagrams: Reference](../VS_csharp/uml-class-diagrams--reference.md)<br />-   [UML Class Diagrams: Guidelines](../VS_csharp/uml-class-diagrams--guidelines.md)|Logical classes and their relationships. For example, a new class is added to describe a **Review** and its relationships with other entities, such as **Restaurant**, **Menu**, and **Customer**.<br /><br /> To associate reviews with a customer, the system must store customer details. A UML class diagram can help clarify those details.|  
|*Code-based class diagram*<br /><br /> See [How to: Add Class Diagrams to Projects (Class Designer)](../VS_csharp/how-to--add-class-diagrams-to-projects--class-designer-.md).|Existing classes in code.|  
|*Component diagram (UML)*<br /><br /> See:<br /><br /> -   [UML Component Diagrams: Reference](../VS_csharp/uml-component-diagrams--reference.md)<br />-   [UML Component Diagrams: Guidelines](../VS_csharp/uml-component-diagrams--guidelines.md)|The high-level parts of the system, such as the Dinner Now Web site, and their interfaces. These interfaces define how components interact with each another through the methods or services that they provide and consume.|  
|*Sequence diagram (UML)*<br /><br /> See:<br /><br /> -   [UML Sequence Diagrams: Reference](../VS_csharp/uml-sequence-diagrams--reference.md)<br />-   [UML Sequence Diagrams: Guidelines](../VS_csharp/uml-sequence-diagrams--guidelines.md)|The sequence of interactions between instances.|  
 ...
 ![UML Component Diagram](../VS_csharp/media/uml_internal.png "UML_Internal")  
 ...
 **UML component diagram**  
 ...
 ![UML Sequence Diagram](../VS_csharp/media/uml_revsystem.png "UML_RevSystem")  
...
|*Layer diagram*<br /><br /> See:<br /><br /> -   [How to: Create Layer Diagrams from Artifacts](../VS_csharp/create-layer-diagrams-from-your-code.md)<br />-   [Layer Diagrams: Reference](../VS_csharp/layer-diagrams--reference.md)<br />-   [Layer Diagrams: Guidelines](../VS_csharp/layer-diagrams--guidelines.md)<br />-   [How to: Validate Code Against Layer Diagrams](../VS_csharp/validate-code-with-layer-diagrams.md)|The logical architecture of the code.<br /><br /> A layer diagram organizes and maps the artifacts in a [!INCLUDE[vsprvs](../VS_csharp/includes/vsprvs_md.md)] solution to abstract groups called *layers*. These layers identify the roles, tasks, or functions that these artifacts perform in the system.<br /><br /> Layer diagrams are useful for describing the intended design of the system and validating evolving code against that design.<br /><br /> To create layers, drag items from Solution Explorer, code maps, Class View, and Object Browser. To draw new layers, use the toolbox or right-click the diagram surface.<br /><br /> To view existing dependencies, right-click the layer diagram surface, and then click **Generate Dependencies**. To specify intended dependencies, draw new dependencies.|  
 ...
 ![Layer diagram of integrated payment system](../VS_csharp/media/layer_integrated_dnlucerne.png "Layer_Integrated_DNLucerne")  
...
-   Visual Studio supports UML 2.1.2. This overview describes only the major features of the UML diagrams in this release, but there are many books that discuss UML and its use in detail.  
 ...
 See [Developing Models for Software Design](../VS_csharp/create-models-for-your-app.md).  
...
-   [How to: Link Work Items to Model Elements](../VS_csharp/link-model-elements-and-work-items.md)  
...
-   [Using Models in the Development Process](../VS_csharp/use-models-in-your-development-process.md)  
  
-   [Modeling User Requirements](../VS_csharp/model-user-requirements.md)  
  
-   [Modeling the Architecture of a Software System](../VS_csharp/model-your-app-s-architecture.md)  
...
-   The External Payment Processor Gateway, which the Dinner Now Payment System uses to validate payments, is out of scope for the Web site.  
 ...
 ![Highlighting Process Payment on a use case diagram](../VS_csharp/media/uml_processpay.png "UML_ProcessPay")  
 ...
 **Highlighting Process Payment on the use case diagram**  
 ...
 ![Rescoping Pay Restaurant on the use case diagram](../VS_csharp/media/uml_payrestaurant.png "UML_PayRestaurant")  
  
 **Rescoping Pay Restaurant on the use case diagram**  
  
 See:  
  
-   [UML Use Case Diagrams: Reference](../VS_csharp/uml-use-case-diagrams--reference.md)  
  
-   [UML Use Case Diagrams: Guidelines](../VS_csharp/uml-use-case-diagrams--guidelines.md)  
...
|**Diagram**|**Describes**|  
|-----------------|-------------------|  
|Activity diagram|The flow of steps in a use case and those who perform those steps in that use case.<br /><br /> The names of use cases frequently mirror the steps in an activity diagram. Activity diagrams support elements such as decisions, merges, inputs and outputs, concurrent flows, and so on.<br /><br /> See:<br /><br /> -   [UML Activity Diagrams: Reference](../VS_csharp/uml-activity-diagrams--reference.md)<br />-   [UML Activity Diagrams: Guidelines](../VS_csharp/uml-activity-diagrams--guidelines.md)|  
|Sequence diagram|The sequence of interactions between the participants in a use case.<br /><br /> See:<br /><br /> -   [UML Sequence Diagrams: Reference](../VS_csharp/uml-sequence-diagrams--reference.md)<br />-   [UML Sequence Diagrams: Guidelines](../VS_csharp/uml-sequence-diagrams--guidelines.md)|  
|Class diagram (UML)|The entities or types that participate in the use case.<br /><br /> See:<br /><br /> -   [UML Class Diagrams: Reference](../VS_csharp/uml-class-diagrams--reference.md)<br />-   [UML Class Diagrams: Guidelines](../VS_csharp/uml-class-diagrams--guidelines.md)|  
...
###  <a name="UnderstandActivities"></a> Understand the Business Process: Activity Diagrams  
 ...
 ![Lucerne payment system on activity diagram](../VS_csharp/media/uml_lucerne.png "UML_Lucerne")  
...
-   [UML Activity Diagrams: Reference](../VS_csharp/uml-activity-diagrams--reference.md)  
  
-   [UML Activity Diagrams: Guidelines](../VS_csharp/uml-activity-diagrams--guidelines.md)  
...
|**Diagram**|**Description**|  
|-----------------|---------------------|  
|Use case diagram|Summarize the activities that each actor performs.<br /><br /> See:<br /><br /> -   [UML Use Case Diagrams: Reference](../VS_csharp/uml-use-case-diagrams--reference.md)<br />-   [UML Use Case Diagrams: Guidelines](../VS_csharp/uml-use-case-diagrams--guidelines.md)|  
|Component diagram|Visualize the system as a collection of reusable parts that provide or consume behavior through a well-defined set of interfaces.<br /><br /> See:<br /><br /> -   [UML Component Diagrams: Reference](../VS_csharp/uml-component-diagrams--reference.md)<br />-   [UML Component Diagrams: Guidelines](../VS_csharp/uml-component-diagrams--guidelines.md)|  
...
###  <a name="DescribeComponents"></a> Describe the System Structure: Component Diagrams  
 ...
 ![External components in the payment system](../VS_csharp/media/uml_extdnpayment.png "UML_ExtDNPayment")  
...
-   PaymentProcessing  
 ...
 ![Components inside Dinner Now Web site](../VS_csharp/media/uml_dinnernow.png "UML_DinnerNow")  
...
-   [UML Component Diagrams: Reference](../VS_csharp/uml-component-diagrams--reference.md)  
  
-   [UML Component Diagrams: Guidelines](../VS_csharp/uml-component-diagrams--guidelines.md)  
...
|**Diagram**|**Description**|  
|-----------------|---------------------|  
|Code map|Visualize the organization and relationships in existing code.<br /><br /> To identify candidates for components, create a code map and group items by their function in the system.<br /><br /> See:<br /><br /> -   [Map dependencies across your solutions](../VS_csharp/map-dependencies-across-your-solutions.md)|  
|Sequence diagram|Visualize the sequence of interactions between components or the parts inside a component.<br /><br /> To create a lifeline on a sequence diagram from a component, right-click the component, and then click **Create Lifeline**.<br /><br /> See:<br /><br /> -   [UML Sequence Diagrams: Reference](../VS_csharp/uml-sequence-diagrams--reference.md)<br />-   [UML Sequence Diagrams: Guidelines](../VS_csharp/uml-sequence-diagrams--guidelines.md)|  
|Class diagram (UML)|Define the interfaces on the provided or required ports and the classes that implement the functionality of the components.<br /><br /> See:<br /><br /> -   [UML Class Diagrams: Reference](../VS_csharp/uml-class-diagrams--reference.md)<br />-   [UML Class Diagrams: Guidelines](../VS_csharp/uml-class-diagrams--guidelines.md)|  
...
|Activity diagram|Visualize the internal processing that components perform in response to incoming messages.<br /><br /> See:<br /><br /> -   [UML Activity Diagrams: Reference](../VS_csharp/uml-activity-diagrams--reference.md)<br />-   [UML Activity Diagrams: Guidelines](../VS_csharp/uml-activity-diagrams--guidelines.md)|  
...
-   Find areas of complexity, natural layers or patterns, or other areas that might benefit from improvement.  
 ...
 ![Dependency graph for Dinner Now payment system](../VS_csharp/media/dep_dnpayment.png "Dep_DNPayment")  
 ...
 **Code map for Dinner Now payment system**  
 ...
 ![Methods inside PaymentProcessing and dependencies](../VS_csharp/media/depgraph_expandeddn.png "DepGraph_ExpandedDN")  
 ...
 **Methods inside PaymentProcessing class and their dependencies**  
 ...
 ![Dependency graph for Lucerne payment system](../VS_csharp/media/depgraph_lucernepay.png "DepGraph_LucernePay")  
 ...
 **Code map for Lucerne Payment System**  
 ...
 ![Dependency graph with reorganized code](../VS_csharp/media/depgraph_integrated.png "DepGraph_Integrated")  
...
-   To explore specific code or solution items, use Solution Explorer to select items and relationships that you want to visualize. You can then either generate a new map or add selected items to an existing map. See [How to: Visualize Code on Code Maps](../VS_csharp/map-dependencies-across-your-solutions.md).  
  
-   To help you explore the map, rearrange the layout so that it suits the kinds of tasks that you want to perform.  
  
     For example, to visualize layering in the code, select a tree layout. See [How to: Browse and Rearrange Code Maps](../VS_csharp/browse-and-rearrange-code-maps.md).  
...
|Class diagram (code-based)|Existing classes in code for a specific project.<br /><br /> To visualize and modify an existing class in code, use Class Designer.<br /><br /> See [How to: Add Class Diagrams to Projects (Class Designer)](../VS_csharp/how-to--add-class-diagrams-to-projects--class-designer-.md).|  
...
###  <a name="DescribeSequence"></a> Describe the Interactions: Sequence Diagrams  
 ...
 ![Sequence diagram for Process Payment use case](../VS_csharp/media/umlsequence_processpayment.png "UMLSequence_ProcessPayment")  
...
-   [UML Sequence Diagrams: Reference](../VS_csharp/uml-sequence-diagrams--reference.md)  
  
-   [UML Sequence Diagrams: Guidelines](../VS_csharp/uml-sequence-diagrams--guidelines.md)  
...
###  <a name="DefineClasses"></a> Define a Glossary of Types: Class Diagrams  
 ...
 ![Process Payment entities on the class diagram](../VS_csharp/media/uml_payentities.png "UML_PayEntities")  
 ...
 **Process Payment entities on a class diagram**  
 ...
 ![Process Payment entity details on a class diagram](../VS_csharp/media/uml_payment.png "UML_Payment")  
  
 **Process Payment details on the class diagram**  
  
 See:  
  
-   [UML Class Diagrams: Reference](../VS_csharp/uml-class-diagrams--reference.md)  
...
-   A common glossary of terms to use when discussing the users' needs and the entities that participate in the system. See [Modeling User Requirements](../VS_csharp/model-user-requirements.md).  
  
-   Types that are used by parts of the system, such as components, regardless of their implementation. See [Modeling the Architecture of a Software System](../VS_csharp/model-your-app-s-architecture.md).  
...
|**Diagram**|**Description**|  
|-----------------|---------------------|  
|Use case diagram|Define the types that are used to describe goals and steps in use cases.<br /><br /> See:<br /><br /> -   [UML Use Case Diagrams: Reference](../VS_csharp/uml-use-case-diagrams--reference.md)<br />-   [UML Use Case Diagrams: Guidelines](../VS_csharp/uml-use-case-diagrams--guidelines.md)|  
|Activity diagram|Define the types of data that pass through object nodes, input pins, output pins, and activity parameter nodes.<br /><br /> See:<br /><br /> -   [UML Activity Diagrams: Reference](../VS_csharp/uml-activity-diagrams--reference.md)<br />-   [UML Activity Diagrams: Guidelines](../VS_csharp/uml-activity-diagrams--guidelines.md)|  
...
|Code map|Visualize the organization and relationships in existing code.<br /><br /> To identify classes, their relationships, and their methods, create a code map that shows those elements.<br /><br /> See:<br /><br /> -   [Map dependencies across your solutions](../VS_csharp/map-dependencies-across-your-solutions.md)|  
 ...
 **Layer diagram for Dinner Now integrated with Lucerne**  
 ...
 ![Updated dependency graph with integrated system](../VS_csharp/media/depgraph_intsystem.png "DepGraph_IntSystem")  
 ...
 **Code map with updated method calls**  
 ...
 ![Dependency graph without PaymentProcessing](../VS_csharp/media/depgraph_nomore.png "DepGraph_NoMore")  
...
|**Diagram**|**Description**|  
|-----------------|---------------------|  
|Code map|Visualize the organization and relationships in existing code.<br /><br /> To create layers, generate a code map, and then group items on the map as potential layers. Drag the groups from the map to the layer diagram.<br /><br /> See:<br /><br /> -   [Map dependencies across your solutions](../VS_csharp/map-dependencies-across-your-solutions.md)<br />-   [Browse and rearrange code maps](../VS_csharp/browse-and-rearrange-code-maps.md)|  
