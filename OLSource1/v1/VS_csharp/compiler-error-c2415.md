...
2.  A newer processor supports the instruction with additional types. Adjust the [/arch](../VS_csharp/-arch--minimum-cpu-architecture-.md) option to use the later processor.