...
## Remarks  
 ...
 For more information on `CClientDC`, see [Device Contexts](../VS_csharp/device-contexts.md).  
...
##  <a name="cclientdc__cclientdc"></a>  CClientDC::CClientDC  
 Constructs a `CClientDC` object that accesses the client area of the [CWnd](../VS_csharp/cwnd-class.md) pointed to by `pWnd`.  
...
### Example  
 [!code[NVC_MFCDocView#42](../VS_csharp/codesnippet/CPP/cclientdc-class_1.cpp)]  
