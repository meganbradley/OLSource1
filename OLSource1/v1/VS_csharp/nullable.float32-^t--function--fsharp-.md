...
Converts the argument to [float32](../VS_csharp/core.float32-type-abbreviation--fsharp-.md). This is a direct conversion for all primitive numeric types. The operation requires an appropriate static conversion method on the input type.  
...
## See Also  
 ...
 [Operators.float32<^T> Function (F#)](../VS_csharp/operators.float32-^t--function--fsharp-.md)