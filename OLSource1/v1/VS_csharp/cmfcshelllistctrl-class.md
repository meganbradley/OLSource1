...
|[CMFCShellListCtrl::OnCompareItems](#cmfcshelllistctrl__oncompareitems)|The framework calls this method when it compares two items. (Overrides [CMFCListCtrl::OnCompareItems](../VS_csharp/cmfclistctrl-class.md#cmfclistctrl__oncompareitems).)|  
...
## Remarks  
 The `CMFCShellListCtrl` class extends the functionality of the [CMFCListCtrl Class](../VS_csharp/cmfclistctrl-class.md) by enabling your program to list Windows shell items. The display format that is used is like that of a list view for an Explorer window.  
  
 A [CMFCShellTreeCtrl](../VS_csharp/cmfcshelltreectrl-class.md) object can be associated with a `CMFCShellListCtrl` object to create a complete Explorer window. Then, selecting an item in the `CMFCShellTreeCtrl` will cause the `CMFCShellListCtrl` object to list the contents of the selected item.  
  
## Example  
 The following example demonstrates how to create an object of the `CMFCShellListCtrl` class and how to display the parent folder of the currently displayed folder. This code snippet is part of the [Explorer sample](../VS_csharp/visual-c---samples.md).  
  
 [!code[NVC_MFC_Explorer#1](../VS_csharp/codesnippet/CPP/cmfcshelllistctrl-class_1.h)]  
[!code[NVC_MFC_Explorer#2](../VS_csharp/codesnippet/CPP/cmfcshelllistctrl-class_2.cpp)]  
[!code[NVC_MFC_Explorer#3](../VS_csharp/codesnippet/CPP/cmfcshelllistctrl-class_3.cpp)]  
...
## Inheritance Hierarchy  
 ...
 [CMFCShellListCtrl](../VS_csharp/cmfcshelllistctrl-class.md)  
...
##  <a name="cmfcshelllistctrl__displayparentfolder"></a>  CMFCShellListCtrl::DisplayParentFolder  
 Updates the [CMFCShellListCtrl](../VS_csharp/cmfcshelllistctrl-class.md) object to display the parent folder of the currently displayed folder.  
...
##  <a name="cmfcshelllistctrl__getcurrentfolder"></a>  CMFCShellListCtrl::GetCurrentFolder  
 Retrieves the path of the currently selected folder in the [CMFCShellListCtrl](../VS_csharp/cmfcshelllistctrl-class.md) object.  
...
##  <a name="cmfcshelllistctrl__getcurrentfoldername"></a>  CMFCShellListCtrl::GetCurrentFolderName  
 Retrieves the name of the currently selected folder in the [CMFCShellListCtrl](../VS_csharp/cmfcshelllistctrl-class.md) object.  
...
##  <a name="cmfcshelllistctrl__getcurrentshellfolder"></a>  CMFCShellListCtrl::GetCurrentShellFolder  
 Gets a pointer to the currently selected item in the [CMFCShellListCtrl](../VS_csharp/cmfcshelllistctrl-class.md) object.  
...
### Remarks  
 The index supplied by `iItem` is based on the items currently displayed by the [CMFCShellListCtrl Class](../VS_csharp/cmfcshelllistctrl-class.md) object.  
  
##  <a name="cmfcshelllistctrl__getitemtypes"></a>  CMFCShellListCtrl::GetItemTypes  
 Returns the type of items displayed by the [CMFCShellListCtrl](../VS_csharp/cmfcshelllistctrl-class.md) object.  
...
##  <a name="cmfcshelllistctrl__isdesktop"></a>  CMFCShellListCtrl::IsDesktop  
 Determines if the folder that is displayed in the [CMFCShellListCtrl](../VS_csharp/cmfcshelllistctrl-class.md) object is the desktop folder.  
...
### Remarks  
 Each item in the [CMFCShellListCtrl](../VS_csharp/cmfcshelllistctrl-class.md) object may have text in one or more columns. When the framework calls this method, it specifies the column that it is interested in. If you call this function manually, you must also specify the column that you are interested in.  
...
### Remarks  
 By default, the framework creates four columns in a [CMFCShellListCtrl](../VS_csharp/cmfcshelllistctrl-class.md) object. The names of these columns are `Name`, `Size`, `Type`, and `Modified`. You can override this method to customize the number of columns and their names.  
  
##  <a name="cmfcshelllistctrl__refresh"></a>  CMFCShellListCtrl::Refresh  
 Refreshes and repaints the [CMFCShellListCtrl](../VS_csharp/cmfcshelllistctrl-class.md) object.  
...
##  <a name="cmfcshelllistctrl__setitemtypes"></a>  CMFCShellListCtrl::SetItemTypes  
 Sets the type of items that are listed in the [CMFCShellListCtrl](../VS_csharp/cmfcshelllistctrl-class.md) object.  
...
## See Also  
 ...
 [CMFCListCtrl Class](../VS_csharp/cmfclistctrl-class.md)   
 [CMFCShellTreeCtrl Class](../VS_csharp/cmfcshelltreectrl-class.md)