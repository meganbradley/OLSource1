...
|?DataServiceCollection : bool|Generates collections derived from <xref:System.Data.Services.Client.DataServiceCollection`1*>. The default value is false.|  
  
## Remarks  
 For a walkthrough that shows how to use the ODataService type provider, see [Walkthrough: Accessing Typed Data From an OData Service (F#)](../VS_csharp/walkthrough--accessing-an-odata-service-by-using-type-providers--fsharp-.md).  
...
|MyService.ServiceTypes.*ServiceTypeName*|The service context type, inherited from <xref:System.Data.Linq.DataContext*>.|  
|MyService.ServiceTypes.SimpleDataContextTypes.*ServiceTypeName*|Contains one property for each property of the full context type, which returns a <xref:System.Data.Services.Client.DataServiceQuery`1*>.<br /><br /> The Credentials property gets or sets the credentials used to query the OData service at runtime.<br /><br /> The DataContext property gets the full data context, of type <xref:System.Data.Linq.DataContext*>. This is the base type of the *ServiceTypeName* type generated by the type provider.|  
  
## Platforms  
 [!INCLUDE[win8](../VS_csharp/includes/win8_md.md)], Windows 8, Windows 7, Windows Server 2012, Windows Server 2008 R2  
...
## See Also  
 ...
 [Microsoft.FSharp.Data.TypeProviders Namespace (F#)](../VS_csharp/microsoft.fsharp.data.typeproviders-namespace--fsharp-.md)   
 [How To: Access Typed Data From an OData Service (F#)](../VS_csharp/walkthrough--accessing-an-odata-service-by-using-type-providers--fsharp-.md)