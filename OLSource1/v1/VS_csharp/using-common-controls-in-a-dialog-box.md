...
The Windows common controls can be used in [dialog boxes](../VS_csharp/dialog-boxes.md), form views, record views, and any other window based on a dialog template. The following procedure, with minor changes, will work for forms as well.  
  
## Procedures  
  
#### To use a common control in a dialog box  
  
1.  Place the control on the dialog template [using the dialog editor](../VS_csharp/using-the-dialog-editor-to-add-controls.md).  
...
3.  If this common control is providing input to the program, declare additional member variable(s) in the dialog class to handle those input values.  
    ...
    > [!NOTE]
    >  You can add these member variables using the context menu in Class View (see [Adding a Member Variable](../VS_csharp/adding-a-member-variable---visual-c---.md)).  
...
4.  In [OnInitDialog](../Topic/CDialog::OnInitDialog.md) for your dialog class, set the initial conditions for the common control. Using the member variable created in the previous step, use the member functions to set initial value and other settings. See the following descriptions of the controls for details on settings.  
     ...
     You can also use [dialog data exchange](../VS_csharp/dialog-data-exchange-and-validation.md) (DDX) to initialize controls in a dialog box.  
...
## Remarks  
 The addition of some common controls to a dialog box will cause the dialog box to no longer function. Refer to [Adding Controls to a Dialog Causes the Dialog to No Longer Function](../VS_csharp/adding-controls-to-a-dialog-causes-the-dialog-to-no-longer-function.md) for more information on handling this situation.  
  
## What do you want to do?  
  
-   [Add controls to a dialog box by hand instead of with the dialog editor](../VS_csharp/adding-controls-by-hand.md)  
  
-   [Derive my control from one of the standard Windows common controls](../VS_csharp/deriving-controls-from-a-standard-control.md)  
  
-   [Use a common control as a child window](../VS_csharp/using-a-common-control-as-a-child-window.md)  
  
-   [Receive notification messages from a control](../VS_csharp/receiving-notification-from-common-controls.md)  
  
-   [Use dialog data exchange (DDX)](../VS_csharp/dialog-data-exchange-and-validation.md)  
