...
module machine type 'type1' conflicts with target machine type 'type2'  
 ...
 Similarly, if you create one module with the [!INCLUDE[vcprx64](../VS_csharp/includes/vcprx64_md.md)] compiler and another module with the x86 compiler, and try to link them, the linker will generate LNK1112.  
