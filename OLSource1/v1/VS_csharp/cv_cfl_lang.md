...
## Elements  
 ...
 CV_CFL_MSIL  
 Application language is an unknown Microsoft Intermediate Language (MSIL), possibly a result of using the [/LTCG (Link-time Code Generation)](../VS_csharp/-ltcg--link-time-code-generation-.md) switch.  
  
 CV_CFL_HLSL  
 Application language is High Level Shader Language.  
  
## Remarks  
 The values in this enumeration are returned by a call to the [IDiaSymbol::get_language](../VS_csharp/idiasymbol--get_language.md) method.  
...
## See Also  
 ...
 [IDiaSymbol::get_language](../VS_csharp/idiasymbol--get_language.md)