...
---
# SccUninitialize Function
This function cleans up any allocations or open connections created by a previous call to the [SccInitialize Function](../VS_csharp/sccinitialize-function.md) in preparation for shutting down the source control plug-in.  
...
#### Parameters  
 pvContext  
 [in] The pointer to the source control plug-in context structure created in the [SccInitialize Function](../VS_csharp/sccinitialize-function.md).  
