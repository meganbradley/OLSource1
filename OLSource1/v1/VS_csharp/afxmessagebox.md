...
#### Parameters  
 ...
 `nType`  
 The style of the message box. Apply any of the [message-box styles](../VS_csharp/message-box-styles.md) to the box.  
...
-   **IDYES** The Yes button was selected.  
 ...
 The functions [AfxFormatString1](../VS_csharp/afxformatstring1.md) and [AfxFormatString2](../VS_csharp/afxformatstring2.md) can be useful in formatting text that appears in a message box.  
...
## See Also  
 ...
 [CWnd::MessageBox](../Topic/CWnd::MessageBox.md)