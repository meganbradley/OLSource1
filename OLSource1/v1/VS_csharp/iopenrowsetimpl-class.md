...
|||  
|-|-|  
|[CreateRowset](../VS_csharp/iopenrowsetimpl--createrowset.md)|Creates a rowset object. Not called directly by user.|  
|[OpenRowset](../VS_csharp/iopenrowsetimpl--openrowset.md)|Opens and returns a rowset that includes all rows from a single base table or index. (Not in ATLDB.H)|  
