...
|||  
|-|-|  
|![Run after build](../VS_csharp/media/ute_runafterbuild_btn.png "UTE_RunAfterBuild_btn")|To run your unit tests after each local build, choose **Test** on the standard menu, and then choose **Run Tests After Build** on the Test Explorer toolbar.|  
...
###  <a name="BKMK_View_test_details"></a> View test details  
 ...
 ![Test execution details](../VS_csharp/media/ute_testdetails.png "UTE_TestDetails")  
...
###  <a name="BKMK_Grouping_the_test_list"></a> Grouping the test list  
 To change the way that tests are organized, choose the down arrow next to the **Group By** button ![Test Explorer group button](../VS_csharp/media/ute_groupby_btn.png "UTE_GroupBy_btn") and select a new grouping criteria.  
  
 ![Group tests by category in Test Explorer](../VS_csharp/media/ute_groupbycategory.png "UTE_GroupByCategory")  
...
3.  Enter the filter value between the quotation marks.  
 ...
 ![Filter tests in Test Explorer](../VS_csharp/media/ute_filtertestlist.png "UTE_FilterTestList")  
...
##  <a name="BKMK_Create_custom_playlists"></a> Create custom playlists  
 ...
 ![Choose a playlist](../VS_csharp/media/ute_playlist.png "UTE_Playlist")  
...
2.  In Test Explorer, select the test methods and then choose **Debug Selected Tests** on the context menu.  
 ...
 For more information, about the debugger, see [Debugging in Visual Studio](../VS_csharp/debugging-in-visual-studio.md).  
  
 ![Back to top](../VS_csharp/media/pcs_backtotop.png "PCS_BackToTop") [Contents](#BKMK_Contents)  
  
###  <a name="BKMK_Diagnose_test_method_performance_issues"></a> Diagnose test method performance issues  
 To diagnose why a test method is taking too much time, select the method in Test Explorer and then choose Profile on the context menu. See [Analyzing Application Performance by Using Profiling Tools](../VS_csharp/performance-explorer.md).  
...
2.  Choose one of the following commands from the sub-menu:  
 ...
 For more information, see [Using Code Coverage to Determine How Much Code Is Being Tested](../VS_csharp/using-code-coverage-to-determine-how-much-code-is-being-tested.md).  
...
## See Also  
 ...
 [How to: Run a Unit Test as a 64-bit Process](../VS_csharp/run-a-unit-test-as-a-64-bit-process.md)