...
### Remarks  
 ...
 If `_Func` is an object of type `Operation` and `c` is a constant, then `bind1st` ( `_Func`, `c`) is equivalent to the [binder1st](../VS_csharp/binder1st-class.md) class constructor `binder1st`< `Operation`> ( `_Func`, `c`) and is more convenient.  
...
### Remarks  
 ...
 If `_Func` is an object of type **Operation** and `c` is a constant, then `bind2nd` ( `_Func`, `c` ) is equivalent to the [binder2nd](../VS_csharp/binder2nd-class.md) class constructor **binder2nd<Operation\>** ( `_Func`, `c` ) and more convenient.  
...
### Return Value  
 The first template function returns the unary function [pointer_to_unary_function](../VS_csharp/pointer_to_unary_function-class.md) < `Arg`, **Result**>(* `_pfunc`).  
  
 The second template function returns binary function [pointer_to_binary_function](../VS_csharp/pointer_to_binary_function-class.md) < **Arg1**, **Arg2**, **Result**>(* `_pfunc`).  
...
### Example  
 [!code[functional_ptr_fun#1](../VS_csharp/codesnippet/CPP/-functional--functions_1.cpp)]  
