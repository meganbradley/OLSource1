...
---
# Reserved Words
The following words are reserved by the linker. These names can be used as arguments in [module-definition statements](../VS_csharp/module-definition--.def--files.md) only if the name is enclosed in double quotation marks ("").  
