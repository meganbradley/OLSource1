...
### Remarks  
 ...
 At some point in the future, you must call the                         [CurrentScheduler::Detach](../VS_csharp/currentscheduler-class.md#currentscheduler__detach_method) method in order to allow the scheduler to shut down.  
 ...
 This method will throw an                         [improper_scheduler_attach](../VS_csharp/improper_scheduler_attach-class.md) exception if this scheduler is the current scheduler of the calling context.  
...
### Remarks  
 ...
 The method will throw an                         [improper_scheduler_reference](../VS_csharp/improper_scheduler_reference-class.md) exception if the reference count prior to calling the                         `Reference` method was zero and the call is made from a context that is not owned by the scheduler.  
