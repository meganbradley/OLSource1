...
## Remarks  
 ...
 It is possible to modify the alignment of a particular section with the align parameter to the [/SECTION](../VS_csharp/-section--specify-section-attributes-.md) option.  
