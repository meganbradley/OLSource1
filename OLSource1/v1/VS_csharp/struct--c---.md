...
#### Parameters  
 ...
 `tag`  
 The type name given to the structure. The tag becomes a reserved word within the scope of the structure. The tag is optional. If omitted, an anonymous structure is defined. For more information, see [Anonymous Class Types](../VS_csharp/anonymous-class-types.md).  
  
 `base-list`  
 Optional list of classes or structures this structure will derive its members from. See [Base Classes](../VS_csharp/base-classes.md) for more information. Each base class or structure name can be preceded by an access specifier ([public](../VS_csharp/public--c---.md), [private](../VS_csharp/private--c---.md), [protected](../VS_csharp/protected--c---.md)) and the [virtual](../VS_csharp/virtual--c---.md) keyword. See the member-access table in [Controlling Access to Class Members](../Topic/Controlling%20Access%20to%20Class%20Members.md) for more information.  
  
 `member-list`  
 List of structure members. Refer to [Class Members](../VS_csharp/class-member-overview.md) for more information. The only difference here is that `struct` is used in place of `class`.  
  
 `declarators`  
 Declarator list specifying the names of the class. Declarator lists declare one or more instances of the structure type. Declarators may include initializer lists if all data members of the class are `public`. Initializer lists are common in structures because data members are `public` by default.  See [Overview of Declarators](../VS_csharp/overview-of-declarators.md) for more information.  
...
## Using a Structure  
 ...
 For related information, see [class](../VS_csharp/class--c---.md), [union](../VS_csharp/unions.md), and [enum](../VS_csharp/enumerations--c---.md).  
