...
From the resource editor, you can add a new event handler, or edit an existing event handler, for a dialog box control using the [Event Handler Wizard](../VS_csharp/event-handler-wizard.md).  
  
 You can add an event to the class implementing the dialog box using the [Properties window](../VS_csharp/properties-window.md). If you want to add the event to a class other than the dialog box class, use the Event Handler Wizard.  
  
### To add an event handler to a dialog box control  
  
1.  Double-click the dialog box resource in [Resource View](../VS_csharp/resource-view-window.md) to open the dialog box resource that contains the control in the [dialog editor](../VS_csharp/dialog-editor.md).  
...
6.  Click **Add and edit** to add the event handler to the project and open the text editor at the new function to add the appropriate event handler code.  
 ...
 Alternately, you can add event handlers from the [Properties window](../VS_csharp/properties-window.md). See [Adding Event Handlers for Dialog Box Controls](../VS_csharp/adding-event-handlers-for-dialog-box-controls.md) for more information.  
