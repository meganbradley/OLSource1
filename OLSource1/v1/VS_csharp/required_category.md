...
---
# REQUIRED_CATEGORY
Add a `REQUIRED_CATEGORY` macro to your component's [category map](../VS_csharp/begin_category_map.md) to specify that it should be registered as requiring the category identified by the `catID` parameter.  
...
## Remarks  
 ...
 For more information about component categories, including a sample list, see [What are Component Categories and how do they work?](http://msdn.microsoft.com/library/windows/desktop/ms694322) in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
## Example  
 [!code[NVC_ATL_Windowing#135](../VS_csharp/codesnippet/CPP/required_category_1.h)]  
