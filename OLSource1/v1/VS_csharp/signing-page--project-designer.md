 ...
 **Sign the ClickOnce manifests** check box  
 Select this check box to sign the application and deployment manifests with a public/private key pair. For more information about how to do this, see [How to: Sign Application and Deployment Manifests](../VS_csharp/how-to--sign-application-and-deployment-manifests.md).  
 ...
 **Sign the assembly** check box  
 ...
 This option uses the Al.exe tool provided by the [!INCLUDE[winsdklong](../VS_csharp/includes/winsdklong_md.md)] to sign the assembly. For more information about Al.exe, see [How to: Sign an Assembly with a Strong Name](assetId:///2c30799a-a826-46b4-a25d-c584027a6c67).  
...
## See Also  
 ...
 [How to: Sign Application and Deployment Manifests](../VS_csharp/how-to--sign-application-and-deployment-manifests.md)   
