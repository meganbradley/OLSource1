 ...
 *hAccessorToFlush*  
 [in] Handle to the accessor, which contains binding information and type information in its **PROVIDER_MAP** (see [IAccessorImpl](../VS_csharp/iaccessorimpl-class.md)).  
...
## See Also  
 [IRowsetChangeImpl Class](../VS_csharp/irowsetchangeimpl-class.md)