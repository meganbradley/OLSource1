...
#### Parameters  
 `StringType`  
 The ATL/MFC string class to use for the path (see                         [CStringT](../VS_csharp/cstringt-class.md)).  
...
|[CPathT::operator PCXSTR](../Topic/CPathT::operator%20CPathT::PCXSTR.md)|This operator allows the object to be treated like a string.|  
