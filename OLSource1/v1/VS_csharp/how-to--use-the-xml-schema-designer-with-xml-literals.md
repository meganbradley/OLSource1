...
1.  Open a new text file in Notepad.Copy the XML Schema sample code from [Purchase Order Schema](../VS_csharp/sample-xsd-file--simple-schema.md) and paste it in to the file.  
