...
-   Create your test as a sequence of recorded methods. For more information about how to record a method, see [Creating Coded UI Tests](../VS_csharp/use-ui-automation-to-test-your-code.md#VerifyingCodeUsingCUITCreate).  
...
-   Create a separate <xref:Microsoft.VisualStudio.TestTools.UITest.Common.UIMap.UIMap*> file for each module in your application under test. For more information, see [Testing a Large Application with Multiple UI Maps](../VS_csharp/testing-a-large-application-with-multiple-ui-maps.md).  
...
-   If a control has an assertion that is no longer valid:  
 ...
 For more information about how to record coded UI tests, see [Verifying Code by Using Coded User Interface Tests](../VS_csharp/use-ui-automation-to-test-your-code.md).  
