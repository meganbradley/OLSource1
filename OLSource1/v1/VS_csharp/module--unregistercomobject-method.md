...
#### Parameters  
 ...
 `cookies`  
 An array of pointers to values that identify the class objects to be unregistered. The array was created by the [RegisterCOMObject](../VS_csharp/module--registercomobject-method.md) method.  
