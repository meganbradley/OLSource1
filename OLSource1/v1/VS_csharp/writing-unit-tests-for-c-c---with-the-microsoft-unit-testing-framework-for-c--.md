...
2.  Make the DLL accessible to the test project:  
    ...
    -   `#include` a `.h` file that contains declarations of the DLL’s externally-accessible functions.  
         ...
         The `.h` file should contain function declarations marked with `_declspec(dllimport)`. Alternatively, you can export the methods using a DEF file. For more information, see [Importing and Exporting from a DLL](../VS_csharp/importing-and-exporting.md).  
...
1.  On the **File** menu, choose **New**, **Project**.  
     ...
     ![Creating a C&#43;&#43; Unit Test Project](../VS_csharp/media/utecpp01.png "UteCpp01")  
  
2.  In the new project, inspect **unittest1.cpp**  
  
     ![Test project with TEST&#95;CLASS and TEST&#95;METHOD](../VS_csharp/media/utecpp2.png "UteCpp2")  
...
3.  Verify that the tests run in Test Explorer:  
    ...
    2.  On the **Test** menu, choose **Run** , **All Tests**.  
         ...
         ![Unit Test Explorer with one passed test](../VS_csharp/media/utecpp04.png "UteCpp04")  
...
1.  Create a **Visual C++** project by using the **Win32 Project** template.  
     ...
     ![Creating a C&#43;&#43; Win32 project](../VS_csharp/media/utecpp05.png "UteCpp05")  
...
2.  Select **DLL** and **Export Symbols** in the Win32 Application Wizard.  
     ...
     ![C&#43;&#43; project wizard set for DLL and Export Symbols](../VS_csharp/media/utecpp06.png "UteCpp06")  
  
3.  Declare an exported function in the principal .h file:  
  
     ![New DLL code project and .h file with API macros](../VS_csharp/media/utecpp07.png "UteCpp07")  
  
     The declarator `__declspec(dllexport)` causes the public and protected members of the class to be visible outside the DLL. For more information, see [Using dllimport and dllexport in C++ classes](../VS_csharp/using-dllimport-and-dllexport-in-c---classes.md).  
...
1.  Add the DLL project to the project references of the test project:  
    ...
    1.  Open the properties of the test project and choose **Common Properties**, **Framework and References**.  
         ...
         ![C&#43;&#43; project properties &#45; Framework and References](../VS_csharp/media/utecpp08.png "UteCpp08")  
  
    2.  Choose **Add New Reference**.  
  
         In the **Add Reference** dialog box, select the DLL project and choose **Add**.  
  
         ![C&#43;&#43; project properties &#45; Add New Reference](../VS_csharp/media/utecpp09.png "UteCpp09")  
...
5.  In Test Explorer, choose **Run All**.  
     ...
     ![Unit Test Explorer &#45; Basic Test passed](../VS_csharp/media/utecpp10.png "UteCpp10")  
...
2.  Build the solution, and then in Test Explorer, choose **Run All**.  
     ...
     ![The RangeTest fails](../VS_csharp/media/ute_cpp_testexplorer_rangetest_fail.png "UTE_Cpp_TestExplorer_RangeTest_Fail")  
...
4.  Build the solution and then in Test Explorer, choose **Run All**.  
     ...
     ![Unit Test Explorer &#45; Range Test passed](../VS_csharp/media/utecpp12.png "UteCpp12")  
...
3.  Open (or double-click) the failed test.  
     ...
     ![NegativeRangeTests failed](../VS_csharp/media/ute_cpp_testexplorer_negativerangetest_fail.png "UTE_Cpp_TestExplorer_NegativeRangeTest_Fail")  
...
6.  All tests now pass.  
     ...
     ![All tests pass](../VS_csharp/media/ute_ult_alltestspass.png "UTE_ULT_AllTestsPass")  
...
## See Also  
 [Unit testing existing C++ applications with Test Explorer](../VS_csharp/unit-testing-existing-c---applications-with-test-explorer.md)   
 [Using Microsoft.VisualStudio.TestTools.CppUnitTestFramework](../VS_csharp/using-microsoft.visualstudio.testtools.cppunittestframework.md)   
 ...
 [Creating and Using a Dynamic Link Library](../VS_csharp/walkthrough--creating-and-using-a-dynamic-link-library--c---.md)   
 [Importing and Exporting from a DLL](../VS_csharp/importing-and-exporting.md)