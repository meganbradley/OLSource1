...
DslTextTransform.cmd is a script that calls TextTransform.exe and runs it with common options. You can use DslTextTransformation.cmd to automate a nightly build of your [!INCLUDE[dsl](../VS_csharp/includes/dsl_md.md)] projects. For more information, see [TextTransform](../VS_csharp/generating-files-with-the-texttransform-utility.md).  
