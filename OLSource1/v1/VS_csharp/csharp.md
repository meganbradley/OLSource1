...
## In This Section  
 [Getting Started with Visual C#](../VS_csharp/getting-started-with-csharp.md)  
 Introduces the features of C# for programmers who are new to the language or are new to [!INCLUDE[vsprvs](../VS_csharp/includes/vsprvs_md.md)], and provides a roadmap for finding Help about [!INCLUDE[vsprvs](../VS_csharp/includes/vsprvs_md.md)].  
  
 [Using the Visual C# IDE](../VS_csharp/using-the-visual-studio-development-environment-for-csharp.md)  
 Introduces the [!INCLUDE[csprcs](../VS_csharp/includes/csprcs_md.md)] development environment.  
...
## See Also  
 ...
 [.NET Development](assetId:///43e22490-fb00-409c-8301-585a03034ae2)