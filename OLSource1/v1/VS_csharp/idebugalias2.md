...
## Methods  
 In addition to the methods on the [IDebugAlias](../VS_csharp/idebugalias.md) interface, this interface implements the following method:  
  
|Method|Description|  
|------------|-----------------|  
|[IDebugAlias2::GetAppDomainId](../VS_csharp/idebugalias2--getappdomainid.md)|Retrieves the identifier for the application domain.|  
