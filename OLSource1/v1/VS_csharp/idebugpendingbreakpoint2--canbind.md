...
#### Parameters  
 `ppErrorEnum`  
 [out] Returns an [IEnumDebugErrorBreakpoints2](../VS_csharp/ienumdebugerrorbreakpoints2.md) object that contains a list of [IDebugErrorBreakpoint2](../VS_csharp/idebugerrorbreakpoint2.md) objects if there could be errors.  
...
## Remarks  
 This method is called to determine what would happen if this pending breakpoint was bound. Call the [IDebugPendingBreakpoint2::Bind](../VS_csharp/idebugpendingbreakpoint2--bind.md) method to actually bind the pending breakpoint.  
  
## Example  
 The following example shows how to implement this method for a simple `CPendingBreakpoint` object that exposes the [IDebugPendingBreakpoint2](../VS_csharp/idebugpendingbreakpoint2.md) interface.  
