...
This compiler option is obsolete. In versions of Visual Studio before Visual Studio 2013, this detects 64-bit portability problems on types that are also marked with the [__w64](../VS_csharp/__w64.md) keyword.  
...
-   pointer  
 ...
 If you regularly compile your application by using a 64-bit compiler, you can just disable **/Wp64** in your 32-bit compilations because the 64-bit compiler will detect all issues. For more information about how to target a Windows 64-bit operating system, see [64-Bit Programming with Visual C++](../VS_csharp/configuring-programs-for-64-bit--visual-c---.md).  
