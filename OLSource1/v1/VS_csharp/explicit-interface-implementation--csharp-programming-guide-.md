...
If a [class](../VS_csharp/class--csharp-reference-.md) implements two interfaces that contain a member with the same signature, then implementing that member on the class will cause both interfaces to use that member as their implementation. In the following example, all the calls to `Paint` invoke the same method.  
 ...
 [!code[csProgGuideInheritance#41](../VS_csharp/codesnippet/CSharp/explicit-interface-implementation--csharp-programming-guide-_3.cs)]  
 ...
 [!code[csProgGuideInheritance#42](../VS_csharp/codesnippet/CSharp/explicit-interface-implementation--csharp-programming-guide-_4.cs)]  
 ...
 [!code[csProgGuideInheritance#43](../VS_csharp/codesnippet/CSharp/explicit-interface-implementation--csharp-programming-guide-_5.cs)]  
