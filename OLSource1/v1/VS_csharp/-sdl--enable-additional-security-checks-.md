...
## Remarks  
 **/sdl** enables a superset of the baseline security checks provided by [/GS](../VS_csharp/-gs--buffer-security-check-.md) and overrides **/GS-**. By default, **/sdl** is off. **/sdl-** disables the additional security checks.  
...
|------------------------------|-------------------------------------|-----------------|  
|[C4146](../VS_csharp/compiler-warning--level-2--c4146.md)|/we4146|A unary minus operator was applied to an unsigned type, resulting in an unsigned result.|  
|[C4308](../VS_csharp/compiler-warning--level-2--c4308.md)|/we4308|A negative integral constant converted to unsigned type, resulting in a possibly meaningless result.|  
|[C4532](../VS_csharp/compiler-warning--level-1--c4532.md)|/we4532|Use of `continue`, `break` or `goto` keywords in a `__finally`/`finally` block has undefined behavior during abnormal termination.|  
|[C4533](../VS_csharp/compiler-warning--level-1--c4533.md)|/we4533|Code initializing a variable will not be executed.|  
|[C4700](../VS_csharp/compiler-warning--level-1-and-level-4--c4700.md)|/we4700|Use of an uninitialized local variable.|  
|[C4703](../VS_csharp/compiler-warning--level-4--c4703.md)|/we4703|Use of a potentially uninitialized local pointer variable.|  
|[C4789](../VS_csharp/compiler-warning--level-1--c4789.md)|/we4789|Buffer overrun when specific C run-time (CRT) functions are used.|  
|[C4995](../VS_csharp/compiler-warning--level-3--c4995.md)|/we4995|Use of a function marked with pragma [deprecated](../VS_csharp/deprecated--c-c---.md).|  
|[C4996](../VS_csharp/compiler-warning--level-3--c4996.md)|/we4996|Use of a function marked as [deprecated](../VS_csharp/deprecated--c---.md).|  
