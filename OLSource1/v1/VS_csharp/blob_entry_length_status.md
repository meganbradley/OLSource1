...
---
# BLOB_ENTRY_LENGTH_STATUS
Used with `BEGIN_COLUMN_MAP` and `END_COLUMN_MAP` to bind a binary large object ([BLOB](https://msdn.microsoft.com/en-us/library/ms711511.aspx)). Similar to [BLOB_ENTRY](../VS_csharp/blob_entry.md), except that this macro also gets the length and status of the BLOB column.  
...
## See Also  
 ...
 [BLOB_ENTRY_STATUS](../VS_csharp/blob_entry_status.md)