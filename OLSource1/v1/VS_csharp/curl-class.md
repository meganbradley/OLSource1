...
-   Scheme: "http" or [ATL_URL_SCHEME_HTTP](../VS_csharp/atl_url_scheme.md)  
...
### Example  
 ...
 [!code[NVC_ATL_Utilities#133](../VS_csharp/codesnippet/CPP/curl-class_1.cpp)]  
...
### Return Value  
 Returns the [ATL_URL_SCHEME](../VS_csharp/atl_url_scheme.md) value describing the scheme of the URL.  
...
### Parameters  
 `nScheme`  
 One of the [ATL_URL_SCHEME](../VS_csharp/atl_url_scheme.md) values for the scheme.  
...
### Remarks  
 You can also set the scheme by using an [ATL_URL_SCHEME](../VS_csharp/atl_url_scheme.md) constant (see [CUrl::SetScheme](../Topic/CUrl::SetScheme.md)).  
