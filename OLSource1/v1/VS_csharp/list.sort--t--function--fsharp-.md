...
Sorts the given list using [Operators.compare](../VS_csharp/operators.compare--t--function--fsharp-.md).  
...
## Example  
 ...
 [!code[FsLists#5](../VS_csharp/codesnippet/FSharp/list.sort--t--function--fsharp-_1.fs)]  
