...
---
# Wrapper Classes
When you [insert a control](../VS_csharp/inserting-the-control-into-a-visual-c---application.md) into a Visual C++ project, wrapper classes for the control are not included by default. However, if you want to [modify the control's behavior](../VS_csharp/modifying-a-control-s-run-time-behavior.md), you can write a wrapper class for the control. Depending on how you intend to manipulate the control programmatically, you need to write one or more of the control's wrapper classes.  
