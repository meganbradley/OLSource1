...
## Remarks  
 ...
 This command only builds projects that have changed since the last build. To build all projects in a solution, use [/rebuild (devenv.exe)](../VS_csharp/-rebuild--devenv.exe-.md).  
...
## See Also  
 ...
 [/Rebuild (devenv.exe)](../VS_csharp/-rebuild--devenv.exe-.md)   
 [/Clean (devenv.exe)](../VS_csharp/-clean--devenv.exe-.md)   
 [/out (Visual Studio)](../VS_csharp/-out--devenv.exe-.md)