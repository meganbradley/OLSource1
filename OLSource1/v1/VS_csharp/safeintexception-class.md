...
### Public Constructors  
 [SafeIntException::SafeIntException](../VS_csharp/safeintexception--safeintexception.md)  
 Creates a `SafeIntException` object.  
  
## Remarks  
 The [SafeInt Class](../VS_csharp/safeint-class.md) is the only class that uses the `SafeIntException` class.  
