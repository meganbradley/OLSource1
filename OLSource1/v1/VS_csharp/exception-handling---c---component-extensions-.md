...
## In This Section  
 [Basic Concepts in Using Managed Exceptions](../VS_csharp/basic-concepts-in-using-managed-exceptions.md)  
 Describes throwing exceptions and using `try`/`catch` blocks.  
  
 [Differences in Exception Handling Behavior Under /CLR](../VS_csharp/differences-in-exception-handling-behavior-under--clr.md)  
 ...
 [How to: Define and Install a Global Exception Handler](../VS_csharp/how-to--define-and-install-a-global-exception-handler.md)  
 Demonstrates how unhandled exceptions can be captured.  
  
 [How to: Catch Exceptions in Native Code Thrown from MSIL](../VS_csharp/how-to--catch-exceptions-in-native-code-thrown-from-msil.md)  
...
## See Also  
 [/clr Keywords and Constructs](../VS_csharp/component-extensions-for-runtime-platforms.md)