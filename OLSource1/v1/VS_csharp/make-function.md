...
---
# Make Function
Initializes the specified [!INCLUDE[wrt](../VS_csharp/includes/wrt_md.md)] class. Use this function to instantiate a component that is defined in the same module.  
...
## Remarks  
 See [How to: Instantiate WRL Components Directly](../VS_csharp/how-to--instantiate-wrl-components-directly.md) to learn the differences between this function and [Microsoft::WRL::Details::MakeAndInitialize](../VS_csharp/makeandinitialize-function.md), and for an example.  
