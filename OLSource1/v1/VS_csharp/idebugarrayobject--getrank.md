...
## Remarks  
 Use the [IDebugArrayObject::GetDimensions](../VS_csharp/idebugarrayobject--getdimensions.md) method to retrieve the size of each dimension of the array object.  
