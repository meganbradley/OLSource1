...
## Remarks  
 User-defined types can overload the `!` operator (see [operator](../VS_csharp/operator--csharp-reference-2.md)).  
  
## Example  
 [!code[csRefOperators#7](../VS_csharp/codesnippet/CSharp/!-operator--csharp-reference-_1.cs)]  
