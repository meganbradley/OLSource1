...
### Remarks  
 This function is called by the [COccManager::CreateContainer](../VS_csharp/coccmanager-class.md#coccmanager__createcontainer) function. For more information on customizing the creation of containers, see [COccManager::CreateSite](../VS_csharp/coccmanager-class.md#coccmanager__createsite).  
...
### Remarks  
 For a list of possible values, see [Windows Styles](../VS_csharp/window-styles.md). To retrieve the extended styles of the control site, call [COleControlSite::GetExStyle](#colecontrolsite__getexstyle).  
...
### Parameters  
 ...
 `wFlags`  
 Flags describing the context of the call to IDispatch::Invoke. For possible `wFlags` values, see `IDispatch::Invoke` in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
 ...
 `pbParamInfo`  
 Pointer to a null-terminated string of bytes specifying the types of the parameters following `pbParamInfo`. For possible values, see the Remarks section for [COleDispatchDriver::InvokeHelper](../VS_csharp/coledispatchdriver-class.md#coledispatchdriver__invokehelper).  
...
### Remarks  
 For more information, see                         [OLEMISC](http://msdn.microsoft.com/library/windows/desktop/ms678497)in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Parameters  
 ...
 `nFlags`  
 Window positioning flags. For a list of possible values, see the                                 [SetWindowPos](http://msdn.microsoft.com/library/windows/desktop/ms633545) function in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Remarks  
 ...
 Modifies the window styles of the control. Styles to be added or removed can be combined by using the bitwise OR ( &#124; ) operator. See the                         [CreateWindow](http://msdn.microsoft.com/library/windows/desktop/ms632679) function in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)] for information about the available window styles.  
...
### Remarks  
 ...
 Modifies the window extended styles of the control site object. Styles to be added or removed can be combined by using the bitwise OR ( &#124; ) operator. See the                         [CreateWindowEx](http://msdn.microsoft.com/library/windows/desktop/ms632680) function in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)] for information about the available window styles.  
...
### Parameters  
 ...
 `vtProp`  
 Specifies the type of property to be set. For possible values, see the Remarks section for [COleDispatchDriver::InvokeHelper](../VS_csharp/coledispatchdriver-class.md#coledispatchdriver__invokehelper).  
...
### Parameters  
 *lpmsg*  
 A pointer to a [MSG](../VS_csharp/msg-structure.md) structure. This structure contains the Windows message triggering the `SetFocus` request for the control contained in the current control site.  
 ...
 *y*  
 ...
 `nFlags`  
 Specifies the window sizing and positioning flags. For possible values, see the Remarks section for                                 [SetWindowPos](http://msdn.microsoft.com/library/windows/desktop/ms633545) in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
## See Also  
 ...
 [COleControlContainer](../VS_csharp/colecontrolcontainer-class.md)