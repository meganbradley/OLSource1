...
|[CImageList::DeleteTempMap](#cimagelist__deletetempmap)|Called by the [CWinApp](../VS_csharp/cwinapp-class.md) idle-time handler to delete any temporary `CImageList` object created by `FromHandle`.|  
...
## Remarks  
 ...
 For more information on using `CImageList`, see [Controls](../VS_csharp/controls--mfc-.md) and [Using CImageList](../VS_csharp/using-cimagelist.md).  
...
### Example  
 [!code[NVC_MFC_CImageList#1](../VS_csharp/codesnippet/CPP/cimagelist-class_1.cpp)]  
...
### Example  
 [!code[NVC_MFC_CImageList#2](../VS_csharp/codesnippet/CPP/cimagelist-class_2.cpp)]  
...
### Example  
 [!code[NVC_MFC_CImageList#3](../VS_csharp/codesnippet/CPP/cimagelist-class_3.cpp)]  
...
##  <a name="cimagelist__copy"></a>  CImageList::Copy  
 This member function implements the behavior of the Win32 function                 [ImageList_Copy](http://msdn.microsoft.com/library/windows/desktop/bb761520), as described in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Example  
 [!code[NVC_MFC_CImageList#6](../VS_csharp/codesnippet/CPP/cimagelist-class_4.cpp)]  
  
##  <a name="cimagelist__create"></a>  CImageList::Create  
 Initializes an image list and attaches it to a [CImageList](../VS_csharp/cimagelist-class.md) object.  
...
|`ILC_MASK`|Uses a mask. The image list contains two bitmaps, one of which is a monochrome bitmap used as a mask. If this value is not included, the image list contains only one bitmap. See [Drawing Images from an Image List](../VS_csharp/drawing-images-from-an-image-list.md) for additional information on masked images.|  
...
### Example  
 [!code[NVC_MFC_CImageList#7](../VS_csharp/codesnippet/CPP/cimagelist-class_5.cpp)]  
...
### Example  
 [!code[NVC_MFC_CImageList#8](../VS_csharp/codesnippet/CPP/cimagelist-class_6.cpp)]  
...
### Example  
 [!code[NVC_MFC_CImageList#9](../VS_csharp/codesnippet/CPP/cimagelist-class_7.cpp)]  
...
### Example  
 [!code[NVC_MFC_CImageList#4](../VS_csharp/codesnippet/CPP/cimagelist-class_8.cpp)]  
...
### Parameters  
 ...
 `sz`  
 Size of the portion of the image to draw relative to the upper-left corner of the image. See `dx` and                                 *dy* in                                 [ImageList_DrawEx](http://msdn.microsoft.com/library/windows/desktop/bb761536) in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)]*.*  
  
 *clrBk*  
 Background color of the image. See                                 *rgbBk* in                                 [ImageList_DrawEx](http://msdn.microsoft.com/library/windows/desktop/bb761536) in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)]*.*  
  
 *clrFg*  
 Foreground color of the image. See                                 *rgbFg* in                                 [ImageList_DrawEx](http://msdn.microsoft.com/library/windows/desktop/bb761536) in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)]*.*  
  
 `nStyle`  
 Flag specifying the drawing style. See                                 *fStyle* in                                 [ImageList_DrawEx](http://msdn.microsoft.com/library/windows/desktop/bb761536) in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)]*.*  
...
### Example  
 [!code[NVC_MFC_CImageList#10](../VS_csharp/codesnippet/CPP/cimagelist-class_9.cpp)]  
 ...
 *pimldp*  
 ...
 `pDC`  
 A pointer to the destination device context. You must delete this [CDC](../VS_csharp/cdc-class.md) object when you are done with it.  
...
### Example  
 [!code[NVC_MFC_CImageList#11](../VS_csharp/codesnippet/CPP/cimagelist-class_10.cpp)]  
...
### Example  
 [!code[NVC_MFC_CImageList#5](../VS_csharp/codesnippet/CPP/cimagelist-class_11.cpp)]  
...
### Example  
 [!code[NVC_MFC_CImageList#12](../VS_csharp/codesnippet/CPP/cimagelist-class_12.cpp)]  
...
### Example  
 [!code[NVC_MFC_CImageList#13](../VS_csharp/codesnippet/CPP/cimagelist-class_13.cpp)]  
...
### Example  
 [!code[NVC_MFC_CImageList#14](../VS_csharp/codesnippet/CPP/cimagelist-class_14.cpp)]  
...
### Example  
 [!code[NVC_MFC_CImageList#15](../VS_csharp/codesnippet/CPP/cimagelist-class_15.cpp)]  
...
### Example  
 [!code[NVC_MFC_CImageList#23](../VS_csharp/codesnippet/CPP/cimagelist-class_16.cpp)]  
...
### Example  
 [!code[NVC_MFC_CImageList#16](../VS_csharp/codesnippet/CPP/cimagelist-class_17.cpp)]  
...
### Example  
 [!code[NVC_MFC_CImageList#18](../VS_csharp/codesnippet/CPP/cimagelist-class_18.cpp)]  
...
### Example  
 [!code[NVC_MFC_CImageList#19](../VS_csharp/codesnippet/CPP/cimagelist-class_19.cpp)]  
...
### Example  
 [!code[NVC_MFC_CImageList#20](../VS_csharp/codesnippet/CPP/cimagelist-class_20.cpp)]  
...
### Example  
 [!code[NVC_MFC_CImageList#21](../VS_csharp/codesnippet/CPP/cimagelist-class_21.cpp)]  
...
### Example  
 [!code[NVC_MFC_CImageList#22](../VS_csharp/codesnippet/CPP/cimagelist-class_22.cpp)]  
...
### Example  
 [!code[NVC_MFC_CImageList#17](../VS_csharp/codesnippet/CPP/cimagelist-class_23.cpp)]  
