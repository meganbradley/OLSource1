...
## Properties  
 ...
 ![Properties on assocations](../VS_csharp/media/uml_classprop.png "UML_ClassProp")  
...
|**Work Items**|The number of work items linked to this association. To link work items, see [How to: Link Work Items to Model Elements](../VS_csharp/link-model-elements-and-work-items.md).|  
