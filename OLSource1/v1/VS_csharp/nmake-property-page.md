...
The **NMake** property page lets you specify build settings for NMake projects.  
 ...
 For more information about NMake projects, see [Creating a Makefile Project](../VS_csharp/creating-a-makefile-project.md).  
...
## See Also  
 ...
 [How to: Enable IntelliSense for Makefile Projects](../VS_csharp/how-to--enable-intellisense-for-makefile-projects.md)