...
The **/checked** option specifies whether an integer arithmetic statement that results in a value that is outside the range of the data type, and that is not in the scope of a [checked](../VS_csharp/checked--csharp-reference-.md) or [unchecked](../VS_csharp/unchecked--csharp-reference-.md) keyword, causes a run-time exception.  
...
1.  Open the project's **Properties** page. For more information, see [Build Page, Project Designer (C#)](../VS_csharp/build-page--project-designer--csharp-.md).  
