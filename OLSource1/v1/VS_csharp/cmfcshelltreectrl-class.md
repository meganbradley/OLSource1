...
---
# CMFCShellTreeCtrl Class
The `CMFCShellTreeCtrl` class extends [CTreeCtrl Class](../VS_csharp/ctreectrl-class.md) functionality by displaying a hierarchy of Shell items.  
...
|[CMFCShellTreeCtrl::GetRelatedList](#cmfcshelltreectrl__getrelatedlist)|Returns a pointer to the [CMFCShellListCtrl](../VS_csharp/cmfcshelllistctrl-class.md) object that is used together with this `CMFCShellTreeCtrl` object to create an Explorer-like window.|  
|[CMFCShellTreeCtrl::OnChildNotify](#cmfcshelltreectrl__onchildnotify)|This member function is called by this window's parent window when it receives a notification message that applies to this window. (Overrides [CWnd::OnChildNotify](../VS_csharp/cwnd-class.md#cwnd__onchildnotify).)|  
...
## Inheritance Hierarchy  
 ...
 [CMFCShellTreeCtrl](../VS_csharp/cmfcshelltreectrl-class.md)  
  
## Requirements  
 **Header:** afxshelltreeCtrl.h  
  
## Example  
 The following example demonstrates how to create an object of the `CMFCShellTreeCtrl` class. This code snippet is part of the [Explorer sample](../VS_csharp/visual-c---samples.md).  
  
 [!code[NVC_MFC_Explorer#4](../VS_csharp/codesnippet/CPP/cmfcshelltreectrl-class_1.h)]  
[!code[NVC_MFC_Explorer#5](../VS_csharp/codesnippet/CPP/cmfcshelltreectrl-class_2.cpp)]  
...
##  <a name="cmfcshelltreectrl__getflags"></a>  CMFCShellTreeCtrl::GetFlags  
 Returns the flags set for the [CMFCShellTreeCtrl Class](../VS_csharp/cmfcshelltreectrl-class.md) object.  
...
##  <a name="cmfcshelltreectrl__getitempath"></a>  CMFCShellTreeCtrl::GetItemPath  
 Retrieves the path of an item in the [CMFCShellTreeCtrl Class](../VS_csharp/cmfcshelltreectrl-class.md) object.  
...
##  <a name="cmfcshelltreectrl__getrelatedlist"></a>  CMFCShellTreeCtrl::GetRelatedList  
 Returns a pointer to the [CMFCShellListCtrl Class](../VS_csharp/cmfcshelllistctrl-class.md) object that is associated with this [CMFCShellTreeCtrl](../VS_csharp/cmfcshelltreectrl-class.md) object.  
...
##  <a name="cmfcshelltreectrl__refresh"></a>  CMFCShellTreeCtrl::Refresh  
 Refreshes and repaints the [CMFCShellTreeCtrl](../VS_csharp/cmfcshelltreectrl-class.md).  
...
##  <a name="cmfcshelltreectrl__selectpath"></a>  CMFCShellTreeCtrl::SelectPath  
 Selects an item in the [CMFCShellTreeCtrl Class](../VS_csharp/cmfcshelltreectrl-class.md) based on the supplied path.  
...
### Parameters  
 ...
 [in] `bRefresh`  
 A Boolean that specifies whether the [CMFCShellTreeCtrl Class](../VS_csharp/cmfcshelltreectrl-class.md) should be refreshed immediately.  
...
##  <a name="cmfcshelltreectrl__setrelatedlist"></a>  CMFCShellTreeCtrl::SetRelatedList  
 Associates a [CMFCShellListCtrl](../VS_csharp/cmfcshelllistctrl-class.md) object with a [CMFCShellTreeCtrl](../VS_csharp/cmfcshelltreectrl-class.md) object.  
...
## See Also  
 ...
 [CTreeCtrl Class](../VS_csharp/ctreectrl-class.md)   
 [CMFCShellListCtrl Class](../VS_csharp/cmfcshelllistctrl-class.md)