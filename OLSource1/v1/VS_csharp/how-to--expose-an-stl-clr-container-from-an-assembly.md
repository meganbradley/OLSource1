...
### Description  
 ...
 For more information on the manifest tool and side-by-side assemblies, see [Building C/C++ Isolated Applications and Side-by-side Assemblies](../VS_csharp/building-c-c---isolated-applications-and-side-by-side-assemblies.md).  
