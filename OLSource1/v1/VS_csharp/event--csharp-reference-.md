...
|[virtual](../VS_csharp/virtual--csharp-reference-.md)|Allows derived classes to override the event behavior by using the [override](../VS_csharp/override--csharp-reference-.md) keyword.|[Inheritance (Visual C#)](../VS_csharp/inheritance--csharp-programming-guide-.md)|  
