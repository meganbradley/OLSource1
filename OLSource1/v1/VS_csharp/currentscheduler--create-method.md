...
## Remarks  
 ...
 After a scheduler is created with the `Create` method, you must call the [CurrentScheduler::Detach](../VS_csharp/currentscheduler--detach-method.md) method at some point in the future in order to allow the scheduler to shut down.  
...
## See Also  
 ...
 [Scheduler::Reference Method](../VS_csharp/scheduler--reference-method.md)   
