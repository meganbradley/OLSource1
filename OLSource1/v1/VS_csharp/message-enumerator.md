...
---
# Message Enumerator
The following flags are used for the `TEXTOUTPROC` function, which is a callback function that the IDE provides when it calls the [SccOpenProject Function](../VS_csharp/sccopenproject-function.md) (see [Displaying Output by Using the LPTEXTOUTPROC Function](../VS_csharp/lptextoutproc.md) for details on the callback function).  
