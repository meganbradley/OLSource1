...
The techniques and facilities for handling exceptions in OLE are the same as those for handling other exceptions. For further information on exception handling, see the article [C++ Exception Handling](../VS_csharp/c---exception-handling.md).  
...
-   [COleException](../VS_csharp/coleexception-class.md) For handling general OLE exceptions.  
  
-   [COleDispatchException](../VS_csharp/coledispatchexception-class.md) For generating and handling OLE dispatch (automation) exceptions.  
...
-   The name of the application that generated the exception  
 ...
 Two global functions correspond to the two OLE exception classes: [AfxThrowOleException](../VS_csharp/afxthrowoleexception.md) and [AfxThrowOleDispatchException](../VS_csharp/afxthrowoledispatchexception.md). Use them to throw general OLE exceptions and OLE dispatch exceptions, respectively.  
