...
2.  In the [Properties Window](../VS_csharp/properties-window.md), in the **Prompt** property field, add a description of the button for the status bar; after the message, add \n and the tool tip name.  
...
> [!NOTE]
>  You can edit prompt text using the [Properties Window](../VS_csharp/properties-window.md).  
