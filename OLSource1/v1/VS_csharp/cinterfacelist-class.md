...
## Remarks  
 This class provides a constructor and derived methods for creating a list of COM interface pointers. Use [CInterfaceArray](../VS_csharp/cinterfacearray-class.md) when an array is required.  
