...
1.  In [Resource View](../VS_csharp/resource-view-window.md) or a document window, select your resource, for example, IDD_ABOUTBOX.  
...
2.  In the [Properties window](../VS_csharp/properties-window.md), click the **Property Pages** button.  
