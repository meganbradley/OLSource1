...
The Graph View provides a graphic representation of global schema nodes and the relationships between the nodes. Note that the Graph View does not allow you to alter the layout of the schema set on the design surface. The Graph View also includes the XML Schema Designer toolbar and the breadcrumb bar.  
 ...
 ![XML Schema Designer Graph View](../VS_csharp/media/xsddesigner_graphview.gif "XSDDesigner_GraphView")  
  
## Design Surface  
 The design surface of the Graph View displays the contents of the [XML Schema Designer Workspace](../VS_csharp/xml-schema-designer-workspace.md). If the workspace contains any global nodes from the schema set, the nodes are shown on the Graph View design surface and arrows are drawn between the nodes that have relationships.  
 ...
 ![XSD Designer; Graph View](../VS_csharp/media/xsdgraphviewwatermark.gif "XSDGraphViewWatermark")  
...
## XSD Toolbar  
 ...
 ![XML Schema Designer Toolbar](../VS_csharp/media/xsdgraphviewtoolbar.gif "XSDGraphViewToolbar")  
...
## XML Editor Integration  
 ...
 If you make changes to the schema set in the XML Editor, the changes will be synchronized in the Graph View. For more information, see [Integration with XML Editor](../VS_csharp/integration-with-xml-editor.md).  
  
## See Also  
 [Design Surface](../VS_csharp/xml-schema-designer-workspace.md)