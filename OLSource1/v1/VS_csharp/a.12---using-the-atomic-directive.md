...
The following example avoids race conditions (simultaneous updates of an element of *x* by multiple threads) by using the `atomic` directive ([Section 2.6.4](../VS_csharp/2.6.4-atomic-construct.md) on page 19):  
