...
```  
 ...
 /LIBPATH: `dir`  
 Overrides the environment library path. For details, see the description of the LINK [/LIBPATH](../VS_csharp/-libpath--additional-libpath-.md) option.  
 ...
 /NODEFAULTLIB  
 Removes one or more default libraries from the list of libraries it searches when resolving external references. See [/NODEFAULTLIB](../VS_csharp/-nodefaultlib--ignore-libraries-.md) for more information.  
 ...
 Tells the operating system how to run a program created by linking to the output library. For more information, see the description of the LINK [/SUBSYSTEM](../VS_csharp/-subsystem--specify-subsystem-.md) option.  
