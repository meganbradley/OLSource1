...
## Remarks  
 The class describes an enumeration common to all specializations of template class [codecvt](../VS_csharp/codecvt-class.md). The enumeration result describes the possible return values from [do_in](../VS_csharp/codecvt-class.md#codecvt__do_in) or [do_out](../VS_csharp/codecvt-class.md#codecvt__do_out):  
