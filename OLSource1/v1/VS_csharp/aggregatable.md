...
|---------------------|--------------------|  
|**Never**|[DECLARE_NOT_AGGREGATABLE](../VS_csharp/declare_not_aggregatable.md)|  
|**Allowed**|[DECLARE_POLY_AGGREGATABLE](../VS_csharp/declare_poly_aggregatable.md)|  
|**Always**|[DECLARE_ONLY_AGGREGATABLE](../VS_csharp/declare_only_aggregatable.md)|  
