...
## Attributes  
 ...
 In [!INCLUDE[dnprdnlong](../VS_csharp/includes/dnprdnlong_md.md)] code, Visual Basic does not support the DebuggerBrowsable attribute. This limitation is removed in more recent versions of the .NET Framework.  
  
## Visualizers  
 You can write a visualizer to display any managed data type. For more information, see [How to: Write a Visualizer](../VS_csharp/how-to--write-a-visualizer.md).  
...
## See Also  
 [Using DebuggerTypeProxy Attribute](../VS_csharp/using-debuggertypeproxy-attribute.md)   
 [Using DebuggerDisplay Attribute](../VS_csharp/using-the-debuggerdisplay-attribute.md)   
