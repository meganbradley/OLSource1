...
## Remarks  
 This function is identical to the function overload [fmod(float, float)](../VS_csharp/fmod-function--c---amp-.md). It’s provided for source-level compatibility with source code that uses the C Standard Library function `fmodf`.  
