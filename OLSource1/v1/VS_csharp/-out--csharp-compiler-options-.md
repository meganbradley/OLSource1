...
-   A .dll or .netmodule will take its name from the first source code file.  
 ...
 The /out compiler option is required in order for an exe to be the target of a friend assembly. For more information see [Friend Assemblies (C#)](../VS_csharp/friend-assemblies--csharp-and-visual-basic-.md).  
...
## See Also  
 ...
 [Friend Assemblies (C#)](../VS_csharp/friend-assemblies--csharp-and-visual-basic-.md)   
