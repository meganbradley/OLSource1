...
## Remarks  
 The <c\> tag gives you a way to indicate that text within a description should be marked as code. Use [<code\>](../VS_csharp/-code---csharp-programming-guide-.md) to indicate multiple lines as code.  
  
 Compile with [/doc](../VS_csharp/-doc--csharp-compiler-options-.md) to process documentation comments to a file.  
  
## Example  
 [!code[csProgGuideDocComments#2](../VS_csharp/codesnippet/CSharp/-c---csharp-programming-guide-_1.cs)]  
