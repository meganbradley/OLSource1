 ...
 **CAtlArray** provides methods for creating and managing an array of elements of a user-defined type. Although similar to standard C arrays, the **CAtlArray** object can dynamically shrink and grow as necessary. The array index always starts at position 0, and the upper bound can be fixed, or allowed to expand as new elements are added.  
 ...
 For arrays with a small number of elements, the ATL class [CSimpleArray](../VS_csharp/csimplearray-class.md) can be used.  
...
### Remarks  
 The new element is added to the end of the array. If no element is provided, an empty element is added; that is, the array is increased in size as though a real element has been added. If the operation fails, [AtlThrow](../VS_csharp/atlthrow.md) is called with the argument E_OUTOFMEMORY.  
  
### Example  
 [!code[NVC_ATL_Utilities#1](../VS_csharp/codesnippet/CPP/catlarray-class_1.cpp)]  
...
### Example  
 [!code[NVC_ATL_Utilities#2](../VS_csharp/codesnippet/CPP/catlarray-class_2.cpp)]  
...
### Example  
 [!code[NVC_ATL_Utilities#3](../VS_csharp/codesnippet/CPP/catlarray-class_3.cpp)]  
...
### Example  
 [!code[NVC_ATL_Utilities#4](../VS_csharp/codesnippet/CPP/catlarray-class_4.cpp)]  
...
> [!NOTE]
>  `CAtlArray::Copy` does not support arrays consisting of elements created with the [CAutoPtr](../VS_csharp/cautoptr-class.md) class.  
  
### Example  
 [!code[NVC_ATL_Utilities#5](../VS_csharp/codesnippet/CPP/catlarray-class_5.cpp)]  
...
### Example  
 [!code[NVC_ATL_Utilities#6](../VS_csharp/codesnippet/CPP/catlarray-class_6.cpp)]  
...
### Example  
 [!code[NVC_ATL_Utilities#7](../VS_csharp/codesnippet/CPP/catlarray-class_7.cpp)]  
...
> [!NOTE]
>  `CAtlArray::InsertArrayAt` does not support arrays consisting of elements created with the [CAutoPtr](../VS_csharp/cautoptr-class.md) class.  
  
### Example  
 [!code[NVC_ATL_Utilities#8](../VS_csharp/codesnippet/CPP/catlarray-class_8.cpp)]  
...
### Example  
 [!code[NVC_ATL_Utilities#9](../VS_csharp/codesnippet/CPP/catlarray-class_9.cpp)]  
...
### Example  
 [!code[NVC_ATL_Utilities#10](../VS_csharp/codesnippet/CPP/catlarray-class_10.cpp)]  
...
### Remarks  
 Performs a similar function to [CAtlArray::GetAt](../Topic/CAtlArray::GetAt.md). Unlike the MFC class [CArray](../VS_csharp/carray-class.md), this operator cannot be used as a substitute for [CAtlArray::SetAt](../Topic/CAtlArray::SetAt.md).  
...
### Example  
 [!code[NVC_ATL_Utilities#11](../VS_csharp/codesnippet/CPP/catlarray-class_11.cpp)]  
...
### Example  
 [!code[NVC_ATL_Utilities#12](../VS_csharp/codesnippet/CPP/catlarray-class_12.cpp)]  
