...
## Remarks  
 ...
 If you don't give an argument for the **check_stack** pragma, stack checking reverts to the behavior specified on the command line. For more information, see [Compiler Reference](../VS_csharp/compiler-options.md). The interaction of the **#pragma check_stack** and the [/Gs](../VS_csharp/-gs--control-stack-checking-calls-.md) option is summarized in the following table.  
