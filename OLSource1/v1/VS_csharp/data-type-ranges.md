...
|char|1|none|–128 to 127 by default<br /><br /> 0 to 255 when compiled by using [/J](../VS_csharp/-j--default-char-type-is-unsigned-.md)|  
...
|wchar_t|2|__wchar_t|0 to 65,535|  
 ...
 C/C++ in Visual Studio also supports sized integer types. For more information, see [__int8, \__int16, \__int32, \__int64](../VS_csharp/__int8--__int16--__int32--__int64.md) and [Integer Limits](../VS_csharp/integer-limits.md).  
  
 For more information about the restrictions of the sizes of each type, see [Fundamental Types](../VS_csharp/fundamental-types---c---.md).  
  
 The range of enumerated types varies depending on the language context and specified compiler flags. For more information, see [C Enumeration Declarations](../VS_csharp/c-enumeration-declarations.md) and [C++ Enumeration Declarations](../VS_csharp/enumerations--c---.md).  
  
## See Also  
 [Keywords](../VS_csharp/keywords--c---.md)   
 [Fundamental Types](../VS_csharp/fundamental-types---c---.md)