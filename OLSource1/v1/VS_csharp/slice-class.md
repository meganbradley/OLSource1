...
## Remarks  
 The class stores the parameters that characterize an object of type [slice_array](../VS_csharp/slice_array-class.md) The subset of a valarray is indirectly constructed when an object of class slice appears as an argument for an object of class [valarray](../VS_csharp/valarray-class.md#valarray__operator_at)**<Type\>**. The stored values that specify the subset selected from the parent valarray include:  
