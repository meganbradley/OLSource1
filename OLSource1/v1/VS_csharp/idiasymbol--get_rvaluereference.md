...
Retrieves a flag that specifies whether a pointer type is an rvalue reference. Use when the [SymTagEnum](../VS_csharp/symtagenum.md) is set to a pointer type.  
