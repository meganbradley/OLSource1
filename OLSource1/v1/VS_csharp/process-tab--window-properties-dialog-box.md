...
Use the **Process** tab to identify the process of the selected window. To display the [Window Properties Dialog Box](../VS_csharp/window-properties-dialog-box.md), move the focus to the [Windows View](../VS_csharp/windows-view.md) window. Select any window node in the tree, then choose **Properties** from the **View** menu.  
