...
-   Use animations that require user interaction to reset the state, such as forcing the user to respond to a flashing notification in order to make it stop flashing. Interacting with them in any way should be sufficient to dismiss them.  
 ...
 For more information on applications for these best practices, see [Animation patterns](../VS_csharp/animations-for-visual-studio.md#BKMK_AnimationPatterns).  
...
-   Relaxed, not hurried  
 ...
 ![Recommended animation styles for Visual Studio](../VS_csharp/media/1202-a_vsanimstyles.png "1202-a_VSAnimStyles")  
...
#### Appear and disappear  
 ...
 ![Appear&#47;Disappear animation in Visual Studio](../VS_csharp/media/1202-b_appearanddisappear.png "1202-b_AppearAndDisappear")  
...
#### Fade-in and fade-out  
 ...
 ![Fade&#45;in&#47;Fade&#45;out animation in Visual Studio](../VS_csharp/media/1202-c_fadeinfadeout.png "1202-c_FadeInFadeOut")  
...
#### Color blend from A to B  
 ...
 ![Color blend animation in Visual Studio](../VS_csharp/media/1202-d_colorblend.png "1202-d_ColorBlend")  
...
#### Expand and contract  
 ...
 ![Expand&#47;Contract animation in Visual Studio](../VS_csharp/media/1202-e_expandcontract.png "1202-e_ExpandContract")  
...
#### X-Y position change  
 ...
 ![X&#47;Y position change animation in Visual Studio](../VS_csharp/media/1202-f_xypositionchange.png "1202-f_XYPositionChange")  
...
#### Rotate  
 ...
 ![Rotate animation in Visual Studio](../VS_csharp/media/1202-g_rotate.png "1202-g_Rotate")  
...
-   Duration: Zero seconds  
 ...
 ![Tab open animation in Visual Studio](../VS_csharp/media/1202-h_tabopen.png "1202-h_TabOpen")  
...
-   Duration: 200 milliseconds  
 ...
 ![Tab close animation in Visual Studio](../VS_csharp/media/1202-i_tabclose.png "1202-i_TabClose")  
...
-   Duration: 200 milliseconds  
 ...
 ![Tab reorder animation in Visual Studio](../VS_csharp/media/1202-j_tabreorder.png "1202-j_TabReorder")  
...
-   Duration: 200 milliseconds  
 ...
 ![Close floating document animation in Visual Studio](../VS_csharp/media/1202-k_closefloatingdocument.png "1202-k_CloseFloatingDocument")  
...
-   Duration: 200 milliseconds  
 ...
 ![Window state transition animation in Visual Studio](../VS_csharp/media/1202-l_windowstatetransition.png "1202-l_WindowStateTransition")  
...
-   Duration: 200 milliseconds  
 ...
 ![Menu open animation in Visual Studio](../VS_csharp/media/1202-m_menuopen.png "1202-m_MenuOpen")  
...
-   Duration: 200 milliseconds  
 ...
 ![Menu close animation in Visual Studio](../VS_csharp/media/1202-n_menuclose.png "1202-n_MenuClose")  
...
-   Duration: Zero seconds  
 ...
 ![Auto&#45;hide tool window animation in Visual Studio](../VS_csharp/media/1202-o_autohidetoolwindowreveal.png "1202-o_AutoHideToolWindowReveal")