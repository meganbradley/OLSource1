...
This is a library intrinsic. Calls to this function may be generated by uses of the generic [pown](../VS_csharp/operators.pown-^t--function--fsharp-.md) operator on values of type `decimal`.  
...
#### Parameters  
 `x`  
 Type: [decimal](../VS_csharp/core.decimal-type-abbreviation--fsharp-.md)  
