...
#### Parameters  
 ...
 `wType`  
 [in] Indicates the data type of the value part of the buffer. For information about type indicators, see [Data Types](https://msdn.microsoft.com/en-us/library/ms723969.aspx) in the *OLE DB Programmer's Reference* in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
## Remarks  
 ...
 For information about using bookmarks in consumers, see [Using Bookmarks](../VS_csharp/using-bookmarks.md).  
