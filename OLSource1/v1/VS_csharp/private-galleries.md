...
-   Create an Atom (RSS) feed to a suitably configured central location (repository) on your intranet. For more information, see [How To: Create an Atom Feed for a Private Gallery](../VS_csharp/how-to--create-an-atom-feed-for-a-private-gallery.md).  
...
## Adding a Private Gallery to Extensions and Updates in Visual Studio  
 ...
 ![Extension Manager Add Dialog](../VS_csharp/media/em_adddialog.png "EM_AddDialog")  
...
```  
 ...
 For more information, see [How To: Manage a Private Gallery with Registry Settings](../VS_csharp/how-to--manage-a-private-gallery-by-using-registry-settings.md).  
...
## Installing Extensions from a Private Gallery  
 ...
 ![Extension Manager Installing Private Gallery](../VS_csharp/media/em_.png "EM_")  
...
## Updating Extensions from a Private Gallery  
 ...
 ![Extension Manager Private Gallery Update](../VS_csharp/media/em_update.png "EM_Update")  
...
## See Also  
 [Installing and Managing Visual Studio Tools and Extensions](../VS_csharp/finding-and-using-visual-studio-extensions.md)   
