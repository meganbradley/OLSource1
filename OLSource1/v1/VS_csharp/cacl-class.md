...
|Name|Description|  
|----------|-----------------|  
|[CAcl::AccessMaskArray](../Topic/CAcl::CAccessMaskArray.md)|An array of `ACCESS_MASK`s.|  
...
-   System  
 ...
 For more details, see the [ACL](http://msdn.microsoft.com/library/windows/desktop/aa374872) discussion in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Parameters  
 `pSids`  
 A pointer to an array of [CSid](../VS_csharp/csid-class.md) objects.  
...
### Parameters  
 ...
 `pSid`  
 The [CSid](../VS_csharp/csid-class.md) object to which the ACL entry applies.  
