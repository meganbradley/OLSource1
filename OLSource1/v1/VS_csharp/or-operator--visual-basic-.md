...
> [!NOTE]
>  In a `Boolean` comparison, the `Or` operator always evaluates both expressions, which could include making procedure calls. The [OrElse Operator](../VS_csharp/orelse-operator--visual-basic-.md) performs *short-circuiting*, which means that if `expression1` is `True`, then `expression2` is not evaluated.  
...
## Example  
 ...
 [!code[VbVbalrOperators#35](../VS_csharp/codesnippet/VisualBasic/or-operator--visual-basic-_1.vb)]  
...
## Example  
 ...
 [!code[VbVbalrOperators#36](../VS_csharp/codesnippet/VisualBasic/or-operator--visual-basic-_2.vb)]  
