...
```  
 ...
 [!code[FsLangRef2#4001](../VS_csharp/codesnippet/FSharp/operator-overloading--fsharp-_1.fs)]  
...
## Creating New Operators  
 ...
 A table that shows the precedence of all operators in F# can be found in [Symbol and Operator Reference](../VS_csharp/symbol-and-operator-reference--fsharp-.md).  
...
## Example  
 ...
 [!code[FsLangRef2#4002](../VS_csharp/codesnippet/FSharp/operator-overloading--fsharp-_2.fs)]  
...
## Operators at the Global Level  
 ...
 [!code[FsLangRef2#4003](../VS_csharp/codesnippet/FSharp/operator-overloading--fsharp-_3.fs)]  
 ...
 The keyword `inline` is often used with global operators, which are often small functions that are best integrated into the calling code. Making operator functions inline also enables them to work with statically resolved type parameters to produce statically resolved generic code. For more information, see [Inline Functions](../VS_csharp/inline-functions--fsharp-.md) and [Statically Resolved Type Parameters](../VS_csharp/statically-resolved-type-parameters--fsharp-.md).  
