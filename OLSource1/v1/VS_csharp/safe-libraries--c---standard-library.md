...
Several enhancements have been made to the libraries that ship with Visual C++, including the Standard C++ Library, to make them more secure.  
 ...
 Several enhancements have also been made to make iterators and algorithms more secure. For more information, see [Checked Iterators](../VS_csharp/checked-iterators.md), [Debug Iterator Support](../VS_csharp/debug-iterator-support.md) and [_ITERATOR_DEBUG_LEVEL](../VS_csharp/_iterator_debug_level.md).  
...
|[char_traits::copy](../Topic/char_traits::copy.md)|[char_traits::_Copy_s](../Topic/char_traits::_Copy_s.md)|  
 ...
 If you call any one of the potentially unsafe methods above, or if you use iterators incorrectly, the compiler will generate [Compiler Warning (level 1) C4996](../VS_csharp/compiler-warning--level-3--c4996.md). For information on how to disable these warnings, see [_SCL_SECURE_NO_WARNINGS](../VS_csharp/_scl_secure_no_warnings.md).  
  
## In This Section  
 [_ITERATOR_DEBUG_LEVEL](../VS_csharp/_iterator_debug_level.md)  
  
 [_SCL_SECURE_NO_WARNINGS](../VS_csharp/_scl_secure_no_warnings.md)  
  
 [Checked Iterators](../VS_csharp/checked-iterators.md)  
  
 [Debug Iterator Support](../VS_csharp/debug-iterator-support.md)  
