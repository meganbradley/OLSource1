...
1.  Add an integer variable that's named **timeLeft**, just like you did in the previous procedure. Your code should look like the following.  
     ...
     [!code[VbExpressTutorial3Step3#5](../VS_csharp/codesnippet/VisualBasic/step-3--add-a-countdown-timer_1.vb)]
[!code[VbExpressTutorial3Step3#5](../VS_csharp/codesnippet/CSharp/step-3--add-a-countdown-timer_1.cs)]  
...
5.  Add the following statements to the new event handler method.  
     ...
     [!code[VbExpressTutorial3Step3#6](../VS_csharp/codesnippet/VisualBasic/step-3--add-a-countdown-timer_2.vb)]
[!code[VbExpressTutorial3Step3#6](../VS_csharp/codesnippet/CSharp/step-3--add-a-countdown-timer_2.cs)]  
    ...
    ```  
     ...
     [!code[VbExpressTutorial3Step3#24](../VS_csharp/codesnippet/VisualBasic/step-3--add-a-countdown-timer_3.vb)]
[!code[VbExpressTutorial3Step3#24](../VS_csharp/codesnippet/CSharp/step-3--add-a-countdown-timer_3.cs)]  
...
6.  Add three lines to the end of the `StartTheQuiz()` method, so the code looks like the following.  
     ...
     [!code[VbExpressTutorial3Step3#7](../VS_csharp/codesnippet/VisualBasic/step-3--add-a-countdown-timer_4.vb)]
[!code[VbExpressTutorial3Step3#7](../VS_csharp/codesnippet/CSharp/step-3--add-a-countdown-timer_4.cs)]  
...
7.  Save your program, run it, and then choose the **Start** button on the form.  
     ...
     ![Math quiz in progress](../VS_csharp/media/express_addcountdown.png "Express_AddCountdown")  
Math quiz in progress  
  
### To continue or review  
  
-   To go to the next tutorial step, see [Step 4: Add the CheckTheAnswer() Method](../VS_csharp/step-4--add-the-checktheanswer---method.md).  
  
-   To return to the previous tutorial step, see [Step 2: Create a Random Addition Problem](../VS_csharp/step-2--create-a-random-addition-problem.md).