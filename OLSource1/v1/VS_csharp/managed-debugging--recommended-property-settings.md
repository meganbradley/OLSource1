...
Certain properties should be set the same way for all managed debugging scenarios.  
 ...
 Settings not listed here may vary among the different managed project types. For example, **Start Action** will be set differently in a Windows Forms project than in a [!INCLUDE[vstecasp](../VS_csharp/includes/vstecasp_md.md)] project.  
...
|**Optimize code**|C#, F#, and Visual Basic: Set to false. Optimized code is harder to debug, because the generated instructions do not correspond directly to your source code. If you find your program has a bug that appears only in optimized code, you can turn this setting on, but remember that code shown in the **Disassembly** window is generated from optimized source that might not match what you see in the Code Editor. To debug optimized code, you must turn off Just My Code. (See [Restrict stepping to Just My Code](../VS_csharp/navigating-through-code-with-the-debugger.md#BKMK_Restrict_stepping_to_Just_My_Code)).<br /><br /> For more information, see [Project Settings for  C# Debug Configurations](../VS_csharp/project-settings-for--csharp-debug-configurations.md) or [Project Settings for a Visual Basic Debug Configuration](../VS_csharp/project-settings-for-a-visual-basic-debug-configuration.md).|  
...
## See Also  
 ...
 [Debugging Preparation: C# and Visual Basic Project Types](../VS_csharp/debugging-preparation--csharp--fsharp--and-visual-basic-project-types.md)