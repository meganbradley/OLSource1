...
## Remarks  
 ...
 [!code[NVC_MFCCObjectSample#20](../VS_csharp/codesnippet/CPP/declare_serial_1.h)]  
  
 For more information on the `DECLARE_SERIAL` macro, see [CObject Class Topics](../VS_csharp/using-cobject.md).  
  
## Example  
 [!code[NVC_MFCCObjectSample#21](../VS_csharp/codesnippet/CPP/declare_serial_2.h)]  
