...
## Example  
 The following example illustrates the StopProfile method. The example assumes that a call to the StartProfile method has been made for the same thread or process identified by [PROFILE_CURRENTID](../VS_csharp/profile_currentid.md).  
