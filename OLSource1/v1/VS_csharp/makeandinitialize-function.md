...
## Remarks  
 See [How to: Instantiate WRL Components Directly](../VS_csharp/how-to--instantiate-wrl-components-directly.md) to learn the differences between this function and [Microsoft::WRL::Make](../VS_csharp/make-function.md), and for an example.  
