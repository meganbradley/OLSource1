...
|Element|Description|  
|-------------|-----------------|  
|[Reference](../VS_csharp/reference-element--visual-studio-templates-.md)|Specifies the assembly reference to add when the item is added to a project.|  
...
## See Also  
 [References Element (Visual Studio Templates)](../VS_csharp/references-element--visual-studio-templates-.md)   
 [Reference Element (Visual Studio Templates)](../VS_csharp/reference-element--visual-studio-templates-.md)   
