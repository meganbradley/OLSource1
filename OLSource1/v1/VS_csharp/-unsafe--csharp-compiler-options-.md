...
The **/unsafe** compiler option allows code that uses the [unsafe](../VS_csharp/unsafe--csharp-reference-.md) keyword to compile.  
...
## Remarks  
 For more information about unsafe code, see [Unsafe Code and Pointers (C# Programmer's Reference)](../VS_csharp/unsafe-code-and-pointers--csharp-programming-guide-.md).  
