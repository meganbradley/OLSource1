...
## Preparing to Upgrade  
 ...
 If the project uses extensions, they must already be installed on the computer where you are performing the upgrade or the upgrade will fail. This requirement includes any extensions that the project references but doesn't use; you should remove any unused extensions before you upgrade. For more information, see [How to: Add or Remove Extensions](../VS_csharp/how-to--add-or-remove-extensions.md).  
...
## See Also  
 ...
 [How to: Handle Data Events](../VS_csharp/how-to--handle-data-events.md)   
 [How to: Upgrade a SharePoint-enabled LightSwitch App](../VS_csharp/how-to--upgrade-a-sharepoint-enabled-lightswitch-app.md)