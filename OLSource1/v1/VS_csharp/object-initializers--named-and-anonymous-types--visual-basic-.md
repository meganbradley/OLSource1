...
## Declarations  
 ...
 [!code[VbVbalrObjectInit#1](../VS_csharp/codesnippet/VisualBasic/object-initializers--named-and-anonymous-types--visual-basic-_1.vb)]  
  
 An anonymous type has no usable name. Therefore an instantiation of an anonymous type cannot include a class name.  
  
 [!code[VbVbalrObjectInit#2](../VS_csharp/codesnippet/VisualBasic/object-initializers--named-and-anonymous-types--visual-basic-_2.vb)]  
...
## Named Types  
 ...
 [!code[VbVbalrObjectInit#3](../VS_csharp/codesnippet/VisualBasic/object-initializers--named-and-anonymous-types--visual-basic-_3.vb)]  
  
 Alternatively, you can obtain the same result by using the following code:  
  
 [!code[VbVbalrObjectInit#4](../VS_csharp/codesnippet/VisualBasic/object-initializers--named-and-anonymous-types--visual-basic-_4.vb)]  
 ...
 [!code[VbVbalrObjectInit#5](../VS_csharp/codesnippet/VisualBasic/object-initializers--named-and-anonymous-types--visual-basic-_5.vb)]  
 ...
 [!code[VbVbalrObjectInit#6](../VS_csharp/codesnippet/VisualBasic/object-initializers--named-and-anonymous-types--visual-basic-_6.vb)]  
  
 You do not have to initialize all properties, as the following code shows.  
  
 [!code[VbVbalrObjectInit#7](../VS_csharp/codesnippet/VisualBasic/object-initializers--named-and-anonymous-types--visual-basic-_7.vb)]  
...
### Type Inference with Named Types  
 ...
 [!code[VbVbalrObjectInit#8](../VS_csharp/codesnippet/VisualBasic/object-initializers--named-and-anonymous-types--visual-basic-_8.vb)]  
...
-   A class member cannot be initialized more than one time in the object initializer list. The declaration of `cust7` causes an error.  
     ...
     [!code[VbVbalrObjectInit#9](../VS_csharp/codesnippet/VisualBasic/object-initializers--named-and-anonymous-types--visual-basic-_9.vb)]  
...
-   A member can be used to initialize itself or another field. If a member is accessed before it has been initialized, as in the following declaration for `cust8`, the default value will be used. Remember that when a declaration that uses an object initializer is processed, the first thing that happens is that the appropriate constructor is invoked. After that, the individual fields in the initializer list are initialized. In the following examples, the default value for `Name` is assigned for `cust8`, and an initialized value is assigned in `cust9`.  
     ...
     [!code[VbVbalrObjectInit#10](../VS_csharp/codesnippet/VisualBasic/object-initializers--named-and-anonymous-types--visual-basic-_10.vb)]  
     ...
     [!code[VbVbalrObjectInit#11](../VS_csharp/codesnippet/VisualBasic/object-initializers--named-and-anonymous-types--visual-basic-_11.vb)]  
...
-   Object initializers can be nested. In the following example, `AddressClass` is a class that has two properties, `City` and `State`, and the `Customer` class has an `Address` property that is an instance of `AddressClass`.  
     ...
     [!code[VbVbalrObjectInit#12](../VS_csharp/codesnippet/VisualBasic/object-initializers--named-and-anonymous-types--visual-basic-_12.vb)]  
...
## Anonymous Types  
 ...
 [!code[VbVbalrObjectInit#13](../VS_csharp/codesnippet/VisualBasic/object-initializers--named-and-anonymous-types--visual-basic-_13.vb)]  
...
>  The name of the anonymous type is generated by the compiler, and may vary from compilation to compilation. Your code should not use or rely on the name of an anonymous type.  
 ...
 Anonymous types provide critical support for [!INCLUDE[vbteclinq](../VS_csharp/includes/vbteclinq_md.md)] queries. For more information about the use of anonymous types in queries, see [Anonymous Types](../VS_csharp/anonymous-types--visual-basic-.md) and [Introduction to LINQ in Visual Basic](../VS_csharp/introduction-to-linq-in-visual-basic.md).  
...
-   Typically, all or most of the properties in an anonymous type declaration will be key properties, which are indicated by typing the keyword `Key` in front of the property name.  
     ...
     [!code[VbVbalrObjectInit#14](../VS_csharp/codesnippet/VisualBasic/object-initializers--named-and-anonymous-types--visual-basic-_14.vb)]  
  
     For more information about key properties, see [Key](../VS_csharp/key--visual-basic-.md).  
...
-   Anonymous types can also establish the names and values of their properties in several other ways. For example, an anonymous type property can take both the name and the value of a variable, or the name and value of a property of another object.  
     ...
     [!code[VbVbalrObjectInit#15](../VS_csharp/codesnippet/VisualBasic/object-initializers--named-and-anonymous-types--visual-basic-_15.vb)]  
  
     For more information about the options for defining properties in anonymous types, see [How to: Infer Property Names and Types in Anonymous Types](../VS_csharp/how-to--infer-property-names-and-types-in-anonymous-type-declarations--visual-basic-.md).  
...
## See Also  
 ...
 [How to: Infer Property Names and Types in Anonymous Types](../VS_csharp/how-to--infer-property-names-and-types-in-anonymous-type-declarations--visual-basic-.md)   
