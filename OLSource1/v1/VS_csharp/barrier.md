...
## Remarks  
 ...
 For more information, see [2.6.3 barrier Directive](../VS_csharp/2.6.3-barrier-directive.md).  
  
## Example  
 For a sample of how to use `barrier`, see [master](../VS_csharp/master.md).  
