...
The restrictions that apply to type parameters on classes are the same as those that apply to type parameters on interfaces (see [Generic Classes (C++)](../VS_csharp/generic-classes--c---cli-.md)).  
 ...
 For more information on interfaces, see [interface class](../VS_csharp/interface-class---c---component-extensions-.md).  
 ...
 **class** or **typename**  
 ...
 Takes the form specified in [Constraints](../VS_csharp/constraints-on-generic-type-parameters--c---cli-.md)  
