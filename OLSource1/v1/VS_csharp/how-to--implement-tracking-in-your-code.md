...
To track an OLE item, you must handle certain events related to the item, such as clicking the item or updating the view of the document. In all cases, it is sufficient to declare a temporary [CRectTracker](../VS_csharp/crecttracker-class.md) object and manipulate the item by means of this object.  
...
|Hatching pattern overlays item|Item's server is open|  
 ...
 [!code[NVC_MFCOClient#1](../VS_csharp/codesnippet/CPP/how-to--implement-tracking-in-your-code_1.cpp)]  
  
 The tracker is initialized by setting the minimum size and clearing the style of the tracker.  
  
 [!code[NVC_MFCOClient#2](../VS_csharp/codesnippet/CPP/how-to--implement-tracking-in-your-code_2.cpp)]  
 ...
 [!code[NVC_MFCOClient#3](../VS_csharp/codesnippet/CPP/how-to--implement-tracking-in-your-code_3.cpp)]  
  
 The following code overlays the item with a hatched pattern if the item is currently open.  
  
 [!code[NVC_MFCOClient#4](../VS_csharp/codesnippet/CPP/how-to--implement-tracking-in-your-code_4.cpp)]  
 ...
 [!code[NVC_MFCOClient#5](../VS_csharp/codesnippet/CPP/how-to--implement-tracking-in-your-code_5.cpp)]  
