...
2.  Create a [!INCLUDE[vstecasp](../VS_csharp/includes/vstecasp_md.md)] page that embeds the control.  
  
3.  In the Web site that is hosting the [!INCLUDE[vstecasp](../VS_csharp/includes/vstecasp_md.md)] test harness, create a subdirectory called `/Code`.  
