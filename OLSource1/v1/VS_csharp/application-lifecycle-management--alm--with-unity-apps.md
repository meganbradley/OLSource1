...
|[CodeLens](../VS_csharp/find-code-changes-and-other-history-with-codelens.md)|Yes||  
...
|[Unit tests](../VS_csharp/unit-test-your-code.md)|Within Unity, but not Visual Studio|Unity provides its own unit test framework as part of [Unity Test Tools](https://www.assetstore.unity3d.com/en/#!/content/13802) (Unity Asset Store). Unit test results are reported within Unity and will not be surfaced within Visual Studio.|  
|[Automated (Coded) UI tests](../VS_csharp/use-ui-automation-to-test-your-code.md)|No|Coded UI tests rely on readable controls in the app’s UI; Unity apps are graphical in nature and so content isn’t readable by the Coded UI test tools.|  
...
|Feature|Supported with Unity|Additional Comments|  
|-------------|--------------------------|-------------------------|  
|[Code quality analysis](../VS_csharp/analyzing-managed-code-quality-by-using-code-analysis.md)|Yes|Can analyze the C# script code within Visual Studio.|  
|[Code clone detection](../VS_csharp/finding-duplicate-code-by-using-code-clone-detection.md)|Yes|Can analyze the C# script code within Visual Studio.|  
|[Code metrics](../VS_csharp/measuring-complexity-and-maintainability-of-managed-code.md)|Yes|Can analyze the C# script code within Visual Studio.|  
|[Performance profiling](../VS_csharp/performance-explorer.md)|No|Use the [Unity Profiler](http://docs.unity3d.com/Manual/Profiler.html) (Unity website).|  
|[.NET Framework memory analysis](../Topic/Analyze%20.NET%20Framework%20memory%20issues.md)|No|Visual Studio tools do not have hooks into the Mono framework (as used by Unity) for profiling. Use the [Unity Profiler](http://docs.unity3d.com/Manual/Profiler.html) (Unity documentation).|  
