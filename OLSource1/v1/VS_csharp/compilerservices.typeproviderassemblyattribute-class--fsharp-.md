...
|Member|Description|  
|------------|-----------------|  
|[new](../VS_csharp/compilerservices.typeproviderassemblyattribute-constructor--fsharp-.md)|Creates an instance of the attribute|  
  
## Instance Members  
  
|Member|Description|  
|------------|-----------------|  
|[AssemblyName](../VS_csharp/typeproviderassemblyattribute.assemblyname-property--fsharp-.md) : [string](../VS_csharp/core.string-type-abbreviation--fsharp-.md)|Specifies the name of the design-time assembly for this type provider.|  
