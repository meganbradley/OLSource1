...
#### Parameters  
 ...
 `assemBytes`  
 [out] Returns an [IEEDataStorage](../VS_csharp/ieedatastorage.md) object containing the assembly bytes of this object (this is a null value if no bytes are available).  
 ...
 `alr`  
 [out] Returns a value from the [ASSEMBLYLOCRESOLUTION](../VS_csharp/assemblylocresolution.md) enumeration indicating the location of the assembly.  
