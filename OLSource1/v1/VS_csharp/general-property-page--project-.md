 ...
 **Target Platform Version**  
 For the Windows platform, specifies the version of the Windows SDK that your project builds with. For Windows, this is the Windows SDK version. [!INCLUDE[vs_dev14](../VS_csharp/includes/vs_dev14_md.md)] ships with Windows SDK 8.1. If you installed the [Tools for Windows 10](http://go.microsoft.com/fwlink/p/?LinkId=617631), each version of those tools that you have installed appears in the dropdown.  
  
 To target Windows 7 or Windows Vista, use the value **8.1**, since Windows SDK 8.1 is backward compatible to those platforms. In addition, you should define the appropriate value for _WIN32_WINNT in targetver.h. For Windows 7, that's 0x0601. See [Modifying WINVER and _WINT32_WINNT](../VS_csharp/modifying-winver-and-_win32_winnt.md).  
  
 You can install the v110_xp platform toolset included in [!INCLUDE[vs_dev11_long](../VS_csharp/includes/vs_dev11_long_md.md)] to use the current version of [!INCLUDE[vsprvs](../VS_csharp/includes/vsprvs_md.md)] to build Windows XP and [!INCLUDE[WinXPSvr](../VS_csharp/includes/winxpsvr_md.md)] projects. For information on how to obtain and use this platform toolset, see [Configuring C++ 11 Programs for Windows XP](../VS_csharp/configuring-programs-for-windows-xp.md). For additional information on changing the platform toolset, see [How to: Modify the Target Framework and Platform Toolset](../VS_csharp/how-to--modify-the-target-framework-and-platform-toolset.md).  
 ...
 **Build Log File**  
 ...
 You can use project macros to change the directory location. See [Macros for Build Commands and Properties](../VS_csharp/common-macros-for-build-commands-and-properties.md).  
  
 **Platform Toolset**  
 Allows the project to target a different version of the Visual C++ libraries and compiler. [!INCLUDE[vcprvc](../VS_csharp/includes/vcprvc_md.md)] projects can target either the default toolset in [!INCLUDE[vs_dev11_long](../VS_csharp/includes/vs_dev11_long_md.md)] (**v100**) or the toolset that creates executables that can run on Windowx XP.  
 ...
 **Common Language Runtime support**  
 Causes the [/clr](../VS_csharp/-clr--common-language-runtime-compilation-.md) compiler option to be used.  
 ...
 **Whole Program Optimization**  
 Specifies the [/GL](../VS_csharp/-gl--whole-program-optimization-.md) compiler option and [/LTCG](../VS_csharp/-ltcg--link-time-code-generation-.md) linker option.  
  
 **Windows Store App Support**  
 Specifies whether this project supports [!INCLUDE[win8_appname_long](../VS_csharp/includes/win8_appname_long_md.md)] apps. For more information, see [/ZW (Windows Runtime Compilation)](../VS_csharp/-zw--windows-runtime-compilation-.md), and the Windows Developer Center.  
