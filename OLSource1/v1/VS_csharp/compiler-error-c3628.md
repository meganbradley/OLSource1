...
'base class' : managed or WinRTclasses only support public inheritance  
 ...
 An attempt was made to use a managed or WinRT class as a [private](../VS_csharp/private--c---.md) or [protected](../VS_csharp/protected--c---.md) base class. A managed or WinRT class can only be used as a base class with [public](../VS_csharp/public--c---.md) access.  
