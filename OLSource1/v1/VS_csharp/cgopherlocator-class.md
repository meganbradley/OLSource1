...
---
# CGopherLocator Class
Gets a gopher "locator" from a gopher server, determines the locator's type, and makes the locator available to [CGopherFileFind](../VS_csharp/cgopherfilefind-class.md).  
...
## Remarks  
 ...
 An application normally uses the locator for calls to [CGopherFileFind::FindFile](../VS_csharp/cgopherfilefind-class.md#cgopherfilefind__findfile) to retrieve a specific piece of information.  
  
 To learn more about how `CGopherLocator` works with the other MFC Internet classes, see the article [Internet Programming with WinInet](../VS_csharp/win32-internet-extensions--wininet-.md).  
...
### Remarks  
 You never create a `CGopherLocator` object directly. Instead, call [CGopherConnection::CreateLocator](../VS_csharp/cgopherconnection-class.md#cgopherconnection__createlocator) to create and return a pointer to the `CGopherLocator` object.  
