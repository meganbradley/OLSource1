...
|Member|Description|  
|------------|-----------------|  
|[new](../VS_csharp/core.sealedattribute-constructor--fsharp-.md)|Creates an instance of the attribute|  
  
## Instance Members  
  
|Member|Description|  
|------------|-----------------|  
|[Value](../VS_csharp/sealedattribute.value-property--fsharp-.md)|The value of the attribute, indicating whether the type is sealed or not.|  
