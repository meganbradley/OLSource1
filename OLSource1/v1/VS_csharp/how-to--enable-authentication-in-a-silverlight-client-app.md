...
> [!NOTE]
>  The process for setting permissions differs for HTML clients – see [How to: Enable Authentication in an HTML Client App](../VS_csharp/how-to--enable-authentication-in-an-html-client-app.md). LightSwitch apps that have been enabled for SharePoint use SharePoint authentication for access control.  
...
-   [Authentication](../VS_csharp/how-to--enable-authentication-in-a-silverlight-client-app.md#auth)  
  
-   [Permissions](../VS_csharp/how-to--enable-authentication-in-a-silverlight-client-app.md#perms)  
  
-   [Publishing and Administration](../VS_csharp/how-to--enable-authentication-in-a-silverlight-client-app.md#admin)  
...
-   Follow the steps in [Administering a LightSwitch Application](../VS_csharp/administering-a-lightswitch-application.md).  
...
## See Also  
 [Silverlight Client Screens for LightSwitch Apps](../VS_csharp/silverlight-client-screens-for-lightswitch-apps.md)   
 [Administering a LightSwitch Application](../VS_csharp/administering-a-lightswitch-application.md)   
 [How to: Enable Authentication in an HTML Client App](../VS_csharp/how-to--enable-authentication-in-an-html-client-app.md)   
 [Creating Secure Applications](../VS_csharp/security-considerations-for-lightswitch.md)   
