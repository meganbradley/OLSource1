...
|Name|Description|  
|----------|-----------------|  
|[ObjectIdForDebugger property](../VS_csharp/asynctaskmethodbuilder-tresult-.objectidfordebugger-property.md)|Gets an object that may be used to uniquely identify this builder to the debugger.|  
|[m_task field](../VS_csharp/asynctaskmethodbuilder-tresult-.m_task-field.md)|Represents the lazily initialized built task.|  
