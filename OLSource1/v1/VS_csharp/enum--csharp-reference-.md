...
```  
 ...
 In this enumeration, the sequence of elements is forced to start from `1` instead of `0`. However, including a constant that has the value of 0 is recommended. For more information, see [Enumeration Types](../VS_csharp/enumeration-types--csharp-programming-guide-.md).  
...
## Robust Programming  
 Just as with any constant, all references to the individual values of an enum are converted to numeric literals at compile time. This can create potential versioning issues as described in [Constants](../VS_csharp/constants--csharp-programming-guide-.md).  
...
## See Also  
 ...
 [Enumeration Types](../VS_csharp/enumeration-types--csharp-programming-guide-.md)   
