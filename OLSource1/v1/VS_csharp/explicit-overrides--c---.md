...
**Microsoft Specific**  
 ...
 If the same virtual function is declared in two or more [interfaces](../VS_csharp/__interface.md) and if a class is derived from these interfaces, you can explicitly override each virtual function.  
  
 For information on explicit overrides in managed code using the new managed syntax, see [Explicit Overrides](../VS_csharp/explicit-overrides---c---component-extensions-.md).  
