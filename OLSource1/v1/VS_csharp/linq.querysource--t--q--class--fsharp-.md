...
apitype: "Assembly"
f1_keywords: 
  - "Microsoft.FSharp.Linq.QuerySource``2.#ctor"
dev_langs: 
  - "FSharp"
...
|Member|Description|  
|------------|-----------------|  
|[new](../VS_csharp/linq.querysource--t--q--constructor--fsharp-.md)|Create a new QuerySource object from an enumerable sequence.|  
  
## Instance Members  
  
|Member|Description|  
|------------|-----------------|  
|[Source](../VS_csharp/querysource.source--t--q--property--fsharp-.md): seq<'T>|The enumerable sequence that is associated with a query.|  
