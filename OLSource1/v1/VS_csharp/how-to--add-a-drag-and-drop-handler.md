...
You can add handlers for drag-and-drop events to your DSL, so that users can drag items onto your diagram from other diagrams or from other parts of [!INCLUDE[vsprvs](../VS_csharp/includes/vsprvs_md.md)]. You can also add handlers for events such as double-clicks. Together, drag-and-drop and double-click handlers are known as *gesture handlers*.  
  
 This topic discusses drag-and-drop gestures that originate on other diagrams. For move and copy events within a single diagram, consider the alternative of defining a subclass of `ElementOperations`. For more information, see [How to Customize Copy and Move](../VS_csharp/customizing-copy-behavior.md). You might also be able to customize the DSL definition.  
...
-   <xref:Microsoft.VisualStudio.Modeling.Diagrams.ShapeElement.OnDoubleClick*> – This method is called when the user double-clicks the shape or diagram.  
     ...
     For more information, see [How to intercept a click on a shape or decorator](../VS_csharp/how-to--intercept-a-click-on-a-shape-or-decorator.md).  
...
1.  Add to your **Dsl** and **DslPackage** projects the **MefExtension** files that are described in [Extend your DSL by using MEF](../VS_csharp/extend-your-dsl-by-using-mef.md).  
...
1.  Make the source DSL accessible by [!INCLUDE[vsprvs](../VS_csharp/includes/vsprvs_md.md)] Model Bus:  
...
## See Also  
 [How to customize copy](../VS_csharp/customizing-copy-behavior.md)   
