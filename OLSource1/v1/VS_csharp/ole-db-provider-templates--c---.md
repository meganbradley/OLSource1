...
-   Visual C++ 6.0 supported only read-only providers. [Creating an OLE DB Provider](../VS_csharp/creating-an-ole-db-provider.md) discusses how to create a read-only provider.  
  
-   Visual C++ .NET supports updatable providers, which can update (write to) the data store. For information about updatable providers, see [Creating an Updatable Provider](../VS_csharp/creating-an-updatable-provider.md); the [UpdatePV](assetId:///c8bed873-223c-4a7d-af55-f90138c6f38f) sample is an example of an updatable provider.  
  
 For more information, see:  
  
-   [The OLE DB Provider Template Architecture](../VS_csharp/ole-db-provider-template-architecture.md)  
