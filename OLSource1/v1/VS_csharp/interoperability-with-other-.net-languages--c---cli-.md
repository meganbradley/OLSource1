...
## In This Section  
 [How to: Implement is and as C# Keywords in C++](../VS_csharp/how-to--implement-is-and-as-csharp-keywords--c---cli-.md)  
  
 [How to: Implement the lock C# Keyword in C++](../VS_csharp/how-to--implement-the-lock-csharp-keyword--c---cli-.md)  
  
 [How to: Consume a C# Indexer](../VS_csharp/how-to--consume-a-csharp-indexer--c---cli-.md)  
