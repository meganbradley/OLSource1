...
## Remarks  
 ...
 [!code[NVC_MFCAutomation#11](../VS_csharp/codesnippet/CPP/on_event_range_1.cpp)]  
  
 specifies a list containing a short integer followed by a **BOOL**.  
  
 For a list of the **VTS_** constants, see [EVENT_CUSTOM](../VS_csharp/event_custom.md).  
...
## Example  
 ...
 [!code[NVC_MFCAutomation#12](../VS_csharp/codesnippet/CPP/on_event_range_2.h)]  
  
 The code below is defined in the implementation file of the dialog class.  
  
 [!code[NVC_MFCAutomation#13](../VS_csharp/codesnippet/CPP/on_event_range_3.cpp)]  
...
## See Also  
 ...
 [ON_EVENT](../VS_csharp/on_event.md)   
 [ON_PROPNOTIFY](../VS_csharp/on_propnotify.md)   
 [ON_PROPNOTIFY_RANGE](../VS_csharp/on_propnotify_range.md)