...
2.  Add the Microsoft ADO data control to the dialog box; see [Inserting the Control into a Visual C++ Application](../VS_csharp/inserting-the-control-into-a-visual-c---application.md).  
