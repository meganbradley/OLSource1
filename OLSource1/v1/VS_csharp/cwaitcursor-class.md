...
>  Because of how their constructors and destructors work, `CWaitCursor` objects are always declared as local variables — they're never declared as global variables nor are they allocated with **new**.  
 ...
 Another way to display a wait cursor is to use the combination of [CCmdTarget::BeginWaitCursor](../VS_csharp/ccmdtarget-class.md#ccmdtarget__beginwaitcursor), [CCmdTarget::EndWaitCursor](../VS_csharp/ccmdtarget-class.md#ccmdtarget__endwaitcursor), and perhaps [CCmdTarget::RestoreWaitCursor](../VS_csharp/ccmdtarget-class.md#ccmdtarget__restorewaitcursor). However, `CWaitCursor` is easier to use because you don't need to set the cursor to the previous cursor when you're done with the lengthy operation.  
  
> [!NOTE]
>  MFC sets and restores the cursor using the [CWinApp::DoWaitCursor](../VS_csharp/cwinapp-class.md#cwinapp__dowaitcursor) virtual function. You can override this function to provide custom behavior.  
...
## Example  
 [!code[NVC_MFCWindowing#62](../VS_csharp/codesnippet/CPP/cwaitcursor-class_1.cpp)]  
...
### Example  
 [!code[NVC_MFCWindowing#63](../VS_csharp/codesnippet/CPP/cwaitcursor-class_2.cpp)]  
...
### Remarks  
 ...
 If you need to restore the wait cursor while in a function other than the one in which the `CWaitCursor` object is declared, you can call [CCmdTarget::RestoreWaitCursor](../VS_csharp/ccmdtarget-class.md#ccmdtarget__restorewaitcursor).  
  
### Example  
 [!code[NVC_MFCWindowing#64](../VS_csharp/codesnippet/CPP/cwaitcursor-class_3.cpp)]  
  
## See Also  
 [Hierarchy Chart](../VS_csharp/hierarchy-chart.md)   
 [CCmdTarget::BeginWaitCursor](../VS_csharp/ccmdtarget-class.md#ccmdtarget__beginwaitcursor)   
 [CCmdTarget::EndWaitCursor](../VS_csharp/ccmdtarget-class.md#ccmdtarget__endwaitcursor)   
 [CCmdTarget::RestoreWaitCursor](../VS_csharp/ccmdtarget-class.md#ccmdtarget__restorewaitcursor)   
 [CWinApp::DoWaitCursor](../VS_csharp/cwinapp-class.md#cwinapp__dowaitcursor)   
