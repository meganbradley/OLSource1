...
5.  You must also add a `TagsChanged` event that will be called by the update method.  
     ...
     [!code[VSSDKHighlightWordTest#10](../VS_csharp/codesnippet/CSharp/walkthrough--highlighting-text_1.cs)]
[!code[VSSDKHighlightWordTest#10](../VS_csharp/codesnippet/VisualBasic/walkthrough--highlighting-text_1.vb)]  
