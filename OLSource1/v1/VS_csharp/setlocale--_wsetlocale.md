...
|`_tsetlocale`|`setlocale`|`setlocale`|`_wsetlocale`|  
 ...
 For more information, see the [setlocale](../VS_csharp/setlocale.md) pragma directive in the [Preprocessor Reference](../VS_csharp/c-c---preprocessor-reference.md).  
  
 The function [_configthreadlocale](../VS_csharp/_configthreadlocale.md) is used to control whether `setlocale` affects the locale of all threads in a program or only the locale of the calling thread.  
...
## See Also  
 [Locale Names, Language and Country/Region Strings](../VS_csharp/locale-names--languages--and-country-region-strings.md)   
 [_configthreadlocale](../VS_csharp/_configthreadlocale.md)   
 [_create_locale, _wcreate_locale](../VS_csharp/_create_locale--_wcreate_locale.md)   
 [Locale](../VS_csharp/locale.md)   
 [localeconv](../VS_csharp/localeconv.md)   
 [_mbclen, mblen, _mblen_l, _mbsnlen, _mbsnlen_l](../VS_csharp/_mbclen--mblen--_mblen_l.md)   
 [strlen, strlen_l, wcslen, wcslen_l, _mbslen, _mbslen_l, _mbstrlen, _mbstrlen_l](../VS_csharp/strlen--wcslen--_mbslen--_mbslen_l--_mbstrlen--_mbstrlen_l.md)   
 [mbstowcs, _mbstowcs_l](../VS_csharp/mbstowcs--_mbstowcs_l.md)   
 [mbtowc, _mbtowc_l](../VS_csharp/mbtowc--_mbtowc_l.md)   
 ...
 [wcstombs, _wcstombs_l](../VS_csharp/wcstombs--_wcstombs_l.md)   
 [wctomb, _wctomb_l](../VS_csharp/wctomb--_wctomb_l.md)