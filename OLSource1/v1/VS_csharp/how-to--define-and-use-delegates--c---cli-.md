...
This article shows how to define and consume delegates in [!INCLUDE[cppcli](../VS_csharp/includes/cppcli_md.md)].  
...
## To use unbound delegates  
 ...
 Unbound delegates are especially useful if you want to iterate through the objects in a collection—by using [for each, in](../VS_csharp/for-each--in.md) keywords—and call a member function on each instance.  
...
**7**  
**8**  
**7** The next sample shows how to use unbound delegates and the [for each, in](../VS_csharp/for-each--in.md) keywords to iterate through objects in a collection and call a member function on each instance.  
