...
#### Parameters  
 ...
 `data[]`  
 [in] An array of [DiaAddressMapEntry](../VS_csharp/diaaddressmapentry.md) structures that define the translation map.  
