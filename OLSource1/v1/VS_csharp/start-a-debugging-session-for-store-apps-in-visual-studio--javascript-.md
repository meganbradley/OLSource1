...
> [!NOTE]
>  For apps written in XAML and Visual C#, Visual C++, or Visual Basic, see [Start a debugging session for a Store app in Visual Studio (VB, C#, C++ and XAML)](../VS_csharp/start-a-debugging-session-for-a-store-app-in-visual-studio--vb--csharp--c---and-xaml-.md)  
...
3.  Press F5.  
 ...
 Visual Studio builds and starts the app with the debugger attached. Execution continues until a breakpoint is reached, you manually suspend execution, an unhandled exception occurs, or the app ends. For more information, see [Quick Start: Debugging apps (JavaScript)](../VS_csharp/quickstart--debug-html-and-css.md).  
...
-   Choose the down arrow in the **Machine Name** box and choose **<Locate...>**. Then choose the remote machine from **Select Remote Debugger Connection** dialog box.  
     ...
     ![Select Remote Debugger Connection](../VS_csharp/media/vsrun_pro_selectremotedebuggerdlg.png "VSRUN_PRO_SelectRemoteDebuggerDlg")  
...
## See Also  
 [Quickstart: Debugger navigation (JavaScript)](../VS_csharp/control-execution-of-a-store-app-in-a-visual-studio-debug-session-for-windows-store-apps--javascript-.md)   
 [Quickstart: Debugging apps (JavaScript)](../VS_csharp/quickstart--debug-html-and-css.md)   
 [How to trigger suspend, resume, and background events in Metro style apps](../VS_csharp/how-to-trigger-suspend--resume--and-background-events-for-windows-store-apps-in-visual-studio.md)   
