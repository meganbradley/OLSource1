...
5.  Use a `Return` statement to return the value to the calling code.  
     ...
     [!code[VbVbcnProcedures#1](../VS_csharp/codesnippet/VisualBasic/how-to--create-a-procedure-that-returns-a-value--visual-basic-_1.vb)]  
  
     The following example shows a typical call to `hypotenuse`.  
  
     [!code[VbVbcnProcedures#6](../VS_csharp/codesnippet/VisualBasic/how-to--create-a-procedure-that-returns-a-value--visual-basic-_2.vb)]  
