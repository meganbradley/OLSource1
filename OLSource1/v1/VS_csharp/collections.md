...
##  <a name="_core_collection_shapes"></a> Collection Shapes  
 ...
 Each of the three provided collection shapes is described briefly later in this topic. To compare the features of the shapes to help you decide which is best for your program, see [Recommendations for Choosing a Collection Class](../VS_csharp/recommendations-for-choosing-a-collection-class.md).  
...
##  <a name="_core_the_template.2d.based_collection_classes"></a> The Template-Based Collection Classes  
 The easiest way to implement a type-safe collection that contains objects of any type is to use one of the MFC template-based classes. For examples of these classes, see the MFC sample [COLLECT](../VS_csharp/visual-c---samples.md).  
...
|`CUIntArray`||`CMapWordToPtr`|  
 ...
 The Characteristics of MFC Collection Classes table in [Recommendations for Choosing a Collection Class](../VS_csharp/recommendations-for-choosing-a-collection-class.md) describes the MFC collection classes in terms of these characteristics (other than shape):  
...
-   [Recommendations for Choosing a Collection Class](../VS_csharp/recommendations-for-choosing-a-collection-class.md)  
  
-   [How to: Make a Type-Safe Collection](../VS_csharp/how-to--make-a-type-safe-collection.md)  
  
-   [Creating Stack and Queue Collections](../VS_csharp/creating-stack-and-queue-collections.md)  
  
-   [CArray::Add](../Topic/CArray::Add.md)  
  
#### Template-Based Collection-Class Tasks  
  
-   [Template-Based Classes](../VS_csharp/template-based-classes.md)  
  
#### Accessing the Members of a Collection (Template-Based or Not)  
  
-   [Accessing All Members of a Collection](../VS_csharp/accessing-all-members-of-a-collection.md)  
  
-   [Deleting All Objects in a CObject Collection](../VS_csharp/deleting-all-objects-in-a-cobject-collection.md)  
