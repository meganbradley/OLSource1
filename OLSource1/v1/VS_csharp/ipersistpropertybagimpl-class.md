...
|Name|Description|  
|----------|-----------------|  
|[IPersistPropertyBagImpl::GetClassID](../VS_csharp/ipersistpropertybagimpl--getclassid.md)|Retrieves the object's CLSID.|  
|[IPersistPropertyBagImpl::InitNew](../VS_csharp/ipersistpropertybagimpl--initnew.md)|Initializes a newly created object. The ATL implementation returns `S_OK`.|  
|[IPersistPropertyBagImpl::Load](../VS_csharp/ipersistpropertybagimpl--load.md)|Loads the object's properties from a client-supplied property bag.|  
|[IPersistPropertyBagImpl::Save](../VS_csharp/ipersistpropertybagimpl--save.md)|Saves the object's properties into a client-supplied property bag.|  
...
### Remarks  
 See [IPersistPropertyBag::InitNew](https://msdn.microsoft.com/en-us/library/aa768204.aspx) in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Remarks  
 ...
 See [IPersistPropertyBag::Load](https://msdn.microsoft.com/en-us/library/aa768206.aspx) in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
