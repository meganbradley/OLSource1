...
-   [Customizing the header item's appearance](../VS_csharp/customizing-the-header-item-s-appearance.md)  
  
-   [Ordering items in the header control](../VS_csharp/ordering-items-in-the-header-control.md)  
  
-   [Providing drag-and-drop support for the header items](../VS_csharp/providing-drag-and-drop-support-for-header-items.md)  
