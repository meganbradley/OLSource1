...
Like [fprintf](../VS_csharp/printf.fprintf--t--function--fsharp-.md), but calls the specified function to generate the result. See [kprintf](../VS_csharp/printf.kprintf--result--t--function--fsharp-.md).  
...
#### Parameters  
 ...
 `format`  
 Type: [TextWriterFormat](../VS_csharp/printf.textwriterformat--t--result--type-abbreviation--fsharp-.md)`<'T,'Result>`  
