...
6.  On the **View** menu, select **Toolbox**.  
     ...
     The Toolbox opens. For more information, see [Toolbox](../VS_csharp/toolbox.md).  
...
## Attach to Your Windows Form Application for Debugging  
 In [!INCLUDE[vs_current_short](../VS_csharp/includes/vs_current_short_md.md)], you can attach the debugger to a running process. If you are using an Express Edition, this feature is not supported.  
