...
## Remarks  
 ...
 For more information on using `CStatusBarCtrl`, see [Controls](../VS_csharp/controls--mfc-.md) and [Using CStatusBarCtrl](../VS_csharp/using-cstatusbarctrl.md).  
...
### Parameters  
 `dwStyle`  
 Specifies the status bar control's style. Apply any combination of status bar control styles listed in                                 [Common Control Styles](http://msdn.microsoft.com/library/windows/desktop/bb775498) in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)]. This parameter must include the **WS_CHILD** style. It should also include the **WS_VISIBLE** style.  
  
 `rect`  
 Specifies the status bar control's size and position. It can be either a [CRect](../VS_csharp/crect-class.md) object or a                                 [RECT](http://msdn.microsoft.com/library/windows/desktop/dd162897) structure.  
...
### Example  
 [!code[NVC_MFC_CStatusBarCtrl#1](../VS_csharp/codesnippet/CPP/cstatusbarctrl-class_1.cpp)]  
...
### Example  
 [!code[NVC_MFC_CStatusBarCtrl#2](../VS_csharp/codesnippet/CPP/cstatusbarctrl-class_2.cpp)]  
...
### Remarks  
 This method sends the                         [SB_GETICON](http://msdn.microsoft.com/library/windows/desktop/bb760744) message, which is described in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
  
 A status bar control consists of a row of text output panes, which are also known as parts. For more information about the status bar, see [Status Bar Implementation in MFC](../VS_csharp/status-bar-implementation-in-mfc.md) and [Setting the Mode of a CStatusBarCtrl Object](../VS_csharp/setting-the-mode-of-a-cstatusbarctrl-object.md).  
...
### Example  
 ...
 [!code[NVC_MFC_CStatusBarCtrl_s1#1](../VS_csharp/codesnippet/CPP/cstatusbarctrl-class_3.h)]  
...
### Example  
 ...
 [!code[NVC_MFC_CStatusBarCtrl_s1#2](../VS_csharp/codesnippet/CPP/cstatusbarctrl-class_4.cpp)]  
...
### Example  
 [!code[NVC_MFC_CStatusBarCtrl#3](../VS_csharp/codesnippet/CPP/cstatusbarctrl-class_5.cpp)]  
...
### Example  
 [!code[NVC_MFC_CStatusBarCtrl#4](../VS_csharp/codesnippet/CPP/cstatusbarctrl-class_6.cpp)]  
...
### Return Value  
 The length, in characters, of the text or a [CString](../VS_csharp/cstringt-class.md) containing the current text.  
  
### Example  
 [!code[NVC_MFC_CStatusBarCtrl#5](../VS_csharp/codesnippet/CPP/cstatusbarctrl-class_7.cpp)]  
...
### Example  
 [!code[NVC_MFC_CStatusBarCtrl#6](../VS_csharp/codesnippet/CPP/cstatusbarctrl-class_8.cpp)]  
...
### Return Value  
 A [CString](../VS_csharp/cstringt-class.md) object containing the text to be used in the tooltip.  
  
### Remarks  
 This member function implements the behavior of the Win32 message                         [SB_GETTIPTEXT](http://msdn.microsoft.com/library/windows/desktop/bb760751), as described in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
  
### Example  
 [!code[NVC_MFC_CStatusBarCtrl#7](../VS_csharp/codesnippet/CPP/cstatusbarctrl-class_9.cpp)]  
...
### Remarks  
 This member function implements the behavior of the Win32 message                         [SB_ISSIMPLE](http://msdn.microsoft.com/library/windows/desktop/bb760753), as described in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Remarks  
 This member function implements the behavior of the Win32 message                         [SB_SETBKCOLOR](http://msdn.microsoft.com/library/windows/desktop/bb760754), as described in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
  
### Example  
 [!code[NVC_MFC_CStatusBarCtrl#8](../VS_csharp/codesnippet/CPP/cstatusbarctrl-class_10.cpp)]  
...
### Remarks  
 This member function implements the behavior of the Win32 message                         [SB_SETICON](http://msdn.microsoft.com/library/windows/desktop/bb760755), as described in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
...
### Example  
 [!code[NVC_MFC_CStatusBarCtrl#9](../VS_csharp/codesnippet/CPP/cstatusbarctrl-class_11.cpp)]  
...
### Example  
 [!code[NVC_MFC_CStatusBarCtrl#10](../VS_csharp/codesnippet/CPP/cstatusbarctrl-class_12.cpp)]  
...
### Example  
 [!code[NVC_MFC_CStatusBarCtrl#11](../VS_csharp/codesnippet/CPP/cstatusbarctrl-class_13.cpp)]  
...
### Remarks  
 This member function implements the behavior of the Win32 message                         [SB_SETTIPTEXT](http://msdn.microsoft.com/library/windows/desktop/bb760759), as described in the [!INCLUDE[winSDK](../VS_csharp/includes/winsdk_md.md)].  
  
### Example  
 [!code[NVC_MFC_CStatusBarCtrl#12](../VS_csharp/codesnippet/CPP/cstatusbarctrl-class_14.cpp)]  
