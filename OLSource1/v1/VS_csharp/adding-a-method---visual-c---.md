...
You can use the [Add Method Wizard](../VS_csharp/add-method-wizard.md) to add a method to an interface in your project. If the project contains a class associated with the interface, the wizard modifies the class, too.  
...
5.  Specify any interface definition language settings for this method in the [IDL attributes](../VS_csharp/idl-attributes--add-method-wizard.md) page of the wizard.  
