...
---
# _ITERATOR_DEBUG_LEVEL
The `_ITERATOR_DEBUG_LEVEL` (IDL) macro supersedes and combines the functionality of the [_SECURE_SCL](../VS_csharp/_secure_scl.md) (SCL) and [_HAS_ITERATOR_DEBUGGING](../VS_csharp/_has_iterator_debugging.md) (HID) macros.  
