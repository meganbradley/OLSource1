...
-   For more information, see [How to: Access a Collection Class with foreach](../VS_csharp/how-to--access-a-collection-class-with-foreach--csharp-programming-guide-.md).  
