...
-   [AMD Developer Guides & Manuals](http://go.microsoft.com/fwlink/p/?LinkId=251203)  
 ...
 The following table lists the intrinsics available on x64 processors. The Technology column lists required instruction-set support. Use the [__cpuid](../VS_csharp/__cpuid--__cpuidex.md) intrinsic to determine instruction-set support at run time. If two entries are in one row, they represent different entry points for the same intrinsic. A [1] indicates the intrinsic is available only on AMD processors. A [2] indicates the intrinsic is available only on Intel processors. A [3] indicates the prototype is a macro. The header required for the function prototype is listed in the Header column. The intrin.h header includes both immintrin.h and ammintrin.h for simplicity.  
...
|[__addgsbyte](../VS_csharp/__addgsbyte--__addgsword--__addgsdword--__addgsqword.md)||intrin.h|void __addgsbyte(unsigned long,unsigned char)|  
|[__addgsdword](../VS_csharp/__addgsbyte--__addgsword--__addgsdword--__addgsqword.md)||intrin.h|void __addgsdword(unsigned long,unsigned int)|  
|[__addgsqword](../VS_csharp/__addgsbyte--__addgsword--__addgsdword--__addgsqword.md)||intrin.h|void __addgsqword(unsigned long,unsigned \__int64)|  
|[__addgsword](../VS_csharp/__addgsbyte--__addgsword--__addgsdword--__addgsqword.md)||intrin.h|void __addgsword(unsigned long,unsigned short)|  
|[_AddressOfReturnAddress](../VS_csharp/_addressofreturnaddress.md)||intrin.h|void * _AddressOfReturnAddress(void)|  
...
|[_BitScanForward](../VS_csharp/_bitscanforward--_bitscanforward64.md)||intrin.h|BOOLEAN _BitScanForward(OUT ULONG* Index,IN ULONG Mask)|  
|[_BitScanForward64](../VS_csharp/_bitscanforward--_bitscanforward64.md)||intrin.h|BOOLEAN _BitScanForward64(OUT ULONG* Index,IN ULONG64 Mask)|  
|[_BitScanReverse](../VS_csharp/_bitscanreverse--_bitscanreverse64.md)||intrin.h|BOOLEAN _BitScanReverse(OUT ULONG* Index,IN ULONG Mask)|  
|[_BitScanReverse64](../VS_csharp/_bitscanreverse--_bitscanreverse64.md)||intrin.h|BOOLEAN _BitScanReverse64(OUT ULONG* Index,IN ULONG64 Mask)|  
|[_bittest](../VS_csharp/_bittest--_bittest64.md)||intrin.h|unsigned char _bittest(long const *a,long b)|  
|[_bittest64](../VS_csharp/_bittest--_bittest64.md)||intrin.h|unsigned char _bittest64(\__int64 const *a,\__int64 b)|  
|[_bittestandcomplement](../VS_csharp/_bittestandcomplement--_bittestandcomplement64.md)||intrin.h|unsigned char _bittestandcomplement(long *a,long b)|  
|[_bittestandcomplement64](../VS_csharp/_bittestandcomplement--_bittestandcomplement64.md)||intrin.h|unsigned char _bittestandcomplement64(\__int64 *a,\__int64 b)|  
|[_bittestandreset](../VS_csharp/_bittestandreset--_bittestandreset64.md)||intrin.h|unsigned char _bittestandreset(long *a,long b)|  
|[_bittestandreset64](../VS_csharp/_bittestandreset--_bittestandreset64.md)||intrin.h|unsigned char _bittestandreset64(\__int64 *a,\__int64 b)|  
|[_bittestandset](../VS_csharp/_bittestandset--_bittestandset64.md)||intrin.h|unsigned char _bittestandset(long *a,long b)|  
|[_bittestandset64](../VS_csharp/_bittestandset--_bittestandset64.md)||intrin.h|unsigned char _bittestandset64(\__int64 *a,\__int64 b)|  
...
|[__cpuid](../VS_csharp/__cpuid--__cpuidex.md)||intrin.h|void __cpuid(int *a,int b)|  
|[__cpuidex](../VS_csharp/__cpuid--__cpuidex.md)||intrin.h|void __cpuidex(int *a,int b,int c)|  
|[__debugbreak](../VS_csharp/__debugbreak.md)||intrin.h|void __debugbreak(void)|  
|[_disable](../VS_csharp/_disable.md)||intrin.h|void _disable(void)|  
|[__emul](../VS_csharp/__emul--__emulu.md)||intrin.h|__int64 [pascal/cdecl] \__emul(int,int)|  
|[__emulu](../VS_csharp/__emul--__emulu.md)||intrin.h|unsigned __int64 [pascal/cdecl]\__emulu(unsigned int,unsigned int)|  
|[_enable](../VS_csharp/_enable.md)||intrin.h|void _enable(void)|  
|[__fastfail](../VS_csharp/__fastfail.md)||intrin.h|void __fastfail(unsigned int)|  
|[__faststorefence](../VS_csharp/__faststorefence.md)||intrin.h|void __faststorefence(void)|  
...
|[__getcallerseflags](../VS_csharp/__getcallerseflags.md)||intrin.h|(unsigned int __getcallerseflags())|  
|[__halt](../VS_csharp/__halt.md)||intrin.h|void __halt(void)|  
|[__inbyte](../VS_csharp/__inbyte.md)||intrin.h|unsigned char __inbyte(unsigned short Port)|  
|[__inbytestring](../VS_csharp/__inbytestring.md)||intrin.h|void __inbytestring(unsigned short Port,unsigned char *Buffer,unsigned long Count)|  
|[__incgsbyte](../VS_csharp/__incgsbyte--__incgsword--__incgsdword--__incgsqword.md)||intrin.h|void __incgsbyte(unsigned long)|  
|[__incgsdword](../VS_csharp/__incgsbyte--__incgsword--__incgsdword--__incgsqword.md)||intrin.h|void __incgsdword(unsigned long)|  
|[__incgsqword](../VS_csharp/__incgsbyte--__incgsword--__incgsdword--__incgsqword.md)||intrin.h|void __incgsqword(unsigned long)|  
|[__incgsword](../VS_csharp/__incgsbyte--__incgsword--__incgsdword--__incgsqword.md)||intrin.h|void __incgsword(unsigned long)|  
|[__indword](../VS_csharp/__indword.md)||intrin.h|unsigned long __indword(unsigned short Port)|  
|[__indwordstring](../VS_csharp/__indwordstring.md)||intrin.h|void __indwordstring(unsigned short Port,unsigned long *Buffer,unsigned long Count)|  
|[__int2c](../VS_csharp/__int2c.md)||intrin.h|void __int2c(void)|  
|[_InterlockedAnd](../VS_csharp/_interlockedand-intrinsic-functions.md)||intrin.h|long _InterlockedAnd(long volatile *,long)|  
|[_InterlockedAnd_HLEAcquire](../VS_csharp/_interlockedand-intrinsic-functions.md)|HLE [2]|immintrin.h|long _InterlockedAnd_HLEAcquire(long volatile *,long)|  
|[_InterlockedAnd_HLERelease](../VS_csharp/_interlockedand-intrinsic-functions.md)|HLE [2]|immintrin.h|long _InterlockedAnd_HLERelease(long volatile *,long)|  
|[_InterlockedAnd_np](../VS_csharp/_interlockedand-intrinsic-functions.md)||intrin.h|long _InterlockedAnd_np(long *,long)|  
|[_InterlockedAnd16](../VS_csharp/_interlockedand-intrinsic-functions.md)||intrin.h|short _InterlockedAnd16(short volatile *,short)|  
|[_InterlockedAnd16_np](../VS_csharp/_interlockedand-intrinsic-functions.md)||intrin.h|short _InterlockedAnd16_np(short *,short)|  
|[_InterlockedAnd64](../VS_csharp/_interlockedand-intrinsic-functions.md)||intrin.h|__int64 _InterlockedAnd64(\__int64 volatile *,\__int64)|  
|[_InterlockedAnd64_HLEAcquire](../VS_csharp/_interlockedand-intrinsic-functions.md)|HLE [2]|immintrin.h|__int64 _InterlockedAnd64_HLEAcquire(\__int64 volatile *,\__int64)|  
|[_InterlockedAnd64_HLERelease](../VS_csharp/_interlockedand-intrinsic-functions.md)|HLE [2]|immintrin.h|__int64 _InterlockedAnd64_HLERelease(\__int64 volatile *,\__int64)|  
|[_InterlockedAnd64_np](../VS_csharp/_interlockedand-intrinsic-functions.md)||intrin.h|__int64 _InterlockedAnd64_np(\__int64 *,\__int64)|  
|[_InterlockedAnd8](../VS_csharp/_interlockedand-intrinsic-functions.md)||intrin.h|char _InterlockedAnd8(char volatile *,char)|  
|[_InterlockedAnd8_np](../VS_csharp/_interlockedand-intrinsic-functions.md)||intrin.h|char _InterlockedAnd8_np(char *,char)|  
|[_interlockedbittestandreset](../VS_csharp/_interlockedbittestandreset-intrinsic-functions.md)||intrin.h|unsigned char _interlockedbittestandreset(long *a,long b)|  
|[_interlockedbittestandreset_HLEAcquire](../VS_csharp/_interlockedbittestandreset-intrinsic-functions.md)|HLE [2]|immintrin.h|unsigned char _interlockedbittestandreset_HLEAcquire(long *a,long b)|  
|[_interlockedbittestandreset_HLERelease](../VS_csharp/_interlockedbittestandreset-intrinsic-functions.md)|HLE [2]|immintrin.h|unsigned char _interlockedbittestandreset_HLERelease(long *a,long b)|  
|[_interlockedbittestandreset64](../VS_csharp/_interlockedbittestandreset-intrinsic-functions.md)||intrin.h|unsigned char _interlockedbittestandreset64(\__int64 *a,\__int64 b)|  
|[_interlockedbittestandreset64_HLEAcquire](../VS_csharp/_interlockedbittestandreset-intrinsic-functions.md)|HLE [2]|immintrin.h|unsigned char _interlockedbittestandreset64_HLEAcquire(\__int64 *a,\__int64 b)|  
|[_interlockedbittestandreset64_HLERelease](../VS_csharp/_interlockedbittestandreset-intrinsic-functions.md)|HLE [2]|immintrin.h|unsigned char _interlockedbittestandreset64_HLERelease(\__int64 *a,\__int64 b)|  
|[_interlockedbittestandset](../VS_csharp/_interlockedbittestandset-intrinsic-functions.md)||intrin.h|unsigned char _interlockedbittestandset(long *a,long b)|  
|[_interlockedbittestandset_HLEAcquire](../VS_csharp/_interlockedbittestandset-intrinsic-functions.md)|HLE [2]|immintrin.h|unsigned char _interlockedbittestandset_HLEAcquire(long *a,long b)|  
|[_interlockedbittestandset_HLERelease](../VS_csharp/_interlockedbittestandset-intrinsic-functions.md)|HLE [2]|immintrin.h|unsigned char _interlockedbittestandset_HLERelease(long *a,long b)|  
|[_interlockedbittestandset64](../VS_csharp/_interlockedbittestandset-intrinsic-functions.md)||intrin.h|unsigned char _interlockedbittestandset64(\__int64 *a,\__int64 b)|  
|[_interlockedbittestandset64_HLEAcquire](../VS_csharp/_interlockedbittestandset-intrinsic-functions.md)|HLE [2]|immintrin.h|unsigned char _interlockedbittestandset64_HLEAcquire(\__int64 *a,\__int64 b)|  
|[_interlockedbittestandset64_HLERelease](../VS_csharp/_interlockedbittestandset-intrinsic-functions.md)|HLE [2]|immintrin.h|unsigned char _interlockedbittestandset64_HLERelease(\__int64 *a,\__int64 b)|  
|[_InterlockedCompareExchange](../VS_csharp/_interlockedcompareexchange-intrinsic-functions.md)||intrin.h|long _InterlockedCompareExchange (long volatile *,long,long)|  
|[_InterlockedCompareExchange_HLEAcquire](../VS_csharp/_interlockedcompareexchange-intrinsic-functions.md)|HLE [2]|immintrin.h|long _InterlockedCompareExchange_HLEAcquire(long volatile *,long,long)|  
|[_InterlockedCompareExchange_HLERelease](../VS_csharp/_interlockedcompareexchange-intrinsic-functions.md)|HLE [2]|immintrin.h|long _InterlockedCompareExchange_HLERelease(long volatile *,long,long)|  
|[_InterlockedCompareExchange_np](../VS_csharp/_interlockedcompareexchange-intrinsic-functions.md)||intrin.h|long _InterlockedCompareExchange_np (long *,long,long)|  
|[_InterlockedCompareExchange128](../VS_csharp/_interlockedcompareexchange128.md)||intrin.h|unsigned char _InterlockedCompareExchange128(\__int64 volatile *,\__int64,\__int64,\__int64\*)|  
|[_InterlockedCompareExchange128_np](../VS_csharp/_interlockedcompareexchange128.md)||intrin.h|unsigned char _InterlockedCompareExchange128(\__int64 volatile *,\__int64,\__int64,\__int64\*)|  
|[_InterlockedCompareExchange16](../VS_csharp/_interlockedcompareexchange-intrinsic-functions.md)||intrin.h|short _InterlockedCompareExchange16(short volatile *Destination,short Exchange,short Comparand)|  
|[_InterlockedCompareExchange16_np](../VS_csharp/_interlockedcompareexchange-intrinsic-functions.md)||intrin.h|short _InterlockedCompareExchange16_np(short volatile *Destination,short Exchange,short Comparand)|  
|[_InterlockedCompareExchange64](../VS_csharp/_interlockedcompareexchange-intrinsic-functions.md)||intrin.h|__int64 _InterlockedCompareExchange64(\__int64 volatile *,\__int64,\__int64)|  
|[_InterlockedCompareExchange64_HLEAcquire](../VS_csharp/_interlockedcompareexchange-intrinsic-functions.md)|HLE [2]|immintrin.h|__int64 _InterlockedCompareExchange64_HLEAcquire(\__int64 volatile *,\__int64,\__int64)|  
|[_InterlockedCompareExchange64_HLERelease](../VS_csharp/_interlockedcompareexchange-intrinsic-functions.md)|HLE [2]|immintrin.h|__int64 _InterlockedCompareExchange64_HLERelease(\__int64 volatile *,\__int64,\__int64)|  
|[_InterlockedCompareExchange64_np](../VS_csharp/_interlockedcompareexchange-intrinsic-functions.md)||intrin.h|__int64 _InterlockedCompareExchange64_np(\__int64 *,\__int64,\__int64)|  
|[_InterlockedCompareExchange8](../VS_csharp/_interlockedcompareexchange-intrinsic-functions.md)||intrin.h|char _InterlockedCompareExchange8(char volatile *Destination,char Exchange,char Comparand)|  
|[_InterlockedCompareExchangePointer](../VS_csharp/_interlockedcompareexchangepointer-intrinsic-functions.md)||intrin.h|void *_InterlockedCompareExchangePointer (void \*volatile \*,void \*,void \*)|  
|[_InterlockedCompareExchangePointer_HLEAcquire](../VS_csharp/_interlockedcompareexchangepointer-intrinsic-functions.md)|HLE [2]|immintrin.h|void *_InterlockedCompareExchangePointer_HLEAcquire(void \*volatile \*,void \*,void \*)|  
|[_InterlockedCompareExchangePointer_HLERelease](../VS_csharp/_interlockedcompareexchangepointer-intrinsic-functions.md)|HLE [2]|immintrin.h|void *_InterlockedCompareExchangePointer_HLERelease(void \*volatile \*,void \*,void \*)|  
|[_InterlockedCompareExchangePointer_np](../VS_csharp/_interlockedcompareexchangepointer-intrinsic-functions.md)||intrin.h|void *_InterlockedCompareExchangePointer_np(void \*\*,void \*,void \*)|  
|[_InterlockedDecrement](../VS_csharp/_interlockeddecrement-intrinsic-functions.md)||intrin.h|long _InterlockedDecrement(long volatile *)|  
|[_InterlockedDecrement16](../VS_csharp/_interlockeddecrement-intrinsic-functions.md)||intrin.h|short _InterlockedDecrement16(short volatile *Addend)|  
|[_InterlockedDecrement64](../VS_csharp/_interlockeddecrement-intrinsic-functions.md)||intrin.h|__int64 _InterlockedDecrement64(\__int64 volatile *)|  
|[_InterlockedExchange](../VS_csharp/_interlockedexchange-intrinsic-functions.md)||intrin.h|long _InterlockedExchange(long volatile *,long)|  
|[_InterlockedExchange_HLEAcquire](../VS_csharp/_interlockedexchange-intrinsic-functions.md)|HLE [2]|immintrin.h|long _InterlockedExchange_HLEAcquire(long volatile *,long)|  
|[_InterlockedExchange_HLERelease](../VS_csharp/_interlockedexchange-intrinsic-functions.md)|HLE [2]|immintrin.h|long _InterlockedExchange_HLERelease(long volatile *,long)|  
|[_InterlockedExchange16](../VS_csharp/_interlockedexchange-intrinsic-functions.md)||intrin.h|short _InterlockedExchange16(short volatile *,short)|  
|[_InterlockedExchange64](../VS_csharp/_interlockedexchange-intrinsic-functions.md)||intrin.h|__int64 _InterlockedExchange64(\__int64 volatile *,\__int64)|  
|[_InterlockedExchange64_HLEAcquire](../VS_csharp/_interlockedexchange-intrinsic-functions.md)|HLE [2]|immintrin.h|__int64 _InterlockedExchange64_HLEAcquire(\__int64 volatile *,\__int64)|  
|[_InterlockedExchange64_HLERelease](../VS_csharp/_interlockedexchange-intrinsic-functions.md)|HLE [2]|immintrin.h|__int64 _InterlockedExchange64_HLERelease(\__int64 volatile *,\__int64)|  
|[_InterlockedExchange8](../VS_csharp/_interlockedexchange-intrinsic-functions.md)||intrin.h|char _InterlockedExchange8(char volatile *,char)|  
|[_InterlockedExchangeAdd](../VS_csharp/_interlockedexchangeadd-intrinsic-functions.md)||intrin.h|long _InterlockedExchangeAdd(long volatile *,long)|  
|[_InterlockedExchangeAdd_HLEAcquire](../VS_csharp/_interlockedexchangeadd-intrinsic-functions.md)|HLE [2]|immintrin.h|long _InterlockedExchangeAdd_HLEAcquire(long volatile *,long)|  
|[_InterlockedExchangeAdd_HLERelease](../VS_csharp/_interlockedexchangeadd-intrinsic-functions.md)|HLE [2]|immintrin.h|long _InterlockedExchangeAdd_HLERelease(long volatile *,long)|  
|[_InterlockedExchangeAdd16](../VS_csharp/_interlockedexchangeadd-intrinsic-functions.md)||intrin.h|short _InterlockedExchangeAdd16(short volatile *,short)|  
|[_InterlockedExchangeAdd64](../VS_csharp/_interlockedexchangeadd-intrinsic-functions.md)||intrin.h|__int64 _InterlockedExchangeAdd64(\__int64 volatile *,\__int64)|  
|[_InterlockedExchangeAdd64_HLEAcquire](../VS_csharp/_interlockedexchangeadd-intrinsic-functions.md)|HLE [2]|immintrin.h|__int64 _InterlockedExchangeAdd64_HLEAcquire(\__int64 volatile *,\__int64)|  
|[_InterlockedExchangeAdd64_HLERelease](../VS_csharp/_interlockedexchangeadd-intrinsic-functions.md)|HLE [2]|immintrin.h|__int64 _InterlockedExchangeAdd64_HLERelease(\__int64 volatile *,\__int64)|  
|[_InterlockedExchangeAdd8](../VS_csharp/_interlockedexchangeadd-intrinsic-functions.md)||intrin.h|char _InterlockedExchangeAdd8(char volatile *,char)|  
|[_InterlockedExchangePointer](../VS_csharp/_interlockedexchangepointer-intrinsic-functions.md)||intrin.h|void * _InterlockedExchangePointer(void \*volatile \*,void \*)|  
|[_InterlockedExchangePointer_HLEAcquire](../VS_csharp/_interlockedexchangepointer-intrinsic-functions.md)|HLE [2]|immintrin.h|void * _InterlockedExchangePointer_HLEAcquire(void \*volatile \*,void \*)|  
|[_InterlockedExchangePointer_HLERelease](../VS_csharp/_interlockedexchangepointer-intrinsic-functions.md)|HLE [2]|immintrin.h|void * _InterlockedExchangePointer_HLERelease(void \*volatile \*,void \*)|  
|[_InterlockedIncrement](../VS_csharp/_interlockedincrement-intrinsic-functions.md)||intrin.h|long _InterlockedIncrement(long volatile *)|  
|[_InterlockedIncrement16](../VS_csharp/_interlockedincrement-intrinsic-functions.md)||intrin.h|short _InterlockedIncrement16(short volatile *Addend)|  
|[_InterlockedIncrement64](../VS_csharp/_interlockedincrement-intrinsic-functions.md)||intrin.h|__int64 _InterlockedIncrement64(\__int64 volatile *)|  
|[_InterlockedOr](../VS_csharp/_interlockedor-intrinsic-functions.md)||intrin.h|long _InterlockedOr(long volatile *,long)|  
|[_InterlockedOr_HLEAcquire](../VS_csharp/_interlockedor-intrinsic-functions.md)|HLE [2]|immintrin.h|long _InterlockedOr_HLEAcquire(long volatile *,long)|  
|[_InterlockedOr_HLERelease](../VS_csharp/_interlockedor-intrinsic-functions.md)|HLE [2]|immintrin.h|long _InterlockedOr_HLERelease(long volatile *,long)|  
|[_InterlockedOr_np](../VS_csharp/_interlockedor-intrinsic-functions.md)||intrin.h|long _InterlockedOr_np(long *,long)|  
|[_InterlockedOr16](../VS_csharp/_interlockedor-intrinsic-functions.md)||intrin.h|short _InterlockedOr16(short volatile *,short)|  
|[_InterlockedOr16_np](../VS_csharp/_interlockedor-intrinsic-functions.md)||intrin.h|short _InterlockedOr16_np(short *,short)|  
|[_InterlockedOr64](../VS_csharp/_interlockedor-intrinsic-functions.md)||intrin.h|__int64 _InterlockedOr64(\__int64 volatile *,\__int64)|  
|[_InterlockedOr64_HLEAcquire](../VS_csharp/_interlockedor-intrinsic-functions.md)|HLE [2]|immintrin.h|__int64 _InterlockedOr64_HLEAcquire(\__int64 volatile *,\__int64)|  
|[_InterlockedOr64_HLERelease](../VS_csharp/_interlockedor-intrinsic-functions.md)|HLE [2]|immintrin.h|__int64 _InterlockedOr64_HLERelease(\__int64 volatile *,\__int64)|  
|[_InterlockedOr64_np](../VS_csharp/_interlockedor-intrinsic-functions.md)||intrin.h|__int64 _InterlockedOr64_np(\__int64 *,\__int64)|  
|[_InterlockedOr8](../VS_csharp/_interlockedor-intrinsic-functions.md)||intrin.h|char _InterlockedOr8(char volatile *,char)|  
|[_InterlockedOr8_np](../VS_csharp/_interlockedor-intrinsic-functions.md)||intrin.h|char _InterlockedOr8_np(char *,char)|  
|[_InterlockedXor](../VS_csharp/_interlockedxor-intrinsic-functions.md)||intrin.h|long _InterlockedXor(long volatile *,long)|  
|[_InterlockedXor_HLEAcquire](../VS_csharp/_interlockedxor-intrinsic-functions.md)|HLE [2]|immintrin.h|long _InterlockedXor_HLEAcquire(long volatile *,long)|  
|[_InterlockedXor_HLERelease](../VS_csharp/_interlockedxor-intrinsic-functions.md)|HLE [2]|immintrin.h|long _InterlockedXor_HLERelease(long volatile *,long)|  
|[_InterlockedXor_np](../VS_csharp/_interlockedxor-intrinsic-functions.md)||intrin.h|long _InterlockedXor_np(long *,long)|  
|[_InterlockedXor16](../VS_csharp/_interlockedxor-intrinsic-functions.md)||intrin.h|short _InterlockedXor16(short volatile *,short)|  
|[_InterlockedXor16_np](../VS_csharp/_interlockedxor-intrinsic-functions.md)||intrin.h|short _InterlockedXor16_np(short *,short)|  
|[_InterlockedXor64](../VS_csharp/_interlockedxor-intrinsic-functions.md)||intrin.h|__int64 _InterlockedXor64(\__int64 volatile *,\__int64)|  
|[_InterlockedXor64_HLEAcquire](../VS_csharp/_interlockedxor-intrinsic-functions.md)|HLE [2]|immintrin.h|__int64 _InterlockedXor64_HLEAcquire(\__int64 volatile *,\__int64)|  
|[_InterlockedXor64_HLERelease](../VS_csharp/_interlockedxor-intrinsic-functions.md)|HLE [2]|immintrin.h|__int64 _InterlockedXor64_HLERelease(\__int64 volatile *,\__int64)|  
|[_InterlockedXor64_np](../VS_csharp/_interlockedxor-intrinsic-functions.md)||intrin.h|__int64 _InterlockedXor64_np(\__int64 *,\__int64)|  
|[_InterlockedXor8](../VS_csharp/_interlockedxor-intrinsic-functions.md)||intrin.h|char _InterlockedXor8(char volatile *,char)|  
|[_InterlockedXor8_np](../VS_csharp/_interlockedxor-intrinsic-functions.md)||intrin.h|char _InterlockedXor8_np(char *,char)|  
|[__invlpg](../VS_csharp/__invlpg.md)||intrin.h|void __invlpg(void*)|  
|[_invpcid](http://go.microsoft.com/fwlink/p/?LinkId=512130)|INVPCID [2]|immintrin.h|void _invpcid(unsigned int,void *)|  
|[__inword](../VS_csharp/__inword.md)||intrin.h|unsigned short __inword(unsigned short Port)|  
|[__inwordstring](../VS_csharp/__inwordstring.md)||intrin.h|void __inwordstring(unsigned short Port,unsigned short *Buffer,unsigned long Count)|  
|_lgdt||intrin.h|void _lgdt(void*)|  
|[__lidt](../VS_csharp/__lidt.md)||intrin.h|void __lidt(void*)|  
|[__ll_lshift](../VS_csharp/__ll_lshift.md)||intrin.h|unsigned __int64 [pascal/cdecl] \__ll_lshift(unsigned \__int64,int)|  
|[__ll_rshift](../VS_csharp/__ll_rshift.md)||intrin.h|__int64 [pascal/cdecl] \__ll_rshift(\__int64,int)|  
...
|[__lzcnt](../VS_csharp/__lzcnt16--__lzcnt--__lzcnt64.md)|LZCNT|intrin.h|unsigned int __lzcnt(unsigned int)|  
...
|[__lzcnt16](../VS_csharp/__lzcnt16--__lzcnt--__lzcnt64.md)|LZCNT|intrin.h|unsigned short __lzcnt16(unsigned short)|  
|[__lzcnt64](../VS_csharp/__lzcnt16--__lzcnt--__lzcnt64.md)|LZCNT|intrin.h|unsigned __int64 \__lzcnt64(unsigned \__int64)|  
...
|[_mm_cvtsi64x_ss](../VS_csharp/_mm_cvtsi64x_ss.md)|SSE2|intrin.h|__m128 _mm_cvtsi64x_ss(\__m128 a,\__int64 b)|  
...
|[_mm_cvtss_si64x](../VS_csharp/_mm_cvtss_si64x.md)|SSE2|intrin.h|__int64 _mm_cvtss_si64x(\__m128 a)|  
...
|[_mm_cvttss_si64x](../VS_csharp/_mm_cvttss_si64x.md)|SSE2|intrin.h|__int64 _mm_cvttss_si64x(\__m128 a)|  
...
|[_mm_extract_si64](../VS_csharp/_mm_extract_si64--_mm_extracti_si64.md)|SSE4a|intrin.h|__m128i _mm_extract_si64(\__m128i,\__m128i)|  
|[_mm_extracti_si64](../VS_csharp/_mm_extract_si64--_mm_extracti_si64.md)|SSE4a|intrin.h|__m128i _mm_extracti_si64(\__m128i,int,int)|  
...
|[_mm_insert_si64](../VS_csharp/_mm_insert_si64--_mm_inserti_si64.md)|SSE4a|intrin.h|__m128i _mm_insert_si64(\__m128i,\__m128i)|  
|[_mm_inserti_si64](../VS_csharp/_mm_insert_si64--_mm_inserti_si64.md)|SSE4a|intrin.h|__m128i _mm_inserti_si64(\__m128i,\__m128i,int,int)|  
...
|[_mm_stream_sd](../VS_csharp/_mm_stream_sd.md)|SSE4a|intrin.h|void _mm_stream_sd(double*,\__m128d)|  
...
|[_mm_stream_si64x](../VS_csharp/_mm_stream_si64x.md)|SSE2|intrin.h|void _mm_stream_si64x(\__int64 *,\__int64)|  
|[_mm_stream_ss](../VS_csharp/_mm_stream_ss.md)|SSE4a|intrin.h|void _mm_stream_ss(float*,\__m128)|  
...
|[__movsb](../VS_csharp/__movsb.md)||intrin.h|VOID __movsb(IN PBYTE,IN BYTE const *,IN SIZE_T)|  
|[__movsd](../VS_csharp/__movsd.md)||intrin.h|VOID __movsd(IN PDWORD,IN DWORD const *,IN SIZE_T)|  
|[__movsq](../VS_csharp/__movsq.md)||intrin.h|VOID __movsq(IN PDWORD64,IN DWORD64 const *,IN SIZE_T)|  
|[__movsw](../VS_csharp/__movsw.md)||intrin.h|VOID __movsw(IN PWORD,IN WORD const *,IN SIZE_T)|  
|[_mul128](../VS_csharp/__mul128.md)||intrin.h|__int64 _mul128(\__int64 multiplier,\__int64 multiplicand,\__int64 *highproduct)|  
|[__mulh](../VS_csharp/__mulh.md)||intrin.h|__int64 \__mulh(\__int64,\__int64)|  
...
|[__nop](../VS_csharp/__nop.md)||intrin.h|void __nop(void)|  
|__nvreg_restore_fence||intrin.h|void __nvreg_restore_fence(void)|  
|__nvreg_save_fence||intrin.h|void __nvreg_save_fence(void)|  
|[__outbyte](../VS_csharp/__outbyte.md)||intrin.h|void __outbyte(unsigned short Port,unsigned char Data)|  
|[__outbytestring](../VS_csharp/__outbytestring.md)||intrin.h|void __outbytestring(unsigned short Port,unsigned char *Buffer,unsigned long Count)|  
|[__outdword](../VS_csharp/__outdword.md)||intrin.h|void __outdword(unsigned short Port,unsigned long Data)|  
|[__outdwordstring](../VS_csharp/__outdwordstring.md)||intrin.h|void __outdwordstring(unsigned short Port,unsigned long *Buffer,unsigned long Count)|  
|[__outword](../VS_csharp/__outword.md)||intrin.h|void __outword(unsigned short Port,unsigned short Data)|  
|[__outwordstring](../VS_csharp/__outwordstring.md)||intrin.h|void __outwordstring(unsigned short Port,unsigned short *Buffer,unsigned long Count)|  
...
|[__popcnt](../VS_csharp/__popcnt16--__popcnt--__popcnt64.md)|POPCNT|intrin.h|unsigned int __popcnt(unsigned int)|  
|[__popcnt16](../VS_csharp/__popcnt16--__popcnt--__popcnt64.md)|POPCNT|intrin.h|unsigned short __popcnt16(unsigned short)|  
|[__popcnt64](../VS_csharp/__popcnt16--__popcnt--__popcnt64.md)|POPCNT|intrin.h|unsigned __int64 \__popcnt64(unsigned \__int64)|  
...
|[__rdtsc](../VS_csharp/__rdtsc.md)||intrin.h|unsigned __int64 \__rdtsc(void)|  
|[__rdtscp](../VS_csharp/__rdtscp.md)|RDTSCP|intrin.h|unsigned __int64 \__rdtscp(unsigned int*)|  
|[_ReadBarrier](../VS_csharp/_readbarrier.md)||intrin.h|void _ReadBarrier(void)|  
|[__readcr0](../VS_csharp/__readcr0.md)||intrin.h|unsigned __int64 \__readcr0(void)|  
|[__readcr2](../VS_csharp/__readcr2.md)||intrin.h|unsigned __int64 \__readcr2(void)|  
|[__readcr3](../VS_csharp/__readcr3.md)||intrin.h|unsigned __int64 \__readcr3(void)|  
|[__readcr4](../VS_csharp/__readcr4.md)||intrin.h|unsigned __int64 \__readcr4(void)|  
|[__readcr8](../VS_csharp/__readcr8.md)||intrin.h|unsigned __int64 \__readcr8(void)|  
|[__readdr](../VS_csharp/__readdr.md)||intrin.h|unsigned __int64 \__readdr(unsigned)|  
|[__readeflags](../VS_csharp/__readeflags.md)||intrin.h|unsigned __int64 \__readeflags(void)|  
...
|[__readgsbyte](../VS_csharp/__readgsbyte--__readgsdword--__readgsqword--__readgsword.md)||intrin.h|unsigned char __readgsbyte(unsigned long Offset)|  
|[__readgsdword](../VS_csharp/__readgsbyte--__readgsdword--__readgsqword--__readgsword.md)||intrin.h|unsigned long __readgsdword(unsigned long Offset)|  
|[__readgsqword](../VS_csharp/__readgsbyte--__readgsdword--__readgsqword--__readgsword.md)||intrin.h|unsigned __int64 \__readgsqword(unsigned long Offset)|  
|[__readgsword](../VS_csharp/__readgsbyte--__readgsdword--__readgsqword--__readgsword.md)||intrin.h|unsigned short __readgsword(unsigned long Offset)|  
|[__readmsr](../VS_csharp/__readmsr.md)||intrin.h|unsigned __int64 \__readmsr(unsigned long)|  
|[__readpmc](../VS_csharp/__readpmc.md)||intrin.h|unsigned __int64 \__readpmc(unsigned long a)|  
|[_ReadWriteBarrier](../VS_csharp/_readwritebarrier.md)||intrin.h|void _ReadWriteBarrier(void)|  
|[_ReturnAddress](../VS_csharp/_returnaddress.md)||intrin.h|void * _ReturnAddress(void)|  
...
|[_rotl16](../VS_csharp/_rotl8--_rotl16.md)||intrin.h|unsigned short _rotl16(unsigned short value,unsigned char shift)|  
|[_rotl8](../VS_csharp/_rotl8--_rotl16.md)||intrin.h|unsigned char _rotl8(unsigned char value,unsigned char shift)|  
|[_rotr16](../VS_csharp/_rotr8--_rotr16.md)||intrin.h|unsigned short _rotr16(unsigned short value,unsigned char shift)|  
|[_rotr8](../VS_csharp/_rotr8--_rotr16.md)||intrin.h|unsigned char _rotr8(unsigned char value,unsigned char shift)|  
...
|[__segmentlimit](../VS_csharp/__segmentlimit.md)||intrin.h|unsigned long __segmentlimit(unsigned long a)|  
|_sgdt||intrin.h|void _sgdt(void*)|  
|[__shiftleft128](../VS_csharp/__shiftleft128.md)||intrin.h|unsigned __int64 \__shiftleft128(unsigned \__int64 LowPart,unsigned \__int64 HighPart,unsigned char Shift)|  
|[__shiftright128](../VS_csharp/__shiftright128.md)||intrin.h|unsigned __int64 \__shiftright128(unsigned \__int64 LowPart,unsigned \__int64 HighPart,unsigned char Shift)|  
...
|[__sidt](../VS_csharp/__sidt.md)||intrin.h|void __sidt(void*)|  
...
|[__stosb](../VS_csharp/__stosb.md)||intrin.h|void __stosb(IN PBYTE,IN BYTE,IN SIZE_T)|  
|[__stosd](../VS_csharp/__stosd.md)||intrin.h|void __stosd(IN PDWORD,IN DWORD,IN SIZE_T)|  
|[__stosq](../VS_csharp/__stosq.md)||intrin.h|void __stosq(IN PDWORD64,IN DWORD64,IN SIZE_T)|  
|[__stosw](../VS_csharp/__stosw.md)||intrin.h|void __stosw(IN PWORD,IN WORD,IN SIZE_T)|  
...
|[__svm_clgi](../VS_csharp/__svm_clgi.md)||intrin.h|void __svm_clgi(void)|  
|[__svm_invlpga](../VS_csharp/__svm_invlpga.md)||intrin.h|void __svm_invlpga(void*,int)|  
|[__svm_skinit](../VS_csharp/__svm_skinit.md)||intrin.h|void __svm_skinit(int)|  
|[__svm_stgi](../VS_csharp/__svm_stgi.md)||intrin.h|void __svm_stgi(void)|  
|[__svm_vmload](../VS_csharp/__svm_vmload.md)||intrin.h|void __svm_vmload(size_t)|  
|[__svm_vmrun](../VS_csharp/__svm_vmrun.md)||intrin.h|void __svm_vmrun(size_t)|  
|[__svm_vmsave](../VS_csharp/__svm_vmsave.md)||intrin.h|void __svm_vmsave(size_t)|  
...
|[__ud2](../VS_csharp/__ud2.md)||intrin.h|void __ud2(void)|  
|[__ull_rshift](../VS_csharp/__ull_rshift.md)||intrin.h|unsigned __int64 [pascal/cdecl] \__ull_rshift(unsigned \__int64,int)|  
|[_umul128](../VS_csharp/_umul128.md)||intrin.h|unsigned __int64 _umul128(unsigned \__int64 multiplier,unsigned \__int64 multiplicand,unsigned \__int64 *highproduct)|  
|[__umulh](../VS_csharp/__umulh.md)||intrin.h|unsigned __int64 \__umulh(unsigned \__int64,unsigned \__int64)|  
|[__vmx_off](../VS_csharp/__vmx_off.md)||intrin.h|void __vmx_off(void)|  
|[__vmx_on](../VS_csharp/__vmx_on.md)||intrin.h|unsigned char __vmx_on(unsigned \__int64*)|  
|[__vmx_vmclear](../VS_csharp/__vmx_vmclear.md)||intrin.h|unsigned char __vmx_vmclear(unsigned \__int64*)|  
|[__vmx_vmlaunch](../VS_csharp/__vmx_vmlaunch.md)||intrin.h|unsigned char __vmx_vmlaunch(void)|  
|[__vmx_vmptrld](../VS_csharp/__vmx_vmptrld.md)||intrin.h|unsigned char __vmx_vmptrld(unsigned \__int64*)|  
|[__vmx_vmptrst](../VS_csharp/__vmx_vmptrst.md)||intrin.h|void __vmx_vmptrst(unsigned \__int64 *)|  
|[__vmx_vmread](../VS_csharp/__vmx_vmread.md)||intrin.h|unsigned char __vmx_vmread(size_t,size_t*)|  
|[__vmx_vmresume](../VS_csharp/__vmx_vmresume.md)||intrin.h|unsigned char __vmx_vmresume(void)|  
|[__vmx_vmwrite](../VS_csharp/__vmx_vmwrite.md)||intrin.h|unsigned char __vmx_vmwrite(size_t,size_t)|  
|[__wbinvd](../VS_csharp/__wbinvd.md)||intrin.h|void __wbinvd(void)|  
|[_WriteBarrier](../VS_csharp/_writebarrier.md)||intrin.h|void _WriteBarrier(void)|  
|[__writecr0](../VS_csharp/__writecr0.md)||intrin.h|void __writecr0(unsigned \__int64)|  
|[__writecr3](../VS_csharp/__writecr3.md)||intrin.h|void __writecr3(unsigned \__int64)|  
|[__writecr4](../VS_csharp/__writecr4.md)||intrin.h|void __writecr4(unsigned \__int64)|  
|[__writecr8](../VS_csharp/__writecr8.md)||intrin.h|void __writecr8(unsigned \__int64)|  
|[__writedr](../VS_csharp/__writedr.md)||intrin.h|void __writedr(unsigned,unsigned \__int64)|  
|[__writeeflags](../VS_csharp/__writeeflags.md)||intrin.h|void __writeeflags(unsigned \__int64)|  
...
|[__writegsbyte](../VS_csharp/__writegsbyte--__writegsdword--__writegsqword--__writegsword.md)||intrin.h|void __writegsbyte(unsigned long Offset,unsigned char Data)|  
|[__writegsdword](../VS_csharp/__writegsbyte--__writegsdword--__writegsqword--__writegsword.md)||intrin.h|void __writegsdword(unsigned long Offset,unsigned long Data)|  
|[__writegsqword](../VS_csharp/__writegsbyte--__writegsdword--__writegsqword--__writegsword.md)||intrin.h|void __writegsqword(unsigned long Offset,unsigned \__int64 Data)|  
|[__writegsword](../VS_csharp/__writegsbyte--__writegsdword--__writegsqword--__writegsword.md)||intrin.h|void __writegsword(unsigned long Offset,unsigned short Data)|  
|[__writemsr](../VS_csharp/__writemsr.md)||intrin.h|void __writemsr(unsigned long,unsigned \__int64)|  
