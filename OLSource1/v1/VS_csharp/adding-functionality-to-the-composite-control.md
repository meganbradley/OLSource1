...
> [!NOTE]
>  If you need to handle messages from Windows controls, see [Implementing a Window](../VS_csharp/implementing-a-window.md) for more information on message handling in ATL.  
