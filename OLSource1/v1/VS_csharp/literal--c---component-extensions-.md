...
## Remarks  
 ...
 For more information, see [static (C++)](../Topic/Static%20\(C++\).md) and [const (C++)](../VS_csharp/const--c---.md).  
  
 `literal` is a context-sensitive keyword. See [Context-Sensitive Keywords](../VS_csharp/context-sensitive-keywords---c---component-extensions-.md) for more information.  
