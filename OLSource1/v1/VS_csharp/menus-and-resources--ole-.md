...
-   Open, for editing an item outside the context of its container, often in a separate window.  
 ...
 In-place activation requires that the container and server applications must negotiate for menu, toolbar, and status bar space. All resources must be designed with this in mind. The article [Menus and Resources: Menu Merging](../VS_csharp/menus-and-resources--menu-merging.md) covers this topic in detail.  
...
-   [Menus and Resources: Container Additions](../VS_csharp/menus-and-resources--container-additions.md)  
