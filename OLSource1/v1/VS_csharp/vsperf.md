...
2.  Profile Windows 8 desktop applications and Windows Server 2012 applications using the sampling profiling method.  
 ...
 For more information about your profiling options, see [Profiling Windows 8 and Windows Server 2012 applications](../VS_csharp/performance-tools-on-windows-8-and-windows-server-2012-applications.md).  
...
## See Also  
 [Profiling Windows 8 and Windows Server 2012 applications](../VS_csharp/performance-tools-on-windows-8-and-windows-server-2012-applications.md)   
