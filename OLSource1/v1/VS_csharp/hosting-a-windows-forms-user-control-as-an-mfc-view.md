...
MFC uses the CWinFormsView class to host a Windows Forms user control in an MFC view. MFC Windows Forms views are ActiveX controls. The user control is hosted as a child of the native view and occupies the entire client area of the native view.  
 ...
 The end result resembles the model used by the [CFormView Class](../VS_csharp/cformview-class.md). This lets you take advantage of the Windows Forms designer and runtime to create rich form-based views.  
  
 Because MFC Windows Forms views are ActiveX controls, they do not have the same `hwnd` as MFC views. Also they cannot be passed as a pointer to a [CView](../VS_csharp/cview-class.md) view. In general, use .NET Framework methods to work with Windows Forms views and rely less on Win32.  
...
## In This Section  
 [How to: Create the User Control and Host MDI View](../VS_csharp/how-to--create-the-user-control-and-host-mdi-view.md)  
 ...
 [How to: Call Properties and Methods of the Windows Forms Control](../VS_csharp/how-to--call-properties-and-methods-of-the-windows-forms-control.md)  
