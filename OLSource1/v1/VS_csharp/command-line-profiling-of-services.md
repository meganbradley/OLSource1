...
This section describes the procedures and options for collecting performance data for Windows services by using [!INCLUDE[vsprvs](../VS_csharp/includes/vsprvs_md.md)] Profiling Tools from the command line.  
...
|**Profile ASP.NET applications**|-   [Command-Line Profiling of ASP.NET Applications](../VS_csharp/command-line-profiling-of-asp.net-web-applications.md)|