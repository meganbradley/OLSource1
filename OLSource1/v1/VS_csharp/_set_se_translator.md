...
## Remarks  
 ...
 You must use [/EHa](../VS_csharp/-eh--exception-handling-model-.md) when using `_set_se_translator`.  
...
|`_set_se_translator`|<eh.h>|  
 ...
 The functionality provided by `_set_se_translator` is not available in code compiled with the [/clr:pure](../VS_csharp/-clr--common-language-runtime-compilation-.md) compiler option.  
