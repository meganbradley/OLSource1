...
> [!NOTE]
>  In Windows, the terms "directory" and "folder" are used interchangeably. Most documentation and user interface text uses the term "folder," but the [!INCLUDE[dnprdnshort](../VS_csharp/includes/dnprdnshort_md.md)] class library uses the term "directory."  
...
## Example  
 ...
 [!code[csFilesandFolders#1](../VS_csharp/codesnippet/CSharp/how-to--iterate-through-a-directory-tree--csharp-programming-guide-_1.cs)]  
...
## Example  
 ...
 [!code[csFilesandFolders#2](../VS_csharp/codesnippet/CSharp/how-to--iterate-through-a-directory-tree--csharp-programming-guide-_2.cs)]  
...
## See Also  
 <xref:System.IO*>   
 [LINQ and File Directories](../VS_csharp/linq-and-file-directories.md)   
 [Files, Folders and Drives (Visual C#)](../VS_csharp/file-system-and-the-registry--csharp-programming-guide-.md)