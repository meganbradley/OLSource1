...
1.  In Visual Studio, set the solution configuration to **Release** and choose the deployment target.  
     ...
     ![Select Release and Local Machine](../VS_csharp/media/cpuuse_selectreleaselocalmachine.png "CPUUSE_SelectReleaseLocalMachine")  
...
3.  Choose **CPU Usage** and then choose **Start**.  
     ...
     ![Choose CPU Usage](../VS_csharp/media/cpuuse_lib_choosecpuusage.png "CPUUSE_LIB_ChooseCpuUsage")  
