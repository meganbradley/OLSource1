...
## Parameters  
 The following table describes the parameters of the [CreateCSharpManifestResourceName Task](../VS_csharp/createcsharpmanifestresourcename-task.md).  
...
|`ResourceFiles`|Required `String` parameter.<br /><br /> The name of the resource file from which to create the [!INCLUDE[csprcs](../VS_csharp/includes/csprcs_md.md)] manifest name.|  
