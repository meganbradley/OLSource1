...
apitype: "Assembly"
f1_keywords: 
  - "Microsoft.FSharp.Core.PrintfFormat`5.#ctor"
dev_langs: 
  - "FSharp"
helpviewer_keywords: 
...
## See Also  
 [Core.PrintfFormat<'Printer,'State,'Residue,'Result,'Tuple> Class (F#)](../VS_csharp/core.printfformat--printer--state--residue--result--tuple--class--fsharp-.md)   
