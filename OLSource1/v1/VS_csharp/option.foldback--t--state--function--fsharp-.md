...
Performs the equivalent of the [List.foldBack](../VS_csharp/list.foldback--t--state--function--fsharp-.md) operation on an option.  
...
## Example  
 ...
 [!code[FsOptions#5](../VS_csharp/codesnippet/FSharp/option.foldback--t--state--function--fsharp-_1.fs)]  
