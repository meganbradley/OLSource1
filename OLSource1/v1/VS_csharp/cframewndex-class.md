...
---
# CFrameWndEx Class
Implements the functionality of a Windows single document interface (SDI) overlapped or popup frame window, and provides members for managing the window. It extends the [CFrameWnd](../VS_csharp/cframewnd-class.md) class.  
...
|[CFrameWndEx::GetDockingManager](#cframewndex__getdockingmanager)|Retrieves the [CDockingManager](../VS_csharp/cdockingmanager-class.md) object for the frame window.|  
...
## Example  
 The following example demonstrates how to inherit a class from the `CFrameWndEx` class. The example illustrates the method signatures in the subclass, and how to override the `OnShowPopupMenu` method. This code snippet is part of the [Word Pad sample](../VS_csharp/visual-c---samples.md).  
  
 [!code[NVC_MFC_WordPad#3](../VS_csharp/codesnippet/CPP/cframewndex-class_1.h)]  
[!code[NVC_MFC_WordPad#4](../VS_csharp/codesnippet/CPP/cframewndex-class_2.cpp)]  
...
##  <a name="cframewndex__getdockingmanager"></a>  CFrameWndEx::GetDockingManager  
 Retrieves the [CDockingManager](../VS_csharp/cdockingmanager-class.md) object for the frame window.  
...
### Return Value  
 A pointer to the [CDockingManager](../VS_csharp/cdockingmanager-class.md).  
  
### Remarks  
 The frame window creates and uses a [CDockingManager](../VS_csharp/cdockingmanager-class.md) object to manage child window docking.  
...
### Return Value  
 Pointer to the [CMFCRibbonBar](../VS_csharp/cmfcribbonbar-class.md) for the frame.  
...
### Remarks  
 You must register each control bar by using the [CDockingManager Class](../VS_csharp/cdockingmanager-class.md) to take a part in the docking layout.  
...
### Parameters  
 ...
 [in] `pContext`  
 Pointer to a [CCreateContext](../VS_csharp/ccreatecontext-structure.md) class that is used by the framework during application creation.  
...
### Parameters  
 [in] `lpCreateStruct`  
 A pointer to the [CREATESTRUCT](../VS_csharp/createstruct-structure.md) for the new frame.  
...
### Parameters  
 [in] `pFrame`  
 Pointer to the [CPaneFrameWnd](../VS_csharp/cpaneframewnd-class.md) pane window.  
...
### Parameters  
 ...
 [in, out] `pRect`  
 Pointer to a [CRect](../VS_csharp/crect-class.md) or [RECT](../VS_csharp/rect-structure.md) structure that contains the frame's coordinates.  
...
### Parameters  
 [in] `lpwndpos`  
 Pointer to a [WINDOWPOS](../VS_csharp/windowpos-structure.md) structure that contains the new size and position.  
...
### Remarks  
 ...
 The [docking manager](../VS_csharp/cdockingmanager-class.md) handles the layout of control bars. You must register each control bar with the docking manager by using the [AddControlBar](#cframewndex__addpane) method or the [InsertControlBar](#cframewndex__insertpane) method.  
