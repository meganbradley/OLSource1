...
-   An individual compiler may adjust the packing of a structure for size reasons. For example [/Zp (Struct Member Alignment)](../VS_csharp/-zp--struct-member-alignment-.md) allows for adjusting the packing of structures.  
