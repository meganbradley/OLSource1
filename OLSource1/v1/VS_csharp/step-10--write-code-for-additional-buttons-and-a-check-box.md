...
-   Add the following code to your Form1 code file (Form1.cs or Form1.vb). Choose the **VB** tab to view Visual Basic code.  
     ...
     [!code[VbExpressTutorial1Step9_10#2](../VS_csharp/codesnippet/VisualBasic/step-10--write-code-for-additional-buttons-and-a-check-box_1.vb)]
[!code[VbExpressTutorial1Step9_10#2](../VS_csharp/codesnippet/CSharp/step-10--write-code-for-additional-buttons-and-a-check-box_1.cs)]  
  
### To continue or review  
  
-   To go to the next tutorial step, see [Step 11: Run Your Program and Try Other Features](../VS_csharp/step-11--run-your-program-and-try-other-features.md).  
  
-   To return to the previous tutorial step, see [Step 9: Review and Comment Your Code](../VS_csharp/step-9--review--comment--and-test-your-code.md).