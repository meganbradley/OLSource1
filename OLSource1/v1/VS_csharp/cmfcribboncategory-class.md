...
---
# CMFCRibbonCategory Class
The `CMFCRibbonCategory` class implements a ribbon tab that contains a group of [ribbon panels](../VS_csharp/cmfcribbonpanel-class.md).  
...
## Remarks  
 Typically, you create a ribbon category indirectly by calling [CMFCRibbonBar::AddCategory](../VS_csharp/cmfcribbonbar-class.md#cmfcribbonbar__addcategory), which returns a pointer to the newly created ribbon category. You add panels to the category by calling [CMFCRibbonCategory::AddPanel](#cmfcribboncategory__addpanel).  
  
 The `CMFCRibbonTab` class draws ribbon categories. It is derived from [CMFCRibbonBaseElement](../VS_csharp/cmfcribbonbaseelement-class.md).  
 ...
 ![CMFCRibbonCategory image](../VS_csharp/media/cmfcribboncategory.png "CMFCRibbonCategory")  
...
### Example  
 ...
 [!code[NVC_MFC_RibbonApp#10](../VS_csharp/codesnippet/CPP/cmfcribboncategory-class_1.cpp)]  
  
##  <a name="cmfcribboncategory__cmfcribboncategory"></a>  CMFCRibbonCategory::CMFCRibbonCategory  
 Constructs and initializes a [CMFCRibbonCategory](../VS_csharp/cmfcribboncategory-class.md) object.  
...
##  <a name="cmfcribboncategory__copyfrom"></a>  CMFCRibbonCategory::CopyFrom  
 Copies the state of the specified [CMFCRibbonCategory](../VS_csharp/cmfcribboncategory-class.md) to the current [CMFCRibbonCategory](../VS_csharp/cmfcribboncategory-class.md) object.  
...
### Parameters  
 [in] `src`  
 The source [CMFCRibbonCategory](../VS_csharp/cmfcribboncategory-class.md) object.  
...
### Parameters  
 [in, out] `arElements`  
 Reference to a [CArray](../VS_csharp/carray-class.md) of ribbon elements.  
...
### Remarks  
 For more information about highlighting a ribbon panel, see [CMFCRibbonPanel::Highlight](../VS_csharp/cmfcribbonpanel-class.md#cmfcribbonpanel__highlight).  
...
### Example  
 ...
 [!code[NVC_MFC_RibbonApp#13](../VS_csharp/codesnippet/CPP/cmfcribboncategory-class_2.cpp)]  
