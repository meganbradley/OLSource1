...
## Remarks  
 The <example\> tag lets you specify an example of how to use a method or other library member. This commonly involves using the [<code\>](../VS_csharp/-code---csharp-programming-guide-.md) tag.  
  
 Compile with [/doc](../VS_csharp/-doc--csharp-compiler-options-.md) to process documentation comments to a file.  
  
## Example  
 [!code[csProgGuideDocComments#3](../VS_csharp/codesnippet/CSharp/-example---csharp-programming-guide-_1.cs)]  
