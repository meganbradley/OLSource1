...
#### Parameters  
 `mapping`  
 Type: [char](../VS_csharp/core.char-type-abbreviation--fsharp-.md) `->` [char](../VS_csharp/core.char-type-abbreviation--fsharp-.md)  
...
## Example  
 ...
 [!code[FsStrings#7](../VS_csharp/codesnippet/FSharp/string.map-function--fsharp-_1.fs)]  
