...
-   You make your code more readable by eliminating repetitive qualifying expressions.  
 ...
 Unless the block contains a loop, the statements run only once. You can nest different kinds of control structures. For more information, see [Nested Control Structures](../VS_csharp/nested-control-structures--visual-basic-.md).  
  
> [!NOTE]
>  You can use the `With` keyword in object initializers also. For more information and examples, see [Object Initializers: Named and Anonymous Types](../VS_csharp/object-initializers--named-and-anonymous-types--visual-basic-.md) and [Anonymous Types](../VS_csharp/anonymous-types--visual-basic-.md).  
>   
...
## Example  
 ...
 [!code[VbVbalrWithStatement#2](../VS_csharp/codesnippet/VisualBasic/with...end-with-statement--visual-basic-_1.vb)]  
...
## Example  
 ...
 [!code[VbVbalrWithStatement#1](../VS_csharp/codesnippet/VisualBasic/with...end-with-statement--visual-basic-_2.vb)]  
