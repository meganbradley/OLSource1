...
# XML Schemas and Data in Document-Level Customizations
 ...
 Visual Studio exposes mapped schema elements in document-level customizations as controls in the programming model. For Excel, Visual Studio adds support for binding the controls to data in databases, Web services, and objects. For Word and Excel, Visual Studio adds support for actions panes, which can be used with a schema-mapped document to create an enhanced end user experience for your solutions. For more information, see [Actions Pane Overview](../VS_officedev/actions-pane-overview.md).  
...
## Deployment of Solutions That Include XML Schemas  
 ...
 [!code[Trin_VstcoreDataWord#1](../VS_officedev/codesnippet/VisualBasic/xml-schemas-and-data-in-document-level-customizations_1.vb)]
[!code[Trin_VstcoreDataWord#1](../VS_officedev/codesnippet/CSharp/xml-schemas-and-data-in-document-level-customizations_1.cs)]  
