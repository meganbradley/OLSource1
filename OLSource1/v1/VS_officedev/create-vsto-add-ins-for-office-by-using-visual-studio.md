...
## In This Section  
 ...
 Provides information about the differences between building Office projects and other types of projects in [!INCLUDE[vsprvs](../VS_officedev/includes/vsprvs_md.md)].  
  
 [Debugging Office Projects](../VS_officedev/debugging-office-projects.md)  
 Provides information about the differences between debugging Office projects and other types of projects in [!INCLUDE[vsprvs](../VS_officedev/includes/vsprvs_md.md)].  
 ...
 Provides links to information about API namespaces and types that are used in Office projects that target the [!INCLUDE[net_v40_short](../VS_officedev/includes/net_v40_short_md.md)]. For API reference documentation about the namespaces and types that are used in Office projects that target the .NET Framework 3.5, see the following reference section in the Visual Studio 2008 documentation: [2007 System Managed Reference](http://go.microsoft.com/fwlink/?LinkId=160658).  
...
## Related Sections  
 ...
 [.NET Framework Programming in Visual Studio](assetId:///f3f63195-82c6-48e8-a4a0-612810e7d093)  
