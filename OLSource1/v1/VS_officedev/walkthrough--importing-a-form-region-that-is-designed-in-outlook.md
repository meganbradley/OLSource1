---
title: "Walkthrough: Importing a Form Region That Is Designed in Outlook"
ms.custom: na
ms.date: "10/01/2016"
...
-   [!INCLUDE[Outlook_15_short](../VS_officedev/includes/outlook_15_short_md.md)] or [!INCLUDE[Outlook_14_short](../VS_officedev/includes/outlook_14_short_md.md)].  
  
> [!NOTE]  
>  Your computer might show different names or locations for some of the Visual Studio user interface elements in the following instructions. The Visual Studio edition that you have and the settings that you use determine these elements. For more information, see [Customizing Development Settings in Visual Studio](assetId:///22c4debb-4e31-47a8-8f19-16f328d7dcd3).  
  
 ![link to video](../VS_officedev/media/playvideo.gif "PlayVideo") For a related video demonstration, see [How Do I: Create Outlook Form Regions Using Visual Studio 2008?](http://go.microsoft.com/fwlink/?LinkID=130305).  
  
## Designing a Form Region by Using the Form Region Designer in Outlook  
 In this step you will design a form region in Outlook. You will then the save the form region to an easy-to-find location so that you can import it into [!INCLUDE[vsprvs](../VS_officedev/includes/vsprvs_md.md)].  
...
2.  In Outlook, on the **Developer** tab, click **Design a Form**. For more information, see [How to: Show the Developer Tab on the Ribbon](../VS_officedev/how-to--show-the-developer-tab-on-the-ribbon.md).  
...
1.  In [!INCLUDE[vsprvs](../VS_officedev/includes/vsprvs_md.md)], create an Outlook VSTO Add-in project with the name **TaskAddIn**.  
...
5.  On the **Select the type of form region you want to create** page, click **Replace-all**, and then click **Next**.  
     ...
     A *replace-all* form region replaces the entire Outlook form. For more information about form region types, see [Creating Outlook Form Regions](../VS_officedev/creating-outlook-form-regions.md).  
...
2.  Add the following code to the `TaskFormRegion` class. This code populates the combo box on the form region with the subject line of each task from the Outlook Tasks folder.  
     ...
     [!code[Trin_Outlook_FR_Import#1](../VS_officedev/codesnippet/CSharp/walkthrough--importing-a-form-region-that-is-designed-in-outlook_1.cs)]
[!code[Trin_Outlook_FR_Import#1](../VS_officedev/codesnippet/VisualBasic/walkthrough--importing-a-form-region-that-is-designed-in-outlook_1.vb)]  
...
3.  Add the following code to the `TaskFormRegion` class. This code performs the following tasks:  
    ...
    -   Adds the subject of the task to the hidden field on the form region. The hidden field stores these values as part of the Outlook item.  
     ...
     [!code[Trin_Outlook_FR_Import#2](../VS_officedev/codesnippet/CSharp/walkthrough--importing-a-form-region-that-is-designed-in-outlook_2.cs)]
[!code[Trin_Outlook_FR_Import#2](../VS_officedev/codesnippet/VisualBasic/walkthrough--importing-a-form-region-that-is-designed-in-outlook_2.vb)]  
...
4.  Add the following code to the `TaskFormRegion` class. This code provides the helper method `FindTaskBySubjectName` that was described in the preceding step.  
     ...
     [!code[Trin_Outlook_FR_Import#3](../VS_officedev/codesnippet/CSharp/walkthrough--importing-a-form-region-that-is-designed-in-outlook_3.cs)]
[!code[Trin_Outlook_FR_Import#3](../VS_officedev/codesnippet/VisualBasic/walkthrough--importing-a-form-region-that-is-designed-in-outlook_3.vb)]  
...
5.  Add the following code to the `TaskFormRegion` class. This code performs the following tasks:  
    ...
    -   Adds the Microsoft.Office.Interop.Outlook.TaskItem.Subject and Microsoft.Office.Interop.Outlook.TaskItem.PercentComplete values to the dependent task list box.  
     ...
     [!code[Trin_Outlook_FR_Import#4](../VS_officedev/codesnippet/CSharp/walkthrough--importing-a-form-region-that-is-designed-in-outlook_4.cs)]
[!code[Trin_Outlook_FR_Import#4](../VS_officedev/codesnippet/VisualBasic/walkthrough--importing-a-form-region-that-is-designed-in-outlook_4.vb)]  
...
6.  Replace the `TaskFormRegion_FormRegionShowing` event handler with the following code. This code performs the following tasks:  
    ...
    -   Calls the `RefreshTaskListBox` helper method when the form region appears. This displays any dependent tasks that were added to the list box when the item was previously opened.  
     ...
     [!code[Trin_Outlook_FR_Import#5](../VS_officedev/codesnippet/CSharp/walkthrough--importing-a-form-region-that-is-designed-in-outlook_5.cs)]
[!code[Trin_Outlook_FR_Import#5](../VS_officedev/codesnippet/VisualBasic/walkthrough--importing-a-form-region-that-is-designed-in-outlook_5.vb)]  
...
-   To learn more about how to design the appearance of a form region by dragging managed controls onto a visual designer, see [Walkthrough: Designing an Outlook Form Region](../VS_officedev/walkthrough--designing-an-outlook-form-region.md).  
  
-   To learn about how to customize the Ribbon of an Outlook item, see [Customizing a Ribbon for Outlook](../VS_officedev/customizing-a-ribbon-for-outlook.md).  
  
-   To learn more about how to add a custom task pane to Outlook, see [Custom Task Panes](../VS_officedev/custom-task-panes.md).  
