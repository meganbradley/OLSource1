---
title: "How to: Add a Resource File"
ms.custom: na
ms.date: "10/01/2016"
...
# How to: Add a Resource File
  The commands for adding resource files is on the shortcut menu of the solution node and feature nodes in Solution Explorer. For more information, see [Localizing SharePoint Solutions](../VS_officedev/localizing-sharepoint-solutions.md).  
  
### To add a global resource file to a SharePoint solution  
  
1.  In [!INCLUDE[vsprvs](../VS_officedev/includes/vsprvs_md.md)], open a SharePoint solution.  
...
5.  When the **Resource Editor** opens in [!INCLUDE[vsprvs](../VS_officedev/includes/vsprvs_md.md)], add resources to the resource file.  
  
### To add a feature resource file to a SharePoint feature  
  
1.  If the SharePoint solution is not already open in [!INCLUDE[vsprvs](../VS_officedev/includes/vsprvs_md.md)], open the solution.  
...
3.  When the **Resource Editor** opens in [!INCLUDE[vsprvs](../VS_officedev/includes/vsprvs_md.md)], add resources to the resource file.  
