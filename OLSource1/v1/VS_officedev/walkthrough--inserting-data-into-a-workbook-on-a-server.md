---
title: "Walkthrough: Inserting Data into a Workbook on a Server"
ms.custom: na
ms.date: "10/01/2016"
...
5.  If you have an existing connection to the AdventureWorksLT database, choose this connection and click **Next**.  
     ...
     Otherwise, click **New Connection**, and use the **Add Connection** dialog box to create the new connection. For more information, see [How to: Connect to Data in a Database](../VS_officedev/walkthrough--inserting-data-into-a-workbook-on-a-server.md).  
...
5.  Click **OK**.  
     ...
     [!INCLUDE[vsprvs](../VS_officedev/includes/vsprvs_md.md)] adds the **DataWriter** project to **Solution Explorer** and opens the **Program.cs** or **Module1.vb** code file.  
...
7.  Add the following **using** (for C#) or **Imports** (for Visual Basic) statement to the top of the code file.  
     ...
     [!code[Trin_CachedDataWalkthroughs#1](../VS_officedev/codesnippet/CSharp/walkthrough--inserting-data-into-a-workbook-on-a-server_1.cs)]
[!code[Trin_CachedDataWalkthroughs#1](../VS_officedev/codesnippet/VisualBasic/walkthrough--inserting-data-into-a-workbook-on-a-server_1.vb)]  
...
8.  Add the following code to the `Main` method. This code declares the following objects:  
    ...
    -   A \<xref:Microsoft.VisualStudio.Tools.Applications.ServerDocument> object to use to access the data cache in the workbook.  
     ...
     [!code[Trin_CachedDataWalkthroughs#3](../VS_officedev/codesnippet/CSharp/walkthrough--inserting-data-into-a-workbook-on-a-server_2.cs)]
[!code[Trin_CachedDataWalkthroughs#3](../VS_officedev/codesnippet/VisualBasic/walkthrough--inserting-data-into-a-workbook-on-a-server_2.vb)]  
...
9. Add the following code to the `Main` method, after the code you added in the previous step. This code performs the following tasks:  
    ...
    -   It uses the \<xref:Microsoft.VisualStudio.Tools.Applications.CachedDataItem.SerializeDataInstance*> method to populate the cached dataset with data from the local typed dataset.  
  
     [!code[Trin_CachedDataWalkthroughs#4](../VS_officedev/codesnippet/CSharp/walkthrough--inserting-data-into-a-workbook-on-a-server_3.cs)]
[!code[Trin_CachedDataWalkthroughs#4](../VS_officedev/codesnippet/VisualBasic/walkthrough--inserting-data-into-a-workbook-on-a-server_3.vb)]  
