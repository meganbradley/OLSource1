---
title: "Walkthrough: Programming Against Events of a NamedRange Control"
ms.custom: na
ms.date: "08/09/2016"
...
1.  Create an Excel Workbook project with the name **My Named Range Events**. Make sure that **Create a new document** is selected. For more information, see [How to: Create Office Projects in Visual Studio](../VS_officedev/how-to--create-office-projects-in-visual-studio.md).  
...
2.  Add code so the `namedRange1_BeforeDoubleClick` event handler looks like the following:  
     ...
     [!code[Trin_VstcoreHostControlsExcel#24](../VS_officedev/codesnippet/CSharp/walkthrough--programming-against-events-of-a-namedrange-control_1.cs)]
[!code[Trin_VstcoreHostControlsExcel#24](../VS_officedev/codesnippet/VisualBasic/walkthrough--programming-against-events-of-a-namedrange-control_1.vb)]  
  
3.  In C#, you must add event handlers for the named range as shown in the \<xref:Microsoft.Office.Tools.Excel.Worksheet.Startup> event below. For information on creating event handlers, see [How to: Create Event Handlers in Office Projects](../VS_officedev/how-to--create-event-handlers-in-office-projects.md).  
  
     [!code[Trin_VstcoreHostControlsExcel#25](../VS_officedev/codesnippet/CSharp/walkthrough--programming-against-events-of-a-namedrange-control_2.cs)]  
...
1.  Add code so the `NamedRange1_Change` event handler looks like the following:  
     ...
     [!code[Trin_VstcoreHostControlsExcel#26](../VS_officedev/codesnippet/CSharp/walkthrough--programming-against-events-of-a-namedrange-control_3.cs)]
[!code[Trin_VstcoreHostControlsExcel#26](../VS_officedev/codesnippet/VisualBasic/walkthrough--programming-against-events-of-a-namedrange-control_3.vb)]  
...
1.  Add code so the **NamedRange1_SelectionChange** event handler looks like the following:  
     ...
     [!code[Trin_VstcoreHostControlsExcel#27](../VS_officedev/codesnippet/CSharp/walkthrough--programming-against-events-of-a-namedrange-control_4.cs)]
[!code[Trin_VstcoreHostControlsExcel#27](../VS_officedev/codesnippet/VisualBasic/walkthrough--programming-against-events-of-a-namedrange-control_4.vb)]  
