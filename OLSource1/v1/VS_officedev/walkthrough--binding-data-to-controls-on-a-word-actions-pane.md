---
title: "Walkthrough: Binding Data to Controls on a Word Actions Pane"
ms.custom: na
ms.date: "08/09/2016"
...
## Setting Up the Data Source  
 To set up the data source, add code to the \<xref:System.Windows.Forms.UserControl.Load> event of the actions pane control to fill the control with data from the \<xref:System.Data.DataTable>, and set the \<xref:System.Windows.Forms.Binding.DataSource*> and \<xref:System.Windows.Forms.BindingSource.DataMember*> properties for each control.  
...
1.  In the \<xref:System.Windows.Forms.UserControl.Load> event handler of the `ActionsControl` class, add the following code.  
     ...
     [!code[Trin_VstcoreActionsPaneWord#1](../VS_officedev/codesnippet/VisualBasic/walkthrough--binding-data-to-controls-on-a-word-actions-pane_1.vb)]
[!code[Trin_VstcoreActionsPaneWord#1](../VS_officedev/codesnippet/CSharp/walkthrough--binding-data-to-controls-on-a-word-actions-pane_1.cs)]  
  
2.  In C#, you must attach the event handler to the \<xref:System.Windows.Forms.UserControl.Load> event. You can place this code in the `ActionsControl` constructor, after the call to `InitializeComponent`. For more information about how to create event handlers, see [How to: Create Event Handlers in Office Projects](../VS_officedev/how-to--create-event-handlers-in-office-projects.md).  
  
     [!code[Trin_VstcoreActionsPaneWord#33](../VS_officedev/codesnippet/CSharp/walkthrough--binding-data-to-controls-on-a-word-actions-pane_2.cs)]  
...
1.  In the `ActionsControl` class, create a method to format the headings of the table.  
     ...
     [!code[Trin_VstcoreActionsPaneWord#2](../VS_officedev/codesnippet/VisualBasic/walkthrough--binding-data-to-controls-on-a-word-actions-pane_3.vb)]
[!code[Trin_VstcoreActionsPaneWord#2](../VS_officedev/codesnippet/CSharp/walkthrough--binding-data-to-controls-on-a-word-actions-pane_3.cs)]  
...
1.  In the `ActionsControl` class, write a method that will create a table if one does not already exist, and add data from the actions pane to the table.  
     ...
     [!code[Trin_VstcoreActionsPaneWord#3](../VS_officedev/codesnippet/VisualBasic/walkthrough--binding-data-to-controls-on-a-word-actions-pane_4.vb)]
[!code[Trin_VstcoreActionsPaneWord#3](../VS_officedev/codesnippet/CSharp/walkthrough--binding-data-to-controls-on-a-word-actions-pane_4.cs)]  
...
1.  Add the following code to the \<xref:System.Windows.Forms.Control.Click> event handler of the **Insert** button.  
     ...
     [!code[Trin_VstcoreActionsPaneWord#4](../VS_officedev/codesnippet/VisualBasic/walkthrough--binding-data-to-controls-on-a-word-actions-pane_5.vb)]
[!code[Trin_VstcoreActionsPaneWord#4](../VS_officedev/codesnippet/CSharp/walkthrough--binding-data-to-controls-on-a-word-actions-pane_5.cs)]  
...
2.  In C#, you must create an event handler for the \<xref:System.Windows.Forms.Control.Click> event of the button.  You can place this code in the \<xref:System.Windows.Forms.UserControl.Load> event handler of the `ActionsControl` class.  
     ...
     [!code[Trin_VstcoreActionsPaneWord#5](../VS_officedev/codesnippet/CSharp/walkthrough--binding-data-to-controls-on-a-word-actions-pane_6.cs)]  
...
2.  Create a new instance of the control at the top of the `ThisDocument` class so that it looks like the following example.  
     ...
     [!code[Trin_VstcoreActionsPaneWord#6](../VS_officedev/codesnippet/CSharp/walkthrough--binding-data-to-controls-on-a-word-actions-pane_7.cs)]
[!code[Trin_VstcoreActionsPaneWord#6](../VS_officedev/codesnippet/VisualBasic/walkthrough--binding-data-to-controls-on-a-word-actions-pane_7.vb)]  
...
3.  Add code to the \<xref:Microsoft.Office.Tools.Word.Document.Startup> event handler of `ThisDocument` so that it looks like the following example.  
     ...
     [!code[Trin_VstcoreActionsPaneWord#7](../VS_officedev/codesnippet/CSharp/walkthrough--binding-data-to-controls-on-a-word-actions-pane_8.cs)]
[!code[Trin_VstcoreActionsPaneWord#7](../VS_officedev/codesnippet/VisualBasic/walkthrough--binding-data-to-controls-on-a-word-actions-pane_8.vb)]  
...
-   Binding data to controls in Excel. For more information, see [Walkthrough: Binding Data to Controls on an Excel Actions Pane](../VS_officedev/walkthrough--binding-data-to-controls-on-an-excel-actions-pane.md).  
