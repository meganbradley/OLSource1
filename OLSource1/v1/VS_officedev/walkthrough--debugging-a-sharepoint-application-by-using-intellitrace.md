---
title: "Walkthrough: Debugging a SharePoint Application by Using IntelliTrace"
ms.custom: na
ms.date: "10/01/2016"
...
> [!NOTE]  
>  The configuration information in this section is specific to this example. For more information about other configuration options, see [Using the IntelliTrace stand-alone collector](../Topic/Using%20the%20IntelliTrace%20stand-alone%20collector.md).  
  
1.  On the computer that's running SharePoint, [set up Microsoft Monitoring Agent and start to monitor your solution](../Topic/Using%20the%20IntelliTrace%20stand-alone%20collector.md).  
...
## See Also  
 ...
 [NIB: Walkthrough: Verify SharePoint Code by Using Unit Tests](assetId:///3d2c4aaf-3cb5-4825-b21b-f10222abe818)  
