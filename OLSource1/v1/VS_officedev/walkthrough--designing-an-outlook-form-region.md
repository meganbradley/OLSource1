---
title: "Walkthrough: Designing an Outlook Form Region"
ms.custom: na
ms.date: "10/01/2016"
...
-   [!INCLUDE[Outlook_15_short](../VS_officedev/includes/outlook_15_short_md.md)] or [!INCLUDE[Outlook_14_short](../VS_officedev/includes/outlook_14_short_md.md)].  
 ...
 ![link to video](../VS_officedev/media/playvideo.gif "PlayVideo") For a video version of this topic, see [Video How to: Designing an Outlook Form Region](http://go.microsoft.com/fwlink/?LinkID=140824).  
...
1.  In [!INCLUDE[vsprvs](../VS_officedev/includes/vsprvs_md.md)], create an Outlook VSTO Add-in project with the name **MapItAddIn**.  
...
5.  On the **Select the type of form region you want to create** page, click **Separate**, and then click **Next**.  
     ...
     A *separate* form region adds a new page to an Outlook form. For more information about form region types, see [Creating Outlook Form Regions](../VS_officedev/creating-outlook-form-regions.md).  
...
4.  Add the following code to the \<xref:Microsoft.Office.Tools.Outlook.FormRegionControl.FormRegionShowing> event handler. This code performs the following tasks:  
    ...
    -   Calls the \<xref:System.Windows.Forms.WebBrowser.Navigate*> method of the \<xref:System.Windows.Forms.WebBrowser> object and passes the URL string as a parameter.  
  
     The Local Search Web site appears in the Map It form region and presents each address in the scratch pad.  
  
     [!code[Trin_Outlook_FR_Separate#2](../VS_officedev/codesnippet/CSharp/walkthrough--designing-an-outlook-form-region_2.cs)]
[!code[Trin_Outlook_FR_Separate#2](../VS_officedev/codesnippet/VisualBasic/walkthrough--designing-an-outlook-form-region_2.vb)]  
