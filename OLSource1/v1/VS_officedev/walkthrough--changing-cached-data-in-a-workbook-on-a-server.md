---
title: "Walkthrough: Changing Cached Data in a Workbook on a Server"
ms.custom: na
ms.date: "10/01/2016"
...
-   [!INCLUDE[Excel_14_short](../VS_officedev/includes/excel_14_short_md.md)].  
...
2.  Replace the `Sheet1_Startup` event handler with the following code. This code uses an instance of the `ProductTableAdapter` class that is defined in the **AdventureWorksDataSet** project to fill the cached dataset with data, if it is currently empty.  
     ...
     [!code[Trin_CachedDataWalkthroughs#8](../VS_officedev/codesnippet/CSharp/walkthrough--changing-cached-data-in-a-workbook-on-a-server_1.cs)]
[!code[Trin_CachedDataWalkthroughs#8](../VS_officedev/codesnippet/VisualBasic/walkthrough--changing-cached-data-in-a-workbook-on-a-server_1.vb)]  
...
7.  Add the following **using** (for C#) or **Imports** (for Visual Basic) statement to the top of the code file.  
     ...
     [!code[Trin_CachedDataWalkthroughs#1](../VS_officedev/codesnippet/CSharp/walkthrough--changing-cached-data-in-a-workbook-on-a-server_2.cs)]
[!code[Trin_CachedDataWalkthroughs#1](../VS_officedev/codesnippet/VisualBasic/walkthrough--changing-cached-data-in-a-workbook-on-a-server_2.vb)]  
...
8.  Add the following code to the `Main` method. This code declares the following objects:  
    ...
    -   A \<xref:Microsoft.VisualStudio.Tools.Applications.ServerDocument> object to use to access the data cache in the workbook.  
     ...
     [!code[Trin_CachedDataWalkthroughs#6](../VS_officedev/codesnippet/CSharp/walkthrough--changing-cached-data-in-a-workbook-on-a-server_3.cs)]
[!code[Trin_CachedDataWalkthroughs#6](../VS_officedev/codesnippet/VisualBasic/walkthrough--changing-cached-data-in-a-workbook-on-a-server_3.vb)]  
...
9. Add the following code to the `Main` method, after the code you added in the previous step. This code performs the following tasks:  
    ...
    -   It saves the changes to the cached dataset in the workbook.  
     ...
     [!code[Trin_CachedDataWalkthroughs#7](../VS_officedev/codesnippet/CSharp/walkthrough--changing-cached-data-in-a-workbook-on-a-server_4.cs)]
[!code[Trin_CachedDataWalkthroughs#7](../VS_officedev/codesnippet/VisualBasic/walkthrough--changing-cached-data-in-a-workbook-on-a-server_4.vb)]  
