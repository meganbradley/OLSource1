---
title: "How to: Include Files by Using a Module"
ms.custom: na
ms.date: "10/01/2016"
...
# How to: Include Files by Using a Module
  *Modules* (not to be confused with [!INCLUDE[vbprvb](../VS_officedev/includes/vbprvb_md.md)] modules) are containers that enable you to deploy files such as ASPX master pages, text files, or images to SharePoint.  
...
1.  In [!INCLUDE[vsprvs](../VS_officedev/includes/vsprvs_md.md)], open or create a SharePoint project.  
...
5.  If you want your files to deploy to a particular folder structure in SharePoint, create those folders under Module1 in [!INCLUDE[vsprvs](../VS_officedev/includes/vsprvs_md.md)] by choosing the Module1 node, and then, on the menu bar, choosing **Project**, **New Folder**.  
