...
### Minimizing Object Model Guard Warnings  
 To help avoid security warnings when you use restricted properties and methods, make sure that your VSTO Add-in obtains Outlook objects from the `Application` field of the `ThisAddIn` class in your project. For more information about this field, see [Programming VSTO Add-Ins](../VS_officedev/programming-vsto-add-ins.md).  
 ...
 [!code[Trin_VstcoreOutlookSecurity#1](../VS_officedev/codesnippet/CSharp/specific-security-considerations-for-office-solutions_1.cs)]
[!code[Trin_VstcoreOutlookSecurity#1](../VS_officedev/codesnippet/VisualBasic/specific-security-considerations-for-office-solutions_1.vb)]  
 ...
 [!code[Trin_VstcoreOutlookSecurity#2](../VS_officedev/codesnippet/CSharp/specific-security-considerations-for-office-solutions_2.cs)]
[!code[Trin_VstcoreOutlookSecurity#2](../VS_officedev/codesnippet/VisualBasic/specific-security-considerations-for-office-solutions_2.vb)]  
...
-   Managed and unmanaged real-time data components.  
 ...
 The following procedures describe how users can use the **Trust Center** to restrict VSTO Add-ins from loading in Microsoft [!INCLUDE[Office_15_short](../VS_officedev/includes/office_15_short_md.md)] and Microsoft Office 2010. These procedures do not affect VSTO Add-ins or customizations created by using Office development tools in Visual Studio.  
  
#### To disable VSTO Add-ins in Microsoft Office 2010 and Microsoft [!INCLUDE[Office_15_short](../VS_officedev/includes/office_15_short_md.md)] applications  
