---
title: "Walkthrough: Import a Custom Master Page and Site Page with an Image"
ms.custom: na
ms.date: "10/01/2016"
...
# Walkthrough: Import a Custom Master Page and Site Page with an Image
  This walkthrough demonstrates how to import a SharePoint custom master page and a site page that has an image into a [!INCLUDE[vsprvs](../VS_officedev/includes/vsprvs_md.md)] SharePoint project.  
...
-   Import and deploy the .wsp file into a [!INCLUDE[vsprvs](../VS_officedev/includes/vsprvs_md.md)] SharePoint project by using the Import SharePoint Solution Package project.  
...
-   Supported editions of [!INCLUDE[TLA#tla_win](../VS_officedev/includes/tlasharptla_win_md.md)] and SharePoint. [!INCLUDE[crdefault](../VS_officedev/includes/crdefault_md.md)] [Requirements for Developing SharePoint Solutions](../VS_officedev/requirements-for-developing-sharepoint-solutions.md).  
...
## Import the Items into Visual Studio  
 Import the .wsp file into [!INCLUDE[vsprvs](../VS_officedev/includes/vsprvs_md.md)]. After the content is imported, you can customize it, add more items, and then deploy it.  
  
#### To import items from the .wsp file into Visual Studio  
  
1.  In [!INCLUDE[vsprvs](../VS_officedev/includes/vsprvs_md.md)], create an **Import SharePoint 2010 Solution Package** project.  
...
7.  Open the SharePoint site to view the deployed items.  
 ...
 An alternative way to import files into [!INCLUDE[vsprvs](../VS_officedev/includes/vsprvs_md.md)] and deploy them to SharePoint is to add the files into modules in [!INCLUDE[vsprvs](../VS_officedev/includes/vsprvs_md.md)]. [!INCLUDE[crdefault](../VS_officedev/includes/crdefault_md.md)] [How to: Import a Master Page or Theme](../VS_officedev/how-to--import-a-master-page-or-theme.md) and [Using Modules to Include Files in the Solution](../VS_officedev/using-modules-to-include-files-in-the-solution.md).  
