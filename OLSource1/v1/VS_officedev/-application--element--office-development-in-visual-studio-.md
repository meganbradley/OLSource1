...
### customization  
 The role of the `customization` element in the `vstov3` namespace is defined in [&#60;customization&#62; Element &#40;Office Development in Visual Studio&#41;](../VS_officedev/-customization--element--office-development-in-visual-studio-.md).  
