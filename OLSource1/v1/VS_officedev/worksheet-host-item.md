...
## Understanding Worksheet Host Items in VSTO Add-in projects  
 ...
 To generate a \<xref:Microsoft.Office.Tools.Excel.Worksheet> host item, use the GetVstoObject method. For more information, see [Extending Word Documents and Excel Workbooks in VSTO Add-ins at Run Time](../VS_officedev/extending-word-documents-and-excel-workbooks-in-vsto-add-ins-at-run-time.md).  
