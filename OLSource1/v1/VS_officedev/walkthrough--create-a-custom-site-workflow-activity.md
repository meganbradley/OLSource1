...
# Walkthrough: Create a Custom Site Workflow Activity
  This walkthrough demonstrates how to create a custom activity for a site-level workflow using [!INCLUDE[vsprvs](../VS_officedev/includes/vsprvs_md.md)]. (Site-level workflows apply to the whole site, not just a list on the site.) The custom activity creates a backup Announcements list and then copies the contents of the Announcements list into it.  
...
3.  Replace all of the code in Class1 with the following:  
     ...
     [!code[SP_AnnBackup#1](../VS_officedev/codesnippet/CSharp/walkthrough--create-a-custom-site-workflow-activity_1.cs)]
[!code[SP_AnnBackup#1](../VS_officedev/codesnippet/VisualBasic/walkthrough--create-a-custom-site-workflow-activity_1.vb)]  
