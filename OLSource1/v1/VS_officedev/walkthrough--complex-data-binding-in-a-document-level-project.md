...
2.  Add the following code to the `Sheet1_Startup` method to set the text for the b`utton`.  
     ...
     [!code[Trin_VstcoreDataExcel#8](../VS_officedev/codesnippet/CSharp/walkthrough--complex-data-binding-in-a-document-level-project_1.cs)]
[!code[Trin_VstcoreDataExcel#8](../VS_officedev/codesnippet/VisualBasic/walkthrough--complex-data-binding-in-a-document-level-project_1.vb)]  
  
3.  For C# only, add an event handler for the \<xref:System.Windows.Forms.Control.Click> event to the `Sheet1_Startup` method.  
  
     [!code[Trin_VstcoreDataExcel#9](../VS_officedev/codesnippet/CSharp/walkthrough--complex-data-binding-in-a-document-level-project_2.cs)]  
...
1.  Add an event handler for the \<xref:System.Windows.Forms.Control.Click> event of the b`utton`, and add the following code to commit all changes that have been made in the dataset back to the database.  
     ...
     [!code[Trin_VstcoreDataExcel#10](../VS_officedev/codesnippet/CSharp/walkthrough--complex-data-binding-in-a-document-level-project_3.cs)]
[!code[Trin_VstcoreDataExcel#10](../VS_officedev/codesnippet/VisualBasic/walkthrough--complex-data-binding-in-a-document-level-project_3.vb)]  
...
-   Create a master/detail relation between a field and a table. For more information, see [Walkthrough: Creating a Master Detail Relation Using a Cached Dataset](../VS_officedev/walkthrough--creating-a-master-detail-relation-using-a-cached-dataset.md).  
