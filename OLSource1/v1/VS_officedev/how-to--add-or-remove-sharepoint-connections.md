---
title: "How to: Add or Remove SharePoint Connections"
ms.custom: na
ms.date: "09/28/2016"
...
3.  In the **Add SharePoint Connection** box, enter the [!INCLUDE[TLA2#tla_url](../VS_officedev/includes/tla2sharptla_url_md.md)] for the SharePoint site (for example, http://testserver/sites/unittests).  
