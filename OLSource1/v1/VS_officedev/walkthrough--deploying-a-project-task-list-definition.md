...
# Walkthrough: Deploying a Project Task List Definition
  This walkthrough shows you how to use [!INCLUDE[vs_dev11_long](../VS_officedev/includes/vs_dev11_long_md.md)] to create, customize, debug, and deploy a SharePoint list to track project tasks.  
...
6.  Add code to the `ItemAdded` method in the **ProjectTaskListEventReceiver** code file. Each time a new task is added, a default due date and a description is added to the task. The default due date is July 1, 2009.  
     ...
     [!code[SPProjectTaskList#1](../VS_officedev/codesnippet/VisualBasic/walkthrough--deploying-a-project-task-list-definition_1.vb)]
[!code[SPProjectTaskList#1](../VS_officedev/codesnippet/CSharp/walkthrough--deploying-a-project-task-list-definition_1.cs)]  
...
2.  In the **Publish** dialog box, choose the **Publish to File System** option button.  
     ...
     You can change the target location in the **Publish** dialog box by choosing the ellipsis button ![Ellipsis Icon](../VS_officedev/media/ellipsisicon.gif "EllipsisIcon") and then navigating to another location.  
