...
-   You also have to complete the project in the topic [Walkthrough: Creating a Workflow with Association and Initiation Forms](../VS_officedev/walkthrough--creating-a-workflow-with-association-and-initiation-forms.md).  
...
1.  Load the completed project from the topic [Walkthrough: Creating a Workflow with Association and Initiation Forms](../VS_officedev/walkthrough--creating-a-workflow-with-association-and-initiation-forms.md) into [!INCLUDE[vsprvs](../VS_officedev/includes/vsprvs_md.md)].  
...
3.  In the [!INCLUDE[TLA2#tla_xml](../VS_officedev/includes/tla2sharptla_xml_md.md)] of ApplicationPage1.aspx, replace the `PlaceHolderMain` section with the following:  
