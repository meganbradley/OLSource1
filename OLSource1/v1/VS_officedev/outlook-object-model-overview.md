...
### MailItem Object  
 ...
 For an example that shows how to create an e-mail message, see [How to: Programmatically Create an E-Mail Item](../VS_officedev/how-to--programmatically-create-an-e-mail-item.md).  
