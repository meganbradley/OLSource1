...
### Application Object  
 ...
 In VSTO Add-in projects, you can access the Microsoft.Office.Interop.Visio.Application object by using the `Application` field of the `ThisAddIn` class. For more information, see [Programming VSTO Add-Ins](../VS_officedev/programming-vsto-add-ins.md).  
...
### Additional Types in Primary Interop Assemblies  
 ...
 For more information, see [Overview of Classes and Interfaces in the Office Primary Interop Assemblies](http://go.microsoft.com/fwlink/?LinkId=189592) and [Office Primary Interop Assemblies](../VS_officedev/office-primary-interop-assemblies.md).  
