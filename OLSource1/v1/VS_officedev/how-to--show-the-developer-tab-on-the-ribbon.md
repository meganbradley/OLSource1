...
2.  On the **File** tab, choose the **Options** button.  
     ...
     ![Choosing File, Options in Outlook 2010](../VS_officedev/media/vsto_office_file_tab.png "VSTO_Office_File_Tab")  
  
     The following figure shows the **File** tab in Office 2013.  
  
     ![The File tab in Outlook 2013](../VS_officedev/media/vsto_office2013_filetab.png "VSTO_Office2013_FileTab")  
  
     The following figure shows the **Options** button in Office 2013.  
  
     ![The Options button in Outlook 2013 Preview](../VS_officedev/media/vsto_office2013_optionsbutton.png "VSTO_Office2013_OptionsButton")  
...
3.  In the *ApplicationName***Options** dialog box, choose the **Customize Ribbon** button.  
     ...
     ![The Customize Ribbon button](../VS_officedev/media/vsto_office2010_customizeribbonbutton.png "VSTO_Office2010_CustomizeRibbonButton")  
  
4.  In the list of main tabs, select the **Developer** check box.  
  
     The following figure shows the **Developer** check box in Word 2010 and [!INCLUDE[Word_15_short](../VS_officedev/includes/word_15_short_md.md)]. The location of this check box is similar in all other applications listed in the "Applies to" section near the top of this topic.  
  
     ![The Developer check box in the Word Options dialog](../VS_officedev/media/vsto_office2010_developercheckbox.png "VSTO_Office2010_DeveloperCheckbox")  
