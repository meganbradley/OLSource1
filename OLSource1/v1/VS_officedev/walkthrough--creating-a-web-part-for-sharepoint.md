...
-   Supported editions of Microsoft Windows and SharePoint. For more information, see [Requirements for Developing SharePoint Solutions](../VS_officedev/requirements-for-developing-sharepoint-solutions.md).  
  
-   [!INCLUDE[vs_pro_current_short](../VS_officedev/includes/vs_pro_current_short_md.md)] or an edition of Visual Studio Application Lifecycle Management (ALM).  
...
2.  Add the following statements to the top of the Web Part code file.  
     ...
     [!code[SP_WebPart#1](../VS_officedev/codesnippet/CSharp/walkthrough--creating-a-web-part-for-sharepoint_1.cs)]
[!code[SP_WebPart#1](../VS_officedev/codesnippet/VisualBasic/walkthrough--creating-a-web-part-for-sharepoint_1.vb)]  
...
3.  Add the following code to the `WebPart1` class. This code declares the following fields:  
    ...
    -   A string that contains the path of the employee data file.  
     ...
     [!code[SP_WebPart#2](../VS_officedev/codesnippet/CSharp/walkthrough--creating-a-web-part-for-sharepoint_2.cs)]
[!code[SP_WebPart#2](../VS_officedev/codesnippet/VisualBasic/walkthrough--creating-a-web-part-for-sharepoint_2.vb)]  
...
4.  Add the following code to the `WebPart1` class. This code adds a custom property named `DataFilePath` to the Web Part. A custom property is a property that can be set in SharePoint by the user. This property gets and sets the location of a XML data file that is used to populate the data grid.  
     ...
     [!code[SP_WebPart#3](../VS_officedev/codesnippet/CSharp/walkthrough--creating-a-web-part-for-sharepoint_3.cs)]
[!code[SP_WebPart#3](../VS_officedev/codesnippet/VisualBasic/walkthrough--creating-a-web-part-for-sharepoint_3.vb)]  
...
5.  Replace the `CreateChildControls` method with the following code. This code performs the following tasks:  
    ...
    -   Binds the data grid to an XML file that contains employee data.  
     ...
     [!code[SP_WebPart#4](../VS_officedev/codesnippet/CSharp/walkthrough--creating-a-web-part-for-sharepoint_4.cs)]
[!code[SP_WebPart#4](../VS_officedev/codesnippet/VisualBasic/walkthrough--creating-a-web-part-for-sharepoint_4.vb)]  
...
6.  Add the following method to the `WebPart1` class. This code performs the following tasks:  
    ...
    -   Handles the event that is raised when the user chooses the verb in the verbs menu. This code filters the list of employees that appears in the data grid.  
     ...
     [!code[SP_WebPart#5](../VS_officedev/codesnippet/CSharp/walkthrough--creating-a-web-part-for-sharepoint_5.cs)]
[!code[SP_WebPart#5](../VS_officedev/codesnippet/VisualBasic/walkthrough--creating-a-web-part-for-sharepoint_5.vb)]  
