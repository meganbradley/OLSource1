...
## Binding Data to the Control  
 A \<xref:Microsoft.Office.Tools.Word.Bookmark> control supports simple data binding. The bookmark should be bound to a data source using the \<xref:System.Windows.Forms.IBindableComponent.DataBindings*> property. The default data binding property of the bookmark is the \<xref:Microsoft.Office.Tools.Word.Bookmark.Text*> property.  
  
 If the data in the bound dataset is updated, the \<xref:Microsoft.Office.Tools.Word.Bookmark> control reflects the changes.  
  
 In document-level projects, you can also bind data to bookmarks by using the **Data Sources** window. For more information, see [How to: Populate Documents with Data from Objects](../VS_officedev/how-to--populate-documents-with-data-from-objects.md).  
...
## Assigning Text to the Bookmark  
 ...
 The \<xref:Microsoft.Office.Tools.Word.Bookmark> control also has the \<xref:Microsoft.Office.Tools.Word.Bookmark.Text*> property. This is different from the \<xref:Microsoft.Office.Interop.Word.Range.Text*> property that is available on the \<xref:Microsoft.Office.Tools.Word.Bookmark.Range*> property of a \<xref:Microsoft.Office.Tools.Word.Bookmark> control or the \<xref:Microsoft.Office.Interop.Word.Bookmark.Range*> property of a \<xref:Microsoft.Office.Interop.Word.Bookmark> object.  
  
|Text Property|Description|  
|-------------------|-----------------|  
|\<xref:Microsoft.Office.Tools.Word.Bookmark.Text*>|Use this property to display text within the bookmark and leave the bookmark on the document. Assigning text to the bookmark expands the bookmark range and does not delete the bookmark.<br /><br /> For example, `Bookmark1.Text = "Hello world"` inserts the text into the bookmark and leaves the bookmark intact.|  
|\<xref:Microsoft.Office.Interop.Word.Range.Text*>|Use this property to display text at the bookmark location and automatically delete the bookmark. For example, `Bookmark1.Range.Text = "Hello world"` inserts the text into the bookmark and deletes the bookmark.|  
