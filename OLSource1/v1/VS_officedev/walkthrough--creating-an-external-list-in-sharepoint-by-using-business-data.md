---
title: "Walkthrough: Creating an External List in SharePoint by Using Business Data"
ms.custom: na
ms.date: "10/01/2016"
...
-   [!INCLUDE[vsPro](../VS_officedev/includes/vspro_md.md)], [!INCLUDE[vsUltLong](../VS_officedev/includes/vsultlong_md.md)], or [!INCLUDE[vsPreLong](../VS_officedev/includes/vsprelong_md.md)].  
...
2.  Add a connection to the SQL Server AdventureWorks sample database.  
     ...
     For more information, see [Add/Modify Connection (Microsoft SQL Server)](assetId:///fa400910-26c3-4df7-b9d1-115e688b4ea3).  
...
12. In the `ContactService` class, replace the `ReadItem` method with the following code. This code performs the following tasks:  
    ...
    >  Replace the value of the `ServerName` field with the name of your server.  
     ...
     [!code[SP_BDC#3](../VS_officedev/codesnippet/CSharp/walkthrough--creating-an-external-list-in-sharepoint-by-using-business-data_1.cs)]
[!code[SP_BDC#3](../VS_officedev/codesnippet/VisualBasic/walkthrough--creating-an-external-list-in-sharepoint-by-using-business-data_1.vb)]  
...
5.  In the `ContactService` class, replace the `ReadList` method with the following code. This code performs the following tasks:  
    ...
    >  Replace the value of the `ServerName` field with the name of your server.  
     ...
     [!code[SP_BDC#2](../VS_officedev/codesnippet/CSharp/walkthrough--creating-an-external-list-in-sharepoint-by-using-business-data_2.cs)]
[!code[SP_BDC#2](../VS_officedev/codesnippet/VisualBasic/walkthrough--creating-an-external-list-in-sharepoint-by-using-business-data_2.vb)]  
...
> [!NOTE]  
>  You might have to modify your security settings in SharePoint before you can debug your solution.  For more information, see [Designing a Business Data Connectivity Model](../VS_officedev/designing-a-business-data-connectivity-model.md).  
