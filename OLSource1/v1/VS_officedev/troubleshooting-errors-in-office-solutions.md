---
title: "Troubleshooting Errors in Office Solutions"
ms.custom: na
ms.date: "10/01/2016"
...
### Some Events of Office Objects Are Not Accessible When Using C#  
 ...
 For example, \<xref:Microsoft.Office.Interop.Excel.Application> objects have a \<xref:Microsoft.Office.Interop.Excel.AppEvents_Event.NewWorkbook> event and a \<xref:Microsoft.Office.Interop.Excel._Application.NewWorkbook*> property. To handle the \<xref:Microsoft.Office.Interop.Excel.AppEvents_Event.NewWorkbook> event, cast the \<xref:Microsoft.Office.Interop.Excel.Application> to the \<xref:Microsoft.Office.Interop.Excel.AppEvents_Event> interface. The following code example demonstrates how to do this in a document-level project for Excel.  
  
 [!code[Trin_VstcoreTroubleshootingExcel#1](../VS_officedev/codesnippet/CSharp/troubleshooting-errors-in-office-solutions_1.cs)]  
  
 For more information about event interfaces in the Office PIAs, see [Overview of Classes and Interfaces in the Office Primary Interop Assemblies](assetId:///da92dc3c-8209-44de-8095-a843659368d5).  
  
### Cannot Reference Office PIA Classes in Projects that Target the [!INCLUDE[net_v40_short](../VS_officedev/includes/net_v40_short_md.md)] or the [!INCLUDE[net_v45](../VS_officedev/includes/net_v45_md.md)]  
 In projects that target the [!INCLUDE[net_v40_short](../VS_officedev/includes/net_v40_short_md.md)] or the [!INCLUDE[net_v45](../VS_officedev/includes/net_v45_md.md)], code that references a class that is defined in an Office PIA will not compile by default. Classes in the PIAs use the naming convention *objectname*Class, such as \<xref:Microsoft.Office.Interop.Word.DocumentClass> and \<xref:Microsoft.Office.Interop.Excel.WorkbookClass>. For example, the following code from a Word VSTO Add-in project will not compile.  
...
### References to Office Classes Are Not Recognized  
 ...
 [!code[Trin_VstcoreTroubleshootingWord#2](../VS_officedev/codesnippet/CSharp/troubleshooting-errors-in-office-solutions_2.cs)]
[!code[Trin_VstcoreTroubleshootingWord#2](../VS_officedev/codesnippet/VisualBasic/troubleshooting-errors-in-office-solutions_2.vb)]  
 ...
 [!code[Trin_VstcoreTroubleshootingWord#3](../VS_officedev/codesnippet/CSharp/troubleshooting-errors-in-office-solutions_3.cs)]
[!code[Trin_VstcoreTroubleshootingWord#3](../VS_officedev/codesnippet/VisualBasic/troubleshooting-errors-in-office-solutions_3.vb)]  
  
 You will get errors if you use an unqualified declaration, for example:  
  
 [!code[Trin_VstcoreTroubleshootingWord#4](../VS_officedev/codesnippet/CSharp/troubleshooting-errors-in-office-solutions_4.cs)]
[!code[Trin_VstcoreTroubleshootingWord#4](../VS_officedev/codesnippet/VisualBasic/troubleshooting-errors-in-office-solutions_4.vb)]  
