...
|Title|Description|  
|-----------|-----------------|  
|[How to: Add or Remove SharePoint Connections](../VS_officedev/how-to--add-or-remove-sharepoint-connections.md)|Describes the steps that are required for adding a new SharePoint site to the **SharePoint Connections** node in **Server Explorer**.|  
