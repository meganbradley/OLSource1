---
title: "Walkthrough: Creating a Master Detail Relation Using a Cached Dataset"
ms.custom: na
ms.date: "08/09/2016"
...
1.  Create an Excel Workbook project with the name **My Master-Detail**, using either Visual Basic or C#. Make sure that **Create a new document** is selected. For more information, see [How to: Create Office Projects in Visual Studio](../VS_officedev/how-to--create-office-projects-in-visual-studio.md).  
...
2.  Add the following code to the `Sheet1_Startup` method to set the text for the buttons.  
     ...
     [!code[Trin_VstcoreDataExcel#15](../VS_officedev/codesnippet/VisualBasic/walkthrough--creating-a-master-detail-relation-using-a-cached-dataset_1.vb)]
[!code[Trin_VstcoreDataExcel#15](../VS_officedev/codesnippet/CSharp/walkthrough--creating-a-master-detail-relation-using-a-cached-dataset_1.cs)]  
  
3.  For C# only, add event handlers for the button click events to the `Sheet1_Startup` method.  
  
     [!code[Trin_VstcoreDataExcel#16](../VS_officedev/codesnippet/CSharp/walkthrough--creating-a-master-detail-relation-using-a-cached-dataset_2.cs)]  
...
1.  Add an event handler for the \<xref:System.Windows.Forms.Control.Click> event of `Button1`, and add the following code to move backwards through the records:  
     ...
     [!code[Trin_VstcoreDataExcel#17](../VS_officedev/codesnippet/VisualBasic/walkthrough--creating-a-master-detail-relation-using-a-cached-dataset_3.vb)]
[!code[Trin_VstcoreDataExcel#17](../VS_officedev/codesnippet/CSharp/walkthrough--creating-a-master-detail-relation-using-a-cached-dataset_3.cs)]  
...
2.  Add an event handler for the \<xref:System.Windows.Forms.Control.Click> event of `Button2`, and add the following code to advance through the records:  
     ...
     [!code[Trin_VstcoreDataExcel#18](../VS_officedev/codesnippet/VisualBasic/walkthrough--creating-a-master-detail-relation-using-a-cached-dataset_4.vb)]
[!code[Trin_VstcoreDataExcel#18](../VS_officedev/codesnippet/CSharp/walkthrough--creating-a-master-detail-relation-using-a-cached-dataset_4.cs)]  
...
-   Deploy the solution. For more information, see [Deploying an Office Solution](../VS_officedev/deploying-an-office-solution.md)  
