...
# Walkthrough: Updating a Chart in a Worksheet Using Radio Buttons
 ...
 To see the result as a completed sample, see the Excel Controls Sample at [Office Development Samples and Walkthroughs](../VS_officedev/office-development-samples-and-walkthroughs.md).  
...
2.  Add code to the `ChartOptions` class to create a `SelectionChanged` event and the `Selection` property.  
     ...
     [!code[Trin_VstcoreProgrammingControlsExcel#13](../VS_officedev/codesnippet/VisualBasic/walkthrough--updating-a-chart-in-a-worksheet-using-radio-buttons_1.vb)]
[!code[Trin_VstcoreProgrammingControlsExcel#13](../VS_officedev/codesnippet/CSharp/walkthrough--updating-a-chart-in-a-worksheet-using-radio-buttons_1.cs)]  
...
1.  Set the chart type in the `CheckedChanged` event handler of the `areaBlockChart` radio button and then raise the event.  
     ...
     [!code[Trin_VstcoreProgrammingControlsExcel#14](../VS_officedev/codesnippet/VisualBasic/walkthrough--updating-a-chart-in-a-worksheet-using-radio-buttons_2.vb)]
[!code[Trin_VstcoreProgrammingControlsExcel#14](../VS_officedev/codesnippet/CSharp/walkthrough--updating-a-chart-in-a-worksheet-using-radio-buttons_2.cs)]  
  
2.  Set the chart type in the `CheckedChanged` event handler of the `barChart` radio button.  
  
     [!code[Trin_VstcoreProgrammingControlsExcel#15](../VS_officedev/codesnippet/VisualBasic/walkthrough--updating-a-chart-in-a-worksheet-using-radio-buttons_3.vb)]
[!code[Trin_VstcoreProgrammingControlsExcel#15](../VS_officedev/codesnippet/CSharp/walkthrough--updating-a-chart-in-a-worksheet-using-radio-buttons_3.cs)]  
  
3.  Set the chart type in the `CheckedChanged` event handler of the `columnChart` radio button.  
  
     [!code[Trin_VstcoreProgrammingControlsExcel#16](../VS_officedev/codesnippet/VisualBasic/walkthrough--updating-a-chart-in-a-worksheet-using-radio-buttons_4.vb)]
[!code[Trin_VstcoreProgrammingControlsExcel#16](../VS_officedev/codesnippet/CSharp/walkthrough--updating-a-chart-in-a-worksheet-using-radio-buttons_4.cs)]  
  
4.  Set the chart type in the `CheckedChanged` event handler of the `lineChart` radio button.  
  
     [!code[Trin_VstcoreProgrammingControlsExcel#17](../VS_officedev/codesnippet/VisualBasic/walkthrough--updating-a-chart-in-a-worksheet-using-radio-buttons_5.vb)]
[!code[Trin_VstcoreProgrammingControlsExcel#17](../VS_officedev/codesnippet/CSharp/walkthrough--updating-a-chart-in-a-worksheet-using-radio-buttons_5.cs)]  
  
5.  In C#, you must add event handlers for the radio buttons. You can add the code to the `ChartOptions` constructor, beneath the call to `InitializeComponent`. For information about how to create event handlers, see [How to: Create Event Handlers in Office Projects](../VS_officedev/how-to--create-event-handlers-in-office-projects.md).  
  
     [!code[Trin_VstcoreProgrammingControlsExcel#18](../VS_officedev/codesnippet/CSharp/walkthrough--updating-a-chart-in-a-worksheet-using-radio-buttons_6.cs)]  
...
1.  Add the following event handler to the `Sheet1` class.  
     ...
     [!code[Trin_VstcoreProgrammingControlsExcel#19](../VS_officedev/codesnippet/VisualBasic/walkthrough--updating-a-chart-in-a-worksheet-using-radio-buttons_7.vb)]
[!code[Trin_VstcoreProgrammingControlsExcel#19](../VS_officedev/codesnippet/CSharp/walkthrough--updating-a-chart-in-a-worksheet-using-radio-buttons_7.cs)]  
  
2.  In C#, you must add an event handler for the user control to the \<xref:Microsoft.Office.Tools.Excel.Worksheet.Startup> event as shown below. For information about how to create event handlers, see [How to: Create Event Handlers in Office Projects](../VS_officedev/how-to--create-event-handlers-in-office-projects.md).  
  
     [!code[Trin_VstcoreProgrammingControlsExcel#20](../VS_officedev/codesnippet/CSharp/walkthrough--updating-a-chart-in-a-worksheet-using-radio-buttons_8.cs)]  
...
-   Change formatting on a worksheet by using check boxes. For more information, see [Walkthrough: Changing Worksheet Formatting Using CheckBox Controls](../VS_officedev/walkthrough--changing-worksheet-formatting-using-checkbox-controls.md).  
