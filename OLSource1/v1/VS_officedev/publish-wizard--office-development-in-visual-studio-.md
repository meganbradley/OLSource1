...
## What is the default installation path on end user computers?  
 The installation path is optional. You can set the installation path later if you prefer. For details, see [How to: Change the Installation Path of an Office Solution](assetId:///d0eaa07b-2d72-4902-899f-2f9fb165b8fd).  
