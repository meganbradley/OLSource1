...
### Event Handler Method Declarations  
 ...
 [!code[Trin_VstcoreWordAutomation#121](../VS_officedev/codesnippet/VisualBasic/events-in-office-projects_1.vb)]
[!code[Trin_VstcoreWordAutomation#121](../VS_officedev/codesnippet/CSharp/events-in-office-projects_1.cs)]  
...
>  The following code example shows the event handlers in the `Sheet1` class. The names of the event handlers in other host item classes correspond to the class name. For example, in the `Sheet2` class, the **Startup** event handler is named `Sheet2_Startup`. In the `ThisWorkbook` class, the **Startup** event handler is named `ThisWorkbook_Startup`.  
 ...
 [!code[Trin_VstcoreExcelAutomation#83](../VS_officedev/codesnippet/CSharp/events-in-office-projects_2.cs)]
[!code[Trin_VstcoreExcelAutomation#83](../VS_officedev/codesnippet/VisualBasic/events-in-office-projects_2.vb)]  
...
### Startup Event  
 ...
 For more information about the startup sequence of VSTO Add-ins, see [Architecture of VSTO Add-ins](../VS_officedev/architecture-of-vsto-add-ins.md).  
