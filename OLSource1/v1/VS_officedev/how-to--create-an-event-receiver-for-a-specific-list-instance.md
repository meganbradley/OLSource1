---
title: "How to: Create an Event Receiver for a Specific List Instance"
ms.custom: na
ms.date: "10/01/2016"
...
5.  In [!INCLUDE[vsprvs](../VS_officedev/includes/vsprvs_md.md)], create an event receiver project.  
