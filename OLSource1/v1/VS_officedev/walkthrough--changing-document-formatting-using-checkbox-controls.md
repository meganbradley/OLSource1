---
title: "Walkthrough: Changing Document Formatting Using CheckBox Controls"
ms.custom: na
ms.date: "10/01/2016"
...
2.  For C# only, add the following constants to the **ThisDocument** class.  
     ...
     [!code[Trin_VstcoreProgrammingControlsWord#2](../VS_officedev/codesnippet/CSharp/walkthrough--changing-document-formatting-using-checkbox-controls_1.cs)]  
  
3.  Add the following code to the \<xref:System.Windows.Forms.Control.Click> event handler of the `applyBoldFont` check box.  
  
     [!code[Trin_VstcoreProgrammingControlsWord#3](../VS_officedev/codesnippet/VisualBasic/walkthrough--changing-document-formatting-using-checkbox-controls_2.vb)]
[!code[Trin_VstcoreProgrammingControlsWord#3](../VS_officedev/codesnippet/CSharp/walkthrough--changing-document-formatting-using-checkbox-controls_2.cs)]  
  
4.  Add the following code to the \<xref:System.Windows.Forms.Control.Click> event handler of the `applyItalicFont` check box.  
  
     [!code[Trin_VstcoreProgrammingControlsWord#4](../VS_officedev/codesnippet/VisualBasic/walkthrough--changing-document-formatting-using-checkbox-controls_3.vb)]
[!code[Trin_VstcoreProgrammingControlsWord#4](../VS_officedev/codesnippet/CSharp/walkthrough--changing-document-formatting-using-checkbox-controls_3.cs)]  
...
5.  Add the following code to the \<xref:System.Windows.Forms.Control.Click> event handler of the `applyUnderlineFont` check box.  
     ...
     [!code[Trin_VstcoreProgrammingControlsWord#5](../VS_officedev/codesnippet/VisualBasic/walkthrough--changing-document-formatting-using-checkbox-controls_4.vb)]
[!code[Trin_VstcoreProgrammingControlsWord#5](../VS_officedev/codesnippet/CSharp/walkthrough--changing-document-formatting-using-checkbox-controls_4.cs)]  
  
6.  In C#, you must add event handlers for the text boxes to the \<xref:Microsoft.Office.Tools.Word.Document.Startup> event. For information about how to create event handlers, see [How to: Create Event Handlers in Office Projects](../VS_officedev/how-to--create-event-handlers-in-office-projects.md).  
  
     [!code[Trin_VstcoreProgrammingControlsWord#6](../VS_officedev/codesnippet/CSharp/walkthrough--changing-document-formatting-using-checkbox-controls_5.cs)]  
...
-   Use a button to populate a text box. For more information, see [Walkthrough: Displaying Text in a Text Box in a Document Using a Button](../VS_officedev/walkthrough--displaying-text-in-a-text-box-in-a-document-using-a-button.md).  
