---
title: "Troubleshooting Office Solution Deployment"
ms.custom: na
ms.date: "10/01/2016"
...
## Troubleshooting Office Solutions by Using the Event Viewer  
 You can use the event viewer in Windows to see error messages that are captured by the [!INCLUDE[vsto_runtime](../VS_officedev/includes/vsto_runtime_md.md)] when you install or uninstall Office solutions. You can use these messages from the event logger to resolve installation and deployment problems. For more information, see [Event Logging for Office Solutions](../VS_officedev/event-logging-for-office-solutions.md).  
...
## Prerequisites for Microsoft Office Aren't Installed  
 You can add the .NET Framework, the [!INCLUDE[vsto_runtime](../VS_officedev/includes/vsto_runtime_md.md)], and the Office primary interop assemblies to your Setup package as prerequisites that are deployed with your Office solution. For information about how to install the primary interop assemblies, see [Configuring a Computer to Develop Office Solutions](../VS_officedev/configuring-a-computer-to-develop-office-solutions.md) and [How to: Install Office Primary Interop Assemblies](../VS_officedev/how-to--install-office-primary-interop-assemblies.md).  
