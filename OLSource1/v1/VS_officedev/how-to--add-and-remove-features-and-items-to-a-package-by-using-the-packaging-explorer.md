---
title: "How to: Add and Remove Features and Items to a Package by Using the Packaging Explorer"
ms.custom: na
ms.date: "08/09/2016"
...
# How to: Add and Remove Features and Items to a Package by Using the Packaging Explorer
 ...
 Alternatively, you can use the Packaging Designer to view and re-order the Features to change the activation order. For more information, see [How to: Add and Remove Features and Items to a Package by Using the Package Designer](../VS_officedev/how-to--add-and-remove-features-and-items-to-a-package-by-using-the-package-designer.md).  
