...
-   Creating a site definition by using the [!INCLUDE[vsprvs](../VS_officedev/includes/vsprvs_md.md)] project template.  
...
## Creating a Site Definition Solution  
 First, create the site definition project in [!INCLUDE[vsprvs](../VS_officedev/includes/vsprvs_md.md)].  
...
6.  In the **What is the trust level for this SharePoint solution?** section, choose the **Deploy as a farm solution** option button.  
     ...
     All site definition projects must be deployed as farm solutions. For more information about sandboxed solutions versus farm solutions, see [Sandboxed Solution Considerations](../VS_officedev/sandboxed-solution-considerations.md).  
...
6.  Under VisualWebPart1.ascx, open the VisualWebPart1.ascx.cs file (for [!INCLUDE[csprcs](../VS_officedev/includes/csprcs_md.md)]) or VisualWebPart1.ascx.vb (for [!INCLUDE[vbprvb](../VS_officedev/includes/vbprvb_md.md)]) , and then add the following code:  
  
     [!code[SP_SimpleSiteDef#1](../VS_officedev/codesnippet/VisualBasic/walkthrough--create-a-basic-site-definition-project_1.vb)]
[!code[SP_SimpleSiteDef#1](../VS_officedev/codesnippet/CSharp/walkthrough--create-a-basic-site-definition-project_1.cs)]  
