...
-   **DLGC_WANTCHARS** <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> messages.  
...
## Remarks  
 Normally, Windows handles all arrow-key and TAB-key input to a <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> control. By overriding <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>, a <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> control can choose a particular type of input to process itself.  
  
 The default <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> functions for the predefined control classes return a code appropriate for each class.  
