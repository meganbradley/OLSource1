...
## Rule Description  
 When instances of a type can be combined by using operations such as addition and subtraction, you should almost always define equality to return <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> for any two instances that have the same constituent values.  
...
## Example  
 The following example defines a type (<CodeContentPlaceHolder>3\</CodeContentPlaceHolder>) that violates this rule. This type should implement the equality operator to make any two instances that have the same field values test <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> for equality. The type <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> shows the corrected implementation. Note that this type also implements the inequality operator and overrides \<xref:System.Object.Equals*> to satisfy other rules. A complete implementation would also implement \<xref:System.Object.GetHashCode*>.  
  
 [!code[FxCop.Design.AddAndSubtract#1](../vs140/codesnippet/CSharp/ca1013--overload-operator-equals-on-overloading-add-and-subtract_1.cs)]  
...
## Example  
 ...
 [!code[FxCop.Design.TestAddAndSubtract#1](../vs140/codesnippet/CSharp/ca1013--overload-operator-equals-on-overloading-add-and-subtract_2.cs)]  
