...
symbol already defined in object  
 ...
 The given <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>, displayed in its decorated form, was multiply defined.  
...
2.  The symbol is a packaged function (created by compiling with [/Gy](../vs140/-gy--enable-function-level-linking-.md)) and was included in more than one file but was changed between compilations. Recompile all files that include <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>.  
...
5.  A header file declared and defined a variable. Possible solutions include:  
    ...
    -   Declare the variable in .h: <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> and then assign to it in a .c or .cpp file: <CodeContentPlaceHolder>4\</CodeContentPlaceHolder>.  
