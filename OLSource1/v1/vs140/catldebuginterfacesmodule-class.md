...
## Remarks  
 <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> provides the support required for debugging interfaces. It is included in any project that defines the symbol [_ATL_DEBUG_QI](../vs140/_atl_debug_qi.md).  
