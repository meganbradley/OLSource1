...
2.  As you did before, modify the <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> method to fill in random numbers for the multiplication and division problems.  
...
3.  Modify the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> method so that it also checks the multiplication and division problems.  
