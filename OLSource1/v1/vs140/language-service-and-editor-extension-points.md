...
-   <xref:Microsoft.VisualStudio.Text.Tagging.TextMarkerTag*>: associated with an adornment.  
    ...
    > [!NOTE]
    >  For an example of a <xref:Microsoft.VisualStudio.Text.Tagging.TextMarkerTag*>, see the HighlightWordTag definition in [Walkthrough: How to Highlight Text in the Editor](../vs140/walkthrough--highlighting-text.md).  
