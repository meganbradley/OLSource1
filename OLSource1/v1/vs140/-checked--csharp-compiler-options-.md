...
4.  Modify the **Check for arithmetic overflow/underflow** property.  
 ...
 To access this compiler option programmatically, see <xref:VSLangProj80.CSharpProjectConfigurationProperties3.CheckForOverflowUnderflow?qualifyHint=False>.  
