...
## Remarks  
 After constructing the object, you must call the [CWnd::Create](../vs140/cwnd--create.md) function before the edit control is used. If you derive a class from <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> and add it to the template using <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>, the framework calls both this constructor and the **Create** function.  
