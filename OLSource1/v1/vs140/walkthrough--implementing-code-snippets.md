...
3.  Create a file in the snippet folder, name it **test**<CodeContentPlaceHolder>3\</CodeContentPlaceHolder>, and then add the following text:  
...
6.  Add a static <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> class to the project.  
...
8.  Add the \<xref:Microsoft.VisualStudio.Shell.ProvideLanguageCodeExpansionAttribute*> to the <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> class. This attribute can be added to any public or internal (non-static) class in the project. (You may have to add a <CodeContentPlaceHolder>6\</CodeContentPlaceHolder> statement for the Microsoft.VisualStudio.Shell namespace.)  
...
1.  Open the <CodeContentPlaceHolder>7\</CodeContentPlaceHolder> class file.  
...
1.  To the file that contains the <CodeContentPlaceHolder>8\</CodeContentPlaceHolder> class, add the following <CodeContentPlaceHolder>9\</CodeContentPlaceHolder> statements.  
...
2.  Make the <CodeContentPlaceHolder>10\</CodeContentPlaceHolder> class implement the \<xref:Microsoft.VisualStudio.TextManager.Interop.IVsExpansionClient*> interface.  
...
3.  In the <CodeContentPlaceHolder>11\</CodeContentPlaceHolder> class, import the \<xref:Microsoft.VisualStudio.Text.Operations.ITextStructureNavigatorSelectorService*>.  
...
5.  In the constructor of the <CodeContentPlaceHolder>12\</CodeContentPlaceHolder> class, set the following fields.  
