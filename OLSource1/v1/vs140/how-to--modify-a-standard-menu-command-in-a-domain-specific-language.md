...
> [!NOTE]
>  If you want to create your own menu commands, see [How to Add a Command](../vs140/how-to--add-a-command-to-the-shortcut-menu.md).  
  
##  \<a name="what">\</a> What commands can you modify?  
  
#### To discover what commands you can modify  
  
1.  In the <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> project, open <CodeContentPlaceHolder>4\</CodeContentPlaceHolder>. This C# file can be found in Solution Explorer as a subsidiary of <CodeContentPlaceHolder>5\</CodeContentPlaceHolder>.  
  
2.  Find classes in this file whose names end with "<CodeContentPlaceHolder>6\</CodeContentPlaceHolder>", for example <CodeContentPlaceHolder>7\</CodeContentPlaceHolder> and <CodeContentPlaceHolder>8\</CodeContentPlaceHolder>.  
  
3.  In each command set class, type "<CodeContentPlaceHolder>9\</CodeContentPlaceHolder>" followed by a space. IntelliSense will show a list of the methods that you can override. Each command has a pair of methods whose names begin "<CodeContentPlaceHolder>10\</CodeContentPlaceHolder>" and "<CodeContentPlaceHolder>11\</CodeContentPlaceHolder>".  
...
2.  In **DslPackage**, create a folder named **Custom Code**. In this folder, create a new class file named <CodeContentPlaceHolder>14\</CodeContentPlaceHolder>.  
...
##  \<a name="override">\</a> Override the command methods  
 Most commands have two associated methods: The method with a name like <CodeContentPlaceHolder>15\</CodeContentPlaceHolder>... determines whether the command should be visible and enabled. It is called whenever the user right-clicks the diagram, and should execute quickly and make no changes. <CodeContentPlaceHolder>16\</CodeContentPlaceHolder>... is called when the user clicks the command, and should perform the function of the command. You might want to override either one or both of these methods.  
...
-   <CodeContentPlaceHolder>17\</CodeContentPlaceHolder>. The shape that the user right-clicked is always included in this list of shapes and connectors. If the user clicks on a blank part of the diagram, the Diagram is the only member of the list.  
  
-   <CodeContentPlaceHolder>18\</CodeContentPlaceHolder> - <CodeContentPlaceHolder>19\</CodeContentPlaceHolder> if the user clicked a blank part of the diagram.  
  
-   <CodeContentPlaceHolder>20\</CodeContentPlaceHolder>  
  
-   <CodeContentPlaceHolder>21\</CodeContentPlaceHolder> - the user did not select multiple shapes  
  
-   <CodeContentPlaceHolder>22\</CodeContentPlaceHolder> - the shape or diagram that the user right-clicked  
  
-   <CodeContentPlaceHolder>23\</CodeContentPlaceHolder> - the model element represented by a shape.  
  
 For more information about how to navigate from element to element and about how to create objects and links, see [How to Navigate and Update the Model](../vs140/navigating-and-updating-a-model-in-program-code.md).  
  
## See Also  
 \<xref:System.ComponentModel.Design.MenuCommand*>   
 [Programming Domain-Specific Languages](../vs140/writing-code-to-customise-a-domain-specific-language.md)   
 [Walkthrough: Adding a Command to the Shortcut Menu](../vs140/how-to--add-a-command-to-the-shortcut-menu.md)   
 [Walkthrough: Getting Information from a Selected Link](../vs140/walkthrough--getting-information-from-a-selected-link.md)   
 [How VSPackages Add User Interface Elements to the IDE](../vs140/how-vspackages-add-user-interface-elements.md)   
