...
## Cases where an editor supports multiple views  
 ...
 Instead of the view querying for the undo manager, of which there is one for each view, the document data object calls [CreateInstance](assetId:///M:Microsoft.VisualStudio.Shell.Interop.ILocalRegistry2.CreateInstance(System.Guid,System.Object,System.Guid@,System.UInt32,System.IntPtr@)?qualifyHint=False&autoUpgrade=True) to instantiate the undo manager, specifying a class identifier of CLSID_OLEUndoManager. The class identifier is defined in the OCUNDOID.h file.  
  
 When using assetId:///M:Microsoft.VisualStudio.Shell.Interop.ILocalRegistry2.CreateInstance(System.Guid,System.Object,System.Guid@,System.UInt32,System.IntPtr@)?qualifyHint=False&autoUpgrade=True to create your own undo manager instance, use the following procedure to hook your undo manager into the environment.  
...
4.  Call `QueryInterface` on `IOleUndoManager` for `IID_IVsChangeTrackingUndoManager`. Store the pointer to <xref:Microsoft.VisualStudio.TextManager.Interop.IVsChangeTrackingUndoManager*>.  
     ...
     Use the pointer to <xref:Microsoft.VisualStudio.TextManager.Interop.IVsChangeTrackingUndoManager*> to call the <xref:Microsoft.VisualStudio.TextManager.Interop.IVsChangeTrackingUndoManager.MarkCleanState*>, the [AdviseTrackingClient](assetId:///M:Microsoft.VisualStudio.TextManager.Interop.IVsChangeTrackingUndoManager.AdviseTrackingClient(Microsoft.VisualStudio.TextManager.Interop.IVsUndoTrackingEvents)?qualifyHint=False&autoUpgrade=True), and the <xref:Microsoft.VisualStudio.TextManager.Interop.IVsChangeTrackingUndoManager.UnadviseTrackingClient*> methods.  
  
5.  Call `QueryInterface` on `IOleUndoManager` for `IID_IVsLinkCapableUndoManager`.  
  
6.  Call [AdviseLinkedUndoClient](assetId:///M:Microsoft.VisualStudio.TextManager.Interop.IVsLinkCapableUndoManager.AdviseLinkedUndoClient(Microsoft.VisualStudio.TextManager.Interop.IVsLinkedUndoClient)?qualifyHint=False&autoUpgrade=True) with your document, which should also implement the <xref:Microsoft.VisualStudio.TextManager.Interop.IVsLinkedUndoClient*> interface. When your document is closed, call `IVsLinkCapableUndoManager::UnadviseLinkedUndoClient`.  
...
9. When changes are made to the document, call [Add](assetId:///M:Microsoft.VisualStudio.OLE.Interop.IOleUndoManager.Add(Microsoft.VisualStudio.OLE.Interop.IOleUndoUnit)?qualifyHint=False&autoUpgrade=True) on the manager with an `OleUndoUnit` class. The assetId:///M:Microsoft.VisualStudio.OLE.Interop.IOleUndoManager.Add(Microsoft.VisualStudio.OLE.Interop.IOleUndoUnit)?qualifyHint=False&autoUpgrade=True method keeps a reference to the object, so generally you release it right after the assetId:///M:Microsoft.VisualStudio.OLE.Interop.IOleUndoManager.Add(Microsoft.VisualStudio.OLE.Interop.IOleUndoUnit)?qualifyHint=False&autoUpgrade=True.  
