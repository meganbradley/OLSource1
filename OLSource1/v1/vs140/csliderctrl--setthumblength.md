...
|---------------|-----------------|  
|[in] <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>|Length of the slider, in pixels.|  
...
## Example  
 The following code example defines the variable, <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>, that is used to access the current trackbar control. The example also defines a variable, <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>, that is used to store the default length of the trackbar control's thumb component. These variables are used in the next example.  
