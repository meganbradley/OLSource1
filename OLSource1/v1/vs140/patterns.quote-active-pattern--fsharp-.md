...
apitype: "Assembly"
f1_keywords: 
  - "Microsoft.FSharp.Quotations.PatternsModule.QuotePattern"
dev_langs: 
  - "FSharp"
helpviewer_keywords: 
  - "Quote active pattern [F#]"
...
## Return Value  
 The formal type of the return value is <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>. The option type represents whether the input expression produces a match. In a pattern matching expression, the input is decomposed into the expression enclosed by a nested quotation literal.  
