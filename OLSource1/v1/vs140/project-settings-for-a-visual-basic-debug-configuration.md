...
> [!WARNING]
>  This topic does not apply to Store apps. See [How to start a debugging session (Visual C++, Visual C#, and Visual Basic)](../vs140/start-a-debugging-session-for-a-store-app-in-visual-studio--vb--csharp--c---and-xaml-.md)  
