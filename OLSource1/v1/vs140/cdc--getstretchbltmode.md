...
## Remarks  
 The bitmap-stretching mode defines how information is removed from bitmaps that are stretched or compressed by the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> member function.  
