...
## Example  
 In this example, the <xref:System.BitConverter.GetBytes(System.Int32)?qualifyHint=False> method of the <xref:System.BitConverter?qualifyHint=False> class is called to convert an `int` to an array of bytes.  
...
## See Also  
 <xref:System.BitConverter?qualifyHint=False>   
 <xref:System.BitConverter.IsLittleEndian?qualifyHint=False>   
