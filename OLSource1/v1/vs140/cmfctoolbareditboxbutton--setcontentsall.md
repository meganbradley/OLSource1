...
## Return Value  
 Nonzero if the text was set; 0 if the <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> control with the specified command ID does not exist.  
