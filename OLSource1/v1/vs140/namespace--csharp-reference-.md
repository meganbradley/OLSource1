...
The <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> keyword is used to declare a scope that contains a set of related objects. You can use a namespace to organize code elements and to create globally unique types.  
...
-   [delegate](../vs140/delegate--csharp-reference-.md)  
 ...
 It is possible to define a namespace in two or more declarations. For example, the following example defines two classes as part of the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> namespace:  
