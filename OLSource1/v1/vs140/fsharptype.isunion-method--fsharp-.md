...
---
# FSharpType.IsUnion Method (F#)
Returns <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> if the specified type is a representation of an F# union type or the runtime type of a value of that type.  
...
## Return Value  
 Returns <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> if the type check succeeds.  
