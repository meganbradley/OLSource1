...
## Return Value  
 <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> if the associated thread is *joinable*; otherwise, <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>.  
  
## Remarks  
 A thread object is *joinable* if <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>.  
