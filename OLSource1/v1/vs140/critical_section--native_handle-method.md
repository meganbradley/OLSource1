...
## Remarks  
 A <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> object is not associated with a platform specific native handle for the Windows operating system. The method simply returns a reference to the object itself.  
