...
## Remarks  
 The context identifier is originally specified in [CInternetSession](../vs140/cinternetsession-class.md) and passed by MFC to [CInternetConnection](../vs140/cinternetconnection-class.md)- and [CInternetFile](../vs140/cinternetfile-class.md)-derived classes. You can override this default and assign any <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> parameter a value of your choosing. <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> is associated with any operation of the given object. <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> identifies the operation's status information returned by [CInternetSession::OnStatusCallback](../vs140/cinternetsession--onstatuscallback.md).  
