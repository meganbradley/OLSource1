...
An expression tree may not contain an unsafe pointer operation  
 ...
 Expression trees do not support pointer types because the <xref:System.Linq.Expressions.Expression<CodeContentPlaceHolder>1\</CodeContentPlaceHolder>Expression<Func\<int*[], int*[]>) e = (int*[] i)=>i;`  
