...
apitype: "Assembly"
f1_keywords: 
  - "Microsoft.FSharp.Core.Operators.op_LogicalNot``1"
dev_langs: 
  - "FSharp"
helpviewer_keywords: 
  - "Operators.op_LogicalNot operator [F#]"
  - "Operators.( ~~~ ) operator [F#]"
  - "~~~ operator [F#]"
  - "op_LogicalNot operator [F#]"
ms.assetid: 80822c6d-b0a8-445c-adbc-2dd78954cc5d
