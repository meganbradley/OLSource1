...
## Remarks  
 Call this method to insert a separator between two existing buttons. If <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> is -1, this method adds the separator to the end of the list of toolbar buttons.  
