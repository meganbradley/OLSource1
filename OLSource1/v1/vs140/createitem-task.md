...
|`Exclude`|Optional \<xref:Microsoft.Build.Framework.ITaskItem*>`[]` output parameter.\<br />\<br /> Specifies the items to exclude from the output item collection. This parameter can contain wildcard specifications. For more information, see [MSBuild Items](../vs140/msbuild-items.md) and [How To: Build all Files in a Directory Except One](../vs140/how-to--exclude-files-from-the-build.md).|  
