...
```  
 ...
 Therefore we recommend that you use <xref:Microsoft.VisualStudio.Modeling.ElementOperations?qualifyHint=False> to create new elements. For more information, see [Customizing Element Creation and Pasting](../vs140/customizing-element-creation-and-movement.md).  
