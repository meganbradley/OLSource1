...
apitype: "Assembly"
f1_keywords: 
  - "Microsoft.FSharp.Collections.SeqModule.CompareWith``1"
dev_langs: 
  - "FSharp"
helpviewer_keywords: 
  - "Seq.compareWith function [F#]"
  - "compareWith function [F#]"
...
## Example  
 The following example demonstrates the use of <CodeContentPlaceHolder>8\</CodeContentPlaceHolder> to compare two sequences using a custom comparison function.  
  
 [!code[FsSequences#19](../vs140/codesnippet/FSharp/seq.comparewith--t--function--fsharp-_1.fs)]  
