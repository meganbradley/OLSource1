 ...
 *dwDispId*  
 ...
 Points to the window that hosts the data-source control to which the property will be bound. Call <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> with the resource ID of the DCS's host window to retrieve this pointer.  
  
## Remarks  
 The <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> object on which you call this function must be a data-bound control.  
  
## Example  
 <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> might be used in the following context:  
