...
---
# CStatusBar::SetIndicators
Sets each indicator's ID to the value specified by the corresponding element of the array <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>, loads the string resource specified by each ID, and sets the indicator's text to the string.  
