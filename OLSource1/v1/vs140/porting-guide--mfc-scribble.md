...
## MFC Scribble  
 ...
 Note that you can also run devenv at the command line, using the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> option, instead of using the wizard to upgrade your projects. See [/Upgrade (devenv.exe)](../vs140/-upgrade--devenv.exe-.md). That could be helpful in automating the upgrade process for a large number of projects.  
