...
|Case-translation convention|None|  
 ...
 The [/Gz](../vs140/-gd---gr---gv---gz--calling-convention-.md) compiler option specifies `__stdcall` for all functions not explicitly declared with a different calling convention.  
