...
1.  Use <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> to get the language service ID and the interface ID of the \<xref:Microsoft.VisualStudio.TextManager.Interop.IVsContainedLanguageFactory*>.  
