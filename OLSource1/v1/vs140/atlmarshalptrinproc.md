...
f1_keywords: 
  - "AtlMarshalPtrInProc"
  - "ATL.AtlMarshalPtrInProc"
  - "ATL::AtlMarshalPtrInProc"
dev_langs: 
  - "C++"
helpviewer_keywords: 
  - "AtlMarshalPtrInProc function"
 ...
 *pUnk*  
 ...
 [out] A pointer to the <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> interface on the new stream object used for marshaling.  
...
## Remarks  
 ...
 <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> can only be used on a pointer to an in-process object.  
  
## Example  
 [!code[NVC_ATL_COM#50](../vs140/codesnippet/CPP/atlmarshalptrinproc_1.cpp)]  
