...
dev_langs: 
  - "FSharp"
helpviewer_keywords: 
  - "ParseUInt64 function [F#]"
  - "LanguagePrimitives.ParseUInt64 function [F#]"
ms.assetid: 1f1b0a0e-7042-4dd8-80eb-56404d28eca0
...
---
# LanguagePrimitives.ParseUInt64 Function (F#)
Parse an unsigned 64-bit integer according to the rules used by the overloaded <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> conversion operator when applied to strings.  
