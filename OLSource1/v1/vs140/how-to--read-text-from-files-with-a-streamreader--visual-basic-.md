...
The <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> object provides methods to open a \<xref:System.IO.TextReader*> and a \<xref:System.IO.TextWriter*>. These methods, <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> and <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>, are advanced methods that do not appear in IntelliSense unless you select the **All** tab.  
  
### To read a line from a file with a text reader  
  
-   Use the <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> method to open the \<xref:System.IO.TextReader*>, specifying the file. This example opens the file named <CodeContentPlaceHolder>4\</CodeContentPlaceHolder>, reads a line from it, and displays the line in a message box.  
