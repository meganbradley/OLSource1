...
|**/Fa** *directory*\\*filename*|*filename*.asm is placed in the specified <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>. Only valid when compiling a single source code file.|  
|**/Fa** *directory*\\*filename.extension*|*filename.extension* is placed in the specified <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>. Only valid when compiling a single source code file.|  
