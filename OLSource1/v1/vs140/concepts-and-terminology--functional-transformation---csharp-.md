 ...
 *Functional programming* is a programming approach that directly supports pure functional transformation.  
 ...
 For more information about functional programming, see [Functional Programming vs. Imperative Programming (C#)](../vs140/functional-programming-vs.-imperative-programming--csharp-.md).  
...
## Terminology  
 ...
 For more information about, see [Lambda Expressions &#91;C#&#93;](../vs140/lambda-expressions--csharp-programming-guide-.md).  
  
 collection  
 A structured set of data, usually of a uniform type. To be compatible with LINQ, a collection must implement the <xref:System.Collections.IEnumerable?qualifyHint=False> interface or the <xref:System.Linq.IQueryable?qualifyHint=False> interface (or one of their generic counterparts, <xref:System.Collections.Generic.IEnumerator`1?qualifyHint=False> or <xref:System.Linq.IQueryable`1?qualifyHint=False>).  
 ...
 For more information, see [Anonymous Types &#91;C#&#93;](../vs140/anonymous-types--csharp-programming-guide-.md).  
 ...
 For more information, see [Implicitly Typed Local Variables &#91;C#&#93;](../vs140/implicitly-typed-local-variables--csharp-programming-guide-.md).  
 ...
 For more information, see [Introduction to LINQ Queries (C#)](../vs140/introduction-to-linq-queries--csharp-.md) and [Deferred Execution and Lazy Evaluation in LINQ to XML (C#)](../vs140/deferred-execution-and-lazy-evaluation-in-linq-to-xml--csharp-.md).  
