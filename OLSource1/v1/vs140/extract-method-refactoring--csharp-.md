...
1.  Create a console application named <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>, and then replace <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> with the following example code.  
...
4.  Specify a name for the new method, such as <CodeContentPlaceHolder>5\</CodeContentPlaceHolder>, in the **New Method Name** box.  
...
## Generic Type Parameters  
 When you extract a method that has an unconstrained generic type parameter, the generated code will not add the <CodeContentPlaceHolder>6\</CodeContentPlaceHolder> modifier to that parameter unless a value is assigned to it. If the extracted method will support reference types as the generic type argument, then you should manually add the <CodeContentPlaceHolder>7\</CodeContentPlaceHolder> modifier to the parameter in the method signature.  
