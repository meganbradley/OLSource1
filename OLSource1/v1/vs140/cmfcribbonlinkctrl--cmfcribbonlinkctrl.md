...
## Example  
 The following example demonstrates how to use the constructor of the <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> class. This code snippet is part of the [Ribbon Gadgets sample](../vs140/visual-c---samples.md).  
