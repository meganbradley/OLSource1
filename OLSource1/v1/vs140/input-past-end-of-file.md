...
## See Also  
 <xref:Microsoft.VisualBasic.FileSystem.Input?qualifyHint=False>   
 <xref:Microsoft.VisualBasic.FileSystem.EOF?qualifyHint=False>   
 <xref:Microsoft.VisualBasic.FileSystem.Seek?qualifyHint=False>   
 <xref:Microsoft.VisualBasic.FileSystem.Loc?qualifyHint=False>