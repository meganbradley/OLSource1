...
This topic shows how to convert .NET collections to their equivalent STL/CLR containers. As an example we show how to convert a .NET <xref:System.Collections.Generic.List`1*> to a STL/CLR [vector](../vs140/vector--stl-clr-.md) and how to convert a .NET <xref:System.Collections.Generic.Dictionary`2*> to a STL/CLR [map](../vs140/map--stl-clr-.md), but the procedure is similar for all collections and containers.  
