...
|**Prefix**|Mandatory <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> parameter.\<br />\<br /> If <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>, concatenates the value of the **Value** parameter before the value of the environment variable that is specified by the **Name** parameter, and then assigns the result to the environment variable. If <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>, assigns only the value of the **Value** parameter to the environment variable.|  
|**Target**|Optional **String** parameter.\<br />\<br /> Specifies the location where an environment variable is stored. Specify "<CodeContentPlaceHolder>3\</CodeContentPlaceHolder>" or "<CodeContentPlaceHolder>4\</CodeContentPlaceHolder>".\<br />\<br /> For more information, see "EnvironmentVariableTarget Enumeration" on the [MSDN](http://go.microsoft.com/fwlink/?LinkId=737) Web site.|  
