...
A <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> property declaration specifies access levels in both the [Property Statement](../vs140/property-statement.md) and the [Set Statement (Visual Basic)](../vs140/set-statement--visual-basic-.md).  
