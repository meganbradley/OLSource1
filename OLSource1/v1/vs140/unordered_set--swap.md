...
f1_keywords: 
  - "unordered_set::swap"
  - "tr1.unordered_set.swap"
  - "tr1::unordered_set::swap"
  - "std.tr1.unordered_set.swap"
  - "unordered_set.swap"
  - "swap"
  - "unordered_set/std::tr1::unordered_set::swap"
  - "std::tr1::unordered_set::swap"
dev_langs: 
  - "C++"
helpviewer_keywords: 
