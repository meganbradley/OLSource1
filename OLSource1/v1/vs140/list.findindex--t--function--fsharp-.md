...
## Example  
 The following code shows how to use <CodeContentPlaceHolder>6\</CodeContentPlaceHolder> and compares its behavior to that of [List.find](../vs140/list.find--t--function--fsharp-.md).  
