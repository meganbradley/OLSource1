...
#### Parameters  
 ...
 <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> to display the complete width of the category name regardless of the width of the property name column. <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> to limit the width of the category name to the width of the property name column. The default value is <CodeContentPlaceHolder>4\</CodeContentPlaceHolder>.  
  
 [in] <CodeContentPlaceHolder>5\</CodeContentPlaceHolder>  
 <CodeContentPlaceHolder>6\</CodeContentPlaceHolder> to update the property grid control immediately; <CodeContentPlaceHolder>7\</CodeContentPlaceHolder> to update the control when the next redraw event occurs. The default value is <CodeContentPlaceHolder>8\</CodeContentPlaceHolder>.  
