...
The specified event implicitly declares a member with the same name as a method declared with the <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> modifier.  
  
 **Error ID:** BC31413  
  
### To correct this error  
  
-   Remove the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> modifier from the method in the base class or give the property or method a unique name.  
