...
You have attempted to override a method with another method that differs by its return type. A type may override an inherited overridable method by declaring a method with the same name and signature, and marking the declaration with the <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> modifier. The signatures of the two methods must match.  
