...
## Remarks  
 The *status* parameter value is defined by the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> enumerated type, which is defined within the **COleCurrency** class.  
