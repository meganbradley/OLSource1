...
An assignment statement uses <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> to assign the address of a generic procedure to a delegate, but it does not supply any type arguments to the generic procedure.  
...
-   Specify the type arguments for the generic procedure in the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> expression.  
