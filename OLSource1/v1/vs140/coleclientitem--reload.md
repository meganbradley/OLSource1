...
## Remarks  
 Call the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> function after activating the item as an item of another type by a call to [ActivateAs](../vs140/coleclientitem--activateas.md).  
