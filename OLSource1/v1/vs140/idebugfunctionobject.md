...
## Notes for Callers  
 This interface is a specialization of the [IDebugObject](../vs140/idebugobject.md) interface and is obtained using [QueryInterface](../vs140/queryinterface.md) on the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> interface.  
