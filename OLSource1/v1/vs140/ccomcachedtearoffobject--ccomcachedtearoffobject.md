...
#### Parameters  
 ...
 [in] Pointer to the **IUnknown** of the <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>.  
  
## Remarks  
 Initializes the <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> member, [m_contained](../vs140/ccomcachedtearoffobject--m_contained.md).  
