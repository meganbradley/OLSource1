...
Let [Microsoft Test Manager](../vs140/testing-your-application-using-microsoft-test-manager.md) record your keystrokes and gestures while you are testing an application. The next time you run the test, you can play back your actions quickly and accurately.  
 ...
 Playback can also help when you want to run a test with [different data](../vs140/repeat-a-test-with-different-data.md), on [multiple configurations](../vs140/test-configurations--specifying-test-platforms.md), or where there are [shared steps](../vs140/share-steps-between-test-cases.md) that are the same in many test cases. It also speeds up regression testing—that is, tests that you run from one sprint to the next to make sure that everything is still working correctly.  
  
 You can record and play back tests in a wide range of desktop applications, and also web applications that you access through a supported browser. For a detailed list, see [Supported Configurations and Platforms for Coded UI Tests and Action Recordings](../vs140/supported-configurations-and-platforms-for-coded-ui-tests-and-action-recordings.md).  
...
1.  [Connect Microsoft Test Manager](../vs140/connect-microsoft-test-manager-to-your-team-project-and-test-plan.md) to your team project, and select your current test plan.  
  
2.  [Select a test case and run it](../vs140/run-manual-tests-with-microsoft-test-manager.md).  
  
     ![Start the test from Microsoft Test Manager.](../vs140/media/almt_ws71recordrun.png "ALMT_ws71recordRun")  
  
## Recording your actions during a test run  
 In the **Start Test** window, select **Create action recording**.  
  
 ![Create an action recording.](../vs140/media/almt_ws72recordcreate.png "ALMT_ws72recordCreate")  
...
>  Choose **Pause** if you want to interrupt your test, for example to reply to an email.  
 ...
 ![Pause the recording if you are interrupted.](../vs140/media/almt_ws77recordpause.png "ALMT_ws77recordPause")  
  
### If you make a mistake  
 Open the editing panel at the bottom of test runner. You can delete actions there:  
  
 ![Editing the recording inline.](../vs140/media/almt_ws75recordeditinline.png "ALMT_ws75recordEditInline")  
...
### If the test includes shared steps  
 ...
 ![Recording a shared step.](../vs140/media/almt_ws73recordsharedstep.png "ALMT_ws73recordSharedStep")  
  
 You have to indicate when you finish recording the shared steps:  
  
 ![Recording a shared step.](../vs140/media/almt_ws74recordendsharedstep.png "ALMT_ws74recordEndSharedStep")  
...
### If the steps include parameters  
 ...
 ![Parameters are identified if you type them.](../vs140/media/almt_ws76parametermatch.png "ALMT_ws76parameterMatch")  
...
## Playing back an action recording  
 [Select your test and run it](../vs140/run-manual-tests-with-microsoft-test-manager.md). Don’t check the overwrite option in the **Start Test** dialog.  
  
 ![Start the test without overwriting the recording.](../vs140/media/almt_ws78startplay.png "ALMT_ws78StartPlay")  
 ...
 ![Play each step and then verify the result.](../vs140/media/almt_ws79playstep.png "ALMT_ws79playStep")  
 ...
 **A:**  Yes. The recording is linked to the test case, so you can play it back from any instance of that test case, even in different [test configurations](../vs140/test-configurations--specifying-test-platforms.md), test suites or test plans.  
 ...
 **A:**  Action recording works best for applications in which each user interface field has a unique ID, and for basic gestures such as keystrokes clicks or touches and menu choices. It might not work as well for gestures such as drawing, and doesn’t work for some applications and web browsers.  
 ...
 See [Supported Configurations and Platforms for Coded UI Tests and Action Recordings](../vs140/supported-configurations-and-platforms-for-coded-ui-tests-and-action-recordings.md).  
  
 To learn how to develop your application so that it’s easier to record tests, see [Enable Coded UI Testing of Your Controls](../vs140/enable-coded-ui-testing-of-your-controls.md).  
  
 **Record/playback is cool. But can I completely automate a test, including verifying the results?**  
 Yes. [Automate your tests](../vs140/automate-system-tests.md)