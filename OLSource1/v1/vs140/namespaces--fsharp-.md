...
## Remarks  
 ...
 [!code[FsLangRef2#6406](../vs140/codesnippet/FSharp/namespaces--fsharp-_1.fs)]  
  
 If the entire contents of the file are in one module, you can also declare namespaces implicitly by using the <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> keyword and providing the new namespace name in the fully qualified module name. The following example shows a code file that declares a namespace <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> and a module <CodeContentPlaceHolder>4\</CodeContentPlaceHolder>, which contains a function.  
  
 [!code[FsLangRef2#6401](../vs140/codesnippet/FSharp/namespaces--fsharp-_2.fs)]  
...
## Global Namespace  
 ...
 [!code[FsLangRef2#6408](../vs140/codesnippet/FSharp/namespaces--fsharp-_7.fs)]  
  
## See Also  
 [F# Language Reference](../vs140/fsharp-language-reference.md)   
 [Modules (F#)](../vs140/modules--fsharp-.md)