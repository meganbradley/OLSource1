...
---
# COM_INTERFACE_ENTRY_AUTOAGGREGATE
Same as [COM_INTERFACE_ENTRY_AGGREGATE](../vs140/com_interface_entry_aggregate.md), except if <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> is **NULL**, it automatically creates the aggregate described by the <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>.  
