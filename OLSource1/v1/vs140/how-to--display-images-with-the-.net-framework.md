...
The following code example modifies the OnPaint event handler to retrieve a pointer to the <xref:System.Drawing.Graphics*> object for the main form. The [OnPaint](assetId:///M:System.Windows.Forms.Form.OnPaint(System.Windows.Forms.PaintEventArgs)?qualifyHint=False&autoUpgrade=True) function is intended for a Windows Forms application, most likely created with a Visual Studio application wizard.  
