...
## Remarks  
 The **/bugreport** option specifies that the following information should be placed in <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>:  
...
-   A description of how you think the problem should be fixed, which you will be prompted for.  
 ...
 Because a copy of all source code files will be placed in <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>, you might want to reproduce the suspected code defect in the shortest possible program.  
...
## See Also  
 ...
 [/errorreport (Set Error Reporting Behavior)](../vs140/-errorreport--csharp-compiler-options-.md)   
