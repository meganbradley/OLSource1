...
|---------------|-----------------|  
|[in] <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>|Zero-based index of an item in the current list-view control.|  
  
## Return Value  
 <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> if the specified item is visible;otherwise, <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>.  
