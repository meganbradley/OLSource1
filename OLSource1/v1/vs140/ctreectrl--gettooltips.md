...
## Remarks  
 The MFC implementation of <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> returns a <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> object, which is used by the tree control, rather than a handle to a tooltip control.  
