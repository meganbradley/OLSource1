...
```  
 ...
 Besides starting and stopping threads, you can also pause threads by calling the [Sleep](assetId:///M:System.Threading.Thread.Sleep(System.Int32)?qualifyHint=False&autoUpgrade=True) or <xref:System.Threading.Thread.Suspend*> method, resume a suspended thread by using the <xref:System.Threading.Thread.Resume*> method, and destroy a thread by using the <xref:System.Threading.Thread.Abort*> method  
...
|assetId:///M:System.Threading.Thread.Sleep(System.Int32)?qualifyHint=False&autoUpgrade=True|Pauses a thread for a specified time.|  
...
## See Also  
 ...
 [Parameters and Return Values for Multithreaded Procedures (C#)](../vs140/parameters-and-return-values-for-multithreaded-procedures--csharp-.md)   
