...
## Programming Model  
 ...
 The following illustration shows how two agents use message blocks and message-passing functions to communicate. In this illustration, <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> sends a message to <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> by using the [concurrency::send](../vs140/send-function.md) function and a [concurrency::unbounded_buffer](../vs140/unbounded_buffer-class.md) object. <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> uses the [concurrency::receive](../vs140/receive-function.md) function to read the message. <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> uses the same method to send a message to <CodeContentPlaceHolder>4\</CodeContentPlaceHolder>. Dashed arrows represent the flow of data between agents. Solid arrows connect the agents to the message blocks that they write to or read from.  
...
## Example  
 ...
 [!code[concrt-basic-agents#1](../vs140/codesnippet/CPP/asynchronous-agents-library_1.cpp)]  
