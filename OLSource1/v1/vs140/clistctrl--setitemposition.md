...
## Remarks  
 ...
 If the list view control has the <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> style, the list view is arranged after the position of the item is set.  
