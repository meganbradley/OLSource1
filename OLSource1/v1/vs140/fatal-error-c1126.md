...
'identifier' : automatic allocation exceeds size  
 ...
 To correct this error, use <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> or <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> to allocate large amounts of data.