...
f1_keywords: 
  ...
  - "CMFCVisualManager::OnDrawFloatingToolbarBorder"
  - "OnDrawFloatingToolbarBorder"
dev_langs: 
  - "C++"
helpviewer_keywords: 
  - "OnDrawFloatingToolbarBorder method"
...
## Remarks  
 ...
 The size of the border is specified by the corresponding parameter in <CodeContentPlaceHolder>5\</CodeContentPlaceHolder>. For example, the width of the top border of the toolbar is specified by <CodeContentPlaceHolder>6\</CodeContentPlaceHolder>.  
