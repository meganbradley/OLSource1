...
In native code, you can catch native C++ exception from MSIL.  You can catch CLR exceptions with <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> and <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>.  
