...
Tests if any element of the collection satisfies the given predicate. If the input function is <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> and the elements are <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>, then this function computes <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>.  
...
## Return Value  
 True if any element of <CodeContentPlaceHolder>8\</CodeContentPlaceHolder> satisfies <CodeContentPlaceHolder>9\</CodeContentPlaceHolder>.  
