...
An interface contains definitions for a group of related functionalities that a [class](../vs140/class--csharp-reference-.md) or a [struct](../vs140/struct--csharp-reference-.md) can implement.  
 ...
 The following example shows an implementation of the IEquatable<T\> interface. The implementing class, `Car`, must provide an implementation of the <xref:System.IEquatable`1.Equals?qualifyHint=False> method.  
