...
<CodeContentPlaceHolder>0\</CodeContentPlaceHolder>  
 In the preceding example, the first version of <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> is selected, and its address is copied into <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>.  
...
-   A function return type  
 ...
 Note that although a nonmember function, <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>, was used in the preceding example, the same rules are applied when taking the address of overloaded member functions.  
