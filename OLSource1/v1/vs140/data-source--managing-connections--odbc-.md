...
<CodeContentPlaceHolder>0\</CodeContentPlaceHolder>  
     This connection string specifies a trusted connection, which uses Windows NT integrated security. You should avoid hard-coding a password or specifying a blank password, because doing so creates a major security weakness. Instead, you can give <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> a new connection string so that it queries for a user ID and password.  
...
1.  Construct a <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> object.  
  
2.  Call its <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> or **Open** member function.  
...
##  \<a name="_core_disconnecting_from_a_data_source">\</a> Disconnecting from a Data Source  
 You must close any open recordsets before calling the **Close** member function of <CodeContentPlaceHolder>5\</CodeContentPlaceHolder>. In recordsets associated with the <CodeContentPlaceHolder>6\</CodeContentPlaceHolder> object you want to close, any pending <CodeContentPlaceHolder>7\</CodeContentPlaceHolder> or **Edit** statements are canceled and all pending transactions are rolled back.  
  
#### To disconnect from a data source  
  
1.  Call the <CodeContentPlaceHolder>8\</CodeContentPlaceHolder> object's [Close](../vs140/cdatabase--close.md) member function.  
  
2.  Destroy the object unless you want to reuse it.  
  
##  \<a name="_core_reusing_a_cdatabase_object">\</a> Reusing a CDatabase Object  
 You can reuse a <CodeContentPlaceHolder>9\</CodeContentPlaceHolder> object after disconnecting from it, whether you use it to reconnect to the same data source or to connect to a different data source.  
  
#### To reuse a CDatabase object  
  
1.  Close the object's original connection.  
  
2.  Instead of destroying the object, call its <CodeContentPlaceHolder>10\</CodeContentPlaceHolder> or **Open** member function again.  
