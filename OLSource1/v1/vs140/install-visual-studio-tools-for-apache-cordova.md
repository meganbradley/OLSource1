...
4.  Open Visual Studio, choose **Tools**, then **Extensions and Updates**, and then **Updates**. If there is a Visual Studio update available for Visual Studio Tools for Apache Cordova, install it.  
    ...
    > [!NOTE]
    >  The first time you build an app after installing the tools, Visual Studio will download and install the Cordova tools. As a result, the first build takes extra time to complete. Check the Output window to see progress. If you see an error such as <CodeContentPlaceHolder>5\</CodeContentPlaceHolder>, you may need to clean the solution and rebuild. For more information, see [Re-installing vs-tac](https://msdn.microsoft.com/library/dn771551%20\(v=vs.140\).aspx#vstac).  
...
-   Xcode command-line tools (from Terminal app, use <CodeContentPlaceHolder>6\</CodeContentPlaceHolder>)  
...
<CodeContentPlaceHolder>2\</CodeContentPlaceHolder>  
    > [!NOTE]
    >  In Visual Studio 2013, the preceding command is <CodeContentPlaceHolder>8\</CodeContentPlaceHolder>.  
...
<CodeContentPlaceHolder>3\</CodeContentPlaceHolder>  
    > [!NOTE]
    >  The preceding commands for certificates have changed in the latest version of the agent. Use <CodeContentPlaceHolder>9\</CodeContentPlaceHolder> to check supported commands.  
