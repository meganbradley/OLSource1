...
#### Parameters  
 ...
 The zero-based index of the first character in the <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> object to delete.  
...
## Remarks  
 If <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> is longer than the string, the rest of the string will be removed.  
