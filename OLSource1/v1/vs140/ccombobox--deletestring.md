...
---
# CComboBox::DeleteString
Deletes the item in position <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> from the combo box.  
...
## Return Value  
 If the return value is greater than or equal to 0, then it is a count of the strings remaining in the list. The return value is **CB_ERR** if <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> specifies an index greater than the number of items in the list.  
