...
## Member List  
 After you type a period (.) to delimit an instance of an \<xref:System.Xml.Linq.XElement*> or \<xref:System.Xml.Linq.XDocument*> object (or an instance of <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> or <CodeContentPlaceHolder>6\</CodeContentPlaceHolder>), Visual Basic IntelliSense displays a list of possible object members. The initial list includes three options that represent XML axis properties, as described in the following list.  
