...
The project system cannot find a node corresponding to a file.  
 ...
 Dependent files are persisted in the project file by adding a <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> attribute to the <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> node. For example:  
