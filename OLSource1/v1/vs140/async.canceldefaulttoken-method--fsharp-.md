...
## Example  
 The following example shows how to create a cancellable asynchronous operation in a Windows Forms application. It also shows how to use <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> to cancel the operation.  
  
 [!code[FsAsyncAPIs#5](../vs140/codesnippet/FSharp/async.canceldefaulttoken-method--fsharp-_1.fs)]  
