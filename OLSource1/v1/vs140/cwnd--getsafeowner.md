...
#### Parameters  
 ...
 A pointer to a parent <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> window. May be **NULL**.  
...
## Remarks  
 The safe owner is the first non-child parent window of <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>. If <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> is **NULL**, the thread's main window (retrieved via [AfxGetMainWnd](../vs140/afxgetmainwnd.md)) is used to find an owner.  
