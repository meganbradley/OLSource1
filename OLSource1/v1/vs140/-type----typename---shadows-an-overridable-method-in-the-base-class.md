...
-   If you intend to override the base procedure, add the <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> keyword to the declaration.  
  
-   If you intend to shadow the base procedure, add the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> keyword to the declaration.  
