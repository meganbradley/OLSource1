...
---
# CRect::BottomRight
The coordinates are returned as a reference to a [CPoint](../vs140/cpoint-class.md) object that is contained in <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>.  
