...
> [!NOTE]
>  [CListCtrl](../vs140/clistctrl-class.md) provides an embedded header control, and [CListView](../vs140/clistview-class.md) encapsulates <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> in an MFC class. In general, think of using <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> to label lists that you intend to draw yourself.  
