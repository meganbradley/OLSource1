...
---
# CMFCToolBar::GetCustomizeButton
Retrieves a pointer to the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> object that is associated with the toolbar.  
  
## Syntax  
  
<CodeContentPlaceHolder>0\</CodeContentPlaceHolder>  
## Return Value  
 A pointer to the <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> object that is associated with the toolbar.  
...
## Remarks  
 ...
 You can call the [CMFCToolBar::IsExistCustomizeButton](../vs140/cmfctoolbar--isexistcustomizebutton.md) method to determine whether the toolbar contains a valid <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> object.  
