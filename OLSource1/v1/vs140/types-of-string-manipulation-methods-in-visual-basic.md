...
#### Shared Methods  
 ...
 In the preceding example, the [String.Copy](assetId:///M:System.String.Copy(System.String)?qualifyHint=True&autoUpgrade=True) method is a static method, which acts upon an expression it is given and assigns the resulting value to `bString`.  
...
#### Instance Methods  
 ...
 In this example, the [String.Substring](assetId:///M:System.String.Substring(System.Int32)?qualifyHint=True&autoUpgrade=True) method is a method of the instance of `String` (that is, `aString`). It performs an operation on `aString` and assigns that value to `bString`.  
