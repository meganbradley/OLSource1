...
'<<CodeContentPlaceHolder>0\</CodeContentPlaceHolder>>' is an event, and so cannot be called directly. Use a <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> statement to raise an event.  
...
1.  Use a <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> statement to signal an event and invoke the procedure or procedures that handle it.  
