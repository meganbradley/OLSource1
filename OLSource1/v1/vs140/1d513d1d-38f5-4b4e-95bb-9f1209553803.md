...
<CodeContentPlaceHolder>0\</CodeContentPlaceHolder> can only intercept exceptions, and you have attempted to catch something that is not derived from an exception.  
  
 **Error ID:** BC30392  
  
### To correct this error  
  
1.  Remove the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> statement, or change the target of the <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> to an actual exception.  
