...
---
# CMenu::Attach
Attaches an existing Windows menu to a <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> object.  
...
## Remarks  
 This function should not be called if a menu is already attached to the <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> object. The menu handle is stored in the <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> data member.  
