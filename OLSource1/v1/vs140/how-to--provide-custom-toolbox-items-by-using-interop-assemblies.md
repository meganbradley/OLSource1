...
1.  Obtain instances of :  
    ...
    2.  <xref:Microsoft.VisualStudio.Shell.Interop.IVsToolbox3?qualifyHint=False>, which provides support for localization and [!INCLUDE[vsprvs](../vs140/includes/vsprvs_md.md)] settings persistence.  
