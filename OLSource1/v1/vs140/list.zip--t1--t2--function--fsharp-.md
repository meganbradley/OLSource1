...
## Example  
 The following code example illustrates the use of <CodeContentPlaceHolder>6\</CodeContentPlaceHolder>.  
  
 [!code[FsLists#13](../vs140/codesnippet/FSharp/list.zip--t1--t2--function--fsharp-_1.fs)]  
