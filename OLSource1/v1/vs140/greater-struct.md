...
---
# greater Struct
A binary predicate that performs the greater-than operation ( <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>) on its arguments.  
...
#### Parameters  
 ...
 The left operand of the greater-than operation. The unspecialized template takes an lvalue reference argument of type <CodeContentPlaceHolder>9\</CodeContentPlaceHolder>. The specialized template does perfect forwarding of lvalue and rvalue reference arguments of inferred type <CodeContentPlaceHolder>10\</CodeContentPlaceHolder>.  
  
 <CodeContentPlaceHolder>11\</CodeContentPlaceHolder>  
 The right operand of the greater-than operation. The unspecialized template takes an lvalue reference argument of type <CodeContentPlaceHolder>12\</CodeContentPlaceHolder>. The specialized template does perfect forwarding of lvalue and rvalue reference arguments of inferred type <CodeContentPlaceHolder>13\</CodeContentPlaceHolder>.  
