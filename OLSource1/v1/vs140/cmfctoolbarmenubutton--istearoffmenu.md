...
## Return Value  
 <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> if the toolbar menu button has a tear-off bar; otherwise <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>.  
