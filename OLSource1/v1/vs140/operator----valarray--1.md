...
## Return Value  
 A valarray whose elements are the element-wise quotient of <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> divided by <CodeContentPlaceHolder>5\</CodeContentPlaceHolder>  
