...
5.  Locate the <CodeContentPlaceHolder>7\</CodeContentPlaceHolder> element that contains <CodeContentPlaceHolder>8\</CodeContentPlaceHolder> elements.  
  
6.  In the <CodeContentPlaceHolder>9\</CodeContentPlaceHolder> element that calls VSPackage.en-US.resx, replace the <CodeContentPlaceHolder>10\</CodeContentPlaceHolder> element with a <CodeContentPlaceHolder>11\</CodeContentPlaceHolder> element, set to <CodeContentPlaceHolder>12\</CodeContentPlaceHolder>, as follows.  
  
<CodeContentPlaceHolder>5\</CodeContentPlaceHolder>  
7.  For each localized language, copy the  <CodeContentPlaceHolder>13\</CodeContentPlaceHolder> element for VsPackage.en-US, and set the **Include** attribute and **LogicalName** element of the copy to the target locale, as shown in the following example.  
  
8.  To each localized <CodeContentPlaceHolder>14\</CodeContentPlaceHolder> element, add a <CodeContentPlaceHolder>15\</CodeContentPlaceHolder> element that points to <CodeContentPlaceHolder>16\</CodeContentPlaceHolder>, as shown in the following example.  
