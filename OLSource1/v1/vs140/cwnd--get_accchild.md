...
---
# CWnd::get_accChild
Called by the framework to retrieve the address of an <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> interface for the specified child.  
...
#### Parameters  
 ...
 Identifies the child whose <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> interface is to be retrieved.  
  
 *ppdispChild*  
 Receives the address of the child object's <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> interface.  
