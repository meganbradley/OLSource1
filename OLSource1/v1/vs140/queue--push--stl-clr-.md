...
## Remarks  
 The member function adds an element with value <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> at the end of the queue. You use it to append an element to the queue.  
