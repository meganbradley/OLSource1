...
4.  Modify the **DLL Base Address** property.  
     ...
     To set this compiler option programmatically, see <xref:VSLangProj80.CSharpProjectConfigurationProperties3.BaseAddress?qualifyHint=False>.  
  
## See Also  
 <xref:System.Diagnostics.ProcessModule.BaseAddress?qualifyHint=True>   
