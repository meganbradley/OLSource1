...
## Rule Description  
 When the name of an instance field matches a parameter or a local variable name, the instance field is accessed by using the <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> (<CodeContentPlaceHolder>1\</CodeContentPlaceHolder> in [!INCLUDE[vbprvb](../vs140/includes/vbprvb_md.md)]) keyword when inside the method body. When maintaining code, it is easy to forget this difference and assume that the parameter/local variable refers to the instance field, which leads to errors. This is true especially for lengthy method bodies.  
...
## Example  
 ...
 [!code[FxCop.Maintainability.VarMatchesField#1](../vs140/codesnippet/VisualBasic/ca1500--variable-names-should-not-match-field-names_1.vb)]
[!code[FxCop.Maintainability.VarMatchesField#1](../vs140/codesnippet/CSharp/ca1500--variable-names-should-not-match-field-names_1.cs)]