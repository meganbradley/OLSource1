...
The application is attempting to use the <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> enumeration members <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> or <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>, which are not applicable to the specified locale.  
  
### To correct this error  
  
1.  Remove either <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> or <CodeContentPlaceHolder>4\</CodeContentPlaceHolder>.  
