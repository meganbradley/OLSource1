...
## Return Value  
 Nonzero if the message was fully processed in <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> and should not be processed further. Zero if the message should be processed in the normal way.  
