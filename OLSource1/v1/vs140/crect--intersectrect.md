...
---
# CRect::IntersectRect
Makes a <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> equal to the intersection of two existing rectangles.  
...
#### Parameters  
 ...
 Points to a [RECT](../vs140/rect-structure.md) structure or <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> object that contains a source rectangle.  
  
 <CodeContentPlaceHolder>4\</CodeContentPlaceHolder>  
 Points to a <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> structure or <CodeContentPlaceHolder>6\</CodeContentPlaceHolder> object that contains a source rectangle.  
