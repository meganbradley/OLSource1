...
## Example  
 The following example generates C3483 because the variable <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> appears more than one time in the capture list of the lambda expression:  
