...
|---------------|---------------------|  
|\<xref:Microsoft.VisualStudio.TextManager.Interop.IVsTextBuffer*>|<CodeContentPlaceHolder>3\</CodeContentPlaceHolder> is not implemented.|  
