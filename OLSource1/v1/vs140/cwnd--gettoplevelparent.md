...
## Remarks  
 <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> is similar to [GetTopLevelFrame](../vs140/cwnd--gettoplevelframe.md) and [GetTopLevelOwner](../vs140/cwnd--gettoplevelowner.md); however, it ignores the value set as the current owner window.  
