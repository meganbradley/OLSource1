...
|Add a single project solution to source control using **Add Selected Projects to Source Control**.|1.  Create a single project solution.\<br />2.  Add only solution to source control as a selection (**File**, **Source Control**, **Add Selected Projects to Source Control**). If this step succeeds, continue to next step.\<br />3.  Add project to source control as selection (**File**, **Source Control**, **Add Selected Projects to Source Control**).\<br />4.  Click **Yes** to add the project to the same location.\<br />5.  Click **Check Out** in **Check Out For Edit** dialog box.|<CodeContentPlaceHolder>0\</CodeContentPlaceHolder>\<br />\<br /> The project and all files within the project have a checked out source control indicator, and a ToolTip displays "Not under source control".\<br />\<br /> <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>\<br />\<br /> Project and solution file are in the same folder in source control.|  
|Cancel adding a solution to source control|1.  Create a single project solution.\<br />2.  Attempt to add project and solution to source control. If this step succeeds, continue to next step.\<br />3.  Cancel after you are in source control system.|<CodeContentPlaceHolder>2\</CodeContentPlaceHolder>\<br />\<br /> The Set project location source control dialog box appears only once.\<br />\<br /> <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>\<br />\<br /> Project add canceled, project/solution is NOT under source control and all Add to source control menus still available.|  
...
|Open a solution containing a Remote Site Web project from source control|1.  Create a Remote Site Web project.\<br />2.  Add the solution to source control. If this step succeeds, continue to next step.\<br />3.  Close the solution.\<br />4.  Open the solution from source control to a new location.|<CodeContentPlaceHolder>4\</CodeContentPlaceHolder>\<br />\<br /> Remote Site Web is NOT under source control.\<br />\<br /> <CodeContentPlaceHolder>5\</CodeContentPlaceHolder>\<br />\<br /> Solution opened from source control.\<br />\<br /> Remote Site project is loaded, but it is NOT under source control.|  
...
|Add to solution — solution added to source control by selection|1.  Create a solution with a project.\<br />2.  Add only solution to source control as selection. If this step succeeds, continue to next step.\<br />3.  Close the solution.\<br />4.  Create a new solution.\<br />5.  Add the previously controlled solution from source control (**File**, **Source Control**, **Add Project from Source Control**).|<CodeContentPlaceHolder>6\</CodeContentPlaceHolder>\<br />\<br /> Project is not under source control.\<br />\<br /> <CodeContentPlaceHolder>7\</CodeContentPlaceHolder>\<br />\<br /> If the first solution had solution items, they cannot be added from source control, so they do not appear.\<br />\<br /> Project from first solution appears as unavailable.|  
