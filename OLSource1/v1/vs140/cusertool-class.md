...
## Example  
 The following example demonstrates how to create a tool from a <CodeContentPlaceHolder>13\</CodeContentPlaceHolder> object, set the <CodeContentPlaceHolder>14\</CodeContentPlaceHolder> member variable, and set the application that the user tool runs. This code snippet is part of the [Visual Studio Demo sample](../vs140/visual-c---samples.md).  
  
 [!code[NVC_MFC_VisualStudioDemo#35](../vs140/codesnippet/CPP/cusertool-class_1.cpp)]  
...
### Return Value  
 A reference to <CodeContentPlaceHolder>17\</CodeContentPlaceHolder> object that contains the text of the command associated with the user tool.  
...
### Return Value  
 A handle to the loaded icon ( <CodeContentPlaceHolder>18\</CodeContentPlaceHolder>), or <CodeContentPlaceHolder>19\</CodeContentPlaceHolder> if the default icon cannot be loaded.  
