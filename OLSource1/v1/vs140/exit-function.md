...
> [!NOTE]
>  You can use the constants <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> and <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>, defined in STDLIB.H, to indicate success or failure of your program.  
  
 Issuing a <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> statement from the **main** function is equivalent to calling the **exit** function with the return value as its argument.  
