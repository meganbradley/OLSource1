...
apitype: "Assembly"
f1_keywords: 
  - "Microsoft.FSharp.Core.Operators.ToUInt16``1"
dev_langs: 
  - "FSharp"
helpviewer_keywords: 
  - "Operators.uint16 function [F#]"
  - "uint16 function [F#]"
  - "Operators.ToUInt16 function [F#]"
  - "ToUInt16 function [F#]"
...
Converts the argument to unsigned 16-bit integer. This is a direct conversion for all primitive numeric types. For strings, the input is converted using [Parse](assetId:///M:System.UInt16.Parse(System.String)?qualifyHint=False&autoUpgrade=True) with <xref:System.Globalization.CultureInfo.InvariantCulture*> settings. Otherwise the operation requires an appropriate static conversion method on the input type.  
