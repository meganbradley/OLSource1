...
Retrieves the section part of an address location. Use when the [LocationType Enumeration](../vs140/locationtype.md) is set to <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>.  
