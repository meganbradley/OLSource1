...
---
# CRuntimeClass::m_pBaseClass
If your application statically links to MFC, this data member contains a pointer to the <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> structure of the base class.  
