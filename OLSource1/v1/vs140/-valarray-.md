...
|[operator^](../vs140/-valarray--operators.md#operator_xor)|Obtains the bitwise exclusive <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> between corresponding elements of two equally sized valarrays or between a valarray and a specified value of the element type.|  
|[operator&#124;](../vs140/-valarray--operators.md#operator_or)|Obtains the bitwise <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> between corresponding elements of two equally sized valarrays or between a valarray and a specified value of the element type.|  
|[operator&#124;&#124;](../vs140/-valarray--operators.md#operator_lor)|Obtains the logical <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> between corresponding elements of two equally sized valarrays or between a valarray and a specified value of the valarray's element type.|  
...
|||  
|-|-|  
|[valarray\<bool> Class](../vs140/valarray-bool--class.md)|A specialized version of the template class valarray\<**Type**> to elements of type <CodeContentPlaceHolder>4\</CodeContentPlaceHolder>.|  
