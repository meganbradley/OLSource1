...
apitype: "Assembly"
f1_keywords: 
  - "Microsoft.FSharp.Core.ExtraTopLevelOperators.SpliceExpression``1"
dev_langs: 
  - "FSharp"
helpviewer_keywords: 
  - "SpliceExpression operator [F#]"
  - "~% operator [F#]"
  - "ExtraTopLevelOperators.( ~% ) operator [F#]"
  - "ExtraTopLevelOperators.SpliceExpression operator [F#]"
...
#### Parameters  
 ...
 Type: [Expr](../vs140/quotations.expr--t--class--fsharp-.md)<CodeContentPlaceHolder>2\</CodeContentPlaceHolder>  
