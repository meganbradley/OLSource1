...
Must obtain function pointers to run initializers; consider System::ModuleHandle::ResolveMethodHandle  
 ...
 Under **/clr**, initializer symbols contain function tokens, not functions pointers.  You need to convert tokens to pointers using [ResolveMethodHandle](assetId:///M:System.ModuleHandle.ResolveMethodHandle(System.Int32)?qualifyHint=False&autoUpgrade=True).  
