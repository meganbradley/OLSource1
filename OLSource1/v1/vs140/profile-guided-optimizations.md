...
> [!NOTE]
>  Information that is gathered from profiling test runs will override optimizations that would otherwise be in effect if you specify **/Ob**, **/Os**, or **/Ot**. For more information, see [/Ob (Inline Function Expansion)](../vs140/-ob--inline-function-expansion-.md) and [/Os, /Ot (Favor Small Code, Favor Fast Code)](../vs140/-os---ot--favor-small-code--favor-fast-code-.md).  
...
-   Compile one or more source code files with [/GL](../vs140/-gl--whole-program-optimization-.md).  
...
-   Profile the application.  
     ...
     You can use the <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> option when you profile your application. This option enables you to specify whether you want to profile the application in safe mode or fast mode. For more information about these modes, see [PogoSafeMode](../vs140/pogosafemode.md).  
