...
#### Parameters  
 ...
 `pExtendedInfo`  
 [out] Returns a `VARIANT` (C++) or object (C#) that can be used to retrieve the extended property information. For example, this parameter might return an `IUnknown` interface that can be queried for an [IDebugDocumentText2](../vs140/idebugdocumenttext2.md) interface. See Remarks for details.  
...
|----------|----------|-----------------|  
|guidDocument|{3f98de84-fee9-11d0-b47f-00a0244a1dd2}|Returns an `IUnknown` interface to the document. Typically, the [IDebugDocumentText2](../vs140/idebugdocumenttext2.md) interface can be obtained from this `IUnknown` interface.|  
