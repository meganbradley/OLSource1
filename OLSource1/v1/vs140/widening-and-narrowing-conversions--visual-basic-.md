...
|[SByte](../vs140/sbyte-data-type--visual-basic-.md)|`SByte`, `Short`, `Integer`, `Long`, `Decimal`, `Single`, `Double`|  
|[Byte](../vs140/byte-data-type--visual-basic-.md)|`Byte`, `Short`, `UShort`, `Integer`, `UInteger`, `Long`, `ULong`, `Decimal`, `Single`, `Double`|  
|[Short](../vs140/short-data-type--visual-basic-.md)|`Short`, `Integer`, `Long`, `Decimal`, `Single`, `Double`|  
|[UShort](../vs140/ushort-data-type--visual-basic-.md)|`UShort`, `Integer`, `UInteger`, `Long`, `ULong`, `Decimal`, `Single`, `Double`|  
|[Integer](../vs140/integer-data-type--visual-basic-.md)|`Integer`, `Long`, `Decimal`, `Single`, `Double`<sup>2</sup>|  
|[UInteger](../vs140/uinteger-data-type.md)|`UInteger`, `Long`, `ULong`, `Decimal`, `Single`, `Double`<sup>2</sup>|  
|[Long](../vs140/long-data-type--visual-basic-.md)|`Long`, `Decimal`, `Single`, `Double`<sup>2</sup>|  
|[ULong](../vs140/ulong-data-type--visual-basic-.md)|`ULong`, `Decimal`, `Single`, `Double`<sup>2</sup>|  
|[Decimal](../vs140/decimal-data-type--visual-basic-.md)|`Decimal`, `Single`, `Double`<sup>2</sup>|  
|[Single](../vs140/single-data-type--visual-basic-.md)|`Single`, `Double`|  
|[Double](../vs140/double-data-type--visual-basic-.md)|`Double`|  
...
|[Char](../vs140/char-data-type--visual-basic-.md)|`Char`, `String`|  
...
|[Nothing](../vs140/nothing--visual-basic-.md)|Any data type or object type.|  
 ...
 Widening conversions always succeed at run time and never incur data loss. You can always perform them implicitly, whether the [Option Strict Statement](../vs140/option-strict-statement.md) sets the type checking switch to `On` or to `Off`.  
...
-   Conversions in either direction between [String](../vs140/string-data-type--visual-basic-.md) and any numeric type, `Boolean`, or [Date](../vs140/date-data-type--visual-basic-.md)  
...
-   <xref:System.InvalidCastException?qualifyHint=False> — if no conversion is defined between the two types  
  
-   <xref:System.OverflowException?qualifyHint=False> — (integral types only) if the converted value is too large for the target type  
  
 If a class or structure defines a [CType Function](../vs140/ctype-function--visual-basic-.md) to serve as a conversion operator to or from that class or structure, that `CType` can throw any exception it deems appropriate. In addition, that `CType` might call [!INCLUDE[vbprvb](../vs140/includes/vbprvb_md.md)] functions or [!INCLUDE[dnprdnshort](../vs140/includes/dnprdnshort_md.md)] methods, which in turn could throw a variety of exceptions.  
