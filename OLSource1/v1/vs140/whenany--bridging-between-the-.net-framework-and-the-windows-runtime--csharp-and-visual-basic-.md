...
dev_langs: 
  ...
  - CSharp
helpviewer_keywords: 
  - async, using AsTask [C#]
  - async, bridging between .NET and Windows Runtime
  - async, using WhenAny [C#]
  - async, using WhenAny [VB]
  - async, using AsTask [VB]
...
-   [WhenAny: Bridging between the .NET Framework and the Windows Runtime (C#)](../vs140/whenany--bridging-between-the-.net-framework-and-the-windows-runtime--csharp-.md)