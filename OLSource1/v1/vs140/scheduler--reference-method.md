...
## Remarks  
 ...
 The method will throw an [improper_scheduler_reference](../vs140/improper_scheduler_reference-class.md) exception if the reference count prior to calling the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> method was zero and the call is made from a context that is not owned by the scheduler.  
