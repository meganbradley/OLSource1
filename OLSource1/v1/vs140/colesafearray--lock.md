...
## Remarks  
 ...
 The pointer in the array descriptor is valid until <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> is called. Calls to <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> can be nested; an equal number of calls to <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> are required.  
