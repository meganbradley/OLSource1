...
## Return Value  
 <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> indicates that the registry information is directed to the **HKCU** node; <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> indicates that the application writes registry information to the default node. The default node is **HKEY_CLASSES_ROOT** (**HKCR**).  
...
## Requirements  
 <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> afxstat_.h  
