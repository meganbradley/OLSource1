...
## Return Value  
 The first method returns <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>.  
  
 The second method returns a copy of <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> that is made before the decrement.  
