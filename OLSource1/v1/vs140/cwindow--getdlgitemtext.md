...
## Remarks  
 The second version of this method allows you to copy the control's text to a <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>. This version returns **TRUE** if the text is successfully copied; otherwise, **FALSE**.  
