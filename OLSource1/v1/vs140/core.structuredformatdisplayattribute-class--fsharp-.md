...
|Member|Description|  
|------------|-----------------|  
|[Value](../vs140/structuredformatdisplayattribute.value-property--fsharp-.md)|Indicates the text to display by default when objects of this type are displayed using `%A`[printf](../vs140/core.printf-module--fsharp-.md) formatting patterns and other two-dimensional text-based display layouts.|  
