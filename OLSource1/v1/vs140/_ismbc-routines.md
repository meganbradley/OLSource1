...
|[_ismbcgraph, _ismbcgraph_l](../vs140/8e0a5f47-ba64-4411-92a3-3c525d16e3be.md)|Graphic|Returns nonzero if and only if `c` is a single-byte representation of any ASCII or katakana printable character except a white space ( ). See examples for `_ismbcdigit`, `_ismbcalpha`, and `_ismbcpunct`.|  
...
|[_ismbcprint, _ismbcprint_l](../vs140/8e0a5f47-ba64-4411-92a3-3c525d16e3be.md)|Printable|Returns nonzero if and only if `c` is a single-byte representation of any ASCII or katakana printable character including a white space ( ): See examples for `_ismbcspace`, `_ismbcdigit`, `_ismbcalpha`, and `_ismbcpunct`.|  
|[_ismbcpunct, _ismbcpunct_l](../vs140/8e0a5f47-ba64-4411-92a3-3c525d16e3be.md)|Punctuation|Returns nonzero if and only if `c` is a single-byte representation of any ASCII or katakana punctuation character.|  
|[_ismbcblank, _ismbcblank_l,](../vs140/8e0a5f47-ba64-4411-92a3-3c525d16e3be.md)|Space or horizontal tab|Returns nonzero if and only if `c` is a single-byte representation of a space character or a horizontal tab character: `c`=0x20 or `c`=0x09.|  
|[_ismbcspace, _ismbcspace_l](../vs140/8e0a5f47-ba64-4411-92a3-3c525d16e3be.md)|Whitespace|Returns nonzero if and only if `c` is a white space character: `c`=0x20 or 0x09<=`c`<=0x0D.|  
