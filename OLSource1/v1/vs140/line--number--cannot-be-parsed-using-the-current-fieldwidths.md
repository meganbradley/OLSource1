...
-   Adjust <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> so the line can be parsed correctly, or insert exception-handling code in order to handle the line.  
