...
## Value vs. reference types  
 ...
 If you really want a reference-like type (base class, virtual functions), you need to explicitly disable copying, as shown in the <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> class in the following code.  
...
<CodeContentPlaceHolder>2\</CodeContentPlaceHolder>  
 ...
 Some *non-value* types are move-only, such as when you can’t clone a resource, only transfer ownership. Example: <CodeContentPlaceHolder>7\</CodeContentPlaceHolder>.  
