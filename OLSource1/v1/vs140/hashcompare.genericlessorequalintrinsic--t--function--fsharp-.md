...
## Return Value  
 <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> if the first object is less than or equal to the second; otherwise, <CodeContentPlaceHolder>6\</CodeContentPlaceHolder>.  
