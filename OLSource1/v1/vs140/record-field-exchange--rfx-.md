...
> [!NOTE]
>  If you have implemented bulk row fetching in a derived <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> class, the framework uses the bulk record field exchange (Bulk RFX) mechanism to transfer data. For more information, see [Recordset: Fetching Records in Bulk (ODBC)](../vs140/recordset--fetching-records-in-bulk--odbc-.md).  
