...
-   Use the <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> property of the XML literal to reference its value as a <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>. Use the <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> function, another type conversion function, or the \<xref:System.Convert*> class to cast the value as the specified type.  
