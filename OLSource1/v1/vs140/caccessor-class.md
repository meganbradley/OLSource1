...
## Remarks  
 ...
 If your accessor contains fields that point to memory (such as a <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> or interface) that must be freed, call the member function [CAccessorRowset::FreeRecordMemory](../vs140/caccessorrowset--freerecordmemory.md) before the next record is read.  
