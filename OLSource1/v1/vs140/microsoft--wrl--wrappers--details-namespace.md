...
|Name|Description|  
|----------|-----------------|  
|[CompareStringOrdinal Method](../vs140/comparestringordinal-method.md)|Compares two specified <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> objects and returns an integer that indicates their relative position in a sort order.|  
