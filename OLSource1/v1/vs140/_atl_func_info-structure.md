...
## Members  
 **cc**  
 The calling convention. When using this structure with the [IDispEventSimpleImpl](../vs140/idispeventsimpleimpl-class.md) class, this member must be **CC_STDCALL**. <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> is the only option supported in Windows CE for the <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> field of the <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> structure. Any other value is unsupported thus its behavior undefined.  
...
## Example  
 ...
 you would define an <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> structure:  
