...
6.  In DebuggerSide.cs, add the following statement to the <CodeContentPlaceHolder>10\</CodeContentPlaceHolder> statements:  
  
<CodeContentPlaceHolder>0\</CodeContentPlaceHolder>  
 Now you are ready to create the debugger-side code. This is the code that runs within the debugger to display the information that you want to visualize. First, you have to change the declaration of the <CodeContentPlaceHolder>11\</CodeContentPlaceHolder> object so that inherits from the base class <CodeContentPlaceHolder>12\</CodeContentPlaceHolder>.  
...
<CodeContentPlaceHolder>2\</CodeContentPlaceHolder>  
 <CodeContentPlaceHolder>13\</CodeContentPlaceHolder> has one abstract method (<CodeContentPlaceHolder>14\</CodeContentPlaceHolder>) that you must override.  
  
#### To override the DialogDebuggerVisualizer.Show method  
  
-   In <CodeContentPlaceHolder>15\</CodeContentPlaceHolder>, add the following **method:**  
  
<CodeContentPlaceHolder>3\</CodeContentPlaceHolder>  
 The <CodeContentPlaceHolder>16\</CodeContentPlaceHolder> method contains the code that actually creates the visualizer dialog box or other user interface and displays the information that has been passed to the visualizer from the debugger. You must add the code that creates the dialog box and displays the information. In this walkthrough, you will do this using a Windows forms message box. First, you must add a reference and <CodeContentPlaceHolder>17\</CodeContentPlaceHolder> statement for System.Windows.Forms.  
...
4.  In DebuggerSide.cs, add the following statement to the <CodeContentPlaceHolder>18\</CodeContentPlaceHolder> statements:  
...
1.  In the <CodeContentPlaceHolder>19\</CodeContentPlaceHolder> method, add the following line of code:  
...
1.  Add the following attribute code to DebuggerSide.cs, after the <CodeContentPlaceHolder>20\</CodeContentPlaceHolder> statements but before <CodeContentPlaceHolder>21\</CodeContentPlaceHolder>:  
...
1.  Add the following method to class <CodeContentPlaceHolder>22\</CodeContentPlaceHolder>:  
...
3.  In the **Name** box, type a meaningful name for the console application, such as <CodeContentPlaceHolder>23\</CodeContentPlaceHolder>.  
...
3.  In TestConsole.cs, add the following code to the <CodeContentPlaceHolder>24\</CodeContentPlaceHolder> statements:  
  
<CodeContentPlaceHolder>8\</CodeContentPlaceHolder>  
4.  In method <CodeContentPlaceHolder>25\</CodeContentPlaceHolder>, add the following code:  
