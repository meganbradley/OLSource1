...
|Topic|Description|  
|-----------|-----------------|  
|[Namespaces Overview (LINQ to XML)](../vs140/namespaces-overview--linq-to-xml-3.md)|This topic introduces namespaces, the <xref:System.Xml.Linq.XName?qualifyHint=False> class, and the <xref:System.Xml.Linq.XNamespace?qualifyHint=False> class.|  
