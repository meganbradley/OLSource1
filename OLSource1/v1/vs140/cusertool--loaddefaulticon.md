...
## Return Value  
 A handle to the loaded icon (<CodeContentPlaceHolder>1\</CodeContentPlaceHolder>), or <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> if the default icon cannot be loaded.  
