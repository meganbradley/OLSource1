...
---
# CObList::RemoveAll
Removes all the elements from this list and frees the associated <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> memory.  
...
## Remarks  
 ...
 When you remove elements from a <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>, you remove the object pointers from the list. It is your responsibility to delete the objects themselves.  
