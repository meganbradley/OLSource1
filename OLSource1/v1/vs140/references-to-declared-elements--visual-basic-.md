...
```  
 ...
 You cannot use the class name itself to qualify a member that is not [Shared](../vs140/shared--visual-basic-.md). You must first create an instance in an object variable (in this case `demoClass`) and then reference it by the variable name.  
