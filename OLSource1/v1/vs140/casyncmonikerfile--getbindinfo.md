...
## Return Value  
 Retrieves the settings for **IBindStatusCallBack**. For a description of the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> interface, see the [!INCLUDE[winSDK](../vs140/includes/winsdk_md.md)].  
