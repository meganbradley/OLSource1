...
The initialization expression in a <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> statement evaluates to a data type that cannot be converted to the declared type of the constant.  
