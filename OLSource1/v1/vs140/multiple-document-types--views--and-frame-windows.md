...
Multiple-View User Interfaces  
 ...
 For more information about <CodeContentPlaceHolder>0\</CodeContentPlaceHolder>, see class [CView](../vs140/cview-class.md) in the *MFC Reference* and the [Scribble sample](../vs140/visual-c---samples.md).  
