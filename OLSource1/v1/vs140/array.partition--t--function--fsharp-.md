...
## Return Value  
 A pair of arrays. The first containing the elements the predicate for which the predicate evaluated to <CodeContentPlaceHolder>7\</CodeContentPlaceHolder>, and the second containing those for which the predicate evaluated to <CodeContentPlaceHolder>8\</CodeContentPlaceHolder>.  
