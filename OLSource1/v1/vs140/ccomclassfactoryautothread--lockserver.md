...
## Remarks  
 When using <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>, **_Module** typically refers to the global instance of [CComAutoThreadModule](../vs140/ccomautothreadmodule-class.md).  
  
 Calling <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> allows a client to hold onto a class factory so that multiple objects can be quickly created.  
