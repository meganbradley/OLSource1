 ...
 *value*  
 The value to add to the <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> object, associated with <CodeContentPlaceHolder>4\</CodeContentPlaceHolder>.  
  
## Return Value  
 Returns the position of the key/value element pair in the <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> object.  
