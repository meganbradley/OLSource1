...
-   Native or managed C or C++ code in Visual C++ projects, header files (.h or <CodeContentPlaceHolder>0\</CodeContentPlaceHolder>), or binaries  
...
7.  The map shows the relationships. In this example, the methods called by the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> method, and their location in the solution or externally.  
...
|The message **Unknown Methods** appears on a method node.\<br />\<br /> This issue occurs because the name of the method cannot be resolved.|The binary file might not have a base relocation table.|Turn on the **/FIXED:NO** option in the linker.\<br />\<br /> See [/FIXED (Fixed Base Address)](../vs140/-fixed--fixed-base-address-.md).|  
||The program database (.pdb) file might not be built.\<br />\<br /> A .pdb file stores debugging information, such as type, method, and source file information.|Turn on the **/DEBUG** option in the linker.\<br />\<br /> See [/DEBUG (Generate Debug Info)](../vs140/-debug--generate-debug-info-.md).|  
...
||The caller is not a function and is either a thunk in the binary file or a pointer in the data section.|When the caller is a thunk, try using <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> to avoid the thunk.\<br />\<br /> See:\<br />\<br /> -   [General Rules and Limitations](../vs140/general-rules-and-limitations.md)\<br />-   [Importing Function Calls Using __declspec(dllimport)](../vs140/importing-function-calls-using-__declspec-dllimport-.md)\<br />-   [dllexport, dllimport](../vs140/dllexport--dllimport.md)|  
