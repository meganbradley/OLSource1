...
You can use the `My.Application.Log` and `My.Log` objects to log information about exceptions that occur in your application. These examples show how to use the `My.Application.Log.WriteException` method to log exceptions that you catch explicitly and exceptions that are unhandled.  
 ...
 For logging tracing information, use the `My.Application.Log.WriteEntry` method. For more information, see [WriteEntry](assetId:///M:Microsoft.VisualBasic.Logging.Log.WriteEntry(System.String)?qualifyHint=False&autoUpgrade=True)  
...
## See Also  
 ...
 assetId:///M:Microsoft.VisualBasic.Logging.Log.WriteEntry(System.String)?qualifyHint=False&autoUpgrade=True   
