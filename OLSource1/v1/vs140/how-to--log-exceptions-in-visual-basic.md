...
You can use the <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> and <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> objects to log information about exceptions that occur in your application. These examples show how to use the <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> method to log exceptions that you catch explicitly and exceptions that are unhandled.  
  
 For logging tracing information, use the <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> method. For more information, see \<xref:Microsoft.VisualBasic.Logging.Log.WriteEntry*>  
...
2.  Use a <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> block to catch the exception.  
  
     [!code[VbVbalrMyApplicationLog#6](../vs140/codesnippet/VisualBasic/how-to--log-exceptions-in-visual-basic_2.vb)]  
  
3.  Put the code that could generate an exception in the <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> block.  
  
     Uncomment the <CodeContentPlaceHolder>6\</CodeContentPlaceHolder> and <CodeContentPlaceHolder>7\</CodeContentPlaceHolder> lines to cause a \<xref:System.NullReferenceException*> exception.  
  
     [!code[VbVbalrMyApplicationLog#7](../vs140/codesnippet/VisualBasic/how-to--log-exceptions-in-visual-basic_3.vb)]  
  
4.  In the <CodeContentPlaceHolder>8\</CodeContentPlaceHolder> block, use the <CodeContentPlaceHolder>9\</CodeContentPlaceHolder> method to write the exception information.  
...
6.  Add the <CodeContentPlaceHolder>10\</CodeContentPlaceHolder> method to the <CodeContentPlaceHolder>11\</CodeContentPlaceHolder> event handler.  
