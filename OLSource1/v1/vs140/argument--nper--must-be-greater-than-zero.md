...
The <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> function, which returns a <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> specifying the number of periods for an annuity based on periodic fixed payments and a fixed interest rate, requires an argument greater than zero.  
