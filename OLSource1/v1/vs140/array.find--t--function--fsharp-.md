...
Returns the first element for which the given function returns `true`. Raise <xref:System.Collections.Generic.KeyNotFoundException?qualifyHint=False> if no such element exists.  
