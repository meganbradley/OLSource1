...
## Building the Example  
 The example in this topic adds to the project that's developed in [Cancel a Task or a List of Tasks (C# and Visual Basic)](../vs140/cancel-an-async-task-or-a-list-of-tasks--csharp-and-visual-basic-.md) to cancel a list of tasks. The example uses the same UI, although the **Cancel** button isn’t used explicitly.  
...
## See Also  
 [WhenAny](assetId:///M:System.Threading.Tasks.Task.WhenAny(System.Collections.Generic.IEnumerable{System.Threading.Tasks.Task})?qualifyHint=False&autoUpgrade=True)   
