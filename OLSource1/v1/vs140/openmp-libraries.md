...
|VCOMPD.LIB|Multithreaded, dynamic link (import library for VCOMPD.LID) (debug)|  
 ...
 If _DEBUG is defined in a compilation and if <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> is in source code, VCOMPD.LIB will be the default lib. Otherwise, VCOMP.LIB will be used.  
