...
<CodeContentPlaceHolder>0\</CodeContentPlaceHolder>  
 You can insert this snippet by clicking **Insert Snippet** in the context menu of the code window, then **Visual C#**, then type <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>, then TAB, or you can type <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> and press TAB + TAB.  
  
 An example of a surround-with snippet: in C++ the shortcut <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> can be used either as an insertion snippet or as a surround-with snippet. If you select a line of code (for example <CodeContentPlaceHolder>6\</CodeContentPlaceHolder>), and then click **Surround With**, then **if**, the snippet is expanded around the line:  
  
<CodeContentPlaceHolder>1\</CodeContentPlaceHolder>  
## Snippet Replacement Parameters  
 Snippets can contain replacement parameters, which are placeholders that you must replace to fit the precise code you are writing. In the previous example <CodeContentPlaceHolder>7\</CodeContentPlaceHolder> is a replacement parameter, which you would replace with the appropriate condition. The replacement you make is repeated for every instance of the same replacement parameter in the snippet.  
...
<CodeContentPlaceHolder>2\</CodeContentPlaceHolder>  
 If you change <CodeContentPlaceHolder>8\</CodeContentPlaceHolder> to <CodeContentPlaceHolder>9\</CodeContentPlaceHolder>, then every instance of <CodeContentPlaceHolder>10\</CodeContentPlaceHolder> is changed. If you change <CodeContentPlaceHolder>11\</CodeContentPlaceHolder> to <CodeContentPlaceHolder>12\</CodeContentPlaceHolder> in the property declaration, then the value in the set method is also changed to <CodeContentPlaceHolder>13\</CodeContentPlaceHolder>.  
