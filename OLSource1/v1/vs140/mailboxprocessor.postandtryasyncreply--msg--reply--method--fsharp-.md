...
Like [MailboxProcessor.AsyncPostAndReply](../vs140/mailboxprocessor.postandasyncreply--msg--reply--method--fsharp-.md), but returns <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> if no reply within the timeout period.  
...
#### Parameters  
 ...
 Type: [AsyncReplyChannel](../vs140/control.asyncreplychannel--reply--class--fsharp-.md)<CodeContentPlaceHolder>3\</CodeContentPlaceHolder>  
...
## Return Value  
 An asynchronous computation ([Async](../vs140/control.async-class--fsharp-.md) object) that will return the reply or <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> if the timeout expires.  
  
## Remarks  
  
## Example  
 The following code shows how to use the <CodeContentPlaceHolder>6\</CodeContentPlaceHolder> method.  
