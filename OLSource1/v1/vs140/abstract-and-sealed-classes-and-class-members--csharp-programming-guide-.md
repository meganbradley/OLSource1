...
## Sealed Classes and Class Members  
 Classes can be declared as [sealed](../vs140/sealed--csharp-reference-.md) by putting the keyword `sealed` before the class definition. For example:  
