...
-   Your solution and project file formats must fit your implementation strategy.  
     ...
     For more information, see [How to: Upgrade a Project System](../vs140/upgrading-custom-projects.md) and [Registering File Name Extensions for Side-By-Side Deployments](../vs140/registering-file-name-extensions-for-side-by-side-deployments.md).  
