...
-   Use the variable name on the left side of an assignment statement.  
     ...
     The following example sets the value of the variable <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>.  
...
-   Use the variable name following the equal (<CodeContentPlaceHolder>3\</CodeContentPlaceHolder>) sign in an assignment statement.  
  
     The following example reads the value of the variable <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> and then uses the value of the variable <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> in an expression.  
