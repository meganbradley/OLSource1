...
## Enumeration Types as Bit Flags  
 ...
 For more information about what to consider when you define enumeration types with the <xref:System.FlagsAttribute?qualifyHint=True> attribute, see <xref:System.Enum?qualifyHint=True>.  
  
## Using the System.Enum Methods to Discover and Manipulate Enum Values  
 All enums are instances of the <xref:System.Enum?qualifyHint=True> type. You cannot derive new classes from <xref:System.Enum?qualifyHint=True>, but you can use its methods to discover information about and manipulate values in an enum instance.  
  
 [!code[csProgGuideEnums#5](../vs140/codesnippet/CSharp/enumeration-types--csharp-programming-guide-_7.cs)]
  
  
 For more information, see <xref:System.Enum?qualifyHint=True>.  
