...
#### Parameters  
 *x*  
 [in] The name of the user record class derived from <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>.  
...
## Remarks  
 ...
 The <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> macro is completed with the <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> macro. This macro is used when there is only one accessor required in the user record.  
