...
---
# CRect::PtInRect
Determines whether the specified point lies within <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>.  
...
## Return Value  
 Nonzero if the point lies within <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>; otherwise 0.  
  
## Remarks  
 A point is within <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> if it lies on the left or top side or is within all four sides. A point on the right or bottom side is outside <CodeContentPlaceHolder>5\</CodeContentPlaceHolder>.  
