...
##  \<a name="_atl_using_.25.module.25">\</a> Using %MODULE%  
 The [ATL Control Wizard](../vs140/atl-control-wizard.md) automatically generates a script that uses <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>. ATL uses this replaceable parameter for the actual location of your server's DLL or EXE.  
  
## Concatenating Run-Time Data with Script Data  
 Another use of the preprocessor is to concatenate run-time data with script data. For example, suppose an entry is needed that contains a full path to a module with the string "<CodeContentPlaceHolder>2\</CodeContentPlaceHolder>" appended at the end. First, define the following expansion:  
...
<CodeContentPlaceHolder>0\</CodeContentPlaceHolder>  
 ...
 [!code[NVC_ATL_Utilities#113](../vs140/codesnippet/CPP/using-replaceable-parameters--the-registrar-s-preprocessor-_1.cpp)]  
  
 During the parsing of the script, the Registrar expands <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> to <CodeContentPlaceHolder>4\</CodeContentPlaceHolder>.  
