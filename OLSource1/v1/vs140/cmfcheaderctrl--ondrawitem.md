...
#### Parameters  
 ...
 <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> to draw the item in pressed state; otherwise, <CodeContentPlaceHolder>6\</CodeContentPlaceHolder>.  
  
 [in] <CodeContentPlaceHolder>7\</CodeContentPlaceHolder>  
 <CodeContentPlaceHolder>8\</CodeContentPlaceHolder> to draw the item in highlighted state; otherwise, <CodeContentPlaceHolder>9\</CodeContentPlaceHolder>.  
