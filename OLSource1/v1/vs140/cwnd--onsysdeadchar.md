...
---
# CWnd::OnSysDeadChar
The framework calls this member function if the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> object has the input focus when the [OnSysKeyUp](../vs140/cwnd--onsyskeyup.md) or [OnSysKeyDown](../vs140/cwnd--onsyskeydown.md) member function is called.  
