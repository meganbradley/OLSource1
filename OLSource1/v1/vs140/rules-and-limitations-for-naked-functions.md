...
-   The <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> statement is not permitted.  
...
-   For the same reason, any form of <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> is prohibited.  
  
-   Use of the <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> function is prohibited.  
...
-   The <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> keyword is ignored when compiling with [/clr](../vs140/-clr--common-language-runtime-compilation-.md).  
