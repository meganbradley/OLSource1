...
## Remarks  
 Unlike the [AddString](../vs140/ccombobox--addstring.md) member function, the <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> member function does not cause a list with the [CBS_SORT](../vs140/combo-box-styles.md) style to be sorted.  
