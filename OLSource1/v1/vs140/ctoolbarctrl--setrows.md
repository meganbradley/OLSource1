...
## Remarks  
 ...
 Note also that the <CodeContentPlaceHolder>9\</CodeContentPlaceHolder> member function will always chose the layout that results in the smallest toolbar size. Creating a toolbar with the <CodeContentPlaceHolder>10\</CodeContentPlaceHolder> style and then resizing the control will simply apply the method outlined above given the width of the control.  
  
 This function can only be called for toolbars that were created with the <CodeContentPlaceHolder>11\</CodeContentPlaceHolder> style.  
