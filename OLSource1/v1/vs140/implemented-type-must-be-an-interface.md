...
An <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> statement does not specify an interface. A class can implement only an interface.  
...
2.  If the statement specifies a class, consider using the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> statement.  
