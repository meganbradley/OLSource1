...
## Remarks  
 ...
 If you need to restore the wait cursor while in a function other than the one in which the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> object is declared, you can call [CCmdTarget::RestoreWaitCursor](../vs140/ccmdtarget--restorewaitcursor.md).  
