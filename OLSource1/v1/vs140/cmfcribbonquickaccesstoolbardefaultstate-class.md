...
|Name|Description|  
|----------|-----------------|  
|[CMFCRibbonQuickAccessToolBarDefaultState::CMFCRibbonQuickAccessToolBarDefaultState](#cmfcribbonquickaccesstoolbardefaultstate__cmfcribbonquickaccesstoolbardefaultstate)|Constructs a <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> object.|  
...
## Example  
 The following example demonstrates how to construct an object of the <CodeContentPlaceHolder>6\</CodeContentPlaceHolder> class and how to add a command to the default state for the Quick Access Toolbar.  
  
 [!code[NVC_MFC_RibbonApp#21](../vs140/codesnippet/CPP/cmfcribbonquickaccesstoolbardefaultstate-class_1.cpp)]  
...
### Parameters  
 ...
 A reference to the source <CodeContentPlaceHolder>10\</CodeContentPlaceHolder> object to copy from.  
  
### Remarks  
 This method copies each command from the source <CodeContentPlaceHolder>11\</CodeContentPlaceHolder> object to this object by using the [CMFCRibbonQuickAccessToolBarDefaultState::AddCommand](#cmfcribbonquickaccesstoolbardefaultstate__addcommand) method.  
