...
## Bring up the localhost page in the browser  
 If IIS is not installed correctly, you should get errors when you type <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> in a browser.  
  
## Bring up the Web page in the browser  
 Start a Web browser and type the URL of the page you are trying to debug (for example: <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>). If IIS is not configured correctly, or your ASP.NET application is not deployed correctly, you should get errors that help you to fix your IIS setup and your ASP.NET deployment.  
