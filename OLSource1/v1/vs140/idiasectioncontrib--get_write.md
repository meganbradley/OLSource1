...
#### Parameters  
 ...
 [out] Returns <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> if the section can be written to; otherwise, returns <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>.  
