...
> [!NOTE]
>  For the debugger to attach to code written in C++, the code needs to emit <CodeContentPlaceHolder>0\</CodeContentPlaceHolder>. You can add this to your code automatically by linking with the [/ASSEMBLYDEBUG](../vs140/-assemblydebug--add-debuggableattribute-.md) linker option.  
