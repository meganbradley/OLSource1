...
## In This Section  
 ...
 A wrapper for <CodeContentPlaceHolder>0\</CodeContentPlaceHolder>.  
 ...
 Used only within an <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> handler in a <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>-derived class.  
 ...
 A wrapper for <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>.  
 ...
 A wrapper for <CodeContentPlaceHolder>5\</CodeContentPlaceHolder>.  
  
 [CD2DBrushProperties Class](../vs140/cd2dbrushproperties-class.md)  
 A wrapper for <CodeContentPlaceHolder>6\</CodeContentPlaceHolder>.  
  
 [CD2DEllipse Class](../vs140/cd2dellipse-class.md)  
 A wrapper for <CodeContentPlaceHolder>7\</CodeContentPlaceHolder>.  
  
 [CD2DGeometry Class](../vs140/cd2dgeometry-class.md)  
 A wrapper for <CodeContentPlaceHolder>8\</CodeContentPlaceHolder>.  
  
 [CD2DGeometrySink Class](../vs140/cd2dgeometrysink-class.md)  
 A wrapper for <CodeContentPlaceHolder>9\</CodeContentPlaceHolder>.  
  
 [CD2DGradientBrush Class](../vs140/cd2dgradientbrush-class.md)  
 The base class of the <CodeContentPlaceHolder>10\</CodeContentPlaceHolder> and the <CodeContentPlaceHolder>11\</CodeContentPlaceHolder> classes.  
  
 [CD2DLayer Class](../vs140/cd2dlayer-class.md)  
 A wrapper for <CodeContentPlaceHolder>12\</CodeContentPlaceHolder>.  
  
 [CD2DLinearGradientBrush Class](../vs140/cd2dlineargradientbrush-class.md)  
 A wrapper for <CodeContentPlaceHolder>13\</CodeContentPlaceHolder>.  
  
 [CD2DMesh Class](../vs140/cd2dmesh-class.md)  
 A wrapper for <CodeContentPlaceHolder>14\</CodeContentPlaceHolder>.  
  
 [CD2DPathGeometry Class](../vs140/cd2dpathgeometry-class.md)  
 A wrapper for <CodeContentPlaceHolder>15\</CodeContentPlaceHolder>.  
  
 [CD2DPointF Class](../vs140/cd2dpointf-class.md)  
 A wrapper for <CodeContentPlaceHolder>16\</CodeContentPlaceHolder>.  
  
 [CD2DPointU Class](../vs140/cd2dpointu-class.md)  
 A wrapper for <CodeContentPlaceHolder>17\</CodeContentPlaceHolder>.  
  
 [CD2DRadialGradientBrush Class](../vs140/cd2dradialgradientbrush-class.md)  
 A wrapper for <CodeContentPlaceHolder>18\</CodeContentPlaceHolder>.  
  
 [CD2DRectF Class](../vs140/cd2drectf-class.md)  
 A wrapper for <CodeContentPlaceHolder>19\</CodeContentPlaceHolder>.  
  
 [CD2DRectU Class](../vs140/cd2drectu-class.md)  
 A wrapper for <CodeContentPlaceHolder>20\</CodeContentPlaceHolder>.  
  
 [CD2DResource Class](../vs140/cd2dresource-class.md)  
 An abstract class that provides a interface for creating and managing <CodeContentPlaceHolder>21\</CodeContentPlaceHolder> resources such as brushes, layers, and texts.  
  
 [CD2DRoundedRect Class](../vs140/cd2droundedrect-class.md)  
 A wrapper for <CodeContentPlaceHolder>22\</CodeContentPlaceHolder>.  
  
 [CD2DSizeF Class](../vs140/cd2dsizef-class.md)  
 A wrapper for <CodeContentPlaceHolder>23\</CodeContentPlaceHolder>.  
  
 [CD2DSizeU Class](../vs140/cd2dsizeu-class.md)  
 A wrapper for <CodeContentPlaceHolder>24\</CodeContentPlaceHolder>.  
  
 [CD2DSolidColorBrush Class](../vs140/cd2dsolidcolorbrush-class.md)  
 A wrapper for <CodeContentPlaceHolder>25\</CodeContentPlaceHolder>.  
  
 [CD2DTextFormat Class](../vs140/cd2dtextformat-class.md)  
 A wrapper for <CodeContentPlaceHolder>26\</CodeContentPlaceHolder>.  
  
 [CD2DTextLayout Class](../vs140/cd2dtextlayout-class.md)  
 A wrapper for <CodeContentPlaceHolder>27\</CodeContentPlaceHolder>.  
 ...
 A wrapper for <CodeContentPlaceHolder>28\</CodeContentPlaceHolder>.  
 ...
 Provides docking support for <CodeContentPlaceHolder>29\</CodeContentPlaceHolder>-derived panes.  
 ...
 A serialized <CodeContentPlaceHolder>30\</CodeContentPlaceHolder> class that loads, unloads, or clears the state of one or more docking control bars in persistent memory (a file).  
  
 [CDocObjectServer Class](../vs140/cdocobjectserver-class.md)  
 Implements the additional OLE interfaces needed to make a normal <CodeContentPlaceHolder>31\</CodeContentPlaceHolder> server into a full DocObject server: <CodeContentPlaceHolder>32\</CodeContentPlaceHolder>, <CodeContentPlaceHolder>33\</CodeContentPlaceHolder>, <CodeContentPlaceHolder>34\</CodeContentPlaceHolder>, and <CodeContentPlaceHolder>35\</CodeContentPlaceHolder>.  
 ...
 In addition to providing the functionality of a Windows list box, the <CodeContentPlaceHolder>36\</CodeContentPlaceHolder> class lets the user move list box items, such as filenames, within the list box.  
 ...
 Implements the stock Font property and encapsulates the functionality of a Windows font object and the <CodeContentPlaceHolder>37\</CodeContentPlaceHolder> interface.  
 ...
 A wrapper for <CodeContentPlaceHolder>38\</CodeContentPlaceHolder>.  
 ...
 A dictionary collection class that maps unique <CodeContentPlaceHolder>39\</CodeContentPlaceHolder> objects to <CodeContentPlaceHolder>40\</CodeContentPlaceHolder> pointers.  
  
 [CMapStringToPtr Class](../vs140/cmapstringtoptr-class.md)  
 Supports maps of void pointers keyed by <CodeContentPlaceHolder>41\</CodeContentPlaceHolder> objects.  
  
 [CMapStringToString Class](../vs140/cmapstringtostring-class.md)  
 Supports maps of <CodeContentPlaceHolder>42\</CodeContentPlaceHolder> objects keyed by <CodeContentPlaceHolder>43\</CodeContentPlaceHolder> objects.  
  
 [CMapWordToOb Class](../vs140/cmapwordtoob-class.md)  
 Supports maps of <CodeContentPlaceHolder>44\</CodeContentPlaceHolder> pointers keyed by 16-bit words.  
 ...
 An encapsulation of the Windows <CodeContentPlaceHolder>45\</CodeContentPlaceHolder>.  
 ...
 The <CodeContentPlaceHolder>46\</CodeContentPlaceHolder> and [CMFCColorBar Class](../vs140/cmfccolorbar-class.md) classes are used together to implement a color picker control.  
 ...
 A tabbed pane with the visual appearance of the **Navigation Pane** in Microsoft Outlook 2000 or Outlook 2003. The <CodeContentPlaceHolder>47\</CodeContentPlaceHolder> object contains a [CMFCOutlookBarTabCtrl Class](../vs140/cmfcoutlookbartabctrl-class.md) object and a series of tabs. The tabs can be either [CMFCOutlookBarPane](../vs140/cmfcoutlookbarpane-class.md) objects or <CodeContentPlaceHolder>48\</CodeContentPlaceHolder>-derived objects. To the user, the Outlook bar appears as a series of buttons and a display area. When the user clicks a button, the corresponding control or button pane is displayed.  
 ...
 Implements a status bar similar to the <CodeContentPlaceHolder>49\</CodeContentPlaceHolder> class. However, the <CodeContentPlaceHolder>50\</CodeContentPlaceHolder> class has features not offered by the <CodeContentPlaceHolder>51\</CodeContentPlaceHolder> class, such as the ability to display images, animations, and progress bars; and the ability to respond to mouse double-clicks.  
 ...
 Contains the resource IDs of toolbar images in various states. <CodeContentPlaceHolder>54\</CodeContentPlaceHolder> is a helper class that is used as a parameter of the [CMFCToolBar::LoadToolBarEx](../vs140/cmfctoolbar--loadtoolbarex.md) method.  
 ...
 An extended tooltip implementation based on the [CToolTipCtrl Class](../vs140/ctooltipctrl-class.md). A tooltip based on the <CodeContentPlaceHolder>55\</CodeContentPlaceHolder> class can display an icon, a label, and a description. You can customize its visual appearance by using a gradient fill, custom text and border colors, bold text, rounded corners, or a balloon style.  
 ...
 Provides support for changing the appearance of your application at a global level. The <CodeContentPlaceHolder>56\</CodeContentPlaceHolder> class works together with a class that provides instructions to draw the GUI controls of your application using a consistent style. These other classes are referred to as visual managers and they inherit from <CodeContentPlaceHolder>57\</CodeContentPlaceHolder>.  
 ...
 Extends [CPaneFrameWnd Class](../vs140/cpaneframewnd-class.md). It can support multiple panes. Instead of a single embedded handle to a control bar, <CodeContentPlaceHolder>58\</CodeContentPlaceHolder> contains a [CPaneContainerManager Class](../vs140/cpanecontainermanager-class.md) object that enables the user to dock one <CodeContentPlaceHolder>59\</CodeContentPlaceHolder> to another and dynamically create multiple floating, tabbed windows.  
 ...
 The <CodeContentPlaceHolder>60\</CodeContentPlaceHolder> class represents the network address control, which you can use to input and validate the format of IPv4, IPv6, and named DNS addresses.  
 ...
 Supports arrays of <CodeContentPlaceHolder>61\</CodeContentPlaceHolder> pointers.  
  
 [CObject Class](../vs140/cobject-class.md)  
 The principal base class for the Microsoft Foundation Class Library.  
  
 [CObList Class](../vs140/coblist-class.md)  
 Supports ordered lists of non-unique <CodeContentPlaceHolder>62\</CodeContentPlaceHolder> pointers accessible sequentially or by pointer value.  
  
 [COccManager Class](../vs140/coccmanager-class.md)  
 Manages various custom control sites; implemented by <CodeContentPlaceHolder>63\</CodeContentPlaceHolder> and <CodeContentPlaceHolder>64\</CodeContentPlaceHolder> objects.  
 ...
 Implements a method for MFC to update the state of user-interface objects related to the <CodeContentPlaceHolder>65\</CodeContentPlaceHolder>-driven features of your application.  
 ...
 Encapsulates the <CodeContentPlaceHolder>66\</CodeContentPlaceHolder> data type of OLE automation.  
 ...
 Handles exceptions specific to the OLE <CodeContentPlaceHolder>67\</CodeContentPlaceHolder> interface, which is a key part of OLE automation.  
 ...
 Implements an OLE container that supports MFC. You must derive the in-place frame window class for your application from the <CodeContentPlaceHolder>68\</CodeContentPlaceHolder> class, instead of deriving it from the [COleIPFrameWnd](../vs140/coleipframewnd-class.md) class.  
 ...
 Represents a stream of data (<CodeContentPlaceHolder>69\</CodeContentPlaceHolder>) in a compound file as part of OLE Structured Storage.  
 ...
 The <CodeContentPlaceHolder>70\</CodeContentPlaceHolder> class wraps the Windows pager control, which can scroll into view a contained window that does not fit the containing window.  
 ...
 Enhancement of the [CControlBar Class](../vs140/ccontrolbar-class.md). If you are upgrading an existing MFC project, you need to replace all occurrences of <CodeContentPlaceHolder>71\</CodeContentPlaceHolder> with <CodeContentPlaceHolder>72\</CodeContentPlaceHolder>.  
  
 [CPaneContainer](../vs140/cpanecontainer-class.md)  
 Basic component of the docking model implemented by MFC. An object of this class stores pointers to two docking panes or to two instances of <CodeContentPlaceHolder>73\</CodeContentPlaceHolder> It also stores a pointer to the divider that separates the panes (or the containers). By nesting containers inside containers, the framework can build a binary tree that represents complex docking layouts. The root of the binary tree is stored in a [CPaneContainerManager Class](../vs140/cpanecontainermanager-class.md) object.  
 ...
 Similar to the Windows <CodeContentPlaceHolder>74\</CodeContentPlaceHolder> structure.  
 ...
 A wrapper for <CodeContentPlaceHolder>75\</CodeContentPlaceHolder>.  
 ...
 Derives from <CodeContentPlaceHolder>76\</CodeContentPlaceHolder>, and represents a higher level of abstraction of the Windows Sockets API.  
  
 [CSocketFile Class](../vs140/csocketfile-class.md)  
 A <CodeContentPlaceHolder>77\</CodeContentPlaceHolder> object used for sending and receiving data across a network via Windows Sockets.  
 ...
 Supports arrays of <CodeContentPlaceHolder>78\</CodeContentPlaceHolder> objects.  
  
 [CStringList Class](../vs140/cstringlist-class.md)  
 Supports lists of <CodeContentPlaceHolder>79\</CodeContentPlaceHolder> objects.  
 ...
 A pop-up dialog box that functions like a message box but can display additional information to the user. The <CodeContentPlaceHolder>80\</CodeContentPlaceHolder> also includes functionality for gathering information from the user.  
 ...
 Maintains runtime information about tooltips. The <CodeContentPlaceHolder>81\</CodeContentPlaceHolder> class is instantiated one time per application.  
 ...
 Provides a type-safe "wrapper" for objects of class <CodeContentPlaceHolder>82\</CodeContentPlaceHolder> or <CodeContentPlaceHolder>83\</CodeContentPlaceHolder>.  
  
 [CTypedPtrList Class](../vs140/ctypedptrlist-class.md)  
 Provides a type-safe "wrapper" for objects of class <CodeContentPlaceHolder>84\</CodeContentPlaceHolder>.  
  
 [CTypedPtrMap Class](../vs140/ctypedptrmap-class.md)  
 Provides a type-safe "wrapper" for objects of the pointer-map classes <CodeContentPlaceHolder>85\</CodeContentPlaceHolder>, <CodeContentPlaceHolder>86\</CodeContentPlaceHolder>, <CodeContentPlaceHolder>87\</CodeContentPlaceHolder>, and <CodeContentPlaceHolder>88\</CodeContentPlaceHolder>.  
 ...
 Derived from <CodeContentPlaceHolder>90\</CodeContentPlaceHolder>.  
