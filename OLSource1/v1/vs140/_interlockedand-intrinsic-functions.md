...
## Remarks  
 ...
 On ARM platforms, use the intrinsics with <CodeContentPlaceHolder>28\</CodeContentPlaceHolder> and <CodeContentPlaceHolder>29\</CodeContentPlaceHolder> suffixes for acquire and release semantics, such as at the beginning and end of a critical section. The intrinsics with an <CodeContentPlaceHolder>30\</CodeContentPlaceHolder> ("no fence") suffix do not act as a memory barrier.  
