 ...
 **key_compare** is a synonym for the template parameter <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>.  
 ...
 For more information on <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> see the [multimap Class](../vs140/multimap-class.md) topic.  
  
## Example  
 See the example for [key_comp](../vs140/multimap--key_comp.md) for an example of how to declare and use <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>.  
