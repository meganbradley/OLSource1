...
The `Key` keyword enables you to specify behavior for properties of anonymous types. Only properties you designate as key properties participate in tests of equality between anonymous type instances, or calculation of hash code values. The values of key properties cannot be changed.  
 ...
 When a new anonymous type is created, it inherits directly from <xref:System.Object*>. The compiler overrides three inherited members: [Equals](assetId:///M:System.Object.Equals(System.Object)?qualifyHint=False&autoUpgrade=True), <xref:System.Object.GetHashCode*>, and <xref:System.Object.ToString*>. The override code that is produced for assetId:///M:System.Object.Equals(System.Object)?qualifyHint=False&autoUpgrade=True and <xref:System.Object.GetHashCode*> is based on key properties. If there are no key properties in the type, <xref:System.Object.GetHashCode*> and assetId:///M:System.Object.Equals(System.Object)?qualifyHint=False&autoUpgrade=True are not overridden.  
...
## Hash Code Calculation  
 Like assetId:///M:System.Object.Equals(System.Object)?qualifyHint=False&autoUpgrade=True, the hash function that is defined in <xref:System.Object.GetHashCode*> for an anonymous type is based on the key properties of the type. The following examples show the interaction between key properties and hash code values.  
