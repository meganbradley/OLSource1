...
|Method|Description|  
|------------|-----------------|  
|[XElement](assetId:///M:System.Xml.Linq.XElement.#ctor(System.Xml.Linq.XElement)?qualifyHint=False&autoUpgrade=True)|Constructs an <xref:System.Xml.Linq.XElement*>.|  
|<xref:System.Xml.Linq.XDocument.#ctor*>|Constructs a <xref:System.Xml.Linq.XDocument*>.|  
|[Add](assetId:///M:System.Xml.Linq.XContainer.Add(System.Object)?qualifyHint=False&autoUpgrade=True)|Adds to the end of the child content of the <xref:System.Xml.Linq.XElement*> or <xref:System.Xml.Linq.XDocument*>.|  
|[AddAfterSelf](assetId:///M:System.Xml.Linq.XNode.AddAfterSelf(System.Object)?qualifyHint=False&autoUpgrade=True)|Adds content after the <xref:System.Xml.Linq.XNode*>.|  
|[AddBeforeSelf](assetId:///M:System.Xml.Linq.XNode.AddBeforeSelf(System.Object)?qualifyHint=False&autoUpgrade=True)|Adds content before the <xref:System.Xml.Linq.XNode*>.|  
|[AddFirst](assetId:///M:System.Xml.Linq.XContainer.AddFirst(System.Object)?qualifyHint=False&autoUpgrade=True)|Adds content at the beginning of the child content of the <xref:System.Xml.Linq.XContainer*>.|  
|[ReplaceAll](assetId:///M:System.Xml.Linq.XElement.ReplaceAll(System.Object)?qualifyHint=False&autoUpgrade=True)|Replaces all content (child nodes and attributes) of an <xref:System.Xml.Linq.XElement*>.|  
|[ReplaceAttributes](assetId:///M:System.Xml.Linq.XElement.ReplaceAttributes(System.Object)?qualifyHint=False&autoUpgrade=True)|Replaces the attributes of an <xref:System.Xml.Linq.XElement*>.|  
|[ReplaceNodes](assetId:///M:System.Xml.Linq.XContainer.ReplaceNodes(System.Object)?qualifyHint=False&autoUpgrade=True)|Replaces the children nodes with new content.|  
|[ReplaceWith](assetId:///M:System.Xml.Linq.XNode.ReplaceWith(System.Object)?qualifyHint=False&autoUpgrade=True)|Replaces a node with new content.|  
