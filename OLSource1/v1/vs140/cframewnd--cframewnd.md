...
dev_langs: 
  - "C++"
helpviewer_keywords: 
  - "CFrameWnd class, constructor"
  - "CFrameWnd class, construction/destruction"
...
---
# CFrameWnd::CFrameWnd
Constructs a <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> object, but does not create the visible frame window.  
