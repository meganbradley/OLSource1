...
-   **AdditionalManifestDependencies**  
     ...
     Specifies attributes that will be placed in the <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> section of the manifest file.  
...
-   **AllowIsolation**  
     ...
     If <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>, causes the operating system to do manifest lookups and loads. If <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>, indicates that DLLs are loaded as if there was no manifest.  
...
-   **AssemblyDebug**  
     ...
     If <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>, emits the **DebuggableAttribute** attribute together with debug information tracking and disables JIT optimizations. If <CodeContentPlaceHolder>4\</CodeContentPlaceHolder>, emits the **DebuggableAttribute** attribute but disables debug information tracking and enables JIT optimizations.  
...
-   **AttributeFileTracking**  
     ...
     Enables deeper file tracking to capture link incremental's behavior. Always returns <CodeContentPlaceHolder>5\</CodeContentPlaceHolder>.  
  
-   **BaseAddress**  
  
     Optional **String** parameter.  
  
     Sets a base address for the program or DLL being built. Specify <CodeContentPlaceHolder>6\</CodeContentPlaceHolder>.  
...
-   **DataExecutionPrevention**  
     ...
     If <CodeContentPlaceHolder>7\</CodeContentPlaceHolder>, indicates that an executable was tested to be compatible with the Windows Data Execution Prevention feature.  
...
-   **DelaySign**  
     ...
     If <CodeContentPlaceHolder>8\</CodeContentPlaceHolder>, partially signs an assembly. By default, the value is <CodeContentPlaceHolder>9\</CodeContentPlaceHolder>.  
...
-   **EnableCOMDATFolding**  
     ...
     If <CodeContentPlaceHolder>10\</CodeContentPlaceHolder>, enables identical COMDAT folding.  
  
     For more information, see the <CodeContentPlaceHolder>11\</CodeContentPlaceHolder> argument of [/OPT (Optimizations)](../vs140/-opt--optimizations-.md).  
  
-   **EnableUAC**  
  
     Optional **Boolean** parameter.  
  
     If <CodeContentPlaceHolder>12\</CodeContentPlaceHolder>, specifies that User Account Control (UAC) information is embedded in the program manifest.  
...
-   **FixedBaseAddress**  
     ...
     If <CodeContentPlaceHolder>13\</CodeContentPlaceHolder>, creates a program or DLL that can be loaded only at its preferred base address.  
...
-   **GenerateDebugInformation**  
     ...
     If <CodeContentPlaceHolder>14\</CodeContentPlaceHolder>, creates debugging information for the .exe file or DLL.  
...
-   **GenerateManifest**  
     ...
     If <CodeContentPlaceHolder>15\</CodeContentPlaceHolder>, creates a side-by-side manifest file.  
...
-   **GenerateMapFile**  
     ...
     If <CodeContentPlaceHolder>16\</CodeContentPlaceHolder>, creates a *map file*. The file name extension of the map file is .map.  
...
-   **HeapCommitSize**  
     ...
     For more information, see the <CodeContentPlaceHolder>17\</CodeContentPlaceHolder> argument in [/HEAP (Set Heap Size)](../vs140/-heap--set-heap-size-.md). Also, see the **HeapReserveSize** parameter.  
...
-   **HeapReserveSize**  
     ...
     For more information, see the <CodeContentPlaceHolder>18\</CodeContentPlaceHolder> argument in [/HEAP (Set Heap Size)](../vs140/-heap--set-heap-size-.md). Also, see the **HeapCommitSize** parameter in this table.  
  
-   **IgnoreAllDefaultLibraries**  
  
     Optional **Boolean** parameter.  
  
     If <CodeContentPlaceHolder>19\</CodeContentPlaceHolder>, tells the linker to remove one or more default libraries from the list of libraries it searches when it resolves external references.  
...
-   **IgnoreEmbeddedIDL**  
     ...
     If <CodeContentPlaceHolder>20\</CodeContentPlaceHolder>, specifies that any IDL attributes in source code should not be processed into an .idl file.  
...
-   **IgnoreImportLibrary**  
     ...
     If <CodeContentPlaceHolder>21\</CodeContentPlaceHolder>, specifies that the import library generated by this configuration should not be imported into dependent projects.  
...
-   **ImageHasSafeExceptionHandlers**  
     ...
     If <CodeContentPlaceHolder>22\</CodeContentPlaceHolder>, the linker produces an image only if it can also produce a table of the image's safe exception handlers.  
...
-   **LargeAddressAware**  
     ...
     If <CodeContentPlaceHolder>23\</CodeContentPlaceHolder>, the application can handle addresses larger than 2 gigabytes.  
...
-   **LinkDLL**  
     ...
     If <CodeContentPlaceHolder>24\</CodeContentPlaceHolder>, builds a DLL as the main output file.  
...
-   **LinkIncremental**  
     ...
     If <CodeContentPlaceHolder>25\</CodeContentPlaceHolder>, enables incremental linking.  
...
-   **LinkLibraryDependencies**  
     ...
     If <CodeContentPlaceHolder>26\</CodeContentPlaceHolder>, specifies that library outputs from project dependencies are automatically linked in.  
...
-   **LinkStatus**  
     ...
     If <CodeContentPlaceHolder>27\</CodeContentPlaceHolder>, specifies that the linker is to display a progress indicator that shows what percentage of the link is complete.  
  
     For more information, see the <CodeContentPlaceHolder>28\</CodeContentPlaceHolder> argument of [/LTCG (Link-time Code Generation)](../vs140/-ltcg--link-time-code-generation-.md).  
...
-   **MapExports**  
     ...
     If <CodeContentPlaceHolder>29\</CodeContentPlaceHolder>, tells the linker to include exported functions in a map file.  
  
     For more information, see the <CodeContentPlaceHolder>30\</CodeContentPlaceHolder> argument of [/MAPINFO (Include Information in Mapfile)](../vs140/-mapinfo--include-information-in-mapfile-.md).  
...
-   **MergeSections**  
     ...
     Combines sections in an image. Specify <CodeContentPlaceHolder>31\</CodeContentPlaceHolder>.  
...
-   **NoEntryPoint**  
     ...
     If <CodeContentPlaceHolder>32\</CodeContentPlaceHolder>, specifies a resource-only DLL.  
...
-   **OptimizeReferences**  
     ...
     If <CodeContentPlaceHolder>33\</CodeContentPlaceHolder>, eliminates functions and/or data that are never referenced.  
  
     For more information, see the <CodeContentPlaceHolder>34\</CodeContentPlaceHolder> argument in [/OPT (Optimizations)](../vs140/-opt--optimizations-.md).  
...
-   **PerUserRedirection**  
     ...
     If <CodeContentPlaceHolder>35\</CodeContentPlaceHolder> and Register Output is enabled, forces registry writes to **HKEY_CLASSES_ROOT** to be redirected to **HKEY_CURRENT_USER**.  
...
-   **PreventDllBinding**  
     ...
     If <CodeContentPlaceHolder>37\</CodeContentPlaceHolder>, indicates to Bind.exe that the linked image should not be bound.  
...
-   **Profile**  
     ...
     If <CodeContentPlaceHolder>38\</CodeContentPlaceHolder>, produces an output file that can be used with the **Performance Tools** profiler.  
...
-   **RandomizedBaseAddress**  
     ...
     If <CodeContentPlaceHolder>39\</CodeContentPlaceHolder>, generates an executable image that can be randomly rebased at load time by using the *address space layout randomization* (ASLR) feature of Windows.  
...
-   **RegisterOutput**  
     ...
     If <CodeContentPlaceHolder>40\</CodeContentPlaceHolder>, registers the primary output of this build.  
...
-   **SetChecksum**  
     ...
     If <CodeContentPlaceHolder>41\</CodeContentPlaceHolder>, sets the checksum in the header of an .exe file.  
...
-   **Sources**  
     ...
     Required <CodeContentPlaceHolder>42\</CodeContentPlaceHolder> parameter.  
...
-   **StackCommitSize**  
     ...
     For more information, see the <CodeContentPlaceHolder>43\</CodeContentPlaceHolder> argument of [/STACK (Stack Allocations)](../vs140/-stack--stack-allocations-.md).  
...
-   **StackReserveSize**  
     ...
     For more information, see the <CodeContentPlaceHolder>44\</CodeContentPlaceHolder> argument of [/STACK (Stack Allocations)](../vs140/-stack--stack-allocations-.md).  
...
-   **SupportNobindOfDelayLoadedDLL**  
     ...
     If <CodeContentPlaceHolder>45\</CodeContentPlaceHolder>, tells the linker not to include a bindable Import Address Table (IAT) in the final image.  
  
     For more information, see the <CodeContentPlaceHolder>46\</CodeContentPlaceHolder> argument of [/DELAY (Delay Load Import Settings)](../vs140/-delay--delay-load-import-settings-.md).  
  
-   **SupportUnloadOfDelayLoadedDLL**  
  
     Optional **Boolean** parameter.  
  
     If <CodeContentPlaceHolder>47\</CodeContentPlaceHolder>, tells the delay-load helper function to support explicit unloading of the DLL.  
  
     For more information, see the <CodeContentPlaceHolder>48\</CodeContentPlaceHolder> argument of [/DELAY (Delay Load Import Settings)](../vs140/-delay--delay-load-import-settings-.md).  
  
-   **SuppressStartupBanner**  
  
     Optional **Boolean** parameter.  
  
     If <CodeContentPlaceHolder>49\</CodeContentPlaceHolder>, prevents the display of the copyright and version number message when the task starts.  
...
-   **SwapRunFromCD**  
     ...
     If <CodeContentPlaceHolder>50\</CodeContentPlaceHolder>, tells the operating system to first copy the linker output to a swap file, and then run the image from there.  
  
     For more information, see the <CodeContentPlaceHolder>51\</CodeContentPlaceHolder> argument of [/SWAPRUN (Load Linker Output to Swap File)](../vs140/-swaprun--load-linker-output-to-swap-file-.md). Also, see the **SwapRunFromNET** parameter.  
  
-   **SwapRunFromNET**  
  
     Optional **Boolean** parameter.  
  
     If <CodeContentPlaceHolder>52\</CodeContentPlaceHolder>, tells the operating system to first copy the linker output to a swap file, and then run the image from there.  
  
     For more information, see the <CodeContentPlaceHolder>53\</CodeContentPlaceHolder> argument of [/SWAPRUN (Load Linker Output to Swap File)](../vs140/-swaprun--load-linker-output-to-swap-file-.md). Also, see the **SwapRunFromCD** parameter in this table.  
...
-   **TerminalServerAware**  
     ...
     If <CodeContentPlaceHolder>54\</CodeContentPlaceHolder>, sets a flag in the IMAGE_OPTIONAL_HEADER DllCharacteristics field in the program image's optional header. When this flag is set, Terminal Server will not make certain changes to the application.  
...
-   **TreatLinkerWarningAsErrors**  
     ...
     If <CodeContentPlaceHolder>55\</CodeContentPlaceHolder>, causes no output file to be generated if the linker generates a warning.  
...
-   **TurnOffAssemblyGeneration**  
     ...
     If <CodeContentPlaceHolder>56\</CodeContentPlaceHolder>, creates an image for the current output file without a .NET Framework assembly.  
...
-   **UACExecutionLevel**  
    ...
    -   **AsInvoker** - <CodeContentPlaceHolder>57\</CodeContentPlaceHolder>  
  
    -   **HighestAvailable** - <CodeContentPlaceHolder>58\</CodeContentPlaceHolder>  
  
    -   **RequireAdministrator** - <CodeContentPlaceHolder>59\</CodeContentPlaceHolder>  
  
     For more information, see the <CodeContentPlaceHolder>60\</CodeContentPlaceHolder> argument of [/MANIFESTUAC (Embeds UAC information in manifest)](../vs140/-manifestuac--embeds-uac-information-in-manifest-.md).  
  
-   **UACUIAccess**  
  
     Optional **Boolean** parameter.  
  
     If <CodeContentPlaceHolder>61\</CodeContentPlaceHolder>, the application bypasses user interface protection levels and drives input to higher-permission windows on the desktop; otherwise, <CodeContentPlaceHolder>62\</CodeContentPlaceHolder>.  
  
     For more information, see the <CodeContentPlaceHolder>63\</CodeContentPlaceHolder> argument of [/MANIFESTUAC (Embeds UAC information in manifest)](../vs140/-manifestuac--embeds-uac-information-in-manifest-.md).  
  
-   **UseLibraryDependencyInputs**  
  
     Optional **Boolean** parameter.  
  
     If <CodeContentPlaceHolder>64\</CodeContentPlaceHolder>, the inputs to the librarian tool are used rather than the library file itself when library outputs of project dependencies are linked in.  
  
-   **Version**  
  
     Optional **String** parameter.  
  
     Put a version number in the header of the .exe or .dll file. Specify "<CodeContentPlaceHolder>65\</CodeContentPlaceHolder>". The <CodeContentPlaceHolder>66\</CodeContentPlaceHolder> and <CodeContentPlaceHolder>67\</CodeContentPlaceHolder> arguments are decimal numbers from 0 through 65535.  
