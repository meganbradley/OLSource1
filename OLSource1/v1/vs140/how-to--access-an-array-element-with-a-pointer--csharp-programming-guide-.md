...
<CodeContentPlaceHolder>0\</CodeContentPlaceHolder>  
 The expression in square brackets must be implicitly convertible to <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>, <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>, <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>, or <CodeContentPlaceHolder>4\</CodeContentPlaceHolder>. The operation p[e] is equivalent to *(p+e). Like C and C++, the pointer element access does not check for out-of-bounds errors.  
  
## Example  
 In this example, 123 memory locations are allocated to a character array, <CodeContentPlaceHolder>5\</CodeContentPlaceHolder>. The array is used to display the lowercase letters and the uppercase letters in two [for](../vs140/for--csharp-reference-.md) loops.  
  
 Notice that the expression <CodeContentPlaceHolder>6\</CodeContentPlaceHolder> is equivalent to the expression <CodeContentPlaceHolder>7\</CodeContentPlaceHolder>, and you can obtain the same result by using either of the two expressions.  
