...
## Return Value  
 A <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> structure that specifies the size of locked toolbar images or an empty <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> structure if the toolbar is not locked.  
