...
> [!NOTE]
>  There are no extensibility interfaces to create or edit the solution configurations. You must use <CodeContentPlaceHolder>0\</CodeContentPlaceHolder>. However, there are extensibility APIs for managing the solution build. For more information, see \<xref:Microsoft.VisualStudio.Shell.Interop.IVsSolutionBuildManager2*>.  
