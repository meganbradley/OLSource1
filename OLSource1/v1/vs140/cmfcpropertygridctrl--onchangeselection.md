...
|---------------|-----------------|  
|[in] <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>|Pointer to the newly selected property.|  
|[in] <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>|Pointer to the previously selected property.|  
