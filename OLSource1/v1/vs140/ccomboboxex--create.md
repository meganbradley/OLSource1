...
#### Parameters  
 ...
 A pointer to a [CWnd](../vs140/cwnd-class.md) object that is the parent window of the combo box (usually a <CodeContentPlaceHolder>5\</CodeContentPlaceHolder>). It must not be **NULL**.  
...
## Remarks  
 Create a <CodeContentPlaceHolder>7\</CodeContentPlaceHolder> object in two steps:  
  
1.  Call [CComboBoxEx](../vs140/ccomboboxex--ccomboboxex.md) to construct a <CodeContentPlaceHolder>8\</CodeContentPlaceHolder> object.  
  
2.  Call this member function, which creates the extended Windows combo box and attaches it to the <CodeContentPlaceHolder>9\</CodeContentPlaceHolder> object.  
