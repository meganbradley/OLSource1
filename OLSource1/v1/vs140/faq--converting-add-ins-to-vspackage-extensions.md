...
-   Triggered by a menu command (the code is in the <CodeContentPlaceHolder>16\</CodeContentPlaceHolder> method)  
  
-   Automatically on startup (the code is in the <CodeContentPlaceHolder>17\</CodeContentPlaceHolder> event handler.)  
...
3.  Add the following <CodeContentPlaceHolder>18\</CodeContentPlaceHolder> statements to the file:  
  
<CodeContentPlaceHolder>0\</CodeContentPlaceHolder>  
4.  Find the <CodeContentPlaceHolder>19\</CodeContentPlaceHolder> method. Add a call to \<xref:Microsoft.VisualStudio.Shell.Package.GetService*> to get the \<xref:EnvDTE80.DTE2*> object:  
  
<CodeContentPlaceHolder>1\</CodeContentPlaceHolder>  
5.  Add the code that your add-in had in its <CodeContentPlaceHolder>20\</CodeContentPlaceHolder> method. For example, here is some code that adds a new pane to the **Output** window and prints "Some Text" in the new pane.  
...
4.  Set a breakpoint in the <CodeContentPlaceHolder>21\</CodeContentPlaceHolder> method and start debugging (F5).  
  
5.  In the experimental instance, open a project. The VSPackage should load, and your breakpoint should be hit.  
  
 You can specify other contexts in which to load your VSPackage by using the fields of \<xref:Microsoft.VisualStudio.Shell.Interop.UIContextGuids80*>. For more information, see [How to: Autoload a VSPackage](../vs140/loading-vspackages.md).  
...
2.  Add these <CodeContentPlaceHolder>22\</CodeContentPlaceHolder> statements:  
  
<CodeContentPlaceHolder>5\</CodeContentPlaceHolder>  
3.  Find the <CodeContentPlaceHolder>23\</CodeContentPlaceHolder> method. This method handles the command you specified in the package wizard. Add a call to \<xref:Microsoft.VisualStudio.Shell.Package.GetService*> to get the DTE object:  
...
## How do I manage Visual Studio windows in the VSPackage way?  
 If your add-in manages Visual Studio windows, the add-in code should work in a VSPackage. For example, this procedure shows how to add code that manages the **Task List** to the <CodeContentPlaceHolder>24\</CodeContentPlaceHolder> method of the VSPackage.  
...
3.  Add these <CodeContentPlaceHolder>25\</CodeContentPlaceHolder> statements:  
  
<CodeContentPlaceHolder>7\</CodeContentPlaceHolder>  
4.  Find the <CodeContentPlaceHolder>26\</CodeContentPlaceHolder> method. Add a call to \<xref:Microsoft.VisualStudio.Shell.Package.GetService*> to get the \<xref:EnvDTE80.DTE2*> object:  
...
3.  Add these <CodeContentPlaceHolder>27\</CodeContentPlaceHolder> statements:  
  
<CodeContentPlaceHolder>10\</CodeContentPlaceHolder>  
4.  Find the <CodeContentPlaceHolder>28\</CodeContentPlaceHolder> method. Add a call to \<xref:Microsoft.VisualStudio.Shell.Package.GetService*> to get the \<xref:EnvDTE80.DTE2*> object:  
...
## How do I set keyboard shortcuts in a VSPackage?  
 You use the <CodeContentPlaceHolder>29\</CodeContentPlaceHolder> element of the .vsct file. In the following example, the keyboard shortcut for the command <CodeContentPlaceHolder>30\</CodeContentPlaceHolder> is Alt+A, and the keyboard shortcut for the command <CodeContentPlaceHolder>31\</CodeContentPlaceHolder> is Alt+Ctrl+A. Notice the syntax for the key names.  
  
<CodeContentPlaceHolder>13\</CodeContentPlaceHolder>  
## How do I handle automation events in a VSPackage?  
 You handle automation events in a VSPackage in the same way as in your add-in. The following code shows how to handle the <CodeContentPlaceHolder>32\</CodeContentPlaceHolder> event. (This example assumes that you've already gotten the DTE object.)  
