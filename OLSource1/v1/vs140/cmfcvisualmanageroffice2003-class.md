...
---
# CMFCVisualManagerOffice2003 Class
<CodeContentPlaceHolder>86\</CodeContentPlaceHolder> gives an application a Microsoft Office 2003 appearance.  
...
|[CMFCVisualManagerOffice2003::GetPropertyGridGroupColor](#cmfcvisualmanageroffice2003__getpropertygridgroupcolor)|The framework calls this method to get the background color of a property list. (Overrides <CodeContentPlaceHolder>87\</CodeContentPlaceHolder>.)|  
|[CMFCVisualManagerOffice2003::GetPropertyGridGroupTextColor](#cmfcvisualmanageroffice2003__getpropertygridgrouptextcolor)|The framework calls this method to retrieve the text color of a property list. (Overrides <CodeContentPlaceHolder>88\</CodeContentPlaceHolder>.)|  
...
|[CMFCVisualManagerOffice2003::GetSmartDockingBaseGuideColors](#cmfcvisualmanageroffice2003__getsmartdockingbaseguidecolors)|Sets the specified base group background color and border color. (Overrides <CodeContentPlaceHolder>89\</CodeContentPlaceHolder>.)|  
...
|[CMFCVisualManagerOffice2003::GetToolBarCustomizeButtonMargin](#cmfcvisualmanageroffice2003__gettoolbarcustomizebuttonmargin)|Gets the margin of the toolbar Customize button. (Overrides <CodeContentPlaceHolder>90\</CodeContentPlaceHolder>.)|  
|[CMFCVisualManagerOffice2003::GetToolbarDisabledColor](#cmfcvisualmanageroffice2003__gettoolbardisabledcolor)|Gets the disabled color for the toolbar. (Overrides <CodeContentPlaceHolder>91\</CodeContentPlaceHolder>.)|  
...
|[CMFCVisualManagerOffice2003::IsHighlightOneNoteTabs](#cmfcvisualmanageroffice2003__ishighlightonenotetabs)|Indicates whether OneNote tabs should be highlighted. (Overrides <CodeContentPlaceHolder>92\</CodeContentPlaceHolder>.)|  
|[CMFCVisualManagerOffice2003::IsOffsetPressedButton](#cmfcvisualmanageroffice2003__isoffsetpressedbutton)|Called by the framework when drawing a toolbar button. (Overrides <CodeContentPlaceHolder>93\</CodeContentPlaceHolder>.)|  
...
|[CMFCVisualManagerOffice2003::OnDrawBarGripper](#cmfcvisualmanageroffice2003__ondrawbargripper)|Called by the framework when it draws the gripper for a control bar. (Overrides <CodeContentPlaceHolder>94\</CodeContentPlaceHolder>.)|  
|[CMFCVisualManagerOffice2003::OnDrawBrowseButton](#cmfcvisualmanageroffice2003__ondrawbrowsebutton)|The framework calls this method when it draws the browse button for an edit control. (Overrides <CodeContentPlaceHolder>95\</CodeContentPlaceHolder>.)|  
|[CMFCVisualManagerOffice2003::OnDrawButtonBorder](#cmfcvisualmanageroffice2003__ondrawbuttonborder)|The framework calls this method when it draws the border of a toolbar button. (Overrides <CodeContentPlaceHolder>96\</CodeContentPlaceHolder>.)|  
...
|[CMFCVisualManagerOffice2003::OnDrawComboBorder](#cmfcvisualmanageroffice2003__ondrawcomboborder)|The framework calls this method when it draws the border around a [CMFCToolBarComboBoxButton](../vs140/cmfctoolbarcomboboxbutton-class.md) object. (Overrides <CodeContentPlaceHolder>97\</CodeContentPlaceHolder>.)|  
|[CMFCVisualManagerOffice2003::OnDrawComboDropButton](#cmfcvisualmanageroffice2003__ondrawcombodropbutton)|The framework calls this method when it draws the drop button of a [CMFCToolBarComboBoxButton](../vs140/cmfctoolbarcomboboxbutton-class.md). (Overrides <CodeContentPlaceHolder>98\</CodeContentPlaceHolder>.)|  
...
|[CMFCVisualManagerOffice2003::OnDrawMenuBorder](#cmfcvisualmanageroffice2003__ondrawmenuborder)|The framework calls this method when it draws the border of a [CMFCPopupMenu](../vs140/cmfcpopupmenu-class.md). (Overrides <CodeContentPlaceHolder>99\</CodeContentPlaceHolder>.)|  
...
|[CMFCVisualManagerOffice2003::OnDrawPaneBorder](#cmfcvisualmanageroffice2003__ondrawpaneborder)|The framework calls this method when it draws the border of a [CPane](../vs140/cpane-class.md) object. (Overrides <CodeContentPlaceHolder>100\</CodeContentPlaceHolder>.)|  
|[CMFCVisualManagerOffice2003::OnDrawPaneCaption](#cmfcvisualmanageroffice2003__ondrawpanecaption)|The framework calls this method when it draws a caption for a [CDockablePane](../vs140/cdockablepane-class.md) object. (Overrides <CodeContentPlaceHolder>101\</CodeContentPlaceHolder>.)|  
|[CMFCVisualManagerOffice2003::OnDrawPopupWindowBorder](#cmfcvisualmanageroffice2003__ondrawpopupwindowborder)|The framework calls this method when it draws the border of a popup window. (Overrides <CodeContentPlaceHolder>102\</CodeContentPlaceHolder>.)|  
|[CMFCVisualManagerOffice2003::OnDrawPopupWindowButtonBorder](#cmfcvisualmanageroffice2003__ondrawpopupwindowbuttonborder)|The framework calls this method when it draws the border of a button in a popup window. (Overrides <CodeContentPlaceHolder>103\</CodeContentPlaceHolder>.)|  
|[CMFCVisualManagerOffice2003::OnDrawPopupWindowCaption](#cmfcvisualmanageroffice2003__ondrawpopupwindowcaption)|The framework calls this method when it draws the caption of a popup window. (Overrides <CodeContentPlaceHolder>104\</CodeContentPlaceHolder>.)|  
...
|[CMFCVisualManagerOffice2003::OnDrawRibbonQuickAccessToolBarSeparator](#cmfcvisualmanageroffice2003__ondrawribbonquickaccesstoolbarseparator)|The framework calls this method when it draws a separator on the Quick Access Toolbar of a ribbon. (Overrides <CodeContentPlaceHolder>105\</CodeContentPlaceHolder>.)|  
...
|[CMFCVisualManagerOffice2003::OnDrawRibbonStatusBarPane](#cmfcvisualmanageroffice2003__ondrawribbonstatusbarpane)|The framework calls this method when it draws a pane on the status bar. (Overrides <CodeContentPlaceHolder>106\</CodeContentPlaceHolder>.)|  
|[CMFCVisualManagerOffice2003::OnDrawScrollButtons](#cmfcvisualmanageroffice2003__ondrawscrollbuttons)|The framework calls this method when it draws scroll buttons. (Overrides <CodeContentPlaceHolder>107\</CodeContentPlaceHolder>.)|  
|[CMFCVisualManagerOffice2003::OnDrawSeparator](#cmfcvisualmanageroffice2003__ondrawseparator)|The framework calls this method when it draws a separator. (Overrides <CodeContentPlaceHolder>108\</CodeContentPlaceHolder>.)|  
...
|[CMFCVisualManagerOffice2003::OnDrawStatusBarPaneBorder](#cmfcvisualmanageroffice2003__ondrawstatusbarpaneborder)|The framework calls this method when it draws the border for a [CMFCStatusBar](../vs140/cmfcstatusbar-class.md) object. (Overrides <CodeContentPlaceHolder>109\</CodeContentPlaceHolder>.)|  
...
|[CMFCVisualManagerOffice2003::OnDrawTab](#cmfcvisualmanageroffice2003__ondrawtab)|The framework calls this method when it draws the tabs for a [CMFCBaseTabCtrl](../vs140/cmfcbasetabctrl-class.md) object. (Overrides <CodeContentPlaceHolder>110\</CodeContentPlaceHolder>.)|  
|[CMFCVisualManagerOffice2003::OnDrawTabsButtonBorder](#cmfcvisualmanageroffice2003__ondrawtabsbuttonborder)|The framework calls this method when it draws the border of a tab button. (Overrides <CodeContentPlaceHolder>111\</CodeContentPlaceHolder>.)|  
|[CMFCVisualManagerOffice2003::OnDrawTask](#cmfcvisualmanageroffice2003__ondrawtask)|The framework calls this method when it draws a [CMFCTasksPaneTask](../vs140/cmfctaskspanetask-class.md) object. (Overrides <CodeContentPlaceHolder>112\</CodeContentPlaceHolder>.)|  
|[CMFCVisualManagerOffice2003::OnDrawTasksGroupAreaBorder](#cmfcvisualmanageroffice2003__ondrawtasksgroupareaborder)|The framework calls this method when it draws a border around a group on a [CMFCTasksPane](../vs140/cmfctaskspane-class.md) object. (Overrides <CodeContentPlaceHolder>113\</CodeContentPlaceHolder>.)|  
|[CMFCVisualManagerOffice2003::OnDrawTasksGroupCaption](#cmfcvisualmanageroffice2003__ondrawtasksgroupcaption)|The framework calls this method when it draws the caption for a [CMFCTasksPaneTaskGroup](../vs140/cmfctaskspanetaskgroup-class.md) object. (Overrides <CodeContentPlaceHolder>114\</CodeContentPlaceHolder>.)|  
|[CMFCVisualManagerOffice2003::OnDrawTearOffCaption](#cmfcvisualmanageroffice2003__ondrawtearoffcaption)|The framework calls this method when it draws the caption for a [CMFCPopupMenu](../vs140/cmfcpopupmenu-class.md) object. (Overrides <CodeContentPlaceHolder>115\</CodeContentPlaceHolder>.)|  
|[CMFCVisualManagerOffice2003::OnErasePopupWindowButton](#cmfcvisualmanageroffice2003__onerasepopupwindowbutton)|The framework calls this method when it erases a button in a popup window. (Overrides <CodeContentPlaceHolder>116\</CodeContentPlaceHolder>.)|  
|[CMFCVisualManagerOffice2003::OnEraseTabsArea](#cmfcvisualmanageroffice2003__onerasetabsarea)|The framework calls this method when it erases the tab area of a tab window. (Overrides <CodeContentPlaceHolder>117\</CodeContentPlaceHolder>.)|  
|[CMFCVisualManagerOffice2003::OnEraseTabsButton](#cmfcvisualmanageroffice2003__onerasetabsbutton)|The framework calls this method when it erases the text and icon of a tab button. (Overrides <CodeContentPlaceHolder>118\</CodeContentPlaceHolder>.)|  
...
|[CMFCVisualManagerOffice2003::OnFillBarBackground](#cmfcvisualmanageroffice2003__onfillbarbackground)|The framework calls this method when it fills the background of a [CBasePane](../vs140/cbasepane-class.md) object. (Overrides <CodeContentPlaceHolder>119\</CodeContentPlaceHolder>.)|  
|[CMFCVisualManagerOffice2003::OnFillButtonInterior](#cmfcvisualmanageroffice2003__onfillbuttoninterior)|The framework calls this method when it fills the background of a toolbar button. (Overrides <CodeContentPlaceHolder>120\</CodeContentPlaceHolder>.)|  
|[CMFCVisualManagerOffice2003::OnFillCommandsListBackground](#cmfcvisualmanageroffice2003__onfillcommandslistbackground)|The framework calls this method when it fills the background of a toolbar button that belongs to a command list. (Overrides <CodeContentPlaceHolder>121\</CodeContentPlaceHolder>.)|  
...
|[CMFCVisualManagerOffice2003::OnFillHighlightedArea](#cmfcvisualmanageroffice2003__onfillhighlightedarea)|The framework calls this method when it fills the highlighted area of a toolbar button. (Overrides <CodeContentPlaceHolder>122\</CodeContentPlaceHolder>.)|  
...
|[CMFCVisualManagerOffice2003::OnFillPopupWindowBackground](#cmfcvisualmanageroffice2003__onfillpopupwindowbackground)|The framework calls this method when it fills the background of a pop-up window. (Overrides <CodeContentPlaceHolder>123\</CodeContentPlaceHolder>.)|  
|[CMFCVisualManagerOffice2003::OnFillTab](#cmfcvisualmanageroffice2003__onfilltab)|The framework calls this method when it fills the background of a tab window. (Overrides <CodeContentPlaceHolder>124\</CodeContentPlaceHolder>.)|  
|[CMFCVisualManagerOffice2003::OnFillTasksGroupInterior](#cmfcvisualmanageroffice2003__onfilltasksgroupinterior)|The framework calls this method when it fills the interior of a [CMFCTasksPaneTaskGroup](../vs140/cmfctaskspanetaskgroup-class.md) object. (Overrides <CodeContentPlaceHolder>125\</CodeContentPlaceHolder>.)|  
...
|[CMFCVisualManagerOffice2003::OnHighlightQuickCustomizeMenuButton](#cmfcvisualmanageroffice2003__onhighlightquickcustomizemenubutton)|The framework calls this method when it draws a highlighted quick-customize menu button. (Overrides <CodeContentPlaceHolder>126\</CodeContentPlaceHolder>.)|  
|[CMFCVisualManagerOffice2003::OnHighlightRarelyUsedMenuItems](#cmfcvisualmanageroffice2003__onhighlightrarelyusedmenuitems)|The framework calls this method when it draws a highlighted menu command. (Overrides <CodeContentPlaceHolder>127\</CodeContentPlaceHolder>.)|  
|[CMFCVisualManagerOffice2003::OnUpdateSystemColors](#cmfcvisualmanageroffice2003__onupdatesystemcolors)|The framework calls this function when the system colors change. (Overrides <CodeContentPlaceHolder>128\</CodeContentPlaceHolder>.)|  
...
## Remarks  
 You use the <CodeContentPlaceHolder>129\</CodeContentPlaceHolder> class to change the visual appearance of your application to resemble Microsoft Office 2003.  
...
### Return Value  
 Returns <CodeContentPlaceHolder>135\</CodeContentPlaceHolder> if the theme API is enabled or <CodeContentPlaceHolder>136\</CodeContentPlaceHolder> if not.  
...
### Return Value  
 Returns <CodeContentPlaceHolder>142\</CodeContentPlaceHolder> if the theme API is enabled or <CodeContentPlaceHolder>143\</CodeContentPlaceHolder> if not.  
...
### Parameters  
 ...
 <CodeContentPlaceHolder>147\</CodeContentPlaceHolder> if the button is horizontal, or <CodeContentPlaceHolder>148\</CodeContentPlaceHolder> if it is vertical.  
 ...
 <CodeContentPlaceHolder>151\</CodeContentPlaceHolder> if the customize arrow-down or arrow-left image should be drawn in the button rectangle, or <CodeContentPlaceHolder>152\</CodeContentPlaceHolder> if not.  
  
 [in] <CodeContentPlaceHolder>153\</CodeContentPlaceHolder>  
 <CodeContentPlaceHolder>154\</CodeContentPlaceHolder> if the horizontal or vertical customize More-Buttons image should be drawn in the button rectangle, or <CodeContentPlaceHolder>155\</CodeContentPlaceHolder> if not.  
...
### Parameters  
 ...
 Ignored. The state is taken from <CodeContentPlaceHolder>160\</CodeContentPlaceHolder>.  
  
### Return Value  
 <CodeContentPlaceHolder>161\</CodeContentPlaceHolder> if the Theme API is enabled; otherwise <CodeContentPlaceHolder>162\</CodeContentPlaceHolder>.  
...
### Return Value  
 Returns the background color of <CodeContentPlaceHolder>164\</CodeContentPlaceHolder>.  
...
### Parameters  
 ...
 [out] <CodeContentPlaceHolder>171\</CodeContentPlaceHolder>  
 ...
 [out] <CodeContentPlaceHolder>172\</CodeContentPlaceHolder>  
 A reference to a <CodeContentPlaceHolder>173\</CodeContentPlaceHolder> parameter where this method stores the color for the border of the tab window. The default color for the border is black.  
  
 [out] <CodeContentPlaceHolder>174\</CodeContentPlaceHolder>  
 A reference to a <CodeContentPlaceHolder>175\</CodeContentPlaceHolder> parameter where this method stores the color for the highlight state of the tab window.  
  
 [out] <CodeContentPlaceHolder>176\</CodeContentPlaceHolder>  
 A reference to a <CodeContentPlaceHolder>177\</CodeContentPlaceHolder> parameter where this method stores the color for face of the tab window.  
  
 [out] <CodeContentPlaceHolder>178\</CodeContentPlaceHolder>  
 A reference to a <CodeContentPlaceHolder>179\</CodeContentPlaceHolder> parameter where this method stores the color for the shadow of the tab window.  
  
 [out] <CodeContentPlaceHolder>180\</CodeContentPlaceHolder>  
 A reference to a <CodeContentPlaceHolder>181\</CodeContentPlaceHolder> parameter where this method stores the color for the light edge of the tab window.  
  
 [out] <CodeContentPlaceHolder>182\</CodeContentPlaceHolder>  
 ...
 [out] <CodeContentPlaceHolder>183\</CodeContentPlaceHolder>  
...
### Parameters  
 [out] <CodeContentPlaceHolder>184\</CodeContentPlaceHolder>  
...
### Return Value  
 Returns <CodeContentPlaceHolder>186\</CodeContentPlaceHolder> if tooltip information is returned, and <CodeContentPlaceHolder>187\</CodeContentPlaceHolder> otherwise.  
...
### Return Value  
 <CodeContentPlaceHolder>188\</CodeContentPlaceHolder> if the visual manager uses native colors; otherwise, <CodeContentPlaceHolder>189\</CodeContentPlaceHolder>.  
...
### Return Value  
 <CodeContentPlaceHolder>190\</CodeContentPlaceHolder> if the visual manager draws borders around panes that are docked and tabbed; <CodeContentPlaceHolder>191\</CodeContentPlaceHolder> otherwise.  
...
### Return Value  
 Returns <CodeContentPlaceHolder>192\</CodeContentPlaceHolder>.  
...
### Remarks  
 The default implementation returns <CodeContentPlaceHolder>193\</CodeContentPlaceHolder>.  
...
### Remarks  
 Returns <CodeContentPlaceHolder>194\</CodeContentPlaceHolder> if there is a status bar with an Office XP look, or <CodeContentPlaceHolder>195\</CodeContentPlaceHolder> if not.  
...
### Return Value  
 Returns <CodeContentPlaceHolder>197\</CodeContentPlaceHolder> if the toolbar is round, or <CodeContentPlaceHolder>198\</CodeContentPlaceHolder> if it is a menu bar.  
...
### Return Value  
 <CodeContentPlaceHolder>199\</CodeContentPlaceHolder> if the visual manager uses a Windows XP theme; otherwise, <CodeContentPlaceHolder>200\</CodeContentPlaceHolder>.  
...
### Return Value  
 Returns <CodeContentPlaceHolder>201\</CodeContentPlaceHolder> if Windows theming is supported, or <CodeContentPlaceHolder>202\</CodeContentPlaceHolder> if not.  
...
### Remarks  
 ...
 The <CodeContentPlaceHolder>207\</CodeContentPlaceHolder> parameter does not contain the coordinates of the border. It contains the size of the border in the <CodeContentPlaceHolder>208\</CodeContentPlaceHolder>, <CodeContentPlaceHolder>209\</CodeContentPlaceHolder>, <CodeContentPlaceHolder>210\</CodeContentPlaceHolder>, and <CodeContentPlaceHolder>211\</CodeContentPlaceHolder> data members. A value less than or equal to 0 indicates no border on that side of the auto-hide button.  
...
### Remarks  
 ...
 The possible states of a toolbar button are <CodeContentPlaceHolder>225\</CodeContentPlaceHolder>, <CodeContentPlaceHolder>226\</CodeContentPlaceHolder>, or <CodeContentPlaceHolder>227\</CodeContentPlaceHolder>.  
...
### Parameters  
 ...
 <CodeContentPlaceHolder>233\</CodeContentPlaceHolder> if the border should have a flat, 2D appearance, or <CodeContentPlaceHolder>234\</CodeContentPlaceHolder> if not.  
...
### Parameters  
 ...
 <CodeContentPlaceHolder>239\</CodeContentPlaceHolder> if the checkbox is highlighted, or <CodeContentPlaceHolder>240\</CodeContentPlaceHolder> if not.  
  
 [in] <CodeContentPlaceHolder>241\</CodeContentPlaceHolder>  
 <CodeContentPlaceHolder>242\</CodeContentPlaceHolder> if the checkbox is pressed, or <CodeContentPlaceHolder>243\</CodeContentPlaceHolder> if not.  
  
 [in] <CodeContentPlaceHolder>244\</CodeContentPlaceHolder>  
 <CodeContentPlaceHolder>245\</CodeContentPlaceHolder> if the checkbox is enabled, or <CodeContentPlaceHolder>246\</CodeContentPlaceHolder> if not.  
...
### Parameters  
 ...
 A pointer to a <CodeContentPlaceHolder>253\</CodeContentPlaceHolder> object. The framework draws this combo box button.  
...
### Parameters  
 ...
 A pointer to a <CodeContentPlaceHolder>260\</CodeContentPlaceHolder> object. The framework draws the drop button for this combo box button  
...
### Parameters  
 ...
 <CodeContentPlaceHolder>265\</CodeContentPlaceHolder> if the box to be drawn is opened, or <CodeContentPlaceHolder>266\</CodeContentPlaceHolder> if not.  
...
### Parameters  
 ...
 <CodeContentPlaceHolder>306\</CodeContentPlaceHolder> if the tab is active, or <CodeContentPlaceHolder>307\</CodeContentPlaceHolder> if not.  
...
### Parameters  
 ...
 <CodeContentPlaceHolder>313\</CodeContentPlaceHolder> if the bar is in infinite mode, or <CodeContentPlaceHolder>314\</CodeContentPlaceHolder> if not. The default implementation does not use this parameter.  
...
### Parameters  
 ...
 <CodeContentPlaceHolder>331\</CodeContentPlaceHolder> if the framework should draw the left button with a " **-**" for zoom out, or <CodeContentPlaceHolder>332\</CodeContentPlaceHolder> if the framework should draw the right button with a " **+**" for zoom in.  
...
### Parameters  
 ...
 <CodeContentPlaceHolder>344\</CodeContentPlaceHolder> if the scroll buttons are highlighted, or <CodeContentPlaceHolder>345\</CodeContentPlaceHolder> if not.  
...
### Parameters  
 ...
 <CodeContentPlaceHolder>350\</CodeContentPlaceHolder> if the pane is docked horizontally, or <CodeContentPlaceHolder>351\</CodeContentPlaceHolder> if the pane is docked vertically.  
...
### Parameters  
 ...
 [in] <CodeContentPlaceHolder>353\</CodeContentPlaceHolder>  
...
### Remarks  
 Override this method in a derived visual manager to customize the appearance of the border for a <CodeContentPlaceHolder>360\</CodeContentPlaceHolder> object.  
...
### Remarks  
 A <CodeContentPlaceHolder>378\</CodeContentPlaceHolder> object calls this method when it processes the <CodeContentPlaceHolder>379\</CodeContentPlaceHolder> message.Override this method in a derived class to customize the look of tabs.  
...
### Remarks  
 The framework displays tasks on the task bar as both an icon and text. The <CodeContentPlaceHolder>390\</CodeContentPlaceHolder> parameter contains the icon for the task indicated by <CodeContentPlaceHolder>391\</CodeContentPlaceHolder>. Override this method in a derived class to customize the appearance of tasks on the task bar.  
...
### Parameters  
 [in] <CodeContentPlaceHolder>392\</CodeContentPlaceHolder>  
 A pointer to a device context.  
 ...
 A Boolean parameter that specifies if the border is highlighted. A value of <CodeContentPlaceHolder>395\</CodeContentPlaceHolder> indicates that the border is highlighted.  
  
 [in] <CodeContentPlaceHolder>396\</CodeContentPlaceHolder>  
 A Boolean parameter that specifies whether the group area has a title. A value of <CodeContentPlaceHolder>397\</CodeContentPlaceHolder> indicates that the group area does not have a title.  
...
### Remarks  
 Override this method in a derived class to customize the caption for a <CodeContentPlaceHolder>403\</CodeContentPlaceHolder>.  
...
### Parameters  
 ...
 <CodeContentPlaceHolder>407\</CodeContentPlaceHolder> if the caption is active; <CodeContentPlaceHolder>408\</CodeContentPlaceHolder> otherwise.  
  
### Remarks  
 This function is called by the framework when a [CMFCPopupMenu](../vs140/cmfcpopupmenu-class.md) object processes a <CodeContentPlaceHolder>409\</CodeContentPlaceHolder> message and must draw a tear-off caption.  
...
### Remarks  
 This function is called by the framework when a [CMFCBaseTabCtrl](../vs140/cmfcbasetabctrl-class.md) object processes a <CodeContentPlaceHolder>416\</CodeContentPlaceHolder> message and erases the tab area.  
...
### Parameters  
 ...
 [in] <CodeContentPlaceHolder>419\</CodeContentPlaceHolder>  
...
### Remarks  
 The framework erases the text and icon for a button when a [CMFCBaseTabCtrl](../vs140/cmfcbasetabctrl-class.md) object processes the <CodeContentPlaceHolder>421\</CodeContentPlaceHolder> message  
...
### Return Value  
 <CodeContentPlaceHolder>425\</CodeContentPlaceHolder> if the method is successful or <CodeContentPlaceHolder>426\</CodeContentPlaceHolder> if not.  
  
### Remarks  
 This method fills the area indicated by <CodeContentPlaceHolder>427\</CodeContentPlaceHolder> with the background color of the active tab. It is called when a <CodeContentPlaceHolder>428\</CodeContentPlaceHolder> object processes a <CodeContentPlaceHolder>429\</CodeContentPlaceHolder> message and erases a tab frame.  
...
### Parameters  
 ...
 [in] <CodeContentPlaceHolder>432\</CodeContentPlaceHolder>  
...
### Remarks  
 The default implementation of this method fills the background of the bar with the 3d background color from the global variable <CodeContentPlaceHolder>438\</CodeContentPlaceHolder>.  
...
### Parameters  
 ...
 The state of the toolbar button (the possible states of a toolbar button are <CodeContentPlaceHolder>443\</CodeContentPlaceHolder>, <CodeContentPlaceHolder>444\</CodeContentPlaceHolder>, or <CodeContentPlaceHolder>445\</CodeContentPlaceHolder>).  
...
### Parameters  
 ...
 [in] <CodeContentPlaceHolder>455\</CodeContentPlaceHolder>  
...
### Parameters  
 [in] <CodeContentPlaceHolder>456\</CodeContentPlaceHolder>  
 A pointer to a device context.  
  
 [in] <CodeContentPlaceHolder>457\</CodeContentPlaceHolder>  
 A rectangle that specifies the boundaries of the caption bar.  
  
 [out] <CodeContentPlaceHolder>458\</CodeContentPlaceHolder>  
 A reference to a <CodeContentPlaceHolder>459\</CodeContentPlaceHolder> object to which this method writes the color of text on the caption bar.  
...
### Parameters  
 ...
 [in] <CodeContentPlaceHolder>462\</CodeContentPlaceHolder>  
 ...
 [out] <CodeContentPlaceHolder>464\</CodeContentPlaceHolder>  
 A reference to a <CodeContentPlaceHolder>465\</CodeContentPlaceHolder> object where this method stores the text color of the outlook page button.  
...
### Parameters  
 ...
 <CodeContentPlaceHolder>473\</CodeContentPlaceHolder> if the tab is active or <CodeContentPlaceHolder>474\</CodeContentPlaceHolder> if not.  
...
### Parameters  
 [in] <CodeContentPlaceHolder>484\</CodeContentPlaceHolder>  
 A pointer to a device context.  
...
### Remarks  
 The framework calls this method as a part of processing the <CodeContentPlaceHolder>486\</CodeContentPlaceHolder> message. Override this method in a derived visual manager if you want to execute custom code when the colors change in your application.  
...
### Remarks  
 If <CodeContentPlaceHolder>488\</CodeContentPlaceHolder> is <CodeContentPlaceHolder>489\</CodeContentPlaceHolder>, the visual manager will use native Windows XP colors such as blue, olive, or silver. Otherwise, the visual manager will use the colors obtained from <CodeContentPlaceHolder>490\</CodeContentPlaceHolder>. The visual manager uses visual elements such as <CodeContentPlaceHolder>491\</CodeContentPlaceHolder>, <CodeContentPlaceHolder>492\</CodeContentPlaceHolder>, <CodeContentPlaceHolder>493\</CodeContentPlaceHolder>, <CodeContentPlaceHolder>494\</CodeContentPlaceHolder>, and <CodeContentPlaceHolder>495\</CodeContentPlaceHolder>.  
  
 By default, a <CodeContentPlaceHolder>496\</CodeContentPlaceHolder> object uses native Windows XP theme colors.  
...
### Parameters  
 ...
 <CodeContentPlaceHolder>498\</CodeContentPlaceHolder> if the Windows XP global theme should be used (the default), or <CodeContentPlaceHolder>499\</CodeContentPlaceHolder> if not.  
...
### Parameters  
 ...
 <CodeContentPlaceHolder>501\</CodeContentPlaceHolder> if you want the visual manager to use a global theme; <CodeContentPlaceHolder>502\</CodeContentPlaceHolder> otherwise.  
  
### Remarks  
 If a <CodeContentPlaceHolder>503\</CodeContentPlaceHolder> object uses a global theme, it draws the GUI elements by using the [CMFCVisualManagerWindows Class](../vs140/cmfcvisualmanagerwindows-class.md).  
  
 If a <CodeContentPlaceHolder>504\</CodeContentPlaceHolder> object does not use a global theme, it draws the GUI elements by using the [CMFCVisualManagerOfficeXP Class](../vs140/cmfcvisualmanagerofficexp-class.md).  
