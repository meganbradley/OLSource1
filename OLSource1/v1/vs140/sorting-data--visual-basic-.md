...
|-----------------|-----------------|------------------------------------------|----------------------|  
|OrderBy|Sorts values in ascending order.|`Order By`|<xref:System.Linq.Enumerable.OrderBy``2?qualifyHint=True><br /><br /> <xref:System.Linq.Queryable.OrderBy``2?qualifyHint=True>|  
|OrderByDescending|Sorts values in descending order.|`Order By … Descending`|<xref:System.Linq.Enumerable.OrderByDescending``2?qualifyHint=True><br /><br /> <xref:System.Linq.Queryable.OrderByDescending``2?qualifyHint=True>|  
|ThenBy|Performs a secondary sort in ascending order.|`Order By …, …`|<xref:System.Linq.Enumerable.ThenBy``2?qualifyHint=True><br /><br /> <xref:System.Linq.Queryable.ThenBy``2?qualifyHint=True>|  
|ThenByDescending|Performs a secondary sort in descending order.|`Order By …, … Descending`|<xref:System.Linq.Enumerable.ThenByDescending``2?qualifyHint=True><br /><br /> <xref:System.Linq.Queryable.ThenByDescending``2?qualifyHint=True>|  
|Reverse|Reverses the order of the elements in a collection.|Not applicable.|<xref:System.Linq.Enumerable.Reverse``1?qualifyHint=True><br /><br /> <xref:System.Linq.Queryable.Reverse``1?qualifyHint=True>|  
