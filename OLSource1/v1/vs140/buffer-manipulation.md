...
|[memchr, wmemchr](../vs140/memchr--wmemchr.md)|Return pointer to first occurrence, within specified number of characters, of given character in buffer|Not applicable. To call the standard C function, use <CodeContentPlaceHolder>0\</CodeContentPlaceHolder>. For more information, see [Platform Invoke Examples](assetId:///15926806-f0b7-487e-93a6-4e9367ec689f).|  
...
|[_swab](../vs140/_swab.md)|Swap bytes of data and store them at specified location|Not applicable. To call the standard C function, use <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>. For more information, see [Platform Invoke Examples](assetId:///15926806-f0b7-487e-93a6-4e9367ec689f).|  
  
 When the source and target areas overlap, only <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> is guaranteed to copy the full source properly.  
