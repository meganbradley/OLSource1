...
#### Parameters  
 ...
 A function which will be called to invoke the body of the work. This may be a lambda or other object which supports a version of the function call operator with the signature <CodeContentPlaceHolder>10\</CodeContentPlaceHolder>.  
...
## Remarks  
 ...
 After this function returns, the <CodeContentPlaceHolder>14\</CodeContentPlaceHolder> object is considered in a final state and should not be used. Note that utilization after the <CodeContentPlaceHolder>15\</CodeContentPlaceHolder> method returns will result in undefined behavior.  
  
 In the non-exceptional path of execution, you have a mandate to call either this method or the <CodeContentPlaceHolder>16\</CodeContentPlaceHolder> method before the destructor of the <CodeContentPlaceHolder>17\</CodeContentPlaceHolder> executes.  
