...
#### Parameters  
 ...
 See <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> in [IDocHostUIHandler::GetHostInfo](https://msdn.microsoft.com/en-us/library/aa753257.aspx) in the [!INCLUDE[winSDK](../vs140/includes/winsdk_md.md)].  
