...
## Remarks  
 This is the value specified by the user in the Print dialog box, and it is stored in the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> object referenced by the <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> member. If the user has not specified a value, the default is the first page of the document.  
