...
You can use the <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> and <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> objects to log information about your application. This example shows how to use the <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> method to log tracing information.  
  
 For logging exception information, use the <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> method; see [How to: Log Exceptions in Visual Basic](../vs140/how-to--log-exceptions-in-visual-basic.md).  
  
## Example  
 This example uses the <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> method to write out the trace information.  
