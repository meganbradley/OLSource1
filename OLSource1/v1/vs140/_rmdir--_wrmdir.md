...
## Return Value  
 Each of these functions returns 0 if the directory is successfully deleted. A return value of –1 indicates an error and <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> is set to one of the following values:  
...
## Remarks  
 The <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> function deletes the directory specified by <CodeContentPlaceHolder>5\</CodeContentPlaceHolder>. The directory must be empty, and it must not be the current working directory or the root directory.  
  
 <CodeContentPlaceHolder>6\</CodeContentPlaceHolder> is a wide-character version of <CodeContentPlaceHolder>7\</CodeContentPlaceHolder>; the <CodeContentPlaceHolder>8\</CodeContentPlaceHolder> argument to <CodeContentPlaceHolder>9\</CodeContentPlaceHolder> is a wide-character string. <CodeContentPlaceHolder>10\</CodeContentPlaceHolder> and <CodeContentPlaceHolder>11\</CodeContentPlaceHolder> behave identically otherwise.  
