...
## Example  
 This example uses <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> to get at the CWinApp class illustrating a way that <CodeContentPlaceHolder>5\</CodeContentPlaceHolder>, <CodeContentPlaceHolder>6\</CodeContentPlaceHolder>, <CodeContentPlaceHolder>7\</CodeContentPlaceHolder>, and <CodeContentPlaceHolder>8\</CodeContentPlaceHolder> can be used from any function in an MFC application.  
