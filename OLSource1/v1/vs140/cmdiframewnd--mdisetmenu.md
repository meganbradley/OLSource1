...
## Remarks  
 After calling <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>, an application must call the [DrawMenuBar](../vs140/cwnd--drawmenubar.md) member function of <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> to update the menu bar.  
