...
## Return Value  
 A <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>* that points to the dock row in which the pane is docked, or <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> if the pane is not docked.  
