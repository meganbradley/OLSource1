...
## Data Types  
 You can assign a variable, constant, or expression of any data type to an `Object` variable. To determine the data type an `Object` variable currently refers to, you can use the [GetTypeCode](assetId:///M:System.Type.GetTypeCode(System.Type)?qualifyHint=False&autoUpgrade=True) method of the <xref:System.Type*?displayProperty=fullName> class. The following example illustrates this.  
