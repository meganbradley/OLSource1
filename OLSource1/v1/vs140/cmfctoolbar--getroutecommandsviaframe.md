...
## Remarks  
 ...
 If this method returns a nonzero value, you can retrieve a pointer to the parent frame object by using the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> method. See the VisualStudioDemo sample for an example that uses this method.  
