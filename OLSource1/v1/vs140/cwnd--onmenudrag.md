...
|---------------|-----------------|  
|[in] <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>|The index position of the menu item when the drag operation begins.|  
...
|------------------|-------------|  
|<CodeContentPlaceHolder>3\</CodeContentPlaceHolder>|The menu should remain active. If the mouse is released, it should be ignored.|  
|<CodeContentPlaceHolder>4\</CodeContentPlaceHolder>|The menu should be ended.|  
