...
---
# LINQ to Objects (C#)
The term "LINQ to Objects" refers to the use of LINQ queries with any <xref:System.Collections.IEnumerable?qualifyHint=False> or <xref:System.Collections.Generic.IEnumerable`1?qualifyHint=False> collection directly, without the use of an intermediate LINQ provider or API such as [LINQ to SQL](assetId:///73d13345-eece-471a-af40-4cc7a2f11655) or [LINQ to XML](../vs140/linq-to-xml.md). You can use LINQ to query any enumerable collections such as <xref:System.Collections.Generic.List`1?qualifyHint=False>, <xref:System.Array?qualifyHint=False>, or <xref:System.Collections.Generic.Dictionary`2?qualifyHint=False>. The collection may be user-defined or may be returned by a .NET Framework API.  
...
## In This Section  
 ...
 [LINQ and Reflection (C#)](../vs140/linq-and-reflection--csharp-.md)  
 ...
 [How to: Add Custom Methods for LINQ Queries (C#)](../vs140/how-to--add-custom-methods-for-linq-queries--csharp-.md)  
 Explains how to extend the set of methods that you can use for LINQ queries by adding extension methods to the <xref:System.Collections.Generic.IEnumerable`1?qualifyHint=False> interface.  
