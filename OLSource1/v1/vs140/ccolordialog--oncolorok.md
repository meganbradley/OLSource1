...
dev_langs: 
  - "C++"
helpviewer_keywords: 
  - "CColorDialog class, overridables"
  - "OnColorOK method"
...
-   Entering values in the RGB edit boxes  
 ...
 Overriding <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> allows you to reject a color the user enters into a common color dialog box for any application-specific reason.  
 ...
 You can call [SetCurrentColor](../vs140/ccolordialog--setcurrentcolor.md) from within <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> to force a color selection. Once <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> has been fired (that is, the user clicks **OK** to accept the color change), you can call [GetColor](../vs140/ccolordialog--getcolor.md) to get the RGB value of the new color.  
  
## Example  
 [!code[NVC_MFCDocView#52](../vs140/codesnippet/CPP/ccolordialog--oncolorok_1.cpp)]  
