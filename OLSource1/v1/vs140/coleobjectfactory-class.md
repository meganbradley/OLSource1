...
|Name|Description|  
|----------|-----------------|  
|[COleObjectFactory::COleObjectFactory](#coleobjectfactory__coleobjectfactory)|Constructs a <CodeContentPlaceHolder>16\</CodeContentPlaceHolder> object.|  
...
## Remarks  
 The <CodeContentPlaceHolder>17\</CodeContentPlaceHolder> class has member functions for performing the following functions:  
...
##  \<a name="coleobjectfactory__coleobjectfactory">\</a>  COleObjectFactory::COleObjectFactory  
 Constructs a <CodeContentPlaceHolder>19\</CodeContentPlaceHolder> object, initializes it as an unregistered object factory, and adds it to the list of factories.  
...
##  \<a name="coleobjectfactory__getlicensekey">\</a>  COleObjectFactory::GetLicenseKey  
 Requests a unique license key from the control's DLL and stores it in the <CodeContentPlaceHolder>28\</CodeContentPlaceHolder> pointed to by <CodeContentPlaceHolder>29\</CodeContentPlaceHolder>.  
...
### Parameters  
 ...
 Pointer to a <CodeContentPlaceHolder>32\</CodeContentPlaceHolder> that will store the license key.  
  
### Return Value  
 Nonzero if the license-key string is not **NULL**; otherwise 0.  
  
### Remarks  
 The default implementation of this function returns 0 and stores nothing in the <CodeContentPlaceHolder>33\</CodeContentPlaceHolder>. If you use MFC ActiveX ControlWizard to create your project, ControlWizard supplies an override that retrieves the control's license key.  
...
-   **UpdateRegistry(**  <CodeContentPlaceHolder>36\</CodeContentPlaceHolder>  **)** Registers this object factory with the OLE system registry. This function is usually called by [CWinApp::InitInstance](../vs140/cwinapp-class.md#cwinapp__initinstance) when the application is launched.  
  
-   **UpdateRegistry(**  <CodeContentPlaceHolder>37\</CodeContentPlaceHolder>  **)** This form of the function is overridable. If <CodeContentPlaceHolder>38\</CodeContentPlaceHolder> is **TRUE**, this function registers the control class with the system registry. Otherwise, it unregisters the class.  
...
### Parameters  
 ...
 A <CodeContentPlaceHolder>41\</CodeContentPlaceHolder> storing the container's version of the license string.  
  
### Return Value  
 Nonzero if the run-time license is valid; otherwise 0.  
  
### Remarks  
 The default version calls [GetLicenseKey](#coleobjectfactory__getlicensekey) to get a copy of the control's license string and compares it with the string in <CodeContentPlaceHolder>42\</CodeContentPlaceHolder>. If the two strings match, the function returns a nonzero value; otherwise it returns 0.  
