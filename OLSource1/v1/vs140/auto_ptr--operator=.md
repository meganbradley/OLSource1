...
---
# auto_ptr::operator=
An assignment operator that transfers ownership from one <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> object to another.  
...
## Return Value  
 A reference to an object of type <CodeContentPlaceHolder>4\</CodeContentPlaceHolder>\<**Type**>.  
