 ...
 **Make sure that the file is not open by another process and is not write-protected.**  
 ...
 During a rebuild or clean, Visual C++ deletes all known intermediate and output files for the build, as well as any files that meet the wildcard specifications in the **Extensions to Delete on Clean** property in the [General Configuration Settings Property Page](../vs140/general-property-page--project-.md).  
