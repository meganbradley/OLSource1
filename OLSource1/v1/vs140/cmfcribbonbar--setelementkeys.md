...
## Return Value  
 <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> if the keytips of at least one ribbon element are set; otherwise <CodeContentPlaceHolder>5\</CodeContentPlaceHolder>.  
