...
|Member|Description|  
|------------|-----------------|  
|[add_Invalidate](../vs140/itypeprovider.add_invalidate-method--fsharp-.md) : <xref:System.EventHandler?qualifyHint=False> -> unit|Add an event handler for the [Invalidate](../vs140/itypeprovider.invalidate-event--fsharp-.md) event.|  
|[ApplyStaticArguments](../vs140/itypeprovider.applystaticarguments-method--fsharp-.md) : <xref:System.Type?qualifyHint=False> * [string](../vs140/core.string-type-abbreviation--fsharp-.md) [] \* [obj](../vs140/core.obj-type-abbreviation--fsharp-.md) [] -> <xref:System.Type?qualifyHint=False>|Apply static arguments to a provided type that accepts static arguments.|  
|[GetInvokerExpression](../vs140/itypeprovider.getinvokerexpression-method--fsharp-.md) : <xref:System.Reflection.MethodBase?qualifyHint=False> * [Quotations.Expr](../vs140/quotations.expr-class--fsharp-.md) [] -> [Quotations.Expr](../vs140/quotations.expr-class--fsharp-.md)|Called by the compiler to ask for an Expression tree to replace the given <xref:System.Reflection.MethodBase?qualifyHint=False> with.|  
...
|[GetStaticParameters](../vs140/itypeprovider.getstaticparameters-method--fsharp-.md) : <xref:System.Type?qualifyHint=False> -> <xref:System.Reflection.ParameterInfo?qualifyHint=False> []|Get the static parameters for a provided type.|  
|[Invalidate](../vs140/itypeprovider.invalidate-event--fsharp-.md) : [IEvent](../vs140/control.ievent--delegate--args--interface--fsharp-.md)<<xref:System.EventHandler?qualifyHint=False>, <xref:System.EventArgs?qualifyHint=False>>|Triggered when an assumption changes that invalidates the resolutions so far reported by the provider.|  
|[remove_Invalidate](../vs140/itypeprovider.remove_invalidate-method--fsharp-.md) : <xref:System.EventHandler?qualifyHint=False> -> unit|Remove an event handler for the [Invalidate](../vs140/itypeprovider.invalidate-event--fsharp-.md) event.|  
