...
-   **DTS_TIMEFORMAT** Displays the time in long format, producing output like "5:31:42 PM".  
 ...
 The following example code (where <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> is the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> object) demonstrates one possible solution:  
