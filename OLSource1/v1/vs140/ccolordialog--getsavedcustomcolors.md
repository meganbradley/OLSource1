...
---
# CColorDialog::GetSavedCustomColors
<CodeContentPlaceHolder>1\</CodeContentPlaceHolder> objects permit the user, in addition to choosing colors, to define up to 16 custom colors.  
...
## Remarks  
 The <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> member function provides access to these colors. These colors can be retrieved after [DoModal](../vs140/ccolordialog--domodal.md) returns **IDOK**.  
