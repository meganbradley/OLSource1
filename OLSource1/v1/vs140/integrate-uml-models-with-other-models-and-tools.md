...
-   **ModelBus References.** ModelBus is a framework for creating and resolving references between models. It includes the ModelBus Picker, which lets the user select an element in a model. It also helps the user to resolve references that are lost because of changes in the target model.  
     ...
     For more information, see [Integrating Models](../vs140/integrating-models-by-using-visual-studio-modelbus.md).  
...
2.  **VMSDK Events** can be used to propagate changes outside the model – for example, to change the filename of a linked document, or to change an element in another model.  
 ...
 For more information see [How to Define a Gesture Handler](../vs140/define-a-gesture-handler-on-a-modeling-diagram.md) and [How to Write a Drag and Drop Handler](../vs140/how-to--add-a-drag-and-drop-handler.md).  
...
-   [How to Define a Gesture Handler](../vs140/define-a-gesture-handler-on-a-modeling-diagram.md)  
 ...
 For an example in which a UML model is be read by a DSL, see [How to Write a Drag and Drop Handler](../vs140/how-to--add-a-drag-and-drop-handler.md).  
