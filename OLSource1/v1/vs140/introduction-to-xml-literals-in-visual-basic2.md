...
## Creating XML Trees  
 The following example shows how to create an <xref:System.Xml.Linq.XElement?qualifyHint=False>, in this case `contacts`:  
...
### Creating an XElement with Simple Content  
 You can create an <xref:System.Xml.Linq.XElement?qualifyHint=False> that contains simple content, as follows:  
...
### Creating an Empty Element  
 You can create an empty <xref:System.Xml.Linq.XElement?qualifyHint=False>, as follows:  
...
### Using Embedded Expressions  
 An important feature of XML literals is that they allow embedded expressions. Embedded expressions enable you to evaluate an expression and insert the results of the expression into the XML tree. If the expression evaluates to a type of <xref:System.Xml.Linq.XElement?qualifyHint=False>, an element is inserted into the tree. If the expression evaluates to a type of <xref:System.Xml.Linq.XAttribute?qualifyHint=False>, an attribute is inserted into the tree. You can insert elements and attributes into the tree only where they are valid.  
