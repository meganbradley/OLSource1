...
apitype: "Assembly"
f1_keywords: 
  - "Microsoft.FSharp.Collections.SeqModule.Skip``1"
dev_langs: 
  - "FSharp"
helpviewer_keywords: 
  - "skip function [F#]"
...
## Example  
 The following example demonstrates the use of <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> to skip the first five squares of a list of squares.  
  
 [!code[FsSequences#171](../vs140/codesnippet/FSharp/seq.skip--t--function--fsharp-_1.fs)]  
