...
---
# DDX_FieldCBIndex
The <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> function synchronizes the index of the selected item in the list box control of a combo box control in a record view and an <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> field data member of a recordset associated with the record view.  
...
## Example  
 See [DDX_FieldText](../vs140/ddx_fieldtext.md) for a general DDX_Field example. The example would be similar for <CodeContentPlaceHolder>8\</CodeContentPlaceHolder>.  
