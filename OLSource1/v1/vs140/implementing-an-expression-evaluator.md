...
-   [IDebugBinder](../vs140/idebugbinder.md)  
 ...
 The EE implements [IDebugProperty2](../vs140/idebugproperty2.md). <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> provides the mechanism for describing the result of an expression evaluation, such as a local variable, a primitive, or an object, to Visual Studio, which then displays the appropriate information in the **Locals**, **Watch**, or **Immediate** window.  
