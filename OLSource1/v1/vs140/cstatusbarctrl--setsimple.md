...
#### Parameters  
 ...
 Display-type flag. If this parameter is <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>, the control displays simple text; if it is <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>, it displays multiple parts.  
