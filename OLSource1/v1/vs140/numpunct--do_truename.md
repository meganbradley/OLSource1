...
## Example  
 See the example for [truename](../vs140/numpunct--truename.md), where the virtual member function is called by <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>.  
