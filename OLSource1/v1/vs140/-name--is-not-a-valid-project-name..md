...
This error generally occurs when the <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> command is issued from the **Command** window or **Find/Command** box and an incorrect project name is entered for *projectname*.  
