...
apitype: "Assembly"
f1_keywords: 
  - "Microsoft.FSharp.Core.Operators.Checked.op_UnaryNegation``1"
dev_langs: 
  - "FSharp"
helpviewer_keywords: 
  - "~- operator [F#]"
  - "Checked.( ~- ) operator [F#]"
  - "op_UnaryNegation operator [F#]"
  - "Checked.op_UnaryNegation operator [F#]"
ms.assetid: 4fa7cd12-8c9f-495f-8741-e5da3d28fd19
