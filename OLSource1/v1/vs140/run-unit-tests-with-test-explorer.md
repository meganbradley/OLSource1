...
|||  
|-|-|  
|![Run after build](../vs140/media/ute_runafterbuild_btn.png "UTE_RunAfterBuild_btn")|To run your unit tests after each local build, choose **Test** on the standard menu, and then choose **Run Tests After Build** on the Test Explorer toolbar.|  
...
###  \<a name="BKMK_View_test_details">\</a> View test details  
 ...
 ![Test execution details](../vs140/media/ute_testdetails.png "UTE_TestDetails")  
...
###  \<a name="BKMK_Grouping_the_test_list">\</a> Grouping the test list  
 To change the way that tests are organized, choose the down arrow next to the **Group By** button ![Test Explorer group button](../vs140/media/ute_groupby_btn.png "UTE_GroupBy_btn") and select a new grouping criteria.  
  
 ![Group tests by category in Test Explorer](../vs140/media/ute_groupbycategory.png "UTE_GroupByCategory")  
 ...
 **Traits in the Microsoft Unit Testing Framework for C++**  
 ...
 To define a trait, use the <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> macro. For example, to define a trait named <CodeContentPlaceHolder>5\</CodeContentPlaceHolder>:  
...
|Macro|Description|  
|-----------|-----------------|  
|<CodeContentPlaceHolder>6\</CodeContentPlaceHolder>|Use the TEST_METHOD_ATTRIBUTE macro to define a trait.|  
|<CodeContentPlaceHolder>7\</CodeContentPlaceHolder>|Use the predefined Owner trait to specify an owner of the test method.|  
|<CodeContentPlaceHolder>8\</CodeContentPlaceHolder>|Use the predefined Priority trait to assign relative priorities to your test methods.|  
...
3.  Enter the filter value between the quotation marks.  
 ...
 ![Filter tests in Test Explorer](../vs140/media/ute_filtertestlist.png "UTE_FilterTestList")  
...
##  \<a name="BKMK_Create_custom_playlists">\</a> Create custom playlists  
 ...
 ![Choose a playlist](../vs140/media/ute_playlist.png "UTE_Playlist")  
...
###  \<a name="BKMK_Diagnose_test_method_performance_issues">\</a> Diagnose test method performance issues  
 To diagnose why a test method is taking too much time, select the method in Test Explorer and then choose Profile on the context menu. See [Analyzing Application Performance by Using Profiling Tools](../vs140/performance-explorer.md).  
...
2.  Choose one of the following commands from the sub-menu:  
 ...
 For more information, see [Using Code Coverage to Determine How Much Code Is Being Tested](../vs140/using-code-coverage-to-determine-how-much-code-is-being-tested.md).  
...
## See Also  
 ...
 [How to: Run a Unit Test as a 64-bit Process](../vs140/run-a-unit-test-as-a-64-bit-process.md)