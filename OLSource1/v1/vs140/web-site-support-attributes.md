...
```  
 ...
 specifies that an instance of PythonIntellisenseProvider, which implements <xref:Microsoft.VisualStudio.Shell.Interop.IVsIntellisenseProject?qualifyHint=False>, should be created on demand to provide language services.  
