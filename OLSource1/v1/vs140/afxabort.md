...
## Remarks  
 <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> is called internally by MFC member functions when there is a fatal error, such as an uncaught exception that cannot be handled. You can call <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> in the rare case when you encounter a catastrophic error from which you cannot recover.  
