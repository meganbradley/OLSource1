...
#### Parameters  
 ...
 Your class derived from <CodeContentPlaceHolder>18\</CodeContentPlaceHolder>.  
...
## Remarks  
 <CodeContentPlaceHolder>19\</CodeContentPlaceHolder> represents the module for an application (EXE) and contains code that supports creating an EXE, processing the command line, registering class objects, running the message loop, and cleaning up on exit.  
...
### Parameters  
 ...
 The value passed as the <CodeContentPlaceHolder>24\</CodeContentPlaceHolder> parameter in WinMain.  
...
### Remarks  
 This method can be overridden. If overriding [CAtlExeModuleT::PreMessageLoop](../vs140/catlexemodulet--premessageloop.md), [CAtlExeModuleT::PostMessageLoop](../vs140/catlexemodulet--postmessageloop.md), or [CAtlExeModuleT::RunMessageLoop](../vs140/catlexemodulet--runmessageloop.md) doesn't provide enough flexibility, it's possible to override the <CodeContentPlaceHolder>28\</CodeContentPlaceHolder> function using this method.  
