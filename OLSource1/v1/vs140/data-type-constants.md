...
> [!NOTE]
>  The /J compiler option changes the default <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> type to <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>.  
  
|Constant|Value|Meaning|  
|--------------|-----------|-------------|  
|**SCHAR_MAX**|127|Maximum signed <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> value|  
|**SCHAR_MIN**|–128|Minimum signed <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> value|  
|**UCHAR_MAX**|255 (0xff)|Maximum <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> value|  
|**CHAR_BIT**|8|Number of bits in a <CodeContentPlaceHolder>5\</CodeContentPlaceHolder>|  
...
|**UINT_MAX**|4294967295 (0xffffffff)|Maximum <CodeContentPlaceHolder>6\</CodeContentPlaceHolder> value|  
|**ULONG_MAX**|4294967295 (0xffffffff)|Maximum <CodeContentPlaceHolder>7\</CodeContentPlaceHolder> value|  
|**INT_MAX**|2147483647|Maximum (signed) <CodeContentPlaceHolder>8\</CodeContentPlaceHolder> value|  
|**INT_MIN**|–2147483647–1|Minimum (signed) <CodeContentPlaceHolder>9\</CodeContentPlaceHolder> value|  
|**LONG_MAX**|2147483647|Maximum (signed) **long** value|  
|**LONG_MIN**|–2147483647–1|Minimum (signed) **long** value|  
|**CHAR_MAX**|127 (255 if /J option used)|Maximum <CodeContentPlaceHolder>10\</CodeContentPlaceHolder> value|  
|**CHAR_MIN**|–128 (0 if /J option used)|Minimum <CodeContentPlaceHolder>11\</CodeContentPlaceHolder> value|  
|**MB_LEN_MAX**|2|Maximum number of bytes in multibyte <CodeContentPlaceHolder>12\</CodeContentPlaceHolder>|  
