...
## Remarks  
 In such a case, you must create the querydef and set its properties using other <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> member functions. For a description of external databases, see [SetConnect](../vs140/cdaoquerydef--setconnect.md).  
