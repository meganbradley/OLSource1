...
|**Point Texture Filtering**|Sets the filtering mode to <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> (point texture filtering) for all appropriate texture samples.\<br />\<br /> For more information, see [Point, Bilinear, Trilinear, and Anisotropic Filtering Variants](../vs140/point--bilinear--trilinear--and-anisotropic-texture-filtering-variants.md).|  
|**Bilinear Texture Filtering**|Sets the filtering mode to <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> (bilinear texture filtering) for all appropriate texture samples.\<br />\<br /> For more information, see [Point, Bilinear, Trilinear, and Anisotropic Filtering Variants](../vs140/point--bilinear--trilinear--and-anisotropic-texture-filtering-variants.md).|  
|**Trilinear Texture Filtering**|Sets the filtering mode to <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> (trilinear texture filtering) for all appropriate texture samples.\<br />\<br /> For more information, see [Point, Bilinear, Trilinear, and Anisotropic Filtering Variants](../vs140/point--bilinear--trilinear--and-anisotropic-texture-filtering-variants.md).|  
|**Anisotropic Texture Filtering**|Sets the filtering mode to <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> and <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> to <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> (16x anisotropic texture filtering) for all appropriate texture samples.\<br />\<br /> For more information, see [Point, Bilinear, Trilinear, and Anisotropic Filtering Variants](../vs140/point--bilinear--trilinear--and-anisotropic-texture-filtering-variants.md).|  
|**16bpp Render Target Format**|Sets the pixel format to <CodeContentPlaceHolder>6\</CodeContentPlaceHolder> (16bpp, 565 format) for all render targets and backbuffers.\<br />\<br /> For more information, see [16bpp Render Target Format Variant](../vs140/16bpp-render-target-format-variant.md)|  
