...
|-----------------|-----------------|------------------------------------------|----------------------|  
|Join|Joins two sequences based on key selector functions and extracts pairs of values.|<CodeContentPlaceHolder>0\</CodeContentPlaceHolder>\<br />\<br /> -or-\<br />\<br /> <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>|\<xref:System.Linq.Enumerable.Join*?displayProperty=fullName>\<br />\<br /> \<xref:System.Linq.Queryable.Join*?displayProperty=fullName>|  
|GroupJoin|Joins two sequences based on key selector functions and groups the resulting matches for each element.|<CodeContentPlaceHolder>2\</CodeContentPlaceHolder>|\<xref:System.Linq.Enumerable.GroupJoin*?displayProperty=fullName>\<br />\<br /> \<xref:System.Linq.Queryable.GroupJoin*?displayProperty=fullName>|  
