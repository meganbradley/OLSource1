...
---
# unchecked_adjacent_difference
Same as [adjacent_difference](../vs140/adjacent_difference.md), but allows the use of an unchecked iterator as output iterator when _SECURE_SCL=1 is defined.  <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> is defined in the <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> namespace.  
