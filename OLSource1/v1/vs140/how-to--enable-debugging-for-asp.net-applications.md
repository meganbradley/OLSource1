...
2.  Web.config is an XML file, and so contains nested sections marked by tags. Locate the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> element. If the compilation element does not exist, create it.  
  
3.  If the <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> element does not contain a <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> attribute, add the attribute to the element.  
  
4.  Make sure the <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> attribute value is set to <CodeContentPlaceHolder>5\</CodeContentPlaceHolder>.  
