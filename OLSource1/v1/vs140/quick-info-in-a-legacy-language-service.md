...
## Implementing the Quick Info Feature  
 The <xref:Microsoft.VisualStudio.Package.ViewFilter*> class handles the IntelliSense Quick Info operation. When the <xref:Microsoft.VisualStudio.Package.ViewFilter*> class receives the <xref:Microsoft.VisualStudio.VSConstants.VSStd2KCmdID.QUICKINFO*> command, the class calls the assetId:///M:Microsoft.VisualStudio.Package.LanguageService.ParseSource(Microsoft.VisualStudio.Package.ParseRequest)?qualifyHint=False&autoUpgrade=True method with the parse reason of <xref:Microsoft.VisualStudio.Package.ParseReason.QuickInfo*> and the location of the caret at the time the <xref:Microsoft.VisualStudio.VSConstants.VSStd2KCmdID.QUICKINFO*> command was sent. The assetId:///M:Microsoft.VisualStudio.Package.LanguageService.ParseSource(Microsoft.VisualStudio.Package.ParseRequest)?qualifyHint=False&autoUpgrade=True method parser must then parse the source up to the given location and then parse the identifier at the given location to determine what to display in the Quick Info tool tip.  
  
 Most parsers do an initial parse of the entire source file and store the results in a parse tree. The complete parse is carried out when <xref:Microsoft.VisualStudio.Package.ParseReason.Check*> is passed to assetId:///M:Microsoft.VisualStudio.Package.LanguageService.ParseSource(Microsoft.VisualStudio.Package.ParseRequest)?qualifyHint=False&autoUpgrade=True method. Other kinds of parsing can then use the parse tree to obtain the desired information.  
  
 For example, the parse reason value of <xref:Microsoft.VisualStudio.Package.ParseReason.QuickInfo*> can find the identifier at the source location and look it up in the parse tree to obtain the type information. This type information is then passed to the <xref:Microsoft.VisualStudio.Package.AuthoringScope*> class, and is returned by the assetId:///M:Microsoft.VisualStudio.Package.AuthoringScope.GetDataTipText(System.Int32,System.Int32,Microsoft.VisualStudio.TextManager.Interop.TextSpan@)?qualifyHint=False&autoUpgrade=True method.