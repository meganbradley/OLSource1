...
A constant operand has the value and type of the constant value it represents. A character constant has <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> type. An integer constant has <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>, **long**, <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>, or <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> type, depending on the integer's size and on the way the value is specified. See [Constants](../vs140/c-constants.md) for more information.  
