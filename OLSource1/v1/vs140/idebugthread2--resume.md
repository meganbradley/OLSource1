...
## Remarks  
 ...
 For each call to this method, there must be a previous call to the [IDebugThread2::Suspend](../vs140/idebugthread2--suspend.md) method. The suspend count determines how many times the <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> method has been called so far.  
