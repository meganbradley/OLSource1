...
|[ImplicitExpressionConversionHelper](../vs140/leafexpressionconverter.implicitexpressionconversionhelper--t--function--fsharp-.md): 'T -> <xref:System.Linq.Expressions.Expression<CodeContentPlaceHolder>1\</CodeContentPlaceHolder>1*>|Converts a subset of F# quotations to a LINQ expression, for the subset of LINQ expressions represented by the expression syntax in the C# language.|  
