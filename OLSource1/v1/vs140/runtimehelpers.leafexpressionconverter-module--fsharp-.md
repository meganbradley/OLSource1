...
|[QuotationToExpression](../vs140/leafexpressionconverter.quotationtoexpression-function--fsharp-.md): [Expr](../vs140/quotations.expr-class--fsharp-.md) -> <xref:System.Linq.Expressions.Expression`1?qualifyHint=False>|Converts a subset of F# quotations to a LINQ expression, for the subset of LINQ expressions represented by the expression syntax in the C# language.|  
|[QuotationToLambdaExpression](../vs140/leafexpressionconverter.quotationtolambdaexpression--t--function--fsharp-.md): [Expr](../vs140/quotations.expr--t--class--fsharp-.md)<'T> -> <xref:System.Linq.Expressions.Expression`1?qualifyHint=False><'T>|Converts a subset of F# quotations to a LINQ expression, for the subset of LINQ expressions represented by the expression syntax in the C# language.|  
