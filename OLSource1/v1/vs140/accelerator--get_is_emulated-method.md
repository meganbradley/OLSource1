...
## Return Value  
 <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> if the <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> is emulated. Otherwise, <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>.  
