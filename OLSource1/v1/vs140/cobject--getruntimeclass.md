...
---
# CObject::GetRuntimeClass
Returns the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> structure corresponding to this object's class.  
...
## Remarks  
 There is one <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> structure for each <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>-derived class. The structure members are as follows:  
...
-   **CRuntimeClass\* ( PASCAL\* m_pfn_GetBaseClass )( )** If your application is dynamically linked to the AFXDLL version of MFC, a pointer to a function that returns the <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> structure of the base class.  
  
-   **CRuntimeClass\* m_pBaseClass** If your application is statically linked to MFC, a pointer to the <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> structure of the base class.  
...
## Example  
 See [CObList::CObList](../vs140/coblist--coblist.md) for a listing of the <CodeContentPlaceHolder>6\</CodeContentPlaceHolder> class used in all <CodeContentPlaceHolder>7\</CodeContentPlaceHolder> examples.  
