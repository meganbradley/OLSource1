 ...
 *projectfolder*\obj\\<CodeContentPlaceHolder>0\</CodeContentPlaceHolder>  
 A temporary configuration-specific output directory.  
  
 *projectfolder*\obj\\<CodeContentPlaceHolder>1\</CodeContentPlaceHolder>\temp  
 Working area used by the compiler.  
  
 *projectfolder*\obj\\<CodeContentPlaceHolder>2\</CodeContentPlaceHolder>\temppe  
 Temporary assemblies used by designers at design-time are created here.  
  
 outputdir  
 The directory specified by the Output Path property. See [Build Pane, Project Designer (C#)](../vs140/build-page--project-designer--csharp-.md) for more information.  
