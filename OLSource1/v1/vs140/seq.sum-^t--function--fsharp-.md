...
## Remarks  
 The elements are summed using the <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> operator and <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> property associated with the generated type.  
