...
2.  Call [GetHiddenTextSession](assetId:///M:Microsoft.VisualStudio.TextManager.Interop.IVsHiddenTextManager.GetHiddenTextSession(System.Object,Microsoft.VisualStudio.TextManager.Interop.IVsHiddenTextSession@)?qualifyHint=False&autoUpgrade=True), passing in a pointer for a given text buffer. This returns a pointer to the <xref:Microsoft.VisualStudio.TextManager.Interop.IVsHiddenTextSession*> object for the buffer.  
  
3.  Call [QueryInterface](assetId:///M:System.Runtime.InteropServices.Marshal.QueryInterface(System.IntPtr,System.Guid@,System.IntPtr@)?qualifyHint=False&autoUpgrade=True) on <xref:Microsoft.VisualStudio.TextManager.Interop.IVsHiddenTextSession*> for a pointer to <xref:Microsoft.VisualStudio.TextManager.Interop.IVsOutliningSession*>.  
  
4.  Call assetId:///M:Microsoft.VisualStudio.TextManager.Interop.IVsOutliningSession.AddOutlineRegions(System.UInt32,System.Int32,Microsoft.VisualStudio.TextManager.Interop.NewOutlineRegion[])?qualifyHint=False&autoUpgrade=True to add one or more new outline regions at a time.  
