...
-   In the declaration, put the SAL annotation that corresponds to the return value either directly before the function identifier or before <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>.  
