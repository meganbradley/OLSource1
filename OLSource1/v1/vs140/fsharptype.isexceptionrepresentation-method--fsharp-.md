...
---
# FSharpType.IsExceptionRepresentation Method (F#)
Returns <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> if the specified type is a representation of an F# exception declaration.  
...
## Return Value  
 Returns <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> if the type checked is an F# exception.  
