...
## Remarks  
 Initializes the control size to 5080X5080 HIMETRIC units (2"X2") and initializes the <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> data member values to **NULL** or **FALSE**.  
