...
## Return Value  
 ...
 If the function fails, the return value is –1. To get extended error information, call <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>.  
