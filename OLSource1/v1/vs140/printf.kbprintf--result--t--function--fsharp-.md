...
Like [bprintf](../vs140/printf.bprintf--t--function--fsharp-.md), but calls the specified function to generate the result. See [kprintf](../vs140/printf.kprintf--result--t--function--fsharp-.md).  
...
#### Parameters  
 ...
 `builder`  
 Type: <xref:System.Text.StringBuilder?qualifyHint=False>  
  
 The input StringBuilder.  
  
 `format`  
 Type: [BuilderFormat](../vs140/printf.builderformat--t--result--type-abbreviation--fsharp-.md)`<'T,'Result>`  
