...
|Name|Description|  
|----------|-----------------|  
|<CodeContentPlaceHolder>2\</CodeContentPlaceHolder>|The amount to resize horizontally, as a percentage.|  
|<CodeContentPlaceHolder>3\</CodeContentPlaceHolder>|The amount to resize vertically, as a percentage.|  
