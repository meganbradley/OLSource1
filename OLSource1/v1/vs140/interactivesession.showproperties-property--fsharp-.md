...
ms.topic: "reference"
f1_keywords: 
  - "Microsoft.FSharp.Compiler.Interactive.InteractiveSession.ShowProperties"
dev_langs: 
  - "FSharp"
helpviewer_keywords: 
  - "ShowProperties property [F#]"
  - "InteractiveSession.ShowProperties property [F#]"
ms.assetid: d9bdf52d-1cf7-4808-ac4e-e151ec921c4d
...
---
# InteractiveSession.ShowProperties Property (F#)
When set to <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>, disables the display of properties of evaluated objects in the output of the interactive session.  
