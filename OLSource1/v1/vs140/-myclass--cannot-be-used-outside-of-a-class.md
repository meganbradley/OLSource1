...
You have used the <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> keyword outside a class structure.  
  
 **Error ID:** BC30470  
  
### To correct this error  
  
-   Move the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> declaration into your class structure.  
