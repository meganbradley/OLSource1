...
The <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> object allows you to access special directories, such as the **MyDocuments** directory.  
  
## Procedure  
  
#### To write new text files in the My Documents directory  
  
1.  Use the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> property to supply the path.  
...
2.  Use the <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> method to write text to the specified file.  
...
## Compiling the Code  
 Replace <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> with the name of the file you want to write to.  
