...
## Defining the Glyph  
 Define a glyph by implementing the <xref:Microsoft.VisualStudio.Text.Editor.IGlyphFactory?qualifyHint=False> interface.  
...
3.  Add a class named `TodoGlyphFactory` that implements <xref:Microsoft.VisualStudio.Text.Editor.IGlyphFactory?qualifyHint=False>.  
...
6.  Add a class named `TodoGlyphFactoryProvider` that implements <xref:Microsoft.VisualStudio.Text.Editor.IGlyphFactoryProvider?qualifyHint=False>. Export this class with a <xref:Microsoft.VisualStudio.Utilities.NameAttribute?qualifyHint=False> of "TodoGlyph", an <xref:Microsoft.VisualStudio.Utilities.OrderAttribute?qualifyHint=False> of After VsTextMarker, a <xref:Microsoft.VisualStudio.Utilities.ContentTypeAttribute?qualifyHint=False> of "code", and a <xref:Microsoft.VisualStudio.Text.Tagging.TagTypeAttribute?qualifyHint=False> of TodoTag.  
...
7.  Implement the <xref:Microsoft.VisualStudio.Text.Editor.IGlyphFactoryProvider.GetGlyphFactory?qualifyHint=False> method by instantiating the `TodoGlyphFactory`.  
...
4.  Modify the class named `TodoTagger` that implements <xref:Microsoft.VisualStudio.Text.Tagging.ITagger`1?qualifyHint=False> of type `TodoTag`.  
  
     [!code[VSSDKTodoGlyphTest#9](../vs140/codesnippet/CSharp/walkthrough--creating-a-margin-glyph_9.cs)]
[!code[VSSDKTodoGlyphTest#9](../vs140/codesnippet/VisualBasic/walkthrough--creating-a-margin-glyph_9.vb)]
  
  
5.  To the `TodoTagger` class, add private fields for an <xref:Microsoft.VisualStudio.Text.Classification.IClassifier?qualifyHint=False> and for the text to find in the classification spans.  
  
     [!code[VSSDKTodoGlyphTest#10](../vs140/codesnippet/CSharp/walkthrough--creating-a-margin-glyph_10.cs)]
[!code[VSSDKTodoGlyphTest#10](../vs140/codesnippet/VisualBasic/walkthrough--creating-a-margin-glyph_10.vb)]
  
  
6.  Add a constructor that sets the classifier.  
  
     [!code[VSSDKTodoGlyphTest#11](../vs140/codesnippet/CSharp/walkthrough--creating-a-margin-glyph_11.cs)]
[!code[VSSDKTodoGlyphTest#11](../vs140/codesnippet/VisualBasic/walkthrough--creating-a-margin-glyph_11.vb)]
  
  
7.  Implement the <xref:Microsoft.VisualStudio.Text.Tagging.ITagger`1.GetTags?qualifyHint=False> method by finding all the classification spans whose names include the word "comment" and whose text includes the search text. Whenever the search text is found, yield back a new <xref:Microsoft.VisualStudio.Text.Tagging.TagSpan`1?qualifyHint=False> of type `TodoTag`.  
  
     [!code[VSSDKTodoGlyphTest#12](../vs140/codesnippet/CSharp/walkthrough--creating-a-margin-glyph_12.cs)]
[!code[VSSDKTodoGlyphTest#12](../vs140/codesnippet/VisualBasic/walkthrough--creating-a-margin-glyph_12.vb)]
  
  
8.  Declare a `TagsChanged` event.  
  
     [!code[VSSDKTodoGlyphTest#13](../vs140/codesnippet/CSharp/walkthrough--creating-a-margin-glyph_13.cs)]
[!code[VSSDKTodoGlyphTest#13](../vs140/codesnippet/VisualBasic/walkthrough--creating-a-margin-glyph_13.vb)]
  
  
9. Add a class named `TodoTaggerProvider` that implements <xref:Microsoft.VisualStudio.Text.Tagging.ITaggerProvider?qualifyHint=False>, and export it with a <xref:Microsoft.VisualStudio.Utilities.ContentTypeAttribute?qualifyHint=False> of "code" and a <xref:Microsoft.VisualStudio.Text.Tagging.TagTypeAttribute?qualifyHint=False> of TodoTag.  
  
     [!code[VSSDKTodoGlyphTest#14](../vs140/codesnippet/CSharp/walkthrough--creating-a-margin-glyph_14.cs)]
[!code[VSSDKTodoGlyphTest#14](../vs140/codesnippet/VisualBasic/walkthrough--creating-a-margin-glyph_14.vb)]
  
  
10. Import the <xref:Microsoft.VisualStudio.Text.Classification.IClassifierAggregatorService?qualifyHint=False>.  
  
     [!code[VSSDKTodoGlyphTest#15](../vs140/codesnippet/CSharp/walkthrough--creating-a-margin-glyph_15.cs)]
[!code[VSSDKTodoGlyphTest#15](../vs140/codesnippet/VisualBasic/walkthrough--creating-a-margin-glyph_15.vb)]
  
  
11. Implement the <xref:Microsoft.VisualStudio.Text.Tagging.ITaggerProvider.CreateTagger``1?qualifyHint=False> method by instantiating the `TodoTagger`.  
