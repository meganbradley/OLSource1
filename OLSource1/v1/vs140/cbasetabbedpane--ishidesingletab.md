...
## Return Value  
 <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> if the tab window is not shown when there is only one visible tab; otherwise, <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>.  
