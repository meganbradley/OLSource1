 ...
 **A:**  <xref:Microsoft.VisualStudio.Shell.Interop.IUIHostLocale2.GetUILocale?qualifyHint=False> or <xref:Microsoft.VisualStudio.Shell.Interop.IUIHostLocale.GetUILocale?qualifyHint=False>will return the LCID of [!INCLUDE[vsprvs](../vs140/includes/vsprvs_md.md)] currently in use.  
