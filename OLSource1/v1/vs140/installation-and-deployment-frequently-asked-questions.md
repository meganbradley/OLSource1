 ...
 **A:**  [GetUILocale](assetId:///M:Microsoft.VisualStudio.Shell.Interop.IUIHostLocale2.GetUILocale(System.UInt32@)?qualifyHint=False&autoUpgrade=True) or [GetUILocale](assetId:///M:Microsoft.VisualStudio.Shell.Interop.IUIHostLocale.GetUILocale(System.UInt32@)?qualifyHint=False&autoUpgrade=True)will return the LCID of [!INCLUDE[vsprvs](../vs140/includes/vsprvs_md.md)] currently in use.  
