...
## Return Value  
 The **dwMask** data member of <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>. It specifies the character formatting attributes that are consistent throughout the current selection.  
  
## Remarks  
 The <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> parameter receives the attributes of the first character in the current selection. The return value specifies which attributes are consistent throughout the selection.  
