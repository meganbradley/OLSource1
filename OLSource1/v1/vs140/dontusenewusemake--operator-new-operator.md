...
## Return Value  
 Provides a way to pass additional arguments if you overload operator <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>.  
  
## Remarks  
 Overloads operator <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> and prevents it from being used in RuntimeClass.  
