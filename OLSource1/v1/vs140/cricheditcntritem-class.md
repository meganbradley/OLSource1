...
|Name|Description|  
|----------|-----------------|  
|[CRichEditCntrItem::CRichEditCntrItem](#cricheditcntritem__cricheditcntritem)|Constructs a <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> object.|  
...
## Remarks  
 ...
 <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> maintains the text and formatting characteristic of text. <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> maintains the list of OLE client items which are in the view. <CodeContentPlaceHolder>6\</CodeContentPlaceHolder> provides container-side access to the OLE client item.  
...
##  \<a name="cricheditcntritem__cricheditcntritem">\</a>  CRichEditCntrItem::CRichEditCntrItem  
 Call this function to create a <CodeContentPlaceHolder>8\</CodeContentPlaceHolder> object and add it to the container document.  
  
<CodeContentPlaceHolder>1\</CodeContentPlaceHolder>  
### Parameters  
 *preo*  
 Pointer to an                                 [REOBJECT](http://msdn.microsoft.com/library/windows/desktop/bb787946) structure which describes an OLE item. The new <CodeContentPlaceHolder>9\</CodeContentPlaceHolder> object is constructed around this OLE item. If                                 *preo* is **NULL**, the client item is empty.  
  
 <CodeContentPlaceHolder>10\</CodeContentPlaceHolder>  
 Pointer to the container document that will contain this item. If <CodeContentPlaceHolder>11\</CodeContentPlaceHolder> is **NULL**, you must explicitly call [COleDocument::AddItem](../vs140/coledocument-class.md#coledocument__additem) to add this client item to a document.  
