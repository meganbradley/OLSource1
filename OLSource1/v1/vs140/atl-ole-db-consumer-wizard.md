...
> [!NOTE]
>  This wizard requires you to click the **Data Source** button to select a data source before entering names in the <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> and **.h file** fields.  
...
-   **All** tab  
     ...
     **Provider**  
     Select an appropriate provider to manage the connection to the data source. The type of provider is typically determined by the type of database to which you are connecting. Click the <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> button or click the **Connection** tab.  
...
-   If you select a consumer **Type** of Table, the wizard uses the <CodeContentPlaceHolder>7\</CodeContentPlaceHolder> and **db_table** attributes to create the table and table accessor class declarations, and uses **db_column** to create the column map, for example:  
  
<CodeContentPlaceHolder>0\</CodeContentPlaceHolder>  
     instead of using the <CodeContentPlaceHolder>8\</CodeContentPlaceHolder> template class to declare the table and table accessor class, and the BEGIN_COLUMN_MAP and END_COLUMN_MAP macros to create the column map, for example:  
  
<CodeContentPlaceHolder>1\</CodeContentPlaceHolder>  
-   If you select a consumer **Type** of Command, the wizard uses the <CodeContentPlaceHolder>9\</CodeContentPlaceHolder> and **db_command** attributes, and uses **db_column** to create the column map, for example:  
 ...
 **Type**  
 Select one of these radio buttons to specify whether the consumer class will be derived from <CodeContentPlaceHolder>10\</CodeContentPlaceHolder> or <CodeContentPlaceHolder>11\</CodeContentPlaceHolder> (default).  
  
 **Table**  
 Select this option if you want to use <CodeContentPlaceHolder>12\</CodeContentPlaceHolder> or **db_table** to create the table and table accessor class declarations.  
  
 **Command**  
 Select this option if you want to use <CodeContentPlaceHolder>13\</CodeContentPlaceHolder> or **db_command** to create the command and command accessor class declarations. This is the default selection.  
