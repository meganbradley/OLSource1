...
Prints a formatted string to the Visual Studio output window. It is called from a function with the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> restriction clause. When the AMP runtime detects the call, it raises a [runtime_exception](../vs140/runtime_exception-class.md) exception with the same formatting string.  
