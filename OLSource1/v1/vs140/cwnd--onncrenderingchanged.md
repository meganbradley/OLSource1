...
|---------------|-----------------|  
|[in] <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>|<CodeContentPlaceHolder>2\</CodeContentPlaceHolder> if Desktop Window Manager (DWM) rendering is enabled for the nonclient area of the window; <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> if rendering is disabled.|  
