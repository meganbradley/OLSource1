...
---
# CRegKey::Create
Call this method to create the specified key, if it does not exist as a subkey of <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>.  
...
#### Parameters  
 ...
 Specifies the name of a key to be created or opened. This name must be a subkey of <CodeContentPlaceHolder>4\</CodeContentPlaceHolder>.  
