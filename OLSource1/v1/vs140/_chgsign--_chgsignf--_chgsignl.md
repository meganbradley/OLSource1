...
## Return Value  
 The <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> functions return a value that's equal to the floating-point argument <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>, but with its sign reversed. There is no error return.  
  
## Requirements  
  
|Routine|Required header|  
|-------------|---------------------|  
|<CodeContentPlaceHolder>4\</CodeContentPlaceHolder>|\<float.h>|  
|<CodeContentPlaceHolder>5\</CodeContentPlaceHolder>, <CodeContentPlaceHolder>6\</CodeContentPlaceHolder>|\<math.h>|  
