...
ms.topic: "reference"
f1_keywords: 
  - "Microsoft.FSharp.Compiler.Interactive.IEventLoop.Run"
dev_langs: 
  - "FSharp"
helpviewer_keywords: 
...
---
# IEventLoop.Run Method (F#)
Runs the event loop. A return of <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> indicates that the event loop was restarted.  
