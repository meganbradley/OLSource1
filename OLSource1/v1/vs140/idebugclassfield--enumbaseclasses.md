...
## Return Value  
 If successful, returns S_OK, returns S_SH_NO_BASE_CLASSES if there are no base classes (and the <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> parameter is set to a null value); otherwise, returns an error code.  
...
<CodeContentPlaceHolder>2\</CodeContentPlaceHolder>  
 The enumeration would return the base classes in the order <CodeContentPlaceHolder>5\</CodeContentPlaceHolder>, <CodeContentPlaceHolder>6\</CodeContentPlaceHolder>, <CodeContentPlaceHolder>7\</CodeContentPlaceHolder>.  
