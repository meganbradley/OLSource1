...
#### Parameters  
 ...
 `beginAction`  
 Type: `'Arg1 * 'Arg2 * 'Arg3 *` <xref:System.AsyncCallback?qualifyHint=False> `*` [obj](../vs140/core.obj-type-abbreviation--fsharp-.md) `->` <xref:System.IAsyncResult?qualifyHint=False>  
