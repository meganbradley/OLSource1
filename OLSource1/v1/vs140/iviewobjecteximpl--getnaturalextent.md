...
## Remarks  
 If <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> is <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> and *pExtentInfo->dwExtentMode* is **DVEXTENT_CONTENT**, sets *<CodeContentPlaceHolder>3\</CodeContentPlaceHolder> to the control class's data member [CComControlBase::m_sizeNatural](../vs140/ccomcontrolbase--m_sizenatural.md). Otherwise, returns an error <CodeContentPlaceHolder>4\</CodeContentPlaceHolder>.  
