...
## Methods for Adding Content  
 The following methods add child content to an <xref:System.Xml.Linq.XElement?qualifyHint=False> or an <xref:System.Xml.Linq.XDocument?qualifyHint=False>:  
  
|Method|Description|  
|------------|-----------------|  
|<xref:System.Xml.Linq.XContainer.Add?qualifyHint=False>|Adds content at the end of the child content of the <xref:System.Xml.Linq.XContainer?qualifyHint=False>.|  
|<xref:System.Xml.Linq.XContainer.AddFirst?qualifyHint=False>|Adds content at the beginning of the child content of the <xref:System.Xml.Linq.XContainer?qualifyHint=False>.|  
 ...
 The following methods add content as sibling nodes of an <xref:System.Xml.Linq.XNode?qualifyHint=False>. The most common node to which you add sibling content is <xref:System.Xml.Linq.XElement?qualifyHint=False>, although you can add valid sibling content to other types of nodes such as <xref:System.Xml.Linq.XText?qualifyHint=False> or <xref:System.Xml.Linq.XComment?qualifyHint=False>.  
