...
2.  Navigate to the node <CodeContentPlaceHolder>0\</CodeContentPlaceHolder>.  
  
3.  Set the string value <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> to the full path and filename of your preferred custom log location.  
  
     This location must be in a directory to which the user has write access. For example, on Windows Vista, create the following folder structure and set <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> to C:\Users\\<username\>\Documents\Logs\ClickOnce\installation.log.  
