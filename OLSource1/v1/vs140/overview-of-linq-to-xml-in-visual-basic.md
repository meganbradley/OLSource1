...
## XML Namespaces  
 ...
 You can retrieve an <xref:System.Xml.Linq.XNamespace?qualifyHint=False> object for a particular namespace prefix by using the [GetXmlNamespace Operator](../vs140/getxmlnamespace-operator--visual-basic-.md).  
...
### Using XML Namespaces in XML Literals  
 The following example shows how to create an <xref:System.Xml.Linq.XElement?qualifyHint=False> object that uses the global namespace `ns`:  
