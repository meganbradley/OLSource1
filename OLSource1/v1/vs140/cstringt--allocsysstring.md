...
---
# CStringT::AllocSysString
Allocates an Automation-compatible string of the type <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> and copies the contents of the <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> object into it, including the terminating null character.  
...
## Example  
 The following example demonstrates the use of <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>.  
