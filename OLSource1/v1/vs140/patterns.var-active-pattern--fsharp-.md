...
apitype: "Assembly"
f1_keywords: 
  - "Microsoft.FSharp.Quotations.PatternsModule.VarPattern"
dev_langs: 
  - "FSharp"
helpviewer_keywords: 
  - "Var active pattern [F#]"
...
## Return Value  
 The formal return type is <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>. The option indicates whether the input results in a match. In a pattern matching expression, the input is represented as a [Var](../vs140/quotations.var-class--fsharp-.md) object that represents a local value or variable.  
