...
|Feature|Description|  
|-------------|-----------------|  
|Expression evaluators|Supports the [!INCLUDE[vsprvs](../vs140/includes/vsprvs_md.md)] debugger by validating breakpoints and supplying a list of expressions to be displayed in the **Autos** debug window.<br /><br /> For more information, see [Debugger and Language Overview](../vs140/language-service-support-for-debugging.md).|  
