...
#### Parameters  
 ...
 <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> if the separator is horizontal, <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> if the separator is vertical.  
  
## Remarks  
 [CMFCToolBar::DoPaint](../vs140/cmfctoolbar--dopaint.md) calls this method for each [CMFCToolBar::DrawSeparator](../vs140/cmfctoolbar--drawseparator.md) object that has the <CodeContentPlaceHolder>6\</CodeContentPlaceHolder> style, instead of calling [CMFCToolBar::DrawButton](../vs140/cmfctoolbar--drawbutton.md) for those buttons.  
