...
## Return Value  
 A pointer to the ribbon element if <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> points to the current object; otherwise <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>.  
