...
## In This Section  
 ...
 Discusses a new feature called <CodeContentPlaceHolder>0\</CodeContentPlaceHolder>, which provides access to information and default object instances that are related to an application and its run-time environment.  
 ...
 [Creating and Using Components in Visual Basic](../vs140/creating-and-using-components-in-visual-basic.md)  
 ...
 [Windows Forms Application Basics (Visual Basic)](../vs140/windows-forms-application-basics--visual-basic-.md)  
 Provides information about creating Windows Forms applications by using Visual Studio.  
  
 [Customizing Projects and Extending My with Visual Basic](../vs140/customizing-projects-and-extending-my-with-visual-basic.md)  
 Describes how you can customize project templates to provide additional <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> objects.  
