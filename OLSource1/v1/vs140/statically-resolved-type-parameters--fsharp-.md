...
helpviewer_keywords: 
  ...
  - "type parameters [F#], statically resolved"
  - "hat type parameters [F#]"
...
|-------------|-------------|-------------------------|  
|Syntax|<CodeContentPlaceHolder>7\</CodeContentPlaceHolder>, <CodeContentPlaceHolder>8\</CodeContentPlaceHolder>|<CodeContentPlaceHolder>9\</CodeContentPlaceHolder>, <CodeContentPlaceHolder>10\</CodeContentPlaceHolder>|  
...
|Use with inline functions|No. An inline function cannot be parameterized with a standard generic type parameter.|Yes. Statically resolved type parameters cannot be used on functions or methods that are not inline.|  
 ...
 [!code[FsLangRef3#401](../vs140/codesnippet/FSharp/statically-resolved-type-parameters--fsharp-_1.fs)]  
  
 The resolved type of <CodeContentPlaceHolder>11\</CodeContentPlaceHolder> is based on the use of both <CodeContentPlaceHolder>12\</CodeContentPlaceHolder> and <CodeContentPlaceHolder>13\</CodeContentPlaceHolder>, both of which cause type inference to infer member constraints on the statically resolved type parameters. The resolved type, as shown in the F# interpreter, is as follows.  
...
## See Also  
 ...
 [Inline Functions](../vs140/inline-functions--fsharp-.md)