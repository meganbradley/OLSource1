...
> [!NOTE]
>  This option and the [/win32res (Import a Win32 Resource File) (C# Compiler Options)](../vs140/-win32res--csharp-compiler-options-.md) option are mutually exclusive. If you try to use both options in the same command line you will get a build error.  
...
## See Also  
 ...
 [/nowin32manifest](../vs140/-nowin32manifest--csharp-compiler-options-.md)   
