...
## Options Page Registry Path  
 ...
 [!code[VSSDKSupportForOptionsPages#1](../vs140/codesnippet/CSharp/options-and-options-pages_1.cs)][!code[VSSDKSupportForOptionsPages#1](../vs140/codesnippet/VisualBasic/options-and-options-pages_1.vb)]  
...
## Tools/Options Page Attributes and Layout  
 ...
 [!code[VSSDKSupportForOptionsPages#2](../vs140/codesnippet/CSharp/options-and-options-pages_2.cs)][!code[VSSDKSupportForOptionsPages#2](../vs140/codesnippet/VisualBasic/options-and-options-pages_2.vb)]  
...
-   <xref:System.ComponentModel.DescriptionAttribute*> determines the description of the option.  
 ...
 [!code[VSSDKSupportForOptionsPages#3](../vs140/codesnippet/CSharp/options-and-options-pages_3.cs)][!code[VSSDKSupportForOptionsPages#3](../vs140/codesnippet/VisualBasic/options-and-options-pages_3.vb)]  
...
## Accessing Options Pages from Another VSPackage  
 ...
 [!code[VSSDKSupportForOptionsPages#4](../vs140/codesnippet/CSharp/options-and-options-pages_4.cs)][!code[VSSDKSupportForOptionsPages#4](../vs140/codesnippet/VisualBasic/options-and-options-pages_4.vb)]  
  
 The following code fragment gets the value of OptionInteger from MyOptionPage:  
  
 [!code[VSSDKSupportForOptionsPages#5](../vs140/codesnippet/CSharp/options-and-options-pages_5.cs)][!code[VSSDKSupportForOptionsPages#5](../vs140/codesnippet/VisualBasic/options-and-options-pages_5.vb)]  
