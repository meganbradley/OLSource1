...
|Name|Description|  
|----------|-----------------|  
|[CStatic::CStatic](#cstatic__cstatic)|Constructs a <CodeContentPlaceHolder>13\</CodeContentPlaceHolder> object.|  
  
### Public Methods  
  
|Name|Description|  
|----------|-----------------|  
|[CStatic::Create](#cstatic__create)|Creates the Windows static control and attaches it to the <CodeContentPlaceHolder>14\</CodeContentPlaceHolder> object.|  
...
## Remarks  
 ...
 Create a static control in two steps. First, call the constructor to construct the <CodeContentPlaceHolder>15\</CodeContentPlaceHolder> object, then call the [Create](#cstatic__create) member function to create the static control and attach it to the <CodeContentPlaceHolder>16\</CodeContentPlaceHolder> object.  
  
 If you create a <CodeContentPlaceHolder>17\</CodeContentPlaceHolder> object within a dialog box (through a dialog resource), the <CodeContentPlaceHolder>18\</CodeContentPlaceHolder> object is automatically destroyed when the user closes the dialog box.  
  
 If you create a <CodeContentPlaceHolder>19\</CodeContentPlaceHolder> object within a window, you may also need to destroy it. A <CodeContentPlaceHolder>20\</CodeContentPlaceHolder> object created on the stack within a window is automatically destroyed. If you create the <CodeContentPlaceHolder>21\</CodeContentPlaceHolder> object on the heap by using the **new** function, you must call **delete** on the object to destroy it when you are done with it.  
...
##  \<a name="cstatic__create">\</a>  CStatic::Create  
 Creates the Windows static control and attaches it to the <CodeContentPlaceHolder>23\</CodeContentPlaceHolder> object.  
...
### Parameters  
 ...
 Specifies the position and size of the static control. It can be either a <CodeContentPlaceHolder>27\</CodeContentPlaceHolder> structure or a <CodeContentPlaceHolder>28\</CodeContentPlaceHolder> object.  
  
 <CodeContentPlaceHolder>29\</CodeContentPlaceHolder>  
 Specifies the <CodeContentPlaceHolder>30\</CodeContentPlaceHolder> parent window, usually a <CodeContentPlaceHolder>31\</CodeContentPlaceHolder> object. It must not be **NULL**.  
...
### Remarks  
 Construct a <CodeContentPlaceHolder>33\</CodeContentPlaceHolder> object in two steps. First, call the constructor <CodeContentPlaceHolder>34\</CodeContentPlaceHolder>, and then call **Create**, which creates the Windows static control and attaches it to the <CodeContentPlaceHolder>35\</CodeContentPlaceHolder> object.  
...
##  \<a name="cstatic__getbitmap">\</a>  CStatic::GetBitmap  
 Gets the handle of the bitmap, previously set with [SetBitmap](#cstatic__setbitmap), that is associated with <CodeContentPlaceHolder>38\</CodeContentPlaceHolder>.  
...
##  \<a name="cstatic__getcursor">\</a>  CStatic::GetCursor  
 Gets the handle of the cursor, previously set with [SetCursor](#cstatic__setcursor), that is associated with <CodeContentPlaceHolder>39\</CodeContentPlaceHolder>.  
...
##  \<a name="cstatic__getenhmetafile">\</a>  CStatic::GetEnhMetaFile  
 Gets the handle of the enhanced metafile, previously set with [SetEnhMetafile](#cstatic__setenhmetafile), that is associated with <CodeContentPlaceHolder>40\</CodeContentPlaceHolder>.  
...
##  \<a name="cstatic__geticon">\</a>  CStatic::GetIcon  
 Gets the handle of the icon, previously set with [SetIcon](#cstatic__seticon), that is associated with <CodeContentPlaceHolder>41\</CodeContentPlaceHolder>.  
...
### Return Value  
 The handle of the bitmap that was previously associated with the static control, or <CodeContentPlaceHolder>43\</CodeContentPlaceHolder> if no bitmap was associated with the static control.  
...
-   MFC provides the class <CodeContentPlaceHolder>44\</CodeContentPlaceHolder>, which you can use when you have to do more with a bitmap image than just call the Win32 function <CodeContentPlaceHolder>45\</CodeContentPlaceHolder>. <CodeContentPlaceHolder>46\</CodeContentPlaceHolder>, which contains one kind of GDI object, is often used in cooperation with <CodeContentPlaceHolder>47\</CodeContentPlaceHolder>, which is a <CodeContentPlaceHolder>48\</CodeContentPlaceHolder> class that is used for displaying a graphic object as a static control.  
  
 <CodeContentPlaceHolder>49\</CodeContentPlaceHolder> is an ATL/MFC class that lets you more easily work with device independent bitmaps (DIB). For more information, see [CImage Class](../vs140/cimage-class.md).  
  
-   Typical usage is to give <CodeContentPlaceHolder>50\</CodeContentPlaceHolder> a GDI object that is returned by the HBITMAP operator of a <CodeContentPlaceHolder>51\</CodeContentPlaceHolder> or <CodeContentPlaceHolder>52\</CodeContentPlaceHolder> object. The code to do this resembles the following line.  
  
<CodeContentPlaceHolder>9\</CodeContentPlaceHolder>  
 The following example creates two <CodeContentPlaceHolder>53\</CodeContentPlaceHolder> objects on the heap. It then loads one with a system bitmap using <CodeContentPlaceHolder>54\</CodeContentPlaceHolder> and the other from a file using <CodeContentPlaceHolder>55\</CodeContentPlaceHolder>.  
