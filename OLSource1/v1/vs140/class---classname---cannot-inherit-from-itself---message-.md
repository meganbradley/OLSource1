...
1.  Check the spelling of the class name in the <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> statement.  
  
2.  If you do not intend to inherit from a different class, remove the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> statement entirely.  
