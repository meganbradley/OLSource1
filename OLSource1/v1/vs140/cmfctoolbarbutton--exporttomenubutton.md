...
## Remarks  
 ...
 The default implementation of this method returns <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>. Override this method if you want to take additional actions when the framework converts an object that is derived from [CMFCToolBarButton Class](../vs140/cmfctoolbarbutton-class.md) to a menu button.  
