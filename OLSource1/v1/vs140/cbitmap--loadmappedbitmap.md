 ...
 *nMapSize*  
 The number of color maps pointed to by <CodeContentPlaceHolder>4\</CodeContentPlaceHolder>.  
  
## Return Value  
 Nonzero if successful; otherwise 0.  
  
## Remarks  
 By default, <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> will map colors commonly used in button glyphs.  
