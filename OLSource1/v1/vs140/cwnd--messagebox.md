...
#### Parameters  
 ...
 Points to a <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> object or null-terminated string containing the message to be displayed.  
  
 <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>  
 Points to a <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> object or null-terminated string to be used for the message-box caption. If <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> is **NULL**, the default caption "Error" is used.  
