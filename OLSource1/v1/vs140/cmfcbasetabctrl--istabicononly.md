...
## Return Value  
 <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> if a tab label has only icons; <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> otherwise.  
