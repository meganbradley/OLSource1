...
|Promises|[Promises](assetId:///358ad98b-f7fa-448c-9ee0-ef1e2a45e9c6) allow easier and cleaner asynchronous coding. Promise constructors are supported, along with the <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> and <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> utility methods.|  
...
|Arrow functions|The arrow function (=>) provides shorthand syntax for the <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> keyword which features a lexical <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> binding.|  
...
|Spread operator|The [spread operator](assetId:///10263a4c-bd27-4d87-9917-fb4b6bf373db) (<CodeContentPlaceHolder>4\</CodeContentPlaceHolder>) expands iterable expressions into individual arguments. For example, <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> is approximately the same as <CodeContentPlaceHolder>6\</CodeContentPlaceHolder>.|  
