...
|||  
|-|-|  
|**Applies to**|Non-COM <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>, **class**, <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>s, <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> methods, interface members, interface parameters, <CodeContentPlaceHolder>4\</CodeContentPlaceHolder>s, **union**s, <CodeContentPlaceHolder>5\</CodeContentPlaceHolder>s|  
|**Repeatable**|Yes|  
