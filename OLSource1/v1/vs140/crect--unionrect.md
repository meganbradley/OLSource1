...
---
# CRect::UnionRect
Makes the dimensions of <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> equal to the union of the two source rectangles.  
...
#### Parameters  
 ...
 Points to a [RECT](../vs140/rect-structure.md) or <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> that contains a source rectangle.  
  
 <CodeContentPlaceHolder>4\</CodeContentPlaceHolder>  
 Points to a <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> or <CodeContentPlaceHolder>6\</CodeContentPlaceHolder> that contains a source rectangle.  
