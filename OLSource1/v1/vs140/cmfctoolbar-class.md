...
3.  Call [CBasePane::EnableDocking](../vs140/cbasepane-class.md#cbasepane__enabledocking) to specify the docking style.  
 ...
 `CMFCToolBar` is the base class for the MFC Library classes [CMFCMenuBar](../vs140/cmfcmenubar-class.md), [CMFCPopupMenuBar](../vs140/cmfcpopupmenubar-class.md), and [CMFCDropDownToolBar](../vs140/cmfcdropdowntoolbar-class.md).  
...
### Remarks  
 ...
 For more information about the `nGrayImagePercentage` parameter, see [CMFCToolBarImages::GrayImages](../vs140/cmfctoolbarimages-class.md#cmfctoolbarimages__grayimages).  
...
### Remarks  
 This method extends the base class implementation, [CBasePane::EnableDocking](../vs140/cbasepane-class.md#cbasepane__enabledocking), by setting the `CBasePane::m_dwControlBarStyle` data member to `AFX_CBRS_FLOAT`. This method then passes `dwAlignment` to the base class implementation.  
...
### Remarks  
 The framework calls this method when it updates the client area that is associated with a toolbar button. It calls the [CWnd::InvalidateRect](../vs140/cwnd-class.md#cwnd__invalidaterect) method with the client rectangle of the `CMFCToolBarButton` object that exists at the provided index.  
...
### Remarks  
 This method posts a `WM_COMMAND` message to the window that owns the toolbar by calling [CWnd::PostMessage](../vs140/cwnd-class.md#cwnd__postmessage) and passing the command ID of the specified button as the `wParam` parameter.  
