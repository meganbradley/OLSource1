...
2.  Copy the DLL to either of the following locations:  
    ...
    -   *VisualStudioInstallPath* <CodeContentPlaceHolder>0\</CodeContentPlaceHolder>  
  
    -   <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> *VisualStudioVersion* <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>  
