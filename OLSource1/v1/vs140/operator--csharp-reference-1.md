...
Square brackets (<CodeContentPlaceHolder>0\</CodeContentPlaceHolder>) are used for arrays, indexers, and attributes. They can also be used with pointers.  
  
## Remarks  
 An array type is a type followed by <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>:  
 ...
 For example, the .NET Framework defines a <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> type that associates keys and values of arbitrary type:  
