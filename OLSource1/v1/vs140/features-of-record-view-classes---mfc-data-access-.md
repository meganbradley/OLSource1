...
You can do form-based data-access programming with class [CFormView](../vs140/cformview-class.md), but [CRecordView](../vs140/crecordview-class.md) and [CDaoRecordView](../vs140/cdaorecordview-class.md) are generally better classes to derive from. In addition to their <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> features, <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> and <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>:  
