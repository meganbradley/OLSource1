...
4.  Start the profiler. Type:  
    ...
    |[/counter](../vs140/counter.md) **:** <CodeContentPlaceHolder>8\</CodeContentPlaceHolder>|Collects information from the processor performance counter that is specified in Config. Counter information is added to the data that is collected at each profiling event.|  
    |[events](../vs140/events--vsperfcmd-.md) **:** <CodeContentPlaceHolder>9\</CodeContentPlaceHolder>|Specifies an Event Tracing for Windows (ETW) event to be collected during profiling. ETW events are collected in a separate (.etl) file.|  
...
-   The following pairs of **VSPerfCmd** options start and stop data collection. Specify each option on a separate command line. You can turn data collection on and off multiple times.  
    ...
    |[/processon](../vs140/processon-and-processoff.md) **:** <CodeContentPlaceHolder>10\</CodeContentPlaceHolder> [/processoff](../vs140/processon-and-processoff.md) **:** <CodeContentPlaceHolder>11\</CodeContentPlaceHolder>|Starts (**/processon**) or stops (**/processoff**) data collection for the process that is specified by the process ID (<CodeContentPlaceHolder>12\</CodeContentPlaceHolder>).|  
    |[/threadon](../vs140/threadon-and-threadoff.md) **:** <CodeContentPlaceHolder>13\</CodeContentPlaceHolder> [/threadoff](../vs140/threadon-and-threadoff.md) **:** <CodeContentPlaceHolder>14\</CodeContentPlaceHolder>|Starts (**/threadon**) or stops (**/threadoff**) data collection for the thread that is specified by the thread ID (<CodeContentPlaceHolder>15\</CodeContentPlaceHolder>).|  
