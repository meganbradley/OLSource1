...
## Example  
 The following example is composed of a library type (<CodeContentPlaceHolder>0\</CodeContentPlaceHolder>) with unsecured fields, a type (<CodeContentPlaceHolder>1\</CodeContentPlaceHolder>) that can create instances of the library type and mistaken passes instances to types do not have permission to create them, and application code that can read an instance's fields even though it does not have the permission that secures the type.  
  
 The following library code violates the rule.  
  
 [!code[FxCop.Security.LinkDemandOnField#1](../vs140/codesnippet/CSharp/ca2112--secured-types-should-not-expose-fields_1.cs)]  
...
## Example  
 ...
 [!code[FxCop.Security.LDOnFieldsDistributor#1](../vs140/codesnippet/CSharp/ca2112--secured-types-should-not-expose-fields_2.cs)]  
...
## Example  
 ...
 [!code[FxCop.Security.TestLinkDemandOnFields#1](../vs140/codesnippet/CSharp/ca2112--secured-types-should-not-expose-fields_3.cs)]  
