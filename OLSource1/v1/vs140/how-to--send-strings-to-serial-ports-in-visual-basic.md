...
## Example  
 ...
 Use the `My.Computer.Ports.OpenSerialPort` method to obtain a reference to the port. For more information, see <xref:Microsoft.VisualBasic.Devices.Ports.OpenSerialPort?qualifyHint=False>.  
 ...
 The <xref:System.IO.Ports.SerialPort.WriteLine?qualifyHint=False> method sends the data to the serial port.  
