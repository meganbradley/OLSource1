...
## Remarks  
 For a color bitmap, either the <CodeContentPlaceHolder>6\</CodeContentPlaceHolder> or <CodeContentPlaceHolder>7\</CodeContentPlaceHolder> parameter should be set to 1. If both of these parameters are set to 1, <CodeContentPlaceHolder>8\</CodeContentPlaceHolder> creates a monochrome bitmap.  
 ...
 When you finish with the <CodeContentPlaceHolder>9\</CodeContentPlaceHolder> object created by the <CodeContentPlaceHolder>10\</CodeContentPlaceHolder> function, first select the bitmap out of the device context, then delete the <CodeContentPlaceHolder>11\</CodeContentPlaceHolder> object.  
