...
This example shows how LINQ can be used to perform advanced grouping and sorting operations on lists of files or folders. It also shows how to page output in the console window by using the <xref:System.Linq.Enumerable.Skip``1?qualifyHint=False> and <xref:System.Linq.Enumerable.Take``1?qualifyHint=False> methods.  
