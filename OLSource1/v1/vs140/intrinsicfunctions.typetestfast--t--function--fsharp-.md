...
A compiler intrinsic that implements the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> operator  
...
## Return Value  
 <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> if the type matches the specified type; otherwise <CodeContentPlaceHolder>4\</CodeContentPlaceHolder>.  
