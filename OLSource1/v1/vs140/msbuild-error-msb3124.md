...
-   Remove [\<fileAssociation> Element](../vs140/clickonce-deployment-manifest.md)<CodeContentPlaceHolder>0\</CodeContentPlaceHolder> attributes that are not unique. Each listed \<fileAssociation> element's extension attributes must be unique.  
