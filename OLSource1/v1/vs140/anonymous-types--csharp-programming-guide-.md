...
## Remarks  
 ...
 Because the <xref:System.Object.Equals?qualifyHint=False> and <xref:System.Object.GetHashCode?qualifyHint=False> methods on anonymous types are defined in terms of the `Equals` and `GetHashCode` methods of the properties, two instances of the same anonymous type are equal only if all their properties are equal.  
