...
---
# CInternetFile::SetReadBufferSize
Call this member function to set the size of the temporary read buffer used by a <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>-derived object.  
...
## Remarks  
 ...
 By default, a <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> object does not provide any buffering for reading. If you call this member function, you must be sure that the file has been opened for read access.  
  
 You can increase the buffer size at any time, but shrinking the buffer will have no effect. If you call [ReadString](../vs140/cinternetfile--readstring.md) without first calling <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>, you will get a buffer of 4096 bytes.  
