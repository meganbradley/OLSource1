...
## Remarks  
 <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> allows an application to retrieve the current reporting function for the C run-time debug library reporting process.  
...
## Example  
 For a sample of how to use <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>, see [report](assetId:///f6e08c30-6bd9-459a-830a-56deec0d2051).  
