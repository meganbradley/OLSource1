...
## Remarks  
 <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> is a convenience macro that calls the macros [BEGIN_MSG_MAP](../vs140/begin_msg_map.md) and [END_MSG_MAP](../vs140/end_msg_map.md) to create an empty message map:  
