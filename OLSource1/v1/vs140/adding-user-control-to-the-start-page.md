...
2.  In the **XAML** pane, add the following namespace declaration to the top-level <xref:System.Windows.Controls.Grid?qualifyHint=False> element.  
...
3.  In the **XAML** pane, scroll to the <Grid\> section.  
     ...
     The section contains a <xref:System.Windows.Controls.TabControl?qualifyHint=False> element in a <xref:System.Windows.Controls.Grid?qualifyHint=False> element.  
