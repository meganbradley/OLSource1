...
#### Parameters  
 ...
 <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> to specify that the text runs horizontally; <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> to specify that the text runs vertically.  
  
## Return Value  
 <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> if this method succeeds; otherwise, <CodeContentPlaceHolder>6\</CodeContentPlaceHolder>. In debug mode, this method asserts if this method is unsuccessful.  
