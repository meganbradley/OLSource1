...
## Example  
 ...
 [!code[FxCop.Security.TypesDoNotSuppress#1](../vs140/codesnippet/CSharp/ca2118--review-suppressunmanagedcodesecurityattribute-usage_1.cs)]  
  
## Example  
 In the following example, the <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> method provides a publicly accessible code path to the platform invocation method <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>.  
  
 [!code[FxCop.Security.PInvokeAndSuppress#1](../vs140/codesnippet/CSharp/ca2118--review-suppressunmanagedcodesecurityattribute-usage_2.cs)]  
  
## Example  
 In the following example, the public method <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> causes a violation. To resolve the violation, <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> should be made private, and access to it should be through a public method secured by a security demand, as illustrated by the <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> method.  
  
 [!code[FxCop.Security.TypeInvokeAndSuppress#1](../vs140/codesnippet/CSharp/ca2118--review-suppressunmanagedcodesecurityattribute-usage_3.cs)]  
