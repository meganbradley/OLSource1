...
## Remarks  
 By default this method always returns <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>. Override this method to indicate whether the display size can be large.  
