...
|[CPrintInfo::m_pPD](#cprintinfo__m_ppd)|Contains a pointer to the <CodeContentPlaceHolder>8\</CodeContentPlaceHolder> object used for the Print dialog box.|  
...
## Remarks  
 <CodeContentPlaceHolder>9\</CodeContentPlaceHolder> is a structure and does not have a base class.  
  
 The framework creates an object of <CodeContentPlaceHolder>10\</CodeContentPlaceHolder> each time the Print or Print Preview command is chosen and destroys it when the command is completed.  
  
 <CodeContentPlaceHolder>11\</CodeContentPlaceHolder> contains information about both the print job as a whole, such as the range of pages to be printed, and the current status of the print job, such as the page currently being printed. Some information is stored in an associated [CPrintDialog](../vs140/cprintdialog-class.md) object; this object contains the values entered by the user in the Print dialog box.  
  
 A <CodeContentPlaceHolder>12\</CodeContentPlaceHolder> object is passed between the framework and your view class during the printing process and is used to exchange information between the two. For example, the framework informs the view class which page of the document to print by assigning a value to the <CodeContentPlaceHolder>13\</CodeContentPlaceHolder> member of <CodeContentPlaceHolder>14\</CodeContentPlaceHolder>; the view class retrieves the value and performs the actual printing of the specified page.  
  
 Another example is the case in which the length of the document is not known until it is printed. In this situation, the view class tests for the end of the document each time a page is printed. When the end is reached, the view class sets the <CodeContentPlaceHolder>15\</CodeContentPlaceHolder> member of <CodeContentPlaceHolder>16\</CodeContentPlaceHolder> to **FALSE**; this informs the framework to stop the print loop.  
  
 <CodeContentPlaceHolder>17\</CodeContentPlaceHolder> is used by the member functions of <CodeContentPlaceHolder>18\</CodeContentPlaceHolder> listed under "See Also." For more information about the printing architecture provided by the Microsoft Foundation Class Library, see [Frame Windows](../vs140/frame-windows.md) and [Document/View Architecture](../vs140/document-view-architecture.md) and the articles [Printing](../vs140/printing.md) and [Printing: Multipage Documents](../vs140/multipage-documents.md).  
...
### Remarks  
 This is the value specified by the user in the Print dialog box, and it is stored in the <CodeContentPlaceHolder>20\</CodeContentPlaceHolder> object referenced by the <CodeContentPlaceHolder>21\</CodeContentPlaceHolder> member. If the user has not specified a value, the default is the first page of the document.  
...
### Remarks  
 This value is stored in the <CodeContentPlaceHolder>22\</CodeContentPlaceHolder> object referenced by the <CodeContentPlaceHolder>23\</CodeContentPlaceHolder> member.  
...
### Remarks  
 This value is stored in the <CodeContentPlaceHolder>24\</CodeContentPlaceHolder> object referenced by the <CodeContentPlaceHolder>25\</CodeContentPlaceHolder> member.  
...
### Remarks  
 This is the value specified by the user in the Print dialog box, and it is stored in the <CodeContentPlaceHolder>26\</CodeContentPlaceHolder> object referenced by the <CodeContentPlaceHolder>27\</CodeContentPlaceHolder> member. If the user has not specified a value, the default is the last page of the document.  
...
### Remarks  
 If you are doing print-time pagination, you can set this member to **FALSE** in your override of <CodeContentPlaceHolder>28\</CodeContentPlaceHolder> once the end of the document has been reached. You do not have to modify this variable if you have specified the length of the document at the beginning of the print job using the <CodeContentPlaceHolder>29\</CodeContentPlaceHolder> member function. The <CodeContentPlaceHolder>30\</CodeContentPlaceHolder> member is a public variable of type **BOOL**.  
...
### Remarks  
 Data members <CodeContentPlaceHolder>31\</CodeContentPlaceHolder> and **m_nOffsetPage** are invalid unless this flag is **TRUE**.  
...
### Remarks  
 The framework calls <CodeContentPlaceHolder>32\</CodeContentPlaceHolder> and <CodeContentPlaceHolder>33\</CodeContentPlaceHolder> once for each page of the document, specifying a different value for this member each time; its values range from the value returned by <CodeContentPlaceHolder>34\</CodeContentPlaceHolder> to that returned by <CodeContentPlaceHolder>35\</CodeContentPlaceHolder>. Use this member in your overrides of <CodeContentPlaceHolder>36\</CodeContentPlaceHolder> and <CodeContentPlaceHolder>37\</CodeContentPlaceHolder> to print the specified page of the document.  
  
 When preview mode is first invoked, the framework reads the value of this member to determine which page of the document should be previewed initially. You can set the value of this member in your override of <CodeContentPlaceHolder>38\</CodeContentPlaceHolder> to maintain the user's current position in the document when entering preview mode. The <CodeContentPlaceHolder>39\</CodeContentPlaceHolder> member is a public variable of type **UINT**.  
...
### Remarks  
 This value may be **SP_ERROR** if the job hasn't yet printed (that is, if the <CodeContentPlaceHolder>40\</CodeContentPlaceHolder> object is newly constructed and has not yet been used to print), or if there was an error in starting the job.  
...
##  \<a name="cprintinfo__m_ppd">\</a>  CPrintInfo::m_pPD  
 Contains a pointer to the <CodeContentPlaceHolder>41\</CodeContentPlaceHolder> object used to display the Print dialog box for the print job.  
  
### Remarks  
 The <CodeContentPlaceHolder>42\</CodeContentPlaceHolder> member is a public variable declared as a pointer to <CodeContentPlaceHolder>43\</CodeContentPlaceHolder>.  
...
### Remarks  
 You may want to refer to this in your override of <CodeContentPlaceHolder>44\</CodeContentPlaceHolder>. You can use this member to keep track of what area remains usable after you print headers, footers, and so on. The **m_rectDraw** member is a public variable of type <CodeContentPlaceHolder>45\</CodeContentPlaceHolder>.  
...
### Remarks  
 The framework uses "Page %u\nPages %u-%u\n" as the default value. If you want a different format for the page numbers, specify a format string in your override of <CodeContentPlaceHolder>46\</CodeContentPlaceHolder>. The **m_strPageDesc** member is a public variable of type <CodeContentPlaceHolder>47\</CodeContentPlaceHolder>.  
...
### Remarks  
 This value is stored in the <CodeContentPlaceHolder>48\</CodeContentPlaceHolder> object referenced by the <CodeContentPlaceHolder>49\</CodeContentPlaceHolder> member. If the length of the document is known before it is printed, call this function from your override of <CodeContentPlaceHolder>50\</CodeContentPlaceHolder>. If the length of the document depends on a setting specified by the user in the Print dialog box, call this function from your override of <CodeContentPlaceHolder>51\</CodeContentPlaceHolder>. If the length of the document is not known until it is printed, use the <CodeContentPlaceHolder>52\</CodeContentPlaceHolder> member to control the print loop.  
...
### Remarks  
 Page numbers normally start at 1. This value is stored in the <CodeContentPlaceHolder>53\</CodeContentPlaceHolder> object referenced by the <CodeContentPlaceHolder>54\</CodeContentPlaceHolder> member.  
