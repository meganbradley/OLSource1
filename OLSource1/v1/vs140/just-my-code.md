...
##  \<a name="BKMK_Enable_or_disable_Just_My_Code">\</a> Enable or disable Just My Code  
 ...
 ![Enable Just My Code in the Options dialog box](../vs140/media/dbg_justmycode_options.png "DBG_JustMyCode_Options")  
...
###  \<a name="BKMK_Override_call_stack_filtering">\</a> Override call stack filtering  
 In call stack displays, such as the Call Stack and Tasks windows, Just My Code collapses non-user code into an annotated frame labeled <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>. To view the collapsed frames, choose **Show External Code** on the context menu of the call stack display.  
...
-   Functions specified in <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> files in the <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> folder.  
  
 **Stepping**  
  
 By default, only functions specified in <CodeContentPlaceHolder>6\</CodeContentPlaceHolder> files in the <CodeContentPlaceHolder>7\</CodeContentPlaceHolder> folder are considered non-user code.  
  
 You can create your own <CodeContentPlaceHolder>8\</CodeContentPlaceHolder> and <CodeContentPlaceHolder>9\</CodeContentPlaceHolder> to customize the stepping and call stack window behavior in the <CodeContentPlaceHolder>10\</CodeContentPlaceHolder>.  
...
###  \<a name="BKMK_CPP_Customize_stepping_behavior">\</a> Customize stepping behavior  
 You can specify functions to step over by listing them as non-user code in <CodeContentPlaceHolder>11\</CodeContentPlaceHolder> files.  
  
-   To specify non-user code for all users of the Visual Studio machine, add the .natstepfilter file to the <CodeContentPlaceHolder>12\</CodeContentPlaceHolder> folder.  
  
-   To specify non-user code for an individual user, add the .natstepfilter file to the <CodeContentPlaceHolder>13\</CodeContentPlaceHolder> folder.  
...
|<CodeContentPlaceHolder>14\</CodeContentPlaceHolder>|Required. An ECMA-262 formatted regular expression specifying the full function name to match. For example:\<br />\<br /> <CodeContentPlaceHolder>15\</CodeContentPlaceHolder>\<br />\<br /> tells the debugger that all methods in <CodeContentPlaceHolder>16\</CodeContentPlaceHolder> are to be considered non-user code. The match is case-sensitive.|  
|<CodeContentPlaceHolder>17\</CodeContentPlaceHolder>|Optional. An ECMA-262 formatted regular expression specifying the full path to the module containing the function. The match is case-insensitive.|  
|<CodeContentPlaceHolder>18\</CodeContentPlaceHolder>|Required. One of these case-sensitive values:\<br />\<br /> -   <CodeContentPlaceHolder>19\</CodeContentPlaceHolder>  – tells the debugger to step over the matched function.\<br />-   <CodeContentPlaceHolder>20\</CodeContentPlaceHolder>  – tells the debugger to step into the matched functions, overriding any other <CodeContentPlaceHolder>21\</CodeContentPlaceHolder> for the matched functions.|  
  
###  \<a name="BKMK_CPP_Customize_call_stack_behavior">\</a> Customize call stack behavior  
 You can specify modules, source files, and functions to treat as non-user code in call stacks by specifying them in <CodeContentPlaceHolder>22\</CodeContentPlaceHolder> files.  
  
-   To specify non-user code for all users of the Visual Studio machine, add the .natjmc file to the <CodeContentPlaceHolder>23\</CodeContentPlaceHolder> folder.  
  
-   To specify non-user code for an individual user, add the .natjmc file to the <CodeContentPlaceHolder>24\</CodeContentPlaceHolder> folder.  
...
|---------------|-----------------|  
|<CodeContentPlaceHolder>25\</CodeContentPlaceHolder>|Required. The full path of the module or modules. You can use the Windows wildcard characters <CodeContentPlaceHolder>26\</CodeContentPlaceHolder> (zero or one characters) and <CodeContentPlaceHolder>27\</CodeContentPlaceHolder> (zero or more characters). For example,\<br />\<br /> <CodeContentPlaceHolder>28\</CodeContentPlaceHolder>\<br />\<br /> tells the debugger to treat all modules in <CodeContentPlaceHolder>29\</CodeContentPlaceHolder> on any drive as external code.|  
|<CodeContentPlaceHolder>30\</CodeContentPlaceHolder>|Optional. The name of the company that publishes the module that is embedded in the executable file. You can use this attribute to disambiguate the modules.|  
  
 **File element attributes**  
  
|Attribute|Description|  
|---------------|-----------------|  
|<CodeContentPlaceHolder>31\</CodeContentPlaceHolder>|Required. The full path of the source file or files to treat as external code. You can use the Windows wildcard characters <CodeContentPlaceHolder>32\</CodeContentPlaceHolder> and <CodeContentPlaceHolder>33\</CodeContentPlaceHolder> when specifying the path.|  
  
 **Function element attributes**  
  
|Attribute|Description|  
|---------------|-----------------|  
|<CodeContentPlaceHolder>34\</CodeContentPlaceHolder>|Required. The fully qualified name of the function to treat as external code.|  
|<CodeContentPlaceHolder>35\</CodeContentPlaceHolder>|Optional. The name or full path to the module that contains the function. You can use this attribute to disambiguate functions with the same name.|  
|<CodeContentPlaceHolder>36\</CodeContentPlaceHolder>|When set to <CodeContentPlaceHolder>37\</CodeContentPlaceHolder>, the call stack displays the function that threw the exception rather than this function.|  
...
-   Script that is executed by passing a string to the host-provided <CodeContentPlaceHolder>38\</CodeContentPlaceHolder> function is classified as **MyCode**.  
  
-   Script that is executed by passing a string to the <CodeContentPlaceHolder>39\</CodeContentPlaceHolder> constructor is classified as **LibraryCode**.  
  
-   Script that is contained in a framework reference, such as WinJS or the Azure SDK, is classified as **LibraryCode**.  
  
-   Script that is executed by passing a string to the <CodeContentPlaceHolder>40\</CodeContentPlaceHolder>, <CodeContentPlaceHolder>41\</CodeContentPlaceHolder>, or <CodeContentPlaceHolder>42\</CodeContentPlaceHolder> functions is classified as **UnrelatedCode**.  
  
-   The <CodeContentPlaceHolder>43\</CodeContentPlaceHolder> specifies other user and non-user code for all Visual Studio JavaScript projects.  
  
 You can modify the default classifications and classify specific files and urls by add a .json file named <CodeContentPlaceHolder>44\</CodeContentPlaceHolder> to the root folder of a project.  
...
-   If the <CodeContentPlaceHolder>45\</CodeContentPlaceHolder> keyword is encountered in:  
...
###  \<a name="BKMK_JS_Customize_Just_My_Code">\</a> Customize Just My Code  
 To categorize user and non-user code for a single Visual Studio project, add a .json file named <CodeContentPlaceHolder>46\</CodeContentPlaceHolder> to the root folder of the project.  
  
 Classifications are performed in this order:  
  
1.  Default classifications  
  
2.  Classifications in the <CodeContentPlaceHolder>47\</CodeContentPlaceHolder> file  
  
3.  Classifications in the <CodeContentPlaceHolder>48\</CodeContentPlaceHolder> file of the current project.  
...
|||  
|-|-|  
|**Eval**|Script that is executed by passing a string to the host-provided <CodeContentPlaceHolder>49\</CodeContentPlaceHolder> function. By default, Eval script is classified as **MyCode**.|  
|**Function**|Script that is executed by passing a string to the <CodeContentPlaceHolder>50\</CodeContentPlaceHolder> constructor. By default, Function script is classified as **LibraryCode**.|  
|**ScriptBlock**|Script that is executed by passing a string to the <CodeContentPlaceHolder>51\</CodeContentPlaceHolder>, <CodeContentPlaceHolder>52\</CodeContentPlaceHolder>, or <CodeContentPlaceHolder>53\</CodeContentPlaceHolder> functions. By default, ScriptBlock script is classified as **UnrelatedCode**.|  
  
 You can change the value to one of these keywords:  
  
-   <CodeContentPlaceHolder>54\</CodeContentPlaceHolder>  classifies the script as **MyCode**.  
  
-   <CodeContentPlaceHolder>55\</CodeContentPlaceHolder>  classifies the script as **LibraryCode**.  
  
-   <CodeContentPlaceHolder>56\</CodeContentPlaceHolder>  classifies the script as **UnrelatedCode**.  
...
|**Unrelated**|An array of urls or files that are classified as **UnrelatedCode**.|  
 ...
 The url or file string can contain one or more <CodeContentPlaceHolder>57\</CodeContentPlaceHolder> characters, which match zero or more characters. <CodeContentPlaceHolder>58\</CodeContentPlaceHolder> is the equivalent of the regular expression <CodeContentPlaceHolder>59\</CodeContentPlaceHolder>.