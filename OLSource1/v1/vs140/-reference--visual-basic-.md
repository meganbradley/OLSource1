...
-   A field, property, event, or method that has a return type or parameter type from Assembly B is invoked.  
 ...
 The Vbc.rsp response file, which references commonly used [!INCLUDE[dnprdnshort](../vs140/includes/dnprdnshort_md.md)] assemblies, is used by default. Use <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> if you do not want the compiler to use Vbc.rsp.  
  
 The short form of <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> is <CodeContentPlaceHolder>5\</CodeContentPlaceHolder>.  
  
## Example  
 The following code compiles source file I<CodeContentPlaceHolder>6\</CodeContentPlaceHolder> and reference assemblies from M<CodeContentPlaceHolder>7\</CodeContentPlaceHolder> and M<CodeContentPlaceHolder>8\</CodeContentPlaceHolder> to produce O<CodeContentPlaceHolder>9\</CodeContentPlaceHolder>.  
