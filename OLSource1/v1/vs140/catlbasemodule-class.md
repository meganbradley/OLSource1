...
|[CAtlBaseModule::GetModuleInstance](../vs140/catlbasemodule--getmoduleinstance.md)|Returns the module instance from a <CodeContentPlaceHolder>9\</CodeContentPlaceHolder> object.|  
|[CAtlBaseModule::GetResourceInstance](../vs140/catlbasemodule--getresourceinstance.md)|Returns the resource instance from a <CodeContentPlaceHolder>10\</CodeContentPlaceHolder> object.|  
...
|[CAtlBaseModule::SetResourceInstance](../vs140/catlbasemodule--setresourceinstance.md)|Sets the resource instance of a <CodeContentPlaceHolder>11\</CodeContentPlaceHolder> object.|  
...
## Remarks  
 An instance of <CodeContentPlaceHolder>12\</CodeContentPlaceHolder> named _AtlBaseModule is present in every ATL project, containing a handle to the module instance, a handle to the module containing resources (which by default, are one and the same), and an array of handles to modules providing primary resources. <CodeContentPlaceHolder>13\</CodeContentPlaceHolder> can be safely accessed from multiple threads.  
...
### Remarks  
 Creates the <CodeContentPlaceHolder>16\</CodeContentPlaceHolder>.  
...
##  \<a name="catlbasemodule__getmoduleinstance">\</a>  CAtlBaseModule::GetModuleInstance  
 Returns the module instance from a <CodeContentPlaceHolder>17\</CodeContentPlaceHolder> object.  
...
##  \<a name="catlbasemodule__setresourceinstance">\</a>  CAtlBaseModule::SetResourceInstance  
 Sets the resource instance of a <CodeContentPlaceHolder>19\</CodeContentPlaceHolder> object.  
