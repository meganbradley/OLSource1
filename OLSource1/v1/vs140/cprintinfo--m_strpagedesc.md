...
## Remarks  
 The framework uses "Page %u\nPages %u-%u\n" as the default value. If you want a different format for the page numbers, specify a format string in your override of <CodeContentPlaceHolder>0\</CodeContentPlaceHolder>. The **m_strPageDesc** member is a public variable of type <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>.  
