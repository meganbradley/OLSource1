...
---
# CMFCToolBarComboBoxEdit Class
The framework uses the <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> class to create a toolbar button that behaves like an editable combo box control.  
...
|Name|Description|  
|----------|-----------------|  
|[CMFCToolBarComboBoxEdit::CMFCToolBarComboBoxEdit](#cmfctoolbarcomboboxedit__cmfctoolbarcomboboxedit)|Constructs a <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> object.|  
...
|Name|Description|  
|----------|-----------------|  
|<CodeContentPlaceHolder>5\</CodeContentPlaceHolder>|Translates window messages before they are dispatched to the                                         [TranslateMessage](http://msdn.microsoft.com/library/windows/desktop/ms644955) and                                         [DispatchMessage](http://msdn.microsoft.com/library/windows/desktop/ms644934) Windows functions. (Overrides [CWnd::PreTranslateMessage](../vs140/cwnd-class.md#cwnd__pretranslatemessage).)|  
  
### Remarks  
 Derive a class from the <CodeContentPlaceHolder>6\</CodeContentPlaceHolder> class to customize its edit operations.  
...
### Example  
 The following example demonstrates how to construct an object of the <CodeContentPlaceHolder>9\</CodeContentPlaceHolder> class. This code snippet is part of the [IE Demo sample](../vs140/visual-c---samples.md).  
