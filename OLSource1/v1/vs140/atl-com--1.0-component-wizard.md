 ...
 **Short name**  
 Sets the abbreviated name for the object. The name that you provide determines the <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> and <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> names, the **.cpp file** and **.h file** names, the **Interface** name, the **Type** names, and the **ProgID**, unless you change those fields individually.  
...
> [!NOTE]
>  If you create your project using attributes, or if you indicate on this wizard page that the COM+ 1.0 component uses attributes, you cannot change this option because ATL does not include the <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> attribute.  
