...
Adding this attribute to a type with value <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> disables the behavior where F# makes the type serializable by default.  
