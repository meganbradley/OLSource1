...
|Exception|Condition|  
|---------------|---------------|  
|<xref:System.ArgumentException?qualifyHint=False>|Thrown when the input sequence has zero elements.|  
...
## Example  
 The following code example shows how to use `Seq.average`, and also compares `Seq.average` with [Seq.averageBy](../vs140/seq.averageby--t-^u--function--fsharp-.md).  
