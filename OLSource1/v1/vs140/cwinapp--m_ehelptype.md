...
---
# CWinApp::m_eHelpType
The type of this data member is the enumerated type **AFX_HELP_TYPE**, which is defined within the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> class.  
...
-   To set the application's help to WinHelp, call <CodeContentPlaceHolder>7\</CodeContentPlaceHolder> and specify **afxWinHelp**.  
