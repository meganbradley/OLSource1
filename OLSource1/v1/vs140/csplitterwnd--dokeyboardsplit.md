...
## Remarks  
 This member function is a high level command that is used by the [CView](../vs140/cview-class.md) class to delegate to the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> implementation.  
