...
**Microsoft Specific**  
 ...
 You can define as inline a function with the <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> attribute. In this case, the function is always instantiated and exported, whether or not any module in the program references the function. The function is presumed to be imported by another program.  
