...
A statement accesses a programming element that is defined in another assembly, but there is no project reference to that assembly.  
 ...
 For example, your code might be accessing an enumeration named <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> using the qualification string <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>. If the compiler cannot find <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> among your project's references, it generates this error.  
