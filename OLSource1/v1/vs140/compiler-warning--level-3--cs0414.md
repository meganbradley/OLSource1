 ...
 **Note** If the variable <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> is declared as <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>, no error will be generated because the compiler cannot know whether a derived class might use it or some other client code might instantiate the class and reference the variable  
