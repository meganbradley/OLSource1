...
## Return Value  
 The year represented by the value of this <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> object or <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> if the year could not be obtained.  
...
-   [GetDayOfYear](../vs140/coledatetime--getdayofyear.md)  
 ...
 For more information about the bounds for <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> values, see the article [Date and Time: Automation Support](../vs140/date-and-time--automation-support.md).  
