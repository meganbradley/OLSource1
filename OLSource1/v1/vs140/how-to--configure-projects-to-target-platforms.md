...
-   For [!INCLUDE[vbprvb](../vs140/includes/vbprvb_md.md)] projects, see [/platform (Visual Basic)](../vs140/-platform--visual-basic-.md).  
  
-   For [!INCLUDE[csprcs](../vs140/includes/csprcs_md.md)] projects, see [Build Pane, Project Designer (C#)](../vs140/build-page--project-designer--csharp-.md).  
  
-   For [!INCLUDE[vcprvc](../vs140/includes/vcprvc_md.md)] projects, see [/clr (Common Language Runtime Compilation)](../vs140/-clr--common-language-runtime-compilation-.md).  
  
## See Also  
 [Build Platforms](../vs140/understanding-build-platforms.md)   
 [/platform (Specify Output Platform)  (C# Compiler Options)](../vs140/-platform--csharp-compiler-options-.md)   
