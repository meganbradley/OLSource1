...
#### Parameters  
 ...
 Type: [int](../vs140/core.int-type-abbreviation--fsharp-.md) <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> [int](../vs140/core.int-type-abbreviation--fsharp-.md) <CodeContentPlaceHolder>5\</CodeContentPlaceHolder>  
...
## Example  
 The following code demonstrates the use of <CodeContentPlaceHolder>7\</CodeContentPlaceHolder> to create a two-dimensional array.  
