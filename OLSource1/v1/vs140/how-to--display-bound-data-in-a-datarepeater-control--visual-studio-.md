...
5.  Change the drop type of the table to <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> by clicking <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> in the drop-down list on the table node.  
