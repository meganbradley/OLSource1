...
## Return Value  
 <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> if a bar pane is successfully docked to the frame window side that is specified by <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>, <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> otherwise.  
  
## Remarks  
 <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> can have one of the following values:  
