...
-   For all values <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> of type **Key**, the call **hash_comp**( <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>) serves as a hash function, which yields a distribution of values of type **size_t**. The function supplied by hash_compare returns <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>.  
  
-   For any value <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> of type **Key** that precedes <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> in the sequence and has the same hash value (value returned by the hash function), **hash_comp**( <CodeContentPlaceHolder>6\</CodeContentPlaceHolder>, <CodeContentPlaceHolder>7\</CodeContentPlaceHolder>) is false. The function must impose a total ordering on values of type **Key**. The function supplied by hash_compare returns                         *comp*( <CodeContentPlaceHolder>8\</CodeContentPlaceHolder>, <CodeContentPlaceHolder>9\</CodeContentPlaceHolder>) <CodeContentPlaceHolder>10\</CodeContentPlaceHolder> where                         *comp* is a stored object of type **Traits** that you can specify when you construct the object hash_comp. For the default **Traits** parameter type **less\<Key>**, sort keys never decrease in value.  
