...
### Registering an Editor Factory by Using Managed Code  
 You must register your editor factory in your VSPackage's the <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> method. First call <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>, and then call \<xref:Microsoft.VisualStudio.Shell.Package.RegisterEditorFactory*> for each editor factory  
...
1.  The [!INCLUDE[vsprvs](../vs140/includes/vsprvs_md.md)] project system calls \<xref:Microsoft.VisualStudio.Shell.Interop.IVsUIShellOpenDocument.OpenStandardEditor*>.  
