...
Decrements the reference count on the Resource Manager instance. The Resource Manager is destroyed when its reference count goes to <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>.  
