...
|Add ready-to-use components to your application.|Use the <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> to add a variety of items.|These items are easy to integrate into your application and save you a great deal of work.|  
...
|Implement Open, Save, and Save As commands.|Write code for the document's <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> member function.|The framework displays dialog boxes for the **Open**, **Save**, and **Save As** commands on the **File** menu. It writes and reads back a document using the data format specified in your <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> member function.|  
...
|Create a simple text editor.|If you want your view to be a simple text editor, derive your view class or classes from [CEditView](../vs140/ceditview-class.md) or [CRichEditView](../vs140/cricheditview-class.md).|The view provides editing functions, Clipboard support, and file input/output. <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> provides styled text.|  
