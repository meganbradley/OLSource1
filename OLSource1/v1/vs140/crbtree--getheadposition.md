...
## Remarks  
 The value returned by <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> can be used with methods such as [CRBTree::GetKeyAt](../vs140/crbtree--getkeyat.md) or [CRBTree::GetNext](../vs140/crbtree--getnext.md) to traverse the tree and retrieve values.  
