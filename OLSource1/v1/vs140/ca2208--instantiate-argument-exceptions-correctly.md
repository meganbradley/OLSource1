...
## Rule Description  
 ...
 The signatures of the one and two string constructors of \<xref:System.ArgumentException*> and its derived types are not consistent with respect to the <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> and <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> parameters. Make sure these constructors are called with the correct string arguments. The signatures are as follows:  
  
 \<xref:System.ArgumentException*>(string <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>)  
  
 \<xref:System.ArgumentException*>(string <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>, string <CodeContentPlaceHolder>4\</CodeContentPlaceHolder>)  
  
 \<xref:System.ArgumentNullException*>(string <CodeContentPlaceHolder>5\</CodeContentPlaceHolder>)  
  
 \<xref:System.ArgumentNullException*>(string <CodeContentPlaceHolder>6\</CodeContentPlaceHolder>, string <CodeContentPlaceHolder>7\</CodeContentPlaceHolder>)  
  
 \<xref:System.ArgumentOutOfRangeException*>(string <CodeContentPlaceHolder>8\</CodeContentPlaceHolder>)  
  
 \<xref:System.ArgumentOutOfRangeException*>(string <CodeContentPlaceHolder>9\</CodeContentPlaceHolder>, string <CodeContentPlaceHolder>10\</CodeContentPlaceHolder>)  
  
 \<xref:System.DuplicateWaitObjectException*>(string <CodeContentPlaceHolder>11\</CodeContentPlaceHolder>)  
  
 \<xref:System.DuplicateWaitObjectException*>(string <CodeContentPlaceHolder>12\</CodeContentPlaceHolder>, string <CodeContentPlaceHolder>13\</CodeContentPlaceHolder>)  
