...
4.  Add the following references to the project and make sure that **CopyLocal** is set to <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>:  
...
3.  Modify the class declaration for <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> so that it implements \<xref:Microsoft.VisualStudio.Language.Intellisense.ICompletionSource*>:  
...
5.  Add a constructor that sets the source provider and buffer. The <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> class is defined in later steps:  
...
8.  Implement the <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> method:  
...
1.  Add a file named <CodeContentPlaceHolder>7\</CodeContentPlaceHolder>.  
...
1.  Add a class named <CodeContentPlaceHolder>9\</CodeContentPlaceHolder> that implements \<xref:Microsoft.VisualStudio.OLE.Interop.IOleCommandTarget*>:  
