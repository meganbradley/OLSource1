...
---
# Strings (F#)
The `string` type represents immutable text as a sequence of Unicode characters. `string` is an alias for <xref:System.String?qualifyHint=False> in the .NET Framework.  
...
## String Class  
 Because the string type in F# is actually a .NET Framework <xref:System.String?qualifyHint=False> type, all the <xref:System.String?qualifyHint=False> members are available. This includes the `+` operator, which is used to concatenate strings, the `Length` property, and the `Chars` property, which returns the string as an array of Unicode characters. For more information about strings, see <xref:System.String?qualifyHint=False>.  
  
 By using the `Chars` property of <xref:System.String?qualifyHint=False>, you can access the individual characters in a string by specifying an index, as is shown in the following code.  
