...
## Return Value  
 <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> if the current tab control is in an MDI client area window; otherwise, <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>.  
