...
-   Do not modify the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> file directly. If you do this, the changes to the file will be overwritten.  
...
-   Create each assertion using the **Coded UI Test Builder**, which automatically adds an assertion method to the <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> file.  
...
-   If you are creating assertions by coding with the API, create a method for each assertion in the part of the \<xref:Microsoft.VisualStudio.TestTools.UITest.Common.UIMap.UIMap*> class that is in the <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> file. Call this method from your test method to execute the assertion.  
  
-   If you are directly coding with the API, use the properties and methods in the classes generated in the <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> file in your code as much as you can. These classes will make your work easier, more reliable, and will help you be more productive.  
