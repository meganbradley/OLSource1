...
## Remarks  
 Use this method to obtain the full name of the font. For example, if the font name is is <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> and the font script is <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>, this method returns "Arial (Cyrillic)".  
