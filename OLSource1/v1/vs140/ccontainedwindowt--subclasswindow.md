...
---
# CContainedWindowT::SubclassWindow
Subclasses the window identified by <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> and attaches it to the <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> object.  
...
> [!NOTE]
>  Do not call <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> if you have already called [Create](../vs140/ccontainedwindowt--create.md).  
