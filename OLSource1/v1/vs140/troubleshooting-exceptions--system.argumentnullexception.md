...
An \<xref:System.ArgumentNullException*> exception is thrown when a null reference (<CodeContentPlaceHolder>0\</CodeContentPlaceHolder> in Visual Basic) is passed to a method that does not accept it as a valid argument.  
