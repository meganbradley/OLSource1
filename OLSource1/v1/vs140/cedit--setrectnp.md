...
#### Parameters  
 ...
 Points to a <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> structure or <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> object that specifies the new dimensions of the rectangle.  
...
## Remarks  
 ...
 <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> is identical to the <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> member function except that the edit-control window is not redrawn.  
  
 When the edit control is first created, the formatting rectangle is the same as the client area of the edit-control window. By calling the <CodeContentPlaceHolder>6\</CodeContentPlaceHolder> member function, an application can make the formatting rectangle larger or smaller than the edit-control window.  
