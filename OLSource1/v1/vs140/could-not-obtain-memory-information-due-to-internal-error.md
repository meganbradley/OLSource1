...
A call to one of the memory-information properties of the <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> object failed.  
  
### To correct this error  
  
-   Add a <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> block around the call to the memory-information property of the <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> object.  
