...
---
# &lt;iomanip&gt;
Include the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> standard header <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> to define several manipulators that each take a single argument.  
  
## Syntax  
  
<CodeContentPlaceHolder>0\</CodeContentPlaceHolder>  
## Remarks  
 Each of these manipulators returns an unspecified type, called **T1** through **T10**, that overloads both <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>\<**Elem**, **Tr**><CodeContentPlaceHolder>4\</CodeContentPlaceHolder>[operator>>](../vs140/-istream--operators.md#operator_gt__gt_) and <CodeContentPlaceHolder>5\</CodeContentPlaceHolder>\<**Elem**, **Tr**><CodeContentPlaceHolder>6\</CodeContentPlaceHolder>[operator<<](../vs140/-ostream--operators.md#operator_lt__lt_).  
