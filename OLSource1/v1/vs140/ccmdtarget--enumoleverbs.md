...
## Return Value  
 TRUE if the object supports at least one OLE verb (in which case \*<CodeContentPlaceHolder>2\</CodeContentPlaceHolder> points to an **IEnumOLEVERB** enumerator interface), otherwise FALSE.  
