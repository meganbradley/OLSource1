...
---
# CDockablePaneAdapter Class
Provides docking support for <CodeContentPlaceHolder>5\</CodeContentPlaceHolder>-derived panes.  
...
## Remarks  
 ...
 If you want to customize the <CodeContentPlaceHolder>6\</CodeContentPlaceHolder> behavior, just derive a new class from it and set the runtime class information to a tabbed window by using [CMFCBaseTabCtrl::SetDockingBarWrapperRTC](../vs140/cmfcbasetabctrl-class.md#cmfcbasetabctrl__setdockingbarwrapperrtc).  
