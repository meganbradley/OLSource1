...
3.  Create a new <xref:Microsoft.VisualBasic.FileIO.TextFieldParser?qualifyHint=False> object, defining the width and format.  
...
## See Also  
 ...
 <xref:Microsoft.VisualBasic.FileIO.TextFieldParser.EndOfData?qualifyHint=False>   
