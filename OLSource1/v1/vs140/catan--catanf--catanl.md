...
## Return Value  
 The arctangent of <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>, in radians. The result is unbounded along the imaginary axis, and  in the interval [−π/2; +π/2] along the real axis.  
