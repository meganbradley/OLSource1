...
---
# CStatic::GetCursor
Gets the handle of the cursor, previously set with [SetCursor](../vs140/cstatic--setcursor.md), that is associated with <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>.  
