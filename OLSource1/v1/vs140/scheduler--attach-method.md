...
## Remarks  
 ...
 If this method is called from a context that is already attached to a different scheduler, the existing scheduler is remembered as the previous scheduler, and the newly created scheduler becomes the current scheduler. When you call the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> method at a later point, the previous scheduler is restored as the current scheduler.  
