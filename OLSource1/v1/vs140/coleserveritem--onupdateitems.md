...
## Remarks  
 The default implementation calls [UpdateLink](../vs140/coleclientitem--updatelink.md) for all <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> objects in the document.  
