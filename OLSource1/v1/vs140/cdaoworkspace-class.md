...
## Capabilities  
 Class <CodeContentPlaceHolder>28\</CodeContentPlaceHolder> provides the following:  
...
## Usage  
 You can use class <CodeContentPlaceHolder>29\</CodeContentPlaceHolder> to:  
...
-   If you create a new <CodeContentPlaceHolder>30\</CodeContentPlaceHolder> object but do not do so through an existing <CodeContentPlaceHolder>31\</CodeContentPlaceHolder> object, MFC creates a temporary workspace object for you, which corresponds to DAO's default workspace. If you do so for multiple databases, all of the database objects are associated with the default workspace. You can access a database's workspace through a <CodeContentPlaceHolder>32\</CodeContentPlaceHolder> data member.  
  
-   Similarly, if you create a <CodeContentPlaceHolder>33\</CodeContentPlaceHolder> object without supplying a pointer to a <CodeContentPlaceHolder>34\</CodeContentPlaceHolder> object, MFC creates a temporary database object and, by extension, a temporary workspace object. You can access a recordset's database, and indirectly its workspace, through a <CodeContentPlaceHolder>35\</CodeContentPlaceHolder> data member.  
...
### Parameters  
 ...
 The full path of the compacted database that you are creating. You can also specify a network path as with <CodeContentPlaceHolder>42\</CodeContentPlaceHolder>. You cannot use the <CodeContentPlaceHolder>43\</CodeContentPlaceHolder> argument to specify the same database file as <CodeContentPlaceHolder>44\</CodeContentPlaceHolder>.  
  
 <CodeContentPlaceHolder>45\</CodeContentPlaceHolder>  
 A password, used when you want to compact a password-protected database. Note that if you use the version of <CodeContentPlaceHolder>46\</CodeContentPlaceHolder> that takes a password, you must supply all parameters. Also, because this is a connect parameter, it requires special formatting, as follows: ;PWD= <CodeContentPlaceHolder>47\</CodeContentPlaceHolder>. For example: ;PWD="Happy". (The leading semicolon is required.)  
  
 <CodeContentPlaceHolder>48\</CodeContentPlaceHolder>  
 A string expression used to specify collating order for creating <CodeContentPlaceHolder>49\</CodeContentPlaceHolder>. If you omit this argument by accepting the default value of **dbLangGeneral** (see below), the locale of the new database is the same as that of the old database. Possible values are:  
...
-   **dbLangTurkish** Turkish  
 ...
 Indicates one or more options for the target database, <CodeContentPlaceHolder>51\</CodeContentPlaceHolder>. If you omit this argument by accepting the default value, the <CodeContentPlaceHolder>52\</CodeContentPlaceHolder> will have the same encryption and the same version as <CodeContentPlaceHolder>53\</CodeContentPlaceHolder>. You can combine the **dbEncrypt** or **dbDecrypt** option with one of the version options using the bitwise-OR operator. Possible values, which specify a database format, not a database engine version, are:  
...
-   **dbVersion30** Create a database that uses the Microsoft Jet database engine version 3.0 while compacting.  
 ...
 You can use **dbEncrypt** or **dbDecrypt** in the options argument to specify whether to encrypt or to decrypt the database as it is compacted. If you omit an encryption constant or if you include both **dbDecrypt** and **dbEncrypt**, <CodeContentPlaceHolder>54\</CodeContentPlaceHolder> will have the same encryption as <CodeContentPlaceHolder>55\</CodeContentPlaceHolder>. You can use one of the version constants in the options argument to specify the version of the data format for the compacted database. This constant affects only the version of the data format of <CodeContentPlaceHolder>56\</CodeContentPlaceHolder>. You can specify only one version constant. If you omit a version constant, <CodeContentPlaceHolder>57\</CodeContentPlaceHolder> will have the same version as <CodeContentPlaceHolder>58\</CodeContentPlaceHolder>. You can compact <CodeContentPlaceHolder>59\</CodeContentPlaceHolder> only to a version that is the same or later than that of <CodeContentPlaceHolder>60\</CodeContentPlaceHolder>.  
...
> [!CAUTION]
>  The <CodeContentPlaceHolder>61\</CodeContentPlaceHolder> member function will not correctly convert a complete Microsoft Access database from one version to another. Only the data format is converted. Microsoft Access-defined objects, such as forms and reports, are not converted. However, the data is correctly converted.  
  
> [!TIP]
>  You can also use <CodeContentPlaceHolder>62\</CodeContentPlaceHolder> to copy a database file.  
...
##  \<a name="cdaoworkspace__create">\</a>  CDaoWorkspace::Create  
 Call this member function to create a new DAO workspace object and associate it with the MFC <CodeContentPlaceHolder>63\</CodeContentPlaceHolder> object.  
 ...
 *lpszUserName*  
 The user name of the workspace's owner. For requirements, see the <CodeContentPlaceHolder>65\</CodeContentPlaceHolder> parameter to the [SetDefaultUser](#cdaoworkspace__setdefaultuser) member function. For related information, see the topic "UserName Property" in DAO Help.  
...
### Remarks  
 <CodeContentPlaceHolder>67\</CodeContentPlaceHolder> is useful if you need to loop through all defined databases in the workspace's Databases collection. To obtain information about a given database in the collection, see [GetDatabaseInfo](#cdaoworkspace__getdatabaseinfo). Typical usage is to call <CodeContentPlaceHolder>68\</CodeContentPlaceHolder> for the number of open databases, then use that number as a loop index for repeated calls to <CodeContentPlaceHolder>69\</CodeContentPlaceHolder>.  
...
-   <CodeContentPlaceHolder>73\</CodeContentPlaceHolder> (Default) Name, Updatable, Transactions  
  
-   <CodeContentPlaceHolder>74\</CodeContentPlaceHolder> Primary information plus: Version, Collating Order, Query Timeout  
  
-   <CodeContentPlaceHolder>75\</CodeContentPlaceHolder> Primary and secondary information plus: Connect  
...
### Remarks  
 ...
 For a description of the information returned in <CodeContentPlaceHolder>77\</CodeContentPlaceHolder>, see the [CDaoDatabaseInfo](../vs140/cdaodatabaseinfo-structure.md) structure. This structure has members that correspond to the items of information listed above in the description of <CodeContentPlaceHolder>78\</CodeContentPlaceHolder>. When you request information at one level, you get information for any prior levels as well.  
...
##  \<a name="cdaoworkspace__getname">\</a>  CDaoWorkspace::GetName  
 Call this member function to get the user-defined name of the DAO workspace object underlying the <CodeContentPlaceHolder>79\</CodeContentPlaceHolder> object.  
...
### Remarks  
 This count does not include any open workspaces not appended to the collection. <CodeContentPlaceHolder>80\</CodeContentPlaceHolder> is useful if you need to loop through all defined workspaces in the Workspaces collection. To obtain information about a given workspace in the collection, see [GetWorkspaceInfo](#cdaoworkspace__getworkspaceinfo). Typical usage is to call <CodeContentPlaceHolder>81\</CodeContentPlaceHolder> for the number of open workspaces, then use that number as a loop index for repeated calls to <CodeContentPlaceHolder>82\</CodeContentPlaceHolder>.  
...
-   <CodeContentPlaceHolder>86\</CodeContentPlaceHolder> (Default) Name  
  
-   <CodeContentPlaceHolder>87\</CodeContentPlaceHolder> Primary information plus: User Name  
  
-   <CodeContentPlaceHolder>88\</CodeContentPlaceHolder> Primary and secondary information plus: Isolate ODBCTrans  
...
### Remarks  
 For a description of the information returned in <CodeContentPlaceHolder>90\</CodeContentPlaceHolder>, see the [CDaoWorkspaceInfo](../vs140/cdaoworkspaceinfo-structure.md) structure. This structure has members that correspond to the items of information listed above in the description of <CodeContentPlaceHolder>91\</CodeContentPlaceHolder>. When you request information at one level, you get information for prior levels as well.  
...
##  \<a name="cdaoworkspace__isopen">\</a>  CDaoWorkspace::IsOpen  
 Call this member function to determine whether the <CodeContentPlaceHolder>93\</CodeContentPlaceHolder> object is open — that is, whether the MFC object has been initialized by a call to [Open](#cdaoworkspace__open) or a call to [Create](#cdaoworkspace__create).  
...
### Parameters  
 ...
 The name of the DAO workspace object to open — a string with up to 14 characters that uniquely names the workspace. Accept the default value **NULL** to explicitly open the default workspace. For naming requirements, see the <CodeContentPlaceHolder>95\</CodeContentPlaceHolder> parameter for [Create](#cdaoworkspace__create). For related information, see the topic "Name Property" in DAO Help.  
  
### Remarks  
 After constructing a <CodeContentPlaceHolder>96\</CodeContentPlaceHolder> object, call this member function to do one of the following:  
  
-   Explicitly open the default workspace. Pass **NULL** for <CodeContentPlaceHolder>97\</CodeContentPlaceHolder>.  
  
-   Open an existing <CodeContentPlaceHolder>98\</CodeContentPlaceHolder> object, a member of the Workspaces collection, by name. Pass a valid name for an existing workspace object.  
 ...
 **Open** puts the workspace object into an open state and also initializes the database engine if it has not already been initialized for your application.  
 ...
 Although many <CodeContentPlaceHolder>99\</CodeContentPlaceHolder> member functions can only be called after the workspace has been opened, the following member functions, which operate on the database engine, are available after construction of the C++ object but before a call to **Open**:  
...
### Remarks  
 You must close the database specified by <CodeContentPlaceHolder>101\</CodeContentPlaceHolder> before you repair it. In a multiuser environment, other users cannot have <CodeContentPlaceHolder>102\</CodeContentPlaceHolder> open while you are repairing it. If <CodeContentPlaceHolder>103\</CodeContentPlaceHolder> is not closed or is not available for exclusive use, an error occurs.  
...
> [!NOTE]
>  When you begin a transaction, the database engine records its operations in a file kept in the directory specified by the TEMP environment variable on the workstation. If the transaction log file exhausts the available storage on your TEMP drive, the database engine will cause MFC to throw a <CodeContentPlaceHolder>104\</CodeContentPlaceHolder> (DAO error 2004). At this point, if you call **CommitTrans**, an indeterminate number of operations are committed but the remaining uncompleted operations are lost, and the operation has to be restarted. Calling **Rollback** releases the transaction log and rolls back all operations in the transaction.  
...
1.  Construct a <CodeContentPlaceHolder>106\</CodeContentPlaceHolder> object but do not call **Create**.  
  
2.  Call <CodeContentPlaceHolder>107\</CodeContentPlaceHolder> and, if you like, [SetDefaultUser](#cdaoworkspace__setdefaultuser).  
...
1.  Construct a <CodeContentPlaceHolder>109\</CodeContentPlaceHolder> object but do not call **Create**.  
  
2.  Call <CodeContentPlaceHolder>110\</CodeContentPlaceHolder> and, if you like, [SetDefaultPassword](#cdaoworkspace__setdefaultpassword).  
...
### Remarks  
 Call <CodeContentPlaceHolder>111\</CodeContentPlaceHolder> only if you need to specify special settings. For more information, see the topic "IniPath Property" in DAO Help.  
  
> [!NOTE]
>  Call <CodeContentPlaceHolder>112\</CodeContentPlaceHolder> during application installation, not when the application runs. <CodeContentPlaceHolder>113\</CodeContentPlaceHolder> must be called before you open any workspaces, databases, or recordsets; otherwise, MFC throws an exception.  
