...
|[IsModule](../vs140/fsharptype.ismodule-method--fsharp-.md)|Returns `true` if the specified type is a \<xref:System.Type*> value corresponding to the compiled form of an F# module.|  
...
|[MakeFunctionType](../vs140/fsharptype.makefunctiontype-method--fsharp-.md)|Returns a \<xref:System.Type*> `object` representing the F# function type with the given domain and range.|  
