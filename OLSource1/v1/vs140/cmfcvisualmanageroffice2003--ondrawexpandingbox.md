...
#### Parameters  
 ...
 <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> if the box to be drawn is opened, or <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> if not.  
