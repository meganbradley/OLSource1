...
---
# CMenu::GetMenuItemID
Obtains the menu-item identifier for a menu item located at the position defined by <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>.  
...
## Return Value  
 The item ID for the specified item in a pop-up menu if the function is successful. If the specified item is a pop-up menu (as opposed to an item within the pop-up menu), the return value is –1. If <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> corresponds to a **SEPARATOR** menu item, the return value is 0.  
