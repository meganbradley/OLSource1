...
f1_keywords: 
  ...
  - "SetLastPercentInPaneContainer"
  - "CDockablePane::SetLastPercentInPaneContainer"
dev_langs: 
  - "C++"
helpviewer_keywords: 
  - "SetLastPercentInPaneContainer method"
...
#### Parameters  
 ...
 An <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> that specifies the percentage of space that the pane occupies in its container.  
