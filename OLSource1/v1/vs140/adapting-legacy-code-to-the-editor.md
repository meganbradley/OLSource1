...
|Method|Conversion|  
|------------|----------------|  
|<xref:Microsoft.VisualStudio.Editor.IVsEditorAdaptersFactoryService.GetBufferAdapter?qualifyHint=False>|Converts an <xref:Microsoft.VisualStudio.Text.ITextBuffer?qualifyHint=False> to an <xref:Microsoft.VisualStudio.TextManager.Interop.IVsTextBuffer?qualifyHint=False>.|  
|<xref:Microsoft.VisualStudio.Editor.IVsEditorAdaptersFactoryService.GetDataBuffer?qualifyHint=False>|Converts an <xref:Microsoft.VisualStudio.TextManager.Interop.IVsTextBuffer?qualifyHint=False> to an <xref:Microsoft.VisualStudio.Text.ITextBuffer?qualifyHint=False>.|  
|<xref:Microsoft.VisualStudio.Editor.IVsEditorAdaptersFactoryService.GetDocumentBuffer?qualifyHint=False>|Converts an <xref:Microsoft.VisualStudio.TextManager.Interop.IVsTextBuffer?qualifyHint=False> to an <xref:Microsoft.VisualStudio.Text.ITextBuffer?qualifyHint=False>.|  
|<xref:Microsoft.VisualStudio.Editor.IVsEditorAdaptersFactoryService.GetViewAdapter?qualifyHint=False>|Converts an <xref:Microsoft.VisualStudio.Text.Editor.ITextView?qualifyHint=False> to an <xref:Microsoft.VisualStudio.TextManager.Interop.IVsTextView?qualifyHint=False>.|  
|<xref:Microsoft.VisualStudio.Editor.IVsEditorAdaptersFactoryService.GetWpfTextView?qualifyHint=False>|Converts an <xref:Microsoft.VisualStudio.TextManager.Interop.IVsTextView?qualifyHint=False> to an <xref:Microsoft.VisualStudio.Text.Editor.IWpfTextView?qualifyHint=False>.|  
...
|Method|Conversion|  
|------------|----------------|  
|<xref:Microsoft.VisualStudio.Editor.IVsEditorAdaptersFactoryService.CreateVsCodeWindowAdapter?qualifyHint=False>|Creates an <xref:Microsoft.VisualStudio.TextManager.Interop.IVsCodeWindow?qualifyHint=False>.|  
|<xref:Microsoft.VisualStudio.Editor.IVsEditorAdaptersFactoryService.CreateVsTextBufferAdapter?qualifyHint=False>|Creates an <xref:Microsoft.VisualStudio.TextManager.Interop.IVsTextBuffer?qualifyHint=False> for a specified <xref:Microsoft.VisualStudio.Utilities.IContentType?qualifyHint=False>.|  
|<xref:Microsoft.VisualStudio.Editor.IVsEditorAdaptersFactoryService.CreateVsTextBufferAdapter?qualifyHint=False>|Creates an <xref:Microsoft.VisualStudio.TextManager.Interop.IVsTextBuffer?qualifyHint=False>.|  
|<xref:Microsoft.VisualStudio.Editor.IVsEditorAdaptersFactoryService.CreateVsTextBufferCoordinatorAdapter?qualifyHint=False>|Creates an <xref:Microsoft.VisualStudio.TextManager.Interop.IVsTextBufferCoordinator?qualifyHint=False>.|  
|<xref:Microsoft.VisualStudio.Editor.IVsEditorAdaptersFactoryService.CreateVsTextViewAdapter?qualifyHint=False>|Creates an <xref:Microsoft.VisualStudio.TextManager.Interop.IVsTextView?qualifyHint=False> for an <xref:Microsoft.VisualStudio.Text.Editor.ITextViewRoleSet?qualifyHint=False>.|  
|<xref:Microsoft.VisualStudio.Editor.IVsEditorAdaptersFactoryService.CreateVsTextViewAdapter?qualifyHint=False>|Creates an <xref:Microsoft.VisualStudio.TextManager.Interop.IVsTextView?qualifyHint=False>.|  
...
2.  Instantiate the <xref:Microsoft.VisualStudio.Editor.IVsEditorAdaptersFactoryService?qualifyHint=False>, as follows.  
