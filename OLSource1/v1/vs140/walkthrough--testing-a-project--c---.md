...
5.  To examine the value of the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> variable, move the pointer over <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> and then move it over the expansion control at the left of the tooltip window. The variable name <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> and its value of 12 are displayed.  
  
     Open the shortcut menu for the <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> variable and then choose **Add Watch** to display that variable in the **Watch 1** window. You can also select a variable and drag it to the **Watch 1** window.  
  
6.  To step to the next line of code, on the menu bar, choose **Debug**, **Step Over**, or choose the F10 key.  
  
     The value of <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> in the **Watch 1** window is now displayed as 13.  
  
7.  Open the shortcut menu for the <CodeContentPlaceHolder>6\</CodeContentPlaceHolder> statement and then choose **Run to Cursor**. The yellow arrow to the left of the code points to the next statement to be executed.  
  
8.  The <CodeContentPlaceHolder>7\</CodeContentPlaceHolder> number should decrease when a Cardgame terminates. At this point, <CodeContentPlaceHolder>8\</CodeContentPlaceHolder> should equal 0 because all Cardgame instances have been deleted, but the **Watch 1** window indicates that <CodeContentPlaceHolder>9\</CodeContentPlaceHolder> equals 18. This indicates that there's a bug in the code, which you can detect and fix by completing the next walkthrough, [Debugging a Project (C++)](../vs140/walkthrough--debugging-a-project--c---.md).  
