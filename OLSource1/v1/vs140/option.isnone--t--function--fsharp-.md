...
Returns <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> if the option is <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>.  
...
## Return Value  
 <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> if the option is <CodeContentPlaceHolder>6\</CodeContentPlaceHolder>.  
