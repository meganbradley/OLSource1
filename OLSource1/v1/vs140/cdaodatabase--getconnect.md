...
helpviewer_keywords: 
  - "GetConnect method"
  - "database connections [C++], getting connection information"
  - "ODBC connections [C++], getting connection information"
  - "Jet databases [C++]"
  - "Jet databases [C++], connection strings"
...
---
# CDaoDatabase::GetConnect
Call this member function to retrieve the connection string used to connect the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> object to an ODBC or ISAM database.  
