...
|Name|Description|  
|----------|-----------------|  
|[CComControlBase::AppearanceType](../vs140/ccomcontrolbase--appearancetype.md)|Override if your <CodeContentPlaceHolder>75\</CodeContentPlaceHolder> stock property isn't of type <CodeContentPlaceHolder>76\</CodeContentPlaceHolder>.|  
...
|[CComControlBase::DoesVerbActivate](../vs140/ccomcontrolbase--doesverbactivate.md)|Checks that the <CodeContentPlaceHolder>77\</CodeContentPlaceHolder> parameter used by <CodeContentPlaceHolder>78\</CodeContentPlaceHolder> either activates the control's user interface ( <CodeContentPlaceHolder>79\</CodeContentPlaceHolder> equals <CodeContentPlaceHolder>80\</CodeContentPlaceHolder>), defines the action taken when the user double-clicks the control ( <CodeContentPlaceHolder>81\</CodeContentPlaceHolder> equals <CodeContentPlaceHolder>82\</CodeContentPlaceHolder>), displays the control ( <CodeContentPlaceHolder>83\</CodeContentPlaceHolder> equals <CodeContentPlaceHolder>84\</CodeContentPlaceHolder>), or activates the control ( <CodeContentPlaceHolder>85\</CodeContentPlaceHolder> equals **OLEIVERB_INPLACEACTIVATE**).|  
|[CComControlBase::DoesVerbUIActivate](../vs140/ccomcontrolbase--doesverbuiactivate.md)|Checks that the <CodeContentPlaceHolder>86\</CodeContentPlaceHolder> parameter used by <CodeContentPlaceHolder>87\</CodeContentPlaceHolder> causes the control's user interface to activate and returns **TRUE**.|  
...
|[CComControlBase::GetAmbientFont](../vs140/ccomcontrolbase--getambientfont.md)|Retrieves a pointer to the container's ambient <CodeContentPlaceHolder>88\</CodeContentPlaceHolder> interface.|  
...
|[CComControlBase::GetAmbientMessageReflect](../vs140/ccomcontrolbase--getambientmessagereflect.md)|Retrieves **DISPID_AMBIENT_MESSAGEREFLECT**, a flag indicating whether the container wants to receive window messages (such as <CodeContentPlaceHolder>89\</CodeContentPlaceHolder>) as events.|  
|[CComControlBase::GetAmbientPalette](../vs140/ccomcontrolbase--getambientpalette.md)|Retrieves **DISPID_AMBIENT_PALETTE**, used to access the container's <CodeContentPlaceHolder>90\</CodeContentPlaceHolder>.|  
|[CComControlBase::GetAmbientProperty](../vs140/ccomcontrolbase--getambientproperty.md)|Retrieves the container property specified by <CodeContentPlaceHolder>91\</CodeContentPlaceHolder>.|  
...
|[CComControlBase::GetDirty](../vs140/ccomcontrolbase--getdirty.md)|Returns the value of data member <CodeContentPlaceHolder>92\</CodeContentPlaceHolder>.|  
...
|[CComControlBase::InPlaceActivate](../vs140/ccomcontrolbase--inplaceactivate.md)|Causes the control to transition from the inactive state to whatever state the verb in <CodeContentPlaceHolder>93\</CodeContentPlaceHolder> indicates.|  
...
|[CComControlBase::OnDrawAdvanced](../vs140/ccomcontrolbase--ondrawadvanced.md)|The default **OnDrawAdvanced** prepares a normalized device context for drawing, then calls your control class's <CodeContentPlaceHolder>94\</CodeContentPlaceHolder> method.|  
...
|[CComControlBase::OnPaint](../vs140/ccomcontrolbase--onpaint.md)|Prepares the container for painting, gets the control's client area, then calls the control class's <CodeContentPlaceHolder>95\</CodeContentPlaceHolder> method.|  
...
|[CComControlBase::SetDirty](../vs140/ccomcontrolbase--setdirty.md)|Sets the data member <CodeContentPlaceHolder>96\</CodeContentPlaceHolder> to the value in <CodeContentPlaceHolder>97\</CodeContentPlaceHolder>.|  
...
|[CComControlBase::m_bDrawFromNatural](../vs140/ccomcontrolbase--m_bdrawfromnatural.md)|Flag indicating that <CodeContentPlaceHolder>98\</CodeContentPlaceHolder> and <CodeContentPlaceHolder>99\</CodeContentPlaceHolder> should set the control size from <CodeContentPlaceHolder>100\</CodeContentPlaceHolder> rather than from <CodeContentPlaceHolder>101\</CodeContentPlaceHolder>.|  
|[CComControlBase::m_bDrawGetDataInHimetric](../vs140/ccomcontrolbase--m_bdrawgetdatainhimetric.md)|Flag indicating that <CodeContentPlaceHolder>102\</CodeContentPlaceHolder> should use HIMETRIC units and not pixels when drawing.|  
...
|[CComControlBase::m_spAmbientDispatch](../vs140/ccomcontrolbase--m_spambientdispatch.md)|A <CodeContentPlaceHolder>103\</CodeContentPlaceHolder> object that lets you retrieve and set the container's properties through an <CodeContentPlaceHolder>104\</CodeContentPlaceHolder> pointer.|  
...
## Remarks  
 This class provides methods for creating and managing ATL controls. [CComControl Class](../vs140/ccomcontrol-class.md) derives from <CodeContentPlaceHolder>105\</CodeContentPlaceHolder>. When you create a Standard Control or DHTML control using the ATL Control Wizard, the wizard will automatically derive your class from <CodeContentPlaceHolder>106\</CodeContentPlaceHolder>.  
...
### Remarks  
 The ATL Control Wizard adds **m_nAppearance** stock property of type short. Override <CodeContentPlaceHolder>107\</CodeContentPlaceHolder> if you use a different data type.  
...
### Remarks  
 Initializes the control size to 5080X5080 HIMETRIC units (2"X2") and initializes the <CodeContentPlaceHolder>109\</CodeContentPlaceHolder> data member values to **NULL** or **FALSE**.  
...
### Remarks  
 If the control is windowed, <CodeContentPlaceHolder>110\</CodeContentPlaceHolder> destroys it by calling [DestroyWindow](http://msdn.microsoft.com/library/windows/desktop/ms632682).  
...
### Parameters  
 ...
 A pointer to the interface pointer identified by <CodeContentPlaceHolder>113\</CodeContentPlaceHolder>, or **NULL** if the interface is not found.  
...
##  \<a name="ccomcontrolbase__doesverbactivate">\</a>  CComControlBase::DoesVerbActivate  
 Checks that the <CodeContentPlaceHolder>114\</CodeContentPlaceHolder> parameter used by <CodeContentPlaceHolder>115\</CodeContentPlaceHolder> either activates the control's user interface ( <CodeContentPlaceHolder>116\</CodeContentPlaceHolder> equals <CodeContentPlaceHolder>117\</CodeContentPlaceHolder>), defines the action taken when the user double-clicks the control ( <CodeContentPlaceHolder>118\</CodeContentPlaceHolder> equals <CodeContentPlaceHolder>119\</CodeContentPlaceHolder>), displays the control ( <CodeContentPlaceHolder>120\</CodeContentPlaceHolder> equals <CodeContentPlaceHolder>121\</CodeContentPlaceHolder>), or activates the control ( <CodeContentPlaceHolder>122\</CodeContentPlaceHolder> equals **OLEIVERB_INPLACEACTIVATE**).  
  
<CodeContentPlaceHolder>5\</CodeContentPlaceHolder>  
### Parameters  
 <CodeContentPlaceHolder>123\</CodeContentPlaceHolder>  
 Value indicating the action to be performed by <CodeContentPlaceHolder>124\</CodeContentPlaceHolder>.  
  
### Return Value  
 Returns **TRUE** if <CodeContentPlaceHolder>125\</CodeContentPlaceHolder> equals <CodeContentPlaceHolder>126\</CodeContentPlaceHolder>, <CodeContentPlaceHolder>127\</CodeContentPlaceHolder>, <CodeContentPlaceHolder>128\</CodeContentPlaceHolder>, or **OLEIVERB_INPLACEACTIVATE**; otherwise, returns **FALSE**.  
...
##  \<a name="ccomcontrolbase__doesverbuiactivate">\</a>  CComControlBase::DoesVerbUIActivate  
 Checks that the <CodeContentPlaceHolder>129\</CodeContentPlaceHolder> parameter used by <CodeContentPlaceHolder>130\</CodeContentPlaceHolder> causes the control's user interface to activate and returns **TRUE**.  
  
<CodeContentPlaceHolder>6\</CodeContentPlaceHolder>  
### Parameters  
 <CodeContentPlaceHolder>131\</CodeContentPlaceHolder>  
 Value indicating the action to be performed by <CodeContentPlaceHolder>132\</CodeContentPlaceHolder>.  
  
### Return Value  
 Returns **TRUE** if <CodeContentPlaceHolder>133\</CodeContentPlaceHolder> equals <CodeContentPlaceHolder>134\</CodeContentPlaceHolder>, <CodeContentPlaceHolder>135\</CodeContentPlaceHolder>, <CodeContentPlaceHolder>136\</CodeContentPlaceHolder>, or **OLEIVERB_INPLACEACTIVATE**. Otherwise, the method returns **FALSE**.  
...
##  \<a name="ccomcontrolbase__getambientfont">\</a>  CComControlBase::GetAmbientFont  
 Retrieves a pointer to the container's ambient <CodeContentPlaceHolder>140\</CodeContentPlaceHolder> interface.  
...
##  \<a name="ccomcontrolbase__getambientmessagereflect">\</a>  CComControlBase::GetAmbientMessageReflect  
 Retrieves **DISPID_AMBIENT_MESSAGEREFLECT**, a flag indicating whether the container wants to receive window messages (such as <CodeContentPlaceHolder>144\</CodeContentPlaceHolder>) as events.  
...
##  \<a name="ccomcontrolbase__getambientpalette">\</a>  CComControlBase::GetAmbientPalette  
 Retrieves **DISPID_AMBIENT_PALETTE**, used to access the container's <CodeContentPlaceHolder>146\</CodeContentPlaceHolder>.  
...
##  \<a name="ccomcontrolbase__getambientproperty">\</a>  CComControlBase::GetAmbientProperty  
 Retrieves the container property specified by <CodeContentPlaceHolder>148\</CodeContentPlaceHolder>.  
...
### Remarks  
 ATL has provided a set of helper functions to retrieve specific properties, for example, [CComControlBase::GetAmbientBackColor](../vs140/ccomcontrolbase--getambientbackcolor.md). If there is no suitable method available, use <CodeContentPlaceHolder>151\</CodeContentPlaceHolder>.  
...
##  \<a name="ccomcontrolbase__getdirty">\</a>  CComControlBase::GetDirty  
 Returns the value of data member <CodeContentPlaceHolder>153\</CodeContentPlaceHolder>.  
...
##  \<a name="ccomcontrolbase__inplaceactivate">\</a>  CComControlBase::InPlaceActivate  
 Causes the control to transition from the inactive state to whatever state the verb in <CodeContentPlaceHolder>155\</CodeContentPlaceHolder> indicates.  
...
### Parameters  
 ...
 The IID of the interface pointer that should be returned in <CodeContentPlaceHolder>159\</CodeContentPlaceHolder>.  
  
 <CodeContentPlaceHolder>160\</CodeContentPlaceHolder>  
 Address of the pointer variable that receives the interface pointer requested in <CodeContentPlaceHolder>161\</CodeContentPlaceHolder>.  
  
### Return Value  
 Returns S_OK on success, or an error HRESULT on failure.  
  
### Remarks  
 If the site supports the interface requested in <CodeContentPlaceHolder>162\</CodeContentPlaceHolder>, the pointer is returned by means of <CodeContentPlaceHolder>163\</CodeContentPlaceHolder>. Otherwise, <CodeContentPlaceHolder>164\</CodeContentPlaceHolder> is set to NULL.  
...
### Remarks  
 This flag is checked by <CodeContentPlaceHolder>165\</CodeContentPlaceHolder> and, if **TRUE**, causes the function to return **E_FAIL**.  
...
##  \<a name="ccomcontrolbase__m_bdrawfromnatural">\</a>  CComControlBase::m_bDrawFromNatural  
 Flag indicating that <CodeContentPlaceHolder>166\</CodeContentPlaceHolder> and <CodeContentPlaceHolder>167\</CodeContentPlaceHolder> should set the control size from <CodeContentPlaceHolder>168\</CodeContentPlaceHolder> rather than from <CodeContentPlaceHolder>169\</CodeContentPlaceHolder>.  
...
##  \<a name="ccomcontrolbase__m_bdrawgetdatainhimetric">\</a>  CComControlBase::m_bDrawGetDataInHimetric  
 Flag indicating that <CodeContentPlaceHolder>170\</CodeContentPlaceHolder> should use HIMETRIC units and not pixels when drawing.  
...
### Remarks  
 This means the control is visible and its window, if any, is visible, but its menus and toolbars may not be active. The <CodeContentPlaceHolder>171\</CodeContentPlaceHolder> flag indicates the control's user interface, such as menus, is also active.  
...
>  To use this data member within your control class, you must declare it as a data member in your control class. Your control class will not inherit this data member from the base class because it is declared within a union in the base class.  
 ...
 The data member <CodeContentPlaceHolder>172\</CodeContentPlaceHolder> points to an [IOleInPlaceSite](http://msdn.microsoft.com/library/windows/desktop/ms686586), [IOleInPlaceSiteEx](http://msdn.microsoft.com/library/windows/desktop/ms693461), or [IOleInPlaceSiteWindowless](http://msdn.microsoft.com/library/windows/desktop/ms682300) interface, depending on the value of the <CodeContentPlaceHolder>173\</CodeContentPlaceHolder> and <CodeContentPlaceHolder>174\</CodeContentPlaceHolder> flags. (The data member <CodeContentPlaceHolder>175\</CodeContentPlaceHolder> must be **TRUE** for the <CodeContentPlaceHolder>176\</CodeContentPlaceHolder> pointer to be valid.)  
  
 If <CodeContentPlaceHolder>177\</CodeContentPlaceHolder> is **FALSE** and <CodeContentPlaceHolder>178\</CodeContentPlaceHolder> is **TRUE**, <CodeContentPlaceHolder>179\</CodeContentPlaceHolder> is an **IOleInPlaceSiteEx** interface pointer. See [m_spInPlaceSite](../vs140/ccomcontrolbase--m_spinplacesite.md) for a table showing the relationship among these three data members.  
...
>  To use this data member within your control class, you must declare it as a data member in your control class. Your control class will not inherit this data member from the base class because it is declared within a union in the base class.  
 ...
 The <CodeContentPlaceHolder>180\</CodeContentPlaceHolder> flag must be **TRUE** for the <CodeContentPlaceHolder>181\</CodeContentPlaceHolder> pointer to be valid.  
...
>  To use this data member within your control class, you must declare it as a data member in your control class. Your control class will not inherit this data member from the base class because it is declared within a union in the base class.  
 ...
 This flag is checked by [IOleObjectImpl::SetExtent](../vs140/ioleobjectimpl--setextent.md) and, if **TRUE**, <CodeContentPlaceHolder>182\</CodeContentPlaceHolder> notifies the container of view changes. if this flag is set, the **OLEMISC_RECOMPOSEONRESIZE** bit in the [OLEMISC](http://msdn.microsoft.com/library/windows/desktop/ms678497) enumeration should also be set.  
...
### Remarks  
 The value of <CodeContentPlaceHolder>183\</CodeContentPlaceHolder> can be set with [CComControlBase::SetDirty](../vs140/ccomcontrolbase--setdirty.md) and retrieved with [CComControlBase::GetDirty](../vs140/ccomcontrolbase--getdirty.md).  
...
### Remarks  
 This flag is checked by <CodeContentPlaceHolder>184\</CodeContentPlaceHolder> and, if **TRUE**, the size passed into <CodeContentPlaceHolder>185\</CodeContentPlaceHolder> is assigned to <CodeContentPlaceHolder>186\</CodeContentPlaceHolder>.  
  
 The size passed into <CodeContentPlaceHolder>187\</CodeContentPlaceHolder> is always assigned to <CodeContentPlaceHolder>188\</CodeContentPlaceHolder>, regardless of the value of <CodeContentPlaceHolder>189\</CodeContentPlaceHolder>.  
...
### Remarks  
 The <CodeContentPlaceHolder>190\</CodeContentPlaceHolder> flag indicates that the control is active, but not that its user interface is active.  
...
>  To use this data member within your control class, you must declare it as a data member in your control class. Your control class will not inherit this data member from the base class because it is declared within a union in the base class.  
 ...
 The data member <CodeContentPlaceHolder>191\</CodeContentPlaceHolder> points to an [IOleInPlaceSite](http://msdn.microsoft.com/library/windows/desktop/ms686586), [IOleInPlaceSiteEx](http://msdn.microsoft.com/library/windows/desktop/ms693461), or [IOleInPlaceSiteWindowless](http://msdn.microsoft.com/library/windows/desktop/ms682300) interface, depending on the value of the <CodeContentPlaceHolder>192\</CodeContentPlaceHolder> and [CComControlBase::m_bInPlaceSiteEx](../vs140/ccomcontrolbase--m_binplacesiteex.md) flags. (The data member [CComControlBase::m_bNegotiatedWnd](../vs140/ccomcontrolbase--m_bnegotiatedwnd.md) must be **TRUE** for the [CComControlBase::m_spInPlaceSite](../vs140/ccomcontrolbase--m_spinplacesite.md) pointer to be valid.)  
  
 If <CodeContentPlaceHolder>193\</CodeContentPlaceHolder> is **TRUE**, <CodeContentPlaceHolder>194\</CodeContentPlaceHolder> is an **IOleInPlaceSiteWindowless** interface pointer. See [CComControlBase::m_spInPlaceSite](../vs140/ccomcontrolbase--m_spinplacesite.md) for a table showing the complete relationship between these data members.  
...
>  To use this data member within your control class, you must declare it as a data member in your control class. Your control class will not inherit this data member from the base class because it is declared within a union in the base class.  
 ...
 This size is scaled by the display. The control's physical size is specified in the <CodeContentPlaceHolder>195\</CodeContentPlaceHolder> data member and is fixed.  
...
>  To use this data member within your control class, you must declare it as a data member in your control class. Your control class will not inherit this data member from the base class because it is declared within a union in the base class.  
 ...
 This size is fixed, while the size in <CodeContentPlaceHolder>196\</CodeContentPlaceHolder> is scaled by the display.  
...
##  \<a name="ccomcontrolbase__m_spambientdispatch">\</a>  CComControlBase::m_spAmbientDispatch  
 A <CodeContentPlaceHolder>197\</CodeContentPlaceHolder> object that lets you retrieve and set an object's properties through an <CodeContentPlaceHolder>198\</CodeContentPlaceHolder> pointer.  
...
>  To use this data member within your control class, you must declare it as a data member in your control class. Your control class will not inherit this data member from the base class because it is declared within a union in the base class.  
 ...
 The <CodeContentPlaceHolder>200\</CodeContentPlaceHolder> pointer is valid only if the [m_bNegotiatedWnd](../vs140/ccomcontrolbase--m_bnegotiatedwnd.md) flag is **TRUE**.  
  
 The following table shows how the <CodeContentPlaceHolder>201\</CodeContentPlaceHolder> pointer type depends on the [m_bWndLess](../vs140/ccomcontrolbase--m_bwndless.md) and [m_bInPlaceSiteEx](../vs140/ccomcontrolbase--m_binplacesiteex.md) data member flags:  
  
|m_spInPlaceSite Type|m_bWndLess Value|m_bInPlaceSiteEx Value|  
|---------------------------|-----------------------|-----------------------------|  
|**IOleInPlaceSiteWindowless**|**TRUE**|**TRUE** or **FALSE**|  
|**IOleInPlaceSiteEx**|**FALSE**|**TRUE**|  
|<CodeContentPlaceHolder>202\</CodeContentPlaceHolder>|**FALSE**|**FALSE**|  
...
>  To use this data member within your control class, you must declare it as a data member in your control class. Your control class will not inherit this data member from the base class because it is declared within a union in the base class.  
 ...
 The interface <CodeContentPlaceHolder>203\</CodeContentPlaceHolder> implements the [IOleObject::Advise](http://msdn.microsoft.com/library/windows/desktop/ms686573) and [IOleObject::Unadvise](http://msdn.microsoft.com/library/windows/desktop/ms693749) methods to establish and delete advisory connections to the container. The control's container must implement an advise sink by supporting the [IAdviseSink](http://msdn.microsoft.com/library/windows/desktop/ms692513) interface.  
...
### Return Value  
 A standard <CodeContentPlaceHolder>205\</CodeContentPlaceHolder> value.  
  
### Remarks  
 The default <CodeContentPlaceHolder>206\</CodeContentPlaceHolder> deletes or restores the device context or does nothing, depending on flags set in [CComControlBase::OnDrawAdvanced](../vs140/ccomcontrolbase--ondrawadvanced.md).  
  
 An <CodeContentPlaceHolder>207\</CodeContentPlaceHolder> method is automatically added to your control class when you create your control with the ATL Control Wizard. The wizard's default <CodeContentPlaceHolder>208\</CodeContentPlaceHolder> draws a rectangle with the label "ATL 8.0".  
...
##  \<a name="ccomcontrolbase__ondrawadvanced">\</a>  CComControlBase::OnDrawAdvanced  
 The default <CodeContentPlaceHolder>209\</CodeContentPlaceHolder> prepares a normalized device context for drawing, then calls your control class's <CodeContentPlaceHolder>210\</CodeContentPlaceHolder> method.  
...
### Return Value  
 A standard <CodeContentPlaceHolder>212\</CodeContentPlaceHolder> value.  
...
### Parameters  
 ...
 Flag that indicates whether the window message was successfully handled. The default is <CodeContentPlaceHolder>217\</CodeContentPlaceHolder>.  
...
### Parameters  
 ...
 Flag that indicates whether the window message was successfully handled. The default is <CodeContentPlaceHolder>222\</CodeContentPlaceHolder>.  
  
### Return Value  
 Always returns 1.  
  
##  \<a name="ccomcontrolbase__onpaint">\</a>  CComControlBase::OnPaint  
 Prepares the container for painting, gets the control's client area, then calls the control class's <CodeContentPlaceHolder>223\</CodeContentPlaceHolder> method.  
...
### Remarks  
 If <CodeContentPlaceHolder>228\</CodeContentPlaceHolder> is not NULL, <CodeContentPlaceHolder>229\</CodeContentPlaceHolder> assumes it contains a valid HDC and uses it instead of [CComControlBase::m_hWndCD](../vs140/ccomcontrolbase--m_hwndcd.md).  
...
### Parameters  
 ...
 Flag that indicates whether the window message was successfully handled. The default is <CodeContentPlaceHolder>234\</CodeContentPlaceHolder>.  
...
### Remarks  
 <CodeContentPlaceHolder>237\</CodeContentPlaceHolder> calls [IAdviseSink::OnViewChange](http://msdn.microsoft.com/library/windows/desktop/ms694337). The only value of *lindex* currently supported is -1, which indicates that the entire view is of interest.  
...
##  \<a name="ccomcontrolbase__setdirty">\</a>  CComControlBase::SetDirty  
 Sets the data member <CodeContentPlaceHolder>238\</CodeContentPlaceHolder> to the value in <CodeContentPlaceHolder>239\</CodeContentPlaceHolder>.  
...
### Remarks  
 **SetDirty(TRUE)** should be called to flag that the control has changed since it was last saved. The value of <CodeContentPlaceHolder>241\</CodeContentPlaceHolder> is retrieved with [CComControlBase::GetDirty](../vs140/ccomcontrolbase--getdirty.md).  
