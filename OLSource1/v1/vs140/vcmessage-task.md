...
|**Type**|Optional **String** parameter.\<br />\<br /> Specifies the kind of message to emit. Specify either <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> to emit a warning message, or <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> to emit an error message.|  
