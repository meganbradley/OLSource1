...
## Example  
 This example shows how to obtain the <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> interface from a session. For a more complete example of using tables, see the [IDiaTable](../vs140/idiatable.md) interface.  
