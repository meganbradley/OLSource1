...
Use the **Output** tab to specify what data from each message to list in [Messages View](../vs140/messages-view.md). To display the [Message Options Dialog Box](../vs140/message-options-dialog-box.md), choose **Log Messages** from the **Spy** menu.  
