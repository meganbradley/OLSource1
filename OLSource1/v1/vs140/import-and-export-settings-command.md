...
## Switches  
 /export:<CodeContentPlaceHolder>2\</CodeContentPlaceHolder>  
 Optional. Exports the current settings to the specified file.  
  
 /import:<CodeContentPlaceHolder>3\</CodeContentPlaceHolder>  
...
## Example  
 The following command exports the curent settings to the file <CodeContentPlaceHolder>4\</CodeContentPlaceHolder>.  
