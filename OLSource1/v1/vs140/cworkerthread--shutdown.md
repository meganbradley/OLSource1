...
## Return Value  
 Returns S_OK on success, or an error HRESULT on failure, such as if the timeout value, <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>, is exceeded.  
  
## Remarks  
 To reuse the object, call [CWorkerThread::Initialize](../vs140/cworkerthread--initialize.md) after calling this method.  
  
 Note that calling **Shutdown** on an object initialized with a pointer to another <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> object has no effect and always returns S_OK.  
