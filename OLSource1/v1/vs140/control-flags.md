...
|[_crtDbgFlag](../vs140/_crtdbgflag.md)|Controls how the debug heap manager tracks allocations|  
 ...
 These flags can be defined with a /D command-line option or with a <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> directive. When the flag is defined with <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>, the directive must appear before the header file include statement for the routine declarations.  
