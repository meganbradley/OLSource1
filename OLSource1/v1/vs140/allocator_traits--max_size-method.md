...
## Remarks  
 This method returns <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>, if that expression is well formed; otherwise it returns <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>.  
