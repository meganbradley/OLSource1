...
## Return Value  
 If successful, returns the gamma of <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>.  
  
 A range error may occur if the magnitude of <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> is too large or too small for the data type. A domain error or range error     may occur if <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> <=0.  
...
|--------------|--------------|------------------|  
|<CodeContentPlaceHolder>5\</CodeContentPlaceHolder>,                <CodeContentPlaceHolder>6\</CodeContentPlaceHolder>,  <CodeContentPlaceHolder>7\</CodeContentPlaceHolder>|\<math.h>|\<cmath>|  
