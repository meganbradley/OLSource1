...
|[raw_dispinterfaces](../vs140/raw_dispinterfaces.md)|Tells the compiler to generate low-level wrapper functions for dispinterface methods and properties that call **IDispatch::Invoke** and return the <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> error code.|  
