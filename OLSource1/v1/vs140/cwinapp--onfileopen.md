...
## Remarks  
 You must add an <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> statement to your <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> class message map to enable this member function. If enabled, this function handles execution of the File Open command.  
