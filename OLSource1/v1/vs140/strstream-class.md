...
|||  
|-|-|  
|[strstream](#strstream__strstream)|Constructs an object of type <CodeContentPlaceHolder>7\</CodeContentPlaceHolder>.|  
...
|[rdbuf](#strstream__rdbuf)|Returns a pointer to the stream's associated <CodeContentPlaceHolder>8\</CodeContentPlaceHolder> object.|  
...
### Example  
  See [strstreambuf::pcount](../vs140/strstreambuf-class.md#strstreambuf__pcount) for a sample that uses <CodeContentPlaceHolder>11\</CodeContentPlaceHolder>.  
