...
|-----------|-----------------|-----------------|  
|[CA2AEX](../vs140/ca2aex-class.md)|This class is used by the string conversion macros <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> and <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>, and the typedef **CA2A**.|atlconv.h|  
|[CA2CAEX](../vs140/ca2caex-class.md)|This class is used by string conversion macros <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> and <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>, and the typedef **CA2CA**.|atlconv.h|  
|[CA2WEX](../vs140/ca2wex-class.md)|This class is used by the string conversion macros <CodeContentPlaceHolder>4\</CodeContentPlaceHolder>, <CodeContentPlaceHolder>5\</CodeContentPlaceHolder>, <CodeContentPlaceHolder>6\</CodeContentPlaceHolder>, and <CodeContentPlaceHolder>7\</CodeContentPlaceHolder>, and the typedef **CA2W**.|atlconv.h|  
...
|[CBindStatusCallback](../vs140/cbindstatuscallback-class.md)|This class implements the <CodeContentPlaceHolder>8\</CodeContentPlaceHolder> interface.|atlctl.h|  
...
|[CComAutoThreadModule](../vs140/ccomautothreadmodule-class.md)|As of ATL 7.0, <CodeContentPlaceHolder>9\</CodeContentPlaceHolder> is obsolete: see [ATL Modules](../vs140/atl-module-classes.md) for more details.|atlbase.h|  
|[CComBSTR](../vs140/ccombstr-class.md)|This class is a wrapper for <CodeContentPlaceHolder>10\</CodeContentPlaceHolder>s.|atlbase.h|  
...
|[CComCurrency](../vs140/ccomcurrency-class.md)|This class has methods and operators for creating and managing a <CodeContentPlaceHolder>11\</CodeContentPlaceHolder> object.|atlcur.h|  
...
|[CComModule](../vs140/ccommodule-class.md)|As of ATL 7.0, <CodeContentPlaceHolder>12\</CodeContentPlaceHolder> is obsolete: see [ATL Modules](../vs140/atl-module-classes.md) for more details.|atlbase.h|  
...
|[CComObjectGlobal](../vs140/ccomobjectglobal-class.md)|This class manages a reference count on the module containing your <CodeContentPlaceHolder>13\</CodeContentPlaceHolder> object.|atlcom.h|  
...
|[CComSafeArray](../vs140/ccomsafearray-class.md)|This class is a wrapper for the <CodeContentPlaceHolder>14\</CodeContentPlaceHolder> structure.|atlsafe.h|  
|[CComSafeArrayBound](../vs140/ccomsafearraybound-class.md)|This class is a wrapper for a <CodeContentPlaceHolder>15\</CodeContentPlaceHolder> structure.|atlsafe.h|  
...
|[CNoWorkerThread Class](../vs140/cnoworkerthread-class.md)|Use this class as the argument for the <CodeContentPlaceHolder>16\</CodeContentPlaceHolder> template parameter cache classes if you want to disable dynamic cache maintenance.|atlutil.h|  
...
|[CSid](../vs140/csid-class.md)|This class is a wrapper for a <CodeContentPlaceHolder>17\</CodeContentPlaceHolder> (security identifier) structure.|atlsecurity.h|  
...
|[CStringElementTraits](../vs140/cstringelementtraits-class.md)|This class provides static functions used by collection classes storing <CodeContentPlaceHolder>18\</CodeContentPlaceHolder> objects.|cstringt.h|  
...
|[CW2AEX](../vs140/cw2aex-class.md)|This class is used by the string conversion macros <CodeContentPlaceHolder>19\</CodeContentPlaceHolder>, <CodeContentPlaceHolder>20\</CodeContentPlaceHolder>, <CodeContentPlaceHolder>21\</CodeContentPlaceHolder>, and <CodeContentPlaceHolder>22\</CodeContentPlaceHolder>, and the typedef **CW2A**.|atlconv.h|  
|[CW2CWEX](../vs140/cw2cwex-class.md)|This class is used by the string conversion macros <CodeContentPlaceHolder>23\</CodeContentPlaceHolder> and <CodeContentPlaceHolder>24\</CodeContentPlaceHolder>, and the typedef **CW2CW**.|atlconv.h|  
|[CW2WEX](../vs140/cw2wex-class.md)|This class is used by the string conversion macros <CodeContentPlaceHolder>25\</CodeContentPlaceHolder> and <CodeContentPlaceHolder>26\</CodeContentPlaceHolder>, and the typedef <CodeContentPlaceHolder>27\</CodeContentPlaceHolder>.|atlconv.h|  
...
|[IAtlAutoThreadModule](../vs140/iatlautothreadmodule-class.md)|This class represents an interface to a <CodeContentPlaceHolder>28\</CodeContentPlaceHolder> method.|atlbase.h|  
...
|[IDispatchImpl](../vs140/idispatchimpl-class.md)|This class provides a default implementation for the <CodeContentPlaceHolder>29\</CodeContentPlaceHolder> portion of a dual interface.|atlcom.h|  
|[IDispEventImpl](../vs140/idispeventimpl-class.md)|This class provides implementations of the <CodeContentPlaceHolder>30\</CodeContentPlaceHolder> methods.|atlcom.h|  
|[IDispEventSimpleImpl](../vs140/idispeventsimpleimpl-class.md)|This class provides implementations of the <CodeContentPlaceHolder>31\</CodeContentPlaceHolder> methods, without getting type information from a type library.|atlcom.h|  
...
|[IObjectSafetyImpl](../vs140/iobjectsafetyimpl-class.md)|This class provides a default implementation of the <CodeContentPlaceHolder>32\</CodeContentPlaceHolder> interface to allow a client to retrieve and set an object's safety levels.|atlctl.h|  
...
|[IServiceProviderImpl](../vs140/iserviceproviderimpl-class.md)|This class provides a default implementation of the <CodeContentPlaceHolder>33\</CodeContentPlaceHolder> interface.|atlcom.h|  
...
|[ISupportErrorInfoImpl](../vs140/isupporterrorinfoimpl-class.md)|This class provides a default implementation of the <CodeContentPlaceHolder>34\</CodeContentPlaceHolder> interface and can be used when only a single interface generates errors on an object.|atlcom.h|  
...
|[IWorkerThreadClient Interface](../vs140/iworkerthreadclient-interface.md)|<CodeContentPlaceHolder>35\</CodeContentPlaceHolder> is the interface implemented by clients of the [CWorkerThread](../vs140/cworkerthread-class.md) class.|atlutil.h|  
|[_U_MENUorID](../vs140/_u_menuorid-class.md)|This class provides wrappers for **CreateWindow** and **CreateWindowEx**.|atlwin.h|  
|[_U_RECT](../vs140/_u_rect-class.md)|This argument adapter class allows either <CodeContentPlaceHolder>36\</CodeContentPlaceHolder> pointers or references to be passed to a function that is implemented in terms of pointers.|atlwin.h|  
|[_U_STRINGorID](../vs140/_u_stringorid-class.md)|This argument adapter class allows either resource names (<CodeContentPlaceHolder>37\</CodeContentPlaceHolder>s) or resource IDs (**UINT**s) to be passed to a function without requiring the caller to convert the ID to a string using the **MAKEINTRESOURCE** macro.|atlwin.h|  
