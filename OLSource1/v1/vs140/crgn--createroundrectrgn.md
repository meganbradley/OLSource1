...
---
# CRgn::CreateRoundRectRgn
Creates a rectangular region with rounded corners that is stored in the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> object.  
...
## Remarks  
 ...
 When an application has finished using a region created with the <CodeContentPlaceHolder>7\</CodeContentPlaceHolder> function, it should select the region out of the device context and use the [CGDIObject::DeleteObject](../vs140/cgdiobject--deleteobject.md) member function to remove it.  
