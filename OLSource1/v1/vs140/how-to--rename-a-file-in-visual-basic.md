...
Use the <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> method of the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> object to rename a file by supplying the current location, file name, and the new file name. This method cannot be used to move a file; use the <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> method to move and rename the file.  
  
### To rename a file  
  
-   Use the <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> method to rename a file. This example renames the file named <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> to <CodeContentPlaceHolder>5\</CodeContentPlaceHolder>.  
...
-   <CodeContentPlaceHolder>6\</CodeContentPlaceHolder> contains path information (\<xref:System.ArgumentException*>).  
  
-   The path is not valid because it is <CodeContentPlaceHolder>7\</CodeContentPlaceHolder> (\<xref:System.ArgumentNullException*>).  
  
-   <CodeContentPlaceHolder>8\</CodeContentPlaceHolder> is <CodeContentPlaceHolder>9\</CodeContentPlaceHolder> or an empty string (\<xref:System.ArgumentNullException*>).  
  
-   The source file is not valid or does not exist (\<xref:System.IO.FileNotFoundException*>).  
  
-   There is an existing file or directory with the name specified in <CodeContentPlaceHolder>10\</CodeContentPlaceHolder> (\<xref:System.IO.IOException*>).  
