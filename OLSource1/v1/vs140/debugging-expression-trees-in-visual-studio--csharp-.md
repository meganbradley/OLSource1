...
You can analyze the structure and content of expression trees when you debug your applications. To get a quick overview of the expression tree structure, you can use the `DebugView` property, which is available only in debug mode. For more information about debugging, see [Debugging in Visual Studio](../vs140/debugging-in-visual-studio.md).  
 ...
 To better represent the content of expression trees, the `DebugView` property uses Visual Studio visualizers. For more information, see [Visualizers](../vs140/create-custom-visualizers-of-data.md).  
...
## ParameterExpressions  
 <xref:System.Linq.Expressions.ParameterExpression?qualifyHint=False> variable names are displayed with a "$" symbol at the beginning.  
...
## ConstantExpressions  
 For <xref:System.Linq.Expressions.ConstantExpression?qualifyHint=False> objects that represent integer values, strings, and `null`, the value of the constant is displayed.  
...
|Type|Suffix|  
|----------|------------|  
|<xref:System.UInt32?qualifyHint=False>|U|  
|<xref:System.Int64?qualifyHint=False>|L|  
|<xref:System.UInt64?qualifyHint=False>|UL|  
|<xref:System.Double?qualifyHint=False>|D|  
|<xref:System.Single?qualifyHint=False>|F|  
|<xref:System.Decimal?qualifyHint=False>|M|  
...
## BlockExpression  
 If the type of a <xref:System.Linq.Expressions.BlockExpression?qualifyHint=False> object differs from the type of the last expression in the block, the type is displayed in the `DebugInfo` property in angle brackets (< and >). Otherwise, the type of the <xref:System.Linq.Expressions.BlockExpression?qualifyHint=False> object is not displayed.  
...
## LambdaExpression  
 <xref:System.Linq.Expressions.LambdaExpression?qualifyHint=False> objects are displayed together with their delegate types.  
...
## LabelExpression  
 If you specify a default value for the <xref:System.Linq.Expressions.LabelExpression?qualifyHint=False> object, this value is displayed before the <xref:System.Linq.Expressions.LabelTarget?qualifyHint=False> object.  
