...
dev_langs: 
  - "C++"
helpviewer_keywords: 
  - "CMFCRibbonStatusBarPane class, constructor"
...
#### Parameters  
 ...
 If <CodeContentPlaceHolder>4\</CodeContentPlaceHolder>, the status pane cannot be highlighted or selected by clicking it.  
