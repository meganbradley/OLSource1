...
-   **Language**  
     ...
     Choose from **CS** (C#, which is the default), **VB** (Visual Basic), or **JS** (JScript). You can also specify a fully qualified name for a class that implements <CodeContentPlaceHolder>0\</CodeContentPlaceHolder>.  
...
-   **Sources**  
     ...
     Required <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> parameter.  
...
-   **SuppressStartupBanner**  
     ...
     If <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>, prevents the display of the copyright and version number message when the task starts.  
