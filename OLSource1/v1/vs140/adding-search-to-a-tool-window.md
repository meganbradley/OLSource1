...
1.  Create a VSIX project named <CodeContentPlaceHolder>15\</CodeContentPlaceHolder> with a tool window named **TestSearch**. If you need help doing this, see [Creating an Extension with a Tool Window](../vs140/creating-an-extension-with-a-tool-window.md).  
  
## To create a tool window  
  
1.  In the <CodeContentPlaceHolder>16\</CodeContentPlaceHolder> project, open the TestSearchControl.xaml file.  
  
2.  Replace the existing <CodeContentPlaceHolder>17\</CodeContentPlaceHolder> block with the following block, which adds a read-only \<xref:System.Windows.Controls.TextBox*> to the \<xref:System.Windows.Controls.UserControl*> in the tool window.  
  
<CodeContentPlaceHolder>0\</CodeContentPlaceHolder>  
3.  In the TestSearchControl.xaml.cs file, add the following using statement:  
  
<CodeContentPlaceHolder>1\</CodeContentPlaceHolder>  
4.  Remove the <CodeContentPlaceHolder>18\</CodeContentPlaceHolder> method.  
...
<CodeContentPlaceHolder>2\</CodeContentPlaceHolder>  
     [!code[ToolWindowSearch#1](../vs140/codesnippet/CSharp/adding-search-to-a-tool-window_1.cs)]
[!code[ToolWindowSearch#1](../vs140/codesnippet/VisualBasic/adding-search-to-a-tool-window_1.vb)]  
...
1.  In the TestSearch.cs file, add the following code to the <CodeContentPlaceHolder>19\</CodeContentPlaceHolder> class. The code overrides the \<xref:Microsoft.VisualStudio.Shell.Interop.IVsWindowSearch.SearchEnabled*> property so that the get accessor returns <CodeContentPlaceHolder>20\</CodeContentPlaceHolder>.  
...
1.  In the TestSearch.cs file, add the following <CodeContentPlaceHolder>21\</CodeContentPlaceHolder> statements:  
  
<CodeContentPlaceHolder>4\</CodeContentPlaceHolder>  
2.  In the <CodeContentPlaceHolder>22\</CodeContentPlaceHolder> class, add the following code, which performs the following actions:  
...
1.  In the TestSearch.cs file, add the following code to the <CodeContentPlaceHolder>25\</CodeContentPlaceHolder> class. This code enables instant search instead of on-demand search (meaning that the user doesn’t have to click ENTER). The code overrides the <CodeContentPlaceHolder>26\</CodeContentPlaceHolder> method in the <CodeContentPlaceHolder>27\</CodeContentPlaceHolder> class, which is necessary to change the default settings.  
...
3.  In the <CodeContentPlaceHolder>28\</CodeContentPlaceHolder> method, add the following line, which enables the display of a progress bar.  
  
<CodeContentPlaceHolder>7\</CodeContentPlaceHolder>  
     For the progress bar to appear, the progress must be reported. To report the progress, uncomment the following code in the <CodeContentPlaceHolder>29\</CodeContentPlaceHolder> method of the <CodeContentPlaceHolder>30\</CodeContentPlaceHolder> class:  
  
<CodeContentPlaceHolder>8\</CodeContentPlaceHolder>  
4.  To slow processing enough that the progress bar is visible, uncomment the following line in the <CodeContentPlaceHolder>31\</CodeContentPlaceHolder> method of the <CodeContentPlaceHolder>32\</CodeContentPlaceHolder> class:  
...
1.  In the TestSearch.cs file, add the following code to the <CodeContentPlaceHolder>33\</CodeContentPlaceHolder> class. The code overrides the <CodeContentPlaceHolder>34\</CodeContentPlaceHolder> method, which allows the search implementation to detect whether a given option is on or off. The code in <CodeContentPlaceHolder>35\</CodeContentPlaceHolder> adds an option to match case to an \<xref:Microsoft.VisualStudio.Shell.Interop.IVsEnumWindowSearchOptions*> enumerator. The option to match case is also made available as the <CodeContentPlaceHolder>36\</CodeContentPlaceHolder> property.  
  
<CodeContentPlaceHolder>10\</CodeContentPlaceHolder>  
2.  In the <CodeContentPlaceHolder>37\</CodeContentPlaceHolder> class, uncomment matchCase line in the <CodeContentPlaceHolder>38\</CodeContentPlaceHolder> method:  
...
1.  In the TestSearch.cs file, add the following code to the <CodeContentPlaceHolder>39\</CodeContentPlaceHolder> class. The code implements <CodeContentPlaceHolder>40\</CodeContentPlaceHolder> by adding a \<xref:Microsoft.VisualStudio.PlatformUI.WindowSearchSimpleFilter*> that specifies to filter the search results so that only even lines appear.  
  
<CodeContentPlaceHolder>12\</CodeContentPlaceHolder>  
     Now the search control displays the search filter <CodeContentPlaceHolder>41\</CodeContentPlaceHolder>. When the user chooses the filter, the string <CodeContentPlaceHolder>42\</CodeContentPlaceHolder> appears in the search box. Other search criteria can appear at the same time as the filter. Search strings may appear before the filter, after the filter, or both.  
  
2.  In the TestSearch.cs file, add the following methods to the <CodeContentPlaceHolder>43\</CodeContentPlaceHolder> class, which is in the <CodeContentPlaceHolder>44\</CodeContentPlaceHolder> class. These methods support the <CodeContentPlaceHolder>45\</CodeContentPlaceHolder> method, which you’ll modify in the next step.  
  
<CodeContentPlaceHolder>13\</CodeContentPlaceHolder>  
3.  In the <CodeContentPlaceHolder>46\</CodeContentPlaceHolder> class, update the <CodeContentPlaceHolder>47\</CodeContentPlaceHolder> method with the following code. This change updates the code to support the filter.  
...
7.  Delete <CodeContentPlaceHolder>48\</CodeContentPlaceHolder> from the search box, select the **Match case** check box, and then enter <CodeContentPlaceHolder>49\</CodeContentPlaceHolder> in the search box.  
