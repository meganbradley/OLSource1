...
## Return Value  
 A pointer to the single <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> object for the application.  
...
## Example  
 [!code[NVC_MFCWindowing#126](../vs140/codesnippet/CPP/afxgetapp_1.cpp)]  
