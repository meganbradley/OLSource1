...
---
# CTabCtrl::SetItemState
Sets the state of the tab control item identified by <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>.  
...
#### Parameters  
 ...
 A reference to a <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> value containing the state information. Can be one of the following values:  
