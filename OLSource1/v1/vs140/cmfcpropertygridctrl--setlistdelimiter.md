...
## Remarks  
 Use this method to define a delimiter character in a list of property values that are used in the [CMFCPropertyGridProperty::CMFCPropertyGridProperty](../vs140/cmfcpropertygridproperty--cmfcpropertygridproperty.md) constructor. In that constructor, set the <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> parameter to <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>.  
