...
>  The following technical note has not been updated since it was first included in the online documentation. As a result, some procedures and topics might be out of date or incorrect. For the latest information, it is recommended that you search for the topic of interest in the online documentation index.  
 ...
 A **ControlBar** is a <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>-derived class that:  
  
-   Is aligned to the top or bottom of a frame window.  
  
-   May contain child items that are either HWND-based controls (for example, <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>) or non-<CodeContentPlaceHolder>4\</CodeContentPlaceHolder> based items (for example, <CodeContentPlaceHolder>5\</CodeContentPlaceHolder>, <CodeContentPlaceHolder>6\</CodeContentPlaceHolder>).  
  
 Control bars support the additional styles:  
  
-   <CodeContentPlaceHolder>7\</CodeContentPlaceHolder> (The default) pin the control bar to the top.  
  
-   <CodeContentPlaceHolder>8\</CodeContentPlaceHolder> Pin the control bar to the bottom.  
  
-   <CodeContentPlaceHolder>9\</CodeContentPlaceHolder> Do not reposition the control bar when the parent resizes.  
  
 Classes derived from <CodeContentPlaceHolder>10\</CodeContentPlaceHolder> provide more interesting implementations:  
  
-   <CodeContentPlaceHolder>11\</CodeContentPlaceHolder> A status bar, items are status bar panes containing text.  
  
-   <CodeContentPlaceHolder>12\</CodeContentPlaceHolder> A toolbar, items are bitmap buttons aligned in a row.  
  
-   <CodeContentPlaceHolder>13\</CodeContentPlaceHolder> A toolbar-like frame containing standard windows controls (created from a dialog template resource).  
  
-   **CDockBar** A generalized docking area for other <CodeContentPlaceHolder>14\</CodeContentPlaceHolder> derived objects. The specific member functions and variables available in this class are likely to change in future releases.  
 ...
 The <CodeContentPlaceHolder>15\</CodeContentPlaceHolder> class gives standard implementation for:  
...
-   Supporting the implementation of derived classes.  
 ...
 C++ control bar objects will usually be embedded as members of a <CodeContentPlaceHolder>16\</CodeContentPlaceHolder> derived class, and will be cleaned up when the parent <CodeContentPlaceHolder>17\</CodeContentPlaceHolder> and object are destroyed. If you need to allocate a control bar object on the heap, you can simply set the **m_bAutoDestruct** member to **TRUE** to make the control bar "**delete this**" when the <CodeContentPlaceHolder>18\</CodeContentPlaceHolder> is destroyed.  
  
> [!NOTE]
>  If you create your own <CodeContentPlaceHolder>19\</CodeContentPlaceHolder>-derived class, rather than using one of MFC's derived classes, such as <CodeContentPlaceHolder>20\</CodeContentPlaceHolder>, <CodeContentPlaceHolder>21\</CodeContentPlaceHolder>, or <CodeContentPlaceHolder>22\</CodeContentPlaceHolder>, you will need to set the <CodeContentPlaceHolder>23\</CodeContentPlaceHolder> data member. This can be done in the override of **Create**:  
 ...
 **Control Bar Layout Algorithm**  
 ...
 See <CodeContentPlaceHolder>24\</CodeContentPlaceHolder> and <CodeContentPlaceHolder>25\</CodeContentPlaceHolder> for more details.  
 ...
 **CCmdUI Support for CStatusBar**  
 ...
 The way indicators are usually updated is through the <CodeContentPlaceHolder>27\</CodeContentPlaceHolder> mechanism. On idle time, the status bar will call the <CodeContentPlaceHolder>28\</CodeContentPlaceHolder> handler with the string ID of the indicator pane.  
  
 The <CodeContentPlaceHolder>29\</CodeContentPlaceHolder> handler can call:  
...
-   **SetText**: To change the text. Be careful if you use this because the pane will not automatically resize.  
 ...
 Refer to class [CStatusBar](../vs140/cstatusbar-class.md) in the *Class Library Reference* for details about <CodeContentPlaceHolder>30\</CodeContentPlaceHolder> creation and customization APIs. Most customization of status bars should be done before the status bar is initially made visible.  
 ...
 A toolbar is a control bar with a row of bitmap buttons that may include separators. Two styles of buttons are supported: pushbuttons and check box buttons. Radio group functionality can be built with check box buttons and <CodeContentPlaceHolder>32\</CodeContentPlaceHolder>.  
...
|RGB(255, 255, 255)|COLOR_BTNHIGHLIGHT|  
 ...
 Refer to class [CToolBar](../vs140/ctoolbar-class.md) the *Class Library Reference* for details about the <CodeContentPlaceHolder>33\</CodeContentPlaceHolder> creation and customization APIs. Most customization of toolbars should be done before the toolbar is initially made visible.  
...
## CCmdUI Support for CToolBar  
 The way toolbar buttons are always updated is through the <CodeContentPlaceHolder>34\</CodeContentPlaceHolder> mechanism. On idle time, the toolbar will call the <CodeContentPlaceHolder>35\</CodeContentPlaceHolder> handler with the command ID of that button. <CodeContentPlaceHolder>36\</CodeContentPlaceHolder> is not called for separators, but it is called for pushbuttons and check box buttons.  
  
 The <CodeContentPlaceHolder>37\</CodeContentPlaceHolder> handler can call:  
  
-   **Enable**: To enable or disable the button. This works equally for pushbuttons and check box buttons.  
  
-   <CodeContentPlaceHolder>38\</CodeContentPlaceHolder>: To set the check state of a button. Calling this for a toolbar button will turn it into a check box button. <CodeContentPlaceHolder>39\</CodeContentPlaceHolder> takes a parameter which can be 0 (not checked), 1 (checked) or 2 (indeterminate)  
  
-   <CodeContentPlaceHolder>40\</CodeContentPlaceHolder>: Shorthand for <CodeContentPlaceHolder>41\</CodeContentPlaceHolder>.  
 ...
 The customization APIs will permit you to change the state of a given toolbar button, preferably you should change these states in the <CodeContentPlaceHolder>42\</CodeContentPlaceHolder> handler for the command the toolbar button represents. Remember, the idle processing will change the state of toolbar buttons with the <CodeContentPlaceHolder>43\</CodeContentPlaceHolder> handler, so any changes to these states made through SetButtonStyle may get lost after the next idle.  
  
 Toolbar buttons will send **WM_COMMAND** messages like normal buttons or menu items and are normally handled by an <CodeContentPlaceHolder>44\</CodeContentPlaceHolder> handler in the same class that provides the <CodeContentPlaceHolder>45\</CodeContentPlaceHolder> handler.  
...
##  \<a name="_mfcnotes_cdialogbar">\</a> CDialogBar  
 ...
 A <CodeContentPlaceHolder>46\</CodeContentPlaceHolder> is used for the print-preview toolbar, which contains standard pushbutton controls.  
  
 Using a <CodeContentPlaceHolder>47\</CodeContentPlaceHolder> is like using a <CodeContentPlaceHolder>48\</CodeContentPlaceHolder>. You must define a dialog template for the dialog bar and remove all the styles except **WS_CHILD**. Note that the dialog must not be visible.  
  
 The control notifications for a <CodeContentPlaceHolder>49\</CodeContentPlaceHolder> will be sent to the parent of the control bar (just like toolbar buttons).  
  
## CCmdUI Support for CDialogBar  
 Dialog bar buttons should be updated through the <CodeContentPlaceHolder>50\</CodeContentPlaceHolder> handler mechanism. At idle time, the dialog bar will call the <CodeContentPlaceHolder>51\</CodeContentPlaceHolder> handler with the command ID of all the buttons that have a ID >= 0x8000 (that is, in the range of command IDs).  
  
 The <CodeContentPlaceHolder>52\</CodeContentPlaceHolder> handler can call:  
