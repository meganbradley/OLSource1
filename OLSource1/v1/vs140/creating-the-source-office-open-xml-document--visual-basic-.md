...
4.  Select the lines that contain the Visual Basic code. The first line starts with the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> keyword. The last line is "End Class". Format the lines with the courier font. Format them with a new style, and name the new style "Code".  
