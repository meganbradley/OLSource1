...
|<xref:System.IO.FileStream*?displayProperty=fullName>|Supports random access to files through its [Seek](assetId:///M:System.IO.FileStream.Seek(System.Int64,System.IO.SeekOrigin)?qualifyHint=False&autoUpgrade=True) method. <xref:System.IO.FileStream*> opens files synchronously by default but also supports asynchronous operation.|  
