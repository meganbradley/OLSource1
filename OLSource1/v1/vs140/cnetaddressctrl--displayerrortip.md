...
## Return Value  
 The value <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> if this method is successful; otherwise, an error code.  
...
## Remarks  
 ...
 This message invokes the [NetAddr_DisplayErrorTip](http://msdn.microsoft.com/library/windows/desktop/bb774314) macro, which is described in the [!INCLUDE[winSDK](../vs140/includes/winsdk_md.md)]. That macro sends the <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> message.  
