...
<CodeContentPlaceHolder>2\</CodeContentPlaceHolder>  
 Most **RFX_** functions have three arguments as shown above, but some (e.g. <CodeContentPlaceHolder>6\</CodeContentPlaceHolder> and <CodeContentPlaceHolder>7\</CodeContentPlaceHolder>) have additional optional arguments.  
  
 More than one **RFX_** may be included in each <CodeContentPlaceHolder>8\</CodeContentPlaceHolder> function.  
...
## Notes  
 Recordset field functions are designed to work only with the <CodeContentPlaceHolder>9\</CodeContentPlaceHolder> classes. They are not generally usable by any other MFC classes.  
  
 Initial values of data are set in the standard C++ constructor, usually in a block with <CodeContentPlaceHolder>10\</CodeContentPlaceHolder> and <CodeContentPlaceHolder>11\</CodeContentPlaceHolder> comments.  
 ...
 Each function that calls <CodeContentPlaceHolder>12\</CodeContentPlaceHolder> (for instance <CodeContentPlaceHolder>13\</CodeContentPlaceHolder>, <CodeContentPlaceHolder>14\</CodeContentPlaceHolder>), does its own initialization around the call to <CodeContentPlaceHolder>15\</CodeContentPlaceHolder>.  
...
## How Does It Work?  
 ...
 The <CodeContentPlaceHolder>16\</CodeContentPlaceHolder> member function is much like the <CodeContentPlaceHolder>17\</CodeContentPlaceHolder> member function — it is responsible for getting or setting data to/from an external form (in this case columns from the result of an ODBC query) from/to member data in the class. The <CodeContentPlaceHolder>18\</CodeContentPlaceHolder> parameter is the context for doing data exchange and is similar to the <CodeContentPlaceHolder>19\</CodeContentPlaceHolder> parameter to <CodeContentPlaceHolder>20\</CodeContentPlaceHolder>. The <CodeContentPlaceHolder>21\</CodeContentPlaceHolder> (a <CodeContentPlaceHolder>22\</CodeContentPlaceHolder> object) has an operation indicator, which is similar to, but a generalization of the <CodeContentPlaceHolder>23\</CodeContentPlaceHolder> direction flag. An RFX function may have to support the following operations:  
...
-   <CodeContentPlaceHolder>24\</CodeContentPlaceHolder> — Set status bit dirty (i.e. changed) field  
  
-   <CodeContentPlaceHolder>25\</CodeContentPlaceHolder> — Set status bit indicating null value for field  
  
-   <CodeContentPlaceHolder>26\</CodeContentPlaceHolder> — Return value of dirty status bit  
  
-   <CodeContentPlaceHolder>27\</CodeContentPlaceHolder> — Return value of null status bit  
  
-   <CodeContentPlaceHolder>28\</CodeContentPlaceHolder> — Return TRUE if field can hold NULL values  
...
-   Have the <CodeContentPlaceHolder>29\</CodeContentPlaceHolder> member function conditionally include additional RFX calls or any other valid C++ statements.  
 ...
 **RFX_Text and RFX_Binary**:  
 ...
 It is important to call <CodeContentPlaceHolder>33\</CodeContentPlaceHolder> at the start of your RFX function, and return immediately if it returns FALSE. This mechanism keeps parameter operations from being performed on **outputColumns**, and vice versa (like calling **BindParam** on an **outputColumn**). In addition, <CodeContentPlaceHolder>34\</CodeContentPlaceHolder> automatically keeps track of the count of **outputColumns** (<CodeContentPlaceHolder>35\</CodeContentPlaceHolder>) and params (<CodeContentPlaceHolder>36\</CodeContentPlaceHolder>).  
