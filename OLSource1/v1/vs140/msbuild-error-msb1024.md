...
1.  Specify only one schema to validate the project against using the format <CodeContentPlaceHolder>0\</CodeContentPlaceHolder>, for example, <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>  
