...
2.  Set a breakpoint on the line that reads, <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>.  
  
3.  Type the following in the **Immediate** window: <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>  
...
6.  Type the following in the **Immediate** window: <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>  
  
7.  Type the following in the **Immediate** window: <CodeContentPlaceHolder>4\</CodeContentPlaceHolder>  
  
8.  Verify that you hit the breakpoint, and examine the value of static variable <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> in the **Locals** window. It should have the value of 3.  
