...
## In This Section  
 [Output Stream Manipulators with One Argument](../vs140/output-stream-manipulators-with-one-argument--int-or-long-.md) (<CodeContentPlaceHolder>0\</CodeContentPlaceHolder> or <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>)  
  
 [Other One-Argument Output Stream Manipulators](../vs140/other-one-argument-output-stream-manipulators.md)  
