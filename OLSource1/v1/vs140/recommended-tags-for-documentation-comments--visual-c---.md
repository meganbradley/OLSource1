...
|[\<value>](../vs140/-value---visual-c---.md)|||  
 ...
 In the current release, the Visual C++ compiler does not support <CodeContentPlaceHolder>0\</CodeContentPlaceHolder>, a tag that is supported by other Visual Studio compilers. Visual C++ may support <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> in a future release.  
