...
## Remarks  
 ...
 The edit control does not scroll vertically past the last line of text in the edit control. If the current line plus the number of lines specified by <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> exceeds the total number of lines in the edit control, the value is adjusted so that the last line of the edit control is scrolled to the top of the edit-control window.  
  
 <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> can be used to scroll horizontally past the last character of any line.  
