...
##  \<a name="BKMK_In_this_topic">\</a> In this topic  
 This topic describes the options that you can use with the <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> command line tool. The topic contains the following sections:  
...
|||  
|-|-|  
|**/app:{AppName}**|Starts the profiler and waits for the specified app to be launched from the Start menu.\<br />\<br /> Run <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> to view the app Name and PackageFullName of installed apps.|  
|**/package:{PackageFullName}**|Starts the profiler and waits for the specified app to be launched from the Start menu.\<br />\<br /> Run <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> to view the app Name and PackageFullName of installed apps.|  
