...
#### Parameters  
 ...
 [out] Returns <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> if the user-defined data type is unaligned; otherwise, returns <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>.  
