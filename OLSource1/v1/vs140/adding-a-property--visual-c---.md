...
5.  Click **Finish** to add the property.  
 ...
 The **Get** and <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> methods of the property are displayed as two icons in Class View, under the interface where it is defined. You can double-click either icon to view the property declaration in the .idl file.  
