...
---
# CMFCToolBarComboBoxButton::SetACCData
Populates the specified <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> object by using accessibility data from the combo box button.  
...
#### Parameters  
 ...
 A <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> object that receives the accessibility data from the combo box button.  
