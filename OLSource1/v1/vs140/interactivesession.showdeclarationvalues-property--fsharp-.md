...
ms.topic: "reference"
f1_keywords: 
  - "Microsoft.FSharp.Compiler.Interactive.InteractiveSession.ShowDeclarationValues"
dev_langs: 
  - "FSharp"
helpviewer_keywords: 
  - "ShowDeclarationValues property [F#]"
  - "InteractiveSession.ShowDeclarationValues property [F#]"
ms.assetid: a7e9481d-4159-4587-99ad-58610f8a7ef5
...
---
# InteractiveSession.ShowDeclarationValues Property (F#)
When set to <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>, disables the display of declaration values in the output of the interactive session.  
