...
##  \<a name="generic_errno">\</a>  generic_errno  
 A type that represents the enumeration that provides the symbolic names for all the error-code macros defined by Posix in <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>.  
