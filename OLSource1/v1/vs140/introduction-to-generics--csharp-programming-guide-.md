...
-   As the type of the private member data in the nested class.  
 ...
 [!code[csProgGuideGenerics#2](../vs140/codesnippet/CSharp/introduction-to-generics--csharp-programming-guide-_1.cs)]
