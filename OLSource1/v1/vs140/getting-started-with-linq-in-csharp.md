...
## In This Section  
 [Introduction to LINQ Queries](../vs140/introduction-to-linq-queries--csharp-.md)  
 Describes the three parts of the basic LINQ query operation that are common across all languages and data sources.  
  
 [LINQ and Generic Types](../vs140/linq-and-generic-types--csharp-.md)  
 Provides a brief introduction to generic types as they are used in LINQ.  
  
 [Basic Query Operations (LINQ)](../vs140/basic-linq-query-operations--csharp-.md)  
 Describes the most common types of query operations and how they are expressed in C#.  
  
 [Data Transformations with LINQ](../vs140/data-transformations-with-linq--csharp-.md)  
 Describes the various ways that you can transform data retrieved in queries.  
  
 [Type Relationships in Query Operations](../vs140/type-relationships-in-linq-query-operations--csharp-.md)  
 ...
 [C# Features That Support LINQ](../vs140/csharp-features-that-support-linq.md)  
