...
|\<xref:Microsoft.VisualStudio.Modeling.Integration.Shell*?displayProperty=fullName>|Modelbus adapter framework for [!INCLUDE[vsprvs](../vs140/includes/vsprvs_md.md)].|  
...
|\<xref:Microsoft.VisualStudio.Modeling.Shell*?displayProperty=fullName>|The interface between DSLs and [!INCLUDE[vsprvs](../vs140/includes/vsprvs_md.md)].|  
