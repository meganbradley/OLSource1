...
apitype: "Assembly"
f1_keywords: 
  - "Microsoft.FSharp.Core.Operators.Checked.ToUIntPtr``1"
dev_langs: 
  - "FSharp"
helpviewer_keywords: 
  - "unativeint function [F#]"
  - "ToUIntPtr function [F#]"
  - "Checked.unativeint function [F#]"
  - "Checked.ToUIntPtr function [F#]"
...
Converts the argument to <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>. This is a direct, checked conversion for all primitive numeric types. Otherwise the operation requires an appropriate static conversion method on the input type.  
