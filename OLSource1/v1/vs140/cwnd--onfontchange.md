...
---
# CWnd::OnFontChange
All top-level windows in the system receive an <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> call from the framework after the application changes the pool of font resources.  
...
## Remarks  
 ...
 To send this message, use the [SendMessage](http://msdn.microsoft.com/library/windows/desktop/ms644950) Windows function with the <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> parameter set to **HWND_BROADCAST**.  
