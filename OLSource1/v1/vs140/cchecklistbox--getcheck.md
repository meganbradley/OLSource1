...
|Value|Description|  
|-----------|-----------------|  
|<CodeContentPlaceHolder>2\</CodeContentPlaceHolder>|The check box is checked.|  
|<CodeContentPlaceHolder>3\</CodeContentPlaceHolder>|The check box is not checked.|  
|<CodeContentPlaceHolder>4\</CodeContentPlaceHolder>|The check box state is indeterminate.|  
