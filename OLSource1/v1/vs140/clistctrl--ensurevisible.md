...
## Remarks  
 The list view control is scrolled if necessary. If the <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> parameter is nonzero, no scrolling occurs if the item is partially visible.  
