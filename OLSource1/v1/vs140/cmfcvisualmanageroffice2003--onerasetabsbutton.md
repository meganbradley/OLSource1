...
## Remarks  
 The framework erases the text and icon for a button when a [CMFCBaseTabCtrl](../vs140/cmfcbasetabctrl-class.md) object processes the <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> message  
