...
## Remarks  
 ...
 Each window that receives an <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> call should call the [SendMessage](http://msdn.microsoft.com/library/windows/desktop/ms644950) Windows function to pass a [WM_DRAWCLIPBOARD](http://msdn.microsoft.com/library/windows/desktop/ms649025) message on to the next window in the Clipboard-viewer chain. The handle of the next window is returned by the [SetClipboardViewer](../vs140/cwnd--setclipboardviewer.md) member function; it may be modified in response to an [OnChangeCbChain](../vs140/cwnd--onchangecbchain.md) member function call.  
