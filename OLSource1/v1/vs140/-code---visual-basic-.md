...
## Remarks  
 Use the <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> tag to indicate multiple lines as code. Use [\<c> (Visual Basic)](../vs140/-c---visual-basic-.md) to indicate that text within a description should be marked as code.  
  
 Compile with [/doc](../vs140/-doc.md) to process documentation comments to a file.  
  
## Example  
 This example uses the \<code> tag to include example code for using the <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> field.  
