...
---
# CMDIFrameWnd::CreateClient
Creates the MDI client window that manages the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> objects.  
...
## Remarks  
 This member function should be called if you override the <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> member function directly.  
