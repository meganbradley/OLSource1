...
## Example  
 The following example defines a <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> method for the <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> data type.  
