...
Edit UI action properties  
 ...
 For example, if a server is unavailable, and you have a UI action associated with your Web browser that states **Go to Web page ‘http://Contoso1/default.aspx’**, you could change the URL to <CodeContentPlaceHolder>0\</CodeContentPlaceHolder>.  
...
## See Also  
 ...
 [How to: Create a Data-Driven Coded UI Test](../vs140/creating-a-data-driven-coded-ui-test.md)   
