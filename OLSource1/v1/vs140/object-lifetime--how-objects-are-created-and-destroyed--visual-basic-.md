...
### How New and Finalize Methods Work in a Class Hierarchy  
 ...
 When an object is no longer needed, the CLR calls the <xref:System.Object.Finalize?qualifyHint=False> method for that object before freeing its memory. The <xref:System.Object.Finalize?qualifyHint=False> method is called a `destructor` because it performs cleanup tasks, such as saving state information, closing files and connections to databases, and other tasks that must be done before releasing the object.  
...
## IDisposable Interface  
 ...
 To supplement garbage collection, your classes can provide a mechanism to actively manage system resources if they implement the <xref:System.IDisposable?qualifyHint=False> interface. <xref:System.IDisposable?qualifyHint=False> has one method, <xref:System.IDisposable.Dispose?qualifyHint=False>, which clients should call when they finish using an object. You can use the <xref:System.IDisposable.Dispose?qualifyHint=False> method to immediately release resources and perform tasks such as closing files and database connections. Unlike the `Finalize` destructor, the <xref:System.IDisposable.Dispose?qualifyHint=False> method is not called automatically. Clients of a class must explicitly call <xref:System.IDisposable.Dispose?qualifyHint=False> when you want to immediately release resources.  
  
### Implementing IDisposable  
 A class that implements the <xref:System.IDisposable?qualifyHint=False> interface should include these sections of code:  
...
-   An overload of the <xref:System.IDisposable.Dispose?qualifyHint=False> that frees the class's resources. This method should be called by the <xref:System.IDisposable.Dispose?qualifyHint=False> and `Finalize` methods of the base class:  
...
-   An implementation of <xref:System.IDisposable.Dispose?qualifyHint=False> that contains only the following code:  
