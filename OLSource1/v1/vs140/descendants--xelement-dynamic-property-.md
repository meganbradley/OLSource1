...
## Property Value/Return Value  
 An indexer of the type <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>. This indexer takes the expanded name of the specified descendant elements and returns the matching child elements in an \<xref:System.Collections.IEnumerable*><CodeContentPlaceHolder>2\</CodeContentPlaceHolder>\<xref:System.Xml.Linq.XElement*><CodeContentPlaceHolder>3\</CodeContentPlaceHolder> collection.  
