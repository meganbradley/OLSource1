...
---
# COleSafeArray::CreateOneDim
Creates a new one-dimensional <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> object.  
...
## Remarks  
 The function allocates and initializes the data for the array, copying the specified data if the pointer <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> is not **NULL**.  
