...
ms.topic: "article"
f1_keywords: 
  - "mutex/std::unique_lock::operator bool"
dev_langs: 
  - "C++"
...
## Return Value  
 <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> if the thread owns the mutex; otherwise <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>.  
