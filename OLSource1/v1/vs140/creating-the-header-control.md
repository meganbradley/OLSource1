...
2.  In [OnInitDialog](../vs140/cdialog--oninitdialog.md), create and set the styles for the <CodeContentPlaceHolder>0\</CodeContentPlaceHolder>, position it, and display it.  
