...
**The response file was specified twice. A response file can be specified only once.**  
 ...
 The command line contains references to more than one response file. For example, <CodeContentPlaceHolder>0\</CodeContentPlaceHolder>.  
...
-   Remove the duplicate reference to the response file. For example, instead of using <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>, use <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>.  
