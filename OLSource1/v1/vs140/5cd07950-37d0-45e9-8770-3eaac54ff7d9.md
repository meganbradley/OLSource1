...
2.  If you are using custom attributes that you developed, change the <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> attribute to match the kind of item you are using.  
