...
Either you tried to call the <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> procedure of a class, or you tried to access a <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> property or method either cross-process or cross-thread. A <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> procedure is callable from a module outside the class, but is part of the project in which the class is defined.  
