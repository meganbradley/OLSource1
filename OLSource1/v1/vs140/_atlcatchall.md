...
## Remarks  
 Used in conjunction with <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>. Resolves to C++ [catch(...)](../vs140/try--throw--and-catch-statements--c---.md) for handling all types of C++ exceptions.  
