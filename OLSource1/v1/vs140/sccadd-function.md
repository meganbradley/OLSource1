...
#### Parameters  
 ...
 nFiles  
 [in] Number of files selected to be added to the current project as given in the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> array.  
...
## Remarks  
 The usual <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> are replaced here by an array, <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>, with one <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> option specification per file. This is because the file type may vary from file to file.  
  
> [!NOTE]
>  It is invalid to specify both <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> and <CodeContentPlaceHolder>6\</CodeContentPlaceHolder> options for the same file, but it is valid to specify neither. Setting neither is the same as setting <CodeContentPlaceHolder>7\</CodeContentPlaceHolder>, in which case the source control plug-in autodetects the file type.  
  
 Below is the list of flags used in the <CodeContentPlaceHolder>8\</CodeContentPlaceHolder> array:  
