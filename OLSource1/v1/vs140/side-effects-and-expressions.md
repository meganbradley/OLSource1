...
A side effect occurs when evaluating an expression changes the value of data in your application.  
 ...
 When evaluation of properties or implicit function calls is turned off, you can force evaluation by using the <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> format modifier (for C# only). See [Format Specifiers in C#](../vs140/format-specifiers-in-csharp.md).  
