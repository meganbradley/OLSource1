...
## Remarks  
 ...
 For more information on `CMemFile`, see the articles [Files in MFC](../vs140/files-in-mfc.md) and [Memory Management (MFC)](../vs140/memory-management.md) and see [File Handling](../vs140/file-handling.md) in the                 *Run-Time Library Reference*.  
