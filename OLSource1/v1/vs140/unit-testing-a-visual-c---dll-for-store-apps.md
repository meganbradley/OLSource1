...
3.  Name the project <CodeContentPlaceHolder>10\</CodeContentPlaceHolder>; specify the location; name the solution <CodeContentPlaceHolder>11\</CodeContentPlaceHolder>; and make sure **Create directory for solution** is checked.  
...
4.  In the new project, open **unittest1.cpp**.  
    ...
    -   Each test is defined by using <CodeContentPlaceHolder>12\</CodeContentPlaceHolder>.  
    ...
    -   Test methods are grouped into classes by using <CodeContentPlaceHolder>13\</CodeContentPlaceHolder>.  
...
<CodeContentPlaceHolder>0\</CodeContentPlaceHolder>  
     Notice that the <CodeContentPlaceHolder>14\</CodeContentPlaceHolder> class provides several static methods that you can use to verify results in test methods.  
...
<CodeContentPlaceHolder>1\</CodeContentPlaceHolder>  
     ...
     The <CodeContentPlaceHolder>15\</CodeContentPlaceHolder> class declares a constructor and the <CodeContentPlaceHolder>16\</CodeContentPlaceHolder> estimator method.  
...
4.  Add the ROOTERLIB_EXPORTS symbol to the command line.  
    ...
    3.  Choose **\<Edit...>** from the **Preprocessor Definitions** list, and then add <CodeContentPlaceHolder>17\</CodeContentPlaceHolder> in the Preprocessor Definitions dialog box.  
...
2.  Include the RooterLib header file in **unittest1.cpp**.  
    ...
    2.  Add this code to below the <CodeContentPlaceHolder>18\</CodeContentPlaceHolder> line:  
...
3.  To see why the test fails, step through the function:  
    ...
    1.  Set a breakpoint at the start of the <CodeContentPlaceHolder>19\</CodeContentPlaceHolder> function.  
...
1.  Simplify the central calculation in the <CodeContentPlaceHolder>20\</CodeContentPlaceHolder> function:  
