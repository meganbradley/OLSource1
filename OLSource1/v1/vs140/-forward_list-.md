...
|||  
|-|-|  
|[forward_list](../vs140/forward_list-class.md)|Describes an object that controls a varying-length sequence of elements. The sequence is stored as a singly-linked list of elements, each containing a member of type <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>.|  
