...
|[SafeInt Functions](../vs140/safeint-functions.md)|Functions that can be used without creating a <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> object.|  
|[SafeIntException Class](../vs140/safeintexception-class.md)|A class of exceptions related to the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> class.|  
