...
Returns the index of the first element in the list that satisfies the given predicate. Return <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> if no such element exists.  
...
## Return Value  
 The index of the first element for which the predicate returns <CodeContentPlaceHolder>6\</CodeContentPlaceHolder>, or <CodeContentPlaceHolder>7\</CodeContentPlaceHolder> if every element evaluates to <CodeContentPlaceHolder>8\</CodeContentPlaceHolder>.  
...
## Example  
 The following code example illustrates the use of <CodeContentPlaceHolder>10\</CodeContentPlaceHolder> and <CodeContentPlaceHolder>11\</CodeContentPlaceHolder>.  
  
 [!code[FsLists#10](../vs140/codesnippet/FSharp/list.tryfindindex--t--function--fsharp-_1.fs)]  
