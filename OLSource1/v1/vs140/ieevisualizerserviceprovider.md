...
## Notes for Implementers  
 Visual Studio implements this interface to create a visualizer service object, which in turn is used to supply class IDs (<CodeContentPlaceHolder>1\</CodeContentPlaceHolder>s) of type visualizers to the Visual Studio IDE.  
