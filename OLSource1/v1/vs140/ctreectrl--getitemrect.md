...
---
# CTreeCtrl::GetItemRect
Call this function to retrieve the bounding rectangle for <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> and determine whether it is visible or not.  
...
## Return Value  
 Nonzero if the item is visible, with the bounding rectangle contained in <CodeContentPlaceHolder>4\</CodeContentPlaceHolder>. Otherwise, 0 with <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> uninitialized.  
