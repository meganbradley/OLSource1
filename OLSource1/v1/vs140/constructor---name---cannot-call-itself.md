...
A <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> procedure in a class or structure calls itself.  
...
2.  If you do not intend to call a different constructor, remove the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> call entirely.  
