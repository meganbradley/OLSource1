...
## Return Value  
 <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> indicates the restart manager recovers the application; <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> indicates the restart manager does not.  
