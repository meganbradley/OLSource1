...
<CodeContentPlaceHolder>1\</CodeContentPlaceHolder>  
 except that <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> is only evaluated once. The [^ operator](../vs140/^-operator--csharp-reference-.md) performs a bitwise exclusive-OR operation on integral operands and logical exclusive-OR on [bool](../vs140/bool--csharp-reference-.md) operands.  
