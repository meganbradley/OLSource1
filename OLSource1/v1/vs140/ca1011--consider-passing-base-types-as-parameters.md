...
## Example  
 The following example shows a method, <CodeContentPlaceHolder>0\</CodeContentPlaceHolder>, that can be used only with a \<xref:System.IO.FileStream*> object, which violates this rule. A second method, <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>, satisfies the rule by replacing the \<xref:System.IO.FileStream*> parameter by using a \<xref:System.IO.Stream*>.  
