...
|[Compiler Conformance Improvements in Visual C++](../vs140/compiler-conformance-improvements-in-visual-c---2015.md)|A list of conformance improvements and other changes in the Visual C++ compiler that might require changes in your code.|  
...
|[C++/CLI Migration Primer](../vs140/c---cli-migration-primer.md)|Shows in detail how to upgrade your Managed Extensions for C++ syntax to use the new syntax. For more information, see [Component Extensions for Runtime Platforms](../vs140/component-extensions-for-runtime-platforms.md).|  
