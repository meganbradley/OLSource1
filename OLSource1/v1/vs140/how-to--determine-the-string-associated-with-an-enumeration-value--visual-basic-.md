...
The <xref:System.Enum.GetValues?qualifyHint=False> and <xref:System.Enum.GetNames?qualifyHint=False> methods allow you to determine the strings and values associated with enumeration members.  
  
### To determine the string associated with an enumeration  
  
-   Use the <xref:System.Enum.GetNames?qualifyHint=False> method to retrieve the strings associated with the enumeration members. This example declares an enumeration, `flavorEnum`, then uses the <xref:System.Enum.GetNames?qualifyHint=False> method to display the strings associated with each member.  
...
## See Also  
 <xref:System.Enum.GetValues?qualifyHint=False>   
 <xref:System.Enum.GetNames?qualifyHint=False>   
