...
helpviewer_keywords: 
  - "defaults [C++], users"
  - "workspaces [C++], users"
  - "users [C++], setting default"
  - "DAO [C++], user names"
  - "SetDefaultUser method"
  - "default users"
...
2.  Call <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> and, if you like, [SetDefaultPassword](../vs140/cdaoworkspace--setdefaultpassword.md).  
