...
'cast' : explicit cast from 'cast_from' to 'cast_to' is not verifiable  
 ...
 Some casts are safe (for example, a <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> that triggers user-defined conversions and a <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>). A [safe_cast](../vs140/safe_cast--c---component-extensions-.md) is guaranteed to produce verifiable code.  
