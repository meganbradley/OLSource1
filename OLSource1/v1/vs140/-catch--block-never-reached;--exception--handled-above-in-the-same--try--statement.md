...
A <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> block in the code cannot be reached because it is handled in a preceding <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> block.  
