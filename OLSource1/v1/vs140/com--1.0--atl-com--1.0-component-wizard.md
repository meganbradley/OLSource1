...
|Option|Description|  
|------------|-----------------|  
|**Dual**|Specifies that the object supports a dual interface (its vtable has custom interface functions and late-binding <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> methods). Allows both COM clients and Automation controllers to access the object.|  
