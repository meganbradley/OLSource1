...
## Return Value  
 <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> if the method succeeds, or <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> if the specified index is invalid or the index refers to the **Customize** button.  
