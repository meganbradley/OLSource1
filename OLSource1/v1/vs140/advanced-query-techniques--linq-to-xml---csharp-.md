...
|Topic|Description|  
|-----------|-----------------|  
|[How to: Join Two Collections (LINQ to XML) (C#)](../vs140/how-to--join-two-collections--linq-to-xml---csharp-.md)|Shows how to use the <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> clause to take advantage of relationships in XML data.|  
