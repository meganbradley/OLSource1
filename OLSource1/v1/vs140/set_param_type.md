...
---
# SET_PARAM_TYPE
Specifies <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> macros that follow the <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> macro input, output, or input/output.  
