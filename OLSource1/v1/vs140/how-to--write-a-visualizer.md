...
2.  If you want your visualizer to be able to edit data objects, as well as display them, you will need to override the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> or <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> methods from \<xref:Microsoft.VisualStudio.DebuggerVisualizers.VisualizerObjectSource*>.  
