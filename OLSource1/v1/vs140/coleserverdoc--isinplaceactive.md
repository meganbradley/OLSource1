...
---
# COleServerDoc::IsInPlaceActive
Call the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> member function to determine whether the item is currently in the in-place active state.  
  
## Syntax  
  
<CodeContentPlaceHolder>0\</CodeContentPlaceHolder>  
## Return Value  
 Nonzero if the <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> object is active in place; otherwise 0.  
