...
## Example  
 The following example demonstrates how to call the default property `myProperty` on class `class1`. The three assignment statements store values in `myProperty`, and the <xref:Microsoft.VisualBasic.Interaction.MsgBox?qualifyHint=False> call reads the values.  
  
 [!code[VbVbcnProcedures#13](../vs140/codesnippet/VisualBasic/how-to--declare-and-call-a-default-property-in-visual-basic_9.vb)]
  
  
 The most common use of a default property is the <xref:Microsoft.VisualBasic.Collection.Item?qualifyHint=False> property on various collection classes.  
