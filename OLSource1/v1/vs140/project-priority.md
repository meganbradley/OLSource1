...
-   The IDE calls the [IsDocumentInProject](assetId:///M:Microsoft.VisualStudio.Shell.Interop.IVsProject2.IsDocumentInProject(System.String,System.Int32@,Microsoft.VisualStudio.Shell.Interop.VSDOCUMENTPRIORITY[],System.UInt32@)?qualifyHint=False&autoUpgrade=True) method for each project in the solution to determine whether the document is a member of that project.  
