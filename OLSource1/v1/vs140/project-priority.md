...
-   The IDE calls the <xref:Microsoft.VisualStudio.Shell.Interop.IVsProject2.IsDocumentInProject?qualifyHint=False> method for each project in the solution to determine whether the document is a member of that project.  
...
-   The <xref:Microsoft.VisualStudio.Shell.Interop.VSDOCUMENTPRIORITY?qualifyHint=False> enumeration provides the document priority values.  
