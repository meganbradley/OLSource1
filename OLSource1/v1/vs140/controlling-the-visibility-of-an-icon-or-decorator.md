...
1.  Add a calculated domain property to the domain class. In the **Properties** window, set the following values:  
     ...
     **IsBrowsable =**  <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>  **- this hides the property from the user**  
  
     **Kind =**  <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>  **- this means that you will provide code that calculates its value**  
  
     **Name** for example **DecoratorControl**  
  
     **Type** = <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>  
  
     For more information, see [Calculated and Custom Properties](../vs140/calculated-and-custom-storage-properties.md).  
...
2.  Make the new property control the decorator visibility.  
    ...
    4.  Under **Visibility Entries**, enter <CodeContentPlaceHolder>4\</CodeContentPlaceHolder>.  
