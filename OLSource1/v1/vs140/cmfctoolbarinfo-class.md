...
---
# CMFCToolBarInfo Class
Contains the resource IDs of toolbar images in various states. <CodeContentPlaceHolder>9\</CodeContentPlaceHolder> is a helper class that is used as a parameter of the [CMFCToolBar::LoadToobarEx](../vs140/cmfctoolbar-class.md#cmfctoolbar__loadtoolbarex) method.  
...
## Remarks  
 A full toolbar bitmap consists of small toolbar images (buttons) of a fixed size. Each resource ID that is stored in a <CodeContentPlaceHolder>10\</CodeContentPlaceHolder> object is a bitmap that contains a full set of toolbar images in a single state (for example, selected, disabled, large, or menu images).  
...
## See Also  
 ...
 [CMFCToolBar::LoadToobarEx](../vs140/cmfctoolbar-class.md#cmfctoolbar__loadtoolbarex)