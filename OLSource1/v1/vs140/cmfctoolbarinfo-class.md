...
---
# CMFCToolBarInfo Class
Contains the resource IDs of toolbar images in various states. `CMFCToolBarInfo` is a helper class that is used as a parameter of the [CMFCToolBar::LoadToobarEx](../vs140/cmfctoolbar-class.md#cmfctoolbar__loadtoolbarex) method.  
