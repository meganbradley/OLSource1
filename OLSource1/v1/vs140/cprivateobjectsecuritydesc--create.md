...
ms.topic: "reference"
f1_keywords: 
  - "ATL.CPrivateObjectSecurityDesc.Create"
  - "ATL::CPrivateObjectSecurityDesc::Create"
...
#### Parameters  
 ...
 Pointer to a **GUID** structure that identifies the type of object associated with the current object. Set <CodeContentPlaceHolder>7\</CodeContentPlaceHolder> to NULL if the object does not have a GUID.  
  
 *bIsContainerObject*  
 Specifies whether the new object can contain other objects. A value of true indicates that the new object is a container. A value of false indicates that the new object is not a container.  
  
 <CodeContentPlaceHolder>8\</CodeContentPlaceHolder>  
 A set of bit flags that control how access-control entries (ACEs) are inherited from <CodeContentPlaceHolder>9\</CodeContentPlaceHolder>. See [CreatePrivateObjectSecurityEx](http://msdn.microsoft.com/library/windows/desktop/aa446581) for more details.  
