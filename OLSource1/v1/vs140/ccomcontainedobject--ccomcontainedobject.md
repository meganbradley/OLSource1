...
## Remarks  
 Sets the <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> member pointer (inherited through the <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> class) to <CodeContentPlaceHolder>4\</CodeContentPlaceHolder>.  
