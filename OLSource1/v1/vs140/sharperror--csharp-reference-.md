...
---
# #error (C# Reference)
<CodeContentPlaceHolder>2\</CodeContentPlaceHolder> lets you generate an error from a specific location in your code. For example:  
  
<CodeContentPlaceHolder>0\</CodeContentPlaceHolder>  
## Remarks  
 A common use of <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> is in a conditional directive.  
