...
6.  Click in the newly created tab in Visual Studio and type a valid Visual C++ program, or copy and paste one of the sample programs.  
     ...
     If you use the sample program, notice that you use the <CodeContentPlaceHolder>0\</CodeContentPlaceHolder>keyword instead of <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> when creating a .NET object, and that <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> returns a handle (<CodeContentPlaceHolder>3\</CodeContentPlaceHolder>) rather than a pointer (<CodeContentPlaceHolder>4\</CodeContentPlaceHolder>):  
  
     <CodeContentPlaceHolder>5\</CodeContentPlaceHolder>  
  
     For more information on the new Visual C++ syntax, see [New C++ Language Features](../vs140/component-extensions-for-runtime-platforms.md).  
