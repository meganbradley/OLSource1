...
[DDX_ManagedControl](../vs140/ddx_managedcontrol.md) calls [CWinFormsControl::CreateManagedControl](../vs140/cwinformscontrol--createmanagedcontrol.md) to create a control matching the resource control ID. If you use `DDX_ManagedControl` for a `CWinFormsControl` control (in wizard-generated code), you should not call `CreateManagedControl` explicitly for the same control.  
