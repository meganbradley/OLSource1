...
---
# CWinThread::InitInstance
<CodeContentPlaceHolder>1\</CodeContentPlaceHolder> must be overridden to initialize each new instance of a user-interface thread.  
...
## Remarks  
 Typically, you override <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> to perform tasks that must be completed when a thread is first created.  
