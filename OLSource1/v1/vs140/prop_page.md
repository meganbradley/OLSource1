...
## Remarks  
 <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> is similar to [PROP_ENTRY_TYPE](../vs140/prop_entry_type.md), but does not require a property description or DISPID.  
  
> [!NOTE]
>  If you have already entered a CLSID with <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> or [PROP_ENTRY_TYPE_EX](../vs140/prop_entry_type_ex.md), you do not need to make an additional entry with <CodeContentPlaceHolder>4\</CodeContentPlaceHolder>.  
