...
Adds the tick count of a specified <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> object to the stored tick count.  
...
## Return Value  
 The <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> object after the addition is performed.  
