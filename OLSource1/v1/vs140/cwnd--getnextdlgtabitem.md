...
#### Parameters  
 ...
 Identifies the **COleControlSiteOrWnd** control. For more information about <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>, see [CWnd::GetNextDlgGroupItem](../vs140/cwnd--getnextdlggroupitem.md).  
...
## Return Value  
 ...
 For more information about <CodeContentPlaceHolder>5\</CodeContentPlaceHolder>, see [CWnd::GetNextDlgGroupItem](../vs140/cwnd--getnextdlggroupitem.md).  
