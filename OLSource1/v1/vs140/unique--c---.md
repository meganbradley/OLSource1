...
## Example  
 See the [ref](../vs140/ref--c---.md) example for a sample use of **unique**.  
...
|||  
|-|-|  
|**Applies to**|<CodeContentPlaceHolder>1\</CodeContentPlaceHolder>, <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>, **union**, interface parameter, interface method|  
|**Repeatable**|No|  
