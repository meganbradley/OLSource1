...
#### Parameters  
 ...
 Reference to a <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> object specifying the tracking rectangle.  
  
## Remarks  
 This member function is called by the framework during resizing of splitters. Override <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> for advanced customization of the imagery of the splitter window. The default imagery is similar to the splitter in Microsoft Works for Windows or Microsoft Windows 95/98, in that the intersections of the splitter bars are blended together.  
