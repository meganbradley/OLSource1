...
> [!NOTE]
>  Recall that initialization for the whole application is best done in your override of the [InitInstance](../vs140/cwinapp--initinstance.md) member function of class <CodeContentPlaceHolder>0\</CodeContentPlaceHolder>, and cleanup for the whole application is best done in your override of the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> member function [ExitInstance](../vs140/cwinapp--exitinstance.md).  
