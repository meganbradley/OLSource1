...
-   Call the [SetPropertyValue](assetId:///M:Microsoft.VisualStudio.Shell.Interop.IVsBuildPropertyStorage.SetPropertyValue(System.String,System.String,System.UInt32,System.String)?qualifyHint=False&autoUpgrade=True) method to save a full path of the project file.  
...
-   Call the [GetPropertyValue](assetId:///M:Microsoft.VisualStudio.Shell.Interop.IVsBuildPropertyStorage.GetPropertyValue(System.String,System.String,System.UInt32,System.String@)?qualifyHint=False&autoUpgrade=True) method to retrieve a full path of the project file.  
...
1.  Implement the [IsFragmentDirty](assetId:///M:Microsoft.VisualStudio.Shell.Interop.IPersistXMLFragment.IsFragmentDirty(System.UInt32,System.Int32@)?qualifyHint=False&autoUpgrade=True) method to determine whether an XML fragment has changed since it was last saved to its current file.  
...
2.  Implement the [Save](assetId:///M:Microsoft.VisualStudio.Shell.Interop.IPersistXMLFragment.Save(System.Guid@,System.UInt32,System.String@,System.Int32)?qualifyHint=False&autoUpgrade=True) method to save the XML data in the project file.  
...
1.  Implement the [InitNew](assetId:///M:Microsoft.VisualStudio.Shell.Interop.IPersistXMLFragment.InitNew(System.Guid@,System.UInt32)?qualifyHint=False&autoUpgrade=True) method to initialize the project extension properties and other build-independent data. This method is called if there is no XML configuration data present in the project file.  
...
2.  Implement the [Load](assetId:///M:Microsoft.VisualStudio.Shell.Interop.IPersistXMLFragment.Load(System.Guid@,System.UInt32,System.String)?qualifyHint=False&autoUpgrade=True) method to load the XML data from the project file.  
