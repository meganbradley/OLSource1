...
## Remarks  
 ...
 The <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> member function replaces the dialog-box units in <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> with screen units (pixels) so that the rectangle can be used to create a dialog box or position a control within a box.  
