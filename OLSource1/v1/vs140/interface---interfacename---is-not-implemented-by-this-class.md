...
-   Add an <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> statement at the beginning of the class or structure so that it implements the appropriate interface.  
  
-   Remove the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> keyword from the member that causes this error.  
