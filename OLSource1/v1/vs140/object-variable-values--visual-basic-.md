...
|--------------|---------------------------------------------------|  
|[IsArray](assetId:///M:Microsoft.VisualBasic.Information.IsArray(System.Object)?qualifyHint=False&autoUpgrade=True)|An array of values, rather than a single value|  
|[IsDate](assetId:///M:Microsoft.VisualBasic.Information.IsDate(System.Object)?qualifyHint=False&autoUpgrade=True)|A [Date Data Type (Visual Basic)](../vs140/date-data-type--visual-basic-.md) value, or a string that can be interpreted as a date and time value|  
|[IsDBNull](assetId:///M:Microsoft.VisualBasic.Information.IsDBNull(System.Object)?qualifyHint=False&autoUpgrade=True)|An object of type <xref:System.DBNull*>, which represents missing or nonexistent data|  
|[IsError](assetId:///M:Microsoft.VisualBasic.Information.IsError(System.Object)?qualifyHint=False&autoUpgrade=True)|An exception object, which derives from <xref:System.Exception*>|  
|[IsNothing](assetId:///M:Microsoft.VisualBasic.Information.IsNothing(System.Object)?qualifyHint=False&autoUpgrade=True)|[Nothing (Visual Basic)](../vs140/nothing--visual-basic-.md), that is, no object is currently assigned to the variable|  
|[IsNumeric](assetId:///M:Microsoft.VisualBasic.Information.IsNumeric(System.Object)?qualifyHint=False&autoUpgrade=True)|A number, or a string that can be interpreted as a number|  
|[IsReference](assetId:///M:Microsoft.VisualBasic.Information.IsReference(System.Object)?qualifyHint=False&autoUpgrade=True)|A reference type (such as a string, array, delegate, or class type)|  
