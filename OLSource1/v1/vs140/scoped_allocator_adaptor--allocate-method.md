...
Allocates memory by using the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> allocator.  
...
## Return Value  
 The first member function returns <CodeContentPlaceHolder>4\</CodeContentPlaceHolder>. The second member function returns <CodeContentPlaceHolder>5\</CodeContentPlaceHolder>.  
