...
<CodeContentPlaceHolder>0\</CodeContentPlaceHolder>  
 ...
 <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> is underlined if the attribute is static.  
  
 <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> is omitted if the attribute has no type.  
  
 <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> denotes the multiplicity. It is omitted if the multiplicity is 1.  
...
|**Multiplicity**|1|**1** - this attribute has a single value of the specified Type.\<br />\<br /> **0..1** - this attribute can have a value of <CodeContentPlaceHolder>4\</CodeContentPlaceHolder>.\<br />\<br /> **\*** - this attribute's value is a collection of values.\<br />\<br /> **1..\*** - this attribute's value is a collection that contains at least one value.\<br />\<br /> *n* **..** *m* - this attribute's value is a collection that contains between *n* and *m* values.|  
