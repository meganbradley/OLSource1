...
the type 'type' (return type of GetEnumerator) must have a suitable public MoveNext member function and public Current property  
 ...
 User-defined collection classes must contain definitions for <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> and <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>.  
