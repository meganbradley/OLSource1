...
5.  The \<xref:Microsoft.VisualStudio.Package.Source.OnCommand*> method looks for a token trigger flag of \<xref:Microsoft.VisualStudio.Package.TokenTriggers.MatchBraces*> on the token that is returned from the \<xref:Microsoft.VisualStudio.Package.Source.GetTokenInfo*> method; that is, the token that represents the closing brace).  
  
6.  If the trigger flag of \<xref:Microsoft.VisualStudio.Package.TokenTriggers.MatchBraces*> is found, the \<xref:Microsoft.VisualStudio.Package.Source.MatchBraces*> method in the \<xref:Microsoft.VisualStudio.Package.Source*> class is called.  
