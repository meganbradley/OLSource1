...
## Return Value  
 <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> if the runtime will automatically select an appropriate accelerator; otherwise, <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>.  
