...
---
# COleSafeArray::Attach
Gives control of the data in an existing **VARIANT** array to the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> object.  
...
## Remarks  
 The source **VARIANT**'s type is set to <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>. This function clears the current array data, if any.  
