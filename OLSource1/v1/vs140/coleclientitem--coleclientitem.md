...
---
# COleClientItem::COleClientItem
Constructs a <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> object and adds it to the container document's collection of document items, which constructs only the C++ object and does not perform any OLE initialization.  
