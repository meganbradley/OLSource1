...
|---------------|-----------------|  
|<CodeContentPlaceHolder>1\</CodeContentPlaceHolder>|Required **String** parameter.\<br />\<br /> Specifies the path of the output directory. If the path is not an absolute path, it is treated as a path that is relative to the root project directory.|  
|<CodeContentPlaceHolder>2\</CodeContentPlaceHolder>|Required **ITaskItem[]** output parameter.\<br />\<br /> Specifies the path and name of the generated .resources file. If the path is not an absolute path, the .resources file is generated relative to the root project directory.|  
|<CodeContentPlaceHolder>3\</CodeContentPlaceHolder>|Required **ITaskItem[]** parameter.\<br />\<br /> Specifies one or more resources to embed in the generated .resources file.|  
