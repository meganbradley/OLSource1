...
---
# COleServerItem::OnInitFromData
Called by the framework to initialize an OLE item using the contents of <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>.  
