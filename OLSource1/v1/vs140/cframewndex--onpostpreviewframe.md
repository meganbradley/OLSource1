...
#### Parameters  
 ...
 <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> when the frame is in print preview mode; <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> when print preview mode is off.  
