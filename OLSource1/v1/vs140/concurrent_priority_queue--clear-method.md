...
## Remarks  
 <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> is not concurrency-safe. You must ensure that no other threads are invoking methods on the concurrent priority queue when you call this method. <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> does not free memory.  
