...
1.  You can reference an assembly directly from your code by using the #using directive, such as <CodeContentPlaceHolder>0\</CodeContentPlaceHolder>. For more information, see [The #using Directive](../vs140/sharpusing-directive--c---.md).  
