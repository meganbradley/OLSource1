...
1.  Create a VSPackage in C# named <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> that has a menu command. For more information, see [Creating a VSPackage with a Menu Command](../vs140/creating-an-extension-with-a-menu-command.md).  
