...
## Remarks  
 Used for the <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> member of the [BP_REQUEST_INFO](../vs140/bp_request_info.md) and [BP_REQUEST_INFO2](../vs140/bp_request_info2.md) structures.  
  
 These values may be combined with a bitwise <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>.  
