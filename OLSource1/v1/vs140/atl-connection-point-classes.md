...
-   [IConnectionPointContainerImpl](../vs140/iconnectionpointcontainerimpl-class.md) implements the connection point container and manages the list of <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> objects.  
