...
detected\<count> Windows Runtime types imported in one module and defined in another module  
 ...
 When it produced the current target, the linker detected <<CodeContentPlaceHolder>0\</CodeContentPlaceHolder>> Windows Runtime types, each of which is imported in one module and also defined in another module.  
