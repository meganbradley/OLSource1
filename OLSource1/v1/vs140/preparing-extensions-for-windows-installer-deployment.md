...
3.  Set the InstalledByMsi element of the VSIX manifest to <CodeContentPlaceHolder>0\</CodeContentPlaceHolder>. For more information about the VSIX manifest, see [VSIX Extension Schema 2.0 Reference](../vs140/vsix-extension-schema-2.0-reference.md).  
