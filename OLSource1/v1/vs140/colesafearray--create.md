...
#### Parameters  
 ...
 The base type of the array (that is, the **VARTYPE** of each element of the array). The **VARTYPE** is restricted to a subset of the variant types. Neither the **VT_ARRAY** nor the **VT_BYREF** flag can be set. <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> and **VT_NULL** are not valid base types for the array. All other types are legal.  
