...
You can use [!INCLUDE[vbprvb](../vs140/includes/vbprvb_md.md)] to process drives, folders, and files with the <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> object, which provides better performance and is easier to use than traditional methods such as the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> and <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> functions (although they are still available). The following sections discuss these methods in detail.  
  
## In This Section  
 [File Access with Visual Basic](../vs140/file-access-with-visual-basic.md)  
 Discusses how to use the <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> object to work with files, drives, and folders.  
 ...
 Demonstrates how to use the <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> object to manipulate files and folders.  
...
## Related Sections  
 ...
 Reference documentation for the <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> object and its members.