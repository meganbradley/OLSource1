...
## Remarks  
 ...
 The default value of <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> in the Visual C++ implementation of the OpenMP standard is the number of virtual processors, including hyperthreading CPUs.  
