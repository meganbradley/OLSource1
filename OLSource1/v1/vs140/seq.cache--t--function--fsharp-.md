...
apitype: "Assembly"
f1_keywords: 
  - "Microsoft.FSharp.Collections.SeqModule.Cache``1"
dev_langs: 
  - "FSharp"
helpviewer_keywords: 
  - "cache function [F#]"
  - "Seq.cache function [F#]"
...
## Example  
 The following code example demonstrates how to use <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> to avoid recomputing elements of a sequence.  
  
 [!code[FsSequences#27](../vs140/codesnippet/FSharp/seq.cache--t--function--fsharp-_1.fs)]  
...
**9931 is prime.**   
## Thread Safety  
 Enumeration of the result sequence is thread-safe in the sense that multiple independent <CodeContentPlaceHolder>6\</CodeContentPlaceHolder> values may be used simultaneously from different threads (accesses to the internal lookaside table are thread-safe). Each individual <CodeContentPlaceHolder>7\</CodeContentPlaceHolder> is not typically thread-safe and should not be accessed concurrently.  
