...
## The Colorizer class and the Scanner  
 The base <xref:Microsoft.VisualStudio.Package.LanguageService*> class has a [M:Microsoft.VisualStudio.Package.LanguageService.GetColorizer(Microsoft.VisualStudio.TextManager.Interop.IVsTextLines)](assetId:///M:Microsoft.VisualStudio.Package.LanguageService.GetColorizer(Microsoft.VisualStudio.TextManager.Interop.IVsTextLines)?qualifyHint=False&autoUpgrade=True) method that instantiantes the <xref:Microsoft.VisualStudio.Package.Colorizer*> class. The scanner that is returned from the [M:Microsoft.VisualStudio.Package.LanguageService.GetScanner(Microsoft.VisualStudio.TextManager.Interop.IVsTextLines)](assetId:///M:Microsoft.VisualStudio.Package.LanguageService.GetScanner(Microsoft.VisualStudio.TextManager.Interop.IVsTextLines)?qualifyHint=False&autoUpgrade=True) method is passed to the <xref:Microsoft.VisualStudio.Package.Colorizer*> class constructor.  
  
 You must implement the assetId:///M:Microsoft.VisualStudio.Package.LanguageService.GetScanner(Microsoft.VisualStudio.TextManager.Interop.IVsTextLines)?qualifyHint=False&autoUpgrade=True method in your own version of the <xref:Microsoft.VisualStudio.Package.LanguageService*> class. The <xref:Microsoft.VisualStudio.Package.Colorizer*> class uses the scanner to obtain all token color information.  
