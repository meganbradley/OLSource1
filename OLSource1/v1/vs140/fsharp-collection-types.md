...
|[Set](../vs140/collections.set--t--class--fsharp-.md)|An immutable set that's based on binary trees, where comparison is the F# structural comparison function, which potentially uses implementations of the <xref:System.IComparable*> interface on key values.|[Set Module](../vs140/collections.set-module--fsharp-.md)|  
