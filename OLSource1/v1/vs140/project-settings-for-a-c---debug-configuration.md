...
|**Command Arguments** (Local Windows Debugger and Remote Windows Debugger)|-   Specifies arguments for the command specified earlier.\<br />\<br /> You can use the following redirection operators in this box:\<br />\<br /> < <CodeContentPlaceHolder>0\</CodeContentPlaceHolder>\<br /> Reads stdin from file.\<br />\<br /> > <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>\<br /> Writes stdout to file.\<br />\<br /> >> <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>\<br /> Appends stdout to file.\<br />\<br /> 2> <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>\<br /> Writes stderr to file.\<br />\<br /> 2>> <CodeContentPlaceHolder>4\</CodeContentPlaceHolder>\<br /> Appends stderr to file.\<br />\<br /> 2> &1\<br /> Sends stderr (2) output to same location as stdout (1).\<br />\<br /> 1> &2\<br /> Sends stdout (1) output to same location as stderr (2).\<br />\<br /> In most cases, these operators are applicable only to console applications.|  
...
|**SQL Debugging** (all but MPI Cluster Debugger)|Enables debugging of SQL procedures from your [!INCLUDE[vcprvc](../vs140/includes/vcprvc_md.md)] application. Default setting is No.|  
...
|Setting|Description|  
|-------------|-----------------|  
|**Generate Debug Info** ([/DEBUG](../vs140/-debug--generate-debug-info-.md))|Tells the linker to include debug information, which will have the format specified by /Z7, /Zd, Zi, or /ZI.|  
|**Generate Program Database File** ([/PDB:name](../vs140/-pdb--use-program-database-.md))|Specify the name of a PDB file in this box. You must select ZI or /Zi for Debug Information Format.|  
|**Strip Private Symbols** ([/PDBSTRIPPED:filename](../vs140/-pdbstripped--strip-private-symbols-.md))|Specify the name of a PDB file in this box if you do not want to include private symbols in the PDB file. This option creates a second program database (PDB) file when you build your program image with any of the compiler or linker options that generate a PDB file, such as /DEBUG, /Z7, /Zd. Or /Zi. This second PDB file omits symbols that you would not want to ship to your customers. For more information, see [/PDBSTRIPPED (Strip Private Symbols)](../vs140/-pdbstripped--strip-private-symbols-.md).|  
|**Generate Map File** ([/MAP](../vs140/-map--generate-mapfile-.md))|Tells the linker to generate a map file during linking. Default setting is No. For more information, see [/MAP (Generate Mapfile)](../vs140/-map--generate-mapfile-.md).|  
|**Map File Name** ([/MAP:](../vs140/-map--generate-mapfile-.md)*name*)|If you choose Generate Map File, you can specify the map file in this box. For more information, see [/MAP (Generate Mapfile)](../vs140/-map--generate-mapfile-.md).|  
|**Map Exports** ([/MAPINFO:EXPORTS](../vs140/-mapinfo--include-information-in-mapfile-.md))|Includes exported functions in the map file. Default setting is No. For more information, see [/MAPINFO (Include Information in Mapfile)](../vs140/-mapinfo--include-information-in-mapfile-.md).|  
|**Debuggable Assembly** ([/ASSEMBLYDEBUG](../vs140/-mapinfo--include-information-in-mapfile-.md))|Specifies settings for the Linker /ASSEMBLYDEBUG option. Possible values are as follows:\<br />\<br /> -   **No debuggable attribute emitted**.\<br />-   **Runtime tracking and disable optimizations (/ASSEMBLYDEBUG)**. This is the default setting,\<br />-   **No runtime tracking and enable optimizations(/ASSEMBLYDEBUG:DISABLE)**.\<br />-   **\<inherit from parent or project defaults>**.\<br />-   For more information, see [/ASSEMBLYDEBUG (Add DebuggableAttribute)](../vs140/-assemblydebug--add-debuggableattribute-.md).|  
...
## See Also  
 ...
 [/ASSEMBLYDEBUG (Add DebuggableAttribute)](../vs140/-assemblydebug--add-debuggableattribute-.md)   
 [Macros for Build Commands and Properties](../vs140/common-macros-for-build-commands-and-properties.md)