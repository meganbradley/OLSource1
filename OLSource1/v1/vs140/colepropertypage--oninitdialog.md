...
## Remarks  
 Override it if any special action is required when the dialog is initialized. The default implementation calls <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> and returns **FALSE**.  
