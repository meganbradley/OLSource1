...
|Member|Description|  
|------------|-----------------|  
|[FromConverter](../vs140/fsharpfunc.fromconverter--t--u--method--fsharp-.md)|Convert an value of type <xref:System.Converter<CodeContentPlaceHolder>1\</CodeContentPlaceHolder>2*> to a F# first class function value|  
