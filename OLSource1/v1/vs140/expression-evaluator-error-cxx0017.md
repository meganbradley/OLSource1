...
symbol not found  
 ...
 This error can occur when trying to typecast a variable in order to watch the variable during debugging. The <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> declares a new name for a type, but it does not define a new type. The typecast attempted in the debugger requires the name of a defined type.  
...
2.  Use an actual type name to cast variables in the debugger, rather than a <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>-defined name.