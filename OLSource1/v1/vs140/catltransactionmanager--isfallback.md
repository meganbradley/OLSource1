...
ms.topic: "reference"
f1_keywords: 
  - "atltransactionmanager/CAtlTransactionManager::IsFallback"
  - "IsFallback"
dev_langs: 
  - "C++"
helpviewer_keywords: 
...
## Return Value  
 Returns <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> is the class supports fallback calls. <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> otherwise.  
