...
## Remarks  
 Note that this member function uses a <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> object as its return value, rather than an <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>.  
