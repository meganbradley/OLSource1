...
---
# &lt;system_error&gt;
Include the header <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> to define the exception class <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> and related templates for processing low-level system errors.  
...
|||  
|-|-|  
|[generic_errno](../vs140/-system_error--typedefs.md#generic_errno)|A type that represents the enumeration that provides the symbolic names for all the error-code macros defined by Posix in <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>.|  
  
### Functions  
  
|||  
|-|-|  
|[make_error_code](../vs140/-system_error--functions.md#make_error_code)|Creates an <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> object.|  
|[make_error_condition](../vs140/-system_error--functions.md#make_error_condition)|Creates an <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> object.|  
...
|||  
|-|-|  
|[errc](../vs140/-system_error--enums.md#errc_enumeration)|Provides symbolic names for all the error-code macros defined by Posix in <CodeContentPlaceHolder>6\</CodeContentPlaceHolder>.|  
