...
'function': cannot compile an unmanaged function with /clr:pure or /clr:safe  
 ...
 A compilation with **/clr:pure** or **/clr:safe** will produce an MSIL only image, an image with no native (unmanaged) code.  Therefore, you cannot use the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> pragma in a **/clr:pure** or **/clr:safe** compilation.  
