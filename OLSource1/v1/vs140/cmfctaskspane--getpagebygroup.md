...
## Return Value  
 <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> if the group <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> exists; otherwise, <CodeContentPlaceHolder>5\</CodeContentPlaceHolder>.  
