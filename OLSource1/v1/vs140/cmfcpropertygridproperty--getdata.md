...
---
# CMFCPropertyGridProperty::GetData
Retrieves a <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> value that is associated with a property.  
  
## Syntax  
  
<CodeContentPlaceHolder>0\</CodeContentPlaceHolder>  
## Return Value  
 A <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> value.  
