...
## Remarks  
 ...
 For more information on <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>, see the Remarks section of the [hash_multimap Class](../vs140/hash_multimap-class.md) topic.  
  
 In Visual C++ .NET 2003, members of the [\<hash_map>](../vs140/-hash_map-.md) and [\<hash_set>](../vs140/-hash_set-.md) header files are no longer in the std namespace, but rather have been moved into the stdext namespace. See [The stdext Namespace](../vs140/stdext-namespace.md) for more information.  
  
## Example  
 See the example for [value_type](../vs140/hash_multimap--value_type.md) for an example of how to declare and use <CodeContentPlaceHolder>4\</CodeContentPlaceHolder>.  
