...
## Remarks  
 This class provides default static functions and methods for moving, copying, comparing, and hashing elements stored in a collection class object. <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> is specified as the default provider of these operations by the collection classes [CAtlArray](../vs140/catlarray-class.md), [CAtlList](../vs140/catllist-class.md), [CRBMap](../vs140/crbmap-class.md), [CRBMultiMap](../vs140/crbmultimap-class.md), and [CRBTree](../vs140/crbtree-class.md).  
