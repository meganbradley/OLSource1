...
ms.topic: "reference"
f1_keywords: 
  - "ATL::CAccessToken::GetThreadToken"
  - "ATL.CAccessToken.GetThreadToken"
  - "GetThreadToken"
...
---
# CAccessToken::GetThreadToken
Call this method to initialize the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> with the token from the given thread.  
...
#### Parameters  
 ...
 Indicates whether the access check is to be made against the security context of the thread calling the <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> method or against the security context of the process for the calling thread.  
