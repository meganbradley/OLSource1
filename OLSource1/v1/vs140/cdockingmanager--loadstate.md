...
## Return Value  
 <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> if the docking manager state was loaded successfully; otherwise <CodeContentPlaceHolder>4\</CodeContentPlaceHolder>.  
