...
|---------------|-----------------|  
|[in] <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>|Pointer to the [CMenu](../vs140/cmenu-class.md) object that represents the menu or submenu.|  
|[in] <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>|The menu that was destroyed. Currently, it can only be the window menu, <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>.|  
