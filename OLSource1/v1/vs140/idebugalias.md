...
## Methods in Vtable Order  
 The following methods are defined in the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> interface.  
...
|[GetICorDebugValue](../vs140/idebugalias--geticordebugvalue.md)|Retrieves an <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> interface that provides access to managed code information about this object (managed code only).|  
