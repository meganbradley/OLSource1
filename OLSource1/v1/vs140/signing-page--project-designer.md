 ...
 **Delay sign only** check box  
 ...
 Note that a delay signed project will not run and cannot be debugged. You can, however, use the [Strong Name Tool (Sn.exe)](assetId:///c1d2b532-1b8e-4c7a-8ac5-53b801135ec6) with the <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> option to skip verification during development.  
