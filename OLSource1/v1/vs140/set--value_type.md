...
## Remarks  
 ...
 Note that both [key_type](../vs140/set--key_type.md) and <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> are synonyms for the template parameter **Key**. Both types are provided for the set and multiset classes, where they are identical, for compatibility with the map and multimap classes, where they are distinct.  
