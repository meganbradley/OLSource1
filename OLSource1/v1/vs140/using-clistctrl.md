...
> [!NOTE]
>  The [!INCLUDE[winSDK](../vs140/includes/winsdk_md.md)] refers to list controls as "list view controls." This usage of "view" does not refer to MFC view classes, particularly <CodeContentPlaceHolder>0\</CodeContentPlaceHolder>. For more information, see [List Control and List View](../vs140/list-control-and-list-view.md).  
