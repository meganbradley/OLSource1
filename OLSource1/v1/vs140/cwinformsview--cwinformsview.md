...
## Example  
 In the following example, the <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> class inherits from <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> and passes the type of <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> to the <CodeContentPlaceHolder>6\</CodeContentPlaceHolder> constructor. <CodeContentPlaceHolder>7\</CodeContentPlaceHolder> is a custom-built control in ControlLibrary1.dll.  
