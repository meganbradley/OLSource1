...
#### Parameters  
 ...
 [out] Returns <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> if the section contains uninitialized data; otherwise, returns <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>.  
