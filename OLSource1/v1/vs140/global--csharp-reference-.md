...
---
# global (C# Reference)
The <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> contextual keyword, when it comes before the [:: operator](../vs140/---operator--csharp-reference-.md), refers to the global namespace, which is the default namespace for any C# program and is otherwise unnamed. For more information, see [How to: Use the Namespace Alias Qualifier (C# Programming Guide)](../vs140/how-to--use-the-global-namespace-alias--csharp-programming-guide-.md).  
  
## Example  
 The following example shows how to use the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> contextual keyword to specify that the class <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> is defined in the global namespace:  
