...
Performs a bitwise <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> of a value and an existing value that is stored in an <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> object.  
