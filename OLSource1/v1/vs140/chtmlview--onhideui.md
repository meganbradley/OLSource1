...
## Return Value  
 <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> if successful, or an OLE-defined error code otherwise.  
  
## Remarks  
 Override <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> to react to the <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> notification from the Microsoft Web Browser control. See [IDocHostUIHandler::HideUI](https://msdn.microsoft.com/en-us/library/aa753259.aspx) in the [!INCLUDE[winSDK](../vs140/includes/winsdk_md.md)] for more information.  
