...
-   If you need to perform a transformation on the contents of the parameter, use a [Function Statement (Visual Basic)](../vs140/function-statement--visual-basic-.md) to define a <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> procedure instead of an operator.  
