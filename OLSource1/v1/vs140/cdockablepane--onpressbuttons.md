...
---
# CDockablePane::OnPressButtons
Called when the user presses a caption button other than the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> and <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> buttons.  
