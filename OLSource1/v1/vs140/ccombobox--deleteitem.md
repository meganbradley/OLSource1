...
---
# CComboBox::DeleteItem
Called by the framework when the user deletes an item from an owner-draw <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> object or destroys the combo box.  
