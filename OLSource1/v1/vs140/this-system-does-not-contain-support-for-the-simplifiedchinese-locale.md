...
You are attempting to use the <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> enumeration member, but your system does not support the Simplified Chinese locale.  
