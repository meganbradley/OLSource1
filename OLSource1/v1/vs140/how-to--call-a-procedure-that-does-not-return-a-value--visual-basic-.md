...
3.  Place the arguments in the argument list within the parentheses, separated by commas. Be sure you supply the arguments in the same order that the `Sub` procedure defines the corresponding parameters.  
     ...
     The following example calls the [!INCLUDE[vbprvb](../vs140/includes/vbprvb_md.md)] [AppActivate](assetId:///M:Microsoft.VisualBasic.Interaction.AppActivate(System.String)?qualifyHint=False&autoUpgrade=True) function to activate an application window. assetId:///M:Microsoft.VisualBasic.Interaction.AppActivate(System.String)?qualifyHint=False&autoUpgrade=True takes the window title as its sole argument. It does not return a value to the calling code. If a Notepad process is not running, the example throws an <xref:System.ArgumentException*>. The `Shell` procedure assumes the applications are in the paths specified.  
...
## See Also  
 [Shell](assetId:///M:Microsoft.VisualBasic.Interaction.Shell(System.String,Microsoft.VisualBasic.AppWinStyle,System.Boolean,System.Int32)?qualifyHint=False&autoUpgrade=True)   
