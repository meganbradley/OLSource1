...
#### Parameters  
 ...
 The parent window of the drop-down frame, or <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> to use the parent window of the drop-down toolbar button.  
...
## Remarks  
 ...
 This method fails if <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> is <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> and the drop-down toolbar button does not have a parent window.  
