...
Adding this attribute to an F# mutable binding causes the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> prefix to be used for all accesses to the field.  
