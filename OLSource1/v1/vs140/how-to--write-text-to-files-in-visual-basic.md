...
The [WriteAllText](assetId:///M:Microsoft.VisualBasic.FileIO.FileSystem.WriteAllText(System.String,System.String,System.Boolean)?qualifyHint=False&autoUpgrade=True) method can be used to write text to files. If the specified file does not exist, it is created.  
