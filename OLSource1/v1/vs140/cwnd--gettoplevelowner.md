...
## Remarks  
 The top-level window is the window that is a child of the desktop. If <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> has no attached window, this function returns **NULL**.  
