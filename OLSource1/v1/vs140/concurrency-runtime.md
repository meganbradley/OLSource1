...
|[Walkthrough: Connecting Using Tasks and XML HTTP Request (IXHR2)](../vs140/walkthrough--connecting-using-tasks-and-xml-http-requests.md)|Shows how to combine PPL tasks with the <CodeContentPlaceHolder>7\</CodeContentPlaceHolder> and <CodeContentPlaceHolder>8\</CodeContentPlaceHolder> interfaces to send HTTP GET and POST requests to a web service in a [!INCLUDE[win8_appname_long](../vs140/includes/win8_appname_long_md.md)] app.|  
