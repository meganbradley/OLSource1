...
## Remarks  
 Use the <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> tag in the comment for a method declaration to describe the return value.  
  
 Compile with [/doc](../vs140/-doc.md) to process documentation comments to a file.  
  
## Example  
 This example uses the <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> tag to explain what the <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> function returns.  
