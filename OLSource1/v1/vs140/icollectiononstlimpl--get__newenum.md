...
## Remarks  
 The newly created enumerator maintains an iterator on the original collection, <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>, (so no copy is made) and holds a COM reference on the collection object to ensure that the collection remains alive while there are outstanding enumerators.  
