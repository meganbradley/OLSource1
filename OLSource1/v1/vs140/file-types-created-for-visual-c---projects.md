...
|.ilk|Linking|Incremental link file. See [/INCREMENTAL](../vs140/-incremental--link-incrementally-.md) for more information.|  
|.map|Linking|A text file containing linker information. Use the [/Fm](../vs140/-fm--name-mapfile-.md) compiler option to name the map file. See [/MAP](../vs140/-map--generate-mapfile-.md) for more information.|  
