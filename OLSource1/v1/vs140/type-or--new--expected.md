...
A type parameter in the declaration of a generic type introduces a constraint list with the <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> keyword but does not specify a valid constraint.  
  
 A constraint on a type parameter must be a valid class or interface, or one of the keywords <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>, <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>, or <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>. If you specify an invalid constraint or none at all, the compiler generates this error.  
...
3.  Remember to separate multiple constraints on a single type parameter with commas, and to enclose the constraint list in braces (<CodeContentPlaceHolder>4\</CodeContentPlaceHolder>).  
