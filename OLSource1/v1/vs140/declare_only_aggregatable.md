...
## Remarks  
 <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> causes an error (**E_FAIL**) if an attempt is made to **CoCreate** your object as nonaggregated object.  
  
 By default, [CComCoClass](../vs140/ccomcoclass-class.md) contains the [DECLARE_AGGREGATABLE](../vs140/declare_aggregatable.md) macro, which specifies that your object can be aggregated. To override this default behavior, include <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> in your class definition.  
