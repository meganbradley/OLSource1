...
---
# adapter (STL-CLR)
The STL/CLR header <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> specifies two template classes (<CodeContentPlaceHolder>2\</CodeContentPlaceHolder> and <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>), and the template function <CodeContentPlaceHolder>4\</CodeContentPlaceHolder>.  
