...
## Remarks  
 If <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>, each tab windows displays a popup menu that shows a list of opened documents at the right edge of the tab area; Otherwise, the tab window displays scroll buttons at the right edge of the tab area. The default value is <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>.  
