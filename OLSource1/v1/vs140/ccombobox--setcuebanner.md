...
## Return Value  
 <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> if the method is successful; otherwise, <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>.  
...
## Example  
 The following code example defines the variable, <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>, that is used to programmatically access the combo box control. This variable is used in the next example.  
