...
## Example  
 In the following example, the object pointed to by <CodeContentPlaceHolder>6\</CodeContentPlaceHolder> is pinned until it passes out of scope:  
