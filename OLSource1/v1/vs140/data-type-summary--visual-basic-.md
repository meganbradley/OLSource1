...
|-----------------------|--------------------------------------------|--------------------------------|-----------------|  
|[Boolean](../vs140/boolean-data-type--visual-basic-.md)|\<xref:System.Boolean*>|Depends on implementing platform|<CodeContentPlaceHolder>0\</CodeContentPlaceHolder> or <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>|  
...
|[Object](../vs140/object-data-type.md)|\<xref:System.Object*> (class)|4 bytes on 32-bit platform\<br />\<br /> 8 bytes on 64-bit platform|Any type can be stored in a variable of type <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>|  
...
### Object Overhead  
 An <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> referring to any elementary or composite data type uses 4 bytes in addition to the data contained in the data type.  
