...
The directive binding rules call for a **barrier** directive to bind to the closest enclosing <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> directive. For more information on directive binding, see [Section 2.8](../vs140/2.8-directive-binding.md) on page 32.  
