...
#### Parameters  
 `start_address`  
 Start address of a routine that begins execution of a new thread. For `_beginthread`, the calling convention is either [__cdecl](../vs140/__cdecl.md) (for native code) or [__clrcall](../vs140/__clrcall.md) (for managed code); for `_beginthreadex`, it is either [__stdcall](../vs140/__stdcall.md) (for native code) or [__clrcall](../vs140/__clrcall.md) (for managed code).  
