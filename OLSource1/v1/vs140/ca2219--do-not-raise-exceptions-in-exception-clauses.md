...
## Cause  
 An exception is thrown from a <CodeContentPlaceHolder>0\</CodeContentPlaceHolder>, filter, or fault clause.  
  
## Rule Description  
 When an exception is raised in an exception clause, it greatly increases the difficulty of debugging.  
  
 When an exception is raised in a <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> or fault clause, the new exception hides the active exception, if present. This makes the original error hard to detect and debug.  
...
## How to Fix Violations  
 To fix this violation of this rule, do not explicitly raise an exception from a <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>, filter, or fault clause.  
...
## Related Rules  
 [Do not raise exceptions in unexpected locations](../vs140/ca1065--do-not-raise-exceptions-in-unexpected-locations.md)  
