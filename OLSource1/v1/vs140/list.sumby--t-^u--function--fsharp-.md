...
## Example  
 The following code example illustrates the use of [List.sum](../vs140/list.sum-^t--function--fsharp-.md), <CodeContentPlaceHolder>6\</CodeContentPlaceHolder>, and [List.average](../vs140/list.average-^t--function--fsharp-.md).  
