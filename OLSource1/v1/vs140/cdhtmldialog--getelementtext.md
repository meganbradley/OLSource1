...
---
# CDHtmlDialog::GetElementText
Retrieves the **innerText** property of the HTML element identified by <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>.  
...
## Return Value  
 The **innerText** property of the HTML element identified by <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> or **NULL** if the property or element could not be found.  
