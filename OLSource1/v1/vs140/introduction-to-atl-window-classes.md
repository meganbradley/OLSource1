...
-   [CWindow](../vs140/cwindow-class.md) allows you to attach a window handle to the <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> object. You then call <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> methods to manipulate the window.  
...
-   [CContainedWindowT](../vs140/ccontainedwindowt-class.md) is a prebuilt class that implements a window whose message map is contained in another class. Using <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> allows you to centralize message processing in one class.  
