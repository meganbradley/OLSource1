...
## Remarks  
 The use of this function usually requires a type annotation. An incorrect type annotation may result in runtime type errors. Individual <xref:System.Collections.Generic.IEnumerator<CodeContentPlaceHolder>2\</CodeContentPlaceHolder>Cast<CodeContentPlaceHolder>3\</CodeContentPlaceHolder>Seq.cast<CodeContentPlaceHolder>4\</CodeContentPlaceHolder>int`.  
