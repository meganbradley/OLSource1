...
-   An object of class path stores the pathname in native form, but supports easy conversion between this stored form and several external forms:  
 ...
 Interconversions between these representations are mediated, as needed, by the use of one or more <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> facets. If a specific locale object is not designated, these facets are obtained from the global locale.  
...
|Name|Description|  
|----------|-----------------|  
|[directory_entry Class](../vs140/directory_entry-class.md)|Describes an object that is returned by a <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> or a <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> and contains a path.|  
...
|[path Class](../vs140/path-class--c---standard-template-library-.md)|Defines a class that stores an object of template type <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> that is suitable for use as a file name.|  
...
|[file_status Class](../vs140/file_status-class.md)|Wraps a <CodeContentPlaceHolder>5\</CodeContentPlaceHolder>.|  
