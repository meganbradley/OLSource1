...
A class or structure is appears in multiple definitions in the same container type, and more than one definition is not marked <CodeContentPlaceHolder>0\</CodeContentPlaceHolder>.  
