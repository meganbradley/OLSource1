...
## Remarks  
 The default direction is counterclockwise. The <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> function specifies the direction in which the following functions draw:  
  
|Arc|Pie|  
|---------|---------|  
|<CodeContentPlaceHolder>2\</CodeContentPlaceHolder>|**Rectangle**|  
