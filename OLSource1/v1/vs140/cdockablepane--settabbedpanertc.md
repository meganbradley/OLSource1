...
## Remarks  
 ...
 The default runtime class is set according to the <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> parameter of [CDockablePane::Create](../vs140/cdockablepane--create.md) and [CDockablePane::CreateEx](../vs140/cdockablepane--createex.md). To customize the new tabbed panes, derive your class from one of the following classes:  
