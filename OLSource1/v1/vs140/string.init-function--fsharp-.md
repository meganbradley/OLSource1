...
#### Parameters  
 ...
 Type: [int](../vs140/core.int-type-abbreviation--fsharp-.md) <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> [string](../vs140/core.string-type-abbreviation--fsharp-.md)  
...
|Exception|Condition|  
|---------------|---------------|  
|\<xref:System.ArgumentException*>|Thrown when <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> is negative.|  
