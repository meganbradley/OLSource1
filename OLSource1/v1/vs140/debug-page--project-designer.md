...
> [!WARNING]
>  This topic does not apply to Windows Store apps. See [How to start a debugging session (Visual C++, Visual C#, and Visual Basic)](../vs140/start-a-debugging-session-for-a-store-app-in-visual-studio--vb--csharp--c---and-xaml-.md) in the Windows Dev Center.  
...
## Start Action  
 **Start Action** indicates the item to start when the application is debugged: the project, a custom program, a URL, or nothing. By default, this option is set to **Start project**. The **Start Action** setting on the **Debug** page determines the value of the <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> property.  
