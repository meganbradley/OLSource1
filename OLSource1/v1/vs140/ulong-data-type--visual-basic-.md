...
## Remarks  
 Use the <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> data type to contain binary data too large for <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>, or the largest possible unsigned integer values.  
...
-   **Interop Considerations.** If you are interfacing with components not written for the .NET Framework, for example Automation or COM objects, keep in mind that types such as <CodeContentPlaceHolder>8\</CodeContentPlaceHolder> can have a different data width (32 bits) in other environments. If you are passing a 32-bit argument to such a component, declare it as <CodeContentPlaceHolder>9\</CodeContentPlaceHolder> instead of <CodeContentPlaceHolder>10\</CodeContentPlaceHolder> in your managed Visual Basic code.  
  
     Furthermore, Automation does not support 64-bit integers on Windows 95, Windows 98, Windows ME, or Windows 2000. You cannot pass a Visual Basic <CodeContentPlaceHolder>11\</CodeContentPlaceHolder> argument to an Automation component on these platforms.  
  
-   **Widening.** The <CodeContentPlaceHolder>12\</CodeContentPlaceHolder> data type widens to <CodeContentPlaceHolder>13\</CodeContentPlaceHolder>, <CodeContentPlaceHolder>14\</CodeContentPlaceHolder>, and <CodeContentPlaceHolder>15\</CodeContentPlaceHolder>. This means you can convert <CodeContentPlaceHolder>16\</CodeContentPlaceHolder> to any of these types without encountering a \<xref:System.OverflowException*?displayProperty=fullName> error.  
