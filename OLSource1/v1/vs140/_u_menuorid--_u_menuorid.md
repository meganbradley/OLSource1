...
---
# _U_MENUorID::_U_MENUorID
The **UINT** argument is just cast to an <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> in the constructor and the result stored in the class's single data member, [m_hMenu](../vs140/_u_menuorid--m_hmenu.md).  
...
## Remarks  
 The argument to the <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> constructor is stored directly without conversion.  
