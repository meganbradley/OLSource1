...
-   Modify and export an existing template as a custom template.  
     ...
     For more information, see [How to: Update Existing Templates](../vs140/how-to--update-existing-templates.md).  
  
-   Pass custom parameters into a template to replace existing values.  
  
     For more information, see [How to: Substitute Parameters in a Template](../vs140/how-to--substitute-parameters-in-a-template.md).  
  
-   Customize the wizards that create projects from templates.  
  
     For more information, see [How to: Use Wizards with Project Templates](../vs140/how-to--use-wizards-with-project-templates.md).  
  
## Related Sections  
 [Introduction to Visual Studio Templates](../vs140/creating-project-and-item-templates.md)  
  
 [How to: Troubleshoot Templates](../vs140/how-to--troubleshoot-templates.md)  
