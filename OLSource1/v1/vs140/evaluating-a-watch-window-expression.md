...
3.  <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> calls [IDebugExpressionEvaluator::Parse](../vs140/idebugexpressionevaluator--parse.md) to do the actual work of parsing the text and produce an [IDebugParsedExpression](../vs140/idebugparsedexpression.md) object.  
  
4.  <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> creates an [IDebugExpression2](../vs140/idebugexpression2.md) object and puts the <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> object into it. This I<CodeContentPlaceHolder>3\</CodeContentPlaceHolder> object is then returned to Visual Studio.  
...
6.  <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> passes the call to [IDebugParsedExpression::EvaluateSync](../vs140/idebugparsedexpression--evaluatesync.md) to do the actual evaluation and produce an [IDebugProperty2](../vs140/idebugproperty2.md) object that is returned to Visual Studio.  
