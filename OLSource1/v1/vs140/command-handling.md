...
Your editor can define new commands. Commands are typically displayed in a menu, on a tool bar, or in a context menu.  
 ...
 A language service can control what context menus are shown in the editor, by intercepting the <xref:Microsoft.VisualStudio.VSConstants.VSStd2KCmdID.SHOWCONTEXTMENU*> enumeration. Alternately, you can control the context menu on a per-marker basis. For more information see [Key Commands for Language Service Filters](../vs140/important-commands-for-language-service-filters.md).  
