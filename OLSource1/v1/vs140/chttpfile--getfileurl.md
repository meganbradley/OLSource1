...
## Remarks  
 Use this member function only after a successful call to [SendRequest](../vs140/chttpfile--sendrequest.md) or on a <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> object successfully created by [OpenURL](../vs140/cinternetsession--openurl.md).  
