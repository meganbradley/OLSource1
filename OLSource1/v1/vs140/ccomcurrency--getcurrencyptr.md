...
f1_keywords: 
  ...
  - "ATL.CComCurrency.GetCurrencyPtr"
  - "ATL::CComCurrency::GetCurrencyPtr"
  - "GetCurrencyPtr"
  - "CComCurrency::GetCurrencyPtr"
dev_langs: 
...
---
# CComCurrency::GetCurrencyPtr
Returns the address of an <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> data member.  
  
## Syntax  
  
<CodeContentPlaceHolder>0\</CodeContentPlaceHolder>  
## Return Value  
 Returns the address of an <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> data member  
