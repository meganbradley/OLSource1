...
|[in] <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>|Pointer to the parent window of the tear-off bar.|  
|[in] <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>|The command ID of the tear-off bar.|  
|[in] <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>|The window text of the tear-off bar.|  
