...
## Return Value  
 The current keyboard navigation object on the ribbon bar; otherwise <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> if no object currently displays keytips.  
