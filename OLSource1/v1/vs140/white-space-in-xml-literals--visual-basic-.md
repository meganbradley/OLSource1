...
> [!NOTE]
>  If the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> attribute appears in an XML element literal, the [!INCLUDE[vbprvb](../vs140/includes/vbprvb_md.md)] compiler includes the attribute in the \<xref:System.Xml.Linq.XElement*> object, but adding this attribute does not change how the compiler treats white space.  
...
## Examples  
 ...
 [!code[VbXMLSamples#29](../vs140/codesnippet/VisualBasic/white-space-in-xml-literals--visual-basic-_1.vb)]  
