...
## Notes for Callers  
 Use [QueryInterface](../vs140/queryinterface.md) to obtain this interface from the [IDebugContainerField](../vs140/idebugcontainerfield.md) interface if the [IDebugField::GetKind](../vs140/idebugfield--getkind.md) method returns <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>.  
