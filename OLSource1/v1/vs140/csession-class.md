...
## Remarks  
 One or more sessions can be associated with each provider connection (data source), which is represented by a [CDataSource](../vs140/cdatasource-class.md) object. To create a new <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> for a <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>, call [CSession::Open](../vs140/csession--open.md). To begin a database transaction, <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> provides the <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> method. Once a transaction is started, you can commit to it using the **Commit** method, or cancel it using the **Abort** method.  
