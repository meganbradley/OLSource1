...
## Example  
 It is more difficult to split a string into its Unicode text characters, but this is necessary if you need information about the visual representation of a string. This example uses the [SubstringByTextElements](assetId:///M:System.Globalization.StringInfo.SubstringByTextElements(System.Int32,System.Int32)?qualifyHint=False&autoUpgrade=True) method to get information about the Unicode text characters that make up a string.  
...
## See Also  
 [Chars](assetId:///P:System.String.Chars(System.Int32)?qualifyHint=False&autoUpgrade=True)   
