...
## Example  
 This example demonstrates how to split a string into a <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> array, and how to split a string into a <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> array of its Unicode text characters. The reason for this distinction is that Unicode text characters can be composed of two or more <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> characters (such as a surrogate pair or a combining character sequence). For more information, see \<xref:System.Globalization.TextElementEnumerator*> and "The Unicode Standard" at http://www.unicode.org.  
