...
## Sorting arrays by using custom criteria  
 ...
 In the following example, a structure named `Element` is derived from <xref:System.IComparable*>, and written to provide a [CompareTo](assetId:///M:System.IComparable.CompareTo(System.Object)?qualifyHint=False&autoUpgrade=True) method that uses the average of two integers as the sort criterion.  
