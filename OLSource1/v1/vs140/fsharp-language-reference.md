...
|[Strings](../vs140/strings--fsharp-.md)|Describes strings in F#. The `string` type represents immutable text, as a sequence of Unicode characters. `string` is an alias for <xref:System.String?qualifyHint=False> in the .NET Framework.|  
