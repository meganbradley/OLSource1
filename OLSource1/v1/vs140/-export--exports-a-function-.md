...
## Remarks  
 ...
 The *entryname* is the name of the function or data item as it is to be used by the calling program. <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> specifies an index into the exports table in the range 1 through 65,535; if you do not specify <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>, LINK assigns one. The **NONAME** keyword exports the function only as an ordinal, without an *entryname*.  
...
> [!NOTE]
>  Do not specify the decorated form of C identifiers that are declared <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> or <CodeContentPlaceHolder>4\</CodeContentPlaceHolder>.  
