...
In this step, you add controls, such as a <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> control and a <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> control, to your form. You then add buttons to your form.  
