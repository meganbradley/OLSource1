...
|[IMPLEMENT_OLECREATE_EX](../vs140/implement_olecreate_ex.md)|Implements the control's <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> function and declares an instance of the class factory.|  
