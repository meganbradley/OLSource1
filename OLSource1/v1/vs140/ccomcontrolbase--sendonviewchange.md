...
f1_keywords: 
  ...
  - "CComControlBase::SendOnViewChange"
  - "ATL.CComControlBase.SendOnViewChange"
  - "ATL::CComControlBase::SendOnViewChange"
dev_langs: 
  - "C++"
helpviewer_keywords: 
  - "SendOnViewChange method"
...
## Remarks  
 <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> calls [IAdviseSink::OnViewChange](http://msdn.microsoft.com/library/windows/desktop/ms694337). The only value of *lindex* currently supported is -1, which indicates that the entire view is of interest.  
