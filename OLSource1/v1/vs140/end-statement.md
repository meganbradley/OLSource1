...
> [!IMPORTANT]
>  The `End` statement calls the [Exit](assetId:///M:System.Environment.Exit(System.Int32)?qualifyHint=False&autoUpgrade=True) method of the <xref:System.Environment*> class in the <xref:System*> namespace. assetId:///M:System.Environment.Exit(System.Int32)?qualifyHint=False&autoUpgrade=True requires that you have `UnmanagedCode` permission. If you do not, a <xref:System.Security.SecurityException*> error occurs.  
