...
3.  In the **Compile-time directives** box, add the [#include](../vs140/sharpinclude-directive--c-c---.md) compiler directive to include the new resource file in the main resource file in the development environment.  
