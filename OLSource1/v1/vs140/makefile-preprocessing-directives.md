 ...
 **!IF**  <CodeContentPlaceHolder>0\</CodeContentPlaceHolder>  
 Processes statements between **!IF** and the next **!ELSE** or <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> if <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> evaluates to a nonzero value.  
  
 **!IFDEF**  *macroname*  
 Processes statements between <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> and the next **!ELSE** or <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> if *macroname* is defined. A null macro is considered to be defined.  
  
 **!IFNDEF**  *macroname*  
 Processes statements between **!IFNDEF** and the next **!ELSE** or <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> if *macroname* is not defined.  
  
 **!ELSE**[**IF** *constantexpression* &#124; **IFDEF** *macroname*&#124; **IFNDEF** *macroname*]  
 Processes statements between **!ELSE** and the next <CodeContentPlaceHolder>6\</CodeContentPlaceHolder> if the prior **!IF**, <CodeContentPlaceHolder>7\</CodeContentPlaceHolder>, or **!IFNDEF** statement evaluated to zero. The optional keywords give further control of preprocessing.  
 ...
 **!ELSEIFNDEF**  
 ...
 Marks the end of an **!IF**, <CodeContentPlaceHolder>9\</CodeContentPlaceHolder>, or **!IFNDEF** block. Any text after <CodeContentPlaceHolder>10\</CodeContentPlaceHolder> on the same line is ignored.  
