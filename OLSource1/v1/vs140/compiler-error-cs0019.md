...
## Example  
 In the following example, CS0019 is generated in two places because [bool](../vs140/bool--csharp-reference-.md) in C# is not convertible to [int](../vs140/int--csharp-reference-.md). CS0019 also is generated when the subtraction operator is applied to a string. The addition operator (+) can be used with string operands because that operator is overloaded by the <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> class to perform string concatenation.  
