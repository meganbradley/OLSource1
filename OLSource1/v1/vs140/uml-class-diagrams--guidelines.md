...
2.  To add attributes or operations to the types, or literals to an enumeration, choose the **Attributes**, **Operations** or **Literals** heading in the type, and press ENTER.  
     ...
     You can write a signature such as <CodeContentPlaceHolder>6\</CodeContentPlaceHolder>. See [Attributes and Operations](#AttributesAndOperations).  
...
-   Use an **Enumeration** (3) to represent a type that has a limited number of literal values, for example <CodeContentPlaceHolder>7\</CodeContentPlaceHolder> and <CodeContentPlaceHolder>8\</CodeContentPlaceHolder>.  
...
-   **(none)** - You can leave a type unspecified in the signature by omitting the preceding colon (<CodeContentPlaceHolder>9\</CodeContentPlaceHolder>).  
 ...
 **Null** or a value of the given type.  
 ...
 A collection of between <CodeContentPlaceHolder>15\</CodeContentPlaceHolder> and <CodeContentPlaceHolder>16\</CodeContentPlaceHolder> instances of the given type.  
...
<CodeContentPlaceHolder>2\</CodeContentPlaceHolder>  
 Use the short form of visibility. The default value is <CodeContentPlaceHolder>17\</CodeContentPlaceHolder> (public).  
...
### Attributes and Associations  
 ...
 Each attribute name becomes a role name. It appears at the opposite end of the association from the owning type. Look, for example, at <CodeContentPlaceHolder>23\</CodeContentPlaceHolder> in the illustration.  
...
1.  Create a class or interface. This will become your template type. Name it accordingly, for example, <CodeContentPlaceHolder>24\</CodeContentPlaceHolder>.  
...
5.  Set the name property to a parameter name for your template type, for example, <CodeContentPlaceHolder>25\</CodeContentPlaceHolder>.  
...
9. Add attributes and operations to the template type as you would do for other classes.  
     ...
     You can use parameters whose kind is **Class**, **Interface** or **Enumeration** in the definition of attributes and operations. For example, by using parameter classes <CodeContentPlaceHolder>26\</CodeContentPlaceHolder> and <CodeContentPlaceHolder>27\</CodeContentPlaceHolder>, you could define this operation in <CodeContentPlaceHolder>28\</CodeContentPlaceHolder>:  
  
     <CodeContentPlaceHolder>29\</CodeContentPlaceHolder>  
  
     You can use a parameter whose kind is **Integer** as a bound in a multiplicity. For example, a parameter integer max could be used to define the multiplicity of an attribute as <CodeContentPlaceHolder>30\</CodeContentPlaceHolder>.  
...
1.  Create a new type, for example, <CodeContentPlaceHolder>31\</CodeContentPlaceHolder>.  
  
2.  Open the shortcut menu for the new type, and then choose **Properties**.  
  
3.  In the **Template Binding** property, select the template type, for example <CodeContentPlaceHolder>32\</CodeContentPlaceHolder>, from the drop-down list.  
  
4.  Expand the **Template Binding** property.  
  
     A row appears for each parameter of the template type.  
  
5.  Set each parameter to a suitable value. For example, set the <CodeContentPlaceHolder>33\</CodeContentPlaceHolder> parameter to a class called <CodeContentPlaceHolder>34\</CodeContentPlaceHolder>.  
...
-   Open the shortcut menu for the diagram or an element, choose **Generate Code**, and then set the necessary properties.  
     ...
     For more information about how to set these properties and customize the provided templates, see [How to: Generate Code from UML Class Diagrams](../vs140/generate-code-from-uml-class-diagrams.md).  
