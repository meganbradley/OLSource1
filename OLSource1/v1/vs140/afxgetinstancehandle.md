...
## Return Value  
 An <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> to the current instance of the application. If called from within a DLL linked with the USRDLL version of MFC, an <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> to the DLL is returned.  
  
## Remarks  
 <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> always returns the <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> of your executable file (.EXE) unless it is called from within a DLL linked with the USRDLL version of MFC. In this case, it returns an <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> to the DLL.  
