...
---
# COleServerDoc::IsEmbedded
Call the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> member function to determine whether the document represents an object embedded in a container.  
  
## Syntax  
  
<CodeContentPlaceHolder>0\</CodeContentPlaceHolder>  
## Return Value  
 Nonzero if the <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> object is a document that represents an object embedded in a container; otherwise 0.  
