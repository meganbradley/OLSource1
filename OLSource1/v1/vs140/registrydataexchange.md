...
## Remarks  
 The macros [BEGIN_RDX_MAP](../vs140/begin_rdx_map.md) and [END_RDX_MAP](../vs140/end_rdx_map.md) expand to a function that calls <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>.  
