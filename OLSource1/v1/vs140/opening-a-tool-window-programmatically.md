...
Tool windows are typically opened by clicking a command on a menu, or by pressing an equivalent keyboard shortcut. However, you might have to open a tool window programmatically, like the command handler does.  
 ...
 To open a tool window in the managed VSPackage that provides it, use [FindToolWindow](assetId:///M:Microsoft.VisualStudio.Shell.Package.FindToolWindow(System.Type,System.Int32,System.Boolean)?qualifyHint=False&autoUpgrade=True). To open a tool window in another VSPackage, use [FindToolWindow](assetId:///M:Microsoft.VisualStudio.Shell.Interop.IVsUIShell.FindToolWindow(System.UInt32,System.Guid@,Microsoft.VisualStudio.Shell.Interop.IVsWindowFrame@)?qualifyHint=False&autoUpgrade=True). In either case, the tool window is created as required.  
...
3.  Use assetId:///M:Microsoft.VisualStudio.Shell.Package.FindToolWindow(System.Type,System.Int32,System.Boolean)?qualifyHint=False&autoUpgrade=True to find the tool window pane or to create it if it does not already exist.  
