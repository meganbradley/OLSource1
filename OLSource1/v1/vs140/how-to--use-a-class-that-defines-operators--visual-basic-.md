...
## Example  
 The following example accesses the SQL structure \<xref:System.Data.SqlTypes.SqlString*>, which defines the conversion operators ([CType Function](../vs140/ctype-function--visual-basic-.md)) in both directions between a SQL string and a [!INCLUDE[vbprvb](../vs140/includes/vbprvb_md.md)] string. Use <CodeContentPlaceHolder>0\</CodeContentPlaceHolder>*SQL string expression*, <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> to convert a SQL string to a [!INCLUDE[vbprvb](../vs140/includes/vbprvb_md.md)] string, and <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>*Visual Basic string expression*, \<xref:System.Data.SqlTypes.SqlString*><CodeContentPlaceHolder>3\</CodeContentPlaceHolder> to convert in the other direction.  
 ...
 The \<xref:System.Data.SqlTypes.SqlString*> structure defines a conversion operator ([CType Function](../vs140/ctype-function--visual-basic-.md)) from <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> to \<xref:System.Data.SqlTypes.SqlString*> and another from \<xref:System.Data.SqlTypes.SqlString*> to <CodeContentPlaceHolder>5\</CodeContentPlaceHolder>. The statement that assigns <CodeContentPlaceHolder>6\</CodeContentPlaceHolder> to <CodeContentPlaceHolder>7\</CodeContentPlaceHolder> makes use of the first operator, and the \<xref:Microsoft.VisualBasic.Interaction.MsgBox*> function call uses the second.  
...
## Compiling the Code  
 ...
 Include the appropriate <CodeContentPlaceHolder>8\</CodeContentPlaceHolder> statement for the SQL string at the beginning of your source file (in this case \<xref:System.Data.SqlTypes*>).  
