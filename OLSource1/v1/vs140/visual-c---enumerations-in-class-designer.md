...
Class Designer supports C++ <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> and scoped <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> types. Following is an example:  
...
<CodeContentPlaceHolder>0\</CodeContentPlaceHolder>  
 ...
 For more information about using the <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> type, see [C++ Enumeration Declarations](../vs140/enumerations--c---.md).  
