...
## Remarks  
 This member function is called when a vertical splitter window is created. <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> indicates the default location where the split occurs.  
