...
To leverage pooling in your application, you must make sure OLE DB services are invoked by obtaining your data source through **IDataInitialize** or **IDBPromptInitialize**. If you directly use <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> to invoke the provider based on the provider's CLSID, no OLE DB services are invoked.  
