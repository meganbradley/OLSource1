...
## Artifact References  
 ...
 [M:Microsoft.VisualStudio.ArchitectureTools.Extensibility.Layer.ArtifactReferenceExtensions.CreateArtifactReferenceAsync(Microsoft.VisualStudio.ArchitectureTools.Extensibility.Layer.ILayer,EnvDTE.Project)](assetId:///M:Microsoft.VisualStudio.ArchitectureTools.Extensibility.Layer.ArtifactReferenceExtensions.CreateArtifactReferenceAsync(Microsoft.VisualStudio.ArchitectureTools.Extensibility.Layer.ILayer,EnvDTE.Project)?qualifyHint=False&autoUpgrade=True) creates an artifact reference from an <xref:EnvDTE.Project*> or <xref:EnvDTE.ProjectItem*>. This is an asynchronous operation. Therefore, you usually provide a callback that is called when the creation is complete.  
