...
|**Attach to a running C/C++ service**|-   [How to: Attach the Profiler to a Native Service to Collect Concurrency Data by Using the Command Line](../vs140/283a1ee1-b43e-4daf-95ae-1311925a42a8.md)|  
...
|**Profile by using the instrumentation method**|-   [Collecting Detailed Timing Data for Services Using the Instrumentation Method from the Profiler Command-Line](../vs140/6116e1df-ed3e-4b0d-ac7f-22f7d7ac00ea.md)|  
