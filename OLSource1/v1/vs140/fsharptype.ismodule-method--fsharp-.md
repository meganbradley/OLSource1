...
---
# FSharpType.IsModule Method (F#)
Returns <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> if the specified type is a \<xref:System.Type*> value corresponding to the compiled form of an F# module.  
