...
## Example  
 ...
 The preceding example uses the <xref:System.Type.ToString?qualifyHint=False> method on the <xref:System.Type?qualifyHint=False> object returned by the [GetType Operator](../vs140/gettype-operator--visual-basic-.md), because <xref:System.Type?qualifyHint=False> cannot be converted to `String` using `CStr`.  
