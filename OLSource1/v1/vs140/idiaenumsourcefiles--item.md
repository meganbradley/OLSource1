...
#### Parameters  
 index  
 [in] Index of the [IDiaSourceFile](../vs140/idiasourcefile.md) object to be retrieved. The index is in the range 0 to <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>-1, where <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> is returned by the [IDiaEnumSourceFiles::get_Count](../vs140/idiaenumsourcefiles--get_count.md) method.  
