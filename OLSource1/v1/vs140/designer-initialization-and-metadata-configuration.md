...
3.  Calls each design surface extension provider's [OnDesignerCreated](assetId:///M:Microsoft.VisualStudio.Shell.Design.DesignSurfaceExtension.OnDesignerCreated(System.ComponentModel.Design.IDesigner)?qualifyHint=False&autoUpgrade=True) method or [OnComponentCreated](assetId:///M:Microsoft.VisualStudio.Shell.Design.DesignSurfaceExtension.OnComponentCreated(System.ComponentModel.IComponent)?qualifyHint=False&autoUpgrade=True) method (as appropriate).  
