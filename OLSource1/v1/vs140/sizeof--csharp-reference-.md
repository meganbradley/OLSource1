...
|`sizeof(bool)`|1|  
 ...
 For all other types, including structs, the `sizeof` operator can be used only in unsafe code blocks. Although you can use the [Marshal.SizeOf](assetId:///M:System.Runtime.InteropServices.Marshal.SizeOf(System.Object)?qualifyHint=True&autoUpgrade=True) method, the value returned by this method is not always the same as the value returned by `sizeof`. assetId:///M:System.Runtime.InteropServices.Marshal.SizeOf(System.Object)?qualifyHint=True&autoUpgrade=True returns the size after the type has been marshaled, whereas `sizeof` returns the size as it has been allocated by the common language runtime, including any padding.  
