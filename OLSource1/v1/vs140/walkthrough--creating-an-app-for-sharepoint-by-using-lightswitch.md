...
2.  In the **Properties** window, in the text box for the **Name** property, enter <CodeContentPlaceHolder>25\</CodeContentPlaceHolder>.  
...
3.  In the **Screen Name** text box, enter <CodeContentPlaceHolder>26\</CodeContentPlaceHolder>.  
...
6.  In the **Properties** window, choose the **Display Name** text box, and then enter <CodeContentPlaceHolder>27\</CodeContentPlaceHolder>.  
...
11. In the **Adding Custom List** dialog box, name the list <CodeContentPlaceHolder>28\</CodeContentPlaceHolder>, and then choose the **Create** button.  
  
12. On the **Site Contents** page, choose the **add an app** link, and then choose **Contoso Products Template**.  
  
13. In the **Adding Custom List** dialog box, name the list <CodeContentPlaceHolder>29\</CodeContentPlaceHolder>, and then choose the **Create** button.  
...
2.  In the Code Editor, locate the <CodeContentPlaceHolder>30\</CodeContentPlaceHolder> element and then replace <CodeContentPlaceHolder>31\</CodeContentPlaceHolder> with <CodeContentPlaceHolder>32\</CodeContentPlaceHolder>.  
  
     This string will appear on the splash screen.  
  
3.  In the \<title> element, replace <CodeContentPlaceHolder>33\</CodeContentPlaceHolder> with <CodeContentPlaceHolder>34\</CodeContentPlaceHolder>.  
...
2.  In the **Properties** window, in the **Name** text box, enter <CodeContentPlaceHolder>35\</CodeContentPlaceHolder>.  
...
3.  In the **Name** text box, enter <CodeContentPlaceHolder>36\</CodeContentPlaceHolder>, and then choose the **Add** button.  
...
3.  In the Code Editor, in the <CodeContentPlaceHolder>37\</CodeContentPlaceHolder> method, locate the line <CodeContentPlaceHolder>38\</CodeContentPlaceHolder>, and then add the following code:  
...
3.  In the **Name** text box, enter <CodeContentPlaceHolder>39\</CodeContentPlaceHolder>, and then choose the **Add** button.  
  
4.  In the Code Editor, replace the contents with the following code:  
  
<CodeContentPlaceHolder>8\</CodeContentPlaceHolder>  
<CodeContentPlaceHolder>9\</CodeContentPlaceHolder>  
     Notice that this code retrieves the <CodeContentPlaceHolder>40\</CodeContentPlaceHolder> host object by using the server API for LightSwitch: <CodeContentPlaceHolder>41\</CodeContentPlaceHolder>. The <CodeContentPlaceHolder>42\</CodeContentPlaceHolder> host object provides access to several useful properties and methods that are used to interact with the SharePoint site. In particular, the <CodeContentPlaceHolder>43\</CodeContentPlaceHolder> method provides an entry point for interacting with assets that belong to the app web. When the app web’s **ClientContext** is retrieved, the proper context token is used for communicating back into SharePoint.  
...
3.  In the **Name** text box, enter <CodeContentPlaceHolder>44\</CodeContentPlaceHolder>, and then choose the **Add** button.  
  
4.  In the Code Editor, enter the following <CodeContentPlaceHolder>45\</CodeContentPlaceHolder> or <CodeContentPlaceHolder>46\</CodeContentPlaceHolder> statements:  
  
<CodeContentPlaceHolder>10\</CodeContentPlaceHolder>  
<CodeContentPlaceHolder>11\</CodeContentPlaceHolder>  
     Add the following code to the <CodeContentPlaceHolder>47\</CodeContentPlaceHolder> method:  
...
8.  In the **Properties** window, in the **Name** text box, enter <CodeContentPlaceHolder>48\</CodeContentPlaceHolder>.  
...
10. Choose the **OK** button to accept the default value of <CodeContentPlaceHolder>49\</CodeContentPlaceHolder> and close the dialog box.  
...
16. Name the method <CodeContentPlaceHolder>50\</CodeContentPlaceHolder>, and then choose the **OK** button.  
  
17. In the **Screen Designer**, open the shortcut menu for the **Upload Photo** node, and then choose **Edit Execute Code**.  
  
18. In the Code Editor, add the following code to the <CodeContentPlaceHolder>51\</CodeContentPlaceHolder> method:  
...
20. In the **Properties** window, name the tab <CodeContentPlaceHolder>52\</CodeContentPlaceHolder>.  
  
21. Below the **Rows Layout &#124; Photos** node, open the shortcut menu for the **Command Bar** node, and then choose **Add Button**.  
  
22. In the **Add Button** dialog box, choose the **Write my own method** option button, name the method <CodeContentPlaceHolder>53\</CodeContentPlaceHolder>, and then choose the **OK** button.  
  
23. In the **Properties** window, enter <CodeContentPlaceHolder>54\</CodeContentPlaceHolder> as the display name.  
...
7.  In the **Properties** window, under **Width**, in the **Pixels** text box, enter <CodeContentPlaceHolder>55\</CodeContentPlaceHolder>.  
  
8.  Under **Height**, in the **Pixels** text box, enter <CodeContentPlaceHolder>56\</CodeContentPlaceHolder>.  
  
#### To add a popup  
  
1.  In the Screen Designer, choose the **Popups** node, and then choose **Add Popup**.  
  
2.  In the **Properties** window, in the **Name** text box, enter <CodeContentPlaceHolder>57\</CodeContentPlaceHolder>.  
...
<CodeContentPlaceHolder>22\</CodeContentPlaceHolder>  
     The relationship between the **Photos** and **Surveys** entities was set to **Cascade Delete**, so the <CodeContentPlaceHolder>59\</CodeContentPlaceHolder> method is called when a survey record is deleted. This code calls the <CodeContentPlaceHolder>60\</CodeContentPlaceHolder> method of the <CodeContentPlaceHolder>61\</CodeContentPlaceHolder> class to delete the photos from the SharePoint list.  
...
7.  In the **Method** text box, enter <CodeContentPlaceHolder>62\</CodeContentPlaceHolder>, and then choose the **OK** button.  
  
8.  Open the shortcut menu for the **Delete Photo** node, and then choose **Edit Execute Code**.  
  
9. In the Code Editor, add the following code to the <CodeContentPlaceHolder>63\</CodeContentPlaceHolder> method:  
