...
## Return Value  
 <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> if the pane can be switched to autohide mode; otherwise, <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>.  
