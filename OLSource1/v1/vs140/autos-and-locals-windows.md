...
<CodeContentPlaceHolder>0\</CodeContentPlaceHolder>  
 If you set a breakpoint on the line <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>; and run the debugger, when execution stops the **Autos** window will look like this:  
  
 ![Autos&#45;CSharp](../vs140/media/autos-csharp.png "Autos-CSharp")  
  
 Note that the value of <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> is 0, because the line <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> has not yet been executed.  
...
<CodeContentPlaceHolder>1\</CodeContentPlaceHolder>  
 If you set a breakpoint on the line <CodeContentPlaceHolder>6\</CodeContentPlaceHolder> and run the debugger, when execution stops the **Autos** window will look like this:  
  
 ![Autos&#45;Cplus](../vs140/media/autos-cplus.png "Autos-Cplus")  
  
 Note that the variable e is uninitialized because the code on the line <CodeContentPlaceHolder>7\</CodeContentPlaceHolder> has not yet been executed.  
...
<CodeContentPlaceHolder>2\</CodeContentPlaceHolder>  
 Set a breakpoint on the int <CodeContentPlaceHolder>8\</CodeContentPlaceHolder> line.  
...
## Editing a Value in a Variable Window  
 ...
 You can enter an expression for a value, for example <CodeContentPlaceHolder>9\</CodeContentPlaceHolder>. The debugger accepts most valid language expressions.  
...
-   Evaluating some expressions can change the value of a variable or otherwise affect the state of your program. For example, evaluating <CodeContentPlaceHolder>10\</CodeContentPlaceHolder> changes the value of <CodeContentPlaceHolder>11\</CodeContentPlaceHolder> and <CodeContentPlaceHolder>12\</CodeContentPlaceHolder>.  
