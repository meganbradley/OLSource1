...
|-----------------|-----------------|---------------------------------|----------------------|  
|Select|Projects values that are based on a transform function.|`select`|<xref:System.Linq.Enumerable.Select``2?qualifyHint=True><br /><br /> <xref:System.Linq.Queryable.Select``2?qualifyHint=True>|  
|SelectMany|Projects sequences of values that are based on a transform function and then flattens them into one sequence.|Use multiple `from` clauses|<xref:System.Linq.Enumerable.SelectMany``2?qualifyHint=True><br /><br /> <xref:System.Linq.Queryable.SelectMany``2?qualifyHint=True>|  
