...
## Remarks  
 The text label is aligned as specified by the <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> parameter. It can be one of the following <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> values:  
