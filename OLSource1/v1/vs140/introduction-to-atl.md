...
-   How a [template library](../vs140/using-a-template-library.md) differs from a standard C++ library.  
  
-   What you [can and cannot do with ATL](../vs140/scope-of-atl.md).  
  
-   [Recommendations for choosing between ATL and MFC](../vs140/recommendations-for-choosing-between-atl-and-mfc.md).  
