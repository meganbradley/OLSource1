...
|<xref:System.Collections.Generic.KeyNotFoundException?qualifyHint=False>|Thrown when every item of the sequence evaluates to `None` when the given function is applied.|  
