...
## Remarks  
 The <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> member function is required for each call to the <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> member function, but only after painting is complete.  
  
 If the caret was hidden by the <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> member function, <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> restores the caret to the screen.  
