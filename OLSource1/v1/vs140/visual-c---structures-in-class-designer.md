...
Class Designer supports C++ structures, which are declared with the keyword <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>. Following is an example:  
  
<CodeContentPlaceHolder>0\</CodeContentPlaceHolder>  
 For more information about using the <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> type, see [struct (C++)](../vs140/struct--c---.md).  
...
|------------------|-------------------------|  
|<CodeContentPlaceHolder>3\</CodeContentPlaceHolder>|**StructureName**\<br />\<br /> Struct|  
