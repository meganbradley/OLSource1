...
## Remarks  
 This function automatically calls the windows functions <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> and <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> before and after retrieving the element. If the data element is a string, object, or variant, the function copies the element in the correct way. The parameter <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> should point to a large enough buffer to contain the element.  
