...
#### Parameters  
 ...
 The timeout value in milliseconds. If one is not provided then the default value is -1, which corresponds to <xref:System.Threading.Timeout.Infinite?qualifyHint=False>.  
