...
#### Parameters  
 ...
 [in] An <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> interface to the program. This is the same value supplied to the [IDebugProgramPublisher2::PublishProgram](../vs140/idebugprogrampublisher2--publishprogram.md) method and uniquely identifies the program being removed (that is, it is used as a cookie).  
