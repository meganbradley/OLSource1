...
<CodeContentPlaceHolder>0\</CodeContentPlaceHolder>  
 ...
 To create an array in which all the elements are initialized to zero, use <CodeContentPlaceHolder>21\</CodeContentPlaceHolder>.  
...
## Array Types and Modules  
 ...
 The library module [Microsoft.FSharp.Collections.Array](../vs140/collections.array-module--fsharp-.md) supports operations on one-dimensional arrays. The modules <CodeContentPlaceHolder>22\</CodeContentPlaceHolder>, <CodeContentPlaceHolder>23\</CodeContentPlaceHolder>, and <CodeContentPlaceHolder>24\</CodeContentPlaceHolder> contain functions that support operations on arrays of two, three, and four dimensions, respectively. You can create arrays of rank greater than four by using \<xref:System.Array*>.  
...
<CodeContentPlaceHolder>3\</CodeContentPlaceHolder>  
 The string <CodeContentPlaceHolder>25\</CodeContentPlaceHolder> appears only in the first array because the operation of creating a new element overwrites the reference in <CodeContentPlaceHolder>26\</CodeContentPlaceHolder> but does not affect the original reference to an empty string that is still present in <CodeContentPlaceHolder>27\</CodeContentPlaceHolder>. The string <CodeContentPlaceHolder>28\</CodeContentPlaceHolder> appears in both arrays because the <CodeContentPlaceHolder>29\</CodeContentPlaceHolder> operation on the \<xref:System.Text.StringBuilder*> type affects the underlying \<xref:System.Text.StringBuilder*> object, which is referenced in both arrays.  
  
 [Array.sub](../vs140/array.sub--t--function--fsharp-.md) generates a new array from a subrange of an array. You specify the subrange by providing the starting index and the length. The following code demonstrates the use of <CodeContentPlaceHolder>30\</CodeContentPlaceHolder>.  
...
<CodeContentPlaceHolder>4\</CodeContentPlaceHolder>  
 ...
 The following code demonstrates <CodeContentPlaceHolder>31\</CodeContentPlaceHolder>.  
...
<CodeContentPlaceHolder>5\</CodeContentPlaceHolder>  
 [Array.choose](../vs140/array.choose--t--u--function--fsharp-.md) selects elements of an array to include in a new array. The following code demonstrates <CodeContentPlaceHolder>32\</CodeContentPlaceHolder>. Note that the element type of the array does not have to match the type of the value returned in the option type. In this example, the element type is <CodeContentPlaceHolder>33\</CodeContentPlaceHolder> and the option is the result of a polynomial function, <CodeContentPlaceHolder>34\</CodeContentPlaceHolder>, as a floating point number.  
...
<CodeContentPlaceHolder>6\</CodeContentPlaceHolder>  
 [Array.collect](../vs140/array.collect--t--u--function--fsharp-.md) runs a specified function on each array element of an existing array and then collects the elements generated by the function and combines them into a new array. The following code demonstrates <CodeContentPlaceHolder>35\</CodeContentPlaceHolder>.  
...
<CodeContentPlaceHolder>7\</CodeContentPlaceHolder>  
 [Array.concat](../vs140/array.concat--t--function--fsharp-.md) takes a sequence of arrays and combines them into a single array. The following code demonstrates <CodeContentPlaceHolder>36\</CodeContentPlaceHolder>.  
...
<CodeContentPlaceHolder>8\</CodeContentPlaceHolder>  
 [Array.filter](../vs140/array.filter--t--function--fsharp-.md) takes a Boolean condition function and generates a new array that contains only those elements from the input array for which the condition is true. The following code demonstrates <CodeContentPlaceHolder>37\</CodeContentPlaceHolder>.  
...
<CodeContentPlaceHolder>9\</CodeContentPlaceHolder>  
 [Array.rev](../vs140/array.rev--t--function--fsharp-.md) generates a new array by reversing the order of an existing array. The following code demonstrates <CodeContentPlaceHolder>38\</CodeContentPlaceHolder>.  
...
### Multidimensional Arrays  
 ...
 The type of a two-dimensional array is written out as <CodeContentPlaceHolder>40\</CodeContentPlaceHolder> (for example, <CodeContentPlaceHolder>41\</CodeContentPlaceHolder>, <CodeContentPlaceHolder>42\</CodeContentPlaceHolder>), and the type of a three-dimensional array is written as <CodeContentPlaceHolder>43\</CodeContentPlaceHolder>, and so on for arrays of higher dimensions.  
...
<CodeContentPlaceHolder>13\</CodeContentPlaceHolder>  
 You can use this slicing syntax for types that implement the element access operators and overloaded <CodeContentPlaceHolder>44\</CodeContentPlaceHolder> methods. For example, the following code creates a Matrix type that wraps the F# 2D array, implements an Item property to provide support for array indexing, and implements three versions of <CodeContentPlaceHolder>45\</CodeContentPlaceHolder>. If you can use this code as a template for your matrix types, you can use all the slicing operations that this section describes.  
  
<CodeContentPlaceHolder>14\</CodeContentPlaceHolder>  
### Boolean Functions on Arrays  
 The functions [Array.exists](../vs140/array.exists--t--function--fsharp-.md) and [Array.exists2](../vs140/array.exists2--t1--t2--function--fsharp-.md) test elements in either one or two arrays, respectively. These functions take a test function and return <CodeContentPlaceHolder>46\</CodeContentPlaceHolder> if there is an element (or element pair for <CodeContentPlaceHolder>47\</CodeContentPlaceHolder>) that satisfies the condition.  
  
 The following code demonstrates the use of <CodeContentPlaceHolder>48\</CodeContentPlaceHolder> and <CodeContentPlaceHolder>49\</CodeContentPlaceHolder>. In these examples, new functions are created by applying only one of the arguments, in these cases, the function argument.  
...
### Searching Arrays  
 [Array.find](../vs140/array.find--t--function--fsharp-.md) takes a Boolean function and returns the first element for which the function returns <CodeContentPlaceHolder>50\</CodeContentPlaceHolder>, or raises a \<xref:System.Collections.Generic.KeyNotFoundException*> if no element that satisfies the condition is found. [Array.findIndex](../vs140/array.findindex--t--function--fsharp-.md) is like <CodeContentPlaceHolder>51\</CodeContentPlaceHolder>, except that it returns the index of the element instead of the element itself.  
  
 The following code uses <CodeContentPlaceHolder>52\</CodeContentPlaceHolder> and <CodeContentPlaceHolder>53\</CodeContentPlaceHolder> to locate a number that is both a perfect square and perfect cube.  
...
<CodeContentPlaceHolder>17\</CodeContentPlaceHolder>  
 [Array.tryFind](../vs140/array.tryfind--t--function--fsharp-.md) is like <CodeContentPlaceHolder>54\</CodeContentPlaceHolder>, except that its result is an option type, and it returns <CodeContentPlaceHolder>55\</CodeContentPlaceHolder> if no element is found. <CodeContentPlaceHolder>56\</CodeContentPlaceHolder> should be used instead of <CodeContentPlaceHolder>57\</CodeContentPlaceHolder> when you do not know whether a matching element is in the array. Similarly, [Array.tryFindIndex](../vs140/array.tryfindindex--t--function--fsharp-.md) is like [Array.findIndex](../vs140/array.findindex--t--function--fsharp-.md) except that the option type is the return value. If no element is found, the option is <CodeContentPlaceHolder>58\</CodeContentPlaceHolder>.  
  
 The following code demonstrates the use of <CodeContentPlaceHolder>59\</CodeContentPlaceHolder>. This code depends on the previous code.  
...
<CodeContentPlaceHolder>18\</CodeContentPlaceHolder>  
 Use [Array.tryPick](../vs140/array.trypick--t--u--function--fsharp-.md) when you need to transform an element in addition to finding it. The result is the first element for which the function returns the transformed element as an option value, or <CodeContentPlaceHolder>60\</CodeContentPlaceHolder> if no such element is found.  
  
 The following code shows the use of <CodeContentPlaceHolder>61\</CodeContentPlaceHolder>. In this case, instead of a lambda expression, several local helper functions are defined to simplify the code.  
...
### Performing Computations on Arrays  
 The [Array.average](../vs140/array.average-^t--function--fsharp-.md) function returns the average of each element in an array. It is limited to element types that support exact division by an integer, which includes floating point types but not integral types. The [Array.averageBy](../vs140/array.averageby--t-^u--function--fsharp-.md) function returns the average of the results of calling a function on each element. For an array of integral type, you can use <CodeContentPlaceHolder>62\</CodeContentPlaceHolder> and have the function convert each element to a floating point type for the computation.  
...
### Modifying Arrays  
 [Array.set](../vs140/array.set--t--function--fsharp-.md) sets an element to a specified value. [Array.fill](../vs140/array.fill--t--function--fsharp-.md) sets a range of elements in an array to a specified value. The following code provides an example of <CodeContentPlaceHolder>63\</CodeContentPlaceHolder>.  
...
### Sorting Arrays  
 Use [Array.sort](../vs140/array.sort--t--function--fsharp-.md) to sort an array by using the generic comparison function. Use [Array.sortBy](../vs140/array.sortby--t--key--function--fsharp-.md) to specify a function that generates a value, referred to as a *key*, to sort by using the generic comparison function on the key. Use [Array.sortWith](../vs140/array.sortwith--t--function--fsharp-.md) if you want to provide a custom comparison function. <CodeContentPlaceHolder>64\</CodeContentPlaceHolder>, <CodeContentPlaceHolder>65\</CodeContentPlaceHolder>, and <CodeContentPlaceHolder>66\</CodeContentPlaceHolder> all return the sorted array as a new array. The variations [Array.sortInPlace](../vs140/array.sortinplace--t--function--fsharp-.md), [Array.sortInPlaceBy](../vs140/array.sortinplaceby--t--key--function--fsharp-.md), and [Array.sortInPlaceWith](../vs140/array.sortinplacewith--t--function--fsharp-.md) modify the existing array instead of returning a new one.  
