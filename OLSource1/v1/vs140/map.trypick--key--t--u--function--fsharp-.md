...
Searches the map looking for the first element where the given function returns a <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> value.  
...
## Example  
 The following code shows the use of the <CodeContentPlaceHolder>7\</CodeContentPlaceHolder> function.  
