...
## Remarks  
 <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> derives from the class [CComSafeDeleteCriticalSection](../vs140/ccomsafedeletecriticalsection-class.md). However, <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> overrides the [Term](../vs140/ccomsafedeletecriticalsection--term.md) method to <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> access, which forces internal memory cleanup to occur only when instances of this class go out of scope or are explicitly deleted from memory.  
