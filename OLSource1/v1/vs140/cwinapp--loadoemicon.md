...
---
# CWinApp::LoadOEMIcon
Loads the Windows predefined icon resource specified by <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>.  
...
## Remarks  
 Use the <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> or [LoadStandardIcon](../vs140/cwinapp--loadstandardicon.md) member function to access the predefined Windows icons.  
