...
---
# CWinApp::LoadStandardIcon
Loads the Windows predefined icon resource that <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> specifies.  
...
## Remarks  
 Use the <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> or [LoadOEMIcon](../vs140/cwinapp--loadoemicon.md) member function to access the predefined Windows icons.  
