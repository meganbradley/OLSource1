...
|||  
|-|-|  
|[Analyzing Visual Basic and C# code quality in Metro style apps with Visual Studio code analysis](../vs140/analyze-visual-basic-and-csharp-code-quality-in-store-apps-using-visual-studio-static-code-analysis.md)|Use code analysis in Visual Basic and C# projects.|  
|[Analyzing C++ code quality of Metro style apps with Visual Studio code analysis](../vs140/analyze-c---code-quality-of-store-apps-using-visual-studio-static-code-analysis.md)|Use code analysis in C++ projects.|  
