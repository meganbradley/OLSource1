...
---
# CPictureHolder::CreateFromBitmap
Uses a bitmap to initialize the picture object in a <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>.  
 ...
 *pPal*  
 ...
 Handle to the bitmap from which the <CodeContentPlaceHolder>6\</CodeContentPlaceHolder> object is created.  
...
## Remarks  
 If <CodeContentPlaceHolder>8\</CodeContentPlaceHolder> is **TRUE**, the caller should not use the bitmap or palette object in any way after this call returns. If <CodeContentPlaceHolder>9\</CodeContentPlaceHolder> is **FALSE**, the caller is responsible for ensuring that the bitmap and palette objects remain valid for the lifetime of the picture object.  
