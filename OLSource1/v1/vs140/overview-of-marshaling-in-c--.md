...
> [!NOTE]
>  If you have embedded <CodeContentPlaceHolder>0\</CodeContentPlaceHolder>s in your string, the result of marshaling the string is not guaranteed. The embedded <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>s can cause the string to be truncated or they might be preserved.  
 ...
 In earlier versions, you could marshal data by using [Platform Invoke](assetId:///eca7606e-ebfb-4f47-b8d9-289903fdc045). For more information about <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>, see [Calling Native Functions from Managed Code](../vs140/calling-native-functions-from-managed-code.md).  
