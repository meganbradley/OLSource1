...
## Remarks  
 The path of the filename includes the file's title plus the entire directory path. For example, <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> will return "C:\FILES\TEXT.DAT" for the file C:\FILES\TEXT.DAT.  
