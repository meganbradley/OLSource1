...
## Remarks  
 The <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> member function sends a <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> message directly, bypassing the application queue. If the update region is empty, <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> is not sent.  
