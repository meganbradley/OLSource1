...
2.  Get the \<xref:System.Type*> of the options page by applying the <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> keyword to the name of the class that defines the options page.  
