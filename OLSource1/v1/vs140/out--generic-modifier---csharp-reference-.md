...
For generic type parameters, the <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> keyword specifies that the type parameter is covariant. You can use the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> keyword in generic interfaces and delegates.  
 ...
 An interface that has a covariant type parameter enables its methods to return more derived types than those specified by the type parameter. For example, because in .NET Framework 4, in <xref:System.Collections.Generic.IEnumerable<CodeContentPlaceHolder>2\</CodeContentPlaceHolder>IEnumerabe(Of String)<CodeContentPlaceHolder>3\</CodeContentPlaceHolder>IEnumerable(Of Object)` type without using any special conversion methods.  
...
## Example  
 ...
 [!code[csVarianceKeywords#3](../vs140/codesnippet/CSharp/out--generic-modifier---csharp-reference-_1.cs)]  
...
## Example  
 ...
 [!code[csVarianceKeywords#4](../vs140/codesnippet/CSharp/out--generic-modifier---csharp-reference-_2.cs)]  
...
## See Also  
 ...
 [in (Generic Modifier) (C# Reference)](../vs140/in--generic-modifier---csharp-reference-.md)   
