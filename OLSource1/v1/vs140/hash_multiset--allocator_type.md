...
## Remark  
 ...
 For more information on <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>, see the Remarks section of the [hash_multiset Class](../vs140/hash_multiset-class.md).  
  
## Example  
 See example for [get_allocator](../vs140/hash_multiset--get_allocator.md) for an example using <CodeContentPlaceHolder>4\</CodeContentPlaceHolder>  
