...
## Return Value  
 An array of descriptions of the properties (<xref:System.Reflection.PropertyInfo?qualifyHint=False> objects) of the record type.  
  
## Exceptions  
  
|Exception|Condition|  
|---------------|---------------|  
|<xref:System.ArgumentException?qualifyHint=False>|Thrown if the given type is not an record.|  
