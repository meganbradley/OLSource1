...
-   A .dll or .netmodule will take its name from the first source code file.  
 ...
 Any modules produced as part of a compilation become files associated with any assembly also produced in the compilation. Use [ildasm.exe](assetId:///db27f6b2-f1ec-499e-be3a-7eecf95ca42b) to view the assembly manifest to see the associated files.  
  
 The /out compiler option is required in order for an exe to be the target of a friend assembly. For more information see [Friend Assemblies (C#)](../vs140/friend-assemblies--csharp-and-visual-basic-.md).  
...
## Example  
 Compile <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> and create output file <CodeContentPlaceHolder>4\</CodeContentPlaceHolder>, as well as build <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> and create module output file <CodeContentPlaceHolder>6\</CodeContentPlaceHolder>:  
  
<CodeContentPlaceHolder>1\</CodeContentPlaceHolder>  
## See Also  
 [C# Compiler Options](../vs140/csharp-compiler-options.md)   
 [Friend Assemblies (C#)](../vs140/friend-assemblies--csharp-and-visual-basic-.md)   
