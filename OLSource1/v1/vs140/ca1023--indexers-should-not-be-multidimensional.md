...
## Example  
 The following example shows a type, <CodeContentPlaceHolder>0\</CodeContentPlaceHolder>, with a multi-dimensional indexer that violates the rule. The indexer can be seen as a type of conversion and therefore is more appropriately exposed as a method. The type is redesigned in <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> to satisfy the rule.  
  
 [!code[FxCop.Design.OneDimensionForIndexer#1](../vs140/codesnippet/VisualBasic/ca1023--indexers-should-not-be-multidimensional_1.vb)]
[!code[FxCop.Design.OneDimensionForIndexer#1](../vs140/codesnippet/CPP/ca1023--indexers-should-not-be-multidimensional_1.cpp)]
[!code[FxCop.Design.OneDimensionForIndexer#1](../vs140/codesnippet/CSharp/ca1023--indexers-should-not-be-multidimensional_1.cs)]  
