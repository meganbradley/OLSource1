...
|[in] <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>|A value of <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> if the first Microsoft Intellimouse X button is double-clicked, or <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> if the second X button is double-clicked.|  
