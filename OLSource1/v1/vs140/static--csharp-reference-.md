...
---
# static (C# Reference)
Use the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> modifier to declare a static member, which belongs to the type itself rather than to a specific object. The <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> modifier can be used with classes, fields, methods, properties, operators, events, and constructors, but it cannot be used with indexers, destructors, or types other than classes. For more information, see [Static Classes and Static Class Members](../vs140/static-classes-and-static-class-members--csharp-programming-guide-.md).  
  
## Example  
 The following class is declared as <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> and contains only <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> methods:  
 ...
 To refer to the static member <CodeContentPlaceHolder>5\</CodeContentPlaceHolder>, use the fully qualified name, <CodeContentPlaceHolder>6\</CodeContentPlaceHolder>, unless the member is accessible from the same scope:  
...
<CodeContentPlaceHolder>0\</CodeContentPlaceHolder>  
 ...
 If the <CodeContentPlaceHolder>7\</CodeContentPlaceHolder> keyword is applied to a class, all the members of the class must be static.  
...
> [!NOTE]
>  The <CodeContentPlaceHolder>8\</CodeContentPlaceHolder> keyword has more limited uses than in C++. To compare with the C++ keyword, see [Static](../vs140/static--c---.md).  
