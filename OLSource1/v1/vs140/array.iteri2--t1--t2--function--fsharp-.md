...
Applies the given function to a pair of elements drawn from matching indices in two arrays, also passing the index of the elements. The two arrays must have the same lengths, otherwise <xref:System.ArgumentException?qualifyHint=False> is raised.  
