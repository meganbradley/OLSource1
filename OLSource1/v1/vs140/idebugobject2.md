...
## Methods in Vtable order  
 In addition to the methods on the [IDebugObject](../vs140/idebugobject.md) interface, the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> interface implements the following:  
...
|[IsEncOutdated](../vs140/idebugobject2--isencoutdated.md)|Determines whether the Edit and Continue state is no longer valid.\<br />\<br /> A custom expression evaluator does not implement this method (it should always return <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>).|  
