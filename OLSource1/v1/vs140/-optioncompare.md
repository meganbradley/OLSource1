...
## Remarks  
 You can specify <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> in one of two forms: <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> to use binary string comparisons, and <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> to use text string comparisons. By default, the compiler uses <CodeContentPlaceHolder>5\</CodeContentPlaceHolder>.  
...
## Example  
 The following code compiles P<CodeContentPlaceHolder>8\</CodeContentPlaceHolder> and uses binary string comparisons.  
