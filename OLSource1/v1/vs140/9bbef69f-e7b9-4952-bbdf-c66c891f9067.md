...
This property or procedure has the same name as another property or procedure marked with the <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> modifier.  
  
 **Error ID:** BC30695  
  
### To correct this error  
  
-   Use the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> modifier.  
