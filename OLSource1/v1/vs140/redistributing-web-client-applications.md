...
If your application uses the MFC classes implementing the WebBrowser control (for example, <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> or <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>), Microsoft Internet Explorer 4.0 or later must at least be minimally installed on the target computer.  
