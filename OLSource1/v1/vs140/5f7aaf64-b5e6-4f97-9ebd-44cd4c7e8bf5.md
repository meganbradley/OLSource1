...
A custom event declares an <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> or <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> procedure and marks it as <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>, but the event is defined in a type that is marked as <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> or is not marked.  
  
 When you apply \<xref:System.CLSCompliantAttribute*> to a programming element, you set the attribute's <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> parameter to either <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> or <CodeContentPlaceHolder>6\</CodeContentPlaceHolder> to indicate compliance or noncompliance. There is no default for this parameter, and you must supply a value.  
...
-   If you require that the event remain within its containing type, remove \<xref:System.CLSCompliantAttribute*> from its definition or mark it as <CodeContentPlaceHolder>7\</CodeContentPlaceHolder>.  
