...
|Namespace|Changes the name of the namespace to the new name, in the declaration, all <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> statements, and all fully qualified names.|  
