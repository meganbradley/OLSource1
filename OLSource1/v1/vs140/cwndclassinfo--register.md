...
## Remarks  
 If you have specified the [DECLARE_WND_CLASS](../vs140/declare_wnd_class.md) (the default in [CWindowImpl](../vs140/cwindowimpl-class.md)) or the [DECLARE_WND_CLASS_EX](../vs140/declare_wnd_class_ex.md) macro, <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> registers a new window class. In this case, the <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> parameter is not used.  
  
 If you have specified the [DECLARE_WND_SUPERCLASS](../vs140/declare_wnd_superclass.md) macro, <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> registers a superclass — a window class that is based on an existing class but uses a different window procedure. The existing window class's window procedure is returned in <CodeContentPlaceHolder>5\</CodeContentPlaceHolder>.  
