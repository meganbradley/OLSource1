...
2.  If necessary, choose drawing colors: In the [Colors palette](../vs140/colors-window--image-editor-for-icons-.md), click the left mouse button to select a foreground color or the right mouse button to select a background color.  
