...
## Return Value  
 If you want to set string data, use the nontemplated versions of <CodeContentPlaceHolder>6\</CodeContentPlaceHolder>. The nontemplated versions of this method return **void\***, which points to the part of the buffer that contains the specified column data. Returns **NULL** if the column is not found.  
