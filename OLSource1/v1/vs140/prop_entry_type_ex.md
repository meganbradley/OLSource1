...
#### Parameters  
 ...
 [in] The CLSID of the associated property page. Use the special value <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> for a property that does not have an associated property page.  
...
## Remarks  
 The <CodeContentPlaceHolder>7\</CodeContentPlaceHolder> macro was insecure and deprecated. It has been replaced with <CodeContentPlaceHolder>8\</CodeContentPlaceHolder>.  
...
## Example  
 The following example groups entries for <CodeContentPlaceHolder>9\</CodeContentPlaceHolder> followed by an entry for <CodeContentPlaceHolder>10\</CodeContentPlaceHolder>. Grouping by dual interface will improve performance.  
