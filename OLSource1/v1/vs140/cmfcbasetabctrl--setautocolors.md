...
## Remarks  
 If you provide a custom array of colors, the default array of colors is ignored. If the parameter <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> is empty, the framework reverts to the default array of colors.  
