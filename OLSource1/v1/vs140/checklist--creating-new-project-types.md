...
5.  Write the code for the following project type components:  
    ...
    -   Objects, or classes derived from <CodeContentPlaceHolder>0\</CodeContentPlaceHolder>, available for Automation.  
...
7.  Display your project in the **Project** tab of the **Add Reference** dialog box by setting <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> as the value for <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>. For more information, see \<xref:Microsoft.VisualStudio.Shell.Interop.__VSHPROPID*> and \<xref:Microsoft.VisualStudio.Shell.Interop.IVsHierarchy.GetProperty*>.  
