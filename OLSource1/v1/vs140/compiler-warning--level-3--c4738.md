...
storing 32-bit float result in memory, possible loss of performance  
 ...
 To resolve this warning and avoid rounding, compile with [/fp:fast](../vs140/-fp--specify-floating-point-behavior-.md) or use <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>s instead of <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>s.  
