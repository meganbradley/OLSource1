...
#### Parameters  
 pFlag  
 [out] Returns <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> if the <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> was linked with the /LTCG linker switch; otherwise, returns <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>.  
