...
#### Parameters  
 ...
 A path, which may be absolute or relative, to the property being loaded asynchronously. <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> uses URLs, not filenames. If you want a <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> object for a file, prepend <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> to the path.  
