...
#### Parameters  
 ...
 Pointer to an <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> structure in which to store a copy of the security descriptor's SACL. If a system **ACL** exists, the method sets <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> to the address of the security descriptor's system **ACL**. If a system **ACL** does not exist, no value is stored.  
