...
## Remarks  
 Implements the behavior of the Win32 message [RB_MAXIMIZEBAND](http://msdn.microsoft.com/library/windows/desktop/bb774500) with <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> set to 1, as described in the [!INCLUDE[winSDK](../vs140/includes/winsdk_md.md)].  
