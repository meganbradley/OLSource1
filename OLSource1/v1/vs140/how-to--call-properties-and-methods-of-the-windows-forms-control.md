...
Because [CWinFormsView::GetControl](../vs140/cwinformsview--getcontrol.md) returns a pointer to \<xref:System.Windows.Forms.Control*?displayProperty=fullName>, and not a pointer to <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>, it is advisable to add a member of the user control type and initialize it in [IView::OnInitialUpdate](../vs140/iview--oninitialupdate.md). Now you can call methods and properties using <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>.  
...
2.  Add the following line to the public overrides section of the <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> class declaration in MFC02View.h.  
