...
unable to open metadata in 'file', file may have been deleted or moved  
 ...
 A metadata file that was referenced in source (with <CodeContentPlaceHolder>0\</CodeContentPlaceHolder>) was not found in the same directory by the compiler back end process as it was by the compiler front end process. See [The #using Directive](../vs140/sharpusing-directive--c---.md) for more information.  
