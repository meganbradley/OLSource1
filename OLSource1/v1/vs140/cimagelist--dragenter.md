...
---
# CImageList::DragEnter
During a drag operation, locks updates to the window specified by <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> and displays the drag image at the position specified by <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>.  
...
## Remarks  
 ...
 If <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> is **NULL**, this function draws the image in the display context associated with the desktop window, and coordinates are relative to the upper left corner of the screen.  
