...
|Topic|Description|  
|-----------|-----------------|  
|[LINQ to XML Overview (C#)](../vs140/linq-to-xml-overview--csharp-.md)|Provides an overview of the LINQ to XML technology.|  
|[LINQ to XML vs. DOM (C#)](../vs140/linq-to-xml-vs.-dom--csharp-.md)|Compares LINQ to XML to the Document Object Model (DOM).|  
