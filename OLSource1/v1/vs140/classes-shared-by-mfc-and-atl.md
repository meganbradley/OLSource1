...
|[CPoint](../vs140/cpoint-class.md)|A class similar to the Windows [POINT](../vs140/point-structure.md) structure that also includes member functions to manipulate <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> and **POINT** structures.|atltypes.h|  
|[CRect](../vs140/crect-class.md)|A class similar to a Windows [RECT](../vs140/rect-structure.md) structure that also includes member functions to manipulate <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> objects and Windows <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> structures.|atltypes.h|  
|[CSimpleStringT](../vs140/csimplestringt-class.md)|Represents a <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> object.|atlsimpstr.h|  
...
|[CStrBufT](../vs140/cstrbuft-class.md)|Provides automatic resource cleanup for <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> and <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> calls on a existing <CodeContentPlaceHolder>6\</CodeContentPlaceHolder> object.|atlsimpstr.h|  
|[CStringData](../vs140/cstringdata-class.md)|Represents the data of a string object.|atlsimpstr.h|  
|[CStringT](../vs140/cstringt-class.md)|Represents a <CodeContentPlaceHolder>7\</CodeContentPlaceHolder> object.|cstringt.h (MFC dependent) atlstr.h (MFC independent)|  
...
|[IAtlStringMgr](../vs140/iatlstringmgr-class.md)|Represents the interface to a <CodeContentPlaceHolder>8\</CodeContentPlaceHolder> memory manager.|atlsimpstr.h|  
