 ...
 *value*  
 [in] The property value of type <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>.  
  
## Remarks  
 With this macro, you can directly specify the property value of type <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>. To set the property to default value defined in ATLDB.H, use [PROPERTY_INFO_ENTRY](../vs140/property_info_entry.md). To set the value, flags, and options for the property, use [PROPERTY_INFO_ENTRY_EX](../vs140/property_info_entry_ex.md).  
