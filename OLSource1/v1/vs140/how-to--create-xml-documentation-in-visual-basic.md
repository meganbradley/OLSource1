...
2.  Type <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> (three single-quotation marks).  
...
3.  Add descriptive information between the appropriate tags.  
    ...
    > [!NOTE]
    >  If you add additional lines within the XML documentation block, each line must begin with <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>.  
