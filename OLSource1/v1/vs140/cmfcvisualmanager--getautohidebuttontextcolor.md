...
ms.topic: "reference"
f1_keywords: 
  - "GetAutoHideButtonTextColor"
  - "CMFCVisualManager.GetAutoHideButtonTextColor"
  - "CMFCVisualManager::GetAutoHideButtonTextColor"
dev_langs: 
  - "C++"
helpviewer_keywords: 
  - "GetAutoHideButtonTextColor method"
...
## Return Value  
 A [COLORREF](http://msdn.microsoft.com/library/windows/desktop/dd183449) parameter that specifies the text color of <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>.  
