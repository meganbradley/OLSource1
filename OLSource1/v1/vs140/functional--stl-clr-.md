...
---
# functional (STL-CLR)
Include the STL/CLR header <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> to define the a number of template classes and related template delegates and functions.  
...
|[binary_delegate_noreturn](../vs140/binary_delegate_noreturn--stl-clr-.md)|Two-argument delegate returning <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>.|  
|[unary_delegate](../vs140/unary_delegate--stl-clr-.md)|One-argument delegate.|  
|[unary_delegate_noreturn](../vs140/unary_delegate_noreturn--stl-clr-.md)|One-argument delegate returning <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>.|  
