...
---
# COleTemplateServer::ConnectTemplate
Connects the document template pointed to by <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> to the underlying [COleObjectFactory](../vs140/coleobjectfactory-class.md) object.  
