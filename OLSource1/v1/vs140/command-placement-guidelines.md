...
-   You can put a command in additional groups by adding a [CommandPlacements Element](../vs140/commandplacements-element.md) section after the definition of the command, and then adding to the <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> a [CommandPlacement Element](../vs140/commandplacement-element.md) for each additional group.  
...
-   Make menus, groups, and commands self-parenting. That is, do not assign a <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> in the definition of the item.  
  
-   Use <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> entries in the <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> section to put menus, groups, and commands in their parent menus and groups.  
  
-   In the <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> section, the entries that populate a given menu or group should be adjacent to one another. This aids readability and makes the <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> rankings easier to determine.  
