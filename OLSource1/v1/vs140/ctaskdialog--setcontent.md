...
---
# CTaskDialog::SetContent
Updates the content of the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>.  
...
## Example  
 [!code[NVC_MFC_CTaskDialog#7](../vs140/codesnippet/CPP/ctaskdialog--setcontent_1.cpp)]  
