...
-   Unlike classes, structs can be instantiated without using a <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> operator.  
  
-   Structs can declare constructors that have parameters.  
  
-   A struct cannot inherit from another struct or class, and it cannot be the base of a class. All structs inherit directly from <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>, which inherits from <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>.  
...
-   [How to: Know the Difference Between Passing a Struct and Passing a Class Reference to a Method](../vs140/9c1313a6-32a8-4ea7-a59f-450f66af628b.md)  
