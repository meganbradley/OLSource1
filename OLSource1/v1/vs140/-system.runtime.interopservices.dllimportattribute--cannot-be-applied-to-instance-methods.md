...
-   If the procedure does not need to apply individually to each instance of its class or structure, then declare it as <CodeContentPlaceHolder>0\</CodeContentPlaceHolder>.  
  
-   If the procedure cannot be <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>, then remove the \<xref:System.Runtime.InteropServices.DllImportAttribute*> from the declaration of this procedure.  
