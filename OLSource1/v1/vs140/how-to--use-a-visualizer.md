...
-   Copy the visualizer DLL to the remote computer before you start the debugging session.  
     ...
     *Visual Studio install path* <CodeContentPlaceHolder>0\</CodeContentPlaceHolder>  
  
     -or-  
  
     <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> *Visual Studio Version* <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>  
