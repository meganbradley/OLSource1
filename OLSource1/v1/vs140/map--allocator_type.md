...
## Remark  
 ...
 For more information on <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>, see the Remarks section of the [map Class](../vs140/map-class.md) topic.  
  
## Example  
 See example for [get_allocator](../vs140/map--get_allocator.md) for an example that uses <CodeContentPlaceHolder>4\</CodeContentPlaceHolder>.  
