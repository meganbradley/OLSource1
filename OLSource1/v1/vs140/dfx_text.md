...
---
# DFX_Text
Transfers <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> data between the field data members of a [CDaoRecordset](../vs140/cdaorecordset-class.md) object and columns of a record on the data source.  
 ...
 *value*  
 ...
 An option that lets you take advantage of MFC's double buffering mechanism for detecting recordset fields that have changed. The default, <CodeContentPlaceHolder>6\</CodeContentPlaceHolder>, uses double buffering. The other possible value is <CodeContentPlaceHolder>7\</CodeContentPlaceHolder>. If you specify this value, MFC does no checking on this field. You must call [SetFieldDirty](../vs140/cdaorecordset--setfielddirty.md) and [SetFieldNull](../vs140/cdaorecordset--setfieldnull.md) yourself.  
...
## Example  
 This example shows several calls to <CodeContentPlaceHolder>8\</CodeContentPlaceHolder>. Notice also the two calls to [CDaoFieldExchange::SetFieldType](../vs140/cdaofieldexchange--setfieldtype.md). You must write the first call to <CodeContentPlaceHolder>9\</CodeContentPlaceHolder> and its **DFX** call. The second call and its associated **DFX** calls are normally written by the code wizard that generated the class.  
