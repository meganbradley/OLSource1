...
## Example  
 The following code copies the directory that <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> specifies into the directory that <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> specifies. This code also provides a standard dialog box that shows the estimated amount of time remaining before the operation finishes.  
