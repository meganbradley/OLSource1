...
PDB 'filename' was not found with 'object/library' or at 'path'; linking object as if no debug info  
 ...
 The linker was unable to find your .pdb file. Copy it into the directory that contains <CodeContentPlaceHolder>0\</CodeContentPlaceHolder>.  
  
 To find the name of the .pdb file associated with the object file:  
  
1.  Extract an object file from the library with [lib](../vs140/lib-reference.md) **/extract:**<CodeContentPlaceHolder>1\</CodeContentPlaceHolder>**.obj** <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>**.lib**.  
  
2.  Check the path to the .pdb file with **dumpbin /section:.debug$T /rawdata** <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>**.obj**.  
