...
##  \<a name="_core_file_manager_drag_and_drop">\</a> File Manager Drag and Drop  
 ...
 To enable file drag and drop in your application, the MFC Application Wizard writes a call to the [CWnd](../vs140/cwnd-class.md) member function [DragAcceptFiles](../vs140/cwnd--dragacceptfiles.md) for your main frame window in your <CodeContentPlaceHolder>4\</CodeContentPlaceHolder>. You can remove that call if you do not want to implement the drag-and-drop feature.  
