 ...
 *statement-list statement*  
 ...
 Identifiers in a compound statement are presumed **auto** unless explicitly declared otherwise with **register**, **static**, or <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>, except functions, which can only be <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>. You can leave off the <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> specifier in function declarations and the function will still be <CodeContentPlaceHolder>4\</CodeContentPlaceHolder>.  
  
 Storage is not allocated and initialization is not permitted if a variable or function is declared in a compound statement with storage class <CodeContentPlaceHolder>5\</CodeContentPlaceHolder>. The declaration refers to an external variable or function defined elsewhere.  
...
<CodeContentPlaceHolder>0\</CodeContentPlaceHolder>  
 In this example, if <CodeContentPlaceHolder>6\</CodeContentPlaceHolder> is greater than 0, all statements inside the compound statement are executed in order.  
