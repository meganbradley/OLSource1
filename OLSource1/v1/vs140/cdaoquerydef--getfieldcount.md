...
## Remarks  
 <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> is useful for looping through all fields in the querydef. For that purpose, use <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> in conjunction with [GetFieldInfo](../vs140/cdaoquerydef--getfieldinfo.md).  
