...
## Remarks  
 The class [CAtlAutoThreadModule](../vs140/catlautothreadmodule-class.md) derives from <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> in order to implement a thread-pooled, apartment-model COM server. It replaces the obsolete class [CComAutoThreadModule](../vs140/ccomautothreadmodule-class.md).  
  
> [!NOTE]
>  This class should not be used in a DLL, as the default <CodeContentPlaceHolder>6\</CodeContentPlaceHolder> value of INFINITE will cause a deadlock when the DLL is unloaded.  
