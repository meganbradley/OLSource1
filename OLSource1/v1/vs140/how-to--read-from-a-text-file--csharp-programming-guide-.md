...
This example reads the contents of a text file by using the static methods [ReadAllText](assetId:///M:System.IO.File.ReadAllText(System.String)?qualifyHint=False&autoUpgrade=True) and [ReadAllLines](assetId:///M:System.IO.File.ReadAllLines(System.String)?qualifyHint=False&autoUpgrade=True) from the <xref:System.IO.File*?displayProperty=fullName> class.  
