...
## Compiling the Code  
 ...
 If you are not using the text files from [How to: Write to a Text File (C# Programming Guide)](../vs140/how-to--write-to-a-text-file--csharp-programming-guide-.md), replace the argument to <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> and <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> with the appropriate path and file name on your computer.  
...
## .NET Framework Security  
 Do not rely on the name of a file to determine the contents of the file. For example, the file <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> might not be a C# source file.  
