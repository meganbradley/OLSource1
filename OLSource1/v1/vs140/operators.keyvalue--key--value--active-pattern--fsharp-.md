...
An active pattern to match values of type <xref:System.Collections.Generic.KeyValuePair`2?qualifyHint=False>`.`  
...
#### Parameters  
 `keyValuePair`  
 Type: <xref:System.Collections.Generic.KeyValuePair`2?qualifyHint=False>`<'Key,                                                                                                              'Value>`  
