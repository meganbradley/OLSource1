...
|||  
|-|-|  
|[_ATL_DEBUG_INTERFACES](../vs140/_atl_debug_interfaces.md)|Writes, to the output window, any interface leaks that are detected when <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> is called.|  
|[_ATL_DEBUG_QI](../vs140/_atl_debug_qi.md)|Writes all calls to <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> to the output window.|  
...
|[ATLENSURE](../vs140/atlensure.md)|Performs parameters validation. Call <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> if needed|  
