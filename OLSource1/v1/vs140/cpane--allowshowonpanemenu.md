...
## Return Value  
 <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> if the pane is displayed in the list; otherwise, <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>. The base implementation always returns <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>.  
