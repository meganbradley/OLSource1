...
## In This Section  
 [Creating a Basic Project System, Part 1](../vs140/creating-a-basic-project-system--part-1.md)  
 Describes how to create a custom project system.  
  
 [Creating a Basic Project System, Part 2](../vs140/creating-a-basic-project-system--part-2.md)  
 Describes how to create a custom project system.  
  
 [Saving Data in Project Files](../vs140/saving-data-in-project-files.md)  
 Explains how add to project (.*proj) files.  
  
 [Verifying Subtypes of a Project at Run Time](../vs140/verifying-subtypes-of-a-project-at-run-time.md)  
 Explains how to verify the subtype of a project at run time.  
  
 [Adding and Removing Property Pages](../vs140/adding-and-removing-property-pages.md)  
 Explains how to customize the property pages for your custom project.  
  
 [Adding an Attribute to a Project Item](../vs140/adding-an-attribute-to-a-project-item.md)  
 ...
 [Managing Universal Windows Projects](../vs140/managing-universal-windows-projects.md)  
