...
## Declaration Syntax  
 ...
 You use the `Widening` or `Narrowing` keyword only on a type conversion operator. The operator symbol is always [CType Function](../vs140/ctype-function--visual-basic-.md) for a type conversion operator.  
