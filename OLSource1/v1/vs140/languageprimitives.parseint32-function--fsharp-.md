...
dev_langs: 
  - "FSharp"
helpviewer_keywords: 
  - "ParseInt32 function [F#]"
  - "LanguagePrimitives.ParseInt32 function [F#]"
ms.assetid: b6cbd33a-517f-479a-a5f2-8eb570634216
...
---
# LanguagePrimitives.ParseInt32 Function (F#)
Parse a 32-bit integer according to the rules used by the overloaded <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> conversion operator when applied to strings.  
