...
3.  Add the following code in the appropriate event handler (for example, in the <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> event handler for a **Print**<CodeContentPlaceHolder>4\</CodeContentPlaceHolder>).  
...
3.  Add the following code in the appropriate event handler (for example, in the <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> event handler for a **Print**<CodeContentPlaceHolder>6\</CodeContentPlaceHolder>).  
...
4.  Add the following code in the appropriate event handler (for example, in the <CodeContentPlaceHolder>7\</CodeContentPlaceHolder> event handler for a **Print**<CodeContentPlaceHolder>8\</CodeContentPlaceHolder>).  
