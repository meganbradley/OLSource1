...
## Return Value  
 The length of the string in bytes, excluding the terminating null character. If <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> does not specify a valid index, the return value is **CB_ERR**.  
