...
A type name occurs where an expression is required. An expression must consist of some combination of variables, constants, literals, properties, and <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> procedure calls.  
