...
2.  Add <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> attributes to every <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> element. Set the values of the <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> attributes to $fileinputname$.*FileExtension*, where *FileExtension* is the file name extension of the file that is being included in the template. For example:  
