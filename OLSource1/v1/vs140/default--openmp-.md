...
## Remarks  
 <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>, which is in effect if the <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> clause is not specified, means that any variable in a parallel region will be treated as if it were specified with the [shared](../vs140/shared--openmp-.md) clause. <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> means that any variables used in a parallel region that are not scoped with the [private](../vs140/private--openmp-.md), [shared](../vs140/shared--openmp-.md), [reduction](../vs140/reduction.md), [firstprivate](../vs140/firstprivate.md), or [lastprivate](../vs140/lastprivate.md) clause will cause a compiler error.  
  
 <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> applies to the following directives:  
...
## Example  
 See [private](../vs140/private--openmp-.md) for an example of using <CodeContentPlaceHolder>5\</CodeContentPlaceHolder>.  
