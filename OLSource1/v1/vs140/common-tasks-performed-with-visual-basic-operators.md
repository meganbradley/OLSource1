...
|-|-|  
|To|See|  
|Add one numeric value to another|[+ Operator (Visual Basic)](../vs140/--operator--visual-basic-.md)|  
...
|Divide one numeric value into another|[/ Operator (Visual Basic)](../vs140/--operator--visual-basic-3.md)|  
|Find the quotient of one numeric value divided by another (without the remainder)|[\ Operator](../vs140/--operator--visual-basic-2.md)|  
|Find the remainder of one numeric value divided by another (without the quotient)|[Mod Operator (Visual Basic)](../vs140/mod-operator--visual-basic-.md)|  
...
|-|-|  
|To|See|  
|Determine whether two values are equal|<CodeContentPlaceHolder>0\</CodeContentPlaceHolder> Operator ([Comparison Operators in Visual Basic](../vs140/comparison-operators-in-visual-basic.md))|  
|Determine whether two values are unequal|<CodeContentPlaceHolder>1\</CodeContentPlaceHolder> Operator ([Comparison Operators in Visual Basic](../vs140/comparison-operators-in-visual-basic.md))|  
|Determine whether one value is less than another|<CodeContentPlaceHolder>2\</CodeContentPlaceHolder> Operator ([Comparison Operators in Visual Basic](../vs140/comparison-operators-in-visual-basic.md))|  
|Determine whether one value is greater than another|<CodeContentPlaceHolder>3\</CodeContentPlaceHolder> Operator ([Comparison Operators in Visual Basic](../vs140/comparison-operators-in-visual-basic.md))|  
|Determine whether one value is less than or equal to another|<CodeContentPlaceHolder>4\</CodeContentPlaceHolder> Operator ([Comparison Operators in Visual Basic](../vs140/comparison-operators-in-visual-basic.md))|  
|Determine whether one value is greater than or equal to another|<CodeContentPlaceHolder>5\</CodeContentPlaceHolder> Operator ([Comparison Operators in Visual Basic](../vs140/comparison-operators-in-visual-basic.md))|  
...
|Determine whether an object is of a specific type|[TypeOf Operator (Visual Basic)](../vs140/typeof-operator--visual-basic-.md)|  
...
|-|-|  
|To|See|  
|Join multiple strings into a single string|<CodeContentPlaceHolder>6\</CodeContentPlaceHolder> Operator ([Concatenation Operators in Visual Basic](../vs140/concatenation-operators-in-visual-basic.md))|  
|Join numeric values with string values|<CodeContentPlaceHolder>7\</CodeContentPlaceHolder> Operator ([Concatenation Operators in Visual Basic](../vs140/concatenation-operators-in-visual-basic.md))|  
