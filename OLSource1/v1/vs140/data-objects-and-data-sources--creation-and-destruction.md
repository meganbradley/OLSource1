...
3.  Depending on the design of the program, the application creates either a <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> object or an object from a class derived from <CodeContentPlaceHolder>4\</CodeContentPlaceHolder>.  
  
4.  The selected data is inserted into the data source by calling one of the functions in the <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> or <CodeContentPlaceHolder>6\</CodeContentPlaceHolder> groups.  
  
5.  The application calls the <CodeContentPlaceHolder>7\</CodeContentPlaceHolder> member function (or the <CodeContentPlaceHolder>8\</CodeContentPlaceHolder> member function if this is a drag-and-drop operation) belonging to the object created in step 3.  
  
6.  If this is a **Cut** operation or <CodeContentPlaceHolder>9\</CodeContentPlaceHolder> returns <CodeContentPlaceHolder>10\</CodeContentPlaceHolder>, the data selected in step 1 is deleted from the document.  
  
 This scenario is implemented by the MFC OLE samples [OCLIENT](../vs140/visual-c---samples.md) and [HIERSVR](../vs140/visual-c---samples.md). Look at the source for each application's <CodeContentPlaceHolder>11\</CodeContentPlaceHolder>-derived class for all but the <CodeContentPlaceHolder>12\</CodeContentPlaceHolder> and <CodeContentPlaceHolder>13\</CodeContentPlaceHolder> functions. These two functions are in either the <CodeContentPlaceHolder>14\</CodeContentPlaceHolder> or <CodeContentPlaceHolder>15\</CodeContentPlaceHolder>-derived class implementations. These sample programs provide a good example of how to implement these concepts.  
  
 One other situation in which you might want to create a <CodeContentPlaceHolder>16\</CodeContentPlaceHolder> object occurs if you are modifying the default behavior of a drag-and-drop operation. For more information, see the [Drag and Drop: Customizing](../vs140/drag-and-drop--customizing.md) article.  
...
##  \<a name="_core_destroying_data_sources">\</a> Destroying Data Sources  
 ...
 [!code[NVC_MFCListView#1](../vs140/codesnippet/CPP/data-objects-and-data-sources--creation-and-destruction_1.cpp)]  
