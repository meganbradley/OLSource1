...
---
# CRect::Width
Calculates the width of <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> by subtracting the left value from the right value.  
  
## Syntax  
  
<CodeContentPlaceHolder>0\</CodeContentPlaceHolder>  
## Return Value  
 The width of <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>.  
