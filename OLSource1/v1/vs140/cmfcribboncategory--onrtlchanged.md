...
#### Parameters  
 ...
 <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> if the layout is right-to-left; <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> if the layout is left-to-right.  
