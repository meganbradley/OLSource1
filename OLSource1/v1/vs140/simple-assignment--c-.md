...
<CodeContentPlaceHolder>0\</CodeContentPlaceHolder>  
 In this example, the value of <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> is converted to type **double** and assigned to <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>.  
