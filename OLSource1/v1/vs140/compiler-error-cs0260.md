...
Missing partial modifier on declaration of type 'type'; another partial declaration of this type exists  
 ...
 This error indicates that you have declared multiple classes that have the same name. In addition, at least one but not all of the declarations contains the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> modifier. If you want to define a class in several parts, you must declare each part by using the keyword <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>.  
