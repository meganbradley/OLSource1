...
If you cannot create a custom Start Page by using the Start Page project template, as described in [Start Pages](../vs140/creating-your-own-start-page.md), you can manually create one by following the steps in this document.  
...
2.  Add a reference to <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>.  
...
4.  Remove the <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> declaration from the top-level element. This makes the XAML content compatible with the Visual Studio tool window that hosts the start page.  
  
5.  Add the following namespace declarations to the top-level \<UserControl> element.  
  
<CodeContentPlaceHolder>0\</CodeContentPlaceHolder>  
     These namespaces let you access Visual Studio commands, controls, and UI settings. For more information, see [Adding Visual Studio Commands to a Start Page](../vs140/adding-visual-studio-commands-to-a-start-page.md).  
...
## See Also  
 ...
 [Walkthrough: Saving User Settings on a Start Page](../vs140/walkthrough--saving-user-settings-on-a-start-page.md)   
