...
1.  When you create a new project, select the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> target. Use the <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> target until your program is fully debugged and you are ready to build a <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> target. The compiler does not optimize the <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> target.  
  
2.  Select the project in Solution Explorer.  
  
3.  On the **View** menu, click **Property Pages**.  
  
4.  In the **Property Pages** dialog box, make sure <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> is selected in the **Configuration** drop-down list.  
  
5.  In the folder view on the left, select the **C/C++** folder.  
  
6.  Under the **C++** folder, select <CodeContentPlaceHolder>6\</CodeContentPlaceHolder>.  
  
7.  In the properties list on the right, find <CodeContentPlaceHolder>7\</CodeContentPlaceHolder>. The setting next to it probably says <CodeContentPlaceHolder>8\</CodeContentPlaceHolder>[/Od](../vs140/-od--disable--debug--.md)<CodeContentPlaceHolder>9\</CodeContentPlaceHolder>. Choose one of the other options (<CodeContentPlaceHolder>10\</CodeContentPlaceHolder>[/O1](../vs140/-o1---o2--minimize-size--maximize-speed-.md)<CodeContentPlaceHolder>11\</CodeContentPlaceHolder>, <CodeContentPlaceHolder>12\</CodeContentPlaceHolder>[/O2](../vs140/-o1---o2--minimize-size--maximize-speed-.md)<CodeContentPlaceHolder>13\</CodeContentPlaceHolder>, <CodeContentPlaceHolder>14\</CodeContentPlaceHolder>[/Ox](../vs140/-ox--full-optimization-.md)<CodeContentPlaceHolder>15\</CodeContentPlaceHolder>, or <CodeContentPlaceHolder>16\</CodeContentPlaceHolder>).  
  
8.  If you chose the <CodeContentPlaceHolder>17\</CodeContentPlaceHolder> option for <CodeContentPlaceHolder>18\</CodeContentPlaceHolder>, you can now set options for any of the other properties shown in the properties list.  
  
9. Select the Configuation Properties, C/C++, Command Line node of the project properties page, and add <CodeContentPlaceHolder>19\</CodeContentPlaceHolder>[/Zo](../vs140/-zo--enhance-optimized-debugging-.md)<CodeContentPlaceHolder>20\</CodeContentPlaceHolder> to the **Additional Options** text box.  
  
    > [!WARNING]
    >  <CodeContentPlaceHolder>21\</CodeContentPlaceHolder> requires Visual Studio 2013 Update 3 or a later version.  
    >   
    >  Adding <CodeContentPlaceHolder>22\</CodeContentPlaceHolder> will disable [Edit and Continue](../vs140/edit-and-continue--visual-csharp-.md).  
