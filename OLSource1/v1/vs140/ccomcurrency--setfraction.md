...
---
# CComCurrency::SetFraction
Call this method to set the fractional component of a <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> object.  
...
#### Parameters  
 *nFraction*  
 The value to be assigned to the fractional component of the <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> data member. The sign of the fractional component must the same as the integer component, and the value must be in range -9999 (**CY_MIN_FRACTION**) to +9999 (**CY_MAX_FRACTION**).  
