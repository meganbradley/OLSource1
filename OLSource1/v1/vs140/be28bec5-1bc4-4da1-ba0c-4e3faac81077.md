...
<CodeContentPlaceHolder>0\</CodeContentPlaceHolder> statements are restricted to jumps within the current block of code.  
  
 **Error ID:** BC30757  
  
### To correct this error  
  
-   Restructure your code so that the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> statement and the label are both inside the <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> block.  
