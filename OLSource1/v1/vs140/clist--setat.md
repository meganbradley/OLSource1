...
## Remarks  
 It is not the same as an index, and you cannot operate on a **POSITION** value yourself. <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> writes the element to the specified position in the list.  
