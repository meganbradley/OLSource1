...
A combination of flags, which is passed by the framework to the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> method, when a tab (MDI child) is being registered with Windows 7 taskbar tabs.  
