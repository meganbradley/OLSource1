...
-   In the .vsz file, specify any custom parameters necessary for your wizard to work. See [The .vsz File (Project Control)](../vs140/.vsz-file--project-control-.md) and [Predefined Custom Wizard Symbols](../vs140/custom-parameters-in-the-wizard-.vsz-file.md) for more information.  
...
-   In the section marked <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> in the HTML files, add JScript function calls and access the Visual Studio Object Model to customize the behavior of your wizard. You must call these functions using <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>, as follows:  
