...
This example defines and calls the <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> function in user32.dll and then passes a string to it.  
...
-   The *name* or *dllName* is <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>. (\<xref:System.ArgumentNullException*>)  
  
-   The containing type has been previously created using <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>. (\<xref:System.InvalidOperationException*>)  
