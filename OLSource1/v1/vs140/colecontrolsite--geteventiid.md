...
## Return Value  
 Nonzero if successful, otherwise 0. If successful, <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> contains the interface ID for the control's default event interface.  
