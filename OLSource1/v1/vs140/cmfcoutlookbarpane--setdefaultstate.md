...
## Remarks  
 This method restores the Outlook bar buttons to the original set. This method is like <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>, except that it does not trigger a redraw of the Outlook bar pane.  
