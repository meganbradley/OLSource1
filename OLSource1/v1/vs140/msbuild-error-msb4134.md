...
**MSB4134: DefaultToolsVersion cannot be set after a project has been loaded into the Engine.**  
 ...
 This error occurs when an attempt to change the value of <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> is made after [!INCLUDE[vstecmsbuild](../vs140/includes/vstecmsbuild_md.md)] already has built a project.  
  
### To correct this error  
  
-   Change the value of <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> before you build a project.  
