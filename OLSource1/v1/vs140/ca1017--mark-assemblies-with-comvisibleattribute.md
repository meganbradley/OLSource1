...
## How to Fix Violations  
 To fix a violation of this rule, add the attribute to the assembly. If you do not want the assembly to be visible to COM clients, apply the attribute and set its value to <CodeContentPlaceHolder>0\</CodeContentPlaceHolder>.  
  
## When to Suppress Warnings  
 Do not suppress a warning from this rule. If you want the assembly to be visible, apply the attribute and set its value to <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>.  
...
## Example  
 ...
 [!code[FxCop.Design.AssembliesCom#1](../vs140/codesnippet/CPP/ca1017--mark-assemblies-with-comvisibleattribute_1.cpp)]
[!code[FxCop.Design.AssembliesCom#1](../vs140/codesnippet/VisualBasic/ca1017--mark-assemblies-with-comvisibleattribute_1.vb)]
[!code[FxCop.Design.AssembliesCom#1](../vs140/codesnippet/CSharp/ca1017--mark-assemblies-with-comvisibleattribute_1.cs)]  
