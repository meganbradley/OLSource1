...
### Description  
 The following example shows a type with inconsistent definitions of equality. <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> changes the meaning of equality by providing a custom implementation of the equality operator, but does not override \<xref:System.Object.Equals*> so that it behaves identically.  
...
## Example  
 The following code tests the behavior of <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>.  
...
## Example  
 The following code tests the behavior of <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>.  
