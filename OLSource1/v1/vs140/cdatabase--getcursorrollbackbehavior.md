...
## Remarks  
 The following table lists the possible return values for <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> and the corresponding effect on the open recordset.  
  
|Return value|Effect on CRecordset objects|  
|------------------|----------------------------------|  
|<CodeContentPlaceHolder>2\</CodeContentPlaceHolder>|Call <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> immediately following the transaction rollback.|  
|<CodeContentPlaceHolder>4\</CodeContentPlaceHolder>|Call <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> immediately following the transaction rollback.|  
|<CodeContentPlaceHolder>6\</CodeContentPlaceHolder>|Proceed normally with <CodeContentPlaceHolder>7\</CodeContentPlaceHolder> operations.|  
