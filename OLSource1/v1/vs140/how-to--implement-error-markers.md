...
2.  Create a marker of the type <CodeContentPlaceHolder>0\</CodeContentPlaceHolder>. For more information, see [How to: Add Standard Text Markers](../vs140/how-to--add-standard-text-markers.md).  
