...
## Remarks  
 Create the command as a null-terminated string. <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> does not return data records. If you want to operate on records, use a recordset object instead.  
