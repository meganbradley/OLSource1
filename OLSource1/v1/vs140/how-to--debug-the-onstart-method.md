...
1.  Add a call to \<xref:System.Diagnostics.Debugger.Launch*> at the beginning of the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>method.  
  
<CodeContentPlaceHolder>0\</CodeContentPlaceHolder>  
2.  Start the service (you can use <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>, or start it in the **Services** window).  
...
5.  A new instance of Visual Studio starts, and execution is stopped at the <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> method.  
