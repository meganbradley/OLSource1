...
The standard overloaded skip range operator, for example, <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> for lists, <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> for sequences.  
