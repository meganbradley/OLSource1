...
## Remarks  
 ...
 Any ODBC data source, such as an attached table, can have a local cache. To create the cache, open a recordset object from the remote data source, call the <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> and <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> member functions, and then call the <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> member function or step through the records by using one of the Move operations. The <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> parameter of the <CodeContentPlaceHolder>6\</CodeContentPlaceHolder> member function can be based on the number of records your application can work with at one time. For example, if you are using a recordset as the source of the data to be displayed on screen, you could pass the <CodeContentPlaceHolder>7\</CodeContentPlaceHolder> <CodeContentPlaceHolder>8\</CodeContentPlaceHolder> parameter as 20 to display 20 records at one time.  
