...
## AppDomain.CurrentDomain.FriendlyName Differences  
 <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> returns different results depending on whether the hosting process is enabled. If you call <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> with the hosting process enabled, it returns *app_name*<CodeContentPlaceHolder>2\</CodeContentPlaceHolder>. If you call it the hosting process disabled, it returns *app_name*<CodeContentPlaceHolder>3\</CodeContentPlaceHolder>.  
  
## Assembly.GetCallingAssembly().FullName Differences  
 <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> returns different results depending on whether the hosting process is enabled. If you call <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> with the hosting process enabled, it returns <CodeContentPlaceHolder>6\</CodeContentPlaceHolder>. If you call <CodeContentPlaceHolder>7\</CodeContentPlaceHolder> with the hosting process disabled, it returns the application name.  
