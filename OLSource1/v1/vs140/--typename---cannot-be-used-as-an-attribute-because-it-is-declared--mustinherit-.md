...
Custom attribute classes cannot be declared as <CodeContentPlaceHolder>0\</CodeContentPlaceHolder>.  
  
 **Error ID:** BC31506  
  
### To correct this error  
  
-   Remove the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> modifier from custom attributes.  
