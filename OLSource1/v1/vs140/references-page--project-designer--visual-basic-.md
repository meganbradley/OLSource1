 ...
 **Imported namespaces**  
 ...
 You can create aliases for user-imported namespaces. To do this, enter the alias and the namespace in the format *alias*=*namespace*. This is useful if you are using long namespaces, for example: <CodeContentPlaceHolder>0\</CodeContentPlaceHolder>.  
...
-   Aliased imports, such as <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>.  
  
-   XML namespaces, such as <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>.  
  
## See Also  
 [NIB How to: Add or Remove References By Using the Add Reference Dialog Box](assetId:///3bd75d61-f00c-47c0-86a2-dd1f20e231c9)   
 [How to: Add or Remove Imported Namespaces](../vs140/how-to--add-or-remove-imported-namespaces--visual-basic-.md)   
