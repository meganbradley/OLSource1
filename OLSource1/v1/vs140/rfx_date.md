...
---
# RFX_Date
Transfers <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> or **TIMESTAMP_STRUCT** data between the field data members of a <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> object and the columns of a record on the data source of ODBC type **SQL_DATE**, **SQL_TIME**, or **SQL_TIMESTAMP**.  
