...
You declare a variable of the [Object Data Type](../vs140/object-data-type.md) by specifying <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> in a [Dim Statement (Visual Basic)](../vs140/dim-statement--visual-basic-.md). You assign an object to such a variable by placing the object after the equal sign (<CodeContentPlaceHolder>3\</CodeContentPlaceHolder>) in an assignment statement or initialization clause.  
  
## Example  
 The following example declares an <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> variable and assigns the current instance to it.  
...
-   A class, structure, or module in which to put the <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> statement.  
