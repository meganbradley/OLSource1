...
## Opening a transaction  
 The most convenient method of managing a transaction is with a <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> statement enclosed in a <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> statement:  
  
<CodeContentPlaceHolder>0\</CodeContentPlaceHolder>  
 If an exception that prevents the final <CodeContentPlaceHolder>6\</CodeContentPlaceHolder> occurs during the changes, the Store will be reset to its previous state. This helps you make sure that errors do not leave the model in an inconsistent state.  
 ...
 To make your changes permanent, you should <CodeContentPlaceHolder>7\</CodeContentPlaceHolder> the transaction before it is disposed. If an exception occurs that is not caught inside the transaction, the Store will be reset to its state before the changes.  
...
## Rules Fire at the End of a Transaction  
 ...
 You can define your own rules. For more information about rules, see [Responding to Changes in the Model](../vs140/responding-to-and-propagating-changes.md).  
