...
|\<xref:Microsoft.VisualStudio.TextManager.Interop.IVsTextView*>|Provides the basic methods for managing and accessing the view. <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> is not thread safe.|  
