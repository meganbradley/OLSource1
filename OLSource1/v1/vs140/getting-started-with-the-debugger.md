...
<CodeContentPlaceHolder>1\</CodeContentPlaceHolder>  
 Set a breakpoint on the <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> call in the Main method and start debugging. When execution breaks, click **Debug / Step Into** (or **Step Into** on the toolbar, or **F11**). Execution breaks again at the first curly brace in Method1():  
  
 ![Stepping into code](../vs140/media/getstartedstepinto.png "GetStartedStepInto")  
  
 Stop debugging and start again, and when execution breaks at the breakpoint, click **Debug / Step Over** (or **Step Over** on the toolbar, or **F10**). Execution breaks again at <CodeContentPlaceHolder>6\</CodeContentPlaceHolder>.  
