...
## Remarks  
 ...
 File translation mode specifies either `binary` or `text` translation for [_open](../vs140/_open--_wopen.md) and [_pipe](../vs140/_pipe.md) I/O operations. For more information, see [_fmode](../vs140/_fmode.md).  
