...
#### Parameters  
 ...
 [out, retval] Returns <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> if the section cannot be paged out; otherwise, returns <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>.  
