...
## Remarks  
 The <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> message is sent by the list box when it receives a <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> message, but only if the list box meets all of these criteria:  
