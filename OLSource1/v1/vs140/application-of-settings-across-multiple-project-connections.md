...
## New Capability Flag  
 <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> Function sets the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> flag to indicate that a batch operation is in progress  
...
-   [SccEndBatch Function](../vs140/sccendbatch-function.md)  
 ...
 The <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> function starts a group of source control operations. <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> closes the group. The groups may not be nested.  
