...
|Element|Description|  
|-------------|-----------------|  
|<CodeContentPlaceHolder>1\</CodeContentPlaceHolder>|Contains child elements that enumerate the file types in the VSIX package.|  
  
### Attributes  
  
|Attribute|Description|  
|---------------|-----------------|  
|<CodeContentPlaceHolder>2\</CodeContentPlaceHolder>|(Required.) The location of the schema used for this [Content_Types].xml file.|  
...
### Child Elements  
 The <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> element can contain any number of <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> elements.  
  
|Element|Description|  
|-------------|-----------------|  
|<CodeContentPlaceHolder>5\</CodeContentPlaceHolder>|Describes a content type in the VSIX package. Every file type in the package must have its own <CodeContentPlaceHolder>6\</CodeContentPlaceHolder> element.|  
  
### Attributes  
  
|Attribute|Description|  
|---------------|-----------------|  
|<CodeContentPlaceHolder>7\</CodeContentPlaceHolder>|The file name extension of a file in the VSIX package.|  
|<CodeContentPlaceHolder>8\</CodeContentPlaceHolder>|Describes the kind of content that is associated with the file name extension.|  
  
### {Attribute name} Attribute  
 Visual Studio recognizes the following <CodeContentPlaceHolder>9\</CodeContentPlaceHolder> values for the associated <CodeContentPlaceHolder>10\</CodeContentPlaceHolder> types.  
