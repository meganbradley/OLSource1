...
|Page|REG_SZ|*GUID*|The GUID of the property page to request from the VSPackage by calling the [GetPropertyPage](assetId:///M:Microsoft.VisualStudio.Shell.Interop.IVsPackage.GetPropertyPage(System.Guid@,Microsoft.VisualStudio.Shell.Interop.VSPROPSHEETPAGE[])?qualifyHint=False&autoUpgrade=True) method. If this registry entry is not present, the registry key describes a node, not a page.|  
