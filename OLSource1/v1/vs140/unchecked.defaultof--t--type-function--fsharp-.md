...
apitype: "Assembly"
f1_keywords: 
  - "Microsoft.FSharp.Core.Operators.Unchecked.DefaultOf``1"
dev_langs: 
  - "FSharp"
helpviewer_keywords: 
  - "Unchecked.defaultof type function [F#]"
  - "defaultof type function [F#]"
...
Generate a default value for any type. This is <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> for reference types. For structures, this is structure value where all fields have the default value. This function is unsafe in the sense that some F# values do not have proper <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> values.  
