...
apitype: "Assembly"
f1_keywords: 
  - "Microsoft.FSharp.Core.LanguagePrimitives.HashCompare.GenericGreaterThanIntrinsic``1"
dev_langs: 
  - "FSharp"
helpviewer_keywords: 
  - "GenericGreaterThanIntrinsic function [F#]"
...
## Return Value  
 <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> if the first object is greater than the second; otherwise, <CodeContentPlaceHolder>6\</CodeContentPlaceHolder>.  
