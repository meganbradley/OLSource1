...
## Unicode Characters  
 ...
 You can use methods such as <xref:System.Char.IsDigit?qualifyHint=False> and <xref:System.Char.IsPunctuation?qualifyHint=False> on an individual character in a `String` variable to determine its Unicode classification.  
...
## String Manipulations  
 ...
 You can manipulate the contents of a `String` variable by using a variety of string functions. The following example illustrates the <xref:Microsoft.VisualBasic.Strings.Left?qualifyHint=False> function  
...
```  
 ...
 A string created by another component might be padded with leading or trailing spaces. If you receive such a string, you can use the <xref:Microsoft.VisualBasic.Strings.Trim?qualifyHint=False>, <xref:Microsoft.VisualBasic.Strings.LTrim?qualifyHint=False>, and <xref:Microsoft.VisualBasic.Strings.RTrim?qualifyHint=False> functions to remove these spaces.  
...
-   **Framework Type.** The corresponding type in the .NET Framework is the <xref:System.String?qualifyHint=True> class.  
  
## See Also  
 <xref:System.String?qualifyHint=True>   
