...
1.  Declare the object variable to be of the [Object Data Type](../vs140/object-data-type.md). (Declaring a variable as `Object` is the same as declaring it as <xref:System.Object*?displayProperty=fullName>.)  
