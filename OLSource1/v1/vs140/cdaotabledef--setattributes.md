...
---
# CDaoTableDef::SetAttributes
Sets a value that indicates one or more characteristics of a <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> object.  
...
#### Parameters  
 ...
 Characteristics of the table represented by the <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> object and can be a sum of these constants:  
