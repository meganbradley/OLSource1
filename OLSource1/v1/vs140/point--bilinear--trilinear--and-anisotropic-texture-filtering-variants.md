...
## Remarks  
 These variants override the sampler states on calls to <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> in which the application-provided sampler's filter mode is one of these:  
...
-   <CodeContentPlaceHolder>13\</CodeContentPlaceHolder>  
 ...
 In the **Point Texture Filtering** variant, the application-provided filter mode is replaced with <CodeContentPlaceHolder>14\</CodeContentPlaceHolder>; in the **Bilinear Texture Filtering** variant, it's replaced with <CodeContentPlaceHolder>15\</CodeContentPlaceHolder>; and in the **Trilinear Texture Filtering** variant, it's replaced with <CodeContentPlaceHolder>16\</CodeContentPlaceHolder>.  
  
 In the **Anisotropic Texture Filtering** variant, the application-provided filter mode is replaced with <CodeContentPlaceHolder>17\</CodeContentPlaceHolder>, and the Max Anisotropy is set to 16.  
