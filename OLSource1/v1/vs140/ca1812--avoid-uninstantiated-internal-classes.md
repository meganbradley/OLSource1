...
-   Types that cannot be instantiated and that define <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> (<CodeContentPlaceHolder>2\</CodeContentPlaceHolder> in Visual Basic) methods only.  
  
 If you apply \<xref:System.Runtime.CompilerServices.InternalsVisibleToAttribute*?displayProperty=fullName> to the assembly that is being analyzed, this rule will not occur on any constructors that are marked as <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> because you cannot tell whether a field is being used by another <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> assembly.  
  
 Even though you cannot work around this limitation in [!INCLUDE[vsprvs](../vs140/includes/vsprvs_md.md)] Code Analysis, the external stand-alone FxCop will occur on internal constructors if every <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> assembly is present in the analysis.  
...
-   The <CodeContentPlaceHolder>6\</CodeContentPlaceHolder> (<CodeContentPlaceHolder>7\</CodeContentPlaceHolder> in Visual Basic) modifier for types that target [!INCLUDE[dnprdnlong](../vs140/includes/dnprdnlong_md.md)].  
...
-   The class is created automatically by the runtime or [!INCLUDE[vstecasp](../vs140/includes/vstecasp_md.md)]. For example, classes that implement \<xref:System.Configuration.IConfigurationSectionHandler*?displayProperty=fullName> or \<xref:System.Web.IHttpHandler*?displayProperty=fullName>.  
