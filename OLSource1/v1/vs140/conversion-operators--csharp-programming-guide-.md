...
-   Conversions declared as <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> occur automatically when it is required.  
  
-   Conversions declared as <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> require a cast to be called.  
  
-   All conversions must be declared as <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>.  
