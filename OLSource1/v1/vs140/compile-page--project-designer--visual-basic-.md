 ...
 **Option compare**  
 ...
 If a source code file contains an [Option Compare Statement](../vs140/option-compare-statement.md), the `Binary` or `Text` value in the statement overrides the **Option Compare** setting on the **Compile page**.  
