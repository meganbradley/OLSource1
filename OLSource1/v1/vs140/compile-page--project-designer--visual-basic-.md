 ...
 **Option explicit**  
 ...
 If a source code file contains an [Option Explicit Statement (Visual Basic)](../vs140/option-explicit-statement--visual-basic-.md), the <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> or <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> value in the statement overrides the **Option Explicit** setting on the **Compile page**.  
 ...
 Setting **Option Explicit** to <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> is generally not a good practice. You could misspell a variable name in one or more locations, which would cause unexpected results when the program is run.  
...
-   Implicit typing that results in an <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> type  
  
 Implicit narrowing conversion errors occur when there is an implicit data type conversion that is a narrowing conversion. For more information, see [Option Strict Statement](../vs140/option-strict-statement.md), [Implicit and Explicit Conversions (Visual Basic)](../vs140/implicit-and-explicit-conversions--visual-basic-.md), and [Widening and Narrowing Conversions (Visual Basic)](../vs140/widening-and-narrowing-conversions--visual-basic-.md).  
  
 An object is late bound when it is assigned to a property or method of a variable that is declared to be of type <CodeContentPlaceHolder>4\</CodeContentPlaceHolder>. For more information, see [Option Strict Statement](../vs140/option-strict-statement.md) and [Early and Late Binding (Visual Basic)](../vs140/early-and-late-binding--visual-basic-.md).  
  
 Implicit object type errors occur when an appropriate type cannot be inferred for a declared variable, so a type of <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> is inferred. This primarily occurs when you use a <CodeContentPlaceHolder>6\</CodeContentPlaceHolder> statement to declare a variable without using an <CodeContentPlaceHolder>7\</CodeContentPlaceHolder> clause, and <CodeContentPlaceHolder>8\</CodeContentPlaceHolder> is off. For more information, see [Option Strict Statement](../vs140/option-strict-statement.md), [Option Infer Statement](../vs140/option-infer-statement.md), and the [Visual Basic Language Specification](../vs140/visual-basic-language-specification.md).  
  
 The **Option Strict** setting corresponds to the [/optionstrict](../vs140/-optionstrict.md) compiler option.  
  
 If a source code file contains an [Option Strict Statement](../vs140/option-strict-statement.md), the <CodeContentPlaceHolder>9\</CodeContentPlaceHolder> or <CodeContentPlaceHolder>10\</CodeContentPlaceHolder> value in the statement overrides the **Option Strict** setting on the **Compile page**.  
 ...
 **Option Strict Individual Warnings.** The **Warning configurations** section of the **Compile page** has settings that correspond to the three conditions that cause a compile-time error when <CodeContentPlaceHolder>11\</CodeContentPlaceHolder> is on. Following are these settings:  
...
-   **Implicit type; object assumed**  
 ...
 You can individually change each warning configuration setting to **None**, **Warning**, or **Error**. If all three warning configuration settings are set to **Error**, <CodeContentPlaceHolder>12\</CodeContentPlaceHolder> appears in the <CodeContentPlaceHolder>13\</CodeContentPlaceHolder> box. If all three are set to **None**, <CodeContentPlaceHolder>14\</CodeContentPlaceHolder> appears in this box. For any other combination of these settings, **(custom)** appears.  
 ...
 **Option compare**  
 ...
 If a source code file contains an [Option Compare Statement](../vs140/option-compare-statement.md), the <CodeContentPlaceHolder>15\</CodeContentPlaceHolder> or <CodeContentPlaceHolder>16\</CodeContentPlaceHolder> value in the statement overrides the **Option Compare** setting on the **Compile page**.  
 ...
 **Option infer**  
 ...
 If a source code file contains an [Option Infer Statement](../vs140/option-infer-statement.md), the <CodeContentPlaceHolder>17\</CodeContentPlaceHolder> or <CodeContentPlaceHolder>18\</CodeContentPlaceHolder> value in the statement overrides the **Option Infer** setting on the **Compile page**.  
 ...
 **Target CPU**  
 ...
 For more information, see [/platform (Visual Basic)](../vs140/-platform--visual-basic-.md).  
 ...
 **Advanced Compile Options**  
 Click this button to access the **AdvancedCompiler Settings** dialog box. Use the **AdvancedCompiler Settings** dialog box to specify a project's advanced build configuration properties. This dialog box applies to Visual Basic projects only. For more information, see [Advanced Compiler Settings Dialog Box (Visual Basic)](../vs140/advanced-compiler-settings-dialog-box--visual-basic-.md).  
