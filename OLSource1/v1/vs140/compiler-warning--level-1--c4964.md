...
No optimization options were specified; profile info will not be collected  
 ...
 [/GL](../vs140/-gl--whole-program-optimization-.md) and [/LTCG](../vs140/-ltcg--link-time-code-generation-.md) were specified, but no optimizations were requested, so no .pgc files will be generated and, therefore, no profile-guided optimizations will be possible.  
