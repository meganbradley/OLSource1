...
-   For the [!INCLUDE[dnprdnlong](../vs140/includes/dnprdnlong_md.md)], use either the `/keyfile` or `/keycontainer` compiler option [(/KEYFILE](../vs140/-keyfile--specify-key-or-key-pair-to-sign-an-assembly-.md) or [/KEYCONTAINER](../vs140/-keycontainer--specify-a-key-container-to-sign-an-assembly-.md) linker option in C++).  
