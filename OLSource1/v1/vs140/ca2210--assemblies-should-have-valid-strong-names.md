...
-   Use the Assembly Linker tool (Al.exe) provided by the [!INCLUDE[dnprdnshort](../vs140/includes/dnprdnshort_md.md)] SDK.  
  
-   For the [!INCLUDE[dnprdnshort](../vs140/includes/dnprdnshort_md.md)] v1.0 or v1.1, use either the \<xref:System.Reflection.AssemblyKeyFileAttribute*?displayProperty=fullName> or \<xref:System.Reflection.AssemblyKeyNameAttribute*?displayProperty=fullName> attribute.  
  
-   For the [!INCLUDE[dnprdnlong](../vs140/includes/dnprdnlong_md.md)], use either the <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> or <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> compiler option [(/KEYFILE](../vs140/-keyfile--specify-key-or-key-pair-to-sign-an-assembly-.md) or [/KEYCONTAINER](../vs140/-keycontainer--specify-a-key-container-to-sign-an-assembly-.md) linker option in C++).  
  
 **To sign your assembly with a strong name in Visual Studio**  
  
1.  In [!INCLUDE[vsprvs](../vs140/includes/vsprvs_md.md)], open your solution.  
...
-   Use the strong name tool (Sn.exe) that is provided by the [!INCLUDE[dnprdnshort](../vs140/includes/dnprdnshort_md.md)] SDK. For more information, see [Strong Name Tool (Sn.exe)](assetId:///c1d2b532-1b8e-4c7a-8ac5-53b801135ec6).  
