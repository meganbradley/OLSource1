...
Demonstrates how to add a native Unicode string (<CodeContentPlaceHolder>2\</CodeContentPlaceHolder>) to a database and how to marshal a \<xref:System.String*?displayProperty=fullName> from a database to a native Unicode string.  
