...
## Remarks  
 An F# module is a grouping of F# code constructs such as types, values, function values, and code in <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> bindings. It is implemented as a common language runtime (CLR) class that has only static members. There are two types of module declarations, depending on whether the whole file is included in the module: a top-level module declaration and a local module declaration. A top-level module declaration includes the whole file in the module. A top-level module declaration can appear only as the first declaration in a file.  
  
 In the syntax for the top-level module declaration, the optional <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> is the sequence of nested namespace names that contains the module. The qualified namespace does not have to be previously declared.  
 ...
 [!code[FsModules#6601](../vs140/codesnippet/FSharp/modules--fsharp-_1.fs)]  
  
 This file would be compiled as if it were written in this manner:  
  
 [!code[FsModules#6602](../vs140/codesnippet/FSharp/modules--fsharp-_2.fs)]  
  
 If you have multiple modules in a file, you must use a local module declaration for each module. If an enclosing namespace is declared, these modules are part of the enclosing namespace. If an enclosing namespace is not declared, the modules become part of the implicitly created top-level module. The following code example shows a code file that contains multiple modules. The compiler implicitly creates a top-level module named <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>, and <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> and <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> are nested in that top-level module.  
  
 [!code[FsModules#6603](../vs140/codesnippet/FSharp/modules--fsharp-_3.fs)]  
 ...
 The <CodeContentPlaceHolder>6\</CodeContentPlaceHolder> can be one of the following: <CodeContentPlaceHolder>7\</CodeContentPlaceHolder>, <CodeContentPlaceHolder>8\</CodeContentPlaceHolder>, <CodeContentPlaceHolder>9\</CodeContentPlaceHolder>. For more information, see [Access Control (F#)](../vs140/access-control--fsharp-.md). The default is public.  
...
## Referencing Code in Modules  
 ...
 You can open the module or one or more of the namespaces to simplify the code. For more information about opening namespaces and modules, see [Import Declarations: the open Keyword (F#)](../vs140/import-declarations--the-open-keyword--fsharp-.md).  
  
 The following code example shows a top-level module that contains all the code up to the end of the file.  
  
 [!code[FsModules#6604](../vs140/codesnippet/FSharp/modules--fsharp-_4.fs)]  
 ...
 [!code[FsModules#6605](../vs140/codesnippet/FSharp/modules--fsharp-_5.fs)]  
  
## Nested Modules  
 Modules can be nested. Inner modules must be indented as far as outer module declarations to indicate that they are inner modules, not new modules. For example, compare the following two examples. Module <CodeContentPlaceHolder>11\</CodeContentPlaceHolder> is an inner module in the following code.  
  
 [!code[FsModules#6607](../vs140/codesnippet/FSharp/modules--fsharp-_6.fs)]  
  
 But module <CodeContentPlaceHolder>12\</CodeContentPlaceHolder> is a sibling to module <CodeContentPlaceHolder>13\</CodeContentPlaceHolder> in the following code.  
  
 [!code[FsModules#6608](../vs140/codesnippet/FSharp/modules--fsharp-_7.fs)]  
  
 Module <CodeContentPlaceHolder>14\</CodeContentPlaceHolder> is also a sibling module in the following code, because it is not indented as far as other declarations in module <CodeContentPlaceHolder>15\</CodeContentPlaceHolder>.  
  
 [!code[FsModules#6609](../vs140/codesnippet/FSharp/modules--fsharp-_8.fs)]  
 ...
 [!code[FsModules#6610](../vs140/codesnippet/FSharp/modules--fsharp-_9.fs)]  
  
 To eliminate the warning, indent the inner module.  
  
 [!code[FsModules#6611](../vs140/codesnippet/FSharp/modules--fsharp-_10.fs)]  
 ...
 [!code[FsModules#6612](../vs140/codesnippet/FSharp/modules--fsharp-_11.fs)]  
