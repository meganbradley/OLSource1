...
---
# CStatic::GetIcon
Gets the handle of the icon, previously set with [SetIcon](../vs140/cstatic--seticon.md), that is associated with <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>.  
