...
---
# CTreeCtrl::GetItemText
Returns the text of the item specified by <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>.  
...
## Return Value  
 A <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> object containing the item's text.  
