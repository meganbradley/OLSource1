...
The following code example uses the <xref:System.Drawing.Graphics*> class to modify the [OnPaint](assetId:///M:System.Windows.Forms.Form.OnPaint(System.Windows.Forms.PaintEventArgs)?qualifyHint=False&autoUpgrade=True) event handler to retrieve a pointer to the <xref:System.Drawing.Graphics*> object for the main form. This pointer is then used to set the background color of the form and draw a line and an arc using the <xref:System.Drawing.Graphics.DrawLine*?displayProperty=fullName> and <xref:System.Drawing.Graphics.DrawArc*> methods.  
