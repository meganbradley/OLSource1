...
## Return Value  
 A <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> object containing the path and database type for the table.  
  
## Remarks  
 For a <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> object that represents an attached table, the <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> object consists of one or two parts (a database type specifier and a path to the database).  
