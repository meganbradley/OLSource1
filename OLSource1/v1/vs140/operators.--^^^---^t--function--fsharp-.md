...
apitype: "Assembly"
f1_keywords: 
  - "Microsoft.FSharp.Core.Operators.op_ExclusiveOr``1"
dev_langs: 
  - "FSharp"
helpviewer_keywords: 
  - "^^^ operator [F#]"
  - "op_ExclusiveOr operator [F#]"
  - "Operators.( ^^^ ) operator [F#]"
  - "Operators.op_ExclusiveOr operator [F#]"
ms.assetid: 6e37643f-f7bd-4efb-893f-59730d8275b4
