...
A property was specified without required parameters but with the <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> modifier.  
...
-   Remove the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> modifier from the property definition.  
