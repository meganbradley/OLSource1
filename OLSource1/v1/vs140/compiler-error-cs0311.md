...
<CodeContentPlaceHolder>0\</CodeContentPlaceHolder>  
 If this error occurs when trying to use a value-type argument, notice that an implicit numeric conversion, for example from <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> to <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>, does not satisfy a generic type parameter.  
