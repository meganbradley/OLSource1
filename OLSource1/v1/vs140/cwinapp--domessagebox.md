...
## Return Value  
 Returns the same values as <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>.  
  
## Remarks  
 Do not call this member function to open a message box; use <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> instead.  
  
 Override this member function to customize your application-wide processing of <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> calls.  
