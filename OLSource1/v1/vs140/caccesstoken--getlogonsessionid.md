...
---
# CAccessToken::GetLogonSessionId
Call this method to get the Logon Session ID associated with the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> object.  
...
## Remarks  
 In debug builds, an assertion error will occur if <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> is an invalid value.  
