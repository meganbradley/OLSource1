...
## Return Value  
 The <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> of the control being prepared for DDX or DDV.  
...
## Remarks  
 ...
 Preparation consists of storing the control's <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> in the <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> class. The framework uses this handle to restore the focus to the previously focused control in the event of a DDX or DDV failure.  
  
 Implementors of custom DDX or DDV routines should call <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> for all non-edit controls for which they are exchanging data via DDX or validating data via DDV.  
