...
## File Patching  
 ...
 File patching also works for assemblies that are downloaded on demand using the [DownloadFileGroup](assetId:///M:System.Deployment.Application.ApplicationDeployment.DownloadFileGroup(System.String)?qualifyHint=False&autoUpgrade=True) and [DownloadFileGroupAsync](assetId:///M:System.Deployment.Application.ApplicationDeployment.DownloadFileGroupAsync(System.String)?qualifyHint=False&autoUpgrade=True) methods.  
