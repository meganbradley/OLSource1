...
## Remarks  
 See [ATLTRACE2](../vs140/atltrace2.md) for a description of **ATLTRACE**. **ATLTRACE** and <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> have the same behavior, **ATLTRACE** is included for backward compatibility.  
