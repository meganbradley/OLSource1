...
This useful casting operator provides an efficient method to access the null-terminated C string contained in a <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> object.  
