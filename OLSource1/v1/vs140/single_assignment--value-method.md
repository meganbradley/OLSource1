...
## Remarks  
 This method will wait until a message arrives if no message is currently stored in the <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> messaging block.  
