...
## Example  
 The C# version of this example uses method syntax and the <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> operator to generate a CSV file from an XML document in a single expression. For more information, see [Query Syntax and Method Syntax in LINQ (C#)](../vs140/query-syntax-and-method-syntax-in-linq--csharp-.md).  
