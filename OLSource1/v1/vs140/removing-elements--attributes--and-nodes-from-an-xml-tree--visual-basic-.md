...
### Description  
 ...
 For more information on the <xref:System.Linq.Enumerable.ToList``1?qualifyHint=False> operator, see [Converting Data Types (Visual Basic)](../vs140/converting-data-types--visual-basic-.md).  
