...
ms.topic: "article"
f1_keywords: 
  - "internal_concurrent_hash/concurrency::concurrent_unordered_map::find"
dev_langs: 
  - "C++"
helpviewer_keywords: 
  - "find method"
...
## Return Value  
 An iterator pointing to the location of the the first element that matched the key provided, or the iterator <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> if no such element exists.  
