...
---
# CRect::operator =
Assigns *srcRect* to <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>.  
...
#### Parameters  
 *srcRect*  
 Refers to a source rectangle. Can be a [RECT](../vs140/rect-structure.md) or <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>.  
