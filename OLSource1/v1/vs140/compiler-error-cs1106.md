...
## Example  
 The following example generates CS1106 because the class <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> is not defined as <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>:  
