...
-   Set a filter or a sort order for the recordset. Do this in <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> after the recordset object is constructed but before its **Open** member function is called. For more information, see [Recordset: Filtering Records (ODBC)](../vs140/recordset--filtering-records--odbc-.md) and [Recordset: Sorting Records (ODBC)](../vs140/recordset--sorting-records--odbc-.md).  
