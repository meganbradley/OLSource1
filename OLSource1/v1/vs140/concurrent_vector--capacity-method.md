...
## Remarks  
 Unlike an STL <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>, a <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> object does not move existing elements if it allocates more memory.  
