 ...
 **Function handler name**  
 Displays the name of the function that is added to handle the event. By default, the name is based on the message type and the command, prepended by "On". For example, for the button called <CodeContentPlaceHolder>0\</CodeContentPlaceHolder>, the message type <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> displays the function handler name <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>.  
