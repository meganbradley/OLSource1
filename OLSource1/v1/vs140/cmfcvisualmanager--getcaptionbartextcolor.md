...
## Return Value  
 A [COLORREF](http://msdn.microsoft.com/library/windows/desktop/dd183449) parameter that indicates the color of the text in <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>.  
