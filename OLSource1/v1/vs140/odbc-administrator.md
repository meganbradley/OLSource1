...
2.  Click **Next** on each dialog box until you reach the **Installation Options** dialog box. Select **Custom**, and then click <CodeContentPlaceHolder>0\</CodeContentPlaceHolder>.  
