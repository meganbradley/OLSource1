...
## Remarks  
 Call this function after calling <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> to retrieve the ending page number in the range of pages to be printed.  
