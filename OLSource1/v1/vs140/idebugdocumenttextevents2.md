...
## Notes for Callers  
 [!INCLUDE[vsprvs](../vs140/includes/vsprvs_md.md)] obtains this interface through a call to the [Advise](assetId:///M:System.Runtime.InteropServices.ComTypes.IConnectionPoint.Advise(System.Object,System.Int32@)?qualifyHint=False&autoUpgrade=True) method. The <xref:System.Runtime.InteropServices.ComTypes.IConnectionPoint*> interface is obtained from a call to the [EnumConnectionPoints](assetId:///M:System.Runtime.InteropServices.ComTypes.IConnectionPointContainer.EnumConnectionPoints(System.Runtime.InteropServices.ComTypes.IEnumConnectionPoints@)?qualifyHint=False&autoUpgrade=True) method. The <xref:System.Runtime.InteropServices.ComTypes.IConnectionPointContainer*> interface is obtained by calling the [QueryInterface](../vs140/queryinterface.md) method on an [IDebugDocument2](../vs140/idebugdocument2.md) interface.  
