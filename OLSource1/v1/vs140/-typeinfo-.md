...
---
# &lt;typeinfo&gt;
Include the standard header <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> to define several types associated with the type-identification operator [typeid](../vs140/typeid-operator.md), which yields information about both static and dynamic types.  
