...
## Remarks  
 Returns E_INVALIDARG if <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> is zero, returns S_FALSE if less than <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> elements are returned, returns S_OK otherwise.  
