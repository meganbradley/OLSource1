...
## Remarks  
 ...
 initializes the controlled sequence with the sequence <CodeContentPlaceHolder>10\</CodeContentPlaceHolder>[begin](../vs140/hash_set--begin--stl-clr-.md)<CodeContentPlaceHolder>11\</CodeContentPlaceHolder> <CodeContentPlaceHolder>12\</CodeContentPlaceHolder>[end](../vs140/hash_set--end--stl-clr-.md)<CodeContentPlaceHolder>13\</CodeContentPlaceHolder>, with the default ordering predicate, and with the default hash function. You use it to specify an initial controlled sequence that is a copy of the sequence controlled by the hash_set object <CodeContentPlaceHolder>14\</CodeContentPlaceHolder>, with the default ordering predicate and hash function.  
  
 The constructor:  
  
 <CodeContentPlaceHolder>15\</CodeContentPlaceHolder>  
  
 initializes the controlled sequence with the sequence <CodeContentPlaceHolder>16\</CodeContentPlaceHolder>[begin](../vs140/hash_set--begin--stl-clr-.md)<CodeContentPlaceHolder>17\</CodeContentPlaceHolder> <CodeContentPlaceHolder>18\</CodeContentPlaceHolder>[end](../vs140/hash_set--end--stl-clr-.md)<CodeContentPlaceHolder>19\</CodeContentPlaceHolder>, with the default ordering predicate, and with the default hash function. You use it to specify an initial controlled sequence that is a copy of the sequence controlled by the hash_set object <CodeContentPlaceHolder>20\</CodeContentPlaceHolder>, with the default ordering predicate and hash function.  
