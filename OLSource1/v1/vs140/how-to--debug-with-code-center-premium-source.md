...
10. In the **Cache symbols from symbol servers in this directory** box, enter a location such as <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> where Code Center Premium can cache the symbols. Caching symbols can significantly improve performance during debugging.  
...
1.  In your <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> class, set a breakpoint on the package constructor.  
  
2.  In the <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> menu, click **Start Debugging**.  
...
2.  Launch Internet Explorer enter the following URL: <CodeContentPlaceHolder>6\</CodeContentPlaceHolder>  
