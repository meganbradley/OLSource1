...
f1_keywords: 
  ...
  - "SetKeyboardNavigationLevel"
  - "CMFCRibbonBar.SetKeyboardNavigationLevel"
dev_langs: 
  - "C++"
helpviewer_keywords: 
  - "SetKeyboardNavigationLevel method"
...
#### Parameters  
 ...
 <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> to set the keyboard focus to the ribbon bar.  
