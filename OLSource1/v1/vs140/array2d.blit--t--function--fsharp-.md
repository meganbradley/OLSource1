...
apitype: "Assembly"
f1_keywords: 
  - "Microsoft.FSharp.Collections.Array2DModule.CopyTo``1"
dev_langs: 
  - "FSharp"
helpviewer_keywords: 
  - "Array2D.blit function [F#]"
  - "CopyTo function [F#]"
  - "Array2D.CopyTo function [F#]"
  - "blit function [F#]"
...
#### Parameters  
 ...
 Type: <CodeContentPlaceHolder>6\</CodeContentPlaceHolder>[&#91;,&#93;](../vs140/core.--t--type--fsharp-4.md)  
...
|Exception|Condition|  
|---------------|---------------|  
|\<xref:System.ArgumentException*>|Thrown when any of the indices are negative or if either of the counts are larger than the dimensions of the array allow.|  
