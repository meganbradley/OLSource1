...
-   Drawing in the window  
 ...
 Most drawing in a framework application occurs in the view, whose [OnDraw](../vs140/cview--ondraw.md) member function is called whenever the window's contents must be drawn. If your window is a child of the view, you might delegate some of the view's drawing to your child window by having <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> call one of your window's member functions.  
