...
This example opens a <xref:System.IO.StreamWriter?qualifyHint=False> object with the `My.Computer.FileSystem.OpenTextFileWriter` method and uses it to write a string to a text file with the <xref:System.IO.TextWriter.WriteLine?qualifyHint=False> method of the <xref:System.IO.StreamWriter?qualifyHint=False> class.  
...
-   The pathname is too long (<xref:System.IO.PathTooLongException?qualifyHint=False>).  
