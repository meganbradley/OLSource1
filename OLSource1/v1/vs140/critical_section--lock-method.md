...
## Remarks  
 It is often safer to utilize the [scoped_lock](../vs140/critical_section--scoped_lock-class.md) construct to acquire and release a <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> object in an exception safe way.  
