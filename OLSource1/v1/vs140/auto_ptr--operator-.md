...
---
# auto_ptr::operator*
The dereferencing operator for objects of type <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>.  
...
## Remarks  
 The indirection operator returns <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>[get](../vs140/auto_ptr--get.md). Hence, the stored pointer must not be null.  
