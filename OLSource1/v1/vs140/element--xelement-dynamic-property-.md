...
## Property Value/Return Value  
 An indexer of the type <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>. This indexer takes an expanded name parameter and returns the corresponding \<xref:System.Xml.Linq.XElement*>, or <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> if there is no element with the specified name.  
