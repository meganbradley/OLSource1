...
## Remarks  
 <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> copies the state of <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> to the current pane by calling the following methods:  
