...
## Example  
 ...
 [!code[concrt-scheduler-policy#1](../vs140/codesnippet/CPP/how-to--specify-specific-scheduler-policies_1.cpp)]  
...
## Compiling the Code  
 Copy the example code and paste it in a Visual Studio project, or paste it in a file that is named <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> and then run the following command in a Visual Studio Command Prompt window.  
