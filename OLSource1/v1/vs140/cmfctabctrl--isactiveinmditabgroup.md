...
## Return Value  
 <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> if the current tab of a tab control is the active tab in an MDI tab group; otherwise, <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>.  
