...
-   The window frame GetProperty method \<xref:Microsoft.VisualStudio.Shell.Interop.IVsWindowFrame.GetProperty*> on any of the following properties:  
 ...
 If your extension uses C++, you can pass <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> for the parameters you don’t want.  
...
-   \<xref:Microsoft.VisualStudio.Shell.Interop.IVsWindowFrame.GetProperty*> using \<xref:Microsoft.VisualStudio.Shell.Interop.__VSFPROPID6.VSFPROPID_PendingInitialization*>.  
  
-   \<xref:Microsoft.VisualStudio.Shell.Interop.IVsRunningDocumentTable4.GetDocumentFlags*>. This method returns a \<xref:Microsoft.VisualStudio.Shell.Interop._VSRDTFLAGS4*> object that includes a value for \<xref:Microsoft.VisualStudio.Shell.Interop._VSRDTFLAGS4.RDT_PendingInitialization*> if the document has not yet been initialized.  
