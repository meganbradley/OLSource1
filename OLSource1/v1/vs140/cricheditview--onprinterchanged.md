...
## Remarks  
 The default implementation sets the paper size to the physical height and width for the output device (printer). If there is no device context associated with <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>, the default implementation sets the paper size to 8.5 by 11 inches.  
