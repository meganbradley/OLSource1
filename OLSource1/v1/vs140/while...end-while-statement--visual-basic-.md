...
## Example  
 The following example reads all lines in a text file. The [OpenText](assetId:///M:System.IO.File.OpenText(System.String)?qualifyHint=False&autoUpgrade=True) method opens the file and returns a <xref:System.IO.StreamReader*> that reads the characters. In the `While` condition, the <xref:System.IO.StreamReader.Peek*> method of the `StreamReader` determines whether the file contains additional characters.  
