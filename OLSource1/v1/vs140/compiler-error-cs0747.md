...
1.  Ensure that all expressions in the initializer are assignments to properties or fields of the type. In the following example, the second expression is an error because the value <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> is not assigned to any property or field of <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>.  
