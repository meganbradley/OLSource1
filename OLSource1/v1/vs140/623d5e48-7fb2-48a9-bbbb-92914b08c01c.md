...
System.Diagnostics.DebuggerHiddenAttribute does not affect 'Get' or 'Set' when applied to the Property definition. Apply the attribute directly to the 'Get' and 'Set' procedures as appropriate.  
 ...
 Although you can apply \<xref:System.Diagnostics.DebuggerHiddenAttribute*> to a property, it does not have any effect. It has the effect that you want only if you apply it to the property's <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> or <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> procedure.  
...
-   Remove the \<xref:System.Diagnostics.DebuggerHiddenAttribute*> from the property declaration and apply it to the property's <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> or <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> procedure as appropriate.  
