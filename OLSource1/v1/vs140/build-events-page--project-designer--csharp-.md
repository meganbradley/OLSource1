...
Use the **Build Events** page of the **Project Designer** to specify build configuration instructions. You can also specify the conditions under which any post-build events are run. For more information, see [How To: Specify Build Events (C#)](../vs140/how-to--specify-build-events--csharp-.md)and [How to: Specify Build Events (Visual Basic)](../vs140/how-to--specify-build-events--visual-basic-.md).  
  
## UIElement List  
 **Configuration**  
 This control is not editable in this page. For a description of this control, see [Build Page, Project Designer (C#)](../vs140/build-page--project-designer--csharp-.md).  
  
 **Platform**  
 This control is not editable on this page. For a description of this control, see [Build Page, Project Designer (C#)](../vs140/build-page--project-designer--csharp-.md).  
