...
#### Parameters  
 ...
 A pointer to a [REBARINFO](http://msdn.microsoft.com/library/windows/desktop/bb774395) structure that contains the information to be set. You must set the <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> member of this structure to <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> before sending this message  
