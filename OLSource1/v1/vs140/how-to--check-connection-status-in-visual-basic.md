...
The <xref:Microsoft.VisualBasic.Devices.Network.IsAvailable?qualifyHint=False> property can be used to determine whether the computer has a working network or Internet connection.  
