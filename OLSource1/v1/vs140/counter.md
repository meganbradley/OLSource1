...
#### Parameters  
 ...
 (Optional) The string to use in place of <CodeContentPlaceHolder>6\</CodeContentPlaceHolder> in the column headers of profiler reports and views.  
  
## Required Options  
 The Counter option can only be used with one of the following options:  
  
 **Start:** <CodeContentPlaceHolder>7\</CodeContentPlaceHolder>  
 Initializes the profiler to use the instrumentation method.  
  
 **Launch:** <CodeContentPlaceHolder>8\</CodeContentPlaceHolder>  
 Starts the specified application and the profiler. The profiler must be initialized to use the sampling method.  
  
 **Attach:** <CodeContentPlaceHolder>9\</CodeContentPlaceHolder>  
