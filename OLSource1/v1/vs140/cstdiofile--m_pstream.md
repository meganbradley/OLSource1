...
---
# CStdioFile::m_pStream
The <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> data member is the pointer to an open file as returned by the C run-time function <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>.  
