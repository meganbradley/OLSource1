...
#### Parameters  
 ...
 [out] A pointer to a rowset object. Typically this parameter is not used, but it can be used if you must perform more work on the rowset before passing it to a COM object. The lifetime of <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> is bound by <CodeContentPlaceHolder>4\</CodeContentPlaceHolder>.  
