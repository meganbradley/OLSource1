...
## Remarks  
 <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> method calls the <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> method, which you can use to clean up data when the animation ends.  
