...
---
# CStrBufT Class
This class provides automatic resource cleanup for             <CodeContentPlaceHolder>10\</CodeContentPlaceHolder> and             <CodeContentPlaceHolder>11\</CodeContentPlaceHolder> calls on an existing             <CodeContentPlaceHolder>12\</CodeContentPlaceHolder> object.  
...
#### Parameters  
 *TCharType*  
 The character type of the                         <CodeContentPlaceHolder>13\</CodeContentPlaceHolder> class. Can be one of the following:  
  
-   <CodeContentPlaceHolder>14\</CodeContentPlaceHolder> (for ANSI character strings)  
  
-   <CodeContentPlaceHolder>15\</CodeContentPlaceHolder> (for Unicode character strings)  
...
|Name|Description|  
|----------|-----------------|  
|<CodeContentPlaceHolder>16\</CodeContentPlaceHolder>|A pointer to a constant string.|  
|<CodeContentPlaceHolder>17\</CodeContentPlaceHolder>|A pointer to a string.|  
|<CodeContentPlaceHolder>18\</CodeContentPlaceHolder>|The string type whose buffer is to be manipulated by specializations of this class template.|  
...
## Remarks  
 ...
 Primarily designed as a helper class,                 <CodeContentPlaceHolder>20\</CodeContentPlaceHolder> provides a convenient way for a developer to work with the character buffer of a string object without worrying about how or when to call                 <CodeContentPlaceHolder>21\</CodeContentPlaceHolder>. This is possible because the wrapper object goes out of scope naturally in the case of an exception or multiple exiting code paths; causing its destructor to free the string resource.  
...
### Parameters  
 ...
 The string object associated with the buffer. Typically, the developer will use the predefined typedefs of                                 **CStrBuf** (                                **TCHAR** variant),                                 **CStrBufA** (                                <CodeContentPlaceHolder>23\</CodeContentPlaceHolder> variant) and                                 **CStrBufW** (                                <CodeContentPlaceHolder>24\</CodeContentPlaceHolder> variant).  
...
### Remarks  
 ...
 Note that the copy constructor is                         <CodeContentPlaceHolder>26\</CodeContentPlaceHolder>.  
...
##  \<a name="cstrbuft__set_length">\</a>  CStrBufT::SET_LENGTH  
 Set the length of the string object at                 <CodeContentPlaceHolder>27\</CodeContentPlaceHolder> time.  
...
> [!NOTE]
>  Must be less than or equal to the minimum buffer length specified in the constructor of                                     <CodeContentPlaceHolder>29\</CodeContentPlaceHolder>.  
