...
## Notes for Callers  
 A call to [QueryInterface](../vs140/queryinterface.md) on the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> interface returns this interface. Also, a call to [IDebugDefaultPort2::GetPortNotify](../vs140/idebugdefaultport2--getportnotify.md) returns this interface. A debug engine can see this interface as a parameter to [IDebugProgramProvider2::WatchForProviderEvents](../vs140/idebugprogramprovider2--watchforproviderevents.md).  
