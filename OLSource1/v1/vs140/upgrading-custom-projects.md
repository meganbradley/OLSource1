...
-   If the \<xref:Microsoft.VisualStudio.Shell.Interop.__VSPPROJECTUPGRADEVIAFACTORYFLAGS.PUVFF_SXSBACKUP*> flag is specified in the \<xref:Microsoft.VisualStudio.Shell.Interop.IVsProjectUpgradeViaFactory.UpgradeProject*> method, the upgrade is going to be implemented as an in-place upgrade prior to the opening of the project.  
  
-   If the \<xref:Microsoft.VisualStudio.Shell.Interop.__VSPPROJECTUPGRADEVIAFACTORYFLAGS.PUVFF_COPYBACKUP*> flag is specified in the \<xref:Microsoft.VisualStudio.Shell.Interop.IVsProjectUpgradeViaFactory.UpgradeProject*> method, the upgrade is implemented as a copy upgrade.  
...
-   If the \<xref:Microsoft.VisualStudio.Shell.Interop.__VSUPGRADEPROJFLAGS.UPF_SILENTMIGRATE*> flag is not specified in the \<xref:Microsoft.VisualStudio.Shell.Interop.IVsProjectUpgrade.UpgradeProject*> call, then you must prompt the user to upgrade the project file.  
...
2.  If you want to do an in-place upgrade as a part of the solution opening, supply the flag \<xref:Microsoft.VisualStudio.Shell.Interop.__VSPPROJECTUPGRADEVIAFACTORYFLAGS.PUVFF_SXSBACKUP*> as the <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> parameter in your \<xref:Microsoft.VisualStudio.Shell.Interop.IVsProjectUpgradeViaFactory.UpgradeProject*> implementation.  
  
3.  If you want to do an in-place upgrade as a part of the solution opening, supply the flag \<xref:Microsoft.VisualStudio.Shell.Interop.__VSPPROJECTUPGRADEVIAFACTORYFLAGS.PUVFF_COPYBACKUP*> as the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> parameter in your \<xref:Microsoft.VisualStudio.Shell.Interop.IVsProjectUpgradeViaFactory.UpgradeProject*> implementation.  
  
4.  For both the steps 2 and 3, the actual file upgrade steps, using \<xref:Microsoft.VisualStudio.Shell.Interop.IVsQueryEditQuerySave2*>, can be implemented as described in the "Implementing <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>" section below, or you can delegate the actual file upgrade to \<xref:Microsoft.VisualStudio.Shell.Interop.IVsProjectUpgrade*>.  
...
3.  If the project needs to upgrade the project type to a new version, then it must determine whether the project file can be modified by calling the \<xref:Microsoft.VisualStudio.Shell.Interop.IVsQueryEditQuerySave2.QueryEditFiles*> method and passing in a value of \<xref:Microsoft.VisualStudio.Shell.Interop.tagVSQueryEditFlags.QEF_ReportOnly*> for the <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> parameter. The project then needs to do the following:  
  
    -   If the <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> value returned in the <CodeContentPlaceHolder>6\</CodeContentPlaceHolder> parameter is \<xref:Microsoft.VisualStudio.Shell.Interop.tagVSQueryEditResult.QER_EditOK*>, then the upgrade can proceed because the project file can be written.  
  
    -   If the <CodeContentPlaceHolder>7\</CodeContentPlaceHolder> value returned in the <CodeContentPlaceHolder>8\</CodeContentPlaceHolder> parameter is \<xref:Microsoft.VisualStudio.Shell.Interop.tagVSQueryEditResult.QER_EditNotOK*> and the <CodeContentPlaceHolder>9\</CodeContentPlaceHolder> value has the \<xref:Microsoft.VisualStudio.Shell.Interop.tagVSQueryEditResultFlags.QER_ReadOnlyNotUnderScc*> bit set, then \<xref:Microsoft.VisualStudio.Shell.Interop.IVsProjectUpgrade.UpgradeProject*> must return failure, because users should resolve the permissions issue themselves. The project should then do the following:  
  
         Report the error to the user by calling \<xref:Microsoft.VisualStudio.Shell.Interop.IVsUIShell.ReportErrorInfo*>. and return the \<xref:Microsoft.VisualStudio.Shell.Interop.VSErrorCodes.VS_E_PROJECTMIGRATIONFAILED*> error code to \<xref:Microsoft.VisualStudio.Shell.Interop.IVsProjectUpgrade*>.  
  
    -   If the <CodeContentPlaceHolder>10\</CodeContentPlaceHolder> value is \<xref:Microsoft.VisualStudio.Shell.Interop.tagVSQueryEditResult.QER_EditNotOK*> and the <CodeContentPlaceHolder>11\</CodeContentPlaceHolder> value has the \<xref:Microsoft.VisualStudio.Shell.Interop.tagVSQueryEditResultFlags.QER_ReadOnlyUnderScc*> bit set, then the project file should be checked out by calling \<xref:Microsoft.VisualStudio.Shell.Interop.IVsQueryEditQuerySave2.QueryEditFiles*> (\<xref:Microsoft.VisualStudio.Shell.Interop.tagVSQueryEditFlags.QEF_ForceEdit_NoPrompting*>, \<xref:Microsoft.VisualStudio.Shell.Interop.tagVSQueryEditFlags.QEF_DisallowInMemoryEdits*>,...).  
...
7.  If \<xref:Microsoft.VisualStudio.Shell.Interop.IVsProjectFactory.CanCreateProject*> returns <CodeContentPlaceHolder>12\</CodeContentPlaceHolder>, then the environment calls your \<xref:Microsoft.VisualStudio.Shell.Interop.IVsProjectFactory.CanCreateProject*> implementation.  
...
9. The environment calls your <CodeContentPlaceHolder>13\</CodeContentPlaceHolder> implementation to determine whether the project file needs to be upgraded.  
  
10. You call \<xref:Microsoft.VisualStudio.Shell.Interop.IVsQueryEditQuerySave2.QueryEditFiles*> and pass in a value of \<xref:Microsoft.VisualStudio.Shell.Interop.tagVSQueryEditFlags.QEF_ReportOnly*> for the <CodeContentPlaceHolder>14\</CodeContentPlaceHolder> parameter.  
  
11. The environment returns \<xref:Microsoft.VisualStudio.Shell.Interop.tagVSQueryEditResult.QER_EditNotOK*> for <CodeContentPlaceHolder>15\</CodeContentPlaceHolder> and the \<xref:Microsoft.VisualStudio.Shell.Interop.tagVSQueryEditResultFlags.QER_ReadOnlyUnderScc*> bit is set in <CodeContentPlaceHolder>16\</CodeContentPlaceHolder>.  
  
12. Your \<xref:Microsoft.VisualStudio.Shell.Interop.IVsProjectUpgrade*> implementation calls <CodeContentPlaceHolder>17\</CodeContentPlaceHolder> (\<xref:Microsoft.VisualStudio.Shell.Interop.tagVSQueryEditFlags.QEF_ForceEdit_NoPrompting*>, \<xref:Microsoft.VisualStudio.Shell.Interop.tagVSQueryEditFlags.QEF_DisallowInMemoryEdits*>).  
...
-   If you do not handle your own project reload, then you return <CodeContentPlaceHolder>19\</CodeContentPlaceHolder> for \<xref:Microsoft.VisualStudio.Shell.Interop.IVsHierarchy.GetProperty*> (\<xref:Microsoft.VisualStudio.Shell.Interop.__VSHPROPID.VSHPROPID_HandlesOwnReload*>). In this case, before \<xref:Microsoft.VisualStudio.Shell.Interop.IVsQueryEditQuerySave2.QueryEditFiles*>([QEF_ForceEdit_NoPrompting](assetId:///F:Microsoft.VisualStudio.Shell.Interop.tagVSQueryEditFlags.QEF_ForceEdit_NoPrompting?qualifyHint=False&autoUpgrade=True), [QEF_DisallowInMemoryEdits](assetId:///F:Microsoft.VisualStudio.Shell.Interop.tagVSQueryEditFlags.QEF_DisallowInMemoryEdits?qualifyHint=False&autoUpgrade=True),) returns, the environment creates another new, instance of your project, for example, Project2, as follows:  
    ...
    2.  The environment calls your <CodeContentPlaceHolder>20\</CodeContentPlaceHolder> implementation to create a second instance of your project, Project2.  
  
    3.  The environment calls your <CodeContentPlaceHolder>21\</CodeContentPlaceHolder> implementation to open the file and initialize the second project object, Project2.  
  
    4.  The environment calls <CodeContentPlaceHolder>22\</CodeContentPlaceHolder> for a second time to determine whether the project object should be upgraded. However, this call is made on a new, second, instance of the project, Project2. This is the project that is opened in the solution.  
  
        > [!NOTE]
        >  In the instance that your first project, Project1, is placed in the inactive state, then you must return \<xref:Microsoft.VisualStudio.VSConstants.S_OK*> from the first call to your \<xref:Microsoft.VisualStudio.Shell.Interop.IVsProjectUpgrade.UpgradeProject*> implementation. See [Basic Project](assetId:///385fd2a3-d9f1-4808-87c2-a3f05a91fc36) for an implementation of <CodeContentPlaceHolder>23\</CodeContentPlaceHolder>.  
  
    5.  You call \<xref:Microsoft.VisualStudio.Shell.Interop.IVsQueryEditQuerySave2.QueryEditFiles*> and pass in a value of \<xref:Microsoft.VisualStudio.Shell.Interop.tagVSQueryEditFlags.QEF_ReportOnly*> for the <CodeContentPlaceHolder>24\</CodeContentPlaceHolder> parameter.  
 ...
 If you fail to upgrade, return \<xref:Microsoft.VisualStudio.Shell.Interop.VSErrorCodes.VS_E_PROJECTMIGRATIONFAILED*> from <CodeContentPlaceHolder>25\</CodeContentPlaceHolder>. If no upgrade is necessary or you choose not to upgrade, treat the <CodeContentPlaceHolder>26\</CodeContentPlaceHolder> call as a no-op. If you return \<xref:Microsoft.VisualStudio.Shell.Interop.VSErrorCodes.VS_E_PROJECTMIGRATIONFAILED*>, a placeholder node is added to the solution for your project.  
