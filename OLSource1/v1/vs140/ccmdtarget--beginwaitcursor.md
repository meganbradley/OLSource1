...
## Remarks  
 ...
 The actions of <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> are not always effective outside of a single message handler as other actions, such as <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> handling, could change the cursor.  
  
 Call <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> to restore the previous cursor.  
