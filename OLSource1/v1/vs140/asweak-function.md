...
#### Parameters  
 ...
 A pointer to the type of parameter <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>.  
  
 <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>  
 An instance of a type.  
  
 <CodeContentPlaceHolder>4\</CodeContentPlaceHolder>  
 When this operation completes, a pointer to a weak reference to parameter <CodeContentPlaceHolder>5\</CodeContentPlaceHolder>.  
