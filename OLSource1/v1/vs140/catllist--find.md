...
## Remarks  
 In debug builds, an assertion failure will occur if the list object is not valid, or if the <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> value is out of range.  
