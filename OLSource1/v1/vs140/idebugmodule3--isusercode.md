...
#### Parameters  
 ...
 [out] Nonzero (<CodeContentPlaceHolder>3\</CodeContentPlaceHolder>) if module represents user code, zero (<CodeContentPlaceHolder>4\</CodeContentPlaceHolder>) if it does not.  
