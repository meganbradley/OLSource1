...
ms.topic: "article"
f1_keywords: 
  - "functional/std::tr1::reference_wrapper::operator()"
  - "reference_wrapper.operator()"
  - "std.tr1.reference_wrapper.operator()"
  - "std::tr1::reference_wrapper::operator()"
  - "reference_wrapper::operator()"
dev_langs: 
  - "C++"
...
## Remarks  
 The template member operator returns <CodeContentPlaceHolder>4\</CodeContentPlaceHolder>.  
