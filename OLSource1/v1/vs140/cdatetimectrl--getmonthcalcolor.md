...
#### Parameters  
 ...
 An <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> value specifying which color area of the month calendar to retrieve. For a list of values, see the <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> parameter for [SetMonthCalColor](../vs140/cdatetimectrl--setmonthcalcolor.md).  
