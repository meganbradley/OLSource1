...
1.  In the **Screen Members List** of the **Screen Designer**, select the heading of a collection (for example, the <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> heading).  
