...
## Remarks  
 When deleting a **CException** object, use the **Delete** member function to delete the exception. Do not use the **delete** operator directly, because the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> object may be a global object or have been created on the stack.  
