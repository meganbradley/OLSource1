...
---
# CRect::OffsetRect
Moves <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> by the specified offsets.  
...
## Remarks  
 Moves <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> *x* units along the x-axis and *y* units along the y-axis. The *x* and *y* parameters are signed values, so <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> can be moved left or right and up or down.  
