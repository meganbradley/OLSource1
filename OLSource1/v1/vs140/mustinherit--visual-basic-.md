...
## Remarks  
 ...
 The .NET Framework defines several `MustInherit` classes, among them <xref:System.Array?qualifyHint=False>, <xref:System.Enum?qualifyHint=False>, and <xref:System.ValueType?qualifyHint=False>. <xref:System.ValueType?qualifyHint=False> is an example of a base class that restricts a variable. All value types derive from <xref:System.ValueType?qualifyHint=False>. If you declare a variable as <xref:System.ValueType?qualifyHint=False>, you can assign only value types to that variable.  
