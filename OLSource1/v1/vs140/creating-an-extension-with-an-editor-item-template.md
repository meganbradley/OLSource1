...
1.  In the **New Project** dialog box, expand **Visual C#** or **Visual Basic** and then click **Extensibility**. In the **Templates** pane, select **VSIX Project**. In the **Name** box, type <CodeContentPlaceHolder>0\</CodeContentPlaceHolder>. Click **OK**.  
...
3.  There are three code files, as follows:  
    ...
    -   EditorClassifier1.cs contains the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> class.  
  
    -   EditorClassifier1ClassificationDefinition.cs contains the <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> class.  
  
    -   EditorClassifier1Format.cs contains the <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>  class.  
  
    -   EditorClassifier1Provider.cs contains the <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> class.  
...
1.  In the **New Project** dialog box, expand **Visual C#** or **Visual Basic** and then click **Extensibility**. In the **Templates** pane, select **VSIX Project**. In the **Name** box, type <CodeContentPlaceHolder>5\</CodeContentPlaceHolder>. Click **OK**.  
...
3.  There are two code files, as follows:  
    ...
    -   TextAdornment1.cs contains the <CodeContentPlaceHolder>6\</CodeContentPlaceHolder> class.  
  
    -   extAdornment1TextViewCreationListener.cs contains the <CodeContentPlaceHolder>7\</CodeContentPlaceHolder> class.  
...
1.  In the **New Project** dialog box, expand **Visual C#** or **Visual Basic** and then click **Extensibility**. In the **Templates** pane, select **VSIX Project**. In the **Name** box, type <CodeContentPlaceHolder>8\</CodeContentPlaceHolder>. Click **OK**.  
...
3.  There are two code files, as follows:  
    ...
    -   ViewportAdornment1.cs contains the <CodeContentPlaceHolder>9\</CodeContentPlaceHolder> class.  
  
    -   ViewportAdornment1TextViewCreationListener.cs contains the <CodeContentPlaceHolder>10\</CodeContentPlaceHolder> class  
...
1.  In the **New Project** dialog box, expand **Visual C#** or **Visual Basic** and then click **Extensibility**. In the **Templates** pane, select **VSIX Project**. In the **Name** box, type <CodeContentPlaceHolder>11\</CodeContentPlaceHolder>. Click **OK**.  
...
3.  There are two code files, as follows:  
    ...
    -   EditorMargin1.cs contains the <CodeContentPlaceHolder>12\</CodeContentPlaceHolder> class.  
  
    -   EditorMargin1Factory.cs contains the <CodeContentPlaceHolder>13\</CodeContentPlaceHolder> class.  
