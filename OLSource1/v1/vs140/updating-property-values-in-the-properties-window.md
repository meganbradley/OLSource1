...
2.  Implement [RefreshPropertyBrowser](assetId:///M:Microsoft.VisualStudio.Shell.Interop.IVsUIShell.RefreshPropertyBrowser(System.Int32)?qualifyHint=False&autoUpgrade=True) to keep the **Properties** window in sync with property changes for a project (or any other selected object being browsed by the **Properties** window) without implementing <xref:Microsoft.VisualStudio.OLE.Interop.IConnectionPointContainer*> and firing [OnChanged](assetId:///M:Microsoft.VisualStudio.OLE.Interop.IPropertyNotifySink.OnChanged(System.Int32)?qualifyHint=False&autoUpgrade=True) events.  
  
3.  Implement the <xref:Microsoft.VisualStudio.Shell.Interop.IVsHierarchy*> methods [AdviseHierarchyEvents](assetId:///M:Microsoft.VisualStudio.Shell.Interop.IVsHierarchy.AdviseHierarchyEvents(Microsoft.VisualStudio.Shell.Interop.IVsHierarchyEvents,System.UInt32@)?qualifyHint=False&autoUpgrade=True) and [UnadviseHierarchyEvents](assetId:///M:Microsoft.VisualStudio.Shell.Interop.IVsHierarchy.UnadviseHierarchyEvents(System.UInt32)?qualifyHint=False&autoUpgrade=True) to establish and disable, respectively, client notification of hierarchy events without requiring the hierarchy to implement <xref:Microsoft.VisualStudio.OLE.Interop.IConnectionPointContainer*>.  
...
3.  A connection point controls how many connections (one or more) it allows in its implementation of [Advise](assetId:///M:Microsoft.VisualStudio.OLE.Interop.IConnectionPoint.Advise(System.Object,System.UInt32@)?qualifyHint=False&autoUpgrade=True). A connection point that allows only one interface can return <xref:Microsoft.VisualStudio.VSConstants.E_NOTIMPL*> from the [EnumConnections](assetId:///M:Microsoft.VisualStudio.OLE.Interop.IConnectionPoint.EnumConnections(Microsoft.VisualStudio.OLE.Interop.IEnumConnections@)?qualifyHint=False&autoUpgrade=True) method.  
