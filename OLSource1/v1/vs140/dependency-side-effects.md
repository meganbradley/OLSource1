 ...
 **echo Building bounce.exe...** This effect does not occur if a double colon (<CodeContentPlaceHolder>0\</CodeContentPlaceHolder>) is used. For example, this set of rules:  
