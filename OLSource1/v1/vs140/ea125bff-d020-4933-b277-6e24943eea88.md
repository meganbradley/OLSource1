...
-   It must be <CodeContentPlaceHolder>0\</CodeContentPlaceHolder>, all its containers must be <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>, and it must expose at least one <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> member.  
  
-   It must not be *abstract*, that is, it must not be declared with <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>.  
