 ...
 **Make sure that the file image is a valid managed assembly or module.**  
 This exception is thrown when an unmanaged dynamic link library or executable is passed to the [Load](assetId:///M:System.Reflection.Assembly.Load(System.String)?qualifyHint=False&autoUpgrade=True) method for loading.  
