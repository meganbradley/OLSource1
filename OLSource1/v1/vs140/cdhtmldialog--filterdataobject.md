...
#### Parameters  
 ...
 See <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> in [IDocHostUIHandler::FilterDataObject](https://msdn.microsoft.com/en-us/library/aa753254.aspx) in the [!INCLUDE[winSDK](../vs140/includes/winsdk_md.md)].  
  
 <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>  
 See <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> in **IDocHostUIHandler::FilterDataObject** in the [!INCLUDE[winSDK](../vs140/includes/winsdk_md.md)].  
