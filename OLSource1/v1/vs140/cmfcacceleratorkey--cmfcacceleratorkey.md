...
## Remarks  
 If you do not provide a shortcut key when you create a <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>, use the [CMFCAcceleratorKey::SetAccelerator](../vs140/cmfcacceleratorkey--setaccelerator.md) method to associate a shortcut key with your <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> object.  
