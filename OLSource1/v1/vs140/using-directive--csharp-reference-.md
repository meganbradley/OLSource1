...
-   To create an alias for a namespace or a type. This is called a *using alias directive*.  
 ...
 The `using` keyword is also used to create *using statements*, which help ensure that <xref:System.IDisposable?qualifyHint=False> objects such as files and fonts are handled correctly. See [using Statement](../vs140/using-statement--csharp-reference-.md) for more information.  
