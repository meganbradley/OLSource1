...
-   If the optional parameter must have a default value of this particular type, remove <xref:System.CLSCompliantAttribute?qualifyHint=False>. The procedure cannot be CLS-compliant.  
