...
To maintain type safety and security, C# does not support pointer arithmetic, by default. However, by using the [unsafe](../vs140/unsafe--csharp-reference-.md) keyword, you can define an unsafe context in which pointers can be used. For more information about pointers, see the topic [Pointer types](../vs140/pointer-types--csharp-programming-guide-.md).  
...
-   In order for C# to compile unsafe code, the application must be compiled with [/unsafe](../vs140/-unsafe--csharp-compiler-options-.md).  
...
-   [How to: Use Pointers to Copy an Array of Bytes (C#)](../vs140/how-to--use-pointers-to-copy-an-array-of-bytes---csharp-programming-guide-.md)  
