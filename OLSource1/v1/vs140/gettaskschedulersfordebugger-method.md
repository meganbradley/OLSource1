...
Retrieves an array of all <xref:System.Threading.Tasks.TaskScheduler?qualifyHint=False> objects that are currently active.  
...
## Return Value  
 An array of all <xref:System.Threading.Tasks.TaskScheduler?qualifyHint=False> objects that are currently active in this <xref:System.AppDomain?qualifyHint=False>.  
