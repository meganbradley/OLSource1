...
#### Parameters  
 ...
 If <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>, returns the image index in the image list that contains the large images; otherwise returns the image index in the image list that contains the small images.  
