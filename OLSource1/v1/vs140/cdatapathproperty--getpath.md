...
---
# CDataPathProperty::GetPath
Call this member function to retrieve the path, set when the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> object was constructed, or specified in **Open**, or specified in a previous call to the <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> member function.  
