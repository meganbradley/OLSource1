...
-   [How to Add a command to the shortcut menu](../vs140/how-to--add-a-command-to-the-shortcut-menu.md) – Create your own commands that can update your model or external resources.  
  
-   [How to add a drag and drop handler](../vs140/how-to--add-a-drag-and-drop-handler.md) – Allow the user to move items from one diagram to another, including UML diagrams. You can store references to one model in another.  
