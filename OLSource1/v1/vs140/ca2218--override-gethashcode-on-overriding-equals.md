...
## How to Fix Violations  
 To fix a violation of this rule, provide an implementation of \<xref:System.Object.GetHashCode*>. For a pair of objects of the same type, you must ensure that the implementation returns the same value if your implementation of \<xref:System.Object.Equals*> returns <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> for the pair.  
