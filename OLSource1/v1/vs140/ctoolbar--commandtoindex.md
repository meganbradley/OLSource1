...
---
# CToolBar::CommandToIndex
This member function returns the index of the first toolbar button, starting at position 0, whose command ID matches <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>.  
