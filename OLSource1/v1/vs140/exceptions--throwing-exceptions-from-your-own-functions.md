...
1.  Use one of the MFC helper functions, such as <CodeContentPlaceHolder>0\</CodeContentPlaceHolder>. These functions throw a preallocated exception object of the appropriate type.  
     ...
     [!code[NVC_MFCExceptions#17](../vs140/codesnippet/CPP/exceptions--throwing-exceptions-from-your-own-functions_1.cpp)]  
...
2.  Use a user-defined exception to indicate a problem condition. You can throw an item of any type, even an entire class, as your exception.  
     ...
     [!code[NVC_MFCExceptions#18](../vs140/codesnippet/CPP/exceptions--throwing-exceptions-from-your-own-functions_2.cpp)]  
  
> [!NOTE]
>  MFC's default handling of exceptions applies only to pointers to <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> objects (and objects of <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>-derived classes). The example above bypasses MFC's exception mechanism.  
