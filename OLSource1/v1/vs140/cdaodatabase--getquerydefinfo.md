...
helpviewer_keywords: 
  - "AFX_DAO_ALL_INFO"
  - "databases [C++], getting query information"
  - "GetQueryDefInfo method"
  - "AFX_DAO_SECONDARY_INFO"
  - "AFX_DAO_PRIMARY_INFO"
...
-   <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> (Default) Name, Type  
  
-   <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> Primary information plus: Date Created, Date of Last Update, Returns Records, Updatable  
  
-   <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> Primary and secondary information plus: SQL, Connect, ODBCTimeout  
...
## Remarks  
 ...
 For a description of the information returned in *querydefinfo*, see the [CDaoQueryDefInfo](../vs140/cdaoquerydefinfo-structure.md) structure. This structure has members that correspond to the items of information listed above in the description of <CodeContentPlaceHolder>7\</CodeContentPlaceHolder>. If you request one level of information, you get any prior levels of information as well.  
