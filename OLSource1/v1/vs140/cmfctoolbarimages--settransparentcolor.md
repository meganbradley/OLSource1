...
## Remarks  
 When you or the framework call [CMFCToolBarImages::Draw](../vs140/cmfctoolbarimages--draw.md), the method does not draw any pixel that matches the color specified by <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>.  
