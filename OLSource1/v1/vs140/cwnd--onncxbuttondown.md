...
|[in] <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>|A value of <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> if the first mouse X button is pressed, or <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> if the second X button is pressed.|  
