...
A class using a <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> attribute block does not define any <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> properties or methods. If a class is to be exposed as a COM object, its properties and methods must be declared with <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> access.  
...
-   Add the <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> keyword to one or more properties or methods in the class, or remove the <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> attribute block.  
