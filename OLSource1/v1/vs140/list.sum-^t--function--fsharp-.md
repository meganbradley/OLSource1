...
## Example  
 The following code example illustrates the use of <CodeContentPlaceHolder>4\</CodeContentPlaceHolder>, [List.sumBy](../vs140/list.sumby--t-^u--function--fsharp-.md), and [List.average](../vs140/list.average-^t--function--fsharp-.md).  
