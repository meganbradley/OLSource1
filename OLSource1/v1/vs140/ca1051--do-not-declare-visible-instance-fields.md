...
## Example  
 The following example shows a type (<CodeContentPlaceHolder>10\</CodeContentPlaceHolder>) that violates this rule. <CodeContentPlaceHolder>11\</CodeContentPlaceHolder> shows the corrected code.  
