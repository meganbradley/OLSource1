...
|[LINQ to XML for XPath Users (Visual Basic)](../vs140/linq-to-xml-for-xpath-users--visual-basic-.md)|Presents a number of XPath expressions and their [!INCLUDE[sqltecxlinq](../vs140/includes/sqltecxlinq_md.md)] equivalents.|  
