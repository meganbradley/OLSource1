...
3.  A definition in an **EXPORTS** statement in a <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>  
 ...
 /EXPORT: *entryname*[= *internalname*][,@ <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>[, **NONAME**]][, **DATA**]  
 ...
 The *entryname* is the name of the function or data item as it is to be used by the calling program. Optionally, you can specify the *internalname* as the function known in the defining program; by default, *internalname* is the same as *entryname*. The <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> specifies an index into the export table in the range 1 through 65,535; if you do not specify <CodeContentPlaceHolder>4\</CodeContentPlaceHolder>, LIB assigns one. The **NONAME** keyword exports the function only as an ordinal, without an *entryname*. The **DATA** keyword is used to export data-only objects.  
  
 /INCLUDE: <CodeContentPlaceHolder>5\</CodeContentPlaceHolder>  
