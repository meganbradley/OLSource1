...
compiler option 'option' inconsistent with precompiled header; current command-line option ignored  
 ...
 This warning can occur when a different value for the Pack Structures option ([/Zp](../vs140/-zp--struct-member-alignment-.md)) was specified during compilation of the precompiled header.