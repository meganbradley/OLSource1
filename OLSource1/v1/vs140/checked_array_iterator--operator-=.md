...
---
# checked_array_iterator::operator&lt;=
Tests if the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> on the left side of the operator is less than or equal to the <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> on the right side.  
...
#### Parameters  
 ...
 The <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> to compare against.  
