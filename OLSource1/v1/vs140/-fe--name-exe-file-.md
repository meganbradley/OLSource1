...
## Example  
 The following command line creates an executable file in <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> with the same base name as the first source or object file:  
