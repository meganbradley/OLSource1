...
## Notes for Callers  
 ...
 A debug engine can obtain this interface indirectly through a call to [IDebugDefaultPort2::GetServer](../vs140/idebugdefaultport2--getserver.md) (which returns [IDebugCoreServer3](../vs140/idebugcoreserver3.md), an interface that is derived from <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>).  
