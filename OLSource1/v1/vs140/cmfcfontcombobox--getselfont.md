...
## Return Value  
 A pointer to [CMFCFontInfo Class](../vs140/cmfcfontinfo-class.md) object that describes a font. It can be <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> if no font is selected in the combo box.  
