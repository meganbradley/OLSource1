...
## Return Value  
 An RGB (red, green, blue) 32-bit color value that defines the solid color closest to the <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> value that the device can represent.  
