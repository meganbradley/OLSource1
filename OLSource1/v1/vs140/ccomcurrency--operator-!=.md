...
#### Parameters  
 ...
 The <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> object to be compared.  
  
## Return Value  
 Returns **true** if the item being compared is not equal to the <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> object; otherwise, **false**.  
