...
This example constructs a long string from many smaller strings using the \<xref:System.Text.StringBuilder*> class. The \<xref:System.Text.StringBuilder*> class is more efficient than the <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> operator for concatenating many strings.  
