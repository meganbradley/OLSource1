...
1.  Register your own source control VSPackage (see [Source-Control VSPackage Registration and Selection](../vs140/registration-and-selection--source-control-vspackage-.md)).  
...
3.  Specify glyphs to be used and handle Solution Explorer glyph events (see [Glyph Control (Source-Control VSPackage)](../vs140/glyph-control--source-control-vspackage-.md)).  
