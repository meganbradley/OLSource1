...
#### Parameters  
 ...
 <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> to enable multiple column sort mode; <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> to disable multiple column sort mode and to remove any columns from the list of sorted columns. The default value is <CodeContentPlaceHolder>4\</CodeContentPlaceHolder>.  
