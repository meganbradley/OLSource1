...
An <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> statement inside an interface contains a keyword that is not allowed, such as <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>. An interface can only define members, not implement them.  
