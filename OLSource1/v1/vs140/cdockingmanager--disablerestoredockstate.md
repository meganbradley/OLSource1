...
#### Parameters  
 ...
 <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> to disable loading of docking layout from the registry; otherwise, <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>.  
