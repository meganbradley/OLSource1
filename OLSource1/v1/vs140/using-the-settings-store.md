...
2.  In <CodeContentPlaceHolder>4\</CodeContentPlaceHolder>, remove the body of the method, and add these lines get the configuration settings store:  
