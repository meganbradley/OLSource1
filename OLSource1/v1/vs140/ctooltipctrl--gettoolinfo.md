...
#### Parameters  
 *ToolInfo*  
 Reference to a <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> object that receives the tool's text.  
...
## Remarks  
 The **hwnd** and **uId** members of the [TOOLINFO](http://msdn.microsoft.com/library/windows/desktop/bb760256) structure referenced by *CToolInfo* identify the tool. If that tool has been registered with the tool tip control through a previous call to <CodeContentPlaceHolder>4\</CodeContentPlaceHolder>, the <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> structure is filled with information about the tool.  
