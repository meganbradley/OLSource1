...
## Return Value  
 Returns <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> if tooltip information is returned, and <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> otherwise.  
