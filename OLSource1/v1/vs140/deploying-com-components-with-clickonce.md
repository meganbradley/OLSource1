...
2.  In the **New Project** dialog box, select the **Visual Basic** node and select an **ActiveX DLL** project. In the **Name** box, type <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>.  
...
4.  In Class1.vb, add the following code after the generated code for the <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> method:  
...
2.  In the **New Project** dialog box, select the **Visual Basic** node and select **Windows Application**. In the **Name** box, type <CodeContentPlaceHolder>5\</CodeContentPlaceHolder>.  
...
> [!NOTE]
>  You can simulate the absence of a COM component by temporarily unregistering it. Open a command prompt, go to your system folder by typing <CodeContentPlaceHolder>6\</CodeContentPlaceHolder>, then unregister the component by typing <CodeContentPlaceHolder>7\</CodeContentPlaceHolder>. You can register it again by typing <CodeContentPlaceHolder>8\</CodeContentPlaceHolder>.  
