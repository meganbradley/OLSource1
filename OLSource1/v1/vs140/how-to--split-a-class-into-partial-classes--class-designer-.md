...
You can divide the declaration of a class or structure among several declarations by using the <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> keyword in Visual Basic or the <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> keyword in Visual C#. You can use as many partial declarations as you want, in as many different source files as you want, or in one source file. However, all the declarations must be in the same assembly and the same namespace.  
 ...
 The following examples split the definition of class <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> into two declarations, each of which defines a different procedure. The two partial definitions in the examples could be in one source file or in two different source files.  
  
> [!NOTE]
>  Visual Basic uses partial-class definitions to separate Visual Studio—generated code from user-authored code. The code is separated into discrete source files. For example, the **Windows Form Designer** defines partial classes for controls such as <CodeContentPlaceHolder>5\</CodeContentPlaceHolder>. You should not modify the generated code in these controls.  
  
 For more information about partial types in Visual Basic, see [Partial (Visual Basic)](../vs140/partial--visual-basic-.md).  
  
## Example  
 To split a class definition in Visual Basic, use the <CodeContentPlaceHolder>6\</CodeContentPlaceHolder> keyword, as shown in the following example.  
  
<CodeContentPlaceHolder>0\</CodeContentPlaceHolder>  
## Example  
 To split a class definition in Visual C#, use the <CodeContentPlaceHolder>7\</CodeContentPlaceHolder> keyword, as shown in the following example.  
...
## See Also  
 ...
 [partial (Method)](../vs140/partial--method---csharp-reference-.md)   
