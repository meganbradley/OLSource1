 ...
 *argument-expression-list*  **,**  *assignment-expression*  
 ...
 A function-call expression has the value and type of the function's return value. A function cannot return an object of array type. If the function's return type is <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> (that is, the function has been declared never to return a value), the function-call expression also has <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> type. (See [Function Calls](../vs140/function-calls.md) for more information.)  
