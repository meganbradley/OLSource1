...
## Notes for Implementers  
 ...
 If the port supports sending port events, it must also implement the \<xref:System.Runtime.InteropServices.ComTypes.IConnectionPointContainer*> interface to support an \<xref:System.Runtime.InteropServices.ComTypes.IConnectionPoint*> interface that in turn provides the [IDebugPortEvents2](../vs140/idebugportevents2.md) interface.  
