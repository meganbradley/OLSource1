...
The object variable declared with the <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> keyword does not refer to a class instance that can raise events.  
