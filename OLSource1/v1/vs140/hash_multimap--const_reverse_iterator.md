...
ms.topic: "article"
f1_keywords: 
  - "std.hash_multimap.const_reverse_iterator"
...
## Remarks  
 A type <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> cannot modify the value of an element and is use to iterate through the hash_multimap in reverse.  
 ...
 To dereference a <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> pointing to an element in a hash_multimap, use the **->** operator.  
...
## Example  
 See the example for [rend](../vs140/hash_multimap--rend.md) for an example of how to declare and use the <CodeContentPlaceHolder>10\</CodeContentPlaceHolder>.  
