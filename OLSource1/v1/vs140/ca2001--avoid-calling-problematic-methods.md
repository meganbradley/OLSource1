...
|Method|Description|  
|------------|-----------------|  
|[GC.Collect](assetId:///M:System.GC.Collect(System.Int32,System.GCCollectionMode)?qualifyHint=True&autoUpgrade=True)|Calling GC.Collect can significantly affect application performance and is rarely necessary. For more information, see the [Rico Mariani's Performance Tidbits](http://go.microsoft.com/fwlink/?LinkId=169256) blog entry on MSDN.|  
...
|<xref:System.Runtime.InteropServices.SafeHandle.DangerousGetHandle*?displayProperty=fullName>|The DangerousGetHandle method poses a security risk because it can return a handle that is not valid. See the [DangerousAddRef](assetId:///M:System.Runtime.InteropServices.SafeHandle.DangerousAddRef(System.Boolean@)?qualifyHint=False&autoUpgrade=True) and the <xref:System.Runtime.InteropServices.SafeHandle.DangerousRelease*> methods for more information about how to use the DangerousGetHandle method safely.|  
|[Assembly.LoadFrom](assetId:///M:System.Reflection.Assembly.LoadFrom(System.String)?qualifyHint=True&autoUpgrade=True)<br /><br /> [Assembly.LoadFile](assetId:///M:System.Reflection.Assembly.LoadFile(System.String)?qualifyHint=True&autoUpgrade=True)<br /><br /> [Assembly.LoadWithPartialName](assetId:///M:System.Reflection.Assembly.LoadWithPartialName(System.String)?qualifyHint=True&autoUpgrade=True)|These methods can load assemblies from unexpected locations. For example, see Suzanne Cook's .NET CLR Notes blog posts [LoadFile vs. LoadFrom](http://go.microsoft.com/fwlink/?LinkId=164450) and [Choosing a Binding Context](http://go.microsoft.com/fwlink/?LinkId=164451) on the MSDN Web site for information about methods that load assemblies.|  
