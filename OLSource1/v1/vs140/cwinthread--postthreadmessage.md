...
---
# CWinThread::PostThreadMessage
Called to post a user-defined message to another <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> object.  
...
## Remarks  
 The posted message is mapped to the proper message handler by the message map macro <CodeContentPlaceHolder>5\</CodeContentPlaceHolder>.  
