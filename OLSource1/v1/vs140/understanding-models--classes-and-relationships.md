...
## The DSL Definition  
 When you open <CodeContentPlaceHolder>0\</CodeContentPlaceHolder>, your [!INCLUDE[vsprvs](../vs140/includes/vsprvs_md.md)] window resembles the following picture.  
...
## Multiplicities  
 ...
 Configure the multiplicity of a role either by typing on the diagram or by modifying the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> property in the **Properties** window. The following table describes the settings for this property.  
