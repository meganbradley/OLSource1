...
-   The <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> and <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> attributes, and the <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>[version](assetId:///66ac5cf3-2230-44fd-aaf6-8013e4a4ae81) attribute value are important parts of the MIDL definition for a Media Foundation component that uses [!INCLUDE[cppwrl_short](../vs140/includes/cppwrl_short_md.md)].  
...
-   The [InspectableClass](../vs140/inspectableclass-macro.md) macro implements basic COM functionality such as reference counting and the <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> method, and sets the runtime class name and trust level.  
...
1.  In Visual Studio, create a **Blank Solution** project. Name the project, for example, <CodeContentPlaceHolder>4\</CodeContentPlaceHolder>.  
  
2.  Add a **DLL (Windows Store apps)** project to the solution. Name the project, for example, <CodeContentPlaceHolder>5\</CodeContentPlaceHolder>.  
  
3.  Add a **Midl File (.idl)** file to the project. Name the file, for example, <CodeContentPlaceHolder>6\</CodeContentPlaceHolder>.  
...
6.  Add a new header file to the project, name it <CodeContentPlaceHolder>7\</CodeContentPlaceHolder>, and then add this code:  
...
9. Add a new module-definition file to the project, name it <CodeContentPlaceHolder>8\</CodeContentPlaceHolder>, and then add this code:  
...
11. In the project’s **Property Pages** dialog box, set the following **Linker** properties.  
    ...
    1.  Under **Input**, for the **Module Definition File**, specify <CodeContentPlaceHolder>9\</CodeContentPlaceHolder>.  
  
    2.  Also under **Input**, add <CodeContentPlaceHolder>10\</CodeContentPlaceHolder>, <CodeContentPlaceHolder>11\</CodeContentPlaceHolder>, and <CodeContentPlaceHolder>12\</CodeContentPlaceHolder> to the **Additional Dependencies** property.  
...
1.  Add a new **C# Blank App (XAML)** project to the <CodeContentPlaceHolder>13\</CodeContentPlaceHolder> solution. Name the project, for example, <CodeContentPlaceHolder>14\</CodeContentPlaceHolder>.  
  
2.  In the **MediaCapture** project, add a reference to the <CodeContentPlaceHolder>15\</CodeContentPlaceHolder> project. To learn how, see [How to: Add or Remove References By Using the Reference Manager](../vs140/how-to--add-or-remove-references-by-using-the-reference-manager.md).  
