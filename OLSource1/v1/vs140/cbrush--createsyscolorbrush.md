...
## Remarks  
 ...
 When an application has finished using the brush created by <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>, it should select the brush out of the device context.  
