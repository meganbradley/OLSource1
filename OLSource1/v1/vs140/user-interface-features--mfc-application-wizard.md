...
|**Child maximized**|Specifies whether a child window is initially maximized by setting the cs.style flag **WS_MAXIMIZE** in the [PreCreateWindow](../vs140/cwnd--precreatewindow.md) member function of <CodeContentPlaceHolder>0\</CodeContentPlaceHolder>.|  
