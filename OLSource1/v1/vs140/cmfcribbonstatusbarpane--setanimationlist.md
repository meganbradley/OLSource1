...
## Return Value  
 <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> if the image list is successfully attached to the status bar pane; <CodeContentPlaceHolder>6\</CodeContentPlaceHolder> otherwise.  
