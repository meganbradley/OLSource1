...
This walkthrough shows how to add a menu to the menu bar of the Visual Studio integrated development environment (IDE). The IDE menu bar contains menu categories such as **File**, **Edit**, **View**, **Window**, and **Help**.  
 ...
 Menus are declared in the .vsct file of the project. For more information about menus and .vsct files, see [Menu and Toolbar Commands](../vs140/commands--menus--and-toolbars.md).  
...
1.  Create a VSIX project named <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>. You can find the VSIX project template in the **New Project** dialog under **Visual C#** / **Extensibility**.  For more information, see [Creating a VSPackage with a Menu Command](../vs140/creating-an-extension-with-a-menu-command.md).  
...
<CodeContentPlaceHolder>1\</CodeContentPlaceHolder>  
     The <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> and <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> values of the menu specify the command set and the specific menu in the command set.  
  
     The <CodeContentPlaceHolder>6\</CodeContentPlaceHolder> and <CodeContentPlaceHolder>7\</CodeContentPlaceHolder> values of the parent position the menu on the section of the Visual Studio menu bar that contains the Tools and Add-ins menus.  
  
     The value of the <CodeContentPlaceHolder>8\</CodeContentPlaceHolder> string specifies that the text should appear in the menu item.  
...
4.  Find the <CodeContentPlaceHolder>9\</CodeContentPlaceHolder> section. Notice that the [!INCLUDE[vsprvs](../vs140/includes/vsprvs_md.md)] Package template has generated a <CodeContentPlaceHolder>10\</CodeContentPlaceHolder> element that has its parent set to <CodeContentPlaceHolder>11\</CodeContentPlaceHolder>. As a result, this command will appear on your menu.  
