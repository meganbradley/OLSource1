...
> [!NOTE]
>  Previous to MFC 7.0, <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> returned a pointer to <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>. If you have code that calls <CodeContentPlaceHolder>4\</CodeContentPlaceHolder>, you need to change the return type to the templatized class **CRowset<>**.  
