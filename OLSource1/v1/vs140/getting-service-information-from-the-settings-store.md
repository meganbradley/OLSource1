...
## Finding a Specific Service  
 You can also use the [CollectionExists](assetId:///M:Microsoft.VisualStudio.Settings.SettingsStore.CollectionExists(System.String)?qualifyHint=False&autoUpgrade=True) method to determine whether a particular service is installed. You must know the type of the service class.  
