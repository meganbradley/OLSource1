...
-   Integer arithmetic overflow either throws an <xref:System.OverflowException?qualifyHint=False> or discards the most significant bits of the result. Integer division by zero always throws a `DivideByZeroException`.  
