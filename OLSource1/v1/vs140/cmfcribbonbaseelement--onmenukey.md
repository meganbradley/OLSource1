...
## Remarks  
 By default this method always returns <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>. Override this method to respond when a user presses a menu keytip on the main panel.  
