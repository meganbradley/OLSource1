...
#### Parameters  
 ...
 [out] Returns <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> if the section can be discarded from memory as needed; otherwise, returns <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>.  
