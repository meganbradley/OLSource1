...
This example shows how to import the XML namespace prefix <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> and use it in an XML literal and XML axis properties.  
  
## Example  
 [!code[VbXMLSamples#8](../vs140/codesnippet/VisualBasic/how-to--declare-and-use-xml-namespace-prefixes--visual-basic-_1.vb)]  
