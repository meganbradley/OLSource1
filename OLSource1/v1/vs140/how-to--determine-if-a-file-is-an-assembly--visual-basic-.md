...
1.  Call the [GetAssemblyName](assetId:///M:System.Reflection.AssemblyName.GetAssemblyName(System.String)?qualifyHint=False&autoUpgrade=True) method, passing the full file path and name of the file you are testing.  
...
```  
 ...
 The assetId:///M:System.Reflection.AssemblyName.GetAssemblyName(System.String)?qualifyHint=False&autoUpgrade=True method loads the test file, and then releases it once the information is read.  
