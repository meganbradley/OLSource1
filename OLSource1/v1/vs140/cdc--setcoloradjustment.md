...
## Remarks  
 The color adjustment values are used to adjust the input color of the source bitmap for calls to the <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> member function when **HALFTONE** mode is set.  
