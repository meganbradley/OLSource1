...
|Access Modifier|The level of access of the class (<CodeContentPlaceHolder>0\</CodeContentPlaceHolder> or <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>).|Public|  
...
|Inheritance Modifier|Describes the kind of inheritance of the source code class that is generated from the connector (<CodeContentPlaceHolder>4\</CodeContentPlaceHolder>, <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> or <CodeContentPlaceHolder>6\</CodeContentPlaceHolder>).|none|  
...
|Tooltip Type|How the tooltip is defined (fixed, variable, or none). If fixed, then the value of the <CodeContentPlaceHolder>7\</CodeContentPlaceHolder> property is used as the tooltip; if variable, then the tooltip is defined in custom code.|\<none>|  
|Notes|Informal notes that are associated with this connector.|\<none>|  
|Routing Style|The style that is used for routing the connector. A <CodeContentPlaceHolder>8\</CodeContentPlaceHolder> connector makes right-angled turns as required; a <CodeContentPlaceHolder>9\</CodeContentPlaceHolder> connector does not.|Rectilinear|  
|Exposed Color As Property\<br />\<br /> Exposed Dash Style As Property\<br />\<br /> Exposed Thickness As Property\<br />\<br /> Exposes Text Color|If <CodeContentPlaceHolder>10\</CodeContentPlaceHolder>, the user can set the stated property of a shape. To set this, right-click the shape definition and click **Add Exposed**.|False|  
