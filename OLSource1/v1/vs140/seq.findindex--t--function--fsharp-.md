...
Returns the index of the first element for which the given function returns <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>.  
...
## Return Value  
 The index of the first element for which the given function returns <CodeContentPlaceHolder>6\</CodeContentPlaceHolder>.  
