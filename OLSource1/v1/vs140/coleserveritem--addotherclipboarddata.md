...
---
# COleServerItem::AddOtherClipboardData
Call this function to place the presentation and conversion formats for the OLE item in the specified <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> object.  
...
#### Parameters  
 ...
 Pointer to the <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> object in which the data should be placed.  
