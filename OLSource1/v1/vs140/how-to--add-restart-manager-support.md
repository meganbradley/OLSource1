...
3.  Find the constructor for your main application. For example, if your project is MyProject, the constructor is <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>.  
  
4.  Add the following line of code to your constructor.  
  
<CodeContentPlaceHolder>0\</CodeContentPlaceHolder>  
5.  Make sure the <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> method of your application calls its parent <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> method: [CWinApp::InitInstance](../vs140/cwinapp--initinstance.md) or <CodeContentPlaceHolder>4\</CodeContentPlaceHolder>. The <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> method is responsible for checking the <CodeContentPlaceHolder>6\</CodeContentPlaceHolder> parameter.  
