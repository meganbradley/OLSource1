...
##  <a name="BKMK_TaskTReturnType"></a> Task(T) Return Type  
 The <xref:System.Threading.Tasks.Task`1*> return type is used for an async method that contains a [Return](../vs140/return-statement--visual-basic-.md) statement in which the operand has type `TResult`.  
