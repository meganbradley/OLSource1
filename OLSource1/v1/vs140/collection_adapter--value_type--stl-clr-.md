...
## Remarks  
 The type is a synonym for the template parameter <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>, if present in the specialization; otherwise it is a synonym for <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>.  
