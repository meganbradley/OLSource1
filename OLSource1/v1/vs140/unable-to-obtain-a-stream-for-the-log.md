...
1.  Set the \<xref:Microsoft.VisualBasic.Logging.FileLogTraceListener.LogFileCreationSchedule*> property to \<xref:Microsoft.VisualBasic.Logging.LogFileCreationScheduleOption.Daily*> or \<xref:Microsoft.VisualBasic.Logging.LogFileCreationScheduleOption.Weekly*> to include a date-stamp in the log file name.  
