...
-   A jagged array is an array of arrays, and therefore its elements are reference types and are initialized to <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>.  
  
-   Arrays are zero indexed: an array with <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> elements is indexed from <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> to <CodeContentPlaceHolder>4\</CodeContentPlaceHolder>.  
  
-   Array elements can be of any type, including an array type.  
  
-   Array types are [reference types](../vs140/reference-types--csharp-reference-.md) derived from the abstract base type \<xref:System.Array*>. Since this type implements \<xref:System.Collections.IEnumerable*> and \<xref:System.Collections.Generic.IEnumerable`1*>, you can use [foreach](../vs140/foreach--in--csharp-reference-.md) iteration on all arrays in C#.  
