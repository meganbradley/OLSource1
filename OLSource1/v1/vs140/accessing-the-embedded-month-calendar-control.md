...
The embedded month calendar control object can be accessed from the <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> object with a call to the [GetMonthCalCtrl](../vs140/cdatetimectrl--getmonthcalctrl.md) member function.  
