...
#### Parameters  
 ...
 <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>t  
 A <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> mask that indicates the new values for the control bits specified by the <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> mask. This parameter can be a combination of the flags listed for the <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> parameter.  
