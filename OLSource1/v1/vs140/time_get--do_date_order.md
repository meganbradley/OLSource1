...
f1_keywords: 
  ...
  - "do_date_order"
  - "time_get.do_date_order"
  - "xloctime/std::time_get::do_date_order"
dev_langs: 
  - "C++"
helpviewer_keywords: 
  - "do_date_order method"
...
## Example  
 See the example for [date_order](../vs140/time_get--date_order.md), which calls <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>.  
