...
-   [RFX](../vs140/record-field-exchange--rfx-.md) for recordsets of class <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> (ODBC).  
  
-   DFX for recordsets of class <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> (DAO).  
