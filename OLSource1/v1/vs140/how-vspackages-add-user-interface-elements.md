...
-   A UI element that is defined by using the `DefaultInvisible` flag will not be displayed in the IDE unless it is either displayed by its VSPackage implementation of the [QueryStatus](assetId:///M:EnvDTE.IDTCommandTarget.QueryStatus(System.String,EnvDTE.vsCommandStatusTextWanted,EnvDTE.vsCommandStatus@,System.Object@)?qualifyHint=False&autoUpgrade=True) method, or associated with a particular UI context in the `VisibilityConstraints` section.  
