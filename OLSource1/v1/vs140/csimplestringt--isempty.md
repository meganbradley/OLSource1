...
---
# CSimpleStringT::IsEmpty
Tests a <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> object for the empty condition.  
  
## Syntax  
  
<CodeContentPlaceHolder>0\</CodeContentPlaceHolder>  
## Return Value  
 Returns **true** if the <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> object has 0 length; otherwise **false**.  
