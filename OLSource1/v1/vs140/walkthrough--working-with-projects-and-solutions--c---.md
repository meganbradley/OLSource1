...
4.  The Cardgame.h file is opened in the editor. Make these changes:  
    ...
    -   Add two private data members after the opening brace of the class definition.  
         ...
         [!code[NVC_Walkthrough_Working_With_Projects#100](../vs140/codesnippet/CPP/walkthrough--working-with-projects-and-solutions--c---_1.h)]  
  
    -   Modify the default constructor that Visual Studio generated. After the <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> access specifier, find the line that looks like this:  
  
         <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>  
  
         Modify it to take one parameter of type <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>, named **players**.  
  
         [!code[NVC_Walkthrough_Working_With_Projects#101](../vs140/codesnippet/CPP/walkthrough--working-with-projects-and-solutions--c---_2.h)]  
    ...
    -   After the default destructor, add an inline declaration for a static int member function named **GetParticipants** that takes no parameters and returns the **totalParticipants** value.  
         ...
         [!code[NVC_Walkthrough_Working_With_Projects#102](../vs140/codesnippet/CPP/walkthrough--working-with-projects-and-solutions--c---_3.h)]  
  
5.  The Cardgame.h file should resemble this after you change it:  
  
     [!code[NVC_Walkthrough_Working_With_Projects#103](../vs140/codesnippet/CPP/walkthrough--working-with-projects-and-solutions--c---_4.h)]  
  
     The line <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> tells the compiler to include the file only one time. For more information, see [once](../vs140/once.md).  
...
7.  Delete everything in the file and replace it with this code:  
     ...
     [!code[NVC_Walkthrough_Working_With_Projects#111](../vs140/codesnippet/CPP/walkthrough--working-with-projects-and-solutions--c---_5.cpp)]  
  
    > [!NOTE]
    >  You can use auto-completion when you are entering code. For example, if you were entering this code, you could enter **pl** or **tot** and then press Ctrl+Spacebar so that auto-completion finishes entering <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> or <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> for you.  
  
     For information about <CodeContentPlaceHolder>6\</CodeContentPlaceHolder>, see [The #include Directive](../vs140/sharpinclude-directive--c-c---.md).  
...
3.  In the TestGames.cpp editing window, enter the following code.  
     ...
     [!code[NVC_Walkthrough_Working_With_Projects#120](../vs140/codesnippet/CPP/walkthrough--working-with-projects-and-solutions--c---_6.cpp)]  
