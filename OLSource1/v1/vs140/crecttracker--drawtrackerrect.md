...
---
# CRectTracker::DrawTrackerRect
Called by the framework whenever the position of the tracker has changed while inside the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> or <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> member function.  
...
#### Parameters  
 ...
 Pointer to the <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> that contains the rectangle to draw.  
...
## Remarks  
 The default implementation makes a call to <CodeContentPlaceHolder>8\</CodeContentPlaceHolder>, which draws a dotted rectangle.  
