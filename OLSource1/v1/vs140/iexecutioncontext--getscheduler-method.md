...
## Return Value  
 An <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> interface.  
  
## Remarks  
 You are required to initialize the execution context with a valid <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> interface before you use it as a parameter to methods supplied by the Resource Manager.  
