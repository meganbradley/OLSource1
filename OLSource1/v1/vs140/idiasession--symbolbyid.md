...
## Example  
 This example retrieves an [IDiaSymbol](../vs140/idiasymbol.md) representing the type of another symbol. This example shows how to use the <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> method in the session. A simpler approach is to call the [IDiaSymbol::get_type](../vs140/idiasymbol--get_type.md) method to retrieve the type symbol directly.  
