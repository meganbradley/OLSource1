...
> [!IMPORTANT]
>  Any object that supports <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> is responsible for its own security, and that of any object it delegates. The programmer must take into account issues arising from running code in the user's context, cross-site scripting and perform suitable zone checking.  
