...
## In This Section  
 ...
 Describes how to use the <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> and <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> methods of the <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> object to create a registry key and set its value.  
  
 [How to: Read a Value from a Registry Key in Visual Basic](../vs140/how-to--read-a-value-from-a-registry-key-in-visual-basic.md)  
 Describes how to use the <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> method of the <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> object to read a value from a registry key.  
  
 [How to: Delete a Registry Key in Visual Basic](../vs140/how-to--delete-a-registry-key-in-visual-basic.md)  
 Describes how to use the <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> method of the <CodeContentPlaceHolder>6\</CodeContentPlaceHolder> property to delete a registry key.  
 ...
 Describes how to use the <CodeContentPlaceHolder>7\</CodeContentPlaceHolder> and <CodeContentPlaceHolder>8\</CodeContentPlaceHolder> classes of the [!INCLUDE[dnprdnshort](../vs140/includes/dnprdnshort_md.md)] to access the registry.  
...
## Related Sections  
 ...
 Lists and explains members of the <CodeContentPlaceHolder>9\</CodeContentPlaceHolder> object.  
  
 \<xref:Microsoft.Win32.Registry*>  
 Presents an overview of the <CodeContentPlaceHolder>10\</CodeContentPlaceHolder> class, along with links to individual keys and members.