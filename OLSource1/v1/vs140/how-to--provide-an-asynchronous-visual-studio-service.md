...
-   If you are autoloading the package, you must add the <xref:Microsoft.VisualStudio.Shell.PackageAutoLoadFlags?qualifyHint=False> BackgroundLoad value to the attribute. For more information about autoloading VSPackages, see [Loading VSPackages](../vs140/loading-vspackages.md).  
