...
---
# CWindow::DestroyWindow
Destroys the window associated with the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> object and sets [m_hWnd](../vs140/cwindow--m_hwnd.md) to **NULL**.  
...
## Remarks  
 ...
 It does not destroy the <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> object itself.  
