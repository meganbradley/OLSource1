 ...
 **READYSTATE_INTERACTIVE**  
 ...
 [InternalSetReadyState](../vs140/colecontrol--internalsetreadystate.md) changes the ready state to the value supplied, then calls <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>.  
