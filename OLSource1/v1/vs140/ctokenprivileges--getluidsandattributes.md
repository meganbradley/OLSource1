...
---
# CTokenPrivileges::GetLuidsAndAttributes
Retrieves the locally unique identifiers (LUIDs) and attribute flags from the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> object.  
...
## Remarks  
 This method will enumerate all of the privileges contained in the <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> access token object and place the individual LUIDs and (optionally) the attribute flags into array objects.  
