...
## Example  
 Sometimes it is useful to have data about the characters in your string and the positions of those characters within your string. You can think of a string as an array of characters (<CodeContentPlaceHolder>0\</CodeContentPlaceHolder> instances); you can retrieve a particular character by referencing the index of that character through the \<xref:System.String.Chars*> property.  
  
 [!code[VbVbalrStrings#49](../vs140/codesnippet/VisualBasic/how-to--access-characters-in-strings-in-visual-basic_1.vb)]  
  
 The <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> parameter of the \<xref:System.String.Chars*> property is zero-based.  
...
## Robust Programming  
 ...
 The \<xref:System.String.Chars*> property throws an \<xref:System.IndexOutOfRangeException*> exception if the <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> parameter is greater than or equal to the length of the string, or if it is less than zero  
