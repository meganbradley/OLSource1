...
-   You can programmatically obtain information about an assembly by using reflection. For more information, see [Reflection (C#)](../vs140/reflection--csharp-.md).  
...
## Adding a Reference to an Assembly  
 To use an assembly, you must add a reference to it. Next, you use the [using directive](../vs140/using-directive--csharp-reference-.md) to choose the namespace of the items you want to use. Once an assembly is referenced and imported, all the accessible classes, properties, methods, and other members of its namespaces are available to your application as if their code were part of your source file.  
  
 In C#, you can also use two versions of the same assembly in a single application. For more information, see [extern alias](../vs140/extern-alias--csharp-reference-.md).  
  
## Creating an Assembly  
 Compile your application by clicking **Build** on the **Build** menu or by building it from the command line using the command-line compiler. For details about building assemblies from the command line, see [Command-line Building With csc.exe](../vs140/command-line-building-with-csc.exe.md).  
...
## See Also  
 ...
 [How to: Share an Assembly with Other Applications (C#)](../vs140/how-to--share-an-assembly-with-other-applications--csharp-.md)   
 [How to: Load and Unload Assemblies (C#)](../vs140/how-to--load-and-unload-assemblies--csharp-.md)   
 [How to: Determine If a File Is an Assembly (C#)](../vs140/how-to--determine-if-a-file-is-an-assembly--csharp-.md)   
 [How to: Create and Use Assemblies Using the Command Line (C#)](../vs140/how-to--create-and-use-assemblies-using-the-command-line--csharp-.md)   
 [Walkthrough: Embedding Types from Managed Assemblies (C#)](../vs140/walkthrough--embedding-types-from-managed-assemblies-in-visual-studio--csharp-.md)   
 [Walkthrough: Embedding Type Information from Microsoft Office Assemblies (C#)](../vs140/walkthrough--embedding-type-information-from-microsoft-office-assemblies-in-visual-studio--csharp-.md)