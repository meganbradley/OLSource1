...
12. With AutoClik.Document still selected in the **OLE Classes** list box, choose the **Remote** command from the <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> menu.  
