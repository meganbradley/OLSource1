...
5.  You must also add a `TagsChanged` event that will be called by the update method.  
     ...
     [!code[VSSDKHighlightWordTest#10](../vs140/codesnippet/CSharp/walkthrough--highlighting-text_1.cs)][!code[VSSDKHighlightWordTest#10](../vs140/codesnippet/VisualBasic/walkthrough--highlighting-text_1.vb)]  
...
8.  You must implement the [GetTags](assetId:///M:Microsoft.VisualStudio.Text.Tagging.ITagger`1.GetTags(Microsoft.VisualStudio.Text.NormalizedSnapshotSpanCollection)?qualifyHint=False&autoUpgrade=True) method. This method takes a collection of <xref:Microsoft.VisualStudio.Text.SnapshotSpan*> objects and returns an enumeration of tag spans.  
