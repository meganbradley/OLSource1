...
|To|See|  
|--------|---------|  
|Determine whether the mouse has a scroll wheel.|<xref:Microsoft.VisualBasic.Devices.Mouse.WheelExists?qualifyHint=False>|  
|Determine whether the left and right mouse buttons have been swapped|<xref:Microsoft.VisualBasic.Devices.Mouse.ButtonsSwapped?qualifyHint=False>|  
|Set how much to scroll when the mouse wheel is rotated one notch.|<xref:Microsoft.VisualBasic.Devices.Mouse.WheelScrollLines?qualifyHint=False>|  
