...
## Remarks  
 This interface can be used instead of most of the other symbol provider interfaces. It provides direct access to the metadata and <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> interfaces.  
