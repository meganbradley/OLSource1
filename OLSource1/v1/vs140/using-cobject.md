...
---
# Using CObject
[CObject](../vs140/cobject-class.md) is the root base class for most of the Microsoft Foundation Class Library (MFC). The <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> class contains many useful features that you may want to incorporate into your own program objects, including serialization support, run-time class information, and object diagnostic output. If you derive your class from <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>, your class can exploit these <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> features.  
