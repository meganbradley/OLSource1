...
|Member|Description|  
|------------|-----------------|  
|[new](../vs140/optimizedclosures.fsharpfunc--t1--t2--t3--t4--t5--u--constructor--fsharp-.md)|Construct an optimized function value that can accept five curried arguments without intervening execution.|  
  
## Instance Members  
  
|Member|Description|  
|------------|-----------------|  
|[Invoke](../vs140/fsharpfunc.invoke--t1--t2--t3--t4--t5--u--method--fsharp-.md)|Invoke an F# first class function value that accepts five curried arguments without intervening execution|  
  
## Static Members  
  
|Member|Description|  
|------------|-----------------|  
|[Adapt](../vs140/fsharpfunc.adapt--t1--t2--t3--t4--t5--u--method--fsharp-.md)|Adapt an F# first class function value to be an optimized function value that can accept five curried arguments without intervening execution.|  
