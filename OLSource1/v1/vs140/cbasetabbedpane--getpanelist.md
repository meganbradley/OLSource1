...
#### Parameters  
 ...
 A <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> that is filled with the panes that are contained in the tabbed pane.  
  
 [in] <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>  
 If it is not <CodeContentPlaceHolder>4\</CodeContentPlaceHolder>, the returned list contains only panes that are of the specified runtime class.  
