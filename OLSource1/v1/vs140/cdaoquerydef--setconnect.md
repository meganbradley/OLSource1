...
>  The preferred way to work with ODBC tables is to attach them to an .MDB database.  
 ...
 Before executing a querydef that represents a SQL pass-through query to an ODBC data source, set the connection string with <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> and call [SetReturnsRecords](../vs140/cdaoquerydef--setreturnsrecords.md) to specify whether the query returns records.  
