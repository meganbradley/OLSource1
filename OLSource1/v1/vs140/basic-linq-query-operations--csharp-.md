...
> [!NOTE]
>  For non-generic data sources such as <xref:System.Collections.ArrayList?qualifyHint=False>, the range variable must be explicitly typed. For more information, see [How to: Query an ArrayList with LINQ (C#)](../vs140/how-to--query-an-arraylist-with-linq--csharp-.md) and [from clause (C# Reference)](../vs140/from-clause--csharp-reference-.md).  
