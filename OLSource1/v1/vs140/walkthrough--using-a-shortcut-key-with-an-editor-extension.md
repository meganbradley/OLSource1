...
4.  Change the [TextViewCreated](assetId:///M:Microsoft.VisualStudio.Text.Editor.IWpfTextViewCreationListener.TextViewCreated(Microsoft.VisualStudio.Text.Editor.IWpfTextView)?qualifyHint=False&autoUpgrade=True) method so that it adds the `KeyBindingCommandFilter`.  
