...
2.  Manually add the following to your document's message map:  
     ...
     [!code[NVC_MFCDocView#9](../vs140/codesnippet/CPP/mapi-support-in-mfc_1.cpp)]  
...
3.  Build your application.  
 ...
 If mail support is available, MFC enables your menu item with <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> and subsequently processes the command with <CodeContentPlaceHolder>6\</CodeContentPlaceHolder>. If mail support is not available, MFC automatically removes your menu item so the user will not see it.  
