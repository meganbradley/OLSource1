...
## Remarks  
 If the return value of **back** is assigned to a <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>, the queue object cannot be modified. If the return value of **back** is assigned to a **reference**, the queue object can be modified.  
