...
---
# CRect::CopyRect
Copies the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> rectangle into <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>.  
...
#### Parameters  
 ...
 Points to the [RECT](../vs140/rect-structure.md) structure or <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> object that is to be copied.  
