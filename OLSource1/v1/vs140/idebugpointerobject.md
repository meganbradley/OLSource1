...
## Notes for Callers  
 The [IDebugObject](../vs140/idebugobject.md) interface can obtain this interface by using [QueryInterface](../vs140/queryinterface.md) if the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> represents a pointer.  
