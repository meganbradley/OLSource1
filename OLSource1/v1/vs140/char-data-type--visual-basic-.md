...
## Unicode Characters  
 ...
 You can use methods like [IsDigit](assetId:///M:System.Char.IsDigit(System.Char)?qualifyHint=False&autoUpgrade=True) and [IsPunctuation](assetId:///M:System.Char.IsPunctuation(System.Char)?qualifyHint=False&autoUpgrade=True) on a `Char` variable to determine its Unicode classification.  
  
## Type Conversions  
 Visual Basic does not convert directly between `Char` and the numeric types. You can use the [Asc](assetId:///M:Microsoft.VisualBasic.Strings.Asc(System.Char)?qualifyHint=False&autoUpgrade=True) or [AscW](assetId:///M:Microsoft.VisualBasic.Strings.AscW(System.Char)?qualifyHint=False&autoUpgrade=True) function to convert a `Char` value to an `Integer` that represents its code point. You can use the [Chr](assetId:///M:Microsoft.VisualBasic.Strings.Chr(System.Int32)?qualifyHint=False&autoUpgrade=True) or [ChrW](assetId:///M:Microsoft.VisualBasic.Strings.ChrW(System.Int32)?qualifyHint=False&autoUpgrade=True) function to convert an `Integer` value to a `Char` that has that code point.  
...
## See Also  
 ...
 assetId:///M:Microsoft.VisualBasic.Strings.Asc(System.Char)?qualifyHint=False&autoUpgrade=True   
 assetId:///M:Microsoft.VisualBasic.Strings.AscW(System.Char)?qualifyHint=False&autoUpgrade=True   
 assetId:///M:Microsoft.VisualBasic.Strings.Chr(System.Int32)?qualifyHint=False&autoUpgrade=True   
 assetId:///M:Microsoft.VisualBasic.Strings.ChrW(System.Int32)?qualifyHint=False&autoUpgrade=True   
