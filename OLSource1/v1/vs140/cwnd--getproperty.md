...
---
# CWnd::GetProperty
Call this member function to get the ActiveX control property specified by <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>.  
...
#### Parameters  
 ...
 Address of the variable that will that will receive the property value. It must match the type specified by <CodeContentPlaceHolder>5\</CodeContentPlaceHolder>.  
  
## Remarks  
 **GetProperty** returns the value through <CodeContentPlaceHolder>6\</CodeContentPlaceHolder>.  
  
> [!NOTE]
>  This function should be called only on a <CodeContentPlaceHolder>7\</CodeContentPlaceHolder> object that represents an ActiveX control.  
