...
1.  Create a VSIX project named <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> with a menu command named **ChangeMenuText**. For more information, see [Creating a VSPackage with a Menu Command](../vs140/creating-an-extension-with-a-menu-command.md).  
  
2.  In the .vstc file, add the <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> flag to your menu command, as shown in the following example.  
