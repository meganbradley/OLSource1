...
## Remarks  
 ...
 The <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> variable that will be initialized with the value of the variable in the master thread, as it exists before the parallel construct.  
...
## Example  
 See [threadprivate](../vs140/threadprivate.md) for an example of using <CodeContentPlaceHolder>4\</CodeContentPlaceHolder>.  
