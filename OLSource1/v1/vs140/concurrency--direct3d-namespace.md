...
|Name|Description|  
|----------|-----------------|  
|[scoped_d3d_access_lock Class](../vs140/scoped_d3d_access_lock-class.md)|An RAII wrapper for a D3D access lock on an <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> object.|  
