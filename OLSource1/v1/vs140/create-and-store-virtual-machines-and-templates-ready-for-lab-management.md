...
-   Convert the virtual machine into a template and store the template in the team project library.  
 ...
 ![Components of an integrated Lab Management setup](../vs140/media/labcomponentsextended.png "LabComponentsExtended")  
...
5.  Enable remote desktop connections to this virtual machine.  
     ...
     This enables guest-based connections to the virtual machine. For more information about the types of connections, see [How to: Connect to a Virtual Environment](assetId:///1a1a9408-5310-4201-9bdc-424378cd5080).  
...
1.  Install a test agent on your virtual machine. You can find the test agent on the same DVD from which you installed Team Foundation Server.  
     ...
     You do not have to register your test agent with a test controller when you install your test agent. This will be done automatically when the virtual machine is deployed by [!INCLUDE[vstsLabShort](../vs140/includes/vstslabshort_md.md)].  
...
## See Also  
 ...
 [Setting Up Virtual Environments for Testing and Development](assetId:///19105786-2a8b-4afd-94ea-102cfe3c01bf)   
 [How to: Create an Environment Using Network Isolation](../vs140/creating-and-using-a-network-isolated-environment.md)