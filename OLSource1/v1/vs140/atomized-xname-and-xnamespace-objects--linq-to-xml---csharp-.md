...
```  
 ...
 The following example passes an <xref:System.Xml.Linq.XName*> to the [Descendants](assetId:///M:System.Xml.Linq.XContainer.Descendants(System.Xml.Linq.XName)?qualifyHint=False&autoUpgrade=True) method call, which then has better performance because of the atomization pattern.  
