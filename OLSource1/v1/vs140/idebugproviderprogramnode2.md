...
## Notes for Callers  
 Call [QueryInterface](../vs140/queryinterface.md) on an <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> interface to obtain this interface. If this interface cannot be obtained, the DE does not support marshaling of interfaces.  
...
|Method|Description|  
|------------|-----------------|  
|[UnmarshalDebuggeeInterface](../vs140/idebugproviderprogramnode2--unmarshaldebuggeeinterface.md)|Gets a specified interface across process boundaries.|  
