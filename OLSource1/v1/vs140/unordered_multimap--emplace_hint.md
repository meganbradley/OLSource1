...
ms.topic: "article"
f1_keywords: 
  - "unordered_map/std::tr1::unordered_multimap::emplace_hint"
  - "unordered_multimap::emplace_hint"
  - "unordered_multimap.emplace_hint"
  - "std.tr1.unordered_multimap.emplace_hint"
  - "std::tr1::unordered_multimap::emplace_hint"
dev_langs: 
  - "C++"
helpviewer_keywords: 
...
|<CodeContentPlaceHolder>1\</CodeContentPlaceHolder>|The arguments forwarded to construct an element to be inserted into the unordered.|  
