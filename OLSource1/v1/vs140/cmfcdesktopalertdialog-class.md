...
---
# CMFCDesktopAlertDialog Class
The <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> class is used together with the [CMFCDesktopAlertWnd Class](../vs140/cmfcdesktopalertwnd-class.md) to display a custom dialog in a popup window.  
...
|[CMFCDesktopAlertDialog::PreTranslateMessage](#cmfcdesktopalertdialog__pretranslatemessage)|(Overrides <CodeContentPlaceHolder>6\</CodeContentPlaceHolder>.)|  
  
### Remarks  
 Perform the following steps to display a custom dialog in a popup window:  
  
1.  Derive a class from <CodeContentPlaceHolder>7\</CodeContentPlaceHolder>.  
