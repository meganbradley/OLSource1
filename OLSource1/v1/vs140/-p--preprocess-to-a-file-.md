 ...
 **/P** adds <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> directives to the output, at the beginning and end of each included file and around lines removed by preprocessor directives for conditional compilation. These directives renumber the lines of the preprocessed file. As a result, errors generated during later stages of processing refer to the line numbers of the original source file rather than lines in the preprocessed file. To suppress the generation of <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> directives, use [/EP (Preprocess to stdout Without #line Directives)](../vs140/-ep--preprocess-to-stdout-without-sharpline-directives-.md) as well as **/P**.  
...
## Example  
 The following command line preprocesses <CodeContentPlaceHolder>4\</CodeContentPlaceHolder>, preserves comments, adds <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> directives, and writes the result to a file, <CodeContentPlaceHolder>6\</CodeContentPlaceHolder>:  
