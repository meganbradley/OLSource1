...
>  The following procedure applies to either a [CListView](../vs140/clistview-class.md) or [CListCtrl](../vs140/clistctrl-class.md) object.  
 ...
 Even though columns can be added to a list control at any time, the columns are visible only when the control has the <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> style bit turned on.  
