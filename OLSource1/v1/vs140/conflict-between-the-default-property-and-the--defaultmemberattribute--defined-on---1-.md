...
A class, structure, or interface declares a default property with the [Default (Visual Basic)](../vs140/default--visual-basic-.md) keyword but also applies the <xref:System.Reflection.DefaultMemberAttribute?qualifyHint=False> to designate a different member as the default member.  
