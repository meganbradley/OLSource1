...
2.  Remove the conflicting declaration (either the <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> keyword or the \<xref:System.Reflection.DefaultMemberAttribute*>).  
