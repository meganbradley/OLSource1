...
## Remarks  
 The method fails if the tool that the <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> parameter specifies is not in the internal list or if the tool is the first tool item in the list.  
