...
#### Parameters  
 ...
 [out] Returns <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> if the pointer is an rvalue reference; otherwise, returns <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>.  
