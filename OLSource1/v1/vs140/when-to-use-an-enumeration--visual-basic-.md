...
Enumerations offer an easy way to work with sets of related constants. An enumeration, or <CodeContentPlaceHolder>0\</CodeContentPlaceHolder>, is a symbolic name for a set of values. Enumerations are treated as data types, and you can use them to create sets of constants for use with variables and properties.  
...
## Naming Enumerations  
 ...
 When referring to a member of an enumeration, you must qualify the member name with the enumeration name or else use the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> statement. For more information, see [Enumerations and Name Qualification](../vs140/enumerations-and-name-qualification--visual-basic-.md).  
  
## Predefined Enumerations  
 [!INCLUDE[vbprvb](../vs140/includes/vbprvb_md.md)] provides a number of predefined enumerations, such as <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> and <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>t, to facilitate your code. For a list of these see [Constants and Enumerations (Visual Basic)](../vs140/constants-and-enumerations--visual-basic-.md).  
