...
2.  Install Active Directory and DNS server roles in the virtual machine. For more information about how to install Active Directory on Windows Server 2008 R2, see [AD DS Installation and Removal Step-by-Step Guide](http://go.microsoft.com/fwlink/?LinkId=237610).  
    ...
    1.  [!INCLUDE[vstsLabShort](../vs140/includes/vstslabshort_md.md)] does not support use of separate virtual machines in an environment for Active Directory and DNS.  
...
3.  Install the test agent on the domain controller virtual machine. For more information, see [Installing and Configuring Test Agents and Test Controllers](../vs140/install-and-configure-test-agents.md).  
...
## See Also  
 [How to: Create and Use a Network Isolated Environment](../vs140/creating-and-using-a-network-isolated-environment.md)   
