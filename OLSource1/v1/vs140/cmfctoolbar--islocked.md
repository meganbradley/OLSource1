...
## Return Value  
 <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> if the toolbar is locked; otherwise, <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>.  
  
## Remarks  
 This method returns <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> when the user cannot perform customization tasks such as repositioning toolbar buttons.  
