...
---
# CDockState::m_arrBarInfo
A <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> object that is an array of pointers to the stored control bar information for each control bar that has saved state information in the <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> object.  
