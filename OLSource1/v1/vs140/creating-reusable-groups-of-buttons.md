...
1.  Create a VSIX project named `ReusableButtons`. For more information, see [Creating a VSPackage with a Menu Command](../vs140/creating-an-extension-with-a-menu-command.md).  
