...
You can serialize XML trees to a \<xref:System.IO.File*>, a \<xref:System.IO.TextWriter*>, or an \<xref:System.Xml.XmlWriter*>.  
 ...
 You can serialize any XML component, including \<xref:System.Xml.Linq.XDocument*> and \<xref:System.Xml.Linq.XElement*>, to a string by using the <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> method.  
