...
You can serialize XML trees to a <xref:System.IO.File*>, a <xref:System.IO.TextWriter*>, or an <xref:System.Xml.XmlWriter*>.  
 ...
 If you want to suppress formatting when serializing to a string, you can use the [XNode.ToString](assetId:///M:System.Xml.Linq.XNode.ToString(System.Xml.Linq.SaveOptions)?qualifyHint=True&autoUpgrade=True) method.  
