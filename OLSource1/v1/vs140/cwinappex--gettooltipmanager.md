...
## Remarks  
 If the <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> object is not initialized, this function calls [CWinAppEx::InitTooltipManager](../vs140/cwinappex--inittooltipmanager.md) before it returns a pointer.  
