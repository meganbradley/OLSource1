...
helpviewer_keywords: 
  - "OnRenderData method"
  - "COleServerItem class, overidables"
...
## Remarks  
 ...
 If <CodeContentPlaceHolder>4\</CodeContentPlaceHolder>->*tymed* is **TYMED_NULL**, the **STGMEDIUM** should allocated and filled as specified by *lpFormatEtc->tymed*. If not **TYMED_NULL**, the **STGMEDIUM** should be filled in place with the data.  
