...
## Remarks  
 When the handle is removed [IWorkerThreadClient::CloseHandle](../vs140/iworkerthreadclient--closehandle.md) will be called on the associated object that was passed to [AddHandle](../vs140/cworkerthread--addhandle.md). If this call fails, <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> will call the Windows [CloseHandle](http://msdn.microsoft.com/library/windows/desktop/ms724211) function on the handle.  
