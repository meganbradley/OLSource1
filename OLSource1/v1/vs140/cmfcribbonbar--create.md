...
## Return Value  
 <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> if the window was created; otherwise <CodeContentPlaceHolder>5\</CodeContentPlaceHolder>.  
  
## Remarks  
  
## Example  
 The following example demonstrates how to use the <CodeContentPlaceHolder>6\</CodeContentPlaceHolder> method of the <CodeContentPlaceHolder>7\</CodeContentPlaceHolder> class.  
