...
## Remarks  
 Because it calls <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>, this method changes the name of the specified color in all <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> objects in your application.  
