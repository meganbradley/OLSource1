...
dev_langs: 
  - "C++"
helpviewer_keywords: 
  - "CDaoRecordset class, filter"
  - "recordsets, filtering"
  - "m_strFilter"
...
## Remarks  
 It does not include the reserved word **WHERE** to filter the recordset. The use of this data member is not applicable to table-type recordsets. The use of **m_strFilter** has no effect when opening a recordset using a <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> pointer.  
