...
This topic describes how to add global nodes to the [workspace](../vs140/xml-schema-designer-workspace.md) from the [Start View](../vs140/start-view.md).  
...
3.  Click on the **add** link to the right of the **Global Complex Types** heading.  
     ...
     The <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> and <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> complex type nodes will appear on the design surface of the Graph View.