...
3.  If the DLL routine expects arguments by value, make sure <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> is specified for those arguments in the declaration for the routine.  
