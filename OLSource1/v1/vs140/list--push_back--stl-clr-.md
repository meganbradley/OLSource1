...
## Remarks  
 The member function inserts an element with value <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> at the end of the controlled sequence. You use it to append another element to the list.  
