...
---
# PX_UShort
Call this function within your control's <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> member function to serialize or initialize a property of type <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> **short**.  
...
#### Parameters  
 ...
 Pointer to the [CPropExchange](../vs140/cpropexchange-class.md) object (typically passed as a parameter to <CodeContentPlaceHolder>4\</CodeContentPlaceHolder>).  
