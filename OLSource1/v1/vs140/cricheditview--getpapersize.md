...
## Return Value  
 The size of the paper used in printing, measured in <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>.  
  
## Example  
 [!code[NVC_MFCDocView#153](../vs140/codesnippet/CPP/cricheditview--getpapersize_1.cpp)]  
