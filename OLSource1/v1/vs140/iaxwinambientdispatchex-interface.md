...
## Remarks  
 ...
 This interface is exposed by ATL's ActiveX control hosting objects. Derived from [IAxWinAmbientDispatch](../vs140/iaxwinambientdispatch-interface.md), <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> adds a method that allows you to supplement the ambient property interface provided by ATL with one of your own.  
  
 [AXHost](https://msdn.microsoft.com/en-us/library/system.windows.forms.axhost.aspx) will try to load type information about <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> and <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> from the type library that contains the code.  
