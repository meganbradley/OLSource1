...
#### Parameters  
 ...
 [in] The name of the window class that will superclass <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>. If **NULL**, ATL will generate a window class name.  
...
## Remarks  
 ...
 <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> implements the following static function:  
  
 [!code[NVC_ATL_Windowing#127](../vs140/codesnippet/CPP/declare_wnd_superclass_1.cpp)]  
  
 By default, [CWindowImpl](../vs140/cwindowimpl-class.md) uses the [DECLARE_WND_CLASS](../vs140/declare_wnd_class.md) macro to create a window based on a new window class. By specifying the <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> macro in a <CodeContentPlaceHolder>6\</CodeContentPlaceHolder>-derived class, the window class will be based on an existing class but will use your window procedure. This technique is called superclassing.  
  
 Besides using the <CodeContentPlaceHolder>7\</CodeContentPlaceHolder> and <CodeContentPlaceHolder>8\</CodeContentPlaceHolder> macros, you can override the [GetWndClassInfo](../vs140/cwindowimpl--getwndclassinfo.md) function with your own implementation.  
