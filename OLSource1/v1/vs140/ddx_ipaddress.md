...
dev_langs: 
  - "C++"
helpviewer_keywords: 
  - "DDX_IPAddress function"
  - "IP address control, DDX"
...
---
# DDX_IPAddress
The <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> function manages the transfer of data between an IP Address control and a data member of the control view object.  
 ...
 *value*  
 A reference to the <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> containing the four-field value of the IP Address control. The fields are filled or read as follows.  
...
## Remarks  
 When <CodeContentPlaceHolder>6\</CodeContentPlaceHolder> is called, *value* is either read from the IP Address control, or *value* is written to the control, depending on the direction of the exchange.  
