...
---
# CMenu::GetMenuContextHelpId
Retrieves the context help ID associated with <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>.  
  
## Syntax  
  
<CodeContentPlaceHolder>0\</CodeContentPlaceHolder>  
## Return Value  
 The context help ID currently associated with <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> if it has one; zero otherwise.  
