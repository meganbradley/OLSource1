...
## Return Value  
 <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> returns the file descriptor. There is no error return. The result is undefined if <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> does not specify an open file. If stream is <CodeContentPlaceHolder>6\</CodeContentPlaceHolder>, _<CodeContentPlaceHolder>7\</CodeContentPlaceHolder> invokes the invalid parameter handler, as described in [Parameter Validation](../vs140/parameter-validation.md). If execution is allowed to continue, this function returns -1 and sets <CodeContentPlaceHolder>8\</CodeContentPlaceHolder> to <CodeContentPlaceHolder>9\</CodeContentPlaceHolder>.  
