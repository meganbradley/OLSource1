...
#### Parameters  
 ...
 [out] Returns <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> if the section can be read; otherwise, returns <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>.  
