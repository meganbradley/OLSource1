...
## Notes for Implementers  
 The DE implements this interface as part of its normal operations. The [IDebugEvent2](../vs140/idebugevent2.md) interface must be implemented on the same object as this interface (the SDM uses the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> method to access the <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> interface).  
