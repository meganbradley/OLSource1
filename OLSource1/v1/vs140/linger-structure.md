...
---
# LINGER Structure
The <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> structure is used for manipulating the **SO_LINGER** and **SO_DONTLINGER** options of <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>.  
