...
## Remarks  
 ...
 Unless you use the [/out](../vs140/-out--csharp-compiler-options-.md) option, the output file name takes the name of the first input file. A [Main](../vs140/main---and-command-line-arguments--csharp-programming-guide-.md) method isn’t required.  
  
 If you specify the /target:winmdobj option at a command prompt, all files until the next **/out** or [/target:module](../vs140/-target-module--csharp-compiler-options-.md) option are used to create the Windows program.  
...
## Example  
 The following command compiles <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> into an intermediate .winmdobj file.  
