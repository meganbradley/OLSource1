...
## Return Value  
 Pointer to a linked list of one or more <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> structures containing response information about the host. For more information about the <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> structure, see the "addrinfo" article in the [MSDN Library](http://go.microsoft.com/fwlink/?linkid=556)  
