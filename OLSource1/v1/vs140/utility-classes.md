...
-   [_U_RECT](../vs140/_u_rect-class.md) An argument adapter class that allows either <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> pointers or references to be passed to a function that is implemented in terms of pointers.  
