...
Object initializers cannot be used to initialize any member of a class that is declared as shared. For more information, see [Shared (Visual Basic)](../vs140/shared--visual-basic-.md).  
