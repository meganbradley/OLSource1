...
-   Division by exactly 1.0 is transformed into a use of the dividend. x*y/1.0 is transformed into x\*y. Similarly, x/1.0\*y is transformed into x\*y.  
 ...
 Using **/fp:precise** when [fenv_access](../vs140/fenv_access.md) is ON disables optimizations such as compile-time evaluations of floating-point expressions. For example, if you use [_control87, _controlfp, \__control87_2](../vs140/_control87--_controlfp--__control87_2.md) to change the rounding mode, and the compiler performs a floating-point calculation, the rounding mode you specified is not in effect unless `fenv_access` is ON.  
