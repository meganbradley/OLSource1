...
---
# CMFCHeaderCtrl Class
The <CodeContentPlaceHolder>13\</CodeContentPlaceHolder> class supports sorting multiple columns in a header control.  
...
|Name|Description|  
|----------|-----------------|  
|[CMFCHeaderCtrl::CMFCHeaderCtrl](#cmfcheaderctrl__cmfcheaderctrl)|Constructs a <CodeContentPlaceHolder>14\</CodeContentPlaceHolder> object.|  
...
|<CodeContentPlaceHolder>16\</CodeContentPlaceHolder>|Used by the framework to obtain a pointer to the [CRuntimeClass](../vs140/cruntimeclass-structure.md) object that is associated with this class type.|  
...
## Example  
 The following example demonstrates how to construct an object of the <CodeContentPlaceHolder>17\</CodeContentPlaceHolder> class, and how to enable *multiple column sort* mode for the current header control.  
  
 [!code[NVC_MFC_RibbonApp#24](../vs140/codesnippet/CPP/cmfcheaderctrl-class_1.cpp)]  
  
## Remarks  
 The <CodeContentPlaceHolder>18\</CodeContentPlaceHolder> class draws a sort arrow on a header control column to indicate that the column is sorted. Use *multiple column sort* mode if a set of columns in the parent list control ( [CMFCListCtrl](../vs140/cmfclistctrl-class.md)) can be sorted at the same time.  
...
|<CodeContentPlaceHolder>26\</CodeContentPlaceHolder>|-1|  
...
### Parameters  
 ...
 <CodeContentPlaceHolder>34\</CodeContentPlaceHolder> to enable multiple column sort mode; <CodeContentPlaceHolder>35\</CodeContentPlaceHolder> to disable multiple column sort mode and to remove any columns from the list of sorted columns. The default value is <CodeContentPlaceHolder>36\</CodeContentPlaceHolder>.  
...
### Return Value  
 <CodeContentPlaceHolder>38\</CodeContentPlaceHolder> if any column in the header control is sorted in ascending order; otherwise, <CodeContentPlaceHolder>39\</CodeContentPlaceHolder>.  
...
### Return Value  
 <CodeContentPlaceHolder>40\</CodeContentPlaceHolder> if the parent window of the current header control is a dialog box; otherwise, <CodeContentPlaceHolder>41\</CodeContentPlaceHolder>.  
...
### Return Value  
 <CodeContentPlaceHolder>42\</CodeContentPlaceHolder> if multiple column sort mode is enabled; otherwise, <CodeContentPlaceHolder>43\</CodeContentPlaceHolder>.  
...
### Parameters  
 ...
 <CodeContentPlaceHolder>48\</CodeContentPlaceHolder> to draw the item in pressed state; otherwise, <CodeContentPlaceHolder>49\</CodeContentPlaceHolder>.  
  
 [in] <CodeContentPlaceHolder>50\</CodeContentPlaceHolder>  
 <CodeContentPlaceHolder>51\</CodeContentPlaceHolder> to draw the item in highlighted state; otherwise, <CodeContentPlaceHolder>52\</CodeContentPlaceHolder>.  
...
### Parameters  
 ...
 Specifies the sort order of the column that the <CodeContentPlaceHolder>59\</CodeContentPlaceHolder> parameter specifies. <CodeContentPlaceHolder>60\</CodeContentPlaceHolder> to set ascending order; <CodeContentPlaceHolder>61\</CodeContentPlaceHolder> to set descending order. The default value is <CodeContentPlaceHolder>62\</CodeContentPlaceHolder>.  
  
 [in] <CodeContentPlaceHolder>63\</CodeContentPlaceHolder>  
 <CodeContentPlaceHolder>64\</CodeContentPlaceHolder> to set the sort order of the column that the <CodeContentPlaceHolder>65\</CodeContentPlaceHolder> parameter specifies.  
 ...
 <CodeContentPlaceHolder>66\</CodeContentPlaceHolder> to first remove all columns from the list of sort columns, and then add the specified column to the list. The default value is <CodeContentPlaceHolder>67\</CodeContentPlaceHolder>.  
