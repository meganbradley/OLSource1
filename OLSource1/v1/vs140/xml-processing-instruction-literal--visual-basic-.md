...
>  An XML literal can span multiple lines without needing line continuation characters. This enables you to copy content from an XML document and paste it directly into a [!INCLUDE[vbprvb](../vs140/includes/vbprvb_md.md)] program.  
 ...
 The [!INCLUDE[vbprvb](../vs140/includes/vbprvb_md.md)] compiler converts the XML processing instruction literal to a call to the [XProcessingInstruction](assetId:///M:System.Xml.Linq.XProcessingInstruction.#ctor(System.String,System.String)?qualifyHint=False&autoUpgrade=True) constructor.  
