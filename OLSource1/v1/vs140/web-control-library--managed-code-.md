...
3.  In the Web site that is hosting the [!INCLUDE[vstecasp](../vs140/includes/vstecasp_md.md)] test harness, create a subdirectory called <CodeContentPlaceHolder>0\</CodeContentPlaceHolder>.  
  
4.  Copy the source code for the control into the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> subdirectory.  
  
5.  Open the source code in the <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> subdirectory and set breakpoints.  
