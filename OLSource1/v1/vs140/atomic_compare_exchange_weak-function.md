...
## Remarks  
 This method performs a *weak atomic compare and exchange operation* that has implicit <CodeContentPlaceHolder>9\</CodeContentPlaceHolder>[memory_order](../vs140/memory_order-enum.md) arguments. For more information, see [atomic_compare_exchange_weak_explicit Function](../vs140/atomic_compare_exchange_weak_explicit-function.md).  
