...
#### Parameters  
 ...
 Address of a <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> structure that contains the margin information to be set. The members of the <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> structure do not define a bounding rectangle. See [CToolTipCtrl::GetMargin](../vs140/ctooltipctrl--getmargin.md) for a description of the margin information.  
