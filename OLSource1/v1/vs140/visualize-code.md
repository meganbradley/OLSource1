...
|||  
|-|-|  
|**Understand code and its relationships:**<br /><br /> Map relationships between specific pieces of code.<br /><br /> See an overview of the relationships in your code for the entire solution.<br /><br /> **Note**: In this release of Visual Studio, the term *code map* is used in place of *dependency graph*.|-   [Map dependencies across your solutions](../vs140/map-dependencies-across-your-solutions.md)<br />-   [Use code maps to debug your applications](../vs140/use-code-maps-to-debug-your-applications.md)<br />-   [Find potential problems in code using code maps](../vs140/find-potential-problems-using-code-map-analyzers.md)<br />-   [Map methods on the call stack while debugging](../vs140/map-methods-on-the-call-stack-while-debugging-in-visual-studio.md)|  
|**Understand class structures:**<br /><br /> Visualize the structure of classes in a project by creating class diagrams from code.|[How to: Add Class Diagrams to Projects](../vs140/how-to--add-class-diagrams-to-projects--class-designer-.md)|  
...
|**Communicate the user requirements and architecture:**<br /><br /> Model the user requirements and architecture of your software system by drawing the following UML diagrams: activity, component, class, sequence, and use case.|-   [Developing Models for Software Design](../vs140/create-models-for-your-app.md)<br />-   [Modeling User Requirements](../vs140/model-user-requirements.md)<br />-   [Modeling the Architecture of a Software System](../vs140/model-your-app-s-architecture.md)|  
...
## See Also  
 [Scenario: Updating a System by Using Visualization and Modeling](../vs140/scenario--change-your-design-using-visualization-and-modeling.md)   
