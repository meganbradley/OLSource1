...
|[RDX_TEXT](../vs140/rdx_text.md)|Associates the specified registry entry with a specified member variable of type TCHAR.|  
 ...
 The global function [RegistryDataExchange](../vs140/registrydataexchange.md), or the member function of the same name created by the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> and <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> macros, should be used whenever your code needs to exchange data between the system registry and the variables specified in the RDX map.  
