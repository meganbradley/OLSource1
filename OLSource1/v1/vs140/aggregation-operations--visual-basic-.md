...
|Average|Calculates the average value of a collection of values.|`Aggregate … In … Into Average()`|[Enumerable.Average](assetId:///M:System.Linq.Enumerable.Average(System.Collections.Generic.IEnumerable{System.Decimal})?qualifyHint=True&autoUpgrade=True)<br /><br /> [Queryable.Average](assetId:///M:System.Linq.Queryable.Average(System.Linq.IQueryable{System.Decimal})?qualifyHint=True&autoUpgrade=True)|  
...
|Max|Determines the maximum value in a collection.|`Aggregate … In … Into Max()`|[Enumerable.Max](assetId:///M:System.Linq.Enumerable.Max(System.Collections.Generic.IEnumerable{System.Decimal})?qualifyHint=True&autoUpgrade=True)<br /><br /> <xref:System.Linq.Queryable.Max*?displayProperty=fullName>|  
|Min|Determines the minimum value in a collection.|`Aggregate … In … Into Min()`|[Enumerable.Min](assetId:///M:System.Linq.Enumerable.Min(System.Collections.Generic.IEnumerable{System.Decimal})?qualifyHint=True&autoUpgrade=True)<br /><br /> <xref:System.Linq.Queryable.Min*?displayProperty=fullName>|  
|Sum|Calculates the sum of the values in a collection.|`Aggregate … In … Into Sum()`|[Enumerable.Sum](assetId:///M:System.Linq.Enumerable.Sum(System.Collections.Generic.IEnumerable{System.Decimal})?qualifyHint=True&autoUpgrade=True)<br /><br /> [Queryable.Sum](assetId:///M:System.Linq.Queryable.Sum(System.Linq.IQueryable{System.Decimal})?qualifyHint=True&autoUpgrade=True)|  
