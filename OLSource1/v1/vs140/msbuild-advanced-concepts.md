...
|Title|Description|  
|-----------|-----------------|  
|[MSBuild Batching](../vs140/msbuild-batching.md)|Describes how to batch build targets and tasks based on item metadata.|  
...
|[Building Projects in Parallel to Improve Build Performance](../vs140/building-multiple-projects-in-parallel-with-msbuild.md)|Describes how to build multiple projects faster on computers that have multiple processors or multicore processors.|  
