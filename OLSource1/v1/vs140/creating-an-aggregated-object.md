...
> [!NOTE]
>  If you use and release an interface from the aggregated object during <CodeContentPlaceHolder>0\</CodeContentPlaceHolder>, you should add the [DECLARE_PROTECT_FINAL_CONSTRUCT](../vs140/declare_protect_final_construct.md) macro to the definition of your class object.  
