...
---
# CTokenGroups::GetSidsAndAttributes
Retrieves the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> objects and (optionally) the attributes belonging to the <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> object.  
...
## Remarks  
 This method will enumerate all of the <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> objects contained in the <CodeContentPlaceHolder>6\</CodeContentPlaceHolder> object and place them and (optionally) the attribute flags into array objects.  
