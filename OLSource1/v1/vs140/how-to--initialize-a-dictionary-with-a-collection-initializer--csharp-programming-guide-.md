...
A <xref:System.Collections.Generic.Dictionary`2*> contains a collection of key/value pairs. Its [Add](assetId:///M:System.Collections.Generic.Dictionary`2.Add(`0,`1)?qualifyHint=False&autoUpgrade=True) method takes two parameters, one for the key and one for the value. To initialize a <xref:System.Collections.Generic.Dictionary`2*>, or any collection whose `Add` method takes multiple parameters, enclose each set of parameters in braces as shown in the following example.  
