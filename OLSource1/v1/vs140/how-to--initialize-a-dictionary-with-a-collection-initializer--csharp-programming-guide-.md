...
A <xref:System.Collections.Generic.Dictionary<CodeContentPlaceHolder>0\</CodeContentPlaceHolder>2.Add*> method takes two parameters, one for the key and one for the value. To initialize a <xref:System.Collections.Generic.Dictionary<CodeContentPlaceHolder>1\</CodeContentPlaceHolder>Add<CodeContentPlaceHolder>2\</CodeContentPlaceHolder>2*> is initialized with instances of type <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>.  
 ...
 Note the two pairs of braces in each element of the collection. The innermost braces enclose the object initializer for the <CodeContentPlaceHolder>4\</CodeContentPlaceHolder>, and the outermost braces enclose the initializer for the key/value pair that will be added to the <CodeContentPlaceHolder>5\</CodeContentPlaceHolder>\<xref:System.Collections.Generic.Dictionary`2*>. Finally, the whole collection initializer for the dictionary is enclosed in braces.  
