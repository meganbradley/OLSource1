...
ms.assetid: 97b4ef82-a321-4135-ab4b-40312aed69cc
...
## Example  
 See the example for [get_allocator](../vs140/multiset--get_allocator.md) for an example using <CodeContentPlaceHolder>4\</CodeContentPlaceHolder>  
