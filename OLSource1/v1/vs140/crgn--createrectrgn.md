...
## Remarks  
 ...
 When it has finished using a region created by <CodeContentPlaceHolder>6\</CodeContentPlaceHolder>, an application should use the [CGDIObject::DeleteObject](../vs140/cgdiobject--deleteobject.md) member function to remove the region.  
