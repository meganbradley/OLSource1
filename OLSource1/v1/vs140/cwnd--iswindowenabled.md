...
---
# CWnd::IsWindowEnabled
Specifies whether <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> is enabled for mouse and keyboard input.  
  
## Syntax  
  
<CodeContentPlaceHolder>0\</CodeContentPlaceHolder>  
## Return Value  
 Nonzero if <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> is enabled; otherwise 0.  
