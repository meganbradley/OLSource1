...
## Remarks  
 When <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> is **TRUE**, it changes the <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> option for this <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> object. For a brief description of this option, see [SetOptions](../vs140/cricheditctrl--setoptions.md). You can use this function to set all the options for this <CodeContentPlaceHolder>6\</CodeContentPlaceHolder> object.  
