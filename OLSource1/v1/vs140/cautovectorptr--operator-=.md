...
## Remarks  
 The assignment operator detaches the <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> object from any current pointer and attaches the new pointer, <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>, in its place.  
