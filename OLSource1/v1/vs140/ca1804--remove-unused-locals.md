...
## How to Fix Violations  
 To fix a violation of this rule, remove or use the local variable. Note that the C# compiler that is included with [!INCLUDE[dnprdnlong](../vs140/includes/dnprdnlong_md.md)] removes unused local variables when the <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> option is enabled.  
