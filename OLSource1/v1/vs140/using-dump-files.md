...
-   With [Just-In-Time Debugging](../vs140/just-in-time-debugging-in-visual-studio.md) enabled, you can attach the debugger to a crashed process that is running outside the debugger, and then save a dump file. See [Attach to Running Processes with the Visual Studio Debugger](../vs140/attach-to-running-processes-with-the-visual-studio-debugger.md)  
