...
## Return Value  
 If successful, returns <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>; otherwise, returns <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> if there are no more injected sources to skip.  
