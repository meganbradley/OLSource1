...
## Remarks  
 When the protected code finishes executing, the thread must call <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> to release ownership of the critical section.  
