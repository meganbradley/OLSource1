...
## Remarks  
 <CodeContentPlaceHolder>8\</CodeContentPlaceHolder> is similar to [AtlAxCreateControl](../vs140/atlaxcreatecontrol.md) but also allows you to receive an interface pointer to the newly created control and set up an event sink to receive events fired by the control.  
