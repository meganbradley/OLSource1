...
## Symbol-Browsing Libraries  
 ...
 To provide the lists of symbols to the Visual Studio object manager, you must first register the library with the Visual Studio object manager by calling the assetId:///M:Microsoft.VisualStudio.Shell.Interop.IVsObjectManager2.RegisterSimpleLibrary(Microsoft.VisualStudio.Shell.Interop.IVsSimpleLibrary2,System.UInt32@)?qualifyHint=False&autoUpgrade=True method. After the library is registered, the Visual Studio object manager requests certain information about the capabilities of the library. For example, it requests the library flags and supported categories by calling the [GetLibFlags2](assetId:///M:Microsoft.VisualStudio.Shell.Interop.IVsSimpleLibrary2.GetLibFlags2(System.UInt32@)?qualifyHint=False&autoUpgrade=True) and [GetSupportedCategoryFields2](assetId:///M:Microsoft.VisualStudio.Shell.Interop.IVsSimpleLibrary2.GetSupportedCategoryFields2(System.Int32,System.UInt32@)?qualifyHint=False&autoUpgrade=True) methods. At some point, when one of the tools requests data from this library, the object manager requests the top-level list of symbols by calling the [GetList2](assetId:///M:Microsoft.VisualStudio.Shell.Interop.IVsSimpleLibrary2.GetList2(System.UInt32,System.UInt32,Microsoft.VisualStudio.Shell.Interop.VSOBSEARCHCRITERIA2[],Microsoft.VisualStudio.Shell.Interop.IVsSimpleObjectList2@)?qualifyHint=False&autoUpgrade=True) method. In response, the library manufactures a list of symbols and exposes it to the Visual Studio object manager through the <xref:Microsoft.VisualStudio.Shell.Interop.IVsSimpleObjectList2*> interface. The [!INCLUDE[vsprvs](../vs140/includes/vsprvs_md.md)] object manager determines how many items are in the list by calling the [GetItemCount](assetId:///M:Microsoft.VisualStudio.Shell.Interop.IVsSimpleObjectList2.GetItemCount(System.UInt32@)?qualifyHint=False&autoUpgrade=True) method. All following requests relate to a given item in the list and supply the item index number in each request. The Visual Studio object manager proceeds to collect the information on the type, the accessibility, and other properties of the item by calling the [GetCategoryField2](assetId:///M:Microsoft.VisualStudio.Shell.Interop.IVsSimpleObjectList2.GetCategoryField2(System.UInt32,System.Int32,System.UInt32@)?qualifyHint=False&autoUpgrade=True) method.  
  
 It determines the name of the item by calling the [GetTextWithOwnership](assetId:///M:Microsoft.VisualStudio.Shell.Interop.IVsSimpleObjectList2.GetTextWithOwnership(System.UInt32,Microsoft.VisualStudio.Shell.Interop.VSTREETEXTOPTIONS,System.String@)?qualifyHint=False&autoUpgrade=True) method and requests the icon information by calling the [GetDisplayData](assetId:///M:Microsoft.VisualStudio.Shell.Interop.IVsSimpleObjectList2.GetDisplayData(System.UInt32,Microsoft.VisualStudio.Shell.Interop.VSTREEDISPLAYDATA[])?qualifyHint=False&autoUpgrade=True) method. The icon is displayed to the left of the item name and depicts the type of the item, the accessibility, and other properties.  
  
 The [!INCLUDE[vsprvs](../vs140/includes/vsprvs_md.md)] object manager calls the [GetExpandable3](assetId:///M:Microsoft.VisualStudio.Shell.Interop.IVsSimpleObjectList2.GetExpandable3(System.UInt32,System.UInt32,System.Int32@)?qualifyHint=False&autoUpgrade=True) method to determine if a given list item is expandable and has children items. If UI sends a request to expand an element, the object manager requests the child list of symbols by calling the [GetList2](assetId:///M:Microsoft.VisualStudio.Shell.Interop.IVsSimpleObjectList2.GetList2(System.UInt32,System.UInt32,System.UInt32,Microsoft.VisualStudio.Shell.Interop.VSOBSEARCHCRITERIA2[],Microsoft.VisualStudio.Shell.Interop.IVsSimpleObjectList2@)?qualifyHint=False&autoUpgrade=True) method. The process continues with different parts of the tree being built on demand.  
