...
## Cause  
 An externally visible generic type contains a <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> (<CodeContentPlaceHolder>3\</CodeContentPlaceHolder> in Visual Basic) member.  
