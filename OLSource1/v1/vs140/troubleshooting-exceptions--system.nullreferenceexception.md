...
###  \<a name="BKMK_A_property_or_field_is_null">\</a> A property or field is null  
 The fields and properties of a class are automatically initialized to their [default value](assetId:///53a3b505-4b27-444b-b079-0eb84a97cfd8) when the class is created. The default value of a reference type is <CodeContentPlaceHolder>27\</CodeContentPlaceHolder> (<CodeContentPlaceHolder>28\</CodeContentPlaceHolder> in Visual Basic) Calling member methods on a field or property of a parent class when the field or property value is null causes a NullReferenceException.  
  
 In this example, the highlighted line throws a NullReferenceException because the <CodeContentPlaceHolder>29\</CodeContentPlaceHolder> property of <CodeContentPlaceHolder>30\</CodeContentPlaceHolder> is auto-initialized to null.  
...
###  \<a name="BKMK_A_method_parameter_is_null">\</a> A method parameter is null  
 A method parameter that is a reference type can be <CodeContentPlaceHolder>31\</CodeContentPlaceHolder> (<CodeContentPlaceHolder>32\</CodeContentPlaceHolder> in Visual Basic). Calling member methods or properties on a parameter value that is null causes a NullReferenceException.  
  
 In this example, the highlighted line throws a NullReferenceException because <CodeContentPlaceHolder>33\</CodeContentPlaceHolder> calls <CodeContentPlaceHolder>34\</CodeContentPlaceHolder> with a parameter that is null.  
...
###  \<a name="BKMK_The_return_value_of_a_method_is_null">\</a> The return value of a method is null  
 A method that returns a reference type can return <CodeContentPlaceHolder>35\</CodeContentPlaceHolder> (<CodeContentPlaceHolder>36\</CodeContentPlaceHolder> in Visual Basic). Calling methods or properties of the returned reference type causes a NullReferenceException when the reference is null.  
  
 In this example, the highlighted line throws a NullReferenceException because the call to <CodeContentPlaceHolder>37\</CodeContentPlaceHolder> returns a null reference in the <CodeContentPlaceHolder>38\</CodeContentPlaceHolder> method.  
...
###  \<a name="BKMK_An_object_in_a_collection_or_array_is_null">\</a> An object in a collection or array is null  
 ...
 In this example, the highlighted line in <CodeContentPlaceHolder>39\</CodeContentPlaceHolder> throws a NullReferenceException because the call to <CodeContentPlaceHolder>40\</CodeContentPlaceHolder> returns an item that is null.  
...
###  \<a name="BKMK_An_object_is_not_created_because_of_a_condition">\</a> An object is not created because of a condition  
 ...
 In this example the highlighted line in <CodeContentPlaceHolder>41\</CodeContentPlaceHolder> throws a NullReferenceException because it initializes the <CodeContentPlaceHolder>42\</CodeContentPlaceHolder> variable only if the <CodeContentPlaceHolder>43\</CodeContentPlaceHolder> method returns <CodeContentPlaceHolder>44\</CodeContentPlaceHolder>.  
...
### The property of an object passed to a method is set to null  
 When an object is passed as a parameter to a method by value (without use of the <CodeContentPlaceHolder>45\</CodeContentPlaceHolder> or <CodeContentPlaceHolder>46\</CodeContentPlaceHolder> keyword in C# or the <CodeContentPlaceHolder>47\</CodeContentPlaceHolder> keyword in Visual Basic), the method can't change the memory location of the parameter—what the parameter points to—but it can change the properties of the object.  
  
 In this example, the <CodeContentPlaceHolder>48\</CodeContentPlaceHolder> method creates an <CodeContentPlaceHolder>49\</CodeContentPlaceHolder> object and initializes the <CodeContentPlaceHolder>50\</CodeContentPlaceHolder> property. It then calls <CodeContentPlaceHolder>51\</CodeContentPlaceHolder>, passing the new object as the parameter. <CodeContentPlaceHolder>52\</CodeContentPlaceHolder> sets the Engine property to null, which causes the highlighted line in <CodeContentPlaceHolder>53\</CodeContentPlaceHolder> to throw a NullReferenceException.  
...
###  \<a name="BKMK_An_object_passed_by_reference_to_a_method_is_set_to_null">\</a> An object passed by reference to a method is set to null  
 When you pass a reference type as a parameter to a method by reference (using the <CodeContentPlaceHolder>54\</CodeContentPlaceHolder> or <CodeContentPlaceHolder>55\</CodeContentPlaceHolder> keyword in C# or the <CodeContentPlaceHolder>56\</CodeContentPlaceHolder> keyword in Visual Basic), you can change the memory location that the parameter points to.  
  
 If you pass a reference type by reference to a method, the method can set the referenced type to <CodeContentPlaceHolder>57\</CodeContentPlaceHolder> (<CodeContentPlaceHolder>58\</CodeContentPlaceHolder> in Visual Basic).  
  
 In this example, the highlighted line in <CodeContentPlaceHolder>59\</CodeContentPlaceHolder> throws a NullReferenceException because the call to the <CodeContentPlaceHolder>60\</CodeContentPlaceHolder> method sets the <CodeContentPlaceHolder>61\</CodeContentPlaceHolder> variable to null.  
...
-   Rest the pointer on the variable name to see its value in a [data tip](../vs140/view-data-values-in-data-tips--in-the-code-editor.md). If the variable references an object or a collection, you can expand the data type to examine its properties or elements.  
...
###  \<a name="BKMK_Use_Debug_Assert_to_confirm_an_invariant">\</a> Use Debug.Assert to confirm an invariant  
 An *invariant* is a condition that you are sure is true. A [Debug.Assert (System.Diagnostics)](http://msdn.microsoft.com/library/system.diagnostics.debug.assert.aspx) statement is called only from debug builds of your apps and is not called from release code. If the invariant condition is not true, the debugger breaks at the Assert statement and displays a dialog box. <CodeContentPlaceHolder>62\</CodeContentPlaceHolder> provides a check that the condition has not changed while you are developing the app. An assertion also documents for others who read your code that the condition must always be true.  
  
 For example, the <CodeContentPlaceHolder>63\</CodeContentPlaceHolder> method assumes that its <CodeContentPlaceHolder>64\</CodeContentPlaceHolder> parameter will never be null because its only caller method (<CodeContentPlaceHolder>65\</CodeContentPlaceHolder>) is known to fully initialize the <CodeContentPlaceHolder>66\</CodeContentPlaceHolder>. The  assert in <CodeContentPlaceHolder>67\</CodeContentPlaceHolder> documents the assumption and provides a check that the assumption is true.  
  
 If someone adds a new caller method (<CodeContentPlaceHolder>68\</CodeContentPlaceHolder>) that does not initialize the parameter, the assert is triggered.  
  
<CodeContentPlaceHolder>18\</CodeContentPlaceHolder>  
<CodeContentPlaceHolder>19\</CodeContentPlaceHolder>  
 ![Back to top](../vs140/media/pcs_backtotop.png "PCS_BackToTop") [Entries in this section](#BKMK_Avoid_NullReferenceExceptions)  
...
###  \<a name="BKMK_Check_for_null_Nothing_in_Visual_Basic_before_using_a_reference_type">\</a> Check for null (Nothing in Visual Basic) before you use a reference type  
 ...
 In this example, the <CodeContentPlaceHolder>69\</CodeContentPlaceHolder> tests the return value of the <CodeContentPlaceHolder>70\</CodeContentPlaceHolder> method. If the object is not null, it is used; otherwise, the method reports the error.  
...
###  \<a name="BKMK_Use_try_catch_finally_Try_Catch_Finally_in_Visual_Basic_to_handle_the_exception">\</a> Use try-catch-finally (Try-Catch-Finally in Visual Basic) to handle the exception  
 ...
 In this example, <CodeContentPlaceHolder>71\</CodeContentPlaceHolder> uses two asserts to confirm the assumption that its parameter contains a complete automobile, including an engine. In the <CodeContentPlaceHolder>72\</CodeContentPlaceHolder> block, the highlighted line throws a NullReferenceException because the call to <CodeContentPlaceHolder>73\</CodeContentPlaceHolder> can destroy the car's <CodeContentPlaceHolder>74\</CodeContentPlaceHolder> property. The <CodeContentPlaceHolder>75\</CodeContentPlaceHolder> block captures the exception, writes the exception information to a file, and reports the error to the user. In the <CodeContentPlaceHolder>76\</CodeContentPlaceHolder> block, the method insures that the state of the car is no worse than when the method began.  
