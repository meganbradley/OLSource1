...
If a property specifies <CodeContentPlaceHolder>0\</CodeContentPlaceHolder>, all properties overloaded on that name must also specify <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>.  
  
 **Error ID:** BC30361  
  
### To correct this error  
  
-   Make sure all of the overloaded properties are declared <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>.  
