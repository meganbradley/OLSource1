...
## Remarks  
 Constructs a ribbon slider that is <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> pixels wide in the panel category where the slider is added. By default, the slider is horizontal.  
