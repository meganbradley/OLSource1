...
## How to Fix Violations  
 All fields that are smaller than 8 bytes must have offsets that are a multiple of their size, and fields that are 8 bytes or more must have offsets that are a multiple of 8. Another solution is to use <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> instead of <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>, if reasonable.  
