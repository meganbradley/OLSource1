...
|[OMP_NESTED](../vs140/omp_nested.md)|Specifies whether nested parallelism is enabled, unless nested parallelism is enabled or disabled with <CodeContentPlaceHolder>0\</CodeContentPlaceHolder>.|  
...
|[OMP_SCHEDULE](../vs140/omp_schedule.md)|Modifies the behavior of the [schedule](../vs140/schedule.md) clause when <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> is specified in a <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> or <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> directive.|  
