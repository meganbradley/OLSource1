...
3.  In the **Add Client** dialog box, choose **HTML Client**, name it <CodeContentPlaceHolder>10\</CodeContentPlaceHolder>, and then choose the **OK** button.  
...
4.  In the **Screen Name** text box, enter <CodeContentPlaceHolder>11\</CodeContentPlaceHolder>.  
...
6.  In the **Screen Name** text box, enter <CodeContentPlaceHolder>12\</CodeContentPlaceHolder>.  
...
6.  In the **Specify the screen data to add** text box, enter <CodeContentPlaceHolder>13\</CodeContentPlaceHolder>, and then choose the **OK** button.  
  
7.  Expand the **Add** node, and then choose **Other Screen Data**.  
  
     The **Add Screen Data** dialog box appears.  
  
8.  In the **Specify the screen data to add** text box, enter <CodeContentPlaceHolder>14\</CodeContentPlaceHolder>, and then choose the **OK** button.  
...
5.  In the **Screen Name** text box, enter <CodeContentPlaceHolder>15\</CodeContentPlaceHolder>, and then choose the **OK** button.  
...
8.  In the **Specify the screen data to add** text box, enter <CodeContentPlaceHolder>16\</CodeContentPlaceHolder>, and then choose the **OK** button.  
  
9. Expand the **Add** node, and then choose **Other Screen Data**.  
  
     The **Add Screen Data** dialog box appears.  
  
10. In the **Specify the screen data to add** text box, enter <CodeContentPlaceHolder>17\</CodeContentPlaceHolder>, and then choose the **OK** button.  
  
11. Expand the **Add** node, and then choose **Other Screen Data**.  
  
     The **Add Screen Data** dialog box appears.  
  
12. In the **Specify the screen data to add** text box, enter <CodeContentPlaceHolder>18\</CodeContentPlaceHolder>, and then choose the **OK** button.  
  
13. Expand the **Add** node, and then choose **Other Screen Data**.  
  
     The **Add Screen Data** dialog box appears.  
  
14. In the **Specify the screen data to add** text box, enter <CodeContentPlaceHolder>19\</CodeContentPlaceHolder>, and then choose the **OK** button.  
...
4.  In the code editor, add the following code for the <CodeContentPlaceHolder>20\</CodeContentPlaceHolder> function:  
  
<CodeContentPlaceHolder>0\</CodeContentPlaceHolder>  
     This JavaScript code uses the <CodeContentPlaceHolder>21\</CodeContentPlaceHolder> member variable to determine what to display and the <CodeContentPlaceHolder>22\</CodeContentPlaceHolder> method to define the formatting.  
...
7.  In the **Search Online** text box, enter <CodeContentPlaceHolder>23\</CodeContentPlaceHolder>.  
...
10. In the code editor, add the following script tag after the last <CodeContentPlaceHolder>24\</CodeContentPlaceHolder> tag:  
...
8.  In the **Min** text box, enter <CodeContentPlaceHolder>25\</CodeContentPlaceHolder>.  
...
11. In the **Screen Name** text box, enter <CodeContentPlaceHolder>26\</CodeContentPlaceHolder>, and then choose the **OK** button.  
...
8.  In the **Properties** window, set the value of the **Name** property to <CodeContentPlaceHolder>27\</CodeContentPlaceHolder>.  
...
10. In the **Specify the data for the new custom control** text box, enter <CodeContentPlaceHolder>28\</CodeContentPlaceHolder>, and then choose the **OK** button.  
...
1.  In **Solution Explorer**, open the default.htm file, and then, in the code editor, replace the <CodeContentPlaceHolder>29\</CodeContentPlaceHolder> element with the following code:  
...
1.  In **Solution Explorer**, open the default.htm file, and then, in the code editor, replace “light” in the following two lines <CodeContentPlaceHolder>30\</CodeContentPlaceHolder>, <CodeContentPlaceHolder>31\</CodeContentPlaceHolder>with <CodeContentPlaceHolder>32\</CodeContentPlaceHolder>.  
...
8.  In the **Group** text box, enter <CodeContentPlaceHolder>33\</CodeContentPlaceHolder>.  
  
9. In the **Button** text box, enter <CodeContentPlaceHolder>34\</CodeContentPlaceHolder>.  
...
17. Open the default.htm file, locate the line <CodeContentPlaceHolder>35\</CodeContentPlaceHolder> in the code editor, and then replace ”dark-theme” with <CodeContentPlaceHolder>36\</CodeContentPlaceHolder>.  
