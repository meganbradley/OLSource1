...
## Return Value  
 <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> if the group text color was successfully changed; otherwise, <CodeContentPlaceHolder>5\</CodeContentPlaceHolder>.  
