...
1.  From the Start screen, enter <CodeContentPlaceHolder>0\</CodeContentPlaceHolder>, and then choose the Enter key.  
...
-   **Find dialog boxes, menu commands, and options**. In the [Quick Launch](../vs140/quick-launch--environment--options-dialog-box.md) box, enter keywords or phrases for the items that you’re trying to find. For example, the following options appear if you enter <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>:  
  
     Figure 3: Quick Launch results list for <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>  
...
-   **Clear the Immediate window**. You can erase the contents of the [Immediate Window](../vs140/immediate-window.md) at design time by entering <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> or <CodeContentPlaceHolder>4\</CodeContentPlaceHolder>  
