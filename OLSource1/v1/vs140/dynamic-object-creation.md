...
1.  Use the following code to dynamically create an object by using the <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> function of the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>. Note that on failure, <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> returns **NULL** instead of raising an exception:  
  
     [!code[NVC_MFCCObjectSample#6](../vs140/codesnippet/CPP/dynamic-object-creation_1.cpp)]  
