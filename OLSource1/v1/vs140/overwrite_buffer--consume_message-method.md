...
Consumes a message previously offered by the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> messaging block and reserved by the target, returning a copy of the message to the caller.  
