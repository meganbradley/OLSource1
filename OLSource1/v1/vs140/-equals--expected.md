...
---
# &#39;Equals&#39; expected
A <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> or <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> clause has been specified without an <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> operator. You use the <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> operator to identify the <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> operation to test key fields for matching items.  
  
 **Error ID:** BC36619  
  
### To correct this error  
  
1.  Add the <CodeContentPlaceHolder>6\</CodeContentPlaceHolder> operator and key fields to the <CodeContentPlaceHolder>7\</CodeContentPlaceHolder> or <CodeContentPlaceHolder>8\</CodeContentPlaceHolder> clause. For example:  
