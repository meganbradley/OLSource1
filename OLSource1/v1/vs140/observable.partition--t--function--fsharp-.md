...
## Return Value  
 A tuple of observables. The first triggers when the predicate returns <CodeContentPlaceHolder>5\</CodeContentPlaceHolder>, and the second triggers when the predicate returns <CodeContentPlaceHolder>6\</CodeContentPlaceHolder>.  
