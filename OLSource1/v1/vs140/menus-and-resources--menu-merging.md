...
##  \<a name="_core_toolbars_and_status_bars">\</a> Toolbars and Status Bars  
 ...
 This toolbar is loaded in your <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>-derived class, created for you by the application wizard. The status bar is handled by the container application. For more information on the implementation of in-place frame windows, see [Servers: Implementing a Server](../vs140/servers--implementing-a-server.md).  
