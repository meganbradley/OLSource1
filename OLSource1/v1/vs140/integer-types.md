...
-   The type for a decimal constant without a suffix is either <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>, **long int**, or **unsigned long int**. The first of these three types in which the constant's value can be represented is the type assigned to the constant.  
  
-   The type assigned to octal and hexadecimal constants without suffixes is <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>, <CodeContentPlaceHolder>4\</CodeContentPlaceHolder>, **long int**, or **unsigned long int** depending on the size of the constant.  
