...
> [!NOTE]
>  You can use the <xref:System.Array.Rank?qualifyHint=False> property to determine the how many dimensions an array has.  
...
> [!NOTE]
>  You can create an array without using the `Dim` statement or the `New` clause. For example, you can call the <xref:System.Array.CreateInstance?qualifyHint=False> method, or another component can pass your code an array created in this manner. Such an array can have a lower bound other than 0. You can always test for the lower bound of a dimension by using the <xref:System.Array.GetLowerBound?qualifyHint=False> method or the `LBound` function.  
