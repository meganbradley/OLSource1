...
## Working with Dimensions  
 ...
 The following illustrations show the conceptual structure of arrays with different ranks. Each element in the illustrations shows the index values that access it. For example, you can access the first element of the second row of the two-dimensional array by specifying indexes <CodeContentPlaceHolder>6\</CodeContentPlaceHolder>.  
  
 ![Graphic diagram of one&#45;dimensional array](../vs140/media/arrayexdimone.gif "ArrayExDimOne")  
One-dimensional array  
  
 ![Graphic diagram of two&#45;dimensional array](../vs140/media/arrayexdimtwo.gif "ArrayExDimTwo")  
Two-dimensional array  
  
 ![Graphic diagram of three&#45;dimensional array](../vs140/media/arrayexdimthree.gif "ArrayExDimThree")  
...
<CodeContentPlaceHolder>5\</CodeContentPlaceHolder>  
 Note that, because each index varies from 0 to its maximum, each dimension of <CodeContentPlaceHolder>7\</CodeContentPlaceHolder> is declared as one less than the required length for that dimension. Note also that the size of the array increases with each new dimension. The three sizes in the preceding examples are 31, 372, and 1,860 elements respectively.  
  
> [!NOTE]
>  You can create an array without using the <CodeContentPlaceHolder>8\</CodeContentPlaceHolder> statement or the <CodeContentPlaceHolder>9\</CodeContentPlaceHolder> clause. For example, you can call the \<xref:System.Array.CreateInstance*> method, or another component can pass your code an array created in this manner. Such an array can have a lower bound other than 0. You can always test for the lower bound of a dimension by using the \<xref:System.Array.GetLowerBound*> method or the <CodeContentPlaceHolder>10\</CodeContentPlaceHolder> function.  
