...
#### Parameters  
 ...
 When you convert a tabbed pane, specify <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> to convert only the active tab. Specify <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> to convert all tabs in the pane.  
