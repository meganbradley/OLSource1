...
## Remarks  
 Returns a <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> (C++ data type) value. **true** means the current session is open; **false** means the current session is closed.  
