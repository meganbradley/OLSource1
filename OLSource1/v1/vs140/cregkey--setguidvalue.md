...
## Remarks  
 This method makes use of <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> and converts the GUID into a string using [StringFromGUID2](http://msdn.microsoft.com/library/windows/desktop/ms683893).  
