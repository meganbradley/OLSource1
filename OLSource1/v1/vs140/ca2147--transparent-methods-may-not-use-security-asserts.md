...
## Rule Description  
 ...
 Transparent code is not allowed to elevate security privileges. Therefore, any permissions granted or demanded of it are automatically passed through the code to the caller or host application domain. Examples of elevations include Asserts, LinkDemands, SuppressUnmanagedCode, and <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> code.  
...
## Example  
 This code will fail if <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> is transparent, when the <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> method throws a \<xref:System.InvalidOperationException*>.  
  
 [!code[FxCop.Security.CA2147.TransparentMethodsMustNotUseSecurityAsserts#1](../vs140/codesnippet/CSharp/ca2147--transparent-methods-may-not-use-security-asserts_1.cs)]  
...
## Example  
 ...
 [!code[FxCop.Security.SecurityTransparentCode2#1](../vs140/codesnippet/CSharp/ca2147--transparent-methods-may-not-use-security-asserts_2.cs)]  
