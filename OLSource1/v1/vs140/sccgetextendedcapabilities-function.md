...
#### Parameters  
 ...
 pbSupported  
 [out] Returns non-zero (<CodeContentPlaceHolder>1\</CodeContentPlaceHolder>) if the specified capability is supported; otherwise, returns zero (<CodeContentPlaceHolder>2\</CodeContentPlaceHolder>).  
