...
## Example  
 See [Hosting ActiveX Controls Using ATL AXHost](../vs140/hosting-activex-controls-using-atl-axhost.md) for a sample of how to use <CodeContentPlaceHolder>6\</CodeContentPlaceHolder>.  
