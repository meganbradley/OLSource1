...
|\<xref:Microsoft.Build.Tasks.TaskExtension.Log*>|Optional \<xref:Microsoft.Build.Utilities.TaskLoggingHelper*> read-only parameter.\<br />\<br /> Gets a <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> object that contains task logging methods.|  
