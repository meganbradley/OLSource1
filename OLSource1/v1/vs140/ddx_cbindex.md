...
## Remarks  
 When <CodeContentPlaceHolder>7\</CodeContentPlaceHolder> is called, *index* is set to the index of the current combo box selection. If no item is selected, *index* is set to 0.  
