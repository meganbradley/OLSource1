...
#### Parameters  
 ...
 <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> to display the label in bold text; otherwise, <CodeContentPlaceHolder>6\</CodeContentPlaceHolder>.  
  
## Return Value  
 The zero-based index of the group where the label was added, or -1 if the group specified by <CodeContentPlaceHolder>7\</CodeContentPlaceHolder> does not exist.  
