...
The following tables list tasks associated with the <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> object.  
  
## In This Section  
 [How to: Upload a File in Visual Basic](../vs140/how-to--upload-a-file-in-visual-basic.md)  
 Demonstrates how to upload a file and store it to a remote location using <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>.  
  
 [How to: Download a File in Visual Basic](../vs140/how-to--download-a-file-in-visual-basic.md)  
 Demonstrates how to download a file from a remote location using <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>.  
...
## Reference  
 ...
 Describes the <CodeContentPlaceHolder>6\</CodeContentPlaceHolder> property.