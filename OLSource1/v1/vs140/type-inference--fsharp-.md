...
## Inference of Parameter and Return Types  
 ...
 For example, in the following code, the parameter types <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> and <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> and the return type are all inferred to be <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> because the literal <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> is of type <CodeContentPlaceHolder>5\</CodeContentPlaceHolder>.  
  
 [!code[FsLangRef3#301](../vs140/codesnippet/FSharp/type-inference--fsharp-_1.fs)]  
  
 You can influence type inference by changing the literals. If you make the <CodeContentPlaceHolder>6\</CodeContentPlaceHolder> a <CodeContentPlaceHolder>7\</CodeContentPlaceHolder> by appending the suffix <CodeContentPlaceHolder>8\</CodeContentPlaceHolder>, the types of <CodeContentPlaceHolder>9\</CodeContentPlaceHolder>, <CodeContentPlaceHolder>10\</CodeContentPlaceHolder>, and the return value are inferred to be <CodeContentPlaceHolder>11\</CodeContentPlaceHolder>.  
 ...
 [!code[FsLangRef3#302](../vs140/codesnippet/FSharp/type-inference--fsharp-_2.fs)]  
  
 You can also explicitly specify the return value of a function by providing a type annotation after all the parameters.  
  
 [!code[FsLangRef3#303](../vs140/codesnippet/FSharp/type-inference--fsharp-_3.fs)]  
 ...
 [!code[FsLangRef3#304](../vs140/codesnippet/FSharp/type-inference--fsharp-_4.fs)]  
...
## Automatic Generalization  
 ...
 [!code[FsLangRef3#305](../vs140/codesnippet/FSharp/type-inference--fsharp-_5.fs)]  
