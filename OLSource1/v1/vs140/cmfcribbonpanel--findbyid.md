...
## Return Value  
 The ribbon element that is identified by the specified command ID; otherwise <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> if no ribbon element is identified with the specified command ID.  
