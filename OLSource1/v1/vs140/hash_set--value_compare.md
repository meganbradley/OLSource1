...
## Remarks  
 **value_compare** is a synonym for the template parameter <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>.  
  
 For more information on <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> see the [hash_set Class](../vs140/hash_set-class.md) topic.  
...
## Example  
 See the example for [value_comp](../vs140/hash_set--value_comp.md) for an example of how to declare and use <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>.  
