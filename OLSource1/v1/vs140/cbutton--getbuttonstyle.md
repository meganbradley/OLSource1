...
## Return Value  
 Returns the button styles for this <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> object. This function returns only the [BS_](../vs140/button-styles.md) style values, not any of the other window styles.  
