...
|[XElement.SetAttributeValue](assetId:///M:System.Xml.Linq.XElement.SetAttributeValue(System.Xml.Linq.XName,System.Object)?qualifyHint=True&autoUpgrade=True)|Sets the value of an attribute. Creates the attribute if it doesn't exist. If the value is set to `null`, removes the attribute.|  
|[XElement.SetElementValue](assetId:///M:System.Xml.Linq.XElement.SetElementValue(System.Xml.Linq.XName,System.Object)?qualifyHint=True&autoUpgrade=True)|Sets the value of a child element. Creates the element if it doesn't exist. If the value is set to `null`, removes the element.|  
...
|[XElement.SetValue](assetId:///M:System.Xml.Linq.XElement.SetValue(System.Object)?qualifyHint=True&autoUpgrade=True)|Sets the value of an element.|  
...
|[XAttribute.SetValue](assetId:///M:System.Xml.Linq.XAttribute.SetValue(System.Object)?qualifyHint=True&autoUpgrade=True)|Sets the value of an attribute.|  
