...
## Remarks  
 A tab control creates a tool tip control if it has the **TCS_TOOLTIPS** style. You can also assign a tool tip control to a tab control by using the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> member function.  
