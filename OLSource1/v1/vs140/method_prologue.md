...
## Remarks  
 Typically, member functions of interfaces implemented by <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>-derived objects already use this macro to provide automatic initialization of the <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> pointer. For example:  
