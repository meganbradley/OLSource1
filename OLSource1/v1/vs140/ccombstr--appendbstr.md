...
---
# CComBSTR::AppendBSTR
Appends the specified <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> to [m_str](../vs140/ccombstr--m_str.md).  
...
#### Parameters  
 ...
 [in] A <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> to append.  
  
## Return Value  
 <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> on success, or any standard <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> error value.  
