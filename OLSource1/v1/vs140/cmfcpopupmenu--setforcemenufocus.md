...
#### Parameters  
 ...
 <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> if you want the framework to force the input focus to the menu bar when a pop-up menu is displayed. <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> if you want the pop-up menu to retain the focus.  
