...
## Remarks  
 This method sees all of the elements of an array object as a one-dimensional array, even if the array object is multi-dimensional. For example, given the array <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>, this method would return 36 in the <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> parameter. Use the [IDebugArrayObject::GetElement](../vs140/idebugarrayobject--getelement.md) method to retrieve the individual elements one at a time.  
