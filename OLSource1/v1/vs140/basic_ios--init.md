...
-   [rdstate](../vs140/basic_ios--rdstate.md) returns [goodbit](../vs140/ios_base--iostate.md) if <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> is nonzero; otherwise, it returns [badbit](../vs140/ios_base--iostate.md).  
...
-   [getloc](../vs140/ios_base--getloc.md) returns <CodeContentPlaceHolder>4\</CodeContentPlaceHolder>.  
