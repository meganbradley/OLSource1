...
---
# AfxSetResourceHandle
Use this function to set the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> handle that determines where the default resources of the application are loaded.  
