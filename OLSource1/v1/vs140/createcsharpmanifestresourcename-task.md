...
|<CodeContentPlaceHolder>2\</CodeContentPlaceHolder>|Required <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> parameter.\<br />\<br /> The name of the resource file from which to create the [!INCLUDE[csprcs](../vs140/includes/csprcs_md.md)] manifest name.|  
