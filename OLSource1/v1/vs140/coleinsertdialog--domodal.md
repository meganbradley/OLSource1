...
#### Parameters  
 ...
 <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> inserts only DocObjects.  
  
 <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> inserts only ActiveX controls.  
...
## Remarks  
 If you want to initialize the various dialog box controls by setting members of the [m_io](../vs140/coleinsertdialog--m_io.md) structure, you should do this before calling <CodeContentPlaceHolder>4\</CodeContentPlaceHolder>, but after the dialog object is constructed.  
  
 If <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> returns IDOK, you can call other member functions to retrieve the settings or information input into the dialog box by the user.  
