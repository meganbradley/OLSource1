...
this __declspec is supported only when compiled with /clr or /clr:pure  
 ...
 A `__declspec` modifier was used but that `__declspec` modifier is only valid when compiled with one of the [/clr](../vs140/-clr--common-language-runtime-compilation-.md) options.  
