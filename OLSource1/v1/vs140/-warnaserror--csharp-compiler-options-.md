...
## Remarks  
 ...
 Use [/warn](../vs140/-warn--csharp-compiler-options-.md) to specify the level of warnings that you want the compiler to display. Use [/nowarn](../vs140/-nowarn--csharp-compiler-options-.md) to disable certain warnings.  
...
3.  Modify the **Treat Warnings As Errors** property.  
     ...
     To set this compiler option programmatically, see <xref:VSLangProj80.CSharpProjectConfigurationProperties3.TreatWarningsAsErrors?qualifyHint=False>.  
