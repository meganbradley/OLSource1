...
-   [CComDispatchDriver](../vs140/ccomdispatchdriver.md) Retrieves or sets an object's properties through an <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> pointer.  
...
-   [IPropertyPage2Impl](../vs140/ipropertypage2impl-class.md) Similar to <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>, but also allows a client to select a specific property in a property page.  
