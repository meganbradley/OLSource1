...
## Return Value  
 Returns the new position or an invalid stream position ( [seekoff](../vs140/basic_streambuf--seekoff.md)(_*Off*, <CodeContentPlaceHolder>5\</CodeContentPlaceHolder>, <CodeContentPlaceHolder>6\</CodeContentPlaceHolder>) ).  
  
## Remarks  
 Moves the pointer relative to <CodeContentPlaceHolder>7\</CodeContentPlaceHolder>.  
