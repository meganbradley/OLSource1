...
#### Parameters  
 ...
 Specifies the sort order of the column that the <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> parameter specifies. <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> to set ascending order; <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> to set descending order. The default value is <CodeContentPlaceHolder>6\</CodeContentPlaceHolder>.  
  
 [in] <CodeContentPlaceHolder>7\</CodeContentPlaceHolder>  
 <CodeContentPlaceHolder>8\</CodeContentPlaceHolder> to set the sort order of the column that the <CodeContentPlaceHolder>9\</CodeContentPlaceHolder> parameter specifies.  
 ...
 <CodeContentPlaceHolder>10\</CodeContentPlaceHolder> to first remove all columns from the list of sort columns, and then add the specified column to the list. The default value is <CodeContentPlaceHolder>11\</CodeContentPlaceHolder>.  
