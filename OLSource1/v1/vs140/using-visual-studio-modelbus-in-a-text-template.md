...
11. Verify that the DSL is working by pressing  F5. In the experimental project, open `Sample.provider`. Close the experimental instance of [!INCLUDE[vsprvs](../vs140/includes/vsprvs_md.md)].  
...
4.  In the experimental instance of [!INCLUDE[vsprvs](../vs140/includes/vsprvs_md.md)], open `Debugging\Sample.consume`.  
