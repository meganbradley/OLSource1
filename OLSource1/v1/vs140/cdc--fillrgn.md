...
---
# CDC::FillRgn
Fills the region specified by <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> with the brush specified by <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>.  
...
## Remarks  
 The brush must either be created using the <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> member functions <CodeContentPlaceHolder>6\</CodeContentPlaceHolder>, <CodeContentPlaceHolder>7\</CodeContentPlaceHolder>, <CodeContentPlaceHolder>8\</CodeContentPlaceHolder>, or be retrieved by **GetStockObject**.  
