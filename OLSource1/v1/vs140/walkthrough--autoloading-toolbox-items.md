...
-   Load the <xref:System.Drawing.Design.ToolboxItem?qualifyHint=False> object in the [!INCLUDE[vsprvs](../vs140/includes/vsprvs_md.md)] **Toolbox** when <xref:Microsoft.VisualStudio.Shell.Package.ToolboxInitialized?qualifyHint=False> and <xref:Microsoft.VisualStudio.Shell.Package.ToolboxUpgraded?qualifyHint=False> events are handled.  
...
3.  Expand the Package Members region to modify the `Initialize` method to do the following things:  
    ...
    -   For [!INCLUDE[csprcs](../vs140/includes/csprcs_md.md)], subscribe to the <xref:Microsoft.VisualStudio.Shell.Package.ToolboxInitialized?qualifyHint=False> and <xref:Microsoft.VisualStudio.Shell.Package.ToolboxUpgraded?qualifyHint=False> events.  
