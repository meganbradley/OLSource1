...
## Notes for Callers  
 The SDM calls [QueryInterface](../vs140/queryinterface.md) on an <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> interface to obtain this interface to track sessions that have attached to programs.  
