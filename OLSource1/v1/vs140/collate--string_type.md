...
---
# collate::string_type
A type that describes a string of type <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> containing characters of type **CharType**.  
...
## Example  
 For an example of how to declare and use <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>, see [transform](../vs140/collate--transform.md).  
