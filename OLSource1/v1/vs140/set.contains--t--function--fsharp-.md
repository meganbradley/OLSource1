...
Evaluates to <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> if the given element is in the given set.  
...
## Return Value  
 True if <CodeContentPlaceHolder>6\</CodeContentPlaceHolder> is in <CodeContentPlaceHolder>7\</CodeContentPlaceHolder>.  
