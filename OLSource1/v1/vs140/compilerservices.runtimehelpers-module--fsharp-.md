...
|[EnumerateFromFunctions](../vs140/runtimehelpers.enumeratefromfunctions--t--u--function--fsharp-.md)  `: (unit -> 'T) -> ('T -> bool) -> ('T -> 'U) -> seq<'U>`|The F# compiler emits calls to this function to implement the compiler-intrinsic conversions from weakly typed <xref:System.Collections.IEnumerable?qualifyHint=False> sequences to typed sequences.|  
