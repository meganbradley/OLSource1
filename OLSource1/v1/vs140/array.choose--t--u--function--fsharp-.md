...
apitype: "Assembly"
f1_keywords: 
  - "Microsoft.FSharp.Collections.ArrayModule.Choose``2"
dev_langs: 
  - "FSharp"
helpviewer_keywords: 
  - "Array.choose function [F#]"
  - "choose function [F#]"
...
Applies the given function to each element of the array. Returns the array comprised of the results <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> for each element where the function returns <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>.  
...
## Example  
 The following code demonstrates the use of <CodeContentPlaceHolder>8\</CodeContentPlaceHolder> to perform an operation only on the even numbers in an array.  
  
 [!code[FsArrays#14](../vs140/codesnippet/FSharp/array.choose--t--u--function--fsharp-_1.fs)]  
