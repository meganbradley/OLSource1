...
|-|-|  
|Term|Definition|  
|[Const Statement](../vs140/const-statement--visual-basic-.md)|Describes the `Const` statement, which is used to declare constants.|  
|[Enum Statement](../vs140/enum-statement--visual-basic-.md)|Describes the `Enum` statement, which is used to create enumerations.|  
