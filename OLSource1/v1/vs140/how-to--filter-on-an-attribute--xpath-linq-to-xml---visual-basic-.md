...
## Example  
 This example finds all descendants elements with the name of <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>, and with a <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> attribute with a value of "Shipping".  
