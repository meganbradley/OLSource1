...
<CodeContentPlaceHolder>4\</CodeContentPlaceHolder>  
 As with all [pragma directives](../vs140/pragma-directives-and-the-__pragma-keyword.md), the alternate pragma syntax <CodeContentPlaceHolder>10\</CodeContentPlaceHolder> is also supported.  
  
 As with the Auto-Parallelizer, you can specify the [/Qvec-report](../vs140/-qvec-report--auto-vectorizer-reporting-level-.md) command-line option to report either successfully vectorized loops only—**/Qvec-report:1**—or both successfully and unsuccessfully vectorized loops—**/Qvec-report:2**).  
...
## See Also  
 ...
 [/Qpar](../vs140/-qpar--auto-parallelizer-.md)   
