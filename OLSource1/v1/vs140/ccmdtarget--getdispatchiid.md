...
## Remarks  
 Derived classes should override this member function (if not overridden, <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> returns FALSE). See [COleControl](../vs140/colecontrol-class.md).  
