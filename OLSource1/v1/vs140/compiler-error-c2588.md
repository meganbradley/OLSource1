...
'::~identifier' : illegal global destructor  
 ...
 This error can be caused by a missing class, structure, or union name on the left side of the scope resolution (<CodeContentPlaceHolder>1\</CodeContentPlaceHolder>) operator.  
