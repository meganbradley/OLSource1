...
## Remarks  
 The possible values for <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> are defined in the file Safeint.h. For convenience, the possible values are also listed here.  
