...
<CodeContentPlaceHolder>3\</CodeContentPlaceHolder>  
 This example outputs the same XML as the first example. However, notice that you can actually see the resulting structure of the new XML in the functional approach. You can see the creation of the <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> element, the code that pulls the <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> element from the source tree, and the code that transforms the attributes from the source tree to elements in the new tree.  
