...
> [!NOTE]
>  Although [ClickOnce](../vs140/clickonce-security-and-deployment.md) deployment for [!INCLUDE[vcprvc](../vs140/includes/vcprvc_md.md)] native applications is possible in Visual Studio, it requires extra steps. For more information, see [ClickOnce Deployment for Visual C++ Applications](../vs140/clickonce-deployment-for-visual-c---applications.md).  
...
-   Local deployment, in which you copy particular Visual C++ DLLs from your Visual Studio installation—typically in \Program Files (x86)\Microsoft Visual Studio <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>\VC\Redist\\<CodeContentPlaceHolder>3\</CodeContentPlaceHolder>\\<CodeContentPlaceHolder>4\</CodeContentPlaceHolder>\—and install them on target computers in the same folder as the application executable. You can use this deployment method to enable installation by users who don't have administrator rights, or for applications that can be run from a network share.  
