...
---
# IDebugEngine3::SetEngineGuid
This method sets the debug engine's (DE) <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>.  
...
#### Parameters  
 ...
 [in] <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> of the engine.  
