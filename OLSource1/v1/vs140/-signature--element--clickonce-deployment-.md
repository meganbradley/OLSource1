...
## Example  
 The following code example illustrates a <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> element in a deployment manifest used in a [!INCLUDE[ndptecclick](../vs140/includes/ndptecclick_md.md)] deployment.  
