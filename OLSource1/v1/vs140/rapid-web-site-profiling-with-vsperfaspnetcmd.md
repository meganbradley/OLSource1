 ...
 **vsperfaspnetcmd /memory**[**:lifetime**] **/trace**<CodeContentPlaceHolder>0\</CodeContentPlaceHolder>  
 ...
 **vsperfaspnetcmd /tip** <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>  
...
|Option|Description|  
|------------|-----------------|  
|**/Output:** <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>|By default, the profiling data (.vsp) file is created in the current directory with the file name **PerformanceReport.vsp**. Use the /output option to specify a different location, file name, or both.|  
