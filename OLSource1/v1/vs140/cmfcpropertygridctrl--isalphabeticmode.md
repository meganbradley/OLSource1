...
## Return Value  
 <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> if the property grid control is in alphabetic mode; otherwise <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>.  
