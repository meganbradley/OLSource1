...
|Member|Description|  
|------------|-----------------|  
|[new](../vs140/core.fsharptypefunc-constructor--fsharp-.md)|Construct an instance of an F# first class type function value|  
  
## Instance Members  
  
|Member|Description|  
|------------|-----------------|  
|[Specialize](../vs140/fsharptypefunc.specialize--t--method--fsharp-.md)|Specialize the type function at a given type|  
