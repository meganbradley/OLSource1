...
#### Parameters  
 ...
 The mangled name of the type after including static parameters. The mangled name is derived from the base type name by adding a backtick (<CodeContentPlaceHolder>3\</CodeContentPlaceHolder>staticArguments`  
