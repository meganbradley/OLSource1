...
helpviewer_keywords: 
  - "scripts, debugging"
  - "debugging script, expressions"
  - "expression evaluation, script debugging"
  - "JScript, expression evaluator"
  - "debugging [JScript], expressions"
...
## eval Method  
 The expression evaluator does not support expressions that use the <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> method, such as:  
...
## Regular Expression Literals  
 The expression evaluator does not support regular expression literals, such as <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>.  
