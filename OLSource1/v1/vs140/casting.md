...
Class Hierarchy  
 ...
 An object of type <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> could be visualized as shown in the following figure.  
  
 ![Class C with sub&#45;objects B and A](../vs140/media/vc38zz2.gif "vc38ZZ2")  
Class C with B Subobject and A Subobject  
  
 Given an instance of class <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>, there is a <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> subobject and an <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> subobject. The instance of <CodeContentPlaceHolder>4\</CodeContentPlaceHolder>, including the <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> and <CodeContentPlaceHolder>6\</CodeContentPlaceHolder> subobjects, is the "complete object."  
