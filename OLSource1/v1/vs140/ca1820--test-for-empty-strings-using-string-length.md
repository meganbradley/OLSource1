...
## How to Fix Violations  
 To fix a violation of this rule, change the comparison to use the <xref:System.String.Length?qualifyHint=False> property and test for the null string. If targeting [!INCLUDE[dnprdnlong](../vs140/includes/dnprdnlong_md.md)], use the <xref:System.String.IsNullOrEmpty?qualifyHint=False> method.  
