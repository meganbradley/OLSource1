...
## Remarks  
 ...
 If you want to disable share violation checking, use the bitwise OR operator to combine the flag **OFN_SHAREAWARE** with <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>.  
