...
1.  Call <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> on \<xref:Microsoft.VisualStudio.Shell.Interop.IVsBuildPropertyStorage*> of the project subtype.  
  
2.  Call \<xref:Microsoft.VisualStudio.Shell.Interop.IVsBuildPropertyStorage.RemoveProperty*> with <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> set to the property you want to remove.  
...
### Persisting Non-Build Related Information  
 ...
 You can implement \<xref:Microsoft.VisualStudio.Shell.Interop.IPersistXMLFragment*> on the main <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> object, the <CodeContentPlaceHolder>6\</CodeContentPlaceHolder> object, or both.  
