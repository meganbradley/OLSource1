...
apitype: "Assembly"
f1_keywords: 
  - "Microsoft.FSharp.Collections.Array2DModule.InitializeBased``1"
dev_langs: 
  - "FSharp"
helpviewer_keywords: 
  - "Array2D.InitializeBased function [F#]"
  - "Array2D.initBased function [F#]"
  - "initBased function [F#]"
  - "InitializeBased function [F#]"
...
#### Parameters  
 ...
 Type: [int](../vs140/core.int-type-abbreviation--fsharp-.md) <CodeContentPlaceHolder>6\</CodeContentPlaceHolder> [int](../vs140/core.int-type-abbreviation--fsharp-.md) <CodeContentPlaceHolder>7\</CodeContentPlaceHolder>  
...
|Exception|Condition|  
|---------------|---------------|  
|\<xref:System.ArgumentException*>|Thrown when <CodeContentPlaceHolder>8\</CodeContentPlaceHolder>, <CodeContentPlaceHolder>9\</CodeContentPlaceHolder>, <CodeContentPlaceHolder>10\</CodeContentPlaceHolder>, or <CodeContentPlaceHolder>11\</CodeContentPlaceHolder> is negative.|  
