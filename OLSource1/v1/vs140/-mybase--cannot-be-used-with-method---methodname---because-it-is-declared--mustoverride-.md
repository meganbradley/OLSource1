...
You have attempted to use <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> with a method that has been declared <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>.  
