...
#### Parameters  
 ...
 The type that represents the stored allocator object that encapsulates details about the allocation and deallocation of memory for the concurrent vector. This argument is optional and the default value is                         <CodeContentPlaceHolder>38\</CodeContentPlaceHolder>.  
...
|[concurrent_unordered_multiset::insert Method](#concurrent_unordered_multiset__insert_method)|Overloaded. Adds elements to the                                         <CodeContentPlaceHolder>54\</CodeContentPlaceHolder> object.|  
...
|[concurrent_unordered_multiset::swap Method](#concurrent_unordered_multiset__swap_method)|Swaps the contents of two                                         <CodeContentPlaceHolder>55\</CodeContentPlaceHolder> objects. This method is not concurrency-safe.|  
|[concurrent_unordered_multiset::unsafe_erase Method](#concurrent_unordered_multiset__unsafe_erase_method)|Overloaded. Removes elements from the                                         <CodeContentPlaceHolder>56\</CodeContentPlaceHolder> at specified positions. This method is not concurrency-safe.|  
  
### Public Operators  
  
|Name|Description|  
|----------|-----------------|  
|[concurrent_unordered_multiset::operator= Operator](#concurrent_unordered_multiset__operator_eq_operator)|Overloaded. Assigns the contents of another                                         <CodeContentPlaceHolder>57\</CodeContentPlaceHolder> object to this one. This method is not concurrency-safe.|  
...
### Parameters  
 ...
 The source                                 <CodeContentPlaceHolder>70\</CodeContentPlaceHolder> object to move elements from.  
  
### Remarks  
 All constructors store an allocator object                         <CodeContentPlaceHolder>71\</CodeContentPlaceHolder> and initialize the unordered multiset.  
 ...
 The fourth and fifth constructors specify a copy of the concurrent unordered multiset                         <CodeContentPlaceHolder>74\</CodeContentPlaceHolder>.  
  
 The last constructor specifies a move of the concurrent unordered multiset                         <CodeContentPlaceHolder>75\</CodeContentPlaceHolder>.  
...
### Remarks  
 The first member function inserts the element                         <CodeContentPlaceHolder>89\</CodeContentPlaceHolder> in the controlled sequence, then returns the iterator that designates the inserted element.  
  
 The second member function returns insert(                        <CodeContentPlaceHolder>90\</CodeContentPlaceHolder>), using                         <CodeContentPlaceHolder>91\</CodeContentPlaceHolder> as a starting place within the controlled sequence to search for the insertion point.  
  
 The third member function inserts the sequence of element values from the range [                        <CodeContentPlaceHolder>92\</CodeContentPlaceHolder>,                         <CodeContentPlaceHolder>93\</CodeContentPlaceHolder>).  
  
 The last two member functions behave the same as the first two, except that                         <CodeContentPlaceHolder>94\</CodeContentPlaceHolder> is used to construct the inserted value.  
...
##  \<a name="concurrent_unordered_multiset__operator_eq_operator">\</a>  concurrent_unordered_multiset::operator= Operator  
 Assigns the contents of another                 <CodeContentPlaceHolder>96\</CodeContentPlaceHolder> object to this one. This method is not concurrency-safe.  
  
<CodeContentPlaceHolder>18\</CodeContentPlaceHolder>  
### Parameters  
 <CodeContentPlaceHolder>97\</CodeContentPlaceHolder>  
 The source                                 <CodeContentPlaceHolder>98\</CodeContentPlaceHolder> object.  
  
### Return Value  
 A reference to this                         <CodeContentPlaceHolder>99\</CodeContentPlaceHolder> object.  
  
### Remarks  
 After erasing any existing elements in a concurrent unordered multiset,                         <CodeContentPlaceHolder>100\</CodeContentPlaceHolder> either copies or moves the contents of                         <CodeContentPlaceHolder>101\</CodeContentPlaceHolder> into the concurrent unordered multiset.  
...
### Remarks  
 The member function alters the number of buckets to be at least                         <CodeContentPlaceHolder>103\</CodeContentPlaceHolder> and rebuilds the hash table as needed. The number of buckets must be a power of 2. If not a power of 2, it will be rounded up to the next largest power of 2.  
...
##  \<a name="concurrent_unordered_multiset__swap_method">\</a>  concurrent_unordered_multiset::swap Method  
 Swaps the contents of two                 <CodeContentPlaceHolder>104\</CodeContentPlaceHolder> objects. This method is not concurrency-safe.  
  
<CodeContentPlaceHolder>21\</CodeContentPlaceHolder>  
### Parameters  
 <CodeContentPlaceHolder>105\</CodeContentPlaceHolder>  
 The                                 <CodeContentPlaceHolder>106\</CodeContentPlaceHolder> object to swap with.  
...
##  \<a name="concurrent_unordered_multiset__unsafe_erase_method">\</a>  concurrent_unordered_multiset::unsafe_erase Method  
 Removes elements from the                 <CodeContentPlaceHolder>113\</CodeContentPlaceHolder> at specified positions. This method is not concurrency-safe.  
...
### Remarks  
 The first member function removes the element pointed to by                         <CodeContentPlaceHolder>118\</CodeContentPlaceHolder>. The second member function removes the elements in the range [                        <CodeContentPlaceHolder>119\</CodeContentPlaceHolder>,                         <CodeContentPlaceHolder>120\</CodeContentPlaceHolder>).  
