...
## Remarks  
 Querydef names are unique, user-defined names. You can call <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> before the querydef object is appended to the QueryDefs collection.  
