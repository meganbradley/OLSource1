...
> [!NOTE]
>  If the filter takes a long time to run, you might display results more quickly by using the <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> advanced search operator.  
