...
4.  At the command line, type <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> *sourceFileName* and then press ENTER.  
  
     For example, if you stored your source code in a directory called <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>, you would open the Command Prompt and type <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> to change to that directory. If the directory contained a source file named <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>, you could compile it by typing <CodeContentPlaceHolder>4\</CodeContentPlaceHolder>.  
...
2.  At the command line, type <CodeContentPlaceHolder>5\</CodeContentPlaceHolder>*sourceFileName* and then press ENTER.  
  
     For example, if you stored your source code in a directory called <CodeContentPlaceHolder>6\</CodeContentPlaceHolder>, you would open the Command Prompt and type <CodeContentPlaceHolder>7\</CodeContentPlaceHolder> to change to that directory. If the directory contained a source file named <CodeContentPlaceHolder>8\</CodeContentPlaceHolder>, you could compile it by typing <CodeContentPlaceHolder>9\</CodeContentPlaceHolder>.  
