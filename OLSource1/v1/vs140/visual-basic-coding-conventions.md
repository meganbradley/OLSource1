...
-   Do not use "My" or "my" as part of a variable name. This practice creates confusion with the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> objects.  
...
-   When you use the <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> method, use the default construct for new console applications, and use <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> for command-line arguments.  
...
-   Use <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> rather than unsigned types, except where they are necessary.  
...
### Use the With Keyword  
 When you make a series of calls to one object, consider using the <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> keyword:  
...
### Use the Try...Catch and Using Statements when you use Exception Handling  
 Do not use <CodeContentPlaceHolder>6\</CodeContentPlaceHolder>.  
  
### Use the IsNot Keyword  
 Use the <CodeContentPlaceHolder>7\</CodeContentPlaceHolder> keyword instead of <CodeContentPlaceHolder>8\</CodeContentPlaceHolder>.  
...
-   Use <CodeContentPlaceHolder>9\</CodeContentPlaceHolder> rather than <CodeContentPlaceHolder>10\</CodeContentPlaceHolder>:  
  
     [!code[VbVbalrGuidelines#24](../vs140/codesnippet/VisualBasic/visual-basic-coding-conventions_16.vb)]  
  
-   Use <CodeContentPlaceHolder>11\</CodeContentPlaceHolder>, and do not instantiate the delegate explicitly:  
...
-   Do not verify whether an event is <CodeContentPlaceHolder>12\</CodeContentPlaceHolder> (null) before you call the <CodeContentPlaceHolder>13\</CodeContentPlaceHolder> method. <CodeContentPlaceHolder>14\</CodeContentPlaceHolder> checks for <CodeContentPlaceHolder>15\</CodeContentPlaceHolder> before it raises the event.  
  
### Using Shared Members  
 Call <CodeContentPlaceHolder>16\</CodeContentPlaceHolder> members by using the class name, not from an instance variable.  
...
-   Use embedded expressions to include values and to create XML from existing values instead of using API calls such as the <CodeContentPlaceHolder>17\</CodeContentPlaceHolder> method:  
...
-   Rename properties when the property names in the result would be ambiguous. For example, if your query returns a customer name and an order ID, rename them instead of leaving them as <CodeContentPlaceHolder>18\</CodeContentPlaceHolder> and <CodeContentPlaceHolder>19\</CodeContentPlaceHolder> in the result:  
...
-   Align query clauses under the <CodeContentPlaceHolder>20\</CodeContentPlaceHolder> statement:  
  
     [!code[VbVbalrGuidelines#32](../vs140/codesnippet/VisualBasic/visual-basic-coding-conventions_24.vb)]  
  
-   Use <CodeContentPlaceHolder>21\</CodeContentPlaceHolder> clauses before other query clauses so that later query clauses operate on the filtered set of data:  
  
     [!code[VbVbalrGuidelines#33](../vs140/codesnippet/VisualBasic/visual-basic-coding-conventions_25.vb)]  
  
-   Use the <CodeContentPlaceHolder>22\</CodeContentPlaceHolder> clause to explicitly define a join operation instead of using the <CodeContentPlaceHolder>23\</CodeContentPlaceHolder> clause to implicitly define a join operation:  
