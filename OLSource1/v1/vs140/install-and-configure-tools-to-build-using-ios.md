...
-   In the Terminal window vcremote is running in, enter <CodeContentPlaceHolder>7\</CodeContentPlaceHolder>.  
...
8.  Update the folder name in the **Remote Root** field to specify the folder used by the remote agent in your home (~) directory on the Mac. By default, the remote agent uses /Users/<CodeContentPlaceHolder>8\</CodeContentPlaceHolder>/vcremote as the remote root.  
...
3.  When prompted for confirmation, enter <CodeContentPlaceHolder>11\</CodeContentPlaceHolder>.  
...
-   To use a background process to capture <CodeContentPlaceHolder>16\</CodeContentPlaceHolder> and <CodeContentPlaceHolder>17\</CodeContentPlaceHolder> to a file named server.log, enter:  
