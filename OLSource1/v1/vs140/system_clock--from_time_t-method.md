...
Static method that returns a [time_point](../vs140/time_point-class.md) that most closely approximates the time that is represented by <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>.  
