...
-   The "ProjName" string in the MSSCCPRJ.SCC file must match exactly the string returned from the <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> function. If the string returned by the function has quotes around it, the string in the MSSCCPRJ.SCC file must have quotes around it, and vice versa.  
...
## An Illustration of the MSSCCPRJ.SCC File Format  
 ...
 [Line 1] <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>  
  
 [Line 2]  
  
 [Line 3] <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>  
  
 [Line 4] <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>  
  
 [Line 5] <CodeContentPlaceHolder>4\</CodeContentPlaceHolder>  
  
 [Line 6]  
  
 [Line 7] <CodeContentPlaceHolder>5\</CodeContentPlaceHolder>  
  
 [Line 8] <CodeContentPlaceHolder>6\</CodeContentPlaceHolder>  
  
 [Line 9] <CodeContentPlaceHolder>7\</CodeContentPlaceHolder>  
 ...
 What follows is a section of settings for each file, marked by the file name in square brackets. This section is repeated for each file being tracked. This line is a sample of a file name, namely, <CodeContentPlaceHolder>9\</CodeContentPlaceHolder>. The IDE expects the following two lines. It does not, however, define the style of the values defined. The variables are <CodeContentPlaceHolder>10\</CodeContentPlaceHolder> and <CodeContentPlaceHolder>11\</CodeContentPlaceHolder>.  
