...
|A [get](../vs140/get--csharp-reference-.md) accessor of a property has no parameters.|A `get` accessor of an indexer has the same formal parameter list as the indexer.|  
|A [set](../vs140/set--csharp-reference-.md) accessor of a property contains the implicit `value` parameter.|A `set` accessor of an indexer has the same formal parameter list as the indexer, and also to the [value](../vs140/value--csharp-reference-.md) parameter.|  
