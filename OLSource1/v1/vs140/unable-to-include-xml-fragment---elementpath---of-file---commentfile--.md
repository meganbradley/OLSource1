...
An <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> tag in an XML comment contains an XPath expression for an element that does not exist, or the file contains badly formed XML.  
