...
#### Parameters  
 ...
 If <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>, the outlook window will be redrawn.  
  
## Remarks  
 Use this function to change text alignment for page buttons.  
  
 <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> can be one of the following values:  
