...
|MyDb.ServiceTypes.*DataContextTypeName*|The data context type, inherited from <xref:System.Data.Linq.DataContext?qualifyHint=False>.|  
|MyDb.ServiceTypes.SimpleDataContextTypes. *DataContextTypeName*|Contains one method for each method on the full context type, including stored procedures and functions, if the options for these have been selected. The methods return <xref:System.Data.Linq.ISingleResult`1?qualifyHint=False>.<br /><br /> Contains one property for each property of the full context type. The properties return <xref:System.Data.Linq.Table`1?qualifyHint=False>.<br /><br /> The property `Connection` gets the database connection as an instance of <xref:System.Data.Common.DbConnection?qualifyHint=False>.<br /><br /> The property DataContext gets the full data context, of type <xref:System.Data.Linq.DataContext?qualifyHint=False>. This is the base type of the *DataContextTypeName* type generated by the type provider.|  
  
> [!WARNING]
>  **Note** To improve performance of read-only operations, set the <xref:System.Data.Linq.DataContext.ObjectTrackingEnabled?qualifyHint=False> property on the <xref:System.Data.Linq.DataContext?qualifyHint=False> object to false.  
