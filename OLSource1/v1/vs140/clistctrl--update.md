...
---
# CListCtrl::Update
Forces the list view control to repaint the item specified by <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>.  
...
## Remarks  
 This function also arranges the list view control if it has the <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> style.  
