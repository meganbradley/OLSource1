...
## Return Value  
 A <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> value. Equal to the **uHit** member of the **MCHITTESTINFO** structure.  
  
## Remarks  
 <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> uses the **MCHITTESTINFO** structure, which contains information about the hit test.  
