...
## Remarks  
 This method returns a nonzero value if the total count, <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>, of all tracked commands is equal to or larger than the initial count, <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>. By default, the framework sets the initial count 0. You can override this value by using the [CMFCCmdUsageCount::SetOptions](../vs140/cmfccmdusagecount--setoptions.md) method.  
