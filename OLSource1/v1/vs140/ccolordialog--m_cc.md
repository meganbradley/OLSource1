...
## Remarks  
 After constructing a <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> object, you can use <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> to set various aspects of the dialog box before calling the [DoModal](../vs140/ccolordialog--domodal.md) member function.  
