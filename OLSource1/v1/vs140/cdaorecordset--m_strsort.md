...
## Remarks  
 ...
 The use of <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> has no effect when opening a recordset using a <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> pointer.  
