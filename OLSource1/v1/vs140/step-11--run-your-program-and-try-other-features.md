...
3.  Choose a color to set the PictureBox background color. Look closely at the <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> method to understand how it works.  
...
-   To learn more about Visual C#, see [Introduction to the C# Language and the .NET Framework](../vs140/introduction-to-the-csharp-language-and-the-.net-framework.md).  
