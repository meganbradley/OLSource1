...
## Remarks  
 This method is for use within the body of the agent. For each agent, at most one concurrent reader may be active, so no more than one concurrent call to [Receive](../vs140/mailboxprocessor.receive--msg--method--fsharp-.md), [TryReceive](../vs140/mailboxprocessor.tryreceive--msg--method--fsharp-.md), <CodeContentPlaceHolder>9\</CodeContentPlaceHolder> or [TryScan](../vs140/mailboxprocessor.tryscan--msg--t--method--fsharp-.md) may be active. The body of the <CodeContentPlaceHolder>10\</CodeContentPlaceHolder> function is locked during its execution, but the lock is released before the execution of the asynchronous workflow.  
  
## Example  
 The following example shows how to use the <CodeContentPlaceHolder>11\</CodeContentPlaceHolder> method. In this code, mailbox processor agents manage a series of simulated jobs that run and compute a result.  
