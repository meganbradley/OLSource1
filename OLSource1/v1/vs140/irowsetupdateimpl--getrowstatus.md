...
#### Parameters  
 ...
 [in] Corresponds to the <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> parameter in [IRowsetUpdate::GetRowStatus](https://msdn.microsoft.com/en-us/library/ms724377.aspx).  
