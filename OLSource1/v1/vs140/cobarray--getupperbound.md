...
## Remarks  
 Because array indexes are zero-based, this function returns a value 1 less than <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>.  
...
## Example  
 See [CObList::CObList](../vs140/coblist--coblist.md) for a listing of the <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> class used in all collection examples.  
