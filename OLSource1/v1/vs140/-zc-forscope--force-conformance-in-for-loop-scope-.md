...
<CodeContentPlaceHolder>1\</CodeContentPlaceHolder>  
 If you use **/Zc:forScope-**, warning C4288 (off by default) is generated if a variable is in scope because of a declaration that was made in a previous scope. To demonstrate this, remove the <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> characters in the example code to declare <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>.  
