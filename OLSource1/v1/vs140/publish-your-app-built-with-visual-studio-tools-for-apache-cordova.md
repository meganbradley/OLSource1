...
-   For Windows Phone, see [Submit your app](http://msdn.microsoft.com/library/windowsphone/help/jj206724.aspx) in the Windows Dev Center.  
 ...
 For your convenience, the <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> agent also creates a Wireless Manifest plist file. You can use this file to upload your iOS app to Windows Intune. The plist file can be found in the bin folder with your IPA (.ipa) file after you build your app in Visual Studio. You can also modify this file manually.  
