...
-   Continue: Run again, and leave any old step active.  
 ...
 The thread passed to <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> is useful when deciding which step to cancel. If you do not know the thread, running execute cancels all steps. With knowledge of the thread, you only need to cancel the step on the active thread.  
