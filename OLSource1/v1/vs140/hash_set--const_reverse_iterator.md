...
f1_keywords: 
  ...
  - "std.hash_set.const_reverse_iterator"
  - "std::hash_set::const_reverse_iterator"
dev_langs: 
  - "C++"
helpviewer_keywords: 
...
## Remarks  
 A type <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> cannot modify the value of an element and is use to iterate through the hash_set in reverse.  
  
 In Visual C++ .NET 2003, members of the [\<hash_map>](../vs140/-hash_map-.md) and [\<hash_set>](../vs140/-hash_set-.md) header files are no longer in the std namespace, but rather have been moved into the stdext namespace. See [The stdext Namespace](../vs140/stdext-namespace.md) for more information.  
  
## Example  
 See the example for [rend](../vs140/hash_set--rend.md) for an example of how to declare and use the <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>  
