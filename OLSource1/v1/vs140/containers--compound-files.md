...
##  \<a name="_core_components_of_a_compound_file">\</a> Components of a Compound File  
 The OLE implementation of compound files uses three object types: stream objects, storage objects, and <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> objects. These objects are similar to the components of a standard file system in the following ways:  
...
##  \<a name="_core_using_compound_files_format_for_your_data">\</a> Using Compound Files Format for Your Data  
 After successfully creating an application that has a document class derived from <CodeContentPlaceHolder>4\</CodeContentPlaceHolder>, ensure that your main document constructor calls <CodeContentPlaceHolder>5\</CodeContentPlaceHolder>. When the application wizard creates OLE container applications, this call is inserted for you.  
