...
## Remarks  
 <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> describes an object that can represent the difference between the addresses of any two elements in the controlled sequence.  
