...
-   [Creating a Windows Forms Toolbox Control](../vs140/creating-a-windows-forms-toolbox-control.md)  
...
## Creating Custom Start Pages  
 Learn how to make your own start page, either from scratch or from a downloadable start page sample: [Start Pages](../vs140/creating-a-custom-start-page.md).  
  
## Write to the Activity Log  
 Learn how to write to the Activity Log: [How to: Use the Activity Log](../vs140/how-to--use-the-activity-log.md).