...
---
# IErrorRecordsImpl Class
Implements the OLE DB [IErrorRecords](https://msdn.microsoft.com/en-us/library/ms718112.aspx) interface, adding records to and retrieving records from a data member ([m_rgErrors](../vs140/ierrorrecordsimpl--m_rgerrors.md)) of type **CAtlArray<**<CodeContentPlaceHolder>1\</CodeContentPlaceHolder>**>**.  
...
#### Parameters  
 ...
 A class derived from <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>.  
