...
>   
>  For more information, see [Verifying Code by Using Unit Tests](../vs140/unit-test-your-code.md) in the MSDN Library.  
  
## In this section  
 [Unit testing C# code in a Metro style app](../vs140/unit-testing-visual-csharp-code-in-a-store-app.md)  
  
 [Unit testing a C++ dll for Metro style apps](../vs140/unit-testing-a-visual-c---dll-for-store-apps.md)  
  
 [Running unit tests for Metro style apps](../vs140/run-unit-tests-for-store-apps-in-visual-studio.md)