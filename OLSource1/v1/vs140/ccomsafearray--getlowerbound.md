...
## Remarks  
 If the lower bound is 0, this indicates a C-like array whose first element is element number 0. In the event of an error, for example, an invalid dimension argument, this method calls <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> with an HRESULT describing the error.  
