...
---
# COleStreamFile::Attach
Associates the supplied OLE stream with the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> object.  
...
#### Parameters  
 ...
 Points to the OLE stream (<CodeContentPlaceHolder>3\</CodeContentPlaceHolder>) to be associated with the object. Cannot be **NULL**.  
