...
Every class or struct in C# implicitly inherits the \<xref:System.Object*> class. Therefore, every object in C# gets the \<xref:System.Object.ToString*> method, which returns a string representation of that object. For example, all variables of type <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> have a <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> method, which enables them to return their contents as a string:  
 ...
 For information about how to use format strings and other types of custom formatting with the <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> method, see [Formatting Types](assetId:///0d1364da-5b30-4d42-8e6b-03378343343f).  
...
1.  Declare a <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> method with the following modifiers and return type:  
...
2.  Implement the method so that it returns a string.  
     ...
     You can test the <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> method as shown in the following code example:  
