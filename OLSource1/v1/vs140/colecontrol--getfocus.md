...
---
# COleControl::GetFocus
Determines whether the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> object has the focus.  
...
## Return Value  
 ...
 Otherwise, returns the <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> object that has the focus (same as <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>).  
