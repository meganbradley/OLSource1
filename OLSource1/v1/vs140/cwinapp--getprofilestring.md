...
## Return Value  
 The return value is the string from the application's .INI file or <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> if the string cannot be found. The maximum string length supported by the framework is <CodeContentPlaceHolder>5\</CodeContentPlaceHolder>. If <CodeContentPlaceHolder>6\</CodeContentPlaceHolder> is **NULL**, the return value is an empty string.  
