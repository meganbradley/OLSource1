...
## Converting Dynamic Objects  
 Type conversions of dynamic objects are performed by user-defined dynamic conversions that use the [TryConvert](assetId:///M:System.Dynamic.DynamicObject.TryConvert(System.Dynamic.ConvertBinder,System.Object@)?qualifyHint=False&autoUpgrade=True) or [BindConvert](assetId:///M:System.Dynamic.DynamicMetaObject.BindConvert(System.Dynamic.ConvertBinder)?qualifyHint=False&autoUpgrade=True) methods. If you're working with dynamic objects, use the [CTypeDynamic](assetId:///M:Microsoft.VisualBasic.Conversion.CTypeDynamic(System.Object,System.Type)?qualifyHint=False&autoUpgrade=True) method to convert the dynamic object.  
