...
## Remarks  
 The **EXTLOGPEN** structure defines the style, width, and brush attributes of a pen. For example, call <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> to match the particular style of a pen.  
...
## Example  
 The following code example demonstrates calling <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> to retrieve a pen's attributes, and then create a new, cosmetic pen with the same color.  
