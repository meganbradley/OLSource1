...
#### Parameters  
 ...
 Specifies the type of help requested. For a list of possible values and how they affect the <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> parameter, see the <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> parameter described in the [HTMLHelp API Reference](vsconOvhtmlhelpapioverview) in the [!INCLUDE[winSDK](../vs140/includes/winsdk_md.md)].  
