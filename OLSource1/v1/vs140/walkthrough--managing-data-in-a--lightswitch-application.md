...
4.  In the **Name** text box, enter <CodeContentPlaceHolder>5\</CodeContentPlaceHolder>, and then choose the **OK** button.  
...
2.  In the **Properties** window, set the **Name** property to <CodeContentPlaceHolder>6\</CodeContentPlaceHolder>.  
...
2.  In the **Properties** window, set the **Name** property to <CodeContentPlaceHolder>7\</CodeContentPlaceHolder>.  
...
<CodeContentPlaceHolder>0\</CodeContentPlaceHolder>  
    > [!IMPORTANT]
    >  In the line <CodeContentPlaceHolder>8\</CodeContentPlaceHolder>, replace the placeholder path with the location of the file that you downloaded.  
...
5.  Add the following code to the <CodeContentPlaceHolder>9\</CodeContentPlaceHolder> method:  
