...
#### Parameters  
 *hRowToFlush*  
 [in] Handle to the rows for the data. The type of this row is determined from the *RowClass* template argument of the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> class (<CodeContentPlaceHolder>2\</CodeContentPlaceHolder> by default).  
