...
4.  Modify the **Additional Options** property to include **/CGTHREADS:**<CodeContentPlaceHolder>2\</CodeContentPlaceHolder>, where <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> is a value from 1 to 8, and then choose **OK**.  
