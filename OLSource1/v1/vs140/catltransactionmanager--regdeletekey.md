...
f1_keywords: 
  - "RegDeleteKeyEx"
  - "atltransactionmanager/CAtlTransactionManager::RegDeleteKeyEx"
dev_langs: 
  - "C++"
helpviewer_keywords: 
  - "RegDeleteKeyEx"
...
|---------------|-----------------|  
|<CodeContentPlaceHolder>1\</CodeContentPlaceHolder>|A handle to an open registry key.|  
|<CodeContentPlaceHolder>2\</CodeContentPlaceHolder>|The name of the key to be deleted.|  
