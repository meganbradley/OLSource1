...
|[CObArray::GetData](../vs140/cobarray-class.md#cobarray__getdata)|Allows access to elements in the array. Can be <CodeContentPlaceHolder>7\</CodeContentPlaceHolder>.|  
...
## Remarks  
 <CodeContentPlaceHolder>8\</CodeContentPlaceHolder> incorporates the <CodeContentPlaceHolder>9\</CodeContentPlaceHolder> macro to support run-time type access and dumping to a <CodeContentPlaceHolder>10\</CodeContentPlaceHolder> object. If you need a dump of individual pointer array elements, you must set the depth of the dump context to 1 or greater.  
  
> [!NOTE]
>  Before using an array, use <CodeContentPlaceHolder>11\</CodeContentPlaceHolder> to establish its size and allocate memory for it. If you do not use <CodeContentPlaceHolder>12\</CodeContentPlaceHolder>, adding elements to your array causes it to be frequently reallocated and copied. Frequent reallocation and copying are inefficient and can fragment memory.  
