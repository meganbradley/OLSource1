...
---
# _RTC_SetErrorFunc
Designates a function as the handler for reporting run-time error checks (RTCs). This function is deprecated; use <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> instead.  
...
## Remarks  
 Do not use this function; instead, use <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>. It is retained only for backward compatibility.  
