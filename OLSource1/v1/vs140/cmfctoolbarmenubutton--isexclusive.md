...
## Return Value  
 <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> if the button is working in exclusive mode; otherwise <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>.  
...
## Remarks  
 ...
 The default implementation always returns <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>. Override this method in a derived class if you want to turn on exclusive mode.  
