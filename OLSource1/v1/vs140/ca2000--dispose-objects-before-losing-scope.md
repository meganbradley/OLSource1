...
## How to Fix Violations  
 ...
 Note that you can use the `using` statement (`Using` in [!INCLUDE[vbprvb](../vs140/includes/vbprvb_md.md)]) to wrap objects that implement `IDisposable`. Objects that are wrapped in this manner will automatically be disposed at the close of the `using` block.  
