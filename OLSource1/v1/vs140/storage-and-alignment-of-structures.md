 ...
 *offset* <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> *alignment-requirement* <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> 0  
...
<CodeContentPlaceHolder>0\</CodeContentPlaceHolder>  
 ...
 To use the <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> pragma to specify packing other than the packing specified on the command line for a particular structure, give the <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> pragma, where the packing size is 1, 2, 4, 8, or 16, before the structure. To reinstate the packing given on the command line, specify the <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> pragma with no arguments.  
