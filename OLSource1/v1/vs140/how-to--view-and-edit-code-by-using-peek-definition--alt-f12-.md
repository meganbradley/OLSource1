...
1.  You can find **Peek Definition** by opening the shortcut menu for a method that you want to explore. (Keyboard: Alt+F12)  
     ...
     This illustration shows the **Peek Definition** window for a method that's named <CodeContentPlaceHolder>0\</CodeContentPlaceHolder>:  
  
     ![Peek Window](../vs140/media/peekwindow.png "PeekWindow")  
  
     The definition window appears below the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> line in the original file. The window doesn't hide any of the code in your original file. The lines that follow the <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> call appear under the definition window.  
