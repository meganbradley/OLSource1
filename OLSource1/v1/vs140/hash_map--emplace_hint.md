...
dev_langs: 
  - "C++"
helpviewer_keywords: 
  - "emplace_hint method, hash_map class"
  - "emplace_hint method"
...
## Return Value  
 The [emplace](../vs140/hash_multimap--emplace.md) member function returns an iterator that points to the position where the new element was inserted into the <CodeContentPlaceHolder>5\</CodeContentPlaceHolder>, or where the existing element with equivalent ordering is located.  
