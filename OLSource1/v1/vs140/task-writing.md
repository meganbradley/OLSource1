...
```  
 ...
 When tasks run, they can also receive inputs from the project file if you create .NET properties on the task class. [!INCLUDE[vstecmsbuild](../vs140/includes/vstecmsbuild_md.md)] sets these properties immediately before calling the task's `Execute` method. To create a string property, use task code such as:  
...
### Description  
 This following [!INCLUDE[csprcs](../vs140/includes/csprcs_md.md)] class demonstrates a task deriving from the <xref:Microsoft.Build.Utilities.Task?qualifyHint=False> helper class. This task returns `true`, indicating that it succeeded.  
...
### Description  
 This following [!INCLUDE[csprcs](../vs140/includes/csprcs_md.md)] class demonstrates a task implementing the <xref:Microsoft.Build.Framework.ITask?qualifyHint=False> interface. This task returns `true`, indicating that it succeeded.  
...
### Description  
 This [!INCLUDE[csprcs](../vs140/includes/csprcs_md.md)] class demonstrates a task that derives from the <xref:Microsoft.Build.Utilities.Task?qualifyHint=False> helper class. It has a required string property, and raises an event that is displayed by all registered loggers.  
