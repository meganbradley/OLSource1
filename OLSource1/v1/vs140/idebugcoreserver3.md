...
## Remarks  
 A custom port supplier receives the [IDebugCoreServer2](../vs140/idebugcoreserver2.md) interface on a call to [IDebugPortEvents2::Event](../vs140/idebugportevents2--event.md). The <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> interface can be obtained from that interface.  
