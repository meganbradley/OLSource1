...
2.  In the [Insert Resource dialog box](../vs140/add-resource-dialog-box.md), select **Icon** or **Cursor** and click **New**.  
...
## See Also  
 [Using the 256-Color Palette](../vs140/using-the-256-color-palette--image-editor-for-icons-.md)   
