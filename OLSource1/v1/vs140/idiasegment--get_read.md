...
#### Parameters  
 ...
 [out] Returns <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> if the segment can be read; otherwise, returns <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>.  
