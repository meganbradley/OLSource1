 ...
 **Information for Programmers**  
 ...
 This error occurs when the operating system failed to create the memory pool for the application. Specifically, the C Runtime (CRT) called the Win32 function <CodeContentPlaceHolder>0\</CodeContentPlaceHolder>, which returned NULL indicating failure.  
