...
## Remarks  
 This method is for those debug engines that supply documents directly to the IDE. Otherwise, this method should return <CodeContentPlaceHolder>4\</CodeContentPlaceHolder>.  
