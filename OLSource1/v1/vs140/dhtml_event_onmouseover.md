...
ms.topic: "article"
f1_keywords: 
  - "AFXDHTML/DHTML_EVENT_ONMOUSEOVER"
  - "DHTML_EVENT_ONMOUSEOVER"
dev_langs: 
  - "C++"
helpviewer_keywords: 
  - "DHTML_EVENT_ONMOUSEOVER macro"
...
---
# DHTML_EVENT_ONMOUSEOVER
Handles (at the document level) the **onmouseover** event originated by the HTML element identified by <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>.  
