...
##  <a name="BKMK_CustomSQL"></a> Executing Transact-SQL code  
 You can also specify Transact-SQL directly by using the [ExecuteCommand](assetId:///M:System.Data.Linq.DataContext.ExecuteCommand(System.String,System.Object[])?qualifyHint=False&autoUpgrade=True) method on the `DataContext` class.  
