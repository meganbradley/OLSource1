...
---
# CDC::GetCharWidth
Retrieves the widths of individual characters in a consecutive group of characters from the current font, using <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>, the input device context.  
