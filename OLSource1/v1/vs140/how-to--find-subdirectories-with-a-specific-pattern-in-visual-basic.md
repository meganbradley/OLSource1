...
-   One or more of the specified wildcard characters is `Nothing`, an empty string, or contains only spaces (<xref:System.ArgumentNullException?qualifyHint=False>).  
...
## See Also  
 <xref:Microsoft.VisualBasic.FileIO.FileSystem.GetDirectories?qualifyHint=False>   
