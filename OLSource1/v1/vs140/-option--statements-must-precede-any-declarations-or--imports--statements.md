...
<CodeContentPlaceHolder>0\</CodeContentPlaceHolder> statements should be the first non-comment statements in your source code.  
  
 **Error ID:** BC30627  
  
### To correct this error  
  
-   Move the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> statements to the top of the source code, immediately before <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> and <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> statements.  
