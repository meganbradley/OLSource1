...
## Return Value  
 The localized name of the key specified by the <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> parameter. If the key has no mapped name, <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> returns an empty string.  
