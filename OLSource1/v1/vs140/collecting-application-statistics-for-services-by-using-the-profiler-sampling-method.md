...
|----------|---------------------|  
|**Attach the profiler to a .NET service**|-   [How to: Attach the Profiler to a .NET Service to Collect Application Statistics Using the Command Line](../vs140/how-to--attach-the-profiler-to-a-.net-service-to-collect-application-statistics-by-using-the-command-line.md)|  
...
|**Attach the profiler to a C/C++ service**|-   [How to: Attach the Profiler to a Native Service to Collect Application Statistics Using the Command Line](../vs140/how-to--attach-the-profiler-to-a-native-service-to-collect-application-statistics-by-using-the-command-line.md)|  
...
|**Profile ASP.NET Web applications**|-   [Collecting Application Statistics for ASP.NET Applications Using the Profiler Sampling Method from Command-Line](../vs140/collecting-application-statistics-for-asp.net-web-applications-using-the-profiler-sampling-method-from-the-command-line.md)|  
