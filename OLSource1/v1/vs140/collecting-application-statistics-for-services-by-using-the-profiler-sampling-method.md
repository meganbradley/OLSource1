...
|----------|---------------------|  
|**Attach the profiler to a .NET service**|-   [How to: Attach the Profiler to a .NET Service to Collect Application Statistics Using the Command Line](../vs140/a0046c47-26c8-4bec-96a0-81da05e5104a.md)|  
...
|**Attach the profiler to a C/C++ service**|-   [How to: Attach the Profiler to a Native Service to Collect Application Statistics Using the Command Line](../vs140/f783817f-77a0-4eb8-985b-ec3b77eadc42.md)|  
...
|**Profile ASP.NET Web applications**|-   [Collecting Application Statistics for ASP.NET Applications Using the Profiler Sampling Method from Command-Line](../vs140/f8383ab1-eb49-4d3f-8608-d8b4d51a81be.md)|  
