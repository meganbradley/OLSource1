...
## Remarks  
 ...
 The following macros map a message to a handler function. This function must be defined in <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>.  
...
## Example  
 ...
 When a <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> object receives a <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> message, the message is directed to <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> for the actual processing. If <CodeContentPlaceHolder>6\</CodeContentPlaceHolder> indicates the message requires further processing, the message will then be directed to the default message map in <CodeContentPlaceHolder>7\</CodeContentPlaceHolder>.  
  
 In addition to the default message map, you can define an alternate message map with [ALT_MSG_MAP](../vs140/alt_msg_map.md). Always begin a message map with <CodeContentPlaceHolder>8\</CodeContentPlaceHolder>. You can then declare subsequent alternate message maps. The following example shows the default message map and one alternate message map, each containing one handler function:  
 ...
 The [END_MSG_MAP](../vs140/end_msg_map.md) macro marks the end of the message map. Note that there is always exactly one instance of <CodeContentPlaceHolder>9\</CodeContentPlaceHolder> and <CodeContentPlaceHolder>10\</CodeContentPlaceHolder>.  
