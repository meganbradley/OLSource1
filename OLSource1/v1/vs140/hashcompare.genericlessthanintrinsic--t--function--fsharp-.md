...
apitype: "Assembly"
f1_keywords: 
  - "Microsoft.FSharp.Core.LanguagePrimitives.HashCompare.GenericLessThanIntrinsic``1"
dev_langs: 
  - "FSharp"
helpviewer_keywords: 
  - "GenericLessThanIntrinsic function [F#]"
...
## Return Value  
 <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> if the first object is less than the second; otherwise, <CodeContentPlaceHolder>6\</CodeContentPlaceHolder>.  
