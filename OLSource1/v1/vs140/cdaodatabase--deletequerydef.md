...
---
# CDaoDatabase::DeleteQueryDef
Call this member function to delete the specified querydef — saved query — from the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> object's QueryDefs collection.  
