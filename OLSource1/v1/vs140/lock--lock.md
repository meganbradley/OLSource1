...
## Remarks  
 ...
 The fourth form of the constructor does not acquire a lock on `_object`. `lock_later` is a member of the [lock_when Enum](../vs140/lock_when-enum.md). Use [acquire](../vs140/lock--acquire.md) or [try_acquire](../vs140/lock--try_acquire.md) to acquire the lock in this case.  
