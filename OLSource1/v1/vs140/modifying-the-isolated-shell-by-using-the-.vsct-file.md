...
<CodeContentPlaceHolder>0\</CodeContentPlaceHolder>  
 ...
 For example, to remove the next pane and previous pane commands, uncomment the <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> and <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> entries:  
...
|VsDbgCmdUsed.vsct|Command table for the debugger.|  
 ...
 For more information, see [Designing XML Command Table (.Vsct) Files](../vs140/designing-xml-command-table--.vsct--files.md) and the [VSCT XML Schema Reference](../vs140/vsct-xml-schema-reference.md).  
