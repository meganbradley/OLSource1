...
You can use the work item tracking feature to log work item from within [!INCLUDE[vsPreLong](../vs140/includes/vsprelong_md.md)]. To use this feature, your project must be part of Team Project in [!INCLUDE[esprfound](../vs140/includes/esprfound_md.md)].  
