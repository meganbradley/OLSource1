...
|||  
|-|-|  
|**Applies to**|<CodeContentPlaceHolder>1\</CodeContentPlaceHolder>, **class**, <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>, method, property|  
|**Repeatable**|No|  
|**Required attributes**|**coclass** (when applied to **class** or <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>)|  
