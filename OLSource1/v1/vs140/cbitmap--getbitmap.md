...
#### Parameters  
 ...
 Pointer to a [BITMAP Structure](../vs140/bitmap-structure.md) structure that will receive the image properties. This parameter must not be <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>.  
