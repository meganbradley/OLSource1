...
## Example  
 See the example for [decimal_point](../vs140/numpunct--decimal_point.md), where the virtual member function is called by <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>.  
