...
3.  Attach the profiler to the target application. Type:  
     ...
     **VSPerfCmd**  [/attach](../vs140/attach.md) **:**{<CodeContentPlaceHolder>9\</CodeContentPlaceHolder>&#124;<CodeContentPlaceHolder>10\</CodeContentPlaceHolder>} [<CodeContentPlaceHolder>11\</CodeContentPlaceHolder>]  
  
     <CodeContentPlaceHolder>12\</CodeContentPlaceHolder> specifies the process ID of the target application. <CodeContentPlaceHolder>13\</CodeContentPlaceHolder> specifies the name of the process. Note that if you specify <CodeContentPlaceHolder>14\</CodeContentPlaceHolder> and multiple processes that have the same name are running, results are unpredictable. You can view the process IDs of all running processes in Windows Task Manager.  
    ...
    |[/counter](../vs140/counter.md) **:** <CodeContentPlaceHolder>21\</CodeContentPlaceHolder>|Changes the sampling event and interval to the processor performance counter and the interval that is specified in <CodeContentPlaceHolder>22\</CodeContentPlaceHolder>.|  
...
-   The following pairs of **VSPerfCmd** options start and stop data collection. Specify each option on a separate command line. You can turn data collection on and off multiple times.  
    ...
    |[/processon](../vs140/processon-and-processoff.md) **:** <CodeContentPlaceHolder>23\</CodeContentPlaceHolder> [/processoff](../vs140/processon-and-processoff.md) **:** <CodeContentPlaceHolder>24\</CodeContentPlaceHolder>|Starts (**/processon**) or stops (**/processoff**) data collection for the process that is specified by <CodeContentPlaceHolder>25\</CodeContentPlaceHolder>.|  
    |[/attach](../vs140/attach.md) **:** <CodeContentPlaceHolder>26\</CodeContentPlaceHolder> [/detach](../vs140/detach.md)|**/attach** starts to collect data for the process specified by <CodeContentPlaceHolder>27\</CodeContentPlaceHolder>. **/detach** stops data collection for all processes.|  
