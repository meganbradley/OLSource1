...
## Example  
 This example uses the [GetString](assetId:///M:System.Text.Encoding.GetString(System.Byte[])?qualifyHint=False&autoUpgrade=True) method of the <xref:System.Text.Encoding.Unicode*?displayProperty=fullName> encoding class to convert all the bytes from a byte array into a string.  
...
## See Also  
 ...
 assetId:///M:System.Text.Encoding.GetString(System.Byte[])?qualifyHint=False&autoUpgrade=True   
