...
## Remarks  
 This value may be **SP_ERROR** if the job hasn't yet printed (that is, if the <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> object is newly constructed and has not yet been used to print), or if there was an error in starting the job.  
