...
|---------------|-----------------|  
|[in] <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>|Command identifier of the button that is to receive a new bitmap.|  
|[in] <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>|Zero-based index of an image in the current toolbar control's image list.|  
