...
## Remarks  
 <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> can have the following values as specified by the enumeration <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>:  
...
-   **checkAlwaysMemDF** Calls <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> every time memory is allocated or freed. This will significantly slow memory allocations and deallocations.  
