 ...
 **Automatic insertion of end constructs**  
 When you type—for example, the first line of a procedure declaration, <CodeContentPlaceHolder>0\</CodeContentPlaceHolder>and press ENTER, the text editor adds a matching <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> line. Similarly, if you add a [For](../vs140/for...next-statement--visual-basic-.md) loop, the text editor adds a matching <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> statement. When this option is selected, the code editor automatically adds the end construct.  
...
-   Add a missing <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> to an <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> statement  
 ...
 **Automatic insertion of Interface and MustOverride members**  
 When you commit an <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> statement or an <CodeContentPlaceHolder>6\</CodeContentPlaceHolder> statement for a class, the text editor inserts prototypes for the members that have to be implemented or overridden, respectively.  
 ...
 **Enable highlighting of references and keywords**  
 The text editor can highlight all instances of a symbol or all of the keywords in a clause such as <CodeContentPlaceHolder>7\</CodeContentPlaceHolder>, <CodeContentPlaceHolder>8\</CodeContentPlaceHolder>, or <CodeContentPlaceHolder>9\</CodeContentPlaceHolder>. You can navigate between highlighted references or keywords by pressing CTRL+SHIFT+DOWN ARROW or CTRL+SHIFT+UP ARROW.  
