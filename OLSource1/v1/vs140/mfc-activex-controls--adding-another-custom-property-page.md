...
4.  Click <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> to add the resource to your project.  
...
5.  In the **Class Name** box in the [MFC Class Wizard](../vs140/mfc-add-class-wizard.md), type a name for the new dialog class. (In this example, <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>.)  
...
7.  In the **Base Class** box, select <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>.  
...
9. Click **Finish** to create the class.  
 ...
 [!code[NVC_MFC_AxUI#32](../vs140/codesnippet/CPP/mfc-activex-controls--adding-another-custom-property-page_1.cpp)]  
  
 Note that you must increase the second parameter of the <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> macro (the property page count) from 1 to 2.  
...
6.  In the .CPP file of your new property page class (in this example, <CodeContentPlaceHolder>4\</CodeContentPlaceHolder>) modify the <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> so that IDS_SAMPLE_ADDPAGE is passed by [AfxOleRegisterPropertyPageClass](../vs140/afxoleregisterpropertypageclass.md), as in the following example:  
  
     [!code[NVC_MFC_AxUI#33](../vs140/codesnippet/CPP/mfc-activex-controls--adding-another-custom-property-page_2.cpp)]  
  
7.  Modify the constructor of <CodeContentPlaceHolder>6\</CodeContentPlaceHolder> so that **IDS_SAMPLE_ADDPPG_CAPTION** is passed to the <CodeContentPlaceHolder>7\</CodeContentPlaceHolder> constructor, as follows:  
  
     [!code[NVC_MFC_AxUI#34](../vs140/codesnippet/CPP/mfc-activex-controls--adding-another-custom-property-page_3.cpp)]  
