...
This example shows how to use an attribute axis property to access XML attributes in an XML element by name. In particular, it uses the <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> attribute axis property to access the attribute named <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> in the <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> object.  
  
## Example  
 [!code[VbXMLSamples#11](../vs140/codesnippet/VisualBasic/how-to--access-xml-attributes--visual-basic-_1.vb)]  
