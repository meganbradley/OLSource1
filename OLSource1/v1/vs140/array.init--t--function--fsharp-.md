...
## Example  
 The following code demonstrates the use of <CodeContentPlaceHolder>5\</CodeContentPlaceHolder>.  
  
 [!code[FsArrays#101](../vs140/codesnippet/FSharp/array.init--t--function--fsharp-_1.fs)]  
