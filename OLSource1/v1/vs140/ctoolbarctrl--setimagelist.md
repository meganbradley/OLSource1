...
#### Parameters  
 ...
 A pointer to a <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> object containing the images to be used by the toolbar control to display button images in their default state.  
...
## Remarks  
 ...
 The MFC implementation of <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> uses a <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> object containing the toolbar control's button images, rather than a handle to an image list.  
