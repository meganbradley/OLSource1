...
---
# CTreeCtrl::ItemHasChildren
Use this function to determine whether the tree item specified by <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> has child items.  
...
## Return Value  
 Nonzero if the tree item specified by <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> has child items; 0 if it does not.  
