...
## Remarks  
 ...
 Embedded event maps within a DHTML and URL event map consist of a <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> macro followed by [DHTML_EVENT](../vs140/dhtml-event-maps.md) macros and an [END_EMBED_DHTML_EVENT_MAP](../vs140/end_embed_dhtml_event_map.md) macro.  
  
 Each embedded event map requires a corresponding [URL event entry](../vs140/url_event_entry.md) to map *mapName* (specified in <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>) to a URL or HTML resource.  
