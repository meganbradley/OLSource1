...
## Return Value  
 A <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> object that specifies the text displayed if the user enters data that does not match the validation rule.  
  
## Remarks  
 For a <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> object, this <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> is read-only for an attached table and read/write for a base table.  
