...
## Remarks  
 ...
 Note that the <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> and <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> member functions both find a string, but the <CodeContentPlaceHolder>6\</CodeContentPlaceHolder> member function also selects the string.  
