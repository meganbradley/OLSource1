...
|Topic|Description|  
|-----------|-----------------|  
|[How to: Serialize Using XmlSerializer (C#)](../vs140/how-to--serialize-using-xmlserializer--csharp-.md)|Demonstrates how to serialize using <xref:System.Xml.Serialization.XmlSerializer?qualifyHint=False>.|  
|[How to: Serialize Using DataContractSerializer (C#)](../vs140/how-to--serialize-using-datacontractserializer--csharp-.md)|Demonstrates how to serialize using <xref:System.Runtime.Serialization.DataContractSerializer?qualifyHint=False>.|  
