...
### Multi-Project Solutions  
 ...
 The solution queries each project factory for <xref:Microsoft.VisualStudio.Shell.Interop.IVsProjectUpgradeViaFactory*>. It then calls [UpgradeProject_CheckOnly](assetId:///M:Microsoft.VisualStudio.Shell.Interop.IVsProjectUpgradeViaFactory.UpgradeProject_CheckOnly(System.String,Microsoft.VisualStudio.Shell.Interop.IVsUpgradeLogger,System.Int32@,System.Guid@,System.UInt32@)?qualifyHint=False&autoUpgrade=True) to see if global project files need upgrading and to determine the supported upgrade strategies. The **Upgrade Wizard** is then invoked.  
  
 After the user completes the wizard, [UpgradeProject](assetId:///M:Microsoft.VisualStudio.Shell.Interop.IVsProjectUpgradeViaFactory.UpgradeProject(System.String,System.UInt32,System.String,System.String@,Microsoft.VisualStudio.Shell.Interop.IVsUpgradeLogger,System.Int32@,System.Guid@)?qualifyHint=False&autoUpgrade=True) is called on each project factory to perform the actual upgrade. To facilitate backup, IVsProjectUpgradeViaFactory methods provide the <xref:Microsoft.VisualStudio.Shell.Interop.SVsUpgradeLogger*> service to log the details of the upgrade process. This service cannot be cached.  
  
 After updating all relevant global files, each project factory can choose to instantiate a project. The project implementation must support <xref:Microsoft.VisualStudio.Shell.Interop.IVsProjectUpgrade*>. The [UpgradeProject](assetId:///M:Microsoft.VisualStudio.Shell.Interop.IVsProjectUpgrade.UpgradeProject(System.UInt32)?qualifyHint=False&autoUpgrade=True) method is then called to upgrade all relevant project items.  
  
> [!NOTE]
>  The assetId:///M:Microsoft.VisualStudio.Shell.Interop.IVsProjectUpgradeViaFactory.UpgradeProject(System.String,System.UInt32,System.String,System.String@,Microsoft.VisualStudio.Shell.Interop.IVsUpgradeLogger,System.Int32@,System.Guid@)?qualifyHint=False&autoUpgrade=True method does not provide the SVsUpgradeLogger service. This service can be obtained by calling [QueryService](assetId:///M:Microsoft.VisualStudio.OLE.Interop.IServiceProvider.QueryService(System.Guid@,System.Guid@,System.IntPtr@)?qualifyHint=False&autoUpgrade=True).  
...
## See Also  
 ...
 [How to: Upgrade Project Systems](../vs140/upgrading-custom-projects.md)   
