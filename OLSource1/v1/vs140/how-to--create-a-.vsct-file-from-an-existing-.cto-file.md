...
4.  Type **vsct.exe** *ctofilename***.cto** *vsctfilename***.vsct -S***symfilename***.ctsym**.  
     ...
     <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> is the name of the .cto file, <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> is the name of the vsct file you want to create, and <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> is the name of the .ctsym file.  
