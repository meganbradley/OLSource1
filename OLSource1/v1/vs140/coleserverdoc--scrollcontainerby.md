...
---
# COleServerDoc::ScrollContainerBy
Call the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> member function to scroll the container document by the amount, in pixels, indicated by <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>.  
