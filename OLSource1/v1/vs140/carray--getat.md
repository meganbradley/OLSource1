...
## Remarks  
 Passing a negative value or a value greater than the value returned by <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> will result in a failed assertion.  
