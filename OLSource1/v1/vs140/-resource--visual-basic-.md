...
## Remarks  
 ...
 If `filename` is a [!INCLUDE[dnprdnshort](../vs140/includes/dnprdnshort_md.md)] resource file created, for example, by the [Resource File Generator (Resgen.exe)](assetId:///8ef159de-b660-4bec-9213-c3fbc4d1c6f4) or in the development environment, it can be accessed with members in the <xref:System.Resources?qualifyHint=False> namespace (see <xref:System.Resources.ResourceManager?qualifyHint=False> for more information). To access all other resources at run time, use one of the following methods: <xref:System.Reflection.Assembly.GetManifestResourceInfo?qualifyHint=False>, <xref:System.Reflection.Assembly.GetManifestResourceNames?qualifyHint=False>, or <xref:System.Reflection.Assembly.GetManifestResourceStream?qualifyHint=False>.  
