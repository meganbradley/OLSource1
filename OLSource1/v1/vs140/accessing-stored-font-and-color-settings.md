...
-   Use the [OpenCategory](assetId:///M:Microsoft.VisualStudio.Shell.Interop.IVsFontAndColorStorage.OpenCategory(System.Guid@,System.UInt32)?qualifyHint=False&autoUpgrade=True) method to open a category to be persisted by using the category's GUID and a mode flag as arguments.  
...
### Storing and Retrieving Information  
 To obtain or configure information that a user can modify for a named display item in an open category, VSPackages call the [GetItem](assetId:///M:Microsoft.VisualStudio.Shell.Interop.IVsFontAndColorStorage.GetItem(System.String,Microsoft.VisualStudio.Shell.Interop.ColorableItemInfo[])?qualifyHint=False&autoUpgrade=True) and [SetItem](assetId:///M:Microsoft.VisualStudio.Shell.Interop.IVsFontAndColorStorage.SetItem(System.String,Microsoft.VisualStudio.Shell.Interop.ColorableItemInfo[])?qualifyHint=False&autoUpgrade=True) methods.  
  
 Information about font attributes for a particular category is obtained by using the [GetFont](assetId:///M:Microsoft.VisualStudio.Shell.Interop.IVsFontAndColorStorage.GetFont(Microsoft.VisualStudio.Shell.Interop.LOGFONTW[],Microsoft.VisualStudio.Shell.Interop.FontInfo[])?qualifyHint=False&autoUpgrade=True) and [SetFont](assetId:///M:Microsoft.VisualStudio.Shell.Interop.IVsFontAndColorStorage.SetFont(Microsoft.VisualStudio.Shell.Interop.FontInfo[])?qualifyHint=False&autoUpgrade=True) methods.  
  
> [!NOTE]
>  The `fFlags` argument that is passed to the assetId:///M:Microsoft.VisualStudio.Shell.Interop.IVsFontAndColorStorage.OpenCategory(System.Guid@,System.UInt32)?qualifyHint=False&autoUpgrade=True method when that category was opened defines the behavior of the assetId:///M:Microsoft.VisualStudio.Shell.Interop.IVsFontAndColorStorage.GetItem(System.String,Microsoft.VisualStudio.Shell.Interop.ColorableItemInfo[])?qualifyHint=False&autoUpgrade=True and the assetId:///M:Microsoft.VisualStudio.Shell.Interop.IVsFontAndColorStorage.GetFont(Microsoft.VisualStudio.Shell.Interop.LOGFONTW[],Microsoft.VisualStudio.Shell.Interop.FontInfo[])?qualifyHint=False&autoUpgrade=True methods. By default, these methods only return information aboutdisplay itemsthat have changed. However, if a category is opened by using the <xref:Microsoft.VisualStudio.Shell.Interop.__FCSTORAGEFLAGS.FCSF_LOADDEFAULTS*> flag, both updated and unchanged display items can be accessed by assetId:///M:Microsoft.VisualStudio.Shell.Interop.IVsFontAndColorStorage.GetItem(System.String,Microsoft.VisualStudio.Shell.Interop.ColorableItemInfo[])?qualifyHint=False&autoUpgrade=True and assetId:///M:Microsoft.VisualStudio.Shell.Interop.IVsFontAndColorStorage.GetFont(Microsoft.VisualStudio.Shell.Interop.LOGFONTW[],Microsoft.VisualStudio.Shell.Interop.FontInfo[])?qualifyHint=False&autoUpgrade=True.  
...
> [!NOTE]
>  The assetId:///M:Microsoft.VisualStudio.Shell.Interop.IVsFontAndColorStorage.GetItem(System.String,Microsoft.VisualStudio.Shell.Interop.ColorableItemInfo[])?qualifyHint=False&autoUpgrade=True and the assetId:///M:Microsoft.VisualStudio.Shell.Interop.IVsFontAndColorStorage.GetFont(Microsoft.VisualStudio.Shell.Interop.LOGFONTW[],Microsoft.VisualStudio.Shell.Interop.FontInfo[])?qualifyHint=False&autoUpgrade=True methods return REGDB_E_KEYMISSING, (0x80040152L) when you use them to retrieve information about unchanged **Display Items**.  
