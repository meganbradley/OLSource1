...
## Remarks  
 Without this option the stack size defaults to 1 MB. The <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> argument can be in decimal or C-language notation. The argument can range from 1 to the maximum stack size accepted by the linker. The linker rounds up the specified value to the nearest 4 bytes. The space between **/F** and <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>is optional.  
