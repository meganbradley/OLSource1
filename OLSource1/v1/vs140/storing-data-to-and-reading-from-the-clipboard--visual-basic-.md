...
## Writing to the Clipboard  
 Use the [SetText](assetId:///M:Microsoft.VisualBasic.MyServices.ClipboardProxy.SetText(System.String)?qualifyHint=False&autoUpgrade=True) method to write text to the Clipboard. The following code writes the string "This is a test string" to the Clipboard.  
 ...
 Use the [SetData](assetId:///M:Microsoft.VisualBasic.MyServices.ClipboardProxy.SetData(System.String,System.Object)?qualifyHint=False&autoUpgrade=True) method to write data to the Clipboard. This example writes the `DataObject``dataChunk` to the Clipboard in the custom format `specialFormat`.  
  
 [!code[VbVbcnMyClipboard#7](../vs140/codesnippet/VisualBasic/storing-data-to-and-reading-from-the-clipboard--visual-basic-_7.vb)]  
  
 Use the [SetAudio](assetId:///M:Microsoft.VisualBasic.MyServices.ClipboardProxy.SetAudio(System.IO.Stream)?qualifyHint=False&autoUpgrade=True) method to write audio data to the Clipboard. This example creates the byte array `musicReader`, reads the file `cool.wav` into it, and then writes it to the Clipboard.  
...
## See Also  
 ...
 [SetDataObject](assetId:///M:Microsoft.VisualBasic.MyServices.ClipboardProxy.SetDataObject(System.Windows.Forms.DataObject)?qualifyHint=False&autoUpgrade=True)   
