...
|----------------|-----------------|  
|where T: struct|The type argument must be a value type. Any value type except <xref:System.Nullable?qualifyHint=False> can be specified. See [Using Nullable Types (C# Programmer's Reference)](../vs140/using-nullable-types--csharp-programming-guide-.md) for more information.|  
