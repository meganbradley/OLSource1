...
6.  In DebuggerSide.vb, add the following statement to the <CodeContentPlaceHolder>10\</CodeContentPlaceHolder> statements:  
  
<CodeContentPlaceHolder>0\</CodeContentPlaceHolder>  
## Add the Debugger-side Code  
 Now, you are ready to create the debugger-side code. This is the code that runs within the debugger to display the information that you want to visualize. First, you have to change the declaration of the <CodeContentPlaceHolder>11\</CodeContentPlaceHolder> object so that it inherits from the base class <CodeContentPlaceHolder>12\</CodeContentPlaceHolder>.  
...
1.  Add the following attribute code to DebuggerSide.vb, after the <CodeContentPlaceHolder>20\</CodeContentPlaceHolder> statements but before <CodeContentPlaceHolder>21\</CodeContentPlaceHolder>:  
...
3.  In TestConsole. vb, add the following <CodeContentPlaceHolder>23\</CodeContentPlaceHolder> statement:  
  
<CodeContentPlaceHolder>8\</CodeContentPlaceHolder>  
4.  In method <CodeContentPlaceHolder>24\</CodeContentPlaceHolder>, add the following code:  
