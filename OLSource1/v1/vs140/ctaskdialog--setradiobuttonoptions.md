...
#### Parameters  
 ...
 <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> to enable the radio button; <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> to disable the radio button.  
  
## Remarks  
 This method throws an exception with the [ENSURE (MFC)](../vs140/ensure--mfc-.md) macro if <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> is not a valid ID for a radio button.  
