...
Converts the argument to byte. This is a direct conversion for all primitive numeric types. For strings, the input is converted using [Parse](assetId:///M:System.Byte.Parse(System.String)?qualifyHint=False&autoUpgrade=True) on strings and otherwise requires a `ToByte` method on the input type.  
