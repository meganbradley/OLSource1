...
```  
 ...
 In a text template, set `hostspecific` in the template directive. Use the [parameter](../vs140/t4-parameter-directive.md) directive to get values:  
...
```  
 ...
 In a directive processor, you can call [ResolveParameterValue](assetId:///M:Microsoft.VisualStudio.TextTemplating.ITextTemplatingEngineHost.ResolveParameterValue(System.String,System.String,System.String)?qualifyHint=False&autoUpgrade=True):  
