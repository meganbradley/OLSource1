...
## Remarks  
 The <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> method forces the continuation task to run synchronously on the context, causing its antecedent task's completion.  
