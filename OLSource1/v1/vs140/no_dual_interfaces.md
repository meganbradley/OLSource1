...
## Remarks  
 Normally, the wrapper will call the method through the virtual function table for the interface. With <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>, the wrapper instead calls **IDispatch::Invoke** to invoke the method.  
