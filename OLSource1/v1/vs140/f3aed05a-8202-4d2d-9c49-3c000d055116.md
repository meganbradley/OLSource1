...
You have attempted to use <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> on a class that contains a <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> member that has not been overridden.  
  
 **Error ID:** BC30376  
  
### To correct this error  
  
-   Remove the <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> statement.  
