...
## Return Value  
 See the return value description for <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>.  
  
## Remarks  
 <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> returns the element (or a reference to the element) associated with a given position. It is not the same as an index, and you cannot operate on a **POSITION** value yourself. A variable of type **POSITION** is a key for the list.  
