...
## Return Value  
 The previously defined error function; or <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> if there is no previously defined function.  
  
## Remarks  
 In new code, use only <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>. <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> is only included in the library for backward compatibility.  
  
 The <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> callback applies only to the component that it was linked in, but not globally.  
  
 Make sure that the address that you pass to <CodeContentPlaceHolder>6\</CodeContentPlaceHolder> is that of a valid error handling function.  
 ...
 **typedef int (__cdecl \*_RTC_error_fnW)(int**  <CodeContentPlaceHolder>7\</CodeContentPlaceHolder> **, const wchar_t \*** *filename* **, int**  *linenumber* **, const wchar_t \*** <CodeContentPlaceHolder>8\</CodeContentPlaceHolder> **, const wchar_t \*** *format* **, ...);**  
...
|-------------|---------------------|  
|<CodeContentPlaceHolder>11\</CodeContentPlaceHolder>|\<rtcapi.h>|  
