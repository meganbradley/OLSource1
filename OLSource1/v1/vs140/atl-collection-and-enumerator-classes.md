...
|[CComEnumOnSTL](../vs140/ccomenumonstl-class.md)|Enumerator object implementation (uses <CodeContentPlaceHolder>0\</CodeContentPlaceHolder>)|  
|[CComEnum](../vs140/ccomenum-class.md)|Enumerator object implementation (uses <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>)|  
...
|[CAdapt](../vs140/cadapt-class.md)|Adapter class (hides **operator &** allowing <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>, <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>, and <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> to be stored in STL containers)|  
