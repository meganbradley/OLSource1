...
f1_keywords: 
  ...
  - "ATL::CComMultiThreadModel::Increment"
  - "CComMultiThreadModel.Increment"
  - "Increment"
  - "ATL.CComMultiThreadModel.Increment"
dev_langs: 
...
---
# CComMultiThreadModel::Increment
This static function calls the Win32 function [InterlockedIncrement](http://msdn.microsoft.com/library/windows/desktop/ms683614), which increments the value of the variable pointed to by <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>.  
