...
#### Parameters  
 ...
 Pointer to a variable that specifies the size, in bytes, of the buffer pointed to by the <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> parameter. When the method returns, this variable contains the size of the data copied to the buffer.  
