...
## Names  
 **Return type**  
 The data type returned by the method. <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> is recommended for all interface types, because it provides a standard way to return errors.  
  
|Interface type|Description|  
|--------------------|-----------------|  
|Dual interface|<CodeContentPlaceHolder>1\</CodeContentPlaceHolder>. Unchangeable.|  
|Custom interface|<CodeContentPlaceHolder>2\</CodeContentPlaceHolder>. Unchangeable.|  
