...
## Return Value  
 A **POSITION** value that can be used for iteration or object pointer retrieval; **NULL** if <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> is negative or too large.  
