...
dev_langs: 
  - "C++"
helpviewer_keywords: 
  - "AfxEnableMemoryLeakDump function"
...
---
# AfxEnableMemoryLeakDump
Enables and disables the memory leak dump in the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> destructor.  
...
#### Parameters  
 ...
 <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> indicates the memory leak dump is enabled; <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> indicates the memory leak dump is disabled.  
