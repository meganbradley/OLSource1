...
---
# id
Specifies a <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> parameter for a member function (either a property or a method, in an interface or dispinterface).  
