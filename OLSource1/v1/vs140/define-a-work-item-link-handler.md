...
### Project References  
 Add the following [!INCLUDE[TLA2#tla_net](../vs140/includes/tla2sharptla_net_md.md)] assemblies to your project references:  
 ...
 <CodeContentPlaceHolder>13\</CodeContentPlaceHolder> - used by the sample code  
...
### Import the Work Item Namespace  
 In your [!INCLUDE[vsprvs](../vs140/includes/vsprvs_md.md)] project **References**, add references to the following assemblies:  
...
1.  Press **F5**, or on the **Debug** menu, choose **Start Debugging**.  
     ...
     **Troubleshooting**: If a new [!INCLUDE[vsprvs](../vs140/includes/vsprvs_md.md)] does not start, ensure that the VSIX project is set as the Startup project of the solution.  
...
5.  Verify that the title of the work item is the same as the model element, if you have used the sample code in the previous section. This demonstrates <CodeContentPlaceHolder>14\</CodeContentPlaceHolder> has worked.  
  
6.  Complete the form, save and close the work item.  
  
7.  Verify that the work item is now colored red. This demonstrates <CodeContentPlaceHolder>15\</CodeContentPlaceHolder> in the sample code.  
    ...
    -   The correct <CodeContentPlaceHolder>16\</CodeContentPlaceHolder> attribute is attached to the handler class, and the class implements <CodeContentPlaceHolder>17\</CodeContentPlaceHolder>.  
  
    -   The parameters of all <CodeContentPlaceHolder>18\</CodeContentPlaceHolder> and <CodeContentPlaceHolder>19\</CodeContentPlaceHolder> attributes are valid.  
...
### Listening for Link Creation  
 <CodeContentPlaceHolder>21\</CodeContentPlaceHolder> is called just after a link is created. It is called whether the link is to a new work item or an existing item. It is called once for each work item.  
  
<CodeContentPlaceHolder>3\</CodeContentPlaceHolder>  
> [!NOTE]
>  To make this example work, you must add a project reference to <CodeContentPlaceHolder>22\</CodeContentPlaceHolder>, and import the namespace <CodeContentPlaceHolder>23\</CodeContentPlaceHolder>. However, these additions are not required for other implementations of <CodeContentPlaceHolder>24\</CodeContentPlaceHolder>.  
  
### Listening for Link Removal  
 <CodeContentPlaceHolder>25\</CodeContentPlaceHolder> is called once just before each work item link that is deleted. If a model element is deleted, all of its links will be removed.  
...
<CodeContentPlaceHolder>6\</CodeContentPlaceHolder>  
 The format of <CodeContentPlaceHolder>26\</CodeContentPlaceHolder> is:  
...
-   The URI for your server would be:  
     ...
     Case is important in <CodeContentPlaceHolder>29\</CodeContentPlaceHolder>.  
  
-   <CodeContentPlaceHolder>30\</CodeContentPlaceHolder> can be obtained from your TFS connection:  
  
<CodeContentPlaceHolder>7\</CodeContentPlaceHolder>  
 For more information about References, see [How to Attach Reference Strings to Model Elements](../vs140/attach-reference-strings-to-uml-model-elements.md).  
...
## See Also  
 ...
 [How to Attach Reference Strings to Model Elements](../vs140/attach-reference-strings-to-uml-model-elements.md)   
