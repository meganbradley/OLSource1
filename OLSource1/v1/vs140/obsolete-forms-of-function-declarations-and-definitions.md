...
<CodeContentPlaceHolder>0\</CodeContentPlaceHolder>  
 Functions returning an integer or pointer with the same size as an <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> are not required to have a declaration although the declaration is recommended.  
