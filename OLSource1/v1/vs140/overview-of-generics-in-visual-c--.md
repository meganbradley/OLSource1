...
## Generic Functions and Types  
 ...
 A description of the syntax of generic classes may be found in [Generic Classes (C++)](../vs140/generic-classes--c---cli-.md)`.` A new namespace, <xref:System.Collections.Generic?qualifyHint=False>, introduces a set of parameterized collection types including <xref:System.Collections.Generic.Dictionary`2?qualifyHint=False>, <xref:System.Collections.Generic.List`1?qualifyHint=False> and <xref:System.Collections.Generic.LinkedList`1?qualifyHint=False>. See [Generics in the .NET Framework Class Library (C# Programmers Reference)](../vs140/generics-in-the-.net-framework-class-library--csharp-programming-guide-.md) for more information.  
 ...
 For a description of the syntax, see [Generic Functions](../vs140/generic-functions--c---cli-.md).  
