...
4.  Modify the **Internal Compiler Error Reporting** property.  
 ...
 For information about how to set this compiler option programmatically, see <xref:VSLangProj80.CSharpProjectConfigurationProperties3.ErrorReport?qualifyHint=False>.  
