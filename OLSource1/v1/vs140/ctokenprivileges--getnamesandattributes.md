...
ms.topic: "reference"
f1_keywords: 
  - "ATL::CTokenPrivileges::GetNamesAndAttributes"
...
---
# CTokenPrivileges::GetNamesAndAttributes
Retrieves the name and attribute flags from the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> object.  
...
#### Parameters  
 *pNames*  
 Pointer to an array of <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> objects. **CNames** is a typedef defined as **CAtlArray \<CString> CNames**.  
...
## Remarks  
 This method will enumerate all of the privileges contained in the <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> object, placing the name and (optionally) the attribute flags into array objects.  
