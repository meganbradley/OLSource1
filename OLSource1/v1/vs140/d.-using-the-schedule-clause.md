...
<CodeContentPlaceHolder>2\</CodeContentPlaceHolder>  
 ...
 The **guided** schedule is appropriate for the case in which the threads may arrive at varying times at a **for** construct with each iteration requiring about the same amount of work. This can happen if, for example, the **for** construct is preceded by one or more sections or **for** constructs with <CodeContentPlaceHolder>7\</CodeContentPlaceHolder> clauses.  
