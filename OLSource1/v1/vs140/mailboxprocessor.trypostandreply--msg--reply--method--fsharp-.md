...
#### Parameters  
 ...
 An optional timeout parameter (in milliseconds) to wait for a reply message. Defaults to -1 which corresponds to <xref:System.Threading.Timeout.Infinite?qualifyHint=False>.  
