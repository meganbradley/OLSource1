...
warning C6242: A jump out of this try-block forces local unwind. Incurs severe performance penalty  
 ...
 Use <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> to exit the protected block of a try-finally.  
  
## Example  
 The following code generates this warning:  
  
<CodeContentPlaceHolder>0\</CodeContentPlaceHolder>  
 To correct this warning, use <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> as shown in the following code:  
