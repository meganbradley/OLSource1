...
> [!NOTE]
>  If the type of the delegate is not known, that is, the lambda expression is of type <xref:System.Linq.Expressions.LambdaExpression*> and not <xref:System.Linq.Expressions.Expression`1*>, you must call the [DynamicInvoke](assetId:///M:System.Delegate.DynamicInvoke(System.Object[])?qualifyHint=False&autoUpgrade=True) method on the delegate instead of invoking it directly.  
