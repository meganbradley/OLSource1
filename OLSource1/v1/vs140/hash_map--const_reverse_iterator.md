...
f1_keywords: 
  ...
  - "stdext::hash_map::const_reverse_iterator"
  - "std::hash_map::const_reverse_iterator"
  - "std.hash_map.const_reverse_iterator"
  - "hash_map::const_reverse_iterator"
...
## Example  
 See the example for [rend](../vs140/hash_map--rend.md) for an example of how to declare and use the <CodeContentPlaceHolder>10\</CodeContentPlaceHolder>.  
