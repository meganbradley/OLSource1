...
To add a class in a Visual C++ project, in **Solution Explorer**, right-click the project, click **Add**, and then click **Class**. This opens the [Add Class Dialog Box](../vs140/add-class-dialog-box.md) dialog box.  
 ...
 If your project naming convention requires you to use an existing name, then you can just change the case of one or more letters in the name because Visual C++ is case-sensitive. For example, although you cannot name a class <CodeContentPlaceHolder>0\</CodeContentPlaceHolder>, you can name it <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>.  
