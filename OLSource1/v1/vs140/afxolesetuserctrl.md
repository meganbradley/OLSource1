...
ms.topic: "article"
f1_keywords: 
  - "AFXWIN/AfxOleSetUserCtrl"
  - "AfxOleSetUserCtrl"
dev_langs: 
  - "C++"
helpviewer_keywords: 
  - "AfxOleSetUserCtrl function"
  - "application control"
...
---
# AfxOleSetUserCtrl
Sets or clears the user-control flag, which is explained in the reference for <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>.  
