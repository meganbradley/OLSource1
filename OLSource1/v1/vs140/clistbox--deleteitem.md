...
---
# CListBox::DeleteItem
Called by the framework when the user deletes an item from an owner-draw <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> object or destroys the list box.  
...
## Remarks  
 ...
 See [CWnd::OnDeleteItem](../vs140/cwnd--ondeleteitem.md) for a description of the <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> structure.  
