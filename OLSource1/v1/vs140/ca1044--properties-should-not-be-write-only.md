...
## Example  
 In the following example, <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> is a type with a write-only property. <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> contains the corrected code.  
  
 [!code[FxCop.Design.PropertiesNotWriteOnly#1](../vs140/codesnippet/VisualBasic/ca1044--properties-should-not-be-write-only_1.vb)]
[!code[FxCop.Design.PropertiesNotWriteOnly#1](../vs140/codesnippet/CSharp/ca1044--properties-should-not-be-write-only_1.cs)]