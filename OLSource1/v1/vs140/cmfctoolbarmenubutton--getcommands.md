...
## Remarks  
 A toolbar menu button can display a submenu. You can provide the list of commands in the submenu in the constructor or in [CMFCToolBarMenuButton::CreateFromMenu](../vs140/cmfctoolbarmenubutton--createfrommenu.md) as a handle to a menu (<CodeContentPlaceHolder>1\</CodeContentPlaceHolder>). The menu is converted to a list of objects that are derived from [CMFCToolBarButton Class](../vs140/cmfctoolbarbutton-class.md) and stored in the internal <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> object. You can access this list by calling this method.  
