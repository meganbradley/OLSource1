...
## Return Value  
 <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> if the current property object represents a group; <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> if the property represents a value.  
