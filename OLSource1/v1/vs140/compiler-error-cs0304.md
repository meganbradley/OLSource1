...
Cannot create an instance of the variable type 'type' because it does not have the new() constraint  
 ...
 When you implement a generic class, and you want to use the `new` keyword to create a new instance of any type that is supplied for a type parameter `T`, you must apply the [new() constraint](../vs140/new--csharp-reference-.md) to `T` in the class declaration, as shown in the following example.  
