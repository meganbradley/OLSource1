...
#### Parameters  
 ...
 A pointer to the pane to be docked to the left of <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>.  
  
 [in] [out] <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>  
 A pointer to the target pane.  
  
## Return Value  
 <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> if the pane is docked successfully; otherwise, <CodeContentPlaceHolder>5\</CodeContentPlaceHolder>.  
