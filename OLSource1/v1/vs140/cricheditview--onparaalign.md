...
-   <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> Align the paragraphs with the left margin.  
  
-   <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> Align the paragraphs with the right margin.  
  
-   <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> Center the paragraphs between the margins.  
