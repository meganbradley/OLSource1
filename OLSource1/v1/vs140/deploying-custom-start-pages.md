...
-   By manually creating a .vsix file. For more information, see [How to: Manually Package an Extension (VSIX Deployment)](../vs140/how-to--manually-package-an-extension--vsix-deployment-.md).  
 ...
 For Visual Studio to recognize a Start Page, the <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> of the VSIX Manifest must contain a <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> that has the <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> attribute set to <CodeContentPlaceHolder>5\</CodeContentPlaceHolder>. A Start Page extension that has been installed by using VSIX deployment appears in the **Customize Start Page** list on the **Startup** options page as **[Installed Extension]** *Extension Name*.  
...
2.  In the <CodeContentPlaceHolder>6\</CodeContentPlaceHolder> element of the vsix manifest, add an <CodeContentPlaceHolder>7\</CodeContentPlaceHolder> element that has a value of <CodeContentPlaceHolder>8\</CodeContentPlaceHolder>.  
