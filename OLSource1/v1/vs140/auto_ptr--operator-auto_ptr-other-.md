...
Casts from one kind of <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> to another kind of <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>.  
  
## Syntax  
  
<CodeContentPlaceHolder>0\</CodeContentPlaceHolder>  
## Return Value  
 The type cast operator returns <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> \<**Other**>(**\*this**).  
