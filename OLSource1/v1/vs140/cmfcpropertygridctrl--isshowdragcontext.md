...
## Return Value  
 <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> if the framework redraws the name and value columns during a resize operation; <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> if the framework redraws the columns after the drag operation is completed.  
