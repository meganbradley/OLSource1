...
---
# CDaoTableDef::GetDateCreated
Call this function to determine the date and time the table underlying the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> object was created.  
  
## Syntax  
  
<CodeContentPlaceHolder>0\</CodeContentPlaceHolder>  
## Return Value  
 A value containing the date and time of the creation of the table underlying the <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> object.  
