...
## Remarks  
 This function is called by the framework when a [CMFCBaseTabCtrl Class](../vs140/cmfcbasetabctrl-class.md) object processes a <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> message and erases the tab area.  
