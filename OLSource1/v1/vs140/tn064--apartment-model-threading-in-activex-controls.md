...
## Protecting Shared Data  
 If your control uses shared data, such as a static member variable, access to that data should be protected with a critical section to prevent more than one thread from modifying the data at the same time. To set up a critical section for this purpose, declare a static member variable of class <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> in your control's class. Use the <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> and **Unlock** member functions of this critical section object wherever your code accesses the shared data.  
...
<CodeContentPlaceHolder>3\</CodeContentPlaceHolder>  
 ...
 If your project was generated by an earlier version of ControlWizard, your existing code will have a Boolean value as the sixth parameter. If the existing parameter is TRUE, change it to <CodeContentPlaceHolder>9\</CodeContentPlaceHolder>. If the existing parameter is FALSE, change it to <CodeContentPlaceHolder>10\</CodeContentPlaceHolder>.  
  
 If your control does not follow the rules for apartment-model threading, you must not pass <CodeContentPlaceHolder>11\</CodeContentPlaceHolder> in this parameter.  
