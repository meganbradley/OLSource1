...
Using the managed package framework (MPF) language classes to implement a language service in [!INCLUDE[csprcs](../vs140/includes/csprcs_md.md)] is straightforward. You need a VSPackage to host the language service, the language service itself, and a parser for your language.  
...
3.  Select [!INCLUDE[csprcs](../vs140/includes/csprcs_md.md)] as the language and the option to generate a new key file. Click **Next**.  
...
6.  Enter **Insert Snippet** as the **Command Name** and <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> for the **Command ID**. Click **Finish**.  
...
5.  Enter **MyLanguageService.cs** for the name of the class file and click **Add**.  
     ...
     You can use whatever name you want. These procedures detailed here assume <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> as the name.  
  
6.  In the MyLanguageService.cs file, add the following <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> statements.  
...
7.  Modify the <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> class to derive from the \<xref:Microsoft.VisualStudio.Package.LanguageService*> class:  
...
9. Implement the abstract methods as described in [Implementing a Language Service (Managed Package Framework)](../vs140/implementing-a-legacy-language-service2.md).  
  
### Register the Language Service  
  
1.  Open the MyLanguagePackagePackage.cs file and add the following <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> statements:  
...
3.  In the new class file, add the following <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> statements.  
...
7.  Otherwise, position the caret inside the class and enter the method to be overridden.  
     ...
     For example, type <CodeContentPlaceHolder>6\</CodeContentPlaceHolder> to see a list of all methods that can be overridden in that class.  
