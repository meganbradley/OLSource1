...
## Return Value  
 ...
 In retail mode, <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> if the <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> parameter is invalid. In debug mode, this method asserts.  
