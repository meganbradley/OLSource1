...
-   Create your own reports from warehouse data (on-premises TFS only)  
 ...
 ![From the Charts tab, view any charts created](../vs140/media/tracktestresultsoverview.PNG "TrackTestResultsOverview")  
...
### Track testing progress  
 ...
 ![Click Charts tab to view the default chart](../vs140/media/trackdefaultchart.png "TrackDefaultChart")  
...
1.  Select the test plan or test suite for your chart in the Test plan tab. Then create a new chart.  
     ...
     ![Charts tab; click New](../vs140/media/tracknewtestresultchart.png "TrackNewTestResultChart")  
  
2.  Select the chart type. Based on the chart, configure the fields that you want to use to group by, or for rows and columns.  
  
     ![Configure the fields for your chart](../vs140/media/trackconfigurechart.png "TrackConfigureChart")  
 ...
 **What's the test status for a specific test suite?**  
 ...
 ![Choose Outcome for grouping](../vs140/media/trackexampleoutcome.png "TrackExampleOutcome")  
...
3.  Add a test results stacked bar chart. Choose Suite as the rows pivot and Outcome as the columns pivot.  
     ...
     ![Choose Suite and Outcome for chart](../vs140/media/trackexampleuserstories.png "TrackExampleUserStories")  
 ...
 **How many tests has each tester left to run?**  
 ...
 ![Choose Tester and Outcome for chart](../vs140/media/trackexampletestertestsleft.png "TrackExampleTesterTestsLeft")  
...
2.  Select the test plan or test suite for your chart in the Test plan tab. Then add a test case chart.  
     ...
     ![Charts tab; choose New](../vs140/media/tracknewtestcasechart.png "TrackNewTestCaseChart")  
...
3.  Select the chart type. Based on the chart, configure the fields that you want to use to group by, for rows and columns, or the range (trend charts only).  
     ...
     ![Configure the fields for your chart](../vs140/media/trackconfigurechart2.png "TrackConfigureChart2")  
 ...
 **How can I track burndown for test case creation?**  
 ...
 ![Create a stacked area chart for this](../vs140/media/trackexampleburndownreadiness.png "TrackExampleBurndownReadiness")  
 ...
 **A:** Yes. Select the test case within a test suite and then choose to view the test details pane.  
 ...
 ![Tests tab; choose to show the test details pane](../vs140/media/trackshowdetailspane.png "TrackShowDetailsPane")  
  
 View the recent test results for this test case.  
  
 ![Choose test results from the view](../vs140/media/tracktestresultspane.png "TrackTestResultsPane")  
 ...
 **A:** Pin a chart to your team's home page for all the team to view. Use the chart's context menu.  
 ...
 ![Choose context menu for chart](../vs140/media/trackeditdeletepinchart.png "TrackEditDeletePinChart")  
...
##  <a name="testResults"></a> Track automated test results with Microsoft Test Manager  
 ...
 ![Analyze test runs](../vs140/media/almt_ws21analyze.png "ALMT_ws21Analyze")  
 ...
 ![Set failure type](../vs140/media/almt_ws22failuretype.png "ALMT_ws22FailureType")  
 ...
 **A:** If your on-premises TFS installation includes report services, you can view the [Test Plan Progress chart](assetId:///97d112d1-2d31-4890-b518-124fbeebea30), which shows how many of this sprint’s tests have passed or failed. Open http://*<your Team Foundation Server\>*/Reports and navigate to **TfsReports > DefaultCollection >***your project***> Tests**. Alternatively, in Visual Studio, in Team Explorer, open **Reports**.  
