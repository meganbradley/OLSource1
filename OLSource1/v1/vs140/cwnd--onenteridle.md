 ...
 *pWho*  
 Specifies a pointer to the dialog box (if <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> is **MSGF_DIALOGBOX**), or the window that contains the displayed menu (if <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> is **MSGF_MENU**). This pointer may be temporary and should not be stored for later use.  
