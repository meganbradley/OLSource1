...
##### External Editors  
 ...
 The <xref:Microsoft.VisualStudio.Shell.Interop.IVsProject3.IsDocumentInProject?qualifyHint=False> method sets the document priority by using the <xref:Microsoft.VisualStudio.Shell.Interop.VSDOCUMENTPRIORITY?qualifyHint=False> enumeration. If the `DP_External` value is specified, the file can be opened by an external editor.  
...
## See Also  
 <xref:Microsoft.VisualStudio.Shell.Interop.IVsEditorFactory?qualifyHint=False>