...
##### External Editors  
 ...
 The \<xref:Microsoft.VisualStudio.Shell.Interop.IVsProject3.IsDocumentInProject*> method sets the document priority by using the \<xref:Microsoft.VisualStudio.Shell.Interop.VSDOCUMENTPRIORITY*> enumeration. If the <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> value is specified, the file can be opened by an external editor.  
