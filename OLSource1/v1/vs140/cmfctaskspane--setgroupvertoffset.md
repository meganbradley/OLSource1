...
## Remarks  
 ...
 Call this method to customize the margins of task pane elements. If <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> is -1, the framework determines the margin value by using the visual manager (<CodeContentPlaceHolder>3\</CodeContentPlaceHolder>). The default offset is 15 pixels.  
