...
### Field validation  
 ...
 If the field is required, there should be watermark text stating **\<Required>** and the field background should be light yellow (VSColor: <CodeContentPlaceHolder>9\</CodeContentPlaceHolder>) and the foreground should be gray (VSColor: <CodeContentPlaceHolder>10\</CodeContentPlaceHolder>):  
