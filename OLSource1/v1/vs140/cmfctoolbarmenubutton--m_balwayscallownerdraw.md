...
## Remarks  
 When this member variable is set to <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>, the button always calls [CFrmWndEx::OnDrawMenuImage](../vs140/cframewndex--ondrawmenuimage.md) method to display the image on the button. When <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> is <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>, the button itself draws the image if the image is predefined. Otherwise, it calls <CodeContentPlaceHolder>4\</CodeContentPlaceHolder>.  
