...
|[CComUnkArray](../vs140/ccomunkarray-class.md)|Stores <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> pointers and is designed to be used as a parameter to the [IConnectionPointImpl](../vs140/iconnectionpointimpl-class.md) template class.|  
