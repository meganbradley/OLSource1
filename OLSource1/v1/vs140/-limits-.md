...
---
# &lt;limits&gt;
Defines the template class <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> and two enumerations concerning floating-point representations and rounding.  
  
## Syntax  
  
<CodeContentPlaceHolder>0\</CodeContentPlaceHolder>  
## Remarks  
 Explicit specializations of the <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> class describe many properties of the fundamental types, including the character, integer, and floating-point types and <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> that are implementation defined rather than fixed by the rules of the C++ language. Properties described in \<limits> include accuracy, minimum and maximum sized representations, rounding, and signaling type errors.  
