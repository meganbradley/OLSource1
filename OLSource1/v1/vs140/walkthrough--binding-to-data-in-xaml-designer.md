...
4.  Open the MainWindow.xaml.cs (or MainWindow.xaml.vb) file and add the following code. In C#, add the code in the <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> namespace (before the final closing parenthesis in the file). In Visual Basic, just add the new class.  
...
3.  With the <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> selected, in the Properties window, choose the **New** button next to the **DataContext** property.  
...
5.  In the **Toolbox**, choose a <CodeContentPlaceHolder>6\</CodeContentPlaceHolder> control to add it to the form.  
  
6.  With the <CodeContentPlaceHolder>7\</CodeContentPlaceHolder> control selected, in the Properties window, choose the property marker to the right of the **Text** property, and then choose **Create Data Binding**. (The property marker looks like a small box.)  
...
8.  Press F5 to run the app.  
     ...
     The <CodeContentPlaceHolder>8\</CodeContentPlaceHolder> control should show the default value of 0 as text.  
