...
3.  Add the following code in an event procedure:  
     ...
     [!code[VbPowerPacksTabbing#1](../vs140/codesnippet/CSharp/how-to--enable-tabbing-between-shapes--visual-studio-_1.cs)][!code[VbPowerPacksTabbing#1](../vs140/codesnippet/VisualBasic/how-to--enable-tabbing-between-shapes--visual-studio-_1.vb)]  
  
4.  Add the following code in the `Button1_PreviewKeyDown` event procedure:  
  
     [!code[VbPowerPacksTabbing#2](../vs140/codesnippet/CSharp/how-to--enable-tabbing-between-shapes--visual-studio-_2.cs)][!code[VbPowerPacksTabbing#2](../vs140/codesnippet/VisualBasic/how-to--enable-tabbing-between-shapes--visual-studio-_2.vb)]  
