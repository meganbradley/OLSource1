...
|[ToFSharpFunc](../vs140/funcconvert.tofsharpfunc--t--u--method--fsharp-.md)|Convert the given <xref:System.Converter`2*> delegate object to an F# function value.|  
|[ToFSharpFunc](../vs140/funcconvert.tofsharpfunc--t--method--fsharp-.md)|Convert the given <xref:System.Action`1*> delegate object to an F# function value.|  
