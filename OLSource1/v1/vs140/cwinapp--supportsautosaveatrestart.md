...
## Return Value  
 <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> indicates the restart manager autosaves open documents when the application restarts; <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> indicates the restart manager does not.  
