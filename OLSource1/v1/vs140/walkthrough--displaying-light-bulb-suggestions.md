...
6.  Implement the [M:Microsoft.VisualStudio.Language.Intellisense.ISuggestedAction.GetPreviewAsync(System.Threading.CancellationToken)](assetId:///M:Microsoft.VisualStudio.Language.Intellisense.ISuggestedAction.GetPreviewAsync(System.Threading.CancellationToken)?qualifyHint=False&autoUpgrade=True) method so that it displays the action preview.  
...
7.  Implement the [M:Microsoft.VisualStudio.Language.Intellisense.ISuggestedAction.GetActionSetsAsync(System.Threading.CancellationToken)](assetId:///M:Microsoft.VisualStudio.Language.Intellisense.ISuggestedAction.GetActionSetsAsync(System.Threading.CancellationToken)?qualifyHint=False&autoUpgrade=True) method so that it returns an empty <xref:Microsoft.VisualStudio.Language.Intellisense.SuggestedActionSet*> enumeration.  
