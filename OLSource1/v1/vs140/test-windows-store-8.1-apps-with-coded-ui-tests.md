...
10. **Visual C#**  
     ...
     **Visual Basic**  
     ...
     In Solution Explorer, open the CodedUITest1.vb file and then in the CodedUITestMethod1() test method code, right-click the call to the assertion method that was automatically added <CodeContentPlaceHolder>14\</CodeContentPlaceHolder> and choose **Go To Definition**. This will open the UIMap.Designer.vb file in the code editor so you can view the view the added code for the assert method and the controls.  
