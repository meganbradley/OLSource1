...
## Return Value  
 <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> if the tab control hides the tab label when it has one tab; otherwise <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>.  
