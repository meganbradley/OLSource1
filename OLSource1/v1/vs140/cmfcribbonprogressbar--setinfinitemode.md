...
#### Parameters  
 ...
 <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> to specify that the progress bar is in infinite mode; otherwise, <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>.  
