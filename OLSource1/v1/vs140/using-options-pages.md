...
---
# Using Options Pages
The [!INCLUDE[vsprvs](../vs140/includes/vsprvs_md.md)] automation model provides the <xref:EnvDTE.DTE?qualifyHint=False> object to enable VSPackages to access the **Options** dialog box on the **Tools** menu.  
