...
##  \<a name="_core_support_for_automation_servers">\</a> Support for Automation Servers  
 ...
 [!code[NVC_MFCAutomation#1](../vs140/codesnippet/CPP/automation-servers_1.cpp)]  
  
 The Properties window and Class View assist in maintaining dispatch maps. When you add a new method or property to a class, Visual C++ adds a corresponding <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> or <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> macro with parameters indicating the class name, external and internal names of the method or property, and data types.  
