...
|[DDX_OCInt](../vs140/ddx_ocint.md)|Manages the transfer of <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> (or **long**) data between a property of an OLE control and an <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> (or **long**) data member.|  
|[DDX_OCIntRO](../vs140/ddx_ocintro.md)|Manages the transfer of <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> (or **long**) data between a read-only property of an OLE control and an <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> (or **long**) data member.|  
