...
-   <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> Dock to the top side of the frame window.  
  
-   **AFX_IDW_DOCKBAR_BOTTOM** Dock to the bottom side of the frame window.  
  
-   <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> Dock to the left side of the frame window.  
  
-   <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> Dock to the right side of the frame window.  
...
## Remarks  
 The control bar will be docked to one of the sides of the frame window specified in the calls to both [CControlBar::EnableDocking](../vs140/ccontrolbar--enabledocking.md) and [CFrameWnd::EnableDocking](../vs140/cframewnd--enabledocking.md). The side chosen is determined by <CodeContentPlaceHolder>7\</CodeContentPlaceHolder>.  
