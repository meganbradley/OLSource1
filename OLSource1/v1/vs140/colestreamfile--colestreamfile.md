...
## Remarks  
 If <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> is **NULL**, the object is not associated with an OLE stream, otherwise, the object is associated with the supplied OLE stream.  
