...
## Example  
 The following example shows a method, <CodeContentPlaceHolder>0\</CodeContentPlaceHolder>, which violates the rule and a method, <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>, which correctly calls the \<xref:System.Uri*> overload.  
