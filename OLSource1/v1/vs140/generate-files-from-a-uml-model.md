...
<CodeContentPlaceHolder>0\</CodeContentPlaceHolder>  
 The following file is the text template. It generates a line of text for each UML class in the model, and a line for each attribute in each class. Code for reading the model is embedded in the text, delimited by <CodeContentPlaceHolder>8\</CodeContentPlaceHolder>.  
...
-   To allow the generating code in your template to access the model, write <CodeContentPlaceHolder>12\</CodeContentPlaceHolder> directives for the assemblies needed to read a UML model. Use <CodeContentPlaceHolder>13\</CodeContentPlaceHolder> to open the model. For more information, see [How to Read a Model in Program Code](../vs140/read-a-uml-model-in-program-code.md).  
