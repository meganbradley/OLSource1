...
## Return Value  
 <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> if [Desktop Window Manager](http://msdn.microsoft.com/library/windows/desktop/aa969540) (DWM) composition is enabled; otherwise, <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>.  
