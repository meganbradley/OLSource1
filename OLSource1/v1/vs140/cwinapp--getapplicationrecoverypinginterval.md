...
## Remarks  
 ...
 The length of time that the framework waits for the recovery callback function to return is the ping interval. You can customize the ping interval by overriding <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> or by providing a custom value to <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>.  
