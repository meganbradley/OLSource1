...
-   [In-Memory XML Tree Modification vs. Functional Construction (LINQ to XML) (C#)](../vs140/in-memory-xml-tree-modification-vs.-functional-construction--linq-to-xml---csharp-.md)