...
## Remarks  
 ...
 initializes the controlled sequence with the sequence <CodeContentPlaceHolder>7\</CodeContentPlaceHolder>[begin](../vs140/map--begin--stl-clr-.md)<CodeContentPlaceHolder>8\</CodeContentPlaceHolder> <CodeContentPlaceHolder>9\</CodeContentPlaceHolder>[end](../vs140/map--end--stl-clr-.md)<CodeContentPlaceHolder>10\</CodeContentPlaceHolder>, with the default ordering predicate. You use it to specify an initial controlled sequence that is a copy of the sequence controlled by the map object <CodeContentPlaceHolder>11\</CodeContentPlaceHolder>, with the default ordering predicate.  
  
 The constructor:  
  
 <CodeContentPlaceHolder>12\</CodeContentPlaceHolder>  
  
 initializes the controlled sequence with the sequence <CodeContentPlaceHolder>13\</CodeContentPlaceHolder>[begin](../vs140/map--begin--stl-clr-.md)<CodeContentPlaceHolder>14\</CodeContentPlaceHolder> <CodeContentPlaceHolder>15\</CodeContentPlaceHolder>[end](../vs140/map--end--stl-clr-.md)<CodeContentPlaceHolder>16\</CodeContentPlaceHolder>, with the default ordering predicate. You use it to specify an initial controlled sequence that is a copy of the sequence controlled by the map object <CodeContentPlaceHolder>17\</CodeContentPlaceHolder>, with the default ordering predicate.  
