...
## Return Value  
 <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> if this method is successful; otherwise, <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>.  
  
## Remarks  
 This method uses the [CMonthCalCtrl::SetCurrentView](../vs140/cmonthcalctrl--setcurrentview.md) method to set the view to <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>, which represents the month view.  
