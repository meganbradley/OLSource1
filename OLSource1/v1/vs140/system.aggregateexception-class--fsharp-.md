...
|Member|Description|  
|------------|-----------------|  
|[InnerExceptions](../vs140/aggregateexception.innerexceptions-property--fsharp-.md)|Gets a read-only collection of the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> instances that caused the current exception.|  
