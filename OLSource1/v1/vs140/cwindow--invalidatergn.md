...
## Remarks  
 Specifies a <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> return type, while the <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> Win32 function always returns **TRUE**.  
