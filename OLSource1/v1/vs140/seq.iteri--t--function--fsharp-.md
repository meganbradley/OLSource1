...
apitype: "Assembly"
f1_keywords: 
  - "Microsoft.FSharp.Collections.SeqModule.IterateIndexed``1"
dev_langs: 
  - "FSharp"
helpviewer_keywords: 
  - "iteri function [F#]"
  - "Seq.iteri function [F#]"
  - "Seq.IterateIndexed function [F#]"
...
#### Parameters  
 ...
 Type: [int](../vs140/core.int-type-abbreviation--fsharp-.md) <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> [unit](../vs140/core.unit-type-abbreviation--fsharp-.md)  
...
## Example  
 The following code shows how to use <CodeContentPlaceHolder>6\</CodeContentPlaceHolder> and compares its behavior to related functions.  
  
 [!code[FsSequences#43](../vs140/codesnippet/FSharp/seq.iteri--t--function--fsharp-_1.fs)]  
