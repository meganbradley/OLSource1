...
2.  In the **New Project** dialog box, in the left pane, click **Installed Templates**, click **Visual C++**, and then select **Win32**. In the middle pane, select **Win32 Project**.  
     ...
     In the **Name** box, type a name for the project, for example, <CodeContentPlaceHolder>12\</CodeContentPlaceHolder>. Click **OK**.  
...
5.  In **Solution Explorer**, right-click the Win32app project, click **Add**, and then click **New Item**. In the **Add New Item** dialog box, select **C++ File (.cpp)**. In the **Name** box, type a name for the file, for example, <CodeContentPlaceHolder>13\</CodeContentPlaceHolder>. Click **Add**.  
  
### To start a Windows desktop application  
  
1.  Just as every C application and C++ application must have a <CodeContentPlaceHolder>14\</CodeContentPlaceHolder> function as its starting point, every Win32-based application must have a <CodeContentPlaceHolder>15\</CodeContentPlaceHolder> function. <CodeContentPlaceHolder>16\</CodeContentPlaceHolder> has the following syntax.  
...
2.  Win32 programs require \<windows.h>. \<tchar.h> defines the TCHAR macro, which resolves ultimately to <CodeContentPlaceHolder>17\</CodeContentPlaceHolder> if the UNICODE symbol is defined in your project, otherwise it resolves to <CodeContentPlaceHolder>18\</CodeContentPlaceHolder>.  If you always build with UNICODE enabled, you don't need TCHAR and can just use wchar_t directly.  
  
<CodeContentPlaceHolder>1\</CodeContentPlaceHolder>  
3.  In addition to the <CodeContentPlaceHolder>19\</CodeContentPlaceHolder> function, every Windows desktop application must also have a window-procedure function. This function is typically named <CodeContentPlaceHolder>20\</CodeContentPlaceHolder> but you can name it whatever you like. <CodeContentPlaceHolder>21\</CodeContentPlaceHolder> has the following syntax.  
  
<CodeContentPlaceHolder>2\</CodeContentPlaceHolder>  
     In this function you write code to handle *messages* that the application receives from Windows when *events* occur. For example, if a user clicks an OK button in your application, Windows will send a message to you and you can write code inside your <CodeContentPlaceHolder>22\</CodeContentPlaceHolder> function that does whatever work is appropriate. This is called *handling* an event. You only handle the events that are relevant for your application.  
...
<CodeContentPlaceHolder>6\</CodeContentPlaceHolder>  
     At this point, the displayed window will not have much content because you have not yet implemented the <CodeContentPlaceHolder>25\</CodeContentPlaceHolder> function. In other words, the application is not yet handling the messages that Windows is now sending to it.  
  
5.  To handle the messages we first add a message loop to listen for the messages that Windows sends. When the application receives a message, this loop dispatches it to your <CodeContentPlaceHolder>26\</CodeContentPlaceHolder> function to be handled. The message loop resembles the following code.  
...
<CodeContentPlaceHolder>7\</CodeContentPlaceHolder>  
     ...
     At this point, the <CodeContentPlaceHolder>27\</CodeContentPlaceHolder> function should resemble the following code.  
  
<CodeContentPlaceHolder>8\</CodeContentPlaceHolder>  
### To add functionality to the WndProc function  
  
1.  To enable the <CodeContentPlaceHolder>28\</CodeContentPlaceHolder> function to handle the messages that the application receives, implement a switch statement.  
