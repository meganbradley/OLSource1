...
## Example  
 In the following examples, the enum value <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> and the constant <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> raise this warning. To fix the issues, remove the [<CodeContentPlaceHolder>2\</CodeContentPlaceHolder>] attribute to make them security transparent.  
