...
---
# tile_static_memory_fence Function
Blocks execution of all threads in a tile until all outstanding <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> memory accesses have been completed. This ensures that <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> memory accesses are visible to other threads in the thread tile, and that accesses are executed in program order.  
