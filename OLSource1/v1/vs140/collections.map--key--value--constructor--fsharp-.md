...
Builds a map that contains the bindings of the given <xref:System.Collections.Generic.IEnumerable<CodeContentPlaceHolder>1\</CodeContentPlaceHolder>elements<CodeContentPlaceHolder>2\</CodeContentPlaceHolder>\<'Key * 'Value>`  
