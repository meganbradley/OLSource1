...
## Remarks  
 A metric is a registry value used to change a debug engine's behavior or to advertise supported functionality. This method can forward the call to the appropriate form of the [Debugging SDK Helpers](../vs140/sdk-helpers-for-debugging.md) function, <CodeContentPlaceHolder>5\</CodeContentPlaceHolder>.  
