...
|Method|Description|  
|------------|-----------------|  
|[IDiaEnumSectionContribs::get__NewEnum](../vs140/idiaenumsectioncontribs--get__newenum.md)|Retrieves the [IEnumVARIANT Interface](assetId:///139e3c93-faef-4003-9079-e0e94494db3e) version of this enumerator.|  
...
## Example  
 This example shows how to obtain (the <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> function) and use (the <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> function) the <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> interface. For a more complete example of using section contributions, see the [IDiaSectionContrib](../vs140/idiasectioncontrib.md) interface.  
