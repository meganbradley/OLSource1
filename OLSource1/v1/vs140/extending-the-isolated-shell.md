...
1.  Add a Visual Studio Package project named <CodeContentPlaceHolder>0\</CodeContentPlaceHolder>.  
  
2.  On the **Basic VSPackage Information** page of the wizard, set **Company name** to <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> and **VSPackage name** to <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>. Choose the **Next** button.  
  
3.  On the next page, select **Menu Command** and then choose **Next**.  
  
4.  On the next page, set **Command name** to <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> and **Command ID** to <CodeContentPlaceHolder>4\</CodeContentPlaceHolder>, and then choose **Next**.  
...
1.  In the **Add New Project** dialog box, under **Visual C#**, **Extensibility**, use the **Editor Margin** template to add a project. Name it <CodeContentPlaceHolder>5\</CodeContentPlaceHolder>.  
  
2.  In the ShellExtensionsVSIX project, open the Source.extension.vsixmanifest file in the Design view, not the Code view.  
  
3.  In the <CodeContentPlaceHolder>6\</CodeContentPlaceHolder> section, choose **Add Content**.  
...
1.  In the **Add New Project** dialog box, under **Visual C#**, **Extensibility**, use the **VSIXProject** template to add a project. Name it <CodeContentPlaceHolder>7\</CodeContentPlaceHolder>.  
  
2.  In the ShellExtensionsVSIX project, open the Source.extensions.vsixmanifest file in the Design view, not the Code view.  
  
3.  In the <CodeContentPlaceHolder>8\</CodeContentPlaceHolder> section, choose **New**.  
...
7.  If this project includes compiled code, you must edit the project so that the assembly is included in the output.  
    ...
    2.  In the first <CodeContentPlaceHolder>9\</CodeContentPlaceHolder> block, change the value of <CodeContentPlaceHolder>10\</CodeContentPlaceHolder> to <CodeContentPlaceHolder>11\</CodeContentPlaceHolder>.  
