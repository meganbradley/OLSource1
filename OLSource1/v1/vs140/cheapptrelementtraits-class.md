...
## Remarks  
 This class provides methods, static functions, and typedefs for aiding the creation of collection class objects containing heap pointers. The class <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> derives from <CodeContentPlaceHolder>6\</CodeContentPlaceHolder>.  
