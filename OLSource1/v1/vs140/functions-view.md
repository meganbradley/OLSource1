...
The Functions view lists the functions that are called during profiling.  
 ...
 To add or remove columns, right-click in the report window and then select **Add/Remove Columns**. Additionally, you can sort the data by clicking a column name. For more information, see [How to: Customize Performance Report Views](../vs140/how-to--customize-report-view-columns.md).  
