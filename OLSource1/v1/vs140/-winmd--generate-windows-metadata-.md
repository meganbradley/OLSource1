...
## Remarks  
 ...
 By default, the output file name has the form <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>.winmd. To specify a different file name, use the [/WINMDFILE](../vs140/-winmdfile--specify-winmd-file-.md) option.  
