...
The argument requires a value other than an empty string ("") or <CodeContentPlaceHolder>0\</CodeContentPlaceHolder>. This may be a result of incorrectly calculating the value.  
