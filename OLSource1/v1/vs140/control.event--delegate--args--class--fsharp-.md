...
|[Trigger](../vs140/event.trigger--delegate--args--method--fsharp-.md)|Triggers the event using the given sender object and parameters. The sender object may be `null`.|  
