...
---
# CDC::StartDoc
Informs the device driver that a new print job is starting and that all subsequent <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> and <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> calls should be spooled under the same job until an <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> call occurs.  
