...
2.  In the **Visual C++** category, choose the **Win32 Console Application** template, and then name the project <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>.  
...
1.  In the GreetingsConsoleApp.cpp file, enter a blank line before the line <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> and then enter the following code:  
  
<CodeContentPlaceHolder>0\</CodeContentPlaceHolder>  
     A red squiggly line appears under <CodeContentPlaceHolder>4\</CodeContentPlaceHolder>. An error message appears if you point to it.  
...
2.  To include the iostream header, enter the following code after <CodeContentPlaceHolder>5\</CodeContentPlaceHolder>:  
...
<CodeContentPlaceHolder>1\</CodeContentPlaceHolder>  
     ...
     The red squiggly line under <CodeContentPlaceHolder>6\</CodeContentPlaceHolder> disappears when you fix the error.  
...
1.  Add a breakpoint from the menu bar at the line <CodeContentPlaceHolder>7\</CodeContentPlaceHolder>. You can also just click in the left margin to set a breakpoint.  
