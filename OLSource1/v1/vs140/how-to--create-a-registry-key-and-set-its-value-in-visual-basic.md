...
The <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> method of the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> object can be used to create a registry key.  
  
## Procedure  
  
#### To create a registry key  
  
-   Use the <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> method, specifying which hive to place the key under as well as the name of the key. The parameter <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> is not case-sensitive. This example creates the registry key <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> under HKEY_CURRENT_USER.  
...
1.  Use the <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> method, specifying which hive to place the key under as well as the name of the key. This example creates the registry key <CodeContentPlaceHolder>6\</CodeContentPlaceHolder> under HKEY_CURRENT_USER.  
  
     [!code[VbResourceTasks#17](../vs140/codesnippet/VisualBasic/how-to--create-a-registry-key-and-set-its-value-in-visual-basic_1.vb)]  
  
2.  Set the value with the <CodeContentPlaceHolder>7\</CodeContentPlaceHolder> method. This example sets the string value. "MyTestKeyValue" to "This is a test value".  
...
## Example  
 This example creates the registry key <CodeContentPlaceHolder>8\</CodeContentPlaceHolder> under HKEY_CURRENT_USER and then sets the string value <CodeContentPlaceHolder>9\</CodeContentPlaceHolder> to <CodeContentPlaceHolder>10\</CodeContentPlaceHolder>.  
...
-   The name of the key is <CodeContentPlaceHolder>12\</CodeContentPlaceHolder> (\<xref:System.ArgumentNullException*>).  
