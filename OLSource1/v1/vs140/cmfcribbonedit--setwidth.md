...
#### Parameters  
 ...
 <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> to set the width for floating mode; <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> to set the width for regular mode.  
