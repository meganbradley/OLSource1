...
-   The property ID corresponding to your property. You must remove the first seven characters ("DBPROP_") from the front of the property name. For example, if you want to add **DBPROP_MAXROWS**, pass <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> as the first element. If this is a custom property, pass the full GUID name (for example, <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>).  
  
-   The variant type of the property (in [OLE DB Properties](https://msdn.microsoft.com/en-us/library/ms722734.aspx) in the *OLE DB Programmer's Reference*). Enter the **VT_** type (such as <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> or <CodeContentPlaceHolder>4\</CodeContentPlaceHolder>) corresponding to the data type.  
