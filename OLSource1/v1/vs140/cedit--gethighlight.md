...
|---------------|-----------------|  
|[out] <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>|Zero-based index of the first character in the range of text that is highlighted.|  
|[out] <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>|Zero-based index of the last character in the range of text that is highlighted.|  
