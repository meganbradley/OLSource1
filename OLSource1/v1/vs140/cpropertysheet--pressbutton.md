...
## Remarks  
 ...
 A call to <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> will not send the [PSN_APPLY](http://msdn.microsoft.com/library/windows/desktop/bb774552) notification from a property page to the framework. To send this notification, call [CPropertyPage::OnOK](../vs140/cpropertypage--onok.md).  
