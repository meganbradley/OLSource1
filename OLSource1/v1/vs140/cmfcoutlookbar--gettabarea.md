...
## Remarks  
 ...
 The default implementation of <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> returns the whole client area of the Outlook bar if the Outlook bar is static; that is, if the Outlook bar cannot float. Otherwise, it returns the area that page buttons take at the top and bottom of the Outlook bar control.  
  
 Override this method in class derived from <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> to change this behavior.  
