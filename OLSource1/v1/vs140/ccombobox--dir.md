...
#### Parameters  
 ...
 Can be any combination of the <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> values described in [CFile::GetStatus](../vs140/cfile--getstatus.md) or any combination of the following values:  
...
-   **DDL_DIRECTORY** The name specified by <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> specifies a directory.  
  
-   **DDL_ARCHIVE** File has been archived.  
  
-   **DDL_DRIVES** Include all drives that match the name specified by <CodeContentPlaceHolder>4\</CodeContentPlaceHolder>.  
