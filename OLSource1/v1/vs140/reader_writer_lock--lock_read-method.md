...
## Remarks  
 It is often safer to utilize the [scoped_lock_read](../vs140/reader_writer_lock--scoped_lock_read-class.md) construct to acquire and release a <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> object as a reader in an exception safe way.  
