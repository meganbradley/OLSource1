...
## Return Value  
 A pointer to the item's string if the method was successful; otherwise, <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> if the index is invalid, a combo box button is not found, or if index is -1 and there is no selected item in the combo box.  
