...
## Remarks  
 It is not the same as an index, and you cannot operate on a **POSITION** value yourself. <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> retrieves the <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> pointer associated with a given position.  
