...
## Related Sections  
 [/openmp (Enable OpenMP 2.0 Support)](../vs140/-openmp--enable-openmp-2.0-support-.md)  
 Causes the compiler to process <CodeContentPlaceHolder>0\</CodeContentPlaceHolder>.  
