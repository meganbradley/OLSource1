...
-   Adding a <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> block, when the instruction pointer ends up in the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> block or the <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> block.  
  
-   Removing a <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> block, when the instruction pointer is in a <CodeContentPlaceHolder>4\</CodeContentPlaceHolder>block or the <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> block.  
  
-   Adding a <CodeContentPlaceHolder>6\</CodeContentPlaceHolder> block around the current instruction pointer.  
  
-   Adding a <CodeContentPlaceHolder>7\</CodeContentPlaceHolder> block around the current instruction pointer.  
...
-   Adding, changing, or removing <CodeContentPlaceHolder>8\</CodeContentPlaceHolder> status.  
...
-   Adding a new overloading property or method, unless the property or method is <CodeContentPlaceHolder>9\</CodeContentPlaceHolder> and there are no occurrences of the name in any active statement.  
  
-   Adding or removing the <CodeContentPlaceHolder>10\</CodeContentPlaceHolder> clause on a member variable.  
...
-   Adding a new field in any class marked with <CodeContentPlaceHolder>11\</CodeContentPlaceHolder> or <CodeContentPlaceHolder>12\</CodeContentPlaceHolder>.  
  
-   Changing the <CodeContentPlaceHolder>13\</CodeContentPlaceHolder> or <CodeContentPlaceHolder>14\</CodeContentPlaceHolder> status of a method.  
...
###  \<a name="BKMK_EnumerationEdits">\</a> Enumeration Edits  
 Changes to enumerations (<CodeContentPlaceHolder>15\</CodeContentPlaceHolder>) are not allowed by Edit and Continue during Break Mode. Specifically, Edit and Continue does not support the following changes:  
  
-   Modifying the underlying type of an <CodeContentPlaceHolder>16\</CodeContentPlaceHolder>.  
  
-   Adding, changing, or removing an <CodeContentPlaceHolder>17\</CodeContentPlaceHolder> member.  
  
-   Changing the access modifier of an <CodeContentPlaceHolder>18\</CodeContentPlaceHolder>.  
...
###  \<a name="BKMK_ImportsEdits">\</a> Imports Edits  
 Edit and Continue does not allow adding, changing, or removing <CodeContentPlaceHolder>19\</CodeContentPlaceHolder> statements while in Break mode.  
...
-   Changing the access modifiers for a property or method, for example, changing <CodeContentPlaceHolder>20\</CodeContentPlaceHolder> to <CodeContentPlaceHolder>21\</CodeContentPlaceHolder>.  
...
-   Changing the access modifiers of a property or method (for example, changing <CodeContentPlaceHolder>22\</CodeContentPlaceHolder> to **Private**).  
