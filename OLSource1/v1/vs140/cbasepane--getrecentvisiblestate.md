...
## Return Value  
 A <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> that specifies the recent visible state. If <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>, the pane was visible when serialized and should be visible when restored. If <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>, the pane was hidden when serialized and should be hidden when restored.  
