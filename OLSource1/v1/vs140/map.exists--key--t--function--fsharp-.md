...
apitype: "Assembly"
f1_keywords: 
  - "Microsoft.FSharp.Collections.MapModule.Exists``2"
dev_langs: 
  - "FSharp"
helpviewer_keywords: 
  - "Map.exists function [F#]"
  - "exists function [F#]"
...
Returns <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> if the given predicate returns <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> for one of the bindings in the map.  
...
## Return Value  
 <CodeContentPlaceHolder>7\</CodeContentPlaceHolder> if the predicate returns <CodeContentPlaceHolder>8\</CodeContentPlaceHolder> for one of the key/value pairs.  
