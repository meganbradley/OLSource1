...
---
# CMFCListCtrl Class
The <CodeContentPlaceHolder>12\</CodeContentPlaceHolder> class extends the functionality of [CListCtrl](../vs140/clistctrl-class.md) class by supporting the advanced header control functionality of the [CMFCHeaderCtrl Class](../vs140/cmfcheaderctrl-class.md).  
...
## Remarks  
 <CodeContentPlaceHolder>13\</CodeContentPlaceHolder> offers two enhancements to [CListCtrl](../vs140/clistctrl-class.md) class. First, it indicates that column sorting is an available option by automatically drawing a sort arrow on the header. Second, it supports data sorting on multiple columns at the same time.  
  
## Example  
 The following example demonstrates how to use various methods in the <CodeContentPlaceHolder>14\</CodeContentPlaceHolder> class. The example shows how to create a list control, insert columns, insert items, set the text of an item, and set the font of the list control. This code snippet is part of the [Visual Studio Demo sample](../vs140/visual-c---samples.md).  
  
 [!code[NVC_MFC_VisualStudioDemo#25](../vs140/codesnippet/CPP/cmfclistctrl-class_1.h)]  
[!code[NVC_MFC_VisualStudioDemo#26](../vs140/codesnippet/CPP/cmfclistctrl-class_2.cpp)]  
...
### Remarks  
 <CodeContentPlaceHolder>17\</CodeContentPlaceHolder> uses the method <CodeContentPlaceHolder>18\</CodeContentPlaceHolder> to calculate what color to use for sorted columns. The color picked is based upon the regular background color.  
...
### Return Value  
 <CodeContentPlaceHolder>20\</CodeContentPlaceHolder> if the list control supports multiple sort; <CodeContentPlaceHolder>21\</CodeContentPlaceHolder> otherwise.  
...
### Return Value  
 A <CodeContentPlaceHolder>27\</CodeContentPlaceHolder> value that specifies the background color of the cell.  
  
### Remarks  
 The default implementation of <CodeContentPlaceHolder>28\</CodeContentPlaceHolder> does not use the supplied input parameters and instead simply calls <CodeContentPlaceHolder>29\</CodeContentPlaceHolder>. Therefore, by default, the whole list control will have the same background color. You can override <CodeContentPlaceHolder>30\</CodeContentPlaceHolder> in a derived class to mark individual cells with a separate background color.  
...
### Remarks  
 By default, this method returns <CodeContentPlaceHolder>34\</CodeContentPlaceHolder>. All of the cells in a list control have the same font. Override this method in order to provide different fonts for different cells.  
...
### Return Value  
 A <CodeContentPlaceHolder>37\</CodeContentPlaceHolder> value that specifies the text color of the cell.  
  
### Remarks  
 By default, this method calls <CodeContentPlaceHolder>38\</CodeContentPlaceHolder> regardless of input parameters. The whole list control will have the same text color. You can override <CodeContentPlaceHolder>39\</CodeContentPlaceHolder> in a derived class to mark individual cells with a separate text color.  
...
### Parameters  
 ...
 A Boolean that specifies whether the method adds the column indicated by <CodeContentPlaceHolder>44\</CodeContentPlaceHolder> to the list of sort columns.  
...
### Parameters  
 ...
 A Boolean that specifies whether this method adds the column indicated by <CodeContentPlaceHolder>48\</CodeContentPlaceHolder> to the list of sort columns.  
