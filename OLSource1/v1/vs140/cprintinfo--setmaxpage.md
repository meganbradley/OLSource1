...
## Remarks  
 This value is stored in the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> object referenced by the <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> member. If the length of the document is known before it is printed, call this function from your override of <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>. If the length of the document depends on a setting specified by the user in the Print dialog box, call this function from your override of <CodeContentPlaceHolder>4\</CodeContentPlaceHolder>. If the length of the document is not known until it is printed, use the <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> member to control the print loop.  
