...
---
# operator!= Operator
Tests if the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> object on the left side of the operator is not equal to the <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> object on the right side.  
...
## Return Value  
 <CodeContentPlaceHolder>12\</CodeContentPlaceHolder> if the concurrent vectors are not equal; <CodeContentPlaceHolder>13\</CodeContentPlaceHolder> if the concurrent vectors are equal.  
