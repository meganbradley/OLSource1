...
---
# invalid_scheduler_policy_value Class
This class describes an exception thrown when a policy key of a             <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> object is set to an invalid value for that key.  
...
|Name|Description|  
|----------|-----------------|  
|[invalid_scheduler_policy_value::invalid_scheduler_policy_value Constructor](../vs140/invalid_scheduler_policy_thread_specification-class.md#invalid_scheduler_policy_value__invalid_scheduler_policy_value_constructor)|Overloaded. Constructs an                                         <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> object.|  
