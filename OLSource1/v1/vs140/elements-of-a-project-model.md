...
Project model  
 ...
 Projects can support commands and therefore must implement the <xref:Microsoft.VisualStudio.OLE.Interop.IOleCommandTarget?qualifyHint=False> interface to participate in command routing through the command context GUIDs.  
