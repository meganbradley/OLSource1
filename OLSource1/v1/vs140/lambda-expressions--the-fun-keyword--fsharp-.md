...
The <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> keyword is used to define a lambda expression, that is, an anonymous function.  
  
## Syntax  
  
<CodeContentPlaceHolder>0\</CodeContentPlaceHolder>  
## Remarks  
 The <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> typically consists of names and, optionally, types of parameters. More generally, the <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> can be composed of any F# patterns. For a full list of possible patterns, see [Patterns](../vs140/pattern-matching--fsharp-.md). Lists of valid parameters include the following examples.  
  
<CodeContentPlaceHolder>1\</CodeContentPlaceHolder>  
 The <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> is the body of the function, the last expression of which generates a return value. Examples of valid lambda expressions include the following:  
