...
apitype: "Assembly"
f1_keywords: 
  - "Microsoft.FSharp.Collections.Array3DModule.Set``1"
dev_langs: 
  - "FSharp"
helpviewer_keywords: 
  - "set function [F#]"
  - "SetAtIndex function [F#]"
  - "Array3D.SetAtIndex function [F#]"
  - "Array3D.set function [F#]"
...
## Remarks  
 You can also use the syntax <CodeContentPlaceHolder>8\</CodeContentPlaceHolder>.  
