...
## Remarks  
 This function behaves the same as the STL function <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>. For more information, see [set_symmetric_difference](../vs140/set_symmetric_difference.md).  
