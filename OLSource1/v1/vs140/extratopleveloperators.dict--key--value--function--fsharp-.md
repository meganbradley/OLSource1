...
## Return Value  
 An object that implements <xref:System.Collections.Generic.IDictionary<CodeContentPlaceHolder>3\</CodeContentPlaceHolder>CreateDictionary<CodeContentPlaceHolder>4\</CodeContentPlaceHolder>dict` function.  
