...
---
# CListBox::FindStringExact
Finds the first list-box string that matches the string specified in <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>.  
...
## Remarks  
 If the list box was created with an owner-draw style but without the [LBS_HASSTRINGS](../vs140/list-box-styles.md) style, the <CodeContentPlaceHolder>6\</CodeContentPlaceHolder> member function attempts to match the doubleword value against the value of <CodeContentPlaceHolder>7\</CodeContentPlaceHolder>.  
