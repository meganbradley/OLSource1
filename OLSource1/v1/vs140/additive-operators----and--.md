...
<CodeContentPlaceHolder>2\</CodeContentPlaceHolder>  
 Although the integral value 1 is added to <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>, it does not mean "add 1 to the address"; rather it means "adjust the pointer to point to the next object in the array" that happens to be 2 bytes (or <CodeContentPlaceHolder>4\</CodeContentPlaceHolder>) away.  
  
> [!NOTE]
>  Code of the form <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> is rarely found in C++ programs; to perform an increment, these forms are preferable: <CodeContentPlaceHolder>6\</CodeContentPlaceHolder> or <CodeContentPlaceHolder>7\</CodeContentPlaceHolder>.  
