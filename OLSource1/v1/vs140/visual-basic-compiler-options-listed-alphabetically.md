...
|[/?](../vs140/-help------visual-basic-.md)|Displays compiler options. This command is the same as specifying the <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> option. No compilation occurs.|  
|<CodeContentPlaceHolder>1\</CodeContentPlaceHolder>|Names additional files that don't directly affect code generation but may be used by analyzers for producing errors or warnings.|  
...
|<CodeContentPlaceHolder>2\</CodeContentPlaceHolder>|Run the analyzers from this assembly (Short form: /a)|  
...
|<CodeContentPlaceHolder>3\</CodeContentPlaceHolder>|Specify the algorithm for calculating the source file checksum stored in PDB.  Supported values are: SHA1 (default) or SHA256.|  
...
|[/help](../vs140/-help------visual-basic-.md)|Displays compiler options. This command is the same as specifying the <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> option. No compilation occurs.|  
...
|[/main](../vs140/-main.md)|Specifies the class that contains the <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> procedure to use at startup.|  
|[/moduleassemblyname](../vs140/-moduleassemblyname.md)|Specifies the name of the assembly that a module will be a part of.|  
|<CodeContentPlaceHolder>6\</CodeContentPlaceHolder>|Specify the name of the source module|  
...
|<CodeContentPlaceHolder>7\</CodeContentPlaceHolder>|Specifies whether to use concurrent build (+).|  
|[/platform](../vs140/-platform--visual-basic-.md)|Specifies the processor platform the compiler targets for the output file.|  
|<CodeContentPlaceHolder>8\</CodeContentPlaceHolder>|Specify the preferred output language name.|  
...
|<CodeContentPlaceHolder>9\</CodeContentPlaceHolder>|Specify a ruleset file that disables specific diagnostics.|  
