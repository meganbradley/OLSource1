...
Applies the given function to pair of elements drawn from matching indices in two arrays. The two arrays must have the same lengths, otherwise an <xref:System.ArgumentException?qualifyHint=False> is raised.  
