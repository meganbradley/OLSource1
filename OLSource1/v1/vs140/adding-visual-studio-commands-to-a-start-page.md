...
## Adding Commands from the Command Well  
 The start page created in [Creating a Custom Start Page](../vs140/creating-a-custom-start-page.md) added the <xref:Microsoft.VisualStudio.PlatformUI?qualifyHint=True> and <xref:Microsoft.VisualStudio.Shell?qualifyHint=True> namespaces, as follows.  
