 ...
 **Parameters**  
 ...
 `identifier`  
 The iteration variable that represents the collection element.  When `identifier` is a [Tracking Reference Operator (C++ Component Extensions)](../vs140/tracking-reference-operator--c---component-extensions-.md), you can modify the element.  
 ...
 **Remarks**  
 ...
 `for each` and `in` are [context-sensitive keywords](../vs140/context-sensitive-keywords---c---component-extensions-.md).  
