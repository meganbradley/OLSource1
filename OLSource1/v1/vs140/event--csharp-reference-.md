...
---
# event (C# Reference)
The <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> keyword is used to declare an event in a publisher class.  
  
## Example  
 The following example shows how to declare and raise an event that uses \<xref:System.EventHandler*> as the underlying delegate type. For the complete code example that also shows how to use the generic <xref:System.EventHandler<CodeContentPlaceHolder>1\</CodeContentPlaceHolder>protected<CodeContentPlaceHolder>2\</CodeContentPlaceHolder>. These access modifiers define how users of the class can access the event. For more information, see [Access Modifiers](../vs140/access-modifiers--csharp-programming-guide-.md).  
...
|[abstract](../vs140/abstract--csharp-reference-.md)|The compiler will not generate the <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> and <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> event accessor blocks and therefore derived classes must provide their own implementation.||  
