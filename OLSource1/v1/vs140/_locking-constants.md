...
## Remarks  
 The *mode* argument in the call to the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> function specifies the locking action to be performed.  
 ...
 Same as <CodeContentPlaceHolder>4\</CodeContentPlaceHolder>.  
  
 <CodeContentPlaceHolder>5\</CodeContentPlaceHolder>  
 Locks the specified bytes. If bytes cannot be locked, the function returns an error.  
  
 <CodeContentPlaceHolder>6\</CodeContentPlaceHolder>  
 Same as <CodeContentPlaceHolder>7\</CodeContentPlaceHolder>.  
