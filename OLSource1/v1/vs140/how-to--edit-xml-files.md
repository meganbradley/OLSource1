...
3.  Enter the filename in the **Name** field and press **Add**.  
     ...
     The XML file is added to the project and opened in the XML Editor. The file contains the default XML declaration, <CodeContentPlaceHolder>0\</CodeContentPlaceHolder>.  
