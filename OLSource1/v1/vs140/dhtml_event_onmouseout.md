...
f1_keywords: 
  ...
  - "AFXDHTML/DHTML_EVENT_ONMOUSEOUT"
dev_langs: 
  - "C++"
helpviewer_keywords: 
  - "DHTML_EVENT_ONMOUSEOUT macro"
...
---
# DHTML_EVENT_ONMOUSEOUT
Handles (at the document level) the **onmouseout** event originated by the HTML element identified by <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>.  
