...
## Return Value  
 An <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> value; otherwise 0 if there is not enough memory to display the message box. See [AfxMessageBox](../vs140/afxmessagebox.md) for the possible return values.  
  
## Example  
 Here is an example of the use of <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>. For another example, see the example for [CATCH](../vs140/catch.md).  
