...
Posts a message to the message queue of the [MailboxProcessor](../vs140/control.mailboxprocessor--msg--class--fsharp-.md), asynchronously.  
...
## Example  
 ...
 [!code[FsMailboxProcessor#2](../vs140/codesnippet/FSharp/mailboxprocessor.post--msg--method--fsharp-_1.fs)]  
