...
Retrieves the virtual address (VA) of the location. Use when the [LocationType Enumeration](../vs140/locationtype.md) is set to <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>.  
