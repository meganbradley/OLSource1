...
## Remarks  
 ...
 This function supersedes the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> method. To write code that is compatible with both 32-bit and 64-bit versions of Windows, use <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>.  
