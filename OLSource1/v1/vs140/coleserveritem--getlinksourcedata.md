...
---
# COleServerItem::GetLinkSourceData
Call this function to get the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> data for an OLE item.  
...
#### Parameters  
 ...
 Pointer to the [STGMEDIUM](http://msdn.microsoft.com/library/windows/desktop/ms683812) structure that will receive the <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> data for the OLE item.  
