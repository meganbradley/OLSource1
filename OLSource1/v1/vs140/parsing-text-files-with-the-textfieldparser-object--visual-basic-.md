...
## Parsing Files with Multiple Formats  
 The `PeekChars` method of the `TextFieldParser` object can be used to check each field before reading it, allowing you to define multiple formats for the fields and react accordingly. For more information, see [How to: Read From Text Files with Multiple Formats in Visual Basic](../vs140/how-to--read-from-text-files-with-multiple-formats-in-visual-basic.md).  
...
## See Also  
 ...
 [PeekChars](assetId:///M:Microsoft.VisualBasic.FileIO.TextFieldParser.PeekChars(System.Int32)?qualifyHint=False&autoUpgrade=True)   
 ...
 [SetDelimiters](assetId:///M:Microsoft.VisualBasic.FileIO.TextFieldParser.SetDelimiters(System.String[])?qualifyHint=False&autoUpgrade=True)   
 [SetFieldWidths](assetId:///M:Microsoft.VisualBasic.FileIO.TextFieldParser.SetFieldWidths(System.Int32[])?qualifyHint=False&autoUpgrade=True)   
