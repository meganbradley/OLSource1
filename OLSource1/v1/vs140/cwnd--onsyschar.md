...
---
# CWnd::OnSysChar
The framework calls this member function if <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> has the input focus and the [WM_SYSKEYUP](../vs140/cwnd--onsyskeyup.md) and [WM_SYSKEYDOWN](../vs140/cwnd--onsyskeydown.md) messages are translated.  
...
#### Parameters  
 ...
 The <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> parameter can have these values:  
