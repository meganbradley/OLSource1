...
##  \<a name="_core_mixing_exception_keywords_and_macros">\</a> Mixing Exception Keywords and Macros  
 ...
 [!code[NVC_MFCExceptions#10](../vs140/codesnippet/CPP/exceptions--using-mfc-macros-and-c---exceptions_1.cpp)]  
  
 The problem occurs because <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> is deleted when execution passes out of the "inner" **CATCH** block. Using the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> macro instead of the **THROW** statement will cause the "outer" **CATCH** block to receive a valid pointer:  
  
 [!code[NVC_MFCExceptions#11](../vs140/codesnippet/CPP/exceptions--using-mfc-macros-and-c---exceptions_2.cpp)]  
...
##  \<a name="_core_try_blocks_inside_catch_blocks">\</a> Try Blocks Inside Catch Blocks  
 ...
 [!code[NVC_MFCExceptions#12](../vs140/codesnippet/CPP/exceptions--using-mfc-macros-and-c---exceptions_3.cpp)]  
