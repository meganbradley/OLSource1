...
explicit instantiation; storage class specifier 'specifier' not permitted on specialization  
 ...
 You cannot use storage-class specifiers (such as <CodeContentPlaceHolder>0\</CodeContentPlaceHolder>) in a specialization of a template class that was previously explicitly instantiated.