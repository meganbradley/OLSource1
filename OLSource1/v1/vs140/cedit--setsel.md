 ...
 *bNoScroll*  
 ...
 Specifies the starting position. If <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> is 0 and <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> is –1, all the text in the edit control is selected. If <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> is –1, any current selection is removed.  
