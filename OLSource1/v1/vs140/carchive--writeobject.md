...
---
# CArchive::WriteObject
Stores the specified <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> to the archive.  
...
## Example  
 For a definition of the class <CodeContentPlaceHolder>7\</CodeContentPlaceHolder>, see the example for [CObList::CObList](../vs140/coblist--coblist.md).  
