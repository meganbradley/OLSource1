...
## Initializing the Custom Format String  
 Initialize the custom string with a call to <CodeContentPlaceHolder>0\</CodeContentPlaceHolder>. For more information, see [Using Custom Format Strings in a Date and Time Picker Control](../vs140/using-custom-format-strings-in-a-date-and-time-picker-control.md). A common place to set the custom format string is in the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> function of your containing dialog class or <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> function of your containing view class.  
...
## Handling the DTN_FORMATQUERY Notification  
 ...
 [!code[NVC_MFCControlLadenDialog#8](../vs140/codesnippet/CPP/using-callback-fields-in-a-date-and-time-picker-control_1.cpp)]  
...
## Handling the DTN_FORMAT Notification  
 ...
 [!code[NVC_MFCControlLadenDialog#9](../vs140/codesnippet/CPP/using-callback-fields-in-a-date-and-time-picker-control_2.cpp)]  
