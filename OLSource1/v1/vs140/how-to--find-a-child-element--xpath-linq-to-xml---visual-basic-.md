...
This topic compares the XPath child element axis to the [!INCLUDE[sqltecxlinq](../vs140/includes/sqltecxlinq_md.md)] <xref:System.Xml.Linq.XContainer.Element?qualifyHint=False> method.  
