...
## Return Value  
 Returns <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>(_*Left*. [begin](../vs140/container-class--begin.md), \_*Left*. [end](../vs140/container-class--end.md), \_*Right***.begin**, \_*Right*.**end**).  
