...
helpviewer_keywords: 
  ...
  - "Create method [C++]"
  - "workspaces [C++], creating"
  - "workspaces [C++], password"
  - "workspaces [C++], naming"
  - "passwords [C++], workspace"
...
---
# CDaoWorkspace::Create
Call this member function to create a new DAO workspace object and associate it with the MFC <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> object.  
 ...
 *lpszUserName*  
 The user name of the workspace's owner. For requirements, see the <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> parameter to the [SetDefaultUser](../vs140/cdaoworkspace--setdefaultuser.md) member function. For related information, see the topic "UserName Property" in DAO Help.  
