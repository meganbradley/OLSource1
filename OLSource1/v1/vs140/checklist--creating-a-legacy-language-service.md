...
1.  Implement the <xref:Microsoft.VisualStudio.Shell.Interop.IVsPackage*> interface.  
    ...
    -   Make your language service available to the integrated development environment (IDE) in your [SetSite](assetId:///M:Microsoft.VisualStudio.Shell.Interop.IVsPackage.SetSite(Microsoft.VisualStudio.OLE.Interop.IServiceProvider)?qualifyHint=False&autoUpgrade=True) implementation.  
...
-   Text view filter  
    ...
    -   Call the [AddCommandFilter](assetId:///M:Microsoft.VisualStudio.TextManager.Interop.IVsTextView.AddCommandFilter(Microsoft.VisualStudio.OLE.Interop.IOleCommandTarget,Microsoft.VisualStudio.OLE.Interop.IOleCommandTarget@)?qualifyHint=False&autoUpgrade=True) method and pass in your <xref:Microsoft.VisualStudio.OLE.Interop.IOleCommandTarget*> implementation.  
  
    -   Call the [RemoveCommandFilter](assetId:///M:Microsoft.VisualStudio.TextManager.Interop.IVsTextView.RemoveCommandFilter(Microsoft.VisualStudio.OLE.Interop.IOleCommandTarget)?qualifyHint=False&autoUpgrade=True) method when you detach from the view so that these commands are no longer passed to you.  
...
-   Statement completion  
     ...
     Support the statement completion command (that is, <xref:Microsoft.VisualStudio.VSConstants.VSStd2KCmdID.COMPLETEWORD*>) and call the [UpdateCompletionStatus](assetId:///M:Microsoft.VisualStudio.TextManager.Interop.IVsTextView.UpdateCompletionStatus(Microsoft.VisualStudio.TextManager.Interop.IVsCompletionSet,System.UInt32)?qualifyHint=False&autoUpgrade=True) method in the <xref:Microsoft.VisualStudio.TextManager.Interop.IVsTextView*> interface, passing the <xref:Microsoft.VisualStudio.TextManager.Interop.IVsCompletionSet*> interface. For more information, see [Statement Completion](../vs140/statement-completion-in-a-legacy-language-service.md).  
...
-   Task List items  
     ...
     Register the task provider with the task list's [RegisterTaskProvider](assetId:///M:Microsoft.VisualStudio.Shell.Interop.IVsTaskList.RegisterTaskProvider(Microsoft.VisualStudio.Shell.Interop.IVsTaskProvider,System.UInt32@)?qualifyHint=False&autoUpgrade=True) method.  
     ...
     Create task item objects and call the [RefreshTasks](assetId:///M:Microsoft.VisualStudio.Shell.Interop.IVsTaskList.RefreshTasks(System.UInt32)?qualifyHint=False&autoUpgrade=True) method in the <xref:Microsoft.VisualStudio.Shell.Interop.IVsTaskList*> interface when there are new or updated tasks.  
...
-   Comment task items  
     ...
     Obtain the <xref:Microsoft.VisualStudio.Shell.Interop.IVsEnumCommentTaskTokens*> interface from the [EnumTokens](assetId:///M:Microsoft.VisualStudio.Shell.Interop.IVsCommentTaskInfo.EnumTokens(Microsoft.VisualStudio.Shell.Interop.IVsEnumCommentTaskTokens@)?qualifyHint=False&autoUpgrade=True) method.  
