...
---
# CPaneDivider::m_pSliderRTC
Holds a pointer to runtime class information about a <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>-derived object.  
...
## Example  
 The following example shows how to set the <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> member variable:  
