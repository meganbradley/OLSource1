...
## Remarks  
 <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> loads the string resources associated with [m_dwDocString](../vs140/ipropertypageimpl--m_dwdocstring.md), [m_dwHelpFile](../vs140/ipropertypageimpl--m_dwhelpfile.md), and [m_dwTitle](../vs140/ipropertypageimpl--m_dwtitle.md).  
