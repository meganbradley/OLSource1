...
## Example  
 This example first finds an <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> element. It then finds the <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> attribute of the parent element.  
