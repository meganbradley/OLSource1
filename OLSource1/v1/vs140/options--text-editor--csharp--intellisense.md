 ...
 **Place keywords in completion lists**  
 When this option is selected, IntelliSense adds C# keywords, for example, [class](../vs140/class--csharp-reference-.md), to the completion list.  
  
 **Place code snippets in completion lists**  
 When this option is selected, IntelliSense adds aliases for C# code snippets to the completion list. In the case where the code snippet alias is the same as a keyword, for example, [class](../vs140/class--csharp-reference-.md), the keyword is replaced by the shortcut. For more information, see [Default Expansions in C#](../vs140/visual-csharp-code-snippets.md).  
 ...
 **Add new line on enter at end of fully typed word**  
 ...
 For example, if you type <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> and then press ENTER, the following appears in the editor:  
  
 <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>  
  
 <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> (cursor location)  
  
 However, if you type only <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> and then press ENTER, the following appears in the editor:  
  
 <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> (cursor location)  
