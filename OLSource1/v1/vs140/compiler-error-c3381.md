...
'assembly' : assembly access specifiers are only available in code compiled with a /clr option  
 ...
 For more information, see [Type Visibility](../vs140/how-to--define-and-consume-classes-and-structs--c---cli-.md#BKMK_Type_visibility) and [/clr (Common Language Runtime Compilation)](../vs140/-clr--common-language-runtime-compilation-.md).  
