...
## Return Value  
 <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> if the pop-up menu can hide the rarely used commands; otherwise <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>.  
