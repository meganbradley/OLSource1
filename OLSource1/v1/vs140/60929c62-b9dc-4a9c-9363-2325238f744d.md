...
An access value is not valid in <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> mode.  
  
### To correct this error  
  
-   Change the value to either <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> or <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>.  
