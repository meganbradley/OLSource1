...
A <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> exception occurs when SQL Server Compact opens a database file that was created in an earlier version of the product.  
  
## Remarks  
 You can update the database file by using [!INCLUDE[vs_orcas_long](../vs140/includes/vs_orcas_long_md.md)] or by using the API <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>.  
