...
<CodeContentPlaceHolder>0\</CodeContentPlaceHolder>  
 Since this instance of the class is generated on the stack, the initial value of <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> can be anything. Also, since it is a **const** instance, the value of <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> can never be changed.