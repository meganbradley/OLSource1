 ...
 **Ignore Import Library**  
 ...
 Use **Ignore Import Library** to resolve this problem. When set to <CodeContentPlaceHolder>0\</CodeContentPlaceHolder>, the project system will ignore the presence or absence of that .lib file and cause any project that depends on this project to not link with the nonexistent .lib file.  
 ...
 **Use Library Dependency Inputs**  
 In a large project, when a dependent project produces a .lib file, incremental linking is disabled. If there are many dependent projects that produce .lib files, building the application can take a long time. When this property is set to <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>, the project system links in the .obj files for .libs produced by dependent projects, thus enabling incremental linking.  
