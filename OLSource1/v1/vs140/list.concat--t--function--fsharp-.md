...
#### Parameters  
 `lists`  
 Type: [seq](../vs140/collections.seq--t--type-abbreviation--fsharp-.md)`<'T list>`  
...
## Example  
 The following code example illustrates that [List.append](../vs140/list.append--t--function--fsharp-.md) is used to join two lists together; and `List.concat` is used to join any number of lists.  
