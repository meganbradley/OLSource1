...
## Remarks  
 The first member function returns [rdbuf](../vs140/basic_stringstream--rdbuf.md) -> [str](../vs140/basic_stringbuf--str.md). The second member function calls <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> -> **str**(<CodeContentPlaceHolder>4\</CodeContentPlaceHolder>).  
