...
> [!NOTE]
>  If you want angle brackets to appear in the text of a documentation comment, use <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> and <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>. For example, the string <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> will appear as <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>.  
