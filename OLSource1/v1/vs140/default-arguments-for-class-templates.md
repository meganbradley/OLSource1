...
## Example  
 In the following example, an array class template is defined with a default type <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> for the array element and a default value for the template parameter specifying the size.  
