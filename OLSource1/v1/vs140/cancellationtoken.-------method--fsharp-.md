...
apitype: Assembly
f1_keywords: 
  - System.Threading.CancellationToken.op_BangEquals
dev_langs: 
  - FSharp
helpviewer_keywords: 
  ...
  - CancellationToken.op_BangEquals operator [F#]
ms.assetid: 56682c19-8f21-459f-9839-2d13d34dfec2
...
## Remarks  
 This API is provided for use only with the F# Core Library Versions that targets .NET Framework 2.0. If you are using .NET Framework 4, use the .NET Framework 4 API with the same name, <xref:System.Threading.CancellationToken.op_Inequality?qualifyHint=False>.  
