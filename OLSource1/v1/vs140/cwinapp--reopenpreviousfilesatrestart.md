...
## Return Value  
 <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> indicates the restart manager reopens the previously open files; <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> indicates the restart manager does not.  
