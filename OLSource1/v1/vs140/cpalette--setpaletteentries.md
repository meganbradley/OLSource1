...
## Remarks  
 If the logical palette is selected into a device context when the application calls <CodeContentPlaceHolder>5\</CodeContentPlaceHolder>, the changes will not take effect until the application calls [CDC::RealizePalette](../vs140/cdc--realizepalette.md).  
