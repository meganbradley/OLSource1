 ...
 **Attribute quotes**  
 When authoring XML attributes, the editor inserts the <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> characters and positions the caret (^) inside the double quotes.  
