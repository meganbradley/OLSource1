...
> [!NOTE]
>  Your derived class *must* supply its own constructor. In the constructor, invoke the constructor, <CodeContentPlaceHolder>5\</CodeContentPlaceHolder>, with the resource name or ID as an argument.  
