...
#### Parameters  
 ...
 <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> if the Outlook bar is scrolling down, or <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> if it is scrolling up.  
