...
-   [Optimize the compiler for an ATL project](../vs140/specifying-compiler-optimization-for-an-atl-project.md)  
 ...
 You can specify project properties (for example, [whether to link statically to the CRT](../vs140/programming-with-atl-and-c-run-time-code.md)) in the [Project Properties](../vs140/general-property-page--project-.md) page, and you can set [build configurations](../vs140/understanding-build-configurations.md) for an ATL project. See [Using Projects to Build Applications](assetId:///3339fa90-bac2-4b95-8361-662a2e0e7dfe) for more information.  
