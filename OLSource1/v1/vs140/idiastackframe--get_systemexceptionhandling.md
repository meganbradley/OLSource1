...
#### Parameters  
 ...
 [out] Returns <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> if system exception handling is in effect for this frame; otherwise, returns <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>.  
