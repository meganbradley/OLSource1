...
---
# CWindowImpl::UnsubclassWindow
Detaches the subclassed window from the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> object and restores the original window procedure, saved in [m_pfnSuperWindowProc](../vs140/cwindowimpl--m_pfnsuperwindowproc.md).  
