...
2.  Open the test case in Visual Studio.  
     ...
     ![Open Test Case Using Microsoft Visual Studio](../vs140/media/open_testcasevs.png "Open_TestCaseVS")  
  
3.  Associate the test method with your test case.  
  
     ![Associate Automation With Test Case](../vs140/media/associate_automation.png "Associate_Automation")  
...
2.  To import all the test methods from the solution:  
     ...
     **tcm testcase /collection:** *CollectionUrl* **/teamproject:** *MyProject* **/import /storage:** *MyAssembly* **.dll  /category:"** *MyIntegrationTestCategory* **"**  
     ...
     The category parameter is optional but recommended. You only want to create test cases from integration or system tests, which you can mark by using the [&#91;TestCategory ("category")&#93;](../vs140/defining-test-categories-to-group-your-tests.md) attribute.  
...
1.  In [!INCLUDE[TCMext](../vs140/includes/tcmext_md.md)], choose **Testing Center**, **Plan**, **Properties**.  
  
2.  Under **Builds**, set **Filter for builds**. You can set the [build definition and quality attribute](assetId:///a971b0f9-7c28-479d-a37b-8fd7e27ef692) of the builds you want to choose from.  
  
3.  Choose **Modify** to assign a build to the test plan. You can compare your current build with a build you plan to take. The associated items list shows the changes to work items between the builds. You can then assign the latest build to take and use for testing with this plan. For more information, see [Determining Which Builds Have Bug Fixes, New Features or Requirements](../vs140/what-development-has-been-done-since-a-previous-build-.md).  
...
##  <a name="AddEnvironment"></a> Create a Lab Environment and Settings to Run Your Tests  
 To run your automated tests tests using [!INCLUDE[TCMext](../vs140/includes/tcmext_md.md)], you must use a lab environment. It must have roles for each of the client and server machines used in your tests. (If you’ve used lab environments for manual tests, notice that automated tests must have a machine for the client role.)  
  
1.  Create or choose either a [standard lab environment](assetId:///7ba1b89c-f98d-4ff5-aa74-c47df4c97f55) or an [SCVMM lab environment](assetId:///386f79b2-dfdd-46c3-b481-5d7a627175d3).  
  
     If you create a new environment, choose a machine for each role.  
  
     ![The machines tab in the new environment wizard.](../vs140/media/almt_wsa01.png "ALMT_wsa01")  
     ...
     We recommend that you use a different user account than the [lab service account](../vs140/configure-the-lab-service-account.md) used by the test controller.  
  
     ![The advanced tab in the new environment wizard.](../vs140/media/almt_wsa02.png "ALMT_wsa02")  
  
2.  Set the test plan to use your environment for automated tests.  
  
     ![Automation on test plan properties](../vs140/media/almt_wsa03selectenv.png "ALMT_wsa03SelectEnv")  
  
3.  If you want to collect more than the basic diagnostic data from the test machines, create a test settings file.  
  
     ![New test settings](../vs140/media/almt_wsa04newsettings.png "ALMT_wsa04newSettings")  
  
     In the test settings wizard, choose the data you want to collect for each machine.  
  
     ![Select diagnostics for each machine role](../vs140/media/almt_wsa05setroles.png "ALMT_wsa05setRoles")  
...
1.  In [!INCLUDE[TCMext](../vs140/includes/tcmext_md.md)], choose **Testing Center**, **Test**, **Analyze Test Runs**.  
 ...
 **A:** Yes. [Use UI Automation To Test Your Code](../vs140/use-ui-automation-to-test-your-code.md)  
  
 **Q: Can I automate deploying the code to a lab environment?**  
 Yes. [Automate build-deploy-test workflows](../vs140/automated-build-deploy-test-workflows.md)  
 ...
 **A:** To make the automated test iterate over different data, write that into the code of the test method.  
 ...
 [Test parameters](../vs140/repeat-a-test-with-different-data.md) are only used with the manual version of the test. They aren’t visible to the automated test code.  
 ...
 **The build directory of the test run either does not exist or access permission is required**  
 ...
 ![Error when using a vNext build](../vs140/media/auto-test-qna-addition2.png.png "auto-test-qna-addition2.png")  
