...
ms.topic: "reference"
f1_keywords: 
  - "ATL.CPrivateObjectSecurityDesc.ConvertToAutoInherit"
...
#### Parameters  
 ...
 Pointer to a **GUID** structure that identifies the type of object associated with the current object. Set <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> to NULL if the object does not have a GUID.  
