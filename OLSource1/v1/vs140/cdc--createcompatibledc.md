...
---
# CDC::CreateCompatibleDC
Creates a memory device context that is compatible with the device specified by <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>.  
...
#### Parameters  
 ...
 A pointer to a device context. If <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> is **NULL**, the function creates a memory device context that is compatible with the system display.  
