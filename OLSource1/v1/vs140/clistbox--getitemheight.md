...
## Return Value  
 The height, in pixels, of the items in the list box. If the list box has the [LBS_OWNERDRAWVARIABLE](../vs140/list-box-styles.md) style, the return value is the height of the item specified by <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>. If an error occurs, the return value is **LB_ERR**.  
