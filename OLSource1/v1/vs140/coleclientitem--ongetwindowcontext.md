...
## Remarks  
 ...
 If the container is an MDI application, the default implementation returns a pointer to the [CMDIFrameWnd](../vs140/cmdiframewnd-class.md) object in <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> and a pointer to the active [CMDIChildWnd](../vs140/cmdichildwnd-class.md) object in <CodeContentPlaceHolder>5\</CodeContentPlaceHolder>. If the container is an SDI application, the default implementation returns a pointer to the [CFrameWnd](../vs140/cframewnd-class.md) object in <CodeContentPlaceHolder>6\</CodeContentPlaceHolder> and returns **NULL** in <CodeContentPlaceHolder>7\</CodeContentPlaceHolder>. The default implementation also fills in the members of <CodeContentPlaceHolder>8\</CodeContentPlaceHolder>.  
