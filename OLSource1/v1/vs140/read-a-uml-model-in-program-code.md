...
##  \<a name="Reading">\</a> Reading a Model in Program Code  
 To access the content of a model without showing it in a [!INCLUDE[vsprvs](../vs140/includes/vsprvs_md.md)] window, use <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>.  
