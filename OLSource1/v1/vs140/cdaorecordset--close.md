...
---
# CDaoRecordset::Close
Closing a <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> object removes it from the collection of open recordsets in the associated database.  
  
## Syntax  
  
<CodeContentPlaceHolder>0\</CodeContentPlaceHolder>  
## Remarks  
 Because **Close** does not destroy the <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> object, you can reuse the object by calling **Open** on the same data source or a different data source.  
