...
#### Parameters  
 ...
 [out] Returns <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> if the section is not to be added to the in-memory image; otherwise, returns <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>.  
