...
## Members  
 ...
 BP_COND_WHEN_TRUE  
 Fires the breakpoint only when the conditional expression associated with the breakpoint evaluates to <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>.  
...
## Remarks  
 Used for the <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> member of the [BP_CONDITION](../vs140/bp_condition.md) structure.  
