...
|||  
|-|-|  
|[DA0001: Use StringBuilder for concatenations](../vs140/da0001--use-stringbuilder-for-concatenations.md)|Calls to <xref:System.String.Concat(System.String,System.String)?qualifyHint=True> are a significant proportion of the profiling data. Consider using the <xref:System.Text.StringBuilder?qualifyHint=False> class to construct strings from multiple segments.|  
