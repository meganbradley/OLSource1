...
1.  Create the beginning and ending statements for the structure.  
     ...
     You can specify the access level of a structure using the [Public (Visual Basic)](../vs140/public--visual-basic-.md), [Protected (Visual Basic)](../vs140/protected--visual-basic-.md), [Friend (Visual Basic)](../vs140/friend--visual-basic-.md), or [Private (Visual Basic)](../vs140/private--visual-basic-.md) keyword, or you can let it default to `Public`.  
...
2.  Add elements to the body of the structure.  
     ...
     A structure must have at least one element. You must declare every element and specify an access level for it. If you use the [Dim Statement (Visual Basic)](../vs140/dim-statement--visual-basic-.md) without any keywords, the accessibility defaults to `Public`.  
    ...
    ```  
     ...
     In addition to variables, `Sub` procedures, and events, you can also define constants, `Function` procedures, and properties in a structure. You can designate at most one property as the *default property*, provided it takes at least one argument. You can handle an event with a [Shared (Visual Basic)](../vs140/shared--visual-basic-.md)`Sub` procedure. For more information, see [How to: Declare and Call a Default Property in Visual Basic](../vs140/how-to--declare-and-call-a-default-property-in-visual-basic.md).  
