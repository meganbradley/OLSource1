...
4.  In the Text Tool Dialog Box, type <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> in the empty text area. This text will appear in a resizable box located in the upper left corner of app.ico, in the Image Editor.  
