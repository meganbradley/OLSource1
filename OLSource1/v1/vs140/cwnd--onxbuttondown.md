...
|[in] <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>|A value of <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> if the first Microsoft Intellimouse X button was clicked, or <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> if the second X button was clicked.|  
