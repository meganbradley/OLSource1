...
## Remarks  
 The default command button control is the control that is selected when the <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> is first displayed to the user.  
  
 This method throws an exception if it cannot find the command button control specified by <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>.  
