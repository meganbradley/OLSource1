...
---
# CSid::AccountName
Returns the name of the account associated with the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> object.  
  
## Syntax  
  
<CodeContentPlaceHolder>0\</CodeContentPlaceHolder>  
## Return Value  
 Returns the <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> pointing to the name of the account.  
