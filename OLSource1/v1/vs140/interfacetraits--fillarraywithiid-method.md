...
## Remarks  
 Assigns the interface ID of <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> to the array element specified by the index argument.  
  
 Contrary to the name of this API, only one array element is modified; not the entire array.  
  
 For more information about <CodeContentPlaceHolder>4\</CodeContentPlaceHolder>, see the Public Typedefs section in [InterfaceTraits Structure](../vs140/interfacetraits-structure.md).  
