...
The following table shows non-intrinsic math functions that can be derived from the intrinsic math functions of the \<xref:System.Math*?displayProperty=fullName> object. You can access the intrinsic math functions by adding <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> to your file or project.  
