...
Properties and methods are <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> by default. The <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> modifier can only be used on methods that override another property or method.  
  
 **Error ID:** BC31088  
  
### To correct this error  
  
-   Remove the <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> modifier from properties and methods that do not override another member.  
