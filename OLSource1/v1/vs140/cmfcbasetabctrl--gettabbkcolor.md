...
## Return Value  
 A [COLORREF](http://msdn.microsoft.com/library/windows/desktop/dd183449) value that indicates the background color of the specified tab; -1 if <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> is out of range.  
