...
## Return Value  
 Specifies the outcome of the <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> function. Some of the following values are more probable than others, but all are possible.  
...
## Remarks  
 ...
 Note that the features of Microsoft Visual C++ simplify the creation of the callback function passed to <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>. The address passed to the <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> member function is a pointer to a function exported with **__declspec(dllexport)** and with the <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> calling convention.  
 ...
 **BOOL CALLBACK EXPORT** AFunction( **HDC**, <CodeContentPlaceHolder>6\</CodeContentPlaceHolder> **);**  
