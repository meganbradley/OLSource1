...
```  
 ...
 In the following table, *EntityContainer* is the single type generated by edmgen.exe, which has base type <xref:System.Data.Objects.ObjectContext?qualifyHint=False>. This is the value of the static parameter `EntityContainer`, if it is given. Otherwise, it is the name chosen by edmgen.exe.  
...
|MyDb.ServiceTypes.*EntityContainer*|The data context type, inherited from <xref:System.Data.Objects.ObjectContext?qualifyHint=False>.|  
|MyDb.ServiceTypes.SimpleDataContextTypes.*EntityContainer*|Contains one method for each method of the full context type, including stored procedures and functions. The methods return <xref:System.Data.Linq.ISingleResult`1?qualifyHint=False>.<br /><br /> Contains one property for each property of the full context type. The properties return <xref:System.Data.Linq.Table`1?qualifyHint=False>.<br /><br /> The property Connection gets the database connection as an instance of <xref:System.Data.Common.DbConnection?qualifyHint=False>.<br /><br /> The property DataContext gets the full data context, of type <xref:System.Data.Objects.ObjectContext?qualifyHint=False>. This is the base type of the *EntityContainer* type generated by the type provider.|  
