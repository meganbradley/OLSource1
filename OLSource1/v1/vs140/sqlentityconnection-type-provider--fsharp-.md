...
|?Provider : string|The name of the ADO.NET data provider to be used. The default is <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>.|  
...
|?ForceUpdate : bool|Determines whether the type provider updates the generated types to reflect changes in the database schema. When <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> is false, the provider reacts to changes in the <CodeContentPlaceHolder>5\</CodeContentPlaceHolder>. The default value is true.|  
...
<CodeContentPlaceHolder>1\</CodeContentPlaceHolder>  
 In the following table, *EntityContainer* is the single type generated by edmgen.exe, which has base type \<xref:System.Data.Objects.ObjectContext*>. This is the value of the static parameter <CodeContentPlaceHolder>6\</CodeContentPlaceHolder>, if it is given. Otherwise, it is the name chosen by edmgen.exe.  
  
|Type|Description|  
|----------|-----------------|  
|MyDb|The overall container type.\<br />\<br /> Contains a method <CodeContentPlaceHolder>7\</CodeContentPlaceHolder> that returns a simplified view of the data context. The method returns a new instance of MyDB.ServiceTypes.SimpleDataContextTypes.*EntityContainer*. The version with the connectionString parameter may be used when the connection string is determined at runtime.|  
...
|MyDb.ServiceTypes.SimpleDataContextTypes.*EntityContainer*|Contains one method for each method of the full context type, including stored procedures and functions. The methods return <xref:System.Data.Linq.ISingleResult<CodeContentPlaceHolder>8\</CodeContentPlaceHolder>1*>.\<br />\<br /> The property Connection gets the database connection as an instance of \<xref:System.Data.Common.DbConnection*>.\<br />\<br /> The property DataContext gets the full data context, of type \<xref:System.Data.Objects.ObjectContext*>. This is the base type of the *EntityContainer* type generated by the type provider.|  
