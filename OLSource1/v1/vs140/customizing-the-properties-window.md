...
```  
 ...
 You can specify either your own editor, or an editor supplied in the [!INCLUDE[dnprdnshort](../vs140/includes/dnprdnshort_md.md)], such as <xref:System.Windows.Forms.Design.FileNameEditor?qualifyHint=False> or <xref:System.Drawing.Design.ImageEditor?qualifyHint=False>. For example, use the following procedure to have a property in which the user can enter a file name.  
