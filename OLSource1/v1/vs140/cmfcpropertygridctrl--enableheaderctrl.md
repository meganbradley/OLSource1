...
#### Parameters  
 ...
 <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> to enable the header control; <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> to disable the header control. The default value is <CodeContentPlaceHolder>4\</CodeContentPlaceHolder>.  
