...
## Example  
 The following example shows a type that violates the rule. No function that is named <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> occurs in kernel32.dll.  
  
 [!code[FxCop.Interoperability.DLLExists#1](../vs140/codesnippet/CSharp/ca1400--p-invoke-entry-points-should-exist_1.cs)]  
