...
---
# CProgressCtrl::SetPos
Sets the progress bar control's current position as specified by <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> and redraws the bar to reflect the new position.  
