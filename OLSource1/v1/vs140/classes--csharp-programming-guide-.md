...
## Declaring Classes  
 ...
 The <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> keyword is preceded by the access level. Because [public](../vs140/public--csharp-reference-.md) is used in this case, anyone can create objects from this class. The name of the class follows the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> keyword. The remainder of the definition is the class body, where the behavior and data are defined. Fields, properties, methods, and events on a class are collectively referred to as *class members*.  
...
## Creating Objects  
 ...
 When an instance of a class is created, a reference to the object is passed back to the programmer. In the previous example, <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> is a reference to an object that is based on <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>. This reference refers to the new object but does not contain the object data itself. In fact, you can create an object reference without creating an object at all:  
...
## Description  
 In the following example, a public class that contains a single field, a method, and a special method called a constructor is defined. For more information, see [Constructors](../vs140/constructors--csharp-programming-guide-.md). The class is then instantiated with the <CodeContentPlaceHolder>6\</CodeContentPlaceHolder> keyword.  
