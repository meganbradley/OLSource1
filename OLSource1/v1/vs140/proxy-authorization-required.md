...
-   If you want to use your default credentials with your proxy, you can do the following:  
    ...
    2.  In the configuration file, find the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> block, and add this code:  
  
<CodeContentPlaceHolder>0\</CodeContentPlaceHolder>  
         You must insert the correct proxy address for your network in <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>.  
