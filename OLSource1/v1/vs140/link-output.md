...
##  \<a name="_core_other_output">\</a> Other Output  
 When you type <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> without any other command-line input, LINK displays a usage statement that summarizes its options.  
