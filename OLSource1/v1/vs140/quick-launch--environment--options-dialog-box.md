...
|--------------|--------------|--------------------------|  
|Most recently used|@mru\<br />\<br /> For example, <CodeContentPlaceHolder>0\</CodeContentPlaceHolder>|Displays up to five of the items that you **Most Recently Used**.|  
|Menus|@menu\<br />\<br /> For example, <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>|Limits the search to menu items.|  
|Options|@opt\<br />\<br /> For example, <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>|Limits the search to settings in the **Options** dialog box.|  
|Documents|@doc\<br />\<br /> For example, <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>|Limits the search to file names and paths of open documents for the search criteria, but doesn't search the text inside the files themselves.|  
