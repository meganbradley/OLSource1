...
---
# m_stateFlags Field
Stores information about the current state of the <xref:System.Threading.Tasks.Task?qualifyHint=False> object.  
...
## Remarks  
 You typically use the <xref:System.Threading.Tasks.Task.Status?qualifyHint=True> property to access this value.  
