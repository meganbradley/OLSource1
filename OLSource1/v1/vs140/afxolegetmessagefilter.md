...
## Remarks  
 Call this function to access the current <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>-derived object, just as you would call <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> to access the current application object.  
