...
|`Save`|Saves the current user settings.|  
 ...
 The `My.Settings` object also provides advanced properties and methods, inherited from the <xref:System.Configuration.ApplicationSettingsBase?qualifyHint=False> class.  
...
## See Also  
 <xref:System.Configuration.ApplicationSettingsBase?qualifyHint=False>   
