...
## Remarks  
 For example, this exception is thrown if the <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> method of either object type is called when the object is not performing an asynchronous write operation.  
