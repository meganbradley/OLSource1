...
<CodeContentPlaceHolder>2\</CodeContentPlaceHolder>  
 The two-dimensional array named <CodeContentPlaceHolder>8\</CodeContentPlaceHolder> has 150 elements, each having **float** type.  
...
<CodeContentPlaceHolder>4\</CodeContentPlaceHolder>  
 This statement declares the type and name of an array of pointers to <CodeContentPlaceHolder>9\</CodeContentPlaceHolder>. The actual definition of <CodeContentPlaceHolder>10\</CodeContentPlaceHolder> occurs elsewhere.  
  
 **Microsoft Specific**  
  
 The type of integer required to hold the maximum size of an array is the size of **size_t**. Defined in the header file STDDEF.H, **size_t** is an <CodeContentPlaceHolder>11\</CodeContentPlaceHolder> with the range 0x00000000 to 0x7CFFFFFF.  
