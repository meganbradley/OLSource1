...
---
# Using the Task List
Use the **Task List** to track code comments that use tokens such as <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> and <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>, or custom tokens, and to manage shortcuts that will take you directly to a predefined location in the code. Click on the item in the list to go to its location in the source code.  
...
-   The comment marker (<CodeContentPlaceHolder>3\</CodeContentPlaceHolder>)  
  
-   The token, for example (<CodeContentPlaceHolder>4\</CodeContentPlaceHolder>)  
  
-   The comment (the rest of the text)  
  
<CodeContentPlaceHolder>0\</CodeContentPlaceHolder>  
 Because <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> is a predefined token,   this comment appears as a <CodeContentPlaceHolder>6\</CodeContentPlaceHolder> task in the list.  
