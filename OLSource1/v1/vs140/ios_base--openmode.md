...
## Remarks  
 The type is a <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> that describes an object that can store the opening mode for several iostreams objects. The distinct flag values (elements) are:  
