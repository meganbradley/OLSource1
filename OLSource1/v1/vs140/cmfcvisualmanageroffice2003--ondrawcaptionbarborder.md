...
#### Parameters  
 ...
 <CodeContentPlaceHolder>6\</CodeContentPlaceHolder> if the border should have a flat, 2D appearance, or <CodeContentPlaceHolder>7\</CodeContentPlaceHolder> if not.  
