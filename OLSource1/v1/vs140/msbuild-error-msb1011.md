...
1.  Include the project file name on the command line. For example, instead of typing <CodeContentPlaceHolder>0\</CodeContentPlaceHolder>, type <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>.  
