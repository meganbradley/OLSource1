...
4.  Add a constructor for this class that calls the base constructor with a <xref:Microsoft.VisualStudio.Language.Intellisense.SmartTagType?qualifyHint=False> of <xref:Microsoft.VisualStudio.Language.Intellisense.SmartTagType.Factoid?qualifyHint=False>, which will cause a blue line to appear under the first character of a word. (If you use <xref:Microsoft.VisualStudio.Language.Intellisense.SmartTagType.Ephemeral?qualifyHint=False>, a red line will appear under the last character of the word.)  
