...
2.  If you are using a custom attribute you developed, modify <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> and set the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> property to <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>.  
