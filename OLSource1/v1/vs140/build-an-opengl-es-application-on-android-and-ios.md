...
3.  Give the app a name like <CodeContentPlaceHolder>0\</CodeContentPlaceHolder>, and then choose **OK**.  
...
1.  Verify that the remote agent is running on your Mac, and that Visual Studio is paired to the remote agent. To start the remote agent, open a Terminal app window and enter <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>. For more information, see [Configure the remote agent in Visual Studio](../vs140/install-and-configure-tools-to-build-using-ios.md#ConfigureVS).  
