...
|[Average](assetId:///M:System.Linq.Enumerable.Average(System.Collections.Generic.IEnumerable{System.Decimal})?qualifyHint=False&autoUpgrade=True)|`Aggregate … In … Into Average()`<br /><br /> (For more information, see [Aggregate Clause (Visual Basic)](../vs140/aggregate-clause--visual-basic-.md).)|  
...
|[Max](assetId:///M:System.Linq.Enumerable.Max(System.Collections.Generic.IEnumerable{System.Decimal})?qualifyHint=False&autoUpgrade=True)|`Aggregate … In … Into Max()`<br /><br /> (For more information, see [Aggregate Clause (Visual Basic)](../vs140/aggregate-clause--visual-basic-.md).)|  
|[Min](assetId:///M:System.Linq.Enumerable.Min(System.Collections.Generic.IEnumerable{System.Decimal})?qualifyHint=False&autoUpgrade=True)|`Aggregate … In … Into Min()`<br /><br /> (For more information, see [Aggregate Clause (Visual Basic)](../vs140/aggregate-clause--visual-basic-.md).)|  
...
|[Sum](assetId:///M:System.Linq.Enumerable.Sum(System.Collections.Generic.IEnumerable{System.Decimal})?qualifyHint=False&autoUpgrade=True)|`Aggregate … In … Into Sum()`<br /><br /> (For more information, see [Aggregate Clause (Visual Basic)](../vs140/aggregate-clause--visual-basic-.md).)|  
