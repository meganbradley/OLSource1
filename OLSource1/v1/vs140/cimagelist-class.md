...
|Value|Meaning|  
|-----------|-------------|  
|<CodeContentPlaceHolder>66\</CodeContentPlaceHolder>|The source image is copied to the destination image's index. This operation results in multiple instances of a given image. <CodeContentPlaceHolder>67\</CodeContentPlaceHolder> is the default.|  
|<CodeContentPlaceHolder>68\</CodeContentPlaceHolder>|The source and destination images exchange positions within the image list.|  
  
 <CodeContentPlaceHolder>69\</CodeContentPlaceHolder>  
 A pointer to a <CodeContentPlaceHolder>70\</CodeContentPlaceHolder> object that is the target of the copy operation.  
  
### Return Value  
 Nonzero if successful; otherwise zero.  
  
### Example  
 [!code[NVC_MFC_CImageList#6](../vs140/codesnippet/CPP/cimagelist-class_4.cpp)]  
...
### Parameters  
 ...
 Specifies the type of image list to create. This parameter can be a combination of the following values, but it can include only one of the <CodeContentPlaceHolder>74\</CodeContentPlaceHolder> values.  
  
|Value|Meaning|  
|-----------|-------------|  
|<CodeContentPlaceHolder>75\</CodeContentPlaceHolder>|Use the default behavior if none of the other <CodeContentPlaceHolder>76\</CodeContentPlaceHolder>* flags is specified. Typically, the default is <CodeContentPlaceHolder>77\</CodeContentPlaceHolder>; but for older display drivers, the default is <CodeContentPlaceHolder>78\</CodeContentPlaceHolder>.|  
|<CodeContentPlaceHolder>79\</CodeContentPlaceHolder>|Use a 4-bit (16 color) device-independent bitmap (DIB) section as the bitmap for the image list.|  
|<CodeContentPlaceHolder>80\</CodeContentPlaceHolder>|Use an 8-bit DIB section. The colors used for the color table are the same colors as the halftone palette.|  
|<CodeContentPlaceHolder>81\</CodeContentPlaceHolder>|Use a 16-bit (32/64k color) DIB section.|  
|<CodeContentPlaceHolder>82\</CodeContentPlaceHolder>|Use a 24-bit DIB section.|  
|<CodeContentPlaceHolder>83\</CodeContentPlaceHolder>|Use a 32-bit DIB section.|  
|<CodeContentPlaceHolder>84\</CodeContentPlaceHolder>|Use a device-dependent bitmap.|  
|<CodeContentPlaceHolder>85\</CodeContentPlaceHolder>|Uses a mask. The image list contains two bitmaps, one of which is a monochrome bitmap used as a mask. If this value is not included, the image list contains only one bitmap. See [Drawing Images from an Image List](../vs140/drawing-images-from-an-image-list.md) for additional information on masked images.|  
...
### Remarks  
 ...
 If <CodeContentPlaceHolder>113\</CodeContentPlaceHolder> is **NULL**, this function draws the image in the display context associated with the desktop window, and coordinates are relative to the upper left corner of the screen.  
