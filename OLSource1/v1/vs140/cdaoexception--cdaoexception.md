...
4.  Examine the current [CDaoErrorInfo](../vs140/cdaoerrorinfo-structure.md) structure that <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> returns in the [m_pErrorInfo](../vs140/cdaoexception--m_perrorinfo.md) data member. Its members provide information on the DAO error.  
