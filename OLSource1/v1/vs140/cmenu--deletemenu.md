...
#### Parameters  
 ...
 Specifies the menu item that is to be deleted, as determined by <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>.  
  
 <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>  
 Is used to interpret <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> in the following way:  
...
## Remarks  
 If the menu item has an associated pop-up menu, <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> destroys the handle to the pop-up menu and frees the memory used by the pop-up menu.  
