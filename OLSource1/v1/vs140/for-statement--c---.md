...
```  
 ...
 By default, under [/Ze](../vs140/-za---ze--disable-language-extensions-.md), a variable declared in a `for` loop remains in scope until the `for` loop's enclosing scope ends.  
