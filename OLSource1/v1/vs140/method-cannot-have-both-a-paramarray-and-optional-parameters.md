...
A <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> argument is automatically optional, and it must be the only optional argument in the procedure declaration. All preceding arguments must be required.  
