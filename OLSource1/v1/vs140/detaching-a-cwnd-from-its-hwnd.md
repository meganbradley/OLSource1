...
If you need to circumvent the object-<CodeContentPlaceHolder>0\</CodeContentPlaceHolder> relationship, MFC provides another <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> member function, [Detach](../vs140/cwnd--detach.md), which disconnects the C++ window object from the Windows window. This prevents the destructor from destroying the Windows window when the object is destroyed.  
