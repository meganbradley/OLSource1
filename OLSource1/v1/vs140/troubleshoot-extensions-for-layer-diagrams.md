...
3.  Regular breakpoints might not work in a validation method, because it runs in a separate process. You must insert a call to <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> if you want to step through your method.  
