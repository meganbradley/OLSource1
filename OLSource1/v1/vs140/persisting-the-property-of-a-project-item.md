...
3.  Use a breakpoint or otherwise determine that your VSPackage is loaded and that SetItemAttribute runs.  
    ...
    > [!NOTE]
    >  You can autoload a VSPackage in the UI context <xref:Microsoft.VisualStudio.VSConstants.UICONTEXT_SolutionExists?qualifyHint=False>. For more information, see [How to: Autoload a VSPackage](../vs140/loading-vspackages.md).  
