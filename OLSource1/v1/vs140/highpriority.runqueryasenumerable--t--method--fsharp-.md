...
#### Parameters  
 `expr`  
 Type: [Expr](../vs140/quotations.expr--t--class--fsharp-.md)<[QuerySource](../vs140/linq.querysource--t--q--class--fsharp-.md)<'T,                        <xref:System.Collections.IEnumerable?qualifyHint=False>>>  
...
## See Also  
 ...
 [QueryRunExtensions.HighPriority Module (F#)](../vs140/queryrunextensions.highpriority-module--fsharp-.md)