...
This operator is used to perform division on a <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> object and assign it the result.  
...
## Return Value  
 Returns the updated <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> object. If the divisor is 0, an assert failure will occur.  
