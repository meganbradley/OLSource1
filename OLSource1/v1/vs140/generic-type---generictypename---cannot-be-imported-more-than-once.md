...
1.  If the source file containing this <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> statement also contains another <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> statement specifying the same generic type, remove one of them.  
