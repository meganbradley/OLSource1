...
Creates a new schedule group within the scheduler. The version that takes the parameter <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> causes tasks within the newly created schedule group to be biased towards executing at the location specified by that parameter.  
