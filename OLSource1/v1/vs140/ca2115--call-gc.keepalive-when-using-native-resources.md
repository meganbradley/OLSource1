...
## Cause  
 A method declared in a type with a finalizer references a <xref:System.IntPtr*?displayProperty=fullName> or <xref:System.UIntPtr*?displayProperty=fullName> field, but does not call [GC.KeepAlive](assetId:///M:System.GC.KeepAlive(System.Object)?qualifyHint=True&autoUpgrade=True).  
...
## How to Fix Violations  
 To fix a violation of this rule, add a call to [KeepAlive](assetId:///M:System.GC.KeepAlive(System.Object)?qualifyHint=False&autoUpgrade=True) to the method, passing the current instance (`this` in C# and C++) as the argument. Position the call after the last line of code where the object must be protected from garbage collection. Immediately after the call to assetId:///M:System.GC.KeepAlive(System.Object)?qualifyHint=False&autoUpgrade=True, the object is again considered ready for garbage collection assuming that there are no managed references to it.  
...
>  This example is pseudo-code Although the code compiles and runs, the warning is not fired because an unmanaged resource is not created or freed.  
 ...
 [!code[FxCop.Security.IntptrAndFinalize#1](../vs140/codesnippet/CSharp/ca2115--call-gc.keepalive-when-using-native-resources_1.cs)]  
  
## See Also  
 assetId:///M:System.GC.KeepAlive(System.Object)?qualifyHint=True&autoUpgrade=True   
