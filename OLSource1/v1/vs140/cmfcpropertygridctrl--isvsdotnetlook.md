...
## Return Value  
 <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> if the property grid control is in the style of [!INCLUDE[vsprvslong](../vs140/includes/vsprvslong_md.md)]; otherwise, <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>.  
