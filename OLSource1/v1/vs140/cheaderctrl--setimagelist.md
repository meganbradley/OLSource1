...
#### Parameters  
 ...
 A pointer to a <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> object containing the image list to be assigned to the header control.  
  
## Return Value  
 A pointer to the [CImageList](../vs140/cimagelist-class.md) object previously assigned to the header control.  
  
## Remarks  
 This member function implements the behavior of the Win32 message [HDM_SETIMAGELIST](http://msdn.microsoft.com/library/windows/desktop/bb775365), as described in the [!INCLUDE[winSDK](../vs140/includes/winsdk_md.md)]. The <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> object to which the returned pointer points is a temporary object and is deleted in the next idle-time processing.  
