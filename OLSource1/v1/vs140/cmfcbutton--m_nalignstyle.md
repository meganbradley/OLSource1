...
## Remarks  
 Use one of the following <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> enumeration values to specify the alignment of the button text:  
...
|ALIGN_RIGHT|Aligns the button text to the right side of the button.|  
 ...
 The <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> constructor initializes this member to ALIGN_CENTER.  
