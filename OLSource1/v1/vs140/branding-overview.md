...
-   Implement \<xref:Microsoft.VisualStudio.Shell.Interop.IVsInstalledProduct*>.  
 ...
 The Visual Studio Library provides the <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> template class to create an implementation of \<xref:Microsoft.VisualStudio.Shell.Interop.IVsInstalledProduct*>. For more information, see [How To: Advertise a VSPackage (C++)](../vs140/how-to--brand-a-vspackage--c---.md).  
