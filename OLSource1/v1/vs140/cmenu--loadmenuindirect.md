...
---
# CMenu::LoadMenuIndirect
Loads a resource from a menu template in memory and attaches it to the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> object.  
...
## Remarks  
 ...
 The **mtOption** flags should include **MF_END** for the last item in a pop-up list and for the last item in the main list. See the <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> member function for other flags. The **mtId** member must be omitted from the **MENUITEMTEMPLATE** structure when **MF_POPUP** is specified in **mtOption**.  
...
## Example  
 [!code[NVC_MFCWindowing#30](../vs140/codesnippet/CPP/cmenu--loadmenuindirect_1.cpp)]  
