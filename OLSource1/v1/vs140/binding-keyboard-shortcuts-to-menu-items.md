...
2.  Create an empty <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> section after the <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> if it is not already present.  
  
    > [!WARNING]
    >  For more information about key bindings, see [Keybinding](../vs140/keybinding-element.md).  
  
     In the <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> section, create a <CodeContentPlaceHolder>6\</CodeContentPlaceHolder> entry.  
  
     Set the <CodeContentPlaceHolder>7\</CodeContentPlaceHolder>  and  <CodeContentPlaceHolder>8\</CodeContentPlaceHolder> attributes to those of the command you want to invoke.  
  
     Set the <CodeContentPlaceHolder>9\</CodeContentPlaceHolder> attribute to **Control**, **Alt**, or **Shift**.  
  
     The KeyBindings section should look something like this:  
  
<CodeContentPlaceHolder>0\</CodeContentPlaceHolder>  
 If your keyboard shortcut requires more than two keys, set the <CodeContentPlaceHolder>10\</CodeContentPlaceHolder> and <CodeContentPlaceHolder>11\</CodeContentPlaceHolder> attributes.  
 ...
 To make the command available in the Visual Studio editor, set the <CodeContentPlaceHolder>12\</CodeContentPlaceHolder> attribute to <CodeContentPlaceHolder>13\</CodeContentPlaceHolder>.  
  
 To make the command available only in a custom editor, set the <CodeContentPlaceHolder>14\</CodeContentPlaceHolder> attribute to the name of the custom editor that was generated by the [!INCLUDE[vsprvs](../vs140/includes/vsprvs_md.md)] Package Template when you created the VSPackage that includes the custom editor. To find the name value, look in the <CodeContentPlaceHolder>15\</CodeContentPlaceHolder> section for a <CodeContentPlaceHolder>16\</CodeContentPlaceHolder> node whose <CodeContentPlaceHolder>17\</CodeContentPlaceHolder> attribute ends in "<CodeContentPlaceHolder>18\</CodeContentPlaceHolder>." This is the name of the custom editor.  
  
## Example  
 This example binds the keyboard shortcut CTRL+ALT+C to a command named <CodeContentPlaceHolder>19\</CodeContentPlaceHolder> in a package named <CodeContentPlaceHolder>20\</CodeContentPlaceHolder>.  
  
<CodeContentPlaceHolder>1\</CodeContentPlaceHolder>  
## Example  
 This example binds the keyboard shortcut CTL+B to a command named <CodeContentPlaceHolder>21\</CodeContentPlaceHolder> in a project named <CodeContentPlaceHolder>22\</CodeContentPlaceHolder>. The command is available only in the custom editor and not in other editors.  
