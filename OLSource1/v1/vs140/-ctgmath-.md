...
## Remarks  
 ...
 Including this header ensures that the names declared using external linkage in the Standard C library header are declared in the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> namespace.  
