...
## Remarks  
 ...
 If an attribute pertains not only to the following element but to the entire assembly, you place the attribute block at the beginning of the source file and identify the attribute with the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> keyword. If it applies to the current assembly module, you use the [Module](../vs140/module--keyword---visual-basic-.md) keyword.  
