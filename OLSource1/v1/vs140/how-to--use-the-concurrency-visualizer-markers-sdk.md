...
5.  Add code to create customer marker series by using the static [M:Microsoft.ConcurrencyVisualizer.Instrumentation.Markers.CreateMarkerSeries(System.String)](assetId:///M:Microsoft.ConcurrencyVisualizer.Instrumentation.Markers.CreateMarkerSeries(System.String)?qualifyHint=False&autoUpgrade=True) method. The <xref:Microsoft.ConcurrencyVisualizer.Instrumentation.MarkerSeries*> class contains methods for creating spans and writing flags, messages, and alerts.  
