...
-   IntelliSense  
 ...
 For more information about editor extension points, see [Editor Extension Points](../vs140/language-service-and-editor-extension-points.md).  
...
-   [Walkthrough: How to Use a Shell Command to Add an Adornment](../vs140/walkthrough--using-a-shell-command-with-an-editor-extension.md)  
  
-   [Walkthrough: How to Use an Access Key to Add an Adornment](../vs140/walkthrough--using-a-shortcut-key-with-an-editor-extension.md)  
