...
2.  Copy the XML Schema sample code from [Purchase Order Schema](../vs140/sample-xsd-file--simple-schema.md) and paste it to replace the code that was added to the new XSD file by default.  
