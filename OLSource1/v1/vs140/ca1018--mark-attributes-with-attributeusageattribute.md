...
## Rule Description  
 ...
 The \<xref:System.AttributeTargets*?displayProperty=fullName> enumeration defines the targets that you can specify for a custom attribute. If you omit \<xref:System.AttributeUsageAttribute*>, your custom attribute will be valid for all targets, as defined by the <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> value of \<xref:System.AttributeTargets*> enumeration.  
...
## Example  
 The following example defines two attributes. <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> incorrectly omits the \<xref:System.AttributeUsageAttribute*> statement, and <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> correctly implements the attribute that is described earlier in this section. Note that the property <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> is required by the design rule [Define accessors for attribute arguments](../vs140/ca1019--define-accessors-for-attribute-arguments.md) and is included for completeness.  
