 ...
 **Short name**  
 Sets the root name for the object. The name that you provide determines the <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> and **Coclass** names, the **.cpp file** and **.h file** names, the **Interface** name, the **Type** names, and the **ProgID**, unless you change those fields individually.  
