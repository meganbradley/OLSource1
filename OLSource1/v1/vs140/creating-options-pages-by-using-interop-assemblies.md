...
## Making Tools Options Pages Available to the IDE  
 ...
 This is done through the implementation of the [GetPropertyPage](assetId:///M:Microsoft.VisualStudio.Shell.Interop.IVsPackage.GetPropertyPage(System.Guid@,Microsoft.VisualStudio.Shell.Interop.VSPROPSHEETPAGE[])?qualifyHint=False&autoUpgrade=True) method, which returns a <xref:Microsoft.VisualStudio.Shell.Interop.VSPROPSHEETPAGE*> structure based on the GUID passed.  
