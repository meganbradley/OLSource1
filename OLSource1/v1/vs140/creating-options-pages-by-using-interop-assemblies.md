...
Managed VSPackages can use the COM-based interop assemblies of the [!INCLUDE[vsipsdk](../vs140/includes/vsipsdk_md.md)] to extend the [!INCLUDE[vsprvs](../vs140/includes/vsprvs_md.md)] integrated development environment (IDE) by adding **Options** pages to the **Tools** menu.  
...
>  A **Tools Options** page implemented as a dialog box, using a DialogProc to handle windows messages, must be a modeless dialog box, and must not call the EndDialog function.  
 ...
 A VSPackage that implements a **Tools Options** page can support programmatic control of its properties directly or through the IDE's automation model. For more information on supporting **Tools Options** pages with automation, see [Creating Tools Options Pages with Automation](../vs140/creating-options-pages-by-using-automation.md).  
...
## Making Tools Options Pages Available to the IDE  
 ...
 The settings contained in its <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> member determine the exact interpretation of the other members of \<xref:Microsoft.VisualStudio.Shell.Interop.VSPROPSHEETPAGE*>. The structure typically provides:  
...
## See Also  
 ...
 [Tools Options Pages Support](../vs140/automation-support-for-options-pages.md)   
