...
##  <a name="OnAssociatedProperty"></a> Use AssociateValueWith() to update other features of a shape  
 ...
 Instead, you can update such features by using [M:Microsoft.VisualStudio.Modeling.Diagrams.ShapeElement.OnAssociatedPropertyChanged(Microsoft.VisualStudio.Modeling.Diagrams.PropertyChangedEventArgs)](assetId:///M:Microsoft.VisualStudio.Modeling.Diagrams.ShapeElement.OnAssociatedPropertyChanged(Microsoft.VisualStudio.Modeling.Diagrams.PropertyChangedEventArgs)?qualifyHint=False&autoUpgrade=True). In the following example, the arrow style of a connector is controlled by a value of a domain property in the relationship that the connector displays:  
