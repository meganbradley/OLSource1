...
#### Parameters  
 ...
 Alpha value used to describe the opacity of the layered window. For more information, see the **SourceConstantAlpha** member of the [BLENDFUNCTION](http://msdn.microsoft.com/library/windows/desktop/dd183393) structure. When <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> is 0, the window is completely transparent. When <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> is 255, the window is opaque.  
