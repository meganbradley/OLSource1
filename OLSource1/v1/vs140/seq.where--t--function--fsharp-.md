...
## Remarks  
 The returned sequence may be passed between threads safely. However, individual <xref:System.Collections.Generic.IEnumerator<CodeContentPlaceHolder>4\</CodeContentPlaceHolder>Where` in the .NET assembly. If accessing the member from a .NET language other than F#, or through reflection, use this name.  
