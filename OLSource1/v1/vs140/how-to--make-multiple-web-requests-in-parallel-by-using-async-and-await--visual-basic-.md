...
4.  Finally, define method `CreateMultipleTasksAsync`, which performs the following steps.  
    ...
    -   The method declares an `HttpClient` object,which you need  to access method [GetByteArrayAsync](assetId:///M:System.Net.Http.HttpClient.GetByteArrayAsync(System.String)?qualifyHint=False&autoUpgrade=True) in `ProcessURLAsync`.  
