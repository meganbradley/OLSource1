...
The [UploadFile](assetId:///M:Microsoft.VisualBasic.Devices.Network.UploadFile(System.String,System.Uri)?qualifyHint=False&autoUpgrade=True) method can be used to upload a file and store it to a remote location. If the `ShowUI` parameter is set to `True`, a dialog box is displayed that shows the progress of the download and allows users to cancel the operation.  
...
## See Also  
 ...
 assetId:///M:Microsoft.VisualBasic.Devices.Network.UploadFile(System.String,System.Uri)?qualifyHint=False&autoUpgrade=True   
