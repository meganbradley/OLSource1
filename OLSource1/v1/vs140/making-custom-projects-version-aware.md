...
## Allowing Projects to Load in Multiple Versions  
 ...
 Before a project is loaded, Visual Studio calls the [UpgradeProject_CheckOnly](assetId:///M:Microsoft.VisualStudio.Shell.Interop.IVsProjectUpgradeViaFactory4.UpgradeProject_CheckOnly(System.String,Microsoft.VisualStudio.Shell.Interop.IVsUpgradeLogger,System.UInt32@,System.Guid@,System.UInt32@)?qualifyHint=False&autoUpgrade=True) method to determine whether the project can be upgraded. If the project can be upgraded, the `UpgradeProject_CheckOnly` method sets a flag that causes a later call to the [UpgradeProject](assetId:///M:Microsoft.VisualStudio.Shell.Interop.IVsProjectUpgradeViaFactory.UpgradeProject(System.String,System.UInt32,System.String,System.String@,Microsoft.VisualStudio.Shell.Interop.IVsUpgradeLogger,System.Int32@,System.Guid@)?qualifyHint=False&autoUpgrade=True) method to upgrade the project. Because incompatible projects can’t be upgraded, `UpgradeProject_CheckOnly` must first check for project compatibility, as described in the earlier section.  
...
4.  In your component, call the `IVsAppCompat.BreakAssetCompatibility` method for each project that you want to mark as incompatible. The component can set the value of the parameter `lpszMinimumVersion` to a specific minimum version instead of having Visual Studio look up the current version string in the registry. This approach minimizes the risk of the component inadvertently setting a higher value in the future, based on what is in the registry at that time. If that higher value were set, Visual Studio couldn't open the project.  
    ...
    ```  
     ...
     For more information, see [SetProperty](assetId:///M:Microsoft.VisualStudio.Shell.Interop.IVsHierarchy.SetProperty(System.UInt32,System.Int32,System.Object)?qualifyHint=False&autoUpgrade=True).  
...
## Detecting Whether a Project is Incompatible  
 ...
 To enable the detection of project incompatibility, you must implement the assetId:///M:Microsoft.VisualStudio.Shell.Interop.IVsProjectUpgradeViaFactory4.UpgradeProject_CheckOnly(System.String,Microsoft.VisualStudio.Shell.Interop.IVsUpgradeLogger,System.UInt32@,System.Guid@,System.UInt32@)?qualifyHint=False&autoUpgrade=True and [CreateProject](assetId:///M:Microsoft.VisualStudio.Shell.Interop.IVsProjectFactory.CreateProject(System.String,System.String,System.String,System.UInt32,System.Guid@,System.IntPtr@,System.Int32@)?qualifyHint=False&autoUpgrade=True) methods. If a project is incompatible, `UpgradeProject_CheckOnly` must return the success code `VS_S_INCOMPATIBLEPROJECT`, and `CreateProject` must return the error code `VS_E_INCOMPATIBLEPROJECT`. For flavored projects, you must implement `IVsProjectFlavorUpgradeViaFactory2.UpgradeProjectFlavor_CheckOnly` instead of `IVsProjectUpgradeViaFactory4.UpgradeProject_CheckOnly`.  
