...
6.  Click the **Find Next** button until the text is selected in the <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> section of a [Button Element](../vs140/button-element.md).  
  
     The <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> element that the command appears in is the command definition.  
  
 When you have found the command definition, you can put a copy of the command on another menu or toolbar by creating a [CommandPlacement Element](../vs140/commandplacement-element.md) that has the same <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> and <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> values as the command. For more information, see [How to: Create Reusable Groups of Buttons](../vs140/creating-reusable-groups-of-buttons.md).  
