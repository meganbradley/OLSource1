...
The F# compiler emits calls to this function to implement the compiler-intrinsic conversions from weakly typed <xref:System.Collections.IEnumerable?qualifyHint=False> sequences to typed sequences.  
