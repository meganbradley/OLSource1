...
metadata operation failed (HRESULT) : error  
 ...
 <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> is the HRESULT from the .NET runtime method. <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> is the .NET-supplied text.  
