...
## Return Value  
 <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> if the control is enabled, <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> if it is not.  
...
## Remarks  
 ...
 If <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> is not a valid identifier for either a common <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> button or a command button control, this method throws an exception.  
