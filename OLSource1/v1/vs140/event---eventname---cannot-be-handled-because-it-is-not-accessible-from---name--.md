...
You attempted to handle an event that is not accessible. For example, if a <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> variable is shared, the method handling the events must also be shared.  
