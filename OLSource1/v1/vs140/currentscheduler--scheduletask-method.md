...
Schedules a light-weight task within the scheduler associated with the calling context. The light-weight task will be placed in a schedule group determined by the runtime. The version that takes the parameter <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> causes the task to be biased towards executing at the specified location.  
