...
---
# SccCheckout Function
Given a list of fully qualified file names, this function checks them out to the local drive. The comment applies to all files being checked out. The comment argument can be a <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> string.  
