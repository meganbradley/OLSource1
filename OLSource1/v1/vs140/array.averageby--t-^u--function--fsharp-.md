...
|Exception|Condition|  
|---------------|---------------|  
|\<xref:System.ArgumentException*>|Thrown when <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> is empty.|  
...
## Example  
 The following example illustrates the use of <CodeContentPlaceHolder>7\</CodeContentPlaceHolder>.  
