...
---
# CAdapt::operator =
The assignment operator assigns the argument, <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>, to the data member [m_T](../vs140/cadapt--m_t.md) and returns the current adapter object.  
