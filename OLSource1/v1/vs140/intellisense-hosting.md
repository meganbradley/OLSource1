...
#### IVsIntellisenseHost.GetHostFlags  
 An <xref:Microsoft.VisualStudio.TextManager.Interop.IVsIntellisenseHost*> interface provider must implement the [GetHostFlags](assetId:///M:Microsoft.VisualStudio.TextManager.Interop.IVsIntellisenseHost.GetHostFlags(System.UInt32@)?qualifyHint=False&autoUpgrade=True) method to enable a client to determine what type of IntelliSense features the host supports.  
