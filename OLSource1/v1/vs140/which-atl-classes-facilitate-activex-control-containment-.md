...
|[CWindow](../vs140/cwindow-class.md)|Provides a method, [GetDlgControl](../vs140/cwindow--getdlgcontrol.md), that will return an interface pointer on a control, given the ID of its host window. In addition, the Windows API wrappers exposed by <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> generally make window management easier.|  
