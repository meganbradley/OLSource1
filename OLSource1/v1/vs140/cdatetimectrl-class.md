...
|Name|Description|  
|----------|-----------------|  
|[CDateTimeCtrl::CDateTimeCtrl](#cdatetimectrl__cdatetimectrl)|Constructs a <CodeContentPlaceHolder>18\</CodeContentPlaceHolder> object.|  
...
|[CDateTimeCtrl::Create](#cdatetimectrl__create)|Creates the date and time picker control and attaches it to the <CodeContentPlaceHolder>19\</CodeContentPlaceHolder> object.|  
...
|[CDateTimeCtrl::GetMonthCalCtrl](#cdatetimectrl__getmonthcalctrl)|Retrieves the <CodeContentPlaceHolder>20\</CodeContentPlaceHolder> object associated with the date and time picker control.|  
...
|[CDateTimeCtrl::GetTime](#cdatetimectrl__gettime)|Retrieves the currently selected time from a date and time picker control and puts it in a specified <CodeContentPlaceHolder>21\</CodeContentPlaceHolder> structure.|  
...
### Example  
 The following code example defines the variable, <CodeContentPlaceHolder>24\</CodeContentPlaceHolder>, that is used to programmatically access the date and time picker control. This variable is used in the next example.  
  
 [!code[NVC_MFC_CDateTimeCtrl_s1#1](../vs140/codesnippet/CPP/cdatetimectrl-class_1.h)]  
  
### Example  
 The following code example closes the drop-down calendar for the current date and time picker control.  
  
 [!code[NVC_MFC_CDateTimeCtrl_s1#5](../vs140/codesnippet/CPP/cdatetimectrl-class_2.cpp)]  
  
##  \<a name="cdatetimectrl__create">\</a>  CDateTimeCtrl::Create  
 Creates the date and time picker control and attaches it to the <CodeContentPlaceHolder>25\</CodeContentPlaceHolder> object.  
...
1.  Call [CDateTimeCtrl](#cdatetimectrl__cdatetimectrl) to construct a <CodeContentPlaceHolder>30\</CodeContentPlaceHolder> object.  
  
2.  Call this member function, which creates the Windows date and time picker control and attaches it to the <CodeContentPlaceHolder>31\</CodeContentPlaceHolder> object.  
  
 When you call **Create**, the common controls are initialized.  
  
### Example  
 [!code[NVC_MFC_CDateTimeCtrl#1](../vs140/codesnippet/CPP/cdatetimectrl-class_3.cpp)]  
...
|---------------|-----------------|  
|[out] <CodeContentPlaceHolder>32\</CodeContentPlaceHolder>|A pointer to a                                         [DATETIMEPICKERINFO](http://msdn.microsoft.com/library/windows/desktop/bb761729) structure that receives a description of the current date and time picker control.\<br />\<br /> The caller is responsible for allocating this structure. However, this method initializes the <CodeContentPlaceHolder>33\</CodeContentPlaceHolder> member of the structure.|  
  
### Return Value  
 <CodeContentPlaceHolder>34\</CodeContentPlaceHolder> if this method is successful; otherwise, <CodeContentPlaceHolder>35\</CodeContentPlaceHolder>.  
...
### Example  
 The following code example defines the variable, <CodeContentPlaceHolder>36\</CodeContentPlaceHolder>, that is used to programmatically access the date and time picker control. This variable is used in the next example.  
...
### Example  
 ...
 [!code[NVC_MFC_CDateTimeCtrl_s1#4](../vs140/codesnippet/CPP/cdatetimectrl-class_4.cpp)]  
...
### Parameters  
 ...
 An <CodeContentPlaceHolder>38\</CodeContentPlaceHolder> value specifying which color area of the month calendar to retrieve. For a list of values, see the <CodeContentPlaceHolder>39\</CodeContentPlaceHolder> parameter for [SetMonthCalColor](#cdatetimectrl__setmonthcalcolor).  
...
### Example  
 [!code[NVC_MFC_CDateTimeCtrl#2](../vs140/codesnippet/CPP/cdatetimectrl-class_5.cpp)]  
  
##  \<a name="cdatetimectrl__getmonthcalctrl">\</a>  CDateTimeCtrl::GetMonthCalCtrl  
 Retrieves the <CodeContentPlaceHolder>40\</CodeContentPlaceHolder> object associated with the date and time picker control.  
...
### Remarks  
 Date and time picker controls create a child month calendar control when the user clicks the drop-down arrow. When the <CodeContentPlaceHolder>41\</CodeContentPlaceHolder> object is no longer needed, it is destroyed, so your application must not rely on storing the object representing the date time picker control's child month calendar.  
  
### Example  
 [!code[NVC_MFC_CDateTimeCtrl#3](../vs140/codesnippet/CPP/cdatetimectrl-class_6.cpp)]  
...
### Remarks  
 The <CodeContentPlaceHolder>42\</CodeContentPlaceHolder> object pointed to by the return value is a temporary object and is destroyed during the next idle processing time.  
...
### Parameters  
 ...
 A pointer to a [COleDateTime](../vs140/coledatetime-class.md) object or a [CTime](../vs140/ctime-class.md) object containing the earliest time allowed in the <CodeContentPlaceHolder>44\</CodeContentPlaceHolder> object.  
  
 <CodeContentPlaceHolder>45\</CodeContentPlaceHolder>  
 A pointer to a <CodeContentPlaceHolder>46\</CodeContentPlaceHolder> object or a <CodeContentPlaceHolder>47\</CodeContentPlaceHolder> object containing the latest time allowed in the <CodeContentPlaceHolder>48\</CodeContentPlaceHolder> object.  
  
### Return Value  
 A <CodeContentPlaceHolder>49\</CodeContentPlaceHolder> value containing flags that indicate which ranges are set. If  
  
 <CodeContentPlaceHolder>50\</CodeContentPlaceHolder> == 0  
  
 then the second parameter is valid. Similarly, if  
  
 <CodeContentPlaceHolder>51\</CodeContentPlaceHolder> == 0  
  
 then the first parameter is valid.  
  
### Remarks  
 This member function implements the behavior of the Win32 message                         [DTM_GETRANGE](http://msdn.microsoft.com/library/windows/desktop/bb761767), as described in the [!INCLUDE[winSDK](../vs140/includes/winsdk_md.md)]. In MFC's implementation, you can specify either <CodeContentPlaceHolder>52\</CodeContentPlaceHolder> or <CodeContentPlaceHolder>53\</CodeContentPlaceHolder> usages.  
  
### Example  
 [!code[NVC_MFC_CDateTimeCtrl#4](../vs140/codesnippet/CPP/cdatetimectrl-class_7.cpp)]  
  
##  \<a name="cdatetimectrl__gettime">\</a>  CDateTimeCtrl::GetTime  
 Retrieves the currently selected time from a date and time picker control and puts it in a specified <CodeContentPlaceHolder>54\</CodeContentPlaceHolder> structure.  
...
### Return Value  
 In the first version, nonzero if the time is successfully written to the <CodeContentPlaceHolder>55\</CodeContentPlaceHolder> object; otherwise 0. In the second and third versions, a <CodeContentPlaceHolder>56\</CodeContentPlaceHolder> value equal to the **dwFlag** member set in the                         [NMDATETIMECHANGE](http://msdn.microsoft.com/library/windows/desktop/bb761730) structure. See the **Remarks** section below for more information.  
  
### Remarks  
 This member function implements the behavior of the Win32 message                         [DTM_GETSYSTEMTIME](http://msdn.microsoft.com/library/windows/desktop/bb761769), as described in the [!INCLUDE[winSDK](../vs140/includes/winsdk_md.md)]. In the MFC implementation of **GetTime**, you can use <CodeContentPlaceHolder>57\</CodeContentPlaceHolder> or <CodeContentPlaceHolder>58\</CodeContentPlaceHolder> classes, or you can use a <CodeContentPlaceHolder>59\</CodeContentPlaceHolder> structure, to store the time information.  
  
 The return value <CodeContentPlaceHolder>60\</CodeContentPlaceHolder> in the second and third versions, above, indicates whether or not the date and time picker control is set to the "no date" status, as indicated in the                         [NMDATETIMECHANGE](http://msdn.microsoft.com/library/windows/desktop/bb761730) structure member <CodeContentPlaceHolder>61\</CodeContentPlaceHolder>. If the value returned equals **GDT_NONE**, the control is set to "no date" status, and uses the **DTS_SHOWNONE** style. If the value returned equals **GDT_VALID**, the system time is successfully stored in the destination location.  
  
### Example  
 [!code[NVC_MFC_CDateTimeCtrl#5](../vs140/codesnippet/CPP/cdatetimectrl-class_8.cpp)]  
...
|Parameter|Description|  
|---------------|-----------------|  
|[out] <CodeContentPlaceHolder>62\</CodeContentPlaceHolder>|Pointer to a                                         [SIZE](http://msdn.microsoft.com/library/windows/desktop/dd145106) structure that contains the ideal size for the control.|  
  
### Return Value  
 The return value is always <CodeContentPlaceHolder>63\</CodeContentPlaceHolder>.  
...
### Example  
 The following code example defines the variable, <CodeContentPlaceHolder>64\</CodeContentPlaceHolder>, that is used to programmatically access the date and time picker control. This variable is used in the next example.  
...
### Example  
 ...
 [!code[NVC_MFC_CDateTimeCtrl_s1#2](../vs140/codesnippet/CPP/cdatetimectrl-class_9.cpp)]  
...
### Example  
 [!code[NVC_MFC_CDateTimeCtrl#6](../vs140/codesnippet/CPP/cdatetimectrl-class_10.cpp)]  
...
### Parameters  
 ...
 <CodeContentPlaceHolder>66\</CodeContentPlaceHolder> value specifying which area of the month calendar control to set. This value can be one of the following.  
...
### Example  
 [!code[NVC_MFC_CDateTimeCtrl#7](../vs140/codesnippet/CPP/cdatetimectrl-class_11.cpp)]  
  
> [!NOTE]
>  If you use this code, you'll want to make a member of your <CodeContentPlaceHolder>70\</CodeContentPlaceHolder>-derived class called <CodeContentPlaceHolder>71\</CodeContentPlaceHolder> of type **CFont**.  
...
|Parameter|Description|  
|---------------|-----------------|  
|[in] <CodeContentPlaceHolder>72\</CodeContentPlaceHolder>|A new month calendar control style, which is a bitwise combination (OR) of month calendar control styles. For more information, see                                         [Month Calendar Control Styles](http://msdn.microsoft.com/library/windows/desktop/bb760919).|  
...
### Example  
 The following code example defines the variable, <CodeContentPlaceHolder>73\</CodeContentPlaceHolder>, that is used to programmatically access the date and time picker control. This variable is used in the next example.  
...
### Example  
 ...
 [!code[NVC_MFC_CDateTimeCtrl_s1#3](../vs140/codesnippet/CPP/cdatetimectrl-class_12.cpp)]  
...
### Parameters  
 ...
 A pointer to a [COleDateTime](../vs140/coledatetime-class.md) object or a [CTime](../vs140/ctime-class.md) object containing the earliest time allowed in the <CodeContentPlaceHolder>75\</CodeContentPlaceHolder> object.  
  
 <CodeContentPlaceHolder>76\</CodeContentPlaceHolder>  
 A pointer to a <CodeContentPlaceHolder>77\</CodeContentPlaceHolder> object or a <CodeContentPlaceHolder>78\</CodeContentPlaceHolder> object containing the latest time allowed in the <CodeContentPlaceHolder>79\</CodeContentPlaceHolder> object.  
  
### Return Value  
 Nonzero if successful; otherwise 0.  
  
### Remarks  
 This member function implements the behavior of the Win32 message                         [DTM_SETRANGE](http://msdn.microsoft.com/library/windows/desktop/bb761780), as described in the [!INCLUDE[winSDK](../vs140/includes/winsdk_md.md)]. In MFC's implementation, you can specify either <CodeContentPlaceHolder>80\</CodeContentPlaceHolder> or <CodeContentPlaceHolder>81\</CodeContentPlaceHolder> usages. If the <CodeContentPlaceHolder>82\</CodeContentPlaceHolder> object has a **NULL** status, the range will be removed. If the <CodeContentPlaceHolder>83\</CodeContentPlaceHolder> pointer or the <CodeContentPlaceHolder>84\</CodeContentPlaceHolder> pointer is **NULL**, the range will be removed.  
...
### Remarks  
 This member function implements the behavior of the Win32 message                         [DTM_SETSYSTEMTIME](http://msdn.microsoft.com/library/windows/desktop/bb761782), as described in the [!INCLUDE[winSDK](../vs140/includes/winsdk_md.md)]. In the MFC implementation of **SetTime**, you can use the <CodeContentPlaceHolder>85\</CodeContentPlaceHolder> or <CodeContentPlaceHolder>86\</CodeContentPlaceHolder> classes, or you can use a <CodeContentPlaceHolder>87\</CodeContentPlaceHolder> structure, to set the time information.  
  
### Example  
 [!code[NVC_MFC_CDateTimeCtrl#8](../vs140/codesnippet/CPP/cdatetimectrl-class_13.cpp)]  
