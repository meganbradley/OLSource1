...
You can extend Visual Studio by creating VSPackages. These are the software modules that Visual Studio itself is made of. Tool windows, editors, services, and project types all are VSPackages. The Visual Studio SDK lets you create your own VSPackages.  
 ...
 The walkthroughs in this section teach how to create VSPackages, give them functionality, integrate them into Visual Studio, and distribute them to other users. For more information about VSPackages and what they can do, see the [Visual Studio Integration SDK Roadmap](../vs140/inside-the-visual-studio-sdk.md).  
  
## In This Section  
 [How to Create a VSPackage](../vs140/creating-an-extension-with-a-menu-command.md)  
 ...
 [How to Create a Tool Window](../vs140/adding-a-tool-window.md)  
 ...
 [Tutorial 4: How to Integrate into the Properties Window, Task List, Output Window, and Options Dialog](../vs140/extending-the-properties--task-list--output--and-options-windows.md)  
...
## Related Sections  
 [Introducing the Visual Studio SDK](../Topic/Introducing%20the%20Visual%20Studio%20SDK_deleted.md)  
 ...
 [Visual Studio Integration SDK Roadmap](../vs140/inside-the-visual-studio-sdk.md)  
