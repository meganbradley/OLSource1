...
#### Parameters  
 ...
 A pointer to the length of the address in <CodeContentPlaceHolder>6\</CodeContentPlaceHolder> in bytes.  
...
-   **WSAEFAULT** The <CodeContentPlaceHolder>7\</CodeContentPlaceHolder> argument is not large enough.  
