...
---
# DHTML_EVENT_ONDATASETCOMPLETE
Handles (at the document level) the **ondatasetcomplete** event originated by the HTML element identified by <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>.  
