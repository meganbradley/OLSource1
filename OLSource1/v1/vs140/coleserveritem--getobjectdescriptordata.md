...
## Remarks  
 The information is copied into the **STGMEDIUM** structure pointed to by <CodeContentPlaceHolder>4\</CodeContentPlaceHolder>. This format includes the information needed for the Paste Special dialog.  
