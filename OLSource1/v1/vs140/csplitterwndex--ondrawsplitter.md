...
#### Parameters  
 ...
 Pointer to the device context. If this parameter is <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>, the framework redraws the active window.  
  
 [in] <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>  
 One of the <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> enumeration values that specifies the splitter window element to draw. Valid values are <CodeContentPlaceHolder>5\</CodeContentPlaceHolder>, <CodeContentPlaceHolder>6\</CodeContentPlaceHolder>, <CodeContentPlaceHolder>7\</CodeContentPlaceHolder>, and <CodeContentPlaceHolder>8\</CodeContentPlaceHolder>.  
