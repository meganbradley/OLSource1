...
|---------------|-----------------|  
|[in] <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>|Specifies the minimum number of visible items.|  
...
## Example  
 The following code example defines the variable, <CodeContentPlaceHolder>4\</CodeContentPlaceHolder>, that is used to programmatically access the combo box control. This variable is used in the next example.  
