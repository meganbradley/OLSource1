...
-   A comparison run-time operator (such as <CodeContentPlaceHolder>0\</CodeContentPlaceHolder>) was used in a conditional assembly statement instead of a relational operator (such as [EQ](../vs140/operator-eq.md)).  
