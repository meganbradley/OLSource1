...
## In This Section  
 ...
 Provides information about the **_RPTn** and **_RPTFn** macros (defined in CRTDBG.H), which replace the use of <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> statements for debugging.  
