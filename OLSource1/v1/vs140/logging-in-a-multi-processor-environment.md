...
```  
 ...
 To forward events in a forwarding logger, call the [ForwardEvent](assetId:///M:Microsoft.Build.Framework.IEventRedirector.ForwardEvent(Microsoft.Build.Framework.BuildEventArgs)?qualifyHint=False&autoUpgrade=True) method of the <xref:Microsoft.Build.Framework.IEventRedirector*> interface. Pass the appropriate <xref:Microsoft.Build.Framework.BuildEventArgs*>, or a derivative, as the parameter.  
