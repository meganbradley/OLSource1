...
|------------|-------------|-------------|  
|<CodeContentPlaceHolder>1\</CodeContentPlaceHolder>|Abnormal termination|Terminates the calling program with exit code 3|  
|<CodeContentPlaceHolder>2\</CodeContentPlaceHolder>|Floating-point error|Terminates the calling program|  
|<CodeContentPlaceHolder>3\</CodeContentPlaceHolder>|Illegal instruction|Terminates the calling program|  
|<CodeContentPlaceHolder>4\</CodeContentPlaceHolder>|CTRL+C interrupt|Terminates the calling program|  
|<CodeContentPlaceHolder>5\</CodeContentPlaceHolder>|Illegal storage access|Terminates the calling program|  
|<CodeContentPlaceHolder>6\</CodeContentPlaceHolder>|Termination request sent to the program|Ignores the signal|  
  
 If the argument is not a valid signal as specified above, the invalid parameter handler is invoked, as described in [Parameter Validation](../vs140/parameter-validation.md). If not handled, the function sets <CodeContentPlaceHolder>7\</CodeContentPlaceHolder> to <CodeContentPlaceHolder>8\</CodeContentPlaceHolder> and returns a nonzero value.  
