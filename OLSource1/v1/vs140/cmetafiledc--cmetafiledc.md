...
## Remarks  
 First, call <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>, then call **Create**, which creates the Windows metafile device context and attaches it to the <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> object.  
