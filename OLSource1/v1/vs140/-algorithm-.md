...
-   The <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> suffix indicates that the algorithm is used with function objects operating on the values of the elements rather than on the values of the elements themselves. The <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> algorithm looks for elements whose values satisfy the criterion specified by a function object, and the <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> algorithm searches for a particular value.  
  
-   The _copy suffix indicates that the algorithm not only manipulates the values of the elements but also copies the modified values into a destination range. The <CodeContentPlaceHolder>6\</CodeContentPlaceHolder> algorithm reverses the order of the elements within a range, and the <CodeContentPlaceHolder>7\</CodeContentPlaceHolder> algorithm also copies the result into a destination range.  
...
|[all_of](../vs140/-algorithm--functions.md#all_of)|Returns <CodeContentPlaceHolder>9\</CodeContentPlaceHolder> when a condition is present at each element in the given range.|  
|[any_of](../vs140/-algorithm--functions.md#any_of)|Returns <CodeContentPlaceHolder>10\</CodeContentPlaceHolder> when a condition is present at least once in the specified range of elements.|  
...
|[copy_if](../vs140/-algorithm--functions.md#copy_if)|Copy all elements in a given range that test <CodeContentPlaceHolder>11\</CodeContentPlaceHolder> for a specified condition|  
...
|[is_heap](../vs140/-algorithm--functions.md#is_heap)|Returns <CodeContentPlaceHolder>12\</CodeContentPlaceHolder> if the elements in the specified range form a heap.|  
|[is_heap_until](../vs140/-algorithm--functions.md#is_heap_until)|Returns <CodeContentPlaceHolder>13\</CodeContentPlaceHolder> if the specified range forms a heap until the last element.|  
|[is_partitioned](../vs140/-algorithm--functions.md#is_partitioned)|Returns <CodeContentPlaceHolder>14\</CodeContentPlaceHolder> if all the elements in the given range that test <CodeContentPlaceHolder>15\</CodeContentPlaceHolder> for a condition come before any elements that test <CodeContentPlaceHolder>16\</CodeContentPlaceHolder>.|  
...
|[is_sorted](../vs140/-algorithm--functions.md#is_sorted)|Returns <CodeContentPlaceHolder>17\</CodeContentPlaceHolder> if the elements in the specified range are in sorted order.|  
|[is_sorted_until](../vs140/-algorithm--functions.md#is_sorted_until)|Returns <CodeContentPlaceHolder>18\</CodeContentPlaceHolder> if the elements in the specified range are in sorted order.|  
...
|[none_of](../vs140/-algorithm--functions.md#none_of)|Returns <CodeContentPlaceHolder>19\</CodeContentPlaceHolder> when a condition is never present among elements in the given range.|  
...
|[partition_copy](../vs140/-algorithm--functions.md#partition_copy)|Copies elements for which a condition is <CodeContentPlaceHolder>20\</CodeContentPlaceHolder> to one destination, and for which the condition is <CodeContentPlaceHolder>21\</CodeContentPlaceHolder> to another. The elements must come from a specified range.|  
