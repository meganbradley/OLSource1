...
## Return Value  
 <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> indicates the restart manager restores autosaved files; <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> indicates the restart manager does not.  
