...
1.  You can set a value to a local property by using code.  
     ...
     The following example sets the value of a local property named <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> to <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>.  
