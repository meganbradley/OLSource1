...
---
# CFont::GetLogFont
Call this function to retrieve a copy of the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> structure for <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>.  
