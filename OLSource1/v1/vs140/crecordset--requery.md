...
## Remarks  
 ...
 If the attempt to rebuild the recordset fails, the recordset is closed. Before you call **Requery**, you can determine whether the recordset can be requeried by calling the <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> member function. <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> does not guarantee that **Requery** will succeed.  
