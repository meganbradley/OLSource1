...
apitype: "Assembly"
f1_keywords: 
  - "Microsoft.FSharp.Core.PrintfModule.PrintFormatToTextWriter``1"
dev_langs: 
  - "FSharp"
helpviewer_keywords: 
  - "Printf.fprintf function [F#]"
  - "fprintf function [F#]"
  - "PrintFormatToTextWriter function [F#]"
  - "Printf.PrintFormatToTextWriter function [F#]"
ms.assetid: 18f16c19-14e9-4eea-b147-cc302132c1e8
...
## Remarks  
 This function is named <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> in compiled assemblies. If accessing the member from a language other than F#, or through reflection, use this name.  
