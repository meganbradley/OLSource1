...
9. Implement the `MyToolWindowMouseRightButtonDown` event as follows.  
    ...
    ```  
     ...
     This creates a <xref:System.ComponentModel.Design.CommandID*> object for the shortcut menu, identifies the location of the mouse click, and opens the shortcut menu in that location by using the [ShowContextMenu](assetId:///M:Microsoft.VisualStudio.Shell.OleMenuCommandService.ShowContextMenu(System.ComponentModel.Design.CommandID,System.Int32,System.Int32)?qualifyHint=False&autoUpgrade=True) method.  
