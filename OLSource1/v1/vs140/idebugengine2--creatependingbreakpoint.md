...
## Return Value  
 If successful, returns <CodeContentPlaceHolder>5\</CodeContentPlaceHolder>; otherwise, returns an error code. Typically returns <CodeContentPlaceHolder>6\</CodeContentPlaceHolder> if the <CodeContentPlaceHolder>7\</CodeContentPlaceHolder> parameter does not match any language supported by the DE of if the <CodeContentPlaceHolder>8\</CodeContentPlaceHolder> parameter is invalid or incomplete.  
...
## Example  
 The following example shows how to implement this method for a simple <CodeContentPlaceHolder>9\</CodeContentPlaceHolder> object. The DE's implementation of the <CodeContentPlaceHolder>10\</CodeContentPlaceHolder> could then forward all calls to this implementation of the method in each program.  
