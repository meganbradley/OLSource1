...
> [!NOTE]
>  The image is already loaded by the time this method can be called. The <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> method is typically used when the image has been moved or changed and a new alignment is required.  
