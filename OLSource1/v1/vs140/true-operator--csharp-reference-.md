...
Returns the [bool](../vs140/bool--csharp-reference-.md) value `true` to indicate that an operand is true and returns `false` otherwise.  
 ...
 If a type defines operator `true`, it must also define operator [false](../vs140/false--csharp-reference-.md).  
