 ...
 **Make sure you are not trying to unload the application domain that is the default, has a running thread, or that has already been unloaded.**  
 Any of these conditions will cause this exception to be thrown. For more information, see [Unload](assetId:///M:System.AppDomain.Unload(System.AppDomain)?qualifyHint=False&autoUpgrade=True).  
