...
#### Parameters  
 ...
 [in] The message map identifier. To use the default message map declared with [BEGIN_MSG_MAP](../vs140/begin_msg_map.md), pass zero. To use an alternate message map declared with [ALT_MSG_MAP(msgMapID)](../vs140/alt_msg_map.md), pass <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>.  
