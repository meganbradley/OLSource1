...
|AsQueryable|Converts a (generic) <xref:System.Collections.IEnumerable*> to a (generic) <xref:System.Linq.IQueryable*>.|Not applicable.|[Queryable.AsQueryable](assetId:///M:System.Linq.Queryable.AsQueryable(System.Collections.IEnumerable)?qualifyHint=True&autoUpgrade=True)|  
