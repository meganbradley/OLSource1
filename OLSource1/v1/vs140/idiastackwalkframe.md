...
## Notes for Callers  
 The client application implements this interface and passes an instance of the interface to the [IDiaFrameData::execute](../vs140/idiaframedata--execute.md) method. The same instance of this interface is used again and again to maintain the state of the registers during each invocation of the <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> method. The <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> method also uses this interface to determine the return address.  
