...
---
# CPen::GetLogPen
Gets a <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> underlying structure.  
...
## Remarks  
 The <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> structure defines the style, color, and pattern of a pen.  
  
 For example, call <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> to match the particular style of pen.  
...
## Example  
 The following code example demonstrates calling <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> to retrieve a pen character, and then create a new, solid pen with the same color.  
