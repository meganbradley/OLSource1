...
-   <xref:Microsoft.VisualBasic.CompilerServices.Conversions?qualifyHint=False> class  
  
-   <xref:Microsoft.VisualBasic.Strings.AscW(System.Char)?qualifyHint=False> method  
  
-   <xref:Microsoft.VisualBasic.Strings.AscW(System.String)?qualifyHint=False> method  
  
-   <xref:Microsoft.VisualBasic.Strings.ChrW(System.Int32)?qualifyHint=False> method  
  
-   <xref:Microsoft.VisualBasic.Constants.vbBack?qualifyHint=False> constant  
  
-   <xref:Microsoft.VisualBasic.Constants.vbCr?qualifyHint=False> constant  
  
-   <xref:Microsoft.VisualBasic.Constants.vbCrLf?qualifyHint=False> constant  
  
-   <xref:Microsoft.VisualBasic.Constants.vbFormFeed?qualifyHint=False> constant  
  
-   <xref:Microsoft.VisualBasic.Constants.vbLf?qualifyHint=False> constant  
  
-   <xref:Microsoft.VisualBasic.Constants.vbNewLine?qualifyHint=False> constant  
  
-   <xref:Microsoft.VisualBasic.Constants.vbNullChar?qualifyHint=False> constant  
  
-   <xref:Microsoft.VisualBasic.Constants.vbNullString?qualifyHint=False> constant  
  
-   <xref:Microsoft.VisualBasic.Constants.vbTab?qualifyHint=False> constant  
  
-   <xref:Microsoft.VisualBasic.Constants.vbVerticalTab?qualifyHint=False> constant  
