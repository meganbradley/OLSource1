...
-   If the method in the derived class is not preceded by [new](../vs140/new--csharp-reference-.md) or [override](../vs140/override--csharp-reference-.md) keywords, the compiler will issue a warning and the method will behave as if the `new` keyword were present.  
...
## Override and Method Selection  
 ...
 For more examples of `new` and `override`, see [Knowing When to Use Override and New Keywords (C# Programming Guide)](../vs140/knowing-when-to-use-override-and-new-keywords--csharp-programming-guide-.md).  
