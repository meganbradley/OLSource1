...
## Remarks  
 <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> directs messages to the message map identified by [m_dwMsgMapID](../vs140/ccontainedwindowt--m_dwmsgmapid.md). If necessary, <CodeContentPlaceHolder>6\</CodeContentPlaceHolder> calls [DefWindowProc](../vs140/ccontainedwindowt--defwindowproc.md) for additional message processing.  
