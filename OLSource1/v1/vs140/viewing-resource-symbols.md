...
1.  In [Resource View](../vs140/resource-view-window.md), right-click your .rc file.  
...
2.  Select **Resource Symbols** from the shortcut menu to view a resource symbol table in the [Resource Symbols dialog box](../vs140/resource-symbols-dialog-box.md).  
