...
-   Class [CMenu](../vs140/cmenu-class.md) for manipulating your program's menus at run time. Use the documentation for <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> and the sample to learn how to use <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> effectively.  
