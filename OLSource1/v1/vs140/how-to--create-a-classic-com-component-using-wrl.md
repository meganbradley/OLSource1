...
1.  In Visual Studio, create a **Blank Solution** project. Name the project, for example, <CodeContentPlaceHolder>0\</CodeContentPlaceHolder>.  
  
2.  Add a **Win32 Project** to the solution. Name the project, for example, <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>. On the **Application Settings** tab, select **DLL**.  
  
3.  Add a **Midl File (.idl)** file to the project. Name the file, for example, <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>.  
...
5.  In CalculatorComponent.cpp, define the <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> class. The <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> class inherits from [Microsoft::WRL::RuntimeClass](../vs140/runtimeclass-class.md). [Microsoft::WRL::RuntimeClassFlags\<ClassicCom>](../vs140/runtimeclassflags-structure.md) specifies that the class derives from [IUnknown](http://msdn.microsoft.com/library/windows/desktop/ms680509\(v=vs.85\).aspx) and not [IInspectable](http://msdn.microsoft.com/library/br205821\(v=vs.85\).aspx). (<CodeContentPlaceHolder>5\</CodeContentPlaceHolder> is available only to [!INCLUDE[win8_appstore_short](../vs140/includes/win8_appstore_short_md.md)] app components.) <CodeContentPlaceHolder>6\</CodeContentPlaceHolder> creates a factory for the class that can be used with functions such as [CoCreateInstance](http://msdn.microsoft.com/library/windows/desktop/ms686615\(v=vs.85\).aspx).  
...
7.  Add a **Module-Definition File (.def)** file to the project. Name the file, for example, <CodeContentPlaceHolder>7\</CodeContentPlaceHolder>. This file gives the linker the names of the functions to be exported.  
...
1.  Register the COM component with the Windows Registry. To do so, create a registration entries file, name it <CodeContentPlaceHolder>8\</CodeContentPlaceHolder>, and add the following text. Replace *\<dll-path>* with the path of your DLL—for example, <CodeContentPlaceHolder>9\</CodeContentPlaceHolder>.  
...
3.  Add a **Win32 Console Application** project to the solution. Name the project, for example, <CodeContentPlaceHolder>10\</CodeContentPlaceHolder>.  
