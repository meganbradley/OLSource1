...
The <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> object provides properties for getting information about the computer's memory, loaded assemblies, name, and operating system.  
  
## Remarks  
 This table lists tasks commonly accomplished through the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> object and points to topics demonstrating how to perform each.  
...
|Determine the installed <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> on the computer on which the application is running.|\<xref:Microsoft.VisualBasic.Devices.ComputerInfo.InstalledUICulture*>|  
