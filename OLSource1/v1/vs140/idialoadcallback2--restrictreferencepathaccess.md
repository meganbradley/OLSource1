...
## Remarks  
 Any return code other than <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> to prevent looking for a .pdb file in the path where the .exe file is located.  
