...
1.  Create unit tests that use the test frameworks of your choice.  
    ...
    2.  Write each unit test as a method. Prefix each test method with the <CodeContentPlaceHolder>7\</CodeContentPlaceHolder> attribute.  
...
1.  Create a Visual C# Class Library project. This project will contain the code that we want to deliver. In this example, it is named <CodeContentPlaceHolder>8\</CodeContentPlaceHolder>.  
...
4.  Generate the method from the test.  
    ...
    1.  Place the cursor on <CodeContentPlaceHolder>9\</CodeContentPlaceHolder>, and then on the shortcut menu choose **Generate**, **New Type**.  
  
    2.  In the **Generate New Type** dialog box, set **Project** to the class library project. In this example, it is <CodeContentPlaceHolder>10\</CodeContentPlaceHolder>.  
  
    3.  Place the cursor on <CodeContentPlaceHolder>11\</CodeContentPlaceHolder>, and then on the shortcut menu choose **Generate**, **Method Stub**.  
...
1.  In <CodeContentPlaceHolder>12\</CodeContentPlaceHolder>, improve the code of <CodeContentPlaceHolder>13\</CodeContentPlaceHolder>:  
...
3.  Inspect the method under test to see what might be wrong. In the <CodeContentPlaceHolder>14\</CodeContentPlaceHolder> class, rewrite the code:  
