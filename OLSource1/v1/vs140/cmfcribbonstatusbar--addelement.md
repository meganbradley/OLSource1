...
#### Parameters  
 ...
 <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> if you want to add the element as visible, <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> if you want to add the element as hidden.  
