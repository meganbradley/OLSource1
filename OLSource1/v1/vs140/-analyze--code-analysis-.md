...
## Arguments  
 ...
 The `number` parameter that is used with this option specifies the size, in bytes, of the stack frame for which warning [C6262](../vs140/c6262.md) is generated. If this parameter is not specified, the stack frame size is 16KB by default.  
