...
#### Parameters  
 ...
 The position value, obtained with either a call to [CRBMultiMap::FindFirstWithKey](../vs140/crbmultimap--findfirstwithkey.md) or [CRBMultiMap::GetNextValueWithKey](../vs140/crbmultimap--getnextvaluewithkey.md), or a previous call to <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>.  
