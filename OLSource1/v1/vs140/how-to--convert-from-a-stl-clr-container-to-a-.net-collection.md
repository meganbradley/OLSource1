...
This topic shows how to convert STL/CLR containers to their equivalent .NET collections. As an example, we show how to convert a STL/CLR [vector](../vs140/vector--stl-clr-.md) to a .NET <xref:System.Collections.Generic.ICollection`1*> and how to convert a STL/CLR [map](../vs140/map--stl-clr-.md) to a .NET <xref:System.Collections.Generic.IDictionary`2*>, but the procedure is similar for all collections and containers.  
