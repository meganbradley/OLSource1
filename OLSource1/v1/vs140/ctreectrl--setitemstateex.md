...
|[in] <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>|The extended state of the item. For more information, see the <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> member of the [TVITEMEX](http://msdn.microsoft.com/library/windows/desktop/bb773459) structure.|  
...
## Remarks  
 This method sends the [TVM_SETITEM](http://msdn.microsoft.com/library/windows/desktop/bb773758) message, which is described in the [!INCLUDE[winSDK](../vs140/includes/winsdk_md.md)]. This method assigns the <CodeContentPlaceHolder>6\</CodeContentPlaceHolder> parameter to the <CodeContentPlaceHolder>7\</CodeContentPlaceHolder> member of a [TVITEMEX](http://msdn.microsoft.com/library/windows/desktop/bb773459) structure, and then uses that structure in the message.  
...
## Example  
 The following code example defines a variable, <CodeContentPlaceHolder>8\</CodeContentPlaceHolder>, that is used to access the current tree-view control. The code example also defines an unsigned integer and several HTREEITEM variables. These variables are used in the next example.  
