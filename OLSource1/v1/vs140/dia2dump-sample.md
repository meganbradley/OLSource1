...
2.  In the project property pages, in the **C/C++** &#124; **General** &#124; **Additional Include Directories** property, specify the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> directory. This guarantees that the compiler can find the dia2.h file.  
