...
The alias name used in the <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> statement conflicts with another name declared in the root namespace.  
  
 **Error ID:** BC31403  
  
### To correct this error  
  
-   Choose a unique name for the alias used by the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> statement.  
