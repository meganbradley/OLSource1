...
4.  In the **Name** box, type <CodeContentPlaceHolder>0\</CodeContentPlaceHolder>.  
  
5.  Click **OK**.  
  
     The Windows Forms Designer opens.  
  
6.  Select the form in the Windows Forms Designer. In the **Properties** window, set the **Size** property to <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>.  
...
4.  In the Properties window, set the **Location** property to <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>.  
  
5.  Set the **Size** property to <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>.  
...
7.  In the Properties window, set the **Size** property to <CodeContentPlaceHolder>4\</CodeContentPlaceHolder>.  
...
## Changing the Appearance of the DataRepeater Control  
 In this optional step, you change the <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> of the \<xref:Microsoft.VisualBasic.PowerPacks.DataRepeater*> control at design time. You also add code to display rows in alternating colors and to change a label's <CodeContentPlaceHolder>6\</CodeContentPlaceHolder> conditionally.  
...
2.  In the Properties window, set the <CodeContentPlaceHolder>7\</CodeContentPlaceHolder> property to white.  
...
5.  In the \<xref:Microsoft.VisualBasic.PowerPacks.DataRepeater.DrawItem*> event handler, add the following code to alternate the <CodeContentPlaceHolder>8\</CodeContentPlaceHolder>:  
  
     [!code[VbPowerPacksDataRepeaterWalkthrough#1](../vs140/codesnippet/CSharp/walkthrough--displaying-data-in-a-datarepeater-control--visual-studio-_1.cs)]
[!code[VbPowerPacksDataRepeaterWalkthrough#1](../vs140/codesnippet/VisualBasic/walkthrough--displaying-data-in-a-datarepeater-control--visual-studio-_1.vb)]  
  
6.  In the \<xref:Microsoft.VisualBasic.PowerPacks.DataRepeater.DrawItem*> event handler, add the following code to change the <CodeContentPlaceHolder>9\</CodeContentPlaceHolder> of a label depending on a condition:  
  
     [!code[VbPowerPacksDataRepeaterWalkthrough#2](../vs140/codesnippet/CSharp/walkthrough--displaying-data-in-a-datarepeater-control--visual-studio-_2.cs)]
[!code[VbPowerPacksDataRepeaterWalkthrough#2](../vs140/codesnippet/VisualBasic/walkthrough--displaying-data-in-a-datarepeater-control--visual-studio-_2.vb)]  
...
2.  Add the following code to the <CodeContentPlaceHolder>10\</CodeContentPlaceHolder> event:  
  
     [!code[VbPowerPacksDataRepeaterWalkthrough#3](../vs140/codesnippet/CSharp/walkthrough--displaying-data-in-a-datarepeater-control--visual-studio-_3.cs)]
[!code[VbPowerPacksDataRepeaterWalkthrough#3](../vs140/codesnippet/VisualBasic/walkthrough--displaying-data-in-a-datarepeater-control--visual-studio-_3.vb)]  
...
4.  Add the following code to the <CodeContentPlaceHolder>11\</CodeContentPlaceHolder> event handler:  
  
     [!code[VbPowerPacksDataRepeaterWalkthrough#4](../vs140/codesnippet/CSharp/walkthrough--displaying-data-in-a-datarepeater-control--visual-studio-_4.cs)]
[!code[VbPowerPacksDataRepeaterWalkthrough#4](../vs140/codesnippet/VisualBasic/walkthrough--displaying-data-in-a-datarepeater-control--visual-studio-_4.vb)]  
...
5.  Double-click the \<xref:System.Windows.Forms.Button*> control to open the Code Editor, and add the following code to the <CodeContentPlaceHolder>12\</CodeContentPlaceHolder> event handler.  
  
     [!code[VbPowerPacksDataRepeaterWalkthrough#5](../vs140/codesnippet/CSharp/walkthrough--displaying-data-in-a-datarepeater-control--visual-studio-_5.cs)]
[!code[VbPowerPacksDataRepeaterWalkthrough#5](../vs140/codesnippet/VisualBasic/walkthrough--displaying-data-in-a-datarepeater-control--visual-studio-_5.vb)]  
...
2.  In the Properties window, set the **Location** property to <CodeContentPlaceHolder>13\</CodeContentPlaceHolder>.  
  
3.  Set the **Size** property to <CodeContentPlaceHolder>14\</CodeContentPlaceHolder>.  
