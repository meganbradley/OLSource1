...
5.  In the <xref:Microsoft.VisualBasic.PowerPacks.DataRepeater.DrawItem*> event handler, add the following code to alternate the `BackColor`:  
     ...
     [!code[VbPowerPacksDataRepeaterWalkthrough#1](../vs140/codesnippet/CSharp/walkthrough--displaying-data-in-a-datarepeater-control--visual-studio-_1.cs)][!code[VbPowerPacksDataRepeaterWalkthrough#1](../vs140/codesnippet/VisualBasic/walkthrough--displaying-data-in-a-datarepeater-control--visual-studio-_1.vb)]  
...
6.  In the <xref:Microsoft.VisualBasic.PowerPacks.DataRepeater.DrawItem*> event handler, add the following code to change the `ForeColor` of a label depending on a condition:  
     ...
     [!code[VbPowerPacksDataRepeaterWalkthrough#2](../vs140/codesnippet/CSharp/walkthrough--displaying-data-in-a-datarepeater-control--visual-studio-_2.cs)][!code[VbPowerPacksDataRepeaterWalkthrough#2](../vs140/codesnippet/VisualBasic/walkthrough--displaying-data-in-a-datarepeater-control--visual-studio-_2.vb)]  
...
2.  Add the following code to the `Form_Load` event:  
     ...
     [!code[VbPowerPacksDataRepeaterWalkthrough#3](../vs140/codesnippet/CSharp/walkthrough--displaying-data-in-a-datarepeater-control--visual-studio-_3.cs)][!code[VbPowerPacksDataRepeaterWalkthrough#3](../vs140/codesnippet/VisualBasic/walkthrough--displaying-data-in-a-datarepeater-control--visual-studio-_3.vb)]  
...
4.  Add the following code to the `BindingNavigatorDeleteItem_EnabledChanged` event handler:  
     ...
     [!code[VbPowerPacksDataRepeaterWalkthrough#4](../vs140/codesnippet/CSharp/walkthrough--displaying-data-in-a-datarepeater-control--visual-studio-_4.cs)][!code[VbPowerPacksDataRepeaterWalkthrough#4](../vs140/codesnippet/VisualBasic/walkthrough--displaying-data-in-a-datarepeater-control--visual-studio-_4.vb)]  
...
5.  Double-click the <xref:System.Windows.Forms.Button*> control to open the Code Editor, and add the following code to the `SearchButton_Click` event handler.  
     ...
     [!code[VbPowerPacksDataRepeaterWalkthrough#5](../vs140/codesnippet/CSharp/walkthrough--displaying-data-in-a-datarepeater-control--visual-studio-_5.cs)][!code[VbPowerPacksDataRepeaterWalkthrough#5](../vs140/codesnippet/VisualBasic/walkthrough--displaying-data-in-a-datarepeater-control--visual-studio-_5.vb)]  
