...
## Remarks  
 ...
 For example, in the <CodeContentPlaceHolder>6\</CodeContentPlaceHolder> expression, the <CodeContentPlaceHolder>7\</CodeContentPlaceHolder> is what follows the pipe symbol.  
