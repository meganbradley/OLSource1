 ...
 *sizeInit*  
 ...
 A pointer to a creation context used to create the view (usually the <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> passed into the parent frame's overridden [CFrameWnd::OnCreateClient](../vs140/cframewnd--oncreateclient.md) member function in which the splitter window is being created).  
