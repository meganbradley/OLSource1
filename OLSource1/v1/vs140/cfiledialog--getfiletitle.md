...
## Remarks  
 The title of the file includes only its prefix, without the path or the extension. For example, <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> will return "TEXT" for the file C:\FILES\TEXT.DAT.  
