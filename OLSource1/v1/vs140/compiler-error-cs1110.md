...
1.  As the message states, add a reference to System.Core.dll or remove the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> modifier from the method declaration.  
