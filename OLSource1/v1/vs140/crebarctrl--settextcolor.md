...
#### Parameters  
 ...
 A **COLORREF** value that represents the new text color in the <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> object.  
  
## Return Value  
 The [COLORREF](http://msdn.microsoft.com/library/windows/desktop/dd183449) value representing the previous text color associated with the <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> object.  
