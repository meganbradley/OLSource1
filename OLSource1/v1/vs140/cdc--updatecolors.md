...
## Remarks  
 An inactive window with a realized logical palette may call <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> as an alternative to redrawing its client area when the system palette changes.  
