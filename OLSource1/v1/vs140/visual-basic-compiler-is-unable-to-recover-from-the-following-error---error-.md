...
The [!INCLUDE[vbprvb](../vs140/includes/vbprvb_md.md)] compiler is unable to recover from the following error: <<CodeContentPlaceHolder>0\</CodeContentPlaceHolder>>.  
  
 Some IDE features have been disabled.  
  
 An internal error has occurred in the [!INCLUDE[vbprvb](../vs140/includes/vbprvb_md.md)] compiler.  
