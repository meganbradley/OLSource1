...
A \<xref:System.Runtime.InteropServices.DispIdAttribute*> attribute block specifies a DISPID value of 0, which is reserved by <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> to represent the default property of the class to which it is applied.  
