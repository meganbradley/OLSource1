...
-   Check the spelling of the variable in the <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> statement and in the corresponding <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> statement to make sure it matches.  
