...
## Remarks  
 The first element of the `source` sequence is evaluated at each call. To avoid this reevaluation, you can create a cached version of a sequence by calling [Seq.cache](../vs140/seq.cache--t--function--fsharp-.md).  
