...
## List Members  
 A list of valid members from a type (or namespace) appears after you type a trigger character (for example, a period (<CodeContentPlaceHolder>1\</CodeContentPlaceHolder>) in managed code or <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> in C++). If you continue typing characters, the list is filtered to include only the members that begin with those characters.  
...
## Quick Info  
 ...
 You can turn Quick Info off In C++ by setting **Tools/Options/Text Editor/C/C++/Advanced/Auto Quick Info** to <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>.  
...
## See Also  
 ...
 [Visual C# IntelliSense](../vs140/visual-csharp-intellisense.md)   
 [JScript IntelliSense Overview](../vs140/javascript-intellisense.md)   
