 ...
 **(C++11)** In the ISO C++11 Standard, [noexcept](../vs140/noexcept--c---.md) operator was introduced and is supported in Visual Studio 2015 and later. Whenever possible, use <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> to specify whether a function might throw exceptions.  
...
|throw(<CodeContentPlaceHolder>3\</CodeContentPlaceHolder>)|The function can throw an exception of type <CodeContentPlaceHolder>4\</CodeContentPlaceHolder>. However, in Visual C++ .NET, this is interpreted as throw(...).  See [Function Exception Specifiers](../vs140/15.4-function-exception-specifiers.md).|  
...
|C++ function with throw(...) exception specification|throw(...)|throw(...)|throw(...)|throw(...)|  
|C++ function with throw(<CodeContentPlaceHolder>5\</CodeContentPlaceHolder>) exception specification|throw(...)|throw(...)|throw(...)|throw(...)|  
