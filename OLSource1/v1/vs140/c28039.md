...
warning C28039: The type of actual parameter \<operand> should exactly match the type \<typename>  
 ...
 For enum types, if the type of an enum parameter is annotated with <CodeContentPlaceHolder>0\</CodeContentPlaceHolder>, arithmetic is permitted on the parameter. Otherwise the parameter must be of exactly the correct type. If a constant is strictly required, warning C28137 may also apply.  
