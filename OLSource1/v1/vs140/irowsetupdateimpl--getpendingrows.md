...
#### Parameters  
 ...
 [in] Corresponds to the <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> parameter in [IRowsetUpdate::GetPendingRows](https://msdn.microsoft.com/en-us/library/ms719626.aspx).  
