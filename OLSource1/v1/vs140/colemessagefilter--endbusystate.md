...
## Remarks  
 ...
 By default, the framework enters the busy state during idle processing, which is performed by [CWinApp::OnIdle](../vs140/cwinapp--onidle.md). While the application is handling <CodeContentPlaceHolder>7\</CodeContentPlaceHolder> notifications, incoming calls are handled after idle processing is complete.  
