...
## Remarks  
 Initializes the <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> data member, [m_contained](../vs140/ccompolyobject--m_contained.md), and increments the module lock count.  
