...
#### Parameters  
 ...
 Points to a <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> object in which the data is to be rendered.  
  
## Return Value  
 Nonzero if successful; otherwise 0.  
  
## Remarks  
 The specified format is one previously placed in the <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> object using the [DelayRenderData](../vs140/coledatasource--delayrenderdata.md) member function for delayed rendering. The default implementation of this function simply returns **FALSE**.  
