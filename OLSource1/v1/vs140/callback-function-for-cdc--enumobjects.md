 ...
 *lpszLogObject*  
 ...
 Points to the application-supplied data passed to the <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> function.  
  
## Return Value  
 The callback function returns an <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>. The value of this return is user-defined. If the callback function returns 0, <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> stops enumeration early.  
