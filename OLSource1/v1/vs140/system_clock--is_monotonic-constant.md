...
## Remarks  
 A clock is *monotonic* if the value that is returned by a first call to <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> is always less than or equal to the value that is returned by a subsequent call to <CodeContentPlaceHolder>4\</CodeContentPlaceHolder>.  
