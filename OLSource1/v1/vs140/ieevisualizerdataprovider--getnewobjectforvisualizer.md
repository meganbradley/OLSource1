...
## Remarks  
 <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> re-evaluates the object it currently represents and returns the result as a new object. The existing object will be updated as a result of the evaluation.  
