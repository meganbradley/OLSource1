...
## Remarks  
 An instance of <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> holds a modified-type that is the element type of the array type <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> with all array dimensions removed, or <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> if <CodeContentPlaceHolder>6\</CodeContentPlaceHolder> is not an array type.  
