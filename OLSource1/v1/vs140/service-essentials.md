...
-   Managed objects that are deeply nested, or not sited at all, may call [GetGlobalService](assetId:///M:Microsoft.VisualStudio.Shell.Package.GetGlobalService(System.Type)?qualifyHint=False&autoUpgrade=True) for direct access to global services. For more information, see [How to: Use GetGlobalService](../vs140/how-to--use-getglobalservice.md).  
