...
You declared a variable that is typed as a structure in conjunction with <CodeContentPlaceHolder>0\</CodeContentPlaceHolder>, which is not a valid use of the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> modifier.  
  
 **Error ID:** BC30413  
  
### To correct this error  
  
1.  Use <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> to handle events defined in a structure.  
