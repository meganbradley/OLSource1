...
apitype: "Assembly"
f1_keywords: 
  - "Microsoft.FSharp.Core.Operators.DefaultArg``1"
dev_langs: 
  - "FSharp"
helpviewer_keywords: 
  - "defaultArg function [F#]"
  - "Operators.defaultArg function [F#]"
...
## Return Value  
 The argument value. If it is <CodeContentPlaceHolder>5\</CodeContentPlaceHolder>, the <CodeContentPlaceHolder>6\</CodeContentPlaceHolder> is returned.  
