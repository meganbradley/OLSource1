...
-   In the [!INCLUDE[dnprdnshort](../vs140/includes/dnprdnshort_md.md)] class library, events are based on the <xref:System.EventHandler?qualifyHint=False> delegate and the <xref:System.EventArgs?qualifyHint=False> base class.  
...
## See Also  
 <xref:System.EventHandler?qualifyHint=False>   
