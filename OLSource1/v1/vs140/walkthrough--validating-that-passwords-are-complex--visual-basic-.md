...
### Code  
 [!code[VbVbcnRegEx#1](../vs140/codesnippet/VisualBasic/walkthrough--validating-that-passwords-are-complex--visual-basic-_1.vb)]  
...
-   Access to the members of the \<xref:System.Text.RegularExpressions*> namespace. Add an <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> statement if you are not fully qualifying member names in your code. For more information, see [Imports Statement](../vs140/imports-statement--.net-namespace-and-type-.md).  
  
## Security  
 If you are moving the password across a network, you need to use a secure method for transferring data. For more information, see [ASP.NET Web Application Security](assetId:///658d0430-1644-4744-b52d-08b0d6fcacb8).  
  
 You can improve the accuracy of the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> function by adding additional complexity checks:  
