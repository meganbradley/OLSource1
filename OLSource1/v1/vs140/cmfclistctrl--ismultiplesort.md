...
## Return Value  
 <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> if the list control supports multiple sort; <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> otherwise.  
