...
#### Parameters  
 ...
 The type of accessor class (such as <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>, <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>, or <CodeContentPlaceHolder>4\</CodeContentPlaceHolder>) that you want the command to use. The default is <CodeContentPlaceHolder>5\</CodeContentPlaceHolder>, which specifies that the class not support parameters or output columns.  
  
 <CodeContentPlaceHolder>6\</CodeContentPlaceHolder>  
 The type of rowset class (such as <CodeContentPlaceHolder>7\</CodeContentPlaceHolder> or <CodeContentPlaceHolder>8\</CodeContentPlaceHolder>) that you want the command to use. The default is <CodeContentPlaceHolder>9\</CodeContentPlaceHolder>.  
