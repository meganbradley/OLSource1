...
## Return Value  
 A handle to the menu if success. <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> if the list of commands associated with the toolbar menu button is empty.  
