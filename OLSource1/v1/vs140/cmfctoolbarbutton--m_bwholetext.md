...
## Remarks  
 If this data member is set to <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>, the framework displays the full text label by enlarging the button. Otherwise, the framework truncates and appends an ellipsis (**...**) to the text label.  
