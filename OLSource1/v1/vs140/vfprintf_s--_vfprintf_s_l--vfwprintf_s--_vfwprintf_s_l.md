...
## Remarks  
 Each of these functions takes a pointer to an argument list, then formats and writes the given data to <CodeContentPlaceHolder>12\</CodeContentPlaceHolder>.  
  
 These functions differ from the non-secure versions only in that the secure versions check that the <CodeContentPlaceHolder>13\</CodeContentPlaceHolder> string contains valid formatting characters.  
  
 <CodeContentPlaceHolder>14\</CodeContentPlaceHolder> is the wide-character version of <CodeContentPlaceHolder>15\</CodeContentPlaceHolder>; the two functions behave identically if the stream is opened in ANSI mode. <CodeContentPlaceHolder>16\</CodeContentPlaceHolder> doesn't currently support output into a UNICODE stream.  
...
> [!IMPORTANT]
>  Ensure that <CodeContentPlaceHolder>18\</CodeContentPlaceHolder> is not a user-defined string. For more information, see [Avoiding Buffer Overruns](http://msdn.microsoft.com/library/windows/desktop/ms717795).  
...
|-------------|---------------------|----------------------|  
|<CodeContentPlaceHolder>27\</CodeContentPlaceHolder>, _<CodeContentPlaceHolder>28\</CodeContentPlaceHolder>|\<stdio.h> and \<stdarg.h>|\<varargs.h>*|  
|<CodeContentPlaceHolder>29\</CodeContentPlaceHolder>, _<CodeContentPlaceHolder>30\</CodeContentPlaceHolder>|\<stdio.h> or \<wchar.h>, and \<stdarg.h>|\<varargs.h>*|  
