...
## Example  
 The following example resolves C3498 by passing the managed variable <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> to the parameter list of the lambda expression:  
