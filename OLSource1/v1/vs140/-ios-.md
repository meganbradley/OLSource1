...
|[defaultfloat](../vs140/-ios--functions.md#ios_defaultfloat)|Configures the flags of an <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> object to use a default display format for float values.|  
