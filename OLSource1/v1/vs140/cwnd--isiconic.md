...
---
# CWnd::IsIconic
Specifies whether <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> is minimized (iconic).  
  
## Syntax  
  
<CodeContentPlaceHolder>0\</CodeContentPlaceHolder>  
## Return Value  
 Nonzero if <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> is minimized; otherwise 0.  
