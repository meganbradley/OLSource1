...
|---------------|-----------------|  
|[in] <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>|The zero-based index of an item.|  
...
## Example  
 The following code example defines a variable, <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>, that is used to access the current list-view control. This variable is used in the next example.  
