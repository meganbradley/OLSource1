...
#### Parameters  
 ...
 Pointer to a vector of indexes for each dimension in the array. The leftmost (most significant) dimension is <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>[0]*.*  
