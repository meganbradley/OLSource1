...
-   <CodeContentPlaceHolder>14\</CodeContentPlaceHolder> <CodeContentPlaceHolder>15\</CodeContentPlaceHolder> (<CodeContentPlaceHolder>16\</CodeContentPlaceHolder>)  
 ...
 If its name begins with two underscores (<CodeContentPlaceHolder>17\</CodeContentPlaceHolder>), a data type is non-standard.  
...
|wchar_t|2|__wchar_t|0 to 65,535|  
 ...
 Depending on how it's used, a variable of <CodeContentPlaceHolder>18\</CodeContentPlaceHolder> designates either a wide-character type or multibyte-character type. Use the <CodeContentPlaceHolder>19\</CodeContentPlaceHolder> prefix before a character or string constant to designate the wide-character-type constant.  
  
 <CodeContentPlaceHolder>20\</CodeContentPlaceHolder> and <CodeContentPlaceHolder>21\</CodeContentPlaceHolder> are modifiers that you can use with any integral type except <CodeContentPlaceHolder>22\</CodeContentPlaceHolder>. Note that <CodeContentPlaceHolder>23\</CodeContentPlaceHolder>, <CodeContentPlaceHolder>24\</CodeContentPlaceHolder>, and <CodeContentPlaceHolder>25\</CodeContentPlaceHolder> are three distinct types for the purposes of mechanisms like overloading and templates.  
  
 The <CodeContentPlaceHolder>26\</CodeContentPlaceHolder> and <CodeContentPlaceHolder>27\</CodeContentPlaceHolder> types have a size of four bytes. However, portable code should not depend on the size of <CodeContentPlaceHolder>28\</CodeContentPlaceHolder> because the language standard allows this to be implementation-specific.  
