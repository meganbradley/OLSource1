...
---
# error_category::operator==
Tests for equality between <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> objects.  
...
|---------------|-----------------|  
|<CodeContentPlaceHolder>2\</CodeContentPlaceHolder>|The object to be tested for equality.|  
  
## Return Value  
 **true** if the objects are equal; **false** if the objects are not equal.  
  
## Remarks  
 This member operator returns <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>.  
