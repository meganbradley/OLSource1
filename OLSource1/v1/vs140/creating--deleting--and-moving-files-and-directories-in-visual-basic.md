...
## Reference  
 ...
 <xref:Microsoft.VisualBasic.FileIO.FileSystem.DeleteDirectory?qualifyHint=False>  
 Describes the `DeleteDirectory` method.  
  
 <xref:Microsoft.VisualBasic.FileIO.FileSystem.DeleteFile?qualifyHint=False>  
 Describes the `DeleteFile` method.  
  
 <xref:Microsoft.VisualBasic.FileIO.FileSystem.GetParentPath?qualifyHint=False>  
 Describes the `GetParentPath` method.  
  
 <xref:Microsoft.VisualBasic.FileIO.FileSystem.MoveDirectory?qualifyHint=False>  
 ...
 <xref:Microsoft.VisualBasic.FileIO.FileSystem.RenameDirectory?qualifyHint=False>  
