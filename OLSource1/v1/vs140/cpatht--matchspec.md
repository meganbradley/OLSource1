...
#### Parameters  
 ...
 Pointer to a null-terminated string with the file type for which to search. For example, to test whether the file at the current path is a DOC file, <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> should be set to "*.doc".  
