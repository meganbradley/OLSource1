...
You attempted to override a delegate on the base class name that was declared with a <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> statement.  
  
 **Error ID:** BC30474  
  
### To correct this error  
  
1.  Change the overridden member so it is not a <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> statement.  
