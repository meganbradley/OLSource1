...
|----------|---------------------|  
|**Profile a .NET service**|-   [How to: Instrument a .NET Service and Collect Detailed Timing Data Using the Profiler Command Line](../vs140/9f73593a-69a7-41b7-a21c-81d3ab0eb8fe.md)|  
...
|**Profile a C/C++ service**|-   [How to: Instrument a Native Service and Collect Detailed Timing Data Using the Profiler Command Line](../vs140/dfe58b39-63f8-4a87-ab3a-2b5b14faa8d0.md)|  
...
|**Profile ASP.NET Web applications**|-   [Collecting Detailed Timing Data for an ASP.NET Application Using the Profiler Instrumentation Method from the Command-Line](../vs140/29f2fc55-aaf7-4e18-a672-8815455fba73.md)|  
