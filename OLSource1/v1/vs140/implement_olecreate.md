...
---
# IMPLEMENT_OLECREATE
Either this macro or [IMPLEMENT_OLECREATE_FLAGS](../vs140/implement_olecreate_flags.md) must appear in the implementation file for any class that uses <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>.  
...
> [!NOTE]
>  If you use <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>, by default, you support only the single threading model. If you use <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>, you can specify which threading model your object supports by using the <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> parameter.  
