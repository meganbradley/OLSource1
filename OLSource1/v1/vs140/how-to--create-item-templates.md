...
4.  For a Windows 8.1 store C# project, in the .vstemplate file, add the following XML within the opening and closing <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> tag: <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>.  
  
     A C++ Windows 8.1 store project uses a value of <CodeContentPlaceHolder>4\</CodeContentPlaceHolder>. For Windows 10 and other project types, see [TemplateGroupID Element (Visual Studio Templates)](../vs140/templategroupid-element--visual-studio-templates-.md).  
  
     The following example shows the entire contents of a .vstemplate file after the line of XML <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> has been added to it. This example is specific to C# projects. You can modify the <ProjectTpe> and \< [TemplateGroupID](../vs140/templategroupid-element--visual-studio-templates-.md)> elements to specify other language and project types.  
...
2.  Set the text value of the element to one of the following values:  
    ...
    4.  Web  
     ...
     For example: <CodeContentPlaceHolder>6\</CodeContentPlaceHolder>.  
