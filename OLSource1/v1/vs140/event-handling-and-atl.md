...
## In This Section  
 ...
 Lists the steps for using <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> and shows a code sample.  
  
 [Using IDispEventSimpleImpl](../vs140/using-idispeventsimpleimpl.md)  
 Lists the steps for using <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> and shows a code sample.  
