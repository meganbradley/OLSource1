...
---
# CComControlBase::m_bDrawFromNatural
Flag indicating that <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> and <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> should set the control size from <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> rather than from <CodeContentPlaceHolder>4\</CodeContentPlaceHolder>.  
