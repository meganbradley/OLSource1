...
#### Parameters  
 ...
 Indicate the date-span and time-span values to be copied into this <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> object.  
  
## Remarks  
 For functions that query the value of a <CodeContentPlaceHolder>6\</CodeContentPlaceHolder> object, see the following member functions:  
