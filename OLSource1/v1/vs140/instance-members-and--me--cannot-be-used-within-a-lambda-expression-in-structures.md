...
From within a structure, you have defined a lambda expression that refers to an instance member of the structure or uses <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>. The following code illustrates these two invalid references.  
