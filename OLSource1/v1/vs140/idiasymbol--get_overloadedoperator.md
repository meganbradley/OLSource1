...
#### Parameters  
 ...
 [out] Returns <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> if the user-defined data type has overloaded operators; otherwise, returns <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>.  
