...
|[Step 4: Lay Out Your Form with a TableLayoutPanel Control](../vs140/step-4--lay-out-your-form-with-a-tablelayoutpanel-control.md)|Add a <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> control to your form.|  
|[Step 5: Add Controls to Your Form](../vs140/step-5--add-controls-to-your-form.md)|Add controls, such as a <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> control and a <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> control, to your form. Add buttons to your form.|  
