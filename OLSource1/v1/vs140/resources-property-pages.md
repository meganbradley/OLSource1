...
For more information on using the resource compiler, see [Using RC (The RC Command Line)](http://msdn.microsoft.com/library/windows/desktop/aa381055).  
 ...
 For information on how to access the **Resources** property pages, see [How To: Specify Project Properties with Property Pages](../vs140/how-to--specify-project-properties-with-property-pages.md).  
