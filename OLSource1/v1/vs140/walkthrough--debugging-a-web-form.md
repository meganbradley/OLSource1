...
11. Double-click the button control you dropped.  
     ...
     This takes you to the code page: Default.aspx.cs for C# or Default.aspx.vb for [!INCLUDE[vbprvb](../vs140/includes/vbprvb_md.md)]. The cursor should be in the function <CodeContentPlaceHolder>5\</CodeContentPlaceHolder>.  
  
12. In the <CodeContentPlaceHolder>6\</CodeContentPlaceHolder> function, add the following code:  
...
6.  In the **Watch** window, type **TextBox1.Text**.  
     ...
     The **Watch** window shows the value of the variable <CodeContentPlaceHolder>7\</CodeContentPlaceHolder>:  
  
<CodeContentPlaceHolder>2\</CodeContentPlaceHolder>  
7.  On the **Debug** menu, click **Step Over**.  
  
     The value of <CodeContentPlaceHolder>8\</CodeContentPlaceHolder> changes in the **Watch** window to read:  
