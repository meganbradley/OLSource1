...
The C run-time library provides extensive debugging support. To use one of the CRT debug libraries, you must link with [/DEBUG](../vs140/-debug--generate-debug-info-.md) and compile with **/MDd**, **/MTd**, or **/LDd**.  
