...
## Organize Usings  
 ...
 When selected, <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> using directives appear before other using directives. For more information, see [Sort Usings](../vs140/sort-usings.md).  
