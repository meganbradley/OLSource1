...
```  
 ...
 In the [Select Clause (Visual Basic)](../vs140/select-clause--visual-basic-.md) clause, an object initializer is used to instantiate each new `Student` object by using the data from the two sources.  
