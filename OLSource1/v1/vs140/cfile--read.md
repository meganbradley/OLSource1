...
---
# CFile::Read
Reads data into a buffer from the file associated with the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> object.  
...
## Return Value  
 The number of bytes transferred to the buffer. Note that for all <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> classes, the return value may be less than <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> if the end of file was reached.  
