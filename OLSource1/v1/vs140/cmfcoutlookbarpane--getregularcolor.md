...
## Remarks  
 Use [CMFCOutlookBarPane::SetTextColor](../vs140/cmfcoutlookbarpane--settextcolor.md) to set the current (regular and selected) text color of the Outlook bar. You can obtain the default text color by calling the [GetSysColor](http://msdn.microsoft.com/library/windows/desktop/ms724371) function with the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> index.  
