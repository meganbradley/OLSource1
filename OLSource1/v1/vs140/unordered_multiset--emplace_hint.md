...
ms.topic: "article"
f1_keywords: 
  - "std.tr1.unordered_multiset.emplace_hint"
  - "unordered_multiset::emplace_hint"
  - "unordered_multiset.emplace_hint"
  - "unordered_set/std::tr1::unordered_multiset::emplace_hint"
  - "std::tr1::unordered_multiset::emplace_hint"
dev_langs: 
  - "C++"
helpviewer_keywords: 
...
|<CodeContentPlaceHolder>1\</CodeContentPlaceHolder>|The arguments forwarded to construct an element to be inserted into the unordered_multiset.|  
