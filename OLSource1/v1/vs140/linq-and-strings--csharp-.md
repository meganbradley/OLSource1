...
---
# LINQ and Strings (C#)
LINQ can be used to query and transform strings and collections of strings. It can be especially useful with semi-structured data in text files. LINQ queries can be combined with traditional string functions and regular expressions. For example, you can use the [Split](assetId:///M:System.String.Split(System.Char[])?qualifyHint=False&autoUpgrade=True) or [Split](assetId:///M:System.Text.RegularExpressions.Regex.Split(System.String)?qualifyHint=False&autoUpgrade=True) method to create an array of strings that you can then query or modify by using LINQ. You can use the [IsMatch](assetId:///M:System.Text.RegularExpressions.Regex.IsMatch(System.String)?qualifyHint=False&autoUpgrade=True) method in the `where` clause of a LINQ query. And you can use LINQ to query or modify the <xref:System.Text.RegularExpressions.MatchCollection*> results returned by a regular expression.  
  
 You can also use the techniques described in this section to transform semi-structured text data to XML. For more information, see [How to: Generate XML from CSV Files](../vs140/how-to--generate-xml-from-csv-files.md).  
  
 The examples in this section fall into two categories:  
  
## Querying a Block of Text  
 You can query, analyze, and modify text blocks by splitting them into a queryable array of smaller strings by using the assetId:///M:System.String.Split(System.Char[])?qualifyHint=False&autoUpgrade=True method or the assetId:///M:System.Text.RegularExpressions.Regex.Split(System.String)?qualifyHint=False&autoUpgrade=True method. You can split the source text into words, sentences, paragraphs, pages, or any other criteria, and then perform additional splits if they are required in your query.  
  
 [How to: Count Occurrences of a Word in a String (LINQ) (C#)](../vs140/how-to--count-occurrences-of-a-word-in-a-string--linq---csharp-.md)  
 ...
 [How to: Query for Characters in a String (LINQ) (C#)](../vs140/how-to--query-for-characters-in-a-string--linq---csharp-.md)  
...
## Querying Semi-Structured Data in Text Format  
 ...
 [How to: Reorder the Fields of a Delimited File (LINQ) (C#)](../vs140/how-to--reorder-the-fields-of-a-delimited-file--linq---csharp-.md)  
