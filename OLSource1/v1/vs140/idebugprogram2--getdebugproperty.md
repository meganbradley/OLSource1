...
## Remarks  
 ...
 A program may expose any number and type of additional properties that can be described through the <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> interface. An IDE might display the additional program properties through a generic property browser user interface.  
