...
-   If you want to override the procedure, make the parameter list exactly the same as the parameter list in the base class procedure. If the last parameter is declared with <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> in the base class procedure, declare it with <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> in the overriding procedure.  
