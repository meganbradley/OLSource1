...
#### Parameters  
 ...
 [out] Returns <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> if the UDT has been aligned to some memory boundary; otherwise, returns <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>.  
