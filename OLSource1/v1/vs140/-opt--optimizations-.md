 ...
 **/OPT:REF** eliminates functions and data that are never referenced; **/OPT:NOREF** keeps functions and data that are never referenced.  
 ...
 You have to explicitly mark `const` data as a COMDAT; use [__declspec(selectany)](../vs140/selectany.md).  
 ...
 **ICF[=**  `iterations` **] &#124; NOICF**  
 ...
 To place functions in COMDATs, you use the **/Gy** compiler option; to place `const` data, you declare it `__declspec(selectany)`. For information about how to specify data for folding, see [selectany](../vs140/selectany.md).  
