...
-   [Debug.Assert](assetId:///M:System.Diagnostics.Debug.Assert(System.Boolean)?qualifyHint=True&autoUpgrade=True) and [Trace.Assert](assetId:///M:System.Diagnostics.Trace.Assert(System.Boolean)?qualifyHint=True&autoUpgrade=True) methods, which break execution and outputs information if a specified condition fails. By default, the `Assert` method displays the information in a dialog box. For more information, see [Assertions in Managed Code](../vs140/assertions-in-managed-code.md).  
  
-   The [Debug.Fail](assetId:///M:System.Diagnostics.Debug.Fail(System.String)?qualifyHint=True&autoUpgrade=True) and [Trace.Fail](assetId:///M:System.Diagnostics.Trace.Fail(System.String)?qualifyHint=True&autoUpgrade=True) methods, which always breaks execution and outputs information. By default, the `Fail` methods display the information in a dialog box.  
