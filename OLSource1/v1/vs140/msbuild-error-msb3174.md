...
|<xref:Microsoft.Build.Tasks.GenerateManifestBase.AssemblyVersion*>|Has the same requirements as [Version](assetId:///M:System.Version.#ctor(System.String)?qualifyHint=False&autoUpgrade=True). All octets must be greater than 0. Must specify all four octets. An empty string is acceptable.|  
|<xref:Microsoft.Build.Tasks.GenerateApplicationManifest.ClrVersion*>|Has the same requirements as assetId:///M:System.Version.#ctor(System.String)?qualifyHint=False&autoUpgrade=True. All octets must be greater than 0. Must specify all four octets. An empty string is acceptable.|  
|<xref:Microsoft.Build.Tasks.GenerateApplicationManifest.OSVersion*>|Has the same requirements as assetId:///M:System.Version.#ctor(System.String)?qualifyHint=False&autoUpgrade=True. All octets must be greater than 0. Must specify all four octets. An empty string is acceptable.|  
...
|<xref:Microsoft.Build.Tasks.GenerateManifestBase.TargetCulture*>|Can be an empty string. Can also be a neutral culture (specified by the two-digit lowercase language code only, for example, "jp" for Japanese). Otherwise, this value has the same requirements as [CultureInfo](assetId:///M:System.Globalization.CultureInfo.#ctor(System.String)?qualifyHint=False&autoUpgrade=True).|  
...
|---------------|------------------|  
|<xref:Microsoft.Build.Tasks.GenerateManifestBase.AssemblyName*>|Must be a valid file name.|  
|<xref:Microsoft.Build.Tasks.GenerateManifestBase.AssemblyVersion*>|Has the same requirements as assetId:///M:System.Version.#ctor(System.String)?qualifyHint=False&autoUpgrade=True. All octets must be greater than 0. Must specify all four octets. An empty string is acceptable.|  
|<xref:Microsoft.Build.Tasks.GenerateDeploymentManifest.MinimumRequiredVersion*>|Has the same requirements as assetId:///M:System.Version.#ctor(System.String)?qualifyHint=False&autoUpgrade=True. All octets must be greater than 0. An empty string is acceptable.|  
|<xref:Microsoft.Build.Tasks.GenerateManifestBase.Platform*>|Must be **AnyCPU**, **x86**, **x64**, or **Itanium**. An empty string is acceptable.|  
|<xref:Microsoft.Build.Tasks.GenerateManifestBase.TargetCulture*>|Can be an empty string. Can also be a neutral culture (specified by the two-digit lowercase language code only, for example, "jp" for Japanese). Otherwise, this value has the same requirements as assetId:///M:System.Globalization.CultureInfo.#ctor(System.String)?qualifyHint=False&autoUpgrade=True.|  
