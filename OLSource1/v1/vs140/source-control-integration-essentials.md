...
1.  Create and register your own source control VSPackage, as described in [Source-Control VSPackage Registration and Selection](../vs140/registration-and-selection--source-control-vspackage-.md).  
