...
|Element|Description|  
|-------------|-----------------|  
|[VisibilityConstraints](../vs140/visibilityconstraints-element.md)|The <CodeContentPlaceHolder>7\</CodeContentPlaceHolder> element determines the static visibility of groups of commands and toolbars.|  
