...
|-----------|--------------------|  
|<CodeContentPlaceHolder>1\</CodeContentPlaceHolder>|\<xref:Microsoft.VisualStudio.Shell.Interop.IVsProject3*>\<br />\<br /> \<xref:Microsoft.VisualStudio.Shell.Interop.IVsCfgProvider2*>\<br />\<br /> \<xref:Microsoft.VisualStudio.Shell.Interop.IPersistFileFormat*>\<br />\<br /> \<xref:Microsoft.VisualStudio.Shell.Interop.IVsSolutionEvents*>|  
|<CodeContentPlaceHolder>2\</CodeContentPlaceHolder>|\<xref:Microsoft.VisualStudio.Shell.Interop.IVsProjectFactory*>|  
|<CodeContentPlaceHolder>3\</CodeContentPlaceHolder>|\<xref:Microsoft.VisualStudio.Shell.Interop.IVsHierarchy*>|  
...
|<CodeContentPlaceHolder>5\</CodeContentPlaceHolder>|\<xref:Microsoft.VisualStudio.OLE.Interop.IPropertyPageSite*>|  
  
 <CodeContentPlaceHolder>6\</CodeContentPlaceHolder> class is a wrapper for MSBuild items.  
