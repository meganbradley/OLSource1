...
## Remarks  
 ...
 In Debug builds, this method generates an assertion failure if the index that is specified by <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> is invalid.  
