...
The declaration of a local variable within a generic procedure specifies <CodeContentPlaceHolder>0\</CodeContentPlaceHolder>.  
...
-   Remove the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> keyword from the variable declaration.  
