...
|---------------|-----------------|  
|[in] <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>|The number of pixels per second to scroll.|  
|[in] <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>|The time interval between updates of the control.|  
