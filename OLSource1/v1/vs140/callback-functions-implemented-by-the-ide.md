...
## Related Sections  
 ...
 Examines the list of files for their current status. In addition, uses the <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> function to notify the caller when a file does not match the criteria for the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>.  
 ...
 Sets a wide variety of options. Each option starts with <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> and has its own defined set of values.  
