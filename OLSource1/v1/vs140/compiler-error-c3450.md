...
'type': not an attribute; cannot specify [System::AttributeUsageAttribute] or [Windows::Foundation::Metadata::AttributeUsageAttribute]  
 ...
 A user-defined managed attribute must inherit from [AttributeCollection](assetId:///M:System.ComponentModel.AttributeCollection.#ctor(System.Attribute[])?qualifyHint=False&autoUpgrade=True). A Windows Runtime attribute must be defined in the `Windows::Foundation::Metadata` namespace.  
