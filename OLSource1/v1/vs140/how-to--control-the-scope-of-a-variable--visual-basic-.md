...
-   Place the [Dim Statement](../vs140/dim-statement--visual-basic-.md) for the variable between the initiating and terminating declaration statements of that block, for example between the <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> and <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> statements of a <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> loop.  
  
     You can refer to the variable only from within the block.  
  
#### To make a variable visible only within a procedure  
  
-   Place the <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> statement for the variable inside the procedure but outside any block (such as a <CodeContentPlaceHolder>6\</CodeContentPlaceHolder>...<CodeContentPlaceHolder>7\</CodeContentPlaceHolder> block).  
...
1.  Place the <CodeContentPlaceHolder>8\</CodeContentPlaceHolder> statement for the variable inside the module, class, or structure, but outside any procedure.  
  
2.  Include the [Private](../vs140/private--visual-basic-.md) keyword in the <CodeContentPlaceHolder>9\</CodeContentPlaceHolder> statement.  
...
1.  Place the <CodeContentPlaceHolder>10\</CodeContentPlaceHolder> statement for the variable inside the module, class, or structure, but outside any procedure.  
  
2.  Include the [Friend](../vs140/friend--visual-basic-.md) or [Public](../vs140/public--visual-basic-.md) keyword in the <CodeContentPlaceHolder>11\</CodeContentPlaceHolder> statement.  
...
<CodeContentPlaceHolder>0\</CodeContentPlaceHolder>  
 In the preceding example, all the procedures defined in module <CodeContentPlaceHolder>12\</CodeContentPlaceHolder> can refer to the <CodeContentPlaceHolder>13\</CodeContentPlaceHolder> variable <CodeContentPlaceHolder>14\</CodeContentPlaceHolder>. When the <CodeContentPlaceHolder>15\</CodeContentPlaceHolder> procedure is called, it displays the contents of the string variable <CodeContentPlaceHolder>16\</CodeContentPlaceHolder> in a dialog box.  
  
 With the following alteration to the preceding example, the string variable <CodeContentPlaceHolder>17\</CodeContentPlaceHolder> can be referred to by code anywhere in the namespace of its declaration.  
