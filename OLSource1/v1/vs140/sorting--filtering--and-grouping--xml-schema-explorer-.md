...
1.  <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> nodes.  
  
2.  <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> nodes.  
  
3.  <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> nodes.  
  
4.  <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> nodes.  
  
5.  <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> nodes.  
  
6.  <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> nodes.  
  
7.  <CodeContentPlaceHolder>6\</CodeContentPlaceHolder> nodes.  
  
8.  <CodeContentPlaceHolder>7\</CodeContentPlaceHolder> nodes.  
  
9. <CodeContentPlaceHolder>8\</CodeContentPlaceHolder> nodes.  
  
### Sort By Name  
 When the **Sort By Name** option is selected, global nodes are sorted in the following order:  
  
1.  <CodeContentPlaceHolder>9\</CodeContentPlaceHolder> nodes (in alphabetical order of namespaces).  
  
2.  <CodeContentPlaceHolder>10\</CodeContentPlaceHolder> nodes (in alphabetical order of <CodeContentPlaceHolder>11\</CodeContentPlaceHolder> attributes).  
  
3.  <CodeContentPlaceHolder>12\</CodeContentPlaceHolder> nodes (in alphabetical order of <CodeContentPlaceHolder>13\</CodeContentPlaceHolder> attributes).  
