...
## Remarks  
 ...
 For more information on using `CStdioFile`, see the articles [Files in MFC](../vs140/files-in-mfc.md) and [File Handling](../vs140/file-handling.md) in the                 *Run-Time Library Reference*.  
