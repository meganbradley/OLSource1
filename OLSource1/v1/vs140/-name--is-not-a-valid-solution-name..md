...
This error generally occurs when the command <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> has been entered in the **Command** window or **Find/Command** box with an incorrectly formatted value for the argument /sln:*solutionname*.  
