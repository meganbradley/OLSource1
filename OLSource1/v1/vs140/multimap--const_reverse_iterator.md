...
## Remarks  
 A type <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> cannot modify the value of an element and is use to iterate through the multimap in reverse.  
...
## Example  
 See the example for [rend](../vs140/multimap--rend.md) for an example of how to declare and use <CodeContentPlaceHolder>10\</CodeContentPlaceHolder>.  
