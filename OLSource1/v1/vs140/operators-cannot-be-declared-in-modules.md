...
-   If you require an operation on the module, use a [Function Statement (Visual Basic)](../vs140/function-statement--visual-basic-.md) to define a <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> procedure that performs the operation.  
