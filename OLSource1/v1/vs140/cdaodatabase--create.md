...
helpviewer_keywords: 
  - "MDB databases"
  - "databases [C++], creating"
  - "Create method [C++]"
  - "DAO [C++], creating Jet databases"
  - "Jet databases [C++]"
  - "Jet databases [C++], creating"
  - "CDaoDatabase class, creating"
...
---
# CDaoDatabase::Create
To create a new Microsoft Jet (.MDB) database, call this member function after you construct a <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> object.  
