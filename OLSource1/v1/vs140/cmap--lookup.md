...
#### Parameters  
 ...
 Template parameter specifying the type of the <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> value.  
...
## Remarks  
 <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> uses a hashing algorithm to quickly find the map element with a key that exactly matches the given key.  
