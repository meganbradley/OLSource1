...
#### Parameters  
 ...
 <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> to specify that the color bar control is docked vertically; <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> to specify that the color bar control is docked horizontally.  
