...
This example declares an array of <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> objects named <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>, populates it, and then sorts it alphabetically.  
