...
-   Access to Mscorlib.dll and the <xref:System?qualifyHint=False> namespace.  
  
## Robust Programming  
 The following conditions may cause an exception:  
  
-   Array is empty (<xref:System.ArgumentNullException?qualifyHint=False> class)  
  
-   Array is multidimensional (<xref:System.RankException?qualifyHint=False> class)  
  
-   One or more elements of the array do not implement the <xref:System.IComparable?qualifyHint=False> interface (<xref:System.InvalidOperationException?qualifyHint=False> class)  
  
## See Also  
 <xref:System.Array.Sort?qualifyHint=True>   
