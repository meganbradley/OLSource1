...
The following table shows the default values of value types returned by the default constructors. Default constructors are invoked by using the <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> operator, as follows:  
...
|----------------|-------------------|  
|[bool](../vs140/bool--csharp-reference-.md)|<CodeContentPlaceHolder>3\</CodeContentPlaceHolder>|  
...
|[struct](../vs140/struct--csharp-reference-.md)|The value produced by setting all value-type fields to their default values and all reference-type fields to <CodeContentPlaceHolder>4\</CodeContentPlaceHolder>.|  
