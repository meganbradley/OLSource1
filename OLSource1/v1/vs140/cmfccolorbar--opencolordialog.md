...
## Return Value  
 <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> if the user selected a color; <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> if the user canceled the color dialog box.  
