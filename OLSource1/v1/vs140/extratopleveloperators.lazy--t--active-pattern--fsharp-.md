...
An active pattern to force the execution of values of type [Lazy](../vs140/control.lazy--t--type-abbreviation--fsharp-.md).  
...
#### Parameters  
 ...
 Type: [Lazy](../vs140/control.lazy--t--type-abbreviation--fsharp-.md)<CodeContentPlaceHolder>2\</CodeContentPlaceHolder>  
...
## Example  
 The following code illustrates the use of the <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> active pattern.  
  
 [!code[FsCoreLib2#8](../vs140/codesnippet/FSharp/extratopleveloperators.lazy--t--active-pattern--fsharp-_1.fs)]  
