...
Blocks execution of all threads in a tile until all threads in a tile have reached this call. This ensures that <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>memory accesses are visible to other threads in the thread tile, and have been executed in program order.  
