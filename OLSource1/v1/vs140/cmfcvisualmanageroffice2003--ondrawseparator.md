...
#### Parameters  
 ...
 <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> if the pane is docked horizontally, or <CodeContentPlaceHolder>6\</CodeContentPlaceHolder> if the pane is docked vertically.  
