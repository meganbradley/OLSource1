...
## Remarks  
 This method requires that you set either **DBPROP_CANFETCHBACKWARDS** or **DBPROP_CANSCROLLBACKWARDS** to <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> before calling **Open** on the table or command containing the rowset.  
