...
#### Parameters  
 ...
 Tab stops are set at every <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> dialog units. See *rgTabStops* for a description of a dialog unit.  
...
## Remarks  
 To set tab stops to the default size of 2 dialog units, call the parameterless version of this member function. To set tab stops to a size other than 2, call the version with the <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> argument.  
  
 To set tab stops to an array of sizes, use the version with the <CodeContentPlaceHolder>6\</CodeContentPlaceHolder> and <CodeContentPlaceHolder>7\</CodeContentPlaceHolder> arguments. A tab stop will be set for each value in <CodeContentPlaceHolder>8\</CodeContentPlaceHolder>, up to the number specified by <CodeContentPlaceHolder>9\</CodeContentPlaceHolder>.  
  
 To respond to a call to the <CodeContentPlaceHolder>10\</CodeContentPlaceHolder> member function, the list box must have been created with the [LBS_USETABSTOPS](../vs140/list-box-styles.md) style.  
