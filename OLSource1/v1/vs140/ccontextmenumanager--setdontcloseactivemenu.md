...
#### Parameters  
 ...
 A Boolean parameter that controls whether to close the active pop-up menu. A value of <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> indicates the active pop-up menu is not closed. <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> indicates that the active pop-up menu is closed.  
  
## Remarks  
 By default, the <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> closes the active pop-up menu.  
