...
2.  Set a breakpoint somewhere in the application that is easily reached, for example in **MainFrm.cpp**, at the start of <CodeContentPlaceHolder>0\</CodeContentPlaceHolder>.  
...
## Set Up Debugging with Remote Symbols  
 ...
 Starting in Visual Studio 2013 Update 2, you can use the following msvsmon command-line switch to use remote symbols for managed code: <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>  
