...
2.  Change the file name extension to <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>  
...
-   If a project contains a <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> file, code elements that are defined in that project will not be searched if they are named in the <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> section of the <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> file.  
  
-   Some kinds of generated code:  
  
    1.  <CodeContentPlaceHolder>6\</CodeContentPlaceHolder>, <CodeContentPlaceHolder>7\</CodeContentPlaceHolder>  
  
    2.  <CodeContentPlaceHolder>8\</CodeContentPlaceHolder> methods  
  
     However, this does not automatically apply to all generated code. For example, if you use text templates, you might want to exclude the generated files by naming them in a <CodeContentPlaceHolder>9\</CodeContentPlaceHolder> file.  
...
1.  Place the templates in a sub directory of the Visual Studio project. Name it, for example, <CodeContentPlaceHolder>10\</CodeContentPlaceHolder>.  
  
2.  Add a new text file to the project, and change its name and extension to <CodeContentPlaceHolder>11\</CodeContentPlaceHolder>  
