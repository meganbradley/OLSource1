...
-   Enter a Boolean expression in the **Filter by Boolean Expression** box. The debugger evaluates the expression for each thread context. Only rows where the value is <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> are displayed.  
