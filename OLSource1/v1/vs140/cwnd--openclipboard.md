...
## Return Value  
 Nonzero if the Clipboard is opened via <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>, or 0 if another application or window has the Clipboard open.  
...
## Remarks  
 ...
 The current <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> object will not become the owner of the Clipboard until the [EmptyClipboard](http://msdn.microsoft.com/library/windows/desktop/ms649037) Windows function is called.  
