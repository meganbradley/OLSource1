...
-   [JavaScript Validation](#Validation)  
 ...
 For more information about the IntelliSense functionality of [!INCLUDE[vs_current_short](../vs140/includes/vs_current_short_md.md)], see [Using IntelliSense](../vs140/using-intellisense.md).  
...
-   <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> elements with <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> attributes that point to another script file. The target script file must have the file-name extension .js.  
  
-   JavaScript files that reference other JavaScript files by using a <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> directive.  
...
-   The [!INCLUDE[atlaslib_current_ext](../vs140/includes/atlaslib_current_ext_md.md)], if you are working in an AJAX-enabled ASP.NET Web application.  
  
    > [!NOTE]
    >  IntelliSense is not supported for script that is in event-handler attributes on HTML elements, or that is defined in <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> attributes.  
...
-   Objects described using standard JavaScript comment tags (//). For more information, see [Extending JavaScript IntelliSense](../vs140/extending-javascript-intellisense.md).  
  
-   Objects supported using the [extensibility](#Extensibility) mechanism. For more information, see [Extending JavaScript IntelliSense](../vs140/extending-javascript-intellisense.md).  
  
-   [ASP.NET AJAX objects](#ASPNet)  
  
 When IntelliSense is unable to determine the type of an object, it provides options for statement completion using identifiers in the active document. For more information, see [Statement Completion using Identifiers](../vs140/statement-completion-for-identifiers.md).  
  
###  \<a name="HTMLDom">\</a> HTML DOM Elements  
 JavaScript IntelliSense provides programming references for Dynamic HTML (DHTML) DOM elements, such as <CodeContentPlaceHolder>6\</CodeContentPlaceHolder>, <CodeContentPlaceHolder>7\</CodeContentPlaceHolder>, and <CodeContentPlaceHolder>8\</CodeContentPlaceHolder>. Only the elements that are included in the current document and master page are displayed by IntelliSense. JavaScript IntelliSense also supports the <CodeContentPlaceHolder>9\</CodeContentPlaceHolder> and <CodeContentPlaceHolder>10\</CodeContentPlaceHolder> objects and their members.  
  
###  \<a name="IntrinsicObjects">\</a> Intrinsic Objects  
 JavaScript IntelliSense provides programming references for intrinsic objects such as <CodeContentPlaceHolder>11\</CodeContentPlaceHolder>, <CodeContentPlaceHolder>12\</CodeContentPlaceHolder>, <CodeContentPlaceHolder>13\</CodeContentPlaceHolder>, <CodeContentPlaceHolder>14\</CodeContentPlaceHolder>, and <CodeContentPlaceHolder>15\</CodeContentPlaceHolder>. For more information about intrinsic objects, see [Intrinsic Objects](assetId:///6520c634-a7d1-4a05-8c1b-2e79f449d2e4).  
  
###  \<a name="UserDefined">\</a> User-defined Variables, Functions, and Objects  
 When you change a JavaScript file, [!INCLUDE[vs_current_short](../vs140/includes/vs_current_short_md.md)] scans opened and referenced documents to determine all available code resources. This includes the variables, functions, and objects that you have created. These resources are then available to JavaScript IntelliSense.  
...
####  \<a name="Script">\</a> Script References  
 ...
 If you are not working with an ASP.NET AJAX-enabled Web page, you can reference an external script file by using the <CodeContentPlaceHolder>16\</CodeContentPlaceHolder> attribute in the opening tag of a <CodeContentPlaceHolder>17\</CodeContentPlaceHolder> element. The <CodeContentPlaceHolder>18\</CodeContentPlaceHolder> attribute specifies the URL to an external file that contains the source code or data.  
  
 The following example shows markup that uses the <CodeContentPlaceHolder>19\</CodeContentPlaceHolder> attribute in a <<CodeContentPlaceHolder>20\</CodeContentPlaceHolder>> tag to reference a script file.  
...
<CodeContentPlaceHolder>1\</CodeContentPlaceHolder>  
 IntelliSense also supports script files that are embedded as resources in an assembly in ASP.NET AJAX Web applications. For more information about embedded script resources, see [Embedding a JavaScript File as a Resource in an Assembly](assetId:///d8cb78cd-95a9-4dc6-92df-391866817e89).  
  
####  \<a name="ReferenceDirectives">\</a> Reference Directives  
 A <CodeContentPlaceHolder>21\</CodeContentPlaceHolder> directive enables [!INCLUDE[vs_current_short](../vs140/includes/vs_current_short_md.md)] to establish a relationship between the script you are currently editing and other scripts. The <CodeContentPlaceHolder>22\</CodeContentPlaceHolder> directive lets you include a script file in the scripting context of the current script file. This enables IntelliSense to reference externally defined functions, types, and fields as you code.  
  
 You create a <CodeContentPlaceHolder>23\</CodeContentPlaceHolder> directive in the form of an XML comment. The directive must be declared earlier in the file than any script. A <CodeContentPlaceHolder>24\</CodeContentPlaceHolder> directive can include a disk-based script reference, an assembly-based script reference, a service-based script reference, or a page-based script reference.  
...
>  JavaScript IntelliSense is not supported for script that is contained in Web service (.asmx) files in Web Application Projects (WAP).  
 ...
 The following rules apply to a <CodeContentPlaceHolder>38\</CodeContentPlaceHolder> directive.  
  
-   The <CodeContentPlaceHolder>39\</CodeContentPlaceHolder> XML comment must be declared before any script.  
...
-   File names use relative paths. You can use the tilde operator (<CodeContentPlaceHolder>40\</CodeContentPlaceHolder>) to make application-root-relative paths.  
...
-   Implicit (Windows), for [!INCLUDE[win8_appname_long](../vs140/includes/win8_appname_long_md.md)] apps using JavaScript. Files included in this group are in scope for every .js file opened in the Code Editor for the project of the specified type.  
...
>  Except for Web projects, this feature works only for JavaScript files that are opened outside the context of a project. For Web projects, remote files referenced in your project are downloaded by default.  
 ...
 For instructions about using this feature, see [Options, Text Editor, JavaScript, IntelliSense](../vs140/options--text-editor--javascript--intellisense.md).  
...
## See Also  
 ...
 [How to: Create JavaScript XML Documentation Comments](../vs140/create-xml-documentation-comments-for-javascript-intellisense.md)   
 [Extending JavaScript IntelliSense](../vs140/extending-javascript-intellisense.md)   
 [Statement Completion using Identifiers](../vs140/statement-completion-for-identifiers.md)   
