...
apitype: "Assembly"
f1_keywords: 
  - "Microsoft.FSharp.Quotations.PatternsModule.DefaultValuePattern"
dev_langs: 
  - "FSharp"
helpviewer_keywords: 
  - "DefaultValue active pattern [F#]"
...
## Return Value  
 The formal return type is <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>. The option indicates whether the input results in a match. In a pattern matching expression, the input is decomposed, upon a successful match, into a type object that represents the type that is being constructed.  
