...
2.  Override the <xref:Microsoft.VisualStudio.Shell.Package.Initialize*> method.  
     ...
     In your implementation of the <xref:Microsoft.VisualStudio.Shell.Package.Initialize*> method, call the [RegisterEditorFactory](assetId:///M:Microsoft.VisualStudio.Shell.Package.RegisterEditorFactory(Microsoft.VisualStudio.Shell.Interop.IVsEditorFactory)?qualifyHint=False&autoUpgrade=True) method and pass the instance of your editor factory as demonstrated below.  
...
3.  Unregister the editor factories.  
     ...
     Editor factories are automatically unregistered when the VSPackage is disposed. If the editor factory object implements the <xref:System.IDisposable*> interface, its `Dispose` method is called after the factory has been unregistered with [!INCLUDE[vsprvs](../vs140/includes/vsprvs_md.md)].  
...
3.  Register the editor factory.  
     ...
     The editor factory is registered in the [RegisterEditor](assetId:///M:Microsoft.VisualStudio.Shell.Interop.IVsRegisterEditors.RegisterEditor(System.Guid@,Microsoft.VisualStudio.Shell.Interop.IVsEditorFactory,System.UInt32@)?qualifyHint=False&autoUpgrade=True) implementation.  
