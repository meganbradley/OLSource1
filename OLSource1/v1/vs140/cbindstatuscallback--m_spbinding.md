...
---
# CBindStatusCallback::m_spBinding
A pointer to the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> interface of the current bind operation.  
  
## Syntax  
  
<CodeContentPlaceHolder>0\</CodeContentPlaceHolder>  
## Remarks  
 Initialized in <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> and released in <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>.  
