...
## Remarks  
 If you want to initialize the various file dialog-box options by setting members of the **m_ofn** structure, you should do this before calling <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>, but after the dialog object is constructed.  
  
 For example, if you want to allow the user to select multiple files, set the <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> flag before calling <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>, as shown in the code example in [CFileDialog Class](../vs140/cfiledialog-class.md).  
 ...
 <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> is a virtual function overridden from class <CodeContentPlaceHolder>5\</CodeContentPlaceHolder>.  
