...
5.  On the **Select Template Options** page, set **Template Name** to <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> and **Template Description** to <CodeContentPlaceHolder>5\</CodeContentPlaceHolder>  
  
6.  Next to the **Icon Image** box, click **Browse**. In the **File name** box, type <CodeContentPlaceHolder>6\</CodeContentPlaceHolder>. Locate Color.bmp and click **Open**.  
  
7.  Next to the **Preview Image** box, click **Browse**. In the **File name** box, type <CodeContentPlaceHolder>7\</CodeContentPlaceHolder>. Locate ScreenShot.bmp and click **Open**. Click **Next**.  
  
     ![Select template options](../vs140/media/pcwc_selecttemplateoptions2.png "PCWC_SelectTemplateOptions2")  
  
8.  On the **Select VSIX Options** page, change **Product Name** to <CodeContentPlaceHolder>8\</CodeContentPlaceHolder>.  
...
8.  Set **Category** to <CodeContentPlaceHolder>9\</CodeContentPlaceHolder> and **Tags** to <CodeContentPlaceHolder>10\</CodeContentPlaceHolder>.  
...
3.  Set **Name** to <CodeContentPlaceHolder>11\</CodeContentPlaceHolder>. Click **OK**.  
...
6.  In the <CodeContentPlaceHolder>12\</CodeContentPlaceHolder> attribute, replace both occurrences of <CodeContentPlaceHolder>13\</CodeContentPlaceHolder> with <CodeContentPlaceHolder>14\</CodeContentPlaceHolder>.  
...
7.  In the <CodeContentPlaceHolder>15\</CodeContentPlaceHolder> method, change <CodeContentPlaceHolder>16\</CodeContentPlaceHolder> to <CodeContentPlaceHolder>17\</CodeContentPlaceHolder>.  
...
5.  Drag a BlueColorTextControl somewhere in the <CodeContentPlaceHolder>18\</CodeContentPlaceHolder> tag of the web page.  
  
6.  In the <CodeContentPlaceHolder>19\</CodeContentPlaceHolder> tag, add a <CodeContentPlaceHolder>20\</CodeContentPlaceHolder> attribute and make its value <CodeContentPlaceHolder>21\</CodeContentPlaceHolder>. The resulting tag should resemble the following one.  
...
9. To complete the uninstallation process, restart Visual Studio.  
 ...
 The debug action wizard must have a public implementation of <CodeContentPlaceHolder>22\</CodeContentPlaceHolder>, and must be signed by using a strong assembly name.  
  
#### To create the debug action wizard  
  
1.  In the **New Project** dialog box, create a **Visual C#**, **Windows**, **Class Library** project and name it <CodeContentPlaceHolder>23\</CodeContentPlaceHolder>.  
...
7.  Set **Key file name** to <CodeContentPlaceHolder>24\</CodeContentPlaceHolder> and clear the **Protect my key file with a password** option.  
