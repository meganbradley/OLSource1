...
dev_langs: 
  - "C++"
helpviewer_keywords: 
  - "CreateDIBPatternBrush method"
  - "device-independent bitmap brush"
  - "DIB brush"
 ...
 *lpPackedDIB*  
 Points to a packed DIB consisting of a <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> structure immediately followed by an array of bytes defining the pixels of the bitmap.  
...
## Example  
 [!code[NVC_MFCDocView#23](../vs140/codesnippet/CPP/cbrush--createdibpatternbrush_1.cpp)]  
