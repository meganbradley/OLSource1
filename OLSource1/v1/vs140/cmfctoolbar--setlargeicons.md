...
#### Parameters  
 ...
 A Boolean value that specifies which icons to use. If this parameter is <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>, the framework displays large icons. Otherwise, the framework displays regular icons.  
