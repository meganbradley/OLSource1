...
#### Parameters  
 ...
 A long pointer to a <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> structure.  
...
|1|Item 1 sorts after item 2.|  
 ...
 See [CWnd::OnCompareItem](../vs140/cwnd--oncompareitem.md) for a description of the <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> structure.  
