...
apitype: "Assembly"
f1_keywords: 
  - "Microsoft.FSharp.Collections.SetModule.IsEmpty``1"
dev_langs: 
  - "FSharp"
helpviewer_keywords: 
  - "Set.isEmpty function [F#]"
  - "isEmpty function [F#]"
...
Returns <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> if the set is empty.  
...
## Return Value  
 <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> if <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> is empty. Otherwise, returns <CodeContentPlaceHolder>6\</CodeContentPlaceHolder>.  
