 ...
 *RelationshipName.PropertyName/!Role*  
 ...
 The name that you use for the element-to-link hop is the value of the role's <CodeContentPlaceHolder>0\</CodeContentPlaceHolder>. The name that you use for the link-to-element hop is the target role name.  
