...
## Example  
 The following code example calls <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> in a loop, and <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> calls the <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> function. The <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> modifier causes the inline expansion of the <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> function.  
