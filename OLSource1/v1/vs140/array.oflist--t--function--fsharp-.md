...
## Example  
 The following code example demonstrates the use of <CodeContentPlaceHolder>4\</CodeContentPlaceHolder>.  
  
 [!code[FsArrays#59](../vs140/codesnippet/FSharp/array.oflist--t--function--fsharp-_1.fs)]  
