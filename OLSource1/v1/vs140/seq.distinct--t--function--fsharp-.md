...
## Example  
 The following example demonstrates the use of <CodeContentPlaceHolder>4\</CodeContentPlaceHolder>. The example generates the binary representation of a number as a sequence. It then determines that the only unique numbers are 0 and 1.  
