...
## Remarks  
 ...
 For <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>, but not for <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>, the semantics of **Close** are affected by the socket options **SO_LINGER** and **SO_DONTLINGER**. For further information, see member function <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>.  
