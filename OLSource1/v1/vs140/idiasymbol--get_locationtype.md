...
#### Parameters  
 ...
 [out] Returns a value from the [LocationType](../vs140/locationtype.md) enumeration that specifies the location type of a data symbol, such as <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> or <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>.  
