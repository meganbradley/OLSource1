...
3.  If necessary, create a new string value named <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>.  
  
4.  Set the <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> value to <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>.  
