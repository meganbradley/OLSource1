...
apitype: "Assembly"
f1_keywords: 
  - "Microsoft.FSharp.Core.Operators.Lock``2"
dev_langs: 
  - "FSharp"
helpviewer_keywords: 
  - "lock function [F#]"
  - "Operators.lock function [F#]"
...
#### Parameters  
 ...
 Type: [unit](../vs140/core.unit-type-abbreviation--fsharp-.md) <CodeContentPlaceHolder>4\</CodeContentPlaceHolder>  
