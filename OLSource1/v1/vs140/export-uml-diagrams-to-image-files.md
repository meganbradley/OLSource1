...
>  To make this code work as a menu command, you must incorporate it into a MEF component. For more information, see [How to Define a Menu Command](../vs140/define-a-menu-command-on-a-modeling-diagram.md).  
 ...
 The code first uses <xref:Microsoft.VisualStudio.ArchitectureTools.Extensibility.Presentation.IShape.GetObject``1*> to get the <xref:Microsoft.VisualStudio.Modeling.Diagrams.Diagram*> of the underlying implementation. This type has a method [M:Microsoft.VisualStudio.Modeling.Diagrams.Diagram.CreateBitmap(System.Collections.ICollection,Microsoft.VisualStudio.Modeling.Diagrams.Diagram.CreateBitmapPreference)](assetId:///M:Microsoft.VisualStudio.Modeling.Diagrams.Diagram.CreateBitmap(System.Collections.ICollection,Microsoft.VisualStudio.Modeling.Diagrams.Diagram.CreateBitmapPreference)?qualifyHint=False&autoUpgrade=True).  
