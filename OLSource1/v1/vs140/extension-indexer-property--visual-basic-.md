...
## Remarks  
 ...
 To access the value of the first element in a collection of \<xref:System.Xml.Linq.XElement*> or \<xref:System.Xml.Linq.XAttribute*> objects, you can use the XML `Value` property. For more information, see [XML Value Property](../vs140/xml-value-property--visual-basic-.md).  
