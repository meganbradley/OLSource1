...
## Remarks  
 Each of these functions creates a new process and executes it, and passes an array of pointers to command-line arguments and uses the <CodeContentPlaceHolder>28\</CodeContentPlaceHolder> environment variable to find the file to execute.  
