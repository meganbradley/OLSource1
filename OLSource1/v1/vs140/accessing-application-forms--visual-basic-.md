...
The <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> object provides an easy way to access an instance of each Windows Form declared in the application's project. You can also use properties of the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> object to access the application's splash screen and main form, and get a list of the application's open forms.  
...
|-|-|  
|To|See|  
|Access one form from another form in an application.|[My.Forms Object (Visual Basic)](../vs140/my.forms-object.md)|  
