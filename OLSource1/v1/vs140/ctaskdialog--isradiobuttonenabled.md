...
## Return Value  
 <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> if the radio button is enabled, <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> if it is not.  
  
## Remarks  
 If <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> is not a valid identifier for a radio button, this method throws an exception.  
