...
## Example  
 The following code illustrates the use of <CodeContentPlaceHolder>4\</CodeContentPlaceHolder>.  
  
 [!code[FsOptions#7](../vs140/codesnippet/FSharp/option.get--t--function--fsharp-_1.fs)]  
