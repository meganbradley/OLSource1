...
3.  Use the `My.Computer.Ports.OpenSerialPort` method to obtain a reference to the port. For more information, see [OpenSerialPort](assetId:///M:Microsoft.VisualBasic.Devices.Ports.OpenSerialPort(System.String)?qualifyHint=False&autoUpgrade=True).  
