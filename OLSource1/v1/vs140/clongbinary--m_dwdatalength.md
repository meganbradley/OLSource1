...
---
# CLongBinary::m_dwDataLength
Stores the actual size in bytes of the data stored in the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> handle in <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>.  
