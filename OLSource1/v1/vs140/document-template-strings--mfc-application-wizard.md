...
|**File new short name**|Sets the name appearing in the standard Windows <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> dialog box, if there is more than one new document template. If your application is an [Automation server](../vs140/automation-servers.md), this name is used as the short name of your Automation object. By default, the project name.|  
