...
When uploading and downloading files with the [My.Computer.Network Object](../vs140/my.computer.network-object.md), you must specify a `connectionTimeout` greater than `0`.  
