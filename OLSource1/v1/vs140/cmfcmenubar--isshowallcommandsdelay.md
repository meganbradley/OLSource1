...
-   Display the full menu after the user clicks the arrow at the bottom of the menu.  
 ...
 By default, all <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> objects use the option to display the full menu after a short delay. This option cannot be changed programmatically in the <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> class. However, a user can change the behavior during toolbar customization by using the **Customize** dialog box..  
