...
---
# ManagedType
A managed type (any symbol defined by metadata, or native to the memory and resource management functionality of languages such as C#) is identified by a <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> symbol.  
...
|--------------|---------------|-----------------|  
|[IDiaSymbol::get_name](../vs140/idiasymbol--get_name.md)|<CodeContentPlaceHolder>1\</CodeContentPlaceHolder>|Name of the managed symbol.|  
