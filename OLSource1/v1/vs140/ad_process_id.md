...
## Members  
 ...
 A value from the [AD_PROCESS_ID_TYPE](../vs140/ad_process_id_type.md) enumeration specifying how to interpret the <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> union (or, for managed code, which member of the structure to access).  
