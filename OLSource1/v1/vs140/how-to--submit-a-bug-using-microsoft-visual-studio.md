...
>  Using Visual Studio to submit a bug does not automatically add data that was collected when a test was run, unlike when you create a bug using Test Runner or the Exploratory Testing window from Microsoft Test Manager. For more information about these methods, see [Submitting Bugs](../vs140/submitting-bugs-in-microsoft-test-manager.md).  
 ...
 ![Create bug in Visual Studio](../vs140/media/vs_createbug1.png "VS_CreateBug1")  
  
 ![New bug form in Vsual Studio](../vs140/media/vs_createbug2.png "VS_CreateBug2")  
...
1.  To create a bug, you must first connect to your Team Foundation Server. On the **TEAM** menu, choose **Connect to Team Foundation Server**. Select the server from the list of servers.  
     ...
     For more information about how to connect to [!INCLUDE[esprtfs](../vs140/includes/esprtfs_md.md)], see [How to: Connect to a Team Project in Team Foundation Server](assetId:///25b3fe4f-ee89-4b58-ba19-4c94a47636a6).  
