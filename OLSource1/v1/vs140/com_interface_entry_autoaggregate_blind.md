...
---
# COM_INTERFACE_ENTRY_AUTOAGGREGATE_BLIND
Same as [COM_INTERFACE_ENTRY_AUTOAGGREGATE](../vs140/com_interface_entry_autoaggregate.md), except that querying for any IID results in forwarding the query to <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>, and if <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> is **NULL**, automatically creating the aggregate described by the <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>.  
...
#### Parameters  
 ...
 [in] The identifier of the aggregate that will be created if <CodeContentPlaceHolder>6\</CodeContentPlaceHolder> is **NULL**.  
