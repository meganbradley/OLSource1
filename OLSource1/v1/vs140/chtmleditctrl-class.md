...
|Name|Description|  
|----------|-----------------|  
|[CHtmlEditCtrl::CHtmlEditCtrl](#chtmleditctrl__chtmleditctrl)|Constructs a <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> object.|  
  
### Public Methods  
  
|Name|Description|  
|----------|-----------------|  
|[CHtmlEditCtrl::Create](#chtmleditctrl__create)|Creates a WebBrowser ActiveX control and attaches it to the <CodeContentPlaceHolder>6\</CodeContentPlaceHolder> object. This function automatically puts the WebBrowser ActiveX control into edit mode.|  
...
##  \<a name="chtmleditctrl__create">\</a>  CHtmlEditCtrl::Create  
 Creates a WebBrowser ActiveX control and attaches it to the <CodeContentPlaceHolder>9\</CodeContentPlaceHolder> object. The WebBrowser ActiveX control automatically navigates to a default document and then is placed in edit mode by this function.  
