...
## Remarks  
 The sink implements the outgoing interface supported by the connection point. The client uses the <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> cookie to remove the connection by passing it to [AtlUnadvise](../vs140/atlunadvise.md).  
  
## Example  
 [!code[NVC_ATL_Windowing#91](../vs140/codesnippet/CPP/atladvise_1.cpp)]  
