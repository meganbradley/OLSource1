...
7.  Start the profiler. Type:  
    ...
    |[/waitstart](../vs140/waitstart.md)[**:**<CodeContentPlaceHolder>6\</CodeContentPlaceHolder>]|Specifies the number of seconds to wait for the profiler to initialize before it returns an error. If <CodeContentPlaceHolder>7\</CodeContentPlaceHolder> is not specified, the profiler waits indefinitely. By default, **/start** returns immediately.|  
    ...
    |[/counter](../vs140/counter.md) **:** <CodeContentPlaceHolder>8\</CodeContentPlaceHolder>|Collects information from the processor performance counter specified in Config. Counter information is added to the data collected at each profiling event.|  
    |[/wincounter](../vs140/wincounter.md) **:** <CodeContentPlaceHolder>9\</CodeContentPlaceHolder>|Specifies a Windows performance counter to be collected during profiling.|  
    |[/automark](../vs140/automark.md) **:** <CodeContentPlaceHolder>10\</CodeContentPlaceHolder>|Use with **/wincounter** only. Specifies the number of milliseconds between Windows performance counter collection events. Default is 500 ms.|  
    |[/events](../vs140/events--vsperfcmd-.md) **:** <CodeContentPlaceHolder>11\</CodeContentPlaceHolder>|Specifies an Event Tracing for Windows (ETW) event to be collected during profiling. ETW events are collected in a separate (.etl) file.|  
  
8.  If necessary, start the service.  
  
9. Attach the profiler to the service. Type:  
  
     **VSPerfCmd /attach:** <CodeContentPlaceHolder>12\</CodeContentPlaceHolder>&#124;<CodeContentPlaceHolder>13\</CodeContentPlaceHolder>  
...
-   The following pairs of **VSPerfCmd** options start and stop data collection. Specify each option on a separate command line. You can turn data collection on and off multiple times.  
    ...
    |[/processon](../vs140/processon-and-processoff.md) **:** <CodeContentPlaceHolder>14\</CodeContentPlaceHolder> [/processoff](../vs140/processon-and-processoff.md) **:** <CodeContentPlaceHolder>15\</CodeContentPlaceHolder>|Starts (**/processon**) or stops (**/processoff**) data collection for the process specified by the process ID (<CodeContentPlaceHolder>16\</CodeContentPlaceHolder>).|  
    |[/threadon](../vs140/threadon-and-threadoff.md) **:** <CodeContentPlaceHolder>17\</CodeContentPlaceHolder> [/threadoff](../vs140/threadon-and-threadoff.md) **:** <CodeContentPlaceHolder>18\</CodeContentPlaceHolder>|Starts (**/threadon**) or stops (**/threadoff**) data collection for the thread specified by the thread ID (<CodeContentPlaceHolder>19\</CodeContentPlaceHolder>).|  
