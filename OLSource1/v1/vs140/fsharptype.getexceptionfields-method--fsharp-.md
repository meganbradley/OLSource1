...
|Exception|Condition|  
|---------------|---------------|  
|<xref:System.ArgumentException?qualifyHint=False>|Thrown if the given type is not an exception.|  
  
## Return Value  
 An array containing the <xref:System.Reflection.PropertyInfo?qualifyHint=False> of each field in the exception.  
  
## Remarks  
 Assumes `exceptionType` is an exception representation type. If not, <xref:System.ArgumentException?qualifyHint=False> is raised.  
