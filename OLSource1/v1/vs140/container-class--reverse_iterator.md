...
## Remarks  
 It is described here as a synonym for the unspecified type **T7** (typically <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> **\<**[iterator](../vs140/container-class--iterator.md)**>**).  
