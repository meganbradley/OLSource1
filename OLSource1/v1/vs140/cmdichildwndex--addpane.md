...
## Return Value  
 <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> if the pane was successfully registered with the docking manager; otherwise, <CodeContentPlaceHolder>6\</CodeContentPlaceHolder>.  
