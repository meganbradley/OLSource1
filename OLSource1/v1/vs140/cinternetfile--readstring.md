...
## Remarks  
 The function places the resulting line into the memory referenced by the <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> parameter. It stops reading characters when it reaches the maximum number of characters, specified by <CodeContentPlaceHolder>5\</CodeContentPlaceHolder>. The buffer always receives a terminating null character.  
  
 If you call <CodeContentPlaceHolder>6\</CodeContentPlaceHolder> without first calling [SetReadBufferSize](../vs140/cinternetfile--setreadbuffersize.md), you will get a buffer of 4096 bytes.  
