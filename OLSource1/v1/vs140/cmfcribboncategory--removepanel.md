...
#### Parameters  
 ...
 <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> to delete the panel object from memory; <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> to remove the panel object without deleting it.  
