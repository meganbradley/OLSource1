...
1.  Get the number of items in the list of symbols by implementing the [GetItemCount](assetId:///M:Microsoft.VisualStudio.Shell.Interop.IVsSimpleObjectList2.GetItemCount(System.UInt32@)?qualifyHint=False&autoUpgrade=True) method. The following example demonstrates how the object manager obtains the information on the number of items in the list.  
...
3.  Get the text representation of a given list item by implementing the [GetTextWithOwnership](assetId:///M:Microsoft.VisualStudio.Shell.Interop.IVsSimpleObjectList2.GetTextWithOwnership(System.UInt32,Microsoft.VisualStudio.Shell.Interop.VSTREETEXTOPTIONS,System.String@)?qualifyHint=False&autoUpgrade=True) method. The following example demonstrates how to obtain a full name of a given item.  
...
4.  Get the icon information for a given list item by implementing the [GetDisplayData](assetId:///M:Microsoft.VisualStudio.Shell.Interop.IVsSimpleObjectList2.GetDisplayData(System.UInt32,Microsoft.VisualStudio.Shell.Interop.VSTREEDISPLAYDATA[])?qualifyHint=False&autoUpgrade=True) method. The icon represents the type (class, method, and so on), and accessibility (private, public, and so on) of a list item. The following example demonstrates how to obtain the icon information based on a given item attributes.  
...
5.  Get the information on whether a given list item is expandable by implementing the [GetExpandable3](assetId:///M:Microsoft.VisualStudio.Shell.Interop.IVsSimpleObjectList2.GetExpandable3(System.UInt32,System.UInt32,System.Int32@)?qualifyHint=False&autoUpgrade=True) method. The following example demonstrates how to obtain the information on whether a given item can be expanded.  
...
6.  Get a child list of symbols of a given list item by implementing the [GetList2](assetId:///M:Microsoft.VisualStudio.Shell.Interop.IVsSimpleObjectList2.GetList2(System.UInt32,System.UInt32,System.UInt32,Microsoft.VisualStudio.Shell.Interop.VSOBSEARCHCRITERIA2[],Microsoft.VisualStudio.Shell.Interop.IVsSimpleObjectList2@)?qualifyHint=False&autoUpgrade=True) method. The following example demonstrates how to obtain a child list of symbols of a given item for **Call** or **Callers** graphs.  
