...
#### Parameters  
 ...
 Points to a null-terminated string that specifies the filename (without extension) of the device driver (for example, "EPSON"). You can also pass a <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> object for this parameter.  
 ...
 Points to a null-terminated string that specifies the file or device name for the physical output medium (file or output port). You can also pass a <CodeContentPlaceHolder>7\</CodeContentPlaceHolder> object for this parameter.  
  
 <CodeContentPlaceHolder>8\</CodeContentPlaceHolder>  
 Points to a <CodeContentPlaceHolder>9\</CodeContentPlaceHolder> structure containing device-specific initialization data for the device driver. The Windows **DocumentProperties** function retrieves this structure filled in for a given device. The <CodeContentPlaceHolder>10\</CodeContentPlaceHolder> parameter must be **NULL** if the device driver is to use the default initialization (if any) specified by the user through the Control Panel.  
