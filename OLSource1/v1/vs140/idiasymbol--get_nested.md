...
#### Parameters  
 ...
 [out] Returns <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> if the user-defined data type is nested; otherwise, returns <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>.  
