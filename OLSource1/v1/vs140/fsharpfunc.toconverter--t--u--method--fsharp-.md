...
Convert an F# first class function value to a value of type <xref:System.Converter<CodeContentPlaceHolder>1\</CodeContentPlaceHolder>func<CodeContentPlaceHolder>2\</CodeContentPlaceHolder>'T -> 'U<CodeContentPlaceHolder>3\</CodeContentPlaceHolder>2*> that represents the input function.  
