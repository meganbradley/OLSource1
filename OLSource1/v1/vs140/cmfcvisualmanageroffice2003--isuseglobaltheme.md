...
## Return Value  
 <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> if the visual manager uses a Windows XP theme; otherwise, <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>.  
