...
#### Parameters  
 ...
 Specifies the name of a key to be created or opened. This name must be a subkey of <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>.  
...
## Remarks  
 If the <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> parameter is NULL or points to an empty string, **Open** opens a new handle of the key identified by <CodeContentPlaceHolder>6\</CodeContentPlaceHolder>, but does not close any previously opened handle.  
