...
#### Parameters  
 ...
 Type: <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> [unit](../vs140/core.unit-type-abbreviation--fsharp-.md)<CodeContentPlaceHolder>4\</CodeContentPlaceHolder>[exn](../vs140/core.exn-type-abbreviation--fsharp-.md) <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> [unit](../vs140/core.unit-type-abbreviation--fsharp-.md)<CodeContentPlaceHolder>6\</CodeContentPlaceHolder>\<xref:System.OperationCanceledException*> <CodeContentPlaceHolder>7\</CodeContentPlaceHolder> [unit](../vs140/core.unit-type-abbreviation--fsharp-.md)<CodeContentPlaceHolder>8\</CodeContentPlaceHolder> [unit](../vs140/core.unit-type-abbreviation--fsharp-.md)  
...
## Remarks  
 The argument for this method is a lambda expression that takes three continuation functions, which are typically called <CodeContentPlaceHolder>9\</CodeContentPlaceHolder> (the success continuation), <CodeContentPlaceHolder>10\</CodeContentPlaceHolder> (the cancel continuation) and <CodeContentPlaceHolder>11\</CodeContentPlaceHolder> (the error continuation), as the following code shows:  
  
<CodeContentPlaceHolder>1\</CodeContentPlaceHolder>  
> [!WARNING]
>  If you use this method, you must call exactly one of the continuation functions or else throw an exception, in which case F# calls <CodeContentPlaceHolder>12\</CodeContentPlaceHolder> with the exception on your behalf. If you call more than one continuation, call any continuation more than once, or both call a continuation and throw an exception, any subsequent use of the resulting async object may have undefined behavior.  
  
## Example  
 The following example illustrates how to use <CodeContentPlaceHolder>13\</CodeContentPlaceHolder> to wrap an event-based asynchronous computation as an F# async.  
