...
#### Parameters  
 `callback`  
 Type: `('T ->` [unit](../vs140/core.unit-type-abbreviation--fsharp-.md)`) * (`[exn](../vs140/core.exn-type-abbreviation--fsharp-.md) `->` [unit](../vs140/core.unit-type-abbreviation--fsharp-.md)`) * (`<xref:System.OperationCanceledException?qualifyHint=False> `->` [unit](../vs140/core.unit-type-abbreviation--fsharp-.md)`) ->` [unit](../vs140/core.unit-type-abbreviation--fsharp-.md)  
