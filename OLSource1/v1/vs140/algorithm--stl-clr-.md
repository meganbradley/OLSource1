...
|[nth_element (STL/CLR)](../vs140/nth_element--stl-clr-.md)|Partitions a sequence of elements, correctly locating the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>th element of the sequence so that all the elements in front of it are less than or equal to it and all the elements that follow it are greater than or equal to it.|  
...
|[random_shuffle (STL/CLR)](../vs140/random_shuffle--stl-clr-.md)|Rearranges a sequence of <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> elements in a range into one of <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>! possible arrangements selected at random.|  
