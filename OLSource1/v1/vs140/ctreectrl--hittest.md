...
## Remarks  
 When this function is called, the <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> parameter specifies the coordinates of the point to test. The function returns the handle of the item at the specified point or **NULL** if no item occupies the point. In addition, the <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> parameter contains a value that indicates the location of the specified point. Possible values are:  
...
## Example  
 [!code[NVC_MFC_CTreeCtrl#26](../vs140/codesnippet/CPP/ctreectrl--hittest_1.cpp)]  
