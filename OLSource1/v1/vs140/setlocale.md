...
## Remarks  
 ...
 The "C" locale maps each character in the string to its value as a <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> (unsigned short). Other values that are valid for <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> are those entries that are found in the [Language Strings](../vs140/language-strings.md) list. For example, you could issue:  
