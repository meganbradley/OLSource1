...
## Return Value  
 The memory contents of the byte, word, double word, or quadword (as indicated by the name of the function called) at the location <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>.  
