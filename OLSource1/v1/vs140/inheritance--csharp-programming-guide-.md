...
>  Structs do not support inheritance, but they can implement interfaces. For more information, see [Interfaces (C# Programming Guide)](../vs140/interfaces--csharp-programming-guide-.md).  
 ...
 Conceptually, a derived class is a specialization of the base class. For example, if you have a base class <CodeContentPlaceHolder>0\</CodeContentPlaceHolder>, you might have one derived class that is named <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> and another derived class that is named <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>. A <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> is an <CodeContentPlaceHolder>4\</CodeContentPlaceHolder>, and a <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> is an <CodeContentPlaceHolder>6\</CodeContentPlaceHolder>, but each derived class represents different specializations of the base class.  
 ...
 The following illustration shows a class <CodeContentPlaceHolder>7\</CodeContentPlaceHolder> that represents an item of work in some business process. Like all classes, it derives from \<xref:System.Object*?displayProperty=fullName> and inherits all its methods. <CodeContentPlaceHolder>8\</CodeContentPlaceHolder> adds five members of its own. These include a constructor, because constructors are not inherited. Class <CodeContentPlaceHolder>9\</CodeContentPlaceHolder> inherits from <CodeContentPlaceHolder>10\</CodeContentPlaceHolder> and represents a particular kind of work item. <CodeContentPlaceHolder>11\</CodeContentPlaceHolder> adds two more members to the members that it inherits from <CodeContentPlaceHolder>12\</CodeContentPlaceHolder> and from \<xref:System.Object*>. It must add its own constructor, and it also adds <CodeContentPlaceHolder>13\</CodeContentPlaceHolder>. Property <CodeContentPlaceHolder>14\</CodeContentPlaceHolder> enables the <CodeContentPlaceHolder>15\</CodeContentPlaceHolder> instance to be associated with the original <CodeContentPlaceHolder>16\</CodeContentPlaceHolder> to which the change request applies.  
  
 ![Class Inheritance](../vs140/media/class_inheritance.png "Class_Inheritance")  
Class inheritance  
  
 The following example shows how the class relationships demonstrated in the previous illustration are expressed in C#. The example also shows how <CodeContentPlaceHolder>17\</CodeContentPlaceHolder> overrides the virtual method \<xref:System.Object.ToString*?displayProperty=fullName>, and how the <CodeContentPlaceHolder>18\</CodeContentPlaceHolder> class inherits the <CodeContentPlaceHolder>19\</CodeContentPlaceHolder> implementation of the method.  
...
## Interfaces  
 ...
 Interfaces are used to define specific capabilities for classes that do not necessarily have an "is a" relationship. For example, the <xref:System.IEquatable<CodeContentPlaceHolder>20\</CodeContentPlaceHolder>1*> does not imply the same kind of "is a" relationship that exists between a base class and a derived class (for example, a <CodeContentPlaceHolder>21\</CodeContentPlaceHolder> is an <CodeContentPlaceHolder>22\</CodeContentPlaceHolder>). For more information, see [Interfaces (C# Programming Guide)](../vs140/interfaces--csharp-programming-guide-.md).  
