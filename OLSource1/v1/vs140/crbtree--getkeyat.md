...
## Return Value  
 Returns the key stored at position <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> in the tree.  
  
## Remarks  
 If <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> is not a valid position value, results are unpredictable. In debug builds, an assertion failure will occur if <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> is equal to NULL.  
