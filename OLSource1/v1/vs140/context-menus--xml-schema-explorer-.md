...
|**Show All Outbound References**|For every file in the selected namespace, finds and highlights the following:\<br />\<br /> -   All namespaces referenced in import statements without a <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> attribute.\<br />-   All files in namespaces other than the selected one that are specified in the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> attribute in import and include statements.|  
...
|Option|Description|  
|------------|-----------------|  
|**Show All Inbound References**|Finds and highlights all files that specify the selected file in the <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> attributes of their include and import statements.|  
|**Show All Outbound References**|Finds and highlights the following:\<br />\<br /> -   All namespaces specified in the namespace attributes of all import statements that do not have the <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> attribute.\<br />-   All files specified in the <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> attributes of all import and include statements.|  
...
|**Show All References**|For global elements, finds and highlights all references (elements that have <CodeContentPlaceHolder>5\</CodeContentPlaceHolder>) to the selected element.|  
...
|**Show All References**|For global attributes, finds and highlights all references (other attributes that have <CodeContentPlaceHolder>6\</CodeContentPlaceHolder>) to the selected attribute.|  
...
|**Show All References**|Finds and highlights all references (attribute groups that have <CodeContentPlaceHolder>7\</CodeContentPlaceHolder>) to the selected attribute group.|  
...
|**Show All References**|Finds and highlights all references (groups that have <CodeContentPlaceHolder>8\</CodeContentPlaceHolder>) to the selected group.|  
