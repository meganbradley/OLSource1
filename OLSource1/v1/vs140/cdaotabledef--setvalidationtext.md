...
---
# CDaoTableDef::SetValidationText
Call this member function to set the exception text of a validation rule for a <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> object with an underlying base table supported by the Microsoft Jet database engine.  
