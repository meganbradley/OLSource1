...
apitype: "Assembly"
f1_keywords: 
  - "Microsoft.FSharp.Control.FSharpMailboxProcessor`1.PostAndAsyncReply``1"
dev_langs: 
  - "FSharp"
helpviewer_keywords: 
  - "MailboxProcessor.PostAndAsyncReply method [F#]"
  - "PostAndAsyncReply method [F#]"
...
#### Parameters  
 ...
 Type: [AsyncReplyChannel](../vs140/control.asyncreplychannel--reply--class--fsharp-.md)<CodeContentPlaceHolder>2\</CodeContentPlaceHolder>  
...
## Return Value  
 An asychronous computation ([Async](../vs140/control.async-class--fsharp-.md) object) that will wait for the reply from the agent.  
  
## Remarks  
 The message is generated by applying <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> to a new reply channel to be incorporated into the message. The receiving agent must process this message and invoke the Reply method on this reply channel precisely once.  
  
## Example  
 The following code example shows a mailbox processor agent that uses <CodeContentPlaceHolder>5\</CodeContentPlaceHolder>. The return value of <CodeContentPlaceHolder>6\</CodeContentPlaceHolder> is an asynchronous workflow, which in this example is started by using <CodeContentPlaceHolder>7\</CodeContentPlaceHolder>, to set up the code that handles the reply.  
  
 [!code[FsMailboxProcessor#14](../vs140/codesnippet/FSharp/mailboxprocessor.postandasyncreply--msg--reply--method--fsharp-_1.fs)]  
