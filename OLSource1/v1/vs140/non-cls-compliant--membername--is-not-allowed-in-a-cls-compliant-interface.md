...
-   If you require that this member remain within its current interface, remove the <xref:System.CLSCompliantAttribute?qualifyHint=False> from its definition or mark it as `<CLSCompliant(False)>`.  
