...
> [!WARNING]
>  **Note** The .NET Framework namespace <xref:System.ComponentModel?qualifyHint=False> contains an attribute that has the same name. For information about this attribute, see <xref:System.ComponentModel.DefaultValueAttribute?qualifyHint=False>.  
