...
## Return Value  
 <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> if the pop-up menu with the tear-off bar is enabled; otherwise <CodeContentPlaceHolder>4\</CodeContentPlaceHolder>.  
