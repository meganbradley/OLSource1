...
2.  Create an XML file, and name it <CodeContentPlaceHolder>0\</CodeContentPlaceHolder>.  
...
4.  Create a second XML file, and name it <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>.  
