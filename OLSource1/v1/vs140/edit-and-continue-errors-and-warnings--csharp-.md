...
You have made an edit to a section of code that is not allowed in Visual C# Edit and Continue.  
 ...
 For more information about supported edits in Edit and Continue for [!INCLUDE[csharp_current_short](../vs140/includes/csharp_current_short_md.md)], see [Supported Code Changes (C#)](../vs140/supported-code-changes--csharp-.md). If you need more information about a specific error or warning, you can search or post on the MSDN [Visual C# IDE forum](http://go.microsoft.com/fwlink/?LinkId=214693).  
