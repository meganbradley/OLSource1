...
|7|**Role Name**|The name of a role, that is, one end of an association. Can be used to refer to the associated object. In the previous illustration, for any Order <CodeContentPlaceHolder>0\</CodeContentPlaceHolder>, <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> is its associated Menu.\<br />\<br /> Each role has its own properties, listed under the properties of the association.|  
