...
3.  If a function named <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> appears in the middle part of the view, all the functions that called the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> function appear in the top part of the view, and all the functions that were called by the <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> appear in the bottom part of the view.  
