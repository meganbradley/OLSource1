...
|----------------|-----------------|  
|**Static variable** <CodeContentPlaceHolder>0\</CodeContentPlaceHolder>|A static variable. <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> is the name of the variable.|  
