...
## Remarks  
 ...
 Call <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> before calling [DoModal](../vs140/cpropertysheet--domodal.md). After you call <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>, <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> will return either **ID_WIZFINISH** (if the user closes with the Finish button) or **IDCANCEL**.  
  
 <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> sets the PSH_WIZARD flag.  
