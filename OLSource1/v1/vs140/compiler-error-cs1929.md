...
Instance argument: cannot convert from 'typeA' to 'typeB'.  
 ...
 This error is generated when you try to invoke an extension method from a class that it does not extend. In the example shown here, the extension method is defined for the derived class <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>, but not for the base class <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>.  
