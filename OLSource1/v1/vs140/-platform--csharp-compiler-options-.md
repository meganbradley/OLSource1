...
ms.tgt_pltfrm: na
ms.topic: article
H1: /platform (C# Compiler Options)
f1_keywords: 
  - /platform
dev_langs: 
  - CSharp
...
-   Executables compiled with **/platform:anycpu32bitpreferred** execute on the 32-bit CLR.  
 ...
 For more information about developing an application to run on a Windows 64-bit operating system, see [64-bit Applications](assetId:///fd4026bc-2c3d-4b27-86dc-ec5e96018181).  
 ...
 **Note /platform** is not available in the development environment in Visual C# Express.  
 ...
 For information on how to set this compiler option programmatically, see <xref:VSLangProj80.CSharpProjectConfigurationProperties3.PlatformTarget?qualifyHint=False>.  
