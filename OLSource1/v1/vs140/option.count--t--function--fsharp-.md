...
## Return Value  
 A zero if the option is <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>, a one otherwise.  
  
## Remarks  
 The expression <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> evaluates to <CodeContentPlaceHolder>5\</CodeContentPlaceHolder>.  
...
## Example  
 The following code illustrates the use of <CodeContentPlaceHolder>7\</CodeContentPlaceHolder>.  
