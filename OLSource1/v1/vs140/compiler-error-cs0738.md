...
## Example  
 The following code generates CS0738 because the class method returns <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> and the interface member of the same name returns <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>:  
