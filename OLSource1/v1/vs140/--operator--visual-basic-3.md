...
|------------------------|---------------------------------------|  
|Floating-point (`Single` or `Double`)|Returns infinity (<xref:System.Double.PositiveInfinity?qualifyHint=False> or <xref:System.Double.NegativeInfinity?qualifyHint=False>), or <xref:System.Double.NaN?qualifyHint=False> (not a number) if `expression1` is also zero|  
|`Decimal`|Throws <xref:System.DivideByZeroException?qualifyHint=False>|  
|Integral (signed or unsigned)|Attempted conversion back to integral type throws <xref:System.OverflowException?qualifyHint=False> because integral types cannot accept <xref:System.Double.PositiveInfinity?qualifyHint=False>, <xref:System.Double.NegativeInfinity?qualifyHint=False>, or <xref:System.Double.NaN?qualifyHint=False>|  
