...
warning C6400: Using \<function name> to perform a case-insensitive compare to constant string \<string name>. Yields unexpected results in non-English locales  
 ...
 String comparisons should typically be performed with the <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> function. To perform a locale-independent comparison on Windows XP, the first parameter should be the constant <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>.  
