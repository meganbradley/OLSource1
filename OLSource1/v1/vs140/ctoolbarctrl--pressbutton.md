...
#### Parameters  
 ...
 <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> to press the specified button; <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> to release the specified button. The default value is <CodeContentPlaceHolder>5\</CodeContentPlaceHolder>.  
