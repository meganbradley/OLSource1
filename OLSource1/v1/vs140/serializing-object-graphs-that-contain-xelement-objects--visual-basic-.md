...
|Topic|Description|  
|-----------|-----------------|  
|[How to: Serialize Using XmlSerializer (Visual Basic)](../vs140/how-to--serialize-using-xmlserializer--visual-basic-.md)|Demonstrates how to serialize using <xref:System.Xml.Serialization.XmlSerializer?qualifyHint=False>.|  
|[How to: Serialize Using DataContractSerializer (Visual Basic)](../vs140/how-to--serialize-using-datacontractserializer--visual-basic-.md)|Demonstrates how to serialize using <xref:System.Runtime.Serialization.DataContractSerializer?qualifyHint=False>.|  
