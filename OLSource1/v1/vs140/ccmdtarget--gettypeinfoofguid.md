...
#### Parameters  
 ...
 Pointer to a pointer to the <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> interface.  
  
## Return Value  
 An HRESULT indicating the success or failure of the call. If successful, *<CodeContentPlaceHolder>6\</CodeContentPlaceHolder> points to the type information interface.  
