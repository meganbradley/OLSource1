...
The \<xref:Microsoft.VisualBasic.MyServices.FileSystemProxy.GetFiles*> method returns a read-only collection of strings representing the path names for the files. You can use the <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> parameter to specify a specific pattern.  
...
1.  Use the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> method to return the list of files. This example returns all .rtf files in the specified directory.  
...
2.  Use the <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> method to copy the files. This example copies the files to the directory named <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>.  
...
3.  Close the <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> statement with a <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> statement.  
...
## Example  
 The following example, which presents the above snippets in complete form, copies all .rtf files in the specified directory to the directory named <CodeContentPlaceHolder>6\</CodeContentPlaceHolder>.  
