...
## Return Value  
 <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> if the toolbar contains the **Customize** button; otherwise <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>.  
  
## Remarks  
 If this method returns <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>, the [CMFCToolBar::GetCustomizeButton](../vs140/cmfctoolbar--getcustomizebutton.md) method returns a pointer to the **Customize** button that appears at the end of the toolbar.  
