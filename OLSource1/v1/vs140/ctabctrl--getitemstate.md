...
---
# CTabCtrl::GetItemState
Retrieves the state of the tab control item identified by <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>.  
...
## Return Value  
 A reference to a <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> value receiving the state information. Can be one of the following values:  
...
## Remarks  
 An item's state is specified by the **dwState** member of the <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> structure.  
