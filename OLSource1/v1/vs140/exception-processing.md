...
|[END_CATCH](../vs140/end_catch.md)|Ends the last **CATCH** or <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> code block.|  
|[END_CATCH_ALL](../vs140/end_catch_all.md)|Ends the last <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> code block.|  
...
|[AfxThrowOleException](../vs140/afxthrowoleexception.md)|Throws an OLE exception.|  
 ...
 To support database exceptions, the database classes provide two exception classes, <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> and <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>, and global functions to support the exception types:  
