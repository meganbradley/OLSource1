...
## Remarks  
 <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> retrieves the current client-defined application hook function for the C run-time debug library memory allocation process.  
...
|-------------|---------------------|  
|<CodeContentPlaceHolder>2\</CodeContentPlaceHolder>|\<crtdbg.h>|  
