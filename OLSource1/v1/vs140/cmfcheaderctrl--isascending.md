...
## Return Value  
 <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> if any column in the header control is sorted in ascending order; otherwise, <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>.  
