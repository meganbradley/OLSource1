...
2.  From the **Debug** menu, click **Continue**, **Step**, or **Set Next Statement** or evaluate a function in a debugger window.  
     ...
     The new code is compiled and the debugging continues with the new code. Some changes are not supported by Edit and Continue. For more information, see [Supported Code Changes (C#)](../vs140/supported-code-changes--csharp-.md).  
...
## See Also  
 ...
 [Edit and Continue Errors and Warnings (C#)](../vs140/edit-and-continue-errors-and-warnings--csharp-.md)