...
## Remarks  
 A type <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> is use to iterate through the set in reverse.  
  
## Example  
 See the example for [rbegin](../vs140/set--rbegin.md) for an example of how to declare and use <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>.  
