...
|Name|Description|  
|----------|-----------------|  
|[CComDynamicUnkArray::Add](../vs140/ccomdynamicunkarray--add.md)|Call this method to add an <CodeContentPlaceHolder>12\</CodeContentPlaceHolder> pointer to the array.|  
|[CComDynamicUnkArray::begin](../vs140/ccomdynamicunkarray--begin.md)|Returns a pointer to the first <CodeContentPlaceHolder>13\</CodeContentPlaceHolder> pointer in the collection.|  
