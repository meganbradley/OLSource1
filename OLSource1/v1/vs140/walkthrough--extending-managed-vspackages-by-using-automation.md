...
1.  Create a [!INCLUDE[vsprvs](../vs140/includes/vsprvs_md.md)] Package project named <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>.  
...
5.  On the **Command Options** page, change the **Command Name** to <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>.  
...
4.  In the AutoPackage file, replace the body of the <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> method with the following lines:  
...
[!code[VSSDKAuto#2](../vs140/codesnippet/VisualBasic/walkthrough--extending-managed-vspackages-by-using-automation_2.vb)]  
 ...
 This code calls \<xref:Microsoft.VisualStudio.Shell.Package.GetService*> to obtain a \<xref:EnvDTE.DTE*> automation object that represents the [!INCLUDE[vsprvs](../vs140/includes/vsprvs_md.md)] IDE. The automation code in <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> creates a new pane in the **Output** window named **Test**. The [!INCLUDE[vsprvs](../vs140/includes/vsprvs_md.md)] name and version is then written to the new **Output** pane.  
