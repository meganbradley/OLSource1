...
6.  Add the following code to <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> to implement the function:  
...
3.  Edit DisplayDialogView.cpp:  
    ...
    -   Add the following code to <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> to implement the function:  
