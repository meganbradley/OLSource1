...
## Remarks  
 When specified, the <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> argument marks the indicated thread as the current thread. An asterisk (*) is displayed in the list next to the current thread.  
