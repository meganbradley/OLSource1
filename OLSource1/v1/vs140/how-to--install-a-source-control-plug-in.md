...
## How the IDE Detects Version 1.2/1.3 Support  
 ...
 Next, [!INCLUDE[vsprvs](../vs140/includes/vsprvs_md.md)] determines whether the particular new capability is supported by examining the <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> argument on the [SccInitialize Function](../vs140/sccinitialize-function.md).  
