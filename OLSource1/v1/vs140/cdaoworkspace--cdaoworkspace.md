...
-   Or call the object's [Create](../vs140/cdaoworkspace--create.md) member function to create a new DAO workspace object. This explicitly starts a new workspace session, which you can refer to via the <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> object. After calling **Create**, you can call [Append](../vs140/cdaoworkspace--append.md) if you want to add the workspace to the database engine's Workspaces collection.  
