...
apitype: "Assembly"
f1_keywords: 
  - "Microsoft.FSharp.Collections.SeqModule.TryFind``1"
dev_langs: 
  - "FSharp"
helpviewer_keywords: 
  - "Seq.tryFind function [F#]"
  - "tryFind function [F#]"
ms.assetid: ac43c6f5-4dc7-4e9a-a222-00b5736aee47
...
## Return Value  
 Returns the first element for which the given function returns <CodeContentPlaceHolder>5\</CodeContentPlaceHolder>. Return <CodeContentPlaceHolder>6\</CodeContentPlaceHolder> if no such element exists.  
