...
---
# CImage::LoadFromResource
Loads an image from a <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> resource.  
...
## Remarks  
 The resource must be of type <CodeContentPlaceHolder>5\</CodeContentPlaceHolder>.  
