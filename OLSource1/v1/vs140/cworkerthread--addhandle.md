...
## Remarks  
 [IWorkerThreadClient::Execute](../vs140/iworkerthreadclient--execute.md) will be called through <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> when the handle, <CodeContentPlaceHolder>5\</CodeContentPlaceHolder>, is signaled.  
