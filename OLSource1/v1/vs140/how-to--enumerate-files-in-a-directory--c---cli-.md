...
The following code example demonstrates how to retrieve a list of the files in a directory. Additionally, the subdirectories are enumerated. The following code example uses the [GetFiles](assetId:///M:System.IO.Directory.GetFiles(System.String)?qualifyHint=False&autoUpgrade=True)assetId:///M:System.IO.Directory.GetFiles(System.String)?qualifyHint=False&autoUpgrade=True and [GetDirectories](assetId:///M:System.IO.Directory.GetDirectories(System.String)?qualifyHint=False&autoUpgrade=True) methods to display the contents of the C:\Windows directory.  
