...
## The VSIX Manifest  
 ...
 The VSIX manifest must be named <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> when it is included in a .vsix file.  
...
## Dependencies and References  
 ...
 If a project in a multi-project solution includes a reference to another project in the same solution, the VSIX package includes the dependencies of that project. You can override this behavior by clicking the reference for the internal project, and then, in the **Properties** window, setting the **Output Groups Included in VSIX** property to <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>.  
  
 To include satellite DLLs from referenced assemblies in the VSIX package, add <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> to the **Output Groups Included in VSIX** property.  
...
## Installation Location  
 ...
 By default, the installation applies only to the current user, because %LocalAppData% is a user-specific directory. However, if you set the [AllUsers](assetId:///ac817f50-3276-4ddb-b467-8bbb1432455b) element of the manifest to <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>, the extension will be installed under ..\\*VisualStudioInstallationFolder*\Common7\IDE\Extensions and will be available to all users of the computer.  
