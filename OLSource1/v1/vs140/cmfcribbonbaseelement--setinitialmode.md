...
#### Parameters  
 ...
 <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> to limit the display size for the ribbon element to compact or intermediate; otherwise, <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>.  
