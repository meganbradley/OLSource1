...
|<CodeContentPlaceHolder>0\</CodeContentPlaceHolder>|A string that corresponds to the current setting of the **Active Solution Configuration** box in the **Configuration Manager**.|  
|<CodeContentPlaceHolder>1\</CodeContentPlaceHolder>|A <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> value that can be set in the **Project Properties** dialog box. By default, the Debug configuration for a project defines <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>. When <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> is defined, \<xref:System.Diagnostics.Debug*> class methods generate output to the **Output** window. When it is not defined, \<xref:System.Diagnostics.Debug*> class methods are not compiled and no Debug output is generated.|  
|<CodeContentPlaceHolder>5\</CodeContentPlaceHolder>|A string representing the output type for the project or the setting of the command-line **/target** option. The possible values of <CodeContentPlaceHolder>6\</CodeContentPlaceHolder> are:\<br />\<br /> -   "winexe" for a Windows application.\<br />-   "exe" for a console application.\<br />-   "library" for a class library.\<br />-   "module" for a module.\<br />-   The **/target** option may be set in the [!INCLUDE[vsprvs](../vs140/includes/vsprvs_md.md)] integrated development environment. For more information, see [/target (Visual Basic)](../vs140/-target--visual-basic-.md).|  
|<CodeContentPlaceHolder>7\</CodeContentPlaceHolder>|A <CodeContentPlaceHolder>8\</CodeContentPlaceHolder> value that can be set in the **Project Properties** dialog box. By default, all configurations for a project define <CodeContentPlaceHolder>9\</CodeContentPlaceHolder>. When <CodeContentPlaceHolder>10\</CodeContentPlaceHolder> is defined, \<xref:System.Diagnostics.Trace*> class methods generate output to the **Output** window. When it is not defined, \<xref:System.Diagnostics.Trace*> class methods are not compiled and no <CodeContentPlaceHolder>11\</CodeContentPlaceHolder> output is generated.|  
|<CodeContentPlaceHolder>12\</CodeContentPlaceHolder>|A number representing the [!INCLUDE[vbprvb](../vs140/includes/vbprvb_md.md)] version, in *major*.*minor* format. The version number for [!INCLUDE[vbprvblong](../vs140/includes/vbprvblong_md.md)] is 8.0.|  
...
|-|-|  
|**Constant**|**Description**|  
|<CodeContentPlaceHolder>13\</CodeContentPlaceHolder>|Carriage return/linefeed character combination.|  
|<CodeContentPlaceHolder>14\</CodeContentPlaceHolder>|Carriage return character.|  
|<CodeContentPlaceHolder>15\</CodeContentPlaceHolder>|Linefeed character.|  
|<CodeContentPlaceHolder>16\</CodeContentPlaceHolder>|Newline character.|  
|<CodeContentPlaceHolder>17\</CodeContentPlaceHolder>|Null character.|  
|<CodeContentPlaceHolder>18\</CodeContentPlaceHolder>|Not the same as a zero-length string (""); used for calling external procedures.|  
|<CodeContentPlaceHolder>19\</CodeContentPlaceHolder>|Error number. User-defined error numbers should be greater than this value. For example:\<br />\<br /> <CodeContentPlaceHolder>20\</CodeContentPlaceHolder>|  
|<CodeContentPlaceHolder>21\</CodeContentPlaceHolder>|Tab character.|  
|<CodeContentPlaceHolder>22\</CodeContentPlaceHolder>|Backspace character.|  
|<CodeContentPlaceHolder>23\</CodeContentPlaceHolder>|Not used in Microsoft Windows.|  
|<CodeContentPlaceHolder>24\</CodeContentPlaceHolder>|Not useful in Microsoft Windows.|  
...
|\<xref:Microsoft.VisualBasic.TriState*>|Indicates a <CodeContentPlaceHolder>25\</CodeContentPlaceHolder> value or whether the default should be used when calling number-formatting functions.|  
