...
#### Parameters  
 ...
 <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> to increment the number of tracked objects. <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> to decrement the number of tracked objects.  
