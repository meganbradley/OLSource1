...
-   The <xref:System.Converter`2?qualifyHint=False> delegate  
 ...
 For more information and examples, see [Using Variance for Func and Action Generic Delegates (C#)](../vs140/using-variance-for-func-and-action-generic-delegates--csharp-.md).  
