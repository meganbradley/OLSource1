...
## Return Value  
 A [COLORREF](http://msdn.microsoft.com/library/windows/desktop/dd183449) parameter that indicates the text color of the specified tab; -1 if <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> is out of range.  
