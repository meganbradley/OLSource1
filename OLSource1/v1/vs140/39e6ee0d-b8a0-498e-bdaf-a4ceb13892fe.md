...
A constructor is declared with the <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> keyword.  
...
-   Remove the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> keyword from all constructor declarations.  
