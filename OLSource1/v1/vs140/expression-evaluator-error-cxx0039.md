...
symbol is ambiguous  
 ...
 You must use the scope resolution operator (<CodeContentPlaceHolder>0\</CodeContentPlaceHolder>) to explicitly specify the instance to use in the expression.  
