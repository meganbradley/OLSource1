...
You can package several DSLs as part of a single solution so that they are installed together.  
 ...
 You can use several techniques to integrate multiple DSLs. For more information, see [Integrating Models by using Visual Studio ModelBus](../vs140/integrating-models-by-using-visual-studio-modelbus.md) and [How to Write a Drag-and-Drop Handler](../vs140/how-to--add-a-drag-and-drop-handler.md) and [Customizing Copy-Paste Behavior](../vs140/customizing-copy-behavior.md).  
...
1.  Create two or more DSL solutions and a VSIX project, and add all the projects to a single solution.  
    ...
    -   Change the names of the **Dsl** and **DslPackage** projects so that they are all different. For example: <CodeContentPlaceHolder>0\</CodeContentPlaceHolder>, <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>, <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>, <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>.  
...
2.  Combine the VSIX manifests of the DSLs:  
    ...
    2.  For each DSL, choose **Add Content** and add:  
        ...
        -   <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> project as a **MEF Component**  
  
        -   <CodeContentPlaceHolder>6\</CodeContentPlaceHolder> project as a **MEF Component**  
  
        -   <CodeContentPlaceHolder>7\</CodeContentPlaceHolder> project as a **VS Package**  
...
## See Also  
 ...
 [How to Write a Drag-and-Drop Handler](../vs140/how-to--add-a-drag-and-drop-handler.md)   
 [Customizing Copy-Paste Behavior](../vs140/customizing-copy-behavior.md)