...
## Return Value  
 <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> if the frame of the tab control is rendered in a flat style; <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> if the frame is rendered in a 3D style.  
