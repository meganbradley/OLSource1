...
apitype: "Assembly"
f1_keywords: 
  - "Microsoft.FSharp.Collections.Array4DModule.Get``1"
dev_langs: 
  - "FSharp"
helpviewer_keywords: 
  - "Array4D.get function [F#]"
  - "Array4D.GetAtIndex function [F#]"
...
## Remarks  
 You can also use the syntax <CodeContentPlaceHolder>7\</CodeContentPlaceHolder>.  
