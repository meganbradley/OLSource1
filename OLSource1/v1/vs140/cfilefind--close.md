...
## Remarks  
 After calling **Close**, you do not have to create a new <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> instance before calling [FindFile](../vs140/cfilefind--findfile.md) to begin a new search.  
