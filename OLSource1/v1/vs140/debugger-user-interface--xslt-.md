...
|Name|Description|  
|----------|-----------------|  
|<CodeContentPlaceHolder>0\</CodeContentPlaceHolder>|The context size.|  
|<CodeContentPlaceHolder>1\</CodeContentPlaceHolder>|The position, or index number, of the context node, relative to the context size.|  
|<CodeContentPlaceHolder>2\</CodeContentPlaceHolder>|The value of the context node.|  
...
-   Built-in XSLT functions such as <CodeContentPlaceHolder>4\</CodeContentPlaceHolder>, <CodeContentPlaceHolder>5\</CodeContentPlaceHolder>, and so on, are not allowed.  
