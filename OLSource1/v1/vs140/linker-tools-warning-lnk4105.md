...
<CodeContentPlaceHolder>0\</CodeContentPlaceHolder>  
 would direct the linker to search for the required libraries in <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> before searching in the default locations.