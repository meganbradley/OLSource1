...
---
# COleDateTimeSpan::SetStatus
Sets the status (validity) of this <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> object.  
...
## Remarks  
 The *Status* parameter value is defined by the **DateTimeSpanStatus** enumerated type, which is defined within the <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> class.  
