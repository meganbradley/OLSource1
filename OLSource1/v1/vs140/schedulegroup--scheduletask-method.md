...
## Remarks  
 Calling the <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> method implicitly places a reference count on the schedule group which is removed by the runtime at an appropriate time after the task executes.  
