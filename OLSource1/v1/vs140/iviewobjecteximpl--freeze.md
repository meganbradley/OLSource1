...
---
# IViewObjectExImpl::Freeze
Freezes the drawn representation of a control so it won't change until an <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>. The ATL implementation returns **E_NOTIMPL**.  
