...
The following classes are ready-to-use array classes.  
 ...
 Stores elements of type <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> in an array.  
  
 [CObArray](../vs140/cobarray-class.md)  
 Stores pointers to objects of class <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> or to objects of classes derived from <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> in an array.  
  
 [CPtrArray](../vs140/cptrarray-class.md)  
 Stores pointers to <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> (generic pointers) in an array.  
 ...
 Stores <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> objects in an array.  
