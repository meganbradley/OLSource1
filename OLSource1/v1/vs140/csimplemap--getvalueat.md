...
## Return Value  
 Returns the value referenced by <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>.  
  
## Remarks  
 The index passed by <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> must be valid for the return value to be meaningful.  
