...
> [!NOTE]
>  [IDebugProgram2::Continue](../vs140/idebugprogram2--continue.md), [IDebugProgram2::Execute](../vs140/idebugprogram2--execute.md), and [IDebugProgram2::Step](../vs140/idebugprogram2--step.md) methods are deprecated and should no longer be used. Use the corresponding methods on the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> interface instead.  
...
## Methods in Vtable Order  
 In addition to the methods inherited from [IDebugProcess2](../vs140/idebugprocess2.md), <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> implements the following methods.  
...
|[IDebugProcess3::DisableENC](../vs140/idebugprocess3--disableenc.md)|Disables Edit and Continue (ENC) for this process.\<br />\<br /> A custom port supplier does not implement this method (it should always return <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>).|  
|[IDebugProcess3::GetENCAvailableState](../vs140/idebugprocess3--getencavailablestate.md)|Get the ENC state for this process.\<br />\<br /> A custom port supplier does not implement this method (it should always return <CodeContentPlaceHolder>4\</CodeContentPlaceHolder>).|  
