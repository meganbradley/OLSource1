...
## Return Value  
 Specifies whether to activate the <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> and whether to discard the mouse event. It must be one of the following values:  
  
-   **MA_ACTIVATE** Activate <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> object.  
  
-   **MA_NOACTIVATE** Do not activate <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> object.  
  
-   **MA_ACTIVATEANDEAT** Activate <CodeContentPlaceHolder>6\</CodeContentPlaceHolder> object and discard the mouse event.  
  
-   **MA_NOACTIVATEANDEAT** Do not activate <CodeContentPlaceHolder>7\</CodeContentPlaceHolder> object and discard the mouse event.  
