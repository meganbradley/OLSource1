...
## Example  
 The following code example illustrates how to use <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> to set up a computation to run when another asynchronous operation is completed, as indicated by a wait handle.  
