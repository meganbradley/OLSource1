...
---
# Async.AwaitWaitHandle Method (F#)
Creates an asynchronous computation that will wait for the supplied <xref:System.Threading.WaitHandle?qualifyHint=False>.  
...
#### Parameters  
 `waitHandle`  
 Type: <xref:System.Threading.WaitHandle?qualifyHint=False>  
...
## Return Value  
 An asynchronous computation that waits on the given <xref:System.Threading.WaitHandle?qualifyHint=False> object.  
...
## Example  
 ...
 [!code[FsAsyncAPIs#17](../vs140/codesnippet/FSharp/async.awaitwaithandle-method--fsharp-_1.fs)]
