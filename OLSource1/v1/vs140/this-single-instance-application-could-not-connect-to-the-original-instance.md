...
-   The application does not have permissions to create kernel objects. For more information about kernel objects, see [Mutex](assetId:///9dd06e25-12c0-4a9e-855a-452dc83803e2).  
     ...
     The base name for the kernel objects comes from concatenating the assembly's GUID, major version number, and minor version number. For example, the base name could be <CodeContentPlaceHolder>0\</CodeContentPlaceHolder>.  
