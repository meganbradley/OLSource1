...
---
# CRectTracker::OnChangedRect
Called by the framework whenever the tracker rectangle has changed during a call to <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>.  
...
#### Parameters  
 *rectOld*  
 Contains the old device coordinates of the <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> object.  
  
## Remarks  
 At the time this function is called, all feedback drawn with <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> has been removed. The default implementation of this function does nothing.  
