...
## Remarks  
 ...
 A window enters a moving or sizing modal loop when the user clicks the window's title bar or sizing border, or when the window passes the [WM_SYSCOMMAND](http://msdn.microsoft.com/library/windows/desktop/ms646360) message to the [CWnd::DefWindowProc](../vs140/cwnd--defwindowproc.md) function and the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> parameter of that message specifies <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> or <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>.  
