...
## Remarks  
 This function is called before the [OnKeyUp](../vs140/cwnd--onkeyup.md) member function and after the [OnKeyDown](../vs140/cwnd--onkeydown.md) member function are called. <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> contains the value of the keyboard key being pressed or released.  
  
 Because there is not necessarily a one-to-one correspondence between keys pressed and <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> calls generated, the information in <CodeContentPlaceHolder>6\</CodeContentPlaceHolder> is generally not useful to applications. The information in <CodeContentPlaceHolder>7\</CodeContentPlaceHolder> applies only to the most recent call to the <CodeContentPlaceHolder>8\</CodeContentPlaceHolder> member function or the <CodeContentPlaceHolder>9\</CodeContentPlaceHolder> member function that precedes the call to <CodeContentPlaceHolder>10\</CodeContentPlaceHolder>.  
