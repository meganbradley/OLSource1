...
---
# CWnd::OnRenderFormat
The Clipboard owner's <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> member function is called by the framework when a particular format with delayed rendering needs to be rendered.  
...
## Remarks  
 ...
 Do not call the <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> member function or the **CloseClipboard** Windows function from within <CodeContentPlaceHolder>4\</CodeContentPlaceHolder>.  
