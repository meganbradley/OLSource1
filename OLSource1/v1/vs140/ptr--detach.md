...
## Exceptions  
 Internally, `QueryInterface` is called on the owned COM object and any error `HRESULT` is converted to an exception by [ThrowExceptionForHR](assetId:///M:System.Runtime.InteropServices.Marshal.ThrowExceptionForHR(System.Int32)?qualifyHint=False&autoUpgrade=True).  
