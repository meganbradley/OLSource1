...
1.  Import the <xref:System.Diagnostics?qualifyHint=False> namespace at the beginning of the code file. For more information, see [Imports Statement](../vs140/imports-statement--.net-namespace-and-type-.md).  
