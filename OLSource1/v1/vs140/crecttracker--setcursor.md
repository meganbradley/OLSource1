...
---
# CRectTracker::SetCursor
Call this function to change the cursor shape while it is over the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> object's region.  
...
#### Parameters  
 ...
 Results of the previous hit test, from the <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> message.  
  
## Return Value  
 Nonzero if the previous hit was over the tracker rectangle; otherwise 0.  
  
## Remarks  
 Call this function from inside the function of your window that handles the <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> message (typically <CodeContentPlaceHolder>6\</CodeContentPlaceHolder>).  
