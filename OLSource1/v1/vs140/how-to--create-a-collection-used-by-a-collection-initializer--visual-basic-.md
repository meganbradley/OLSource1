...
## Example  
 The following example shows an <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> collection that contains a public <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> method that a collection initializer can use to add objects of type <CodeContentPlaceHolder>5\</CodeContentPlaceHolder>. The <CodeContentPlaceHolder>6\</CodeContentPlaceHolder> method enables you to use the shortened collection initializer syntax.  
