...
## Microsoft Specific  
 ...
 When compiling with [/clr:pure](../vs140/-clr--common-language-runtime-compilation-.md), all functions and function pointers are `__clrcall` unless specified otherwise.  
