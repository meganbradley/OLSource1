...
---
# COleClientItem::GetDrawAspect
Call the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> member function to determine the current "aspect," or view, of the item.  
  
## Syntax  
  
<CodeContentPlaceHolder>0\</CodeContentPlaceHolder>  
## Return Value  
 A value from the <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> enumeration, whose values are listed in the reference for [SetDrawAspect](../vs140/coleclientitem--setdrawaspect.md).  
