...
Deprecated. Enables synchronous exception handling using the assumption that functions declared by using <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> never throw an exception.  
