...
```  
 ...
 The `#undef` directive causes an identifier's preprocessor definition to be forgotten. See [The #undef Directive](../vs140/sharpundef-directive--c-c---.md) for more information.  
 ...
 **Microsoft Specific**  
 ...
 Defining macros and constants with the [/D](../vs140/-d--preprocessor-definitions-.md) compiler option has the same effect as using a `#define` preprocessing directive at the start of your file. Up to 30 macros can be defined by using the /D option.  
