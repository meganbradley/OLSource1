...
## In This Section  
 ...
 [Formatting, C#/J#, Text Editor, Options Dialog Box](../vs140/options--text-editor--csharp--formatting.md)  
 Describes settings for indenting, new line formatting, and wrapping text, among others, for C# and J#.  
  
 [Advanced, C#/J#, Text Editor, Options Dialog Box](../vs140/options--text-editor--csharp--advanced.md)  
 Describes outlining, error identification, and XML documentation comment settings for C# and J#.  
  
 [IntelliSense, C#/J#, Text Editor, Options Dialog Box](../vs140/options--text-editor--csharp--intellisense.md)  
