...
## Remarks  
 ...
 <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> is identical to <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> except that <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> is a static method. Therefore, it will create a temporary visual manager if one does not exist.  
  
 <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> always return 0s for versions of Windows earlier than Windows XP.  
