...
## Remarks  
 The prefix increment operator (<CodeContentPlaceHolder>4\</CodeContentPlaceHolder>) adds one to its operand; this incremented value is the result of the expression. The operand must be an l-value not of type **const**. The result is an l-value of the same type as the operand.  
...
<CodeContentPlaceHolder>3\</CodeContentPlaceHolder>  
 If <CodeContentPlaceHolder>6\</CodeContentPlaceHolder> is greater than or equal to <CodeContentPlaceHolder>7\</CodeContentPlaceHolder> or less than <CodeContentPlaceHolder>8\</CodeContentPlaceHolder> by 1, it will be incremented twice.  
