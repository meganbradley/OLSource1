 ...
 **RECT&**  <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>  
...
## Remarks  
 This dialog box is automatically attached to the <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> object. To create a modal dialog box, call [DoModal](../vs140/cdialogimpl--domodal.md). The second override above is used only with [CComControl](../vs140/ccomcontrol-class.md).  
