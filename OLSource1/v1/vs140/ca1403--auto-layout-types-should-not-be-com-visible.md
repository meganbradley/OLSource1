...
## Cause  
 A Component Object Model (COM) visible value type is marked with the <xref:System.Runtime.InteropServices.StructLayoutAttribute?qualifyHint=True> attribute set to <xref:System.Runtime.InteropServices.LayoutKind.Auto?qualifyHint=True>.  
  
## Rule Description  
 <xref:System.Runtime.InteropServices.LayoutKind.Auto?qualifyHint=False> layout types are managed by the common language runtime. The layout of these types can change between versions of the .NET Framework, which will break COM clients that expect a specific layout. Note that if the <xref:System.Runtime.InteropServices.StructLayoutAttribute?qualifyHint=False> attribute is not specified, the C#, [!INCLUDE[vbprvb](../vs140/includes/vbprvb_md.md)], and C++ compilers specify the <xref:System.Runtime.InteropServices.LayoutKind.Sequential?qualifyHint=False> layout for value types.  
...
## How to Fix Violations  
 To fix a violation of this rule, change the value of the <xref:System.Runtime.InteropServices.StructLayoutAttribute?qualifyHint=False> attribute to <xref:System.Runtime.InteropServices.LayoutKind.Explicit?qualifyHint=False> or <xref:System.Runtime.InteropServices.LayoutKind.Sequential?qualifyHint=False>, or make the type invisible to COM.  
...
## Example  
 ...
 [!code[FxCop.Interoperability.AutoLayout#1](../vs140/codesnippet/CSharp/ca1403--auto-layout-types-should-not-be-com-visible_1.cs)]
[!code[FxCop.Interoperability.AutoLayout#1](../vs140/codesnippet/VisualBasic/ca1403--auto-layout-types-should-not-be-com-visible_1.vb)]
