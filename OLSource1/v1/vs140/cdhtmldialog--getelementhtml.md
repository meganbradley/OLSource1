...
---
# CDHtmlDialog::GetElementHtml
Retrieves the **innerHTML** property of the HTML element identified by <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>.  
...
## Return Value  
 The **innerHTML** property of the HTML element identified by <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> or **NULL** if the element could not be found.  
