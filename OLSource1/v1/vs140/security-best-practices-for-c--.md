...
## SafeInt Library  
 [The SafeInt Library](../vs140/safeint-library.md) helps prevent integer overflows and other exploitable errors that might occur when the application performs mathematical operations. The `SafeInt` library includes the [SafeInt Class](../vs140/safeint-class.md), the [SafeIntException Class](../vs140/safeintexception-class.md), and several [SafeInt Functions](../vs140/safeint-functions.md).  
