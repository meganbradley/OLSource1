...
#### Parameters  
 ...
 <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> to specify that the character set must match when selecting a font; <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> to specify that the character set can be ignored when selecting a font.  
