...
|[SwitchToContext](../vs140/async.switchtocontext-method--fsharp-.md)|Creates an asynchronous computation that runs its continuation by using the [Post](assetId:///M:System.Threading.SynchronizationContext.Post(System.Threading.SendOrPostCallback,System.Object)?qualifyHint=False&autoUpgrade=True) method of the supplied synchronization context. If the supplied synchronization context is `null`, the asynchronous computation is equivalent to [SwitchToThreadPool](../vs140/async.switchtothreadpool-method--fsharp-.md).|  
