...
|[SwitchToContext](../vs140/async.switchtocontext-method--fsharp-.md)|Creates an asynchronous computation that runs its continuation by using the \<xref:System.Threading.SynchronizationContext.Post*> method of the supplied synchronization context. If the supplied synchronization context is `null`, the asynchronous computation is equivalent to [SwitchToThreadPool](../vs140/async.switchtothreadpool-method--fsharp-.md).|  
