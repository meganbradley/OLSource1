...
-   Such members as a field, [event](../vs140/event--csharp-reference-.md), [property](../vs140/using-properties--csharp-programming-guide-.md), or method  
 ...
 Unless you compile with [/target:module](../vs140/-target-module--csharp-compiler-options-.md), <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> will contain \<assembly>\</assembly> tags specifying the name of the file containing the assembly manifest for the output file of the compilation.  
