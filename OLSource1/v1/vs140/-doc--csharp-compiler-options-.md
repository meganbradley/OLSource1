...
3.  Modify the **XML documentation file** property.  
 ...
 For information on how to set this compiler option programmatically, see <xref:VSLangProj80.CSharpProjectConfigurationProperties3.DocumentationFile?qualifyHint=False>.  
