...
In the [!INCLUDE[vsprvs](../vs140/includes/vsprvs_md.md)] managed package framework, classes derived from \<xref:Microsoft.VisualStudio.Shell.DialogPage*> extend the [!INCLUDE[vsprvs](../vs140/includes/vsprvs_md.md)] IDE by adding **Options** pages under the **Tools** menu.  
...
### Description  
 The following class defines a minimal "hello world" options page. When opened, the user can set the public <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> property in a property grid.  
...
### Description  
 ...
 In the case of a project generated by the package template, call this function from the <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> function to attach it to the default command added to the **Tools** menu.  
