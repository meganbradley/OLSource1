...
You can use the <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> method to persist changes to the user settings.  
...
## Example  
 This example changes the value of the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> user setting and saves that change by calling the <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> method.  
  
 [!code[VbVbalrMyResources#5](../vs140/codesnippet/VisualBasic/how-to--persist-user-settings-in-visual-basic_1.vb)]  
  
 For this example to work, your application must have a <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> user setting, of type <CodeContentPlaceHolder>4\</CodeContentPlaceHolder>. For more information, see [Managing Application Settings](../vs140/managing-application-settings--.net-.md).  
