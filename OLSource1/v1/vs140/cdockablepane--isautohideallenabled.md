...
## Return Value  
 <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> if the dockable pane, and all other panes in the container, can be switched to autohide mode; otherwise, <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>.  
