...
section 'name' specified with /SECTION option does not exist  
 ...
 [DUMPBIN](../vs140/dumpbin-reference.md) or [EDITBIN](../vs140/editbin-reference.md) could not find a section called <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> in the input file.  
