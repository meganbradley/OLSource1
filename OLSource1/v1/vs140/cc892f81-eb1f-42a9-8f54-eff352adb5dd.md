...
Unlike most methods, methods marked with the <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> modifier are overridable by default.  
  
 **Error ID:** BC30730  
  
### To correct this error  
  
-   Omit the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> modifier from methods marked with the <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> modifier.  
