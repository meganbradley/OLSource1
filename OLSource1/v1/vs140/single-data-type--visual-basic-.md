...
-   **Widening.** The `Single` data type widens to `Double`. This means you can convert `Single` to `Double` without encountering a <xref:System.OverflowException?qualifyHint=True> error.  
...
-   **Framework Type.** The corresponding type in the .NET Framework is the <xref:System.Single?qualifyHint=True> structure.  
  
## See Also  
 <xref:System.Single?qualifyHint=True>   
