...
## Remarks  
 Use the <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> data type to contain floating-point values that do not require the full data width of <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>. In some cases the common language runtime might be able to pack your <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> variables closely together and save memory consumption.  
...
-   **Widening.** The <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> data type widens to <CodeContentPlaceHolder>6\</CodeContentPlaceHolder>. This means you can convert <CodeContentPlaceHolder>7\</CodeContentPlaceHolder> to <CodeContentPlaceHolder>8\</CodeContentPlaceHolder> without encountering a \<xref:System.OverflowException*?displayProperty=fullName> error.  
...
-   **Type Characters.** Appending the literal type character <CodeContentPlaceHolder>9\</CodeContentPlaceHolder> to a literal forces it to the <CodeContentPlaceHolder>10\</CodeContentPlaceHolder> data type. Appending the identifier type character <CodeContentPlaceHolder>11\</CodeContentPlaceHolder> to any identifier forces it to <CodeContentPlaceHolder>12\</CodeContentPlaceHolder>.  
