...
---
# CDC::FromHandle
Returns a pointer to a <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> object when given a handle to a device context.  
...
## Remarks  
 If a <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> object is not attached to the handle, a temporary <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> object is created and attached.  
