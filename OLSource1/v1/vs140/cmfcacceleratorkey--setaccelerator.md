...
## Remarks  
 Use this method to set the shortcut key for a <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> if you did not provide a shortcut key when you created the <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>.  
