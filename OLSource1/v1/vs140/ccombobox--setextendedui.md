...
---
# CComboBox::SetExtendedUI
Call the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> member function to select either the default user interface or the extended user interface for a combo box that has the [CBS_DROPDOWN](../vs140/combo-box-styles.md) or [CBS_DROPDOWNLIST](../vs140/combo-box-styles.md) style.  
