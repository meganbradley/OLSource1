...
1.  Remove links to the [C run-time libraries](../vs140/crt-library-features.md) (CRT):  
    ...
    1.  In the .cpp file defining the entry point of your application, change the entry point to <CodeContentPlaceHolder>4\</CodeContentPlaceHolder>. Using <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> indicates that your project does not link to the CRT.  
    ...
    5.  In stdafx.h, comment out all the <CodeContentPlaceHolder>6\</CodeContentPlaceHolder> statements. For example, in console applications:  
...
<CodeContentPlaceHolder>1\</CodeContentPlaceHolder>  
    6.  For Windows Forms applications, in Form1.cpp, comment out the <CodeContentPlaceHolder>7\</CodeContentPlaceHolder> statement that references windows.h. For example:  
