...
## Remarks  
 There is no default implementation. You must override this function to return an item that represents the entire document. This return value should be an object of a <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>-derived class.  
