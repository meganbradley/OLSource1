...
|Name|Description|  
|----------|-----------------|  
|[CEdit::CEdit](#cedit__cedit)|Constructs a <CodeContentPlaceHolder>45\</CodeContentPlaceHolder> control object.|  
...
|[CEdit::Create](#cedit__create)|Creates the Windows edit control and attaches it to the <CodeContentPlaceHolder>46\</CodeContentPlaceHolder> object.|  
...
|[CEdit::GetLimitText](#cedit__getlimittext)|Gets the maximum amount of text this <CodeContentPlaceHolder>47\</CodeContentPlaceHolder> can contain.|  
...
|[CEdit::GetMargins](#cedit__getmargins)|Gets the left and right margins for this <CodeContentPlaceHolder>48\</CodeContentPlaceHolder>.|  
...
|[CEdit::SetLimitText](#cedit__setlimittext)|Sets the maximum amount of text this <CodeContentPlaceHolder>49\</CodeContentPlaceHolder> can contain.|  
|[CEdit::SetMargins](#cedit__setmargins)|Sets the left and right margins for this <CodeContentPlaceHolder>50\</CodeContentPlaceHolder>.|  
...
## Remarks  
 ...
 You can create an edit control either from a dialog template or directly in your code. In both cases, first call the constructor <CodeContentPlaceHolder>51\</CodeContentPlaceHolder> to construct the <CodeContentPlaceHolder>52\</CodeContentPlaceHolder> object, then call the [Create](#cedit__create) member function to create the Windows edit control and attach it to the <CodeContentPlaceHolder>53\</CodeContentPlaceHolder> object.  
  
 Construction can be a one-step process in a class derived from <CodeContentPlaceHolder>54\</CodeContentPlaceHolder>. Write a constructor for the derived class and call **Create** from within the constructor.  
  
 <CodeContentPlaceHolder>55\</CodeContentPlaceHolder> inherits significant functionality from <CodeContentPlaceHolder>56\</CodeContentPlaceHolder>. To set and retrieve text from a <CodeContentPlaceHolder>57\</CodeContentPlaceHolder> object, use the <CodeContentPlaceHolder>58\</CodeContentPlaceHolder> member functions [SetWindowText](../vs140/cwnd-class.md#cwnd__setwindowtext) and [GetWindowText](../vs140/cwnd-class.md#cwnd__getwindowtext), which set or get the entire contents of an edit control, even if it is a multiline control. Text lines in a multiline control are separated by '\r\n' character sequences. Also, if an edit control is multiline, get and set part of the control's text by calling the <CodeContentPlaceHolder>59\</CodeContentPlaceHolder> member functions [GetLine](#cedit__getline), [SetSel](#cedit__setsel), [GetSel](#cedit__getsel), and [ReplaceSel](#cedit__replacesel).  
  
 If you want to handle Windows notification messages sent by an edit control to its parent (usually a class derived from <CodeContentPlaceHolder>60\</CodeContentPlaceHolder>), add a message-map entry and message-handler member function to the parent class for each message.  
  
 Each message-map entry takes the following form:  
  
 **ON_**Notification **(** *id, memberFxn***)**  
  
 where <CodeContentPlaceHolder>61\</CodeContentPlaceHolder> specifies the child window ID of the edit control sending the notification, and <CodeContentPlaceHolder>62\</CodeContentPlaceHolder> is the name of the parent member function you have written to handle the notification.  
...
-   **ON_EN_VSCROLL** The user clicks an edit control's vertical scroll bar. The parent window is notified before the screen is updated.  
 ...
 If you create a <CodeContentPlaceHolder>63\</CodeContentPlaceHolder> object within a dialog box, the <CodeContentPlaceHolder>64\</CodeContentPlaceHolder> object is automatically destroyed when the user closes the dialog box.  
  
 If you create a <CodeContentPlaceHolder>65\</CodeContentPlaceHolder> object from a dialog resource using the dialog editor, the <CodeContentPlaceHolder>66\</CodeContentPlaceHolder> object is automatically destroyed when the user closes the dialog box.  
  
 If you create a <CodeContentPlaceHolder>67\</CodeContentPlaceHolder> object within a window, you may also need to destroy it. If you create the <CodeContentPlaceHolder>68\</CodeContentPlaceHolder> object on the stack, it is destroyed automatically. If you create the <CodeContentPlaceHolder>69\</CodeContentPlaceHolder> object on the heap by using the **new** function, you must call **delete** on the object to destroy it when the user terminates the Windows edit control. If you allocate any memory in the <CodeContentPlaceHolder>70\</CodeContentPlaceHolder> object, override the <CodeContentPlaceHolder>71\</CodeContentPlaceHolder> destructor to dispose of the allocations.  
 ...
 For more information on <CodeContentPlaceHolder>72\</CodeContentPlaceHolder>, see:  
...
##  \<a name="cedit__cedit">\</a>  CEdit::CEdit  
 Constructs a <CodeContentPlaceHolder>74\</CodeContentPlaceHolder> object.  
...
##  \<a name="cedit__charfrompos">\</a>  CEdit::CharFromPos  
 Call this function to retrieve the zero-based line and character indices of the character nearest the specified point in this <CodeContentPlaceHolder>75\</CodeContentPlaceHolder> control  
  
<CodeContentPlaceHolder>3\</CodeContentPlaceHolder>  
### Parameters  
 <CodeContentPlaceHolder>76\</CodeContentPlaceHolder>  
 The coordinates of a point in the client area of this <CodeContentPlaceHolder>77\</CodeContentPlaceHolder> object.  
...
##  \<a name="cedit__create">\</a>  CEdit::Create  
 Creates the Windows edit control and attaches it to the <CodeContentPlaceHolder>78\</CodeContentPlaceHolder> object.  
...
### Parameters  
 ...
 Specifies the edit control's size and position. Can be a <CodeContentPlaceHolder>81\</CodeContentPlaceHolder> object or <CodeContentPlaceHolder>82\</CodeContentPlaceHolder> structure.  
  
 <CodeContentPlaceHolder>83\</CodeContentPlaceHolder>  
 Specifies the edit control's parent window (usually a <CodeContentPlaceHolder>84\</CodeContentPlaceHolder>). It must not be **NULL**.  
...
### Remarks  
 You construct a <CodeContentPlaceHolder>86\</CodeContentPlaceHolder> object in two steps. First, call the <CodeContentPlaceHolder>87\</CodeContentPlaceHolder> constructor and then call **Create**, which creates the Windows edit control and attaches it to the <CodeContentPlaceHolder>88\</CodeContentPlaceHolder> object.  
 ...
 These messages are handled by default by the [OnNcCreate](../vs140/cwnd-class.md#cwnd__onnccreate), [OnNcCalcSize](../vs140/cwnd-class.md#cwnd__onnccalcsize), [OnCreate](../vs140/cwnd-class.md#cwnd__oncreate), and [OnGetMinMaxInfo](../vs140/cwnd-class.md#cwnd__ongetminmaxinfo) member functions in the <CodeContentPlaceHolder>89\</CodeContentPlaceHolder> base class. To extend the default message handling, derive a class from <CodeContentPlaceHolder>90\</CodeContentPlaceHolder>, add a message map to the new class, and override the above message-handler member functions. Override <CodeContentPlaceHolder>91\</CodeContentPlaceHolder>, for example, to perform needed initialization for the new class.  
...
### Remarks  
 ...
 The undo flag is automatically cleared whenever the [SetWindowText](../vs140/cwnd-class.md#cwnd__setwindowtext) or [SetHandle](#cedit__sethandle)<CodeContentPlaceHolder>92\</CodeContentPlaceHolder> member functions are called.  
...
### Remarks  
 A soft line break consists of two carriage returns and a linefeed inserted at the end of a line that is broken because of word wrapping. A hard line break consists of one carriage return and a linefeed. Lines that end with a hard line break are not affected by <CodeContentPlaceHolder>93\</CodeContentPlaceHolder>.  
  
 Windows will only respond if the <CodeContentPlaceHolder>94\</CodeContentPlaceHolder> object is a multiple-line edit control.  
  
 <CodeContentPlaceHolder>95\</CodeContentPlaceHolder> only affects the buffer returned by [GetHandle](#cedit__gethandle) and the text returned by                         [WM_GETTEXT](http://msdn.microsoft.com/library/windows/desktop/ms632627). It has no impact on the display of the text within the edit control.  
...
### Parameters  
 ...
 The number of characters that can be received. This number includes the terminating <CodeContentPlaceHolder>98\</CodeContentPlaceHolder> character.  
  
### Return Value  
 For the first overload, <CodeContentPlaceHolder>99\</CodeContentPlaceHolder> if the method is successful; otherwise <CodeContentPlaceHolder>100\</CodeContentPlaceHolder>.  
...
|---------------|-----------------|  
|[out] <CodeContentPlaceHolder>101\</CodeContentPlaceHolder>|Zero-based index of the first character in the range of text that is highlighted.|  
|[out] <CodeContentPlaceHolder>102\</CodeContentPlaceHolder>|Zero-based index of the last character in the range of text that is highlighted.|  
  
### Return Value  
 <CodeContentPlaceHolder>103\</CodeContentPlaceHolder> if this method is successful; otherwise, <CodeContentPlaceHolder>104\</CodeContentPlaceHolder>.  
...
##  \<a name="cedit__getlimittext">\</a>  CEdit::GetLimitText  
 Call this member function to get the text limit for this <CodeContentPlaceHolder>105\</CodeContentPlaceHolder> object.  
  
<CodeContentPlaceHolder>14\</CodeContentPlaceHolder>  
### Return Value  
 The current text limit, in bytes, for this <CodeContentPlaceHolder>106\</CodeContentPlaceHolder> object.  
...
##  \<a name="cedit__getline">\</a>  CEdit::GetLine  
 Call this function to retrieve a line of text from an edit control and places it in <CodeContentPlaceHolder>107\</CodeContentPlaceHolder>.  
...
### Parameters  
 ...
 Specifies the maximum number of bytes that can be copied to the buffer. <CodeContentPlaceHolder>111\</CodeContentPlaceHolder> places this value in the first word of <CodeContentPlaceHolder>112\</CodeContentPlaceHolder> before making the call to Windows.  
  
### Return Value  
 The number of bytes actually copied. The return value is 0 if the line number specified by <CodeContentPlaceHolder>113\</CodeContentPlaceHolder> is greater than the number of lines in the edit control.  
...
### Remarks  
 <CodeContentPlaceHolder>114\</CodeContentPlaceHolder> is only processed by multiple-line edit controls.  
...
### Return Value  
 Specifies the character to be displayed instead of the character that the user typed. The return value is <CodeContentPlaceHolder>115\</CodeContentPlaceHolder> if no password character exists.  
...
### Parameters  
 ...
 Points to the <CodeContentPlaceHolder>117\</CodeContentPlaceHolder> structure that receives the formatting rectangle.  
...
### Return Value  
 The version that returns a <CodeContentPlaceHolder>120\</CodeContentPlaceHolder> returns a value that contains the starting position in the low-order word and the position of the first nonselected character after the end of the selection in the high-order word.  
...
### Return Value  
 <CodeContentPlaceHolder>121\</CodeContentPlaceHolder> if this method is successful; otherwise, <CodeContentPlaceHolder>122\</CodeContentPlaceHolder>.  
...
### Parameters  
 ...
 Contains the zero-based index value for the desired character in the text of the edit control, or contains –1. If <CodeContentPlaceHolder>128\</CodeContentPlaceHolder> is –1, it specifies the current line, that is, the line that contains the caret.  
  
### Return Value  
 The zero-based line number of the line containing the character index specified by <CodeContentPlaceHolder>129\</CodeContentPlaceHolder>. If <CodeContentPlaceHolder>130\</CodeContentPlaceHolder> is –1, the number of the line that contains the first character of the selection is returned. If there is no selection, the current line number is returned.  
...
### Parameters  
 ...
 Contains the index value for the desired line in the text of the edit control, or contains –1. If <CodeContentPlaceHolder>132\</CodeContentPlaceHolder> is –1, it specifies the current line, that is, the line that contains the caret.  
  
### Return Value  
 The character index of the line specified in <CodeContentPlaceHolder>133\</CodeContentPlaceHolder> or –1 if the specified line number is greater than the number of lines in the edit control.  
...
### Return Value  
 For single-line edit controls, the return value is the length, in <CodeContentPlaceHolder>135\</CodeContentPlaceHolder>s, of the text in the edit control.  
  
 For multiline edit controls, the return value is the length, in <CodeContentPlaceHolder>136\</CodeContentPlaceHolder>s, of the line specified by the <CodeContentPlaceHolder>137\</CodeContentPlaceHolder> parameter. For [!INCLUDE[vcpransi](../vs140/includes/vcpransi_md.md)] text, the length is the number of bytes in the line; for Unicode text, the length is the number of characters in the line. The length does not include the carriage-return character at the end of the line.  
  
 If the <CodeContentPlaceHolder>138\</CodeContentPlaceHolder> parameter is more than the number of characters in the control, the return value is zero.  
  
 If the <CodeContentPlaceHolder>139\</CodeContentPlaceHolder> parameter is –1, the return value is the number of unselected characters in the lines that contain selected characters. For example, if the selection extends from the fourth character of one line through the eighth character from the end of the next line, the return value is 10. That is, three characters on the first line and seven on the next.  
  
 For more information about the <CodeContentPlaceHolder>140\</CodeContentPlaceHolder> type, see the <CodeContentPlaceHolder>141\</CodeContentPlaceHolder> row in the table in                         [Windows Data Types](http://msdn.microsoft.com/library/windows/desktop/aa383751).  
...
### Remarks  
 ...
 The edit control does not scroll vertically past the last line of text in the edit control. If the current line plus the number of lines specified by <CodeContentPlaceHolder>144\</CodeContentPlaceHolder> exceeds the total number of lines in the edit control, the value is adjusted so that the last line of the edit control is scrolled to the top of the edit-control window.  
  
 <CodeContentPlaceHolder>145\</CodeContentPlaceHolder> can be used to scroll horizontally past the last character of any line.  
...
##  \<a name="cedit__paste">\</a>  CEdit::Paste  
 Call this function to insert the data from the Clipboard into the <CodeContentPlaceHolder>146\</CodeContentPlaceHolder> at the insertion point.  
...
##  \<a name="cedit__posfromchar">\</a>  CEdit::PosFromChar  
 Call this function to get the position (top-left corner) of a given character within this <CodeContentPlaceHolder>147\</CodeContentPlaceHolder> object.  
...
### Return Value  
 The coordinates of the top-left corner of the character specified by <CodeContentPlaceHolder>149\</CodeContentPlaceHolder>.  
  
### Remarks  
 The character is specified by giving its zero-based index value. If <CodeContentPlaceHolder>150\</CodeContentPlaceHolder> is greater than the index of the last character in this <CodeContentPlaceHolder>151\</CodeContentPlaceHolder> object, the return value specifies the coordinates of the character position just past the last character in this <CodeContentPlaceHolder>152\</CodeContentPlaceHolder> object.  
...
##  \<a name="cedit__replacesel">\</a>  CEdit::ReplaceSel  
 Call this function to replace the current selection in an edit control with the text specified by <CodeContentPlaceHolder>153\</CodeContentPlaceHolder>.  
...
### Parameters  
 ...
 If <CodeContentPlaceHolder>158\</CodeContentPlaceHolder>, the cue banner is not drawn when the user clicks in the edit control and gives the control the focus.  
  
 If <CodeContentPlaceHolder>159\</CodeContentPlaceHolder>, the cue banner is drawn even when the control has focus. The cue banner disappears when the user starts to type in the control.  
  
 The default value is <CodeContentPlaceHolder>160\</CodeContentPlaceHolder>.  
  
### Return Value  
 <CodeContentPlaceHolder>161\</CodeContentPlaceHolder> if the method is successful; otherwise <CodeContentPlaceHolder>162\</CodeContentPlaceHolder>.  
...
### Remarks  
 ...
 <CodeContentPlaceHolder>163\</CodeContentPlaceHolder> clears the undo buffer (the [CanUndo](#cedit__canundo) member function then returns 0) and the internal modification flag (the [GetModify](#cedit__getmodify) member function then returns 0). The edit-control window is redrawn.  
...
|Parameter|Description|  
|---------------|-----------------|  
|[in] <CodeContentPlaceHolder>164\</CodeContentPlaceHolder>|Zero-based index of the first character in the range of text to highlight.|  
|[in] <CodeContentPlaceHolder>165\</CodeContentPlaceHolder>|Zero-based index of the last character in the range of text to highlight.|  
...
##  \<a name="cedit__setlimittext">\</a>  CEdit::SetLimitText  
 Call this member function to set the text limit for this <CodeContentPlaceHolder>166\</CodeContentPlaceHolder> object.  
...
### Remarks  
 ...
 Changing the text limit restricts only the text the user can enter. It has no effect on any text already in the edit control, nor does it affect the length of the text copied to the edit control by the [SetWindowText](../vs140/cwnd-class.md#cwnd__setwindowtext) member function in <CodeContentPlaceHolder>168\</CodeContentPlaceHolder>. If an application uses the <CodeContentPlaceHolder>169\</CodeContentPlaceHolder> function to place more text into an edit control than is specified in the call to <CodeContentPlaceHolder>170\</CodeContentPlaceHolder>, the user can delete any of the text within the edit control. However, the text limit will prevent the user from replacing the existing text with new text, unless deleting the current selection causes the text to fall below the text limit.  
...
### Remarks  
 ...
 When the <CodeContentPlaceHolder>172\</CodeContentPlaceHolder> member function is called, <CodeContentPlaceHolder>173\</CodeContentPlaceHolder> will redraw all visible characters using the character specified by                         *ch*.  
  
 If the edit control is created with the [ES_PASSWORD](../vs140/edit-styles.md) style, the default password character is set to an asterisk ( **\***). This style is removed if <CodeContentPlaceHolder>174\</CodeContentPlaceHolder> is called with                         *ch* set to 0.  
...
### Parameters  
 ...
 Points to the <CodeContentPlaceHolder>177\</CodeContentPlaceHolder> structure or <CodeContentPlaceHolder>178\</CodeContentPlaceHolder> object that specifies the new dimensions of the formatting rectangle.  
  
### Remarks  
 This member is processed only by multiple-line edit controls.  
  
 Use <CodeContentPlaceHolder>179\</CodeContentPlaceHolder> to set the formatting rectangle of a multiple-line edit control. The formatting rectangle is the limiting rectangle of the text, which is independent of the size of the edit-control window. When the edit control is first created, the formatting rectangle is the same as the client area of the edit-control window. By using the <CodeContentPlaceHolder>180\</CodeContentPlaceHolder> member function, an application can make the formatting rectangle larger or smaller than the edit-control window.  
  
 If the edit control has no scroll bar, text will be clipped, not wrapped, if the formatting rectangle is made larger than the window. If the edit control contains a border, the formatting rectangle is reduced by the size of the border. If you adjust the rectangle returned by the <CodeContentPlaceHolder>181\</CodeContentPlaceHolder> member function, you must remove the size of the border before you pass the rectangle to <CodeContentPlaceHolder>182\</CodeContentPlaceHolder>.  
  
 When <CodeContentPlaceHolder>183\</CodeContentPlaceHolder> is called, the edit control's text is also reformatted and redisplayed.  
...
### Parameters  
 ...
 Points to a <CodeContentPlaceHolder>185\</CodeContentPlaceHolder> structure or <CodeContentPlaceHolder>186\</CodeContentPlaceHolder> object that specifies the new dimensions of the rectangle.  
  
### Remarks  
 The formatting rectangle is the limiting rectangle of the text, which is independent of the size of the edit-control window.  
  
 <CodeContentPlaceHolder>187\</CodeContentPlaceHolder> is identical to the <CodeContentPlaceHolder>188\</CodeContentPlaceHolder> member function except that the edit-control window is not redrawn.  
  
 When the edit control is first created, the formatting rectangle is the same as the client area of the edit-control window. By calling the <CodeContentPlaceHolder>189\</CodeContentPlaceHolder> member function, an application can make the formatting rectangle larger or smaller than the edit-control window.  
 ...
 *bNoScroll*  
 ...
 Specifies the starting position. If <CodeContentPlaceHolder>191\</CodeContentPlaceHolder> is 0 and <CodeContentPlaceHolder>192\</CodeContentPlaceHolder> is –1, all the text in the edit control is selected. If <CodeContentPlaceHolder>193\</CodeContentPlaceHolder> is –1, any current selection is removed.  
...
### Parameters  
 ...
 Specifies that tab stops are to be set at every <CodeContentPlaceHolder>196\</CodeContentPlaceHolder> dialog units.  
  
 <CodeContentPlaceHolder>197\</CodeContentPlaceHolder>  
 Specifies the number of tab stops contained in <CodeContentPlaceHolder>198\</CodeContentPlaceHolder>. This number must be greater than 1.  
...
### Remarks  
 ...
 To set tab stops to the default size of 32 dialog units, call the parameterless version of this member function. To set tab stops to a size other than 32, call the version with the <CodeContentPlaceHolder>200\</CodeContentPlaceHolder> parameter. To set tab stops to an array of sizes, use the version with two parameters.  
  
 This member function is only processed by multiple-line edit controls.  
  
 <CodeContentPlaceHolder>201\</CodeContentPlaceHolder> does not automatically redraw the edit window. If you change the tab stops for text already in the edit control, call [CWnd::InvalidateRect](../vs140/cwnd-class.md#cwnd__invalidaterect) to redraw the edit window.  
...
|Parameter|Description|  
|---------------|-----------------|  
|[in] <CodeContentPlaceHolder>202\</CodeContentPlaceHolder>|Pointer to an                                         [EDITBALLOONTIP](http://msdn.microsoft.com/library/windows/desktop/bb775466) structure that describes the balloon tip.|  
|[in] <CodeContentPlaceHolder>203\</CodeContentPlaceHolder>|Pointer to a Unicode string that contains the title of the balloon tip.|  
|[in] <CodeContentPlaceHolder>204\</CodeContentPlaceHolder>|Pointer to a Unicode string that contains the balloon tip text.|  
|[in] <CodeContentPlaceHolder>205\</CodeContentPlaceHolder>|An <CodeContentPlaceHolder>206\</CodeContentPlaceHolder> that specifies the type of icon to associate with the balloon tip. The default value is <CodeContentPlaceHolder>207\</CodeContentPlaceHolder>. For more information, see the <CodeContentPlaceHolder>208\</CodeContentPlaceHolder> member of the                                         [EDITBALLOONTIP](http://msdn.microsoft.com/library/windows/desktop/bb775466) structure.|  
  
### Return Value  
 <CodeContentPlaceHolder>209\</CodeContentPlaceHolder> if this method is successful; otherwise, <CodeContentPlaceHolder>210\</CodeContentPlaceHolder>.  
...
### Example  
 The following code example defines a variable, <CodeContentPlaceHolder>211\</CodeContentPlaceHolder>, that is used to access the current edit control. This variable is used in the next example.  
