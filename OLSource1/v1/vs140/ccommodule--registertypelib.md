...
#### Parameters  
 ...
 [in] String in the format <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>, where <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> is the integer index of the TYPELIB resource.  
