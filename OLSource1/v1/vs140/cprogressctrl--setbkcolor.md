...
#### Parameters  
 ...
 A **COLORREF** value that specifies the new background color. Specify the <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> value to use the default background color for the progress bar.  
