...
---
# COleDialog::GetLastError
Call the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> member function to get additional error information when <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> returns **IDABORT**.  
  
## Syntax  
  
<CodeContentPlaceHolder>0\</CodeContentPlaceHolder>  
## Return Value  
 The error codes returned by <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> depend on the specific dialog box displayed.  
  
## Remarks  
 See the <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> member function in the derived classes for information about specific error messages.  
