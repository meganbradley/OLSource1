...
2.  In the **Properties** window, click **Edit Additional Query Code**.  
     ...
     The server code file opens in the Code Editor. A method that represents your query appears in the code file. The name of the method starts with the name of your query and ends with the word <CodeContentPlaceHolder>0\</CodeContentPlaceHolder>. For example, if the name of your query is <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>, the name of the method that appears in Code Editor is <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>.  
...
### Top *N* Customers Based on Sales Orders  
 The following query returns customers who have placed the greatest number of orders. A parameter named <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> is passed into the method. The <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> parameter specifies the number of customers to return in the result.  
