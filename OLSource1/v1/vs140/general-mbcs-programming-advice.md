...
-   For flexibility, use run-time macros such as <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> and <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> when possible. For more information, see [Generic-Text Mappings in Tchar.h](../vs140/generic-text-mappings-in-tchar.h.md).  
  
-   Use the C run-time <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> function to get information about the current code page.  
