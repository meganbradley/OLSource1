...
-   Console ([org.apache.cordova.console](https://github.com/apache/cordova-plugin-console/blob/master/doc/index.md))  
     ...
     Provides a different implementation of <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> (for use as a workaround to <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> issues).  
