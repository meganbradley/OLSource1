...
-   Methods declared with the <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> (<CodeContentPlaceHolder>1\</CodeContentPlaceHolder> in Visual Basic) modifier.  
  
-   Methods declared with the <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> (<CodeContentPlaceHolder>3\</CodeContentPlaceHolder> in Visual Basic) modifier.  
  
-   Methods declared with the <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> (<CodeContentPlaceHolder>5\</CodeContentPlaceHolder> in Visual Basic) modifier.  
  
-   Methods declared with the <CodeContentPlaceHolder>6\</CodeContentPlaceHolder> (<CodeContentPlaceHolder>7\</CodeContentPlaceHolder> statement in Visual Basic) modifier.  
