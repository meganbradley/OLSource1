...
---
# SINK_ENTRY
Declares the handler function (<CodeContentPlaceHolder>1\</CodeContentPlaceHolder>) for the specified event (<CodeContentPlaceHolder>2\</CodeContentPlaceHolder>), of the control identified by <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>.  
