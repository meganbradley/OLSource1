...
dev_langs: 
  - "C++"
helpviewer_keywords: 
  - "SetItemExpandedImageIndex method"
...
|[in] <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>|The index of the image to display when the specified item is in the expanded state.|  
...
## Remarks  
 This method sends the [TVM_SETITEM](http://msdn.microsoft.com/library/windows/desktop/bb773758) message, which is described in the [!INCLUDE[winSDK](../vs140/includes/winsdk_md.md)]. This method assigns the <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> parameter to the <CodeContentPlaceHolder>6\</CodeContentPlaceHolder> member of a [TVITEMEX](http://msdn.microsoft.com/library/windows/desktop/bb773459) structure, and then uses that structure in the message.  
...
## Example  
 ...
 [!code[NVC_MFC_CTreeCtrl_s1#1](../vs140/codesnippet/CPP/ctreectrl--setitemexpandedimageindex_1.h)]  
...
## Example  
 ...
 [!code[NVC_MFC_CTreeCtrl_s1#8](../vs140/codesnippet/CPP/ctreectrl--setitemexpandedimageindex_2.cpp)]  
