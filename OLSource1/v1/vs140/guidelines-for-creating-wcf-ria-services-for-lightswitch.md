...
|<xref:System.ComponentModel.DataAnnotations.StringLengthAttribute?qualifyHint=False>|In [!INCLUDE[smb_current_short](../vs140/includes/smb_current_short_md.md)], use the `MaximumLength` property to set the **Maximum Length** property of the field.|  
|<xref:System.ComponentModel.DataAnnotations.StringLengthAttribute?qualifyHint=False>|In [!INCLUDE[smb_current_short](../vs140/includes/smb_current_short_md.md)], if you apply this attribute, the **Display by Default** property of the field is set to `False`.|  
