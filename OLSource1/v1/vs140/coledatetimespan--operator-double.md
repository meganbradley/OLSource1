...
Converts this <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> value to a **double**.  
  
## Syntax  
  
<CodeContentPlaceHolder>0\</CodeContentPlaceHolder>  
## Remarks  
 This operator returns the value of this <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> value as a floating-point number of days.  
