...
## Text Controls  
 ...
 A control in which the user can enter and edit text. Unlike the control encapsulated in <CodeContentPlaceHolder>0\</CodeContentPlaceHolder>, a rich edit control supports character and paragraph formatting and OLE objects.  
