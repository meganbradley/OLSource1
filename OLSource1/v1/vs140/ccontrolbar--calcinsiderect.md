...
#### Parameters  
 ...
 Indicates that the bar is horizontally or vertically oriented. The <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> parameter is nonzero if the bar is horizontally oriented and is 0 if it is vertically oriented.  
