...
## Return Value  
 <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> to dim the images of disabled buttons; <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>to obtain images from the collection of disabled images.  
