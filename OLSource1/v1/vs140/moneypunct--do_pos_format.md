...
## Return Value  
 ...
 The template version of moneypunct\<**CharType**, **Inputlterator**> returns <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>**money_base::symbol**, **money_base::sign**, **money_base::value**, **money_base::none**<CodeContentPlaceHolder>2\</CodeContentPlaceHolder>.  
  
## Example  
 See the example for [pos_format](../vs140/moneypunct--pos_format.md), where the virtual member function is called by <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>.  
