...
Language-Integrated Query (LINQ) makes it easy to access database information and execute queries.  
 ...
 The following example shows how to create a new application that performs queries against a SQL Server database. The sample counts, sums, and averages the results by using the <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> and <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> clauses. For more information, see [Aggregate Clause (Visual Basic)](../vs140/aggregate-clause--visual-basic-.md) and [Group By Clause (Visual Basic)](../vs140/group-by-clause--visual-basic-.md).  
...
3.  Name the file <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>. Click **Add**. The Object Relational Designer (O/R Designer) is opened for the northwind.dbml file.  
...
2.  Click the Customers table and drag it to the left pane of the designer. Click the Orders table and drag it to the left pane of the designer.  
     ...
     The designer creates new <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> and <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> objects for your project. Notice that the designer automatically detects relationships between the tables and creates child properties for related objects. For example, IntelliSense will show that the <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> object has an <CodeContentPlaceHolder>6\</CodeContentPlaceHolder> property for all orders related to that customer.  
...
2.  Double-click Form1 to add code to the <CodeContentPlaceHolder>7\</CodeContentPlaceHolder> event of the form.  
  
3.  When you added tables to the O/R Designer, the designer added a \<xref:System.Data.Linq.DataContext*> object for your project. This object contains the code that you must have to access those tables, and to access individual objects and collections for each table. The \<xref:System.Data.Linq.DataContext*> object for your project is named based on the name of your .dbml file. For this project, the \<xref:System.Data.Linq.DataContext*> object is named <CodeContentPlaceHolder>8\</CodeContentPlaceHolder>.  
     ...
     Add the following code to the <CodeContentPlaceHolder>9\</CodeContentPlaceHolder> event to query the tables that are exposed as properties of your \<xref:System.Data.Linq.DataContext*> and count, sum, and average the results. The sample uses the <CodeContentPlaceHolder>10\</CodeContentPlaceHolder> clause to query for a single result, and the <CodeContentPlaceHolder>11\</CodeContentPlaceHolder> clause to show an average for grouped results.  
  
     [!code[VbLINQToSQLHowTos#13](../vs140/codesnippet/VisualBasic/how-to--count--sum--or-average-data-by-using-linq--visual-basic-_1.vb)]  
