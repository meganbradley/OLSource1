...
## Remarks  
 ...
 In the previous syntax, `accessibility-modifier` can be `public`, `private` or `internal`. For more information, see [Access Control (F#)](../vs140/access-control--fsharp-.md).  
