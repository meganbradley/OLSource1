...
#### Parameters  
 ...
 <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> to retrieve the destination size; <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> to retrieve the source image size.  
  
## Return Value  
 A <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> structure, which specifies the size of an image in pixels.  
