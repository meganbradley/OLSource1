...
> [!NOTE]
>  To verify whether there is an exception, check the value returned by <CodeContentPlaceHolder>5\</CodeContentPlaceHolder>: if it is a null value, then no exception is associated with this object.  
