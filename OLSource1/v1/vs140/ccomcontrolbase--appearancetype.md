...
## Remarks  
 The ATL Control Wizard adds **m_nAppearance** stock property of type short. Override <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> if you use a different data type.  
