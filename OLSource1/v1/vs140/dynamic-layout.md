...
1.  Find or create a place in your dialog class's implementation code where you want to specify the dynamic layout for the dialog. For example, you might want to add a method such as <CodeContentPlaceHolder>8\</CodeContentPlaceHolder> in your dialog, and call it from places where the layout needs to be changed. You might first call this from the constructor, or after making changes to the dialog.  
...
10. If you want to disable dynamic layout, call [CWnd::EnableDynamicLayout](../vs140/cwnd--enabledynamiclayout.md) with <CodeContentPlaceHolder>9\</CodeContentPlaceHolder> as for the <CodeContentPlaceHolder>10\</CodeContentPlaceHolder> parameter.  
