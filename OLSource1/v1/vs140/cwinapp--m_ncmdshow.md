...
## Remarks  
 You should pass <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> as an argument when you call [CWnd::ShowWindow](../vs140/cwnd--showwindow.md) for your application's main window. <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> is a public variable of type <CodeContentPlaceHolder>5\</CodeContentPlaceHolder>.  
