...
**MSB3486: Cannot get certificate from store '\<certificate store>'.**  
 ...
 The <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> MSBuild task generates this error when the certificate matching the thumbprint of your project's .pfx file is not found in your personal certificate store.  
