...
## Remarks  
 ...
 To toggle the HUD, you don't have to be actively capturing graphics information—that is, it can be toggled through an instance of the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> class, but the [Init](../vs140/init.md) member function doesn't have to be called first.