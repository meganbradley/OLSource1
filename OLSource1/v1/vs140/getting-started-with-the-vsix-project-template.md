...
3.  Add the .zip file to the project. Set its **Copy to Output Directory** property to <CodeContentPlaceHolder>0\</CodeContentPlaceHolder>.  
  
4.  In the **Solution Explorer**, double-click the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> file to open it in the **VSIX Manifest Designer**, and then make the following changes:  
