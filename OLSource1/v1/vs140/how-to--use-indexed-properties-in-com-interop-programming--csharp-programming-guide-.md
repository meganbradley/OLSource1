...
> [!NOTE]
>  The previous example also uses the [optional arguments](../vs140/named-and-optional-arguments--csharp-programming-guide-.md) feature, introduced in Visual C# 2010, which enables you to omit `Type.Missing`.  
