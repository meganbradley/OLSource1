...
-   How to view the list of <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> instances that are created in your application.  
...
5.  Paste the following code for your chosen language into the empty code file.  
 ...
 [!code[Debugger#1](../vs140/codesnippet/CSharp/walkthrough--debugging-a-parallel-application_1.cs)]
[!code[Debugger#1](../vs140/codesnippet/CPP/walkthrough--debugging-a-parallel-application_1.cpp)]
[!code[Debugger#1](../vs140/codesnippet/VisualBasic/walkthrough--debugging-a-parallel-application_1.vb)]  
  
1.  On the **File** menu, click **Save All**.  
  
2.  On the **Build** menu, click **Rebuild Solution**.  
  
     Notice that there are four calls to <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> (<CodeContentPlaceHolder>2\</CodeContentPlaceHolder> in the C++ sample) Therefore, you do not have to insert breakpoints; just running the application will cause it to break in the debugger up to four times.  
...
1.  On the **Debug** menu, point to **Windows** and then click **Parallel Stacks**. Make sure that **Threads** is selected in the box at the upper-left corner.  
     ...
     The call stack of the Main thread appears in one box and the call stacks for the other four threads are grouped in another box. Four threads are grouped together because their stack frames share the same method contexts; that is, they are in the same methods: <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>, <CodeContentPlaceHolder>4\</CodeContentPlaceHolder>, and <CodeContentPlaceHolder>5\</CodeContentPlaceHolder>. To view the thread IDs and names of the threads that share the same box, hover over the header (**4 Threads**). The current thread is displayed in bold, as shown in the following illustration.  
