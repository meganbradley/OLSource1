...
A <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> block within the code is never reached.  
...
-   Remove the extraneous <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> block.  
