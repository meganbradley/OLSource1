...
|/F <CodeContentPlaceHolder>0\</CodeContentPlaceHolder>|Specifies <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> as a makefile. Spaces or tabs can precede <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>. Specify /F once for each makefile. To supply a makefile from standard input, specify a dash (–) for <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>, and end keyboard input with either F6 or CTRL+Z.|  
...
|/X <CodeContentPlaceHolder>4\</CodeContentPlaceHolder>|Sends NMAKE error output to <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> instead of standard error. Spaces or tabs can precede <CodeContentPlaceHolder>6\</CodeContentPlaceHolder>. To send error output to standard output, specify a dash (–) for <CodeContentPlaceHolder>7\</CodeContentPlaceHolder>. Does not affect output from commands to standard error.|  
