...
## Example  
 The following Visual Basic example shows a type <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> that correctly calls the \<xref:System.Object.Finalize*> method in its base class.  
  
 [!code[FxCop.Usage.IDisposableBaseCalled#1](../vs140/codesnippet/VisualBasic/ca2220--finalizers-should-call-base-class-finalizer_1.vb)]  
