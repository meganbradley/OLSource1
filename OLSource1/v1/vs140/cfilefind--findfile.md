...
#### Parameters  
 ...
 A pointer to a string containing the name of the file to find. If you pass **NULL** for <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>, **FindFile** does a wildcard (*.\*) search.  
...
## Remarks  
 After calling **FindFile** to begin the file search, call [FindNextFile](../vs140/cfilefind--findnextfile.md) to retrieve subsequent files. You must call <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> at least once before calling any of the following attribute member functions:  
