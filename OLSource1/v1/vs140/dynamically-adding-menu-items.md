...
5.  Override the assetId:///M:Microsoft.VisualStudio.Shell.OleMenuCommand.DynamicItemMatch(System.Int32)?qualifyHint=False&autoUpgrade=True method so that it calls the matches predicate and sets the <xref:Microsoft.VisualStudio.Shell.OleMenuCommand.MatchedCommandId*> property:  
