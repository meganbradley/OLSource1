...
You have attempted to expose a private type outside the public class <CodeContentPlaceHolder>0\</CodeContentPlaceHolder>.  
  
 **Error ID:** BC30508  
  
### To correct this error  
  
-   Declare the type <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>.  
