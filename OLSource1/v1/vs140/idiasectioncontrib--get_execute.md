...
#### Parameters  
 ...
 [out] Returns <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> if the section can be executed as code; otherwise, returns <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>.  
