...
-   `signatures`. Read/write. Gets or sets the array of function signatures. Each element in the array is a `signature` object. Some `signature` properties, such as `locid`, correspond to common [XML Documentation Comment](../vs140/xml-documentation-comments--javascript-.md) attributes.  
    ...
    -   `returnValue`. Read/write. Gets or sets a return value object with properties that correspond to the following attributes of the [<returns>](../vs140/-returns---javascript-.md) element:  
...
###  <a name="SymbolHelp"></a> symbolHelp Property  
 ...
 Some properties of the `symbolHelp` object, such as `locid`, correspond to common [XML Documentation Comment](../vs140/xml-documentation-comments--javascript-.md) attributes.  
