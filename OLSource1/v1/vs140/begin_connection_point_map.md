...
## Remarks  
 Start your connection point map with the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> macro, add entries for each of your connection points with the [CONNECTION_POINT_ENTRY](../vs140/connection_point_entry.md) macro, and complete the map with the [END_CONNECTION_POINT_MAP](../vs140/end_connection_point_map.md) macro.  
