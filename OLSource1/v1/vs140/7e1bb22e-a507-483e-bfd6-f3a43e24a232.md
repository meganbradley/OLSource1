...
<CodeContentPlaceHolder>0\</CodeContentPlaceHolder> disallows implicit conversions from '<CodeContentPlaceHolder>1\</CodeContentPlaceHolder>' to '<CodeContentPlaceHolder>2\</CodeContentPlaceHolder>'; the Visual Basic 6.0 collection type is not compatible with the [!INCLUDE[dnprdnshort](../vs140/includes/dnprdnshort_md.md)] collection type.  
