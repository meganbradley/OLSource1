...
---
# CWinApp::LoadOEMCursor
Loads the Windows predefined cursor resource specified by <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>.  
...
## Remarks  
 Use the <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> or [LoadStandardCursor](../vs140/cwinapp--loadstandardcursor.md) member function to access the predefined Windows cursors.  
