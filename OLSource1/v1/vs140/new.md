...
---
# new
Briefly describes the uses of the <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> keyword and links to more information.  
...
|[ref new, gcnew](../vs140/ref-new--gcnew---c---component-extensions-.md)|In a [!INCLUDE[cppwrt_short](../vs140/includes/cppwrt_short_md.md)] (<CodeContentPlaceHolder>1\</CodeContentPlaceHolder>) or C++/CLI (<CodeContentPlaceHolder>2\</CodeContentPlaceHolder>) project, this compound keyword creates a reference-counted object.|