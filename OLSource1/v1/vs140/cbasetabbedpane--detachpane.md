...
## Return Value  
 <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> if the framework successfully detaches the pane; <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> if <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> is <CodeContentPlaceHolder>6\</CodeContentPlaceHolder> or refers to a pane that is not in the tabbed pane.  
