...
|Exception Settings|CTRL+ALT+E|[Managing Exceptions with the Debugger](../vs140/managing-exceptions-with-the-debugger.md)|  
|Output|CTRL+ALT+O|[Output Window](../vs140/output-window.md)|  
|GPU Threads|-|[How to: Use the GPU Threads Window](../vs140/how-to--use-the-gpu-threads-window.md)|  
|Tasks|CTR:+SHIFT+D, K|[Using the Tasks Window](../vs140/using-the-tasks-window.md)|  
|Parallel Stacks|CTR:+SHIFT+D, S|[Using the Parallel Stacks Window](../vs140/using-the-parallel-stacks-window.md)|  
|Parallel Watch|CTR:+SHIFT+D, (1, 2, 3, 4)|[Using the Parallel Stacks Window](../vs140/using-the-parallel-stacks-window.md)|  
...
|Processes|CTRL+ALT+Z|[Debug Threads and Processes](../vs140/debug-threads-and-processes.md)|  
