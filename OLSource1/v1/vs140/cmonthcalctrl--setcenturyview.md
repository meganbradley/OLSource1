...
## Remarks  
 This method uses the [CMonthCalCtrl::SetCurrentView](../vs140/cmonthcalctrl--setcurrentview.md) method to set the view to <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>, which represents the century view.  
