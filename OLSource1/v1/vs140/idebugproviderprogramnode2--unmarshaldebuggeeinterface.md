...
#### Parameters  
 ...
 `ppvObject`  
 [out] Returns the object implementing the desired interface. [C++] this can be cast directly to the desired interface type. [C#] use the [GetObjectForIUnknown](assetId:///M:System.Runtime.InteropServices.Marshal.GetObjectForIUnknown(System.IntPtr)?qualifyHint=False&autoUpgrade=True) method to get the desired interface.  
