...
5.  Attach the profiler to the target application. Type:  
     ...
     **VSPerfCmd**  [/attach](../vs140/attach.md) **:**{<CodeContentPlaceHolder>8\</CodeContentPlaceHolder>&#124;<CodeContentPlaceHolder>9\</CodeContentPlaceHolder>} [[/targetclr](../vs140/targetclr.md)**:**<CodeContentPlaceHolder>10\</CodeContentPlaceHolder>]  
  
    -   <CodeContentPlaceHolder>11\</CodeContentPlaceHolder> specifies the process ID of the target application. <CodeContentPlaceHolder>12\</CodeContentPlaceHolder> specifies the name of the process. Note that if you specify <CodeContentPlaceHolder>13\</CodeContentPlaceHolder> and multiple processes that have the same name are running, results are unpredictable. You can view the process IDs of all running processes in Windows Task Manager.  
...
-   The following pairs of options start and stop data collection. Specify each option on a separate command line. You can turn data collection on and off multiple times.  
    ...
    |[/processon](../vs140/processon-and-processoff.md) **:** <CodeContentPlaceHolder>15\</CodeContentPlaceHolder> [/processoff](../vs140/processon-and-processoff.md) **:** <CodeContentPlaceHolder>16\</CodeContentPlaceHolder>|Starts (**/processon**) or stops (**/processoff**) data collection for the process that is specified by the <CodeContentPlaceHolder>17\</CodeContentPlaceHolder>.|  
    |[/attach](../vs140/attach.md) **:**{<CodeContentPlaceHolder>18\</CodeContentPlaceHolder>&#124;<CodeContentPlaceHolder>19\</CodeContentPlaceHolder>} [/detach](../vs140/detach.md)[**:**{<CodeContentPlaceHolder>20\</CodeContentPlaceHolder>&#124;<CodeContentPlaceHolder>21\</CodeContentPlaceHolder>}]|**/attach** starts to collect data for the process that is specified by the <CodeContentPlaceHolder>22\</CodeContentPlaceHolder> or process name (ProcName). **/detach** stops data collection for the specified process or for all processes if a specific process is not specified.|  
