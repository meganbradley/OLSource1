...
Returns <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> if the option is not <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>.  
...
## Return Value  
 <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> if the option is not <CodeContentPlaceHolder>6\</CodeContentPlaceHolder>.  
