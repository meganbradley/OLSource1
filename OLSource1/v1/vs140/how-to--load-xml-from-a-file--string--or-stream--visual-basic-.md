...
-   To populate an XML literal such as an <xref:System.Xml.Linq.XElement*> or <xref:System.Xml.Linq.XDocument*> object from a stream, you can use the `Load` method or the [XNode.ReadFrom](assetId:///M:System.Xml.Linq.XNode.ReadFrom(System.Xml.XmlReader)?qualifyHint=True&autoUpgrade=True) method.  
  
 The following code example shows the use of the [ReadFrom](assetId:///M:System.Xml.Linq.XNode.ReadFrom(System.Xml.XmlReader)?qualifyHint=False&autoUpgrade=True) method to populate an <xref:System.Xml.Linq.XDocument*> object with XML from an XML stream.  
  
 [!code[VbXMLSamples#46](../vs140/codesnippet/VisualBasic/how-to--load-xml-from-a-file--string--or-stream--visual-basic-_3.vb)]  
  
## See Also  
 [XDocument.Load](assetId:///M:System.Xml.Linq.XDocument.Load(System.String)?qualifyHint=True&autoUpgrade=True)   
 [XElement.Load](assetId:///M:System.Xml.Linq.XElement.Load(System.String)?qualifyHint=True&autoUpgrade=True)   
 [XElement.Parse](assetId:///M:System.Xml.Linq.XElement.Parse(System.String)?qualifyHint=True&autoUpgrade=True)   
 [XDocument.Parse](assetId:///M:System.Xml.Linq.XDocument.Parse(System.String)?qualifyHint=True&autoUpgrade=True)   
 assetId:///M:System.Xml.Linq.XNode.ReadFrom(System.Xml.XmlReader)?qualifyHint=True&autoUpgrade=True   
