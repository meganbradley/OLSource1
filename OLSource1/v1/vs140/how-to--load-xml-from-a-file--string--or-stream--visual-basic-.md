...
-   To populate an XML literal such as an \<xref:System.Xml.Linq.XElement*> or \<xref:System.Xml.Linq.XDocument*> object from a file, use the <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> method. This method can take a file path, text stream, or XML stream as input.  
...
-   To populate an XML literal such as an \<xref:System.Xml.Linq.XElement*> or \<xref:System.Xml.Linq.XDocument*> object from a string, you can use the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> method.  
...
-   To populate an XML literal such as an \<xref:System.Xml.Linq.XElement*> or \<xref:System.Xml.Linq.XDocument*> object from a stream, you can use the <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> method or the \<xref:System.Xml.Linq.XNode.ReadFrom*?displayProperty=fullName> method.  
