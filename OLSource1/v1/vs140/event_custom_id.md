...
---
# EVENT_CUSTOM_ID
Defines an event firing function for a custom event belonging to the dispatch ID specified by <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>.  
...
## Remarks  
 The <CodeContentPlaceHolder>6\</CodeContentPlaceHolder> argument is a space-separated list of values from the **VTS_** constants. One or more of these values separated by spaces, not commas, specifies the function's parameter list. For example:  
