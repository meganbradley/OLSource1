...
## Return Value  
 Returns **TRUE** if successful, or **FALSE** otherwise. **FALSE** is returned if the size in the <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> member of the **LVINSERTMARK** structure does not equal the actual size of the structure.  
