...
## Task Logic  
 ...
 The execution logic of a task is implemented as a .NET class that implements the <xref:Microsoft.Build.Framework.ITask?qualifyHint=False> interface, which is defined in the <xref:Microsoft.Build.Framework?qualifyHint=False> namespace.  
 ...
 You can write your own task by authoring a managed class that implements the <xref:Microsoft.Build.Framework.ITask?qualifyHint=False> interface. For more information, see [How To: Write a Task](../vs140/task-writing.md).  
