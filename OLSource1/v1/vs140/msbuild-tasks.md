...
## Executing a Task from a Project File  
 ...
 To execute a task in an [!INCLUDE[vstecmsbuild](../vs140/includes/vstecmsbuild_md.md)] project file, create an element with the name of the task as a child of a <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> element. If a task accepts parameters, these are passed as attributes of the element.  
  
 [!INCLUDE[vstecmsbuild](../vs140/includes/vstecmsbuild_md.md)] item lists and properties can be used as parameters. For example, the following code calls the <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> task and sets the value of the <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> property of the <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> object equal to the value of the <CodeContentPlaceHolder>6\</CodeContentPlaceHolder> property declared in the previous example.  
  
<CodeContentPlaceHolder>0\</CodeContentPlaceHolder>  
 Tasks can also return information to the project file, which can be stored in items or properties for later use. For example, the following code calls the <CodeContentPlaceHolder>7\</CodeContentPlaceHolder> task and stores the information from the <CodeContentPlaceHolder>8\</CodeContentPlaceHolder> output property in the <CodeContentPlaceHolder>9\</CodeContentPlaceHolder> item list.  
