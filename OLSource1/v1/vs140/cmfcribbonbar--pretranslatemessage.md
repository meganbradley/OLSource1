...
## Return Value  
 <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> if the message was processed by the ribbon bar; otherwise <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>.  
