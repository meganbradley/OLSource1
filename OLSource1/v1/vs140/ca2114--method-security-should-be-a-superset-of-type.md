...
## Rule Description  
 A method should not have both a method-level and type-level declarative security for the same action. The two checks are not combined; only the method-level demand is applied. For example, if a type demands permission <CodeContentPlaceHolder>0\</CodeContentPlaceHolder>, and one of its methods demands permission <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>, code does not have to have permission <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> to execute the method.  
  
## How to Fix Violations  
 Review your code to make sure that both actions are required. If both actions are required, make sure that the method-level action includes the security specified at the type level. For example, if your type demands permission <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>, and its method must also demand permission <CodeContentPlaceHolder>4\</CodeContentPlaceHolder>, the method should explicitly demand <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> and <CodeContentPlaceHolder>6\</CodeContentPlaceHolder>.  
...
## Example  
 ...
 [!code[FxCop.Security.MethodLevelSecurity#1](../vs140/codesnippet/CSharp/ca2114--method-security-should-be-a-superset-of-type_1.cs)]  
...
## Example  
 ...
 [!code[FxCop.Security.TestMethodLevelSecurity#1](../vs140/codesnippet/CSharp/ca2114--method-security-should-be-a-superset-of-type_2.cs)]  
