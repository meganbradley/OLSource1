...
---
# CAccessToken::OpenCOMClientToken
Call this method from within a COM server handling a call from a client to initialize the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> with the access token from the COM client.  
