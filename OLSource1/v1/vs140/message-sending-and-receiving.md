...
Consider the sending part of the process and how the framework responds.  
 ...
 The **Run** member function of class <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> retrieves messages and dispatches them to the appropriate window. Most command messages are sent to the main frame window of the application. The <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> predefined by the class library gets the messages and routes them differently, depending on the category of message received.  
