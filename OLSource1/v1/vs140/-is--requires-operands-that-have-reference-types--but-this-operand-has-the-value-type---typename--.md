...
The <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> comparison operator determines whether two object variables refer to the same instance. This comparison is not defined for value types.  
  
 **Error ID:** BC30020  
  
### To correct this error  
  
-   Use the appropriate arithmetic comparison operator or the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> operator to compare two value types.  
