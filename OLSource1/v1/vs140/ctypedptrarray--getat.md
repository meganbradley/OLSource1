...
---
# CTypedPtrArray::GetAt
This inline function calls <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>**::GetAt**.  
...
## Return Value  
 A copy of the element at the location specified by <CodeContentPlaceHolder>4\</CodeContentPlaceHolder>. This element is of the type specified by the template parameter *TYPE*.  
