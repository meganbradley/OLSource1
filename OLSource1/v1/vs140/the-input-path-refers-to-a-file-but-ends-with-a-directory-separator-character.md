...
An operation was attempted requiring that a filename be supplied, but the supplied name ends with a directory separator character (<CodeContentPlaceHolder>0\</CodeContentPlaceHolder>). This may be the result of an incorrectly parsed file path.  
