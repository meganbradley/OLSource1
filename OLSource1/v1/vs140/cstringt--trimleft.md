...
#### Parameters  
 ...
 A pointer to a string containing the target characters to be trimmed. All leading occurrences of characters in <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> will be trimmed from the <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> object.  
