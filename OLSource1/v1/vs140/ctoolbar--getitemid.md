...
---
# CToolBar::GetItemID
This member function returns the command ID of the button or separator specified by <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>.  
...
## Return Value  
 The command ID of the button or separator specified by <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>.  
