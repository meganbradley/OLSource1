...
## Remarks  
 This function behaves the same as the STL function <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> For more information, see [inplace_merge](../vs140/inplace_merge.md).  
