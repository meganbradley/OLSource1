...
## Remarks  
 Use the values in the [Array4D module](../vs140/collections.array4d-module--fsharp-.md) to manipulate values of this type, or the notation <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> to get and set array values.  
