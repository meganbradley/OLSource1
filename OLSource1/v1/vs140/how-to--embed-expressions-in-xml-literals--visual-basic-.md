...
You can combine XML literals with embedded expressions to create an XML document, fragment, or element that contains content created at run time. The following examples demonstrate how to use embedded expressions to populate element content, attributes, and element names at run time.  
 ...
 The syntax for an embedded expression is <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> <CodeContentPlaceHolder>5\</CodeContentPlaceHolder>, which is the same syntax that [!INCLUDE[vstecasp](../vs140/includes/vstecasp_md.md)] uses. For more information, see [Embedded Expressions in XML](../vs140/embedded-expressions-in-xml--visual-basic-.md).  
...
-   The following example shows how to insert the text that is contained in the <CodeContentPlaceHolder>6\</CodeContentPlaceHolder> variable between the opening and closing name elements.  
...
-   The following example shows how to insert the text that is contained in the <CodeContentPlaceHolder>7\</CodeContentPlaceHolder> variable as the value of the <CodeContentPlaceHolder>8\</CodeContentPlaceHolder> attribute.  
...
-   The following example shows how to insert the text that is contained in the <CodeContentPlaceHolder>9\</CodeContentPlaceHolder> variable as the name of an element.  
