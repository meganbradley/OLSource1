...
-   Override **CDocument**'s <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> member function in your document class. <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> writes and reads the document's data to and from disk.  
