...
A statement attempts to convert an <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> expression to a type that can only be a base class and cannot be used to create an instance.  
  
 The <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> operator creates a procedure delegate instance that references a specific procedure.  
  
 **Error ID:** BC30939  
  
### To correct this error  
  
-   Assign the <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> expression to a specific delegate type.  
