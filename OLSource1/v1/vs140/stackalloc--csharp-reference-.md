...
```  
 ...
 Because pointer types are involved, `stackalloc` requires [unsafe](../vs140/unsafe--csharp-reference-.md) context. For more information, see [Unsafe Code and Pointers](../vs140/unsafe-code-and-pointers--csharp-programming-guide-.md).  
