...
## Return Value  
 A reference to a <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> object.  
  
## Remarks  
 Use <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> to take advantage of the functionality of the Windows toolbar common control, and to take advantage of the support [CToolBarCtrl](../vs140/ctoolbarctrl-class.md) provides for toolbar customization.  
