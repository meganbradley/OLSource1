...
---
# CRecordset::m_strSort
After you construct the recordset object, but before you call its **Open** member function, use this data member to store a <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> containing a SQL **ORDER BY** clause.  
