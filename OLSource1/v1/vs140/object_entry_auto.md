...
#### Parameters  
 ...
 [in] The CLSID of a COM class implemented by the C++ class named <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>.  
  
 <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>  
 [in] The name of the C++ class implementing the COM class represented by <CodeContentPlaceHolder>4\</CodeContentPlaceHolder>.  
