...
Creates two new maps, one containing the bindings for which the given predicate returns <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>, and the other the remaining bindings.  
...
## Return Value  
 A pair of maps in which the first contains the elements for which the predicate returned <CodeContentPlaceHolder>6\</CodeContentPlaceHolder> and the second containing the elements for which the predicated returned <CodeContentPlaceHolder>7\</CodeContentPlaceHolder>.  
...
## Example  
 ...
 [!code[FsMaps#13](../vs140/codesnippet/FSharp/map.partition--key--t--function--fsharp-_1.fs)]  
