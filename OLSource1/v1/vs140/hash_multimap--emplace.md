...
dev_langs: 
  - "C++"
helpviewer_keywords: 
  - "emplace method, hash_multimap class"
  - "emplace method"
...
|<CodeContentPlaceHolder>2\</CodeContentPlaceHolder>|The value used to move construct an element to be inserted into the [hash_multimap](../vs140/hash_multimap-class.md).|  
  
## Return Value  
 The <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> member function returns an iterator that points to the position where the new element was inserted.  
