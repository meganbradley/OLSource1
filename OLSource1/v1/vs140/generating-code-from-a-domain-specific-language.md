...
## In This Section  
 [Accessing Models from Text Templates](../vs140/accessing-models-from-text-templates.md)  
...
## Related Sections  
 ...
 [Code Generation in a Build Process](../vs140/code-generation-in-a-build-process.md)  
