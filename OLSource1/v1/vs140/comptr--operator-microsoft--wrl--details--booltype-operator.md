...
## Return Value  
 If an interface is associated with this ComPtr, the address of the [BoolStruct::Member](../vs140/boolstruct--member-data-member.md) data member; otherwise, <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>.  
