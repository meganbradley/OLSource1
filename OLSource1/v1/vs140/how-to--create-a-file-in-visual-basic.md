...
## Compiling the Code  
 Use the <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> variable to write to the file.  
...
-   The path name is <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> (\<xref:System.ArgumentNullException*>).  
