...
-   **DisableSpecificWarnings**  
     ...
     For more information, see the `/wd` option in [/w, /Wn, /WX, /Wall, /wln, /wdn, /wen, /won (Warning Level)](../vs140/-w---w0---w1---w2---w3---w4---w1---w2---w3---w4---wall---wd---we---wo---wv---wx--warning-level-.md).  
...
-   **ForceConformanceInForLoopScope**  
     ...
     If `true`, implements standard C++ behavior in [for](../vs140/for-statement--c---.md) loops that use Microsoft extensions ([/Ze](../vs140/-za---ze--disable-language-extensions-.md)).  
...
-   **TreatSpecificWarningsAsErrors**  
     ...
     For more information, see the **/we**`n` option in [/w, /Wn, /WX, /Wall, /wln, /wdn, /wen, /won (Warning Level)](../vs140/-w---w0---w1---w2---w3---w4---w1---w2---w3---w4---wall---wd---we---wo---wv---wx--warning-level-.md).  
...
-   **XMLDocumentationFileName**  
     ...
     For more information, see the `name` argument in [/doc (Process Documentation Comments) (C/C++)](../vs140/-doc--process-documentation-comments---c-c---.md). Also see the **GenerateXMLDocumentationFiles** parameter in this table.  
