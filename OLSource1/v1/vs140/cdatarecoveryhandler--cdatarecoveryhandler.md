...
|[in] <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>|Indicates which options of the restart manager are supported.|  
|[in] <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>|The time between autosaves. This parameter is in milliseconds.|  
  
## Remarks  
 The MFC framework automatically creates a <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> object for your application when you use the **New Project** wizard. Unless you are customizing the data recovery behavior or the restart manager, you should not create a <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> object.  
