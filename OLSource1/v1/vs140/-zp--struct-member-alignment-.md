...
## Remarks  
 When you specify this option, each structure member after the first is stored on either the size of the member type or <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>-byte boundaries (where <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> is 1, 2, 4, 8, or 16), whichever is smaller.  
