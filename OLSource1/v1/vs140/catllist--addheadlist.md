...
## Remarks  
 The list pointed to by <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> is inserted at the start of the existing list. In debug builds, an assertion failure will occur if <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> is equal to NULL.  
