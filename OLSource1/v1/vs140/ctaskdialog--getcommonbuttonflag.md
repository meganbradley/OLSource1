...
## Return Value  
 The value of the corresponding <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> common button. If there is no corresponding common button, this method returns 0.  
