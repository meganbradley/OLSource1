...
> [!NOTE]
>  **The web portal or Microsoft Test Runner?** There are two ways of running manual tests in Visual Studio. You’ll probably find it more convenient to [run tests with the web portal](../vs140/planning-manual-tests-using-the-web-portal.md), unless you want these additional features of Microsoft Test Runner:  
>   
...
> -   [Replay your actions](../vs140/record-and-play-back-manual-tests.md) so that you can repeat a test quickly and accurately.  
> -   [Collect additional diagnostic data](../vs140/collect-more-diagnostic-data-in-manual-tests.md) during your tests  
...
1.  **Get ready to test.** Here are a few things you might need to do before running your tests:  
    ...
    2.  [Create some test cases.](../vs140/plan-manual-tests-with-microsoft-test-manager.md) Typically you create them at the start of a sprint, and aim to have them all pass by the end of the sprint. You can create them either with the web portal or Microsoft Test Manager.  
    ...
    4.  [Connect MTM to your test plan](../vs140/connect-microsoft-test-manager-to-your-team-project-and-test-plan.md)  
  
2.  Run a test case.  
  
     ![Run a test case](../vs140/media/almp_t_create07.png "ALMP_T_Create07")  
...
3.  Create an action recording so that you can quickly repeat the test later.  
     ...
     ![Start your application, then the test run](../vs140/media/almp_t_create08.png "ALMP_T_Create08")  
...
4.  Follow the steps in the test. Mark each step as either Passed or Failed. When a step fails, add a comment to describe what was wrong. You can attach screenshots, too.  
     ...
     ![Add comments and snapshots to the test run log](../vs140/media/almp_t_create09.png "ALMP_T_Create09")  
  
     If you have to attend to something else, ![Pause icon](../vs140/media/almp_t_runtestpauseicon.png "ALMP_T_runTestPauseIcon")Pause the test. You don’t want your emails or password included in the recording.  
  
5.  Create a bug if you find a problem.  
  
     ![Report a bug from the test run](../vs140/media/almp_t_create10.png "ALMP_T_Create10")  
  
6.  Name the bug and describe the failure.  
  
     ![Give the bug a title](../vs140/media/almp_t_create11.png "ALMP_T_Create11")  
  
     You can assign the bug if you know who'll fix it.  
  
7.  End the test and save the results.  
  
     ![Complete the test run](../vs140/media/almp_t_create12.png "ALMP_T_Create12")  
...
1.  Start the test. Don’t overwrite the recording.  
     ...
     ![Uncheck Overwrite recording. Click Start.](../vs140/media/alm_p_t78play.png "ALM_P_T78play")  
  
2.  **Play** your recorded actions. You have to verify the results of each step.  
  
     ![Click Play](../vs140/media/almp_t79playstep.png "ALMP_T79playStep")  
...
## Track the progress of your tests  
 ...
 ![View test results and reset a test ready to re&#45;run](../vs140/media/almp_t_run13.png "ALMP_T_run13")  
  
## See Also  
 [Repeating tests with different data](../vs140/repeat-a-test-with-different-data.md)   
 [Testing on multiple configurations](../vs140/test-configurations--specifying-test-platforms.md)   
 [Testing in a Lab Environment](assetId:///14ba54c8-a158-4a6e-b00a-b00ae960feb8)   
 [Recording and playing back manual tests](../vs140/record-and-play-back-manual-tests.md)   
 [Collecting Test Data](../vs140/collect-more-diagnostic-data-in-manual-tests.md)   
 [Testing Windows Phone apps](../vs140/testing-windows-store-apps.md)