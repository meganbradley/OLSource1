...
'keyword': use [System::AttributeUsageAttribute] for managed attributes; use [Windows::Foundation::Metadata::AttributeUsageAttribute] for WinRT attributes  
 ...
 Use \<xref:System.AttributeUsageAttribute*> to declare **/clr** attributes. Use <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> to declare Windows Runtime attributes.  
