...
## Remarks  
 The <CodeContentPlaceHolder>6\</CodeContentPlaceHolder> can be a combination of the following flags.  
...
|UNDNAME_NO_THISTYPE|0x0060|Disables all modifiers on the <CodeContentPlaceHolder>7\</CodeContentPlaceHolder> type.|  
...
|UNDNAME_NO_MEMBER_TYPE|0x0200|Disables expansion of <CodeContentPlaceHolder>8\</CodeContentPlaceHolder> or <CodeContentPlaceHolder>9\</CodeContentPlaceHolder> members.|  
