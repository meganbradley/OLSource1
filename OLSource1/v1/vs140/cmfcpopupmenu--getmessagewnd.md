...
## Return Value  
 A pointer to the window that receives the pop-up menu messages; <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> if there is no window.  
