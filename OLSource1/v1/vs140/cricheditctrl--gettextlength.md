...
---
# CRichEditCtrl::GetTextLength
Retrieves the length of the text, in characters, in this <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> object, not including the terminating null character.  
  
## Syntax  
  
<CodeContentPlaceHolder>0\</CodeContentPlaceHolder>  
## Return Value  
 The length of the text in this <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> object.  
