...
## Remarks  
 ...
 For more information on <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>, see the Remarks section of the [queue Class](../vs140/queue-class.md) topic.  
  
## Example  
 See the example for [queue](../vs140/queue--queue.md) for an example of how to declare and use <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>.  
