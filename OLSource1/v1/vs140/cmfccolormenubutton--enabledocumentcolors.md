...
#### Parameters  
 ...
 <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> to display document-specific colors or <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> to display system colors.  
