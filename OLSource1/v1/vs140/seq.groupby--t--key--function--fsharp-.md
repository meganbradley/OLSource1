...
## Example  
 The following example demonstrates the use of <CodeContentPlaceHolder>6\</CodeContentPlaceHolder> to group the odd and even numbers in a sequence into two separate sequences.  
