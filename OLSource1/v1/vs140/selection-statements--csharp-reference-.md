...
A selection statement causes the program control to be transferred to a specific flow based upon whether a certain condition is <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> or not.  
  
 The following keywords are used in selection statements:  
  
-   [if](../vs140/if-else--csharp-reference-.md)  
  
-   [else](../vs140/if-else--csharp-reference-.md)  
  
-   [switch](../vs140/switch--csharp-reference-.md)  
  
-   [case](../vs140/switch--csharp-reference-.md)  
  
-   [default](../vs140/switch--csharp-reference-.md)  
