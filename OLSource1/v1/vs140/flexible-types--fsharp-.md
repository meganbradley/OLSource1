...
## Remarks  
 In the previous syntax, <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> represents a base type or an interface.  
...
-   Any other combination of enumerable sequences  
 ...
 The following code uses <CodeContentPlaceHolder>7\</CodeContentPlaceHolder> to demonstrate the scenarios that you can support by using flexible types.  
