...
#### Parameters  
 ...
 Specifies the new group alignment. If <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>, the new group is aligned vertically. If <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>, the new group is aligned horizontally.  
