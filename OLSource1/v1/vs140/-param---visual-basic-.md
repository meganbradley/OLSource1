...
## Remarks  
 The <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> tag should be used in the comment for a method declaration to describe one of the parameters for the method.  
  
 The text for the <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> tag will appear in the following locations:  
...
## Example  
 This example uses the <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> tag to describe the <CodeContentPlaceHolder>6\</CodeContentPlaceHolder> parameter.  
