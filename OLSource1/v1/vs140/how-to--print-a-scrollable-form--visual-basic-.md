...
3.  Add the following code in the appropriate event handler (for example, in the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> event handler for a **Print**<CodeContentPlaceHolder>2\</CodeContentPlaceHolder>).  
  
<CodeContentPlaceHolder>0\</CodeContentPlaceHolder>  
    > [!NOTE]
    >  On some operating systems, text or graphics drawn by \<xref:System.Drawing.Graphics*> methods may not print correctly. In this case, you will not be able to print with the <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> parameter.  
