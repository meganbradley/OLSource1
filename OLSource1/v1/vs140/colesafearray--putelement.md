...
#### Parameters  
 ...
 Pointer to the data to assign to the array. **VT_DISPATCH**, **VT_UNKNOWN**, and <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> variant types are pointers and do not require another level of indirection.  
