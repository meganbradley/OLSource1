...
|InitializeOpenFileFromCurrentDocument|Get/Set (Boolean)|Determines whether the [OpenFile](assetId:///M:EnvDTE.DTEClass.OpenFile(System.String,System.String)?qualifyHint=False&autoUpgrade=True) command seeds the directory and file name from the last active document, or from the last place you opened a file.|  
