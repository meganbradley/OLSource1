...
|Class|Purpose|  
|-----------|-------------|  
|[_bstr_t](../vs140/_bstr_t-class.md)|Wraps the <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> type to provide useful operators and methods.|  
...
|[_com_ptr_t](../vs140/_com_ptr_t-class.md)|Encapsulates COM interface pointers, and automates the required calls to <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>, **Release**, and <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>.|  
