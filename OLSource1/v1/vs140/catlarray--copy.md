...
## Remarks  
 ...
 In debug builds, an ATLASSERT will be raised if the existing <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> object is not valid, or if <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> refers to the same object. In release builds, invalid arguments may lead to unpredictable behavior.  
  
> [!NOTE]
>  <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> does not support arrays consisting of elements created with the [CAutoPtr](../vs140/cautoptr-class.md) class.  
