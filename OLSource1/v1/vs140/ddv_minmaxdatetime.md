...
---
# DDV_MinMaxDateTime
Call <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> to verify that the time/date value in the date and time picker control ([CDateTimeCtrl](../vs140/cdatetimectrl-class.md)) associated with *refValue* falls between <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> and <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>.  
