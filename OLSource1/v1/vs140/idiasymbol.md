...
> [!NOTE]
>  Symbols will return meaningful data for only some of these methods, depending on the type of symbol. If a method returns <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>, then that method has returned meaningful data.  
...
|[get_hasAlloca](../vs140/idiasymbol--get_hasalloca.md)|Retrieves a flag indicating whether the function contains a call to <CodeContentPlaceHolder>4\</CodeContentPlaceHolder>.|  
...
|[get_isAcceleratorStubFunction](../vs140/idiasymbol--get_isacceleratorstubfunction.md)|Indicates whether the symbol corresponds to a top-level function symbol for a shader compiled for an accelerator that corresponds to a <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> call.|  
...
|[get_isMultipleInheritance](../vs140/idiasymbol--get_ismultipleinheritance.md)|Specifies whether the <CodeContentPlaceHolder>6\</CodeContentPlaceHolder> pointer points to a data member with multiple inheritance.|  
...
|[get_isPointerBasedOnSymbolValue](../vs140/idiasymbol--get_ispointerbasedonsymbolvalue.md)|Specifies whether the <CodeContentPlaceHolder>7\</CodeContentPlaceHolder> pointer is based on a symbol value.|  
...
|[get_isSingleInheritance](../vs140/idiasymbol--get_issingleinheritance.md)|Specifies whether the <CodeContentPlaceHolder>8\</CodeContentPlaceHolder> pointer points to a data member with single inheritance.|  
...
|[get_isVirtualInheritance](../vs140/idiasymbol--get_isvirtualinheritance.md)|Specifies whether the <CodeContentPlaceHolder>9\</CodeContentPlaceHolder> pointer points to a data member with virtual inheritance.|  
...
|[IDiaSymbol::get_oemId](../vs140/idiasymbol--get_oemid.md)|Retrieves the symbol's <CodeContentPlaceHolder>10\</CodeContentPlaceHolder> value.|  
|[IDiaSymbol::get_oemSymbolId](../vs140/idiasymbol--get_oemsymbolid.md)|Retrieves the symbol's <CodeContentPlaceHolder>11\</CodeContentPlaceHolder> value.|  
...
|[get_restrictedType](../vs140/idiasymbol--get_restrictedtype.md)|Specifies whether the <CodeContentPlaceHolder>12\</CodeContentPlaceHolder> pointer is flagged as restricted.|  
...
|[IDiaSymbol::get_thisAdjust](../vs140/idiasymbol--get_thisadjust.md)|Retrieves the logical <CodeContentPlaceHolder>13\</CodeContentPlaceHolder> adjustor for the method.|  
...
|[IDiaSymbol::get_undecoratedNameEx](../vs140/idiasymbol--get_undecoratednameex.md)|Extension of the <CodeContentPlaceHolder>14\</CodeContentPlaceHolder> method that retrieves the undecorated name based on the value of an extension field.|  
...
> [!NOTE]
>  <CodeContentPlaceHolder>15\</CodeContentPlaceHolder> is a class that wraps a <CodeContentPlaceHolder>16\</CodeContentPlaceHolder> and automatically handles freeing the string when the instantiation goes out of scope.  
  
<CodeContentPlaceHolder>1\</CodeContentPlaceHolder>  
## Requirements  
 <CodeContentPlaceHolder>17\</CodeContentPlaceHolder> Dia2.h  
