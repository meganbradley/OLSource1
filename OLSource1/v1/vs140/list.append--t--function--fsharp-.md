...
## Example  
 The following code example illustrates the use of <CodeContentPlaceHolder>6\</CodeContentPlaceHolder> to join two lists together. Use [List.concat](../vs140/list.concat--t--function--fsharp-.md) to join more than two lists.  
