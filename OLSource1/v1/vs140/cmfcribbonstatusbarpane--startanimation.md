...
## Remarks  
 You must specify a handle to an image list before you call <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> by using <CodeContentPlaceHolder>4\</CodeContentPlaceHolder>.  
