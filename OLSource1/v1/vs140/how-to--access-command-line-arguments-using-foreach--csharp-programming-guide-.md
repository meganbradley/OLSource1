...
Another approach to iterating over the array is to use the [foreach](../vs140/foreach--in--csharp-reference-.md) statement as shown in this example. The `foreach` statement can be used to iterate over an array, a .NET Framework collection class, or any class or struct that implements the <xref:System.Collections.IEnumerable?qualifyHint=False> interface.  
...
## See Also  
 ...
 <xref:System.Collections?qualifyHint=False>   
