...
3.  In OpenDialog.cs, add the following <CodeContentPlaceHolder>9\</CodeContentPlaceHolder> statement:  
...
2.  Add the following <CodeContentPlaceHolder>10\</CodeContentPlaceHolder> declarations:  
