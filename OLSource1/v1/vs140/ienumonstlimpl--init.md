...
## Remarks  
 If you pass <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> a reference to a collection held in another object, you can use the <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> parameter to ensure that the object, and the collection it holds, is available for as long as the enumerator needs it.  
