...
A class or interface inherits from a base class or interface but has a less restrictive access level.  
 ...
 For example, a <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> interface inherits from a <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> interface, or a <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> class inherits from a <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> class. This exposes the base class or interface to access beyond the intended level.  
...
-   If you require the less restrictive access level, remove the <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> statement. You cannot inherit from a more restricted base class or interface.  
