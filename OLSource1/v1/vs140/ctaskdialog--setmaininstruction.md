...
---
# CTaskDialog::SetMainInstruction
Updates the main instruction of the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>.  
...
## Example  
 [!code[NVC_MFC_CTaskDialog#7](../vs140/codesnippet/CPP/ctaskdialog--setmaininstruction_1.cpp)]  
