...
## Remarks  
 This function is typically called in response to a <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> message. To begin a drag operation, use the <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> member function.  
