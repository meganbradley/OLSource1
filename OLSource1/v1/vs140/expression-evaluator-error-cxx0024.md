...
operation needs l-value  
 ...
 For example, <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> is a valid l-value because it points to a specific memory location. The logical comparison <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> is not a valid l-value because it evaluates to TRUE or FALSE, not to a memory address.  
