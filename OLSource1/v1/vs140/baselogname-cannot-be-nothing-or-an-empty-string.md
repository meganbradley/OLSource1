...
The value of the \<xref:Microsoft.VisualBasic.Logging.FileLogTraceListener.BaseFileName*> property cannot be <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> or an empty string.  
