...
---
# CComBSTR::ArrayToBSTR
Frees any existing string held in the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> object, then creates a <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> from the first character of each element in the safearray and attaches it to the <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> object.  
