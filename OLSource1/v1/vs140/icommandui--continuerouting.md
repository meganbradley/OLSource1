...
## Remarks  
 This is an advanced member function that should be used in conjunction with an [ON_COMMAND_EX](../vs140/on_command_ex.md) handler that returns <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>. For more information, see Technical Note [TN006: Message Maps](../vs140/tn006--message-maps.md).  
