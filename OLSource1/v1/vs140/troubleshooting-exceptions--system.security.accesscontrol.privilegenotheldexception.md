...
The exception that is thrown when a method in the <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> namespace attempts to enable a privilege that it does not have.  
