...
## Remarks  
 The following table lists the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> enumeration values that specify the appearance of a button.  
...
|BUTTONSTYLE_NOBORDERS|The button does not have raised sides and always appears two-dimensional. The button does not appear to be pressed into an indentation when it is clicked.|  
 ...
 The <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> constructor initializes this member to <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>.  
  
## Example  
 The following example demonstrates how to set the values of the <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> member variable in the <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> class. This example is part of the [New Controls sample](../vs140/visual-c---samples.md).  
