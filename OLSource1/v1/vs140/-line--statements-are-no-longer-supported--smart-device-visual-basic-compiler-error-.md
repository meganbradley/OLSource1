...
The <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> statement is no longer supported. File I/O functionality is normally available as \<xref:Microsoft.VisualBasic.FileSystem.LineInput*?displayProperty=fullName>, but the targeted version of the .NET Compact Framework does not support it.  
