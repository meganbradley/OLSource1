...
The `Line` statement is no longer supported. File I/O functionality is normally available as [FileSystem.LineInput](assetId:///M:Microsoft.VisualBasic.FileSystem.LineInput(System.Int32)?qualifyHint=True&autoUpgrade=True), but the targeted version of the .NET Compact Framework does not support it.  
