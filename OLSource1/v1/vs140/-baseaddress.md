...
|-|-|  
|Term|Definition|  
|<CodeContentPlaceHolder>1\</CodeContentPlaceHolder>|Required. The base address for the DLL. This address must be specified as a hexadecimal number.|  
...
## Remarks  
 ...
 To complete the signing process for a DLL, use the <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> option of the Strong Naming tool (Sn.exe).  
