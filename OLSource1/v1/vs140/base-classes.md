...
Multiple Instances of a Single Base Class  
 ...
 In the figure, pictorial representations of the components of <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> and <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> are shown. However, the base class, <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>, is in <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> through the <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> path and the <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> path. To eliminate this redundancy, such classes can be declared as virtual base classes when they are inherited.  
