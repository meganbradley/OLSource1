...
## Return Value  
 A [thread::id](../vs140/thread--id-class.md) object that uniquely identifies the associated thread, or <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> if no thread is associated with the object.  
