...
## Remarks  
 Unlike the [AddString](../vs140/clistbox--addstring.md) member function, <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> does not cause a list with the [LBS_SORT](../vs140/list-box-styles.md) style to be sorted.  
