...
|-------------|----------|-----------------|  
|<CodeContentPlaceHolder>0\</CodeContentPlaceHolder>|[Members (F#)](../vs140/members--fsharp-.md)\<br />\<br /> [Abstract Classes](../vs140/abstract-classes--fsharp-.md)|Indicates a method that either has no implementation in the type in which it is declared or that is virtual and has a default implementation.|  
|<CodeContentPlaceHolder>1\</CodeContentPlaceHolder>|[Let Bindings](../vs140/let-bindings--fsharp-.md)\<br />\<br /> [Members (F#)](../vs140/members--fsharp-.md)\<br />\<br /> [Constraints](../vs140/constraints--fsharp-.md)|Used in mutually recursive bindings, in property declarations, and with multiple constraints on generic parameters.|  
|<CodeContentPlaceHolder>2\</CodeContentPlaceHolder>|[Classes (F#)](../vs140/classes--fsharp-.md)\<br />\<br /> [Patterns](../vs140/pattern-matching--fsharp-.md)|Used to give the current class object an object name. Also used to give a name to a whole pattern within a pattern match.|  
|<CodeContentPlaceHolder>3\</CodeContentPlaceHolder>|[Assertions (F#)](../vs140/assertions--fsharp-.md)|Used to verify code during debugging.|  
|<CodeContentPlaceHolder>4\</CodeContentPlaceHolder>|[Classes (F#)](../vs140/classes--fsharp-.md)\<br />\<br /> [Inheritance (F#)](../vs140/inheritance--fsharp-.md)|Used as the name of the base class object.|  
|<CodeContentPlaceHolder>5\</CodeContentPlaceHolder>|[Verbose Syntax (F#)](../vs140/verbose-syntax--fsharp-.md)|In verbose syntax, indicates the start of a code block.|  
|<CodeContentPlaceHolder>6\</CodeContentPlaceHolder>|[Classes (F#)](../vs140/classes--fsharp-.md)|In verbose syntax, indicates the start of a class definition.|  
|<CodeContentPlaceHolder>7\</CodeContentPlaceHolder>|[Members (F#)](../vs140/members--fsharp-.md)|Indicates an implementation of an abstract method; used together with an abstract method declaration to create a virtual method.|  
|<CodeContentPlaceHolder>8\</CodeContentPlaceHolder>|[Delegates (F#)](../vs140/delegates--fsharp-.md)|Used to declare a delegate.|  
|<CodeContentPlaceHolder>9\</CodeContentPlaceHolder>|[Do Bindings](../vs140/do-bindings--fsharp-.md)\<br />\<br /> [Loops: the for...to Expression](../vs140/loops--for...to-expression--fsharp-.md)\<br />\<br /> [Loops: the for...in Expression](../vs140/loops--for...in-expression--fsharp-.md)\<br />\<br /> [Loops: while...do](../vs140/loops--while...do-expression--fsharp-.md)|Used in looping constructs or to execute imperative code.|  
|<CodeContentPlaceHolder>10\</CodeContentPlaceHolder>|[Verbose Syntax (F#)](../vs140/verbose-syntax--fsharp-.md)|In verbose syntax, indicates the end of a block of code in a looping expression.|  
|<CodeContentPlaceHolder>11\</CodeContentPlaceHolder>|[Casting and Conversions (F#)](../vs140/casting-and-conversions--fsharp-.md)|Used to convert to a type that is lower in the inheritance chain.|  
...
|<CodeContentPlaceHolder>41\</CodeContentPlaceHolder>|[Modules (F#)](../vs140/modules--fsharp-.md)|Used to associate a name with a group of related types, values, and functions, to logically separate it from other code.|  
...
|<CodeContentPlaceHolder>66\</CodeContentPlaceHolder>|[Exceptions: try...with Expression](../vs140/exceptions--the-try...with-expression--fsharp-.md)\<br />\<br /> [Exceptions: the try...finally Expression](../vs140/exceptions--the-try...finally-expression--fsharp-.md)|Used to introduce a block of code that might generate an exception. Used together with <CodeContentPlaceHolder>67\</CodeContentPlaceHolder> or <CodeContentPlaceHolder>68\</CodeContentPlaceHolder>.|  
