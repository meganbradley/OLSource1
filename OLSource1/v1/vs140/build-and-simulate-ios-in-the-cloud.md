...
<CodeContentPlaceHolder>3\</CodeContentPlaceHolder>  
         ...
         Any command line option can be specified this way in the config file, so you can also use this method to modify other settings such as the port used. Type <CodeContentPlaceHolder>10\</CodeContentPlaceHolder> to see a complete list of commands.  
