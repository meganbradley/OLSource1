...
#### Parameters  
 ...
 A pointer to the device context for a <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> object.  
  
 [in] <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>  
 A pointer to a <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> object. The framework draws a border around this popup menu.  
