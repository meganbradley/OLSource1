...
## Remarks  
 The typedef is a synonym for the type <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> in the template's call signature. You use it to determine the return type of the wrapped callable object.  
