...
## Remarks  
 The **/recurse** option lets you compile source code files in all child directories of either the specified directory (<CodeContentPlaceHolder>5\</CodeContentPlaceHolder>) or of the project directory.  
