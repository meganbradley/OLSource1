...
## Members  
 fIsUserCode  
 Non-zero (<CodeContentPlaceHolder>2\</CodeContentPlaceHolder>) if the module is to be considered user code; otherwise, zero (<CodeContentPlaceHolder>3\</CodeContentPlaceHolder>) if the module is to be treated as external code and not to be debugged.  
