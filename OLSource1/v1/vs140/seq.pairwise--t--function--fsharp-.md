...
apitype: "Assembly"
f1_keywords: 
  - "Microsoft.FSharp.Collections.SeqModule.Pairwise``1"
dev_langs: 
  - "FSharp"
helpviewer_keywords: 
  - "pairwise function [F#]"
  - "Seq.pairwise function [F#]"
...
## Example  
 The following example demonstrates the use of <CodeContentPlaceHolder>4\</CodeContentPlaceHolder>. The initial sequence is a sequence of squares up to 100. The <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> function generates a sequence of tuples of consecutive squares, <CodeContentPlaceHolder>6\</CodeContentPlaceHolder>. The second part of the example produces a list of the differences in each pair of squares.  
  
 [!code[FsSequences#18](../vs140/codesnippet/FSharp/seq.pairwise--t--function--fsharp-_1.fs)]  
