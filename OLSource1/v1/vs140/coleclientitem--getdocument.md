...
## Remarks  
 This pointer allows access to the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> object that you passed as an argument to the <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> constructor.  
