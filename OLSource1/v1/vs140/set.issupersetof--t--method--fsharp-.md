...
apitype: "Assembly"
f1_keywords: 
  - "Microsoft.FSharp.Collections.FSharpSet`1.IsSupersetOf"
dev_langs: 
  - "FSharp"
helpviewer_keywords: 
  - "IsSupersetOf method [F#]"
  - "Set.IsSupersetOf method [F#]"
...
## Return Value  
 <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> if this set is a superset of <CodeContentPlaceHolder>5\</CodeContentPlaceHolder>.  
  
## Remarks  
  
## Example  
 The following code illustrates the use of the <CodeContentPlaceHolder>6\</CodeContentPlaceHolder> method.  
  
 [!code[FsSets#12](../vs140/codesnippet/FSharp/set.issupersetof--t--method--fsharp-_1.fs)]  
