...
1.  Eliminate the explicit implementation and just have the implicit implementation <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> implement both of the interface methods.  
