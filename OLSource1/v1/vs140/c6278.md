...
<CodeContentPlaceHolder>1\</CodeContentPlaceHolder>  
 If the underlying object in the array is a primitive type such as <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>, <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>, <CodeContentPlaceHolder>4\</CodeContentPlaceHolder>, or pointer, there are no destructors to be called. In these cases warning [C6283](../vs140/c6283.md) is reported instead.  
