...
-   <CodeContentPlaceHolder>7\</CodeContentPlaceHolder> returns the entire path for the file. For example, calling <CodeContentPlaceHolder>8\</CodeContentPlaceHolder> to generate a user message about the file <CodeContentPlaceHolder>9\</CodeContentPlaceHolder> returns the file path <CodeContentPlaceHolder>10\</CodeContentPlaceHolder>.  
  
-   [GetFileTitle](../vs140/cfilefind--getfiletitle.md) returns the file name, excluding the file extension. For example, calling <CodeContentPlaceHolder>11\</CodeContentPlaceHolder> to generate a user message about the file <CodeContentPlaceHolder>12\</CodeContentPlaceHolder> returns the file title <CodeContentPlaceHolder>13\</CodeContentPlaceHolder>.  
