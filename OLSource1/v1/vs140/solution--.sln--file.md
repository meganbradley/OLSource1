...
A solution is a structure for organizing projects in Visual Studio. The solution maintains the state information for projects in .sln (text-based, shared) and .suo (binary, user-specific solution options) files. For further information on .suo files, see [Solution User Options (.Suo) File](../vs140/solution-user-options--.suo--file.md).  
 ...
 If your VSPackage is loaded as a result of being referenced in the .sln file, the environment calls [ReadSolutionProps](assetId:///M:Microsoft.VisualStudio.Shell.Interop.IVsPersistSolutionProps.ReadSolutionProps(Microsoft.VisualStudio.Shell.Interop.IVsHierarchy,System.String,System.String,System.String,System.Int32,Microsoft.VisualStudio.OLE.Interop.IPropertyBag)?qualifyHint=False&autoUpgrade=True) to read in the .sln file.  
