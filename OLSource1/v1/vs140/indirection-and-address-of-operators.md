...
<CodeContentPlaceHolder>1\</CodeContentPlaceHolder>  
 The address-of operator (**&**) takes the address of the sixth element of the array <CodeContentPlaceHolder>5\</CodeContentPlaceHolder>. The result is stored in the pointer variable <CodeContentPlaceHolder>6\</CodeContentPlaceHolder>.  
  
<CodeContentPlaceHolder>2\</CodeContentPlaceHolder>  
 The indirection operator (**\***) is used in this example to access the <CodeContentPlaceHolder>7\</CodeContentPlaceHolder> value at the address stored in <CodeContentPlaceHolder>8\</CodeContentPlaceHolder>. The value is assigned to the integer variable <CodeContentPlaceHolder>9\</CodeContentPlaceHolder>.  
  
<CodeContentPlaceHolder>3\</CodeContentPlaceHolder>  
 This example prints the word <CodeContentPlaceHolder>10\</CodeContentPlaceHolder>, demonstrating that the result of applying the indirection operator to the address of <CodeContentPlaceHolder>11\</CodeContentPlaceHolder> is the same as <CodeContentPlaceHolder>12\</CodeContentPlaceHolder>.  
  
<CodeContentPlaceHolder>4\</CodeContentPlaceHolder>  
 Once the function <CodeContentPlaceHolder>13\</CodeContentPlaceHolder> is declared, two pointers to <CodeContentPlaceHolder>14\</CodeContentPlaceHolder> are declared and initialized. The first pointer, <CodeContentPlaceHolder>15\</CodeContentPlaceHolder>, is initialized using only the name of the function, while the second, <CodeContentPlaceHolder>16\</CodeContentPlaceHolder>, uses the address-of operator in the initialization. The initializations are equivalent.  
