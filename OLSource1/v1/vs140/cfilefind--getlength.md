...
## Remarks  
 ...
 <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> uses the Win32 structure [WIN32_FIND_DATA](http://msdn.microsoft.com/library/windows/desktop/aa365740) to get and return the value of the file size, in bytes.  
  
> [!NOTE]
>  As of MFC 7.0, <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> supports 64-bit integer types. Previously existing code built with this newer version of the library may result in truncation warnings.  
