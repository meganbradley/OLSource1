...
## Return Value  
 The number of characters in <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>; not counting a null terminator.  
  
## Remarks  
 Call this method to retrieve the number of characters in the string pointed to by <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>.  
