...
#### Parameters  
 ...
 Your class, derived from <CodeContentPlaceHolder>16\</CodeContentPlaceHolder>.  
...
|[IViewObjectExImpl::Freeze](../vs140/iviewobjecteximpl--freeze.md)|Freezes the drawn representation of a control so it won't change until an <CodeContentPlaceHolder>17\</CodeContentPlaceHolder>. The ATL implementation returns **E_NOTIMPL**.|  
...
|[IViewObjectExImpl::QueryHitPoint](../vs140/iviewobjecteximpl--queryhitpoint.md)|Checks if the specified point is in the specified rectangle and returns a [HITRESULT](http://msdn.microsoft.com/library/windows/desktop/ms682187) value in <CodeContentPlaceHolder>18\</CodeContentPlaceHolder>.|  
|[IViewObjectExImpl::QueryHitRect](../vs140/iviewobjecteximpl--queryhitrect.md)|Checks whether the control's display rectangle overlaps any point in the specified location rectangle and returns a **HITRESULT** value in <CodeContentPlaceHolder>19\</CodeContentPlaceHolder>.|  
...
### Remarks  
 This method calls **CComControl::OnDrawAdvanced** which in turn calls your control class's <CodeContentPlaceHolder>23\</CodeContentPlaceHolder> method. An <CodeContentPlaceHolder>24\</CodeContentPlaceHolder> method is automatically added to your control class when you create your control with the ATL Control Wizard. The Wizard's default <CodeContentPlaceHolder>25\</CodeContentPlaceHolder> draws a rectangle with the label "ATL 3.0".  
...
##  \<a name="iviewobjecteximpl__freeze">\</a>  IViewObjectExImpl::Freeze  
 Freezes the drawn representation of a control so it won't change until an <CodeContentPlaceHolder>26\</CodeContentPlaceHolder>. The ATL implementation returns **E_NOTIMPL**.  
...
### Remarks  
 If <CodeContentPlaceHolder>27\</CodeContentPlaceHolder> is <CodeContentPlaceHolder>28\</CodeContentPlaceHolder> and *pExtentInfo->dwExtentMode* is **DVEXTENT_CONTENT**, sets * <CodeContentPlaceHolder>29\</CodeContentPlaceHolder> to the control class's data member [CComControlBase::m_sizeNatural](../vs140/ccomcontrolbase--m_sizenatural.md). Otherwise, returns an error <CodeContentPlaceHolder>30\</CodeContentPlaceHolder>.  
...
### Remarks  
 By default, ATL sets <CodeContentPlaceHolder>31\</CodeContentPlaceHolder> to indicate that the control supports **VIEWSTATUS_OPAQUE** (possible values are in the [VIEWSTATUS](http://msdn.microsoft.com/library/windows/desktop/ms687201) enumeration).  
...
##  \<a name="iviewobjecteximpl__queryhitpoint">\</a>  IViewObjectExImpl::QueryHitPoint  
 Checks if the specified point is in the specified rectangle and returns a [HITRESULT](http://msdn.microsoft.com/library/windows/desktop/ms682187) value in <CodeContentPlaceHolder>32\</CodeContentPlaceHolder>.  
  
<CodeContentPlaceHolder>9\</CodeContentPlaceHolder>  
### Remarks  
 The value can be either **HITRESULT_HIT** or **HITRESULT_OUTSIDE**.  
  
 If <CodeContentPlaceHolder>33\</CodeContentPlaceHolder> equals [DVASPECT_CONTENT](http://msdn.microsoft.com/library/windows/desktop/ms690318), the method returns <CodeContentPlaceHolder>34\</CodeContentPlaceHolder>. Otherwise, the method returns **E_FAIL**.  
...
##  \<a name="iviewobjecteximpl__queryhitrect">\</a>  IViewObjectExImpl::QueryHitRect  
 Checks whether the control's display rectangle overlaps any point in the specified location rectangle and returns a [HITRESULT](http://msdn.microsoft.com/library/windows/desktop/ms682187) value in <CodeContentPlaceHolder>35\</CodeContentPlaceHolder>.  
  
<CodeContentPlaceHolder>10\</CodeContentPlaceHolder>  
### Remarks  
 The value can be either **HITRESULT_HIT** or **HITRESULT_OUTSIDE**.  
  
 If <CodeContentPlaceHolder>36\</CodeContentPlaceHolder> equals [DVASPECT_CONTENT](http://msdn.microsoft.com/library/windows/desktop/ms690318), the method returns <CodeContentPlaceHolder>37\</CodeContentPlaceHolder>. Otherwise, the method returns **E_FAIL**.  
...
### Example  
 The following code shows a simple implementation of <CodeContentPlaceHolder>38\</CodeContentPlaceHolder>.  
...
### Example  
 The following code shows a simple implementation of <CodeContentPlaceHolder>41\</CodeContentPlaceHolder>.  
