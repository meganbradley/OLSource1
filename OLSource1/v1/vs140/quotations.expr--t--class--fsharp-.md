...
## Remarks  
 This type is named <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> in the assembly. If you are accessing the type from a language other than F#, or through reflection, use this name.  
  
## Instance Members  
  
|Member|Description|  
|------------|-----------------|  
|[Raw](../vs140/expr.raw--t--property--fsharp-.md)|Gets the raw expression associated with this type-carrying expression|  
