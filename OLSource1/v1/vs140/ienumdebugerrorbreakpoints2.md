...
## Remarks  
 This interface holds a list of [IDebugErrorBreakpoint2](../vs140/idebugerrorbreakpoint2.md) interfaces, each of which describes a breakpoint that could not be bound and why it could not be bound. Visual Studio uses the <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> interface to update the breakpoints shown in the IDE.  
