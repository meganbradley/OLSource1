...
If you are using [!INCLUDE[TCMext](../vs140/includes/tcmext_md.md)] to run your tests, you might want to send out a status e-mail with a hyperlink to the latest test results. You can construct a hyperlink with a URL that contains the necessary information about your [!INCLUDE[esprtfs](../vs140/includes/esprtfs_md.md)] and team project and the ID of your test run. This way, the test results can be accessed immediately. You will not have to search for them in [!INCLUDE[TCMext](../vs140/includes/tcmext_md.md)].  
  
> [!NOTE]
>  You must have [!INCLUDE[TCMext](../vs140/includes/tcmext_md.md)] installed on the computer that you use to access this URL.  
...
1.  To create a hyperlink, you will need the following information about your team project:  
    ...
    -   The name of your [!INCLUDE[esprtfs](../vs140/includes/esprtfs_md.md)]  
