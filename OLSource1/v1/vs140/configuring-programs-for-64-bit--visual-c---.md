...
## Related Sections  
 ...
 [/clr (Common Language Runtime Compilation)](../vs140/-clr--common-language-runtime-compilation-.md) for information on how to run an application compiled with **/clr:safe** under WOW64 on a 64-bit operating system.  
  
 [/favor (Optimize for 64)](../vs140/-favor--optimize-for-architecture-specifics-.md)  
