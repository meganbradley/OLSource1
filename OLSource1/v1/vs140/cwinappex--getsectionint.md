...
## Return Value  
 The integer data that is stored in the specified registry value; <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> if the data does not exist.  
