...
A class or interface is marked as <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> when it derives from or implements a type that is marked as <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> or is not marked.  
...
-   If you require that this type remain within its current inheritance hierarchy or implementation scheme, remove the \<xref:System.CLSCompliantAttribute*> from its definition or mark it as <CodeContentPlaceHolder>5\</CodeContentPlaceHolder>.  
