...
## Remarks  
 **/ALLOWISOLATION:NO** indicates DLLs are loaded as if there was no manifest and causes the linker to set the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> bit in the optional header's <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> field.  
