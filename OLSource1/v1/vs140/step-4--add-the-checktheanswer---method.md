...
1.  Add the `CheckTheAnswer()` method.  
     ...
     [!code[VbExpressTutorial3Step4#8](../vs140/codesnippet/VisualBasic/step-4--add-the-checktheanswer---method_1.vb)][!code[VbExpressTutorial3Step4#8](../vs140/codesnippet/CSharp/step-4--add-the-checktheanswer---method_1.cs)]  
...
2.  Add the following code to the `if else` statement.  
     ...
     [!code[VbExpressTutorial3Step4#10](../vs140/codesnippet/VisualBasic/step-4--add-the-checktheanswer---method_2.vb)][!code[VbExpressTutorial3Step4#10](../vs140/codesnippet/CSharp/step-4--add-the-checktheanswer---method_2.cs)]  
