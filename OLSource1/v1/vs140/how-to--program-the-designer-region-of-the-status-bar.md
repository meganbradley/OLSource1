...
2.  Update the Designer region of the status bar by calling the [SetInsMode](assetId:///M:Microsoft.VisualStudio.Shell.Interop.IVsStatusbar.SetInsMode(System.Object@)?qualifyHint=False&autoUpgrade=True) method and [SetLineColChar](assetId:///M:Microsoft.VisualStudio.Shell.Interop.IVsStatusbar.SetLineColChar(System.Object@,System.Object@,System.Object@)?qualifyHint=False&autoUpgrade=True) method of the <xref:Microsoft.VisualStudio.Shell.Interop.IVsStatusbar*> instance.  
  
## Example  
 This example demonstrates how to program the Designer region of the status bar.  
  
 [!code[VSSDKDesignerStatusBar#1](../vs140/codesnippet/VisualBasic/how-to--program-the-designer-region-of-the-status-bar_1.vb)][!code[VSSDKDesignerStatusBar#1](../vs140/codesnippet/CSharp/how-to--program-the-designer-region-of-the-status-bar_1.cs)]  
