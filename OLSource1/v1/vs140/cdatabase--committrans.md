...
## Remarks  
 A transaction consists of a series of calls to the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>, **Edit**, **Delete**, and **Update** member functions of a <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> object that began with a call to the [BeginTrans](../vs140/cdatabase--begintrans.md) member function. **CommitTrans** commits the transaction. By default, updates are committed immediately; calling **BeginTrans** causes commitment of updates to be delayed until **CommitTrans** is called.  
