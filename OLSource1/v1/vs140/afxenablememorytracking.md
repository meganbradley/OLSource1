...
f1_keywords: 
  ...
  - "AFX/AfxEnableMemoryTracking"
dev_langs: 
  - "C++"
helpviewer_keywords: 
  - "AfxEnableMemoryTracking function"
...
## Remarks  
 ...
 For more information on <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>, see [Debugging MFC Applications](../vs140/mfc-debugging-techniques.md).  
  
> [!NOTE]
>  This function works only in the Debug version of MFC.  
  
## Example  
 [!code[NVC_MFC_Utilities#24](../vs140/codesnippet/CPP/afxenablememorytracking_1.cpp)]  
