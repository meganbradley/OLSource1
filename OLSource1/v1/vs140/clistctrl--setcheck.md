...
#### Parameters  
 ...
 Specifies whether the state image of the item should be visible or not. By default, *fCheck* is **TRUE** and the state image is visible. If <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> is **FALSE**, it is not visible.  
