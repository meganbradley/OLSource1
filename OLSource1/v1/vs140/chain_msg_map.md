...
## Remarks  
 <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> directs messages to a base class's default message map (declared with [BEGIN_MSG_MAP](../vs140/begin_msg_map.md)). To direct messages to a base class's alternate message map (declared with [ALT_MSG_MAP](../vs140/alt_msg_map.md)), use [CHAIN_MSG_MAP_ALT](../vs140/chain_msg_map_alt.md).  
