...
apitype: "Assembly"
f1_keywords: 
  - "Microsoft.FSharp.Collections.ArrayModule.FoldBack``2"
dev_langs: 
  - "FSharp"
helpviewer_keywords: 
  - "foldBack function [F#]"
  - "Array.foldBack function [F#]"
...
## Remarks  
 This function is named <CodeContentPlaceHolder>10\</CodeContentPlaceHolder> in compiled assemblies. If you are accessing the function from a .NET language other than F#, or through reflection, use this name.  
  
## Example  
 The following code example shows the difference between [Array.fold](../vs140/array.fold--t--state--function--fsharp-.md) and <CodeContentPlaceHolder>11\</CodeContentPlaceHolder>.  
  
 [!code[FsArrays#46](../vs140/codesnippet/FSharp/array.foldback--t--state--function--fsharp-_1.fs)]  
