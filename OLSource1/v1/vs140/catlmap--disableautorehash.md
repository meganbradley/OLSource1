...
---
# CAtlMap::DisableAutoRehash
Call this method to disable automatic rehashing of the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> object.  
...
## Remarks  
 ...
 <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> is most useful when a large number of elements will be added to the map at once. Instead of triggering the rehashing process every time the limits are exceeded, it is more efficient to call <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>, add the elements, and finally call [CAtlMap::EnableAutoRehash](../vs140/catlmap--enableautorehash.md).  
