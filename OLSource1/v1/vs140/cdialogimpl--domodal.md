...
## Return Value  
 If successful, the value of the <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> parameter specified in the call to [EndDialog](../vs140/cdialogimpl--enddialog.md). Otherwise, -1.  
  
## Remarks  
 This dialog box is automatically attached to the <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> object.  
