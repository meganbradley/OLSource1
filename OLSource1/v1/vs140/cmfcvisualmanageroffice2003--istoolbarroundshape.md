...
## Return Value  
 Returns <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> if the toolbar is round, or <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> if it is a menu bar.  
