...
-   Menus, toolbars and the application title bar should reflect the topmost multiple-document interface (MDI) client window.  
 ...
 For example, when the HTML view of a Web Form inside a Visual Basic Web Application project is opened and the user selects a <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> tag, feedback is provided in the following manner:  
