...
## Remarks  
 If <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>, each tab window displays the **Close** button on the right edge of the tab. Otherwise, the **Close** button is not displayed. The default value is <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>.  
