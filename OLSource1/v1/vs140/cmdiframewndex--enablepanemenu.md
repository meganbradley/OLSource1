...
#### Parameters  
 ...
 If <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>, automatic handling of the pane menu is enabled; if <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>, automatic handling is disabled.  
 ...
 If <CodeContentPlaceHolder>8\</CodeContentPlaceHolder>, the pane menu displays only a list of toolbars. If <CodeContentPlaceHolder>9\</CodeContentPlaceHolder>, the menu displays a list of toolbars and docking bars.  
  
 [in] <CodeContentPlaceHolder>10\</CodeContentPlaceHolder>  
 If <CodeContentPlaceHolder>11\</CodeContentPlaceHolder>, the pane menu displays only a list of toolbars. If <CodeContentPlaceHolder>12\</CodeContentPlaceHolder>, the menu displays a list of toolbars and docking bars.  
