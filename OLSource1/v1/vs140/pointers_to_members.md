...
> [!CAUTION]
>  We advise you to put the <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> pragma only in the source code file that you want to affect, and only after any <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> directives. This practice lessens the risk that the pragma will affect other files, and that you will accidently specify multiple definitions for the same variable, function, or class name.  
