...
## Remarks  
 ...
 If you implement the **Cancel** button in a modeless dialog box, you must override the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> method and call [DestroyWindow](../vs140/cwnd--destroywindow.md) inside it. Do not call the base-class method, because it calls <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>, which will make the dialog box invisible but not destroy it.  
  
> [!NOTE]
>  You cannot override this method when you use a <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> object in a program that is compiled under Windows XP. For more information about <CodeContentPlaceHolder>4\</CodeContentPlaceHolder>, see [CFileDialog Class](../vs140/cfiledialog-class.md).  
  
## Example  
 [!code[NVC_MFCControlLadenDialog#66](../vs140/codesnippet/CPP/cdialog--oncancel_1.cpp)]  
  
## Requirements  
 <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> afxwin.h  
