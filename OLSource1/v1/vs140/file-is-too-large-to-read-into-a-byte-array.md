...
The size of the file you are attempting to read into a byte array exceeds 4 GB. The <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> method cannot read a file that exceeds this size.  
