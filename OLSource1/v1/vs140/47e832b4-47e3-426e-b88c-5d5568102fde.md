...
## Example  
 In the following example, <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> is a shared member.  
  
<CodeContentPlaceHolder>0\</CodeContentPlaceHolder>  
 Because <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> is shared, trying to set its initial value in an object initializer list causes this error.  
