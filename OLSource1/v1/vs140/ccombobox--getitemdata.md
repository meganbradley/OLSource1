...
## Remarks  
 The 32-bit value can be set with the <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> parameter of a [SetItemData](../vs140/ccombobox--setitemdata.md) member function call. Use the <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> member function if the 32-bit value to be retrieved is a pointer (**void\***).  
