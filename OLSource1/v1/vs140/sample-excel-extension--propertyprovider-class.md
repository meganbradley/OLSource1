...
This internal class extends the <xref:Microsoft.VisualStudio.TestTools.UITesting.UITestPropertyProvider?qualifyHint=False> class and provides property services for [!INCLUDE[ofprexcel](../vs140/includes/ofprexcel_md.md)] elements to record and play back user interface (UI) tests.  
