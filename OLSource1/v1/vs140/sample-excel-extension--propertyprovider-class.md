...
## GetPropertyValue and SetPropertyValue Methods  
 The <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> method uses the <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> class of this extension to return the property value from Excel. The <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> method uses the \<xref:Microsoft.VisualStudio.TestTools.UITesting.Keyboard*> class and the <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> component to set the property value. These methods are called by the testing framework.  
  
## Code Generation Customization Methods  
 These methods are not implemented for this extension. Therefore, they either return <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> or throw the \<xref:System.NotImplementedException*>.  
