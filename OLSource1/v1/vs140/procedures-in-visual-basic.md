...
A *procedure* is a block of [!INCLUDE[vbprvb](../vs140/includes/vbprvb_md.md)] statements enclosed by a declaration statement (<CodeContentPlaceHolder>0\</CodeContentPlaceHolder>, <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>, <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>, <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>, <CodeContentPlaceHolder>4\</CodeContentPlaceHolder>) and a matching <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> declaration. All executable statements in [!INCLUDE[vbprvb](../vs140/includes/vbprvb_md.md)] must be within some procedure.  
...
-   With a <CodeContentPlaceHolder>6\</CodeContentPlaceHolder> statement, control returns immediately to the calling code. Statements following the <CodeContentPlaceHolder>7\</CodeContentPlaceHolder> statement do not run. You can have more than one <CodeContentPlaceHolder>8\</CodeContentPlaceHolder> statement in the same procedure.  
  
-   With an <CodeContentPlaceHolder>9\</CodeContentPlaceHolder> or <CodeContentPlaceHolder>10\</CodeContentPlaceHolder> statement, control returns immediately to the calling code. Statements following the <CodeContentPlaceHolder>11\</CodeContentPlaceHolder> statement do not run. You can have more than one <CodeContentPlaceHolder>12\</CodeContentPlaceHolder> statement in the same procedure, and you can mix <CodeContentPlaceHolder>13\</CodeContentPlaceHolder> and <CodeContentPlaceHolder>14\</CodeContentPlaceHolder> statements in the same procedure.  
  
-   If a procedure has no <CodeContentPlaceHolder>15\</CodeContentPlaceHolder> or <CodeContentPlaceHolder>16\</CodeContentPlaceHolder> statements, it concludes with an <CodeContentPlaceHolder>17\</CodeContentPlaceHolder> or <CodeContentPlaceHolder>18\</CodeContentPlaceHolder>, <CodeContentPlaceHolder>19\</CodeContentPlaceHolder>, or <CodeContentPlaceHolder>20\</CodeContentPlaceHolder> statement following the last statement of the procedure body. The <CodeContentPlaceHolder>21\</CodeContentPlaceHolder> statement returns control immediately to the calling code. You can have only one <CodeContentPlaceHolder>22\</CodeContentPlaceHolder> statement in a procedure.  
...
-   Event-handling procedures are <CodeContentPlaceHolder>23\</CodeContentPlaceHolder> procedures that execute in response to an event raised by user action or by an occurrence in a program.  
...
## Procedures and Structured Code  
 Every line of executable code in your application must be inside some procedure, such as <CodeContentPlaceHolder>24\</CodeContentPlaceHolder>, <CodeContentPlaceHolder>25\</CodeContentPlaceHolder>, or <CodeContentPlaceHolder>26\</CodeContentPlaceHolder>. If you subdivide large procedures into smaller ones, your application is more readable.  
