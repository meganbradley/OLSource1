...
**Microsoft Specific**  
 ...
 By default, wildcards are not expanded in command-line arguments. You can replace the normal argument vector <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> loading routine with a version that does expand wildcards by linking with the setargv.obj or wsetargv.obj file. If your program uses a <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> function, link with setargv.obj. If your program uses a <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> function, link with wsetargv.obj. Both of these have equivalent behavior.  
