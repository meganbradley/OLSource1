...
Although <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> should cover your basic needs when programming against the registry, you can also use the \<xref:Microsoft.Win32.Registry*> and \<xref:Microsoft.Win32.RegistryKey*> classes in the \<xref:Microsoft.Win32*> namespace of the [!INCLUDE[dnprdnshort](../vs140/includes/dnprdnshort_md.md)].  
