...
## Defining Exception Classes  
 ...
 New properties should only be added to the exception class when the data they provide is useful to resolving the exception. If new properties are added to the derived exception class, <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> should be overridden to return the added information.  
