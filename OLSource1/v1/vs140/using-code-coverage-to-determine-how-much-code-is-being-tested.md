...
<CodeContentPlaceHolder>3\</CodeContentPlaceHolder>  
 ...
 <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> *ExclusionName* <CodeContentPlaceHolder>6\</CodeContentPlaceHolder> *FunctionName* <CodeContentPlaceHolder>7\</CodeContentPlaceHolder>  
  
 <CodeContentPlaceHolder>8\</CodeContentPlaceHolder> *ExclusionName* <CodeContentPlaceHolder>9\</CodeContentPlaceHolder> *SourceFilePath* <CodeContentPlaceHolder>10\</CodeContentPlaceHolder>  
  
-   *ExclusionName* is any unique name.  
  
-   *FunctionName* is a fully qualified function name. It may contain wildcards. For example, to exclude all the functions of a class, write <CodeContentPlaceHolder>11\</CodeContentPlaceHolder>  
  
-   *SourceFilePath* is the local or UNC path of a .cpp file. It may contain wildcards. The following example excludes all files in a particular directory: <CodeContentPlaceHolder>12\</CodeContentPlaceHolder>  
...
-   The exclusions must be compiled as unmanaged (native) code, either by setting the compiler option or by using <CodeContentPlaceHolder>14\</CodeContentPlaceHolder>.  
  
> [!NOTE]
>  To exclude functions in C++/CLI code, apply the attribute <CodeContentPlaceHolder>15\</CodeContentPlaceHolder> to the function. This is the same as for C#.  
