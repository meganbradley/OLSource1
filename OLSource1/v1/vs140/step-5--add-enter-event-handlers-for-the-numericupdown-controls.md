...
2.  Enter <CodeContentPlaceHolder>0\</CodeContentPlaceHolder>, and note that the control shows **30**.  
  
3.  Enter <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>, and note that **350** appears but changes to **100** after a second.  
  
     Before you fix this problem, think about what's happening. Consider why the **0** didn't disappear when you entered <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> and why **350** changed to **100** but not immediately.  
...
2.  Choose the **Enter** event, enter <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>, and then choose the Enter key.  
