...
|Name|Description|  
|----------|-----------------|  
|[CMapStringToOb::operator &#91;&#93;](../vs140/cmapstringtoob-class.md#cmapstringtoob__operator_at)|Inserts an element into the map — operator substitution for <CodeContentPlaceHolder>11\</CodeContentPlaceHolder>.|  
  
## Remarks  
 <CodeContentPlaceHolder>12\</CodeContentPlaceHolder> incorporates the <CodeContentPlaceHolder>13\</CodeContentPlaceHolder> macro to support run-time type access and dumping to a <CodeContentPlaceHolder>14\</CodeContentPlaceHolder> object. If you need a dump of individual map elements (pointer values), you must set the depth of the dump context to 1 or greater.  
  
 Pointer-to-pointer maps may not be serialized.  
  
 When a <CodeContentPlaceHolder>15\</CodeContentPlaceHolder> object is deleted, or when its elements are removed, only the pointers are removed, not the entities they reference.  
  
 For more information on <CodeContentPlaceHolder>16\</CodeContentPlaceHolder>, see the article [Collections](../vs140/collections.md).  
