...
## Remarks  
 The **importlib** C++ attribute causes an <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> statement to be placed in the library block of the generated .idl file. The **importlib** attribute has the same functionality as the [importlib](http://msdn.microsoft.com/library/windows/desktop/aa367050) MIDL attribute.  
