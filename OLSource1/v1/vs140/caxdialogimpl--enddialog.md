...
## Remarks  
 <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> must be called through the dialog box procedure. After the dialog box is destroyed, Windows uses the value of <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> as the return value for <CodeContentPlaceHolder>4\</CodeContentPlaceHolder>, which created the dialog box.  
  
> [!NOTE]
>  Do not call <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> to destroy a modeless dialog box. Call [DestroyWindow](../vs140/caxdialogimpl--destroywindow.md) instead.  
