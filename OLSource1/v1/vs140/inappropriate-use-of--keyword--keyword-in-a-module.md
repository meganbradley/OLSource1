...
-   If you intend this programming element to be a module, use only the <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> or <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> keyword in its declaration. By default, a module uses to <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> if you do not specify its access level.  
