...
-   LIBPATH, which specifies directories to search for metadata files referenced with [#using](../vs140/sharpusing-directive--c---.md). See `#using` for more information on LIBPATH.  
