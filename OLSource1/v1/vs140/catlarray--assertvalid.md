...
## Remarks  
 If the array object is not valid, <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> will throw an assertion. This method is available only if _DEBUG is defined.  
