...
Returns a sequence that, when iterated, skips elements of the underlying sequence while the given predicate returns <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>, and then yields the remaining elements of the sequence.  
...
## Example  
 The following example demonstrates the use of <CodeContentPlaceHolder>7\</CodeContentPlaceHolder>. The resulting sequences contains only elements that are greater than 10.  
  
 [!code[FsSequences#172](../vs140/codesnippet/FSharp/seq.skipwhile--t--function--fsharp-_1.fs)]  
