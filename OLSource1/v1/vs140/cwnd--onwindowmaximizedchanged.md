...
|---------------|-----------------|  
|[in] <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>|<CodeContentPlaceHolder>2\</CodeContentPlaceHolder> if the current window is maximized, and <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> if it is not.|  
