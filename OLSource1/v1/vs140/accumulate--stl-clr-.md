...
## Remarks  
 This function behaves the same as the STL numeric function <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>. For more information, see [accumulate](../vs140/accumulate.md).  
