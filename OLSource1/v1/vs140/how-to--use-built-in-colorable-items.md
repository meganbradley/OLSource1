...
2.  Set the `RequestStockColors` registry entry value to 1.  
     ...
     After you create the registry entry, your colorizer's <xref:Microsoft.VisualStudio.TextManager.Interop.IVsColorizer.ColorizeLine?qualifyHint=False> method can use the members of the <xref:Microsoft.VisualStudio.TextManager.Interop.DEFAULTITEMS?qualifyHint=False> enumeration to fill in the array of color attributes for use by the editor.  
