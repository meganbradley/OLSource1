...
## Return Value  
 If <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> falls within the bounding rectangle of either the left or the right scroll button of the ribbon category, returns a pointer to that button, or otherwise, returns <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>.  
