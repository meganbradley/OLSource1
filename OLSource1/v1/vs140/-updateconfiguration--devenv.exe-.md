...
## Remarks  
 [!INCLUDE[vsprvs](../vs140/includes/vsprvs_md.md)] runs this command automatically when you install a VSIX package. You should run <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> after patching your files so that [!INCLUDE[vsprvs](../vs140/includes/vsprvs_md.md)] updates the MEF cache. This enables you to evaluate whether your fix is adequate.  
