...
9. On the form design surface, double-click the button.  
     ...
     This takes you to the code page. The cursor should be in <CodeContentPlaceHolder>5\</CodeContentPlaceHolder>.  
  
10. In the function <CodeContentPlaceHolder>6\</CodeContentPlaceHolder>., add the following code:  
...
5.  In the **Watch1** window, click on a blank row. In the **Name** column, type <CodeContentPlaceHolder>7\</CodeContentPlaceHolder> (if you are using Visual Basic, Visual C#, or J#) or <CodeContentPlaceHolder>8\</CodeContentPlaceHolder> (if you are using C++), then press ENTER.  
