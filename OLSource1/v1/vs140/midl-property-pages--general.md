...
-   Generate Stubless Proxies ([/Oicf](http://msdn.microsoft.com/library/windows/desktop/aa367352))  
 ...
 For information on how to access the **General** property page in the **MIDL** folder, see [How To: Specify Project Properties with Property Pages](../vs140/how-to--specify-project-properties-with-property-pages.md).  
  
 For information on how to programmatically access MIDL options for C++ projects, see <xref:Microsoft.VisualStudio.VCProjectEngine.VCMidlTool?qualifyHint=False> object.  
