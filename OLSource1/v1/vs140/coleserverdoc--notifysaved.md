...
## Remarks  
 When the user chooses the Save command from the File menu, <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> is called for you by <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>'s implementation of [OnSaveDocument](../vs140/cdocument--onsavedocument.md). This function notifies the OLE system DLLs, which in turn notify the containers. In container applications written with the Microsoft Foundation Class Library, the [OnChange](../vs140/coleclientitem--onchange.md) member function of <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> is called.  
