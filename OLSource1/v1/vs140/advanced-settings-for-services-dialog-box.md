...
---
# Advanced Settings for Services Dialog Box
Client application services provide simplified access to [!INCLUDE[ajax_current_short](../vs140/includes/ajax_current_short_md.md)] login, roles, and profile services from Windows Forms and Windows Presentation Foundation (WPF) applications. You can use the **Services** page in the **Project Designer** to configure client application services. For more information about the **Services** page, see [Services Page, Project Designer](../vs140/services-page--project-designer.md).  
 ...
 **Role service cache timeout**  
 ...
 The role provider accesses the cached role values or the roles service when you call the [IsInRole](assetId:///M:System.Web.Security.RolePrincipal.IsInRole(System.String)?qualifyHint=False&autoUpgrade=True) method. To programmatically clear the cache and force this method to access the remote service, call the <xref:System.Web.ClientServices.Providers.ClientRoleProvider.ResetCache*> method.  
...
## See Also  
 ...
 [Services Page, Project Designer](../vs140/services-page--project-designer.md)   
 [How to: Configure Client Application Services](assetId:///34a8688a-a32c-40d3-94be-c8e610c6a4e8)   
 [How to: Work Offline with Client Application Services](assetId:///f792cb16-8520-4a0f-9dc9-07bfbc454e38)