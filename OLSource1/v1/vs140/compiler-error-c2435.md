...
'var' : dynamic initialization requires managed CRT, cannot compile with /clr:safe  
 ...
 Initialization of global per–application domain variable requires the CRT compiled with <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>, which does not produce a verifiable image.  
