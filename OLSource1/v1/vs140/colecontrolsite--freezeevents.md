...
## Remarks  
 If <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> is **TRUE**, the control site requests the control to stop fring events. If <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> is **FALSE**, the control site requests the control to continue firing events.  
