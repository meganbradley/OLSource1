...
## Remarks  
 The member function inserts an element with value <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> into the the controlled sequence, and reorders the controlled sequence to maintain the heap discipline. You use it to add another element to the queue.  
