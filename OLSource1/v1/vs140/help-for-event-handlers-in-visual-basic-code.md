...
To get Help on a particular event handler while in the code editor, put your cursor on the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> clause at the back end of the event procedure, then press F1. For example, in the <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> statement below, the correct place to put the cursor is in <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>:  
