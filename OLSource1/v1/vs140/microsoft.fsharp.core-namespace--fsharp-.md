...
|module [String](../vs140/core.string-module--fsharp-.md)|Functional programming operators for string processing. Further string operations are available via the member functions on strings and other functionality in <xref:System.String?qualifyHint=False> and <xref:System.Text.RegularExpressions.Regex?qualifyHint=False> types.|  
...
|type [bigint](../vs140/core.bigint-type-abbreviation--fsharp-.md)|Arbitrarily large integers. An abbreviation for the type <xref:System.Numerics.BigInteger?qualifyHint=False>.|  
|type [bool](../vs140/core.bool-type-abbreviation--fsharp-.md)|An abbreviation for the CLI type <xref:System.Boolean?qualifyHint=False>.|  
|type [byte](../vs140/core.byte-type-abbreviation--fsharp-.md)|An abbreviation for the CLI type <xref:System.Byte?qualifyHint=False>.|  
|type [char](../vs140/core.char-type-abbreviation--fsharp-.md)|An abbreviation for the CLI type <xref:System.Char?qualifyHint=False>.|  
|type [decimal](../vs140/core.decimal-type-abbreviation--fsharp-.md)|An abbreviation for the CLI type <xref:System.Decimal?qualifyHint=False>.|  
|type [double](../vs140/core.double-type-abbreviation--fsharp-.md)|An abbreviation for the CLI type <xref:System.Double?qualifyHint=False>.|  
|type [exn](../vs140/core.exn-type-abbreviation--fsharp-.md)|An abbreviation for the CLI type <xref:System.Exception?qualifyHint=False>.|  
|type [float](../vs140/core.float-type-abbreviation--fsharp-.md)|An abbreviation for the CLI type <xref:System.Double?qualifyHint=False>.|  
|type [float32](../vs140/core.float32-type-abbreviation--fsharp-.md)|An abbreviation for the CLI type <xref:System.Single?qualifyHint=False>.|  
...
|type [int](../vs140/core.int-type-abbreviation--fsharp-.md)|An abbreviation for the CLI type <xref:System.Int32?qualifyHint=False>.|  
|type [int16](../vs140/core.int16-type-abbreviation--fsharp-.md)|An abbreviation for the CLI type <xref:System.Int16?qualifyHint=False>.|  
|type [int32](../vs140/core.int32-type-abbreviation--fsharp-.md)|An abbreviation for the CLI type <xref:System.Int32?qualifyHint=False>.|  
|type [int64](../vs140/core.int64-type-abbreviation--fsharp-.md)|An abbreviation for the CLI type <xref:System.Int64?qualifyHint=False>.|  
|type [int8](../vs140/core.int8-type-abbreviation--fsharp-.md)|An abbreviation for the CLI type <xref:System.SByte?qualifyHint=False>.|  
|type [nativeint](../vs140/core.nativeint-type-abbreviation--fsharp-.md)|An abbreviation for the CLI type <xref:System.IntPtr?qualifyHint=False>.|  
|type [obj](../vs140/core.obj-type-abbreviation--fsharp-.md)|An abbreviation for the CLI type <xref:System.Object?qualifyHint=False>.|  
...
|type [sbyte](../vs140/core.sbyte-type-abbreviation--fsharp-.md)|An abbreviation for the CLI type <xref:System.SByte?qualifyHint=False>.|  
|type [single](../vs140/core.single-type-abbreviation--fsharp-.md)|An abbreviation for the CLI type <xref:System.Single?qualifyHint=False>.|  
|type [string](../vs140/core.string-type-abbreviation--fsharp-.md)|An abbreviation for the CLI type <xref:System.String?qualifyHint=False>.|  
|type [uint16](../vs140/core.uint16-type-abbreviation--fsharp-.md)|An abbreviation for the CLI type <xref:System.UInt16?qualifyHint=False>.|  
|type [uint32](../vs140/core.uint32-type-abbreviation--fsharp-.md)|An abbreviation for the CLI type <xref:System.UInt32?qualifyHint=False>.|  
|type [uint64](../vs140/core.uint64-type-abbreviation--fsharp-.md)|An abbreviation for the CLI type <xref:System.UInt64?qualifyHint=False>.|  
|type [uint8](../vs140/core.uint8-type-abbreviation--fsharp-.md)|An abbreviation for the CLI type <xref:System.Byte?qualifyHint=False>.|  
|type [unativeint](../vs140/core.unativeint-type-abbreviation--fsharp-.md)|An abbreviation for the CLI type <xref:System.UIntPtr?qualifyHint=False>.|  
