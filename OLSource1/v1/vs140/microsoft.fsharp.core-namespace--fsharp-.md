...
|type [&#91;&#93;\<'T>](../vs140/core.--t--type--fsharp-2.md)|Single dimensional, zero-based arrays, written <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>, <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> and so on.|  
...
|type [CompilationRepresentationAttribute](../vs140/core.compilationrepresentationattribute-class--fsharp-.md)|This attribute is used to adjust the runtime representation for a type. For example, it may be used to note that the <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> representation may be used for a type. This affects how some constructs are compiled.|  
