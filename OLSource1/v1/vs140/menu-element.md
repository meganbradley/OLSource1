...
|CommandFlag|Required. See [CommandFlag Element](../vs140/command-flag-element.md). The valid CommandFlag values for a Menu are as follows:<br /><br /> -   **AlwaysCreate**<br />-   **DefaultDocked**<br />-   **DefaultInvisible** - This flag does not affect the display of toolbars.<br />-   **DontCache**<br />-   **DynamicVisibility** - This flag does not affect the display of toolbars.<br />-   **IconAndText**<br />-   **NoCustomize**<br />-   **NotInTBList**<br />-   **NoToolbarClose**<br />-   **TextChanges**<br />-   **TextIsAnchorCommand**|  
