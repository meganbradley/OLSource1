...
|Strings|Required. See [Strings Element](../vs140/strings-element.md). The child <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> element must be defined.|  
