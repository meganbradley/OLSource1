...
apitype: "Assembly"
f1_keywords: 
  - "Microsoft.FSharp.Quotations.DerivedPatternsModule.MethodWithReflectedDefinitionPattern"
dev_langs: 
  - "FSharp"
helpviewer_keywords: 
  - "MethodWithReflectedDefinition active pattern [F#]"
...
Recognizes methods that have an associated <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>.  
...
## Return Value  
 The expression of the method definition if it is found; otherwise, <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>.  
