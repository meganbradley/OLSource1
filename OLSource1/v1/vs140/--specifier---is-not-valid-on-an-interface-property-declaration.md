...
A <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> statement inside an interface contains an invalid keyword, such as <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>. An interface can only define members, not implement them.  
