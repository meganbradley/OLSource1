...
You can define validation constraints that test whether the model meets a condition you specify. For example, you could define a constraint to make sure that a user does not create a loop of inheritance relationships. The constraint is invoked when the user tries to open or save the model, and can also be invoked manually. If the constraint fails, an error message that you define is added to the error window. You can package these constraints into a Visual Studio Integration Extension ([VSIX](http://go.microsoft.com/fwlink/?LinkId=160780)) and distribute it to other Visual Studio users.  
 ...
 You can also define constraints that validate the model against external resources such as databases. If you want to validate program code against a layer diagram, see [Architecture validation for layer diagrams](../vs140/add-custom-architecture-validation-to-layer-diagrams.md).  
...
2.  Open the **.cs** file in the new project and modify the class to implement your validation constraint.  
    ...
    > [!IMPORTANT]
    >  Make sure that your **.cs** files contain the following <CodeContentPlaceHolder>10\</CodeContentPlaceHolder> statement:  
    >   
...
5.  Install the menu command on another computer by copying the file **bin\\\*\\\*.vsix** that is built by your project. For more information, see [Installing and uninstalling an extension](#Installing).  
 ...
 When you add other **.cs** files, you will typically require the following <CodeContentPlaceHolder>12\</CodeContentPlaceHolder> statements:  
...
2.  In the validation class project, add references to the following [!INCLUDE[TLA2#tla_net](../vs140/includes/tla2sharptla_net_md.md)] assemblies:  
...
6.  Double-click the error report. If the elements mentioned in the report are visible on the screen, they will be highlighted.  
    ...
    -   The correct <CodeContentPlaceHolder>18\</CodeContentPlaceHolder> and <CodeContentPlaceHolder>19\</CodeContentPlaceHolder> attributes are attached to the validation methods.  
  
    -   <CodeContentPlaceHolder>20\</CodeContentPlaceHolder> is included in the argument for the <CodeContentPlaceHolder>21\</CodeContentPlaceHolder> attribute, and it is composed with other values using Logical OR (&#124;).  
  
    -   The parameters of all the <CodeContentPlaceHolder>22\</CodeContentPlaceHolder> and <CodeContentPlaceHolder>23\</CodeContentPlaceHolder> attributes are valid.  
  
##  \<a name="Implementing">\</a> Evaluating the Constraint  
 The validation method should determine whether the validation constraint that you want to apply is true or false. If true, it should do nothing. If false, it should report an error using the methods provided by the <CodeContentPlaceHolder>24\</CodeContentPlaceHolder> parameter.  
...
<CodeContentPlaceHolder>2\</CodeContentPlaceHolder>  
 See [Programming with the UML API](../vs140/programming-with-the-uml-api.md) for information about the methods and types you can use to navigate and read the model.  
...
|||  
|-|-|  
|<CodeContentPlaceHolder>25\</CodeContentPlaceHolder>|Defines the method as a validation constraint using Managed Extensibility Framework (MEF).|  
|<CodeContentPlaceHolder>26\</CodeContentPlaceHolder>|Specifies when validation will be performed. Use bitwise OR (&#124;) if you want to combine more than one option.\<br />\<br /> <CodeContentPlaceHolder>27\</CodeContentPlaceHolder> = invoked by the Validate menu.\<br />\<br /> <CodeContentPlaceHolder>28\</CodeContentPlaceHolder> = invoked on saving the model.\<br />\<br /> <CodeContentPlaceHolder>29\</CodeContentPlaceHolder> = invoked on opening the model. <CodeContentPlaceHolder>30\</CodeContentPlaceHolder> = invoked on saving the model, but for a contravention warns the user that it may not be possible to re-open the model. Also called on loading, before the model is parsed.|  
|<CodeContentPlaceHolder>31\</CodeContentPlaceHolder>\<br />\<br /> <CodeContentPlaceHolder>32\</CodeContentPlaceHolder>\<br />\<br /> <CodeContentPlaceHolder>33\</CodeContentPlaceHolder>|Replace the second parameter <CodeContentPlaceHolder>34\</CodeContentPlaceHolder> by the type of element to which you want the constraint to apply. The constraint method will be invoked on all elements in the specified type.\<br />\<br /> The name of the method is unimportant.|  
...
### Reporting Validation Errors  
 To create an error report, use the methods provided by <CodeContentPlaceHolder>35\</CodeContentPlaceHolder>:  
  
 <CodeContentPlaceHolder>36\</CodeContentPlaceHolder>  
  
-   <CodeContentPlaceHolder>37\</CodeContentPlaceHolder> appears in the [!INCLUDE[vsprvs](../vs140/includes/vsprvs_md.md)] Error List  
  
-   <CodeContentPlaceHolder>38\</CodeContentPlaceHolder> is a string that should be a unique identifier of the error  
  
-   <CodeContentPlaceHolder>39\</CodeContentPlaceHolder> identifies elements in the model. When the user double-clicks the error report, the shape representing this element will be selected.  
  
 <CodeContentPlaceHolder>40\</CodeContentPlaceHolder> <CodeContentPlaceHolder>41\</CodeContentPlaceHolder> and <CodeContentPlaceHolder>42\</CodeContentPlaceHolder> place messages in different sections of the error list.  
...
## How Validation Methods are Applied  
 ...
 Each validation method is applied to each element that conforms to the type in its second parameter. This means that, for example, if you define a validation method with a second parameter of <CodeContentPlaceHolder>43\</CodeContentPlaceHolder> and another with its supertype <CodeContentPlaceHolder>44\</CodeContentPlaceHolder>, then both of these methods will be applied to each use case in the model.  
  
 The hierarchy of types is summarized in [Model Element Types](../vs140/uml-model-element-types.md).  
  
 You can also access elements by following relationships. For example, if you were to define a validation method on <CodeContentPlaceHolder>45\</CodeContentPlaceHolder>, you could loop through its owned properties:  
  
<CodeContentPlaceHolder>4\</CodeContentPlaceHolder>  
### Creating a validation method on the Model  
 If you want to ensure that a validation method is called exactly once during each validation run, you can validate the <CodeContentPlaceHolder>46\</CodeContentPlaceHolder>:  
...
### Validating shapes and diagrams  
 ...
 In your validation class, declare <CodeContentPlaceHolder>47\</CodeContentPlaceHolder> as an imported property:  
  
<CodeContentPlaceHolder>6\</CodeContentPlaceHolder>  
 In a validation method, you can use <CodeContentPlaceHolder>48\</CodeContentPlaceHolder> to access the current focus diagram, if there is one:  
  
<CodeContentPlaceHolder>7\</CodeContentPlaceHolder>  
 To log an error, you must obtain the model element that the shape represents, because you cannot pass a shape to <CodeContentPlaceHolder>49\</CodeContentPlaceHolder>:  
...
|||  
|-|-|  
|<CodeContentPlaceHolder>50\</CodeContentPlaceHolder>|Store a value|  
|<CodeContentPlaceHolder>51\</CodeContentPlaceHolder>|Get a value. Returns true if successful.|  
|<CodeContentPlaceHolder>52\</CodeContentPlaceHolder>|Get a value.|  
|<CodeContentPlaceHolder>53\</CodeContentPlaceHolder>|Get a value of the specified type.|  
