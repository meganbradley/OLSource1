...
'symbol name': attributes not present on previous declaration.  
 ...
 Notice that the SAL macros will not expand unless the project has the [/analyze](../vs140/-analyze--code-analysis-.md) flag specified. When you specify **/analyze**, the compiler can throw C4985, even if no warnings or errors appeared without **/analyze**.  
