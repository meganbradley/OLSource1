...
#### Parameters  
 l<CodeContentPlaceHolder>2\</CodeContentPlaceHolder>  
...
## Remarks  
 Note that the constructor automatically fills in the members of the <CodeContentPlaceHolder>7\</CodeContentPlaceHolder> structure. You should only change these if you want a font dialog different than the default.  
