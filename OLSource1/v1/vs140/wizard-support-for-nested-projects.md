...
The IDE runs two wizards that the parent project for nested projects can implement: the **New Project** wizard and the **Add Item** wizard.  
 ...
 For more information about wizards, see [Wizard (.Vsz) File](../vs140/wizard--.vsz--file.md), [Context Parameters](../vs140/context-parameters.md) and [Registering Project and Item Templates](../vs140/registering-project-and-item-templates.md).  
