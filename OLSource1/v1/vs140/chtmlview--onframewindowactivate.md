...
## Remarks  
 Override <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> to react to the <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> notification from the Microsoft Web Browser control. See [IDocHostUIHandler::OnFrameWindowActivate](https://msdn.microsoft.com/en-us/library/aa753262.aspx) in the [!INCLUDE[winSDK](../vs140/includes/winsdk_md.md)] for more information.  
