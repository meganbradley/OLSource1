...
Converts the argument to a string using <xref:System.Object.ToString?qualifyHint=False>.  
...
## Remarks  
 For standard integer and floating point values the <xref:System.Object.ToString?qualifyHint=False> conversion uses <xref:System.Globalization.CultureInfo.InvariantCulture?qualifyHint=False>.  
