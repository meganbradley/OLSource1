...
## Remarks  
 ...
 Override this member function to change how a frame is activated. For example, you can force MDI child windows to be maximized. Add the appropriate functionality, then call the base class version with an explicit <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>.  
  
## Example  
 [!code[NVC_MFCWindowing#1](../vs140/codesnippet/CPP/cframewnd--activateframe_1.cpp)]  
