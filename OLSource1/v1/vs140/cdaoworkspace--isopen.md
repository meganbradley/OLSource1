...
---
# CDaoWorkspace::IsOpen
Call this member function to determine whether the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> object is open — that is, whether the MFC object has been initialized by a call to [Open](../vs140/cdaoworkspace--open.md) or a call to [Create](../vs140/cdaoworkspace--create.md).  
