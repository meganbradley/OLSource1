...
### Description  
 In the following example, an array of strings is initialized and passed as an argument to a <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> method for strings. The method displays the elements of the array. Next, methods <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> and <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> are called to demonstrate that sending an array argument by value does not prevent changes to the array elements.  
...
### Description  
 In the following example, a two-dimensional array of integers is initialized and passed to the <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> method. The method displays the elements of the array.  
