...
#### Parameters  
 ...
 Specifies the initial state of the frame control. Can be one or more of the values described for the *uState* parameter in <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> in the [!INCLUDE[winSDK](../vs140/includes/winsdk_md.md)]. Use the <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> value **DFCS_ADJUSTRECT** to adjust the bounding rectangle to exclude the surrounding edge of the push button.  
  
## Return Value  
 Nonzero if successful; otherwise 0.  
  
## Remarks  
 In several cases, <CodeContentPlaceHolder>6\</CodeContentPlaceHolder> depends on the <CodeContentPlaceHolder>7\</CodeContentPlaceHolder> parameter. The following list shows the relationship between the four <CodeContentPlaceHolder>8\</CodeContentPlaceHolder> values and <CodeContentPlaceHolder>9\</CodeContentPlaceHolder>:  
...
## Example  
 This code draws the size gripper in the bottom-right corner of your window. It's appropriate for the <CodeContentPlaceHolder>10\</CodeContentPlaceHolder> handler of a dialog box, which has no styles and normally doesn't contain other controls (like a status bar) that may give it a size gripper.  
