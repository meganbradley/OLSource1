...
---
# CComBSTR::Attach
Attaches a <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> to the <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> object by setting the [m_str](../vs140/ccombstr--m_str.md) member to *src*.  
...
#### Parameters  
 *src*  
 [in] The <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> to attach to the object.  
...
> [!NOTE]
>  This method will assert if <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> is non-**NULL**.  
