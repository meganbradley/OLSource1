...
4.  Start the profiler. Type:**VSPerfCmd** [/start](../vs140/start.md)**:sample** [/output](../vs140/output.md)**:**<CodeContentPlaceHolder>0\</CodeContentPlaceHolder>[<CodeContentPlaceHolder>1\</CodeContentPlaceHolder>]  
...
6.  Attach the profiler to the ASP.NET worker process. Type:**VSPerfCmd** [/attach](../vs140/attach.md)**:**{<CodeContentPlaceHolder>9\</CodeContentPlaceHolder>&#124;<CodeContentPlaceHolder>10\</CodeContentPlaceHolder>} [<CodeContentPlaceHolder>11\</CodeContentPlaceHolder>] [[/targetclr](../vs140/targetclr.md)**:**<CodeContentPlaceHolder>12\</CodeContentPlaceHolder>]  
  
    -   <CodeContentPlaceHolder>13\</CodeContentPlaceHolder> specifies the process ID of the ASP.NET worker process; <CodeContentPlaceHolder>14\</CodeContentPlaceHolder> specifies the name of the worker process. You can view the process IDs and names of all running processes in Windows Task Manager.  
    ...
    |------------------|-----------------|  
    |[/timer](../vs140/timer.md) **:** <CodeContentPlaceHolder>15\</CodeContentPlaceHolder>|Changes the sampling interval to the number of non-halted clock cycles that are specified by <CodeContentPlaceHolder>16\</CodeContentPlaceHolder>.|  
    |[/pf](../vs140/pf.md)[**:**<CodeContentPlaceHolder>17\</CodeContentPlaceHolder>]|Changes the sampling event to page faults. If <CodeContentPlaceHolder>18\</CodeContentPlaceHolder> is specified, sets the number of page faults between samples. Default is 10.|  
    |[/sys](../vs140/sys--vsperfcmd-.md)[<CodeContentPlaceHolder>19\</CodeContentPlaceHolder>]|Changes the sampling event to system calls from the process to the operating system kernel (syscalls). If <CodeContentPlaceHolder>20\</CodeContentPlaceHolder> is specified, sets the number of calls between samples. Default is 10.|  
    |[/counter](../vs140/counter.md) **:** <CodeContentPlaceHolder>21\</CodeContentPlaceHolder>|Changes the sampling event and interval to the processor performance counter and interval that are specified in <CodeContentPlaceHolder>22\</CodeContentPlaceHolder>.|  
    |[/targetclr](../vs140/targetclr.md) **:** <CodeContentPlaceHolder>23\</CodeContentPlaceHolder>|Specifies the version of the common language runtime (CLR) to profile when more than one version of the runtime is loaded in an application.|  
  
    -   **targetclr:** <CodeContentPlaceHolder>24\</CodeContentPlaceHolder> specifies the version of the CLR to profile when more than one version of the runtime is loaded in an application. Optional.  
...
-   The following pairs of **VSPerfCmd** options start and stop data collection. Specify each option on a separate command line. You can turn data collection on and off multiple times.  
    ...
    |[/processon](../vs140/processon-and-processoff.md) **:** <CodeContentPlaceHolder>25\</CodeContentPlaceHolder> **/processoff:** <CodeContentPlaceHolder>26\</CodeContentPlaceHolder>|Starts (**/processon**) or stops (**/processoff**) data collection for the process that is specified by the <CodeContentPlaceHolder>27\</CodeContentPlaceHolder>.|  
    |[/attach](../vs140/attach.md) **:**{<CodeContentPlaceHolder>28\</CodeContentPlaceHolder>&#124;<CodeContentPlaceHolder>29\</CodeContentPlaceHolder>} [/detach](../vs140/detach.md)[**:**{<CodeContentPlaceHolder>30\</CodeContentPlaceHolder>&#124;<CodeContentPlaceHolder>31\</CodeContentPlaceHolder>}]|**/attach** starts to collect data for the process specified by the <CodeContentPlaceHolder>32\</CodeContentPlaceHolder> or process name (ProcName). **/detach** stops data collection for the specified process or for all processes if a specific process is not specified.|  
