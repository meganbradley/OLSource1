...
#### Parameters  
 *idAni*  
 Specifies the type of animation. If you specify **IDANI_CAPTION**, the window caption will animate from the position specified by <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> to the position specified by <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>. The effect is similar to minimizing or maximizing a window.  
