...
## Example  
 The following examples shows how to use <CodeContentPlaceHolder>6\</CodeContentPlaceHolder>.  
  
 [!code[FsMaps#6](../vs140/codesnippet/FSharp/map.find--key--t--function--fsharp-_1.fs)]  
