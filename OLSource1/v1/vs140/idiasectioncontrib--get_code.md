...
#### Parameters  
 ...
 [out] Returns <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> if the section contains executable code; otherwise, returns <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>.  
