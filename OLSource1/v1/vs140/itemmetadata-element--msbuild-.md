...
|---------------|-----------------|  
|<CodeContentPlaceHolder>2\</CodeContentPlaceHolder>|Optional attribute.\<br />\<br /> Condition to be evaluated. For more information, see [MSBuild Conditions](../vs140/msbuild-conditions.md).|  
...
## Example  
 The following code example shows how to add <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> metadata with the value <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> to the item <CodeContentPlaceHolder>5\</CodeContentPlaceHolder>.  
