...
ms.topic: "article"
f1_keywords: 
  - "std::hash_multiset::value_compare"
...
## Example  
 See example for [value_comp](../vs140/hash_multiset--value_comp.md) for an example of how to declare and use <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>.  
