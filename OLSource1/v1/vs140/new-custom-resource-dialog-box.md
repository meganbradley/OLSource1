...
## Remarks  
 Do not specify a resource name or [!INCLUDE[TLA2#tla_id](../vs140/includes/tla2sharptla_id_md.md)] that is reserved by [!INCLUDE[vsprvs](../vs140/includes/vsprvs_md.md)]. The reserved names are DESIGNINFO, HWB, and TEXTINCLUDE, and the reserved [!INCLUDE[TLA2#tla_id](../vs140/includes/tla2sharptla_id_md.md)] is 255.  
