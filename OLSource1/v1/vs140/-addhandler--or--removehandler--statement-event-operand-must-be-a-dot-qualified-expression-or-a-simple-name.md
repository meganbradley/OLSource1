...
-   Specify the name of the object that raises the event followed by a dot (`.`) and the event name as in the following example.  
     ...
     [!code[VbVbalrEventError#30](../vs140/codesnippet/VisualBasic/-addhandler--or--removehandler--statement-event-operand-must-be-a-dot-qualified-expression-or-a-simple-name_1.vb)]  
