...
---
# CObList::GetTail
Gets the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> pointer that represents the tail element of this list.  
...
## Remarks  
 You must ensure that the list is not empty before calling <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>. If the list is empty, then the Debug version of the Microsoft Foundation Class Library asserts. Use [IsEmpty](../vs140/coblist--isempty.md) to verify that the list contains elements.  
...
## Example  
 See [CObList::CObList](../vs140/coblist--coblist.md) for a listing of the <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> class.  
