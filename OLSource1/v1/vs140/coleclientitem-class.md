...
|Name|Description|  
|----------|-----------------|  
|[COleClientItem::COleClientItem](#coleclientitem__coleclientitem)|Constructs a <CodeContentPlaceHolder>80\</CodeContentPlaceHolder> object.|  
...
|[COleClientItem::GetClipboardData](#coleclientitem__getclipboarddata)|Gets the data that would be placed on the Clipboard by calling the <CodeContentPlaceHolder>81\</CodeContentPlaceHolder> member function.|  
|[COleClientItem::GetDocument](#coleclientitem__getdocument)|Returns the <CodeContentPlaceHolder>82\</CodeContentPlaceHolder> object that contains the present item.|  
...
|[COleClientItem::IsInPlaceActive](#coleclientitem__isinplaceactive)|Returns <CodeContentPlaceHolder>83\</CodeContentPlaceHolder> if the item is in-place active.|  
...
|[COleClientItem::IsModified](#coleclientitem__ismodified)|Returns <CodeContentPlaceHolder>84\</CodeContentPlaceHolder> if the item has been modified since it was last saved.|  
|[COleClientItem::IsOpen](#coleclientitem__isopen)|Returns <CodeContentPlaceHolder>85\</CodeContentPlaceHolder> if the item is currently open in the server application.|  
|[COleClientItem::IsRunning](#coleclientitem__isrunning)|Returns <CodeContentPlaceHolder>86\</CodeContentPlaceHolder> if the item's server application is running.|  
...
|[COleClientItem::Reload](#coleclientitem__reload)|Reloads the item after a call to <CodeContentPlaceHolder>87\</CodeContentPlaceHolder>.|  
...
|-----------|-------------|------------|  
|– 0|Primary verb|<CodeContentPlaceHolder>93\</CodeContentPlaceHolder>|  
|– 1|Secondary verb|(None)|  
|– 1|Display item for editing|<CodeContentPlaceHolder>94\</CodeContentPlaceHolder>|  
|– 2|Edit item in separate window|<CodeContentPlaceHolder>95\</CodeContentPlaceHolder>|  
|– 3|Hide item|<CodeContentPlaceHolder>96\</CodeContentPlaceHolder>|  
...
### Remarks  
 If the server application was written using the Microsoft Foundation Class Library, this function causes the [OnDoVerb](../vs140/coleserveritem-class.md#coleserveritem__ondoverb) member function of the corresponding <CodeContentPlaceHolder>99\</CodeContentPlaceHolder> object to be executed.  
  
 If the primary verb is Edit and zero is specified in the <CodeContentPlaceHolder>100\</CodeContentPlaceHolder> parameter, the server application is launched to allow the OLE item to be edited. If the container application supports in-place activation, editing can be done in place. If the container does not support in-place activation (or if the Open verb is specified), the server is launched in a separate window and editing can be done there. Typically, when the user of the container application double-clicks the OLE item, the value for the primary verb in the <CodeContentPlaceHolder>101\</CodeContentPlaceHolder> parameter determines which action the user can take. However, if the server supports only one action, it takes that action, no matter which value is specified in the <CodeContentPlaceHolder>102\</CodeContentPlaceHolder> parameter.  
...
##  \<a name="coleclientitem__activateas">\</a>  COleClientItem::ActivateAs  
 Uses OLE's object conversion facilities to activate the item as though it were an item of the type specified by <CodeContentPlaceHolder>103\</CodeContentPlaceHolder>.  
...
### Parameters  
 *rDataObject*  
 Reference to a <CodeContentPlaceHolder>105\</CodeContentPlaceHolder> object that will be initialized to allow access to the data in the OLE item.  
...
##  \<a name="coleclientitem__cancreatefromdata">\</a>  COleClientItem::CanCreateFromData  
 Checks whether a container application can create an embedded object from the given <CodeContentPlaceHolder>106\</CodeContentPlaceHolder> object.  
...
### Return Value  
 Nonzero if the container can create an embedded object from the <CodeContentPlaceHolder>108\</CodeContentPlaceHolder> object; otherwise 0.  
  
### Remarks  
 The <CodeContentPlaceHolder>109\</CodeContentPlaceHolder> class is used in data transfers for retrieving data in various formats from the Clipboard, through drag and drop, or from an embedded OLE item.  
...
##  \<a name="coleclientitem__cancreatelinkfromdata">\</a>  COleClientItem::CanCreateLinkFromData  
 Checks whether a container application can create a linked object from the given <CodeContentPlaceHolder>110\</CodeContentPlaceHolder> object.  
...
### Return Value  
 Nonzero if the container can create a linked object from the <CodeContentPlaceHolder>112\</CodeContentPlaceHolder> object.  
  
### Remarks  
 The <CodeContentPlaceHolder>113\</CodeContentPlaceHolder> class is used in data transfers for retrieving data in various formats from the Clipboard, through drag and drop, or from an embedded OLE item.  
...
-   <CodeContentPlaceHolder>115\</CodeContentPlaceHolder> Save the OLE item.  
  
-   <CodeContentPlaceHolder>116\</CodeContentPlaceHolder> Do not save the OLE item.  
  
-   <CodeContentPlaceHolder>117\</CodeContentPlaceHolder> Prompt the user on whether to save the OLE item.  
...
##  \<a name="coleclientitem__coleclientitem">\</a>  COleClientItem::COleClientItem  
 Constructs a <CodeContentPlaceHolder>118\</CodeContentPlaceHolder> object and adds it to the container document's collection of document items, which constructs only the C++ object and does not perform any OLE initialization.  
...
##  \<a name="coleclientitem__convertto">\</a>  COleClientItem::ConvertTo  
 Call this member function to convert the item to the type specified by <CodeContentPlaceHolder>120\</CodeContentPlaceHolder>.  
...
##  \<a name="coleclientitem__createfromdata">\</a>  COleClientItem::CreateFromData  
 Call this function to create an embedded item from a <CodeContentPlaceHolder>126\</CodeContentPlaceHolder> object.  
 ...
 *render*  
 ...
 Pointer to a                                 [FORMATETC](http://msdn.microsoft.com/library/windows/desktop/ms682177) structure used if                                 *render* is **OLERENDER_FORMAT** or **OLERENDER_DRAW**. Provide a value for this parameter only if you want to specify additional format information beyond the Clipboard format specified by <CodeContentPlaceHolder>130\</CodeContentPlaceHolder>. If you omit this parameter, default values are used for the other fields in the **FORMATETC** structure.  
  
### Return Value  
 Nonzero if successful; otherwise 0.  
  
### Remarks  
 Data transfer operations, such as pasting from the Clipboard or drag-and-drop operations, provide <CodeContentPlaceHolder>131\</CodeContentPlaceHolder> objects containing the information offered by a server application. It is usually used in your override of [CView::OnDrop](../vs140/cview-class.md#cview__ondrop).  
 ...
 *render*  
 ...
 Pointer to a                                 [FORMATETC](http://msdn.microsoft.com/library/windows/desktop/ms682177) structure used if                                 *render* is **OLERENDER_FORMAT** or **OLERENDER_DRAW**. Provide a value for this parameter only if you want to specify additional format information beyond the Clipboard format specified by <CodeContentPlaceHolder>136\</CodeContentPlaceHolder>. If you omit this parameter, default values are used for the other fields in the **FORMATETC** structure.  
 ...
 *render*  
 ...
 Pointer to a                                 [FORMATETC](http://msdn.microsoft.com/library/windows/desktop/ms682177) structure used if                                 *render* is **OLERENDER_FORMAT** or **OLERENDER_DRAW**. Provide a value for this parameter only if you want to specify additional format information beyond the Clipboard format specified by <CodeContentPlaceHolder>139\</CodeContentPlaceHolder>. If you omit this parameter, default values are used for the other fields in the **FORMATETC** structure.  
...
##  \<a name="coleclientitem__createlinkfromdata">\</a>  COleClientItem::CreateLinkFromData  
 Call this function to create a linked item from a <CodeContentPlaceHolder>140\</CodeContentPlaceHolder> object.  
 ...
 *render*  
 ...
 Pointer to a                                 [FORMATETC](http://msdn.microsoft.com/library/windows/desktop/ms682177) structure used if                                 *render* is **OLERENDER_FORMAT** or **OLERENDER_DRAW**. Provide a value for this parameter only if you want to specify additional format information beyond the Clipboard format specified by <CodeContentPlaceHolder>144\</CodeContentPlaceHolder>. If you omit this parameter, default values are used for the other fields in the **FORMATETC** structure.  
  
### Return Value  
 Nonzero if successful; otherwise 0.  
  
### Remarks  
 Call this during a drop operation when the user indicates a link should be created. It can also be used to handle the Edit Paste command. It is called by the framework in <CodeContentPlaceHolder>145\</CodeContentPlaceHolder> and in [COlePasteSpecialDialog::CreateItem](../vs140/colepastespecialdialog-class.md#colepastespecialdialog__createitem) when the Link option has been selected.  
 ...
 *render*  
 ...
 Pointer to a                                 [FORMATETC](http://msdn.microsoft.com/library/windows/desktop/ms682177) structure used if                                 *render* is **OLERENDER_FORMAT** or **OLERENDER_DRAW**. Provide a value for this parameter only if you want to specify additional format information beyond the Clipboard format specified by <CodeContentPlaceHolder>149\</CodeContentPlaceHolder>. If you omit this parameter, default values are used for the other fields in the **FORMATETC** structure.  
 ...
 *render*  
 ...
 Pointer to a                                 [FORMATETC](http://msdn.microsoft.com/library/windows/desktop/ms682177) structure used if                                 *render* is **OLERENDER_FORMAT** or **OLERENDER_DRAW**. Provide a value for this parameter only if you want to specify additional format information beyond the Clipboard format specified by <CodeContentPlaceHolder>153\</CodeContentPlaceHolder>. If you omit this parameter, default values are used for the other fields in the **FORMATETC** structure.  
 ...
 *render*  
 ...
 Pointer to a                                 [FORMATETC](http://msdn.microsoft.com/library/windows/desktop/ms682177) structure used if                                 *render* is **OLERENDER_FORMAT** or **OLERENDER_DRAW**. Provide a value for this parameter only if you want to specify additional format information beyond the Clipboard format specified by <CodeContentPlaceHolder>156\</CodeContentPlaceHolder>. If you omit this parameter, default values are used for the other fields in the **FORMATETC** structure.  
...
##  \<a name="coleclientitem__createstaticfromdata">\</a>  COleClientItem::CreateStaticFromData  
 Call this function to create a static item from a <CodeContentPlaceHolder>157\</CodeContentPlaceHolder> object.  
 ...
 *render*  
 ...
 Pointer to a                                 [FORMATETC](http://msdn.microsoft.com/library/windows/desktop/ms682177) structure used if                                 *render* is **OLERENDER_FORMAT** or **OLERENDER_DRAW**. Provide a value for this parameter only if you want to specify additional format information beyond the Clipboard format specified by <CodeContentPlaceHolder>161\</CodeContentPlaceHolder>. If you omit this parameter, default values are used for the other fields in the **FORMATETC** structure.  
  
### Return Value  
 Nonzero if successful; otherwise 0.  
  
### Remarks  
 A static item contains the presentation data but not the native data; consequently, it cannot be edited. This is essentially the same as [CreateStaticFromClipboard](#coleclientitem__createstaticfromclipboard) except that a static item can be created from an arbitrary <CodeContentPlaceHolder>162\</CodeContentPlaceHolder>, not just from the Clipboard.  
...
### Remarks  
 ...
 If your application supports undo, do not call <CodeContentPlaceHolder>163\</CodeContentPlaceHolder>; instead, call [DeactivateUI](#coleclientitem__deactivateui).  
...
##  \<a name="coleclientitem__dodragdrop">\</a>  COleClientItem::DoDragDrop  
 Call the <CodeContentPlaceHolder>165\</CodeContentPlaceHolder> member function to perform a drag-and-drop operation.  
...
### Parameters  
 ...
 The offset from <CodeContentPlaceHolder>168\</CodeContentPlaceHolder> where the mouse position was at the time of the drag.  
...
### Return Value  
 A <CodeContentPlaceHolder>172\</CodeContentPlaceHolder> value. If it is <CodeContentPlaceHolder>173\</CodeContentPlaceHolder>, the original data should be removed.  
  
### Remarks  
 The drag-and-drop operation does not start immediately. It waits until the mouse cursor leaves the rectangle specified by <CodeContentPlaceHolder>174\</CodeContentPlaceHolder> or until a specified number of milliseconds have passed. If <CodeContentPlaceHolder>175\</CodeContentPlaceHolder> is **NULL**, the size of the rectangle is one pixel.  
...
##  \<a name="coleclientitem__doverb">\</a>  COleClientItem::DoVerb  
 Call <CodeContentPlaceHolder>176\</CodeContentPlaceHolder> to execute the specified verb.  
...
|Value|Meaning|Symbol|  
|-----------|-------------|------------|  
|– 0|Primary verb|<CodeContentPlaceHolder>178\</CodeContentPlaceHolder>|  
|– 1|Secondary verb|(None)|  
|– 1|Display item for editing|<CodeContentPlaceHolder>179\</CodeContentPlaceHolder>|  
|– 2|Edit item in separate window|<CodeContentPlaceHolder>180\</CodeContentPlaceHolder>|  
|– 3|Hide item|<CodeContentPlaceHolder>181\</CodeContentPlaceHolder>|  
...
### Remarks  
 ...
 If the primary verb is Edit and zero is specified in the <CodeContentPlaceHolder>184\</CodeContentPlaceHolder> parameter, the server application is launched to allow the OLE item to be edited. If the container application supports in-place activation, editing can be done in place. If the container does not support in-place activation (or if the Open verb is specified), the server is launched in a separate window and editing can be done there. Typically, when the user of the container application double-clicks the OLE item, the value for the primary verb in the <CodeContentPlaceHolder>185\</CodeContentPlaceHolder> parameter determines which action the user can take. However, if the server supports only one action, it takes that action, no matter which value is specified in the <CodeContentPlaceHolder>186\</CodeContentPlaceHolder> parameter.  
...
### Parameters  
 ...
 Pointer to a [CRect](../vs140/crect-class.md) object or <CodeContentPlaceHolder>189\</CodeContentPlaceHolder> structure that defines the bounding rectangle in which to draw the OLE item (in logical units determined by the device context).  
  
 <CodeContentPlaceHolder>190\</CodeContentPlaceHolder>  
 Specifies the aspect of the OLE item, that is, how it should be displayed. If <CodeContentPlaceHolder>191\</CodeContentPlaceHolder> is –1, the last aspect set by using [SetDrawAspect](#coleclientitem__setdrawaspect) is used. For more information about possible values for this flag, see [SetDrawAspect](#coleclientitem__setdrawaspect).  
  
### Return Value  
 Nonzero if successful; otherwise 0.  
  
### Remarks  
 The function may use the metafile representation of the OLE item created by the [OnDraw](../vs140/coleserveritem-class.md#coleserveritem__ondraw) member function of <CodeContentPlaceHolder>192\</CodeContentPlaceHolder>.  
  
 Typically you use **Draw** for screen display, passing the screen device context as <CodeContentPlaceHolder>193\</CodeContentPlaceHolder>. In this case, you need to specify only the first two parameters.  
  
 The <CodeContentPlaceHolder>194\</CodeContentPlaceHolder> parameter identifies the rectangle in the target device context (relative to its current mapping mode). Rendering may involve scaling the picture and can be used by container applications to impose a view that scales between the displayed view and the final printed image.  
...
### Remarks  
 This function provides the same information as [GetExtent](#coleclientitem__getextent). However, you can call <CodeContentPlaceHolder>197\</CodeContentPlaceHolder> to get extent information during the processing of other OLE handlers, such as [OnChange](#coleclientitem__onchange). The dimensions are in <CodeContentPlaceHolder>198\</CodeContentPlaceHolder> units.  
  
 This is possible because <CodeContentPlaceHolder>199\</CodeContentPlaceHolder> uses the                         [IViewObject2](http://msdn.microsoft.com/library/windows/desktop/ms691318) interface rather than use the                         [IOleObject](http://msdn.microsoft.com/library/windows/desktop/dd542709) interface to get the extent of this item. The **IViewObject2** COM object caches the extent information used in the previous call to                         [IViewObject::Draw](http://msdn.microsoft.com/library/windows/desktop/ms688655).  
...
##  \<a name="coleclientitem__getclassid">\</a>  COleClientItem::GetClassID  
 Returns the class ID of the item into the memory pointed to by <CodeContentPlaceHolder>200\</CodeContentPlaceHolder>.  
...
##  \<a name="coleclientitem__getclipboarddata">\</a>  COleClientItem::GetClipboardData  
 Call this function to get a <CodeContentPlaceHolder>202\</CodeContentPlaceHolder> object containing all the data that would be placed on the Clipboard by a call to the [CopyToClipboard](#coleclientitem__copytoclipboard) member function.  
...
### Remarks  
 <CodeContentPlaceHolder>207\</CodeContentPlaceHolder> is called as the default implementation of [OnGetClipboardData](#coleclientitem__ongetclipboarddata). Override <CodeContentPlaceHolder>208\</CodeContentPlaceHolder> only if you want to offer data formats in addition to those offered by <CodeContentPlaceHolder>209\</CodeContentPlaceHolder>. Place those formats in the <CodeContentPlaceHolder>210\</CodeContentPlaceHolder> object before or after calling <CodeContentPlaceHolder>211\</CodeContentPlaceHolder>, and then pass the <CodeContentPlaceHolder>212\</CodeContentPlaceHolder> object to the [COleDataSource::SetClipboard](../vs140/coledatasource-class.md#coledatasource__setclipboard) function. For example, if you want the OLE item's position in its container document to accompany it on the Clipboard, you would define your own format for passing that information and place it in the <CodeContentPlaceHolder>213\</CodeContentPlaceHolder> before calling <CodeContentPlaceHolder>214\</CodeContentPlaceHolder>.  
...
### Remarks  
 This pointer allows access to the <CodeContentPlaceHolder>215\</CodeContentPlaceHolder> object that you passed as an argument to the <CodeContentPlaceHolder>216\</CodeContentPlaceHolder> constructor.  
  
##  \<a name="coleclientitem__getdrawaspect">\</a>  COleClientItem::GetDrawAspect  
 Call the <CodeContentPlaceHolder>217\</CodeContentPlaceHolder> member function to determine the current "aspect," or view, of the item.  
  
<CodeContentPlaceHolder>34\</CodeContentPlaceHolder>  
### Return Value  
 A value from the <CodeContentPlaceHolder>218\</CodeContentPlaceHolder> enumeration, whose values are listed in the reference for [SetDrawAspect](#coleclientitem__setdrawaspect).  
...
### Parameters  
 ...
 Pointer to a **SIZE** structure or a <CodeContentPlaceHolder>220\</CodeContentPlaceHolder> object that will receive the size information.  
...
### Remarks  
 If the server application was written using the Microsoft Foundation Class Library, this function causes the [OnGetExtent](../vs140/coleserveritem-class.md#coleserveritem__ongetextent) member function of the corresponding <CodeContentPlaceHolder>222\</CodeContentPlaceHolder> object to be called. Note that the retrieved size may differ from the size last set by the [SetExtent](#coleclientitem__setextent) member function; the size specified by <CodeContentPlaceHolder>223\</CodeContentPlaceHolder> is treated as a suggestion. The dimensions are in <CodeContentPlaceHolder>224\</CodeContentPlaceHolder> units.  
  
> [!NOTE]
>  Do not call <CodeContentPlaceHolder>225\</CodeContentPlaceHolder> during the processing of an OLE handler, such as [OnChange](#coleclientitem__onchange). Call [GetCachedExtent](#coleclientitem__getcachedextent) instead.  
...
##  \<a name="coleclientitem__getinplacewindow">\</a>  COleClientItem::GetInPlaceWindow  
 Call the <CodeContentPlaceHolder>227\</CodeContentPlaceHolder> member function to get a pointer to the window in which the item has been opened for in-place editing.  
...
### Return Value  
 A **COleClientItem::ItemState** enumerated value, which can be one of the following: <CodeContentPlaceHolder>228\</CodeContentPlaceHolder>, **loadedState**, <CodeContentPlaceHolder>229\</CodeContentPlaceHolder>, <CodeContentPlaceHolder>230\</CodeContentPlaceHolder>, <CodeContentPlaceHolder>231\</CodeContentPlaceHolder>. For information about these states, see the article [Containers: Client-Item States](../vs140/containers--client-item-states.md).  
...
### Return Value  
 An <CodeContentPlaceHolder>232\</CodeContentPlaceHolder> value.  
  
### Remarks  
 For member functions that return a **BOOL** value of **FALSE**, or other member functions that return **NULL**, <CodeContentPlaceHolder>233\</CodeContentPlaceHolder> returns more detailed failure information. Be aware that most OLE member functions throw exceptions for more serious errors. The specific information on the interpretation of the <CodeContentPlaceHolder>234\</CodeContentPlaceHolder> depends on the underlying OLE call that last returned an <CodeContentPlaceHolder>235\</CodeContentPlaceHolder> value.  
  
 For more information on <CodeContentPlaceHolder>236\</CodeContentPlaceHolder>, see                         [Structure of COM Error Codes](http://msdn.microsoft.com/library/windows/desktop/ms690088) in the [!INCLUDE[winSDK](../vs140/includes/winsdk_md.md)] documentation.  
...
-   <CodeContentPlaceHolder>237\</CodeContentPlaceHolder> Update the linked item whenever possible. This option supports the Automatic link-update radio button in the Links dialog box.  
  
-   <CodeContentPlaceHolder>238\</CodeContentPlaceHolder> Update the linked item only on request from the container application (when the [UpdateLink](#coleclientitem__updatelink) member function is called). This option supports the Manual link-update radio button in the Links dialog box.  
...
-   <CodeContentPlaceHolder>239\</CodeContentPlaceHolder> The OLE item is a link.  
  
-   <CodeContentPlaceHolder>240\</CodeContentPlaceHolder> The OLE item is embedded.  
  
-   <CodeContentPlaceHolder>241\</CodeContentPlaceHolder> The OLE item is static, that is, it contains only presentation data, not native data, and thus cannot be edited.  
...
-   <CodeContentPlaceHolder>242\</CodeContentPlaceHolder> The full type name displayed to the user.  
  
-   <CodeContentPlaceHolder>243\</CodeContentPlaceHolder> A short name (15 characters maximum) for use in pop-up menus and the Edit Links dialog box.  
  
-   <CodeContentPlaceHolder>244\</CodeContentPlaceHolder> Name of the application servicing the class.  
...
### Remarks  
 It is common to execute different logic depending on whether the item is being edited in place. The function checks whether the current item state is equal to either the <CodeContentPlaceHolder>246\</CodeContentPlaceHolder> or the <CodeContentPlaceHolder>247\</CodeContentPlaceHolder>.  
...
##  \<a name="coleclientitem__onactivateui">\</a>  COleClientItem::OnActivateUI  
 The framework calls <CodeContentPlaceHolder>249\</CodeContentPlaceHolder> when the object has entered the active UI state.  
  
<CodeContentPlaceHolder>50\</CodeContentPlaceHolder>  
### Remarks  
 The object has now installed its tool bar and menus.  
  
 The default implementation remembers the server's <CodeContentPlaceHolder>250\</CodeContentPlaceHolder> for later **GetServerWindow** calls.  
...
-   <CodeContentPlaceHolder>252\</CodeContentPlaceHolder> The OLE item's appearance has changed.  
  
-   <CodeContentPlaceHolder>253\</CodeContentPlaceHolder> The OLE item has been saved.  
  
-   <CodeContentPlaceHolder>254\</CodeContentPlaceHolder> The OLE item has been closed.  
  
-   <CodeContentPlaceHolder>255\</CodeContentPlaceHolder> The OLE item has changed from one state to another.  
  
 <CodeContentPlaceHolder>256\</CodeContentPlaceHolder>  
 If <CodeContentPlaceHolder>257\</CodeContentPlaceHolder> is <CodeContentPlaceHolder>258\</CodeContentPlaceHolder> or <CodeContentPlaceHolder>259\</CodeContentPlaceHolder>, this parameter is not used. If <CodeContentPlaceHolder>260\</CodeContentPlaceHolder> is <CodeContentPlaceHolder>261\</CodeContentPlaceHolder>, this parameter specifies the aspect of the OLE item that has changed. For possible values, see the <CodeContentPlaceHolder>262\</CodeContentPlaceHolder> parameter of [COleClientItem::Draw](#coleclientitem__draw). If <CodeContentPlaceHolder>263\</CodeContentPlaceHolder> is <CodeContentPlaceHolder>264\</CodeContentPlaceHolder>, this parameter is a **COleClientItem::ItemState** enumerated value and describes the state being entered. It can have one of the following values: <CodeContentPlaceHolder>265\</CodeContentPlaceHolder>, **loadedState**, <CodeContentPlaceHolder>266\</CodeContentPlaceHolder>, <CodeContentPlaceHolder>267\</CodeContentPlaceHolder>, or <CodeContentPlaceHolder>268\</CodeContentPlaceHolder>.  
  
### Remarks  
 (If the server application is written using the Microsoft Foundation Class Library, this function is called in response to the <CodeContentPlaceHolder>269\</CodeContentPlaceHolder> member functions of <CodeContentPlaceHolder>270\</CodeContentPlaceHolder> or <CodeContentPlaceHolder>271\</CodeContentPlaceHolder>.) The default implementation marks the container document as modified if <CodeContentPlaceHolder>272\</CodeContentPlaceHolder> is <CodeContentPlaceHolder>273\</CodeContentPlaceHolder> or <CodeContentPlaceHolder>274\</CodeContentPlaceHolder>.  
  
 For <CodeContentPlaceHolder>275\</CodeContentPlaceHolder>, the current state returned from [GetItemState](#coleclientitem__getitemstate) will still be the old state, meaning the state that was current prior to this state change.  
...
##  \<a name="coleclientitem__ondeactivate">\</a>  COleClientItem::OnDeactivate  
 Called by the framework when the OLE item transitions from the in-place active state ( <CodeContentPlaceHolder>276\</CodeContentPlaceHolder>) to the loaded state, meaning that it is deactivated after an in-place activation.  
...
### Remarks  
 ...
 If <CodeContentPlaceHolder>278\</CodeContentPlaceHolder> is **FALSE**, the container should disable the undo command, in effect discarding the undo state of the container, because it indicates that the last operation performed by the server is not undoable.  
...
##  \<a name="coleclientitem__ongetclipboarddata">\</a>  COleClientItem::OnGetClipboardData  
 Called by the framework to get a <CodeContentPlaceHolder>279\</CodeContentPlaceHolder> object containing all the data that would be placed on the Clipboard by a call to either the [CopyToClipboard](#coleclientitem__copytoclipboard) or the [DoDragDrop](#coleclientitem__dodragdrop) member function.  
...
##  \<a name="coleclientitem__ongetcliprect">\</a>  COleClientItem::OnGetClipRect  
 The framework calls the <CodeContentPlaceHolder>283\</CodeContentPlaceHolder> member function to get the clipping-rectangle coordinates of the item that is being edited in place.  
...
##  \<a name="coleclientitem__ongetitemposition">\</a>  COleClientItem::OnGetItemPosition  
 The framework calls the <CodeContentPlaceHolder>284\</CodeContentPlaceHolder> member function to get the coordinates of the item that is being edited in place.  
...
### Remarks  
 ...
 If the container is an MDI application, the default implementation returns a pointer to the [CMDIFrameWnd](../vs140/cmdiframewnd-class.md) object in <CodeContentPlaceHolder>289\</CodeContentPlaceHolder> and a pointer to the active [CMDIChildWnd](../vs140/cmdichildwnd-class.md) object in <CodeContentPlaceHolder>290\</CodeContentPlaceHolder>. If the container is an SDI application, the default implementation returns a pointer to the [CFrameWnd](../vs140/cframewnd-class.md) object in <CodeContentPlaceHolder>291\</CodeContentPlaceHolder> and returns **NULL** in <CodeContentPlaceHolder>292\</CodeContentPlaceHolder>. The default implementation also fills in the members of <CodeContentPlaceHolder>293\</CodeContentPlaceHolder>.  
...
### Remarks  
 ...
 The default implementation inserts into <CodeContentPlaceHolder>296\</CodeContentPlaceHolder> the in-place container menus; that is, the File, Container, and Window menu groups. [CDocTemplate::SetContainerInfo](../vs140/cdoctemplate-class.md#cdoctemplate__setcontainerinfo) is used to set this menu resource. The default implementation also assigns the appropriate values to elements 0, 2, and 4 in <CodeContentPlaceHolder>297\</CodeContentPlaceHolder>, depending on the menu resource. Override this function if the default implementation is not appropriate for your application; for example, if your application does not use document templates for associating resources with document types. If you override this function, you should also override [OnSetMenu](#coleclientitem__onsetmenu) and [OnRemoveMenus](#coleclientitem__onremovemenus). This is an advanced overridable.  
...
### Remarks  
 The default implementation removes from <CodeContentPlaceHolder>299\</CodeContentPlaceHolder> the in-place container menus, that is, the File, Container, and Window menu groups. Override this function if the default implementation is not appropriate for your application; for example, if your application does not use document templates for associating resources with document types. If you override this function, you should probably override [OnInsertMenus](#coleclientitem__oninsertmenus) and [OnSetMenu](#coleclientitem__onsetmenu) as well. This is an advanced overridable.  
  
 The submenus on <CodeContentPlaceHolder>300\</CodeContentPlaceHolder> may be shared by more than one composite menu if the server has repeatedly called <CodeContentPlaceHolder>301\</CodeContentPlaceHolder>. Therefore you should not delete any submenus in your override of <CodeContentPlaceHolder>302\</CodeContentPlaceHolder>; you should only detach them.  
...
##  \<a name="coleclientitem__onsetmenu">\</a>  COleClientItem::OnSetMenu  
 Called by the framework two times when in-place activation begins and ends; the first time to install the composite menu and the second time (with <CodeContentPlaceHolder>303\</CodeContentPlaceHolder> equal to **NULL**) to remove it.  
  
<CodeContentPlaceHolder>64\</CodeContentPlaceHolder>  
### Parameters  
 <CodeContentPlaceHolder>304\</CodeContentPlaceHolder>  
 Pointer to the composite menu constructed by calls to the [OnInsertMenus](#coleclientitem__oninsertmenus) member function and the <CodeContentPlaceHolder>305\</CodeContentPlaceHolder> function.  
...
### Return Value  
 Nonzero if the function call causes a change in the control bars' state; 0 if the call causes no change, or if <CodeContentPlaceHolder>309\</CodeContentPlaceHolder> does not point to the container's frame window.  
  
### Remarks  
 This function returns 0 if the control bars are already in the state specified by                         *bShow.* This would occur, for example, if the control bars are hidden and <CodeContentPlaceHolder>310\</CodeContentPlaceHolder> is **FALSE**.  
...
### Remarks  
 **Release** is called by the <CodeContentPlaceHolder>312\</CodeContentPlaceHolder> destructor.  
...
### Remarks  
 Call the <CodeContentPlaceHolder>313\</CodeContentPlaceHolder> function after activating the item as an item of another type by a call to [ActivateAs](#coleclientitem__activateas).  
...
##  \<a name="coleclientitem__setdrawaspect">\</a>  COleClientItem::SetDrawAspect  
 Call the <CodeContentPlaceHolder>314\</CodeContentPlaceHolder> member function to set the "aspect," or view, of the item.  
  
<CodeContentPlaceHolder>72\</CodeContentPlaceHolder>  
### Parameters  
 <CodeContentPlaceHolder>315\</CodeContentPlaceHolder>  
 A value from the <CodeContentPlaceHolder>316\</CodeContentPlaceHolder> enumeration. This parameter can have one of the following values:  
  
-   <CodeContentPlaceHolder>317\</CodeContentPlaceHolder> Item is represented in such a way that it can be displayed as an embedded object inside its container.  
  
-   <CodeContentPlaceHolder>318\</CodeContentPlaceHolder> Item is rendered in a "thumbnail" representation so that it can be displayed in a browsing tool.  
  
-   <CodeContentPlaceHolder>319\</CodeContentPlaceHolder> Item is represented by an icon.  
  
-   <CodeContentPlaceHolder>320\</CodeContentPlaceHolder> Item is represented as if it were printed using the Print command from the File menu.  
  
### Remarks  
 The aspect specifies how the item is to be rendered by [Draw](#coleclientitem__draw) when the default value for that function's <CodeContentPlaceHolder>321\</CodeContentPlaceHolder> argument is used.  
...
### Remarks  
 If the server application was written using the Microsoft Foundation Class Library, this causes the [OnSetExtent](../vs140/coleserveritem-class.md#coleserveritem__onsetextent) member function of the corresponding <CodeContentPlaceHolder>324\</CodeContentPlaceHolder> object to be called. The OLE item can then adjust its display accordingly. The dimensions must be in <CodeContentPlaceHolder>325\</CodeContentPlaceHolder> units. Call this function when the user resizes the OLE item or if you support some form of layout negotiation.  
...
### Remarks  
 ...
 The <CodeContentPlaceHolder>331\</CodeContentPlaceHolder> parameter is copied into the item; therefore, <CodeContentPlaceHolder>332\</CodeContentPlaceHolder> must be freed by the caller.  
...
-   <CodeContentPlaceHolder>333\</CodeContentPlaceHolder> Update the linked item whenever possible. This option supports the Automatic link-update radio button in the Links dialog box.  
  
-   <CodeContentPlaceHolder>334\</CodeContentPlaceHolder> Update the linked item only on request from the container application (when the [UpdateLink](#coleclientitem__updatelink) member function is called). This option supports the Manual link-update radio button in the Links dialog box.  
