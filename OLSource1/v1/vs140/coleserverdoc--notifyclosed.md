...
## Remarks  
 When the user chooses the Close command from the File menu, <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> is called by <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>'s implementation of the [OnCloseDocument](../vs140/cdocument--onclosedocument.md) member function. In container applications written with the Microsoft Foundation Class Library, the [OnChange](../vs140/coleclientitem--onchange.md) member function of <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> is called.  
