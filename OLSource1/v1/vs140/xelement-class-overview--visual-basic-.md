...
-   You can parse XML from various sources, including a <xref:System.IO.TextReader?qualifyHint=False>, text files, or a Web address (URL). For more information, see [Parsing XML (Visual Basic)](../vs140/parsing-xml--visual-basic-.md).  
