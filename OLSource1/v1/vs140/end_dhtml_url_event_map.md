...
#### Parameters  
 ...
 The name of the class containing the event map. This class should derive directly or indirectly from [CMultiPageDHtmlDialog](../vs140/cmultipagedhtmldialog-class.md). This should match <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> in the corresponding [BEGIN_DHTML_URL_EVENT_MAP](../vs140/begin_dhtml_url_event_map.md) macro.  
