...
-   ![Prerequsite](../vs140/media/prereq.png "Prereq")At the end of a test, the process in which the test runs is terminated. If you started your application in the test, the application usually closes.  If you do not want the test to close your application when it exits, you must add a .runsettings file to your solution and use the <CodeContentPlaceHolder>10\</CodeContentPlaceHolder> option. For more information, see [Configuring tests with .runsettings](../vs140/configure-unit-tests-by-using-a-.runsettings-file.md).  
...
-   Adds a method called <CodeContentPlaceHolder>13\</CodeContentPlaceHolder> to your UI map (UIMap.uitest). This file opens in the Coded UI Test Editor, where you can edit the assertions.  
...
>  You should not have to change the keyboard assignments for mouse hover events under ordinary circumstances. Use caution when reassigning the keyboard assignment. Your choice might already be in use elsewhere within Visual Studio or the application being tested.  
 ...
 In the configuration file, change the values for the <CodeContentPlaceHolder>15\</CodeContentPlaceHolder> and <CodeContentPlaceHolder>16\</CodeContentPlaceHolder> keys to modify the keyboard assignments:  
 ...
 **Setting implicit mouse hovers for the web browser**  
 ...
 In many websites, when you hover over a particular control, it expands to show additional details. Generally, these look like menus in desktop applications. Because this is a common pattern, coded UI tests enable implicit hovers for Web browsing. For example, if you record hovers in Internet Explorer, an event is fired. These events can lead to redundant hovers getting recorded. Because of this, implicit hovers are recorded with <CodeContentPlaceHolder>17\</CodeContentPlaceHolder> set to <CodeContentPlaceHolder>18\</CodeContentPlaceHolder> in the UI test configuration file. This allows playback to continue if a hover event fails.  
  
 To enable the recording of implicit hovers in a Web browser, open the configuration file:  
  
 <CodeContentPlaceHolder>19\</CodeContentPlaceHolder>  
  
 Verify that the configuration file has the key <CodeContentPlaceHolder>20\</CodeContentPlaceHolder> set to a to a value of <CodeContentPlaceHolder>21\</CodeContentPlaceHolder> as shown in the following sample:  
...
<CodeContentPlaceHolder>6\</CodeContentPlaceHolder>  
     ...
     You can also add new test methods and add code to them in the same way. Each test method must have the <CodeContentPlaceHolder>22\</CodeContentPlaceHolder> attribute.  
...
-   The second part consists of enabling you to get and set properties on a UI test control. For example, coded UI tests can get the count of items in a <CodeContentPlaceHolder>23\</CodeContentPlaceHolder>, or set a <CodeContentPlaceHolder>24\</CodeContentPlaceHolder> to the selected state.  
...
-   To specify the property of the control to get, use the appropriate string from the <CodeContentPlaceHolder>27\</CodeContentPlaceHolder> class in each control as the parameter to \<xref:Microsoft.VisualStudio.TestTools.UITesting.UITestControl.GetProperty*>.  
...
-   To specify the property of the control to set, use the appropriate string from the  <CodeContentPlaceHolder>29\</CodeContentPlaceHolder> class as the first parameter to \<xref:Microsoft.VisualStudio.TestTools.UITesting.UITestControl.SetProperty*>, with the property value as the second parameter.  
