...
---
# CWnd::OnIconEraseBkgnd
The framework calls this member function for a minimized (iconic) <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> object when the background of the icon must be filled before painting the icon.  
...
## Remarks  
 <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> receives this call only if a class icon is defined for the window default implementation; otherwise [OnEraseBkgnd](../vs140/cwnd--onerasebkgnd.md) is called.  
