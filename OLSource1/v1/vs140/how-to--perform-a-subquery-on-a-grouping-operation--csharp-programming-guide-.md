...
## Compiling the Code  
 This example contains references to objects that are defined in the sample application in [How to: Query a Collections of Objects](../vs140/how-to--query-a-collection-of-objects--csharp-programming-guide-.md). To compile and run this method, paste it into the <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> class in that application and add a call to it from the <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> method.  
