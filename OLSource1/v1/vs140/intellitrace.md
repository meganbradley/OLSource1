...
|||  
|-|-|  
|**Debug my application with IntelliTrace:**\<br />\<br /> -   Show me past events.\<br />-   Show me call information with past events.\<br />-   Save my IntelliTrace session.\<br />-   Control the data that IntelliTrace collects.|-   [Walkthrough: Using IntelliTrace](../vs140/walkthrough--using-intellitrace.md)\<br />     [Record Execution History to Debug Your Application with IntelliTrace in Visual Studio](../vs140/intellitrace-features.md)\<br />-   [Configure IntelliTrace](assetId:///7657ecab-e07e-4b1b-872d-f05d966be37e)\<br />-   [Historical Debugging](../vs140/historical-debugging.md)|  
