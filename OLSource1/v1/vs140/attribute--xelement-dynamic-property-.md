...
## Property Value/Return Value  
 An indexer of the type <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>. This indexer takes the expanded name of the specified attribute and returns the corresponding \<xref:System.Xml.Linq.XAttribute*>, or <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> if there is no attribute with the specified name.  
