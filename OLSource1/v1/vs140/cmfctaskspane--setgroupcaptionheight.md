...
## Remarks  
 ...
 If <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> is -1, the framework determines the margin value by using the visual manager (<CodeContentPlaceHolder>3\</CodeContentPlaceHolder>). The default caption height is 25 pixels.  
