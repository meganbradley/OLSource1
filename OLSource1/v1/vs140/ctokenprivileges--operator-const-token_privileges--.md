...
ms.topic: "reference"
f1_keywords: 
  - "ATL.CTokenPrivileges.operatorconstTOKEN_PRIVILEGES*"
  - "operatorconstTOKEN_PRIVILEGES*"
  - "ATL::CTokenPrivileges::operatorconstTOKEN_PRIVILEGES*"
  - "CTokenPrivileges::operatorconstTOKEN_PRIVILEGES*"
  - "CTokenPrivileges.operatorconstTOKEN_PRIVILEGES*"
  - "constTOKEN_PRIVILEGES*"
dev_langs: 
  - "C++"
helpviewer_keywords: 
  - "const TOKEN_PRIVILEGES * operator"
