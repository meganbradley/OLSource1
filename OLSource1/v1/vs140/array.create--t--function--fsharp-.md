...
apitype: "Assembly"
f1_keywords: 
  - "Microsoft.FSharp.Collections.ArrayModule.Create``1"
dev_langs: 
  - "FSharp"
helpviewer_keywords: 
  - "Array.create function [F#]"
  - "create function [F#]"
...
## Example  
 The following code illustrates the use of <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> as well as setting and getting array values.  
  
 [!code[FsArrays#9](../vs140/codesnippet/FSharp/array.create--t--function--fsharp-_1.fs)]  
