...
2.  In the [Properties Window](../vs140/properties-window.md), in the **Caption** property, type a new name for the control, typing an ampersand (**&**) in front of the letter you want as the access key for that control. For example, <CodeContentPlaceHolder>0\</CodeContentPlaceHolder>.  
