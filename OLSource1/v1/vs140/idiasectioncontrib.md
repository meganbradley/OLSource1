...
## Example  
 This function shows the address of each section along with any associated symbols. See the [IDiaEnumSectionContribs](../vs140/idiaenumsectioncontribs.md) interface to see how the <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> interface is obtained.  
