...
## Example  
 The following code contrasts the behavior of [Array.scan](../vs140/array.scan--t--state--function--fsharp-.md) and <CodeContentPlaceHolder>8\</CodeContentPlaceHolder>.  
