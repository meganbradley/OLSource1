...
Retrieves the value of the policy key supplied as the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> parameter.  
...
## Return Value  
 If the key specified by the <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> parameter is supported, the policy value for the key cast to an <CodeContentPlaceHolder>4\</CodeContentPlaceHolder>.  
