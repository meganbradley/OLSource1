...
## In This Section  
 ...
 Describes the Win32 <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> function and provides a link to its reference topic in the Platform SDK. Also describes the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> intrinsic.  
  
 [C/C++ Assertions](../vs140/c-c---assertions.md)  
 Discusses assertion statements, how they work, the benefits of using them (catching logic errors, checking results of an operation, and testing error conditions), their interaction with <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>, and the types of assertions supported in [!INCLUDE[vsprvs](../vs140/includes/vsprvs_md.md)].  
