...
---
# IAtlStringMgr Class
This class represents the interface to a             <CodeContentPlaceHolder>6\</CodeContentPlaceHolder> memory manager.  
...
|[Clone](#iatlstringmgr__clone)|Call this method to return a pointer to a new string manager for use with another instance of                                         <CodeContentPlaceHolder>7\</CodeContentPlaceHolder>.|  
|[Free](#iatlstringmgr__free)|Call this method to free a string data structure.|  
|[GetNilString](#iatlstringmgr__getnilstring)|Returns a pointer to the                                         <CodeContentPlaceHolder>8\</CodeContentPlaceHolder> object used by empty string objects.|  
...
##  \<a name="iatlstringmgr__clone">\</a>  IAtlStringMgr::Clone  
 Returns a pointer to a new string manager for use with another instance of                 <CodeContentPlaceHolder>11\</CodeContentPlaceHolder>.  
  
<CodeContentPlaceHolder>2\</CodeContentPlaceHolder>  
### Return Value  
 Returns a copy of the                         <CodeContentPlaceHolder>12\</CodeContentPlaceHolder> object.  
...
### Remarks  
 ...
 However, if the memory manager does not support being used by multiple instances of                         <CodeContentPlaceHolder>13\</CodeContentPlaceHolder>, a pointer to a sharable string manager should be returned.  
...
### Return Value  
 A pointer to the                         <CodeContentPlaceHolder>15\</CodeContentPlaceHolder> object used to represent an empty string.  
...
### Remarks  
 Call this function to resize the existing memory block specified by                         <CodeContentPlaceHolder>19\</CodeContentPlaceHolder>.  
