...
|Member|Description|  
|------------|-----------------|  
|[AllowIntoPattern](../vs140/customoperationattribute.allowintopattern-property--fsharp-.md) : [bool](../vs140/core.bool-type-abbreviation--fsharp-.md) with get, set|Indicates if the custom operation supports the use of <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> immediately after the use of the operation in a query or other computation expression to consume the results of the operation.|  
