...
|**Name**|Application-specific information that was set on the object by using the Direct3D function <CodeContentPlaceHolder>0\</CodeContentPlaceHolder>—typically to provide additional identifying information about an object.|  
...
|**bool**|A Boolean (<CodeContentPlaceHolder>1\</CodeContentPlaceHolder> or <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>) value. Each Boolean value is represented by a 32-bit value.|  
