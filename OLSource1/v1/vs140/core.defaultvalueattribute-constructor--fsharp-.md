...
#### Parameters  
 ...
 Indicates whether to assert that the field type supports <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>.  
  
## Return Value  
 A new <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> instance.  
