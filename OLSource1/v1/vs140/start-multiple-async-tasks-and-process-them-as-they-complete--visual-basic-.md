...
By using [Task.WhenAny](assetId:///M:System.Threading.Tasks.Task.WhenAny(System.Threading.Tasks.Task[])?qualifyHint=True&autoUpgrade=True), you can start multiple tasks at the same time and process them one by one as they’re completed rather than process them in the order in which they're started.  
