...
## Remarks  
 [IWorkerThreadClient::Execute](../vs140/iworkerthreadclient--execute.md) will be called through <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> when the timer is signaled.  
  
 Pass the timer handle from <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> to [CWorkerThread::RemoveHandle](../vs140/cworkerthread--removehandle.md) to close the timer.  
