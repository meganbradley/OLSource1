...
## Example  
 The following code example shows how to use the <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> method.  
  
 [!code[FsMaps#2](../vs140/codesnippet/FSharp/map.add--key--value--method--fsharp-_1.fs)]  
