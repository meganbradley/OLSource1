...
## Remarks  
 To compare row handles, this method casts the **HROW** handles to **RowClass** members and calls <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> on the pointers.  
