...
---
# CMFCRibbonButtonsGroup::SetParentCategory
Sets the parent <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> of the <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> object and all the buttons within it.  
