...
|`_tfdopen`|`_fdopen`|`_fdopen`|`_wfdopen`|  
 ...
 Valid characters for the `mode` string used in `fopen` and `_fdopen` correspond to `oflag` arguments used in [_open](../vs140/_open--_wopen.md) and [_sopen](../vs140/_sopen--_wsopen.md), as follows.  
