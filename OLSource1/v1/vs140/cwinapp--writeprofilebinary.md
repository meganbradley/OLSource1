...
## Example  
 This example uses <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> to get at the CWinApp class illustrating a way that <CodeContentPlaceHolder>6\</CodeContentPlaceHolder> and <CodeContentPlaceHolder>7\</CodeContentPlaceHolder> can be used from any function in an MFC application.  
