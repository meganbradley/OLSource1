 ...
 *status*  
 [in] The <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> status of the specified parameter. For information on <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> values, see [Status](https://msdn.microsoft.com/en-us/library/ms722617.aspx) in the *OLE DB Programmer's Reference*, or search for <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> in oledb.h.  
