...
## Remarks  
 You must open the data source object using [CDataSource::Open](../vs140/cdatasource--open.md) before passing it to <CodeContentPlaceHolder>4\</CodeContentPlaceHolder>.  
