...
## Members  
 dwID  
 An ID to differentiate multiple viewers or visualizers implemented by one <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>.  
 ...
 bstrMetric  
 Metric under which the custom viewer or type visualizer <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> is stored.  
