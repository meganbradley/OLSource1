...
> [!NOTE]
>  In certain situations, using <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> can be inefficient, as the following code example illustrates:  
  
 [!code[NVC_MFCDatabase#5](../vs140/codesnippet/CPP/cdaorecordset--isfieldnull_1.cpp)]  
  
> [!NOTE]
>  If you are using dynamic record binding, without deriving from <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>, be sure to use **VT_NULL** as shown in the example.  
