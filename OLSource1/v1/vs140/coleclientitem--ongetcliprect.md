...
---
# COleClientItem::OnGetClipRect
The framework calls the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> member function to get the clipping-rectangle coordinates of the item that is being edited in place.  
