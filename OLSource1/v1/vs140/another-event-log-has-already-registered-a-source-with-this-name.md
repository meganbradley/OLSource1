...
1.  Remove the association of the source with the first log using the [DeleteEventSource](assetId:///M:System.Diagnostics.EventLog.DeleteEventSource(System.String)?qualifyHint=False&autoUpgrade=True) or the [DeleteEventSource](assetId:///M:System.Diagnostics.EventLog.DeleteEventSource(System.String,System.String)?qualifyHint=False&autoUpgrade=True) method.  
