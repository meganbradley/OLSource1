...
## In This Section  
 ...
 [Walkthrough: Dynamically Adding Menu Items](../vs140/dynamically-adding-menu-items.md)  
 Demonstrates how to add menu items dynamically.  
  
 [Implementing a Context Menu in a Tool Window](../vs140/adding-a-shortcut-menu-in-a-tool-window.md)  
