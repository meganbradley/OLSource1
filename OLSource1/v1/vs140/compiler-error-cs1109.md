...
## Example  
 The following example generates CS1109 because the class <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> is nested inside the class <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>:  
