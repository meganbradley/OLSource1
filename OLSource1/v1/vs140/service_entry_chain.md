...
---
# SERVICE_ENTRY_CHAIN
Instructs [IServiceProviderImpl::QueryService](../vs140/iserviceproviderimpl--queryservice.md) to chain to the object specified by <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>.  
