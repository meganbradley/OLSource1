...
|Title|Description|  
|-----------|-----------------|  
|[VSIXLanguagePack Element](../vs140/vsixlanguagepack-element--vsix-language-pack-schema-.md)|Defines the root element of a VSIX manifest for a language pack.\<br />\<br /> The <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> and <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> elements are children of this element.|  
