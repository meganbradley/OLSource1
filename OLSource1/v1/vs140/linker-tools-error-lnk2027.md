...
-   If the module is a safe .netmodule, pass the module directly to the linker.  
 ...
 For more information, see [/ASSEMBLYMODULE (Add a MSIL Module to the Assembly)](../vs140/-assemblymodule--add-a-msil-module-to-the-assembly-.md) and [.netmodule Files as Linker Input](../vs140/.netmodule-files-as-linker-input.md).