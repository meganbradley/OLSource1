...
## Return Value  
 <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> if a floating mini frame window can be closed. <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> otherwise.  
