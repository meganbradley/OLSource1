...
<CodeContentPlaceHolder>0\</CodeContentPlaceHolder>  
 For more information about how to protect critical sections with <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> and <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>, see [Multithreading: How To Use the Synchronization Classes](../vs140/multithreading--how-to-use-the-synchronization-classes.md).  
  
 You must also verify that any methods you override (such as <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>) are thread-safe.  
