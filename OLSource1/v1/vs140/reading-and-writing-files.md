...
If you've used the C run-time library file-handling functions, MFC reading and writing operations will appear familiar. This article describes reading directly from and writing directly to a <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> object. You can also do buffered file I/O with the [CArchive](../vs140/carchive-class.md) class.  
...
2.  The <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> member function is also available for moving to a specific offset within the file.  
