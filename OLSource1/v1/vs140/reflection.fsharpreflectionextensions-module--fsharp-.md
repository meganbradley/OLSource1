...
## Remarks  
 The .NET portable library does not have the <xref:System.Reflection.BindingFlags?qualifyHint=False> type, so these methods provide alternative versions of certain methods on the [FSharpType](../vs140/reflection.fsharptype-class--fsharp-.md) and [FSharpValue](../vs140/reflection.fsharpvalue-class--fsharp-.md) types that take a `bool` as a parameter instead of <xref:System.Reflection.BindingFlags?qualifyHint=False>. For other methods, use the [FSharpType](../vs140/reflection.fsharptype-class--fsharp-.md) and [FSharpValue](../vs140/reflection.fsharpvalue-class--fsharp-.md) types directly.  
