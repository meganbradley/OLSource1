...
1.  Check the spelling of the interface name in the <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> statement.  
  
2.  If you do not intend to inherit from a different interface, remove the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> statement entirely.  
