...
An assignment statement uses <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> to assign the address of a generic extension method to a delegate, but it does not supply any type arguments to the extension method.  
...
-   In the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> expression, specify the type arguments for the extension method.  
