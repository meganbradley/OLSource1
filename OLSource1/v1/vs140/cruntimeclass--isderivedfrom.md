...
#### Parameters  
 *pBaseClass*  
 The familiar name of a class derived from <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>.  
  
## Return Value  
 **TRUE** if the class calling <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> is derived from the base class whose <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> structure is given as a parameter; otherwise **FALSE**.  
...
> [!NOTE]
>  To use the <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> structure, you must include the <CodeContentPlaceHolder>5\</CodeContentPlaceHolder>, <CodeContentPlaceHolder>6\</CodeContentPlaceHolder>, or <CodeContentPlaceHolder>7\</CodeContentPlaceHolder> macro in the implementation of the class for which you want to retrieve run-time object information.  
  
 For more information on using <CodeContentPlaceHolder>8\</CodeContentPlaceHolder>, see the article [CObject Class: Accessing Run-Time Class Information](../vs140/accessing-run-time-class-information.md).  
