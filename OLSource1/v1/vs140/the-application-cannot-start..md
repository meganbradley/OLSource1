...
2.  In the **Open** text box, type <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> and click **OK**.  
...
2.  In the **Open** text box, type <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> and click **OK**.  
