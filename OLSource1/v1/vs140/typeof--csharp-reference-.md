...
---
# typeof (C# Reference)
Used to obtain the <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> object for a type. A <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> expression takes the following form:  
