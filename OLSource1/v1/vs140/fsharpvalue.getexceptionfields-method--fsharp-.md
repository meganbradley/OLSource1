...
#### Parameters  
 ...
 `bindingFlags`  
 Type: <xref:System.Reflection.BindingFlags?qualifyHint=False>[option](../vs140/core.option--t--union--fsharp-.md)  
...
|Exception|Condition|  
|---------------|---------------|  
|<xref:System.ArgumentException?qualifyHint=False>|Thrown when the input type is not an F# exception.|  
