...
This attribute is used to adjust the runtime representation for a type. For example, it may be used to note that the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> representation may be used for a type. This affects how some constructs are compiled.  
