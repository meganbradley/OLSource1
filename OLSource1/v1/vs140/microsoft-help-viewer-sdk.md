...
-   METHOD: this will become the keyword that gets passed through.  
 ...
 For example, given a custom library called CustomLibrary and a method called MyTestMethod, when an F1 request comes in it will be formatted as <CodeContentPlaceHolder>15\</CodeContentPlaceHolder>.  
