...
## Remarks  
 In debug builds, an ATLASSERT will be raised if <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> exceeds the number of elements in the array. In release builds, an invalid argument may lead to unpredictable behavior.  
