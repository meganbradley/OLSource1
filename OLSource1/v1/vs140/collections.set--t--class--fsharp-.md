...
|[IsProperSubsetOf](../vs140/set.ispropersubsetof--t--method--fsharp-.md)|Evaluates to <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> if all elements of the first set are in the second, and at least one element of the second is not in the first.|  
|[IsProperSupersetOf](../vs140/set.ispropersupersetof--t--method--fsharp-.md)|Evaluates to <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> if all elements of the second set are in the first, and at least one element of the first is not in the second.|  
|[IsSubsetOf](../vs140/set.issubsetof--t--method--fsharp-.md)|Evaluates to <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> if all elements of the first set are in the second.|  
|[IsSupersetOf](../vs140/set.issupersetof--t--method--fsharp-.md)|Evaluates to <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> if all elements of the second set are in the first.|  
