...
## Description  
 This method is provided as a convenient way to obtain a window handle (`HWND`) for a \<xref:System.Windows.Forms.UserControl*> control, rather than performing a series of casts on a managed object, such as:  
