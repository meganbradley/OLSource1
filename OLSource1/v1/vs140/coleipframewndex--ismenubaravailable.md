...
---
# COleIPFrameWndEx::IsMenuBarAvailable
Determines whether the pointer to the menu bar object is not <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>  
...
## Remarks  
 Call this method to determine whether the frame window maintains a non-<CodeContentPlaceHolder>2\</CodeContentPlaceHolder> pointer to its menu bar object.  
