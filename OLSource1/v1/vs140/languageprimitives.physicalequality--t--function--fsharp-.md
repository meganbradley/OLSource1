...
## Return Value  
 `true` if boxed versions of the inputs are reference-equal, or if both are primitive numeric types and the implementation of [Equals](assetId:///M:System.Object.Equals(System.Object)?qualifyHint=False&autoUpgrade=True) for the type of the first argument returns `true` on the boxed version of the inputs.  
