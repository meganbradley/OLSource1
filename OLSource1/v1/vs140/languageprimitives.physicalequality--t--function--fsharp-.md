...
## Return Value  
 <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> if boxed versions of the inputs are reference-equal, or if both are primitive numeric types and the implementation of \<xref:System.Object.Equals*> for the type of the first argument returns <CodeContentPlaceHolder>6\</CodeContentPlaceHolder> on the boxed version of the inputs.  
