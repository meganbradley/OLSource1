...
The body of a lambda expression must be an expression that calculates and returns a single value. No statements are permitted, including <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> statements.  
