...
#### Parameters  
 ...
 <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> for the number of images in the large image list; <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> for the number of images in the small image list.  
