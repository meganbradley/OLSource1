...
## Remarks  
 Used as the <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> member of the [EXCEPTION_INFO](../vs140/exception_info.md) structure to indicate the state of the exception and what can be done about it.  
