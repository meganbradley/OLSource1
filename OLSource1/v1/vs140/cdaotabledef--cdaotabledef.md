...
## Remarks  
 After constructing the object, you must call the [Create](../vs140/cdaotabledef--create.md) or [Open](../vs140/cdaotabledef--open.md) member function. When you finish with the object, you must call its [Close](../vs140/cdaotabledef--close.md) member function and destroy the <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> object.  
