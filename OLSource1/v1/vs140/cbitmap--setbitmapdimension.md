...
## Return Value  
 The previous bitmap dimensions. Height is in the **cy** member variable of the <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> object, and width is in the **cx** member variable.  
