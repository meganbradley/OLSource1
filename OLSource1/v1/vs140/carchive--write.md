...
## Remarks  
 ...
 You can use the **Write** member function within your <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> function to write ordinary structures that are contained in your objects.  
