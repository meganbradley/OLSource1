...
## Remarks  
 ...
 If the **InputIterator** satisfies the requirements for a bidirectional iterator type, then <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> may be negative. If **InputIterator** is an input or forward iterator type, <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> must be nonnegative.  
