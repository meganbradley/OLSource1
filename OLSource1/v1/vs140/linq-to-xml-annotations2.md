...
Annotations in [!INCLUDE[sqltecxlinq](../vs140/includes/sqltecxlinq_md.md)] enable you to associate any arbitrary object of any arbitrary type with any XML component in an XML tree.  
 ...
 To add an annotation to an XML component, such as an <xref:System.Xml.Linq.XElement*> or <xref:System.Xml.Linq.XAttribute*>, you call the [AddAnnotation](assetId:///M:System.Xml.Linq.XObject.AddAnnotation(System.Object)?qualifyHint=False&autoUpgrade=True) method. You retrieve annotations by type.  
...
|Method|Description|  
|------------|-----------------|  
|assetId:///M:System.Xml.Linq.XObject.AddAnnotation(System.Object)?qualifyHint=False&autoUpgrade=True|Adds an object to the annotation list of an <xref:System.Xml.Linq.XObject*>.|  
