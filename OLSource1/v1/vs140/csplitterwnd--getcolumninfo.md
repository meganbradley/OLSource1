 ...
 *cxCur*  
 A reference to an <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> to be set to the current width of the column.  
  
 <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>  
 A reference to an <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> to be set to the current minimum width of the column.  
