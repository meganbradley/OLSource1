...
You can improve the performance of the async solution in [Walkthrough: Accessing the Web by Using async and await (C#)](../vs140/walkthrough--accessing-the-web-by-using-async-and-await--csharp-.md) by using the <xref:System.Threading.Tasks.Task.WhenAll?qualifyHint=True> method. This method asynchronously awaits multiple asynchronous operations, which are represented as a collection of tasks.  
