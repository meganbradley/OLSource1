...
#### Parameters  
 ...
 An rvalue reference to a <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> object.  
  
## Return Value  
 Returns <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>.  
  
## Remarks  
 The member operator replaces the contents of the object by using the contents of <CodeContentPlaceHolder>4\</CodeContentPlaceHolder>, treated as an rvalue reference. For more information, see [Lvalues and Rvalues](../vs140/lvalues-and-rvalues--visual-c---.md).  
