...
## Return Value  
 Returns the number of bytes required to hold a **TOKEN_PRIVILEGES** structure represented by the <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> object, including all of the privilege entries it contains.  
