...
## Remarks  
 By default, the text color for active tabs is <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>. You can change the text color with the method [CMFCBaseTabCtrl::SetActiveTabTextColor](../vs140/cmfcbasetabctrl--setactivetabtextcolor.md).  
