...
## Remarks  
 The <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> object can be created using an existing <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> object, or expressed as a 64-bit value. The default constructor sets the time span to 0.  
