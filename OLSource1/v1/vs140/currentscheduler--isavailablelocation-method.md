...
## Return Value  
 An indication of whether or not the location specified by the <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> argument is available on the current scheduler.  
