...
-   <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> Returns the bounding rectangle of the entire item, including the icon and label.  
  
-   <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> Returns the bounding rectangle of the icon or small icon.  
  
-   <CodeContentPlaceHolder>6\</CodeContentPlaceHolder> Returns the bounding rectangle of the item text.  
