...
## Return Value  
 <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> if the accelerator supports CPU shared memory; otherwise, <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>.  
