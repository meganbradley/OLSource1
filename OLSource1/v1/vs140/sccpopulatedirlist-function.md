...
#### Parameters  
 ...
 nDirs  
 [in] Number of directory paths in the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> array.  
  
 lpDirPaths  
 [in] Array of directory paths to examine.  
  
 pfnPopulate  
 [in] Callback function to call for each directory path and (optionally) filename in <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> (see [POPDIRLISTFUNC](../vs140/popdirlistfunc.md) for details).  
