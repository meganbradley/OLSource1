...
#### Parameters  
 ...
 A pointer to the parent window. The default value is <CodeContentPlaceHolder>5\</CodeContentPlaceHolder>.  
  
 [in] <CodeContentPlaceHolder>6\</CodeContentPlaceHolder>  
 A pointer to the parent window. The default value is <CodeContentPlaceHolder>7\</CodeContentPlaceHolder>.  
