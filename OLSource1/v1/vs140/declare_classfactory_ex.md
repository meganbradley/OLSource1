...
---
# DECLARE_CLASSFACTORY_EX
Declares <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> to be the class factory.  
...
## Remarks  
 The <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> parameter must derive from [CComClassFactory](../vs140/ccomclassfactory-class.md) and override the <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> method.  
  
 [CComCoClass](../vs140/ccomcoclass-class.md) includes the [DECLARE_CLASSFACTORY](../vs140/declare_classfactory.md) macro, which specifies <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> as the default class factory. However, by including the <CodeContentPlaceHolder>6\</CodeContentPlaceHolder> macro in your object's class definition, you override this default.  
