...
-   –1, if the encoding of sequences of type <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> is state dependent.  
...
## Example  
 See the example for [encoding](../vs140/codecvt--encoding.md), which calls <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>.  
