...
Consumes a message previously offered by the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> and reserved by the target, transferring ownership to the caller.  
