...
Applies the given function to successive elements, returning the first result where the function returns a <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> value.  
