...
## In This Section  
 [Performance Rules by ID](../vs140/performance-rules-by-id.md)  
  
 The Profiling Tools performance rules are organized in four categories:  
  
|||  
|-|-|  
|[.NET Framework Usage Performance Rules](../vs140/.net-framework-usage-performance-rules.md)|Rules that help you use the .NET Framework efficiently.|  
...
|[Profiling Tools Usage Rules](../vs140/profiling-tools-usage-rules.md)|Rules that help you use the Profiling Tools efficiently.|  
