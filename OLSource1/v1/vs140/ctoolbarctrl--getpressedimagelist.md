...
## Return Value  
 Pointer to a [CImageList](../vs140/cimagelist-class.md) that contains the image list for the current control, or <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> if no such image list is set.  
