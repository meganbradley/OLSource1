...
## Remarks  
 The value of the <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> parameter can be one of the following <CodeContentPlaceHolder>4\</CodeContentPlaceHolder>enumerations.  
