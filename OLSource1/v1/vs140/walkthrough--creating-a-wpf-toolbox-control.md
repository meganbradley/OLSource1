...
3.  In the **Name** box, type the name you want to use for the project. (This walkthrough uses the name <CodeContentPlaceHolder>0\</CodeContentPlaceHolder>.) Click **OK**.  
...
4.  In the **XAML** pane, set the height of the <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> elements and the width of the <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> elements to <CodeContentPlaceHolder>4\</CodeContentPlaceHolder>.  
  
5.  Edit the markup for the button and the two labels to resemble the following example.  
  
     [!code[ToolboxControlWPF#11](../vs140/codesnippet/Xaml/walkthrough--creating-a-wpf-toolbox-control_1.xaml)]  
  
     The <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> and <CodeContentPlaceHolder>6\</CodeContentPlaceHolder> attributes set the position of the elements on the grid. The <CodeContentPlaceHolder>7\</CodeContentPlaceHolder> attribute on the button enables the first column to be resized independently of the width of the button.  
  
     The <CodeContentPlaceHolder>8\</CodeContentPlaceHolder> attributes of the labels use a <CodeContentPlaceHolder>9\</CodeContentPlaceHolder> syntax to bind to properties that you will define later in the walkthrough.  
  
### Coding the User Control  
 The <CodeContentPlaceHolder>10\</CodeContentPlaceHolder> control will expose a method to increment the counter, an event to be raised whenever the counter is incremented, a <CodeContentPlaceHolder>11\</CodeContentPlaceHolder> button, and three properties to store the current count, the display text, and whether to show or hide the <CodeContentPlaceHolder>12\</CodeContentPlaceHolder> button. The <CodeContentPlaceHolder>13\</CodeContentPlaceHolder> attribute determines where in the **Toolbox** the <CodeContentPlaceHolder>14\</CodeContentPlaceHolder> control will appear.  
...
2.  At the top of the file, add a <CodeContentPlaceHolder>15\</CodeContentPlaceHolder> directive for the \<xref:System.ComponentModel*> namespace.  
  
3.  After the generated class, create a public class to define the data context.  
  
     [!code[ToolboxControlWPF#01](../vs140/codesnippet/CSharp/walkthrough--creating-a-wpf-toolbox-control_2.cs)]  
...
4.  Right-click the \<xref:System.ComponentModel.INotifyPropertyChanged*> interface declaration, click **Implement Interface**, and then click **Implement Interface** again.  
     ...
     Visual Studio declares a <CodeContentPlaceHolder>16\</CodeContentPlaceHolder> event.  
  
5.  After the event declaration, create the following private method to raise the event.  
  
     [!code[ToolboxControlWPF#02](../vs140/codesnippet/CSharp/walkthrough--creating-a-wpf-toolbox-control_3.cs)]  
  
6.  Create the following private fields and public properties to hold the values of the two labels in the control.  
  
     [!code[ToolboxControlWPF#03](../vs140/codesnippet/CSharp/walkthrough--creating-a-wpf-toolbox-control_4.cs)]  
  
     Raising the <CodeContentPlaceHolder>17\</CodeContentPlaceHolder> event causes the XAML binding to update the content of the bound controls. Setting the properties as <CodeContentPlaceHolder>18\</CodeContentPlaceHolder> makes them available to the designer, but not to other programs unless they bind to this data context.  
...
1.  At the definition of the partial class that implements the control, right-click the class name, click **Refactor**, click **Rename**, and then change the name of the class to <CodeContentPlaceHolder>19\</CodeContentPlaceHolder>. This is the name that will be displayed in the **Toolbox** when the extension is installed.  
  
2.  Immediately above the class definition, in the <CodeContentPlaceHolder>20\</CodeContentPlaceHolder> attribute declaration, change the value of the first parameter from <CodeContentPlaceHolder>21\</CodeContentPlaceHolder> to <CodeContentPlaceHolder>22\</CodeContentPlaceHolder>. This sets the name of the item group that will host the control in the **Toolbox**.  
  
     The following example shows the <CodeContentPlaceHolder>23\</CodeContentPlaceHolder> attribute and the adjusted class definition.  
  
     [!code[ToolboxControlWPF#04](../vs140/codesnippet/CSharp/walkthrough--creating-a-wpf-toolbox-control_5.cs)]  
  
3.  Create a private field to hold the data context for the control, and then in the constructor, assign the data context to the <CodeContentPlaceHolder>24\</CodeContentPlaceHolder> class, as shown in the following example.  
  
     [!code[ToolboxControlWPF#05](../vs140/codesnippet/CSharp/walkthrough--creating-a-wpf-toolbox-control_6.cs)]  
  
4.  Create the following public properties to mirror the <CodeContentPlaceHolder>25\</CodeContentPlaceHolder> and <CodeContentPlaceHolder>26\</CodeContentPlaceHolder> properties from the data context.  
  
     [!code[ToolboxControlWPF#06](../vs140/codesnippet/CSharp/walkthrough--creating-a-wpf-toolbox-control_7.cs)]  
...
5.  Create the following public method to increment the counter, and an event to notify the hosting application.  
     ...
     [!code[ToolboxControlWPF#07](../vs140/codesnippet/CSharp/walkthrough--creating-a-wpf-toolbox-control_8.cs)]  
  
6.  Implement the click handler for the <CodeContentPlaceHolder>27\</CodeContentPlaceHolder> button as follows.  
  
     [!code[ToolboxControlWPF#08](../vs140/codesnippet/CSharp/walkthrough--creating-a-wpf-toolbox-control_9.cs)]  
  
7.  Add the following public property to show or hide the <CodeContentPlaceHolder>28\</CodeContentPlaceHolder> button.  
  
     [!code[ToolboxControlWPF#09](../vs140/codesnippet/CSharp/walkthrough--creating-a-wpf-toolbox-control_10.cs)]  
...
4.  From the **General** section of the **Toolbox**, drag a **Counter** control to your form, and then select it.  
     ...
     The <CodeContentPlaceHolder>29\</CodeContentPlaceHolder> and <CodeContentPlaceHolder>30\</CodeContentPlaceHolder> properties should be displayed in the **Properties** window, together with the other properties inherited from \<xref:System.Windows.Controls.UserControl*>. The <CodeContentPlaceHolder>31\</CodeContentPlaceHolder> property should not be displayed because it is read-only.  
  
5.  Change the value of the <CodeContentPlaceHolder>32\</CodeContentPlaceHolder> property.  
  
     The label text that is displayed in the designer should change.  
  
6.  Set the <CodeContentPlaceHolder>33\</CodeContentPlaceHolder> property to <CodeContentPlaceHolder>34\</CodeContentPlaceHolder>, and then set it back to <CodeContentPlaceHolder>35\</CodeContentPlaceHolder>.  
  
     The <CodeContentPlaceHolder>36\</CodeContentPlaceHolder> button on the control should disappear and then re-appear.  
  
7.  Drag a \<xref:System.Windows.Controls.Button*> control to the form, set its <CodeContentPlaceHolder>37\</CodeContentPlaceHolder>attribute to <CodeContentPlaceHolder>38\</CodeContentPlaceHolder>, and then double-click the button to open its click handler in code view.  
  
8.  Implement the click handler to call the <CodeContentPlaceHolder>39\</CodeContentPlaceHolder> method of the control.  
  
     [!code[ToolboxControlWPF#21](../vs140/codesnippet/CSharp/walkthrough--creating-a-wpf-toolbox-control_11.cs)]  
  
9. In the constructor function, after the call to <CodeContentPlaceHolder>40\</CodeContentPlaceHolder>, type <CodeContentPlaceHolder>41\</CodeContentPlaceHolder>, and then press the TAB key twice to generate a handler for the <CodeContentPlaceHolder>42\</CodeContentPlaceHolder> event.  
  
10. Implement the new handler as shown in the following example.  
  
     [!code[ToolboxControlWPF#22](../vs140/codesnippet/CSharp/walkthrough--creating-a-wpf-toolbox-control_12.cs)]  
...
## See Also  
 ...
 [Walkthrough: Creating a Windows Forms Toolbox Control](../vs140/creating-a-windows-forms-toolbox-control.md)   
 ...
 [Control Authoring Overview](assetId:///3d864748-cff0-4e63-9b23-d8e5a635b28f)