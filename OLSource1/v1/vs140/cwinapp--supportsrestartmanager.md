...
## Return Value  
 <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> indicates the application supports the restart manager; <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> indicates the application does not.  
