...
1.  Insert this code in the <xref:Microsoft.VisualStudio.Shell.Package.Initialize*> method or in any other method except the VSPackage constructor:  
    ...
    ```  
     ...
     This code gets the <xref:Microsoft.VisualStudio.Shell.Interop.SVsActivityLog*> service and casts it to an <xref:Microsoft.VisualStudio.Shell.Interop.IVsActivityLog*> interface. [LogEntry](assetId:///M:Microsoft.VisualStudio.Shell.Interop.IVsActivityLog.LogEntry(System.UInt32,System.String,System.String)?qualifyHint=False&autoUpgrade=True) writes an informational entry into the activity log using the current cultural context.  
