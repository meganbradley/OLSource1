...
## Return Value  
 An RGB (red, green, blue) color value that defines the solid color closest to the <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> value that the device can represent.  
