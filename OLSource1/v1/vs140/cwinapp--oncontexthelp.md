...
## Remarks  
 You must add an <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> statement to your <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> class message map and also add an accelerator table entry, typically SHIFT+F1, to enable this member function.  
