...
1.  Set the `pfDisplay` parameter in [DisplayChildProperties](assetId:///M:Microsoft.VisualStudio.Shell.Interop.IVsPerPropertyBrowsing.DisplayChildProperties(System.Int32,System.Int32@)?qualifyHint=False&autoUpgrade=True) to `FALSE`.  
  
2.  Set the `pfHide` parameter in [HideProperty](assetId:///M:Microsoft.VisualStudio.Shell.Interop.IVsPerPropertyBrowsing.HideProperty(System.Int32,System.Int32@)?qualifyHint=False&autoUpgrade=True) to `TRUE`.  
