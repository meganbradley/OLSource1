...
1.  Set the <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> parameter in \<xref:Microsoft.VisualStudio.Shell.Interop.IVsPerPropertyBrowsing.DisplayChildProperties*> to <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>.  
  
2.  Set the <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> parameter in \<xref:Microsoft.VisualStudio.Shell.Interop.IVsPerPropertyBrowsing.HideProperty*> to <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>.  
