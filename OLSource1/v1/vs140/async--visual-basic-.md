...
## Return Types  
 An async method is either a [Sub](../vs140/sub-procedures--visual-basic-.md) procedure, or a [Function](../vs140/function-procedures--visual-basic-.md) procedure that has a return type of <xref:System.Threading.Tasks.Task?qualifyHint=False> or <xref:System.Threading.Tasks.Task`1?qualifyHint=False>. The method cannot declare any [ByRef](../vs140/byref--visual-basic-.md) parameters.  
