...
## Return Value  
 <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> if the pane was added to an MDI child window as a tabbed document; otherwise, <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>.  
