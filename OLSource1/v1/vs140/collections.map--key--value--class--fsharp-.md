...
|Member|Description|  
|------------|-----------------|  
|[new](../vs140/collections.map--key--value--constructor--fsharp-.md)|Builds a map that contains the bindings of the given <xref:System.Collections.Generic.IEnumerable`1?qualifyHint=False>.|  
...
|[Item](../vs140/map.item--key--value--property--fsharp-.md)|Lookup an element in the map. Raise <xref:System.Collections.Generic.KeyNotFoundException?qualifyHint=False> if no binding exists in the map.|  
