...
## How to Fix Violations  
 Remove the empty finalizer. If a finalizer is required for debugging, enclose the whole finalizer in <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> directives.  
...
## Example  
 The following example shows an empty finalizer that should be removed, a finalizer that should be enclosed in <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> directives, and a finalizer that uses the <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> directives correctly.  
  
 [!code[FxCop.Performance.RemoveEmptyFinalizers#1](../vs140/codesnippet/CSharp/ca1821--remove-empty-finalizers_1.cs)]