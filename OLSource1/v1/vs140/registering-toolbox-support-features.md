...
-   Providing any <xref:System.Drawing.Design.ToolboxItem?qualifyHint=False> objects to be loaded by the [!INCLUDE[vsprvs](../vs140/includes/vsprvs_md.md)] environment.  
...
|----------|----------|----------|-----------------|  
|`Default Items`|REG_DWORD|Can be any DWORD value. Starting with 1. The value is incremented if you update your VSPackage to supply more or different items.|The value of `Default Items` must be greater than or equal to 1 to add <xref:System.Drawing.Design.ToolboxItem?qualifyHint=False> objects to the [!INCLUDE[vsprvs](../vs140/includes/vsprvs_md.md)] **Toolbox**.<br /><br /> Changing the value of `Default Items` will cause the [!INCLUDE[vsprvs](../vs140/includes/vsprvs_md.md)] IDE to load the most recent instance of a VSPackage providing <xref:System.Drawing.Design.ToolboxItem?qualifyHint=False> objects, rather than using any cached values.<br /><br /> In the Managed Package Framework, `Default Items` is set by the value used in the constructor for the <xref:Microsoft.VisualStudio.Shell.ProvideToolboxItemsAttribute?qualifyHint=False> instance applied to the VSPackage providing <xref:System.Drawing.Design.ToolboxItem?qualifyHint=False> objects.|  
...
## Registering Support for Dynamic Toolbox-Item Configuration  
 ...
 The registry data under HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\VisualStudio\\*<Version\>*\CLSID contains the information the [!INCLUDE[vsprvs](../vs140/includes/vsprvs_md.md)] environment requires to invoke the implementation of <xref:Microsoft.VisualStudio.Shell.IConfigureToolboxItem?qualifyHint=False>.  
