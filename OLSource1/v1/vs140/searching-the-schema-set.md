...
-   Any <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> or <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> attributes that match the specified keyword. This enables you to find elements, attributes, types, and so on by name.  
  
-   The <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> attributes of include statements.  
  
-   The <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> attributes of import statements.  
