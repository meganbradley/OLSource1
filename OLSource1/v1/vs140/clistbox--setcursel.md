...
#### Parameters  
 ...
 Specifies the zero-based index of the string to be selected. If <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> is –1, the list box is set to have no selection.  
  
## Return Value  
 <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> if an error occurs.  
