...
## Return Value  
 <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> if the ribbon panel contains the specified ribbon element; otherwise <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>.  
