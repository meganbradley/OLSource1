...
---
# CDBPropSet Class
Inherits from the **DBPROPSET** structure and adds a constructor that initializes key fields as well as the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> access method.  
...
## Remarks  
 OLE DB providers and consumers use **DBPROPSET** structures to pass arrays of <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> structures. Each <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> structure represents a single property that can be set.  
