...
The <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> function prints to <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> using the given format, and adds a newline.  
...
#### Parameters  
 ...
 Type: [TextWriterFormat](../vs140/printf.textwriterformat--t--type-abbreviation--fsharp-.md)<CodeContentPlaceHolder>4\</CodeContentPlaceHolder>  
...
## Example  
 The following code example demonstrates the use of <CodeContentPlaceHolder>6\</CodeContentPlaceHolder> with various format specifiers. For more information on format specifiers, see [Printf Module](../vs140/core.printf-module--fsharp-.md).  
