...
4.  Now try it out. When you start debugging the project and click **Tools / Invoke FirstCommand**, you should see an instance of Notepad come up.  
     ...
     You can use an instance of the <xref:System.Diagnostics.Process?qualifyHint=False> class to run any executable, not just Notepad. Try it with calc.exe, for example.  
