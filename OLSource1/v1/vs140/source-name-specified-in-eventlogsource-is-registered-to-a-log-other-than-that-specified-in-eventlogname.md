...
-   Make sure the source is registered to the correct log. To do this, use the [CreateEventSource](assetId:///M:System.Diagnostics.EventLog.CreateEventSource(System.String,System.String,System.String)?qualifyHint=False&autoUpgrade=True) method or one of its overloads to specify a string that uniquely identifies your component to the event log.  
