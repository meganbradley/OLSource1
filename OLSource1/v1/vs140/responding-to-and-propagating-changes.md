...
-   **Passing Event Arguments to Rules and Events** Both events and rules are passed an <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> parameter that has information about how the model changed.  
