...
1.  Create a new Windows Application project and add a <xref:System.Windows.Forms.Button?qualifyHint=False> control, a <xref:System.Windows.Forms.CheckBox?qualifyHint=False> control, and a <xref:System.Windows.Forms.RadioButton?qualifyHint=False> control to the form.  
...
## See Also  
 <xref:Microsoft.VisualBasic.Information.TypeName?qualifyHint=False>   
