...
## Implementation  
 ...
 If a DE handles a breakpoint but cannot bind it, it returns an error of type <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>. The debug package responds by displaying an error dialog box, and the IDE places an exclamation glyph inside the breakpoint glyph to the left of the source code line.  
