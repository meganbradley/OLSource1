...
-   Set the [\<fileAssociation> Element](../vs140/clickonce-deployment-manifest.md)<CodeContentPlaceHolder>0\</CodeContentPlaceHolder> attribute to a value that starts with a period character (.), for example, ".doc".  
