...
-   An <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> statement specifying the \<xref:System*> namespace. For more information, see [Imports Statement](../vs140/imports-statement--.net-namespace-and-type-.md).  
...
## Robust Programming  
 ...
 For optimal error control, you might want to enclose the string search in the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> block of a [Try...Catch...Finally Statement (Visual Basic)](../vs140/try...catch...finally-statement--visual-basic-.md) construction.  
