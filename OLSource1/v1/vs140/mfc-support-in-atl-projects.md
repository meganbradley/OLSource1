...
<CodeContentPlaceHolder>0\</CodeContentPlaceHolder>  
 You can view the application object class and its <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> and <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> functions in Class View.  
