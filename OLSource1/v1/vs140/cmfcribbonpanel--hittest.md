...
#### Parameters  
 ...
 <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> to test the ribbon panel caption; otherwise <CodeContentPlaceHolder>4\</CodeContentPlaceHolder>.  
  
## Return Value  
 Pointer to a ribbon element if the specified point is located in it; otherwise <CodeContentPlaceHolder>5\</CodeContentPlaceHolder>.  
