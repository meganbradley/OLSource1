...
## Remarks  
 If the control is windowed, <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> destroys it by calling [DestroyWindow](http://msdn.microsoft.com/library/windows/desktop/ms632682).  
