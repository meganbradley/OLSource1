...
## Remarks  
 You can also use the syntax <CodeContentPlaceHolder>6\</CodeContentPlaceHolder>.  
  
 This function is named <CodeContentPlaceHolder>7\</CodeContentPlaceHolder> in compiled assemblies. If you are accessing the member from a language other than F#, or through reflection, use this name.  
