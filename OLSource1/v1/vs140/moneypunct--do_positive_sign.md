...
## Example  
 See the example for [positive_sign](../vs140/moneypunct--positive_sign.md), where the virtual member function is called by <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>.  
