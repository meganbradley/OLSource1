...
## Return Value  
 The localized name of the currently selected hot key. If there is no selected hot key, <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> returns an empty string.  
