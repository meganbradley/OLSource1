...
## Example  
 In the following example, <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> causes two violations of this rule. <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> corrects the first violation by passing the invariant culture to System.String.Compare, and corrects the second violation by passing the current culture to \<xref:System.String.ToLower*> because <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> is displayed to the user.  
  
 [!code[FxCop.Globalization.CultureInfo#1](../vs140/codesnippet/CSharp/ca1304--specify-cultureinfo_1.cs)]  
...
## Example  
 ...
 [!code[FxCop.Globalization.IFormatProvider#1](../vs140/codesnippet/CSharp/ca1304--specify-cultureinfo_2.cs)]  
...
**06/04/1900 12:15:12**   
## Related Rules  
 [Specify IFormatProvider](../vs140/ca1305--specify-iformatprovider.md)  
