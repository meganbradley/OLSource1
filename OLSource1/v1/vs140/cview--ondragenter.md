...
-   <CodeContentPlaceHolder>10\</CodeContentPlaceHolder> for **MK_ALT** Creates a copy of the dropped object and delete the original object. This is typically the default drop effect, when the view can accept this data object.  
  
 For more information, see the MFC Advanced Concepts sample [OCLIENT](../vs140/visual-c---samples.md).  
  
## Remarks  
 Default implementation is to do nothing and return <CodeContentPlaceHolder>11\</CodeContentPlaceHolder>.  
  
 Override this function to prepare for future calls to the [OnDragOver](../vs140/cview--ondragover.md) member function. Any data required from the data object should be retrieved at this time for later use in the <CodeContentPlaceHolder>12\</CodeContentPlaceHolder> member function. The view should also be updated at this time to give the user visual feedback. For more information, see the article [Drag and Drop: Implementing a Drop Target](../vs140/drag-and-drop--implementing-a-drop-target.md).  
