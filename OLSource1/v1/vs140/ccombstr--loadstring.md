...
---
# CComBSTR::LoadString
Loads a string resource specified by <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> and stores it in this object.  
...
## Remarks  
 The first function loads the resource from the module identified by you via the <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> parameter. The second function loads the resource from the resource module associated with the [CComModule](../vs140/ccommodule-class.md)-derived object used in this project.  
