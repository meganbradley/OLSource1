...
apitype: "Assembly"
f1_keywords: 
  - "Microsoft.FSharp.Control.FSharpMailboxProcessor`1.PostAndReply``1"
dev_langs: 
  - "FSharp"
helpviewer_keywords: 
  - "MailboxProcessor.PostAndReply method [F#]"
  - "PostAndReply method [F#]"
...
## Remarks  
 The message is generated by applying <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> to a new reply channel to be incorporated into the message. The receiving agent must process this message and invoke the <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> method on this reply channel precisely once.  
...
## Example  
 ...
 [!code[FsMailboxProcessor#7](../vs140/codesnippet/FSharp/mailboxprocessor.postandreply--msg--reply--method--fsharp-_1.fs)]  
