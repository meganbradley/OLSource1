...
|`HKEY_LOCAL_MACHINE\   SOFTWARE\     Microsoft\       VisualStudio\         X.Y\           SolutionPersistence\             <PackageName>\`<br /><br /> (Note that the key name, `SourceCodeControl`, is already used by [!INCLUDE[vsprvs](../vs140/includes/vsprvs_md.md)] and is not available as a choice for <PackageName\>.)|(default) = rg_sz:{ID_Package}|  
