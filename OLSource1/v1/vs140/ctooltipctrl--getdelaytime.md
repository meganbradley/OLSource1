...
-   <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> Retrieve the length of time the tool tip window remains visible if the pointer is stationary within a tool's bounding rectangle.  
  
-   <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> Retrieve the length of time the pointer must remain stationary within a tool's bounding rectangle before the tool tip window appears.  
  
-   <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> Retrieve the length of time it takes for subsequent tool tip windows to appear as the pointer moves from one tool to another.  
