...
## Remarks  
 This method removes a group of message handlers, mapped to the command IDs specifed by <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> and <CodeContentPlaceHolder>4\</CodeContentPlaceHolder>, from the command source object.  
