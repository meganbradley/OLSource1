...
---
# CPictureHolder::GetPictureDispatch
This function returns a pointer to the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> object's <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> interface.  
  
## Syntax  
  
<CodeContentPlaceHolder>0\</CodeContentPlaceHolder>  
## Return Value  
 A pointer to the <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> object's <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> interface.  
