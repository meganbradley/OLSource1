...
-   Determine whether this occurred because the <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> URL in the deployment manifest is pointing to a different location than the URL used for activation.  
...
-   Examine the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> URL in the deployment manifest. Ensure that you are updating the bits in the same location that <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> points to.  
