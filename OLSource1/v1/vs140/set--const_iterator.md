...
ms.assetid: 9fa04b9d-c5ab-4cc2-a262-e82b3588235c
...
## Example  
 See the example for [begin](../vs140/set--begin.md) for an example that uses <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>.  
