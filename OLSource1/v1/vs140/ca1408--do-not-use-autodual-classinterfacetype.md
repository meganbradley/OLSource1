...
## Cause  
 A Component Object Model (COM) visible type is marked with the \<xref:System.Runtime.InteropServices.ClassInterfaceAttribute*> attribute set to the <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> value of \<xref:System.Runtime.InteropServices.ClassInterfaceType*>.  
...
## How to Fix Violations  
 To fix a violation of this rule, change the value of the \<xref:System.Runtime.InteropServices.ClassInterfaceAttribute*> attribute to the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> value of \<xref:System.Runtime.InteropServices.ClassInterfaceType*> and explicitly define the interface.  
...
## Example  
 ...
 [!code[FxCop.Interoperability.AutoDual#1](../vs140/codesnippet/CSharp/ca1408--do-not-use-autodual-classinterfacetype_1.cs)]
[!code[FxCop.Interoperability.AutoDual#1](../vs140/codesnippet/VisualBasic/ca1408--do-not-use-autodual-classinterfacetype_1.vb)]  
  
## Related Rules  
 [Auto Layout Types Should Not Be ComVisible](../vs140/ca1403--auto-layout-types-should-not-be-com-visible.md)  
  
 [Mark Com Source Interfaces as IDispatch](../vs140/ca1412--mark-comsource-interfaces-as-idispatch.md)  
