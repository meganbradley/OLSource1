...
The <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> object provides the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> method for reading from binary files.  
  
### To read from a binary file  
  
-   Use the <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> method, which returns the contents of a file as a byte array. This example reads from the file <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>.  
