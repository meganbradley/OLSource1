...
## Remarks  
 The function fills the return array with a bitmask of bits from the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> family (see [Directory Status Code Enumerator](../vs140/directory-status-code-enumerator.md)), one entry for each directory given. The status array is allocated by the caller.  
