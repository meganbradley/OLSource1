...
## Return Value  
 <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> if the Outlook bar tab control is in Outlook 2003 mode; otherwise <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>;  
