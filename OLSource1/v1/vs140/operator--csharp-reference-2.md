...
Use the <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> keyword to overload a built-in operator or to provide a user-defined conversion in a class or struct declaration.  
