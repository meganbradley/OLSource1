...
#### Parameters  
 ...
 A reference to the address of a <CodeContentPlaceHolder>6\</CodeContentPlaceHolder> value that receives the IP address. See **Remarks** for a table that shows how <CodeContentPlaceHolder>7\</CodeContentPlaceHolder> is filled.  
