...
#### Parameters  
 ...
 The type being managed by another <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>, used to initialize the current object.  
  
## Remarks  
 The <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> object can be created using an existing pointer, in which case it transfers ownership of the pointer.  
