 ...
 **Syntax coloring**  
 XSLT keywords, such as <CodeContentPlaceHolder>0\</CodeContentPlaceHolder>, <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>, and so on, are displayed in the XSLT keyword color specified by the **Fonts and Colors** settings.  
