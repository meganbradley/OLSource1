...
#### Parameters  
 ...
 The \<xref:System.IO.TextWriter*> instance that receives the output.  
  
 <CodeContentPlaceHolder>4\</CodeContentPlaceHolder>  
 Type: [TextWriterFormat](../vs140/printf.textwriterformat--t--result--type-abbreviation--fsharp-.md)<CodeContentPlaceHolder>5\</CodeContentPlaceHolder>  
...
## Remarks  
 This function is named <CodeContentPlaceHolder>6\</CodeContentPlaceHolder> in the compiled assemblies. If you are accessing the function from a .NET language other than F#, or through reflection, use this name.  
