...
A partial method cannot have out parameters  
 ...
 A partial method cannot have an [out](../vs140/out--csharp-reference-.md) parameter. Out parameters are not allowed because if the partial method is removed by the compiler then there is no guarantee that the out parameter is ever assigned.  
