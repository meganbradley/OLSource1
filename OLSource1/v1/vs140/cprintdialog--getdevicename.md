...
## Remarks  
 Call this function after calling [DoModal](../vs140/cprintdialog--domodal.md) to retrieve the name of the currently selected printer, or after calling [GetDefaults](../vs140/cprintdialog--getdefaults.md) to retrieve the current device defaults of the default printer. Use a pointer to the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> object returned by <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> as the value of <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> in a call to [CDC::CreateDC](../vs140/cdc--createdc.md).  
