...
The first walkthrough in this series, [Tutorial 1: How to Create a Basic Project System](../vs140/creating-a-basic-project-system--part-1.md), shows how to create a basic project system. This walkthrough builds on the basic project system by adding a Visual Studio template, a property page, and other features. You must complete the first walkthrough before you start this one.  
...
1.  In [!INCLUDE[vsprvs](../vs140/includes/vsprvs_md.md)], open the SimpleProject solution that you created by following [Tutorial 1: How to Create a Basic Project System](../vs140/creating-a-basic-project-system--part-1.md).  
...
-   The \<ProjectType> element names the Project type in the **New Project** dialog box. This name replaces the project name parameter of the ProvideProjectFactory attribute.  
    ...
    > [!NOTE]
    >  The \<ProjectType> element must match the <CodeContentPlaceHolder>15\</CodeContentPlaceHolder> argument of the <CodeContentPlaceHolder>16\</CodeContentPlaceHolder> attribute in the SimpleProjectPackage.cs file.  
...
-   AssemblyInfo.cs  
 ...
 All three files have <CodeContentPlaceHolder>17\</CodeContentPlaceHolder> set to true, which enables parameter substitution.  The Program.cs file has <CodeContentPlaceHolder>18\</CodeContentPlaceHolder> set to true, which causes the file to be opened in the code editor when a project is created.  
  
 For more information about the elements in the Visual Studio Template schema, see the [Visual Studio Template Schema Reference](../vs140/visual-studio-template-schema-reference.md).  
...
2.  A command prompt window appears. When you see the words <CodeContentPlaceHolder>19\</CodeContentPlaceHolder>, click ENTER. After the window closes, open Visual Studio.  
...
5.  You should see a new instance of SimpleProject.  
 ...
 ![](../vs140/media/simpproj2_newproj.png "SimpProj2_NewProj")  
  
 ![](../vs140/media/simpproj2_myproj.png "SimpProj2_MyProj")  
...
5.  . Click **Cancel** and stop debugging  
 ...
 ![](../vs140/media/simpproj2_rollup.png "SimpProj2_Rollup")  
  
 ![](../vs140/media/simpproj2_subfolder.png "SimpProj2_Subfolder")  
  
## Substituting Project Template Parameters  
 [Tutorial 1: How to Create a Basic Project System](../vs140/creating-a-basic-project-system--part-1.md) showed how to overwrite the <CodeContentPlaceHolder>20\</CodeContentPlaceHolder> method to do a basic kind of template parameter substitution. This section teaches how to use the more sophisticated Visual Studio template parameters.  
...
-   $safeprojectname$ is the name provided by a user in the **New Project** dialog box, modified to remove all unsafe characters and spaces.  
 ...
 For a complete list of template parameters, see [Template Parameters](../vs140/template-parameters.md).  If you want to create your own custom template parameter, see [NIB: How to: Pass Custom Parameters to Templates](assetId:///5bc2ad11-84c7-4683-a276-e5e00d85d8fb).  
  
#### To substitute project template parameters  
  
1.  In the SimpleProjectNode.cs file, remove the <CodeContentPlaceHolder>21\</CodeContentPlaceHolder> method.  
...
## Creating a Project Property Page  
 ...
 Derive your property page class from the <CodeContentPlaceHolder>22\</CodeContentPlaceHolder> base class. The properties grid provided by the <CodeContentPlaceHolder>23\</CodeContentPlaceHolder> class is aware of most primitive data types and knows how to display them.  In addition, the <CodeContentPlaceHolder>24\</CodeContentPlaceHolder> class knows how to persist property values to the project file.  
...
1.  In the SimpleProjectPackage.cs file, add this <CodeContentPlaceHolder>25\</CodeContentPlaceHolder> attribute to the <CodeContentPlaceHolder>26\</CodeContentPlaceHolder> class:  
  
<CodeContentPlaceHolder>12\</CodeContentPlaceHolder>  
     This registers the property page class <CodeContentPlaceHolder>27\</CodeContentPlaceHolder> with COM.  
  
2.  In the SimpleProjectNode.cs file, add these two overridden methods to the <CodeContentPlaceHolder>28\</CodeContentPlaceHolder> class:  
...
<CodeContentPlaceHolder>14\</CodeContentPlaceHolder>  
     The <CodeContentPlaceHolder>29\</CodeContentPlaceHolder> class exposes the three public properties AssemblyName, OutputType, and RootNamespace. Because AssemblyName has no set method, it is displayed as a read-only property. OutputType is an enumerated constant, so it appears as dropdown list.  
  
     The <CodeContentPlaceHolder>30\</CodeContentPlaceHolder> base class provides <CodeContentPlaceHolder>31\</CodeContentPlaceHolder> to persist the properties. The <CodeContentPlaceHolder>32\</CodeContentPlaceHolder> method uses <CodeContentPlaceHolder>33\</CodeContentPlaceHolder> to retrieve the persisted property values and set the corresponding properties.  The <CodeContentPlaceHolder>34\</CodeContentPlaceHolder> method uses <CodeContentPlaceHolder>35\</CodeContentPlaceHolder> to get the values of the properties and persist them to the project file. The property set method sets <CodeContentPlaceHolder>36\</CodeContentPlaceHolder> to true to indicate that the properties have to be persisted.  Persistence occurs when you save the project or solution.  
...
8.  Right-click the project node in **Solution Explorer**, and then click **Properties**. The **Property Pages** dialog box is displayed.  
 ...
 ![](../vs140/media/simpproj2_proppage.png "SimpProj2_PropPage")  
...
8.  Close the experimental instance of Visual Studio.  
 ...
 ![](../vs140/media/simpproj2_proppage2.png "SimpProj2_PropPage2")