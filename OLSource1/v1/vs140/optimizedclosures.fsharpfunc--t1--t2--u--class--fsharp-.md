...
|Member|Description|  
|------------|-----------------|  
|[new](../vs140/optimizedclosures.fsharpfunc--t1--t2--u--constructor--fsharp-.md)|Construct an optimized function value that can accept two curried arguments without intervening execution.|  
  
## Instance Members  
  
|Member|Description|  
|------------|-----------------|  
|[Invoke](../vs140/fsharpfunc.invoke--t1--t2--u--method--fsharp-.md)|Invoke the optimized function value with two curried arguments|  
  
## Static Members  
  
|Member|Description|  
|------------|-----------------|  
|[Adapt](../vs140/fsharpfunc.adapt--t1--t2--u--method--fsharp-.md)|Adapt an F# first class function value to be an optimized function value that can accept two curried arguments without intervening execution.|  
