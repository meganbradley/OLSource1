...
-   Defining an item class derived from <CodeContentPlaceHolder>0\</CodeContentPlaceHolder>. For further details on server items, see [Servers: Server Items](../vs140/servers--server-items.md).  
  
-   Changing the base class of the document class to <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>. For further details, see [Servers: Implementing Server Documents](../vs140/servers--implementing-server-documents.md).  
  
-   Defining a frame-window class derived from <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>. For further details, see [Servers: Implementing In-Place Frame Windows](../vs140/servers--implementing-in-place-frame-windows.md).  
