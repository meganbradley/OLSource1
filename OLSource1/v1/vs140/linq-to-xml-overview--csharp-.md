...
-   Manipulate the in-memory XML tree by using methods such as <xref:System.Xml.Linq.XContainer.Add*>, <xref:System.Xml.Linq.XNode.Remove*>, <xref:System.Xml.Linq.XNode.ReplaceWith*>, and [SetValue](assetId:///M:System.Xml.Linq.XElement.SetValue(System.Object)?qualifyHint=False&autoUpgrade=True).  
