...
-   Manipulate the in-memory XML tree by using methods such as <xref:System.Xml.Linq.XContainer.Add?qualifyHint=False>, <xref:System.Xml.Linq.XNode.Remove?qualifyHint=False>, <xref:System.Xml.Linq.XNode.ReplaceWith?qualifyHint=False>, and <xref:System.Xml.Linq.XElement.SetValue?qualifyHint=False>.  
