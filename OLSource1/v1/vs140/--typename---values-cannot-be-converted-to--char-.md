...
'\<typename>' values cannot be converted to Char. Use Microsoft.VisualBasic.ChrW to interpret a numeric value as a Unicode character or first convert it to 'String' to produce a digit.  
 ...
 An expression attempts to convert a data type other than <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> or <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> to <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>.  
  
 **Error ID:** BC32007  
  
### To correct this error  
  
-   Use the <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> function to convert a numeric value to a Unicode character, or first convert the value to <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> and then to <CodeContentPlaceHolder>5\</CodeContentPlaceHolder>.  
