...
## Reference  
 ...
 <xref:Microsoft.VisualBasic.Devices.Ports.SerialPortNames?qualifyHint=False>  
 Describes the `SerialPortNames` property, which gets a collection of the names of the serial ports on the computer.  
  
 <xref:Microsoft.VisualBasic.Devices.Ports.OpenSerialPort?qualifyHint=False>  
 Describes the `OpenSerialPort` method, which creates and opens a <xref:System.IO.Ports.SerialPort?qualifyHint=True> object.  
  
## Related Sections  
 <xref:System.IO.Ports.SerialPort?qualifyHint=False>  
 Describes the .NET Framework <xref:System.IO.Ports.SerialPort?qualifyHint=False> class.