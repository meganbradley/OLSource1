...
The <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> object provides a property and a method for accessing the computer's serial ports.  
...
## Reference  
 ...
 Describes the <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> property, which gets a collection of the names of the serial ports on the computer.  
  
 \<xref:Microsoft.VisualBasic.Devices.Ports.OpenSerialPort*>  
 Describes the <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> method, which creates and opens a \<xref:System.IO.Ports.SerialPort*?displayProperty=fullName> object.  
