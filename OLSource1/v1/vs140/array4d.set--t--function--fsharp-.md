...
apitype: "Assembly"
f1_keywords: 
  - "Microsoft.FSharp.Collections.Array4DModule.Set``1"
dev_langs: 
  - "FSharp"
helpviewer_keywords: 
  - "Array4D.set function [F#]"
  - "set function [F#]"
  - "SetAtIndex function [F#]"
  - "Array4D.SetAtIndex function [F#]"
...
## Remarks  
 You can also use the syntax <CodeContentPlaceHolder>9\</CodeContentPlaceHolder>.  
