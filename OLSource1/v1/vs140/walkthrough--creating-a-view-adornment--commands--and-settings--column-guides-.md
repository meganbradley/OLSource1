...
```  
 ...
 Instances of this class hold onto the associated <xref:Microsoft.VisualStudio.Text.Editor.IWpfTextView?qualifyHint=False> and a list of `Line` objects drawn on the view.  
