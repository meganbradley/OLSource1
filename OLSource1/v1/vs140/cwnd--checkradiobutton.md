...
## Remarks  
 The <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> function sends a [BM_SETCHECK](http://msdn.microsoft.com/library/windows/desktop/bb775989) message to the specified radio button.  
