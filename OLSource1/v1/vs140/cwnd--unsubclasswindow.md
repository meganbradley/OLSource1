...
---
# CWnd::UnsubclassWindow
Call this member function to set **WndProc** back to its original value and detach the window identified by <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> from the **CWnd** object.  
