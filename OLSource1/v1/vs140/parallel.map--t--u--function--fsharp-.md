...
apitype: "Assembly"
f1_keywords: 
  - "Microsoft.FSharp.Collections.ParallelModule.Map``2"
dev_langs: 
  - "FSharp"
helpviewer_keywords: 
  - "map function [F#]"
  - "Parallel.map function [F#]"
...
## Return Value  
 An array whose elements are the result of applying the <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> function to each element of the input array.  
