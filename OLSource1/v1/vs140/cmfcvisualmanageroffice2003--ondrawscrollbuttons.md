...
#### Parameters  
 ...
 <CodeContentPlaceHolder>6\</CodeContentPlaceHolder> if the scroll buttons are highlighted, or <CodeContentPlaceHolder>7\</CodeContentPlaceHolder> if not.  
