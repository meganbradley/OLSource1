...
---
# divides Struct
A predefined function object that performs the division operation ( <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>) on its arguments.  
...
#### Parameters  
 ...
 A type that supports an <CodeContentPlaceHolder>6\</CodeContentPlaceHolder> that takes operands of the specified or inferred types.  
