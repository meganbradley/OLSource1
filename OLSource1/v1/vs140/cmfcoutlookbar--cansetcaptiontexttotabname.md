...
## Return Value  
 <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> if the Outlook bar window caption is automatically set to the text of the active tab; otherwise <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>.  
