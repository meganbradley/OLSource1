...
|---------------|-----------------|  
|[in] <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>|Zero-based index of the first character in the range of text to highlight.|  
|[in] <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>|Zero-based index of the last character in the range of text to highlight.|  
