...
#### Parameters  
 ...
 If <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> is negative, its absolute value will be multiplied by the number of processors in the machine to get the total number of threads.  
  
 If <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> is zero, [ATLS_DEFAULT_THREADSPERPROC](../vs140/atls_default_threadsperproc.md) will be multiplied by the number of processors in the machine to get the total number of threads.  
