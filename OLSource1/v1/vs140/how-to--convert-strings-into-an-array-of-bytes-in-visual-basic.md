...
## Example  
 This example uses the [GetBytes](assetId:///M:System.Text.Encoding.GetBytes(System.String)?qualifyHint=False&autoUpgrade=True) method of the <xref:System.Text.Encoding.Unicode*?displayProperty=fullName> encoding class to convert a string into an array of bytes.  
...
## See Also  
 ...
 assetId:///M:System.Text.Encoding.GetBytes(System.String)?qualifyHint=False&autoUpgrade=True   
