...
---
# CWinApp::LoadStandardCursor
Loads the Windows predefined cursor resource that <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> specifies.  
...
#### Parameters  
 ...
 An **IDC_** manifest constant identifier that specifies a predefined Windows cursor. These identifiers are defined in WINDOWS.H. The following list shows the possible predefined values and meanings for <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>:  
...
## Remarks  
 Use the <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> or [LoadOEMCursor](../vs140/cwinapp--loadoemcursor.md) member function to access the predefined Windows cursors.  
