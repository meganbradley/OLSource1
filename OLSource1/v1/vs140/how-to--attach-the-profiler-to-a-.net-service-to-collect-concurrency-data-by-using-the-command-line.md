...
7.  Attach the profiler to the service. Type:  
     ...
     **VSPerfCmd /attach:** <CodeContentPlaceHolder>9\</CodeContentPlaceHolder> [[/targetclr](../vs140/targetclr.md)**:**<CodeContentPlaceHolder>10\</CodeContentPlaceHolder>]  
  
    -   <CodeContentPlaceHolder>11\</CodeContentPlaceHolder> specifies the process ID or process name of the service. You can view the process IDs of all running processes in Windows Task Manager.  
  
    -   **targetclr:** <CodeContentPlaceHolder>12\</CodeContentPlaceHolder> specifies the version of the common language runtime (CLR) to profile when more than one version of the runtime is loaded in an application. Optional.  
...
-   The following pairs of **VSPerfCmd** options start and stop data collection. Specify each option on a separate command line. You can turn data collection on and off multiple times.  
    ...
    |[/processon](../vs140/processon-and-processoff.md) **:** <CodeContentPlaceHolder>13\</CodeContentPlaceHolder> [/processoff](../vs140/processon-and-processoff.md) **:** <CodeContentPlaceHolder>14\</CodeContentPlaceHolder>|Starts (**/processon**) or stops (**/processoff**) data collection for the process specified by the process ID (<CodeContentPlaceHolder>15\</CodeContentPlaceHolder>).|  
    |**/attach:**{<CodeContentPlaceHolder>16\</CodeContentPlaceHolder>&#124;<CodeContentPlaceHolder>17\</CodeContentPlaceHolder>} [/detach](../vs140/detach.md)[:{<CodeContentPlaceHolder>18\</CodeContentPlaceHolder>&#124;<CodeContentPlaceHolder>19\</CodeContentPlaceHolder>}]|**/attach** starts to collect data for the process specified by the process ID or process name. **/detach** stops data collection for the specified process or for all processes if a specific process is not specified.|  
