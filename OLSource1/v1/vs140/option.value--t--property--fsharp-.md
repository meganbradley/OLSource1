...
Get the value of a <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> option. A \<xref:System.NullReferenceException*> is raised if the option is <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>.  
