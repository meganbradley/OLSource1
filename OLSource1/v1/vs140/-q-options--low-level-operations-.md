...
-   [/QIfist (Suppress _ftol)](../vs140/-qifist--suppress-_ftol-.md): Suppresses <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> when a conversion from a floating-point type to an integer type is required (x86 only).  
  
-   [/Qimprecise_fwaits (Remove fwaits Inside try Blocks)](../vs140/-qimprecise_fwaits--remove-fwaits-inside-try-blocks-.md): Removes <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> commands inside <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> blocks.  
