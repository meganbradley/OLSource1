...
|Name|Description|  
|----------|-----------------|  
|[CButton::CButton](#cbutton__cbutton)|Constructs a <CodeContentPlaceHolder>36\</CodeContentPlaceHolder> object.|  
  
### Public Methods  
  
|Name|Description|  
|----------|-----------------|  
|[CButton::Create](#cbutton__create)|Creates the Windows button control and attaches it to the <CodeContentPlaceHolder>37\</CodeContentPlaceHolder> object.|  
|[CButton::DrawItem](#cbutton__drawitem)|Override to draw an owner-drawn <CodeContentPlaceHolder>38\</CodeContentPlaceHolder> object.|  
...
## Remarks  
 ...
 Typical buttons are the check box, radio button, and pushbutton. A <CodeContentPlaceHolder>39\</CodeContentPlaceHolder> object can become any of these, according to the [button style](../vs140/button-styles.md) specified at its initialization by the [Create](#cbutton__create) member function.  
  
 In addition, the [CBitmapButton](../vs140/cbitmapbutton-class.md) class derived from <CodeContentPlaceHolder>40\</CodeContentPlaceHolder> supports creation of button controls labeled with bitmap images instead of text. A <CodeContentPlaceHolder>41\</CodeContentPlaceHolder> can have separate bitmaps for a button's up, down, focused, and disabled states.  
  
 You can create a button control either from a dialog template or directly in your code. In both cases, first call the constructor <CodeContentPlaceHolder>42\</CodeContentPlaceHolder> to construct the <CodeContentPlaceHolder>43\</CodeContentPlaceHolder> object; then call the **Create** member function to create the Windows button control and attach it to the <CodeContentPlaceHolder>44\</CodeContentPlaceHolder> object.  
  
 Construction can be a one-step process in a class derived from <CodeContentPlaceHolder>45\</CodeContentPlaceHolder>. Write a constructor for the derived class and call **Create** from within the constructor.  
 ...
 **ON_**Notification **(**<CodeContentPlaceHolder>46\</CodeContentPlaceHolder>, <CodeContentPlaceHolder>47\</CodeContentPlaceHolder>**)**  
  
 where <CodeContentPlaceHolder>48\</CodeContentPlaceHolder> specifies the child window ID of the control sending the notification and <CodeContentPlaceHolder>49\</CodeContentPlaceHolder> is the name of the parent member function you have written to handle the notification.  
  
 The parent's function prototype is as follows:  
  
 **afx_msg** <CodeContentPlaceHolder>50\</CodeContentPlaceHolder> <CodeContentPlaceHolder>51\</CodeContentPlaceHolder> **( );**  
...
|**ON_BN_DOUBLECLICKED**|The user double-clicks a button.|  
 ...
 If you create a <CodeContentPlaceHolder>52\</CodeContentPlaceHolder> object from a dialog resource, the <CodeContentPlaceHolder>53\</CodeContentPlaceHolder> object is automatically destroyed when the user closes the dialog box.  
  
 If you create a <CodeContentPlaceHolder>54\</CodeContentPlaceHolder> object within a window, you may need to destroy it. If you create the <CodeContentPlaceHolder>55\</CodeContentPlaceHolder> object on the heap by using the **new** function, you must call **delete** on the object to destroy it when the user closes the Windows button control. If you create the <CodeContentPlaceHolder>56\</CodeContentPlaceHolder> object on the stack, or it is embedded in the parent dialog object, it is destroyed automatically.  
...
##  \<a name="cbutton__create">\</a>  CButton::Create  
 Creates the Windows button control and attaches it to the <CodeContentPlaceHolder>59\</CodeContentPlaceHolder> object.  
...
### Parameters  
 ...
 Specifies the button control's size and position. It can be either a <CodeContentPlaceHolder>63\</CodeContentPlaceHolder> object or a <CodeContentPlaceHolder>64\</CodeContentPlaceHolder> structure.  
  
 <CodeContentPlaceHolder>65\</CodeContentPlaceHolder>  
 Specifies the button control's parent window, usually a <CodeContentPlaceHolder>66\</CodeContentPlaceHolder>. It must not be **NULL**.  
...
### Remarks  
 You construct a <CodeContentPlaceHolder>68\</CodeContentPlaceHolder> object in two steps. First, call the constructor and then call **Create**, which creates the Windows button control and attaches it to the <CodeContentPlaceHolder>69\</CodeContentPlaceHolder> object.  
...
### Remarks  
 An owner-drawn button has the **BS_OWNERDRAW** style set. Override this member function to implement drawing for an owner-drawn <CodeContentPlaceHolder>71\</CodeContentPlaceHolder> object. The application should restore all graphics device interface (GDI) objects selected for the display context supplied in <CodeContentPlaceHolder>72\</CodeContentPlaceHolder> before the member function terminates.  
...
### Return Value  
 Returns the button styles for this <CodeContentPlaceHolder>73\</CodeContentPlaceHolder> object. This function returns only the [BS_](../vs140/button-styles.md) style values, not any of the other window styles.  
...
### Parameters  
 ...
 A pointer to the image list of the <CodeContentPlaceHolder>75\</CodeContentPlaceHolder> object.  
...
|---------------|-----------------|  
|[out] <CodeContentPlaceHolder>76\</CodeContentPlaceHolder>|Pointer to a buffer, which the caller is responsible for allocating and deallocating. If the return value is <CodeContentPlaceHolder>77\</CodeContentPlaceHolder>, the buffer contains the note text that is associated with the current command link control; otherwise, the buffer is unchanged.|  
|[in, out] <CodeContentPlaceHolder>78\</CodeContentPlaceHolder>|A pointer to an unsigned integer variable.\<br />\<br /> When this method is called, the variable contains the size of the buffer specified by the <CodeContentPlaceHolder>79\</CodeContentPlaceHolder> parameter.\<br />\<br /> When this method returns, if the return value is <CodeContentPlaceHolder>80\</CodeContentPlaceHolder> the variable contains the size of the note associated with the current command link control. If the return value is <CodeContentPlaceHolder>81\</CodeContentPlaceHolder>, the variable contains the buffer size required to contain the note.|  
...
### Return Value  
 ...
 In the second overload, <CodeContentPlaceHolder>82\</CodeContentPlaceHolder> if this method is successful; otherwise, <CodeContentPlaceHolder>83\</CodeContentPlaceHolder>.  
  
### Remarks  
 Use this method only with controls whose button style is <CodeContentPlaceHolder>84\</CodeContentPlaceHolder> or <CodeContentPlaceHolder>85\</CodeContentPlaceHolder>.  
...
### Remarks  
 Use this method only with controls whose button style is <CodeContentPlaceHolder>86\</CodeContentPlaceHolder> or <CodeContentPlaceHolder>87\</CodeContentPlaceHolder>.  
...
### Remarks  
 ...
 Use this method only with controls whose button style is <CodeContentPlaceHolder>88\</CodeContentPlaceHolder> or <CodeContentPlaceHolder>89\</CodeContentPlaceHolder>.  
  
 This method initializes the <CodeContentPlaceHolder>90\</CodeContentPlaceHolder> member of a                         [BUTTON_SPLITINFO](http://msdn.microsoft.com/library/windows/desktop/bb775955) structure with the <CodeContentPlaceHolder>91\</CodeContentPlaceHolder> flag, and then sends that structure in the                         [BCM_GETSPLITINFO](http://msdn.microsoft.com/library/windows/desktop/bb775969) message that is described in the [!INCLUDE[winSDK](../vs140/includes/winsdk_md.md)]. When the message function returns, this method retrieves the glyph from the <CodeContentPlaceHolder>92\</CodeContentPlaceHolder> member of the structure.  
...
### Remarks  
 Use this method only with controls whose button style is <CodeContentPlaceHolder>93\</CodeContentPlaceHolder> or <CodeContentPlaceHolder>94\</CodeContentPlaceHolder>.  
  
 This method initializes the <CodeContentPlaceHolder>95\</CodeContentPlaceHolder> member of a                         [BUTTON_SPLITINFO](http://msdn.microsoft.com/library/windows/desktop/bb775955) structure with the <CodeContentPlaceHolder>96\</CodeContentPlaceHolder> flag, and then sends that structure in the                         [BCM_GETSPLITINFO](http://msdn.microsoft.com/library/windows/desktop/bb775969) message that is described in the [!INCLUDE[winSDK](../vs140/includes/winsdk_md.md)]. When the message function returns, this method retrieves the image list from the <CodeContentPlaceHolder>97\</CodeContentPlaceHolder> member of the structure.  
...
|Parameter|Description|  
|---------------|-----------------|  
|[out] <CodeContentPlaceHolder>98\</CodeContentPlaceHolder>|Pointer to a                                         [BUTTON_SPLITINFO](http://msdn.microsoft.com/library/windows/desktop/bb775955) structure that receives information about the current split button control. The caller is responsible for allocating the structure.|  
  
### Return Value  
 <CodeContentPlaceHolder>99\</CodeContentPlaceHolder> if this method is successful; otherwise, <CodeContentPlaceHolder>100\</CodeContentPlaceHolder>.  
  
### Remarks  
 Use this method only with controls whose button style is <CodeContentPlaceHolder>101\</CodeContentPlaceHolder> or <CodeContentPlaceHolder>102\</CodeContentPlaceHolder>.  
...
|Parameter|Description|  
|---------------|-----------------|  
|[out] <CodeContentPlaceHolder>103\</CodeContentPlaceHolder>|Pointer to a                                         [SIZE](http://msdn.microsoft.com/library/windows/desktop/dd145106) structure that receives the description of a rectangle.|  
  
### Return Value  
 <CodeContentPlaceHolder>104\</CodeContentPlaceHolder> if this method is successful; otherwise, <CodeContentPlaceHolder>105\</CodeContentPlaceHolder>.  
  
### Remarks  
 Use this method only with controls whose button style is <CodeContentPlaceHolder>106\</CodeContentPlaceHolder> or <CodeContentPlaceHolder>107\</CodeContentPlaceHolder>.  
 ...
 This method initializes the <CodeContentPlaceHolder>108\</CodeContentPlaceHolder> member of a                         [BUTTON_SPLITINFO](http://msdn.microsoft.com/library/windows/desktop/bb775955) structure with the <CodeContentPlaceHolder>109\</CodeContentPlaceHolder> flag, and then sends that structure in the                         [BCM_GETSPLITINFO](http://msdn.microsoft.com/library/windows/desktop/bb775969) message that is described in the [!INCLUDE[winSDK](../vs140/includes/winsdk_md.md)]. When the message function returns, this method retrieves the bounding rectangle from the <CodeContentPlaceHolder>110\</CodeContentPlaceHolder> member of the structure.  
...
### Return Value  
 A bitwise combination of split button styles. For more information, see the <CodeContentPlaceHolder>111\</CodeContentPlaceHolder> member of the                         [BUTTON_SPLITINFO](http://msdn.microsoft.com/library/windows/desktop/bb775955) structure.  
  
### Remarks  
 Use this method only with controls whose button style is <CodeContentPlaceHolder>112\</CodeContentPlaceHolder> or <CodeContentPlaceHolder>113\</CodeContentPlaceHolder>.  
 ...
 This method initializes the <CodeContentPlaceHolder>114\</CodeContentPlaceHolder> member of a                         [BUTTON_SPLITINFO](http://msdn.microsoft.com/library/windows/desktop/bb775955) structure with the <CodeContentPlaceHolder>115\</CodeContentPlaceHolder> flag, and then sends that structure in the                         [BCM_GETSPLITINFO](http://msdn.microsoft.com/library/windows/desktop/bb775969) message that is described in the [!INCLUDE[winSDK](../vs140/includes/winsdk_md.md)]. When the message function returns, this method retrieves the split button styles from the <CodeContentPlaceHolder>116\</CodeContentPlaceHolder> member of the structure.  
...
|------------------|-----------|-----------------|  
|<CodeContentPlaceHolder>117\</CodeContentPlaceHolder>|0x0000|The initial state.|  
|<CodeContentPlaceHolder>118\</CodeContentPlaceHolder>|0x0001|The button control is checked.|  
|<CodeContentPlaceHolder>119\</CodeContentPlaceHolder>|0x0002|The state is indeterminate (only possible when the button control has three states).|  
|<CodeContentPlaceHolder>120\</CodeContentPlaceHolder>|0x0004|The button control is pressed.|  
|<CodeContentPlaceHolder>121\</CodeContentPlaceHolder>|0x0008|The button control has the focus.|  
  
### Remarks  
 A button control with the <CodeContentPlaceHolder>122\</CodeContentPlaceHolder> or <CodeContentPlaceHolder>123\</CodeContentPlaceHolder> button style creates a check box that has a third state that is named the indeterminate state. The indeterminate state indicates that the check box is neither checked nor unchecked.  
  
### Example  
 [!code[NVC_MFC_CButton#9](../vs140/codesnippet/CPP/cbutton-class_9.cpp)]  
  
##  \<a name="cbutton__gettextmargin">\</a>  CButton::GetTextMargin  
 Call this method to get the text margin of the <CodeContentPlaceHolder>124\</CodeContentPlaceHolder> object.  
  
<CodeContentPlaceHolder>19\</CodeContentPlaceHolder>  
### Parameters  
 <CodeContentPlaceHolder>125\</CodeContentPlaceHolder>  
 A pointer to the text margin of the <CodeContentPlaceHolder>126\</CodeContentPlaceHolder> object.  
...
-   **BS_VCENTER**  
 ...
 Unlike [CBitmapButton](../vs140/cbitmapbutton-class.md), which uses four bitmaps per button, <CodeContentPlaceHolder>128\</CodeContentPlaceHolder> uses only one bitmap per the button. When the button is pressed, the bitmap appears to shift down and to the right.  
...
### Remarks  
 Use the <CodeContentPlaceHolder>131\</CodeContentPlaceHolder> member function to retrieve the button style. The low-order word of the complete button style is the button-specific style.  
...
-   **BS_VCENTER**  
 ...
 Unlike [CBitmapButton](../vs140/cbitmapbutton-class.md), which uses four bitmaps per button, <CodeContentPlaceHolder>134\</CodeContentPlaceHolder> uses only one cursor per the button. When the button is pressed, the cursor appears to shift down and to the right.  
...
|Parameter|Description|  
|---------------|-----------------|  
|[in] <CodeContentPlaceHolder>135\</CodeContentPlaceHolder>|<CodeContentPlaceHolder>136\</CodeContentPlaceHolder> to set <CodeContentPlaceHolder>137\</CodeContentPlaceHolder> state; otherwise, <CodeContentPlaceHolder>138\</CodeContentPlaceHolder>.|  
  
### Return Value  
 <CodeContentPlaceHolder>139\</CodeContentPlaceHolder> if this method is successful; otherwise, <CodeContentPlaceHolder>140\</CodeContentPlaceHolder>.  
  
### Remarks  
 A split button control has a style of <CodeContentPlaceHolder>141\</CodeContentPlaceHolder> or <CodeContentPlaceHolder>142\</CodeContentPlaceHolder> and consists of a button and a drop-down arrow to its right. For more information, see                         [Button Styles](http://msdn.microsoft.com/library/windows/desktop/bb775951). Usually, the drop-down state is set when the user clicks the drop-down arrow. Use this method to programmatically set the drop-down state of the control. The drop-down arrow is drawn shaded to indicate the state.  
...
### Example  
 The following code example defines the variable, <CodeContentPlaceHolder>143\</CodeContentPlaceHolder>, that is used to programmatically access the split button control. This variable is used in the following example.  
...
##  \<a name="cbutton__setelevationrequired">\</a>  CButton::SetElevationRequired  
 Sets the state of the current button control to <CodeContentPlaceHolder>144\</CodeContentPlaceHolder>, which is necessary for the control to display an elevated security icon.  
...
|Parameter|Description|  
|---------------|-----------------|  
|[in] <CodeContentPlaceHolder>145\</CodeContentPlaceHolder>|<CodeContentPlaceHolder>146\</CodeContentPlaceHolder> to set <CodeContentPlaceHolder>147\</CodeContentPlaceHolder> state; otherwise, <CodeContentPlaceHolder>148\</CodeContentPlaceHolder>.|  
...
### Remarks  
 If a button or command link control requires elevated security permission to perform an action, set the control to <CodeContentPlaceHolder>151\</CodeContentPlaceHolder> state. Subsequently, Windows displays the User Account Control (UAC) shield icon on the control. For more information, see "User Account Control" at                         [MSDN](http://go.microsoft.com/fwlink/?LinkId=18507).  
...
-   **BS_VCENTER**  
 ...
 Unlike [CBitmapButton](../vs140/cbitmapbutton-class.md), which uses four bitmaps per button, <CodeContentPlaceHolder>153\</CodeContentPlaceHolder> uses only one icon per the button. When the button is pressed, the icon appears to shift down and to the right.  
  
### Example  
 [!code[NVC_MFC_CButton#8](../vs140/codesnippet/CPP/cbutton-class_8.cpp)]  
  
##  \<a name="cbutton__setimagelist">\</a>  CButton::SetImageList  
 Call this method to set the image list of the <CodeContentPlaceHolder>154\</CodeContentPlaceHolder> object.  
...
|Parameter|Description|  
|---------------|-----------------|  
|[in] <CodeContentPlaceHolder>156\</CodeContentPlaceHolder>|Pointer to a Unicode string that is set as the note text for the command link control.|  
  
### Return Value  
 <CodeContentPlaceHolder>157\</CodeContentPlaceHolder> if this method is successful; otherwise, <CodeContentPlaceHolder>158\</CodeContentPlaceHolder>.  
  
### Remarks  
 Use this method only with controls whose button style is <CodeContentPlaceHolder>159\</CodeContentPlaceHolder> or <CodeContentPlaceHolder>160\</CodeContentPlaceHolder>.  
...
### Example  
 The following code example defines the variable, <CodeContentPlaceHolder>161\</CodeContentPlaceHolder>, that is used to programmatically access the command link control. This variable is used in the following example.  
...
|Parameter|Description|  
|---------------|-----------------|  
|[in] <CodeContentPlaceHolder>162\</CodeContentPlaceHolder>|A character that specifies the glyph to use as the split button drop-down arrow.|  
  
### Return Value  
 <CodeContentPlaceHolder>163\</CodeContentPlaceHolder> if this method is successful; otherwise, <CodeContentPlaceHolder>164\</CodeContentPlaceHolder>.  
  
### Remarks  
 Use this method only with controls that have the button style <CodeContentPlaceHolder>165\</CodeContentPlaceHolder> or <CodeContentPlaceHolder>166\</CodeContentPlaceHolder>.  
  
 A glyph is the physical representation of a character in a particular font. The <CodeContentPlaceHolder>167\</CodeContentPlaceHolder>parameter is not used as the glyph, but is instead used to select a glyph from a set of system-defined glyphs. The default drop-down arrow glyph is specified by a character '6', and resembles the Unicode character BLACK DOWN-POINTING TRIANGLE (U+25BC).  
  
 This method initializes the <CodeContentPlaceHolder>168\</CodeContentPlaceHolder> member of a                         [BUTTON_SPLITINFO](http://msdn.microsoft.com/library/windows/desktop/bb775955) structure with the <CodeContentPlaceHolder>169\</CodeContentPlaceHolder> flag and the <CodeContentPlaceHolder>170\</CodeContentPlaceHolder> member with the <CodeContentPlaceHolder>171\</CodeContentPlaceHolder> parameter, and then sends that structure in the                         [BCM_GETSPLITINFO](http://msdn.microsoft.com/library/windows/desktop/bb775969) message that is described in the [!INCLUDE[winSDK](../vs140/includes/winsdk_md.md)].  
...
|Parameter|Description|  
|---------------|-----------------|  
|[in] <CodeContentPlaceHolder>172\</CodeContentPlaceHolder>|Pointer to a [CImageList](../vs140/cimagelist-class.md) object to assign to the current split button control.|  
  
### Return Value  
 <CodeContentPlaceHolder>173\</CodeContentPlaceHolder> if this method is successful; otherwise, <CodeContentPlaceHolder>174\</CodeContentPlaceHolder>.  
  
### Remarks  
 Use this method only with controls whose button style is <CodeContentPlaceHolder>175\</CodeContentPlaceHolder> or <CodeContentPlaceHolder>176\</CodeContentPlaceHolder>.  
  
 This method initializes the <CodeContentPlaceHolder>177\</CodeContentPlaceHolder> member of a                         [BUTTON_SPLITINFO](http://msdn.microsoft.com/library/windows/desktop/bb775955) structure with the <CodeContentPlaceHolder>178\</CodeContentPlaceHolder> flag and the <CodeContentPlaceHolder>179\</CodeContentPlaceHolder> member with the <CodeContentPlaceHolder>180\</CodeContentPlaceHolder> parameter, and then sends that structure in the                         [BCM_GETSPLITINFO](http://msdn.microsoft.com/library/windows/desktop/bb775969) message that is described in the [!INCLUDE[winSDK](../vs140/includes/winsdk_md.md)].  
...
|Parameter|Description|  
|---------------|-----------------|  
|[in] <CodeContentPlaceHolder>181\</CodeContentPlaceHolder>|Pointer to a                                         [BUTTON_SPLITINFO](http://msdn.microsoft.com/library/windows/desktop/bb775955) structure that defines the current split button control.|  
  
### Return Value  
 <CodeContentPlaceHolder>182\</CodeContentPlaceHolder> if this method is successful; otherwise, <CodeContentPlaceHolder>183\</CodeContentPlaceHolder>.  
  
### Remarks  
 Use this method only with controls whose button style is <CodeContentPlaceHolder>184\</CodeContentPlaceHolder> or <CodeContentPlaceHolder>185\</CodeContentPlaceHolder>.  
...
### Example  
 The following code example defines the variable, <CodeContentPlaceHolder>186\</CodeContentPlaceHolder>, that is used to programmatically access the split button control.  
  
 [!code[NVC_MFC_CButton_s1#1](../vs140/codesnippet/CPP/cbutton-class_10.h)]  
  
### Example  
 The following code example changes the glyph that is used for the split button drop-down arrow. The example substitutes an up-pointing triangle glyph for the default down-pointing triangle glyph. The glyph that is displayed depends on the character that you specify in the <CodeContentPlaceHolder>187\</CodeContentPlaceHolder> member of the <CodeContentPlaceHolder>188\</CodeContentPlaceHolder> structure. The down-pointing triangle glyph is specified by a character '6' and the up-pointing triangle glyph is specified by a character '5'. For comparison, see the convenience method, [CButton::SetSplitGlyph](#cbutton__setsplitglyph).  
  
 [!code[NVC_MFC_CButton_s1#4](../vs140/codesnippet/CPP/cbutton-class_13.cpp)]  
...
|Parameter|Description|  
|---------------|-----------------|  
|[in] <CodeContentPlaceHolder>189\</CodeContentPlaceHolder>|Pointer to a                                         [SIZE](http://msdn.microsoft.com/library/windows/desktop/dd145106) structure that describes a bounding rectangle.|  
  
### Return Value  
 <CodeContentPlaceHolder>190\</CodeContentPlaceHolder> if this method is successful; otherwise, <CodeContentPlaceHolder>191\</CodeContentPlaceHolder>.  
  
### Remarks  
 Use this method only with controls whose button style is <CodeContentPlaceHolder>192\</CodeContentPlaceHolder> or <CodeContentPlaceHolder>193\</CodeContentPlaceHolder>.  
 ...
 This method initializes the <CodeContentPlaceHolder>194\</CodeContentPlaceHolder> member of a                         [BUTTON_SPLITINFO](http://msdn.microsoft.com/library/windows/desktop/bb775955) structure with the <CodeContentPlaceHolder>195\</CodeContentPlaceHolder> flag and the <CodeContentPlaceHolder>196\</CodeContentPlaceHolder> member with the <CodeContentPlaceHolder>197\</CodeContentPlaceHolder> parameter, and then sends that structure in the                         [BCM_GETSPLITINFO](http://msdn.microsoft.com/library/windows/desktop/bb775969) message that is described in the [!INCLUDE[winSDK](../vs140/includes/winsdk_md.md)].  
  
### Example  
 The following code example defines the variable, <CodeContentPlaceHolder>198\</CodeContentPlaceHolder>, that is used to programmatically access the split button control. This variable is used in the following example.  
...
|Parameter|Description|  
|---------------|-----------------|  
|[in] <CodeContentPlaceHolder>199\</CodeContentPlaceHolder>|A bitwise combination of split button styles. For more information, see the <CodeContentPlaceHolder>200\</CodeContentPlaceHolder> member of the                                         [BUTTON_SPLITINFO](http://msdn.microsoft.com/library/windows/desktop/bb775955) structure.|  
...
### Remarks  
 Use this method only with controls whose button style is <CodeContentPlaceHolder>203\</CodeContentPlaceHolder> or <CodeContentPlaceHolder>204\</CodeContentPlaceHolder>.  
  
 The split button styles specify the alignment, aspect ratio, and graphical format with which Windows draws a split button icon. For more information, see the <CodeContentPlaceHolder>205\</CodeContentPlaceHolder> member of the                         [BUTTON_SPLITINFO](http://msdn.microsoft.com/library/windows/desktop/bb775955) structure.  
  
 This method initializes the <CodeContentPlaceHolder>206\</CodeContentPlaceHolder> member of a                         [BUTTON_SPLITINFO](http://msdn.microsoft.com/library/windows/desktop/bb775955) structure with the <CodeContentPlaceHolder>207\</CodeContentPlaceHolder> flag and the <CodeContentPlaceHolder>208\</CodeContentPlaceHolder> member with the <CodeContentPlaceHolder>209\</CodeContentPlaceHolder> parameter, and then sends that structure in the                         [BCM_GETSPLITINFO](http://msdn.microsoft.com/library/windows/desktop/bb775969) message that is described in the [!INCLUDE[winSDK](../vs140/includes/winsdk_md.md)].  
  
### Example  
 The following code example defines the variable, <CodeContentPlaceHolder>210\</CodeContentPlaceHolder>, that is used to programmatically access the split button control.  
  
 [!code[NVC_MFC_CButton_s1#1](../vs140/codesnippet/CPP/cbutton-class_10.h)]  
  
### Example  
 The following code example sets the style of the split button drop-down arrow. The <CodeContentPlaceHolder>211\</CodeContentPlaceHolder> style displays the arrow on the left side of the button, and the <CodeContentPlaceHolder>212\</CodeContentPlaceHolder> style retains the drop-down arrow's proportions when you resize the button.  
...
##  \<a name="cbutton__settextmargin">\</a>  CButton::SetTextMargin  
 Call this method to set the text margin of the <CodeContentPlaceHolder>213\</CodeContentPlaceHolder> object.  
