...
1.  Restart the <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> object.  
...
4.  In the **References** dialog box, select the check box for the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> object.  
