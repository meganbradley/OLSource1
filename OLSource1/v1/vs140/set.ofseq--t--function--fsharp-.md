...
## Return Value  
 The set containing <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>.  
...
## Example  
 The following example demonstrates how to create a set from a sequence by using <CodeContentPlaceHolder>5\</CodeContentPlaceHolder>.  
  
 [!code[FsSamples101#2001](../vs140/codesnippet/FSharp/set.ofseq--t--function--fsharp-_1.fs)]  
