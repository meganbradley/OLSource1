...
|[in] <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>|A <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> object to serialize from or to.|  
  
## Remarks  
 This method serializes the map structure of command counts, <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>, and the total command usage, <CodeContentPlaceHolder>4\</CodeContentPlaceHolder>, counter from or to the specified archive.  
