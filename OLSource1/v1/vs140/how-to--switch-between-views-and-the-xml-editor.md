...
4.  Drag the <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> node from the XML Schema Explorer onto the Graph View. Right-click the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> node in the Graph View and select **Show in Content Model View** in the context menu.  
  
     The Content Model View with the details of <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> node appears.  
