...
## Implementation of Properties Window Buttons  
 ...
 The [MapPropertyToCategory](assetId:///M:Microsoft.VisualStudio.Shell.Interop.ICategorizeProperties.MapPropertyToCategory(System.Int32,System.Int32@)?qualifyHint=False&autoUpgrade=True) method returns the appropriate property category value for the specified property. The [GetCategoryName](assetId:///M:Microsoft.VisualStudio.Shell.Interop.ICategorizeProperties.GetCategoryName(System.Int32,System.UInt32,System.String@)?qualifyHint=False&autoUpgrade=True) method returns a string that contains the category name. You only have to provide support for custom category values because Visual Studio knows the standard property category values.  
