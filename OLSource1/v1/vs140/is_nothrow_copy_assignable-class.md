...
## Remarks  
 An instance of the type predicate holds true for a referenceable type <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> where <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> holds true; otherwise it holds false.  
