...
##  \<a name="_core_portions_of_ole_not_implemented_by_the_class_library">\</a> Portions of OLE Not Implemented by the Class Library  
 ...
 IMoniker Interface  
 The <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> interface is implemented by the class library (for example, the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> class) but has not previously been exposed to the programmer. For more information about this interface, see OLE Moniker Implementations in the OLE section of the [!INCLUDE[winSDK](../vs140/includes/winsdk_md.md)]. However, see also class [CMonikerFile](../vs140/cmonikerfile-class.md) and [CAsyncMonikerFile](../vs140/casyncmonikerfile-class.md).  
