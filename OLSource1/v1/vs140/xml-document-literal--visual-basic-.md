...
>  An XML literal can span multiple lines without using line continuation characters. This enables you to copy content from an XML document and paste it directly into a [!INCLUDE[vbprvb](../vs140/includes/vbprvb_md.md)] program.  
 ...
 The [!INCLUDE[vbprvb](../vs140/includes/vbprvb_md.md)] compiler converts the XML document literal into calls to the [XDocument](assetId:///M:System.Xml.Linq.XDocument.#ctor(System.Xml.Linq.XDeclaration,System.Object[])?qualifyHint=False&autoUpgrade=True) and [XDeclaration](assetId:///M:System.Xml.Linq.XDeclaration.#ctor(System.String,System.String,System.String)?qualifyHint=False&autoUpgrade=True) constructors.  
