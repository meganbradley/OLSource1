...
---
# XML Document Literal (Visual Basic)
A literal representing an <xref:System.Xml.Linq.XDocument?qualifyHint=False> object.  
...
|`rootElement`|Required. Root element of the document. The format is one of the following:<br /><br /> <ul><li>[XML Element Literal](../vs140/xml-element-literal--visual-basic-.md).</li><li>Embedded expression of the form `<%=` `elementExp` `%>`. The `elementExp` returns one of the following:<br /><br /> <ul><li>An <xref:System.Xml.Linq.XElement?qualifyHint=False> object.</li><li>A collection that contains one <xref:System.Xml.Linq.XElement?qualifyHint=False> object and any number of <xref:System.Xml.Linq.XProcessingInstruction?qualifyHint=False> and <xref:System.Xml.Linq.XComment?qualifyHint=False> objects.</li></ul></li></ul><br /> For more information, see [Embedded Expressions In XML](../vs140/embedded-expressions-in-xml--visual-basic-.md).|  
  
## Return Value  
 An <xref:System.Xml.Linq.XDocument?qualifyHint=False> object.  
...
>  An XML literal can span multiple lines without using line continuation characters. This enables you to copy content from an XML document and paste it directly into a [!INCLUDE[vbprvb](../vs140/includes/vbprvb_md.md)] program.  
 ...
 The [!INCLUDE[vbprvb](../vs140/includes/vbprvb_md.md)] compiler converts the XML document literal into calls to the <xref:System.Xml.Linq.XDocument.#ctor?qualifyHint=False> and <xref:System.Xml.Linq.XDeclaration.#ctor?qualifyHint=False> constructors.  
