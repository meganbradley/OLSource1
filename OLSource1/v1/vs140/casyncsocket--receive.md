...
#### Parameters  
 ...
 The length of <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> in bytes.  
...
-   **WSAESHUTDOWN** The socket has been shut down; it is not possible to call **Receive** on a socket after <CodeContentPlaceHolder>7\</CodeContentPlaceHolder> has been invoked with <CodeContentPlaceHolder>8\</CodeContentPlaceHolder> set to 0 or 2.  
