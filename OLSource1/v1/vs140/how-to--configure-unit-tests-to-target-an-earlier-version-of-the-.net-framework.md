...
6.  Set the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> to version 3.5 or a later version in the <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> labeled <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>. You should not specify a client version:  
...
## See Also  
 ...
 [Advanced Compiler Settings Dialog Box (Visual Basic)](../vs140/advanced-compiler-settings-dialog-box--visual-basic-.md)