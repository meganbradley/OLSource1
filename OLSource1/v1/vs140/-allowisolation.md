 ...
 **/ALLOWISOLATION:NO** indicates that executables are loaded as if there were no manifest, and causes [EDITBIN](../vs140/editbin-reference.md) to set the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> bit in the optional header's <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> field.  
