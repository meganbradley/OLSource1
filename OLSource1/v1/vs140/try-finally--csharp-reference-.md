...
## Example  
 ...
 C# also contains the [using statement](../vs140/using-statement--csharp-reference-.md), which provides similar functionality for <xref:System.IDisposable?qualifyHint=False> objects in a convenient syntax.  
