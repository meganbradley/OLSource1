...
dev_langs: 
  - "C++"
helpviewer_keywords: 
  - "MapAccelerator method"
  - "mappings, accelerator"
  - "accelerator mapping"
 ...
 *pIDBtn*  
 A pointer to a **UINT** that receives the command identifier of the button that corresponds to the accelerator specified in <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>.  
