...
Adding this attribute to a record or union type disables the automatic generation of overrides for <xref:System.Object.Equals?qualifyHint=False>, <xref:System.Object.GetHashCode?qualifyHint=False> and <xref:System.IComparable?qualifyHint=False> for the type. The type will by default use reference equality.  
