...
## In This Section  
 ...
 Illustrates converting between strings and numeric, <CodeContentPlaceHolder>0\</CodeContentPlaceHolder>, or date/time values.  
  
 [How to: Convert an Object to Another Type (Visual Basic)](../vs140/how-to--convert-an-object-to-another-type-in-visual-basic.md)  
 Shows how to convert an <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> variable to any other data type.  
