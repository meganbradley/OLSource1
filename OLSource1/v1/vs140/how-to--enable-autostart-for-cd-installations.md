...
When deploying a [!INCLUDE[ndptecclick](../vs140/includes/ndptecclick_md.md)] application by means of removable media such as CD-ROM or DVD-ROM, you can enable <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> so that the [!INCLUDE[ndptecclick](../vs140/includes/ndptecclick_md.md)] application is automatically launched when the media is inserted.  
  
 <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> can be enabled on the **Publish** page of the **Project Designer**.  
