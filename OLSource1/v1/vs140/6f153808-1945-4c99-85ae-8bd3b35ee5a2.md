...
-   If neither the procedure nor its container needs to be generic, then remove the <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> clauses so that they are not generic.  
