...
#### Parameters  
 ...
 [out] A pointer to the variable containing the <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> status of the specified parameter. For information on <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> values, see [Status](https://msdn.microsoft.com/en-us/library/ms722617.aspx) in the *OLE DB Programmer's Reference*, or search for <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> in oledb.h.  
