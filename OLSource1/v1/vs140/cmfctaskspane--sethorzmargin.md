...
## Remarks  
 ...
 If n is -1, and the framework determines the margin value by using the visual manager (<CodeContentPlaceHolder>2\</CodeContentPlaceHolder>). The default horizontal margin is 12 pixels.  
