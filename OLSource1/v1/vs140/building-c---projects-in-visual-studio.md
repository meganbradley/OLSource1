...
-   Or, in the [Command Window](../vs140/command-window.md) (on the menu bar, choose **View**, **Other Windows**, **Command Window**), enter <CodeContentPlaceHolder>0\</CodeContentPlaceHolder>.  
  
-   Or, in the [Quick Launch](../vs140/quick-launch--environment--options-dialog-box.md) box, enter <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>.  
...
-   Or, in the Command Window (on the menu bar, choose **View**, **Other Windows**, **Command Window**), enter <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>.  
  
-   Or, in the Quick Launch box, enter <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>.  
