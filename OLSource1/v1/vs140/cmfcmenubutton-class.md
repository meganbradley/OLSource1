...
|Name|Description|  
|----------|-----------------|  
|[CMFCMenuButton::CMFCMenuButton](#cmfcmenubutton__cmfcmenubutton)|Constructs a <CodeContentPlaceHolder>9\</CodeContentPlaceHolder> object.|  
  
### Public Methods  
  
|Name|Description|  
|----------|-----------------|  
|[CMFCMenuButton::PreTranslateMessage](#cmfcmenubutton__pretranslatemessage)|Called by the framework to translate window messages before they are dispatched. (Overrides <CodeContentPlaceHolder>10\</CodeContentPlaceHolder>.)|  
...
## Remarks  
 The <CodeContentPlaceHolder>11\</CodeContentPlaceHolder> class is derived from the [CMFCButton Class](../vs140/cmfcbutton-class.md) which is, in turn, derived from the [CButton Class](../vs140/cbutton-class.md). Therefore, you can use <CodeContentPlaceHolder>12\</CodeContentPlaceHolder> in your code the same way you would use <CodeContentPlaceHolder>13\</CodeContentPlaceHolder>.  
  
 When you create a <CodeContentPlaceHolder>14\</CodeContentPlaceHolder>, you must pass in a handle to the associated pop-up menu. Next, call the function <CodeContentPlaceHolder>15\</CodeContentPlaceHolder>. <CodeContentPlaceHolder>16\</CodeContentPlaceHolder> checks that the button size is sufficient to include an arrow that points to the location where the pop-up window will appear - namely, underneath or to the right of the button.  
...
## Example  
 ...
 [!code[NVC_MFC_NewControls#38](../vs140/codesnippet/CPP/cmfcmenubutton-class_1.h)]  
[!code[NVC_MFC_NewControls#39](../vs140/codesnippet/CPP/cmfcmenubutton-class_2.cpp)]  
...
### Remarks  
 If <CodeContentPlaceHolder>17\</CodeContentPlaceHolder> is <CodeContentPlaceHolder>18\</CodeContentPlaceHolder>, the framework calls the inherited <CodeContentPlaceHolder>19\</CodeContentPlaceHolder> method for this object. Otherwise, the framework calls [CContextMenuManager::TrackPopupMenu](../vs140/ccontextmenumanager-class.md#ccontextmenumanager__trackpopupmenu).  
...
### Remarks  
 When the user presses the menu button, the application shows a pop-up menu. The framework will display the pop-up menu either under the button or to the right of the button. The button also has a small arrow that indicates where the pop-up menu will appear. If <CodeContentPlaceHolder>20\</CodeContentPlaceHolder> is <CodeContentPlaceHolder>21\</CodeContentPlaceHolder>, the framework displays the pop-up menu to the right of the button. Otherwise, it displays the pop-up menu under the button.  
...
### Remarks  
 If the <CodeContentPlaceHolder>22\</CodeContentPlaceHolder> member is <CodeContentPlaceHolder>23\</CodeContentPlaceHolder>, the menu button does not become pressed when the uses clicks the button. In this case, the framework displays only the pop-up menu.  
  
 If the <CodeContentPlaceHolder>24\</CodeContentPlaceHolder> member is <CodeContentPlaceHolder>25\</CodeContentPlaceHolder>, the menu button becomes pressed when the user clicks the button. It stays pressed until after the user closes the pop-up menu, either by making a selection or canceling.  
...
### Remarks  
 If you call this function and <CodeContentPlaceHolder>28\</CodeContentPlaceHolder> is <CodeContentPlaceHolder>29\</CodeContentPlaceHolder>, <CodeContentPlaceHolder>30\</CodeContentPlaceHolder> will calculate only the new size of the button.  
