...
<CodeContentPlaceHolder>0\</CodeContentPlaceHolder>  
 In the preceding example, the variable <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> is promoted to type double and multiplied by <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>; then the result is rounded to type float before being assigned to <CodeContentPlaceHolder>4\</CodeContentPlaceHolder>.  
