...
Retrieves the relative virtual address (RVA) of the location. Use when the [LocationType Enumeration](../vs140/locationtype.md) is set to <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>.  
