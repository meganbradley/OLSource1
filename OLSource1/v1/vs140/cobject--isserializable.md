...
## Example  
 See [CObList::CObList](../vs140/coblist--coblist.md) for a listing of the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> class used in all <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> examples.  
