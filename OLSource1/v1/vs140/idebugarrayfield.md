...
## Notes for Callers  
 Use [QueryInterface](../vs140/queryinterface.md) to obtain this interface from the [IDebugContainerField](../vs140/idebugcontainerfield.md) interface if [IDebugField::GetKind](../vs140/idebugfield--getkind.md) returns the flag <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>.  
