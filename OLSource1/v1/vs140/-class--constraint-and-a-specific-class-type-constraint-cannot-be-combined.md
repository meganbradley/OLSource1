...
-   The type argument must expose a parameterless constructor that the creating code can access (include the <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> constraint)  
...
-   The type argument must be a value type (include the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> constraint)  
  
-   The type argument must be a reference type (include the <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> constraint)  
  
 You cannot specify both <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> and <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> for the same type parameter, and you cannot specify either one more than once.  
...
-   If you want the type argument to inherit from the specified class name, remove the <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> keyword from the constraint list.  
