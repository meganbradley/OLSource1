...
ms.topic: "reference"
f1_keywords: 
  - "operatorconstSECURITY_DESCRIPTOR*"
  - "ATL::CSecurityDesc::operatorconstSECURITY_DESCRIPTOR*"
  - "ATL.CSecurityDesc.operatorconstSECURITY_DESCRIPTOR*"
  - "CSecurityDesc.operatorconstSECURITY_DESCRIPTOR*"
  - "CSecurityDesc::operatorconstSECURITY_DESCRIPTOR*"
  - "constSECURITY_DESCRIPTOR*"
dev_langs: 
  - "C++"
helpviewer_keywords: 
  - "operator const SECURITY_DESCRIPTOR *"
  - "const SECURITY_DESCRIPTOR * operator"
