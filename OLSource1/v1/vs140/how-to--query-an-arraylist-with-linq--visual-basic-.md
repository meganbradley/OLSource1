...
## Example  
 The following example shows a simple query over an <xref:System.Collections.ArrayList*>. Note that this example uses object initializers when the code calls the [Add](assetId:///M:System.Collections.ArrayList.Add(System.Object)?qualifyHint=False&autoUpgrade=True) method, but this is not a requirement.  
