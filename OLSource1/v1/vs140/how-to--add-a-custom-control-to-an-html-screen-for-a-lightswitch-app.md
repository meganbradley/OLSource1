...
3.  In the **Specify the data for the new custom control** text box, enter the item or collection to be bound to the control.  
     ...
     For example, enter <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> to bind to a customer’s postal code, or enter <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> to bind to the entire customer record.  
...
<CodeContentPlaceHolder>1\</CodeContentPlaceHolder>  
     This code renders the control at run time. Replace <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> with the name of your control, and change the <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> and <CodeContentPlaceHolder>6\</CodeContentPlaceHolder> parameters as necessary.  
