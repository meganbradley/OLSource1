...
3.  Open the application manifest in your preferred text or XML editor and find the <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> element for your recently added file.  
  
     If you added an XML file named <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>, the file will look similar to the following code example.  
  
 <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>  
  
1.  Add the attribute <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> to this element, and supply it with a value of <CodeContentPlaceHolder>4\</CodeContentPlaceHolder>.  
...
## See Also  
 [Accessing Local and Remote Data in ClickOnce Applications](../vs140/accessing-local-and-remote-data-in-clickonce-applications.md)