...
A dynamic-link library (DLL) is a library specified in the <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> clause of a <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> statement. Possible causes for this error include:  
