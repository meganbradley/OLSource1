...
#### Parameters  
 ...
 <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> to allocate memory for an object that supports weak references; <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> to allocate memory for an object that doesn't support weak references.  
