...
<CodeContentPlaceHolder>1\</CodeContentPlaceHolder>  
 except that <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> is only evaluated once. The [/ operator](../vs140/--operator--csharp-reference-1.md) is predefined for numeric types to perform division.  
  
 The <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> operator cannot be overloaded directly, but user-defined types can overload the [/ operator](../vs140/--operator--csharp-reference-1.md) (see [operator](../vs140/operator--csharp-reference-2.md)). On all compound assignment operators, overloading the binary operator implicitly overloads the equivalent compound assignment.  
