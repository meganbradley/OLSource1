...
apitype: "Assembly"
f1_keywords: 
  - "Microsoft.FSharp.Core.Operators.op_GreaterThan``1"
dev_langs: 
  - "FSharp"
helpviewer_keywords: 
  - "op_GreaterThan operator [F#]"
  - "Operators.( > ) operator [F#]"
  - "> operator [F#]"
  - "Operators.op_GreaterThan operator [F#]"
ms.assetid: 22954f96-f585-47a1-8199-ac2a7c85d7e0
