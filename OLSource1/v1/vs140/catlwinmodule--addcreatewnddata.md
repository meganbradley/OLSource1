...
---
# CAtlWinModule::AddCreateWndData
This method initializes and adds an <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> structure.  
...
#### Parameters  
 ...
 Pointer to the <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> structure to be initialized and added to the current module.  
