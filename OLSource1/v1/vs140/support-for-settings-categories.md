...
[!code[VSSDKSupportForSettingsCategories#1](../vs140/codesnippet/CSharp/support-for-settings-categories_1.cs)]  
 ...
 Resource ID 106 maps to "My Category", 107 to "My Settings", and 108 to "Various Options". This declares that <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> provides the category, My Category_My Settings. The category is provided by the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> class, which must implement \<xref:Microsoft.VisualStudio.Shell.IProfileManager*>. The settings in that category are the public properties of the <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> class.  
