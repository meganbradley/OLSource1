...
## Return Value  
 The first two operators return the incremented value; the last two operators return the value before the increment. The operators use the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>[memory_order](../vs140/memory_order-enum.md).  
