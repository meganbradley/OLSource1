...
## Packaging an Extension in an Empty VSIX Project  
 You can package an existing extension, or an extension that does not already have VSIX support, by wrapping it in an empty VSIX project. The extension to be wrapped must be of a type that is supported by the [VSIX schema](../vs140/vsix-extension-schema-2.0-reference.md).  
...
## See Also  
 [VSX Schema for Extensions](../vs140/vsix-extension-schema-2.0-reference.md)   
