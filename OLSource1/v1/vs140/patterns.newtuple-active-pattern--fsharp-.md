...
apitype: "Assembly"
f1_keywords: 
  - "Microsoft.FSharp.Quotations.PatternsModule.NewTuplePattern"
dev_langs: 
  - "FSharp"
helpviewer_keywords: 
  - "NewTuple active pattern [F#]"
...
## Return Value  
 The formal return type is <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>. The option indicates whether the input results in a match. In a pattern matching expression, the input is decomposed into a list of expressions that form the tuple definition.  
