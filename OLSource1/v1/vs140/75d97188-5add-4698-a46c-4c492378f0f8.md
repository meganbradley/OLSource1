...
Find the next name, if any, that matches the `filespec` argument in a previous call to [_findfirst](../vs140/9bb46d1a-b946-47de-845a-a0b109a33ead.md), and then alter the `fileinfo` structure contents accordingly.  
