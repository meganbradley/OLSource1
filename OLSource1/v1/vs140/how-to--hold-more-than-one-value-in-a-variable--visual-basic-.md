...
3.  Declare your variable with a <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> statement.  
  
4.  Follow the variable name with an <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> clause.  
  
5.  Follow the <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> keyword with the name of the appropriate composite data type.  
