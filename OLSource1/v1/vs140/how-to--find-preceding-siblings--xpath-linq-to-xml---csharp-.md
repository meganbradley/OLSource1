...
This topic compares the XPath `preceding-sibling` axis to the [!INCLUDE[sqltecxlinq](../vs140/includes/sqltecxlinq_md.md)] child <xref:System.Xml.Linq.XNode.ElementsBeforeSelf?qualifyHint=True> axis.  
  
 The XPath expression is:  
  
 `preceding-sibling::*`  
  
 Note that the results of both <xref:System.Xml.XPath.Extensions.XPathSelectElements?qualifyHint=False> and <xref:System.Xml.Linq.XNode.ElementsBeforeSelf?qualifyHint=True> are in document order.  
