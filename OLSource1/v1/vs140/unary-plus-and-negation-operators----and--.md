...
## + operator  
 ...
 Integral promotion is performed on integral operands. The resultant type is the type to which the operand is promoted. Thus, the expression <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>, where <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> is of type <CodeContentPlaceHolder>4\</CodeContentPlaceHolder>, results in type <CodeContentPlaceHolder>5\</CodeContentPlaceHolder>; the value is unmodified. See [Integral Promotions](../vs140/integral-promotions.md) for more information about how the promotion is done.  
