...
## Remarks  
 A <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> can also be described as the number of elements between two pointers, because a pointer to an element contains its address.  
