...
## Return Value  
 <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> if tabbed windows are scrolled using a popup menu of tabbed window labels; <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> if tabbed windows are scrolled using forward and backward scroll buttons.  
