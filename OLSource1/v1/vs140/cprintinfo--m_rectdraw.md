...
## Remarks  
 You may want to refer to this in your override of <CodeContentPlaceHolder>0\</CodeContentPlaceHolder>. You can use this member to keep track of what area remains usable after you print headers, footers, and so on. The **m_rectDraw** member is a public variable of type <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>.  
