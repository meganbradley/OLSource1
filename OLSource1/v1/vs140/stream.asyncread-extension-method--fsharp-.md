...
|---------------|-----------------|  
|<xref:System.ArgumentException?qualifyHint=False>|Thrown when the sum of `offset` and `count` is longer than the buffer length.|  
|<xref:System.ArgumentOutOfRangeException?qualifyHint=False>|Thrown when `offset` or `count` is negative.|  
...
## See Also  
 <xref:System.IO.Stream?qualifyHint=False>   
