...
|---------------|-----------------|  
|\<xref:System.ArgumentException*>|Thrown when the sum of <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> and <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> is longer than the buffer length.|  
|\<xref:System.ArgumentOutOfRangeException*>|Thrown when <CodeContentPlaceHolder>6\</CodeContentPlaceHolder> or <CodeContentPlaceHolder>7\</CodeContentPlaceHolder> is negative.|  
  
## Return Value  
  
## Remarks  
 This member is named <CodeContentPlaceHolder>8\</CodeContentPlaceHolder> in compiled assemblies. If you are accessing the method from a language other than F#, or through reflection, use this name.  
