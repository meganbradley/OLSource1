...
entry point 'decorated_function_name' already has a thread attribute; 'attribute' ignored  
 ...
 An entry point, specified with [/ENTRY (Entry-Point Symbol)](../vs140/-entry--entry-point-symbol-.md), had a threading attribute, but [/CLRTHREADATTRIBUTE (Set CLR Thread Attribute)](../vs140/-clrthreadattribute--set-clr-thread-attribute-.md) was also specified, with a different threading model.  
