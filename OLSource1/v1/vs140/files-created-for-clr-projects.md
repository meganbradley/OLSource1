...
|*projname*.h|The main include file for the project, which contains all declarations, global symbols, and <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> directives for other header files.|  
