...
## Remarks  
 The member operator returns a referene to the element at position <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>. You use it to access an element whose position you know.  
