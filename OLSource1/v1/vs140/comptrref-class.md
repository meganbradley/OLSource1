...
|[ComPtrRef::operator void** Operator](../vs140/comptrref--operator-void---operator.md)|Deletes the current ComPtrRef object, casts the pointer to the interface that was represented by the ComPtrRef object as a pointer-to-pointer-to <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>, and then returns the cast pointer.|  
