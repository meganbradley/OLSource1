...
|[Force](../vs140/lazy.force--t--extension-method--fsharp-.md)  `: unit -> 'T`|Forces the execution of this value and returns its result. Same as <xref:System.Lazy`1.Value?qualifyHint=False>. Mutual exclusion is used to prevent other threads from also computing the value.|  
