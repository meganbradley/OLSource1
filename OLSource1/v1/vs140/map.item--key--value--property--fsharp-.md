...
Lookup an element in the map. Raise <xref:System.Collections.Generic.KeyNotFoundException?qualifyHint=False> if no binding exists in the map.  
...
|Exception|Condition|  
|---------------|---------------|  
|<xref:System.Collections.Generic.KeyNotFoundException?qualifyHint=False>|Thrown when the key is not found.|  
