...
## Members  
 ...
 fIsDebuggerPresent  
 Nonzero (<CodeContentPlaceHolder>2\</CodeContentPlaceHolder>) if the [!INCLUDE[vsprvs](../vs140/includes/vsprvs_md.md)] debugger is running, zero (<CodeContentPlaceHolder>3\</CodeContentPlaceHolder>) if it is not.  
