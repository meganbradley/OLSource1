...
ms.topic: "article"
f1_keywords: 
  - "AFXDHTML/DHTML_EVENT_ONBEFOREUPDATE"
  - "DHTML_EVENT_ONBEFOREUPDATE"
dev_langs: 
  - "C++"
helpviewer_keywords: 
  - "DHTML_EVENT_ONBEFOREUPDATE macro"
...
---
# DHTML_EVENT_ONBEFOREUPDATE
Handles (at the document level) the **onbeforeupdate** event originated by the HTML element identified by <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>.  
