...
## Return Value  
 A positive number if the specified item is selected; otherwise, it is 0. The return value is <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> if an error occurs.  
