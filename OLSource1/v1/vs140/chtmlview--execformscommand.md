...
---
# CHtmlView::ExecFormsCommand
Executes the specified command using the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> method.  
...
## Return Value  
 A standard <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> value. For a complete listing of possible values, see [IOleCommandTarget::Exec](http://msdn.microsoft.com/library/windows/desktop/ms690300) in the [!INCLUDE[winSDK](../vs140/includes/winsdk_md.md)].  
