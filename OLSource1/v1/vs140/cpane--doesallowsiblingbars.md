...
f1_keywords: 
  ...
  - "CPane.DoesAllowSiblingBars"
  - "DoesAllowSiblingBars"
dev_langs: 
  - "C++"
helpviewer_keywords: 
  - "DoesAllowSiblingBars method"
...
## Return Value  
 <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> if this pane can dock to another pane on the same row as itself; otherwise, <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>.  
