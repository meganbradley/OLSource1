...
## Remarks  
 All <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>, **Edit**, **Delete**, and **Update** calls executed since the last [BeginTrans](../vs140/cdatabase--begintrans.md) are rolled back to the state that existed at the time of that call.  
