...
## Remarks  
 This method allocates the resources for a <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>. To create the pop-up menu item, call [CMFCPopupMenu::Create](../vs140/cmfcpopupmenu--create.md).  
