...
#### Parameters  
 ...
 A <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> object that specifies the virtual rectangle to be set.  
  
 [in] <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>  
 Specify <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> if <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> contains points relative to the parent window.  
