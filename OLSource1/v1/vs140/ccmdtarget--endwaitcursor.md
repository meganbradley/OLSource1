...
---
# CCmdTarget::EndWaitCursor
Call this function after you have called the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> member function to return from the hourglass cursor to the previous cursor.  
