...
## Return Value  
 A pointer to the [IUnknown](http://msdn.microsoft.com/library/windows/desktop/ms680509) interface of the OLE control represented by this <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> object. If this object does not represent an OLE control, the return value is **NULL**.  
