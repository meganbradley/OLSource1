...
-   The system could not retrieve the absolute path (<xref:System.ArgumentException?qualifyHint=False>).  
...
-   The combined path points to an existing directory (<xref:System.IO.IOException?qualifyHint=False>).  
  
-   The destination file exists and `overwrite` is set to `False` (<xref:System.IO.IOException?qualifyHint=False>).  
  
-   The user does not have sufficient permissions to access the file (<xref:System.IO.IOException?qualifyHint=False>).  
  
-   A file in the target folder with the same name is in use (<xref:System.IO.IOException?qualifyHint=False>).  
...
-   `ShowUI` is set to `True`, `onUserCancel` is set to `ThrowException`, and the user has cancelled the operation (<xref:System.OperationCanceledException?qualifyHint=False>).  
  
-   `ShowUI` is set to `True`, `onUserCancel` is set to `ThrowException`, and an unspecified I/O error occurs (<xref:System.OperationCanceledException?qualifyHint=False>).  
