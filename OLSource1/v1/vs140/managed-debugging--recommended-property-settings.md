...
Certain properties should be set the same way for all managed debugging scenarios.  
 ...
 Settings not listed here may vary among the different managed project types. For example, **Start Action** will be set differently in a Windows Forms project than in a [!INCLUDE[vstecasp](../vs140/includes/vstecasp_md.md)] project.  
...
|**Define DEBUG constant**|Select this check box to define the <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> constant, which enables your application to use the \<xref:System.Diagnostics.Debug*> class.|  
|**Define TRACE constant**|Select this check box to define the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> constant, which enables your application to use the \<xref:System.Diagnostics.Trace*> class.|  
  
## See Also  
 [Debugging Managed Code](../vs140/debugging-managed-code.md)   
 [Debugging Preparation: C# and Visual Basic Project Types](../vs140/debugging-preparation--csharp--fsharp--and-visual-basic-project-types.md)