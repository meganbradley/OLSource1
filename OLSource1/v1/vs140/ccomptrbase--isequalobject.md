...
---
# CComPtrBase::IsEqualObject
Call this method to check if the specified **IUnknown** points to the same object associated with the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> object.  
