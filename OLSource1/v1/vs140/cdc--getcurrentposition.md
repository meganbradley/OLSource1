...
## Return Value  
 The current position as a <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> object.  
  
## Remarks  
 The current position can be set with the <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> member function.  
