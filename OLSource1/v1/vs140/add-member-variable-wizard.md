...
-   If you are adding a member variable that is not a dialog box control, select from the list of available types.  
    ...
    |||  
    |-|-|  
    |<CodeContentPlaceHolder>0\</CodeContentPlaceHolder>|**short**|  
    |**double**|<CodeContentPlaceHolder>1\</CodeContentPlaceHolder>|  
 ...
 **Min value**  
 Available only when the variable type is **BOOL**, <CodeContentPlaceHolder>5\</CodeContentPlaceHolder>, **UINT**, **long**, <CodeContentPlaceHolder>6\</CodeContentPlaceHolder>, **float**, **double**, **BYTE**, **short**, [COLECurrency](../vs140/colecurrency-class.md) or [CTime](../vs140/ctime-class.md). Indicates the lowest value acceptable for a scale or date range.  
  
 **Max value**  
 Available only when the variable type is **BOOL**, <CodeContentPlaceHolder>7\</CodeContentPlaceHolder>, **UINT**, **long**, <CodeContentPlaceHolder>8\</CodeContentPlaceHolder>, **float**, **double**, **BYTE**, **short**, <CodeContentPlaceHolder>9\</CodeContentPlaceHolder> or <CodeContentPlaceHolder>10\</CodeContentPlaceHolder>. Indicates the highest value acceptable for a scale or date range.  
