...
2.  Obtain a marker type ID of the marker you are interested in by calling the \<xref:Microsoft.VisualStudio.TextManager.Interop.IVsTextManager.GetRegisteredMarkerTypeID*> method with the <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> of the text marker you wish to work with.  
  
    > [!NOTE]
    >  Do not use the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> of the VSPackage or of the service that provides the text marker.  
