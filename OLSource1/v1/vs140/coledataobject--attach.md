...
---
# COleDataObject::Attach
Call this function to associate the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> object with an OLE data object.  
 ...
 **TRUE** if the OLE data object should be released when the <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> object is destroyed; otherwise **FALSE**.  
