...
The .NET Framework class library reflection APIs can be used to examine the metadata in a .NET assembly and create collections of types, type members, parameters, and so on that are in that assembly. Because these collections support the generic <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> interface, they can be queried by using LINQ.  
