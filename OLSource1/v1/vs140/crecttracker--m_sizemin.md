...
## Remarks  
 Both default values, **cx** and **cy**, are calculated from the default system value for the border width. This data member is used only by the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> member function.  
