...
```  
 ...
 The \<xref:Microsoft.Build.Tasks.Windows.UpdateManifestForBrowserApplication*> task is run when an [!INCLUDE[TLA2#tla_xbap](../vs140/includes/tla2sharptla_xbap_md.md)] project is built in order to add the `<hostInBrowser />` element.  
