...
f1_keywords: 
  ...
  - "CStringT::FormatMessageV"
  - "ATL.CStringT.FormatMessageV"
  - "ATL::CStringT::FormatMessageV"
  - "FormatMessageV"
dev_langs: 
  - "C++"
helpviewer_keywords: 
  - "FormatMessageV method"
...
## Remarks  
 The function requires a message definition as input, determined by <CodeContentPlaceHolder>4\</CodeContentPlaceHolder>. The function copies the formatted message text and a variable list of arguments to the <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> object, processing any embedded insert sequences if requested.  
  
> [!NOTE]
>  <CodeContentPlaceHolder>6\</CodeContentPlaceHolder> calls [CStringT::FormatMessage](../vs140/cstringt--formatmessage.md), which attempts to allocate system memory for the newly formatted string. If this attempt fails, a memory exception is automatically thrown.  
