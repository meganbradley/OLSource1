...
4.  Locate the <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> element in the build configuration with which you’re building.  
  
     The following example shows the <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> element in bold text for the Debug build configuration on an x86 platform:  
  
<CodeContentPlaceHolder>0\</CodeContentPlaceHolder>  
5.  Add one or more warning numbers as the value of the <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> element. If you specify multiple warning numbers, separate them with a comma, as the following example shows.  
...
## See Also  
 ...
 [How to: View, Save, and Configure Build Log Files](../vs140/how-to--view--save--and-configure-build-log-files.md)   
