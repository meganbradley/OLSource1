...
## Remarks  
 This is also called structured storage. You typically call this function from the constructor of your <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>-derived class. For more information about compound documents, see the article [Containers: Compound Files](../vs140/containers--compound-files.md)..  
