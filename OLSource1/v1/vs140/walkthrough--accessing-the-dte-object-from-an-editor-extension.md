...
1.  Create a C# VSIX project named <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>. Add an Editor Classifier item template and name it <CodeContentPlaceHolder>4\</CodeContentPlaceHolder>. For more information, see [Creating an Extension with an Editor Item Template](../vs140/creating-an-extension-with-an-editor-item-template.md).  
...
3.  Go to the DTETest.cs file, and add the following <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> directives:  
  
<CodeContentPlaceHolder>0\</CodeContentPlaceHolder>  
4.  In the <CodeContentPlaceHolder>6\</CodeContentPlaceHolder> class, import a \<xref:Microsoft.VisualStudio.Shell.SVsServiceProvider*>.  
  
<CodeContentPlaceHolder>1\</CodeContentPlaceHolder>  
5.  In the <CodeContentPlaceHolder>7\</CodeContentPlaceHolder> method, add the following code.  
