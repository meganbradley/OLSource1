...
## Remarks  
 The following shows how the column type information is formatted in XML. <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> specifies the column's data type. Note that the data types are based on OLE DB data types, not those of the database being accessed.  
