 ...
 **END Microsoft Specific**  
 ...
 The first character of an identifier must be an alphabetic character, either uppercase or lowercase, or an underscore ( **_** ). Because C++ identifiers are case sensitive, <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> is different from <CodeContentPlaceHolder>5\</CodeContentPlaceHolder>.  
  
 Identifiers cannot be exactly the same spelling and case as keywords. Identifiers that contain keywords are legal. For example, <CodeContentPlaceHolder>6\</CodeContentPlaceHolder> is a legal identifier, even though it contains <CodeContentPlaceHolder>7\</CodeContentPlaceHolder>, which is a keyword.  
