...
#### Parameters  
 ...
 [in] Corresponds to <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> parameter to [IRowsetLocate::Hash](https://msdn.microsoft.com/en-us/library/ms709697.aspx).  
