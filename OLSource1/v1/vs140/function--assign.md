...
## Remarks  
 The member functions each replace the <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> held by <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> with the callable object passed as the <CodeContentPlaceHolder>6\</CodeContentPlaceHolder>. Both allocate storage with the allocator object <CodeContentPlaceHolder>7\</CodeContentPlaceHolder>.  
