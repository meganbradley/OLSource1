...
This topic demonstrates how to convert various Visual C++ string types into other strings. The strings types that are covered include `char *`, `wchar_t*`, [_bstr_t](../vs140/_bstr_t-class.md), [CComBSTR](../vs140/ccombstr-class.md), [CString](../vs140/using-cstring.md), [basic_string](../vs140/basic_string-class.md), and <xref:System.String?qualifyHint=True>. In all cases, a copy of the string is made when converted to the new type. Any changes made to the new string will not affect the original string, and vice versa.  
