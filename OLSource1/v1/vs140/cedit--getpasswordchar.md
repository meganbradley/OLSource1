...
## Return Value  
 Specifies the character to be displayed instead of the character that the user typed. The return value is <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> if no password character exists.  
...
## Example  
 [!code[NVC_MFC_CEdit#14](../vs140/codesnippet/CPP/cedit--getpasswordchar_1.cpp)]  
