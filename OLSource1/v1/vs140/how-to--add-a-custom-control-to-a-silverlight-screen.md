...
2.  In the method block, add code that binds the screen data to a property of the custom control.  
     ...
     [!code[LS_Screens#6](../vs140/codesnippet/CSharp/how-to--add-a-custom-control-to-a-silverlight-screen_1.cs)][!code[LS_Screens#6](../vs140/codesnippet/VisualBasic/how-to--add-a-custom-control-to-a-silverlight-screen_1.vb)]  
