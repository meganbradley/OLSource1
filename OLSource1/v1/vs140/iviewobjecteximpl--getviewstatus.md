...
## Remarks  
 By default, ATL sets <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> to indicate that the control supports **VIEWSTATUS_OPAQUE** (possible values are in the [VIEWSTATUS](http://msdn.microsoft.com/library/windows/desktop/ms687201) enumeration).  
