...
2.  Type the following commands at separate command prompts:  
    ...
    1.  <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> *%HeadNode% %FxPath%* <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>  
  
    2.  <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> *%HeadNode%* <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>  
  
    3.  <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> *%HeadNode% %ProfilerPath%* <CodeContentPlaceHolder>5\</CodeContentPlaceHolder>  
