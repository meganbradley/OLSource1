...
5.  For Microsoft C++, the text arguments of a preprocessor directive must be ASCII. For example, the directive, <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>, is not valid.