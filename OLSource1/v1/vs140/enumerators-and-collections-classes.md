...
-   [ICollectionOnSTLImpl](../vs140/icollectiononstlimpl-class.md) Provides the implementation for the **Count**, **Item**, and <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> properties of a collection interface.  
