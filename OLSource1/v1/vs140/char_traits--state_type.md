...
## Remarks  
 The type describes an object that can represent a conversion state. It is typically a synonym for <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>, but in any case it has essentially the same properties as that type.  
