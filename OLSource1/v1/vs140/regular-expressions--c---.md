...
-   A *bracket expression* of the form "[<CodeContentPlaceHolder>0\</CodeContentPlaceHolder>]", which matches a character or a collation element in the target sequence that is also in the set defined by the expression <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>, or of the form "[^<CodeContentPlaceHolder>2\</CodeContentPlaceHolder>]", which matches a character or a collation element in the target sequence that is not in the set defined by the expression <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>.  
  
     The expression <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> can contain any combination of the following things:  
  
    -   An individual character. Adds that character to the set defined by <CodeContentPlaceHolder>5\</CodeContentPlaceHolder>.  
  
    -   A *character range* of the form "<CodeContentPlaceHolder>6\</CodeContentPlaceHolder>-<CodeContentPlaceHolder>7\</CodeContentPlaceHolder>". Adds the characters that are represented by values in the closed range [<CodeContentPlaceHolder>8\</CodeContentPlaceHolder>, <CodeContentPlaceHolder>9\</CodeContentPlaceHolder>] to the set defined by <CodeContentPlaceHolder>10\</CodeContentPlaceHolder>.  
  
    -   A *character class* of the form "[:<CodeContentPlaceHolder>11\</CodeContentPlaceHolder>:]". Adds the characters in the named class to the set defined by <CodeContentPlaceHolder>12\</CodeContentPlaceHolder>.  
  
    -   An *equivalence class* of the form "[=<CodeContentPlaceHolder>13\</CodeContentPlaceHolder>=]". Adds the collating elements that are equivalent to <CodeContentPlaceHolder>14\</CodeContentPlaceHolder> to the set defined by <CodeContentPlaceHolder>15\</CodeContentPlaceHolder>.  
  
    -   A *collating symbol* of the form "[.<CodeContentPlaceHolder>16\</CodeContentPlaceHolder>.]". Adds the collation element <CodeContentPlaceHolder>17\</CodeContentPlaceHolder> to the set defined by <CodeContentPlaceHolder>18\</CodeContentPlaceHolder>.  
  
-   An *anchor*. Anchor '^' matches the beginning of the target sequence; anchor '$' matches the end of the target sequence.  
  
 A *capture group* of the form "( *subexpression* )", or "\\( *subexpression* \\)" in <CodeContentPlaceHolder>19\</CodeContentPlaceHolder> and <CodeContentPlaceHolder>20\</CodeContentPlaceHolder>, which matches the sequence of characters in the target sequence that is matched by the pattern between the delimiters.  
  
-   An *identity escape* of the form "\\<CodeContentPlaceHolder>21\</CodeContentPlaceHolder>", which matches the character <CodeContentPlaceHolder>22\</CodeContentPlaceHolder> in the target sequence.  
...
-   "(a)" matches the target sequence "a" and associates capture group 1 with the subsequence "a", but does not match the target sequences "B", "b", or "c".  
 ...
 In <CodeContentPlaceHolder>23\</CodeContentPlaceHolder>, <CodeContentPlaceHolder>24\</CodeContentPlaceHolder>, and <CodeContentPlaceHolder>25\</CodeContentPlaceHolder>, an element can also be a *back reference* of the form "\\<CodeContentPlaceHolder>26\</CodeContentPlaceHolder>", where <CodeContentPlaceHolder>27\</CodeContentPlaceHolder> represents a decimal value N that matches a sequence of characters in the target sequence that is the same as the sequence of characters that is matched by the Nth *capture group*. For example, "(a)\1" matches the target sequence "aa" because the first (and only) capture group matches the initial sequence "a" and then the \1 matches the final sequence "a".  
  
 In <CodeContentPlaceHolder>28\</CodeContentPlaceHolder>, an element can also be one of the following things:  
...
-   A *hexadecimal escape sequence* of the form "\x<CodeContentPlaceHolder>29\</CodeContentPlaceHolder>". Matches a character in the target sequence that is represented by the two hexadecimal digits <CodeContentPlaceHolder>30\</CodeContentPlaceHolder>.  
  
-   A *unicode escape sequence* of the form "\u<CodeContentPlaceHolder>31\</CodeContentPlaceHolder>". Matches a character in the target sequence that is represented by the four hexadecimal digits <CodeContentPlaceHolder>32\</CodeContentPlaceHolder>.  
  
-   A *control escape sequence* of the form "\c<CodeContentPlaceHolder>33\</CodeContentPlaceHolder>". Matches the control character that is named by the character <CodeContentPlaceHolder>34\</CodeContentPlaceHolder>.  
...
-   "a\B." matches the target sequence "ab", but does not match the target sequence "a~".  
 ...
 In <CodeContentPlaceHolder>35\</CodeContentPlaceHolder>, an element can also be one of the following things:  
...
-   An *octal escape sequence* of the form "\\<CodeContentPlaceHolder>36\</CodeContentPlaceHolder>". Matches a character in the target sequence whose representation is the value represented by the one, two, or three octal digits <CodeContentPlaceHolder>37\</CodeContentPlaceHolder>.  
  
### Repetition  
 Any element other than a *positive assert*, a *negative assert*, or an *anchor* can be followed by a repetition count. The most general kind of repetition count takes the form "{<CodeContentPlaceHolder>38\</CodeContentPlaceHolder>,<CodeContentPlaceHolder>39\</CodeContentPlaceHolder>}", or "\\{<CodeContentPlaceHolder>40\</CodeContentPlaceHolder>,<CodeContentPlaceHolder>41\</CodeContentPlaceHolder>\\}" in <CodeContentPlaceHolder>42\</CodeContentPlaceHolder> and <CodeContentPlaceHolder>43\</CodeContentPlaceHolder>. An element that is followed by this form of repetition count matches at least <CodeContentPlaceHolder>44\</CodeContentPlaceHolder> successive occurrences and no more than <CodeContentPlaceHolder>45\</CodeContentPlaceHolder> successive occurrences of a sequence that matches the element. For example, "a{2,3}" matches the target sequence "aa" and the target sequence "aaa", but not the target sequence "a" or the target sequence "aaaa".  
  
 A repetition count can also take one of the following forms:  
  
-   "{<CodeContentPlaceHolder>46\</CodeContentPlaceHolder>}", or "\\{<CodeContentPlaceHolder>47\</CodeContentPlaceHolder>\\}" in <CodeContentPlaceHolder>48\</CodeContentPlaceHolder> and <CodeContentPlaceHolder>49\</CodeContentPlaceHolder>. Equivalent to "{<CodeContentPlaceHolder>50\</CodeContentPlaceHolder>,<CodeContentPlaceHolder>51\</CodeContentPlaceHolder>}".  
  
-   "{<CodeContentPlaceHolder>52\</CodeContentPlaceHolder>,}", or "\\{<CodeContentPlaceHolder>53\</CodeContentPlaceHolder>,\\}" in <CodeContentPlaceHolder>54\</CodeContentPlaceHolder> and <CodeContentPlaceHolder>55\</CodeContentPlaceHolder>. Equivalent to "{<CodeContentPlaceHolder>56\</CodeContentPlaceHolder>,unbounded}".  
...
-   "a*" matches the target sequence "", the target sequence "a", the target sequence "aa", and so on.  
 ...
 For all grammars except <CodeContentPlaceHolder>57\</CodeContentPlaceHolder> and <CodeContentPlaceHolder>58\</CodeContentPlaceHolder>, a repetition count can also take one of the following forms:  
...
-   "a+" matches the target sequence "a", the target sequence "aa", and so on, but not the target sequence "".  
 ...
 In <CodeContentPlaceHolder>59\</CodeContentPlaceHolder>, all the forms of repetition count can be followed by the character '?', which designates a *non-greedy repetition*.  
...
### Alternation  
 In all regular expression grammars except <CodeContentPlaceHolder>60\</CodeContentPlaceHolder> and <CodeContentPlaceHolder>61\</CodeContentPlaceHolder>, a concatenated regular expression can be followed by the character '&#124;' and another concatenated regular expression. Any number of concatenated regular expressions can be combined in this manner. The resulting expression matches any target sequence that matches one or more of the concatenated regular expressions.  
  
 When more than one of the concatenated regular expressions matches the target sequence, <CodeContentPlaceHolder>62\</CodeContentPlaceHolder> chooses the first of the concatenated regular expressions that matches the sequence as the match (*first match*); the other regular expression grammars choose the one that achieves the *longest match*. For example, "ab&#124;cd" matches the target sequence "ab" and the target sequence "cd", but does not match the target sequence "abd" or the target sequence "acd".  
  
 In <CodeContentPlaceHolder>63\</CodeContentPlaceHolder> and <CodeContentPlaceHolder>64\</CodeContentPlaceHolder>, a newline character ('\n') can be used to separate alternations.  
  
### Subexpression  
 In <CodeContentPlaceHolder>65\</CodeContentPlaceHolder> and <CodeContentPlaceHolder>66\</CodeContentPlaceHolder>, a subexpression is a concatenation. In the other regular expression grammars, a subexpression is an alternation.  
...
### Back Reference  
 A back reference is a backslash that is followed by a decimal value N. It matches the contents of the Nth *capture group*. The value of N must not be more than the number of capture groups that precede the back reference. In <CodeContentPlaceHolder>67\</CodeContentPlaceHolder> and <CodeContentPlaceHolder>68\</CodeContentPlaceHolder>, the value of N is determined by the decimal digit that follows the backslash. In <CodeContentPlaceHolder>69\</CodeContentPlaceHolder>, the value of N is determined by all the decimal digits that immediately follow the backslash. Therefore, in <CodeContentPlaceHolder>70\</CodeContentPlaceHolder> and <CodeContentPlaceHolder>71\</CodeContentPlaceHolder>, the value of N is never more than 9, even if the regular expression has more than nine capture groups. In <CodeContentPlaceHolder>72\</CodeContentPlaceHolder>, the value of N is unbounded.  
...
-   "(b(((((((((a))))))))))\10" has different meanings in <CodeContentPlaceHolder>73\</CodeContentPlaceHolder> and in <CodeContentPlaceHolder>74\</CodeContentPlaceHolder>. In <CodeContentPlaceHolder>75\</CodeContentPlaceHolder> the back reference is "\1". The back reference matches the contents of the first capture group (that is, the one that begins with "(b" and ends with the final ")" and comes before the back reference), and the final '0' matches the ordinary character '0'. In <CodeContentPlaceHolder>76\</CodeContentPlaceHolder>, the back reference is "\10". It matches the tenth capture group, that is, the innermost one.  
...
### Character Class  
 A character class in a bracket expression adds all the characters in the named class to the character set that is defined by the bracket expression. To create a character class, use "[:" followed by the name of the class followed by ":]". Internally, names of character classes are recognized by calling <CodeContentPlaceHolder>77\</CodeContentPlaceHolder>. A character <CodeContentPlaceHolder>78\</CodeContentPlaceHolder> belongs to such a class if <CodeContentPlaceHolder>79\</CodeContentPlaceHolder> returns true. The default <CodeContentPlaceHolder>80\</CodeContentPlaceHolder> template supports the class names in the following table.  
...
### Equivalence Class  
 An equivalence class in a bracket expression adds all the characters and *collating elements* that are equivalent to the collating element in the equivalence class definition to the set that is defined by the bracket expression. To create an equivalence class, use "[=" followed by a collating element followed by "=]". Internally, two collating elements <CodeContentPlaceHolder>81\</CodeContentPlaceHolder> and <CodeContentPlaceHolder>82\</CodeContentPlaceHolder> are equivalent if <CodeContentPlaceHolder>83\</CodeContentPlaceHolder>.  
  
### File Format Escape  
 A file format escape consists of the usual C language character escape sequences, "\\\\", "\a", "\b", "\f", "\n", "\r", "\t", "\v".These have the usual meanings, that is, backslash, alert, backspace, form feed, newline, carriage return, horizontal tab, and vertical tab, respectively. In <CodeContentPlaceHolder>84\</CodeContentPlaceHolder>, "\a" and "\b" are not allowed. ("\\\\" is allowed, but it is an identity escape, not a file format escape).  
...
|<CodeContentPlaceHolder>89\</CodeContentPlaceHolder>|<CodeContentPlaceHolder>90\</CodeContentPlaceHolder> plus { '"', '/' }|  
|<CodeContentPlaceHolder>91\</CodeContentPlaceHolder>|All characters except those that can be part of an identifier. Typically, this includes letters, digits, '$', '_', and unicode escape sequences. For more information, see the ECMAScript Language Specification.|  
...
-   "[a^bc]" matches the target sequences "a", "b", "c", and "^", but not the target sequence "d".  
 ...
 In all regular expression grammars except <CodeContentPlaceHolder>92\</CodeContentPlaceHolder>, if a ']' is the first character that follows the opening '[' or is the first character that follows an initial '^', it represents itself.  
...
-   "[^]abc]" matches the target sequence "d", but not the target sequences "a", "b", "c", or "]".  
 ...
 In <CodeContentPlaceHolder>93\</CodeContentPlaceHolder>, use '\\]' to represent the character ']' in a bracket expression.  
...
### Ordinary Character  
 ...
 In <CodeContentPlaceHolder>94\</CodeContentPlaceHolder>, the following characters have special meanings:  
  
-   ^  $  \  .  *  +  ?  (  )  [  ]  {  }  &#124;  
  
 In <CodeContentPlaceHolder>95\</CodeContentPlaceHolder> and <CodeContentPlaceHolder>96\</CodeContentPlaceHolder>, the following characters have special meanings:  
  
-   .   [   \  
  
 Also in <CodeContentPlaceHolder>97\</CodeContentPlaceHolder> and <CodeContentPlaceHolder>98\</CodeContentPlaceHolder>, the following characters have special meanings when they are used in a particular context:  
...
-   '$' has a special meaning when it is the last character of a regular expression.  
 ...
 In <CodeContentPlaceHolder>99\</CodeContentPlaceHolder>, <CodeContentPlaceHolder>100\</CodeContentPlaceHolder>, and <CodeContentPlaceHolder>101\</CodeContentPlaceHolder>, the following characters have special meanings:  
  
-   .   [   \   (   *   +   ?   {   &#124;  
  
 Also in <CodeContentPlaceHolder>102\</CodeContentPlaceHolder>, <CodeContentPlaceHolder>103\</CodeContentPlaceHolder>, and <CodeContentPlaceHolder>104\</CodeContentPlaceHolder>, the following characters have special meanings when they are used in a particular context.  
...
-   '$' has a special meaning when it is the last character of a regular expression.  
 ...
 An ordinary character matches the same character in the target sequence. By default, this means that the match succeeds if the two characters are represented by the same value. In a case-insensitive match, two characters <CodeContentPlaceHolder>105\</CodeContentPlaceHolder> and <CodeContentPlaceHolder>106\</CodeContentPlaceHolder> match if <CodeContentPlaceHolder>107\</CodeContentPlaceHolder>. In a locale-sensitive match, two characters <CodeContentPlaceHolder>108\</CodeContentPlaceHolder> and <CodeContentPlaceHolder>109\</CodeContentPlaceHolder> match if <CodeContentPlaceHolder>110\</CodeContentPlaceHolder>.  
...
-   The current character is at the beginning of the target sequence and is one of the word characters <CodeContentPlaceHolder>111\</CodeContentPlaceHolder>  
...
|-----------------------------|----------------------|----------------------|  
|"$&"|"&"|The character sequence that matches the entire regular expression (<CodeContentPlaceHolder>112\</CodeContentPlaceHolder>)|  
|"$$"||"$"|  
||"\\&"|"&"|  
|"$<CodeContentPlaceHolder>113\</CodeContentPlaceHolder>[match.prefix().first, match.prefix().second)<CodeContentPlaceHolder>114\</CodeContentPlaceHolder>[match.suffix().first, match.suffix().second)<CodeContentPlaceHolder>115\</CodeContentPlaceHolder>n<CodeContentPlaceHolder>116\</CodeContentPlaceHolder>n<CodeContentPlaceHolder>117\</CodeContentPlaceHolder>[match[n].first, match[n].second)<CodeContentPlaceHolder>118\</CodeContentPlaceHolder>nn<CodeContentPlaceHolder>119\</CodeContentPlaceHolder>nn<CodeContentPlaceHolder>120\</CodeContentPlaceHolder>[match[nn].first, match[nn].second)`|  
