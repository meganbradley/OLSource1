...
#### Parameters  
 ...
 A string that contains a set of valid characters. <CodeContentPlaceHolder>9\</CodeContentPlaceHolder> indicates that all characters are valid. The default value of this parameter is <CodeContentPlaceHolder>10\</CodeContentPlaceHolder>.  
  
## Remarks  
 Use this method to create the mask for the masked edit control. Derive a class from the <CodeContentPlaceHolder>11\</CodeContentPlaceHolder> class and override the [CMFCMaskedEdit::IsMaskedChar](../vs140/cmfcmaskededit--ismaskedchar.md) method to use your own code for custom mask processing.  
