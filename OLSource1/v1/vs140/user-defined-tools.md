...
## Enabling user-defined tools support  
 ...
 [!code[NVC_MFC_VisualStudioDemo#1](../vs140/codesnippet/CPP/user-defined-tools_1.cpp)]  
...
3.  For each tool, set its text label by setting <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> and set its command by calling <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>. The default implementation of [CUserTool](../vs140/cusertool-class.md) automatically retrieves available icons from the program that is specified in the call to <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>.  
