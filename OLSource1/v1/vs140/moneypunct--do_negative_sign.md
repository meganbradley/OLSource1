...
## Example  
 See the example for [negative_sign](../vs140/moneypunct--negative_sign.md), where the virtual member function is called by <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>.  
