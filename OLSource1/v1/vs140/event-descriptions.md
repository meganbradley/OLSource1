...
|Document text events|Occur when text in a document is changed. These events are not sent through the <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> method.|  
