...
-   `attributelist`  
     ...
     The <xref:System.FlagsAttribute?qualifyHint=False> attribute indicates that the value of an instance of the enumeration can include multiple enumeration members, and that each member represents a bit field in the enumeration value.  
...
## Assigning Multiple Values  
 Enumerations typically represent mutually exclusive values. By including the <xref:System.FlagsAttribute?qualifyHint=False> attribute in the `Enum` declaration, you can instead assign multiple values to an instance of the enumeration. The <xref:System.FlagsAttribute?qualifyHint=False> attribute specifies that the enumeration be treated as a bit field, that is, a set of flags. These are called *bitwise* enumerations.  
  
 When you declare an enumeration by using the <xref:System.FlagsAttribute?qualifyHint=False> attribute, we recommend that you use powers of 2, that is, 1, 2, 4, 8, 16, and so on, for the values. We also recommend that "None" be the name of a member whose value is 0. For additional guidelines, see <xref:System.FlagsAttribute?qualifyHint=False> and <xref:System.Enum?qualifyHint=False>.  
...
## Example  
 The following example shows how to use a bitwise enumeration. Multiple values can be assigned to an instance of a bitwise enumeration. The `Enum` declaration includes the <xref:System.FlagsAttribute?qualifyHint=False> attribute, which indicates that the enumeration can be treated as a set of flags.  
  
 [!code[VbEnumsTask#61](../vs140/codesnippet/VisualBasic/enum-statement--visual-basic-_6.vb)]
  
  
## Example  
 The following example iterates through an enumeration. It uses the <xref:System.Enum.GetNames?qualifyHint=False> method to retrieve an array of member names from the enumeration, and <xref:System.Enum.GetValues?qualifyHint=False> to retrieve an array of member values.  
  
 [!code[VbEnumsTask#51](../vs140/codesnippet/VisualBasic/enum-statement--visual-basic-_7.vb)]
  
  
## See Also  
 <xref:System.Enum?qualifyHint=False>   
