...
-   <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>  
     ...
     Optional. List of attributes that apply to this enumeration. You must enclose the [attribute list](../vs140/attribute-list--visual-basic-.md) in angle brackets ("<CodeContentPlaceHolder>2\</CodeContentPlaceHolder>" and "<CodeContentPlaceHolder>3\</CodeContentPlaceHolder>").  
...
-   <CodeContentPlaceHolder>4\</CodeContentPlaceHolder>  
    ...
    -   [Private](../vs140/private--visual-basic-.md)  
     ...
     You can specify <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> to allow access from code within the enumeration's class, a derived class, or the same assembly.  
...
-   <CodeContentPlaceHolder>9\</CodeContentPlaceHolder>  
     ...
     Each <CodeContentPlaceHolder>10\</CodeContentPlaceHolder> has the following syntax and parts: <CodeContentPlaceHolder>11\</CodeContentPlaceHolder>  
  
    |||  
    |-|-|  
    |Part|Description|  
    |<CodeContentPlaceHolder>12\</CodeContentPlaceHolder>|Required. Name of this member.|  
    |<CodeContentPlaceHolder>13\</CodeContentPlaceHolder>|Optional. Expression that is evaluated at compile time and assigned to this member.|  
  
-   <CodeContentPlaceHolder>14\</CodeContentPlaceHolder> <CodeContentPlaceHolder>15\</CodeContentPlaceHolder>  
  
     Terminates the <CodeContentPlaceHolder>16\</CodeContentPlaceHolder> block.  
...
## Data Type  
 The <CodeContentPlaceHolder>17\</CodeContentPlaceHolder> statement can declare the data type of an enumeration. Each member takes the enumeration's data type. You can specify <CodeContentPlaceHolder>18\</CodeContentPlaceHolder>, <CodeContentPlaceHolder>19\</CodeContentPlaceHolder>, <CodeContentPlaceHolder>20\</CodeContentPlaceHolder>, <CodeContentPlaceHolder>21\</CodeContentPlaceHolder>, <CodeContentPlaceHolder>22\</CodeContentPlaceHolder>, <CodeContentPlaceHolder>23\</CodeContentPlaceHolder>, <CodeContentPlaceHolder>24\</CodeContentPlaceHolder>, or <CodeContentPlaceHolder>25\</CodeContentPlaceHolder>.  
  
 If you do not specify <CodeContentPlaceHolder>26\</CodeContentPlaceHolder> for the enumeration, each member takes the data type of its <CodeContentPlaceHolder>27\</CodeContentPlaceHolder>. If you specify both <CodeContentPlaceHolder>28\</CodeContentPlaceHolder> and <CodeContentPlaceHolder>29\</CodeContentPlaceHolder>, the data type of <CodeContentPlaceHolder>30\</CodeContentPlaceHolder> must be convertible to <CodeContentPlaceHolder>31\</CodeContentPlaceHolder>. If neither <CodeContentPlaceHolder>32\</CodeContentPlaceHolder> nor <CodeContentPlaceHolder>33\</CodeContentPlaceHolder> is present, the data type defaults to <CodeContentPlaceHolder>34\</CodeContentPlaceHolder>.  
  
## Initializing Members  
 The <CodeContentPlaceHolder>35\</CodeContentPlaceHolder> statement can initialize the contents of selected members in <CodeContentPlaceHolder>36\</CodeContentPlaceHolder>. You use <CodeContentPlaceHolder>37\</CodeContentPlaceHolder> to supply an expression to be assigned to the member.  
  
 If you do not specify <CodeContentPlaceHolder>38\</CodeContentPlaceHolder> for a member, Visual Basic initializes it either to zero (if it is the first <CodeContentPlaceHolder>39\</CodeContentPlaceHolder> in <CodeContentPlaceHolder>40\</CodeContentPlaceHolder>), or to a value greater by one than that of the immediately preceding <CodeContentPlaceHolder>41\</CodeContentPlaceHolder>.  
  
 The expression supplied in each <CodeContentPlaceHolder>42\</CodeContentPlaceHolder> can be any combination of literals, other constants that are already defined, and enumeration members that are already defined, including a previous member of this enumeration. You can use arithmetic and logical operators to combine such elements.  
  
 You cannot use variables or functions in <CodeContentPlaceHolder>43\</CodeContentPlaceHolder>. However, you can use conversion keywords such as <CodeContentPlaceHolder>44\</CodeContentPlaceHolder> and <CodeContentPlaceHolder>45\</CodeContentPlaceHolder>. You can also use <CodeContentPlaceHolder>46\</CodeContentPlaceHolder> if you call it with a constant <CodeContentPlaceHolder>47\</CodeContentPlaceHolder> or <CodeContentPlaceHolder>48\</CodeContentPlaceHolder> argument, since that can be evaluated at compile time.  
  
 Enumerations cannot have floating-point values. If a member is assigned a floating-point value and <CodeContentPlaceHolder>49\</CodeContentPlaceHolder> is set to on, a compiler error occurs. If <CodeContentPlaceHolder>50\</CodeContentPlaceHolder> is off, the value is automatically converted to the <CodeContentPlaceHolder>51\</CodeContentPlaceHolder> type.  
...
## Modifiers  
 ...
 By default, all enumerations are types and their fields are constants. Therefore the <CodeContentPlaceHolder>52\</CodeContentPlaceHolder>, <CodeContentPlaceHolder>53\</CodeContentPlaceHolder>, and <CodeContentPlaceHolder>54\</CodeContentPlaceHolder> keywords cannot be used when declaring an enumeration or its members.  
  
## Assigning Multiple Values  
 Enumerations typically represent mutually exclusive values. By including the \<xref:System.FlagsAttribute*> attribute in the <CodeContentPlaceHolder>55\</CodeContentPlaceHolder> declaration, you can instead assign multiple values to an instance of the enumeration. The \<xref:System.FlagsAttribute*> attribute specifies that the enumeration be treated as a bit field, that is, a set of flags. These are called *bitwise* enumerations.  
...
## Example  
 The following example shows how to use the <CodeContentPlaceHolder>56\</CodeContentPlaceHolder> statement. Note that the member is referred to as <CodeContentPlaceHolder>57\</CodeContentPlaceHolder>, and not as <CodeContentPlaceHolder>58\</CodeContentPlaceHolder>.  
  
 [!code[VbEnumsTask#41](../vs140/codesnippet/VisualBasic/enum-statement--visual-basic-_1.vb)]  
  
## Example  
 The method in the following example is outside the <CodeContentPlaceHolder>59\</CodeContentPlaceHolder> class. Therefore, <CodeContentPlaceHolder>60\</CodeContentPlaceHolder> is fully qualified as <CodeContentPlaceHolder>61\</CodeContentPlaceHolder>.  
  
 [!code[VbEnumsTask#42](../vs140/codesnippet/VisualBasic/enum-statement--visual-basic-_2.vb)]  
  
## Example  
 The following example uses the <CodeContentPlaceHolder>62\</CodeContentPlaceHolder> statement to define a related set of named constant values. In this case, the values are colors you might choose to design data entry forms for a database.  
...
## Example  
 In the following example, an <CodeContentPlaceHolder>63\</CodeContentPlaceHolder> clause is used to specify the <CodeContentPlaceHolder>64\</CodeContentPlaceHolder> of an enumeration.  
  
 [!code[VbEnumsTask#6](../vs140/codesnippet/VisualBasic/enum-statement--visual-basic-_5.vb)]  
  
## Example  
 The following example shows how to use a bitwise enumeration. Multiple values can be assigned to an instance of a bitwise enumeration. The <CodeContentPlaceHolder>65\</CodeContentPlaceHolder> declaration includes the \<xref:System.FlagsAttribute*> attribute, which indicates that the enumeration can be treated as a set of flags.  
