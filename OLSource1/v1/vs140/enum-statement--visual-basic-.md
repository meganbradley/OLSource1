...
## Example  
 The following example iterates through an enumeration. It uses the [GetNames](assetId:///M:System.Enum.GetNames(System.Type)?qualifyHint=False&autoUpgrade=True) method to retrieve an array of member names from the enumeration, and [GetValues](assetId:///M:System.Enum.GetValues(System.Type)?qualifyHint=False&autoUpgrade=True) to retrieve an array of member values.  
