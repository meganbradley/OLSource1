...
5.  Call the \<xref:Microsoft.VisualStudio.Shell.Interop.IVsDocDataFileChangeControl.IgnoreFileChanges*> method to notify the \<xref:Microsoft.VisualStudio.TextManager.Interop.VsTextBuffer*> object to resume monitoring for file change notifications by setting the <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> parameter to <CodeContentPlaceHolder>4\</CodeContentPlaceHolder>.  
