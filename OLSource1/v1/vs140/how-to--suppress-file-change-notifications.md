...
5.  Call the assetId:///M:Microsoft.VisualStudio.Shell.Interop.IVsDocDataFileChangeControl.IgnoreFileChanges(System.Int32)?qualifyHint=False&autoUpgrade=True method to notify the <xref:Microsoft.VisualStudio.TextManager.Interop.VsTextBuffer*> object to resume monitoring for file change notifications by setting the `fIgnore` parameter to `false`.  
