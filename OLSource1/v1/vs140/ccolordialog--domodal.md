...
## Remarks  
 If you want to initialize the various color dialog-box options by setting members of the [m_cc](../vs140/ccolordialog--m_cc.md) structure, you should do this before calling <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> but after the dialog-box object is constructed.  
  
 After calling <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>, you can call other member functions to retrieve the settings or information input by the user into the dialog box.  
