...
Define macros in a command line, command file, makefile, or the Tools.ini file.  
 ...
 In a command line or command file, spaces and tabs delimit arguments and cannot surround the equal sign. If <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> has embedded spaces or tabs, enclose either the string itself or the entire macro in double quotation marks (" ").  
