...
Class <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> provides a group of member functions that control the various attributes of the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> object and the tool tip window.  
