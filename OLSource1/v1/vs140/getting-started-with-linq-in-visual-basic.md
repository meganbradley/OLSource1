...
## In This Section  
 [Three Parts of a LINQ Query (Visual Basic)](../vs140/writing-your-first-linq-query--visual-basic-.md)  
 ...
 [Basic Query Operators (Visual Basic)](../vs140/basic-query-operations--visual-basic-.md)  
 Describes the most common types of query operations and how they are expressed in Visual Basic.  
  
 [Visual Basic 9.0 Features Supporting LINQ](../vs140/visual-basic-features-that-support-linq.md)  
 Describes the Visual Basic language features that support LINQ, such as anonymous types and type inference.  
  
 [Type Relationships in Query Operations (Visual Basic)](../vs140/type-relationships-in-query-operations--visual-basic-.md)  
