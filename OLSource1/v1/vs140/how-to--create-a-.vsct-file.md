...
7.  In the XML file, type <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> and then press TAB. Close the tag by typing <CodeContentPlaceHolder>4\</CodeContentPlaceHolder>.  
...
<CodeContentPlaceHolder>0\</CodeContentPlaceHolder>  
     The ResourceName element should always be set to <CodeContentPlaceHolder>5\</CodeContentPlaceHolder>.  
