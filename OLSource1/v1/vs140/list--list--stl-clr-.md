...
## Remarks  
 ...
 initializes the controlled sequence with the sequence <CodeContentPlaceHolder>4\</CodeContentPlaceHolder>[begin](../vs140/list--begin--stl-clr-.md)<CodeContentPlaceHolder>5\</CodeContentPlaceHolder> <CodeContentPlaceHolder>6\</CodeContentPlaceHolder>[end](../vs140/list--end--stl-clr-.md)<CodeContentPlaceHolder>7\</CodeContentPlaceHolder>. You use it to specify an initial controlled sequence that is a copy of the sequence controlled by the list object <CodeContentPlaceHolder>8\</CodeContentPlaceHolder>.  
  
 The constructor:  
  
 <CodeContentPlaceHolder>9\</CodeContentPlaceHolder>  
  
 initializes the controlled sequence with the sequence <CodeContentPlaceHolder>10\</CodeContentPlaceHolder>[begin](../vs140/list--begin--stl-clr-.md)<CodeContentPlaceHolder>11\</CodeContentPlaceHolder> <CodeContentPlaceHolder>12\</CodeContentPlaceHolder>[end](../vs140/list--end--stl-clr-.md)<CodeContentPlaceHolder>13\</CodeContentPlaceHolder>. You use it to specify an initial controlled sequence that is a copy of the sequence controlled by the list object whose handle is <CodeContentPlaceHolder>14\</CodeContentPlaceHolder>.  
