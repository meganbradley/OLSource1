...
## Cause  
 A tranparent type or method is declaratively marked with a \<xref:System.Security.Permissions.SecurityAction*?displayProperty=fullName><CodeContentPlaceHolder>0\</CodeContentPlaceHolder> demand or the method calls the \<xref:System.Security.CodeAccessPermission.Demand*?displayProperty=fullName> method.  
