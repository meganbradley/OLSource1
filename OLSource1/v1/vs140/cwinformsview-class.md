...
> [!NOTE]
>  CWinFormsView does not support the MFC splitter window ( [CSplitterWnd Class](../vs140/csplitterwnd-class.md)). Currently only the Windows Forms Splitter control ( <xref:System.Windows.Forms.Splitter?qualifyHint=False>) is supported.  
