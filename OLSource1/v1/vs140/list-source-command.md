...
## Switches  
 /Count:<CodeContentPlaceHolder>2\</CodeContentPlaceHolder>  
 Optional. Specifies the number of lines to display.  
  
 /Current  
 Optional. Shows the current line.  
  
 /File:<CodeContentPlaceHolder>3\</CodeContentPlaceHolder>  
 ...
 /Line:<CodeContentPlaceHolder>4\</CodeContentPlaceHolder>  
 Optional. Shows a specific line number.  
  
 /ShowLineNumbers:<CodeContentPlaceHolder>5\</CodeContentPlaceHolder>  
