...
apitype: "Assembly"
f1_keywords: 
  - "Microsoft.FSharp.Quotations.PatternsModule.SequentialPattern"
dev_langs: 
  - "FSharp"
helpviewer_keywords: 
  - "Sequential active pattern [F#]"
...
## Return Value  
 The formal return type is <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>. The option indicates whether the input results in a match. In a pattern matching expression, upon a successful match, the input, a single expression, is decomposed into two expressions.  
