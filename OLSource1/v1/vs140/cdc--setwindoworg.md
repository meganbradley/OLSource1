 ...
 *y*  
 ...
 Specifies the logical coordinates of the new origin of the window. You can pass either a **POINT** structure or a <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> object for this parameter.  
  
## Return Value  
 The previous origin of the window as a <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> object.  
