...
## Remarks  
 You typically do not need to call this function explicitly; it is called by the destructors for <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> and <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>.  
