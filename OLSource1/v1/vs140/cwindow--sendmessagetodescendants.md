...
---
# CWindow::SendMessageToDescendants
Sends the specified message to all immediate children of the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> object.  
...
## Remarks  
 If <CodeContentPlaceHolder>6\</CodeContentPlaceHolder> is **TRUE**, the message is additionally sent to all other descendant windows.  
