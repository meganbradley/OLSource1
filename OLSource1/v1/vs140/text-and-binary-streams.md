...
-   Partial lines (by omitting the <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> at the end of a file).  
  
-   characters other than the printable characters, NL, and <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> (horizontal tab).  
