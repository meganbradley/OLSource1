...
## Remarks  
 ...
 <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> is initialized by the constructor. For an example, see the [CContainedWindowT](../vs140/ccontainedwindowt-class.md) overview.  
