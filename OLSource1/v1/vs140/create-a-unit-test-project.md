...
5.  If the code that you want to test is in another location, see [Managing Project References](../vs140/managing-references-in-a-project.md) for information about adding references.  
 ...
 **Running unit tests**  
 ...
 [Running Unit Tests with Unit Test Explorer](../vs140/run-unit-tests-with-test-explorer.md)