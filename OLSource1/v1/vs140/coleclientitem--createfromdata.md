...
---
# COleClientItem::CreateFromData
Call this function to create an embedded item from a <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> object.  
...
## Remarks  
 Data transfer operations, such as pasting from the Clipboard or drag-and-drop operations, provide <CodeContentPlaceHolder>6\</CodeContentPlaceHolder> objects containing the information offered by a server application. It is usually used in your override of [CView::OnDrop](../vs140/cview--ondrop.md).  
