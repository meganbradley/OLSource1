...
## Return Value  
 <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> if the toolbar has a sibling and the toolbar and its sibling are positioned on the same pane; otherwise <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>.  
  
## Remarks  
 The internal CMFCCustomizeButton::CreatePopupMenu method calls this method to determine how to show the **Customize** pop-up menu. If this method returns <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>, the framework displays the **Show Buttons on One Row** or **Show Buttons on Two Rows** buttons.  
