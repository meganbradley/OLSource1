...
1.  Specify it in a registry key:  
     ...
     and add a (Default) subkey that has a value of <CodeContentPlaceHolder>15\</CodeContentPlaceHolder>.  
  
2.  Add the MSBuild property <CodeContentPlaceHolder>16\</CodeContentPlaceHolder> to your project file. The value of this property is a semi colon delimited list of directories in which the Extension SDKs you want to reference reside.  
