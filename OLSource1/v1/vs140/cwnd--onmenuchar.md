...
#### Parameters  
 ...
 Contains a pointer to the selected <CodeContentPlaceHolder>4\</CodeContentPlaceHolder>. The pointer may be temporary and should not be stored.  
...
## Remarks  
 It is sent to the <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> that owns the menu. <CodeContentPlaceHolder>6\</CodeContentPlaceHolder> is also called when the user presses ALT and any other key, even if the key does not correspond to a mnemonic character. In this case, <CodeContentPlaceHolder>7\</CodeContentPlaceHolder> points to the menu owned by the <CodeContentPlaceHolder>8\</CodeContentPlaceHolder>, and <CodeContentPlaceHolder>9\</CodeContentPlaceHolder> is 0.  
