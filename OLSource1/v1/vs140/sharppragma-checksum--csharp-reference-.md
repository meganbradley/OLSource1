...
## Remarks  
 ...
 This solution does not work for [!INCLUDE[vstecasp](../vs140/includes/vstecasp_md.md)] projects, because the computed checksum is for the generated source file, rather than the .aspx file. To address this problem, <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> provides checksum support for [!INCLUDE[vstecasp](../vs140/includes/vstecasp_md.md)] pages.  
 ...
 If the compiler encounters no <CodeContentPlaceHolder>6\</CodeContentPlaceHolder> directive in the file, it computes the checksum and writes the value to the PDB file.  
