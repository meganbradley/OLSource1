...
## Return Value  
 <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> if this pane can be docked at the specified docking pane; otherwise, <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>.  
