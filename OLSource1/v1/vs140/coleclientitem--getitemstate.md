...
## Return Value  
 A **COleClientItem::ItemState** enumerated value, which can be one of the following: <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>, **loadedState**, <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>, <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>, <CodeContentPlaceHolder>4\</CodeContentPlaceHolder>. For information about these states, see the article [Containers: Client-Item States](../vs140/containers--client-item-states.md).  
