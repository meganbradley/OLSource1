...
<CodeContentPlaceHolder>0\</CodeContentPlaceHolder>  
 We’ll assume that the expected value of <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> after calling <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> is 20 (the result of incrementing <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> 20 times). (We’ll also assume that you can’t see the bug in <CodeContentPlaceHolder>4\</CodeContentPlaceHolder>).But the result is actually 44. How can we find the bug without stepping through <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> 10 times? We can use Historical Debugging to find the bug faster and more easily. Here’s how:  
...
2.  Set a breakpoint on the <CodeContentPlaceHolder>6\</CodeContentPlaceHolder> line.  
  
3.  Start debugging. The code executes to the breakpoint. In the **Locals** window, you can see that the value of <CodeContentPlaceHolder>7\</CodeContentPlaceHolder> is 44.  
...
5.  You should see a double arrow next to the left margin, just above the breakpoint. This area is called the navigation gutter, and is used for Historical Debugging. Click the arrow.  
     ...
     In the code window, you should see that the preceding line of code (<CodeContentPlaceHolder>8\</CodeContentPlaceHolder>) is colored pink. Above the window, you should see a message that you are now in Historical Debugging.  
...
6.  Now you can step into the <CodeContentPlaceHolder>9\</CodeContentPlaceHolder> method (**F11**, or the **Step Into** button in the navigation gutter. Step forward (**F10**, or **Go to Next Call** in the navigation gutter. The pink line is now on the <CodeContentPlaceHolder>10\</CodeContentPlaceHolder> line. **F10** in this case does not step to the next line of code. Instead, it steps to the next function call. Historical debugging navigates from call to call, and it skips lines of code that do not include a function call.  
  
7.  Now step into the <CodeContentPlaceHolder>11\</CodeContentPlaceHolder> method. You should see the bug in this code immediately.  
