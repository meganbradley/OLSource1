...
You have attempted to use a unary operator (<CodeContentPlaceHolder>0\</CodeContentPlaceHolder>, <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>, or <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>) on a type, such as a <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>, for which it is not defined.  
