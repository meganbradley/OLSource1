...
-   <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> -- specifies that a function never returns; in other words it always throws an exception. The compiler can adjust its compilation rules for [[noreturn]] entities.  
