...
## Remarks  
 ...
 This method associates an image list with the task pane control. To set the icon for a task when you call [CMFCTasksPane::AddTask](../vs140/cmfctaskspane--addtask.md), set <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> to the appropriate zero-based index in this image list.  
