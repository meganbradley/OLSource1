...
|---------------|-----------------|  
|[in] <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>|Specifies the horizontal padding of the toolbar control, in pixels.|  
|[in] <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>|Specifies the vertical padding of the toolbar control, in pixels.|  
  
## Return Value  
 A <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> whose low word contains the previous horizontal padding value, and whose high word contains the previous vertical padding value. The padding values are measured in pixels.  
