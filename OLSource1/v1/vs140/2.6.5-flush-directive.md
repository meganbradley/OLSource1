...
-   At entry to and exit from <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>  
...
-   At entry to and exit from **parallel sections**  
 ...
 The directive is not implied if a <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> clause is present. It should be noted that the **flush** directive is not implied for any of the following:  
