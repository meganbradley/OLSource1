...
The <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> attribute was applied to an <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>, <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>, or <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> method declaration. This attribute can only be used with an empty <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> or <CodeContentPlaceHolder>5\</CodeContentPlaceHolder>.  
  
 **Error ID:** BC31531  
  
### To correct this error  
  
-   Remove the <CodeContentPlaceHolder>6\</CodeContentPlaceHolder> attribute from the method declaration.  
