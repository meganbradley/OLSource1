...
## Remarks  
 If both <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> and <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> are **NULL**, <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> uses the current default printer.  
