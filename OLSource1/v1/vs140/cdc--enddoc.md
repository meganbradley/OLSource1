...
## Remarks  
 ...
 If an application encounters a printing error or a canceled print operation, it must not attempt to terminate the operation by using either <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> or [AbortDoc](../vs140/cdc--abortdoc.md). GDI automatically terminates the operation before returning the error value.  
