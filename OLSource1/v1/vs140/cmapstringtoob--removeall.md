...
---
# CMapStringToOb::RemoveAll
Removes all the elements from this map and destroys the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> key objects.  
  
## Syntax  
  
<CodeContentPlaceHolder>0\</CodeContentPlaceHolder>  
## Remarks  
 The <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> objects referenced by each key are not destroyed. The <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> function can cause memory leaks if you do not ensure that the referenced <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> objects are destroyed.  
...
## Example  
 See [CObList::CObList](../vs140/coblist--coblist.md) for a listing of the <CodeContentPlaceHolder>6\</CodeContentPlaceHolder> class used in all collection examples.  
