...
2.  <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> for \<xref:Microsoft.VisualStudio.Shell.Interop.SVsTrackSelectionEx*> from the \<xref:Microsoft.VisualStudio.OLE.Interop.IServiceProvider*> passed into the \<xref:Microsoft.VisualStudio.Shell.Interop.IVsWindowPane.SetSite*> method.  
...
4.  Call \<xref:Microsoft.VisualStudio.Shell.Interop.IVsTrackSelectionEx.OnElementValueChange*> with first parameter set to <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> (taken from the \<xref:Microsoft.VisualStudio.VSConstants.VSSELELEMID*> enumeration), and the third parameter, <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>, representing a string form of the GUID that represents your **Properties** window. Make this call only once at the first creation of your **Properties** window document window. After the call this **Properties** window is associated with your window frame.  
  
### To obtain the Window Frame object when you are not the implementer  
  
-   You can <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> for \<xref:Microsoft.VisualStudio.Shell.Interop.SVsTrackSelectionEx*> service from \<xref:Microsoft.VisualStudio.Shell.Interop.IVsWindowFrame.GetProperty*> with the parameter <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> set to \<xref:Microsoft.VisualStudio.Shell.Interop.__VSFPROPID.VSFPROPID_SPFrame*>.  
  
-   You can obtain the active document window by calling \<xref:Microsoft.VisualStudio.Shell.Interop.IVsMonitorSelection.GetCurrentSelection*> through SVsMonitorSelection service. Set the parameter <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> to <CodeContentPlaceHolder>6\</CodeContentPlaceHolder>, taken from the \<xref:Microsoft.VisualStudio.VSConstants.VSSELELEMID*> enumeration.  
