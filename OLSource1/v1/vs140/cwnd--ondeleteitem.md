...
## Remarks  
 If the **hwndItem** member of the <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> structure belongs to a combo box or list box, then the <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> virtual function of the appropriate class is called. Override the <CodeContentPlaceHolder>6\</CodeContentPlaceHolder> member function of the appropriate control's class to delete item-specific data.  
