...
## Remarks  
 After this operation, the <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> and <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> flags will both be cleared for the files on which the undo checkout was performed.  
