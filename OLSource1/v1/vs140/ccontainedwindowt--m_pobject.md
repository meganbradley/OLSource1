...
---
# CContainedWindowT::m_pObject
Points to the object containing the <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> object.  
...
## Remarks  
 ...
 <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> is initialized by the constructor. For an example, see the [CContainedWindowT](../vs140/ccontainedwindowt-class.md) overview.  
