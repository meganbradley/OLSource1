...
## Remarks  
 If this attribute is specified, the .tlh header, with the declarations to expose type-library items, will be generated without an <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> statement to include the .tli header file.  
