...
## Cause  
 A public type is sealed and declares a method that is both <CodeContentPlaceHolder>0\</CodeContentPlaceHolder> (<CodeContentPlaceHolder>1\</CodeContentPlaceHolder> in Visual Basic) and not final. This rule does not report violations for delegate types, which must follow this pattern.  
...
## Example  
 ...
 [!code[FxCop.Design.SealedVirtual#1](../vs140/codesnippet/CPP/ca1048--do-not-declare-virtual-members-in-sealed-types_1.cpp)]