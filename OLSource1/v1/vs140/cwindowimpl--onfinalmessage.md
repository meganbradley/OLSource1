...
---
# CWindowImpl::OnFinalMessage
Called after receiving the last message (typically <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>).  
...
## Remarks  
 The default implementation of <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> does nothing, but you can override this function to handle cleanup before destroying a window. If you want to automatically delete your object upon the window destruction, you can call <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> in this function.  
