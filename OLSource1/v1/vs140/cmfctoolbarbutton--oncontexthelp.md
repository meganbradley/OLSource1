...
## Remarks  
 The default implementation of this method does nothing and returns <CodeContentPlaceHolder>4\</CodeContentPlaceHolder>. Override this method to return a nonzero value if the button processes the help message.  
  
 For more information about the <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> message, see [TN028: Context-Sensitive Help Support](../vs140/tn028--context-sensitive-help-support.md).  
