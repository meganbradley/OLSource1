...
## Remarks  
 ...
 If the window was created by the calling thread, <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> does not return until the window procedure has processed the message. Otherwise, it returns immediately.  
