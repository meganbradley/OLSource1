...
2.  Choose one of the following:  
    ...
    -   To validate code against all modeling projects in the solution, run [!INCLUDE[vstecmsbuild](../vs140/includes/vstecmsbuild_md.md)] with the following custom property:  
     ...
     Any errors that occur will be listed. For more information about [!INCLUDE[vstecmsbuild](../vs140/includes/vstecmsbuild_md.md)], see [MSBuild](../vs140/msbuild.md) and [MSBuild Task](../vs140/msbuild-task.md).  
