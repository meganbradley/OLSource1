...
<CodeContentPlaceHolder>0\</CodeContentPlaceHolder>  
    > [!NOTE]
    >  On some operating systems, text or graphics drawn by \<xref:System.Drawing.Graphics*> methods may not print correctly. In this case, use the compatible printing method: <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>).  
