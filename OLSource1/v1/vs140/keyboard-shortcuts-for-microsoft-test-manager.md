...
As you become more familiar with [!INCLUDE[TCMext](../vs140/includes/tcmext_md.md)], you can take advantage of the keyboard shortcuts that are provided for you. These will help you navigate the user interface more quickly in the **Testing Center**, in the **Lab Center**, and when you run tests using [!INCLUDE[mtrlong](../vs140/includes/mtrlong_md.md)].  
...
## Testing Center and Lab Center  
 ...
 ![Keyboard Shortcuts for Microsoft Test Manager](../vs140/media/keyboard_mtm.png "Keyboard_MTM")  
...
## See Also  
 ...
 [Defining Your Testing Effort Using Test Plans](../vs140/defining-a-test-plan.md)