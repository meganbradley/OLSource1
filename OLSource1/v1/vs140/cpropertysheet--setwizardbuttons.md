...
## Remarks  
 Call <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> only after the dialog is open; you can't call <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> before you call [DoModal](../vs140/cpropertysheet--domodal.md). Typically, you should call <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> from [CPropertyPage::OnSetActive](../vs140/cpropertypage--onsetactive.md).  
