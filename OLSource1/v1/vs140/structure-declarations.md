 ...
 *struct-declarator*:  
 ...
 Each variable declared in *struct-declaration-list* is defined as a member of the structure type. Variable declarations within *struct-declaration-list* have the same form as other variable declarations discussed in this section, except that the declarations cannot contain storage-class specifiers or initializers. The structure members can have any variable types except type <CodeContentPlaceHolder>10\</CodeContentPlaceHolder>, an incomplete type, or a function type.  
...
<CodeContentPlaceHolder>2\</CodeContentPlaceHolder>  
 The <CodeContentPlaceHolder>11\</CodeContentPlaceHolder> structure has three members: <CodeContentPlaceHolder>12\</CodeContentPlaceHolder>, <CodeContentPlaceHolder>13\</CodeContentPlaceHolder>, and <CodeContentPlaceHolder>14\</CodeContentPlaceHolder>. The <CodeContentPlaceHolder>15\</CodeContentPlaceHolder> member is a 20-element array, and <CodeContentPlaceHolder>16\</CodeContentPlaceHolder> and <CodeContentPlaceHolder>17\</CodeContentPlaceHolder> are simple members with <CodeContentPlaceHolder>18\</CodeContentPlaceHolder> and **long** type, respectively. The identifier <CodeContentPlaceHolder>19\</CodeContentPlaceHolder> is the structure identifier.  
  
<CodeContentPlaceHolder>3\</CodeContentPlaceHolder>  
 This example defines three structure variables: <CodeContentPlaceHolder>20\</CodeContentPlaceHolder>, <CodeContentPlaceHolder>21\</CodeContentPlaceHolder>, and <CodeContentPlaceHolder>22\</CodeContentPlaceHolder>. Each structure has the same list of three members. The members are declared to have the structure type <CodeContentPlaceHolder>23\</CodeContentPlaceHolder>, defined in the previous example.  
  
<CodeContentPlaceHolder>4\</CodeContentPlaceHolder>  
 The <CodeContentPlaceHolder>24\</CodeContentPlaceHolder> structure has two members with **float** type, <CodeContentPlaceHolder>25\</CodeContentPlaceHolder> and <CodeContentPlaceHolder>26\</CodeContentPlaceHolder>. The structure type has no tag and is therefore unnamed or anonymous.  
  
<CodeContentPlaceHolder>5\</CodeContentPlaceHolder>  
 The first two members of the structure are a <CodeContentPlaceHolder>27\</CodeContentPlaceHolder> variable and a pointer to a **float** value. The third member, <CodeContentPlaceHolder>28\</CodeContentPlaceHolder>, is declared as a pointer to the structure type being defined (<CodeContentPlaceHolder>29\</CodeContentPlaceHolder>).  
 ...
 **Microsoft Specific**  
 ...
 <CodeContentPlaceHolder>30\</CodeContentPlaceHolder> *identifier***{** *set-of-declarations* *type array-name***[ ];};**  
  
 Unsized arrays can appear only as the last member of a structure. Structures containing unsized array declarations can be nested within other structures as long as no further members are declared in any enclosing structures. Arrays of such structures are not allowed. The <CodeContentPlaceHolder>31\</CodeContentPlaceHolder> operator, when applied to a variable of this type or to the type itself, assumes 0 for the size of the array.  
