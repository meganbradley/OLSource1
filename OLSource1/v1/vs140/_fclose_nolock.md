...
## Return Value  
 <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> returns 0 if the stream is successfully closed. Returns <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> to indicate an error.  
  
## Remarks  
 This functions is a non-locking version of <CodeContentPlaceHolder>5\</CodeContentPlaceHolder>. It is identical except that it is not protected from interference by other threads. It might be faster because it does not incur the overhead of locking out other threads. Use this function only in thread-safe contexts such as single-threaded applications or where the calling scope already handles thread isolation.  
  
## Requirements  
  
|Function|Required header|  
|--------------|---------------------|  
|<CodeContentPlaceHolder>6\</CodeContentPlaceHolder>|\<stdio.h>|  
