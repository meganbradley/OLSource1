...
|---------------|-----------------|  
|[in] <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>|One of the following values that specifies a monthly, annual, decade, or century view.\<br />\<br /> MCMV_MONTH: Monthly view\<br />\<br /> MCMV_YEAR: Annual view\<br />\<br /> MCMV_DECADE: Decade view\<br />\<br /> MCMV_CENTURY: Century view|  
