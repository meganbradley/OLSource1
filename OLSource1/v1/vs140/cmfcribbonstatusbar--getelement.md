...
## Return Value  
 A pointer to the element that is located at the specified index. <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> if the index is negative or exceeds the number of elements in the status bar.  
