...
-   **UpdateRegistry(**  <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>  **)** Registers this object factory with the OLE system registry. This function is usually called by [CWinApp::InitInstance](../vs140/cwinapp--initinstance.md) when the application is launched.  
  
-   **UpdateRegistry(**  <CodeContentPlaceHolder>4\</CodeContentPlaceHolder>  **)** This form of the function is overridable. If <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> is **TRUE**, this function registers the control class with the system registry. Otherwise, it unregisters the class.  
