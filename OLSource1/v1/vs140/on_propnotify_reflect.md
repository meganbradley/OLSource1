...
f1_keywords: 
  ...
  - "AFXDISP/ON_PROPNOTIFY_REFLECT"
dev_langs: 
  - "C++"
helpviewer_keywords: 
  - "ON_PROPNOTIFY_REFLECT macro"
...
---
# ON_PROPNOTIFY_REFLECT
The <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> macro, when used in the event sink map of an OLE control's wrapper class, receives property notifications sent by the control before they are handled by the control's container.  
