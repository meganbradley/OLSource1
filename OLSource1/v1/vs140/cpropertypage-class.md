...
|Name|Description|  
|----------|-----------------|  
|[CPropertyPage::CPropertyPage](#cpropertypage__cpropertypage)|Constructs a <CodeContentPlaceHolder>18\</CodeContentPlaceHolder> object.|  
...
|[CPropertyPage::Construct](#cpropertypage__construct)|Constructs a <CodeContentPlaceHolder>19\</CodeContentPlaceHolder> object. Use <CodeContentPlaceHolder>20\</CodeContentPlaceHolder> if you want to specify your parameters at run time, or if you are using arrays.|  
|[CPropertyPage::GetPSP](#cpropertypage__getpsp)|Retrieves the Windows                                         [PROPSHEETPAGE](http://msdn.microsoft.com/library/windows/desktop/bb774548) structure associated with the <CodeContentPlaceHolder>21\</CodeContentPlaceHolder> object.|  
...
## Remarks  
 ...
 For more information on establishing a property sheet as a wizard, see [CPropertySheet::SetWizardMode](../vs140/cpropertysheet-class.md#cpropertysheet__setwizardmode). For more information on using <CodeContentPlaceHolder>24\</CodeContentPlaceHolder> objects, see the article [Property Sheets and Property Pages](../vs140/property-sheets-and-property-pages-in-mfc.md).  
...
### Remarks  
 ...
 The <CodeContentPlaceHolder>26\</CodeContentPlaceHolder> member function does nothing in a modeless property sheet, because a modeless property sheet does not have a Cancel button by default.  
...
##  \<a name="cpropertypage__construct">\</a>  CPropertyPage::Construct  
 Call this member function to construct a <CodeContentPlaceHolder>27\</CodeContentPlaceHolder> object.  
...
-   The user has selected (tabbed to) this page.  
 ...
 Call **Construct** if one of the other class constructors has not been called. The <CodeContentPlaceHolder>33\</CodeContentPlaceHolder> member function is flexible because you can leave the parameter statement blank and then specify multiple parameters and construction at any point in your code.  
  
 You must use <CodeContentPlaceHolder>34\</CodeContentPlaceHolder> when you work with arrays, and you must call **Construct** for each member of the array so that the data members are assigned proper values.  
  
### Example  
 [!code[NVC_MFCDocView#112](../vs140/codesnippet/CPP/cpropertypage-class_1.cpp)]  
...
-   The user has selected (tabbed to) this page.  
 ...
 If you have multiple parameters (for example, if you are using an array), use [CPropertySheet::Construct](../vs140/cpropertysheet-class.md#cpropertysheet__construct) instead of <CodeContentPlaceHolder>42\</CodeContentPlaceHolder>.  
  
### Example  
 [!code[NVC_MFCDocView#113](../vs140/codesnippet/CPP/cpropertypage-class_2.cpp)]  
  
##  \<a name="cpropertypage__getpsp">\</a>  CPropertyPage::GetPSP  
 Retrieves the Windows                 [PROPSHEETPAGE](http://msdn.microsoft.com/library/windows/desktop/bb774548) structure associated with the <CodeContentPlaceHolder>43\</CodeContentPlaceHolder> object.  
...
##  \<a name="cpropertypage__m_psp">\</a>  CPropertyPage::m_psp  
 <CodeContentPlaceHolder>44\</CodeContentPlaceHolder> is a structure whose members store the characteristics of                 [PROPSHEETPAGE](http://msdn.microsoft.com/library/windows/desktop/bb774548).  
...
### Example  
 [!code[NVC_MFCDocView#128](../vs140/codesnippet/CPP/cpropertypage-class_3.cpp)]  
...
### Remarks  
 ...
 The default implementation of <CodeContentPlaceHolder>47\</CodeContentPlaceHolder> calls <CodeContentPlaceHolder>48\</CodeContentPlaceHolder>.  
...
### Example  
 [!code[NVC_MFCDocView#114](../vs140/codesnippet/CPP/cpropertypage-class_4.cpp)]  
...
### Example  
 [!code[NVC_MFCDocView#115](../vs140/codesnippet/CPP/cpropertypage-class_5.cpp)]  
...
### Remarks  
 When the user chooses either the OK or the Apply Now button, the framework receives the                         [PSN_APPLY](http://msdn.microsoft.com/library/windows/desktop/bb774552) notification from the property page. The call to <CodeContentPlaceHolder>49\</CodeContentPlaceHolder> won't be made if you call [CPropertySheet::PressButton](../vs140/cpropertysheet-class.md#cpropertysheet__pressbutton) because the property page does not send the notification in that case.  
 ...
 The default implementation of this member function marks the page as "clean" to reflect that the data was updated in the <CodeContentPlaceHolder>50\</CodeContentPlaceHolder> function.  
  
### Example  
 [!code[NVC_MFCDocView#116](../vs140/codesnippet/CPP/cpropertypage-class_6.cpp)]  
...
### Remarks  
 ...
 The default implementation of <CodeContentPlaceHolder>51\</CodeContentPlaceHolder> returns **TRUE**.  
  
### Example  
 [!code[NVC_MFCDocView#117](../vs140/codesnippet/CPP/cpropertypage-class_7.cpp)]  
...
### Remarks  
 ...
 The default implementation of <CodeContentPlaceHolder>52\</CodeContentPlaceHolder> does nothing.  
...
### Example  
 [!code[NVC_MFCDocView#118](../vs140/codesnippet/CPP/cpropertypage-class_8.cpp)]  
...
### Remarks  
 When a user clicks the **Finish** button in a wizard, the framework calls this function; when <CodeContentPlaceHolder>53\</CodeContentPlaceHolder> returns **TRUE** (a nonzero value), the property sheet is able to be destroyed (but is not actually destroyed). Call <CodeContentPlaceHolder>54\</CodeContentPlaceHolder> to destroy the property sheet. Do not call <CodeContentPlaceHolder>55\</CodeContentPlaceHolder> from <CodeContentPlaceHolder>56\</CodeContentPlaceHolder>; doing so will cause heap corruption or other errors.  
...
### Example  
 [!code[NVC_MFCDocView#119](../vs140/codesnippet/CPP/cpropertypage-class_9.cpp)]  
  
 [!code[NVC_MFCDocView#120](../vs140/codesnippet/CPP/cpropertypage-class_10.cpp)]  
  
 [!code[NVC_MFCDocView#121](../vs140/codesnippet/CPP/cpropertypage-class_11.cpp)]  
  
 [!code[NVC_MFCDocView#122](../vs140/codesnippet/CPP/cpropertypage-class_12.cpp)]  
...
### Example  
 [!code[NVC_MFCDocView#123](../vs140/codesnippet/CPP/cpropertypage-class_13.cpp)]  
...
### Example  
 [!code[NVC_MFCDocView#124](../vs140/codesnippet/CPP/cpropertypage-class_14.cpp)]  
  
 [!code[NVC_MFCDocView#125](../vs140/codesnippet/CPP/cpropertypage-class_15.cpp)]  
  
 [!code[NVC_MFCDocView#126](../vs140/codesnippet/CPP/cpropertypage-class_16.cpp)]  
...
### Example  
 [!code[NVC_MFCDocView#127](../vs140/codesnippet/CPP/cpropertypage-class_17.cpp)]  
