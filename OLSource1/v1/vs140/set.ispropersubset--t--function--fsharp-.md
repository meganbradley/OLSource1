...
Evaluates to <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> if all elements of the first set are in the second, and at least one element of the second is not in the first.  
...
## Return Value  
 <CodeContentPlaceHolder>6\</CodeContentPlaceHolder> if <CodeContentPlaceHolder>7\</CodeContentPlaceHolder> is a proper subset of <CodeContentPlaceHolder>8\</CodeContentPlaceHolder>. Otherwise, returns <CodeContentPlaceHolder>9\</CodeContentPlaceHolder>.  
...
## Example  
 The following code illustrates the use of the <CodeContentPlaceHolder>11\</CodeContentPlaceHolder> function.  
