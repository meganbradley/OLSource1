...
To appear in the **Help About** dialog box and the splash screen, VSPackages must implement the <xref:Microsoft.VisualStudio.Shell.Interop.IVsInstalledProduct?qualifyHint=False> interface. Doing this provides the following information to [!INCLUDE[vsprvs](../vs140/includes/vsprvs_md.md)]:  
