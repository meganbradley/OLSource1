...
## Remarks  
 Points to a null-terminated string that specifies the command line for the application. Use <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> to access any command-line arguments the user entered when the application was started. <CodeContentPlaceHolder>4\</CodeContentPlaceHolder> is a public variable of type <CodeContentPlaceHolder>5\</CodeContentPlaceHolder>.  
