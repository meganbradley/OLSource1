...
This error generally occurs when the <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> switch has been entered, along with additional switches for the **Find in Files** or **Replace in Files** commands.  
...
3.  If you want to start a new Find in Files or Replace in Files operation, re-enter the command, omitting <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>.  
