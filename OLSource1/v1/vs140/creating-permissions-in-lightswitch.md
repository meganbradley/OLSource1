...
3.  In the **Permissions** grid, choose the **\<Add New Permission>** placeholder, and then enter <CodeContentPlaceHolder>0\</CodeContentPlaceHolder>.  
  
4.  In the **Display Name** column, enter <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>.  
  
5.  In the **Description** column, enter <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>, and then choose the **Enter** key.  
