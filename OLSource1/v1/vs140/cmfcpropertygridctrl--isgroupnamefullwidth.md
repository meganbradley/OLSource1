...
## Return Value  
 <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> if group names are displayed across the width of the property grid control; <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> if group names are truncated by the right (value) column of the control.  
