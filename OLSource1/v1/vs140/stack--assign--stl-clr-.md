...
## Remarks  
 The member function assigns <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> to the underlying container. You use it to change the entire contents of the stack.  
