...
---
# COleClientItem::OnSetMenu
Called by the framework two times when in-place activation begins and ends; the first time to install the composite menu and the second time (with <CodeContentPlaceHolder>1\</CodeContentPlaceHolder> equal to **NULL**) to remove it.  
...
#### Parameters  
 ...
 Pointer to the composite menu constructed by calls to the [OnInsertMenus](../vs140/coleclientitem--oninsertmenus.md) member function and the <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> function.  
