...
#### Parameters  
 ...
 [out] Returns <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> if the section is shareable in memory; otherwise, returns <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>.  
