...
3.  In the **Breakpoint Filter** dialog box, type:  
     ...
     To create a more complex filter, you can combine clauses using <CodeContentPlaceHolder>1\</CodeContentPlaceHolder>, the AND operator, <CodeContentPlaceHolder>2\</CodeContentPlaceHolder>, the OR operator, <CodeContentPlaceHolder>3\</CodeContentPlaceHolder>, the NOT operator, and parentheses.  
...
3.  In the **Breakpoint Filter** dialog box, type:  
     ...
     <CodeContentPlaceHolder>4\</CodeContentPlaceHolder>  *yourprocessname*  
  
     —or—  
  
     <CodeContentPlaceHolder>5\</CodeContentPlaceHolder> *yourprocessIDnumber*  
  
     To create a more complex filter, you can combine clauses using <CodeContentPlaceHolder>6\</CodeContentPlaceHolder>, the AND operator, <CodeContentPlaceHolder>7\</CodeContentPlaceHolder>, the OR operator, <CodeContentPlaceHolder>8\</CodeContentPlaceHolder>, the NOT operator, and parentheses.  
...
3.  In the **Breakpoint Filter** dialog box, type:  
     ...
     <CodeContentPlaceHolder>9\</CodeContentPlaceHolder> *yourthreadname*  
  
     —or—  
  
     <CodeContentPlaceHolder>10\</CodeContentPlaceHolder> *yourthreadIDnumber*  
  
     To create a more complex filter, you can combine clauses using <CodeContentPlaceHolder>11\</CodeContentPlaceHolder>, the AND operator, <CodeContentPlaceHolder>12\</CodeContentPlaceHolder>, the OR operator, <CodeContentPlaceHolder>13\</CodeContentPlaceHolder>, the NOT operator, and parentheses.  
  
4.  Click **OK**.  
  
## Example  
 The following example shows how to create a filter for a breakpoint on a computer named <CodeContentPlaceHolder>14\</CodeContentPlaceHolder> and a thread named <CodeContentPlaceHolder>15\</CodeContentPlaceHolder>.  
