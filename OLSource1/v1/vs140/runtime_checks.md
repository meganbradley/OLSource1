...
---
# runtime_checks
Disables or restores the [/RTC](../vs140/-rtc--run-time-error-checks-.md) settings.  
  
## Syntax  
  
<CodeContentPlaceHolder>0\</CodeContentPlaceHolder>  
## Remarks  
 You cannot enable a run-time check that was not enabled with a compiler option. For example, if you do not specify /RTCs, specifying <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> will not enable stack frame verification.  
