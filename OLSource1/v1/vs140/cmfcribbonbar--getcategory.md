...
## Return Value  
 A pointer to the ribbon category at the specified index; otherwise, <CodeContentPlaceHolder>2\</CodeContentPlaceHolder> if <CodeContentPlaceHolder>3\</CodeContentPlaceHolder> was out of range.  
