...
-   Visual Studio Enterprise  
 ...
 When you create a new coded UI test, the [!INCLUDE[vsprvs](../vs140/includes/vsprvs_md.md)] testing framework generates code for the test by default in a <xref:Microsoft.VisualStudio.TestTools.UITest.Common.UIMap.UIMap?qualifyHint=False> class. For more information about how to record coded UI tests, see [Creating Coded UI Tests](../vs140/use-ui-automation-to-test-your-code.md#VerifyingCodeUsingCUITCreate) and [Anatomy of a Coded UI Test](../vs140/anatomy-of-a-coded-ui-test.md).  
