# [Full screen picture: Alice shares protected attachment](ems/AADRightsMgmt/1.md)
# [Activating Azure Rights Management](ems/AADRightsMgmt/Activating-Azure-Rights-Management.md)
# [Full screen picture: Available settings for RMS templates](ems/AADRightsMgmt/2.md)
...
# [Benefits of Intune App SDK](ems/Intune_App_SDK/4.md)
...
# [View and use files that have been protected by Rights Management](ems/RMS_Client/5.md)
...
# [Rights Management (RMS) Client](ems/RMS_Client/6.md)
...
# [Requirements for Azure Rights Management](ems/RMS_Client/7.md)
...
# [Protect a file on a device (protect in-place) by using the Rights Management sharing application](ems/RMS_Client/9.md)
