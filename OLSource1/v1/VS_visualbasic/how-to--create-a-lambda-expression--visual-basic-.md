...
3.  Following the parameter list, type a single expression as the body of the function. The value that the expression evaluates to is the value returned by the function. You do not use an `As` clause to specify the return type.  
     ...
     [!code[VbVbalrLambdas#1](../VS_csharp/codesnippet/VisualBasic/how-to--create-a-lambda-expression--visual-basic-_1.vb)]  
  
     You call the lambda expression by passing in an integer argument.  
  
     [!code[VbVbalrLambdas#2](../VS_csharp/codesnippet/VisualBasic/how-to--create-a-lambda-expression--visual-basic-_2.vb)]  
  
4.  Alternatively, the same result is accomplished by the following example:  
  
     [!code[VbVbalrLambdas#3](../VS_csharp/codesnippet/VisualBasic/how-to--create-a-lambda-expression--visual-basic-_3.vb)]  
...
3.  Following the parameter list, type a single statement as the body of the subroutine.  
     ...
     [!code[VbVbalrLambdas#17](../VS_csharp/codesnippet/VisualBasic/how-to--create-a-lambda-expression--visual-basic-_4.vb)]  
  
     You call the lambda expression by passing in a string argument.  
  
     [!code[VbVbalrLambdas#18](../VS_csharp/codesnippet/VisualBasic/how-to--create-a-lambda-expression--visual-basic-_5.vb)]  
...
4.  Within the body of the function, add the following code to create an expression and return the value. You do not use an `As` clause to specify the return type.  
     ...
     [!code[VbVbalrLambdas#19](../VS_csharp/codesnippet/VisualBasic/how-to--create-a-lambda-expression--visual-basic-_6.vb)]  
  
     You call the lambda expression by passing in an integer argument.  
  
     [!code[VbVbalrLambdas#20](../VS_csharp/codesnippet/VisualBasic/how-to--create-a-lambda-expression--visual-basic-_7.vb)]  
...
4.  Within the body of the function, add the following code to execute when the subroutine is invoked.  
     ...
     [!code[VbVbalrLambdas#21](../VS_csharp/codesnippet/VisualBasic/how-to--create-a-lambda-expression--visual-basic-_8.vb)]  
  
     You call the lambda expression by passing in a string argument.  
  
     [!code[VbVbalrLambdas#22](../VS_csharp/codesnippet/VisualBasic/how-to--create-a-lambda-expression--visual-basic-_9.vb)]  
...
## Example  
 ...
 [!code[VbVbalrLambdas#10](../VS_csharp/codesnippet/VisualBasic/how-to--create-a-lambda-expression--visual-basic-_10.vb)]  
  
 The previous example is equivalent to the following code, which is written in [!INCLUDE[vbteclinqext](../VS_csharp/includes/vbteclinqext_md.md)] syntax:  
  
 [!code[VbVbalrLambdas#11](../VS_csharp/codesnippet/VisualBasic/how-to--create-a-lambda-expression--visual-basic-_11.vb)]  
