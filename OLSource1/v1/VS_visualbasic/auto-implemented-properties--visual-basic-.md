...
*Auto-implemented properties* enable you to quickly specify a property of a class without having to write code to `Get` and `Set` the property. When you write code for an auto-implemented property, the Visual Basic compiler automatically creates a private field to store the property variable in addition to creating the associated `Get` and `Set` procedures.  
 ...
 [!code[VbVbalrAutoImplementedProperties#1](../VS_visualbasic/codesnippet/VisualBasic/auto-implemented-properties--visual-basic-_1.vb)]  
 ...
 [!code[VbVbalrAutoImplementedProperties#5](../VS_visualbasic/codesnippet/VisualBasic/auto-implemented-properties--visual-basic-_2.vb)]  
  
 The following code example shows the equivalent code for the previous auto-implemented property example.  
  
 [!code[VbVbalrAutoImplementedProperties#2](../VS_visualbasic/codesnippet/VisualBasic/auto-implemented-properties--visual-basic-_3.vb)]  
...
## Initializing an Auto-Implemented Property  
 ...
 [!code[VbVbalrAutoImplementedProperties#3](../VS_visualbasic/codesnippet/VisualBasic/auto-implemented-properties--visual-basic-_4.vb)]  
 ...
 [!code[VbVbalrAutoImplementedProperties#4](../VS_visualbasic/codesnippet/VisualBasic/auto-implemented-properties--visual-basic-_5.vb)]  
