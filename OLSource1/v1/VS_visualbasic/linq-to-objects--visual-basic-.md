...
## In This Section  
 ...
 [LINQ and Reflection (Visual Basic)](../VS_csharp/linq-and-reflection--visual-basic-.md)  
 Links to a sample that demonstrates how LINQ uses reflection.  
  
 [LINQ and File Directories (Visual Basic)](../VS_csharp/linq-and-file-directories--visual-basic-.md)  
 ...
 [How to: Query an ArrayList with LINQ (Visual Basic)](../VS_csharp/how-to--query-an-arraylist-with-linq--visual-basic-.md)  
 Demonstrates how to query an ArrayList in C#.  
  
 [How to: Add Custom Methods for LINQ Queries (Visual Basic)](../VS_csharp/how-to--add-custom-methods-for-linq-queries--visual-basic-.md)  
