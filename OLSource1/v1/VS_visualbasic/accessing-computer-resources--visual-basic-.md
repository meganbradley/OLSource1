...
## In This Section  
 [Playing Sounds](../VS_visualbasic/playing-sounds--visual-basic-.md)  
 ...
 [Getting Information about the Computer](../VS_visualbasic/getting-information-about-the-computer--visual-basic-.md)  
 Lists tasks associated with `My.Computer.Info`, such as determining a computer's full name or IP addresses.  
  
 [Accessing the Keyboard](../VS_visualbasic/accessing-the-keyboard--visual-basic-.md)  
 Lists tasks associated with `My.Computer.Keyboard`, such as determining whether CAPS LOCK is on.  
  
 [Accessing the Mouse](../VS_visualbasic/accessing-the-mouse--visual-basic-.md)  
 Lists tasks associated with `My.Computer.Mouse`, such as determining whether a mouse is present.  
  
 [Performing Network Operations](../VS_visualbasic/performing-network-operations--visual-basic-.md)  
