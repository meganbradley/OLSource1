...
>  The `RemoveHandler` statement is an exception. You cannot pass a lambda expression in for the delegate parameter of `RemoveHandler`.  
 ...
 [!code[VbVbalrLambdas#14](../VS_csharp/codesnippet/VisualBasic/lambda-expressions--visual-basic-_1.vb)]  
 ...
 [!code[VbVbalrLambdas#15](../VS_csharp/codesnippet/VisualBasic/lambda-expressions--visual-basic-_2.vb)]  
 ...
 [!code[VbVbalrLambdas#3](../VS_csharp/codesnippet/VisualBasic/lambda-expressions--visual-basic-_3.vb)]  
 ...
 [!code[VbVbalrLambdas#8](../VS_csharp/codesnippet/VisualBasic/lambda-expressions--visual-basic-_4.vb)]  
...
```  
 ...
 You can add the same event handler by using an async lambda in an [AddHandler Statement](../VS_csharp/addhandler-statement.md). To add this handler, add an `Async` modifier before the lambda parameter list, as the following example shows.  
...
##  <a name="context"></a> Context  
 ...
 [!code[VbVbalrLambdas#12](../VS_csharp/codesnippet/VisualBasic/lambda-expressions--visual-basic-_5.vb)]  
...
-   A parameter of the lambda expression in which it is nested: `level2`  
 ...
 [!code[VbVbalrLambdas#9](../VS_csharp/codesnippet/VisualBasic/lambda-expressions--visual-basic-_6.vb)]  
  
## Converting to a Delegate Type  
 A lambda expression can be implicitly converted to a compatible delegate type. For information about the general requirements for compatibility, see [Relaxed Delegate Conversions](../VS_csharp/relaxed-delegate-conversion--visual-basic-.md). For example, the following code example shows a lambda expression that implicitly converts to `Func(Of Integer, Boolean)` or a matching delegate signature.  
  
 [!code[VbVbalrLambdas#16](../VS_csharp/codesnippet/VisualBasic/lambda-expressions--visual-basic-_7.vb)]  
 ...
 [!code[VbVbalrLambdas#23](../VS_csharp/codesnippet/VisualBasic/lambda-expressions--visual-basic-_8.vb)]  
...
-   The following example defines a lambda expression that returns `True` if the nullable argument has an assigned value, and `False` if its value is `Nothing`.  
     ...
     [!code[VbVbalrLambdas#4](../VS_csharp/codesnippet/VisualBasic/lambda-expressions--visual-basic-_9.vb)]  
  
-   The following example defines a lambda expression that returns the index of the last element in an array.  
  
     [!code[VbVbalrLambdas#5](../VS_csharp/codesnippet/VisualBasic/lambda-expressions--visual-basic-_10.vb)]  
...
## See Also  
 ...
 [Value Types that Might Not Have a Defined Value](../VS_csharp/nullable-value-types--visual-basic-.md)   
 [How to: Pass Procedures to Another Procedure in Visual Basic](../VS_csharp/how-to--pass-procedures-to-another-procedure-in-visual-basic.md)   
 [How to: Create a Lambda Expression](../VS_csharp/how-to--create-a-lambda-expression--visual-basic-.md)   
 [Relaxed Delegate Conversions](../VS_csharp/relaxed-delegate-conversion--visual-basic-.md)