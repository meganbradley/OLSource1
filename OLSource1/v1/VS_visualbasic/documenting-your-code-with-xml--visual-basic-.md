...
In [!INCLUDE[vbprvb](../VS_csharp/includes/vbprvb_md.md)], you can document your code using XML  
  
## XML Documentation Comments  
 [!INCLUDE[vbprvb](../VS_csharp/includes/vbprvb_md.md)] provides an easy way to automatically create XML documentation for projects. You can automatically generate an XML skeleton for your types and members, and then provide summaries, descriptive documentation for each parameter, and other remarks. With the appropriate setup, the XML documentation is automatically emitted into an XML file with the same name as your project and the .xml extension. For more information, see [/doc](../VS_csharp/-doc.md).  
...
-   Developers are free to create their own set of tags. There is a recommended set of tags (see "Related Sections" in this topic). Some of the recommended tags have special meanings:  
    ...
    -   The <summary\> tag is used by IntelliSense in [!INCLUDE[vsprvs](../VS_csharp/includes/vsprvs_md.md)] to display additional information about a type or member.  
...
-   [Processing the XML File (Visual Basic)](../VS_csharp/processing-the-xml-file--visual-basic-.md)  
...
## See Also  
 ...
 [Visual Basic Language Guide](../VS_csharp/visual-basic-programming-guide.md)