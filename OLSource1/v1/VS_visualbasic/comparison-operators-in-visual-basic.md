...
## Comparing Numeric Values  
 [!INCLUDE[vbprvb](../VS_csharp/includes/vbprvb_md.md)] compares numeric values using six numeric comparison operators. Each operator takes as operands two expressions that evaluate to numeric values. The following table lists the operators and shows examples of each.  
...
## Comparing Strings  
 ...
 The sort order is based on either a binary comparison or a textual comparison depending on the setting of `Option Compare`. For more information see [Option Compare Statement](../VS_csharp/option-compare-statement.md).  
  
## Comparing Objects  
 [!INCLUDE[vbprvb](../VS_csharp/includes/vbprvb_md.md)] compares two object reference variables with the [Is Operator (Visual Basic)](../VS_csharp/is-operator--visual-basic-.md) and the [IsNot Operator](../VS_csharp/isnot-operator--visual-basic-.md). You can use either of these operators to determine if two reference variables refer to the same object instance. The following example illustrates this.  
  
 [!code[VbVbalrOperators#65](../VS_csharp/codesnippet/VisualBasic/comparison-operators-in-visual-basic_1.vb)]  
 ...
 [!code[VbVbalrOperators#66](../VS_csharp/codesnippet/VisualBasic/comparison-operators-in-visual-basic_2.vb)]  
 ...
 [!code[VbVbalrOperators#67](../VS_csharp/codesnippet/VisualBasic/comparison-operators-in-visual-basic_3.vb)]  
...
### Comparing Object Type  
 ...
 [!code[VbVbalrOperators#68](../VS_csharp/codesnippet/VisualBasic/comparison-operators-in-visual-basic_4.vb)]  
 ...
 For more information, see [TypeOf Operator (Visual Basic)](../VS_csharp/typeof-operator--visual-basic-.md).  
