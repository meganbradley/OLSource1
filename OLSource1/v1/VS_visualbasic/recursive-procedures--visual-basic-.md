...
A *recursive* procedure is one that calls itself. In general, this is not the most effective way to write [!INCLUDE[vbprvb](../VS_csharp/includes/vbprvb_md.md)] code.  
  
 The following procedure uses recursion to calculate the factorial of its original argument.  
  
 [!code[VbVbcnProcedures#51](../VS_csharp/codesnippet/VisualBasic/recursive-procedures--visual-basic-_1.vb)]  
