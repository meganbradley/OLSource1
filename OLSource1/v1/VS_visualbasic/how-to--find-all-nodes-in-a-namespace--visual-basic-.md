...
## Example  
 ...
 This example uses the following XML document: [Sample XML File: Consolidated Purchase Orders](../VS_visualbasic/sample-xml-file--consolidated-purchase-orders3.md).  
