...
-   Use a \<xref:System.IO.StreamReader> to read the file. For more information, see [Basics of .NET Framework File I/O and the File System (Visual Basic)](../VS_visualbasic/basics-of-.net-framework-file-i-o-and-the-file-system--visual-basic-.md).  
...
## See Also  
 ...
 [How to: Read Text from Files with a StreamReader](../VS_visualbasic/how-to--read-text-from-files-with-a-streamreader--visual-basic-.md)