...
## Remarks  
 ...
 When you use the `Take` clause in a query, you may also need to ensure that the results are returned in an order that will enable the `Take` clause to include the intended results. For more information about ordering query results, see [Order By Clause](../VS_visualbasic/order-by-clause--visual-basic-.md).  
...
## Example  
 ...
 [!code[VbSimpleQuerySamples#1](../VS_visualbasic/codesnippet/VisualBasic/take-clause--visual-basic-_1.vb)]  
