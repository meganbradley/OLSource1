...
## When an Option Compare Statement Is Not Present  
 If the source code does not contain an `Option Compare` statement, the **Option Compare** setting on the [Compile Page, Project Designer (Visual Basic)](../Topic/Compile%20Page,%20Project%20Designer%20\(Visual%20Basic\).md) is used. If you use the command-line compiler, the setting specified by the [/optioncompare](../VS_visualbasic/-optioncompare.md) compiler option is used.  
...
-   Include the [/optioncompare](../VS_visualbasic/-optioncompare.md) compiler option in the **vbc** command.  
...
## Example  
 ...
 [!code[VbVbalrStatements#45](../VS_visualbasic/codesnippet/VisualBasic/option-compare-statement_1.vb)]  
...
## Example  
 ...
 [!code[VbVbalrStatements#46](../VS_visualbasic/codesnippet/VisualBasic/option-compare-statement_2.vb)]  
...
## See Also  
 ...
 [String Functions](../VS_visualbasic/string-functions--visual-basic-.md)   
