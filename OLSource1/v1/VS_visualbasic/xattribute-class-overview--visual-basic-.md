...
## Overview  
 Working with attributes in [!INCLUDE[sqltecxlinq](../VS_visualbasic/includes/sqltecxlinq_md.md)] is similar to working with elements. Their constructors are similar. The methods that you use to retrieve collections of them are similar. A [!INCLUDE[vbteclinq](../VS_visualbasic/includes/vbteclinq_md.md)] query expression for a collection of attributes looks very similar to a [!INCLUDE[vbteclinq](../VS_visualbasic/includes/vbteclinq_md.md)] query expression for a collection of elements.  
