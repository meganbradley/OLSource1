...
## Putting Multiple Statements on One Line  
 ...
 [!code[VbVbalrStatements#70](../VS_visualbasic/codesnippet/VisualBasic/statements-in-visual-basic_12.vb)]  
...
## Continuing a Statement over Multiple Lines  
 ...
 [!code[VbVbalrStatements#71](../VS_visualbasic/codesnippet/VisualBasic/statements-in-visual-basic_13.vb)]  
...
|After a comma (`,`).|[!code[VbVbalrLineContinuation#1](../VS_visualbasic/codesnippet/VisualBasic/statements-in-visual-basic_14.vb)]|  
|After an open parenthesis (`(`) or before a closing parenthesis (`)`).|[!code[VbVbalrLineContinuation#2](../VS_visualbasic/codesnippet/VisualBasic/statements-in-visual-basic_15.vb)]|  
|After an open curly brace (`{`) or before a closing curly brace (`}`).|[!code[VbVbalrLineContinuation#3](../VS_visualbasic/codesnippet/VisualBasic/statements-in-visual-basic_16.vb)]<br /><br /> For more information, see [Object Initializers: Named and Anonymous Types](../VS_visualbasic/object-initializers--named-and-anonymous-types--visual-basic-.md) or [Collection Initializers](../VS_visualbasic/collection-initializers--visual-basic-.md).|  
|After an open embedded expression (`<%=`) or before the close of an embedded expression (`%>`) within an XML literal.|[!code[VbVbalrLineContinuation#4](../VS_visualbasic/codesnippet/VisualBasic/statements-in-visual-basic_17.vb)]<br /><br /> For more information, see [Embedded Expressions in XML](../VS_visualbasic/embedded-expressions-in-xml--visual-basic-.md).|  
|After the concatenation operator (`&`).|[!code[VbVbcnConventions#9](../VS_visualbasic/codesnippet/VisualBasic/statements-in-visual-basic_18.vb)]<br /><br /> For more information, see [Operators Listed by Functionality](../VS_visualbasic/operators-listed-by-functionality--visual-basic-.md).|  
|After assignment operators (`=`, `&=`, `:=`, `+=`, `-=`, `*=`, `/=`, `\=`, `^=`, `<<=`, `>>=`).|[!code[VbVbalrLineContinuation#5](../VS_visualbasic/codesnippet/VisualBasic/statements-in-visual-basic_19.vb)]<br /><br /> For more information, see [Operators Listed by Functionality](../VS_visualbasic/operators-listed-by-functionality--visual-basic-.md).|  
|After binary operators (`+`, `-`, `/`, `*`, `Mod`, `<>`, `<`, `>`, `<=`, `>=`, `^`, `>>`, `<<`, `And`, `AndAlso`, `Or`, `OrElse`, `Like`, `Xor`) within an expression.|[!code[VbVbalrLineContinuation#7](../VS_visualbasic/codesnippet/VisualBasic/statements-in-visual-basic_20.vb)]<br /><br /> For more information, see [Operators Listed by Functionality](../VS_visualbasic/operators-listed-by-functionality--visual-basic-.md).|  
|After the `Is` and `IsNot` operators.|[!code[VbVbalrLineContinuation#8](../VS_visualbasic/codesnippet/VisualBasic/statements-in-visual-basic_21.vb)]<br /><br /> For more information, see [Operators Listed by Functionality](../VS_visualbasic/operators-listed-by-functionality--visual-basic-.md).|  
|After a member qualifier character (`.`) and before the member name. However, you must include a line-continuation character (_) following a member qualifier character when you are using the `With` statement or supplying values in the initialization list for a type. Consider breaking the line after the assignment operator (for example, `=`) when you are using `With` statements or object initialization lists.|[!code[VbVbalrLineContinuation#5](../VS_visualbasic/codesnippet/VisualBasic/statements-in-visual-basic_19.vb)]<br />[!code[VbVbalrLineContinuation#14](../VS_visualbasic/codesnippet/VisualBasic/statements-in-visual-basic_22.vb)]<br /><br /> For more information, see [With...End With Statement](../VS_visualbasic/with...end-with-statement--visual-basic-.md) or [Object Initializers: Named and Anonymous Types](../VS_visualbasic/object-initializers--named-and-anonymous-types--visual-basic-.md).|  
|After an XML axis property qualifier (`.` or `.@` or `...`). However, you must include a line-continuation character (_) when you specify a member qualifier when you are using the `With` keyword.|[!code[VbVbalrLineContinuation#9](../VS_visualbasic/codesnippet/VisualBasic/statements-in-visual-basic_23.vb)]<br /><br /> For more information, see [XML Axis Properties](../VS_visualbasic/xml-axis-properties--visual-basic-.md).|  
|After a less-than sign (<) or before a greater-than sign (`>`) when you specify an attribute. Also after a greater-than sign (`>`) when you specify an attribute. However, you must include a line-continuation character (_) when you specify assembly-level or module-level attributes.|[!code[VbVbalrLineContinuation#10](../VS_visualbasic/codesnippet/VisualBasic/statements-in-visual-basic_24.vb)]<br /><br /> For more information, see [Attributes](../Topic/Attributes%20\(C%23%20and%20Visual%20Basic\).md).|  
