...
>  An XML literal can span multiple lines without using line continuation characters. This feature enables you to copy content from an XML document and paste it directly into a [!INCLUDE[vbprvb](../VS_visualbasic/includes/vbprvb_md.md)] program.  
 ...
 The [!INCLUDE[vbprvb](../VS_visualbasic/includes/vbprvb_md.md)] compiler converts the XML comment literal to a call to the \<xref:System.Xml.Linq.XComment.#ctor*> constructor.  
  
## Example  
 The following example creates an XML comment that contains the text "This is a comment".  
  
 [!code[VbXMLSamples#9](../VS_visualbasic/codesnippet/VisualBasic/xml-comment-literal--visual-basic-_1.vb)]  
