...
## How Messages are Logged  
 ...
 ![My Log Call](../VS_visualbasic/media/mylogcall.png "MyLogCall")  
 ...
 ![My Log Configuration](../VS_visualbasic/media/mylogconfig.png "MyLogConfig")  
...
## Where Messages are Logged  
 ...
 The debug output can be viewed in the [!INCLUDE[vsprvs](../VS_visualbasic/includes/vsprvs_md.md)] **Output** window when running your application in debug mode. To open the **Output** window, click the **Debug** menu item, point to **Windows**, and then click **Output**. In the **Output** window, select **Debug** from the **Show output from** box.  
 ...
 You can override the default behavior by adding or changing the computer's and the application's configuration files. For more information, see [Walkthrough: Changing Where My.Application.Log Writes Information](../VS_visualbasic/walkthrough--changing-where-my.application.log-writes-information--visual-basic-.md).  
  
## Configuring Log Settings  
 The `Log` object has a default implementation that works without an application configuration file, app.config. To change the defaults, you must add a configuration file with the new settings. For more information, see [Walkthrough: Filtering My.Application.Log Output](../VS_visualbasic/walkthrough--filtering-my.application.log-output--visual-basic-.md).  
...
## See Also  
 ...
 [Logging Information from the Application](../VS_visualbasic/logging-information-from-the-application--visual-basic-.md)