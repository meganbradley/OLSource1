...
## Example  
 ...
 [!code[VbVbalrConditionalComp#3](../VS_csharp/codesnippet/VisualBasic/sharpconst-directive_1.vb)]  
...
## See Also  
 ...
 [If...Then...Else Statement (Visual Basic)](../VS_csharp/if...then...else-statement--visual-basic-.md)