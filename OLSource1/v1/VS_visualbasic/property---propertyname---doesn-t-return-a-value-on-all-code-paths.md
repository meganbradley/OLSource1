...
-   Include the value in a [Return Statement (Visual Basic)](../VS_csharp/return-statement--visual-basic-.md).  
  
 If control passes to `Exit Property` or `End Get` and you have not assigned any value to the property name, the `Get` procedure returns the default value of the property's data type. For more information, see "Behavior" in [Function Statement (Visual Basic)](../VS_csharp/function-statement--visual-basic-.md).  
