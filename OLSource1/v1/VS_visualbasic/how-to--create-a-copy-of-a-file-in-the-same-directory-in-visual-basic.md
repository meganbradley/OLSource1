...
-   Use the `CopyFile` method, supplying the target file and the location. The following example creates a copy of `test.txt` called `test2.txt`.  
     ...
     [!code[VbVbcnMyFileSystem#51](../VS_visualbasic/codesnippet/VisualBasic/how-to--create-a-copy-of-a-file-in-the-same-directory-in-visual-basic_1.vb)]  
...
-   Use the `CopyFile` method, supplying the target file and location, and setting `overwrite` to `True`. The following example creates a copy of `test.txt` called `test2.txt` and overwrites any existing files by that name.  
     ...
     [!code[VbVbcnMyFileSystem#52](../VS_visualbasic/codesnippet/VisualBasic/how-to--create-a-copy-of-a-file-in-the-same-directory-in-visual-basic_2.vb)]  
...
## See Also  
 ...
 [How to: Copy Files with a Specific Pattern to a Directory](../VS_visualbasic/how-to--copy-files-with-a-specific-pattern-to-a-directory-in-visual-basic.md)   
 [How to: Create a Copy of a File in a Different Directory](../VS_visualbasic/how-to--create-a-copy-of-a-file-in-a-different-directory-in-visual-basic.md)   
 [How to: Copy a Directory to Another Directory](../VS_visualbasic/how-to--copy-a-directory-to-another-directory-in-visual-basic.md)   
 [How to: Rename a File](../VS_visualbasic/how-to--rename-a-file-in-visual-basic.md)