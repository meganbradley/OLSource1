...
[!INCLUDE[vbprvb](../VS_visualbasic/includes/vbprvb_md.md)] provides several attributes that allow objects interoperate with unmanaged code, and one attribute that enables module members to be accessed without the module name. The following table lists the attributes used by [!INCLUDE[vbprvb](../VS_visualbasic/includes/vbprvb_md.md)].  
