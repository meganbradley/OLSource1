...
## Nesting Levels  
 Control structures in [!INCLUDE[vbprvb](../VS_visualbasic/includes/vbprvb_md.md)] can be nested to as many levels as you want. It is common practice to make nested structures more readable by indenting the body of each one. The integrated development environment (IDE) editor automatically does this.  
...
## Overlapping Control Structures  
 ...
 ![Graphic diagram of invalid nesting](../VS_visualbasic/media/nestexampleinvalid.gif "NestExampleInvalid")  
Invalid nesting of For and With structures  
  
 The [!INCLUDE[vbprvb](../VS_visualbasic/includes/vbprvb_md.md)] compiler detects such overlapping control structures and signals a compile-time error.  
