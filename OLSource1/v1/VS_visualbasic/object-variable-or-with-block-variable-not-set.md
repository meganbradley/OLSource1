...
-   A variable was declared without specifying a type. If a variable is declared without specifying a type, it defaults to type `Object`.  
    ...
    > [!TIP]
    >  The `Option Strict` statement disallows implicit typing that results in an `Object` type. If you omit the type, a compile-time error will occur. See [Option Strict Statement](../VS_csharp/option-strict-statement.md).  
...
## See Also  
 ...
 [ReDim Statement (Visual Basic)](../VS_csharp/redim-statement--visual-basic-.md)   
 [With...End With Statement](../VS_csharp/with...end-with-statement--visual-basic-.md)