...
If you want to find out if an expression of the [String Data Type (Visual Basic)](../VS_csharp/string-data-type--visual-basic-.md) satisfies a pattern, then you can use the [Like Operator](../VS_csharp/like-operator--visual-basic-.md).  
...
-   Put the specific character directly in the pattern string. Certain special characters must be enclosed in brackets (`[ ]`). For more information, see [Like Operator](../VS_csharp/like-operator--visual-basic-.md).  
  
     The following example tests whether `myString` consists exactly of the single character `H`.  
  
     [!code[VbVbalrOperators#70](../VS_csharp/codesnippet/VisualBasic/how-to--match-a-string-against-a-pattern--visual-basic-_1.vb)]  
...
-   Put a question mark (`?`) in the pattern string. Any valid character in this position makes a successful match.  
     ...
     [!code[VbVbalrOperators#71](../VS_csharp/codesnippet/VisualBasic/how-to--match-a-string-against-a-pattern--visual-basic-_2.vb)]  
...
-   Put brackets (`[ ]`) in the pattern string, and inside the brackets put the list of characters. Do not separate the characters with commas or any other separator. Any single character in the list makes a successful match.  
     ...
     [!code[VbVbalrOperators#72](../VS_csharp/codesnippet/VisualBasic/how-to--match-a-string-against-a-pattern--visual-basic-_3.vb)]  
...
-   Put brackets (`[ ]`) in the pattern string, and inside the brackets put the lowest and highest characters in the range, separated by a hyphen (`–`). Any single character within the range makes a successful match.  
     ...
     [!code[VbVbalrOperators#73](../VS_csharp/codesnippet/VisualBasic/how-to--match-a-string-against-a-pattern--visual-basic-_4.vb)]  
...
1.  Call the `Like` operator twice on the same string expression, and connect the two calls with either the [Or Operator (Visual Basic)](../VS_csharp/or-operator--visual-basic-.md) or the [OrElse Operator](../VS_csharp/orelse-operator--visual-basic-.md).  
...
3.  In the pattern string for the second `Like` clause, do not put any character at the position in question.  
     ...
     [!code[VbVbalrOperators#74](../VS_csharp/codesnippet/VisualBasic/how-to--match-a-string-against-a-pattern--visual-basic-_5.vb)]  
...
## See Also  
 ...
 [String Data Type (Visual Basic)](../VS_csharp/string-data-type--visual-basic-.md)