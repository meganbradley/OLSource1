...
##  <a name="BKMK_ArrayElements"></a> Array Elements in a Simple Array  
 ...
 [!code[VbVbalrArrays#2](../VS_visualbasic/codesnippet/VisualBasic/arrays-in-visual-basic_1.vb)]  
...
-   The value that’s contained in the element represents the number of students in that grade.  
 ...
 ![Picture of array showing numbers of students](../VS_visualbasic/media/arrayexampleschool.gif "ArrayExampleSchool")  
...
##  <a name="BKMK_CreatingAnArray"></a> Creating an Array  
 ...
 [!code[VbVbalrArrays#12](../VS_visualbasic/codesnippet/VisualBasic/arrays-in-visual-basic_3.vb)]  
  
 You can also use a `New` clause to supply the size of an array when it’s created, as the following example shows.  
  
 [!code[VbVbalrArrays#11](../VS_visualbasic/codesnippet/VisualBasic/arrays-in-visual-basic_4.vb)]  
 ...
 [!code[VbVbalrArrays#13](../VS_visualbasic/codesnippet/VisualBasic/arrays-in-visual-basic_5.vb)]  
  
 For more information, see [ReDim Statement](../VS_visualbasic/redim-statement--visual-basic-.md).  
...
##  <a name="BKMK_StoringValues"></a> Storing Values in an Array  
 ...
 [!code[VbVbalrArrays#5](../VS_visualbasic/codesnippet/VisualBasic/arrays-in-visual-basic_6.vb)]  
  
 The following example shows some statements that get values from arrays.  
  
 [!code[VbVbalrArrays#6](../VS_visualbasic/codesnippet/VisualBasic/arrays-in-visual-basic_7.vb)]  
...
##  <a name="BKMK_Populating"></a> Populating an Array with Initial Values  
 ...
 [!code[VbVbalrCollectionInitializers#4](../VS_visualbasic/codesnippet/VisualBasic/arrays-in-visual-basic_9.vb)]  
...
###  <a name="BKMK_NestedArrayLiterals"></a> Nested Array Literals  
 ...
 [!code[VbVbalrCollectionInitializers#7](../VS_visualbasic/codesnippet/VisualBasic/arrays-in-visual-basic_10.vb)]  
...
>  You can avoid an error when you supply nested array literals of different dimensions by enclosing the inner array literals in parentheses. The parentheses force the array literal expression to be evaluated, and the resulting values are used with the outer array literal, as the following code shows.  
 ...
 [!code[VbVbalrCollectionInitializers#11](../VS_visualbasic/codesnippet/VisualBasic/arrays-in-visual-basic_11.vb)]  
 ...
 [!code[VbVbalrCollectionInitializers#8](../VS_visualbasic/codesnippet/VisualBasic/arrays-in-visual-basic_12.vb)]  
  
 For additional examples, see [How to: Initialize an Array Variable in Visual Basic](../VS_visualbasic/how-to--initialize-an-array-variable-in-visual-basic.md).  
...
##  <a name="BKMK_Iterating"></a> Iterating Through an Array  
 ...
 The following example iterates through a one-dimensional array by using the [For...Next Statement](../VS_visualbasic/for...next-statement--visual-basic-.md). The \<xref:System.Array.GetUpperBound*> method returns the highest value that the index can have. The lowest index value is always 0.  
  
 [!code[VbVbalrArrays#41](../VS_visualbasic/codesnippet/VisualBasic/arrays-in-visual-basic_13.vb)]  
 ...
 [!code[VbVbalrArrays#42](../VS_visualbasic/codesnippet/VisualBasic/arrays-in-visual-basic_14.vb)]  
  
 The following example iterates through a one-dimensional array by using a [For Each...Next Statement](../VS_visualbasic/for-each...next-statement--visual-basic-.md).  
  
 [!code[VbVbalrArrays#43](../VS_visualbasic/codesnippet/VisualBasic/arrays-in-visual-basic_15.vb)]  
 ...
 [!code[VbVbalrArrays#44](../VS_visualbasic/codesnippet/VisualBasic/arrays-in-visual-basic_16.vb)]  
  
##  <a name="BKMK_ReturnValues"></a> Arrays as Return Values and Parameters  
 To return an array from a `Function` procedure, specify the array data type and the number of dimensions as the return type of the [Function Statement](../VS_visualbasic/function-statement--visual-basic-.md). Within the function, declare a local array variable with same data type and number of dimensions. In the [Return Statement](../VS_visualbasic/return-statement--visual-basic-.md), include the local array variable without parentheses.  
 ...
 [!code[VbVbalrArrays#51](../VS_visualbasic/codesnippet/VisualBasic/arrays-in-visual-basic_17.vb)]  
 ...
 [!code[VbVbalrArrays#52](../VS_visualbasic/codesnippet/VisualBasic/arrays-in-visual-basic_18.vb)]  
...
##  <a name="BKMK_JaggedArrays"></a> Jagged Arrays  
 ...
 [!code[VbVbalrArrays#21](../VS_visualbasic/codesnippet/VisualBasic/arrays-in-visual-basic_19.vb)]  
...
##  <a name="BKMK_ArrayTypes"></a> Array Types and Other Types  
 ...
 Every array inherits from the \<xref:System.Array?displayProperty=fullName> class, and you can declare a variable to be of type `Array`, but you cannot create an array of type `Array`. Also, the [ReDim Statement](../VS_visualbasic/redim-statement--visual-basic-.md) cannot operate on a variable declared as type `Array`. For these reasons, and for type safety, it is advisable to declare every array as a specific type, such as `Integer` in the preceding example.  
...
-   You can pass the variable to the \<xref:Microsoft.VisualBasic.Information.VarType*> function to receive a `VariantType` value representing the type classification of the variable.  
 ...
 [!code[VbVbalrArrays#15](../VS_visualbasic/codesnippet/VisualBasic/arrays-in-visual-basic_21.vb)]  
...
##  <a name="BKMK_Collections"></a> Collections as an Alternative to Arrays  
 ...
 If you need to change the size of an array, you must use the [ReDim Statement](../VS_visualbasic/redim-statement--visual-basic-.md). When you do this, [!INCLUDE[vbprvb](../VS_visualbasic/includes/vbprvb_md.md)] creates a new array and releases the previous array for disposal. This takes execution time. Therefore, if the number of items you are working with changes frequently, or you cannot predict the maximum number of items you need, you might obtain better performance using a collection.  
...
### Example  
 The following example uses the [!INCLUDE[dnprdnshort](../VS_visualbasic/includes/dnprdnshort_md.md)] generic class <xref:System.Collections.Generic.List`1?displayProperty=fullName> to create a list collection of `Customer` objects.  
  
 [!code[VbVbalrArrays#1](../VS_visualbasic/codesnippet/VisualBasic/arrays-in-visual-basic_22.vb)]  
...
|Term|Definition|  
|----------|----------------|  
|[Array Dimensions in Visual Basic](../VS_visualbasic/array-dimensions-in-visual-basic.md)|Explains rank and dimensions in arrays.|  
|[How to: Initialize an Array Variable in Visual Basic](../VS_visualbasic/how-to--initialize-an-array-variable-in-visual-basic.md)|Describes how to populate arrays with initial values.|  
|[How to: Sort An Array in Visual Basic](../VS_visualbasic/how-to--sort-an-array-in-visual-basic.md)|Shows how to sort the elements of an array alphabetically.|  
|[How to: Assign One Array to Another Array](../VS_visualbasic/how-to--assign-one-array-to-another-array--visual-basic-.md)|Describes the rules and steps for assigning an array to another array variable.|  
|[Troubleshooting Arrays](../VS_visualbasic/troubleshooting-arrays--visual-basic-.md)|Discusses some common problems that arise when working with arrays.|  
