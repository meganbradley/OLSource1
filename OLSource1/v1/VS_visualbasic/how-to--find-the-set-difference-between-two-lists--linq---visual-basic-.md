...
1.  Copy names1.txt and names2.txt to your solution folder as shown in [How to: Combine and Compare String Collections (LINQ) (Visual Basic)](../VS_visualbasic/how-to--combine-and-compare-string-collections--linq---visual-basic-.md).  
