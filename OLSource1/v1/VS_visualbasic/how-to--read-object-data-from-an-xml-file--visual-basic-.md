...
## Compiling the Code  
 Replace the file name "c:\temp\SerializationOverview.xml" with the name of the file containing the serialized data. For more information about serializing data, see [How to: Write Object Data to an XML File (Visual Basic)](../VS_csharp/how-to--write-object-data-to-an-xml-file--visual-basic-.md).  
...
## See Also  
 ...
 [How to: Write Object Data to an XML File (Visual Basic)](../VS_csharp/how-to--write-object-data-to-an-xml-file--visual-basic-.md)   
 [Serialization (Visual Basic)](../VS_csharp/serialization--visual-basic-.md)   
