...
-   The data types of `Static` local variables cannot be inferred. For more information, see [Local Type Inference](../VS_csharp/local-type-inference--visual-basic-.md).  
...
## Example  
 ...
 [!code[VbVbalrKeywords#5](../VS_csharp/codesnippet/VisualBasic/static--visual-basic-_1.vb)]  
