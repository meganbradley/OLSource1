...
## Example  
 [!code[VbVbalrStrings#71](../VS_visualbasic/codesnippet/VisualBasic/how-to--search-within-a-string--visual-basic-_1.vb)]  
  
## Compiling the Code  
 This example requires:  
  
-   An `Imports` statement specifying the \<xref:System> namespace. For more information, see [Imports Statement (.NET Namespace and Type)](../VS_visualbasic/imports-statement--.net-namespace-and-type-.md).  
...
## Robust Programming  
 ...
 For optimal error control, you might want to enclose the string search in the `Try` block of a [Try...Catch...Finally Statement](../VS_visualbasic/try...catch...finally-statement--visual-basic-.md) construction.  
