...
## Remarks  
 Use the `<summary>` tag to describe a type or a type member. Use [\<remarks>](../VS_visualbasic/-remarks---visual-basic-.md) to add supplemental information to a type description.  
...
## Example  
 ...
 [!code[VbVbcnXmlDocComments#1](../VS_visualbasic/codesnippet/VisualBasic/-summary---visual-basic-_1.vb)]  
