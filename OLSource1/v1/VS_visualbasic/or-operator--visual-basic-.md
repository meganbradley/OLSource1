...
> [!NOTE]
>  In a `Boolean` comparison, the `Or` operator always evaluates both expressions, which could include making procedure calls. The [OrElse Operator](../VS_visualbasic/orelse-operator--visual-basic-.md) performs *short-circuiting*, which means that if `expression1` is `True`, then `expression2` is not evaluated.  
...
## Data Types  
 ...
 For a `Boolean` comparison, the data type of the result is `Boolean`. For a bitwise comparison, the result data type is a numeric type appropriate for the data types of `expression1` and `expression2`. See the "Relational and Bitwise Comparisons" table in [Data Types of Operator Results](../VS_visualbasic/data-types-of-operator-results--visual-basic-.md).  
...
## Example  
 ...
 [!code[VbVbalrOperators#35](../VS_visualbasic/codesnippet/VisualBasic/or-operator--visual-basic-_1.vb)]  
...
## Example  
 ...
 [!code[VbVbalrOperators#36](../VS_visualbasic/codesnippet/VisualBasic/or-operator--visual-basic-_2.vb)]  
...
## See Also  
 ...
 [OrElse Operator](../VS_visualbasic/orelse-operator--visual-basic-.md)   
