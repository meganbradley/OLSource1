...
-   Supplying a [New Operator](../VS_visualbasic/new-operator--visual-basic-.md) clause after specifying dimension lengths in the array variable declaration. The following code lines show invalid declarations of this type.  
