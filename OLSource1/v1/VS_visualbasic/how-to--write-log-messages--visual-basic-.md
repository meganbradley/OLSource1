...
You can use the `My.Application.Log` and `My.Log` objects to log information about your application. This example shows how to use the `My.Application.Log.WriteEntry` method to log tracing information.  
 ...
 For logging exception information, use the `My.Application.Log.WriteException` method; see [How to: Log Exceptions](../VS_visualbasic/how-to--log-exceptions-in-visual-basic.md).  
  
## Example  
 This example uses the `My.Application.Log.WriteEntry` method to write out the trace information.  
  
 [!code[VbVbalrMyApplicationLog#11](../VS_visualbasic/codesnippet/VisualBasic/how-to--write-log-messages--visual-basic-_1.vb)]  
  
## .NET Framework Security  
 Make sure the data you write to the log does not include sensitive information such as user passwords. For more information, see [Working with Application Logs](../VS_visualbasic/working-with-application-logs-in-visual-basic.md).  
...
## See Also  
 ...
 [Walkthrough: Filtering My.Application.Log Output](../VS_visualbasic/walkthrough--filtering-my.application.log-output--visual-basic-.md)