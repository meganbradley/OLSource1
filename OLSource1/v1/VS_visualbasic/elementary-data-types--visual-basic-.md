...
[!INCLUDE[vbprvb](../VS_visualbasic/includes/vbprvb_md.md)] supplies a set of predefined data types, which you can use for many of your programming elements. This section describes these types and how to use them.  
...
## Related Sections  
 ...
 Introduces the [!INCLUDE[vbprvb](../VS_visualbasic/includes/vbprvb_md.md)] data types and describes how to use them.  
  
 [Data Types](../VS_visualbasic/data-type-summary--visual-basic-.md)  
 Provides an overview of the elementary data types supplied by [!INCLUDE[vbprvb](../VS_visualbasic/includes/vbprvb_md.md)].