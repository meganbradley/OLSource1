...
## Example  
 The following example shows the same code for XML that is in a namespace. For more information, see [Working with XML Namespaces (Visual Basic)](../VS_csharp/working-with-xml-namespaces--visual-basic-.md).  
