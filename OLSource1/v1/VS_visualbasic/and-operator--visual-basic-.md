...
> [!NOTE]
>  In a Boolean comparison, the `And` operator always evaluates both expressions, which could include making procedure calls. The [AndAlso Operator](../VS_visualbasic/andalso-operator--visual-basic-.md) performs *short-circuiting*, which means that if `expression1` is `False`, then `expression2` is not evaluated.  
...
## Example  
 ...
 [!code[VbVbalrOperators#22](../VS_visualbasic/codesnippet/VisualBasic/and-operator--visual-basic-_1.vb)]  
...
## Example  
 ...
 [!code[VbVbalrOperators#23](../VS_visualbasic/codesnippet/VisualBasic/and-operator--visual-basic-_2.vb)]  
