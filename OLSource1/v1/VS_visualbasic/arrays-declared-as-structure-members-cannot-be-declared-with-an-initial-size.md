...
2.  If you require a certain size of array, you can redimension a dynamic array with a [ReDim Statement](../VS_visualbasic/redim-statement--visual-basic-.md) when your code is running. The following example illustrates this.  
