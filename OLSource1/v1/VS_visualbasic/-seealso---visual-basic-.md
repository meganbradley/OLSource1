...
## Remarks  
 Use the `<seealso>` tag to specify the text that you want to appear in a See Also section. Use [\<see>](../VS_visualbasic/-see---visual-basic-.md) to specify a link from within text.  
...
## Example  
 ...
 [!code[VbVbcnXmlDocComments#6](../VS_visualbasic/codesnippet/VisualBasic/-seealso---visual-basic-_1.vb)]  
