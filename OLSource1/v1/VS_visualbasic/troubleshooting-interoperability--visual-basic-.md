...
## Overloaded Methods  
 Although you can create overloaded methods with [!INCLUDE[vbprvb](../VS_visualbasic/includes/vbprvb_md.md)], they are not supported by COM. When a class that contains overloaded methods is exposed as a COM object, new method names are generated for the overloaded methods.  
...
##  <a name="vbconinteroperabilitymarshalinganchor6"></a> Creating Instances of a .NET Framework Class  
 ...
 [!code[VbVbalrInterop#21](../VS_visualbasic/codesnippet/VisualBasic/troubleshooting-interoperability--visual-basic-_2.vb)]  
...
```  
 ...
 [!INCLUDE[vbprvblong](../VS_visualbasic/includes/vbprvblong_md.md)] requires that you always create instances of COM objects before you can use their methods. To use these methods in [!INCLUDE[vbprvblong](../VS_visualbasic/includes/vbprvblong_md.md)], declare a variable of the desired class and use the new keyword to assign the object to the object variable. The `Shared` keyword can be used when you want to make sure that only one instance of the class is created.  
  
 [!code[VbVbalrInterop#23](../VS_visualbasic/codesnippet/VisualBasic/troubleshooting-interoperability--visual-basic-_3.vb)]  
  
##  <a name="vbconinteroperabilitymarshalinganchor9"></a> Unhandled Errors in Event Handlers  
 One common interop problem involves errors in event handlers that handle events raised by COM objects. Such errors are ignored unless you specifically check for errors using `On Error` or `Try...Catch...Finally` statements. For example, the following example is from a [!INCLUDE[vbprvblong](../VS_visualbasic/includes/vbprvblong_md.md)] project that has a reference to the Microsoft ActiveX Data Objects 2.8 Library COM object.  
  
 [!code[VbVbalrInterop#24](../VS_visualbasic/codesnippet/VisualBasic/troubleshooting-interoperability--visual-basic-_4.vb)]  
...
### Understanding COM interop errors  
 ...
 [!code[VbVbalrInterop#25](../VS_visualbasic/codesnippet/VisualBasic/troubleshooting-interoperability--visual-basic-_5.vb)]  
...
##  <a name="vbconinteroperabilitymarshalinganchor10"></a> ActiveX Control Issues  
 Most ActiveX controls that work with Visual Basic 6.0 work with [!INCLUDE[vbprvblong](../VS_visualbasic/includes/vbprvblong_md.md)] without trouble. The main exceptions are container controls, or controls that visually contain other controls. Some examples of older controls that do not work correctly with [!INCLUDE[vsprvs](../VS_visualbasic/includes/vsprvs_md.md)] are as follows:  
...
##  <a name="vbconinteroperabilitymarshalinganchor11"></a> Passing ReadOnly Properties of Controls ByRef  
 ...
 [!code[VbVbalrInterop#26](../VS_visualbasic/codesnippet/VisualBasic/troubleshooting-interoperability--visual-basic-_6.vb)]  
 ...
 [!code[VbVbalrInterop#27](../VS_visualbasic/codesnippet/VisualBasic/troubleshooting-interoperability--visual-basic-_7.vb)]  
...
## See Also  
 ...
 [Walkthrough: Implementing Inheritance with COM Objects](../VS_visualbasic/walkthrough--implementing-inheritance-with-com-objects--visual-basic-.md)   
