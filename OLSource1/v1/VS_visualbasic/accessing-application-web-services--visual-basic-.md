...
|-|-|  
|To|See|  
|Call a Web service|[My.WebServices Object](../VS_csharp/my.webservices-object.md)|  
|Call a Web service asynchronously and handle an event when it completes|[How to: Call a Web Service Asynchronously](../VS_csharp/how-to--call-a-web-service-asynchronously--visual-basic-.md)|  
