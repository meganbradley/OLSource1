...
An aggregation operation computes a single value from a collection of values. An example of an aggregation operation is calculating the average daily temperature from a month's worth of daily temperature values.  
 ...
 ![LINQ Aggregation Operations](../VS_visualbasic/media/linq_aggregation.png "LINQ_Aggregation")  
...
### Average  
 The following code example uses the `Aggregate Into Average` clause in [!INCLUDE[vbprvb](../VS_visualbasic/includes/vbprvb_md.md)] to calculate the average temperature in an array of numbers that represent temperatures.  
  
 [!code[CsLINQAggregating#1](../VS_visualbasic/codesnippet/VisualBasic/aggregation-operations--visual-basic-_1.vb)]  
  
### Count  
 The following code example uses the `Aggregate Into Count` clause in [!INCLUDE[vbprvb](../VS_visualbasic/includes/vbprvb_md.md)] to count the number of values in an array that are greater than or equal to 80.  
  
 [!code[CsLINQAggregating#2](../VS_visualbasic/codesnippet/VisualBasic/aggregation-operations--visual-basic-_2.vb)]  
  
### LongCount  
 The following code example uses the `Aggregate Into LongCount` clause to count the number of values in an array.  
  
 [!code[CsLINQAggregating#3](../VS_visualbasic/codesnippet/VisualBasic/aggregation-operations--visual-basic-_3.vb)]  
...
### Max  
 ...
 [!code[CsLINQAggregating#4](../VS_visualbasic/codesnippet/VisualBasic/aggregation-operations--visual-basic-_4.vb)]  
...
### Min  
 ...
 [!code[CsLINQAggregating#5](../VS_visualbasic/codesnippet/VisualBasic/aggregation-operations--visual-basic-_5.vb)]  
...
### Sum  
 ...
 [!code[CsLINQAggregating#6](../VS_visualbasic/codesnippet/VisualBasic/aggregation-operations--visual-basic-_6.vb)]  
