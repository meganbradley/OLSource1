...
## Remarks  
 ...
 [!code[VbVbalrEvents#37](../VS_visualbasic/codesnippet/VisualBasic/raiseevent-statement_1.vb)]  
...
> [!NOTE]
>  You can change the default behavior of events by defining a custom event. For custom events, the `RaiseEvent` statement invokes the event's `RaiseEvent` accessor. For more information on custom events, see [Event Statement](../VS_visualbasic/event-statement.md).  
...
## Example  
 ...
 [!code[VbVbalrEvents#14](../VS_visualbasic/codesnippet/VisualBasic/raiseevent-statement_2.vb)]  
...
## Example  
 ...
 [!code[VbVbalrEvents#15](../VS_visualbasic/codesnippet/VisualBasic/raiseevent-statement_3.vb)]  
