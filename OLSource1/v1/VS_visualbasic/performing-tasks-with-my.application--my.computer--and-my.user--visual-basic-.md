...
## My.Application, My.Computer, and My.User  
 ...
 [!code[VbVbcnMy#1](../VS_csharp/codesnippet/VisualBasic/performing-tasks-with-my.application--my.computer--and-my.user--visual-basic-_1.vb)]  
  
 [!code[VbVbcnMy#2](../VS_csharp/codesnippet/VisualBasic/performing-tasks-with-my.application--my.computer--and-my.user--visual-basic-_2.vb)]  
 ...
 [!code[VbVbalrTextFieldParser#23](../VS_csharp/codesnippet/VisualBasic/performing-tasks-with-my.application--my.computer--and-my.user--visual-basic-_3.vb)]  
 ...
 [!code[VbVbcnMy#3](../VS_csharp/codesnippet/VisualBasic/performing-tasks-with-my.application--my.computer--and-my.user--visual-basic-_4.vb)]  
