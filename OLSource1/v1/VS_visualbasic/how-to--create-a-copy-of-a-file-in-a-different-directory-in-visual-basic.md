...
-   Use the `CopyFile` method to copy a file, specifying a source file and the target directory. The`overwrite` parameter allows you to specify whether or not to overwrite existing files. The following code examples demonstrate how to use `CopyFile`.  
     ...
     [!code[VbFileIOMisc#24](../VS_visualbasic/codesnippet/VisualBasic/how-to--create-a-copy-of-a-file-in-a-different-directory-in-visual-basic_1.vb)]  
...
## See Also  
 ...
 [How to: Create a Copy of a File in the Same Directory](../VS_visualbasic/how-to--create-a-copy-of-a-file-in-the-same-directory-in-visual-basic.md)   
