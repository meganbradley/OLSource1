...
You declare a variable of the [Object Data Type](../VS_visualbasic/object-data-type.md) by specifying `As Object` in a [Dim Statement](../VS_visualbasic/dim-statement--visual-basic-.md). You assign an object to such a variable by placing the object after the equal sign (`=`) in an assignment statement or initialization clause.  
