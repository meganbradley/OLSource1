...
You declare a variable of the [Object Data Type](../VS_csharp/object-data-type.md) by specifying `As Object` in a [Dim Statement (Visual Basic)](../VS_csharp/dim-statement--visual-basic-.md). You assign an object to such a variable by placing the object after the equal sign (`=`) in an assignment statement or initialization clause.  
