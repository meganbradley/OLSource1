...
## Installing the Power Packs Controls as a Prerequisite  
 ...
 When [!INCLUDE[vsprvs](../VS_visualbasic/includes/vsprvs_md.md)] is installed on your development computer, a Power Packs bootstrapper package is added to the [!INCLUDE[vsprvs](../VS_visualbasic/includes/vsprvs_md.md)] bootstrapper directory. This package is then available when you follow the procedures for adding prerequisites for either [!INCLUDE[ndptecclick](../VS_visualbasic/includes/ndptecclick_md.md)] or Windows Installer deployment.  
