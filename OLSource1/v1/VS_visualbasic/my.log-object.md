...
## Remarks  
 ...
 The `My.Log` object is available for ASP.NET applications only. For client applications, use [My.Application.Log Object](../VS_csharp/my.application.log-object.md).  
