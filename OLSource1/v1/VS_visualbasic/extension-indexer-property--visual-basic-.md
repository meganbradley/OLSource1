...
## Remarks  
 ...
 To access the value of the first element in a collection of \<xref:System.Xml.Linq.XElement> or \<xref:System.Xml.Linq.XAttribute> objects, you can use the XML `Value` property. For more information, see [XML Value Property](../VS_visualbasic/xml-value-property--visual-basic-.md).  
...
## Example  
 ...
 [!code[VbXMLSamples#24](../VS_visualbasic/codesnippet/VisualBasic/extension-indexer-property--visual-basic-_1.vb)]  
