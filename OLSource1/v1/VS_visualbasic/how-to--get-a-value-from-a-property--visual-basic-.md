...
You retrieve a property's value by including the property name in an expression.  
 ...
 The property's `Get` procedure retrieves the value, but you do not explicitly call it by name. You use the property just as you would use a variable. [!INCLUDE[vbprvb](../VS_csharp/includes/vbprvb_md.md)] makes the calls to the property's procedures.  
...
1.  Use the property name in an expression the same way you would use a variable name. You can use a property anywhere you can use a variable or a constant.  
     ...
     The following example reads the value of the [!INCLUDE[vbprvb](../VS_csharp/includes/vbprvb_md.md)] `Now` property, implicitly calling its `Get` procedure.  
  
     [!code[VbVbalrDateProperties#4](../VS_csharp/codesnippet/VisualBasic/how-to--get-a-value-from-a-property--visual-basic-_1.vb)]  
...
## See Also  
 ...
 [Differences Between Properties and Variables](../VS_csharp/differences-between-properties-and-variables-in-visual-basic.md)   
 ...
 [How to: Declare and Call a Default Property (Visual Basic)](../VS_csharp/how-to--declare-and-call-a-default-property-in-visual-basic.md)   
