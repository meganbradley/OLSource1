...
## Example  
 ...
 This example uses the following XML document: [Sample XML File: Test Configuration (LINQ to XML)](../VS_csharp/sample-xml-file--test-configuration--linq-to-xml-2.md).  
...
## Example  
 ...
 This example uses the following XML document: [Sample XML File: Test Configuration in a Namespace](../VS_csharp/sample-xml-file--test-configuration-in-a-namespace3.md).  
