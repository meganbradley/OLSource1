...
## Example  
 ...
 [!code[VbVbalrCollectionInitializersHowTo1#1](../VS_csharp/codesnippet/VisualBasic/how-to--create-an-add-extension-method-used-by-a-collection-initializer--visual-basic-_1.vb)]  
  
 [!code[VbVbalrCollectionInitializersHowTo1#2](../VS_csharp/codesnippet/VisualBasic/how-to--create-an-add-extension-method-used-by-a-collection-initializer--visual-basic-_2.vb)]  
  
 [!code[VbVbalrCollectionInitializersHowTo1#3](../VS_csharp/codesnippet/VisualBasic/how-to--create-an-add-extension-method-used-by-a-collection-initializer--visual-basic-_3.vb)]  
  
## See Also  
 [Collection Initializers Overview (Visual Basic)](../VS_csharp/collection-initializers--visual-basic-.md)   
 [How to: Create a Collection Used by a Collection Initializer](../VS_csharp/how-to--create-a-collection-used-by-a-collection-initializer--visual-basic-.md)