...
> [!NOTE]
>  The `To` keyword is used in this statement to specify the range for the counter. You can also use this keyword in the [Select...Case Statement (Visual Basic)](../VS_csharp/select...case-statement--visual-basic-.md) and in array declarations. For more information about array declarations, see [Dim Statement (Visual Basic)](../VS_csharp/dim-statement--visual-basic-.md).  
...
## Simple Examples  
 ...
 [!code[VbVbalrStatements#111](../VS_csharp/codesnippet/VisualBasic/for...next-statement--visual-basic-_1.vb)]  
 ...
 [!code[VbVbalrStatements#112](../VS_csharp/codesnippet/VisualBasic/for...next-statement--visual-basic-_2.vb)]  
  
> [!TIP]
>  A [While...End While Statement](../VS_csharp/while...end-while-statement--visual-basic-.md) or [Do...Loop Statement](../VS_csharp/do...loop-statement--visual-basic-.md) works well when you don't know in advance how many times to run the statements in the loop. However, when you expect to run the loop a specific number of times, a `For`...`Next` loop is a better choice. You determine the number of iterations when you first enter the loop.  
...
## Nesting Loops  
 ...
 [!code[VbVbalrStatements#113](../VS_csharp/codesnippet/VisualBasic/for...next-statement--visual-basic-_3.vb)]  
  
 When nesting loops, each loop must have a unique `counter` variable.  
  
 You can also nest different kinds control structures within each other. For more information, see [Nested Control Structures](../VS_csharp/nested-control-structures--visual-basic-.md).  
...
## Exit For and Continue For  
 ...
 [!code[VbVbalrStatements#115](../VS_csharp/codesnippet/VisualBasic/for...next-statement--visual-basic-_4.vb)]  
...
-   You have an endless loop, which is a loop that could run a large or even infinite number of times. If you detect such a condition, you can use `Exit For` to escape the loop. For more information, see [Do...Loop Statement (Visual Basic)](../VS_csharp/do...loop-statement--visual-basic-.md).  
...
|No|No|Yes. The data type is inferred from the `start`, `end`, and `step` expressions. For information about type inference, see [Option Infer Statement](../VS_csharp/option-infer-statement.md) and [Local Type Inference (Visual Basic)](../VS_csharp/local-type-inference--visual-basic-.md).|  
...
-   An enumeration that you declare by using an [Enum Statement (Visual Basic)](../VS_csharp/enum-statement--visual-basic-.md).  
...
## Example  
 ...
 [!code[VbVbalrStatements#114](../VS_csharp/codesnippet/VisualBasic/for...next-statement--visual-basic-_5.vb)]  
  
## Example  
 The following example iterates through an enumeration that's declared by using an [Enum Statement (Visual Basic)](../VS_csharp/enum-statement--visual-basic-.md).  
  
 [!code[VbVbalrStatements#116](../VS_csharp/codesnippet/VisualBasic/for...next-statement--visual-basic-_6.vb)]  
  
## Example  
 In the following example, the statement parameters use a class that has operator overloads for the `+`, `-`, `>=`, and `<=` operators.  
  
 [!code[VbVbalrStatements#117](../VS_csharp/codesnippet/VisualBasic/for...next-statement--visual-basic-_7.vb)]  
