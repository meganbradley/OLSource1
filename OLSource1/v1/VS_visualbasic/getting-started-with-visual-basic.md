...
## Related Sections  
 ...
 Provides links to sample code in [!INCLUDE[vbprvb](../VS_visualbasic/includes/vbprvb_md.md)].  
  
 [Walkthroughs](../VS_visualbasic/visual-basic-language-walkthroughs.md)  
 Provides a list of Help pages that demonstrate aspects of the [!INCLUDE[vbprvb](../VS_visualbasic/includes/vbprvb_md.md)] language.  
 ...
 Provides links into the [!INCLUDE[vsprvs](../VS_visualbasic/includes/vsprvs_md.md)] documentation.  
  
 [C#](../Topic/C%23.md)  
 Provides links into the documentation on application development with [!INCLUDE[csprcs](../VS_visualbasic/includes/csprcs_md.md)].  
 ...
 Provides information about using Microsoft Office and [!INCLUDE[vsprvs](../VS_visualbasic/includes/vsprvs_md.md)] as part of a business application.