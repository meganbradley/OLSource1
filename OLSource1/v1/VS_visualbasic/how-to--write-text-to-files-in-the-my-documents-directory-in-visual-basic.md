...
1.  Use the `My.Computer.FileSystem.SpecialDirectories.MyDocuments` property to supply the path.  
     ...
     [!code[VbFileIOWrite#1](../VS_visualbasic/codesnippet/VisualBasic/how-to--write-text-to-files-in-the-my-documents-directory-in-visual-basic_1.vb)]  
  
2.  Use the `WriteAllText` method to write text to the specified file.  
  
     [!code[VbVbcnMyFileSystem#14](../VS_visualbasic/codesnippet/VisualBasic/how-to--write-text-to-files-in-the-my-documents-directory-in-visual-basic_2.vb)]  
  
## Example  
 [!code[VbFileIOWrite#2](../VS_visualbasic/codesnippet/VisualBasic/how-to--write-text-to-files-in-the-my-documents-directory-in-visual-basic_3.vb)]  
