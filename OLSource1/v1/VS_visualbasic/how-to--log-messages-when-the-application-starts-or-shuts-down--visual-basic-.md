...
3.  Add the `My.Application.Log.WriteEntry` method to the `Startup` event handler.  
     ...
     [!code[VbVbalrMyApplicationLog#1](../VS_csharp/codesnippet/VisualBasic/how-to--log-messages-when-the-application-starts-or-shuts-down--visual-basic-_1.vb)]  
...
3.  Add the `My.Application.Log.WriteEntry` method to the `Shutdown` event handler.  
     ...
     [!code[VbVbalrMyApplicationLog#2](../VS_csharp/codesnippet/VisualBasic/how-to--log-messages-when-the-application-starts-or-shuts-down--visual-basic-_2.vb)]  
  
## Example  
 You can use the **Project Designer** to access the application events in the Code Editor. For more information, see [Application Page, Project Designer (Visual Basic)](../VS_csharp/application-page--project-designer--visual-basic-.md).  
  
 [!code[VbVbalrMyApplicationLog#3](../VS_csharp/codesnippet/VisualBasic/how-to--log-messages-when-the-application-starts-or-shuts-down--visual-basic-_3.vb)]  
