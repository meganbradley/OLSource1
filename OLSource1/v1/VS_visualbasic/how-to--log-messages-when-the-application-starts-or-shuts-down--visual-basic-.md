...
3.  Add the `My.Application.Log.WriteEntry` method to the `Startup` event handler.  
     ...
     [!code[VbVbalrMyApplicationLog#1](../VS_visualbasic/codesnippet/VisualBasic/how-to--log-messages-when-the-application-starts-or-shuts-down--visual-basic-_1.vb)]  
...
3.  Add the `My.Application.Log.WriteEntry` method to the `Shutdown` event handler.  
     ...
     [!code[VbVbalrMyApplicationLog#2](../VS_visualbasic/codesnippet/VisualBasic/how-to--log-messages-when-the-application-starts-or-shuts-down--visual-basic-_2.vb)]  
...
## Example  
 ...
 [!code[VbVbalrMyApplicationLog#3](../VS_visualbasic/codesnippet/VisualBasic/how-to--log-messages-when-the-application-starts-or-shuts-down--visual-basic-_3.vb)]  
