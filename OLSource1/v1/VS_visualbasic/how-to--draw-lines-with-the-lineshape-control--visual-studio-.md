...
4.  Add the following code in an `Event` procedure:  
     ...
     [!code[VbPowerPacksLine#1](../VS_visualbasic/codesnippet/CSharp/how-to--draw-lines-with-the-lineshape-control--visual-studio-_1.cs)]
[!code[VbPowerPacksLine#1](../VS_visualbasic/codesnippet/VisualBasic/how-to--draw-lines-with-the-lineshape-control--visual-studio-_1.vb)]  
