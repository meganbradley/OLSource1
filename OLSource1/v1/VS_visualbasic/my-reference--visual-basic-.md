...
|Accessing the forms in the current project.|[My.Forms Object](../VS_visualbasic/my.forms-object.md)|  
|Accessing the application log.|`My.Application.Log` (\<xref:Microsoft.VisualBasic.ApplicationServices.ApplicationBase.Log*>)|  
|Accessing the current web request.|[My.Request Object](../VS_visualbasic/my.request-object.md)|  
|Accessing resource elements.|[My.Resources Object](../VS_visualbasic/my.resources-object.md)|  
|Accessing the current web response.|[My.Response Object](../VS_visualbasic/my.response-object.md)|  
|Accessing user and application level settings.|[My.Settings Object](../VS_visualbasic/my.settings-object.md)|  
|Accessing the current user's security context.|`My.User` (\<xref:Microsoft.VisualBasic.ApplicationServices.User>)|  
|Accessing XML Web services referenced by the current project.|[My.WebServices Object](../VS_visualbasic/my.webservices-object.md)|  
  
## See Also  
 [Overview of the Visual Basic Application Model](../VS_visualbasic/overview-of-the-visual-basic-application-model.md)   
 [Development with My](../VS_visualbasic/development-with-my--visual-basic-.md)