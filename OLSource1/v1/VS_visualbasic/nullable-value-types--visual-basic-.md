...
Sometimes you work with a value type that does not have a defined value in certain circumstances. For example, a field in a database might have to distinguish between having an assigned value that is meaningful and not having an assigned value. Value types can be extended to take either their normal values or a null value. Such an extension is called a *nullable type*.  
 ...
 [!code[VbVbalrNullableValue#1](../VS_visualbasic/codesnippet/VisualBasic/nullable-value-types--visual-basic-_1.vb)]  
 ...
 You cannot construct a nullable type on a reference type such as an array, a `String`, or a class. The underlying type must be a value type. For more information, see [Value Types and Reference Types](../VS_visualbasic/value-types-and-reference-types.md).  
...
### Default Values  
 ...
 [!code[VbVbalrNullableValue#2](../VS_visualbasic/codesnippet/VisualBasic/nullable-value-types--visual-basic-_2.vb)]  
...
### Storing Values  
 ...
 [!code[VbVbalrNullableValue#3](../VS_visualbasic/codesnippet/VisualBasic/nullable-value-types--visual-basic-_3.vb)]  
 ...
 [!code[VbVbalrNullableValue#4](../VS_visualbasic/codesnippet/VisualBasic/nullable-value-types--visual-basic-_4.vb)]  
...
### Retrieving Values  
 To retrieve the value of a variable of a nullable type, you should first test its <xref:System.Nullable`1.HasValue*> property to confirm that it has a value. If you try to read the value when <xref:System.Nullable`1.HasValue*> is `False`, [!INCLUDE[vbprvb](../VS_visualbasic/includes/vbprvb_md.md)] throws an \<xref:System.InvalidOperationException> exception. The following example shows the recommended way to read the variable `numberOfChildren` of the previous examples.  
  
 [!code[VbVbalrNullableValue#5](../VS_visualbasic/codesnippet/VisualBasic/nullable-value-types--visual-basic-_5.vb)]  
...
|`False`|`False`|`False`|`False`|  
 ...
 [!code[VbVbalrNullableValue#6](../VS_visualbasic/codesnippet/VisualBasic/nullable-value-types--visual-basic-_6.vb)]  
...
## Propagation  
 ...
 [!code[VbVbalrNullableValue#7](../VS_visualbasic/codesnippet/VisualBasic/nullable-value-types--visual-basic-_7.vb)]  
  
 If one or both operands have a value of `Nothing`, the result will be `Nothing`.  
  
 [!code[VbVbalrNullableValue#8](../VS_visualbasic/codesnippet/VisualBasic/nullable-value-types--visual-basic-_8.vb)]  
