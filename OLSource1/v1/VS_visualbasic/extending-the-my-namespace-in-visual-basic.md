...
##  <a name="customizing"></a> Customizing Existing My Namespace Members  
 The `My` namespace in Visual Basic exposes frequently used information about your application, your computer, and more. For a complete list of the objects in the `My` namespace, see [My Reference](../VS_visualbasic/my-reference--visual-basic-.md). You may have to customize existing members of the `My` namespace so that they better match the needs of your application. Any property of an object in the `My` namespace that is not read-only can be set to a custom value.  
 ...
 [!code[VbVbcnExtendingMy#1](../VS_visualbasic/codesnippet/VisualBasic/extending-the-my-namespace-in-visual-basic_1.vb)]  
...
##  <a name="addingtoobjects"></a> Adding Members to My Objects  
 ...
 [!code[VbVbcnExtendingMy#2](../VS_visualbasic/codesnippet/VisualBasic/extending-the-my-namespace-in-visual-basic_2.vb)]  
...
###  <a name="addingtonamespace"></a> Adding Members to the My Namespace  
 ...
 [!code[VbVbcnExtendingMy#3](../VS_visualbasic/codesnippet/VisualBasic/extending-the-my-namespace-in-visual-basic_3.vb)]  
 ...
 [!code[VbVbcnExtendingMy#4](../VS_visualbasic/codesnippet/VisualBasic/extending-the-my-namespace-in-visual-basic_4.vb)]  
...
##  <a name="addingevents"></a> Adding Events to Custom My Objects  
 ...
 [!code[VbVbcnExtendingMy#5](../VS_visualbasic/codesnippet/VisualBasic/extending-the-my-namespace-in-visual-basic_5.vb)]  
 ...
 [!code[VbVbcnExtendingMy#6](../VS_visualbasic/codesnippet/VisualBasic/extending-the-my-namespace-in-visual-basic_6.vb)]  
...
##  <a name="packaging"></a> Packaging and Deploying Extensions  
 ...
 For details about how to deploy `My` namespace extensions, see [Packaging and Deploying Custom My Extensions](../VS_visualbasic/packaging-and-deploying-custom-my-extensions--visual-basic-.md).  
  
## See Also  
 [Packaging and Deploying Custom My Extensions](../VS_visualbasic/packaging-and-deploying-custom-my-extensions--visual-basic-.md)   
 [Extending the Visual Basic Application Model](../VS_visualbasic/extending-the-visual-basic-application-model.md)   
 [Customizing Which Objects are Available in My](../VS_visualbasic/customizing-which-objects-are-available-in-my--visual-basic-.md)   
