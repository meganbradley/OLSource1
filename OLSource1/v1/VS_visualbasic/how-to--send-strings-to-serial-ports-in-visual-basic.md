...
This topic describes how to use `My.Computer.Ports` to send strings to the computer's serial ports in [!INCLUDE[vbprvb](../VS_visualbasic/includes/vbprvb_md.md)].  
...
## Example  
 ...
 [!code[VbVbalrMyComputer#33](../VS_visualbasic/codesnippet/VisualBasic/how-to--send-strings-to-serial-ports-in-visual-basic_1.vb)]  
