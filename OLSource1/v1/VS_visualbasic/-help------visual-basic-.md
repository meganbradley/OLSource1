...
> [!NOTE]
>  The `/help` option is not available from within the [!INCLUDE[vsprvs](../VS_visualbasic/includes/vsprvs_md.md)] development environment; it is available only when compiling from the command line.  
