...
---
# Visual Basic
Visual Basic is engineered for productively building type-safe and object-oriented applications. Visual Basic enables developers to target Windows, Web, and mobile devices. As with all languages targeting the Microsoft [!INCLUDE[dnprdnshort](../VS_csharp/includes/dnprdnshort_md.md)], programs written in Visual Basic benefit from security and language interoperability.  
  
 This generation of [!INCLUDE[vbprvb](../VS_csharp/includes/vbprvb_md.md)] continues the tradition of giving you a fast and easy way to create [!INCLUDE[dnprdnshort](../VS_csharp/includes/dnprdnshort_md.md)]-based applications.  
...
## In This Section  
 ...
 [Developing Applications with Visual Basic](../VS_csharp/developing-applications-with-visual-basic.md)  
 Discusses various aspects of development in [!INCLUDE[vbprvb](../VS_csharp/includes/vbprvb_md.md)], such as the code editor, security, exception handling, debugging, and using the [!INCLUDE[dnprdnshort](../VS_csharp/includes/dnprdnshort_md.md)] class library.  
  
 [Visual Basic Programming Guide](../VS_csharp/visual-basic-programming-guide.md)  
 Introduces the major components of [!INCLUDE[vbprvb](../VS_csharp/includes/vbprvb_md.md)], an object-oriented programming language.  
  
 [Reference (Visual Basic)](../VS_csharp/reference--visual-basic-.md)  
 Contains the [!INCLUDE[vbprvb](../VS_csharp/includes/vbprvb_md.md)] language and compiler information.  
...
## Related Sections  
 ...
 Provides entry to the library of classes, interfaces, and value types that are included in the Microsoft [!INCLUDE[dnprdnshort](../VS_csharp/includes/dnprdnshort_md.md)] SDK.