...
> [!NOTE]
>  In classes and modules, structures declared using the [Dim Statement (Visual Basic)](../VS_csharp/dim-statement--visual-basic-.md) default to public access. If you intend a structure to be private, make sure you declare it using the [Private (Visual Basic)](../VS_csharp/private--visual-basic-.md) keyword.  
