...
> [!NOTE]
>  In classes and modules, structures declared using the [Dim Statement](../VS_visualbasic/dim-statement--visual-basic-.md) default to public access. If you intend a structure to be private, make sure you declare it using the [Private](../VS_visualbasic/private--visual-basic-.md) keyword.  
