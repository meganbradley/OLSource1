...
Because this call is not awaited, execution of the current method continues before the call is completed. Consider applying the 'Await' operator to the result of the call.  
 ...
 The current method calls an async method that returns a <xref:System.Threading.Tasks.Task*> or a <xref:System.Threading.Tasks.Task`1*> and doesn’t apply the [Await](../VS_csharp/await-operator--visual-basic-.md) operator to the result. The call to the async method starts an asynchronous task. However, because no `Await` operator is applied, the program continues without waiting for the task to complete. In most cases, that behavior isn't expected. Usually other aspects of the calling method depend on the results of the call or, minimally, the called method is expected to complete before you return from the method that contains the call.  
 ...
 By default, this message is a warning. For more information about hiding warnings or treating warnings as errors, see [Configuring Warnings in Visual Basic](../VS_csharp/configuring-warnings-in-visual-basic.md).  
...
3.  Replace the code in the **XAML** view of MainWindow.xaml with the following code.  
    ...
    ```  
     ...
     For more information about the XAML Designer, see [Creating a UI by using XAML Designer](../VS_csharp/creating-a-ui-by-using-xaml-designer-in-visual-studio.md). For information about how to build your own simple UI, see the "To create a WPF application" and "To design a simple WPF MainWindow" sections of [Walkthrough: Writing an Async Program (C# and Visual Basic)](../VS_csharp/walkthrough--accessing-the-web-by-using-async-and-await--csharp-and-visual-basic-.md).  
