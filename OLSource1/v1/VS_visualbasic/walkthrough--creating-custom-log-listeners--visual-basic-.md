...
-   In your application, create a class named `SimpleListener` that inherits from \<xref:System.Diagnostics.TraceListener>.  
     ...
     [!code[VbVbalrMyApplicationLog#16](../VS_visualbasic/codesnippet/VisualBasic/walkthrough--creating-custom-log-listeners--visual-basic-_1.vb)]  
...
-   The following code shows how to determine the strongly named type name for `SimpleListener`.  
     ...
     [!code[VbVbalrMyApplicationLog#17](../VS_visualbasic/codesnippet/VisualBasic/walkthrough--creating-custom-log-listeners--visual-basic-_2.vb)]  
