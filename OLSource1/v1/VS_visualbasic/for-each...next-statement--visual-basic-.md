...
>  A [For...Next Statement](../VS_visualbasic/for...next-statement--visual-basic-.md) works well when you can associate each iteration of a loop with a control variable and determine that variable's initial and final values. However, when you are dealing with a collection, the concept of initial and final values isn't meaningful, and you don't necessarily know how many elements the collection has. In this kind of case, a `For Each`...`Next` loop is often a better choice.  
 ...
 [!code[VbVbalrStatements#121](../VS_visualbasic/codesnippet/VisualBasic/for-each...next-statement--visual-basic-_1.vb)]  
  
 For more examples, see [Collections](../Topic/Collections%20\(C%23%20and%20Visual%20Basic\).md) and [Arrays](../VS_visualbasic/arrays-in-visual-basic.md).  
...
## Nested Loops  
 ...
 [!code[VbVbalrStatements#122](../VS_visualbasic/codesnippet/VisualBasic/for-each...next-statement--visual-basic-_2.vb)]  
  
 When you nest loops, each loop must have a unique `element` variable.  
  
 You can also nest different kinds of control structures within each other. For more information, see [Nested Control Structures](../VS_visualbasic/nested-control-structures--visual-basic-.md).  
  
## Exit For and Continue For  
 The [Exit For](../VS_visualbasic/exit-statement--visual-basic-.md) statement causes execution to exit the `For`…`Next` loop and transfers control to the statement that follows the `Next` statement.  
 ...
 [!code[VbVbalrStatements#123](../VS_visualbasic/codesnippet/VisualBasic/for-each...next-statement--visual-basic-_3.vb)]  
...
-   There an endless loop, which is a loop that could run a large or even infinite number of times. If you detect such a condition, you can use `Exit For` to escape the loop. For more information, see [Do...Loop Statement](../VS_visualbasic/do...loop-statement--visual-basic-.md).  
...
## Iterators  
 ...
 [!code[VbVbalrStatements#127](../VS_visualbasic/codesnippet/VisualBasic/for-each...next-statement--visual-basic-_4.vb)]  
  
 For more information, see [Iterators](../Topic/Iterators%20\(C%23%20and%20Visual%20Basic\).md), [Yield Statement](../VS_visualbasic/yield-statement--visual-basic-.md), and [Iterator](../VS_visualbasic/iterator--visual-basic-.md).  
...
### Narrowing Conversions  
 ...
 [!code[VbVbalrStatements#89](../VS_visualbasic/codesnippet/VisualBasic/for-each...next-statement--visual-basic-_5.vb)]  
...
## Example  
 ...
 [!code[VbVbalrStatements#124](../VS_visualbasic/codesnippet/VisualBasic/for-each...next-statement--visual-basic-_6.vb)]  
...
## Example  
 ...
 [!code[VbVbalrStatements#125](../VS_visualbasic/codesnippet/VisualBasic/for-each...next-statement--visual-basic-_7.vb)]  
