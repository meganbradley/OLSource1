...
|`piCommentList`|Optional. List of XML processing instructions and XML comments. Takes the following format:<br /><br /> `piComment [` `piComment` `... ]`<br /><br /> Each `piComment`can be one of the following:<br /><br /> -   [XML Processing Instruction Literal](../VS_visualbasic/xml-processing-instruction-literal--visual-basic-.md).<br />-   [XML Comment Literal](../VS_visualbasic/xml-comment-literal--visual-basic-.md).|  
|`rootElement`|Required. Root element of the document. The format is one of the following:<br /><br /> <ul><li>[XML Element Literal](../VS_visualbasic/xml-element-literal--visual-basic-.md).</li><li>Embedded expression of the form `<%=` `elementExp` `%>`. The `elementExp` returns one of the following:<br /><br /> <ul><li>An \<xref:System.Xml.Linq.XElement> object.</li><li>A collection that contains one \<xref:System.Xml.Linq.XElement> object and any number of \<xref:System.Xml.Linq.XProcessingInstruction> and \<xref:System.Xml.Linq.XComment> objects.</li></ul></li></ul><br /> For more information, see [Embedded Expressions in XML](../VS_visualbasic/embedded-expressions-in-xml--visual-basic-.md).|  
...
> [!NOTE]
>  An XML literal can span multiple lines without using line continuation characters. This enables you to copy content from an XML document and paste it directly into a [!INCLUDE[vbprvb](../VS_visualbasic/includes/vbprvb_md.md)] program.  
  
 The [!INCLUDE[vbprvb](../VS_visualbasic/includes/vbprvb_md.md)] compiler converts the XML document literal into calls to the \<xref:System.Xml.Linq.XDocument.#ctor*> and \<xref:System.Xml.Linq.XDeclaration.#ctor*> constructors.  
...
## Example  
 ...
 [!code[VbXMLSamples#30](../VS_visualbasic/codesnippet/VisualBasic/xml-document-literal--visual-basic-_1.vb)]  
...
## See Also  
 ...
 [XML Processing Instruction Literal](../VS_visualbasic/xml-processing-instruction-literal--visual-basic-.md)   
