...
## Building the Example  
 This example adds to the code that’s developed in [Cancel Remaining Async Tasks after One Is Complete (Visual Basic)](../VS_visualbasic/cancel-remaining-async-tasks-after-one-is-complete--visual-basic-.md) and uses the same UI.  
