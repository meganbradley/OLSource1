...
2.  If the error recurs, save your work and restart [!INCLUDE[vsprvs](../VS_visualbasic/includes/vsprvs_md.md)].  
  
3.  If the error persists, reinstall [!INCLUDE[vbprvb](../VS_visualbasic/includes/vbprvb_md.md)].  
