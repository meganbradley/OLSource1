...
```  
 ...
 The previous example duplicates the signature in the declaration exactly, but variations are possible. In particular, other modifiers can be added, such as `Overloads` or `Overrides`. Only one `Overrides` modifier is permitted. For more information about method modifiers, see [Sub Statement](../VS_csharp/sub-statement--visual-basic-.md).  
...
## Example  
 ...
 [!code[VbVbalrPartialMeths#4](../VS_csharp/codesnippet/VisualBasic/partial-methods--visual-basic-_1.vb)]  
  
 In a file named Product.vb, provide an implementation for `QuantityChanged`.  
  
 [!code[VbVbalrPartialMeths#5](../VS_csharp/codesnippet/VisualBasic/partial-methods--visual-basic-_2.vb)]  
 ...
 [!code[VbVbalrPartialMeths#6](../VS_csharp/codesnippet/VisualBasic/partial-methods--visual-basic-_3.vb)]  
...
## See Also  
 ...
 [Sub Procedure](../VS_csharp/sub-procedures--visual-basic-.md)   
 [Optional Parameters](../VS_csharp/optional-parameters--visual-basic-.md)   
 [Partial](../VS_csharp/partial--visual-basic-.md)   
