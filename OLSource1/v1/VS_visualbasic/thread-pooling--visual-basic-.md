...
A *thread pool* is a collection of threads that can be used to perform several tasks in the background. (See [Threading (Visual Basic)](../VS_csharp/threading--visual-basic-.md) for background information.) This leaves the primary thread free to perform other tasks asynchronously.  
...
## See Also  
 ...
 [How to: Use a Thread Pool (Visual Basic)](../VS_csharp/how-to--use-a-thread-pool--visual-basic-.md)   
 [Threading (Visual Basic)](../VS_csharp/threading--visual-basic-.md)   
 [Multithreaded Applications (Visual Basic)](../VS_csharp/multithreaded-applications--visual-basic-.md)   
 [Thread Synchronization (Visual Basic)](../VS_csharp/thread-synchronization--visual-basic-.md)