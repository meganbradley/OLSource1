...
## Remarks  
 Visual Basic always performs exponentiation in the [Double Data Type](../VS_visualbasic/double-data-type--visual-basic-.md).  
...
## Example  
 ...
 [!code[VbVbalrOperators#20](../VS_visualbasic/codesnippet/VisualBasic/^-operator--visual-basic-_1.vb)]  
