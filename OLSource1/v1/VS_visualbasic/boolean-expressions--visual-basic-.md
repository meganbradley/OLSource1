...
A *Boolean expression* is an expression that evaluates to a value of the [Boolean Data Type](../VS_visualbasic/boolean-data-type--visual-basic-.md): `True` or `False`. `Boolean` expressions can take several forms. The simplest is the direct comparison of the value of a `Boolean` variable to a `Boolean` literal, as shown in the following example.  
  
 [!code[VbVbalrOperators#87](../VS_visualbasic/codesnippet/VisualBasic/boolean-expressions--visual-basic-_1.vb)]  
...
## Two Meanings of the = Operator  
 ...
 [!code[VbVbalrOperators#88](../VS_visualbasic/codesnippet/VisualBasic/boolean-expressions--visual-basic-_2.vb)]  
  
 For further information, see [Value Comparisons](../VS_visualbasic/value-comparisons--visual-basic-.md) and [Statements](../VS_visualbasic/statements--visual-basic-.md).  
...
## Comparison Operators  
 ...
 Because 42 is less than 81, the Boolean expression in the preceding example evaluates to `True`. For more information on this kind of expression, see [Value Comparisons](../VS_visualbasic/value-comparisons--visual-basic-.md).  
...
## Short-Circuiting Operators  
 ...
 [!code[VbVbalrOperators#89](../VS_visualbasic/codesnippet/VisualBasic/boolean-expressions--visual-basic-_3.vb)]  
...
### Comparison with Non-Short-Circuiting Operators  
 ...
 [!code[VbVbalrOperators#90](../VS_visualbasic/codesnippet/VisualBasic/boolean-expressions--visual-basic-_4.vb)]  
  
 The preceding example calls `testFunction()` even though the left expression evaluates to `False`.  
  
## Parenthetical Expressions  
 You can use parentheses to control the order of evaluation of Boolean expressions. Expressions enclosed by parentheses evaluate first. For multiple levels of nesting, precedence is granted to the most deeply nested expressions. Within parentheses, evaluation proceeds according to the rules of operator precedence. For more information, see [Operator Precedence in Visual Basic](../VS_visualbasic/operator-precedence-in-visual-basic.md).  
