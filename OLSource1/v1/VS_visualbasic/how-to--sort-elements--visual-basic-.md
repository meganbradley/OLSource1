...
## Example  
 ...
 This example uses the following XML document: [Sample XML File: Numerical Data in a Namespace](../VS_visualbasic/sample-xml-file--numerical-data-in-a-namespace1.md).  
