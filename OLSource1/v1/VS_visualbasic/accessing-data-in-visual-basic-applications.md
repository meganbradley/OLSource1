...
## Related Sections  
 ...
 Provides links to pages on creating applications that work with data, using [!INCLUDE[vsprvs](../VS_visualbasic/includes/vsprvs_md.md)].  
 ...
 Provides information about [!INCLUDE[vbtecdlinq](../VS_visualbasic/includes/vbtecdlinq_md.md)]. Includes programming examples.  
 ...
 Provides links to topics that describe how to incorporate [!INCLUDE[sql_sync_long](../VS_visualbasic/includes/sql_sync_long_md.md)] into applications that enable synchronization of data between local and remote data.  
 ...
 Provides links to pages on connecting your application to data with design-time tools and ADO.NET connection objects, using [!INCLUDE[vsprvs](../VS_visualbasic/includes/vsprvs_md.md)].  
