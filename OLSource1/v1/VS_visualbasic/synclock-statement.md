...
-   You can't use the [Await](../VS_visualbasic/await-operator--visual-basic-.md) operator in a `SyncLock` block.  
...
### Code  
 [!code[VbVbalrThreading#1](../VS_visualbasic/codesnippet/VisualBasic/synclock-statement_1.vb)]  
...
### Code  
 [!code[VbVbalrThreading#21](../VS_visualbasic/codesnippet/VisualBasic/synclock-statement_2.vb)]  
