...
-   Copy the names.csv and scores.csv files into your project folder, as described in [How to: Join Content from Dissimilar Files (LINQ) (Visual Basic)](../VS_visualbasic/how-to--join-content-from-dissimilar-files--linq---visual-basic-.md).  
...
```  
 ...
 In the [Select Clause](../VS_visualbasic/select-clause--visual-basic-.md) clause, an object initializer is used to instantiate each new `Student` object by using the data from the two sources.  
