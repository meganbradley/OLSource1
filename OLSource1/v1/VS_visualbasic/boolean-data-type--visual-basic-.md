...
## Remarks  
 Use the [Boolean Data Type (Visual Basic)](../VS_csharp/boolean-data-type--visual-basic-.md) to contain two-state values such as true/false, yes/no, or on/off.  
