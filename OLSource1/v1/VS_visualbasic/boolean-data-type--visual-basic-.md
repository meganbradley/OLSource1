...
## Remarks  
 Use the [Boolean Data Type (Visual Basic)](../VS_visualbasic/boolean-data-type--visual-basic-.md) to contain two-state values such as true/false, yes/no, or on/off.  
