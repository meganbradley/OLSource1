...
|`argument3`|Required. `Object`. Evaluated and returned if `argument1` evaluates to `False` or if `argument1` is a [Nullable](../VS_visualbasic/nullable-value-types--visual-basic-.md)`Boolean` variable that evaluates to [Nothing](../VS_visualbasic/nothing--visual-basic-.md).|  
 ...
 [!code[VbVbalrOperators#100](../VS_visualbasic/codesnippet/VisualBasic/if-operator--visual-basic-_1.vb)]  
 ...
 [!code[VbVbalrOperators#101](../VS_visualbasic/codesnippet/VisualBasic/if-operator--visual-basic-_2.vb)]  
...
|`argument3`|Required. `Object`. Evaluated and returned if `argument2` evaluates to `Nothing`.|  
 ...
 [!code[VbVbalrOperators#102](../VS_visualbasic/codesnippet/VisualBasic/if-operator--visual-basic-_3.vb)]  
