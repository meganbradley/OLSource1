...
-   Use the `My.Application.Log.WriteEntry` or `My.Application.Log.WriteException` method to write information to the file log. For more information, see [How to: Write Log Messages](../VS_visualbasic/how-to--write-log-messages--visual-basic-.md) and [How to: Log Exceptions](../VS_visualbasic/how-to--log-exceptions-in-visual-basic.md).  
