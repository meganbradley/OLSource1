...
---
# Queries (Visual Basic)
[!INCLUDE[vbprvb](../VS_visualbasic/includes/vbprvb_md.md)] enables you to create [!INCLUDE[vbteclinqext](../VS_visualbasic/includes/vbteclinqext_md.md)] expressions in your code.  
