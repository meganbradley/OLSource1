...
## Parts  
 ...
 <  
 Optional. Denotes the beginning of the name of the attribute when `attribute` is not a valid identifier in [!INCLUDE[vbprvb](../VS_visualbasic/includes/vbprvb_md.md)].  
...
|`name`|Required. Local attribute name. See [Names of Declared XML Elements and Attributes](../VS_visualbasic/names-of-declared-xml-elements-and-attributes--visual-basic-.md).|  
  
 \>  
 Optional. Denotes the end of the name of the attribute when `attribute` is not a valid identifier in [!INCLUDE[vbprvb](../VS_visualbasic/includes/vbprvb_md.md)].  
...
## Remarks  
 ...
 The naming rules for XML attributes differ from the naming rules for [!INCLUDE[vbprvb](../VS_visualbasic/includes/vbprvb_md.md)] identifiers. To access an XML attribute that has a name that is not a valid Visual Basic identifier, enclose the name in angle brackets (\< and >).  
  
## XML Namespaces  
 The name in an attribute axis property can use only XML namespace prefixes declared globally by using the `Imports` statement. It cannot use XML namespace prefixes declared locally within XML element literals. For more information, see [Imports Statement (XML Namespace)](../VS_visualbasic/imports-statement--xml-namespace-.md).  
...
## Example  
 ...
 [!code[VbXMLSamples#12](../VS_visualbasic/codesnippet/VisualBasic/xml-attribute-axis-property--visual-basic-_1.vb)]  
...
## Example  
 ...
 [!code[VbXMLSamples#44](../VS_visualbasic/codesnippet/VisualBasic/xml-attribute-axis-property--visual-basic-_2.vb)]  
...
## Example  
 The following example uses the angle bracket syntax to get the value of the XML attribute named `number-type`, which is not a valid identifier in [!INCLUDE[vbprvb](../VS_visualbasic/includes/vbprvb_md.md)].  
  
 [!code[VbXMLSamples#13](../VS_visualbasic/codesnippet/VisualBasic/xml-attribute-axis-property--visual-basic-_3.vb)]  
...
## Example  
 ...
 [!code[VbXMLSamples#14](../VS_visualbasic/codesnippet/VisualBasic/xml-attribute-axis-property--visual-basic-_4.vb)]  
