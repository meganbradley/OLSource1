...
## Example  
 ...
 This example uses the following XML document: [Sample XML File: Customers and Orders in a Namespace](../VS_csharp/sample-xml-file--customers-and-orders-in-a-namespace1.md).  
