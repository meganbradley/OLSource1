...
## Remarks  
 ...
 A `Try…Catch` statement consists of a `Try` block followed by one or more `Catch` clauses, which specify handlers for various exceptions. When an exception is thrown in a `Try` block, [!INCLUDE[vbprvb](../VS_visualbasic/includes/vbprvb_md.md)] looks for the `Catch` statement that handles the exception. If a matching `Catch` statement is not found, [!INCLUDE[vbprvb](../VS_visualbasic/includes/vbprvb_md.md)] examines the method that called the current method, and so on up the call stack. If no `Catch` block is found, [!INCLUDE[vbprvb](../VS_visualbasic/includes/vbprvb_md.md)] displays an unhandled exception message to the user and stops execution of the program.  
...
-   The statement has no `exception` variable, for example: `Catch`  
 ...
 When a `Try…Catch…Finally` statement is nested in another `Try` block, [!INCLUDE[vbprvb](../VS_visualbasic/includes/vbprvb_md.md)] first examines each `Catch` statement in the innermost `Try` block. If no matching `Catch` statement is found, the search proceeds to the `Catch` statements of the outer `Try…Catch…Finally` block.  
...
-   An [End Statement](../VS_visualbasic/end-statement.md) is encountered in the `Try` or `Catch` block.  
...
-   Exception handling makes a program more complex.  
 ...
 [!code[VbVbalrStatements#94](../VS_visualbasic/codesnippet/VisualBasic/try...catch...finally-statement--visual-basic-_1.vb)]  
...
## Partial-Trust Situations  
 ...
 [!code[VbVbalrStatements#85](../VS_visualbasic/codesnippet/VisualBasic/try...catch...finally-statement--visual-basic-_2.vb)]  
...
## Example  
 ...
 [!code[VbVbalrStatements#86](../VS_visualbasic/codesnippet/VisualBasic/try...catch...finally-statement--visual-basic-_3.vb)]  
...
## Example  
 ...
 [!code[VbVbalrStatements#91](../VS_visualbasic/codesnippet/VisualBasic/try...catch...finally-statement--visual-basic-_4.vb)]  
...
## Example  
 ...
 [!code[VbVbalrStatements#92](../VS_visualbasic/codesnippet/VisualBasic/try...catch...finally-statement--visual-basic-_5.vb)]  
...
## Example  
 ...
 [!code[VbVbalrStatements#93](../VS_visualbasic/codesnippet/VisualBasic/try...catch...finally-statement--visual-basic-_6.vb)]  
...
## Example  
 ...
 [!code[csAsyncExceptions#1](../VS_visualbasic/codesnippet/VisualBasic/try...catch...finally-statement--visual-basic-_7.vb)]  
...
## Example  
 ...
 [!code[csAsyncExceptions#3](../VS_visualbasic/codesnippet/VisualBasic/try...catch...finally-statement--visual-basic-_8.vb)]  
...
## See Also  
 ...
 [Throw Statement](../VS_visualbasic/throw-statement--visual-basic-.md)