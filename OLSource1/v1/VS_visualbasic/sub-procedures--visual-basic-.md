...
A `Sub` procedure is a series of [!INCLUDE[vbprvb](../VS_csharp/includes/vbprvb_md.md)] statements enclosed by the `Sub` and `End Sub` statements. The `Sub` procedure performs a task and then returns control to the calling code, but it does not return a value to the calling code.  
...
## Declaration Syntax  
 ...
 The `modifiers` can specify access level and information about overloading, overriding, sharing, and shadowing. For more information, see [Sub Statement](../VS_csharp/sub-statement--visual-basic-.md).  
...
### Illustration of Declaration and Call  
 ...
 [!code[VbVbcnProcedures#2](../VS_csharp/codesnippet/VisualBasic/sub-procedures--visual-basic-_1.vb)]  
  
 The following example shows a typical call to `tellOperator`.  
  
 [!code[VbVbcnProcedures#3](../VS_csharp/codesnippet/VisualBasic/sub-procedures--visual-basic-_2.vb)]  
...
## See Also  
 ...
 [How to: Call an Event Handler in Visual Basic](../VS_csharp/how-to--call-an-event-handler-in-visual-basic.md)