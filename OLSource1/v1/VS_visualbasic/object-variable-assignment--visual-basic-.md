...
You use a normal assignment statement to assign an object to an object variable. You can assign an object expression or the [Nothing](../VS_visualbasic/nothing--visual-basic-.md) keyword, as the following example illustrates.  
...
## Current Instance  
 ...
 The `Me` keyword acts as an object variable referring to the current instance. If a procedure is not [Shared](../VS_visualbasic/shared--visual-basic-.md), it can use the `Me` keyword to obtain a pointer to the current instance. Shared procedures cannot be associated with a specific instance of a class.  
...
## See Also  
 ...
 [How to: Make an Object Variable Not Refer to Any Instance](../VS_visualbasic/how-to--make-an-object-variable-not-refer-to-any-instance--visual-basic-.md)   
