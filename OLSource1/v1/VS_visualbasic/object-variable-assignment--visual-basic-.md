...
You use a normal assignment statement to assign an object to an object variable. You can assign an object expression or the [Nothing](../VS_csharp/nothing--visual-basic-.md) keyword, as the following example illustrates.  
...
## Current Instance  
 ...
 The `Me` keyword acts as an object variable referring to the current instance. If a procedure is not [Shared (Visual Basic)](../VS_csharp/shared--visual-basic-.md), it can use the `Me` keyword to obtain a pointer to the current instance. Shared procedures cannot be associated with a specific instance of a class.  
...
## See Also  
 ...
 [How to: Declare an Object Variable and Assign an Object to It in Visual Basic](../VS_csharp/how-to--declare-an-object-variable-and-assign-an-object-to-it-in-visual-basic.md)   
 [How to: Make an Object Variable Not Refer to Any Instance](../VS_csharp/how-to--make-an-object-variable-not-refer-to-any-instance--visual-basic-.md)   
