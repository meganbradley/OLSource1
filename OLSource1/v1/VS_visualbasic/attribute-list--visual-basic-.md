...
## Parts  
 `attributemodifier`  
 Required for attributes applied at the beginning of a source file. Can be [Assembly](../VS_visualbasic/assembly--visual-basic-.md) or [Module](../VS_visualbasic/module--keyword---visual-basic-.md).  
...
## Remarks  
 ...
 For more information on when to use attributes, see [Attributes](../Topic/Attributes%20\(C%23%20and%20Visual%20Basic\).md). For information on attribute names, see [Declared Element Names](../VS_visualbasic/declared-element-names--visual-basic-.md).  
...
## Example  
 ...
 [!code[VbVbalrStatements#1](../VS_visualbasic/codesnippet/VisualBasic/attribute-list--visual-basic-_1.vb)]  
...
## See Also  
 ...
 [Module \<keyword>](../VS_visualbasic/module--keyword---visual-basic-.md)   
