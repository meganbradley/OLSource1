...
## Parts  
 `attributemodifier`  
 Required for attributes applied at the beginning of a source file. Can be [Assembly](../VS_csharp/assembly--visual-basic-.md) or [Module](../VS_csharp/module--keyword---visual-basic-.md).  
...
## Remarks  
 ...
 For more information on when to use attributes, see [Attributes (C# and Visual Basic)](../VS_csharp/attributes--csharp-and-visual-basic-.md). For information on attribute names, see [Declared Element Names](../VS_csharp/declared-element-names--visual-basic-.md).  
...
## Example  
 ...
 [!code[VbVbalrStatements#1](../VS_csharp/codesnippet/VisualBasic/attribute-list--visual-basic-_1.vb)]  
...
## See Also  
 [Assembly](../VS_csharp/assembly--visual-basic-.md)   
 [Module <keyword\>](../VS_csharp/module--keyword---visual-basic-.md)   
