...
Quantifier operations return a \<xref:System.Boolean> value that indicates whether some or all of the elements in a sequence satisfy a condition.  
 ...
 ![LINQ Quantifier Operations](../VS_visualbasic/media/linq_quantifier.png "LINQ_Quantifier")  
...
## Query Expression Syntax Examples  
 ...
 [!code[CsLINQAnyAll#1](../VS_visualbasic/codesnippet/VisualBasic/quantifier-operations--visual-basic-_1.vb)]  
 ...
 [!code[CsLINQAnyAll#2](../VS_visualbasic/codesnippet/VisualBasic/quantifier-operations--visual-basic-_2.vb)]  
...
## See Also  
 ...
 [How to: Query for Sentences that Contain a Specified Set of Words (LINQ) (Visual Basic)](../VS_visualbasic/how-to--query-for-sentences-that-contain-a-specified-set-of-words--linq---visual-basic-1.md)