...
## In This Section  
 [Three Parts of a LINQ Query (Visual Basic)](../VS_csharp/writing-your-first-linq-query--visual-basic-.md)  
 ...
 [Basic Query Operators (Visual Basic)](../VS_csharp/basic-query-operations--visual-basic-.md)  
 Describes the most common types of query operations and how they are expressed in Visual Basic.  
  
 [Visual Basic 9.0 Features Supporting LINQ](../VS_csharp/visual-basic-features-that-support-linq.md)  
 Describes the Visual Basic language features that support LINQ, such as anonymous types and type inference.  
  
 [Type Relationships in Query Operations (Visual Basic)](../VS_csharp/type-relationships-in-query-operations--visual-basic-.md)  
...
## Related Sections  
 ...
 [Visual Studio IDE and Tools Support for LINQ](../VS_csharp/visual-studio-ide-and-tools-support-for-linq--visual-basic-.md)  
