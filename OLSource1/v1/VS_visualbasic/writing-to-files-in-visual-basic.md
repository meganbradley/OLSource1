...
## In This Section  
 [How to: Write Text to Files](../VS_visualbasic/how-to--write-text-to-files-in-visual-basic.md)  
 Demonstrates how to write to text files.  
  
 [How to: Append to Text Files](../VS_visualbasic/how-to--append-to-text-files-in-visual-basic.md)  
 Demonstrates how to append text to a text file.  
  
 [How to: Write to Binary Files](../VS_visualbasic/how-to--write-to-binary-files-in-visual-basic.md)  
 Demonstrates how to write to a binary file.  
  
 [How to: Write Text to Files in the My Documents Directory](../VS_visualbasic/how-to--write-text-to-files-in-the-my-documents-directory-in-visual-basic.md)  
 Demonstrates how to create and write to a new text file in the **My Documents** directory.  
  
 [How to: Write Text to Files with a StreamWriter](../VS_visualbasic/how-to--write-text-to-files-with-a-streamwriter-in-visual-basic.md)  
...
## Related Sections  
 ...
 [Creating, Deleting, and Moving Files and Directories](../VS_visualbasic/creating--deleting--and-moving-files-and-directories-in-visual-basic.md)  
 Explains how to perform tasks that involve creating, deleting, moving, and renaming files and directories.  
  
 [Storing Data to and Reading from the Clipboard](../VS_visualbasic/storing-data-to-and-reading-from-the-clipboard--visual-basic-.md)  
 ...
 [File Encodings](../VS_visualbasic/file-encodings--visual-basic-.md)  
