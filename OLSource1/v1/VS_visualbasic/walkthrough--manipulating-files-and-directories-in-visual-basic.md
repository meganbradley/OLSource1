...
This walkthrough provides an introduction to the fundamentals of file I/O in [!INCLUDE[vbprvb](../VS_csharp/includes/vbprvb_md.md)]. It describes how to create a small application that lists and examines text files in a directory. For each selected text file, the application provides file attributes and the first line of content. There is an option to write information to a log file.  
  
 This walkthrough uses members of the `My.Computer.FileSystem Object`, which are available in [!INCLUDE[vbprvb](../VS_csharp/includes/vbprvb_md.md)]. See <xref:Microsoft.VisualBasic.FileIO.FileSystem*> for more information. At the end of the walkthrough, an equivalent example is provided that uses classes from the <xref:System.IO*> namespace.  
...
2.  Add the following code to the `Click` event handler.  
     ...
     [!code[VbVbcnMyFileSystem#103](../VS_csharp/codesnippet/VisualBasic/walkthrough--manipulating-files-and-directories-in-visual-basic_1.vb)]  
...
3.  Add the following `ListFiles` method.  
     ...
     [!code[VbVbcnMyFileSystem#104](../VS_csharp/codesnippet/VisualBasic/walkthrough--manipulating-files-and-directories-in-visual-basic_2.vb)]  
...
2.  Add the following code to the `Click` event handler.  
     ...
     [!code[VbVbcnMyFileSystem#105](../VS_csharp/codesnippet/VisualBasic/walkthrough--manipulating-files-and-directories-in-visual-basic_3.vb)]  
...
3.  Add the following `GetTextForOutput` method.  
     ...
     [!code[VbVbcnMyFileSystem#107](../VS_csharp/codesnippet/VisualBasic/walkthrough--manipulating-files-and-directories-in-visual-basic_4.vb)]  
...
1.  Add the following code to the end of the `examineButton_Click` event handler.  
     ...
     [!code[VbVbcnMyFileSystem#106](../VS_csharp/codesnippet/VisualBasic/walkthrough--manipulating-files-and-directories-in-visual-basic_5.vb)]  
...
2.  Add the following code to the event handler.  
     ...
     [!code[VbVbcnMyFileSystem#102](../VS_csharp/codesnippet/VisualBasic/walkthrough--manipulating-files-and-directories-in-visual-basic_6.vb)]  
...
1.  Add the following `SetEnabled` method.  
     ...
     [!code[VbVbcnMyFileSystem#108](../VS_csharp/codesnippet/VisualBasic/walkthrough--manipulating-files-and-directories-in-visual-basic_7.vb)]  
...
## Full example using My.Computer.FileSystem  
 ...
 [!code[VbVbcnMyFileSystem#101](../VS_csharp/codesnippet/VisualBasic/walkthrough--manipulating-files-and-directories-in-visual-basic_8.vb)]  
...
## Full example using System.IO  
 ...
 [!code[VbVbcnMyFileSystem#111](../VS_csharp/codesnippet/VisualBasic/walkthrough--manipulating-files-and-directories-in-visual-basic_9.vb)]  
  
## See Also  
 <xref:System.IO*>   
 <xref:Microsoft.VisualBasic.FileIO.FileSystem*>   
 <xref:Microsoft.VisualBasic.FileIO.FileSystem.CurrentDirectory*>   
 [Walkthrough: Manipulating Files by Using .NET Framework Methods (Visual Basic)](../VS_csharp/walkthrough--manipulating-files-by-using-.net-framework-methods--visual-basic-.md)