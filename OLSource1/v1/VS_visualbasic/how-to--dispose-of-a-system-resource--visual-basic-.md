...
1.  Make sure you include the appropriate [Imports Statement](../VS_csharp/imports-statement--.net-namespace-and-type-.md) for the database connection at the beginning of your source file (in this case, <xref:System.Data.SqlClient*>).  
...
## See Also  
 ...
 [Using Statement](../VS_csharp/using-statement--visual-basic-.md)