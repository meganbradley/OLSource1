...
3.  Import the target namespace or namespaces into your code file or project. A target namespace is identified by the `targetNamespace` or `tns` attribute of your XSD schema.  
 ...
 For more information on the capabilities of XML IntelliSense in Visual Basic, see [XML IntelliSense in Visual Basic](../VS_visualbasic/xml-intellisense-in-visual-basic.md). For more information on importing XML namespaces, see [Imports Statement (XML Namespace)](../VS_visualbasic/imports-statement--xml-namespace-.md) or [References Page, Project Designer (Visual Basic)](../Topic/References%20Page,%20Project%20Designer%20\(Visual%20Basic\).md).  
  
 [!INCLUDE[note_settings_general](../VS_visualbasic/includes/note_settings_general_md.md)]  
  
 ![link to video](../VS_visualbasic/media/playvideo.gif "PlayVideo") For a video version of this topic, see [Video How to: Enable XML IntelliSense in Visual Basic](http://go.microsoft.com/fwlink/?LinkId=102466). For a related video demonstration, see [How Do I Enable XML IntelliSense and Use XML Namespaces?](http://go.microsoft.com/fwlink/?LinkId=143035).  
...
2.  At the beginning of the code file, add an `Imports` statement for the target XML namespace, as shown in the following example.  
     ...
     [!code[VbXMLSamples#1](../VS_visualbasic/codesnippet/VisualBasic/how-to--enable-xml-intellisense-in-visual-basic_1.vb)]  
     ...
     [!code[VbXmlSamples#50](../VS_visualbasic/codesnippet/VisualBasic/how-to--enable-xml-intellisense-in-visual-basic_2.vb)]  
