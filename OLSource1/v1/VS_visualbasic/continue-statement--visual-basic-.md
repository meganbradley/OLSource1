...
## Remarks  
 ...
 You can use `Continue` at any location in the loop that allows transfers. The rules allowing transfer of control are the same as with the [GoTo Statement](../VS_visualbasic/goto-statement.md).  
...
## Example  
 ...
 [!code[VbVbalrStatements#14](../VS_visualbasic/codesnippet/VisualBasic/continue-statement--visual-basic-_1.vb)]  
