...
This topic compares the XPath child elements axis to the [!INCLUDE[sqltecxlinq](../VS_visualbasic/includes/sqltecxlinq_md.md)] \<xref:System.Xml.Linq.XContainer.Elements*> axis.  
