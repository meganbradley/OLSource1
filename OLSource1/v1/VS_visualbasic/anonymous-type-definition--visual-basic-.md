...
## Compiler-Generated Code  
 ...
 [!code[VbVbalrAnonymousTypes#25](../VS_csharp/codesnippet/VisualBasic/anonymous-type-definition--visual-basic-_1.vb)]  
...
-   `Equals` returns `True` if two anonymous type instances are the same instance, or if they meet the following conditions:  
    ...
    -   Comparison of each corresponding pair of key properties returns `True`.  
     ...
     [!code[VbVbalrAnonymousTypes#24](../VS_csharp/codesnippet/VisualBasic/anonymous-type-definition--visual-basic-_2.vb)]  
...
-   `ToString` returns a string of concatenated property values, as shown in the following example. Both key and non-key properties are included.  
     ...
     [!code[VbVbalrAnonymousTypes#29](../VS_csharp/codesnippet/VisualBasic/anonymous-type-definition--visual-basic-_3.vb)]  
