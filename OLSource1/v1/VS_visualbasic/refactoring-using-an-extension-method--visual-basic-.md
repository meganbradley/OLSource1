...
This example builds on the previous example, [Retrieving the Text of the Paragraphs (Visual Basic)](../VS_visualbasic/retrieving-the-text-of-the-paragraphs--visual-basic-.md), by refactoring the concatenation of strings using a pure function that is implemented as an extension method.  
