...
---
# Numeric Data Types (Visual Basic)
[!INCLUDE[vbprvb](../VS_visualbasic/includes/vbprvb_md.md)] supplies several *numeric data types* for handling numbers in various representations. *Integral* types represent only whole numbers (positive, negative, and zero), and *nonintegral* types represent numbers with both integer and fractional parts.  
  
 For a table showing a side-by-side comparison of the [!INCLUDE[vbprvb](../VS_visualbasic/includes/vbprvb_md.md)] data types, see [Data Types](../VS_visualbasic/data-type-summary--visual-basic-.md).  
  
## Integral Numeric Types  
 *Integral data types* are those that represent only numbers without fractional parts.  
  
 The *signed* integral data types are [SByte Data Type](../VS_visualbasic/sbyte-data-type--visual-basic-.md) (8-bit), [Short Data Type](../VS_visualbasic/short-data-type--visual-basic-.md) (16-bit), [Integer Data Type](../VS_visualbasic/integer-data-type--visual-basic-.md) (32-bit), and [Long Data Type](../VS_visualbasic/long-data-type--visual-basic-.md) (64-bit). If a variable always stores integers rather than fractional numbers, declare it as one of these types.  
  
 The *unsigned* integral types are [Byte Data Type](../VS_visualbasic/byte-data-type--visual-basic-.md) (8-bit), [UShort Data Type](../VS_visualbasic/ushort-data-type--visual-basic-.md) (16-bit), [UInteger Data Type](../VS_visualbasic/uinteger-data-type.md) (32-bit), and [ULong Data Type](../VS_visualbasic/ulong-data-type--visual-basic-.md) (64-bit). If a variable contains binary data, or data of unknown nature, declare it as one of these types.  
  
### Performance  
 Arithmetic operations are faster with integral types than with other data types. They are fastest with the `Integer` and `UInteger` types in [!INCLUDE[vbprvb](../VS_visualbasic/includes/vbprvb_md.md)].  
...
### Large Integers  
 ...
 If you need even larger values, you can use the [Decimal Data Type](../VS_visualbasic/decimal-data-type--visual-basic-.md). You can hold numbers from -79,228,162,514,264,337,593,543,950,335 through 79,228,162,514,264,337,593,543,950,335 in a `Decimal` variable if you do not use any decimal places. However, operations with `Decimal` numbers are considerably slower than with any other numeric data type.  
 ...
 *Nonintegral data types* are those that represent numbers with both integer and fractional parts.  
 ...
 The nonintegral numeric data types are `Decimal` (128-bit fixed point), [Single Data Type](../VS_visualbasic/single-data-type--visual-basic-.md) (32-bit floating point), and [Double Data Type](../VS_visualbasic/double-data-type--visual-basic-.md) (64-bit floating point). They are all signed types. If a variable can contain a fraction, declare it as one of these types.  
...
## See Also  
 ...
 [Character Data Types](../VS_visualbasic/character-data-types--visual-basic-.md)   
 [Miscellaneous Data Types](../VS_visualbasic/miscellaneous-data-types--visual-basic-.md)   
