...
This topic describes how to use `My.Computer.Ports` to show the available serial ports of the computer in [!INCLUDE[vbprvb](../VS_csharp/includes/vbprvb_md.md)].  
...
## Example  
 ...
 [!code[VbVbalrMyComputer#45](../VS_csharp/codesnippet/VisualBasic/how-to--show-available-serial-ports-in-visual-basic_1.vb)]  
...
-   Access to the members of the <xref:System.Windows.Forms*> namespace. Add an `Imports` statement if you are not fully qualifying member names in your code. For more information, see [Imports Statement](../VS_csharp/imports-statement--.net-namespace-and-type-.md).  
