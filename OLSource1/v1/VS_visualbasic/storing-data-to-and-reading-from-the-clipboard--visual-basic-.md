...
## Reading from the Clipboard  
 ...
 [!code[VbVbcnMyClipboard#4](../VS_csharp/codesnippet/VisualBasic/storing-data-to-and-reading-from-the-clipboard--visual-basic-_1.vb)]  
  
 This code example is also available as an IntelliSense code snippet. In the code snippet picker, it is located in **Windows Forms Applications > Clipboard**. For more information, see [Code Snippets](../VS_csharp/code-snippets.md).  
 ...
 [!code[VbResourceTasks#16](../VS_csharp/codesnippet/VisualBasic/storing-data-to-and-reading-from-the-clipboard--visual-basic-_2.vb)]  
...
## Determining the type of file stored in the Clipboard  
 ...
 [!code[VbResourceTasks#13](../VS_csharp/codesnippet/VisualBasic/storing-data-to-and-reading-from-the-clipboard--visual-basic-_3.vb)]  
...
## Clearing the Clipboard  
 ...
 [!code[VbVbcnMyClipboard#3](../VS_csharp/codesnippet/VisualBasic/storing-data-to-and-reading-from-the-clipboard--visual-basic-_4.vb)]  
...
## Writing to the Clipboard  
 ...
 [!code[VbVbcnMyClipboard#1](../VS_csharp/codesnippet/VisualBasic/storing-data-to-and-reading-from-the-clipboard--visual-basic-_5.vb)]  
 ...
 [!code[VbVbcnMyClipboard#2](../VS_csharp/codesnippet/VisualBasic/storing-data-to-and-reading-from-the-clipboard--visual-basic-_6.vb)]  
 ...
 [!code[VbVbcnMyClipboard#7](../VS_csharp/codesnippet/VisualBasic/storing-data-to-and-reading-from-the-clipboard--visual-basic-_7.vb)]  
 ...
 [!code[VbResourceTasks#5](../VS_csharp/codesnippet/VisualBasic/storing-data-to-and-reading-from-the-clipboard--visual-basic-_8.vb)]  
...
## See Also  
 ...
 [How to: Read Object Data from an XML File in Visual Basic](../VS_csharp/how-to--read-object-data-from-an-xml-file--csharp-and-visual-basic-.md)   
 [How to: Write Object Data to an XML File in Visual Basic](../VS_csharp/how-to--write-object-data-to-an-xml-file--csharp-and-visual-basic-.md)