...
|-------------------|----------------------|-------------------------------------|  
|`CBool`|[Boolean Data Type](../VS_visualbasic/boolean-data-type--visual-basic-.md)|Any valid `Char` or `String` or numeric expression.|  
|`CByte`|[Byte Data Type](../VS_visualbasic/byte-data-type--visual-basic-.md)|0 through 255 (unsigned); fractional parts are rounded.<sup>1</sup>|  
|`CChar`|[Char Data Type](../VS_visualbasic/char-data-type--visual-basic-.md)|Any valid `Char` or `String` expression; only first character of a `String` is converted; value can be 0 through 65535 (unsigned).|  
|`CDate`|[Date Data Type](../VS_visualbasic/date-data-type--visual-basic-.md)|Any valid representation of a date and time.|  
|`CDbl`|[Double Data Type](../VS_visualbasic/double-data-type--visual-basic-.md)|-1.79769313486231570E+308 through -4.94065645841246544E-324 for negative values; 4.94065645841246544E-324 through 1.79769313486231570E+308 for positive values.|  
|`CDec`|[Decimal Data Type](../VS_visualbasic/decimal-data-type--visual-basic-.md)|+/-79,228,162,514,264,337,593,543,950,335 for zero-scaled numbers, that is, numbers with no decimal places. For numbers with 28 decimal places, the range is +/-7.9228162514264337593543950335. The smallest possible non-zero number is 0.0000000000000000000000000001 (+/-1E-28).|  
|`CInt`|[Integer Data Type](../VS_visualbasic/integer-data-type--visual-basic-.md)|-2,147,483,648 through 2,147,483,647; fractional parts are rounded.<sup>1</sup>|  
|`CLng`|[Long Data Type](../VS_visualbasic/long-data-type--visual-basic-.md)|-9,223,372,036,854,775,808 through 9,223,372,036,854,775,807; fractional parts are rounded.<sup>1</sup>|  
|`CObj`|[Object Data Type](../VS_visualbasic/object-data-type.md)|Any valid expression.|  
|`CSByte`|[SByte Data Type](../VS_visualbasic/sbyte-data-type--visual-basic-.md)|-128 through 127; fractional parts are rounded.<sup>1</sup>|  
|`CShort`|[Short Data Type](../VS_visualbasic/short-data-type--visual-basic-.md)|-32,768 through 32,767; fractional parts are rounded.<sup>1</sup>|  
|`CSng`|[Single Data Type](../VS_visualbasic/single-data-type--visual-basic-.md)|-3.402823E+38 through -1.401298E-45 for negative values; 1.401298E-45 through 3.402823E+38 for positive values.|  
|`CStr`|[String Data Type](../VS_visualbasic/string-data-type--visual-basic-.md)|Returns for `CStr` depend on the `expression` argument. See [Return Values for the CStr Function](../VS_visualbasic/return-values-for-the-cstr-function--visual-basic-.md).|  
|`CUInt`|[UInteger Data Type](../VS_visualbasic/uinteger-data-type.md)|0 through 4,294,967,295 (unsigned); fractional parts are rounded.<sup>1</sup>|  
|`CULng`|[ULong Data Type](../VS_visualbasic/ulong-data-type--visual-basic-.md)|0 through 18,446,744,073,709,551,615 (unsigned); fractional parts are rounded.<sup>1</sup>|  
|`CUShort`|[UShort Data Type](../VS_visualbasic/ushort-data-type--visual-basic-.md)|0 through 65,535 (unsigned); fractional parts are rounded.<sup>1</sup>|  
...
## CType Function  
 The [CType Function](../VS_visualbasic/ctype-function--visual-basic-.md) takes a second argument, `typename`, and coerces `expression` to `typename`, where `typename` can be any data type, structure, class, or interface to which there exists a valid conversion.  
  
 For a comparison of `CType` with the other type conversion keywords, see [DirectCast Operator](../VS_visualbasic/directcast-operator--visual-basic-.md) and [TryCast Operator](../VS_visualbasic/trycast-operator--visual-basic-.md).  
...
## CBool Example  
 ...
 [!code[VbVbalrFunctions#1](../VS_visualbasic/codesnippet/VisualBasic/type-conversion-functions--visual-basic-_1.vb)]  
  
## CByte Example  
 The following example uses the `CByte` function to convert an expression to a `Byte`.  
  
 [!code[VbVbalrFunctions#2](../VS_visualbasic/codesnippet/VisualBasic/type-conversion-functions--visual-basic-_2.vb)]  
  
## CChar Example  
 The following example uses the `CChar` function to convert the first character of a `String` expression to a `Char` type.  
  
 [!code[VbVbalrFunctions#3](../VS_visualbasic/codesnippet/VisualBasic/type-conversion-functions--visual-basic-_3.vb)]  
 ...
 [!code[VbVbalrFunctions#4](../VS_visualbasic/codesnippet/VisualBasic/type-conversion-functions--visual-basic-_4.vb)]  
...
## CDate Example  
 ...
 [!code[VbVbalrFunctions#5](../VS_visualbasic/codesnippet/VisualBasic/type-conversion-functions--visual-basic-_5.vb)]  
  
## CDbl Example  
 [!code[VbVbalrFunctions#6](../VS_visualbasic/codesnippet/VisualBasic/type-conversion-functions--visual-basic-_6.vb)]  
  
## CDec Example  
 The following example uses the `CDec` function to convert a numeric value to `Decimal`.  
  
 [!code[VbVbalrFunctions#7](../VS_visualbasic/codesnippet/VisualBasic/type-conversion-functions--visual-basic-_7.vb)]  
  
## CInt Example  
 The following example uses the `CInt` function to convert a value to `Integer`.  
  
 [!code[VbVbalrFunctions#8](../VS_visualbasic/codesnippet/VisualBasic/type-conversion-functions--visual-basic-_8.vb)]  
  
## CLng Example  
 The following example uses the `CLng` function to convert values to `Long`.  
  
 [!code[VbVbalrFunctions#9](../VS_visualbasic/codesnippet/VisualBasic/type-conversion-functions--visual-basic-_9.vb)]  
...
## CObj Example  
 ...
 [!code[VbVbalrFunctions#10](../VS_visualbasic/codesnippet/VisualBasic/type-conversion-functions--visual-basic-_10.vb)]  
  
## CSByte Example  
 The following example uses the `CSByte` function to convert a numeric value to `SByte`.  
  
 [!code[VbVbalrFunctions#11](../VS_visualbasic/codesnippet/VisualBasic/type-conversion-functions--visual-basic-_11.vb)]  
  
## CShort Example  
 The following example uses the `CShort` function to convert a numeric value to `Short`.  
  
 [!code[VbVbalrFunctions#12](../VS_visualbasic/codesnippet/VisualBasic/type-conversion-functions--visual-basic-_12.vb)]  
  
## CSng Example  
 The following example uses the `CSng` function to convert values to `Single`.  
  
 [!code[VbVbalrFunctions#13](../VS_visualbasic/codesnippet/VisualBasic/type-conversion-functions--visual-basic-_13.vb)]  
  
## CStr Example  
 The following example uses the `CStr` function to convert a numeric value to `String`.  
  
 [!code[VbVbalrFunctions#14](../VS_visualbasic/codesnippet/VisualBasic/type-conversion-functions--visual-basic-_14.vb)]  
  
 The following example uses the `CStr` function to convert `Date` values to `String` values.  
  
 [!code[VbVbalrFunctions#15](../VS_visualbasic/codesnippet/VisualBasic/type-conversion-functions--visual-basic-_15.vb)]  
 ...
 For more detail on the values returned by `CStr`, see [Return Values for the CStr Function](../VS_visualbasic/return-values-for-the-cstr-function--visual-basic-.md).  
  
## CUInt Example  
 The following example uses the `CUInt` function to convert a numeric value to `UInteger`.  
  
 [!code[VbVbalrFunctions#16](../VS_visualbasic/codesnippet/VisualBasic/type-conversion-functions--visual-basic-_16.vb)]  
  
## CULng Example  
 The following example uses the `CULng` function to convert a numeric value to `ULong`.  
  
 [!code[VbVbalrFunctions#17](../VS_visualbasic/codesnippet/VisualBasic/type-conversion-functions--visual-basic-_17.vb)]  
  
## CUShort Example  
 The following example uses the `CUShort` function to convert a numeric value to `UShort`.  
  
 [!code[VbVbalrFunctions#18](../VS_visualbasic/codesnippet/VisualBasic/type-conversion-functions--visual-basic-_18.vb)]  
...
## See Also  
 ...
 [Conversion Functions](../VS_visualbasic/conversion-functions--visual-basic-.md)   
