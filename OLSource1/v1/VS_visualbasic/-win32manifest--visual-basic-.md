...
> [!NOTE]
>  This option and the [/win32resource](../VS_visualbasic/-win32resource.md) option are mutually exclusive. If you try to use both options in the same command line, you will get a build error.  
