 ...
 *Functional programming* is a programming approach that directly supports pure functional transformation.  
 ...
 For more information about functional programming, see [Functional Programming vs. Imperative Programming (Visual Basic)](../VS_visualbasic/functional-programming-vs.-imperative-programming--visual-basic-.md).  
...
## Terminology  
 ...
 For more information, see [Standard Query Operators Overview (Visual Basic)](../VS_visualbasic/standard-query-operators-overview--visual-basic-.md).  
 ...
 For more information about, see [Lambda Expressions](../VS_visualbasic/lambda-expressions--visual-basic-.md).  
 ...
 For more information, see [Basic Query Operations (Visual Basic)](../VS_visualbasic/basic-query-operations--visual-basic-.md) and [Deferred Execution and Lazy Evaluation in LINQ to XML (Visual Basic)](../VS_visualbasic/deferred-execution-and-lazy-evaluation-in-linq-to-xml--visual-basic-.md).  
