...
## Remarks  
 ...
 If you compile with `/target:module`, the name of the key file is held in the module and incorporated into the assembly that is created when you compile an assembly with [/addmodule](../VS_visualbasic/-addmodule.md).  
  
 You can also pass your encryption information to the compiler with [/keycontainer](../VS_visualbasic/-keycontainer.md). Use [/delaysign](../VS_visualbasic/-delaysign.md) if you want a partially signed assembly.  
...
> [!NOTE]
>  The `/keyfile` option is not available from within the [!INCLUDE[vsprvs](../VS_visualbasic/includes/vsprvs_md.md)] development environment; it is available only when compiling from the command line.  
