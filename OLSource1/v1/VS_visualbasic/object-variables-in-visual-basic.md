...
## See Also  
 ...
 [How to: Speed Up Access to an Object with a Long Qualification Path](../VS_visualbasic/how-to--speed-up-access-to-an-object-with-a-long-qualification-path--visual-basic-.md)   
