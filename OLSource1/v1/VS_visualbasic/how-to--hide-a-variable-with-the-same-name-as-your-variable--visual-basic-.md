...
-   **Shadowing Through Inheritance.** If the variable you want to hide is defined at class level, you can shadow it through inheritance by redeclaring it with the [Shadows](../VS_visualbasic/shadows--visual-basic-.md) keyword in a derived class.  
...
3.  Within the subregion, write a [Dim Statement](../VS_visualbasic/dim-statement--visual-basic-.md) declaring the shadowing variable.  
...
3.  Inside the derived class, write a `Dim` statement declaring your variable. Include the [Shadows](../VS_visualbasic/shadows--visual-basic-.md) keyword in the declaration.  
...
## See Also  
 ...
 [Differences Between Shadowing and Overriding](../VS_visualbasic/differences-between-shadowing-and-overriding--visual-basic-.md)   
 [How to: Hide an Inherited Variable](../VS_visualbasic/how-to--hide-an-inherited-variable--visual-basic-.md)   
 [How to: Access a Variable Hidden by a Derived Class](../VS_visualbasic/how-to--access-a-variable-hidden-by-a-derived-class--visual-basic-.md)   
