...
## Remarks  
 ...
 The `My.Response` object is only available for [!INCLUDE[vstecasp](../VS_visualbasic/includes/vstecasp_md.md)] applications.  
...
## Example  
 ...
 [!code[VbVbalrMyWeb#1](../VS_visualbasic/codesnippet/VisualBasic/my.response-object_1.aspx)]  
