...
## Remarks  
 ...
 See [/linkresource (Visual Basic)](../VS_csharp/-linkresource--visual-basic-.md) to reference a [!INCLUDE[dnprdnshort](../VS_csharp/includes/dnprdnshort_md.md)] resource file, or [/resource (Visual Basic)](../VS_csharp/-resource--visual-basic-.md) to attach a [!INCLUDE[dnprdnshort](../VS_csharp/includes/dnprdnshort_md.md)] resource file. See [/win32resource](../VS_csharp/-win32resource.md) to import a .res file.  
