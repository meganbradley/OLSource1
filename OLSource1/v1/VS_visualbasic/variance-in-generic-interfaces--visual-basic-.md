...
```  
 ...
 For more examples, see [Using Variance in Interfaces for Generic Collections (Visual Basic)](../VS_csharp/using-variance-in-interfaces-for-generic-collections--visual-basic-.md).  
...
## See Also  
 [Using Variance in Interfaces for Generic Collections (Visual Basic)](../VS_csharp/using-variance-in-interfaces-for-generic-collections--visual-basic-.md)   
 ...
 [Variance in Delegates (Visual Basic)](../VS_csharp/variance-in-delegates--visual-basic-.md)