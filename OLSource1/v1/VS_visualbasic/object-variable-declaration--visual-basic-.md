...
You use a normal declaration statement to declare an object variable. For the data type, you specify either `Object` (that is, the [Object Data Type](../VS_csharp/object-data-type.md)) or a more specific class from which the object is to be created.  
...
```  
 ...
 You can also specify [Public (Visual Basic)](../VS_csharp/public--visual-basic-.md), [Protected (Visual Basic)](../VS_csharp/protected--visual-basic-.md), [Friend (Visual Basic)](../VS_csharp/friend--visual-basic-.md), `Protected Friend`, [Private (Visual Basic)](../VS_csharp/private--visual-basic-.md), [Shared (Visual Basic)](../VS_csharp/shared--visual-basic-.md), or [Static (Visual Basic)](../VS_csharp/static--visual-basic-.md) in the declaration. The following example declarations are valid:  
