...
You use a normal declaration statement to declare an object variable. For the data type, you specify either `Object` (that is, the [Object Data Type](../VS_visualbasic/object-data-type.md)) or a more specific class from which the object is to be created.  
...
```  
 ...
 You can also specify [Public](../VS_visualbasic/public--visual-basic-.md), [Protected](../VS_visualbasic/protected--visual-basic-.md), [Friend](../VS_visualbasic/friend--visual-basic-.md), `Protected Friend`, [Private](../VS_visualbasic/private--visual-basic-.md), [Shared](../VS_visualbasic/shared--visual-basic-.md), or [Static](../VS_visualbasic/static--visual-basic-.md) in the declaration. The following example declarations are valid:  
