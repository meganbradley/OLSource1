...
> [!NOTE]
>  In the warning configurations that you can set on the [Compile Page, Project Designer (Visual Basic)](../VS_csharp/compile-page--project-designer--visual-basic-.md), there are three settings that correspond to the three conditions that cause a compile-time error. For information about how to use these settings, see [To set warning configurations in the IDE](../VS_csharp/option-strict-statement.md#conditions) later in this topic.  
...
## Implicit Narrowing Conversion Errors  
 ...
 [!INCLUDE[vbprvb](../VS_csharp/includes/vbprvb_md.md)] can convert many data types to other data types. Data loss can occur when the value of one data type is converted to a data type that has less precision or a smaller capacity. A run-time error occurs if such a narrowing conversion fails. `Option Strict` ensures compile-time notification of these narrowing conversions so that you can avoid them. For more information, see [Implicit and Explicit Conversions (Visual Basic)](../VS_csharp/implicit-and-explicit-conversions--visual-basic-.md) and [Widening and Narrowing Conversions (Visual Basic)](../VS_csharp/widening-and-narrowing-conversions--visual-basic-.md).  
...
-   [+ Operator (Visual Basic)](../VS_csharp/--operator--visual-basic-.md)  
...
-   [Char Data Type (Visual Basic)](../VS_csharp/char-data-type--visual-basic-.md)  
  
 When you concatenate strings by using the [& Operator (Visual Basic)](../VS_csharp/--operator--visual-basic-.md), all conversions to the strings are considered to be widening. So these conversions do not generate an implicit narrowing conversion error, even if `Option Strict` is on.  
...
### Default Data Types and Values  
 The following table describes the results of various combinations of specifying the data type and initializer in a [Dim Statement (Visual Basic)](../VS_csharp/dim-statement--visual-basic-.md).  
...
## When an Option Strict Statement Is Not Present  
 If the source code does not contain an `Option Strict` statement, the **Option strict** setting on the [Compile Page, Project Designer (Visual Basic)](../VS_csharp/compile-page--project-designer--visual-basic-.md) is used. The **Compile Page** has settings that provide additional control over the conditions that generate an error.  
  
 If you are using the command-line compiler, you can use the [/optionstrict](../VS_csharp/-optionstrict.md) compiler option to specify a setting for `Option Strict`.  
...
### To set Option Strict on the command line  
 Include the [/optionstrict](../VS_csharp/-optionstrict.md) compiler option in the **vbc** command.  
...
## Example  
 ...
 [!code[VbVbalrStatements#161](../VS_csharp/codesnippet/VisualBasic/option-strict-statement_1.vb)]  
...
## Example  
 ...
 [!code[VbVbalrStatements#162](../VS_csharp/codesnippet/VisualBasic/option-strict-statement_2.vb)]  
...
## Example  
 ...
 [!code[VbVbalrStatements#163](../VS_csharp/codesnippet/VisualBasic/option-strict-statement_3.vb)]  
  
 [!code[VbVbalrStatements#164](../VS_csharp/codesnippet/VisualBasic/option-strict-statement_4.vb)]  
  
## See Also  
 [Widening and Narrowing Conversions](../VS_csharp/widening-and-narrowing-conversions--visual-basic-.md)   
 [Implicit and Explicit Conversions (Visual Basic)](../VS_csharp/implicit-and-explicit-conversions--visual-basic-.md)   
 ...
 [Type Conversion Functions (Visual Basic)](../VS_csharp/type-conversion-functions--visual-basic-.md)   
 [How to: Access Members of an Object (Visual Basic)](../VS_csharp/how-to--access-members-of-an-object--visual-basic-.md)   
 [Embedded Expressions in XML (Visual Basic)](../VS_csharp/embedded-expressions-in-xml--visual-basic-.md)   
 [Relaxed Delegate Conversion (Visual Basic)](../VS_csharp/relaxed-delegate-conversion--visual-basic-.md)   
