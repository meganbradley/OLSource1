...
|-----------------------------|--------------------|  
|[Boolean Data Type (Visual Basic)](../VS_csharp/boolean-data-type--visual-basic-.md)|A string containing "True" or "False".|  
|[Date Data Type (Visual Basic)](../VS_csharp/date-data-type--visual-basic-.md)|A string containing a `Date` value (date and time) in the short date format of your system.|  
|[Numeric Data Types](../VS_csharp/numeric-data-types--visual-basic-.md)|A string representing the number.|  
...
## See Also  
 ...
 [Date Data Type (Visual Basic)](../VS_csharp/date-data-type--visual-basic-.md)