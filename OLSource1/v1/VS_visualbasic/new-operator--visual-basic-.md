...
## Remarks  
 ...
 [!code[VbVbalrKeywords#11](../VS_visualbasic/codesnippet/VisualBasic/new-operator--visual-basic-_1.vb)]  
  
 Since arrays are classes, `New` can create a new array instance, as shown in the following examples.  
  
 [!code[VbVbalrKeywords#12](../VS_visualbasic/codesnippet/VisualBasic/new-operator--visual-basic-_2.vb)]  
...
> [!NOTE]
>  The `New` keyword is also used in type parameter lists to specify that the supplied type must expose an accessible parameterless constructor. For more information about type parameters and constraints, see [Type List](../VS_visualbasic/type-list--visual-basic-.md).  
  
 To create a constructor procedure for a class, set the name of a `Sub` procedure to the `New` keyword. For more information, see [Object Lifetime: How Objects Are Created and Destroyed](../VS_visualbasic/object-lifetime--how-objects-are-created-and-destroyed--visual-basic-.md).  
