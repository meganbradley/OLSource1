...
###  <a name="BKMK_CancelAndRestart"></a> Cancel and Restart the Operation  
 ...
 For more information about cancellation, see [Fine-Tuning Your Async Application (Visual Basic)](../VS_visualbasic/fine-tuning-your-async-application--visual-basic-.md).  
