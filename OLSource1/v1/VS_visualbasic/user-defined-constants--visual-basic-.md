...
## Const Statement Usage  
 ...
 [!code[VbEnumsTask#10](../VS_csharp/codesnippet/VisualBasic/user-defined-constants--visual-basic-_1.vb)]  
  
 It also can define `String` constants:  
  
 [!code[VbEnumsTask#13](../VS_csharp/codesnippet/VisualBasic/user-defined-constants--visual-basic-_2.vb)]  
 ...
 [!code[VbEnumsTask#15](../VS_csharp/codesnippet/VisualBasic/user-defined-constants--visual-basic-_3.vb)]  
...
-   To create a constant available throughout the application, declare it using the `Public` keyword in the declarations section the class.  
 ...
 For more information, see [How to: Declare A Constant](../VS_csharp/how-to--declare-a-constant--visual-basic-.md).  
...
### Avoiding Circular References  
 ...
 [!code[VbEnumsTask#16](../VS_csharp/codesnippet/VisualBasic/user-defined-constants--visual-basic-_4.vb)]  
[!code[VbEnumsTask#17](../VS_csharp/codesnippet/VisualBasic/user-defined-constants--visual-basic-_5.vb)]  
  
 If a cycle occurs, [!INCLUDE[vbprvb](../VS_csharp/includes/vbprvb_md.md)] generates a compiler error.  
