...
> [!NOTE]
>  Visual Basic supports *partial methods*, which are typically implemented in partial classes. For more information, see [Partial Methods](../VS_visualbasic/partial-methods--visual-basic-.md) and [Sub Statement](../VS_visualbasic/sub-statement--visual-basic-.md).  
...
|-|-|  
|Term|Definition|  
|`attrlist`|Optional. List of attributes that apply to this type. You must enclose the [Attribute List](../VS_visualbasic/attribute-list--visual-basic-.md) in angle brackets (`< >`).|  
|`accessmodifier`|Optional. Specifies what code can access this type. See [Access Levels in Visual Basic](../VS_visualbasic/access-levels-in-visual-basic.md).|  
...
|`Of`|Optional. Specifies that this is a generic type. See [Generic Types in Visual Basic](../VS_visualbasic/generic-types-in-visual-basic--visual-basic-.md).|  
|`typelist`|Required if you use [Of](../VS_visualbasic/of-clause--visual-basic-.md). See [Type List](../VS_visualbasic/type-list--visual-basic-.md).|  
|`Inherits`|Optional. See [Inherits Statement](../VS_visualbasic/inherits-statement.md).|  
|`classname`|Required if you use `Inherits`. The name of the class or interface from which this class derives.|  
|`Implements`|Optional. See [Implements Statement](../VS_visualbasic/implements-statement.md).|  
...
## Example  
 ...
 [!code[VbVbalrKeywords#3](../VS_visualbasic/codesnippet/VisualBasic/partial--visual-basic-_1.vb)]  
