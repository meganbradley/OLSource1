...
## Remarks  
 The `<c>` tag gives you a way to indicate that text within a description should be marked as code. Use [\<code>](../VS_visualbasic/-code---visual-basic-.md) to indicate multiple lines as code.  
...
## Example  
 ...
 [!code[VbVbcnXmlDocComments#1](../VS_visualbasic/codesnippet/VisualBasic/-c---visual-basic-_1.vb)]  
