...
ms.tgt_pltfrm: na
ms.topic: "article"
H1: "Assemblies and the Global Assembly Cache (Visual Basic)"
dev_langs: 
  - "VB"
...
translation.priority.mt: 
  ...
  - "tr-tr"
---
# Assemblies and the Global Assembly Cache (Visual Basic)1
...
-   You can programmatically obtain information about an assembly by using reflection. For more information, see [Reflection (Visual Basic)](../VS_visualbasic/reflection--visual-basic-.md).  
...
## Adding a Reference to an Assembly  
 To use an assembly, you must add a reference to it. Next, you use the [Imports statement](../VS_visualbasic/imports-statement--.net-namespace-and-type-.md) to choose the namespace of the items you want to use. Once an assembly is referenced and imported, all the accessible classes, properties, methods, and other members of its namespaces are available to your application as if their code were part of your source file.  
  
## Creating an Assembly  
 Compile your application by building it from the command line using the command-line compiler. For details about building assemblies from the command line, see [Building from the Command Line](../VS_visualbasic/building-from-the-command-line--visual-basic-.md).  
