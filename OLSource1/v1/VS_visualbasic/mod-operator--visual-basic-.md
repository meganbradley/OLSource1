...
## Remarks  
 ...
 If `number1` or `number2` evaluates to [Nothing](../VS_visualbasic/nothing--visual-basic-.md), it is treated as zero.  
  
 Related operators include the following:  
  
-   The [\ Operator (Visual Basic)](../VS_visualbasic/--operator--visual-basic-2.md) returns the integer quotient of a division. For example, the expression `14 \ 4` evaluates to 3.  
  
-   The [/ Operator (Visual Basic)](../VS_visualbasic/--operator--visual-basic-3.md) returns the full quotient, including the remainder, as a floating-point number. For example, the expression `14 / 4` evaluates to 3.5.  
...
## Example  
 ...
 [!code[VbVbalrOperators#31](../VS_visualbasic/codesnippet/VisualBasic/mod-operator--visual-basic-_1.vb)]  
...
## Example  
 ...
 [!code[VbVbalrOperators#32](../VS_visualbasic/codesnippet/VisualBasic/mod-operator--visual-basic-_2.vb)]  
