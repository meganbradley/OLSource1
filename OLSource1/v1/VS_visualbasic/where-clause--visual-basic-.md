...
## Example  
 ...
 [!code[VbSimpleQuerySamples#23](../VS_visualbasic/codesnippet/VisualBasic/where-clause--visual-basic-_1.vb)]  
  
## Example  
 The following example uses `And` and `Or` logical operators in the `Where` clause.  
  
 [!code[VbSimpleQuerySamples#31](../VS_visualbasic/codesnippet/VisualBasic/where-clause--visual-basic-_2.vb)]  
