...
## Result  
 ...
 The [\ Operator (Visual Basic)](../VS_csharp/--operator--visual-basic-2.md) returns the integer quotient, which drops the remainder.  
...
|One expression is a [Single](../VS_csharp/single-data-type--visual-basic-.md) data type and the other is not a [Double](../VS_csharp/double-data-type--visual-basic-.md)|`Single`|  
|One expression is a [Decimal](../VS_csharp/decimal-data-type--visual-basic-.md) data type and the other is not a [Single](../VS_csharp/single-data-type--visual-basic-.md) or a [Double](../VS_csharp/double-data-type--visual-basic-.md)|`Decimal`|  
|Either expression is a [Double](../VS_csharp/double-data-type--visual-basic-.md) data type|`Double`|  
...
## Example  
 ...
 [!code[VbVbalrOperators#16](../VS_csharp/codesnippet/VisualBasic/--operator--visual-basic-3_1.vb)]  
...
## See Also  
 ...
 [Data Types of Operator Results](../VS_csharp/data-types-of-operator-results--visual-basic-.md)   
