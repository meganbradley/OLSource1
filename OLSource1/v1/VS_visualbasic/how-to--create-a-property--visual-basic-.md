...
1.  Outside any property or procedure, use a [Property Statement](../VS_visualbasic/property-statement.md), followed by an `End Property` statement.  
...
1.  Between the `Property` and `End Property` statements, write a [Get Statement](../VS_visualbasic/get-statement.md), followed by an `End Get` statement. You do not need to define any parameters for the `Get` procedure.  
...
1.  Between the `Property` and `End Property` statements, write a [Set Statement](../VS_visualbasic/set-statement--visual-basic-.md), followed by an `End Set` statement.  
...
## Example  
 ...
 [!code[VbVbcnProcedures#8](../VS_visualbasic/codesnippet/VisualBasic/how-to--create-a-property--visual-basic-_1.vb)]  
 ...
 [!code[VbVbcnProcedures#9](../VS_visualbasic/codesnippet/VisualBasic/how-to--create-a-property--visual-basic-_2.vb)]  
