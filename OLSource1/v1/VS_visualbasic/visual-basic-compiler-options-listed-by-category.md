...
The [!INCLUDE[vbprvb](../VS_csharp/includes/vbprvb_md.md)] command-line compiler is provided as an alternative to compiling programs from within the [!INCLUDE[vsprvs](../VS_csharp/includes/vsprvs_md.md)] integrated development environment (IDE). The following is a list of the [!INCLUDE[vbprvb](../VS_csharp/includes/vbprvb_md.md)] command-line compiler options sorted by functional category.  
...
|[/optimize](../VS_csharp/-optimize.md)|Enables/disables optimizations.|  
...
|-|-|  
|Option|Purpose|  
|[/doc](../VS_csharp/-doc.md)|Process documentation comments to an XML file.|  
...
|[/target](../VS_csharp/-target--visual-basic-.md)|Specifies the format of the output.|  
...
|[/keyfile](../VS_csharp/-keyfile.md)|Specifies a file containing a key or key pair to give an assembly a strong name.|  
...
|-|-|  
|Option|Purpose|  
|[/?](../VS_csharp/-help------visual-basic-.md)|Displays the compiler options. This command is the same as specifying the `/help` option. No compilation occurs.|  
|[/help](../VS_csharp/-help------visual-basic-.md)|Displays the compiler options. This command is the same as specifying the `/?` option. No compilation occurs.|  
...
|[/optionstrict](../VS_csharp/-optionstrict.md)|Enforces strict type semantics.|  
...
|[/highentropyva](../VS_csharp/-highentropyva--visual-basic-.md)|Tells the Windows kernel whether a particular executable supports high entropy Address Space Layout Randomization (ASLR).|  
...
## See Also  
 [Visual Basic Compiler Options Listed Alphabetically](../VS_csharp/visual-basic-compiler-options-listed-alphabetically.md)   
