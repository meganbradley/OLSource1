...
-   Use the member-access operator (`.`) between the object variable name and the member name.  
    ...
    ```  
     ...
     If the member is [Shared](../VS_visualbasic/shared--visual-basic-.md), you do not need a variable to access it.  
...
1.  Declare the object variable to be of the [Object Data Type](../VS_visualbasic/object-data-type.md). (Declaring a variable as `Object` is the same as declaring it as \<xref:System.Object?displayProperty=fullName>.)  
