...
## Example  
 ...
 [!code[VbVbalrDelegates#8](../VS_csharp/codesnippet/VisualBasic/addressof-operator--visual-basic-_1.vb)]  
  
## Example  
 The following example uses the `AddressOf` operator to designate the startup function for a thread.  
  
 [!code[VbVbalrDelegates#9](../VS_csharp/codesnippet/VisualBasic/addressof-operator--visual-basic-_2.vb)]  
