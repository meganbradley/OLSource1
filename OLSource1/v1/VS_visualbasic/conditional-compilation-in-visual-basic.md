...
In *conditional compilation*, particular blocks of code in a program are compiled selectively while others are ignored.  
 ...
 [!code[VbVbalrConditionalComp#5](../VS_visualbasic/codesnippet/VisualBasic/conditional-compilation-in-visual-basic_1.vb)]  
...
|-|-|  
|Title|Description|  
|[Program Structure and Code Conventions](../VS_visualbasic/program-structure-and-code-conventions--visual-basic-.md)|Provides suggestions for making your code easy to read and maintain.|  
