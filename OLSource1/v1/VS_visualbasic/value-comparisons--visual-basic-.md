...
Comparison operators can be used to construct expressions that compare the values of numeric variables. These expressions return a `Boolean` value based on whether the comparison is true or false. Examples of such an expression are as follows.  
 ...
 [!code[VbVbalrOperators#84](../VS_csharp/codesnippet/VisualBasic/value-comparisons--visual-basic-_1.vb)]  
 ...
 [!code[VbVbalrOperators#85](../VS_csharp/codesnippet/VisualBasic/value-comparisons--visual-basic-_2.vb)]  
 ...
 [!code[VbVbalrOperators#86](../VS_csharp/codesnippet/VisualBasic/value-comparisons--visual-basic-_3.vb)]  
