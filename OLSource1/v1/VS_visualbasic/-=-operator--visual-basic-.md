...
## Remarks  
 The element on the left side of the `&=` operator can be a simple scalar variable, a property, or an element of an array. The variable or property cannot be [ReadOnly (Visual Basic)](../VS_csharp/readonly--visual-basic-.md). The `&=` operator concatenates the `String` expression on its right to the `String` variable or property on its left, and assigns the result to the variable or property on its left.  
...
## Example  
 ...
 [!code[VbVbalrOperators#3](../VS_csharp/codesnippet/VisualBasic/-=-operator--visual-basic-_1.vb)]  
  
## See Also  
 [& Operator](../VS_csharp/--operator--visual-basic-.md)   
 [+= Operator](../VS_csharp/-=-operator--visual-basic-.md)   
 [Assignment Operators](../VS_csharp/assignment-operators--visual-basic-.md)   
 [Concatenation Operators](../VS_csharp/concatenation-operators--visual-basic-.md)   
