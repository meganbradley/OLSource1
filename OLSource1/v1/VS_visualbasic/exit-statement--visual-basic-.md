...
## Statements  
 ...
 To specify a return value, you can assign the value to the function name on a line before the `Exit Function` statement. To assign the return value and exit the function in one statement, you can instead use the [Return Statement](../VS_visualbasic/return-statement--visual-basic-.md).  
...
## Example  
 ...
 [!code[VbVbalrStatements#133](../VS_visualbasic/codesnippet/VisualBasic/exit-statement--visual-basic-_1.vb)]  
...
## Example  
 ...
 [!code[VbVbalrStatements#23](../VS_visualbasic/codesnippet/VisualBasic/exit-statement--visual-basic-_2.vb)]  
  
## Example  
 The following example uses the [Return Statement](../VS_visualbasic/return-statement--visual-basic-.md) to assign the return value and exit the function.  
  
 [!code[VbVbalrStatements#24](../VS_visualbasic/codesnippet/VisualBasic/exit-statement--visual-basic-_3.vb)]  
...
## See Also  
 ...
 [Stop Statement](../VS_visualbasic/stop-statement--visual-basic-.md)   
