...
-   [WriteOnly](../VS_visualbasic/writeonly--visual-basic-.md)  
...
```  
 ...
 For more information, see: [Object Lifetime: How Objects Are Created and Destroyed](../VS_visualbasic/object-lifetime--how-objects-are-created-and-destroyed--visual-basic-.md).  
...
-   To declare events, use the [Event Statement](../VS_visualbasic/event-statement.md).  
  
-   To raise events, use the [RaiseEvent Statement](../VS_visualbasic/raiseevent-statement.md).  
  
-   To specify event handlers using a declarative way, use the [WithEvents](../VS_visualbasic/withevents--visual-basic-.md) statement and the [Handles](../VS_visualbasic/handles-clause--visual-basic-.md) clause.  
  
-   To be able to dynamically add, remove, and change the event handler associated with an event, use the [AddHandler Statement](../VS_visualbasic/addhandler-statement.md) and [RemoveHandler Statement](../VS_visualbasic/removehandler-statement.md) together with the [AddressOf Operator](../VS_visualbasic/addressof-operator--visual-basic-.md).  
...
|---------------------------|----------------|  
|[Public](../VS_visualbasic/public--visual-basic-.md)|The type or member can be accessed by any other code in the same assembly or another assembly that references it.|  
|[Private](../VS_visualbasic/private--visual-basic-.md)|The type or member can only be accessed by code in the same class.|  
|[Protected](../VS_visualbasic/protected--visual-basic-.md)|The type or member can only be accessed by code in the same class or in a derived class.|  
|[Friend](../VS_visualbasic/friend--visual-basic-.md)|The type or member can be accessed by any code in the same assembly, but not from another assembly.|  
...
-   [NotInheritable](../VS_visualbasic/notinheritable--visual-basic-.md)  
...
|Visual Basic Modifier|Definition|  
|---------------------------|----------------|  
|[Overridable](../VS_visualbasic/overridable--visual-basic-.md)|Allows a class member to be overridden in a derived class.|  
|[Overrides](../VS_visualbasic/overrides--visual-basic-.md)|Overrides a virtual (overridable) member defined in the base class.|  
|[NotOverridable](../VS_visualbasic/notoverridable--visual-basic-.md)|Prevents a member from being overridden in an inheriting class.|  
|[MustOverride](../VS_visualbasic/mustoverride--visual-basic-.md)|Requires that a class member to be overridden in the derived class.|  
|[Shadows](../VS_visualbasic/shadows--visual-basic-.md)|Hides a member inherited from a base class|  
