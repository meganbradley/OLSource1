...
## Remarks  
 If the source code file contains an [Option Explicit Statement (Visual Basic)](../VS_csharp/option-explicit-statement--visual-basic-.md), the statement overrides the `/optionexplicit` command-line compiler setting.  
...
## Example  
 ...
 [!code[VbVbalrCompiler#5](../VS_csharp/codesnippet/VisualBasic/-optionexplicit_1.vb)]  
