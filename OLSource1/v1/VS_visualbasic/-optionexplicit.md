...
## Remarks  
 If the source code file contains an [Option Explicit Statement](../VS_visualbasic/option-explicit-statement--visual-basic-.md), the statement overrides the `/optionexplicit` command-line compiler setting.  
...
## Example  
 ...
 [!code[VbVbalrCompiler#5](../VS_visualbasic/codesnippet/VisualBasic/-optionexplicit_1.vb)]  
