...
You can make external objects available to your project by choosing the **Add Reference** command on the **Project** menu. References in [!INCLUDE[vbprvb](../VS_visualbasic/includes/vbprvb_md.md)] can point to assemblies, which are like type libraries but contain more information.  
...
## Using Aliases with the Imports Statement  
 ...
 [!code[VbVbalrApplication#3](../VS_visualbasic/codesnippet/VisualBasic/references-and-the-imports-statement--visual-basic-_1.vb)]  
 ...
 [!code[VbVbalrApplication#4](../VS_visualbasic/codesnippet/VisualBasic/references-and-the-imports-statement--visual-basic-_2.vb)]  
  
 Future references to this namespace can be considerably shorter:  
  
 [!code[VbVbalrApplication#5](../VS_visualbasic/codesnippet/VisualBasic/references-and-the-imports-statement--visual-basic-_3.vb)]  
