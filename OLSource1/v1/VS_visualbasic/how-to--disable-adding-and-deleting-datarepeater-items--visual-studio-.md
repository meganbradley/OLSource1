...
12. Add the following code to the `BindingNavigatorDeleteItem_EnabledChanged` event handler:  
     ...
     [!code[VbPowerPacksDataRepeaterDisableAddDelete#1](../VS_csharp/codesnippet/CSharp/how-to--disable-adding-and-deleting-datarepeater-items--visual-studio-_1.cs)]
[!code[VbPowerPacksDataRepeaterDisableAddDelete#1](../VS_csharp/codesnippet/VisualBasic/how-to--disable-adding-and-deleting-datarepeater-items--visual-studio-_1.vb)]  
...
2.  Add the following code to the `Form_Load` event:  
     ...
     [!code[VbPowerPacksDataRepeaterDisableAddDelete#2](../VS_csharp/codesnippet/CSharp/how-to--disable-adding-and-deleting-datarepeater-items--visual-studio-_2.cs)]
[!code[VbPowerPacksDataRepeaterDisableAddDelete#2](../VS_csharp/codesnippet/VisualBasic/how-to--disable-adding-and-deleting-datarepeater-items--visual-studio-_2.vb)]  
