...
2.  If the error continues, save your work and restart [!INCLUDE[vsprvs](../VS_visualbasic/includes/vsprvs_md.md)].  
  
3.  If the error continues, restart the computer.  
  
4.  If the error recurs, reinstall [!INCLUDE[vbprvb](../VS_visualbasic/includes/vbprvb_md.md)].  
