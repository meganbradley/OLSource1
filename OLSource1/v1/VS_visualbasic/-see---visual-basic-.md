...
## Remarks  
 Use the `<see>` tag to specify a link from within text. Use [<seealso\> (Visual Basic)](../VS_csharp/-seealso---visual-basic-.md) to indicate text that you might want to appear in a "See Also" section.  
...
## Example  
 ...
 [!code[VbVbcnXmlDocComments#6](../VS_csharp/codesnippet/VisualBasic/-see---visual-basic-_1.vb)]  
