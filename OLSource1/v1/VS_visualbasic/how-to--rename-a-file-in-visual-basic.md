...
-   Use the `My.Computer.FileSystem.RenameFile` method to rename a file. This example renames the file named `Test.txt` to `SecondTest.txt`.  
     ...
     [!code[VbVbcnMyFileSystem#9](../VS_visualbasic/codesnippet/VisualBasic/how-to--rename-a-file-in-visual-basic_1.vb)]  
...
## See Also  
 ...
 [How to: Move a File](../VS_visualbasic/how-to--move-a-file-in-visual-basic.md)   
