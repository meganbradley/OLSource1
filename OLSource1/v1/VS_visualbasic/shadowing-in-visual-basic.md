...
### Shadowing Through Scope  
 ...
 ![Graphic diagram of shadowing through scope](../VS_visualbasic/media/shadowscope.gif "ShadowScope")  
Shadowing through scope  
  
 For an example of shadowing through scope, see [How to: Hide a Variable with the Same Name as Your Variable](../VS_visualbasic/how-to--hide-a-variable-with-the-same-name-as-your-variable--visual-basic-.md).  
...
### Shadowing Through Inheritance  
 ...
 ![Graphic diagram of shadowing through inheritance](../VS_visualbasic/media/shadowinherit.gif "ShadowInherit")  
Shadowing through inheritance  
  
 For an example of shadowing through inheritance, see [How to: Hide a Variable with the Same Name as Your Variable](../VS_visualbasic/how-to--hide-a-variable-with-the-same-name-as-your-variable--visual-basic-.md) and [How to: Hide an Inherited Variable](../VS_visualbasic/how-to--hide-an-inherited-variable--visual-basic-.md).  
...
## Shadowing and Overriding  
 Do not confuse shadowing with overriding. Both are used when a derived class inherits from a base class, and both redefine one declared element with another. But there are significant differences between the two. For a comparison, see [Differences Between Shadowing and Overriding](../VS_visualbasic/differences-between-shadowing-and-overriding--visual-basic-.md).  
  
## Shadowing and Overloading  
 If you shadow the same base class element with more than one element in your derived class, the shadowing elements become overloaded versions of that element. For more information, see [Procedure Overloading](../VS_visualbasic/procedure-overloading--visual-basic-.md).  
...
## Accessing a Shadowed Element  
 ...
 For an example of accessing a shadowed element, see [How to: Access a Variable Hidden by a Derived Class](../VS_visualbasic/how-to--access-a-variable-hidden-by-a-derived-class--visual-basic-.md).  
