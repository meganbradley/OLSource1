...
## In This Section  
 ...
 [Port Operations in the .NET Framework with Visual Basic](../VS_csharp/port-operations-in-the-.net-framework-with-visual-basic.md)  
 Describes how to use the [!INCLUDE[dnprdnshort](../VS_csharp/includes/dnprdnshort_md.md)] when performing port operations.  
