...
## Prerequisites  
 ...
 You may want to review [How to: Write Event Information to a Text File](../VS_visualbasic/how-to--write-event-information-to-a-text-file--visual-basic-.md) or [How to: Write to an Application Event Log](../VS_visualbasic/how-to--write-to-an-application-event-log--visual-basic-.md).  
...
2.  This code example shows how to determine the strongly named type name for a fully qualified type—"System.Diagnostics.FileLogTraceListener" in this case.  
     ...
     [!code[VbVbalrMyApplicationLog#15](../VS_visualbasic/codesnippet/VisualBasic/walkthrough--changing-where-my.application.log-writes-information--visual-basic-_1.vb)]  
...
## See Also  
 ...
 [How to: Write Event Information to a Text File](../VS_visualbasic/how-to--write-event-information-to-a-text-file--visual-basic-.md)   
 [How to: Write to an Application Event Log](../VS_visualbasic/how-to--write-to-an-application-event-log--visual-basic-.md)