...
Visual Basic supports anonymous types, which enable you to create objects without writing a class definition for the data type. Instead, the compiler generates a class for you. The class has no usable name, inherits directly from \<xref:System.Object>, and contains the properties you specify in declaring the object. Because the name of the data type is not specified, it is referred to as an *anonymous type*.  
 ...
 [!code[VbVbalrAnonymousTypes#1](../VS_visualbasic/codesnippet/VisualBasic/anonymous-types--visual-basic-_1.vb)]  
 ...
 [!code[VbVbalrAnonymousTypes#2](../VS_visualbasic/codesnippet/VisualBasic/anonymous-types--visual-basic-_2.vb)]  
 ...
 [!code[VbVbalrAnonymousTypes#3](../VS_visualbasic/codesnippet/VisualBasic/anonymous-types--visual-basic-_3.vb)]  
  
 For more information about the code created by the compiler for an anonymous type, see [Anonymous Type Definition](../VS_visualbasic/anonymous-type-definition--visual-basic-.md).  
...
## Declaring an Anonymous Type  
 ...
 [!code[VbVbalrAnonymousTypes#4](../VS_visualbasic/codesnippet/VisualBasic/anonymous-types--visual-basic-_4.vb)]  
 ...
 [!code[VbVbalrAnonymousTypes#5](../VS_visualbasic/codesnippet/VisualBasic/anonymous-types--visual-basic-_5.vb)]  
  
 For more information about other ways to specify anonymous type properties, see [How to: Infer Property Names and Types in Anonymous Type Declarations](../VS_visualbasic/how-to--infer-property-names-and-types-in-anonymous-type-declarations--visual-basic-.md).  
...
-   At least one property in each declaration is a key property.  
 ...
 [!code[VbVbalrAnonymousTypes#6](../VS_visualbasic/codesnippet/VisualBasic/anonymous-types--visual-basic-_6.vb)]  
 ...
 [!code[VbVbalrAnonymousTypes#7](../VS_visualbasic/codesnippet/VisualBasic/anonymous-types--visual-basic-_7.vb)]  
...
### Read-Only Values  
 ...
 [!code[VbVbalrAnonymousTypes#8](../VS_visualbasic/codesnippet/VisualBasic/anonymous-types--visual-basic-_8.vb)]  
...
-   `custs1` contains a collection of strings, because `cust.Name` is a string.  
     ...
     [!code[VbVbalrAnonymousTypes#30](../VS_visualbasic/codesnippet/VisualBasic/anonymous-types--visual-basic-_9.vb)]  
...
-   `custs2` contains a collection of `Customer` objects, because each element of `customers` is a `Customer` object, and the whole element is selected by the query.  
     ...
     [!code[VbVbalrAnonymousTypes#31](../VS_visualbasic/codesnippet/VisualBasic/anonymous-types--visual-basic-_10.vb)]  
 ...
 [!code[VbVbalrAnonymousTYpes#32](../VS_visualbasic/codesnippet/VisualBasic/anonymous-types--visual-basic-_11.vb)]  
 ...
 [!code[VbVbalrAnonymousTypes#33](../VS_visualbasic/codesnippet/VisualBasic/anonymous-types--visual-basic-_12.vb)]  
...
## Deciding Whether to Use Anonymous Types  
 ...
 [!code[VbVbalrAnonymousTypes#9](../VS_visualbasic/codesnippet/VisualBasic/anonymous-types--visual-basic-_13.vb)]  
 ...
 [!code[VbVbalrAnonymousTypes#10](../VS_visualbasic/codesnippet/VisualBasic/anonymous-types--visual-basic-_14.vb)]  
...
## An Anonymous Type Definition  
 ...
 For more information about the code created by the compiler and the functionality of the overridden methods, see [Anonymous Type Definition](../VS_visualbasic/anonymous-type-definition--visual-basic-.md).  
