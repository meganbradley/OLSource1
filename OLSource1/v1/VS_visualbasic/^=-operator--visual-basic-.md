...
## Remarks  
 ...
 Visual Basic always performs exponentiation in the [Double Data Type](../VS_visualbasic/double-data-type--visual-basic-.md). Operands of any different type are converted to `Double`, and the result is always `Double`.  
...
## Example  
 ...
 [!code[VbVbalrOperators#21](../VS_visualbasic/codesnippet/VisualBasic/^=-operator--visual-basic-_1.vb)]  
