...
|[TryCast Operator](../VS_visualbasic/trycast-operator--visual-basic-.md)|Reference types only|One type must inherit from or implement the other type|Returns [Nothing](../VS_visualbasic/nothing--visual-basic-.md)|  
  
## Example  
 The following example demonstrates two uses of `DirectCast`, one that fails at run time and one that succeeds.  
  
 [!code[VbVbalrKeywords#1](../VS_visualbasic/codesnippet/VisualBasic/directcast-operator--visual-basic-_1.vb)]  
