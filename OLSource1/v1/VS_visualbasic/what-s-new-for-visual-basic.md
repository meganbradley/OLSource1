...
## Current Version  
 [Nameof](../Topic/nameof%20\(C%23%20and%20Visual%20Basic%20Reference\).md)  
 ...
 [Null-conditional Member Access and Indexing](../Topic/Null-conditional%20Operators%20\(C%23%20and%20Visual%20Basic\).md)  
 ...
 [Multi-line String Literals](../VS_visualbasic/string-basics-in-visual-basic.md)  
 ...
 [TypeOf \<expr> IsNot \<type>](../VS_visualbasic/typeof-operator--visual-basic-.md)  
 For more readability of your code, you can now use `TypeOf` with `IsNot`.  
  
 [#Disable Warning \<ID> and #Enable Warning \<ID>](../VS_visualbasic/directives--visual-basic-.md)  
 ...
 [Partial Module and Interface Definitions](../VS_visualbasic/partial--visual-basic-.md)  
 In addition to classes and structs, you can declare partial modules and interfaces.  
  
 [#Region Directives inside Method Bodies](../VS_visualbasic/sharpregion-directive.md)  
 You can put #Region…#End Region delimiters anywhere in a file, inside functions, and even spanning across function bodies.  
  
 [Overrides Definitions are Implicitly Overloads](../VS_visualbasic/overrides--visual-basic-.md)  
