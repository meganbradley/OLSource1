...
-   `WhenAll` returns a task that completes when all tasks in a collection are complete.  
     ...
     For more information and an example that uses `WhenAll`, see [How to: Extend the Async Walkthrough by Using Task.WhenAll (Visual Basic)](../VS_visualbasic/how-to--extend-the-async-walkthrough-by-using-task.whenall--visual-basic-.md).  
...
>  To run the examples, you must have Visual Studio 2012 or newer and the .NET Framework 4.5 or newer installed on your computer.  
 ...
 ![WPF window with Cancel button](../VS_visualbasic/media/cancellation.png "Cancellation")  
