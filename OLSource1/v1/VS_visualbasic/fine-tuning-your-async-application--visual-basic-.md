...
-   `WhenAll` returns a task that completes when all tasks in a collection are complete.  
     ...
     For more information and an example that uses `WhenAll`, see [How to: Extend the Async Walkthrough by Using Task.WhenAll (Visual Basic)](../VS_csharp/how-to--extend-the-async-walkthrough-by-using-task.whenall--visual-basic-.md).  
  
 This section includes the following examples.  
  
-   [Cancel an Async Task or a List of Tasks (Visual Basic)](../VS_csharp/cancel-an-async-task-or-a-list-of-tasks--visual-basic-.md).  
  
-   [Cancel Async Tasks after a Period of Time (Visual Basic)](../VS_csharp/cancel-async-tasks-after-a-period-of-time--visual-basic-.md)  
  
-   [Cancel Remaining Async Tasks after One Is Complete (Visual Basic)](../VS_csharp/cancel-remaining-async-tasks-after-one-is-complete--visual-basic-.md)  
  
-   [Start Multiple Async Tasks and Process Them As They Complete (Visual Basic)](../VS_csharp/start-multiple-async-tasks-and-process-them-as-they-complete--visual-basic-.md)  
...
>  To run the examples, you must have Visual Studio 2012 or newer and the .NET Framework 4.5 or newer installed on your computer.  
 ...
 ![WPF window with Cancel button](../VS_csharp/media/cancellation.png "Cancellation")  
