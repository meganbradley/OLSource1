...
---
# -errorreport
Specifies how the [!INCLUDE[vbprvb](../VS_visualbasic/includes/vbprvb_md.md)] compiler should report internal compiler errors.  
...
## Remarks  
 This option provides a convenient way to report a [!INCLUDE[vbprvb](../VS_visualbasic/includes/vbprvb_md.md)] internal compiler error (ICE) to the [!INCLUDE[vbprvb](../VS_visualbasic/includes/vbprvb_md.md)] team at Microsoft. By default, the compiler sends no information to Microsoft. However, if you do encounter an internal compiler error, this option allows you to report the error to Microsoft. That information will help Microsoft engineers identify the cause and may help improve the next release of [!INCLUDE[vbprvb](../VS_visualbasic/includes/vbprvb_md.md)].  
...
|`none`|If an internal compiler error occurs, it will not be collected or sent to Microsoft.|  
 ...
 The compiler sends data that includes the stack at the time of the error, which usually includes some source code. If `/errorreport` is used with the [/bugreport](../VS_visualbasic/-bugreport.md) option, then the entire source file is sent.  
  
 This option is best used with the [/bugreport](../VS_visualbasic/-bugreport.md) option, because it allows Microsoft engineers to more easily reproduce the error.  
