...
## When an Option Explicit Statement Is Not Present  
 If the source code does not contain an `Option Explicit` statement, the **Option Explicit** setting on the [Compile Page, Project Designer (Visual Basic)](../Topic/Compile%20Page,%20Project%20Designer%20\(Visual%20Basic\).md) is used. If the command-line compiler is used, the [/optionexplicit](../VS_visualbasic/-optionexplicit.md) compiler option is used.  
...
-   Include the [/optionexplicit](../VS_visualbasic/-optionexplicit.md) compiler option in the **vbc** command.  
...
## Example  
 ...
 [!code[VbVbalrStatements#47](../VS_visualbasic/codesnippet/VisualBasic/option-explicit-statement--visual-basic-_1.vb)]  
  
 [!code[VbVbalrStatements#48](../VS_visualbasic/codesnippet/VisualBasic/option-explicit-statement--visual-basic-_2.vb)]  
