...
1.  Place the [Dim Statement](../VS_visualbasic/dim-statement--visual-basic-.md) for the variable inside the module, class, or structure, but outside any procedure.  
...
2.  Include the [Public](../VS_visualbasic/public--visual-basic-.md) keyword in the `Dim` statement.  
...
2.  Include the [Protected](../VS_visualbasic/protected--visual-basic-.md) keyword in the `Dim` statement.  
...
2.  Include the [Friend](../VS_visualbasic/friend--visual-basic-.md) keyword in the `Dim` statement.  
