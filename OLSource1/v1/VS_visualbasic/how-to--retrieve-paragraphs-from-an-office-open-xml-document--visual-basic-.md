...
## Example  
 ...
 For a detailed tutorial that explains how this example works, see [Pure Functional Transformations of XML (Visual Basic)](../VS_visualbasic/pure-functional-transformations-of-xml--visual-basic-.md).  
...
```  
 ...
 When run with the sample Open XML document described in [Creating the Source Office Open XML Document (Visual Basic)](../VS_visualbasic/creating-the-source-office-open-xml-document--visual-basic-.md), this example produces the following output:  
