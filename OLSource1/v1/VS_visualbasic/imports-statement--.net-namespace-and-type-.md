...
|-|-|  
|Term|Definition|  
|`aliasname`|Optional. An *import alias* or name by which code can refer to `namespace` instead of the full qualification string. See [Declared Element Names](../VS_csharp/declared-element-names--visual-basic-.md).|  
...
## Remarks  
 ...
 Note that the `Imports` statement does not make elements from other projects and assemblies available to your project. Importing does not take the place of setting a reference. It only removes the need to qualify names that are already available to your project. For more information, see "Importing Containing Elements" in [References to Declared Elements](../VS_csharp/references-to-declared-elements--visual-basic-.md).  
  
> [!NOTE]
>  You can define implicit `Imports` statements by using the [References Page, Project Designer (Visual Basic)](../VS_csharp/references-page--project-designer--visual-basic-.md). For more information, see [How to: Add or Remove Imported Namespaces (Visual Basic)](../VS_csharp/how-to--add-or-remove-imported-namespaces--visual-basic-.md).  
  
## Import Aliases  
 An *import alias* defines the alias for a namespace or type. Import aliases are useful when you need to use items with the same name that are declared in one or more namespaces. For more information and an example, see "Qualifying an Element Name" in [References to Declared Elements](../VS_csharp/references-to-declared-elements--visual-basic-.md).  
...
## Example  
 ...
 [!code[VbVbalrStatements#152](../VS_csharp/codesnippet/VisualBasic/imports-statement--.net-namespace-and-type-_1.vb)]  
...
## Example  
 ...
 [!code[VbVbalrStatements#153](../VS_csharp/codesnippet/VisualBasic/imports-statement--.net-namespace-and-type-_2.vb)]  
  
 [!code[VbVbalrStatements#154](../VS_csharp/codesnippet/VisualBasic/imports-statement--.net-namespace-and-type-_3.vb)]  
...
## Example  
 ...
 [!code[VbVbalrStatements#155](../VS_csharp/codesnippet/VisualBasic/imports-statement--.net-namespace-and-type-_4.vb)]  
  
 [!code[VbVbalrStatements#156](../VS_csharp/codesnippet/VisualBasic/imports-statement--.net-namespace-and-type-_5.vb)]  
...
## Example  
 ...
 [!code[VbVbalrStatements#157](../VS_csharp/codesnippet/VisualBasic/imports-statement--.net-namespace-and-type-_6.vb)]  
  
 [!code[VbVbalrStatements#158](../VS_csharp/codesnippet/VisualBasic/imports-statement--.net-namespace-and-type-_7.vb)]  
...
## See Also  
 ...
 [References to Declared Elements (Visual Basic)](../VS_csharp/references-to-declared-elements--visual-basic-.md)