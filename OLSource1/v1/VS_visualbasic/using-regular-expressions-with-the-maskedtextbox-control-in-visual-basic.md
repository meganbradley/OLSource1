...
## Description of the Masking Language  
 The standard <xref:System.Windows.Forms.MaskedTextBox*> masking language is based on the one used by the `Masked Edit` control in [!INCLUDE[vbprvb](../VS_csharp/includes/vbprvb_md.md)] 6.0 and should be familiar to users migrating from that platform.  
