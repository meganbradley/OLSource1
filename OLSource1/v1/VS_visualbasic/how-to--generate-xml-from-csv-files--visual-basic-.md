...
This example shows how to use [!INCLUDE[vbteclinqext](../VS_csharp/includes/vbteclinqext_md.md)] and [!INCLUDE[sqltecxlinq](../VS_csharp/includes/sqltecxlinq_md.md)] to generate an XML file from a comma-separated value (CSV) file.  
  
## Example  
 The following code performs a [!INCLUDE[vbteclinq](../VS_csharp/includes/vbteclinq_md.md)] query on an array of strings.  
