...
This example shows how to use [!INCLUDE[vbteclinqext](../VS_visualbasic/includes/vbteclinqext_md.md)] and [!INCLUDE[sqltecxlinq](../VS_visualbasic/includes/sqltecxlinq_md.md)] to generate an XML file from a comma-separated value (CSV) file.  
  
## Example  
 The following code performs a [!INCLUDE[vbteclinq](../VS_visualbasic/includes/vbteclinq_md.md)] query on an array of strings.  
