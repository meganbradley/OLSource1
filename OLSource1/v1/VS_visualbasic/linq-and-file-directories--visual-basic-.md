...
Many file system operations are essentially queries and are therefore well-suited to the LINQ approach.  
 ...
 [How to: Query for Files with a Specified Attribute or Name (Visual Basic)](../VS_csharp/how-to--query-for-files-with-a-specified-attribute-or-name--visual-basic-.md)  
 Shows how to search for files by examining one or more properties of its <xref:System.IO.FileInfo*> object.  
  
 [How to: Group Files by Extension (LINQ) (Visual Basic)](../VS_csharp/how-to--group-files-by-extension--linq---visual-basic-.md)  
 ...
 [How to: Compare the Contents of Two Folders (LINQ) (Visual Basic)](../VS_csharp/how-to--compare-the-contents-of-two-folders--linq---visual-basic-.md)s  
 ...
 [How to: Query for Duplicate Files in a Directory Tree (LINQ) (Visual Basic)](../VS_csharp/how-to--query-for-duplicate-files-in-a-directory-tree--linq---visual-basic-.md)  
 ...
 [How to: Query the Contents of Files in a Folder (LINQ) (Visual Basic)](../VS_csharp/how-to--query-the-contents-of-files-in-a-folder--linq---visual-basic-.md)  
