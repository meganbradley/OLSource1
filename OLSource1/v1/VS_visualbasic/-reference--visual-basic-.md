...
## Remarks  
 The file(s) you import must contain assembly metadata. Only public types are visible outside the assembly. The [/addmodule](../VS_csharp/-addmodule.md) option imports metadata from a module.  
...
-   A field, property, event, or method that has a return type or parameter type from Assembly B is invoked.  
 ...
 The Vbc.rsp response file, which references commonly used [!INCLUDE[dnprdnshort](../VS_csharp/includes/dnprdnshort_md.md)] assemblies, is used by default. Use `/noconfig` if you do not want the compiler to use Vbc.rsp.  
