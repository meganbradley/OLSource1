...
2.  Inside your derived class, write a [Dim Statement](../VS_visualbasic/dim-statement--visual-basic-.md) declaring your variable. Use the same name as that of the inherited variable.  
  
3.  Include the [Shadows](../VS_visualbasic/shadows--visual-basic-.md) keyword in the declaration.  
...
## See Also  
 ...
 [How to: Hide a Variable with the Same Name as Your Variable](../VS_visualbasic/how-to--hide-a-variable-with-the-same-name-as-your-variable--visual-basic-.md)   
