...
This example builds on the previous example, [Retrieving the Paragraphs and Their Styles (Visual Basic)](../VS_csharp/retrieving-the-paragraphs-and-their-styles--visual-basic-.md). This new example retrieves the text of each paragraph as a string.  
 ...
 These queries, which are chained together, use the processing model that is examined in detail in the topic [Tutorial: Deferred Execution (Visual Basic)](../VS_csharp/tutorial--deferred-execution--visual-basic-.md).  
...
## Example  
 ...
 For instructions for creating the source document for this example, see [Creating the Source Office Open XML Document (Visual Basic)](../VS_csharp/creating-the-source-office-open-xml-document--visual-basic-.md).  
...
-   [Refactoring Using an Extension Method (Visual Basic)](../VS_csharp/refactoring-using-an-extension-method--visual-basic-.md)  
...
## See Also  
 ...
 [Deferred Execution and Lazy Evaluation in LINQ to XML (Visual Basic)](../VS_csharp/deferred-execution-and-lazy-evaluation-in-linq-to-xml--visual-basic-.md)