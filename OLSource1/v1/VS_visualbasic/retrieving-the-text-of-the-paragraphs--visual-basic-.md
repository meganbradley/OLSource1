...
This example builds on the previous example, [Retrieving the Paragraphs and Their Styles (Visual Basic)](../VS_visualbasic/retrieving-the-paragraphs-and-their-styles--visual-basic-.md). This new example retrieves the text of each paragraph as a string.  
 ...
 These queries, which are chained together, use the processing model that is examined in detail in the topic [Tutorial: Deferred Execution (Visual Basic)](../VS_visualbasic/tutorial--deferred-execution--visual-basic-.md).  
...
## Example  
 ...
 For instructions for creating the source document for this example, see [Creating the Source Office Open XML Document (Visual Basic)](../VS_visualbasic/creating-the-source-office-open-xml-document--visual-basic-.md).  
