...
## Example  
 The following code compiles all [!INCLUDE[vbprvb](../VS_visualbasic/includes/vbprvb_md.md)] files in the current directory.  
  
```  
vbc *.vb  
```  
  
 The following code compiles all [!INCLUDE[vbprvb](../VS_visualbasic/includes/vbprvb_md.md)] files in the `Test\ABC` directory and any directories below it, and then generates `Test.ABC.dll`.  
